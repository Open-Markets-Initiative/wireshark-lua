...
-- Message Block
asx_securities_ntp_itch_v1_05.message_block = {}

-- Size: Message Block
asx_securities_ntp_itch_v1_05.message_block.size = function(buffer, offset, message_count)
  -- Size of Heartbeat
...
asx_securities_ntp_itch_v1_05.message_block.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
  end
...
asx_securities_ntp_itch_v1_05.message_block.dissect = function(buffer, offset, packet, parent, message_count)
  return asx_securities_ntp_itch_v1_05.message_block.branches(buffer, offset, packet, parent, message_count)
end
...
asx_securities_ntp_itch_v1_05.packet.dissect = function(buffer, packet, parent)
  ...
  index = asx_securities_ntp_itch_v1_05.message_block.dissect(buffer, index, packet, parent, message_count)
