...
asx_securities_trade_ouch_v3_6_dissect.cancel_by_order_id_message = function(buffer, offset, packet, parent)
  if show.cancel_by_order_id_message then
    ...
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.cancel_by_order_id_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.cancel_by_order_id_message_fields(buffer, offset, packet, element)
    ...
    return asx_securities_trade_ouch_v3_6_dissect.cancel_by_order_id_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.cancel_order_message = function(buffer, offset, packet, parent)
  if show.cancel_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.cancel_order_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.cancel_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.cancel_order_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.replace_order_message = function(buffer, offset, packet, parent)
  if show.replace_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.replace_order_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.replace_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.replace_order_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.enter_order_message = function(buffer, offset, packet, parent)
  if show.enter_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.enter_order_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.enter_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.enter_order_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.login_request_packet = function(buffer, offset, packet, parent)
  if show.login_request_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.login_request_packet, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.login_request_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.login_request_packet_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.order_executed_message = function(buffer, offset, packet, parent)
  if show.order_executed_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.order_executed_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.order_executed_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.order_executed_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.order_cancelled_message = function(buffer, offset, packet, parent)
  if show.order_cancelled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.order_cancelled_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.order_cancelled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.order_cancelled_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.order_replaced_message = function(buffer, offset, packet, parent)
  if show.order_replaced_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.order_replaced_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.order_replaced_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.order_replaced_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.order_rejected_message = function(buffer, offset, packet, parent)
  if show.order_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.order_rejected_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.order_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.order_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.order_accepted_message = function(buffer, offset, packet, parent)
  if show.order_accepted_message then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.order_accepted_message, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.order_accepted_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.order_accepted_message_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.login_rejected_packet = function(buffer, offset, packet, parent)
  if show.login_rejected_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.login_rejected_packet, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.login_accepted_packet = function(buffer, offset, packet, parent)
  if show.login_accepted_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.login_accepted_packet, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.debug_packet = function(buffer, offset, packet, parent)
  if show.debug_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.debug_packet, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.debug_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.debug_packet_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.packet_header = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.packet_header, buffer(offset, 0))
    local index = asx_securities_trade_ouch_v3_6_dissect.packet_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return asx_securities_trade_ouch_v3_6_dissect.packet_header_fields(buffer, offset, packet, element)
  end
end
...
asx_securities_trade_ouch_v3_6_dissect.soup_bin_tcp_packet = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  ...
  if show.soup_bin_tcp_packet then
    local element = parent:add(asx_securities_trade_ouch_v3_6.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = asx_securities_trade_ouch_v3_6_dissect.soup_bin_tcp_packet_fields(buffer, offset, packet, element, size_of_soup_bin_tcp_packet)
    element:set_len(size_of_soup_bin_tcp_packet)
    local display = asx_securities_trade_ouch_v3_6_display.soup_bin_tcp_packet(buffer, packet, element)
    element:append_text(display)
