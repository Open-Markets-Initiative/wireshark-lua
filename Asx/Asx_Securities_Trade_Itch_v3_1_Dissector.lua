...
asx_securities_trade_itch_v3_1.timestamp_nanoseconds = {}

-- Size: Timestamp Nanoseconds
asx_securities_trade_itch_v3_1.timestamp_nanoseconds.size = 4

-- Display: Timestamp Nanoseconds
asx_securities_trade_itch_v3_1.timestamp_nanoseconds.display = function(value)
  return "Timestamp Nanoseconds: "..value
end

-- Dissect: Timestamp Nanoseconds
asx_securities_trade_itch_v3_1.timestamp_nanoseconds.dissect = function(buffer, offset, packet, parent)
  local length = asx_securities_trade_itch_v3_1.timestamp_nanoseconds.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = asx_securities_trade_itch_v3_1.timestamp_nanoseconds.display(value, buffer, offset, packet, parent)
...
asx_securities_trade_itch_v3_1.payload.size = function(buffer, offset, message_type)
  ...
  if message_type == "T" then
    return asx_securities_trade_itch_v3_1.seconds_message.size(buffer, offset)
  end
  -- Size of Order Book Directory Message
  if message_type == "R" then
    return asx_securities_trade_itch_v3_1.order_book_directory_message.size(buffer, offset)
  end
  -- Size of Combination Order Book Directory Message
  if message_type == "M" then
    return asx_securities_trade_itch_v3_1.combination_order_book_directory_message.size(buffer, offset)
  end
  -- Size of Tick Size Table Entry Message
  if message_type == "L" then
    return asx_securities_trade_itch_v3_1.tick_size_table_entry_message.size(buffer, offset)
  end
  -- Size of System Event Message
  if message_type == "S" then
    return asx_securities_trade_itch_v3_1.system_event_message.size(buffer, offset)
  end
  -- Size of Order Book State Message
  if message_type == "O" then
    return asx_securities_trade_itch_v3_1.order_book_state_message.size(buffer, offset)
  end
  -- Size of Add Order No Participant Id Message
  if message_type == "A" then
    return asx_securities_trade_itch_v3_1.add_order_no_participant_id_message.size(buffer, offset)
  end
  -- Size of Add Order Participant Id Message
  if message_type == "F" then
    return asx_securities_trade_itch_v3_1.add_order_participant_id_message.size(buffer, offset)
  end
  -- Size of Order Executed Message
  if message_type == "E" then
    return asx_securities_trade_itch_v3_1.order_executed_message.size(buffer, offset)
  end
  -- Size of Order Executed With Price Message
  if message_type == "C" then
    return asx_securities_trade_itch_v3_1.order_executed_with_price_message.size(buffer, offset)
  end
  -- Size of Order Replace Message
  if message_type == "U" then
    return asx_securities_trade_itch_v3_1.order_replace_message.size(buffer, offset)
  end
  -- Size of Order Delete Message
  if message_type == "D" then
    return asx_securities_trade_itch_v3_1.order_delete_message.size(buffer, offset)
  end
  -- Size of Trade Message
  if message_type == "P" then
    return asx_securities_trade_itch_v3_1.trade_message.size(buffer, offset)
  end
  -- Size of Equilibrium Price Update Message
  if message_type == "Z" then
    return asx_securities_trade_itch_v3_1.equilibrium_price_update_message.size(buffer, offset)
  end
...
-- Display: Payload
asx_securities_trade_itch_v3_1.payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v3_1.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  local size = asx_securities_trade_itch_v3_1.payload.size(buffer, offset, message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = asx_securities_trade_itch_v3_1.payload.display(buffer, packet, parent)
...
asx_securities_trade_itch_v3_1.packet.dissect = function(buffer, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = asx_securities_trade_itch_v3_1.message.dissect(buffer, index, packet, parent, size_of_message, message_index)
  end
