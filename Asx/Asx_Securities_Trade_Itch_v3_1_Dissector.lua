...
-- Dissect: Message
asx_securities_trade_itch_v3_1_dissect.message = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if show.message then
    ...
    -- Skip element, add fields directly
    asx_securities_trade_itch_v3_1_dissect.message_fields(buffer, offset, packet, parent, size_of_message, message_index)
...
asx_securities_trade_itch_v3_1_dissect.packet = function(buffer, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = asx_securities_trade_itch_v3_1_dissect.message(buffer, index, packet, parent, size_of_message, message_index)
  end
