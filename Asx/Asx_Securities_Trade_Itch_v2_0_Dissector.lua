...
asx_securities_trade_itch_v2_0_display.equilibrium_price_update_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.equilibrium_price_update_message = function(buffer, offset, packet, parent)
  ...
  if show.equilibrium_price_update_message then
    local length = asx_securities_trade_itch_v2_0_size_of.equilibrium_price_update_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.equilibrium_price_update_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.equilibrium_price_update_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.equilibrium_price_update_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.trade_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.trade_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_message then
    local length = asx_securities_trade_itch_v2_0_size_of.trade_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.trade_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.trade_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.trade_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.order_delete_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.order_delete_message = function(buffer, offset, packet, parent)
  ...
  if show.order_delete_message then
    local length = asx_securities_trade_itch_v2_0_size_of.order_delete_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.order_delete_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.order_delete_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.order_delete_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.order_replace_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.order_replace_message = function(buffer, offset, packet, parent)
  ...
  if show.order_replace_message then
    local length = asx_securities_trade_itch_v2_0_size_of.order_replace_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.order_replace_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.order_replace_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.order_replace_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.order_executed_with_price_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.order_executed_with_price_message = function(buffer, offset, packet, parent)
  ...
  if show.order_executed_with_price_message then
    local length = asx_securities_trade_itch_v2_0_size_of.order_executed_with_price_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.order_executed_with_price_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.order_executed_with_price_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.order_executed_with_price_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.order_executed_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.order_executed_message = function(buffer, offset, packet, parent)
  ...
  if show.order_executed_message then
    local length = asx_securities_trade_itch_v2_0_size_of.order_executed_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.order_executed_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.order_executed_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.order_executed_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.add_order_participant_id_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.add_order_participant_id_message = function(buffer, offset, packet, parent)
  ...
  if show.add_order_participant_id_message then
    local length = asx_securities_trade_itch_v2_0_size_of.add_order_participant_id_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.add_order_participant_id_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.add_order_participant_id_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.add_order_participant_id_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.add_order_no_participant_id_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.add_order_no_participant_id_message = function(buffer, offset, packet, parent)
  ...
  if show.add_order_no_participant_id_message then
    local length = asx_securities_trade_itch_v2_0_size_of.add_order_no_participant_id_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.add_order_no_participant_id_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.add_order_no_participant_id_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.add_order_no_participant_id_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.order_book_state_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.order_book_state_message = function(buffer, offset, packet, parent)
  ...
  if show.order_book_state_message then
    local length = asx_securities_trade_itch_v2_0_size_of.order_book_state_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.order_book_state_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.order_book_state_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.order_book_state_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.system_event_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.system_event_message = function(buffer, offset, packet, parent)
  ...
  if show.system_event_message then
    local length = asx_securities_trade_itch_v2_0_size_of.system_event_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.system_event_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.system_event_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.system_event_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.tick_size_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.tick_size_message = function(buffer, offset, packet, parent)
  ...
  if show.tick_size_message then
    local length = asx_securities_trade_itch_v2_0_size_of.tick_size_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.tick_size_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.tick_size_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.tick_size_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.combination_order_book_directory_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.combination_order_book_directory_message = function(buffer, offset, packet, parent)
  ...
  if show.combination_order_book_directory_message then
    local length = asx_securities_trade_itch_v2_0_size_of.combination_order_book_directory_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.combination_order_book_directory_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.combination_order_book_directory_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.combination_order_book_directory_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.order_book_directory_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.order_book_directory_message = function(buffer, offset, packet, parent)
  ...
  if show.order_book_directory_message then
    local length = asx_securities_trade_itch_v2_0_size_of.order_book_directory_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.order_book_directory_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.order_book_directory_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.order_book_directory_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.seconds_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.seconds_message = function(buffer, offset, packet, parent)
  ...
  if show.seconds_message then
    local length = asx_securities_trade_itch_v2_0_size_of.seconds_message(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.seconds_message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.seconds_message, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.seconds_message_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_display.message_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    local length = asx_securities_trade_itch_v2_0_size_of.message_header(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.message_header(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.message_header, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.message_header_fields(buffer, offset, packet, parent)
end

-- Display: Message
asx_securities_trade_itch_v2_0_display.message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message
asx_securities_trade_itch_v2_0_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
asx_securities_trade_itch_v2_0_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  -- Optionally add struct element to protocol tree
  if show.message then
    local range = buffer(offset, size_of_message)
    local display = asx_securities_trade_itch_v2_0_display.message(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.message, range, display)
  end

  asx_securities_trade_itch_v2_0_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
asx_securities_trade_itch_v2_0_display.packet_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
asx_securities_trade_itch_v2_0_dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    local length = asx_securities_trade_itch_v2_0_size_of.packet_header(buffer, offset)
    local range = buffer(offset, length)
    local display = asx_securities_trade_itch_v2_0_display.packet_header(buffer, packet, parent)
    parent = parent:add(asx_securities_trade_itch_v2_0.fields.packet_header, range, display)
  end

  return asx_securities_trade_itch_v2_0_dissect.packet_header_fields(buffer, offset, packet, parent)
end
...
asx_securities_trade_itch_v2_0_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index = asx_securities_trade_itch_v2_0_dissect.message(buffer, index, packet, parent, size_of_message)
  end
