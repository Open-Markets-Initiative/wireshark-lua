...
ice_futures_mdf_impact_v1_1_33.fields.reserved2_bytes = ProtoField.new("Reserved2 Bytes", "ice.futures.mdf.impact.v1.1.33.reserved2bytes", ftypes.BYTES)
...
ice_futures_mdf_impact_v1_1_33.fields.timestamp = ProtoField.new("Timestamp", "ice.futures.mdf.impact.v1.1.33.timestamp", ftypes.UINT64)
...
dissect.reserved2_bytes = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_futures_mdf_impact_v1_1_33.fields.reserved2_bytes, range, value, display)
...
-- Register Ice Futures Mdf iMpact 1.1.33 Heuristic
