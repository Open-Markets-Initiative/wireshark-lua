...
ice_futures_mdf_impact_v1_1_34.fields.leg_body_length = ProtoField.new("Leg Body Length", "ice.futures.mdf.impact.v1.1.34.legbodylength", ftypes.UINT8)
...
ice_futures_mdf_impact_v1_1_34.fields.leg_market_id = ProtoField.new("Leg Market Id", "ice.futures.mdf.impact.v1.1.34.legmarketid", ftypes.UINT32)
ice_futures_mdf_impact_v1_1_34.fields.leg_ratio = ProtoField.new("Leg Ratio", "ice.futures.mdf.impact.v1.1.34.legratio", ftypes.UINT16)
ice_futures_mdf_impact_v1_1_34.fields.leg_ratio_price_denominator = ProtoField.new("Leg Ratio Price Denominator", "ice.futures.mdf.impact.v1.1.34.legratiopricedenominator", ftypes.UINT32)
ice_futures_mdf_impact_v1_1_34.fields.leg_ratio_price_numerator = ProtoField.new("Leg Ratio Price Numerator", "ice.futures.mdf.impact.v1.1.34.legratiopricenumerator", ftypes.UINT32)
ice_futures_mdf_impact_v1_1_34.fields.leg_ratio_qty_denominator = ProtoField.new("Leg Ratio Qty Denominator", "ice.futures.mdf.impact.v1.1.34.legratioqtydenominator", ftypes.UINT32)
ice_futures_mdf_impact_v1_1_34.fields.leg_ratio_qty_numerator = ProtoField.new("Leg Ratio Qty Numerator", "ice.futures.mdf.impact.v1.1.34.legratioqtynumerator", ftypes.UINT32)
...
ice_futures_mdf_impact_v1_1_34.fields.leg_strategy_code = ProtoField.new("Leg Strategy Code", "ice.futures.mdf.impact.v1.1.34.legstrategycode", ftypes.UINT16)
