...
dissect.valuation_date_applying_date = function(buffer, offset, packet, parent)
  local length = size_of.valuation_date_applying_date
  local range = buffer(offset, length)
  local value = range:string()
...
size_of.marker_index_prices = function(buffer, offset)
  local index = 0
  ...
  index = index + size_of.valuation_date_applying_date
...
dissect.marker_index_prices_fields = function(buffer, offset, packet, parent)
  ...
  index, valuation_date_applying_date = dissect.valuation_date_applying_date(buffer, index, packet, parent)
...
dissect.marker_index_prices = function(buffer, offset, packet, parent)
  ...
  if show.marker_index_prices then
    local length = size_of.marker_index_prices(buffer, offset)
    local range = buffer(offset, length)
...
dissect.reserved_field_1 = function(buffer, offset, packet, parent)
  local length = size_of.reserved_field_1
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
...
size_of.market_snapshot_message = function(buffer, offset)
  ...
  index = index + size_of.reserved_field_1
...
dissect.market_snapshot_message_fields = function(buffer, offset, packet, parent)
  ...
  index, reserved_field_1 = dissect.reserved_field_1(buffer, index, packet, parent)
...
size_of.payload = function(buffer, offset, message_type)
  ...
  if message_type == "z" then
    return size_of.marker_index_prices(buffer, offset)
  end
