...
ice_futures_mdf_impact_v1_1_34.fields.alt_high_price = ProtoField.new("Alt High Price", "ice.futures.mdf.impact.v1.1.34.althighprice", ftypes.INT64)
ice_futures_mdf_impact_v1_1_34.fields.alt_last_trade_price = ProtoField.new("Alt Last Trade Price", "ice.futures.mdf.impact.v1.1.34.altlasttradeprice", ftypes.INT64)
ice_futures_mdf_impact_v1_1_34.fields.alt_low_price = ProtoField.new("Alt Low Price", "ice.futures.mdf.impact.v1.1.34.altlowprice", ftypes.INT64)
ice_futures_mdf_impact_v1_1_34.fields.alt_price = ProtoField.new("Alt Price", "ice.futures.mdf.impact.v1.1.34.altprice", ftypes.INT64)
ice_futures_mdf_impact_v1_1_34.fields.alt_vwap = ProtoField.new("Alt Vwap", "ice.futures.mdf.impact.v1.1.34.altvwap", ftypes.INT64)
ice_futures_mdf_impact_v1_1_34.fields.aon = ProtoField.new("Aon", "ice.futures.mdf.impact.v1.1.34.aon", ftypes.STRING)
...
ice_futures_mdf_impact_v1_1_34.fields.hedge_body_length = ProtoField.new("Hedge Body Length", "ice.futures.mdf.impact.v1.1.34.hedgebodylength", ftypes.INT8)
...
ice_futures_mdf_impact_v1_1_34.fields.hedge_delta = ProtoField.new("Hedge Delta", "ice.futures.mdf.impact.v1.1.34.hedgedelta", ftypes.INT16)
ice_futures_mdf_impact_v1_1_34.fields.hedge_market_id = ProtoField.new("Hedge Market Id", "ice.futures.mdf.impact.v1.1.34.hedgemarketid", ftypes.INT32)
...
ice_futures_mdf_impact_v1_1_34.fields.hedge_price = ProtoField.new("Hedge Price", "ice.futures.mdf.impact.v1.1.34.hedgeprice", ftypes.INT64)
...
ice_futures_mdf_impact_v1_1_34.fields.hedge_strategy_code = ProtoField.new("Hedge Strategy Code", "ice.futures.mdf.impact.v1.1.34.hedgestrategycode", ftypes.INT16)
...
ice_futures_mdf_impact_v1_1_34.fields.leg_underlying_market_id = ProtoField.new("Leg Underlying Market Id", "ice.futures.mdf.impact.v1.1.34.legunderlyingmarketid", ftypes.INT32)
...
ice_futures_mdf_impact_v1_1_34.fields.number_of_msgs = ProtoField.new("Number Of Msgs", "ice.futures.mdf.impact.v1.1.34.numberofmsgs", ftypes.UINT16)
...
ice_futures_mdf_impact_v1_1_34.fields.send_datetime = ProtoField.new("Send Datetime", "ice.futures.mdf.impact.v1.1.34.senddatetime", ftypes.UINT64)
...
ice_futures_mdf_impact_v1_1_34.fields.special_field_id = ProtoField.new("Special Field Id", "ice.futures.mdf.impact.v1.1.34.specialfieldid", ftypes.INT8)
ice_futures_mdf_impact_v1_1_34.fields.special_field_length = ProtoField.new("Special Field Length", "ice.futures.mdf.impact.v1.1.34.specialfieldlength", ftypes.INT16)
...
ice_futures_mdf_impact_v1_1_34.fields.valuation_date_applying_date = ProtoField.new("Valuation Date Applying Date", "ice.futures.mdf.impact.v1.1.34.valuationdateapplyingdate", ftypes.STRING)
...
ice_futures_mdf_impact_v1_1_34.fields.variable_field = ProtoField.new("Variable Field", "ice.futures.mdf.impact.v1.1.34.variablefield", ftypes.STRING)
...
ice_futures_mdf_impact_v1_1_34.prefs.show_variable_field = Pref.bool("Show Variable Field", show.variable_field, "Parse and add Variable Field to protocol tree")
...
function ice_futures_mdf_impact_v1_1_34.prefs_changed()
  ...
  if show.variable_field ~= ice_futures_mdf_impact_v1_1_34.prefs.show_variable_field then
    show.variable_field = ice_futures_mdf_impact_v1_1_34.prefs.show_variable_field
    changed = true
  end
...
ice_futures_mdf_impact_v1_1_34_display.old_style_options_trade_and_market_stats_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.option_settlement_price_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.option_open_interest_message = function(packet, parent, length)
  return ""
end
...
-- Display: Rfq Message
ice_futures_mdf_impact_v1_1_34_display.rfq_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.new_options_market_definition_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.hedge_definition = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Hedge Definition
ice_futures_mdf_impact_v1_1_34_dissect.hedge_definition_fields = function(buffer, offset, packet, parent, hedge_definition_index)
  local index = offset

  -- Implicit Hedge Definition Index
  if hedge_definition_index ~= nil then
    local iteration = parent:add(ice_futures_mdf_impact_v1_1_34.fields.hedge_definition_index, hedge_definition_index)
...
ice_futures_mdf_impact_v1_1_34_dissect.hedge_definition = function(buffer, offset, packet, parent, hedge_definition_index)
  if show.hedge_definition then
    -- Optionally add element to protocol tree
    parent = parent:add(ice_futures_mdf_impact_v1_1_34.fields.hedge_definition, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_34_dissect.hedge_definition_fields(buffer, offset, packet, parent, hedge_definition_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return ice_futures_mdf_impact_v1_1_34_dissect.hedge_definition_fields(buffer, offset, packet, parent, hedge_definition_index)
  end
end
...
ice_futures_mdf_impact_v1_1_34_display.strategy_leg_definition = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Leg Definition
ice_futures_mdf_impact_v1_1_34_dissect.strategy_leg_definition_fields = function(buffer, offset, packet, parent, strategy_leg_definition_index)
  local index = offset

  -- Implicit Strategy Leg Definition Index
  if strategy_leg_definition_index ~= nil then
    local iteration = parent:add(ice_futures_mdf_impact_v1_1_34.fields.strategy_leg_definition_index, strategy_leg_definition_index)
    iteration:set_generated()
  end
...
ice_futures_mdf_impact_v1_1_34_dissect.strategy_leg_definition = function(buffer, offset, packet, parent, strategy_leg_definition_index)
  if show.strategy_leg_definition then
    ...
    local index = ice_futures_mdf_impact_v1_1_34_dissect.strategy_leg_definition_fields(buffer, offset, packet, parent, strategy_leg_definition_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return ice_futures_mdf_impact_v1_1_34_dissect.strategy_leg_definition_fields(buffer, offset, packet, parent, strategy_leg_definition_index)
  end
end
...
ice_futures_mdf_impact_v1_1_34_display.new_options_strategy_definition_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_dissect.new_options_strategy_definition_message_fields = function(buffer, offset, packet, parent)
  ...
  for strategy_leg_definition_index = 1, number_of_strategy_leg_definitions do
    index, strategy_leg_definition = ice_futures_mdf_impact_v1_1_34_dissect.strategy_leg_definition(buffer, index, packet, parent, strategy_leg_definition_index)
  end
  ...
  for hedge_definition_index = 1, number_of_hedge_definitions do
    index, hedge_definition = ice_futures_mdf_impact_v1_1_34_dissect.hedge_definition(buffer, index, packet, parent, hedge_definition_index)
  end
...
ice_futures_mdf_impact_v1_1_34_display.delete_price_level_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.change_price_level_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.add_price_level_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.market_snapshot_price_level_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.transaction_end_marker_for_empty_last_bundle_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.fixing_indicative_price_message_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.fixing_lockdown_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.fixing_transition_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.message_bundle_marker = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.delete_order_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.add_or_modify_order_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.market_snapshot_order_message = function(packet, parent, length)
  return ""
end
...
-- Size: Aon
ice_futures_mdf_impact_v1_1_34_size_of.aon = 1

-- Display: Aon
ice_futures_mdf_impact_v1_1_34_display.aon = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Aon: No Value"
  end
...
-- Dissect: Aon
ice_futures_mdf_impact_v1_1_34_dissect.aon = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.aon
  local range = buffer(offset, length)
  ...
  local display = ice_futures_mdf_impact_v1_1_34_display.aon(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.aon, range, value, display)

  return offset + length, value
end

-- Size: Alt Last Trade Price
ice_futures_mdf_impact_v1_1_34_size_of.alt_last_trade_price = 8

-- Display: Alt Last Trade Price
ice_futures_mdf_impact_v1_1_34_display.alt_last_trade_price = function(value)
  return "Alt Last Trade Price: "..value
end

-- Dissect: Alt Last Trade Price
ice_futures_mdf_impact_v1_1_34_dissect.alt_last_trade_price = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.alt_last_trade_price
  local range = buffer(offset, length)
  local value = range:int64()
  local display = ice_futures_mdf_impact_v1_1_34_display.alt_last_trade_price(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.alt_last_trade_price, range, value, display)

  return offset + length, value
end

-- Size: Alt Vwap
ice_futures_mdf_impact_v1_1_34_size_of.alt_vwap = 8

-- Display: Alt Vwap
ice_futures_mdf_impact_v1_1_34_display.alt_vwap = function(value)
  return "Alt Vwap: "..value
end

-- Dissect: Alt Vwap
ice_futures_mdf_impact_v1_1_34_dissect.alt_vwap = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.alt_vwap
  local range = buffer(offset, length)
  local value = range:int64()
  local display = ice_futures_mdf_impact_v1_1_34_display.alt_vwap(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.alt_vwap, range, value, display)

  return offset + length, value
end

-- Size: Alt Low Price
ice_futures_mdf_impact_v1_1_34_size_of.alt_low_price = 8

-- Display: Alt Low Price
ice_futures_mdf_impact_v1_1_34_display.alt_low_price = function(value)
  return "Alt Low Price: "..value
end

-- Dissect: Alt Low Price
ice_futures_mdf_impact_v1_1_34_dissect.alt_low_price = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.alt_low_price
  local range = buffer(offset, length)
  local value = range:int64()
  local display = ice_futures_mdf_impact_v1_1_34_display.alt_low_price(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.alt_low_price, range, value, display)

  return offset + length, value
end

-- Size: Alt High Price
ice_futures_mdf_impact_v1_1_34_size_of.alt_high_price = 8

-- Display: Alt High Price
ice_futures_mdf_impact_v1_1_34_display.alt_high_price = function(value)
  return "Alt High Price: "..value
end

-- Dissect: Alt High Price
ice_futures_mdf_impact_v1_1_34_dissect.alt_high_price = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.alt_high_price
  local range = buffer(offset, length)
  local value = range:int64()
  local display = ice_futures_mdf_impact_v1_1_34_display.alt_high_price(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.alt_high_price, range, value, display)

  return offset + length, value
end

-- Size: Alt Price
ice_futures_mdf_impact_v1_1_34_size_of.alt_price = 8

-- Display: Alt Price
ice_futures_mdf_impact_v1_1_34_display.alt_price = function(value)
  return "Alt Price: "..value
end

-- Dissect: Alt Price
ice_futures_mdf_impact_v1_1_34_dissect.alt_price = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.alt_price
  local range = buffer(offset, length)
  local value = range:int64()
  local display = ice_futures_mdf_impact_v1_1_34_display.alt_price(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.alt_price, range, value, display)

  return offset + length, value
end

-- Calculate runtime size of: Variable Field
ice_futures_mdf_impact_v1_1_34_size_of.variable_field = function(buffer, offset, special_field_id)
  -- Size of Alt Price
  if special_field_id == 1 then
    return ice_futures_mdf_impact_v1_1_34_size_of.alt_price(buffer, offset)
  end
  -- Size of Alt High Price
  if special_field_id == 2 then
    return ice_futures_mdf_impact_v1_1_34_size_of.alt_high_price(buffer, offset)
  end
  -- Size of Alt Low Price
  if special_field_id == 3 then
    return ice_futures_mdf_impact_v1_1_34_size_of.alt_low_price(buffer, offset)
  end
  -- Size of Alt Vwap
  if special_field_id == 4 then
    return ice_futures_mdf_impact_v1_1_34_size_of.alt_vwap(buffer, offset)
  end
  -- Size of Alt Last Trade Price
  if special_field_id == 5 then
    return ice_futures_mdf_impact_v1_1_34_size_of.alt_last_trade_price(buffer, offset)
  end
  -- Size of Aon
  if special_field_id == 6 then
    return ice_futures_mdf_impact_v1_1_34_size_of.aon(buffer, offset)
  end
...
ice_futures_mdf_impact_v1_1_34_display.variable_field = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Variable Field
ice_futures_mdf_impact_v1_1_34_dissect.variable_field_branches = function(buffer, offset, packet, parent, special_field_id)
  -- Dissect Alt Price
  if special_field_id == 1 then
    return ice_futures_mdf_impact_v1_1_34_dissect.alt_price(buffer, offset, packet, parent)
  end
  -- Dissect Alt High Price
  if special_field_id == 2 then
    return ice_futures_mdf_impact_v1_1_34_dissect.alt_high_price(buffer, offset, packet, parent)
  end
  -- Dissect Alt Low Price
  if special_field_id == 3 then
    return ice_futures_mdf_impact_v1_1_34_dissect.alt_low_price(buffer, offset, packet, parent)
  end
  -- Dissect Alt Vwap
  if special_field_id == 4 then
    return ice_futures_mdf_impact_v1_1_34_dissect.alt_vwap(buffer, offset, packet, parent)
  end
  -- Dissect Alt Last Trade Price
  if special_field_id == 5 then
    return ice_futures_mdf_impact_v1_1_34_dissect.alt_last_trade_price(buffer, offset, packet, parent)
  end
  -- Dissect Aon
  if special_field_id == 6 then
    return ice_futures_mdf_impact_v1_1_34_dissect.aon(buffer, offset, packet, parent)
  end
...
ice_futures_mdf_impact_v1_1_34_dissect.variable_field = function(buffer, offset, packet, parent, special_field_id)
  if not show.variable_field then
    return ice_futures_mdf_impact_v1_1_34_dissect.variable_field_branches(buffer, offset, packet, parent, special_field_id)
  end

  -- Calculate size and check that branch is not empty
  local size = ice_futures_mdf_impact_v1_1_34_size_of.variable_field(buffer, offset, special_field_id)
  if size == 0 then
    return offset
  end
  ...
  local display = ice_futures_mdf_impact_v1_1_34_display.variable_field(buffer, packet, parent)
  local element = parent:add(ice_futures_mdf_impact_v1_1_34.fields.variable_field, range, display)
...
ice_futures_mdf_impact_v1_1_34_display.special_field = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Special Field
ice_futures_mdf_impact_v1_1_34_dissect.special_field_fields = function(buffer, offset, packet, parent, special_field_index)
  local index = offset

  -- Implicit Special Field Index
  if special_field_index ~= nil then
    local iteration = parent:add(ice_futures_mdf_impact_v1_1_34.fields.special_field_index, special_field_index)
    iteration:set_generated()
  end
  ...
  index = ice_futures_mdf_impact_v1_1_34_dissect.variable_field(buffer, index, packet, parent, special_field_id)
...
ice_futures_mdf_impact_v1_1_34_display.special_field_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_dissect.special_field_message_fields = function(buffer, offset, packet, parent)
  ...
  for special_field_index = 1, number_of_special_fields do
    index, special_field = ice_futures_mdf_impact_v1_1_34_dissect.special_field(buffer, index, packet, parent, special_field_index)
  end
...
ice_futures_mdf_impact_v1_1_34_display.new_expiry_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.leg_definition = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Leg Definition
ice_futures_mdf_impact_v1_1_34_dissect.leg_definition_fields = function(buffer, offset, packet, parent, leg_definition_index)
  local index = offset

  -- Implicit Leg Definition Index
  if leg_definition_index ~= nil then
    local iteration = parent:add(ice_futures_mdf_impact_v1_1_34.fields.leg_definition_index, leg_definition_index)
    iteration:set_generated()
  end
...
ice_futures_mdf_impact_v1_1_34_dissect.leg_definition = function(buffer, offset, packet, parent, leg_definition_index)
  if show.leg_definition then
    -- Optionally add element to protocol tree
    parent = parent:add(ice_futures_mdf_impact_v1_1_34.fields.leg_definition, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_34_dissect.leg_definition_fields(buffer, offset, packet, parent, leg_definition_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return ice_futures_mdf_impact_v1_1_34_dissect.leg_definition_fields(buffer, offset, packet, parent, leg_definition_index)
  end
end
...
ice_futures_mdf_impact_v1_1_34_display.new_futures_strategy_definition_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_dissect.new_futures_strategy_definition_message_fields = function(buffer, offset, packet, parent)
  ...
  for leg_definition_index = 1, number_of_leg_definitions do
    index, leg_definition = ice_futures_mdf_impact_v1_1_34_dissect.leg_definition(buffer, index, packet, parent, leg_definition_index)
  end
...
ice_futures_mdf_impact_v1_1_34_display.interval_price_limit_notification_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.strip_info_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.pre_open_price_indicator_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.market_event_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.end_of_day_market_summary_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_size_of.valuation_date_applying_date = 10

-- Display: Valuation Date Applying Date
ice_futures_mdf_impact_v1_1_34_display.valuation_date_applying_date = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
ice_futures_mdf_impact_v1_1_34_dissect.valuation_date_applying_date = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.valuation_date_applying_date
  local range = buffer(offset, length)
  ...
  local display = ice_futures_mdf_impact_v1_1_34_display.valuation_date_applying_date(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.valuation_date_applying_date, range, value, display)
...
ice_futures_mdf_impact_v1_1_34_size_of.index_prices_message = function(buffer, offset)
  ...
  index = index + ice_futures_mdf_impact_v1_1_34_size_of.valuation_date_applying_date
...
ice_futures_mdf_impact_v1_1_34_display.index_prices_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_dissect.index_prices_message_fields = function(buffer, offset, packet, parent)
  ...
  index, valuation_date_applying_date = ice_futures_mdf_impact_v1_1_34_dissect.valuation_date_applying_date(buffer, index, packet, parent)
...
ice_futures_mdf_impact_v1_1_34_display.settlement_price_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.close_price_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.open_price_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.open_interest_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.system_text_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.market_state_change_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.market_statistics_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.cancelled_trade_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.investigated_trade_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.spot_market_trade_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.trade_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.market_snapshot_message = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_display.message_header = function(packet, parent, length)
  return ""
end
...
-- Display: Message
ice_futures_mdf_impact_v1_1_34_display.message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
ice_futures_mdf_impact_v1_1_34_dissect.message_fields = function(buffer, offset, packet, parent, message_index)
  local index = offset

  -- Implicit Message Index
  if message_index ~= nil then
    local iteration = parent:add(ice_futures_mdf_impact_v1_1_34.fields.message_index, message_index)
    iteration:set_generated()
  end
...
-- Size: Send Datetime
ice_futures_mdf_impact_v1_1_34_size_of.send_datetime = 8

-- Display: Send Datetime
ice_futures_mdf_impact_v1_1_34_display.send_datetime = function(value)
  -- Parse unix timestamp
  local seconds = math.floor(value:tonumber()/1000)
  local milliseconds = value:tonumber()%1000
...
ice_futures_mdf_impact_v1_1_34_dissect.send_datetime = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.send_datetime
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = ice_futures_mdf_impact_v1_1_34_display.send_datetime(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.send_datetime, range, value, display)

  return offset + length, value
end

-- Size: Number Of Msgs
ice_futures_mdf_impact_v1_1_34_size_of.number_of_msgs = 2

-- Display: Number Of Msgs
ice_futures_mdf_impact_v1_1_34_display.number_of_msgs = function(value)
  return "Number Of Msgs: "..value
end

-- Dissect: Number Of Msgs
ice_futures_mdf_impact_v1_1_34_dissect.number_of_msgs = function(buffer, offset, packet, parent)
  local length = ice_futures_mdf_impact_v1_1_34_size_of.number_of_msgs
  local range = buffer(offset, length)
  local value = range:uint()
  local display = ice_futures_mdf_impact_v1_1_34_display.number_of_msgs(value, buffer, offset, packet, parent)

  parent:add(ice_futures_mdf_impact_v1_1_34.fields.number_of_msgs, range, value, display)
...
ice_futures_mdf_impact_v1_1_34_size_of.packet_header = function(buffer, offset)
  ...
  index = index + ice_futures_mdf_impact_v1_1_34_size_of.number_of_msgs

  index = index + ice_futures_mdf_impact_v1_1_34_size_of.send_datetime

  return index
end

-- Display: Packet Header
ice_futures_mdf_impact_v1_1_34_display.packet_header = function(packet, parent, length)
  return ""
end
...
ice_futures_mdf_impact_v1_1_34_dissect.packet_header_fields = function(buffer, offset, packet, parent)
  ...
  index, number_of_msgs = ice_futures_mdf_impact_v1_1_34_dissect.number_of_msgs(buffer, index, packet, parent)

  -- Send Datetime: 8 Byte Unsigned Fixed Width Integer
  index, send_datetime = ice_futures_mdf_impact_v1_1_34_dissect.send_datetime(buffer, index, packet, parent)
...
ice_futures_mdf_impact_v1_1_34_dissect.packet = function(buffer, packet, parent)
  ...
  for message_index = 1, number_of_msgs do
    index, message = ice_futures_mdf_impact_v1_1_34_dissect.message(buffer, index, packet, parent, message_index)
  end
