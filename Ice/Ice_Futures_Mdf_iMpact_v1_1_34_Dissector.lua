...
omi_ice_futures_mdf_impact_v1_1_34.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_34.prefs.show_leg_definition_index = Pref.bool("Show Leg Definition Index", show.leg_definition_index, "Show generated leg definition index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_34.prefs.show_special_field_index = Pref.bool("Show Special Field Index", show.special_field_index, "Show generated special field index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_34.prefs.show_strategy_leg_definition_index = Pref.bool("Show Strategy Leg Definition Index", show.strategy_leg_definition_index, "Show generated strategy leg definition index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_34.prefs.show_hedge_definition_index = Pref.bool("Show Hedge Definition Index", show.hedge_definition_index, "Show generated hedge definition index in protocol tree")
...
function omi_ice_futures_mdf_impact_v1_1_34.prefs_changed()
  ...
  if show.message_index ~= omi_ice_futures_mdf_impact_v1_1_34.prefs.show_message_index then
    show.message_index = omi_ice_futures_mdf_impact_v1_1_34.prefs.show_message_index
  end
  if show.leg_definition_index ~= omi_ice_futures_mdf_impact_v1_1_34.prefs.show_leg_definition_index then
    show.leg_definition_index = omi_ice_futures_mdf_impact_v1_1_34.prefs.show_leg_definition_index
  end
  if show.special_field_index ~= omi_ice_futures_mdf_impact_v1_1_34.prefs.show_special_field_index then
    show.special_field_index = omi_ice_futures_mdf_impact_v1_1_34.prefs.show_special_field_index
  end
  if show.strategy_leg_definition_index ~= omi_ice_futures_mdf_impact_v1_1_34.prefs.show_strategy_leg_definition_index then
    show.strategy_leg_definition_index = omi_ice_futures_mdf_impact_v1_1_34.prefs.show_strategy_leg_definition_index
  end
  if show.hedge_definition_index ~= omi_ice_futures_mdf_impact_v1_1_34.prefs.show_hedge_definition_index then
    show.hedge_definition_index = omi_ice_futures_mdf_impact_v1_1_34.prefs.show_hedge_definition_index
  end
end
...
ice_futures_mdf_impact_v1_1_34.new_options_strategy_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_34.new_options_strategy_definition_message.display(packet, parent, length)
    parent:append_text(display)
...
ice_futures_mdf_impact_v1_1_34.special_field.dissect = function(buffer, offset, packet, parent, special_field_index)
  if show.special_field then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_ice_futures_mdf_impact_v1_1_34.fields.special_field, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_34.special_field.fields(buffer, offset, packet, parent, special_field_index)
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_34.special_field.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return ice_futures_mdf_impact_v1_1_34.special_field.fields(buffer, offset, packet, parent, special_field_index)
  end
end
...
ice_futures_mdf_impact_v1_1_34.special_field_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_34.special_field_message.display(packet, parent, length)
    parent:append_text(display)
...
ice_futures_mdf_impact_v1_1_34.new_futures_strategy_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_34.new_futures_strategy_definition_message.display(packet, parent, length)
    parent:append_text(display)
...
-- Dissect: Message
ice_futures_mdf_impact_v1_1_34.message.dissect = function(buffer, offset, packet, parent, message_index)
  if show.message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_ice_futures_mdf_impact_v1_1_34.fields.message, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_34.message.fields(buffer, offset, packet, parent, message_index)
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_34.message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return ice_futures_mdf_impact_v1_1_34.message.fields(buffer, offset, packet, parent, message_index)
  end
end
...
ice_futures_mdf_impact_v1_1_34.packet.requiredsize = function(buffer)
  return buffer:len() >= ice_futures_mdf_impact_v1_1_34.packet_header.size
end
...
-- Dissector Heuristic for Ice Futures Mdf iMpact 1.1.34 (Udp)
local function omi_ice_futures_mdf_impact_v1_1_34_udp_heuristic(buffer, packet, parent)
...
omi_ice_futures_mdf_impact_v1_1_34:register_heuristic("udp", omi_ice_futures_mdf_impact_v1_1_34_udp_heuristic)
