...
ice_mdf_impact_v1_1_33.fields.agg_bid_qty = ProtoField.new("Agg Bid Qty", "ice.mdf.impact.v1.1.33.aggbidqty", ftypes.INT32)
ice_mdf_impact_v1_1_33.fields.agg_offer_qty = ProtoField.new("Agg Offer Qty", "ice.mdf.impact.v1.1.33.aggofferqty", ftypes.INT32)
...
ice_mdf_impact_v1_1_33.fields.auction_date = ProtoField.new("Auction Date", "ice.mdf.impact.v1.1.33.auctiondate", ftypes.STRING)
...
ice_mdf_impact_v1_1_33.fields.eur_price = ProtoField.new("Eur Price", "ice.mdf.impact.v1.1.33.eurprice", ftypes.INT64)
ice_mdf_impact_v1_1_33.fields.event_code = ProtoField.new("Event Code", "ice.mdf.impact.v1.1.33.eventcode", ftypes.STRING)
...
ice_mdf_impact_v1_1_33.fields.extra_flags = ProtoField.new("Extra Flags", "ice.mdf.impact.v1.1.33.extraflags", ftypes.INT8)
ice_mdf_impact_v1_1_33.fields.fixing_indicative_price_message_message = ProtoField.new("Fixing Indicative Price Message Message", "ice.mdf.impact.v1.1.33.fixingindicativepricemessagemessage", ftypes.STRING)
...
ice_mdf_impact_v1_1_33.fields.gbp_price = ProtoField.new("Gbp Price", "ice.mdf.impact.v1.1.33.gbpprice", ftypes.INT64)
...
ice_mdf_impact_v1_1_33.fields.investigation_status = ProtoField.new("Investigation Status", "ice.mdf.impact.v1.1.33.investigationstatus", ftypes.STRING)
...
ice_mdf_impact_v1_1_33.fields.num_decimals_price = ProtoField.new("Num Decimals Price", "ice.mdf.impact.v1.1.33.numdecimalsprice", ftypes.INT8)
ice_mdf_impact_v1_1_33.fields.num_decimals_price_in_gram = ProtoField.new("Num Decimals Price In Gram", "ice.mdf.impact.v1.1.33.numdecimalspriceingram", ftypes.INT8)
...
ice_mdf_impact_v1_1_33.fields.number_of_hedge_definitions = ProtoField.new("Number Of Hedge Definitions", "ice.mdf.impact.v1.1.33.numberofhedgedefinitions", ftypes.INT8)
ice_mdf_impact_v1_1_33.fields.number_of_leg_definitions = ProtoField.new("Number Of Leg Definitions", "ice.mdf.impact.v1.1.33.numberoflegdefinitions", ftypes.INT8)
ice_mdf_impact_v1_1_33.fields.number_of_special_fields = ProtoField.new("Number Of Special Fields", "ice.mdf.impact.v1.1.33.numberofspecialfields", ftypes.INT8)
ice_mdf_impact_v1_1_33.fields.number_of_strategy_leg_definitions = ProtoField.new("Number Of Strategy Leg Definitions", "ice.mdf.impact.v1.1.33.numberofstrategylegdefinitions", ftypes.INT8)
...
ice_mdf_impact_v1_1_33.fields.off_market_trade_indicator = ProtoField.new("Off Market Trade Indicator", "ice.mdf.impact.v1.1.33.offmarkettradeindicator", ftypes.STRING)
...
ice_mdf_impact_v1_1_33.fields.price_level_position = ProtoField.new("Price Level Position", "ice.mdf.impact.v1.1.33.pricelevelposition", ftypes.INT8)
...
ice_mdf_impact_v1_1_33.fields.reserved_bytes_4 = ProtoField.new("Reserved Bytes 4", "ice.mdf.impact.v1.1.33.reservedbytes4", ftypes.INT32)
...
ice_mdf_impact_v1_1_33.fields.threshold_imbalance_qty = ProtoField.new("Threshold Imbalance Qty", "ice.mdf.impact.v1.1.33.thresholdimbalanceqty", ftypes.INT32)
...
ice_mdf_impact_v1_1_33.fields.total_volume = ProtoField.new("Total Volume", "ice.mdf.impact.v1.1.33.totalvolume", ftypes.INT32)
...
ice_mdf_impact_v1_1_33.fields.usd_price = ProtoField.new("Usd Price", "ice.mdf.impact.v1.1.33.usdprice", ftypes.INT64)
...
ice_mdf_impact_v1_1_33.prefs.show_fixing_indicative_price_message_message = Pref.bool("Show Fixing Indicative Price Message Message", show.fixing_indicative_price_message_message, "Parse and add Fixing Indicative Price Message Message to protocol tree")
...
function ice_mdf_impact_v1_1_33.prefs_changed()
  ...
  if show.fixing_indicative_price_message_message ~= ice_mdf_impact_v1_1_33.prefs.show_fixing_indicative_price_message_message then
    show.fixing_indicative_price_message_message = ice_mdf_impact_v1_1_33.prefs.show_fixing_indicative_price_message_message
    changed = true
  end
...
dissect.total_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.total_volume, range, value, display)
...
dissect.event_code = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.event_code, range, value, display)
...
dissect.off_market_trade_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.off_market_trade_indicator, range, value, display)
...
dissect.fixing_indicative_price_message_message = function(buffer, offset, packet, parent)
  ...
  if show.fixing_indicative_price_message_message then
    ...
    parent = parent:add(ice_mdf_impact_v1_1_33.fields.fixing_indicative_price_message_message, range, display)
  end
...
dissect.eur_price = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.eur_price, range, value, display)
...
dissect.gbp_price = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.gbp_price, range, value, display)
...
dissect.usd_price = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.usd_price, range, value, display)
...
dissect.agg_offer_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.agg_offer_qty, range, value, display)
...
dissect.agg_bid_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.agg_bid_qty, range, value, display)
...
dissect.auction_date = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.auction_date, range, value, display)
...
dissect.threshold_imbalance_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.threshold_imbalance_qty, range, value, display)
...
dissect.reserved_bytes_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.reserved_bytes_4, range, value, display)
...
dissect.investigation_status = function(buffer, offset, packet, parent)
  ...
  parent:add(ice_mdf_impact_v1_1_33.fields.investigation_status, range, value, display)
