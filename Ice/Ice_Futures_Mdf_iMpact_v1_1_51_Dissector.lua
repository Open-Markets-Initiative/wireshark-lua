...
omi_ice_futures_mdf_impact_v1_1_51.fields.has_no_direct_outright_originator = ProtoField.new("Has No Direct Outright Originator", "ice.futures.mdf.impact.v1.1.51.hasnodirectoutrightoriginator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_ice_futures_mdf_impact_v1_1_51.fields.has_no_direct_outright_taker = ProtoField.new("Has No Direct Outright Taker", "ice.futures.mdf.impact.v1.1.51.hasnodirectoutrighttaker", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_ice_futures_mdf_impact_v1_1_51.fields.is_leg_deal_outside_ipl = ProtoField.new("Is Leg Deal Outside Ipl", "ice.futures.mdf.impact.v1.1.51.islegdealoutsideipl", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
omi_ice_futures_mdf_impact_v1_1_51.fields.is_modify_order = ProtoField.new("Is Modify Order", "ice.futures.mdf.impact.v1.1.51.ismodifyorder", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_ice_futures_mdf_impact_v1_1_51.fields.is_option_strategy_hedge = ProtoField.new("Is Option Strategy Hedge", "ice.futures.mdf.impact.v1.1.51.isoptionstrategyhedge", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
omi_ice_futures_mdf_impact_v1_1_51.fields.is_rfc_crossing = ProtoField.new("Is Rfc Crossing", "ice.futures.mdf.impact.v1.1.51.isrfccrossing", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_ice_futures_mdf_impact_v1_1_51.fields.is_vertical_split = ProtoField.new("Is Vertical Split", "ice.futures.mdf.impact.v1.1.51.isverticalsplit", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_ice_futures_mdf_impact_v1_1_51.fields.unused_2 = ProtoField.new("Unused 2", "ice.futures.mdf.impact.v1.1.51.unused2", ftypes.UINT8, nil, base.DEC, 0x03)
omi_ice_futures_mdf_impact_v1_1_51.fields.unused_7 = ProtoField.new("Unused 7", "ice.futures.mdf.impact.v1.1.51.unused7", ftypes.UINT8, nil, base.DEC, 0x7F)
...
-- Ice Futures iMpact Mdf 1.1.51 Application Messages
...
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_leg_definition_index = Pref.bool("Show Leg Definition Index", show.leg_definition_index, "Show generated leg definition index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_extra_leg_definition_index = Pref.bool("Show Extra Leg Definition Index", show.extra_leg_definition_index, "Show generated extra leg definition index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_special_field_index = Pref.bool("Show Special Field Index", show.special_field_index, "Show generated special field index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_strategy_leg_definition_index = Pref.bool("Show Strategy Leg Definition Index", show.strategy_leg_definition_index, "Show generated strategy leg definition index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_hedge_definition_index = Pref.bool("Show Hedge Definition Index", show.hedge_definition_index, "Show generated hedge definition index in protocol tree")
omi_ice_futures_mdf_impact_v1_1_51.prefs.show_extra_strategy_leg_definition_index = Pref.bool("Show Extra Strategy Leg Definition Index", show.extra_strategy_leg_definition_index, "Show generated extra strategy leg definition index in protocol tree")

-- Handle changed preferences
function omi_ice_futures_mdf_impact_v1_1_51.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_application_messages then
    show.application_messages = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_message_index then
    show.message_index = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_message_index
  end
  if show.leg_definition_index ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_leg_definition_index then
    show.leg_definition_index = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_leg_definition_index
  end
  if show.extra_leg_definition_index ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_extra_leg_definition_index then
    show.extra_leg_definition_index = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_extra_leg_definition_index
  end
  if show.special_field_index ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_special_field_index then
    show.special_field_index = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_special_field_index
  end
  if show.strategy_leg_definition_index ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_strategy_leg_definition_index then
    show.strategy_leg_definition_index = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_strategy_leg_definition_index
  end
  if show.hedge_definition_index ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_hedge_definition_index then
    show.hedge_definition_index = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_hedge_definition_index
  end
  if show.extra_strategy_leg_definition_index ~= omi_ice_futures_mdf_impact_v1_1_51.prefs.show_extra_strategy_leg_definition_index then
    show.extra_strategy_leg_definition_index = omi_ice_futures_mdf_impact_v1_1_51.prefs.show_extra_strategy_leg_definition_index
  end
end
...
ice_futures_mdf_impact_v1_1_51.modify_flags.bits = function(range, value, packet, parent)

  -- Unused 7: 7 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.unused_7, range, value)

  -- Is Modify Order: 1 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.is_modify_order, range, value)
end

-- Dissect: Modify Flags
ice_futures_mdf_impact_v1_1_51.modify_flags.dissect = function(buffer, offset, packet, parent)
  local size = ice_futures_mdf_impact_v1_1_51.modify_flags.size
  local range = buffer(offset, size)
  local value = range:uint()
  local display = ice_futures_mdf_impact_v1_1_51.modify_flags.display(range, value, packet, parent)
  local element = parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.modify_flags, range, display)

  if show.modify_flags then
    ice_futures_mdf_impact_v1_1_51.modify_flags.bits(range, value, packet, element)
  end
...
ice_futures_mdf_impact_v1_1_51.new_options_strategy_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.new_options_strategy_definition_message, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_51.new_options_strategy_definition_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_51.new_options_strategy_definition_message.display(packet, parent, length)
    parent:append_text(display)
...
ice_futures_mdf_impact_v1_1_51.special_field.dissect = function(buffer, offset, packet, parent, special_field_index)
  if show.special_field then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.special_field, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_51.special_field.fields(buffer, offset, packet, parent, special_field_index)
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_51.special_field.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return ice_futures_mdf_impact_v1_1_51.special_field.fields(buffer, offset, packet, parent, special_field_index)
  end
end
...
ice_futures_mdf_impact_v1_1_51.special_field_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.special_field_message, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_51.special_field_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_51.special_field_message.display(packet, parent, length)
    parent:append_text(display)
...
ice_futures_mdf_impact_v1_1_51.new_futures_strategy_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.new_futures_strategy_definition_message, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_51.new_futures_strategy_definition_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_51.new_futures_strategy_definition_message.display(packet, parent, length)
    parent:append_text(display)
...
ice_futures_mdf_impact_v1_1_51.trade_flags.bits = function(range, value, packet, parent)

  -- Unused 2: 2 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.unused_2, range, value)

  -- Is Option Strategy Hedge: 1 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.is_option_strategy_hedge, range, value)

  -- Has No Direct Outright Taker: 1 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.has_no_direct_outright_taker, range, value)

  -- Is Vertical Split: 1 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.is_vertical_split, range, value)

  -- Has No Direct Outright Originator: 1 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.has_no_direct_outright_originator, range, value)

  -- Is Leg Deal Outside Ipl: 1 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.is_leg_deal_outside_ipl, range, value)

  -- Is Rfc Crossing: 1 Bit
  parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.is_rfc_crossing, range, value)
end

-- Dissect: Trade Flags
ice_futures_mdf_impact_v1_1_51.trade_flags.dissect = function(buffer, offset, packet, parent)
  local size = ice_futures_mdf_impact_v1_1_51.trade_flags.size
  local range = buffer(offset, size)
  local value = range:uint()
  local display = ice_futures_mdf_impact_v1_1_51.trade_flags.display(range, value, packet, parent)
  local element = parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.trade_flags, range, display)

  if show.trade_flags then
    ice_futures_mdf_impact_v1_1_51.trade_flags.bits(range, value, packet, element)
  end
...
-- Dissect: Message
ice_futures_mdf_impact_v1_1_51.message.dissect = function(buffer, offset, packet, parent, message_index)
  if show.message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_ice_futures_mdf_impact_v1_1_51.fields.message, buffer(offset, 0))
    local index = ice_futures_mdf_impact_v1_1_51.message.fields(buffer, offset, packet, parent, message_index)
    local length = index - offset
    parent:set_len(length)
    local display = ice_futures_mdf_impact_v1_1_51.message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return ice_futures_mdf_impact_v1_1_51.message.fields(buffer, offset, packet, parent, message_index)
  end
end
...
omi_ice_futures_mdf_impact_v1_1_51:register_heuristic("udp", omi_ice_futures_mdf_impact_v1_1_51_udp_heuristic)
