...
siac_cts_output_cta_v2_9.participant_data.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_9.previous_close_price_date.size

  index = index + siac_cts_output_cta_v2_9.last_price.size

  index = index + siac_cts_output_cta_v2_9.high_price.size

  index = index + siac_cts_output_cta_v2_9.low_price.size

  index = index + siac_cts_output_cta_v2_9.open_price.size

  index = index + siac_cts_output_cta_v2_9.total_volume_short.size

  index = index + siac_cts_output_cta_v2_9.tick.size
...
siac_cts_output_cta_v2_9.consolidated_data.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_9.previous_close_price_date.size

  index = index + siac_cts_output_cta_v2_9.last_participant_id.size
...
siac_cts_output_cta_v2_9.timestamp_2.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_9.seconds.size

  index = index + siac_cts_output_cta_v2_9.nanoseconds.size
...
siac_cts_output_cta_v2_9.sale_conditions.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_9.settlement_type.size

  index = index + siac_cts_output_cta_v2_9.trade_through_exempt_reason.size

  index = index + siac_cts_output_cta_v2_9.extended_hours_or_sequence_type.size

  index = index + siac_cts_output_cta_v2_9.sro_trade_detail.size
...
siac_cts_output_cta_v2_9.timestamp_1.size = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_9.prior_day_trade_date_and_time.size = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_9.original_trade.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_9.sale_conditions.size(buffer, offset + index)

  index = index + siac_cts_output_cta_v2_9.trade_price.size

  index = index + siac_cts_output_cta_v2_9.trade_volume.size

  index = index + siac_cts_output_cta_v2_9.sellers_sale_days.size

  index = index + siac_cts_output_cta_v2_9.stop_stock_indicator.size

  index = index + siac_cts_output_cta_v2_9.trade_through_exempt_indicator.size

  index = index + siac_cts_output_cta_v2_9.short_sale_restriction_indicator.size

  index = index + siac_cts_output_cta_v2_9.prior_day_trade_date_and_time.size(buffer, offset + index)
...
siac_cts_output_cta_v2_9.corrected_trade.size = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_9.trade_payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.trade_payload.dissect = function(buffer, offset, packet, parent, trade_message_type)
  ...
  local size = siac_cts_output_cta_v2_9.trade_payload.size(buffer, offset, trade_message_type)
  if size == 0 then
    return offset
  end
  ...
  local display = siac_cts_output_cta_v2_9.trade_payload.display(buffer, packet, parent)
...
-- Dissect: Trade
siac_cts_output_cta_v2_9.trade.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
...
siac_cts_output_cta_v2_9.summary_payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.summary_payload.dissect = function(buffer, offset, packet, parent, summary_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_9.summary_payload.size(buffer, offset, summary_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_9.summary_payload.display(buffer, packet, parent)
...
-- Dissect: Summary
siac_cts_output_cta_v2_9.summary.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
...
siac_cts_output_cta_v2_9.prior_day_payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.prior_day_payload.dissect = function(buffer, offset, packet, parent, prior_day_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_9.prior_day_payload.size(buffer, offset, prior_day_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_9.prior_day_payload.display(buffer, packet, parent)
...
-- Dissect: Prior Day
siac_cts_output_cta_v2_9.prior_day.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
...
siac_cts_output_cta_v2_9.participants.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_9.participant_id.size

  index = index + siac_cts_output_cta_v2_9.trade_total_volume.size
...
siac_cts_output_cta_v2_9.market_status_payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.market_status_payload.dissect = function(buffer, offset, packet, parent, market_status_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_9.market_status_payload.size(buffer, offset, market_status_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_9.market_status_payload.display(buffer, packet, parent)
...
siac_cts_output_cta_v2_9.market_status.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
...
siac_cts_output_cta_v2_9.index_payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.index_payload.dissect = function(buffer, offset, packet, parent, index_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_9.index_payload.size(buffer, offset, index_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_9.index_payload.display(buffer, packet, parent)
...
-- Dissect: Index
siac_cts_output_cta_v2_9.index.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
...
siac_cts_output_cta_v2_9.control_payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.control_payload.dissect = function(buffer, offset, packet, parent, control_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_9.control_payload.size(buffer, offset, control_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_9.control_payload.display(buffer, packet, parent)
...
-- Dissect: Control
siac_cts_output_cta_v2_9.control.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
...
siac_cts_output_cta_v2_9.administrative_payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.administrative_payload.dissect = function(buffer, offset, packet, parent, administrative_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_9.administrative_payload.size(buffer, offset, administrative_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_9.administrative_payload.display(buffer, packet, parent)
...
siac_cts_output_cta_v2_9.administrative.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
...
-- Display: Payload
siac_cts_output_cta_v2_9.payload.display = function(buffer, offset, packet, parent)
  return ""
end
...
siac_cts_output_cta_v2_9.payload.dissect = function(buffer, offset, packet, parent, message_category)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_9.payload.size(buffer, offset, message_category)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_9.payload.display(buffer, packet, parent)
...
siac_cts_output_cta_v2_9.message_header.size = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_9.sip_block_timestamp.size = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_9.block_header.size = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_9.version.size

  index = index + siac_cts_output_cta_v2_9.block_size.size

  index = index + siac_cts_output_cta_v2_9.data_feed_indicator.size

  index = index + siac_cts_output_cta_v2_9.retransmission_indicator.size

  index = index + siac_cts_output_cta_v2_9.block_sequence_number.size

  index = index + siac_cts_output_cta_v2_9.messages_in_block.size

  index = index + siac_cts_output_cta_v2_9.sip_block_timestamp.size(buffer, offset + index)

  index = index + siac_cts_output_cta_v2_9.block_checksum.size
