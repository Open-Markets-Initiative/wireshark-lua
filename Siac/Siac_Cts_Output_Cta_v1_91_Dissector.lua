...
-- Dissect: Message
siac_cts_output_cta_v1_91_dissect.message = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(siac_cts_output_cta_v1_91.fields.message, buffer(offset, 0))
    local current = siac_cts_output_cta_v1_91_dissect.message_fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    siac_cts_output_cta_v1_91_dissect.message_fields(buffer, offset, packet, parent, size_of_message, message_index)
