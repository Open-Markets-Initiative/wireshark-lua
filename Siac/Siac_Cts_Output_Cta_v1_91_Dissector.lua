...
omi_siac_cts_output_cta_v1_91.fields.summary_participant_id = ProtoField.new("Summary Participant Id", "siac.cts.output.cta.v1.91.summaryparticipantid", ftypes.STRING)
...
omi_siac_cts_output_cta_v1_91.fields.prior_day_trade_cancel_error_message = ProtoField.new("Prior Day Trade Cancel Error Message", "siac.cts.output.cta.v1.91.priordaytradecancelerrormessage", ftypes.STRING)
...
function omi_siac_cts_output_cta_v1_91.prefs_changed()
  ...
  if show.structs ~= omi_siac_cts_output_cta_v1_91.prefs.show_structs then
    show.structs = omi_siac_cts_output_cta_v1_91.prefs.show_structs
  end
  if show.indexes ~= omi_siac_cts_output_cta_v1_91.prefs.show_indexes then
    show.indexes = omi_siac_cts_output_cta_v1_91.prefs.show_indexes
  end
end
...
siac_cts_output_cta_v1_91.summary_participant_id = {}

-- Size: Summary Participant Id
siac_cts_output_cta_v1_91.summary_participant_id.size = 1

-- Display: Summary Participant Id
siac_cts_output_cta_v1_91.summary_participant_id.display = function(value)
  return "Summary Participant Id: "..value
end

-- Dissect: Summary Participant Id
siac_cts_output_cta_v1_91.summary_participant_id.dissect = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v1_91.summary_participant_id.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_cts_output_cta_v1_91.summary_participant_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_siac_cts_output_cta_v1_91.fields.summary_participant_id, range, value, display)
...
siac_cts_output_cta_v1_91.participant_end_of_day_summary_message.size =
  ...
  siac_cts_output_cta_v1_91.security_symbol.size + 
  siac_cts_output_cta_v1_91.instrument_type.size + 
  siac_cts_output_cta_v1_91.summary_participant_id.size + 
  siac_cts_output_cta_v1_91.previous_close_price_date.size + 
  siac_cts_output_cta_v1_91.last_price.size + 
  siac_cts_output_cta_v1_91.high_price.size + 
  siac_cts_output_cta_v1_91.low_price.size + 
...
siac_cts_output_cta_v1_91.participant_end_of_day_summary_message.fields = function(buffer, offset, packet, parent)
  ...
  index, summary_participant_id = siac_cts_output_cta_v1_91.summary_participant_id.dissect(buffer, index, packet, parent)
...
siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message = {}

-- Size: Prior Day Trade Cancel Error Message
siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.size =
  siac_cts_output_cta_v1_91.participant_id.size + 
  siac_cts_output_cta_v1_91.timestamp_1.size + 
  siac_cts_output_cta_v1_91.message_id.size + 
  siac_cts_output_cta_v1_91.transaction_id.size + 
...
siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prior Day Trade Cancel Error Message
siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_siac_cts_output_cta_v1_91.fields.prior_day_trade_cancel_error_message, buffer(offset, 0))
    local index = siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.fields(buffer, offset, packet, parent)
  end
end
...
siac_cts_output_cta_v1_91.prior_day_message_payload.dissect = function(buffer, offset, packet, parent, prior_day_message_type)
  ...
  if prior_day_message_type == "X" then
    return siac_cts_output_cta_v1_91.prior_day_trade_cancel_error_message.dissect(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v1_91.participants.fields = function(buffer, offset, packet, parent, participants_index)
  ...
  if participants_index ~= nil and show.indexes then
