...
function omi_siac_cqs_input_cta_v2_9_b.prefs_changed()
  ...
  if show.headers ~= omi_siac_cqs_input_cta_v2_9_b.prefs.show_headers then
    show.headers = omi_siac_cqs_input_cta_v2_9_b.prefs.show_headers
  end
...
-- Register Siac Cqs Input Cta 2.9.b for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_siac_cqs_input_cta_v2_9_b)
