...
function omi_siac_opra_recipient_obi_v6_1.prefs_changed()
  ...
  if show.structs ~= omi_siac_opra_recipient_obi_v6_1.prefs.show_structs then
    show.structs = omi_siac_opra_recipient_obi_v6_1.prefs.show_structs
  end
  if show.indexes ~= omi_siac_opra_recipient_obi_v6_1.prefs.show_indexes then
    show.indexes = omi_siac_opra_recipient_obi_v6_1.prefs.show_indexes
  end
end
...
siac_opra_recipient_obi_v6_1.packet.requiredsize = function(buffer)
  return buffer:len() >= siac_opra_recipient_obi_v6_1.block_header.size
end
...
omi_siac_opra_recipient_obi_v6_1:register_heuristic("udp", omi_siac_opra_recipient_obi_v6_1_udp_heuristic)

-- Register Siac Opra Recipient Obi 6.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_siac_opra_recipient_obi_v6_1)
