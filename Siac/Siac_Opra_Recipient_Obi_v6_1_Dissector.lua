...
local show = {}
local format = {}
local siac_opra_recipient_obi_v6_1_display = {}
local siac_opra_recipient_obi_v6_1_dissect = {}
local siac_opra_recipient_obi_v6_1_size_of = {}
local verify = {}
...
-- Size: Block Pad Byte
siac_opra_recipient_obi_v6_1_size_of.block_pad_byte = 1

-- Display: Block Pad Byte
siac_opra_recipient_obi_v6_1_display.block_pad_byte = function(value)
  return "Block Pad Byte: "..value
end

-- Dissect: Block Pad Byte
siac_opra_recipient_obi_v6_1_dissect.block_pad_byte = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.block_pad_byte
...
siac_opra_recipient_obi_v6_1_size_of.offer_index_value = 8

-- Display: Offer Index Value
siac_opra_recipient_obi_v6_1_display.offer_index_value = function(value)
  return "Offer Index Value: "..value
end

-- Dissect: Offer Index Value
siac_opra_recipient_obi_v6_1_dissect.offer_index_value = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.offer_index_value
  local range = buffer(offset, length)
...
siac_opra_recipient_obi_v6_1_size_of.bid_index_value = 4

-- Display: Bid Index Value
siac_opra_recipient_obi_v6_1_display.bid_index_value = function(value)
  return "Bid Index Value: "..value
end

-- Dissect: Bid Index Value
siac_opra_recipient_obi_v6_1_dissect.bid_index_value = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.bid_index_value
  local range = buffer(offset, length)
...
siac_opra_recipient_obi_v6_1_size_of.index_value_denominator_code = 1

-- Display: Index Value Denominator Code
siac_opra_recipient_obi_v6_1_display.index_value_denominator_code = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.index_value_denominator_code = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.index_value_denominator_code
  local range = buffer(offset, length)
...
-- Size: Reserved 1
siac_opra_recipient_obi_v6_1_size_of.reserved_1 = 1

-- Display: Reserved 1
siac_opra_recipient_obi_v6_1_display.reserved_1 = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
siac_opra_recipient_obi_v6_1_dissect.reserved_1 = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.reserved_1
  local range = buffer(offset, length)
...
siac_opra_recipient_obi_v6_1_size_of.security_symbol = 5

-- Display: Security Symbol
siac_opra_recipient_obi_v6_1_display.security_symbol = function(value)
  return "Security Symbol: "..value
end

-- Dissect: Security Symbol
siac_opra_recipient_obi_v6_1_dissect.security_symbol = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.security_symbol
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.participant_reference_number = 4

-- Display: Participant Reference Number
siac_opra_recipient_obi_v6_1_display.participant_reference_number = function(value)
  return "Participant Reference Number: "..value
end

-- Dissect: Participant Reference Number
siac_opra_recipient_obi_v6_1_dissect.participant_reference_number = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.participant_reference_number
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Transaction Id
siac_opra_recipient_obi_v6_1_size_of.transaction_id = 4

-- Display: Transaction Id
siac_opra_recipient_obi_v6_1_display.transaction_id = function(value)
  return "Transaction Id: "..value
end

-- Dissect: Transaction Id
siac_opra_recipient_obi_v6_1_dissect.transaction_id = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.transaction_id
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.message_indicator = 1

-- Display: Message Indicator
siac_opra_recipient_obi_v6_1_display.message_indicator = function(value)
  return "Message Indicator: "..value
end

-- Dissect: Message Indicator
siac_opra_recipient_obi_v6_1_dissect.message_indicator = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.message_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.underlying_value_bid_and_offer_message = function(buffer, offset)
  local index = 0
  ...
  index = index + siac_opra_recipient_obi_v6_1_size_of.security_symbol

  index = index + siac_opra_recipient_obi_v6_1_size_of.reserved_1

  index = index + siac_opra_recipient_obi_v6_1_size_of.index_value_denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.bid_index_value

  index = index + siac_opra_recipient_obi_v6_1_size_of.offer_index_value

  return index
end

-- Display: Underlying Value Bid And Offer Message
siac_opra_recipient_obi_v6_1_display.underlying_value_bid_and_offer_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.underlying_value_bid_and_offer_message = function(buffer, offset, packet, parent)
  if show.underlying_value_bid_and_offer_message then
    ...
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.underlying_value_bid_and_offer_message, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.underlying_value_bid_and_offer_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.underlying_value_bid_and_offer_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.underlying_value_bid_and_offer_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Reserved 4
siac_opra_recipient_obi_v6_1_size_of.reserved_4 = 4

-- Display: Reserved 4
siac_opra_recipient_obi_v6_1_display.reserved_4 = function(value)
  return "Reserved 4: "..value
end

-- Dissect: Reserved 4
siac_opra_recipient_obi_v6_1_dissect.reserved_4 = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.reserved_4
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
...
-- Size: Index Value
siac_opra_recipient_obi_v6_1_size_of.index_value = 4

-- Display: Index Value
siac_opra_recipient_obi_v6_1_display.index_value = function(value)
  return "Index Value: "..value
end

-- Dissect: Index Value
siac_opra_recipient_obi_v6_1_dissect.index_value = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.index_value
  local range = buffer(offset, length)
  local value = range:int()
...
siac_opra_recipient_obi_v6_1_size_of.underlying_value_last_sale_message = function(buffer, offset)
  local index = 0
  ...
  index = index + siac_opra_recipient_obi_v6_1_size_of.index_value

  index = index + siac_opra_recipient_obi_v6_1_size_of.reserved_4

  return index
end

-- Display: Underlying Value Last Sale Message
siac_opra_recipient_obi_v6_1_display.underlying_value_last_sale_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.underlying_value_last_sale_message = function(buffer, offset, packet, parent)
  if show.underlying_value_last_sale_message then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.underlying_value_last_sale_message, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.underlying_value_last_sale_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.underlying_value_last_sale_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.underlying_value_last_sale_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Underlying Value Message Payload
siac_opra_recipient_obi_v6_1_size_of.underlying_value_message_payload = function(buffer, offset, underlying_value_message_type)
  -- Size of Underlying Value Last Sale Message
  if underlying_value_message_type == " " then
    return siac_opra_recipient_obi_v6_1_size_of.underlying_value_last_sale_message(buffer, offset)
  end
  -- Size of Underlying Value Bid And Offer Message
  if underlying_value_message_type == "I" then
    return siac_opra_recipient_obi_v6_1_size_of.underlying_value_bid_and_offer_message(buffer, offset)
  end
...
siac_opra_recipient_obi_v6_1_display.underlying_value_message_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Underlying Value Message Payload
siac_opra_recipient_obi_v6_1_dissect.underlying_value_message_payload_branches = function(buffer, offset, packet, parent, underlying_value_message_type)
  -- Dissect Underlying Value Last Sale Message
  if underlying_value_message_type == " " then
    return siac_opra_recipient_obi_v6_1_dissect.underlying_value_last_sale_message(buffer, offset, packet, parent)
  end
  -- Dissect Underlying Value Bid And Offer Message
  if underlying_value_message_type == "I" then
    return siac_opra_recipient_obi_v6_1_dissect.underlying_value_bid_and_offer_message(buffer, offset, packet, parent)
  end
...
siac_opra_recipient_obi_v6_1_dissect.underlying_value_message_payload = function(buffer, offset, packet, parent, underlying_value_message_type)
  ...
  local size = siac_opra_recipient_obi_v6_1_size_of.underlying_value_message_payload(buffer, offset, underlying_value_message_type)
  if size == 0 then
    return offset
  end
...
siac_opra_recipient_obi_v6_1_size_of.underlying_value_message_type = 1

-- Display: Underlying Value Message Type
siac_opra_recipient_obi_v6_1_display.underlying_value_message_type = function(value)
  if value == " " then
...
siac_opra_recipient_obi_v6_1_dissect.underlying_value_message_type = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.underlying_value_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.underlying_value_message = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.underlying_value_message_type
  ...
  index = index + siac_opra_recipient_obi_v6_1_size_of.underlying_value_message_payload(buffer, underlying_value_message_payload_offset, underlying_value_message_payload_type)

  return index
end

-- Display: Underlying Value Message
siac_opra_recipient_obi_v6_1_display.underlying_value_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.underlying_value_message_fields = function(buffer, offset, packet, parent)
  ...
  index = siac_opra_recipient_obi_v6_1_dissect.underlying_value_message_payload(buffer, index, packet, parent, underlying_value_message_type)

  return index
end

-- Dissect: Underlying Value Message
siac_opra_recipient_obi_v6_1_dissect.underlying_value_message = function(buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1_display.message_data = function(value)
  return "Message Data: "..value
end

-- Dissect runtime sized field: Message Data
siac_opra_recipient_obi_v6_1_dissect.message_data = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.message_data_length = 2

-- Display: Message Data Length
siac_opra_recipient_obi_v6_1_display.message_data_length = function(value)
  return "Message Data Length: "..value
end

-- Dissect: Message Data Length
siac_opra_recipient_obi_v6_1_dissect.message_data_length = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.message_data_length
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.control_message_type = 1

-- Display: Control Message Type
siac_opra_recipient_obi_v6_1_display.control_message_type = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.control_message_type = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.control_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.control_message = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.control_message_type
...
siac_opra_recipient_obi_v6_1_display.control_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.control_message_fields = function(buffer, offset, packet, parent)
  ...
  if message_data_exists then
    ...
    index, message_data = siac_opra_recipient_obi_v6_1_dissect.message_data(buffer, index, packet, parent, message_data_length)
  end
...
siac_opra_recipient_obi_v6_1_dissect.control_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Message Type
siac_opra_recipient_obi_v6_1_size_of.message_type = 1

-- Display: Message Type
siac_opra_recipient_obi_v6_1_display.message_type = function(value)
  return "Message Type: "..value
end

-- Dissect: Message Type
siac_opra_recipient_obi_v6_1_dissect.message_type = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_display.administrative_message = function(packet, parent, length)
  return ""
end
...
-- Size: Price
siac_opra_recipient_obi_v6_1_size_of.price = 4

-- Display: Price
siac_opra_recipient_obi_v6_1_display.price = function(value)
  return "Price: "..value
end

-- Dissect: Price
siac_opra_recipient_obi_v6_1_dissect.price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.price
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.denominator_code = 1

-- Display: Denominator Code
siac_opra_recipient_obi_v6_1_display.denominator_code = function(value)
  return "Denominator Code: "..value
end

-- Dissect: Denominator Code
siac_opra_recipient_obi_v6_1_dissect.denominator_code = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.denominator_code
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Participant Id
siac_opra_recipient_obi_v6_1_size_of.participant_id = 1

-- Display: Participant Id
siac_opra_recipient_obi_v6_1_display.participant_id = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.participant_id = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.participant_id
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.best_offer_appendage = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.participant_id

  index = index + siac_opra_recipient_obi_v6_1_size_of.denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.price

  index = index + siac_opra_recipient_obi_v6_1_size_of.size

  return index
end

-- Display: Best Offer Appendage
siac_opra_recipient_obi_v6_1_display.best_offer_appendage = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.best_offer_appendage_fields = function(buffer, offset, packet, parent)
  ...
  -- Size
  index, size = siac_opra_recipient_obi_v6_1_dissect.size(buffer, index, packet, parent)
...
siac_opra_recipient_obi_v6_1_dissect.best_offer_appendage = function(buffer, offset, packet, parent)
  if show.best_offer_appendage then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.best_offer_appendage, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.best_offer_appendage_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.best_offer_appendage(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.best_offer_appendage_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Best Bid Appendage
siac_opra_recipient_obi_v6_1_size_of.best_bid_appendage = function(buffer, offset)
  local index = 0
...
siac_opra_recipient_obi_v6_1_display.best_bid_appendage = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.best_bid_appendage = function(buffer, offset, packet, parent)
  if show.best_bid_appendage then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.best_bid_appendage, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.best_bid_appendage_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.best_bid_appendage(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.best_bid_appendage_fields(buffer, offset, packet, element)
  end
end

-- Size: Offer Size Short
siac_opra_recipient_obi_v6_1_size_of.offer_size_short = 2

-- Display: Offer Size Short
siac_opra_recipient_obi_v6_1_display.offer_size_short = function(value)
  return "Offer Size Short: "..value
end

-- Dissect: Offer Size Short
siac_opra_recipient_obi_v6_1_dissect.offer_size_short = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.offer_size_short
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.offer_price_short = 2

-- Display: Offer Price Short
siac_opra_recipient_obi_v6_1_display.offer_price_short = function(value)
  return "Offer Price Short: "..value
end

-- Dissect: Offer Price Short
siac_opra_recipient_obi_v6_1_dissect.offer_price_short = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.offer_price_short
  local range = buffer(offset, length)
  local value = range:int()
...
-- Size: Bid Size Short
siac_opra_recipient_obi_v6_1_size_of.bid_size_short = 2

-- Display: Bid Size Short
siac_opra_recipient_obi_v6_1_display.bid_size_short = function(value)
  return "Bid Size Short: "..value
end

-- Dissect: Bid Size Short
siac_opra_recipient_obi_v6_1_dissect.bid_size_short = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.bid_size_short
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.bid_price_short = 2

-- Display: Bid Price Short
siac_opra_recipient_obi_v6_1_display.bid_price_short = function(value)
  return "Bid Price Short: "..value
end

-- Dissect: Bid Price Short
siac_opra_recipient_obi_v6_1_dissect.bid_price_short = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.bid_price_short
  local range = buffer(offset, length)
  local value = range:int()
...
siac_opra_recipient_obi_v6_1_size_of.strike_price_short = 2

-- Display: Strike Price Short
siac_opra_recipient_obi_v6_1_display.strike_price_short = function(value)
  return "Strike Price Short: "..value
end

-- Dissect: Strike Price Short
siac_opra_recipient_obi_v6_1_dissect.strike_price_short = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.strike_price_short
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.expiration_year = 1

-- Display: Expiration Year
siac_opra_recipient_obi_v6_1_display.expiration_year = function(value)
  return "Expiration Year: "..value
end

-- Dissect: Expiration Year
siac_opra_recipient_obi_v6_1_dissect.expiration_year = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.expiration_year
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Expiration Day
siac_opra_recipient_obi_v6_1_size_of.expiration_day = 1

-- Display: Expiration Day
siac_opra_recipient_obi_v6_1_display.expiration_day = function(value)
  return "Expiration Day: "..value
end

-- Dissect: Expiration Day
siac_opra_recipient_obi_v6_1_dissect.expiration_day = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.expiration_day
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.expiration_month = 1

-- Display: Expiration Month
siac_opra_recipient_obi_v6_1_display.expiration_month = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.expiration_month = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.expiration_month
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.expiration_block = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.expiration_month

  index = index + siac_opra_recipient_obi_v6_1_size_of.expiration_day

  index = index + siac_opra_recipient_obi_v6_1_size_of.expiration_year

  return index
end

-- Display: Expiration Block
siac_opra_recipient_obi_v6_1_display.expiration_block = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.expiration_block = function(buffer, offset, packet, parent)
  if show.expiration_block then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.expiration_block, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.expiration_block_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.expiration_block(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.expiration_block_fields(buffer, offset, packet, element)
  end
end

-- Size: Security Symbol Short
siac_opra_recipient_obi_v6_1_size_of.security_symbol_short = 4

-- Display: Security Symbol Short
siac_opra_recipient_obi_v6_1_display.security_symbol_short = function(value)
  return "Security Symbol Short: "..value
end

-- Dissect: Security Symbol Short
siac_opra_recipient_obi_v6_1_dissect.security_symbol_short = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.security_symbol_short
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Bbo Indicator
siac_opra_recipient_obi_v6_1_size_of.bbo_indicator = 1

-- Display: Bbo Indicator
siac_opra_recipient_obi_v6_1_display.bbo_indicator = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.bbo_indicator = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.bbo_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.quote_message_type = 1

-- Display: Quote Message Type
siac_opra_recipient_obi_v6_1_display.quote_message_type = function(value)
  if value == " " then
...
siac_opra_recipient_obi_v6_1_dissect.quote_message_type = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.quote_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.short_equity_and_index_quote_message = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.quote_message_type

  index = index + siac_opra_recipient_obi_v6_1_size_of.bbo_indicator

  index = index + siac_opra_recipient_obi_v6_1_size_of.transaction_id

  index = index + siac_opra_recipient_obi_v6_1_size_of.participant_reference_number

  index = index + siac_opra_recipient_obi_v6_1_size_of.security_symbol_short

  index = index + siac_opra_recipient_obi_v6_1_size_of.expiration_block(buffer, offset + index)

  index = index + siac_opra_recipient_obi_v6_1_size_of.strike_price_short

  index = index + siac_opra_recipient_obi_v6_1_size_of.bid_price_short

  index = index + siac_opra_recipient_obi_v6_1_size_of.bid_size_short

  index = index + siac_opra_recipient_obi_v6_1_size_of.offer_price_short
...
siac_opra_recipient_obi_v6_1_display.short_equity_and_index_quote_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.short_equity_and_index_quote_message_fields = function(buffer, offset, packet, parent)
  ...
  if best_bid_appendage_exists then
    index, best_bid_appendage = siac_opra_recipient_obi_v6_1_dissect.best_bid_appendage(buffer, index, packet, parent)
  end
  ...
  if best_offer_appendage_exists then
    index, best_offer_appendage = siac_opra_recipient_obi_v6_1_dissect.best_offer_appendage(buffer, index, packet, parent)
  end
...
siac_opra_recipient_obi_v6_1_dissect.short_equity_and_index_quote_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
siac_opra_recipient_obi_v6_1_size_of.best_offer_size = 4

-- Display: Best Offer Size
siac_opra_recipient_obi_v6_1_display.best_offer_size = function(value)
  return "Best Offer Size: "..value
end

-- Dissect: Best Offer Size
siac_opra_recipient_obi_v6_1_dissect.best_offer_size = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_offer_size
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.best_offer_price = 4

-- Display: Best Offer Price
siac_opra_recipient_obi_v6_1_display.best_offer_price = function(value)
  return "Best Offer Price: "..value
end

-- Dissect: Best Offer Price
siac_opra_recipient_obi_v6_1_dissect.best_offer_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_offer_price
  local range = buffer(offset, length)
  local value = range:int()
...
siac_opra_recipient_obi_v6_1_size_of.best_offer_denominator_code = 1

-- Display: Best Offer Denominator Code
siac_opra_recipient_obi_v6_1_display.best_offer_denominator_code = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.best_offer_denominator_code = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_offer_denominator_code
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.best_offer_participant_id = 1

-- Display: Best Offer Participant Id
siac_opra_recipient_obi_v6_1_display.best_offer_participant_id = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.best_offer_participant_id = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_offer_participant_id
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Best Bid Size
siac_opra_recipient_obi_v6_1_size_of.best_bid_size = 4

-- Display: Best Bid Size
siac_opra_recipient_obi_v6_1_display.best_bid_size = function(value)
  return "Best Bid Size: "..value
end

-- Dissect: Best Bid Size
siac_opra_recipient_obi_v6_1_dissect.best_bid_size = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_bid_size
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Best Bid Price
siac_opra_recipient_obi_v6_1_size_of.best_bid_price = 4

-- Display: Best Bid Price
siac_opra_recipient_obi_v6_1_display.best_bid_price = function(value)
  return "Best Bid Price: "..value
end

-- Dissect: Best Bid Price
siac_opra_recipient_obi_v6_1_dissect.best_bid_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_bid_price
  local range = buffer(offset, length)
  local value = range:int()
...
siac_opra_recipient_obi_v6_1_size_of.best_bid_denominator_code = 1

-- Display: Best Bid Denominator Code
siac_opra_recipient_obi_v6_1_display.best_bid_denominator_code = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.best_bid_denominator_code = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_bid_denominator_code
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.best_bid_participant_id = 1

-- Display: Best Bid Participant Id
siac_opra_recipient_obi_v6_1_display.best_bid_participant_id = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.best_bid_participant_id = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.best_bid_participant_id
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.best_bid_and_offer_appendage = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_bid_participant_id

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_bid_denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_bid_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_bid_size

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_offer_participant_id

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_offer_denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_offer_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.best_offer_size

  return index
end

-- Display: Best Bid And Offer Appendage
siac_opra_recipient_obi_v6_1_display.best_bid_and_offer_appendage = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.best_bid_and_offer_appendage = function(buffer, offset, packet, parent)
  if show.best_bid_and_offer_appendage then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.best_bid_and_offer_appendage, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.best_bid_and_offer_appendage_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.best_bid_and_offer_appendage(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.best_bid_and_offer_appendage_fields(buffer, offset, packet, element)
  end
end

-- Size: Offer Size
siac_opra_recipient_obi_v6_1_size_of.offer_size = 4

-- Display: Offer Size
siac_opra_recipient_obi_v6_1_display.offer_size = function(value)
  return "Offer Size: "..value
end

-- Dissect: Offer Size
siac_opra_recipient_obi_v6_1_dissect.offer_size = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.offer_size
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Offer Price
siac_opra_recipient_obi_v6_1_size_of.offer_price = 4

-- Display: Offer Price
siac_opra_recipient_obi_v6_1_display.offer_price = function(value)
  return "Offer Price: "..value
end

-- Dissect: Offer Price
siac_opra_recipient_obi_v6_1_dissect.offer_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.offer_price
  local range = buffer(offset, length)
  local value = range:int()
...
-- Size: Bid Size
siac_opra_recipient_obi_v6_1_size_of.bid_size = 4

-- Display: Bid Size
siac_opra_recipient_obi_v6_1_display.bid_size = function(value)
  return "Bid Size: "..value
end

-- Dissect: Bid Size
siac_opra_recipient_obi_v6_1_dissect.bid_size = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.bid_size
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Bid Price
siac_opra_recipient_obi_v6_1_size_of.bid_price = 4

-- Display: Bid Price
siac_opra_recipient_obi_v6_1_display.bid_price = function(value)
  return "Bid Price: "..value
end

-- Dissect: Bid Price
siac_opra_recipient_obi_v6_1_dissect.bid_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.bid_price
  local range = buffer(offset, length)
  local value = range:int()
...
siac_opra_recipient_obi_v6_1_size_of.premium_price_denominator_code = 1

-- Display: Premium Price Denominator Code
siac_opra_recipient_obi_v6_1_display.premium_price_denominator_code = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.premium_price_denominator_code = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.premium_price_denominator_code
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Strike Price
siac_opra_recipient_obi_v6_1_size_of.strike_price = 4

-- Display: Strike Price
siac_opra_recipient_obi_v6_1_display.strike_price = function(value)
  return "Strike Price: "..value
end

-- Dissect: Strike Price
siac_opra_recipient_obi_v6_1_dissect.strike_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.strike_price
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.strike_price_denominator_code = 1

-- Display: Strike Price Denominator Code
siac_opra_recipient_obi_v6_1_display.strike_price_denominator_code = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.strike_price_denominator_code = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.strike_price_denominator_code
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.long_equity_and_index_quote_message = function(buffer, offset)
  local index = 0
  ...
  index = index + siac_opra_recipient_obi_v6_1_size_of.strike_price_denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.strike_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.premium_price_denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.bid_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.bid_size

  index = index + siac_opra_recipient_obi_v6_1_size_of.offer_price
...
siac_opra_recipient_obi_v6_1_display.long_equity_and_index_quote_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.long_equity_and_index_quote_message_fields = function(buffer, offset, packet, parent)
  ...
  if best_bid_and_offer_appendage_exists then
    index, best_bid_and_offer_appendage = siac_opra_recipient_obi_v6_1_dissect.best_bid_and_offer_appendage(buffer, index, packet, parent)
  end
...
siac_opra_recipient_obi_v6_1_dissect.long_equity_and_index_quote_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
siac_opra_recipient_obi_v6_1_size_of.underlying_price = 8

-- Display: Underlying Price
siac_opra_recipient_obi_v6_1_display.underlying_price = function(value)
  return "Underlying Price: "..value
end

-- Dissect: Underlying Price
siac_opra_recipient_obi_v6_1_dissect.underlying_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.underlying_price
  local range = buffer(offset, length)
  local value = range:int64()
...
siac_opra_recipient_obi_v6_1_size_of.underlying_price_denominator_code = 1

-- Display: Underlying Price Denominator Code
siac_opra_recipient_obi_v6_1_display.underlying_price_denominator_code = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1_dissect.underlying_price_denominator_code = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.underlying_price_denominator_code
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Net Change
siac_opra_recipient_obi_v6_1_size_of.net_change = 4

-- Display: Net Change
siac_opra_recipient_obi_v6_1_display.net_change = function(value)
  return "Net Change: "..value
end

-- Dissect: Net Change
siac_opra_recipient_obi_v6_1_dissect.net_change = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.net_change
  local range = buffer(offset, length)
  local value = range:int()
...
-- Size: Last Price
siac_opra_recipient_obi_v6_1_size_of.last_price = 4

-- Display: Last Price
siac_opra_recipient_obi_v6_1_display.last_price = function(value)
  return "Last Price: "..value
end

-- Dissect: Last Price
siac_opra_recipient_obi_v6_1_dissect.last_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.last_price
  local range = buffer(offset, length)
  local value = range:int()
...
-- Size: Low Price
siac_opra_recipient_obi_v6_1_size_of.low_price = 4

-- Display: Low Price
siac_opra_recipient_obi_v6_1_display.low_price = function(value)
  return "Low Price: "..value
end

-- Dissect: Low Price
siac_opra_recipient_obi_v6_1_dissect.low_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.low_price
  local range = buffer(offset, length)
  local value = range:int()
...
-- Size: High Price
siac_opra_recipient_obi_v6_1_size_of.high_price = 4

-- Display: High Price
siac_opra_recipient_obi_v6_1_display.high_price = function(value)
  return "High Price: "..value
end

-- Dissect: High Price
siac_opra_recipient_obi_v6_1_dissect.high_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.high_price
  local range = buffer(offset, length)
  local value = range:int()
...
-- Size: Open Price
siac_opra_recipient_obi_v6_1_size_of.open_price = 4

-- Display: Open Price
siac_opra_recipient_obi_v6_1_display.open_price = function(value)
  return "Open Price: "..value
end

-- Dissect: Open Price
siac_opra_recipient_obi_v6_1_dissect.open_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.open_price
  local range = buffer(offset, length)
  local value = range:int()
...
siac_opra_recipient_obi_v6_1_size_of.open_interest_volume = 4

-- Display: Open Interest Volume
siac_opra_recipient_obi_v6_1_display.open_interest_volume = function(value)
  return "Open Interest Volume: "..value
end

-- Dissect: Open Interest Volume
siac_opra_recipient_obi_v6_1_dissect.open_interest_volume = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.open_interest_volume
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Volume
siac_opra_recipient_obi_v6_1_size_of.volume = 4

-- Display: Volume
siac_opra_recipient_obi_v6_1_display.volume = function(value)
  return "Volume: "..value
end

-- Dissect: Volume
siac_opra_recipient_obi_v6_1_dissect.volume = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.volume
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.equity_and_index_end_of_day_summary_message = function(buffer, offset)
  local index = 0
  ...
  index = index + siac_opra_recipient_obi_v6_1_size_of.volume

  index = index + siac_opra_recipient_obi_v6_1_size_of.open_interest_volume

  index = index + siac_opra_recipient_obi_v6_1_size_of.premium_price_denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.open_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.high_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.low_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.last_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.net_change

  index = index + siac_opra_recipient_obi_v6_1_size_of.underlying_price_denominator_code

  index = index + siac_opra_recipient_obi_v6_1_size_of.underlying_price
...
siac_opra_recipient_obi_v6_1_display.equity_and_index_end_of_day_summary_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.equity_and_index_end_of_day_summary_message = function(buffer, offset, packet, parent)
  if show.equity_and_index_end_of_day_summary_message then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.equity_and_index_end_of_day_summary_message, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.equity_and_index_end_of_day_summary_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.equity_and_index_end_of_day_summary_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.equity_and_index_end_of_day_summary_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Open Interest Message
siac_opra_recipient_obi_v6_1_size_of.open_interest_message = function(buffer, offset)
  local index = 0
...
siac_opra_recipient_obi_v6_1_display.open_interest_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.open_interest_message = function(buffer, offset, packet, parent)
  if show.open_interest_message then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.open_interest_message, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.open_interest_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.open_interest_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.open_interest_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Trade Identifier
siac_opra_recipient_obi_v6_1_size_of.trade_identifier = 4

-- Display: Trade Identifier
siac_opra_recipient_obi_v6_1_display.trade_identifier = function(value)
  return "Trade Identifier: "..value
end

-- Dissect: Trade Identifier
siac_opra_recipient_obi_v6_1_dissect.trade_identifier = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.trade_identifier
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Premium Price
siac_opra_recipient_obi_v6_1_size_of.premium_price = 4

-- Display: Premium Price
siac_opra_recipient_obi_v6_1_display.premium_price = function(value)
  return "Premium Price: "..value
end

-- Dissect: Premium Price
siac_opra_recipient_obi_v6_1_dissect.premium_price = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.premium_price
  local range = buffer(offset, length)
  local value = range:int()
...
siac_opra_recipient_obi_v6_1_size_of.trade_message_type = 1

-- Display: Trade Message Type
siac_opra_recipient_obi_v6_1_display.trade_message_type = function(value)
  if value == " " then
...
siac_opra_recipient_obi_v6_1_dissect.trade_message_type = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.trade_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.equity_and_index_last_sale_message = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.trade_message_type
  ...
  index = index + siac_opra_recipient_obi_v6_1_size_of.premium_price

  index = index + siac_opra_recipient_obi_v6_1_size_of.trade_identifier
...
siac_opra_recipient_obi_v6_1_display.equity_and_index_last_sale_message = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.equity_and_index_last_sale_message = function(buffer, offset, packet, parent)
  if show.equity_and_index_last_sale_message then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.equity_and_index_last_sale_message, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.equity_and_index_last_sale_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.equity_and_index_last_sale_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.equity_and_index_last_sale_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Payload
siac_opra_recipient_obi_v6_1_size_of.payload = function(buffer, offset, message_category)
  -- Size of Equity And Index Last Sale Message
  if message_category == "a" then
    return siac_opra_recipient_obi_v6_1_size_of.equity_and_index_last_sale_message(buffer, offset)
  end
  -- Size of Open Interest Message
  if message_category == "d" then
    return siac_opra_recipient_obi_v6_1_size_of.open_interest_message(buffer, offset)
  end
  -- Size of Equity And Index End Of Day Summary Message
  if message_category == "f" then
    return siac_opra_recipient_obi_v6_1_size_of.equity_and_index_end_of_day_summary_message(buffer, offset)
  end
  -- Size of Long Equity And Index Quote Message
  if message_category == "k" then
    return siac_opra_recipient_obi_v6_1_size_of.long_equity_and_index_quote_message(buffer, offset)
  end
  -- Size of Short Equity And Index Quote Message
  if message_category == "q" then
    return siac_opra_recipient_obi_v6_1_size_of.short_equity_and_index_quote_message(buffer, offset)
  end
  -- Size of Administrative Message
  if message_category == "C" then
    return siac_opra_recipient_obi_v6_1_size_of.administrative_message(buffer, offset)
  end
  -- Size of Control Message
  if message_category == "H" then
    return siac_opra_recipient_obi_v6_1_size_of.control_message(buffer, offset)
  end
  -- Size of Underlying Value Message
  if message_category == "Y" then
    return siac_opra_recipient_obi_v6_1_size_of.underlying_value_message(buffer, offset)
  end
...
-- Display: Payload
siac_opra_recipient_obi_v6_1_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
siac_opra_recipient_obi_v6_1_dissect.payload_branches = function(buffer, offset, packet, parent, message_category)
  -- Dissect Equity And Index Last Sale Message
  if message_category == "a" then
    return siac_opra_recipient_obi_v6_1_dissect.equity_and_index_last_sale_message(buffer, offset, packet, parent)
  end
  -- Dissect Open Interest Message
  if message_category == "d" then
    return siac_opra_recipient_obi_v6_1_dissect.open_interest_message(buffer, offset, packet, parent)
  end
  -- Dissect Equity And Index End Of Day Summary Message
  if message_category == "f" then
    return siac_opra_recipient_obi_v6_1_dissect.equity_and_index_end_of_day_summary_message(buffer, offset, packet, parent)
  end
  -- Dissect Long Equity And Index Quote Message
  if message_category == "k" then
    return siac_opra_recipient_obi_v6_1_dissect.long_equity_and_index_quote_message(buffer, offset, packet, parent)
  end
  -- Dissect Short Equity And Index Quote Message
  if message_category == "q" then
    return siac_opra_recipient_obi_v6_1_dissect.short_equity_and_index_quote_message(buffer, offset, packet, parent)
  end
  -- Dissect Administrative Message
  if message_category == "C" then
    return siac_opra_recipient_obi_v6_1_dissect.administrative_message(buffer, offset, packet, parent)
  end
  -- Dissect Control Message
  if message_category == "H" then
    return siac_opra_recipient_obi_v6_1_dissect.control_message(buffer, offset, packet, parent)
  end
  -- Dissect Underlying Value Message
  if message_category == "Y" then
    return siac_opra_recipient_obi_v6_1_dissect.underlying_value_message(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
siac_opra_recipient_obi_v6_1_dissect.payload = function(buffer, offset, packet, parent, message_category)
  if not show.payload then
    return siac_opra_recipient_obi_v6_1_dissect.payload_branches(buffer, offset, packet, parent, message_category)
  end

  -- Calculate size and check that branch is not empty
  local size = siac_opra_recipient_obi_v6_1_size_of.payload(buffer, offset, message_category)
  if size == 0 then
    return offset
  end
...
siac_opra_recipient_obi_v6_1_size_of.message_category = 1

-- Display: Message Category
siac_opra_recipient_obi_v6_1_display.message_category = function(value)
  if value == "a" then
...
siac_opra_recipient_obi_v6_1_dissect.message_category = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.message_category
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.message = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.participant_id

  index = index + siac_opra_recipient_obi_v6_1_size_of.message_category

  -- Calculate runtime size of Payload field
  local payload_offset = offset + index
  local payload_type = buffer(payload_offset - 1, 1):string()
  index = index + siac_opra_recipient_obi_v6_1_size_of.payload(buffer, payload_offset, payload_type)

  return index
end

-- Display: Message
siac_opra_recipient_obi_v6_1_display.message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
siac_opra_recipient_obi_v6_1_dissect.message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index = siac_opra_recipient_obi_v6_1_dissect.payload(buffer, index, packet, parent, message_category)

  return index
end

-- Dissect: Message
siac_opra_recipient_obi_v6_1_dissect.message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Block Checksum
siac_opra_recipient_obi_v6_1_size_of.block_checksum = 2

-- Display: Block Checksum
siac_opra_recipient_obi_v6_1_display.block_checksum = function(value)
  return "Block Checksum: "..value
end

-- Dissect: Block Checksum
siac_opra_recipient_obi_v6_1_dissect.block_checksum = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.block_checksum
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Nanoseconds
siac_opra_recipient_obi_v6_1_size_of.nanoseconds = 4

-- Display: Nanoseconds
siac_opra_recipient_obi_v6_1_display.nanoseconds = function(value)
  return "Nanoseconds: "..value
end

-- Dissect: Nanoseconds
siac_opra_recipient_obi_v6_1_dissect.nanoseconds = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.nanoseconds
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Seconds
siac_opra_recipient_obi_v6_1_size_of.seconds = 4

-- Display: Seconds
siac_opra_recipient_obi_v6_1_display.seconds = function(value)
  return "Seconds: "..value
end

-- Dissect: Seconds
siac_opra_recipient_obi_v6_1_dissect.seconds = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.seconds
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.block_timestamp = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.seconds

  index = index + siac_opra_recipient_obi_v6_1_size_of.nanoseconds

  return index
end

-- Display: Block Timestamp
siac_opra_recipient_obi_v6_1_display.block_timestamp = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.block_timestamp = function(buffer, offset, packet, parent)
  if show.block_timestamp then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.block_timestamp, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.block_timestamp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.block_timestamp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.block_timestamp_fields(buffer, offset, packet, element)
  end
end

-- Size: Messages In Block
siac_opra_recipient_obi_v6_1_size_of.messages_in_block = 1

-- Display: Messages In Block
siac_opra_recipient_obi_v6_1_display.messages_in_block = function(value)
  return "Messages In Block: "..value
end

-- Dissect: Messages In Block
siac_opra_recipient_obi_v6_1_dissect.messages_in_block = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.messages_in_block
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.block_sequence_number = 4

-- Display: Block Sequence Number
siac_opra_recipient_obi_v6_1_display.block_sequence_number = function(value)
  return "Block Sequence Number: "..value
end

-- Dissect: Block Sequence Number
siac_opra_recipient_obi_v6_1_dissect.block_sequence_number = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.block_sequence_number
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.session_indicator = 1

-- Display: Session Indicator
siac_opra_recipient_obi_v6_1_display.session_indicator = function(value)
  if value == 0 then
...
siac_opra_recipient_obi_v6_1_dissect.session_indicator = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.session_indicator
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.retransmission_indicator = 1

-- Display: Retransmission Indicator
siac_opra_recipient_obi_v6_1_display.retransmission_indicator = function(value)
  return "Retransmission Indicator: "..value
end

-- Dissect: Retransmission Indicator
siac_opra_recipient_obi_v6_1_dissect.retransmission_indicator = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.retransmission_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1_size_of.data_feed_indicator = 1

-- Display: Data Feed Indicator
siac_opra_recipient_obi_v6_1_display.data_feed_indicator = function(value)
  return "Data Feed Indicator: "..value
end

-- Dissect: Data Feed Indicator
siac_opra_recipient_obi_v6_1_dissect.data_feed_indicator = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.data_feed_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Block Size
siac_opra_recipient_obi_v6_1_size_of.block_size = 2

-- Display: Block Size
siac_opra_recipient_obi_v6_1_display.block_size = function(value)
  return "Block Size: "..value
end

-- Dissect: Block Size
siac_opra_recipient_obi_v6_1_dissect.block_size = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.block_size
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Version
siac_opra_recipient_obi_v6_1_size_of.version = 1

-- Display: Version
siac_opra_recipient_obi_v6_1_display.version = function(value)
  return "Version: "..value
end

-- Dissect: Version
siac_opra_recipient_obi_v6_1_dissect.version = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1_size_of.version
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1_size_of.block_header = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1_size_of.version

  index = index + siac_opra_recipient_obi_v6_1_size_of.block_size

  index = index + siac_opra_recipient_obi_v6_1_size_of.data_feed_indicator

  index = index + siac_opra_recipient_obi_v6_1_size_of.retransmission_indicator

  index = index + siac_opra_recipient_obi_v6_1_size_of.session_indicator

  index = index + siac_opra_recipient_obi_v6_1_size_of.block_sequence_number

  index = index + siac_opra_recipient_obi_v6_1_size_of.messages_in_block

  index = index + siac_opra_recipient_obi_v6_1_size_of.block_timestamp(buffer, offset + index)

  index = index + siac_opra_recipient_obi_v6_1_size_of.block_checksum

  return index
end

-- Display: Block Header
siac_opra_recipient_obi_v6_1_display.block_header = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1_dissect.block_header = function(buffer, offset, packet, parent)
  if show.block_header then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_opra_recipient_obi_v6_1.fields.block_header, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1_dissect.block_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_opra_recipient_obi_v6_1_display.block_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1_dissect.block_header_fields(buffer, offset, packet, element)
  end
end

-- Dissect Packet
siac_opra_recipient_obi_v6_1_dissect.packet = function(buffer, packet, parent)
  local index = 0

  -- Block Header: Struct of 9 fields
  index, block_header = siac_opra_recipient_obi_v6_1_dissect.block_header(buffer, index, packet, parent)
  ...
  for message_index = 1, messages_in_block do
    index, message = siac_opra_recipient_obi_v6_1_dissect.message(buffer, index, packet, parent)

    if message ~= nil then
      local iteration = message:add(siac_opra_recipient_obi_v6_1.fields.message_index, message_index)
  ...
  if block_pad_byte_exists then
    index, block_pad_byte = siac_opra_recipient_obi_v6_1_dissect.block_pad_byte(buffer, index, packet, parent)
  end
