...
siac_opra_recipient_obi_v6_1.block_pad_byte.display = function(value)
  return "Block Pad Byte: "..value
end

-- Dissect: Block Pad Byte
siac_opra_recipient_obi_v6_1.block_pad_byte.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.block_pad_byte.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.block_pad_byte.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.offer_index_value.display = function(value)
  return "Offer Index Value: "..value
end

-- Dissect: Offer Index Value
siac_opra_recipient_obi_v6_1.offer_index_value.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.offer_index_value.size
  local range = buffer(offset, length)
  local value = range:int64()
  local display = siac_opra_recipient_obi_v6_1.offer_index_value.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.bid_index_value.display = function(value)
  return "Bid Index Value: "..value
end

-- Dissect: Bid Index Value
siac_opra_recipient_obi_v6_1.bid_index_value.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.bid_index_value.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.bid_index_value.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.index_value_denominator_code.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.index_value_denominator_code.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.index_value_denominator_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.index_value_denominator_code.display(value, buffer, offset, packet, parent)
...
-- Display: Reserved 1
siac_opra_recipient_obi_v6_1.reserved_1.display = function(value)
...
siac_opra_recipient_obi_v6_1.security_symbol.display = function(value)
  return "Security Symbol: "..value
end

-- Dissect: Security Symbol
siac_opra_recipient_obi_v6_1.security_symbol.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.security_symbol.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.security_symbol.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.participant_reference_number.display = function(value)
  return "Participant Reference Number: "..value
end

-- Dissect: Participant Reference Number
siac_opra_recipient_obi_v6_1.participant_reference_number.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.participant_reference_number.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.participant_reference_number.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.transaction_id.display = function(value)
  return "Transaction Id: "..value
end

-- Dissect: Transaction Id
siac_opra_recipient_obi_v6_1.transaction_id.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.transaction_id.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.transaction_id.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.message_indicator.display = function(value)
  return "Message Indicator: "..value
end

-- Dissect: Message Indicator
siac_opra_recipient_obi_v6_1.message_indicator.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.message_indicator.size
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, transaction_id = siac_opra_recipient_obi_v6_1.transaction_id.dissect(buffer, index, packet, parent)

  -- Participant Reference Number: unsigned integer
  index, participant_reference_number = siac_opra_recipient_obi_v6_1.participant_reference_number.dissect(buffer, index, packet, parent)

  -- Security Symbol: Alphanumeric
  index, security_symbol = siac_opra_recipient_obi_v6_1.security_symbol.dissect(buffer, index, packet, parent)

  -- Reserved 1: unsigned integer
  index, reserved_1 = siac_opra_recipient_obi_v6_1.reserved_1.dissect(buffer, index, packet, parent)

  -- Index Value Denominator Code: alphabetic
  index, index_value_denominator_code = siac_opra_recipient_obi_v6_1.index_value_denominator_code.dissect(buffer, index, packet, parent)

  -- Bid Index Value: signed integer
  index, bid_index_value = siac_opra_recipient_obi_v6_1.bid_index_value.dissect(buffer, index, packet, parent)

  -- Offer Index Value: signed integer
  index, offer_index_value = siac_opra_recipient_obi_v6_1.offer_index_value.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Underlying Value Bid And Offer Message
siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.dissect = function(buffer, offset, packet, parent)
  if show.underlying_value_bid_and_offer_message then
    ...
    local index = siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.fields(buffer, offset, packet, parent)
  end
end
...
-- Display: Reserved 4
siac_opra_recipient_obi_v6_1.reserved_4.display = function(value)
...
-- Display: Index Value
siac_opra_recipient_obi_v6_1.index_value.display = function(value)
  return "Index Value: "..value
end

-- Dissect: Index Value
siac_opra_recipient_obi_v6_1.index_value.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.index_value.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.index_value.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, index_value = siac_opra_recipient_obi_v6_1.index_value.dissect(buffer, index, packet, parent)

  -- Reserved 4: unsigned integer
  index, reserved_4 = siac_opra_recipient_obi_v6_1.reserved_4.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Underlying Value Last Sale Message
siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.dissect = function(buffer, offset, packet, parent)
  if show.underlying_value_last_sale_message then
    ...
    local index = siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.fields(buffer, offset, packet, parent)
  end
end

-- Underlying Value Message Payload
siac_opra_recipient_obi_v6_1.underlying_value_message_payload = {}

-- Calculate runtime size of: Underlying Value Message Payload
siac_opra_recipient_obi_v6_1.underlying_value_message_payload.size = function(buffer, offset, underlying_value_message_type)
  -- Size of Underlying Value Last Sale Message
  if underlying_value_message_type == " " then
    return siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.size(buffer, offset)
  end
  -- Size of Underlying Value Bid And Offer Message
  if underlying_value_message_type == "I" then
    return siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.size(buffer, offset)
  end
...
siac_opra_recipient_obi_v6_1.underlying_value_message_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Underlying Value Message Payload
siac_opra_recipient_obi_v6_1.underlying_value_message_payload.branches = function(buffer, offset, packet, parent, underlying_value_message_type)
  -- Dissect Underlying Value Last Sale Message
  if underlying_value_message_type == " " then
    return siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Underlying Value Bid And Offer Message
  if underlying_value_message_type == "I" then
    return siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.dissect(buffer, offset, packet, parent)
  end
...
siac_opra_recipient_obi_v6_1.underlying_value_message_payload.dissect = function(buffer, offset, packet, parent, underlying_value_message_type)
  ...
  local display = siac_opra_recipient_obi_v6_1.underlying_value_message_payload.display(buffer, packet, parent)
...
siac_opra_recipient_obi_v6_1.underlying_value_message_type.display = function(value)
  if value == " " then
...
siac_opra_recipient_obi_v6_1.underlying_value_message_type.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.underlying_value_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.underlying_value_message_type.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.underlying_value_message.fields = function(buffer, offset, packet, parent)
  ...
  index, underlying_value_message_type = siac_opra_recipient_obi_v6_1.underlying_value_message_type.dissect(buffer, index, packet, parent)

  -- Underlying Value Message Payload: Runtime Type with 2 branches
  index = siac_opra_recipient_obi_v6_1.underlying_value_message_payload.dissect(buffer, index, packet, parent, underlying_value_message_type)
...
-- Message Data
siac_opra_recipient_obi_v6_1.message_data = {}

-- Display: Message Data
siac_opra_recipient_obi_v6_1.message_data.display = function(value)
  return "Message Data: "..value
end

-- Dissect runtime sized field: Message Data
siac_opra_recipient_obi_v6_1.message_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.message_data.display(value, buffer, offset, packet, parent, size)
...
siac_opra_recipient_obi_v6_1.message_data_length.display = function(value)
  return "Message Data Length: "..value
end

-- Dissect: Message Data Length
siac_opra_recipient_obi_v6_1.message_data_length.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.message_data_length.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.message_data_length.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.control_message_type.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.control_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.control_message_type.display(value, buffer, offset, packet, parent)
...
-- Control Message
siac_opra_recipient_obi_v6_1.control_message = {}
...
siac_opra_recipient_obi_v6_1.control_message.display = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1.control_message.fields = function(buffer, offset, packet, parent)
  ...
  index, message_data_length = siac_opra_recipient_obi_v6_1.message_data_length.dissect(buffer, index, packet, parent)
  ...
  if message_data_exists then
    ...
    index, message_data = siac_opra_recipient_obi_v6_1.message_data.dissect(buffer, index, packet, parent, message_data_length)
  end
...
siac_opra_recipient_obi_v6_1.administrative_message.size = function(buffer, offset)
  local index = offset
...
siac_opra_recipient_obi_v6_1.administrative_message.display = function(packet, parent, length)
  return ""
end
...
-- Display: Size
siac_opra_recipient_obi_v6_1.size.display = function(value)
  return "Size: "..value
end

-- Dissect: Size
siac_opra_recipient_obi_v6_1.size.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.size.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.size.display(value, buffer, offset, packet, parent)

  parent:add(omi_siac_opra_recipient_obi_v6_1.fields.size, range, value, display)
...
-- Display: Price
siac_opra_recipient_obi_v6_1.price.display = function(value)
  return "Price: "..value
end

-- Dissect: Price
siac_opra_recipient_obi_v6_1.price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.denominator_code.display = function(value)
  return "Denominator Code: "..value
end

-- Dissect: Denominator Code
siac_opra_recipient_obi_v6_1.denominator_code.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.denominator_code.size
  local range = buffer(offset, length)
  local value = range:string()
...
siac_opra_recipient_obi_v6_1.participant_id.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.participant_id.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.participant_id.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.participant_id.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_offer_appendage.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Participant Id: ASCII character
  index, participant_id = siac_opra_recipient_obi_v6_1.participant_id.dissect(buffer, index, packet, parent)

  -- Denominator Code: alphabetic
  index, denominator_code = siac_opra_recipient_obi_v6_1.denominator_code.dissect(buffer, index, packet, parent)

  -- Price: signed integer
  index, price = siac_opra_recipient_obi_v6_1.price.dissect(buffer, index, packet, parent)

  -- Size: unsigned integer
  index, size = siac_opra_recipient_obi_v6_1.size.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Best Offer Appendage
siac_opra_recipient_obi_v6_1.best_offer_appendage.dissect = function(buffer, offset, packet, parent)
  if show.best_offer_appendage then
    ...
    local index = siac_opra_recipient_obi_v6_1.best_offer_appendage.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.best_offer_appendage.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.best_offer_appendage.fields(buffer, offset, packet, parent)
  end
end
...
siac_opra_recipient_obi_v6_1.best_bid_appendage.fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_opra_recipient_obi_v6_1.best_bid_appendage.dissect = function(buffer, offset, packet, parent)
  if show.best_bid_appendage then
    ...
    local index = siac_opra_recipient_obi_v6_1.best_bid_appendage.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.best_bid_appendage.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.best_bid_appendage.fields(buffer, offset, packet, parent)
  end
end
...
siac_opra_recipient_obi_v6_1.offer_size_short.display = function(value)
  return "Offer Size Short: "..value
end

-- Dissect: Offer Size Short
siac_opra_recipient_obi_v6_1.offer_size_short.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.offer_size_short.size
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1.offer_price_short.display = function(value)
  return "Offer Price Short: "..value
end

-- Dissect: Offer Price Short
siac_opra_recipient_obi_v6_1.offer_price_short.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.offer_price_short.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.offer_price_short.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.bid_size_short.display = function(value)
  return "Bid Size Short: "..value
end

-- Dissect: Bid Size Short
siac_opra_recipient_obi_v6_1.bid_size_short.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.bid_size_short.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.bid_size_short.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.bid_price_short.display = function(value)
  return "Bid Price Short: "..value
end

-- Dissect: Bid Price Short
siac_opra_recipient_obi_v6_1.bid_price_short.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.bid_price_short.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.bid_price_short.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.strike_price_short.display = function(value)
  return "Strike Price Short: "..value
end

-- Dissect: Strike Price Short
siac_opra_recipient_obi_v6_1.strike_price_short.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.strike_price_short.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.strike_price_short.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.expiration_year.display = function(value)
  return "Expiration Year: "..value
end

-- Dissect: Expiration Year
siac_opra_recipient_obi_v6_1.expiration_year.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.expiration_year.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.expiration_year.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.expiration_day.display = function(value)
  return "Expiration Day: "..value
end

-- Dissect: Expiration Day
siac_opra_recipient_obi_v6_1.expiration_day.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.expiration_day.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.expiration_day.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.expiration_month.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.expiration_month.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.expiration_month.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.expiration_month.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.expiration_block.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Expiration Month: alphabetic
  index, expiration_month = siac_opra_recipient_obi_v6_1.expiration_month.dissect(buffer, index, packet, parent)

  -- Expiration Day: unsigned integer
  index, expiration_day = siac_opra_recipient_obi_v6_1.expiration_day.dissect(buffer, index, packet, parent)

  -- Expiration Year: unsigned integer
  index, expiration_year = siac_opra_recipient_obi_v6_1.expiration_year.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Expiration Block
siac_opra_recipient_obi_v6_1.expiration_block.dissect = function(buffer, offset, packet, parent)
  if show.expiration_block then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_siac_opra_recipient_obi_v6_1.fields.expiration_block, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1.expiration_block.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.expiration_block.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.expiration_block.fields(buffer, offset, packet, parent)
  end
end
...
siac_opra_recipient_obi_v6_1.security_symbol_short.display = function(value)
  return "Security Symbol Short: "..value
end

-- Dissect: Security Symbol Short
siac_opra_recipient_obi_v6_1.security_symbol_short.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.security_symbol_short.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.security_symbol_short.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.bbo_indicator.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.bbo_indicator.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.bbo_indicator.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.bbo_indicator.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.short_equity_and_index_quote_message = {}
...
siac_opra_recipient_obi_v6_1.short_equity_and_index_quote_message.size = function(buffer, offset)
  ...
  index = index + siac_opra_recipient_obi_v6_1.bid_price_short.size

  index = index + siac_opra_recipient_obi_v6_1.bid_size_short.size

  index = index + siac_opra_recipient_obi_v6_1.offer_price_short.size
...
siac_opra_recipient_obi_v6_1.short_equity_and_index_quote_message.display = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1.short_equity_and_index_quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, security_symbol_short = siac_opra_recipient_obi_v6_1.security_symbol_short.dissect(buffer, index, packet, parent)

  -- Expiration Block: Struct of 3 fields
  index, expiration_block = siac_opra_recipient_obi_v6_1.expiration_block.dissect(buffer, index, packet, parent)

  -- Strike Price Short: unsigned integer
  index, strike_price_short = siac_opra_recipient_obi_v6_1.strike_price_short.dissect(buffer, index, packet, parent)

  -- Bid Price Short: signed integer
  index, bid_price_short = siac_opra_recipient_obi_v6_1.bid_price_short.dissect(buffer, index, packet, parent)

  -- Bid Size Short: unsigned integer
  index, bid_size_short = siac_opra_recipient_obi_v6_1.bid_size_short.dissect(buffer, index, packet, parent)

  -- Offer Price Short: signed integer
  index, offer_price_short = siac_opra_recipient_obi_v6_1.offer_price_short.dissect(buffer, index, packet, parent)

  -- Offer Size Short: unsigned integer
  index, offer_size_short = siac_opra_recipient_obi_v6_1.offer_size_short.dissect(buffer, index, packet, parent)
  ...
  if best_bid_appendage_exists then
    index, best_bid_appendage = siac_opra_recipient_obi_v6_1.best_bid_appendage.dissect(buffer, index, packet, parent)
  end
  ...
  if best_offer_appendage_exists then
    index, best_offer_appendage = siac_opra_recipient_obi_v6_1.best_offer_appendage.dissect(buffer, index, packet, parent)
  end
...
siac_opra_recipient_obi_v6_1.best_offer_size.display = function(value)
  return "Best Offer Size: "..value
end

-- Dissect: Best Offer Size
siac_opra_recipient_obi_v6_1.best_offer_size.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_offer_size.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.best_offer_size.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_offer_price.display = function(value)
  return "Best Offer Price: "..value
end

-- Dissect: Best Offer Price
siac_opra_recipient_obi_v6_1.best_offer_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_offer_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.best_offer_price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_offer_denominator_code.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.best_offer_denominator_code.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_offer_denominator_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.best_offer_denominator_code.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_offer_participant_id.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.best_offer_participant_id.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_offer_participant_id.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.best_offer_participant_id.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_bid_size.display = function(value)
  return "Best Bid Size: "..value
end

-- Dissect: Best Bid Size
siac_opra_recipient_obi_v6_1.best_bid_size.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_bid_size.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.best_bid_size.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_bid_price.display = function(value)
  return "Best Bid Price: "..value
end

-- Dissect: Best Bid Price
siac_opra_recipient_obi_v6_1.best_bid_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_bid_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.best_bid_price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_bid_denominator_code.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.best_bid_denominator_code.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_bid_denominator_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.best_bid_denominator_code.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_bid_participant_id.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.best_bid_participant_id.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.best_bid_participant_id.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.best_bid_participant_id.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.best_bid_and_offer_appendage.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Best Bid Participant Id: alphabetic
  index, best_bid_participant_id = siac_opra_recipient_obi_v6_1.best_bid_participant_id.dissect(buffer, index, packet, parent)

  -- Best Bid Denominator Code: alphabetic
  index, best_bid_denominator_code = siac_opra_recipient_obi_v6_1.best_bid_denominator_code.dissect(buffer, index, packet, parent)

  -- Best Bid Price: signed integer
  index, best_bid_price = siac_opra_recipient_obi_v6_1.best_bid_price.dissect(buffer, index, packet, parent)

  -- Best Bid Size: unsigned integer
  index, best_bid_size = siac_opra_recipient_obi_v6_1.best_bid_size.dissect(buffer, index, packet, parent)

  -- Best Offer Participant Id: alphabetic
  index, best_offer_participant_id = siac_opra_recipient_obi_v6_1.best_offer_participant_id.dissect(buffer, index, packet, parent)

  -- Best Offer Denominator Code: alphabetic
  index, best_offer_denominator_code = siac_opra_recipient_obi_v6_1.best_offer_denominator_code.dissect(buffer, index, packet, parent)

  -- Best Offer Price: signed integer
  index, best_offer_price = siac_opra_recipient_obi_v6_1.best_offer_price.dissect(buffer, index, packet, parent)

  -- Best Offer Size: unsigned integer
  index, best_offer_size = siac_opra_recipient_obi_v6_1.best_offer_size.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Best Bid And Offer Appendage
siac_opra_recipient_obi_v6_1.best_bid_and_offer_appendage.dissect = function(buffer, offset, packet, parent)
  if show.best_bid_and_offer_appendage then
    ...
    local index = siac_opra_recipient_obi_v6_1.best_bid_and_offer_appendage.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.best_bid_and_offer_appendage.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.best_bid_and_offer_appendage.fields(buffer, offset, packet, parent)
  end
end
...
-- Display: Offer Size
siac_opra_recipient_obi_v6_1.offer_size.display = function(value)
  return "Offer Size: "..value
end

-- Dissect: Offer Size
siac_opra_recipient_obi_v6_1.offer_size.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.offer_size.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.offer_size.display(value, buffer, offset, packet, parent)
...
-- Display: Offer Price
siac_opra_recipient_obi_v6_1.offer_price.display = function(value)
  return "Offer Price: "..value
end

-- Dissect: Offer Price
siac_opra_recipient_obi_v6_1.offer_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.offer_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.offer_price.display(value, buffer, offset, packet, parent)
...
-- Display: Bid Size
siac_opra_recipient_obi_v6_1.bid_size.display = function(value)
  return "Bid Size: "..value
end

-- Dissect: Bid Size
siac_opra_recipient_obi_v6_1.bid_size.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.bid_size.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.bid_size.display(value, buffer, offset, packet, parent)
...
-- Display: Bid Price
siac_opra_recipient_obi_v6_1.bid_price.display = function(value)
  return "Bid Price: "..value
end

-- Dissect: Bid Price
siac_opra_recipient_obi_v6_1.bid_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.bid_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.bid_price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.premium_price_denominator_code.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.premium_price_denominator_code.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.premium_price_denominator_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.premium_price_denominator_code.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.strike_price.display = function(value)
  return "Strike Price: "..value
end

-- Dissect: Strike Price
siac_opra_recipient_obi_v6_1.strike_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.strike_price.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.strike_price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.strike_price_denominator_code.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.strike_price_denominator_code.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.strike_price_denominator_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.strike_price_denominator_code.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.long_equity_and_index_quote_message = {}
...
siac_opra_recipient_obi_v6_1.long_equity_and_index_quote_message.size = function(buffer, offset)
  ...
  index = index + siac_opra_recipient_obi_v6_1.bid_size.size
...
siac_opra_recipient_obi_v6_1.long_equity_and_index_quote_message.display = function(packet, parent, length)
  return ""
end
...
siac_opra_recipient_obi_v6_1.long_equity_and_index_quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, strike_price_denominator_code = siac_opra_recipient_obi_v6_1.strike_price_denominator_code.dissect(buffer, index, packet, parent)

  -- Strike Price: unsigned integer
  index, strike_price = siac_opra_recipient_obi_v6_1.strike_price.dissect(buffer, index, packet, parent)

  -- Premium Price Denominator Code: alphabetic
  index, premium_price_denominator_code = siac_opra_recipient_obi_v6_1.premium_price_denominator_code.dissect(buffer, index, packet, parent)

  -- Bid Price: signed integer
  index, bid_price = siac_opra_recipient_obi_v6_1.bid_price.dissect(buffer, index, packet, parent)

  -- Bid Size: unsigned integer
  index, bid_size = siac_opra_recipient_obi_v6_1.bid_size.dissect(buffer, index, packet, parent)

  -- Offer Price: signed integer
  index, offer_price = siac_opra_recipient_obi_v6_1.offer_price.dissect(buffer, index, packet, parent)

  -- Offer Size: unsigned integer
  index, offer_size = siac_opra_recipient_obi_v6_1.offer_size.dissect(buffer, index, packet, parent)
  ...
  if best_bid_and_offer_appendage_exists then
    index, best_bid_and_offer_appendage = siac_opra_recipient_obi_v6_1.best_bid_and_offer_appendage.dissect(buffer, index, packet, parent)
  end
...
siac_opra_recipient_obi_v6_1.underlying_price.display = function(value)
  return "Underlying Price: "..value
end

-- Dissect: Underlying Price
siac_opra_recipient_obi_v6_1.underlying_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.underlying_price.size
  local range = buffer(offset, length)
  local value = range:int64()
  local display = siac_opra_recipient_obi_v6_1.underlying_price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.underlying_price_denominator_code.display = function(value)
  if value == "A" then
...
siac_opra_recipient_obi_v6_1.underlying_price_denominator_code.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.underlying_price_denominator_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.underlying_price_denominator_code.display(value, buffer, offset, packet, parent)
...
-- Display: Net Change
siac_opra_recipient_obi_v6_1.net_change.display = function(value)
  return "Net Change: "..value
end

-- Dissect: Net Change
siac_opra_recipient_obi_v6_1.net_change.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.net_change.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.net_change.display(value, buffer, offset, packet, parent)
...
-- Display: Last Price
siac_opra_recipient_obi_v6_1.last_price.display = function(value)
  return "Last Price: "..value
end

-- Dissect: Last Price
siac_opra_recipient_obi_v6_1.last_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.last_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.last_price.display(value, buffer, offset, packet, parent)
...
-- Display: Low Price
siac_opra_recipient_obi_v6_1.low_price.display = function(value)
  return "Low Price: "..value
end

-- Dissect: Low Price
siac_opra_recipient_obi_v6_1.low_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.low_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.low_price.display(value, buffer, offset, packet, parent)
...
-- Display: High Price
siac_opra_recipient_obi_v6_1.high_price.display = function(value)
  return "High Price: "..value
end

-- Dissect: High Price
siac_opra_recipient_obi_v6_1.high_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.high_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.high_price.display(value, buffer, offset, packet, parent)
...
-- Display: Open Price
siac_opra_recipient_obi_v6_1.open_price.display = function(value)
  return "Open Price: "..value
end

-- Dissect: Open Price
siac_opra_recipient_obi_v6_1.open_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.open_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.open_price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.open_interest_volume.display = function(value)
  return "Open Interest Volume: "..value
end

-- Dissect: Open Interest Volume
siac_opra_recipient_obi_v6_1.open_interest_volume.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.open_interest_volume.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.open_interest_volume.display(value, buffer, offset, packet, parent)
...
-- Display: Volume
siac_opra_recipient_obi_v6_1.volume.display = function(value)
  return "Volume: "..value
end

-- Dissect: Volume
siac_opra_recipient_obi_v6_1.volume.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.volume.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.volume.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.equity_and_index_end_of_day_summary_message.fields = function(buffer, offset, packet, parent)
  ...
  index, volume = siac_opra_recipient_obi_v6_1.volume.dissect(buffer, index, packet, parent)

  -- Open Interest Volume: unsigned integer
  index, open_interest_volume = siac_opra_recipient_obi_v6_1.open_interest_volume.dissect(buffer, index, packet, parent)

  -- Premium Price Denominator Code: alphabetic
  index, premium_price_denominator_code = siac_opra_recipient_obi_v6_1.premium_price_denominator_code.dissect(buffer, index, packet, parent)

  -- Open Price: signed integer
  index, open_price = siac_opra_recipient_obi_v6_1.open_price.dissect(buffer, index, packet, parent)

  -- High Price: signed integer
  index, high_price = siac_opra_recipient_obi_v6_1.high_price.dissect(buffer, index, packet, parent)

  -- Low Price: signed integer
  index, low_price = siac_opra_recipient_obi_v6_1.low_price.dissect(buffer, index, packet, parent)

  -- Last Price: signed integer
  index, last_price = siac_opra_recipient_obi_v6_1.last_price.dissect(buffer, index, packet, parent)

  -- Net Change: signed integer
  index, net_change = siac_opra_recipient_obi_v6_1.net_change.dissect(buffer, index, packet, parent)

  -- Underlying Price Denominator Code: alphabetic
  index, underlying_price_denominator_code = siac_opra_recipient_obi_v6_1.underlying_price_denominator_code.dissect(buffer, index, packet, parent)

  -- Underlying Price: signed integer
  index, underlying_price = siac_opra_recipient_obi_v6_1.underlying_price.dissect(buffer, index, packet, parent)
...
siac_opra_recipient_obi_v6_1.equity_and_index_end_of_day_summary_message.dissect = function(buffer, offset, packet, parent)
  if show.equity_and_index_end_of_day_summary_message then
    ...
    local index = siac_opra_recipient_obi_v6_1.equity_and_index_end_of_day_summary_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.equity_and_index_end_of_day_summary_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.equity_and_index_end_of_day_summary_message.fields(buffer, offset, packet, parent)
  end
end
...
siac_opra_recipient_obi_v6_1.open_interest_message.dissect = function(buffer, offset, packet, parent)
  if show.open_interest_message then
    ...
    local index = siac_opra_recipient_obi_v6_1.open_interest_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.open_interest_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.open_interest_message.fields(buffer, offset, packet, parent)
  end
end
...
siac_opra_recipient_obi_v6_1.trade_identifier.display = function(value)
  return "Trade Identifier: "..value
end

-- Dissect: Trade Identifier
siac_opra_recipient_obi_v6_1.trade_identifier.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.trade_identifier.size
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1.premium_price.display = function(value)
  return "Premium Price: "..value
end

-- Dissect: Premium Price
siac_opra_recipient_obi_v6_1.premium_price.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.premium_price.size
  local range = buffer(offset, length)
  local value = range:int()
  local display = siac_opra_recipient_obi_v6_1.premium_price.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.equity_and_index_last_sale_message.fields = function(buffer, offset, packet, parent)
  ...
  index, premium_price = siac_opra_recipient_obi_v6_1.premium_price.dissect(buffer, index, packet, parent)

  -- Trade Identifier: unsigned integer
  index, trade_identifier = siac_opra_recipient_obi_v6_1.trade_identifier.dissect(buffer, index, packet, parent)
...
siac_opra_recipient_obi_v6_1.equity_and_index_last_sale_message.dissect = function(buffer, offset, packet, parent)
  if show.equity_and_index_last_sale_message then
    ...
    local index = siac_opra_recipient_obi_v6_1.equity_and_index_last_sale_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.equity_and_index_last_sale_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.equity_and_index_last_sale_message.fields(buffer, offset, packet, parent)
  end
end
...
siac_opra_recipient_obi_v6_1.payload.size = function(buffer, offset, message_category)
  -- Size of Equity And Index Last Sale Message
  if message_category == "a" then
    return siac_opra_recipient_obi_v6_1.equity_and_index_last_sale_message.size(buffer, offset)
  end
  -- Size of Open Interest Message
  if message_category == "d" then
    return siac_opra_recipient_obi_v6_1.open_interest_message.size(buffer, offset)
  end
  -- Size of Equity And Index End Of Day Summary Message
  if message_category == "f" then
    return siac_opra_recipient_obi_v6_1.equity_and_index_end_of_day_summary_message.size(buffer, offset)
  end
  -- Size of Long Equity And Index Quote Message
  if message_category == "k" then
    return siac_opra_recipient_obi_v6_1.long_equity_and_index_quote_message.size(buffer, offset)
  end
  -- Size of Short Equity And Index Quote Message
  if message_category == "q" then
    return siac_opra_recipient_obi_v6_1.short_equity_and_index_quote_message.size(buffer, offset)
  end
  -- Size of Administrative Message
  if message_category == "C" then
    return siac_opra_recipient_obi_v6_1.administrative_message.size(buffer, offset)
  end
  -- Size of Control Message
  if message_category == "H" then
    return siac_opra_recipient_obi_v6_1.control_message.size(buffer, offset)
  end
  -- Size of Underlying Value Message
  if message_category == "Y" then
    return siac_opra_recipient_obi_v6_1.underlying_value_message.size(buffer, offset)
  end
...
-- Display: Payload
siac_opra_recipient_obi_v6_1.payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
siac_opra_recipient_obi_v6_1.payload.branches = function(buffer, offset, packet, parent, message_category)
  -- Dissect Equity And Index Last Sale Message
  if message_category == "a" then
...
siac_opra_recipient_obi_v6_1.payload.dissect = function(buffer, offset, packet, parent, message_category)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_opra_recipient_obi_v6_1.payload.display(buffer, packet, parent)
...
siac_opra_recipient_obi_v6_1.message_category.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.message_category.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.message_category.display(value, buffer, offset, packet, parent)
...
-- Message
siac_opra_recipient_obi_v6_1.message = {}

-- Calculate size of: Message
siac_opra_recipient_obi_v6_1.message.size = function(buffer, offset)
  local index = 0

  index = index + siac_opra_recipient_obi_v6_1.participant_id.size

  index = index + siac_opra_recipient_obi_v6_1.message_category.size
...
-- Display: Message
siac_opra_recipient_obi_v6_1.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
siac_opra_recipient_obi_v6_1.message.fields = function(buffer, offset, packet, parent, message_index)
  local index = offset
  ...
  index, message_category = siac_opra_recipient_obi_v6_1.message_category.dissect(buffer, index, packet, parent)

  -- Payload: Runtime Type with 8 branches
  index = siac_opra_recipient_obi_v6_1.payload.dissect(buffer, index, packet, parent, message_category)
...
siac_opra_recipient_obi_v6_1.block_checksum.display = function(value)
  return "Block Checksum: "..value
end

-- Dissect: Block Checksum
siac_opra_recipient_obi_v6_1.block_checksum.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.block_checksum.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.block_checksum.display(value, buffer, offset, packet, parent)
...
-- Display: Nanoseconds
siac_opra_recipient_obi_v6_1.nanoseconds.display = function(value)
  return "Nanoseconds: "..value
end

-- Dissect: Nanoseconds
siac_opra_recipient_obi_v6_1.nanoseconds.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.nanoseconds.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.nanoseconds.display(value, buffer, offset, packet, parent)
...
-- Display: Seconds
siac_opra_recipient_obi_v6_1.seconds.display = function(value)
  return "Seconds: "..value
end

-- Dissect: Seconds
siac_opra_recipient_obi_v6_1.seconds.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.seconds.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.seconds.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.block_timestamp.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Seconds: unsigned integer
  index, seconds = siac_opra_recipient_obi_v6_1.seconds.dissect(buffer, index, packet, parent)

  -- Nanoseconds: unsigned integer
  index, nanoseconds = siac_opra_recipient_obi_v6_1.nanoseconds.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Block Timestamp
siac_opra_recipient_obi_v6_1.block_timestamp.dissect = function(buffer, offset, packet, parent)
  if show.block_timestamp then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_siac_opra_recipient_obi_v6_1.fields.block_timestamp, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1.block_timestamp.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.block_timestamp.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.block_timestamp.fields(buffer, offset, packet, parent)
  end
end
...
siac_opra_recipient_obi_v6_1.messages_in_block.display = function(value)
  return "Messages In Block: "..value
end

-- Dissect: Messages In Block
siac_opra_recipient_obi_v6_1.messages_in_block.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.messages_in_block.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.messages_in_block.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.block_sequence_number.display = function(value)
  return "Block Sequence Number: "..value
end

-- Dissect: Block Sequence Number
siac_opra_recipient_obi_v6_1.block_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.block_sequence_number.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.block_sequence_number.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.session_indicator.display = function(value)
  if value == 0 then
...
siac_opra_recipient_obi_v6_1.session_indicator.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.session_indicator.size
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_opra_recipient_obi_v6_1.retransmission_indicator.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.retransmission_indicator.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.retransmission_indicator.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.data_feed_indicator.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.data_feed_indicator.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_opra_recipient_obi_v6_1.data_feed_indicator.display(value, buffer, offset, packet, parent)
...
-- Display: Block Size
siac_opra_recipient_obi_v6_1.block_size.display = function(value)
  return "Block Size: "..value
end

-- Dissect: Block Size
siac_opra_recipient_obi_v6_1.block_size.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.block_size.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.block_size.display(value, buffer, offset, packet, parent)
...
-- Display: Version
siac_opra_recipient_obi_v6_1.version.display = function(value)
  return "Version: "..value
end

-- Dissect: Version
siac_opra_recipient_obi_v6_1.version.dissect = function(buffer, offset, packet, parent)
  local length = siac_opra_recipient_obi_v6_1.version.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = siac_opra_recipient_obi_v6_1.version.display(value, buffer, offset, packet, parent)
...
siac_opra_recipient_obi_v6_1.block_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Version: unsigned integer
  index, version = siac_opra_recipient_obi_v6_1.version.dissect(buffer, index, packet, parent)

  -- Block Size: unsigned integer
  index, block_size = siac_opra_recipient_obi_v6_1.block_size.dissect(buffer, index, packet, parent)

  -- Data Feed Indicator: ASCII character
  index, data_feed_indicator = siac_opra_recipient_obi_v6_1.data_feed_indicator.dissect(buffer, index, packet, parent)

  -- Retransmission Indicator: ASCII character
  index, retransmission_indicator = siac_opra_recipient_obi_v6_1.retransmission_indicator.dissect(buffer, index, packet, parent)

  -- Session Indicator: unsigned integer
  index, session_indicator = siac_opra_recipient_obi_v6_1.session_indicator.dissect(buffer, index, packet, parent)

  -- Block Sequence Number: unsigned integer
  index, block_sequence_number = siac_opra_recipient_obi_v6_1.block_sequence_number.dissect(buffer, index, packet, parent)

  -- Messages In Block: unsigned integer
  index, messages_in_block = siac_opra_recipient_obi_v6_1.messages_in_block.dissect(buffer, index, packet, parent)

  -- Block Timestamp: Struct of 2 fields
  index, block_timestamp = siac_opra_recipient_obi_v6_1.block_timestamp.dissect(buffer, index, packet, parent)

  -- Block Checksum: unsigned integer
  index, block_checksum = siac_opra_recipient_obi_v6_1.block_checksum.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Block Header
siac_opra_recipient_obi_v6_1.block_header.dissect = function(buffer, offset, packet, parent)
  if show.block_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_siac_opra_recipient_obi_v6_1.fields.block_header, buffer(offset, 0))
    local index = siac_opra_recipient_obi_v6_1.block_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_opra_recipient_obi_v6_1.block_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_opra_recipient_obi_v6_1.block_header.fields(buffer, offset, packet, parent)
  end
end
