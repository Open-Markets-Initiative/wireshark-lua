...
-- Size: Underlying Value Message Payload
siac_opra_recipient_obi_v6_1.underlying_value_message_payload.size = function(buffer, offset, underlying_value_message_type)
  ...
  if underlying_value_message_type == " " then
    return siac_opra_recipient_obi_v6_1.underlying_value_last_sale_message.size
  end
  -- Size of Underlying Value Bid And Offer Message
  if underlying_value_message_type == "I" then
    return siac_opra_recipient_obi_v6_1.underlying_value_bid_and_offer_message.size
  end
...
siac_opra_recipient_obi_v6_1.payload.size = function(buffer, offset, message_category)
  ...
  if message_category == "a" then
    return siac_opra_recipient_obi_v6_1.equity_and_index_last_sale_message.size
  end
  -- Size of Open Interest Message
  if message_category == "d" then
    return siac_opra_recipient_obi_v6_1.open_interest_message.size
  end
  -- Size of Equity And Index End Of Day Summary Message
  if message_category == "f" then
    return siac_opra_recipient_obi_v6_1.equity_and_index_end_of_day_summary_message.size
  end
