...
local show = {}
local format = {}
local siac_cts_output_cta_v2_10_display = {}
local siac_cts_output_cta_v2_10_dissect = {}
local siac_cts_output_cta_v2_10_size_of = {}
local verify = {}
local translate = {}
...
show.fractional_approximate_adjusted_volume_market_center_message = true
show.fractional_consolidated_data = true
show.fractional_consolidated_end_of_day_summary_message = true
show.fractional_corrected_trade = true
show.fractional_long_trade_message = true
show.fractional_original_trade = true
...
show.fractional_trade_cancel_error_message = true
show.fractional_trade_correction_message = true
show.index = true
...
-- Size: Block Pad Byte
siac_cts_output_cta_v2_10_size_of.block_pad_byte = 1

-- Display: Block Pad Byte
siac_cts_output_cta_v2_10_display.block_pad_byte = function(value)
  return "Block Pad Byte: "..value
end

-- Dissect: Block Pad Byte
siac_cts_output_cta_v2_10_dissect.block_pad_byte = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.block_pad_byte
...
-- Size: Tick
siac_cts_output_cta_v2_10_size_of.tick = 1

-- Display: Tick
siac_cts_output_cta_v2_10_display.tick = function(value)
  if value == " " then
...
-- Dissect: Tick
siac_cts_output_cta_v2_10_dissect.tick = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.tick
  local range = buffer(offset, length)
...
siac_cts_output_cta_v2_10_size_of.fractional_total_volume = 8

-- Display: Fractional Total Volume
siac_cts_output_cta_v2_10_display.fractional_total_volume = function(value)
  return "Fractional Total Volume: "..value
end

-- Dissect: Fractional Total Volume
siac_cts_output_cta_v2_10_dissect.fractional_total_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.fractional_total_volume
  local range = buffer(offset, length)
...
-- Display: Low Price
siac_cts_output_cta_v2_10_display.low_price = function(value)
...
-- Dissect: Low Price
siac_cts_output_cta_v2_10_dissect.low_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.low_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
-- Size: High Price
siac_cts_output_cta_v2_10_size_of.high_price = 8

-- Display: High Price
siac_cts_output_cta_v2_10_display.high_price = function(value)
...
-- Dissect: High Price
siac_cts_output_cta_v2_10_dissect.high_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.high_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
-- Size: Last Price
siac_cts_output_cta_v2_10_size_of.last_price = 8

-- Display: Last Price
siac_cts_output_cta_v2_10_display.last_price = function(value)
...
-- Dissect: Last Price
siac_cts_output_cta_v2_10_dissect.last_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.last_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_display.fractional_participant_data = function(packet, parent, length)
  return ""
end
...
siac_cts_output_cta_v2_10_dissect.fractional_participant_data = function(buffer, offset, packet, parent)
  if show.fractional_participant_data then
    ...
    local element = parent:add(siac_cts_output_cta_v2_10.fields.fractional_participant_data, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.fractional_participant_data_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.fractional_participant_data(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.fractional_participant_data_fields(buffer, offset, packet, element)
  end
end
...
siac_cts_output_cta_v2_10_display.last_participant_id = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.last_participant_id = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.last_participant_id
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.fractional_consolidated_data = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.fractional_consolidated_data = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Consolidated Data
siac_cts_output_cta_v2_10_dissect.fractional_consolidated_data_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.fractional_consolidated_data = function(buffer, offset, packet, parent)
  if show.fractional_consolidated_data then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.fractional_consolidated_data, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.fractional_consolidated_data_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.fractional_consolidated_data(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.fractional_consolidated_data_fields(buffer, offset, packet, element)
  end
end

-- Size: Financial Status Indicator
siac_cts_output_cta_v2_10_size_of.financial_status_indicator = 1

-- Display: Financial Status Indicator
siac_cts_output_cta_v2_10_display.financial_status_indicator = function(value)
  if value == "0" then
...
siac_cts_output_cta_v2_10_dissect.financial_status_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.financial_status_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.primary_listing_market_participant_id = 1

-- Display: Primary Listing Market Participant Id
siac_cts_output_cta_v2_10_display.primary_listing_market_participant_id = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.primary_listing_market_participant_id = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.primary_listing_market_participant_id
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.short_sale_restriction_indicator = 1

-- Display: Short Sale Restriction Indicator
siac_cts_output_cta_v2_10_display.short_sale_restriction_indicator = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.short_sale_restriction_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.short_sale_restriction_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.cancel_error_action = 1

-- Display: Cancel Error Action
siac_cts_output_cta_v2_10_display.cancel_error_action = function(value)
  if value == "1" then
...
siac_cts_output_cta_v2_10_dissect.cancel_error_action = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.cancel_error_action
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Nanoseconds
siac_cts_output_cta_v2_10_size_of.nanoseconds = 4

-- Display: Nanoseconds
siac_cts_output_cta_v2_10_display.nanoseconds = function(value)
  return "Nanoseconds: "..value
end

-- Dissect: Nanoseconds
siac_cts_output_cta_v2_10_dissect.nanoseconds = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.nanoseconds
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Seconds
siac_cts_output_cta_v2_10_size_of.seconds = 4

-- Display: Seconds
siac_cts_output_cta_v2_10_display.seconds = function(value)
  return "Seconds: "..value
end

-- Dissect: Seconds
siac_cts_output_cta_v2_10_dissect.seconds = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.seconds
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.timestamp_2 = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_10_size_of.seconds

  index = index + siac_cts_output_cta_v2_10_size_of.nanoseconds

  return index
end

-- Display: Timestamp 2
siac_cts_output_cta_v2_10_display.timestamp_2 = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Timestamp 2
siac_cts_output_cta_v2_10_dissect.timestamp_2_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Seconds: 4 Byte Unsigned Fixed Width Integer
  index, seconds = siac_cts_output_cta_v2_10_dissect.seconds(buffer, index, packet, parent)

  -- Nanoseconds: 4 Byte Unsigned Fixed Width Integer
  index, nanoseconds = siac_cts_output_cta_v2_10_dissect.nanoseconds(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.timestamp_2 = function(buffer, offset, packet, parent)
  if show.timestamp_2 then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.timestamp_2, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.timestamp_2_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.timestamp_2(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.timestamp_2_fields(buffer, offset, packet, element)
  end
end

-- Size: Original Participant Reference Number
siac_cts_output_cta_v2_10_size_of.original_participant_reference_number = 8

-- Display: Original Participant Reference Number
siac_cts_output_cta_v2_10_display.original_participant_reference_number = function(value)
  return "Original Participant Reference Number: "..value
end

-- Dissect: Original Participant Reference Number
siac_cts_output_cta_v2_10_dissect.original_participant_reference_number = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.original_participant_reference_number
  local range = buffer(offset, length)
...
siac_cts_output_cta_v2_10_size_of.trade_reporting_facility_id = 1

-- Display: Trade Reporting Facility Id
siac_cts_output_cta_v2_10_display.trade_reporting_facility_id = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.trade_reporting_facility_id = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_reporting_facility_id
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.trade_through_exempt_indicator = 1

-- Display: Trade Through Exempt Indicator
siac_cts_output_cta_v2_10_display.trade_through_exempt_indicator = function(value)
  if value == "0" then
...
siac_cts_output_cta_v2_10_dissect.trade_through_exempt_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_through_exempt_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.stop_stock_indicator = 1

-- Display: Stop Stock Indicator
siac_cts_output_cta_v2_10_display.stop_stock_indicator = function(value)
  if value == "0" then
...
siac_cts_output_cta_v2_10_dissect.stop_stock_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.stop_stock_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.sellers_sale_days = 1

-- Display: Sellers Sale Days
siac_cts_output_cta_v2_10_display.sellers_sale_days = function(value)
  return "Sellers Sale Days: "..value
end

-- Dissect: Sellers Sale Days
siac_cts_output_cta_v2_10_dissect.sellers_sale_days = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.sellers_sale_days
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Display: Trade Price
siac_cts_output_cta_v2_10_display.trade_price = function(value)
...
-- Dissect: Trade Price
siac_cts_output_cta_v2_10_dissect.trade_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.sro_trade_detail = 1

-- Display: Sro Trade Detail
siac_cts_output_cta_v2_10_display.sro_trade_detail = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.sro_trade_detail = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.sro_trade_detail
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.extended_hours_or_sequence_type = 1

-- Display: Extended Hours Or Sequence Type
siac_cts_output_cta_v2_10_display.extended_hours_or_sequence_type = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.extended_hours_or_sequence_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.extended_hours_or_sequence_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.trade_through_exempt_reason = 1

-- Display: Trade Through Exempt Reason
siac_cts_output_cta_v2_10_display.trade_through_exempt_reason = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.trade_through_exempt_reason = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_through_exempt_reason
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.settlement_type = 1

-- Display: Settlement Type
siac_cts_output_cta_v2_10_display.settlement_type = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.settlement_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.settlement_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.sale_conditions = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_10_size_of.settlement_type

  index = index + siac_cts_output_cta_v2_10_size_of.trade_through_exempt_reason

  index = index + siac_cts_output_cta_v2_10_size_of.extended_hours_or_sequence_type

  index = index + siac_cts_output_cta_v2_10_size_of.sro_trade_detail

  return index
end

-- Display: Sale Conditions
siac_cts_output_cta_v2_10_display.sale_conditions = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sale Conditions
siac_cts_output_cta_v2_10_dissect.sale_conditions_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Settlement Type: 1 Byte Ascii String Enum with 4 values
  index, settlement_type = siac_cts_output_cta_v2_10_dissect.settlement_type(buffer, index, packet, parent)

  -- Trade Through Exempt Reason: 1 Byte Ascii String Enum with 9 values
  index, trade_through_exempt_reason = siac_cts_output_cta_v2_10_dissect.trade_through_exempt_reason(buffer, index, packet, parent)

  -- Extended Hours Or Sequence Type: 1 Byte Ascii String Enum with 5 values
  index, extended_hours_or_sequence_type = siac_cts_output_cta_v2_10_dissect.extended_hours_or_sequence_type(buffer, index, packet, parent)

  -- Sro Trade Detail: 1 Byte Ascii String Enum with 11 values
  index, sro_trade_detail = siac_cts_output_cta_v2_10_dissect.sro_trade_detail(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.sale_conditions = function(buffer, offset, packet, parent)
  if show.sale_conditions then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.sale_conditions, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.sale_conditions_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.sale_conditions(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.sale_conditions_fields(buffer, offset, packet, element)
  end
end

-- Size: Instrument Type
siac_cts_output_cta_v2_10_size_of.instrument_type = 1

-- Display: Instrument Type
siac_cts_output_cta_v2_10_display.instrument_type = function(value)
  if value == "0" then
...
siac_cts_output_cta_v2_10_dissect.instrument_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.instrument_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.security_symbol = 11

-- Display: Security Symbol
siac_cts_output_cta_v2_10_display.security_symbol = function(value)
  return "Security Symbol: "..value
end

-- Dissect: Security Symbol
siac_cts_output_cta_v2_10_dissect.security_symbol = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.security_symbol
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.participant_reference_number = 8

-- Display: Participant Reference Number
siac_cts_output_cta_v2_10_display.participant_reference_number = function(value)
  return "Participant Reference Number: "..value
end

-- Dissect: Participant Reference Number
siac_cts_output_cta_v2_10_dissect.participant_reference_number = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.participant_reference_number
  local range = buffer(offset, length)
  local value = range:int64()
...
-- Size: Transaction Id
siac_cts_output_cta_v2_10_size_of.transaction_id = 4

-- Display: Transaction Id
siac_cts_output_cta_v2_10_display.transaction_id = function(value)
  return "Transaction Id: "..value
end

-- Dissect: Transaction Id
siac_cts_output_cta_v2_10_dissect.transaction_id = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.transaction_id
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Message Id
siac_cts_output_cta_v2_10_size_of.message_id = 1

-- Display: Message Id
siac_cts_output_cta_v2_10_display.message_id = function(value)
  return "Message Id: "..value
end

-- Dissect: Message Id
siac_cts_output_cta_v2_10_dissect.message_id = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.message_id
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.timestamp_1 = function(buffer, offset)
  local index = 0
...
-- Display: Timestamp 1
siac_cts_output_cta_v2_10_display.timestamp_1 = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Timestamp 1
siac_cts_output_cta_v2_10_dissect.timestamp_1_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.timestamp_1 = function(buffer, offset, packet, parent)
  if show.timestamp_1 then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.timestamp_1, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.timestamp_1_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.timestamp_1(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.timestamp_1_fields(buffer, offset, packet, element)
  end
end

-- Size: Participant Id
siac_cts_output_cta_v2_10_size_of.participant_id = 1

-- Display: Participant Id
siac_cts_output_cta_v2_10_display.participant_id = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.participant_id = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.participant_id
  local range = buffer(offset, length)
  local value = range:string()
...
-- Read runtime size of: Fractional Trade Cancel Error Message
siac_cts_output_cta_v2_10_size_of.fractional_trade_cancel_error_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_trade_cancel_error_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Trade Cancel Error Message
siac_cts_output_cta_v2_10_dissect.fractional_trade_cancel_error_message_fields = function(buffer, offset, packet, parent, size_of_fractional_trade_cancel_error_message)
  local index = offset

  -- Participant Id: 1 Byte Ascii String Enum with 20 values
  index, participant_id = siac_cts_output_cta_v2_10_dissect.participant_id(buffer, index, packet, parent)

  -- Timestamp 1: Struct of 2 fields
  index, timestamp_1 = siac_cts_output_cta_v2_10_dissect.timestamp_1(buffer, index, packet, parent)

  -- Message Id: 1 Byte Unsigned Fixed Width Integer
  index, message_id = siac_cts_output_cta_v2_10_dissect.message_id(buffer, index, packet, parent)

  -- Transaction Id: 4 Byte Unsigned Fixed Width Integer
  index, transaction_id = siac_cts_output_cta_v2_10_dissect.transaction_id(buffer, index, packet, parent)
  ...
  index, security_symbol = siac_cts_output_cta_v2_10_dissect.security_symbol(buffer, index, packet, parent)
  ...
  index, timestamp_2 = siac_cts_output_cta_v2_10_dissect.timestamp_2(buffer, index, packet, parent)

  -- Cancel Error Action: 1 Byte Ascii String Enum with 2 values
  index, cancel_error_action = siac_cts_output_cta_v2_10_dissect.cancel_error_action(buffer, index, packet, parent)
  ...
  index, primary_listing_market_participant_id = siac_cts_output_cta_v2_10_dissect.primary_listing_market_participant_id(buffer, index, packet, parent)

  -- Financial Status Indicator: 1 Byte Ascii String Enum with 11 values
  index, financial_status_indicator = siac_cts_output_cta_v2_10_dissect.financial_status_indicator(buffer, index, packet, parent)

  -- Fractional Consolidated Data: Struct of 7 fields
  index, fractional_consolidated_data = siac_cts_output_cta_v2_10_dissect.fractional_consolidated_data(buffer, index, packet, parent)

  -- Fractional Participant Data: Struct of 7 fields
  index, fractional_participant_data = siac_cts_output_cta_v2_10_dissect.fractional_participant_data(buffer, index, packet, parent)

  return index
end

-- Dissect: Fractional Trade Cancel Error Message
siac_cts_output_cta_v2_10_dissect.fractional_trade_cancel_error_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_trade_cancel_error_message = siac_cts_output_cta_v2_10_size_of.fractional_trade_cancel_error_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.participant_data = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.participant_data = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Participant Data
siac_cts_output_cta_v2_10_dissect.participant_data_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.participant_data = function(buffer, offset, packet, parent)
  if show.participant_data then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.participant_data, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.participant_data_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.participant_data(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.participant_data_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Consolidated Data
siac_cts_output_cta_v2_10_size_of.consolidated_data = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.consolidated_data = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Consolidated Data
siac_cts_output_cta_v2_10_dissect.consolidated_data_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.consolidated_data = function(buffer, offset, packet, parent)
  if show.consolidated_data then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.consolidated_data, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.consolidated_data_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.consolidated_data(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.consolidated_data_fields(buffer, offset, packet, element)
  end
end

-- Size: Trade Volume
siac_cts_output_cta_v2_10_size_of.trade_volume = 4

-- Display: Trade Volume
siac_cts_output_cta_v2_10_display.trade_volume = function(value)
  return "Trade Volume: "..value
end

-- Dissect: Trade Volume
siac_cts_output_cta_v2_10_dissect.trade_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_volume
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.trade_cancel_error_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.trade_cancel_error_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Cancel Error Message
siac_cts_output_cta_v2_10_dissect.trade_cancel_error_message_fields = function(buffer, offset, packet, parent, size_of_trade_cancel_error_message)
  local index = offset
  ...
  index, consolidated_data = siac_cts_output_cta_v2_10_dissect.consolidated_data(buffer, index, packet, parent)

  -- Participant Data: Struct of 7 fields
  index, participant_data = siac_cts_output_cta_v2_10_dissect.participant_data(buffer, index, packet, parent)

  return index
end

-- Dissect: Trade Cancel Error Message
siac_cts_output_cta_v2_10_dissect.trade_cancel_error_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_trade_cancel_error_message = siac_cts_output_cta_v2_10_size_of.trade_cancel_error_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.participant_open_high_low_last_indicator = 1

-- Display: Participant Open High Low Last Indicator
siac_cts_output_cta_v2_10_display.participant_open_high_low_last_indicator = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.participant_open_high_low_last_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.participant_open_high_low_last_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.consolidated_high_low_last_indicator = 1

-- Display: Consolidated High Low Last Indicator
siac_cts_output_cta_v2_10_display.consolidated_high_low_last_indicator = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.consolidated_high_low_last_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.consolidated_high_low_last_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.fractional_trade_volume_short = 4

-- Display: Fractional Trade Volume Short
siac_cts_output_cta_v2_10_display.fractional_trade_volume_short = function(value)
  return "Fractional Trade Volume Short: "..value
end

-- Dissect: Fractional Trade Volume Short
siac_cts_output_cta_v2_10_dissect.fractional_trade_volume_short = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.fractional_trade_volume_short
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.trade_price_short = 2

-- Display: Trade Price Short
siac_cts_output_cta_v2_10_display.trade_price_short = function(value)
...
siac_cts_output_cta_v2_10_dissect.trade_price_short = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_price_short
  local range = buffer(offset, length)
...
siac_cts_output_cta_v2_10_size_of.sale_condition_category = 1

-- Display: Sale Condition Category
siac_cts_output_cta_v2_10_display.sale_condition_category = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.sale_condition_category = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.sale_condition_category
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Sale Condition
siac_cts_output_cta_v2_10_size_of.sale_condition = 1

-- Display: Sale Condition
siac_cts_output_cta_v2_10_display.sale_condition = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.sale_condition = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.sale_condition
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.security_symbol_short = 5

-- Display: Security Symbol Short
siac_cts_output_cta_v2_10_display.security_symbol_short = function(value)
  return "Security Symbol Short: "..value
end

-- Dissect: Security Symbol Short
siac_cts_output_cta_v2_10_dissect.security_symbol_short = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.security_symbol_short
  local range = buffer(offset, length)
  local value = range:string()
...
-- Read runtime size of: Fractional Short Trade Message
siac_cts_output_cta_v2_10_size_of.fractional_short_trade_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_short_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Short Trade Message
siac_cts_output_cta_v2_10_dissect.fractional_short_trade_message_fields = function(buffer, offset, packet, parent, size_of_fractional_short_trade_message)
  local index = offset
  ...
  index, security_symbol_short = siac_cts_output_cta_v2_10_dissect.security_symbol_short(buffer, index, packet, parent)

  -- Sale Condition: 1 Byte Ascii String Enum with 26 values
  index, sale_condition = siac_cts_output_cta_v2_10_dissect.sale_condition(buffer, index, packet, parent)

  -- Sale Condition Category: 1 Byte Ascii String Enum with 5 values
  index, sale_condition_category = siac_cts_output_cta_v2_10_dissect.sale_condition_category(buffer, index, packet, parent)

  -- Trade Price Short: 2 Byte Unsigned Fixed Width Integer
  index, trade_price_short = siac_cts_output_cta_v2_10_dissect.trade_price_short(buffer, index, packet, parent)

  -- Fractional Trade Volume Short: 4 Byte Unsigned Fixed Width Integer
  index, fractional_trade_volume_short = siac_cts_output_cta_v2_10_dissect.fractional_trade_volume_short(buffer, index, packet, parent)

  -- Primary Listing Market Participant Id: 1 Byte Ascii String Enum with 16 values
  index, primary_listing_market_participant_id = siac_cts_output_cta_v2_10_dissect.primary_listing_market_participant_id(buffer, index, packet, parent)

  -- Consolidated High Low Last Indicator: 1 Byte Ascii String Enum with 8 values
  index, consolidated_high_low_last_indicator = siac_cts_output_cta_v2_10_dissect.consolidated_high_low_last_indicator(buffer, index, packet, parent)

  -- Participant Open High Low Last Indicator: 1 Byte Ascii String Enum with 17 values
  index, participant_open_high_low_last_indicator = siac_cts_output_cta_v2_10_dissect.participant_open_high_low_last_indicator(buffer, index, packet, parent)

  return index
end

-- Dissect: Fractional Short Trade Message
siac_cts_output_cta_v2_10_dissect.fractional_short_trade_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_short_trade_message = siac_cts_output_cta_v2_10_size_of.fractional_short_trade_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.trade_volume_short = 2

-- Display: Trade Volume Short
siac_cts_output_cta_v2_10_display.trade_volume_short = function(value)
  return "Trade Volume Short: "..value
end

-- Dissect: Trade Volume Short
siac_cts_output_cta_v2_10_dissect.trade_volume_short = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_volume_short
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.short_trade_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.short_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Short Trade Message
siac_cts_output_cta_v2_10_dissect.short_trade_message_fields = function(buffer, offset, packet, parent, size_of_short_trade_message)
  local index = offset
  ...
  index, trade_volume_short = siac_cts_output_cta_v2_10_dissect.trade_volume_short(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.short_trade_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_short_trade_message = siac_cts_output_cta_v2_10_size_of.short_trade_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.limit_up_limit_down_indicator = 1

-- Display: Limit Up Limit Down Indicator
siac_cts_output_cta_v2_10_display.limit_up_limit_down_indicator = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.limit_up_limit_down_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.limit_up_limit_down_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Halt Reason
siac_cts_output_cta_v2_10_size_of.halt_reason = 1

-- Display: Halt Reason
siac_cts_output_cta_v2_10_display.halt_reason = function(value)
  if value == " " then
...
-- Dissect: Halt Reason
siac_cts_output_cta_v2_10_dissect.halt_reason = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.halt_reason
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.security_status = 1

-- Display: Security Status
siac_cts_output_cta_v2_10_display.security_status = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.security_status = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.security_status
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Sell Volume
siac_cts_output_cta_v2_10_size_of.sell_volume = 4

-- Display: Sell Volume
siac_cts_output_cta_v2_10_display.sell_volume = function(value)
  return "Sell Volume: "..value
end

-- Dissect: Sell Volume
siac_cts_output_cta_v2_10_dissect.sell_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.sell_volume
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Buy Volume
siac_cts_output_cta_v2_10_size_of.buy_volume = 4

-- Display: Buy Volume
siac_cts_output_cta_v2_10_display.buy_volume = function(value)
  return "Buy Volume: "..value
end

-- Dissect: Buy Volume
siac_cts_output_cta_v2_10_dissect.buy_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.buy_volume
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.low_indication_price_lower_limit_price_band = 8

-- Display: Low Indication Price Lower Limit Price Band
siac_cts_output_cta_v2_10_display.low_indication_price_lower_limit_price_band = function(value)
...
siac_cts_output_cta_v2_10_dissect.low_indication_price_lower_limit_price_band = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.low_indication_price_lower_limit_price_band
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.high_indication_price_upper_limit_price_band = 8

-- Display: High Indication Price Upper Limit Price Band
siac_cts_output_cta_v2_10_display.high_indication_price_upper_limit_price_band = function(value)
...
siac_cts_output_cta_v2_10_dissect.high_indication_price_upper_limit_price_band = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.high_indication_price_upper_limit_price_band
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.trading_status_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.trading_status_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trading Status Message
siac_cts_output_cta_v2_10_dissect.trading_status_message_fields = function(buffer, offset, packet, parent, size_of_trading_status_message)
  local index = offset
  ...
  index, high_indication_price_upper_limit_price_band = siac_cts_output_cta_v2_10_dissect.high_indication_price_upper_limit_price_band(buffer, index, packet, parent)

  -- Low Indication Price Lower Limit Price Band: 8 Byte Unsigned Fixed Width Integer
  index, low_indication_price_lower_limit_price_band = siac_cts_output_cta_v2_10_dissect.low_indication_price_lower_limit_price_band(buffer, index, packet, parent)

  -- Buy Volume: 4 Byte Unsigned Fixed Width Integer
  index, buy_volume = siac_cts_output_cta_v2_10_dissect.buy_volume(buffer, index, packet, parent)

  -- Sell Volume: 4 Byte Unsigned Fixed Width Integer
  index, sell_volume = siac_cts_output_cta_v2_10_dissect.sell_volume(buffer, index, packet, parent)

  -- Security Status: 1 Byte Ascii String Enum with 13 values
  index, security_status = siac_cts_output_cta_v2_10_dissect.security_status(buffer, index, packet, parent)

  -- Halt Reason: 1 Byte Ascii String Enum with 17 values
  index, halt_reason = siac_cts_output_cta_v2_10_dissect.halt_reason(buffer, index, packet, parent)
  ...
  index, limit_up_limit_down_indicator = siac_cts_output_cta_v2_10_dissect.limit_up_limit_down_indicator(buffer, index, packet, parent)

  return index
end

-- Dissect: Trading Status Message
siac_cts_output_cta_v2_10_dissect.trading_status_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_trading_status_message = siac_cts_output_cta_v2_10_size_of.trading_status_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.held_trade_indicator = 1

-- Display: Held Trade Indicator
siac_cts_output_cta_v2_10_display.held_trade_indicator = function(value)
  if value == " " then
...
siac_cts_output_cta_v2_10_dissect.held_trade_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.held_trade_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
-- Read runtime size of: Fractional Long Trade Message
siac_cts_output_cta_v2_10_size_of.fractional_long_trade_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_long_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Long Trade Message
siac_cts_output_cta_v2_10_dissect.fractional_long_trade_message_fields = function(buffer, offset, packet, parent, size_of_fractional_long_trade_message)
  local index = offset
  ...
  index, held_trade_indicator = siac_cts_output_cta_v2_10_dissect.held_trade_indicator(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.fractional_long_trade_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_long_trade_message = siac_cts_output_cta_v2_10_size_of.fractional_long_trade_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.long_trade_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.long_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Trade Message
siac_cts_output_cta_v2_10_dissect.long_trade_message_fields = function(buffer, offset, packet, parent, size_of_long_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.long_trade_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_long_trade_message = siac_cts_output_cta_v2_10_size_of.long_trade_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.prior_day_trade_date_and_time = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.prior_day_trade_date_and_time = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prior Day Trade Date And Time
siac_cts_output_cta_v2_10_dissect.prior_day_trade_date_and_time_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.prior_day_trade_date_and_time = function(buffer, offset, packet, parent)
  if show.prior_day_trade_date_and_time then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.prior_day_trade_date_and_time, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.prior_day_trade_date_and_time_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.prior_day_trade_date_and_time(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.prior_day_trade_date_and_time_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Fractional Original Trade
siac_cts_output_cta_v2_10_size_of.fractional_original_trade = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.fractional_original_trade = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Original Trade
siac_cts_output_cta_v2_10_dissect.fractional_original_trade_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.fractional_original_trade = function(buffer, offset, packet, parent)
  if show.fractional_original_trade then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.fractional_original_trade, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.fractional_original_trade_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.fractional_original_trade(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.fractional_original_trade_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Fractional Corrected Trade
siac_cts_output_cta_v2_10_size_of.fractional_corrected_trade = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.fractional_corrected_trade = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Corrected Trade
siac_cts_output_cta_v2_10_dissect.fractional_corrected_trade_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.fractional_corrected_trade = function(buffer, offset, packet, parent)
  if show.fractional_corrected_trade then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.fractional_corrected_trade, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.fractional_corrected_trade_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.fractional_corrected_trade(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.fractional_corrected_trade_fields(buffer, offset, packet, element)
  end
end

-- Read runtime size of: Fractional Trade Correction Message
siac_cts_output_cta_v2_10_size_of.fractional_trade_correction_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_trade_correction_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Trade Correction Message
siac_cts_output_cta_v2_10_dissect.fractional_trade_correction_message_fields = function(buffer, offset, packet, parent, size_of_fractional_trade_correction_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.fractional_trade_correction_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_trade_correction_message = siac_cts_output_cta_v2_10_size_of.fractional_trade_correction_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.original_trade = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.original_trade = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Original Trade
siac_cts_output_cta_v2_10_dissect.original_trade_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.original_trade = function(buffer, offset, packet, parent)
  if show.original_trade then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.original_trade, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.original_trade_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.original_trade(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.original_trade_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Corrected Trade
siac_cts_output_cta_v2_10_size_of.corrected_trade = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.corrected_trade = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Corrected Trade
siac_cts_output_cta_v2_10_dissect.corrected_trade_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.corrected_trade = function(buffer, offset, packet, parent)
  if show.corrected_trade then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.corrected_trade, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.corrected_trade_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.corrected_trade(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.corrected_trade_fields(buffer, offset, packet, element)
  end
end

-- Read runtime size of: Trade Correction Message
siac_cts_output_cta_v2_10_size_of.trade_correction_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.trade_correction_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Correction Message
siac_cts_output_cta_v2_10_dissect.trade_correction_message_fields = function(buffer, offset, packet, parent, size_of_trade_correction_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.trade_correction_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_trade_correction_message = siac_cts_output_cta_v2_10_size_of.trade_correction_message(buffer, offset)
...
-- Size: Future Use
siac_cts_output_cta_v2_10_size_of.future_use = 62

-- Display: Future Use
siac_cts_output_cta_v2_10_display.future_use = function(value)
  return "Future Use: "..value
end

-- Dissect: Future Use
siac_cts_output_cta_v2_10_dissect.future_use = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.future_use
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.number_of_extensions = 1

-- Display: Number Of Extensions
siac_cts_output_cta_v2_10_display.number_of_extensions = function(value)
  return "Number Of Extensions: "..value
end

-- Dissect: Number Of Extensions
siac_cts_output_cta_v2_10_dissect.number_of_extensions = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.number_of_extensions
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.auction_collar_lower_threshold_price = 8

-- Display: Auction Collar Lower Threshold Price
siac_cts_output_cta_v2_10_display.auction_collar_lower_threshold_price = function(value)
...
siac_cts_output_cta_v2_10_dissect.auction_collar_lower_threshold_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.auction_collar_lower_threshold_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.auction_collar_upper_threshold_price = 8

-- Display: Auction Collar Upper Threshold Price
siac_cts_output_cta_v2_10_display.auction_collar_upper_threshold_price = function(value)
...
siac_cts_output_cta_v2_10_dissect.auction_collar_upper_threshold_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.auction_collar_upper_threshold_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.auction_collar_reference_price = 8

-- Display: Auction Collar Reference Price
siac_cts_output_cta_v2_10_display.auction_collar_reference_price = function(value)
...
siac_cts_output_cta_v2_10_dissect.auction_collar_reference_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.auction_collar_reference_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.auction_status_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.auction_status_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Auction Status Message
siac_cts_output_cta_v2_10_dissect.auction_status_message_fields = function(buffer, offset, packet, parent, size_of_auction_status_message)
  local index = offset
  ...
  index, auction_collar_reference_price = siac_cts_output_cta_v2_10_dissect.auction_collar_reference_price(buffer, index, packet, parent)

  -- Auction Collar Upper Threshold Price: 8 Byte Unsigned Fixed Width Integer
  index, auction_collar_upper_threshold_price = siac_cts_output_cta_v2_10_dissect.auction_collar_upper_threshold_price(buffer, index, packet, parent)

  -- Auction Collar Lower Threshold Price: 8 Byte Unsigned Fixed Width Integer
  index, auction_collar_lower_threshold_price = siac_cts_output_cta_v2_10_dissect.auction_collar_lower_threshold_price(buffer, index, packet, parent)

  -- Number Of Extensions: 1 Byte Unsigned Fixed Width Integer
  index, number_of_extensions = siac_cts_output_cta_v2_10_dissect.number_of_extensions(buffer, index, packet, parent)
  ...
  index, future_use = siac_cts_output_cta_v2_10_dissect.future_use(buffer, index, packet, parent)

  return index
end

-- Dissect: Auction Status Message
siac_cts_output_cta_v2_10_dissect.auction_status_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_auction_status_message = siac_cts_output_cta_v2_10_size_of.auction_status_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.trade_payload = function(buffer, offset, trade_message_type)
  -- Size of Auction Status Message
  if trade_message_type == "A" then
    return siac_cts_output_cta_v2_10_size_of.auction_status_message(buffer, offset)
  end
  -- Size of Trade Correction Message
  if trade_message_type == "C" then
    return siac_cts_output_cta_v2_10_size_of.trade_correction_message(buffer, offset)
  end
  -- Size of Fractional Trade Correction Message
  if trade_message_type == "O" then
    return siac_cts_output_cta_v2_10_size_of.fractional_trade_correction_message(buffer, offset)
  end
  -- Size of Long Trade Message
  if trade_message_type == "L" then
    return siac_cts_output_cta_v2_10_size_of.long_trade_message(buffer, offset)
  end
  -- Size of Fractional Long Trade Message
  if trade_message_type == "R" then
    return siac_cts_output_cta_v2_10_size_of.fractional_long_trade_message(buffer, offset)
  end
  -- Size of Trading Status Message
  if trade_message_type == "S" then
    return siac_cts_output_cta_v2_10_size_of.trading_status_message(buffer, offset)
  end
  -- Size of Short Trade Message
  if trade_message_type == "T" then
    return siac_cts_output_cta_v2_10_size_of.short_trade_message(buffer, offset)
  end
  -- Size of Fractional Short Trade Message
  if trade_message_type == "H" then
    return siac_cts_output_cta_v2_10_size_of.fractional_short_trade_message(buffer, offset)
  end
  -- Size of Trade Cancel Error Message
  if trade_message_type == "X" then
    return siac_cts_output_cta_v2_10_size_of.trade_cancel_error_message(buffer, offset)
  end
  -- Size of Fractional Trade Cancel Error Message
  if trade_message_type == "E" then
    return siac_cts_output_cta_v2_10_size_of.fractional_trade_cancel_error_message(buffer, offset)
  end
...
siac_cts_output_cta_v2_10_display.trade_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Trade Payload
siac_cts_output_cta_v2_10_dissect.trade_payload_branches = function(buffer, offset, packet, parent, trade_message_type)
  -- Dissect Auction Status Message
  if trade_message_type == "A" then
    return siac_cts_output_cta_v2_10_dissect.auction_status_message(buffer, offset, packet, parent)
  end
  -- Dissect Trade Correction Message
  if trade_message_type == "C" then
    return siac_cts_output_cta_v2_10_dissect.trade_correction_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Trade Correction Message
  if trade_message_type == "O" then
    return siac_cts_output_cta_v2_10_dissect.fractional_trade_correction_message(buffer, offset, packet, parent)
  end
  -- Dissect Long Trade Message
  if trade_message_type == "L" then
    return siac_cts_output_cta_v2_10_dissect.long_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Long Trade Message
  if trade_message_type == "R" then
    return siac_cts_output_cta_v2_10_dissect.fractional_long_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Trading Status Message
  if trade_message_type == "S" then
    return siac_cts_output_cta_v2_10_dissect.trading_status_message(buffer, offset, packet, parent)
  end
  -- Dissect Short Trade Message
  if trade_message_type == "T" then
    return siac_cts_output_cta_v2_10_dissect.short_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Short Trade Message
  if trade_message_type == "H" then
    return siac_cts_output_cta_v2_10_dissect.fractional_short_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Trade Cancel Error Message
  if trade_message_type == "X" then
    return siac_cts_output_cta_v2_10_dissect.trade_cancel_error_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Trade Cancel Error Message
  if trade_message_type == "E" then
    return siac_cts_output_cta_v2_10_dissect.fractional_trade_cancel_error_message(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v2_10_dissect.trade_payload = function(buffer, offset, packet, parent, trade_message_type)
  ...
  local size = siac_cts_output_cta_v2_10_size_of.trade_payload(buffer, offset, trade_message_type)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.trade_message_type = 1

-- Display: Trade Message Type
siac_cts_output_cta_v2_10_display.trade_message_type = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.trade_message_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.trade = function(buffer, offset)
  local index = offset
...
-- Display: Trade
siac_cts_output_cta_v2_10_display.trade = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade
siac_cts_output_cta_v2_10_dissect.trade_fields = function(buffer, offset, packet, parent, size_of_trade)
  local index = offset

  -- Trade Message Type: 1 Byte Ascii String Enum with 10 values
  index, trade_message_type = siac_cts_output_cta_v2_10_dissect.trade_message_type(buffer, index, packet, parent)

  -- Trade Payload: Runtime Type with 10 branches
  index = siac_cts_output_cta_v2_10_dissect.trade_payload(buffer, index, packet, parent, trade_message_type)

  return index
end

-- Dissect: Trade
siac_cts_output_cta_v2_10_dissect.trade = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_trade = siac_cts_output_cta_v2_10_size_of.trade(buffer, offset)
...
siac_cts_output_cta_v2_10_display.initiating_participant_id = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.initiating_participant_id = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.initiating_participant_id
  local range = buffer(offset, length)
  local value = range:string()
...
-- Read runtime size of: Fractional Participant End Of Day Summary Message
siac_cts_output_cta_v2_10_size_of.fractional_participant_end_of_day_summary_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_participant_end_of_day_summary_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Participant End Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.fractional_participant_end_of_day_summary_message_fields = function(buffer, offset, packet, parent, size_of_fractional_participant_end_of_day_summary_message)
  local index = offset
  ...
  index, initiating_participant_id = siac_cts_output_cta_v2_10_dissect.initiating_participant_id(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.fractional_participant_end_of_day_summary_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_participant_end_of_day_summary_message = siac_cts_output_cta_v2_10_size_of.fractional_participant_end_of_day_summary_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.participant_end_of_day_summary_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.participant_end_of_day_summary_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Participant End Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.participant_end_of_day_summary_message_fields = function(buffer, offset, packet, parent, size_of_participant_end_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.participant_end_of_day_summary_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_participant_end_of_day_summary_message = siac_cts_output_cta_v2_10_size_of.participant_end_of_day_summary_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.number_of_participants = 1

-- Display: Number Of Participants
siac_cts_output_cta_v2_10_display.number_of_participants = function(value)
  return "Number Of Participants: "..value
end

-- Dissect: Number Of Participants
siac_cts_output_cta_v2_10_dissect.number_of_participants = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.number_of_participants
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Read runtime size of: Fractional Consolidated End Of Day Summary Message
siac_cts_output_cta_v2_10_size_of.fractional_consolidated_end_of_day_summary_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_consolidated_end_of_day_summary_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Consolidated End Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.fractional_consolidated_end_of_day_summary_message_fields = function(buffer, offset, packet, parent, size_of_fractional_consolidated_end_of_day_summary_message)
  local index = offset
  ...
  index, number_of_participants = siac_cts_output_cta_v2_10_dissect.number_of_participants(buffer, index, packet, parent)

  return index
end

-- Dissect: Fractional Consolidated End Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.fractional_consolidated_end_of_day_summary_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_consolidated_end_of_day_summary_message = siac_cts_output_cta_v2_10_size_of.fractional_consolidated_end_of_day_summary_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.consolidated_end_of_day_summary_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.consolidated_end_of_day_summary_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Consolidated End Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.consolidated_end_of_day_summary_message_fields = function(buffer, offset, packet, parent, size_of_consolidated_end_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.consolidated_end_of_day_summary_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_consolidated_end_of_day_summary_message = siac_cts_output_cta_v2_10_size_of.consolidated_end_of_day_summary_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.previous_close_price = 8

-- Display: Previous Close Price
siac_cts_output_cta_v2_10_display.previous_close_price = function(value)
...
siac_cts_output_cta_v2_10_dissect.previous_close_price = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.previous_close_price
  local range = buffer(offset, length)
  local raw = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.participant_start_of_day_summary_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.participant_start_of_day_summary_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Participant Start Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.participant_start_of_day_summary_message_fields = function(buffer, offset, packet, parent, size_of_participant_start_of_day_summary_message)
  local index = offset
  ...
  index, previous_close_price = siac_cts_output_cta_v2_10_dissect.previous_close_price(buffer, index, packet, parent)

  return index
end

-- Dissect: Participant Start Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.participant_start_of_day_summary_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_participant_start_of_day_summary_message = siac_cts_output_cta_v2_10_size_of.participant_start_of_day_summary_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.consolidated_start_of_day_summary_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.consolidated_start_of_day_summary_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Consolidated Start Of Day Summary Message
siac_cts_output_cta_v2_10_dissect.consolidated_start_of_day_summary_message_fields = function(buffer, offset, packet, parent, size_of_consolidated_start_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.consolidated_start_of_day_summary_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_consolidated_start_of_day_summary_message = siac_cts_output_cta_v2_10_size_of.consolidated_start_of_day_summary_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.summary_payload = function(buffer, offset, summary_message_type)
  -- Size of Consolidated Start Of Day Summary Message
  if summary_message_type == "A" then
    return siac_cts_output_cta_v2_10_size_of.consolidated_start_of_day_summary_message(buffer, offset)
  end
  -- Size of Participant Start Of Day Summary Message
  if summary_message_type == "B" then
    return siac_cts_output_cta_v2_10_size_of.participant_start_of_day_summary_message(buffer, offset)
  end
  -- Size of Consolidated End Of Day Summary Message
  if summary_message_type == "C" then
    return siac_cts_output_cta_v2_10_size_of.consolidated_end_of_day_summary_message(buffer, offset)
  end
  -- Size of Fractional Consolidated End Of Day Summary Message
  if summary_message_type == "T" then
    return siac_cts_output_cta_v2_10_size_of.fractional_consolidated_end_of_day_summary_message(buffer, offset)
  end
  -- Size of Participant End Of Day Summary Message
  if summary_message_type == "D" then
    return siac_cts_output_cta_v2_10_size_of.participant_end_of_day_summary_message(buffer, offset)
  end
  -- Size of Fractional Participant End Of Day Summary Message
  if summary_message_type == "P" then
    return siac_cts_output_cta_v2_10_size_of.fractional_participant_end_of_day_summary_message(buffer, offset)
  end
...
siac_cts_output_cta_v2_10_display.summary_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Summary Payload
siac_cts_output_cta_v2_10_dissect.summary_payload_branches = function(buffer, offset, packet, parent, summary_message_type)
  -- Dissect Consolidated Start Of Day Summary Message
  if summary_message_type == "A" then
    return siac_cts_output_cta_v2_10_dissect.consolidated_start_of_day_summary_message(buffer, offset, packet, parent)
  end
  -- Dissect Participant Start Of Day Summary Message
  if summary_message_type == "B" then
    return siac_cts_output_cta_v2_10_dissect.participant_start_of_day_summary_message(buffer, offset, packet, parent)
  end
  -- Dissect Consolidated End Of Day Summary Message
  if summary_message_type == "C" then
    return siac_cts_output_cta_v2_10_dissect.consolidated_end_of_day_summary_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Consolidated End Of Day Summary Message
  if summary_message_type == "T" then
    return siac_cts_output_cta_v2_10_dissect.fractional_consolidated_end_of_day_summary_message(buffer, offset, packet, parent)
  end
  -- Dissect Participant End Of Day Summary Message
  if summary_message_type == "D" then
    return siac_cts_output_cta_v2_10_dissect.participant_end_of_day_summary_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Participant End Of Day Summary Message
  if summary_message_type == "P" then
    return siac_cts_output_cta_v2_10_dissect.fractional_participant_end_of_day_summary_message(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v2_10_dissect.summary_payload = function(buffer, offset, packet, parent, summary_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_10_size_of.summary_payload(buffer, offset, summary_message_type)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.summary_message_type = 1

-- Display: Summary Message Type
siac_cts_output_cta_v2_10_display.summary_message_type = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.summary_message_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.summary_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.summary = function(buffer, offset)
  local index = offset
...
-- Display: Summary
siac_cts_output_cta_v2_10_display.summary = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Summary
siac_cts_output_cta_v2_10_dissect.summary_fields = function(buffer, offset, packet, parent, size_of_summary)
  local index = offset

  -- Summary Message Type: 1 Byte Ascii String Enum with 6 values
  index, summary_message_type = siac_cts_output_cta_v2_10_dissect.summary_message_type(buffer, index, packet, parent)

  -- Summary Payload: Runtime Type with 6 branches
  index = siac_cts_output_cta_v2_10_dissect.summary_payload(buffer, index, packet, parent, summary_message_type)

  return index
end

-- Dissect: Summary
siac_cts_output_cta_v2_10_dissect.summary = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_summary = siac_cts_output_cta_v2_10_size_of.summary(buffer, offset)
...
-- Read runtime size of: Fractional Prior Day Trade Message
siac_cts_output_cta_v2_10_size_of.fractional_prior_day_trade_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_prior_day_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Prior Day Trade Message
siac_cts_output_cta_v2_10_dissect.fractional_prior_day_trade_message_fields = function(buffer, offset, packet, parent, size_of_fractional_prior_day_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.fractional_prior_day_trade_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_prior_day_trade_message = siac_cts_output_cta_v2_10_size_of.fractional_prior_day_trade_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.prior_day_trade_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.prior_day_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prior Day Trade Message
siac_cts_output_cta_v2_10_dissect.prior_day_trade_message_fields = function(buffer, offset, packet, parent, size_of_prior_day_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.prior_day_trade_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_prior_day_trade_message = siac_cts_output_cta_v2_10_size_of.prior_day_trade_message(buffer, offset)
...
siac_cts_output_cta_v2_10_display.fractional_prior_day_corrected_trade = function(packet, parent, length)
  return ""
end
...
siac_cts_output_cta_v2_10_dissect.fractional_prior_day_corrected_trade = function(buffer, offset, packet, parent)
  if show.fractional_prior_day_corrected_trade then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.fractional_prior_day_corrected_trade, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.fractional_prior_day_corrected_trade_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.fractional_prior_day_corrected_trade(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.fractional_prior_day_corrected_trade_fields(buffer, offset, packet, element)
  end
end
...
siac_cts_output_cta_v2_10_display.fractional_prior_day_trade_correction_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Prior Day Trade Correction Message
siac_cts_output_cta_v2_10_dissect.fractional_prior_day_trade_correction_message_fields = function(buffer, offset, packet, parent, size_of_fractional_prior_day_trade_correction_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.fractional_prior_day_trade_correction_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_prior_day_trade_correction_message = siac_cts_output_cta_v2_10_size_of.fractional_prior_day_trade_correction_message(buffer, offset)
...
siac_cts_output_cta_v2_10_display.prior_day_original_trade = function(packet, parent, length)
  return ""
end
...
siac_cts_output_cta_v2_10_dissect.prior_day_original_trade = function(buffer, offset, packet, parent)
  if show.prior_day_original_trade then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.prior_day_original_trade, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.prior_day_original_trade_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.prior_day_original_trade(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.prior_day_original_trade_fields(buffer, offset, packet, element)
  end
end
...
siac_cts_output_cta_v2_10_display.prior_day_corrected_trade = function(packet, parent, length)
  return ""
end
...
siac_cts_output_cta_v2_10_dissect.prior_day_corrected_trade = function(buffer, offset, packet, parent)
  if show.prior_day_corrected_trade then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.prior_day_corrected_trade, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.prior_day_corrected_trade_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.prior_day_corrected_trade(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.prior_day_corrected_trade_fields(buffer, offset, packet, element)
  end
end

-- Read runtime size of: Prior Day Trade Correction Message
siac_cts_output_cta_v2_10_size_of.prior_day_trade_correction_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.prior_day_trade_correction_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prior Day Trade Correction Message
siac_cts_output_cta_v2_10_dissect.prior_day_trade_correction_message_fields = function(buffer, offset, packet, parent, size_of_prior_day_trade_correction_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.prior_day_trade_correction_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_prior_day_trade_correction_message = siac_cts_output_cta_v2_10_size_of.prior_day_trade_correction_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.prior_day_payload = function(buffer, offset, prior_day_message_type)
  -- Size of Prior Day Trade Correction Message
  if prior_day_message_type == "C" then
    return siac_cts_output_cta_v2_10_size_of.prior_day_trade_correction_message(buffer, offset)
  end
  -- Size of Fractional Prior Day Trade Correction Message
  if prior_day_message_type == "O" then
    return siac_cts_output_cta_v2_10_size_of.fractional_prior_day_trade_correction_message(buffer, offset)
  end
  -- Size of Prior Day Trade Message
  if prior_day_message_type == "L" then
    return siac_cts_output_cta_v2_10_size_of.prior_day_trade_message(buffer, offset)
  end
  -- Size of Fractional Prior Day Trade Message
  if prior_day_message_type == "R" then
    return siac_cts_output_cta_v2_10_size_of.fractional_prior_day_trade_message(buffer, offset)
  end
  -- Size of Prior Day Trade Message
...
siac_cts_output_cta_v2_10_display.prior_day_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Prior Day Payload
siac_cts_output_cta_v2_10_dissect.prior_day_payload_branches = function(buffer, offset, packet, parent, prior_day_message_type)
  -- Dissect Prior Day Trade Correction Message
  if prior_day_message_type == "C" then
    return siac_cts_output_cta_v2_10_dissect.prior_day_trade_correction_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Prior Day Trade Correction Message
  if prior_day_message_type == "O" then
    return siac_cts_output_cta_v2_10_dissect.fractional_prior_day_trade_correction_message(buffer, offset, packet, parent)
  end
  -- Dissect Prior Day Trade Message
  if prior_day_message_type == "L" then
    return siac_cts_output_cta_v2_10_dissect.prior_day_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Prior Day Trade Message
  if prior_day_message_type == "R" then
    return siac_cts_output_cta_v2_10_dissect.fractional_prior_day_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Prior Day Trade Message
  if prior_day_message_type == "X" then
    return siac_cts_output_cta_v2_10_dissect.prior_day_trade_message(buffer, offset, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.prior_day_payload = function(buffer, offset, packet, parent, prior_day_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_10_size_of.prior_day_payload(buffer, offset, prior_day_message_type)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.prior_day_message_type = 1

-- Display: Prior Day Message Type
siac_cts_output_cta_v2_10_display.prior_day_message_type = function(value)
  if value == "C" then
...
siac_cts_output_cta_v2_10_dissect.prior_day_message_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.prior_day_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.prior_day = function(buffer, offset)
  local index = offset
...
-- Display: Prior Day
siac_cts_output_cta_v2_10_display.prior_day = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prior Day
siac_cts_output_cta_v2_10_dissect.prior_day_fields = function(buffer, offset, packet, parent, size_of_prior_day)
  local index = offset

  -- Prior Day Message Type: 1 Byte Ascii String Enum with 6 values
  index, prior_day_message_type = siac_cts_output_cta_v2_10_dissect.prior_day_message_type(buffer, index, packet, parent)

  -- Prior Day Payload: Runtime Type with 6 branches
  index = siac_cts_output_cta_v2_10_dissect.prior_day_payload(buffer, index, packet, parent, prior_day_message_type)

  return index
end

-- Dissect: Prior Day
siac_cts_output_cta_v2_10_dissect.prior_day = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_prior_day = siac_cts_output_cta_v2_10_size_of.prior_day(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.crossing_session_2_total_trades_volume = 8

-- Display: Crossing Session 2 Total Trades Volume
siac_cts_output_cta_v2_10_display.crossing_session_2_total_trades_volume = function(value)
  return "Crossing Session 2 Total Trades Volume: "..value
end

-- Dissect: Crossing Session 2 Total Trades Volume
siac_cts_output_cta_v2_10_dissect.crossing_session_2_total_trades_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.crossing_session_2_total_trades_volume
  local range = buffer(offset, length)
  local value = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.crossing_session_2_dollar_value = 8

-- Display: Crossing Session 2 Dollar Value
siac_cts_output_cta_v2_10_display.crossing_session_2_dollar_value = function(value)
  return "Crossing Session 2 Dollar Value: "..value
end

-- Dissect: Crossing Session 2 Dollar Value
siac_cts_output_cta_v2_10_dissect.crossing_session_2_dollar_value = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.crossing_session_2_dollar_value
  local range = buffer(offset, length)
  local value = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.crossing_session_1_total_trades_volume = 8

-- Display: Crossing Session 1 Total Trades Volume
siac_cts_output_cta_v2_10_display.crossing_session_1_total_trades_volume = function(value)
  return "Crossing Session 1 Total Trades Volume: "..value
end

-- Dissect: Crossing Session 1 Total Trades Volume
siac_cts_output_cta_v2_10_dissect.crossing_session_1_total_trades_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.crossing_session_1_total_trades_volume
  local range = buffer(offset, length)
  local value = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.crossing_session_summary_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.crossing_session_summary_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Crossing Session Summary Message
siac_cts_output_cta_v2_10_dissect.crossing_session_summary_message_fields = function(buffer, offset, packet, parent, size_of_crossing_session_summary_message)
  local index = offset
  ...
  index, crossing_session_1_total_trades_volume = siac_cts_output_cta_v2_10_dissect.crossing_session_1_total_trades_volume(buffer, index, packet, parent)

  -- Crossing Session 2 Dollar Value: 8 Byte Unsigned Fixed Width Integer
  index, crossing_session_2_dollar_value = siac_cts_output_cta_v2_10_dissect.crossing_session_2_dollar_value(buffer, index, packet, parent)

  -- Crossing Session 2 Total Trades Volume: 8 Byte Unsigned Fixed Width Integer
  index, crossing_session_2_total_trades_volume = siac_cts_output_cta_v2_10_dissect.crossing_session_2_total_trades_volume(buffer, index, packet, parent)

  return index
end

-- Dissect: Crossing Session Summary Message
siac_cts_output_cta_v2_10_dissect.crossing_session_summary_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_crossing_session_summary_message = siac_cts_output_cta_v2_10_size_of.crossing_session_summary_message(buffer, offset)
...
-- Size: Dollar Value
siac_cts_output_cta_v2_10_size_of.dollar_value = 8

-- Display: Dollar Value
siac_cts_output_cta_v2_10_display.dollar_value = function(value)
  return "Dollar Value: "..value
end

-- Dissect: Dollar Value
siac_cts_output_cta_v2_10_dissect.dollar_value = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.dollar_value
  local range = buffer(offset, length)
  local value = range:uint64()
...
-- Size: Total Trades
siac_cts_output_cta_v2_10_size_of.total_trades = 4

-- Display: Total Trades
siac_cts_output_cta_v2_10_display.total_trades = function(value)
  return "Total Trades: "..value
end

-- Dissect: Total Trades
siac_cts_output_cta_v2_10_dissect.total_trades = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.total_trades
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.approximate_trades_and_total_dollar_value_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.approximate_trades_and_total_dollar_value_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Approximate Trades And Total Dollar Value Message
siac_cts_output_cta_v2_10_dissect.approximate_trades_and_total_dollar_value_message_fields = function(buffer, offset, packet, parent, size_of_approximate_trades_and_total_dollar_value_message)
  local index = offset
  ...
  index, total_trades = siac_cts_output_cta_v2_10_dissect.total_trades(buffer, index, packet, parent)

  -- Dollar Value: 8 Byte Unsigned Fixed Width Integer
  index, dollar_value = siac_cts_output_cta_v2_10_dissect.dollar_value(buffer, index, packet, parent)

  return index
end

-- Dissect: Approximate Trades And Total Dollar Value Message
siac_cts_output_cta_v2_10_dissect.approximate_trades_and_total_dollar_value_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_approximate_trades_and_total_dollar_value_message = siac_cts_output_cta_v2_10_size_of.approximate_trades_and_total_dollar_value_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.fractional_trade_total_volume = 8

-- Display: Fractional Trade Total Volume
siac_cts_output_cta_v2_10_display.fractional_trade_total_volume = function(value)
  return "Fractional Trade Total Volume: "..value
end

-- Dissect: Fractional Trade Total Volume
siac_cts_output_cta_v2_10_dissect.fractional_trade_total_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.fractional_trade_total_volume
  local range = buffer(offset, length)
  local value = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.fractional_participants = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_10_size_of.participant_id

  index = index + siac_cts_output_cta_v2_10_size_of.fractional_trade_total_volume

  return index
end

-- Display: Fractional Participants
siac_cts_output_cta_v2_10_display.fractional_participants = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Participants
siac_cts_output_cta_v2_10_dissect.fractional_participants_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Participant Id: 1 Byte Ascii String Enum with 20 values
  index, participant_id = siac_cts_output_cta_v2_10_dissect.participant_id(buffer, index, packet, parent)

  -- Fractional Trade Total Volume: 8 Byte Unsigned Fixed Width Integer
  index, fractional_trade_total_volume = siac_cts_output_cta_v2_10_dissect.fractional_trade_total_volume(buffer, index, packet, parent)

  return index
end

-- Dissect: Fractional Participants
siac_cts_output_cta_v2_10_dissect.fractional_participants = function(buffer, offset, packet, parent)
  if show.fractional_participants then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.fractional_participants, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.fractional_participants_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.fractional_participants(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.fractional_participants_fields(buffer, offset, packet, element)
  end
end

-- Read runtime size of: Fractional Approximate Adjusted Volume Market Center Message
siac_cts_output_cta_v2_10_size_of.fractional_approximate_adjusted_volume_market_center_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.fractional_approximate_adjusted_volume_market_center_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fractional Approximate Adjusted Volume Market Center Message
siac_cts_output_cta_v2_10_dissect.fractional_approximate_adjusted_volume_market_center_message_fields = function(buffer, offset, packet, parent, size_of_fractional_approximate_adjusted_volume_market_center_message)
  local index = offset
  ...
  for fractional_participants_index = 1, number_of_participants do
    index, fractional_participants = siac_cts_output_cta_v2_10_dissect.fractional_participants(buffer, index, packet, parent)

    if fractional_participants ~= nil then
      local iteration = fractional_participants:add(siac_cts_output_cta_v2_10.fields.fractional_participants_index, fractional_participants_index)
...
siac_cts_output_cta_v2_10_dissect.fractional_approximate_adjusted_volume_market_center_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_fractional_approximate_adjusted_volume_market_center_message = siac_cts_output_cta_v2_10_size_of.fractional_approximate_adjusted_volume_market_center_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.trade_total_volume = 8

-- Display: Trade Total Volume
siac_cts_output_cta_v2_10_display.trade_total_volume = function(value)
  return "Trade Total Volume: "..value
end

-- Dissect: Trade Total Volume
siac_cts_output_cta_v2_10_dissect.trade_total_volume = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.trade_total_volume
  local range = buffer(offset, length)
  local value = range:uint64()
...
siac_cts_output_cta_v2_10_size_of.participants = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_10_size_of.participant_id

  index = index + siac_cts_output_cta_v2_10_size_of.trade_total_volume

  return index
end

-- Display: Participants
siac_cts_output_cta_v2_10_display.participants = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Participants
siac_cts_output_cta_v2_10_dissect.participants_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, trade_total_volume = siac_cts_output_cta_v2_10_dissect.trade_total_volume(buffer, index, packet, parent)

  return index
end

-- Dissect: Participants
siac_cts_output_cta_v2_10_dissect.participants = function(buffer, offset, packet, parent)
  if show.participants then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.participants, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.participants_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.participants(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.participants_fields(buffer, offset, packet, element)
  end
end

-- Read runtime size of: Approximate Adjusted Volume Market Center Message
siac_cts_output_cta_v2_10_size_of.approximate_adjusted_volume_market_center_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.approximate_adjusted_volume_market_center_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Approximate Adjusted Volume Market Center Message
siac_cts_output_cta_v2_10_dissect.approximate_adjusted_volume_market_center_message_fields = function(buffer, offset, packet, parent, size_of_approximate_adjusted_volume_market_center_message)
  local index = offset
  ...
  for participants_index = 1, number_of_participants do
    index, participants = siac_cts_output_cta_v2_10_dissect.participants(buffer, index, packet, parent)

    if participants ~= nil then
      local iteration = participants:add(siac_cts_output_cta_v2_10.fields.participants_index, participants_index)
      iteration:set_generated()
    end
  end
...
siac_cts_output_cta_v2_10_dissect.approximate_adjusted_volume_market_center_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_approximate_adjusted_volume_market_center_message = siac_cts_output_cta_v2_10_size_of.approximate_adjusted_volume_market_center_message(buffer, offset)
...
-- Size: Reserved
siac_cts_output_cta_v2_10_size_of.reserved = 1

-- Display: Reserved
siac_cts_output_cta_v2_10_display.reserved = function(value)
  return "Reserved: "..value
end

-- Dissect: Reserved
siac_cts_output_cta_v2_10_dissect.reserved = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.reserved
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_display.market_wide_circuit_breaker_status_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Market Wide Circuit Breaker Status Message
siac_cts_output_cta_v2_10_dissect.market_wide_circuit_breaker_status_message_fields = function(buffer, offset, packet, parent, size_of_market_wide_circuit_breaker_status_message)
  local index = offset
  ...
  index, reserved = siac_cts_output_cta_v2_10_dissect.reserved(buffer, index, packet, parent)

  return index
end

-- Dissect: Market Wide Circuit Breaker Status Message
siac_cts_output_cta_v2_10_dissect.market_wide_circuit_breaker_status_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_market_wide_circuit_breaker_status_message = siac_cts_output_cta_v2_10_size_of.market_wide_circuit_breaker_status_message(buffer, offset)
...
-- Size: Mwcb Level 3
siac_cts_output_cta_v2_10_size_of.mwcb_level_3 = 8

-- Display: Mwcb Level 3
siac_cts_output_cta_v2_10_display.mwcb_level_3 = function(value)
  return "Mwcb Level 3: "..value
end

-- Dissect: Mwcb Level 3
siac_cts_output_cta_v2_10_dissect.mwcb_level_3 = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.mwcb_level_3
  local range = buffer(offset, length)
  local value = range:int64()
...
-- Size: Mwcb Level 2
siac_cts_output_cta_v2_10_size_of.mwcb_level_2 = 8

-- Display: Mwcb Level 2
siac_cts_output_cta_v2_10_display.mwcb_level_2 = function(value)
  return "Mwcb Level 2: "..value
end

-- Dissect: Mwcb Level 2
siac_cts_output_cta_v2_10_dissect.mwcb_level_2 = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.mwcb_level_2
  local range = buffer(offset, length)
  local value = range:int64()
...
siac_cts_output_cta_v2_10_display.market_wide_circuit_breaker_decline_level_status_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Market Wide Circuit Breaker Decline Level Status Message
siac_cts_output_cta_v2_10_dissect.market_wide_circuit_breaker_decline_level_status_message_fields = function(buffer, offset, packet, parent, size_of_market_wide_circuit_breaker_decline_level_status_message)
  local index = offset
  ...
  index, mwcb_level_2 = siac_cts_output_cta_v2_10_dissect.mwcb_level_2(buffer, index, packet, parent)

  -- Mwcb Level 3: 8 Byte Signed Fixed Width Integer
  index, mwcb_level_3 = siac_cts_output_cta_v2_10_dissect.mwcb_level_3(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.market_wide_circuit_breaker_decline_level_status_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_market_wide_circuit_breaker_decline_level_status_message = siac_cts_output_cta_v2_10_size_of.market_wide_circuit_breaker_decline_level_status_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.market_status_payload = function(buffer, offset, market_status_message_type)
  -- Size of Market Wide Circuit Breaker Decline Level Status Message
  if market_status_message_type == "M" then
    return siac_cts_output_cta_v2_10_size_of.market_wide_circuit_breaker_decline_level_status_message(buffer, offset)
  end
  -- Size of Market Wide Circuit Breaker Status Message
  if market_status_message_type == "L" then
    return siac_cts_output_cta_v2_10_size_of.market_wide_circuit_breaker_status_message(buffer, offset)
  end
  -- Size of Approximate Adjusted Volume Market Center Message
  if market_status_message_type == "N" then
    return siac_cts_output_cta_v2_10_size_of.approximate_adjusted_volume_market_center_message(buffer, offset)
  end
  -- Size of Fractional Approximate Adjusted Volume Market Center Message
  if market_status_message_type == "V" then
    return siac_cts_output_cta_v2_10_size_of.fractional_approximate_adjusted_volume_market_center_message(buffer, offset)
  end
  -- Size of Approximate Trades And Total Dollar Value Message
  if market_status_message_type == "O" then
    return siac_cts_output_cta_v2_10_size_of.approximate_trades_and_total_dollar_value_message(buffer, offset)
  end
  -- Size of Crossing Session Summary Message
  if market_status_message_type == "P" then
    return siac_cts_output_cta_v2_10_size_of.crossing_session_summary_message(buffer, offset)
  end
...
siac_cts_output_cta_v2_10_display.market_status_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Market Status Payload
siac_cts_output_cta_v2_10_dissect.market_status_payload_branches = function(buffer, offset, packet, parent, market_status_message_type)
  -- Dissect Market Wide Circuit Breaker Decline Level Status Message
  if market_status_message_type == "M" then
    return siac_cts_output_cta_v2_10_dissect.market_wide_circuit_breaker_decline_level_status_message(buffer, offset, packet, parent)
  end
  -- Dissect Market Wide Circuit Breaker Status Message
  if market_status_message_type == "L" then
    return siac_cts_output_cta_v2_10_dissect.market_wide_circuit_breaker_status_message(buffer, offset, packet, parent)
  end
  -- Dissect Approximate Adjusted Volume Market Center Message
  if market_status_message_type == "N" then
    return siac_cts_output_cta_v2_10_dissect.approximate_adjusted_volume_market_center_message(buffer, offset, packet, parent)
  end
  -- Dissect Fractional Approximate Adjusted Volume Market Center Message
  if market_status_message_type == "V" then
    return siac_cts_output_cta_v2_10_dissect.fractional_approximate_adjusted_volume_market_center_message(buffer, offset, packet, parent)
  end
  -- Dissect Approximate Trades And Total Dollar Value Message
  if market_status_message_type == "O" then
    return siac_cts_output_cta_v2_10_dissect.approximate_trades_and_total_dollar_value_message(buffer, offset, packet, parent)
  end
  -- Dissect Crossing Session Summary Message
  if market_status_message_type == "P" then
    return siac_cts_output_cta_v2_10_dissect.crossing_session_summary_message(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v2_10_dissect.market_status_payload = function(buffer, offset, packet, parent, market_status_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_10_size_of.market_status_payload(buffer, offset, market_status_message_type)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.market_status_message_type = 1

-- Display: Market Status Message Type
siac_cts_output_cta_v2_10_display.market_status_message_type = function(value)
  if value == "M" then
...
siac_cts_output_cta_v2_10_dissect.market_status_message_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.market_status_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.market_status = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.market_status = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Market Status
siac_cts_output_cta_v2_10_dissect.market_status_fields = function(buffer, offset, packet, parent, size_of_market_status)
  local index = offset

  -- Market Status Message Type: 1 Byte Ascii String Enum with 6 values
  index, market_status_message_type = siac_cts_output_cta_v2_10_dissect.market_status_message_type(buffer, index, packet, parent)

  -- Market Status Payload: Runtime Type with 6 branches
  index = siac_cts_output_cta_v2_10_dissect.market_status_payload(buffer, index, packet, parent, market_status_message_type)

  return index
end

-- Dissect: Market Status
siac_cts_output_cta_v2_10_dissect.market_status = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_market_status = siac_cts_output_cta_v2_10_size_of.market_status(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.offer_index_value = 8

-- Display: Offer Index Value
siac_cts_output_cta_v2_10_display.offer_index_value = function(value)
  return "Offer Index Value: "..value
end

-- Dissect: Offer Index Value
siac_cts_output_cta_v2_10_dissect.offer_index_value = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.offer_index_value
  local range = buffer(offset, length)
  local value = range:int64()
...
siac_cts_output_cta_v2_10_size_of.bid_index_value = 8

-- Display: Bid Index Value
siac_cts_output_cta_v2_10_display.bid_index_value = function(value)
  return "Bid Index Value: "..value
end

-- Dissect: Bid Index Value
siac_cts_output_cta_v2_10_dissect.bid_index_value = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.bid_index_value
  local range = buffer(offset, length)
  local value = range:int64()
...
-- Size: Index Symbol
siac_cts_output_cta_v2_10_size_of.index_symbol = 11

-- Display: Index Symbol
siac_cts_output_cta_v2_10_display.index_symbol = function(value)
  return "Index Symbol: "..value
end

-- Dissect: Index Symbol
siac_cts_output_cta_v2_10_dissect.index_symbol = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.index_symbol
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.bid_and_offer_index_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.bid_and_offer_index_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Bid And Offer Index Message
siac_cts_output_cta_v2_10_dissect.bid_and_offer_index_message_fields = function(buffer, offset, packet, parent, size_of_bid_and_offer_index_message)
  local index = offset
  ...
  index, index_symbol = siac_cts_output_cta_v2_10_dissect.index_symbol(buffer, index, packet, parent)

  -- Bid Index Value: 8 Byte Signed Fixed Width Integer
  index, bid_index_value = siac_cts_output_cta_v2_10_dissect.bid_index_value(buffer, index, packet, parent)

  -- Offer Index Value: 8 Byte Signed Fixed Width Integer
  index, offer_index_value = siac_cts_output_cta_v2_10_dissect.offer_index_value(buffer, index, packet, parent)

  return index
end

-- Dissect: Bid And Offer Index Message
siac_cts_output_cta_v2_10_dissect.bid_and_offer_index_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_bid_and_offer_index_message = siac_cts_output_cta_v2_10_size_of.bid_and_offer_index_message(buffer, offset)
...
-- Size: Index Value
siac_cts_output_cta_v2_10_size_of.index_value = 8

-- Display: Index Value
siac_cts_output_cta_v2_10_display.index_value = function(value)
  return "Index Value: "..value
end

-- Dissect: Index Value
siac_cts_output_cta_v2_10_dissect.index_value = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.index_value
  local range = buffer(offset, length)
  local value = range:int64()
...
siac_cts_output_cta_v2_10_size_of.index_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.index_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Index Message
siac_cts_output_cta_v2_10_dissect.index_message_fields = function(buffer, offset, packet, parent, size_of_index_message)
  local index = offset
  ...
  index, index_value = siac_cts_output_cta_v2_10_dissect.index_value(buffer, index, packet, parent)

  return index
end

-- Dissect: Index Message
siac_cts_output_cta_v2_10_dissect.index_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_index_message = siac_cts_output_cta_v2_10_size_of.index_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.index_payload = function(buffer, offset, index_message_type)
  -- Size of Index Message
  if index_message_type == "I" then
    return siac_cts_output_cta_v2_10_size_of.index_message(buffer, offset)
  end
  -- Size of Bid And Offer Index Message
  if index_message_type == "Q" then
    return siac_cts_output_cta_v2_10_size_of.bid_and_offer_index_message(buffer, offset)
  end
...
siac_cts_output_cta_v2_10_display.index_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Index Payload
siac_cts_output_cta_v2_10_dissect.index_payload_branches = function(buffer, offset, packet, parent, index_message_type)
  -- Dissect Index Message
  if index_message_type == "I" then
    return siac_cts_output_cta_v2_10_dissect.index_message(buffer, offset, packet, parent)
  end
  -- Dissect Bid And Offer Index Message
  if index_message_type == "Q" then
    return siac_cts_output_cta_v2_10_dissect.bid_and_offer_index_message(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v2_10_dissect.index_payload = function(buffer, offset, packet, parent, index_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_10_size_of.index_payload(buffer, offset, index_message_type)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.index_message_type = 1

-- Display: Index Message Type
siac_cts_output_cta_v2_10_display.index_message_type = function(value)
  if value == "I" then
...
siac_cts_output_cta_v2_10_dissect.index_message_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.index_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.index = function(buffer, offset)
  local index = offset
...
-- Display: Index
siac_cts_output_cta_v2_10_display.index = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Index
siac_cts_output_cta_v2_10_dissect.index_fields = function(buffer, offset, packet, parent, size_of_index)
  local index = offset

  -- Index Message Type: 1 Byte Ascii String Enum with 2 values
  index, index_message_type = siac_cts_output_cta_v2_10_dissect.index_message_type(buffer, index, packet, parent)

  -- Index Payload: Runtime Type with 2 branches
  index = siac_cts_output_cta_v2_10_dissect.index_payload(buffer, index, packet, parent, index_message_type)

  return index
end

-- Dissect: Index
siac_cts_output_cta_v2_10_dissect.index = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_index = siac_cts_output_cta_v2_10_size_of.index(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.end_of_day_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.end_of_day_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: End Of Day Message
siac_cts_output_cta_v2_10_dissect.end_of_day_message_fields = function(buffer, offset, packet, parent, size_of_end_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.end_of_day_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_end_of_day_message = siac_cts_output_cta_v2_10_size_of.end_of_day_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.line_integrity_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.line_integrity_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Line Integrity Message
siac_cts_output_cta_v2_10_dissect.line_integrity_message_fields = function(buffer, offset, packet, parent, size_of_line_integrity_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.line_integrity_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_line_integrity_message = siac_cts_output_cta_v2_10_size_of.line_integrity_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.disaster_recovery_data_center_activation_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.disaster_recovery_data_center_activation_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Disaster Recovery Data Center Activation Message
siac_cts_output_cta_v2_10_dissect.disaster_recovery_data_center_activation_message_fields = function(buffer, offset, packet, parent, size_of_disaster_recovery_data_center_activation_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.disaster_recovery_data_center_activation_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_disaster_recovery_data_center_activation_message = siac_cts_output_cta_v2_10_size_of.disaster_recovery_data_center_activation_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.reset_block_sequence_number_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.reset_block_sequence_number_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Reset Block Sequence Number Message
siac_cts_output_cta_v2_10_dissect.reset_block_sequence_number_message_fields = function(buffer, offset, packet, parent, size_of_reset_block_sequence_number_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.reset_block_sequence_number_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_reset_block_sequence_number_message = siac_cts_output_cta_v2_10_size_of.reset_block_sequence_number_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.start_of_day_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.start_of_day_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Start Of Day Message
siac_cts_output_cta_v2_10_dissect.start_of_day_message_fields = function(buffer, offset, packet, parent, size_of_start_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.start_of_day_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_start_of_day_message = siac_cts_output_cta_v2_10_size_of.start_of_day_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.control_payload = function(buffer, offset, control_message_type)
  -- Size of Start Of Day Message
  if control_message_type == "A" then
    return siac_cts_output_cta_v2_10_size_of.start_of_day_message(buffer, offset)
  end
  -- Size of Reset Block Sequence Number Message
  if control_message_type == "L" then
    return siac_cts_output_cta_v2_10_size_of.reset_block_sequence_number_message(buffer, offset)
  end
  -- Size of Disaster Recovery Data Center Activation Message
  if control_message_type == "P" then
    return siac_cts_output_cta_v2_10_size_of.disaster_recovery_data_center_activation_message(buffer, offset)
  end
  -- Size of Line Integrity Message
  if control_message_type == "T" then
    return siac_cts_output_cta_v2_10_size_of.line_integrity_message(buffer, offset)
  end
  -- Size of End Of Day Message
  if control_message_type == "Z" then
    return siac_cts_output_cta_v2_10_size_of.end_of_day_message(buffer, offset)
  end
...
siac_cts_output_cta_v2_10_display.control_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Control Payload
siac_cts_output_cta_v2_10_dissect.control_payload_branches = function(buffer, offset, packet, parent, control_message_type)
  -- Dissect Start Of Day Message
  if control_message_type == "A" then
    return siac_cts_output_cta_v2_10_dissect.start_of_day_message(buffer, offset, packet, parent)
  end
  -- Dissect Reset Block Sequence Number Message
  if control_message_type == "L" then
    return siac_cts_output_cta_v2_10_dissect.reset_block_sequence_number_message(buffer, offset, packet, parent)
  end
  -- Dissect Disaster Recovery Data Center Activation Message
  if control_message_type == "P" then
    return siac_cts_output_cta_v2_10_dissect.disaster_recovery_data_center_activation_message(buffer, offset, packet, parent)
  end
  -- Dissect Line Integrity Message
  if control_message_type == "T" then
    return siac_cts_output_cta_v2_10_dissect.line_integrity_message(buffer, offset, packet, parent)
  end
  -- Dissect End Of Day Message
  if control_message_type == "Z" then
    return siac_cts_output_cta_v2_10_dissect.end_of_day_message(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v2_10_dissect.control_payload = function(buffer, offset, packet, parent, control_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_10_size_of.control_payload(buffer, offset, control_message_type)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.control_message_type = 1

-- Display: Control Message Type
siac_cts_output_cta_v2_10_display.control_message_type = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.control_message_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.control_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.control = function(buffer, offset)
  local index = offset
...
-- Display: Control
siac_cts_output_cta_v2_10_display.control = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Control
siac_cts_output_cta_v2_10_dissect.control_fields = function(buffer, offset, packet, parent, size_of_control)
  local index = offset

  -- Control Message Type: 1 Byte Ascii String Enum with 5 values
  index, control_message_type = siac_cts_output_cta_v2_10_dissect.control_message_type(buffer, index, packet, parent)

  -- Control Payload: Runtime Type with 5 branches
  index = siac_cts_output_cta_v2_10_dissect.control_payload(buffer, index, packet, parent, control_message_type)

  return index
end

-- Dissect: Control
siac_cts_output_cta_v2_10_dissect.control = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_control = siac_cts_output_cta_v2_10_size_of.control(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.end_of_start_of_day_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.end_of_start_of_day_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: End Of Start Of Day Message
siac_cts_output_cta_v2_10_dissect.end_of_start_of_day_message_fields = function(buffer, offset, packet, parent, size_of_end_of_start_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.end_of_start_of_day_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_end_of_start_of_day_message = siac_cts_output_cta_v2_10_size_of.end_of_start_of_day_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.start_of_start_of_day_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.start_of_start_of_day_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Start Of Start Of Day Message
siac_cts_output_cta_v2_10_dissect.start_of_start_of_day_message_fields = function(buffer, offset, packet, parent, size_of_start_of_start_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.start_of_start_of_day_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_start_of_start_of_day_message = siac_cts_output_cta_v2_10_size_of.start_of_start_of_day_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.end_of_end_of_day_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.end_of_end_of_day_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: End Of End Of Day Message
siac_cts_output_cta_v2_10_dissect.end_of_end_of_day_message_fields = function(buffer, offset, packet, parent, size_of_end_of_end_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.end_of_end_of_day_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_end_of_end_of_day_message = siac_cts_output_cta_v2_10_size_of.end_of_end_of_day_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.start_of_end_of_day_message = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.start_of_end_of_day_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Start Of End Of Day Message
siac_cts_output_cta_v2_10_dissect.start_of_end_of_day_message_fields = function(buffer, offset, packet, parent, size_of_start_of_end_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.start_of_end_of_day_message = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_start_of_end_of_day_message = siac_cts_output_cta_v2_10_size_of.start_of_end_of_day_message(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.administrative_payload = function(buffer, offset, administrative_message_type)
  -- Size of Start Of End Of Day Message
  if administrative_message_type == "A" then
    return siac_cts_output_cta_v2_10_size_of.start_of_end_of_day_message(buffer, offset)
  end
  -- Size of End Of End Of Day Message
  if administrative_message_type == "B" then
    return siac_cts_output_cta_v2_10_size_of.end_of_end_of_day_message(buffer, offset)
  end
  -- Size of Start Of Start Of Day Message
  if administrative_message_type == "C" then
    return siac_cts_output_cta_v2_10_size_of.start_of_start_of_day_message(buffer, offset)
  end
  -- Size of End Of Start Of Day Message
  if administrative_message_type == "D" then
    return siac_cts_output_cta_v2_10_size_of.end_of_start_of_day_message(buffer, offset)
  end
...
siac_cts_output_cta_v2_10_display.administrative_payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Administrative Payload
siac_cts_output_cta_v2_10_dissect.administrative_payload_branches = function(buffer, offset, packet, parent, administrative_message_type)
  -- Dissect Start Of End Of Day Message
  if administrative_message_type == "A" then
    return siac_cts_output_cta_v2_10_dissect.start_of_end_of_day_message(buffer, offset, packet, parent)
  end
  -- Dissect End Of End Of Day Message
  if administrative_message_type == "B" then
    return siac_cts_output_cta_v2_10_dissect.end_of_end_of_day_message(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Start Of Day Message
  if administrative_message_type == "C" then
    return siac_cts_output_cta_v2_10_dissect.start_of_start_of_day_message(buffer, offset, packet, parent)
  end
  -- Dissect End Of Start Of Day Message
  if administrative_message_type == "D" then
    return siac_cts_output_cta_v2_10_dissect.end_of_start_of_day_message(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v2_10_dissect.administrative_payload = function(buffer, offset, packet, parent, administrative_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_10_size_of.administrative_payload(buffer, offset, administrative_message_type)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.administrative_message_type = 1

-- Display: Administrative Message Type
siac_cts_output_cta_v2_10_display.administrative_message_type = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.administrative_message_type = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.administrative_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.administrative = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10_display.administrative = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Administrative
siac_cts_output_cta_v2_10_dissect.administrative_fields = function(buffer, offset, packet, parent, size_of_administrative)
  local index = offset

  -- Administrative Message Type: 1 Byte Ascii String Enum with 4 values
  index, administrative_message_type = siac_cts_output_cta_v2_10_dissect.administrative_message_type(buffer, index, packet, parent)

  -- Administrative Payload: Runtime Type with 4 branches
  index = siac_cts_output_cta_v2_10_dissect.administrative_payload(buffer, index, packet, parent, administrative_message_type)

  return index
end

-- Dissect: Administrative
siac_cts_output_cta_v2_10_dissect.administrative = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_administrative = siac_cts_output_cta_v2_10_size_of.administrative(buffer, offset)
...
siac_cts_output_cta_v2_10_size_of.payload = function(buffer, offset, message_category)
  -- Size of Administrative
  if message_category == "A" then
    return siac_cts_output_cta_v2_10_size_of.administrative(buffer, offset)
  end
  -- Size of Control
  if message_category == "C" then
    return siac_cts_output_cta_v2_10_size_of.control(buffer, offset)
  end
  -- Size of Index
  if message_category == "I" then
    return siac_cts_output_cta_v2_10_size_of.index(buffer, offset)
  end
  -- Size of Market Status
  if message_category == "M" then
    return siac_cts_output_cta_v2_10_size_of.market_status(buffer, offset)
  end
  -- Size of Prior Day
  if message_category == "P" then
    return siac_cts_output_cta_v2_10_size_of.prior_day(buffer, offset)
  end
  -- Size of Summary
  if message_category == "S" then
    return siac_cts_output_cta_v2_10_size_of.summary(buffer, offset)
  end
  -- Size of Trade
  if message_category == "T" then
    return siac_cts_output_cta_v2_10_size_of.trade(buffer, offset)
  end
...
-- Display: Payload
siac_cts_output_cta_v2_10_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
siac_cts_output_cta_v2_10_dissect.payload_branches = function(buffer, offset, packet, parent, message_category)
  -- Dissect Administrative
  if message_category == "A" then
    return siac_cts_output_cta_v2_10_dissect.administrative(buffer, offset, packet, parent)
  end
  -- Dissect Control
  if message_category == "C" then
    return siac_cts_output_cta_v2_10_dissect.control(buffer, offset, packet, parent)
  end
  -- Dissect Index
  if message_category == "I" then
    return siac_cts_output_cta_v2_10_dissect.index(buffer, offset, packet, parent)
  end
  -- Dissect Market Status
  if message_category == "M" then
    return siac_cts_output_cta_v2_10_dissect.market_status(buffer, offset, packet, parent)
  end
  -- Dissect Prior Day
  if message_category == "P" then
    return siac_cts_output_cta_v2_10_dissect.prior_day(buffer, offset, packet, parent)
  end
  -- Dissect Summary
  if message_category == "S" then
    return siac_cts_output_cta_v2_10_dissect.summary(buffer, offset, packet, parent)
  end
  -- Dissect Trade
  if message_category == "T" then
    return siac_cts_output_cta_v2_10_dissect.trade(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
siac_cts_output_cta_v2_10_dissect.payload = function(buffer, offset, packet, parent, message_category)
  if not show.payload then
    return siac_cts_output_cta_v2_10_dissect.payload_branches(buffer, offset, packet, parent, message_category)
  end

  -- Calculate size and check that branch is not empty
  local size = siac_cts_output_cta_v2_10_size_of.payload(buffer, offset, message_category)
  if size == 0 then
    return offset
  end
...
siac_cts_output_cta_v2_10_size_of.message_category = 1

-- Display: Message Category
siac_cts_output_cta_v2_10_display.message_category = function(value)
  if value == "A" then
...
siac_cts_output_cta_v2_10_dissect.message_category = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.message_category
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Message Length
siac_cts_output_cta_v2_10_size_of.message_length = 2

-- Display: Message Length
siac_cts_output_cta_v2_10_display.message_length = function(value)
  return "Message Length: "..value
end

-- Dissect: Message Length
siac_cts_output_cta_v2_10_dissect.message_length = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.message_length
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.message_header = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_10_size_of.message_length

  index = index + siac_cts_output_cta_v2_10_size_of.message_category

  return index
end

-- Display: Message Header
siac_cts_output_cta_v2_10_display.message_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message Header
siac_cts_output_cta_v2_10_dissect.message_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Length: 2 Byte Unsigned Fixed Width Integer
  index, message_length = siac_cts_output_cta_v2_10_dissect.message_length(buffer, index, packet, parent)

  -- Message Category: 1 Byte Ascii String Enum with 7 values
  index, message_category = siac_cts_output_cta_v2_10_dissect.message_category(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.message_header, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.message_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.message_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.message_header_fields(buffer, offset, packet, element)
  end
end

-- Display: Message
siac_cts_output_cta_v2_10_display.message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
siac_cts_output_cta_v2_10_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset

  -- Message Header: Struct of 2 fields
  index, message_header = siac_cts_output_cta_v2_10_dissect.message_header(buffer, index, packet, parent)

  -- Dependency element: Message Category
  local message_category = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 7 branches
  index = siac_cts_output_cta_v2_10_dissect.payload(buffer, index, packet, parent, message_category)

  return index
end

-- Dissect: Message
siac_cts_output_cta_v2_10_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    local element = parent:add(siac_cts_output_cta_v2_10.fields.message, buffer(offset, 0))
    local current = siac_cts_output_cta_v2_10_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = siac_cts_output_cta_v2_10_display.message(buffer, packet, element)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    siac_cts_output_cta_v2_10_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
-- Size: Block Checksum
siac_cts_output_cta_v2_10_size_of.block_checksum = 2

-- Display: Block Checksum
siac_cts_output_cta_v2_10_display.block_checksum = function(value)
  return "Block Checksum: "..value
end

-- Dissect: Block Checksum
siac_cts_output_cta_v2_10_dissect.block_checksum = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.block_checksum
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.sip_block_timestamp = function(buffer, offset)
  local index = 0
...
siac_cts_output_cta_v2_10_display.sip_block_timestamp = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sip Block Timestamp
siac_cts_output_cta_v2_10_dissect.sip_block_timestamp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10_dissect.sip_block_timestamp = function(buffer, offset, packet, parent)
  if show.sip_block_timestamp then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.sip_block_timestamp, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.sip_block_timestamp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.sip_block_timestamp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.sip_block_timestamp_fields(buffer, offset, packet, element)
  end
end

-- Size: Messages In Block
siac_cts_output_cta_v2_10_size_of.messages_in_block = 1

-- Display: Messages In Block
siac_cts_output_cta_v2_10_display.messages_in_block = function(value)
  return "Messages In Block: "..value
end

-- Dissect: Messages In Block
siac_cts_output_cta_v2_10_dissect.messages_in_block = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.messages_in_block
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.block_sequence_number = 4

-- Display: Block Sequence Number
siac_cts_output_cta_v2_10_display.block_sequence_number = function(value)
  return "Block Sequence Number: "..value
end

-- Dissect: Block Sequence Number
siac_cts_output_cta_v2_10_dissect.block_sequence_number = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.block_sequence_number
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.retransmission_indicator = 1

-- Display: Retransmission Indicator
siac_cts_output_cta_v2_10_display.retransmission_indicator = function(value)
  if value == "O" then
...
siac_cts_output_cta_v2_10_dissect.retransmission_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.retransmission_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
siac_cts_output_cta_v2_10_size_of.data_feed_indicator = 1

-- Display: Data Feed Indicator
siac_cts_output_cta_v2_10_display.data_feed_indicator = function(value)
  return "Data Feed Indicator: "..value
end

-- Dissect: Data Feed Indicator
siac_cts_output_cta_v2_10_dissect.data_feed_indicator = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.data_feed_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Block Size
siac_cts_output_cta_v2_10_size_of.block_size = 2

-- Display: Block Size
siac_cts_output_cta_v2_10_display.block_size = function(value)
  return "Block Size: "..value
end

-- Dissect: Block Size
siac_cts_output_cta_v2_10_dissect.block_size = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.block_size
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Version
siac_cts_output_cta_v2_10_size_of.version = 1

-- Display: Version
siac_cts_output_cta_v2_10_display.version = function(value)
  return "Version: "..value
end

-- Dissect: Version
siac_cts_output_cta_v2_10_dissect.version = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10_size_of.version
  local range = buffer(offset, length)
  local value = range:uint()
...
siac_cts_output_cta_v2_10_size_of.block_header = function(buffer, offset)
  local index = 0

  index = index + siac_cts_output_cta_v2_10_size_of.version

  index = index + siac_cts_output_cta_v2_10_size_of.block_size

  index = index + siac_cts_output_cta_v2_10_size_of.data_feed_indicator

  index = index + siac_cts_output_cta_v2_10_size_of.retransmission_indicator

  index = index + siac_cts_output_cta_v2_10_size_of.block_sequence_number

  index = index + siac_cts_output_cta_v2_10_size_of.messages_in_block

  index = index + siac_cts_output_cta_v2_10_size_of.sip_block_timestamp(buffer, offset + index)

  index = index + siac_cts_output_cta_v2_10_size_of.block_checksum

  return index
end

-- Display: Block Header
siac_cts_output_cta_v2_10_display.block_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Block Header
siac_cts_output_cta_v2_10_dissect.block_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Version: 1 Byte Unsigned Fixed Width Integer
  index, version = siac_cts_output_cta_v2_10_dissect.version(buffer, index, packet, parent)

  -- Block Size: 2 Byte Unsigned Fixed Width Integer
  index, block_size = siac_cts_output_cta_v2_10_dissect.block_size(buffer, index, packet, parent)

  -- Data Feed Indicator: 1 Byte Ascii String
  index, data_feed_indicator = siac_cts_output_cta_v2_10_dissect.data_feed_indicator(buffer, index, packet, parent)

  -- Retransmission Indicator: 1 Byte Ascii String Enum with 2 values
  index, retransmission_indicator = siac_cts_output_cta_v2_10_dissect.retransmission_indicator(buffer, index, packet, parent)

  -- Block Sequence Number: 4 Byte Unsigned Fixed Width Integer
  index, block_sequence_number = siac_cts_output_cta_v2_10_dissect.block_sequence_number(buffer, index, packet, parent)

  -- Messages In Block: 1 Byte Unsigned Fixed Width Integer
  index, messages_in_block = siac_cts_output_cta_v2_10_dissect.messages_in_block(buffer, index, packet, parent)

  -- Sip Block Timestamp: Struct of 2 fields
  index, sip_block_timestamp = siac_cts_output_cta_v2_10_dissect.sip_block_timestamp(buffer, index, packet, parent)

  -- Block Checksum: 2 Byte Unsigned Fixed Width Integer
  index, block_checksum = siac_cts_output_cta_v2_10_dissect.block_checksum(buffer, index, packet, parent)
...
siac_cts_output_cta_v2_10_dissect.block_header = function(buffer, offset, packet, parent)
  if show.block_header then
    -- Optionally add element to protocol tree
    local element = parent:add(siac_cts_output_cta_v2_10.fields.block_header, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10_dissect.block_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = siac_cts_output_cta_v2_10_display.block_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10_dissect.block_header_fields(buffer, offset, packet, element)
  end
end

-- Dissect Packet
siac_cts_output_cta_v2_10_dissect.packet = function(buffer, packet, parent)
  local index = 0

  -- Block Header: Struct of 8 fields
  index, block_header = siac_cts_output_cta_v2_10_dissect.block_header(buffer, index, packet, parent)
  ...
  for message_index = 1, messages_in_block do
    ...
    index, message = siac_cts_output_cta_v2_10_dissect.message(buffer, index, packet, parent, message_length)

    if message ~= nil then
      local iteration = message:add(siac_cts_output_cta_v2_10.fields.message_index, message_index)
      iteration:set_generated()
    end
  end
  ...
  if block_pad_byte_exists then
    index, block_pad_byte = siac_cts_output_cta_v2_10_dissect.block_pad_byte(buffer, index, packet, parent)
  end
