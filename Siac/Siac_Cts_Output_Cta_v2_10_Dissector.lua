...
show.fractional_participants_index = true
...
omi_siac_cts_output_cta_v2_10.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_siac_cts_output_cta_v2_10.prefs_changed()
  ...
  if show.message_index ~= omi_siac_cts_output_cta_v2_10.prefs.show_message_index then
    show.message_index = omi_siac_cts_output_cta_v2_10.prefs.show_message_index
  end
  if show.participants_index ~= omi_siac_cts_output_cta_v2_10.prefs.show_participants_index then
    show.participants_index = omi_siac_cts_output_cta_v2_10.prefs.show_participants_index
  end
  if show.fractional_participants_index ~= omi_siac_cts_output_cta_v2_10.prefs.show_fractional_participants_index then
    show.fractional_participants_index = omi_siac_cts_output_cta_v2_10.prefs.show_fractional_participants_index
  end
end
...
siac_cts_output_cta_v2_10.fractional_participants.fields = function(buffer, offset, packet, parent, fractional_participants_index)
  ...
  if fractional_participants_index ~= nil and show.fractional_participants_index then
