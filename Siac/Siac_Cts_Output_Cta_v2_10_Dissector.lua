...
show.fractional_prior_day_original_trade = true
...
omi_siac_cts_output_cta_v2_10.prefs.show_fractional_prior_day_original_trade = Pref.bool("Show Fractional Prior Day Original Trade", show.fractional_prior_day_original_trade, "Parse and add Fractional Prior Day Original Trade to protocol tree")
...
function omi_siac_cts_output_cta_v2_10.prefs_changed()
  ...
  if show.fractional_prior_day_original_trade ~= omi_siac_cts_output_cta_v2_10.prefs.show_fractional_prior_day_original_trade then
    show.fractional_prior_day_original_trade = omi_siac_cts_output_cta_v2_10.prefs.show_fractional_prior_day_original_trade
    changed = true
  end
...
siac_cts_output_cta_v2_10.fractional_trade_cancel_error_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_trade_cancel_error_message.fields = function(buffer, offset, packet, parent, size_of_fractional_trade_cancel_error_message)
  local index = offset
...
siac_cts_output_cta_v2_10.trade_cancel_error_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.trade_cancel_error_message.fields = function(buffer, offset, packet, parent, size_of_trade_cancel_error_message)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_short_trade_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_short_trade_message.fields = function(buffer, offset, packet, parent, size_of_fractional_short_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10.short_trade_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.short_trade_message.fields = function(buffer, offset, packet, parent, size_of_short_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10.trading_status_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.trading_status_message.fields = function(buffer, offset, packet, parent, size_of_trading_status_message)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_long_trade_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_long_trade_message.fields = function(buffer, offset, packet, parent, size_of_fractional_long_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10.long_trade_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.long_trade_message.fields = function(buffer, offset, packet, parent, size_of_long_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_trade_correction_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_trade_correction_message.fields = function(buffer, offset, packet, parent, size_of_fractional_trade_correction_message)
  local index = offset
...
siac_cts_output_cta_v2_10.trade_correction_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.trade_correction_message.fields = function(buffer, offset, packet, parent, size_of_trade_correction_message)
  local index = offset
...
siac_cts_output_cta_v2_10.auction_status_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.auction_status_message.fields = function(buffer, offset, packet, parent, size_of_auction_status_message)
  local index = offset
...
-- Trade Payload
siac_cts_output_cta_v2_10.trade_payload = {}

-- Size: Trade Payload
siac_cts_output_cta_v2_10.trade_payload.size = function(buffer, offset, trade_message_type)
  -- Size of Auction Status Message
  if trade_message_type == "A" then
    return siac_cts_output_cta_v2_10.auction_status_message.size(buffer, offset)
  end
  -- Size of Trade Correction Message
  if trade_message_type == "C" then
    return siac_cts_output_cta_v2_10.trade_correction_message.size(buffer, offset)
  end
  -- Size of Fractional Trade Correction Message
  if trade_message_type == "O" then
    return siac_cts_output_cta_v2_10.fractional_trade_correction_message.size(buffer, offset)
  end
  -- Size of Long Trade Message
  if trade_message_type == "L" then
    return siac_cts_output_cta_v2_10.long_trade_message.size(buffer, offset)
  end
  -- Size of Fractional Long Trade Message
  if trade_message_type == "R" then
    return siac_cts_output_cta_v2_10.fractional_long_trade_message.size(buffer, offset)
  end
  -- Size of Trading Status Message
  if trade_message_type == "S" then
    return siac_cts_output_cta_v2_10.trading_status_message.size(buffer, offset)
  end
  -- Size of Short Trade Message
  if trade_message_type == "T" then
    return siac_cts_output_cta_v2_10.short_trade_message.size(buffer, offset)
  end
  -- Size of Fractional Short Trade Message
  if trade_message_type == "H" then
    return siac_cts_output_cta_v2_10.fractional_short_trade_message.size(buffer, offset)
  end
  -- Size of Trade Cancel Error Message
  if trade_message_type == "X" then
    return siac_cts_output_cta_v2_10.trade_cancel_error_message.size(buffer, offset)
  end
  -- Size of Fractional Trade Cancel Error Message
  if trade_message_type == "E" then
    return siac_cts_output_cta_v2_10.fractional_trade_cancel_error_message.size(buffer, offset)
  end
...
siac_cts_output_cta_v2_10.trade_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Trade Payload
siac_cts_output_cta_v2_10.trade_payload.branches = function(buffer, offset, packet, parent, trade_message_type)
  -- Dissect Auction Status Message
  if trade_message_type == "A" then
...
siac_cts_output_cta_v2_10.trade_payload.dissect = function(buffer, offset, packet, parent, trade_message_type)
  ...
  local display = siac_cts_output_cta_v2_10.trade_payload.display(buffer, packet, parent)
...
-- Trade
siac_cts_output_cta_v2_10.trade = {}

-- Read runtime size of: Trade
siac_cts_output_cta_v2_10.trade.size = function(buffer, offset)
  local index = offset
...
-- Display: Trade
siac_cts_output_cta_v2_10.trade.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade
siac_cts_output_cta_v2_10.trade.fields = function(buffer, offset, packet, parent, size_of_trade)
  local index = offset
  ...
  index = siac_cts_output_cta_v2_10.trade_payload.dissect(buffer, index, packet, parent, trade_message_type)
...
siac_cts_output_cta_v2_10.fractional_participant_end_of_day_summary_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_participant_end_of_day_summary_message.fields = function(buffer, offset, packet, parent, size_of_fractional_participant_end_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10.participant_end_of_day_summary_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.participant_end_of_day_summary_message.fields = function(buffer, offset, packet, parent, size_of_participant_end_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_consolidated_end_of_day_summary_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_consolidated_end_of_day_summary_message.fields = function(buffer, offset, packet, parent, size_of_fractional_consolidated_end_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10.consolidated_end_of_day_summary_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.consolidated_end_of_day_summary_message.fields = function(buffer, offset, packet, parent, size_of_consolidated_end_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10.participant_start_of_day_summary_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.participant_start_of_day_summary_message.fields = function(buffer, offset, packet, parent, size_of_participant_start_of_day_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10.consolidated_start_of_day_summary_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.consolidated_start_of_day_summary_message.fields = function(buffer, offset, packet, parent, size_of_consolidated_start_of_day_summary_message)
  local index = offset
...
-- Summary Payload
siac_cts_output_cta_v2_10.summary_payload = {}

-- Size: Summary Payload
siac_cts_output_cta_v2_10.summary_payload.size = function(buffer, offset, summary_message_type)
  -- Size of Consolidated Start Of Day Summary Message
  if summary_message_type == "A" then
    return siac_cts_output_cta_v2_10.consolidated_start_of_day_summary_message.size(buffer, offset)
  end
  -- Size of Participant Start Of Day Summary Message
  if summary_message_type == "B" then
    return siac_cts_output_cta_v2_10.participant_start_of_day_summary_message.size(buffer, offset)
  end
  -- Size of Consolidated End Of Day Summary Message
  if summary_message_type == "C" then
    return siac_cts_output_cta_v2_10.consolidated_end_of_day_summary_message.size(buffer, offset)
  end
  -- Size of Fractional Consolidated End Of Day Summary Message
  if summary_message_type == "T" then
    return siac_cts_output_cta_v2_10.fractional_consolidated_end_of_day_summary_message.size(buffer, offset)
  end
  -- Size of Participant End Of Day Summary Message
  if summary_message_type == "D" then
    return siac_cts_output_cta_v2_10.participant_end_of_day_summary_message.size(buffer, offset)
  end
  -- Size of Fractional Participant End Of Day Summary Message
  if summary_message_type == "P" then
    return siac_cts_output_cta_v2_10.fractional_participant_end_of_day_summary_message.size(buffer, offset)
  end
...
siac_cts_output_cta_v2_10.summary_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Summary Payload
siac_cts_output_cta_v2_10.summary_payload.branches = function(buffer, offset, packet, parent, summary_message_type)
  -- Dissect Consolidated Start Of Day Summary Message
  if summary_message_type == "A" then
...
siac_cts_output_cta_v2_10.summary_payload.dissect = function(buffer, offset, packet, parent, summary_message_type)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_10.summary_payload.display(buffer, packet, parent)
...
-- Summary
siac_cts_output_cta_v2_10.summary = {}

-- Read runtime size of: Summary
siac_cts_output_cta_v2_10.summary.size = function(buffer, offset)
  local index = offset
...
-- Display: Summary
siac_cts_output_cta_v2_10.summary.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Summary
siac_cts_output_cta_v2_10.summary.fields = function(buffer, offset, packet, parent, size_of_summary)
  local index = offset
  ...
  index = siac_cts_output_cta_v2_10.summary_payload.dissect(buffer, index, packet, parent, summary_message_type)
...
siac_cts_output_cta_v2_10.fractional_prior_day_trade_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_prior_day_trade_message.fields = function(buffer, offset, packet, parent, size_of_fractional_prior_day_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10.prior_day_trade_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.prior_day_trade_message.fields = function(buffer, offset, packet, parent, size_of_prior_day_trade_message)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_prior_day_original_trade.dissect = function(buffer, offset, packet, parent)
  if show.fractional_prior_day_original_trade then
    -- Optionally add element to protocol tree
...
siac_cts_output_cta_v2_10.fractional_prior_day_trade_correction_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_prior_day_trade_correction_message.fields = function(buffer, offset, packet, parent, size_of_fractional_prior_day_trade_correction_message)
  local index = offset
...
siac_cts_output_cta_v2_10.prior_day_trade_correction_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.prior_day_trade_correction_message.fields = function(buffer, offset, packet, parent, size_of_prior_day_trade_correction_message)
  local index = offset
...
-- Prior Day Payload
siac_cts_output_cta_v2_10.prior_day_payload = {}

-- Size: Prior Day Payload
siac_cts_output_cta_v2_10.prior_day_payload.size = function(buffer, offset, prior_day_message_type)
  -- Size of Prior Day Trade Correction Message
  if prior_day_message_type == "C" then
    return siac_cts_output_cta_v2_10.prior_day_trade_correction_message.size(buffer, offset)
  end
  -- Size of Fractional Prior Day Trade Correction Message
  if prior_day_message_type == "O" then
    return siac_cts_output_cta_v2_10.fractional_prior_day_trade_correction_message.size(buffer, offset)
  end
  -- Size of Prior Day Trade Message
  if prior_day_message_type == "L" then
    return siac_cts_output_cta_v2_10.prior_day_trade_message.size(buffer, offset)
  end
  -- Size of Fractional Prior Day Trade Message
  if prior_day_message_type == "R" then
    return siac_cts_output_cta_v2_10.fractional_prior_day_trade_message.size(buffer, offset)
  end
  -- Size of Prior Day Trade Message
...
siac_cts_output_cta_v2_10.prior_day_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Prior Day Payload
siac_cts_output_cta_v2_10.prior_day_payload.branches = function(buffer, offset, packet, parent, prior_day_message_type)
  -- Dissect Prior Day Trade Correction Message
  if prior_day_message_type == "C" then
...
siac_cts_output_cta_v2_10.prior_day_payload.dissect = function(buffer, offset, packet, parent, prior_day_message_type)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_10.prior_day_payload.display(buffer, packet, parent)
...
-- Prior Day
siac_cts_output_cta_v2_10.prior_day = {}

-- Read runtime size of: Prior Day
siac_cts_output_cta_v2_10.prior_day.size = function(buffer, offset)
  local index = offset
...
-- Display: Prior Day
siac_cts_output_cta_v2_10.prior_day.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prior Day
siac_cts_output_cta_v2_10.prior_day.fields = function(buffer, offset, packet, parent, size_of_prior_day)
  local index = offset
  ...
  index = siac_cts_output_cta_v2_10.prior_day_payload.dissect(buffer, index, packet, parent, prior_day_message_type)
...
siac_cts_output_cta_v2_10.crossing_session_summary_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.crossing_session_summary_message.fields = function(buffer, offset, packet, parent, size_of_crossing_session_summary_message)
  local index = offset
...
siac_cts_output_cta_v2_10.approximate_trades_and_total_dollar_value_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.approximate_trades_and_total_dollar_value_message.fields = function(buffer, offset, packet, parent, size_of_approximate_trades_and_total_dollar_value_message)
  local index = offset
...
siac_cts_output_cta_v2_10.fractional_approximate_adjusted_volume_market_center_message.fields = function(buffer, offset, packet, parent, size_of_fractional_approximate_adjusted_volume_market_center_message)
  local index = offset
...
siac_cts_output_cta_v2_10.approximate_adjusted_volume_market_center_message.fields = function(buffer, offset, packet, parent, size_of_approximate_adjusted_volume_market_center_message)
  local index = offset
...
siac_cts_output_cta_v2_10.market_wide_circuit_breaker_status_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.market_wide_circuit_breaker_status_message.fields = function(buffer, offset, packet, parent, size_of_market_wide_circuit_breaker_status_message)
  local index = offset
...
siac_cts_output_cta_v2_10.market_wide_circuit_breaker_decline_level_status_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.market_wide_circuit_breaker_decline_level_status_message.fields = function(buffer, offset, packet, parent, size_of_market_wide_circuit_breaker_decline_level_status_message)
  local index = offset
...
siac_cts_output_cta_v2_10.market_status_payload = {}

-- Size: Market Status Payload
siac_cts_output_cta_v2_10.market_status_payload.size = function(buffer, offset, market_status_message_type)
  -- Size of Market Wide Circuit Breaker Decline Level Status Message
  if market_status_message_type == "M" then
    return siac_cts_output_cta_v2_10.market_wide_circuit_breaker_decline_level_status_message.size(buffer, offset)
  end
  -- Size of Market Wide Circuit Breaker Status Message
  if market_status_message_type == "L" then
    return siac_cts_output_cta_v2_10.market_wide_circuit_breaker_status_message.size(buffer, offset)
  end
  -- Size of Approximate Adjusted Volume Market Center Message
  if market_status_message_type == "N" then
    return siac_cts_output_cta_v2_10.approximate_adjusted_volume_market_center_message.size(buffer, offset)
  end
  -- Size of Fractional Approximate Adjusted Volume Market Center Message
  if market_status_message_type == "V" then
    return siac_cts_output_cta_v2_10.fractional_approximate_adjusted_volume_market_center_message.size(buffer, offset)
  end
  -- Size of Approximate Trades And Total Dollar Value Message
  if market_status_message_type == "O" then
    return siac_cts_output_cta_v2_10.approximate_trades_and_total_dollar_value_message.size(buffer, offset)
  end
  -- Size of Crossing Session Summary Message
  if market_status_message_type == "P" then
    return siac_cts_output_cta_v2_10.crossing_session_summary_message.size(buffer, offset)
  end
...
siac_cts_output_cta_v2_10.market_status_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Market Status Payload
siac_cts_output_cta_v2_10.market_status_payload.branches = function(buffer, offset, packet, parent, market_status_message_type)
  -- Dissect Market Wide Circuit Breaker Decline Level Status Message
  if market_status_message_type == "M" then
...
siac_cts_output_cta_v2_10.market_status_payload.dissect = function(buffer, offset, packet, parent, market_status_message_type)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_10.market_status_payload.display(buffer, packet, parent)
...
-- Market Status
siac_cts_output_cta_v2_10.market_status = {}

-- Read runtime size of: Market Status
siac_cts_output_cta_v2_10.market_status.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.market_status.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Market Status
siac_cts_output_cta_v2_10.market_status.fields = function(buffer, offset, packet, parent, size_of_market_status)
  local index = offset
  ...
  index = siac_cts_output_cta_v2_10.market_status_payload.dissect(buffer, index, packet, parent, market_status_message_type)
...
siac_cts_output_cta_v2_10.bid_and_offer_index_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.bid_and_offer_index_message.fields = function(buffer, offset, packet, parent, size_of_bid_and_offer_index_message)
  local index = offset
...
siac_cts_output_cta_v2_10.index_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.index_message.fields = function(buffer, offset, packet, parent, size_of_index_message)
  local index = offset
...
-- Index Payload
siac_cts_output_cta_v2_10.index_payload = {}

-- Size: Index Payload
siac_cts_output_cta_v2_10.index_payload.size = function(buffer, offset, index_message_type)
  -- Size of Index Message
  if index_message_type == "I" then
    return siac_cts_output_cta_v2_10.index_message.size(buffer, offset)
  end
  -- Size of Bid And Offer Index Message
  if index_message_type == "Q" then
    return siac_cts_output_cta_v2_10.bid_and_offer_index_message.size(buffer, offset)
  end
...
siac_cts_output_cta_v2_10.index_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Index Payload
siac_cts_output_cta_v2_10.index_payload.branches = function(buffer, offset, packet, parent, index_message_type)
  -- Dissect Index Message
  if index_message_type == "I" then
...
siac_cts_output_cta_v2_10.index_payload.dissect = function(buffer, offset, packet, parent, index_message_type)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_10.index_payload.display(buffer, packet, parent)
...
siac_cts_output_cta_v2_10.index_message_type.display = function(value)
  if value == "I" then
...
siac_cts_output_cta_v2_10.index_message_type.dissect = function(buffer, offset, packet, parent)
  local length = siac_cts_output_cta_v2_10.index_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = siac_cts_output_cta_v2_10.index_message_type.display(value, buffer, offset, packet, parent)
...
-- Index
siac_cts_output_cta_v2_10.index = {}

-- Read runtime size of: Index
siac_cts_output_cta_v2_10.index.size = function(buffer, offset)
  local index = offset
...
-- Display: Index
siac_cts_output_cta_v2_10.index.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Index
siac_cts_output_cta_v2_10.index.fields = function(buffer, offset, packet, parent, size_of_index)
  local index = offset

  -- Index Message Type: 1 Byte Ascii String Enum with 2 values
  index, index_message_type = siac_cts_output_cta_v2_10.index_message_type.dissect(buffer, index, packet, parent)

  -- Index Payload: Runtime Type with 2 branches
  index = siac_cts_output_cta_v2_10.index_payload.dissect(buffer, index, packet, parent, index_message_type)
...
siac_cts_output_cta_v2_10.end_of_day_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.end_of_day_message.fields = function(buffer, offset, packet, parent, size_of_end_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10.line_integrity_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.line_integrity_message.fields = function(buffer, offset, packet, parent, size_of_line_integrity_message)
  local index = offset
...
siac_cts_output_cta_v2_10.disaster_recovery_data_center_activation_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.disaster_recovery_data_center_activation_message.fields = function(buffer, offset, packet, parent, size_of_disaster_recovery_data_center_activation_message)
  local index = offset
...
siac_cts_output_cta_v2_10.reset_block_sequence_number_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.reset_block_sequence_number_message.fields = function(buffer, offset, packet, parent, size_of_reset_block_sequence_number_message)
  local index = offset
...
siac_cts_output_cta_v2_10.start_of_day_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.start_of_day_message.fields = function(buffer, offset, packet, parent, size_of_start_of_day_message)
  local index = offset
...
-- Control Payload
siac_cts_output_cta_v2_10.control_payload = {}

-- Size: Control Payload
siac_cts_output_cta_v2_10.control_payload.size = function(buffer, offset, control_message_type)
  -- Size of Start Of Day Message
  if control_message_type == "A" then
    return siac_cts_output_cta_v2_10.start_of_day_message.size(buffer, offset)
  end
  -- Size of Reset Block Sequence Number Message
  if control_message_type == "L" then
    return siac_cts_output_cta_v2_10.reset_block_sequence_number_message.size(buffer, offset)
  end
  -- Size of Disaster Recovery Data Center Activation Message
  if control_message_type == "P" then
    return siac_cts_output_cta_v2_10.disaster_recovery_data_center_activation_message.size(buffer, offset)
  end
  -- Size of Line Integrity Message
  if control_message_type == "T" then
    return siac_cts_output_cta_v2_10.line_integrity_message.size(buffer, offset)
  end
  -- Size of End Of Day Message
  if control_message_type == "Z" then
    return siac_cts_output_cta_v2_10.end_of_day_message.size(buffer, offset)
  end
...
siac_cts_output_cta_v2_10.control_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Control Payload
siac_cts_output_cta_v2_10.control_payload.branches = function(buffer, offset, packet, parent, control_message_type)
  -- Dissect Start Of Day Message
  if control_message_type == "A" then
...
siac_cts_output_cta_v2_10.control_payload.dissect = function(buffer, offset, packet, parent, control_message_type)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_10.control_payload.display(buffer, packet, parent)
...
-- Control
siac_cts_output_cta_v2_10.control = {}

-- Read runtime size of: Control
siac_cts_output_cta_v2_10.control.size = function(buffer, offset)
  local index = offset
...
-- Display: Control
siac_cts_output_cta_v2_10.control.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Control
siac_cts_output_cta_v2_10.control.fields = function(buffer, offset, packet, parent, size_of_control)
  local index = offset
  ...
  index = siac_cts_output_cta_v2_10.control_payload.dissect(buffer, index, packet, parent, control_message_type)
...
siac_cts_output_cta_v2_10.end_of_start_of_day_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.end_of_start_of_day_message.fields = function(buffer, offset, packet, parent, size_of_end_of_start_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10.start_of_start_of_day_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.start_of_start_of_day_message.fields = function(buffer, offset, packet, parent, size_of_start_of_start_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10.end_of_end_of_day_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.end_of_end_of_day_message.fields = function(buffer, offset, packet, parent, size_of_end_of_end_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10.start_of_end_of_day_message.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.start_of_end_of_day_message.fields = function(buffer, offset, packet, parent, size_of_start_of_end_of_day_message)
  local index = offset
...
siac_cts_output_cta_v2_10.administrative_payload = {}

-- Size: Administrative Payload
siac_cts_output_cta_v2_10.administrative_payload.size = function(buffer, offset, administrative_message_type)
  -- Size of Start Of End Of Day Message
  if administrative_message_type == "A" then
    return siac_cts_output_cta_v2_10.start_of_end_of_day_message.size(buffer, offset)
  end
  -- Size of End Of End Of Day Message
  if administrative_message_type == "B" then
    return siac_cts_output_cta_v2_10.end_of_end_of_day_message.size(buffer, offset)
  end
  -- Size of Start Of Start Of Day Message
  if administrative_message_type == "C" then
    return siac_cts_output_cta_v2_10.start_of_start_of_day_message.size(buffer, offset)
  end
  -- Size of End Of Start Of Day Message
  if administrative_message_type == "D" then
    return siac_cts_output_cta_v2_10.end_of_start_of_day_message.size(buffer, offset)
  end
...
siac_cts_output_cta_v2_10.administrative_payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Administrative Payload
siac_cts_output_cta_v2_10.administrative_payload.branches = function(buffer, offset, packet, parent, administrative_message_type)
  -- Dissect Start Of End Of Day Message
  if administrative_message_type == "A" then
...
siac_cts_output_cta_v2_10.administrative_payload.dissect = function(buffer, offset, packet, parent, administrative_message_type)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_10.administrative_payload.display(buffer, packet, parent)
...
-- Administrative
siac_cts_output_cta_v2_10.administrative = {}

-- Read runtime size of: Administrative
siac_cts_output_cta_v2_10.administrative.size = function(buffer, offset)
  local index = offset
...
siac_cts_output_cta_v2_10.administrative.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Administrative
siac_cts_output_cta_v2_10.administrative.fields = function(buffer, offset, packet, parent, size_of_administrative)
  local index = offset
  ...
  index = siac_cts_output_cta_v2_10.administrative_payload.dissect(buffer, index, packet, parent, administrative_message_type)
...
-- Payload
siac_cts_output_cta_v2_10.payload = {}

-- Size: Payload
siac_cts_output_cta_v2_10.payload.size = function(buffer, offset, message_category)
  -- Size of Administrative
  if message_category == "A" then
    return siac_cts_output_cta_v2_10.administrative.size(buffer, offset)
  end
  -- Size of Control
  if message_category == "C" then
    return siac_cts_output_cta_v2_10.control.size(buffer, offset)
  end
  -- Size of Index
  if message_category == "I" then
    return siac_cts_output_cta_v2_10.index.size(buffer, offset)
  end
  -- Size of Market Status
  if message_category == "M" then
    return siac_cts_output_cta_v2_10.market_status.size(buffer, offset)
  end
  -- Size of Prior Day
  if message_category == "P" then
    return siac_cts_output_cta_v2_10.prior_day.size(buffer, offset)
  end
  -- Size of Summary
  if message_category == "S" then
    return siac_cts_output_cta_v2_10.summary.size(buffer, offset)
  end
  -- Size of Trade
  if message_category == "T" then
    return siac_cts_output_cta_v2_10.trade.size(buffer, offset)
  end
...
-- Display: Payload
siac_cts_output_cta_v2_10.payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
siac_cts_output_cta_v2_10.payload.branches = function(buffer, offset, packet, parent, message_category)
  -- Dissect Administrative
  if message_category == "A" then
    return siac_cts_output_cta_v2_10.administrative.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Control
  if message_category == "C" then
    return siac_cts_output_cta_v2_10.control.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Index
  if message_category == "I" then
    return siac_cts_output_cta_v2_10.index.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Market Status
  if message_category == "M" then
    return siac_cts_output_cta_v2_10.market_status.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Prior Day
  if message_category == "P" then
    return siac_cts_output_cta_v2_10.prior_day.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Summary
  if message_category == "S" then
    return siac_cts_output_cta_v2_10.summary.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade
  if message_category == "T" then
    return siac_cts_output_cta_v2_10.trade.dissect(buffer, offset, packet, parent)
  end
...
siac_cts_output_cta_v2_10.payload.dissect = function(buffer, offset, packet, parent, message_category)
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = siac_cts_output_cta_v2_10.payload.display(buffer, packet, parent)
...
siac_cts_output_cta_v2_10.message_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
siac_cts_output_cta_v2_10.message_header.dissect = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_siac_cts_output_cta_v2_10.fields.message_header, buffer(offset, 0))
    local index = siac_cts_output_cta_v2_10.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = siac_cts_output_cta_v2_10.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return siac_cts_output_cta_v2_10.message_header.fields(buffer, offset, packet, parent)
  end
end
...
siac_cts_output_cta_v2_10.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset
  ...
  index, message_header = siac_cts_output_cta_v2_10.message_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Message Category
  local message_category = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 7 branches
  index = siac_cts_output_cta_v2_10.payload.dissect(buffer, index, packet, parent, message_category)

  return index
end

-- Dissect: Message
siac_cts_output_cta_v2_10.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_siac_cts_output_cta_v2_10.fields.message, buffer(offset, 0))
    local current = siac_cts_output_cta_v2_10.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    parent:set_len(size_of_message)
    local display = siac_cts_output_cta_v2_10.message.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    siac_cts_output_cta_v2_10.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
