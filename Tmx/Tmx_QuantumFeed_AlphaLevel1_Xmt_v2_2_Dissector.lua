...
tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.equity_quote_body = ProtoField.new("Equity Quote Body", "tmx.quantumfeed.alphalevel1.xmt.v2.2.equityquotebody", ftypes.STRING)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.stock_status_body = ProtoField.new("Stock Status Body", "tmx.quantumfeed.alphalevel1.xmt.v2.2.stockstatusbody", ftypes.STRING)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.symbol_status_body = ProtoField.new("Symbol Status Body", "tmx.quantumfeed.alphalevel1.xmt.v2.2.symbolstatusbody", ftypes.STRING)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.trade_body = ProtoField.new("Trade Body", "tmx.quantumfeed.alphalevel1.xmt.v2.2.tradebody", ftypes.STRING)
tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.trade_cancelled_body = ProtoField.new("Trade Cancelled Body", "tmx.quantumfeed.alphalevel1.xmt.v2.2.tradecancelledbody", ftypes.STRING)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_equity_quote_body = Pref.bool("Show Equity Quote Body", show.equity_quote_body, "Parse and add Equity Quote Body to protocol tree")
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_stock_status_body = Pref.bool("Show Stock Status Body", show.stock_status_body, "Parse and add Stock Status Body to protocol tree")
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_symbol_status_body = Pref.bool("Show Symbol Status Body", show.symbol_status_body, "Parse and add Symbol Status Body to protocol tree")
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_trade_body = Pref.bool("Show Trade Body", show.trade_body, "Parse and add Trade Body to protocol tree")
tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_trade_cancelled_body = Pref.bool("Show Trade Cancelled Body", show.trade_cancelled_body, "Parse and add Trade Cancelled Body to protocol tree")
...
function tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs_changed()
  ...
  if show.equity_quote_body ~= tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_equity_quote_body then
    show.equity_quote_body = tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_equity_quote_body
    changed = true
  end
  ...
  if show.stock_status_body ~= tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_stock_status_body then
    show.stock_status_body = tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_stock_status_body
    changed = true
  end
  ...
  if show.symbol_status_body ~= tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_symbol_status_body then
    show.symbol_status_body = tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_symbol_status_body
    changed = true
  end
  ...
  if show.trade_body ~= tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_trade_body then
    show.trade_body = tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_trade_body
    changed = true
  end
  if show.trade_cancelled_body ~= tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_trade_cancelled_body then
    show.trade_cancelled_body = tmx_quantumfeed_alphalevel1_xmt_v2_2.prefs.show_trade_cancelled_body
    changed = true
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.equity_quote_body = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.equity_quote_body = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Equity Quote Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.equity_quote_body_fields = function(buffer, offset, packet, parent)
  local index = offset
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.equity_quote_body = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.equity_quote_body then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.equity_quote_body(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.equity_quote_body(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.equity_quote_body, range, display)
  end

  return tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.equity_quote_body_fields(buffer, offset, packet, parent)
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.business_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.business_header = function(buffer, offset, packet, parent)
  ...
  if show.business_header then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.business_header(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.business_header(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.business_header, range, display)
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.equity_quote_message = function(buffer, offset)
  ...
  index = index + tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.business_header(buffer, offset + index)

  index = index + tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.equity_quote_body(buffer, offset + index)

  return index
end

-- Display: Equity Quote Message
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.equity_quote_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.equity_quote_message_fields = function(buffer, offset, packet, parent)
  ...
  -- Equity Quote Body: Struct of 6 fields
  index, equity_quote_body = tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.equity_quote_body(buffer, index, packet, parent)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.equity_quote_message = function(buffer, offset, packet, parent)
  ...
  if show.equity_quote_message then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.equity_quote_message(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.equity_quote_message(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.equity_quote_message, range, display)
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.stock_status_body = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.stock_status_body = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Stock Status Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.stock_status_body_fields = function(buffer, offset, packet, parent)
  local index = offset
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.stock_status_body = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.stock_status_body then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.stock_status_body(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.stock_status_body(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.stock_status_body, range, display)
  end

  return tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.stock_status_body_fields(buffer, offset, packet, parent)
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.stock_status_message = function(buffer, offset)
  ...
  index = index + tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.stock_status_body(buffer, offset + index)

  return index
end

-- Display: Stock Status Message
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.stock_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.stock_status_message_fields = function(buffer, offset, packet, parent)
  ...
  index, stock_status_body = tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.stock_status_body(buffer, index, packet, parent)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.stock_status_message = function(buffer, offset, packet, parent)
  ...
  if show.stock_status_message then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.stock_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.stock_status_message(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.stock_status_message, range, display)
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_cancelled_body = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_cancelled_body = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Trade Cancelled Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_cancelled_body_fields = function(buffer, offset, packet, parent)
  local index = offset
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_cancelled_body = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.trade_cancelled_body then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_cancelled_body(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_cancelled_body(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.trade_cancelled_body, range, display)
  end

  return tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_cancelled_body_fields(buffer, offset, packet, parent)
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_cancelled_message = function(buffer, offset)
  ...
  index = index + tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_cancelled_body(buffer, offset + index)

  return index
end

-- Display: Trade Cancelled Message
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_cancelled_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_cancelled_message_fields = function(buffer, offset, packet, parent)
  ...
  -- Trade Cancelled Body: Struct of 9 fields
  index, trade_cancelled_body = tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_cancelled_body(buffer, index, packet, parent)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_cancelled_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_cancelled_message then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_cancelled_message(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_cancelled_message(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.trade_cancelled_message, range, display)
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_body = function(buffer, offset)
  local index = 0
...
-- Display: Trade Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_body = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Trade Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_body_fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Trade Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_body = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.trade_body then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_body(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_body(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.trade_body, range, display)
  end

  return tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_body_fields(buffer, offset, packet, parent)
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_message = function(buffer, offset)
  ...
  index = index + tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_body(buffer, offset + index)

  return index
end

-- Display: Trade Message
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_message_fields = function(buffer, offset, packet, parent)
  ...
  -- Trade Body: Struct of 14 fields
  index, trade_body = tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_body(buffer, index, packet, parent)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.trade_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_message then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.trade_message(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.trade_message(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.trade_message, range, display)
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.symbol_status_body = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.symbol_status_body = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Symbol Status Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.symbol_status_body_fields = function(buffer, offset, packet, parent)
  local index = offset
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.symbol_status_body = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.symbol_status_body then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.symbol_status_body(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.symbol_status_body(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.symbol_status_body, range, display)
  end

  return tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.symbol_status_body_fields(buffer, offset, packet, parent)
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.symbol_status_message = function(buffer, offset)
  ...
  index = index + tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.symbol_status_body(buffer, offset + index)

  return index
end

-- Display: Symbol Status Message
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.symbol_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.symbol_status_message_fields = function(buffer, offset, packet, parent)
  ...
  index, symbol_status_body = tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.symbol_status_body(buffer, index, packet, parent)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.symbol_status_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_status_message then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.symbol_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.symbol_status_message(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.symbol_status_message, range, display)
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.body_message = function(buffer, offset, msg_type)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.body_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Body Message
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body_message_branches = function(buffer, offset, packet, parent, msg_type)
  -- Dissect Symbol Status Message
  if msg_type == "J" then
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body_message = function(buffer, offset, packet, parent, msg_type)
  if not show.body_message then
    return tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body_message_branches(buffer, offset, packet, parent, msg_type)
  end

  -- Calculate size and check that branch is not empty
  local size = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.body_message(buffer, offset, msg_type)
  if size == 0 then
    return offset
  end
  ...
  local element = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.body_message, range, display)
...
-- Display: Body Header
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.body_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body_header = function(buffer, offset, packet, parent)
  ...
  if show.body_header then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.body_header(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.body_header(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.body_header, range, display)
  end
...
-- Display: Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.body = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body_fields = function(buffer, offset, packet, parent, size_of_body)
  local index = offset
  ...
  index = tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body_message(buffer, index, packet, parent, msg_type)

  return index
end

-- Dissect: Body
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body = function(buffer, offset, packet, parent, size_of_body)
  -- Optionally add struct element to protocol tree
  if show.body then
    ...
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.body, range, display)
  end

  tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body_fields(buffer, offset, packet, parent, size_of_body)
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_display.frame_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.frame_header = function(buffer, offset, packet, parent)
  ...
  if show.frame_header then
    local length = tmx_quantumfeed_alphalevel1_xmt_v2_2_size_of.frame_header(buffer, offset)
    local range = buffer(offset, length)
    local display = tmx_quantumfeed_alphalevel1_xmt_v2_2_display.frame_header(buffer, packet, parent)
    parent = parent:add(tmx_quantumfeed_alphalevel1_xmt_v2_2.fields.frame_header, range, display)
  end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index = tmx_quantumfeed_alphalevel1_xmt_v2_2_dissect.body(buffer, index, packet, parent, msg_length)
  end
