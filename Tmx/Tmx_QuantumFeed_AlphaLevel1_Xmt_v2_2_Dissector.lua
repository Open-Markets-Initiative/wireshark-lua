...
local omi_tmx_quantumfeed_alphalevel1_xmt_v2_2 = Proto("Omi.Tmx.QuantumFeed.AlphaLevel1.Xmt.v2.2", "Tmx QuantumFeed AlphaLevel1 Xmt 2.2")
...
-- Tmx QuantumFeed AlphaLevel1 Xmt 2.2 Headers
...
-- Tmx QuantumFeed AlphaLevel1 2.2 Application Messages
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.packet.requiredsize = function(buffer)
  return buffer:len() >= tmx_quantumfeed_alphalevel1_xmt_v2_2.frame_header.size
end
...
tmx_quantumfeed_alphalevel1_xmt_v2_2.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    for body_index = 1, num_body do
      ...
      index, body = tmx_quantumfeed_alphalevel1_xmt_v2_2.body.dissect(buffer, index, packet, parent, msg_length, body_index)
    end
  end
...
omi_tmx_quantumfeed_alphalevel1_xmt_v2_2:register_heuristic("udp", omi_tmx_quantumfeed_alphalevel1_xmt_v2_2_udp_heuristic)

-- Register Tmx QuantumFeed AlphaLevel1 Xmt 2.2 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_tmx_quantumfeed_alphalevel1_xmt_v2_2)
