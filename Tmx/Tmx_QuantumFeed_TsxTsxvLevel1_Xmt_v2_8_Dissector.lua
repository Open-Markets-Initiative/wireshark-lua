...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.body_index = ProtoField.new("Body Index", "tmx.quantumfeed.tsxtsxvlevel1.xmt.v2.8.bodyindex", ftypes.UINT16)
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.quote_message = function(buffer, offset, packet, parent)
  if show.quote_message then
    ...
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.quote_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.quote_message_fields(buffer, offset, packet, element)
    ...
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.quote_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.stock_status_message = function(buffer, offset, packet, parent)
  if show.stock_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.stock_status_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.stock_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.stock_status_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.moc_imbalance_message = function(buffer, offset, packet, parent)
  if show.moc_imbalance_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.moc_imbalance_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.moc_imbalance_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.moc_imbalance_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.trade_cancelled_message = function(buffer, offset, packet, parent)
  if show.trade_cancelled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.trade_cancelled_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.trade_cancelled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.trade_cancelled_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.trade_report_message = function(buffer, offset, packet, parent)
  if show.trade_report_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.trade_report_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.trade_report_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.trade_report_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.symbol_status_message = function(buffer, offset, packet, parent)
  if show.symbol_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.symbol_status_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.symbol_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.symbol_status_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.business_header = function(buffer, offset, packet, parent)
  if show.business_header then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.business_header, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.business_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.business_header_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.body_message = function(buffer, offset, packet, parent, size_of_body_message)
  ...
  if show.body_message then
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.body_message, buffer(offset, 0))
    local current = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.body_message_fields(buffer, offset, packet, element, size_of_body_message)
    element:set_len(size_of_body_message)
    local display = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_display.body_message(buffer, packet, element)
    element:append_text(display)
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.body_header = function(buffer, offset, packet, parent)
  if show.body_header then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.body_header, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.body_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.body_header_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.body = function(buffer, offset, packet, parent, size_of_body)
  ...
  -- Optionally add group/struct element to protocol tree
  if show.body then
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.body, buffer(offset, 0))
    local current = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.body_fields(buffer, offset, packet, element, size_of_body)
    element:set_len(size_of_body)
    local display = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_display.body(buffer, packet, element)
    element:append_text(display)
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.frame_header = function(buffer, offset, packet, parent)
  if show.frame_header then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.frame_header, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.frame_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.frame_header_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    for body_index = 1, num_body do
      ...
      if body ~= nil then
        local iteration = body:add(tmx_quantumfeed_tsxtsxvlevel1_xmt_v2_8.fields.body_index, body_index)
