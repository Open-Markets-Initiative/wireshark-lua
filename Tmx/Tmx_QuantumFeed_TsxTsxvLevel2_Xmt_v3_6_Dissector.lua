...
-- Tmx QuantumFeed TsxTsxvLevel2 Xmt 3.6 messages
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.body_index = ProtoField.new("Body Index", "tmx.quantumfeed.tsxtsxvlevel2.xmt.v3.6.bodyindex", ftypes.UINT16)
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.cop_limit_index = ProtoField.new("Cop Limit Index", "tmx.quantumfeed.tsxtsxvlevel2.xmt.v3.6.coplimitindex", ftypes.UINT16)
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.cop_order_index = ProtoField.new("Cop Order Index", "tmx.quantumfeed.tsxtsxvlevel2.xmt.v3.6.coporderindex", ftypes.UINT16)
...
function tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.prefs_changed()
  ...
  if show.cop_order ~= tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.prefs.show_cop_order then
    show.cop_order = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.prefs.show_cop_order
    changed = true
  end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_correction_terms_message = function(buffer, offset, packet, parent)
  if show.trade_correction_terms_message then
    ...
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.trade_correction_terms_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_correction_terms_message_fields(buffer, offset, packet, element)
    ...
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_correction_terms_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_correction_message = function(buffer, offset, packet, parent)
  if show.trade_correction_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.trade_correction_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_correction_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_correction_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_cancelled_terms_message = function(buffer, offset, packet, parent)
  if show.trade_cancelled_terms_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.trade_cancelled_terms_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_cancelled_terms_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_cancelled_terms_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_cancelled_message = function(buffer, offset, packet, parent)
  if show.trade_cancelled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.trade_cancelled_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_cancelled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_cancelled_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_report_terms_message = function(buffer, offset, packet, parent)
  if show.trade_report_terms_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.trade_report_terms_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_report_terms_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_report_terms_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_report_message = function(buffer, offset, packet, parent)
  if show.trade_report_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.trade_report_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_report_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.trade_report_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.stock_status_message = function(buffer, offset, packet, parent)
  if show.stock_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.stock_status_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.stock_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.stock_status_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_price_time_assigned_terms_message = function(buffer, offset, packet, parent)
  if show.order_price_time_assigned_terms_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_price_time_assigned_terms_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_price_time_assigned_terms_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_price_time_assigned_terms_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_price_time_assigned_message = function(buffer, offset, packet, parent)
  if show.order_price_time_assigned_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_price_time_assigned_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_price_time_assigned_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_price_time_assigned_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_cancelled_terms_message = function(buffer, offset, packet, parent)
  if show.order_cancelled_terms_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_cancelled_terms_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_cancelled_terms_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_cancelled_terms_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_cancelled_message = function(buffer, offset, packet, parent)
  if show.order_cancelled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_cancelled_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_cancelled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_cancelled_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_booked_terms_message = function(buffer, offset, packet, parent)
  if show.order_booked_terms_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_booked_terms_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_booked_terms_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_booked_terms_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_booked_message = function(buffer, offset, packet, parent)
  if show.order_booked_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_booked_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_booked_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_booked_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.moc_imbalance_message = function(buffer, offset, packet, parent)
  if show.moc_imbalance_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.moc_imbalance_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.moc_imbalance_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.moc_imbalance_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.market_state_update_message = function(buffer, offset, packet, parent)
  if show.market_state_update_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.market_state_update_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.market_state_update_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.market_state_update_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_limit = function(buffer, offset, packet, parent)
  if show.cop_limit then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.cop_limit, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_limit_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_limit_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_limit_message = function(buffer, offset, packet, parent)
  if show.assign_limit_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.assign_limit_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_limit_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_limit_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_cop_no_orders_message = function(buffer, offset, packet, parent)
  if show.assign_cop_no_orders_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.assign_cop_no_orders_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_cop_no_orders_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_cop_no_orders_message_fields(buffer, offset, packet, element)
  end
end
...
-- Dissect: Cop Order
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_order = function(buffer, offset, packet, parent)
  if show.cop_order then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.cop_order, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_order_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_order_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_cop_orders_message = function(buffer, offset, packet, parent)
  if show.assign_cop_orders_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.assign_cop_orders_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_cop_orders_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_cop_orders_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_book_terms_message = function(buffer, offset, packet, parent)
  if show.order_book_terms_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_book_terms_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_book_terms_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_book_terms_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_book_message = function(buffer, offset, packet, parent)
  if show.order_book_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.order_book_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_book_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.order_book_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.symbol_status_message = function(buffer, offset, packet, parent)
  if show.symbol_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.symbol_status_message, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.symbol_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.symbol_status_message_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.business_header = function(buffer, offset, packet, parent)
  if show.business_header then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.business_header, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.business_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.business_header_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.body_header = function(buffer, offset, packet, parent)
  if show.body_header then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.body_header, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.body_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.body_header_fields(buffer, offset, packet, element)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.frame_header = function(buffer, offset, packet, parent)
  if show.frame_header then
    -- Optionally add element to protocol tree
    local element = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.frame_header, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.frame_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.frame_header_fields(buffer, offset, packet, element)
  end
end
