...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_order = function(buffer, offset, packet, parent)
  if show.cop_order then
    -- Optionally add element to protocol tree
    parent = parent:add(tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6.fields.cop_order, buffer(offset, 0))
    local index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_order_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_order_fields(buffer, offset, packet, parent)
  end
end
...
tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.assign_cop_orders_message_fields = function(buffer, offset, packet, parent)
  ...
  -- Array Count Of: Cop Order
  for i = 1, 15 do
    index = tmx_quantumfeed_tsxtsxvlevel2_xmt_v3_6_dissect.cop_order(buffer, index, packet, parent)
  end
