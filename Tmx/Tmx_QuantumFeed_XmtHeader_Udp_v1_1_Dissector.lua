...
function omi_tmx_quantumfeed_xmtheader_udp_v1_1.prefs_changed()
  ...
  if show.indexes ~= omi_tmx_quantumfeed_xmtheader_udp_v1_1.prefs.show_indexes then
    show.indexes = omi_tmx_quantumfeed_xmtheader_udp_v1_1.prefs.show_indexes
  end
end
...
tmx_quantumfeed_xmtheader_udp_v1_1.packet.requiredsize = function(buffer)
  return buffer:len() >= tmx_quantumfeed_xmtheader_udp_v1_1.frame_header.size
end
...
-- Dissector Heuristic for Tmx QuantumFeed XmtHeader Udp 1.1 (Udp)
local function omi_tmx_quantumfeed_xmtheader_udp_v1_1_udp_heuristic(buffer, packet, parent)
...
omi_tmx_quantumfeed_xmtheader_udp_v1_1:register_heuristic("udp", omi_tmx_quantumfeed_xmtheader_udp_v1_1_udp_heuristic)

-- Register Tmx QuantumFeed XmtHeader Udp 1.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_tmx_quantumfeed_xmtheader_udp_v1_1)
