...
tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_correction_terms_message.size = function(buffer, offset)
  local index = 0

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.symbol.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_number.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.price.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.volume.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.buy_broker_number.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.sell_broker_number.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.initiated_by.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.orig_trade_number.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_time_stamp.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.settlement_terms.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.settlement_date.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.cross_type.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.trading_system_time_stamp.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_correction_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.bypass.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_time_stamp.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.cross_type.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.is_dark.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_cancelled_terms_message.size = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_cancelled_message.size = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_report_terms_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.buy_order_id.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.buy_display_volume.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.sell_broker_number.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.sell_order_id.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.sell_display_volume.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_report_message.size = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.stock_status_message.size = function(buffer, offset)
  local index = 0

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.symbol.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.comment.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.stock_state.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.order_price_time_assigned_message.size = function(buffer, offset)
  local index = 0

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.symbol.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.broker_number.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.order_side.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.order_id.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.price.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.volume.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.priority_time_stamp.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.order_cancelled_message.size = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.order_booked_message.size = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.market_state_update_message.size = function(buffer, offset)
  local index = 0

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.market_state.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.stock_group.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.order_book_message.size = function(buffer, offset)
  local index = 0
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.symbol_status_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.listing_market.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.product_type.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.cusip.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.board_lot.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.currency.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.face_value.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.last_sale.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.min_po_qty.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.stock_state.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.test_symbol.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.business_message.size = function(buffer, offset, msg_type)
  ...
  if msg_type == "J" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.symbol_status_message.size(buffer, offset)
  end
  -- Size of Order Book Message
  if msg_type == "G" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.order_book_message.size(buffer, offset)
  end
  -- Size of Market State Update Message
  if msg_type == "E" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.market_state_update_message.size(buffer, offset)
  end
  -- Size of Order Booked Message
  if msg_type == "P" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.order_booked_message.size(buffer, offset)
  end
  -- Size of Order Cancelled Message
  if msg_type == "Q" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.order_cancelled_message.size(buffer, offset)
  end
  -- Size of Order Price Time Assigned Message
  if msg_type == "R" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.order_price_time_assigned_message.size(buffer, offset)
  end
  -- Size of Stock Status Message
  if msg_type == "I" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.stock_status_message.size(buffer, offset)
  end
  -- Size of Trade Report Message
  if msg_type == "S" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_report_message.size(buffer, offset)
  end
  -- Size of Trade Report Terms Message
  if msg_type == "P" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_report_terms_message.size(buffer, offset)
  end
  -- Size of Trade Cancelled Message
  if msg_type == "T" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_cancelled_message.size(buffer, offset)
  end
  -- Size of Trade Cancelled Terms Message
  if msg_type == "q" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_cancelled_terms_message.size(buffer, offset)
  end
  -- Size of Trade Correction Message
  if msg_type == "U" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_correction_message.size(buffer, offset)
  end
  -- Size of Trade Correction Terms Message
  if msg_type == "r" then
    return tmx_quantumfeed_alphalevel2_xmt_v2_1.trade_correction_terms_message.size(buffer, offset)
  end
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.business_header.size = function(buffer, offset)
  local index = 0

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.msg_version.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.source_id.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.stream_id.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.sequence_0.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.sequence_1.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.body_header.size = function(buffer, offset)
  local index = 0

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.msg_length.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.msg_type.size
...
tmx_quantumfeed_alphalevel2_xmt_v2_1.frame_header.size = function(buffer, offset)
  local index = 0

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.start_of_frame.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.protocol_name.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.protocol_version.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.message_length.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.session_id.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.ack_required_poss_dup.size

  index = index + tmx_quantumfeed_alphalevel2_xmt_v2_1.num_body.size
