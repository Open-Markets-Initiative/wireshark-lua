...
-- Tmx QuantumFeed Xmt AlphaLevel2 2.1 Application Messages
...
omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_body_index = Pref.bool("Show Body Index", show.body_index, "Show generated body index in protocol tree")
...
function omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs_changed()
  ...
  if show.body_index ~= omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_body_index then
    show.body_index = omi_tmx_quantumfeed_alphalevel2_xmt_v2_1.prefs.show_body_index
  end
end
...
-- Register Tmx QuantumFeed AlphaLevel2 Xmt 2.1 on default port
