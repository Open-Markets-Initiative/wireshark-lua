...
-- Cme sbe v50 Protocol
local cme_sbe_v50 = Proto("cme.sbe.v50.lua", "Cme sbe v50 Protocol")
...
-- Cme sbe v50 Protocol Element Dissection Options
...
-- Cme sbe v50 Protocol Fields
cme_sbe_v50.fields.actual = ProtoField.new("Actual", "cme.sbe.v50.actual", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x02")
cme_sbe_v50.fields.admin_login = ProtoField.new("Admin Login", "cme.sbe.v50.adminlogin", ftypes.STRING)
cme_sbe_v50.fields.admin_logout = ProtoField.new("Admin Logout", "cme.sbe.v50.adminlogout", ftypes.STRING)
cme_sbe_v50.fields.aggressor_side = ProtoField.new("Aggressor Side", "cme.sbe.v50.aggressorside", ftypes.UINT8)
cme_sbe_v50.fields.appl_id = ProtoField.new("Appl ID", "cme.sbe.v50.applid", ftypes.INT16)
cme_sbe_v50.fields.asset = ProtoField.new("Asset", "cme.sbe.v50.asset", ftypes.STRING)
cme_sbe_v50.fields.block_length = ProtoField.new("Block Length", "cme.sbe.v50.blocklength", ftypes.UINT16)
cme_sbe_v50.fields.block_trade_eligible = ProtoField.new("Block Trade Eligible", "cme.sbe.v50.blocktradeeligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000004")
cme_sbe_v50.fields.cfi_code = ProtoField.new("CFI Code", "cme.sbe.v50.cficode", ftypes.STRING)
cme_sbe_v50.fields.channel_reset = ProtoField.new("Channel Reset", "cme.sbe.v50.channelreset", ftypes.STRING)
cme_sbe_v50.fields.channel_reset_group = ProtoField.new("Channel Reset Group", "cme.sbe.v50.channelresetgroup", ftypes.STRING)
cme_sbe_v50.fields.channel_reset_groups = ProtoField.new("Channel Reset Groups", "cme.sbe.v50.channelresetgroups", ftypes.STRING)
cme_sbe_v50.fields.cleared_volume = ProtoField.new("Cleared Volume", "cme.sbe.v50.clearedvolume", ftypes.INT32)
cme_sbe_v50.fields.contract_multiplier = ProtoField.new("Contract Multiplier", "cme.sbe.v50.contractmultiplier", ftypes.INT32)
cme_sbe_v50.fields.contract_multiplier_unit = ProtoField.new("Contract Multiplier Unit", "cme.sbe.v50.contractmultiplierunit", ftypes.INT8)
cme_sbe_v50.fields.currency = ProtoField.new("Currency", "cme.sbe.v50.currency", ftypes.STRING)
cme_sbe_v50.fields.daily_product_eligibility = ProtoField.new("Daily Product Eligibility", "cme.sbe.v50.dailyproducteligibility", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00020000")
cme_sbe_v50.fields.day = ProtoField.new("day", "cme.sbe.v50.day", ftypes.UINT8)
cme_sbe_v50.fields.decay_quantity = ProtoField.new("Decay Quantity", "cme.sbe.v50.decayquantity", ftypes.INT32)
cme_sbe_v50.fields.decay_start_date = ProtoField.new("Decay Start Date", "cme.sbe.v50.decaystartdate", ftypes.UINT16)
cme_sbe_v50.fields.decaying_product_eligibility = ProtoField.new("Decaying Product Eligibility", "cme.sbe.v50.decayingproducteligibility", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00008000")
cme_sbe_v50.fields.display_factor = ProtoField.new("Display Factor", "cme.sbe.v50.displayfactor", ftypes.INT64)
cme_sbe_v50.fields.ebf_eligible = ProtoField.new("EBF Eligible", "cme.sbe.v50.ebfeligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000010")
cme_sbe_v50.fields.efp_eligible = ProtoField.new("EFP Eligible", "cme.sbe.v50.efpeligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000008")
cme_sbe_v50.fields.efr_eligible = ProtoField.new("EFR Eligible", "cme.sbe.v50.efreligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000040")
cme_sbe_v50.fields.efs_eligible = ProtoField.new("EFS Eligible", "cme.sbe.v50.efseligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000020")
cme_sbe_v50.fields.electronic_match_eligible = ProtoField.new("Electronic Match Eligible", "cme.sbe.v50.electronicmatcheligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000001")
cme_sbe_v50.fields.end_of_event = ProtoField.new("End Of Event", "cme.sbe.v50.endofevent", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x80")
cme_sbe_v50.fields.event_time = ProtoField.new("Event Time", "cme.sbe.v50.eventtime", ftypes.UINT64)
cme_sbe_v50.fields.event_type = ProtoField.new("Event Type", "cme.sbe.v50.eventtype", ftypes.UINT8)
cme_sbe_v50.fields.events_group = ProtoField.new("Events Group", "cme.sbe.v50.eventsgroup", ftypes.STRING)
cme_sbe_v50.fields.events_groups = ProtoField.new("Events Groups", "cme.sbe.v50.eventsgroups", ftypes.STRING)
cme_sbe_v50.fields.final = ProtoField.new("Final", "cme.sbe.v50.final", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x01")
cme_sbe_v50.fields.flow_schedule_type = ProtoField.new("Flow Schedule Type", "cme.sbe.v50.flowscheduletype", ftypes.INT8)
cme_sbe_v50.fields.group_size = ProtoField.new("group Size", "cme.sbe.v50.groupsize", ftypes.STRING)
cme_sbe_v50.fields.group_size8_byte = ProtoField.new("group Size8 Byte", "cme.sbe.v50.groupsize8byte", ftypes.STRING)
cme_sbe_v50.fields.gt_orders_eligibility = ProtoField.new("GT Orders Eligibility", "cme.sbe.v50.gtorderseligibility", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00040000")
cme_sbe_v50.fields.halt_reason = ProtoField.new("Halt Reason", "cme.sbe.v50.haltreason", ftypes.UINT8)
cme_sbe_v50.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "cme.sbe.v50.heartbtint", ftypes.INT8)
cme_sbe_v50.fields.high_limit_price = ProtoField.new("High Limit Price", "cme.sbe.v50.highlimitprice", ftypes.INT64)
cme_sbe_v50.fields.i_link_indicative_mass_quoting_eligible = ProtoField.new("i Link Indicative Mass Quoting Eligible", "cme.sbe.v50.ilinkindicativemassquotingeligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000100")
cme_sbe_v50.fields.implied_matching_eligibility = ProtoField.new("Implied Matching Eligibility", "cme.sbe.v50.impliedmatchingeligibility", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00080000")
cme_sbe_v50.fields.inst_attrib_group = ProtoField.new("Inst Attrib Group", "cme.sbe.v50.instattribgroup", ftypes.STRING)
cme_sbe_v50.fields.inst_attrib_groups = ProtoField.new("Inst Attrib Groups", "cme.sbe.v50.instattribgroups", ftypes.STRING)
cme_sbe_v50.fields.inst_attrib_value = ProtoField.new("Inst Attrib Value", "cme.sbe.v50.instattribvalue", ftypes.STRING)
cme_sbe_v50.fields.intraday = ProtoField.new("Intraday", "cme.sbe.v50.intraday", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x08")
cme_sbe_v50.fields.is_fractional = ProtoField.new("Is Fractional", "cme.sbe.v50.isfractional", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000800")
cme_sbe_v50.fields.last_implied_msg = ProtoField.new("Last Implied Msg", "cme.sbe.v50.lastimpliedmsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x10")
cme_sbe_v50.fields.last_msg_seq_num_processed = ProtoField.new("Last Msg Seq Num Processed", "cme.sbe.v50.lastmsgseqnumprocessed", ftypes.UINT32)
cme_sbe_v50.fields.last_qty = ProtoField.new("Last Qty", "cme.sbe.v50.lastqty", ftypes.INT32)
cme_sbe_v50.fields.last_quote_msg = ProtoField.new("Last Quote Msg", "cme.sbe.v50.lastquotemsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x04")
cme_sbe_v50.fields.last_stats_msg = ProtoField.new("Last Stats Msg", "cme.sbe.v50.laststatsmsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x08")
cme_sbe_v50.fields.last_trade_msg = ProtoField.new("Last Trade Msg", "cme.sbe.v50.lasttrademsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x01")
cme_sbe_v50.fields.last_update_time = ProtoField.new("Last Update Time", "cme.sbe.v50.lastupdatetime", ftypes.UINT64)
cme_sbe_v50.fields.last_volume_msg = ProtoField.new("Last Volume Msg", "cme.sbe.v50.lastvolumemsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x02")
cme_sbe_v50.fields.leg_option_delta = ProtoField.new("Leg Option Delta", "cme.sbe.v50.legoptiondelta", ftypes.INT32)
cme_sbe_v50.fields.leg_price = ProtoField.new("Leg Price", "cme.sbe.v50.legprice", ftypes.INT64)
cme_sbe_v50.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "cme.sbe.v50.legratioqty", ftypes.INT8)
cme_sbe_v50.fields.leg_security_id = ProtoField.new("Leg Security ID", "cme.sbe.v50.legsecurityid", ftypes.INT32)
cme_sbe_v50.fields.leg_side = ProtoField.new("Leg Side", "cme.sbe.v50.legside", ftypes.UINT8)
cme_sbe_v50.fields.legs_group = ProtoField.new("Legs Group", "cme.sbe.v50.legsgroup", ftypes.STRING)
cme_sbe_v50.fields.legs_groups = ProtoField.new("Legs Groups", "cme.sbe.v50.legsgroups", ftypes.STRING)
cme_sbe_v50.fields.lot_type = ProtoField.new("Lot Type", "cme.sbe.v50.lottype", ftypes.INT8)
cme_sbe_v50.fields.lot_type_rules_group = ProtoField.new("Lot Type Rules Group", "cme.sbe.v50.lottyperulesgroup", ftypes.STRING)
cme_sbe_v50.fields.lot_type_rules_groups = ProtoField.new("Lot Type Rules Groups", "cme.sbe.v50.lottyperulesgroups", ftypes.STRING)
cme_sbe_v50.fields.low_limit_price = ProtoField.new("Low Limit Price", "cme.sbe.v50.lowlimitprice", ftypes.INT64)
cme_sbe_v50.fields.main_fraction = ProtoField.new("Main Fraction", "cme.sbe.v50.mainfraction", ftypes.UINT8)
cme_sbe_v50.fields.market_depth = ProtoField.new("Market Depth", "cme.sbe.v50.marketdepth", ftypes.INT8)
cme_sbe_v50.fields.market_segment_id = ProtoField.new("Market Segment ID", "cme.sbe.v50.marketsegmentid", ftypes.UINT8)
cme_sbe_v50.fields.match_algorithm = ProtoField.new("Match Algorithm", "cme.sbe.v50.matchalgorithm", ftypes.STRING)
cme_sbe_v50.fields.match_event_indicator = ProtoField.new("Match Event Indicator", "cme.sbe.v50.matcheventindicator", ftypes.STRING)
cme_sbe_v50.fields.maturity_month_year = ProtoField.new("Maturity Month Year", "cme.sbe.v50.maturitymonthyear", ftypes.STRING)
cme_sbe_v50.fields.max_price_variation = ProtoField.new("Max Price Variation", "cme.sbe.v50.maxpricevariation", ftypes.INT64)
cme_sbe_v50.fields.max_trade_vol = ProtoField.new("Max Trade Vol", "cme.sbe.v50.maxtradevol", ftypes.UINT32)
cme_sbe_v50.fields.md_entry_px = ProtoField.new("MD Entry Px", "cme.sbe.v50.mdentrypx", ftypes.INT64)
cme_sbe_v50.fields.md_entry_size = ProtoField.new("MD Entry Size", "cme.sbe.v50.mdentrysize", ftypes.INT32)
cme_sbe_v50.fields.md_entry_type = ProtoField.new("MD Entry Type", "cme.sbe.v50.mdentrytype", ftypes.STRING)
cme_sbe_v50.fields.md_feed_type = ProtoField.new("MD Feed Type", "cme.sbe.v50.mdfeedtype", ftypes.STRING)
cme_sbe_v50.fields.md_feed_types_group = ProtoField.new("MD Feed Types Group", "cme.sbe.v50.mdfeedtypesgroup", ftypes.STRING)
cme_sbe_v50.fields.md_feed_types_groups = ProtoField.new("MD Feed Types Groups", "cme.sbe.v50.mdfeedtypesgroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_book = ProtoField.new("MD Incremental Refresh Book", "cme.sbe.v50.mdincrementalrefreshbook", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_book_group = ProtoField.new("MD Incremental Refresh Book Group", "cme.sbe.v50.mdincrementalrefreshbookgroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_book_groups = ProtoField.new("MD Incremental Refresh Book Groups", "cme.sbe.v50.mdincrementalrefreshbookgroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_daily_statistics = ProtoField.new("MD Incremental Refresh Daily Statistics", "cme.sbe.v50.mdincrementalrefreshdailystatistics", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_daily_statistics_group = ProtoField.new("MD Incremental Refresh Daily Statistics Group", "cme.sbe.v50.mdincrementalrefreshdailystatisticsgroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_daily_statistics_groups = ProtoField.new("MD Incremental Refresh Daily Statistics Groups", "cme.sbe.v50.mdincrementalrefreshdailystatisticsgroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_limits_banding = ProtoField.new("MD Incremental Refresh Limits Banding", "cme.sbe.v50.mdincrementalrefreshlimitsbanding", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_limits_banding_group = ProtoField.new("MD Incremental Refresh Limits Banding Group", "cme.sbe.v50.mdincrementalrefreshlimitsbandinggroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_limits_banding_groups = ProtoField.new("MD Incremental Refresh Limits Banding Groups", "cme.sbe.v50.mdincrementalrefreshlimitsbandinggroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_session_statistics = ProtoField.new("MD Incremental Refresh Session Statistics", "cme.sbe.v50.mdincrementalrefreshsessionstatistics", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_session_statistics_group = ProtoField.new("MD Incremental Refresh Session Statistics Group", "cme.sbe.v50.mdincrementalrefreshsessionstatisticsgroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_session_statistics_groups = ProtoField.new("MD Incremental Refresh Session Statistics Groups", "cme.sbe.v50.mdincrementalrefreshsessionstatisticsgroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade = ProtoField.new("MD Incremental Refresh Trade", "cme.sbe.v50.mdincrementalrefreshtrade", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade_group = ProtoField.new("MD Incremental Refresh Trade Group", "cme.sbe.v50.mdincrementalrefreshtradegroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade_groups = ProtoField.new("MD Incremental Refresh Trade Groups", "cme.sbe.v50.mdincrementalrefreshtradegroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade_summary = ProtoField.new("MD Incremental Refresh Trade Summary", "cme.sbe.v50.mdincrementalrefreshtradesummary", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade_summary_group = ProtoField.new("MD Incremental Refresh Trade Summary Group", "cme.sbe.v50.mdincrementalrefreshtradesummarygroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade_summary_groups = ProtoField.new("MD Incremental Refresh Trade Summary Groups", "cme.sbe.v50.mdincrementalrefreshtradesummarygroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade_summary_order_group = ProtoField.new("MD Incremental Refresh Trade Summary Order Group", "cme.sbe.v50.mdincrementalrefreshtradesummaryordergroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_trade_summary_order_groups = ProtoField.new("MD Incremental Refresh Trade Summary Order Groups", "cme.sbe.v50.mdincrementalrefreshtradesummaryordergroups", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_volume = ProtoField.new("MD Incremental Refresh Volume", "cme.sbe.v50.mdincrementalrefreshvolume", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_volume_group = ProtoField.new("MD Incremental Refresh Volume Group", "cme.sbe.v50.mdincrementalrefreshvolumegroup", ftypes.STRING)
cme_sbe_v50.fields.md_incremental_refresh_volume_groups = ProtoField.new("MD Incremental Refresh Volume Groups", "cme.sbe.v50.mdincrementalrefreshvolumegroups", ftypes.STRING)
cme_sbe_v50.fields.md_instrument_definition_future = ProtoField.new("MD Instrument Definition Future", "cme.sbe.v50.mdinstrumentdefinitionfuture", ftypes.STRING)
cme_sbe_v50.fields.md_instrument_definition_option = ProtoField.new("MD Instrument Definition Option", "cme.sbe.v50.mdinstrumentdefinitionoption", ftypes.STRING)
cme_sbe_v50.fields.md_instrument_definition_spread = ProtoField.new("MD Instrument Definition Spread", "cme.sbe.v50.mdinstrumentdefinitionspread", ftypes.STRING)
cme_sbe_v50.fields.md_price_level = ProtoField.new("MD Price Level", "cme.sbe.v50.mdpricelevel", ftypes.UINT8)
cme_sbe_v50.fields.md_security_trading_status = ProtoField.new("MD Security Trading Status", "cme.sbe.v50.mdsecuritytradingstatus", ftypes.UINT8)
cme_sbe_v50.fields.md_update_action = ProtoField.new("MD Update Action", "cme.sbe.v50.mdupdateaction", ftypes.UINT8)
cme_sbe_v50.fields.message = ProtoField.new("Message", "cme.sbe.v50.message", ftypes.STRING)
cme_sbe_v50.fields.message_header = ProtoField.new("Message Header", "cme.sbe.v50.messageheader", ftypes.STRING)
cme_sbe_v50.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "cme.sbe.v50.messagesequencenumber", ftypes.UINT32)
cme_sbe_v50.fields.message_size = ProtoField.new("Message Size", "cme.sbe.v50.messagesize", ftypes.UINT16)
cme_sbe_v50.fields.min_cab_price = ProtoField.new("Min Cab Price", "cme.sbe.v50.mincabprice", ftypes.INT64)
cme_sbe_v50.fields.min_lot_size = ProtoField.new("Min Lot Size", "cme.sbe.v50.minlotsize", ftypes.INT32)
cme_sbe_v50.fields.min_price_increment = ProtoField.new("Min Price Increment", "cme.sbe.v50.minpriceincrement", ftypes.INT64)
cme_sbe_v50.fields.min_price_increment_amount = ProtoField.new("Min Price Increment Amount", "cme.sbe.v50.minpriceincrementamount", ftypes.INT64)
cme_sbe_v50.fields.min_trade_vol = ProtoField.new("Min Trade Vol", "cme.sbe.v50.mintradevol", ftypes.UINT32)
cme_sbe_v50.fields.month = ProtoField.new("month", "cme.sbe.v50.month", ftypes.UINT8)
cme_sbe_v50.fields.negative_price_outright_eligible = ProtoField.new("Negative Price Outright Eligible", "cme.sbe.v50.negativepriceoutrighteligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000400")
cme_sbe_v50.fields.negative_strike_eligible = ProtoField.new("Negative Strike Eligible", "cme.sbe.v50.negativestrikeeligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000200")
cme_sbe_v50.fields.null_value = ProtoField.new("Null Value", "cme.sbe.v50.nullvalue", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x80")
cme_sbe_v50.fields.num_in_group = ProtoField.new("num In Group", "cme.sbe.v50.numingroup", ftypes.UINT8)
cme_sbe_v50.fields.number_of_orders = ProtoField.new("Number Of Orders", "cme.sbe.v50.numberoforders", ftypes.INT32)
cme_sbe_v50.fields.open_close_settl_flag = ProtoField.new("Open Close Settl Flag", "cme.sbe.v50.openclosesettlflag", ftypes.UINT8)
cme_sbe_v50.fields.open_interest_qty = ProtoField.new("Open Interest Qty", "cme.sbe.v50.openinterestqty", ftypes.INT32)
cme_sbe_v50.fields.order_cross_eligible = ProtoField.new("Order Cross Eligible", "cme.sbe.v50.ordercrosseligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000002")
cme_sbe_v50.fields.order_id = ProtoField.new("Order ID", "cme.sbe.v50.orderid", ftypes.UINT64)
cme_sbe_v50.fields.order_qty = ProtoField.new("Order Qty", "cme.sbe.v50.orderqty", ftypes.INT32)
cme_sbe_v50.fields.original_contract_size = ProtoField.new("Original Contract Size", "cme.sbe.v50.originalcontractsize", ftypes.INT32)
cme_sbe_v50.fields.otc_eligible = ProtoField.new("OTC Eligible", "cme.sbe.v50.otceligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00000080")
cme_sbe_v50.fields.packet = ProtoField.new("packet", "cme.sbe.v50.packet", ftypes.STRING)
cme_sbe_v50.fields.packet_header = ProtoField.new("Packet Header", "cme.sbe.v50.packetheader", ftypes.STRING)
cme_sbe_v50.fields.padding_2 = ProtoField.new("Padding 2", "cme.sbe.v50.padding2", ftypes.BYTES)
cme_sbe_v50.fields.padding_3 = ProtoField.new("Padding 3", "cme.sbe.v50.padding3", ftypes.BYTES)
cme_sbe_v50.fields.padding_4 = ProtoField.new("Padding 4", "cme.sbe.v50.padding4", ftypes.BYTES)
cme_sbe_v50.fields.padding_5 = ProtoField.new("Padding 5", "cme.sbe.v50.padding5", ftypes.BYTES)
cme_sbe_v50.fields.padding_6 = ProtoField.new("Padding 6", "cme.sbe.v50.padding6", ftypes.BYTES)
cme_sbe_v50.fields.padding_7 = ProtoField.new("Padding 7", "cme.sbe.v50.padding7", ftypes.BYTES)
cme_sbe_v50.fields.payload = ProtoField.new("Payload", "cme.sbe.v50.payload", ftypes.STRING)
cme_sbe_v50.fields.price_display_format = ProtoField.new("Price Display Format", "cme.sbe.v50.pricedisplayformat", ftypes.UINT8)
cme_sbe_v50.fields.price_ratio = ProtoField.new("Price Ratio", "cme.sbe.v50.priceratio", ftypes.INT64)
cme_sbe_v50.fields.put_or_call = ProtoField.new("Put Or Call", "cme.sbe.v50.putorcall", ftypes.UINT8)
cme_sbe_v50.fields.quote_req_id = ProtoField.new("Quote Req ID", "cme.sbe.v50.quotereqid", ftypes.STRING)
cme_sbe_v50.fields.quote_request = ProtoField.new("Quote Request", "cme.sbe.v50.quoterequest", ftypes.STRING)
cme_sbe_v50.fields.quote_type = ProtoField.new("Quote Type", "cme.sbe.v50.quotetype", ftypes.INT8)
cme_sbe_v50.fields.recovery_msg = ProtoField.new("Recovery Msg", "cme.sbe.v50.recoverymsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x20")
cme_sbe_v50.fields.related_sym_group = ProtoField.new("Related Sym Group", "cme.sbe.v50.relatedsymgroup", ftypes.STRING)
cme_sbe_v50.fields.related_sym_groups = ProtoField.new("Related Sym Groups", "cme.sbe.v50.relatedsymgroups", ftypes.STRING)
cme_sbe_v50.fields.reserved = ProtoField.new("Reserved", "cme.sbe.v50.reserved", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x40")
cme_sbe_v50.fields.reserved_12 = ProtoField.new("Reserved 12", "cme.sbe.v50.reserved12", ftypes.UINT32, nil, base.DEC, "0xFFF00000")
cme_sbe_v50.fields.reserved_bits = ProtoField.new("Reserved Bits", "cme.sbe.v50.reservedbits", ftypes.UINT8, nil, base.DEC, "0x70")
cme_sbe_v50.fields.rfq_cross_eligible = ProtoField.new("RFQ Cross Eligible", "cme.sbe.v50.rfqcrosseligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00002000")
cme_sbe_v50.fields.rounded = ProtoField.new("Rounded", "cme.sbe.v50.rounded", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x04")
cme_sbe_v50.fields.rpt_seq = ProtoField.new("Rpt Seq", "cme.sbe.v50.rptseq", ftypes.UINT32)
cme_sbe_v50.fields.schema_id = ProtoField.new("Schema Id", "cme.sbe.v50.schemaid", ftypes.UINT16)
cme_sbe_v50.fields.security_exchange = ProtoField.new("Security Exchange", "cme.sbe.v50.securityexchange", ftypes.STRING)
cme_sbe_v50.fields.security_group = ProtoField.new("Security Group", "cme.sbe.v50.securitygroup", ftypes.STRING)
cme_sbe_v50.fields.security_id = ProtoField.new("Security ID", "cme.sbe.v50.securityid", ftypes.INT32)
cme_sbe_v50.fields.security_status = ProtoField.new("Security Status", "cme.sbe.v50.securitystatus", ftypes.STRING)
cme_sbe_v50.fields.security_sub_type = ProtoField.new("Security Sub Type", "cme.sbe.v50.securitysubtype", ftypes.STRING)
cme_sbe_v50.fields.security_trading_event = ProtoField.new("Security Trading Event", "cme.sbe.v50.securitytradingevent", ftypes.UINT8)
cme_sbe_v50.fields.security_trading_status = ProtoField.new("Security Trading Status", "cme.sbe.v50.securitytradingstatus", ftypes.UINT8)
cme_sbe_v50.fields.security_type = ProtoField.new("Security Type", "cme.sbe.v50.securitytype", ftypes.STRING)
cme_sbe_v50.fields.security_update_action = ProtoField.new("Security Update Action", "cme.sbe.v50.securityupdateaction", ftypes.STRING)
cme_sbe_v50.fields.sending_time = ProtoField.new("Sending Time", "cme.sbe.v50.sendingtime", ftypes.UINT64)
cme_sbe_v50.fields.settl_currency = ProtoField.new("Settl Currency", "cme.sbe.v50.settlcurrency", ftypes.STRING)
cme_sbe_v50.fields.settl_price_type = ProtoField.new("Settl Price Type", "cme.sbe.v50.settlpricetype", ftypes.STRING)
cme_sbe_v50.fields.side = ProtoField.new("Side", "cme.sbe.v50.side", ftypes.INT8)
cme_sbe_v50.fields.snapshot_full_refresh = ProtoField.new("Snapshot Full Refresh", "cme.sbe.v50.snapshotfullrefresh", ftypes.STRING)
cme_sbe_v50.fields.snapshot_full_refresh_group = ProtoField.new("Snapshot Full Refresh Group", "cme.sbe.v50.snapshotfullrefreshgroup", ftypes.STRING)
cme_sbe_v50.fields.snapshot_full_refresh_groups = ProtoField.new("Snapshot Full Refresh Groups", "cme.sbe.v50.snapshotfullrefreshgroups", ftypes.STRING)
cme_sbe_v50.fields.strike_currency = ProtoField.new("Strike Currency", "cme.sbe.v50.strikecurrency", ftypes.STRING)
cme_sbe_v50.fields.strike_price = ProtoField.new("Strike Price", "cme.sbe.v50.strikeprice", ftypes.INT64)
cme_sbe_v50.fields.sub_fraction = ProtoField.new("Sub Fraction", "cme.sbe.v50.subfraction", ftypes.UINT8)
cme_sbe_v50.fields.symbol = ProtoField.new("Symbol", "cme.sbe.v50.symbol", ftypes.STRING)
cme_sbe_v50.fields.template_id = ProtoField.new("Template Id", "cme.sbe.v50.templateid", ftypes.UINT16)
cme_sbe_v50.fields.text = ProtoField.new("Text", "cme.sbe.v50.text", ftypes.STRING)
cme_sbe_v50.fields.tick_rule = ProtoField.new("Tick Rule", "cme.sbe.v50.tickrule", ftypes.INT8)
cme_sbe_v50.fields.tot_num_reports = ProtoField.new("Tot Num Reports", "cme.sbe.v50.totnumreports", ftypes.UINT32)
cme_sbe_v50.fields.trade_date = ProtoField.new("Trade Date", "cme.sbe.v50.tradedate", ftypes.UINT16)
cme_sbe_v50.fields.trade_id = ProtoField.new("Trade ID", "cme.sbe.v50.tradeid", ftypes.INT32)
cme_sbe_v50.fields.trading_reference_date = ProtoField.new("Trading Reference Date", "cme.sbe.v50.tradingreferencedate", ftypes.UINT16)
cme_sbe_v50.fields.trading_reference_price = ProtoField.new("Trading Reference Price", "cme.sbe.v50.tradingreferenceprice", ftypes.INT64)
cme_sbe_v50.fields.transact_time = ProtoField.new("Transact Time", "cme.sbe.v50.transacttime", ftypes.UINT64)
cme_sbe_v50.fields.underlying_product = ProtoField.new("Underlying Product", "cme.sbe.v50.underlyingproduct", ftypes.UINT8)
cme_sbe_v50.fields.underlying_security_id = ProtoField.new("Underlying Security ID", "cme.sbe.v50.underlyingsecurityid", ftypes.INT32)
cme_sbe_v50.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "cme.sbe.v50.underlyingsymbol", ftypes.STRING)
cme_sbe_v50.fields.underlyings_group = ProtoField.new("Underlyings Group", "cme.sbe.v50.underlyingsgroup", ftypes.STRING)
cme_sbe_v50.fields.underlyings_groups = ProtoField.new("Underlyings Groups", "cme.sbe.v50.underlyingsgroups", ftypes.STRING)
cme_sbe_v50.fields.unit_of_measure = ProtoField.new("Unit Of Measure", "cme.sbe.v50.unitofmeasure", ftypes.STRING)
cme_sbe_v50.fields.unit_of_measure_qty = ProtoField.new("Unit Of Measure Qty", "cme.sbe.v50.unitofmeasureqty", ftypes.INT64)
cme_sbe_v50.fields.user_defined_instrument = ProtoField.new("User Defined Instrument", "cme.sbe.v50.userdefinedinstrument", ftypes.STRING)
cme_sbe_v50.fields.variable_product_eligibility = ProtoField.new("Variable Product Eligibility", "cme.sbe.v50.variableproducteligibility", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00010000")
cme_sbe_v50.fields.version = ProtoField.new("Version", "cme.sbe.v50.version", ftypes.UINT16)
cme_sbe_v50.fields.volatility_quoted_option = ProtoField.new("Volatility Quoted Option", "cme.sbe.v50.volatilityquotedoption", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00001000")
cme_sbe_v50.fields.week = ProtoField.new("week", "cme.sbe.v50.week", ftypes.UINT8)
cme_sbe_v50.fields.year = ProtoField.new("year", "cme.sbe.v50.year", ftypes.UINT16)
cme_sbe_v50.fields.zero_price_outright_eligible = ProtoField.new("Zero Price Outright Eligible", "cme.sbe.v50.zeropriceoutrighteligible", ftypes.UINT32, {[1]="Yes",[0]="No"}, base.DEC, "0x00004000")

-----------------------------------------------------------------------
-- Dissect Cme sbe v50 Protocol
-----------------------------------------------------------------------
...
dissect.padding_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.padding_4, range, value, display)
...
dissect.last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.last_qty, range, value, display)
...
dissect.order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.order_id, range, value, display)
...
dissect.md_incremental_refresh_trade_summary_order_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade_summary_order_group, range, display)
...
dissect.num_in_group = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.num_in_group, range, value, display)
...
dissect.padding_5 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.padding_5, range, value, display)
...
dissect.block_length = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.block_length, range, value, display)
...
dissect.group_size8_byte = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.group_size8_byte, range, display)
...
dissect.md_incremental_refresh_trade_summary_order_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade_summary_order_groups, range, display)
...
dissect.padding_6 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.padding_6, range, value, display)
...
dissect.md_update_action = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.md_update_action, range, value, display)
...
dissect.aggressor_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.aggressor_side, range, value, display)
...
dissect.number_of_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.number_of_orders, range, value, display)
...
dissect.rpt_seq = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.rpt_seq, range, value, display)
...
dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_id, range, value, display)
...
dissect.md_entry_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.md_entry_size, range, value, display)
...
dissect.md_entry_px = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.md_entry_px, range, value, display)
...
dissect.md_incremental_refresh_trade_summary_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade_summary_group, range, display)
...
dissect.group_size = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.group_size, range, display)
...
dissect.md_incremental_refresh_trade_summary_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade_summary_groups, range, display)
...
dissect.padding_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.padding_2, range, value, display)
...
dissect.last_trade_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.last_trade_msg, range, display)
...
dissect.last_volume_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.last_volume_msg, range, display)
...
dissect.last_quote_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.last_quote_msg, range, display)
...
dissect.last_stats_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.last_stats_msg, range, display)
...
dissect.last_implied_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.last_implied_msg, range, display)
...
dissect.recovery_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.recovery_msg, range, display)
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.reserved, range, display)
...
dissect.end_of_event = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.end_of_event, range, display)
...
dissect.match_event_indicator_bits = function(buffer, offset, packet, parent)
  ...
  -- End Of Event:  1 Bit
  parent:add(cme_sbe_v50.fields.end_of_event, buffer(offset + 0, 1))

  -- Reserved:  1 Bit
  parent:add(cme_sbe_v50.fields.reserved, buffer(offset + 0, 1))

  -- Recovery Msg:  1 Bit
  parent:add(cme_sbe_v50.fields.recovery_msg, buffer(offset + 0, 1))

  -- Last Implied Msg:  1 Bit
  parent:add(cme_sbe_v50.fields.last_implied_msg, buffer(offset + 0, 1))

  -- Last Stats Msg:  1 Bit
  parent:add(cme_sbe_v50.fields.last_stats_msg, buffer(offset + 0, 1))

  -- Last Quote Msg:  1 Bit
  parent:add(cme_sbe_v50.fields.last_quote_msg, buffer(offset + 0, 1))

  -- Last Volume Msg:  1 Bit
  parent:add(cme_sbe_v50.fields.last_volume_msg, buffer(offset + 0, 1))

  -- Last Trade Msg:  1 Bit
  parent:add(cme_sbe_v50.fields.last_trade_msg, buffer(offset + 0, 1))
end
...
dissect.match_event_indicator = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.match_event_indicator, range, display)
...
dissect.transact_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.transact_time, range, value, display)
...
dissect.md_incremental_refresh_trade_summary = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade_summary, range, display)
...
dissect.underlying_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.underlying_symbol, range, value, display)
...
dissect.underlying_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.underlying_security_id, range, value, display)
...
dissect.underlyings_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.underlyings_group, range, display)
...
dissect.underlyings_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.underlyings_groups, range, display)
...
dissect.min_lot_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.min_lot_size, range, value, display)
...
dissect.lot_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.lot_type, range, value, display)
...
dissect.lot_type_rules_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.lot_type_rules_group, range, display)
...
dissect.lot_type_rules_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.lot_type_rules_groups, range, display)
...
dissect.electronic_match_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.electronic_match_eligible, range, display)
...
dissect.order_cross_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.order_cross_eligible, range, display)
...
dissect.block_trade_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.block_trade_eligible, range, display)
...
dissect.efp_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.efp_eligible, range, display)
...
dissect.ebf_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.ebf_eligible, range, display)
...
dissect.efs_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.efs_eligible, range, display)
...
dissect.efr_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.efr_eligible, range, display)
...
dissect.otc_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.otc_eligible, range, display)
...
dissect.i_link_indicative_mass_quoting_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.i_link_indicative_mass_quoting_eligible, range, display)
...
dissect.negative_strike_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.negative_strike_eligible, range, display)
...
dissect.negative_price_outright_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.negative_price_outright_eligible, range, display)
...
dissect.is_fractional = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.is_fractional, range, display)
...
dissect.volatility_quoted_option = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.volatility_quoted_option, range, display)
...
dissect.rfq_cross_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.rfq_cross_eligible, range, display)
...
dissect.zero_price_outright_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.zero_price_outright_eligible, range, display)
...
dissect.decaying_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.decaying_product_eligibility, range, display)
...
dissect.variable_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.variable_product_eligibility, range, display)
...
dissect.daily_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.daily_product_eligibility, range, display)
...
dissect.gt_orders_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.gt_orders_eligibility, range, display)
...
dissect.implied_matching_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.implied_matching_eligibility, range, display)
...
dissect.reserved_12 = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.reserved_12, range, display)
...
dissect.inst_attrib_value_bits = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.reserved_12, buffer(offset + 0, 4))

  -- Implied Matching Eligibility:  1 Bit
  parent:add(cme_sbe_v50.fields.implied_matching_eligibility, buffer(offset + 0, 4))

  -- GT Orders Eligibility:  1 Bit
  parent:add(cme_sbe_v50.fields.gt_orders_eligibility, buffer(offset + 0, 4))

  -- Daily Product Eligibility:  1 Bit
  parent:add(cme_sbe_v50.fields.daily_product_eligibility, buffer(offset + 0, 4))

  -- Variable Product Eligibility:  1 Bit
  parent:add(cme_sbe_v50.fields.variable_product_eligibility, buffer(offset + 0, 4))

  -- Decaying Product Eligibility:  1 Bit
  parent:add(cme_sbe_v50.fields.decaying_product_eligibility, buffer(offset + 0, 4))

  -- Zero Price Outright Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.zero_price_outright_eligible, buffer(offset + 0, 4))

  -- RFQ Cross Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.rfq_cross_eligible, buffer(offset + 0, 4))

  -- Volatility Quoted Option:  1 Bit
  parent:add(cme_sbe_v50.fields.volatility_quoted_option, buffer(offset + 0, 4))

  -- Is Fractional:  1 Bit
  parent:add(cme_sbe_v50.fields.is_fractional, buffer(offset + 0, 4))

  -- Negative Price Outright Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.negative_price_outright_eligible, buffer(offset + 0, 4))

  -- Negative Strike Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.negative_strike_eligible, buffer(offset + 0, 4))

  -- i Link Indicative Mass Quoting Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.i_link_indicative_mass_quoting_eligible, buffer(offset + 0, 4))

  -- OTC Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.otc_eligible, buffer(offset + 0, 4))

  -- EFR Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.efr_eligible, buffer(offset + 0, 4))

  -- EFS Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.efs_eligible, buffer(offset + 0, 4))

  -- EBF Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.ebf_eligible, buffer(offset + 0, 4))

  -- EFP Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.efp_eligible, buffer(offset + 0, 4))

  -- Block Trade Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.block_trade_eligible, buffer(offset + 0, 4))

  -- Order Cross Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.order_cross_eligible, buffer(offset + 0, 4))

  -- Electronic Match Eligible:  1 Bit
  parent:add(cme_sbe_v50.fields.electronic_match_eligible, buffer(offset + 0, 4))
end
...
dissect.inst_attrib_value = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.inst_attrib_value, range, display)
...
dissect.inst_attrib_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.inst_attrib_group, range, display)
...
dissect.inst_attrib_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.inst_attrib_groups, range, display)
...
dissect.market_depth = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.market_depth, range, value, display)
...
dissect.md_feed_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.md_feed_type, range, value, display)
...
dissect.md_feed_types_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_feed_types_group, range, display)
...
dissect.md_feed_types_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_feed_types_groups, range, display)
...
dissect.event_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.event_time, range, value, display)
...
dissect.event_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.event_type, range, value, display)
...
dissect.events_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.events_group, range, display)
...
dissect.events_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.events_groups, range, display)
...
dissect.user_defined_instrument = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.user_defined_instrument, range, value, display)
...
dissect.high_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.high_limit_price, range, value, display)
...
dissect.low_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.low_limit_price, range, value, display)
...
dissect.open_interest_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.open_interest_qty, range, value, display)
...
dissect.cleared_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.cleared_volume, range, value, display)
...
dissect.final = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.final, range, display)
...
dissect.actual = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.actual, range, display)
...
dissect.rounded = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.rounded, range, display)
...
dissect.intraday = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.intraday, range, display)
...
dissect.reserved_bits = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.reserved_bits, range, display)
...
dissect.null_value = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.null_value, range, display)
...
dissect.settl_price_type_bits = function(buffer, offset, packet, parent)
  ...
  -- Null Value:  1 Bit
  parent:add(cme_sbe_v50.fields.null_value, buffer(offset + 0, 1))

  -- Reserved Bits: 3 Bit Fixed Size Array
  parent:add(cme_sbe_v50.fields.reserved_bits, buffer(offset + 0, 1))

  -- Intraday:  1 Bit
  parent:add(cme_sbe_v50.fields.intraday, buffer(offset + 0, 1))

  -- Rounded:  1 Bit
  parent:add(cme_sbe_v50.fields.rounded, buffer(offset + 0, 1))

  -- Actual:  1 Bit
  parent:add(cme_sbe_v50.fields.actual, buffer(offset + 0, 1))

  -- Final:  1 Bit
  parent:add(cme_sbe_v50.fields.final, buffer(offset + 0, 1))
end
...
dissect.settl_price_type = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.settl_price_type, range, display)
...
dissect.trading_reference_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.trading_reference_price, range, value, display)
...
dissect.unit_of_measure_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.unit_of_measure_qty, range, value, display)
...
dissect.unit_of_measure = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.unit_of_measure, range, value, display)
...
dissect.price_display_format = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.price_display_format, range, value, display)
...
dissect.sub_fraction = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.sub_fraction, range, value, display)
...
dissect.main_fraction = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.main_fraction, range, value, display)
...
dissect.tick_rule = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.tick_rule, range, value, display)
...
dissect.display_factor = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.display_factor, range, value, display)
...
dissect.min_price_increment_amount = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.min_price_increment_amount, range, value, display)
...
dissect.min_price_increment = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.min_price_increment, range, value, display)
...
dissect.max_trade_vol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.max_trade_vol, range, value, display)
...
dissect.min_trade_vol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.min_trade_vol, range, value, display)
...
dissect.match_algorithm = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.match_algorithm, range, value, display)
...
dissect.min_cab_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.min_cab_price, range, value, display)
...
dissect.settl_currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.settl_currency, range, value, display)
...
dissect.strike_currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.strike_currency, range, value, display)
...
dissect.strike_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.strike_price, range, value, display)
...
dissect.currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.currency, range, value, display)
...
dissect.week = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.week, range, value, display)
...
dissect.day = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.day, range, value, display)
...
dissect.month = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.month, range, value, display)
...
dissect.year = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.year, range, value, display)
...
dissect.maturity_month_year = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.maturity_month_year, range, display)
...
dissect.put_or_call = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.put_or_call, range, value, display)
...
dissect.cfi_code = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.cfi_code, range, value, display)
...
dissect.security_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_type, range, value, display)
...
dissect.symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.symbol, range, value, display)
...
dissect.asset = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.asset, range, value, display)
...
dissect.security_group = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_group, range, value, display)
...
dissect.security_exchange = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_exchange, range, value, display)
...
dissect.underlying_product = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.underlying_product, range, value, display)
...
dissect.market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.market_segment_id, range, value, display)
...
dissect.appl_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.appl_id, range, value, display)
...
dissect.md_security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.md_security_trading_status, range, value, display)
...
dissect.last_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.last_update_time, range, value, display)
...
dissect.security_update_action = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_update_action, range, value, display)
...
dissect.tot_num_reports = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.tot_num_reports, range, value, display)
...
dissect.md_instrument_definition_option = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_instrument_definition_option, range, display)
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.side, range, value, display)
...
dissect.quote_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.quote_type, range, value, display)
...
dissect.order_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.order_qty, range, value, display)
...
dissect.related_sym_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.related_sym_group, range, display)
...
dissect.related_sym_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.related_sym_groups, range, display)
...
dissect.padding_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.padding_3, range, value, display)
...
dissect.quote_req_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.quote_req_id, range, value, display)
...
dissect.quote_request = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.quote_request, range, display)
...
dissect.md_entry_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.md_entry_type, range, value, display)
...
dissect.open_close_settl_flag = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.open_close_settl_flag, range, value, display)
...
dissect.trading_reference_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.trading_reference_date, range, value, display)
...
dissect.md_price_level = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.md_price_level, range, value, display)
...
dissect.snapshot_full_refresh_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.snapshot_full_refresh_group, range, display)
...
dissect.snapshot_full_refresh_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.snapshot_full_refresh_groups, range, display)
...
dissect.max_price_variation = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.max_price_variation, range, value, display)
...
dissect.trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.trade_date, range, value, display)
...
dissect.last_msg_seq_num_processed = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.last_msg_seq_num_processed, range, value, display)
...
dissect.snapshot_full_refresh = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.snapshot_full_refresh, range, display)
...
dissect.md_incremental_refresh_volume_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_volume_group, range, display)
...
dissect.md_incremental_refresh_volume_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_volume_groups, range, display)
...
dissect.md_incremental_refresh_volume = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_volume, range, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.trade_id, range, value, display)
...
dissect.md_incremental_refresh_trade_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade_group, range, display)
...
dissect.md_incremental_refresh_trade_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade_groups, range, display)
...
dissect.md_incremental_refresh_trade = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_trade, range, display)
...
dissect.md_incremental_refresh_session_statistics_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_session_statistics_group, range, display)
...
dissect.md_incremental_refresh_session_statistics_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_session_statistics_groups, range, display)
...
dissect.md_incremental_refresh_session_statistics = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_session_statistics, range, display)
...
dissect.md_incremental_refresh_limits_banding_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_limits_banding_group, range, display)
...
dissect.md_incremental_refresh_limits_banding_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_limits_banding_groups, range, display)
...
dissect.md_incremental_refresh_limits_banding = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_limits_banding, range, display)
...
dissect.padding_7 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.padding_7, range, value, display)
...
dissect.md_incremental_refresh_daily_statistics_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_daily_statistics_group, range, display)
...
dissect.md_incremental_refresh_daily_statistics_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_daily_statistics_groups, range, display)
...
dissect.md_incremental_refresh_daily_statistics = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_daily_statistics, range, display)
...
dissect.md_incremental_refresh_book_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_book_group, range, display)
...
dissect.md_incremental_refresh_book_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_book_groups, range, display)
...
dissect.md_incremental_refresh_book = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_incremental_refresh_book, range, display)
...
dissect.security_trading_event = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_trading_event, range, value, display)
...
dissect.halt_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.halt_reason, range, value, display)
...
dissect.security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_trading_status, range, value, display)
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.security_status, range, display)
...
dissect.leg_option_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.leg_option_delta, range, value, display)
...
dissect.leg_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.leg_price, range, value, display)
...
dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.leg_ratio_qty, range, value, display)
...
dissect.leg_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.leg_side, range, value, display)
...
dissect.leg_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.leg_security_id, range, value, display)
...
dissect.legs_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.legs_group, range, display)
...
dissect.legs_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.legs_groups, range, display)
...
dissect.price_ratio = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.price_ratio, range, value, display)
...
dissect.security_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.security_sub_type, range, value, display)
...
dissect.md_instrument_definition_spread = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_instrument_definition_spread, range, display)
...
dissect.flow_schedule_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.flow_schedule_type, range, value, display)
...
dissect.contract_multiplier_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.contract_multiplier_unit, range, value, display)
...
dissect.contract_multiplier = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.contract_multiplier, range, value, display)
...
dissect.original_contract_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.original_contract_size, range, value, display)
...
dissect.decay_start_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.decay_start_date, range, value, display)
...
dissect.decay_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.decay_quantity, range, value, display)
...
dissect.md_instrument_definition_future = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.md_instrument_definition_future, range, display)
...
dissect.text = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.text, range, value, display)
...
dissect.admin_logout = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.admin_logout, range, display)
...
dissect.heart_bt_int = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.heart_bt_int, range, value, display)
...
dissect.admin_login = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.admin_login, range, display)
...
dissect.channel_reset_group = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.channel_reset_group, range, display)
...
dissect.channel_reset_groups = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.channel_reset_groups, range, display)
...
dissect.channel_reset = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.channel_reset, range, display)
...
dissect.payload = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.payload, range, display)
...
dissect.version = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.version, range, value, display)
...
dissect.schema_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.schema_id, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.template_id, range, value, display)
...
dissect.message_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.message_size, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.message_header, range, display)
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.message, range, display)
...
dissect.sending_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.sending_time, range, value, display)
...
dissect.message_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_v50.fields.message_sequence_number, range, value, display)
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_v50.fields.packet_header, range, display)
...
function cme_sbe_v50.init()
end
-- Dissector for cme sbe v50 protocol
function cme_sbe_v50.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = cme_sbe_v50.name

  -- Dissect protocol
  local protocol = parent:add(cme_sbe_v50, buffer(), cme_sbe_v50.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register cme sbe v50 protocol with udp table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, cme_sbe_v50)

-- Verify size of packet
verify.cme_sbe_v50_packet_size = function(buffer)
...
-- Dissector heuristic for cme sbe v50 protocol
local function cme_sbe_v50_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.cme_sbe_v50_packet_size(buffer) then return false end

  -- Verify Version
  if not verify.version(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = cme_sbe_v50
  cme_sbe_v50.dissector(buffer, packet, parent)

  return true
end

-- Register cme sbe v50 protocol heuristic
cme_sbe_v50:register_heuristic("udp", cme_sbe_v50_heuristic)

-----------------------------------------------------------------------
-- This file was generated by a tool for the open markets initiative
-- Protocol Version: v50
