...
omi_jpx_osederivatives_geniuminet_itch_v1_1.fields.force = ProtoField.new("Force", "jpx.osederivatives.geniuminet.itch.v1.1.force", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_jpx_osederivatives_geniuminet_itch_v1_1.fields.market_bid = ProtoField.new("Market Bid", "jpx.osederivatives.geniuminet.itch.v1.1.marketbid", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
...
omi_jpx_osederivatives_geniuminet_itch_v1_1.fields.override_crossing = ProtoField.new("Override Crossing", "jpx.osederivatives.geniuminet.itch.v1.1.overridecrossing", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0010)
...
omi_jpx_osederivatives_geniuminet_itch_v1_1.fields.short_sell = ProtoField.new("Short Sell", "jpx.osederivatives.geniuminet.itch.v1.1.shortsell", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_jpx_osederivatives_geniuminet_itch_v1_1.fields.undisclosed = ProtoField.new("Undisclosed", "jpx.osederivatives.geniuminet.itch.v1.1.undisclosed", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0020)
...
-- Message Block
jpx_osederivatives_geniuminet_itch_v1_1.message_block = {}

-- Size: Message Block
jpx_osederivatives_geniuminet_itch_v1_1.message_block.size = function(buffer, offset, message_count)
  -- Size of Heartbeat
...
jpx_osederivatives_geniuminet_itch_v1_1.message_block.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
  end
  ...
  for message_index = 1, message_count do
    ...
    offset = jpx_osederivatives_geniuminet_itch_v1_1.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
jpx_osederivatives_geniuminet_itch_v1_1.message_block.dissect = function(buffer, offset, packet, parent, message_count)
  return jpx_osederivatives_geniuminet_itch_v1_1.message_block.branches(buffer, offset, packet, parent, message_count)
end
...
jpx_osederivatives_geniuminet_itch_v1_1.packet.dissect = function(buffer, packet, parent)
  ...
  index = jpx_osederivatives_geniuminet_itch_v1_1.message_block.dissect(buffer, index, packet, parent, message_count)
