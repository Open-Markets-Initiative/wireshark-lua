...
omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_tcp_packet = Pref.bool("Show Tcp Packet", show.tcp_packet, "Parse and add Tcp Packet to protocol tree")
omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_udp_packet = Pref.bool("Show Udp Packet", show.udp_packet, "Parse and add Udp Packet to protocol tree")
omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs_changed()
  ...
  if show.message ~= omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message then
    show.message = omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message
  end
  if show.message_header ~= omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message_header then
    show.message_header = omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message_header
  end
  if show.packet_header ~= omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_packet_header then
    show.packet_header = omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_packet_header
  end
  if show.tcp_packet ~= omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_tcp_packet then
    show.tcp_packet = omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_tcp_packet
  end
  if show.udp_packet ~= omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_udp_packet then
    show.udp_packet = omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_udp_packet
  end
  if show.message_index ~= omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message_index then
    show.message_index = omi_jpx_nseequities_marketbyorder_flex_v1_1.prefs.show_message_index
  end
end
