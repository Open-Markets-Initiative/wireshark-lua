...
omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_msg_header = Pref.bool("Show Msg Header", show.msg_header, "Parse and add Msg Header to protocol tree")
omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs_changed()
  ...
  if show.message ~= omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_message then
    show.message = omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_message
  end
  if show.msg_header ~= omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_msg_header then
    show.msg_header = omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_msg_header
  end
  if show.packet ~= omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_packet then
    show.packet = omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_packet
  end
  if show.packet_header ~= omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_packet_header then
    show.packet_header = omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_packet_header
  end
  if show.message_index ~= omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_message_index then
    show.message_index = omi_hkex_hkexsecurities_indexretrans_omd_v1_45.prefs.show_message_index
  end
end
