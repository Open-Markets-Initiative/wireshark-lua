...
local omi_hkex_derivatives_fulltick_omd_v1_47 = Proto("Omi.Hkex.Derivatives.FullTick.Omd.v1.47", "Hkex Derivatives FullTick Omd 1.47")
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.bait_or_implied_order = ProtoField.new("Bait Or Implied Order", "hkex.derivatives.fulltick.omd.v1.47.baitorimpliedorder", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x2000)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.buy_write = ProtoField.new("Buy Write", "hkex.derivatives.fulltick.omd.v1.47.buywrite", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.convert_to_aggressive = ProtoField.new("Convert To Aggressive", "hkex.derivatives.fulltick.omd.v1.47.converttoaggressive", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x1000)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.deal_info_uint_162 = ProtoField.new("Deal Info Uint 162", "hkex.derivatives.fulltick.omd.v1.47.dealinfouint162", ftypes.UINT16)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.deal_type = ProtoField.new("Deal Type", "hkex.derivatives.fulltick.omd.v1.47.dealtype", ftypes.STRING)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.fill_and_kill_immediately = ProtoField.new("Fill And Kill Immediately", "hkex.derivatives.fulltick.omd.v1.47.fillandkillimmediately", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0400)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.firm_color_disabled = ProtoField.new("Firm Color Disabled", "hkex.derivatives.fulltick.omd.v1.47.firmcolordisabled", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0800)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.force = ProtoField.new("Force", "hkex.derivatives.fulltick.omd.v1.47.force", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.internal_trade_or_cross = ProtoField.new("Internal Trade Or Cross", "hkex.derivatives.fulltick.omd.v1.47.internaltradeorcross", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.late_trade = ProtoField.new("Late Trade", "hkex.derivatives.fulltick.omd.v1.47.latetrade", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.market_bid = ProtoField.new("Market Bid", "hkex.derivatives.fulltick.omd.v1.47.marketbid", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.occurred_at_cross = ProtoField.new("Occurred At Cross", "hkex.derivatives.fulltick.omd.v1.47.occurredatcross", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.off_market = ProtoField.new("Off Market", "hkex.derivatives.fulltick.omd.v1.47.offmarket", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0008)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.order_type = ProtoField.new("Order Type", "hkex.derivatives.fulltick.omd.v1.47.ordertype", ftypes.STRING)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.price_stabilization = ProtoField.new("Price Stabilization", "hkex.derivatives.fulltick.omd.v1.47.pricestabilization", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0008)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.printable = ProtoField.new("Printable", "hkex.derivatives.fulltick.omd.v1.47.printable", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.reported_trade = ProtoField.new("Reported Trade", "hkex.derivatives.fulltick.omd.v1.47.reportedtrade", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.short_sell = ProtoField.new("Short Sell", "hkex.derivatives.fulltick.omd.v1.47.shortsell", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.trade_condition = ProtoField.new("Trade Condition", "hkex.derivatives.fulltick.omd.v1.47.tradecondition", ftypes.STRING)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.trade_side = ProtoField.new("Trade Side", "hkex.derivatives.fulltick.omd.v1.47.tradeside", ftypes.UINT8)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.undisclosed = ProtoField.new("Undisclosed", "hkex.derivatives.fulltick.omd.v1.47.undisclosed", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0020)
...
omi_hkex_derivatives_fulltick_omd_v1_47.fields.unused_order_type_bit_10 = ProtoField.new("Unused Order Type Bit 10", "hkex.derivatives.fulltick.omd.v1.47.unusedordertypebit10", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0200)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.unused_order_type_bit_15 = ProtoField.new("Unused Order Type Bit 15", "hkex.derivatives.fulltick.omd.v1.47.unusedordertypebit15", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x4000)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.unused_order_type_bit_16 = ProtoField.new("Unused Order Type Bit 16", "hkex.derivatives.fulltick.omd.v1.47.unusedordertypebit16", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x8000)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.unused_order_type_bit_7 = ProtoField.new("Unused Order Type Bit 7", "hkex.derivatives.fulltick.omd.v1.47.unusedordertypebit7", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0040)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.unused_order_type_bit_8 = ProtoField.new("Unused Order Type Bit 8", "hkex.derivatives.fulltick.omd.v1.47.unusedordertypebit8", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0080)
omi_hkex_derivatives_fulltick_omd_v1_47.fields.unused_order_type_bit_9 = ProtoField.new("Unused Order Type Bit 9", "hkex.derivatives.fulltick.omd.v1.47.unusedordertypebit9", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0100)

-- Hkex Derivatives Omd FullTick 1.47 Application Messages
...
omi_hkex_derivatives_fulltick_omd_v1_47.prefs.show_deal_type = Pref.bool("Show Deal Type", show.deal_type, "Parse and add Deal Type to protocol tree")
...
omi_hkex_derivatives_fulltick_omd_v1_47.prefs.show_order_type = Pref.bool("Show Order Type", show.order_type, "Parse and add Order Type to protocol tree")
...
-- Deal Info Uint 162
hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162 = {}

-- Size: Deal Info Uint 162
hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162.size = 2

-- Display: Deal Info Uint 162
hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162.display = function(value)
  return "Deal Info Uint 162: "..value
end

-- Dissect: Deal Info Uint 162
hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162.dissect = function(buffer, offset, packet, parent)
  local length = hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_derivatives_fulltick_omd_v1_47.fields.deal_info_uint_162, range, value, display)
...
-- Trade Side
hkex_derivatives_fulltick_omd_v1_47.trade_side = {}

-- Size: Trade Side
hkex_derivatives_fulltick_omd_v1_47.trade_side.size = 1

-- Display: Trade Side
hkex_derivatives_fulltick_omd_v1_47.trade_side.display = function(value)
  if value == 0 then
...
-- Dissect: Trade Side
hkex_derivatives_fulltick_omd_v1_47.trade_side.dissect = function(buffer, offset, packet, parent)
  local length = hkex_derivatives_fulltick_omd_v1_47.trade_side.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = hkex_derivatives_fulltick_omd_v1_47.trade_side.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_derivatives_fulltick_omd_v1_47.fields.trade_side, range, value, display)
...
hkex_derivatives_fulltick_omd_v1_47.trade_message.size =
  ...
  hkex_derivatives_fulltick_omd_v1_47.trade_id.size + 
  hkex_derivatives_fulltick_omd_v1_47.combo_group_id.size + 
  hkex_derivatives_fulltick_omd_v1_47.trade_side.size + 
  hkex_derivatives_fulltick_omd_v1_47.deal_type.size + 
  hkex_derivatives_fulltick_omd_v1_47.trade_condition.size + 
  hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162.size + 
...
hkex_derivatives_fulltick_omd_v1_47.trade_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Trade Side: Uint8
  index, trade_side = hkex_derivatives_fulltick_omd_v1_47.trade_side.dissect(buffer, index, packet, parent)
  ...
  index, deal_info_uint_162 = hkex_derivatives_fulltick_omd_v1_47.deal_info_uint_162.dissect(buffer, index, packet, parent)
...
hkex_derivatives_fulltick_omd_v1_47.packet.requiredsize = function(buffer)
  return buffer:len() >= hkex_derivatives_fulltick_omd_v1_47.packet_header.size
end
...
hkex_derivatives_fulltick_omd_v1_47.packet.dissect = function(buffer, packet, parent)
  ...
  for message_index = 1, msg_count do
    ...
    index, message = hkex_derivatives_fulltick_omd_v1_47.message.dissect(buffer, index, packet, parent, msg_size, message_index)
  end
...
omi_hkex_derivatives_fulltick_omd_v1_47:register_heuristic("udp", omi_hkex_derivatives_fulltick_omd_v1_47_udp_heuristic)

-- Register Hkex Derivatives FullTick Omd 1.47 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_hkex_derivatives_fulltick_omd_v1_47)
