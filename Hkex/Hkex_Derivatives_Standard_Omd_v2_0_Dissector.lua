...
local omi_hkex_derivatives_standard_omd_v2_0 = Proto("Omi.Hkex.Derivatives.Standard.Omd.v2.0", "Hkex Derivatives Standard Omd 2.0")
...
omi_hkex_derivatives_standard_omd_v2_0.fields.orderbook_id = ProtoField.new("Orderbook Id", "hkex.derivatives.standard.omd.v2.0.orderbookid", ftypes.UINT32)
...
-- Hkex Derivatives Omd Standard 2.0 Application Messages
...
-- Orderbook Id
hkex_derivatives_standard_omd_v2_0.orderbook_id = {}

-- Size: Orderbook Id
hkex_derivatives_standard_omd_v2_0.orderbook_id.size = 4

-- Display: Orderbook Id
hkex_derivatives_standard_omd_v2_0.orderbook_id.display = function(value)
  return "Orderbook Id: "..value
end

-- Dissect: Orderbook Id
hkex_derivatives_standard_omd_v2_0.orderbook_id.dissect = function(buffer, offset, packet, parent)
  local length = hkex_derivatives_standard_omd_v2_0.orderbook_id.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = hkex_derivatives_standard_omd_v2_0.orderbook_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_derivatives_standard_omd_v2_0.fields.orderbook_id, range, value, display)
...
hkex_derivatives_standard_omd_v2_0.trade_statistics_message.size =
  hkex_derivatives_standard_omd_v2_0.orderbook_id.size + 
...
hkex_derivatives_standard_omd_v2_0.trade_statistics_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Orderbook Id: Uint32
  index, orderbook_id = hkex_derivatives_standard_omd_v2_0.orderbook_id.dissect(buffer, index, packet, parent)
...
hkex_derivatives_standard_omd_v2_0.aggregate_order_book_update_message.size = function(buffer, offset)
  ...
  index = index + hkex_derivatives_standard_omd_v2_0.orderbook_id.size
...
hkex_derivatives_standard_omd_v2_0.packet.requiredsize = function(buffer)
  return buffer:len() >= hkex_derivatives_standard_omd_v2_0.packet_header.size
end
...
-- Dissector Heuristic for Hkex Derivatives Standard Omd 2.0 (Udp)
local function omi_hkex_derivatives_standard_omd_v2_0_udp_heuristic(buffer, packet, parent)
...
omi_hkex_derivatives_standard_omd_v2_0:register_heuristic("udp", omi_hkex_derivatives_standard_omd_v2_0_udp_heuristic)

-- Register Hkex Derivatives Standard Omd 2.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_hkex_derivatives_standard_omd_v2_0)
