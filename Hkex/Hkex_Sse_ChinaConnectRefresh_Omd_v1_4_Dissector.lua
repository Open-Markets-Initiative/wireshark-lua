...
omi_hkex_sse_chinaconnectrefresh_omd_v1_4.fields.security_name_gb = ProtoField.new("Security Name Gb", "hkex.sse.chinaconnectrefresh.omd.v1.4.securitynamegb", ftypes.BYTES)
...
function omi_hkex_sse_chinaconnectrefresh_omd_v1_4.prefs_changed()
  ...
  if show.headers ~= omi_hkex_sse_chinaconnectrefresh_omd_v1_4.prefs.show_headers then
    show.headers = omi_hkex_sse_chinaconnectrefresh_omd_v1_4.prefs.show_headers
  end
  if show.structs ~= omi_hkex_sse_chinaconnectrefresh_omd_v1_4.prefs.show_structs then
    show.structs = omi_hkex_sse_chinaconnectrefresh_omd_v1_4.prefs.show_structs
  end
  if show.indexes ~= omi_hkex_sse_chinaconnectrefresh_omd_v1_4.prefs.show_indexes then
    show.indexes = omi_hkex_sse_chinaconnectrefresh_omd_v1_4.prefs.show_indexes
  end
end
