...
omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_book_entry = Pref.bool("Show Book Entry", show.book_entry, "Parse and add Book Entry to protocol tree")
omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_msg_header = Pref.bool("Show Msg Header", show.msg_header, "Parse and add Msg Header to protocol tree")
omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_book_entry_index = Pref.bool("Show Book Entry Index", show.book_entry_index, "Show generated book entry index in protocol tree")
...
function omi_hkex_hkexsecurities_premium_omd_v1_45.prefs_changed()
  ...
  if show.book_entry ~= omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_book_entry then
    show.book_entry = omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_book_entry
  end
  if show.message ~= omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_message then
    show.message = omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_message
  end
  if show.msg_header ~= omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_msg_header then
    show.msg_header = omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_msg_header
  end
  if show.packet ~= omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_packet then
    show.packet = omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_packet
  end
  if show.packet_header ~= omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_packet_header then
    show.packet_header = omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_packet_header
  end
  if show.message_index ~= omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_message_index then
    show.message_index = omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_message_index
  end
  if show.book_entry_index ~= omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_book_entry_index then
    show.book_entry_index = omi_hkex_hkexsecurities_premium_omd_v1_45.prefs.show_book_entry_index
  end
end
...
-- Size: Filler
hkex_hkexsecurities_premium_omd_v1_45.filler.size = 3
...
hkex_hkexsecurities_premium_omd_v1_45.aggregate_order_book_update_message.size = function(buffer, offset)
  ...
  index = index + hkex_hkexsecurities_premium_omd_v1_45.filler.size
