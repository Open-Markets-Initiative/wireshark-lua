...
omi_hkex_derivatives_premium_omd_v1_47.fields.deal_info = ProtoField.new("Deal Info", "hkex.derivatives.premium.omd.v1.47.dealinfo", ftypes.UINT16)
omi_hkex_derivatives_premium_omd_v1_47.fields.deal_type = ProtoField.new("Deal Type", "hkex.derivatives.premium.omd.v1.47.dealtype", ftypes.UINT8)
...
omi_hkex_derivatives_premium_omd_v1_47.fields.instrument = ProtoField.new("Instrument", "hkex.derivatives.premium.omd.v1.47.instrument", ftypes.UINT8)
...
omi_hkex_derivatives_premium_omd_v1_47.fields.trade_condition = ProtoField.new("Trade Condition", "hkex.derivatives.premium.omd.v1.47.tradecondition", ftypes.UINT16)
...
-- Deal Info
hkex_derivatives_premium_omd_v1_47.deal_info = {}

-- Size: Deal Info
hkex_derivatives_premium_omd_v1_47.deal_info.size = 2

-- Display: Deal Info
hkex_derivatives_premium_omd_v1_47.deal_info.display = function(value)
  return "Deal Info: "..value
end

-- Dissect: Deal Info
hkex_derivatives_premium_omd_v1_47.deal_info.dissect = function(buffer, offset, packet, parent)
  local length = hkex_derivatives_premium_omd_v1_47.deal_info.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = hkex_derivatives_premium_omd_v1_47.deal_info.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_derivatives_premium_omd_v1_47.fields.deal_info, range, value, display)
...
hkex_derivatives_premium_omd_v1_47.trade_condition.display = function(value)
...
hkex_derivatives_premium_omd_v1_47.trade_condition.dissect = function(buffer, offset, packet, parent)
  local length = hkex_derivatives_premium_omd_v1_47.trade_condition.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = hkex_derivatives_premium_omd_v1_47.trade_condition.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_derivatives_premium_omd_v1_47.fields.trade_condition, range, value, display)
...
-- Display: Deal Type
hkex_derivatives_premium_omd_v1_47.deal_type.display = function(value)
  return "Deal Type: "..value
end

-- Dissect: Deal Type
hkex_derivatives_premium_omd_v1_47.deal_type.dissect = function(buffer, offset, packet, parent)
  local length = hkex_derivatives_premium_omd_v1_47.deal_type.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = hkex_derivatives_premium_omd_v1_47.deal_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_derivatives_premium_omd_v1_47.fields.deal_type, range, value, display)
...
hkex_derivatives_premium_omd_v1_47.trade_message.size =
  ...
  hkex_derivatives_premium_omd_v1_47.deal_info.size + 
...
hkex_derivatives_premium_omd_v1_47.trade_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Deal Info: Uint16
  index, deal_info = hkex_derivatives_premium_omd_v1_47.deal_info.dissect(buffer, index, packet, parent)
...
-- Instrument
hkex_derivatives_premium_omd_v1_47.instrument = {}

-- Size: Instrument
hkex_derivatives_premium_omd_v1_47.instrument.size = 1

-- Display: Instrument
hkex_derivatives_premium_omd_v1_47.instrument.display = function(value)
  return "Instrument: "..value
end

-- Dissect: Instrument
hkex_derivatives_premium_omd_v1_47.instrument.dissect = function(buffer, offset, packet, parent)
  local length = hkex_derivatives_premium_omd_v1_47.instrument.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = hkex_derivatives_premium_omd_v1_47.instrument.display(value, buffer, offset, packet, parent)

  parent:add(omi_hkex_derivatives_premium_omd_v1_47.fields.instrument, range, value, display)
...
hkex_derivatives_premium_omd_v1_47.market_status_message.size =
  ...
  hkex_derivatives_premium_omd_v1_47.instrument.size + 
  hkex_derivatives_premium_omd_v1_47.orderbook_id.size + 
  hkex_derivatives_premium_omd_v1_47.commodity_code.size + 
  hkex_derivatives_premium_omd_v1_47.filler_2.size + 
...
hkex_derivatives_premium_omd_v1_47.market_status_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Instrument: Uint8
  index, instrument = hkex_derivatives_premium_omd_v1_47.instrument.dissect(buffer, index, packet, parent)
