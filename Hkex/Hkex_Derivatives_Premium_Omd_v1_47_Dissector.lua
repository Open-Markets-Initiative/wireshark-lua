...
local omi_hkex_derivatives_premium_omd_v1_47 = Proto("Omi.Hkex.Derivatives.Premium.Omd.v1.47", "Hkex Derivatives Premium Omd 1.47")
...
omi_hkex_derivatives_premium_omd_v1_47.fields.buy_write = ProtoField.new("Buy Write", "hkex.derivatives.premium.omd.v1.47.buywrite", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
...
omi_hkex_derivatives_premium_omd_v1_47.fields.internal_trade_or_cross = ProtoField.new("Internal Trade Or Cross", "hkex.derivatives.premium.omd.v1.47.internaltradeorcross", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_hkex_derivatives_premium_omd_v1_47.fields.late_trade = ProtoField.new("Late Trade", "hkex.derivatives.premium.omd.v1.47.latetrade", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_hkex_derivatives_premium_omd_v1_47.fields.occurred_at_cross = ProtoField.new("Occurred At Cross", "hkex.derivatives.premium.omd.v1.47.occurredatcross", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_hkex_derivatives_premium_omd_v1_47.fields.off_market = ProtoField.new("Off Market", "hkex.derivatives.premium.omd.v1.47.offmarket", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0008)
...
omi_hkex_derivatives_premium_omd_v1_47.fields.printable = ProtoField.new("Printable", "hkex.derivatives.premium.omd.v1.47.printable", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_hkex_derivatives_premium_omd_v1_47.fields.reported_trade = ProtoField.new("Reported Trade", "hkex.derivatives.premium.omd.v1.47.reportedtrade", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_hkex_derivatives_premium_omd_v1_47.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_hkex_derivatives_premium_omd_v1_47.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
omi_hkex_derivatives_premium_omd_v1_47.prefs.show_book_entry_index = Pref.bool("Show Book Entry Index", show.book_entry_index, "Show generated book entry index in protocol tree")
omi_hkex_derivatives_premium_omd_v1_47.prefs.show_content_index = Pref.bool("Show Content Index", show.content_index, "Show generated content index in protocol tree")
...
function omi_hkex_derivatives_premium_omd_v1_47.prefs_changed()
  ...
  if show.application_messages ~= omi_hkex_derivatives_premium_omd_v1_47.prefs.show_application_messages then
    show.application_messages = omi_hkex_derivatives_premium_omd_v1_47.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_hkex_derivatives_premium_omd_v1_47.prefs.show_message_index then
    show.message_index = omi_hkex_derivatives_premium_omd_v1_47.prefs.show_message_index
  end
  if show.book_entry_index ~= omi_hkex_derivatives_premium_omd_v1_47.prefs.show_book_entry_index then
    show.book_entry_index = omi_hkex_derivatives_premium_omd_v1_47.prefs.show_book_entry_index
  end
  if show.content_index ~= omi_hkex_derivatives_premium_omd_v1_47.prefs.show_content_index then
    show.content_index = omi_hkex_derivatives_premium_omd_v1_47.prefs.show_content_index
  end
end
...
hkex_derivatives_premium_omd_v1_47.market_alert_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_hkex_derivatives_premium_omd_v1_47.fields.market_alert_message, buffer(offset, 0))
    local index = hkex_derivatives_premium_omd_v1_47.market_alert_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = hkex_derivatives_premium_omd_v1_47.market_alert_message.display(packet, parent, length)
    parent:append_text(display)
...
hkex_derivatives_premium_omd_v1_47.aggregate_order_book_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_hkex_derivatives_premium_omd_v1_47.fields.aggregate_order_book_update_message, buffer(offset, 0))
    local index = hkex_derivatives_premium_omd_v1_47.aggregate_order_book_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = hkex_derivatives_premium_omd_v1_47.aggregate_order_book_update_message.display(packet, parent, length)
    parent:append_text(display)
...
hkex_derivatives_premium_omd_v1_47.packet.requiredsize = function(buffer)
  return buffer:len() >= hkex_derivatives_premium_omd_v1_47.packet_header.size
end
...
hkex_derivatives_premium_omd_v1_47.packet.dissect = function(buffer, packet, parent)
  ...
  for message_index = 1, msg_count do
    ...
    index, message = hkex_derivatives_premium_omd_v1_47.message.dissect(buffer, index, packet, parent, msg_size, message_index)
  end
...
-- Dissector Heuristic for Hkex Derivatives Premium Omd 1.47 (Udp)
local function omi_hkex_derivatives_premium_omd_v1_47_udp_heuristic(buffer, packet, parent)
...
-- Register Hkex Derivatives Premium Omd 1.47 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_hkex_derivatives_premium_omd_v1_47)
