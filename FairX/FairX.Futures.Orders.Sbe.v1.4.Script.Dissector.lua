...
-- FairX Futures Orders Sbe 1.4 Protocol
local fairx_futures_orders_sbe_v1_4 = Proto("FairX.Futures.Orders.Sbe.v1.4.Lua", "FairX Futures Orders Sbe 1.4")
...
-- FairX Futures Orders Sbe 1.4 Fields
fairx_futures_orders_sbe_v1_4.fields.account = ProtoField.new("Account", "fairx.futures.orders.sbe.v1.4.account", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.available_qty = ProtoField.new("Available Qty", "fairx.futures.orders.sbe.v1.4.availableqty", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.begin_exec_id = ProtoField.new("Begin Exec Id", "fairx.futures.orders.sbe.v1.4.beginexecid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.block_length = ProtoField.new("Block Length", "fairx.futures.orders.sbe.v1.4.blocklength", ftypes.UINT16)
fairx_futures_orders_sbe_v1_4.fields.cancel_order_message = ProtoField.new("Cancel Order Message", "fairx.futures.orders.sbe.v1.4.cancelordermessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.cancel_order_reject_message = ProtoField.new("Cancel Order Reject Message", "fairx.futures.orders.sbe.v1.4.cancelorderrejectmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.cancel_reason = ProtoField.new("Cancel Reason", "fairx.futures.orders.sbe.v1.4.cancelreason", ftypes.UINT8)
fairx_futures_orders_sbe_v1_4.fields.canceled_count = ProtoField.new("Canceled Count", "fairx.futures.orders.sbe.v1.4.canceledcount", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.client_order_id = ProtoField.new("Client Order Id", "fairx.futures.orders.sbe.v1.4.clientorderid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.correlation_id = ProtoField.new("Correlation Id", "fairx.futures.orders.sbe.v1.4.correlationid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.current_session_only = ProtoField.new("Current Session Only", "fairx.futures.orders.sbe.v1.4.currentsessiononly", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.details = ProtoField.new("Details", "fairx.futures.orders.sbe.v1.4.details", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.end_exec_id = ProtoField.new("End Exec Id", "fairx.futures.orders.sbe.v1.4.endexecid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.error_message = ProtoField.new("Error Message", "fairx.futures.orders.sbe.v1.4.errormessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.event_resend_complete_message = ProtoField.new("Event Resend Complete Message", "fairx.futures.orders.sbe.v1.4.eventresendcompletemessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.event_resend_reject_message = ProtoField.new("Event Resend Reject Message", "fairx.futures.orders.sbe.v1.4.eventresendrejectmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.event_resend_request_message = ProtoField.new("Event Resend Request Message", "fairx.futures.orders.sbe.v1.4.eventresendrequestmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.exec_id = ProtoField.new("Exec Id", "fairx.futures.orders.sbe.v1.4.execid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.fill_price = ProtoField.new("Fill Price", "fairx.futures.orders.sbe.v1.4.fillprice", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.fill_qty = ProtoField.new("Fill Qty", "fairx.futures.orders.sbe.v1.4.fillqty", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.filled_vwap = ProtoField.new("Filled Vwap", "fairx.futures.orders.sbe.v1.4.filledvwap", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.flags = ProtoField.new("Flags", "fairx.futures.orders.sbe.v1.4.flags", ftypes.UINT8)
fairx_futures_orders_sbe_v1_4.fields.instrument_id = ProtoField.new("Instrument Id", "fairx.futures.orders.sbe.v1.4.instrumentid", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.instrument_info_message = ProtoField.new("Instrument Info Message", "fairx.futures.orders.sbe.v1.4.instrumentinfomessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.instrument_info_request_message = ProtoField.new("Instrument Info Request Message", "fairx.futures.orders.sbe.v1.4.instrumentinforequestmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.is_aggressor = ProtoField.new("Is Aggressor", "fairx.futures.orders.sbe.v1.4.isaggressor", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.is_last_message = ProtoField.new("Is Last Message", "fairx.futures.orders.sbe.v1.4.islastmessage", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.last_exec_id = ProtoField.new("Last Exec Id", "fairx.futures.orders.sbe.v1.4.lastexecid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.last_exec_id_message = ProtoField.new("Last Exec Id Message", "fairx.futures.orders.sbe.v1.4.lastexecidmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.last_exec_id_request_message = ProtoField.new("Last Exec Id Request Message", "fairx.futures.orders.sbe.v1.4.lastexecidrequestmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.last_processed_fill_id = ProtoField.new("Last Processed Fill Id", "fairx.futures.orders.sbe.v1.4.lastprocessedfillid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.last_processed_seq_no = ProtoField.new("Last Processed Seq No", "fairx.futures.orders.sbe.v1.4.lastprocessedseqno", ftypes.UINT32)
fairx_futures_orders_sbe_v1_4.fields.leg_1_fill_price = ProtoField.new("Leg 1 Fill Price", "fairx.futures.orders.sbe.v1.4.leg1fillprice", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.leg_2_fill_price = ProtoField.new("Leg 2 Fill Price", "fairx.futures.orders.sbe.v1.4.leg2fillprice", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.limit_price = ProtoField.new("Limit Price", "fairx.futures.orders.sbe.v1.4.limitprice", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.mass_cancel_order_ack_message = ProtoField.new("Mass Cancel Order Ack Message", "fairx.futures.orders.sbe.v1.4.masscancelorderackmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.mass_cancel_order_message = ProtoField.new("Mass Cancel Order Message", "fairx.futures.orders.sbe.v1.4.masscancelordermessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.mass_cancel_order_reject_message = ProtoField.new("Mass Cancel Order Reject Message", "fairx.futures.orders.sbe.v1.4.masscancelorderrejectmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.match_id = ProtoField.new("Match Id", "fairx.futures.orders.sbe.v1.4.matchid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.message_header = ProtoField.new("Message Header", "fairx.futures.orders.sbe.v1.4.messageheader", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.message_length = ProtoField.new("Message Length", "fairx.futures.orders.sbe.v1.4.messagelength", ftypes.UINT16)
fairx_futures_orders_sbe_v1_4.fields.new_limit_price = ProtoField.new("New Limit Price", "fairx.futures.orders.sbe.v1.4.newlimitprice", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.new_order_message = ProtoField.new("New Order Message", "fairx.futures.orders.sbe.v1.4.newordermessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.new_quantity = ProtoField.new("New Quantity", "fairx.futures.orders.sbe.v1.4.newquantity", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.num_users_affected = ProtoField.new("Num Users Affected", "fairx.futures.orders.sbe.v1.4.numusersaffected", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.only_current_session = ProtoField.new("Only Current Session", "fairx.futures.orders.sbe.v1.4.onlycurrentsession", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.order_canceled_message = ProtoField.new("Order Canceled Message", "fairx.futures.orders.sbe.v1.4.ordercanceledmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.order_entered_message = ProtoField.new("Order Entered Message", "fairx.futures.orders.sbe.v1.4.orderenteredmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.order_filled_message = ProtoField.new("Order Filled Message", "fairx.futures.orders.sbe.v1.4.orderfilledmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.order_id = ProtoField.new("Order Id", "fairx.futures.orders.sbe.v1.4.orderid", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.order_reject_message = ProtoField.new("Order Reject Message", "fairx.futures.orders.sbe.v1.4.orderrejectmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.order_replaced_message = ProtoField.new("Order Replaced Message", "fairx.futures.orders.sbe.v1.4.orderreplacedmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.packet = ProtoField.new("Packet", "fairx.futures.orders.sbe.v1.4.packet", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.padding = ProtoField.new("Padding", "fairx.futures.orders.sbe.v1.4.padding", ftypes.BYTES)
fairx_futures_orders_sbe_v1_4.fields.payload = ProtoField.new("Payload", "fairx.futures.orders.sbe.v1.4.payload", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.ping_message = ProtoField.new("Ping Message", "fairx.futures.orders.sbe.v1.4.pingmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.pong_message = ProtoField.new("Pong Message", "fairx.futures.orders.sbe.v1.4.pongmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.protocol_id = ProtoField.new("Protocol Id", "fairx.futures.orders.sbe.v1.4.protocolid", ftypes.UINT8)
fairx_futures_orders_sbe_v1_4.fields.quantity = ProtoField.new("Quantity", "fairx.futures.orders.sbe.v1.4.quantity", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.receive_time = ProtoField.new("Receive Time", "fairx.futures.orders.sbe.v1.4.receivetime", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.reject_reason = ProtoField.new("Reject Reason", "fairx.futures.orders.sbe.v1.4.rejectreason", ftypes.UINT8)
fairx_futures_orders_sbe_v1_4.fields.replace_order_message = ProtoField.new("Replace Order Message", "fairx.futures.orders.sbe.v1.4.replaceordermessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.request_time = ProtoField.new("Request Time", "fairx.futures.orders.sbe.v1.4.requesttime", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.request_trading_lock = ProtoField.new("Request Trading Lock", "fairx.futures.orders.sbe.v1.4.requesttradinglock", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.resent_event_count = ProtoField.new("Resent Event Count", "fairx.futures.orders.sbe.v1.4.resenteventcount", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.reserved = ProtoField.new("Reserved", "fairx.futures.orders.sbe.v1.4.reserved", ftypes.UINT32)
fairx_futures_orders_sbe_v1_4.fields.sbe_message = ProtoField.new("Sbe Message", "fairx.futures.orders.sbe.v1.4.sbemessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.schema_id = ProtoField.new("Schema Id", "fairx.futures.orders.sbe.v1.4.schemaid", ftypes.UINT16)
fairx_futures_orders_sbe_v1_4.fields.security_type = ProtoField.new("Security Type", "fairx.futures.orders.sbe.v1.4.securitytype", ftypes.UINT8)
fairx_futures_orders_sbe_v1_4.fields.send_time_epoch_nanos = ProtoField.new("Send Time Epoch Nanos", "fairx.futures.orders.sbe.v1.4.sendtimeepochnanos", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.sequence_number = ProtoField.new("Sequence Number", "fairx.futures.orders.sbe.v1.4.sequencenumber", ftypes.UINT32)
fairx_futures_orders_sbe_v1_4.fields.server_time = ProtoField.new("Server Time", "fairx.futures.orders.sbe.v1.4.servertime", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.set_account_message = ProtoField.new("Set Account Message", "fairx.futures.orders.sbe.v1.4.setaccountmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.set_ack_message = ProtoField.new("Set Ack Message", "fairx.futures.orders.sbe.v1.4.setackmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.set_trader_message = ProtoField.new("Set Trader Message", "fairx.futures.orders.sbe.v1.4.settradermessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.side = ProtoField.new("Side", "fairx.futures.orders.sbe.v1.4.side", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.spread_order_filled_message = ProtoField.new("Spread Order Filled Message", "fairx.futures.orders.sbe.v1.4.spreadorderfilledmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.status = ProtoField.new("Status", "fairx.futures.orders.sbe.v1.4.status", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.stream_order_message = ProtoField.new("Stream Order Message", "fairx.futures.orders.sbe.v1.4.streamordermessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.symbol = ProtoField.new("Symbol", "fairx.futures.orders.sbe.v1.4.symbol", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.template_id = ProtoField.new("Template Id", "fairx.futures.orders.sbe.v1.4.templateid", ftypes.UINT16)
fairx_futures_orders_sbe_v1_4.fields.timestamp = ProtoField.new("Timestamp", "fairx.futures.orders.sbe.v1.4.timestamp", ftypes.INT64)
fairx_futures_orders_sbe_v1_4.fields.total_filled = ProtoField.new("Total Filled", "fairx.futures.orders.sbe.v1.4.totalfilled", ftypes.INT32)
fairx_futures_orders_sbe_v1_4.fields.trader = ProtoField.new("Trader", "fairx.futures.orders.sbe.v1.4.trader", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.trading_lock_applied = ProtoField.new("Trading Lock Applied", "fairx.futures.orders.sbe.v1.4.tradinglockapplied", ftypes.INT8)
fairx_futures_orders_sbe_v1_4.fields.unlock_trading_ack_message = ProtoField.new("Unlock Trading Ack Message", "fairx.futures.orders.sbe.v1.4.unlocktradingackmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.unlock_trading_message = ProtoField.new("Unlock Trading Message", "fairx.futures.orders.sbe.v1.4.unlocktradingmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.unlock_trading_reject_message = ProtoField.new("Unlock Trading Reject Message", "fairx.futures.orders.sbe.v1.4.unlocktradingrejectmessage", ftypes.STRING)
fairx_futures_orders_sbe_v1_4.fields.version = ProtoField.new("Version", "fairx.futures.orders.sbe.v1.4.version", ftypes.UINT16)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- FairX Futures Orders Sbe 1.4 Element Dissection Options
...
-- Register FairX Futures Orders Sbe 1.4 Show Options
fairx_futures_orders_sbe_v1_4.prefs.show_cancel_order_message = Pref.bool("Show Cancel Order Message", show.cancel_order_message, "Parse and add Cancel Order Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_cancel_order_reject_message = Pref.bool("Show Cancel Order Reject Message", show.cancel_order_reject_message, "Parse and add Cancel Order Reject Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_complete_message = Pref.bool("Show Event Resend Complete Message", show.event_resend_complete_message, "Parse and add Event Resend Complete Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_reject_message = Pref.bool("Show Event Resend Reject Message", show.event_resend_reject_message, "Parse and add Event Resend Reject Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_request_message = Pref.bool("Show Event Resend Request Message", show.event_resend_request_message, "Parse and add Event Resend Request Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_instrument_info_message = Pref.bool("Show Instrument Info Message", show.instrument_info_message, "Parse and add Instrument Info Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_instrument_info_request_message = Pref.bool("Show Instrument Info Request Message", show.instrument_info_request_message, "Parse and add Instrument Info Request Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_last_exec_id_message = Pref.bool("Show Last Exec Id Message", show.last_exec_id_message, "Parse and add Last Exec Id Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_last_exec_id_request_message = Pref.bool("Show Last Exec Id Request Message", show.last_exec_id_request_message, "Parse and add Last Exec Id Request Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_ack_message = Pref.bool("Show Mass Cancel Order Ack Message", show.mass_cancel_order_ack_message, "Parse and add Mass Cancel Order Ack Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_message = Pref.bool("Show Mass Cancel Order Message", show.mass_cancel_order_message, "Parse and add Mass Cancel Order Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_reject_message = Pref.bool("Show Mass Cancel Order Reject Message", show.mass_cancel_order_reject_message, "Parse and add Mass Cancel Order Reject Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_new_order_message = Pref.bool("Show New Order Message", show.new_order_message, "Parse and add New Order Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_order_canceled_message = Pref.bool("Show Order Canceled Message", show.order_canceled_message, "Parse and add Order Canceled Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_order_entered_message = Pref.bool("Show Order Entered Message", show.order_entered_message, "Parse and add Order Entered Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_order_filled_message = Pref.bool("Show Order Filled Message", show.order_filled_message, "Parse and add Order Filled Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_order_reject_message = Pref.bool("Show Order Reject Message", show.order_reject_message, "Parse and add Order Reject Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_order_replaced_message = Pref.bool("Show Order Replaced Message", show.order_replaced_message, "Parse and add Order Replaced Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_ping_message = Pref.bool("Show Ping Message", show.ping_message, "Parse and add Ping Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_pong_message = Pref.bool("Show Pong Message", show.pong_message, "Parse and add Pong Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_replace_order_message = Pref.bool("Show Replace Order Message", show.replace_order_message, "Parse and add Replace Order Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_sbe_message = Pref.bool("Show Sbe Message", show.sbe_message, "Parse and add Sbe Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_set_account_message = Pref.bool("Show Set Account Message", show.set_account_message, "Parse and add Set Account Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_set_ack_message = Pref.bool("Show Set Ack Message", show.set_ack_message, "Parse and add Set Ack Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_set_trader_message = Pref.bool("Show Set Trader Message", show.set_trader_message, "Parse and add Set Trader Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_spread_order_filled_message = Pref.bool("Show Spread Order Filled Message", show.spread_order_filled_message, "Parse and add Spread Order Filled Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_stream_order_message = Pref.bool("Show Stream Order Message", show.stream_order_message, "Parse and add Stream Order Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_ack_message = Pref.bool("Show Unlock Trading Ack Message", show.unlock_trading_ack_message, "Parse and add Unlock Trading Ack Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_message = Pref.bool("Show Unlock Trading Message", show.unlock_trading_message, "Parse and add Unlock Trading Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_reject_message = Pref.bool("Show Unlock Trading Reject Message", show.unlock_trading_reject_message, "Parse and add Unlock Trading Reject Message to protocol tree")
fairx_futures_orders_sbe_v1_4.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function fairx_futures_orders_sbe_v1_4.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.cancel_order_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_cancel_order_message then
    show.cancel_order_message = fairx_futures_orders_sbe_v1_4.prefs.show_cancel_order_message
    changed = true
  end
  if show.cancel_order_reject_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_cancel_order_reject_message then
    show.cancel_order_reject_message = fairx_futures_orders_sbe_v1_4.prefs.show_cancel_order_reject_message
    changed = true
  end
  if show.event_resend_complete_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_complete_message then
    show.event_resend_complete_message = fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_complete_message
    changed = true
  end
  if show.event_resend_reject_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_reject_message then
    show.event_resend_reject_message = fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_reject_message
    changed = true
  end
  if show.event_resend_request_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_request_message then
    show.event_resend_request_message = fairx_futures_orders_sbe_v1_4.prefs.show_event_resend_request_message
    changed = true
  end
  if show.instrument_info_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_instrument_info_message then
    show.instrument_info_message = fairx_futures_orders_sbe_v1_4.prefs.show_instrument_info_message
    changed = true
  end
  if show.instrument_info_request_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_instrument_info_request_message then
    show.instrument_info_request_message = fairx_futures_orders_sbe_v1_4.prefs.show_instrument_info_request_message
    changed = true
  end
  if show.last_exec_id_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_last_exec_id_message then
    show.last_exec_id_message = fairx_futures_orders_sbe_v1_4.prefs.show_last_exec_id_message
    changed = true
  end
  if show.last_exec_id_request_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_last_exec_id_request_message then
    show.last_exec_id_request_message = fairx_futures_orders_sbe_v1_4.prefs.show_last_exec_id_request_message
    changed = true
  end
  if show.mass_cancel_order_ack_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_ack_message then
    show.mass_cancel_order_ack_message = fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_ack_message
    changed = true
  end
  if show.mass_cancel_order_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_message then
    show.mass_cancel_order_message = fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_message
    changed = true
  end
  if show.mass_cancel_order_reject_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_reject_message then
    show.mass_cancel_order_reject_message = fairx_futures_orders_sbe_v1_4.prefs.show_mass_cancel_order_reject_message
    changed = true
  end
  if show.message_header ~= fairx_futures_orders_sbe_v1_4.prefs.show_message_header then
    show.message_header = fairx_futures_orders_sbe_v1_4.prefs.show_message_header
    changed = true
  end
  if show.new_order_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_new_order_message then
    show.new_order_message = fairx_futures_orders_sbe_v1_4.prefs.show_new_order_message
    changed = true
  end
  if show.order_canceled_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_order_canceled_message then
    show.order_canceled_message = fairx_futures_orders_sbe_v1_4.prefs.show_order_canceled_message
    changed = true
  end
  if show.order_entered_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_order_entered_message then
    show.order_entered_message = fairx_futures_orders_sbe_v1_4.prefs.show_order_entered_message
    changed = true
  end
  if show.order_filled_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_order_filled_message then
    show.order_filled_message = fairx_futures_orders_sbe_v1_4.prefs.show_order_filled_message
    changed = true
  end
  if show.order_reject_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_order_reject_message then
    show.order_reject_message = fairx_futures_orders_sbe_v1_4.prefs.show_order_reject_message
    changed = true
  end
  if show.order_replaced_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_order_replaced_message then
    show.order_replaced_message = fairx_futures_orders_sbe_v1_4.prefs.show_order_replaced_message
    changed = true
  end
  if show.packet ~= fairx_futures_orders_sbe_v1_4.prefs.show_packet then
    show.packet = fairx_futures_orders_sbe_v1_4.prefs.show_packet
    changed = true
  end
  if show.ping_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_ping_message then
    show.ping_message = fairx_futures_orders_sbe_v1_4.prefs.show_ping_message
    changed = true
  end
  if show.pong_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_pong_message then
    show.pong_message = fairx_futures_orders_sbe_v1_4.prefs.show_pong_message
    changed = true
  end
  if show.replace_order_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_replace_order_message then
    show.replace_order_message = fairx_futures_orders_sbe_v1_4.prefs.show_replace_order_message
    changed = true
  end
  if show.sbe_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_sbe_message then
    show.sbe_message = fairx_futures_orders_sbe_v1_4.prefs.show_sbe_message
    changed = true
  end
  if show.set_account_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_set_account_message then
    show.set_account_message = fairx_futures_orders_sbe_v1_4.prefs.show_set_account_message
    changed = true
  end
  if show.set_ack_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_set_ack_message then
    show.set_ack_message = fairx_futures_orders_sbe_v1_4.prefs.show_set_ack_message
    changed = true
  end
  if show.set_trader_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_set_trader_message then
    show.set_trader_message = fairx_futures_orders_sbe_v1_4.prefs.show_set_trader_message
    changed = true
  end
  if show.spread_order_filled_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_spread_order_filled_message then
    show.spread_order_filled_message = fairx_futures_orders_sbe_v1_4.prefs.show_spread_order_filled_message
    changed = true
  end
  if show.stream_order_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_stream_order_message then
    show.stream_order_message = fairx_futures_orders_sbe_v1_4.prefs.show_stream_order_message
    changed = true
  end
  if show.unlock_trading_ack_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_ack_message then
    show.unlock_trading_ack_message = fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_ack_message
    changed = true
  end
  if show.unlock_trading_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_message then
    show.unlock_trading_message = fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_message
    changed = true
  end
  if show.unlock_trading_reject_message ~= fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_reject_message then
    show.unlock_trading_reject_message = fairx_futures_orders_sbe_v1_4.prefs.show_unlock_trading_reject_message
    changed = true
  end
  if show.payload ~= fairx_futures_orders_sbe_v1_4.prefs.show_payload then
    show.payload = fairx_futures_orders_sbe_v1_4.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect FairX Futures Orders Sbe 1.4
-----------------------------------------------------------------------
...
dissect.padding = function(buffer, offset, packet, parent, size)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.padding, range, value, display)
...
dissect.details = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.details, range, value, display)
...
dissect.reject_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.reject_reason, range, value, display)
...
dissect.correlation_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.correlation_id, range, value, display)
...
dissect.event_resend_reject_message = function(buffer, offset, packet, parent)
  ...
  if show.event_resend_reject_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.event_resend_reject_message, range, display)
  end
...
dissect.resent_event_count = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.resent_event_count, range, value, display)
...
dissect.event_resend_complete_message = function(buffer, offset, packet, parent)
  ...
  if show.event_resend_complete_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.event_resend_complete_message, range, display)
  end
...
dissect.end_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.end_exec_id, range, value, display)
...
dissect.begin_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.begin_exec_id, range, value, display)
...
dissect.event_resend_request_message = function(buffer, offset, packet, parent)
  ...
  if show.event_resend_request_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.event_resend_request_message, range, display)
  end
...
dissect.last_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.last_exec_id, range, value, display)
...
dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.timestamp, range, value, display)
...
dissect.last_exec_id_message = function(buffer, offset, packet, parent)
  ...
  if show.last_exec_id_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.last_exec_id_message, range, display)
  end
...
dissect.last_exec_id_request_message = function(buffer, offset, packet, parent)
  ...
  if show.last_exec_id_request_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.last_exec_id_request_message, range, display)
  end
...
dissect.is_aggressor = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.is_aggressor, range, value, display)
...
dissect.instrument_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.instrument_id, range, value, display)
...
dissect.fill_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.fill_qty, range, value, display)
...
dissect.leg_2_fill_price = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.leg_2_fill_price, range, value, display)
...
dissect.leg_1_fill_price = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.leg_1_fill_price, range, value, display)
...
dissect.fill_price = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.fill_price, range, value, display)
...
dissect.available_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.available_qty, range, value, display)
...
dissect.total_filled = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.total_filled, range, value, display)
...
dissect.filled_vwap = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.filled_vwap, range, value, display)
...
dissect.order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.order_id, range, value, display)
...
dissect.client_order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.client_order_id, range, value, display)
...
dissect.match_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.match_id, range, value, display)
...
dissect.exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.exec_id, range, value, display)
...
dissect.spread_order_filled_message = function(buffer, offset, packet, parent)
  ...
  if show.spread_order_filled_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.spread_order_filled_message, range, display)
  end
...
dissect.order_filled_message = function(buffer, offset, packet, parent)
  ...
  if show.order_filled_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.order_filled_message, range, display)
  end
...
dissect.error_message = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.error_message, range, value, display)
...
dissect.unlock_trading_reject_message = function(buffer, offset, packet, parent)
  ...
  if show.unlock_trading_reject_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.unlock_trading_reject_message, range, display)
  end
...
dissect.num_users_affected = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.num_users_affected, range, value, display)
...
dissect.unlock_trading_ack_message = function(buffer, offset, packet, parent)
  ...
  if show.unlock_trading_ack_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.unlock_trading_ack_message, range, display)
  end
...
dissect.current_session_only = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.current_session_only, range, value, display)
...
dissect.unlock_trading_message = function(buffer, offset, packet, parent)
  ...
  if show.unlock_trading_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.unlock_trading_message, range, display)
  end
...
dissect.mass_cancel_order_reject_message = function(buffer, offset, packet, parent)
  ...
  if show.mass_cancel_order_reject_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.mass_cancel_order_reject_message, range, display)
  end
...
dissect.trading_lock_applied = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.trading_lock_applied, range, value, display)
...
dissect.only_current_session = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.only_current_session, range, value, display)
...
dissect.canceled_count = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.canceled_count, range, value, display)
...
dissect.mass_cancel_order_ack_message = function(buffer, offset, packet, parent)
  ...
  if show.mass_cancel_order_ack_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.mass_cancel_order_ack_message, range, display)
  end
...
dissect.request_trading_lock = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.request_trading_lock, range, value, display)
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.side, range, value, display)
...
dissect.limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.limit_price, range, value, display)
...
dissect.mass_cancel_order_message = function(buffer, offset, packet, parent)
  ...
  if show.mass_cancel_order_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.mass_cancel_order_message, range, display)
  end
...
dissect.cancel_order_reject_message = function(buffer, offset, packet, parent)
  ...
  if show.cancel_order_reject_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.cancel_order_reject_message, range, display)
  end
...
dissect.cancel_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.cancel_reason, range, value, display)
...
dissect.receive_time = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.receive_time, range, value, display)
...
dissect.order_canceled_message = function(buffer, offset, packet, parent)
  ...
  if show.order_canceled_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.order_canceled_message, range, display)
  end
...
dissect.cancel_order_message = function(buffer, offset, packet, parent)
  ...
  if show.cancel_order_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.cancel_order_message, range, display)
  end
...
dissect.order_replaced_message = function(buffer, offset, packet, parent)
  ...
  if show.order_replaced_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.order_replaced_message, range, display)
  end
...
dissect.order_reject_message = function(buffer, offset, packet, parent)
  ...
  if show.order_reject_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.order_reject_message, range, display)
  end
...
dissect.quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.quantity, range, value, display)
...
dissect.last_processed_fill_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.last_processed_fill_id, range, value, display)
...
dissect.stream_order_message = function(buffer, offset, packet, parent)
  ...
  if show.stream_order_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.stream_order_message, range, display)
  end
...
dissect.new_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.new_quantity, range, value, display)
...
dissect.new_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.new_limit_price, range, value, display)
...
dissect.replace_order_message = function(buffer, offset, packet, parent)
  ...
  if show.replace_order_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.replace_order_message, range, display)
  end
...
dissect.order_entered_message = function(buffer, offset, packet, parent)
  ...
  if show.order_entered_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.order_entered_message, range, display)
  end
...
dissect.new_order_message = function(buffer, offset, packet, parent)
  ...
  if show.new_order_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.new_order_message, range, display)
  end
...
dissect.set_ack_message = function(buffer, offset, packet, parent)
  ...
  if show.set_ack_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.set_ack_message, range, display)
  end
...
dissect.trader = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.trader, range, value, display)
...
dissect.set_trader_message = function(buffer, offset, packet, parent)
  ...
  if show.set_trader_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.set_trader_message, range, display)
  end
...
dissect.account = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.account, range, value, display)
...
dissect.set_account_message = function(buffer, offset, packet, parent)
  ...
  if show.set_account_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.set_account_message, range, display)
  end
...
dissect.symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.symbol, range, value, display)
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.reserved, range, value, display)
...
dissect.is_last_message = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.is_last_message, range, value, display)
...
dissect.status = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.status, range, value, display)
...
dissect.security_type = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.security_type, range, value, display)
...
dissect.instrument_info_message = function(buffer, offset, packet, parent)
  ...
  if show.instrument_info_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.instrument_info_message, range, display)
  end
...
dissect.instrument_info_request_message = function(buffer, offset, packet, parent)
  ...
  if show.instrument_info_request_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.instrument_info_request_message, range, display)
  end
...
dissect.server_time = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.server_time, range, value, display)
...
dissect.request_time = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.request_time, range, value, display)
...
dissect.pong_message = function(buffer, offset, packet, parent)
  ...
  if show.pong_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.pong_message, range, display)
  end
...
dissect.ping_message = function(buffer, offset, packet, parent)
  ...
  if show.ping_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.ping_message, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, template_id)
  ...
  local element = parent:add(fairx_futures_orders_sbe_v1_4.fields.payload, range, display)
...
dissect.version = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.version, range, value, display)
...
dissect.schema_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.schema_id, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.template_id, range, value, display)
...
dissect.block_length = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.block_length, range, value, display)
...
dissect.send_time_epoch_nanos = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.send_time_epoch_nanos, range, value, display)
...
dissect.last_processed_seq_no = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.last_processed_seq_no, range, value, display)
...
dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.sequence_number, range, value, display)
...
dissect.message_length = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.message_length, range, value, display)
...
dissect.flags = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.flags, range, value, display)
...
dissect.protocol_id = function(buffer, offset, packet, parent)
  ...
  parent:add(fairx_futures_orders_sbe_v1_4.fields.protocol_id, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.message_header, range, display)
  end
...
dissect.sbe_message = function(buffer, offset, packet, parent, size_of_sbe_message)
  ...
  if show.sbe_message then
    ...
    parent = parent:add(fairx_futures_orders_sbe_v1_4.fields.sbe_message, range, display)
  end
...
function fairx_futures_orders_sbe_v1_4.init()
end

-- Dissector for FairX Futures Orders Sbe 1.4
function fairx_futures_orders_sbe_v1_4.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = fairx_futures_orders_sbe_v1_4.name

  -- Dissect protocol
  local protocol = parent:add(fairx_futures_orders_sbe_v1_4, buffer(), fairx_futures_orders_sbe_v1_4.description, "("..buffer:len().." Bytes)")
  return dissect.packet(buffer, packet, protocol)
end

-- Register With Tcp Table
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add(65333, fairx_futures_orders_sbe_v1_4)
...
verify.fairx_futures_orders_sbe_v1_4_packet_size = function(buffer)
...
-- Dissector Heuristic for FairX Futures Orders Sbe 1.4
local function fairx_futures_orders_sbe_v1_4_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.fairx_futures_orders_sbe_v1_4_packet_size(buffer) then return false end
  ...
  packet.conversation = fairx_futures_orders_sbe_v1_4
  fairx_futures_orders_sbe_v1_4.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for FairX Futures Orders Sbe 1.4
fairx_futures_orders_sbe_v1_4:register_heuristic("tcp", fairx_futures_orders_sbe_v1_4_heuristic)
