...
function omi_odx_odxsecuritytoken_pts_itch_v2_2.prefs_changed()
  ...
  if show.indexes ~= omi_odx_odxsecuritytoken_pts_itch_v2_2.prefs.show_indexes then
    show.indexes = omi_odx_odxsecuritytoken_pts_itch_v2_2.prefs.show_indexes
  end
...
-- Dissector Heuristic for Odx OdxSecurityToken Pts Itch 2.2 (Udp)
local function omi_odx_odxsecuritytoken_pts_itch_v2_2_udp_heuristic(buffer, packet, parent)
