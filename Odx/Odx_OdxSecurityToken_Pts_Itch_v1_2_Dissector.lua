...
local omi_odx_odxsecuritytoken_pts_itch_v1_2 = Proto("Odx.OdxSecurityToken.Pts.Itch.v1.2.Lua", "Odx OdxSecurityToken Pts Itch 1.2")
...
omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.packet = ProtoField.new("Packet", "odx.odxsecuritytoken.pts.itch.v1.2.packet", ftypes.STRING)
omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.packet_header = ProtoField.new("Packet Header", "odx.odxsecuritytoken.pts.itch.v1.2.packetheader", ftypes.STRING)
...
omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.packet_type = ProtoField.new("Packet Type", "odx.odxsecuritytoken.pts.itch.v1.2.packettype", ftypes.STRING)
...
omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "odx.odxsecuritytoken.pts.itch.v1.2.soupbintcppacket", ftypes.STRING)
...
omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.timestamp_nanoseconds = ProtoField.new("Timestamp Nanoseconds", "odx.odxsecuritytoken.pts.itch.v1.2.timestampnanoseconds", ftypes.UINT32)
omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.timestamp_seconds = ProtoField.new("Timestamp Seconds", "odx.odxsecuritytoken.pts.itch.v1.2.timestampseconds", ftypes.UINT32)
...
omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
...
function omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs_changed()
  ...
  if show.packet ~= omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_packet then
    show.packet = omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_packet
  end
  if show.packet_header ~= omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_packet_header then
    show.packet_header = omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_packet_header
  end
  ...
  if show.soup_bin_tcp_packet ~= omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_soup_bin_tcp_packet then
    show.soup_bin_tcp_packet = omi_odx_odxsecuritytoken_pts_itch_v1_2.prefs.show_soup_bin_tcp_packet
  end
end
...
-- Packet Type
odx_odxsecuritytoken_pts_itch_v1_2.packet_type = {}

-- Size: Packet Type
odx_odxsecuritytoken_pts_itch_v1_2.packet_type.size = 1

-- Display: Packet Type
odx_odxsecuritytoken_pts_itch_v1_2.packet_type.display = function(value)
  if value == "+" then
...
-- Dissect: Packet Type
odx_odxsecuritytoken_pts_itch_v1_2.packet_type.dissect = function(buffer, offset, packet, parent)
  local length = odx_odxsecuritytoken_pts_itch_v1_2.packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = odx_odxsecuritytoken_pts_itch_v1_2.packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.packet_type, range, value, display)
...
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_nanoseconds = {}

-- Size: Timestamp Nanoseconds
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_nanoseconds.size = 4

-- Display: Timestamp Nanoseconds
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_nanoseconds.display = function(value)
  return "Timestamp Nanoseconds: "..value
end

-- Dissect: Timestamp Nanoseconds
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_nanoseconds.dissect = function(buffer, offset, packet, parent)
  local length = odx_odxsecuritytoken_pts_itch_v1_2.timestamp_nanoseconds.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = odx_odxsecuritytoken_pts_itch_v1_2.timestamp_nanoseconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.timestamp_nanoseconds, range, value, display)

  return offset + length, value
end

-- Timestamp Seconds
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds = {}
...
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds.dissect = function(buffer, offset, packet, parent)
  local length = odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.timestamp_seconds, range, value, display)
...
odx_odxsecuritytoken_pts_itch_v1_2.equilibrium_price_update_message.size =
  odx_odxsecuritytoken_pts_itch_v1_2.timestamp_nanoseconds.size + 
...
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message = {}

-- Size: Timestamp Seconds Message
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.size =
  odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds.size

-- Display: Timestamp Seconds Message
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Timestamp Seconds Message
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.timestamp_seconds_message, buffer(offset, 0))
    local index = odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.fields(buffer, offset, packet, parent)
  end
end
...
odx_odxsecuritytoken_pts_itch_v1_2.sequenced_message.dissect = function(buffer, offset, packet, parent, sequenced_message_type)
  ...
  if sequenced_message_type == "T" then
    return odx_odxsecuritytoken_pts_itch_v1_2.timestamp_seconds_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect System Event Message
...
-- Payload
odx_odxsecuritytoken_pts_itch_v1_2.payload = {}

-- Dissect: Payload
odx_odxsecuritytoken_pts_itch_v1_2.payload.dissect = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Debug Packet
  if packet_type == "+" then
...
-- Packet Header
odx_odxsecuritytoken_pts_itch_v1_2.packet_header = {}

-- Size: Packet Header
odx_odxsecuritytoken_pts_itch_v1_2.packet_header.size =
  odx_odxsecuritytoken_pts_itch_v1_2.packet_length.size + 
  odx_odxsecuritytoken_pts_itch_v1_2.packet_type.size

-- Display: Packet Header
odx_odxsecuritytoken_pts_itch_v1_2.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
odx_odxsecuritytoken_pts_itch_v1_2.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, packet_type = odx_odxsecuritytoken_pts_itch_v1_2.packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Packet Header
odx_odxsecuritytoken_pts_itch_v1_2.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.packet_header, buffer(offset, 0))
    local index = odx_odxsecuritytoken_pts_itch_v1_2.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = odx_odxsecuritytoken_pts_itch_v1_2.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return odx_odxsecuritytoken_pts_itch_v1_2.packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Soup Bin Tcp Packet
odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet = {}

-- Display: Soup Bin Tcp Packet
odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Soup Bin Tcp Packet
odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset

  -- Packet Header: Struct of 2 fields
  index, packet_header = odx_odxsecuritytoken_pts_itch_v1_2.packet_header.dissect(buffer, index, packet, parent)
...
odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset + size_of_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.soup_bin_tcp_packet then
    parent = parent:add(omi_odx_odxsecuritytoken_pts_itch_v1_2.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
    parent:set_len(size_of_soup_bin_tcp_packet)
    local display = odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
...
local soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < odx_odxsecuritytoken_pts_itch_v1_2.packet_header.size then
...
odx_odxsecuritytoken_pts_itch_v1_2.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = odx_odxsecuritytoken_pts_itch_v1_2.soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_soup_bin_tcp_packet)
    else
...
-- Register Odx OdxSecurityToken Pts Itch 1.2 on default port
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, omi_odx_odxsecuritytoken_pts_itch_v1_2)
