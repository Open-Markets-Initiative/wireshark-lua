...
jnx_equities_pts_itch_v1_7.messages.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
...
jnx_equities_pts_itch_v1_7.messages.dissect = function(buffer, offset, packet, parent, message_count)
  return jnx_equities_pts_itch_v1_7.messages.branches(buffer, offset, packet, parent, message_count)
end
