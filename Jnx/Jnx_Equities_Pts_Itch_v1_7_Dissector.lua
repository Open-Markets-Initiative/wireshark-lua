...
-- Dissect: Message
jnx_equities_pts_itch_v1_7.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_jnx_equities_pts_itch_v1_7.fields.message, range, display)
  end
