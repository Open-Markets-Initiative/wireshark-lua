...
-- Message Block
jnx_equities_pts_itch_v1_7.message_block = {}

-- Size: Message Block
jnx_equities_pts_itch_v1_7.message_block.size = function(buffer, offset, message_count)
  -- Size of Heartbeat
...
jnx_equities_pts_itch_v1_7.message_block.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
  end
...
jnx_equities_pts_itch_v1_7.message_block.dissect = function(buffer, offset, packet, parent, message_count)
  return jnx_equities_pts_itch_v1_7.message_block.branches(buffer, offset, packet, parent, message_count)
end
...
jnx_equities_pts_itch_v1_7.packet.dissect = function(buffer, packet, parent)
  ...
  index = jnx_equities_pts_itch_v1_7.message_block.dissect(buffer, index, packet, parent, message_count)
