...
jnx_equities_pts_ouch_v1_12_dissect.soup_bin_tcp_packet = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  ...
  if show.soup_bin_tcp_packet then
    parent = parent:add(jnx_equities_pts_ouch_v1_12.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = jnx_equities_pts_ouch_v1_12_dissect.soup_bin_tcp_packet_fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
