...
-- Jnx Equities Ouch Pts 1.12 Application Messages
...
-- Jnx Equities Ouch Pts 1.12 Session Messages
...
omi_jnx_equities_pts_ouch_v1_12.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_jnx_equities_pts_ouch_v1_12.prefs.show_session_messages = Pref.bool("Show Session Messages", show.session_messages, "Parse and add Session Messages to protocol tree")
...
function omi_jnx_equities_pts_ouch_v1_12.prefs_changed()
  ...
  if show.application_messages ~= omi_jnx_equities_pts_ouch_v1_12.prefs.show_application_messages then
    show.application_messages = omi_jnx_equities_pts_ouch_v1_12.prefs.show_application_messages
  end
  ...
  if show.session_messages ~= omi_jnx_equities_pts_ouch_v1_12.prefs.show_session_messages then
    show.session_messages = omi_jnx_equities_pts_ouch_v1_12.prefs.show_session_messages
  end
...
jnx_equities_pts_ouch_v1_12.unsequenced_data_packet.dissect = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  ...
  if show.session_messages then
    parent = parent:add(omi_jnx_equities_pts_ouch_v1_12.fields.unsequenced_data_packet, buffer(offset, 0))
    local current = jnx_equities_pts_ouch_v1_12.unsequenced_data_packet.fields(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
...
jnx_equities_pts_ouch_v1_12.sequenced_data_packet.dissect = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  local size_of_sequenced_data_packet = jnx_equities_pts_ouch_v1_12.sequenced_data_packet.size(buffer, offset)
  local index = offset + size_of_sequenced_data_packet

  -- Optionally add group/struct element to protocol tree
  if show.session_messages then
    parent = parent:add(omi_jnx_equities_pts_ouch_v1_12.fields.sequenced_data_packet, buffer(offset, 0))
    local current = jnx_equities_pts_ouch_v1_12.sequenced_data_packet.fields(buffer, offset, packet, parent, size_of_sequenced_data_packet)
