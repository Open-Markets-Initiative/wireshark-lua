...
jnx_equities_pts_ouch_v1_12_display.cancel_order_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.replace_order_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.enter_order_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.unsequenced_data_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.login_request_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.order_rejected_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.order_executed_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.order_aiq_canceled_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.order_canceled_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.order_replaced_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.order_accepted_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.system_event_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.sequenced_data_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.login_rejected_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.login_accepted_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.debug_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.packet_header = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_display.soup_bin_tcp_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_12_dissect.soup_bin_tcp_packet = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  ...
  if show.soup_bin_tcp_packet then
    local element = parent:add(jnx_equities_pts_ouch_v1_12.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = jnx_equities_pts_ouch_v1_12_dissect.soup_bin_tcp_packet_fields(buffer, offset, packet, element, size_of_soup_bin_tcp_packet)
    element:set_len(size_of_soup_bin_tcp_packet)
    local display = jnx_equities_pts_ouch_v1_12_display.soup_bin_tcp_packet(buffer, packet, element)
    element:append_text(display)
