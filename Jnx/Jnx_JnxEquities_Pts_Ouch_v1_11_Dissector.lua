...
local omi_jnx_jnxequities_pts_ouch_v1_11 = Proto("Jnx.JnxEquities.Pts.Ouch.v1.11.Lua", "Jnx JnxEquities Pts Ouch 1.11")
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.packet = ProtoField.new("Packet", "jnx.jnxequities.pts.ouch.v1.11.packet", ftypes.STRING)
omi_jnx_jnxequities_pts_ouch_v1_11.fields.packet_header = ProtoField.new("Packet Header", "jnx.jnxequities.pts.ouch.v1.11.packetheader", ftypes.STRING)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.packet_type = ProtoField.new("Packet Type", "jnx.jnxequities.pts.ouch.v1.11.packettype", ftypes.STRING)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "jnx.jnxequities.pts.ouch.v1.11.soupbintcppacket", ftypes.STRING)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.client_heartbeat_packet = ProtoField.new("Client Heartbeat Packet", "jnx.jnxequities.pts.ouch.v1.11.clientheartbeatpacket", ftypes.BYTES)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.end_of_session_packet = ProtoField.new("End Of Session Packet", "jnx.jnxequities.pts.ouch.v1.11.endofsessionpacket", ftypes.BYTES)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.logout_request_packet = ProtoField.new("Logout Request Packet", "jnx.jnxequities.pts.ouch.v1.11.logoutrequestpacket", ftypes.BYTES)
...
omi_jnx_jnxequities_pts_ouch_v1_11.fields.server_heartbeat_packet = ProtoField.new("Server Heartbeat Packet", "jnx.jnxequities.pts.ouch.v1.11.serverheartbeatpacket", ftypes.BYTES)
...
omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_soup_bin_tcp_packet = Pref.bool("Show Soup Bin Tcp Packet", show.soup_bin_tcp_packet, "Parse and add Soup Bin Tcp Packet to protocol tree")
...
function omi_jnx_jnxequities_pts_ouch_v1_11.prefs_changed()
  ...
  if show.packet ~= omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_packet then
    show.packet = omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_packet
  end
  if show.packet_header ~= omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_packet_header then
    show.packet_header = omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_packet_header
  end
  ...
  if show.soup_bin_tcp_packet ~= omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_soup_bin_tcp_packet then
    show.soup_bin_tcp_packet = omi_jnx_jnxequities_pts_ouch_v1_11.prefs.show_soup_bin_tcp_packet
  end
end
...
-- Packet Type
jnx_jnxequities_pts_ouch_v1_11.packet_type = {}

-- Size: Packet Type
jnx_jnxequities_pts_ouch_v1_11.packet_type.size = 1

-- Display: Packet Type
jnx_jnxequities_pts_ouch_v1_11.packet_type.display = function(value)
  if value == "+" then
...
-- Dissect: Packet Type
jnx_jnxequities_pts_ouch_v1_11.packet_type.dissect = function(buffer, offset, packet, parent)
  local length = jnx_jnxequities_pts_ouch_v1_11.packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_jnxequities_pts_ouch_v1_11.packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_jnx_jnxequities_pts_ouch_v1_11.fields.packet_type, range, value, display)
...
-- Display: Timestamp
jnx_jnxequities_pts_ouch_v1_11.timestamp.display = function(value)
...
-- Payload
jnx_jnxequities_pts_ouch_v1_11.payload = {}

-- Dissect: Payload
jnx_jnxequities_pts_ouch_v1_11.payload.dissect = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Debug Packet
  if packet_type == "+" then
...
-- Packet Header
jnx_jnxequities_pts_ouch_v1_11.packet_header = {}

-- Size: Packet Header
jnx_jnxequities_pts_ouch_v1_11.packet_header.size =
  jnx_jnxequities_pts_ouch_v1_11.packet_length.size + 
  jnx_jnxequities_pts_ouch_v1_11.packet_type.size

-- Display: Packet Header
jnx_jnxequities_pts_ouch_v1_11.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
jnx_jnxequities_pts_ouch_v1_11.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, packet_type = jnx_jnxequities_pts_ouch_v1_11.packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Packet Header
jnx_jnxequities_pts_ouch_v1_11.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_jnx_jnxequities_pts_ouch_v1_11.fields.packet_header, buffer(offset, 0))
    local index = jnx_jnxequities_pts_ouch_v1_11.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = jnx_jnxequities_pts_ouch_v1_11.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_jnxequities_pts_ouch_v1_11.packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Soup Bin Tcp Packet
jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet = {}

-- Display: Soup Bin Tcp Packet
jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Soup Bin Tcp Packet
jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset

  -- Packet Header: Struct of 2 fields
  index, packet_header = jnx_jnxequities_pts_ouch_v1_11.packet_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 10 branches
  index = jnx_jnxequities_pts_ouch_v1_11.payload.dissect(buffer, index, packet, parent, packet_type)

  return index
end

-- Dissect: Soup Bin Tcp Packet
jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset + size_of_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.soup_bin_tcp_packet then
    parent = parent:add(omi_jnx_jnxequities_pts_ouch_v1_11.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
    parent:set_len(size_of_soup_bin_tcp_packet)
    local display = jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
...
local soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < jnx_jnxequities_pts_ouch_v1_11.packet_header.size then
...
-- Packet
jnx_jnxequities_pts_ouch_v1_11.packet = {}

-- Verify required size of Tcp packet
jnx_jnxequities_pts_ouch_v1_11.packet.requiredsize = function(buffer)
  return buffer:len() >= jnx_jnxequities_pts_ouch_v1_11.packet_header.size
end

-- Dissect Packet
jnx_jnxequities_pts_ouch_v1_11.packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = jnx_jnxequities_pts_ouch_v1_11.soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_soup_bin_tcp_packet)
    else
...
function omi_jnx_jnxequities_pts_ouch_v1_11.dissector(buffer, packet, parent)
  ...
  return jnx_jnxequities_pts_ouch_v1_11.packet.dissect(buffer, packet, protocol)
end
...
local function omi_jnx_jnxequities_pts_ouch_v1_11_tcp_heuristic(buffer, packet, parent)
  ...
  if not jnx_jnxequities_pts_ouch_v1_11.packet.requiredsize(buffer) then return false end
...
-- Register Heuristic for Jnx JnxEquities Pts Ouch 1.11
omi_jnx_jnxequities_pts_ouch_v1_11:register_heuristic("tcp", omi_jnx_jnxequities_pts_ouch_v1_11_tcp_heuristic)

-- Register Jnx JnxEquities Pts Ouch 1.11 on default port
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, omi_jnx_jnxequities_pts_ouch_v1_11)
