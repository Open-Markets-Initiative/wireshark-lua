...
jnx_equities_pts_ouch_v1_11_display.cancel_order_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.cancel_order_message = function(buffer, offset, packet, parent)
  if show.cancel_order_message then
    ...
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.cancel_order_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.cancel_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.cancel_order_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.cancel_order_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.replace_order_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.replace_order_message = function(buffer, offset, packet, parent)
  if show.replace_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.replace_order_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.replace_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.replace_order_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.replace_order_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.enter_order_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.enter_order_message = function(buffer, offset, packet, parent)
  if show.enter_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.enter_order_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.enter_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.enter_order_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.enter_order_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Unsequenced Message
jnx_equities_pts_ouch_v1_11_size_of.unsequenced_message = function(buffer, offset, unsequenced_message_type)
...
jnx_equities_pts_ouch_v1_11_display.unsequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Unsequenced Message
jnx_equities_pts_ouch_v1_11_dissect.unsequenced_message_branches = function(buffer, offset, packet, parent, unsequenced_message_type)
  -- Dissect Enter Order Message
  if unsequenced_message_type == "O" then
...
jnx_equities_pts_ouch_v1_11_dissect.unsequenced_message = function(buffer, offset, packet, parent, unsequenced_message_type)
  ...
  local size = jnx_equities_pts_ouch_v1_11_size_of.unsequenced_message(buffer, offset, unsequenced_message_type)
  if size == 0 then
    return offset
  end
...
jnx_equities_pts_ouch_v1_11_size_of.unsequenced_message_type = 1

-- Display: Unsequenced Message Type
jnx_equities_pts_ouch_v1_11_display.unsequenced_message_type = function(value)
  if value == "O" then
...
jnx_equities_pts_ouch_v1_11_dissect.unsequenced_message_type = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11_size_of.unsequenced_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
jnx_equities_pts_ouch_v1_11_display.unsequenced_data_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.unsequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  ...
  index, unsequenced_message_type = jnx_equities_pts_ouch_v1_11_dissect.unsequenced_message_type(buffer, index, packet, parent)

  -- Unsequenced Message: Runtime Type with 3 branches
  index = jnx_equities_pts_ouch_v1_11_dissect.unsequenced_message(buffer, index, packet, parent, unsequenced_message_type)
...
jnx_equities_pts_ouch_v1_11_dissect.unsequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_unsequenced_data_packet = jnx_equities_pts_ouch_v1_11_size_of.unsequenced_data_packet(buffer, offset)
...
jnx_equities_pts_ouch_v1_11_display.login_request_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.login_request_packet = function(buffer, offset, packet, parent)
  if show.login_request_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.login_request_packet, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.login_request_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.login_request_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.login_request_packet_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.order_rejected_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.order_rejected_message = function(buffer, offset, packet, parent)
  if show.order_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.order_rejected_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.order_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.order_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.order_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.order_executed_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.order_executed_message = function(buffer, offset, packet, parent)
  if show.order_executed_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.order_executed_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.order_executed_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.order_executed_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.order_executed_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.order_aiq_canceled_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.order_aiq_canceled_message = function(buffer, offset, packet, parent)
  if show.order_aiq_canceled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.order_aiq_canceled_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.order_aiq_canceled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.order_aiq_canceled_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.order_aiq_canceled_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.order_canceled_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.order_canceled_message = function(buffer, offset, packet, parent)
  if show.order_canceled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.order_canceled_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.order_canceled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.order_canceled_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.order_canceled_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.order_replaced_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.order_replaced_message = function(buffer, offset, packet, parent)
  if show.order_replaced_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.order_replaced_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.order_replaced_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.order_replaced_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.order_replaced_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.order_accepted_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.order_accepted_message = function(buffer, offset, packet, parent)
  if show.order_accepted_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.order_accepted_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.order_accepted_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.order_accepted_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.order_accepted_message_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.system_event_message = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.system_event_message = function(buffer, offset, packet, parent)
  if show.system_event_message then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.system_event_message, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.system_event_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.system_event_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.system_event_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Sequenced Message
jnx_equities_pts_ouch_v1_11_size_of.sequenced_message = function(buffer, offset, sequenced_message_type)
...
jnx_equities_pts_ouch_v1_11_display.sequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Sequenced Message
jnx_equities_pts_ouch_v1_11_dissect.sequenced_message_branches = function(buffer, offset, packet, parent, sequenced_message_type)
  -- Dissect System Event Message
  if sequenced_message_type == "S" then
...
jnx_equities_pts_ouch_v1_11_dissect.sequenced_message = function(buffer, offset, packet, parent, sequenced_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = jnx_equities_pts_ouch_v1_11_size_of.sequenced_message(buffer, offset, sequenced_message_type)
  if size == 0 then
    return offset
  end
...
jnx_equities_pts_ouch_v1_11_size_of.sequenced_message_type = 1

-- Display: Sequenced Message Type
jnx_equities_pts_ouch_v1_11_display.sequenced_message_type = function(value)
  if value == "S" then
...
jnx_equities_pts_ouch_v1_11_dissect.sequenced_message_type = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11_size_of.sequenced_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
jnx_equities_pts_ouch_v1_11_display.sequenced_data_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.sequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  index, sequenced_message_type = jnx_equities_pts_ouch_v1_11_dissect.sequenced_message_type(buffer, index, packet, parent)

  -- Sequenced Message: Runtime Type with 7 branches
  index = jnx_equities_pts_ouch_v1_11_dissect.sequenced_message(buffer, index, packet, parent, sequenced_message_type)
...
jnx_equities_pts_ouch_v1_11_dissect.sequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_sequenced_data_packet = jnx_equities_pts_ouch_v1_11_size_of.sequenced_data_packet(buffer, offset)
...
jnx_equities_pts_ouch_v1_11_display.login_rejected_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.login_rejected_packet = function(buffer, offset, packet, parent)
  if show.login_rejected_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.login_rejected_packet, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.login_rejected_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.login_accepted_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.login_accepted_packet = function(buffer, offset, packet, parent)
  if show.login_accepted_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.login_accepted_packet, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.login_accepted_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.debug_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.debug_packet = function(buffer, offset, packet, parent)
  if show.debug_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.debug_packet, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.debug_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.debug_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.debug_packet_fields(buffer, offset, packet, element)
  end
end
...
jnx_equities_pts_ouch_v1_11_display.packet_header = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.packet_header = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.packet_header, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11_dissect.packet_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11_display.packet_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11_dissect.packet_header_fields(buffer, offset, packet, element)
  end
end

-- Display: Soup Bin Tcp Packet
jnx_equities_pts_ouch_v1_11_display.soup_bin_tcp_packet = function(packet, parent, length)
  return ""
end
...
jnx_equities_pts_ouch_v1_11_dissect.soup_bin_tcp_packet = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  ...
  if show.soup_bin_tcp_packet then
    local element = parent:add(jnx_equities_pts_ouch_v1_11.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = jnx_equities_pts_ouch_v1_11_dissect.soup_bin_tcp_packet_fields(buffer, offset, packet, element, size_of_soup_bin_tcp_packet)
    element:set_len(size_of_soup_bin_tcp_packet)
    local display = jnx_equities_pts_ouch_v1_11_display.soup_bin_tcp_packet(buffer, packet, element)
    element:append_text(display)
