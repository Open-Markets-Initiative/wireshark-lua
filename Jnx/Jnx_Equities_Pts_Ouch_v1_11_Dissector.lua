...
-- Protocol table
local jnx_equities_pts_ouch_v1_11 = {}
...
-- Quantity
jnx_equities_pts_ouch_v1_11.quantity = {}

-- Size: Quantity
jnx_equities_pts_ouch_v1_11.quantity.size = 4

-- Display: Quantity
jnx_equities_pts_ouch_v1_11.quantity.display = function(value)
  return "Quantity: "..value
end

-- Dissect: Quantity
jnx_equities_pts_ouch_v1_11.quantity.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.quantity.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.quantity.display(value, buffer, offset, packet, parent)
...
-- Order Token
jnx_equities_pts_ouch_v1_11.order_token = {}

-- Size: Order Token
jnx_equities_pts_ouch_v1_11.order_token.size = 4

-- Display: Order Token
jnx_equities_pts_ouch_v1_11.order_token.display = function(value)
  return "Order Token: "..value
end

-- Dissect: Order Token
jnx_equities_pts_ouch_v1_11.order_token.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.order_token.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.order_token.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.cancel_order_message = {}

-- Calculate size of: Cancel Order Message
jnx_equities_pts_ouch_v1_11.cancel_order_message.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.order_token.size

  index = index + jnx_equities_pts_ouch_v1_11.quantity.size

  return index
end

-- Display: Cancel Order Message
jnx_equities_pts_ouch_v1_11.cancel_order_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Order Message
jnx_equities_pts_ouch_v1_11.cancel_order_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Order Token: 4 Byte Unsigned Fixed Width Integer
  index, order_token = jnx_equities_pts_ouch_v1_11.order_token.dissect(buffer, index, packet, parent)

  -- Quantity: 4 Byte Unsigned Fixed Width Integer
  index, quantity = jnx_equities_pts_ouch_v1_11.quantity.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.cancel_order_message.dissect = function(buffer, offset, packet, parent)
  if show.cancel_order_message then
    ...
    local display = jnx_equities_pts_ouch_v1_11.cancel_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.cancel_order_message.fields(buffer, offset, packet, parent)
  end
end

-- Minimum Quantity
jnx_equities_pts_ouch_v1_11.minimum_quantity = {}

-- Size: Minimum Quantity
jnx_equities_pts_ouch_v1_11.minimum_quantity.size = 4

-- Display: Minimum Quantity
jnx_equities_pts_ouch_v1_11.minimum_quantity.display = function(value)
  return "Minimum Quantity: "..value
end

-- Dissect: Minimum Quantity
jnx_equities_pts_ouch_v1_11.minimum_quantity.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.minimum_quantity.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.minimum_quantity.display(value, buffer, offset, packet, parent)
...
-- Display
jnx_equities_pts_ouch_v1_11.display = {}

-- Size: Display
jnx_equities_pts_ouch_v1_11.display.size = 1

-- Display: Display
jnx_equities_pts_ouch_v1_11.display.display = function(value)
  if value == " " then
...
-- Dissect: Display
jnx_equities_pts_ouch_v1_11.display.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.display.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.display.display(value, buffer, offset, packet, parent)
...
-- Time In Force
jnx_equities_pts_ouch_v1_11.time_in_force = {}

-- Size: Time In Force
jnx_equities_pts_ouch_v1_11.time_in_force.size = 4

-- Display: Time In Force
jnx_equities_pts_ouch_v1_11.time_in_force.display = function(value)
  if value == 0 then
...
jnx_equities_pts_ouch_v1_11.time_in_force.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.time_in_force.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.time_in_force.display(value, buffer, offset, packet, parent)
...
-- Price
jnx_equities_pts_ouch_v1_11.price = {}

-- Size: Price
jnx_equities_pts_ouch_v1_11.price.size = 4

-- Display: Price
jnx_equities_pts_ouch_v1_11.price.display = function(value)
  return "Price: "..value
end

-- Translate: Price
jnx_equities_pts_ouch_v1_11.price.translate = function(raw)
  return raw/10
end

-- Dissect: Price
jnx_equities_pts_ouch_v1_11.price.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.price.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = jnx_equities_pts_ouch_v1_11.price.translate(raw)
  local display = jnx_equities_pts_ouch_v1_11.price.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.replacement_order_token = {}

-- Size: Replacement Order Token
jnx_equities_pts_ouch_v1_11.replacement_order_token.size = 4

-- Display: Replacement Order Token
jnx_equities_pts_ouch_v1_11.replacement_order_token.display = function(value)
  return "Replacement Order Token: "..value
end

-- Dissect: Replacement Order Token
jnx_equities_pts_ouch_v1_11.replacement_order_token.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.replacement_order_token.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.replacement_order_token.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.existing_order_token = {}

-- Size: Existing Order Token
jnx_equities_pts_ouch_v1_11.existing_order_token.size = 4

-- Display: Existing Order Token
jnx_equities_pts_ouch_v1_11.existing_order_token.display = function(value)
  return "Existing Order Token: "..value
end

-- Dissect: Existing Order Token
jnx_equities_pts_ouch_v1_11.existing_order_token.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.existing_order_token.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.existing_order_token.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.replace_order_message = {}

-- Calculate size of: Replace Order Message
jnx_equities_pts_ouch_v1_11.replace_order_message.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.existing_order_token.size

  index = index + jnx_equities_pts_ouch_v1_11.replacement_order_token.size

  index = index + jnx_equities_pts_ouch_v1_11.quantity.size

  index = index + jnx_equities_pts_ouch_v1_11.price.size

  index = index + jnx_equities_pts_ouch_v1_11.time_in_force.size

  index = index + jnx_equities_pts_ouch_v1_11.display.size

  index = index + jnx_equities_pts_ouch_v1_11.minimum_quantity.size

  return index
end

-- Display: Replace Order Message
jnx_equities_pts_ouch_v1_11.replace_order_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replace Order Message
jnx_equities_pts_ouch_v1_11.replace_order_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Existing Order Token: 4 Byte Unsigned Fixed Width Integer
  index, existing_order_token = jnx_equities_pts_ouch_v1_11.existing_order_token.dissect(buffer, index, packet, parent)

  -- Replacement Order Token: 4 Byte Unsigned Fixed Width Integer
  index, replacement_order_token = jnx_equities_pts_ouch_v1_11.replacement_order_token.dissect(buffer, index, packet, parent)

  -- Quantity: 4 Byte Unsigned Fixed Width Integer
  index, quantity = jnx_equities_pts_ouch_v1_11.quantity.dissect(buffer, index, packet, parent)

  -- Price: 4 Byte Unsigned Fixed Width Integer
  index, price = jnx_equities_pts_ouch_v1_11.price.dissect(buffer, index, packet, parent)

  -- Time In Force: 4 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, time_in_force = jnx_equities_pts_ouch_v1_11.time_in_force.dissect(buffer, index, packet, parent)

  -- Display: 1 Byte Ascii String Enum with 2 values
  index, display = jnx_equities_pts_ouch_v1_11.display.dissect(buffer, index, packet, parent)

  -- Minimum Quantity: 4 Byte Unsigned Fixed Width Integer
  index, minimum_quantity = jnx_equities_pts_ouch_v1_11.minimum_quantity.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.replace_order_message.dissect = function(buffer, offset, packet, parent)
  if show.replace_order_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.replace_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.replace_order_message.fields(buffer, offset, packet, parent)
  end
end

-- Cash Margin Type
jnx_equities_pts_ouch_v1_11.cash_margin_type = {}

-- Size: Cash Margin Type
jnx_equities_pts_ouch_v1_11.cash_margin_type.size = 1

-- Display: Cash Margin Type
jnx_equities_pts_ouch_v1_11.cash_margin_type.display = function(value)
  if value == "1" then
...
jnx_equities_pts_ouch_v1_11.cash_margin_type.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.cash_margin_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.cash_margin_type.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_classification = {}

-- Size: Order Classification
jnx_equities_pts_ouch_v1_11.order_classification.size = 1

-- Display: Order Classification
jnx_equities_pts_ouch_v1_11.order_classification.display = function(value)
  if value == "1" then
...
jnx_equities_pts_ouch_v1_11.order_classification.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.order_classification.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.order_classification.display(value, buffer, offset, packet, parent)
...
-- Capacity
jnx_equities_pts_ouch_v1_11.capacity = {}

-- Size: Capacity
jnx_equities_pts_ouch_v1_11.capacity.size = 1

-- Display: Capacity
jnx_equities_pts_ouch_v1_11.capacity.display = function(value)
  if value == "A" then
...
-- Dissect: Capacity
jnx_equities_pts_ouch_v1_11.capacity.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.capacity.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.capacity.display(value, buffer, offset, packet, parent)
...
-- Firm Id
jnx_equities_pts_ouch_v1_11.firm_id = {}

-- Size: Firm Id
jnx_equities_pts_ouch_v1_11.firm_id.size = 4

-- Display: Firm Id
jnx_equities_pts_ouch_v1_11.firm_id.display = function(value)
  return "Firm Id: "..value
end

-- Dissect: Firm Id
jnx_equities_pts_ouch_v1_11.firm_id.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.firm_id.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.firm_id.display(value, buffer, offset, packet, parent)
...
-- Group
jnx_equities_pts_ouch_v1_11.group = {}

-- Size: Group
jnx_equities_pts_ouch_v1_11.group.size = 4

-- Display: Group
jnx_equities_pts_ouch_v1_11.group.display = function(value)
  if value == "DAY" then
...
-- Dissect: Group
jnx_equities_pts_ouch_v1_11.group.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.group.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = jnx_equities_pts_ouch_v1_11.group.display(value, buffer, offset, packet, parent)
...
-- Orderbook Id
jnx_equities_pts_ouch_v1_11.orderbook_id = {}

-- Size: Orderbook Id
jnx_equities_pts_ouch_v1_11.orderbook_id.size = 4

-- Display: Orderbook Id
jnx_equities_pts_ouch_v1_11.orderbook_id.display = function(value)
  return "Orderbook Id: "..value
end

-- Dissect: Orderbook Id
jnx_equities_pts_ouch_v1_11.orderbook_id.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.orderbook_id.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.orderbook_id.display(value, buffer, offset, packet, parent)
...
-- Buy Sell Indicator
jnx_equities_pts_ouch_v1_11.buy_sell_indicator = {}

-- Size: Buy Sell Indicator
jnx_equities_pts_ouch_v1_11.buy_sell_indicator.size = 1

-- Display: Buy Sell Indicator
jnx_equities_pts_ouch_v1_11.buy_sell_indicator.display = function(value)
  if value == "B" then
...
jnx_equities_pts_ouch_v1_11.buy_sell_indicator.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.buy_sell_indicator.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.buy_sell_indicator.display(value, buffer, offset, packet, parent)
...
-- Client Reference
jnx_equities_pts_ouch_v1_11.client_reference = {}

-- Size: Client Reference
jnx_equities_pts_ouch_v1_11.client_reference.size = 10

-- Display: Client Reference
jnx_equities_pts_ouch_v1_11.client_reference.display = function(value)
  return "Client Reference: "..value
end

-- Dissect: Client Reference
jnx_equities_pts_ouch_v1_11.client_reference.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.client_reference.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = jnx_equities_pts_ouch_v1_11.client_reference.display(value, buffer, offset, packet, parent)
...
-- Enter Order Message
jnx_equities_pts_ouch_v1_11.enter_order_message = {}

-- Calculate size of: Enter Order Message
jnx_equities_pts_ouch_v1_11.enter_order_message.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.order_token.size

  index = index + jnx_equities_pts_ouch_v1_11.client_reference.size

  index = index + jnx_equities_pts_ouch_v1_11.buy_sell_indicator.size

  index = index + jnx_equities_pts_ouch_v1_11.quantity.size

  index = index + jnx_equities_pts_ouch_v1_11.orderbook_id.size

  index = index + jnx_equities_pts_ouch_v1_11.group.size

  index = index + jnx_equities_pts_ouch_v1_11.price.size

  index = index + jnx_equities_pts_ouch_v1_11.time_in_force.size

  index = index + jnx_equities_pts_ouch_v1_11.firm_id.size

  index = index + jnx_equities_pts_ouch_v1_11.display.size

  index = index + jnx_equities_pts_ouch_v1_11.capacity.size

  index = index + jnx_equities_pts_ouch_v1_11.minimum_quantity.size

  index = index + jnx_equities_pts_ouch_v1_11.order_classification.size

  index = index + jnx_equities_pts_ouch_v1_11.cash_margin_type.size

  return index
end

-- Display: Enter Order Message
jnx_equities_pts_ouch_v1_11.enter_order_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Enter Order Message
jnx_equities_pts_ouch_v1_11.enter_order_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_reference = jnx_equities_pts_ouch_v1_11.client_reference.dissect(buffer, index, packet, parent)

  -- Buy Sell Indicator: 1 Byte Ascii String Enum with 4 values
  index, buy_sell_indicator = jnx_equities_pts_ouch_v1_11.buy_sell_indicator.dissect(buffer, index, packet, parent)

  -- Quantity: 4 Byte Unsigned Fixed Width Integer
  index, quantity = jnx_equities_pts_ouch_v1_11.quantity.dissect(buffer, index, packet, parent)

  -- Orderbook Id: 4 Byte Unsigned Fixed Width Integer
  index, orderbook_id = jnx_equities_pts_ouch_v1_11.orderbook_id.dissect(buffer, index, packet, parent)

  -- Group: 4 Byte Ascii String Enum with 4 values
  index, group = jnx_equities_pts_ouch_v1_11.group.dissect(buffer, index, packet, parent)
  ...
  index, firm_id = jnx_equities_pts_ouch_v1_11.firm_id.dissect(buffer, index, packet, parent)

  -- Display: 1 Byte Ascii String Enum with 2 values
  index, display = jnx_equities_pts_ouch_v1_11.display.dissect(buffer, index, packet, parent)

  -- Capacity: 1 Byte Ascii String Enum with 2 values
  index, capacity = jnx_equities_pts_ouch_v1_11.capacity.dissect(buffer, index, packet, parent)

  -- Minimum Quantity: 4 Byte Unsigned Fixed Width Integer
  index, minimum_quantity = jnx_equities_pts_ouch_v1_11.minimum_quantity.dissect(buffer, index, packet, parent)

  -- Order Classification: 1 Byte Ascii String Enum with 5 values
  index, order_classification = jnx_equities_pts_ouch_v1_11.order_classification.dissect(buffer, index, packet, parent)

  -- Cash Margin Type: 1 Byte Ascii String Enum with 5 values
  index, cash_margin_type = jnx_equities_pts_ouch_v1_11.cash_margin_type.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.enter_order_message.dissect = function(buffer, offset, packet, parent)
  if show.enter_order_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.enter_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.enter_order_message.fields(buffer, offset, packet, parent)
  end
end
...
jnx_equities_pts_ouch_v1_11.unsequenced_message.size = function(buffer, offset, unsequenced_message_type)
  ...
  if unsequenced_message_type == "O" then
    return jnx_equities_pts_ouch_v1_11.enter_order_message.size(buffer, offset)
  end
  -- Size of Replace Order Message
  if unsequenced_message_type == "U" then
    return jnx_equities_pts_ouch_v1_11.replace_order_message.size(buffer, offset)
  end
  -- Size of Cancel Order Message
  if unsequenced_message_type == "X" then
    return jnx_equities_pts_ouch_v1_11.cancel_order_message.size(buffer, offset)
  end
...
jnx_equities_pts_ouch_v1_11.unsequenced_message.branches = function(buffer, offset, packet, parent, unsequenced_message_type)
  ...
  -- Dissect Replace Order Message
  if unsequenced_message_type == "U" then
    return jnx_equities_pts_ouch_v1_11.replace_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cancel Order Message
  if unsequenced_message_type == "X" then
    return jnx_equities_pts_ouch_v1_11.cancel_order_message.dissect(buffer, offset, packet, parent)
  end
...
jnx_equities_pts_ouch_v1_11.unsequenced_message_type = {}

-- Size: Unsequenced Message Type
jnx_equities_pts_ouch_v1_11.unsequenced_message_type.size = 1

-- Display: Unsequenced Message Type
jnx_equities_pts_ouch_v1_11.unsequenced_message_type.display = function(value)
  if value == "O" then
...
jnx_equities_pts_ouch_v1_11.unsequenced_message_type.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.unsequenced_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.unsequenced_message_type.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.unsequenced_data_packet = {}

-- Read runtime size of: Unsequenced Data Packet
jnx_equities_pts_ouch_v1_11.unsequenced_data_packet.size = function(buffer, offset)
  local index = offset
...
jnx_equities_pts_ouch_v1_11.unsequenced_data_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Unsequenced Data Packet
jnx_equities_pts_ouch_v1_11.unsequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  local index = offset

  -- Unsequenced Message Type: 1 Byte Ascii String Enum with 3 values
  index, unsequenced_message_type = jnx_equities_pts_ouch_v1_11.unsequenced_message_type.dissect(buffer, index, packet, parent)

  -- Unsequenced Message: Runtime Type with 3 branches
  index = jnx_equities_pts_ouch_v1_11.unsequenced_message.dissect(buffer, index, packet, parent, unsequenced_message_type)
...
jnx_equities_pts_ouch_v1_11.requested_sequence_number = {}

-- Size: Requested Sequence Number
jnx_equities_pts_ouch_v1_11.requested_sequence_number.size = 20

-- Display: Requested Sequence Number
jnx_equities_pts_ouch_v1_11.requested_sequence_number.display = function(value)
  return "Requested Sequence Number: "..value
end

-- Dissect: Requested Sequence Number
jnx_equities_pts_ouch_v1_11.requested_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.requested_sequence_number.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.requested_sequence_number.display(value, buffer, offset, packet, parent)
...
-- Requested Session
jnx_equities_pts_ouch_v1_11.requested_session = {}

-- Size: Requested Session
jnx_equities_pts_ouch_v1_11.requested_session.size = 10

-- Display: Requested Session
jnx_equities_pts_ouch_v1_11.requested_session.display = function(value)
  return "Requested Session: "..value
end

-- Dissect: Requested Session
jnx_equities_pts_ouch_v1_11.requested_session.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.requested_session.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.requested_session.display(value, buffer, offset, packet, parent)
...
-- Password
jnx_equities_pts_ouch_v1_11.password = {}

-- Size: Password
jnx_equities_pts_ouch_v1_11.password.size = 10

-- Display: Password
jnx_equities_pts_ouch_v1_11.password.display = function(value)
  return "Password: "..value
end

-- Dissect: Password
jnx_equities_pts_ouch_v1_11.password.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.password.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.password.display(value, buffer, offset, packet, parent)
...
-- Username
jnx_equities_pts_ouch_v1_11.username = {}

-- Size: Username
jnx_equities_pts_ouch_v1_11.username.size = 6

-- Display: Username
jnx_equities_pts_ouch_v1_11.username.display = function(value)
  return "Username: "..value
end

-- Dissect: Username
jnx_equities_pts_ouch_v1_11.username.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.username.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.username.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.login_request_packet = {}

-- Calculate size of: Login Request Packet
jnx_equities_pts_ouch_v1_11.login_request_packet.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.username.size

  index = index + jnx_equities_pts_ouch_v1_11.password.size

  index = index + jnx_equities_pts_ouch_v1_11.requested_session.size

  index = index + jnx_equities_pts_ouch_v1_11.requested_sequence_number.size

  return index
end

-- Display: Login Request Packet
jnx_equities_pts_ouch_v1_11.login_request_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Request Packet
jnx_equities_pts_ouch_v1_11.login_request_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Username: 6 Byte Ascii String
  index, username = jnx_equities_pts_ouch_v1_11.username.dissect(buffer, index, packet, parent)

  -- Password: 10 Byte Ascii String
  index, password = jnx_equities_pts_ouch_v1_11.password.dissect(buffer, index, packet, parent)

  -- Requested Session: 10 Byte Ascii String
  index, requested_session = jnx_equities_pts_ouch_v1_11.requested_session.dissect(buffer, index, packet, parent)

  -- Requested Sequence Number: 20 Byte Ascii String
  index, requested_sequence_number = jnx_equities_pts_ouch_v1_11.requested_sequence_number.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.login_request_packet.dissect = function(buffer, offset, packet, parent)
  if show.login_request_packet then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.login_request_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.login_request_packet.fields(buffer, offset, packet, parent)
  end
end

-- Order Rejected Reason
jnx_equities_pts_ouch_v1_11.order_rejected_reason = {}

-- Size: Order Rejected Reason
jnx_equities_pts_ouch_v1_11.order_rejected_reason.size = 1

-- Display: Order Rejected Reason
jnx_equities_pts_ouch_v1_11.order_rejected_reason.display = function(value)
  if value == "H" then
...
jnx_equities_pts_ouch_v1_11.order_rejected_reason.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.order_rejected_reason.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.order_rejected_reason.display(value, buffer, offset, packet, parent)
...
-- Timestamp
jnx_equities_pts_ouch_v1_11.timestamp = {}

-- Size: Timestamp
jnx_equities_pts_ouch_v1_11.timestamp.size = 8

-- Display: Timestamp
jnx_equities_pts_ouch_v1_11.timestamp.display = function(value)
  return "Timestamp: "..value
end

-- Dissect: Timestamp
jnx_equities_pts_ouch_v1_11.timestamp.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.timestamp.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = jnx_equities_pts_ouch_v1_11.timestamp.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_rejected_message = {}

-- Calculate size of: Order Rejected Message
jnx_equities_pts_ouch_v1_11.order_rejected_message.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.timestamp.size

  index = index + jnx_equities_pts_ouch_v1_11.order_token.size

  index = index + jnx_equities_pts_ouch_v1_11.order_rejected_reason.size

  return index
end

-- Display: Order Rejected Message
jnx_equities_pts_ouch_v1_11.order_rejected_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Rejected Message
jnx_equities_pts_ouch_v1_11.order_rejected_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Timestamp: 8 Byte Unsigned Fixed Width Integer
  index, timestamp = jnx_equities_pts_ouch_v1_11.timestamp.dissect(buffer, index, packet, parent)

  -- Order Token: 4 Byte Unsigned Fixed Width Integer
  index, order_token = jnx_equities_pts_ouch_v1_11.order_token.dissect(buffer, index, packet, parent)

  -- Order Rejected Reason: 1 Byte Ascii String Enum with 15 values
  index, order_rejected_reason = jnx_equities_pts_ouch_v1_11.order_rejected_reason.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_rejected_message.dissect = function(buffer, offset, packet, parent)
  if show.order_rejected_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.order_rejected_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.order_rejected_message.fields(buffer, offset, packet, parent)
  end
end

-- Match Number
jnx_equities_pts_ouch_v1_11.match_number = {}

-- Size: Match Number
jnx_equities_pts_ouch_v1_11.match_number.size = 8

-- Display: Match Number
jnx_equities_pts_ouch_v1_11.match_number.display = function(value)
  return "Match Number: "..value
end

-- Dissect: Match Number
jnx_equities_pts_ouch_v1_11.match_number.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.match_number.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = jnx_equities_pts_ouch_v1_11.match_number.display(value, buffer, offset, packet, parent)
...
-- Liquidity Indicator
jnx_equities_pts_ouch_v1_11.liquidity_indicator = {}

-- Size: Liquidity Indicator
jnx_equities_pts_ouch_v1_11.liquidity_indicator.size = 1

-- Display: Liquidity Indicator
jnx_equities_pts_ouch_v1_11.liquidity_indicator.display = function(value)
  if value == "A" then
...
jnx_equities_pts_ouch_v1_11.liquidity_indicator.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.liquidity_indicator.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.liquidity_indicator.display(value, buffer, offset, packet, parent)
...
-- Execution Price
jnx_equities_pts_ouch_v1_11.execution_price = {}

-- Size: Execution Price
jnx_equities_pts_ouch_v1_11.execution_price.size = 4

-- Display: Execution Price
jnx_equities_pts_ouch_v1_11.execution_price.display = function(value)
  return "Execution Price: "..value
end

-- Translate: Execution Price
jnx_equities_pts_ouch_v1_11.execution_price.translate = function(raw)
  return raw/10
end

-- Dissect: Execution Price
jnx_equities_pts_ouch_v1_11.execution_price.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.execution_price.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = jnx_equities_pts_ouch_v1_11.execution_price.translate(raw)
  local display = jnx_equities_pts_ouch_v1_11.execution_price.display(value, buffer, offset, packet, parent)
...
-- Executed Quantity
jnx_equities_pts_ouch_v1_11.executed_quantity = {}

-- Size: Executed Quantity
jnx_equities_pts_ouch_v1_11.executed_quantity.size = 4

-- Display: Executed Quantity
jnx_equities_pts_ouch_v1_11.executed_quantity.display = function(value)
  return "Executed Quantity: "..value
end

-- Dissect: Executed Quantity
jnx_equities_pts_ouch_v1_11.executed_quantity.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.executed_quantity.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.executed_quantity.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_executed_message = {}

-- Calculate size of: Order Executed Message
jnx_equities_pts_ouch_v1_11.order_executed_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + jnx_equities_pts_ouch_v1_11.executed_quantity.size

  index = index + jnx_equities_pts_ouch_v1_11.execution_price.size

  index = index + jnx_equities_pts_ouch_v1_11.liquidity_indicator.size

  index = index + jnx_equities_pts_ouch_v1_11.match_number.size

  return index
end

-- Display: Order Executed Message
jnx_equities_pts_ouch_v1_11.order_executed_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Executed Message
jnx_equities_pts_ouch_v1_11.order_executed_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, executed_quantity = jnx_equities_pts_ouch_v1_11.executed_quantity.dissect(buffer, index, packet, parent)

  -- Execution Price: 4 Byte Unsigned Fixed Width Integer
  index, execution_price = jnx_equities_pts_ouch_v1_11.execution_price.dissect(buffer, index, packet, parent)

  -- Liquidity Indicator: 1 Byte Ascii String Enum with 2 values
  index, liquidity_indicator = jnx_equities_pts_ouch_v1_11.liquidity_indicator.dissect(buffer, index, packet, parent)

  -- Match Number: 8 Byte Unsigned Fixed Width Integer
  index, match_number = jnx_equities_pts_ouch_v1_11.match_number.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_executed_message.dissect = function(buffer, offset, packet, parent)
  if show.order_executed_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.order_executed_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.order_executed_message.fields(buffer, offset, packet, parent)
  end
end

-- Quantity Prevented From Trading
jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading = {}

-- Size: Quantity Prevented From Trading
jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading.size = 4

-- Display: Quantity Prevented From Trading
jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading.display = function(value)
  return "Quantity Prevented From Trading: "..value
end

-- Dissect: Quantity Prevented From Trading
jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_canceled_reason = {}

-- Size: Order Canceled Reason
jnx_equities_pts_ouch_v1_11.order_canceled_reason.size = 1

-- Display: Order Canceled Reason
jnx_equities_pts_ouch_v1_11.order_canceled_reason.display = function(value)
  if value == "U" then
...
jnx_equities_pts_ouch_v1_11.order_canceled_reason.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.order_canceled_reason.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.order_canceled_reason.display(value, buffer, offset, packet, parent)
...
-- Decrement Quantity
jnx_equities_pts_ouch_v1_11.decrement_quantity = {}

-- Size: Decrement Quantity
jnx_equities_pts_ouch_v1_11.decrement_quantity.size = 4

-- Display: Decrement Quantity
jnx_equities_pts_ouch_v1_11.decrement_quantity.display = function(value)
  return "Decrement Quantity: "..value
end

-- Dissect: Decrement Quantity
jnx_equities_pts_ouch_v1_11.decrement_quantity.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.decrement_quantity.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.decrement_quantity.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message = {}

-- Calculate size of: Order Aiq Canceled Message
jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + jnx_equities_pts_ouch_v1_11.decrement_quantity.size

  index = index + jnx_equities_pts_ouch_v1_11.order_canceled_reason.size

  index = index + jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading.size
...
jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Aiq Canceled Message
jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, decrement_quantity = jnx_equities_pts_ouch_v1_11.decrement_quantity.dissect(buffer, index, packet, parent)

  -- Order Canceled Reason: 1 Byte Ascii String Enum with 16 values
  index, order_canceled_reason = jnx_equities_pts_ouch_v1_11.order_canceled_reason.dissect(buffer, index, packet, parent)

  -- Quantity Prevented From Trading: 4 Byte Unsigned Fixed Width Integer
  index, quantity_prevented_from_trading = jnx_equities_pts_ouch_v1_11.quantity_prevented_from_trading.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.dissect = function(buffer, offset, packet, parent)
  if show.order_aiq_canceled_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Canceled Message
jnx_equities_pts_ouch_v1_11.order_canceled_message = {}

-- Calculate size of: Order Canceled Message
jnx_equities_pts_ouch_v1_11.order_canceled_message.size = function(buffer, offset)
  local index = 0
...
jnx_equities_pts_ouch_v1_11.order_canceled_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Canceled Message
jnx_equities_pts_ouch_v1_11.order_canceled_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
jnx_equities_pts_ouch_v1_11.order_canceled_message.dissect = function(buffer, offset, packet, parent)
  if show.order_canceled_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.order_canceled_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.order_canceled_message.fields(buffer, offset, packet, parent)
  end
end

-- Previous Order Token
jnx_equities_pts_ouch_v1_11.previous_order_token = {}

-- Size: Previous Order Token
jnx_equities_pts_ouch_v1_11.previous_order_token.size = 4

-- Display: Previous Order Token
jnx_equities_pts_ouch_v1_11.previous_order_token.display = function(value)
  return "Previous Order Token: "..value
end

-- Dissect: Previous Order Token
jnx_equities_pts_ouch_v1_11.previous_order_token.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.previous_order_token.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.previous_order_token.display(value, buffer, offset, packet, parent)
...
-- Order State
jnx_equities_pts_ouch_v1_11.order_state = {}

-- Size: Order State
jnx_equities_pts_ouch_v1_11.order_state.size = 1

-- Display: Order State
jnx_equities_pts_ouch_v1_11.order_state.display = function(value)
  if value == "L" then
...
-- Dissect: Order State
jnx_equities_pts_ouch_v1_11.order_state.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.order_state.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.order_state.display(value, buffer, offset, packet, parent)
...
-- Order Number
jnx_equities_pts_ouch_v1_11.order_number = {}

-- Size: Order Number
jnx_equities_pts_ouch_v1_11.order_number.size = 8

-- Display: Order Number
jnx_equities_pts_ouch_v1_11.order_number.display = function(value)
  return "Order Number: "..value
end

-- Dissect: Order Number
jnx_equities_pts_ouch_v1_11.order_number.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.order_number.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = jnx_equities_pts_ouch_v1_11.order_number.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_replaced_message = {}

-- Calculate size of: Order Replaced Message
jnx_equities_pts_ouch_v1_11.order_replaced_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + jnx_equities_pts_ouch_v1_11.order_number.size

  index = index + jnx_equities_pts_ouch_v1_11.minimum_quantity.size

  index = index + jnx_equities_pts_ouch_v1_11.order_state.size

  index = index + jnx_equities_pts_ouch_v1_11.previous_order_token.size

  return index
end

-- Display: Order Replaced Message
jnx_equities_pts_ouch_v1_11.order_replaced_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Replaced Message
jnx_equities_pts_ouch_v1_11.order_replaced_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_number = jnx_equities_pts_ouch_v1_11.order_number.dissect(buffer, index, packet, parent)

  -- Minimum Quantity: 4 Byte Unsigned Fixed Width Integer
  index, minimum_quantity = jnx_equities_pts_ouch_v1_11.minimum_quantity.dissect(buffer, index, packet, parent)

  -- Order State: 1 Byte Ascii String Enum with 2 values
  index, order_state = jnx_equities_pts_ouch_v1_11.order_state.dissect(buffer, index, packet, parent)

  -- Previous Order Token: 4 Byte Unsigned Fixed Width Integer
  index, previous_order_token = jnx_equities_pts_ouch_v1_11.previous_order_token.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.order_replaced_message.dissect = function(buffer, offset, packet, parent)
  if show.order_replaced_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.order_replaced_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.order_replaced_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Accepted Message
jnx_equities_pts_ouch_v1_11.order_accepted_message = {}

-- Calculate size of: Order Accepted Message
jnx_equities_pts_ouch_v1_11.order_accepted_message.size = function(buffer, offset)
  local index = 0
...
jnx_equities_pts_ouch_v1_11.order_accepted_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Accepted Message
jnx_equities_pts_ouch_v1_11.order_accepted_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
jnx_equities_pts_ouch_v1_11.order_accepted_message.dissect = function(buffer, offset, packet, parent)
  if show.order_accepted_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.order_accepted_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.order_accepted_message.fields(buffer, offset, packet, parent)
  end
end

-- System Event
jnx_equities_pts_ouch_v1_11.system_event = {}

-- Size: System Event
jnx_equities_pts_ouch_v1_11.system_event.size = 1

-- Display: System Event
jnx_equities_pts_ouch_v1_11.system_event.display = function(value)
  if value == "S" then
...
jnx_equities_pts_ouch_v1_11.system_event.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.system_event.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.system_event.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.system_event_message = {}

-- Calculate size of: System Event Message
jnx_equities_pts_ouch_v1_11.system_event_message.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.timestamp.size

  index = index + jnx_equities_pts_ouch_v1_11.system_event.size

  return index
end

-- Display: System Event Message
jnx_equities_pts_ouch_v1_11.system_event_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: System Event Message
jnx_equities_pts_ouch_v1_11.system_event_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, system_event = jnx_equities_pts_ouch_v1_11.system_event.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.system_event_message.dissect = function(buffer, offset, packet, parent)
  if show.system_event_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.system_event_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.system_event_message.fields(buffer, offset, packet, parent)
  end
end
...
jnx_equities_pts_ouch_v1_11.sequenced_message.size = function(buffer, offset, sequenced_message_type)
  ...
  if sequenced_message_type == "S" then
    return jnx_equities_pts_ouch_v1_11.system_event_message.size(buffer, offset)
  end
  -- Size of Order Accepted Message
  if sequenced_message_type == "A" then
    return jnx_equities_pts_ouch_v1_11.order_accepted_message.size(buffer, offset)
  end
  -- Size of Order Replaced Message
  if sequenced_message_type == "U" then
    return jnx_equities_pts_ouch_v1_11.order_replaced_message.size(buffer, offset)
  end
  -- Size of Order Canceled Message
  if sequenced_message_type == "C" then
    return jnx_equities_pts_ouch_v1_11.order_canceled_message.size(buffer, offset)
  end
  -- Size of Order Aiq Canceled Message
  if sequenced_message_type == "D" then
    return jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.size(buffer, offset)
  end
  -- Size of Order Executed Message
  if sequenced_message_type == "E" then
    return jnx_equities_pts_ouch_v1_11.order_executed_message.size(buffer, offset)
  end
  -- Size of Order Rejected Message
  if sequenced_message_type == "J" then
    return jnx_equities_pts_ouch_v1_11.order_rejected_message.size(buffer, offset)
  end
...
jnx_equities_pts_ouch_v1_11.sequenced_message.branches = function(buffer, offset, packet, parent, sequenced_message_type)
  ...
  -- Dissect Order Accepted Message
  if sequenced_message_type == "A" then
    return jnx_equities_pts_ouch_v1_11.order_accepted_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Replaced Message
  if sequenced_message_type == "U" then
    return jnx_equities_pts_ouch_v1_11.order_replaced_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Canceled Message
  if sequenced_message_type == "C" then
    return jnx_equities_pts_ouch_v1_11.order_canceled_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Aiq Canceled Message
  if sequenced_message_type == "D" then
    return jnx_equities_pts_ouch_v1_11.order_aiq_canceled_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Executed Message
  if sequenced_message_type == "E" then
    return jnx_equities_pts_ouch_v1_11.order_executed_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Rejected Message
  if sequenced_message_type == "J" then
    return jnx_equities_pts_ouch_v1_11.order_rejected_message.dissect(buffer, offset, packet, parent)
  end
...
jnx_equities_pts_ouch_v1_11.sequenced_message_type = {}

-- Size: Sequenced Message Type
jnx_equities_pts_ouch_v1_11.sequenced_message_type.size = 1

-- Display: Sequenced Message Type
jnx_equities_pts_ouch_v1_11.sequenced_message_type.display = function(value)
  if value == "S" then
...
jnx_equities_pts_ouch_v1_11.sequenced_message_type.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.sequenced_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.sequenced_message_type.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.sequenced_data_packet = {}

-- Read runtime size of: Sequenced Data Packet
jnx_equities_pts_ouch_v1_11.sequenced_data_packet.size = function(buffer, offset)
  local index = offset
...
jnx_equities_pts_ouch_v1_11.sequenced_data_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequenced Data Packet
jnx_equities_pts_ouch_v1_11.sequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  local index = offset

  -- Sequenced Message Type: 1 Byte Ascii String Enum with 7 values
  index, sequenced_message_type = jnx_equities_pts_ouch_v1_11.sequenced_message_type.dissect(buffer, index, packet, parent)

  -- Sequenced Message: Runtime Type with 7 branches
  index = jnx_equities_pts_ouch_v1_11.sequenced_message.dissect(buffer, index, packet, parent, sequenced_message_type)
...
-- Reject Reason Code
jnx_equities_pts_ouch_v1_11.reject_reason_code = {}

-- Size: Reject Reason Code
jnx_equities_pts_ouch_v1_11.reject_reason_code.size = 1

-- Display: Reject Reason Code
jnx_equities_pts_ouch_v1_11.reject_reason_code.display = function(value)
  return "Reject Reason Code: "..value
end

-- Dissect: Reject Reason Code
jnx_equities_pts_ouch_v1_11.reject_reason_code.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.reject_reason_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.reject_reason_code.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.login_rejected_packet = {}

-- Calculate size of: Login Rejected Packet
jnx_equities_pts_ouch_v1_11.login_rejected_packet.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.reject_reason_code.size

  return index
end

-- Display: Login Rejected Packet
jnx_equities_pts_ouch_v1_11.login_rejected_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Rejected Packet
jnx_equities_pts_ouch_v1_11.login_rejected_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Reject Reason Code: 1 Byte Ascii String
  index, reject_reason_code = jnx_equities_pts_ouch_v1_11.reject_reason_code.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.login_rejected_packet.dissect = function(buffer, offset, packet, parent)
  if show.login_rejected_packet then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.login_rejected_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.login_rejected_packet.fields(buffer, offset, packet, parent)
  end
end

-- Sequence Number
jnx_equities_pts_ouch_v1_11.sequence_number = {}

-- Size: Sequence Number
jnx_equities_pts_ouch_v1_11.sequence_number.size = 20

-- Display: Sequence Number
jnx_equities_pts_ouch_v1_11.sequence_number.display = function(value)
  return "Sequence Number: "..value
end

-- Dissect: Sequence Number
jnx_equities_pts_ouch_v1_11.sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.sequence_number.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.sequence_number.display(value, buffer, offset, packet, parent)
...
-- Session
jnx_equities_pts_ouch_v1_11.session = {}

-- Size: Session
jnx_equities_pts_ouch_v1_11.session.size = 10

-- Display: Session
jnx_equities_pts_ouch_v1_11.session.display = function(value)
  return "Session: "..value
end

-- Dissect: Session
jnx_equities_pts_ouch_v1_11.session.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.session.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.session.display(value, buffer, offset, packet, parent)
...
jnx_equities_pts_ouch_v1_11.login_accepted_packet = {}

-- Calculate size of: Login Accepted Packet
jnx_equities_pts_ouch_v1_11.login_accepted_packet.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.session.size

  index = index + jnx_equities_pts_ouch_v1_11.sequence_number.size

  return index
end

-- Display: Login Accepted Packet
jnx_equities_pts_ouch_v1_11.login_accepted_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Accepted Packet
jnx_equities_pts_ouch_v1_11.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session: 10 Byte Ascii String
  index, session = jnx_equities_pts_ouch_v1_11.session.dissect(buffer, index, packet, parent)

  -- Sequence Number: 20 Byte Ascii String
  index, sequence_number = jnx_equities_pts_ouch_v1_11.sequence_number.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.login_accepted_packet.dissect = function(buffer, offset, packet, parent)
  if show.login_accepted_packet then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.login_accepted_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.login_accepted_packet.fields(buffer, offset, packet, parent)
  end
end

-- Text
jnx_equities_pts_ouch_v1_11.text = {}

-- Size: Text
jnx_equities_pts_ouch_v1_11.text.size = 1

-- Display: Text
jnx_equities_pts_ouch_v1_11.text.display = function(value)
  return "Text: "..value
end

-- Dissect: Text
jnx_equities_pts_ouch_v1_11.text.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.text.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.text.display(value, buffer, offset, packet, parent)
...
-- Debug Packet
jnx_equities_pts_ouch_v1_11.debug_packet = {}

-- Calculate size of: Debug Packet
jnx_equities_pts_ouch_v1_11.debug_packet.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.text.size

  return index
end

-- Display: Debug Packet
jnx_equities_pts_ouch_v1_11.debug_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Debug Packet
jnx_equities_pts_ouch_v1_11.debug_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Text: 1 Byte Ascii String
  index, text = jnx_equities_pts_ouch_v1_11.text.dissect(buffer, index, packet, parent)
...
jnx_equities_pts_ouch_v1_11.debug_packet.dissect = function(buffer, offset, packet, parent)
  if show.debug_packet then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.debug_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.debug_packet.fields(buffer, offset, packet, parent)
  end
end
...
jnx_equities_pts_ouch_v1_11.payload.size = function(buffer, offset, packet_type)
  ...
  if packet_type == "+" then
    return jnx_equities_pts_ouch_v1_11.debug_packet.size(buffer, offset)
  end
  -- Size of Login Accepted Packet
  if packet_type == "A" then
    return jnx_equities_pts_ouch_v1_11.login_accepted_packet.size(buffer, offset)
  end
  -- Size of Login Rejected Packet
  if packet_type == "J" then
    return jnx_equities_pts_ouch_v1_11.login_rejected_packet.size(buffer, offset)
  end
  ...
  if packet_type == "L" then
    return jnx_equities_pts_ouch_v1_11.login_request_packet.size(buffer, offset)
  end
...
jnx_equities_pts_ouch_v1_11.payload.branches = function(buffer, offset, packet, parent, packet_type)
  ...
  -- Dissect Login Accepted Packet
  if packet_type == "A" then
    return jnx_equities_pts_ouch_v1_11.login_accepted_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Login Rejected Packet
  if packet_type == "J" then
    return jnx_equities_pts_ouch_v1_11.login_rejected_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Sequenced Data Packet
  if packet_type == "S" then
    return jnx_equities_pts_ouch_v1_11.sequenced_data_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Login Request Packet
  if packet_type == "L" then
    return jnx_equities_pts_ouch_v1_11.login_request_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Unsequenced Data Packet
  if packet_type == "U" then
    return jnx_equities_pts_ouch_v1_11.unsequenced_data_packet.dissect(buffer, offset, packet, parent)
  end
...
-- Packet Type
jnx_equities_pts_ouch_v1_11.packet_type = {}

-- Size: Packet Type
jnx_equities_pts_ouch_v1_11.packet_type.size = 1

-- Display: Packet Type
jnx_equities_pts_ouch_v1_11.packet_type.display = function(value)
  if value == "+" then
...
-- Dissect: Packet Type
jnx_equities_pts_ouch_v1_11.packet_type.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = jnx_equities_pts_ouch_v1_11.packet_type.display(value, buffer, offset, packet, parent)
...
-- Packet Length
jnx_equities_pts_ouch_v1_11.packet_length = {}

-- Size: Packet Length
jnx_equities_pts_ouch_v1_11.packet_length.size = 2

-- Display: Packet Length
jnx_equities_pts_ouch_v1_11.packet_length.display = function(value)
  return "Packet Length: "..value
end

-- Dissect: Packet Length
jnx_equities_pts_ouch_v1_11.packet_length.dissect = function(buffer, offset, packet, parent)
  local length = jnx_equities_pts_ouch_v1_11.packet_length.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = jnx_equities_pts_ouch_v1_11.packet_length.display(value, buffer, offset, packet, parent)
...
-- Packet Header
jnx_equities_pts_ouch_v1_11.packet_header = {}

-- Calculate size of: Packet Header
jnx_equities_pts_ouch_v1_11.packet_header.size = function(buffer, offset)
  local index = 0

  index = index + jnx_equities_pts_ouch_v1_11.packet_length.size

  index = index + jnx_equities_pts_ouch_v1_11.packet_type.size

  return index
end

-- Display: Packet Header
jnx_equities_pts_ouch_v1_11.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
jnx_equities_pts_ouch_v1_11.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Packet Length: 2 Byte Unsigned Fixed Width Integer
  index, packet_length = jnx_equities_pts_ouch_v1_11.packet_length.dissect(buffer, index, packet, parent)

  -- Packet Type: 1 Byte Ascii String Enum with 10 values
  index, packet_type = jnx_equities_pts_ouch_v1_11.packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Packet Header
jnx_equities_pts_ouch_v1_11.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_jnx_equities_pts_ouch_v1_11.fields.packet_header, buffer(offset, 0))
    local index = jnx_equities_pts_ouch_v1_11.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = jnx_equities_pts_ouch_v1_11.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return jnx_equities_pts_ouch_v1_11.packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Soup Bin Tcp Packet
jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet = {}

-- Display: Soup Bin Tcp Packet
jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Soup Bin Tcp Packet
jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset

  -- Packet Header: Struct of 2 fields
  index, packet_header = jnx_equities_pts_ouch_v1_11.packet_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 6 branches
  index = jnx_equities_pts_ouch_v1_11.payload.dissect(buffer, index, packet, parent, packet_type)

  return index
end

-- Dissect: Soup Bin Tcp Packet
jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  ...
  if show.soup_bin_tcp_packet then
    ...
    local current = jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
    parent:set_len(size_of_soup_bin_tcp_packet)
    local display = jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
...
local soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < jnx_equities_pts_ouch_v1_11.packet_header.size(buffer, index) then
...
-- Packet
jnx_equities_pts_ouch_v1_11.packet = {}

-- Dissect Packet
jnx_equities_pts_ouch_v1_11.packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = jnx_equities_pts_ouch_v1_11.soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_soup_bin_tcp_packet)
    else
...
function omi_jnx_equities_pts_ouch_v1_11.dissector(buffer, packet, parent)
  ...
  return jnx_equities_pts_ouch_v1_11.packet.dissect(buffer, packet, protocol)
end
...
jnx_equities_pts_ouch_v1_11.packet.requiredsize = function(buffer)
...
local function omi_jnx_equities_pts_ouch_v1_11_heuristic(buffer, packet, parent)
  ...
  if not jnx_equities_pts_ouch_v1_11.packet.requiredsize(buffer) then return false end
