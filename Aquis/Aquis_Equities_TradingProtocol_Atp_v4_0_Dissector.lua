...
omi_aquis_equities_tradingprotocol_atp_v4_0.fields.lis = ProtoField.new("Lis", "aquis.equities.tradingprotocol.atp.v4.0.lis", ftypes.UINT8, {[0]="Reference Price Waiver", [1]="Large In Scale"}, base.DEC, 0x40)
...
omi_aquis_equities_tradingprotocol_atp_v4_0.fields.order_status = ProtoField.new("Order Status", "aquis.equities.tradingprotocol.atp.v4.0.orderstatus", ftypes.UINT8, {[1]="Pending New", [2]="Acknowledged", [3]="Cancelled", [4]="Rejected", [5]="Filled", [6]="Modified"}, base.DEC, 0xE0)
...
omi_aquis_equities_tradingprotocol_atp_v4_0.fields.party_role = ProtoField.new("Party Role", "aquis.equities.tradingprotocol.atp.v4.0.partyrole", ftypes.UINT8, {[0]="None", [1]="Client Id", [2]="Executing Decision Id", [3]="Investing Decision Id"}, base.DEC, 0x0F)
omi_aquis_equities_tradingprotocol_atp_v4_0.fields.party_role_qualifier = ProtoField.new("Party Role Qualifier", "aquis.equities.tradingprotocol.atp.v4.0.partyrolequalifier", ftypes.UINT8, {[0]="None", [1]="Algo", [2]="Firm", [3]="Person"}, base.DEC, 0xF0)
...
omi_aquis_equities_tradingprotocol_atp_v4_0.fields.routing = ProtoField.new("Routing", "aquis.equities.tradingprotocol.atp.v4.0.routing", ftypes.UINT8, {[0]="Limit", [1]="Post Only", [2]="Pocr", [3]="Restricted Post Only Order", [4]="Restricted Pocr Order"}, base.DEC, 0x38)
...
omi_aquis_equities_tradingprotocol_atp_v4_0.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
-- Ioi Firmup Message
aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message = {}

-- Size: Ioi Firmup Message
aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.size =
...
aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Ioi Firmup Message
aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_aquis_equities_tradingprotocol_atp_v4_0.fields.ioi_firmup_message, buffer(offset, 0))
    local index = aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.fields(buffer, offset, packet, parent)
  end
end
...
aquis_equities_tradingprotocol_atp_v4_0.payload.dissect = function(buffer, offset, packet, parent, msg_type)
  ...
  -- Dissect Ioi Firmup Message
  if msg_type == 29 then
    return aquis_equities_tradingprotocol_atp_v4_0.ioi_firmup_message.dissect(buffer, offset, packet, parent)
  end
