...
function omi_aquis_aquisequities_udpheader_amd_v1_0.prefs_changed()
  ...
  if show.headers ~= omi_aquis_aquisequities_udpheader_amd_v1_0.prefs.show_headers then
    show.headers = omi_aquis_aquisequities_udpheader_amd_v1_0.prefs.show_headers
  end
  if show.structs ~= omi_aquis_aquisequities_udpheader_amd_v1_0.prefs.show_structs then
    show.structs = omi_aquis_aquisequities_udpheader_amd_v1_0.prefs.show_structs
  end
  if show.indexes ~= omi_aquis_aquisequities_udpheader_amd_v1_0.prefs.show_indexes then
    show.indexes = omi_aquis_aquisequities_udpheader_amd_v1_0.prefs.show_indexes
  end
end
