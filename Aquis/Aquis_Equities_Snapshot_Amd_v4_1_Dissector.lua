...
local omi_aquis_equities_snapshot_amd_v4_1 = Proto("Omi.Aquis.Equities.Snapshot.Amd.v4.1", "Aquis Equities Snapshot Amd 4.1")
...
omi_aquis_equities_snapshot_amd_v4_1.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_aquis_equities_snapshot_amd_v4_1.prefs_changed()
  ...
  if show.message_index ~= omi_aquis_equities_snapshot_amd_v4_1.prefs.show_message_index then
    show.message_index = omi_aquis_equities_snapshot_amd_v4_1.prefs.show_message_index
  end
end
...
aquis_equities_snapshot_amd_v4_1.packet.requiredsize = function(buffer)
  return buffer:len() >= aquis_equities_snapshot_amd_v4_1.packet_header.size
end
...
-- Dissector Heuristic for Aquis Equities Snapshot Amd 4.1 (Udp)
local function omi_aquis_equities_snapshot_amd_v4_1_udp_heuristic(buffer, packet, parent)
...
omi_aquis_equities_snapshot_amd_v4_1:register_heuristic("udp", omi_aquis_equities_snapshot_amd_v4_1_udp_heuristic)

-- Register Aquis Equities Snapshot Amd 4.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_aquis_equities_snapshot_amd_v4_1)
