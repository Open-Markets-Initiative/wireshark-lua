...
-- Aquis Equities Orders Atp 4.0 Protocol
local omi_aquis_equities_orders_atp_v4_0 = Proto("Aquis.Equities.Orders.Atp.v4.0.Lua", "Aquis Equities Orders Atp 4.0")

-- Protocol table
local aquis_equities_orders_atp_v4_0 = {}
...
omi_aquis_equities_orders_atp_v4_0.fields.account = ProtoField.new("Account", "aquis.equities.orders.atp.v4.0.account", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.algo_trade_flag = ProtoField.new("Algo Trade Flag", "aquis.equities.orders.atp.v4.0.algotradeflag", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_aquis_equities_orders_atp_v4_0.fields.atp_seq_no = ProtoField.new("Atp Seq No", "aquis.equities.orders.atp.v4.0.atpseqno", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.blotter_blacklist = ProtoField.new("Blotter Blacklist", "aquis.equities.orders.atp.v4.0.blotterblacklist", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.ccp_code = ProtoField.new("Ccp Code", "aquis.equities.orders.atp.v4.0.ccpcode", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.client_seq_no = ProtoField.new("Client Seq No", "aquis.equities.orders.atp.v4.0.clientseqno", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.dark_flag = ProtoField.new("Dark Flag", "aquis.equities.orders.atp.v4.0.darkflag", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_aquis_equities_orders_atp_v4_0.fields.dea_flag = ProtoField.new("Dea Flag", "aquis.equities.orders.atp.v4.0.deaflag", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
omi_aquis_equities_orders_atp_v4_0.fields.designated_order_id = ProtoField.new("Designated Order Id", "aquis.equities.orders.atp.v4.0.designatedorderid", ftypes.UINT64)
omi_aquis_equities_orders_atp_v4_0.fields.display_quantity = ProtoField.new("Display Quantity", "aquis.equities.orders.atp.v4.0.displayquantity", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.extended_order_flags = ProtoField.new("Extended Order Flags", "aquis.equities.orders.atp.v4.0.extendedorderflags", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.flags = ProtoField.new("Flags", "aquis.equities.orders.atp.v4.0.flags", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.inactivity_timeout = ProtoField.new("Inactivity Timeout", "aquis.equities.orders.atp.v4.0.inactivitytimeout", ftypes.UINT16)
omi_aquis_equities_orders_atp_v4_0.fields.ioi_extended_flags = ProtoField.new("Ioi Extended Flags", "aquis.equities.orders.atp.v4.0.ioiextendedflags", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.ioi_order_type = ProtoField.new("Ioi Order Type", "aquis.equities.orders.atp.v4.0.ioiordertype", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.liq_indicator = ProtoField.new("Liq Indicator", "aquis.equities.orders.atp.v4.0.liqindicator", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.liq_prov = ProtoField.new("Liq Prov", "aquis.equities.orders.atp.v4.0.liqprov", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_aquis_equities_orders_atp_v4_0.fields.lis = ProtoField.new("Lis", "aquis.equities.orders.atp.v4.0.lis", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
omi_aquis_equities_orders_atp_v4_0.fields.lis_only = ProtoField.new("Lis Only", "aquis.equities.orders.atp.v4.0.lisonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_aquis_equities_orders_atp_v4_0.fields.logout_reason_code = ProtoField.new("Logout Reason Code", "aquis.equities.orders.atp.v4.0.logoutreasoncode", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.market_data_id = ProtoField.new("Market Data Id", "aquis.equities.orders.atp.v4.0.marketdataid", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.message = ProtoField.new("Message", "aquis.equities.orders.atp.v4.0.message", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.message_header = ProtoField.new("Message Header", "aquis.equities.orders.atp.v4.0.messageheader", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.min_qty = ProtoField.new("Min Qty", "aquis.equities.orders.atp.v4.0.minqty", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.msg_length = ProtoField.new("Msg Length", "aquis.equities.orders.atp.v4.0.msglength", ftypes.UINT16)
omi_aquis_equities_orders_atp_v4_0.fields.msg_seq_no = ProtoField.new("Msg Seq No", "aquis.equities.orders.atp.v4.0.msgseqno", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.msg_type = ProtoField.new("Msg Type", "aquis.equities.orders.atp.v4.0.msgtype", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.new_aqx_ord_id = ProtoField.new("New Aqx Ord Id", "aquis.equities.orders.atp.v4.0.newaqxordid", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.optim_x_universe = ProtoField.new("Optim X Universe", "aquis.equities.orders.atp.v4.0.optimxuniverse", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.order_add_response_flags = ProtoField.new("Order Add Response Flags", "aquis.equities.orders.atp.v4.0.orderaddresponseflags", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_capacity = ProtoField.new("Order Capacity", "aquis.equities.orders.atp.v4.0.ordercapacity", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.order_modify_response_flags_u_81 = ProtoField.new("Order Modify Response Flags U 81", "aquis.equities.orders.atp.v4.0.ordermodifyresponseflagsu81", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.order_ref = ProtoField.new("Order Ref", "aquis.equities.orders.atp.v4.0.orderref", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.order_status = ProtoField.new("Order Status", "aquis.equities.orders.atp.v4.0.orderstatus", ftypes.UINT8, nil, base.DEC, 0xE0)
omi_aquis_equities_orders_atp_v4_0.fields.order_type = ProtoField.new("Order Type", "aquis.equities.orders.atp.v4.0.ordertype", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.orig_aqx_ord_id = ProtoField.new("Orig Aqx Ord Id", "aquis.equities.orders.atp.v4.0.origaqxordid", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.packet = ProtoField.new("Packet", "aquis.equities.orders.atp.v4.0.packet", ftypes.STRING)
...
omi_aquis_equities_orders_atp_v4_0.fields.quantity = ProtoField.new("Quantity", "aquis.equities.orders.atp.v4.0.quantity", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.reason_code = ProtoField.new("Reason Code", "aquis.equities.orders.atp.v4.0.reasoncode", ftypes.UINT8, nil, base.DEC, 0x1F)
omi_aquis_equities_orders_atp_v4_0.fields.reason_text = ProtoField.new("Reason Text", "aquis.equities.orders.atp.v4.0.reasontext", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.request_ref = ProtoField.new("Request Ref", "aquis.equities.orders.atp.v4.0.requestref", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.reserved_1 = ProtoField.new("Reserved 1", "aquis.equities.orders.atp.v4.0.reserved1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_aquis_equities_orders_atp_v4_0.fields.reserved_2 = ProtoField.new("Reserved 2", "aquis.equities.orders.atp.v4.0.reserved2", ftypes.UINT8, nil, base.DEC, 0xC0)
omi_aquis_equities_orders_atp_v4_0.fields.reserved_5 = ProtoField.new("Reserved 5", "aquis.equities.orders.atp.v4.0.reserved5", ftypes.UINT8, nil, base.DEC, 0xF8)
omi_aquis_equities_orders_atp_v4_0.fields.reserved_6 = ProtoField.new("Reserved 6", "aquis.equities.orders.atp.v4.0.reserved6", ftypes.UINT8, nil, base.DEC, 0x3F)
omi_aquis_equities_orders_atp_v4_0.fields.reserved_u_162 = ProtoField.new("Reserved U 162", "aquis.equities.orders.atp.v4.0.reservedu162", ftypes.UINT16)
omi_aquis_equities_orders_atp_v4_0.fields.reserved_u_648 = ProtoField.new("Reserved U 648", "aquis.equities.orders.atp.v4.0.reservedu648", ftypes.UINT64)
omi_aquis_equities_orders_atp_v4_0.fields.result_code = ProtoField.new("Result Code", "aquis.equities.orders.atp.v4.0.resultcode", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.routetolit = ProtoField.new("Routetolit", "aquis.equities.orders.atp.v4.0.routetolit", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
omi_aquis_equities_orders_atp_v4_0.fields.routing = ProtoField.new("Routing", "aquis.equities.orders.atp.v4.0.routing", ftypes.UINT8, nil, base.DEC, 0x38)
omi_aquis_equities_orders_atp_v4_0.fields.security_id_u_162 = ProtoField.new("Security Id U 162", "aquis.equities.orders.atp.v4.0.securityidu162", ftypes.UINT16)
omi_aquis_equities_orders_atp_v4_0.fields.security_id_u_324 = ProtoField.new("Security Id U 324", "aquis.equities.orders.atp.v4.0.securityidu324", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.sender_id = ProtoField.new("Sender Id", "aquis.equities.orders.atp.v4.0.senderid", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.short_code_1 = ProtoField.new("Short Code 1", "aquis.equities.orders.atp.v4.0.shortcode1", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.short_code_2 = ProtoField.new("Short Code 2", "aquis.equities.orders.atp.v4.0.shortcode2", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.short_code_3 = ProtoField.new("Short Code 3", "aquis.equities.orders.atp.v4.0.shortcode3", ftypes.UINT32)
omi_aquis_equities_orders_atp_v4_0.fields.side = ProtoField.new("Side", "aquis.equities.orders.atp.v4.0.side", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.status = ProtoField.new("Status", "aquis.equities.orders.atp.v4.0.status", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.stp_enable = ProtoField.new("Stp Enable", "aquis.equities.orders.atp.v4.0.stpenable", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_aquis_equities_orders_atp_v4_0.fields.table_select_1 = ProtoField.new("Table Select 1", "aquis.equities.orders.atp.v4.0.tableselect1", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.table_select_2 = ProtoField.new("Table Select 2", "aquis.equities.orders.atp.v4.0.tableselect2", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.table_select_3 = ProtoField.new("Table Select 3", "aquis.equities.orders.atp.v4.0.tableselect3", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.time_in_force = ProtoField.new("Time In Force", "aquis.equities.orders.atp.v4.0.timeinforce", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.timestamp = ProtoField.new("Timestamp", "aquis.equities.orders.atp.v4.0.timestamp", ftypes.UINT64)
omi_aquis_equities_orders_atp_v4_0.fields.trade_capture_flags = ProtoField.new("Trade Capture Flags", "aquis.equities.orders.atp.v4.0.tradecaptureflags", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.trade_capture_type = ProtoField.new("Trade Capture Type", "aquis.equities.orders.atp.v4.0.tradecapturetype", ftypes.UINT8)
omi_aquis_equities_orders_atp_v4_0.fields.trade_flags = ProtoField.new("Trade Flags", "aquis.equities.orders.atp.v4.0.tradeflags", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.trade_ref = ProtoField.new("Trade Ref", "aquis.equities.orders.atp.v4.0.traderef", ftypes.UINT32)
...
omi_aquis_equities_orders_atp_v4_0.fields.ioi_invite_message = ProtoField.new("Ioi Invite Message", "aquis.equities.orders.atp.v4.0.ioiinvitemessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.login_message = ProtoField.new("Login Message", "aquis.equities.orders.atp.v4.0.loginmessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.login_response_message = ProtoField.new("Login Response Message", "aquis.equities.orders.atp.v4.0.loginresponsemessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.logout_message = ProtoField.new("Logout Message", "aquis.equities.orders.atp.v4.0.logoutmessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_add_extended_message = ProtoField.new("Order Add Extended Message", "aquis.equities.orders.atp.v4.0.orderaddextendedmessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_add_message = ProtoField.new("Order Add Message", "aquis.equities.orders.atp.v4.0.orderaddmessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_add_response_message = ProtoField.new("Order Add Response Message", "aquis.equities.orders.atp.v4.0.orderaddresponsemessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_cancel_message = ProtoField.new("Order Cancel Message", "aquis.equities.orders.atp.v4.0.ordercancelmessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_cancel_response_message = ProtoField.new("Order Cancel Response Message", "aquis.equities.orders.atp.v4.0.ordercancelresponsemessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_modify_extended_message = ProtoField.new("Order Modify Extended Message", "aquis.equities.orders.atp.v4.0.ordermodifyextendedmessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_modify_message = ProtoField.new("Order Modify Message", "aquis.equities.orders.atp.v4.0.ordermodifymessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.order_modify_response_message = ProtoField.new("Order Modify Response Message", "aquis.equities.orders.atp.v4.0.ordermodifyresponsemessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.trade_bust_message = ProtoField.new("Trade Bust Message", "aquis.equities.orders.atp.v4.0.tradebustmessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.trade_capture_message = ProtoField.new("Trade Capture Message", "aquis.equities.orders.atp.v4.0.tradecapturemessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.trade_capture_response_message = ProtoField.new("Trade Capture Response Message", "aquis.equities.orders.atp.v4.0.tradecaptureresponsemessage", ftypes.STRING)
omi_aquis_equities_orders_atp_v4_0.fields.trade_message = ProtoField.new("Trade Message", "aquis.equities.orders.atp.v4.0.trademessage", ftypes.STRING)
...
-- Min Qty
aquis_equities_orders_atp_v4_0.min_qty = {}

-- Size: Min Qty
aquis_equities_orders_atp_v4_0.min_qty.size = 4

-- Display: Min Qty
aquis_equities_orders_atp_v4_0.min_qty.display = function(value)
  return "Min Qty: "..value
end

-- Dissect: Min Qty
aquis_equities_orders_atp_v4_0.min_qty.dissect = function(buffer, offset, packet, parent)
  local length = aquis_equities_orders_atp_v4_0.min_qty.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.min_qty.display(value, buffer, offset, packet, parent)

  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.min_qty, range, value, display)
...
-- Price
aquis_equities_orders_atp_v4_0.price = {}

-- Size: Price
aquis_equities_orders_atp_v4_0.price.size = 8

-- Display: Price
aquis_equities_orders_atp_v4_0.price.display = function(value)
  return "Price: "..value
end

-- Dissect: Price
aquis_equities_orders_atp_v4_0.price.dissect = function(buffer, offset, packet, parent)
  local length = aquis_equities_orders_atp_v4_0.price.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = aquis_equities_orders_atp_v4_0.price.display(value, buffer, offset, packet, parent)

  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.price, range, value, display)
...
-- Size: Ioi Firmup Message
aquis_equities_orders_atp_v4_0.ioi_firmup_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.min_qty.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size

-- Display: Ioi Firmup Message
aquis_equities_orders_atp_v4_0.ioi_firmup_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Ioi Firmup Message
aquis_equities_orders_atp_v4_0.ioi_firmup_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Order Ref: u32
  index, order_ref = aquis_equities_orders_atp_v4_0.order_ref.dissect(buffer, index, packet, parent)

  -- Price: u64
  index, price = aquis_equities_orders_atp_v4_0.price.dissect(buffer, index, packet, parent)

  -- Quantity: u32
  index, quantity = aquis_equities_orders_atp_v4_0.quantity.dissect(buffer, index, packet, parent)

  -- Min Qty: u32
  index, min_qty = aquis_equities_orders_atp_v4_0.min_qty.dissect(buffer, index, packet, parent)

  -- User Tag: u64
  index, user_tag = aquis_equities_orders_atp_v4_0.user_tag.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.ioi_firmup_message.dissect = function(buffer, offset, packet, parent)
  if show.ioi_firmup_message then
    ...
    local display = aquis_equities_orders_atp_v4_0.ioi_firmup_message.display(packet, parent, length)
...
-- Ioi Invite Message
aquis_equities_orders_atp_v4_0.ioi_invite_message = {}

-- Size: Ioi Invite Message
aquis_equities_orders_atp_v4_0.ioi_invite_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.min_qty.size + 
  aquis_equities_orders_atp_v4_0.timestamp.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size

-- Display: Ioi Invite Message
aquis_equities_orders_atp_v4_0.ioi_invite_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Ioi Invite Message
aquis_equities_orders_atp_v4_0.ioi_invite_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  -- Timestamp: time
  index, timestamp = aquis_equities_orders_atp_v4_0.timestamp.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.ioi_invite_message.dissect = function(buffer, offset, packet, parent)
  if show.ioi_invite_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.ioi_invite_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.ioi_invite_message.fields(buffer, offset, packet, parent)
  end
end
...
aquis_equities_orders_atp_v4_0.ioi_extended_flags.size = 1

-- Display: Ioi Extended Flags
aquis_equities_orders_atp_v4_0.ioi_extended_flags.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.ioi_extended_flags.bits = function(range, value, packet, parent)

  -- Stp Enable: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.stp_enable, range, value)

  -- Lis Only: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.lis_only, range, value)

  -- Reserved 6: 6 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.reserved_6, range, value)
end

-- Dissect: Ioi Extended Flags
aquis_equities_orders_atp_v4_0.ioi_extended_flags.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.ioi_extended_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.ioi_extended_flags.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.ioi_extended_flags, range, display)

  if show.ioi_extended_flags then
    aquis_equities_orders_atp_v4_0.ioi_extended_flags.bits(range, value, packet, element)
  end
...
-- Size: Table Select 3
aquis_equities_orders_atp_v4_0.table_select_3.size = 1

-- Display: Table Select 3
aquis_equities_orders_atp_v4_0.table_select_3.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.table_select_3.bits = function(range, value, packet, parent)

  -- Party Role: 4 Bit Enum with 4 values
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.party_role, range, value)

  -- Party Role Qualifier: 4 Bit Enum with 4 values
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.party_role_qualifier, range, value)
end

-- Dissect: Table Select 3
aquis_equities_orders_atp_v4_0.table_select_3.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.table_select_3.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.table_select_3.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.table_select_3, range, display)

  if show.table_select_3 then
    aquis_equities_orders_atp_v4_0.table_select_3.bits(range, value, packet, element)
  end
...
-- Size: Table Select 2
aquis_equities_orders_atp_v4_0.table_select_2.size = 1

-- Display: Table Select 2
aquis_equities_orders_atp_v4_0.table_select_2.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.table_select_2.bits = function(range, value, packet, parent)
...
aquis_equities_orders_atp_v4_0.table_select_2.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.table_select_2.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.table_select_2.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.table_select_2, range, display)

  if show.table_select_2 then
    aquis_equities_orders_atp_v4_0.table_select_2.bits(range, value, packet, element)
  end
...
-- Table Select 1
aquis_equities_orders_atp_v4_0.table_select_1 = {}

-- Size: Table Select 1
aquis_equities_orders_atp_v4_0.table_select_1.size = 1

-- Display: Table Select 1
aquis_equities_orders_atp_v4_0.table_select_1.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.table_select_1.bits = function(range, value, packet, parent)
...
aquis_equities_orders_atp_v4_0.table_select_1.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.table_select_1.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.table_select_1.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.table_select_1, range, display)

  if show.table_select_1 then
    aquis_equities_orders_atp_v4_0.table_select_1.bits(range, value, packet, element)
  end
...
-- Flags
aquis_equities_orders_atp_v4_0.flags = {}

-- Size: Flags
aquis_equities_orders_atp_v4_0.flags.size = 1

-- Display: Flags
aquis_equities_orders_atp_v4_0.flags.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.flags.bits = function(range, value, packet, parent)

  -- Liq Prov: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.liq_prov, range, value)

  -- Algo Trade Flag: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.algo_trade_flag, range, value)

  -- Dea Flag: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.dea_flag, range, value)

  -- Reserved 5: 5 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.reserved_5, range, value)
end

-- Dissect: Flags
aquis_equities_orders_atp_v4_0.flags.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.flags.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.flags, range, display)

  if show.flags then
    aquis_equities_orders_atp_v4_0.flags.bits(range, value, packet, element)
  end
...
-- Ioi Add Message
aquis_equities_orders_atp_v4_0.ioi_add_message = {}

-- Size: Ioi Add Message
aquis_equities_orders_atp_v4_0.ioi_add_message.size =
  aquis_equities_orders_atp_v4_0.security_id_u_162.size + 
  aquis_equities_orders_atp_v4_0.ioi_order_type.size + 
  aquis_equities_orders_atp_v4_0.time_in_force.size + 
  aquis_equities_orders_atp_v4_0.side.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.order_capacity.size + 
  aquis_equities_orders_atp_v4_0.account.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size + 
  aquis_equities_orders_atp_v4_0.flags.size + 
  aquis_equities_orders_atp_v4_0.table_select_1.size + 
  aquis_equities_orders_atp_v4_0.short_code_1.size + 
  aquis_equities_orders_atp_v4_0.table_select_2.size + 
  aquis_equities_orders_atp_v4_0.short_code_2.size + 
  aquis_equities_orders_atp_v4_0.table_select_3.size + 
  aquis_equities_orders_atp_v4_0.short_code_3.size + 
  aquis_equities_orders_atp_v4_0.min_qty.size + 
  aquis_equities_orders_atp_v4_0.ioi_extended_flags.size + 
  aquis_equities_orders_atp_v4_0.optim_x_universe.size + 
  aquis_equities_orders_atp_v4_0.blotter_blacklist.size

-- Display: Ioi Add Message
aquis_equities_orders_atp_v4_0.ioi_add_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Ioi Add Message
aquis_equities_orders_atp_v4_0.ioi_add_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Security Id U 162: u16
  index, security_id_u_162 = aquis_equities_orders_atp_v4_0.security_id_u_162.dissect(buffer, index, packet, parent)

  -- Ioi Order Type: u8
  index, ioi_order_type = aquis_equities_orders_atp_v4_0.ioi_order_type.dissect(buffer, index, packet, parent)

  -- Time In Force: u8
  index, time_in_force = aquis_equities_orders_atp_v4_0.time_in_force.dissect(buffer, index, packet, parent)

  -- Side: u8
  index, side = aquis_equities_orders_atp_v4_0.side.dissect(buffer, index, packet, parent)
  ...
  -- Order Capacity: u8
  index, order_capacity = aquis_equities_orders_atp_v4_0.order_capacity.dissect(buffer, index, packet, parent)

  -- Account: u8
  index, account = aquis_equities_orders_atp_v4_0.account.dissect(buffer, index, packet, parent)

  -- User Tag: u64
  index, user_tag = aquis_equities_orders_atp_v4_0.user_tag.dissect(buffer, index, packet, parent)

  -- Flags: Struct of 4 fields
  index, flags = aquis_equities_orders_atp_v4_0.flags.dissect(buffer, index, packet, parent)

  -- Table Select 1: Struct of 2 fields
  index, table_select_1 = aquis_equities_orders_atp_v4_0.table_select_1.dissect(buffer, index, packet, parent)

  -- Short Code 1: u32
  index, short_code_1 = aquis_equities_orders_atp_v4_0.short_code_1.dissect(buffer, index, packet, parent)

  -- Table Select 2: Struct of 2 fields
  index, table_select_2 = aquis_equities_orders_atp_v4_0.table_select_2.dissect(buffer, index, packet, parent)

  -- Short Code 2: u32
  index, short_code_2 = aquis_equities_orders_atp_v4_0.short_code_2.dissect(buffer, index, packet, parent)

  -- Table Select 3: Struct of 2 fields
  index, table_select_3 = aquis_equities_orders_atp_v4_0.table_select_3.dissect(buffer, index, packet, parent)

  -- Short Code 3: u32
  index, short_code_3 = aquis_equities_orders_atp_v4_0.short_code_3.dissect(buffer, index, packet, parent)

  -- Min Qty: u32
  index, min_qty = aquis_equities_orders_atp_v4_0.min_qty.dissect(buffer, index, packet, parent)

  -- Ioi Extended Flags: Struct of 3 fields
  index, ioi_extended_flags = aquis_equities_orders_atp_v4_0.ioi_extended_flags.dissect(buffer, index, packet, parent)

  -- Optim X Universe: u8
  index, optim_x_universe = aquis_equities_orders_atp_v4_0.optim_x_universe.dissect(buffer, index, packet, parent)

  -- Blotter Blacklist: char(50)
  index, blotter_blacklist = aquis_equities_orders_atp_v4_0.blotter_blacklist.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.ioi_add_message.dissect = function(buffer, offset, packet, parent)
  if show.ioi_add_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.ioi_add_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.ioi_add_message.fields(buffer, offset, packet, parent)
  end
end
...
aquis_equities_orders_atp_v4_0.trade_bust_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.side.size + 
  aquis_equities_orders_atp_v4_0.trade_ref.size + 
  aquis_equities_orders_atp_v4_0.timestamp.size

-- Display: Trade Bust Message
aquis_equities_orders_atp_v4_0.trade_bust_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Bust Message
aquis_equities_orders_atp_v4_0.trade_bust_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  -- Trade Ref: u32
  index, trade_ref = aquis_equities_orders_atp_v4_0.trade_ref.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.trade_bust_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_bust_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.trade_bust_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.trade_bust_message.fields(buffer, offset, packet, parent)
  end
end

-- Trade Flags
aquis_equities_orders_atp_v4_0.trade_flags = {}

-- Size: Trade Flags
aquis_equities_orders_atp_v4_0.trade_flags.size = 1

-- Display: Trade Flags
aquis_equities_orders_atp_v4_0.trade_flags.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.trade_flags.bits = function(range, value, packet, parent)

  -- Reserved 6: 6 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.reserved_6, range, value)

  -- Lis: 1 Bit Enum with 2 values
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.lis, range, value)

  -- Dark Flag: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.dark_flag, range, value)
end

-- Dissect: Trade Flags
aquis_equities_orders_atp_v4_0.trade_flags.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.trade_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.trade_flags.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.trade_flags, range, display)

  if show.trade_flags then
    aquis_equities_orders_atp_v4_0.trade_flags.bits(range, value, packet, element)
  end
...
-- Size: Trade Message
aquis_equities_orders_atp_v4_0.trade_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.side.size + 
  aquis_equities_orders_atp_v4_0.trade_ref.size + 
  aquis_equities_orders_atp_v4_0.ccp_code.size + 
  aquis_equities_orders_atp_v4_0.liq_indicator.size + 
  aquis_equities_orders_atp_v4_0.security_id_u_162.size + 
  aquis_equities_orders_atp_v4_0.timestamp.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size + 
  aquis_equities_orders_atp_v4_0.trade_flags.size

-- Display: Trade Message
aquis_equities_orders_atp_v4_0.trade_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Message
aquis_equities_orders_atp_v4_0.trade_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  -- Ccp Code: u8
  index, ccp_code = aquis_equities_orders_atp_v4_0.ccp_code.dissect(buffer, index, packet, parent)

  -- Liq Indicator: u8
  index, liq_indicator = aquis_equities_orders_atp_v4_0.liq_indicator.dissect(buffer, index, packet, parent)
  ...
  index, trade_flags = aquis_equities_orders_atp_v4_0.trade_flags.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.trade_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.trade_message.display(packet, parent, length)
    parent:append_text(display)
...
-- Status
aquis_equities_orders_atp_v4_0.status = {}

-- Size: Status
aquis_equities_orders_atp_v4_0.status.size = 1

-- Display: Status
aquis_equities_orders_atp_v4_0.status.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.status.bits = function(range, value, packet, parent)

  -- Reason Code: 5 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.reason_code, range, value)

  -- Order Status: 3 Bit Enum with 6 values
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.order_status, range, value)
end

-- Dissect: Status
aquis_equities_orders_atp_v4_0.status.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.status.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.status.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.status, range, display)

  if show.status then
    aquis_equities_orders_atp_v4_0.status.bits(range, value, packet, element)
  end
...
aquis_equities_orders_atp_v4_0.trade_capture_response_message = {}

-- Size: Trade Capture Response Message
aquis_equities_orders_atp_v4_0.trade_capture_response_message.size =
  aquis_equities_orders_atp_v4_0.status.size + 
  aquis_equities_orders_atp_v4_0.trade_ref.size + 
  aquis_equities_orders_atp_v4_0.request_ref.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size

-- Display: Trade Capture Response Message
aquis_equities_orders_atp_v4_0.trade_capture_response_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Capture Response Message
aquis_equities_orders_atp_v4_0.trade_capture_response_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Status: Struct of 2 fields
  index, status = aquis_equities_orders_atp_v4_0.status.dissect(buffer, index, packet, parent)

  -- Trade Ref: u32
  index, trade_ref = aquis_equities_orders_atp_v4_0.trade_ref.dissect(buffer, index, packet, parent)

  -- Request Ref: u32
  index, request_ref = aquis_equities_orders_atp_v4_0.request_ref.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.trade_capture_response_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_capture_response_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.trade_capture_response_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.trade_capture_response_message.fields(buffer, offset, packet, parent)
  end
end

-- Trade Capture Flags
aquis_equities_orders_atp_v4_0.trade_capture_flags = {}

-- Size: Trade Capture Flags
aquis_equities_orders_atp_v4_0.trade_capture_flags.size = 1

-- Display: Trade Capture Flags
aquis_equities_orders_atp_v4_0.trade_capture_flags.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.trade_capture_flags.bits = function(range, value, packet, parent)

  -- Reserved 1: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.reserved_1, range, value)
...
aquis_equities_orders_atp_v4_0.trade_capture_flags.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.trade_capture_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.trade_capture_flags.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.trade_capture_flags, range, display)

  if show.trade_capture_flags then
    aquis_equities_orders_atp_v4_0.trade_capture_flags.bits(range, value, packet, element)
  end
...
aquis_equities_orders_atp_v4_0.trade_capture_message.size =
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.security_id_u_324.size + 
  aquis_equities_orders_atp_v4_0.trade_capture_type.size + 
  aquis_equities_orders_atp_v4_0.trade_capture_flags.size + 
  aquis_equities_orders_atp_v4_0.account.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size

-- Display: Trade Capture Message
aquis_equities_orders_atp_v4_0.trade_capture_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Capture Message
aquis_equities_orders_atp_v4_0.trade_capture_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, security_id_u_324 = aquis_equities_orders_atp_v4_0.security_id_u_324.dissect(buffer, index, packet, parent)

  -- Trade Capture Type: u8
  index, trade_capture_type = aquis_equities_orders_atp_v4_0.trade_capture_type.dissect(buffer, index, packet, parent)

  -- Trade Capture Flags: Struct of 3 fields
  index, trade_capture_flags = aquis_equities_orders_atp_v4_0.trade_capture_flags.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.trade_capture_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_capture_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.trade_capture_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.trade_capture_message.fields(buffer, offset, packet, parent)
  end
end
...
aquis_equities_orders_atp_v4_0.iceberg_order_refresh_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.orig_aqx_ord_id.size + 
  aquis_equities_orders_atp_v4_0.new_aqx_ord_id.size + 
  aquis_equities_orders_atp_v4_0.quantity.size

-- Display: Iceberg Order Refresh Message
aquis_equities_orders_atp_v4_0.iceberg_order_refresh_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Iceberg Order Refresh Message
aquis_equities_orders_atp_v4_0.iceberg_order_refresh_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  -- Orig Aqx Ord Id: u32
  index, orig_aqx_ord_id = aquis_equities_orders_atp_v4_0.orig_aqx_ord_id.dissect(buffer, index, packet, parent)

  -- New Aqx Ord Id: u32
  index, new_aqx_ord_id = aquis_equities_orders_atp_v4_0.new_aqx_ord_id.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.iceberg_order_refresh_message.dissect = function(buffer, offset, packet, parent)
  if show.iceberg_order_refresh_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.iceberg_order_refresh_message.display(packet, parent, length)
    parent:append_text(display)
...
aquis_equities_orders_atp_v4_0.order_modify_response_message = {}

-- Size: Order Modify Response Message
aquis_equities_orders_atp_v4_0.order_modify_response_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.request_ref.size + 
  aquis_equities_orders_atp_v4_0.status.size + 
  aquis_equities_orders_atp_v4_0.timestamp.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size + 
  aquis_equities_orders_atp_v4_0.order_modify_response_flags_u_81.size

-- Display: Order Modify Response Message
aquis_equities_orders_atp_v4_0.order_modify_response_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Modify Response Message
aquis_equities_orders_atp_v4_0.order_modify_response_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_modify_response_flags_u_81 = aquis_equities_orders_atp_v4_0.order_modify_response_flags_u_81.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.order_modify_response_message.dissect = function(buffer, offset, packet, parent)
  if show.order_modify_response_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_modify_response_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.order_modify_response_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Cancel Response Message
aquis_equities_orders_atp_v4_0.order_cancel_response_message = {}

-- Size: Order Cancel Response Message
aquis_equities_orders_atp_v4_0.order_cancel_response_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.request_ref.size + 
  aquis_equities_orders_atp_v4_0.status.size + 
  aquis_equities_orders_atp_v4_0.timestamp.size + 
...
aquis_equities_orders_atp_v4_0.order_cancel_response_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Response Message
aquis_equities_orders_atp_v4_0.order_cancel_response_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
aquis_equities_orders_atp_v4_0.order_cancel_response_message.dissect = function(buffer, offset, packet, parent)
  if show.order_cancel_response_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_cancel_response_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.order_cancel_response_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Add Response Flags
aquis_equities_orders_atp_v4_0.order_add_response_flags = {}

-- Size: Order Add Response Flags
aquis_equities_orders_atp_v4_0.order_add_response_flags.size = 1

-- Display: Order Add Response Flags
aquis_equities_orders_atp_v4_0.order_add_response_flags.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.order_add_response_flags.bits = function(range, value, packet, parent)
...
aquis_equities_orders_atp_v4_0.order_add_response_flags.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.order_add_response_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.order_add_response_flags.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.order_add_response_flags, range, display)

  if show.order_add_response_flags then
    aquis_equities_orders_atp_v4_0.order_add_response_flags.bits(range, value, packet, element)
  end
...
aquis_equities_orders_atp_v4_0.order_add_response_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.market_data_id.size + 
  aquis_equities_orders_atp_v4_0.status.size + 
  aquis_equities_orders_atp_v4_0.traded_quantity.size + 
  aquis_equities_orders_atp_v4_0.timestamp.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size + 
  aquis_equities_orders_atp_v4_0.order_add_response_flags.size

-- Display: Order Add Response Message
aquis_equities_orders_atp_v4_0.order_add_response_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Add Response Message
aquis_equities_orders_atp_v4_0.order_add_response_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  -- Market Data Id: u32
  index, market_data_id = aquis_equities_orders_atp_v4_0.market_data_id.dissect(buffer, index, packet, parent)

  -- Status: Struct of 2 fields
  index, status = aquis_equities_orders_atp_v4_0.status.dissect(buffer, index, packet, parent)

  -- Traded Quantity: u32
  index, traded_quantity = aquis_equities_orders_atp_v4_0.traded_quantity.dissect(buffer, index, packet, parent)
  ...
  index, order_add_response_flags = aquis_equities_orders_atp_v4_0.order_add_response_flags.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.order_add_response_message.dissect = function(buffer, offset, packet, parent)
  if show.order_add_response_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_add_response_message.display(packet, parent, length)
    parent:append_text(display)
...
aquis_equities_orders_atp_v4_0.order_modify_extended_message = {}

-- Size: Order Modify Extended Message
aquis_equities_orders_atp_v4_0.order_modify_extended_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size + 
  ...
  aquis_equities_orders_atp_v4_0.short_code_3.size + 
  aquis_equities_orders_atp_v4_0.order_capacity.size + 
  aquis_equities_orders_atp_v4_0.display_quantity.size + 
  aquis_equities_orders_atp_v4_0.min_qty.size + 
  aquis_equities_orders_atp_v4_0.reserved_u_648.size

-- Display: Order Modify Extended Message
aquis_equities_orders_atp_v4_0.order_modify_extended_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Modify Extended Message
aquis_equities_orders_atp_v4_0.order_modify_extended_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, display_quantity = aquis_equities_orders_atp_v4_0.display_quantity.dissect(buffer, index, packet, parent)

  -- Min Qty: u32
  index, min_qty = aquis_equities_orders_atp_v4_0.min_qty.dissect(buffer, index, packet, parent)

  -- Reserved U 648: u64
  index, reserved_u_648 = aquis_equities_orders_atp_v4_0.reserved_u_648.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.order_modify_extended_message.dissect = function(buffer, offset, packet, parent)
  if show.order_modify_extended_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_modify_extended_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.order_modify_extended_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Modify Message
aquis_equities_orders_atp_v4_0.order_modify_message = {}

-- Size: Order Modify Message
aquis_equities_orders_atp_v4_0.order_modify_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size + 
...
aquis_equities_orders_atp_v4_0.order_modify_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Modify Message
aquis_equities_orders_atp_v4_0.order_modify_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
aquis_equities_orders_atp_v4_0.order_modify_message.dissect = function(buffer, offset, packet, parent)
  if show.order_modify_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_modify_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.order_modify_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Cancel Message
aquis_equities_orders_atp_v4_0.order_cancel_message = {}

-- Size: Order Cancel Message
aquis_equities_orders_atp_v4_0.order_cancel_message.size =
  aquis_equities_orders_atp_v4_0.order_ref.size + 
  aquis_equities_orders_atp_v4_0.user_tag.size + 
  aquis_equities_orders_atp_v4_0.flags.size + 
  aquis_equities_orders_atp_v4_0.table_select_1.size + 
...
aquis_equities_orders_atp_v4_0.order_cancel_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Message
aquis_equities_orders_atp_v4_0.order_cancel_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
aquis_equities_orders_atp_v4_0.order_cancel_message.dissect = function(buffer, offset, packet, parent)
  if show.order_cancel_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_cancel_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.order_cancel_message.fields(buffer, offset, packet, parent)
  end
end
...
aquis_equities_orders_atp_v4_0.extended_order_flags.size = 1

-- Display: Extended Order Flags
aquis_equities_orders_atp_v4_0.extended_order_flags.display = function(range, value, packet, parent)
  local flags = {}
...
aquis_equities_orders_atp_v4_0.extended_order_flags.bits = function(range, value, packet, parent)
  ...
  -- Routetolit: 1 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.routetolit, range, value)

  -- Routing: 3 Bit Enum with 5 values
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.routing, range, value)

  -- Reserved 2: 2 Bit
  parent:add(omi_aquis_equities_orders_atp_v4_0.fields.reserved_2, range, value)
end

-- Dissect: Extended Order Flags
aquis_equities_orders_atp_v4_0.extended_order_flags.dissect = function(buffer, offset, packet, parent)
  local size = aquis_equities_orders_atp_v4_0.extended_order_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = aquis_equities_orders_atp_v4_0.extended_order_flags.display(range, value, packet, parent)
  local element = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.extended_order_flags, range, display)

  if show.extended_order_flags then
    aquis_equities_orders_atp_v4_0.extended_order_flags.bits(range, value, packet, element)
  end
...
aquis_equities_orders_atp_v4_0.order_add_extended_message = {}

-- Size: Order Add Extended Message
aquis_equities_orders_atp_v4_0.order_add_extended_message.size =
  aquis_equities_orders_atp_v4_0.security_id_u_162.size + 
  aquis_equities_orders_atp_v4_0.order_type.size + 
  aquis_equities_orders_atp_v4_0.time_in_force.size + 
  aquis_equities_orders_atp_v4_0.side.size + 
  aquis_equities_orders_atp_v4_0.quantity.size + 
  aquis_equities_orders_atp_v4_0.price.size + 
  ...
  aquis_equities_orders_atp_v4_0.display_quantity.size + 
  aquis_equities_orders_atp_v4_0.min_qty.size + 
  aquis_equities_orders_atp_v4_0.extended_order_flags.size + 
  aquis_equities_orders_atp_v4_0.reserved_u_648.size + 
  aquis_equities_orders_atp_v4_0.designated_order_id.size + 
  aquis_equities_orders_atp_v4_0.reserved_u_162.size + 
  aquis_equities_orders_atp_v4_0.peg_difference.size

-- Display: Order Add Extended Message
aquis_equities_orders_atp_v4_0.order_add_extended_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Add Extended Message
aquis_equities_orders_atp_v4_0.order_add_extended_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  -- Order Type: u8
  index, order_type = aquis_equities_orders_atp_v4_0.order_type.dissect(buffer, index, packet, parent)
  ...
  index, extended_order_flags = aquis_equities_orders_atp_v4_0.extended_order_flags.dissect(buffer, index, packet, parent)

  -- Reserved U 648: u64
  index, reserved_u_648 = aquis_equities_orders_atp_v4_0.reserved_u_648.dissect(buffer, index, packet, parent)

  -- Designated Order Id: u64
  index, designated_order_id = aquis_equities_orders_atp_v4_0.designated_order_id.dissect(buffer, index, packet, parent)

  -- Reserved U 162: u16
  index, reserved_u_162 = aquis_equities_orders_atp_v4_0.reserved_u_162.dissect(buffer, index, packet, parent)

  -- Peg Difference: s64
  index, peg_difference = aquis_equities_orders_atp_v4_0.peg_difference.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.order_add_extended_message.dissect = function(buffer, offset, packet, parent)
  if show.order_add_extended_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_add_extended_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.order_add_extended_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Add Message
aquis_equities_orders_atp_v4_0.order_add_message = {}

-- Size: Order Add Message
aquis_equities_orders_atp_v4_0.order_add_message.size =
  aquis_equities_orders_atp_v4_0.security_id_u_162.size + 
  aquis_equities_orders_atp_v4_0.order_type.size + 
  aquis_equities_orders_atp_v4_0.time_in_force.size + 
  aquis_equities_orders_atp_v4_0.side.size + 
...
aquis_equities_orders_atp_v4_0.order_add_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Add Message
aquis_equities_orders_atp_v4_0.order_add_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
aquis_equities_orders_atp_v4_0.order_add_message.dissect = function(buffer, offset, packet, parent)
  if show.order_add_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.order_add_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.order_add_message.fields(buffer, offset, packet, parent)
  end
end
...
-- Size: Logout Message
aquis_equities_orders_atp_v4_0.logout_message.size =
  aquis_equities_orders_atp_v4_0.logout_reason_code.size + 
  aquis_equities_orders_atp_v4_0.reason_text.size

-- Display: Logout Message
aquis_equities_orders_atp_v4_0.logout_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Logout Message
aquis_equities_orders_atp_v4_0.logout_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Logout Reason Code: u8
  index, logout_reason_code = aquis_equities_orders_atp_v4_0.logout_reason_code.dissect(buffer, index, packet, parent)

  -- Reason Text: char(32)
  index, reason_text = aquis_equities_orders_atp_v4_0.reason_text.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.logout_message.dissect = function(buffer, offset, packet, parent)
  if show.logout_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.logout_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.logout_message.fields(buffer, offset, packet, parent)
  end
end
...
aquis_equities_orders_atp_v4_0.login_response_message.size =
  aquis_equities_orders_atp_v4_0.result_code.size + 
  aquis_equities_orders_atp_v4_0.client_seq_no.size

-- Display: Login Response Message
aquis_equities_orders_atp_v4_0.login_response_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Response Message
aquis_equities_orders_atp_v4_0.login_response_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Result Code: u8
  index, result_code = aquis_equities_orders_atp_v4_0.result_code.dissect(buffer, index, packet, parent)

  -- Client Seq No: u32
  index, client_seq_no = aquis_equities_orders_atp_v4_0.client_seq_no.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.login_response_message.dissect = function(buffer, offset, packet, parent)
  if show.login_response_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.login_response_message.display(packet, parent, length)
    parent:append_text(display)
...
-- Login Message
aquis_equities_orders_atp_v4_0.login_message = {}

-- Size: Login Message
aquis_equities_orders_atp_v4_0.login_message.size =
  aquis_equities_orders_atp_v4_0.protocol_version.size + 
  aquis_equities_orders_atp_v4_0.sender_id.size + 
  aquis_equities_orders_atp_v4_0.password.size + 
  aquis_equities_orders_atp_v4_0.inactivity_timeout.size + 
  aquis_equities_orders_atp_v4_0.atp_seq_no.size

-- Display: Login Message
aquis_equities_orders_atp_v4_0.login_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Message
aquis_equities_orders_atp_v4_0.login_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Protocol Version: u16
  index, protocol_version = aquis_equities_orders_atp_v4_0.protocol_version.dissect(buffer, index, packet, parent)

  -- Sender Id: char(16)
  index, sender_id = aquis_equities_orders_atp_v4_0.sender_id.dissect(buffer, index, packet, parent)

  -- Password: char(16)
  index, password = aquis_equities_orders_atp_v4_0.password.dissect(buffer, index, packet, parent)

  -- Inactivity Timeout: u16
  index, inactivity_timeout = aquis_equities_orders_atp_v4_0.inactivity_timeout.dissect(buffer, index, packet, parent)

  -- Atp Seq No: u32
  index, atp_seq_no = aquis_equities_orders_atp_v4_0.atp_seq_no.dissect(buffer, index, packet, parent)
...
aquis_equities_orders_atp_v4_0.login_message.dissect = function(buffer, offset, packet, parent)
  if show.login_message then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.login_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.login_message.fields(buffer, offset, packet, parent)
  end
end
...
aquis_equities_orders_atp_v4_0.payload.branches = function(buffer, offset, packet, parent, msg_type)
  ...
  -- Dissect Login Response Message
  if msg_type == 2 then
    return aquis_equities_orders_atp_v4_0.login_response_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Heartbeat
  if msg_type == 0 then
  end
  ...
  -- Dissect Logout Message
  if msg_type == 4 then
    return aquis_equities_orders_atp_v4_0.logout_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Add Message
  if msg_type == 5 then
    return aquis_equities_orders_atp_v4_0.order_add_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Add Extended Message
  if msg_type == 21 then
    return aquis_equities_orders_atp_v4_0.order_add_extended_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Message
  if msg_type == 7 then
    return aquis_equities_orders_atp_v4_0.order_cancel_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Modify Message
  if msg_type == 9 then
    return aquis_equities_orders_atp_v4_0.order_modify_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Modify Extended Message
  if msg_type == 22 then
    return aquis_equities_orders_atp_v4_0.order_modify_extended_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Add Response Message
  if msg_type == 6 then
    return aquis_equities_orders_atp_v4_0.order_add_response_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Response Message
  if msg_type == 8 then
    return aquis_equities_orders_atp_v4_0.order_cancel_response_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Modify Response Message
  if msg_type == 10 then
    return aquis_equities_orders_atp_v4_0.order_modify_response_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Iceberg Order Refresh Message
  if msg_type == 23 then
    return aquis_equities_orders_atp_v4_0.iceberg_order_refresh_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Capture Message
  if msg_type == 17 then
    return aquis_equities_orders_atp_v4_0.trade_capture_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Capture Response Message
  if msg_type == 18 then
    return aquis_equities_orders_atp_v4_0.trade_capture_response_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Message
  if msg_type == 11 then
    return aquis_equities_orders_atp_v4_0.trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Bust Message
  if msg_type == 12 then
    return aquis_equities_orders_atp_v4_0.trade_bust_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Ioi Add Message
  if msg_type == 27 then
    return aquis_equities_orders_atp_v4_0.ioi_add_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Ioi Invite Message
  if msg_type == 28 then
    return aquis_equities_orders_atp_v4_0.ioi_invite_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Ioi Firmup Message
  if msg_type == 29 then
    return aquis_equities_orders_atp_v4_0.ioi_firmup_message.dissect(buffer, offset, packet, parent)
  end
...
-- Message Header
aquis_equities_orders_atp_v4_0.message_header = {}

-- Size: Message Header
aquis_equities_orders_atp_v4_0.message_header.size =
  aquis_equities_orders_atp_v4_0.msg_length.size + 
  aquis_equities_orders_atp_v4_0.msg_type.size + 
  aquis_equities_orders_atp_v4_0.msg_seq_no.size

-- Display: Message Header
aquis_equities_orders_atp_v4_0.message_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message Header
aquis_equities_orders_atp_v4_0.message_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Msg Length: 2 Byte Unsigned Fixed Width Integer
  index, msg_length = aquis_equities_orders_atp_v4_0.msg_length.dissect(buffer, index, packet, parent)

  -- Msg Type: 1 Byte Unsigned Fixed Width Integer Enum with 21 values
  index, msg_type = aquis_equities_orders_atp_v4_0.msg_type.dissect(buffer, index, packet, parent)

  -- Msg Seq No: 4 Byte Unsigned Fixed Width Integer
  index, msg_seq_no = aquis_equities_orders_atp_v4_0.msg_seq_no.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Message Header
aquis_equities_orders_atp_v4_0.message_header.dissect = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.message_header, buffer(offset, 0))
    local index = aquis_equities_orders_atp_v4_0.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = aquis_equities_orders_atp_v4_0.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return aquis_equities_orders_atp_v4_0.message_header.fields(buffer, offset, packet, parent)
  end
end

-- Message
aquis_equities_orders_atp_v4_0.message = {}

-- Display: Message
aquis_equities_orders_atp_v4_0.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
aquis_equities_orders_atp_v4_0.message.fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset

  -- Message Header: Struct of 3 fields
  index, message_header = aquis_equities_orders_atp_v4_0.message_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Msg Type
  local msg_type = buffer(index - 5, 1):uint()

  -- Payload: Runtime Type with 21 branches
  index = aquis_equities_orders_atp_v4_0.payload.dissect(buffer, index, packet, parent, msg_type)

  return index
end

-- Dissect: Message
aquis_equities_orders_atp_v4_0.message.dissect = function(buffer, offset, packet, parent, size_of_message)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_aquis_equities_orders_atp_v4_0.fields.message, buffer(offset, 0))
    local current = aquis_equities_orders_atp_v4_0.message.fields(buffer, offset, packet, parent, size_of_message)
    parent:set_len(size_of_message)
    local display = aquis_equities_orders_atp_v4_0.message.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    aquis_equities_orders_atp_v4_0.message.fields(buffer, offset, packet, parent, size_of_message)
...
local message_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < aquis_equities_orders_atp_v4_0.message_header.size then
...
-- Packet
aquis_equities_orders_atp_v4_0.packet = {}

-- Dissect Packet
aquis_equities_orders_atp_v4_0.packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = aquis_equities_orders_atp_v4_0.message.dissect(buffer, index, packet, parent, size_of_message)
    else
...
function omi_aquis_equities_orders_atp_v4_0.init()
end

-- Dissector for Aquis Equities Orders Atp 4.0
function omi_aquis_equities_orders_atp_v4_0.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = omi_aquis_equities_orders_atp_v4_0.name

  -- Dissect protocol
  local protocol = parent:add(omi_aquis_equities_orders_atp_v4_0, buffer(), omi_aquis_equities_orders_atp_v4_0.description, "("..buffer:len().." Bytes)")
  return aquis_equities_orders_atp_v4_0.packet.dissect(buffer, packet, protocol)
end

-- Register With Tcp Table
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add(65333, omi_aquis_equities_orders_atp_v4_0)
...
aquis_equities_orders_atp_v4_0.packet.requiredsize = function(buffer)

  return true
end

-- Dissector Heuristic for Aquis Equities Orders Atp 4.0
local function omi_aquis_equities_orders_atp_v4_0_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not aquis_equities_orders_atp_v4_0.packet.requiredsize(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = omi_aquis_equities_orders_atp_v4_0
  omi_aquis_equities_orders_atp_v4_0.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Aquis Equities Orders Atp 4.0
omi_aquis_equities_orders_atp_v4_0:register_heuristic("tcp", omi_aquis_equities_orders_atp_v4_0_heuristic)
