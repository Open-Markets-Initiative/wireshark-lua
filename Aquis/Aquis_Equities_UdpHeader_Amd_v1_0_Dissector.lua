...
function omi_aquis_equities_udpheader_amd_v1_0.prefs_changed()
  ...
  if show.message_index ~= omi_aquis_equities_udpheader_amd_v1_0.prefs.show_message_index then
    show.message_index = omi_aquis_equities_udpheader_amd_v1_0.prefs.show_message_index
  end
end
