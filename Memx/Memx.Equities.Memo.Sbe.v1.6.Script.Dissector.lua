...
memx_equities_memo_sbe_v1_6.fields.exec_inst = ProtoField.new("Exec Inst", "memx.equities.memo.sbe.v1.6.execinst", ftypes.UINT16)
...
dissect.exec_inst = function(buffer, offset, packet, parent)
  ...
  parent:add(memx_equities_memo_sbe_v1_6.fields.exec_inst, range, value, display)
...
-- Verify Version Field
verify.version = function(buffer)
  if 262 == buffer(1476, 2):uint() then
    return true
  end
