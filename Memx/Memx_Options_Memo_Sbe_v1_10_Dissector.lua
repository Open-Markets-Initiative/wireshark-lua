...
omi_memx_options_memo_sbe_v1_10.fields.cancel_orders_from_this_port_only = ProtoField.new("Cancel Orders From This Port Only", "memx.options.memo.sbe.v1.10.cancelordersfromthisportonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_memx_options_memo_sbe_v1_10.fields.external_routing_not_allowed = ProtoField.new("External Routing Not Allowed", "memx.options.memo.sbe.v1.10.externalroutingnotallowed", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
omi_memx_options_memo_sbe_v1_10.fields.intermarket_sweep = ProtoField.new("Intermarket Sweep", "memx.options.memo.sbe.v1.10.intermarketsweep", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_memx_options_memo_sbe_v1_10.fields.lockout = ProtoField.new("Lockout", "memx.options.memo.sbe.v1.10.lockout", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_memx_options_memo_sbe_v1_10.fields.participate_do_not_initiate = ProtoField.new("Participate Do Not Initiate", "memx.options.memo.sbe.v1.10.participatedonotinitiate", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_memx_options_memo_sbe_v1_10.fields.send_cancels = ProtoField.new("Send Cancels", "memx.options.memo.sbe.v1.10.sendcancels", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
-- Memx Options Sbe Memo 1.10 Application Messages
...
omi_memx_options_memo_sbe_v1_10.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_memx_options_memo_sbe_v1_10.prefs.show_parties_group_index = Pref.bool("Show Parties Group Index", show.parties_group_index, "Show generated parties group index in protocol tree")
omi_memx_options_memo_sbe_v1_10.prefs.show_two_sided_quotes_group_index = Pref.bool("Show Two Sided Quotes Group Index", show.two_sided_quotes_group_index, "Show generated two sided quotes group index in protocol tree")
omi_memx_options_memo_sbe_v1_10.prefs.show_one_sided_quotes_group_index = Pref.bool("Show One Sided Quotes Group Index", show.one_sided_quotes_group_index, "Show generated one sided quotes group index in protocol tree")
omi_memx_options_memo_sbe_v1_10.prefs.show_execution_allocations_group_index = Pref.bool("Show Execution Allocations Group Index", show.execution_allocations_group_index, "Show generated execution allocations group index in protocol tree")
omi_memx_options_memo_sbe_v1_10.prefs.show_requested_allocations_group_index = Pref.bool("Show Requested Allocations Group Index", show.requested_allocations_group_index, "Show generated requested allocations group index in protocol tree")
omi_memx_options_memo_sbe_v1_10.prefs.show_nested_parties_group_index = Pref.bool("Show Nested Parties Group Index", show.nested_parties_group_index, "Show generated nested parties group index in protocol tree")
omi_memx_options_memo_sbe_v1_10.prefs.show_reported_allocations_group_index = Pref.bool("Show Reported Allocations Group Index", show.reported_allocations_group_index, "Show generated reported allocations group index in protocol tree")

-- Handle changed preferences
function omi_memx_options_memo_sbe_v1_10.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_memx_options_memo_sbe_v1_10.prefs.show_application_messages then
    show.application_messages = omi_memx_options_memo_sbe_v1_10.prefs.show_application_messages
  end
  ...
  if show.parties_group_index ~= omi_memx_options_memo_sbe_v1_10.prefs.show_parties_group_index then
    show.parties_group_index = omi_memx_options_memo_sbe_v1_10.prefs.show_parties_group_index
  end
  if show.two_sided_quotes_group_index ~= omi_memx_options_memo_sbe_v1_10.prefs.show_two_sided_quotes_group_index then
    show.two_sided_quotes_group_index = omi_memx_options_memo_sbe_v1_10.prefs.show_two_sided_quotes_group_index
  end
  if show.one_sided_quotes_group_index ~= omi_memx_options_memo_sbe_v1_10.prefs.show_one_sided_quotes_group_index then
    show.one_sided_quotes_group_index = omi_memx_options_memo_sbe_v1_10.prefs.show_one_sided_quotes_group_index
  end
  if show.execution_allocations_group_index ~= omi_memx_options_memo_sbe_v1_10.prefs.show_execution_allocations_group_index then
    show.execution_allocations_group_index = omi_memx_options_memo_sbe_v1_10.prefs.show_execution_allocations_group_index
  end
  if show.requested_allocations_group_index ~= omi_memx_options_memo_sbe_v1_10.prefs.show_requested_allocations_group_index then
    show.requested_allocations_group_index = omi_memx_options_memo_sbe_v1_10.prefs.show_requested_allocations_group_index
  end
  if show.nested_parties_group_index ~= omi_memx_options_memo_sbe_v1_10.prefs.show_nested_parties_group_index then
    show.nested_parties_group_index = omi_memx_options_memo_sbe_v1_10.prefs.show_nested_parties_group_index
  end
  if show.reported_allocations_group_index ~= omi_memx_options_memo_sbe_v1_10.prefs.show_reported_allocations_group_index then
    show.reported_allocations_group_index = omi_memx_options_memo_sbe_v1_10.prefs.show_reported_allocations_group_index
  end
end
...
memx_options_memo_sbe_v1_10.nested_parties_groups.dissect = function(buffer, offset, packet, parent)
  if show.nested_parties_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.nested_parties_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.nested_parties_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.nested_parties_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.reported_allocations_group.fields = function(buffer, offset, packet, parent, reported_allocations_group_index)
  ...
  -- Trading Capacity Optional: TradingCapacityType
...
memx_options_memo_sbe_v1_10.reported_allocations_groups.dissect = function(buffer, offset, packet, parent)
  if show.reported_allocations_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.reported_allocations_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.reported_allocations_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.reported_allocations_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.execution_allocations_groups.dissect = function(buffer, offset, packet, parent)
  if show.execution_allocations_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.execution_allocations_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.execution_allocations_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.execution_allocations_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.allocation_instruction_alert_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.allocation_instruction_alert_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.allocation_instruction_alert_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.allocation_instruction_alert_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.allocation_instruction_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.allocation_instruction_ack_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.allocation_instruction_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.allocation_instruction_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.parties_groups.dissect = function(buffer, offset, packet, parent)
  if show.parties_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.parties_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.parties_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.parties_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.execution_report_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.execution_report_trade_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.execution_report_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.execution_report_trade_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.execution_report_bulk_quote_pending_new_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.execution_report_bulk_quote_pending_new_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.execution_report_bulk_quote_pending_new_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.execution_report_bulk_quote_pending_new_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.execution_report_new_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.execution_report_new_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.execution_report_new_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.execution_report_new_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.requested_allocations_groups.dissect = function(buffer, offset, packet, parent)
  if show.requested_allocations_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.requested_allocations_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.requested_allocations_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.requested_allocations_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.allocation_instruction_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.allocation_instruction_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.allocation_instruction_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.allocation_instruction_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.one_sided_quotes_groups.dissect = function(buffer, offset, packet, parent)
  if show.one_sided_quotes_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.one_sided_quotes_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.one_sided_quotes_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.one_sided_quotes_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.long_one_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.long_one_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.long_one_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.long_one_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.short_one_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.short_one_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.short_one_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.short_one_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.two_sided_quotes_groups.dissect = function(buffer, offset, packet, parent)
  if show.two_sided_quotes_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.two_sided_quotes_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.two_sided_quotes_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.two_sided_quotes_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.long_two_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.long_two_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.long_two_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.long_two_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.short_two_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.short_two_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.short_two_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.short_two_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.new_order_single_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.new_order_single_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.new_order_single_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.new_order_single_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.sbe_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.sequenced_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_10.unsequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.unsequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_10.fields.unsequenced_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_10.unsequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_10.unsequenced_message.display(packet, parent, length)
    parent:append_text(display)
