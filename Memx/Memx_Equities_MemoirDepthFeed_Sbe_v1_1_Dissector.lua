...
memx_equities_memoirdepthfeed_sbe_v1_1_display.snapshot_complete_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.clear_book_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.corrected_trade_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.broken_trade_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.trade_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.order_executed_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.order_reduced_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.order_deleted_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.order_added_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.trading_session_status_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.security_trading_status_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.reg_sho_restriction_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.instrument_directory_message = function(packet, parent, length)
  return ""
end
...
-- Display: Sbe Header
memx_equities_memoirdepthfeed_sbe_v1_1_display.sbe_header = function(packet, parent, length)
  return ""
end
...
-- Display: Sbe Message
memx_equities_memoirdepthfeed_sbe_v1_1_display.sbe_message = function(packet, parent, length)
  return ""
end
...
-- Display: Message
memx_equities_memoirdepthfeed_sbe_v1_1_display.message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.sequenced_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memoirdepthfeed_sbe_v1_1_dissect.sequenced_message_fields = function(buffer, offset, packet, parent)
  ...
  while index < end_of_payload do
    index, message = memx_equities_memoirdepthfeed_sbe_v1_1_dissect.message(buffer, index, packet, parent)
  end
...
memx_equities_memoirdepthfeed_sbe_v1_1_display.common_header = function(packet, parent, length)
  return ""
end
