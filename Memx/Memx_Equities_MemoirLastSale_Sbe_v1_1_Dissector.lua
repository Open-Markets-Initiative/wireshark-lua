...
-- Memx Equities Sbe MemoirLastSale 1.1 Application Messages
...
-- Memx Equities MemoirLastSale Sbe 1.1 generated fields
omi_memx_equities_memoirlastsale_sbe_v1_1.fields.message_index = ProtoField.new("Message Index", "memx.equities.memoirlastsale.sbe.v1.1.messageindex", ftypes.UINT16)
...
omi_memx_equities_memoirlastsale_sbe_v1_1.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
memx_equities_memoirlastsale_sbe_v1_1.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_equities_memoirlastsale_sbe_v1_1.fields.sbe_message, buffer(offset, 0))
    local index = memx_equities_memoirlastsale_sbe_v1_1.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_equities_memoirlastsale_sbe_v1_1.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_equities_memoirlastsale_sbe_v1_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset
...
-- Dissect: Message
memx_equities_memoirlastsale_sbe_v1_1.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_memx_equities_memoirlastsale_sbe_v1_1.fields.message, buffer(offset, 0))
    local current = memx_equities_memoirlastsale_sbe_v1_1.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    memx_equities_memoirlastsale_sbe_v1_1.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
memx_equities_memoirlastsale_sbe_v1_1.sequenced_message.fields = function(buffer, offset, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index, message = memx_equities_memoirlastsale_sbe_v1_1.message.dissect(buffer, index, packet, parent, size_of_message, message_index)
  end
...
memx_equities_memoirlastsale_sbe_v1_1.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_equities_memoirlastsale_sbe_v1_1.fields.sequenced_message, buffer(offset, 0))
    local index = memx_equities_memoirlastsale_sbe_v1_1.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_equities_memoirlastsale_sbe_v1_1.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
