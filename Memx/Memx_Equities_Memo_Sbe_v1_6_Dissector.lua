...
memx_equities_memo_sbe_v1_6.schema_id.verify = function(buffer)
...
memx_equities_memo_sbe_v1_6.version.verify = function(buffer)
  -- Attempt to read field
...
memx_equities_memo_sbe_v1_6.schema_id.verify = function(buffer)
  -- Attempt to read field
  local value = buffer(1483, 1):uint()
...
memx_equities_memo_sbe_v1_6.version.verify = function(buffer)
  -- Attempt to read field
  local value = buffer(1484, 2):uint()
...
local function omi_memx_equities_memo_sbe_v1_6_heuristic(buffer, packet, parent)
  ...
  -- Verify Schema Id
  if not memx_equities_memo_sbe_v1_6.schema_id.verify(buffer) then return false end

  -- Verify Version
  if not memx_equities_memo_sbe_v1_6.version.verify(buffer) then return false end
