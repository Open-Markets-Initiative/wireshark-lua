...
-- Memx Options MemoirDepth Sbe 1.6.a generated fields
omi_memx_options_memoirdepth_sbe_v1_6_a.fields.message_index = ProtoField.new("Message Index", "memx.options.memoirdepth.sbe.v1.6.a.messageindex", ftypes.UINT16)
...
memx_options_memoirdepth_sbe_v1_6_a.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memoirdepth_sbe_v1_6_a.fields.sbe_message, buffer(offset, 0))
    local index = memx_options_memoirdepth_sbe_v1_6_a.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memoirdepth_sbe_v1_6_a.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memoirdepth_sbe_v1_6_a.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset
...
-- Dissect: Message
memx_options_memoirdepth_sbe_v1_6_a.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_memx_options_memoirdepth_sbe_v1_6_a.fields.message, buffer(offset, 0))
    local current = memx_options_memoirdepth_sbe_v1_6_a.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    memx_options_memoirdepth_sbe_v1_6_a.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
memx_options_memoirdepth_sbe_v1_6_a.sequenced_message.fields = function(buffer, offset, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index, message = memx_options_memoirdepth_sbe_v1_6_a.message.dissect(buffer, index, packet, parent, size_of_message, message_index)
  end
...
memx_options_memoirdepth_sbe_v1_6_a.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memoirdepth_sbe_v1_6_a.fields.sequenced_message, buffer(offset, 0))
    local index = memx_options_memoirdepth_sbe_v1_6_a.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memoirdepth_sbe_v1_6_a.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
