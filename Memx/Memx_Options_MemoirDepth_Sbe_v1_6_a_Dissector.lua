...
-- Intermarket Sweep
memx_options_memoirdepth_sbe_v1_6_a.intermarket_sweep = {}

-- Reserved 7
memx_options_memoirdepth_sbe_v1_6_a.reserved_7 = {}
...
memx_options_memoirdepth_sbe_v1_6_a.trade_conditions.display = function(buffer, packet, parent)
  local display = ""
...
memx_options_memoirdepth_sbe_v1_6_a.trade_conditions.bits = function(buffer, offset, packet, parent)
...
memx_options_memoirdepth_sbe_v1_6_a.trade_conditions.dissect = function(buffer, offset, packet, parent)
  ...
  local display = memx_options_memoirdepth_sbe_v1_6_a.trade_conditions.display(range, packet, parent)
  ...
  if show.trade_conditions then
    memx_options_memoirdepth_sbe_v1_6_a.trade_conditions.bits(buffer, offset, packet, element)
  end
...
memx_options_memoirdepth_sbe_v1_6_a.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 1 then
    return memx_options_memoirdepth_sbe_v1_6_a.instrument_directory_message.size(buffer, offset)
  end
  -- Size of Options Instrument Status Message
  if template_id == 2 then
    return memx_options_memoirdepth_sbe_v1_6_a.options_instrument_status_message.size(buffer, offset)
  end
  -- Size of Underlier Instrument Status Message
  if template_id == 3 then
    return memx_options_memoirdepth_sbe_v1_6_a.underlier_instrument_status_message.size(buffer, offset)
  end
  -- Size of Broken Trade Message
  if template_id == 5 then
    return memx_options_memoirdepth_sbe_v1_6_a.broken_trade_message.size(buffer, offset)
  end
  -- Size of Corrected Trade Message
  if template_id == 6 then
    return memx_options_memoirdepth_sbe_v1_6_a.corrected_trade_message.size(buffer, offset)
  end
  -- Size of Snapshot Complete Message
  if template_id == 7 then
    return memx_options_memoirdepth_sbe_v1_6_a.snapshot_complete_message.size(buffer, offset)
  end
  -- Size of Order Added Short Message
  if template_id == 10 then
    return memx_options_memoirdepth_sbe_v1_6_a.order_added_short_message.size(buffer, offset)
  end
  -- Size of Order Added Long Message
  if template_id == 11 then
    return memx_options_memoirdepth_sbe_v1_6_a.order_added_long_message.size(buffer, offset)
  end
  -- Size of Order Added Extended Message
  if template_id == 12 then
    return memx_options_memoirdepth_sbe_v1_6_a.order_added_extended_message.size(buffer, offset)
  end
  -- Size of Order Deleted Message
  if template_id == 13 then
    return memx_options_memoirdepth_sbe_v1_6_a.order_deleted_message.size(buffer, offset)
  end
  -- Size of Order Reduced Message
  if template_id == 14 then
    return memx_options_memoirdepth_sbe_v1_6_a.order_reduced_message.size(buffer, offset)
  end
  -- Size of Order Executed Message
  if template_id == 15 then
    return memx_options_memoirdepth_sbe_v1_6_a.order_executed_message.size(buffer, offset)
  end
  -- Size of Clear Book Message
  if template_id == 18 then
    return memx_options_memoirdepth_sbe_v1_6_a.clear_book_message.size(buffer, offset)
  end
