...
memx_equities_memo_sbe_v1_2_display.mass_cancel_reject_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.mass_cancel_reject_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_reject_message then
    ...
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.mass_cancel_reject_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.mass_cancel_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.mass_cancel_reject_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.mass_cancel_reject_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.order_cancel_reject_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.order_cancel_reject_message = function(buffer, offset, packet, parent)
  if show.order_cancel_reject_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.order_cancel_reject_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.order_cancel_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.order_cancel_reject_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.order_cancel_reject_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_restatement_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_restatement_message = function(buffer, offset, packet, parent)
  if show.execution_report_restatement_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_restatement_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_restatement_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_restatement_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_restatement_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_trade_break_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_break_message = function(buffer, offset, packet, parent)
  if show.execution_report_trade_break_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_trade_break_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_break_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_trade_break_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_break_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_trade_correction_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_correction_message = function(buffer, offset, packet, parent)
  if show.execution_report_trade_correction_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_trade_correction_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_correction_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_trade_correction_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_correction_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_replaced_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_replaced_message = function(buffer, offset, packet, parent)
  if show.execution_report_replaced_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_replaced_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_replaced_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_replaced_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_replaced_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_pending_replace_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_replace_message = function(buffer, offset, packet, parent)
  if show.execution_report_pending_replace_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_pending_replace_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_replace_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_pending_replace_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_replace_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.mass_cancel_done_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.mass_cancel_done_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_done_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.mass_cancel_done_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.mass_cancel_done_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.mass_cancel_done_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.mass_cancel_done_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_canceled_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_canceled_message = function(buffer, offset, packet, parent)
  if show.execution_report_canceled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_canceled_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_canceled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_canceled_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_canceled_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.pending_mass_cancel_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.pending_mass_cancel_message = function(buffer, offset, packet, parent)
  if show.pending_mass_cancel_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.pending_mass_cancel_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.pending_mass_cancel_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.pending_mass_cancel_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.pending_mass_cancel_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_pending_cancel_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_cancel_message = function(buffer, offset, packet, parent)
  if show.execution_report_pending_cancel_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_pending_cancel_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_cancel_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_pending_cancel_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_cancel_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_trade_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_message = function(buffer, offset, packet, parent)
  if show.execution_report_trade_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_trade_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_trade_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_trade_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_rejected_message = function(buffer, offset, packet, parent)
  if show.execution_report_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_rejected_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_new_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_new_message = function(buffer, offset, packet, parent)
  if show.execution_report_new_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_new_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_new_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_new_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_new_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.execution_report_pending_new_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_new_message = function(buffer, offset, packet, parent)
  if show.execution_report_pending_new_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.execution_report_pending_new_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_new_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.execution_report_pending_new_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.execution_report_pending_new_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.mass_cancel_request_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.mass_cancel_request_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.mass_cancel_request_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.mass_cancel_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.mass_cancel_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.mass_cancel_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.order_cancel_request_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.order_cancel_request_message = function(buffer, offset, packet, parent)
  if show.order_cancel_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.order_cancel_request_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.order_cancel_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.order_cancel_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.order_cancel_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.order_cancel_replace_request_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.order_cancel_replace_request_message = function(buffer, offset, packet, parent)
  if show.order_cancel_replace_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.order_cancel_replace_request_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.order_cancel_replace_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.order_cancel_replace_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.order_cancel_replace_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.new_order_single_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.new_order_single_message = function(buffer, offset, packet, parent)
  if show.new_order_single_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.new_order_single_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.new_order_single_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.new_order_single_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.new_order_single_message_fields(buffer, offset, packet, element)
  end
end
...
-- Display: Sbe Header
memx_equities_memo_sbe_v1_2_display.sbe_header = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.sbe_header = function(buffer, offset, packet, parent)
  if show.sbe_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.sbe_header, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.sbe_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.sbe_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.sbe_header_fields(buffer, offset, packet, element)
  end
end
...
-- Display: Sbe Message
memx_equities_memo_sbe_v1_2_display.sbe_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_display.sequenced_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_display.stream_complete_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.stream_complete_message = function(buffer, offset, packet, parent)
  if show.stream_complete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.stream_complete_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.stream_complete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.stream_complete_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.stream_complete_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.stream_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.stream_rejected_message = function(buffer, offset, packet, parent)
  if show.stream_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.stream_rejected_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.stream_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.stream_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.stream_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.stream_begin_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.stream_begin_message = function(buffer, offset, packet, parent)
  if show.stream_begin_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.stream_begin_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.stream_begin_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.stream_begin_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.stream_begin_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.replay_complete_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.replay_complete_message = function(buffer, offset, packet, parent)
  if show.replay_complete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.replay_complete_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.replay_complete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.replay_complete_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.replay_complete_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.replay_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.replay_rejected_message = function(buffer, offset, packet, parent)
  if show.replay_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.replay_rejected_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.replay_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.replay_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.replay_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.replay_begin_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.replay_begin_message = function(buffer, offset, packet, parent)
  if show.replay_begin_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.replay_begin_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.replay_begin_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.replay_begin_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.replay_begin_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.start_of_session_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.start_of_session_message = function(buffer, offset, packet, parent)
  if show.start_of_session_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.start_of_session_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.start_of_session_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.start_of_session_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.start_of_session_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.login_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.login_rejected_message = function(buffer, offset, packet, parent)
  if show.login_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.login_rejected_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.login_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.login_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.login_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.login_accepted_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.login_accepted_message = function(buffer, offset, packet, parent)
  if show.login_accepted_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.login_accepted_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.login_accepted_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.login_accepted_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.login_accepted_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.unsequenced_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_display.stream_request_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.stream_request_message = function(buffer, offset, packet, parent)
  if show.stream_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.stream_request_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.stream_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.stream_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.stream_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.replay_all_request_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.replay_all_request_message = function(buffer, offset, packet, parent)
  if show.replay_all_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.replay_all_request_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.replay_all_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.replay_all_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.replay_all_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.replay_request_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.replay_request_message = function(buffer, offset, packet, parent)
  if show.replay_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.replay_request_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.replay_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.replay_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.replay_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.login_request_message = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.login_request_message = function(buffer, offset, packet, parent)
  if show.login_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.login_request_message, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.login_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.login_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.login_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_equities_memo_sbe_v1_2_display.common_header = function(packet, parent, length)
  return ""
end
...
memx_equities_memo_sbe_v1_2_dissect.common_header = function(buffer, offset, packet, parent)
  if show.common_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_equities_memo_sbe_v1_2.fields.common_header, buffer(offset, 0))
    local index = memx_equities_memo_sbe_v1_2_dissect.common_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_equities_memo_sbe_v1_2_display.common_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_equities_memo_sbe_v1_2_dissect.common_header_fields(buffer, offset, packet, element)
  end
end
