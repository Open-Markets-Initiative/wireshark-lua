...
memx_equities_memoirlastsale_sbe_v1_1_display.trade_correct_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.trade_correct_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_correct_message then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.trade_correct_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.trade_correct_message(buffer, packet, parent)
...
memx_equities_memoirlastsale_sbe_v1_1_display.trade_cancel_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.trade_cancel_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_cancel_message then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.trade_cancel_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.trade_cancel_message(buffer, packet, parent)
...
memx_equities_memoirlastsale_sbe_v1_1_display.trade_report_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.trade_report_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_report_message then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.trade_report_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.trade_report_message(buffer, packet, parent)
...
memx_equities_memoirlastsale_sbe_v1_1_display.trading_session_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.trading_session_status_message = function(buffer, offset, packet, parent)
  ...
  if show.trading_session_status_message then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.trading_session_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.trading_session_status_message(buffer, packet, parent)
...
memx_equities_memoirlastsale_sbe_v1_1_display.security_trading_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.security_trading_status_message = function(buffer, offset, packet, parent)
  ...
  if show.security_trading_status_message then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.security_trading_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.security_trading_status_message(buffer, packet, parent)
...
memx_equities_memoirlastsale_sbe_v1_1_display.reg_sho_restriction_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.reg_sho_restriction_message = function(buffer, offset, packet, parent)
  ...
  if show.reg_sho_restriction_message then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.reg_sho_restriction_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.reg_sho_restriction_message(buffer, packet, parent)
...
memx_equities_memoirlastsale_sbe_v1_1_display.instrument_directory_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.instrument_directory_message = function(buffer, offset, packet, parent)
  ...
  if show.instrument_directory_message then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.instrument_directory_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.instrument_directory_message(buffer, packet, parent)
...
-- Display: Sbe Header
memx_equities_memoirlastsale_sbe_v1_1_display.sbe_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.sbe_header = function(buffer, offset, packet, parent)
  ...
  if show.sbe_header then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.sbe_header(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.sbe_header(buffer, packet, parent)
...
-- Display: Sbe Message
memx_equities_memoirlastsale_sbe_v1_1_display.sbe_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
-- Display: Message
memx_equities_memoirlastsale_sbe_v1_1_display.message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_display.sequenced_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.sequenced_message_fields = function(buffer, offset, packet, parent)
  ...
  while index < end_of_payload do
    index = memx_equities_memoirlastsale_sbe_v1_1_dissect.message(buffer, index, packet, parent)
  end
...
memx_equities_memoirlastsale_sbe_v1_1_display.common_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirlastsale_sbe_v1_1_dissect.common_header = function(buffer, offset, packet, parent)
  ...
  if show.common_header then
    local length = memx_equities_memoirlastsale_sbe_v1_1_size_of.common_header(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirlastsale_sbe_v1_1_display.common_header(buffer, packet, parent)
