...
memx_options_riskcontrol_sbe_v1_7.fields.sending_time = ProtoField.new("Sending Time", "memx.options.riskcontrol.sbe.v1.7.sendingtime", ftypes.UINT64)
...
memx_options_riskcontrol_sbe_v1_7.fields.transact_time = ProtoField.new("Transact Time", "memx.options.riskcontrol.sbe.v1.7.transacttime", ftypes.UINT64)
...
memx_options_riskcontrol_sbe_v1_7_display.cp_order_rate_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_duplicate_order_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_market_order_net_notional_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_net_notional_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_market_order_gross_notional_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_gross_notional_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.breach_clear_all_by_efid_or_underlier_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.breach_clear_all_by_efid_or_underlier_accepted_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.breach_clear_all_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.breach_clear_all_accepted_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.breach_cleared_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.breach_clear_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.manual_cp_breach_trigger_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.risk_settings_query_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.risk_settings_query_done_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_restricted_underlier_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_allow_market_orders_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_max_contracts_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_max_notional_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_allow_orders_in_crossed_market_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_allow_iso_orders_state_message = function(packet, parent, length)
  return ""
end
...
-- Size: Transact Time
memx_options_riskcontrol_sbe_v1_7_size_of.transact_time = 8
...
memx_options_riskcontrol_sbe_v1_7_display.passive_risk_threshold_notification_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.risk_threshold_update_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.manual_cp_breach_trigger_done_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.manual_cp_breach_trigger_pending_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_breach_count_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_percent_outstanding_contracts_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_total_executions_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_executed_notional_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_volume_threshold_state_message = function(packet, parent, length)
  return ""
end
...
-- Size: Last Px
memx_options_riskcontrol_sbe_v1_7_size_of.last_px = 8
...
-- Size: Sending Time
memx_options_riskcontrol_sbe_v1_7_size_of.sending_time = 8
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_quantity_update_notification_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_acknowledge_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_acknowledged_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_threshold_change_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_threshold_state_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_acknowledge_all_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_clear_all_breaches_by_efid_or_underlier_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_clear_all_breaches_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_order_rate_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_duplicate_order_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_market_order_net_notional_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_net_notional_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_market_order_gross_notional_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_gross_notional_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_restricted_underlier_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_allow_market_orders_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_max_contracts_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_max_notional_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_allow_orders_in_crossed_market_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.single_order_allow_iso_orders_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_clear_breach_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.manual_cp_breach_trigger_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_breach_count_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_percent_outstanding_contracts_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_total_executions_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_executed_notional_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.cp_volume_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_acknowledgement_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.active_risk_threshold_change_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.risk_settings_query_message = function(packet, parent, length)
  return ""
end
...
-- Display: Sbe Header
memx_options_riskcontrol_sbe_v1_7_display.sbe_header = function(packet, parent, length)
  return ""
end
...
-- Display: Sbe Message
memx_options_riskcontrol_sbe_v1_7_display.sbe_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.sequenced_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.stream_complete_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.stream_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.stream_begin_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.replay_complete_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.replay_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.replay_begin_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.start_of_session_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.login_rejected_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.login_accepted_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.unsequenced_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.stream_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.replay_all_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.replay_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.login_request_message = function(packet, parent, length)
  return ""
end
...
memx_options_riskcontrol_sbe_v1_7_display.common_header = function(packet, parent, length)
  return ""
end
