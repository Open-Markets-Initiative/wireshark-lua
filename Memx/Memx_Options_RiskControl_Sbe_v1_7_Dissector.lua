...
-- Memx Options Sbe RiskControl 1.7 Application Messages
...
memx_options_riskcontrol_sbe_v1_7.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_7.fields.sbe_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_7.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_7.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_7.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_7.fields.sequenced_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_7.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_7.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_7.unsequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.unsequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_7.fields.unsequenced_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_7.unsequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_7.unsequenced_message.display(packet, parent, length)
    parent:append_text(display)
