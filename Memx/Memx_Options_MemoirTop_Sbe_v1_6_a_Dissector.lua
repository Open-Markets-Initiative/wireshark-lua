...
memx_options_memoirtop_sbe_v1_6_a_dissect.clear_book_message = function(buffer, offset, packet, parent)
  if show.clear_book_message then
    ...
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.clear_book_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.clear_book_message_fields(buffer, offset, packet, element)
    ...
    return memx_options_memoirtop_sbe_v1_6_a_dissect.clear_book_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.trade_message = function(buffer, offset, packet, parent)
  if show.trade_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.trade_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.trade_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.trade_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.best_offer_short_message = function(buffer, offset, packet, parent)
  if show.best_offer_short_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.best_offer_short_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.best_offer_short_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.best_offer_short_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_short_message = function(buffer, offset, packet, parent)
  if show.best_bid_short_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.best_bid_short_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_short_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_short_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.best_offer_message = function(buffer, offset, packet, parent)
  if show.best_offer_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.best_offer_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.best_offer_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.best_offer_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_message = function(buffer, offset, packet, parent)
  if show.best_bid_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.best_bid_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_offer_message = function(buffer, offset, packet, parent)
  if show.best_bid_offer_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.best_bid_offer_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_offer_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.best_bid_offer_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.snapshot_complete_message = function(buffer, offset, packet, parent)
  if show.snapshot_complete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.snapshot_complete_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.snapshot_complete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.snapshot_complete_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.corrected_trade_message = function(buffer, offset, packet, parent)
  if show.corrected_trade_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.corrected_trade_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.corrected_trade_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.corrected_trade_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.broken_trade_message = function(buffer, offset, packet, parent)
  if show.broken_trade_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.broken_trade_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.broken_trade_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.broken_trade_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.underlier_instrument_status_message = function(buffer, offset, packet, parent)
  if show.underlier_instrument_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.underlier_instrument_status_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.underlier_instrument_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.underlier_instrument_status_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.options_instrument_status_message = function(buffer, offset, packet, parent)
  if show.options_instrument_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.options_instrument_status_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.options_instrument_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.options_instrument_status_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.instrument_directory_message = function(buffer, offset, packet, parent)
  if show.instrument_directory_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.instrument_directory_message, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.instrument_directory_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.instrument_directory_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.sbe_header = function(buffer, offset, packet, parent)
  if show.sbe_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.sbe_header, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.sbe_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.sbe_header_fields(buffer, offset, packet, element)
  end
end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.sequenced_message_fields = function(buffer, offset, packet, parent)
  ...
  while index < end_of_payload do
    index, message = memx_options_memoirtop_sbe_v1_6_a_dissect.message(buffer, index, packet, parent)
  end
...
memx_options_memoirtop_sbe_v1_6_a_dissect.common_header = function(buffer, offset, packet, parent)
  if show.common_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memoirtop_sbe_v1_6_a.fields.common_header, buffer(offset, 0))
    local index = memx_options_memoirtop_sbe_v1_6_a_dissect.common_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_memoirtop_sbe_v1_6_a_dissect.common_header_fields(buffer, offset, packet, element)
  end
end
