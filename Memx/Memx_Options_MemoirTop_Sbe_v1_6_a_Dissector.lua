...
-- Memx Options Sbe MemoirTop 1.6.a Application Messages
...
omi_memx_options_memoirtop_sbe_v1_6_a.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_memx_options_memoirtop_sbe_v1_6_a.prefs_changed()
  ...
  if show.message_index ~= omi_memx_options_memoirtop_sbe_v1_6_a.prefs.show_message_index then
    show.message_index = omi_memx_options_memoirtop_sbe_v1_6_a.prefs.show_message_index
  end
end
