...
omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs_changed()
  ...
  if show.message_index ~= omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_message_index then
    show.message_index = omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_message_index
  end
end
