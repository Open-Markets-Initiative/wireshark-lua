...
memx_equities_memoirtopofbook_sbe_v1_3.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.sbe_message, buffer(offset, 0))
    local index = memx_equities_memoirtopofbook_sbe_v1_3.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_equities_memoirtopofbook_sbe_v1_3.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.sequenced_message, buffer(offset, 0))
    local index = memx_equities_memoirtopofbook_sbe_v1_3.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
