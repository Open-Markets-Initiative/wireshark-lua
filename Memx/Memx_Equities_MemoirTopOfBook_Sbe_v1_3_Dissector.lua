...
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.as_of_sequence_number = ProtoField.new("As Of Sequence Number", "memx.equities.memoirtopofbook.sbe.v1.3.asofsequencenumber", ftypes.UINT64)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.bid_price = ProtoField.new("Bid Price", "memx.equities.memoirtopofbook.sbe.v1.3.bidprice", ftypes.DOUBLE)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.bid_price_short = ProtoField.new("Bid Price Short", "memx.equities.memoirtopofbook.sbe.v1.3.bidpriceshort", ftypes.DOUBLE)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.bid_size = ProtoField.new("Bid Size", "memx.equities.memoirtopofbook.sbe.v1.3.bidsize", ftypes.UINT32)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.bid_size_short = ProtoField.new("Bid Size Short", "memx.equities.memoirtopofbook.sbe.v1.3.bidsizeshort", ftypes.UINT16)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.block_length = ProtoField.new("Block Length", "memx.equities.memoirtopofbook.sbe.v1.3.blocklength", ftypes.UINT16)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.common_header = ProtoField.new("Common Header", "memx.equities.memoirtopofbook.sbe.v1.3.commonheader", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.header_length = ProtoField.new("Header Length", "memx.equities.memoirtopofbook.sbe.v1.3.headerlength", ftypes.UINT8)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.is_test_symbol = ProtoField.new("Is Test Symbol", "memx.equities.memoirtopofbook.sbe.v1.3.istestsymbol", ftypes.UINT8)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.message = ProtoField.new("Message", "memx.equities.memoirtopofbook.sbe.v1.3.message", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.message_count = ProtoField.new("Message Count", "memx.equities.memoirtopofbook.sbe.v1.3.messagecount", ftypes.UINT16)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.message_length = ProtoField.new("Message Length", "memx.equities.memoirtopofbook.sbe.v1.3.messagelength", ftypes.UINT16)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.message_type = ProtoField.new("Message Type", "memx.equities.memoirtopofbook.sbe.v1.3.messagetype", ftypes.UINT8)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.mpv = ProtoField.new("Mpv", "memx.equities.memoirtopofbook.sbe.v1.3.mpv", ftypes.DOUBLE)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.offer_price = ProtoField.new("Offer Price", "memx.equities.memoirtopofbook.sbe.v1.3.offerprice", ftypes.DOUBLE)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.offer_price_short = ProtoField.new("Offer Price Short", "memx.equities.memoirtopofbook.sbe.v1.3.offerpriceshort", ftypes.DOUBLE)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.offer_size = ProtoField.new("Offer size", "memx.equities.memoirtopofbook.sbe.v1.3.offersize", ftypes.UINT32)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.offer_size_uint_16 = ProtoField.new("Offer Size uint 16", "memx.equities.memoirtopofbook.sbe.v1.3.offersizeuint16", ftypes.UINT16)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.packet = ProtoField.new("Packet", "memx.equities.memoirtopofbook.sbe.v1.3.packet", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.payload = ProtoField.new("Payload", "memx.equities.memoirtopofbook.sbe.v1.3.payload", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.round_lot = ProtoField.new("Round Lot", "memx.equities.memoirtopofbook.sbe.v1.3.roundlot", ftypes.UINT32)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.sbe_header = ProtoField.new("Sbe Header", "memx.equities.memoirtopofbook.sbe.v1.3.sbeheader", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.sbe_message = ProtoField.new("Sbe Message", "memx.equities.memoirtopofbook.sbe.v1.3.sbemessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.schema_id = ProtoField.new("Schema Id", "memx.equities.memoirtopofbook.sbe.v1.3.schemaid", ftypes.UINT8)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.security_id = ProtoField.new("Security Id", "memx.equities.memoirtopofbook.sbe.v1.3.securityid", ftypes.UINT16)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.security_trading_status = ProtoField.new("Security Trading Status", "memx.equities.memoirtopofbook.sbe.v1.3.securitytradingstatus", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.security_trading_status_reason = ProtoField.new("Security Trading Status Reason", "memx.equities.memoirtopofbook.sbe.v1.3.securitytradingstatusreason", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.sequence_number = ProtoField.new("Sequence Number", "memx.equities.memoirtopofbook.sbe.v1.3.sequencenumber", ftypes.UINT64)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.sequenced_message = ProtoField.new("Sequenced Message", "memx.equities.memoirtopofbook.sbe.v1.3.sequencedmessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.sequenced_messages = ProtoField.new("Sequenced Messages", "memx.equities.memoirtopofbook.sbe.v1.3.sequencedmessages", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.session_id = ProtoField.new("Session Id", "memx.equities.memoirtopofbook.sbe.v1.3.sessionid", ftypes.UINT64)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.short_sale_restriction = ProtoField.new("Short Sale Restriction", "memx.equities.memoirtopofbook.sbe.v1.3.shortsalerestriction", ftypes.UINT8)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.symbol = ProtoField.new("Symbol", "memx.equities.memoirtopofbook.sbe.v1.3.symbol", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.symbol_sfx = ProtoField.new("Symbol Sfx", "memx.equities.memoirtopofbook.sbe.v1.3.symbolsfx", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.template_id = ProtoField.new("Template Id", "memx.equities.memoirtopofbook.sbe.v1.3.templateid", ftypes.UINT8)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.timestamp = ProtoField.new("Timestamp", "memx.equities.memoirtopofbook.sbe.v1.3.timestamp", ftypes.UINT64)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.trading_session = ProtoField.new("Trading Session", "memx.equities.memoirtopofbook.sbe.v1.3.tradingsession", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.version = ProtoField.new("Version", "memx.equities.memoirtopofbook.sbe.v1.3.version", ftypes.UINT16)

-- Memx Equities Sbe MemoirTopOfBook 1.3 Application Messages
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.best_bid_message = ProtoField.new("Best Bid Message", "memx.equities.memoirtopofbook.sbe.v1.3.bestbidmessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.best_bid_offer_message = ProtoField.new("Best Bid Offer Message", "memx.equities.memoirtopofbook.sbe.v1.3.bestbidoffermessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.best_bid_short_message = ProtoField.new("Best Bid Short Message", "memx.equities.memoirtopofbook.sbe.v1.3.bestbidshortmessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.best_offer_message = ProtoField.new("Best Offer Message", "memx.equities.memoirtopofbook.sbe.v1.3.bestoffermessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.best_offer_short_message = ProtoField.new("Best Offer Short Message", "memx.equities.memoirtopofbook.sbe.v1.3.bestoffershortmessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.clear_book_message = ProtoField.new("Clear Book Message", "memx.equities.memoirtopofbook.sbe.v1.3.clearbookmessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.instrument_directory_message = ProtoField.new("Instrument Directory Message", "memx.equities.memoirtopofbook.sbe.v1.3.instrumentdirectorymessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.reg_sho_restriction_message = ProtoField.new("Reg Sho Restriction Message", "memx.equities.memoirtopofbook.sbe.v1.3.regshorestrictionmessage", ftypes.STRING)
omi_memx_equities_memoirtopofbook_sbe_v1_3.fields.security_trading_status_message = ProtoField.new("Security Trading Status Message", "memx.equities.memoirtopofbook.sbe.v1.3.securitytradingstatusmessage", ftypes.STRING)
...
omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")
omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_sequenced_messages = Pref.bool("Show Sequenced Messages", show.sequenced_messages, "Parse and add Sequenced Messages to protocol tree")
...
function omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs_changed()
  ...
  if show.message ~= omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_message then
    show.message = omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_message
    changed = true
  end
  if show.packet ~= omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_packet then
  ...
  if show.sbe_message ~= omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_sbe_message then
  ...
  if show.payload ~= omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_payload then
    show.payload = omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_payload
    changed = true
  end
  if show.sequenced_messages ~= omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_sequenced_messages then
    show.sequenced_messages = omi_memx_equities_memoirtopofbook_sbe_v1_3.prefs.show_sequenced_messages
    changed = true
  end
...
memx_equities_memoirtopofbook_sbe_v1_3.clear_book_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size
...
memx_equities_memoirtopofbook_sbe_v1_3.best_offer_short_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.offer_size_uint_16.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.offer_price_short.size
...
memx_equities_memoirtopofbook_sbe_v1_3.best_bid_short_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.bid_size_short.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.bid_price_short.size
...
memx_equities_memoirtopofbook_sbe_v1_3.best_offer_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.offer_size.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.offer_price.size
...
memx_equities_memoirtopofbook_sbe_v1_3.best_bid_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.bid_size.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.bid_price.size
...
memx_equities_memoirtopofbook_sbe_v1_3.best_bid_offer_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.bid_size.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.bid_price.size + 
...
memx_equities_memoirtopofbook_sbe_v1_3.trading_session_status_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.trading_session.size
...
memx_equities_memoirtopofbook_sbe_v1_3.snapshot_complete_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.as_of_sequence_number.size
...
memx_equities_memoirtopofbook_sbe_v1_3.security_trading_status_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_trading_status.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_trading_status_reason.size
...
memx_equities_memoirtopofbook_sbe_v1_3.reg_sho_restriction_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.short_sale_restriction.size
...
memx_equities_memoirtopofbook_sbe_v1_3.instrument_directory_message.size =
  memx_equities_memoirtopofbook_sbe_v1_3.timestamp.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.security_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.symbol.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.symbol_sfx.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.round_lot.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.is_test_symbol.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.mpv.size
...
memx_equities_memoirtopofbook_sbe_v1_3.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 1 then
    return memx_equities_memoirtopofbook_sbe_v1_3.instrument_directory_message.size
  end
  -- Size of Reg Sho Restriction Message
  if template_id == 2 then
    return memx_equities_memoirtopofbook_sbe_v1_3.reg_sho_restriction_message.size
  end
  -- Size of Security Trading Status Message
  if template_id == 3 then
    return memx_equities_memoirtopofbook_sbe_v1_3.security_trading_status_message.size
  end
  -- Size of Snapshot Complete Message
  if template_id == 4 then
    return memx_equities_memoirtopofbook_sbe_v1_3.snapshot_complete_message.size
  end
  -- Size of Trading Session Status Message
  if template_id == 5 then
    return memx_equities_memoirtopofbook_sbe_v1_3.trading_session_status_message.size
  end
  -- Size of Best Bid Offer Message
  if template_id == 10 then
    return memx_equities_memoirtopofbook_sbe_v1_3.best_bid_offer_message.size
  end
  -- Size of Best Bid Message
  if template_id == 11 then
    return memx_equities_memoirtopofbook_sbe_v1_3.best_bid_message.size
  end
  -- Size of Best Offer Message
  if template_id == 12 then
    return memx_equities_memoirtopofbook_sbe_v1_3.best_offer_message.size
  end
  -- Size of Best Bid Short Message
  if template_id == 13 then
    return memx_equities_memoirtopofbook_sbe_v1_3.best_bid_short_message.size
  end
  -- Size of Best Offer Short Message
  if template_id == 14 then
    return memx_equities_memoirtopofbook_sbe_v1_3.best_offer_short_message.size
  end
  -- Size of Clear Book Message
  if template_id == 15 then
    return memx_equities_memoirtopofbook_sbe_v1_3.clear_book_message.size
  end
...
-- Size: Sbe Header
memx_equities_memoirtopofbook_sbe_v1_3.sbe_header.size =
  memx_equities_memoirtopofbook_sbe_v1_3.block_length.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.template_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.schema_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.version.size
...
memx_equities_memoirtopofbook_sbe_v1_3.sbe_message.size = function(buffer, offset)
  ...
  index = index + memx_equities_memoirtopofbook_sbe_v1_3.sbe_header.size
...
-- Size: Common Header
memx_equities_memoirtopofbook_sbe_v1_3.common_header.size =
  memx_equities_memoirtopofbook_sbe_v1_3.message_type.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.header_length.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.session_id.size + 
  memx_equities_memoirtopofbook_sbe_v1_3.sequence_number.size
...
function omi_memx_equities_memoirtopofbook_sbe_v1_3.init()
end

-- Dissector for Memx Equities MemoirTopOfBook Sbe 1.3
function omi_memx_equities_memoirtopofbook_sbe_v1_3.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = omi_memx_equities_memoirtopofbook_sbe_v1_3.name
...
udp_table:add(65333, omi_memx_equities_memoirtopofbook_sbe_v1_3)
...
local function omi_memx_equities_memoirtopofbook_sbe_v1_3_heuristic(buffer, packet, parent)
  ...
  omi_memx_equities_memoirtopofbook_sbe_v1_3.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Memx Equities MemoirTopOfBook Sbe 1.3
omi_memx_equities_memoirtopofbook_sbe_v1_3:register_heuristic("udp", omi_memx_equities_memoirtopofbook_sbe_v1_3_heuristic)
