...
local show = {}
local format = {}
local memx_options_memo_sbe_v1_5_b_display = {}
local memx_options_memo_sbe_v1_5_b_dissect = {}
local memx_options_memo_sbe_v1_5_b_size_of = {}
local verify = {}
local translate = {}
...
-- Size: Sending Time
memx_options_memo_sbe_v1_5_b_size_of.sending_time = 8

-- Display: Sending Time
memx_options_memo_sbe_v1_5_b_display.sending_time = function(value)
...
memx_options_memo_sbe_v1_5_b_dissect.sending_time = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.sending_time
...
-- Size: Lockout Id
memx_options_memo_sbe_v1_5_b_size_of.lockout_id = 8

-- Display: Lockout Id
memx_options_memo_sbe_v1_5_b_display.lockout_id = function(value)
  return "Lockout Id: "..value
end

-- Dissect: Lockout Id
memx_options_memo_sbe_v1_5_b_dissect.lockout_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.lockout_id
  local range = buffer(offset, length)
  local value = range:uint64()
...
-- Size: ClOrdId
memx_options_memo_sbe_v1_5_b_size_of.clordid = 20

-- Display: ClOrdId
memx_options_memo_sbe_v1_5_b_display.clordid = function(value)
...
-- Dissect: ClOrdId
memx_options_memo_sbe_v1_5_b_dissect.clordid = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.clordid
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_clear_lockout_done_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.clordid

  index = index + memx_options_memo_sbe_v1_5_b_size_of.lockout_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.sending_time

  return index
end

-- Display: Mass Cancel Clear Lockout Done Message
memx_options_memo_sbe_v1_5_b_display.mass_cancel_clear_lockout_done_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Cancel Clear Lockout Done Message
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_done_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- ClOrdId: 20 Byte Ascii String
  index, clordid = memx_options_memo_sbe_v1_5_b_dissect.clordid(buffer, index, packet, parent)

  -- Lockout Id: 8 Byte Unsigned Fixed Width Integer
  index, lockout_id = memx_options_memo_sbe_v1_5_b_dissect.lockout_id(buffer, index, packet, parent)

  -- Sending Time: 8 Byte Unsigned Fixed Width Integer
  index, sending_time = memx_options_memo_sbe_v1_5_b_dissect.sending_time(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_done_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_clear_lockout_done_message then
    ...
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.mass_cancel_clear_lockout_done_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_done_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.mass_cancel_clear_lockout_done_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_done_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Rej Reason
memx_options_memo_sbe_v1_5_b_size_of.rej_reason = 2

-- Display: Rej Reason
memx_options_memo_sbe_v1_5_b_display.rej_reason = function(value)
  if value == 0 then
...
-- Dissect: Rej Reason
memx_options_memo_sbe_v1_5_b_dissect.rej_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.rej_reason
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_clear_lockout_reject_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.rej_reason
...
memx_options_memo_sbe_v1_5_b_display.mass_cancel_clear_lockout_reject_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Cancel Clear Lockout Reject Message
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_reject_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, rej_reason = memx_options_memo_sbe_v1_5_b_dissect.rej_reason(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_reject_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_clear_lockout_reject_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.mass_cancel_clear_lockout_reject_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.mass_cancel_clear_lockout_reject_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_reject_message_fields(buffer, offset, packet, element)
  end
end

-- Size: User Status
memx_options_memo_sbe_v1_5_b_size_of.user_status = 1

-- Display: User Status
memx_options_memo_sbe_v1_5_b_display.user_status = function(value)
  if value == 8 then
...
-- Dissect: User Status
memx_options_memo_sbe_v1_5_b_dissect.user_status = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.user_status
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.user_notification_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.sending_time

  index = index + memx_options_memo_sbe_v1_5_b_size_of.user_status

  return index
end

-- Display: User Notification Message
memx_options_memo_sbe_v1_5_b_display.user_notification_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: User Notification Message
memx_options_memo_sbe_v1_5_b_dissect.user_notification_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, user_status = memx_options_memo_sbe_v1_5_b_dissect.user_status(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.user_notification_message = function(buffer, offset, packet, parent)
  if show.user_notification_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.user_notification_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.user_notification_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.user_notification_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.user_notification_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Alloc Id
memx_options_memo_sbe_v1_5_b_size_of.alloc_id = 20

-- Display: Alloc Id
memx_options_memo_sbe_v1_5_b_display.alloc_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Alloc Id
memx_options_memo_sbe_v1_5_b_dissect.alloc_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_id
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.alloc_position_effect = 1

-- Display: Alloc Position Effect
memx_options_memo_sbe_v1_5_b_display.alloc_position_effect = function(value)
  -- Check if field has value
...
memx_options_memo_sbe_v1_5_b_dissect.alloc_position_effect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_position_effect
  local range = buffer(offset, length)
...
-- Size: Alloc Qty
memx_options_memo_sbe_v1_5_b_size_of.alloc_qty = 4

-- Display: Alloc Qty
memx_options_memo_sbe_v1_5_b_display.alloc_qty = function(value)
  return "Alloc Qty: "..value
end

-- Dissect: Alloc Qty
memx_options_memo_sbe_v1_5_b_dissect.alloc_qty = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_qty
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.reported_allocations_group = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_qty

  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_position_effect

  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_id

  return index
end

-- Display: Reported Allocations Group
memx_options_memo_sbe_v1_5_b_display.reported_allocations_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Reported Allocations Group
memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Alloc Qty: 4 Byte Unsigned Fixed Width Integer
  index, alloc_qty = memx_options_memo_sbe_v1_5_b_dissect.alloc_qty(buffer, index, packet, parent)

  -- Alloc Position Effect: 1 Byte Ascii String Enum with 2 values
  index, alloc_position_effect = memx_options_memo_sbe_v1_5_b_dissect.alloc_position_effect(buffer, index, packet, parent)

  -- Alloc Id: 20 Byte Ascii String
  index, alloc_id = memx_options_memo_sbe_v1_5_b_dissect.alloc_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Reported Allocations Group
memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_group = function(buffer, offset, packet, parent)
  if show.reported_allocations_group then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.reported_allocations_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.reported_allocations_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_group_fields(buffer, offset, packet, element)
  end
end

-- Size: Num In Group
memx_options_memo_sbe_v1_5_b_size_of.num_in_group = 1

-- Display: Num In Group
memx_options_memo_sbe_v1_5_b_display.num_in_group = function(value)
  return "Num In Group: "..value
end

-- Dissect: Num In Group
memx_options_memo_sbe_v1_5_b_dissect.num_in_group = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.num_in_group
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.block_length_short = 1

-- Display: Block Length Short
memx_options_memo_sbe_v1_5_b_display.block_length_short = function(value)
  return "Block Length Short: "..value
end

-- Dissect: Block Length Short
memx_options_memo_sbe_v1_5_b_dissect.block_length_short = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.block_length_short
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.repeating_group_dimensions = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.block_length_short

  index = index + memx_options_memo_sbe_v1_5_b_size_of.num_in_group

  return index
end

-- Display: Repeating Group Dimensions
memx_options_memo_sbe_v1_5_b_display.repeating_group_dimensions = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Repeating Group Dimensions
memx_options_memo_sbe_v1_5_b_dissect.repeating_group_dimensions_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Block Length Short: 1 Byte Unsigned Fixed Width Integer
  index, block_length_short = memx_options_memo_sbe_v1_5_b_dissect.block_length_short(buffer, index, packet, parent)

  -- Num In Group: 1 Byte Unsigned Fixed Width Integer
  index, num_in_group = memx_options_memo_sbe_v1_5_b_dissect.num_in_group(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.repeating_group_dimensions = function(buffer, offset, packet, parent)
  if show.repeating_group_dimensions then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.repeating_group_dimensions, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.repeating_group_dimensions_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.repeating_group_dimensions(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.repeating_group_dimensions_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Reported Allocations Groups
memx_options_memo_sbe_v1_5_b_size_of.reported_allocations_groups = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.repeating_group_dimensions(buffer, offset + index)
...
memx_options_memo_sbe_v1_5_b_display.reported_allocations_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Reported Allocations Groups
memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_groups_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Repeating Group Dimensions: Struct of 2 fields
  index, repeating_group_dimensions = memx_options_memo_sbe_v1_5_b_dissect.repeating_group_dimensions(buffer, index, packet, parent)
  ...
  for reported_allocations_group_index = 1, num_in_group do
    index, reported_allocations_group = memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_group(buffer, index, packet, parent)

    if reported_allocations_group ~= nil then
      local iteration = reported_allocations_group:add(memx_options_memo_sbe_v1_5_b.fields.reported_allocations_group_index, reported_allocations_group_index)
...
memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_groups = function(buffer, offset, packet, parent)
...
-- Size: Last Px
memx_options_memo_sbe_v1_5_b_size_of.last_px = 8

-- Display: Last Px
memx_options_memo_sbe_v1_5_b_display.last_px = function(value)
...
-- Dissect: Last Px
memx_options_memo_sbe_v1_5_b_dissect.last_px = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.last_px
  local range = buffer(offset, length)
...
-- Size: Last Qty
memx_options_memo_sbe_v1_5_b_size_of.last_qty = 4

-- Display: Last Qty
memx_options_memo_sbe_v1_5_b_display.last_qty = function(value)
  return "Last Qty: "..value
end

-- Dissect: Last Qty
memx_options_memo_sbe_v1_5_b_dissect.last_qty = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.last_qty
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Trade Id
memx_options_memo_sbe_v1_5_b_size_of.trade_id = 8

-- Display: Trade Id
memx_options_memo_sbe_v1_5_b_display.trade_id = function(value)
  return "Trade Id: "..value
end

-- Dissect: Trade Id
memx_options_memo_sbe_v1_5_b_dissect.trade_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.trade_id
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.execution_allocations_group = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.trade_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.last_qty
...
memx_options_memo_sbe_v1_5_b_display.execution_allocations_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Allocations Group
memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Trade Id: 8 Byte Unsigned Fixed Width Integer
  index, trade_id = memx_options_memo_sbe_v1_5_b_dissect.trade_id(buffer, index, packet, parent)

  -- Last Qty: 4 Byte Unsigned Fixed Width Integer
  index, last_qty = memx_options_memo_sbe_v1_5_b_dissect.last_qty(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_group = function(buffer, offset, packet, parent)
  if show.execution_allocations_group then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_allocations_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_allocations_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Allocations Groups
memx_options_memo_sbe_v1_5_b_size_of.execution_allocations_groups = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.execution_allocations_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Allocations Groups
memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_allocations_group_index = 1, num_in_group do
    index, execution_allocations_group = memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_group(buffer, index, packet, parent)

    if execution_allocations_group ~= nil then
      local iteration = execution_allocations_group:add(memx_options_memo_sbe_v1_5_b.fields.execution_allocations_group_index, execution_allocations_group_index)
      iteration:set_generated()
    end
  end
...
memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Trade Date
memx_options_memo_sbe_v1_5_b_size_of.trade_date = 8

-- Display: Trade Date
memx_options_memo_sbe_v1_5_b_display.trade_date = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Trade Date
memx_options_memo_sbe_v1_5_b_dissect.trade_date = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.trade_date
  local range = buffer(offset, length)
...
-- Size: Security Id
memx_options_memo_sbe_v1_5_b_size_of.security_id = 8

-- Display: Security Id
memx_options_memo_sbe_v1_5_b_display.security_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Security Id
memx_options_memo_sbe_v1_5_b_dissect.security_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.security_id
  local range = buffer(offset, length)
...
-- Size: Side
memx_options_memo_sbe_v1_5_b_size_of.side = 1

-- Display: Side
memx_options_memo_sbe_v1_5_b_display.side = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Side
memx_options_memo_sbe_v1_5_b_dissect.side = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.side
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.alloc_canc_replace_reason = 2

-- Display: Alloc Canc Replace Reason
memx_options_memo_sbe_v1_5_b_display.alloc_canc_replace_reason = function(value)
  if value == 2 then
...
memx_options_memo_sbe_v1_5_b_dissect.alloc_canc_replace_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_canc_replace_reason
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.ref_alloc_id_optional = 20

-- Display: Ref Alloc Id Optional
memx_options_memo_sbe_v1_5_b_display.ref_alloc_id_optional = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_5_b_dissect.ref_alloc_id_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.ref_alloc_id_optional
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.alloc_trans_type = 1

-- Display: Alloc Trans Type
memx_options_memo_sbe_v1_5_b_display.alloc_trans_type = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.alloc_trans_type = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_trans_type
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Alloc Type
memx_options_memo_sbe_v1_5_b_size_of.alloc_type = 1

-- Display: Alloc Type
memx_options_memo_sbe_v1_5_b_display.alloc_type = function(value)
  if value == 100 then
...
-- Dissect: Alloc Type
memx_options_memo_sbe_v1_5_b_dissect.alloc_type = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_type
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.allocation_instruction_alert_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_type

  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_trans_type

  index = index + memx_options_memo_sbe_v1_5_b_size_of.ref_alloc_id_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_canc_replace_reason

  index = index + memx_options_memo_sbe_v1_5_b_size_of.side

  index = index + memx_options_memo_sbe_v1_5_b_size_of.security_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.trade_date

  index = index + memx_options_memo_sbe_v1_5_b_size_of.execution_allocations_groups(buffer, offset + index)

  index = index + memx_options_memo_sbe_v1_5_b_size_of.reported_allocations_groups(buffer, offset + index)

  return index
end

-- Display: Allocation Instruction Alert Message
memx_options_memo_sbe_v1_5_b_display.allocation_instruction_alert_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Allocation Instruction Alert Message
memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_alert_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, alloc_type = memx_options_memo_sbe_v1_5_b_dissect.alloc_type(buffer, index, packet, parent)

  -- Alloc Trans Type: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, alloc_trans_type = memx_options_memo_sbe_v1_5_b_dissect.alloc_trans_type(buffer, index, packet, parent)

  -- Ref Alloc Id Optional: 20 Byte Ascii String Nullable
  index, ref_alloc_id_optional = memx_options_memo_sbe_v1_5_b_dissect.ref_alloc_id_optional(buffer, index, packet, parent)

  -- Alloc Canc Replace Reason: 2 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, alloc_canc_replace_reason = memx_options_memo_sbe_v1_5_b_dissect.alloc_canc_replace_reason(buffer, index, packet, parent)

  -- Side: 1 Byte Ascii String Enum with 3 values
  index, side = memx_options_memo_sbe_v1_5_b_dissect.side(buffer, index, packet, parent)

  -- Security Id: 8 Byte Ascii String
  index, security_id = memx_options_memo_sbe_v1_5_b_dissect.security_id(buffer, index, packet, parent)

  -- Trade Date: 8 Byte Ascii String
  index, trade_date = memx_options_memo_sbe_v1_5_b_dissect.trade_date(buffer, index, packet, parent)

  -- Execution Allocations Groups: Struct of 2 fields
  index, execution_allocations_groups = memx_options_memo_sbe_v1_5_b_dissect.execution_allocations_groups(buffer, index, packet, parent)

  -- Reported Allocations Groups: Struct of 2 fields
  index, reported_allocations_groups = memx_options_memo_sbe_v1_5_b_dissect.reported_allocations_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Allocation Instruction Alert Message
memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_alert_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Alloc Rej Code
memx_options_memo_sbe_v1_5_b_size_of.alloc_rej_code = 2

-- Display: Alloc Rej Code
memx_options_memo_sbe_v1_5_b_display.alloc_rej_code = function(value)
  if value == 1 then
...
memx_options_memo_sbe_v1_5_b_dissect.alloc_rej_code = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_rej_code
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Alloc Status
memx_options_memo_sbe_v1_5_b_size_of.alloc_status = 1

-- Display: Alloc Status
memx_options_memo_sbe_v1_5_b_display.alloc_status = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.alloc_status = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.alloc_status
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.secondary_alloc_id = 20

-- Display: Secondary Alloc Id
memx_options_memo_sbe_v1_5_b_display.secondary_alloc_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_5_b_dissect.secondary_alloc_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.secondary_alloc_id
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.allocation_instruction_ack_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.secondary_alloc_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.ref_alloc_id_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_status

  index = index + memx_options_memo_sbe_v1_5_b_size_of.alloc_rej_code
...
memx_options_memo_sbe_v1_5_b_display.allocation_instruction_ack_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Allocation Instruction Ack Message
memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_ack_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, secondary_alloc_id = memx_options_memo_sbe_v1_5_b_dissect.secondary_alloc_id(buffer, index, packet, parent)

  -- Ref Alloc Id Optional: 20 Byte Ascii String Nullable
  index, ref_alloc_id_optional = memx_options_memo_sbe_v1_5_b_dissect.ref_alloc_id_optional(buffer, index, packet, parent)

  -- Alloc Status: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, alloc_status = memx_options_memo_sbe_v1_5_b_dissect.alloc_status(buffer, index, packet, parent)

  -- Alloc Rej Code: 2 Byte Unsigned Fixed Width Integer Enum with 17 values
  index, alloc_rej_code = memx_options_memo_sbe_v1_5_b_dissect.alloc_rej_code(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_ack_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Side Optional
memx_options_memo_sbe_v1_5_b_size_of.side_optional = 1

-- Display: Side Optional
memx_options_memo_sbe_v1_5_b_display.side_optional = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.side_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.side_optional
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.options_security_id_optional = 8

-- Display: Options Security Id Optional
memx_options_memo_sbe_v1_5_b_display.options_security_id_optional = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_5_b_dissect.options_security_id_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.options_security_id_optional
  local range = buffer(offset, length)
...
-- Size: Cxl Rej Reason
memx_options_memo_sbe_v1_5_b_size_of.cxl_rej_reason = 2

-- Display: Cxl Rej Reason
memx_options_memo_sbe_v1_5_b_display.cxl_rej_reason = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.cxl_rej_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.cxl_rej_reason
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.cxl_rej_response_to = 1

-- Display: Cxl Rej Response To
memx_options_memo_sbe_v1_5_b_display.cxl_rej_response_to = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.cxl_rej_response_to = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.cxl_rej_response_to
  local range = buffer(offset, length)
...
-- Size: List Seq No
memx_options_memo_sbe_v1_5_b_size_of.list_seq_no = 1

-- Display: List Seq No
memx_options_memo_sbe_v1_5_b_display.list_seq_no = function(value)
  return "List Seq No: "..value
end

-- Dissect: List Seq No
memx_options_memo_sbe_v1_5_b_dissect.list_seq_no = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.list_seq_no
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.order_cancel_reject_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.clordid

  index = index + memx_options_memo_sbe_v1_5_b_size_of.list_seq_no

  index = index + memx_options_memo_sbe_v1_5_b_size_of.cxl_rej_response_to

  index = index + memx_options_memo_sbe_v1_5_b_size_of.cxl_rej_reason

  index = index + memx_options_memo_sbe_v1_5_b_size_of.options_security_id_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.side_optional
...
memx_options_memo_sbe_v1_5_b_display.order_cancel_reject_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Reject Message
memx_options_memo_sbe_v1_5_b_dissect.order_cancel_reject_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, list_seq_no = memx_options_memo_sbe_v1_5_b_dissect.list_seq_no(buffer, index, packet, parent)

  -- Cxl Rej Response To: 1 Byte Ascii String Enum with 2 values
  index, cxl_rej_response_to = memx_options_memo_sbe_v1_5_b_dissect.cxl_rej_response_to(buffer, index, packet, parent)

  -- Cxl Rej Reason: 2 Byte Unsigned Fixed Width Integer Enum with 65 values
  index, cxl_rej_reason = memx_options_memo_sbe_v1_5_b_dissect.cxl_rej_reason(buffer, index, packet, parent)

  -- Options Security Id Optional: 8 Byte Ascii String Nullable
  index, options_security_id_optional = memx_options_memo_sbe_v1_5_b_dissect.options_security_id_optional(buffer, index, packet, parent)

  -- Side Optional: 1 Byte Ascii String Enum with 4 values
  index, side_optional = memx_options_memo_sbe_v1_5_b_dissect.side_optional(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.order_cancel_reject_message = function(buffer, offset, packet, parent)
  if show.order_cancel_reject_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.order_cancel_reject_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.order_cancel_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.order_cancel_reject_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.order_cancel_reject_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Total Affected Orders
memx_options_memo_sbe_v1_5_b_size_of.total_affected_orders = 4

-- Display: Total Affected Orders
memx_options_memo_sbe_v1_5_b_display.total_affected_orders = function(value)
  return "Total Affected Orders: "..value
end

-- Dissect: Total Affected Orders
memx_options_memo_sbe_v1_5_b_dissect.total_affected_orders = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.total_affected_orders
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_done_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.clordid

  index = index + memx_options_memo_sbe_v1_5_b_size_of.total_affected_orders
...
memx_options_memo_sbe_v1_5_b_display.mass_cancel_done_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Cancel Done Message
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_done_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, total_affected_orders = memx_options_memo_sbe_v1_5_b_dissect.total_affected_orders(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_done_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_done_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.mass_cancel_done_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_done_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.mass_cancel_done_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_done_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Mass Cancel Inst
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_inst = 1

-- Display: Mass Cancel Inst
memx_options_memo_sbe_v1_5_b_display.mass_cancel_inst = function(buffer, packet, parent)
  local display = ""
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_inst = function(buffer, offset, packet, parent)
  local size = 1
...
memx_options_memo_sbe_v1_5_b_size_of.cancel_group_id = 2

-- Display: Cancel Group Id
memx_options_memo_sbe_v1_5_b_display.cancel_group_id = function(value)
  -- Check if field has value
  if value == 65535 then
...
memx_options_memo_sbe_v1_5_b_dissect.cancel_group_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.cancel_group_id
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.underlier_optional = 6

-- Display: Underlier Optional
memx_options_memo_sbe_v1_5_b_display.underlier_optional = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_5_b_dissect.underlier_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.underlier_optional
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.underlying_or_series_optional = 1

-- Display: Underlying Or Series Optional
memx_options_memo_sbe_v1_5_b_display.underlying_or_series_optional = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.underlying_or_series_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.underlying_or_series_optional
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Efid Optional
memx_options_memo_sbe_v1_5_b_size_of.efid_optional = 4

-- Display: Efid Optional
memx_options_memo_sbe_v1_5_b_display.efid_optional = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_5_b_dissect.efid_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.efid_optional
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_reject_reason = 2

-- Display: Mass Cancel Reject Reason
memx_options_memo_sbe_v1_5_b_display.mass_cancel_reject_reason = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_reject_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_reject_reason
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_reject_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.clordid

  index = index + memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_reject_reason

  index = index + memx_options_memo_sbe_v1_5_b_size_of.efid_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.underlying_or_series_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.underlier_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.options_security_id_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.cancel_group_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_inst
...
memx_options_memo_sbe_v1_5_b_display.mass_cancel_reject_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Cancel Reject Message
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_reject_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, mass_cancel_reject_reason = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_reject_reason(buffer, index, packet, parent)

  -- Efid Optional: 4 Byte Ascii String Nullable
  index, efid_optional = memx_options_memo_sbe_v1_5_b_dissect.efid_optional(buffer, index, packet, parent)

  -- Underlying Or Series Optional: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, underlying_or_series_optional = memx_options_memo_sbe_v1_5_b_dissect.underlying_or_series_optional(buffer, index, packet, parent)

  -- Underlier Optional: 6 Byte Ascii String Nullable
  index, underlier_optional = memx_options_memo_sbe_v1_5_b_dissect.underlier_optional(buffer, index, packet, parent)

  -- Options Security Id Optional: 8 Byte Ascii String Nullable
  index, options_security_id_optional = memx_options_memo_sbe_v1_5_b_dissect.options_security_id_optional(buffer, index, packet, parent)

  -- Cancel Group Id: 2 Byte Unsigned Fixed Width Integer Nullable
  index, cancel_group_id = memx_options_memo_sbe_v1_5_b_dissect.cancel_group_id(buffer, index, packet, parent)

  -- Mass Cancel Inst: Struct of 4 fields
  index, mass_cancel_inst = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_inst(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_reject_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_reject_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.mass_cancel_reject_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.mass_cancel_reject_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_reject_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Underlier
memx_options_memo_sbe_v1_5_b_size_of.underlier = 6

-- Display: Underlier
memx_options_memo_sbe_v1_5_b_display.underlier = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Underlier
memx_options_memo_sbe_v1_5_b_dissect.underlier = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.underlier
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.underlying_or_series = 1

-- Display: Underlying Or Series
memx_options_memo_sbe_v1_5_b_display.underlying_or_series = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.underlying_or_series = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.underlying_or_series
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.lockout_id_optional = 8

-- Display: Lockout Id Optional
memx_options_memo_sbe_v1_5_b_display.lockout_id_optional = function(value)
  -- Check if field has value
...
memx_options_memo_sbe_v1_5_b_dissect.lockout_id_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.lockout_id_optional
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.pending_mass_cancel_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.lockout_id_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.efid_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.underlying_or_series

  index = index + memx_options_memo_sbe_v1_5_b_size_of.underlier
...
memx_options_memo_sbe_v1_5_b_display.pending_mass_cancel_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Pending Mass Cancel Message
memx_options_memo_sbe_v1_5_b_dissect.pending_mass_cancel_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, lockout_id_optional = memx_options_memo_sbe_v1_5_b_dissect.lockout_id_optional(buffer, index, packet, parent)

  -- Efid Optional: 4 Byte Ascii String Nullable
  index, efid_optional = memx_options_memo_sbe_v1_5_b_dissect.efid_optional(buffer, index, packet, parent)

  -- Underlying Or Series: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, underlying_or_series = memx_options_memo_sbe_v1_5_b_dissect.underlying_or_series(buffer, index, packet, parent)

  -- Underlier: 6 Byte Ascii String
  index, underlier = memx_options_memo_sbe_v1_5_b_dissect.underlier(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.pending_mass_cancel_message = function(buffer, offset, packet, parent)
  if show.pending_mass_cancel_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.pending_mass_cancel_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.pending_mass_cancel_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.pending_mass_cancel_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.pending_mass_cancel_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Transact Time
memx_options_memo_sbe_v1_5_b_size_of.transact_time = 8

-- Display: Transact Time
memx_options_memo_sbe_v1_5_b_display.transact_time = function(value)
  return "Transact Time: "..value
end

-- Dissect: Transact Time
memx_options_memo_sbe_v1_5_b_dissect.transact_time = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.transact_time
  local range = buffer(offset, length)
  local value = range:uint64()
...
-- Size: Cum Qty
memx_options_memo_sbe_v1_5_b_size_of.cum_qty = 4

-- Display: Cum Qty
memx_options_memo_sbe_v1_5_b_display.cum_qty = function(value)
  return "Cum Qty: "..value
end

-- Dissect: Cum Qty
memx_options_memo_sbe_v1_5_b_dissect.cum_qty = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.cum_qty
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Leaves Qty
memx_options_memo_sbe_v1_5_b_size_of.leaves_qty = 4

-- Display: Leaves Qty
memx_options_memo_sbe_v1_5_b_display.leaves_qty = function(value)
  return "Leaves Qty: "..value
end

-- Dissect: Leaves Qty
memx_options_memo_sbe_v1_5_b_dissect.leaves_qty = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.leaves_qty
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.last_qty_optional = 4

-- Display: Last Qty Optional
memx_options_memo_sbe_v1_5_b_display.last_qty_optional = function(value)
  -- Check if field has value
...
memx_options_memo_sbe_v1_5_b_dissect.last_qty_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.last_qty_optional
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.extended_restatement_reason = 1

-- Display: Extended Restatement Reason
memx_options_memo_sbe_v1_5_b_display.extended_restatement_reason = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.extended_restatement_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.extended_restatement_reason
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.exec_restatement_reason = 1

-- Display: Exec Restatement Reason
memx_options_memo_sbe_v1_5_b_display.exec_restatement_reason = function(value)
  if value == 3 then
...
memx_options_memo_sbe_v1_5_b_dissect.exec_restatement_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.exec_restatement_reason
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Ord Status
memx_options_memo_sbe_v1_5_b_size_of.ord_status = 1

-- Display: Ord Status
memx_options_memo_sbe_v1_5_b_display.ord_status = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Ord Status
memx_options_memo_sbe_v1_5_b_dissect.ord_status = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.ord_status
  local range = buffer(offset, length)
...
-- Size: Exec Id
memx_options_memo_sbe_v1_5_b_size_of.exec_id = 8

-- Display: Exec Id
memx_options_memo_sbe_v1_5_b_display.exec_id = function(value)
  return "Exec Id: "..value
end

-- Dissect: Exec Id
memx_options_memo_sbe_v1_5_b_dissect.exec_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.exec_id
  local range = buffer(offset, length)
  local value = range:uint64()
...
-- Size: Order Id
memx_options_memo_sbe_v1_5_b_size_of.order_id = 8

-- Display: Order Id
memx_options_memo_sbe_v1_5_b_display.order_id = function(value)
  return "Order Id: "..value
end

-- Dissect: Order Id
memx_options_memo_sbe_v1_5_b_dissect.order_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.order_id
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_restatement_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.order_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.clordid

  index = index + memx_options_memo_sbe_v1_5_b_size_of.list_seq_no

  index = index + memx_options_memo_sbe_v1_5_b_size_of.exec_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.ord_status

  index = index + memx_options_memo_sbe_v1_5_b_size_of.security_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.exec_restatement_reason

  index = index + memx_options_memo_sbe_v1_5_b_size_of.extended_restatement_reason

  index = index + memx_options_memo_sbe_v1_5_b_size_of.side

  index = index + memx_options_memo_sbe_v1_5_b_size_of.last_px

  index = index + memx_options_memo_sbe_v1_5_b_size_of.last_qty_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.leaves_qty

  index = index + memx_options_memo_sbe_v1_5_b_size_of.cum_qty

  index = index + memx_options_memo_sbe_v1_5_b_size_of.sending_time

  index = index + memx_options_memo_sbe_v1_5_b_size_of.transact_time

  return index
end

-- Display: Execution Report Restatement Message
memx_options_memo_sbe_v1_5_b_display.execution_report_restatement_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Restatement Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_restatement_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Order Id: 8 Byte Unsigned Fixed Width Integer
  index, order_id = memx_options_memo_sbe_v1_5_b_dissect.order_id(buffer, index, packet, parent)
  ...
  index, exec_id = memx_options_memo_sbe_v1_5_b_dissect.exec_id(buffer, index, packet, parent)

  -- Ord Status: 1 Byte Ascii String Enum with 8 values
  index, ord_status = memx_options_memo_sbe_v1_5_b_dissect.ord_status(buffer, index, packet, parent)

  -- Security Id: 8 Byte Ascii String
  index, security_id = memx_options_memo_sbe_v1_5_b_dissect.security_id(buffer, index, packet, parent)

  -- Exec Restatement Reason: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, exec_restatement_reason = memx_options_memo_sbe_v1_5_b_dissect.exec_restatement_reason(buffer, index, packet, parent)

  -- Extended Restatement Reason: 1 Byte Unsigned Fixed Width Integer Enum with 6 values
  index, extended_restatement_reason = memx_options_memo_sbe_v1_5_b_dissect.extended_restatement_reason(buffer, index, packet, parent)
  ...
  index, last_qty_optional = memx_options_memo_sbe_v1_5_b_dissect.last_qty_optional(buffer, index, packet, parent)

  -- Leaves Qty: 4 Byte Unsigned Fixed Width Integer
  index, leaves_qty = memx_options_memo_sbe_v1_5_b_dissect.leaves_qty(buffer, index, packet, parent)

  -- Cum Qty: 4 Byte Unsigned Fixed Width Integer
  index, cum_qty = memx_options_memo_sbe_v1_5_b_dissect.cum_qty(buffer, index, packet, parent)

  -- Sending Time: 8 Byte Unsigned Fixed Width Integer
  index, sending_time = memx_options_memo_sbe_v1_5_b_dissect.sending_time(buffer, index, packet, parent)

  -- Transact Time: 8 Byte Unsigned Fixed Width Integer
  index, transact_time = memx_options_memo_sbe_v1_5_b_dissect.transact_time(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_restatement_message = function(buffer, offset, packet, parent)
  if show.execution_report_restatement_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_restatement_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_restatement_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_restatement_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_restatement_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Exec Ref Id
memx_options_memo_sbe_v1_5_b_size_of.exec_ref_id = 8

-- Display: Exec Ref Id
memx_options_memo_sbe_v1_5_b_display.exec_ref_id = function(value)
  return "Exec Ref Id: "..value
end

-- Dissect: Exec Ref Id
memx_options_memo_sbe_v1_5_b_dissect.exec_ref_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.exec_ref_id
  local range = buffer(offset, length)
  local value = range:uint64()
...
-- Size: Trd Match Id
memx_options_memo_sbe_v1_5_b_size_of.trd_match_id = 8

-- Display: Trd Match Id
memx_options_memo_sbe_v1_5_b_display.trd_match_id = function(value)
  return "Trd Match Id: "..value
end

-- Dissect: Trd Match Id
memx_options_memo_sbe_v1_5_b_dissect.trd_match_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.trd_match_id
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_trade_break_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.trd_match_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.exec_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.exec_ref_id
...
memx_options_memo_sbe_v1_5_b_display.execution_report_trade_break_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Break Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_break_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, trd_match_id = memx_options_memo_sbe_v1_5_b_dissect.trd_match_id(buffer, index, packet, parent)

  -- Exec Id: 8 Byte Unsigned Fixed Width Integer
  index, exec_id = memx_options_memo_sbe_v1_5_b_dissect.exec_id(buffer, index, packet, parent)

  -- Exec Ref Id: 8 Byte Unsigned Fixed Width Integer
  index, exec_ref_id = memx_options_memo_sbe_v1_5_b_dissect.exec_ref_id(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_break_message = function(buffer, offset, packet, parent)
  if show.execution_report_trade_break_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_trade_break_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_break_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_trade_break_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_break_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Correction Message
memx_options_memo_sbe_v1_5_b_size_of.execution_report_trade_correction_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.execution_report_trade_correction_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Correction Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_correction_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_correction_message = function(buffer, offset, packet, parent)
  if show.execution_report_trade_correction_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_trade_correction_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_correction_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_trade_correction_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_correction_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Price Optional
memx_options_memo_sbe_v1_5_b_size_of.price_optional = 8

-- Display: Price Optional
memx_options_memo_sbe_v1_5_b_display.price_optional = function(raw, value)
...
memx_options_memo_sbe_v1_5_b_dissect.price_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.price_optional
  local range = buffer(offset, length)
  local raw = range:uint64()
...
-- Size: Ord Type
memx_options_memo_sbe_v1_5_b_size_of.ord_type = 1

-- Display: Ord Type
memx_options_memo_sbe_v1_5_b_display.ord_type = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Ord Type
memx_options_memo_sbe_v1_5_b_dissect.ord_type = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.ord_type
  local range = buffer(offset, length)
...
-- Size: Order Qty
memx_options_memo_sbe_v1_5_b_size_of.order_qty = 4

-- Display: Order Qty
memx_options_memo_sbe_v1_5_b_display.order_qty = function(value)
  return "Order Qty: "..value
end

-- Dissect: Order Qty
memx_options_memo_sbe_v1_5_b_dissect.order_qty = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.order_qty
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: OrigClOrdId
memx_options_memo_sbe_v1_5_b_size_of.origclordid = 20

-- Display: OrigClOrdId
memx_options_memo_sbe_v1_5_b_display.origclordid = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: OrigClOrdId
memx_options_memo_sbe_v1_5_b_dissect.origclordid = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.origclordid
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_replaced_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.origclordid
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.order_qty

  index = index + memx_options_memo_sbe_v1_5_b_size_of.ord_type

  index = index + memx_options_memo_sbe_v1_5_b_size_of.price_optional
...
memx_options_memo_sbe_v1_5_b_display.execution_report_replaced_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Replaced Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_replaced_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, origclordid = memx_options_memo_sbe_v1_5_b_dissect.origclordid(buffer, index, packet, parent)
  ...
  index, order_qty = memx_options_memo_sbe_v1_5_b_dissect.order_qty(buffer, index, packet, parent)

  -- Ord Type: 1 Byte Ascii String Enum with 2 values
  index, ord_type = memx_options_memo_sbe_v1_5_b_dissect.ord_type(buffer, index, packet, parent)

  -- Price Optional: 8 Byte Unsigned Fixed Width Integer Nullable
  index, price_optional = memx_options_memo_sbe_v1_5_b_dissect.price_optional(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_replaced_message = function(buffer, offset, packet, parent)
  if show.execution_report_replaced_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_replaced_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_replaced_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_replaced_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_replaced_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Pending Replace Message
memx_options_memo_sbe_v1_5_b_size_of.execution_report_pending_replace_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.execution_report_pending_replace_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Pending Replace Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_replace_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_replace_message = function(buffer, offset, packet, parent)
  if show.execution_report_pending_replace_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_pending_replace_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_replace_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_pending_replace_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_replace_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Cancel Reason
memx_options_memo_sbe_v1_5_b_size_of.cancel_reason = 1

-- Display: Cancel Reason
memx_options_memo_sbe_v1_5_b_display.cancel_reason = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.cancel_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.cancel_reason
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.origclordid_optional = 20

-- Display: OrigClOrdId Optional
memx_options_memo_sbe_v1_5_b_display.origclordid_optional = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_5_b_dissect.origclordid_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.origclordid_optional
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_canceled_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.origclordid_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.exec_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.ord_status

  index = index + memx_options_memo_sbe_v1_5_b_size_of.cancel_reason
...
memx_options_memo_sbe_v1_5_b_display.execution_report_canceled_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Canceled Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_canceled_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, origclordid_optional = memx_options_memo_sbe_v1_5_b_dissect.origclordid_optional(buffer, index, packet, parent)
  ...
  index, cancel_reason = memx_options_memo_sbe_v1_5_b_dissect.cancel_reason(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_canceled_message = function(buffer, offset, packet, parent)
  if show.execution_report_canceled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_canceled_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_canceled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_canceled_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_canceled_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Pending Cancel Message
memx_options_memo_sbe_v1_5_b_size_of.execution_report_pending_cancel_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.execution_report_pending_cancel_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Pending Cancel Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_cancel_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_cancel_message = function(buffer, offset, packet, parent)
  if show.execution_report_pending_cancel_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_pending_cancel_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_cancel_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_pending_cancel_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_cancel_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Party Role
memx_options_memo_sbe_v1_5_b_size_of.party_role = 1

-- Display: Party Role
memx_options_memo_sbe_v1_5_b_display.party_role = function(value)
  if value == 1 then
...
-- Dissect: Party Role
memx_options_memo_sbe_v1_5_b_dissect.party_role = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.party_role
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.party_id_source = 1

-- Display: Party Id Source
memx_options_memo_sbe_v1_5_b_display.party_id_source = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_5_b_dissect.party_id_source = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.party_id_source
  local range = buffer(offset, length)
...
-- Size: Party Id
memx_options_memo_sbe_v1_5_b_size_of.party_id = 16

-- Display: Party Id
memx_options_memo_sbe_v1_5_b_display.party_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Party Id
memx_options_memo_sbe_v1_5_b_dissect.party_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.party_id
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.parties_group = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.party_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.party_id_source

  index = index + memx_options_memo_sbe_v1_5_b_size_of.party_role

  return index
end

-- Display: Parties Group
memx_options_memo_sbe_v1_5_b_display.parties_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Parties Group
memx_options_memo_sbe_v1_5_b_dissect.parties_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Party Id: 16 Byte Ascii String
  index, party_id = memx_options_memo_sbe_v1_5_b_dissect.party_id(buffer, index, packet, parent)

  -- Party Id Source: 1 Byte Ascii String
  index, party_id_source = memx_options_memo_sbe_v1_5_b_dissect.party_id_source(buffer, index, packet, parent)

  -- Party Role: 1 Byte Unsigned Fixed Width Integer Enum with 10 values
  index, party_role = memx_options_memo_sbe_v1_5_b_dissect.party_role(buffer, index, packet, parent)

  return index
end

-- Dissect: Parties Group
memx_options_memo_sbe_v1_5_b_dissect.parties_group = function(buffer, offset, packet, parent)
  if show.parties_group then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.parties_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.parties_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.parties_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.parties_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Parties Groups
memx_options_memo_sbe_v1_5_b_size_of.parties_groups = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.parties_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Parties Groups
memx_options_memo_sbe_v1_5_b_dissect.parties_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for parties_group_index = 1, num_in_group do
    index, parties_group = memx_options_memo_sbe_v1_5_b_dissect.parties_group(buffer, index, packet, parent)

    if parties_group ~= nil then
      local iteration = parties_group:add(memx_options_memo_sbe_v1_5_b.fields.parties_group_index, parties_group_index)
      iteration:set_generated()
    end
  end
...
memx_options_memo_sbe_v1_5_b_dissect.parties_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.contra_trading_capacity = 1

-- Display: Contra Trading Capacity
memx_options_memo_sbe_v1_5_b_display.contra_trading_capacity = function(value)
  if value == 1 then
...
memx_options_memo_sbe_v1_5_b_dissect.contra_trading_capacity = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.contra_trading_capacity
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.trading_capacity = 1

-- Display: Trading Capacity
memx_options_memo_sbe_v1_5_b_display.trading_capacity = function(value)
  if value == 1 then
...
memx_options_memo_sbe_v1_5_b_dissect.trading_capacity = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.trading_capacity
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.position_effect = 1

-- Display: Position Effect
memx_options_memo_sbe_v1_5_b_display.position_effect = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.position_effect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.position_effect
  local range = buffer(offset, length)
...
-- Size: Last Mkt
memx_options_memo_sbe_v1_5_b_size_of.last_mkt = 4

-- Display: Last Mkt
memx_options_memo_sbe_v1_5_b_display.last_mkt = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Last Mkt
memx_options_memo_sbe_v1_5_b_dissect.last_mkt = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.last_mkt
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.last_liquidity_ind = 1

-- Display: Last Liquidity Ind
memx_options_memo_sbe_v1_5_b_display.last_liquidity_ind = function(value)
  if value == 1 then
...
memx_options_memo_sbe_v1_5_b_dissect.last_liquidity_ind = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.last_liquidity_ind
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_trade_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.last_liquidity_ind

  index = index + memx_options_memo_sbe_v1_5_b_size_of.last_mkt

  index = index + memx_options_memo_sbe_v1_5_b_size_of.position_effect

  index = index + memx_options_memo_sbe_v1_5_b_size_of.trading_capacity

  index = index + memx_options_memo_sbe_v1_5_b_size_of.contra_trading_capacity

  index = index + memx_options_memo_sbe_v1_5_b_size_of.parties_groups(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Message
memx_options_memo_sbe_v1_5_b_display.execution_report_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, last_liquidity_ind = memx_options_memo_sbe_v1_5_b_dissect.last_liquidity_ind(buffer, index, packet, parent)

  -- Last Mkt: 4 Byte Ascii String
  index, last_mkt = memx_options_memo_sbe_v1_5_b_dissect.last_mkt(buffer, index, packet, parent)

  -- Position Effect: 1 Byte Ascii String Enum with 2 values
  index, position_effect = memx_options_memo_sbe_v1_5_b_dissect.position_effect(buffer, index, packet, parent)

  -- Trading Capacity: 1 Byte Unsigned Fixed Width Integer Enum with 8 values
  index, trading_capacity = memx_options_memo_sbe_v1_5_b_dissect.trading_capacity(buffer, index, packet, parent)

  -- Contra Trading Capacity: 1 Byte Unsigned Fixed Width Integer Enum with 8 values
  index, contra_trading_capacity = memx_options_memo_sbe_v1_5_b_dissect.contra_trading_capacity(buffer, index, packet, parent)

  -- Parties Groups: Struct of 2 fields
  index, parties_groups = memx_options_memo_sbe_v1_5_b_dissect.parties_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.order_reject_reason = 2

-- Display: Order Reject Reason
memx_options_memo_sbe_v1_5_b_display.order_reject_reason = function(value)
  if value == 1 then
...
memx_options_memo_sbe_v1_5_b_dissect.order_reject_reason = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.order_reject_reason
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_rejected_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.order_reject_reason
...
memx_options_memo_sbe_v1_5_b_display.execution_report_rejected_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Rejected Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_rejected_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_reject_reason = memx_options_memo_sbe_v1_5_b_dissect.order_reject_reason(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_rejected_message = function(buffer, offset, packet, parent)
  if show.execution_report_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_rejected_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_rejected_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Bulk Quote Component New Message
memx_options_memo_sbe_v1_5_b_size_of.execution_report_bulk_quote_component_new_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.execution_report_bulk_quote_component_new_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Bulk Quote Component New Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_component_new_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_component_new_message = function(buffer, offset, packet, parent)
  if show.execution_report_bulk_quote_component_new_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.execution_report_bulk_quote_component_new_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_component_new_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.execution_report_bulk_quote_component_new_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_component_new_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Number Of Orders
memx_options_memo_sbe_v1_5_b_size_of.number_of_orders = 1

-- Display: Number Of Orders
memx_options_memo_sbe_v1_5_b_display.number_of_orders = function(value)
  return "Number Of Orders: "..value
end

-- Dissect: Number Of Orders
memx_options_memo_sbe_v1_5_b_dissect.number_of_orders = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.number_of_orders
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Risk Group Id
memx_options_memo_sbe_v1_5_b_size_of.risk_group_id = 2

-- Display: Risk Group Id
memx_options_memo_sbe_v1_5_b_display.risk_group_id = function(value)
  -- Check if field has value
  if value == 65535 then
...
memx_options_memo_sbe_v1_5_b_dissect.risk_group_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.risk_group_id
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.match_trade_prevention = 1

-- Display: Match Trade Prevention
memx_options_memo_sbe_v1_5_b_display.match_trade_prevention = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.match_trade_prevention = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.match_trade_prevention
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Mtp Group Id
memx_options_memo_sbe_v1_5_b_size_of.mtp_group_id = 2

-- Display: Mtp Group Id
memx_options_memo_sbe_v1_5_b_display.mtp_group_id = function(value)
  -- Check if field has value
  if value == 65535 then
...
memx_options_memo_sbe_v1_5_b_dissect.mtp_group_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.mtp_group_id
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Exec Inst
memx_options_memo_sbe_v1_5_b_size_of.exec_inst = 2

-- Display: Exec Inst
memx_options_memo_sbe_v1_5_b_display.exec_inst = function(buffer, packet, parent)
  local display = ""
...
-- Dissect: Exec Inst
memx_options_memo_sbe_v1_5_b_dissect.exec_inst = function(buffer, offset, packet, parent)
  local size = 2
  local range = buffer(offset, size)
...
-- Size: Time In Force
memx_options_memo_sbe_v1_5_b_size_of.time_in_force = 1

-- Display: Time In Force
memx_options_memo_sbe_v1_5_b_display.time_in_force = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.time_in_force = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.time_in_force
  local range = buffer(offset, length)
...
-- Size: Symbol
memx_options_memo_sbe_v1_5_b_size_of.symbol = 6

-- Display: Symbol
memx_options_memo_sbe_v1_5_b_display.symbol = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Symbol
memx_options_memo_sbe_v1_5_b_dissect.symbol = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.symbol
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_bulk_quote_pending_new_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.clordid

  index = index + memx_options_memo_sbe_v1_5_b_size_of.symbol

  index = index + memx_options_memo_sbe_v1_5_b_size_of.time_in_force

  index = index + memx_options_memo_sbe_v1_5_b_size_of.exec_inst
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.mtp_group_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.match_trade_prevention

  index = index + memx_options_memo_sbe_v1_5_b_size_of.cancel_group_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.risk_group_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.number_of_orders
...
memx_options_memo_sbe_v1_5_b_display.execution_report_bulk_quote_pending_new_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Bulk Quote Pending New Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_pending_new_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, symbol = memx_options_memo_sbe_v1_5_b_dissect.symbol(buffer, index, packet, parent)

  -- Time In Force: 1 Byte Ascii String Enum with 2 values
  index, time_in_force = memx_options_memo_sbe_v1_5_b_dissect.time_in_force(buffer, index, packet, parent)

  -- Exec Inst: Struct of 4 fields
  index, exec_inst = memx_options_memo_sbe_v1_5_b_dissect.exec_inst(buffer, index, packet, parent)
  ...
  index, mtp_group_id = memx_options_memo_sbe_v1_5_b_dissect.mtp_group_id(buffer, index, packet, parent)

  -- Match Trade Prevention: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, match_trade_prevention = memx_options_memo_sbe_v1_5_b_dissect.match_trade_prevention(buffer, index, packet, parent)

  -- Cancel Group Id: 2 Byte Unsigned Fixed Width Integer Nullable
  index, cancel_group_id = memx_options_memo_sbe_v1_5_b_dissect.cancel_group_id(buffer, index, packet, parent)

  -- Risk Group Id: 2 Byte Unsigned Fixed Width Integer Nullable
  index, risk_group_id = memx_options_memo_sbe_v1_5_b_dissect.risk_group_id(buffer, index, packet, parent)

  -- Number Of Orders: 1 Byte Unsigned Fixed Width Integer
  index, number_of_orders = memx_options_memo_sbe_v1_5_b_dissect.number_of_orders(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_pending_new_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.reprice_behavior = 1

-- Display: Reprice Behavior
memx_options_memo_sbe_v1_5_b_display.reprice_behavior = function(value)
  if value == 1 then
...
memx_options_memo_sbe_v1_5_b_dissect.reprice_behavior = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.reprice_behavior
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.reprice_frequency = 1

-- Display: Reprice Frequency
memx_options_memo_sbe_v1_5_b_display.reprice_frequency = function(value)
  if value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.reprice_frequency = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.reprice_frequency
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.position_effect_optional = 1

-- Display: Position Effect Optional
memx_options_memo_sbe_v1_5_b_display.position_effect_optional = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
memx_options_memo_sbe_v1_5_b_dissect.position_effect_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.position_effect_optional
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.execution_report_new_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.position_effect_optional

  index = index + memx_options_memo_sbe_v1_5_b_size_of.exec_inst

  index = index + memx_options_memo_sbe_v1_5_b_size_of.trading_capacity

  index = index + memx_options_memo_sbe_v1_5_b_size_of.reprice_frequency

  index = index + memx_options_memo_sbe_v1_5_b_size_of.reprice_behavior
...
memx_options_memo_sbe_v1_5_b_display.execution_report_new_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report New Message
memx_options_memo_sbe_v1_5_b_dissect.execution_report_new_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, position_effect_optional = memx_options_memo_sbe_v1_5_b_dissect.position_effect_optional(buffer, index, packet, parent)
  ...
  index, reprice_frequency = memx_options_memo_sbe_v1_5_b_dissect.reprice_frequency(buffer, index, packet, parent)

  -- Reprice Behavior: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, reprice_behavior = memx_options_memo_sbe_v1_5_b_dissect.reprice_behavior(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.execution_report_new_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.requested_allocations_group = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.requested_allocations_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Requested Allocations Group
memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_group = function(buffer, offset, packet, parent)
  if show.requested_allocations_group then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.requested_allocations_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.requested_allocations_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Requested Allocations Groups
memx_options_memo_sbe_v1_5_b_size_of.requested_allocations_groups = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.requested_allocations_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Requested Allocations Groups
memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for requested_allocations_group_index = 1, num_in_group do
    index, requested_allocations_group = memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_group(buffer, index, packet, parent)

    if requested_allocations_group ~= nil then
      local iteration = requested_allocations_group:add(memx_options_memo_sbe_v1_5_b.fields.requested_allocations_group_index, requested_allocations_group_index)
      iteration:set_generated()
    end
  end
...
memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.allocation_instruction_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.requested_allocations_groups(buffer, offset + index)

  return index
end

-- Display: Allocation Instruction Message
memx_options_memo_sbe_v1_5_b_display.allocation_instruction_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Allocation Instruction Message
memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, requested_allocations_groups = memx_options_memo_sbe_v1_5_b_dissect.requested_allocations_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Allocation Instruction Message
memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_clear_lockout_request_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.mass_cancel_clear_lockout_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Cancel Clear Lockout Request Message
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_request_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_clear_lockout_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.mass_cancel_clear_lockout_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.mass_cancel_clear_lockout_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_request_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Mass Cancel Request Message
memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_request_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.mass_cancel_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Cancel Request Message
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_request_message = function(buffer, offset, packet, parent)
  if show.mass_cancel_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.mass_cancel_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.mass_cancel_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_request_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Order Id Optional
memx_options_memo_sbe_v1_5_b_size_of.order_id_optional = 8

-- Display: Order Id Optional
memx_options_memo_sbe_v1_5_b_display.order_id_optional = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
memx_options_memo_sbe_v1_5_b_dissect.order_id_optional = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.order_id_optional
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.order_cancel_request_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.sending_time

  index = index + memx_options_memo_sbe_v1_5_b_size_of.order_id_optional
...
memx_options_memo_sbe_v1_5_b_display.order_cancel_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Request Message
memx_options_memo_sbe_v1_5_b_dissect.order_cancel_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_id_optional = memx_options_memo_sbe_v1_5_b_dissect.order_id_optional(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.order_cancel_request_message = function(buffer, offset, packet, parent)
  if show.order_cancel_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.order_cancel_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.order_cancel_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.order_cancel_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.order_cancel_request_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Order Cancel Replace Request Message
memx_options_memo_sbe_v1_5_b_size_of.order_cancel_replace_request_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.order_cancel_replace_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Replace Request Message
memx_options_memo_sbe_v1_5_b_dissect.order_cancel_replace_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.order_cancel_replace_request_message = function(buffer, offset, packet, parent)
  if show.order_cancel_replace_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.order_cancel_replace_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.order_cancel_replace_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.order_cancel_replace_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.order_cancel_replace_request_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Offer Px
memx_options_memo_sbe_v1_5_b_size_of.offer_px = 2

-- Display: Offer Px
memx_options_memo_sbe_v1_5_b_display.offer_px = function(value)
...
-- Dissect: Offer Px
memx_options_memo_sbe_v1_5_b_dissect.offer_px = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.offer_px
  local range = buffer(offset, length)
...
-- Size: Offer Size
memx_options_memo_sbe_v1_5_b_size_of.offer_size = 2

-- Display: Offer Size
memx_options_memo_sbe_v1_5_b_display.offer_size = function(value)
  return "Offer Size: "..value
end

-- Dissect: Offer Size
memx_options_memo_sbe_v1_5_b_dissect.offer_size = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.offer_size
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Bid Px
memx_options_memo_sbe_v1_5_b_size_of.bid_px = 2

-- Display: Bid Px
memx_options_memo_sbe_v1_5_b_display.bid_px = function(value)
  return "Bid Px: "..value
end
...
-- Dissect: Bid Px
memx_options_memo_sbe_v1_5_b_dissect.bid_px = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.bid_px
  local range = buffer(offset, length)
  local raw = range:uint()
...
-- Size: Bid Size
memx_options_memo_sbe_v1_5_b_size_of.bid_size = 2

-- Display: Bid Size
memx_options_memo_sbe_v1_5_b_display.bid_size = function(value)
  return "Bid Size: "..value
end

-- Dissect: Bid Size
memx_options_memo_sbe_v1_5_b_dissect.bid_size = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.bid_size
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.quotes_group = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.bid_size

  index = index + memx_options_memo_sbe_v1_5_b_size_of.bid_px

  index = index + memx_options_memo_sbe_v1_5_b_size_of.offer_size
...
memx_options_memo_sbe_v1_5_b_display.quotes_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quotes Group
memx_options_memo_sbe_v1_5_b_dissect.quotes_group_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, bid_size = memx_options_memo_sbe_v1_5_b_dissect.bid_size(buffer, index, packet, parent)

  -- Bid Px: 2 Byte Unsigned Fixed Width Integer
  index, bid_px = memx_options_memo_sbe_v1_5_b_dissect.bid_px(buffer, index, packet, parent)

  -- Offer Size: 2 Byte Unsigned Fixed Width Integer
  index, offer_size = memx_options_memo_sbe_v1_5_b_dissect.offer_size(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.quotes_group = function(buffer, offset, packet, parent)
  if show.quotes_group then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.quotes_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.quotes_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.quotes_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.quotes_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Quotes Groups
memx_options_memo_sbe_v1_5_b_size_of.quotes_groups = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.quotes_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quotes Groups
memx_options_memo_sbe_v1_5_b_dissect.quotes_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for quotes_group_index = 1, num_in_group do
    index, quotes_group = memx_options_memo_sbe_v1_5_b_dissect.quotes_group(buffer, index, packet, parent)

    if quotes_group ~= nil then
      local iteration = quotes_group:add(memx_options_memo_sbe_v1_5_b.fields.quotes_group_index, quotes_group_index)
      iteration:set_generated()
    end
  end
...
memx_options_memo_sbe_v1_5_b_dissect.quotes_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.long_one_sided_bulk_quote_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.quotes_groups(buffer, offset + index)

  return index
end

-- Display: Long One Sided Bulk Quote Message
memx_options_memo_sbe_v1_5_b_display.long_one_sided_bulk_quote_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long One Sided Bulk Quote Message
memx_options_memo_sbe_v1_5_b_dissect.long_one_sided_bulk_quote_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, quotes_groups = memx_options_memo_sbe_v1_5_b_dissect.quotes_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Long One Sided Bulk Quote Message
memx_options_memo_sbe_v1_5_b_dissect.long_one_sided_bulk_quote_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.short_one_sided_bulk_quote_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.short_one_sided_bulk_quote_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Short One Sided Bulk Quote Message
memx_options_memo_sbe_v1_5_b_dissect.short_one_sided_bulk_quote_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.short_one_sided_bulk_quote_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.long_two_sided_bulk_quote_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.long_two_sided_bulk_quote_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Long Two Sided Bulk Quote Message
memx_options_memo_sbe_v1_5_b_dissect.long_two_sided_bulk_quote_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.long_two_sided_bulk_quote_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.short_two_sided_bulk_quote_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.short_two_sided_bulk_quote_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Short Two Sided Bulk Quote Message
memx_options_memo_sbe_v1_5_b_dissect.short_two_sided_bulk_quote_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.short_two_sided_bulk_quote_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.new_order_single_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.new_order_single_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: New Order Single Message
memx_options_memo_sbe_v1_5_b_dissect.new_order_single_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.new_order_single_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.payload = function(buffer, offset, template_id)
  -- Size of New Order Single Message
  if template_id == 1 then
    return memx_options_memo_sbe_v1_5_b_size_of.new_order_single_message(buffer, offset)
  end
  -- Size of Short Two Sided Bulk Quote Message
  if template_id == 2 then
    return memx_options_memo_sbe_v1_5_b_size_of.short_two_sided_bulk_quote_message(buffer, offset)
  end
  -- Size of Long Two Sided Bulk Quote Message
  if template_id == 3 then
    return memx_options_memo_sbe_v1_5_b_size_of.long_two_sided_bulk_quote_message(buffer, offset)
  end
  -- Size of Short One Sided Bulk Quote Message
  if template_id == 4 then
    return memx_options_memo_sbe_v1_5_b_size_of.short_one_sided_bulk_quote_message(buffer, offset)
  end
  -- Size of Long One Sided Bulk Quote Message
  if template_id == 5 then
    return memx_options_memo_sbe_v1_5_b_size_of.long_one_sided_bulk_quote_message(buffer, offset)
  end
  -- Size of Order Cancel Replace Request Message
  if template_id == 6 then
    return memx_options_memo_sbe_v1_5_b_size_of.order_cancel_replace_request_message(buffer, offset)
  end
  -- Size of Order Cancel Request Message
  if template_id == 7 then
    return memx_options_memo_sbe_v1_5_b_size_of.order_cancel_request_message(buffer, offset)
  end
  -- Size of Mass Cancel Request Message
  if template_id == 8 then
    return memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_request_message(buffer, offset)
  end
  -- Size of Mass Cancel Clear Lockout Request Message
  if template_id == 9 then
    return memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_clear_lockout_request_message(buffer, offset)
  end
  -- Size of Allocation Instruction Message
  if template_id == 10 then
    return memx_options_memo_sbe_v1_5_b_size_of.allocation_instruction_message(buffer, offset)
  end
  -- Size of Execution Report New Message
  if template_id == 11 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_new_message(buffer, offset)
  end
  -- Size of Execution Report Bulk Quote Pending New Message
  if template_id == 12 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_bulk_quote_pending_new_message(buffer, offset)
  end
  -- Size of Execution Report Bulk Quote Component New Message
  if template_id == 13 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_bulk_quote_component_new_message(buffer, offset)
  end
  -- Size of Execution Report Rejected Message
  if template_id == 14 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_rejected_message(buffer, offset)
  end
  -- Size of Execution Report Trade Message
  if template_id == 15 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_trade_message(buffer, offset)
  end
  -- Size of Execution Report Pending Cancel Message
  if template_id == 16 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_pending_cancel_message(buffer, offset)
  end
  -- Size of Execution Report Canceled Message
  if template_id == 17 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_canceled_message(buffer, offset)
  end
  -- Size of Execution Report Pending Replace Message
  if template_id == 18 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_pending_replace_message(buffer, offset)
  end
  -- Size of Execution Report Replaced Message
  if template_id == 19 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_replaced_message(buffer, offset)
  end
  -- Size of Execution Report Trade Correction Message
  if template_id == 20 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_trade_correction_message(buffer, offset)
  end
  -- Size of Execution Report Trade Break Message
  if template_id == 21 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_trade_break_message(buffer, offset)
  end
  -- Size of Execution Report Restatement Message
  if template_id == 22 then
    return memx_options_memo_sbe_v1_5_b_size_of.execution_report_restatement_message(buffer, offset)
  end
  -- Size of Pending Mass Cancel Message
  if template_id == 23 then
    return memx_options_memo_sbe_v1_5_b_size_of.pending_mass_cancel_message(buffer, offset)
  end
  -- Size of Mass Cancel Reject Message
  if template_id == 24 then
    return memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_reject_message(buffer, offset)
  end
  -- Size of Mass Cancel Done Message
  if template_id == 25 then
    return memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_done_message(buffer, offset)
  end
  -- Size of Order Cancel Reject Message
  if template_id == 26 then
    return memx_options_memo_sbe_v1_5_b_size_of.order_cancel_reject_message(buffer, offset)
  end
  -- Size of Allocation Instruction Ack Message
  if template_id == 27 then
    return memx_options_memo_sbe_v1_5_b_size_of.allocation_instruction_ack_message(buffer, offset)
  end
  -- Size of Allocation Instruction Alert Message
  if template_id == 28 then
    return memx_options_memo_sbe_v1_5_b_size_of.allocation_instruction_alert_message(buffer, offset)
  end
  -- Size of User Notification Message
  if template_id == 29 then
    return memx_options_memo_sbe_v1_5_b_size_of.user_notification_message(buffer, offset)
  end
  -- Size of Mass Cancel Clear Lockout Reject Message
  if template_id == 30 then
    return memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_clear_lockout_reject_message(buffer, offset)
  end
  -- Size of Mass Cancel Clear Lockout Done Message
  if template_id == 31 then
    return memx_options_memo_sbe_v1_5_b_size_of.mass_cancel_clear_lockout_done_message(buffer, offset)
  end
...
-- Display: Payload
memx_options_memo_sbe_v1_5_b_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
memx_options_memo_sbe_v1_5_b_dissect.payload_branches = function(buffer, offset, packet, parent, template_id)
  -- Dissect New Order Single Message
  if template_id == 1 then
    return memx_options_memo_sbe_v1_5_b_dissect.new_order_single_message(buffer, offset, packet, parent)
  end
  -- Dissect Short Two Sided Bulk Quote Message
  if template_id == 2 then
    return memx_options_memo_sbe_v1_5_b_dissect.short_two_sided_bulk_quote_message(buffer, offset, packet, parent)
  end
  -- Dissect Long Two Sided Bulk Quote Message
  if template_id == 3 then
    return memx_options_memo_sbe_v1_5_b_dissect.long_two_sided_bulk_quote_message(buffer, offset, packet, parent)
  end
  -- Dissect Short One Sided Bulk Quote Message
  if template_id == 4 then
    return memx_options_memo_sbe_v1_5_b_dissect.short_one_sided_bulk_quote_message(buffer, offset, packet, parent)
  end
  -- Dissect Long One Sided Bulk Quote Message
  if template_id == 5 then
    return memx_options_memo_sbe_v1_5_b_dissect.long_one_sided_bulk_quote_message(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Replace Request Message
  if template_id == 6 then
    return memx_options_memo_sbe_v1_5_b_dissect.order_cancel_replace_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Request Message
  if template_id == 7 then
    return memx_options_memo_sbe_v1_5_b_dissect.order_cancel_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Request Message
  if template_id == 8 then
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Clear Lockout Request Message
  if template_id == 9 then
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Allocation Instruction Message
  if template_id == 10 then
    return memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report New Message
  if template_id == 11 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_new_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Bulk Quote Pending New Message
  if template_id == 12 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_pending_new_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Bulk Quote Component New Message
  if template_id == 13 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_bulk_quote_component_new_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Rejected Message
  if template_id == 14 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_rejected_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Message
  if template_id == 15 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Pending Cancel Message
  if template_id == 16 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_cancel_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Canceled Message
  if template_id == 17 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_canceled_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Pending Replace Message
  if template_id == 18 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_pending_replace_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Replaced Message
  if template_id == 19 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_replaced_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Correction Message
  if template_id == 20 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_correction_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Break Message
  if template_id == 21 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_trade_break_message(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Restatement Message
  if template_id == 22 then
    return memx_options_memo_sbe_v1_5_b_dissect.execution_report_restatement_message(buffer, offset, packet, parent)
  end
  -- Dissect Pending Mass Cancel Message
  if template_id == 23 then
    return memx_options_memo_sbe_v1_5_b_dissect.pending_mass_cancel_message(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Reject Message
  if template_id == 24 then
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_reject_message(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Done Message
  if template_id == 25 then
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_done_message(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Reject Message
  if template_id == 26 then
    return memx_options_memo_sbe_v1_5_b_dissect.order_cancel_reject_message(buffer, offset, packet, parent)
  end
  -- Dissect Allocation Instruction Ack Message
  if template_id == 27 then
    return memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_ack_message(buffer, offset, packet, parent)
  end
  -- Dissect Allocation Instruction Alert Message
  if template_id == 28 then
    return memx_options_memo_sbe_v1_5_b_dissect.allocation_instruction_alert_message(buffer, offset, packet, parent)
  end
  -- Dissect User Notification Message
  if template_id == 29 then
    return memx_options_memo_sbe_v1_5_b_dissect.user_notification_message(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Clear Lockout Reject Message
  if template_id == 30 then
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_reject_message(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Clear Lockout Done Message
  if template_id == 31 then
    return memx_options_memo_sbe_v1_5_b_dissect.mass_cancel_clear_lockout_done_message(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
memx_options_memo_sbe_v1_5_b_dissect.payload = function(buffer, offset, packet, parent, template_id)
  if not show.payload then
    return memx_options_memo_sbe_v1_5_b_dissect.payload_branches(buffer, offset, packet, parent, template_id)
  end

  -- Calculate size and check that branch is not empty
  local size = memx_options_memo_sbe_v1_5_b_size_of.payload(buffer, offset, template_id)
  if size == 0 then
    return offset
  end
...
-- Size: Version
memx_options_memo_sbe_v1_5_b_size_of.version = 2

-- Display: Version
memx_options_memo_sbe_v1_5_b_display.version = function(value)
  return "Version: "..value
end

-- Dissect: Version
memx_options_memo_sbe_v1_5_b_dissect.version = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.version
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Schema Id
memx_options_memo_sbe_v1_5_b_size_of.schema_id = 1

-- Display: Schema Id
memx_options_memo_sbe_v1_5_b_display.schema_id = function(value)
  return "Schema Id: "..value
end

-- Dissect: Schema Id
memx_options_memo_sbe_v1_5_b_dissect.schema_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.schema_id
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Template Id
memx_options_memo_sbe_v1_5_b_size_of.template_id = 1

-- Display: Template Id
memx_options_memo_sbe_v1_5_b_display.template_id = function(value)
  if value == 1 then
...
-- Dissect: Template Id
memx_options_memo_sbe_v1_5_b_dissect.template_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.template_id
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Block Length
memx_options_memo_sbe_v1_5_b_size_of.block_length = 2

-- Display: Block Length
memx_options_memo_sbe_v1_5_b_display.block_length = function(value)
  return "Block Length: "..value
end

-- Dissect: Block Length
memx_options_memo_sbe_v1_5_b_dissect.block_length = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.block_length
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.sbe_header = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.block_length

  index = index + memx_options_memo_sbe_v1_5_b_size_of.template_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.schema_id

  index = index + memx_options_memo_sbe_v1_5_b_size_of.version

  return index
end

-- Display: Sbe Header
memx_options_memo_sbe_v1_5_b_display.sbe_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sbe Header
memx_options_memo_sbe_v1_5_b_dissect.sbe_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Block Length: 2 Byte Unsigned Fixed Width Integer
  index, block_length = memx_options_memo_sbe_v1_5_b_dissect.block_length(buffer, index, packet, parent)

  -- Template Id: 1 Byte Unsigned Fixed Width Integer Enum with 31 values
  index, template_id = memx_options_memo_sbe_v1_5_b_dissect.template_id(buffer, index, packet, parent)

  -- Schema Id: 1 Byte Unsigned Fixed Width Integer Static
  index, schema_id = memx_options_memo_sbe_v1_5_b_dissect.schema_id(buffer, index, packet, parent)

  -- Version: 2 Byte Unsigned Fixed Width Integer Static
  index, version = memx_options_memo_sbe_v1_5_b_dissect.version(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.sbe_header = function(buffer, offset, packet, parent)
  if show.sbe_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.sbe_header, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.sbe_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.sbe_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.sbe_header_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Sbe Message
memx_options_memo_sbe_v1_5_b_size_of.sbe_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.sbe_header(buffer, offset + index)

  -- Calculate runtime size of Payload field
  local payload_offset = offset + index
  local payload_type = buffer(payload_offset - 4, 1):uint()
  index = index + memx_options_memo_sbe_v1_5_b_size_of.payload(buffer, payload_offset, payload_type)

  return index
end

-- Display: Sbe Message
memx_options_memo_sbe_v1_5_b_display.sbe_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sbe Message
memx_options_memo_sbe_v1_5_b_dissect.sbe_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Sbe Header: Struct of 4 fields
  index, sbe_header = memx_options_memo_sbe_v1_5_b_dissect.sbe_header(buffer, index, packet, parent)

  -- Dependency element: Template Id
  local template_id = buffer(index - 4, 1):uint()

  -- Payload: Runtime Type with 31 branches
  index = memx_options_memo_sbe_v1_5_b_dissect.payload(buffer, index, packet, parent, template_id)

  return index
end

-- Dissect: Sbe Message
memx_options_memo_sbe_v1_5_b_dissect.sbe_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.sequenced_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.sbe_message(buffer, offset + index)

  return index
end

-- Display: Sequenced Message
memx_options_memo_sbe_v1_5_b_display.sequenced_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequenced Message
memx_options_memo_sbe_v1_5_b_dissect.sequenced_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Sbe Message: Struct of 2 fields
  index, sbe_message = memx_options_memo_sbe_v1_5_b_dissect.sbe_message(buffer, index, packet, parent)

  return index
end

-- Dissect: Sequenced Message
memx_options_memo_sbe_v1_5_b_dissect.sequenced_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.total_sequence_count = 8

-- Display: Total Sequence Count
memx_options_memo_sbe_v1_5_b_display.total_sequence_count = function(value)
  return "Total Sequence Count: "..value
end

-- Dissect: Total Sequence Count
memx_options_memo_sbe_v1_5_b_dissect.total_sequence_count = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.total_sequence_count
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.stream_complete_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.total_sequence_count

  return index
end

-- Display: Stream Complete Message
memx_options_memo_sbe_v1_5_b_display.stream_complete_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Complete Message
memx_options_memo_sbe_v1_5_b_dissect.stream_complete_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Total Sequence Count: 8 Byte Unsigned Fixed Width Integer
  index, total_sequence_count = memx_options_memo_sbe_v1_5_b_dissect.total_sequence_count(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.stream_complete_message = function(buffer, offset, packet, parent)
  if show.stream_complete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.stream_complete_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.stream_complete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.stream_complete_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.stream_complete_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Stream Reject Code
memx_options_memo_sbe_v1_5_b_size_of.stream_reject_code = 1

-- Display: Stream Reject Code
memx_options_memo_sbe_v1_5_b_display.stream_reject_code = function(value)
  if value == "R" then
...
memx_options_memo_sbe_v1_5_b_dissect.stream_reject_code = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.stream_reject_code
  local range = buffer(offset, length)
...
memx_options_memo_sbe_v1_5_b_size_of.stream_rejected_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.stream_reject_code

  return index
end

-- Display: Stream Rejected Message
memx_options_memo_sbe_v1_5_b_display.stream_rejected_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Rejected Message
memx_options_memo_sbe_v1_5_b_dissect.stream_rejected_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Stream Reject Code: 1 Byte Ascii String Enum with 3 values
  index, stream_reject_code = memx_options_memo_sbe_v1_5_b_dissect.stream_reject_code(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.stream_rejected_message = function(buffer, offset, packet, parent)
  if show.stream_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.stream_rejected_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.stream_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.stream_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.stream_rejected_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Next Sequence Number
memx_options_memo_sbe_v1_5_b_size_of.next_sequence_number = 8

-- Display: Next Sequence Number
memx_options_memo_sbe_v1_5_b_display.next_sequence_number = function(value)
  return "Next Sequence Number: "..value
end

-- Dissect: Next Sequence Number
memx_options_memo_sbe_v1_5_b_dissect.next_sequence_number = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.next_sequence_number
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.stream_begin_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.next_sequence_number

  index = index + memx_options_memo_sbe_v1_5_b_size_of.max_sequence_number

  return index
end

-- Display: Stream Begin Message
memx_options_memo_sbe_v1_5_b_display.stream_begin_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Begin Message
memx_options_memo_sbe_v1_5_b_dissect.stream_begin_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Next Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, next_sequence_number = memx_options_memo_sbe_v1_5_b_dissect.next_sequence_number(buffer, index, packet, parent)

  -- Max Sequence Number
  index, max_sequence_number = memx_options_memo_sbe_v1_5_b_dissect.max_sequence_number(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.stream_begin_message = function(buffer, offset, packet, parent)
  if show.stream_begin_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.stream_begin_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.stream_begin_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.stream_begin_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.stream_begin_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Message Count
memx_options_memo_sbe_v1_5_b_size_of.message_count = 8

-- Display: Message Count
memx_options_memo_sbe_v1_5_b_display.message_count = function(value)
  return "Message Count: "..value
end

-- Dissect: Message Count
memx_options_memo_sbe_v1_5_b_dissect.message_count = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.message_count
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.replay_complete_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.message_count

  return index
end

-- Display: Replay Complete Message
memx_options_memo_sbe_v1_5_b_display.replay_complete_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Complete Message
memx_options_memo_sbe_v1_5_b_dissect.replay_complete_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Count: 8 Byte Unsigned Fixed Width Integer
  index, message_count = memx_options_memo_sbe_v1_5_b_dissect.message_count(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.replay_complete_message = function(buffer, offset, packet, parent)
  if show.replay_complete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.replay_complete_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.replay_complete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.replay_complete_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.replay_complete_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Replay Reject Code
memx_options_memo_sbe_v1_5_b_size_of.replay_reject_code = 1

-- Display: Replay Reject Code
memx_options_memo_sbe_v1_5_b_display.replay_reject_code = function(value)
  if value == "R" then
...
memx_options_memo_sbe_v1_5_b_dissect.replay_reject_code = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.replay_reject_code
  local range = buffer(offset, length)
  local value = range:string()
...
memx_options_memo_sbe_v1_5_b_size_of.replay_rejected_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.replay_reject_code

  return index
end

-- Display: Replay Rejected Message
memx_options_memo_sbe_v1_5_b_display.replay_rejected_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Rejected Message
memx_options_memo_sbe_v1_5_b_dissect.replay_rejected_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Replay Reject Code: 1 Byte Ascii String Enum with 4 values
  index, replay_reject_code = memx_options_memo_sbe_v1_5_b_dissect.replay_reject_code(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.replay_rejected_message = function(buffer, offset, packet, parent)
  if show.replay_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.replay_rejected_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.replay_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.replay_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.replay_rejected_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Pending Message Count
memx_options_memo_sbe_v1_5_b_size_of.pending_message_count = 4

-- Display: Pending Message Count
memx_options_memo_sbe_v1_5_b_display.pending_message_count = function(value)
  return "Pending Message Count: "..value
end

-- Dissect: Pending Message Count
memx_options_memo_sbe_v1_5_b_dissect.pending_message_count = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.pending_message_count
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.replay_begin_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.next_sequence_number

  index = index + memx_options_memo_sbe_v1_5_b_size_of.pending_message_count

  return index
end

-- Display: Replay Begin Message
memx_options_memo_sbe_v1_5_b_display.replay_begin_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Begin Message
memx_options_memo_sbe_v1_5_b_dissect.replay_begin_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, pending_message_count = memx_options_memo_sbe_v1_5_b_dissect.pending_message_count(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.replay_begin_message = function(buffer, offset, packet, parent)
  if show.replay_begin_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.replay_begin_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.replay_begin_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.replay_begin_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.replay_begin_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Session Id
memx_options_memo_sbe_v1_5_b_size_of.session_id = 8

-- Display: Session Id
memx_options_memo_sbe_v1_5_b_display.session_id = function(value)
  return "Session Id: "..value
end

-- Dissect: Session Id
memx_options_memo_sbe_v1_5_b_dissect.session_id = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.session_id
  local range = buffer(offset, length)
  local value = range:uint64()
...
memx_options_memo_sbe_v1_5_b_size_of.start_of_session_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.session_id

  return index
end

-- Display: Start Of Session Message
memx_options_memo_sbe_v1_5_b_display.start_of_session_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Start Of Session Message
memx_options_memo_sbe_v1_5_b_dissect.start_of_session_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session Id: 8 Byte Unsigned Fixed Width Integer
  index, session_id = memx_options_memo_sbe_v1_5_b_dissect.session_id(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.start_of_session_message = function(buffer, offset, packet, parent)
  if show.start_of_session_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.start_of_session_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.start_of_session_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.start_of_session_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.start_of_session_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Login Reject Code
memx_options_memo_sbe_v1_5_b_size_of.login_reject_code = 1

-- Display: Login Reject Code
memx_options_memo_sbe_v1_5_b_display.login_reject_code = function(value)
  if value == "T" then
...
memx_options_memo_sbe_v1_5_b_dissect.login_reject_code = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.login_reject_code
  local range = buffer(offset, length)
  local value = range:string()
...
memx_options_memo_sbe_v1_5_b_size_of.login_rejected_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.login_reject_code

  return index
end

-- Display: Login Rejected Message
memx_options_memo_sbe_v1_5_b_display.login_rejected_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Rejected Message
memx_options_memo_sbe_v1_5_b_dissect.login_rejected_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Login Reject Code: 1 Byte Ascii String Enum with 4 values
  index, login_reject_code = memx_options_memo_sbe_v1_5_b_dissect.login_reject_code(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.login_rejected_message = function(buffer, offset, packet, parent)
  if show.login_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.login_rejected_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.login_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.login_rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.login_rejected_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Supported Request Mode
memx_options_memo_sbe_v1_5_b_size_of.supported_request_mode = 1

-- Display: Supported Request Mode
memx_options_memo_sbe_v1_5_b_display.supported_request_mode = function(value)
  if value == "S" then
...
memx_options_memo_sbe_v1_5_b_dissect.supported_request_mode = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.supported_request_mode
  local range = buffer(offset, length)
  local value = range:string()
...
memx_options_memo_sbe_v1_5_b_size_of.login_accepted_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.supported_request_mode

  return index
end

-- Display: Login Accepted Message
memx_options_memo_sbe_v1_5_b_display.login_accepted_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Accepted Message
memx_options_memo_sbe_v1_5_b_dissect.login_accepted_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Supported Request Mode: 1 Byte Ascii String Enum with 3 values
  index, supported_request_mode = memx_options_memo_sbe_v1_5_b_dissect.supported_request_mode(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.login_accepted_message = function(buffer, offset, packet, parent)
  if show.login_accepted_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.login_accepted_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.login_accepted_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.login_accepted_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.login_accepted_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Unsequenced Message
memx_options_memo_sbe_v1_5_b_size_of.unsequenced_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.unsequenced_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Unsequenced Message
memx_options_memo_sbe_v1_5_b_dissect.unsequenced_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.unsequenced_message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
memx_options_memo_sbe_v1_5_b_size_of.stream_request_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.stream_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Request Message
memx_options_memo_sbe_v1_5_b_dissect.stream_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.stream_request_message = function(buffer, offset, packet, parent)
  if show.stream_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.stream_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.stream_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.stream_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.stream_request_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Replay All Request Message
memx_options_memo_sbe_v1_5_b_size_of.replay_all_request_message = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_5_b_display.replay_all_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay All Request Message
memx_options_memo_sbe_v1_5_b_dissect.replay_all_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_memo_sbe_v1_5_b_dissect.replay_all_request_message = function(buffer, offset, packet, parent)
  if show.replay_all_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.replay_all_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.replay_all_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.replay_all_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.replay_all_request_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Count
memx_options_memo_sbe_v1_5_b_size_of.count = 4

-- Display: Count
memx_options_memo_sbe_v1_5_b_display.count = function(value)
  return "Count: "..value
end

-- Dissect: Count
memx_options_memo_sbe_v1_5_b_dissect.count = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.count
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.replay_request_message = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_memo_sbe_v1_5_b_size_of.count

  return index
end

-- Display: Replay Request Message
memx_options_memo_sbe_v1_5_b_display.replay_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Request Message
memx_options_memo_sbe_v1_5_b_dissect.replay_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, count = memx_options_memo_sbe_v1_5_b_dissect.count(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.replay_request_message = function(buffer, offset, packet, parent)
  if show.replay_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.replay_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.replay_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.replay_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.replay_request_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Token
memx_options_memo_sbe_v1_5_b_size_of.token = 1

-- Display: Token
memx_options_memo_sbe_v1_5_b_display.token = function(value)
  return "Token: "..value
end

-- Dissect: Token
memx_options_memo_sbe_v1_5_b_dissect.token = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.token
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Token Type
memx_options_memo_sbe_v1_5_b_size_of.token_type = 1

-- Display: Token Type
memx_options_memo_sbe_v1_5_b_display.token_type = function(value)
  return "Token Type: "..value
end

-- Dissect: Token Type
memx_options_memo_sbe_v1_5_b_dissect.token_type = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.token_type
  local range = buffer(offset, length)
  local value = range:string()
...
memx_options_memo_sbe_v1_5_b_size_of.login_request_message = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.token_type

  index = index + memx_options_memo_sbe_v1_5_b_size_of.token

  return index
end

-- Display: Login Request Message
memx_options_memo_sbe_v1_5_b_display.login_request_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Request Message
memx_options_memo_sbe_v1_5_b_dissect.login_request_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Token Type: 1 Byte Ascii String
  index, token_type = memx_options_memo_sbe_v1_5_b_dissect.token_type(buffer, index, packet, parent)

  -- Token: 1 Byte Ascii String
  index, token = memx_options_memo_sbe_v1_5_b_dissect.token(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.login_request_message = function(buffer, offset, packet, parent)
  if show.login_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.login_request_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.login_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.login_request_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.login_request_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Data
memx_options_memo_sbe_v1_5_b_size_of.data = function(buffer, offset, message_type)
  -- Size of Login Request Message
  if message_type == 100 then
    return memx_options_memo_sbe_v1_5_b_size_of.login_request_message(buffer, offset)
  end
  -- Size of Replay Request Message
  if message_type == 101 then
    return memx_options_memo_sbe_v1_5_b_size_of.replay_request_message(buffer, offset)
  end
  -- Size of Replay All Request Message
  if message_type == 102 then
    return memx_options_memo_sbe_v1_5_b_size_of.replay_all_request_message(buffer, offset)
  end
  -- Size of Stream Request Message
  if message_type == 103 then
    return memx_options_memo_sbe_v1_5_b_size_of.stream_request_message(buffer, offset)
  end
  -- Size of Unsequenced Message
  if message_type == 104 then
    return memx_options_memo_sbe_v1_5_b_size_of.unsequenced_message(buffer, offset)
  end
  -- Size of Login Accepted Message
  if message_type == 1 then
    return memx_options_memo_sbe_v1_5_b_size_of.login_accepted_message(buffer, offset)
  end
  -- Size of Login Rejected Message
  if message_type == 2 then
    return memx_options_memo_sbe_v1_5_b_size_of.login_rejected_message(buffer, offset)
  end
  -- Size of Start Of Session Message
  if message_type == 3 then
    return memx_options_memo_sbe_v1_5_b_size_of.start_of_session_message(buffer, offset)
  end
  -- Size of Replay Begin Message
  if message_type == 5 then
    return memx_options_memo_sbe_v1_5_b_size_of.replay_begin_message(buffer, offset)
  end
  -- Size of Replay Rejected Message
  if message_type == 6 then
    return memx_options_memo_sbe_v1_5_b_size_of.replay_rejected_message(buffer, offset)
  end
  -- Size of Replay Complete Message
  if message_type == 7 then
    return memx_options_memo_sbe_v1_5_b_size_of.replay_complete_message(buffer, offset)
  end
  -- Size of Stream Begin Message
  if message_type == 8 then
    return memx_options_memo_sbe_v1_5_b_size_of.stream_begin_message(buffer, offset)
  end
  -- Size of Stream Rejected Message
  if message_type == 9 then
    return memx_options_memo_sbe_v1_5_b_size_of.stream_rejected_message(buffer, offset)
  end
  -- Size of Stream Complete Message
  if message_type == 10 then
    return memx_options_memo_sbe_v1_5_b_size_of.stream_complete_message(buffer, offset)
  end
  -- Size of Sequenced Message
  if message_type == 11 then
    return memx_options_memo_sbe_v1_5_b_size_of.sequenced_message(buffer, offset)
  end
...
-- Display: Data
memx_options_memo_sbe_v1_5_b_display.data = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Data
memx_options_memo_sbe_v1_5_b_dissect.data_branches = function(buffer, offset, packet, parent, message_type)
  -- Dissect Login Request Message
  if message_type == 100 then
    return memx_options_memo_sbe_v1_5_b_dissect.login_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Replay Request Message
  if message_type == 101 then
    return memx_options_memo_sbe_v1_5_b_dissect.replay_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Replay All Request Message
  if message_type == 102 then
    return memx_options_memo_sbe_v1_5_b_dissect.replay_all_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Stream Request Message
  if message_type == 103 then
    return memx_options_memo_sbe_v1_5_b_dissect.stream_request_message(buffer, offset, packet, parent)
  end
  -- Dissect Unsequenced Message
  if message_type == 104 then
    return memx_options_memo_sbe_v1_5_b_dissect.unsequenced_message(buffer, offset, packet, parent)
  end
  -- Dissect Login Accepted Message
  if message_type == 1 then
    return memx_options_memo_sbe_v1_5_b_dissect.login_accepted_message(buffer, offset, packet, parent)
  end
  -- Dissect Login Rejected Message
  if message_type == 2 then
    return memx_options_memo_sbe_v1_5_b_dissect.login_rejected_message(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session Message
  if message_type == 3 then
    return memx_options_memo_sbe_v1_5_b_dissect.start_of_session_message(buffer, offset, packet, parent)
  end
  -- Dissect Replay Begin Message
  if message_type == 5 then
    return memx_options_memo_sbe_v1_5_b_dissect.replay_begin_message(buffer, offset, packet, parent)
  end
  -- Dissect Replay Rejected Message
  if message_type == 6 then
    return memx_options_memo_sbe_v1_5_b_dissect.replay_rejected_message(buffer, offset, packet, parent)
  end
  -- Dissect Replay Complete Message
  if message_type == 7 then
    return memx_options_memo_sbe_v1_5_b_dissect.replay_complete_message(buffer, offset, packet, parent)
  end
  -- Dissect Stream Begin Message
  if message_type == 8 then
    return memx_options_memo_sbe_v1_5_b_dissect.stream_begin_message(buffer, offset, packet, parent)
  end
  -- Dissect Stream Rejected Message
  if message_type == 9 then
    return memx_options_memo_sbe_v1_5_b_dissect.stream_rejected_message(buffer, offset, packet, parent)
  end
  -- Dissect Stream Complete Message
  if message_type == 10 then
    return memx_options_memo_sbe_v1_5_b_dissect.stream_complete_message(buffer, offset, packet, parent)
  end
  -- Dissect Sequenced Message
  if message_type == 11 then
    return memx_options_memo_sbe_v1_5_b_dissect.sequenced_message(buffer, offset, packet, parent)
  end
...
-- Dissect: Data
memx_options_memo_sbe_v1_5_b_dissect.data = function(buffer, offset, packet, parent, message_type)
  if not show.data then
    return memx_options_memo_sbe_v1_5_b_dissect.data_branches(buffer, offset, packet, parent, message_type)
  end

  -- Calculate size and check that branch is not empty
  local size = memx_options_memo_sbe_v1_5_b_size_of.data(buffer, offset, message_type)
  if size == 0 then
    return offset
  end
...
-- Size: Message Length
memx_options_memo_sbe_v1_5_b_size_of.message_length = 2

-- Display: Message Length
memx_options_memo_sbe_v1_5_b_display.message_length = function(value)
  return "Message Length: "..value
end

-- Dissect: Message Length
memx_options_memo_sbe_v1_5_b_dissect.message_length = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.message_length
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Message Type
memx_options_memo_sbe_v1_5_b_size_of.message_type = 1

-- Display: Message Type
memx_options_memo_sbe_v1_5_b_display.message_type = function(value)
  if value == 100 then
...
memx_options_memo_sbe_v1_5_b_dissect.message_type = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_5_b_size_of.message_type
  local range = buffer(offset, length)
  local value = range:uint()
...
memx_options_memo_sbe_v1_5_b_size_of.common_header = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_5_b_size_of.message_type

  index = index + memx_options_memo_sbe_v1_5_b_size_of.message_length

  return index
end

-- Display: Common Header
memx_options_memo_sbe_v1_5_b_display.common_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Common Header
memx_options_memo_sbe_v1_5_b_dissect.common_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Type: 1 Byte Unsigned Fixed Width Integer Enum with 16 values
  index, message_type = memx_options_memo_sbe_v1_5_b_dissect.message_type(buffer, index, packet, parent)

  -- Message Length: 2 Byte Unsigned Fixed Width Integer
  index, message_length = memx_options_memo_sbe_v1_5_b_dissect.message_length(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_5_b_dissect.common_header = function(buffer, offset, packet, parent)
  if show.common_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_memo_sbe_v1_5_b.fields.common_header, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_5_b_dissect.common_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = memx_options_memo_sbe_v1_5_b_display.common_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_5_b_dissect.common_header_fields(buffer, offset, packet, element)
  end
end

-- Dissect Packet
memx_options_memo_sbe_v1_5_b_dissect.packet = function(buffer, packet, parent)
  local index = 0

  -- Common Header: Struct of 2 fields
  index, common_header = memx_options_memo_sbe_v1_5_b_dissect.common_header(buffer, index, packet, parent)

  -- Dependency element: Message Type
  local message_type = buffer(index - 3, 1):uint()

  -- Data: Runtime Type with 15 branches
  index = memx_options_memo_sbe_v1_5_b_dissect.data(buffer, index, packet, parent, message_type)
