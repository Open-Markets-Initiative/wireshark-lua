...
verify.omi_memx_equities_memo_sbe_v1_11_packet_size = function(buffer)
...
local function omi_memx_equities_memo_sbe_v1_11_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_memx_equities_memo_sbe_v1_11_packet_size(buffer) then return false end
