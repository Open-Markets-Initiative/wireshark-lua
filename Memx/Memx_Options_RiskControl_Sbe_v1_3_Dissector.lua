...
-- Protocol table
local memx_options_riskcontrol_sbe_v1_3 = {}
...
omi_memx_options_riskcontrol_sbe_v1_3.fields.max_sequence_number = ProtoField.new("Max Sequence Number", "memx.options.riskcontrol.sbe.v1.3.maxsequencenumber", ftypes.UINT64)
...
-- Efid Optional
memx_options_riskcontrol_sbe_v1_3.efid_optional = {}

-- Size: Efid Optional
memx_options_riskcontrol_sbe_v1_3.efid_optional.size = 4

-- Display: Efid Optional
memx_options_riskcontrol_sbe_v1_3.efid_optional.display = function(value)
  -- Check if field has value
...
memx_options_riskcontrol_sbe_v1_3.efid_optional.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_riskcontrol_sbe_v1_3.efid_optional.size
  local range = buffer(offset, length)
  ...
  local display = memx_options_riskcontrol_sbe_v1_3.efid_optional.display(value, buffer, offset, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.underlier_optional.size = 6

-- Display: Underlier Optional
memx_options_riskcontrol_sbe_v1_3.underlier_optional.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_riskcontrol_sbe_v1_3.underlier_optional.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_riskcontrol_sbe_v1_3.underlier_optional.size
  local range = buffer(offset, length)
  ...
  local display = memx_options_riskcontrol_sbe_v1_3.underlier_optional.display(value, buffer, offset, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.clordid_optional.size

  index = index + memx_options_riskcontrol_sbe_v1_3.underlier_optional.size

  index = index + memx_options_riskcontrol_sbe_v1_3.efid_optional.size

  index = index + memx_options_riskcontrol_sbe_v1_3.risk_group_id.size

  index = index + memx_options_riskcontrol_sbe_v1_3.max_order_msgs.size

  index = index + memx_options_riskcontrol_sbe_v1_3.period_in_milli_seconds.size

  return index
end

-- Display: Cp Order Rate Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Order Rate Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- ClOrdId Optional: 20 Byte Ascii String Nullable
  index, clordid_optional = memx_options_riskcontrol_sbe_v1_3.clordid_optional.dissect(buffer, index, packet, parent)

  -- Underlier Optional: 6 Byte Ascii String Nullable
  index, underlier_optional = memx_options_riskcontrol_sbe_v1_3.underlier_optional.dissect(buffer, index, packet, parent)

  -- Efid Optional: 4 Byte Ascii String Nullable
  index, efid_optional = memx_options_riskcontrol_sbe_v1_3.efid_optional.dissect(buffer, index, packet, parent)

  -- Risk Group Id: 2 Byte Unsigned Fixed Width Integer Nullable
  index, risk_group_id = memx_options_riskcontrol_sbe_v1_3.risk_group_id.dissect(buffer, index, packet, parent)

  -- Max Order Msgs: 4 Byte Unsigned Fixed Width Integer
  index, max_order_msgs = memx_options_riskcontrol_sbe_v1_3.max_order_msgs.dissect(buffer, index, packet, parent)

  -- Period In Milli Seconds: 4 Byte Unsigned Fixed Width Integer
  index, period_in_milli_seconds = memx_options_riskcontrol_sbe_v1_3.period_in_milli_seconds.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Cp Order Rate Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_order_rate_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.display(packet, parent, length)
...
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message = {}

-- Calculate size of: Cp Duplicate Order Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.max_dup_orders.size

  index = index + memx_options_riskcontrol_sbe_v1_3.use_order_price_in_dup_check.size
...
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Duplicate Order Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, max_dup_orders = memx_options_riskcontrol_sbe_v1_3.max_dup_orders.dissect(buffer, index, packet, parent)

  -- Use Order Price In Dup Check: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, use_order_price_in_dup_check = memx_options_riskcontrol_sbe_v1_3.use_order_price_in_dup_check.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_duplicate_order_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message = {}

-- Calculate size of: Cp Market Order Net Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.price_in_dollars.size

  return index
end

-- Display: Cp Market Order Net Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Market Order Net Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, price_in_dollars = memx_options_riskcontrol_sbe_v1_3.price_in_dollars.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Cp Market Order Net Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_market_order_net_notional_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Net Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message = {}

-- Calculate size of: Cp Net Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Net Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_net_notional_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Market Order Gross Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message = {}

-- Calculate size of: Cp Market Order Gross Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Market Order Gross Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_market_order_gross_notional_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Gross Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message = {}

-- Calculate size of: Cp Gross Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Gross Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_gross_notional_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.clordid_optional.size

  index = index + memx_options_riskcontrol_sbe_v1_3.breach_id.size

  return index
end

-- Display: Breach Cleared Message
memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Breach Cleared Message
memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, breach_id = memx_options_riskcontrol_sbe_v1_3.breach_id.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Breach Cleared Message
memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.dissect = function(buffer, offset, packet, parent)
  if show.breach_cleared_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message = {}

-- Calculate size of: Breach Clear Rej Message
memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.clordid.size

  index = index + memx_options_riskcontrol_sbe_v1_3.breach_id.size

  index = index + memx_options_riskcontrol_sbe_v1_3.reject_reason.size

  return index
end

-- Display: Breach Clear Rej Message
memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Breach Clear Rej Message
memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- ClOrdId: 20 Byte Ascii String
  index, clordid = memx_options_riskcontrol_sbe_v1_3.clordid.dissect(buffer, index, packet, parent)

  -- Breach Id: 8 Byte Unsigned Fixed Width Integer
  index, breach_id = memx_options_riskcontrol_sbe_v1_3.breach_id.dissect(buffer, index, packet, parent)

  -- Reject Reason: 2 Byte Unsigned Fixed Width Integer Enum with 48 values
  index, reject_reason = memx_options_riskcontrol_sbe_v1_3.reject_reason.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Breach Clear Rej Message
memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.dissect = function(buffer, offset, packet, parent)
  if show.breach_clear_rej_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.fields(buffer, offset, packet, parent)
  end
end

-- Manual Cp Breach Trigger Rej Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message = {}

-- Calculate size of: Manual Cp Breach Trigger Rej Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Manual Cp Breach Trigger Rej Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.dissect = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_rej_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.fields(buffer, offset, packet, parent)
  end
end

-- Risk Settings Query Rej Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message = {}

-- Calculate size of: Risk Settings Query Rej Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Risk Settings Query Rej Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.dissect = function(buffer, offset, packet, parent)
  if show.risk_settings_query_rej_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.clordid.size

  index = index + memx_options_riskcontrol_sbe_v1_3.number_msgs_sent.size

  return index
end

-- Display: Risk Settings Query Done Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Risk Settings Query Done Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, number_msgs_sent = memx_options_riskcontrol_sbe_v1_3.number_msgs_sent.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Risk Settings Query Done Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.dissect = function(buffer, offset, packet, parent)
  if show.risk_settings_query_done_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message = {}

-- Calculate size of: Single Order Max Contracts Threshold State Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.max_contracts.size

  return index
end

-- Display: Single Order Max Contracts Threshold State Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Max Contracts Threshold State Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, max_contracts = memx_options_riskcontrol_sbe_v1_3.max_contracts.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Single Order Max Contracts Threshold State Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_max_contracts_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.max_notional_in_dollars.size

  return index
end

-- Display: Single Order Max Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Max Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, max_notional_in_dollars = memx_options_riskcontrol_sbe_v1_3.max_notional_in_dollars.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Single Order Max Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_max_notional_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message = {}

-- Calculate size of: Single Order Allow Orders In Crossed Market State Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.allow_orders.size

  return index
end

-- Display: Single Order Allow Orders In Crossed Market State Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Allow Orders In Crossed Market State Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, allow_orders = memx_options_riskcontrol_sbe_v1_3.allow_orders.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Single Order Allow Orders In Crossed Market State Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_allow_orders_in_crossed_market_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.allow_iso_orders.size

  return index
end

-- Display: Single Order Allow Iso Orders State Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Allow Iso Orders State Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, allow_iso_orders = memx_options_riskcontrol_sbe_v1_3.allow_iso_orders.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Single Order Allow Iso Orders State Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_allow_iso_orders_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message = {}

-- Calculate size of: Passive Risk Threshold Notification Message
memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.rule_type.size

  index = index + memx_options_riskcontrol_sbe_v1_3.latest_percentage.size

  index = index + memx_options_riskcontrol_sbe_v1_3.breach_id_optional.size

  index = index + memx_options_riskcontrol_sbe_v1_3.transact_time.size

  return index
end

-- Display: Passive Risk Threshold Notification Message
memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Passive Risk Threshold Notification Message
memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, rule_type = memx_options_riskcontrol_sbe_v1_3.rule_type.dissect(buffer, index, packet, parent)

  -- Latest Percentage: 1 Byte Unsigned Fixed Width Integer
  index, latest_percentage = memx_options_riskcontrol_sbe_v1_3.latest_percentage.dissect(buffer, index, packet, parent)

  -- Breach Id Optional: 8 Byte Unsigned Fixed Width Integer Nullable
  index, breach_id_optional = memx_options_riskcontrol_sbe_v1_3.breach_id_optional.dissect(buffer, index, packet, parent)

  -- Transact Time: 8 Byte Unsigned Fixed Width Integer
  index, transact_time = memx_options_riskcontrol_sbe_v1_3.transact_time.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Passive Risk Threshold Notification Message
memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.dissect = function(buffer, offset, packet, parent)
  if show.passive_risk_threshold_notification_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.clordid.size

  index = index + memx_options_riskcontrol_sbe_v1_3.risk_type.size
...
memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Risk Threshold Update Rej Message
memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, risk_type = memx_options_riskcontrol_sbe_v1_3.risk_type.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.dissect = function(buffer, offset, packet, parent)
  if show.risk_threshold_update_rej_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message = {}

-- Calculate size of: Manual Cp Breach Trigger Done Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.total_affected_orders.size

  return index
end

-- Display: Manual Cp Breach Trigger Done Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Manual Cp Breach Trigger Done Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, total_affected_orders = memx_options_riskcontrol_sbe_v1_3.total_affected_orders.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Manual Cp Breach Trigger Done Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.dissect = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_done_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.fields(buffer, offset, packet, parent)
  end
end

-- Manual Cp Breach Trigger Pending Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message = {}

-- Calculate size of: Manual Cp Breach Trigger Pending Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Manual Cp Breach Trigger Pending Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.dissect = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_pending_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.count.size
...
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Breach Count Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, count = memx_options_riskcontrol_sbe_v1_3.count.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_breach_count_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.percent.size
...
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Percent Outstanding Contracts Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, percent = memx_options_riskcontrol_sbe_v1_3.percent.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_percent_outstanding_contracts_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message = {}

-- Calculate size of: Cp Total Executions Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.total_executions.size
...
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Total Executions Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, total_executions = memx_options_riskcontrol_sbe_v1_3.total_executions.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_total_executions_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Executed Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message = {}

-- Calculate size of: Cp Executed Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Executed Notional Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_executed_notional_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.volume.size
...
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Volume Threshold State Message
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, volume = memx_options_riskcontrol_sbe_v1_3.volume.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_volume_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message = {}

-- Calculate size of: Active Risk Quantity Update Notification Message
memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.sending_time.size

  index = index + memx_options_riskcontrol_sbe_v1_3.transact_time.size

  index = index + memx_options_riskcontrol_sbe_v1_3.order_id.size

  index = index + memx_options_riskcontrol_sbe_v1_3.trd_match_id.size

  index = index + memx_options_riskcontrol_sbe_v1_3.efid.size

  index = index + memx_options_riskcontrol_sbe_v1_3.underlier.size

  index = index + memx_options_riskcontrol_sbe_v1_3.option_security_id.size

  index = index + memx_options_riskcontrol_sbe_v1_3.side.size

  index = index + memx_options_riskcontrol_sbe_v1_3.last_px.size

  index = index + memx_options_riskcontrol_sbe_v1_3.last_qty.size

  index = index + memx_options_riskcontrol_sbe_v1_3.un_acked_quantity.size

  return index
end

-- Display: Active Risk Quantity Update Notification Message
memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Active Risk Quantity Update Notification Message
memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Sending Time: 8 Byte Unsigned Fixed Width Integer
  index, sending_time = memx_options_riskcontrol_sbe_v1_3.sending_time.dissect(buffer, index, packet, parent)

  -- Transact Time: 8 Byte Unsigned Fixed Width Integer
  index, transact_time = memx_options_riskcontrol_sbe_v1_3.transact_time.dissect(buffer, index, packet, parent)

  -- Order Id: 8 Byte Unsigned Fixed Width Integer
  index, order_id = memx_options_riskcontrol_sbe_v1_3.order_id.dissect(buffer, index, packet, parent)

  -- Trd Match Id: 8 Byte Unsigned Fixed Width Integer
  index, trd_match_id = memx_options_riskcontrol_sbe_v1_3.trd_match_id.dissect(buffer, index, packet, parent)

  -- Efid: 4 Byte Ascii String
  index, efid = memx_options_riskcontrol_sbe_v1_3.efid.dissect(buffer, index, packet, parent)

  -- Underlier: 6 Byte Ascii String
  index, underlier = memx_options_riskcontrol_sbe_v1_3.underlier.dissect(buffer, index, packet, parent)

  -- Option Security Id: 8 Byte Ascii String
  index, option_security_id = memx_options_riskcontrol_sbe_v1_3.option_security_id.dissect(buffer, index, packet, parent)

  -- Side: 1 Byte Ascii String Enum with 2 values
  index, side = memx_options_riskcontrol_sbe_v1_3.side.dissect(buffer, index, packet, parent)

  -- Last Px: 8 Byte Unsigned Fixed Width Integer
  index, last_px = memx_options_riskcontrol_sbe_v1_3.last_px.dissect(buffer, index, packet, parent)

  -- Last Qty: 4 Byte Unsigned Fixed Width Integer
  index, last_qty = memx_options_riskcontrol_sbe_v1_3.last_qty.dissect(buffer, index, packet, parent)

  -- Un Acked Quantity: 4 Byte Unsigned Fixed Width Integer
  index, un_acked_quantity = memx_options_riskcontrol_sbe_v1_3.un_acked_quantity.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Active Risk Quantity Update Notification Message
memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.dissect = function(buffer, offset, packet, parent)
  if show.active_risk_quantity_update_notification_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.threshold_quantity.size
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Active Risk Acknowledge Rej Message
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, threshold_quantity = memx_options_riskcontrol_sbe_v1_3.threshold_quantity.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.dissect = function(buffer, offset, packet, parent)
  if show.active_risk_acknowledge_rej_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.quantity.size
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Active Risk Acknowledged Message
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, quantity = memx_options_riskcontrol_sbe_v1_3.quantity.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.dissect = function(buffer, offset, packet, parent)
  if show.active_risk_acknowledged_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message = {}

-- Calculate size of: Active Risk Threshold Change Rej Message
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.clordid.size

  index = index + memx_options_riskcontrol_sbe_v1_3.underlier_active_risk_threshold_change_rej_underlier.size

  index = index + memx_options_riskcontrol_sbe_v1_3.efi_d_active_risk_threshold_change_rej_efid.size
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Active Risk Threshold Change Rej Message
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, underlier_active_risk_threshold_change_rej_underlier = memx_options_riskcontrol_sbe_v1_3.underlier_active_risk_threshold_change_rej_underlier.dissect(buffer, index, packet, parent)

  -- Efi D Active Risk Threshold Change Rej Efid: 4 Byte Ascii String
  index, efi_d_active_risk_threshold_change_rej_efid = memx_options_riskcontrol_sbe_v1_3.efi_d_active_risk_threshold_change_rej_efid.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.dissect = function(buffer, offset, packet, parent)
  if show.active_risk_threshold_change_rej_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.fields(buffer, offset, packet, parent)
  end
end

-- Active Risk Threshold State Message
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message = {}

-- Calculate size of: Active Risk Threshold State Message
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Active Risk Threshold State Message
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.dissect = function(buffer, offset, packet, parent)
  if show.active_risk_threshold_state_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Order Rate Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message = {}

-- Calculate size of: Cp Order Rate Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Order Rate Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_order_rate_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message = {}

-- Calculate size of: Cp Duplicate Order Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.use_order_price_in_dup_check_optional.size
...
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Duplicate Order Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, use_order_price_in_dup_check_optional = memx_options_riskcontrol_sbe_v1_3.use_order_price_in_dup_check_optional.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_duplicate_order_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Market Order Net Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message = {}

-- Calculate size of: Cp Market Order Net Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Market Order Net Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_market_order_net_notional_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Net Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message = {}

-- Calculate size of: Cp Net Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Net Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_net_notional_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Market Order Gross Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message = {}

-- Calculate size of: Cp Market Order Gross Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Market Order Gross Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_market_order_gross_notional_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Gross Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message = {}

-- Calculate size of: Cp Gross Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Gross Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_gross_notional_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Single Order Max Contracts Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message = {}

-- Calculate size of: Single Order Max Contracts Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Max Contracts Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_max_contracts_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Single Order Max Notional Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message = {}

-- Calculate size of: Single Order Max Notional Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Max Notional Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_max_notional_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Single Order Allow Orders In Crossed Market Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message = {}

-- Calculate size of: Single Order Allow Orders In Crossed Market Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Allow Orders In Crossed Market Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_allow_orders_in_crossed_market_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Single Order Allow Iso Orders Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message = {}

-- Calculate size of: Single Order Allow Iso Orders Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Single Order Allow Iso Orders Change Req Message
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.single_order_allow_iso_orders_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Clear Breach Req Message
memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message = {}

-- Calculate size of: Cp Clear Breach Req Message
memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Clear Breach Req Message
memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_clear_breach_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + memx_options_riskcontrol_sbe_v1_3.send_cancels.size

  return index
end

-- Display: Manual Cp Breach Trigger Req Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Manual Cp Breach Trigger Req Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, send_cancels = memx_options_riskcontrol_sbe_v1_3.send_cancels.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Manual Cp Breach Trigger Req Message
memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.dissect = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Breach Count Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message = {}

-- Calculate size of: Cp Breach Count Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Breach Count Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_breach_count_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Percent Outstanding Contracts Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message = {}

-- Calculate size of: Cp Percent Outstanding Contracts Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Percent Outstanding Contracts Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_percent_outstanding_contracts_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Total Executions Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message = {}

-- Calculate size of: Cp Total Executions Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Total Executions Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_total_executions_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Executed Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message = {}

-- Calculate size of: Cp Executed Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Executed Notional Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_executed_notional_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Cp Volume Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message = {}

-- Calculate size of: Cp Volume Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cp Volume Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.cp_volume_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Active Risk Acknowledgement Req Message
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message = {}

-- Calculate size of: Active Risk Acknowledgement Req Message
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Active Risk Acknowledgement Req Message
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.dissect = function(buffer, offset, packet, parent)
  if show.active_risk_acknowledgement_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.clordid.size

  index = index + memx_options_riskcontrol_sbe_v1_3.underlier_active_risk_threshold_change_req_underlier.size

  index = index + memx_options_riskcontrol_sbe_v1_3.efi_d_active_risk_threshold_change_req_efid.size
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Active Risk Threshold Change Req Message
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, underlier_active_risk_threshold_change_req_underlier = memx_options_riskcontrol_sbe_v1_3.underlier_active_risk_threshold_change_req_underlier.dissect(buffer, index, packet, parent)

  -- Efi D Active Risk Threshold Change Req Efid: 4 Byte Ascii String
  index, efi_d_active_risk_threshold_change_req_efid = memx_options_riskcontrol_sbe_v1_3.efi_d_active_risk_threshold_change_req_efid.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.dissect = function(buffer, offset, packet, parent)
  if show.active_risk_threshold_change_req_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.fields(buffer, offset, packet, parent)
  end
end

-- Risk Settings Query Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message = {}

-- Calculate size of: Risk Settings Query Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Risk Settings Query Message
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.dissect = function(buffer, offset, packet, parent)
  if show.risk_settings_query_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.fields(buffer, offset, packet, parent)
  end
end

-- Payload
memx_options_riskcontrol_sbe_v1_3.payload = {}

-- Calculate runtime size of: Payload
memx_options_riskcontrol_sbe_v1_3.payload.size = function(buffer, offset, template_id)
  -- Size of Risk Settings Query Message
  if template_id == 1 then
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.size(buffer, offset)
  end
  -- Size of Active Risk Threshold Change Req Message
  if template_id == 2 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Active Risk Acknowledgement Req Message
  if template_id == 3 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.size(buffer, offset)
  end
  -- Size of Cp Volume Threshold Change Req Message
  if template_id == 4 then
    return memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Executed Notional Threshold Change Req Message
  if template_id == 5 then
    return memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Total Executions Threshold Change Req Message
  if template_id == 6 then
    return memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Percent Outstanding Contracts Threshold Change Req Message
  if template_id == 7 then
    return memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Breach Count Threshold Change Req Message
  if template_id == 8 then
    return memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Manual Cp Breach Trigger Req Message
  if template_id == 9 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.size(buffer, offset)
  end
  -- Size of Cp Clear Breach Req Message
  if template_id == 10 then
    return memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.size(buffer, offset)
  end
  -- Size of Single Order Allow Iso Orders Change Req Message
  if template_id == 11 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.size(buffer, offset)
  end
  -- Size of Single Order Allow Orders In Crossed Market Change Req Message
  if template_id == 12 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.size(buffer, offset)
  end
  -- Size of Single Order Max Notional Change Req Message
  if template_id == 13 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.size(buffer, offset)
  end
  -- Size of Single Order Max Contracts Change Req Message
  if template_id == 14 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Gross Notional Threshold Change Req Message
  if template_id == 18 then
    return memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Market Order Gross Notional Threshold Change Req Message
  if template_id == 19 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Net Notional Threshold Change Req Message
  if template_id == 20 then
    return memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Market Order Net Notional Threshold Change Req Message
  if template_id == 21 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Duplicate Order Threshold Change Req Message
  if template_id == 22 then
    return memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Cp Order Rate Threshold Change Req Message
  if template_id == 23 then
    return memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.size(buffer, offset)
  end
  -- Size of Active Risk Threshold State Message
  if template_id == 30 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.size(buffer, offset)
  end
  -- Size of Active Risk Threshold Change Rej Message
  if template_id == 31 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.size(buffer, offset)
  end
  -- Size of Active Risk Acknowledged Message
  if template_id == 32 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.size(buffer, offset)
  end
  -- Size of Active Risk Acknowledge Rej Message
  if template_id == 33 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.size(buffer, offset)
  end
  -- Size of Active Risk Quantity Update Notification Message
  if template_id == 34 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.size(buffer, offset)
  end
  -- Size of Cp Volume Threshold State Message
  if template_id == 35 then
    return memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Executed Notional Threshold State Message
  if template_id == 36 then
    return memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Total Executions Threshold State Message
  if template_id == 37 then
    return memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Percent Outstanding Contracts Threshold State Message
  if template_id == 38 then
    return memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Breach Count Threshold State Message
  if template_id == 39 then
    return memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.size(buffer, offset)
  end
  -- Size of Manual Cp Breach Trigger Pending Message
  if template_id == 40 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.size(buffer, offset)
  end
  -- Size of Manual Cp Breach Trigger Done Message
  if template_id == 41 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.size(buffer, offset)
  end
  -- Size of Risk Threshold Update Rej Message
  if template_id == 42 then
    return memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.size(buffer, offset)
  end
  -- Size of Passive Risk Threshold Notification Message
  if template_id == 43 then
    return memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.size(buffer, offset)
  end
  -- Size of Single Order Allow Iso Orders State Message
  if template_id == 44 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.size(buffer, offset)
  end
  -- Size of Single Order Allow Orders In Crossed Market State Message
  if template_id == 45 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.size(buffer, offset)
  end
  -- Size of Single Order Max Notional Threshold State Message
  if template_id == 46 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.size(buffer, offset)
  end
  -- Size of Single Order Max Contracts Threshold State Message
  if template_id == 47 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.size(buffer, offset)
  end
  -- Size of Risk Settings Query Done Message
  if template_id == 48 then
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.size(buffer, offset)
  end
  -- Size of Risk Settings Query Rej Message
  if template_id == 49 then
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.size(buffer, offset)
  end
  -- Size of Manual Cp Breach Trigger Rej Message
  if template_id == 50 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.size(buffer, offset)
  end
  -- Size of Breach Clear Rej Message
  if template_id == 51 then
    return memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.size(buffer, offset)
  end
  -- Size of Breach Cleared Message
  if template_id == 52 then
    return memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.size(buffer, offset)
  end
  -- Size of Cp Gross Notional Threshold State Message
  if template_id == 60 then
    return memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Market Order Gross Notional Threshold State Message
  if template_id == 61 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Net Notional Threshold State Message
  if template_id == 62 then
    return memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Market Order Net Notional Threshold State Message
  if template_id == 63 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Duplicate Order Threshold State Message
  if template_id == 64 then
    return memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.size(buffer, offset)
  end
  -- Size of Cp Order Rate Threshold State Message
  if template_id == 65 then
    return memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.size(buffer, offset)
  end
...
memx_options_riskcontrol_sbe_v1_3.payload.branches = function(buffer, offset, packet, parent, template_id)
  -- Dissect Risk Settings Query Message
  if template_id == 1 then
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Active Risk Threshold Change Req Message
  if template_id == 2 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Active Risk Acknowledgement Req Message
  if template_id == 3 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledgement_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Volume Threshold Change Req Message
  if template_id == 4 then
    return memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Executed Notional Threshold Change Req Message
  if template_id == 5 then
    return memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Total Executions Threshold Change Req Message
  if template_id == 6 then
    return memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Percent Outstanding Contracts Threshold Change Req Message
  if template_id == 7 then
    return memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Breach Count Threshold Change Req Message
  if template_id == 8 then
    return memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Manual Cp Breach Trigger Req Message
  if template_id == 9 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Clear Breach Req Message
  if template_id == 10 then
    return memx_options_riskcontrol_sbe_v1_3.cp_clear_breach_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Allow Iso Orders Change Req Message
  if template_id == 11 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Allow Orders In Crossed Market Change Req Message
  if template_id == 12 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Max Notional Change Req Message
  if template_id == 13 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Max Contracts Change Req Message
  if template_id == 14 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Gross Notional Threshold Change Req Message
  if template_id == 18 then
    return memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Market Order Gross Notional Threshold Change Req Message
  if template_id == 19 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Net Notional Threshold Change Req Message
  if template_id == 20 then
    return memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Market Order Net Notional Threshold Change Req Message
  if template_id == 21 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Duplicate Order Threshold Change Req Message
  if template_id == 22 then
    return memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Order Rate Threshold Change Req Message
  if template_id == 23 then
    return memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_change_req_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Active Risk Threshold State Message
  if template_id == 30 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Active Risk Threshold Change Rej Message
  if template_id == 31 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_threshold_change_rej_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Active Risk Acknowledged Message
  if template_id == 32 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledged_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Active Risk Acknowledge Rej Message
  if template_id == 33 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_acknowledge_rej_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Active Risk Quantity Update Notification Message
  if template_id == 34 then
    return memx_options_riskcontrol_sbe_v1_3.active_risk_quantity_update_notification_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Volume Threshold State Message
  if template_id == 35 then
    return memx_options_riskcontrol_sbe_v1_3.cp_volume_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Executed Notional Threshold State Message
  if template_id == 36 then
    return memx_options_riskcontrol_sbe_v1_3.cp_executed_notional_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Total Executions Threshold State Message
  if template_id == 37 then
    return memx_options_riskcontrol_sbe_v1_3.cp_total_executions_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Percent Outstanding Contracts Threshold State Message
  if template_id == 38 then
    return memx_options_riskcontrol_sbe_v1_3.cp_percent_outstanding_contracts_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Breach Count Threshold State Message
  if template_id == 39 then
    return memx_options_riskcontrol_sbe_v1_3.cp_breach_count_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Manual Cp Breach Trigger Pending Message
  if template_id == 40 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_pending_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Manual Cp Breach Trigger Done Message
  if template_id == 41 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_done_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Risk Threshold Update Rej Message
  if template_id == 42 then
    return memx_options_riskcontrol_sbe_v1_3.risk_threshold_update_rej_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Passive Risk Threshold Notification Message
  if template_id == 43 then
    return memx_options_riskcontrol_sbe_v1_3.passive_risk_threshold_notification_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Allow Iso Orders State Message
  if template_id == 44 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_iso_orders_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Allow Orders In Crossed Market State Message
  if template_id == 45 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_allow_orders_in_crossed_market_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Max Notional Threshold State Message
  if template_id == 46 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_notional_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Single Order Max Contracts Threshold State Message
  if template_id == 47 then
    return memx_options_riskcontrol_sbe_v1_3.single_order_max_contracts_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Risk Settings Query Done Message
  if template_id == 48 then
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_done_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Risk Settings Query Rej Message
  if template_id == 49 then
    return memx_options_riskcontrol_sbe_v1_3.risk_settings_query_rej_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Manual Cp Breach Trigger Rej Message
  if template_id == 50 then
    return memx_options_riskcontrol_sbe_v1_3.manual_cp_breach_trigger_rej_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Breach Clear Rej Message
  if template_id == 51 then
    return memx_options_riskcontrol_sbe_v1_3.breach_clear_rej_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Breach Cleared Message
  if template_id == 52 then
    return memx_options_riskcontrol_sbe_v1_3.breach_cleared_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Gross Notional Threshold State Message
  if template_id == 60 then
    return memx_options_riskcontrol_sbe_v1_3.cp_gross_notional_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Market Order Gross Notional Threshold State Message
  if template_id == 61 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_gross_notional_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Net Notional Threshold State Message
  if template_id == 62 then
    return memx_options_riskcontrol_sbe_v1_3.cp_net_notional_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Market Order Net Notional Threshold State Message
  if template_id == 63 then
    return memx_options_riskcontrol_sbe_v1_3.cp_market_order_net_notional_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Duplicate Order Threshold State Message
  if template_id == 64 then
    return memx_options_riskcontrol_sbe_v1_3.cp_duplicate_order_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cp Order Rate Threshold State Message
  if template_id == 65 then
    return memx_options_riskcontrol_sbe_v1_3.cp_order_rate_threshold_state_message.dissect(buffer, offset, packet, parent)
  end
...
memx_options_riskcontrol_sbe_v1_3.sbe_header.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.block_length.size

  index = index + memx_options_riskcontrol_sbe_v1_3.template_id.size

  index = index + memx_options_riskcontrol_sbe_v1_3.schema_id.size

  index = index + memx_options_riskcontrol_sbe_v1_3.version.size

  return index
end

-- Display: Sbe Header
memx_options_riskcontrol_sbe_v1_3.sbe_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sbe Header
memx_options_riskcontrol_sbe_v1_3.sbe_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Block Length: 2 Byte Unsigned Fixed Width Integer
  index, block_length = memx_options_riskcontrol_sbe_v1_3.block_length.dissect(buffer, index, packet, parent)

  -- Template Id: 1 Byte Unsigned Fixed Width Integer Enum with 49 values
  index, template_id = memx_options_riskcontrol_sbe_v1_3.template_id.dissect(buffer, index, packet, parent)

  -- Schema Id: 1 Byte Unsigned Fixed Width Integer Static
  index, schema_id = memx_options_riskcontrol_sbe_v1_3.schema_id.dissect(buffer, index, packet, parent)

  -- Version: 2 Byte Unsigned Fixed Width Integer Static
  index, version = memx_options_riskcontrol_sbe_v1_3.version.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Sbe Header
memx_options_riskcontrol_sbe_v1_3.sbe_header.dissect = function(buffer, offset, packet, parent)
  if show.sbe_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_3.fields.sbe_header, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_3.sbe_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.sbe_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.sbe_header.fields(buffer, offset, packet, parent)
  end
end

-- Sbe Message
memx_options_riskcontrol_sbe_v1_3.sbe_message = {}

-- Calculate size of: Sbe Message
memx_options_riskcontrol_sbe_v1_3.sbe_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.sbe_header.size(buffer, offset + index)

  -- Calculate runtime size of Payload field
  local payload_offset = offset + index
  local payload_type = buffer(payload_offset - 4, 1):uint()
  index = index + memx_options_riskcontrol_sbe_v1_3.payload.size(buffer, payload_offset, payload_type)

  return index
end

-- Display: Sbe Message
memx_options_riskcontrol_sbe_v1_3.sbe_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sbe Message
memx_options_riskcontrol_sbe_v1_3.sbe_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Sbe Header: Struct of 4 fields
  index, sbe_header = memx_options_riskcontrol_sbe_v1_3.sbe_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Template Id
  local template_id = buffer(index - 4, 1):uint()

  -- Payload: Runtime Type with 49 branches
  index = memx_options_riskcontrol_sbe_v1_3.payload.dissect(buffer, index, packet, parent, template_id)
...
-- Sequenced Message
memx_options_riskcontrol_sbe_v1_3.sequenced_message = {}

-- Calculate size of: Sequenced Message
memx_options_riskcontrol_sbe_v1_3.sequenced_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.sbe_message.size(buffer, offset + index)

  return index
end

-- Display: Sequenced Message
memx_options_riskcontrol_sbe_v1_3.sequenced_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequenced Message
memx_options_riskcontrol_sbe_v1_3.sequenced_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Sbe Message: Struct of 2 fields
  index, sbe_message = memx_options_riskcontrol_sbe_v1_3.sbe_message.dissect(buffer, index, packet, parent)
...
memx_options_riskcontrol_sbe_v1_3.stream_complete_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.total_sequence_count.size

  return index
end

-- Display: Stream Complete Message
memx_options_riskcontrol_sbe_v1_3.stream_complete_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Complete Message
memx_options_riskcontrol_sbe_v1_3.stream_complete_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Total Sequence Count: 8 Byte Unsigned Fixed Width Integer
  index, total_sequence_count = memx_options_riskcontrol_sbe_v1_3.total_sequence_count.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Stream Complete Message
memx_options_riskcontrol_sbe_v1_3.stream_complete_message.dissect = function(buffer, offset, packet, parent)
  if show.stream_complete_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.stream_complete_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.stream_complete_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.stream_complete_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.stream_reject_code.size

  return index
end

-- Display: Stream Rejected Message
memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Rejected Message
memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Stream Reject Code: 1 Byte Ascii String Enum with 3 values
  index, stream_reject_code = memx_options_riskcontrol_sbe_v1_3.stream_reject_code.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Stream Rejected Message
memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.dissect = function(buffer, offset, packet, parent)
  if show.stream_rejected_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.stream_begin_message = {}

-- Calculate size of: Stream Begin Message
memx_options_riskcontrol_sbe_v1_3.stream_begin_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.next_sequence_number.size

  index = index + memx_options_riskcontrol_sbe_v1_3.max_sequence_number.size

  return index
end

-- Display: Stream Begin Message
memx_options_riskcontrol_sbe_v1_3.stream_begin_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Begin Message
memx_options_riskcontrol_sbe_v1_3.stream_begin_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Next Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, next_sequence_number = memx_options_riskcontrol_sbe_v1_3.next_sequence_number.dissect(buffer, index, packet, parent)

  -- Max Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, max_sequence_number = memx_options_riskcontrol_sbe_v1_3.max_sequence_number.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Stream Begin Message
memx_options_riskcontrol_sbe_v1_3.stream_begin_message.dissect = function(buffer, offset, packet, parent)
  if show.stream_begin_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.stream_begin_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.stream_begin_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.stream_begin_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.replay_complete_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.message_count.size

  return index
end

-- Display: Replay Complete Message
memx_options_riskcontrol_sbe_v1_3.replay_complete_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Complete Message
memx_options_riskcontrol_sbe_v1_3.replay_complete_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Count: 8 Byte Unsigned Fixed Width Integer
  index, message_count = memx_options_riskcontrol_sbe_v1_3.message_count.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Replay Complete Message
memx_options_riskcontrol_sbe_v1_3.replay_complete_message.dissect = function(buffer, offset, packet, parent)
  if show.replay_complete_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.replay_complete_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.replay_complete_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.replay_complete_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.replay_reject_code.size

  return index
end

-- Display: Replay Rejected Message
memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Rejected Message
memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Replay Reject Code: 1 Byte Ascii String Enum with 4 values
  index, replay_reject_code = memx_options_riskcontrol_sbe_v1_3.replay_reject_code.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Replay Rejected Message
memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.dissect = function(buffer, offset, packet, parent)
  if show.replay_rejected_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.replay_begin_message = {}

-- Calculate size of: Replay Begin Message
memx_options_riskcontrol_sbe_v1_3.replay_begin_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.next_sequence_number.size

  index = index + memx_options_riskcontrol_sbe_v1_3.pending_message_count.size

  return index
end

-- Display: Replay Begin Message
memx_options_riskcontrol_sbe_v1_3.replay_begin_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Begin Message
memx_options_riskcontrol_sbe_v1_3.replay_begin_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, pending_message_count = memx_options_riskcontrol_sbe_v1_3.pending_message_count.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Replay Begin Message
memx_options_riskcontrol_sbe_v1_3.replay_begin_message.dissect = function(buffer, offset, packet, parent)
  if show.replay_begin_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.replay_begin_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.replay_begin_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.replay_begin_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.start_of_session_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.session_id.size

  return index
end

-- Display: Start Of Session Message
memx_options_riskcontrol_sbe_v1_3.start_of_session_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Start Of Session Message
memx_options_riskcontrol_sbe_v1_3.start_of_session_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session Id: 8 Byte Unsigned Fixed Width Integer
  index, session_id = memx_options_riskcontrol_sbe_v1_3.session_id.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Start Of Session Message
memx_options_riskcontrol_sbe_v1_3.start_of_session_message.dissect = function(buffer, offset, packet, parent)
  if show.start_of_session_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.start_of_session_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.start_of_session_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.start_of_session_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.login_rejected_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.login_reject_code.size

  return index
end

-- Display: Login Rejected Message
memx_options_riskcontrol_sbe_v1_3.login_rejected_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Rejected Message
memx_options_riskcontrol_sbe_v1_3.login_rejected_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Login Reject Code: 1 Byte Ascii String Enum with 4 values
  index, login_reject_code = memx_options_riskcontrol_sbe_v1_3.login_reject_code.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Login Rejected Message
memx_options_riskcontrol_sbe_v1_3.login_rejected_message.dissect = function(buffer, offset, packet, parent)
  if show.login_rejected_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.login_rejected_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.login_rejected_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_3.login_accepted_message = {}

-- Calculate size of: Login Accepted Message
memx_options_riskcontrol_sbe_v1_3.login_accepted_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.supported_request_mode.size

  return index
end

-- Display: Login Accepted Message
memx_options_riskcontrol_sbe_v1_3.login_accepted_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Accepted Message
memx_options_riskcontrol_sbe_v1_3.login_accepted_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Supported Request Mode: 1 Byte Ascii String Enum with 3 values
  index, supported_request_mode = memx_options_riskcontrol_sbe_v1_3.supported_request_mode.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Login Accepted Message
memx_options_riskcontrol_sbe_v1_3.login_accepted_message.dissect = function(buffer, offset, packet, parent)
  if show.login_accepted_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.login_accepted_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.login_accepted_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.login_accepted_message.fields(buffer, offset, packet, parent)
  end
end

-- Unsequenced Message
memx_options_riskcontrol_sbe_v1_3.unsequenced_message = {}

-- Calculate size of: Unsequenced Message
memx_options_riskcontrol_sbe_v1_3.unsequenced_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.unsequenced_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Unsequenced Message
memx_options_riskcontrol_sbe_v1_3.unsequenced_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.stream_request_message = {}

-- Calculate size of: Stream Request Message
memx_options_riskcontrol_sbe_v1_3.stream_request_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.stream_request_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Stream Request Message
memx_options_riskcontrol_sbe_v1_3.stream_request_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.stream_request_message.dissect = function(buffer, offset, packet, parent)
  if show.stream_request_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.stream_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.stream_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.stream_request_message.fields(buffer, offset, packet, parent)
  end
end

-- Replay All Request Message
memx_options_riskcontrol_sbe_v1_3.replay_all_request_message = {}

-- Calculate size of: Replay All Request Message
memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay All Request Message
memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.dissect = function(buffer, offset, packet, parent)
  if show.replay_all_request_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.fields(buffer, offset, packet, parent)
  end
end

-- Replay Request Message
memx_options_riskcontrol_sbe_v1_3.replay_request_message = {}

-- Calculate size of: Replay Request Message
memx_options_riskcontrol_sbe_v1_3.replay_request_message.size = function(buffer, offset)
  local index = 0
...
memx_options_riskcontrol_sbe_v1_3.replay_request_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replay Request Message
memx_options_riskcontrol_sbe_v1_3.replay_request_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
memx_options_riskcontrol_sbe_v1_3.replay_request_message.dissect = function(buffer, offset, packet, parent)
  if show.replay_request_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.replay_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.replay_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.replay_request_message.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_riskcontrol_sbe_v1_3.login_request_message.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.token_type.size

  index = index + memx_options_riskcontrol_sbe_v1_3.token.size

  return index
end

-- Display: Login Request Message
memx_options_riskcontrol_sbe_v1_3.login_request_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Request Message
memx_options_riskcontrol_sbe_v1_3.login_request_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Token Type: 1 Byte Ascii String
  index, token_type = memx_options_riskcontrol_sbe_v1_3.token_type.dissect(buffer, index, packet, parent)

  -- Token: 1 Byte Ascii String
  index, token = memx_options_riskcontrol_sbe_v1_3.token.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Login Request Message
memx_options_riskcontrol_sbe_v1_3.login_request_message.dissect = function(buffer, offset, packet, parent)
  if show.login_request_message then
    ...
    local index = memx_options_riskcontrol_sbe_v1_3.login_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.login_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.login_request_message.fields(buffer, offset, packet, parent)
  end
end

-- Data
memx_options_riskcontrol_sbe_v1_3.data = {}

-- Calculate runtime size of: Data
memx_options_riskcontrol_sbe_v1_3.data.size = function(buffer, offset, message_type)
  -- Size of Login Request Message
  if message_type == 100 then
    return memx_options_riskcontrol_sbe_v1_3.login_request_message.size(buffer, offset)
  end
  -- Size of Replay Request Message
  if message_type == 101 then
    return memx_options_riskcontrol_sbe_v1_3.replay_request_message.size(buffer, offset)
  end
  -- Size of Replay All Request Message
  if message_type == 102 then
    return memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.size(buffer, offset)
  end
  -- Size of Stream Request Message
  if message_type == 103 then
    return memx_options_riskcontrol_sbe_v1_3.stream_request_message.size(buffer, offset)
  end
  -- Size of Unsequenced Message
  if message_type == 104 then
    return memx_options_riskcontrol_sbe_v1_3.unsequenced_message.size(buffer, offset)
  end
  -- Size of Login Accepted Message
  if message_type == 1 then
    return memx_options_riskcontrol_sbe_v1_3.login_accepted_message.size(buffer, offset)
  end
  -- Size of Login Rejected Message
  if message_type == 2 then
    return memx_options_riskcontrol_sbe_v1_3.login_rejected_message.size(buffer, offset)
  end
  -- Size of Start Of Session Message
  if message_type == 3 then
    return memx_options_riskcontrol_sbe_v1_3.start_of_session_message.size(buffer, offset)
  end
  -- Size of Replay Begin Message
  if message_type == 5 then
    return memx_options_riskcontrol_sbe_v1_3.replay_begin_message.size(buffer, offset)
  end
  -- Size of Replay Rejected Message
  if message_type == 6 then
    return memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.size(buffer, offset)
  end
  -- Size of Replay Complete Message
  if message_type == 7 then
    return memx_options_riskcontrol_sbe_v1_3.replay_complete_message.size(buffer, offset)
  end
  -- Size of Stream Begin Message
  if message_type == 8 then
    return memx_options_riskcontrol_sbe_v1_3.stream_begin_message.size(buffer, offset)
  end
  -- Size of Stream Rejected Message
  if message_type == 9 then
    return memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.size(buffer, offset)
  end
  -- Size of Stream Complete Message
  if message_type == 10 then
    return memx_options_riskcontrol_sbe_v1_3.stream_complete_message.size(buffer, offset)
  end
  -- Size of Sequenced Message
  if message_type == 11 then
    return memx_options_riskcontrol_sbe_v1_3.sequenced_message.size(buffer, offset)
  end
...
memx_options_riskcontrol_sbe_v1_3.data.branches = function(buffer, offset, packet, parent, message_type)
  -- Dissect Login Request Message
  if message_type == 100 then
    return memx_options_riskcontrol_sbe_v1_3.login_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Replay Request Message
  if message_type == 101 then
    return memx_options_riskcontrol_sbe_v1_3.replay_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Replay All Request Message
  if message_type == 102 then
    return memx_options_riskcontrol_sbe_v1_3.replay_all_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stream Request Message
  if message_type == 103 then
    return memx_options_riskcontrol_sbe_v1_3.stream_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Unsequenced Message
  if message_type == 104 then
    return memx_options_riskcontrol_sbe_v1_3.unsequenced_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Login Accepted Message
  if message_type == 1 then
    return memx_options_riskcontrol_sbe_v1_3.login_accepted_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Login Rejected Message
  if message_type == 2 then
    return memx_options_riskcontrol_sbe_v1_3.login_rejected_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session Message
  if message_type == 3 then
    return memx_options_riskcontrol_sbe_v1_3.start_of_session_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Replay Begin Message
  if message_type == 5 then
    return memx_options_riskcontrol_sbe_v1_3.replay_begin_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Replay Rejected Message
  if message_type == 6 then
    return memx_options_riskcontrol_sbe_v1_3.replay_rejected_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Replay Complete Message
  if message_type == 7 then
    return memx_options_riskcontrol_sbe_v1_3.replay_complete_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stream Begin Message
  if message_type == 8 then
    return memx_options_riskcontrol_sbe_v1_3.stream_begin_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stream Rejected Message
  if message_type == 9 then
    return memx_options_riskcontrol_sbe_v1_3.stream_rejected_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stream Complete Message
  if message_type == 10 then
    return memx_options_riskcontrol_sbe_v1_3.stream_complete_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Sequenced Message
  if message_type == 11 then
    return memx_options_riskcontrol_sbe_v1_3.sequenced_message.dissect(buffer, offset, packet, parent)
  end
...
-- Common Header
memx_options_riskcontrol_sbe_v1_3.common_header = {}

-- Calculate size of: Common Header
memx_options_riskcontrol_sbe_v1_3.common_header.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_riskcontrol_sbe_v1_3.message_type.size

  index = index + memx_options_riskcontrol_sbe_v1_3.message_length.size

  return index
end

-- Display: Common Header
memx_options_riskcontrol_sbe_v1_3.common_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Common Header
memx_options_riskcontrol_sbe_v1_3.common_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Type: 1 Byte Unsigned Fixed Width Integer Enum with 16 values
  index, message_type = memx_options_riskcontrol_sbe_v1_3.message_type.dissect(buffer, index, packet, parent)

  -- Message Length: 2 Byte Unsigned Fixed Width Integer
  index, message_length = memx_options_riskcontrol_sbe_v1_3.message_length.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Common Header
memx_options_riskcontrol_sbe_v1_3.common_header.dissect = function(buffer, offset, packet, parent)
  if show.common_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_3.fields.common_header, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_3.common_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_3.common_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_3.common_header.fields(buffer, offset, packet, parent)
  end
end

-- Packet
memx_options_riskcontrol_sbe_v1_3.packet = {}

-- Dissect Packet
memx_options_riskcontrol_sbe_v1_3.packet.dissect = function(buffer, packet, parent)
  local index = 0

  -- Common Header: Struct of 2 fields
  index, common_header = memx_options_riskcontrol_sbe_v1_3.common_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Message Type
  local message_type = buffer(index - 3, 1):uint()

  -- Data: Runtime Type with 15 branches
  index = memx_options_riskcontrol_sbe_v1_3.data.dissect(buffer, index, packet, parent, message_type)
...
function omi_memx_options_riskcontrol_sbe_v1_3.dissector(buffer, packet, parent)
  ...
  return memx_options_riskcontrol_sbe_v1_3.packet.dissect(buffer, packet, protocol)
end
...
memx_options_riskcontrol_sbe_v1_3.packet.requiredsize = function(buffer)

  return true
end

-- Verify Schema Id Field
memx_options_riskcontrol_sbe_v1_3.schema_id.verify = function(buffer)
...
memx_options_riskcontrol_sbe_v1_3.version.verify = function(buffer)
  -- Attempt to read field
...
memx_options_riskcontrol_sbe_v1_3.schema_id.verify = function(buffer)
  -- Attempt to read field
  local value = buffer(1879, 1):uint()
...
memx_options_riskcontrol_sbe_v1_3.version.verify = function(buffer)
  -- Attempt to read field
  local value = buffer(1880, 2):uint()
...
local function omi_memx_options_riskcontrol_sbe_v1_3_heuristic(buffer, packet, parent)
  ...
  if not memx_options_riskcontrol_sbe_v1_3.packet.requiredsize(buffer) then return false end

  -- Verify Schema Id
  if not memx_options_riskcontrol_sbe_v1_3.schema_id.verify(buffer) then return false end

  -- Verify Version
  if not memx_options_riskcontrol_sbe_v1_3.version.verify(buffer) then return false end
