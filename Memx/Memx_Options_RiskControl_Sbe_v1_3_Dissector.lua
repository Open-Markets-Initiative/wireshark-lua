...
omi_memx_options_riskcontrol_sbe_v1_3.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
function omi_memx_options_riskcontrol_sbe_v1_3.prefs_changed()
  ...
  if show.application_messages ~= omi_memx_options_riskcontrol_sbe_v1_3.prefs.show_application_messages then
    show.application_messages = omi_memx_options_riskcontrol_sbe_v1_3.prefs.show_application_messages
    changed = true
  end
