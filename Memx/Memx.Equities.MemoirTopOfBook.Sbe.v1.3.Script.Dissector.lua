...
memx_equities_memoirtopofbook_sbe_v1_3.fields.bid_price = ProtoField.new("Bid Price", "memx.equities.memoirtopofbook.sbe.v1.3.bidprice", ftypes.INT64)
...
memx_equities_memoirtopofbook_sbe_v1_3.fields.mpv = ProtoField.new("Mpv", "memx.equities.memoirtopofbook.sbe.v1.3.mpv", ftypes.INT64)
memx_equities_memoirtopofbook_sbe_v1_3.fields.offer_price = ProtoField.new("Offer Price", "memx.equities.memoirtopofbook.sbe.v1.3.offerprice", ftypes.INT64)
...
memx_equities_memoirtopofbook_sbe_v1_3_display.clear_book_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.clear_book_message = function(buffer, offset, packet, parent)
  ...
  if show.clear_book_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.clear_book_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.clear_book_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.clear_book_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.best_offer_short_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.best_offer_short_message = function(buffer, offset, packet, parent)
  ...
  if show.best_offer_short_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.best_offer_short_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.best_offer_short_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.best_offer_short_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.best_bid_short_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.best_bid_short_message = function(buffer, offset, packet, parent)
  ...
  if show.best_bid_short_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.best_bid_short_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.best_bid_short_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.best_bid_short_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.best_offer_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.best_offer_message = function(buffer, offset, packet, parent)
  ...
  if show.best_offer_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.best_offer_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.best_offer_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.best_offer_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.best_bid_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.best_bid_message = function(buffer, offset, packet, parent)
  ...
  if show.best_bid_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.best_bid_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.best_bid_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.best_bid_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.best_bid_offer_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.best_bid_offer_message = function(buffer, offset, packet, parent)
  ...
  if show.best_bid_offer_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.best_bid_offer_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.best_bid_offer_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.best_bid_offer_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.trading_session_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.trading_session_status_message = function(buffer, offset, packet, parent)
  ...
  if show.trading_session_status_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.trading_session_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.trading_session_status_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.trading_session_status_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.snapshot_complete_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.snapshot_complete_message = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_complete_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.snapshot_complete_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.snapshot_complete_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.snapshot_complete_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.security_trading_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.security_trading_status_message = function(buffer, offset, packet, parent)
  ...
  if show.security_trading_status_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.security_trading_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.security_trading_status_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.security_trading_status_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.reg_sho_restriction_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.reg_sho_restriction_message = function(buffer, offset, packet, parent)
  ...
  if show.reg_sho_restriction_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.reg_sho_restriction_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.reg_sho_restriction_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.reg_sho_restriction_message, range, display)
  end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.instrument_directory_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.instrument_directory_message = function(buffer, offset, packet, parent)
  ...
  if show.instrument_directory_message then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.instrument_directory_message(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.instrument_directory_message(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.instrument_directory_message, range, display)
  end
...
-- Display: Sbe Header
memx_equities_memoirtopofbook_sbe_v1_3_display.sbe_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.sbe_header = function(buffer, offset, packet, parent)
  ...
  if show.sbe_header then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.sbe_header(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.sbe_header(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.sbe_header, range, display)
  end
...
-- Display: Sbe Message
memx_equities_memoirtopofbook_sbe_v1_3_display.sbe_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
-- Display: Message
memx_equities_memoirtopofbook_sbe_v1_3_display.message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.sequenced_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_display.common_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
memx_equities_memoirtopofbook_sbe_v1_3_dissect.common_header = function(buffer, offset, packet, parent)
  ...
  if show.common_header then
    local length = memx_equities_memoirtopofbook_sbe_v1_3_size_of.common_header(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_equities_memoirtopofbook_sbe_v1_3_display.common_header(buffer, packet, parent)
    parent = parent:add(memx_equities_memoirtopofbook_sbe_v1_3.fields.common_header, range, display)
  end
