...
local omi_memx_memxoptions_memoirtop_sbe_v1_3 = Proto("Omi.Memx.MemxOptions.MemoirTop.Sbe.v1.3", "Memx MemxOptions MemoirTop Sbe 1.3")
...
omi_memx_memxoptions_memoirtop_sbe_v1_3.fields.cust_offer_size_short = ProtoField.new("Cust Offer Size Short", "memx.memxoptions.memoirtop.sbe.v1.3.custoffersizeshort", ftypes.UINT16)
...
omi_memx_memxoptions_memoirtop_sbe_v1_3.fields.total_offer_size_short = ProtoField.new("Total Offer Size Short", "memx.memxoptions.memoirtop.sbe.v1.3.totaloffersizeshort", ftypes.UINT16)
...
function omi_memx_memxoptions_memoirtop_sbe_v1_3.prefs_changed()
  ...
  if show.indexes ~= omi_memx_memxoptions_memoirtop_sbe_v1_3.prefs.show_indexes then
    show.indexes = omi_memx_memxoptions_memoirtop_sbe_v1_3.prefs.show_indexes
  end
end
...
memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short = {}

-- Size: Cust Offer Size Short
memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short.size = 2

-- Display: Cust Offer Size Short
memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short.display = function(value)
  return "Cust Offer Size Short: "..value
end

-- Dissect: Cust Offer Size Short
memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short.dissect = function(buffer, offset, packet, parent)
  local length = memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_memxoptions_memoirtop_sbe_v1_3.fields.cust_offer_size_short, range, value, display)
...
memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short = {}

-- Size: Total Offer Size Short
memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short.size = 2

-- Display: Total Offer Size Short
memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short.display = function(value)
  return "Total Offer Size Short: "..value
end

-- Dissect: Total Offer Size Short
memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short.dissect = function(buffer, offset, packet, parent)
  local length = memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_memxoptions_memoirtop_sbe_v1_3.fields.total_offer_size_short, range, value, display)
...
memx_memxoptions_memoirtop_sbe_v1_3.best_offer_short_message.size =
  memx_memxoptions_memoirtop_sbe_v1_3.timestamp.size + 
  memx_memxoptions_memoirtop_sbe_v1_3.symbol.size + 
  memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short.size + 
  memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short.size + 
...
memx_memxoptions_memoirtop_sbe_v1_3.best_offer_short_message.fields = function(buffer, offset, packet, parent)
  ...
  index, total_offer_size_short = memx_memxoptions_memoirtop_sbe_v1_3.total_offer_size_short.dissect(buffer, index, packet, parent)

  -- Cust Offer Size Short: uint16
  index, cust_offer_size_short = memx_memxoptions_memoirtop_sbe_v1_3.cust_offer_size_short.dissect(buffer, index, packet, parent)
...
memx_memxoptions_memoirtop_sbe_v1_3.packet.requiredsize = function(buffer)
  return buffer:len() >= memx_memxoptions_memoirtop_sbe_v1_3.common_header.size
end
...
-- Dissector Heuristic for Memx MemxOptions MemoirTop Sbe 1.3 (Udp)
local function omi_memx_memxoptions_memoirtop_sbe_v1_3_udp_heuristic(buffer, packet, parent)
...
omi_memx_memxoptions_memoirtop_sbe_v1_3:register_heuristic("udp", omi_memx_memxoptions_memoirtop_sbe_v1_3_udp_heuristic)

-- Register Memx MemxOptions MemoirTop Sbe 1.3 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_memx_memxoptions_memoirtop_sbe_v1_3)
