...
-- Memx Options Sbe RiskControl 1.6 Application Messages
...
omi_memx_options_riskcontrol_sbe_v1_6.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
function omi_memx_options_riskcontrol_sbe_v1_6.prefs_changed()
  ...
  if show.application_messages ~= omi_memx_options_riskcontrol_sbe_v1_6.prefs.show_application_messages then
    show.application_messages = omi_memx_options_riskcontrol_sbe_v1_6.prefs.show_application_messages
    changed = true
  end
...
memx_options_riskcontrol_sbe_v1_6.cp_order_rate_threshold_state_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Efid Optional: ActiveRiskThresholdChangeRejEFID
...
memx_options_riskcontrol_sbe_v1_6.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_6.fields.sbe_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_6.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_6.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_6.fields.sequenced_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_6.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_riskcontrol_sbe_v1_6.unsequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.unsequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_riskcontrol_sbe_v1_6.fields.unsequenced_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6.unsequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_riskcontrol_sbe_v1_6.unsequenced_message.display(packet, parent, length)
    parent:append_text(display)
