...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_order_rate_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_order_rate_threshold_state_message then
    ...
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_order_rate_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_order_rate_threshold_state_message_fields(buffer, offset, packet, element)
    ...
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_order_rate_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_duplicate_order_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_duplicate_order_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_duplicate_order_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_duplicate_order_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_duplicate_order_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_net_notional_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_market_order_net_notional_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_market_order_net_notional_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_net_notional_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_net_notional_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_net_notional_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_net_notional_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_net_notional_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_net_notional_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_net_notional_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_gross_notional_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_market_order_gross_notional_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_market_order_gross_notional_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_gross_notional_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_gross_notional_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_gross_notional_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_gross_notional_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_gross_notional_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_gross_notional_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_gross_notional_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.breach_cleared_message = function(buffer, offset, packet, parent)
  if show.breach_cleared_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.breach_cleared_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.breach_cleared_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.breach_cleared_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.breach_clear_rej_message = function(buffer, offset, packet, parent)
  if show.breach_clear_rej_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.breach_clear_rej_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.breach_clear_rej_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.breach_clear_rej_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_rej_message = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_rej_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.manual_cp_breach_trigger_rej_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_rej_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_rej_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_rej_message = function(buffer, offset, packet, parent)
  if show.risk_settings_query_rej_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.risk_settings_query_rej_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_rej_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_rej_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_done_message = function(buffer, offset, packet, parent)
  if show.risk_settings_query_done_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.risk_settings_query_done_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_done_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_done_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_contracts_threshold_state_message = function(buffer, offset, packet, parent)
  if show.single_order_max_contracts_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_max_contracts_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_contracts_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_contracts_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_notional_threshold_state_message = function(buffer, offset, packet, parent)
  if show.single_order_max_notional_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_max_notional_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_notional_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_notional_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_orders_in_crossed_market_state_message = function(buffer, offset, packet, parent)
  if show.single_order_allow_orders_in_crossed_market_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_allow_orders_in_crossed_market_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_orders_in_crossed_market_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_orders_in_crossed_market_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_iso_orders_state_message = function(buffer, offset, packet, parent)
  if show.single_order_allow_iso_orders_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_allow_iso_orders_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_iso_orders_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_iso_orders_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.passive_risk_threshold_notification_message = function(buffer, offset, packet, parent)
  if show.passive_risk_threshold_notification_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.passive_risk_threshold_notification_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.passive_risk_threshold_notification_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.passive_risk_threshold_notification_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.risk_threshold_update_rej_message = function(buffer, offset, packet, parent)
  if show.risk_threshold_update_rej_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.risk_threshold_update_rej_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.risk_threshold_update_rej_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.risk_threshold_update_rej_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_done_message = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_done_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.manual_cp_breach_trigger_done_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_done_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_done_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_pending_message = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_pending_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.manual_cp_breach_trigger_pending_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_pending_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_pending_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_breach_count_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_breach_count_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_breach_count_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_breach_count_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_breach_count_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_percent_outstanding_contracts_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_percent_outstanding_contracts_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_percent_outstanding_contracts_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_percent_outstanding_contracts_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_percent_outstanding_contracts_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_total_executions_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_total_executions_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_total_executions_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_total_executions_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_total_executions_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_executed_notional_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_executed_notional_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_executed_notional_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_executed_notional_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_executed_notional_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_volume_threshold_state_message = function(buffer, offset, packet, parent)
  if show.cp_volume_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_volume_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_volume_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_volume_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_quantity_update_notification_message = function(buffer, offset, packet, parent)
  if show.active_risk_quantity_update_notification_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.active_risk_quantity_update_notification_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_quantity_update_notification_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_quantity_update_notification_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledge_rej_message = function(buffer, offset, packet, parent)
  if show.active_risk_acknowledge_rej_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.active_risk_acknowledge_rej_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledge_rej_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledge_rej_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledged_message = function(buffer, offset, packet, parent)
  if show.active_risk_acknowledged_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.active_risk_acknowledged_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledged_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledged_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_change_rej_message = function(buffer, offset, packet, parent)
  if show.active_risk_threshold_change_rej_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.active_risk_threshold_change_rej_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_change_rej_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_change_rej_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_state_message = function(buffer, offset, packet, parent)
  if show.active_risk_threshold_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.active_risk_threshold_state_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_state_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_order_rate_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_order_rate_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_order_rate_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_order_rate_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_order_rate_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_duplicate_order_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_duplicate_order_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_duplicate_order_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_duplicate_order_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_duplicate_order_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_net_notional_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_market_order_net_notional_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_market_order_net_notional_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_net_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_net_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_net_notional_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_net_notional_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_net_notional_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_net_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_net_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_gross_notional_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_market_order_gross_notional_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_market_order_gross_notional_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_gross_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_market_order_gross_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_gross_notional_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_gross_notional_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_gross_notional_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_gross_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_gross_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_contracts_change_req_message = function(buffer, offset, packet, parent)
  if show.single_order_max_contracts_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_max_contracts_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_contracts_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_contracts_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_notional_change_req_message = function(buffer, offset, packet, parent)
  if show.single_order_max_notional_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_max_notional_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_notional_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_max_notional_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_orders_in_crossed_market_change_req_message = function(buffer, offset, packet, parent)
  if show.single_order_allow_orders_in_crossed_market_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_allow_orders_in_crossed_market_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_orders_in_crossed_market_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_orders_in_crossed_market_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_iso_orders_change_req_message = function(buffer, offset, packet, parent)
  if show.single_order_allow_iso_orders_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.single_order_allow_iso_orders_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_iso_orders_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.single_order_allow_iso_orders_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_clear_breach_req_message = function(buffer, offset, packet, parent)
  if show.cp_clear_breach_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_clear_breach_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_clear_breach_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_clear_breach_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_req_message = function(buffer, offset, packet, parent)
  if show.manual_cp_breach_trigger_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.manual_cp_breach_trigger_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.manual_cp_breach_trigger_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_breach_count_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_breach_count_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_breach_count_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_breach_count_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_breach_count_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_percent_outstanding_contracts_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_percent_outstanding_contracts_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_percent_outstanding_contracts_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_percent_outstanding_contracts_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_percent_outstanding_contracts_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_total_executions_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_total_executions_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_total_executions_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_total_executions_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_total_executions_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_executed_notional_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_executed_notional_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_executed_notional_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_executed_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_executed_notional_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.cp_volume_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.cp_volume_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.cp_volume_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.cp_volume_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.cp_volume_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledgement_req_message = function(buffer, offset, packet, parent)
  if show.active_risk_acknowledgement_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.active_risk_acknowledgement_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledgement_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_acknowledgement_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_change_req_message = function(buffer, offset, packet, parent)
  if show.active_risk_threshold_change_req_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.active_risk_threshold_change_req_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_change_req_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.active_risk_threshold_change_req_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_message = function(buffer, offset, packet, parent)
  if show.risk_settings_query_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.risk_settings_query_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.risk_settings_query_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.sbe_header = function(buffer, offset, packet, parent)
  if show.sbe_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.sbe_header, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.sbe_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.sbe_header_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.stream_complete_message = function(buffer, offset, packet, parent)
  if show.stream_complete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.stream_complete_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.stream_complete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.stream_complete_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.stream_rejected_message = function(buffer, offset, packet, parent)
  if show.stream_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.stream_rejected_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.stream_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.stream_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.stream_begin_message = function(buffer, offset, packet, parent)
  if show.stream_begin_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.stream_begin_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.stream_begin_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.stream_begin_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.replay_complete_message = function(buffer, offset, packet, parent)
  if show.replay_complete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.replay_complete_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.replay_complete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.replay_complete_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.replay_rejected_message = function(buffer, offset, packet, parent)
  if show.replay_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.replay_rejected_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.replay_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.replay_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.replay_begin_message = function(buffer, offset, packet, parent)
  if show.replay_begin_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.replay_begin_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.replay_begin_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.replay_begin_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.start_of_session_message = function(buffer, offset, packet, parent)
  if show.start_of_session_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.start_of_session_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.start_of_session_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.start_of_session_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.login_rejected_message = function(buffer, offset, packet, parent)
  if show.login_rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.login_rejected_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.login_rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.login_rejected_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.login_accepted_message = function(buffer, offset, packet, parent)
  if show.login_accepted_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.login_accepted_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.login_accepted_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.login_accepted_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.stream_request_message = function(buffer, offset, packet, parent)
  if show.stream_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.stream_request_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.stream_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.stream_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.replay_all_request_message = function(buffer, offset, packet, parent)
  if show.replay_all_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.replay_all_request_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.replay_all_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.replay_all_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.replay_request_message = function(buffer, offset, packet, parent)
  if show.replay_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.replay_request_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.replay_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.replay_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.login_request_message = function(buffer, offset, packet, parent)
  if show.login_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.login_request_message, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.login_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.login_request_message_fields(buffer, offset, packet, element)
  end
end
...
memx_options_riskcontrol_sbe_v1_6_dissect.common_header = function(buffer, offset, packet, parent)
  if show.common_header then
    -- Optionally add element to protocol tree
    local element = parent:add(memx_options_riskcontrol_sbe_v1_6.fields.common_header, buffer(offset, 0))
    local index = memx_options_riskcontrol_sbe_v1_6_dissect.common_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return memx_options_riskcontrol_sbe_v1_6_dissect.common_header_fields(buffer, offset, packet, element)
  end
end
