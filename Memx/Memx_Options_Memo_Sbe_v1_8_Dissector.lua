...
memx_options_memo_sbe_v1_8_dissect.reported_allocations_groups_fields = function(buffer, offset, packet, parent)
  ...
  for reported_allocations_group_index = 1, num_in_group do
    ...
    if reported_allocations_group ~= nil then
      local iteration = reported_allocations_group:add(memx_options_memo_sbe_v1_8.fields.reported_allocations_group_index, reported_allocations_group_index)
...
memx_options_memo_sbe_v1_8_dissect.execution_allocations_groups_fields = function(buffer, offset, packet, parent)
  ...
  for execution_allocations_group_index = 1, num_in_group do
    ...
    if execution_allocations_group ~= nil then
      local iteration = execution_allocations_group:add(memx_options_memo_sbe_v1_8.fields.execution_allocations_group_index, execution_allocations_group_index)
      iteration:set_generated()
    end
  end
...
memx_options_memo_sbe_v1_8_dissect.parties_groups_fields = function(buffer, offset, packet, parent)
  ...
  for parties_group_index = 1, num_in_group do
    ...
    if parties_group ~= nil then
      local iteration = parties_group:add(memx_options_memo_sbe_v1_8.fields.parties_group_index, parties_group_index)
      iteration:set_generated()
    end
  end
...
memx_options_memo_sbe_v1_8_dissect.requested_allocations_groups_fields = function(buffer, offset, packet, parent)
  ...
  for requested_allocations_group_index = 1, num_in_group do
    ...
    if requested_allocations_group ~= nil then
      local iteration = requested_allocations_group:add(memx_options_memo_sbe_v1_8.fields.requested_allocations_group_index, requested_allocations_group_index)
      iteration:set_generated()
    end
  end
...
memx_options_memo_sbe_v1_8_dissect.quotes_groups_fields = function(buffer, offset, packet, parent)
  ...
  for quotes_group_index = 1, num_in_group do
    ...
    if quotes_group ~= nil then
      local iteration = quotes_group:add(memx_options_memo_sbe_v1_8.fields.quotes_group_index, quotes_group_index)
      iteration:set_generated()
    end
  end
