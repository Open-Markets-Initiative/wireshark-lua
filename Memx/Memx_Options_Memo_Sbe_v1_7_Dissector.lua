...
omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_ack_message_parties_group = ProtoField.new("Allocation Instruction Ack Message Parties Group", "memx.options.memo.sbe.v1.7.allocationinstructionackmessagepartiesgroup", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_ack_message_parties_groups = ProtoField.new("Allocation Instruction Ack Message Parties Groups", "memx.options.memo.sbe.v1.7.allocationinstructionackmessagepartiesgroups", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_message_parties_group = ProtoField.new("Allocation Instruction Message Parties Group", "memx.options.memo.sbe.v1.7.allocationinstructionmessagepartiesgroup", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_message_parties_groups = ProtoField.new("Allocation Instruction Message Parties Groups", "memx.options.memo.sbe.v1.7.allocationinstructionmessagepartiesgroups", ftypes.STRING)
...
omi_memx_options_memo_sbe_v1_7.fields.max_sequence_number = ProtoField.new("Max Sequence Number", "memx.options.memo.sbe.v1.7.maxsequencenumber", ftypes.UINT64)
...
omi_memx_options_memo_sbe_v1_7.fields.nested_party_i_d_allocation_instruction_ack_nested_party_id = ProtoField.new("Nested Party I D Allocation Instruction Ack Nested Party Id", "memx.options.memo.sbe.v1.7.nestedpartyidallocationinstructionacknestedpartyid", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.nested_party_i_d_allocation_instruction_nested_party_id = ProtoField.new("Nested Party I D Allocation Instruction Nested Party Id", "memx.options.memo.sbe.v1.7.nestedpartyidallocationinstructionnestedpartyid", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.nested_party_id_source = ProtoField.new("Nested Party Id Source", "memx.options.memo.sbe.v1.7.nestedpartyidsource", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.nested_party_role = ProtoField.new("Nested Party Role", "memx.options.memo.sbe.v1.7.nestedpartyrole", ftypes.UINT8)
...
omi_memx_options_memo_sbe_v1_7.fields.one_sided_quotes_group = ProtoField.new("One Sided Quotes Group", "memx.options.memo.sbe.v1.7.onesidedquotesgroup", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.one_sided_quotes_groups = ProtoField.new("One Sided Quotes Groups", "memx.options.memo.sbe.v1.7.onesidedquotesgroups", ftypes.STRING)
...
omi_memx_options_memo_sbe_v1_7.fields.price_short = ProtoField.new("Price Short", "memx.options.memo.sbe.v1.7.priceshort", ftypes.DOUBLE)
omi_memx_options_memo_sbe_v1_7.fields.quantity = ProtoField.new("Quantity", "memx.options.memo.sbe.v1.7.quantity", ftypes.UINT16)
...
omi_memx_options_memo_sbe_v1_7.fields.two_sided_quotes_group = ProtoField.new("Two Sided Quotes Group", "memx.options.memo.sbe.v1.7.twosidedquotesgroup", ftypes.STRING)
omi_memx_options_memo_sbe_v1_7.fields.two_sided_quotes_groups = ProtoField.new("Two Sided Quotes Groups", "memx.options.memo.sbe.v1.7.twosidedquotesgroups", ftypes.STRING)
...
omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_ack_message_parties_group_index = ProtoField.new("Allocation Instruction Ack Message Parties Group Index", "memx.options.memo.sbe.v1.7.allocationinstructionackmessagepartiesgroupindex", ftypes.UINT16)
omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_message_parties_group_index = ProtoField.new("Allocation Instruction Message Parties Group Index", "memx.options.memo.sbe.v1.7.allocationinstructionmessagepartiesgroupindex", ftypes.UINT16)
...
omi_memx_options_memo_sbe_v1_7.fields.one_sided_quotes_group_index = ProtoField.new("One Sided Quotes Group Index", "memx.options.memo.sbe.v1.7.onesidedquotesgroupindex", ftypes.UINT16)
...
omi_memx_options_memo_sbe_v1_7.fields.two_sided_quotes_group_index = ProtoField.new("Two Sided Quotes Group Index", "memx.options.memo.sbe.v1.7.twosidedquotesgroupindex", ftypes.UINT16)
...
omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_ack_message_parties_group = Pref.bool("Show Allocation Instruction Ack Message Parties Group", show.allocation_instruction_ack_message_parties_group, "Parse and add Allocation Instruction Ack Message Parties Group to protocol tree")
omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_ack_message_parties_groups = Pref.bool("Show Allocation Instruction Ack Message Parties Groups", show.allocation_instruction_ack_message_parties_groups, "Parse and add Allocation Instruction Ack Message Parties Groups to protocol tree")
...
omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_message_parties_group = Pref.bool("Show Allocation Instruction Message Parties Group", show.allocation_instruction_message_parties_group, "Parse and add Allocation Instruction Message Parties Group to protocol tree")
omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_message_parties_groups = Pref.bool("Show Allocation Instruction Message Parties Groups", show.allocation_instruction_message_parties_groups, "Parse and add Allocation Instruction Message Parties Groups to protocol tree")
...
function omi_memx_options_memo_sbe_v1_7.prefs_changed()
  ...
  if show.allocation_instruction_ack_message_parties_group ~= omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_ack_message_parties_group then
    show.allocation_instruction_ack_message_parties_group = omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_ack_message_parties_group
    changed = true
  end
  if show.allocation_instruction_ack_message_parties_groups ~= omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_ack_message_parties_groups then
    show.allocation_instruction_ack_message_parties_groups = omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_ack_message_parties_groups
    changed = true
  end
  ...
  if show.allocation_instruction_message_parties_group ~= omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_message_parties_group then
    show.allocation_instruction_message_parties_group = omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_message_parties_group
    changed = true
  end
  if show.allocation_instruction_message_parties_groups ~= omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_message_parties_groups then
    show.allocation_instruction_message_parties_groups = omi_memx_options_memo_sbe_v1_7.prefs.show_allocation_instruction_message_parties_groups
    changed = true
  end
  ...
  if show.two_sided_quotes_group ~= omi_memx_options_memo_sbe_v1_7.prefs.show_two_sided_quotes_group then
    show.two_sided_quotes_group = omi_memx_options_memo_sbe_v1_7.prefs.show_two_sided_quotes_group
    changed = true
  end
  if show.two_sided_quotes_groups ~= omi_memx_options_memo_sbe_v1_7.prefs.show_two_sided_quotes_groups then
    show.two_sided_quotes_groups = omi_memx_options_memo_sbe_v1_7.prefs.show_two_sided_quotes_groups
    changed = true
  end
...
memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_lockout_accepted_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.sending_time.size
...
memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_lockout_reject_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.rej_reason.size + 
  memx_options_memo_sbe_v1_7.sending_time.size
...
memx_options_memo_sbe_v1_7.mass_cancel_clear_lockout_done_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.underlier.size + 
  memx_options_memo_sbe_v1_7.lockout_id.size + 
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.transact_time.size
...
memx_options_memo_sbe_v1_7.mass_cancel_clear_lockout_reject_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.underlier.size + 
  memx_options_memo_sbe_v1_7.lockout_id.size + 
  memx_options_memo_sbe_v1_7.rej_reason.size + 
...
memx_options_memo_sbe_v1_7.user_notification_message.size =
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.user_status.size
...
-- Nested Party Role
memx_options_memo_sbe_v1_7.nested_party_role = {}

-- Size: Nested Party Role
memx_options_memo_sbe_v1_7.nested_party_role.size = 1

-- Display: Nested Party Role
memx_options_memo_sbe_v1_7.nested_party_role.display = function(value)
  if value == 1 then
...
memx_options_memo_sbe_v1_7.nested_party_role.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_7.nested_party_role.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = memx_options_memo_sbe_v1_7.nested_party_role.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_7.fields.nested_party_role, range, value, display)

  return offset + length, value
end

-- Nested Party Id Source
memx_options_memo_sbe_v1_7.nested_party_id_source = {}

-- Size: Nested Party Id Source
memx_options_memo_sbe_v1_7.nested_party_id_source.size = 1

-- Display: Nested Party Id Source
memx_options_memo_sbe_v1_7.nested_party_id_source.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_7.nested_party_id_source.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_7.nested_party_id_source.size
  local range = buffer(offset, length)
  ...
  local display = memx_options_memo_sbe_v1_7.nested_party_id_source.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_7.fields.nested_party_id_source, range, value, display)

  return offset + length, value
end

-- Nested Party I D Allocation Instruction Ack Nested Party Id
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id = {}

-- Size: Nested Party I D Allocation Instruction Ack Nested Party Id
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id.size = 16

-- Display: Nested Party I D Allocation Instruction Ack Nested Party Id
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id.size
  local range = buffer(offset, length)
  ...
  local display = memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_7.fields.nested_party_i_d_allocation_instruction_ack_nested_party_id, range, value, display)

  return offset + length, value
end

-- Allocation Instruction Ack Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group = {}

-- Size: Allocation Instruction Ack Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.size =
  memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id.size + 
  memx_options_memo_sbe_v1_7.nested_party_id_source.size + 
  memx_options_memo_sbe_v1_7.nested_party_role.size

-- Display: Allocation Instruction Ack Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Allocation Instruction Ack Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.fields = function(buffer, offset, packet, parent, allocation_instruction_ack_message_parties_group_index)
  local index = offset
  ...
  if allocation_instruction_ack_message_parties_group_index ~= nil then
    local iteration = parent:add(omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_ack_message_parties_group_index, allocation_instruction_ack_message_parties_group_index)
    iteration:set_generated()
  end

  -- Nested Party I D Allocation Instruction Ack Nested Party Id: 16 Byte Ascii String
  index, nested_party_i_d_allocation_instruction_ack_nested_party_id = memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_ack_nested_party_id.dissect(buffer, index, packet, parent)

  -- Nested Party Id Source: 1 Byte Ascii String
  index, nested_party_id_source = memx_options_memo_sbe_v1_7.nested_party_id_source.dissect(buffer, index, packet, parent)

  -- Nested Party Role: 1 Byte Unsigned Fixed Width Integer Enum with 10 values
  index, nested_party_role = memx_options_memo_sbe_v1_7.nested_party_role.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Allocation Instruction Ack Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.dissect = function(buffer, offset, packet, parent, allocation_instruction_ack_message_parties_group_index)
  if show.allocation_instruction_ack_message_parties_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_ack_message_parties_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.fields(buffer, offset, packet, parent, allocation_instruction_ack_message_parties_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.fields(buffer, offset, packet, parent, allocation_instruction_ack_message_parties_group_index)
  end
end
...
memx_options_memo_sbe_v1_7.repeating_group_dimensions.size =
  memx_options_memo_sbe_v1_7.block_length_short.size + 
  memx_options_memo_sbe_v1_7.num_in_group.size
...
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups = {}

-- Calculate size of: Allocation Instruction Ack Message Parties Groups
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.size = function(buffer, offset)
  local index = 0

  index = index + memx_options_memo_sbe_v1_7.repeating_group_dimensions.size
...
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Allocation Instruction Ack Message Parties Groups
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for allocation_instruction_ack_message_parties_group_index = 1, num_in_group do
    index, allocation_instruction_ack_message_parties_group = memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_group.dissect(buffer, index, packet, parent, allocation_instruction_ack_message_parties_group_index)
  end
...
memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.allocation_instruction_ack_message_parties_groups then
    local length = memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.display(buffer, packet, parent)
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_ack_message_parties_groups, range, display)
  end

  return memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.fields(buffer, offset, packet, parent)
end
...
memx_options_memo_sbe_v1_7.reported_allocations_group.size = function(buffer, offset)
  ...
  index = index + memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.size(buffer, offset + index)
...
memx_options_memo_sbe_v1_7.reported_allocations_group.fields = function(buffer, offset, packet, parent, reported_allocations_group_index)
  ...
  index, allocation_instruction_ack_message_parties_groups = memx_options_memo_sbe_v1_7.allocation_instruction_ack_message_parties_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Reported Allocations Group
memx_options_memo_sbe_v1_7.reported_allocations_group.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.reported_allocations_group then
    local length = memx_options_memo_sbe_v1_7.reported_allocations_group.size(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_options_memo_sbe_v1_7.reported_allocations_group.display(buffer, packet, parent)
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.reported_allocations_group, range, display)
  end

  return memx_options_memo_sbe_v1_7.reported_allocations_group.fields(buffer, offset, packet, parent)
end
...
memx_options_memo_sbe_v1_7.reported_allocations_groups.size = function(buffer, offset)
  ...
  for i = 1, reported_allocations_group_count do
    index = index + memx_options_memo_sbe_v1_7.reported_allocations_group.size(buffer, offset + index)
  end
  return index
end
...
memx_options_memo_sbe_v1_7.execution_allocations_group.size =
  memx_options_memo_sbe_v1_7.trade_id.size + 
  memx_options_memo_sbe_v1_7.last_qty.size + 
  memx_options_memo_sbe_v1_7.last_px.size
...
memx_options_memo_sbe_v1_7.order_cancel_reject_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.cxl_rej_response_to.size + 
  memx_options_memo_sbe_v1_7.cxl_rej_reason.size + 
  memx_options_memo_sbe_v1_7.options_security_id_optional.size + 
  memx_options_memo_sbe_v1_7.side_optional.size + 
  memx_options_memo_sbe_v1_7.sending_time.size
...
memx_options_memo_sbe_v1_7.mass_cancel_done_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.total_affected_orders.size + 
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.transact_time.size
...
memx_options_memo_sbe_v1_7.mass_cancel_reject_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.mass_cancel_reject_reason.size + 
  memx_options_memo_sbe_v1_7.efid_optional.size + 
  memx_options_memo_sbe_v1_7.underlying_or_series_optional.size + 
  memx_options_memo_sbe_v1_7.underlier_optional.size + 
  memx_options_memo_sbe_v1_7.options_security_id_optional.size + 
  memx_options_memo_sbe_v1_7.cancel_group_id.size + 
  memx_options_memo_sbe_v1_7.mass_cancel_inst.size + 
  memx_options_memo_sbe_v1_7.sending_time.size
...
memx_options_memo_sbe_v1_7.pending_mass_cancel_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.mass_cancel_inst.size + 
  memx_options_memo_sbe_v1_7.lockout_id_optional.size + 
  memx_options_memo_sbe_v1_7.efid_optional.size + 
  memx_options_memo_sbe_v1_7.underlying_or_series.size + 
  memx_options_memo_sbe_v1_7.underlier.size + 
  memx_options_memo_sbe_v1_7.options_security_id_optional.size + 
  memx_options_memo_sbe_v1_7.cancel_group_id.size + 
  memx_options_memo_sbe_v1_7.sending_time.size
...
memx_options_memo_sbe_v1_7.execution_report_restatement_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.exec_id.size + 
  memx_options_memo_sbe_v1_7.ord_status.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
  memx_options_memo_sbe_v1_7.exec_restatement_reason.size + 
  memx_options_memo_sbe_v1_7.extended_restatement_reason.size + 
  memx_options_memo_sbe_v1_7.side.size + 
  memx_options_memo_sbe_v1_7.last_px.size + 
  memx_options_memo_sbe_v1_7.last_qty_optional.size + 
  memx_options_memo_sbe_v1_7.leaves_qty.size + 
  memx_options_memo_sbe_v1_7.cum_qty.size + 
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.transact_time.size
...
memx_options_memo_sbe_v1_7.execution_report_trade_break_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.trd_match_id.size + 
  memx_options_memo_sbe_v1_7.exec_id.size + 
  memx_options_memo_sbe_v1_7.exec_ref_id.size + 
  memx_options_memo_sbe_v1_7.ord_status.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
  memx_options_memo_sbe_v1_7.leaves_qty.size + 
  memx_options_memo_sbe_v1_7.cum_qty.size + 
...
memx_options_memo_sbe_v1_7.execution_report_trade_correction_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.trd_match_id.size + 
  memx_options_memo_sbe_v1_7.exec_id.size + 
...
memx_options_memo_sbe_v1_7.execution_report_replaced_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.origclordid.size + 
  memx_options_memo_sbe_v1_7.exec_id.size + 
  memx_options_memo_sbe_v1_7.ord_status.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
  memx_options_memo_sbe_v1_7.side.size + 
  memx_options_memo_sbe_v1_7.order_qty.size + 
  memx_options_memo_sbe_v1_7.ord_type.size + 
  memx_options_memo_sbe_v1_7.price_optional.size + 
  memx_options_memo_sbe_v1_7.leaves_qty.size + 
  memx_options_memo_sbe_v1_7.cum_qty.size + 
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.transact_time.size + 
  memx_options_memo_sbe_v1_7.orig_list_seq_no.size
...
memx_options_memo_sbe_v1_7.execution_report_pending_replace_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.origclordid.size + 
...
memx_options_memo_sbe_v1_7.execution_report_canceled_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.origclordid_optional.size + 
  memx_options_memo_sbe_v1_7.exec_id.size + 
  memx_options_memo_sbe_v1_7.ord_status.size + 
  memx_options_memo_sbe_v1_7.cancel_reason.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
  memx_options_memo_sbe_v1_7.side_optional.size + 
  memx_options_memo_sbe_v1_7.leaves_qty.size + 
  memx_options_memo_sbe_v1_7.cum_qty.size + 
...
memx_options_memo_sbe_v1_7.execution_report_pending_cancel_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.origclordid.size + 
...
-- Size: Parties Group
memx_options_memo_sbe_v1_7.parties_group.size =
  memx_options_memo_sbe_v1_7.party_id.size + 
  memx_options_memo_sbe_v1_7.party_id_source.size + 
  memx_options_memo_sbe_v1_7.party_role.size
...
memx_options_memo_sbe_v1_7.execution_report_rejected_message.size =
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.exec_id.size + 
  memx_options_memo_sbe_v1_7.ord_status.size + 
  memx_options_memo_sbe_v1_7.order_reject_reason.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
  memx_options_memo_sbe_v1_7.side.size + 
  memx_options_memo_sbe_v1_7.leaves_qty.size + 
  memx_options_memo_sbe_v1_7.cum_qty.size + 
...
memx_options_memo_sbe_v1_7.execution_report_bulk_quote_component_new_message.size =
  memx_options_memo_sbe_v1_7.order_id.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.exec_id.size + 
...
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id = {}

-- Size: Nested Party I D Allocation Instruction Nested Party Id
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id.size = 16

-- Display: Nested Party I D Allocation Instruction Nested Party Id
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id.size
  local range = buffer(offset, length)
  ...
  local display = memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_7.fields.nested_party_i_d_allocation_instruction_nested_party_id, range, value, display)

  return offset + length, value
end

-- Allocation Instruction Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group = {}

-- Size: Allocation Instruction Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.size =
  memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id.size + 
  memx_options_memo_sbe_v1_7.nested_party_id_source.size + 
  memx_options_memo_sbe_v1_7.nested_party_role.size

-- Display: Allocation Instruction Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Allocation Instruction Message Parties Group
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.fields = function(buffer, offset, packet, parent, allocation_instruction_message_parties_group_index)
  local index = offset
  ...
  if allocation_instruction_message_parties_group_index ~= nil then
    local iteration = parent:add(omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_message_parties_group_index, allocation_instruction_message_parties_group_index)
    iteration:set_generated()
  end

  -- Nested Party I D Allocation Instruction Nested Party Id: 16 Byte Ascii String
  index, nested_party_i_d_allocation_instruction_nested_party_id = memx_options_memo_sbe_v1_7.nested_party_i_d_allocation_instruction_nested_party_id.dissect(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.dissect = function(buffer, offset, packet, parent, allocation_instruction_message_parties_group_index)
  if show.allocation_instruction_message_parties_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_message_parties_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.fields(buffer, offset, packet, parent, allocation_instruction_message_parties_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.fields(buffer, offset, packet, parent, allocation_instruction_message_parties_group_index)
  end
end

-- Allocation Instruction Message Parties Groups
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups = {}

-- Calculate size of: Allocation Instruction Message Parties Groups
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.size = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Allocation Instruction Message Parties Groups
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for allocation_instruction_message_parties_group_index = 1, num_in_group do
    index, allocation_instruction_message_parties_group = memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_group.dissect(buffer, index, packet, parent, allocation_instruction_message_parties_group_index)
  end
...
memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.allocation_instruction_message_parties_groups then
    local length = memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.display(buffer, packet, parent)
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.allocation_instruction_message_parties_groups, range, display)
  end

  return memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.fields(buffer, offset, packet, parent)
end
...
memx_options_memo_sbe_v1_7.requested_allocations_group.size = function(buffer, offset)
  ...
  index = index + memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.size(buffer, offset + index)
...
memx_options_memo_sbe_v1_7.requested_allocations_group.fields = function(buffer, offset, packet, parent, requested_allocations_group_index)
  ...
  index, allocation_instruction_message_parties_groups = memx_options_memo_sbe_v1_7.allocation_instruction_message_parties_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Requested Allocations Group
memx_options_memo_sbe_v1_7.requested_allocations_group.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.requested_allocations_group then
    local length = memx_options_memo_sbe_v1_7.requested_allocations_group.size(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_options_memo_sbe_v1_7.requested_allocations_group.display(buffer, packet, parent)
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.requested_allocations_group, range, display)
  end

  return memx_options_memo_sbe_v1_7.requested_allocations_group.fields(buffer, offset, packet, parent)
end
...
memx_options_memo_sbe_v1_7.requested_allocations_groups.size = function(buffer, offset)
  ...
  for i = 1, requested_allocations_group_count do
    index = index + memx_options_memo_sbe_v1_7.requested_allocations_group.size(buffer, offset + index)
  end
  return index
end
...
memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_lockouts_by_efid_or_underlier_request_message.size =
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.efid_optional.size + 
  memx_options_memo_sbe_v1_7.underlier_optional.size
...
memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_all_lockouts_request_message.size =
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.clordid.size
...
memx_options_memo_sbe_v1_7.mass_cancel_clear_lockout_request_message.size =
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.underlier.size + 
  memx_options_memo_sbe_v1_7.lockout_id.size
...
memx_options_memo_sbe_v1_7.mass_cancel_request_message.size =
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.efid_optional.size + 
  memx_options_memo_sbe_v1_7.underlying_or_series.size + 
...
memx_options_memo_sbe_v1_7.order_cancel_request_message.size =
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.order_id_optional.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.origclordid_optional.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
...
memx_options_memo_sbe_v1_7.order_cancel_replace_request_message.size =
  memx_options_memo_sbe_v1_7.sending_time.size + 
  memx_options_memo_sbe_v1_7.order_id_optional.size + 
  memx_options_memo_sbe_v1_7.clordid.size + 
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
...
-- Price Short
memx_options_memo_sbe_v1_7.price_short = {}

-- Size: Price Short
memx_options_memo_sbe_v1_7.price_short.size = 2

-- Display: Price Short
memx_options_memo_sbe_v1_7.price_short.display = function(value)
  return "Price Short: "..value
end

-- Translate: Price Short
memx_options_memo_sbe_v1_7.price_short.translate = function(raw)
  return raw/100
end

-- Dissect: Price Short
memx_options_memo_sbe_v1_7.price_short.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_7.price_short.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = memx_options_memo_sbe_v1_7.price_short.translate(raw)
  local display = memx_options_memo_sbe_v1_7.price_short.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_7.fields.price_short, range, value, display)

  return offset + length, value
end

-- Quantity
memx_options_memo_sbe_v1_7.quantity = {}

-- Size: Quantity
memx_options_memo_sbe_v1_7.quantity.size = 2

-- Display: Quantity
memx_options_memo_sbe_v1_7.quantity.display = function(value)
  return "Quantity: "..value
end

-- Dissect: Quantity
memx_options_memo_sbe_v1_7.quantity.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_7.quantity.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = memx_options_memo_sbe_v1_7.quantity.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_7.fields.quantity, range, value, display)

  return offset + length, value
end

-- One Sided Quotes Group
memx_options_memo_sbe_v1_7.one_sided_quotes_group = {}

-- Size: One Sided Quotes Group
memx_options_memo_sbe_v1_7.one_sided_quotes_group.size =
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
  memx_options_memo_sbe_v1_7.side.size + 
  memx_options_memo_sbe_v1_7.quantity.size + 
  memx_options_memo_sbe_v1_7.price_short.size

-- Display: One Sided Quotes Group
memx_options_memo_sbe_v1_7.one_sided_quotes_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: One Sided Quotes Group
memx_options_memo_sbe_v1_7.one_sided_quotes_group.fields = function(buffer, offset, packet, parent, one_sided_quotes_group_index)
  local index = offset

  -- Implicit One Sided Quotes Group Index
  if one_sided_quotes_group_index ~= nil then
    local iteration = parent:add(omi_memx_options_memo_sbe_v1_7.fields.one_sided_quotes_group_index, one_sided_quotes_group_index)
    iteration:set_generated()
  end
  ...
  index, quantity = memx_options_memo_sbe_v1_7.quantity.dissect(buffer, index, packet, parent)

  -- Price Short: 2 Byte Unsigned Fixed Width Integer
  index, price_short = memx_options_memo_sbe_v1_7.price_short.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: One Sided Quotes Group
memx_options_memo_sbe_v1_7.one_sided_quotes_group.dissect = function(buffer, offset, packet, parent, one_sided_quotes_group_index)
  if show.one_sided_quotes_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.one_sided_quotes_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_7.one_sided_quotes_group.fields(buffer, offset, packet, parent, one_sided_quotes_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_7.one_sided_quotes_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_7.one_sided_quotes_group.fields(buffer, offset, packet, parent, one_sided_quotes_group_index)
  end
end

-- One Sided Quotes Groups
memx_options_memo_sbe_v1_7.one_sided_quotes_groups = {}

-- Calculate size of: One Sided Quotes Groups
memx_options_memo_sbe_v1_7.one_sided_quotes_groups.size = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_7.one_sided_quotes_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: One Sided Quotes Groups
memx_options_memo_sbe_v1_7.one_sided_quotes_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for one_sided_quotes_group_index = 1, num_in_group do
    index, one_sided_quotes_group = memx_options_memo_sbe_v1_7.one_sided_quotes_group.dissect(buffer, index, packet, parent, one_sided_quotes_group_index)
  end
...
memx_options_memo_sbe_v1_7.one_sided_quotes_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.one_sided_quotes_groups then
    local length = memx_options_memo_sbe_v1_7.one_sided_quotes_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_options_memo_sbe_v1_7.one_sided_quotes_groups.display(buffer, packet, parent)
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.one_sided_quotes_groups, range, display)
  end

  return memx_options_memo_sbe_v1_7.one_sided_quotes_groups.fields(buffer, offset, packet, parent)
end
...
memx_options_memo_sbe_v1_7.long_one_sided_bulk_quote_message.size = function(buffer, offset)
  ...
  index = index + memx_options_memo_sbe_v1_7.one_sided_quotes_groups.size(buffer, offset + index)
...
memx_options_memo_sbe_v1_7.long_one_sided_bulk_quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, one_sided_quotes_groups = memx_options_memo_sbe_v1_7.one_sided_quotes_groups.dissect(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_7.two_sided_quotes_group = {}

-- Size: Two Sided Quotes Group
memx_options_memo_sbe_v1_7.two_sided_quotes_group.size =
  memx_options_memo_sbe_v1_7.list_seq_no.size + 
  memx_options_memo_sbe_v1_7.security_id.size + 
  memx_options_memo_sbe_v1_7.bid_size.size + 
  memx_options_memo_sbe_v1_7.bid_px.size + 
  memx_options_memo_sbe_v1_7.offer_size.size + 
  memx_options_memo_sbe_v1_7.offer_px.size

-- Display: Two Sided Quotes Group
memx_options_memo_sbe_v1_7.two_sided_quotes_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Two Sided Quotes Group
memx_options_memo_sbe_v1_7.two_sided_quotes_group.fields = function(buffer, offset, packet, parent, two_sided_quotes_group_index)
  local index = offset

  -- Implicit Two Sided Quotes Group Index
  if two_sided_quotes_group_index ~= nil then
    local iteration = parent:add(omi_memx_options_memo_sbe_v1_7.fields.two_sided_quotes_group_index, two_sided_quotes_group_index)
    iteration:set_generated()
  end
...
memx_options_memo_sbe_v1_7.two_sided_quotes_group.dissect = function(buffer, offset, packet, parent, two_sided_quotes_group_index)
  if show.two_sided_quotes_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.two_sided_quotes_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_7.two_sided_quotes_group.fields(buffer, offset, packet, parent, two_sided_quotes_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_7.two_sided_quotes_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_7.two_sided_quotes_group.fields(buffer, offset, packet, parent, two_sided_quotes_group_index)
  end
end

-- Two Sided Quotes Groups
memx_options_memo_sbe_v1_7.two_sided_quotes_groups = {}

-- Calculate size of: Two Sided Quotes Groups
memx_options_memo_sbe_v1_7.two_sided_quotes_groups.size = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_7.two_sided_quotes_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Two Sided Quotes Groups
memx_options_memo_sbe_v1_7.two_sided_quotes_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for two_sided_quotes_group_index = 1, num_in_group do
    index, two_sided_quotes_group = memx_options_memo_sbe_v1_7.two_sided_quotes_group.dissect(buffer, index, packet, parent, two_sided_quotes_group_index)
  end
...
memx_options_memo_sbe_v1_7.two_sided_quotes_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.two_sided_quotes_groups then
    local length = memx_options_memo_sbe_v1_7.two_sided_quotes_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = memx_options_memo_sbe_v1_7.two_sided_quotes_groups.display(buffer, packet, parent)
    parent = parent:add(omi_memx_options_memo_sbe_v1_7.fields.two_sided_quotes_groups, range, display)
  end

  return memx_options_memo_sbe_v1_7.two_sided_quotes_groups.fields(buffer, offset, packet, parent)
end
...
memx_options_memo_sbe_v1_7.long_two_sided_bulk_quote_message.size = function(buffer, offset)
  ...
  index = index + memx_options_memo_sbe_v1_7.two_sided_quotes_groups.size(buffer, offset + index)
...
memx_options_memo_sbe_v1_7.long_two_sided_bulk_quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, two_sided_quotes_groups = memx_options_memo_sbe_v1_7.two_sided_quotes_groups.dissect(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_7.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 6 then
    return memx_options_memo_sbe_v1_7.order_cancel_replace_request_message.size
  end
  -- Size of Order Cancel Request Message
  if template_id == 7 then
    return memx_options_memo_sbe_v1_7.order_cancel_request_message.size
  end
  -- Size of Mass Cancel Request Message
  if template_id == 8 then
    return memx_options_memo_sbe_v1_7.mass_cancel_request_message.size
  end
  -- Size of Mass Cancel Clear Lockout Request Message
  if template_id == 9 then
    return memx_options_memo_sbe_v1_7.mass_cancel_clear_lockout_request_message.size
  end
  -- Size of Mass Cancel Bulk Clear All Lockouts Request Message
  if template_id == 32 then
    return memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_all_lockouts_request_message.size
  end
  -- Size of Mass Cancel Bulk Clear Lockouts By Efid Or Underlier Request Message
  if template_id == 33 then
    return memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_lockouts_by_efid_or_underlier_request_message.size
  end
  ...
  if template_id == 13 then
    return memx_options_memo_sbe_v1_7.execution_report_bulk_quote_component_new_message.size
  end
  -- Size of Execution Report Rejected Message
  if template_id == 14 then
    return memx_options_memo_sbe_v1_7.execution_report_rejected_message.size
  end
  ...
  if template_id == 16 then
    return memx_options_memo_sbe_v1_7.execution_report_pending_cancel_message.size
  end
  -- Size of Execution Report Canceled Message
  if template_id == 17 then
    return memx_options_memo_sbe_v1_7.execution_report_canceled_message.size
  end
  -- Size of Execution Report Pending Replace Message
  if template_id == 18 then
    return memx_options_memo_sbe_v1_7.execution_report_pending_replace_message.size
  end
  -- Size of Execution Report Replaced Message
  if template_id == 19 then
    return memx_options_memo_sbe_v1_7.execution_report_replaced_message.size
  end
  -- Size of Execution Report Trade Correction Message
  if template_id == 20 then
    return memx_options_memo_sbe_v1_7.execution_report_trade_correction_message.size
  end
  -- Size of Execution Report Trade Break Message
  if template_id == 21 then
    return memx_options_memo_sbe_v1_7.execution_report_trade_break_message.size
  end
  -- Size of Execution Report Restatement Message
  if template_id == 22 then
    return memx_options_memo_sbe_v1_7.execution_report_restatement_message.size
  end
  -- Size of Pending Mass Cancel Message
  if template_id == 23 then
    return memx_options_memo_sbe_v1_7.pending_mass_cancel_message.size
  end
  -- Size of Mass Cancel Reject Message
  if template_id == 24 then
    return memx_options_memo_sbe_v1_7.mass_cancel_reject_message.size
  end
  -- Size of Mass Cancel Done Message
  if template_id == 25 then
    return memx_options_memo_sbe_v1_7.mass_cancel_done_message.size
  end
  -- Size of Order Cancel Reject Message
  if template_id == 26 then
    return memx_options_memo_sbe_v1_7.order_cancel_reject_message.size
  end
  ...
  if template_id == 29 then
    return memx_options_memo_sbe_v1_7.user_notification_message.size
  end
  -- Size of Mass Cancel Clear Lockout Reject Message
  if template_id == 30 then
    return memx_options_memo_sbe_v1_7.mass_cancel_clear_lockout_reject_message.size
  end
  -- Size of Mass Cancel Clear Lockout Done Message
  if template_id == 31 then
    return memx_options_memo_sbe_v1_7.mass_cancel_clear_lockout_done_message.size
  end
  -- Size of Mass Cancel Bulk Clear Lockout Reject Message
  if template_id == 35 then
    return memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_lockout_reject_message.size
  end
  -- Size of Mass Cancel Bulk Clear Lockout Accepted Message
  if template_id == 36 then
    return memx_options_memo_sbe_v1_7.mass_cancel_bulk_clear_lockout_accepted_message.size
  end
...
-- Size: Sbe Header
memx_options_memo_sbe_v1_7.sbe_header.size =
  memx_options_memo_sbe_v1_7.block_length.size + 
  memx_options_memo_sbe_v1_7.template_id.size + 
  memx_options_memo_sbe_v1_7.schema_id.size + 
  memx_options_memo_sbe_v1_7.version.size
...
memx_options_memo_sbe_v1_7.sbe_message.size = function(buffer, offset)
  ...
  index = index + memx_options_memo_sbe_v1_7.sbe_header.size
...
memx_options_memo_sbe_v1_7.stream_complete_message.size =
  memx_options_memo_sbe_v1_7.total_sequence_count.size
...
memx_options_memo_sbe_v1_7.stream_rejected_message.size =
  memx_options_memo_sbe_v1_7.stream_reject_code.size
...
memx_options_memo_sbe_v1_7.max_sequence_number.size = 8

-- Display: Max Sequence Number
memx_options_memo_sbe_v1_7.max_sequence_number.display = function(value)
  return "Max Sequence Number: "..value
end

-- Dissect: Max Sequence Number
memx_options_memo_sbe_v1_7.max_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_7.max_sequence_number.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = memx_options_memo_sbe_v1_7.max_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_7.fields.max_sequence_number, range, value, display)
...
memx_options_memo_sbe_v1_7.stream_begin_message.size =
  memx_options_memo_sbe_v1_7.next_sequence_number.size + 
  memx_options_memo_sbe_v1_7.max_sequence_number.size
...
memx_options_memo_sbe_v1_7.replay_complete_message.size =
  memx_options_memo_sbe_v1_7.message_count.size
...
memx_options_memo_sbe_v1_7.replay_rejected_message.size =
  memx_options_memo_sbe_v1_7.replay_reject_code.size
...
memx_options_memo_sbe_v1_7.replay_begin_message.size =
  memx_options_memo_sbe_v1_7.next_sequence_number.size + 
  memx_options_memo_sbe_v1_7.pending_message_count.size
...
memx_options_memo_sbe_v1_7.start_of_session_message.size =
  memx_options_memo_sbe_v1_7.session_id.size
...
memx_options_memo_sbe_v1_7.login_rejected_message.size =
  memx_options_memo_sbe_v1_7.login_reject_code.size
...
memx_options_memo_sbe_v1_7.login_accepted_message.size =
  memx_options_memo_sbe_v1_7.supported_request_mode.size
...
memx_options_memo_sbe_v1_7.stream_request_message.size =
  memx_options_memo_sbe_v1_7.session_id.size + 
  memx_options_memo_sbe_v1_7.next_sequence_number.size
...
memx_options_memo_sbe_v1_7.replay_all_request_message.size =
  memx_options_memo_sbe_v1_7.session_id.size
...
memx_options_memo_sbe_v1_7.replay_request_message.size =
  memx_options_memo_sbe_v1_7.session_id.size + 
  memx_options_memo_sbe_v1_7.next_sequence_number.size + 
  memx_options_memo_sbe_v1_7.count.size
...
memx_options_memo_sbe_v1_7.login_request_message.size =
  memx_options_memo_sbe_v1_7.token_type.size + 
  memx_options_memo_sbe_v1_7.token.size
...
memx_options_memo_sbe_v1_7.data.size = function(buffer, offset, message_type)
  ...
  if message_type == 100 then
    return memx_options_memo_sbe_v1_7.login_request_message.size
  end
  -- Size of Replay Request Message
  if message_type == 101 then
    return memx_options_memo_sbe_v1_7.replay_request_message.size
  end
  -- Size of Replay All Request Message
  if message_type == 102 then
    return memx_options_memo_sbe_v1_7.replay_all_request_message.size
  end
  -- Size of Stream Request Message
  if message_type == 103 then
    return memx_options_memo_sbe_v1_7.stream_request_message.size
  end
  ...
  if message_type == 1 then
    return memx_options_memo_sbe_v1_7.login_accepted_message.size
  end
  -- Size of Login Rejected Message
  if message_type == 2 then
    return memx_options_memo_sbe_v1_7.login_rejected_message.size
  end
  -- Size of Start Of Session Message
  if message_type == 3 then
    return memx_options_memo_sbe_v1_7.start_of_session_message.size
  end
  -- Size of Replay Begin Message
  if message_type == 5 then
    return memx_options_memo_sbe_v1_7.replay_begin_message.size
  end
  -- Size of Replay Rejected Message
  if message_type == 6 then
    return memx_options_memo_sbe_v1_7.replay_rejected_message.size
  end
  -- Size of Replay Complete Message
  if message_type == 7 then
    return memx_options_memo_sbe_v1_7.replay_complete_message.size
  end
  -- Size of Stream Begin Message
  if message_type == 8 then
    return memx_options_memo_sbe_v1_7.stream_begin_message.size
  end
  -- Size of Stream Rejected Message
  if message_type == 9 then
    return memx_options_memo_sbe_v1_7.stream_rejected_message.size
  end
  -- Size of Stream Complete Message
  if message_type == 10 then
    return memx_options_memo_sbe_v1_7.stream_complete_message.size
  end
...
-- Size: Common Header
memx_options_memo_sbe_v1_7.common_header.size =
  memx_options_memo_sbe_v1_7.message_type.size + 
  memx_options_memo_sbe_v1_7.message_length.size
