...
-- Memx Equities Sbe MemoirDepthFeed 1.3 Application Messages
...
-- Memx Equities MemoirDepthFeed Sbe 1.3 generated fields
omi_memx_equities_memoirdepthfeed_sbe_v1_3.fields.message_index = ProtoField.new("Message Index", "memx.equities.memoirdepthfeed.sbe.v1.3.messageindex", ftypes.UINT16)
...
omi_memx_equities_memoirdepthfeed_sbe_v1_3.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_memx_equities_memoirdepthfeed_sbe_v1_3.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Handle changed preferences
function omi_memx_equities_memoirdepthfeed_sbe_v1_3.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_memx_equities_memoirdepthfeed_sbe_v1_3.prefs.show_application_messages then
    show.application_messages = omi_memx_equities_memoirdepthfeed_sbe_v1_3.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_memx_equities_memoirdepthfeed_sbe_v1_3.prefs.show_message_index then
    show.message_index = omi_memx_equities_memoirdepthfeed_sbe_v1_3.prefs.show_message_index
  end
end
...
memx_equities_memoirdepthfeed_sbe_v1_3.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_equities_memoirdepthfeed_sbe_v1_3.fields.sbe_message, buffer(offset, 0))
    local index = memx_equities_memoirdepthfeed_sbe_v1_3.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_equities_memoirdepthfeed_sbe_v1_3.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_equities_memoirdepthfeed_sbe_v1_3.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset

  -- Implicit Message Index
  if message_index ~= nil and show.message_index then
    local iteration = parent:add(omi_memx_equities_memoirdepthfeed_sbe_v1_3.fields.message_index, message_index)
...
-- Dissect: Message
memx_equities_memoirdepthfeed_sbe_v1_3.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_memx_equities_memoirdepthfeed_sbe_v1_3.fields.message, buffer(offset, 0))
    local current = memx_equities_memoirdepthfeed_sbe_v1_3.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    memx_equities_memoirdepthfeed_sbe_v1_3.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
memx_equities_memoirdepthfeed_sbe_v1_3.sequenced_message.fields = function(buffer, offset, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index, message = memx_equities_memoirdepthfeed_sbe_v1_3.message.dissect(buffer, index, packet, parent, size_of_message, message_index)
  end
...
memx_equities_memoirdepthfeed_sbe_v1_3.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_equities_memoirdepthfeed_sbe_v1_3.fields.sequenced_message, buffer(offset, 0))
    local index = memx_equities_memoirdepthfeed_sbe_v1_3.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_equities_memoirdepthfeed_sbe_v1_3.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
