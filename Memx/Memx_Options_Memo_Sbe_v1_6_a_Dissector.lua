...
omi_memx_options_memo_sbe_v1_6_a.fields.cancel_orders_from_this_port_only = ProtoField.new("Cancel Orders From This Port Only", "memx.options.memo.sbe.v1.6.a.cancelordersfromthisportonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_memx_options_memo_sbe_v1_6_a.fields.external_routing_not_allowed = ProtoField.new("External Routing Not Allowed", "memx.options.memo.sbe.v1.6.a.externalroutingnotallowed", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
omi_memx_options_memo_sbe_v1_6_a.fields.intermarket_sweep = ProtoField.new("Intermarket Sweep", "memx.options.memo.sbe.v1.6.a.intermarketsweep", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
...
omi_memx_options_memo_sbe_v1_6_a.fields.lockout = ProtoField.new("Lockout", "memx.options.memo.sbe.v1.6.a.lockout", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_memx_options_memo_sbe_v1_6_a.fields.nested_parties_group = ProtoField.new("Nested Parties Group", "memx.options.memo.sbe.v1.6.a.nestedpartiesgroup", ftypes.STRING)
omi_memx_options_memo_sbe_v1_6_a.fields.nested_parties_groups = ProtoField.new("Nested Parties Groups", "memx.options.memo.sbe.v1.6.a.nestedpartiesgroups", ftypes.STRING)
omi_memx_options_memo_sbe_v1_6_a.fields.nested_party_id = ProtoField.new("Nested Party Id", "memx.options.memo.sbe.v1.6.a.nestedpartyid", ftypes.STRING)
...
omi_memx_options_memo_sbe_v1_6_a.fields.participate_do_not_initiate = ProtoField.new("Participate Do Not Initiate", "memx.options.memo.sbe.v1.6.a.participatedonotinitiate", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_memx_options_memo_sbe_v1_6_a.fields.send_cancels = ProtoField.new("Send Cancels", "memx.options.memo.sbe.v1.6.a.sendcancels", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
-- Memx Options Sbe Memo 1.6.a Application Messages
...
omi_memx_options_memo_sbe_v1_6_a.fields.nested_parties_group_index = ProtoField.new("Nested Parties Group Index", "memx.options.memo.sbe.v1.6.a.nestedpartiesgroupindex", ftypes.UINT16)
...
omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_group = Pref.bool("Show Nested Parties Group", show.nested_parties_group, "Parse and add Nested Parties Group to protocol tree")
omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_groups = Pref.bool("Show Nested Parties Groups", show.nested_parties_groups, "Parse and add Nested Parties Groups to protocol tree")
...
function omi_memx_options_memo_sbe_v1_6_a.prefs_changed()
  ...
  if show.nested_parties_group ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_group then
    show.nested_parties_group = omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_group
    changed = true
  end
  if show.nested_parties_groups ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_groups then
    show.nested_parties_groups = omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_groups
    changed = true
  end
...
-- Nested Party Id
memx_options_memo_sbe_v1_6_a.nested_party_id = {}

-- Size: Nested Party Id
memx_options_memo_sbe_v1_6_a.nested_party_id.size = 16

-- Display: Nested Party Id
memx_options_memo_sbe_v1_6_a.nested_party_id.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
memx_options_memo_sbe_v1_6_a.nested_party_id.dissect = function(buffer, offset, packet, parent)
  local length = memx_options_memo_sbe_v1_6_a.nested_party_id.size
  local range = buffer(offset, length)
  ...
  local display = memx_options_memo_sbe_v1_6_a.nested_party_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.nested_party_id, range, value, display)

  return offset + length, value
end

-- Nested Parties Group
memx_options_memo_sbe_v1_6_a.nested_parties_group = {}

-- Size: Nested Parties Group
memx_options_memo_sbe_v1_6_a.nested_parties_group.size =
  memx_options_memo_sbe_v1_6_a.nested_party_id.size + 
...
memx_options_memo_sbe_v1_6_a.nested_parties_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Nested Parties Group
memx_options_memo_sbe_v1_6_a.nested_parties_group.fields = function(buffer, offset, packet, parent, nested_parties_group_index)
  local index = offset

  -- Implicit Nested Parties Group Index
  if nested_parties_group_index ~= nil then
    local iteration = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.nested_parties_group_index, nested_parties_group_index)
    iteration:set_generated()
  end

  -- Nested Party Id: AllocationInstructionAckNestedPartyID
  index, nested_party_id = memx_options_memo_sbe_v1_6_a.nested_party_id.dissect(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_6_a.nested_parties_group.dissect = function(buffer, offset, packet, parent, nested_parties_group_index)
  if show.nested_parties_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.nested_parties_group, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.nested_parties_group.fields(buffer, offset, packet, parent, nested_parties_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.nested_parties_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_6_a.nested_parties_group.fields(buffer, offset, packet, parent, nested_parties_group_index)
  end
end
...
memx_options_memo_sbe_v1_6_a.nested_parties_groups = {}

-- Calculate size of: Nested Parties Groups
memx_options_memo_sbe_v1_6_a.nested_parties_groups.size = function(buffer, offset)
  local index = 0
...
memx_options_memo_sbe_v1_6_a.nested_parties_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Nested Parties Groups
memx_options_memo_sbe_v1_6_a.nested_parties_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for nested_parties_group_index = 1, num_in_group do
    index, nested_parties_group = memx_options_memo_sbe_v1_6_a.nested_parties_group.dissect(buffer, index, packet, parent, nested_parties_group_index)
  end
...
memx_options_memo_sbe_v1_6_a.nested_parties_groups.dissect = function(buffer, offset, packet, parent)
  if show.nested_parties_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.nested_parties_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.nested_parties_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.nested_parties_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return memx_options_memo_sbe_v1_6_a.nested_parties_groups.fields(buffer, offset, packet, parent)
  end
end
...
memx_options_memo_sbe_v1_6_a.reported_allocations_group.size = function(buffer, offset)
  ...
  index = index + memx_options_memo_sbe_v1_6_a.nested_parties_groups.size(buffer, offset + index)
...
memx_options_memo_sbe_v1_6_a.reported_allocations_group.fields = function(buffer, offset, packet, parent, reported_allocations_group_index)
  ...
  index, nested_parties_groups = memx_options_memo_sbe_v1_6_a.nested_parties_groups.dissect(buffer, index, packet, parent)
...
memx_options_memo_sbe_v1_6_a.reported_allocations_groups.dissect = function(buffer, offset, packet, parent)
  if show.reported_allocations_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.reported_allocations_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.reported_allocations_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.reported_allocations_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.execution_allocations_groups.dissect = function(buffer, offset, packet, parent)
  if show.execution_allocations_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.execution_allocations_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.execution_allocations_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.execution_allocations_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.allocation_instruction_alert_message.dissect = function(buffer, offset, packet, parent)
  if show.allocation_instruction_alert_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.allocation_instruction_alert_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.allocation_instruction_alert_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.allocation_instruction_alert_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.allocation_instruction_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.allocation_instruction_ack_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.allocation_instruction_ack_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.allocation_instruction_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.allocation_instruction_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.parties_groups.dissect = function(buffer, offset, packet, parent)
  if show.parties_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.parties_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.parties_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.parties_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.execution_report_trade_message.dissect = function(buffer, offset, packet, parent)
  if show.execution_report_trade_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.execution_report_trade_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.execution_report_trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.execution_report_trade_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.execution_report_bulk_quote_pending_new_message.dissect = function(buffer, offset, packet, parent)
  if show.execution_report_bulk_quote_pending_new_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.execution_report_bulk_quote_pending_new_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.execution_report_bulk_quote_pending_new_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.execution_report_bulk_quote_pending_new_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.execution_report_new_message.dissect = function(buffer, offset, packet, parent)
  if show.execution_report_new_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.execution_report_new_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.execution_report_new_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.execution_report_new_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.requested_allocations_groups.dissect = function(buffer, offset, packet, parent)
  if show.requested_allocations_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.requested_allocations_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.requested_allocations_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.requested_allocations_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.allocation_instruction_message.dissect = function(buffer, offset, packet, parent)
  if show.allocation_instruction_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.allocation_instruction_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.allocation_instruction_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.allocation_instruction_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.one_sided_quotes_groups.dissect = function(buffer, offset, packet, parent)
  if show.one_sided_quotes_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.one_sided_quotes_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.one_sided_quotes_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.one_sided_quotes_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.long_one_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.long_one_sided_bulk_quote_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.long_one_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.long_one_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.long_one_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.short_one_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.short_one_sided_bulk_quote_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.short_one_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.short_one_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.short_one_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.two_sided_quotes_groups.dissect = function(buffer, offset, packet, parent)
  if show.two_sided_quotes_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.two_sided_quotes_groups, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.two_sided_quotes_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.two_sided_quotes_groups.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.long_two_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.long_two_sided_bulk_quote_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.long_two_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.long_two_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.long_two_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.short_two_sided_bulk_quote_message.dissect = function(buffer, offset, packet, parent)
  if show.short_two_sided_bulk_quote_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.short_two_sided_bulk_quote_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.short_two_sided_bulk_quote_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.short_two_sided_bulk_quote_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.new_order_single_message.dissect = function(buffer, offset, packet, parent)
  if show.new_order_single_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.new_order_single_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.new_order_single_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.new_order_single_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.sbe_message.dissect = function(buffer, offset, packet, parent)
  if show.sbe_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.sbe_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.sbe_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.sbe_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.sequenced_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
...
memx_options_memo_sbe_v1_6_a.unsequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.unsequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_memx_options_memo_sbe_v1_6_a.fields.unsequenced_message, buffer(offset, 0))
    local index = memx_options_memo_sbe_v1_6_a.unsequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = memx_options_memo_sbe_v1_6_a.unsequenced_message.display(packet, parent, length)
    parent:append_text(display)
