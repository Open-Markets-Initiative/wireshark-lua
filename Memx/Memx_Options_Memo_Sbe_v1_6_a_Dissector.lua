...
omi_memx_options_memo_sbe_v1_6_a.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_memx_options_memo_sbe_v1_6_a.prefs.show_parties_group_index = Pref.bool("Show Parties Group Index", show.parties_group_index, "Show generated parties group index in protocol tree")
omi_memx_options_memo_sbe_v1_6_a.prefs.show_two_sided_quotes_group_index = Pref.bool("Show Two Sided Quotes Group Index", show.two_sided_quotes_group_index, "Show generated two sided quotes group index in protocol tree")
omi_memx_options_memo_sbe_v1_6_a.prefs.show_one_sided_quotes_group_index = Pref.bool("Show One Sided Quotes Group Index", show.one_sided_quotes_group_index, "Show generated one sided quotes group index in protocol tree")
omi_memx_options_memo_sbe_v1_6_a.prefs.show_execution_allocations_group_index = Pref.bool("Show Execution Allocations Group Index", show.execution_allocations_group_index, "Show generated execution allocations group index in protocol tree")
omi_memx_options_memo_sbe_v1_6_a.prefs.show_requested_allocations_group_index = Pref.bool("Show Requested Allocations Group Index", show.requested_allocations_group_index, "Show generated requested allocations group index in protocol tree")
omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_group_index = Pref.bool("Show Nested Parties Group Index", show.nested_parties_group_index, "Show generated nested parties group index in protocol tree")
omi_memx_options_memo_sbe_v1_6_a.prefs.show_reported_allocations_group_index = Pref.bool("Show Reported Allocations Group Index", show.reported_allocations_group_index, "Show generated reported allocations group index in protocol tree")

-- Handle changed preferences
function omi_memx_options_memo_sbe_v1_6_a.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_application_messages then
    show.application_messages = omi_memx_options_memo_sbe_v1_6_a.prefs.show_application_messages
  end
  ...
  if show.parties_group_index ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_parties_group_index then
    show.parties_group_index = omi_memx_options_memo_sbe_v1_6_a.prefs.show_parties_group_index
  end
  if show.two_sided_quotes_group_index ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_two_sided_quotes_group_index then
    show.two_sided_quotes_group_index = omi_memx_options_memo_sbe_v1_6_a.prefs.show_two_sided_quotes_group_index
  end
  if show.one_sided_quotes_group_index ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_one_sided_quotes_group_index then
    show.one_sided_quotes_group_index = omi_memx_options_memo_sbe_v1_6_a.prefs.show_one_sided_quotes_group_index
  end
  if show.execution_allocations_group_index ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_execution_allocations_group_index then
    show.execution_allocations_group_index = omi_memx_options_memo_sbe_v1_6_a.prefs.show_execution_allocations_group_index
  end
  if show.requested_allocations_group_index ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_requested_allocations_group_index then
    show.requested_allocations_group_index = omi_memx_options_memo_sbe_v1_6_a.prefs.show_requested_allocations_group_index
  end
  if show.nested_parties_group_index ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_group_index then
    show.nested_parties_group_index = omi_memx_options_memo_sbe_v1_6_a.prefs.show_nested_parties_group_index
  end
  if show.reported_allocations_group_index ~= omi_memx_options_memo_sbe_v1_6_a.prefs.show_reported_allocations_group_index then
    show.reported_allocations_group_index = omi_memx_options_memo_sbe_v1_6_a.prefs.show_reported_allocations_group_index
  end
end
