...
omi_koscom_mdcsrealtime_commodities_exture_v2_018.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
...
function omi_koscom_mdcsrealtime_commodities_exture_v2_018.prefs_changed()
  ...
  if show.packet ~= omi_koscom_mdcsrealtime_commodities_exture_v2_018.prefs.show_packet then
    show.packet = omi_koscom_mdcsrealtime_commodities_exture_v2_018.prefs.show_packet
  end
end
