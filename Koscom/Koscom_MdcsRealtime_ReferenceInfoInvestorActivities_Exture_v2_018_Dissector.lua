...
omi_koscom_mdcsrealtime_referenceinfoinvestoractivities_exture_v2_018.fields.average_yld = ProtoField.new("Average Yld", "koscom.mdcsrealtime.referenceinfoinvestoractivities.exture.v2.018.averageyld", ftypes.DOUBLE)
...
-- Koscom MdcsRealtime ReferenceInfoInvestorActivities 2.018 Application Messages
...
omi_koscom_mdcsrealtime_referenceinfoinvestoractivities_exture_v2_018.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
function omi_koscom_mdcsrealtime_referenceinfoinvestoractivities_exture_v2_018.prefs_changed()
  ...
  if show.structs ~= omi_koscom_mdcsrealtime_referenceinfoinvestoractivities_exture_v2_018.prefs.show_structs then
    show.structs = omi_koscom_mdcsrealtime_referenceinfoinvestoractivities_exture_v2_018.prefs.show_structs
  end
end
