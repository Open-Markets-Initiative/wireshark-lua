...
omi_koscom_mdcsrealtime_indexproduct3_exture_v1_39.fields.filler = ProtoField.new("Filler", "koscom.mdcsrealtime.indexproduct3.exture.v1.39.filler", ftypes.STRING)
...
-- Koscom MdcsRealtime Exture IndexProduct3 1.39 Application Messages
...
omi_koscom_mdcsrealtime_indexproduct3_exture_v1_39.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
...
function omi_koscom_mdcsrealtime_indexproduct3_exture_v1_39.prefs_changed()
  ...
  if show.packet ~= omi_koscom_mdcsrealtime_indexproduct3_exture_v1_39.prefs.show_packet then
    show.packet = omi_koscom_mdcsrealtime_indexproduct3_exture_v1_39.prefs.show_packet
  end
end
...
-- Filler
koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler = {}

-- Size: Filler
koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler.size = 4

-- Display: Filler
koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler.display = function(value)
  return "Filler: "..value
end

-- Dissect: Filler
koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler.dissect = function(buffer, offset, packet, parent)
  local length = koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler.size
  local range = buffer(offset, length)
  local value = range:string(koscom_mdcsrealtime_indexproduct3_exture_v1_39.text_encoding)
  local display = koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler.display(value, buffer, offset, packet, parent)

  parent:add(omi_koscom_mdcsrealtime_indexproduct3_exture_v1_39.fields.filler, range, value, display)
...
koscom_mdcsrealtime_indexproduct3_exture_v1_39.global_index_message.size =
  ...
  koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler.size + 
  koscom_mdcsrealtime_indexproduct3_exture_v1_39.end_keyword.size
...
koscom_mdcsrealtime_indexproduct3_exture_v1_39.global_index_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Filler: String
  index, filler = koscom_mdcsrealtime_indexproduct3_exture_v1_39.filler.dissect(buffer, index, packet, parent)
