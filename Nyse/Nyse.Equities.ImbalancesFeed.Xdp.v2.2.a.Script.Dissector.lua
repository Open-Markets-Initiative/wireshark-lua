...
dissect.significant_imbalance = function(buffer, offset, packet, parent)
  local range = buffer(offset, size_of.significant_imbalance)
  ...
  return offset + size_of.significant_imbalance
end
...
dissect.unpaired_side = function(buffer, offset, packet, parent)
  local range = buffer(offset, size_of.unpaired_side)
  local value = range:string()
  ...
  return offset + size_of.unpaired_side
end
...
dissect.unpaired_qty = function(buffer, offset, packet, parent)
  local range = buffer(offset, size_of.unpaired_qty)
  ...
  return offset + size_of.unpaired_qty
end
...
dissect.imbalance_message_fields = function(buffer, offset, packet, parent)
  ...
  index = dissect.unpaired_qty(buffer, index, packet, parent)

  -- Unpaired Side: 1 Byte Ascii String Enum with 3 values
  index = dissect.unpaired_side(buffer, index, packet, parent)

  -- Significant Imbalance: 1 Byte Ascii String Enum with 2 values
  index = dissect.significant_imbalance(buffer, index, packet, parent)
...
-- Register Nyse Equities ImbalancesFeed Xdp 2.2.a Heuristic
