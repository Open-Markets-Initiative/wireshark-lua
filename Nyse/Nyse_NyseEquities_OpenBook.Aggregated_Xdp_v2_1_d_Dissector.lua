...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.price_resolution = ProtoField.new("Price Resolution", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.priceresolution", ftypes.DOUBLE)
...
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.price_resolution.translate = function(raw)
  return raw/100000000
end
...
nyse_nyseequities_openbookaggregated_xdp_v2_1_d.price_resolution.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int()
  local value = nyse_nyseequities_openbookaggregated_xdp_v2_1_d.price_resolution.translate(raw)
...
-- Dissector Heuristic for Nyse NyseEquities OpenBook.Aggregated Xdp 2.1.d
local function omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d_heuristic(buffer, packet, parent)
...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d:register_heuristic("udp", omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d_heuristic)
