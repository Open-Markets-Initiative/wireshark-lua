...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.prev_close_price = ProtoField.new("Prev Close Price", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.prevcloseprice", ftypes.UINT32)
...
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.price_1 = ProtoField.new("Price 1", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.price1", ftypes.UINT32)
omi_nyse_nyseequities_openbookaggregated_xdp_v2_1_d.fields.price_2 = ProtoField.new("Price 2", "nyse.nyseequities.openbook.aggregated.xdp.v2.1.d.price2", ftypes.UINT32)
