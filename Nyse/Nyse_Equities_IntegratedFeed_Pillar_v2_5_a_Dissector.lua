...
verify.omi_nyse_equities_integratedfeed_pillar_v2_5_a_packet_size = function(buffer)
...
local function omi_nyse_equities_integratedfeed_pillar_v2_5_a_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_nyse_equities_integratedfeed_pillar_v2_5_a_packet_size(buffer) then return false end
