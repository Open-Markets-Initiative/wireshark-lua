...
-- Dissector Heuristic for Nyse ArcaOptions TopFeed Pillar 1.2.j
local function omi_nyse_arcaoptions_topfeed_pillar_v1_2_j_heuristic(buffer, packet, parent)
...
omi_nyse_arcaoptions_topfeed_pillar_v1_2_j:register_heuristic("udp", omi_nyse_arcaoptions_topfeed_pillar_v1_2_j_heuristic)
