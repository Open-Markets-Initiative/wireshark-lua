...
nyse_equities_binarygateway_pillar_v5_8.sequenced_message.size = function(buffer, offset, seq_msg_type)
  ...
  if seq_msg_type == 0x0220 then
    return nyse_equities_binarygateway_pillar_v5_8.session_configuration_request_message.size
  end
  -- Size of Sequenced Filler Message
  if seq_msg_type == 0x0282 then
    return nyse_equities_binarygateway_pillar_v5_8.sequenced_filler_message.size
  end
  ...
  if seq_msg_type == 0x0280 then
    return nyse_equities_binarygateway_pillar_v5_8.order_cancel_request_message.size
  end
  -- Size of Order Modify Request Message
  if seq_msg_type == 0x0270 then
    return nyse_equities_binarygateway_pillar_v5_8.order_modify_request_message.size
  end
  -- Size of Bulk Cancel Request Message
  if seq_msg_type == 0x0281 then
    return nyse_equities_binarygateway_pillar_v5_8.bulk_cancel_request_message.size
  end
  -- Size of Symbol Subscription Request Message
  if seq_msg_type == 0x0346 then
    return nyse_equities_binarygateway_pillar_v5_8.symbol_subscription_request_message.size
  end
  -- Size of Tg Begin Message
  if seq_msg_type == 0x0343 then
    return nyse_equities_binarygateway_pillar_v5_8.tg_begin_message.size
  end
  -- Size of Tg End Message
  if seq_msg_type == 0x0344 then
    return nyse_equities_binarygateway_pillar_v5_8.tg_end_message.size
  end
  -- Size of Manual Action Response Message
  if seq_msg_type == 0x0354 then
    return nyse_equities_binarygateway_pillar_v5_8.manual_action_response_message.size
  end
  -- Size of Risk Limit Update Request Message
  if seq_msg_type == 0x0330 then
    return nyse_equities_binarygateway_pillar_v5_8.risk_limit_update_request_message.size
  end
  -- Size of Risk Action Request Message
  if seq_msg_type == 0x0331 then
    return nyse_equities_binarygateway_pillar_v5_8.risk_action_request_message.size
  end
  -- Size of Equities Symbol Reference Data Message
  if seq_msg_type == 0x0232 then
    return nyse_equities_binarygateway_pillar_v5_8.equities_symbol_reference_data_message.size
  end
  -- Size of Dmm Symbol Reference Data Message
  if seq_msg_type == 0x0832 then
    return nyse_equities_binarygateway_pillar_v5_8.dmm_symbol_reference_data_message.size
  end
  -- Size of Minimum Price Variant Class Reference Data Message
  if seq_msg_type == 0x0230 then
    return nyse_equities_binarygateway_pillar_v5_8.minimum_price_variant_class_reference_data_message.size
  end
  ...
  if seq_msg_type == 0x0272 then
    return nyse_equities_binarygateway_pillar_v5_8.mpid_configuration_message.size
  end
  -- Size of Mmid Configuration Message
  if seq_msg_type == 0x0273 then
    return nyse_equities_binarygateway_pillar_v5_8.mmid_configuration_message.size
  end
  -- Size of Session Configuration Acknowledgement Message
  if seq_msg_type == 0x0221 then
    return nyse_equities_binarygateway_pillar_v5_8.session_configuration_acknowledgement_message.size
  end
  ...
  if seq_msg_type == 0x0271 then
    return nyse_equities_binarygateway_pillar_v5_8.order_modify_cancel_request_acknowledgment_and_urout.size
  end
  -- Size of Order Priority Update Acknowledgment
  if seq_msg_type == 0x0262 then
    return nyse_equities_binarygateway_pillar_v5_8.order_priority_update_acknowledgment.size
  end
  -- Size of Execution Report
  if seq_msg_type == 0x0290 then
    return nyse_equities_binarygateway_pillar_v5_8.execution_report.size
  end
  -- Size of Trade Bust Correct
  if seq_msg_type == 0x0292 then
    return nyse_equities_binarygateway_pillar_v5_8.trade_bust_correct.size
  end
  -- Size of Application Layer Reject
  if seq_msg_type == 0x0263 then
    return nyse_equities_binarygateway_pillar_v5_8.application_layer_reject.size
  end
  -- Size of Symbol Subscription Acknowledgement
  if seq_msg_type == 0x0347 then
    return nyse_equities_binarygateway_pillar_v5_8.symbol_subscription_acknowledgement.size
  end
  -- Size of Gt Begin
  if seq_msg_type == 0x0349 then
    return nyse_equities_binarygateway_pillar_v5_8.gt_begin.size
  end
  -- Size of Gt End
  if seq_msg_type == 0x0350 then
    return nyse_equities_binarygateway_pillar_v5_8.gt_end.size
  end
  -- Size of Auction Price Data
  if seq_msg_type == 0x0352 then
    return nyse_equities_binarygateway_pillar_v5_8.auction_price_data.size
  end
  -- Size of Auction Request
  if seq_msg_type == 0x0348 then
    return nyse_equities_binarygateway_pillar_v5_8.auction_request.size
  end
  -- Size of Manual Action Request
  if seq_msg_type == 0x0353 then
    return nyse_equities_binarygateway_pillar_v5_8.manual_action_request.size
  end
  -- Size of Risk Control Acknowledgement
  if seq_msg_type == 0x0332 then
    return nyse_equities_binarygateway_pillar_v5_8.risk_control_acknowledgement.size
  end
  -- Size of Risk Control Alert
  if seq_msg_type == 0x0333 then
    return nyse_equities_binarygateway_pillar_v5_8.risk_control_alert.size
  end
