...
-- Nyse Arca Options Pillar ComplexFeed 1.0.d Application Messages
...
omi_nyse_arca_options_complexfeed_pillar_v1_0_d.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
omi_nyse_arca_options_complexfeed_pillar_v1_0_d.prefs.show_leg_definition_index = Pref.bool("Show Leg Definition Index", show.leg_definition_index, "Show generated leg definition index in protocol tree")
...
function omi_nyse_arca_options_complexfeed_pillar_v1_0_d.prefs_changed()
  ...
  if show.message_index ~= omi_nyse_arca_options_complexfeed_pillar_v1_0_d.prefs.show_message_index then
    show.message_index = omi_nyse_arca_options_complexfeed_pillar_v1_0_d.prefs.show_message_index
  end
  if show.leg_definition_index ~= omi_nyse_arca_options_complexfeed_pillar_v1_0_d.prefs.show_leg_definition_index then
    show.leg_definition_index = omi_nyse_arca_options_complexfeed_pillar_v1_0_d.prefs.show_leg_definition_index
  end
end
...
nyse_arca_options_complexfeed_pillar_v1_0_d.send_time.dissect = function(buffer, offset, packet, parent)
  if show.send_time then
    ...
    local index, value = nyse_arca_options_complexfeed_pillar_v1_0_d.send_time.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nyse_arca_options_complexfeed_pillar_v1_0_d.send_time.display(packet, parent, value, length)
    parent:append_text(display)
...
nyse_arca_options_complexfeed_pillar_v1_0_d.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = nyse_arca_options_complexfeed_pillar_v1_0_d.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
...
nyse_arca_options_complexfeed_pillar_v1_0_d.packet.requiredsize = function(buffer)
...
local function omi_nyse_arca_options_complexfeed_pillar_v1_0_d_heuristic(buffer, packet, parent)
  ...
  if not nyse_arca_options_complexfeed_pillar_v1_0_d.packet.requiredsize(buffer) then return false end
