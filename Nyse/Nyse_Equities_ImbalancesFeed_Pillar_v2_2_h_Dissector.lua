...
nyse_equities_imbalancesfeed_pillar_v2_2_h_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    ...
    parent = parent:add(nyse_equities_imbalancesfeed_pillar_v2_2_h.fields.message, range, display)
  end
...
nyse_equities_imbalancesfeed_pillar_v2_2_h_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index = nyse_equities_imbalancesfeed_pillar_v2_2_h_dissect.message(buffer, index, packet, parent, message_size)
  end
