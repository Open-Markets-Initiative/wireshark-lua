...
nyse_options_commonclient_pillar_v2_6_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  ...
  -- Payload: 0 Byte
  index = nyse_options_commonclient_pillar_v2_6_dissect.payload(buffer, index, packet, parent, size_of_payload)
...
nyse_options_commonclient_pillar_v2_6_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index = nyse_options_commonclient_pillar_v2_6_dissect.message(buffer, index, packet, parent, message_size)
  end
