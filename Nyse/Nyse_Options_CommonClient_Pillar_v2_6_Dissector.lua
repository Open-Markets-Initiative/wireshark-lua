...
omi_nyse_options_commonclient_pillar_v2_6.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nyse_options_commonclient_pillar_v2_6.prefs_changed()
  ...
  if show.message_index ~= omi_nyse_options_commonclient_pillar_v2_6.prefs.show_message_index then
    show.message_index = omi_nyse_options_commonclient_pillar_v2_6.prefs.show_message_index
  end
end
...
nyse_options_commonclient_pillar_v2_6.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = nyse_options_commonclient_pillar_v2_6.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
