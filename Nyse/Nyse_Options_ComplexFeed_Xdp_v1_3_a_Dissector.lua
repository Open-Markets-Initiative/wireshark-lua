...
nyse_options_complexfeed_xdp_v1_3_a.complex_symbol_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.complex_symbol_definition_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nyse_options_complexfeed_xdp_v1_3_a.fields.complex_symbol_definition_message, buffer(offset, 0))
    local index = nyse_options_complexfeed_xdp_v1_3_a.complex_symbol_definition_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nyse_options_complexfeed_xdp_v1_3_a.complex_symbol_definition_message.display(packet, parent, length)
    parent:append_text(display)
...
nyse_options_complexfeed_xdp_v1_3_a.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset
...
-- Dissect: Message
nyse_options_complexfeed_xdp_v1_3_a.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_nyse_options_complexfeed_xdp_v1_3_a.fields.message, buffer(offset, 0))
    local current = nyse_options_complexfeed_xdp_v1_3_a.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    nyse_options_complexfeed_xdp_v1_3_a.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
nyse_options_complexfeed_xdp_v1_3_a.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = nyse_options_complexfeed_xdp_v1_3_a.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
