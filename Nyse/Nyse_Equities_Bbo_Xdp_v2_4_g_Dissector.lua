...
omi_nyse_equities_bbo_xdp_v2_4_g.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nyse_equities_bbo_xdp_v2_4_g.prefs_changed()
  ...
  if show.message_index ~= omi_nyse_equities_bbo_xdp_v2_4_g.prefs.show_message_index then
    show.message_index = omi_nyse_equities_bbo_xdp_v2_4_g.prefs.show_message_index
  end
end
...
nyse_equities_bbo_xdp_v2_4_g.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset
...
-- Dissect: Message
nyse_equities_bbo_xdp_v2_4_g.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_nyse_equities_bbo_xdp_v2_4_g.fields.message, buffer(offset, 0))
    local current = nyse_equities_bbo_xdp_v2_4_g.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    nyse_equities_bbo_xdp_v2_4_g.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
nyse_equities_bbo_xdp_v2_4_g.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = nyse_equities_bbo_xdp_v2_4_g.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
