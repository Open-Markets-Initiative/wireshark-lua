...
-- Nyse Arca Bbo Xdp 2.4.c Protocol
local nyse_arca_bbo_xdp_v2_4_c = Proto("Nyse.Arca.Bbo.Xdp.v2.4.c.Lua", "Nyse Arca Bbo Xdp 2.4.c")
...
-- Nyse Arca Bbo Xdp 2.4.c Fields
nyse_arca_bbo_xdp_v2_4_c.fields.ask_price = ProtoField.new("Ask Price", "nyse.arca.bbo.xdp.v2.4.c.askprice", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.ask_volume = ProtoField.new("Ask Volume", "nyse.arca.bbo.xdp.v2.4.c.askvolume", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.begin_seq_num = ProtoField.new("Begin Seq Num", "nyse.arca.bbo.xdp.v2.4.c.beginseqnum", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.bid_price = ProtoField.new("Bid Price", "nyse.arca.bbo.xdp.v2.4.c.bidprice", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.bid_volume = ProtoField.new("Bid Volume", "nyse.arca.bbo.xdp.v2.4.c.bidvolume", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.channel_id = ProtoField.new("Channel Id", "nyse.arca.bbo.xdp.v2.4.c.channelid", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.current_refresh_pkt = ProtoField.new("Current Refresh Pkt", "nyse.arca.bbo.xdp.v2.4.c.currentrefreshpkt", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.delivery_flag = ProtoField.new("Delivery Flag", "nyse.arca.bbo.xdp.v2.4.c.deliveryflag", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.end_seq_num = ProtoField.new("End Seq Num", "nyse.arca.bbo.xdp.v2.4.c.endseqnum", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.exchange_code = ProtoField.new("Exchange Code", "nyse.arca.bbo.xdp.v2.4.c.exchangecode", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.halt_condition = ProtoField.new("Halt Condition", "nyse.arca.bbo.xdp.v2.4.c.haltcondition", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.heartbeat_response_message = ProtoField.new("Heartbeat Response Message", "nyse.arca.bbo.xdp.v2.4.c.heartbeatresponsemessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.id = ProtoField.new("Id", "nyse.arca.bbo.xdp.v2.4.c.id", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.last_seq_num = ProtoField.new("Last Seq Num", "nyse.arca.bbo.xdp.v2.4.c.lastseqnum", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.last_symbol_seq_num = ProtoField.new("Last Symbol Seq Num", "nyse.arca.bbo.xdp.v2.4.c.lastsymbolseqnum", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.lot_size = ProtoField.new("Lot Size", "nyse.arca.bbo.xdp.v2.4.c.lotsize", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.market_id = ProtoField.new("Market Id", "nyse.arca.bbo.xdp.v2.4.c.marketid", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.market_state = ProtoField.new("Market State", "nyse.arca.bbo.xdp.v2.4.c.marketstate", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.message = ProtoField.new("Message", "nyse.arca.bbo.xdp.v2.4.c.message", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.message_count = ProtoField.new("Message Count", "nyse.arca.bbo.xdp.v2.4.c.messagecount", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.message_header = ProtoField.new("Message Header", "nyse.arca.bbo.xdp.v2.4.c.messageheader", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.message_size = ProtoField.new("Message Size", "nyse.arca.bbo.xdp.v2.4.c.messagesize", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.message_type = ProtoField.new("Message Type", "nyse.arca.bbo.xdp.v2.4.c.messagetype", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.message_unavailable_message = ProtoField.new("Message Unavailable Message", "nyse.arca.bbo.xdp.v2.4.c.messageunavailablemessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.mpv = ProtoField.new("Mpv", "nyse.arca.bbo.xdp.v2.4.c.mpv", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.nanoseconds = ProtoField.new("Nanoseconds", "nyse.arca.bbo.xdp.v2.4.c.nanoseconds", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.next_source_seq_num = ProtoField.new("Next Source Seq Num", "nyse.arca.bbo.xdp.v2.4.c.nextsourceseqnum", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.packet = ProtoField.new("Packet", "nyse.arca.bbo.xdp.v2.4.c.packet", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.packet_header = ProtoField.new("Packet Header", "nyse.arca.bbo.xdp.v2.4.c.packetheader", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.packet_size = ProtoField.new("Packet Size", "nyse.arca.bbo.xdp.v2.4.c.packetsize", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.payload = ProtoField.new("Payload", "nyse.arca.bbo.xdp.v2.4.c.payload", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.prev_close_price = ProtoField.new("Prev Close Price", "nyse.arca.bbo.xdp.v2.4.c.prevcloseprice", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.prev_close_volume = ProtoField.new("Prev Close Volume", "nyse.arca.bbo.xdp.v2.4.c.prevclosevolume", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.price_resolution = ProtoField.new("Price Resolution", "nyse.arca.bbo.xdp.v2.4.c.priceresolution", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.price_scale_code = ProtoField.new("Price Scale Code", "nyse.arca.bbo.xdp.v2.4.c.pricescalecode", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.price1 = ProtoField.new("Price1", "nyse.arca.bbo.xdp.v2.4.c.price1", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.price2 = ProtoField.new("Price2", "nyse.arca.bbo.xdp.v2.4.c.price2", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.product_id = ProtoField.new("Product Id", "nyse.arca.bbo.xdp.v2.4.c.productid", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.quote_condition = ProtoField.new("Quote Condition", "nyse.arca.bbo.xdp.v2.4.c.quotecondition", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.quote_message = ProtoField.new("Quote Message", "nyse.arca.bbo.xdp.v2.4.c.quotemessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.refresh_header_message = ProtoField.new("Refresh Header Message", "nyse.arca.bbo.xdp.v2.4.c.refreshheadermessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.refresh_request_message = ProtoField.new("Refresh Request Message", "nyse.arca.bbo.xdp.v2.4.c.refreshrequestmessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.request_response_message = ProtoField.new("Request Response Message", "nyse.arca.bbo.xdp.v2.4.c.requestresponsemessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.request_seq_num = ProtoField.new("Request Seq Num", "nyse.arca.bbo.xdp.v2.4.c.requestseqnum", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.reserved1 = ProtoField.new("Reserved1", "nyse.arca.bbo.xdp.v2.4.c.reserved1", ftypes.BYTES)
nyse_arca_bbo_xdp_v2_4_c.fields.reserved2 = ProtoField.new("Reserved2", "nyse.arca.bbo.xdp.v2.4.c.reserved2", ftypes.BYTES)
nyse_arca_bbo_xdp_v2_4_c.fields.reserved4 = ProtoField.new("Reserved4", "nyse.arca.bbo.xdp.v2.4.c.reserved4", ftypes.BYTES)
nyse_arca_bbo_xdp_v2_4_c.fields.retransmission_request_message = ProtoField.new("Retransmission Request Message", "nyse.arca.bbo.xdp.v2.4.c.retransmissionrequestmessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.retransmit_method = ProtoField.new("Retransmit Method", "nyse.arca.bbo.xdp.v2.4.c.retransmitmethod", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.round_lot = ProtoField.new("Round Lot", "nyse.arca.bbo.xdp.v2.4.c.roundlot", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.rp_i_indicator = ProtoField.new("Rp I Indicator", "nyse.arca.bbo.xdp.v2.4.c.rpiindicator", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.security_status = ProtoField.new("Security Status", "nyse.arca.bbo.xdp.v2.4.c.securitystatus", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.security_status_message = ProtoField.new("Security Status Message", "nyse.arca.bbo.xdp.v2.4.c.securitystatusmessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.security_type = ProtoField.new("Security Type", "nyse.arca.bbo.xdp.v2.4.c.securitytype", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.sequence_number = ProtoField.new("Sequence Number", "nyse.arca.bbo.xdp.v2.4.c.sequencenumber", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.sequence_number_reset_message = ProtoField.new("Sequence Number Reset Message", "nyse.arca.bbo.xdp.v2.4.c.sequencenumberresetmessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.session_state = ProtoField.new("Session State", "nyse.arca.bbo.xdp.v2.4.c.sessionstate", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.source_id = ProtoField.new("Source Id", "nyse.arca.bbo.xdp.v2.4.c.sourceid", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.source_time = ProtoField.new("Source Time", "nyse.arca.bbo.xdp.v2.4.c.sourcetime", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.source_time_ns = ProtoField.new("Source Time Ns", "nyse.arca.bbo.xdp.v2.4.c.sourcetimens", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.source_time_reference_message = ProtoField.new("Source Time Reference Message", "nyse.arca.bbo.xdp.v2.4.c.sourcetimereferencemessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.ss_r_state = ProtoField.new("Ss R State", "nyse.arca.bbo.xdp.v2.4.c.ssrstate", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.ss_r_triggering_exchange_id = ProtoField.new("Ss R Triggering Exchange Id", "nyse.arca.bbo.xdp.v2.4.c.ssrtriggeringexchangeid", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.ss_r_triggering_volume = ProtoField.new("Ss R Triggering Volume", "nyse.arca.bbo.xdp.v2.4.c.ssrtriggeringvolume", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.status = ProtoField.new("Status", "nyse.arca.bbo.xdp.v2.4.c.status", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.symbol = ProtoField.new("Symbol", "nyse.arca.bbo.xdp.v2.4.c.symbol", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.symbol_clear_message = ProtoField.new("Symbol Clear Message", "nyse.arca.bbo.xdp.v2.4.c.symbolclearmessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.symbol_index = ProtoField.new("Symbol Index", "nyse.arca.bbo.xdp.v2.4.c.symbolindex", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.symbol_index_mapping_message = ProtoField.new("Symbol Index Mapping Message", "nyse.arca.bbo.xdp.v2.4.c.symbolindexmappingmessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.symbol_index_mapping_request_message = ProtoField.new("Symbol Index Mapping Request Message", "nyse.arca.bbo.xdp.v2.4.c.symbolindexmappingrequestmessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.symbol_seq_num = ProtoField.new("Symbol Seq Num", "nyse.arca.bbo.xdp.v2.4.c.symbolseqnum", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.system_id = ProtoField.new("System Id", "nyse.arca.bbo.xdp.v2.4.c.systemid", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.time = ProtoField.new("Time", "nyse.arca.bbo.xdp.v2.4.c.time", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.timestamp = ProtoField.new("Timestamp", "nyse.arca.bbo.xdp.v2.4.c.timestamp", ftypes.UINT32)
nyse_arca_bbo_xdp_v2_4_c.fields.total_refresh_pkts = ProtoField.new("Total Refresh Pkts", "nyse.arca.bbo.xdp.v2.4.c.totalrefreshpkts", ftypes.UINT16)
nyse_arca_bbo_xdp_v2_4_c.fields.trading_session = ProtoField.new("Trading Session", "nyse.arca.bbo.xdp.v2.4.c.tradingsession", ftypes.UINT8)
nyse_arca_bbo_xdp_v2_4_c.fields.trading_session_change_message = ProtoField.new("Trading Session Change Message", "nyse.arca.bbo.xdp.v2.4.c.tradingsessionchangemessage", ftypes.STRING)
nyse_arca_bbo_xdp_v2_4_c.fields.unit_of_trade = ProtoField.new("Unit Of Trade", "nyse.arca.bbo.xdp.v2.4.c.unitoftrade", ftypes.UINT16)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Nyse Arca Bbo Xdp 2.4.c Element Dissection Options
...
-- Register Nyse Arca Bbo Xdp 2.4.c Show Options
nyse_arca_bbo_xdp_v2_4_c.prefs.show_heartbeat_response_message = Pref.bool("Show Heartbeat Response Message", show.heartbeat_response_message, "Parse and add Heartbeat Response Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_message_unavailable_message = Pref.bool("Show Message Unavailable Message", show.message_unavailable_message, "Parse and add Message Unavailable Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_quote_message = Pref.bool("Show Quote Message", show.quote_message, "Parse and add Quote Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_refresh_header_message = Pref.bool("Show Refresh Header Message", show.refresh_header_message, "Parse and add Refresh Header Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_refresh_request_message = Pref.bool("Show Refresh Request Message", show.refresh_request_message, "Parse and add Refresh Request Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_request_response_message = Pref.bool("Show Request Response Message", show.request_response_message, "Parse and add Request Response Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_retransmission_request_message = Pref.bool("Show Retransmission Request Message", show.retransmission_request_message, "Parse and add Retransmission Request Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_security_status_message = Pref.bool("Show Security Status Message", show.security_status_message, "Parse and add Security Status Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_sequence_number_reset_message = Pref.bool("Show Sequence Number Reset Message", show.sequence_number_reset_message, "Parse and add Sequence Number Reset Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_source_time_reference_message = Pref.bool("Show Source Time Reference Message", show.source_time_reference_message, "Parse and add Source Time Reference Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_clear_message = Pref.bool("Show Symbol Clear Message", show.symbol_clear_message, "Parse and add Symbol Clear Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_index_mapping_message = Pref.bool("Show Symbol Index Mapping Message", show.symbol_index_mapping_message, "Parse and add Symbol Index Mapping Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_index_mapping_request_message = Pref.bool("Show Symbol Index Mapping Request Message", show.symbol_index_mapping_request_message, "Parse and add Symbol Index Mapping Request Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_trading_session_change_message = Pref.bool("Show Trading Session Change Message", show.trading_session_change_message, "Parse and add Trading Session Change Message to protocol tree")
nyse_arca_bbo_xdp_v2_4_c.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function nyse_arca_bbo_xdp_v2_4_c.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.heartbeat_response_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_heartbeat_response_message then
    show.heartbeat_response_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_heartbeat_response_message
    changed = true
  end
  if show.message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_message then
    show.message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_message
    changed = true
  end
  if show.message_header ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_message_header then
    show.message_header = nyse_arca_bbo_xdp_v2_4_c.prefs.show_message_header
    changed = true
  end
  if show.message_unavailable_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_message_unavailable_message then
    show.message_unavailable_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_message_unavailable_message
    changed = true
  end
  if show.packet ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_packet then
    show.packet = nyse_arca_bbo_xdp_v2_4_c.prefs.show_packet
    changed = true
  end
  if show.packet_header ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_packet_header then
    show.packet_header = nyse_arca_bbo_xdp_v2_4_c.prefs.show_packet_header
    changed = true
  end
  if show.quote_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_quote_message then
    show.quote_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_quote_message
    changed = true
  end
  if show.refresh_header_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_refresh_header_message then
    show.refresh_header_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_refresh_header_message
    changed = true
  end
  if show.refresh_request_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_refresh_request_message then
    show.refresh_request_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_refresh_request_message
    changed = true
  end
  if show.request_response_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_request_response_message then
    show.request_response_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_request_response_message
    changed = true
  end
  if show.retransmission_request_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_retransmission_request_message then
    show.retransmission_request_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_retransmission_request_message
    changed = true
  end
  if show.security_status_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_security_status_message then
    show.security_status_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_security_status_message
    changed = true
  end
  if show.sequence_number_reset_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_sequence_number_reset_message then
    show.sequence_number_reset_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_sequence_number_reset_message
    changed = true
  end
  if show.source_time_reference_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_source_time_reference_message then
    show.source_time_reference_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_source_time_reference_message
    changed = true
  end
  if show.symbol_clear_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_clear_message then
    show.symbol_clear_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_clear_message
    changed = true
  end
  if show.symbol_index_mapping_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_index_mapping_message then
    show.symbol_index_mapping_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_index_mapping_message
    changed = true
  end
  if show.symbol_index_mapping_request_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_index_mapping_request_message then
    show.symbol_index_mapping_request_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_symbol_index_mapping_request_message
    changed = true
  end
  if show.trading_session_change_message ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_trading_session_change_message then
    show.trading_session_change_message = nyse_arca_bbo_xdp_v2_4_c.prefs.show_trading_session_change_message
    changed = true
  end
  if show.payload ~= nyse_arca_bbo_xdp_v2_4_c.prefs.show_payload then
    show.payload = nyse_arca_bbo_xdp_v2_4_c.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Nyse Arca Bbo Xdp 2.4.c
-----------------------------------------------------------------------
...
dissect.reserved4 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.reserved4, range, value, display)
...
display.rp_i_indicator = function(value)
  ...
  if value == "A" then
    return "Rp I Indicator: Retail Interest On Bid Side (A)"
  end
  if value == "B" then
    return "Rp I Indicator: Retail Interest On Offer Side (B)"
  end
  if value == "C" then
    return "Rp I Indicator: Retail Interest On The Bid And Offer Side (C)"
  end
...
dissect.rp_i_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.rp_i_indicator, range, value, display)
...
dissect.quote_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.quote_condition, range, value, display)
...
dissect.bid_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.bid_volume, range, value, display)
...
dissect.bid_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.bid_price, range, value, display)
...
dissect.ask_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.ask_volume, range, value, display)
...
dissect.ask_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.ask_price, range, value, display)
...
dissect.symbol_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.symbol_seq_num, range, value, display)
...
dissect.symbol_index = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.symbol_index, range, value, display)
...
dissect.source_time_ns = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.source_time_ns, range, value, display)
...
dissect.quote_message = function(buffer, offset, packet, parent)
  ...
  if show.quote_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.quote_message, range, display)
  end
...
dissect.last_symbol_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.last_symbol_seq_num, range, value, display)
...
dissect.last_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.last_seq_num, range, value, display)
...
dissect.total_refresh_pkts = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.total_refresh_pkts, range, value, display)
...
dissect.current_refresh_pkt = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.current_refresh_pkt, range, value, display)
...
dissect.refresh_header_message = function(buffer, offset, packet, parent)
  ...
  if show.refresh_header_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.refresh_header_message, range, display)
  end
...
dissect.session_state = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.session_state, range, value, display)
...
dissect.market_state = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.market_state, range, value, display)
...
dissect.ss_r_state = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.ss_r_state, range, value, display)
...
dissect.time = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.time, range, value, display)
...
dissect.ss_r_triggering_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.ss_r_triggering_volume, range, value, display)
...
dissect.ss_r_triggering_exchange_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.ss_r_triggering_exchange_id, range, value, display)
...
dissect.price2 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.price2, range, value, display)
...
dissect.price1 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.price1, range, value, display)
...
dissect.halt_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.halt_condition, range, value, display)
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.security_status, range, value, display)
...
dissect.source_time = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.source_time, range, value, display)
...
dissect.security_status_message = function(buffer, offset, packet, parent)
  ...
  if show.security_status_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.security_status_message, range, display)
  end
...
dissect.trading_session = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.trading_session, range, value, display)
...
dissect.trading_session_change_message = function(buffer, offset, packet, parent)
  ...
  if show.trading_session_change_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.trading_session_change_message, range, display)
  end
...
dissect.next_source_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.next_source_seq_num, range, value, display)
...
dissect.symbol_clear_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_clear_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.symbol_clear_message, range, display)
  end
...
dissect.channel_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.channel_id, range, value, display)
...
dissect.product_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.product_id, range, value, display)
...
dissect.end_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.end_seq_num, range, value, display)
...
dissect.begin_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.begin_seq_num, range, value, display)
...
dissect.message_unavailable_message = function(buffer, offset, packet, parent)
  ...
  if show.message_unavailable_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.message_unavailable_message, range, display)
  end
...
dissect.source_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.source_id, range, value, display)
...
dissect.refresh_request_message = function(buffer, offset, packet, parent)
  ...
  if show.refresh_request_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.refresh_request_message, range, display)
  end
...
dissect.retransmit_method = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.retransmit_method, range, value, display)
...
dissect.symbol_index_mapping_request_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_index_mapping_request_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.symbol_index_mapping_request_message, range, display)
  end
...
dissect.heartbeat_response_message = function(buffer, offset, packet, parent)
  ...
  if show.heartbeat_response_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.heartbeat_response_message, range, display)
  end
...
dissect.status = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.status, range, value, display)
...
dissect.request_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.request_seq_num, range, value, display)
...
dissect.request_response_message = function(buffer, offset, packet, parent)
  ...
  if show.request_response_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.request_response_message, range, display)
  end
...
dissect.retransmission_request_message = function(buffer, offset, packet, parent)
  ...
  if show.retransmission_request_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.retransmission_request_message, range, display)
  end
...
dissect.reserved2 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.reserved2, range, value, display)
...
dissect.unit_of_trade = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.unit_of_trade, range, value, display)
...
dissect.mpv = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.mpv, range, value, display)
...
dissect.round_lot = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.round_lot, range, value, display)
...
dissect.price_resolution = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.price_resolution, range, value, display)
...
dissect.prev_close_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.prev_close_volume, range, value, display)
...
dissect.prev_close_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.prev_close_price, range, value, display)
...
dissect.lot_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.lot_size, range, value, display)
...
dissect.security_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.security_type, range, value, display)
...
dissect.price_scale_code = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.price_scale_code, range, value, display)
...
dissect.exchange_code = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.exchange_code, range, value, display)
...
dissect.system_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.system_id, range, value, display)
...
dissect.market_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.market_id, range, value, display)
...
dissect.reserved1 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.reserved1, range, value, display)
...
dissect.symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.symbol, range, value, display)
...
dissect.symbol_index_mapping_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_index_mapping_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.symbol_index_mapping_message, range, display)
  end
...
dissect.id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.id, range, value, display)
...
dissect.source_time_reference_message = function(buffer, offset, packet, parent)
  ...
  if show.source_time_reference_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.source_time_reference_message, range, display)
  end
...
dissect.sequence_number_reset_message = function(buffer, offset, packet, parent)
  ...
  if show.sequence_number_reset_message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.sequence_number_reset_message, range, display)
  end
...
dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.message_type, range, value, display)
...
dissect.message_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.message_size, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.message_header, range, display)
  end
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.message, range, display)
  end
...
dissect.nanoseconds = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.nanoseconds, range, value, display)
...
dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.timestamp, range, value, display)
...
dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.sequence_number, range, value, display)
...
dissect.message_count = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.message_count, range, value, display)
...
dissect.delivery_flag = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.delivery_flag, range, value, display)
...
dissect.packet_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.packet_size, range, value, display)
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    ...
    parent = parent:add(nyse_arca_bbo_xdp_v2_4_c.fields.packet_header, range, display)
  end
...
function nyse_arca_bbo_xdp_v2_4_c.init()
end

-- Dissector for Nyse Arca Bbo Xdp 2.4.c
function nyse_arca_bbo_xdp_v2_4_c.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = nyse_arca_bbo_xdp_v2_4_c.name

  -- Dissect protocol
  local protocol = parent:add(nyse_arca_bbo_xdp_v2_4_c, buffer(), nyse_arca_bbo_xdp_v2_4_c.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, nyse_arca_bbo_xdp_v2_4_c)
...
verify.nyse_arca_bbo_xdp_v2_4_c_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Nyse Arca Bbo Xdp 2.4.c
local function nyse_arca_bbo_xdp_v2_4_c_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.nyse_arca_bbo_xdp_v2_4_c_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = nyse_arca_bbo_xdp_v2_4_c
  nyse_arca_bbo_xdp_v2_4_c.dissector(buffer, packet, parent)

  return true
end

-- Register Nyse Arca Bbo Xdp 2.4.c Heuristic
nyse_arca_bbo_xdp_v2_4_c:register_heuristic("udp", nyse_arca_bbo_xdp_v2_4_c_heuristic)
