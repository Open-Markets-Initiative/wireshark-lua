...
-- Size: Trade Cond 4
size_of.trade_cond_4 = 1

-- Display: Trade Cond 4
display.trade_cond_4 = function(value)
  if value == " " then
...
dissect.trade_cond_4 = function(buffer, offset, packet, parent)
  local length = size_of.trade_cond_4
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.trade_cond_4(value, buffer, offset, packet, parent)
...
-- Size: Trade Cond 3
size_of.trade_cond_3 = 1

-- Display: Trade Cond 3
display.trade_cond_3 = function(value)
  if value == " " then
...
dissect.trade_cond_3 = function(buffer, offset, packet, parent)
  local length = size_of.trade_cond_3
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.trade_cond_3(value, buffer, offset, packet, parent)
...
size_of.non_displayed_trade_message = function(buffer, offset)
  ...
  index = index + size_of.trade_cond_3

  index = index + size_of.trade_cond_4
...
dissect.non_displayed_trade_message_fields = function(buffer, offset, packet, parent)
  ...
  index, trade_cond_3 = dissect.trade_cond_3(buffer, index, packet, parent)

  -- Trade Cond 4: 1 Byte Ascii String Enum with 3 values
  index, trade_cond_4 = dissect.trade_cond_4(buffer, index, packet, parent)
...
-- Size: Reserved 11
size_of.reserved_11 = 1

-- Display: Reserved 11
display.reserved_11 = function(value)
  return "Reserved 11: "..value
end

-- Dissect: Reserved 11
dissect.reserved_11 = function(buffer, offset, packet, parent)
  local length = size_of.reserved_11
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = display.reserved_11(value, buffer, offset, packet, parent)
...
size_of.add_order_refresh_message = function(buffer, offset)
  ...
  index = index + size_of.reserved_11
...
dissect.add_order_refresh_message_fields = function(buffer, offset, packet, parent)
  ...
  -- Reserved 11: 1 Byte
  index, reserved_11 = dissect.reserved_11(buffer, index, packet, parent)
