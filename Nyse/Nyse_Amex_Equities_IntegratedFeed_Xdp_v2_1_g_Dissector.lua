...
nyse_amex_equities_integratedfeed_xdp_v2_1_g_dissect.message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
nyse_amex_equities_integratedfeed_xdp_v2_1_g_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    index = nyse_amex_equities_integratedfeed_xdp_v2_1_g_dissect.message(buffer, index, packet, parent)
  end
