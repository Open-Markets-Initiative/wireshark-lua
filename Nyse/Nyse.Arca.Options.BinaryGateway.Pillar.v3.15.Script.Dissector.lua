...
nyse_arca_options_binarygateway_pillar_v3_15.fields.order_instructions = ProtoField.new("Order Instructions", "nyse.arca.options.binarygateway.pillar.v3.15.orderinstructions", ftypes.BYTES)
...
nyse_arca_options_binarygateway_pillar_v3_15.fields.side = ProtoField.new("Side", "nyse.arca.options.binarygateway.pillar.v3.15.side", ftypes.UINT8)
...
-- Size: Side
nyse_arca_options_binarygateway_pillar_v3_15_size_of.side = 1

-- Display: Side
nyse_arca_options_binarygateway_pillar_v3_15_display.side = function(value)
  if value == 1 then
    return "Side: Buy (1)"
  end
  if value == 2 then
...
-- Dissect: Side
nyse_arca_options_binarygateway_pillar_v3_15_dissect.side = function(buffer, offset, packet, parent)
  local length = nyse_arca_options_binarygateway_pillar_v3_15_size_of.side
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = nyse_arca_options_binarygateway_pillar_v3_15_display.side(value, buffer, offset, packet, parent)

  parent:add(nyse_arca_options_binarygateway_pillar_v3_15.fields.side, range, value, display)
...
nyse_arca_options_binarygateway_pillar_v3_15_size_of.complex_series_request_acknowledgement = function(buffer, offset)
  ...
  index = index + nyse_arca_options_binarygateway_pillar_v3_15_size_of.side
...
nyse_arca_options_binarygateway_pillar_v3_15_dissect.complex_series_request_acknowledgement_fields = function(buffer, offset, packet, parent)
  ...
  index, side = nyse_arca_options_binarygateway_pillar_v3_15_dissect.side(buffer, index, packet, parent)
...
nyse_arca_options_binarygateway_pillar_v3_15_size_of.order_instructions = 16

-- Display: Order Instructions
nyse_arca_options_binarygateway_pillar_v3_15_display.order_instructions = function(value)
...
nyse_arca_options_binarygateway_pillar_v3_15_dissect.order_instructions = function(buffer, offset, packet, parent)
  local length = nyse_arca_options_binarygateway_pillar_v3_15_size_of.order_instructions
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = nyse_arca_options_binarygateway_pillar_v3_15_display.order_instructions(value, buffer, offset, packet, parent)

  parent:add(nyse_arca_options_binarygateway_pillar_v3_15.fields.order_instructions, range, value, display)
