...
local nyse_bqt_xdp_2_1_a = Proto("Nyse.Bqt.Xdp.2.1.a.Lua", "Nyse Bqt Xdp 2.1.a")
...
nyse_bqt_xdp_2_1_a.fields.ask_price = ProtoField.new("Ask Price", "nyse.bqt.xdp.2.1.a.askprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.ask_quote_condition = ProtoField.new("Ask Quote Condition", "nyse.bqt.xdp.2.1.a.askquotecondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.ask_volume = ProtoField.new("Ask Volume", "nyse.bqt.xdp.2.1.a.askvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.beginseqnum = ProtoField.new("BeginSeqNum", "nyse.bqt.xdp.2.1.a.beginseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.bid_price = ProtoField.new("Bid Price", "nyse.bqt.xdp.2.1.a.bidprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.bid_quote_condition = ProtoField.new("Bid Quote Condition", "nyse.bqt.xdp.2.1.a.bidquotecondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.bid_volume = ProtoField.new("Bid Volume", "nyse.bqt.xdp.2.1.a.bidvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.bqt_message = ProtoField.new("BQT Message", "nyse.bqt.xdp.2.1.a.bqtmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.channelid = ProtoField.new("ChannelID", "nyse.bqt.xdp.2.1.a.channelid", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.close_price = ProtoField.new("Close Price", "nyse.bqt.xdp.2.1.a.closeprice", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.closing_price = ProtoField.new("Closing Price", "nyse.bqt.xdp.2.1.a.closingprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.complete = ProtoField.new("Complete", "nyse.bqt.xdp.2.1.a.complete", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.consolidated_security_status_message = ProtoField.new("Consolidated Security Status Message", "nyse.bqt.xdp.2.1.a.consolidatedsecuritystatusmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_single_sided_quote_message = ProtoField.new("Consolidated Single-Sided Quote Message", "nyse.bqt.xdp.2.1.a.consolidatedsinglesidedquotemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_stock_summary_message = ProtoField.new("Consolidated Stock Summary Message", "nyse.bqt.xdp.2.1.a.consolidatedstocksummarymessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_symbol_clear_message = ProtoField.new("Consolidated Symbol Clear Message", "nyse.bqt.xdp.2.1.a.consolidatedsymbolclearmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trade_cancel_message = ProtoField.new("Consolidated Trade Cancel Message", "nyse.bqt.xdp.2.1.a.consolidatedtradecancelmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trade_correction_message = ProtoField.new("Consolidated Trade Correction Message", "nyse.bqt.xdp.2.1.a.consolidatedtradecorrectionmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trade_message = ProtoField.new("Consolidated Trade Message", "nyse.bqt.xdp.2.1.a.consolidatedtrademessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trading_session_change_message = ProtoField.new("Consolidated Trading Session Change Message", "nyse.bqt.xdp.2.1.a.consolidatedtradingsessionchangemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_volume_message = ProtoField.new("Consolidated Volume Message", "nyse.bqt.xdp.2.1.a.consolidatedvolumemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.currentrefreshpkt = ProtoField.new("CurrentRefreshPkt", "nyse.bqt.xdp.2.1.a.currentrefreshpkt", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.delivery_flag = ProtoField.new("Delivery Flag", "nyse.bqt.xdp.2.1.a.deliveryflag", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.endseqnum = ProtoField.new("EndSeqNum", "nyse.bqt.xdp.2.1.a.endseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.exchange_code = ProtoField.new("Exchange Code", "nyse.bqt.xdp.2.1.a.exchangecode", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.halt_condition = ProtoField.new("Halt Condition", "nyse.bqt.xdp.2.1.a.haltcondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.heartbeat_response_message = ProtoField.new("Heartbeat Response Message", "nyse.bqt.xdp.2.1.a.heartbeatresponsemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.high_price = ProtoField.new("High Price", "nyse.bqt.xdp.2.1.a.highprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.lastseqnum = ProtoField.new("LastSeqNum", "nyse.bqt.xdp.2.1.a.lastseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.lastsymbolseqnum = ProtoField.new("LastSymbolSeqNum", "nyse.bqt.xdp.2.1.a.lastsymbolseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.lot_size = ProtoField.new("Lot Size", "nyse.bqt.xdp.2.1.a.lotsize", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.low_price = ProtoField.new("Low Price", "nyse.bqt.xdp.2.1.a.lowprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.market_id = ProtoField.new("Market ID", "nyse.bqt.xdp.2.1.a.marketid", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_best_ask = ProtoField.new("Market ID of Best Ask", "nyse.bqt.xdp.2.1.a.marketidofbestask", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_best_bid = ProtoField.new("Market ID of Best Bid", "nyse.bqt.xdp.2.1.a.marketidofbestbid", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_high_price = ProtoField.new("Market ID of High Price", "nyse.bqt.xdp.2.1.a.marketidofhighprice", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_low_price = ProtoField.new("Market ID of Low Price", "nyse.bqt.xdp.2.1.a.marketidoflowprice", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_open_price = ProtoField.new("Market ID of Open Price", "nyse.bqt.xdp.2.1.a.marketidofopenprice", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_the_close = ProtoField.new("Market ID of the Close", "nyse.bqt.xdp.2.1.a.marketidoftheclose", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.marketstate = ProtoField.new("MarketState", "nyse.bqt.xdp.2.1.a.marketstate", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.message = ProtoField.new("Message", "nyse.bqt.xdp.2.1.a.message", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.message_count = ProtoField.new("Message Count", "nyse.bqt.xdp.2.1.a.messagecount", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.message_header = ProtoField.new("Message Header", "nyse.bqt.xdp.2.1.a.messageheader", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.message_size = ProtoField.new("Message Size", "nyse.bqt.xdp.2.1.a.messagesize", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.message_type = ProtoField.new("Message Type", "nyse.bqt.xdp.2.1.a.messagetype", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.message_unavailable_message = ProtoField.new("Message Unavailable Message", "nyse.bqt.xdp.2.1.a.messageunavailablemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.mpv = ProtoField.new("MPV", "nyse.bqt.xdp.2.1.a.mpv", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.nanoseconds = ProtoField.new("Nanoseconds", "nyse.bqt.xdp.2.1.a.nanoseconds", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.nextsourceseqnum = ProtoField.new("NextSourceSeqNum", "nyse.bqt.xdp.2.1.a.nextsourceseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.number_of_close_prices = ProtoField.new("Number Of Close Prices", "nyse.bqt.xdp.2.1.a.numberofcloseprices", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.ok_for_late_hours = ProtoField.new("Ok for late hours", "nyse.bqt.xdp.2.1.a.okforlatehours", ftypes.UINT8, nil, base.DEC, "0x04")
nyse_bqt_xdp_2_1_a.fields.ok_for_morning_hours = ProtoField.new("Ok for morning hours", "nyse.bqt.xdp.2.1.a.okformorninghours", ftypes.UINT8, nil, base.DEC, "0x01")
nyse_bqt_xdp_2_1_a.fields.ok_for_national_hours = ProtoField.new("Ok for national hours", "nyse.bqt.xdp.2.1.a.okfornationalhours", ftypes.UINT8, nil, base.DEC, "0x02")
nyse_bqt_xdp_2_1_a.fields.open = ProtoField.new("Open", "nyse.bqt.xdp.2.1.a.open", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.original_trade_id = ProtoField.new("Original Trade ID", "nyse.bqt.xdp.2.1.a.originaltradeid", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.packet = ProtoField.new("Packet", "nyse.bqt.xdp.2.1.a.packet", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.packet_header = ProtoField.new("Packet Header", "nyse.bqt.xdp.2.1.a.packetheader", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.packet_size = ProtoField.new("Packet Size", "nyse.bqt.xdp.2.1.a.packetsize", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.payload = ProtoField.new("Payload", "nyse.bqt.xdp.2.1.a.payload", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.prevcloseprice = ProtoField.new("PrevClosePrice", "nyse.bqt.xdp.2.1.a.prevcloseprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.prevclosevolume = ProtoField.new("PrevCloseVolume", "nyse.bqt.xdp.2.1.a.prevclosevolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price = ProtoField.new("Price", "nyse.bqt.xdp.2.1.a.price", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price_1 = ProtoField.new("Price 1", "nyse.bqt.xdp.2.1.a.price1", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price_2 = ProtoField.new("Price 2", "nyse.bqt.xdp.2.1.a.price2", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price_resolution = ProtoField.new("Price Resolution", "nyse.bqt.xdp.2.1.a.priceresolution", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.pricescalecode = ProtoField.new("PriceScaleCode", "nyse.bqt.xdp.2.1.a.pricescalecode", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.productid = ProtoField.new("ProductID", "nyse.bqt.xdp.2.1.a.productid", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.quote_condition = ProtoField.new("Quote Condition", "nyse.bqt.xdp.2.1.a.quotecondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.reason = ProtoField.new("Reason", "nyse.bqt.xdp.2.1.a.reason", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.refresh_header_message = ProtoField.new("Refresh Header Message", "nyse.bqt.xdp.2.1.a.refreshheadermessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.refresh_request_message = ProtoField.new("Refresh Request Message", "nyse.bqt.xdp.2.1.a.refreshrequestmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.request_response_message = ProtoField.new("Request Response Message", "nyse.bqt.xdp.2.1.a.requestresponsemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.requestseqnum = ProtoField.new("RequestSeqNum", "nyse.bqt.xdp.2.1.a.requestseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.reserved = ProtoField.new("Reserved", "nyse.bqt.xdp.2.1.a.reserved", ftypes.UINT8, nil, base.DEC, "0xF8")
nyse_bqt_xdp_2_1_a.fields.reserved1 = ProtoField.new("Reserved1", "nyse.bqt.xdp.2.1.a.reserved1", ftypes.BYTES)
nyse_bqt_xdp_2_1_a.fields.reserved2 = ProtoField.new("Reserved2", "nyse.bqt.xdp.2.1.a.reserved2", ftypes.BYTES)
nyse_bqt_xdp_2_1_a.fields.retail_pricing_indicator = ProtoField.new("Retail Pricing Indicator", "nyse.bqt.xdp.2.1.a.retailpricingindicator", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.retransmission_request_message = ProtoField.new("Retransmission Request Message", "nyse.bqt.xdp.2.1.a.retransmissionrequestmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.retransmitmethod = ProtoField.new("RetransmitMethod", "nyse.bqt.xdp.2.1.a.retransmitmethod", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.round_lot = ProtoField.new("Round Lot", "nyse.bqt.xdp.2.1.a.roundlot", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.security_status = ProtoField.new("Security Status", "nyse.bqt.xdp.2.1.a.securitystatus", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.security_type = ProtoField.new("Security Type", "nyse.bqt.xdp.2.1.a.securitytype", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.sequence_number = ProtoField.new("Sequence Number", "nyse.bqt.xdp.2.1.a.sequencenumber", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.sequence_number_reset_message = ProtoField.new("Sequence Number Reset Message", "nyse.bqt.xdp.2.1.a.sequencenumberresetmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.sessionstate = ProtoField.new("SessionState", "nyse.bqt.xdp.2.1.a.sessionstate", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.side = ProtoField.new("Side", "nyse.bqt.xdp.2.1.a.side", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.source_time = ProtoField.new("Source Time", "nyse.bqt.xdp.2.1.a.sourcetime", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.source_time_ns = ProtoField.new("Source Time NS", "nyse.bqt.xdp.2.1.a.sourcetimens", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.sourceid = ProtoField.new("SourceID", "nyse.bqt.xdp.2.1.a.sourceid", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.sourcetime = ProtoField.new("SourceTime", "nyse.bqt.xdp.2.1.a.sourcetime", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.sourcetimens = ProtoField.new("SourceTimeNS", "nyse.bqt.xdp.2.1.a.sourcetimens", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.ssr_triggering_exchange_id = ProtoField.new("SSR Triggering Exchange ID", "nyse.bqt.xdp.2.1.a.ssrtriggeringexchangeid", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.ssr_triggering_volume = ProtoField.new("SSR Triggering Volume", "nyse.bqt.xdp.2.1.a.ssrtriggeringvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.ssrstate = ProtoField.new("SSRState", "nyse.bqt.xdp.2.1.a.ssrstate", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.status = ProtoField.new("Status", "nyse.bqt.xdp.2.1.a.status", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol = ProtoField.new("Symbol", "nyse.bqt.xdp.2.1.a.symbol", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol_index = ProtoField.new("Symbol Index", "nyse.bqt.xdp.2.1.a.symbolindex", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.symbol_index_mapping_message = ProtoField.new("Symbol Index Mapping Message", "nyse.bqt.xdp.2.1.a.symbolindexmappingmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol_index_mapping_request_message = ProtoField.new("Symbol Index Mapping Request Message", "nyse.bqt.xdp.2.1.a.symbolindexmappingrequestmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol_seq_number = ProtoField.new("Symbol Seq Number", "nyse.bqt.xdp.2.1.a.symbolseqnumber", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.symbolindex = ProtoField.new("SymbolIndex", "nyse.bqt.xdp.2.1.a.symbolindex", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.symbolseqnum = ProtoField.new("SymbolSeqNum", "nyse.bqt.xdp.2.1.a.symbolseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.system_id = ProtoField.new("System ID", "nyse.bqt.xdp.2.1.a.systemid", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.time = ProtoField.new("Time", "nyse.bqt.xdp.2.1.a.time", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.timestamp = ProtoField.new("Timestamp", "nyse.bqt.xdp.2.1.a.timestamp", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.total_volume = ProtoField.new("Total Volume", "nyse.bqt.xdp.2.1.a.totalvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.totalrefreshpkts = ProtoField.new("TotalRefreshPkts", "nyse.bqt.xdp.2.1.a.totalrefreshpkts", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.trade_condition_1 = ProtoField.new("Trade Condition 1", "nyse.bqt.xdp.2.1.a.tradecondition1", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_condition_2 = ProtoField.new("Trade Condition 2", "nyse.bqt.xdp.2.1.a.tradecondition2", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_condition_3 = ProtoField.new("Trade Condition 3", "nyse.bqt.xdp.2.1.a.tradecondition3", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_condition_4 = ProtoField.new("Trade Condition 4", "nyse.bqt.xdp.2.1.a.tradecondition4", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_id = ProtoField.new("Trade ID", "nyse.bqt.xdp.2.1.a.tradeid", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.trade_session = ProtoField.new("Trade Session", "nyse.bqt.xdp.2.1.a.tradesession", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.unit_of_trade = ProtoField.new("Unit of Trade", "nyse.bqt.xdp.2.1.a.unitoftrade", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.volume = ProtoField.new("Volume", "nyse.bqt.xdp.2.1.a.volume", ftypes.UINT32)
...
dissect.complete = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.complete, range, value, display)
...
dissect.reason = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.reason, range, value, display)
...
dissect.total_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.total_volume, range, value, display)
...
dissect.symbol_seq_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.symbol_seq_number, range, value, display)
...
dissect.symbol_index = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.symbol_index, range, value, display)
...
dissect.consolidated_volume_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_volume_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_volume_message, range, display)
  end
...
dissect.close_price = function(buffer, offset, packet, parent)
  ...
  if show.close_price then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.close_price, range, display)
  end
...
dissect.number_of_close_prices = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.number_of_close_prices, range, value, display)
...
dissect.market_id_of_open_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.market_id_of_open_price, range, value, display)
...
dissect.market_id_of_low_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.market_id_of_low_price, range, value, display)
...
dissect.market_id_of_high_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.market_id_of_high_price, range, value, display)
...
dissect.open = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.open, range, value, display)
...
dissect.low_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.low_price, range, value, display)
...
dissect.high_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.high_price, range, value, display)
...
dissect.source_time_ns = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.source_time_ns, range, value, display)
...
dissect.source_time = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.source_time, range, value, display)
...
dissect.consolidated_stock_summary_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_stock_summary_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_stock_summary_message, range, display)
  end
...
dissect.market_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.market_id, range, value, display)
...
dissect.trade_condition_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.trade_condition_4, range, value, display)
...
dissect.trade_condition_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.trade_condition_3, range, value, display)
...
dissect.trade_condition_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.trade_condition_2, range, value, display)
...
dissect.trade_condition_1 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.trade_condition_1, range, value, display)
...
dissect.volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.volume, range, value, display)
...
dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.price, range, value, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.trade_id, range, value, display)
...
dissect.original_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.original_trade_id, range, value, display)
...
dissect.consolidated_trade_correction_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_trade_correction_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_trade_correction_message, range, display)
  end
...
dissect.consolidated_trade_cancel_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_trade_cancel_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_trade_cancel_message, range, display)
  end
...
dissect.symbolseqnum = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.symbolseqnum, range, value, display)
...
dissect.symbolindex = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.symbolindex, range, value, display)
...
dissect.sourcetimens = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.sourcetimens, range, value, display)
...
dissect.sourcetime = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.sourcetime, range, value, display)
...
dissect.consolidated_trade_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_trade_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_trade_message, range, display)
  end
...
dissect.retail_pricing_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.retail_pricing_indicator, range, value, display)
...
dissect.quote_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.quote_condition, range, value, display)
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.side, range, value, display)
...
dissect.consolidated_single_sided_quote_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_single_sided_quote_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_single_sided_quote_message, range, display)
  end
...
dissect.market_id_of_best_bid = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.market_id_of_best_bid, range, value, display)
...
dissect.market_id_of_best_ask = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.market_id_of_best_ask, range, value, display)
...
dissect.bid_quote_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.bid_quote_condition, range, value, display)
...
dissect.ask_quote_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.ask_quote_condition, range, value, display)
...
dissect.bid_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.bid_volume, range, value, display)
...
dissect.bid_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.bid_price, range, value, display)
...
dissect.ask_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.ask_volume, range, value, display)
...
dissect.ask_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.ask_price, range, value, display)
...
dissect.bqt_message = function(buffer, offset, packet, parent)
  ...
  if show.bqt_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.bqt_message, range, display)
  end
...
dissect.lastsymbolseqnum = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.lastsymbolseqnum, range, value, display)
...
dissect.lastseqnum = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.lastseqnum, range, value, display)
...
dissect.totalrefreshpkts = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.totalrefreshpkts, range, value, display)
...
dissect.currentrefreshpkt = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.currentrefreshpkt, range, value, display)
...
dissect.refresh_header_message = function(buffer, offset, packet, parent)
  ...
  if show.refresh_header_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.refresh_header_message, range, display)
  end
...
dissect.sessionstate = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.sessionstate, range, value, display)
...
dissect.marketstate = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.marketstate, range, value, display)
...
dissect.ssrstate = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.ssrstate, range, value, display)
...
dissect.time = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.time, range, value, display)
...
dissect.ssr_triggering_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.ssr_triggering_volume, range, value, display)
...
dissect.ssr_triggering_exchange_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.ssr_triggering_exchange_id, range, value, display)
...
dissect.price_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.price_2, range, value, display)
...
dissect.price_1 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.price_1, range, value, display)
...
dissect.reserved2 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.reserved2, range, value, display)
...
dissect.halt_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.halt_condition, range, value, display)
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.security_status, range, value, display)
...
dissect.consolidated_security_status_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_security_status_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_security_status_message, range, display)
  end
...
dissect.trade_session_bits = function(buffer, offset, packet, parent)
  ...
  -- Reserved: 5 Bit
  parent:add(nyse_bqt_xdp_2_1_a.fields.reserved, buffer(offset, 1))

  -- Ok for late hours: 1 Bit
  parent:add(nyse_bqt_xdp_2_1_a.fields.ok_for_late_hours, buffer(offset, 1))

  -- Ok for national hours: 1 Bit
  parent:add(nyse_bqt_xdp_2_1_a.fields.ok_for_national_hours, buffer(offset, 1))

  -- Ok for morning hours: 1 Bit
  parent:add(nyse_bqt_xdp_2_1_a.fields.ok_for_morning_hours, buffer(offset, 1))
end
...
dissect.consolidated_trading_session_change_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_trading_session_change_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_trading_session_change_message, range, display)
  end
...
dissect.nextsourceseqnum = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.nextsourceseqnum, range, value, display)
...
dissect.consolidated_symbol_clear_message = function(buffer, offset, packet, parent)
  ...
  if show.consolidated_symbol_clear_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.consolidated_symbol_clear_message, range, display)
  end
...
dissect.channelid = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.channelid, range, value, display)
...
dissect.productid = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.productid, range, value, display)
...
dissect.endseqnum = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.endseqnum, range, value, display)
...
dissect.beginseqnum = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.beginseqnum, range, value, display)
...
dissect.message_unavailable_message = function(buffer, offset, packet, parent)
  ...
  if show.message_unavailable_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.message_unavailable_message, range, display)
  end
...
dissect.sourceid = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.sourceid, range, value, display)
...
dissect.refresh_request_message = function(buffer, offset, packet, parent)
  ...
  if show.refresh_request_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.refresh_request_message, range, display)
  end
...
dissect.retransmitmethod = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.retransmitmethod, range, value, display)
...
dissect.symbol_index_mapping_request_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_index_mapping_request_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.symbol_index_mapping_request_message, range, display)
  end
...
dissect.heartbeat_response_message = function(buffer, offset, packet, parent)
  ...
  if show.heartbeat_response_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.heartbeat_response_message, range, display)
  end
...
dissect.status = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.status, range, value, display)
...
dissect.requestseqnum = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.requestseqnum, range, value, display)
...
dissect.request_response_message = function(buffer, offset, packet, parent)
  ...
  if show.request_response_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.request_response_message, range, display)
  end
...
dissect.retransmission_request_message = function(buffer, offset, packet, parent)
  ...
  if show.retransmission_request_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.retransmission_request_message, range, display)
  end
...
dissect.unit_of_trade = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.unit_of_trade, range, value, display)
...
dissect.mpv = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.mpv, range, value, display)
...
dissect.round_lot = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.round_lot, range, value, display)
...
dissect.price_resolution = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.price_resolution, range, value, display)
...
dissect.prevclosevolume = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.prevclosevolume, range, value, display)
...
dissect.prevcloseprice = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.prevcloseprice, range, value, display)
...
dissect.lot_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.lot_size, range, value, display)
...
dissect.security_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.security_type, range, value, display)
...
dissect.pricescalecode = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.pricescalecode, range, value, display)
...
dissect.exchange_code = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.exchange_code, range, value, display)
...
dissect.system_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.system_id, range, value, display)
...
dissect.reserved1 = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.reserved1, range, value, display)
...
dissect.symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.symbol, range, value, display)
...
dissect.symbol_index_mapping_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_index_mapping_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.symbol_index_mapping_message, range, display)
  end
...
dissect.sequence_number_reset_message = function(buffer, offset, packet, parent)
  ...
  if show.sequence_number_reset_message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.sequence_number_reset_message, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(nyse_bqt_xdp_2_1_a.fields.payload, range, display)
...
dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.message_type, range, value, display)
...
dissect.message_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.message_size, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.message_header, range, display)
  end
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.message, range, display)
  end
...
dissect.nanoseconds = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.nanoseconds, range, value, display)
...
dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.timestamp, range, value, display)
...
dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.sequence_number, range, value, display)
...
dissect.message_count = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.message_count, range, value, display)
...
dissect.delivery_flag = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.delivery_flag, range, value, display)
...
dissect.packet_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nyse_bqt_xdp_2_1_a.fields.packet_size, range, value, display)
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    ...
    parent = parent:add(nyse_bqt_xdp_2_1_a.fields.packet_header, range, display)
  end
...
function nyse_bqt_xdp_2_1_a.init()
end

-- Dissector for Nyse Bqt Xdp 2.1.a
function nyse_bqt_xdp_2_1_a.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = nyse_bqt_xdp_2_1_a.name

  -- Dissect protocol
  local protocol = parent:add(nyse_bqt_xdp_2_1_a, buffer(), nyse_bqt_xdp_2_1_a.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, nyse_bqt_xdp_2_1_a)
...
verify.nyse_bqt_xdp_2_1_a_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Nyse Bqt Xdp 2.1.a
local function nyse_bqt_xdp_2_1_a_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.nyse_bqt_xdp_2_1_a_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = nyse_bqt_xdp_2_1_a
  nyse_bqt_xdp_2_1_a.dissector(buffer, packet, parent)

  return true
end

-- Register Nyse Bqt Xdp 2.1.a Heuristic
nyse_bqt_xdp_2_1_a:register_heuristic("udp", nyse_bqt_xdp_2_1_a_heuristic)
