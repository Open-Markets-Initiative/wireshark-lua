...
nyse_bqt_xdp_2_1_a.fields.ask_price = ProtoField.new("Ask Price", "nyse.bqt.xdp.askprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.ask_quote_condition = ProtoField.new("Ask Quote Condition", "nyse.bqt.xdp.askquotecondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.ask_volume = ProtoField.new("Ask Volume", "nyse.bqt.xdp.askvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.beginseqnum = ProtoField.new("BeginSeqNum", "nyse.bqt.xdp.beginseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.bid_price = ProtoField.new("Bid Price", "nyse.bqt.xdp.bidprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.bid_quote_condition = ProtoField.new("Bid Quote Condition", "nyse.bqt.xdp.bidquotecondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.bid_volume = ProtoField.new("Bid Volume", "nyse.bqt.xdp.bidvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.bqt_message = ProtoField.new("BQT Message", "nyse.bqt.xdp.bqtmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.channelid = ProtoField.new("ChannelID", "nyse.bqt.xdp.channelid", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.close_price = ProtoField.new("Close Price", "nyse.bqt.xdp.closeprice", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.closing_price = ProtoField.new("Closing Price", "nyse.bqt.xdp.closingprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.complete = ProtoField.new("Complete", "nyse.bqt.xdp.complete", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.consolidated_security_status_message = ProtoField.new("Consolidated Security Status Message", "nyse.bqt.xdp.consolidatedsecuritystatusmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_single_sided_quote_message = ProtoField.new("Consolidated Single-Sided Quote Message", "nyse.bqt.xdp.consolidatedsinglesidedquotemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_stock_summary_message = ProtoField.new("Consolidated Stock Summary Message", "nyse.bqt.xdp.consolidatedstocksummarymessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_symbol_clear_message = ProtoField.new("Consolidated Symbol Clear Message", "nyse.bqt.xdp.consolidatedsymbolclearmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trade_cancel_message = ProtoField.new("Consolidated Trade Cancel Message", "nyse.bqt.xdp.consolidatedtradecancelmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trade_correction_message = ProtoField.new("Consolidated Trade Correction Message", "nyse.bqt.xdp.consolidatedtradecorrectionmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trade_message = ProtoField.new("Consolidated Trade Message", "nyse.bqt.xdp.consolidatedtrademessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_trading_session_change_message = ProtoField.new("Consolidated Trading Session Change Message", "nyse.bqt.xdp.consolidatedtradingsessionchangemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.consolidated_volume_message = ProtoField.new("Consolidated Volume Message", "nyse.bqt.xdp.consolidatedvolumemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.currentrefreshpkt = ProtoField.new("CurrentRefreshPkt", "nyse.bqt.xdp.currentrefreshpkt", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.delivery_flag = ProtoField.new("Delivery Flag", "nyse.bqt.xdp.deliveryflag", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.endseqnum = ProtoField.new("EndSeqNum", "nyse.bqt.xdp.endseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.exchange_code = ProtoField.new("Exchange Code", "nyse.bqt.xdp.exchangecode", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.halt_condition = ProtoField.new("Halt Condition", "nyse.bqt.xdp.haltcondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.heartbeat_response_message = ProtoField.new("Heartbeat Response Message", "nyse.bqt.xdp.heartbeatresponsemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.high_price = ProtoField.new("High Price", "nyse.bqt.xdp.highprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.lastseqnum = ProtoField.new("LastSeqNum", "nyse.bqt.xdp.lastseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.lastsymbolseqnum = ProtoField.new("LastSymbolSeqNum", "nyse.bqt.xdp.lastsymbolseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.lot_size = ProtoField.new("Lot Size", "nyse.bqt.xdp.lotsize", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.low_price = ProtoField.new("Low Price", "nyse.bqt.xdp.lowprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.market_id = ProtoField.new("Market ID", "nyse.bqt.xdp.marketid", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_best_ask = ProtoField.new("Market ID of Best Ask", "nyse.bqt.xdp.marketidofbestask", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_best_bid = ProtoField.new("Market ID of Best Bid", "nyse.bqt.xdp.marketidofbestbid", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_high_price = ProtoField.new("Market ID of High Price", "nyse.bqt.xdp.marketidofhighprice", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_low_price = ProtoField.new("Market ID of Low Price", "nyse.bqt.xdp.marketidoflowprice", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_open_price = ProtoField.new("Market ID of Open Price", "nyse.bqt.xdp.marketidofopenprice", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.market_id_of_the_close = ProtoField.new("Market ID of the Close", "nyse.bqt.xdp.marketidoftheclose", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.marketstate = ProtoField.new("MarketState", "nyse.bqt.xdp.marketstate", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.message = ProtoField.new("Message", "nyse.bqt.xdp.message", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.message_count = ProtoField.new("Message Count", "nyse.bqt.xdp.messagecount", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.message_header = ProtoField.new("Message Header", "nyse.bqt.xdp.messageheader", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.message_size = ProtoField.new("Message Size", "nyse.bqt.xdp.messagesize", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.message_type = ProtoField.new("Message Type", "nyse.bqt.xdp.messagetype", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.message_unavailable_message = ProtoField.new("Message Unavailable Message", "nyse.bqt.xdp.messageunavailablemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.mpv = ProtoField.new("MPV", "nyse.bqt.xdp.mpv", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.nanoseconds = ProtoField.new("Nanoseconds", "nyse.bqt.xdp.nanoseconds", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.nextsourceseqnum = ProtoField.new("NextSourceSeqNum", "nyse.bqt.xdp.nextsourceseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.number_of_close_prices = ProtoField.new("Number Of Close Prices", "nyse.bqt.xdp.numberofcloseprices", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.ok_for_late_hours = ProtoField.new("Ok for late hours", "nyse.bqt.xdp.okforlatehours", ftypes.UINT8, nil, base.DEC, "0x04")
nyse_bqt_xdp_2_1_a.fields.ok_for_morning_hours = ProtoField.new("Ok for morning hours", "nyse.bqt.xdp.okformorninghours", ftypes.UINT8, nil, base.DEC, "0x01")
nyse_bqt_xdp_2_1_a.fields.ok_for_national_hours = ProtoField.new("Ok for national hours", "nyse.bqt.xdp.okfornationalhours", ftypes.UINT8, nil, base.DEC, "0x02")
nyse_bqt_xdp_2_1_a.fields.open = ProtoField.new("Open", "nyse.bqt.xdp.open", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.original_trade_id = ProtoField.new("Original Trade ID", "nyse.bqt.xdp.originaltradeid", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.packet = ProtoField.new("Packet", "nyse.bqt.xdp.packet", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.packet_header = ProtoField.new("Packet Header", "nyse.bqt.xdp.packetheader", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.packet_size = ProtoField.new("Packet Size", "nyse.bqt.xdp.packetsize", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.payload = ProtoField.new("Payload", "nyse.bqt.xdp.payload", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.prevcloseprice = ProtoField.new("PrevClosePrice", "nyse.bqt.xdp.prevcloseprice", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.prevclosevolume = ProtoField.new("PrevCloseVolume", "nyse.bqt.xdp.prevclosevolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price = ProtoField.new("Price", "nyse.bqt.xdp.price", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price_1 = ProtoField.new("Price 1", "nyse.bqt.xdp.price1", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price_2 = ProtoField.new("Price 2", "nyse.bqt.xdp.price2", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.price_resolution = ProtoField.new("Price Resolution", "nyse.bqt.xdp.priceresolution", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.pricescalecode = ProtoField.new("PriceScaleCode", "nyse.bqt.xdp.pricescalecode", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.productid = ProtoField.new("ProductID", "nyse.bqt.xdp.productid", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.quote_condition = ProtoField.new("Quote Condition", "nyse.bqt.xdp.quotecondition", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.reason = ProtoField.new("Reason", "nyse.bqt.xdp.reason", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.refresh_header_message = ProtoField.new("Refresh Header Message", "nyse.bqt.xdp.refreshheadermessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.refresh_request_message = ProtoField.new("Refresh Request Message", "nyse.bqt.xdp.refreshrequestmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.request_response_message = ProtoField.new("Request Response Message", "nyse.bqt.xdp.requestresponsemessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.requestseqnum = ProtoField.new("RequestSeqNum", "nyse.bqt.xdp.requestseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.reserved = ProtoField.new("Reserved", "nyse.bqt.xdp.reserved", ftypes.UINT8, nil, base.DEC, "0xF8")
nyse_bqt_xdp_2_1_a.fields.reserved1 = ProtoField.new("Reserved1", "nyse.bqt.xdp.reserved1", ftypes.BYTES)
nyse_bqt_xdp_2_1_a.fields.reserved2 = ProtoField.new("Reserved2", "nyse.bqt.xdp.reserved2", ftypes.BYTES)
nyse_bqt_xdp_2_1_a.fields.retail_pricing_indicator = ProtoField.new("Retail Pricing Indicator", "nyse.bqt.xdp.retailpricingindicator", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.retransmission_request_message = ProtoField.new("Retransmission Request Message", "nyse.bqt.xdp.retransmissionrequestmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.retransmitmethod = ProtoField.new("RetransmitMethod", "nyse.bqt.xdp.retransmitmethod", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.round_lot = ProtoField.new("Round Lot", "nyse.bqt.xdp.roundlot", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.security_status = ProtoField.new("Security Status", "nyse.bqt.xdp.securitystatus", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.security_type = ProtoField.new("Security Type", "nyse.bqt.xdp.securitytype", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.sequence_number = ProtoField.new("Sequence Number", "nyse.bqt.xdp.sequencenumber", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.sequence_number_reset_message = ProtoField.new("Sequence Number Reset Message", "nyse.bqt.xdp.sequencenumberresetmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.sessionstate = ProtoField.new("SessionState", "nyse.bqt.xdp.sessionstate", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.side = ProtoField.new("Side", "nyse.bqt.xdp.side", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.source_time = ProtoField.new("Source Time", "nyse.bqt.xdp.sourcetime", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.source_time_ns = ProtoField.new("Source Time NS", "nyse.bqt.xdp.sourcetimens", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.sourceid = ProtoField.new("SourceID", "nyse.bqt.xdp.sourceid", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.sourcetime = ProtoField.new("SourceTime", "nyse.bqt.xdp.sourcetime", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.sourcetimens = ProtoField.new("SourceTimeNS", "nyse.bqt.xdp.sourcetimens", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.ssr_triggering_exchange_id = ProtoField.new("SSR Triggering Exchange ID", "nyse.bqt.xdp.ssrtriggeringexchangeid", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.ssr_triggering_volume = ProtoField.new("SSR Triggering Volume", "nyse.bqt.xdp.ssrtriggeringvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.ssrstate = ProtoField.new("SSRState", "nyse.bqt.xdp.ssrstate", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.status = ProtoField.new("Status", "nyse.bqt.xdp.status", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol = ProtoField.new("Symbol", "nyse.bqt.xdp.symbol", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol_index = ProtoField.new("Symbol Index", "nyse.bqt.xdp.symbolindex", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.symbol_index_mapping_message = ProtoField.new("Symbol Index Mapping Message", "nyse.bqt.xdp.symbolindexmappingmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol_index_mapping_request_message = ProtoField.new("Symbol Index Mapping Request Message", "nyse.bqt.xdp.symbolindexmappingrequestmessage", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.symbol_seq_number = ProtoField.new("Symbol Seq Number", "nyse.bqt.xdp.symbolseqnumber", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.symbolindex = ProtoField.new("SymbolIndex", "nyse.bqt.xdp.symbolindex", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.symbolseqnum = ProtoField.new("SymbolSeqNum", "nyse.bqt.xdp.symbolseqnum", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.system_id = ProtoField.new("System ID", "nyse.bqt.xdp.systemid", ftypes.UINT8)
nyse_bqt_xdp_2_1_a.fields.time = ProtoField.new("Time", "nyse.bqt.xdp.time", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.timestamp = ProtoField.new("Timestamp", "nyse.bqt.xdp.timestamp", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.total_volume = ProtoField.new("Total Volume", "nyse.bqt.xdp.totalvolume", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.totalrefreshpkts = ProtoField.new("TotalRefreshPkts", "nyse.bqt.xdp.totalrefreshpkts", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.trade_condition_1 = ProtoField.new("Trade Condition 1", "nyse.bqt.xdp.tradecondition1", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_condition_2 = ProtoField.new("Trade Condition 2", "nyse.bqt.xdp.tradecondition2", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_condition_3 = ProtoField.new("Trade Condition 3", "nyse.bqt.xdp.tradecondition3", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_condition_4 = ProtoField.new("Trade Condition 4", "nyse.bqt.xdp.tradecondition4", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.trade_id = ProtoField.new("Trade ID", "nyse.bqt.xdp.tradeid", ftypes.UINT32)
nyse_bqt_xdp_2_1_a.fields.trade_session = ProtoField.new("Trade Session", "nyse.bqt.xdp.tradesession", ftypes.STRING)
nyse_bqt_xdp_2_1_a.fields.unit_of_trade = ProtoField.new("Unit of Trade", "nyse.bqt.xdp.unitoftrade", ftypes.UINT16)
nyse_bqt_xdp_2_1_a.fields.volume = ProtoField.new("Volume", "nyse.bqt.xdp.volume", ftypes.UINT32)
