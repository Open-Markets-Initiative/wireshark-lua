...
local omi_nyse_amexequities_bqt_xdp_v2_4_a = Proto("Omi.Nyse.AmexEquities.Bqt.Xdp.v2.4.a", "Nyse AmexEquities Bqt Xdp 2.4.a")
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.ask_price = ProtoField.new("Ask Price", "nyse.amexequities.bqt.xdp.v2.4.a.askprice", ftypes.INT32)
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.bid_price = ProtoField.new("Bid Price", "nyse.amexequities.bqt.xdp.v2.4.a.bidprice", ftypes.INT32)
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_first_price = ProtoField.new("Consolidated First Price", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedfirstprice", ftypes.INT32)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_high_price = ProtoField.new("Consolidated High Price", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedhighprice", ftypes.INT32)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_last_price = ProtoField.new("Consolidated Last Price", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedlastprice", ftypes.INT32)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_low_price = ProtoField.new("Consolidated Low Price", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedlowprice", ftypes.INT32)
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_high_price = ProtoField.new("Nyse Group High Price", "nyse.amexequities.bqt.xdp.v2.4.a.nysegrouphighprice", ftypes.INT32)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_low_price = ProtoField.new("Nyse Group Low Price", "nyse.amexequities.bqt.xdp.v2.4.a.nysegrouplowprice", ftypes.INT32)
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.prev_close_price = ProtoField.new("Prev Close Price", "nyse.amexequities.bqt.xdp.v2.4.a.prevcloseprice", ftypes.UINT32)
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.price = ProtoField.new("Price", "nyse.amexequities.bqt.xdp.v2.4.a.price", ftypes.INT32)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.price_1 = ProtoField.new("Price 1", "nyse.amexequities.bqt.xdp.v2.4.a.price1", ftypes.UINT32)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.price_2 = ProtoField.new("Price 2", "nyse.amexequities.bqt.xdp.v2.4.a.price2", ftypes.UINT32)
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_close_price = ProtoField.new("Primary Listing Market Official Close Price", "nyse.amexequities.bqt.xdp.v2.4.a.primarylistingmarketofficialcloseprice", ftypes.INT32)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_open_price = ProtoField.new("Primary Listing Market Official Open Price", "nyse.amexequities.bqt.xdp.v2.4.a.primarylistingmarketofficialopenprice", ftypes.INT32)
...
-- Nyse AmexEquities Bqt Xdp 2.4.a Headers
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.ask_price_calculate = ProtoField.new("Ask Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.askpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.bid_price_calculate = ProtoField.new("Bid Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.bidpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_first_price_calculate = ProtoField.new("Consolidated First Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedfirstpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_high_price_calculate = ProtoField.new("Consolidated High Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedhighpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_last_price_calculate = ProtoField.new("Consolidated Last Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedlastpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_low_price_calculate = ProtoField.new("Consolidated Low Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.consolidatedlowpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_high_price_calculate = ProtoField.new("NYSE Group High Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.nysegrouphighpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_low_price_calculate = ProtoField.new("NYSE Group Low Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.nysegrouplowpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.price_calculate = ProtoField.new("Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.pricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_close_price_calculate = ProtoField.new("Primary Listing Market Official Close Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.primarylistingmarketofficialclosepricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_open_price_calculate = ProtoField.new("Primary Listing Market Official Open Price Calculate", "nyse.amexequities.bqt.xdp.v2.4.a.primarylistingmarketofficialopenpricecalculate", ftypes.DOUBLE)

-----------------------------------------------------------------------
-- Nyse AmexEquities Bqt Xdp 2.4.a Formatting
-----------------------------------------------------------------------

-- Ask Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_bqt_xdp_v2_4_a.format_decimals = true
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.resolve_records = Pref.bool("Symbol Index Mapping Message", show.records, "Cache records and resolve cross-packet lookups")
...
omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.format_decimals = Pref.bool("Format Decimals", true, "Format decimal-scaled fields as scaled values (off = raw mantissa)")

-- Handle changed preferences
function omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs_changed()

  -- Check if preferences have changed
  if show.records ~= omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.resolve_records then
    show.records = omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.resolve_records
  end
  ...
  if show.structs ~= omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_structs then
    show.structs = omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_indexes then
    show.indexes = omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.show_indexes
  end
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals ~= omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.format_decimals then
    nyse_amexequities_bqt_xdp_v2_4_a.format_decimals = omi_nyse_amexequities_bqt_xdp_v2_4_a.prefs.format_decimals
  end
end
...
nyse_amexequities_bqt_xdp_v2_4_a.conversation = {}
nyse_amexequities_bqt_xdp_v2_4_a.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nyse_amexequities_bqt_xdp_v2_4_a.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nyse_amexequities_bqt_xdp_v2_4_a.conversation.data = function(packet)
  local key = nyse_amexequities_bqt_xdp_v2_4_a.conversation.key(packet)
  local data = nyse_amexequities_bqt_xdp_v2_4_a.conversation.flows[key]
  if data == nil then
    data = { symbol_index_mapping_message = {} }
    nyse_amexequities_bqt_xdp_v2_4_a.conversation.flows[key] = data
  end
  return data
end
...
nyse_amexequities_bqt_xdp_v2_4_a.conversation.current = nil
...
nyse_amexequities_bqt_xdp_v2_4_a.symbol_index.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nyse_amexequities_bqt_xdp_v2_4_a.conversation.current.symbol_index_mapping_message[value]

  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.symbol_index, range, value, display)

  if record ~= nil then
    nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current = record
...
-- Ask Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.ask_price_calculate = {}

-- Display: Ask Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.ask_price_calculate.display = function(value)
  return "Ask Price Calculate: " .. string.format("%g", value)
end

-- Composite: Ask Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.ask_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.ask_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.ask_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.ask_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.ask_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.ask_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.ask_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.ask_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.ask_price.dissect(buffer, offset, packet, parent)
end

-- Bid Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.bid_price_calculate = {}

-- Display: Bid Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.bid_price_calculate.display = function(value)
  return "Bid Price Calculate: " .. string.format("%g", value)
end

-- Composite: Bid Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.bid_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.bid_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.bid_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.bid_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.bid_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.bid_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.bid_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.bid_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.bid_price.dissect(buffer, offset, packet, parent)
end

-- Consolidated First Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price_calculate = {}

-- Display: Consolidated First Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price_calculate.display = function(value)
  return "Consolidated First Price Calculate: " .. string.format("%g", value)
end

-- Composite: Consolidated First Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_first_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_first_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price.dissect(buffer, offset, packet, parent)
end

-- Consolidated High Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price_calculate = {}

-- Display: Consolidated High Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price_calculate.display = function(value)
  return "Consolidated High Price Calculate: " .. string.format("%g", value)
end

-- Composite: Consolidated High Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_high_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_high_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price.dissect(buffer, offset, packet, parent)
end

-- Consolidated Last Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price_calculate = {}

-- Display: Consolidated Last Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price_calculate.display = function(value)
  return "Consolidated Last Price Calculate: " .. string.format("%g", value)
end

-- Composite: Consolidated Last Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_last_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_last_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price.dissect(buffer, offset, packet, parent)
end

-- Consolidated Low Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price_calculate = {}

-- Display: Consolidated Low Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price_calculate.display = function(value)
  return "Consolidated Low Price Calculate: " .. string.format("%g", value)
end

-- Composite: Consolidated Low Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_low_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.consolidated_low_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price.dissect(buffer, offset, packet, parent)
end

-- NYSE Group High Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price_calculate = {}

-- Display: NYSE Group High Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price_calculate.display = function(value)
  return "NYSE Group High Price Calculate: " .. string.format("%g", value)
end

-- Composite: NYSE Group High Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_high_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_high_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price.dissect(buffer, offset, packet, parent)
end

-- NYSE Group Low Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price_calculate = {}

-- Display: NYSE Group Low Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price_calculate.display = function(value)
  return "NYSE Group Low Price Calculate: " .. string.format("%g", value)
end

-- Composite: NYSE Group Low Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_low_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.nyse_group_low_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price.dissect(buffer, offset, packet, parent)
end

-- Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.price_calculate = {}

-- Display: Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.price_calculate.display = function(value)
  return "Price Calculate: " .. string.format("%g", value)
end

-- Composite: Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.price.dissect(buffer, offset, packet, parent)
end

-- Primary Listing Market Official Close Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price_calculate = {}

-- Display: Primary Listing Market Official Close Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price_calculate.display = function(value)
...
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_close_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_close_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price.dissect(buffer, offset, packet, parent)
end

-- Primary Listing Market Official Open Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price_calculate = {}

-- Display: Primary Listing Market Official Open Price Calculate
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price_calculate.display = function(value)
...
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_open_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_bqt_xdp_v2_4_a.fields.primary_listing_market_official_open_price, range, mantissa, mantissa_display)
...
nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_bqt_xdp_v2_4_a.format_decimals then
    local record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price.dissect(buffer, offset, packet, parent)
end
...
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_fractional_volume_message.fields = function(buffer, offset, packet, parent)
  ...
  index, symbol_index, symbol_index_record = nyse_amexequities_bqt_xdp_v2_4_a.symbol_index.dissect(buffer, index, packet, parent)
...
nyse_amexequities_bqt_xdp_v2_4_a.consolidated_fractional_stock_summary_message.fields = function(buffer, offset, packet, parent)
  ...
  index, nyse_group_high_price = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_high_price_calculate.dissect(buffer, index, packet, parent)

  -- Nyse Group Low Price: Binary
  index, nyse_group_low_price = nyse_amexequities_bqt_xdp_v2_4_a.nyse_group_low_price_calculate.dissect(buffer, index, packet, parent)

  -- Primary Listing Market Official Open Price: Binary
  index, primary_listing_market_official_open_price = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_open_price_calculate.dissect(buffer, index, packet, parent)
  ...
  index, primary_listing_market_official_close_price = nyse_amexequities_bqt_xdp_v2_4_a.primary_listing_market_official_close_price_calculate.dissect(buffer, index, packet, parent)

  -- Consolidated High Price: Binary
  index, consolidated_high_price = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_high_price_calculate.dissect(buffer, index, packet, parent)

  -- Consolidated Low Price: Binary
  index, consolidated_low_price = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_low_price_calculate.dissect(buffer, index, packet, parent)

  -- Consolidated First Price: Binary
  index, consolidated_first_price = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_first_price_calculate.dissect(buffer, index, packet, parent)

  -- Consolidated Last Price: Binary
  index, consolidated_last_price = nyse_amexequities_bqt_xdp_v2_4_a.consolidated_last_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexequities_bqt_xdp_v2_4_a.trf_fractional_prior_day_trade_cancel_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Price: Binary
  index, price = nyse_amexequities_bqt_xdp_v2_4_a.price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexequities_bqt_xdp_v2_4_a.best_quotes_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Ask Price: Binary
  index, ask_price = nyse_amexequities_bqt_xdp_v2_4_a.ask_price_calculate.dissect(buffer, index, packet, parent)

  -- Ask Volume: Binary
  index, ask_volume = nyse_amexequities_bqt_xdp_v2_4_a.ask_volume.dissect(buffer, index, packet, parent)

  -- Bid Price: Binary
  index, bid_price = nyse_amexequities_bqt_xdp_v2_4_a.bid_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexequities_bqt_xdp_v2_4_a.symbol_index_mapping_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nyse_amexequities_bqt_xdp_v2_4_a.conversation.current.symbol_index_mapping_message[symbol_index] = {
...
nyse_amexequities_bqt_xdp_v2_4_a.packet.dissect = function(buffer, packet, parent)
  ...
  local data = nyse_amexequities_bqt_xdp_v2_4_a.conversation.data(packet)
  if not packet.visited then
  end
  nyse_amexequities_bqt_xdp_v2_4_a.conversation.current = data
...
-- Register Nyse AmexEquities Bqt Xdp 2.4.a for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_amexequities_bqt_xdp_v2_4_a)
