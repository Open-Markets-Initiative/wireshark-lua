...
local omi_nyse_amexequities_depthfeed_pillar_v1_6 = Proto("Omi.Nyse.AmexEquities.DepthFeed.Pillar.v1.6", "Nyse AmexEquities DepthFeed Pillar 1.6")
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.lower_collar = ProtoField.new("Lower Collar", "nyse.amexequities.depthfeed.pillar.v1.6.lowercollar", ftypes.INT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.upper_collar = ProtoField.new("Upper Collar", "nyse.amexequities.depthfeed.pillar.v1.6.uppercollar", ftypes.INT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nyse.amexequities.depthfeed.pillar.v1.6.messagesequencenumber", ftypes.UINT64)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.auction_interest_clearing_price_calculate = ProtoField.new("Auction Interest Clearing Price Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.auctioninterestclearingpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.continuous_book_clearing_price_calculate = ProtoField.new("Continuous Book Clearing Price Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.continuousbookclearingpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.indicative_match_price_calculate = ProtoField.new("Indicative Match Price Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.indicativematchpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.lower_collar_calculate = ProtoField.new("Lower Collar Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.lowercollarcalculate", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price_calculate = ProtoField.new("Price Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.pricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.reference_price_calculate = ProtoField.new("Reference Price Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.referencepricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.ssr_filing_price_calculate = ProtoField.new("SSR Filing Price Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.ssrfilingpricecalculate", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.upper_collar_calculate = ProtoField.new("Upper Collar Calculate", "nyse.amexequities.depthfeed.pillar.v1.6.uppercollarcalculate", ftypes.DOUBLE)

-----------------------------------------------------------------------
-- Nyse AmexEquities DepthFeed Pillar 1.6 Formatting
-----------------------------------------------------------------------

-- Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_price_calculate = true

-- Reference Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_reference_price_calculate = true

-- Continuous Book Clearing Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_continuous_book_clearing_price_calculate = true

-- Auction Interest Clearing Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_auction_interest_clearing_price_calculate = true

-- SSR Filing Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_ssr_filing_price_calculate = true

-- Indicative Match Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_indicative_match_price_calculate = true

-- Upper Collar Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_upper_collar_calculate = true

-- Lower Collar Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_lower_collar_calculate = true
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.resolve_records = Pref.bool("Symbol Index Mapping Message", show.records, "Cache records and resolve cross-packet lookups")
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_price_calculate = Pref.bool("Format Price Calculate", true, "Format Price Calculate as decimal-scaled value (off = raw mantissa)")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_reference_price_calculate = Pref.bool("Format Reference Price Calculate", true, "Format Reference Price Calculate as decimal-scaled value (off = raw mantissa)")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_continuous_book_clearing_price_calculate = Pref.bool("Format Continuous Book Clearing Price Calculate", true, "Format Continuous Book Clearing Price Calculate as decimal-scaled value (off = raw mantissa)")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_auction_interest_clearing_price_calculate = Pref.bool("Format Auction Interest Clearing Price Calculate", true, "Format Auction Interest Clearing Price Calculate as decimal-scaled value (off = raw mantissa)")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_ssr_filing_price_calculate = Pref.bool("Format SSR Filing Price Calculate", true, "Format SSR Filing Price Calculate as decimal-scaled value (off = raw mantissa)")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_indicative_match_price_calculate = Pref.bool("Format Indicative Match Price Calculate", true, "Format Indicative Match Price Calculate as decimal-scaled value (off = raw mantissa)")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_upper_collar_calculate = Pref.bool("Format Upper Collar Calculate", true, "Format Upper Collar Calculate as decimal-scaled value (off = raw mantissa)")
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_lower_collar_calculate = Pref.bool("Format Lower Collar Calculate", true, "Format Lower Collar Calculate as decimal-scaled value (off = raw mantissa)")

-- Handle changed preferences
function omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs_changed()

  -- Check if preferences have changed
  if show.records ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.resolve_records then
    show.records = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.resolve_records
  end
  ...
  if show.headers ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_headers then
    show.headers = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_headers
  end
  if show.repeating_groups ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_repeating_groups then
    show.repeating_groups = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_repeating_groups
  end
  if show.structs ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_structs then
    show.structs = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_indexes then
    show.indexes = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_indexes
  end
  if show.sequences ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_sequences then
    show.sequences = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.show_sequences
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_price_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_price_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_price_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_price_calculate
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_reference_price_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_reference_price_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_reference_price_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_reference_price_calculate
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_continuous_book_clearing_price_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_continuous_book_clearing_price_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_continuous_book_clearing_price_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_continuous_book_clearing_price_calculate
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_auction_interest_clearing_price_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_auction_interest_clearing_price_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_auction_interest_clearing_price_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_auction_interest_clearing_price_calculate
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_ssr_filing_price_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_ssr_filing_price_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_ssr_filing_price_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_ssr_filing_price_calculate
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_indicative_match_price_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_indicative_match_price_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_indicative_match_price_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_indicative_match_price_calculate
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_upper_collar_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_upper_collar_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_upper_collar_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_upper_collar_calculate
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.format_lower_collar_calculate ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_lower_collar_calculate then
    nyse_amexequities_depthfeed_pillar_v1_6.format_lower_collar_calculate = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_lower_collar_calculate
  end
end
...
nyse_amexequities_depthfeed_pillar_v1_6.conversation = {}
nyse_amexequities_depthfeed_pillar_v1_6.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nyse_amexequities_depthfeed_pillar_v1_6.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nyse_amexequities_depthfeed_pillar_v1_6.conversation.data = function(packet)
  local key = nyse_amexequities_depthfeed_pillar_v1_6.conversation.key(packet)
  local data = nyse_amexequities_depthfeed_pillar_v1_6.conversation.flows[key]
  if data == nil then
    data = { symbol_index_mapping_message = {} }
    nyse_amexequities_depthfeed_pillar_v1_6.conversation.flows[key] = data
  end
  return data
end
...
nyse_amexequities_depthfeed_pillar_v1_6.conversation.current = nil
...
nyse_amexequities_depthfeed_pillar_v1_6.symbol_index.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nyse_amexequities_depthfeed_pillar_v1_6.conversation.current.symbol_index_mapping_message[value]
  if record ~= nil and record.symbol ~= nil then
    display = "Symbol Index: " .. tostring(record.symbol) .. " (" .. tostring(value) .. ")"
  end

  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.symbol_index, range, value, display)

  if record ~= nil then
    nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current = record
...
nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate = {}

-- Display: Auction Interest Clearing Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate.display = function(value)
...
nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.auction_interest_clearing_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.auction_interest_clearing_price, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_auction_interest_clearing_price_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price.dissect(buffer, offset, packet, parent)
end

-- Continuous Book Clearing Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price_calculate = {}

-- Display: Continuous Book Clearing Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price_calculate.display = function(value)
  return "Continuous Book Clearing Price Calculate: " .. string.format("%g", value)
end

-- Composite: Continuous Book Clearing Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.continuous_book_clearing_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.continuous_book_clearing_price, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_continuous_book_clearing_price_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price.dissect(buffer, offset, packet, parent)
end

-- Indicative Match Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price_calculate = {}

-- Display: Indicative Match Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price_calculate.display = function(value)
  return "Indicative Match Price Calculate: " .. string.format("%g", value)
end

-- Composite: Indicative Match Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.indicative_match_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.indicative_match_price, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_indicative_match_price_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price.dissect(buffer, offset, packet, parent)
end

-- Lower Collar Calculate
nyse_amexequities_depthfeed_pillar_v1_6.lower_collar_calculate = {}

-- Display: Lower Collar Calculate
nyse_amexequities_depthfeed_pillar_v1_6.lower_collar_calculate.display = function(value)
  return "Lower Collar Calculate: " .. string.format("%g", value)
end

-- Composite: Lower Collar Calculate
nyse_amexequities_depthfeed_pillar_v1_6.lower_collar_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.lower_collar.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.lower_collar_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.lower_collar_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.lower_collar.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.lower_collar, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.lower_collar_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_lower_collar_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.lower_collar_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.lower_collar.dissect(buffer, offset, packet, parent)
end

-- Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.price_calculate = {}

-- Display: Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.price_calculate.display = function(value)
  return "Price Calculate: " .. string.format("%g", value)
end

-- Composite: Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_price_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.price.dissect(buffer, offset, packet, parent)
end

-- Reference Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.reference_price_calculate = {}

-- Display: Reference Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.reference_price_calculate.display = function(value)
  return "Reference Price Calculate: " .. string.format("%g", value)
end

-- Composite: Reference Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.reference_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.reference_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.reference_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.reference_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.reference_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.reference_price, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.reference_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_reference_price_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.reference_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.reference_price.dissect(buffer, offset, packet, parent)
end

-- SSR Filing Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price_calculate = {}

-- Display: SSR Filing Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price_calculate.display = function(value)
  return "SSR Filing Price Calculate: " .. string.format("%g", value)
end

-- Composite: SSR Filing Price Calculate
nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.ssr_filing_price_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.ssr_filing_price, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_ssr_filing_price_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price.dissect(buffer, offset, packet, parent)
end

-- Upper Collar Calculate
nyse_amexequities_depthfeed_pillar_v1_6.upper_collar_calculate = {}

-- Display: Upper Collar Calculate
nyse_amexequities_depthfeed_pillar_v1_6.upper_collar_calculate.display = function(value)
  return "Upper Collar Calculate: " .. string.format("%g", value)
end

-- Composite: Upper Collar Calculate
nyse_amexequities_depthfeed_pillar_v1_6.upper_collar_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_amexequities_depthfeed_pillar_v1_6.upper_collar.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_amexequities_depthfeed_pillar_v1_6.upper_collar_calculate.display(value)
  local field_tree = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.upper_collar_calculate, range, value, display)
  local mantissa_display = nyse_amexequities_depthfeed_pillar_v1_6.upper_collar.display(mantissa)

  field_tree:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.upper_collar, range, mantissa, mantissa_display)
...
nyse_amexequities_depthfeed_pillar_v1_6.upper_collar_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_upper_collar_calculate then
    local record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_amexequities_depthfeed_pillar_v1_6.upper_collar_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_amexequities_depthfeed_pillar_v1_6.upper_collar.dissect(buffer, offset, packet, parent)
end
...
nyse_amexequities_depthfeed_pillar_v1_6.imbalance_message.fields = function(buffer, offset, packet, parent)
  ...
  index, symbol_index, symbol_index_record = nyse_amexequities_depthfeed_pillar_v1_6.symbol_index.dissect(buffer, index, packet, parent)
  ...
  index, reference_price = nyse_amexequities_depthfeed_pillar_v1_6.reference_price_calculate.dissect(buffer, index, packet, parent)
  ...
  index, continuous_book_clearing_price = nyse_amexequities_depthfeed_pillar_v1_6.continuous_book_clearing_price_calculate.dissect(buffer, index, packet, parent)

  -- Auction Interest Clearing Price: Binary
  index, auction_interest_clearing_price = nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate.dissect(buffer, index, packet, parent)

  -- Ssr Filing Price: Binary
  index, ssr_filing_price = nyse_amexequities_depthfeed_pillar_v1_6.ssr_filing_price_calculate.dissect(buffer, index, packet, parent)

  -- Indicative Match Price: Binary
  index, indicative_match_price = nyse_amexequities_depthfeed_pillar_v1_6.indicative_match_price_calculate.dissect(buffer, index, packet, parent)

  -- Upper Collar: Binary
  index, upper_collar = nyse_amexequities_depthfeed_pillar_v1_6.upper_collar_calculate.dissect(buffer, index, packet, parent)

  -- Lower Collar: Binary
  index, lower_collar = nyse_amexequities_depthfeed_pillar_v1_6.lower_collar_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexequities_depthfeed_pillar_v1_6.price_point.fields = function(buffer, offset, packet, parent, price_point_index)
  ...
  -- Price: Binary
  index, price = nyse_amexequities_depthfeed_pillar_v1_6.price_calculate.dissect(buffer, index, packet, parent)
...
nyse_amexequities_depthfeed_pillar_v1_6.symbol_index_mapping_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nyse_amexequities_depthfeed_pillar_v1_6.conversation.current.symbol_index_mapping_message[symbol_index] = {
...
nyse_amexequities_depthfeed_pillar_v1_6.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nyse_amexequities_depthfeed_pillar_v1_6.sequence ~= nil then
    local sequence = parent:add(omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.message_sequence_number, UInt64.new(nyse_amexequities_depthfeed_pillar_v1_6.sequence + message_index - 1))
...
nyse_amexequities_depthfeed_pillar_v1_6.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nyse_amexequities_depthfeed_pillar_v1_6.sequence = seq_num
...
-- Register Nyse AmexEquities DepthFeed Pillar 1.6 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_amexequities_depthfeed_pillar_v1_6)
