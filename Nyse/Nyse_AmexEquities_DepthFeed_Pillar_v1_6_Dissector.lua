...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.auction_interest_clearing_price = ProtoField.new("Auction Interest Clearing Price", "nyse.amexequities.depthfeed.pillar.v1.6.auctioninterestclearingprice", ftypes.INT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.continuous_book_clearing_price = ProtoField.new("Continuous Book Clearing Price", "nyse.amexequities.depthfeed.pillar.v1.6.continuousbookclearingprice", ftypes.INT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.indicative_match_price = ProtoField.new("Indicative Match Price", "nyse.amexequities.depthfeed.pillar.v1.6.indicativematchprice", ftypes.INT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.prev_close_price = ProtoField.new("Prev Close Price", "nyse.amexequities.depthfeed.pillar.v1.6.prevcloseprice", ftypes.UINT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price = ProtoField.new("Price", "nyse.amexequities.depthfeed.pillar.v1.6.price", ftypes.INT32)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price_1 = ProtoField.new("Price 1", "nyse.amexequities.depthfeed.pillar.v1.6.price1", ftypes.UINT32)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price_2 = ProtoField.new("Price 2", "nyse.amexequities.depthfeed.pillar.v1.6.price2", ftypes.UINT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.reference_price = ProtoField.new("Reference Price", "nyse.amexequities.depthfeed.pillar.v1.6.referenceprice", ftypes.INT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.ssr_filing_price = ProtoField.new("Ssr Filing Price", "nyse.amexequities.depthfeed.pillar.v1.6.ssrfilingprice", ftypes.INT32)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.send_time = ProtoField.new("Send Time", "nyse.amexequities.depthfeed.pillar.v1.6.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.send_time_utc = ProtoField.new("Send Time", "nyse.amexequities.depthfeed.pillar.v1.6.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)
...
-- 0=Local, 1=Utc
nyse_amexequities_depthfeed_pillar_v1_6.absolute_time_base = 0

-- Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_amexequities_depthfeed_pillar_v1_6.format_decimals = true
...
omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_decimals = Pref.bool("Format Decimals", true, "Format decimal-scaled fields as scaled values (off = raw mantissa)")

omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)
...
function omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs_changed()
  ...
  if nyse_amexequities_depthfeed_pillar_v1_6.format_decimals ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_decimals then
    nyse_amexequities_depthfeed_pillar_v1_6.format_decimals = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.format_decimals
  end
  if nyse_amexequities_depthfeed_pillar_v1_6.absolute_time_base ~= omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.absolute_time_base then
    nyse_amexequities_depthfeed_pillar_v1_6.absolute_time_base = omi_nyse_amexequities_depthfeed_pillar_v1_6.prefs.absolute_time_base
  end
end
...
nyse_amexequities_depthfeed_pillar_v1_6.auction_interest_clearing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_amexequities_depthfeed_pillar_v1_6.format_decimals then
...
nyse_amexequities_depthfeed_pillar_v1_6.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_amexequities_depthfeed_pillar_v1_6.send_time.size
    ...
    local field = omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.send_time
    if nyse_amexequities_depthfeed_pillar_v1_6.absolute_time_base == 1 then field = omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_amexequities_depthfeed_pillar_v1_6.send_time.fields(buffer, offset, packet, parent)
