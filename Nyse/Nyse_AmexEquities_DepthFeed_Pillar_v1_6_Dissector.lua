...
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price_resolution = ProtoField.new("Price Resolution", "nyse.amexequities.depthfeed.pillar.v1.6.priceresolution", ftypes.DOUBLE)
omi_nyse_amexequities_depthfeed_pillar_v1_6.fields.price_scale_code = ProtoField.new("Price Scale Code", "nyse.amexequities.depthfeed.pillar.v1.6.pricescalecode", ftypes.DOUBLE)
...
nyse_amexequities_depthfeed_pillar_v1_6.price_resolution.translate = function(raw)
  return raw/100000000
end
...
nyse_amexequities_depthfeed_pillar_v1_6.price_resolution.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int()
  local value = nyse_amexequities_depthfeed_pillar_v1_6.price_resolution.translate(raw)
...
nyse_amexequities_depthfeed_pillar_v1_6.price_scale_code.translate = function(raw)
  return raw/100000000
end
...
nyse_amexequities_depthfeed_pillar_v1_6.price_scale_code.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int()
  local value = nyse_amexequities_depthfeed_pillar_v1_6.price_scale_code.translate(raw)
...
-- Dissector Heuristic for Nyse AmexEquities DepthFeed Pillar 1.6
local function omi_nyse_amexequities_depthfeed_pillar_v1_6_heuristic(buffer, packet, parent)
...
omi_nyse_amexequities_depthfeed_pillar_v1_6:register_heuristic("udp", omi_nyse_amexequities_depthfeed_pillar_v1_6_heuristic)
