...
-- Dissector Heuristic for Nyse ArcaOptions ComplexFeed Pillar 1.0.h
local function omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h_heuristic(buffer, packet, parent)
...
omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h:register_heuristic("udp", omi_nyse_arcaoptions_complexfeed_pillar_v1_0_h_heuristic)
