...
-- Nyse Equities Pillar Bbo 2.5.b Application Messages
...
omi_nyse_equities_bbo_pillar_v2_5_b.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_nyse_equities_bbo_pillar_v2_5_b.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Handle changed preferences
function omi_nyse_equities_bbo_pillar_v2_5_b.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_nyse_equities_bbo_pillar_v2_5_b.prefs.show_application_messages then
    show.application_messages = omi_nyse_equities_bbo_pillar_v2_5_b.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_nyse_equities_bbo_pillar_v2_5_b.prefs.show_message_index then
    show.message_index = omi_nyse_equities_bbo_pillar_v2_5_b.prefs.show_message_index
  end
end
...
nyse_equities_bbo_pillar_v2_5_b.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = nyse_equities_bbo_pillar_v2_5_b.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
