...
local omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n = Proto("Omi.Nyse.TexasEquities.ImbalancesFeed.Pillar.v2.2.n", "Nyse TexasEquities ImbalancesFeed Pillar 2.2.n")
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.auction_interest_clearing_price = ProtoField.new("Auction Interest Clearing Price", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.auctioninterestclearingprice", ftypes.INT32)
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.continuous_book_clearing_price = ProtoField.new("Continuous Book Clearing Price", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.continuousbookclearingprice", ftypes.INT32)
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.indicative_match_price = ProtoField.new("Indicative Match Price", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.indicativematchprice", ftypes.INT32)
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.prev_close_price = ProtoField.new("Prev Close Price", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.prevcloseprice", ftypes.UINT32)
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.price_1 = ProtoField.new("Price 1", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.price1", ftypes.UINT32)
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.price_2 = ProtoField.new("Price 2", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.price2", ftypes.UINT32)
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.ssr_filing_price = ProtoField.new("Ssr Filing Price", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.ssrfilingprice", ftypes.INT32)
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.messagesequencenumber", ftypes.UINT64)
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.auction_interest_clearing_price_calculate = ProtoField.new("Auction Interest Clearing Price Calculate", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.auctioninterestclearingpricecalculate", ftypes.DOUBLE)
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.continuous_book_clearing_price_calculate = ProtoField.new("Continuous Book Clearing Price Calculate", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.continuousbookclearingpricecalculate", ftypes.DOUBLE)
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.indicative_match_price_calculate = ProtoField.new("Indicative Match Price Calculate", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.indicativematchpricecalculate", ftypes.DOUBLE)
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.reference_price_calculate = ProtoField.new("Reference Price Calculate", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.referencepricecalculate", ftypes.DOUBLE)
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.ssr_filing_price_calculate = ProtoField.new("SSR Filing Price Calculate", "nyse.texasequities.imbalancesfeed.pillar.v2.2.n.ssrfilingpricecalculate", ftypes.DOUBLE)

-----------------------------------------------------------------------
-- Nyse TexasEquities ImbalancesFeed Pillar 2.2.n Formatting
-----------------------------------------------------------------------
...
-- 0=Local, 1=Utc
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.absolute_time_base = 0

-- Reference Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals = true
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.resolve_records = Pref.bool("Symbol Index Mapping Message", show.records, "Cache records and resolve cross-packet lookups")
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.format_decimals = Pref.bool("Format Decimals", true, "Format decimal-scaled fields as scaled values (off = raw mantissa)")

omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)

-- Handle changed preferences
function omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs_changed()

  -- Check if preferences have changed
  if show.records ~= omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.resolve_records then
    show.records = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.resolve_records
  end
  ...
  if show.headers ~= omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_headers then
    show.headers = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_headers
  end
  if show.structs ~= omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_structs then
    show.structs = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_indexes then
    show.indexes = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_indexes
  end
  if show.sequences ~= omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_sequences then
    show.sequences = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.show_sequences
  end
  if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals ~= omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.format_decimals then
    nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.format_decimals
  end
  if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.absolute_time_base ~= omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.absolute_time_base then
    nyse_texasequities_imbalancesfeed_pillar_v2_2_n.absolute_time_base = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.prefs.absolute_time_base
  end
end
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation = {}
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.data = function(packet)
  local key = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.key(packet)
  local data = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.flows[key]
  if data == nil then
    data = { symbol_index_mapping_message = {} }
    nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.flows[key] = data
  end
  return data
end
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.current = nil
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.current.symbol_index_mapping_message[value]

  local field_tree = parent:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.symbol_index, range, value, display)

  if record ~= nil then
    nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index_mapping_message.current = record
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price_calculate = {}

-- Display: Auction Interest Clearing Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price_calculate.display = function(value)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.auction_interest_clearing_price_calculate, range, value, display)
  local mantissa_display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price.display(mantissa)

  field_tree:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.auction_interest_clearing_price, range, mantissa, mantissa_display)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals then
    local record = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price.dissect(buffer, offset, packet, parent)
end

-- Continuous Book Clearing Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price_calculate = {}

-- Display: Continuous Book Clearing Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price_calculate.display = function(value)
  return "Continuous Book Clearing Price Calculate: " .. string.format("%g", value)
end

-- Composite: Continuous Book Clearing Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.continuous_book_clearing_price_calculate, range, value, display)
  local mantissa_display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price.display(mantissa)

  field_tree:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.continuous_book_clearing_price, range, mantissa, mantissa_display)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals then
    local record = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price.dissect(buffer, offset, packet, parent)
end

-- Indicative Match Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price_calculate = {}

-- Display: Indicative Match Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price_calculate.display = function(value)
  return "Indicative Match Price Calculate: " .. string.format("%g", value)
end

-- Composite: Indicative Match Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.indicative_match_price_calculate, range, value, display)
  local mantissa_display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price.display(mantissa)

  field_tree:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.indicative_match_price, range, mantissa, mantissa_display)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals then
    local record = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price.dissect(buffer, offset, packet, parent)
end

-- Reference Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price_calculate = {}

-- Display: Reference Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price_calculate.display = function(value)
  return "Reference Price Calculate: " .. string.format("%g", value)
end

-- Composite: Reference Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.reference_price_calculate, range, value, display)
  local mantissa_display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price.display(mantissa)

  field_tree:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.reference_price, range, mantissa, mantissa_display)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals then
    local record = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price.dissect(buffer, offset, packet, parent)
end

-- SSR Filing Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price_calculate = {}

-- Display: SSR Filing Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price_calculate.display = function(value)
  return "SSR Filing Price Calculate: " .. string.format("%g", value)
end

-- Composite: SSR Filing Price Calculate
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.ssr_filing_price_calculate, range, value, display)
  local mantissa_display = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price.display(mantissa)

  field_tree:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.ssr_filing_price, range, mantissa, mantissa_display)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.format_decimals then
    local record = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price.dissect(buffer, offset, packet, parent)
end
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.imbalance_message.fields = function(buffer, offset, packet, parent)
  ...
  index, symbol_index, symbol_index_record = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index.dissect(buffer, index, packet, parent)
  ...
  index, reference_price = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.reference_price_calculate.dissect(buffer, index, packet, parent)
  ...
  index, continuous_book_clearing_price = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.continuous_book_clearing_price_calculate.dissect(buffer, index, packet, parent)

  -- Auction Interest Clearing Price: Binary
  index, auction_interest_clearing_price = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.auction_interest_clearing_price_calculate.dissect(buffer, index, packet, parent)

  -- Ssr Filing Price: Binary
  index, ssr_filing_price = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.ssr_filing_price_calculate.dissect(buffer, index, packet, parent)

  -- Indicative Match Price: Binary
  index, indicative_match_price = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.indicative_match_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.symbol_index_mapping_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.current.symbol_index_mapping_message[symbol_index] = {
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nyse_texasequities_imbalancesfeed_pillar_v2_2_n.sequence ~= nil then
    local sequence = parent:add(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.message_sequence_number, UInt64.new(nyse_texasequities_imbalancesfeed_pillar_v2_2_n.sequence + message_index - 1))
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.send_time.size
    ...
    local field = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.send_time
    if nyse_texasequities_imbalancesfeed_pillar_v2_2_n.absolute_time_base == 1 then field = omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.send_time.fields(buffer, offset, packet, parent)
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nyse_texasequities_imbalancesfeed_pillar_v2_2_n.sequence = seq_num
...
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.packet.requiredsize = function(buffer)
  return buffer:len() >= nyse_texasequities_imbalancesfeed_pillar_v2_2_n.packet_header.size
end

-- Dissect Packet
nyse_texasequities_imbalancesfeed_pillar_v2_2_n.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.data(packet)
  if not packet.visited then
  end
  nyse_texasequities_imbalancesfeed_pillar_v2_2_n.conversation.current = data
...
omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n:register_heuristic("udp", omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n_udp_heuristic)

-- Register Nyse TexasEquities ImbalancesFeed Pillar 2.2.n for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_texasequities_imbalancesfeed_pillar_v2_2_n)
