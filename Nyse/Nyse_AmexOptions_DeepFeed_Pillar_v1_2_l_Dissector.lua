...
-- Dissector Heuristic for Nyse AmexOptions DeepFeed Pillar 1.2.l
local function omi_nyse_amexoptions_deepfeed_pillar_v1_2_l_heuristic(buffer, packet, parent)
...
omi_nyse_amexoptions_deepfeed_pillar_v1_2_l:register_heuristic("udp", omi_nyse_amexoptions_deepfeed_pillar_v1_2_l_heuristic)
