...
local omi_nyse_nationalequities_bbo_pillar_v2_5_d = Proto("Omi.Nyse.NationalEquities.Bbo.Pillar.v2.5.d", "Nyse NationalEquities Bbo Pillar 2.5.d")
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.ask_price = ProtoField.new("Ask Price", "nyse.nationalequities.bbo.pillar.v2.5.d.askprice", ftypes.INT32)
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.bid_price = ProtoField.new("Bid Price", "nyse.nationalequities.bbo.pillar.v2.5.d.bidprice", ftypes.INT32)
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.prev_close_price = ProtoField.new("Prev Close Price", "nyse.nationalequities.bbo.pillar.v2.5.d.prevcloseprice", ftypes.UINT32)
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.price_1 = ProtoField.new("Price 1", "nyse.nationalequities.bbo.pillar.v2.5.d.price1", ftypes.UINT32)
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.price_2 = ProtoField.new("Price 2", "nyse.nationalequities.bbo.pillar.v2.5.d.price2", ftypes.UINT32)
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.send_time = ProtoField.new("Send Time", "nyse.nationalequities.bbo.pillar.v2.5.d.sendtime", ftypes.ABSOLUTE_TIME, nil, base.LOCAL)
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.send_time_utc = ProtoField.new("Send Time", "nyse.nationalequities.bbo.pillar.v2.5.d.sendtime.utc", ftypes.ABSOLUTE_TIME, nil, base.UTC)

-- Nyse NationalEquities Bbo 2.5.d Application Messages
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.bid_price_calculate = ProtoField.new("Bid Price Calculate", "nyse.nationalequities.bbo.pillar.v2.5.d.bidpricecalculate", ftypes.DOUBLE)

-----------------------------------------------------------------------
-- Nyse NationalEquities Bbo Pillar 2.5.d Formatting
-----------------------------------------------------------------------
...
-- 0=Local, 1=Utc
nyse_nationalequities_bbo_pillar_v2_5_d.absolute_time_base = 0

-- Ask Price Calculate format (true = decimal-scaled, false = raw mantissa)
nyse_nationalequities_bbo_pillar_v2_5_d.format_decimals = true
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.resolve_records = Pref.bool("Symbol Index Mapping Message", show.records, "Cache records and resolve cross-packet lookups")
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.format_decimals = Pref.bool("Format Decimals", true, "Format decimal-scaled fields as scaled values (off = raw mantissa)")

omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.absolute_time_base = Pref.enum("Absolute Time Base", 0, "Render absolute times in Utc or in the reader's local time", absolute_time_base_enum, false)

-- Handle changed preferences
function omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs_changed()

  -- Check if preferences have changed
  if show.records ~= omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.resolve_records then
    show.records = omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.resolve_records
  end
  ...
  if show.headers ~= omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_headers then
    show.headers = omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_headers
  end
  if show.structs ~= omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_structs then
    show.structs = omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_structs
  end
  if show.indexes ~= omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_indexes then
    show.indexes = omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_indexes
  end
  if show.sequences ~= omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_sequences then
    show.sequences = omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.show_sequences
  end
  if nyse_nationalequities_bbo_pillar_v2_5_d.format_decimals ~= omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.format_decimals then
    nyse_nationalequities_bbo_pillar_v2_5_d.format_decimals = omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.format_decimals
  end
  if nyse_nationalequities_bbo_pillar_v2_5_d.absolute_time_base ~= omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.absolute_time_base then
    nyse_nationalequities_bbo_pillar_v2_5_d.absolute_time_base = omi_nyse_nationalequities_bbo_pillar_v2_5_d.prefs.absolute_time_base
  end
end
...
nyse_nationalequities_bbo_pillar_v2_5_d.conversation = {}
nyse_nationalequities_bbo_pillar_v2_5_d.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nyse_nationalequities_bbo_pillar_v2_5_d.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nyse_nationalequities_bbo_pillar_v2_5_d.conversation.data = function(packet)
  local key = nyse_nationalequities_bbo_pillar_v2_5_d.conversation.key(packet)
  local data = nyse_nationalequities_bbo_pillar_v2_5_d.conversation.flows[key]
  if data == nil then
    data = { symbol_index_mapping_message = {} }
    nyse_nationalequities_bbo_pillar_v2_5_d.conversation.flows[key] = data
  end
  return data
end
...
nyse_nationalequities_bbo_pillar_v2_5_d.conversation.current = nil
...
nyse_nationalequities_bbo_pillar_v2_5_d.symbol_index.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nyse_nationalequities_bbo_pillar_v2_5_d.conversation.current.symbol_index_mapping_message[value]

  local field_tree = parent:add(omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.symbol_index, range, value, display)

  if record ~= nil then
    nyse_nationalequities_bbo_pillar_v2_5_d.symbol_index_mapping_message.current = record
...
-- Ask Price Calculate
nyse_nationalequities_bbo_pillar_v2_5_d.ask_price_calculate = {}

-- Display: Ask Price Calculate
nyse_nationalequities_bbo_pillar_v2_5_d.ask_price_calculate.display = function(value)
  return "Ask Price Calculate: " .. string.format("%g", value)
end

-- Composite: Ask Price Calculate
nyse_nationalequities_bbo_pillar_v2_5_d.ask_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_nationalequities_bbo_pillar_v2_5_d.ask_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_nationalequities_bbo_pillar_v2_5_d.ask_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.ask_price_calculate, range, value, display)
  local mantissa_display = nyse_nationalequities_bbo_pillar_v2_5_d.ask_price.display(mantissa)

  field_tree:add(omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.ask_price, range, mantissa, mantissa_display)
...
nyse_nationalequities_bbo_pillar_v2_5_d.ask_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_nationalequities_bbo_pillar_v2_5_d.format_decimals then
    local record = nyse_nationalequities_bbo_pillar_v2_5_d.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_nationalequities_bbo_pillar_v2_5_d.ask_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_nationalequities_bbo_pillar_v2_5_d.ask_price.dissect(buffer, offset, packet, parent)
end

-- Bid Price Calculate
nyse_nationalequities_bbo_pillar_v2_5_d.bid_price_calculate = {}

-- Display: Bid Price Calculate
nyse_nationalequities_bbo_pillar_v2_5_d.bid_price_calculate.display = function(value)
  return "Bid Price Calculate: " .. string.format("%g", value)
end

-- Composite: Bid Price Calculate
nyse_nationalequities_bbo_pillar_v2_5_d.bid_price_calculate.composite = function(buffer, offset, record, packet, parent)
  local length = nyse_nationalequities_bbo_pillar_v2_5_d.bid_price.size
  local range = buffer(offset, length)
  local mantissa = range:le_int()
  local value = mantissa / (10 ^ record.price_scale_code)
  local display = nyse_nationalequities_bbo_pillar_v2_5_d.bid_price_calculate.display(value)
  local field_tree = parent:add(omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.bid_price_calculate, range, value, display)
  local mantissa_display = nyse_nationalequities_bbo_pillar_v2_5_d.bid_price.display(mantissa)

  field_tree:add(omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.bid_price, range, mantissa, mantissa_display)
...
nyse_nationalequities_bbo_pillar_v2_5_d.bid_price_calculate.dissect = function(buffer, offset, packet, parent)
  if nyse_nationalequities_bbo_pillar_v2_5_d.format_decimals then
    local record = nyse_nationalequities_bbo_pillar_v2_5_d.symbol_index_mapping_message.current
    if record ~= nil and record.price_scale_code ~= nil then
      return nyse_nationalequities_bbo_pillar_v2_5_d.bid_price_calculate.composite(buffer, offset, record, packet, parent)
    end
  end

  return nyse_nationalequities_bbo_pillar_v2_5_d.bid_price.dissect(buffer, offset, packet, parent)
end
...
nyse_nationalequities_bbo_pillar_v2_5_d.quote_message.fields = function(buffer, offset, packet, parent)
  ...
  index, symbol_index, symbol_index_record = nyse_nationalequities_bbo_pillar_v2_5_d.symbol_index.dissect(buffer, index, packet, parent)
  ...
  -- Ask Price: Binary
  index, ask_price = nyse_nationalequities_bbo_pillar_v2_5_d.ask_price_calculate.dissect(buffer, index, packet, parent)

  -- Ask Volume: Binary
  index, ask_volume = nyse_nationalequities_bbo_pillar_v2_5_d.ask_volume.dissect(buffer, index, packet, parent)

  -- Bid Price: Binary
  index, bid_price = nyse_nationalequities_bbo_pillar_v2_5_d.bid_price_calculate.dissect(buffer, index, packet, parent)
...
nyse_nationalequities_bbo_pillar_v2_5_d.symbol_index_mapping_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nyse_nationalequities_bbo_pillar_v2_5_d.conversation.current.symbol_index_mapping_message[symbol_index] = {
...
nyse_nationalequities_bbo_pillar_v2_5_d.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nyse_nationalequities_bbo_pillar_v2_5_d.sequence ~= nil then
    local sequence = parent:add(omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.message_sequence_number, UInt64.new(nyse_nationalequities_bbo_pillar_v2_5_d.sequence + message_index - 1))
...
nyse_nationalequities_bbo_pillar_v2_5_d.send_time.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = nyse_nationalequities_bbo_pillar_v2_5_d.send_time.size
    ...
    local field = omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.send_time
    if nyse_nationalequities_bbo_pillar_v2_5_d.absolute_time_base == 1 then field = omi_nyse_nationalequities_bbo_pillar_v2_5_d.fields.send_time_utc end
    parent = parent:add(field, buffer(offset, length), NSTime.new(seconds, nanoseconds))
    local index = nyse_nationalequities_bbo_pillar_v2_5_d.send_time.fields(buffer, offset, packet, parent)
...
nyse_nationalequities_bbo_pillar_v2_5_d.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nyse_nationalequities_bbo_pillar_v2_5_d.sequence = seq_num
...
nyse_nationalequities_bbo_pillar_v2_5_d.packet.requiredsize = function(buffer)
  return buffer:len() >= nyse_nationalequities_bbo_pillar_v2_5_d.packet_header.size
end

-- Dissect Packet
nyse_nationalequities_bbo_pillar_v2_5_d.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nyse_nationalequities_bbo_pillar_v2_5_d.conversation.data(packet)
  if not packet.visited then
  end
  nyse_nationalequities_bbo_pillar_v2_5_d.conversation.current = data
...
-- Register Nyse NationalEquities Bbo Pillar 2.5.d for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nyse_nationalequities_bbo_pillar_v2_5_d)
