...
-- Dissector Heuristic for Nyse NationalEquities Bbo Pillar 2.5.d
local function omi_nyse_nationalequities_bbo_pillar_v2_5_d_heuristic(buffer, packet, parent)
...
omi_nyse_nationalequities_bbo_pillar_v2_5_d:register_heuristic("udp", omi_nyse_nationalequities_bbo_pillar_v2_5_d_heuristic)
