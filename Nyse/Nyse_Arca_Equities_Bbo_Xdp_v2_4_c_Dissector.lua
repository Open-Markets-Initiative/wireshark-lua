...
omi_nyse_arca_equities_bbo_xdp_v2_4_c.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nyse_arca_equities_bbo_xdp_v2_4_c.prefs_changed()
  ...
  if show.message_index ~= omi_nyse_arca_equities_bbo_xdp_v2_4_c.prefs.show_message_index then
    show.message_index = omi_nyse_arca_equities_bbo_xdp_v2_4_c.prefs.show_message_index
  end
end
