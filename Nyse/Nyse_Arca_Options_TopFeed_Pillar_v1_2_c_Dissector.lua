...
nyse_arca_options_topfeed_pillar_v1_2_c_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(nyse_arca_options_topfeed_pillar_v1_2_c.fields.message, buffer(offset, 0))
    local current = nyse_arca_options_topfeed_pillar_v1_2_c_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = nyse_arca_options_topfeed_pillar_v1_2_c_display.message(buffer, packet, element)
    element:append_text(display)
