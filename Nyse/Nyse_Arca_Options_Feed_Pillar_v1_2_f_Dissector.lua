...
omi_nyse_arca_options_feed_pillar_v1_2_f.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nyse_arca_options_feed_pillar_v1_2_f.prefs_changed()
  ...
  if show.message_index ~= omi_nyse_arca_options_feed_pillar_v1_2_f.prefs.show_message_index then
    show.message_index = omi_nyse_arca_options_feed_pillar_v1_2_f.prefs.show_message_index
  end
end
