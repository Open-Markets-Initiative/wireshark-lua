...
omi_coinbase_derivatives_ordersapi_sbe_v1_6.fields.post_only = ProtoField.new("Post Only", "coinbase.derivatives.ordersapi.sbe.v1.6.postonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
-- Coinbase Derivatives Sbe OrdersApi 1.6 Application Messages
...
omi_coinbase_derivatives_ordersapi_sbe_v1_6.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
function omi_coinbase_derivatives_ordersapi_sbe_v1_6.prefs_changed()
  ...
  if show.application_messages ~= omi_coinbase_derivatives_ordersapi_sbe_v1_6.prefs.show_application_messages then
    show.application_messages = omi_coinbase_derivatives_ordersapi_sbe_v1_6.prefs.show_application_messages
    changed = true
  end
...
coinbase_derivatives_ordersapi_sbe_v1_6.pong_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_ordersapi_sbe_v1_6.fields.pong_message, buffer(offset, 0))
    local index = coinbase_derivatives_ordersapi_sbe_v1_6.pong_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_6.pong_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_6.ping_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_ordersapi_sbe_v1_6.fields.ping_message, buffer(offset, 0))
    local index = coinbase_derivatives_ordersapi_sbe_v1_6.ping_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_6.ping_message.display(packet, parent, length)
    parent:append_text(display)
