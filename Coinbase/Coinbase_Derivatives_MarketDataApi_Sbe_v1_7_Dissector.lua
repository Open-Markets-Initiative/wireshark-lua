...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.retransmit_reject_message = function(buffer, offset, packet, parent)
  if show.retransmit_reject_message then
    ...
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.retransmit_reject_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.retransmit_reject_message_fields(buffer, offset, packet, element)
    ...
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.retransmit_reject_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.retransmit_request_message = function(buffer, offset, packet, parent)
  if show.retransmit_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.retransmit_request_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.retransmit_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.retransmit_request_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.end_of_cycle_message = function(buffer, offset, packet, parent)
  if show.end_of_cycle_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.end_of_cycle_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.end_of_cycle_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.end_of_cycle_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.end_of_snapshot_message = function(buffer, offset, packet, parent)
  if show.end_of_snapshot_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.end_of_snapshot_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.end_of_snapshot_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.end_of_snapshot_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_snapshot_message = function(buffer, offset, packet, parent)
  if show.order_snapshot_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.order_snapshot_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_snapshot_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_snapshot_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.logical_expiry = function(buffer, offset, packet, parent)
  if show.logical_expiry then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.logical_expiry, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.logical_expiry_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.logical_expiry_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_option_instrument_snapshot_message = function(buffer, offset, packet, parent)
  if show.start_of_option_instrument_snapshot_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.start_of_option_instrument_snapshot_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_option_instrument_snapshot_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_option_instrument_snapshot_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_spread_instrument_snapshot_message = function(buffer, offset, packet, parent)
  if show.start_of_spread_instrument_snapshot_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.start_of_spread_instrument_snapshot_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_spread_instrument_snapshot_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_spread_instrument_snapshot_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_outright_instrument_snapshot_message = function(buffer, offset, packet, parent)
  if show.start_of_outright_instrument_snapshot_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.start_of_outright_instrument_snapshot_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_outright_instrument_snapshot_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.start_of_outright_instrument_snapshot_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.instr_header = function(buffer, offset, packet, parent)
  if show.instr_header then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.instr_header, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.instr_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.instr_header_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.open_interest_message = function(buffer, offset, packet, parent)
  if show.open_interest_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.open_interest_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.open_interest_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.open_interest_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_session_volume_message = function(buffer, offset, packet, parent)
  if show.trade_session_volume_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.trade_session_volume_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_session_volume_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_session_volume_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.market_stat_message = function(buffer, offset, packet, parent)
  if show.market_stat_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.market_stat_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.market_stat_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.market_stat_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_bust_message = function(buffer, offset, packet, parent)
  if show.trade_bust_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.trade_bust_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_bust_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_bust_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.spread_trade_amend_message = function(buffer, offset, packet, parent)
  if show.spread_trade_amend_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.spread_trade_amend_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.spread_trade_amend_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.spread_trade_amend_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_amend_message = function(buffer, offset, packet, parent)
  if show.trade_amend_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.trade_amend_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_amend_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_amend_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_message = function(buffer, offset, packet, parent)
  if show.trade_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.trade_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_summary_message = function(buffer, offset, packet, parent)
  if show.trade_summary_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.trade_summary_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_summary_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trade_summary_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.implied_order_update_message = function(buffer, offset, packet, parent)
  if show.implied_order_update_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.implied_order_update_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.implied_order_update_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.implied_order_update_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_delete_message = function(buffer, offset, packet, parent)
  if show.order_delete_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.order_delete_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_delete_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_delete_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_put_message = function(buffer, offset, packet, parent)
  if show.order_put_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.order_put_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_put_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.order_put_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trading_status_update_message = function(buffer, offset, packet, parent)
  if show.trading_status_update_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.trading_status_update_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trading_status_update_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.trading_status_update_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.option_instrument_definition_message = function(buffer, offset, packet, parent)
  if show.option_instrument_definition_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.option_instrument_definition_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.option_instrument_definition_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.option_instrument_definition_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.spread_instrument_definition_message = function(buffer, offset, packet, parent)
  if show.spread_instrument_definition_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.spread_instrument_definition_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.spread_instrument_definition_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.spread_instrument_definition_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.outright_instrument_definition_message = function(buffer, offset, packet, parent)
  if show.outright_instrument_definition_message then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.outright_instrument_definition_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.outright_instrument_definition_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.outright_instrument_definition_message_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.message_header, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.message_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.message_header_fields(buffer, offset, packet, element)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.sbe_message = function(buffer, offset, packet, parent, size_of_sbe_message)
  ...
  if show.sbe_message then
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.sbe_message, buffer(offset, 0))
    local current = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.sbe_message_fields(buffer, offset, packet, element, size_of_sbe_message)
    element:set_len(size_of_sbe_message)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_7_display.sbe_message(buffer, packet, element)
    element:append_text(display)
...
coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.packet_header = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    local element = parent:add(coinbase_derivatives_marketdataapi_sbe_v1_7.fields.packet_header, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.packet_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_7_dissect.packet_header_fields(buffer, offset, packet, element)
  end
end
