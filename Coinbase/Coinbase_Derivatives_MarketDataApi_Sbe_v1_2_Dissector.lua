...
-- Protocol table
local coinbase_derivatives_marketdataapi_sbe_v1_2 = {}
...
coinbase_derivatives_marketdataapi_sbe_v1_2.padding.dissect = function(buffer, offset, packet, parent, size)
  ...
  local display = coinbase_derivatives_marketdataapi_sbe_v1_2.padding.display(value, buffer, offset, packet, parent, size)
...
-- Display: Details
coinbase_derivatives_marketdataapi_sbe_v1_2.details.display = function(value)
...
-- Dissect: Details
coinbase_derivatives_marketdataapi_sbe_v1_2.details.dissect = function(buffer, offset, packet, parent)
  local length = coinbase_derivatives_marketdataapi_sbe_v1_2.details.size
  local range = buffer(offset, length)
  ...
  local display = coinbase_derivatives_marketdataapi_sbe_v1_2.details.display(value, buffer, offset, packet, parent)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.retry_delay_nanos.display = function(value)
  return "Retry Delay Nanos: "..value
end

-- Dissect: Retry Delay Nanos
coinbase_derivatives_marketdataapi_sbe_v1_2.retry_delay_nanos.dissect = function(buffer, offset, packet, parent)
  local length = coinbase_derivatives_marketdataapi_sbe_v1_2.retry_delay_nanos.size
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = coinbase_derivatives_marketdataapi_sbe_v1_2.retry_delay_nanos.display(value, buffer, offset, packet, parent)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_reject_message.dissect = function(buffer, offset, packet, parent)
  if show.retransmit_reject_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_reject_message.display(packet, parent, length)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_request_message.dissect = function(buffer, offset, packet, parent)
  if show.retransmit_request_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_request_message.fields(buffer, offset, packet, parent)
  end
end

-- Is Prior Settlement Theoretical
coinbase_derivatives_marketdataapi_sbe_v1_2.is_prior_settlement_theoretical = {}

-- Reserved 15
coinbase_derivatives_marketdataapi_sbe_v1_2.reserved_15 = {}
...
coinbase_derivatives_marketdataapi_sbe_v1_2.end_of_snapshot_message.fields = function(buffer, offset, packet, parent)
  ...
  index, definition_flags = coinbase_derivatives_marketdataapi_sbe_v1_2.definition_flags.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: End Of Snapshot Message
coinbase_derivatives_marketdataapi_sbe_v1_2.end_of_snapshot_message.dissect = function(buffer, offset, packet, parent)
  if show.end_of_snapshot_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.end_of_snapshot_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.end_of_snapshot_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.end_of_snapshot_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.order_snapshot_message.dissect = function(buffer, offset, packet, parent)
  if show.order_snapshot_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.order_snapshot_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.order_snapshot_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_spread_instrument_snapshot_message.dissect = function(buffer, offset, packet, parent)
  if show.start_of_spread_instrument_snapshot_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_spread_instrument_snapshot_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_spread_instrument_snapshot_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_spread_instrument_snapshot_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_outright_instrument_snapshot_message.dissect = function(buffer, offset, packet, parent)
  if show.start_of_outright_instrument_snapshot_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_outright_instrument_snapshot_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_outright_instrument_snapshot_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_outright_instrument_snapshot_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.instr_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Instrument Flags: 1 Byte Unsigned Fixed Width Integer
  index, instrument_flags = coinbase_derivatives_marketdataapi_sbe_v1_2.instrument_flags.dissect(buffer, index, packet, parent)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.instr_header.dissect = function(buffer, offset, packet, parent)
  if show.instr_header then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.instr_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.instr_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.instr_header.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.open_interest_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.open_interest_message.dissect = function(buffer, offset, packet, parent)
  if show.open_interest_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.open_interest_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.open_interest_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.open_interest_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_session_volume_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_session_volume_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_session_volume_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_session_volume_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_session_volume_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_session_volume_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.market_stat_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.market_stat_message.dissect = function(buffer, offset, packet, parent)
  if show.market_stat_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.market_stat_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.market_stat_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_bust_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_bust_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_bust_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_bust_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_bust_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.spread_trade_amend_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.spread_trade_amend_message.dissect = function(buffer, offset, packet, parent)
  if show.spread_trade_amend_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.spread_trade_amend_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.spread_trade_amend_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.spread_trade_amend_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_amend_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_amend_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_amend_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_amend_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_amend_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_amend_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_marketdataapi_sbe_v1_2.fields.trade_message, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_summary_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trade_summary_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_summary_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_summary_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.trade_summary_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.implied_order_update_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.implied_order_update_message.dissect = function(buffer, offset, packet, parent)
  if show.implied_order_update_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.implied_order_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.implied_order_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.implied_order_update_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.order_delete_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.order_delete_message.dissect = function(buffer, offset, packet, parent)
  if show.order_delete_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.order_delete_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.order_delete_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_delete_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.order_put_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.order_put_message.dissect = function(buffer, offset, packet, parent)
  if show.order_put_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.order_put_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.order_put_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_put_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trading_status_update_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.trading_status_update_message.dissect = function(buffer, offset, packet, parent)
  if show.trading_status_update_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.trading_status_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.trading_status_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trading_status_update_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.spread_instrument_definition_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.spread_instrument_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.spread_instrument_definition_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.spread_instrument_definition_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.spread_instrument_definition_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.spread_instrument_definition_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_marketdataapi_sbe_v1_2.outright_instrument_definition_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
coinbase_derivatives_marketdataapi_sbe_v1_2.outright_instrument_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.outright_instrument_definition_message then
    ...
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.outright_instrument_definition_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.outright_instrument_definition_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.outright_instrument_definition_message.fields(buffer, offset, packet, parent)
  end
end

-- Payload
coinbase_derivatives_marketdataapi_sbe_v1_2.payload = {}

-- Calculate runtime size of: Payload
coinbase_derivatives_marketdataapi_sbe_v1_2.payload.size = function(buffer, offset, template_id)
  -- Size of Outright Instrument Definition Message
  if template_id == 10 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.outright_instrument_definition_message.size(buffer, offset)
  end
  -- Size of Spread Instrument Definition Message
  if template_id == 11 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.spread_instrument_definition_message.size(buffer, offset)
  end
  -- Size of Trading Status Update Message
  if template_id == 17 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trading_status_update_message.size(buffer, offset)
  end
  -- Size of Order Put Message
  if template_id == 20 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_put_message.size(buffer, offset)
  end
  -- Size of Order Delete Message
  if template_id == 21 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_delete_message.size(buffer, offset)
  end
  -- Size of Implied Order Update Message
  if template_id == 22 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.implied_order_update_message.size(buffer, offset)
  end
  -- Size of Trade Summary Message
  if template_id == 33 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_summary_message.size(buffer, offset)
  end
  -- Size of Trade Message
  if template_id == 30 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_message.size(buffer, offset)
  end
  -- Size of Trade Amend Message
  if template_id == 31 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_amend_message.size(buffer, offset)
  end
  -- Size of Spread Trade Amend Message
  if template_id == 34 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.spread_trade_amend_message.size(buffer, offset)
  end
  -- Size of Trade Bust Message
  if template_id == 32 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_bust_message.size(buffer, offset)
  end
  -- Size of Market Stat Message
  if template_id == 40 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.market_stat_message.size(buffer, offset)
  end
  -- Size of Trade Session Volume Message
  if template_id == 41 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_session_volume_message.size(buffer, offset)
  end
  -- Size of Open Interest Message
  if template_id == 42 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.open_interest_message.size(buffer, offset)
  end
  -- Size of Start Of Outright Instrument Snapshot Message
  if template_id == 110 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_outright_instrument_snapshot_message.size(buffer, offset)
  end
  -- Size of Start Of Spread Instrument Snapshot Message
  if template_id == 111 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_spread_instrument_snapshot_message.size(buffer, offset)
  end
  -- Size of Order Snapshot Message
  if template_id == 120 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_snapshot_message.size(buffer, offset)
  end
  -- Size of End Of Snapshot Message
  if template_id == 122 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.end_of_snapshot_message.size(buffer, offset)
  end
  -- Size of Retransmit Request Message
  if template_id == 200 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_request_message.size(buffer, offset)
  end
  -- Size of Retransmit Reject Message
  if template_id == 202 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_reject_message.size(buffer, offset)
  end
...
-- Display: Payload
coinbase_derivatives_marketdataapi_sbe_v1_2.payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
coinbase_derivatives_marketdataapi_sbe_v1_2.payload.branches = function(buffer, offset, packet, parent, template_id)
  -- Dissect Outright Instrument Definition Message
  if template_id == 10 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.outright_instrument_definition_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Spread Instrument Definition Message
  if template_id == 11 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.spread_instrument_definition_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trading Status Update Message
  if template_id == 17 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trading_status_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Put Message
  if template_id == 20 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_put_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Delete Message
  if template_id == 21 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_delete_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Implied Order Update Message
  if template_id == 22 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.implied_order_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Summary Message
  if template_id == 33 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_summary_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Message
  if template_id == 30 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Amend Message
  if template_id == 31 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_amend_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Spread Trade Amend Message
  if template_id == 34 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.spread_trade_amend_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Bust Message
  if template_id == 32 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_bust_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Market Stat Message
  if template_id == 40 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.market_stat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Session Volume Message
  if template_id == 41 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.trade_session_volume_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Open Interest Message
  if template_id == 42 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.open_interest_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Outright Instrument Snapshot Message
  if template_id == 110 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_outright_instrument_snapshot_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Spread Instrument Snapshot Message
  if template_id == 111 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.start_of_spread_instrument_snapshot_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Snapshot Message
  if template_id == 120 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.order_snapshot_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Snapshot Message
  if template_id == 122 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.end_of_snapshot_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Request Message
  if template_id == 200 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Reject Message
  if template_id == 202 then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.retransmit_reject_message.dissect(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
coinbase_derivatives_marketdataapi_sbe_v1_2.payload.dissect = function(buffer, offset, packet, parent, template_id)
  if not show.payload then
    return coinbase_derivatives_marketdataapi_sbe_v1_2.payload.branches(buffer, offset, packet, parent, template_id)
  end

  -- Calculate size and check that branch is not empty
  local size = coinbase_derivatives_marketdataapi_sbe_v1_2.payload.size(buffer, offset, template_id)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = coinbase_derivatives_marketdataapi_sbe_v1_2.payload.display(buffer, packet, parent)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.message_header.dissect = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_marketdataapi_sbe_v1_2.fields.message_header, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.message_header.fields(buffer, offset, packet, parent)
  end
end

-- Sbe Message
coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message = {}

-- Display: Sbe Message
coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sbe Message
coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message.fields = function(buffer, offset, packet, parent, size_of_sbe_message)
  local index = offset

  -- Message Header: Struct of 5 fields
  index, message_header = coinbase_derivatives_marketdataapi_sbe_v1_2.message_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Template Id
  local template_id = buffer(index - 6, 2):le_uint()

  -- Payload: Runtime Type with 20 branches
  index = coinbase_derivatives_marketdataapi_sbe_v1_2.payload.dissect(buffer, index, packet, parent, template_id)
  ...
  -- Padding: 0 Byte
  index, padding = coinbase_derivatives_marketdataapi_sbe_v1_2.padding.dissect(buffer, index, packet, parent, size_of_padding)

  return index
end

-- Dissect: Sbe Message
coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message.dissect = function(buffer, offset, packet, parent, size_of_sbe_message)
  ...
  if show.sbe_message then
    ...
    local current = coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message.fields(buffer, offset, packet, parent, size_of_sbe_message)
    parent:set_len(size_of_sbe_message)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message.fields(buffer, offset, packet, parent, size_of_sbe_message)
...
coinbase_derivatives_marketdataapi_sbe_v1_2.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Sending Time: 8 Byte Signed Fixed Width Integer
  index, sending_time = coinbase_derivatives_marketdataapi_sbe_v1_2.sending_time.dissect(buffer, index, packet, parent)

  -- Seq Num: 8 Byte Signed Fixed Width Integer
  index, seq_num = coinbase_derivatives_marketdataapi_sbe_v1_2.seq_num.dissect(buffer, index, packet, parent)

  -- Channel Id: 2 Byte Unsigned Fixed Width Integer
  index, channel_id = coinbase_derivatives_marketdataapi_sbe_v1_2.channel_id.dissect(buffer, index, packet, parent)
  ...
  index, snapshot_instrument_id = coinbase_derivatives_marketdataapi_sbe_v1_2.snapshot_instrument_id.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Packet Header
coinbase_derivatives_marketdataapi_sbe_v1_2.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_marketdataapi_sbe_v1_2.fields.packet_header, buffer(offset, 0))
    local index = coinbase_derivatives_marketdataapi_sbe_v1_2.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_marketdataapi_sbe_v1_2.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_marketdataapi_sbe_v1_2.packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Packet
coinbase_derivatives_marketdataapi_sbe_v1_2.packet = {}

-- Dissect Packet
coinbase_derivatives_marketdataapi_sbe_v1_2.packet.dissect = function(buffer, packet, parent)
  local index = 0

  -- Packet Header: Struct of 6 fields
  index, packet_header = coinbase_derivatives_marketdataapi_sbe_v1_2.packet_header.dissect(buffer, index, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, sbe_message = coinbase_derivatives_marketdataapi_sbe_v1_2.sbe_message.dissect(buffer, index, packet, parent, frame_length)
  end
...
function omi_coinbase_derivatives_marketdataapi_sbe_v1_2.dissector(buffer, packet, parent)
  ...
  return coinbase_derivatives_marketdataapi_sbe_v1_2.packet.dissect(buffer, packet, protocol)
end
