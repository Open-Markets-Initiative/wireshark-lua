...
coinbase_derivatives_ordersapi_sbe_v1_3_dissect.data_fields = function(buffer, offset, packet, parent)
  ...
  index, data_value = coinbase_derivatives_ordersapi_sbe_v1_3_dissect.data_value(buffer, index, packet, parent, data_length)
...
coinbase_derivatives_ordersapi_sbe_v1_3_dissect.sbe_message_fields = function(buffer, offset, packet, parent, size_of_sbe_message)
  ...
  -- Padding: 0 Byte
  index, padding = coinbase_derivatives_ordersapi_sbe_v1_3_dissect.padding(buffer, index, packet, parent, size_of_padding)
