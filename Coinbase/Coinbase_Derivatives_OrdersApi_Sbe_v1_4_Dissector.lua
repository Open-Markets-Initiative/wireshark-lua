...
-- Protocol table
local coinbase_derivatives_ordersapi_sbe_v1_4 = {}
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_details = {}

-- Size: Event Resend Reject Details
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_details.size = 23

-- Display: Event Resend Reject Details
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_details.display = function(value)
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_details.dissect = function(buffer, offset, packet, parent)
  local length = coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_details.size
...
coinbase_derivatives_ordersapi_sbe_v1_4.resend_reject_reason = {}

-- Size: Resend Reject Reason
coinbase_derivatives_ordersapi_sbe_v1_4.resend_reject_reason.size = 1

-- Display: Resend Reject Reason
coinbase_derivatives_ordersapi_sbe_v1_4.resend_reject_reason.display = function(value)
  if value == 1 then
...
coinbase_derivatives_ordersapi_sbe_v1_4.resend_reject_reason.dissect = function(buffer, offset, packet, parent)
  local length = coinbase_derivatives_ordersapi_sbe_v1_4.resend_reject_reason.size
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = coinbase_derivatives_ordersapi_sbe_v1_4.resend_reject_reason.display(value, buffer, offset, packet, parent)
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.resend_reject_reason.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_details.size

  return index
end

-- Display: Event Resend Reject Message
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.dissect = function(buffer, offset, packet, parent)
  if show.event_resend_reject_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_complete_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.resent_event_count.size

  return index
end

-- Display: Event Resend Complete Message
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_complete_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_complete_message.dissect = function(buffer, offset, packet, parent)
  if show.event_resend_complete_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_complete_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_complete_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message = {}

-- Calculate size of: Event Resend Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.begin_exec_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.end_exec_id.size

  return index
end

-- Display: Event Resend Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message.dissect = function(buffer, offset, packet, parent)
  if show.event_resend_request_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message = {}

-- Calculate size of: Last Exec Id Message
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.timestamp.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id.size
...
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.dissect = function(buffer, offset, packet, parent)
  if show.last_exec_id_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.fields(buffer, offset, packet, parent)
  end
end

-- Last Exec Id Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message = {}

-- Calculate size of: Last Exec Id Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message.dissect = function(buffer, offset, packet, parent)
  if show.last_exec_id_request_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message = {}

-- Calculate size of: Spread Order Filled Message
coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.timestamp.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.exec_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.match_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.client_order_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.order_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.filled_vwap.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.total_filled.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.available_qty.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.fill_price.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.leg_1_fill_price.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.leg_2_fill_price.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.fill_qty.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.instrument_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.is_aggressor.size

  return index
end

-- Display: Spread Order Filled Message
coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.dissect = function(buffer, offset, packet, parent)
  if show.spread_order_filled_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Filled Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message = {}

-- Calculate size of: Order Filled Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.dissect = function(buffer, offset, packet, parent)
  if show.order_filled_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.error_message.size

  return index
end

-- Display: Unlock Trading Reject Message
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.dissect = function(buffer, offset, packet, parent)
  if show.unlock_trading_reject_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_ack_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.num_users_affected.size

  return index
end

-- Display: Unlock Trading Ack Message
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_ack_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.unlock_trading_ack_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message = {}

-- Calculate size of: Unlock Trading Message
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.current_session_only.size

  return index
end

-- Display: Unlock Trading Message
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.dissect = function(buffer, offset, packet, parent)
  if show.unlock_trading_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.fields(buffer, offset, packet, parent)
  end
end

-- Mass Cancel Order Reject Message
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message = {}

-- Calculate size of: Mass Cancel Order Reject Message
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.dissect = function(buffer, offset, packet, parent)
  if show.mass_cancel_order_reject_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_ack_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.canceled_count.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.only_current_session.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.trading_lock_applied.size

  return index
end

-- Display: Mass Cancel Order Ack Message
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_ack_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.mass_cancel_order_ack_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message = {}

-- Calculate size of: Mass Cancel Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.limit_price.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.instrument_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.side.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.current_session_only.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.request_trading_lock.size

  return index
end

-- Display: Mass Cancel Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.dissect = function(buffer, offset, packet, parent)
  if show.mass_cancel_order_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.order_id_optional.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_reason.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_details.size

  return index
end

-- Display: Cancel Order Reject Message
coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_message.dissect = function(buffer, offset, packet, parent)
  if show.cancel_order_reject_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message = {}

-- Calculate size of: Order Canceled Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.receive_time.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.total_filled.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.instrument_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.cancel_reason.size

  return index
end

-- Display: Order Canceled Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.dissect = function(buffer, offset, packet, parent)
  if show.order_canceled_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.fields(buffer, offset, packet, parent)
  end
end

-- Cancel Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message = {}

-- Calculate size of: Cancel Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.dissect = function(buffer, offset, packet, parent)
  if show.cancel_order_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Replaced Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message = {}

-- Calculate size of: Order Replaced Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.dissect = function(buffer, offset, packet, parent)
  if show.order_replaced_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_reason.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_details.size

  return index
end

-- Display: Order Reject Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_message.dissect = function(buffer, offset, packet, parent)
  if show.order_reject_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message = {}

-- Calculate size of: Stream Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.last_processed_fill_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.limit_price.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.quantity.size
...
coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message.dissect = function(buffer, offset, packet, parent)
  if show.stream_order_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message = {}

-- Calculate size of: Replace Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.new_limit_price.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.new_quantity.size
...
coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.dissect = function(buffer, offset, packet, parent)
  if show.replace_order_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.fields(buffer, offset, packet, parent)
  end
end

-- Order Entered Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message = {}

-- Calculate size of: Order Entered Message
coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.dissect = function(buffer, offset, packet, parent)
  if show.order_entered_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.fields(buffer, offset, packet, parent)
  end
end

-- New Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message = {}

-- Calculate size of: New Order Message
coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.dissect = function(buffer, offset, packet, parent)
  if show.new_order_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.fields(buffer, offset, packet, parent)
  end
end

-- Set Ack Message
coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message = {}

-- Calculate size of: Set Ack Message
coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.set_ack_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.trader.size

  return index
end

-- Display: Set Trader Message
coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.dissect = function(buffer, offset, packet, parent)
  if show.set_trader_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.set_account_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.account.size

  return index
end

-- Display: Set Account Message
coinbase_derivatives_ordersapi_sbe_v1_4.set_account_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.set_account_message.dissect = function(buffer, offset, packet, parent)
  if show.set_account_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.set_account_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.set_account_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message = {}

-- Calculate size of: Instrument Info Message
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.security_type.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.instrument_status.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.is_last_message.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.reserved_byte.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.symbol.size

  return index
end

-- Display: Instrument Info Message
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.dissect = function(buffer, offset, packet, parent)
  if show.instrument_info_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.fields(buffer, offset, packet, parent)
  end
end

-- Instrument Info Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message = {}

-- Calculate size of: Instrument Info Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.dissect = function(buffer, offset, packet, parent)
  if show.instrument_info_request_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.data.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.data_length.size
...
-- Display: Data
coinbase_derivatives_ordersapi_sbe_v1_4.data.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.data.fields = function(buffer, offset, packet, parent)
  ...
  if data_value_exists then
    ...
    index, data_value = coinbase_derivatives_ordersapi_sbe_v1_4.data_value.dissect(buffer, index, packet, parent, data_length)
  end
...
-- Dissect: Data
coinbase_derivatives_ordersapi_sbe_v1_4.data.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.data then
    local length = coinbase_derivatives_ordersapi_sbe_v1_4.data.size(buffer, offset)
    local range = buffer(offset, length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.data.display(buffer, packet, parent)
...
-- Pong Message
coinbase_derivatives_ordersapi_sbe_v1_4.pong_message = {}

-- Calculate size of: Pong Message
coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.correlation_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.request_time.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.server_time.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.trading_instrument_status.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.data.size(buffer, offset + index)

  return index
end

-- Display: Pong Message
coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.fields = function(buffer, offset, packet, parent)
  ...
  index, data = coinbase_derivatives_ordersapi_sbe_v1_4.data.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Pong Message
coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.pong_message then
    local length = coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.size(buffer, offset)
    local range = buffer(offset, length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.display(buffer, packet, parent)
    parent = parent:add(omi_coinbase_derivatives_ordersapi_sbe_v1_4.fields.pong_message, range, display)
  end

  return coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.fields(buffer, offset, packet, parent)
end

-- Ping Message
coinbase_derivatives_ordersapi_sbe_v1_4.ping_message = {}

-- Calculate size of: Ping Message
coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.ping_message then
    local length = coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.size(buffer, offset)
    local range = buffer(offset, length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.display(buffer, packet, parent)
    parent = parent:add(omi_coinbase_derivatives_ordersapi_sbe_v1_4.fields.ping_message, range, display)
  end

  return coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.fields(buffer, offset, packet, parent)
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.new_sequence_number.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_padding.size

  return index
end

-- Display: Gap Fill Message
coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_message.dissect = function(buffer, offset, packet, parent)
  if show.gap_fill_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message = {}

-- Calculate size of: Resend Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.from_sequence_number.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.to_sequence_number.size

  return index
end

-- Display: Resend Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.dissect = function(buffer, offset, packet, parent)
  if show.resend_request_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.fields(buffer, offset, packet, parent)
  end
end

-- Test Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message = {}

-- Calculate size of: Test Request Message
coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.dissect = function(buffer, offset, packet, parent)
  if show.test_request_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.fields(buffer, offset, packet, parent)
  end
end

-- Heartbeat Message
coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message = {}

-- Calculate size of: Heartbeat Message
coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.dissect = function(buffer, offset, packet, parent)
  if show.heartbeat_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.reason.size

  return index
end

-- Display: Logged Out Message
coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.dissect = function(buffer, offset, packet, parent)
  if show.logged_out_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.fields(buffer, offset, packet, parent)
  end
end

-- Logout Message
coinbase_derivatives_ordersapi_sbe_v1_4.logout_message = {}

-- Calculate size of: Logout Message
coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.size = function(buffer, offset)
  local index = 0
...
coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.dissect = function(buffer, offset, packet, parent)
  if show.logout_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.fields(buffer, offset, packet, parent)
  end
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.logon_conf_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_interval_seconds.size

  return index
end

-- Display: Logon Conf Message
coinbase_derivatives_ordersapi_sbe_v1_4.logon_conf_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.logon_conf_message.dissect = function(buffer, offset, packet, parent)
  if show.logon_conf_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.logon_conf_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.logon_conf_message.display(packet, parent, length)
    parent:append_text(display)
...
-- Logon Message
coinbase_derivatives_ordersapi_sbe_v1_4.logon_message = {}

-- Calculate size of: Logon Message
coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.size = function(buffer, offset)
  local index = 0

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.username.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.password.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.reset_seq_num.size

  return index
end

-- Display: Logon Message
coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.dissect = function(buffer, offset, packet, parent)
  if show.logon_message then
    ...
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.fields(buffer, offset, packet, parent)
  end
end

-- Payload
coinbase_derivatives_ordersapi_sbe_v1_4.payload = {}

-- Calculate runtime size of: Payload
coinbase_derivatives_ordersapi_sbe_v1_4.payload.size = function(buffer, offset, template_id)
  -- Size of Logon Message
  if template_id == 100 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.size(buffer, offset)
  end
  -- Size of Logon Conf Message
  if template_id == 200 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logon_conf_message.size(buffer, offset)
  end
  -- Size of Logout Message
  if template_id == 101 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.size(buffer, offset)
  end
  -- Size of Logged Out Message
  if template_id == 201 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.size(buffer, offset)
  end
  -- Size of Heartbeat Message
  if template_id == 10 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.size(buffer, offset)
  end
  -- Size of Test Request Message
  if template_id == 11 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.size(buffer, offset)
  end
  -- Size of Resend Request Message
  if template_id == 102 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.size(buffer, offset)
  end
  -- Size of Gap Fill Message
  if template_id == 202 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_message.size(buffer, offset)
  end
  -- Size of Ping Message
  if template_id == 102 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.size(buffer, offset)
  end
  -- Size of Pong Message
  if template_id == 202 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.size(buffer, offset)
  end
  -- Size of Instrument Info Request Message
  if template_id == 103 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.size(buffer, offset)
  end
  -- Size of Instrument Info Message
  if template_id == 203 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.size(buffer, offset)
  end
  -- Size of Set Account Message
  if template_id == 105 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_account_message.size(buffer, offset)
  end
  -- Size of Set Trader Message
  if template_id == 106 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.size(buffer, offset)
  end
  -- Size of Set Ack Message
  if template_id == 205 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.size(buffer, offset)
  end
  -- Size of New Order Message
  if template_id == 110 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.size(buffer, offset)
  end
  -- Size of Order Entered Message
  if template_id == 210 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.size(buffer, offset)
  end
  -- Size of Replace Order Message
  if template_id == 120 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.size(buffer, offset)
  end
  -- Size of Stream Order Message
  if template_id == 121 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message.size(buffer, offset)
  end
  -- Size of Order Reject Message
  if template_id == 221 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_message.size(buffer, offset)
  end
  -- Size of Order Replaced Message
  if template_id == 220 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.size(buffer, offset)
  end
  -- Size of Cancel Order Message
  if template_id == 130 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.size(buffer, offset)
  end
  -- Size of Order Canceled Message
  if template_id == 230 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.size(buffer, offset)
  end
  -- Size of Cancel Order Reject Message
  if template_id == 233 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_message.size(buffer, offset)
  end
  -- Size of Mass Cancel Order Message
  if template_id == 131 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.size(buffer, offset)
  end
  -- Size of Mass Cancel Order Ack Message
  if template_id == 231 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_ack_message.size(buffer, offset)
  end
  -- Size of Mass Cancel Order Reject Message
  if template_id == 232 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.size(buffer, offset)
  end
  -- Size of Unlock Trading Message
  if template_id == 132 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.size(buffer, offset)
  end
  -- Size of Unlock Trading Ack Message
  if template_id == 234 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_ack_message.size(buffer, offset)
  end
  -- Size of Unlock Trading Reject Message
  if template_id == 235 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.size(buffer, offset)
  end
  -- Size of Order Filled Message
  if template_id == 240 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.size(buffer, offset)
  end
  -- Size of Spread Order Filled Message
  if template_id == 241 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.size(buffer, offset)
  end
  -- Size of Last Exec Id Request Message
  if template_id == 150 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message.size(buffer, offset)
  end
  -- Size of Last Exec Id Message
  if template_id == 250 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.size(buffer, offset)
  end
  -- Size of Event Resend Request Message
  if template_id == 152 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message.size(buffer, offset)
  end
  -- Size of Event Resend Complete Message
  if template_id == 252 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_complete_message.size(buffer, offset)
  end
  -- Size of Event Resend Reject Message
  if template_id == 253 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.size(buffer, offset)
  end
...
-- Display: Payload
coinbase_derivatives_ordersapi_sbe_v1_4.payload.display = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
coinbase_derivatives_ordersapi_sbe_v1_4.payload.branches = function(buffer, offset, packet, parent, template_id)
  -- Dissect Logon Message
  if template_id == 100 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logon_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logon Conf Message
  if template_id == 200 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logon_conf_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Message
  if template_id == 101 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logout_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logged Out Message
  if template_id == 201 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.logged_out_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Heartbeat Message
  if template_id == 10 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Test Request Message
  if template_id == 11 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.test_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Resend Request Message
  if template_id == 102 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.resend_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Gap Fill Message
  if template_id == 202 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.gap_fill_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Ping Message
  if template_id == 102 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Pong Message
  if template_id == 202 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Instrument Info Request Message
  if template_id == 103 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Instrument Info Message
  if template_id == 203 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.instrument_info_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Set Account Message
  if template_id == 105 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_account_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Set Trader Message
  if template_id == 106 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_trader_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Set Ack Message
  if template_id == 205 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.set_ack_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect New Order Message
  if template_id == 110 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.new_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Entered Message
  if template_id == 210 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_entered_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Replace Order Message
  if template_id == 120 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.replace_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stream Order Message
  if template_id == 121 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.stream_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Reject Message
  if template_id == 221 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_reject_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Replaced Message
  if template_id == 220 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_replaced_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cancel Order Message
  if template_id == 130 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Canceled Message
  if template_id == 230 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_canceled_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cancel Order Reject Message
  if template_id == 233 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.cancel_order_reject_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Order Message
  if template_id == 131 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Order Ack Message
  if template_id == 231 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_ack_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Mass Cancel Order Reject Message
  if template_id == 232 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.mass_cancel_order_reject_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Unlock Trading Message
  if template_id == 132 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Unlock Trading Ack Message
  if template_id == 234 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_ack_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Unlock Trading Reject Message
  if template_id == 235 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.unlock_trading_reject_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Order Filled Message
  if template_id == 240 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.order_filled_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Spread Order Filled Message
  if template_id == 241 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.spread_order_filled_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Last Exec Id Request Message
  if template_id == 150 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Last Exec Id Message
  if template_id == 250 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.last_exec_id_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Event Resend Request Message
  if template_id == 152 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Event Resend Complete Message
  if template_id == 252 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_complete_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Event Resend Reject Message
  if template_id == 253 then
    return coinbase_derivatives_ordersapi_sbe_v1_4.event_resend_reject_message.dissect(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
coinbase_derivatives_ordersapi_sbe_v1_4.payload.dissect = function(buffer, offset, packet, parent, template_id)
  if not show.payload then
    return coinbase_derivatives_ordersapi_sbe_v1_4.payload.branches(buffer, offset, packet, parent, template_id)
  end

  -- Calculate size and check that branch is not empty
  local size = coinbase_derivatives_ordersapi_sbe_v1_4.payload.size(buffer, offset, template_id)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = coinbase_derivatives_ordersapi_sbe_v1_4.payload.display(buffer, packet, parent)
...
-- Message Header
coinbase_derivatives_ordersapi_sbe_v1_4.message_header = {}

-- Calculate size of: Message Header
coinbase_derivatives_ordersapi_sbe_v1_4.message_header.size = function(buffer, offset)
  local index = 0
  ...
  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.sequence_number.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.last_processed_seq_no.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.reserved.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.send_time_epoch_nanos.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.block_length.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.template_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.schema_id.size

  index = index + coinbase_derivatives_ordersapi_sbe_v1_4.version.size

  return index
end

-- Display: Message Header
coinbase_derivatives_ordersapi_sbe_v1_4.message_header.display = function(packet, parent, length)
  return ""
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.message_header.dissect = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_ordersapi_sbe_v1_4.fields.message_header, buffer(offset, 0))
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return coinbase_derivatives_ordersapi_sbe_v1_4.message_header.fields(buffer, offset, packet, parent)
  end
end

-- Sbe Message
coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message = {}

-- Display: Sbe Message
coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sbe Message
coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message.fields = function(buffer, offset, packet, parent, size_of_sbe_message)
  local index = offset

  -- Message Header: Struct of 11 fields
  index, message_header = coinbase_derivatives_ordersapi_sbe_v1_4.message_header.dissect(buffer, index, packet, parent)
...
-- Dissect: Sbe Message
coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message.dissect = function(buffer, offset, packet, parent, size_of_sbe_message)
  ...
  if show.sbe_message then
    ...
    local current = coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message.fields(buffer, offset, packet, parent, size_of_sbe_message)
    parent:set_len(size_of_sbe_message)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message.fields(buffer, offset, packet, parent, size_of_sbe_message)
...
local sbe_message_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < coinbase_derivatives_ordersapi_sbe_v1_4.message_header.size(buffer, index) then
...
-- Packet
coinbase_derivatives_ordersapi_sbe_v1_4.packet = {}

-- Dissect Packet
coinbase_derivatives_ordersapi_sbe_v1_4.packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = coinbase_derivatives_ordersapi_sbe_v1_4.sbe_message.dissect(buffer, index, packet, parent, size_of_sbe_message)
    else
...
function omi_coinbase_derivatives_ordersapi_sbe_v1_4.dissector(buffer, packet, parent)
  ...
  return coinbase_derivatives_ordersapi_sbe_v1_4.packet.dissect(buffer, packet, protocol)
end
...
coinbase_derivatives_ordersapi_sbe_v1_4.packet.requiredsize = function(buffer)

  return true
end

-- Verify Schema Id Field
coinbase_derivatives_ordersapi_sbe_v1_4.schema_id.verify = function(buffer)
...
coinbase_derivatives_ordersapi_sbe_v1_4.version.verify = function(buffer)
  -- Attempt to read field
...
local function omi_coinbase_derivatives_ordersapi_sbe_v1_4_heuristic(buffer, packet, parent)
  ...
  if not coinbase_derivatives_ordersapi_sbe_v1_4.packet.requiredsize(buffer) then return false end

  -- Verify Schema Id
  if not coinbase_derivatives_ordersapi_sbe_v1_4.schema_id.verify(buffer) then return false end

  -- Verify Version
  if not coinbase_derivatives_ordersapi_sbe_v1_4.version.verify(buffer) then return false end
