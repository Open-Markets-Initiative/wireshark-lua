...
coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.dissect = function(buffer, offset, packet, parent)
  if show.pong_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_ordersapi_sbe_v1_4.fields.pong_message, buffer(offset, 0))
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.pong_message.display(packet, parent, length)
    parent:append_text(display)
...
coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.dissect = function(buffer, offset, packet, parent)
  if show.ping_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_coinbase_derivatives_ordersapi_sbe_v1_4.fields.ping_message, buffer(offset, 0))
    local index = coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = coinbase_derivatives_ordersapi_sbe_v1_4.ping_message.display(packet, parent, length)
    parent:append_text(display)
