...
omi_coinbase_derivatives_marketdataapi_sbe_v1_3.fields.is_announced = ProtoField.new("Is Announced", "coinbase.derivatives.marketdataapi.sbe.v1.3.isannounced", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
omi_coinbase_derivatives_marketdataapi_sbe_v1_3.fields.is_call = ProtoField.new("Is Call", "coinbase.derivatives.marketdataapi.sbe.v1.3.iscall", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
omi_coinbase_derivatives_marketdataapi_sbe_v1_3.fields.is_prior_settlement_theoretical = ProtoField.new("Is Prior Settlement Theoretical", "coinbase.derivatives.marketdataapi.sbe.v1.3.ispriorsettlementtheoretical", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
-- Coinbase Derivatives Sbe MarketDataApi 1.3 Application Messages
...
omi_coinbase_derivatives_marketdataapi_sbe_v1_3.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
function omi_coinbase_derivatives_marketdataapi_sbe_v1_3.prefs_changed()
  ...
  if show.application_messages ~= omi_coinbase_derivatives_marketdataapi_sbe_v1_3.prefs.show_application_messages then
    show.application_messages = omi_coinbase_derivatives_marketdataapi_sbe_v1_3.prefs.show_application_messages
    changed = true
  end
...
coinbase_derivatives_marketdataapi_sbe_v1_3.definition_flags.bits = function(range, value, packet, parent)

  -- Is Prior Settlement Theoretical: 1 Bit
  parent:add(omi_coinbase_derivatives_marketdataapi_sbe_v1_3.fields.is_prior_settlement_theoretical, range, value)

  -- Is Announced: 1 Bit
  parent:add(omi_coinbase_derivatives_marketdataapi_sbe_v1_3.fields.is_announced, range, value)

  -- Is Call: 1 Bit
  parent:add(omi_coinbase_derivatives_marketdataapi_sbe_v1_3.fields.is_call, range, value)

  -- Reserved 13: 13 Bit
  parent:add(omi_coinbase_derivatives_marketdataapi_sbe_v1_3.fields.reserved_13, range, value)
end
...
coinbase_derivatives_marketdataapi_sbe_v1_3.definition_flags.dissect = function(buffer, offset, packet, parent)
  local size = coinbase_derivatives_marketdataapi_sbe_v1_3.definition_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = coinbase_derivatives_marketdataapi_sbe_v1_3.definition_flags.display(range, value, packet, parent)
