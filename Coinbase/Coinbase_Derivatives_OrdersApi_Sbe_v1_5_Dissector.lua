...
omi_coinbase_derivatives_ordersapi_sbe_v1_5.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
function omi_coinbase_derivatives_ordersapi_sbe_v1_5.prefs_changed()
  ...
  if show.application_messages ~= omi_coinbase_derivatives_ordersapi_sbe_v1_5.prefs.show_application_messages then
    show.application_messages = omi_coinbase_derivatives_ordersapi_sbe_v1_5.prefs.show_application_messages
    changed = true
  end
