...
-- Dissector Heuristic for Coinbase CoinbaseDerivatives OrdersApi Sbe 1.7
local function omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7_heuristic(buffer, packet, parent)
...
omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7:register_heuristic("tcp", omi_coinbase_coinbasederivatives_ordersapi_sbe_v1_7_heuristic)
