...
omi_coinbase_derivatives_marketdataapi_sbe_v1_9.fields.funding_rate_applicable = ProtoField.new("Funding Rate Applicable", "coinbase.derivatives.marketdataapi.sbe.v1.9.fundingrateapplicable", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0010)
...
omi_coinbase_derivatives_marketdataapi_sbe_v1_9.fields.is_announced = ProtoField.new("Is Announced", "coinbase.derivatives.marketdataapi.sbe.v1.9.isannounced", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
omi_coinbase_derivatives_marketdataapi_sbe_v1_9.fields.is_call = ProtoField.new("Is Call", "coinbase.derivatives.marketdataapi.sbe.v1.9.iscall", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
omi_coinbase_derivatives_marketdataapi_sbe_v1_9.fields.is_final = ProtoField.new("Is Final", "coinbase.derivatives.marketdataapi.sbe.v1.9.isfinal", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_coinbase_derivatives_marketdataapi_sbe_v1_9.fields.is_prior_settlement_theoretical = ProtoField.new("Is Prior Settlement Theoretical", "coinbase.derivatives.marketdataapi.sbe.v1.9.ispriorsettlementtheoretical", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
omi_coinbase_derivatives_marketdataapi_sbe_v1_9.fields.is_strike_delisted = ProtoField.new("Is Strike Delisted", "coinbase.derivatives.marketdataapi.sbe.v1.9.isstrikedelisted", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0008)
