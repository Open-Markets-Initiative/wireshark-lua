...
omi_bruceats_equities_lastsale_itch_v1_0.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_bruceats_equities_lastsale_itch_v1_0.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Handle changed preferences
function omi_bruceats_equities_lastsale_itch_v1_0.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_bruceats_equities_lastsale_itch_v1_0.prefs.show_application_messages then
    show.application_messages = omi_bruceats_equities_lastsale_itch_v1_0.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_bruceats_equities_lastsale_itch_v1_0.prefs.show_message_index then
    show.message_index = omi_bruceats_equities_lastsale_itch_v1_0.prefs.show_message_index
  end
end
...
bruceats_equities_lastsale_itch_v1_0.message.size = function(buffer, offset)
  local index = offset
...
bruceats_equities_lastsale_itch_v1_0.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = bruceats_equities_lastsale_itch_v1_0.message.size(buffer, offset)
