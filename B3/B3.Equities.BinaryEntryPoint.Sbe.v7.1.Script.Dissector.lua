...
b3_equities_binaryentrypoint_sbe_v7_1.fields.business_header = ProtoField.new("Business Header", "b3.equities.binaryentrypoint.sbe.v7.1.businessheader", ftypes.STRING)
b3_equities_binaryentrypoint_sbe_v7_1.fields.business_message_reject = ProtoField.new("Business Message Reject", "b3.equities.binaryentrypoint.sbe.v7.1.businessmessagereject", ftypes.STRING)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.cl_ord_id = ProtoField.new("Cl Ord Id", "b3.equities.binaryentrypoint.sbe.v7.1.clordid", ftypes.UINT64)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.cross_id = ProtoField.new("Cross Id", "b3.equities.binaryentrypoint.sbe.v7.1.crossid", ftypes.UINT64)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.framing_header = ProtoField.new("Framing Header", "b3.equities.binaryentrypoint.sbe.v7.1.framingheader", ftypes.STRING)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.header_message = ProtoField.new("Header Message", "b3.equities.binaryentrypoint.sbe.v7.1.headermessage", ftypes.STRING)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.leg_security_exchange = ProtoField.new("Leg Security Exchange", "b3.equities.binaryentrypoint.sbe.v7.1.legsecurityexchange", ftypes.STRING)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.length = ProtoField.new("Length", "b3.equities.binaryentrypoint.sbe.v7.1.length", ftypes.UINT8)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.ord_type = ProtoField.new("Ord Type", "b3.equities.binaryentrypoint.sbe.v7.1.ordtype", ftypes.STRING)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.orig_cl_ord_id = ProtoField.new("Orig Cl Ord Id", "b3.equities.binaryentrypoint.sbe.v7.1.origclordid", ftypes.UINT64)
...
b3_equities_binaryentrypoint_sbe_v7_1.fields.security_exchange = ProtoField.new("Security Exchange", "b3.equities.binaryentrypoint.sbe.v7.1.securityexchange", ftypes.STRING)
...
b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_business_message_reject = Pref.bool("Show Business Message Reject", show.business_message_reject, "Parse and add Business Message Reject to protocol tree")
...
b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_framing_header = Pref.bool("Show Framing Header", show.framing_header, "Parse and add Framing Header to protocol tree")
...
b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_header_message = Pref.bool("Show Header Message", show.header_message, "Parse and add Header Message to protocol tree")
...
function b3_equities_binaryentrypoint_sbe_v7_1.prefs_changed()
  ...
  if show.business_message_reject ~= b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_business_message_reject then
    show.business_message_reject = b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_business_message_reject
    changed = true
  end
  ...
  if show.framing_header ~= b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_framing_header then
    show.framing_header = b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_framing_header
    changed = true
  end
  ...
  if show.header_message ~= b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_header_message then
    show.header_message = b3_equities_binaryentrypoint_sbe_v7_1.prefs.show_header_message
    changed = true
  end
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.framing_header = function(buffer, offset)
  local index = 0
...
b3_equities_binaryentrypoint_sbe_v7_1_display.framing_header = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Framing Header
b3_equities_binaryentrypoint_sbe_v7_1_dissect.framing_header_fields = function(buffer, offset, packet, parent)
  local index = offset
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.framing_header = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.framing_header then
    local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.framing_header(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v7_1_display.framing_header(buffer, packet, parent)
    parent = parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.framing_header, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v7_1_dissect.framing_header_fields(buffer, offset, packet, parent)
end

-- Calculate size of: Header Message
b3_equities_binaryentrypoint_sbe_v7_1_size_of.header_message = function(buffer, offset)
  local index = 0

  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.framing_header(buffer, offset + index)

  return index
end

-- Display: Header Message
b3_equities_binaryentrypoint_sbe_v7_1_display.header_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Header Message
b3_equities_binaryentrypoint_sbe_v7_1_dissect.header_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Framing Header: Struct of 2 fields
  index, framing_header = b3_equities_binaryentrypoint_sbe_v7_1_dissect.framing_header(buffer, index, packet, parent)

  return index
end

-- Dissect: Header Message
b3_equities_binaryentrypoint_sbe_v7_1_dissect.header_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.header_message then
    local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.header_message(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v7_1_display.header_message(buffer, packet, parent)
    parent = parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.header_message, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v7_1_dissect.header_message_fields(buffer, offset, packet, parent)
end

-- Size: Length
b3_equities_binaryentrypoint_sbe_v7_1_size_of.length = 1

-- Display: Length
b3_equities_binaryentrypoint_sbe_v7_1_display.length = function(value)
  return "Length: "..value
end

-- Dissect: Length
b3_equities_binaryentrypoint_sbe_v7_1_dissect.length = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.length
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.length(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.length, range, value, display)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.text = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.length

  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.var_data
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.text_fields = function(buffer, offset, packet, parent)
  ...
  index, length = b3_equities_binaryentrypoint_sbe_v7_1_dissect.length(buffer, index, packet, parent)

  -- Var Data
  index, var_data = b3_equities_binaryentrypoint_sbe_v7_1_dissect.var_data(buffer, index, packet, parent)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.security_exchange = 4

-- Display: Security Exchange
b3_equities_binaryentrypoint_sbe_v7_1_display.security_exchange = function(value)
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.security_exchange = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.security_exchange
  local range = buffer(offset, length)
  ...
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.security_exchange(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.security_exchange, range, value, display)
...
-- Size: Cl Ord Id
b3_equities_binaryentrypoint_sbe_v7_1_size_of.cl_ord_id = 8

-- Display: Cl Ord Id
b3_equities_binaryentrypoint_sbe_v7_1_display.cl_ord_id = function(value)
  return "Cl Ord Id: "..value
end

-- Dissect: Cl Ord Id
b3_equities_binaryentrypoint_sbe_v7_1_dissect.cl_ord_id = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.cl_ord_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.cl_ord_id(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.cl_ord_id, range, value, display)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.business_header = 1

-- Display: Business Header
b3_equities_binaryentrypoint_sbe_v7_1_display.business_header = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.business_header = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.business_header
  local range = buffer(offset, length)
  ...
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.business_header(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.business_header, range, value, display)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.order_mass_action_report_message = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.business_header
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.cl_ord_id
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.security_exchange
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.order_mass_action_report_message_fields = function(buffer, offset, packet, parent)
  ...
  index, business_header = b3_equities_binaryentrypoint_sbe_v7_1_dissect.business_header(buffer, index, packet, parent)
  ...
  index, cl_ord_id = b3_equities_binaryentrypoint_sbe_v7_1_dissect.cl_ord_id(buffer, index, packet, parent)
...
-- Display: Fixed Rate
b3_equities_binaryentrypoint_sbe_v7_1_display.fixed_rate = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.fixed_rate = function(buffer, offset, packet, parent)
  ...
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.fixed_rate(raw, value, buffer, offset, packet, parent)
...
-- Display: Price
b3_equities_binaryentrypoint_sbe_v7_1_display.price = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.price = function(buffer, offset, packet, parent)
  ...
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.price(raw, value, buffer, offset, packet, parent)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.leg_security_exchange = 4

-- Display: Leg Security Exchange
b3_equities_binaryentrypoint_sbe_v7_1_display.leg_security_exchange = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.leg_security_exchange = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.leg_security_exchange
  local range = buffer(offset, length)
  ...
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.leg_security_exchange(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.leg_security_exchange, range, value, display)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.no_legs_group = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.leg_security_exchange
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.no_legs_group_fields = function(buffer, offset, packet, parent)
  ...
  index, leg_security_exchange = b3_equities_binaryentrypoint_sbe_v7_1_dissect.leg_security_exchange(buffer, index, packet, parent)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.business_message_reject = function(buffer, offset)
  local index = 0
...
b3_equities_binaryentrypoint_sbe_v7_1_display.business_message_reject = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Business Message Reject
b3_equities_binaryentrypoint_sbe_v7_1_dissect.business_message_reject_fields = function(buffer, offset, packet, parent)
  local index = offset
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.business_message_reject = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.business_message_reject then
    local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.business_message_reject(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v7_1_display.business_message_reject(buffer, packet, parent)
    parent = parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.business_message_reject, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v7_1_dissect.business_message_reject_fields(buffer, offset, packet, parent)
end
...
-- Size: Cross Id
b3_equities_binaryentrypoint_sbe_v7_1_size_of.cross_id = 8

-- Display: Cross Id
b3_equities_binaryentrypoint_sbe_v7_1_display.cross_id = function(value)
  return "Cross Id: "..value
end

-- Dissect: Cross Id
b3_equities_binaryentrypoint_sbe_v7_1_dissect.cross_id = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.cross_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.cross_id(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.cross_id, range, value, display)
...
-- Size: Ord Type
b3_equities_binaryentrypoint_sbe_v7_1_size_of.ord_type = 1

-- Display: Ord Type
b3_equities_binaryentrypoint_sbe_v7_1_display.ord_type = function(value)
  if value == "1" then
...
-- Dissect: Ord Type
b3_equities_binaryentrypoint_sbe_v7_1_dissect.ord_type = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.ord_type
  local range = buffer(offset, length)
  ...
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.ord_type(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.ord_type, range, value, display)

  return offset + length, value
end

-- Size: Orig Cl Ord Id
b3_equities_binaryentrypoint_sbe_v7_1_size_of.orig_cl_ord_id = 8

-- Display: Orig Cl Ord Id
b3_equities_binaryentrypoint_sbe_v7_1_display.orig_cl_ord_id = function(value)
  return "Orig Cl Ord Id: "..value
end

-- Dissect: Orig Cl Ord Id
b3_equities_binaryentrypoint_sbe_v7_1_dissect.orig_cl_ord_id = function(buffer, offset, packet, parent)
  local length = b3_equities_binaryentrypoint_sbe_v7_1_size_of.orig_cl_ord_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = b3_equities_binaryentrypoint_sbe_v7_1_display.orig_cl_ord_id(value, buffer, offset, packet, parent)

  parent:add(b3_equities_binaryentrypoint_sbe_v7_1.fields.orig_cl_ord_id, range, value, display)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.execution_report_reject_message = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.orig_cl_ord_id

  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.account

  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.ord_type
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v7_1_size_of.cross_id
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.execution_report_reject_message_fields = function(buffer, offset, packet, parent)
  ...
  index, orig_cl_ord_id = b3_equities_binaryentrypoint_sbe_v7_1_dissect.orig_cl_ord_id(buffer, index, packet, parent)

  -- Account: 4 Byte Unsigned Fixed Width Integer
  index, account = b3_equities_binaryentrypoint_sbe_v7_1_dissect.account(buffer, index, packet, parent)

  -- Ord Type: 1 Byte Ascii String Enum with 7 values
  index, ord_type = b3_equities_binaryentrypoint_sbe_v7_1_dissect.ord_type(buffer, index, packet, parent)
  ...
  index, cross_id = b3_equities_binaryentrypoint_sbe_v7_1_dissect.cross_id(buffer, index, packet, parent)
...
b3_equities_binaryentrypoint_sbe_v7_1_size_of.payload = function(buffer, offset, template_id)
  ...
  if template_id == 206 then
    return b3_equities_binaryentrypoint_sbe_v7_1_size_of.business_message_reject(buffer, offset)
  end
  ...
  if template_id == 0 then
    return b3_equities_binaryentrypoint_sbe_v7_1_size_of.header_message(buffer, offset)
  end
...
b3_equities_binaryentrypoint_sbe_v7_1_dissect.payload_branches = function(buffer, offset, packet, parent, template_id)
  ...
  -- Dissect Business Message Reject
  if template_id == 206 then
    return b3_equities_binaryentrypoint_sbe_v7_1_dissect.business_message_reject(buffer, offset, packet, parent)
  end
  -- Dissect Security Definition Request Message
  if template_id == 300 then
  ...
  -- Dissect Header Message
  if template_id == 0 then
    return b3_equities_binaryentrypoint_sbe_v7_1_dissect.header_message(buffer, offset, packet, parent)
  end
