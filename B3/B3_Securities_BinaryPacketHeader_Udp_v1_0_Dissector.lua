...
omi_b3_securities_binarypacketheader_udp_v1_0.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
...
function omi_b3_securities_binarypacketheader_udp_v1_0.prefs_changed()
  ...
  if show.headers ~= omi_b3_securities_binarypacketheader_udp_v1_0.prefs.show_headers then
    show.headers = omi_b3_securities_binarypacketheader_udp_v1_0.prefs.show_headers
  end
...
b3_securities_binarypacketheader_udp_v1_0.packet.requiredsize = function(buffer)
  return buffer:len() >= b3_securities_binarypacketheader_udp_v1_0.packet_header.size + b3_securities_binarypacketheader_udp_v1_0.framing_header.size + b3_securities_binarypacketheader_udp_v1_0.message_header.size
end
...
-- Register B3 Securities BinaryPacketHeader Udp 1.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_b3_securities_binarypacketheader_udp_v1_0)
