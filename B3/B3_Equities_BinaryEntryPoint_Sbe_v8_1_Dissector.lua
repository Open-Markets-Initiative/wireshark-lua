...
b3_equities_binaryentrypoint_sbe_v8_1.positions_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.positions_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.positions_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.positions_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.positions_groups, range, display)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.sides_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.sides_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.sides_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.sides_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.sides_groups, range, display)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.legs_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.legs_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.legs_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.legs_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.legs_groups, range, display)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.cross_sides_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.cross_sides_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.cross_sides_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.cross_sides_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.cross_sides_groups, range, display)
  end
