...
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.new_order_cross_message_no_sides_group = ProtoField.new("New Order Cross Message no Sides Group", "b3.equities.binaryentrypoint.sbe.v8.1.newordercrossmessagenosidesgroup", ftypes.STRING)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.new_order_cross_message_no_sides_groups = ProtoField.new("New Order Cross Message no Sides Groups", "b3.equities.binaryentrypoint.sbe.v8.1.newordercrossmessagenosidesgroups", ftypes.STRING)
...
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.position_maintenance_report_message_no_positions_group = ProtoField.new("Position Maintenance Report Message no Positions Group", "b3.equities.binaryentrypoint.sbe.v8.1.positionmaintenancereportmessagenopositionsgroup", ftypes.STRING)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.position_maintenance_report_message_no_positions_groups = ProtoField.new("Position Maintenance Report Message no Positions Groups", "b3.equities.binaryentrypoint.sbe.v8.1.positionmaintenancereportmessagenopositionsgroups", ftypes.STRING)
...
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_message_no_sides_group = ProtoField.new("Quote Request Message no Sides Group", "b3.equities.binaryentrypoint.sbe.v8.1.quoterequestmessagenosidesgroup", ftypes.STRING)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_message_no_sides_groups = ProtoField.new("Quote Request Message no Sides Groups", "b3.equities.binaryentrypoint.sbe.v8.1.quoterequestmessagenosidesgroups", ftypes.STRING)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_reject_message_no_sides_group = ProtoField.new("Quote Request Reject Message no Sides Group", "b3.equities.binaryentrypoint.sbe.v8.1.quoterequestrejectmessagenosidesgroup", ftypes.STRING)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_reject_message_no_sides_groups = ProtoField.new("Quote Request Reject Message no Sides Groups", "b3.equities.binaryentrypoint.sbe.v8.1.quoterequestrejectmessagenosidesgroups", ftypes.STRING)
...
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.security_definition_request_message_no_legs_group = ProtoField.new("Security Definition Request Message no Legs Group", "b3.equities.binaryentrypoint.sbe.v8.1.securitydefinitionrequestmessagenolegsgroup", ftypes.STRING)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.security_definition_request_message_no_legs_groups = ProtoField.new("Security Definition Request Message no Legs Groups", "b3.equities.binaryentrypoint.sbe.v8.1.securitydefinitionrequestmessagenolegsgroups", ftypes.STRING)
...
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.new_order_cross_message_no_sides_group_index = ProtoField.new("New Order Cross Message no Sides Group Index", "b3.equities.binaryentrypoint.sbe.v8.1.newordercrossmessagenosidesgroupindex", ftypes.UINT16)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.position_maintenance_report_message_no_positions_group_index = ProtoField.new("Position Maintenance Report Message no Positions Group Index", "b3.equities.binaryentrypoint.sbe.v8.1.positionmaintenancereportmessagenopositionsgroupindex", ftypes.UINT16)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_message_no_sides_group_index = ProtoField.new("Quote Request Message no Sides Group Index", "b3.equities.binaryentrypoint.sbe.v8.1.quoterequestmessagenosidesgroupindex", ftypes.UINT16)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_reject_message_no_sides_group_index = ProtoField.new("Quote Request Reject Message no Sides Group Index", "b3.equities.binaryentrypoint.sbe.v8.1.quoterequestrejectmessagenosidesgroupindex", ftypes.UINT16)
omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.security_definition_request_message_no_legs_group_index = ProtoField.new("Security Definition Request Message no Legs Group Index", "b3.equities.binaryentrypoint.sbe.v8.1.securitydefinitionrequestmessagenolegsgroupindex", ftypes.UINT16)
...
omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_new_order_cross_message_no_sides_group = Pref.bool("Show New Order Cross Message no Sides Group", show.new_order_cross_message_no_sides_group, "Parse and add New Order Cross Message no Sides Group to protocol tree")
omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_new_order_cross_message_no_sides_groups = Pref.bool("Show New Order Cross Message no Sides Groups", show.new_order_cross_message_no_sides_groups, "Parse and add New Order Cross Message no Sides Groups to protocol tree")
...
omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_message_no_sides_group = Pref.bool("Show Quote Request Message no Sides Group", show.quote_request_message_no_sides_group, "Parse and add Quote Request Message no Sides Group to protocol tree")
omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_message_no_sides_groups = Pref.bool("Show Quote Request Message no Sides Groups", show.quote_request_message_no_sides_groups, "Parse and add Quote Request Message no Sides Groups to protocol tree")
...
omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_reject_message_no_sides_group = Pref.bool("Show Quote Request Reject Message no Sides Group", show.quote_request_reject_message_no_sides_group, "Parse and add Quote Request Reject Message no Sides Group to protocol tree")
omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_reject_message_no_sides_groups = Pref.bool("Show Quote Request Reject Message no Sides Groups", show.quote_request_reject_message_no_sides_groups, "Parse and add Quote Request Reject Message no Sides Groups to protocol tree")
...
function omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs_changed()
  ...
  if show.new_order_cross_message_no_sides_group ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_new_order_cross_message_no_sides_group then
    show.new_order_cross_message_no_sides_group = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_new_order_cross_message_no_sides_group
    changed = true
  end
  if show.new_order_cross_message_no_sides_groups ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_new_order_cross_message_no_sides_groups then
    show.new_order_cross_message_no_sides_groups = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_new_order_cross_message_no_sides_groups
    changed = true
  end
  ...
  if show.position_maintenance_report_message_no_positions_group ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_position_maintenance_report_message_no_positions_group then
    show.position_maintenance_report_message_no_positions_group = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_position_maintenance_report_message_no_positions_group
    changed = true
  end
  if show.position_maintenance_report_message_no_positions_groups ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_position_maintenance_report_message_no_positions_groups then
    show.position_maintenance_report_message_no_positions_groups = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_position_maintenance_report_message_no_positions_groups
    changed = true
  end
  ...
  if show.quote_request_message_no_sides_group ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_message_no_sides_group then
    show.quote_request_message_no_sides_group = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_message_no_sides_group
    changed = true
  end
  if show.quote_request_message_no_sides_groups ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_message_no_sides_groups then
    show.quote_request_message_no_sides_groups = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_message_no_sides_groups
    changed = true
  end
  ...
  if show.quote_request_reject_message_no_sides_group ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_reject_message_no_sides_group then
    show.quote_request_reject_message_no_sides_group = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_reject_message_no_sides_group
    changed = true
  end
  if show.quote_request_reject_message_no_sides_groups ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_reject_message_no_sides_groups then
    show.quote_request_reject_message_no_sides_groups = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_quote_request_reject_message_no_sides_groups
    changed = true
  end
  ...
  if show.security_definition_request_message_no_legs_group ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_security_definition_request_message_no_legs_group then
    show.security_definition_request_message_no_legs_group = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_security_definition_request_message_no_legs_group
    changed = true
  end
  if show.security_definition_request_message_no_legs_groups ~= omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_security_definition_request_message_no_legs_groups then
    show.security_definition_request_message_no_legs_groups = omi_b3_equities_binaryentrypoint_sbe_v8_1.prefs.show_security_definition_request_message_no_legs_groups
    changed = true
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.text_data.dissect = function(buffer, offset, packet, parent, size)
  ...
  local display = b3_equities_binaryentrypoint_sbe_v8_1.text_data.display(value, packet, parent, size)
...
-- Display: Text
b3_equities_binaryentrypoint_sbe_v8_1.text.display = function(packet, parent, value, length)
  if value == nil then
    return "No Value"
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.text.dissect = function(buffer, offset, packet, parent)
  if show.text then
    ...
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.text, buffer(offset, 0))
    local index, value = b3_equities_binaryentrypoint_sbe_v8_1.text.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.text.display(packet, parent, value, length)
...
-- Size: Investor Id
b3_equities_binaryentrypoint_sbe_v8_1.investor_id.size =
  b3_equities_binaryentrypoint_sbe_v8_1.prefix.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.document.size
...
b3_equities_binaryentrypoint_sbe_v8_1.outbound_business_header.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.msg_seq_num.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.sending_time.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.poss_resend.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.padding.size
...
b3_equities_binaryentrypoint_sbe_v8_1.order_mass_action_report_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.outbound_business_header.size
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.investor_id.size
...
b3_equities_binaryentrypoint_sbe_v8_1.inbound_business_header.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.msg_seq_num.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.sending_time.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.market_segment_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.padding.size
...
b3_equities_binaryentrypoint_sbe_v8_1.order_mass_action_request_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.inbound_business_header.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.mass_action_type.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.mass_action_scope.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.clordid.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.mass_cancel_restatement_reason.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.ordtagid.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.side_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.offset_31_padding_1.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.asset.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_id_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.investor_id.size
...
b3_equities_binaryentrypoint_sbe_v8_1.allocation_report_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.outbound_business_header.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.alloc_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.alloc_report_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.alloc_trans_type.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.alloc_report_type.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.alloc_no_orders_type.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.alloc_rej_code.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.quantity.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.alloc_status.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.trade_date_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.transact_time.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.side.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.sender_location.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.entering_trader.size
...
b3_equities_binaryentrypoint_sbe_v8_1.memo_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = b3_equities_binaryentrypoint_sbe_v8_1.memo_data.display(value, packet, parent, size)
...
-- Display: Memo
b3_equities_binaryentrypoint_sbe_v8_1.memo.display = function(packet, parent, value, length)
  if value == nil then
    return "No Value"
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.memo.dissect = function(buffer, offset, packet, parent)
  if show.memo then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.memo, buffer(offset, 0))
    local index, value = b3_equities_binaryentrypoint_sbe_v8_1.memo.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.memo.display(packet, parent, value, length)
    parent:append_text(display)
...
b3_equities_binaryentrypoint_sbe_v8_1.desk_id_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = b3_equities_binaryentrypoint_sbe_v8_1.desk_id_data.display(value, packet, parent, size)
...
-- Display: Desk Id
b3_equities_binaryentrypoint_sbe_v8_1.desk_id.display = function(packet, parent, value, length)
  if value == nil then
    return "No Value"
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.desk_id.dissect = function(buffer, offset, packet, parent)
  if show.desk_id then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.desk_id, buffer(offset, 0))
    local index, value = b3_equities_binaryentrypoint_sbe_v8_1.desk_id.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.desk_id.display(packet, parent, value, length)
    parent:append_text(display)
...
b3_equities_binaryentrypoint_sbe_v8_1.allocation_instruction_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.inbound_business_header.size
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group = {}

-- Size: Position Maintenance Report Message no Positions Group
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.size =
  b3_equities_binaryentrypoint_sbe_v8_1.pos_type.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.long_qty_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.short_qty.size

-- Display: Position Maintenance Report Message no Positions Group
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Position Maintenance Report Message no Positions Group
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.fields = function(buffer, offset, packet, parent, position_maintenance_report_message_no_positions_group_index)
  local index = offset
  ...
  if position_maintenance_report_message_no_positions_group_index ~= nil then
    local iteration = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.position_maintenance_report_message_no_positions_group_index, position_maintenance_report_message_no_positions_group_index)
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.dissect = function(buffer, offset, packet, parent, position_maintenance_report_message_no_positions_group_index)
  if show.position_maintenance_report_message_no_positions_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.position_maintenance_report_message_no_positions_group, buffer(offset, 0))
    local index = b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.fields(buffer, offset, packet, parent, position_maintenance_report_message_no_positions_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.fields(buffer, offset, packet, parent, position_maintenance_report_message_no_positions_group_index)
  end
end
...
b3_equities_binaryentrypoint_sbe_v8_1.group_size_encoding.size =
  b3_equities_binaryentrypoint_sbe_v8_1.block_length.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.num_in_group.size
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups = {}

-- Calculate size of: Position Maintenance Report Message no Positions Groups
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.size = function(buffer, offset)
  local index = 0

  index = index + b3_equities_binaryentrypoint_sbe_v8_1.group_size_encoding.size
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Position Maintenance Report Message no Positions Groups
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for position_maintenance_report_message_no_positions_group_index = 1, num_in_group do
    index, position_maintenance_report_message_no_positions_group = b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_group.dissect(buffer, index, packet, parent, position_maintenance_report_message_no_positions_group_index)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.position_maintenance_report_message_no_positions_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.position_maintenance_report_message_no_positions_groups, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.fields(buffer, offset, packet, parent)
end
...
b3_equities_binaryentrypoint_sbe_v8_1.threshold_amount.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
    return 0/0
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.threshold_amount.dissect = function(buffer, offset, packet, parent)
  ...
  local value = b3_equities_binaryentrypoint_sbe_v8_1.threshold_amount.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.size(buffer, offset + index)
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message.fields = function(buffer, offset, packet, parent)
  ...
  index, position_maintenance_report_message_no_positions_groups = b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_report_message_no_positions_groups.dissect(buffer, index, packet, parent)
...
b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_cancel_request_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.inbound_business_header.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.pos_req_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.orig_pos_req_ref_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.pos_maint_rpt_ref_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.sender_location.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.entering_trader.size
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group = {}

-- Size: Quote Request Reject Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.size =
  b3_equities_binaryentrypoint_sbe_v8_1.side.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.account.size

-- Display: Quote Request Reject Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Request Reject Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.fields = function(buffer, offset, packet, parent, quote_request_reject_message_no_sides_group_index)
  local index = offset

  -- Implicit Quote Request Reject Message no Sides Group Index
  if quote_request_reject_message_no_sides_group_index ~= nil then
    local iteration = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_reject_message_no_sides_group_index, quote_request_reject_message_no_sides_group_index)
    iteration:set_generated()
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.dissect = function(buffer, offset, packet, parent, quote_request_reject_message_no_sides_group_index)
  if show.quote_request_reject_message_no_sides_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_reject_message_no_sides_group, buffer(offset, 0))
    local index = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.fields(buffer, offset, packet, parent, quote_request_reject_message_no_sides_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.fields(buffer, offset, packet, parent, quote_request_reject_message_no_sides_group_index)
  end
end

-- Quote Request Reject Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups = {}

-- Calculate size of: Quote Request Reject Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.size = function(buffer, offset)
  local index = 0
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Request Reject Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for quote_request_reject_message_no_sides_group_index = 1, num_in_group do
    index, quote_request_reject_message_no_sides_group = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_group.dissect(buffer, index, packet, parent, quote_request_reject_message_no_sides_group_index)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.quote_request_reject_message_no_sides_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_reject_message_no_sides_groups, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.fields(buffer, offset, packet, parent)
end
...
b3_equities_binaryentrypoint_sbe_v8_1.fixed_rate_percentage_8_optional.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
    return 0/0
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.fixed_rate_percentage_8_optional.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.fixed_rate_percentage_8_optional.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.price_8_optional.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
    return 0/0
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.price_8_optional.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.price_8_optional.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.bidirectional_business_header.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.msg_seq_num.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.sending_time.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.poss_resend.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.market_segment_id_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.padding.size
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.bidirectional_business_header.size
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.size(buffer, offset + index)
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message.fields = function(buffer, offset, packet, parent)
  ...
  index, quote_request_reject_message_no_sides_groups = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_reject_message_no_sides_groups.dissect(buffer, index, packet, parent)
...
b3_equities_binaryentrypoint_sbe_v8_1.fixed_rate_percentage_8.translate = function(raw)
  return raw:tonumber()/100000000
end
...
b3_equities_binaryentrypoint_sbe_v8_1.fixed_rate_percentage_8.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.fixed_rate_percentage_8.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group = {}

-- Size: Quote Request Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.size =
  b3_equities_binaryentrypoint_sbe_v8_1.side.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.account.size

-- Display: Quote Request Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Request Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.fields = function(buffer, offset, packet, parent, quote_request_message_no_sides_group_index)
  local index = offset

  -- Implicit Quote Request Message no Sides Group Index
  if quote_request_message_no_sides_group_index ~= nil then
    local iteration = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_message_no_sides_group_index, quote_request_message_no_sides_group_index)
    iteration:set_generated()
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.dissect = function(buffer, offset, packet, parent, quote_request_message_no_sides_group_index)
  if show.quote_request_message_no_sides_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_message_no_sides_group, buffer(offset, 0))
    local index = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.fields(buffer, offset, packet, parent, quote_request_message_no_sides_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.fields(buffer, offset, packet, parent, quote_request_message_no_sides_group_index)
  end
end

-- Quote Request Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups = {}

-- Calculate size of: Quote Request Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.size = function(buffer, offset)
  local index = 0
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Request Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for quote_request_message_no_sides_group_index = 1, num_in_group do
    index, quote_request_message_no_sides_group = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_group.dissect(buffer, index, packet, parent, quote_request_message_no_sides_group_index)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.quote_request_message_no_sides_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.quote_request_message_no_sides_groups, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.fields(buffer, offset, packet, parent)
end
...
-- Translate: Price 8
b3_equities_binaryentrypoint_sbe_v8_1.price_8.translate = function(raw)
  return raw:tonumber()/100000000
end
...
b3_equities_binaryentrypoint_sbe_v8_1.price_8.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.price_8.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.size(buffer, offset + index)
...
b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message.fields = function(buffer, offset, packet, parent)
  ...
  index, quote_request_message_no_sides_groups = b3_equities_binaryentrypoint_sbe_v8_1.quote_request_message_no_sides_groups.dissect(buffer, index, packet, parent)
...
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_response_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.outbound_business_header.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.offset_18_padding_2.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_req_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_id_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_response_type.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_strategy_type.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.symbol.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.security_response_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.sender_location.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.entering_trader.size
...
b3_equities_binaryentrypoint_sbe_v8_1.leg_ratio_qty.translate = function(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.leg_ratio_qty.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.leg_ratio_qty.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group = {}

-- Size: Security Definition Request Message no Legs Group
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.size =
  b3_equities_binaryentrypoint_sbe_v8_1.leg_symbol.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.leg_ratio_qty.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.leg_side.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.padding_1.size

-- Display: Security Definition Request Message no Legs Group
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Request Message no Legs Group
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.fields = function(buffer, offset, packet, parent, security_definition_request_message_no_legs_group_index)
  local index = offset
  ...
  if security_definition_request_message_no_legs_group_index ~= nil then
    local iteration = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.security_definition_request_message_no_legs_group_index, security_definition_request_message_no_legs_group_index)
    iteration:set_generated()
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.dissect = function(buffer, offset, packet, parent, security_definition_request_message_no_legs_group_index)
  if show.security_definition_request_message_no_legs_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.security_definition_request_message_no_legs_group, buffer(offset, 0))
    local index = b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.fields(buffer, offset, packet, parent, security_definition_request_message_no_legs_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.fields(buffer, offset, packet, parent, security_definition_request_message_no_legs_group_index)
  end
end

-- Security Definition Request Message no Legs Groups
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups = {}

-- Calculate size of: Security Definition Request Message no Legs Groups
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.size = function(buffer, offset)
  local index = 0
...
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Request Message no Legs Groups
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for security_definition_request_message_no_legs_group_index = 1, num_in_group do
    index, security_definition_request_message_no_legs_group = b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_group.dissect(buffer, index, packet, parent, security_definition_request_message_no_legs_group_index)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.security_definition_request_message_no_legs_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.security_definition_request_message_no_legs_groups, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.fields(buffer, offset, packet, parent)
end
...
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.size(buffer, offset + index)
...
b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message.fields = function(buffer, offset, packet, parent)
  ...
  index, security_definition_request_message_no_legs_groups = b3_equities_binaryentrypoint_sbe_v8_1.security_definition_request_message_no_legs_groups.dissect(buffer, index, packet, parent)
...
-- Translate: Last Px
b3_equities_binaryentrypoint_sbe_v8_1.last_px.translate = function(raw)
  return raw:tonumber()/10000
end
...
b3_equities_binaryentrypoint_sbe_v8_1.last_px.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.last_px.translate(raw)
...
-- Translate: Stop Px
b3_equities_binaryentrypoint_sbe_v8_1.stop_px.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
    return 0/0
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.stop_px.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.stop_px.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.price_optional.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
    return 0/0
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.price_optional.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.price_optional.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.protection_price.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0x00000000, 0x80000000) then
    return 0/0
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.protection_price.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.protection_price.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group = {}

-- Size: New Order Cross Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.size =
  b3_equities_binaryentrypoint_sbe_v8_1.side.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.offset_1_padding_1.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.account.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.entering_firm_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.clordid.size

-- Display: New Order Cross Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: New Order Cross Message no Sides Group
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.fields = function(buffer, offset, packet, parent, new_order_cross_message_no_sides_group_index)
  local index = offset

  -- Implicit New Order Cross Message no Sides Group Index
  if new_order_cross_message_no_sides_group_index ~= nil then
    local iteration = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.new_order_cross_message_no_sides_group_index, new_order_cross_message_no_sides_group_index)
    iteration:set_generated()
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.dissect = function(buffer, offset, packet, parent, new_order_cross_message_no_sides_group_index)
  if show.new_order_cross_message_no_sides_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.new_order_cross_message_no_sides_group, buffer(offset, 0))
    local index = b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.fields(buffer, offset, packet, parent, new_order_cross_message_no_sides_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.fields(buffer, offset, packet, parent, new_order_cross_message_no_sides_group_index)
  end
end

-- New Order Cross Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups = {}

-- Calculate size of: New Order Cross Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.size = function(buffer, offset)
  local index = 0
...
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: New Order Cross Message no Sides Groups
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for new_order_cross_message_no_sides_group_index = 1, num_in_group do
    index, new_order_cross_message_no_sides_group = b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_group.dissect(buffer, index, packet, parent, new_order_cross_message_no_sides_group_index)
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.new_order_cross_message_no_sides_groups then
    local length = b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.display(buffer, packet, parent)
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.new_order_cross_message_no_sides_groups, range, display)
  end

  return b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.fields(buffer, offset, packet, parent)
end
...
-- Translate: Price
b3_equities_binaryentrypoint_sbe_v8_1.price.translate = function(raw)
  return raw:tonumber()/10000
end
...
b3_equities_binaryentrypoint_sbe_v8_1.price.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = b3_equities_binaryentrypoint_sbe_v8_1.price.translate(raw)
...
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.size(buffer, offset + index)
...
b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message.fields = function(buffer, offset, packet, parent)
  ...
  index, new_order_cross_message_no_sides_groups = b3_equities_binaryentrypoint_sbe_v8_1.new_order_cross_message_no_sides_groups.dissect(buffer, index, packet, parent)
...
-- Size: Custodian Info
b3_equities_binaryentrypoint_sbe_v8_1.custodian_info.size =
  b3_equities_binaryentrypoint_sbe_v8_1.custodian.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.custody_account.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.custody_allocation_type.size
...
b3_equities_binaryentrypoint_sbe_v8_1.order_cancel_replace_request_message.size = function(buffer, offset)
  ...
  index = index + b3_equities_binaryentrypoint_sbe_v8_1.custodian_info.size
...
b3_equities_binaryentrypoint_sbe_v8_1.retransmit_reject_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.request_timestamp.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.retransmit_reject_code.size
...
b3_equities_binaryentrypoint_sbe_v8_1.retransmission_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.request_timestamp.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.next_seq_no.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.count.size
...
b3_equities_binaryentrypoint_sbe_v8_1.retransmit_request_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.timestamp.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.from_seq_no.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.count.size
...
b3_equities_binaryentrypoint_sbe_v8_1.sequence_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.next_seq_no.size
...
b3_equities_binaryentrypoint_sbe_v8_1.not_applied_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.from_seq_no.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.count.size
...
b3_equities_binaryentrypoint_sbe_v8_1.terminate_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.session_ver_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.termination_code.size
...
b3_equities_binaryentrypoint_sbe_v8_1.establish_reject_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.session_ver_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.request_timestamp.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.establishment_reject_code.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.offset_21_padding_1.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.last_incoming_seq_no_optional.size
...
b3_equities_binaryentrypoint_sbe_v8_1.establish_ack_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.session_ver_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.request_timestamp.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.keep_alive_interval.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.next_seq_no.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.last_incoming_seq_no.size
...
b3_equities_binaryentrypoint_sbe_v8_1.credentials_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = b3_equities_binaryentrypoint_sbe_v8_1.credentials_data.display(value, packet, parent, size)
...
-- Display: Credentials
b3_equities_binaryentrypoint_sbe_v8_1.credentials.display = function(packet, parent, value, length)
  if value == nil then
    return "No Value"
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.credentials.dissect = function(buffer, offset, packet, parent)
  if show.credentials then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.credentials, buffer(offset, 0))
    local index, value = b3_equities_binaryentrypoint_sbe_v8_1.credentials.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.credentials.display(packet, parent, value, length)
    parent:append_text(display)
...
b3_equities_binaryentrypoint_sbe_v8_1.negotiate_reject_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.session_ver_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.request_timestamp.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.entering_firm_optional.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.negotiation_reject_code.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.offset_25_padding_3.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.current_session_ver_id.size
...
b3_equities_binaryentrypoint_sbe_v8_1.negotiate_response_message.size =
  b3_equities_binaryentrypoint_sbe_v8_1.session_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.session_ver_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.request_timestamp.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.entering_firm.size
...
b3_equities_binaryentrypoint_sbe_v8_1.client_app_version_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = b3_equities_binaryentrypoint_sbe_v8_1.client_app_version_data.display(value, packet, parent, size)
...
b3_equities_binaryentrypoint_sbe_v8_1.client_app_version.display = function(packet, parent, value, length)
  if value == nil then
    return "No Value"
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.client_app_version.dissect = function(buffer, offset, packet, parent)
  if show.client_app_version then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.client_app_version, buffer(offset, 0))
    local index, value = b3_equities_binaryentrypoint_sbe_v8_1.client_app_version.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.client_app_version.display(packet, parent, value, length)
    parent:append_text(display)
...
b3_equities_binaryentrypoint_sbe_v8_1.client_app_name_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = b3_equities_binaryentrypoint_sbe_v8_1.client_app_name_data.display(value, packet, parent, size)
...
b3_equities_binaryentrypoint_sbe_v8_1.client_app_name.display = function(packet, parent, value, length)
  if value == nil then
    return "No Value"
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.client_app_name.dissect = function(buffer, offset, packet, parent)
  if show.client_app_name then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.client_app_name, buffer(offset, 0))
    local index, value = b3_equities_binaryentrypoint_sbe_v8_1.client_app_name.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.client_app_name.display(packet, parent, value, length)
    parent:append_text(display)
...
b3_equities_binaryentrypoint_sbe_v8_1.client_ip_data.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = b3_equities_binaryentrypoint_sbe_v8_1.client_ip_data.display(value, packet, parent, size)
...
-- Display: Client Ip
b3_equities_binaryentrypoint_sbe_v8_1.client_ip.display = function(packet, parent, value, length)
  if value == nil then
    return "No Value"
  end
...
b3_equities_binaryentrypoint_sbe_v8_1.client_ip.dissect = function(buffer, offset, packet, parent)
  if show.client_ip then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_b3_equities_binaryentrypoint_sbe_v8_1.fields.client_ip, buffer(offset, 0))
    local index, value = b3_equities_binaryentrypoint_sbe_v8_1.client_ip.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = b3_equities_binaryentrypoint_sbe_v8_1.client_ip.display(packet, parent, value, length)
    parent:append_text(display)
...
b3_equities_binaryentrypoint_sbe_v8_1.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 2 then
    return b3_equities_binaryentrypoint_sbe_v8_1.negotiate_response_message.size
  end
  -- Size of Negotiate Reject Message
  if template_id == 3 then
    return b3_equities_binaryentrypoint_sbe_v8_1.negotiate_reject_message.size
  end
  ...
  if template_id == 5 then
    return b3_equities_binaryentrypoint_sbe_v8_1.establish_ack_message.size
  end
  -- Size of Establish Reject Message
  if template_id == 6 then
    return b3_equities_binaryentrypoint_sbe_v8_1.establish_reject_message.size
  end
  -- Size of Terminate Message
  if template_id == 7 then
    return b3_equities_binaryentrypoint_sbe_v8_1.terminate_message.size
  end
  -- Size of Not Applied Message
  if template_id == 8 then
    return b3_equities_binaryentrypoint_sbe_v8_1.not_applied_message.size
  end
  -- Size of Sequence Message
  if template_id == 9 then
    return b3_equities_binaryentrypoint_sbe_v8_1.sequence_message.size
  end
  -- Size of Retransmit Request Message
  if template_id == 12 then
    return b3_equities_binaryentrypoint_sbe_v8_1.retransmit_request_message.size
  end
  -- Size of Retransmission Message
  if template_id == 13 then
    return b3_equities_binaryentrypoint_sbe_v8_1.retransmission_message.size
  end
  -- Size of Retransmit Reject Message
  if template_id == 14 then
    return b3_equities_binaryentrypoint_sbe_v8_1.retransmit_reject_message.size
  end
  ...
  if template_id == 301 then
    return b3_equities_binaryentrypoint_sbe_v8_1.security_definition_response_message.size
  end
  ...
  if template_id == 501 then
    return b3_equities_binaryentrypoint_sbe_v8_1.position_maintenance_cancel_request_message.size
  end
  ...
  if template_id == 602 then
    return b3_equities_binaryentrypoint_sbe_v8_1.allocation_report_message.size
  end
  -- Size of Order Mass Action Request Message
  if template_id == 701 then
    return b3_equities_binaryentrypoint_sbe_v8_1.order_mass_action_request_message.size
  end
...
-- Size: Message Header
b3_equities_binaryentrypoint_sbe_v8_1.message_header.size =
  b3_equities_binaryentrypoint_sbe_v8_1.block_length.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.template_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.schema_id.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.version.size
...
b3_equities_binaryentrypoint_sbe_v8_1.simple_open_framing_header.size =
  b3_equities_binaryentrypoint_sbe_v8_1.message_length.size + 
  b3_equities_binaryentrypoint_sbe_v8_1.encoding_type.size
...
local simple_open_frame_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < b3_equities_binaryentrypoint_sbe_v8_1.simple_open_framing_header.size then
...
b3_equities_binaryentrypoint_sbe_v8_1.packet.requiredsize = function(buffer)

  return true
end

-- Verify Schema Id Field
b3_equities_binaryentrypoint_sbe_v8_1.schema_id.verify = function(buffer)
...
b3_equities_binaryentrypoint_sbe_v8_1.version.verify = function(buffer)
  -- Attempt to read field
...
local function omi_b3_equities_binaryentrypoint_sbe_v8_1_heuristic(buffer, packet, parent)
  ...
  if not b3_equities_binaryentrypoint_sbe_v8_1.packet.requiredsize(buffer) then return false end

  -- Verify Schema Id
  if not b3_equities_binaryentrypoint_sbe_v8_1.schema_id.verify(buffer) then return false end

  -- Verify Version
  if not b3_equities_binaryentrypoint_sbe_v8_1.version.verify(buffer) then return false end
