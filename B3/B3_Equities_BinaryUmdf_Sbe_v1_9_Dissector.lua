...
b3_equities_binaryumdf_sbe_v1_9_dissect.no_m_d_entries_groups_fields = function(buffer, offset, packet, parent)
  ...
  for no_m_d_entries_group_index = 1, num_in_group do
    ...
    if no_m_d_entries_group ~= nil then
      local iteration = no_m_d_entries_group:add(b3_equities_binaryumdf_sbe_v1_9.fields.no_m_d_entries_group_index, no_m_d_entries_group_index)
...
b3_equities_binaryumdf_sbe_v1_9_dissect.no_instr_attribs_groups_fields = function(buffer, offset, packet, parent)
  ...
  for no_instr_attribs_group_index = 1, num_in_group do
    ...
    if no_instr_attribs_group ~= nil then
      local iteration = no_instr_attribs_group:add(b3_equities_binaryumdf_sbe_v1_9.fields.no_instr_attribs_group_index, no_instr_attribs_group_index)
      iteration:set_generated()
    end
  end
...
b3_equities_binaryumdf_sbe_v1_9_dissect.no_legs_groups_fields = function(buffer, offset, packet, parent)
  ...
  for no_legs_group_index = 1, num_in_group do
    ...
    if no_legs_group ~= nil then
      local iteration = no_legs_group:add(b3_equities_binaryumdf_sbe_v1_9.fields.no_legs_group_index, no_legs_group_index)
      iteration:set_generated()
    end
  end
...
b3_equities_binaryumdf_sbe_v1_9_dissect.no_underlyings_groups_fields = function(buffer, offset, packet, parent)
  ...
  for no_underlyings_group_index = 1, num_in_group do
    ...
    if no_underlyings_group ~= nil then
      local iteration = no_underlyings_group:add(b3_equities_binaryumdf_sbe_v1_9.fields.no_underlyings_group_index, no_underlyings_group_index)
      iteration:set_generated()
    end
  end
...
b3_equities_binaryumdf_sbe_v1_9_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(b3_equities_binaryumdf_sbe_v1_9.fields.message, buffer(offset, 0))
    local current = b3_equities_binaryumdf_sbe_v1_9_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = b3_equities_binaryumdf_sbe_v1_9_display.message(buffer, packet, element)
    element:append_text(display)
