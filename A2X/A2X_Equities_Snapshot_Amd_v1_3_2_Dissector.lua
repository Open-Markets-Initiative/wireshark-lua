...
local omi_a2x_equities_snapshot_amd_v1_3_2 = Proto("Omi.A2X.Equities.Snapshot.Amd.v1.3.2", "A2X Equities Snapshot Amd 1.3.2")
...
omi_a2x_equities_snapshot_amd_v1_3_2.fields.mac_open = ProtoField.new("Mac Open", "a2x.equities.snapshot.amd.v1.3.2.macopen", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
omi_a2x_equities_snapshot_amd_v1_3_2.fields.mac_run = ProtoField.new("Mac Run", "a2x.equities.snapshot.amd.v1.3.2.macrun", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_a2x_equities_snapshot_amd_v1_3_2.fields.trading = ProtoField.new("Trading", "a2x.equities.snapshot.amd.v1.3.2.trading", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_a2x_equities_snapshot_amd_v1_3_2.fields.unused = ProtoField.new("Unused", "a2x.equities.snapshot.amd.v1.3.2.unused", ftypes.UINT8, nil, base.DEC, 0x1F)
...
omi_a2x_equities_snapshot_amd_v1_3_2.fields.heartbeat_message = ProtoField.new("Heartbeat Message", "a2x.equities.snapshot.amd.v1.3.2.heartbeatmessage", ftypes.BYTES)
...
function omi_a2x_equities_snapshot_amd_v1_3_2.prefs_changed()
  ...
  if show.message_index ~= omi_a2x_equities_snapshot_amd_v1_3_2.prefs.show_message_index then
    show.message_index = omi_a2x_equities_snapshot_amd_v1_3_2.prefs.show_message_index
  end
end
...
a2x_equities_snapshot_amd_v1_3_2.market_flags.bits = function(range, value, packet, parent)
  ...
  -- Unused: 5 Bit
  parent:add(omi_a2x_equities_snapshot_amd_v1_3_2.fields.unused, range, value)
...
a2x_equities_snapshot_amd_v1_3_2.packet.requiredsize = function(buffer)
  return buffer:len() >= a2x_equities_snapshot_amd_v1_3_2.message_count.size
end
...
a2x_equities_snapshot_amd_v1_3_2.packet.dissect = function(buffer, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = a2x_equities_snapshot_amd_v1_3_2.message.dissect(buffer, index, packet, parent, msg_length, message_index)
  end
...
-- Register A2X Equities Snapshot Amd 1.3.2 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_a2x_equities_snapshot_amd_v1_3_2)
