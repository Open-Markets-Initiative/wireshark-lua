...
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.aod_enabled = ProtoField.new("Aod Enabled", "a2x.equities.rtmdf.amd.v1.3.2.aodenabled", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0400)
...
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.illiquid = ProtoField.new("Illiquid", "a2x.equities.rtmdf.amd.v1.3.2.illiquid", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x1000)
...
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.mac_enabled = ProtoField.new("Mac Enabled", "a2x.equities.rtmdf.amd.v1.3.2.macenabled", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x8000)
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.mac_open = ProtoField.new("Mac Open", "a2x.equities.rtmdf.amd.v1.3.2.macopen", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.mac_run = ProtoField.new("Mac Run", "a2x.equities.rtmdf.amd.v1.3.2.macrun", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.trading = ProtoField.new("Trading", "a2x.equities.rtmdf.amd.v1.3.2.trading", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.unused_1 = ProtoField.new("Unused 1", "a2x.equities.rtmdf.amd.v1.3.2.unused1", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0800)
...
omi_a2x_equities_rtmdf_amd_v1_3_2.fields.heartbeat_message = ProtoField.new("Heartbeat Message", "a2x.equities.rtmdf.amd.v1.3.2.heartbeatmessage", ftypes.BYTES)
...
-- Dissector Heuristic for A2X Equities Rtmdf Amd 1.3.2 (Udp)
local function omi_a2x_equities_rtmdf_amd_v1_3_2_udp_heuristic(buffer, packet, parent)
...
omi_a2x_equities_rtmdf_amd_v1_3_2:register_heuristic("udp", omi_a2x_equities_rtmdf_amd_v1_3_2_udp_heuristic)

-- Register A2X Equities Rtmdf Amd 1.3.2 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_a2x_equities_rtmdf_amd_v1_3_2)
