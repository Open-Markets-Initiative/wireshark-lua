...
boats_equities_memoirtopofbook_sbe_v1_3.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 1 then
    return boats_equities_memoirtopofbook_sbe_v1_3.instrument_directory_message.size
  end
  -- Size of Reg Sho Restriction Message
  if template_id == 2 then
    return boats_equities_memoirtopofbook_sbe_v1_3.reg_sho_restriction_message.size
  end
  ...
  if template_id == 10 then
    return boats_equities_memoirtopofbook_sbe_v1_3.best_bid_offer_message.size
  end
  -- Size of Best Bid Message
  if template_id == 11 then
    return boats_equities_memoirtopofbook_sbe_v1_3.best_bid_message.size
  end
  -- Size of Best Offer Message
  if template_id == 12 then
    return boats_equities_memoirtopofbook_sbe_v1_3.best_offer_message.size
  end
  -- Size of Best Bid Short Message
  if template_id == 13 then
    return boats_equities_memoirtopofbook_sbe_v1_3.best_bid_short_message.size
  end
  -- Size of Best Offer Short Message
  if template_id == 14 then
    return boats_equities_memoirtopofbook_sbe_v1_3.best_offer_short_message.size
  end
  -- Size of Clear Book Message
  if template_id == 15 then
    return boats_equities_memoirtopofbook_sbe_v1_3.clear_book_message.size
  end
...
boats_equities_memoirtopofbook_sbe_v1_3.sequenced_message.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_boats_equities_memoirtopofbook_sbe_v1_3.fields.sequenced_message, buffer(offset, 0))
    local index = boats_equities_memoirtopofbook_sbe_v1_3.sequenced_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = boats_equities_memoirtopofbook_sbe_v1_3.sequenced_message.display(packet, parent, length)
    parent:append_text(display)
