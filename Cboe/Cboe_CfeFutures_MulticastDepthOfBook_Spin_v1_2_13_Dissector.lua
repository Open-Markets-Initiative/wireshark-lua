...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_future_leg = Pref.bool("Show Future Leg", show.future_leg, "Parse and add Future Leg to protocol tree")
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_futures_flags = Pref.bool("Show Futures Flags", show.futures_flags, "Parse and add Futures Flags to protocol tree")
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_summary_flags = Pref.bool("Show Summary Flags", show.summary_flags, "Parse and add Summary Flags to protocol tree")
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_future_leg_index = Pref.bool("Show Future Leg Index", show.future_leg_index, "Show generated future leg index in protocol tree")
...
function omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs_changed()
  ...
  if show.future_leg ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_future_leg then
    show.future_leg = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_future_leg
  end
  if show.futures_flags ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_futures_flags then
    show.futures_flags = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_futures_flags
  end
  ...
  if show.summary_flags ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_summary_flags then
    show.summary_flags = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_summary_flags
  end
  ...
  if show.future_leg_index ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_future_leg_index then
    show.future_leg_index = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_future_leg_index
  end
end
