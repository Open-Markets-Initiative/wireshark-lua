...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.future_leg = ProtoField.new("Future Leg", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.futureleg", ftypes.STRING)
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.futures_flags = ProtoField.new("Futures Flags", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.futuresflags", ftypes.STRING)
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.high_price_is_bid = ProtoField.new("High Price Is Bid", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.highpriceisbid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.high_price_valid = ProtoField.new("High Price Valid", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.highpricevalid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.leg_ratio = ProtoField.new("Leg Ratio", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.legratio", ftypes.INT32)
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.leg_symbol = ProtoField.new("Leg Symbol", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.legsymbol", ftypes.STRING)
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.low_price_is_offer = ProtoField.new("Low Price Is Offer", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.lowpriceisoffer", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.low_price_valid = ProtoField.new("Low Price Valid", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.lowpricevalid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.offer_close_valid = ProtoField.new("Offer Close Valid", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.offerclosevalid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.reserved_flags_3 = ProtoField.new("Reserved Flags 3", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.reservedflags3", ftypes.UINT8, nil, base.DEC, 0xE0)
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.reserved_flags_7 = ProtoField.new("Reserved Flags 7", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.reservedflags7", ftypes.UINT8, nil, base.DEC, 0xFE)
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.summary_flags = ProtoField.new("Summary Flags", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.summaryflags", ftypes.STRING)
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.variance = ProtoField.new("Variance", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.variance", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)

-- Cboe CfeFutures MulticastDepthOfBook Spin 1.2.13 Headers
...
-- Cboe CfeFutures MulticastDepthOfBook 1.2.13 Application Messages
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.future_leg_index = ProtoField.new("Future Leg Index", "cboe.cfefutures.multicastdepthofbook.spin.v1.2.13.futurelegindex", ftypes.UINT16)
...
-----------------------------------------------------------------------
-- Cboe CfeFutures MulticastDepthOfBook Spin 1.2.13 Formatting
-----------------------------------------------------------------------

-- Timestamp format (true = decimal-scaled, false = raw mantissa)
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.format_timestamp = true
...
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")
...
function omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs_changed()
  ...
  if show.repeating_groups ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_repeating_groups then
    show.repeating_groups = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_repeating_groups
  end
  if show.structs ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_structs then
    show.structs = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_indexes then
    show.indexes = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.show_indexes
  end
  if cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.format_timestamp ~= omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.format_timestamp then
    cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.format_timestamp = omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.prefs.format_timestamp
  end
end
...
-- Leg Ratio
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio = {}

-- Size: Leg Ratio
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio.size = 4

-- Display: Leg Ratio
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio.display = function(value)
  return "Leg Ratio: "..value
end

-- Dissect: Leg Ratio
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio.dissect = function(buffer, offset, packet, parent)
  local length = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio.size
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.leg_ratio, range, value, display)

  return offset + length, value
end

-- Leg Symbol
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol = {}

-- Size: Leg Symbol
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol.size = 6

-- Display: Leg Symbol
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol.display = function(value)
  return "Leg Symbol: "..value
end

-- Dissect: Leg Symbol
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol.dissect = function(buffer, offset, packet, parent)
  local length = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.leg_symbol, range, value, display)
...
-- Summary Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags = {}

-- Size: Summary Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags.size = 1

-- Display: Summary Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags.bits = function(range, value, packet, parent)

  -- High Price Valid: 1 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.high_price_valid, range, value)

  -- High Price Is Bid: 1 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.high_price_is_bid, range, value)

  -- Low Price Valid: 1 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.low_price_valid, range, value)

  -- Low Price Is Offer: 1 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.low_price_is_offer, range, value)

  -- Offer Close Valid: 1 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.offer_close_valid, range, value)

  -- Reserved Flags 3: 3 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.reserved_flags_3, range, value)
end

-- Dissect: Summary Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags.display(range, value, packet, parent)
  local element = parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.summary_flags, range, display)

  if show.structs then
    cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.summary_flags.bits(range, value, packet, element)
  end
...
-- Future Leg
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg = {}

-- Size: Future Leg
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.size =
  cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio.size + 
  cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol.size

-- Display: Future Leg
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Future Leg
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.fields = function(buffer, offset, packet, parent, future_leg_index)
  local index = offset

  -- Implicit Future Leg Index
  if future_leg_index ~= nil and show.indexes then
    local iteration = parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.future_leg_index, future_leg_index)
    iteration:set_generated()
  end

  -- Leg Ratio: Signed Binary
  index, leg_ratio = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_ratio.dissect(buffer, index, packet, parent)

  -- Leg Symbol: Alphanumeric
  index, leg_symbol = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_symbol.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Future Leg
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.dissect = function(buffer, offset, packet, parent, future_leg_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.future_leg, buffer(offset, 0))
    local index = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.fields(buffer, offset, packet, parent, future_leg_index)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.fields(buffer, offset, packet, parent, future_leg_index)
  end
end

-- Futures Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags = {}

-- Size: Futures Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.size = 1

-- Display: Futures Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.bits = function(range, value, packet, parent)

  -- Variance: 1 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.variance, range, value)

  -- Reserved Flags 7: 7 Bit
  parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.reserved_flags_7, range, value)
end

-- Dissect: Futures Flags
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.display(range, value, packet, parent)
  local element = parent:add(omi_cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.fields.futures_flags, range, display)

  if show.structs then
    cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.bits(range, value, packet, element)
  end
...
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_instrument_definition_message.size = function(buffer, offset)
  local index = 0

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.time_offset.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.symbol.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.unit_timestamp.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.report_symbol.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_flags.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.expiration_date.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.contract_size.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.listing_state.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.price_increment.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_count.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.leg_offset.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.reserved_1.size

  index = index + cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.contract_date.size
...
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.futures_instrument_definition_message.fields = function(buffer, offset, packet, parent)
  ...
  for future_leg_index = 1, leg_count do
    index, future_leg = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.future_leg.dissect(buffer, index, packet, parent, future_leg_index)
  end
...
-- Heartbeat
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.heartbeat = {}

-- Display: Heartbeat
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.heartbeat.display(packet, parent, 0)
...
cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.messages.dissect = function(buffer, offset, packet, parent, count)
  -- Dissect Heartbeat
  if count == 0 then
    return cboe_cfefutures_multicastdepthofbook_spin_v1_2_13.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
