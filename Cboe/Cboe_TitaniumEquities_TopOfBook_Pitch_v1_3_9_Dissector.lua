...
cboe_titaniumequities_topofbook_pitch_v1_3_9.message.size = function(buffer, offset)
  local index = offset
...
cboe_titaniumequities_topofbook_pitch_v1_3_9.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = cboe_titaniumequities_topofbook_pitch_v1_3_9.message.size(buffer, offset)
...
-- Messages
cboe_titaniumequities_topofbook_pitch_v1_3_9.messages = {}

-- Dissect: Messages
cboe_titaniumequities_topofbook_pitch_v1_3_9.messages.dissect = function(buffer, offset, packet, parent, sequence)
  -- Dissect Heartbeat
  if sequence == 0 then
    return offset
  end
  ...
  for message_index = 1, count do
    ...
    offset = cboe_titaniumequities_topofbook_pitch_v1_3_9.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
cboe_titaniumequities_topofbook_pitch_v1_3_9.packet.requiredsize = function(buffer)
  return buffer:len() >= cboe_titaniumequities_topofbook_pitch_v1_3_9.packet_header.size
end
...
cboe_titaniumequities_topofbook_pitch_v1_3_9.packet.dissect = function(buffer, packet, parent)
  ...
  index = cboe_titaniumequities_topofbook_pitch_v1_3_9.messages.dissect(buffer, index, packet, parent, sequence)
...
omi_cboe_titaniumequities_topofbook_pitch_v1_3_9:register_heuristic("udp", omi_cboe_titaniumequities_topofbook_pitch_v1_3_9_udp_heuristic)

-- Register Cboe TitaniumEquities TopOfBook Pitch 1.3.9 on default port
