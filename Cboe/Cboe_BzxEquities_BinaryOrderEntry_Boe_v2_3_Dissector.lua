...
-- Cboe BzxEquities BinaryOrderEntry 2.3 Application Messages
...
function omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs_changed()
  ...
  if show.repeating_groups ~= omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_repeating_groups then
    show.repeating_groups = omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_repeating_groups
  end
  if show.structs ~= omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_structs then
    show.structs = omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_indexes then
    show.indexes = omi_cboe_bzxequities_binaryorderentry_boe_v2_3.prefs.show_indexes
  end
end
