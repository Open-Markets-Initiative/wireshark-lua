...
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.adap_reserved_flags = ProtoField.new("Adap Reserved Flags", "cboe.byx.equities.summarydepth.pitch.v1.0.4.adapreservedflags", ftypes.UINT8, nil, base.DEC, 0xF8)
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.block_type = ProtoField.new("Block Type", "cboe.byx.equities.summarydepth.pitch.v1.0.4.blocktype", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.clear = ProtoField.new("Clear", "cboe.byx.equities.summarydepth.pitch.v1.0.4.clear", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.complete = ProtoField.new("Complete", "cboe.byx.equities.summarydepth.pitch.v1.0.4.complete", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.lastsale_eligible = ProtoField.new("Lastsale Eligible", "cboe.byx.equities.summarydepth.pitch.v1.0.4.lastsaleeligible", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.price = ProtoField.new("Price", "cboe.byx.equities.summarydepth.pitch.v1.0.4.price", ftypes.DOUBLE)
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.quantity = ProtoField.new("Quantity", "cboe.byx.equities.summarydepth.pitch.v1.0.4.quantity", ftypes.UINT32)
...
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.unused = ProtoField.new("Unused", "cboe.byx.equities.summarydepth.pitch.v1.0.4.unused", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)

-- Cboe Byx Equities Pitch SummaryDepth 1.0.4 Application Messages
...
omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
-- Price
cboe_byx_equities_summarydepth_pitch_v1_0_4.price = {}

-- Size: Price
cboe_byx_equities_summarydepth_pitch_v1_0_4.price.size = 4

-- Display: Price
cboe_byx_equities_summarydepth_pitch_v1_0_4.price.display = function(value)
  return "Price: "..value
end

-- Translate: Price
cboe_byx_equities_summarydepth_pitch_v1_0_4.price.translate = function(raw)
  return raw/10000
end

-- Dissect: Price
cboe_byx_equities_summarydepth_pitch_v1_0_4.price.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byx_equities_summarydepth_pitch_v1_0_4.price.size
  local range = buffer(offset, length)
  local raw = range:le_uint()
  local value = cboe_byx_equities_summarydepth_pitch_v1_0_4.price.translate(raw)
  local display = cboe_byx_equities_summarydepth_pitch_v1_0_4.price.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.price, range, value, display)

  return offset + length, value
end

-- Quantity
cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity = {}

-- Size: Quantity
cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity.size = 4

-- Display: Quantity
cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity.display = function(value)
  return "Quantity: "..value
end

-- Dissect: Quantity
cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.quantity, range, value, display)
...
-- Display: Trade Flags
cboe_byx_equities_summarydepth_pitch_v1_0_4.trade_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_byx_equities_summarydepth_pitch_v1_0_4.trade_flags.bits = function(range, value, packet, parent)

  -- Unused: 1 Bit
  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.unused, range, value)

  -- Lastsale Eligible: 1 Bit
  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.lastsale_eligible, range, value)

  -- Reserved Trade Flags: 6 Bit
  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.reserved_trade_flags, range, value)
end

-- Dissect: Trade Flags
cboe_byx_equities_summarydepth_pitch_v1_0_4.trade_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_byx_equities_summarydepth_pitch_v1_0_4.trade_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_byx_equities_summarydepth_pitch_v1_0_4.trade_flags.display(range, value, packet, parent)
  ...
  if show.trade_flags then
    cboe_byx_equities_summarydepth_pitch_v1_0_4.trade_flags.bits(range, value, packet, element)
  end
...
cboe_byx_equities_summarydepth_pitch_v1_0_4.long_update_adap_block.size =
  ...
  cboe_byx_equities_summarydepth_pitch_v1_0_4.price.size + 
  cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity.size
...
cboe_byx_equities_summarydepth_pitch_v1_0_4.long_update_adap_block.fields = function(buffer, offset, packet, parent)
  ...
  index, price = cboe_byx_equities_summarydepth_pitch_v1_0_4.price.dissect(buffer, index, packet, parent)

  -- Quantity: Binary
  index, quantity = cboe_byx_equities_summarydepth_pitch_v1_0_4.quantity.dissect(buffer, index, packet, parent)
...
-- Dissect: Adap Block
cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_block.dissect = function(buffer, offset, packet, parent, adap_block_index)
  if show.adap_block then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.adap_block, buffer(offset, 0))
    local index = cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_block.fields(buffer, offset, packet, parent, adap_block_index)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_block.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_block.fields(buffer, offset, packet, parent, adap_block_index)
  end
end
...
-- Display: Adap Flags
cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_flags.bits = function(range, value, packet, parent)

  -- Clear: 1 Bit
  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.clear, range, value)

  -- Complete: 1 Bit
  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.complete, range, value)

  -- Block Type: 1 Bit
  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.block_type, range, value)

  -- Adap Reserved Flags: 5 Bit
  parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.adap_reserved_flags, range, value)
end

-- Dissect: Adap Flags
cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_flags.display(range, value, packet, parent)
  ...
  if show.adap_flags then
    cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_flags.bits(range, value, packet, element)
  end
...
cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_byx_equities_summarydepth_pitch_v1_0_4.fields.adap_message, buffer(offset, 0))
    local index = cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_byx_equities_summarydepth_pitch_v1_0_4.adap_message.display(packet, parent, length)
    parent:append_text(display)
...
cboe_byx_equities_summarydepth_pitch_v1_0_4.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = cboe_byx_equities_summarydepth_pitch_v1_0_4.message.dissect(buffer, index, packet, parent, message_length, message_index)
  end
