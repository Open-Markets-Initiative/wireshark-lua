...
-- Dissector Heuristic for Cboe CboeEurope LastSale Apf 1.3
local function omi_cboe_cboeeurope_lastsale_apf_v1_3_heuristic(buffer, packet, parent)
...
omi_cboe_cboeeurope_lastsale_apf_v1_3:register_heuristic("tcp", omi_cboe_cboeeurope_lastsale_apf_v1_3_heuristic)
