...
-- Size: Contract Date
size_of.contract_date = 4

-- Display: Contract Date
display.contract_date = function(value)
  return "Contract Date: "..value
end

-- Dissect: Contract Date
dissect.contract_date = function(buffer, offset, packet, parent)
  local length = size_of.contract_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.contract_date(value, buffer, offset, packet, parent)
...
size_of.futures_instrument_definition_message = function(buffer, offset)
  ...
  index = index + size_of.contract_date
...
dissect.futures_instrument_definition_message_fields = function(buffer, offset, packet, parent)
  ...
  index, contract_date = dissect.contract_date(buffer, index, packet, parent)
