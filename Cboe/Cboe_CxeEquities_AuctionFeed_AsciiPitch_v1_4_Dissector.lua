...
-- Cboe CxeEquities AuctionFeed 1.4 Application Messages
...
cboe_cxeequities_auctionfeed_asciipitch_v1_4.utc_offset_hours = 0
...
omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 0, "Hours behind UTC (GMT) for midnight calculation")
...
function omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs_changed()
  ...
  if show.structs ~= omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs.show_structs then
    show.structs = omi_cboe_cxeequities_auctionfeed_asciipitch_v1_4.prefs.show_structs
  end
