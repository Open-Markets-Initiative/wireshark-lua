...
omi_cboe_edgxoptions_complex_pitch_v2_1_61.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "cboe.edgxoptions.complex.pitch.v2.1.61.secondreserved1", ftypes.BYTES)
...
cboe_edgxoptions_complex_pitch_v2_1_61.timestamp_format = 2
...
cboe_edgxoptions_complex_pitch_v2_1_61.format_timestamp = true
...
omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.timestamp_format = Pref.enum("Time Offset Format", 2, "Time Offset display format", timestamp_format_enum, false)
...
function omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs_changed()
  ...
  if show.structs ~= omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.show_structs then
    show.structs = omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.show_indexes then
    show.indexes = omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.show_indexes
  end
  if cboe_edgxoptions_complex_pitch_v2_1_61.format_timestamp ~= omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.format_timestamp then
    cboe_edgxoptions_complex_pitch_v2_1_61.format_timestamp = omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.format_timestamp
  end
  if cboe_edgxoptions_complex_pitch_v2_1_61.timestamp_format ~= omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.timestamp_format then
    cboe_edgxoptions_complex_pitch_v2_1_61.timestamp_format = omi_cboe_edgxoptions_complex_pitch_v2_1_61.prefs.timestamp_format
  end
...
-- Second Reserved 1
cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1 = {}

-- Size: Second Reserved 1
cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1.size = 1

-- Display: Second Reserved 1
cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_edgxoptions_complex_pitch_v2_1_61.fields.second_reserved_1, range, value, display)
...
cboe_edgxoptions_complex_pitch_v2_1_61.timestamp.display = function(time_offset, stored_time, packet)
  -- Raw display mode
  if cboe_edgxoptions_complex_pitch_v2_1_61.timestamp_format == 0 then
    return "Timestamp: "..(stored_time * 1000000000 + time_offset)
  end

  -- Full datetime mode (calculate from capture date + UTC offset)
  if cboe_edgxoptions_complex_pitch_v2_1_61.timestamp_format == 2 and packet then
...
-- Dissect: Timestamp
cboe_edgxoptions_complex_pitch_v2_1_61.timestamp.dissect = function(buffer, offset, packet, parent)
  if cboe_edgxoptions_complex_pitch_v2_1_61.format_timestamp then
...
cboe_edgxoptions_complex_pitch_v2_1_61.trading_status_message.size =
  ...
  cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1.size
...
cboe_edgxoptions_complex_pitch_v2_1_61.trading_status_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_reserved_1 = cboe_edgxoptions_complex_pitch_v2_1_61.second_reserved_1.dissect(buffer, index, packet, parent)
