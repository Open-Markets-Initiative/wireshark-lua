...
omi_cboe_europe_lastsale_apf_v1_3.fields.unsequenced_message = ProtoField.new("Unsequenced Message", "cboe.europe.lastsale.apf.v1.3.unsequencedmessage", ftypes.BYTES)
...
-- Cboe Europe Apf LastSale 1.3 Application Messages
...
omi_cboe_europe_lastsale_apf_v1_3.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
function omi_cboe_europe_lastsale_apf_v1_3.prefs_changed()
  ...
  if show.application_messages ~= omi_cboe_europe_lastsale_apf_v1_3.prefs.show_application_messages then
    show.application_messages = omi_cboe_europe_lastsale_apf_v1_3.prefs.show_application_messages
  end
...
cboe_europe_lastsale_apf_v1_3.unsequenced_message.size = 0

-- Display: Unsequenced Message
cboe_europe_lastsale_apf_v1_3.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect: Unsequenced Message
cboe_europe_lastsale_apf_v1_3.unsequenced_message.dissect = function(buffer, offset, packet, parent)
  local length = cboe_europe_lastsale_apf_v1_3.unsequenced_message.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = cboe_europe_lastsale_apf_v1_3.unsequenced_message.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_europe_lastsale_apf_v1_3.fields.unsequenced_message, range, value, display)
...
cboe_europe_lastsale_apf_v1_3.sequenced_data_packet.dissect = function(buffer, offset, packet, parent)
  if show.sequenced_data_packet then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_europe_lastsale_apf_v1_3.fields.sequenced_data_packet, buffer(offset, 0))
    local index = cboe_europe_lastsale_apf_v1_3.sequenced_data_packet.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_europe_lastsale_apf_v1_3.sequenced_data_packet.display(packet, parent, length)
    parent:append_text(display)
