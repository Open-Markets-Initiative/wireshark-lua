...
omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.aon = ProtoField.new("Aon", "cboe.c2.options.depthofbook.pitch.v2.41.29.aon", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.display = ProtoField.new("Display", "cboe.c2.options.depthofbook.pitch.v2.41.29.display", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.reserved_bit_1 = ProtoField.new("Reserved Bit 1", "cboe.c2.options.depthofbook.pitch.v2.41.29.reservedbit1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.reserved_bit_2 = ProtoField.new("Reserved Bit 2", "cboe.c2.options.depthofbook.pitch.v2.41.29.reservedbit2", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.reserved_flags = ProtoField.new("Reserved Flags", "cboe.c2.options.depthofbook.pitch.v2.41.29.reservedflags", ftypes.UINT8, nil, base.DEC, 0x0F)
...
-- Cboe C2 Options Pitch DepthOfBook 2.41.29 Application Messages
...
omi_cboe_c2_options_depthofbook_pitch_v2_41_29.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_cboe_c2_options_depthofbook_pitch_v2_41_29.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_cboe_c2_options_depthofbook_pitch_v2_41_29.prefs_changed()
  ...
  if show.application_messages ~= omi_cboe_c2_options_depthofbook_pitch_v2_41_29.prefs.show_application_messages then
    show.application_messages = omi_cboe_c2_options_depthofbook_pitch_v2_41_29.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_cboe_c2_options_depthofbook_pitch_v2_41_29.prefs.show_message_index then
    show.message_index = omi_cboe_c2_options_depthofbook_pitch_v2_41_29.prefs.show_message_index
  end
end
...
cboe_c2_options_depthofbook_pitch_v2_41_29.add_order_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_c2_options_depthofbook_pitch_v2_41_29.add_order_flags.bits = function(range, value, packet, parent)

  -- Reserved Flags: 4 Bit
  parent:add(omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.reserved_flags, range, value)

  -- Aon: 1 Bit
  parent:add(omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.aon, range, value)

  -- Reserved Bit 2: 1 Bit
  parent:add(omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.reserved_bit_2, range, value)

  -- Reserved Bit 1: 1 Bit
  parent:add(omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.reserved_bit_1, range, value)

  -- Display: 1 Bit
  parent:add(omi_cboe_c2_options_depthofbook_pitch_v2_41_29.fields.display, range, value)
end
...
cboe_c2_options_depthofbook_pitch_v2_41_29.add_order_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_c2_options_depthofbook_pitch_v2_41_29.add_order_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_c2_options_depthofbook_pitch_v2_41_29.add_order_flags.display(range, value, packet, parent)
  ...
  if show.add_order_flags then
    cboe_c2_options_depthofbook_pitch_v2_41_29.add_order_flags.bits(range, value, packet, element)
  end
...
cboe_c2_options_depthofbook_pitch_v2_41_29.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = cboe_c2_options_depthofbook_pitch_v2_41_29.message.dissect(buffer, index, packet, parent, message_length, message_index)
  end
