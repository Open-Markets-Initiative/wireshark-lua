...
cboe_europe_depthofbook_pitch_v6_49_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    ...
    parent = parent:add(cboe_europe_depthofbook_pitch_v6_49.fields.message, range, display)
  end
...
cboe_europe_depthofbook_pitch_v6_49_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index = cboe_europe_depthofbook_pitch_v6_49_dissect.message(buffer, index, packet, parent, message_length)
  end
