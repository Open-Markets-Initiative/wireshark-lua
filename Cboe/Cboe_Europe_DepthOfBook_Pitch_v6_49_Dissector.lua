...
-- Cboe Europe Pitch DepthOfBook 6.49 Application Messages
...
cboe_europe_depthofbook_pitch_v6_49.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = cboe_europe_depthofbook_pitch_v6_49.message.dissect(buffer, index, packet, parent, message_length, message_index)
  end
