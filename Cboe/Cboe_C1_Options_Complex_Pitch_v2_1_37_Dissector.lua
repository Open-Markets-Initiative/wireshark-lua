...
omi_cboe_c1_options_complex_pitch_v2_1_37.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
omi_cboe_c1_options_complex_pitch_v2_1_37.prefs.show_complex_instrument_leg_index = Pref.bool("Show Complex Instrument Leg Index", show.complex_instrument_leg_index, "Show generated complex instrument leg index in protocol tree")
...
function omi_cboe_c1_options_complex_pitch_v2_1_37.prefs_changed()
  ...
  if show.message_index ~= omi_cboe_c1_options_complex_pitch_v2_1_37.prefs.show_message_index then
    show.message_index = omi_cboe_c1_options_complex_pitch_v2_1_37.prefs.show_message_index
  end
  if show.complex_instrument_leg_index ~= omi_cboe_c1_options_complex_pitch_v2_1_37.prefs.show_complex_instrument_leg_index then
    show.complex_instrument_leg_index = omi_cboe_c1_options_complex_pitch_v2_1_37.prefs.show_complex_instrument_leg_index
  end
end
