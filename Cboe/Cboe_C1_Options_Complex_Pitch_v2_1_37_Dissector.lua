...
cboe_c1_options_complex_pitch_v2_1_37.fields.complex_instrument_leg_index = ProtoField.new("Complex Instrument Leg Index", "cboe.c1.options.complex.pitch.v2.1.37.complexinstrumentlegindex", ftypes.UINT16)
cboe_c1_options_complex_pitch_v2_1_37.fields.message_index = ProtoField.new("Message Index", "cboe.c1.options.complex.pitch.v2.1.37.messageindex", ftypes.UINT16)
...
cboe_c1_options_complex_pitch_v2_1_37_display.end_of_session_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.auction_summary_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.auction_update_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.trading_status_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.auction_trade_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.auction_cancel_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.auction_notification_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.trade_short_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.trade_long_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.delete_order_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.modify_order_short_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.modify_order_long_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.reduce_size_short_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.reduce_size_long_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.order_executed_at_price_size_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.order_executed_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.add_order_expanded_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.add_order_short_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.add_order_long_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.symbol_mapping_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.complex_instrument_leg = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.complex_instrument_definition_expanded_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_dissect.complex_instrument_definition_expanded_message_fields = function(buffer, offset, packet, parent)
  ...
  for complex_instrument_leg_index = 1, leg_count do
    ...
    if complex_instrument_leg ~= nil then
      local iteration = complex_instrument_leg:add(cboe_c1_options_complex_pitch_v2_1_37.fields.complex_instrument_leg_index, complex_instrument_leg_index)
...
cboe_c1_options_complex_pitch_v2_1_37_display.transaction_end_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.transaction_begin = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.unit_clear_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.time_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.time_reference_message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_display.message_header = function(packet, parent, length)
  return ""
end
...
-- Display: Message
cboe_c1_options_complex_pitch_v2_1_37_display.message = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(cboe_c1_options_complex_pitch_v2_1_37.fields.message, buffer(offset, 0))
    local current = cboe_c1_options_complex_pitch_v2_1_37_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = cboe_c1_options_complex_pitch_v2_1_37_display.message(buffer, packet, element)
    element:append_text(display)
...
cboe_c1_options_complex_pitch_v2_1_37_display.packet_header = function(packet, parent, length)
  return ""
end
...
cboe_c1_options_complex_pitch_v2_1_37_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = cboe_c1_options_complex_pitch_v2_1_37_dissect.message(buffer, index, packet, parent, message_length)
  end
