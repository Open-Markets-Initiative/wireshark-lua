...
omi_cboe_pitch_sequencedunitheader_pitch_v1_0.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_cboe_pitch_sequencedunitheader_pitch_v1_0.prefs_changed()
  ...
  if show.message_index ~= omi_cboe_pitch_sequencedunitheader_pitch_v1_0.prefs.show_message_index then
    show.message_index = omi_cboe_pitch_sequencedunitheader_pitch_v1_0.prefs.show_message_index
  end
end
