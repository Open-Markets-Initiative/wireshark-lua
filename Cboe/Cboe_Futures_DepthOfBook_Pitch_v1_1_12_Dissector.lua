...
cboe_futures_depthofbook_pitch_v1_1_12.payload.size = function(buffer, offset, message_type)
  ...
  if message_type == 0x20 then
    return cboe_futures_depthofbook_pitch_v1_1_12.time_message.size
  end
  -- Size of Unit Clear Message
  if message_type == 0x97 then
    return cboe_futures_depthofbook_pitch_v1_1_12.unit_clear_message.size
  end
  -- Size of Time Reference Message
  if message_type == 0xB1 then
    return cboe_futures_depthofbook_pitch_v1_1_12.time_reference_message.size
  end
  ...
  if message_type == 0x21 then
    return cboe_futures_depthofbook_pitch_v1_1_12.add_order_long_message.size
  end
  -- Size of Add Order Short Message
  if message_type == 0x22 then
    return cboe_futures_depthofbook_pitch_v1_1_12.add_order_short_message.size
  end
  -- Size of Order Executed Message
  if message_type == 0x23 then
    return cboe_futures_depthofbook_pitch_v1_1_12.order_executed_message.size
  end
  -- Size of Reduce Size Long Message
  if message_type == 0x25 then
    return cboe_futures_depthofbook_pitch_v1_1_12.reduce_size_long_message.size
  end
  -- Size of Reduce Size Short Message
  if message_type == 0x26 then
    return cboe_futures_depthofbook_pitch_v1_1_12.reduce_size_short_message.size
  end
  -- Size of Modify Order Long Message
  if message_type == 0x27 then
    return cboe_futures_depthofbook_pitch_v1_1_12.modify_order_long_message.size
  end
  -- Size of Modify Order Short Message
  if message_type == 0x28 then
    return cboe_futures_depthofbook_pitch_v1_1_12.modify_order_short_message.size
  end
  -- Size of Delete Order Message
  if message_type == 0x29 then
    return cboe_futures_depthofbook_pitch_v1_1_12.delete_order_message.size
  end
  -- Size of Trade Long Message
  if message_type == 0x2A then
    return cboe_futures_depthofbook_pitch_v1_1_12.trade_long_message.size
  end
  -- Size of Trade Short Message
  if message_type == 0x2B then
    return cboe_futures_depthofbook_pitch_v1_1_12.trade_short_message.size
  end
  -- Size of Transaction Begin
  if message_type == 0xBC then
    return cboe_futures_depthofbook_pitch_v1_1_12.transaction_begin.size
  end
  -- Size of Transaction End
  if message_type == 0xBD then
    return cboe_futures_depthofbook_pitch_v1_1_12.transaction_end.size
  end
  -- Size of Trade Break Message
  if message_type == 0x2C then
    return cboe_futures_depthofbook_pitch_v1_1_12.trade_break_message.size
  end
  -- Size of Settlement Message
  if message_type == 0xB9 then
    return cboe_futures_depthofbook_pitch_v1_1_12.settlement_message.size
  end
  -- Size of End Of Day Summary Message
  if message_type == 0xBA then
    return cboe_futures_depthofbook_pitch_v1_1_12.end_of_day_summary_message.size
  end
  -- Size of Trading Status Message
  if message_type == 0x31 then
    return cboe_futures_depthofbook_pitch_v1_1_12.trading_status_message.size
  end
  -- Size of End Of Session Message
  if message_type == 0x2D then
    return cboe_futures_depthofbook_pitch_v1_1_12.end_of_session_message.size
  end
