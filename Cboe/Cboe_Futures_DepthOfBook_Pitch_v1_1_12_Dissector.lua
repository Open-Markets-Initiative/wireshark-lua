...
omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.high_price_is_bid = ProtoField.new("High Price Is Bid", "cboe.futures.depthofbook.pitch.v1.1.12.highpriceisbid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.high_price_valid = ProtoField.new("High Price Valid", "cboe.futures.depthofbook.pitch.v1.1.12.highpricevalid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.low_price_is_offer = ProtoField.new("Low Price Is Offer", "cboe.futures.depthofbook.pitch.v1.1.12.lowpriceisoffer", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.low_price_valid = ProtoField.new("Low Price Valid", "cboe.futures.depthofbook.pitch.v1.1.12.lowpricevalid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.offer_close_valid = ProtoField.new("Offer Close Valid", "cboe.futures.depthofbook.pitch.v1.1.12.offerclosevalid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.reserved_flags = ProtoField.new("Reserved Flags", "cboe.futures.depthofbook.pitch.v1.1.12.reservedflags", ftypes.UINT8, nil, base.DEC, 0xE0)
...
-- Cboe Futures Pitch DepthOfBook 1.1.12 Application Messages
...
omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_future_leg_index = Pref.bool("Show Future Leg Index", show.future_leg_index, "Show generated future leg index in protocol tree")

-- Handle changed preferences
function omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_application_messages then
    show.application_messages = omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_message_index then
    show.message_index = omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_message_index
  end
  if show.future_leg_index ~= omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_future_leg_index then
    show.future_leg_index = omi_cboe_futures_depthofbook_pitch_v1_1_12.prefs.show_future_leg_index
  end
end
...
cboe_futures_depthofbook_pitch_v1_1_12.summary_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_futures_depthofbook_pitch_v1_1_12.summary_flags.bits = function(range, value, packet, parent)

  -- High Price Valid: 1 Bit
  parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.high_price_valid, range, value)

  -- High Price Is Bid: 1 Bit
  parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.high_price_is_bid, range, value)

  -- Low Price Valid: 1 Bit
  parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.low_price_valid, range, value)

  -- Low Price Is Offer: 1 Bit
  parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.low_price_is_offer, range, value)

  -- Offer Close Valid: 1 Bit
  parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.offer_close_valid, range, value)

  -- Reserved Flags: 3 Bit
  parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.reserved_flags, range, value)
end

-- Dissect: Summary Flags
cboe_futures_depthofbook_pitch_v1_1_12.summary_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_futures_depthofbook_pitch_v1_1_12.summary_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_futures_depthofbook_pitch_v1_1_12.summary_flags.display(range, value, packet, parent)
  ...
  if show.summary_flags then
    cboe_futures_depthofbook_pitch_v1_1_12.summary_flags.bits(range, value, packet, element)
  end
...
cboe_futures_depthofbook_pitch_v1_1_12.variance.dissect = function(buffer, offset, packet, parent)
  if show.variance then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.variance, buffer(offset, 0))
    local index = cboe_futures_depthofbook_pitch_v1_1_12.variance.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_futures_depthofbook_pitch_v1_1_12.variance.display(packet, parent, length)
    parent:append_text(display)
...
cboe_futures_depthofbook_pitch_v1_1_12.standard.dissect = function(buffer, offset, packet, parent)
  if show.standard then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.standard, buffer(offset, 0))
    local index = cboe_futures_depthofbook_pitch_v1_1_12.standard.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_futures_depthofbook_pitch_v1_1_12.standard.display(packet, parent, length)
    parent:append_text(display)
...
cboe_futures_depthofbook_pitch_v1_1_12.futures_instrument_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cboe_futures_depthofbook_pitch_v1_1_12.fields.futures_instrument_definition_message, buffer(offset, 0))
    local index = cboe_futures_depthofbook_pitch_v1_1_12.futures_instrument_definition_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cboe_futures_depthofbook_pitch_v1_1_12.futures_instrument_definition_message.display(packet, parent, length)
    parent:append_text(display)
