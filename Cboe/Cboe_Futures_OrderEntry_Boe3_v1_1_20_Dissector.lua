...
verify.omi_cboe_futures_orderentry_boe3_v1_1_20_packet_size = function(buffer)
...
local function omi_cboe_futures_orderentry_boe3_v1_1_20_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_cboe_futures_orderentry_boe3_v1_1_20_packet_size(buffer) then return false end
