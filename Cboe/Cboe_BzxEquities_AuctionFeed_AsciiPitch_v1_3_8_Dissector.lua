...
local omi_cboe_bzxequities_auctionfeed_asciipitch_v1_3_8 = Proto("Omi.Cboe.BzxEquities.AuctionFeed.AsciiPitch.v1.3.8", "Cboe BzxEquities AuctionFeed AsciiPitch 1.3.8")
