...
omi_cboe_gaprequestproxy_pitch_v1_0.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_cboe_gaprequestproxy_pitch_v1_0.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_cboe_gaprequestproxy_pitch_v1_0.prefs_changed()
  ...
  if show.structs ~= omi_cboe_gaprequestproxy_pitch_v1_0.prefs.show_structs then
    show.structs = omi_cboe_gaprequestproxy_pitch_v1_0.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_gaprequestproxy_pitch_v1_0.prefs.show_indexes then
    show.indexes = omi_cboe_gaprequestproxy_pitch_v1_0.prefs.show_indexes
  end
end
