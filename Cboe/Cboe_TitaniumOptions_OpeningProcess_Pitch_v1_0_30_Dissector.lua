...
-- Cboe TitaniumOptions Pitch OpeningProcess 1.0.30 Application Messages
...
omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.fields.timestamp = ProtoField.new("Timestamp", "cboe.titaniumoptions.openingprocess.pitch.v1.0.30.timestamp", ftypes.UINT64)
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset_format = 2  -- 0=Raw, 1=TimeOfDay, 2=FullDateTime
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.utc_offset_hours = 5 -- Hours behind UTC (EST = 5, EDT = 4, UTC = 0)
...
omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.prefs.time_offset_format = Pref.enum("Time Offset Format", 2, "Time Offset display format", time_offset_format_enum, false)
omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC for midnight calculation (EST=5, EDT=4, UTC=0)")
...
function omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.prefs_changed()
  ...
  if cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset_format ~= omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.prefs.time_offset_format then
    cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset_format = omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.prefs.time_offset_format
  end
  if cboe_titaniumoptions_openingprocess_pitch_v1_0_30.utc_offset_hours ~= omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.prefs.utc_offset_hours then
    cboe_titaniumoptions_openingprocess_pitch_v1_0_30.utc_offset_hours = omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.prefs.utc_offset_hours
  end
end
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation = {}
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.data = function(packet)
  local key = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.key(packet)
  local data = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.flows[key]
  if data == nil then
    data = { time = { last = nil, frames = {} } }
    cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.flows[key] = data
  end
  return data
end
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.current = nil
...
-- Store: Time
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.current = nil

-- Generated: Time
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.generated = function(value, range, packet, parent)
  local display = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.display(value)
  local time = parent:add(omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.fields.time, range, value, display)
  time:set_generated()
end
...
-- Translate: Timestamp
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.translate = function(time_offset, stored_time)
  return UInt64.new(stored_time * 1000000000 + time_offset)
end

-- Display: Timestamp
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.display = function(time_offset, stored_time, packet)
  -- Raw display mode
  if cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset_format == 0 then
    return "Timestamp: "..(stored_time * 1000000000 + time_offset)
  end

  -- Full datetime mode (calculate from capture date + UTC offset)
  if cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.utc_offset_hours * 3600
...
-- Composite: Timestamp
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.composite = function(buffer, offset, stored_time, packet, parent)
  local length = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset.size
  local range = buffer(offset, length)
  local time_offset = range:le_uint()
  local value = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.translate(time_offset, stored_time)
  local display = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.display(time_offset, stored_time)
  parent = parent:add(omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.fields.timestamp, range, value, display)

  cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.generated(stored_time, range, packet, parent)

  display = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset.display(time_offset)
  parent:add(omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30.fields.time_offset, range, time_offset, display)
...
-- Dissect: Timestamp
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.dissect = function(buffer, offset, packet, parent)
  local stored_time = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.current

  if stored_time ~= nil then
    return cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.composite(buffer, offset, stored_time, packet, parent)
  end

  return cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_offset.dissect(buffer, offset, packet, parent)
end
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.soq_strike_range_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, time_offset = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.timestamp.dissect(buffer, index, packet, parent)
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Store Time Value
  cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.current = time

  if not packet.visited then
    cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.current.time.last = time
  end
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.message.size = function(buffer, offset)
  local index = offset
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.message.size(buffer, offset)
...
-- Messages
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.messages = {}

-- Dissect: Messages
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.messages.dissect = function(buffer, offset, packet, parent, sequence)
  -- Dissect Heartbeat
  if sequence == 0 then
    return offset
  end
  ...
  for message_index = 1, count do
    ...
    offset = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.packet.requiredsize = function(buffer)
  return buffer:len() >= cboe_titaniumoptions_openingprocess_pitch_v1_0_30.packet_header.size
end

-- Dissect Packet
cboe_titaniumoptions_openingprocess_pitch_v1_0_30.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.data(packet)
  if not packet.visited then
    data.time.frames[packet.number] = data.time.last
    data.time.frames[packet.number] = data.time.last
  end
  cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.current = data.time.frames[packet.number]
  cboe_titaniumoptions_openingprocess_pitch_v1_0_30.time.current = data.time.frames[packet.number]
  cboe_titaniumoptions_openingprocess_pitch_v1_0_30.conversation.current = data
  ...
  index = cboe_titaniumoptions_openingprocess_pitch_v1_0_30.messages.dissect(buffer, index, packet, parent, sequence)
...
-- Dissector Heuristic for Cboe TitaniumOptions OpeningProcess Pitch 1.0.30 (Udp)
local function omi_cboe_titaniumoptions_openingprocess_pitch_v1_0_30_udp_heuristic(buffer, packet, parent)
