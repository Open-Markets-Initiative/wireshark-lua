...
omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.reserved_1 = ProtoField.new("Reserved 1", "cboe.byxequities.summarydepth.pitch.v1.0.4.reserved1", ftypes.STRING)
omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.reserved_8 = ProtoField.new("Reserved 8", "cboe.byxequities.summarydepth.pitch.v1.0.4.reserved8", ftypes.UINT64)
...
omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.unused_1 = ProtoField.new("Unused 1", "cboe.byxequities.summarydepth.pitch.v1.0.4.unused1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
function omi_cboe_byxequities_summarydepth_pitch_v1_0_4.prefs_changed()
  ...
  if show.structs ~= omi_cboe_byxequities_summarydepth_pitch_v1_0_4.prefs.show_structs then
    show.structs = omi_cboe_byxequities_summarydepth_pitch_v1_0_4.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_byxequities_summarydepth_pitch_v1_0_4.prefs.show_indexes then
    show.indexes = omi_cboe_byxequities_summarydepth_pitch_v1_0_4.prefs.show_indexes
  end
end
...
-- Reserved 1
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1 = {}

-- Size: Reserved 1
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.size = 1

-- Display: Reserved 1
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.display = function(value)
  return "Reserved 1: "..value
end

-- Dissect: Reserved 1
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.reserved_1, range, value, display)

  return offset + length, value
end

-- Reserved 8
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8 = {}

-- Size: Reserved 8
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8.size = 8

-- Display: Reserved 8
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8.display = function(value)
  return "Reserved 8: "..value
end

-- Dissect: Reserved 8
cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8.dissect = function(buffer, offset, packet, parent)
  local length = cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.reserved_8, range, value, display)
...
cboe_byxequities_summarydepth_pitch_v1_0_4.trading_status_message.size =
  ...
  cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.size + 
...
cboe_byxequities_summarydepth_pitch_v1_0_4.trading_status_message.fields = function(buffer, offset, packet, parent)
  ...
  index, reserved_1 = cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.dissect(buffer, index, packet, parent)
...
cboe_byxequities_summarydepth_pitch_v1_0_4.trade_break_message.size =
  ...
  cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8.size + 
...
cboe_byxequities_summarydepth_pitch_v1_0_4.trade_break_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Reserved 8: Binary
  index, reserved_8 = cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_8.dissect(buffer, index, packet, parent)
...
cboe_byxequities_summarydepth_pitch_v1_0_4.trade_flags.bits = function(range, value, packet, parent)
  ...
  -- Unused 1: 1 Bit
  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.unused_1, range, value)

  -- Lastsale Eligible: 1 Bit
  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.lastsale_eligible, range, value)

  -- Unused 6: 6 Bit
  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.unused_6, range, value)
end
...
cboe_byxequities_summarydepth_pitch_v1_0_4.adap_flags.bits = function(range, value, packet, parent)
  ...
  -- Unused 5: 5 Bit
  parent:add(omi_cboe_byxequities_summarydepth_pitch_v1_0_4.fields.unused_5, range, value)
end
...
cboe_byxequities_summarydepth_pitch_v1_0_4.adap_message.size = function(buffer, offset)
  ...
  index = index + cboe_byxequities_summarydepth_pitch_v1_0_4.reserved_1.size
...
-- Heartbeat
cboe_byxequities_summarydepth_pitch_v1_0_4.heartbeat = {}

-- Display: Heartbeat
cboe_byxequities_summarydepth_pitch_v1_0_4.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
cboe_byxequities_summarydepth_pitch_v1_0_4.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = cboe_byxequities_summarydepth_pitch_v1_0_4.heartbeat.display(packet, parent, 0)
...
cboe_byxequities_summarydepth_pitch_v1_0_4.messages.dissect = function(buffer, offset, packet, parent, count)
  -- Dissect Heartbeat
  if count == 0 then
    return cboe_byxequities_summarydepth_pitch_v1_0_4.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
...
-- Dissector Heuristic for Cboe ByxEquities SummaryDepth Pitch 1.0.4 (Udp)
local function omi_cboe_byxequities_summarydepth_pitch_v1_0_4_udp_heuristic(buffer, packet, parent)
...
omi_cboe_byxequities_summarydepth_pitch_v1_0_4:register_heuristic("udp", omi_cboe_byxequities_summarydepth_pitch_v1_0_4_udp_heuristic)

-- Register Cboe ByxEquities SummaryDepth Pitch 1.0.4 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_cboe_byxequities_summarydepth_pitch_v1_0_4)
