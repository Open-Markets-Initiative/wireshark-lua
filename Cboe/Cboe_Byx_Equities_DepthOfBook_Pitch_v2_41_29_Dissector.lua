...
omi_cboe_byx_equities_depthofbook_pitch_v2_41_29.fields.display = ProtoField.new("Display", "cboe.byx.equities.depthofbook.pitch.v2.41.29.display", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_cboe_byx_equities_depthofbook_pitch_v2_41_29.fields.priority = ProtoField.new("Priority", "cboe.byx.equities.depthofbook.pitch.v2.41.29.priority", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
-- Cboe Byx Equities Pitch DepthOfBook 2.41.29 Application Messages
...
cboe_byx_equities_depthofbook_pitch_v2_41_29.modify_order_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_byx_equities_depthofbook_pitch_v2_41_29.modify_order_flags.bits = function(range, value, packet, parent)

  -- Display: 1 Bit
  parent:add(omi_cboe_byx_equities_depthofbook_pitch_v2_41_29.fields.display, range, value)

  -- Priority: 1 Bit
  parent:add(omi_cboe_byx_equities_depthofbook_pitch_v2_41_29.fields.priority, range, value)

  -- Modify Reserved Flags: 6 Bit
  parent:add(omi_cboe_byx_equities_depthofbook_pitch_v2_41_29.fields.modify_reserved_flags, range, value)
end
...
cboe_byx_equities_depthofbook_pitch_v2_41_29.modify_order_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_byx_equities_depthofbook_pitch_v2_41_29.modify_order_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_byx_equities_depthofbook_pitch_v2_41_29.modify_order_flags.display(range, value, packet, parent)
  ...
  if show.modify_order_flags then
    cboe_byx_equities_depthofbook_pitch_v2_41_29.modify_order_flags.bits(range, value, packet, element)
  end
...
cboe_byx_equities_depthofbook_pitch_v2_41_29.add_order_flags.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_byx_equities_depthofbook_pitch_v2_41_29.add_order_flags.bits = function(range, value, packet, parent)

  -- Display: 1 Bit
  parent:add(omi_cboe_byx_equities_depthofbook_pitch_v2_41_29.fields.display, range, value)

  -- Reserved Flags: 7 Bit
  parent:add(omi_cboe_byx_equities_depthofbook_pitch_v2_41_29.fields.reserved_flags, range, value)
end
...
cboe_byx_equities_depthofbook_pitch_v2_41_29.add_order_flags.dissect = function(buffer, offset, packet, parent)
  local size = cboe_byx_equities_depthofbook_pitch_v2_41_29.add_order_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_byx_equities_depthofbook_pitch_v2_41_29.add_order_flags.display(range, value, packet, parent)
  ...
  if show.add_order_flags then
    cboe_byx_equities_depthofbook_pitch_v2_41_29.add_order_flags.bits(range, value, packet, element)
  end
...
cboe_byx_equities_depthofbook_pitch_v2_41_29.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = cboe_byx_equities_depthofbook_pitch_v2_41_29.message.dissect(buffer, index, packet, parent, message_length, message_index)
  end
