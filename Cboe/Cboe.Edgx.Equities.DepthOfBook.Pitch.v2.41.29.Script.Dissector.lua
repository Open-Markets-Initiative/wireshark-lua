...
cboe_edgx_equities_depthofbook_pitch_v2_41_29.fields.client_id = ProtoField.new("Client Id", "cboe.edgx.equities.depthofbook.pitch.v2.41.29.clientid", ftypes.STRING)
...
dissect.client_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cboe_edgx_equities_depthofbook_pitch_v2_41_29.fields.client_id, range, value, display)
