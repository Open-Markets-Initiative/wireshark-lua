...
cboe_c1_options_auctionfeed_pitch_v1_1_1_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
cboe_c1_options_auctionfeed_pitch_v1_1_1_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    local element = parent:add(cboe_c1_options_auctionfeed_pitch_v1_1_1.fields.message, buffer(offset, 0))
    local current = cboe_c1_options_auctionfeed_pitch_v1_1_1_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = cboe_c1_options_auctionfeed_pitch_v1_1_1_display.message(buffer, packet, element)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    cboe_c1_options_auctionfeed_pitch_v1_1_1_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
