...
omi_cboe_c1options_depthofbook_pitch_v2_39_4.fields.timestamp = ProtoField.new("Timestamp", "cboe.c1options.depthofbook.pitch.v2.39.4.timestamp", ftypes.UINT64)
...
cboe_c1options_depthofbook_pitch_v2_39_4.conversation = {}
cboe_c1options_depthofbook_pitch_v2_39_4.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
cboe_c1options_depthofbook_pitch_v2_39_4.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
cboe_c1options_depthofbook_pitch_v2_39_4.conversation.data = function(packet)
  local key = cboe_c1options_depthofbook_pitch_v2_39_4.conversation.key(packet)
  local data = cboe_c1options_depthofbook_pitch_v2_39_4.conversation.flows[key]
  if data == nil then
    data = { time = { last = nil, frames = {} } }
    cboe_c1options_depthofbook_pitch_v2_39_4.conversation.flows[key] = data
  end
  return data
end
...
cboe_c1options_depthofbook_pitch_v2_39_4.conversation.current = nil
...
-- Store: Time
cboe_c1options_depthofbook_pitch_v2_39_4.time.current = nil

-- Generated: Time
cboe_c1options_depthofbook_pitch_v2_39_4.time.generated = function(value, range, packet, parent)
  local display = cboe_c1options_depthofbook_pitch_v2_39_4.time.display(value)
  local time = parent:add(omi_cboe_c1options_depthofbook_pitch_v2_39_4.fields.time, range, value, display)
  time:set_generated()
end
...
-- Timestamp
cboe_c1options_depthofbook_pitch_v2_39_4.timestamp = {}

-- Translate: Timestamp
cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.translate = function(time_offset, stored_time)
  return UInt64.new(stored_midnightreference + stored_time * 1000000000 + time_offset)
end

-- Display: Timestamp
cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.display = function(time_offset, stored_time)
  return "Timestamp: "..os.date("%Y-%m-%d %H:%M:%S.", stored_time)..string.format("%09d", time_offset)
end

-- Composite: Timestamp
cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.composite = function(buffer, offset, stored_time, packet, parent)
  local length = cboe_c1options_depthofbook_pitch_v2_39_4.time_offset.size
  local range = buffer(offset, length)
  local time_offset = range:le_uint()
  local value = cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.translate(time_offset, stored_time)
  local display = cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.display(time_offset, stored_time)
  parent = parent:add(omi_cboe_c1options_depthofbook_pitch_v2_39_4.fields.timestamp, range, value, display)

  cboe_c1options_depthofbook_pitch_v2_39_4.time.generated(stored_time, range, packet, parent)

  display = cboe_c1options_depthofbook_pitch_v2_39_4.time_offset.display(time_offset)
  parent:add(omi_cboe_c1options_depthofbook_pitch_v2_39_4.fields.time_offset, range, time_offset, display)

  return offset + length, value
end

-- Dissect: Timestamp
cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.dissect = function(buffer, offset, packet, parent)
  local stored_time = cboe_c1options_depthofbook_pitch_v2_39_4.time.current

  if stored_time ~= nil then
    return cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.composite(buffer, offset, stored_time, packet, parent)
  end

  return cboe_c1options_depthofbook_pitch_v2_39_4.time_offset.dissect(buffer, offset, packet, parent)
end
...
cboe_c1options_depthofbook_pitch_v2_39_4.retail_price_improvement_message.fields = function(buffer, offset, packet, parent)
  ...
  index, time_offset = cboe_c1options_depthofbook_pitch_v2_39_4.timestamp.dissect(buffer, index, packet, parent)
...
cboe_c1options_depthofbook_pitch_v2_39_4.time_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Store Time Value
  cboe_c1options_depthofbook_pitch_v2_39_4.time.current = time

  if not packet.visited then
    cboe_c1options_depthofbook_pitch_v2_39_4.conversation.current.time.last = time
  end
...
cboe_c1options_depthofbook_pitch_v2_39_4.message.size = function(buffer, offset)
  local index = offset
...
cboe_c1options_depthofbook_pitch_v2_39_4.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = cboe_c1options_depthofbook_pitch_v2_39_4.message.size(buffer, offset)
...
-- Messages
cboe_c1options_depthofbook_pitch_v2_39_4.messages = {}

-- Dissect: Messages
cboe_c1options_depthofbook_pitch_v2_39_4.messages.dissect = function(buffer, offset, packet, parent, sequence)
  -- Dissect Heartbeat
  if sequence == 0 then
    return offset
  end
  ...
  for message_index = 1, count do
    ...
    offset = cboe_c1options_depthofbook_pitch_v2_39_4.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
cboe_c1options_depthofbook_pitch_v2_39_4.packet.dissect = function(buffer, packet, parent)
  ...
  local data = cboe_c1options_depthofbook_pitch_v2_39_4.conversation.data(packet)
  if not packet.visited then
    data.time.frames[packet.number] = data.time.last
  end
  cboe_c1options_depthofbook_pitch_v2_39_4.time.current = data.time.frames[packet.number]
  cboe_c1options_depthofbook_pitch_v2_39_4.conversation.current = data
  ...
  index = cboe_c1options_depthofbook_pitch_v2_39_4.messages.dissect(buffer, index, packet, parent, sequence)
