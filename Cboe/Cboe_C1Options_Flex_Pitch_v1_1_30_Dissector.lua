...
omi_cboe_c1options_flex_pitch_v1_1_30.fields.bit_fields = ProtoField.new("Bit Fields", "cboe.c1options.flex.pitch.v1.1.30.bitfields", ftypes.STRING)
...
omi_cboe_c1options_flex_pitch_v1_1_30.fields.reserved_7 = ProtoField.new("Reserved 7", "cboe.c1options.flex.pitch.v1.1.30.reserved7", ftypes.UINT8, nil, base.DEC, 0xFE)
...
omi_cboe_c1options_flex_pitch_v1_1_30.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "cboe.c1options.flex.pitch.v1.1.30.secondreserved1", ftypes.BYTES)
...
cboe_c1options_flex_pitch_v1_1_30.format_timestamp = true
...
omi_cboe_c1options_flex_pitch_v1_1_30.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")
...
function omi_cboe_c1options_flex_pitch_v1_1_30.prefs_changed()
  ...
  if show.repeating_groups ~= omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_repeating_groups then
    show.repeating_groups = omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_repeating_groups
  end
  if show.structs ~= omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_structs then
    show.structs = omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_structs
  end
  if show.indexes ~= omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_indexes then
    show.indexes = omi_cboe_c1options_flex_pitch_v1_1_30.prefs.show_indexes
  end
  if cboe_c1options_flex_pitch_v1_1_30.format_timestamp ~= omi_cboe_c1options_flex_pitch_v1_1_30.prefs.format_timestamp then
    cboe_c1options_flex_pitch_v1_1_30.format_timestamp = omi_cboe_c1options_flex_pitch_v1_1_30.prefs.format_timestamp
  end
end
...
-- Second Reserved 1
cboe_c1options_flex_pitch_v1_1_30.second_reserved_1 = {}

-- Size: Second Reserved 1
cboe_c1options_flex_pitch_v1_1_30.second_reserved_1.size = 1

-- Display: Second Reserved 1
cboe_c1options_flex_pitch_v1_1_30.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
cboe_c1options_flex_pitch_v1_1_30.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = cboe_c1options_flex_pitch_v1_1_30.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = cboe_c1options_flex_pitch_v1_1_30.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_c1options_flex_pitch_v1_1_30.fields.second_reserved_1, range, value, display)
...
-- Size: Time Reference
cboe_c1options_flex_pitch_v1_1_30.time_reference.size = 4

-- Display: Time Reference
cboe_c1options_flex_pitch_v1_1_30.time_reference.display = function(value)
  return "Time Reference: "..value
end

-- Dissect: Time Reference
cboe_c1options_flex_pitch_v1_1_30.time_reference.dissect = function(buffer, offset, packet, parent)
  local length = cboe_c1options_flex_pitch_v1_1_30.time_reference.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cboe_c1options_flex_pitch_v1_1_30.time_reference.display(value, buffer, offset, packet, parent)

  parent:add(omi_cboe_c1options_flex_pitch_v1_1_30.fields.time_reference, range, value, display)
...
-- Translate: Timestamp
cboe_c1options_flex_pitch_v1_1_30.timestamp.translate = function(time_offset, stored_midnight_reference, stored_time)
  return UInt64.new(stored_midnight_reference + stored_time * 1000000000 + time_offset)
end

-- Display: Timestamp
cboe_c1options_flex_pitch_v1_1_30.timestamp.display = function(time_offset, stored_midnight_reference, stored_time)
...
cboe_c1options_flex_pitch_v1_1_30.timestamp.composite = function(buffer, offset, stored_midnight_reference, stored_time, packet, parent)
  ...
  local value = cboe_c1options_flex_pitch_v1_1_30.timestamp.translate(time_offset, stored_midnight_reference, stored_time)
  local display = cboe_c1options_flex_pitch_v1_1_30.timestamp.display(time_offset, stored_midnight_reference, stored_time)
...
cboe_c1options_flex_pitch_v1_1_30.trading_status_message.size =
  ...
  cboe_c1options_flex_pitch_v1_1_30.second_reserved_1.size
...
cboe_c1options_flex_pitch_v1_1_30.trading_status_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_reserved_1 = cboe_c1options_flex_pitch_v1_1_30.second_reserved_1.dissect(buffer, index, packet, parent)
...
cboe_c1options_flex_pitch_v1_1_30.dac_delta.fields = function(buffer, offset, packet, parent, dac_delta_index)
  ...
  if dac_delta_index ~= nil and show.indexes then
...
-- Bit Fields
cboe_c1options_flex_pitch_v1_1_30.bit_fields = {}

-- Size: Bit Fields
cboe_c1options_flex_pitch_v1_1_30.bit_fields.size = 1

-- Display: Bit Fields
cboe_c1options_flex_pitch_v1_1_30.bit_fields.display = function(range, value, packet, parent)
  local flags = {}
...
cboe_c1options_flex_pitch_v1_1_30.bit_fields.bits = function(range, value, packet, parent)

  -- Percentage 1: 1 Bit
  parent:add(omi_cboe_c1options_flex_pitch_v1_1_30.fields.percentage_1, range, value)

  -- Reserved 7: 7 Bit
  parent:add(omi_cboe_c1options_flex_pitch_v1_1_30.fields.reserved_7, range, value)
end

-- Dissect: Bit Fields
cboe_c1options_flex_pitch_v1_1_30.bit_fields.dissect = function(buffer, offset, packet, parent)
  local size = cboe_c1options_flex_pitch_v1_1_30.bit_fields.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cboe_c1options_flex_pitch_v1_1_30.bit_fields.display(range, value, packet, parent)
  local element = parent:add(omi_cboe_c1options_flex_pitch_v1_1_30.fields.bit_fields, range, display)

  if show.structs then
    cboe_c1options_flex_pitch_v1_1_30.bit_fields.bits(range, value, packet, element)
  end
...
-- Heartbeat
cboe_c1options_flex_pitch_v1_1_30.heartbeat = {}

-- Display: Heartbeat
cboe_c1options_flex_pitch_v1_1_30.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
cboe_c1options_flex_pitch_v1_1_30.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = cboe_c1options_flex_pitch_v1_1_30.heartbeat.display(packet, parent, 0)
...
cboe_c1options_flex_pitch_v1_1_30.messages.dissect = function(buffer, offset, packet, parent, count)
  -- Dissect Heartbeat
  if count == 0 then
    return cboe_c1options_flex_pitch_v1_1_30.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
