...
local omi_cboe_titaniumconsolidated_oneoptions_pitch_v1_0_10 = Proto("Cboe.TitaniumConsolidated.OneOptions.Pitch.v1.0.10.Lua", "Cboe TitaniumConsolidated OneOptions Pitch 1.0.10")
...
-- Dissect: Messages
cboe_titaniumconsolidated_oneoptions_pitch_v1_0_10.messages.dissect = function(buffer, offset, packet, parent, count, sequence)
  -- Dissect Heartbeat
  if count == 0 then
    return offset
  end
...
cboe_titaniumconsolidated_oneoptions_pitch_v1_0_10.packet.dissect = function(buffer, packet, parent)
  ...
  index = cboe_titaniumconsolidated_oneoptions_pitch_v1_0_10.messages.dissect(buffer, index, packet, parent, count, sequence)
