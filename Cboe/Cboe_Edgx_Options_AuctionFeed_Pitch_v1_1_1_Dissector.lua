...
-- Cboe Edgx Options Pitch AuctionFeed 1.1.1 Application Messages
...
omi_cboe_edgx_options_auctionfeed_pitch_v1_1_1.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_cboe_edgx_options_auctionfeed_pitch_v1_1_1.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Handle changed preferences
function omi_cboe_edgx_options_auctionfeed_pitch_v1_1_1.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_cboe_edgx_options_auctionfeed_pitch_v1_1_1.prefs.show_application_messages then
    show.application_messages = omi_cboe_edgx_options_auctionfeed_pitch_v1_1_1.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_cboe_edgx_options_auctionfeed_pitch_v1_1_1.prefs.show_message_index then
    show.message_index = omi_cboe_edgx_options_auctionfeed_pitch_v1_1_1.prefs.show_message_index
  end
end
