...
cboe_options_openingauction_csm_v1_0.fields.eop_exponent = ProtoField.new("Eop Exponent", "cboe.options.openingauction.csm.v1.0.eopexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.max_strike_price_exponent = ProtoField.new("Max Strike Price Exponent", "cboe.options.openingauction.csm.v1.0.maxstrikepriceexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.md_entry_px_exponent = ProtoField.new("Md Entry Px Exponent", "cboe.options.openingauction.csm.v1.0.mdentrypxexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.minimum_above_premium_fraction_exponent = ProtoField.new("Minimum Above Premium Fraction Exponent", "cboe.options.openingauction.csm.v1.0.minimumabovepremiumfractionexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.minimum_below_premium_fraction_exponent = ProtoField.new("Minimum Below Premium Fraction Exponent", "cboe.options.openingauction.csm.v1.0.minimumbelowpremiumfractionexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.minimum_strike_price_fraction_exponent = ProtoField.new("Minimum Strike Price Fraction Exponent", "cboe.options.openingauction.csm.v1.0.minimumstrikepricefractionexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.premium_break_point_exponent = ProtoField.new("Premium Break Point Exponent", "cboe.options.openingauction.csm.v1.0.premiumbreakpointexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.prev_close_px_exponent = ProtoField.new("Prev Close Px Exponent", "cboe.options.openingauction.csm.v1.0.prevclosepxexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cboe_options_openingauction_csm_v1_0.fields.strike_price_exponent = ProtoField.new("Strike Price Exponent", "cboe.options.openingauction.csm.v1.0.strikepriceexponent", ftypes.INT8, {[1]="Yes",[0]="No"})
