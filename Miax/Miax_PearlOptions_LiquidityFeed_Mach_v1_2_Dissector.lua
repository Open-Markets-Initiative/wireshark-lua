...
-- End Of Session
miax_pearloptions_liquidityfeed_mach_v1_2.end_of_session = {}

-- Display: End Of Session
miax_pearloptions_liquidityfeed_mach_v1_2.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
miax_pearloptions_liquidityfeed_mach_v1_2.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearloptions_liquidityfeed_mach_v1_2.end_of_session.display(packet, parent, 0)
...
-- Start Of Session
miax_pearloptions_liquidityfeed_mach_v1_2.start_of_session = {}

-- Display: Start Of Session
miax_pearloptions_liquidityfeed_mach_v1_2.start_of_session.display = function(packet, parent, length)
  return "Start Of Session"
end


-- Dissect: Start Of Session
miax_pearloptions_liquidityfeed_mach_v1_2.start_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearloptions_liquidityfeed_mach_v1_2.start_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Heartbeat
miax_pearloptions_liquidityfeed_mach_v1_2.heartbeat = {}

-- Display: Heartbeat
miax_pearloptions_liquidityfeed_mach_v1_2.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
miax_pearloptions_liquidityfeed_mach_v1_2.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearloptions_liquidityfeed_mach_v1_2.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_pearloptions_liquidityfeed_mach_v1_2.payload.dissect = function(buffer, offset, packet, parent, packet_type)
  ...
  if packet_type == 0 then
    return miax_pearloptions_liquidityfeed_mach_v1_2.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session
  if packet_type == 1 then
    return miax_pearloptions_liquidityfeed_mach_v1_2.start_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if packet_type == 2 then
    return miax_pearloptions_liquidityfeed_mach_v1_2.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Application Message
