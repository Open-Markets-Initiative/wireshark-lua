...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.attributable_order = ProtoField.new("Attributable Order", "miax.pearlequities.expressorders.meo.v2.7.b.attributableorder", ftypes.UINT16, nil, base.DEC, 0x0300)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.locate_required = ProtoField.new("Locate Required", "miax.pearlequities.expressorders.meo.v2.7.b.locaterequired", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0020)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.min_qty_exec_type = ProtoField.new("Min Qty Exec Type", "miax.pearlequities.expressorders.meo.v2.7.b.minqtyexectype", ftypes.UINT16, nil, base.DEC, 0x0C00)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.nbbo_setter_joiner = ProtoField.new("Nbbo Setter Joiner", "miax.pearlequities.expressorders.meo.v2.7.b.nbbosetterjoiner", ftypes.UINT8, nil, base.DEC, 0x07)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.packet_header = ProtoField.new("Packet Header", "miax.pearlequities.expressorders.meo.v2.7.b.packetheader", ftypes.STRING)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.packet_length = ProtoField.new("Packet Length", "miax.pearlequities.expressorders.meo.v2.7.b.packetlength", ftypes.UINT16)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.packet_type = ProtoField.new("Packet Type", "miax.pearlequities.expressorders.meo.v2.7.b.packettype", ftypes.STRING)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.routing_instruction = ProtoField.new("Routing Instruction", "miax.pearlequities.expressorders.meo.v2.7.b.routinginstruction", ftypes.UINT8, nil, base.DEC, 0x07)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.routing_strategy = ProtoField.new("Routing Strategy", "miax.pearlequities.expressorders.meo.v2.7.b.routingstrategy", ftypes.UINT8, nil, base.DEC, 0xF8)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.self_trade_protection_instruction = ProtoField.new("Self Trade Protection Instruction", "miax.pearlequities.expressorders.meo.v2.7.b.selftradeprotectioninstruction", ftypes.UINT8, nil, base.DEC, 0x38)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.self_trade_protection_level = ProtoField.new("Self Trade Protection Level", "miax.pearlequities.expressorders.meo.v2.7.b.selftradeprotectionlevel", ftypes.UINT8, nil, base.DEC, 0x07)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.short_sale_indicator = ProtoField.new("Short Sale Indicator", "miax.pearlequities.expressorders.meo.v2.7.b.shortsaleindicator", ftypes.UINT16, nil, base.DEC, 0x0006)
omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.side = ProtoField.new("Side", "miax.pearlequities.expressorders.meo.v2.7.b.side", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_miax_pearlequities_expressorders_meo_v2_7_b.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
...
function omi_miax_pearlequities_expressorders_meo_v2_7_b.prefs_changed()
  ...
  if show.packet_header ~= omi_miax_pearlequities_expressorders_meo_v2_7_b.prefs.show_packet_header then
    show.packet_header = omi_miax_pearlequities_expressorders_meo_v2_7_b.prefs.show_packet_header
  end
...
-- Packet Length
miax_pearlequities_expressorders_meo_v2_7_b.packet_length = {}

-- Size: Packet Length
miax_pearlequities_expressorders_meo_v2_7_b.packet_length.size = 2

-- Display: Packet Length
miax_pearlequities_expressorders_meo_v2_7_b.packet_length.display = function(value)
  return "Packet Length: "..value
end

-- Dissect: Packet Length
miax_pearlequities_expressorders_meo_v2_7_b.packet_length.dissect = function(buffer, offset, packet, parent)
  local length = miax_pearlequities_expressorders_meo_v2_7_b.packet_length.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_pearlequities_expressorders_meo_v2_7_b.packet_length.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.packet_length, range, value, display)

  return offset + length, value
end

-- Packet Type
miax_pearlequities_expressorders_meo_v2_7_b.packet_type = {}

-- Size: Packet Type
miax_pearlequities_expressorders_meo_v2_7_b.packet_type.size = 1

-- Display: Packet Type
miax_pearlequities_expressorders_meo_v2_7_b.packet_type.display = function(value)
  if value == "s" then
...
-- Dissect: Packet Type
miax_pearlequities_expressorders_meo_v2_7_b.packet_type.dissect = function(buffer, offset, packet, parent)
  local length = miax_pearlequities_expressorders_meo_v2_7_b.packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = miax_pearlequities_expressorders_meo_v2_7_b.packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.packet_type, range, value, display)
...
-- Payload
miax_pearlequities_expressorders_meo_v2_7_b.payload = {}

-- Dissect: Payload
miax_pearlequities_expressorders_meo_v2_7_b.payload.dissect = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Sequenced Data Packet
...
-- Packet Header
miax_pearlequities_expressorders_meo_v2_7_b.packet_header = {}

-- Size: Packet Header
miax_pearlequities_expressorders_meo_v2_7_b.packet_header.size =
  miax_pearlequities_expressorders_meo_v2_7_b.packet_length.size + 
  miax_pearlequities_expressorders_meo_v2_7_b.packet_type.size

-- Display: Packet Header
miax_pearlequities_expressorders_meo_v2_7_b.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
miax_pearlequities_expressorders_meo_v2_7_b.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Packet Length: 2 Byte Unsigned Fixed Width Integer
  index, packet_length = miax_pearlequities_expressorders_meo_v2_7_b.packet_length.dissect(buffer, index, packet, parent)

  -- Packet Type: 1 Byte Ascii String Enum with 12 values
  index, packet_type = miax_pearlequities_expressorders_meo_v2_7_b.packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Packet Header
miax_pearlequities_expressorders_meo_v2_7_b.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_pearlequities_expressorders_meo_v2_7_b.fields.packet_header, buffer(offset, 0))
    local index = miax_pearlequities_expressorders_meo_v2_7_b.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_pearlequities_expressorders_meo_v2_7_b.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_pearlequities_expressorders_meo_v2_7_b.packet_header.fields(buffer, offset, packet, parent)
  end
end
...
miax_pearlequities_expressorders_meo_v2_7_b.esesm_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_esesm_tcp_packet)
  ...
  index, packet_header = miax_pearlequities_expressorders_meo_v2_7_b.packet_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 12 branches
  index = miax_pearlequities_expressorders_meo_v2_7_b.payload.dissect(buffer, index, packet, parent, packet_type)
...
local esesm_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < miax_pearlequities_expressorders_meo_v2_7_b.packet_header.size then
...
miax_pearlequities_expressorders_meo_v2_7_b.packet.requiredsize = function(buffer)
  return buffer:len() >= miax_pearlequities_expressorders_meo_v2_7_b.packet_header.size
end
...
-- Register Miax PearlEquities ExpressOrders Meo 2.7.b on default port
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, omi_miax_pearlequities_expressorders_meo_v2_7_b)
