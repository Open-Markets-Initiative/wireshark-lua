...
-- Miax Options TopOfMarket Mach 1.9 Protocol
local miax_options_topofmarket_mach_v1_9 = Proto("Miax.Options.TopOfMarket.Mach.v1.9.Lua", "Miax Options TopOfMarket Mach 1.9")
...
-- Miax Options TopOfMarket Mach 1.9 Fields
miax_options_topofmarket_mach_v1_9.fields.active_on_miax = ProtoField.new("Active On Miax", "miax.options.topofmarket.mach.v1.9.activeonmiax", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.application_message = ProtoField.new("Application Message", "miax.options.topofmarket.mach.v1.9.applicationmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.bid_condition = ProtoField.new("Bid Condition", "miax.options.topofmarket.mach.v1.9.bidcondition", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.bid_price_2 = ProtoField.new("Bid Price 2", "miax.options.topofmarket.mach.v1.9.bidprice2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.bid_price_4 = ProtoField.new("Bid Price 4", "miax.options.topofmarket.mach.v1.9.bidprice4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.bid_priority_customer_size_2 = ProtoField.new("Bid Priority Customer Size 2", "miax.options.topofmarket.mach.v1.9.bidprioritycustomersize2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.bid_priority_customer_size_4 = ProtoField.new("Bid Priority Customer Size 4", "miax.options.topofmarket.mach.v1.9.bidprioritycustomersize4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.bid_size_2 = ProtoField.new("Bid Size 2", "miax.options.topofmarket.mach.v1.9.bidsize2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.bid_size_4 = ProtoField.new("Bid Size 4", "miax.options.topofmarket.mach.v1.9.bidsize4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.call_or_put = ProtoField.new("Call Or Put", "miax.options.topofmarket.mach.v1.9.callorput", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.closing_time = ProtoField.new("Closing Time", "miax.options.topofmarket.mach.v1.9.closingtime", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.correction_number = ProtoField.new("Correction Number", "miax.options.topofmarket.mach.v1.9.correctionnumber", ftypes.UINT8)
miax_options_topofmarket_mach_v1_9.fields.data = ProtoField.new("Data", "miax.options.topofmarket.mach.v1.9.data", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.double_sided_top_of_market_compact_message = ProtoField.new("Double Sided Top Of Market Compact Message", "miax.options.topofmarket.mach.v1.9.doublesidedtopofmarketcompactmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.event_reason = ProtoField.new("Event Reason", "miax.options.topofmarket.mach.v1.9.eventreason", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.expected_event_time_nano_seconds_part = ProtoField.new("Expected Event Time Nano Seconds Part", "miax.options.topofmarket.mach.v1.9.expectedeventtimenanosecondspart", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.expiration_date = ProtoField.new("Expiration Date", "miax.options.topofmarket.mach.v1.9.expirationdate", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.liquidity_acceptance_increment_indicator = ProtoField.new("Liquidity Acceptance Increment Indicator", "miax.options.topofmarket.mach.v1.9.liquidityacceptanceincrementindicator", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.long_term_option = ProtoField.new("Long Term Option", "miax.options.topofmarket.mach.v1.9.longtermoption", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.mbbo_condition = ProtoField.new("Mbbo Condition", "miax.options.topofmarket.mach.v1.9.mbbocondition", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.mbbo_price_2 = ProtoField.new("Mbbo Price 2", "miax.options.topofmarket.mach.v1.9.mbboprice2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.mbbo_price_4 = ProtoField.new("Mbbo Price 4", "miax.options.topofmarket.mach.v1.9.mbboprice4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.mbbo_priority_customer_size_2 = ProtoField.new("Mbbo Priority Customer Size 2", "miax.options.topofmarket.mach.v1.9.mbboprioritycustomersize2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.mbbo_priority_customer_size_4 = ProtoField.new("Mbbo Priority Customer Size 4", "miax.options.topofmarket.mach.v1.9.mbboprioritycustomersize4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.mbbo_size_2 = ProtoField.new("Mbbo Size 2", "miax.options.topofmarket.mach.v1.9.mbbosize2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.mbbo_size_4 = ProtoField.new("Mbbo Size 4", "miax.options.topofmarket.mach.v1.9.mbbosize4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.message = ProtoField.new("Message", "miax.options.topofmarket.mach.v1.9.message", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.message_type = ProtoField.new("Message Type", "miax.options.topofmarket.mach.v1.9.messagetype", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.miax_bbo_posting_increment_indicator = ProtoField.new("Miax Bbo Posting Increment Indicator", "miax.options.topofmarket.mach.v1.9.miaxbbopostingincrementindicator", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.notification_time = ProtoField.new("Notification Time", "miax.options.topofmarket.mach.v1.9.notificationtime", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.offer_condition = ProtoField.new("Offer Condition", "miax.options.topofmarket.mach.v1.9.offercondition", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.offer_price_2 = ProtoField.new("Offer Price 2", "miax.options.topofmarket.mach.v1.9.offerprice2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.offer_price_4 = ProtoField.new("Offer Price 4", "miax.options.topofmarket.mach.v1.9.offerprice4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.offer_priority_customer_size_2 = ProtoField.new("Offer Priority Customer Size 2", "miax.options.topofmarket.mach.v1.9.offerprioritycustomersize2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.offer_priority_customer_size_4 = ProtoField.new("Offer Priority Customer Size 4", "miax.options.topofmarket.mach.v1.9.offerprioritycustomersize4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.offer_size_2 = ProtoField.new("Offer Size 2", "miax.options.topofmarket.mach.v1.9.offersize2", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.offer_size_4 = ProtoField.new("Offer Size 4", "miax.options.topofmarket.mach.v1.9.offersize4", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.opening_time = ProtoField.new("Opening Time", "miax.options.topofmarket.mach.v1.9.openingtime", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.opening_underlying_market_code = ProtoField.new("Opening Underlying Market Code", "miax.options.topofmarket.mach.v1.9.openingunderlyingmarketcode", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.packet = ProtoField.new("Packet", "miax.options.topofmarket.mach.v1.9.packet", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.packet_length = ProtoField.new("Packet Length", "miax.options.topofmarket.mach.v1.9.packetlength", ftypes.UINT16)
miax_options_topofmarket_mach_v1_9.fields.packet_type = ProtoField.new("Packet Type", "miax.options.topofmarket.mach.v1.9.packettype", ftypes.UINT8)
miax_options_topofmarket_mach_v1_9.fields.payload = ProtoField.new("Payload", "miax.options.topofmarket.mach.v1.9.payload", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.priority_quote_width = ProtoField.new("Priority Quote Width", "miax.options.topofmarket.mach.v1.9.priorityquotewidth", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.product_add_update_time = ProtoField.new("Product Add Update Time", "miax.options.topofmarket.mach.v1.9.productaddupdatetime", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.product_id = ProtoField.new("Product Id", "miax.options.topofmarket.mach.v1.9.productid", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.reference_correction_number = ProtoField.new("Reference Correction Number", "miax.options.topofmarket.mach.v1.9.referencecorrectionnumber", ftypes.UINT8)
miax_options_topofmarket_mach_v1_9.fields.reference_trade_id = ProtoField.new("Reference Trade Id", "miax.options.topofmarket.mach.v1.9.referencetradeid", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.reserved = ProtoField.new("Reserved", "miax.options.topofmarket.mach.v1.9.reserved", ftypes.UINT64)
miax_options_topofmarket_mach_v1_9.fields.restricted_option = ProtoField.new("Restricted Option", "miax.options.topofmarket.mach.v1.9.restrictedoption", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.seconds_part = ProtoField.new("Seconds Part", "miax.options.topofmarket.mach.v1.9.secondspart", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.security_symbol = ProtoField.new("Security Symbol", "miax.options.topofmarket.mach.v1.9.securitysymbol", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.sequence_number = ProtoField.new("Sequence Number", "miax.options.topofmarket.mach.v1.9.sequencenumber", ftypes.UINT64)
miax_options_topofmarket_mach_v1_9.fields.series_update = ProtoField.new("Series Update", "miax.options.topofmarket.mach.v1.9.seriesupdate", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.session_id = ProtoField.new("Session Id", "miax.options.topofmarket.mach.v1.9.sessionid", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.session_number = ProtoField.new("Session Number", "miax.options.topofmarket.mach.v1.9.sessionnumber", ftypes.UINT8)
miax_options_topofmarket_mach_v1_9.fields.strike_price = ProtoField.new("Strike Price", "miax.options.topofmarket.mach.v1.9.strikeprice", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.system_state_message = ProtoField.new("System State Message", "miax.options.topofmarket.mach.v1.9.systemstatemessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.system_status = ProtoField.new("System Status", "miax.options.topofmarket.mach.v1.9.systemstatus", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.system_time_message = ProtoField.new("System Time Message", "miax.options.topofmarket.mach.v1.9.systemtimemessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.timestamp = ProtoField.new("Timestamp", "miax.options.topofmarket.mach.v1.9.timestamp", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.to_m_version = ProtoField.new("To M Version", "miax.options.topofmarket.mach.v1.9.tomversion", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.top_of_market_bid_compact_message = ProtoField.new("Top Of Market Bid Compact Message", "miax.options.topofmarket.mach.v1.9.topofmarketbidcompactmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.top_of_market_offer_compact_message = ProtoField.new("Top Of Market Offer Compact Message", "miax.options.topofmarket.mach.v1.9.topofmarketoffercompactmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.trade_cancel_message = ProtoField.new("Trade Cancel Message", "miax.options.topofmarket.mach.v1.9.tradecancelmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.trade_condition = ProtoField.new("Trade Condition", "miax.options.topofmarket.mach.v1.9.tradecondition", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.trade_id = ProtoField.new("Trade Id", "miax.options.topofmarket.mach.v1.9.tradeid", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.trade_message = ProtoField.new("Trade Message", "miax.options.topofmarket.mach.v1.9.trademessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.trade_price = ProtoField.new("Trade Price", "miax.options.topofmarket.mach.v1.9.tradeprice", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.trade_size = ProtoField.new("Trade Size", "miax.options.topofmarket.mach.v1.9.tradesize", ftypes.UINT32)
miax_options_topofmarket_mach_v1_9.fields.trading_status = ProtoField.new("Trading Status", "miax.options.topofmarket.mach.v1.9.tradingstatus", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "miax.options.topofmarket.mach.v1.9.underlyingsymbol", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.underlying_trading_status_message = ProtoField.new("Underlying Trading Status Message", "miax.options.topofmarket.mach.v1.9.underlyingtradingstatusmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.wide_double_sided_top_of_market_message = ProtoField.new("Wide Double Sided Top Of Market Message", "miax.options.topofmarket.mach.v1.9.widedoublesidedtopofmarketmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.wide_top_of_market_bid_message = ProtoField.new("Wide Top Of Market Bid Message", "miax.options.topofmarket.mach.v1.9.widetopofmarketbidmessage", ftypes.STRING)
miax_options_topofmarket_mach_v1_9.fields.wide_top_of_market_offer_message = ProtoField.new("Wide Top Of Market Offer Message", "miax.options.topofmarket.mach.v1.9.widetopofmarketoffermessage", ftypes.STRING)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Miax Options TopOfMarket Mach 1.9 Element Dissection Options
...
-- Register Miax Options TopOfMarket Mach 1.9 Show Options
miax_options_topofmarket_mach_v1_9.prefs.show_application_message = Pref.bool("Show Application Message", show.application_message, "Parse and add Application Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_double_sided_top_of_market_compact_message = Pref.bool("Show Double Sided Top Of Market Compact Message", show.double_sided_top_of_market_compact_message, "Parse and add Double Sided Top Of Market Compact Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_series_update = Pref.bool("Show Series Update", show.series_update, "Parse and add Series Update to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_system_state_message = Pref.bool("Show System State Message", show.system_state_message, "Parse and add System State Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_system_time_message = Pref.bool("Show System Time Message", show.system_time_message, "Parse and add System Time Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_top_of_market_bid_compact_message = Pref.bool("Show Top Of Market Bid Compact Message", show.top_of_market_bid_compact_message, "Parse and add Top Of Market Bid Compact Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_top_of_market_offer_compact_message = Pref.bool("Show Top Of Market Offer Compact Message", show.top_of_market_offer_compact_message, "Parse and add Top Of Market Offer Compact Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_trade_cancel_message = Pref.bool("Show Trade Cancel Message", show.trade_cancel_message, "Parse and add Trade Cancel Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_trade_message = Pref.bool("Show Trade Message", show.trade_message, "Parse and add Trade Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_underlying_trading_status_message = Pref.bool("Show Underlying Trading Status Message", show.underlying_trading_status_message, "Parse and add Underlying Trading Status Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_wide_double_sided_top_of_market_message = Pref.bool("Show Wide Double Sided Top Of Market Message", show.wide_double_sided_top_of_market_message, "Parse and add Wide Double Sided Top Of Market Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_wide_top_of_market_bid_message = Pref.bool("Show Wide Top Of Market Bid Message", show.wide_top_of_market_bid_message, "Parse and add Wide Top Of Market Bid Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_wide_top_of_market_offer_message = Pref.bool("Show Wide Top Of Market Offer Message", show.wide_top_of_market_offer_message, "Parse and add Wide Top Of Market Offer Message to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_data = Pref.bool("Show Data", show.data, "Parse and add Data to protocol tree")
miax_options_topofmarket_mach_v1_9.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function miax_options_topofmarket_mach_v1_9.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.application_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_application_message then
    show.application_message = miax_options_topofmarket_mach_v1_9.prefs.show_application_message
    changed = true
  end
  if show.double_sided_top_of_market_compact_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_double_sided_top_of_market_compact_message then
    show.double_sided_top_of_market_compact_message = miax_options_topofmarket_mach_v1_9.prefs.show_double_sided_top_of_market_compact_message
    changed = true
  end
  if show.message ~= miax_options_topofmarket_mach_v1_9.prefs.show_message then
    show.message = miax_options_topofmarket_mach_v1_9.prefs.show_message
    changed = true
  end
  if show.packet ~= miax_options_topofmarket_mach_v1_9.prefs.show_packet then
    show.packet = miax_options_topofmarket_mach_v1_9.prefs.show_packet
    changed = true
  end
  if show.series_update ~= miax_options_topofmarket_mach_v1_9.prefs.show_series_update then
    show.series_update = miax_options_topofmarket_mach_v1_9.prefs.show_series_update
    changed = true
  end
  if show.system_state_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_system_state_message then
    show.system_state_message = miax_options_topofmarket_mach_v1_9.prefs.show_system_state_message
    changed = true
  end
  if show.system_time_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_system_time_message then
    show.system_time_message = miax_options_topofmarket_mach_v1_9.prefs.show_system_time_message
    changed = true
  end
  if show.top_of_market_bid_compact_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_top_of_market_bid_compact_message then
    show.top_of_market_bid_compact_message = miax_options_topofmarket_mach_v1_9.prefs.show_top_of_market_bid_compact_message
    changed = true
  end
  if show.top_of_market_offer_compact_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_top_of_market_offer_compact_message then
    show.top_of_market_offer_compact_message = miax_options_topofmarket_mach_v1_9.prefs.show_top_of_market_offer_compact_message
    changed = true
  end
  if show.trade_cancel_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_trade_cancel_message then
    show.trade_cancel_message = miax_options_topofmarket_mach_v1_9.prefs.show_trade_cancel_message
    changed = true
  end
  if show.trade_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_trade_message then
    show.trade_message = miax_options_topofmarket_mach_v1_9.prefs.show_trade_message
    changed = true
  end
  if show.underlying_trading_status_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_underlying_trading_status_message then
    show.underlying_trading_status_message = miax_options_topofmarket_mach_v1_9.prefs.show_underlying_trading_status_message
    changed = true
  end
  if show.wide_double_sided_top_of_market_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_wide_double_sided_top_of_market_message then
    show.wide_double_sided_top_of_market_message = miax_options_topofmarket_mach_v1_9.prefs.show_wide_double_sided_top_of_market_message
    changed = true
  end
  if show.wide_top_of_market_bid_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_wide_top_of_market_bid_message then
    show.wide_top_of_market_bid_message = miax_options_topofmarket_mach_v1_9.prefs.show_wide_top_of_market_bid_message
    changed = true
  end
  if show.wide_top_of_market_offer_message ~= miax_options_topofmarket_mach_v1_9.prefs.show_wide_top_of_market_offer_message then
    show.wide_top_of_market_offer_message = miax_options_topofmarket_mach_v1_9.prefs.show_wide_top_of_market_offer_message
    changed = true
  end
  if show.data ~= miax_options_topofmarket_mach_v1_9.prefs.show_data then
    show.data = miax_options_topofmarket_mach_v1_9.prefs.show_data
    changed = true
  end
  if show.payload ~= miax_options_topofmarket_mach_v1_9.prefs.show_payload then
    show.payload = miax_options_topofmarket_mach_v1_9.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Miax Options TopOfMarket Mach 1.9
-----------------------------------------------------------------------
...
dissect.expected_event_time_nano_seconds_part = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.expected_event_time_nano_seconds_part, range, value, display)
...
dissect.seconds_part = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.seconds_part, range, value, display)
...
dissect.event_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.event_reason, range, value, display)
...
dissect.trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.trading_status, range, value, display)
...
dissect.underlying_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.underlying_symbol, range, value, display)
...
dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.timestamp, range, value, display)
...
dissect.underlying_trading_status_message = function(buffer, offset, packet, parent)
  ...
  if show.underlying_trading_status_message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.underlying_trading_status_message, range, display)
  end
...
dissect.trade_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.trade_condition, range, value, display)
...
dissect.trade_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.trade_size, range, value, display)
...
dissect.trade_price = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.trade_price, range, value, display)
...
dissect.correction_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.correction_number, range, value, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.trade_id, range, value, display)
...
dissect.product_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.product_id, range, value, display)
...
dissect.trade_cancel_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_cancel_message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.trade_cancel_message, range, display)
  end
...
dissect.reference_correction_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.reference_correction_number, range, value, display)
...
dissect.reference_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.reference_trade_id, range, value, display)
...
dissect.trade_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.trade_message, range, display)
  end
...
dissect.offer_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.offer_condition, range, value, display)
...
dissect.offer_priority_customer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.offer_priority_customer_size_4, range, value, display)
...
dissect.offer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.offer_size_4, range, value, display)
...
dissect.offer_price_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.offer_price_4, range, value, display)
...
dissect.bid_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.bid_condition, range, value, display)
...
dissect.bid_priority_customer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.bid_priority_customer_size_4, range, value, display)
...
dissect.bid_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.bid_size_4, range, value, display)
...
dissect.bid_price_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.bid_price_4, range, value, display)
...
dissect.wide_double_sided_top_of_market_message = function(buffer, offset, packet, parent)
  ...
  if show.wide_double_sided_top_of_market_message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.wide_double_sided_top_of_market_message, range, display)
  end
...
dissect.offer_priority_customer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.offer_priority_customer_size_2, range, value, display)
...
dissect.offer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.offer_size_2, range, value, display)
...
dissect.offer_price_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.offer_price_2, range, value, display)
...
dissect.bid_priority_customer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.bid_priority_customer_size_2, range, value, display)
...
dissect.bid_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.bid_size_2, range, value, display)
...
dissect.bid_price_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.bid_price_2, range, value, display)

  return offset + length, value
end

-- Calculate size of: Double Sided Top Of Market Compact Message
size_of.double_sided_top_of_market_compact_message = function(buffer, offset)
  local index = 0
...
dissect.double_sided_top_of_market_compact_message = function(buffer, offset, packet, parent)
  ...
  if show.double_sided_top_of_market_compact_message then
    local length = size_of.double_sided_top_of_market_compact_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.double_sided_top_of_market_compact_message(buffer, packet, parent)
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.double_sided_top_of_market_compact_message, range, display)
  end
...
dissect.mbbo_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.mbbo_condition, range, value, display)
...
dissect.mbbo_priority_customer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.mbbo_priority_customer_size_4, range, value, display)
...
dissect.mbbo_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.mbbo_size_4, range, value, display)
...
dissect.mbbo_price_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.mbbo_price_4, range, value, display)

  return offset + length, value
end

-- Calculate size of: Wide Top Of Market Offer Message
size_of.wide_top_of_market_offer_message = function(buffer, offset)
  local index = 0
...
dissect.wide_top_of_market_offer_message = function(buffer, offset, packet, parent)
  ...
  if show.wide_top_of_market_offer_message then
    local length = size_of.wide_top_of_market_offer_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.wide_top_of_market_offer_message(buffer, packet, parent)
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.wide_top_of_market_offer_message, range, display)
  end
...
size_of.wide_top_of_market_bid_message = function(buffer, offset)
  local index = 0
...
dissect.wide_top_of_market_bid_message = function(buffer, offset, packet, parent)
  ...
  if show.wide_top_of_market_bid_message then
    local length = size_of.wide_top_of_market_bid_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.wide_top_of_market_bid_message(buffer, packet, parent)
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.wide_top_of_market_bid_message, range, display)
  end
...
dissect.mbbo_priority_customer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.mbbo_priority_customer_size_2, range, value, display)
...
dissect.mbbo_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.mbbo_size_2, range, value, display)
...
dissect.mbbo_price_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.mbbo_price_2, range, value, display)

  return offset + length, value
end

-- Calculate size of: Top Of Market Offer Compact Message
size_of.top_of_market_offer_compact_message = function(buffer, offset)
  local index = 0
...
dissect.top_of_market_offer_compact_message = function(buffer, offset, packet, parent)
  ...
  if show.top_of_market_offer_compact_message then
    local length = size_of.top_of_market_offer_compact_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.top_of_market_offer_compact_message(buffer, packet, parent)
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.top_of_market_offer_compact_message, range, display)
  end
...
size_of.top_of_market_bid_compact_message = function(buffer, offset)
  local index = 0
...
dissect.top_of_market_bid_compact_message = function(buffer, offset, packet, parent)
  ...
  if show.top_of_market_bid_compact_message then
    local length = size_of.top_of_market_bid_compact_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.top_of_market_bid_compact_message(buffer, packet, parent)
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.top_of_market_bid_compact_message, range, display)
  end
...
dissect.system_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.system_status, range, value, display)
...
dissect.session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.session_id, range, value, display)
...
dissect.to_m_version = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.to_m_version, range, value, display)
...
dissect.notification_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.notification_time, range, value, display)
...
dissect.system_state_message = function(buffer, offset, packet, parent)
  ...
  if show.system_state_message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.system_state_message, range, display)
  end
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.reserved, range, value, display)
...
dissect.priority_quote_width = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.priority_quote_width, range, value, display)
...
dissect.opening_underlying_market_code = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.opening_underlying_market_code, range, value, display)
...
dissect.liquidity_acceptance_increment_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.liquidity_acceptance_increment_indicator, range, value, display)
...
dissect.miax_bbo_posting_increment_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.miax_bbo_posting_increment_indicator, range, value, display)
...
dissect.active_on_miax = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.active_on_miax, range, value, display)
...
dissect.long_term_option = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.long_term_option, range, value, display)
...
dissect.restricted_option = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.restricted_option, range, value, display)
...
dissect.closing_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.closing_time, range, value, display)
...
dissect.opening_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.opening_time, range, value, display)
...
dissect.call_or_put = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.call_or_put, range, value, display)
...
dissect.strike_price = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.strike_price, range, value, display)
...
dissect.expiration_date = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.expiration_date, range, value, display)
...
dissect.security_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.security_symbol, range, value, display)
...
dissect.product_add_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.product_add_update_time, range, value, display)
...
dissect.series_update = function(buffer, offset, packet, parent)
  ...
  if show.series_update then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.series_update, range, display)
  end
...
dissect.system_time_message = function(buffer, offset, packet, parent)
  ...
  if show.system_time_message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.system_time_message, range, display)
  end
...
size_of.data = function(buffer, offset, message_type)
  ...
  if message_type == "B" then
    return size_of.top_of_market_bid_compact_message(buffer, offset)
  end
  -- Size of Top Of Market Offer Compact Message
  if message_type == "O" then
    return size_of.top_of_market_offer_compact_message(buffer, offset)
  end
  -- Size of Wide Top Of Market Bid Message
  if message_type == "W" then
    return size_of.wide_top_of_market_bid_message(buffer, offset)
  end
  -- Size of Wide Top Of Market Offer Message
  if message_type == "A" then
    return size_of.wide_top_of_market_offer_message(buffer, offset)
  end
  -- Size of Double Sided Top Of Market Compact Message
  if message_type == "d" then
    return size_of.double_sided_top_of_market_compact_message(buffer, offset)
  end
...
dissect.data = function(buffer, offset, packet, parent, message_type)
  ...
  local element = parent:add(miax_options_topofmarket_mach_v1_9.fields.data, range, display)
...
dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.message_type, range, value, display)
...
dissect.application_message = function(buffer, offset, packet, parent)
  ...
  if show.application_message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.application_message, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, packet_type)
  ...
  local element = parent:add(miax_options_topofmarket_mach_v1_9.fields.payload, range, display)
...
dissect.session_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.session_number, range, value, display)
...
dissect.packet_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.packet_type, range, value, display)
...
dissect.packet_length = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.packet_length, range, value, display)
...
dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_topofmarket_mach_v1_9.fields.sequence_number, range, value, display)
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(miax_options_topofmarket_mach_v1_9.fields.message, range, display)
  end
...
function miax_options_topofmarket_mach_v1_9.init()
end

-- Dissector for Miax Options TopOfMarket Mach 1.9
function miax_options_topofmarket_mach_v1_9.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = miax_options_topofmarket_mach_v1_9.name

  -- Dissect protocol
  local protocol = parent:add(miax_options_topofmarket_mach_v1_9, buffer(), miax_options_topofmarket_mach_v1_9.description, "("..buffer:len().." Bytes)")
  return dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, miax_options_topofmarket_mach_v1_9)
...
verify.miax_options_topofmarket_mach_v1_9_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Miax Options TopOfMarket Mach 1.9
local function miax_options_topofmarket_mach_v1_9_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.miax_options_topofmarket_mach_v1_9_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = miax_options_topofmarket_mach_v1_9
  miax_options_topofmarket_mach_v1_9.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Miax Options TopOfMarket Mach 1.9
miax_options_topofmarket_mach_v1_9:register_heuristic("udp", miax_options_topofmarket_mach_v1_9_heuristic)
