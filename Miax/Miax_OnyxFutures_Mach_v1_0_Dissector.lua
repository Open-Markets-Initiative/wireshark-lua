...
miax_onyxfutures_mach_v1_0.application_message.dissect = function(buffer, offset, packet, parent, size_of_application_message)
  ...
  if show.application_message then
    parent = parent:add(omi_miax_onyxfutures_mach_v1_0.fields.application_message, buffer(offset, 0))
    local current = miax_onyxfutures_mach_v1_0.application_message.fields(buffer, offset, packet, parent, size_of_application_message)
...
miax_onyxfutures_mach_v1_0.message.dissect = function(buffer, offset, packet, parent)
  if show.message then
    ...
    parent = parent:add(omi_miax_onyxfutures_mach_v1_0.fields.message, buffer(offset, 0))
    local index = miax_onyxfutures_mach_v1_0.message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_onyxfutures_mach_v1_0.message.display(packet, parent, length)
    parent:append_text(display)
