...
omi_miax_pearlequities_topofmarket_mach_v1_1_c.fields.second_reserved_1 = ProtoField.new("Second Reserved 1", "miax.pearlequities.topofmarket.mach.v1.1.c.secondreserved1", ftypes.STRING)
...
-----------------------------------------------------------------------
-- Miax PearlEquities TopOfMarket Mach 1.1.c Formatting
-----------------------------------------------------------------------

-- Timestamp format (true = decimal-scaled, false = raw mantissa)
miax_pearlequities_topofmarket_mach_v1_1_c.format_timestamp = true
...
function omi_miax_pearlequities_topofmarket_mach_v1_1_c.prefs_changed()
  ...
  if miax_pearlequities_topofmarket_mach_v1_1_c.format_timestamp ~= omi_miax_pearlequities_topofmarket_mach_v1_1_c.prefs.format_timestamp then
    miax_pearlequities_topofmarket_mach_v1_1_c.format_timestamp = omi_miax_pearlequities_topofmarket_mach_v1_1_c.prefs.format_timestamp
  end
end
...
-- Second Reserved 1
miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1 = {}

-- Size: Second Reserved 1
miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1.size = 1

-- Display: Second Reserved 1
miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1.display = function(value)
  return "Second Reserved 1: "..value
end

-- Dissect: Second Reserved 1
miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1.dissect = function(buffer, offset, packet, parent)
  local length = miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_pearlequities_topofmarket_mach_v1_1_c.fields.second_reserved_1, range, value, display)
...
miax_pearlequities_topofmarket_mach_v1_1_c.timestamp.dissect = function(buffer, offset, packet, parent)
  if miax_pearlequities_topofmarket_mach_v1_1_c.format_timestamp then
...
-- Client Heartbeat
miax_pearlequities_topofmarket_mach_v1_1_c.client_heartbeat = {}

-- Display: Client Heartbeat
miax_pearlequities_topofmarket_mach_v1_1_c.client_heartbeat.display = function(packet, parent, length)
  return "Client Heartbeat"
end


-- Dissect: Client Heartbeat
miax_pearlequities_topofmarket_mach_v1_1_c.client_heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_topofmarket_mach_v1_1_c.client_heartbeat.display(packet, parent, 0)
...
miax_pearlequities_topofmarket_mach_v1_1_c.esesm_payload.dissect = function(buffer, offset, packet, parent, esesm_packet_type)
  ...
  if esesm_packet_type == "1" then
    return miax_pearlequities_topofmarket_mach_v1_1_c.client_heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Test Packet
...
miax_pearlequities_topofmarket_mach_v1_1_c.symbol_update_message.size =
  ...
  miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1.size + 
...
miax_pearlequities_topofmarket_mach_v1_1_c.symbol_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_reserved_1 = miax_pearlequities_topofmarket_mach_v1_1_c.second_reserved_1.dissect(buffer, index, packet, parent)
...
-- End Of Session
miax_pearlequities_topofmarket_mach_v1_1_c.end_of_session = {}

-- Display: End Of Session
miax_pearlequities_topofmarket_mach_v1_1_c.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
miax_pearlequities_topofmarket_mach_v1_1_c.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_topofmarket_mach_v1_1_c.end_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Start Of Session
miax_pearlequities_topofmarket_mach_v1_1_c.start_of_session = {}

-- Display: Start Of Session
miax_pearlequities_topofmarket_mach_v1_1_c.start_of_session.display = function(packet, parent, length)
  return "Start Of Session"
end


-- Dissect: Start Of Session
miax_pearlequities_topofmarket_mach_v1_1_c.start_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_topofmarket_mach_v1_1_c.start_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Heartbeat
miax_pearlequities_topofmarket_mach_v1_1_c.heartbeat = {}

-- Display: Heartbeat
miax_pearlequities_topofmarket_mach_v1_1_c.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
miax_pearlequities_topofmarket_mach_v1_1_c.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_pearlequities_topofmarket_mach_v1_1_c.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_pearlequities_topofmarket_mach_v1_1_c.payload.dissect = function(buffer, offset, packet, parent, mach_packet_type)
  ...
  if mach_packet_type == 0 then
    return miax_pearlequities_topofmarket_mach_v1_1_c.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session
  if mach_packet_type == 1 then
    return miax_pearlequities_topofmarket_mach_v1_1_c.start_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if mach_packet_type == 2 then
    return miax_pearlequities_topofmarket_mach_v1_1_c.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Application Message
