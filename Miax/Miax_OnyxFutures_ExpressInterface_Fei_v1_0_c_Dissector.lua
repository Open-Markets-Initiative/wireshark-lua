...
miax_onyxfutures_expressinterface_fei_v1_0_c.fields.application_message = ProtoField.new("Application Message", "miax.onyxfutures.expressinterface.fei.v1.0.c.applicationmessage", ftypes.STRING)
miax_onyxfutures_expressinterface_fei_v1_0_c.fields.message = ProtoField.new("Message", "miax.onyxfutures.expressinterface.fei.v1.0.c.message", ftypes.STRING)
miax_onyxfutures_expressinterface_fei_v1_0_c.fields.message_type = ProtoField.new("Message Type", "miax.onyxfutures.expressinterface.fei.v1.0.c.messagetype", ftypes.STRING)
...
miax_onyxfutures_expressinterface_fei_v1_0_c.fields.packet_type = ProtoField.new("Packet Type", "miax.onyxfutures.expressinterface.fei.v1.0.c.packettype", ftypes.UINT8)
...
miax_onyxfutures_expressinterface_fei_v1_0_c.fields.session_number = ProtoField.new("Session Number", "miax.onyxfutures.expressinterface.fei.v1.0.c.sessionnumber", ftypes.UINT8)
...
miax_onyxfutures_expressinterface_fei_v1_0_c.prefs.show_application_message = Pref.bool("Show Application Message", show.application_message, "Parse and add Application Message to protocol tree")
miax_onyxfutures_expressinterface_fei_v1_0_c.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
...
function miax_onyxfutures_expressinterface_fei_v1_0_c.prefs_changed()
  ...
  if show.application_message ~= miax_onyxfutures_expressinterface_fei_v1_0_c.prefs.show_application_message then
    show.application_message = miax_onyxfutures_expressinterface_fei_v1_0_c.prefs.show_application_message
    changed = true
  end
  if show.message ~= miax_onyxfutures_expressinterface_fei_v1_0_c.prefs.show_message then
    show.message = miax_onyxfutures_expressinterface_fei_v1_0_c.prefs.show_message
    changed = true
  end
...
-- Size: Message Type
miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.message_type = 1

-- Display: Message Type
miax_onyxfutures_expressinterface_fei_v1_0_c_display.message_type = function(value)
  return "Message Type: "..value
end

-- Dissect: Message Type
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.message_type = function(buffer, offset, packet, parent)
  local length = miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.message_type
  local range = buffer(offset, length)
  local value = range:string()
  local display = miax_onyxfutures_expressinterface_fei_v1_0_c_display.message_type(value, buffer, offset, packet, parent)

  parent:add(miax_onyxfutures_expressinterface_fei_v1_0_c.fields.message_type, range, value, display)

  return offset + length, value
end

-- Calculate size of: Application Message
miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.application_message = function(buffer, offset)
  local index = 0

  index = index + miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.message_type

  index = index + miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.data

  return index
end

-- Display: Application Message
miax_onyxfutures_expressinterface_fei_v1_0_c_display.application_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Application Message
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.application_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Type: 1 Byte Ascii String
  index, message_type = miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.message_type(buffer, index, packet, parent)

  -- Data
  index, data = miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.data(buffer, index, packet, parent)

  return index
end

-- Dissect: Application Message
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.application_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.application_message then
    local length = miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.application_message(buffer, offset)
    local range = buffer(offset, length)
    local display = miax_onyxfutures_expressinterface_fei_v1_0_c_display.application_message(buffer, packet, parent)
    parent = parent:add(miax_onyxfutures_expressinterface_fei_v1_0_c.fields.application_message, range, display)
  end

  return miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.application_message_fields(buffer, offset, packet, parent)
end
...
miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.payload = function(buffer, offset, packet_type)
  ...
  if packet_type == 3 then
    return miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.application_message(buffer, offset)
  end
...
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.payload_branches = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Application Message
  if packet_type == 3 then
    return miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.application_message(buffer, offset, packet, parent)
  end
...
-- Size: Session Number
miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.session_number = 1

-- Display: Session Number
miax_onyxfutures_expressinterface_fei_v1_0_c_display.session_number = function(value)
  return "Session Number: "..value
end

-- Dissect: Session Number
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.session_number = function(buffer, offset, packet, parent)
  local length = miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.session_number
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_onyxfutures_expressinterface_fei_v1_0_c_display.session_number(value, buffer, offset, packet, parent)

  parent:add(miax_onyxfutures_expressinterface_fei_v1_0_c.fields.session_number, range, value, display)
...
miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.message = function(buffer, offset)
  local index = 0

  index = index + miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.sequence_number
  ...
  index = index + miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.session_number

  -- Calculate runtime size of Payload field
  local payload_offset = offset + index
  local payload_type = buffer(payload_offset - 2, 1):le_uint()
  index = index + miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.payload(buffer, payload_offset, payload_type)

  return index
end

-- Display: Message
miax_onyxfutures_expressinterface_fei_v1_0_c_display.message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, session_number = miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.session_number(buffer, index, packet, parent)
...
-- Dissect: Message
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.message then
    local length = miax_onyxfutures_expressinterface_fei_v1_0_c_size_of.message(buffer, offset)
    local range = buffer(offset, length)
    local display = miax_onyxfutures_expressinterface_fei_v1_0_c_display.message(buffer, packet, parent)
    parent = parent:add(miax_onyxfutures_expressinterface_fei_v1_0_c.fields.message, range, display)
  end

  return miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.message_fields(buffer, offset, packet, parent)
end
...
miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    index = miax_onyxfutures_expressinterface_fei_v1_0_c_dissect.message(buffer, index, packet, parent)
  end
...
udp_table:add(65333, miax_onyxfutures_expressinterface_fei_v1_0_c)
...
miax_onyxfutures_expressinterface_fei_v1_0_c:register_heuristic("udp", miax_onyxfutures_expressinterface_fei_v1_0_c_heuristic)
