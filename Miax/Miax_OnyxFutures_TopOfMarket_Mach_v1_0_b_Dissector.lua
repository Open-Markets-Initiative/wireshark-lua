...
omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
function omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs_changed()
  ...
  if show.repeating_groups ~= omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs.show_repeating_groups then
    show.repeating_groups = omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs.show_repeating_groups
  end
  if show.structs ~= omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs.show_structs then
    show.structs = omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs.show_structs
  end
  if show.indexes ~= omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs.show_indexes then
    show.indexes = omi_miax_onyxfutures_topofmarket_mach_v1_0_b.prefs.show_indexes
  end
end
...
miax_onyxfutures_topofmarket_mach_v1_0_b.complex_instrument_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = miax_onyxfutures_topofmarket_mach_v1_0_b.complex_instrument_definition_message.display(packet, parent, length)
    parent:append_text(display)
...
miax_onyxfutures_topofmarket_mach_v1_0_b.application_message.dissect = function(buffer, offset, packet, parent, size_of_application_message)
  ...
  if show.structs then
    parent = parent:add(omi_miax_onyxfutures_topofmarket_mach_v1_0_b.fields.application_message, buffer(offset, 0))
    local current = miax_onyxfutures_topofmarket_mach_v1_0_b.application_message.fields(buffer, offset, packet, parent, size_of_application_message)
...
-- Mach Message
miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message = {}

-- Calculate size of: Mach Message
miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.size = function(buffer, offset)
  local index = 0
...
miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mach Message
miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_onyxfutures_topofmarket_mach_v1_0_b.fields.mach_message, buffer(offset, 0))
    local index = miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.fields(buffer, offset, packet, parent)
  end
end
...
miax_onyxfutures_topofmarket_mach_v1_0_b.packet.requiredsize = function(buffer)
  return buffer:len() >= miax_onyxfutures_topofmarket_mach_v1_0_b.sequence_number.size + miax_onyxfutures_topofmarket_mach_v1_0_b.packet_length.size + miax_onyxfutures_topofmarket_mach_v1_0_b.packet_type.size + miax_onyxfutures_topofmarket_mach_v1_0_b.session_number.size
end
...
miax_onyxfutures_topofmarket_mach_v1_0_b.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, mach_message = miax_onyxfutures_topofmarket_mach_v1_0_b.mach_message.dissect(buffer, index, packet, parent)
  end
...
omi_miax_onyxfutures_topofmarket_mach_v1_0_b:register_heuristic("udp", omi_miax_onyxfutures_topofmarket_mach_v1_0_b_udp_heuristic)

-- Register Miax OnyxFutures TopOfMarket Mach 1.0.b for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_miax_onyxfutures_topofmarket_mach_v1_0_b)
