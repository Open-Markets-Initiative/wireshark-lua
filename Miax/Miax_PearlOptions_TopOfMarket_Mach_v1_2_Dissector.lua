...
omi_miax_pearloptions_topofmarket_mach_v1_2.fields.message = ProtoField.new("Message", "miax.pearloptions.topofmarket.mach.v1.2.message", ftypes.STRING)
...
omi_miax_pearloptions_topofmarket_mach_v1_2.fields.notification_time = ProtoField.new("Notification Time", "miax.pearloptions.topofmarket.mach.v1.2.notificationtime", ftypes.UINT32)
...
omi_miax_pearloptions_topofmarket_mach_v1_2.fields.packet_header = ProtoField.new("Packet Header", "miax.pearloptions.topofmarket.mach.v1.2.packetheader", ftypes.STRING)
...
omi_miax_pearloptions_topofmarket_mach_v1_2.fields.packet_type = ProtoField.new("Packet Type", "miax.pearloptions.topofmarket.mach.v1.2.packettype", ftypes.STRING)
...
omi_miax_pearloptions_topofmarket_mach_v1_2.fields.product_add_update_time = ProtoField.new("Product Add Update Time", "miax.pearloptions.topofmarket.mach.v1.2.productaddupdatetime", ftypes.UINT32)
...
omi_miax_pearloptions_topofmarket_mach_v1_2.fields.pearl_system_time_message = ProtoField.new("Pearl System Time Message", "miax.pearloptions.topofmarket.mach.v1.2.pearlsystemtimemessage", ftypes.STRING)
...
omi_miax_pearloptions_topofmarket_mach_v1_2.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_miax_pearloptions_topofmarket_mach_v1_2.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
...
function omi_miax_pearloptions_topofmarket_mach_v1_2.prefs_changed()
  ...
  if show.message ~= omi_miax_pearloptions_topofmarket_mach_v1_2.prefs.show_message then
    show.message = omi_miax_pearloptions_topofmarket_mach_v1_2.prefs.show_message
  end
  if show.packet_header ~= omi_miax_pearloptions_topofmarket_mach_v1_2.prefs.show_packet_header then
    show.packet_header = omi_miax_pearloptions_topofmarket_mach_v1_2.prefs.show_packet_header
  end
...
-- Notification Time
miax_pearloptions_topofmarket_mach_v1_2.notification_time = {}

-- Size: Notification Time
miax_pearloptions_topofmarket_mach_v1_2.notification_time.size = 4

-- Display: Notification Time
miax_pearloptions_topofmarket_mach_v1_2.notification_time.display = function(value)
  return "Notification Time: "..value
end

-- Dissect: Notification Time
miax_pearloptions_topofmarket_mach_v1_2.notification_time.dissect = function(buffer, offset, packet, parent)
  local length = miax_pearloptions_topofmarket_mach_v1_2.notification_time.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_pearloptions_topofmarket_mach_v1_2.notification_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_pearloptions_topofmarket_mach_v1_2.fields.notification_time, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time = {}

-- Size: Product Add Update Time
miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time.size = 4

-- Display: Product Add Update Time
miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time.display = function(value)
  return "Product Add Update Time: "..value
end

-- Dissect: Product Add Update Time
miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time.dissect = function(buffer, offset, packet, parent)
  local length = miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_pearloptions_topofmarket_mach_v1_2.fields.product_add_update_time, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_2.system_state_message.size =
  miax_pearloptions_topofmarket_mach_v1_2.notification_time.size + 
...
miax_pearloptions_topofmarket_mach_v1_2.system_state_message.fields = function(buffer, offset, packet, parent)
  ...
  index, notification_time = miax_pearloptions_topofmarket_mach_v1_2.notification_time.dissect(buffer, index, packet, parent)
...
miax_pearloptions_topofmarket_mach_v1_2.series_update_message.size =
  miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time.size + 
  miax_pearloptions_topofmarket_mach_v1_2.product_id.size + 
  miax_pearloptions_topofmarket_mach_v1_2.underlying_symbol.size + 
...
miax_pearloptions_topofmarket_mach_v1_2.series_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, product_add_update_time = miax_pearloptions_topofmarket_mach_v1_2.product_add_update_time.dissect(buffer, index, packet, parent)
...
miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message = {}

-- Size: Pearl System Time Message
miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.size =
  miax_pearloptions_topofmarket_mach_v1_2.seconds.size

-- Display: Pearl System Time Message
miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Pearl System Time Message
miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_pearloptions_topofmarket_mach_v1_2.fields.pearl_system_time_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.fields(buffer, offset, packet, parent)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_2.data.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == "1" then
    return miax_pearloptions_topofmarket_mach_v1_2.pearl_system_time_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Series Update Message
...
-- Packet Header
miax_pearloptions_topofmarket_mach_v1_2.packet_header = {}

-- Size: Packet Header
miax_pearloptions_topofmarket_mach_v1_2.packet_header.size =
  miax_pearloptions_topofmarket_mach_v1_2.packet_length.size + 
  miax_pearloptions_topofmarket_mach_v1_2.packet_type.size

-- Display: Packet Header
miax_pearloptions_topofmarket_mach_v1_2.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
miax_pearloptions_topofmarket_mach_v1_2.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_pearloptions_topofmarket_mach_v1_2.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_pearloptions_topofmarket_mach_v1_2.fields.packet_header, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_2.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_pearloptions_topofmarket_mach_v1_2.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_2.packet_header.fields(buffer, offset, packet, parent)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_2.sesm_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_sesm_tcp_packet)
  ...
  index, packet_header = miax_pearloptions_topofmarket_mach_v1_2.packet_header.dissect(buffer, index, packet, parent)
...
local sesm_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < miax_pearloptions_topofmarket_mach_v1_2.packet_header.size then
...
miax_pearloptions_topofmarket_mach_v1_2.tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= miax_pearloptions_topofmarket_mach_v1_2.packet_header.size
end
...
-- Message
miax_pearloptions_topofmarket_mach_v1_2.message = {}

-- Calculate size of: Message
miax_pearloptions_topofmarket_mach_v1_2.message.size = function(buffer, offset)
  local index = 0
...
-- Display: Message
miax_pearloptions_topofmarket_mach_v1_2.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
miax_pearloptions_topofmarket_mach_v1_2.message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Message
miax_pearloptions_topofmarket_mach_v1_2.message.dissect = function(buffer, offset, packet, parent)
  if show.message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_pearloptions_topofmarket_mach_v1_2.fields.message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_2.message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_pearloptions_topofmarket_mach_v1_2.message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_2.message.fields(buffer, offset, packet, parent)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_2.udp_packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = miax_pearloptions_topofmarket_mach_v1_2.message.dissect(buffer, index, packet, parent)
  end
