...
local omi_miax_pearlequities_expressorders_meo_v2_7_a = Proto("Omi.Miax.PearlEquities.ExpressOrders.Meo.v2.7.a", "Miax PearlEquities ExpressOrders Meo 2.7.a")
...
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.attributable_order = ProtoField.new("Attributable Order", "miax.pearlequities.expressorders.meo.v2.7.a.attributableorder", ftypes.UINT16, {[0]="No", [1]="Attributed To Firm Mpid", [2]="Attributed Rtal To This Order"}, base.DEC, 0x0300)
...
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.locate_required = ProtoField.new("Locate Required", "miax.pearlequities.expressorders.meo.v2.7.a.locaterequired", ftypes.UINT16, {[0]="Not Applicable", [1]="Yes"}, base.DEC, 0x0020)
...
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.min_qty_exec_type = ProtoField.new("Min Qty Exec Type", "miax.pearlequities.expressorders.meo.v2.7.a.minqtyexectype", ftypes.UINT16, {[0]="Not Applicable", [1]="Single Contra Order", [2]="Multiple Contra Orders"}, base.DEC, 0x0C00)
...
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.routing_instruction = ProtoField.new("Routing Instruction", "miax.pearlequities.expressorders.meo.v2.7.a.routinginstruction", ftypes.UINT8, {[0]="Route Once", [1]="Reroutable", [2]="Do Not Route"}, base.DEC, 0x07)
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.routing_strategy = ProtoField.new("Routing Strategy", "miax.pearlequities.expressorders.meo.v2.7.a.routingstrategy", ftypes.UINT8, {[0]="Not Applicable", [1]="Order Protection", [2]="Primary Auction"}, base.DEC, 0x38)
...
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.self_trade_protection_instruction = ProtoField.new("Self Trade Protection Instruction", "miax.pearlequities.expressorders.meo.v2.7.a.selftradeprotectioninstruction", ftypes.UINT8, {[0]="Not Applicable", [1]="Cancel Newest", [2]="Cancel Oldest", [3]="Cancel Both", [4]="Decrement And Cancel"}, base.DEC, 0x38)
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.self_trade_protection_level = ProtoField.new("Self Trade Protection Level", "miax.pearlequities.expressorders.meo.v2.7.a.selftradeprotectionlevel", ftypes.UINT8, {[0]="Self Trade Protection Disabled", [1]="Firm", [2]="Mpid", [3]="Parent Group"}, base.DEC, 0x07)
...
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.short_sale_indicator = ProtoField.new("Short Sale Indicator", "miax.pearlequities.expressorders.meo.v2.7.a.shortsaleindicator", ftypes.UINT16, {[0]="Not Applicable", [1]="Sell Long", [2]="Sell Short", [3]="Sell Short Exempt"}, base.DEC, 0x0006)
omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.side = ProtoField.new("Side", "miax.pearlequities.expressorders.meo.v2.7.a.side", ftypes.UINT16, {[0]="Buy", [1]="Sell"}, base.DEC, 0x0001)
...
-- Miax PearlEquities ExpressOrders 2.7.a Application Messages
...
omi_miax_pearlequities_expressorders_meo_v2_7_a.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
function omi_miax_pearlequities_expressorders_meo_v2_7_a.prefs_changed()
  ...
  if show.structs ~= omi_miax_pearlequities_expressorders_meo_v2_7_a.prefs.show_structs then
    show.structs = omi_miax_pearlequities_expressorders_meo_v2_7_a.prefs.show_structs
  end
end
...
miax_pearlequities_expressorders_meo_v2_7_a.unsequenced_data_packet.dissect = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  ...
  if show.structs then
    parent = parent:add(omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.unsequenced_data_packet, buffer(offset, 0))
    local current = miax_pearlequities_expressorders_meo_v2_7_a.unsequenced_data_packet.fields(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
...
miax_pearlequities_expressorders_meo_v2_7_a.sequenced_data_packet.dissect = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_miax_pearlequities_expressorders_meo_v2_7_a.fields.sequenced_data_packet, buffer(offset, 0))
    local current = miax_pearlequities_expressorders_meo_v2_7_a.sequenced_data_packet.fields(buffer, offset, packet, parent, size_of_sequenced_data_packet)
...
-- Esesm Payload
miax_pearlequities_expressorders_meo_v2_7_a.esesm_payload = {}

-- Dissect: Esesm Payload
miax_pearlequities_expressorders_meo_v2_7_a.esesm_payload.dissect = function(buffer, offset, packet, parent, esesm_packet_type)
  -- Dissect Sequenced Data Packet
...
miax_pearlequities_expressorders_meo_v2_7_a.esesm_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_esesm_tcp_packet)
  ...
  index = miax_pearlequities_expressorders_meo_v2_7_a.esesm_payload.dissect(buffer, index, packet, parent, esesm_packet_type)
...
-- Register Miax PearlEquities ExpressOrders Meo 2.7.a for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_miax_pearlequities_expressorders_meo_v2_7_a)
