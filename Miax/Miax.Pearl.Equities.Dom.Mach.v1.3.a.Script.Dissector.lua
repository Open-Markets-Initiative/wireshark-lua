...
-- Miax Pearl Equities Dom Mach 1.3.a Protocol
local miax_pearl_equities_dom_mach_v1_3_a = Proto("Miax.Pearl.Equities.Dom.Mach.v1.3.a.Lua", "Miax Pearl Equities Dom Mach 1.3.a")
...
-- Miax Pearl Equities Dom Mach 1.3.a Fields
miax_pearl_equities_dom_mach_v1_3_a.fields.add_order_message = ProtoField.new("Add Order Message", "miax.pearl.equities.dom.mach.v1.3.a.addordermessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.application_message = ProtoField.new("Application Message", "miax.pearl.equities.dom.mach.v1.3.a.applicationmessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.attributable_id = ProtoField.new("Attributable Id", "miax.pearl.equities.dom.mach.v1.3.a.attributableid", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.closing_time = ProtoField.new("Closing Time", "miax.pearl.equities.dom.mach.v1.3.a.closingtime", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.correction_number = ProtoField.new("Correction Number", "miax.pearl.equities.dom.mach.v1.3.a.correctionnumber", ftypes.UINT8)
miax_pearl_equities_dom_mach_v1_3_a.fields.data = ProtoField.new("Data", "miax.pearl.equities.dom.mach.v1.3.a.data", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.delete_order_message = ProtoField.new("Delete Order Message", "miax.pearl.equities.dom.mach.v1.3.a.deleteordermessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.do_m_version = ProtoField.new("Do M Version", "miax.pearl.equities.dom.mach.v1.3.a.domversion", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.lot_size = ProtoField.new("Lot Size", "miax.pearl.equities.dom.mach.v1.3.a.lotsize", ftypes.UINT16)
miax_pearl_equities_dom_mach_v1_3_a.fields.market_state = ProtoField.new("Market State", "miax.pearl.equities.dom.mach.v1.3.a.marketstate", ftypes.UINT8)
miax_pearl_equities_dom_mach_v1_3_a.fields.message = ProtoField.new("Message", "miax.pearl.equities.dom.mach.v1.3.a.message", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.message_type = ProtoField.new("Message Type", "miax.pearl.equities.dom.mach.v1.3.a.messagetype", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.modify_order_message = ProtoField.new("Modify Order Message", "miax.pearl.equities.dom.mach.v1.3.a.modifyordermessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.opening_time = ProtoField.new("Opening Time", "miax.pearl.equities.dom.mach.v1.3.a.openingtime", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.order_execution_message = ProtoField.new("Order Execution Message", "miax.pearl.equities.dom.mach.v1.3.a.orderexecutionmessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.order_id = ProtoField.new("Order Id", "miax.pearl.equities.dom.mach.v1.3.a.orderid", ftypes.UINT64)
miax_pearl_equities_dom_mach_v1_3_a.fields.order_side = ProtoField.new("Order Side", "miax.pearl.equities.dom.mach.v1.3.a.orderside", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.packet = ProtoField.new("Packet", "miax.pearl.equities.dom.mach.v1.3.a.packet", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.packet_length = ProtoField.new("Packet Length", "miax.pearl.equities.dom.mach.v1.3.a.packetlength", ftypes.UINT16)
miax_pearl_equities_dom_mach_v1_3_a.fields.packet_type = ProtoField.new("Packet Type", "miax.pearl.equities.dom.mach.v1.3.a.packettype", ftypes.UINT8)
miax_pearl_equities_dom_mach_v1_3_a.fields.payload = ProtoField.new("Payload", "miax.pearl.equities.dom.mach.v1.3.a.payload", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.price = ProtoField.new("Price", "miax.pearl.equities.dom.mach.v1.3.a.price", ftypes.UINT64)
miax_pearl_equities_dom_mach_v1_3_a.fields.primary_market_code = ProtoField.new("Primary Market Code", "miax.pearl.equities.dom.mach.v1.3.a.primarymarketcode", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.reserved = ProtoField.new("Reserved", "miax.pearl.equities.dom.mach.v1.3.a.reserved", ftypes.UINT8)
miax_pearl_equities_dom_mach_v1_3_a.fields.security_trading_status_notification_message = ProtoField.new("Security Trading Status Notification Message", "miax.pearl.equities.dom.mach.v1.3.a.securitytradingstatusnotificationmessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.sequence_number = ProtoField.new("Sequence Number", "miax.pearl.equities.dom.mach.v1.3.a.sequencenumber", ftypes.UINT64)
miax_pearl_equities_dom_mach_v1_3_a.fields.session_id = ProtoField.new("Session Id", "miax.pearl.equities.dom.mach.v1.3.a.sessionid", ftypes.UINT8)
miax_pearl_equities_dom_mach_v1_3_a.fields.session_number = ProtoField.new("Session Number", "miax.pearl.equities.dom.mach.v1.3.a.sessionnumber", ftypes.UINT8)
miax_pearl_equities_dom_mach_v1_3_a.fields.short_sale_restriction = ProtoField.new("Short Sale Restriction", "miax.pearl.equities.dom.mach.v1.3.a.shortsalerestriction", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.size = ProtoField.new("Size", "miax.pearl.equities.dom.mach.v1.3.a.size", ftypes.UINT32)
miax_pearl_equities_dom_mach_v1_3_a.fields.symbol_clear_message = ProtoField.new("Symbol Clear Message", "miax.pearl.equities.dom.mach.v1.3.a.symbolclearmessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.symbol_id = ProtoField.new("Symbol Id", "miax.pearl.equities.dom.mach.v1.3.a.symbolid", ftypes.UINT32)
miax_pearl_equities_dom_mach_v1_3_a.fields.symbol_update_message = ProtoField.new("Symbol Update Message", "miax.pearl.equities.dom.mach.v1.3.a.symbolupdatemessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.system_state_message = ProtoField.new("System State Message", "miax.pearl.equities.dom.mach.v1.3.a.systemstatemessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.system_status = ProtoField.new("System Status", "miax.pearl.equities.dom.mach.v1.3.a.systemstatus", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.system_time_message = ProtoField.new("System Time Message", "miax.pearl.equities.dom.mach.v1.3.a.systemtimemessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.test_security_indicator = ProtoField.new("Test Security Indicator", "miax.pearl.equities.dom.mach.v1.3.a.testsecurityindicator", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.ticker_symbol = ProtoField.new("Ticker Symbol", "miax.pearl.equities.dom.mach.v1.3.a.tickersymbol", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.timestamp = ProtoField.new("Timestamp", "miax.pearl.equities.dom.mach.v1.3.a.timestamp", ftypes.UINT32)
miax_pearl_equities_dom_mach_v1_3_a.fields.trade_cancel_message = ProtoField.new("Trade Cancel Message", "miax.pearl.equities.dom.mach.v1.3.a.tradecancelmessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.trade_id = ProtoField.new("Trade Id", "miax.pearl.equities.dom.mach.v1.3.a.tradeid", ftypes.UINT64)
miax_pearl_equities_dom_mach_v1_3_a.fields.trade_message = ProtoField.new("Trade Message", "miax.pearl.equities.dom.mach.v1.3.a.trademessage", ftypes.STRING)
miax_pearl_equities_dom_mach_v1_3_a.fields.trading_status = ProtoField.new("Trading Status", "miax.pearl.equities.dom.mach.v1.3.a.tradingstatus", ftypes.UINT8)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Miax Pearl Equities Dom Mach 1.3.a Element Dissection Options
...
-- Register Miax Pearl Equities Dom Mach 1.3.a Show Options
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_add_order_message = Pref.bool("Show Add Order Message", show.add_order_message, "Parse and add Add Order Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_application_message = Pref.bool("Show Application Message", show.application_message, "Parse and add Application Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_delete_order_message = Pref.bool("Show Delete Order Message", show.delete_order_message, "Parse and add Delete Order Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_modify_order_message = Pref.bool("Show Modify Order Message", show.modify_order_message, "Parse and add Modify Order Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_order_execution_message = Pref.bool("Show Order Execution Message", show.order_execution_message, "Parse and add Order Execution Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_security_trading_status_notification_message = Pref.bool("Show Security Trading Status Notification Message", show.security_trading_status_notification_message, "Parse and add Security Trading Status Notification Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_symbol_clear_message = Pref.bool("Show Symbol Clear Message", show.symbol_clear_message, "Parse and add Symbol Clear Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_symbol_update_message = Pref.bool("Show Symbol Update Message", show.symbol_update_message, "Parse and add Symbol Update Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_system_state_message = Pref.bool("Show System State Message", show.system_state_message, "Parse and add System State Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_system_time_message = Pref.bool("Show System Time Message", show.system_time_message, "Parse and add System Time Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_trade_cancel_message = Pref.bool("Show Trade Cancel Message", show.trade_cancel_message, "Parse and add Trade Cancel Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_trade_message = Pref.bool("Show Trade Message", show.trade_message, "Parse and add Trade Message to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_data = Pref.bool("Show Data", show.data, "Parse and add Data to protocol tree")
miax_pearl_equities_dom_mach_v1_3_a.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function miax_pearl_equities_dom_mach_v1_3_a.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.add_order_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_add_order_message then
    show.add_order_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_add_order_message
    changed = true
  end
  if show.application_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_application_message then
    show.application_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_application_message
    changed = true
  end
  if show.delete_order_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_delete_order_message then
    show.delete_order_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_delete_order_message
    changed = true
  end
  if show.message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_message then
    show.message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_message
    changed = true
  end
  if show.modify_order_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_modify_order_message then
    show.modify_order_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_modify_order_message
    changed = true
  end
  if show.order_execution_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_order_execution_message then
    show.order_execution_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_order_execution_message
    changed = true
  end
  if show.packet ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_packet then
    show.packet = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_packet
    changed = true
  end
  if show.security_trading_status_notification_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_security_trading_status_notification_message then
    show.security_trading_status_notification_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_security_trading_status_notification_message
    changed = true
  end
  if show.symbol_clear_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_symbol_clear_message then
    show.symbol_clear_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_symbol_clear_message
    changed = true
  end
  if show.symbol_update_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_symbol_update_message then
    show.symbol_update_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_symbol_update_message
    changed = true
  end
  if show.system_state_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_system_state_message then
    show.system_state_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_system_state_message
    changed = true
  end
  if show.system_time_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_system_time_message then
    show.system_time_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_system_time_message
    changed = true
  end
  if show.trade_cancel_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_trade_cancel_message then
    show.trade_cancel_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_trade_cancel_message
    changed = true
  end
  if show.trade_message ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_trade_message then
    show.trade_message = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_trade_message
    changed = true
  end
  if show.data ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_data then
    show.data = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_data
    changed = true
  end
  if show.payload ~= miax_pearl_equities_dom_mach_v1_3_a.prefs.show_payload then
    show.payload = miax_pearl_equities_dom_mach_v1_3_a.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Miax Pearl Equities Dom Mach 1.3.a
-----------------------------------------------------------------------
...
dissect.size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.size, range, value, display)
...
dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.price, range, value, display)
...
dissect.correction_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.correction_number, range, value, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.trade_id, range, value, display)
...
dissect.symbol_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.symbol_id, range, value, display)
...
dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.timestamp, range, value, display)
...
dissect.trade_cancel_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_cancel_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.trade_cancel_message, range, display)
  end
...
dissect.trade_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.trade_message, range, display)
  end
...
dissect.order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.order_id, range, value, display)
...
dissect.order_execution_message = function(buffer, offset, packet, parent)
  ...
  if show.order_execution_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.order_execution_message, range, display)
  end
...
dissect.delete_order_message = function(buffer, offset, packet, parent)
  ...
  if show.delete_order_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.delete_order_message, range, display)
  end
...
dissect.modify_order_message = function(buffer, offset, packet, parent)
  ...
  if show.modify_order_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.modify_order_message, range, display)
  end
...
dissect.attributable_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.attributable_id, range, value, display)
...
dissect.order_side = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.order_side, range, value, display)
...
dissect.add_order_message = function(buffer, offset, packet, parent)
  ...
  if show.add_order_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.add_order_message, range, display)
  end
...
dissect.symbol_clear_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_clear_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.symbol_clear_message, range, display)
  end
...
dissect.short_sale_restriction = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.short_sale_restriction, range, value, display)
...
dissect.market_state = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.market_state, range, value, display)
...
dissect.trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.trading_status, range, value, display)
...
dissect.security_trading_status_notification_message = function(buffer, offset, packet, parent)
  ...
  if show.security_trading_status_notification_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.security_trading_status_notification_message, range, display)
  end
...
dissect.system_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.system_status, range, value, display)
...
dissect.session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.session_id, range, value, display)
...
dissect.do_m_version = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.do_m_version, range, value, display)
...
dissect.system_state_message = function(buffer, offset, packet, parent)
  ...
  if show.system_state_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.system_state_message, range, display)
  end
...
dissect.primary_market_code = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.primary_market_code, range, value, display)
...
dissect.closing_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.closing_time, range, value, display)
...
dissect.opening_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.opening_time, range, value, display)
...
dissect.lot_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.lot_size, range, value, display)
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.reserved, range, value, display)
...
dissect.test_security_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.test_security_indicator, range, value, display)
...
dissect.ticker_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.ticker_symbol, range, value, display)
...
dissect.symbol_update_message = function(buffer, offset, packet, parent)
  ...
  if show.symbol_update_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.symbol_update_message, range, display)
  end
...
dissect.system_time_message = function(buffer, offset, packet, parent)
  ...
  if show.system_time_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.system_time_message, range, display)
  end
...
dissect.data = function(buffer, offset, packet, parent, message_type)
  ...
  local element = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.data, range, display)
...
dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.message_type, range, value, display)
...
dissect.application_message = function(buffer, offset, packet, parent)
  ...
  if show.application_message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.application_message, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, packet_type)
  ...
  local element = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.payload, range, display)
...
dissect.session_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.session_number, range, value, display)
...
dissect.packet_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.packet_type, range, value, display)
...
dissect.packet_length = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.packet_length, range, value, display)
...
dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.sequence_number, range, value, display)
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(miax_pearl_equities_dom_mach_v1_3_a.fields.message, range, display)
  end
...
function miax_pearl_equities_dom_mach_v1_3_a.init()
end

-- Dissector for Miax Pearl Equities Dom Mach 1.3.a
function miax_pearl_equities_dom_mach_v1_3_a.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = miax_pearl_equities_dom_mach_v1_3_a.name

  -- Dissect protocol
  local protocol = parent:add(miax_pearl_equities_dom_mach_v1_3_a, buffer(), miax_pearl_equities_dom_mach_v1_3_a.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, miax_pearl_equities_dom_mach_v1_3_a)
...
verify.miax_pearl_equities_dom_mach_v1_3_a_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Miax Pearl Equities Dom Mach 1.3.a
local function miax_pearl_equities_dom_mach_v1_3_a_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.miax_pearl_equities_dom_mach_v1_3_a_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = miax_pearl_equities_dom_mach_v1_3_a
  miax_pearl_equities_dom_mach_v1_3_a.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Miax Pearl Equities Dom Mach 1.3.a
miax_pearl_equities_dom_mach_v1_3_a:register_heuristic("udp", miax_pearl_equities_dom_mach_v1_3_a_heuristic)
