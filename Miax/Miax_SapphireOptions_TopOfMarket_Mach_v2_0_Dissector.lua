...
omi_miax_sapphireoptions_topofmarket_mach_v2_0.prefs.show_mach_message = Pref.bool("Show Mach Message", show.mach_message, "Parse and add Mach Message to protocol tree")
...
omi_miax_sapphireoptions_topofmarket_mach_v2_0.prefs.show_sesm_packet_header = Pref.bool("Show Sesm Packet Header", show.sesm_packet_header, "Parse and add Sesm Packet Header to protocol tree")
...
function omi_miax_sapphireoptions_topofmarket_mach_v2_0.prefs_changed()
  ...
  if show.mach_message ~= omi_miax_sapphireoptions_topofmarket_mach_v2_0.prefs.show_mach_message then
    show.mach_message = omi_miax_sapphireoptions_topofmarket_mach_v2_0.prefs.show_mach_message
  end
  ...
  if show.sesm_packet_header ~= omi_miax_sapphireoptions_topofmarket_mach_v2_0.prefs.show_sesm_packet_header then
    show.sesm_packet_header = omi_miax_sapphireoptions_topofmarket_mach_v2_0.prefs.show_sesm_packet_header
  end
