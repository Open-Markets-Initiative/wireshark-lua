...
omi_miax_miaxoptions_orderfeed_mach_v2_5_b.fields.message = ProtoField.new("Message", "miax.miaxoptions.orderfeed.mach.v2.5.b.message", ftypes.STRING)
...
omi_miax_miaxoptions_orderfeed_mach_v2_5_b.fields.packet_header = ProtoField.new("Packet Header", "miax.miaxoptions.orderfeed.mach.v2.5.b.packetheader", ftypes.STRING)
...
omi_miax_miaxoptions_orderfeed_mach_v2_5_b.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_miax_miaxoptions_orderfeed_mach_v2_5_b.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
...
function omi_miax_miaxoptions_orderfeed_mach_v2_5_b.prefs_changed()
  ...
  if show.message ~= omi_miax_miaxoptions_orderfeed_mach_v2_5_b.prefs.show_message then
    show.message = omi_miax_miaxoptions_orderfeed_mach_v2_5_b.prefs.show_message
  end
  if show.packet_header ~= omi_miax_miaxoptions_orderfeed_mach_v2_5_b.prefs.show_packet_header then
    show.packet_header = omi_miax_miaxoptions_orderfeed_mach_v2_5_b.prefs.show_packet_header
  end
...
-- Packet Header
miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header = {}

-- Size: Packet Header
miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.size =
  miax_miaxoptions_orderfeed_mach_v2_5_b.packet_length.size + 
  miax_miaxoptions_orderfeed_mach_v2_5_b.packet_type.size

-- Display: Packet Header
miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_miaxoptions_orderfeed_mach_v2_5_b.fields.packet_header, buffer(offset, 0))
    local index = miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.fields(buffer, offset, packet, parent)
  end
end
...
miax_miaxoptions_orderfeed_mach_v2_5_b.sesm_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_sesm_tcp_packet)
  ...
  index, packet_header = miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.dissect(buffer, index, packet, parent)
...
local sesm_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.size then
...
miax_miaxoptions_orderfeed_mach_v2_5_b.tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= miax_miaxoptions_orderfeed_mach_v2_5_b.packet_header.size
end
...
-- Message
miax_miaxoptions_orderfeed_mach_v2_5_b.message = {}

-- Calculate size of: Message
miax_miaxoptions_orderfeed_mach_v2_5_b.message.size = function(buffer, offset)
  local index = 0
...
-- Display: Message
miax_miaxoptions_orderfeed_mach_v2_5_b.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
miax_miaxoptions_orderfeed_mach_v2_5_b.message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Message
miax_miaxoptions_orderfeed_mach_v2_5_b.message.dissect = function(buffer, offset, packet, parent)
  if show.message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_miaxoptions_orderfeed_mach_v2_5_b.fields.message, buffer(offset, 0))
    local index = miax_miaxoptions_orderfeed_mach_v2_5_b.message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_miaxoptions_orderfeed_mach_v2_5_b.message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_miaxoptions_orderfeed_mach_v2_5_b.message.fields(buffer, offset, packet, parent)
  end
end
...
miax_miaxoptions_orderfeed_mach_v2_5_b.udp_packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = miax_miaxoptions_orderfeed_mach_v2_5_b.message.dissect(buffer, index, packet, parent)
  end
