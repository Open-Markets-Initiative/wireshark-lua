...
-- Miax MiaxOptions Ais Mach 2.6 Headers
...
-- Miax MiaxOptions Ais 2.6 Application Messages
...
-----------------------------------------------------------------------
-- Miax MiaxOptions Ais Mach 2.6 Formatting
-----------------------------------------------------------------------

-- Timestamp format (true = decimal-scaled, false = raw mantissa)
miax_miaxoptions_ais_mach_v2_6.format_timestamp = true
...
omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_miax_miaxoptions_ais_mach_v2_6.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")
...
function omi_miax_miaxoptions_ais_mach_v2_6.prefs_changed()
  ...
  if show.repeating_groups ~= omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_repeating_groups then
    show.repeating_groups = omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_repeating_groups
  end
  if show.structs ~= omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_structs then
    show.structs = omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_structs
  end
  if show.indexes ~= omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_indexes then
    show.indexes = omi_miax_miaxoptions_ais_mach_v2_6.prefs.show_indexes
  end
  if miax_miaxoptions_ais_mach_v2_6.format_timestamp ~= omi_miax_miaxoptions_ais_mach_v2_6.prefs.format_timestamp then
    miax_miaxoptions_ais_mach_v2_6.format_timestamp = omi_miax_miaxoptions_ais_mach_v2_6.prefs.format_timestamp
  end
end
...
miax_miaxoptions_ais_mach_v2_6.timestamp.dissect = function(buffer, offset, packet, parent)
  if miax_miaxoptions_ais_mach_v2_6.format_timestamp then
