...
-- Miax Options Tom Mach 2.3 Protocol
local miax_options_tom_mach_v2_3 = Proto("Miax.Options.Tom.Mach.v2.3.Lua", "Miax Options Tom Mach 2.3")
...
-- Miax Options Tom Mach 2.3 Fields
miax_options_tom_mach_v2_3.fields.active_on_miax = ProtoField.new("Active On Miax", "miax.options.tom.mach.v2.3.activeonmiax", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.application_message = ProtoField.new("Application Message", "miax.options.tom.mach.v2.3.applicationmessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.bid_condition = ProtoField.new("Bid Condition", "miax.options.tom.mach.v2.3.bidcondition", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.bid_price_2 = ProtoField.new("Bid Price 2", "miax.options.tom.mach.v2.3.bidprice2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.bid_price_4 = ProtoField.new("Bid Price 4", "miax.options.tom.mach.v2.3.bidprice4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.bid_priority_customer_size_2 = ProtoField.new("Bid Priority Customer Size 2", "miax.options.tom.mach.v2.3.bidprioritycustomersize2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.bid_priority_customer_size_4 = ProtoField.new("Bid Priority Customer Size 4", "miax.options.tom.mach.v2.3.bidprioritycustomersize4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.bid_size_2 = ProtoField.new("Bid Size 2", "miax.options.tom.mach.v2.3.bidsize2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.bid_size_4 = ProtoField.new("Bid Size 4", "miax.options.tom.mach.v2.3.bidsize4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.call_or_put = ProtoField.new("Call Or Put", "miax.options.tom.mach.v2.3.callorput", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.closing_time = ProtoField.new("Closing Time", "miax.options.tom.mach.v2.3.closingtime", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.correction_number = ProtoField.new("Correction Number", "miax.options.tom.mach.v2.3.correctionnumber", ftypes.UINT8)
miax_options_tom_mach_v2_3.fields.data = ProtoField.new("Data", "miax.options.tom.mach.v2.3.data", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.event_reason = ProtoField.new("Event Reason", "miax.options.tom.mach.v2.3.eventreason", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.expected_event_time_nano_seconds = ProtoField.new("Expected Event Time Nano Seconds", "miax.options.tom.mach.v2.3.expectedeventtimenanoseconds", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.expected_event_time_seconds = ProtoField.new("Expected Event Time Seconds", "miax.options.tom.mach.v2.3.expectedeventtimeseconds", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.expiration_date = ProtoField.new("Expiration Date", "miax.options.tom.mach.v2.3.expirationdate", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.last_sale_message = ProtoField.new("Last Sale Message", "miax.options.tom.mach.v2.3.lastsalemessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.liquidity_acceptance_increment_indicator = ProtoField.new("Liquidity Acceptance Increment Indicator", "miax.options.tom.mach.v2.3.liquidityacceptanceincrementindicator", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.long_term_option = ProtoField.new("Long Term Option", "miax.options.tom.mach.v2.3.longtermoption", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.mbbo_condition = ProtoField.new("Mbbo Condition", "miax.options.tom.mach.v2.3.mbbocondition", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.mbbo_price_2 = ProtoField.new("Mbbo Price 2", "miax.options.tom.mach.v2.3.mbboprice2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.mbbo_price_4 = ProtoField.new("Mbbo Price 4", "miax.options.tom.mach.v2.3.mbboprice4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.mbbo_priority_customer_size_2 = ProtoField.new("Mbbo Priority Customer Size 2", "miax.options.tom.mach.v2.3.mbboprioritycustomersize2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.mbbo_priority_customer_size_4 = ProtoField.new("Mbbo Priority Customer Size 4", "miax.options.tom.mach.v2.3.mbboprioritycustomersize4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.mbbo_size_2 = ProtoField.new("Mbbo Size 2", "miax.options.tom.mach.v2.3.mbbosize2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.mbbo_size_4 = ProtoField.new("Mbbo Size 4", "miax.options.tom.mach.v2.3.mbbosize4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.message = ProtoField.new("Message", "miax.options.tom.mach.v2.3.message", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.message_type = ProtoField.new("Message Type", "miax.options.tom.mach.v2.3.messagetype", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.miax_bbo_posting_increment_indicator = ProtoField.new("Miax Bbo Posting Increment Indicator", "miax.options.tom.mach.v2.3.miaxbbopostingincrementindicator", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.notification_time = ProtoField.new("Notification Time", "miax.options.tom.mach.v2.3.notificationtime", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.offer_condition = ProtoField.new("Offer Condition", "miax.options.tom.mach.v2.3.offercondition", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.offer_price_2 = ProtoField.new("Offer Price 2", "miax.options.tom.mach.v2.3.offerprice2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.offer_price_4 = ProtoField.new("Offer Price 4", "miax.options.tom.mach.v2.3.offerprice4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.offer_priority_customer_size_2 = ProtoField.new("Offer Priority Customer Size 2", "miax.options.tom.mach.v2.3.offerprioritycustomersize2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.offer_priority_customer_size_4 = ProtoField.new("Offer Priority Customer Size 4", "miax.options.tom.mach.v2.3.offerprioritycustomersize4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.offer_size_2 = ProtoField.new("Offer Size 2", "miax.options.tom.mach.v2.3.offersize2", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.offer_size_4 = ProtoField.new("Offer Size 4", "miax.options.tom.mach.v2.3.offersize4", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.opening_time = ProtoField.new("Opening Time", "miax.options.tom.mach.v2.3.openingtime", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.opening_underlying_market_code = ProtoField.new("Opening Underlying Market Code", "miax.options.tom.mach.v2.3.openingunderlyingmarketcode", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.packet = ProtoField.new("Packet", "miax.options.tom.mach.v2.3.packet", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.packet_length = ProtoField.new("Packet Length", "miax.options.tom.mach.v2.3.packetlength", ftypes.UINT16)
miax_options_tom_mach_v2_3.fields.packet_type = ProtoField.new("Packet Type", "miax.options.tom.mach.v2.3.packettype", ftypes.UINT8)
miax_options_tom_mach_v2_3.fields.payload = ProtoField.new("Payload", "miax.options.tom.mach.v2.3.payload", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.priority_quote_width = ProtoField.new("Priority Quote Width", "miax.options.tom.mach.v2.3.priorityquotewidth", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.product_add_update_time = ProtoField.new("Product Add Update Time", "miax.options.tom.mach.v2.3.productaddupdatetime", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.product_id = ProtoField.new("Product Id", "miax.options.tom.mach.v2.3.productid", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.reference_correction_number = ProtoField.new("Reference Correction Number", "miax.options.tom.mach.v2.3.referencecorrectionnumber", ftypes.UINT8)
miax_options_tom_mach_v2_3.fields.reference_trade_id = ProtoField.new("Reference Trade Id", "miax.options.tom.mach.v2.3.referencetradeid", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.reserved = ProtoField.new("Reserved", "miax.options.tom.mach.v2.3.reserved", ftypes.UINT64)
miax_options_tom_mach_v2_3.fields.restricted_option = ProtoField.new("Restricted Option", "miax.options.tom.mach.v2.3.restrictedoption", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.security_symbol = ProtoField.new("Security Symbol", "miax.options.tom.mach.v2.3.securitysymbol", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.sequence_number = ProtoField.new("Sequence Number", "miax.options.tom.mach.v2.3.sequencenumber", ftypes.UINT64)
miax_options_tom_mach_v2_3.fields.session_id = ProtoField.new("Session Id", "miax.options.tom.mach.v2.3.sessionid", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.session_number = ProtoField.new("Session Number", "miax.options.tom.mach.v2.3.sessionnumber", ftypes.UINT8)
miax_options_tom_mach_v2_3.fields.simple_double_sided_top_of_market_compact_message = ProtoField.new("Simple Double Sided Top Of Market Compact Message", "miax.options.tom.mach.v2.3.simpledoublesidedtopofmarketcompactmessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.simple_double_sided_top_of_market_wide_message = ProtoField.new("Simple Double Sided Top Of Market Wide Message", "miax.options.tom.mach.v2.3.simpledoublesidedtopofmarketwidemessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.simple_series_update_message = ProtoField.new("Simple Series Update Message", "miax.options.tom.mach.v2.3.simpleseriesupdatemessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.simple_top_of_market_bid_compact_message = ProtoField.new("Simple Top Of Market Bid Compact Message", "miax.options.tom.mach.v2.3.simpletopofmarketbidcompactmessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.simple_top_of_market_bid_wide_message = ProtoField.new("Simple Top Of Market Bid Wide Message", "miax.options.tom.mach.v2.3.simpletopofmarketbidwidemessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.simple_top_of_market_offer_compact_message = ProtoField.new("Simple Top Of Market Offer Compact Message", "miax.options.tom.mach.v2.3.simpletopofmarketoffercompactmessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.simple_top_of_market_offer_wide_message = ProtoField.new("Simple Top Of Market Offer Wide Message", "miax.options.tom.mach.v2.3.simpletopofmarketofferwidemessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.strike_price = ProtoField.new("Strike Price", "miax.options.tom.mach.v2.3.strikeprice", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.system_state_message = ProtoField.new("System State Message", "miax.options.tom.mach.v2.3.systemstatemessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.system_status = ProtoField.new("System Status", "miax.options.tom.mach.v2.3.systemstatus", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.system_time_message = ProtoField.new("System Time Message", "miax.options.tom.mach.v2.3.systemtimemessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.timestamp = ProtoField.new("Timestamp", "miax.options.tom.mach.v2.3.timestamp", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.to_m_version = ProtoField.new("To M Version", "miax.options.tom.mach.v2.3.tomversion", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.trade_cancel_message = ProtoField.new("Trade Cancel Message", "miax.options.tom.mach.v2.3.tradecancelmessage", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.trade_condition = ProtoField.new("Trade Condition", "miax.options.tom.mach.v2.3.tradecondition", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.trade_id = ProtoField.new("Trade Id", "miax.options.tom.mach.v2.3.tradeid", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.trade_price = ProtoField.new("Trade Price", "miax.options.tom.mach.v2.3.tradeprice", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.trade_size = ProtoField.new("Trade Size", "miax.options.tom.mach.v2.3.tradesize", ftypes.UINT32)
miax_options_tom_mach_v2_3.fields.trading_status = ProtoField.new("Trading Status", "miax.options.tom.mach.v2.3.tradingstatus", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "miax.options.tom.mach.v2.3.underlyingsymbol", ftypes.STRING)
miax_options_tom_mach_v2_3.fields.underlying_trading_status_notification_message = ProtoField.new("Underlying Trading Status Notification Message", "miax.options.tom.mach.v2.3.underlyingtradingstatusnotificationmessage", ftypes.STRING)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Miax Options Tom Mach 2.3 Element Dissection Options
...
-- Register Miax Options Tom Mach 2.3 Show Options
miax_options_tom_mach_v2_3.prefs.show_application_message = Pref.bool("Show Application Message", show.application_message, "Parse and add Application Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_last_sale_message = Pref.bool("Show Last Sale Message", show.last_sale_message, "Parse and add Last Sale Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_simple_double_sided_top_of_market_compact_message = Pref.bool("Show Simple Double Sided Top Of Market Compact Message", show.simple_double_sided_top_of_market_compact_message, "Parse and add Simple Double Sided Top Of Market Compact Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_simple_double_sided_top_of_market_wide_message = Pref.bool("Show Simple Double Sided Top Of Market Wide Message", show.simple_double_sided_top_of_market_wide_message, "Parse and add Simple Double Sided Top Of Market Wide Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_simple_series_update_message = Pref.bool("Show Simple Series Update Message", show.simple_series_update_message, "Parse and add Simple Series Update Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_bid_compact_message = Pref.bool("Show Simple Top Of Market Bid Compact Message", show.simple_top_of_market_bid_compact_message, "Parse and add Simple Top Of Market Bid Compact Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_bid_wide_message = Pref.bool("Show Simple Top Of Market Bid Wide Message", show.simple_top_of_market_bid_wide_message, "Parse and add Simple Top Of Market Bid Wide Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_offer_compact_message = Pref.bool("Show Simple Top Of Market Offer Compact Message", show.simple_top_of_market_offer_compact_message, "Parse and add Simple Top Of Market Offer Compact Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_offer_wide_message = Pref.bool("Show Simple Top Of Market Offer Wide Message", show.simple_top_of_market_offer_wide_message, "Parse and add Simple Top Of Market Offer Wide Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_system_state_message = Pref.bool("Show System State Message", show.system_state_message, "Parse and add System State Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_system_time_message = Pref.bool("Show System Time Message", show.system_time_message, "Parse and add System Time Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_trade_cancel_message = Pref.bool("Show Trade Cancel Message", show.trade_cancel_message, "Parse and add Trade Cancel Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_underlying_trading_status_notification_message = Pref.bool("Show Underlying Trading Status Notification Message", show.underlying_trading_status_notification_message, "Parse and add Underlying Trading Status Notification Message to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_data = Pref.bool("Show Data", show.data, "Parse and add Data to protocol tree")
miax_options_tom_mach_v2_3.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function miax_options_tom_mach_v2_3.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.application_message ~= miax_options_tom_mach_v2_3.prefs.show_application_message then
    show.application_message = miax_options_tom_mach_v2_3.prefs.show_application_message
    changed = true
  end
  if show.last_sale_message ~= miax_options_tom_mach_v2_3.prefs.show_last_sale_message then
    show.last_sale_message = miax_options_tom_mach_v2_3.prefs.show_last_sale_message
    changed = true
  end
  if show.message ~= miax_options_tom_mach_v2_3.prefs.show_message then
    show.message = miax_options_tom_mach_v2_3.prefs.show_message
    changed = true
  end
  if show.packet ~= miax_options_tom_mach_v2_3.prefs.show_packet then
    show.packet = miax_options_tom_mach_v2_3.prefs.show_packet
    changed = true
  end
  if show.simple_double_sided_top_of_market_compact_message ~= miax_options_tom_mach_v2_3.prefs.show_simple_double_sided_top_of_market_compact_message then
    show.simple_double_sided_top_of_market_compact_message = miax_options_tom_mach_v2_3.prefs.show_simple_double_sided_top_of_market_compact_message
    changed = true
  end
  if show.simple_double_sided_top_of_market_wide_message ~= miax_options_tom_mach_v2_3.prefs.show_simple_double_sided_top_of_market_wide_message then
    show.simple_double_sided_top_of_market_wide_message = miax_options_tom_mach_v2_3.prefs.show_simple_double_sided_top_of_market_wide_message
    changed = true
  end
  if show.simple_series_update_message ~= miax_options_tom_mach_v2_3.prefs.show_simple_series_update_message then
    show.simple_series_update_message = miax_options_tom_mach_v2_3.prefs.show_simple_series_update_message
    changed = true
  end
  if show.simple_top_of_market_bid_compact_message ~= miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_bid_compact_message then
    show.simple_top_of_market_bid_compact_message = miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_bid_compact_message
    changed = true
  end
  if show.simple_top_of_market_bid_wide_message ~= miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_bid_wide_message then
    show.simple_top_of_market_bid_wide_message = miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_bid_wide_message
    changed = true
  end
  if show.simple_top_of_market_offer_compact_message ~= miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_offer_compact_message then
    show.simple_top_of_market_offer_compact_message = miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_offer_compact_message
    changed = true
  end
  if show.simple_top_of_market_offer_wide_message ~= miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_offer_wide_message then
    show.simple_top_of_market_offer_wide_message = miax_options_tom_mach_v2_3.prefs.show_simple_top_of_market_offer_wide_message
    changed = true
  end
  if show.system_state_message ~= miax_options_tom_mach_v2_3.prefs.show_system_state_message then
    show.system_state_message = miax_options_tom_mach_v2_3.prefs.show_system_state_message
    changed = true
  end
  if show.system_time_message ~= miax_options_tom_mach_v2_3.prefs.show_system_time_message then
    show.system_time_message = miax_options_tom_mach_v2_3.prefs.show_system_time_message
    changed = true
  end
  if show.trade_cancel_message ~= miax_options_tom_mach_v2_3.prefs.show_trade_cancel_message then
    show.trade_cancel_message = miax_options_tom_mach_v2_3.prefs.show_trade_cancel_message
    changed = true
  end
  if show.underlying_trading_status_notification_message ~= miax_options_tom_mach_v2_3.prefs.show_underlying_trading_status_notification_message then
    show.underlying_trading_status_notification_message = miax_options_tom_mach_v2_3.prefs.show_underlying_trading_status_notification_message
    changed = true
  end
  if show.data ~= miax_options_tom_mach_v2_3.prefs.show_data then
    show.data = miax_options_tom_mach_v2_3.prefs.show_data
    changed = true
  end
  if show.payload ~= miax_options_tom_mach_v2_3.prefs.show_payload then
    show.payload = miax_options_tom_mach_v2_3.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Miax Options Tom Mach 2.3
-----------------------------------------------------------------------
...
dissect.expected_event_time_nano_seconds = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.expected_event_time_nano_seconds, range, value, display)
...
dissect.expected_event_time_seconds = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.expected_event_time_seconds, range, value, display)
...
dissect.event_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.event_reason, range, value, display)
...
dissect.trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.trading_status, range, value, display)
...
dissect.underlying_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.underlying_symbol, range, value, display)
...
dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.timestamp, range, value, display)
...
dissect.underlying_trading_status_notification_message = function(buffer, offset, packet, parent)
  ...
  if show.underlying_trading_status_notification_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.underlying_trading_status_notification_message, range, display)
  end
...
dissect.trade_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.trade_condition, range, value, display)
...
dissect.trade_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.trade_size, range, value, display)
...
dissect.trade_price = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.trade_price, range, value, display)
...
dissect.correction_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.correction_number, range, value, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.trade_id, range, value, display)
...
dissect.product_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.product_id, range, value, display)
...
dissect.trade_cancel_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_cancel_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.trade_cancel_message, range, display)
  end
...
dissect.reference_correction_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.reference_correction_number, range, value, display)
...
dissect.reference_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.reference_trade_id, range, value, display)
...
dissect.last_sale_message = function(buffer, offset, packet, parent)
  ...
  if show.last_sale_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.last_sale_message, range, display)
  end
...
dissect.offer_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.offer_condition, range, value, display)
...
dissect.offer_priority_customer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.offer_priority_customer_size_4, range, value, display)
...
dissect.offer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.offer_size_4, range, value, display)
...
dissect.offer_price_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.offer_price_4, range, value, display)
...
dissect.bid_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.bid_condition, range, value, display)
...
dissect.bid_priority_customer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.bid_priority_customer_size_4, range, value, display)
...
dissect.bid_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.bid_size_4, range, value, display)
...
dissect.bid_price_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.bid_price_4, range, value, display)
...
dissect.simple_double_sided_top_of_market_wide_message = function(buffer, offset, packet, parent)
  ...
  if show.simple_double_sided_top_of_market_wide_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.simple_double_sided_top_of_market_wide_message, range, display)
  end
...
dissect.offer_priority_customer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.offer_priority_customer_size_2, range, value, display)
...
dissect.offer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.offer_size_2, range, value, display)
...
dissect.offer_price_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.offer_price_2, range, value, display)
...
dissect.bid_priority_customer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.bid_priority_customer_size_2, range, value, display)
...
dissect.bid_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.bid_size_2, range, value, display)
...
dissect.bid_price_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.bid_price_2, range, value, display)
...
dissect.simple_double_sided_top_of_market_compact_message = function(buffer, offset, packet, parent)
  ...
  if show.simple_double_sided_top_of_market_compact_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.simple_double_sided_top_of_market_compact_message, range, display)
  end
...
dissect.mbbo_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.mbbo_condition, range, value, display)
...
dissect.mbbo_priority_customer_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.mbbo_priority_customer_size_4, range, value, display)
...
dissect.mbbo_size_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.mbbo_size_4, range, value, display)
...
dissect.mbbo_price_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.mbbo_price_4, range, value, display)
...
dissect.simple_top_of_market_offer_wide_message = function(buffer, offset, packet, parent)
  ...
  if show.simple_top_of_market_offer_wide_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.simple_top_of_market_offer_wide_message, range, display)
  end
...
dissect.simple_top_of_market_bid_wide_message = function(buffer, offset, packet, parent)
  ...
  if show.simple_top_of_market_bid_wide_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.simple_top_of_market_bid_wide_message, range, display)
  end
...
dissect.mbbo_priority_customer_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.mbbo_priority_customer_size_2, range, value, display)
...
dissect.mbbo_size_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.mbbo_size_2, range, value, display)
...
dissect.mbbo_price_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.mbbo_price_2, range, value, display)
...
dissect.simple_top_of_market_offer_compact_message = function(buffer, offset, packet, parent)
  ...
  if show.simple_top_of_market_offer_compact_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.simple_top_of_market_offer_compact_message, range, display)
  end
...
dissect.simple_top_of_market_bid_compact_message = function(buffer, offset, packet, parent)
  ...
  if show.simple_top_of_market_bid_compact_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.simple_top_of_market_bid_compact_message, range, display)
  end
...
dissect.system_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.system_status, range, value, display)
...
dissect.session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.session_id, range, value, display)
...
dissect.to_m_version = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.to_m_version, range, value, display)
...
dissect.notification_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.notification_time, range, value, display)
...
dissect.system_state_message = function(buffer, offset, packet, parent)
  ...
  if show.system_state_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.system_state_message, range, display)
  end
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.reserved, range, value, display)
...
dissect.priority_quote_width = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.priority_quote_width, range, value, display)
...
dissect.opening_underlying_market_code = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.opening_underlying_market_code, range, value, display)
...
dissect.liquidity_acceptance_increment_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.liquidity_acceptance_increment_indicator, range, value, display)
...
dissect.miax_bbo_posting_increment_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.miax_bbo_posting_increment_indicator, range, value, display)
...
dissect.active_on_miax = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.active_on_miax, range, value, display)
...
dissect.long_term_option = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.long_term_option, range, value, display)
...
dissect.restricted_option = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.restricted_option, range, value, display)
...
dissect.closing_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.closing_time, range, value, display)
...
dissect.opening_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.opening_time, range, value, display)
...
dissect.call_or_put = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.call_or_put, range, value, display)
...
dissect.strike_price = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.strike_price, range, value, display)
...
dissect.expiration_date = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.expiration_date, range, value, display)
...
dissect.security_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.security_symbol, range, value, display)
...
dissect.product_add_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.product_add_update_time, range, value, display)
...
dissect.simple_series_update_message = function(buffer, offset, packet, parent)
  ...
  if show.simple_series_update_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.simple_series_update_message, range, display)
  end
...
dissect.system_time_message = function(buffer, offset, packet, parent)
  ...
  if show.system_time_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.system_time_message, range, display)
  end
...
dissect.data = function(buffer, offset, packet, parent, message_type)
  ...
  local element = parent:add(miax_options_tom_mach_v2_3.fields.data, range, display)
...
dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.message_type, range, value, display)
...
dissect.application_message = function(buffer, offset, packet, parent)
  ...
  if show.application_message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.application_message, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, packet_type)
  ...
  local element = parent:add(miax_options_tom_mach_v2_3.fields.payload, range, display)
...
dissect.session_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.session_number, range, value, display)
...
dissect.packet_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.packet_type, range, value, display)
...
dissect.packet_length = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.packet_length, range, value, display)
...
dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_options_tom_mach_v2_3.fields.sequence_number, range, value, display)
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(miax_options_tom_mach_v2_3.fields.message, range, display)
  end
...
function miax_options_tom_mach_v2_3.init()
end

-- Dissector for Miax Options Tom Mach 2.3
function miax_options_tom_mach_v2_3.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = miax_options_tom_mach_v2_3.name

  -- Dissect protocol
  local protocol = parent:add(miax_options_tom_mach_v2_3, buffer(), miax_options_tom_mach_v2_3.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, miax_options_tom_mach_v2_3)
...
verify.miax_options_tom_mach_v2_3_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Miax Options Tom Mach 2.3
local function miax_options_tom_mach_v2_3_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.miax_options_tom_mach_v2_3_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = miax_options_tom_mach_v2_3
  miax_options_tom_mach_v2_3.dissector(buffer, packet, parent)
