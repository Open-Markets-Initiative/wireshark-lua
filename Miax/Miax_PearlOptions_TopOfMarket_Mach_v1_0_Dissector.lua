...
local miax_pearloptions_topofmarket_mach_v1_0 = Proto("Miax.PearlOptions.TopOfMarket.Mach.v1.0.Lua", "Miax PearlOptions TopOfMarket Mach 1.0")
...
miax_pearloptions_topofmarket_mach_v1_0.fields.closing_time = ProtoField.new("Closing Time", "miax.pearloptions.topofmarket.mach.v1.0.closingtime", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.correction_number = ProtoField.new("Correction Number", "miax.pearloptions.topofmarket.mach.v1.0.correctionnumber", ftypes.UINT8)
miax_pearloptions_topofmarket_mach_v1_0.fields.data = ProtoField.new("Data", "miax.pearloptions.topofmarket.mach.v1.0.data", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.event_reason = ProtoField.new("Event Reason", "miax.pearloptions.topofmarket.mach.v1.0.eventreason", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.expected_event_time_nano_seconds_part = ProtoField.new("Expected Event Time Nano Seconds Part", "miax.pearloptions.topofmarket.mach.v1.0.expectedeventtimenanosecondspart", ftypes.UINT32)
miax_pearloptions_topofmarket_mach_v1_0.fields.expected_event_time_seconds_part = ProtoField.new("Expected Event Time Seconds Part", "miax.pearloptions.topofmarket.mach.v1.0.expectedeventtimesecondspart", ftypes.UINT32)
miax_pearloptions_topofmarket_mach_v1_0.fields.expiration_date = ProtoField.new("Expiration Date", "miax.pearloptions.topofmarket.mach.v1.0.expirationdate", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.liquidity_acceptance_increment_indicator = ProtoField.new("Liquidity Acceptance Increment Indicator", "miax.pearloptions.topofmarket.mach.v1.0.liquidityacceptanceincrementindicator", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.long_term_option = ProtoField.new("Long Term Option", "miax.pearloptions.topofmarket.mach.v1.0.longtermoption", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.message = ProtoField.new("Message", "miax.pearloptions.topofmarket.mach.v1.0.message", ftypes.STRING)
...
miax_pearloptions_topofmarket_mach_v1_0.fields.opening_underlying_market_code = ProtoField.new("Opening Underlying Market Code", "miax.pearloptions.topofmarket.mach.v1.0.openingunderlyingmarketcode", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.packet = ProtoField.new("Packet", "miax.pearloptions.topofmarket.mach.v1.0.packet", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.packet_length = ProtoField.new("Packet Length", "miax.pearloptions.topofmarket.mach.v1.0.packetlength", ftypes.UINT16)
...
miax_pearloptions_topofmarket_mach_v1_0.fields.product_add_update_time = ProtoField.new("Product Add Update Time", "miax.pearloptions.topofmarket.mach.v1.0.productaddupdatetime", ftypes.UINT32)
...
miax_pearloptions_topofmarket_mach_v1_0.fields.to_m_version = ProtoField.new("To M Version", "miax.pearloptions.topofmarket.mach.v1.0.tomversion", ftypes.STRING)
...
miax_pearloptions_topofmarket_mach_v1_0.fields.compact_double_sided_top_of_market_message = ProtoField.new("Compact Double Sided Top Of Market Message", "miax.pearloptions.topofmarket.mach.v1.0.compactdoublesidedtopofmarketmessage", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.compact_top_of_market_best_offer_message = ProtoField.new("Compact Top Of Market Best Offer Message", "miax.pearloptions.topofmarket.mach.v1.0.compacttopofmarketbestoffermessage", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.compact_top_of_market_bid_message = ProtoField.new("Compact Top Of Market Bid Message", "miax.pearloptions.topofmarket.mach.v1.0.compacttopofmarketbidmessage", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.last_sale_message = ProtoField.new("Last Sale Message", "miax.pearloptions.topofmarket.mach.v1.0.lastsalemessage", ftypes.STRING)
miax_pearloptions_topofmarket_mach_v1_0.fields.pearl_system_time_message = ProtoField.new("Pearl System Time Message", "miax.pearloptions.topofmarket.mach.v1.0.pearlsystemtimemessage", ftypes.STRING)
...
miax_pearloptions_topofmarket_mach_v1_0.fields.wide_top_of_market_best_offer_message = ProtoField.new("Wide Top Of Market Best Offer Message", "miax.pearloptions.topofmarket.mach.v1.0.widetopofmarketbestoffermessage", ftypes.STRING)
...
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_application_message = Pref.bool("Show Application Message", show.application_message, "Parse and add Application Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_double_sided_top_of_market_message = Pref.bool("Show Compact Double Sided Top Of Market Message", show.compact_double_sided_top_of_market_message, "Parse and add Compact Double Sided Top Of Market Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_top_of_market_best_offer_message = Pref.bool("Show Compact Top Of Market Best Offer Message", show.compact_top_of_market_best_offer_message, "Parse and add Compact Top Of Market Best Offer Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_top_of_market_bid_message = Pref.bool("Show Compact Top Of Market Bid Message", show.compact_top_of_market_bid_message, "Parse and add Compact Top Of Market Bid Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_last_sale_message = Pref.bool("Show Last Sale Message", show.last_sale_message, "Parse and add Last Sale Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_pearl_system_time_message = Pref.bool("Show Pearl System Time Message", show.pearl_system_time_message, "Parse and add Pearl System Time Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_series_update_message = Pref.bool("Show Series Update Message", show.series_update_message, "Parse and add Series Update Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_system_state_message = Pref.bool("Show System State Message", show.system_state_message, "Parse and add System State Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_trade_cancel_message = Pref.bool("Show Trade Cancel Message", show.trade_cancel_message, "Parse and add Trade Cancel Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_underlying_trading_status_notification = Pref.bool("Show Underlying Trading Status Notification", show.underlying_trading_status_notification, "Parse and add Underlying Trading Status Notification to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_double_sided_top_of_market_message = Pref.bool("Show Wide Double Sided Top Of Market Message", show.wide_double_sided_top_of_market_message, "Parse and add Wide Double Sided Top Of Market Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_top_of_market_best_bid_message = Pref.bool("Show Wide Top Of Market Best Bid Message", show.wide_top_of_market_best_bid_message, "Parse and add Wide Top Of Market Best Bid Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_top_of_market_best_offer_message = Pref.bool("Show Wide Top Of Market Best Offer Message", show.wide_top_of_market_best_offer_message, "Parse and add Wide Top Of Market Best Offer Message to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_data = Pref.bool("Show Data", show.data, "Parse and add Data to protocol tree")
miax_pearloptions_topofmarket_mach_v1_0.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function miax_pearloptions_topofmarket_mach_v1_0.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.application_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_application_message then
    show.application_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_application_message
    changed = true
  end
  if show.compact_double_sided_top_of_market_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_double_sided_top_of_market_message then
    show.compact_double_sided_top_of_market_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_double_sided_top_of_market_message
    changed = true
  end
  if show.compact_top_of_market_best_offer_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_top_of_market_best_offer_message then
    show.compact_top_of_market_best_offer_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_top_of_market_best_offer_message
    changed = true
  end
  if show.compact_top_of_market_bid_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_top_of_market_bid_message then
    show.compact_top_of_market_bid_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_compact_top_of_market_bid_message
    changed = true
  end
  if show.last_sale_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_last_sale_message then
    show.last_sale_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_last_sale_message
    changed = true
  end
  if show.message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_message then
    show.message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_message
    changed = true
  end
  if show.packet ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_packet then
    show.packet = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_packet
    changed = true
  end
  if show.pearl_system_time_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_pearl_system_time_message then
    show.pearl_system_time_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_pearl_system_time_message
    changed = true
  end
  if show.series_update_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_series_update_message then
    show.series_update_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_series_update_message
    changed = true
  end
  if show.system_state_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_system_state_message then
    show.system_state_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_system_state_message
    changed = true
  end
  if show.trade_cancel_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_trade_cancel_message then
    show.trade_cancel_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_trade_cancel_message
    changed = true
  end
  if show.underlying_trading_status_notification ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_underlying_trading_status_notification then
    show.underlying_trading_status_notification = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_underlying_trading_status_notification
    changed = true
  end
  if show.wide_double_sided_top_of_market_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_double_sided_top_of_market_message then
    show.wide_double_sided_top_of_market_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_double_sided_top_of_market_message
    changed = true
  end
  if show.wide_top_of_market_best_bid_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_top_of_market_best_bid_message then
    show.wide_top_of_market_best_bid_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_top_of_market_best_bid_message
    changed = true
  end
  if show.wide_top_of_market_best_offer_message ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_top_of_market_best_offer_message then
    show.wide_top_of_market_best_offer_message = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_wide_top_of_market_best_offer_message
    changed = true
  end
  if show.data ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_data then
    show.data = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_data
    changed = true
  end
  if show.payload ~= miax_pearloptions_topofmarket_mach_v1_0.prefs.show_payload then
    show.payload = miax_pearloptions_topofmarket_mach_v1_0.prefs.show_payload
    changed = true
  end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.expected_event_time_nano_seconds_part = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.expected_event_time_nano_seconds_part, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.expected_event_time_seconds_part = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.expected_event_time_seconds_part, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.event_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.event_reason, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.trading_status, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.timestamp, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.underlying_trading_status_notification = function(buffer, offset, packet, parent)
  if show.underlying_trading_status_notification then
    ...
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.underlying_trading_status_notification, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.underlying_trading_status_notification_fields(buffer, offset, packet, element)
    ...
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.underlying_trading_status_notification_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.trade_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.trade_condition, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.trade_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.trade_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.correction_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.correction_number, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.trade_id, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.product_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.product_id, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.trade_cancel_message = function(buffer, offset, packet, parent)
  if show.trade_cancel_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.trade_cancel_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.trade_cancel_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.trade_cancel_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.reference_correction_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.reference_correction_number, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.reference_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.reference_trade_id, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.last_sale_message = function(buffer, offset, packet, parent)
  if show.last_sale_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.last_sale_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.last_sale_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.last_sale_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.offer_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.offer_condition, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_offer_priority_customer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_offer_priority_customer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_offer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_offer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.bid_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.bid_condition, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_bid_priority_customer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_bid_priority_customer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_bid_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_double_sided_top_of_market_message = function(buffer, offset, packet, parent)
  if show.wide_double_sided_top_of_market_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_double_sided_top_of_market_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_double_sided_top_of_market_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_double_sided_top_of_market_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.offer_priority_customer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.offer_priority_customer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.offer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.offer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.bid_priority_customer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.bid_priority_customer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.bid_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_double_sided_top_of_market_message = function(buffer, offset, packet, parent)
  if show.compact_double_sided_top_of_market_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.compact_double_sided_top_of_market_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_double_sided_top_of_market_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_double_sided_top_of_market_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.pbbo_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.pbbo_condition, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_pbbo_priority_customer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_pbbo_priority_customer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_pbbo_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_pbbo_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_top_of_market_best_offer_message = function(buffer, offset, packet, parent)
  if show.wide_top_of_market_best_offer_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_top_of_market_best_offer_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_top_of_market_best_offer_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_top_of_market_best_offer_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_top_of_market_best_bid_message = function(buffer, offset, packet, parent)
  if show.wide_top_of_market_best_bid_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.wide_top_of_market_best_bid_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_top_of_market_best_bid_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.wide_top_of_market_best_bid_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.pbbo_priority_customer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.pbbo_priority_customer_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.pbbo_size = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.pbbo_size, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_top_of_market_best_offer_message = function(buffer, offset, packet, parent)
  if show.compact_top_of_market_best_offer_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.compact_top_of_market_best_offer_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_top_of_market_best_offer_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_top_of_market_best_offer_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_top_of_market_bid_message = function(buffer, offset, packet, parent)
  if show.compact_top_of_market_bid_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.compact_top_of_market_bid_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_top_of_market_bid_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.compact_top_of_market_bid_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.system_status = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.system_status, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.session_id, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.notification_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.notification_time, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.system_state_message = function(buffer, offset, packet, parent)
  if show.system_state_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.system_state_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.system_state_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.system_state_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.opening_underlying_market_code = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.opening_underlying_market_code, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.liquidity_acceptance_increment_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.liquidity_acceptance_increment_indicator, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.pearl_bbo_posting_increment_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.pearl_bbo_posting_increment_indicator, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.active_on_pearl = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.active_on_pearl, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.long_term_option = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.long_term_option, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.restricted_option = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.restricted_option, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.call_or_put = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.call_or_put, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.product_add_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.product_add_update_time, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.series_update_message = function(buffer, offset, packet, parent)
  if show.series_update_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.series_update_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.series_update_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.series_update_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.pearl_system_time_message = function(buffer, offset, packet, parent)
  if show.pearl_system_time_message then
    -- Optionally add element to protocol tree
    local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.pearl_system_time_message, buffer(offset, 0))
    local index = miax_pearloptions_topofmarket_mach_v1_0_dissect.pearl_system_time_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return miax_pearloptions_topofmarket_mach_v1_0_dissect.pearl_system_time_message_fields(buffer, offset, packet, element)
  end
end
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.data = function(buffer, offset, packet, parent, message_type)
  ...
  local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.data, range, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.message_type, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.payload = function(buffer, offset, packet, parent, packet_type)
  ...
  local element = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.payload, range, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.session_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.session_number, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.packet_type = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.packet_type, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.packet_length = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.packet_length, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.sequence_number, range, value, display)
...
miax_pearloptions_topofmarket_mach_v1_0_dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(miax_pearloptions_topofmarket_mach_v1_0.fields.message, range, display)
  end
...
function miax_pearloptions_topofmarket_mach_v1_0.init()
end

-- Dissector for Miax PearlOptions TopOfMarket Mach 1.0
function miax_pearloptions_topofmarket_mach_v1_0.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = miax_pearloptions_topofmarket_mach_v1_0.name

  -- Dissect protocol
  local protocol = parent:add(miax_pearloptions_topofmarket_mach_v1_0, buffer(), miax_pearloptions_topofmarket_mach_v1_0.description, "("..buffer:len().." Bytes)")
  return miax_pearloptions_topofmarket_mach_v1_0_dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, miax_pearloptions_topofmarket_mach_v1_0)
...
verify.miax_pearloptions_topofmarket_mach_v1_0_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Miax PearlOptions TopOfMarket Mach 1.0
local function miax_pearloptions_topofmarket_mach_v1_0_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.miax_pearloptions_topofmarket_mach_v1_0_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = miax_pearloptions_topofmarket_mach_v1_0
  miax_pearloptions_topofmarket_mach_v1_0.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Miax PearlOptions TopOfMarket Mach 1.0
miax_pearloptions_topofmarket_mach_v1_0:register_heuristic("udp", miax_pearloptions_topofmarket_mach_v1_0_heuristic)
