...
omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.fields.message = ProtoField.new("Message", "miax.sapphireoptions.complextopofmarket.mach.v1.0.a.message", ftypes.STRING)
...
omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.fields.packet_header = ProtoField.new("Packet Header", "miax.sapphireoptions.complextopofmarket.mach.v1.0.a.packetheader", ftypes.STRING)
...
omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.fields.packet_type = ProtoField.new("Packet Type", "miax.sapphireoptions.complextopofmarket.mach.v1.0.a.packettype", ftypes.STRING)
...
omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
...
function omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.prefs_changed()
  ...
  if show.message ~= omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.prefs.show_message then
    show.message = omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.prefs.show_message
  end
  if show.packet_header ~= omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.prefs.show_packet_header then
    show.packet_header = omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.prefs.show_packet_header
  end
...
-- Packet Header
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header = {}

-- Size: Packet Header
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.size =
  miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_length.size + 
  miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_type.size

-- Display: Packet Header
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.fields.packet_header, buffer(offset, 0))
    local index = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.fields(buffer, offset, packet, parent)
  end
end
...
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.sesm_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_sesm_tcp_packet)
  ...
  index, packet_header = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.dissect(buffer, index, packet, parent)
...
local sesm_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.size then
...
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= miax_sapphireoptions_complextopofmarket_mach_v1_0_a.packet_header.size
end
...
-- Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message = {}

-- Calculate size of: Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.size = function(buffer, offset)
  local index = 0
...
-- Display: Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.dissect = function(buffer, offset, packet, parent)
  if show.message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.fields.message, buffer(offset, 0))
    local index = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.fields(buffer, offset, packet, parent)
  end
end
...
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.udp_packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.message.dissect(buffer, index, packet, parent)
  end
