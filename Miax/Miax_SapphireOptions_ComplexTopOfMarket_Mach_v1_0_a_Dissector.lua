...
-- System Time Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message = {}

-- Size: System Time Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.size =
  miax_sapphireoptions_complextopofmarket_mach_v1_0_a.seconds.size

-- Display: System Time Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: System Time Message
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_sapphireoptions_complextopofmarket_mach_v1_0_a.fields.system_time_message, buffer(offset, 0))
    local index = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.fields(buffer, offset, packet, parent)
  end
end
...
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.data.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == "1" then
    return miax_sapphireoptions_complextopofmarket_mach_v1_0_a.system_time_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Simple Series Update Message
...
-- End Of Session
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.end_of_session = {}

-- Display: End Of Session
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.end_of_session.display(packet, parent, 0)
...
-- Start Of Session
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.start_of_session = {}

-- Display: Start Of Session
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.start_of_session.display = function(packet, parent, length)
  return "Start Of Session"
end


-- Dissect: Start Of Session
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.start_of_session.dissect = function(buffer, offset, packet, parent)
  local display = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.start_of_session.display(packet, parent, 0)
  packet.cols.info = display
...
-- Heartbeat
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.heartbeat = {}

-- Display: Heartbeat
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = miax_sapphireoptions_complextopofmarket_mach_v1_0_a.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
miax_sapphireoptions_complextopofmarket_mach_v1_0_a.payload.dissect = function(buffer, offset, packet, parent, packet_type)
  ...
  if packet_type == 0 then
    return miax_sapphireoptions_complextopofmarket_mach_v1_0_a.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Start Of Session
  if packet_type == 1 then
    return miax_sapphireoptions_complextopofmarket_mach_v1_0_a.start_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if packet_type == 2 then
    return miax_sapphireoptions_complextopofmarket_mach_v1_0_a.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Application Message
