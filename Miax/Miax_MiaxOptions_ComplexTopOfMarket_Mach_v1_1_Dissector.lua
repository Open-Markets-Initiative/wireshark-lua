...
local omi_miax_miaxoptions_complextopofmarket_mach_v1_1 = Proto("Omi.Miax.MiaxOptions.ComplexTopOfMarket.Mach.v1.1", "Miax MiaxOptions ComplexTopOfMarket Mach 1.1")
...
omi_miax_miaxoptions_complextopofmarket_mach_v1_1.fields.seconds = ProtoField.new("Seconds", "miax.miaxoptions.complextopofmarket.mach.v1.1.seconds", ftypes.UINT32)
...
-- Miax MiaxOptions ComplexTopOfMarket 1.1 Application Messages
...
-----------------------------------------------------------------------
-- Miax MiaxOptions ComplexTopOfMarket Mach 1.1 Formatting
-----------------------------------------------------------------------

-- Timestamp format (true = decimal-scaled, false = raw mantissa)
miax_miaxoptions_complextopofmarket_mach_v1_1.format_timestamp = true
...
omi_miax_miaxoptions_complextopofmarket_mach_v1_1.prefs.format_timestamp = Pref.bool("Format Timestamp", true, "Compose Timestamp with the stored seconds anchor (off = raw nanoseconds)")
...
function omi_miax_miaxoptions_complextopofmarket_mach_v1_1.prefs_changed()
  ...
  if miax_miaxoptions_complextopofmarket_mach_v1_1.format_timestamp ~= omi_miax_miaxoptions_complextopofmarket_mach_v1_1.prefs.format_timestamp then
    miax_miaxoptions_complextopofmarket_mach_v1_1.format_timestamp = omi_miax_miaxoptions_complextopofmarket_mach_v1_1.prefs.format_timestamp
  end
end
...
miax_miaxoptions_complextopofmarket_mach_v1_1.conversation = {}
miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.data = function(packet)
  local key = miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.key(packet)
  local data = miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.flows[key]
  if data == nil then
    data = { seconds = { last = nil, frames = {} } }
    miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.flows[key] = data
  end
  return data
end
...
miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.current = nil
...
-- Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds = {}

-- Size: Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.size = 4

-- Display: Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.display = function(value)
  return "Nanoseconds: "..value
end

-- Dissect: Nanoseconds
miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.dissect = function(buffer, offset, packet, parent)
  local length = miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_1.fields.nanoseconds, range, value, display)
...
-- Seconds
miax_miaxoptions_complextopofmarket_mach_v1_1.seconds = {}

-- Size: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.size = 4

-- Store: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.current = nil

-- Generated: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.generated = function(value, range, packet, parent)
  local display = miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.display(value)
  local seconds = parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_1.fields.seconds, range, value, display)
  seconds:set_generated()
end

-- Display: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.display = function(value)
  -- Parse unix seconds timestamp
  return "Seconds: "..os.date("%Y-%m-%d %H:%M:%S.", value)
end

-- Dissect: Seconds
miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.dissect = function(buffer, offset, packet, parent)
  local length = miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.display(value, buffer, offset, packet, parent)

  parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_1.fields.seconds, range, value, display)
...
-- Translate: Timestamp
miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.translate = function(nanoseconds, stored_seconds)
  return UInt64.new(stored_seconds * 1000000000 + nanoseconds)
end

-- Display: Timestamp
miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.display = function(nanoseconds, stored_seconds)
  return "Timestamp: "..os.date("%Y-%m-%d %H:%M:%S.", stored_seconds)..string.format("%09d", nanoseconds)
end

-- Composite: Timestamp
miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.composite = function(buffer, offset, stored_seconds, packet, parent)
  local length = miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.size
  local range = buffer(offset, length)
  local nanoseconds = range:le_uint()
  local value = miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.translate(nanoseconds, stored_seconds)
  local display = miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.display(nanoseconds, stored_seconds, packet)
  parent = parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_1.fields.timestamp, range, value, display)

  miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.generated(stored_seconds, range, packet, parent)

  display = miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.display(nanoseconds)
  parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_1.fields.nanoseconds, range, nanoseconds, display)
...
miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.dissect = function(buffer, offset, packet, parent)
  if miax_miaxoptions_complextopofmarket_mach_v1_1.format_timestamp then
    local stored_seconds = miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.current

    if stored_seconds ~= nil then
      return miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.composite(buffer, offset, stored_seconds, packet, parent)
    end
  end

  return miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.dissect(buffer, offset, packet, parent)
end
...
miax_miaxoptions_complextopofmarket_mach_v1_1.underlying_trading_status_message.size =
  miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.size + 
...
miax_miaxoptions_complextopofmarket_mach_v1_1.underlying_trading_status_message.fields = function(buffer, offset, packet, parent)
  ...
  index, nanoseconds = miax_miaxoptions_complextopofmarket_mach_v1_1.timestamp.dissect(buffer, index, packet, parent)
...
miax_miaxoptions_complextopofmarket_mach_v1_1.complex_strategy_definition_message.size = function(buffer, offset)
  ...
  index = index + miax_miaxoptions_complextopofmarket_mach_v1_1.nanoseconds.size
...
miax_miaxoptions_complextopofmarket_mach_v1_1.complex_strategy_definition_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_miax_miaxoptions_complextopofmarket_mach_v1_1.fields.complex_strategy_definition_message, buffer(offset, 0))
    local index = miax_miaxoptions_complextopofmarket_mach_v1_1.complex_strategy_definition_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = miax_miaxoptions_complextopofmarket_mach_v1_1.complex_strategy_definition_message.display(packet, parent, length)
    parent:append_text(display)
...
miax_miaxoptions_complextopofmarket_mach_v1_1.system_time_message.size =
  miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.size
...
miax_miaxoptions_complextopofmarket_mach_v1_1.system_time_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Seconds: SecTime
  index, seconds = miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.dissect(buffer, index, packet, parent)

  -- Store Seconds Value
  miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.current = seconds

  if not packet.visited then
    miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.current.seconds.last = seconds
  end
...
miax_miaxoptions_complextopofmarket_mach_v1_1.application_message.dissect = function(buffer, offset, packet, parent, size_of_application_message)
...
-- Mach Message
miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message = {}

-- Calculate size of: Mach Message
miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message.size = function(buffer, offset)
  local index = 0
...
miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mach Message
miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message.fields(buffer, offset, packet, parent)
  end
end
...
miax_miaxoptions_complextopofmarket_mach_v1_1.packet.requiredsize = function(buffer)
  return buffer:len() >= miax_miaxoptions_complextopofmarket_mach_v1_1.sequence_number.size + miax_miaxoptions_complextopofmarket_mach_v1_1.packet_length.size + miax_miaxoptions_complextopofmarket_mach_v1_1.packet_type.size + miax_miaxoptions_complextopofmarket_mach_v1_1.session_number.size
end

-- Dissect Packet
miax_miaxoptions_complextopofmarket_mach_v1_1.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.data(packet)
  if not packet.visited then
    data.seconds.frames[packet.number] = data.seconds.last
  end
  miax_miaxoptions_complextopofmarket_mach_v1_1.seconds.current = data.seconds.frames[packet.number]
  miax_miaxoptions_complextopofmarket_mach_v1_1.conversation.current = data
  ...
  while index < end_of_payload do
    ...
    index, mach_message = miax_miaxoptions_complextopofmarket_mach_v1_1.mach_message.dissect(buffer, index, packet, parent)
  end
...
-- Dissector Heuristic for Miax MiaxOptions ComplexTopOfMarket Mach 1.1 (Udp)
local function omi_miax_miaxoptions_complextopofmarket_mach_v1_1_udp_heuristic(buffer, packet, parent)
