...
local omi_currenex_currenexforex_orderservice_cbp_v26_0 = Proto("Omi.Currenex.CurrenexForex.OrderService.Cbp.v26.0", "Currenex CurrenexForex OrderService Cbp 26.0")
...
-- Currenex CurrenexForex OrderService 26.0 Application Messages
...
omi_currenex_currenexforex_orderservice_cbp_v26_0.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
function omi_currenex_currenexforex_orderservice_cbp_v26_0.prefs_changed()
  ...
  if show.structs ~= omi_currenex_currenexforex_orderservice_cbp_v26_0.prefs.show_structs then
    show.structs = omi_currenex_currenexforex_orderservice_cbp_v26_0.prefs.show_structs
  end
end
...
-- Register Currenex CurrenexForex OrderService Cbp 26.0 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_currenex_currenexforex_orderservice_cbp_v26_0)
