...
local currenex_forex_now_cbp_v10_0 = Proto("Currenex.Forex.Now.Cbp.v10.0.Lua", "Currenex Forex Now Cbp 10.0")
...
currenex_forex_now_cbp_v10_0.fields.activity_indicator = ProtoField.new("Activity Indicator", "currenex.forex.now.cbp.v10.0.activityindicator", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.instrument_id = ProtoField.new("Instrument Id", "currenex.forex.now.cbp.v10.0.instrumentid", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.instrument_index = ProtoField.new("Instrument Index", "currenex.forex.now.cbp.v10.0.instrumentindex", ftypes.INT16)
currenex_forex_now_cbp_v10_0.fields.instrument_type = ProtoField.new("Instrument Type", "currenex.forex.now.cbp.v10.0.instrumenttype", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.itch_etx = ProtoField.new("Itch Etx", "currenex.forex.now.cbp.v10.0.itchetx", ftypes.INT8)
currenex_forex_now_cbp_v10_0.fields.itch_soh = ProtoField.new("Itch Soh", "currenex.forex.now.cbp.v10.0.itchsoh", ftypes.INT8)
currenex_forex_now_cbp_v10_0.fields.message_body = ProtoField.new("Message Body", "currenex.forex.now.cbp.v10.0.messagebody", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.message_header = ProtoField.new("Message Header", "currenex.forex.now.cbp.v10.0.messageheader", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.message_type = ProtoField.new("Message Type", "currenex.forex.now.cbp.v10.0.messagetype", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.packet = ProtoField.new("Packet", "currenex.forex.now.cbp.v10.0.packet", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.paid_given_indicator = ProtoField.new("Paid Given Indicator", "currenex.forex.now.cbp.v10.0.paidgivenindicator", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.password = ProtoField.new("Password", "currenex.forex.now.cbp.v10.0.password", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.price = ProtoField.new("Price", "currenex.forex.now.cbp.v10.0.price", ftypes.DOUBLE)
currenex_forex_now_cbp_v10_0.fields.rate = ProtoField.new("Rate", "currenex.forex.now.cbp.v10.0.rate", ftypes.DOUBLE)
currenex_forex_now_cbp_v10_0.fields.reason_alpha_3 = ProtoField.new("Reason Alpha 3", "currenex.forex.now.cbp.v10.0.reasonalpha3", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.reason_alpha_50 = ProtoField.new("Reason Alpha 50", "currenex.forex.now.cbp.v10.0.reasonalpha50", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.reject_msg_type = ProtoField.new("Reject Msg Type", "currenex.forex.now.cbp.v10.0.rejectmsgtype", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.sequence_number = ProtoField.new("Sequence Number", "currenex.forex.now.cbp.v10.0.sequencenumber", ftypes.UINT32)
currenex_forex_now_cbp_v10_0.fields.session_id = ProtoField.new("Session Id", "currenex.forex.now.cbp.v10.0.sessionid", ftypes.INT32)
currenex_forex_now_cbp_v10_0.fields.settlement_date = ProtoField.new("Settlement Date", "currenex.forex.now.cbp.v10.0.settlementdate", ftypes.INT64)
currenex_forex_now_cbp_v10_0.fields.size_indicator = ProtoField.new("Size Indicator", "currenex.forex.now.cbp.v10.0.sizeindicator", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.subscribe_to_now_depth_of_book = ProtoField.new("Subscribe To Now Depth Of Book", "currenex.forex.now.cbp.v10.0.subscribetonowdepthofbook", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.subscribe_to_now_mid_activity_indicator = ProtoField.new("Subscribe To Now Mid Activity Indicator", "currenex.forex.now.cbp.v10.0.subscribetonowmidactivityindicator", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.subscribe_to_now_paid_given_with_bucketed_size = ProtoField.new("Subscribe To Now Paid Given With Bucketed Size", "currenex.forex.now.cbp.v10.0.subscribetonowpaidgivenwithbucketedsize", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.subscribe_to_nowwamr_with_confidence_factor = ProtoField.new("Subscribe To Nowwamr With Confidence Factor", "currenex.forex.now.cbp.v10.0.subscribetonowwamrwithconfidencefactor", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.subscription_type = ProtoField.new("Subscription Type", "currenex.forex.now.cbp.v10.0.subscriptiontype", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.timestamp = ProtoField.new("Timestamp", "currenex.forex.now.cbp.v10.0.timestamp", ftypes.INT64)
currenex_forex_now_cbp_v10_0.fields.transact_time = ProtoField.new("Transact Time", "currenex.forex.now.cbp.v10.0.transacttime", ftypes.INT64)
currenex_forex_now_cbp_v10_0.fields.type = ProtoField.new("Type", "currenex.forex.now.cbp.v10.0.type", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.user_id = ProtoField.new("User Id", "currenex.forex.now.cbp.v10.0.userid", ftypes.STRING)

-- Currenex Forex Now Cbp 10.0 messages
currenex_forex_now_cbp_v10_0.fields.depth_of_book_message = ProtoField.new("Depth Of Book Message", "currenex.forex.now.cbp.v10.0.depthofbookmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.heart_beat_message = ProtoField.new("Heart Beat Message", "currenex.forex.now.cbp.v10.0.heartbeatmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.instrument_info = ProtoField.new("Instrument Info", "currenex.forex.now.cbp.v10.0.instrumentinfo", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.instrument_info_ack_message = ProtoField.new("Instrument Info Ack Message", "currenex.forex.now.cbp.v10.0.instrumentinfoackmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.logon_message = ProtoField.new("Logon Message", "currenex.forex.now.cbp.v10.0.logonmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.logout_message = ProtoField.new("Logout Message", "currenex.forex.now.cbp.v10.0.logoutmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.mass_subscription_reply_message = ProtoField.new("Mass Subscription Reply Message", "currenex.forex.now.cbp.v10.0.masssubscriptionreplymessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.mass_subscription_request_message = ProtoField.new("Mass Subscription Request Message", "currenex.forex.now.cbp.v10.0.masssubscriptionrequestmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.mid_activity_indicator_message = ProtoField.new("Mid Activity Indicator Message", "currenex.forex.now.cbp.v10.0.midactivityindicatormessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.paid_given_message = ProtoField.new("Paid Given Message", "currenex.forex.now.cbp.v10.0.paidgivenmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.reject_message = ProtoField.new("Reject Message", "currenex.forex.now.cbp.v10.0.rejectmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.subscription_reply_message = ProtoField.new("Subscription Reply Message", "currenex.forex.now.cbp.v10.0.subscriptionreplymessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.subscription_request_message = ProtoField.new("Subscription Request Message", "currenex.forex.now.cbp.v10.0.subscriptionrequestmessage", ftypes.STRING)
currenex_forex_now_cbp_v10_0.fields.wamr_with_confidence_factor_message = ProtoField.new("Wamr With Confidence Factor Message", "currenex.forex.now.cbp.v10.0.wamrwithconfidencefactormessage", ftypes.STRING)

-- Currenex Forex Now Cbp 10.0 generated fields
currenex_forex_now_cbp_v10_0.fields.level_index = ProtoField.new("Level Index", "currenex.forex.now.cbp.v10.0.levelindex", ftypes.UINT16)
...
currenex_forex_now_cbp_v10_0.prefs.show_depth_of_book_message = Pref.bool("Show Depth Of Book Message", show.depth_of_book_message, "Parse and add Depth Of Book Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_heart_beat_message = Pref.bool("Show Heart Beat Message", show.heart_beat_message, "Parse and add Heart Beat Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_instrument_info = Pref.bool("Show Instrument Info", show.instrument_info, "Parse and add Instrument Info to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_instrument_info_ack_message = Pref.bool("Show Instrument Info Ack Message", show.instrument_info_ack_message, "Parse and add Instrument Info Ack Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_logon_message = Pref.bool("Show Logon Message", show.logon_message, "Parse and add Logon Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_logout_message = Pref.bool("Show Logout Message", show.logout_message, "Parse and add Logout Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_mass_subscription_reply_message = Pref.bool("Show Mass Subscription Reply Message", show.mass_subscription_reply_message, "Parse and add Mass Subscription Reply Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_mass_subscription_request_message = Pref.bool("Show Mass Subscription Request Message", show.mass_subscription_request_message, "Parse and add Mass Subscription Request Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_mid_activity_indicator_message = Pref.bool("Show Mid Activity Indicator Message", show.mid_activity_indicator_message, "Parse and add Mid Activity Indicator Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_paid_given_message = Pref.bool("Show Paid Given Message", show.paid_given_message, "Parse and add Paid Given Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_reject_message = Pref.bool("Show Reject Message", show.reject_message, "Parse and add Reject Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_subscription_reply_message = Pref.bool("Show Subscription Reply Message", show.subscription_reply_message, "Parse and add Subscription Reply Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_subscription_request_message = Pref.bool("Show Subscription Request Message", show.subscription_request_message, "Parse and add Subscription Request Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_wamr_with_confidence_factor_message = Pref.bool("Show Wamr With Confidence Factor Message", show.wamr_with_confidence_factor_message, "Parse and add Wamr With Confidence Factor Message to protocol tree")
currenex_forex_now_cbp_v10_0.prefs.show_message_body = Pref.bool("Show Message Body", show.message_body, "Parse and add Message Body to protocol tree")

-- Handle changed preferences
function currenex_forex_now_cbp_v10_0.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.depth_of_book_message ~= currenex_forex_now_cbp_v10_0.prefs.show_depth_of_book_message then
    show.depth_of_book_message = currenex_forex_now_cbp_v10_0.prefs.show_depth_of_book_message
    changed = true
  end
  if show.heart_beat_message ~= currenex_forex_now_cbp_v10_0.prefs.show_heart_beat_message then
    show.heart_beat_message = currenex_forex_now_cbp_v10_0.prefs.show_heart_beat_message
    changed = true
  end
  if show.instrument_info ~= currenex_forex_now_cbp_v10_0.prefs.show_instrument_info then
    show.instrument_info = currenex_forex_now_cbp_v10_0.prefs.show_instrument_info
    changed = true
  end
  if show.instrument_info_ack_message ~= currenex_forex_now_cbp_v10_0.prefs.show_instrument_info_ack_message then
    show.instrument_info_ack_message = currenex_forex_now_cbp_v10_0.prefs.show_instrument_info_ack_message
    changed = true
  end
  if show.logon_message ~= currenex_forex_now_cbp_v10_0.prefs.show_logon_message then
    show.logon_message = currenex_forex_now_cbp_v10_0.prefs.show_logon_message
    changed = true
  end
  if show.logout_message ~= currenex_forex_now_cbp_v10_0.prefs.show_logout_message then
    show.logout_message = currenex_forex_now_cbp_v10_0.prefs.show_logout_message
    changed = true
  end
  if show.mass_subscription_reply_message ~= currenex_forex_now_cbp_v10_0.prefs.show_mass_subscription_reply_message then
    show.mass_subscription_reply_message = currenex_forex_now_cbp_v10_0.prefs.show_mass_subscription_reply_message
    changed = true
  end
  if show.mass_subscription_request_message ~= currenex_forex_now_cbp_v10_0.prefs.show_mass_subscription_request_message then
    show.mass_subscription_request_message = currenex_forex_now_cbp_v10_0.prefs.show_mass_subscription_request_message
    changed = true
  end
  if show.message_header ~= currenex_forex_now_cbp_v10_0.prefs.show_message_header then
    show.message_header = currenex_forex_now_cbp_v10_0.prefs.show_message_header
    changed = true
  end
  if show.mid_activity_indicator_message ~= currenex_forex_now_cbp_v10_0.prefs.show_mid_activity_indicator_message then
    show.mid_activity_indicator_message = currenex_forex_now_cbp_v10_0.prefs.show_mid_activity_indicator_message
    changed = true
  end
  if show.packet ~= currenex_forex_now_cbp_v10_0.prefs.show_packet then
    show.packet = currenex_forex_now_cbp_v10_0.prefs.show_packet
    changed = true
  end
  if show.paid_given_message ~= currenex_forex_now_cbp_v10_0.prefs.show_paid_given_message then
    show.paid_given_message = currenex_forex_now_cbp_v10_0.prefs.show_paid_given_message
    changed = true
  end
  if show.reject_message ~= currenex_forex_now_cbp_v10_0.prefs.show_reject_message then
    show.reject_message = currenex_forex_now_cbp_v10_0.prefs.show_reject_message
    changed = true
  end
  if show.subscription_reply_message ~= currenex_forex_now_cbp_v10_0.prefs.show_subscription_reply_message then
    show.subscription_reply_message = currenex_forex_now_cbp_v10_0.prefs.show_subscription_reply_message
    changed = true
  end
  if show.subscription_request_message ~= currenex_forex_now_cbp_v10_0.prefs.show_subscription_request_message then
    show.subscription_request_message = currenex_forex_now_cbp_v10_0.prefs.show_subscription_request_message
    changed = true
  end
  if show.wamr_with_confidence_factor_message ~= currenex_forex_now_cbp_v10_0.prefs.show_wamr_with_confidence_factor_message then
    show.wamr_with_confidence_factor_message = currenex_forex_now_cbp_v10_0.prefs.show_wamr_with_confidence_factor_message
    changed = true
  end
  if show.message_body ~= currenex_forex_now_cbp_v10_0.prefs.show_message_body then
    show.message_body = currenex_forex_now_cbp_v10_0.prefs.show_message_body
    changed = true
  end
...
currenex_forex_now_cbp_v10_0_dissect.itch_etx = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.itch_etx, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.reason_alpha_50 = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.reason_alpha_50, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.reject_msg_type = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.reject_msg_type, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.session_id, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.activity_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.activity_indicator, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.instrument_index = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.instrument_index, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.timestamp, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.price, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.transact_time = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.transact_time, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.paid_given_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.paid_given_indicator, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.size_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.size_indicator, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.rate = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.rate, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.type = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.type, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.subscribe_to_now_mid_activity_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.subscribe_to_now_mid_activity_indicator, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.subscribe_to_nowwamr_with_confidence_factor = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.subscribe_to_nowwamr_with_confidence_factor, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.subscribe_to_now_paid_given_with_bucketed_size = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.subscribe_to_now_paid_given_with_bucketed_size, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.subscribe_to_now_depth_of_book = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.subscribe_to_now_depth_of_book, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.subscription_type = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.subscription_type, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.settlement_date = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.settlement_date, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.instrument_id = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.instrument_id, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.instrument_type = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.instrument_type, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.reason_alpha_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.reason_alpha_3, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.user_id = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.user_id, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.password = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.password, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.message_body = function(buffer, offset, packet, parent, message_type)
  ...
  local element = parent:add(currenex_forex_now_cbp_v10_0.fields.message_body, range, display)
...
currenex_forex_now_cbp_v10_0_dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.message_type, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.sequence_number, range, value, display)
...
currenex_forex_now_cbp_v10_0_dissect.itch_soh = function(buffer, offset, packet, parent)
  ...
  parent:add(currenex_forex_now_cbp_v10_0.fields.itch_soh, range, value, display)
...
function currenex_forex_now_cbp_v10_0.init()
end

-- Dissector for Currenex Forex Now Cbp 10.0
function currenex_forex_now_cbp_v10_0.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = currenex_forex_now_cbp_v10_0.name

  -- Dissect protocol
  local protocol = parent:add(currenex_forex_now_cbp_v10_0, buffer(), currenex_forex_now_cbp_v10_0.description, "("..buffer:len().." Bytes)")
  return currenex_forex_now_cbp_v10_0_dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, currenex_forex_now_cbp_v10_0)
...
verify.currenex_forex_now_cbp_v10_0_packet_size = function(buffer)
...
local function currenex_forex_now_cbp_v10_0_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.currenex_forex_now_cbp_v10_0_packet_size(buffer) then return false end

  -- Verify Itch Soh
  if not verify.itch_soh(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = currenex_forex_now_cbp_v10_0
  currenex_forex_now_cbp_v10_0.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Currenex Forex Now Cbp 10.0
currenex_forex_now_cbp_v10_0:register_heuristic("udp", currenex_forex_now_cbp_v10_0_heuristic)
