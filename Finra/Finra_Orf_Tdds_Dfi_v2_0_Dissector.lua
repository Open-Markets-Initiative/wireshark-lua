...
-- Finra Orf Dfi Tdds 2.0 Application Messages
...
finra_orf_tdds_dfi_v2_0.control_payload.size = function(buffer, offset, control_message_type)
  ...
  if control_message_type == "I" then
    return finra_orf_tdds_dfi_v2_0.start_of_day_message.size
  end
  -- Size of End Of Day Message
  if control_message_type == "J" then
    return finra_orf_tdds_dfi_v2_0.end_of_day_message.size
  end
  -- Size of Market Session Open Message
  if control_message_type == "O" then
    return finra_orf_tdds_dfi_v2_0.market_session_open_message.size
  end
  -- Size of Market Session Close Message
  if control_message_type == "O" then
    return finra_orf_tdds_dfi_v2_0.market_session_close_message.size
  end
  -- Size of End Of Retransmission Requests Message
  if control_message_type == "K" then
    return finra_orf_tdds_dfi_v2_0.end_of_retransmission_requests_message.size
  end
  -- Size of End Of Transmissions Message
  if control_message_type == "Z" then
    return finra_orf_tdds_dfi_v2_0.end_of_transmissions_message.size
  end
  -- Size of Line Integrity Message
  if control_message_type == "T" then
    return finra_orf_tdds_dfi_v2_0.line_integrity_message.size
  end
  -- Size of Sequence Number Reset Message
  if control_message_type == "L" then
    return finra_orf_tdds_dfi_v2_0.sequence_number_reset_message.size
  end
  -- Size of End Of Trade Reporting Message
  if control_message_type == "X" then
    return finra_orf_tdds_dfi_v2_0.end_of_trade_reporting_message.size
  end
...
finra_orf_tdds_dfi_v2_0.administrative_payload.size = function(buffer, offset, administrative_message_type)
  ...
  if administrative_message_type == "A" then
    return finra_orf_tdds_dfi_v2_0.general_administrative_message.size
  end
  -- Size of Closing Trade Summary Report Message
  if administrative_message_type == "2" then
    return finra_orf_tdds_dfi_v2_0.closing_trade_summary_report_message.size
  end
  -- Size of Trading Action Message
  if administrative_message_type == "H" then
    return finra_orf_tdds_dfi_v2_0.trading_action_message.size
  end
  -- Size of Market Wide Circuit Breaker Event Message
  if administrative_message_type == "M" then
    return finra_orf_tdds_dfi_v2_0.market_wide_circuit_breaker_event_message.size
  end
...
finra_orf_tdds_dfi_v2_0.trade_payload.size = function(buffer, offset, trade_message_type)
  ...
  if trade_message_type == "5" then
    return finra_orf_tdds_dfi_v2_0.trade_report_short_form_message.size
  end
  -- Size of Trade Report Long Form Message
  if trade_message_type == "6" then
    return finra_orf_tdds_dfi_v2_0.trade_report_long_form_message.size
  end
  -- Size of Trade Cancel Error Message
  if trade_message_type == "7" then
    return finra_orf_tdds_dfi_v2_0.trade_cancel_error_message.size
  end
  -- Size of Trade Correction Message
  if trade_message_type == "8" then
    return finra_orf_tdds_dfi_v2_0.trade_correction_message.size
  end
