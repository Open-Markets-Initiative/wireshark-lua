...
local show = {}
local format = {}
local eurex_cash_eti_t7_v9_1_display = {}
local eurex_cash_eti_t7_v9_1_dissect = {}
local eurex_cash_eti_t7_v9_1_size_of = {}
local verify = {}
local translate = {}
...
eurex_cash_eti_t7_v9_1.fields.accrued_interes_amt = ProtoField.new("Accrued Interes Amt", "eurex.cash.eti.t7.v9.1.accruedinteresamt", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.alloc_qty = ProtoField.new("Alloc Qty", "eurex.cash.eti.t7.v9.1.allocqty", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.best_bid_px = ProtoField.new("Best Bid Px", "eurex.cash.eti.t7.v9.1.bestbidpx", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.best_bid_size = ProtoField.new("Best Bid Size", "eurex.cash.eti.t7.v9.1.bestbidsize", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.best_offer_px = ProtoField.new("Best Offer Px", "eurex.cash.eti.t7.v9.1.bestofferpx", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.best_offer_size = ProtoField.new("Best Offer Size", "eurex.cash.eti.t7.v9.1.bestoffersize", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.bid_px = ProtoField.new("Bid Px", "eurex.cash.eti.t7.v9.1.bidpx", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.bid_size = ProtoField.new("Bid Size", "eurex.cash.eti.t7.v9.1.bidsize", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.coupon_rate = ProtoField.new("Coupon Rate", "eurex.cash.eti.t7.v9.1.couponrate", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.cum_qty = ProtoField.new("Cum Qty", "eurex.cash.eti.t7.v9.1.cumqty", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.currency = ProtoField.new("Currency", "eurex.cash.eti.t7.v9.1.currency", ftypes.STRING)
eurex_cash_eti_t7_v9_1.fields.cxl_qty = ProtoField.new("Cxl Qty", "eurex.cash.eti.t7.v9.1.cxlqty", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.cxl_size = ProtoField.new("Cxl Size", "eurex.cash.eti.t7.v9.1.cxlsize", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.display_high_qty = ProtoField.new("Display High Qty", "eurex.cash.eti.t7.v9.1.displayhighqty", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.display_low_qty = ProtoField.new("Display Low Qty", "eurex.cash.eti.t7.v9.1.displaylowqty", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.display_qty = ProtoField.new("Display Qty", "eurex.cash.eti.t7.v9.1.displayqty", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.event_px = ProtoField.new("Event Px", "eurex.cash.eti.t7.v9.1.eventpx", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.fill_px = ProtoField.new("Fill Px", "eurex.cash.eti.t7.v9.1.fillpx", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.fill_qty = ProtoField.new("Fill Qty", "eurex.cash.eti.t7.v9.1.fillqty", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.imbalance_qty = ProtoField.new("Imbalance Qty", "eurex.cash.eti.t7.v9.1.imbalanceqty", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.last_px = ProtoField.new("Last Px", "eurex.cash.eti.t7.v9.1.lastpx", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.last_qty = ProtoField.new("Last Qty", "eurex.cash.eti.t7.v9.1.lastqty", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.leaves_qty = ProtoField.new("Leaves Qty", "eurex.cash.eti.t7.v9.1.leavesqty", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.message = ProtoField.new("Message", "eurex.cash.eti.t7.v9.1.message", ftypes.STRING)
...
eurex_cash_eti_t7_v9_1.fields.message_header = ProtoField.new("Message Header", "eurex.cash.eti.t7.v9.1.messageheader", ftypes.STRING)
...
eurex_cash_eti_t7_v9_1.fields.offer_px = ProtoField.new("Offer Px", "eurex.cash.eti.t7.v9.1.offerpx", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.offer_size = ProtoField.new("Offer Size", "eurex.cash.eti.t7.v9.1.offersize", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.order_qty = ProtoField.new("Order Qty", "eurex.cash.eti.t7.v9.1.orderqty", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.payload = ProtoField.new("Payload", "eurex.cash.eti.t7.v9.1.payload", ftypes.STRING)
eurex_cash_eti_t7_v9_1.fields.peg_offset_value_abs = ProtoField.new("Peg Offset Value Abs", "eurex.cash.eti.t7.v9.1.pegoffsetvalueabs", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.peg_offset_value_pct = ProtoField.new("Peg Offset Value Pct", "eurex.cash.eti.t7.v9.1.pegoffsetvaluepct", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.potential_exec_volume = ProtoField.new("Potential Exec Volume", "eurex.cash.eti.t7.v9.1.potentialexecvolume", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.price = ProtoField.new("Price", "eurex.cash.eti.t7.v9.1.price", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.quote_event_px = ProtoField.new("Quote Event Px", "eurex.cash.eti.t7.v9.1.quoteeventpx", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.quote_event_qty = ProtoField.new("Quote Event Qty", "eurex.cash.eti.t7.v9.1.quoteeventqty", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.settl_curr_amt = ProtoField.new("Settl Curr Amt", "eurex.cash.eti.t7.v9.1.settlcurramt", ftypes.DOUBLE)
eurex_cash_eti_t7_v9_1.fields.settl_curr_fx_rate = ProtoField.new("Settl Curr Fx Rate", "eurex.cash.eti.t7.v9.1.settlcurrfxrate", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.side_gross_trade_amt = ProtoField.new("Side Gross Trade Amt", "eurex.cash.eti.t7.v9.1.sidegrosstradeamt", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.stop_px = ProtoField.new("Stop Px", "eurex.cash.eti.t7.v9.1.stoppx", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.fields.volume_discovery_price = ProtoField.new("Volume Discovery Price", "eurex.cash.eti.t7.v9.1.volumediscoveryprice", ftypes.DOUBLE)
...
eurex_cash_eti_t7_v9_1.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
eurex_cash_eti_t7_v9_1.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
...
eurex_cash_eti_t7_v9_1.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")
...
function eurex_cash_eti_t7_v9_1.prefs_changed()
  ...
  if show.message ~= eurex_cash_eti_t7_v9_1.prefs.show_message then
    show.message = eurex_cash_eti_t7_v9_1.prefs.show_message
    changed = true
  end
  if show.message_header ~= eurex_cash_eti_t7_v9_1.prefs.show_message_header then
    show.message_header = eurex_cash_eti_t7_v9_1.prefs.show_message_header
    changed = true
  end
  ...
  if show.payload ~= eurex_cash_eti_t7_v9_1.prefs.show_payload then
    show.payload = eurex_cash_eti_t7_v9_1.prefs.show_payload
    changed = true
  end
...
-- Size: Pad 1
eurex_cash_eti_t7_v9_1_size_of.pad_1 = 1

-- Display: Pad 1
eurex_cash_eti_t7_v9_1_display.pad_1 = function(value)
  return "Pad 1: "..value
end

-- Dissect: Pad 1
eurex_cash_eti_t7_v9_1_dissect.pad_1 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.pad_1
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.pad_1(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.target_party_executing_trader = 6

-- Display: Target Party Executing Trader
eurex_cash_eti_t7_v9_1_display.target_party_executing_trader = function(value)
...
eurex_cash_eti_t7_v9_1_dissect.target_party_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.target_party_executing_trader
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.target_party_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.target_party_executing_firm = 5

-- Display: Target Party Executing Firm
eurex_cash_eti_t7_v9_1_display.target_party_executing_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.target_party_executing_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.target_party_executing_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.target_party_executing_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.target_party_id_executing_trader = 4

-- Display: Target Party Id Executing Trader
eurex_cash_eti_t7_v9_1_display.target_party_id_executing_trader = function(value)
  return "Target Party Id Executing Trader: "..value
end

-- Dissect: Target Party Id Executing Trader
eurex_cash_eti_t7_v9_1_dissect.target_party_id_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.target_party_id_executing_trader
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.target_party_id_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_target_parties_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.target_party_id_executing_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.target_party_executing_firm

  index = index + eurex_cash_eti_t7_v9_1_size_of.target_party_executing_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.pad_1

  return index
end

-- Display: Xetra En Light Target Parties Comp
eurex_cash_eti_t7_v9_1_display.xetra_en_light_target_parties_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Target Parties Comp
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_target_parties_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Target Party Id Executing Trader: 4 Byte Unsigned Fixed Width Integer
  index, target_party_id_executing_trader = eurex_cash_eti_t7_v9_1_dissect.target_party_id_executing_trader(buffer, index, packet, parent)

  -- Target Party Executing Firm: 5 Byte Ascii String Nullable
  index, target_party_executing_firm = eurex_cash_eti_t7_v9_1_dissect.target_party_executing_firm(buffer, index, packet, parent)

  -- Target Party Executing Trader: 6 Byte Ascii String Nullable
  index, target_party_executing_trader = eurex_cash_eti_t7_v9_1_dissect.target_party_executing_trader(buffer, index, packet, parent)

  -- Pad 1: 1 Byte
  index, pad_1 = eurex_cash_eti_t7_v9_1_dissect.pad_1(buffer, index, packet, parent)

  return index
end

-- Dissect: Xetra En Light Target Parties Comp
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_target_parties_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.xetra_en_light_target_parties_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_target_parties_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_target_parties_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_target_parties_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_target_parties_comp_fields(buffer, offset, packet, parent)
end

-- Size: Free Text 5
eurex_cash_eti_t7_v9_1_size_of.free_text_5 = 132

-- Display: Free Text 5
eurex_cash_eti_t7_v9_1_display.free_text_5 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Free Text 5
eurex_cash_eti_t7_v9_1_dissect.free_text_5 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.free_text_5
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.free_text_5(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_executing_trader = 6

-- Display: Party Executing Trader
eurex_cash_eti_t7_v9_1_display.party_executing_trader = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.party_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_executing_trader
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_executing_firm = 5

-- Display: Party Executing Firm
eurex_cash_eti_t7_v9_1_display.party_executing_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.party_executing_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_executing_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_executing_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_cancel_type = 1

-- Display: Quote Cancel Type
eurex_cash_eti_t7_v9_1_display.quote_cancel_type = function(value)
  if value == 4 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_cancel_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_cancel_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_cancel_type(value, buffer, offset, packet, parent)
...
-- Size: Side
eurex_cash_eti_t7_v9_1_size_of.side = 1

-- Display: Side
eurex_cash_eti_t7_v9_1_display.side = function(value)
  if value == 1 then
    return "Side: Buy (1)"
  end
  if value == 2 then
...
-- Dissect: Side
eurex_cash_eti_t7_v9_1_dissect.side = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.side
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.side(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.number_of_resp_disclosure_instruction = 1

-- Display: Number Of Resp Disclosure Instruction
eurex_cash_eti_t7_v9_1_display.number_of_resp_disclosure_instruction = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.number_of_resp_disclosure_instruction = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.number_of_resp_disclosure_instruction
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.number_of_resp_disclosure_instruction(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.no_target_party_i_ds = 1

-- Display: No Target Party I Ds
eurex_cash_eti_t7_v9_1_display.no_target_party_i_ds = function(value)
  return "No Target Party I Ds: "..value
end

-- Dissect: No Target Party I Ds
eurex_cash_eti_t7_v9_1_dissect.no_target_party_i_ds = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_target_party_i_ds
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_target_party_i_ds(value, buffer, offset, packet, parent)
...
-- Size: Settl Date
eurex_cash_eti_t7_v9_1_size_of.settl_date = 4

-- Display: Settl Date
eurex_cash_eti_t7_v9_1_display.settl_date = function(value)
  return "Settl Date: "..value
end

-- Dissect: Settl Date
eurex_cash_eti_t7_v9_1_dissect.settl_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.settl_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.settl_date(value, buffer, offset, packet, parent)
...
-- Size: Negotiation Id
eurex_cash_eti_t7_v9_1_size_of.negotiation_id = 4

-- Display: Negotiation Id
eurex_cash_eti_t7_v9_1_display.negotiation_id = function(value)
  return "Negotiation Id: "..value
end

-- Dissect: Negotiation Id
eurex_cash_eti_t7_v9_1_dissect.negotiation_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.negotiation_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.negotiation_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.market_segment_id = 4

-- Display: Market Segment Id
eurex_cash_eti_t7_v9_1_display.market_segment_id = function(value)
  return "Market Segment Id: "..value
end

-- Dissect: Market Segment Id
eurex_cash_eti_t7_v9_1_dissect.market_segment_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.market_segment_id
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = eurex_cash_eti_t7_v9_1_display.market_segment_id(value, buffer, offset, packet, parent)
...
-- Dissect: Order Qty
eurex_cash_eti_t7_v9_1_dissect.order_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_qty
  local range = buffer(offset, length)
...
-- Dissect: Offer Px
eurex_cash_eti_t7_v9_1_dissect.offer_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.offer_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Dissect: Bid Px
eurex_cash_eti_t7_v9_1_dissect.bid_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.bid_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Size: Sender Sub Id
eurex_cash_eti_t7_v9_1_size_of.sender_sub_id = 4

-- Display: Sender Sub Id
eurex_cash_eti_t7_v9_1_display.sender_sub_id = function(value)
  return "Sender Sub Id: "..value
end

-- Dissect: Sender Sub Id
eurex_cash_eti_t7_v9_1_dissect.sender_sub_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.sender_sub_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.sender_sub_id(value, buffer, offset, packet, parent)
...
-- Size: Msg Seq Num
eurex_cash_eti_t7_v9_1_size_of.msg_seq_num = 4

-- Display: Msg Seq Num
eurex_cash_eti_t7_v9_1_display.msg_seq_num = function(value)
  return "Msg Seq Num: "..value
end

-- Dissect: Msg Seq Num
eurex_cash_eti_t7_v9_1_dissect.msg_seq_num = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.msg_seq_num
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.msg_seq_num(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.request_header_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.msg_seq_num

  index = index + eurex_cash_eti_t7_v9_1_size_of.sender_sub_id

  return index
end

-- Display: Request Header Comp
eurex_cash_eti_t7_v9_1_display.request_header_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Request Header Comp
eurex_cash_eti_t7_v9_1_dissect.request_header_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Msg Seq Num: 4 Byte Unsigned Fixed Width Integer
  index, msg_seq_num = eurex_cash_eti_t7_v9_1_dissect.msg_seq_num(buffer, index, packet, parent)

  -- Sender Sub Id: 4 Byte Unsigned Fixed Width Integer
  index, sender_sub_id = eurex_cash_eti_t7_v9_1_dissect.sender_sub_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Request Header Comp
eurex_cash_eti_t7_v9_1_dissect.request_header_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.request_header_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.request_header_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.request_header_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.request_header_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.request_header_comp_fields(buffer, offset, packet, parent)
end

-- Size: Pad 2
eurex_cash_eti_t7_v9_1_size_of.pad_2 = 2

-- Display: Pad 2
eurex_cash_eti_t7_v9_1_display.pad_2 = function(value)
  return "Pad 2: "..value
end

-- Dissect: Pad 2
eurex_cash_eti_t7_v9_1_dissect.pad_2 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.pad_2
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.pad_2(value, buffer, offset, packet, parent)
...
-- Size: Network Msg Id
eurex_cash_eti_t7_v9_1_size_of.network_msg_id = 8

-- Display: Network Msg Id
eurex_cash_eti_t7_v9_1_display.network_msg_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.network_msg_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.network_msg_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.network_msg_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_update_negotiation_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_update_negotiation_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Update Negotiation Request
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_update_negotiation_request_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_update_negotiation_request)
  local index = offset

  -- Network Msg Id: 8 Byte Ascii String Nullable
  index, network_msg_id = eurex_cash_eti_t7_v9_1_dissect.network_msg_id(buffer, index, packet, parent)

  -- Pad 2: 2 Byte
  index, pad_2 = eurex_cash_eti_t7_v9_1_dissect.pad_2(buffer, index, packet, parent)
  ...
  index, market_segment_id = eurex_cash_eti_t7_v9_1_dissect.market_segment_id(buffer, index, packet, parent)

  -- Negotiation Id: 4 Byte Unsigned Fixed Width Integer
  index, negotiation_id = eurex_cash_eti_t7_v9_1_dissect.negotiation_id(buffer, index, packet, parent)

  -- Settl Date: 4 Byte Unsigned Fixed Width Integer
  index, settl_date = eurex_cash_eti_t7_v9_1_dissect.settl_date(buffer, index, packet, parent)

  -- No Target Party I Ds: 1 Byte Unsigned Fixed Width Integer
  index, no_target_party_i_ds = eurex_cash_eti_t7_v9_1_dissect.no_target_party_i_ds(buffer, index, packet, parent)

  -- Number Of Resp Disclosure Instruction: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, number_of_resp_disclosure_instruction = eurex_cash_eti_t7_v9_1_dissect.number_of_resp_disclosure_instruction(buffer, index, packet, parent)

  -- Side: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, side = eurex_cash_eti_t7_v9_1_dissect.side(buffer, index, packet, parent)

  -- Quote Cancel Type: 1 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, quote_cancel_type = eurex_cash_eti_t7_v9_1_dissect.quote_cancel_type(buffer, index, packet, parent)

  -- Party Executing Firm: 5 Byte Ascii String Nullable
  index, party_executing_firm = eurex_cash_eti_t7_v9_1_dissect.party_executing_firm(buffer, index, packet, parent)

  -- Party Executing Trader: 6 Byte Ascii String Nullable
  index, party_executing_trader = eurex_cash_eti_t7_v9_1_dissect.party_executing_trader(buffer, index, packet, parent)

  -- Free Text 5: 132 Byte Ascii String Nullable
  index, free_text_5 = eurex_cash_eti_t7_v9_1_dissect.free_text_5(buffer, index, packet, parent)
  ...
  for i = 1, no_target_party_i_ds do
    index = eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_target_parties_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_update_negotiation_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_update_negotiation_request = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_update_negotiation_request(buffer, offset)
  ...
  if show.xetra_en_light_update_negotiation_request then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_update_negotiation_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_update_negotiation_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_update_negotiation_request_fields(buffer, offset, packet, parent, size_of_xetra_en_light_update_negotiation_request)

  return offset + size_of_xetra_en_light_update_negotiation_request
end

-- Size: Pad 3
eurex_cash_eti_t7_v9_1_size_of.pad_3 = 3

-- Display: Pad 3
eurex_cash_eti_t7_v9_1_display.pad_3 = function(value)
  return "Pad 3: "..value
end

-- Dissect: Pad 3
eurex_cash_eti_t7_v9_1_dissect.pad_3 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.pad_3
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.pad_3(value, buffer, offset, packet, parent)
...
-- Size: Trad Ses Event
eurex_cash_eti_t7_v9_1_size_of.trad_ses_event = 1

-- Display: Trad Ses Event
eurex_cash_eti_t7_v9_1_display.trad_ses_event = function(value)
  if value == 101 then
...
eurex_cash_eti_t7_v9_1_dissect.trad_ses_event = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trad_ses_event
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trad_ses_event(value, buffer, offset, packet, parent)
...
-- Size: Trade Date
eurex_cash_eti_t7_v9_1_size_of.trade_date = 4

-- Display: Trade Date
eurex_cash_eti_t7_v9_1_display.trade_date = function(value)
  return "Trade Date: "..value
end

-- Dissect: Trade Date
eurex_cash_eti_t7_v9_1_dissect.trade_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_date(value, buffer, offset, packet, parent)
...
-- Size: Pad 7
eurex_cash_eti_t7_v9_1_size_of.pad_7 = 7

-- Display: Pad 7
eurex_cash_eti_t7_v9_1_display.pad_7 = function(value)
  return "Pad 7: "..value
end

-- Dissect: Pad 7
eurex_cash_eti_t7_v9_1_dissect.pad_7 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.pad_7
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.pad_7(value, buffer, offset, packet, parent)
...
-- Size: Last Fragment
eurex_cash_eti_t7_v9_1_size_of.last_fragment = 1

-- Display: Last Fragment
eurex_cash_eti_t7_v9_1_display.last_fragment = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.last_fragment = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.last_fragment
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.last_fragment(value, buffer, offset, packet, parent)
...
-- Size: Appl Id
eurex_cash_eti_t7_v9_1_size_of.appl_id = 1

-- Display: Appl Id
eurex_cash_eti_t7_v9_1_display.appl_id = function(value)
  if value == 1 then
...
-- Dissect: Appl Id
eurex_cash_eti_t7_v9_1_dissect.appl_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.appl_resend_flag = 1

-- Display: Appl Resend Flag
eurex_cash_eti_t7_v9_1_display.appl_resend_flag = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.appl_resend_flag = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_resend_flag
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_resend_flag(value, buffer, offset, packet, parent)
...
-- Size: Partition Id
eurex_cash_eti_t7_v9_1_size_of.partition_id = 2

-- Display: Partition Id
eurex_cash_eti_t7_v9_1_display.partition_id = function(value)
  return "Partition Id: "..value
end

-- Dissect: Partition Id
eurex_cash_eti_t7_v9_1_dissect.partition_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.partition_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.partition_id(value, buffer, offset, packet, parent)
...
-- Size: Appl Sub Id
eurex_cash_eti_t7_v9_1_size_of.appl_sub_id = 4

-- Display: Appl Sub Id
eurex_cash_eti_t7_v9_1_display.appl_sub_id = function(value)
  return "Appl Sub Id: "..value
end

-- Dissect: Appl Sub Id
eurex_cash_eti_t7_v9_1_dissect.appl_sub_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_sub_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_sub_id(value, buffer, offset, packet, parent)
...
-- Size: Appl Seq Num
eurex_cash_eti_t7_v9_1_size_of.appl_seq_num = 8

-- Display: Appl Seq Num
eurex_cash_eti_t7_v9_1_display.appl_seq_num = function(value)
  return "Appl Seq Num: "..value
end

-- Dissect: Appl Seq Num
eurex_cash_eti_t7_v9_1_dissect.appl_seq_num = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_seq_num
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.appl_seq_num(value, buffer, offset, packet, parent)
...
-- Size: Sending Time
eurex_cash_eti_t7_v9_1_size_of.sending_time = 8

-- Display: Sending Time
eurex_cash_eti_t7_v9_1_display.sending_time = function(value)
...
eurex_cash_eti_t7_v9_1_dissect.sending_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.sending_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.sending_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.rbc_header_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.sending_time

  index = index + eurex_cash_eti_t7_v9_1_size_of.appl_seq_num

  index = index + eurex_cash_eti_t7_v9_1_size_of.appl_sub_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.partition_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.appl_resend_flag

  index = index + eurex_cash_eti_t7_v9_1_size_of.appl_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.last_fragment

  index = index + eurex_cash_eti_t7_v9_1_size_of.pad_7

  return index
end

-- Display: Rbc Header Comp
eurex_cash_eti_t7_v9_1_display.rbc_header_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rbc Header Comp
eurex_cash_eti_t7_v9_1_dissect.rbc_header_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Sending Time: 8 Byte Unsigned Fixed Width Integer
  index, sending_time = eurex_cash_eti_t7_v9_1_dissect.sending_time(buffer, index, packet, parent)

  -- Appl Seq Num: 8 Byte Unsigned Fixed Width Integer
  index, appl_seq_num = eurex_cash_eti_t7_v9_1_dissect.appl_seq_num(buffer, index, packet, parent)

  -- Appl Sub Id: 4 Byte Unsigned Fixed Width Integer
  index, appl_sub_id = eurex_cash_eti_t7_v9_1_dissect.appl_sub_id(buffer, index, packet, parent)

  -- Partition Id: 2 Byte Unsigned Fixed Width Integer
  index, partition_id = eurex_cash_eti_t7_v9_1_dissect.partition_id(buffer, index, packet, parent)

  -- Appl Resend Flag: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, appl_resend_flag = eurex_cash_eti_t7_v9_1_dissect.appl_resend_flag(buffer, index, packet, parent)

  -- Appl Id: 1 Byte Unsigned Fixed Width Integer Enum with 11 values
  index, appl_id = eurex_cash_eti_t7_v9_1_dissect.appl_id(buffer, index, packet, parent)

  -- Last Fragment: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, last_fragment = eurex_cash_eti_t7_v9_1_dissect.last_fragment(buffer, index, packet, parent)

  -- Pad 7: 7 Byte
  index, pad_7 = eurex_cash_eti_t7_v9_1_dissect.pad_7(buffer, index, packet, parent)

  return index
end

-- Dissect: Rbc Header Comp
eurex_cash_eti_t7_v9_1_dissect.rbc_header_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.rbc_header_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.rbc_header_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.rbc_header_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.rbc_header_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.rbc_header_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Xetra En Light Status Broadcast
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_status_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_status_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Status Broadcast
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_status_broadcast_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_status_broadcast)
  local index = offset
  ...
  index, rbc_header_comp = eurex_cash_eti_t7_v9_1_dissect.rbc_header_comp(buffer, index, packet, parent)

  -- Trade Date: 4 Byte Unsigned Fixed Width Integer
  index, trade_date = eurex_cash_eti_t7_v9_1_dissect.trade_date(buffer, index, packet, parent)

  -- Trad Ses Event: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, trad_ses_event = eurex_cash_eti_t7_v9_1_dissect.trad_ses_event(buffer, index, packet, parent)

  -- Pad 3: 3 Byte
  index, pad_3 = eurex_cash_eti_t7_v9_1_dissect.pad_3(buffer, index, packet, parent)

  return index
end

-- Dissect: Xetra En Light Status Broadcast
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_status_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_status_broadcast = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_status_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.xetra_en_light_status_broadcast then
    local range = buffer(offset, size_of_xetra_en_light_status_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_status_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_status_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_status_broadcast_fields(buffer, offset, packet, parent, size_of_xetra_en_light_status_broadcast)

  return offset + size_of_xetra_en_light_status_broadcast
end

-- Size: Pad 4
eurex_cash_eti_t7_v9_1_size_of.pad_4 = 4

-- Display: Pad 4
eurex_cash_eti_t7_v9_1_display.pad_4 = function(value)
  return "Pad 4: "..value
end

-- Dissect: Pad 4
eurex_cash_eti_t7_v9_1_dissect.pad_4 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.pad_4
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.pad_4(value, buffer, offset, packet, parent)
...
-- Size: Quoting Status
eurex_cash_eti_t7_v9_1_size_of.quoting_status = 1

-- Display: Quoting Status
eurex_cash_eti_t7_v9_1_display.quoting_status = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.quoting_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quoting_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quoting_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quoting_status_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_quoting_status_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Quoting Status Request
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quoting_status_request_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_quoting_status_request)
  local index = offset
  ...
  index, quoting_status = eurex_cash_eti_t7_v9_1_dissect.quoting_status(buffer, index, packet, parent)
  ...
  -- Pad 4: 4 Byte
  index, pad_4 = eurex_cash_eti_t7_v9_1_dissect.pad_4(buffer, index, packet, parent)

  return index
end

-- Dissect: Xetra En Light Quoting Status Request
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quoting_status_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_quoting_status_request = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quoting_status_request(buffer, offset)
  ...
  if show.xetra_en_light_quoting_status_request then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_quoting_status_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_quoting_status_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quoting_status_request_fields(buffer, offset, packet, parent, size_of_xetra_en_light_quoting_status_request)

  return offset + size_of_xetra_en_light_quoting_status_request
end

-- Size: Quote Req Id
eurex_cash_eti_t7_v9_1_size_of.quote_req_id = 20

-- Display: Quote Req Id
eurex_cash_eti_t7_v9_1_display.quote_req_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.quote_req_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_req_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.quote_req_id(value, buffer, offset, packet, parent)
...
-- Size: Quote Id
eurex_cash_eti_t7_v9_1_size_of.quote_id = 8

-- Display: Quote Id
eurex_cash_eti_t7_v9_1_display.quote_id = function(value)
  return "Quote Id: "..value
end

-- Dissect: Quote Id
eurex_cash_eti_t7_v9_1_dissect.quote_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.quote_id(value, buffer, offset, packet, parent)
...
-- Size: Request Time
eurex_cash_eti_t7_v9_1_size_of.request_time = 8

-- Display: Request Time
eurex_cash_eti_t7_v9_1_display.request_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.request_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.request_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.request_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.response_header_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.request_time

  index = index + eurex_cash_eti_t7_v9_1_size_of.sending_time

  index = index + eurex_cash_eti_t7_v9_1_size_of.msg_seq_num

  index = index + eurex_cash_eti_t7_v9_1_size_of.pad_4

  return index
end

-- Display: Response Header Comp
eurex_cash_eti_t7_v9_1_display.response_header_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Response Header Comp
eurex_cash_eti_t7_v9_1_dissect.response_header_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Request Time: 8 Byte Unsigned Fixed Width Integer
  index, request_time = eurex_cash_eti_t7_v9_1_dissect.request_time(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.response_header_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.response_header_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.response_header_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.response_header_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.response_header_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.response_header_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Xetra En Light Quote Response
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_quote_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Quote Response
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_response_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_quote_response)
  local index = offset
  ...
  index, response_header_comp = eurex_cash_eti_t7_v9_1_dissect.response_header_comp(buffer, index, packet, parent)
  ...
  index, quote_req_id = eurex_cash_eti_t7_v9_1_dissect.quote_req_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Xetra En Light Quote Response
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_quote_response = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.xetra_en_light_quote_response then
    local range = buffer(offset, size_of_xetra_en_light_quote_response)
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_quote_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_quote_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_response_fields(buffer, offset, packet, parent, size_of_xetra_en_light_quote_response)

  return offset + size_of_xetra_en_light_quote_response
end

-- Size: Party Entering Trader
eurex_cash_eti_t7_v9_1_size_of.party_entering_trader = 6

-- Display: Party Entering Trader
eurex_cash_eti_t7_v9_1_display.party_entering_trader = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.party_entering_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_entering_trader
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_entering_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_executing_trader = 4

-- Display: Party Id Executing Trader
eurex_cash_eti_t7_v9_1_display.party_id_executing_trader = function(value)
  return "Party Id Executing Trader: "..value
end

-- Dissect: Party Id Executing Trader
eurex_cash_eti_t7_v9_1_dissect.party_id_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_executing_trader
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_executing_trader(value, buffer, offset, packet, parent)
...
-- Dissect: Offer Size
eurex_cash_eti_t7_v9_1_dissect.offer_size = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.offer_size
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Dissect: Bid Size
eurex_cash_eti_t7_v9_1_dissect.bid_size = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.bid_size
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.secondary_quote_id = 8

-- Display: Secondary Quote Id
eurex_cash_eti_t7_v9_1_display.secondary_quote_id = function(value)
  return "Secondary Quote Id: "..value
end

-- Dissect: Secondary Quote Id
eurex_cash_eti_t7_v9_1_dissect.secondary_quote_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.secondary_quote_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.secondary_quote_id(value, buffer, offset, packet, parent)
...
-- Size: Transact Time
eurex_cash_eti_t7_v9_1_size_of.transact_time = 8

-- Display: Transact Time
eurex_cash_eti_t7_v9_1_display.transact_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.transact_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.transact_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.transact_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.srqs_quote_entry_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.transact_time

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.secondary_quote_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.bid_px

  index = index + eurex_cash_eti_t7_v9_1_size_of.bid_size

  index = index + eurex_cash_eti_t7_v9_1_size_of.offer_px

  index = index + eurex_cash_eti_t7_v9_1_size_of.offer_size

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_id_executing_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.quoting_status

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_executing_firm

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_executing_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_entering_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.pad_2

  return index
end

-- Display: Srqs Quote Entry Grp Comp
eurex_cash_eti_t7_v9_1_display.srqs_quote_entry_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Srqs Quote Entry Grp Comp
eurex_cash_eti_t7_v9_1_dissect.srqs_quote_entry_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, party_id_executing_trader = eurex_cash_eti_t7_v9_1_dissect.party_id_executing_trader(buffer, index, packet, parent)
  ...
  index, party_entering_trader = eurex_cash_eti_t7_v9_1_dissect.party_entering_trader(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.srqs_quote_entry_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.srqs_quote_entry_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.srqs_quote_entry_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.srqs_quote_entry_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.srqs_quote_entry_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.srqs_quote_entry_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Quote Entries
eurex_cash_eti_t7_v9_1_size_of.no_quote_entries = 1

-- Display: No Quote Entries
eurex_cash_eti_t7_v9_1_display.no_quote_entries = function(value)
  return "No Quote Entries: "..value
end

-- Dissect: No Quote Entries
eurex_cash_eti_t7_v9_1_dissect.no_quote_entries = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_quote_entries
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_quote_entries(value, buffer, offset, packet, parent)
...
-- Size: Trade Id
eurex_cash_eti_t7_v9_1_size_of.trade_id = 4

-- Display: Trade Id
eurex_cash_eti_t7_v9_1_display.trade_id = function(value)
  return "Trade Id: "..value
end

-- Dissect: Trade Id
eurex_cash_eti_t7_v9_1_dissect.trade_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_requester_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_quote_requester_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Quote Requester Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_requester_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_quote_requester_notification)
  local index = offset
  ...
  index, trade_id = eurex_cash_eti_t7_v9_1_dissect.trade_id(buffer, index, packet, parent)

  -- Quote Req Id: 20 Byte Ascii String Nullable
  index, quote_req_id = eurex_cash_eti_t7_v9_1_dissect.quote_req_id(buffer, index, packet, parent)

  -- No Quote Entries: 1 Byte Unsigned Fixed Width Integer
  index, no_quote_entries = eurex_cash_eti_t7_v9_1_dissect.no_quote_entries(buffer, index, packet, parent)
  ...
  for i = 1, no_quote_entries do
    index = eurex_cash_eti_t7_v9_1_dissect.srqs_quote_entry_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_requester_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_quote_requester_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_requester_notification(buffer, offset)
  ...
  if show.xetra_en_light_quote_requester_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_quote_requester_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_quote_requester_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_requester_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_quote_requester_notification)

  return offset + size_of_xetra_en_light_quote_requester_notification
end

-- Size: Free Text 4
eurex_cash_eti_t7_v9_1_size_of.free_text_4 = 16

-- Display: Free Text 4
eurex_cash_eti_t7_v9_1_display.free_text_4 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Free Text 4
eurex_cash_eti_t7_v9_1_dissect.free_text_4 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.free_text_4
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.free_text_4(value, buffer, offset, packet, parent)
...
-- Size: Free Text 2
eurex_cash_eti_t7_v9_1_size_of.free_text_2 = 12

-- Display: Free Text 2
eurex_cash_eti_t7_v9_1_display.free_text_2 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Free Text 2
eurex_cash_eti_t7_v9_1_dissect.free_text_2 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.free_text_2
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.free_text_2(value, buffer, offset, packet, parent)
...
-- Size: Free Text 1
eurex_cash_eti_t7_v9_1_size_of.free_text_1 = 12

-- Display: Free Text 1
eurex_cash_eti_t7_v9_1_display.free_text_1 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Free Text 1
eurex_cash_eti_t7_v9_1_dissect.free_text_1 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.free_text_1
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.free_text_1(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_event_reason = 1

-- Display: Quote Event Reason
eurex_cash_eti_t7_v9_1_display.quote_event_reason = function(value)
  if value == 14 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_event_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_event_reason(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trading_capacity = 1

-- Display: Trading Capacity
eurex_cash_eti_t7_v9_1_display.trading_capacity = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.trading_capacity = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trading_capacity
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trading_capacity(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_quote_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Quote Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_quote_notification)
  local index = offset
  ...
  index, trading_capacity = eurex_cash_eti_t7_v9_1_dissect.trading_capacity(buffer, index, packet, parent)

  -- Quoting Status: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, quoting_status = eurex_cash_eti_t7_v9_1_dissect.quoting_status(buffer, index, packet, parent)

  -- Quote Event Reason: 1 Byte Unsigned Fixed Width Integer Enum with 7 values
  index, quote_event_reason = eurex_cash_eti_t7_v9_1_dissect.quote_event_reason(buffer, index, packet, parent)
  ...
  index, free_text_1 = eurex_cash_eti_t7_v9_1_dissect.free_text_1(buffer, index, packet, parent)

  -- Free Text 2: 12 Byte Ascii String Nullable
  index, free_text_2 = eurex_cash_eti_t7_v9_1_dissect.free_text_2(buffer, index, packet, parent)

  -- Free Text 4: 16 Byte Ascii String Nullable
  index, free_text_4 = eurex_cash_eti_t7_v9_1_dissect.free_text_4(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_quote_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.xetra_en_light_quote_notification then
    local range = buffer(offset, size_of_xetra_en_light_quote_notification)
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_quote_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_quote_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_quote_notification)

  return offset + size_of_xetra_en_light_quote_notification
end

-- Size: Firm Negotiation Id
eurex_cash_eti_t7_v9_1_size_of.firm_negotiation_id = 20

-- Display: Firm Negotiation Id
eurex_cash_eti_t7_v9_1_display.firm_negotiation_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.firm_negotiation_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.firm_negotiation_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.firm_negotiation_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.respondent_type = 1

-- Display: Respondent Type
eurex_cash_eti_t7_v9_1_display.respondent_type = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.respondent_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.respondent_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.respondent_type(value, buffer, offset, packet, parent)
...
-- Size: Quote Status
eurex_cash_eti_t7_v9_1_size_of.quote_status = 1

-- Display: Quote Status
eurex_cash_eti_t7_v9_1_display.quote_status = function(value)
  if value == 6 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.number_of_respondents = 4

-- Display: Number Of Respondents
eurex_cash_eti_t7_v9_1_display.number_of_respondents = function(value)
  return "Number Of Respondents: "..value
end

-- Dissect: Number Of Respondents
eurex_cash_eti_t7_v9_1_dissect.number_of_respondents = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.number_of_respondents
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.number_of_respondents(value, buffer, offset, packet, parent)
...
-- Size: Expire Time
eurex_cash_eti_t7_v9_1_size_of.expire_time = 8

-- Display: Expire Time
eurex_cash_eti_t7_v9_1_display.expire_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
-- Dissect: Expire Time
eurex_cash_eti_t7_v9_1_dissect.expire_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.expire_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.expire_time(value, buffer, offset, packet, parent)
...
-- Dissect: Last Qty
eurex_cash_eti_t7_v9_1_dissect.last_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.last_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Dissect: Last Px
eurex_cash_eti_t7_v9_1_dissect.last_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.last_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Size: Security Id
eurex_cash_eti_t7_v9_1_size_of.security_id = 8

-- Display: Security Id
eurex_cash_eti_t7_v9_1_display.security_id = function(value)
  return "Security Id: "..value
end

-- Dissect: Security Id
eurex_cash_eti_t7_v9_1_dissect.security_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.security_id
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = eurex_cash_eti_t7_v9_1_display.security_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_requester_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_open_negotiation_requester_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Open Negotiation Requester Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_requester_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_open_negotiation_requester_notification)
  local index = offset
  ...
  index, expire_time = eurex_cash_eti_t7_v9_1_dissect.expire_time(buffer, index, packet, parent)
  ...
  index, number_of_respondents = eurex_cash_eti_t7_v9_1_dissect.number_of_respondents(buffer, index, packet, parent)

  -- Settl Date: 4 Byte Unsigned Fixed Width Integer
  index, settl_date = eurex_cash_eti_t7_v9_1_dissect.settl_date(buffer, index, packet, parent)

  -- Quote Status: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, quote_status = eurex_cash_eti_t7_v9_1_dissect.quote_status(buffer, index, packet, parent)
  ...
  index, respondent_type = eurex_cash_eti_t7_v9_1_dissect.respondent_type(buffer, index, packet, parent)
  ...
  index, firm_negotiation_id = eurex_cash_eti_t7_v9_1_dissect.firm_negotiation_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_requester_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_open_negotiation_requester_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_requester_notification(buffer, offset)
  ...
  if show.xetra_en_light_open_negotiation_requester_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_open_negotiation_requester_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_open_negotiation_requester_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_requester_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_open_negotiation_requester_notification)

  return offset + size_of_xetra_en_light_open_negotiation_requester_notification
end

-- Size: Value Check Type Quantity
eurex_cash_eti_t7_v9_1_size_of.value_check_type_quantity = 1

-- Display: Value Check Type Quantity
eurex_cash_eti_t7_v9_1_display.value_check_type_quantity = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.value_check_type_quantity = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.value_check_type_quantity
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.value_check_type_quantity(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.value_check_type_value = 1

-- Display: Value Check Type Value
eurex_cash_eti_t7_v9_1_display.value_check_type_value = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.value_check_type_value = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.value_check_type_value
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.value_check_type_value(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.valid_until_time = 8

-- Display: Valid Until Time
eurex_cash_eti_t7_v9_1_display.valid_until_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.valid_until_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.valid_until_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.valid_until_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_open_negotiation_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Open Negotiation Request
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_request_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_open_negotiation_request)
  local index = offset
  ...
  index, valid_until_time = eurex_cash_eti_t7_v9_1_dissect.valid_until_time(buffer, index, packet, parent)
  ...
  index, value_check_type_value = eurex_cash_eti_t7_v9_1_dissect.value_check_type_value(buffer, index, packet, parent)

  -- Value Check Type Quantity: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, value_check_type_quantity = eurex_cash_eti_t7_v9_1_dissect.value_check_type_quantity(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_open_negotiation_request = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_request(buffer, offset)
  ...
  if show.xetra_en_light_open_negotiation_request then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_open_negotiation_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_open_negotiation_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_request_fields(buffer, offset, packet, parent, size_of_xetra_en_light_open_negotiation_request)
...
-- Dissect: Leaves Qty
eurex_cash_eti_t7_v9_1_dissect.leaves_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.leaves_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.negotiation_start_time = 8

-- Display: Negotiation Start Time
eurex_cash_eti_t7_v9_1_display.negotiation_start_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.negotiation_start_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.negotiation_start_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.negotiation_start_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_open_negotiation_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Open Negotiation Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_open_negotiation_notification)
  local index = offset
  ...
  index, negotiation_start_time = eurex_cash_eti_t7_v9_1_dissect.negotiation_start_time(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_open_negotiation_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_notification(buffer, offset)
  ...
  if show.xetra_en_light_open_negotiation_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_open_negotiation_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_open_negotiation_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_open_negotiation_notification)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_status_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_negotiation_status_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Negotiation Status Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_status_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_negotiation_status_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_status_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_negotiation_status_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_status_notification(buffer, offset)
  ...
  if show.xetra_en_light_negotiation_status_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_negotiation_status_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_negotiation_status_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_status_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_negotiation_status_notification)

  return offset + size_of_xetra_en_light_negotiation_status_notification
end

-- Size: Trd Reg Ts Execution Time
eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_execution_time = 8

-- Display: Trd Reg Ts Execution Time
eurex_cash_eti_t7_v9_1_display.trd_reg_ts_execution_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_execution_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_execution_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.trd_reg_ts_execution_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_requester_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_negotiation_requester_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Negotiation Requester Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_requester_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_negotiation_requester_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_requester_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_negotiation_requester_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_requester_notification(buffer, offset)
  ...
  if show.xetra_en_light_negotiation_requester_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_negotiation_requester_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_negotiation_requester_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_requester_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_negotiation_requester_notification)

  return offset + size_of_xetra_en_light_negotiation_requester_notification
end

-- Size: Pad 6
eurex_cash_eti_t7_v9_1_size_of.pad_6 = 6

-- Display: Pad 6
eurex_cash_eti_t7_v9_1_display.pad_6 = function(value)
  return "Pad 6: "..value
end

-- Dissect: Pad 6
eurex_cash_eti_t7_v9_1_dissect.pad_6 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.pad_6
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.pad_6(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_negotiation_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Negotiation Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_negotiation_notification)
  local index = offset
  ...
  -- Pad 6: 6 Byte
  index, pad_6 = eurex_cash_eti_t7_v9_1_dissect.pad_6(buffer, index, packet, parent)

  return index
end

-- Dissect: Xetra En Light Negotiation Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_negotiation_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_notification(buffer, offset)
  ...
  if show.xetra_en_light_negotiation_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_negotiation_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_negotiation_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_negotiation_notification)

  return offset + size_of_xetra_en_light_negotiation_notification
end

-- Size: Firm Trade Id
eurex_cash_eti_t7_v9_1_size_of.firm_trade_id = 20

-- Display: Firm Trade Id
eurex_cash_eti_t7_v9_1_display.firm_trade_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.firm_trade_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.firm_trade_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.firm_trade_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.order_origination = 1

-- Display: Order Origination
eurex_cash_eti_t7_v9_1_display.order_origination = function(value)
  if value == 5 then
...
eurex_cash_eti_t7_v9_1_dissect.order_origination = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_origination
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.order_origination(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_investment_decision_maker_qualifier = 1

-- Display: Party Id Investment Decision Maker Qualifier
eurex_cash_eti_t7_v9_1_display.party_id_investment_decision_maker_qualifier = function(value)
  if value == 22 then
...
eurex_cash_eti_t7_v9_1_dissect.party_id_investment_decision_maker_qualifier = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_investment_decision_maker_qualifier
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_investment_decision_maker_qualifier(value, buffer, offset, packet, parent)
...
-- Size: Alloc Method
eurex_cash_eti_t7_v9_1_size_of.alloc_method = 1

-- Display: Alloc Method
eurex_cash_eti_t7_v9_1_display.alloc_method = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.alloc_method = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.alloc_method
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.alloc_method(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.executing_trader_qualifier = 1

-- Display: Executing Trader Qualifier
eurex_cash_eti_t7_v9_1_display.executing_trader_qualifier = function(value)
  if value == 22 then
...
eurex_cash_eti_t7_v9_1_dissect.executing_trader_qualifier = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.executing_trader_qualifier
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.executing_trader_qualifier(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.order_attribute_liquidity_provision = 1

-- Display: Order Attribute Liquidity Provision
eurex_cash_eti_t7_v9_1_display.order_attribute_liquidity_provision = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.order_attribute_liquidity_provision = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_attribute_liquidity_provision
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.order_attribute_liquidity_provision(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.executing_trader = 8

-- Display: Executing Trader
eurex_cash_eti_t7_v9_1_display.executing_trader = function(value)
  return "Executing Trader: "..value
end

-- Dissect: Executing Trader
eurex_cash_eti_t7_v9_1_dissect.executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.executing_trader
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_investment_decision_maker = 8

-- Display: Party Id Investment Decision Maker
eurex_cash_eti_t7_v9_1_display.party_id_investment_decision_maker = function(value)
  return "Party Id Investment Decision Maker: "..value
end

-- Dissect: Party Id Investment Decision Maker
eurex_cash_eti_t7_v9_1_dissect.party_id_investment_decision_maker = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_investment_decision_maker
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_investment_decision_maker(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_client_id = 8

-- Display: Party Id Client Id
eurex_cash_eti_t7_v9_1_display.party_id_client_id = function(value)
  return "Party Id Client Id: "..value
end

-- Dissect: Party Id Client Id
eurex_cash_eti_t7_v9_1_dissect.party_id_client_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_client_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_client_id(value, buffer, offset, packet, parent)
...
-- Dissect: Price
eurex_cash_eti_t7_v9_1_dissect.price = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.price
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_hit_quote_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_hit_quote_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Hit Quote Request
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_hit_quote_request_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_hit_quote_request)
  local index = offset
  ...
  index, party_id_client_id = eurex_cash_eti_t7_v9_1_dissect.party_id_client_id(buffer, index, packet, parent)

  -- Party Id Investment Decision Maker: 8 Byte Unsigned Fixed Width Integer
  index, party_id_investment_decision_maker = eurex_cash_eti_t7_v9_1_dissect.party_id_investment_decision_maker(buffer, index, packet, parent)
  ...
  index, order_attribute_liquidity_provision = eurex_cash_eti_t7_v9_1_dissect.order_attribute_liquidity_provision(buffer, index, packet, parent)

  -- Executing Trader Qualifier: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, executing_trader_qualifier = eurex_cash_eti_t7_v9_1_dissect.executing_trader_qualifier(buffer, index, packet, parent)

  -- Alloc Method: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, alloc_method = eurex_cash_eti_t7_v9_1_dissect.alloc_method(buffer, index, packet, parent)

  -- Party Id Investment Decision Maker Qualifier: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, party_id_investment_decision_maker_qualifier = eurex_cash_eti_t7_v9_1_dissect.party_id_investment_decision_maker_qualifier(buffer, index, packet, parent)

  -- Order Origination: 1 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, order_origination = eurex_cash_eti_t7_v9_1_dissect.order_origination(buffer, index, packet, parent)
  ...
  index, firm_trade_id = eurex_cash_eti_t7_v9_1_dissect.firm_trade_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_hit_quote_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_hit_quote_request = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_hit_quote_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.xetra_en_light_hit_quote_request then
    local range = buffer(offset, size_of_xetra_en_light_hit_quote_request)
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_hit_quote_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_hit_quote_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_hit_quote_request_fields(buffer, offset, packet, parent, size_of_xetra_en_light_hit_quote_request)

  return offset + size_of_xetra_en_light_hit_quote_request
end

-- Read runtime size of: Xetra En Light Enter Quote Request
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_enter_quote_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_enter_quote_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Enter Quote Request
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_enter_quote_request_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_enter_quote_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_enter_quote_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_enter_quote_request = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_enter_quote_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.xetra_en_light_enter_quote_request then
    local range = buffer(offset, size_of_xetra_en_light_enter_quote_request)
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_enter_quote_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_enter_quote_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_enter_quote_request_fields(buffer, offset, packet, parent, size_of_xetra_en_light_enter_quote_request)

  return offset + size_of_xetra_en_light_enter_quote_request
end

-- Size: Secondary Trade Id
eurex_cash_eti_t7_v9_1_size_of.secondary_trade_id = 4

-- Display: Secondary Trade Id
eurex_cash_eti_t7_v9_1_display.secondary_trade_id = function(value)
  return "Secondary Trade Id: "..value
end

-- Dissect: Secondary Trade Id
eurex_cash_eti_t7_v9_1_dissect.secondary_trade_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.secondary_trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.secondary_trade_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_deal_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_deal_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Deal Response
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_deal_response_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_deal_response)
  local index = offset
  ...
  index, secondary_trade_id = eurex_cash_eti_t7_v9_1_dissect.secondary_trade_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_deal_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_deal_response = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_deal_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.xetra_en_light_deal_response then
    local range = buffer(offset, size_of_xetra_en_light_deal_response)
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_deal_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_deal_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_deal_response_fields(buffer, offset, packet, parent, size_of_xetra_en_light_deal_response)

  return offset + size_of_xetra_en_light_deal_response
end

-- Size: Md Sub Book Type
eurex_cash_eti_t7_v9_1_size_of.md_sub_book_type = 1

-- Display: Md Sub Book Type
eurex_cash_eti_t7_v9_1_display.md_sub_book_type = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.md_sub_book_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.md_sub_book_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.md_sub_book_type(value, buffer, offset, packet, parent)
...
-- Size: Md Book Type
eurex_cash_eti_t7_v9_1_size_of.md_book_type = 1

-- Display: Md Book Type
eurex_cash_eti_t7_v9_1_display.md_book_type = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.md_book_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.md_book_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.md_book_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.best_offer_size = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.best_offer_size
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.best_offer_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.best_offer_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.best_bid_size = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.best_bid_size
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Dissect: Best Bid Px
eurex_cash_eti_t7_v9_1_dissect.best_bid_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.best_bid_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.order_book_item_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.best_bid_px

  index = index + eurex_cash_eti_t7_v9_1_size_of.best_bid_size

  index = index + eurex_cash_eti_t7_v9_1_size_of.best_offer_px

  index = index + eurex_cash_eti_t7_v9_1_size_of.best_offer_size

  index = index + eurex_cash_eti_t7_v9_1_size_of.md_book_type

  index = index + eurex_cash_eti_t7_v9_1_size_of.md_sub_book_type

  index = index + eurex_cash_eti_t7_v9_1_size_of.pad_6

  return index
end

-- Display: Order Book Item Grp Comp
eurex_cash_eti_t7_v9_1_display.order_book_item_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end
...
eurex_cash_eti_t7_v9_1_dissect.order_book_item_grp_comp_fields = function(buffer, offset, packet, parent)
  ...
  index, md_book_type = eurex_cash_eti_t7_v9_1_dissect.md_book_type(buffer, index, packet, parent)

  -- Md Sub Book Type: 1 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, md_sub_book_type = eurex_cash_eti_t7_v9_1_dissect.md_sub_book_type(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.order_book_item_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.order_book_item_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.order_book_item_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.order_book_item_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.order_book_item_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.order_book_item_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: Root Party Entering Trader
eurex_cash_eti_t7_v9_1_size_of.root_party_entering_trader = 6

-- Display: Root Party Entering Trader
eurex_cash_eti_t7_v9_1_display.root_party_entering_trader = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_entering_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_entering_trader
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_entering_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_executing_trader = 6

-- Display: Root Party Executing Trader
eurex_cash_eti_t7_v9_1_display.root_party_executing_trader = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_executing_trader
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_executing_firm = 5

-- Display: Root Party Executing Firm
eurex_cash_eti_t7_v9_1_display.root_party_executing_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_executing_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_executing_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_executing_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.no_order_book_items = 1

-- Display: No Order Book Items
eurex_cash_eti_t7_v9_1_display.no_order_book_items = function(value)
  return "No Order Book Items: "..value
end

-- Dissect: No Order Book Items
eurex_cash_eti_t7_v9_1_dissect.no_order_book_items = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_order_book_items
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_order_book_items(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.message_event_source = 1

-- Display: Message Event Source
eurex_cash_eti_t7_v9_1_display.message_event_source = function(value)
  -- Check if field has value
...
eurex_cash_eti_t7_v9_1_dissect.message_event_source = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.message_event_source
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.message_event_source(value, buffer, offset, packet, parent)
...
-- Size: Trd Rpt Status
eurex_cash_eti_t7_v9_1_size_of.trd_rpt_status = 1

-- Display: Trd Rpt Status
eurex_cash_eti_t7_v9_1_display.trd_rpt_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.trd_rpt_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_rpt_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trd_rpt_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_create_deal_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.xetra_en_light_create_deal_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Xetra En Light Create Deal Notification
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_create_deal_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_create_deal_notification)
  local index = offset
  ...
  index, trd_rpt_status = eurex_cash_eti_t7_v9_1_dissect.trd_rpt_status(buffer, index, packet, parent)

  -- Message Event Source: 1 Byte Ascii String Enum with 4 values
  index, message_event_source = eurex_cash_eti_t7_v9_1_dissect.message_event_source(buffer, index, packet, parent)
  ...
  index, no_order_book_items = eurex_cash_eti_t7_v9_1_dissect.no_order_book_items(buffer, index, packet, parent)
  ...
  index, root_party_executing_firm = eurex_cash_eti_t7_v9_1_dissect.root_party_executing_firm(buffer, index, packet, parent)

  -- Root Party Executing Trader: 6 Byte Ascii String Nullable
  index, root_party_executing_trader = eurex_cash_eti_t7_v9_1_dissect.root_party_executing_trader(buffer, index, packet, parent)

  -- Root Party Entering Trader: 6 Byte Ascii String Nullable
  index, root_party_entering_trader = eurex_cash_eti_t7_v9_1_dissect.root_party_entering_trader(buffer, index, packet, parent)
  ...
  for i = 1, no_order_book_items do
    index = eurex_cash_eti_t7_v9_1_dissect.order_book_item_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_create_deal_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_xetra_en_light_create_deal_notification = eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_create_deal_notification(buffer, offset)
  ...
  if show.xetra_en_light_create_deal_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.xetra_en_light_create_deal_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.xetra_en_light_create_deal_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_create_deal_notification_fields(buffer, offset, packet, parent, size_of_xetra_en_light_create_deal_notification)

  return offset + size_of_xetra_en_light_create_deal_notification
end

-- Read runtime size of: User Logout Response
eurex_cash_eti_t7_v9_1_size_of.user_logout_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.user_logout_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: User Logout Response
eurex_cash_eti_t7_v9_1_dissect.user_logout_response_fields = function(buffer, offset, packet, parent, size_of_user_logout_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.user_logout_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_user_logout_response = eurex_cash_eti_t7_v9_1_size_of.user_logout_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.user_logout_response then
    local range = buffer(offset, size_of_user_logout_response)
    local display = eurex_cash_eti_t7_v9_1_display.user_logout_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.user_logout_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.user_logout_response_fields(buffer, offset, packet, parent, size_of_user_logout_response)

  return offset + size_of_user_logout_response
end

-- Size: Username
eurex_cash_eti_t7_v9_1_size_of.username = 4

-- Display: Username
eurex_cash_eti_t7_v9_1_display.username = function(value)
  return "Username: "..value
end

-- Dissect: Username
eurex_cash_eti_t7_v9_1_dissect.username = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.username
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.username(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.user_logout_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.user_logout_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: User Logout Request
eurex_cash_eti_t7_v9_1_dissect.user_logout_request_fields = function(buffer, offset, packet, parent, size_of_user_logout_request)
  local index = offset
  ...
  index, username = eurex_cash_eti_t7_v9_1_dissect.username(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.user_logout_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_user_logout_request = eurex_cash_eti_t7_v9_1_size_of.user_logout_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.user_logout_request then
    local range = buffer(offset, size_of_user_logout_request)
    local display = eurex_cash_eti_t7_v9_1_display.user_logout_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.user_logout_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.user_logout_request_fields(buffer, offset, packet, parent, size_of_user_logout_request)

  return offset + size_of_user_logout_request
end

-- Read runtime size of: User Login Response
eurex_cash_eti_t7_v9_1_size_of.user_login_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.user_login_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: User Login Response
eurex_cash_eti_t7_v9_1_dissect.user_login_response_fields = function(buffer, offset, packet, parent, size_of_user_login_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.user_login_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_user_login_response = eurex_cash_eti_t7_v9_1_size_of.user_login_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.user_login_response then
    local range = buffer(offset, size_of_user_login_response)
    local display = eurex_cash_eti_t7_v9_1_display.user_login_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.user_login_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.user_login_response_fields(buffer, offset, packet, parent, size_of_user_login_response)

  return offset + size_of_user_login_response
end

-- Size: Password
eurex_cash_eti_t7_v9_1_size_of.password = 32

-- Display: Password
eurex_cash_eti_t7_v9_1_display.password = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Password
eurex_cash_eti_t7_v9_1_dissect.password = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.password
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.password(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.user_login_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.user_login_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: User Login Request
eurex_cash_eti_t7_v9_1_dissect.user_login_request_fields = function(buffer, offset, packet, parent, size_of_user_login_request)
  local index = offset
  ...
  index, password = eurex_cash_eti_t7_v9_1_dissect.password(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.user_login_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_user_login_request = eurex_cash_eti_t7_v9_1_size_of.user_login_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.user_login_request then
    local range = buffer(offset, size_of_user_login_request)
    local display = eurex_cash_eti_t7_v9_1_display.user_login_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.user_login_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.user_login_request_fields(buffer, offset, packet, parent, size_of_user_login_request)

  return offset + size_of_user_login_request
end

-- Read runtime size of: Unsubscribe Response
eurex_cash_eti_t7_v9_1_size_of.unsubscribe_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.unsubscribe_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Unsubscribe Response
eurex_cash_eti_t7_v9_1_dissect.unsubscribe_response_fields = function(buffer, offset, packet, parent, size_of_unsubscribe_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.unsubscribe_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_unsubscribe_response = eurex_cash_eti_t7_v9_1_size_of.unsubscribe_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.unsubscribe_response then
    local range = buffer(offset, size_of_unsubscribe_response)
    local display = eurex_cash_eti_t7_v9_1_display.unsubscribe_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.unsubscribe_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.unsubscribe_response_fields(buffer, offset, packet, parent, size_of_unsubscribe_response)

  return offset + size_of_unsubscribe_response
end

-- Size: Ref Appl Sub Id
eurex_cash_eti_t7_v9_1_size_of.ref_appl_sub_id = 4

-- Display: Ref Appl Sub Id
eurex_cash_eti_t7_v9_1_display.ref_appl_sub_id = function(value)
  return "Ref Appl Sub Id: "..value
end

-- Dissect: Ref Appl Sub Id
eurex_cash_eti_t7_v9_1_dissect.ref_appl_sub_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.ref_appl_sub_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.ref_appl_sub_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.unsubscribe_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.unsubscribe_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Unsubscribe Request
eurex_cash_eti_t7_v9_1_dissect.unsubscribe_request_fields = function(buffer, offset, packet, parent, size_of_unsubscribe_request)
  local index = offset
  ...
  index, ref_appl_sub_id = eurex_cash_eti_t7_v9_1_dissect.ref_appl_sub_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.unsubscribe_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_unsubscribe_request = eurex_cash_eti_t7_v9_1_size_of.unsubscribe_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.unsubscribe_request then
    local range = buffer(offset, size_of_unsubscribe_request)
    local display = eurex_cash_eti_t7_v9_1_display.unsubscribe_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.unsubscribe_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.unsubscribe_request_fields(buffer, offset, packet, parent, size_of_unsubscribe_request)

  return offset + size_of_unsubscribe_request
end

-- Size: Fix Cl Ord Id
eurex_cash_eti_t7_v9_1_size_of.fix_cl_ord_id = 20

-- Display: Fix Cl Ord Id
eurex_cash_eti_t7_v9_1_display.fix_cl_ord_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.fix_cl_ord_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fix_cl_ord_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.fix_cl_ord_id(value, buffer, offset, packet, parent)
...
-- Size: Exec Type
eurex_cash_eti_t7_v9_1_size_of.exec_type = 1

-- Display: Exec Type
eurex_cash_eti_t7_v9_1_display.exec_type = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Exec Type
eurex_cash_eti_t7_v9_1_dissect.exec_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.exec_type
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.exec_type(value, buffer, offset, packet, parent)
...
-- Size: Ord Status
eurex_cash_eti_t7_v9_1_size_of.ord_status = 1

-- Display: Ord Status
eurex_cash_eti_t7_v9_1_display.ord_status = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Ord Status
eurex_cash_eti_t7_v9_1_dissect.ord_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.ord_status
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.ord_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.exec_restatement_reason = 2

-- Display: Exec Restatement Reason
eurex_cash_eti_t7_v9_1_display.exec_restatement_reason = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.exec_restatement_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.exec_restatement_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.exec_restatement_reason(value, buffer, offset, packet, parent)
...
-- Size: Order Id Sfx
eurex_cash_eti_t7_v9_1_size_of.order_id_sfx = 4

-- Display: Order Id Sfx
eurex_cash_eti_t7_v9_1_display.order_id_sfx = function(value)
  return "Order Id Sfx: "..value
end

-- Dissect: Order Id Sfx
eurex_cash_eti_t7_v9_1_dissect.order_id_sfx = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_id_sfx
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.order_id_sfx(value, buffer, offset, packet, parent)
...
-- Dissect: Stop Px
eurex_cash_eti_t7_v9_1_dissect.stop_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.stop_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Size: Exec Id
eurex_cash_eti_t7_v9_1_size_of.exec_id = 8

-- Display: Exec Id
eurex_cash_eti_t7_v9_1_display.exec_id = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
-- Dissect: Exec Id
eurex_cash_eti_t7_v9_1_dissect.exec_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.exec_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.exec_id(value, buffer, offset, packet, parent)
...
-- Size: Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_size_of.orig_cl_ord_id = 8

-- Display: Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_display.orig_cl_ord_id = function(value)
  return "Orig Cl Ord Id: "..value
end

-- Dissect: Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_dissect.orig_cl_ord_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.orig_cl_ord_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.orig_cl_ord_id(value, buffer, offset, packet, parent)
...
-- Size: Cl Ord Id
eurex_cash_eti_t7_v9_1_size_of.cl_ord_id = 8

-- Display: Cl Ord Id
eurex_cash_eti_t7_v9_1_display.cl_ord_id = function(value)
  return "Cl Ord Id: "..value
end

-- Dissect: Cl Ord Id
eurex_cash_eti_t7_v9_1_dissect.cl_ord_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.cl_ord_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.cl_ord_id(value, buffer, offset, packet, parent)
...
-- Size: Order Id
eurex_cash_eti_t7_v9_1_size_of.order_id = 8

-- Display: Order Id
eurex_cash_eti_t7_v9_1_display.order_id = function(value)
  return "Order Id: "..value
end

-- Dissect: Order Id
eurex_cash_eti_t7_v9_1_dissect.order_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.order_id(value, buffer, offset, packet, parent)
...
-- Size: Appl Msg Id
eurex_cash_eti_t7_v9_1_size_of.appl_msg_id = 16

-- Display: Appl Msg Id
eurex_cash_eti_t7_v9_1_display.appl_msg_id = function(value)
  return "Appl Msg Id: "..value
end

-- Dissect: Appl Msg Id
eurex_cash_eti_t7_v9_1_dissect.appl_msg_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_msg_id
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.appl_msg_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.notification_in = 8

-- Display: Notification In
eurex_cash_eti_t7_v9_1_display.notification_in = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.notification_in = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.notification_in
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.notification_in(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_out = 8

-- Display: Trd Reg Ts Time Out
eurex_cash_eti_t7_v9_1_display.trd_reg_ts_time_out = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_time_out = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_out
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.trd_reg_ts_time_out(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.rbc_header_me_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_out

  index = index + eurex_cash_eti_t7_v9_1_size_of.notification_in
  ...
  index = index + eurex_cash_eti_t7_v9_1_size_of.appl_msg_id
...
eurex_cash_eti_t7_v9_1_display.rbc_header_me_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rbc Header Me Comp
eurex_cash_eti_t7_v9_1_dissect.rbc_header_me_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Trd Reg Ts Time Out: 8 Byte Unsigned Fixed Width Integer
  index, trd_reg_ts_time_out = eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_time_out(buffer, index, packet, parent)

  -- Notification In: 8 Byte Unsigned Fixed Width Integer
  index, notification_in = eurex_cash_eti_t7_v9_1_dissect.notification_in(buffer, index, packet, parent)
  ...
  -- Appl Msg Id: 16 Byte
  index, appl_msg_id = eurex_cash_eti_t7_v9_1_dissect.appl_msg_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.rbc_header_me_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.rbc_header_me_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.rbc_header_me_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.rbc_header_me_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.rbc_header_me_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.rbc_header_me_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Trailing Stop Update Notification
eurex_cash_eti_t7_v9_1_size_of.trailing_stop_update_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.trailing_stop_update_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Trailing Stop Update Notification
eurex_cash_eti_t7_v9_1_dissect.trailing_stop_update_notification_fields = function(buffer, offset, packet, parent, size_of_trailing_stop_update_notification)
  local index = offset
  ...
  index, rbc_header_me_comp = eurex_cash_eti_t7_v9_1_dissect.rbc_header_me_comp(buffer, index, packet, parent)

  -- Order Id: 8 Byte Unsigned Fixed Width Integer
  index, order_id = eurex_cash_eti_t7_v9_1_dissect.order_id(buffer, index, packet, parent)
  ...
  index, orig_cl_ord_id = eurex_cash_eti_t7_v9_1_dissect.orig_cl_ord_id(buffer, index, packet, parent)
  ...
  index, order_id_sfx = eurex_cash_eti_t7_v9_1_dissect.order_id_sfx(buffer, index, packet, parent)

  -- Market Segment Id: 4 Byte Signed Fixed Width Integer
  index, market_segment_id = eurex_cash_eti_t7_v9_1_dissect.market_segment_id(buffer, index, packet, parent)

  -- Exec Restatement Reason: 2 Byte Unsigned Fixed Width Integer Enum with 50 values
  index, exec_restatement_reason = eurex_cash_eti_t7_v9_1_dissect.exec_restatement_reason(buffer, index, packet, parent)

  -- Ord Status: 1 Byte Ascii String Enum with 8 values
  index, ord_status = eurex_cash_eti_t7_v9_1_dissect.ord_status(buffer, index, packet, parent)

  -- Exec Type: 1 Byte Ascii String Enum with 10 values
  index, exec_type = eurex_cash_eti_t7_v9_1_dissect.exec_type(buffer, index, packet, parent)

  -- Side: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, side = eurex_cash_eti_t7_v9_1_dissect.side(buffer, index, packet, parent)

  -- Fix Cl Ord Id: 20 Byte Ascii String Nullable
  index, fix_cl_ord_id = eurex_cash_eti_t7_v9_1_dissect.fix_cl_ord_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.trailing_stop_update_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_trailing_stop_update_notification = eurex_cash_eti_t7_v9_1_size_of.trailing_stop_update_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.trailing_stop_update_notification then
    local range = buffer(offset, size_of_trailing_stop_update_notification)
    local display = eurex_cash_eti_t7_v9_1_display.trailing_stop_update_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.trailing_stop_update_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.trailing_stop_update_notification_fields(buffer, offset, packet, parent, size_of_trailing_stop_update_notification)

  return offset + size_of_trailing_stop_update_notification
end

-- Size: Ref Appl Last Msg Id
eurex_cash_eti_t7_v9_1_size_of.ref_appl_last_msg_id = 16

-- Display: Ref Appl Last Msg Id
eurex_cash_eti_t7_v9_1_display.ref_appl_last_msg_id = function(value)
  return "Ref Appl Last Msg Id: "..value
end

-- Dissect: Ref Appl Last Msg Id
eurex_cash_eti_t7_v9_1_dissect.ref_appl_last_msg_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.ref_appl_last_msg_id
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.ref_appl_last_msg_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trading_session_status_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.trading_session_status_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Trading Session Status Broadcast
eurex_cash_eti_t7_v9_1_dissect.trading_session_status_broadcast_fields = function(buffer, offset, packet, parent, size_of_trading_session_status_broadcast)
  local index = offset
  ...
  index, ref_appl_last_msg_id = eurex_cash_eti_t7_v9_1_dissect.ref_appl_last_msg_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.trading_session_status_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_trading_session_status_broadcast = eurex_cash_eti_t7_v9_1_size_of.trading_session_status_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.trading_session_status_broadcast then
    local range = buffer(offset, size_of_trading_session_status_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.trading_session_status_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.trading_session_status_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.trading_session_status_broadcast_fields(buffer, offset, packet, parent, size_of_trading_session_status_broadcast)

  return offset + size_of_trading_session_status_broadcast
end

-- Size: Root Party Id Execution Venue
eurex_cash_eti_t7_v9_1_size_of.root_party_id_execution_venue = 4

-- Display: Root Party Id Execution Venue
eurex_cash_eti_t7_v9_1_display.root_party_id_execution_venue = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_id_execution_venue = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_execution_venue
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_execution_venue(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.regulatory_trade_id = 52

-- Display: Regulatory Trade Id
eurex_cash_eti_t7_v9_1_display.regulatory_trade_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.regulatory_trade_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.regulatory_trade_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.regulatory_trade_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_specialist_trader = 6

-- Display: Party Specialist Trader
eurex_cash_eti_t7_v9_1_display.party_specialist_trader = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Party Specialist Trader: No Value"
  end
...
eurex_cash_eti_t7_v9_1_dissect.party_specialist_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_specialist_trader
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_specialist_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_specialist_firm = 5

-- Display: Party Specialist Firm
eurex_cash_eti_t7_v9_1_display.party_specialist_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Party Specialist Firm: No Value"
  end
...
eurex_cash_eti_t7_v9_1_dissect.party_specialist_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_specialist_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_specialist_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_contra_settlement_location = 3

-- Display: Root Party Contra Settlement Location
eurex_cash_eti_t7_v9_1_display.root_party_contra_settlement_location = function(value)
  if value == "APK" then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_contra_settlement_location = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_contra_settlement_location
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_contra_settlement_location(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_contra_settlement_account = 35

-- Display: Root Party Contra Settlement Account
eurex_cash_eti_t7_v9_1_display.root_party_contra_settlement_account = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_contra_settlement_account = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_contra_settlement_account
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_contra_settlement_account(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_contra_firm_kv_number = 4

-- Display: Root Party Contra Firm Kv Number
eurex_cash_eti_t7_v9_1_display.root_party_contra_firm_kv_number = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_contra_firm_kv_number = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_contra_firm_kv_number
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_contra_firm_kv_number(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_contra_settlement_firm = 5

-- Display: Root Party Contra Settlement Firm
eurex_cash_eti_t7_v9_1_display.root_party_contra_settlement_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_contra_settlement_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_contra_settlement_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_contra_settlement_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_contra_firm = 5

-- Display: Root Party Contra Firm
eurex_cash_eti_t7_v9_1_display.root_party_contra_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_contra_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_contra_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_contra_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_settlement_firm = 5

-- Display: Root Party Settlement Firm
eurex_cash_eti_t7_v9_1_display.root_party_settlement_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_settlement_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_settlement_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_settlement_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_settlement_location = 3

-- Display: Root Party Settlement Location
eurex_cash_eti_t7_v9_1_display.root_party_settlement_location = function(value)
  if value == "APK" then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_settlement_location = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_settlement_location
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_settlement_location(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_settlement_account = 35

-- Display: Root Party Settlement Account
eurex_cash_eti_t7_v9_1_display.root_party_settlement_account = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_settlement_account = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_settlement_account
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_settlement_account(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_executing_firm_kv_number = 4

-- Display: Root Party Executing Firm Kv Number
eurex_cash_eti_t7_v9_1_display.root_party_executing_firm_kv_number = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_executing_firm_kv_number = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_executing_firm_kv_number
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_executing_firm_kv_number(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_clearing_firm = 5

-- Display: Root Party Clearing Firm
eurex_cash_eti_t7_v9_1_display.root_party_clearing_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_clearing_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_clearing_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.root_party_clearing_firm(value, buffer, offset, packet, parent)
...
-- Size: Ord Type
eurex_cash_eti_t7_v9_1_size_of.ord_type = 1

-- Display: Ord Type
eurex_cash_eti_t7_v9_1_display.ord_type = function(value)
  if value == 1 then
...
-- Dissect: Ord Type
eurex_cash_eti_t7_v9_1_dissect.ord_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.ord_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.ord_type(value, buffer, offset, packet, parent)
...
-- Size: Order Category
eurex_cash_eti_t7_v9_1_size_of.order_category = 1

-- Display: Order Category
eurex_cash_eti_t7_v9_1_display.order_category = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.order_category = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_category
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.order_category(value, buffer, offset, packet, parent)
...
-- Size: Currency
eurex_cash_eti_t7_v9_1_size_of.currency = 3

-- Display: Currency
eurex_cash_eti_t7_v9_1_display.currency = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Currency
eurex_cash_eti_t7_v9_1_dissect.currency = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.currency
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.currency(value, buffer, offset, packet, parent)
...
-- Size: Settl Currency
eurex_cash_eti_t7_v9_1_size_of.settl_currency = 3

-- Display: Settl Currency
eurex_cash_eti_t7_v9_1_display.settl_currency = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.settl_currency = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.settl_currency
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.settl_currency(value, buffer, offset, packet, parent)
...
-- Size: Account
eurex_cash_eti_t7_v9_1_size_of.account = 2

-- Display: Account
eurex_cash_eti_t7_v9_1_display.account = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Account
eurex_cash_eti_t7_v9_1_dissect.account = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.account
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.account(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_investment_decision_maker_qualifier = 1

-- Display: Root Party Id Investment Decision Maker Qualifier
eurex_cash_eti_t7_v9_1_display.root_party_id_investment_decision_maker_qualifier = function(value)
  if value == 22 then
...
eurex_cash_eti_t7_v9_1_dissect.root_party_id_investment_decision_maker_qualifier = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_investment_decision_maker_qualifier
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_investment_decision_maker_qualifier(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.clearing_instruction = 1

-- Display: Clearing Instruction
eurex_cash_eti_t7_v9_1_display.clearing_instruction = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.clearing_instruction = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.clearing_instruction
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.clearing_instruction(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.refinancing_eligibility_indicator = 1

-- Display: Refinancing Eligibility Indicator
eurex_cash_eti_t7_v9_1_display.refinancing_eligibility_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.refinancing_eligibility_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.refinancing_eligibility_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.refinancing_eligibility_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.last_coupon_deviation_indicator = 1

-- Display: Last Coupon Deviation Indicator
eurex_cash_eti_t7_v9_1_display.last_coupon_deviation_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.last_coupon_deviation_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.last_coupon_deviation_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.last_coupon_deviation_indicator(value, buffer, offset, packet, parent)
...
-- Size: Delivery Type
eurex_cash_eti_t7_v9_1_size_of.delivery_type = 1

-- Display: Delivery Type
eurex_cash_eti_t7_v9_1_display.delivery_type = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.delivery_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.delivery_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.delivery_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.side_liquidity_ind = 1

-- Display: Side Liquidity Ind
eurex_cash_eti_t7_v9_1_display.side_liquidity_ind = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.side_liquidity_ind = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.side_liquidity_ind
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.side_liquidity_ind(value, buffer, offset, packet, parent)
...
-- Size: Match Sub Type
eurex_cash_eti_t7_v9_1_size_of.match_sub_type = 1

-- Display: Match Sub Type
eurex_cash_eti_t7_v9_1_display.match_sub_type = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.match_sub_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.match_sub_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.match_sub_type(value, buffer, offset, packet, parent)
...
-- Size: Match Type
eurex_cash_eti_t7_v9_1_size_of.match_type = 1

-- Display: Match Type
eurex_cash_eti_t7_v9_1_display.match_type = function(value)
  if value == 3 then
...
-- Dissect: Match Type
eurex_cash_eti_t7_v9_1_dissect.match_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.match_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.match_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.transfer_reason = 1

-- Display: Transfer Reason
eurex_cash_eti_t7_v9_1_display.transfer_reason = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.transfer_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.transfer_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.transfer_reason(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trade_report_type = 1

-- Display: Trade Report Type
eurex_cash_eti_t7_v9_1_display.trade_report_type = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.trade_report_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_report_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_report_type(value, buffer, offset, packet, parent)
...
-- Size: Last Mkt
eurex_cash_eti_t7_v9_1_size_of.last_mkt = 2

-- Display: Last Mkt
eurex_cash_eti_t7_v9_1_display.last_mkt = function(value)
  if value == 3 then
...
-- Dissect: Last Mkt
eurex_cash_eti_t7_v9_1_dissect.last_mkt = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.last_mkt
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.last_mkt(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.num_days_interest = 4

-- Display: Num Days Interest
eurex_cash_eti_t7_v9_1_display.num_days_interest = function(value)
  return "Num Days Interest: "..value
end

-- Dissect: Num Days Interest
eurex_cash_eti_t7_v9_1_dissect.num_days_interest = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.num_days_interest
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.num_days_interest(value, buffer, offset, packet, parent)
...
-- Size: Trd Match Id
eurex_cash_eti_t7_v9_1_size_of.trd_match_id = 4

-- Display: Trd Match Id
eurex_cash_eti_t7_v9_1_display.trd_match_id = function(value)
  return "Trd Match Id: "..value
end

-- Dissect: Trd Match Id
eurex_cash_eti_t7_v9_1_dissect.trd_match_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_match_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trd_match_id(value, buffer, offset, packet, parent)
...
-- Size: Match Date
eurex_cash_eti_t7_v9_1_size_of.match_date = 4

-- Display: Match Date
eurex_cash_eti_t7_v9_1_display.match_date = function(value)
  return "Match Date: "..value
end

-- Dissect: Match Date
eurex_cash_eti_t7_v9_1_dissect.match_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.match_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.match_date(value, buffer, offset, packet, parent)
...
-- Size: Trade Number
eurex_cash_eti_t7_v9_1_size_of.trade_number = 4

-- Display: Trade Number
eurex_cash_eti_t7_v9_1_display.trade_number = function(value)
  return "Trade Number: "..value
end

-- Dissect: Trade Number
eurex_cash_eti_t7_v9_1_dissect.trade_number = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_number
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_number(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.side_trade_report_id = 4

-- Display: Side Trade Report Id
eurex_cash_eti_t7_v9_1_display.side_trade_report_id = function(value)
  return "Side Trade Report Id: "..value
end

-- Dissect: Side Trade Report Id
eurex_cash_eti_t7_v9_1_dissect.side_trade_report_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.side_trade_report_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.side_trade_report_id(value, buffer, offset, packet, parent)
...
-- Size: Side Trade Id
eurex_cash_eti_t7_v9_1_size_of.side_trade_id = 4

-- Display: Side Trade Id
eurex_cash_eti_t7_v9_1_display.side_trade_id = function(value)
  return "Side Trade Id: "..value
end

-- Dissect: Side Trade Id
eurex_cash_eti_t7_v9_1_dissect.side_trade_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.side_trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.side_trade_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_specialist_trader = 4

-- Display: Party Id Specialist Trader
eurex_cash_eti_t7_v9_1_display.party_id_specialist_trader = function(value)
  return "Party Id Specialist Trader: "..value
end

-- Dissect: Party Id Specialist Trader
eurex_cash_eti_t7_v9_1_dissect.party_id_specialist_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_specialist_trader
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_specialist_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_contra_settlement_unit = 4

-- Display: Root Party Id Contra Settlement Unit
eurex_cash_eti_t7_v9_1_display.root_party_id_contra_settlement_unit = function(value)
  return "Root Party Id Contra Settlement Unit: "..value
end

-- Dissect: Root Party Id Contra Settlement Unit
eurex_cash_eti_t7_v9_1_dissect.root_party_id_contra_settlement_unit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_contra_settlement_unit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_contra_settlement_unit(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_contra_unit = 4

-- Display: Root Party Id Contra Unit
eurex_cash_eti_t7_v9_1_display.root_party_id_contra_unit = function(value)
  return "Root Party Id Contra Unit: "..value
end

-- Dissect: Root Party Id Contra Unit
eurex_cash_eti_t7_v9_1_dissect.root_party_id_contra_unit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_contra_unit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_contra_unit(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_clearing_unit = 4

-- Display: Root Party Id Clearing Unit
eurex_cash_eti_t7_v9_1_display.root_party_id_clearing_unit = function(value)
  return "Root Party Id Clearing Unit: "..value
end

-- Dissect: Root Party Id Clearing Unit
eurex_cash_eti_t7_v9_1_dissect.root_party_id_clearing_unit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_clearing_unit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_clearing_unit(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_settlement_unit = 4

-- Display: Root Party Id Settlement Unit
eurex_cash_eti_t7_v9_1_display.root_party_id_settlement_unit = function(value)
  return "Root Party Id Settlement Unit: "..value
end

-- Dissect: Root Party Id Settlement Unit
eurex_cash_eti_t7_v9_1_dissect.root_party_id_settlement_unit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_settlement_unit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_settlement_unit(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_executing_trader = 4

-- Display: Root Party Id Executing Trader
eurex_cash_eti_t7_v9_1_display.root_party_id_executing_trader = function(value)
  return "Root Party Id Executing Trader: "..value
end

-- Dissect: Root Party Id Executing Trader
eurex_cash_eti_t7_v9_1_dissect.root_party_id_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_executing_trader
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_session_id = 4

-- Display: Root Party Id Session Id
eurex_cash_eti_t7_v9_1_display.root_party_id_session_id = function(value)
  return "Root Party Id Session Id: "..value
end

-- Dissect: Root Party Id Session Id
eurex_cash_eti_t7_v9_1_dissect.root_party_id_session_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_session_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_session_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_executing_unit = 4

-- Display: Root Party Id Executing Unit
eurex_cash_eti_t7_v9_1_display.root_party_id_executing_unit = function(value)
  return "Root Party Id Executing Unit: "..value
end

-- Dissect: Root Party Id Executing Unit
eurex_cash_eti_t7_v9_1_dissect.root_party_id_executing_unit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_executing_unit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_executing_unit(value, buffer, offset, packet, parent)
...
-- Size: Orig Trade Id
eurex_cash_eti_t7_v9_1_size_of.orig_trade_id = 4

-- Display: Orig Trade Id
eurex_cash_eti_t7_v9_1_display.orig_trade_id = function(value)
  return "Orig Trade Id: "..value
end

-- Dissect: Orig Trade Id
eurex_cash_eti_t7_v9_1_dissect.orig_trade_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.orig_trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.orig_trade_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_investment_decision_maker = 8

-- Display: Root Party Id Investment Decision Maker
eurex_cash_eti_t7_v9_1_display.root_party_id_investment_decision_maker = function(value)
  return "Root Party Id Investment Decision Maker: "..value
end

-- Dissect: Root Party Id Investment Decision Maker
eurex_cash_eti_t7_v9_1_dissect.root_party_id_investment_decision_maker = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_investment_decision_maker
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_investment_decision_maker(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.root_party_id_client_id = 8

-- Display: Root Party Id Client Id
eurex_cash_eti_t7_v9_1_display.root_party_id_client_id = function(value)
  return "Root Party Id Client Id: "..value
end

-- Dissect: Root Party Id Client Id
eurex_cash_eti_t7_v9_1_dissect.root_party_id_client_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.root_party_id_client_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.root_party_id_client_id(value, buffer, offset, packet, parent)
...
-- Dissect: Coupon Rate
eurex_cash_eti_t7_v9_1_dissect.coupon_rate = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.coupon_rate
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.accrued_interes_amt = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.accrued_interes_amt
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.side_gross_trade_amt = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.side_gross_trade_amt
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Dissect: Cum Qty
eurex_cash_eti_t7_v9_1_dissect.cum_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.cum_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.settl_curr_fx_rate = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.settl_curr_fx_rate
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.settl_curr_amt = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.settl_curr_amt
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.trade_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.trade_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Trade Broadcast
eurex_cash_eti_t7_v9_1_dissect.trade_broadcast_fields = function(buffer, offset, packet, parent, size_of_trade_broadcast)
  local index = offset
  ...
  index, root_party_id_client_id = eurex_cash_eti_t7_v9_1_dissect.root_party_id_client_id(buffer, index, packet, parent)

  -- Executing Trader: 8 Byte Unsigned Fixed Width Integer
  index, executing_trader = eurex_cash_eti_t7_v9_1_dissect.executing_trader(buffer, index, packet, parent)

  -- Root Party Id Investment Decision Maker: 8 Byte Unsigned Fixed Width Integer
  index, root_party_id_investment_decision_maker = eurex_cash_eti_t7_v9_1_dissect.root_party_id_investment_decision_maker(buffer, index, packet, parent)

  -- Trade Id: 4 Byte Unsigned Fixed Width Integer
  index, trade_id = eurex_cash_eti_t7_v9_1_dissect.trade_id(buffer, index, packet, parent)

  -- Orig Trade Id: 4 Byte Unsigned Fixed Width Integer
  index, orig_trade_id = eurex_cash_eti_t7_v9_1_dissect.orig_trade_id(buffer, index, packet, parent)

  -- Root Party Id Executing Unit: 4 Byte Unsigned Fixed Width Integer
  index, root_party_id_executing_unit = eurex_cash_eti_t7_v9_1_dissect.root_party_id_executing_unit(buffer, index, packet, parent)

  -- Root Party Id Session Id: 4 Byte Unsigned Fixed Width Integer
  index, root_party_id_session_id = eurex_cash_eti_t7_v9_1_dissect.root_party_id_session_id(buffer, index, packet, parent)

  -- Root Party Id Executing Trader: 4 Byte Unsigned Fixed Width Integer
  index, root_party_id_executing_trader = eurex_cash_eti_t7_v9_1_dissect.root_party_id_executing_trader(buffer, index, packet, parent)

  -- Root Party Id Settlement Unit: 4 Byte Unsigned Fixed Width Integer
  index, root_party_id_settlement_unit = eurex_cash_eti_t7_v9_1_dissect.root_party_id_settlement_unit(buffer, index, packet, parent)

  -- Root Party Id Clearing Unit: 4 Byte Unsigned Fixed Width Integer
  index, root_party_id_clearing_unit = eurex_cash_eti_t7_v9_1_dissect.root_party_id_clearing_unit(buffer, index, packet, parent)

  -- Root Party Id Contra Unit: 4 Byte Unsigned Fixed Width Integer
  index, root_party_id_contra_unit = eurex_cash_eti_t7_v9_1_dissect.root_party_id_contra_unit(buffer, index, packet, parent)

  -- Root Party Id Contra Settlement Unit: 4 Byte Unsigned Fixed Width Integer
  index, root_party_id_contra_settlement_unit = eurex_cash_eti_t7_v9_1_dissect.root_party_id_contra_settlement_unit(buffer, index, packet, parent)

  -- Party Id Specialist Trader: 4 Byte Unsigned Fixed Width Integer
  index, party_id_specialist_trader = eurex_cash_eti_t7_v9_1_dissect.party_id_specialist_trader(buffer, index, packet, parent)
  ...
  index, side_trade_id = eurex_cash_eti_t7_v9_1_dissect.side_trade_id(buffer, index, packet, parent)

  -- Side Trade Report Id: 4 Byte Unsigned Fixed Width Integer
  index, side_trade_report_id = eurex_cash_eti_t7_v9_1_dissect.side_trade_report_id(buffer, index, packet, parent)

  -- Trade Number: 4 Byte Unsigned Fixed Width Integer
  index, trade_number = eurex_cash_eti_t7_v9_1_dissect.trade_number(buffer, index, packet, parent)

  -- Match Date: 4 Byte Unsigned Fixed Width Integer
  index, match_date = eurex_cash_eti_t7_v9_1_dissect.match_date(buffer, index, packet, parent)

  -- Settl Date: 4 Byte Unsigned Fixed Width Integer
  index, settl_date = eurex_cash_eti_t7_v9_1_dissect.settl_date(buffer, index, packet, parent)

  -- Trd Match Id: 4 Byte Unsigned Fixed Width Integer
  index, trd_match_id = eurex_cash_eti_t7_v9_1_dissect.trd_match_id(buffer, index, packet, parent)

  -- Num Days Interest: 4 Byte Unsigned Fixed Width Integer
  index, num_days_interest = eurex_cash_eti_t7_v9_1_dissect.num_days_interest(buffer, index, packet, parent)

  -- Last Mkt: 2 Byte Unsigned Fixed Width Integer Enum with 9 values
  index, last_mkt = eurex_cash_eti_t7_v9_1_dissect.last_mkt(buffer, index, packet, parent)

  -- Trade Report Type: 1 Byte Unsigned Fixed Width Integer Enum with 8 values
  index, trade_report_type = eurex_cash_eti_t7_v9_1_dissect.trade_report_type(buffer, index, packet, parent)

  -- Transfer Reason: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, transfer_reason = eurex_cash_eti_t7_v9_1_dissect.transfer_reason(buffer, index, packet, parent)

  -- Match Type: 1 Byte Unsigned Fixed Width Integer Enum with 7 values
  index, match_type = eurex_cash_eti_t7_v9_1_dissect.match_type(buffer, index, packet, parent)

  -- Match Sub Type: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, match_sub_type = eurex_cash_eti_t7_v9_1_dissect.match_sub_type(buffer, index, packet, parent)

  -- Side: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, side = eurex_cash_eti_t7_v9_1_dissect.side(buffer, index, packet, parent)

  -- Side Liquidity Ind: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, side_liquidity_ind = eurex_cash_eti_t7_v9_1_dissect.side_liquidity_ind(buffer, index, packet, parent)

  -- Delivery Type: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, delivery_type = eurex_cash_eti_t7_v9_1_dissect.delivery_type(buffer, index, packet, parent)

  -- Trading Capacity: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, trading_capacity = eurex_cash_eti_t7_v9_1_dissect.trading_capacity(buffer, index, packet, parent)

  -- Last Coupon Deviation Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 7 values
  index, last_coupon_deviation_indicator = eurex_cash_eti_t7_v9_1_dissect.last_coupon_deviation_indicator(buffer, index, packet, parent)

  -- Refinancing Eligibility Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, refinancing_eligibility_indicator = eurex_cash_eti_t7_v9_1_dissect.refinancing_eligibility_indicator(buffer, index, packet, parent)

  -- Clearing Instruction: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, clearing_instruction = eurex_cash_eti_t7_v9_1_dissect.clearing_instruction(buffer, index, packet, parent)
  ...
  index, root_party_id_investment_decision_maker_qualifier = eurex_cash_eti_t7_v9_1_dissect.root_party_id_investment_decision_maker_qualifier(buffer, index, packet, parent)

  -- Account: 2 Byte Ascii String Nullable
  index, account = eurex_cash_eti_t7_v9_1_dissect.account(buffer, index, packet, parent)

  -- Settl Currency: 3 Byte Ascii String Nullable
  index, settl_currency = eurex_cash_eti_t7_v9_1_dissect.settl_currency(buffer, index, packet, parent)

  -- Currency: 3 Byte Ascii String Nullable
  index, currency = eurex_cash_eti_t7_v9_1_dissect.currency(buffer, index, packet, parent)
  ...
  index, order_category = eurex_cash_eti_t7_v9_1_dissect.order_category(buffer, index, packet, parent)

  -- Ord Type: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, ord_type = eurex_cash_eti_t7_v9_1_dissect.ord_type(buffer, index, packet, parent)
  ...
  index, root_party_clearing_firm = eurex_cash_eti_t7_v9_1_dissect.root_party_clearing_firm(buffer, index, packet, parent)

  -- Root Party Executing Firm Kv Number: 4 Byte Ascii String Nullable
  index, root_party_executing_firm_kv_number = eurex_cash_eti_t7_v9_1_dissect.root_party_executing_firm_kv_number(buffer, index, packet, parent)

  -- Root Party Settlement Account: 35 Byte Ascii String Nullable
  index, root_party_settlement_account = eurex_cash_eti_t7_v9_1_dissect.root_party_settlement_account(buffer, index, packet, parent)

  -- Root Party Settlement Location: 3 Byte Ascii String Enum with 18 values
  index, root_party_settlement_location = eurex_cash_eti_t7_v9_1_dissect.root_party_settlement_location(buffer, index, packet, parent)

  -- Root Party Settlement Firm: 5 Byte Ascii String Nullable
  index, root_party_settlement_firm = eurex_cash_eti_t7_v9_1_dissect.root_party_settlement_firm(buffer, index, packet, parent)

  -- Root Party Contra Firm: 5 Byte Ascii String Nullable
  index, root_party_contra_firm = eurex_cash_eti_t7_v9_1_dissect.root_party_contra_firm(buffer, index, packet, parent)

  -- Root Party Contra Settlement Firm: 5 Byte Ascii String Nullable
  index, root_party_contra_settlement_firm = eurex_cash_eti_t7_v9_1_dissect.root_party_contra_settlement_firm(buffer, index, packet, parent)

  -- Root Party Contra Firm Kv Number: 4 Byte Ascii String Nullable
  index, root_party_contra_firm_kv_number = eurex_cash_eti_t7_v9_1_dissect.root_party_contra_firm_kv_number(buffer, index, packet, parent)

  -- Root Party Contra Settlement Account: 35 Byte Ascii String Nullable
  index, root_party_contra_settlement_account = eurex_cash_eti_t7_v9_1_dissect.root_party_contra_settlement_account(buffer, index, packet, parent)

  -- Root Party Contra Settlement Location: 3 Byte Ascii String Enum with 18 values
  index, root_party_contra_settlement_location = eurex_cash_eti_t7_v9_1_dissect.root_party_contra_settlement_location(buffer, index, packet, parent)

  -- Party Specialist Firm: 5 Byte Ascii String Nullable
  index, party_specialist_firm = eurex_cash_eti_t7_v9_1_dissect.party_specialist_firm(buffer, index, packet, parent)

  -- Party Specialist Trader: 6 Byte Ascii String Nullable
  index, party_specialist_trader = eurex_cash_eti_t7_v9_1_dissect.party_specialist_trader(buffer, index, packet, parent)

  -- Regulatory Trade Id: 52 Byte Ascii String Nullable
  index, regulatory_trade_id = eurex_cash_eti_t7_v9_1_dissect.regulatory_trade_id(buffer, index, packet, parent)

  -- Root Party Id Execution Venue: 4 Byte Ascii String Nullable
  index, root_party_id_execution_venue = eurex_cash_eti_t7_v9_1_dissect.root_party_id_execution_venue(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.trade_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_trade_broadcast = eurex_cash_eti_t7_v9_1_size_of.trade_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.trade_broadcast then
    local range = buffer(offset, size_of_trade_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.trade_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.trade_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.trade_broadcast_fields(buffer, offset, packet, parent, size_of_trade_broadcast)

  return offset + size_of_trade_broadcast
end

-- Size: Throttle Disconnect Limit
eurex_cash_eti_t7_v9_1_size_of.throttle_disconnect_limit = 4

-- Display: Throttle Disconnect Limit
eurex_cash_eti_t7_v9_1_display.throttle_disconnect_limit = function(value)
  return "Throttle Disconnect Limit: "..value
end

-- Dissect: Throttle Disconnect Limit
eurex_cash_eti_t7_v9_1_dissect.throttle_disconnect_limit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.throttle_disconnect_limit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.throttle_disconnect_limit(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.throttle_no_msgs = 4

-- Display: Throttle No Msgs
eurex_cash_eti_t7_v9_1_display.throttle_no_msgs = function(value)
  return "Throttle No Msgs: "..value
end

-- Dissect: Throttle No Msgs
eurex_cash_eti_t7_v9_1_dissect.throttle_no_msgs = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.throttle_no_msgs
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.throttle_no_msgs(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.throttle_time_interval = 8

-- Display: Throttle Time Interval
eurex_cash_eti_t7_v9_1_display.throttle_time_interval = function(value)
  return "Throttle Time Interval: "..value
end

-- Dissect: Throttle Time Interval
eurex_cash_eti_t7_v9_1_dissect.throttle_time_interval = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.throttle_time_interval
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = eurex_cash_eti_t7_v9_1_display.throttle_time_interval(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.notif_header_comp = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v9_1_display.notif_header_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Notif Header Comp
eurex_cash_eti_t7_v9_1_dissect.notif_header_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.notif_header_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.notif_header_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.notif_header_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.notif_header_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.notif_header_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.notif_header_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Throttle Update Notification
eurex_cash_eti_t7_v9_1_size_of.throttle_update_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.throttle_update_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Throttle Update Notification
eurex_cash_eti_t7_v9_1_dissect.throttle_update_notification_fields = function(buffer, offset, packet, parent, size_of_throttle_update_notification)
  local index = offset
  ...
  index, notif_header_comp = eurex_cash_eti_t7_v9_1_dissect.notif_header_comp(buffer, index, packet, parent)

  -- Throttle Time Interval: 8 Byte Signed Fixed Width Integer
  index, throttle_time_interval = eurex_cash_eti_t7_v9_1_dissect.throttle_time_interval(buffer, index, packet, parent)

  -- Throttle No Msgs: 4 Byte Unsigned Fixed Width Integer
  index, throttle_no_msgs = eurex_cash_eti_t7_v9_1_dissect.throttle_no_msgs(buffer, index, packet, parent)

  -- Throttle Disconnect Limit: 4 Byte Unsigned Fixed Width Integer
  index, throttle_disconnect_limit = eurex_cash_eti_t7_v9_1_dissect.throttle_disconnect_limit(buffer, index, packet, parent)

  return index
end

-- Dissect: Throttle Update Notification
eurex_cash_eti_t7_v9_1_dissect.throttle_update_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_throttle_update_notification = eurex_cash_eti_t7_v9_1_size_of.throttle_update_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.throttle_update_notification then
    local range = buffer(offset, size_of_throttle_update_notification)
    local display = eurex_cash_eti_t7_v9_1_display.throttle_update_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.throttle_update_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.throttle_update_notification_fields(buffer, offset, packet, parent, size_of_throttle_update_notification)

  return offset + size_of_throttle_update_notification
end

-- Read runtime size of: Tm Trading Session Status Broadcast
eurex_cash_eti_t7_v9_1_size_of.tm_trading_session_status_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tm_trading_session_status_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tm Trading Session Status Broadcast
eurex_cash_eti_t7_v9_1_dissect.tm_trading_session_status_broadcast_fields = function(buffer, offset, packet, parent, size_of_tm_trading_session_status_broadcast)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.tm_trading_session_status_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tm_trading_session_status_broadcast = eurex_cash_eti_t7_v9_1_size_of.tm_trading_session_status_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tm_trading_session_status_broadcast then
    local range = buffer(offset, size_of_tm_trading_session_status_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.tm_trading_session_status_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tm_trading_session_status_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tm_trading_session_status_broadcast_fields(buffer, offset, packet, parent, size_of_tm_trading_session_status_broadcast)

  return offset + size_of_tm_trading_session_status_broadcast
end

-- Read runtime size of: Tes Trading Session Status Broadcast
eurex_cash_eti_t7_v9_1_size_of.tes_trading_session_status_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tes_trading_session_status_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Trading Session Status Broadcast
eurex_cash_eti_t7_v9_1_dissect.tes_trading_session_status_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_trading_session_status_broadcast)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.tes_trading_session_status_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tes_trading_session_status_broadcast = eurex_cash_eti_t7_v9_1_size_of.tes_trading_session_status_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tes_trading_session_status_broadcast then
    local range = buffer(offset, size_of_tes_trading_session_status_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.tes_trading_session_status_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tes_trading_session_status_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tes_trading_session_status_broadcast_fields(buffer, offset, packet, parent, size_of_tes_trading_session_status_broadcast)

  return offset + size_of_tes_trading_session_status_broadcast
end

-- Size: Trade Publish Indicator
eurex_cash_eti_t7_v9_1_size_of.trade_publish_indicator = 1

-- Display: Trade Publish Indicator
eurex_cash_eti_t7_v9_1_display.trade_publish_indicator = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.trade_publish_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_publish_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_publish_indicator(value, buffer, offset, packet, parent)
...
-- Size: Trd Type
eurex_cash_eti_t7_v9_1_size_of.trd_type = 2

-- Display: Trd Type
eurex_cash_eti_t7_v9_1_display.trd_type = function(value)
  if value == 54 then
...
-- Dissect: Trd Type
eurex_cash_eti_t7_v9_1_dissect.trd_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trd_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.srqs_related_trade_id = 4

-- Display: Srqs Related Trade Id
eurex_cash_eti_t7_v9_1_display.srqs_related_trade_id = function(value)
  return "Srqs Related Trade Id: "..value
end

-- Dissect: Srqs Related Trade Id
eurex_cash_eti_t7_v9_1_dissect.srqs_related_trade_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.srqs_related_trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.srqs_related_trade_id(value, buffer, offset, packet, parent)
...
-- Size: Package Id
eurex_cash_eti_t7_v9_1_size_of.package_id = 4

-- Display: Package Id
eurex_cash_eti_t7_v9_1_display.package_id = function(value)
  return "Package Id: "..value
end

-- Dissect: Package Id
eurex_cash_eti_t7_v9_1_dissect.package_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.package_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.package_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.tes_trade_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tes_trade_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Trade Broadcast
eurex_cash_eti_t7_v9_1_dissect.tes_trade_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_trade_broadcast)
  local index = offset
  ...
  index, package_id = eurex_cash_eti_t7_v9_1_dissect.package_id(buffer, index, packet, parent)
  ...
  index, srqs_related_trade_id = eurex_cash_eti_t7_v9_1_dissect.srqs_related_trade_id(buffer, index, packet, parent)

  -- Trd Type: 2 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, trd_type = eurex_cash_eti_t7_v9_1_dissect.trd_type(buffer, index, packet, parent)
  ...
  index, trade_publish_indicator = eurex_cash_eti_t7_v9_1_dissect.trade_publish_indicator(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.tes_trade_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tes_trade_broadcast = eurex_cash_eti_t7_v9_1_size_of.tes_trade_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tes_trade_broadcast then
    local range = buffer(offset, size_of_tes_trade_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.tes_trade_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tes_trade_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tes_trade_broadcast_fields(buffer, offset, packet, parent, size_of_tes_trade_broadcast)

  return offset + size_of_tes_trade_broadcast
end

-- Size: Trade Report Id
eurex_cash_eti_t7_v9_1_size_of.trade_report_id = 20

-- Display: Trade Report Id
eurex_cash_eti_t7_v9_1_display.trade_report_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.trade_report_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_report_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.trade_report_id(value, buffer, offset, packet, parent)
...
-- Size: Tes Exec Id
eurex_cash_eti_t7_v9_1_size_of.tes_exec_id = 4

-- Display: Tes Exec Id
eurex_cash_eti_t7_v9_1_display.tes_exec_id = function(value)
  return "Tes Exec Id: "..value
end

-- Dissect: Tes Exec Id
eurex_cash_eti_t7_v9_1_dissect.tes_exec_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.tes_exec_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.tes_exec_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.tes_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tes_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Response
eurex_cash_eti_t7_v9_1_dissect.tes_response_fields = function(buffer, offset, packet, parent, size_of_tes_response)
  local index = offset
  ...
  index, tes_exec_id = eurex_cash_eti_t7_v9_1_dissect.tes_exec_id(buffer, index, packet, parent)

  -- Trade Report Id: 20 Byte Ascii String Nullable
  index, trade_report_id = eurex_cash_eti_t7_v9_1_dissect.trade_report_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Tes Response
eurex_cash_eti_t7_v9_1_dissect.tes_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tes_response = eurex_cash_eti_t7_v9_1_size_of.tes_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tes_response then
    local range = buffer(offset, size_of_tes_response)
    local display = eurex_cash_eti_t7_v9_1_display.tes_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tes_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tes_response_fields(buffer, offset, packet, parent, size_of_tes_response)

  return offset + size_of_tes_response
end

-- Size: Alloc Id
eurex_cash_eti_t7_v9_1_size_of.alloc_id = 4

-- Display: Alloc Id
eurex_cash_eti_t7_v9_1_display.alloc_id = function(value)
  return "Alloc Id: "..value
end

-- Dissect: Alloc Id
eurex_cash_eti_t7_v9_1_dissect.alloc_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.alloc_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.alloc_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.tes_execution_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tes_execution_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Execution Broadcast
eurex_cash_eti_t7_v9_1_dissect.tes_execution_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_execution_broadcast)
  local index = offset
  ...
  index, alloc_id = eurex_cash_eti_t7_v9_1_dissect.alloc_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.tes_execution_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tes_execution_broadcast = eurex_cash_eti_t7_v9_1_size_of.tes_execution_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tes_execution_broadcast then
    local range = buffer(offset, size_of_tes_execution_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.tes_execution_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tes_execution_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tes_execution_broadcast_fields(buffer, offset, packet, parent, size_of_tes_execution_broadcast)

  return offset + size_of_tes_execution_broadcast
end

-- Size: Delete Reason
eurex_cash_eti_t7_v9_1_size_of.delete_reason = 1

-- Display: Delete Reason
eurex_cash_eti_t7_v9_1_display.delete_reason = function(value)
  if value == 100 then
...
eurex_cash_eti_t7_v9_1_dissect.delete_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.delete_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.delete_reason(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.tes_delete_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tes_delete_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Delete Broadcast
eurex_cash_eti_t7_v9_1_dissect.tes_delete_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_delete_broadcast)
  local index = offset
  ...
  index, delete_reason = eurex_cash_eti_t7_v9_1_dissect.delete_reason(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.tes_delete_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tes_delete_broadcast = eurex_cash_eti_t7_v9_1_size_of.tes_delete_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tes_delete_broadcast then
    local range = buffer(offset, size_of_tes_delete_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.tes_delete_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tes_delete_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tes_delete_broadcast_fields(buffer, offset, packet, parent, size_of_tes_delete_broadcast)

  return offset + size_of_tes_delete_broadcast
end

-- Display: Var Text
eurex_cash_eti_t7_v9_1_display.var_text = function(value)
  return "Var Text: "..value
end

-- Dissect runtime sized field: Var Text
eurex_cash_eti_t7_v9_1_dissect.var_text = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = eurex_cash_eti_t7_v9_1_display.var_text(value, buffer, offset, packet, parent, size)
...
eurex_cash_eti_t7_v9_1_size_of.trade_alloc_status = 1

-- Display: Trade Alloc Status
eurex_cash_eti_t7_v9_1_display.trade_alloc_status = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.trade_alloc_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_alloc_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_alloc_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.tes_enrichment_rule_id = 4

-- Display: Tes Enrichment Rule Id
eurex_cash_eti_t7_v9_1_display.tes_enrichment_rule_id = function(value)
  return "Tes Enrichment Rule Id: "..value
end

-- Dissect: Tes Enrichment Rule Id
eurex_cash_eti_t7_v9_1_dissect.tes_enrichment_rule_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.tes_enrichment_rule_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.tes_enrichment_rule_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.individual_alloc_id = 4

-- Display: Individual Alloc Id
eurex_cash_eti_t7_v9_1_display.individual_alloc_id = function(value)
  return "Individual Alloc Id: "..value
end

-- Dissect: Individual Alloc Id
eurex_cash_eti_t7_v9_1_dissect.individual_alloc_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.individual_alloc_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.individual_alloc_id(value, buffer, offset, packet, parent)
...
-- Dissect: Alloc Qty
eurex_cash_eti_t7_v9_1_dissect.alloc_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.alloc_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.side_alloc_grp_bc_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.alloc_qty

  index = index + eurex_cash_eti_t7_v9_1_size_of.individual_alloc_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.tes_enrichment_rule_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_executing_firm

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_executing_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.side

  index = index + eurex_cash_eti_t7_v9_1_size_of.trade_alloc_status

  index = index + eurex_cash_eti_t7_v9_1_size_of.pad_3

  return index
end

-- Display: Side Alloc Grp Bc Comp
eurex_cash_eti_t7_v9_1_display.side_alloc_grp_bc_comp = function(buffer, offset, size, packet, parent)
  return ""
end
...
eurex_cash_eti_t7_v9_1_dissect.side_alloc_grp_bc_comp_fields = function(buffer, offset, packet, parent)
  ...
  index, individual_alloc_id = eurex_cash_eti_t7_v9_1_dissect.individual_alloc_id(buffer, index, packet, parent)

  -- Tes Enrichment Rule Id: 4 Byte Unsigned Fixed Width Integer
  index, tes_enrichment_rule_id = eurex_cash_eti_t7_v9_1_dissect.tes_enrichment_rule_id(buffer, index, packet, parent)
  ...
  index, trade_alloc_status = eurex_cash_eti_t7_v9_1_dissect.trade_alloc_status(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.side_alloc_grp_bc_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.side_alloc_grp_bc_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.side_alloc_grp_bc_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.side_alloc_grp_bc_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.side_alloc_grp_bc_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.side_alloc_grp_bc_comp_fields(buffer, offset, packet, parent)
end

-- Size: Trade Report Text
eurex_cash_eti_t7_v9_1_size_of.trade_report_text = 20

-- Display: Trade Report Text
eurex_cash_eti_t7_v9_1_display.trade_report_text = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.trade_report_text = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_report_text
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.trade_report_text(value, buffer, offset, packet, parent)
...
-- Size: No Side Allocs
eurex_cash_eti_t7_v9_1_size_of.no_side_allocs = 1

-- Display: No Side Allocs
eurex_cash_eti_t7_v9_1_display.no_side_allocs = function(value)
  return "No Side Allocs: "..value
end

-- Dissect: No Side Allocs
eurex_cash_eti_t7_v9_1_dissect.no_side_allocs = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_side_allocs
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_side_allocs(value, buffer, offset, packet, parent)
...
-- Size: Var Text Len
eurex_cash_eti_t7_v9_1_size_of.var_text_len = 2

-- Display: Var Text Len
eurex_cash_eti_t7_v9_1_display.var_text_len = function(value)
  return "Var Text Len: "..value
end

-- Dissect: Var Text Len
eurex_cash_eti_t7_v9_1_dissect.var_text_len = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.var_text_len
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.var_text_len(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.auto_approval_rule_id = 4

-- Display: Auto Approval Rule Id
eurex_cash_eti_t7_v9_1_display.auto_approval_rule_id = function(value)
  return "Auto Approval Rule Id: "..value
end

-- Dissect: Auto Approval Rule Id
eurex_cash_eti_t7_v9_1_dissect.auto_approval_rule_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.auto_approval_rule_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.auto_approval_rule_id(value, buffer, offset, packet, parent)
...
-- Size: Trans Bkd Time
eurex_cash_eti_t7_v9_1_size_of.trans_bkd_time = 8

-- Display: Trans Bkd Time
eurex_cash_eti_t7_v9_1_display.trans_bkd_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.trans_bkd_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trans_bkd_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.trans_bkd_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.tes_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tes_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Broadcast
eurex_cash_eti_t7_v9_1_dissect.tes_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_broadcast)
  local index = offset
  ...
  index, auto_approval_rule_id = eurex_cash_eti_t7_v9_1_dissect.auto_approval_rule_id(buffer, index, packet, parent)

  -- Trd Type: 2 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, trd_type = eurex_cash_eti_t7_v9_1_dissect.trd_type(buffer, index, packet, parent)

  -- Var Text Len: 2 Byte Unsigned Fixed Width Integer
  index, var_text_len = eurex_cash_eti_t7_v9_1_dissect.var_text_len(buffer, index, packet, parent)
  ...
  index, no_side_allocs = eurex_cash_eti_t7_v9_1_dissect.no_side_allocs(buffer, index, packet, parent)

  -- Message Event Source: 1 Byte Ascii String Enum with 4 values
  index, message_event_source = eurex_cash_eti_t7_v9_1_dissect.message_event_source(buffer, index, packet, parent)

  -- Trade Report Text: 20 Byte Ascii String Nullable
  index, trade_report_text = eurex_cash_eti_t7_v9_1_dissect.trade_report_text(buffer, index, packet, parent)
  ...
  for i = 1, no_side_allocs do
    index = eurex_cash_eti_t7_v9_1_dissect.side_alloc_grp_bc_comp(buffer, index, packet, parent)
  end

  -- Var Text: 2000 Byte Ascii String Nullable
  index = eurex_cash_eti_t7_v9_1_dissect.var_text(buffer, index, packet, parent, var_text_len)

  return index
end

-- Dissect: Tes Broadcast
eurex_cash_eti_t7_v9_1_dissect.tes_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tes_broadcast = eurex_cash_eti_t7_v9_1_size_of.tes_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tes_broadcast then
    local range = buffer(offset, size_of_tes_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.tes_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tes_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tes_broadcast_fields(buffer, offset, packet, parent, size_of_tes_broadcast)

  return offset + size_of_tes_broadcast
end

-- Size: Party Id Entering Firm
eurex_cash_eti_t7_v9_1_size_of.party_id_entering_firm = 1

-- Display: Party Id Entering Firm
eurex_cash_eti_t7_v9_1_display.party_id_entering_firm = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.party_id_entering_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_entering_firm
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_entering_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.tes_approve_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.tes_approve_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Approve Broadcast
eurex_cash_eti_t7_v9_1_dissect.tes_approve_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_approve_broadcast)
  local index = offset
  ...
  index, party_id_entering_firm = eurex_cash_eti_t7_v9_1_dissect.party_id_entering_firm(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.tes_approve_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_tes_approve_broadcast = eurex_cash_eti_t7_v9_1_size_of.tes_approve_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.tes_approve_broadcast then
    local range = buffer(offset, size_of_tes_approve_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.tes_approve_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.tes_approve_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.tes_approve_broadcast_fields(buffer, offset, packet, parent, size_of_tes_approve_broadcast)

  return offset + size_of_tes_approve_broadcast
end

-- Read runtime size of: Subscribe Response
eurex_cash_eti_t7_v9_1_size_of.subscribe_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.subscribe_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Subscribe Response
eurex_cash_eti_t7_v9_1_dissect.subscribe_response_fields = function(buffer, offset, packet, parent, size_of_subscribe_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.subscribe_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_subscribe_response = eurex_cash_eti_t7_v9_1_size_of.subscribe_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.subscribe_response then
    local range = buffer(offset, size_of_subscribe_response)
    local display = eurex_cash_eti_t7_v9_1_display.subscribe_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.subscribe_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.subscribe_response_fields(buffer, offset, packet, parent, size_of_subscribe_response)

  return offset + size_of_subscribe_response
end

-- Size: Ref Appl Id
eurex_cash_eti_t7_v9_1_size_of.ref_appl_id = 1

-- Display: Ref Appl Id
eurex_cash_eti_t7_v9_1_display.ref_appl_id = function(value)
  if value == 1 then
...
-- Dissect: Ref Appl Id
eurex_cash_eti_t7_v9_1_dissect.ref_appl_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.ref_appl_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.ref_appl_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.subscription_scope = 4

-- Display: Subscription Scope
eurex_cash_eti_t7_v9_1_display.subscription_scope = function(value)
  return "Subscription Scope: "..value
end

-- Dissect: Subscription Scope
eurex_cash_eti_t7_v9_1_dissect.subscription_scope = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.subscription_scope
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.subscription_scope(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.subscribe_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.subscribe_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Subscribe Request
eurex_cash_eti_t7_v9_1_dissect.subscribe_request_fields = function(buffer, offset, packet, parent, size_of_subscribe_request)
  local index = offset
  ...
  index, subscription_scope = eurex_cash_eti_t7_v9_1_dissect.subscription_scope(buffer, index, packet, parent)

  -- Ref Appl Id: 1 Byte Unsigned Fixed Width Integer Enum with 11 values
  index, ref_appl_id = eurex_cash_eti_t7_v9_1_dissect.ref_appl_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.subscribe_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_subscribe_request = eurex_cash_eti_t7_v9_1_size_of.subscribe_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.subscribe_request then
    local range = buffer(offset, size_of_subscribe_request)
    local display = eurex_cash_eti_t7_v9_1_display.subscribe_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.subscribe_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.subscribe_request_fields(buffer, offset, packet, parent, size_of_subscribe_request)

  return offset + size_of_subscribe_request
end

-- Size: Security Status Report Id
eurex_cash_eti_t7_v9_1_size_of.security_status_report_id = 8

-- Display: Security Status Report Id
eurex_cash_eti_t7_v9_1_display.security_status_report_id = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.security_status_report_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.security_status_report_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.security_status_report_id(value, buffer, offset, packet, parent)
...
-- Size: Response In
eurex_cash_eti_t7_v9_1_size_of.response_in = 8

-- Display: Response In
eurex_cash_eti_t7_v9_1_display.response_in = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
-- Dissect: Response In
eurex_cash_eti_t7_v9_1_dissect.response_in = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.response_in
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.response_in(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_in = 8

-- Display: Trd Reg Ts Time In
eurex_cash_eti_t7_v9_1_display.trd_reg_ts_time_in = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_time_in = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_in
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.trd_reg_ts_time_in(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.nr_response_header_me_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.request_time

  index = index + eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_in

  index = index + eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_out

  index = index + eurex_cash_eti_t7_v9_1_size_of.response_in
...
eurex_cash_eti_t7_v9_1_display.nr_response_header_me_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Nr Response Header Me Comp
eurex_cash_eti_t7_v9_1_dissect.nr_response_header_me_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, trd_reg_ts_time_in = eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_time_in(buffer, index, packet, parent)

  -- Trd Reg Ts Time Out: 8 Byte Unsigned Fixed Width Integer
  index, trd_reg_ts_time_out = eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_time_out(buffer, index, packet, parent)

  -- Response In: 8 Byte Unsigned Fixed Width Integer
  index, response_in = eurex_cash_eti_t7_v9_1_dissect.response_in(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.nr_response_header_me_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.nr_response_header_me_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.nr_response_header_me_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.nr_response_header_me_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.nr_response_header_me_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.nr_response_header_me_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Specialist Security State Change Response
eurex_cash_eti_t7_v9_1_size_of.specialist_security_state_change_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_security_state_change_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Security State Change Response
eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_response_fields = function(buffer, offset, packet, parent, size_of_specialist_security_state_change_response)
  local index = offset
  ...
  index, nr_response_header_me_comp = eurex_cash_eti_t7_v9_1_dissect.nr_response_header_me_comp(buffer, index, packet, parent)

  -- Security Status Report Id: 8 Byte Unsigned Fixed Width Integer
  index, security_status_report_id = eurex_cash_eti_t7_v9_1_dissect.security_status_report_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Specialist Security State Change Response
eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_security_state_change_response = eurex_cash_eti_t7_v9_1_size_of.specialist_security_state_change_response(buffer, offset)
  ...
  if show.specialist_security_state_change_response then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.specialist_security_state_change_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_security_state_change_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_response_fields(buffer, offset, packet, parent, size_of_specialist_security_state_change_response)

  return offset + size_of_specialist_security_state_change_response
end

-- Size: Event Type
eurex_cash_eti_t7_v9_1_size_of.event_type = 1

-- Display: Event Type
eurex_cash_eti_t7_v9_1_display.event_type = function(value)
  if value == 26 then
...
-- Dissect: Event Type
eurex_cash_eti_t7_v9_1_dissect.event_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.event_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.event_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.specialist_security_state_change_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_security_state_change_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Security State Change Request
eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_request_fields = function(buffer, offset, packet, parent, size_of_specialist_security_state_change_request)
  local index = offset
  ...
  index, event_type = eurex_cash_eti_t7_v9_1_dissect.event_type(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_security_state_change_request = eurex_cash_eti_t7_v9_1_size_of.specialist_security_state_change_request(buffer, offset)
  ...
  if show.specialist_security_state_change_request then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.specialist_security_state_change_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_security_state_change_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_request_fields(buffer, offset, packet, parent, size_of_specialist_security_state_change_request)

  return offset + size_of_specialist_security_state_change_request
end

-- Read runtime size of: Specialist Rfq Reply Response
eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_rfq_reply_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Rfq Reply Response
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_response_fields = function(buffer, offset, packet, parent, size_of_specialist_rfq_reply_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_rfq_reply_response = eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.specialist_rfq_reply_response then
    local range = buffer(offset, size_of_specialist_rfq_reply_response)
    local display = eurex_cash_eti_t7_v9_1_display.specialist_rfq_reply_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_rfq_reply_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_response_fields(buffer, offset, packet, parent, size_of_specialist_rfq_reply_response)

  return offset + size_of_specialist_rfq_reply_response
end

-- Read runtime size of: Specialist Rfq Reply Request
eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_rfq_reply_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Rfq Reply Request
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_request_fields = function(buffer, offset, packet, parent, size_of_specialist_rfq_reply_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_rfq_reply_request = eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.specialist_rfq_reply_request then
    local range = buffer(offset, size_of_specialist_rfq_reply_request)
    local display = eurex_cash_eti_t7_v9_1_display.specialist_rfq_reply_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_rfq_reply_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_request_fields(buffer, offset, packet, parent, size_of_specialist_rfq_reply_request)

  return offset + size_of_specialist_rfq_reply_request
end

-- Read runtime size of: Specialist Rfq Reply Notification
eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_rfq_reply_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Rfq Reply Notification
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_notification_fields = function(buffer, offset, packet, parent, size_of_specialist_rfq_reply_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_rfq_reply_notification = eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.specialist_rfq_reply_notification then
    local range = buffer(offset, size_of_specialist_rfq_reply_notification)
    local display = eurex_cash_eti_t7_v9_1_display.specialist_rfq_reply_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_rfq_reply_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_notification_fields(buffer, offset, packet, parent, size_of_specialist_rfq_reply_notification)

  return offset + size_of_specialist_rfq_reply_notification
end

-- Size: Quote Request Reject Reason
eurex_cash_eti_t7_v9_1_size_of.quote_request_reject_reason = 1

-- Display: Quote Request Reject Reason
eurex_cash_eti_t7_v9_1_display.quote_request_reject_reason = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_request_reject_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_request_reject_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_request_reject_reason(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reject_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_rfq_reject_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Rfq Reject Request
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reject_request_fields = function(buffer, offset, packet, parent, size_of_specialist_rfq_reject_request)
  local index = offset
  ...
  index, quote_request_reject_reason = eurex_cash_eti_t7_v9_1_dissect.quote_request_reject_reason(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reject_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_rfq_reject_request = eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reject_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.specialist_rfq_reject_request then
    local range = buffer(offset, size_of_specialist_rfq_reject_request)
    local display = eurex_cash_eti_t7_v9_1_display.specialist_rfq_reject_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_rfq_reject_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reject_request_fields(buffer, offset, packet, parent, size_of_specialist_rfq_reject_request)

  return offset + size_of_specialist_rfq_reject_request
end

-- Size: Fill Liquidity Ind
eurex_cash_eti_t7_v9_1_size_of.fill_liquidity_ind = 1

-- Display: Fill Liquidity Ind
eurex_cash_eti_t7_v9_1_display.fill_liquidity_ind = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.fill_liquidity_ind = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fill_liquidity_ind
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.fill_liquidity_ind(value, buffer, offset, packet, parent)
...
-- Size: Fill Exec Id
eurex_cash_eti_t7_v9_1_size_of.fill_exec_id = 4

-- Display: Fill Exec Id
eurex_cash_eti_t7_v9_1_display.fill_exec_id = function(value)
  return "Fill Exec Id: "..value
end

-- Dissect: Fill Exec Id
eurex_cash_eti_t7_v9_1_dissect.fill_exec_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fill_exec_id
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = eurex_cash_eti_t7_v9_1_display.fill_exec_id(value, buffer, offset, packet, parent)
...
-- Size: Fill Match Id
eurex_cash_eti_t7_v9_1_size_of.fill_match_id = 4

-- Display: Fill Match Id
eurex_cash_eti_t7_v9_1_display.fill_match_id = function(value)
  return "Fill Match Id: "..value
end

-- Dissect: Fill Match Id
eurex_cash_eti_t7_v9_1_dissect.fill_match_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fill_match_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.fill_match_id(value, buffer, offset, packet, parent)
...
-- Dissect: Fill Qty
eurex_cash_eti_t7_v9_1_dissect.fill_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fill_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
-- Dissect: Fill Px
eurex_cash_eti_t7_v9_1_dissect.fill_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fill_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.fills_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.fill_px

  index = index + eurex_cash_eti_t7_v9_1_size_of.fill_qty

  index = index + eurex_cash_eti_t7_v9_1_size_of.fill_match_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.fill_exec_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.fill_liquidity_ind
...
eurex_cash_eti_t7_v9_1_display.fills_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end
...
eurex_cash_eti_t7_v9_1_dissect.fills_grp_comp_fields = function(buffer, offset, packet, parent)
  ...
  index, fill_match_id = eurex_cash_eti_t7_v9_1_dissect.fill_match_id(buffer, index, packet, parent)

  -- Fill Exec Id: 4 Byte Signed Fixed Width Integer
  index, fill_exec_id = eurex_cash_eti_t7_v9_1_dissect.fill_exec_id(buffer, index, packet, parent)

  -- Fill Liquidity Ind: 1 Byte Unsigned Fixed Width Integer Enum with 6 values
  index, fill_liquidity_ind = eurex_cash_eti_t7_v9_1_dissect.fill_liquidity_ind(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.fills_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.fills_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.fills_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.fills_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.fills_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.fills_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: Party Entering Firm
eurex_cash_eti_t7_v9_1_size_of.party_entering_firm = 5

-- Display: Party Entering Firm
eurex_cash_eti_t7_v9_1_display.party_entering_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Party Entering Firm: No Value"
  end
...
eurex_cash_eti_t7_v9_1_dissect.party_entering_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_entering_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_entering_firm(value, buffer, offset, packet, parent)
...
-- Size: Triggered
eurex_cash_eti_t7_v9_1_size_of.triggered = 1

-- Display: Triggered
eurex_cash_eti_t7_v9_1_display.triggered = function(value)
  if value == 0 then
...
-- Dissect: Triggered
eurex_cash_eti_t7_v9_1_dissect.triggered = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.triggered
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.triggered(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.appl_seq_indicator = 1

-- Display: Appl Seq Indicator
eurex_cash_eti_t7_v9_1_display.appl_seq_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.appl_seq_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_seq_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_seq_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trading_session_sub_id = 1

-- Display: Trading Session Sub Id
eurex_cash_eti_t7_v9_1_display.trading_session_sub_id = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.trading_session_sub_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trading_session_sub_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trading_session_sub_id(value, buffer, offset, packet, parent)
...
-- Size: Exec Inst
eurex_cash_eti_t7_v9_1_size_of.exec_inst = 1

-- Display: Exec Inst
eurex_cash_eti_t7_v9_1_display.exec_inst = function(value)
  if value == 1 then
...
-- Dissect: Exec Inst
eurex_cash_eti_t7_v9_1_dissect.exec_inst = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.exec_inst
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.exec_inst(value, buffer, offset, packet, parent)
...
-- Size: Time In Force
eurex_cash_eti_t7_v9_1_size_of.time_in_force = 1

-- Display: Time In Force
eurex_cash_eti_t7_v9_1_display.time_in_force = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.time_in_force = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.time_in_force
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.time_in_force(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.order_event_type = 1

-- Display: Order Event Type
eurex_cash_eti_t7_v9_1_display.order_event_type = function(value)
  if value == 100 then
...
eurex_cash_eti_t7_v9_1_dissect.order_event_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_event_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.order_event_type(value, buffer, offset, packet, parent)
...
-- Size: No Fills
eurex_cash_eti_t7_v9_1_size_of.no_fills = 1

-- Display: No Fills
eurex_cash_eti_t7_v9_1_display.no_fills = function(value)
  return "No Fills: "..value
end

-- Dissect: No Fills
eurex_cash_eti_t7_v9_1_dissect.no_fills = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_fills
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_fills(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_entering_trader = 4

-- Display: Party Id Entering Trader
eurex_cash_eti_t7_v9_1_display.party_id_entering_trader = function(value)
  return "Party Id Entering Trader: "..value
end

-- Dissect: Party Id Entering Trader
eurex_cash_eti_t7_v9_1_dissect.party_id_entering_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_entering_trader
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_entering_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_session_id = 4

-- Display: Party Id Session Id
eurex_cash_eti_t7_v9_1_display.party_id_session_id = function(value)
  return "Party Id Session Id: "..value
end

-- Dissect: Party Id Session Id
eurex_cash_eti_t7_v9_1_dissect.party_id_session_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_session_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_session_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_id_executing_unit = 4

-- Display: Party Id Executing Unit
eurex_cash_eti_t7_v9_1_display.party_id_executing_unit = function(value)
  return "Party Id Executing Unit: "..value
end

-- Dissect: Party Id Executing Unit
eurex_cash_eti_t7_v9_1_dissect.party_id_executing_unit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_id_executing_unit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_id_executing_unit(value, buffer, offset, packet, parent)
...
-- Size: Expire Date
eurex_cash_eti_t7_v9_1_size_of.expire_date = 4

-- Display: Expire Date
eurex_cash_eti_t7_v9_1_display.expire_date = function(value)
  return "Expire Date: "..value
end

-- Dissect: Expire Date
eurex_cash_eti_t7_v9_1_dissect.expire_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.expire_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.expire_date(value, buffer, offset, packet, parent)
...
-- Dissect: Cxl Qty
eurex_cash_eti_t7_v9_1_dissect.cxl_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.cxl_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_priority = 8

-- Display: Trd Reg Ts Time Priority
eurex_cash_eti_t7_v9_1_display.trd_reg_ts_time_priority = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_time_priority = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_time_priority
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.trd_reg_ts_time_priority(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_entry_time = 8

-- Display: Trd Reg Ts Entry Time
eurex_cash_eti_t7_v9_1_display.trd_reg_ts_entry_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.trd_reg_ts_entry_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trd_reg_ts_entry_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.trd_reg_ts_entry_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.specialist_order_book_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_order_book_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Order Book Notification
eurex_cash_eti_t7_v9_1_dissect.specialist_order_book_notification_fields = function(buffer, offset, packet, parent, size_of_specialist_order_book_notification)
  local index = offset
  ...
  index, expire_date = eurex_cash_eti_t7_v9_1_dissect.expire_date(buffer, index, packet, parent)

  -- Party Id Executing Unit: 4 Byte Unsigned Fixed Width Integer
  index, party_id_executing_unit = eurex_cash_eti_t7_v9_1_dissect.party_id_executing_unit(buffer, index, packet, parent)

  -- Party Id Session Id: 4 Byte Unsigned Fixed Width Integer
  index, party_id_session_id = eurex_cash_eti_t7_v9_1_dissect.party_id_session_id(buffer, index, packet, parent)

  -- Party Id Executing Trader: 4 Byte Unsigned Fixed Width Integer
  index, party_id_executing_trader = eurex_cash_eti_t7_v9_1_dissect.party_id_executing_trader(buffer, index, packet, parent)

  -- Party Id Entering Trader: 4 Byte Unsigned Fixed Width Integer
  index, party_id_entering_trader = eurex_cash_eti_t7_v9_1_dissect.party_id_entering_trader(buffer, index, packet, parent)

  -- No Fills: 1 Byte Unsigned Fixed Width Integer
  index, no_fills = eurex_cash_eti_t7_v9_1_dissect.no_fills(buffer, index, packet, parent)
  ...
  index, order_event_type = eurex_cash_eti_t7_v9_1_dissect.order_event_type(buffer, index, packet, parent)
  ...
  index, time_in_force = eurex_cash_eti_t7_v9_1_dissect.time_in_force(buffer, index, packet, parent)

  -- Exec Inst: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, exec_inst = eurex_cash_eti_t7_v9_1_dissect.exec_inst(buffer, index, packet, parent)

  -- Trading Session Sub Id: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, trading_session_sub_id = eurex_cash_eti_t7_v9_1_dissect.trading_session_sub_id(buffer, index, packet, parent)

  -- Appl Seq Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, appl_seq_indicator = eurex_cash_eti_t7_v9_1_dissect.appl_seq_indicator(buffer, index, packet, parent)

  -- Triggered: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, triggered = eurex_cash_eti_t7_v9_1_dissect.triggered(buffer, index, packet, parent)

  -- Order Attribute Liquidity Provision: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, order_attribute_liquidity_provision = eurex_cash_eti_t7_v9_1_dissect.order_attribute_liquidity_provision(buffer, index, packet, parent)

  -- Party Entering Firm: 5 Byte Ascii String Nullable
  index, party_entering_firm = eurex_cash_eti_t7_v9_1_dissect.party_entering_firm(buffer, index, packet, parent)
  ...
  for i = 1, no_fills do
    index = eurex_cash_eti_t7_v9_1_dissect.fills_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.specialist_order_book_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_order_book_notification = eurex_cash_eti_t7_v9_1_size_of.specialist_order_book_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.specialist_order_book_notification then
    local range = buffer(offset, size_of_specialist_order_book_notification)
    local display = eurex_cash_eti_t7_v9_1_display.specialist_order_book_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_order_book_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_order_book_notification_fields(buffer, offset, packet, parent, size_of_specialist_order_book_notification)

  return offset + size_of_specialist_order_book_notification
end

-- Read runtime size of: Specialist Instrument Event Notification
eurex_cash_eti_t7_v9_1_size_of.specialist_instrument_event_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_instrument_event_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Instrument Event Notification
eurex_cash_eti_t7_v9_1_dissect.specialist_instrument_event_notification_fields = function(buffer, offset, packet, parent, size_of_specialist_instrument_event_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.specialist_instrument_event_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_instrument_event_notification = eurex_cash_eti_t7_v9_1_size_of.specialist_instrument_event_notification(buffer, offset)
  ...
  if show.specialist_instrument_event_notification then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.specialist_instrument_event_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_instrument_event_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_instrument_event_notification_fields(buffer, offset, packet, parent, size_of_specialist_instrument_event_notification)

  return offset + size_of_specialist_instrument_event_notification
end

-- Size: Not Aff Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_size_of.not_aff_orig_cl_ord_id = 8

-- Display: Not Aff Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_display.not_aff_orig_cl_ord_id = function(value)
  return "Not Aff Orig Cl Ord Id: "..value
end

-- Dissect: Not Aff Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_dissect.not_aff_orig_cl_ord_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.not_aff_orig_cl_ord_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.not_aff_orig_cl_ord_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.not_affected_order_id = 8

-- Display: Not Affected Order Id
eurex_cash_eti_t7_v9_1_display.not_affected_order_id = function(value)
  return "Not Affected Order Id: "..value
end

-- Dissect: Not Affected Order Id
eurex_cash_eti_t7_v9_1_dissect.not_affected_order_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.not_affected_order_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.not_affected_order_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.not_affected_orders_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.not_affected_order_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.not_aff_orig_cl_ord_id

  return index
end

-- Display: Not Affected Orders Grp Comp
eurex_cash_eti_t7_v9_1_display.not_affected_orders_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Not Affected Orders Grp Comp
eurex_cash_eti_t7_v9_1_dissect.not_affected_orders_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Not Affected Order Id: 8 Byte Unsigned Fixed Width Integer
  index, not_affected_order_id = eurex_cash_eti_t7_v9_1_dissect.not_affected_order_id(buffer, index, packet, parent)

  -- Not Aff Orig Cl Ord Id: 8 Byte Unsigned Fixed Width Integer
  index, not_aff_orig_cl_ord_id = eurex_cash_eti_t7_v9_1_dissect.not_aff_orig_cl_ord_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Not Affected Orders Grp Comp
eurex_cash_eti_t7_v9_1_dissect.not_affected_orders_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.not_affected_orders_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.not_affected_orders_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.not_affected_orders_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.not_affected_orders_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.not_affected_orders_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: Affected Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_size_of.affected_orig_cl_ord_id = 8

-- Display: Affected Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_display.affected_orig_cl_ord_id = function(value)
  return "Affected Orig Cl Ord Id: "..value
end

-- Dissect: Affected Orig Cl Ord Id
eurex_cash_eti_t7_v9_1_dissect.affected_orig_cl_ord_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.affected_orig_cl_ord_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.affected_orig_cl_ord_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.affected_order_id = 8

-- Display: Affected Order Id
eurex_cash_eti_t7_v9_1_display.affected_order_id = function(value)
  return "Affected Order Id: "..value
end

-- Dissect: Affected Order Id
eurex_cash_eti_t7_v9_1_dissect.affected_order_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.affected_order_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.affected_order_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.affected_ord_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.affected_order_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.affected_orig_cl_ord_id

  return index
end

-- Display: Affected Ord Grp Comp
eurex_cash_eti_t7_v9_1_display.affected_ord_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Affected Ord Grp Comp
eurex_cash_eti_t7_v9_1_dissect.affected_ord_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Affected Order Id: 8 Byte Unsigned Fixed Width Integer
  index, affected_order_id = eurex_cash_eti_t7_v9_1_dissect.affected_order_id(buffer, index, packet, parent)

  -- Affected Orig Cl Ord Id: 8 Byte Unsigned Fixed Width Integer
  index, affected_orig_cl_ord_id = eurex_cash_eti_t7_v9_1_dissect.affected_orig_cl_ord_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Affected Ord Grp Comp
eurex_cash_eti_t7_v9_1_dissect.affected_ord_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.affected_ord_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.affected_ord_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.affected_ord_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.affected_ord_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.affected_ord_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: Mass Action Reason
eurex_cash_eti_t7_v9_1_size_of.mass_action_reason = 1

-- Display: Mass Action Reason
eurex_cash_eti_t7_v9_1_display.mass_action_reason = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.mass_action_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.mass_action_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.mass_action_reason(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.no_not_affected_orders = 2

-- Display: No Not Affected Orders
eurex_cash_eti_t7_v9_1_display.no_not_affected_orders = function(value)
  return "No Not Affected Orders: "..value
end

-- Dissect: No Not Affected Orders
eurex_cash_eti_t7_v9_1_dissect.no_not_affected_orders = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_not_affected_orders
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_not_affected_orders(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.no_affected_orders = 2

-- Display: No Affected Orders
eurex_cash_eti_t7_v9_1_display.no_affected_orders = function(value)
  return "No Affected Orders: "..value
end

-- Dissect: No Affected Orders
eurex_cash_eti_t7_v9_1_dissect.no_affected_orders = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_affected_orders
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_affected_orders(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.mass_action_report_id = 8

-- Display: Mass Action Report Id
eurex_cash_eti_t7_v9_1_display.mass_action_report_id = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.mass_action_report_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.mass_action_report_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.mass_action_report_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.specialist_delete_all_order_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.specialist_delete_all_order_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Specialist Delete All Order Broadcast
eurex_cash_eti_t7_v9_1_dissect.specialist_delete_all_order_broadcast_fields = function(buffer, offset, packet, parent, size_of_specialist_delete_all_order_broadcast)
  local index = offset
  ...
  index, mass_action_report_id = eurex_cash_eti_t7_v9_1_dissect.mass_action_report_id(buffer, index, packet, parent)
  ...
  index, no_affected_orders = eurex_cash_eti_t7_v9_1_dissect.no_affected_orders(buffer, index, packet, parent)

  -- No Not Affected Orders: 2 Byte Unsigned Fixed Width Integer
  index, no_not_affected_orders = eurex_cash_eti_t7_v9_1_dissect.no_not_affected_orders(buffer, index, packet, parent)

  -- Party Id Entering Firm: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, party_id_entering_firm = eurex_cash_eti_t7_v9_1_dissect.party_id_entering_firm(buffer, index, packet, parent)

  -- Mass Action Reason: 1 Byte Unsigned Fixed Width Integer Enum with 17 values
  index, mass_action_reason = eurex_cash_eti_t7_v9_1_dissect.mass_action_reason(buffer, index, packet, parent)
  ...
  for i = 1, no_affected_orders do
    index = eurex_cash_eti_t7_v9_1_dissect.affected_ord_grp_comp(buffer, index, packet, parent)
  end

  -- Not Affected Orders Grp Comp: Struct of 2 fields
  for i = 1, no_not_affected_orders do
    index = eurex_cash_eti_t7_v9_1_dissect.not_affected_orders_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.specialist_delete_all_order_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_specialist_delete_all_order_broadcast = eurex_cash_eti_t7_v9_1_size_of.specialist_delete_all_order_broadcast(buffer, offset)
  ...
  if show.specialist_delete_all_order_broadcast then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.specialist_delete_all_order_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.specialist_delete_all_order_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.specialist_delete_all_order_broadcast_fields(buffer, offset, packet, parent, size_of_specialist_delete_all_order_broadcast)

  return offset + size_of_specialist_delete_all_order_broadcast
end

-- Size: Quote Type
eurex_cash_eti_t7_v9_1_size_of.quote_type = 1

-- Display: Quote Type
eurex_cash_eti_t7_v9_1_display.quote_type = function(value)
  if value == 0 then
...
-- Dissect: Quote Type
eurex_cash_eti_t7_v9_1_dissect.quote_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_size_type = 1

-- Display: Quote Size Type
eurex_cash_eti_t7_v9_1_display.quote_size_type = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_size_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_size_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_size_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.price_validity_check_type = 1

-- Display: Price Validity Check Type
eurex_cash_eti_t7_v9_1_display.price_validity_check_type = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.price_validity_check_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.price_validity_check_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.price_validity_check_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.match_inst_cross_id = 4

-- Display: Match Inst Cross Id
eurex_cash_eti_t7_v9_1_display.match_inst_cross_id = function(value)
  return "Match Inst Cross Id: "..value
end

-- Dissect: Match Inst Cross Id
eurex_cash_eti_t7_v9_1_dissect.match_inst_cross_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.match_inst_cross_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.match_inst_cross_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.single_quote_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.single_quote_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Single Quote Request
eurex_cash_eti_t7_v9_1_dissect.single_quote_request_fields = function(buffer, offset, packet, parent, size_of_single_quote_request)
  local index = offset
  ...
  index, match_inst_cross_id = eurex_cash_eti_t7_v9_1_dissect.match_inst_cross_id(buffer, index, packet, parent)

  -- Price Validity Check Type: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, price_validity_check_type = eurex_cash_eti_t7_v9_1_dissect.price_validity_check_type(buffer, index, packet, parent)
  ...
  index, quote_size_type = eurex_cash_eti_t7_v9_1_dissect.quote_size_type(buffer, index, packet, parent)

  -- Quote Type: 1 Byte Unsigned Fixed Width Integer Enum with 6 values
  index, quote_type = eurex_cash_eti_t7_v9_1_dissect.quote_type(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.single_quote_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_single_quote_request = eurex_cash_eti_t7_v9_1_size_of.single_quote_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.single_quote_request then
    local range = buffer(offset, size_of_single_quote_request)
    local display = eurex_cash_eti_t7_v9_1_display.single_quote_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.single_quote_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.single_quote_request_fields(buffer, offset, packet, parent, size_of_single_quote_request)

  return offset + size_of_single_quote_request
end

-- Size: Selective Request For Quote Service Status
eurex_cash_eti_t7_v9_1_size_of.selective_request_for_quote_service_status = 1

-- Display: Selective Request For Quote Service Status
eurex_cash_eti_t7_v9_1_display.selective_request_for_quote_service_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.selective_request_for_quote_service_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.selective_request_for_quote_service_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.selective_request_for_quote_service_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.selective_request_for_quote_service_trade_date = 4

-- Display: Selective Request For Quote Service Trade Date
eurex_cash_eti_t7_v9_1_display.selective_request_for_quote_service_trade_date = function(value)
  return "Selective Request For Quote Service Trade Date: "..value
end

-- Dissect: Selective Request For Quote Service Trade Date
eurex_cash_eti_t7_v9_1_dissect.selective_request_for_quote_service_trade_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.selective_request_for_quote_service_trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.selective_request_for_quote_service_trade_date(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.nrbc_header_comp = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v9_1_display.nrbc_header_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Nrbc Header Comp
eurex_cash_eti_t7_v9_1_dissect.nrbc_header_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.nrbc_header_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.nrbc_header_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.nrbc_header_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.nrbc_header_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.nrbc_header_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.nrbc_header_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Service Availability Market Broadcast
eurex_cash_eti_t7_v9_1_size_of.service_availability_market_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.service_availability_market_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Service Availability Market Broadcast
eurex_cash_eti_t7_v9_1_dissect.service_availability_market_broadcast_fields = function(buffer, offset, packet, parent, size_of_service_availability_market_broadcast)
  local index = offset
  ...
  index, nrbc_header_comp = eurex_cash_eti_t7_v9_1_dissect.nrbc_header_comp(buffer, index, packet, parent)

  -- Selective Request For Quote Service Trade Date: 4 Byte Unsigned Fixed Width Integer
  index, selective_request_for_quote_service_trade_date = eurex_cash_eti_t7_v9_1_dissect.selective_request_for_quote_service_trade_date(buffer, index, packet, parent)

  -- Selective Request For Quote Service Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, selective_request_for_quote_service_status = eurex_cash_eti_t7_v9_1_dissect.selective_request_for_quote_service_status(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.service_availability_market_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_service_availability_market_broadcast = eurex_cash_eti_t7_v9_1_size_of.service_availability_market_broadcast(buffer, offset)
  ...
  if show.service_availability_market_broadcast then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.service_availability_market_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.service_availability_market_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.service_availability_market_broadcast_fields(buffer, offset, packet, parent, size_of_service_availability_market_broadcast)

  return offset + size_of_service_availability_market_broadcast
end

-- Size: Pad 5
eurex_cash_eti_t7_v9_1_size_of.pad_5 = 5

-- Display: Pad 5
eurex_cash_eti_t7_v9_1_display.pad_5 = function(value)
  return "Pad 5: "..value
end

-- Dissect: Pad 5
eurex_cash_eti_t7_v9_1_dissect.pad_5 = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.pad_5
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.pad_5(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_rtm_status = 1

-- Display: T 7 Entry Service Rtm Status
eurex_cash_eti_t7_v9_1_display.t_7_entry_service_rtm_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_rtm_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_rtm_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.t_7_entry_service_rtm_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_status = 1

-- Display: T 7 Entry Service Status
eurex_cash_eti_t7_v9_1_display.t_7_entry_service_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.t_7_entry_service_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.appl_seq_status = 1

-- Display: Appl Seq Status
eurex_cash_eti_t7_v9_1_display.appl_seq_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.appl_seq_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_seq_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_seq_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trade_manager_status = 1

-- Display: Trade Manager Status
eurex_cash_eti_t7_v9_1_display.trade_manager_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.trade_manager_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_manager_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_manager_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.matching_engine_status = 1

-- Display: Matching Engine Status
eurex_cash_eti_t7_v9_1_display.matching_engine_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.matching_engine_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.matching_engine_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.matching_engine_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_rtm_trade_date = 4

-- Display: T 7 Entry Service Rtm Trade Date
eurex_cash_eti_t7_v9_1_display.t_7_entry_service_rtm_trade_date = function(value)
  return "T 7 Entry Service Rtm Trade Date: "..value
end

-- Dissect: T 7 Entry Service Rtm Trade Date
eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_rtm_trade_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_rtm_trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.t_7_entry_service_rtm_trade_date(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_trade_date = 4

-- Display: T 7 Entry Service Trade Date
eurex_cash_eti_t7_v9_1_display.t_7_entry_service_trade_date = function(value)
  return "T 7 Entry Service Trade Date: "..value
end

-- Dissect: T 7 Entry Service Trade Date
eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_trade_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.t_7_entry_service_trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.t_7_entry_service_trade_date(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.appl_seq_trade_date = 4

-- Display: Appl Seq Trade Date
eurex_cash_eti_t7_v9_1_display.appl_seq_trade_date = function(value)
  return "Appl Seq Trade Date: "..value
end

-- Dissect: Appl Seq Trade Date
eurex_cash_eti_t7_v9_1_dissect.appl_seq_trade_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_seq_trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_seq_trade_date(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.trade_manager_trade_date = 4

-- Display: Trade Manager Trade Date
eurex_cash_eti_t7_v9_1_display.trade_manager_trade_date = function(value)
  return "Trade Manager Trade Date: "..value
end

-- Dissect: Trade Manager Trade Date
eurex_cash_eti_t7_v9_1_dissect.trade_manager_trade_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_manager_trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_manager_trade_date(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.matching_engine_trade_date = 4

-- Display: Matching Engine Trade Date
eurex_cash_eti_t7_v9_1_display.matching_engine_trade_date = function(value)
  return "Matching Engine Trade Date: "..value
end

-- Dissect: Matching Engine Trade Date
eurex_cash_eti_t7_v9_1_dissect.matching_engine_trade_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.matching_engine_trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.matching_engine_trade_date(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.service_availability_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.service_availability_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Service Availability Broadcast
eurex_cash_eti_t7_v9_1_dissect.service_availability_broadcast_fields = function(buffer, offset, packet, parent, size_of_service_availability_broadcast)
  local index = offset
  ...
  index, matching_engine_trade_date = eurex_cash_eti_t7_v9_1_dissect.matching_engine_trade_date(buffer, index, packet, parent)

  -- Trade Manager Trade Date: 4 Byte Unsigned Fixed Width Integer
  index, trade_manager_trade_date = eurex_cash_eti_t7_v9_1_dissect.trade_manager_trade_date(buffer, index, packet, parent)

  -- Appl Seq Trade Date: 4 Byte Unsigned Fixed Width Integer
  index, appl_seq_trade_date = eurex_cash_eti_t7_v9_1_dissect.appl_seq_trade_date(buffer, index, packet, parent)

  -- T 7 Entry Service Trade Date: 4 Byte Unsigned Fixed Width Integer
  index, t_7_entry_service_trade_date = eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_trade_date(buffer, index, packet, parent)

  -- T 7 Entry Service Rtm Trade Date: 4 Byte Unsigned Fixed Width Integer
  index, t_7_entry_service_rtm_trade_date = eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_rtm_trade_date(buffer, index, packet, parent)

  -- Partition Id: 2 Byte Unsigned Fixed Width Integer
  index, partition_id = eurex_cash_eti_t7_v9_1_dissect.partition_id(buffer, index, packet, parent)

  -- Matching Engine Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, matching_engine_status = eurex_cash_eti_t7_v9_1_dissect.matching_engine_status(buffer, index, packet, parent)

  -- Trade Manager Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, trade_manager_status = eurex_cash_eti_t7_v9_1_dissect.trade_manager_status(buffer, index, packet, parent)

  -- Appl Seq Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, appl_seq_status = eurex_cash_eti_t7_v9_1_dissect.appl_seq_status(buffer, index, packet, parent)

  -- T 7 Entry Service Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, t_7_entry_service_status = eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_status(buffer, index, packet, parent)

  -- T 7 Entry Service Rtm Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, t_7_entry_service_rtm_status = eurex_cash_eti_t7_v9_1_dissect.t_7_entry_service_rtm_status(buffer, index, packet, parent)

  -- Pad 5: 5 Byte
  index, pad_5 = eurex_cash_eti_t7_v9_1_dissect.pad_5(buffer, index, packet, parent)

  return index
end

-- Dissect: Service Availability Broadcast
eurex_cash_eti_t7_v9_1_dissect.service_availability_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_service_availability_broadcast = eurex_cash_eti_t7_v9_1_size_of.service_availability_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.service_availability_broadcast then
    local range = buffer(offset, size_of_service_availability_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.service_availability_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.service_availability_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.service_availability_broadcast_fields(buffer, offset, packet, parent, size_of_service_availability_broadcast)

  return offset + size_of_service_availability_broadcast
end

-- Size: Appl Total Message Count
eurex_cash_eti_t7_v9_1_size_of.appl_total_message_count = 2

-- Display: Appl Total Message Count
eurex_cash_eti_t7_v9_1_display.appl_total_message_count = function(value)
  return "Appl Total Message Count: "..value
end

-- Dissect: Appl Total Message Count
eurex_cash_eti_t7_v9_1_dissect.appl_total_message_count = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_total_message_count
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_total_message_count(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.ref_appl_last_seq_num = 8

-- Display: Ref Appl Last Seq Num
eurex_cash_eti_t7_v9_1_display.ref_appl_last_seq_num = function(value)
  return "Ref Appl Last Seq Num: "..value
end

-- Dissect: Ref Appl Last Seq Num
eurex_cash_eti_t7_v9_1_dissect.ref_appl_last_seq_num = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.ref_appl_last_seq_num
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.ref_appl_last_seq_num(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.appl_end_seq_num = 8

-- Display: Appl End Seq Num
eurex_cash_eti_t7_v9_1_display.appl_end_seq_num = function(value)
  return "Appl End Seq Num: "..value
end

-- Dissect: Appl End Seq Num
eurex_cash_eti_t7_v9_1_dissect.appl_end_seq_num = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_end_seq_num
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.appl_end_seq_num(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.retransmit_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.retransmit_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Retransmit Response
eurex_cash_eti_t7_v9_1_dissect.retransmit_response_fields = function(buffer, offset, packet, parent, size_of_retransmit_response)
  local index = offset
  ...
  index, appl_end_seq_num = eurex_cash_eti_t7_v9_1_dissect.appl_end_seq_num(buffer, index, packet, parent)

  -- Ref Appl Last Seq Num: 8 Byte Unsigned Fixed Width Integer
  index, ref_appl_last_seq_num = eurex_cash_eti_t7_v9_1_dissect.ref_appl_last_seq_num(buffer, index, packet, parent)

  -- Appl Total Message Count: 2 Byte Unsigned Fixed Width Integer
  index, appl_total_message_count = eurex_cash_eti_t7_v9_1_dissect.appl_total_message_count(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.retransmit_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_retransmit_response = eurex_cash_eti_t7_v9_1_size_of.retransmit_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.retransmit_response then
    local range = buffer(offset, size_of_retransmit_response)
    local display = eurex_cash_eti_t7_v9_1_display.retransmit_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.retransmit_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.retransmit_response_fields(buffer, offset, packet, parent, size_of_retransmit_response)

  return offset + size_of_retransmit_response
end

-- Size: Appl Beg Seq Num
eurex_cash_eti_t7_v9_1_size_of.appl_beg_seq_num = 8

-- Display: Appl Beg Seq Num
eurex_cash_eti_t7_v9_1_display.appl_beg_seq_num = function(value)
  return "Appl Beg Seq Num: "..value
end

-- Dissect: Appl Beg Seq Num
eurex_cash_eti_t7_v9_1_dissect.appl_beg_seq_num = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_beg_seq_num
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.appl_beg_seq_num(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.retransmit_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.retransmit_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Retransmit Request
eurex_cash_eti_t7_v9_1_dissect.retransmit_request_fields = function(buffer, offset, packet, parent, size_of_retransmit_request)
  local index = offset
  ...
  index, appl_beg_seq_num = eurex_cash_eti_t7_v9_1_dissect.appl_beg_seq_num(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.retransmit_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_retransmit_request = eurex_cash_eti_t7_v9_1_size_of.retransmit_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.retransmit_request then
    local range = buffer(offset, size_of_retransmit_request)
    local display = eurex_cash_eti_t7_v9_1_display.retransmit_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.retransmit_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.retransmit_request_fields(buffer, offset, packet, parent, size_of_retransmit_request)

  return offset + size_of_retransmit_request
end

-- Size: Appl End Msg Id
eurex_cash_eti_t7_v9_1_size_of.appl_end_msg_id = 16

-- Display: Appl End Msg Id
eurex_cash_eti_t7_v9_1_display.appl_end_msg_id = function(value)
  return "Appl End Msg Id: "..value
end

-- Dissect: Appl End Msg Id
eurex_cash_eti_t7_v9_1_dissect.appl_end_msg_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_end_msg_id
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.appl_end_msg_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.retransmit_me_message_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.retransmit_me_message_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Retransmit Me Message Response
eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_response_fields = function(buffer, offset, packet, parent, size_of_retransmit_me_message_response)
  local index = offset
  ...
  index, appl_end_msg_id = eurex_cash_eti_t7_v9_1_dissect.appl_end_msg_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_retransmit_me_message_response = eurex_cash_eti_t7_v9_1_size_of.retransmit_me_message_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.retransmit_me_message_response then
    local range = buffer(offset, size_of_retransmit_me_message_response)
    local display = eurex_cash_eti_t7_v9_1_display.retransmit_me_message_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.retransmit_me_message_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_response_fields(buffer, offset, packet, parent, size_of_retransmit_me_message_response)

  return offset + size_of_retransmit_me_message_response
end

-- Size: Appl Beg Msg Id
eurex_cash_eti_t7_v9_1_size_of.appl_beg_msg_id = 16

-- Display: Appl Beg Msg Id
eurex_cash_eti_t7_v9_1_display.appl_beg_msg_id = function(value)
  return "Appl Beg Msg Id: "..value
end

-- Dissect: Appl Beg Msg Id
eurex_cash_eti_t7_v9_1_dissect.appl_beg_msg_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_beg_msg_id
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.appl_beg_msg_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.retransmit_me_message_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.retransmit_me_message_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Retransmit Me Message Request
eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_request_fields = function(buffer, offset, packet, parent, size_of_retransmit_me_message_request)
  local index = offset
  ...
  index, appl_beg_msg_id = eurex_cash_eti_t7_v9_1_dissect.appl_beg_msg_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_retransmit_me_message_request = eurex_cash_eti_t7_v9_1_size_of.retransmit_me_message_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.retransmit_me_message_request then
    local range = buffer(offset, size_of_retransmit_me_message_request)
    local display = eurex_cash_eti_t7_v9_1_display.retransmit_me_message_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.retransmit_me_message_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_request_fields(buffer, offset, packet, parent, size_of_retransmit_me_message_request)

  return offset + size_of_retransmit_me_message_request
end

-- Size: Session Status
eurex_cash_eti_t7_v9_1_size_of.session_status = 1

-- Display: Session Status
eurex_cash_eti_t7_v9_1_display.session_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.session_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.session_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.session_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.session_reject_reason = 4

-- Display: Session Reject Reason
eurex_cash_eti_t7_v9_1_display.session_reject_reason = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.session_reject_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.session_reject_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.session_reject_reason(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.reject = function(buffer, offset)
  local index = offset
...
-- Display: Reject
eurex_cash_eti_t7_v9_1_display.reject = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Reject
eurex_cash_eti_t7_v9_1_dissect.reject_fields = function(buffer, offset, packet, parent, size_of_reject)
  local index = offset
  ...
  index, session_reject_reason = eurex_cash_eti_t7_v9_1_dissect.session_reject_reason(buffer, index, packet, parent)

  -- Var Text Len: 2 Byte Unsigned Fixed Width Integer
  index, var_text_len = eurex_cash_eti_t7_v9_1_dissect.var_text_len(buffer, index, packet, parent)

  -- Session Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, session_status = eurex_cash_eti_t7_v9_1_dissect.session_status(buffer, index, packet, parent)
...
-- Dissect: Reject
eurex_cash_eti_t7_v9_1_dissect.reject = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_reject = eurex_cash_eti_t7_v9_1_size_of.reject(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.reject then
    local range = buffer(offset, size_of_reject)
    local display = eurex_cash_eti_t7_v9_1_display.reject(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.reject, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.reject_fields(buffer, offset, packet, parent, size_of_reject)

  return offset + size_of_reject
end

-- Read runtime size of: Rfq Specialist Broadcast
eurex_cash_eti_t7_v9_1_size_of.rfq_specialist_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.rfq_specialist_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rfq Specialist Broadcast
eurex_cash_eti_t7_v9_1_dissect.rfq_specialist_broadcast_fields = function(buffer, offset, packet, parent, size_of_rfq_specialist_broadcast)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.rfq_specialist_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_rfq_specialist_broadcast = eurex_cash_eti_t7_v9_1_size_of.rfq_specialist_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.rfq_specialist_broadcast then
    local range = buffer(offset, size_of_rfq_specialist_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.rfq_specialist_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.rfq_specialist_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.rfq_specialist_broadcast_fields(buffer, offset, packet, parent, size_of_rfq_specialist_broadcast)

  return offset + size_of_rfq_specialist_broadcast
end

-- Read runtime size of: Rfq Response
eurex_cash_eti_t7_v9_1_size_of.rfq_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.rfq_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rfq Response
eurex_cash_eti_t7_v9_1_dissect.rfq_response_fields = function(buffer, offset, packet, parent, size_of_rfq_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.rfq_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_rfq_response = eurex_cash_eti_t7_v9_1_size_of.rfq_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.rfq_response then
    local range = buffer(offset, size_of_rfq_response)
    local display = eurex_cash_eti_t7_v9_1_display.rfq_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.rfq_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.rfq_response_fields(buffer, offset, packet, parent, size_of_rfq_response)

  return offset + size_of_rfq_response
end

-- Size: Rfq Requester Disclosure Instruction
eurex_cash_eti_t7_v9_1_size_of.rfq_requester_disclosure_instruction = 1

-- Display: Rfq Requester Disclosure Instruction
eurex_cash_eti_t7_v9_1_display.rfq_requester_disclosure_instruction = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.rfq_requester_disclosure_instruction = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.rfq_requester_disclosure_instruction
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.rfq_requester_disclosure_instruction(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.rfq_publish_indicator = 1

-- Display: Rfq Publish Indicator
eurex_cash_eti_t7_v9_1_display.rfq_publish_indicator = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.rfq_publish_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.rfq_publish_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.rfq_publish_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.rfq_request = function(buffer, offset)
  local index = offset
...
-- Display: Rfq Request
eurex_cash_eti_t7_v9_1_display.rfq_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rfq Request
eurex_cash_eti_t7_v9_1_dissect.rfq_request_fields = function(buffer, offset, packet, parent, size_of_rfq_request)
  local index = offset
  ...
  index, rfq_publish_indicator = eurex_cash_eti_t7_v9_1_dissect.rfq_publish_indicator(buffer, index, packet, parent)

  -- Rfq Requester Disclosure Instruction: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, rfq_requester_disclosure_instruction = eurex_cash_eti_t7_v9_1_dissect.rfq_requester_disclosure_instruction(buffer, index, packet, parent)
...
-- Dissect: Rfq Request
eurex_cash_eti_t7_v9_1_dissect.rfq_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_rfq_request = eurex_cash_eti_t7_v9_1_size_of.rfq_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.rfq_request then
    local range = buffer(offset, size_of_rfq_request)
    local display = eurex_cash_eti_t7_v9_1_display.rfq_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.rfq_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.rfq_request_fields(buffer, offset, packet, parent, size_of_rfq_request)

  return offset + size_of_rfq_request
end

-- Read runtime size of: Rfq Reject Notification
eurex_cash_eti_t7_v9_1_size_of.rfq_reject_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.rfq_reject_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rfq Reject Notification
eurex_cash_eti_t7_v9_1_dissect.rfq_reject_notification_fields = function(buffer, offset, packet, parent, size_of_rfq_reject_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.rfq_reject_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_rfq_reject_notification = eurex_cash_eti_t7_v9_1_size_of.rfq_reject_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.rfq_reject_notification then
    local range = buffer(offset, size_of_rfq_reject_notification)
    local display = eurex_cash_eti_t7_v9_1_display.rfq_reject_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.rfq_reject_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.rfq_reject_notification_fields(buffer, offset, packet, parent, size_of_rfq_reject_notification)

  return offset + size_of_rfq_reject_notification
end

-- Read runtime size of: Rfq Broadcast
eurex_cash_eti_t7_v9_1_size_of.rfq_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.rfq_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rfq Broadcast
eurex_cash_eti_t7_v9_1_dissect.rfq_broadcast_fields = function(buffer, offset, packet, parent, size_of_rfq_broadcast)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.rfq_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_rfq_broadcast = eurex_cash_eti_t7_v9_1_size_of.rfq_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.rfq_broadcast then
    local range = buffer(offset, size_of_rfq_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.rfq_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.rfq_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.rfq_broadcast_fields(buffer, offset, packet, parent, size_of_rfq_broadcast)

  return offset + size_of_rfq_broadcast
end

-- Size: Quote Event Liquidity Ind
eurex_cash_eti_t7_v9_1_size_of.quote_event_liquidity_ind = 1

-- Display: Quote Event Liquidity Ind
eurex_cash_eti_t7_v9_1_display.quote_event_liquidity_ind = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_event_liquidity_ind = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_liquidity_ind
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_event_liquidity_ind(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_event_side = 1

-- Display: Quote Event Side
eurex_cash_eti_t7_v9_1_display.quote_event_side = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_event_side = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_side
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_event_side(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_event_type = 1

-- Display: Quote Event Type
eurex_cash_eti_t7_v9_1_display.quote_event_type = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_event_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_event_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_event_exec_id = 4

-- Display: Quote Event Exec Id
eurex_cash_eti_t7_v9_1_display.quote_event_exec_id = function(value)
  return "Quote Event Exec Id: "..value
end

-- Dissect: Quote Event Exec Id
eurex_cash_eti_t7_v9_1_dissect.quote_event_exec_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_exec_id
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = eurex_cash_eti_t7_v9_1_display.quote_event_exec_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_event_match_id = 4

-- Display: Quote Event Match Id
eurex_cash_eti_t7_v9_1_display.quote_event_match_id = function(value)
  return "Quote Event Match Id: "..value
end

-- Dissect: Quote Event Match Id
eurex_cash_eti_t7_v9_1_dissect.quote_event_match_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_match_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_event_match_id(value, buffer, offset, packet, parent)
...
-- Size: Quote Msg Id
eurex_cash_eti_t7_v9_1_size_of.quote_msg_id = 8

-- Display: Quote Msg Id
eurex_cash_eti_t7_v9_1_display.quote_msg_id = function(value)
  return "Quote Msg Id: "..value
end

-- Dissect: Quote Msg Id
eurex_cash_eti_t7_v9_1_dissect.quote_msg_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_msg_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.quote_msg_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.quote_event_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.quote_event_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.quote_event_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.security_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_px

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_qty

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_msg_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_match_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_exec_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_type

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_side

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_liquidity_ind

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_event_reason
...
eurex_cash_eti_t7_v9_1_display.quote_event_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Event Grp Comp
eurex_cash_eti_t7_v9_1_dissect.quote_event_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, quote_msg_id = eurex_cash_eti_t7_v9_1_dissect.quote_msg_id(buffer, index, packet, parent)

  -- Quote Event Match Id: 4 Byte Unsigned Fixed Width Integer
  index, quote_event_match_id = eurex_cash_eti_t7_v9_1_dissect.quote_event_match_id(buffer, index, packet, parent)

  -- Quote Event Exec Id: 4 Byte Signed Fixed Width Integer
  index, quote_event_exec_id = eurex_cash_eti_t7_v9_1_dissect.quote_event_exec_id(buffer, index, packet, parent)

  -- Quote Event Type: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, quote_event_type = eurex_cash_eti_t7_v9_1_dissect.quote_event_type(buffer, index, packet, parent)

  -- Quote Event Side: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, quote_event_side = eurex_cash_eti_t7_v9_1_dissect.quote_event_side(buffer, index, packet, parent)

  -- Quote Event Liquidity Ind: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, quote_event_liquidity_ind = eurex_cash_eti_t7_v9_1_dissect.quote_event_liquidity_ind(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.quote_event_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.quote_event_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.quote_event_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.quote_event_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.quote_event_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.quote_event_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Quote Events
eurex_cash_eti_t7_v9_1_size_of.no_quote_events = 1

-- Display: No Quote Events
eurex_cash_eti_t7_v9_1_display.no_quote_events = function(value)
  return "No Quote Events: "..value
end

-- Dissect: No Quote Events
eurex_cash_eti_t7_v9_1_dissect.no_quote_events = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_quote_events
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_quote_events(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_execution_report = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.quote_execution_report = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Execution Report
eurex_cash_eti_t7_v9_1_dissect.quote_execution_report_fields = function(buffer, offset, packet, parent, size_of_quote_execution_report)
  local index = offset
  ...
  index, no_quote_events = eurex_cash_eti_t7_v9_1_dissect.no_quote_events(buffer, index, packet, parent)
  ...
  for i = 1, no_quote_events do
    index = eurex_cash_eti_t7_v9_1_dissect.quote_event_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.quote_execution_report = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_quote_execution_report = eurex_cash_eti_t7_v9_1_size_of.quote_execution_report(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.quote_execution_report then
    local range = buffer(offset, size_of_quote_execution_report)
    local display = eurex_cash_eti_t7_v9_1_display.quote_execution_report(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.quote_execution_report, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.quote_execution_report_fields(buffer, offset, packet, parent, size_of_quote_execution_report)

  return offset + size_of_quote_execution_report
end

-- Size: Not Affected Security Id
eurex_cash_eti_t7_v9_1_size_of.not_affected_security_id = 8

-- Display: Not Affected Security Id
eurex_cash_eti_t7_v9_1_display.not_affected_security_id = function(value)
  return "Not Affected Security Id: "..value
end

-- Dissect: Not Affected Security Id
eurex_cash_eti_t7_v9_1_dissect.not_affected_security_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.not_affected_security_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.not_affected_security_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.not_affected_securities_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.not_affected_security_id

  return index
end

-- Display: Not Affected Securities Grp Comp
eurex_cash_eti_t7_v9_1_display.not_affected_securities_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Not Affected Securities Grp Comp
eurex_cash_eti_t7_v9_1_dissect.not_affected_securities_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Not Affected Security Id: 8 Byte Unsigned Fixed Width Integer
  index, not_affected_security_id = eurex_cash_eti_t7_v9_1_dissect.not_affected_security_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Not Affected Securities Grp Comp
eurex_cash_eti_t7_v9_1_dissect.not_affected_securities_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.not_affected_securities_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.not_affected_securities_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.not_affected_securities_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.not_affected_securities_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.not_affected_securities_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Not Affected Securities
eurex_cash_eti_t7_v9_1_size_of.no_not_affected_securities = 2

-- Display: No Not Affected Securities
eurex_cash_eti_t7_v9_1_display.no_not_affected_securities = function(value)
  return "No Not Affected Securities: "..value
end

-- Dissect: No Not Affected Securities
eurex_cash_eti_t7_v9_1_dissect.no_not_affected_securities = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_not_affected_securities
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_not_affected_securities(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_activation_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.quote_activation_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Activation Response
eurex_cash_eti_t7_v9_1_dissect.quote_activation_response_fields = function(buffer, offset, packet, parent, size_of_quote_activation_response)
  local index = offset
  ...
  index, no_not_affected_securities = eurex_cash_eti_t7_v9_1_dissect.no_not_affected_securities(buffer, index, packet, parent)
  ...
  for i = 1, no_not_affected_securities do
    index = eurex_cash_eti_t7_v9_1_dissect.not_affected_securities_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.quote_activation_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_quote_activation_response = eurex_cash_eti_t7_v9_1_size_of.quote_activation_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.quote_activation_response then
    local range = buffer(offset, size_of_quote_activation_response)
    local display = eurex_cash_eti_t7_v9_1_display.quote_activation_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.quote_activation_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.quote_activation_response_fields(buffer, offset, packet, parent, size_of_quote_activation_response)

  return offset + size_of_quote_activation_response
end

-- Size: Mass Action Type
eurex_cash_eti_t7_v9_1_size_of.mass_action_type = 1

-- Display: Mass Action Type
eurex_cash_eti_t7_v9_1_display.mass_action_type = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.mass_action_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.mass_action_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.mass_action_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.target_party_id_session_id = 4

-- Display: Target Party Id Session Id
eurex_cash_eti_t7_v9_1_display.target_party_id_session_id = function(value)
  return "Target Party Id Session Id: "..value
end

-- Dissect: Target Party Id Session Id
eurex_cash_eti_t7_v9_1_dissect.target_party_id_session_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.target_party_id_session_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.target_party_id_session_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_activation_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.quote_activation_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Activation Request
eurex_cash_eti_t7_v9_1_dissect.quote_activation_request_fields = function(buffer, offset, packet, parent, size_of_quote_activation_request)
  local index = offset
  ...
  index, target_party_id_session_id = eurex_cash_eti_t7_v9_1_dissect.target_party_id_session_id(buffer, index, packet, parent)

  -- Mass Action Type: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, mass_action_type = eurex_cash_eti_t7_v9_1_dissect.mass_action_type(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.quote_activation_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_quote_activation_request = eurex_cash_eti_t7_v9_1_size_of.quote_activation_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.quote_activation_request then
    local range = buffer(offset, size_of_quote_activation_request)
    local display = eurex_cash_eti_t7_v9_1_display.quote_activation_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.quote_activation_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.quote_activation_request_fields(buffer, offset, packet, parent, size_of_quote_activation_request)

  return offset + size_of_quote_activation_request
end

-- Read runtime size of: Quote Activation Notification
eurex_cash_eti_t7_v9_1_size_of.quote_activation_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.quote_activation_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Activation Notification
eurex_cash_eti_t7_v9_1_dissect.quote_activation_notification_fields = function(buffer, offset, packet, parent, size_of_quote_activation_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.quote_activation_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_quote_activation_notification = eurex_cash_eti_t7_v9_1_size_of.quote_activation_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.quote_activation_notification then
    local range = buffer(offset, size_of_quote_activation_notification)
    local display = eurex_cash_eti_t7_v9_1_display.quote_activation_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.quote_activation_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.quote_activation_notification_fields(buffer, offset, packet, parent, size_of_quote_activation_notification)

  return offset + size_of_quote_activation_notification
end

-- Read runtime size of: Ping Response
eurex_cash_eti_t7_v9_1_size_of.ping_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.ping_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Ping Response
eurex_cash_eti_t7_v9_1_dissect.ping_response_fields = function(buffer, offset, packet, parent, size_of_ping_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.ping_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_ping_response = eurex_cash_eti_t7_v9_1_size_of.ping_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.ping_response then
    local range = buffer(offset, size_of_ping_response)
    local display = eurex_cash_eti_t7_v9_1_display.ping_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.ping_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.ping_response_fields(buffer, offset, packet, parent, size_of_ping_response)

  return offset + size_of_ping_response
end

-- Read runtime size of: Ping Request
eurex_cash_eti_t7_v9_1_size_of.ping_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.ping_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Ping Request
eurex_cash_eti_t7_v9_1_dissect.ping_request_fields = function(buffer, offset, packet, parent, size_of_ping_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.ping_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_ping_request = eurex_cash_eti_t7_v9_1_size_of.ping_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.ping_request then
    local range = buffer(offset, size_of_ping_request)
    local display = eurex_cash_eti_t7_v9_1_display.ping_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.ping_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.ping_request_fields(buffer, offset, packet, parent, size_of_ping_request)

  return offset + size_of_ping_request
end

-- Size: Party Detail Status
eurex_cash_eti_t7_v9_1_size_of.party_detail_status = 1

-- Display: Party Detail Status
eurex_cash_eti_t7_v9_1_display.party_detail_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.party_detail_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_detail_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_detail_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.requesting_party_clearing_firm = 9

-- Display: Requesting Party Clearing Firm
eurex_cash_eti_t7_v9_1_display.requesting_party_clearing_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.requesting_party_clearing_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.requesting_party_clearing_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.requesting_party_clearing_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.requesting_party_entering_firm = 9

-- Display: Requesting Party Entering Firm
eurex_cash_eti_t7_v9_1_display.requesting_party_entering_firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.requesting_party_entering_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.requesting_party_entering_firm
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.requesting_party_entering_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.list_update_action = 1

-- Display: List Update Action
eurex_cash_eti_t7_v9_1_display.list_update_action = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.list_update_action = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.list_update_action
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.list_update_action(value, buffer, offset, packet, parent)
...
-- Size: Market Id
eurex_cash_eti_t7_v9_1_size_of.market_id = 2

-- Display: Market Id
eurex_cash_eti_t7_v9_1_display.market_id = function(value)
  if value == 3 then
...
-- Dissect: Market Id
eurex_cash_eti_t7_v9_1_dissect.market_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.market_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.market_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.requesting_party_id_executing_system = 4

-- Display: Requesting Party Id Executing System
eurex_cash_eti_t7_v9_1_display.requesting_party_id_executing_system = function(value)
  if value == 2 then
...
eurex_cash_eti_t7_v9_1_dissect.requesting_party_id_executing_system = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.requesting_party_id_executing_system
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.requesting_party_id_executing_system(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_detail_id_executing_unit = 4

-- Display: Party Detail Id Executing Unit
eurex_cash_eti_t7_v9_1_display.party_detail_id_executing_unit = function(value)
  return "Party Detail Id Executing Unit: "..value
end

-- Dissect: Party Detail Id Executing Unit
eurex_cash_eti_t7_v9_1_dissect.party_detail_id_executing_unit = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_detail_id_executing_unit
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_detail_id_executing_unit(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_entitlements_update_report = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.party_entitlements_update_report = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Party Entitlements Update Report
eurex_cash_eti_t7_v9_1_dissect.party_entitlements_update_report_fields = function(buffer, offset, packet, parent, size_of_party_entitlements_update_report)
  local index = offset
  ...
  index, party_detail_id_executing_unit = eurex_cash_eti_t7_v9_1_dissect.party_detail_id_executing_unit(buffer, index, packet, parent)

  -- Requesting Party Id Executing System: 4 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, requesting_party_id_executing_system = eurex_cash_eti_t7_v9_1_dissect.requesting_party_id_executing_system(buffer, index, packet, parent)

  -- Market Id: 2 Byte Unsigned Fixed Width Integer Enum with 9 values
  index, market_id = eurex_cash_eti_t7_v9_1_dissect.market_id(buffer, index, packet, parent)

  -- List Update Action: 1 Byte Ascii String Enum with 2 values
  index, list_update_action = eurex_cash_eti_t7_v9_1_dissect.list_update_action(buffer, index, packet, parent)

  -- Requesting Party Entering Firm: 9 Byte Ascii String Nullable
  index, requesting_party_entering_firm = eurex_cash_eti_t7_v9_1_dissect.requesting_party_entering_firm(buffer, index, packet, parent)

  -- Requesting Party Clearing Firm: 9 Byte Ascii String Nullable
  index, requesting_party_clearing_firm = eurex_cash_eti_t7_v9_1_dissect.requesting_party_clearing_firm(buffer, index, packet, parent)

  -- Party Detail Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, party_detail_status = eurex_cash_eti_t7_v9_1_dissect.party_detail_status(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.party_entitlements_update_report = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_party_entitlements_update_report = eurex_cash_eti_t7_v9_1_size_of.party_entitlements_update_report(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.party_entitlements_update_report then
    local range = buffer(offset, size_of_party_entitlements_update_report)
    local display = eurex_cash_eti_t7_v9_1_display.party_entitlements_update_report(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.party_entitlements_update_report, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.party_entitlements_update_report_fields(buffer, offset, packet, parent, size_of_party_entitlements_update_report)

  return offset + size_of_party_entitlements_update_report
end

-- Size: Requesting Party Id Entering Firm
eurex_cash_eti_t7_v9_1_size_of.requesting_party_id_entering_firm = 1

-- Display: Requesting Party Id Entering Firm
eurex_cash_eti_t7_v9_1_display.requesting_party_id_entering_firm = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.requesting_party_id_entering_firm = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.requesting_party_id_entering_firm
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.requesting_party_id_entering_firm(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_action_type = 1

-- Display: Party Action Type
eurex_cash_eti_t7_v9_1_display.party_action_type = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.party_action_type = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_action_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_action_type(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.requesting_party_id_executing_trader = 4

-- Display: Requesting Party Id Executing Trader
eurex_cash_eti_t7_v9_1_display.requesting_party_id_executing_trader = function(value)
  return "Requesting Party Id Executing Trader: "..value
end

-- Dissect: Requesting Party Id Executing Trader
eurex_cash_eti_t7_v9_1_dissect.requesting_party_id_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.requesting_party_id_executing_trader
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.requesting_party_id_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_action_report = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.party_action_report = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Party Action Report
eurex_cash_eti_t7_v9_1_dissect.party_action_report_fields = function(buffer, offset, packet, parent, size_of_party_action_report)
  local index = offset
  ...
  index, requesting_party_id_executing_trader = eurex_cash_eti_t7_v9_1_dissect.requesting_party_id_executing_trader(buffer, index, packet, parent)
  ...
  index, party_action_type = eurex_cash_eti_t7_v9_1_dissect.party_action_type(buffer, index, packet, parent)

  -- Requesting Party Id Entering Firm: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, requesting_party_id_entering_firm = eurex_cash_eti_t7_v9_1_dissect.requesting_party_id_entering_firm(buffer, index, packet, parent)

  return index
end

-- Dissect: Party Action Report
eurex_cash_eti_t7_v9_1_dissect.party_action_report = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_party_action_report = eurex_cash_eti_t7_v9_1_size_of.party_action_report(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.party_action_report then
    local range = buffer(offset, size_of_party_action_report)
    local display = eurex_cash_eti_t7_v9_1_display.party_action_report(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.party_action_report, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.party_action_report_fields(buffer, offset, packet, parent, size_of_party_action_report)

  return offset + size_of_party_action_report
end

-- Size: Transaction Delay Indicator
eurex_cash_eti_t7_v9_1_size_of.transaction_delay_indicator = 1

-- Display: Transaction Delay Indicator
eurex_cash_eti_t7_v9_1_display.transaction_delay_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.transaction_delay_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.transaction_delay_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.transaction_delay_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.crossed_indicator = 1

-- Display: Crossed Indicator
eurex_cash_eti_t7_v9_1_display.crossed_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.crossed_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.crossed_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.crossed_indicator(value, buffer, offset, packet, parent)
...
-- Dissect: Display Qty
eurex_cash_eti_t7_v9_1_dissect.display_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.display_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.response_header_me_comp = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v9_1_display.response_header_me_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Response Header Me Comp
eurex_cash_eti_t7_v9_1_dissect.response_header_me_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.response_header_me_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.response_header_me_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.response_header_me_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.response_header_me_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.response_header_me_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.response_header_me_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Order Exec Response
eurex_cash_eti_t7_v9_1_size_of.order_exec_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.order_exec_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Order Exec Response
eurex_cash_eti_t7_v9_1_dissect.order_exec_response_fields = function(buffer, offset, packet, parent, size_of_order_exec_response)
  local index = offset
  ...
  index, response_header_me_comp = eurex_cash_eti_t7_v9_1_dissect.response_header_me_comp(buffer, index, packet, parent)
  ...
  index, crossed_indicator = eurex_cash_eti_t7_v9_1_dissect.crossed_indicator(buffer, index, packet, parent)

  -- Transaction Delay Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, transaction_delay_indicator = eurex_cash_eti_t7_v9_1_dissect.transaction_delay_indicator(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.order_exec_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_order_exec_response = eurex_cash_eti_t7_v9_1_size_of.order_exec_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.order_exec_response then
    local range = buffer(offset, size_of_order_exec_response)
    local display = eurex_cash_eti_t7_v9_1_display.order_exec_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.order_exec_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.order_exec_response_fields(buffer, offset, packet, parent, size_of_order_exec_response)

  return offset + size_of_order_exec_response
end

-- Size: Trade At Close Opt In
eurex_cash_eti_t7_v9_1_size_of.trade_at_close_opt_in = 1

-- Display: Trade At Close Opt In
eurex_cash_eti_t7_v9_1_display.trade_at_close_opt_in = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.trade_at_close_opt_in = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trade_at_close_opt_in
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trade_at_close_opt_in(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.peg_offset_value_pct = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.peg_offset_value_pct
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.peg_offset_value_abs = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.peg_offset_value_abs
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.volume_discovery_price = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.volume_discovery_price
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.display_high_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.display_high_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.display_low_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.display_low_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.order_exec_report_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.order_exec_report_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Order Exec Report Broadcast
eurex_cash_eti_t7_v9_1_dissect.order_exec_report_broadcast_fields = function(buffer, offset, packet, parent, size_of_order_exec_report_broadcast)
  local index = offset
  ...
  index, trade_at_close_opt_in = eurex_cash_eti_t7_v9_1_dissect.trade_at_close_opt_in(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.order_exec_report_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_order_exec_report_broadcast = eurex_cash_eti_t7_v9_1_size_of.order_exec_report_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.order_exec_report_broadcast then
    local range = buffer(offset, size_of_order_exec_report_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.order_exec_report_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.order_exec_report_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.order_exec_report_broadcast_fields(buffer, offset, packet, parent, size_of_order_exec_report_broadcast)

  return offset + size_of_order_exec_report_broadcast
end

-- Read runtime size of: Order Exec Notification
eurex_cash_eti_t7_v9_1_size_of.order_exec_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.order_exec_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Order Exec Notification
eurex_cash_eti_t7_v9_1_dissect.order_exec_notification_fields = function(buffer, offset, packet, parent, size_of_order_exec_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.order_exec_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_order_exec_notification = eurex_cash_eti_t7_v9_1_size_of.order_exec_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.order_exec_notification then
    local range = buffer(offset, size_of_order_exec_notification)
    local display = eurex_cash_eti_t7_v9_1_display.order_exec_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.order_exec_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.order_exec_notification_fields(buffer, offset, packet, parent, size_of_order_exec_notification)

  return offset + size_of_order_exec_notification
end

-- Size: Headline
eurex_cash_eti_t7_v9_1_size_of.headline = 256

-- Display: Headline
eurex_cash_eti_t7_v9_1_display.headline = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Headline
eurex_cash_eti_t7_v9_1_dissect.headline = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.headline
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.headline(value, buffer, offset, packet, parent)
...
-- Size: Orig Time
eurex_cash_eti_t7_v9_1_size_of.orig_time = 8

-- Display: Orig Time
eurex_cash_eti_t7_v9_1_display.orig_time = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
-- Dissect: Orig Time
eurex_cash_eti_t7_v9_1_dissect.orig_time = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.orig_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.orig_time(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.news_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.news_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: News Broadcast
eurex_cash_eti_t7_v9_1_dissect.news_broadcast_fields = function(buffer, offset, packet, parent, size_of_news_broadcast)
  local index = offset
  ...
  index, orig_time = eurex_cash_eti_t7_v9_1_dissect.orig_time(buffer, index, packet, parent)

  -- Var Text Len: 2 Byte Unsigned Fixed Width Integer
  index, var_text_len = eurex_cash_eti_t7_v9_1_dissect.var_text_len(buffer, index, packet, parent)

  -- Headline: 256 Byte Ascii String Nullable
  index, headline = eurex_cash_eti_t7_v9_1_dissect.headline(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.news_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_news_broadcast = eurex_cash_eti_t7_v9_1_size_of.news_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.news_broadcast then
    local range = buffer(offset, size_of_news_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.news_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.news_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.news_broadcast_fields(buffer, offset, packet, parent, size_of_news_broadcast)

  return offset + size_of_news_broadcast
end

-- Size: Enrichment Rule Id
eurex_cash_eti_t7_v9_1_size_of.enrichment_rule_id = 2

-- Display: Enrichment Rule Id
eurex_cash_eti_t7_v9_1_display.enrichment_rule_id = function(value)
  return "Enrichment Rule Id: "..value
end

-- Dissect: Enrichment Rule Id
eurex_cash_eti_t7_v9_1_dissect.enrichment_rule_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.enrichment_rule_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.enrichment_rule_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.new_order_single_short_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.new_order_single_short_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: New Order Single Short Request
eurex_cash_eti_t7_v9_1_dissect.new_order_single_short_request_fields = function(buffer, offset, packet, parent, size_of_new_order_single_short_request)
  local index = offset
  ...
  index, enrichment_rule_id = eurex_cash_eti_t7_v9_1_dissect.enrichment_rule_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.new_order_single_short_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_new_order_single_short_request = eurex_cash_eti_t7_v9_1_size_of.new_order_single_short_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.new_order_single_short_request then
    local range = buffer(offset, size_of_new_order_single_short_request)
    local display = eurex_cash_eti_t7_v9_1_display.new_order_single_short_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.new_order_single_short_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.new_order_single_short_request_fields(buffer, offset, packet, parent, size_of_new_order_single_short_request)

  return offset + size_of_new_order_single_short_request
end

-- Read runtime size of: New Order Single Request
eurex_cash_eti_t7_v9_1_size_of.new_order_single_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.new_order_single_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: New Order Single Request
eurex_cash_eti_t7_v9_1_dissect.new_order_single_request_fields = function(buffer, offset, packet, parent, size_of_new_order_single_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.new_order_single_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_new_order_single_request = eurex_cash_eti_t7_v9_1_size_of.new_order_single_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.new_order_single_request then
    local range = buffer(offset, size_of_new_order_single_request)
    local display = eurex_cash_eti_t7_v9_1_display.new_order_single_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.new_order_single_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.new_order_single_request_fields(buffer, offset, packet, parent, size_of_new_order_single_request)

  return offset + size_of_new_order_single_request
end

-- Read runtime size of: New Order Response
eurex_cash_eti_t7_v9_1_size_of.new_order_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.new_order_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: New Order Response
eurex_cash_eti_t7_v9_1_dissect.new_order_response_fields = function(buffer, offset, packet, parent, size_of_new_order_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.new_order_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_new_order_response = eurex_cash_eti_t7_v9_1_size_of.new_order_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.new_order_response then
    local range = buffer(offset, size_of_new_order_response)
    local display = eurex_cash_eti_t7_v9_1_display.new_order_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.new_order_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.new_order_response_fields(buffer, offset, packet, parent, size_of_new_order_response)

  return offset + size_of_new_order_response
end

-- Read runtime size of: New Order Nr Response
eurex_cash_eti_t7_v9_1_size_of.new_order_nr_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.new_order_nr_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: New Order Nr Response
eurex_cash_eti_t7_v9_1_dissect.new_order_nr_response_fields = function(buffer, offset, packet, parent, size_of_new_order_nr_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.new_order_nr_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_new_order_nr_response = eurex_cash_eti_t7_v9_1_size_of.new_order_nr_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.new_order_nr_response then
    local range = buffer(offset, size_of_new_order_nr_response)
    local display = eurex_cash_eti_t7_v9_1_display.new_order_nr_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.new_order_nr_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.new_order_nr_response_fields(buffer, offset, packet, parent, size_of_new_order_nr_response)

  return offset + size_of_new_order_nr_response
end

-- Calculate size of: Side Alloc Grp Comp
eurex_cash_eti_t7_v9_1_size_of.side_alloc_grp_comp = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v9_1_display.side_alloc_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end
...
eurex_cash_eti_t7_v9_1_dissect.side_alloc_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.side_alloc_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.side_alloc_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.side_alloc_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.side_alloc_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.side_alloc_grp_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Modify Tes Trade Request
eurex_cash_eti_t7_v9_1_size_of.modify_tes_trade_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.modify_tes_trade_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Modify Tes Trade Request
eurex_cash_eti_t7_v9_1_dissect.modify_tes_trade_request_fields = function(buffer, offset, packet, parent, size_of_modify_tes_trade_request)
  local index = offset
  ...
  for i = 1, no_side_allocs do
    index = eurex_cash_eti_t7_v9_1_dissect.side_alloc_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.modify_tes_trade_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_modify_tes_trade_request = eurex_cash_eti_t7_v9_1_size_of.modify_tes_trade_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.modify_tes_trade_request then
    local range = buffer(offset, size_of_modify_tes_trade_request)
    local display = eurex_cash_eti_t7_v9_1_display.modify_tes_trade_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.modify_tes_trade_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.modify_tes_trade_request_fields(buffer, offset, packet, parent, size_of_modify_tes_trade_request)

  return offset + size_of_modify_tes_trade_request
end

-- Read runtime size of: Modify Order Single Short Request
eurex_cash_eti_t7_v9_1_size_of.modify_order_single_short_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.modify_order_single_short_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Modify Order Single Short Request
eurex_cash_eti_t7_v9_1_dissect.modify_order_single_short_request_fields = function(buffer, offset, packet, parent, size_of_modify_order_single_short_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.modify_order_single_short_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_modify_order_single_short_request = eurex_cash_eti_t7_v9_1_size_of.modify_order_single_short_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.modify_order_single_short_request then
    local range = buffer(offset, size_of_modify_order_single_short_request)
    local display = eurex_cash_eti_t7_v9_1_display.modify_order_single_short_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.modify_order_single_short_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.modify_order_single_short_request_fields(buffer, offset, packet, parent, size_of_modify_order_single_short_request)

  return offset + size_of_modify_order_single_short_request
end

-- Size: Ownership Indicator
eurex_cash_eti_t7_v9_1_size_of.ownership_indicator = 1

-- Display: Ownership Indicator
eurex_cash_eti_t7_v9_1_display.ownership_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.ownership_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.ownership_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.ownership_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.stop_px_indicator = 1

-- Display: Stop Px Indicator
eurex_cash_eti_t7_v9_1_display.stop_px_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.stop_px_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.stop_px_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.stop_px_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.modify_order_single_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.modify_order_single_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Modify Order Single Request
eurex_cash_eti_t7_v9_1_dissect.modify_order_single_request_fields = function(buffer, offset, packet, parent, size_of_modify_order_single_request)
  local index = offset
  ...
  index, stop_px_indicator = eurex_cash_eti_t7_v9_1_dissect.stop_px_indicator(buffer, index, packet, parent)
  ...
  index, ownership_indicator = eurex_cash_eti_t7_v9_1_dissect.ownership_indicator(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.modify_order_single_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_modify_order_single_request = eurex_cash_eti_t7_v9_1_size_of.modify_order_single_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.modify_order_single_request then
    local range = buffer(offset, size_of_modify_order_single_request)
    local display = eurex_cash_eti_t7_v9_1_display.modify_order_single_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.modify_order_single_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.modify_order_single_request_fields(buffer, offset, packet, parent, size_of_modify_order_single_request)

  return offset + size_of_modify_order_single_request
end

-- Read runtime size of: Modify Order Response
eurex_cash_eti_t7_v9_1_size_of.modify_order_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.modify_order_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Modify Order Response
eurex_cash_eti_t7_v9_1_dissect.modify_order_response_fields = function(buffer, offset, packet, parent, size_of_modify_order_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.modify_order_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_modify_order_response = eurex_cash_eti_t7_v9_1_size_of.modify_order_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.modify_order_response then
    local range = buffer(offset, size_of_modify_order_response)
    local display = eurex_cash_eti_t7_v9_1_display.modify_order_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.modify_order_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.modify_order_response_fields(buffer, offset, packet, parent, size_of_modify_order_response)

  return offset + size_of_modify_order_response
end

-- Read runtime size of: Modify Order Nr Response
eurex_cash_eti_t7_v9_1_size_of.modify_order_nr_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.modify_order_nr_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Modify Order Nr Response
eurex_cash_eti_t7_v9_1_dissect.modify_order_nr_response_fields = function(buffer, offset, packet, parent, size_of_modify_order_nr_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.modify_order_nr_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_modify_order_nr_response = eurex_cash_eti_t7_v9_1_size_of.modify_order_nr_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.modify_order_nr_response then
    local range = buffer(offset, size_of_modify_order_nr_response)
    local display = eurex_cash_eti_t7_v9_1_display.modify_order_nr_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.modify_order_nr_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.modify_order_nr_response_fields(buffer, offset, packet, parent, size_of_modify_order_nr_response)

  return offset + size_of_modify_order_nr_response
end

-- Size: Quote Entry Status
eurex_cash_eti_t7_v9_1_size_of.quote_entry_status = 1

-- Display: Quote Entry Status
eurex_cash_eti_t7_v9_1_display.quote_entry_status = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_entry_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_entry_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_entry_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_entry_reject_reason = 4

-- Display: Quote Entry Reject Reason
eurex_cash_eti_t7_v9_1_display.quote_entry_reject_reason = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.quote_entry_reject_reason = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_entry_reject_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.quote_entry_reject_reason(value, buffer, offset, packet, parent)
...
-- Dissect: Cxl Size
eurex_cash_eti_t7_v9_1_dissect.cxl_size = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.cxl_size
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.quote_entry_ack_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.security_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.cxl_size

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_entry_reject_reason

  index = index + eurex_cash_eti_t7_v9_1_size_of.quote_entry_status
...
eurex_cash_eti_t7_v9_1_display.quote_entry_ack_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Entry Ack Grp Comp
eurex_cash_eti_t7_v9_1_dissect.quote_entry_ack_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, quote_entry_reject_reason = eurex_cash_eti_t7_v9_1_dissect.quote_entry_reject_reason(buffer, index, packet, parent)

  -- Quote Entry Status: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, quote_entry_status = eurex_cash_eti_t7_v9_1_dissect.quote_entry_status(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.quote_entry_ack_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.quote_entry_ack_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.quote_entry_ack_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.quote_entry_ack_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.quote_entry_ack_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.quote_entry_ack_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Quote Side Entries
eurex_cash_eti_t7_v9_1_size_of.no_quote_side_entries = 1

-- Display: No Quote Side Entries
eurex_cash_eti_t7_v9_1_display.no_quote_side_entries = function(value)
  return "No Quote Side Entries: "..value
end

-- Dissect: No Quote Side Entries
eurex_cash_eti_t7_v9_1_dissect.no_quote_side_entries = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_quote_side_entries
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_quote_side_entries(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.quote_response_id = 8

-- Display: Quote Response Id
eurex_cash_eti_t7_v9_1_display.quote_response_id = function(value)
  -- Parse unix timestamp
  local seconds = value:tonumber()/1000000000
  local nanoseconds = value:tonumber()%1000000000
...
eurex_cash_eti_t7_v9_1_dissect.quote_response_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.quote_response_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = eurex_cash_eti_t7_v9_1_display.quote_response_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.mass_quote_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.mass_quote_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Mass Quote Response
eurex_cash_eti_t7_v9_1_dissect.mass_quote_response_fields = function(buffer, offset, packet, parent, size_of_mass_quote_response)
  local index = offset
  ...
  index, quote_response_id = eurex_cash_eti_t7_v9_1_dissect.quote_response_id(buffer, index, packet, parent)

  -- Market Segment Id: 4 Byte Signed Fixed Width Integer
  index, market_segment_id = eurex_cash_eti_t7_v9_1_dissect.market_segment_id(buffer, index, packet, parent)

  -- No Quote Side Entries: 1 Byte Unsigned Fixed Width Integer
  index, no_quote_side_entries = eurex_cash_eti_t7_v9_1_dissect.no_quote_side_entries(buffer, index, packet, parent)
  ...
  for i = 1, no_quote_side_entries do
    index = eurex_cash_eti_t7_v9_1_dissect.quote_entry_ack_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.mass_quote_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_mass_quote_response = eurex_cash_eti_t7_v9_1_size_of.mass_quote_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.mass_quote_response then
    local range = buffer(offset, size_of_mass_quote_response)
    local display = eurex_cash_eti_t7_v9_1_display.mass_quote_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.mass_quote_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.mass_quote_response_fields(buffer, offset, packet, parent, size_of_mass_quote_response)

  return offset + size_of_mass_quote_response
end

-- Calculate size of: Quote Entry Grp Comp
eurex_cash_eti_t7_v9_1_size_of.quote_entry_grp_comp = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v9_1_display.quote_entry_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Entry Grp Comp
eurex_cash_eti_t7_v9_1_dissect.quote_entry_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.quote_entry_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.quote_entry_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.quote_entry_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.quote_entry_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.quote_entry_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.quote_entry_grp_comp_fields(buffer, offset, packet, parent)
end

-- Read runtime size of: Mass Quote Request
eurex_cash_eti_t7_v9_1_size_of.mass_quote_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.mass_quote_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Mass Quote Request
eurex_cash_eti_t7_v9_1_dissect.mass_quote_request_fields = function(buffer, offset, packet, parent, size_of_mass_quote_request)
  local index = offset
  ...
  for i = 1, no_quote_entries do
    index = eurex_cash_eti_t7_v9_1_dissect.quote_entry_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.mass_quote_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_mass_quote_request = eurex_cash_eti_t7_v9_1_size_of.mass_quote_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.mass_quote_request then
    local range = buffer(offset, size_of_mass_quote_request)
    local display = eurex_cash_eti_t7_v9_1_display.mass_quote_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.mass_quote_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.mass_quote_request_fields(buffer, offset, packet, parent, size_of_mass_quote_request)

  return offset + size_of_mass_quote_request
end

-- Read runtime size of: Logout Response
eurex_cash_eti_t7_v9_1_size_of.logout_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.logout_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Logout Response
eurex_cash_eti_t7_v9_1_dissect.logout_response_fields = function(buffer, offset, packet, parent, size_of_logout_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.logout_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_logout_response = eurex_cash_eti_t7_v9_1_size_of.logout_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.logout_response then
    local range = buffer(offset, size_of_logout_response)
    local display = eurex_cash_eti_t7_v9_1_display.logout_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.logout_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.logout_response_fields(buffer, offset, packet, parent, size_of_logout_response)

  return offset + size_of_logout_response
end

-- Read runtime size of: Logout Request
eurex_cash_eti_t7_v9_1_size_of.logout_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.logout_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Logout Request
eurex_cash_eti_t7_v9_1_dissect.logout_request_fields = function(buffer, offset, packet, parent, size_of_logout_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.logout_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_logout_request = eurex_cash_eti_t7_v9_1_size_of.logout_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.logout_request then
    local range = buffer(offset, size_of_logout_request)
    local display = eurex_cash_eti_t7_v9_1_display.logout_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.logout_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.logout_request_fields(buffer, offset, packet, parent, size_of_logout_request)

  return offset + size_of_logout_request
end

-- Size: Default Cstm Appl Ver Sub Id
eurex_cash_eti_t7_v9_1_size_of.default_cstm_appl_ver_sub_id = 5

-- Display: Default Cstm Appl Ver Sub Id
eurex_cash_eti_t7_v9_1_display.default_cstm_appl_ver_sub_id = function(value)
  if value == "C0002" then
...
eurex_cash_eti_t7_v9_1_dissect.default_cstm_appl_ver_sub_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.default_cstm_appl_ver_sub_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.default_cstm_appl_ver_sub_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.default_cstm_appl_ver_id = 30

-- Display: Default Cstm Appl Ver Id
eurex_cash_eti_t7_v9_1_display.default_cstm_appl_ver_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.default_cstm_appl_ver_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.default_cstm_appl_ver_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.default_cstm_appl_ver_id(value, buffer, offset, packet, parent)
...
-- Size: Trad Ses Mode
eurex_cash_eti_t7_v9_1_size_of.trad_ses_mode = 1

-- Display: Trad Ses Mode
eurex_cash_eti_t7_v9_1_display.trad_ses_mode = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.trad_ses_mode = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.trad_ses_mode
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.trad_ses_mode(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.session_instance_id = 4

-- Display: Session Instance Id
eurex_cash_eti_t7_v9_1_display.session_instance_id = function(value)
  return "Session Instance Id: "..value
end

-- Dissect: Session Instance Id
eurex_cash_eti_t7_v9_1_dissect.session_instance_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.session_instance_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.session_instance_id(value, buffer, offset, packet, parent)
...
-- Size: Heart Bt Int
eurex_cash_eti_t7_v9_1_size_of.heart_bt_int = 4

-- Display: Heart Bt Int
eurex_cash_eti_t7_v9_1_display.heart_bt_int = function(value)
  return "Heart Bt Int: "..value
end

-- Dissect: Heart Bt Int
eurex_cash_eti_t7_v9_1_dissect.heart_bt_int = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.heart_bt_int
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.heart_bt_int(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.logon_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.logon_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Logon Response
eurex_cash_eti_t7_v9_1_dissect.logon_response_fields = function(buffer, offset, packet, parent, size_of_logon_response)
  local index = offset
  ...
  index, heart_bt_int = eurex_cash_eti_t7_v9_1_dissect.heart_bt_int(buffer, index, packet, parent)

  -- Session Instance Id: 4 Byte Unsigned Fixed Width Integer
  index, session_instance_id = eurex_cash_eti_t7_v9_1_dissect.session_instance_id(buffer, index, packet, parent)

  -- Market Id: 2 Byte Unsigned Fixed Width Integer Enum with 9 values
  index, market_id = eurex_cash_eti_t7_v9_1_dissect.market_id(buffer, index, packet, parent)

  -- Trad Ses Mode: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, trad_ses_mode = eurex_cash_eti_t7_v9_1_dissect.trad_ses_mode(buffer, index, packet, parent)

  -- Default Cstm Appl Ver Id: 30 Byte Ascii String Nullable
  index, default_cstm_appl_ver_id = eurex_cash_eti_t7_v9_1_dissect.default_cstm_appl_ver_id(buffer, index, packet, parent)

  -- Default Cstm Appl Ver Sub Id: 5 Byte Ascii String Enum with 1 values
  index, default_cstm_appl_ver_sub_id = eurex_cash_eti_t7_v9_1_dissect.default_cstm_appl_ver_sub_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.logon_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_logon_response = eurex_cash_eti_t7_v9_1_size_of.logon_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.logon_response then
    local range = buffer(offset, size_of_logon_response)
    local display = eurex_cash_eti_t7_v9_1_display.logon_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.logon_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.logon_response_fields(buffer, offset, packet, parent, size_of_logon_response)

  return offset + size_of_logon_response
end

-- Size: Application System Vendor
eurex_cash_eti_t7_v9_1_size_of.application_system_vendor = 30

-- Display: Application System Vendor
eurex_cash_eti_t7_v9_1_display.application_system_vendor = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.application_system_vendor = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.application_system_vendor
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.application_system_vendor(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.application_system_version = 30

-- Display: Application System Version
eurex_cash_eti_t7_v9_1_display.application_system_version = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.application_system_version = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.application_system_version
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.application_system_version(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.application_system_name = 30

-- Display: Application System Name
eurex_cash_eti_t7_v9_1_display.application_system_name = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.application_system_name = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.application_system_name
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.application_system_name(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.fix_engine_vendor = 30

-- Display: Fix Engine Vendor
eurex_cash_eti_t7_v9_1_display.fix_engine_vendor = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.fix_engine_vendor = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fix_engine_vendor
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.fix_engine_vendor(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.fix_engine_version = 30

-- Display: Fix Engine Version
eurex_cash_eti_t7_v9_1_display.fix_engine_version = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.fix_engine_version = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fix_engine_version
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.fix_engine_version(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.fix_engine_name = 30

-- Display: Fix Engine Name
eurex_cash_eti_t7_v9_1_display.fix_engine_name = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.fix_engine_name = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.fix_engine_name
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.fix_engine_name(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.order_routing_indicator = 1

-- Display: Order Routing Indicator
eurex_cash_eti_t7_v9_1_display.order_routing_indicator = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.order_routing_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.order_routing_indicator
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.order_routing_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.appl_usage_quotes = 1

-- Display: Appl Usage Quotes
eurex_cash_eti_t7_v9_1_display.appl_usage_quotes = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.appl_usage_quotes = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_usage_quotes
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.appl_usage_quotes(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.appl_usage_orders = 1

-- Display: Appl Usage Orders
eurex_cash_eti_t7_v9_1_display.appl_usage_orders = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.appl_usage_orders = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_usage_orders
  local range = buffer(offset, length)
  ...
  local display = eurex_cash_eti_t7_v9_1_display.appl_usage_orders(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.logon_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.logon_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Logon Request
eurex_cash_eti_t7_v9_1_dissect.logon_request_fields = function(buffer, offset, packet, parent, size_of_logon_request)
  local index = offset
  ...
  index, appl_usage_orders = eurex_cash_eti_t7_v9_1_dissect.appl_usage_orders(buffer, index, packet, parent)

  -- Appl Usage Quotes: 1 Byte Ascii String Enum with 4 values
  index, appl_usage_quotes = eurex_cash_eti_t7_v9_1_dissect.appl_usage_quotes(buffer, index, packet, parent)

  -- Order Routing Indicator: 1 Byte Ascii String Enum with 2 values
  index, order_routing_indicator = eurex_cash_eti_t7_v9_1_dissect.order_routing_indicator(buffer, index, packet, parent)

  -- Fix Engine Name: 30 Byte Ascii String Nullable
  index, fix_engine_name = eurex_cash_eti_t7_v9_1_dissect.fix_engine_name(buffer, index, packet, parent)

  -- Fix Engine Version: 30 Byte Ascii String Nullable
  index, fix_engine_version = eurex_cash_eti_t7_v9_1_dissect.fix_engine_version(buffer, index, packet, parent)

  -- Fix Engine Vendor: 30 Byte Ascii String Nullable
  index, fix_engine_vendor = eurex_cash_eti_t7_v9_1_dissect.fix_engine_vendor(buffer, index, packet, parent)

  -- Application System Name: 30 Byte Ascii String Nullable
  index, application_system_name = eurex_cash_eti_t7_v9_1_dissect.application_system_name(buffer, index, packet, parent)

  -- Application System Version: 30 Byte Ascii String Nullable
  index, application_system_version = eurex_cash_eti_t7_v9_1_dissect.application_system_version(buffer, index, packet, parent)

  -- Application System Vendor: 30 Byte Ascii String Nullable
  index, application_system_vendor = eurex_cash_eti_t7_v9_1_dissect.application_system_vendor(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.logon_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_logon_request = eurex_cash_eti_t7_v9_1_size_of.logon_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.logon_request then
    local range = buffer(offset, size_of_logon_request)
    local display = eurex_cash_eti_t7_v9_1_display.logon_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.logon_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.logon_request_fields(buffer, offset, packet, parent, size_of_logon_request)

  return offset + size_of_logon_request
end

-- Size: User Status
eurex_cash_eti_t7_v9_1_size_of.user_status = 1

-- Display: User Status
eurex_cash_eti_t7_v9_1_display.user_status = function(value)
  if value == 7 then
...
-- Dissect: User Status
eurex_cash_eti_t7_v9_1_dissect.user_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.user_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.user_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.legal_notification_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.legal_notification_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Legal Notification Broadcast
eurex_cash_eti_t7_v9_1_dissect.legal_notification_broadcast_fields = function(buffer, offset, packet, parent, size_of_legal_notification_broadcast)
  local index = offset
  ...
  index, user_status = eurex_cash_eti_t7_v9_1_dissect.user_status(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.legal_notification_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_legal_notification_broadcast = eurex_cash_eti_t7_v9_1_size_of.legal_notification_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.legal_notification_broadcast then
    local range = buffer(offset, size_of_legal_notification_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.legal_notification_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.legal_notification_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.legal_notification_broadcast_fields(buffer, offset, packet, parent, size_of_legal_notification_broadcast)

  return offset + size_of_legal_notification_broadcast
end

-- Read runtime size of: Issuer Security State Change Response
eurex_cash_eti_t7_v9_1_size_of.issuer_security_state_change_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.issuer_security_state_change_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Issuer Security State Change Response
eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_response_fields = function(buffer, offset, packet, parent, size_of_issuer_security_state_change_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_issuer_security_state_change_response = eurex_cash_eti_t7_v9_1_size_of.issuer_security_state_change_response(buffer, offset)
  ...
  if show.issuer_security_state_change_response then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.issuer_security_state_change_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.issuer_security_state_change_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_response_fields(buffer, offset, packet, parent, size_of_issuer_security_state_change_response)

  return offset + size_of_issuer_security_state_change_response
end

-- Size: Event Date
eurex_cash_eti_t7_v9_1_size_of.event_date = 4

-- Display: Event Date
eurex_cash_eti_t7_v9_1_display.event_date = function(value)
  return "Event Date: "..value
end

-- Dissect: Event Date
eurex_cash_eti_t7_v9_1_dissect.event_date = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.event_date
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.event_date(value, buffer, offset, packet, parent)
...
-- Dissect: Event Px
eurex_cash_eti_t7_v9_1_dissect.event_px = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.event_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.security_status_event_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.event_px

  index = index + eurex_cash_eti_t7_v9_1_size_of.event_date

  index = index + eurex_cash_eti_t7_v9_1_size_of.event_type
...
eurex_cash_eti_t7_v9_1_display.security_status_event_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end
...
eurex_cash_eti_t7_v9_1_dissect.security_status_event_grp_comp_fields = function(buffer, offset, packet, parent)
  ...
  index, event_date = eurex_cash_eti_t7_v9_1_dissect.event_date(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.security_status_event_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.security_status_event_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.security_status_event_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.security_status_event_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.security_status_event_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.security_status_event_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: Sold Out Indicator
eurex_cash_eti_t7_v9_1_size_of.sold_out_indicator = 1

-- Display: Sold Out Indicator
eurex_cash_eti_t7_v9_1_display.sold_out_indicator = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.sold_out_indicator = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.sold_out_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.sold_out_indicator(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.security_status = 1

-- Display: Security Status
eurex_cash_eti_t7_v9_1_display.security_status = function(value)
  if value == 6 then
...
eurex_cash_eti_t7_v9_1_dissect.security_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.security_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.security_status(value, buffer, offset, packet, parent)
...
-- Size: No Events
eurex_cash_eti_t7_v9_1_size_of.no_events = 1

-- Display: No Events
eurex_cash_eti_t7_v9_1_display.no_events = function(value)
  return "No Events: "..value
end

-- Dissect: No Events
eurex_cash_eti_t7_v9_1_dissect.no_events = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_events
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_events(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.issuer_security_state_change_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.issuer_security_state_change_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Issuer Security State Change Request
eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_request_fields = function(buffer, offset, packet, parent, size_of_issuer_security_state_change_request)
  local index = offset
  ...
  index, no_events = eurex_cash_eti_t7_v9_1_dissect.no_events(buffer, index, packet, parent)

  -- Security Status: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, security_status = eurex_cash_eti_t7_v9_1_dissect.security_status(buffer, index, packet, parent)

  -- Sold Out Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, sold_out_indicator = eurex_cash_eti_t7_v9_1_dissect.sold_out_indicator(buffer, index, packet, parent)
  ...
  for i = 1, no_events do
    index = eurex_cash_eti_t7_v9_1_dissect.security_status_event_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_issuer_security_state_change_request = eurex_cash_eti_t7_v9_1_size_of.issuer_security_state_change_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.issuer_security_state_change_request then
    local range = buffer(offset, size_of_issuer_security_state_change_request)
    local display = eurex_cash_eti_t7_v9_1_display.issuer_security_state_change_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.issuer_security_state_change_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_request_fields(buffer, offset, packet, parent, size_of_issuer_security_state_change_request)

  return offset + size_of_issuer_security_state_change_request
end

-- Size: Security Trading Status
eurex_cash_eti_t7_v9_1_size_of.security_trading_status = 1

-- Display: Security Trading Status
eurex_cash_eti_t7_v9_1_display.security_trading_status = function(value)
  if value == 7 then
...
eurex_cash_eti_t7_v9_1_dissect.security_trading_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.security_trading_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.security_trading_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.imbalance_qty = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.imbalance_qty
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_dissect.potential_exec_volume = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.potential_exec_volume
  local range = buffer(offset, length)
  local raw = range:le_uint64()
...
eurex_cash_eti_t7_v9_1_size_of.issuer_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.issuer_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Issuer Notification
eurex_cash_eti_t7_v9_1_dissect.issuer_notification_fields = function(buffer, offset, packet, parent, size_of_issuer_notification)
  local index = offset
  ...
  index, security_trading_status = eurex_cash_eti_t7_v9_1_dissect.security_trading_status(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.issuer_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_issuer_notification = eurex_cash_eti_t7_v9_1_size_of.issuer_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.issuer_notification then
    local range = buffer(offset, size_of_issuer_notification)
    local display = eurex_cash_eti_t7_v9_1_display.issuer_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.issuer_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.issuer_notification_fields(buffer, offset, packet, parent, size_of_issuer_notification)

  return offset + size_of_issuer_notification
end

-- Size: Party Detail Desk Id
eurex_cash_eti_t7_v9_1_size_of.party_detail_desk_id = 3

-- Display: Party Detail Desk Id
eurex_cash_eti_t7_v9_1_display.party_detail_desk_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.party_detail_desk_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_detail_desk_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_detail_desk_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_detail_role_qualifier = 1

-- Display: Party Detail Role Qualifier
eurex_cash_eti_t7_v9_1_display.party_detail_role_qualifier = function(value)
  if value == 10 then
...
eurex_cash_eti_t7_v9_1_dissect.party_detail_role_qualifier = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_detail_role_qualifier
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_detail_role_qualifier(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_detail_executing_trader = 6

-- Display: Party Detail Executing Trader
eurex_cash_eti_t7_v9_1_display.party_detail_executing_trader = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.party_detail_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_detail_executing_trader
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.party_detail_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_detail_id_executing_trader = 4

-- Display: Party Detail Id Executing Trader
eurex_cash_eti_t7_v9_1_display.party_detail_id_executing_trader = function(value)
  return "Party Detail Id Executing Trader: "..value
end

-- Dissect: Party Detail Id Executing Trader
eurex_cash_eti_t7_v9_1_dissect.party_detail_id_executing_trader = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.party_detail_id_executing_trader
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.party_detail_id_executing_trader(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.party_details_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_detail_id_executing_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_detail_executing_trader

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_detail_role_qualifier

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_detail_status

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_detail_desk_id
...
eurex_cash_eti_t7_v9_1_display.party_details_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Party Details Grp Comp
eurex_cash_eti_t7_v9_1_dissect.party_details_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Party Detail Id Executing Trader: 4 Byte Unsigned Fixed Width Integer
  index, party_detail_id_executing_trader = eurex_cash_eti_t7_v9_1_dissect.party_detail_id_executing_trader(buffer, index, packet, parent)

  -- Party Detail Executing Trader: 6 Byte Ascii String Nullable
  index, party_detail_executing_trader = eurex_cash_eti_t7_v9_1_dissect.party_detail_executing_trader(buffer, index, packet, parent)

  -- Party Detail Role Qualifier: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, party_detail_role_qualifier = eurex_cash_eti_t7_v9_1_dissect.party_detail_role_qualifier(buffer, index, packet, parent)

  -- Party Detail Status: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, party_detail_status = eurex_cash_eti_t7_v9_1_dissect.party_detail_status(buffer, index, packet, parent)

  -- Party Detail Desk Id: 3 Byte Ascii String Nullable
  index, party_detail_desk_id = eurex_cash_eti_t7_v9_1_dissect.party_detail_desk_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.party_details_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.party_details_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.party_details_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.party_details_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.party_details_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.party_details_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Party Details
eurex_cash_eti_t7_v9_1_size_of.no_party_details = 2

-- Display: No Party Details
eurex_cash_eti_t7_v9_1_display.no_party_details = function(value)
  return "No Party Details: "..value
end

-- Dissect: No Party Details
eurex_cash_eti_t7_v9_1_dissect.no_party_details = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_party_details
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_party_details(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.last_entity_processed = 16

-- Display: Last Entity Processed
eurex_cash_eti_t7_v9_1_display.last_entity_processed = function(value)
  return "Last Entity Processed: "..value
end

-- Dissect: Last Entity Processed
eurex_cash_eti_t7_v9_1_dissect.last_entity_processed = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.last_entity_processed
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v9_1_display.last_entity_processed(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.inquire_user_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.inquire_user_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Inquire User Response
eurex_cash_eti_t7_v9_1_dissect.inquire_user_response_fields = function(buffer, offset, packet, parent, size_of_inquire_user_response)
  local index = offset
  ...
  index, last_entity_processed = eurex_cash_eti_t7_v9_1_dissect.last_entity_processed(buffer, index, packet, parent)

  -- No Party Details: 2 Byte Unsigned Fixed Width Integer
  index, no_party_details = eurex_cash_eti_t7_v9_1_dissect.no_party_details(buffer, index, packet, parent)
  ...
  for i = 1, no_party_details do
    index = eurex_cash_eti_t7_v9_1_dissect.party_details_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.inquire_user_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_inquire_user_response = eurex_cash_eti_t7_v9_1_size_of.inquire_user_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.inquire_user_response then
    local range = buffer(offset, size_of_inquire_user_response)
    local display = eurex_cash_eti_t7_v9_1_display.inquire_user_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.inquire_user_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.inquire_user_response_fields(buffer, offset, packet, parent, size_of_inquire_user_response)

  return offset + size_of_inquire_user_response
end

-- Read runtime size of: Inquire User Request
eurex_cash_eti_t7_v9_1_size_of.inquire_user_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.inquire_user_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Inquire User Request
eurex_cash_eti_t7_v9_1_dissect.inquire_user_request_fields = function(buffer, offset, packet, parent, size_of_inquire_user_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.inquire_user_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_inquire_user_request = eurex_cash_eti_t7_v9_1_size_of.inquire_user_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.inquire_user_request then
    local range = buffer(offset, size_of_inquire_user_request)
    local display = eurex_cash_eti_t7_v9_1_display.inquire_user_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.inquire_user_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.inquire_user_request_fields(buffer, offset, packet, parent, size_of_inquire_user_request)

  return offset + size_of_inquire_user_request
end

-- Size: Session Sub Mode
eurex_cash_eti_t7_v9_1_size_of.session_sub_mode = 1

-- Display: Session Sub Mode
eurex_cash_eti_t7_v9_1_display.session_sub_mode = function(value)
  if value == 0 then
...
eurex_cash_eti_t7_v9_1_dissect.session_sub_mode = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.session_sub_mode
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.session_sub_mode(value, buffer, offset, packet, parent)
...
-- Size: Session Mode
eurex_cash_eti_t7_v9_1_size_of.session_mode = 1

-- Display: Session Mode
eurex_cash_eti_t7_v9_1_display.session_mode = function(value)
  if value == 1 then
...
eurex_cash_eti_t7_v9_1_dissect.session_mode = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.session_mode
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.session_mode(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.sessions_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.party_id_session_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.session_mode

  index = index + eurex_cash_eti_t7_v9_1_size_of.session_sub_mode
...
eurex_cash_eti_t7_v9_1_display.sessions_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Sessions Grp Comp
eurex_cash_eti_t7_v9_1_dissect.sessions_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, session_mode = eurex_cash_eti_t7_v9_1_dissect.session_mode(buffer, index, packet, parent)

  -- Session Sub Mode: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, session_sub_mode = eurex_cash_eti_t7_v9_1_dissect.session_sub_mode(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.sessions_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.sessions_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.sessions_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.sessions_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.sessions_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.sessions_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Sessions
eurex_cash_eti_t7_v9_1_size_of.no_sessions = 2

-- Display: No Sessions
eurex_cash_eti_t7_v9_1_display.no_sessions = function(value)
  return "No Sessions: "..value
end

-- Dissect: No Sessions
eurex_cash_eti_t7_v9_1_dissect.no_sessions = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_sessions
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_sessions(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.inquire_session_list_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.inquire_session_list_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Inquire Session List Response
eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_response_fields = function(buffer, offset, packet, parent, size_of_inquire_session_list_response)
  local index = offset
  ...
  index, no_sessions = eurex_cash_eti_t7_v9_1_dissect.no_sessions(buffer, index, packet, parent)
  ...
  for i = 1, no_sessions do
    index = eurex_cash_eti_t7_v9_1_dissect.sessions_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_inquire_session_list_response = eurex_cash_eti_t7_v9_1_size_of.inquire_session_list_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.inquire_session_list_response then
    local range = buffer(offset, size_of_inquire_session_list_response)
    local display = eurex_cash_eti_t7_v9_1_display.inquire_session_list_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.inquire_session_list_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_response_fields(buffer, offset, packet, parent, size_of_inquire_session_list_response)

  return offset + size_of_inquire_session_list_response
end

-- Read runtime size of: Inquire Session List Request
eurex_cash_eti_t7_v9_1_size_of.inquire_session_list_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.inquire_session_list_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Inquire Session List Request
eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_request_fields = function(buffer, offset, packet, parent, size_of_inquire_session_list_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_inquire_session_list_request = eurex_cash_eti_t7_v9_1_size_of.inquire_session_list_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.inquire_session_list_request then
    local range = buffer(offset, size_of_inquire_session_list_request)
    local display = eurex_cash_eti_t7_v9_1_display.inquire_session_list_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.inquire_session_list_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_request_fields(buffer, offset, packet, parent, size_of_inquire_session_list_request)

  return offset + size_of_inquire_session_list_request
end

-- Calculate size of: Enrichment Rules Grp Comp
eurex_cash_eti_t7_v9_1_size_of.enrichment_rules_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.enrichment_rule_id

  index = index + eurex_cash_eti_t7_v9_1_size_of.free_text_1

  index = index + eurex_cash_eti_t7_v9_1_size_of.free_text_2

  index = index + eurex_cash_eti_t7_v9_1_size_of.free_text_4
...
eurex_cash_eti_t7_v9_1_display.enrichment_rules_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Enrichment Rules Grp Comp
eurex_cash_eti_t7_v9_1_dissect.enrichment_rules_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.enrichment_rules_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.enrichment_rules_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.enrichment_rules_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.enrichment_rules_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.enrichment_rules_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.enrichment_rules_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Enrichment Rules
eurex_cash_eti_t7_v9_1_size_of.no_enrichment_rules = 2

-- Display: No Enrichment Rules
eurex_cash_eti_t7_v9_1_display.no_enrichment_rules = function(value)
  return "No Enrichment Rules: "..value
end

-- Dissect: No Enrichment Rules
eurex_cash_eti_t7_v9_1_dissect.no_enrichment_rules = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_enrichment_rules
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_enrichment_rules(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.inquire_enrichment_rule_id_list_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.inquire_enrichment_rule_id_list_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Inquire Enrichment Rule Id List Response
eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_response_fields = function(buffer, offset, packet, parent, size_of_inquire_enrichment_rule_id_list_response)
  local index = offset
  ...
  index, no_enrichment_rules = eurex_cash_eti_t7_v9_1_dissect.no_enrichment_rules(buffer, index, packet, parent)
  ...
  for i = 1, no_enrichment_rules do
    index = eurex_cash_eti_t7_v9_1_dissect.enrichment_rules_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_inquire_enrichment_rule_id_list_response = eurex_cash_eti_t7_v9_1_size_of.inquire_enrichment_rule_id_list_response(buffer, offset)
  ...
  if show.inquire_enrichment_rule_id_list_response then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.inquire_enrichment_rule_id_list_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.inquire_enrichment_rule_id_list_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_response_fields(buffer, offset, packet, parent, size_of_inquire_enrichment_rule_id_list_response)
...
eurex_cash_eti_t7_v9_1_size_of.inquire_enrichment_rule_id_list_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.inquire_enrichment_rule_id_list_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Inquire Enrichment Rule Id List Request
eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_request_fields = function(buffer, offset, packet, parent, size_of_inquire_enrichment_rule_id_list_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_inquire_enrichment_rule_id_list_request = eurex_cash_eti_t7_v9_1_size_of.inquire_enrichment_rule_id_list_request(buffer, offset)
  ...
  if show.inquire_enrichment_rule_id_list_request then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.inquire_enrichment_rule_id_list_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.inquire_enrichment_rule_id_list_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_request_fields(buffer, offset, packet, parent, size_of_inquire_enrichment_rule_id_list_request)

  return offset + size_of_inquire_enrichment_rule_id_list_request
end

-- Read runtime size of: Heartbeat Notification
eurex_cash_eti_t7_v9_1_size_of.heartbeat_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.heartbeat_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Heartbeat Notification
eurex_cash_eti_t7_v9_1_dissect.heartbeat_notification_fields = function(buffer, offset, packet, parent, size_of_heartbeat_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.heartbeat_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_heartbeat_notification = eurex_cash_eti_t7_v9_1_size_of.heartbeat_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.heartbeat_notification then
    local range = buffer(offset, size_of_heartbeat_notification)
    local display = eurex_cash_eti_t7_v9_1_display.heartbeat_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.heartbeat_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.heartbeat_notification_fields(buffer, offset, packet, parent, size_of_heartbeat_notification)

  return offset + size_of_heartbeat_notification
end

-- Read runtime size of: Heartbeat
eurex_cash_eti_t7_v9_1_size_of.heartbeat = function(buffer, offset)
  local index = offset
...
-- Display: Heartbeat
eurex_cash_eti_t7_v9_1_display.heartbeat = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Heartbeat
eurex_cash_eti_t7_v9_1_dissect.heartbeat_fields = function(buffer, offset, packet, parent, size_of_heartbeat)
  local index = offset
...
-- Dissect: Heartbeat
eurex_cash_eti_t7_v9_1_dissect.heartbeat = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_heartbeat = eurex_cash_eti_t7_v9_1_size_of.heartbeat(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.heartbeat then
    local range = buffer(offset, size_of_heartbeat)
    local display = eurex_cash_eti_t7_v9_1_display.heartbeat(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.heartbeat, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.heartbeat_fields(buffer, offset, packet, parent, size_of_heartbeat)

  return offset + size_of_heartbeat
end

-- Read runtime size of: Forced User Logout Notification
eurex_cash_eti_t7_v9_1_size_of.forced_user_logout_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.forced_user_logout_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Forced User Logout Notification
eurex_cash_eti_t7_v9_1_dissect.forced_user_logout_notification_fields = function(buffer, offset, packet, parent, size_of_forced_user_logout_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.forced_user_logout_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_forced_user_logout_notification = eurex_cash_eti_t7_v9_1_size_of.forced_user_logout_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.forced_user_logout_notification then
    local range = buffer(offset, size_of_forced_user_logout_notification)
    local display = eurex_cash_eti_t7_v9_1_display.forced_user_logout_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.forced_user_logout_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.forced_user_logout_notification_fields(buffer, offset, packet, parent, size_of_forced_user_logout_notification)

  return offset + size_of_forced_user_logout_notification
end

-- Read runtime size of: Forced Logout Notification
eurex_cash_eti_t7_v9_1_size_of.forced_logout_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.forced_logout_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Forced Logout Notification
eurex_cash_eti_t7_v9_1_dissect.forced_logout_notification_fields = function(buffer, offset, packet, parent, size_of_forced_logout_notification)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.forced_logout_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_forced_logout_notification = eurex_cash_eti_t7_v9_1_size_of.forced_logout_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.forced_logout_notification then
    local range = buffer(offset, size_of_forced_logout_notification)
    local display = eurex_cash_eti_t7_v9_1_display.forced_logout_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.forced_logout_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.forced_logout_notification_fields(buffer, offset, packet, parent, size_of_forced_logout_notification)

  return offset + size_of_forced_logout_notification
end

-- Read runtime size of: Extended Deletion Report
eurex_cash_eti_t7_v9_1_size_of.extended_deletion_report = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.extended_deletion_report = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Extended Deletion Report
eurex_cash_eti_t7_v9_1_dissect.extended_deletion_report_fields = function(buffer, offset, packet, parent, size_of_extended_deletion_report)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.extended_deletion_report = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_extended_deletion_report = eurex_cash_eti_t7_v9_1_size_of.extended_deletion_report(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.extended_deletion_report then
    local range = buffer(offset, size_of_extended_deletion_report)
    local display = eurex_cash_eti_t7_v9_1_display.extended_deletion_report(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.extended_deletion_report, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.extended_deletion_report_fields(buffer, offset, packet, parent, size_of_extended_deletion_report)

  return offset + size_of_extended_deletion_report
end

-- Read runtime size of: Enter Tes Trade Request
eurex_cash_eti_t7_v9_1_size_of.enter_tes_trade_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.enter_tes_trade_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Enter Tes Trade Request
eurex_cash_eti_t7_v9_1_dissect.enter_tes_trade_request_fields = function(buffer, offset, packet, parent, size_of_enter_tes_trade_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.enter_tes_trade_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_enter_tes_trade_request = eurex_cash_eti_t7_v9_1_size_of.enter_tes_trade_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.enter_tes_trade_request then
    local range = buffer(offset, size_of_enter_tes_trade_request)
    local display = eurex_cash_eti_t7_v9_1_display.enter_tes_trade_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.enter_tes_trade_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.enter_tes_trade_request_fields(buffer, offset, packet, parent, size_of_enter_tes_trade_request)

  return offset + size_of_enter_tes_trade_request
end

-- Read runtime size of: Delete Tes Trade Request
eurex_cash_eti_t7_v9_1_size_of.delete_tes_trade_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_tes_trade_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete Tes Trade Request
eurex_cash_eti_t7_v9_1_dissect.delete_tes_trade_request_fields = function(buffer, offset, packet, parent, size_of_delete_tes_trade_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_tes_trade_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_tes_trade_request = eurex_cash_eti_t7_v9_1_size_of.delete_tes_trade_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_tes_trade_request then
    local range = buffer(offset, size_of_delete_tes_trade_request)
    local display = eurex_cash_eti_t7_v9_1_display.delete_tes_trade_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_tes_trade_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_tes_trade_request_fields(buffer, offset, packet, parent, size_of_delete_tes_trade_request)

  return offset + size_of_delete_tes_trade_request
end

-- Read runtime size of: Delete Order Single Request
eurex_cash_eti_t7_v9_1_size_of.delete_order_single_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_order_single_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete Order Single Request
eurex_cash_eti_t7_v9_1_dissect.delete_order_single_request_fields = function(buffer, offset, packet, parent, size_of_delete_order_single_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_order_single_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_order_single_request = eurex_cash_eti_t7_v9_1_size_of.delete_order_single_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_order_single_request then
    local range = buffer(offset, size_of_delete_order_single_request)
    local display = eurex_cash_eti_t7_v9_1_display.delete_order_single_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_order_single_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_order_single_request_fields(buffer, offset, packet, parent, size_of_delete_order_single_request)

  return offset + size_of_delete_order_single_request
end

-- Read runtime size of: Delete Order Response
eurex_cash_eti_t7_v9_1_size_of.delete_order_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_order_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete Order Response
eurex_cash_eti_t7_v9_1_dissect.delete_order_response_fields = function(buffer, offset, packet, parent, size_of_delete_order_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_order_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_order_response = eurex_cash_eti_t7_v9_1_size_of.delete_order_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_order_response then
    local range = buffer(offset, size_of_delete_order_response)
    local display = eurex_cash_eti_t7_v9_1_display.delete_order_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_order_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_order_response_fields(buffer, offset, packet, parent, size_of_delete_order_response)

  return offset + size_of_delete_order_response
end

-- Read runtime size of: Delete Order Nr Response
eurex_cash_eti_t7_v9_1_size_of.delete_order_nr_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_order_nr_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete Order Nr Response
eurex_cash_eti_t7_v9_1_dissect.delete_order_nr_response_fields = function(buffer, offset, packet, parent, size_of_delete_order_nr_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_order_nr_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_order_nr_response = eurex_cash_eti_t7_v9_1_size_of.delete_order_nr_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_order_nr_response then
    local range = buffer(offset, size_of_delete_order_nr_response)
    local display = eurex_cash_eti_t7_v9_1_display.delete_order_nr_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_order_nr_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_order_nr_response_fields(buffer, offset, packet, parent, size_of_delete_order_nr_response)

  return offset + size_of_delete_order_nr_response
end

-- Read runtime size of: Delete Order Broadcast
eurex_cash_eti_t7_v9_1_size_of.delete_order_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_order_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete Order Broadcast
eurex_cash_eti_t7_v9_1_dissect.delete_order_broadcast_fields = function(buffer, offset, packet, parent, size_of_delete_order_broadcast)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_order_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_order_broadcast = eurex_cash_eti_t7_v9_1_size_of.delete_order_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_order_broadcast then
    local range = buffer(offset, size_of_delete_order_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.delete_order_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_order_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_order_broadcast_fields(buffer, offset, packet, parent, size_of_delete_order_broadcast)

  return offset + size_of_delete_order_broadcast
end

-- Read runtime size of: Delete All Quote Response
eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_quote_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Quote Response
eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_response_fields = function(buffer, offset, packet, parent, size_of_delete_all_quote_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_quote_response = eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_all_quote_response then
    local range = buffer(offset, size_of_delete_all_quote_response)
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_quote_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_quote_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_response_fields(buffer, offset, packet, parent, size_of_delete_all_quote_response)

  return offset + size_of_delete_all_quote_response
end

-- Read runtime size of: Delete All Quote Request
eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_quote_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Quote Request
eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_request_fields = function(buffer, offset, packet, parent, size_of_delete_all_quote_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_quote_request = eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_all_quote_request then
    local range = buffer(offset, size_of_delete_all_quote_request)
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_quote_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_quote_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_request_fields(buffer, offset, packet, parent, size_of_delete_all_quote_request)

  return offset + size_of_delete_all_quote_request
end

-- Size: Target Party Id Desk Id
eurex_cash_eti_t7_v9_1_size_of.target_party_id_desk_id = 3

-- Display: Target Party Id Desk Id
eurex_cash_eti_t7_v9_1_display.target_party_id_desk_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
eurex_cash_eti_t7_v9_1_dissect.target_party_id_desk_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.target_party_id_desk_id
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = eurex_cash_eti_t7_v9_1_display.target_party_id_desk_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_quote_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Quote Broadcast
eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_broadcast_fields = function(buffer, offset, packet, parent, size_of_delete_all_quote_broadcast)
  local index = offset
  ...
  index, target_party_id_desk_id = eurex_cash_eti_t7_v9_1_dissect.target_party_id_desk_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_quote_broadcast = eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_all_quote_broadcast then
    local range = buffer(offset, size_of_delete_all_quote_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_quote_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_quote_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_broadcast_fields(buffer, offset, packet, parent, size_of_delete_all_quote_broadcast)

  return offset + size_of_delete_all_quote_broadcast
end

-- Size: Affected Order Request Id
eurex_cash_eti_t7_v9_1_size_of.affected_order_request_id = 4

-- Display: Affected Order Request Id
eurex_cash_eti_t7_v9_1_display.affected_order_request_id = function(value)
  return "Affected Order Request Id: "..value
end

-- Dissect: Affected Order Request Id
eurex_cash_eti_t7_v9_1_dissect.affected_order_request_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.affected_order_request_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.affected_order_request_id(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.affected_order_requests_grp_comp = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.affected_order_request_id
...
eurex_cash_eti_t7_v9_1_display.affected_order_requests_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Affected Order Requests Grp Comp
eurex_cash_eti_t7_v9_1_dissect.affected_order_requests_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Affected Order Request Id: 4 Byte Unsigned Fixed Width Integer
  index, affected_order_request_id = eurex_cash_eti_t7_v9_1_dissect.affected_order_request_id(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.affected_order_requests_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.affected_order_requests_grp_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.affected_order_requests_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.affected_order_requests_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.affected_order_requests_grp_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.affected_order_requests_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Affected Order Requests
eurex_cash_eti_t7_v9_1_size_of.no_affected_order_requests = 2

-- Display: No Affected Order Requests
eurex_cash_eti_t7_v9_1_display.no_affected_order_requests = function(value)
  return "No Affected Order Requests: "..value
end

-- Dissect: No Affected Order Requests
eurex_cash_eti_t7_v9_1_dissect.no_affected_order_requests = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.no_affected_order_requests
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.no_affected_order_requests(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.delete_all_order_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_order_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Order Response
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_response_fields = function(buffer, offset, packet, parent, size_of_delete_all_order_response)
  local index = offset
  ...
  index, no_affected_order_requests = eurex_cash_eti_t7_v9_1_dissect.no_affected_order_requests(buffer, index, packet, parent)
  ...
  for i = 1, no_affected_order_requests do
    index = eurex_cash_eti_t7_v9_1_dissect.affected_order_requests_grp_comp(buffer, index, packet, parent)
  end
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_order_response = eurex_cash_eti_t7_v9_1_size_of.delete_all_order_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_all_order_response then
    local range = buffer(offset, size_of_delete_all_order_response)
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_order_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_order_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_order_response_fields(buffer, offset, packet, parent, size_of_delete_all_order_response)

  return offset + size_of_delete_all_order_response
end

-- Read runtime size of: Delete All Order Request
eurex_cash_eti_t7_v9_1_size_of.delete_all_order_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_order_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Order Request
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_request_fields = function(buffer, offset, packet, parent, size_of_delete_all_order_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_order_request = eurex_cash_eti_t7_v9_1_size_of.delete_all_order_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_all_order_request then
    local range = buffer(offset, size_of_delete_all_order_request)
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_order_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_order_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_order_request_fields(buffer, offset, packet, parent, size_of_delete_all_order_request)

  return offset + size_of_delete_all_order_request
end

-- Read runtime size of: Delete All Order Quote Event Broadcast
eurex_cash_eti_t7_v9_1_size_of.delete_all_order_quote_event_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_order_quote_event_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Order Quote Event Broadcast
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_quote_event_broadcast_fields = function(buffer, offset, packet, parent, size_of_delete_all_order_quote_event_broadcast)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_quote_event_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_order_quote_event_broadcast = eurex_cash_eti_t7_v9_1_size_of.delete_all_order_quote_event_broadcast(buffer, offset)
  ...
  if show.delete_all_order_quote_event_broadcast then
    ...
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_order_quote_event_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_order_quote_event_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_order_quote_event_broadcast_fields(buffer, offset, packet, parent, size_of_delete_all_order_quote_event_broadcast)

  return offset + size_of_delete_all_order_quote_event_broadcast
end

-- Read runtime size of: Delete All Order Nr Response
eurex_cash_eti_t7_v9_1_size_of.delete_all_order_nr_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_order_nr_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Order Nr Response
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_nr_response_fields = function(buffer, offset, packet, parent, size_of_delete_all_order_nr_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_nr_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_order_nr_response = eurex_cash_eti_t7_v9_1_size_of.delete_all_order_nr_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_all_order_nr_response then
    local range = buffer(offset, size_of_delete_all_order_nr_response)
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_order_nr_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_order_nr_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_order_nr_response_fields(buffer, offset, packet, parent, size_of_delete_all_order_nr_response)

  return offset + size_of_delete_all_order_nr_response
end

-- Read runtime size of: Delete All Order Broadcast
eurex_cash_eti_t7_v9_1_size_of.delete_all_order_broadcast = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.delete_all_order_broadcast = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Delete All Order Broadcast
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_broadcast_fields = function(buffer, offset, packet, parent, size_of_delete_all_order_broadcast)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.delete_all_order_broadcast = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_delete_all_order_broadcast = eurex_cash_eti_t7_v9_1_size_of.delete_all_order_broadcast(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.delete_all_order_broadcast then
    local range = buffer(offset, size_of_delete_all_order_broadcast)
    local display = eurex_cash_eti_t7_v9_1_display.delete_all_order_broadcast(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.delete_all_order_broadcast, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.delete_all_order_broadcast_fields(buffer, offset, packet, parent, size_of_delete_all_order_broadcast)

  return offset + size_of_delete_all_order_broadcast
end

-- Read runtime size of: Cross Request Response
eurex_cash_eti_t7_v9_1_size_of.cross_request_response = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.cross_request_response = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Cross Request Response
eurex_cash_eti_t7_v9_1_dissect.cross_request_response_fields = function(buffer, offset, packet, parent, size_of_cross_request_response)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.cross_request_response = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_cross_request_response = eurex_cash_eti_t7_v9_1_size_of.cross_request_response(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.cross_request_response then
    local range = buffer(offset, size_of_cross_request_response)
    local display = eurex_cash_eti_t7_v9_1_display.cross_request_response(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.cross_request_response, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.cross_request_response_fields(buffer, offset, packet, parent, size_of_cross_request_response)

  return offset + size_of_cross_request_response
end

-- Read runtime size of: Cross Request
eurex_cash_eti_t7_v9_1_size_of.cross_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.cross_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Cross Request
eurex_cash_eti_t7_v9_1_dissect.cross_request_fields = function(buffer, offset, packet, parent, size_of_cross_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.cross_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_cross_request = eurex_cash_eti_t7_v9_1_size_of.cross_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.cross_request then
    local range = buffer(offset, size_of_cross_request)
    local display = eurex_cash_eti_t7_v9_1_display.cross_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.cross_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.cross_request_fields(buffer, offset, packet, parent, size_of_cross_request)

  return offset + size_of_cross_request
end

-- Size: Appl Id Status
eurex_cash_eti_t7_v9_1_size_of.appl_id_status = 4

-- Display: Appl Id Status
eurex_cash_eti_t7_v9_1_display.appl_id_status = function(value)
  if value == 105 then
...
eurex_cash_eti_t7_v9_1_dissect.appl_id_status = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.appl_id_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.appl_id_status(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.broadcast_error_notification = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.broadcast_error_notification = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Broadcast Error Notification
eurex_cash_eti_t7_v9_1_dissect.broadcast_error_notification_fields = function(buffer, offset, packet, parent, size_of_broadcast_error_notification)
  local index = offset
  ...
  index, appl_id_status = eurex_cash_eti_t7_v9_1_dissect.appl_id_status(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_dissect.broadcast_error_notification = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_broadcast_error_notification = eurex_cash_eti_t7_v9_1_size_of.broadcast_error_notification(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.broadcast_error_notification then
    local range = buffer(offset, size_of_broadcast_error_notification)
    local display = eurex_cash_eti_t7_v9_1_display.broadcast_error_notification(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.broadcast_error_notification, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.broadcast_error_notification_fields(buffer, offset, packet, parent, size_of_broadcast_error_notification)

  return offset + size_of_broadcast_error_notification
end

-- Read runtime size of: Approve Tes Trade Request
eurex_cash_eti_t7_v9_1_size_of.approve_tes_trade_request = function(buffer, offset)
  local index = offset
...
eurex_cash_eti_t7_v9_1_display.approve_tes_trade_request = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Approve Tes Trade Request
eurex_cash_eti_t7_v9_1_dissect.approve_tes_trade_request_fields = function(buffer, offset, packet, parent, size_of_approve_tes_trade_request)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.approve_tes_trade_request = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_approve_tes_trade_request = eurex_cash_eti_t7_v9_1_size_of.approve_tes_trade_request(buffer, offset)

  -- Optionally add struct element to protocol tree
  if show.approve_tes_trade_request then
    local range = buffer(offset, size_of_approve_tes_trade_request)
    local display = eurex_cash_eti_t7_v9_1_display.approve_tes_trade_request(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.approve_tes_trade_request, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.approve_tes_trade_request_fields(buffer, offset, packet, parent, size_of_approve_tes_trade_request)

  return offset + size_of_approve_tes_trade_request
end

-- Calculate runtime size of: Payload
eurex_cash_eti_t7_v9_1_size_of.payload = function(buffer, offset, template_id)
  -- Size of Approve Tes Trade Request
  if template_id == 10603 then
    return eurex_cash_eti_t7_v9_1_size_of.approve_tes_trade_request(buffer, offset)
  end
  -- Size of Broadcast Error Notification
  if template_id == 10032 then
    return eurex_cash_eti_t7_v9_1_size_of.broadcast_error_notification(buffer, offset)
  end
  -- Size of Cross Request
  if template_id == 10118 then
    return eurex_cash_eti_t7_v9_1_size_of.cross_request(buffer, offset)
  end
  -- Size of Cross Request Response
  if template_id == 10119 then
    return eurex_cash_eti_t7_v9_1_size_of.cross_request_response(buffer, offset)
  end
  -- Size of Delete All Order Broadcast
  if template_id == 10122 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_order_broadcast(buffer, offset)
  end
  -- Size of Delete All Order Nr Response
  if template_id == 10124 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_order_nr_response(buffer, offset)
  end
  -- Size of Delete All Order Quote Event Broadcast
  if template_id == 10308 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_order_quote_event_broadcast(buffer, offset)
  end
  -- Size of Delete All Order Request
  if template_id == 10120 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_order_request(buffer, offset)
  end
  -- Size of Delete All Order Response
  if template_id == 10121 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_order_response(buffer, offset)
  end
  -- Size of Delete All Quote Broadcast
  if template_id == 10410 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_broadcast(buffer, offset)
  end
  -- Size of Delete All Quote Request
  if template_id == 10408 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_request(buffer, offset)
  end
  -- Size of Delete All Quote Response
  if template_id == 10409 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_all_quote_response(buffer, offset)
  end
  -- Size of Delete Order Broadcast
  if template_id == 10112 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_order_broadcast(buffer, offset)
  end
  -- Size of Delete Order Nr Response
  if template_id == 10111 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_order_nr_response(buffer, offset)
  end
  -- Size of Delete Order Response
  if template_id == 10110 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_order_response(buffer, offset)
  end
  -- Size of Delete Order Single Request
  if template_id == 10109 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_order_single_request(buffer, offset)
  end
  -- Size of Delete Tes Trade Request
  if template_id == 10602 then
    return eurex_cash_eti_t7_v9_1_size_of.delete_tes_trade_request(buffer, offset)
  end
  -- Size of Enter Tes Trade Request
  if template_id == 10600 then
    return eurex_cash_eti_t7_v9_1_size_of.enter_tes_trade_request(buffer, offset)
  end
  -- Size of Extended Deletion Report
  if template_id == 10128 then
    return eurex_cash_eti_t7_v9_1_size_of.extended_deletion_report(buffer, offset)
  end
  -- Size of Forced Logout Notification
  if template_id == 10012 then
    return eurex_cash_eti_t7_v9_1_size_of.forced_logout_notification(buffer, offset)
  end
  -- Size of Forced User Logout Notification
  if template_id == 10043 then
    return eurex_cash_eti_t7_v9_1_size_of.forced_user_logout_notification(buffer, offset)
  end
  -- Size of Heartbeat
  if template_id == 10011 then
    return eurex_cash_eti_t7_v9_1_size_of.heartbeat(buffer, offset)
  end
  -- Size of Heartbeat Notification
  if template_id == 10023 then
    return eurex_cash_eti_t7_v9_1_size_of.heartbeat_notification(buffer, offset)
  end
  -- Size of Inquire Enrichment Rule Id List Request
  if template_id == 10040 then
    return eurex_cash_eti_t7_v9_1_size_of.inquire_enrichment_rule_id_list_request(buffer, offset)
  end
  -- Size of Inquire Enrichment Rule Id List Response
  if template_id == 10041 then
    return eurex_cash_eti_t7_v9_1_size_of.inquire_enrichment_rule_id_list_response(buffer, offset)
  end
  -- Size of Inquire Session List Request
  if template_id == 10035 then
    return eurex_cash_eti_t7_v9_1_size_of.inquire_session_list_request(buffer, offset)
  end
  -- Size of Inquire Session List Response
  if template_id == 10036 then
    return eurex_cash_eti_t7_v9_1_size_of.inquire_session_list_response(buffer, offset)
  end
  -- Size of Inquire User Request
  if template_id == 10038 then
    return eurex_cash_eti_t7_v9_1_size_of.inquire_user_request(buffer, offset)
  end
  -- Size of Inquire User Response
  if template_id == 10039 then
    return eurex_cash_eti_t7_v9_1_size_of.inquire_user_response(buffer, offset)
  end
  -- Size of Issuer Notification
  if template_id == 10316 then
    return eurex_cash_eti_t7_v9_1_size_of.issuer_notification(buffer, offset)
  end
  -- Size of Issuer Security State Change Request
  if template_id == 10314 then
    return eurex_cash_eti_t7_v9_1_size_of.issuer_security_state_change_request(buffer, offset)
  end
  -- Size of Issuer Security State Change Response
  if template_id == 10315 then
    return eurex_cash_eti_t7_v9_1_size_of.issuer_security_state_change_response(buffer, offset)
  end
  -- Size of Legal Notification Broadcast
  if template_id == 10037 then
    return eurex_cash_eti_t7_v9_1_size_of.legal_notification_broadcast(buffer, offset)
  end
  -- Size of Logon Request
  if template_id == 10000 then
    return eurex_cash_eti_t7_v9_1_size_of.logon_request(buffer, offset)
  end
  -- Size of Logon Response
  if template_id == 10001 then
    return eurex_cash_eti_t7_v9_1_size_of.logon_response(buffer, offset)
  end
  -- Size of Logout Request
  if template_id == 10002 then
    return eurex_cash_eti_t7_v9_1_size_of.logout_request(buffer, offset)
  end
  -- Size of Logout Response
  if template_id == 10003 then
    return eurex_cash_eti_t7_v9_1_size_of.logout_response(buffer, offset)
  end
  -- Size of Mass Quote Request
  if template_id == 10405 then
    return eurex_cash_eti_t7_v9_1_size_of.mass_quote_request(buffer, offset)
  end
  -- Size of Mass Quote Response
  if template_id == 10406 then
    return eurex_cash_eti_t7_v9_1_size_of.mass_quote_response(buffer, offset)
  end
  -- Size of Modify Order Nr Response
  if template_id == 10108 then
    return eurex_cash_eti_t7_v9_1_size_of.modify_order_nr_response(buffer, offset)
  end
  -- Size of Modify Order Response
  if template_id == 10107 then
    return eurex_cash_eti_t7_v9_1_size_of.modify_order_response(buffer, offset)
  end
  -- Size of Modify Order Single Request
  if template_id == 10106 then
    return eurex_cash_eti_t7_v9_1_size_of.modify_order_single_request(buffer, offset)
  end
  -- Size of Modify Order Single Short Request
  if template_id == 10126 then
    return eurex_cash_eti_t7_v9_1_size_of.modify_order_single_short_request(buffer, offset)
  end
  -- Size of Modify Tes Trade Request
  if template_id == 10601 then
    return eurex_cash_eti_t7_v9_1_size_of.modify_tes_trade_request(buffer, offset)
  end
  -- Size of New Order Nr Response
  if template_id == 10102 then
    return eurex_cash_eti_t7_v9_1_size_of.new_order_nr_response(buffer, offset)
  end
  -- Size of New Order Response
  if template_id == 10101 then
    return eurex_cash_eti_t7_v9_1_size_of.new_order_response(buffer, offset)
  end
  -- Size of New Order Single Request
  if template_id == 10100 then
    return eurex_cash_eti_t7_v9_1_size_of.new_order_single_request(buffer, offset)
  end
  -- Size of New Order Single Short Request
  if template_id == 10125 then
    return eurex_cash_eti_t7_v9_1_size_of.new_order_single_short_request(buffer, offset)
  end
  -- Size of News Broadcast
  if template_id == 10031 then
    return eurex_cash_eti_t7_v9_1_size_of.news_broadcast(buffer, offset)
  end
  -- Size of Order Exec Notification
  if template_id == 10104 then
    return eurex_cash_eti_t7_v9_1_size_of.order_exec_notification(buffer, offset)
  end
  -- Size of Order Exec Report Broadcast
  if template_id == 10117 then
    return eurex_cash_eti_t7_v9_1_size_of.order_exec_report_broadcast(buffer, offset)
  end
  -- Size of Order Exec Response
  if template_id == 10103 then
    return eurex_cash_eti_t7_v9_1_size_of.order_exec_response(buffer, offset)
  end
  -- Size of Party Action Report
  if template_id == 10042 then
    return eurex_cash_eti_t7_v9_1_size_of.party_action_report(buffer, offset)
  end
  -- Size of Party Entitlements Update Report
  if template_id == 10034 then
    return eurex_cash_eti_t7_v9_1_size_of.party_entitlements_update_report(buffer, offset)
  end
  -- Size of Ping Request
  if template_id == 10320 then
    return eurex_cash_eti_t7_v9_1_size_of.ping_request(buffer, offset)
  end
  -- Size of Ping Response
  if template_id == 10321 then
    return eurex_cash_eti_t7_v9_1_size_of.ping_response(buffer, offset)
  end
  -- Size of Quote Activation Notification
  if template_id == 10411 then
    return eurex_cash_eti_t7_v9_1_size_of.quote_activation_notification(buffer, offset)
  end
  -- Size of Quote Activation Request
  if template_id == 10403 then
    return eurex_cash_eti_t7_v9_1_size_of.quote_activation_request(buffer, offset)
  end
  -- Size of Quote Activation Response
  if template_id == 10404 then
    return eurex_cash_eti_t7_v9_1_size_of.quote_activation_response(buffer, offset)
  end
  -- Size of Quote Execution Report
  if template_id == 10407 then
    return eurex_cash_eti_t7_v9_1_size_of.quote_execution_report(buffer, offset)
  end
  -- Size of Rfq Broadcast
  if template_id == 10415 then
    return eurex_cash_eti_t7_v9_1_size_of.rfq_broadcast(buffer, offset)
  end
  -- Size of Rfq Reject Notification
  if template_id == 10420 then
    return eurex_cash_eti_t7_v9_1_size_of.rfq_reject_notification(buffer, offset)
  end
  -- Size of Rfq Request
  if template_id == 10401 then
    return eurex_cash_eti_t7_v9_1_size_of.rfq_request(buffer, offset)
  end
  -- Size of Rfq Response
  if template_id == 10402 then
    return eurex_cash_eti_t7_v9_1_size_of.rfq_response(buffer, offset)
  end
  -- Size of Rfq Specialist Broadcast
  if template_id == 10419 then
    return eurex_cash_eti_t7_v9_1_size_of.rfq_specialist_broadcast(buffer, offset)
  end
  -- Size of Reject
  if template_id == 10010 then
    return eurex_cash_eti_t7_v9_1_size_of.reject(buffer, offset)
  end
  -- Size of Retransmit Me Message Request
  if template_id == 10026 then
    return eurex_cash_eti_t7_v9_1_size_of.retransmit_me_message_request(buffer, offset)
  end
  -- Size of Retransmit Me Message Response
  if template_id == 10027 then
    return eurex_cash_eti_t7_v9_1_size_of.retransmit_me_message_response(buffer, offset)
  end
  -- Size of Retransmit Request
  if template_id == 10008 then
    return eurex_cash_eti_t7_v9_1_size_of.retransmit_request(buffer, offset)
  end
  -- Size of Retransmit Response
  if template_id == 10009 then
    return eurex_cash_eti_t7_v9_1_size_of.retransmit_response(buffer, offset)
  end
  -- Size of Service Availability Broadcast
  if template_id == 10030 then
    return eurex_cash_eti_t7_v9_1_size_of.service_availability_broadcast(buffer, offset)
  end
  -- Size of Service Availability Market Broadcast
  if template_id == 10044 then
    return eurex_cash_eti_t7_v9_1_size_of.service_availability_market_broadcast(buffer, offset)
  end
  -- Size of Single Quote Request
  if template_id == 10418 then
    return eurex_cash_eti_t7_v9_1_size_of.single_quote_request(buffer, offset)
  end
  -- Size of Specialist Delete All Order Broadcast
  if template_id == 10137 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_delete_all_order_broadcast(buffer, offset)
  end
  -- Size of Specialist Instrument Event Notification
  if template_id == 10319 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_instrument_event_notification(buffer, offset)
  end
  -- Size of Specialist Order Book Notification
  if template_id == 10136 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_order_book_notification(buffer, offset)
  end
  -- Size of Specialist Rfq Reject Request
  if template_id == 10421 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reject_request(buffer, offset)
  end
  -- Size of Specialist Rfq Reply Notification
  if template_id == 10424 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_notification(buffer, offset)
  end
  -- Size of Specialist Rfq Reply Request
  if template_id == 10422 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_request(buffer, offset)
  end
  -- Size of Specialist Rfq Reply Response
  if template_id == 10423 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_rfq_reply_response(buffer, offset)
  end
  -- Size of Specialist Security State Change Request
  if template_id == 10317 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_security_state_change_request(buffer, offset)
  end
  -- Size of Specialist Security State Change Response
  if template_id == 10318 then
    return eurex_cash_eti_t7_v9_1_size_of.specialist_security_state_change_response(buffer, offset)
  end
  -- Size of Subscribe Request
  if template_id == 10025 then
    return eurex_cash_eti_t7_v9_1_size_of.subscribe_request(buffer, offset)
  end
  -- Size of Subscribe Response
  if template_id == 10005 then
    return eurex_cash_eti_t7_v9_1_size_of.subscribe_response(buffer, offset)
  end
  -- Size of Tes Approve Broadcast
  if template_id == 10607 then
    return eurex_cash_eti_t7_v9_1_size_of.tes_approve_broadcast(buffer, offset)
  end
  -- Size of Tes Broadcast
  if template_id == 10604 then
    return eurex_cash_eti_t7_v9_1_size_of.tes_broadcast(buffer, offset)
  end
  -- Size of Tes Delete Broadcast
  if template_id == 10606 then
    return eurex_cash_eti_t7_v9_1_size_of.tes_delete_broadcast(buffer, offset)
  end
  -- Size of Tes Execution Broadcast
  if template_id == 10610 then
    return eurex_cash_eti_t7_v9_1_size_of.tes_execution_broadcast(buffer, offset)
  end
  -- Size of Tes Response
  if template_id == 10611 then
    return eurex_cash_eti_t7_v9_1_size_of.tes_response(buffer, offset)
  end
  -- Size of Tes Trade Broadcast
  if template_id == 10614 then
    return eurex_cash_eti_t7_v9_1_size_of.tes_trade_broadcast(buffer, offset)
  end
  -- Size of Tes Trading Session Status Broadcast
  if template_id == 10615 then
    return eurex_cash_eti_t7_v9_1_size_of.tes_trading_session_status_broadcast(buffer, offset)
  end
  -- Size of Tm Trading Session Status Broadcast
  if template_id == 10501 then
    return eurex_cash_eti_t7_v9_1_size_of.tm_trading_session_status_broadcast(buffer, offset)
  end
  -- Size of Throttle Update Notification
  if template_id == 10028 then
    return eurex_cash_eti_t7_v9_1_size_of.throttle_update_notification(buffer, offset)
  end
  -- Size of Trade Broadcast
  if template_id == 10500 then
    return eurex_cash_eti_t7_v9_1_size_of.trade_broadcast(buffer, offset)
  end
  -- Size of Trading Session Status Broadcast
  if template_id == 10307 then
    return eurex_cash_eti_t7_v9_1_size_of.trading_session_status_broadcast(buffer, offset)
  end
  -- Size of Trailing Stop Update Notification
  if template_id == 10127 then
    return eurex_cash_eti_t7_v9_1_size_of.trailing_stop_update_notification(buffer, offset)
  end
  -- Size of Unsubscribe Request
  if template_id == 10006 then
    return eurex_cash_eti_t7_v9_1_size_of.unsubscribe_request(buffer, offset)
  end
  -- Size of Unsubscribe Response
  if template_id == 10007 then
    return eurex_cash_eti_t7_v9_1_size_of.unsubscribe_response(buffer, offset)
  end
  -- Size of User Login Request
  if template_id == 10018 then
    return eurex_cash_eti_t7_v9_1_size_of.user_login_request(buffer, offset)
  end
  -- Size of User Login Response
  if template_id == 10019 then
    return eurex_cash_eti_t7_v9_1_size_of.user_login_response(buffer, offset)
  end
  -- Size of User Logout Request
  if template_id == 10029 then
    return eurex_cash_eti_t7_v9_1_size_of.user_logout_request(buffer, offset)
  end
  -- Size of User Logout Response
  if template_id == 10024 then
    return eurex_cash_eti_t7_v9_1_size_of.user_logout_response(buffer, offset)
  end
  -- Size of Xetra En Light Create Deal Notification
  if template_id == 10808 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_create_deal_notification(buffer, offset)
  end
  -- Size of Xetra En Light Deal Response
  if template_id == 10805 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_deal_response(buffer, offset)
  end
  -- Size of Xetra En Light Enter Quote Request
  if template_id == 10802 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_enter_quote_request(buffer, offset)
  end
  -- Size of Xetra En Light Hit Quote Request
  if template_id == 10804 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_hit_quote_request(buffer, offset)
  end
  -- Size of Xetra En Light Negotiation Notification
  if template_id == 10813 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_notification(buffer, offset)
  end
  -- Size of Xetra En Light Negotiation Requester Notification
  if template_id == 10812 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_requester_notification(buffer, offset)
  end
  -- Size of Xetra En Light Negotiation Status Notification
  if template_id == 10815 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_negotiation_status_notification(buffer, offset)
  end
  -- Size of Xetra En Light Open Negotiation Notification
  if template_id == 10811 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_notification(buffer, offset)
  end
  -- Size of Xetra En Light Open Negotiation Request
  if template_id == 10800 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_request(buffer, offset)
  end
  -- Size of Xetra En Light Open Negotiation Requester Notification
  if template_id == 10810 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_open_negotiation_requester_notification(buffer, offset)
  end
  -- Size of Xetra En Light Quote Notification
  if template_id == 10807 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_notification(buffer, offset)
  end
  -- Size of Xetra En Light Quote Requester Notification
  if template_id == 10816 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_requester_notification(buffer, offset)
  end
  -- Size of Xetra En Light Quote Response
  if template_id == 10803 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quote_response(buffer, offset)
  end
  -- Size of Xetra En Light Quoting Status Request
  if template_id == 10817 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_quoting_status_request(buffer, offset)
  end
  -- Size of Xetra En Light Status Broadcast
  if template_id == 10814 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_status_broadcast(buffer, offset)
  end
  -- Size of Xetra En Light Update Negotiation Request
  if template_id == 10801 then
    return eurex_cash_eti_t7_v9_1_size_of.xetra_en_light_update_negotiation_request(buffer, offset)
  end
...
-- Display: Payload
eurex_cash_eti_t7_v9_1_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
eurex_cash_eti_t7_v9_1_dissect.payload_branches = function(buffer, offset, packet, parent, template_id)
  -- Dissect Approve Tes Trade Request
  if template_id == 10603 then
    return eurex_cash_eti_t7_v9_1_dissect.approve_tes_trade_request(buffer, offset, packet, parent)
  end
  -- Dissect Broadcast Error Notification
  if template_id == 10032 then
    return eurex_cash_eti_t7_v9_1_dissect.broadcast_error_notification(buffer, offset, packet, parent)
  end
  -- Dissect Cross Request
  if template_id == 10118 then
    return eurex_cash_eti_t7_v9_1_dissect.cross_request(buffer, offset, packet, parent)
  end
  -- Dissect Cross Request Response
  if template_id == 10119 then
    return eurex_cash_eti_t7_v9_1_dissect.cross_request_response(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Order Broadcast
  if template_id == 10122 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_order_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Order Nr Response
  if template_id == 10124 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_order_nr_response(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Order Quote Event Broadcast
  if template_id == 10308 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_order_quote_event_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Order Request
  if template_id == 10120 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_order_request(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Order Response
  if template_id == 10121 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_order_response(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Quote Broadcast
  if template_id == 10410 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Quote Request
  if template_id == 10408 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_request(buffer, offset, packet, parent)
  end
  -- Dissect Delete All Quote Response
  if template_id == 10409 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_all_quote_response(buffer, offset, packet, parent)
  end
  -- Dissect Delete Order Broadcast
  if template_id == 10112 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_order_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Delete Order Nr Response
  if template_id == 10111 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_order_nr_response(buffer, offset, packet, parent)
  end
  -- Dissect Delete Order Response
  if template_id == 10110 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_order_response(buffer, offset, packet, parent)
  end
  -- Dissect Delete Order Single Request
  if template_id == 10109 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_order_single_request(buffer, offset, packet, parent)
  end
  -- Dissect Delete Tes Trade Request
  if template_id == 10602 then
    return eurex_cash_eti_t7_v9_1_dissect.delete_tes_trade_request(buffer, offset, packet, parent)
  end
  -- Dissect Enter Tes Trade Request
  if template_id == 10600 then
    return eurex_cash_eti_t7_v9_1_dissect.enter_tes_trade_request(buffer, offset, packet, parent)
  end
  -- Dissect Extended Deletion Report
  if template_id == 10128 then
    return eurex_cash_eti_t7_v9_1_dissect.extended_deletion_report(buffer, offset, packet, parent)
  end
  -- Dissect Forced Logout Notification
  if template_id == 10012 then
    return eurex_cash_eti_t7_v9_1_dissect.forced_logout_notification(buffer, offset, packet, parent)
  end
  -- Dissect Forced User Logout Notification
  if template_id == 10043 then
    return eurex_cash_eti_t7_v9_1_dissect.forced_user_logout_notification(buffer, offset, packet, parent)
  end
  -- Dissect Heartbeat
  if template_id == 10011 then
    return eurex_cash_eti_t7_v9_1_dissect.heartbeat(buffer, offset, packet, parent)
  end
  -- Dissect Heartbeat Notification
  if template_id == 10023 then
    return eurex_cash_eti_t7_v9_1_dissect.heartbeat_notification(buffer, offset, packet, parent)
  end
  -- Dissect Inquire Enrichment Rule Id List Request
  if template_id == 10040 then
    return eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_request(buffer, offset, packet, parent)
  end
  -- Dissect Inquire Enrichment Rule Id List Response
  if template_id == 10041 then
    return eurex_cash_eti_t7_v9_1_dissect.inquire_enrichment_rule_id_list_response(buffer, offset, packet, parent)
  end
  -- Dissect Inquire Session List Request
  if template_id == 10035 then
    return eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_request(buffer, offset, packet, parent)
  end
  -- Dissect Inquire Session List Response
  if template_id == 10036 then
    return eurex_cash_eti_t7_v9_1_dissect.inquire_session_list_response(buffer, offset, packet, parent)
  end
  -- Dissect Inquire User Request
  if template_id == 10038 then
    return eurex_cash_eti_t7_v9_1_dissect.inquire_user_request(buffer, offset, packet, parent)
  end
  -- Dissect Inquire User Response
  if template_id == 10039 then
    return eurex_cash_eti_t7_v9_1_dissect.inquire_user_response(buffer, offset, packet, parent)
  end
  -- Dissect Issuer Notification
  if template_id == 10316 then
    return eurex_cash_eti_t7_v9_1_dissect.issuer_notification(buffer, offset, packet, parent)
  end
  -- Dissect Issuer Security State Change Request
  if template_id == 10314 then
    return eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_request(buffer, offset, packet, parent)
  end
  -- Dissect Issuer Security State Change Response
  if template_id == 10315 then
    return eurex_cash_eti_t7_v9_1_dissect.issuer_security_state_change_response(buffer, offset, packet, parent)
  end
  -- Dissect Legal Notification Broadcast
  if template_id == 10037 then
    return eurex_cash_eti_t7_v9_1_dissect.legal_notification_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Logon Request
  if template_id == 10000 then
    return eurex_cash_eti_t7_v9_1_dissect.logon_request(buffer, offset, packet, parent)
  end
  -- Dissect Logon Response
  if template_id == 10001 then
    return eurex_cash_eti_t7_v9_1_dissect.logon_response(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request
  if template_id == 10002 then
    return eurex_cash_eti_t7_v9_1_dissect.logout_request(buffer, offset, packet, parent)
  end
  -- Dissect Logout Response
  if template_id == 10003 then
    return eurex_cash_eti_t7_v9_1_dissect.logout_response(buffer, offset, packet, parent)
  end
  -- Dissect Mass Quote Request
  if template_id == 10405 then
    return eurex_cash_eti_t7_v9_1_dissect.mass_quote_request(buffer, offset, packet, parent)
  end
  -- Dissect Mass Quote Response
  if template_id == 10406 then
    return eurex_cash_eti_t7_v9_1_dissect.mass_quote_response(buffer, offset, packet, parent)
  end
  -- Dissect Modify Order Nr Response
  if template_id == 10108 then
    return eurex_cash_eti_t7_v9_1_dissect.modify_order_nr_response(buffer, offset, packet, parent)
  end
  -- Dissect Modify Order Response
  if template_id == 10107 then
    return eurex_cash_eti_t7_v9_1_dissect.modify_order_response(buffer, offset, packet, parent)
  end
  -- Dissect Modify Order Single Request
  if template_id == 10106 then
    return eurex_cash_eti_t7_v9_1_dissect.modify_order_single_request(buffer, offset, packet, parent)
  end
  -- Dissect Modify Order Single Short Request
  if template_id == 10126 then
    return eurex_cash_eti_t7_v9_1_dissect.modify_order_single_short_request(buffer, offset, packet, parent)
  end
  -- Dissect Modify Tes Trade Request
  if template_id == 10601 then
    return eurex_cash_eti_t7_v9_1_dissect.modify_tes_trade_request(buffer, offset, packet, parent)
  end
  -- Dissect New Order Nr Response
  if template_id == 10102 then
    return eurex_cash_eti_t7_v9_1_dissect.new_order_nr_response(buffer, offset, packet, parent)
  end
  -- Dissect New Order Response
  if template_id == 10101 then
    return eurex_cash_eti_t7_v9_1_dissect.new_order_response(buffer, offset, packet, parent)
  end
  -- Dissect New Order Single Request
  if template_id == 10100 then
    return eurex_cash_eti_t7_v9_1_dissect.new_order_single_request(buffer, offset, packet, parent)
  end
  -- Dissect New Order Single Short Request
  if template_id == 10125 then
    return eurex_cash_eti_t7_v9_1_dissect.new_order_single_short_request(buffer, offset, packet, parent)
  end
  -- Dissect News Broadcast
  if template_id == 10031 then
    return eurex_cash_eti_t7_v9_1_dissect.news_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Order Exec Notification
  if template_id == 10104 then
    return eurex_cash_eti_t7_v9_1_dissect.order_exec_notification(buffer, offset, packet, parent)
  end
  -- Dissect Order Exec Report Broadcast
  if template_id == 10117 then
    return eurex_cash_eti_t7_v9_1_dissect.order_exec_report_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Order Exec Response
  if template_id == 10103 then
    return eurex_cash_eti_t7_v9_1_dissect.order_exec_response(buffer, offset, packet, parent)
  end
  -- Dissect Party Action Report
  if template_id == 10042 then
    return eurex_cash_eti_t7_v9_1_dissect.party_action_report(buffer, offset, packet, parent)
  end
  -- Dissect Party Entitlements Update Report
  if template_id == 10034 then
    return eurex_cash_eti_t7_v9_1_dissect.party_entitlements_update_report(buffer, offset, packet, parent)
  end
  -- Dissect Ping Request
  if template_id == 10320 then
    return eurex_cash_eti_t7_v9_1_dissect.ping_request(buffer, offset, packet, parent)
  end
  -- Dissect Ping Response
  if template_id == 10321 then
    return eurex_cash_eti_t7_v9_1_dissect.ping_response(buffer, offset, packet, parent)
  end
  -- Dissect Quote Activation Notification
  if template_id == 10411 then
    return eurex_cash_eti_t7_v9_1_dissect.quote_activation_notification(buffer, offset, packet, parent)
  end
  -- Dissect Quote Activation Request
  if template_id == 10403 then
    return eurex_cash_eti_t7_v9_1_dissect.quote_activation_request(buffer, offset, packet, parent)
  end
  -- Dissect Quote Activation Response
  if template_id == 10404 then
    return eurex_cash_eti_t7_v9_1_dissect.quote_activation_response(buffer, offset, packet, parent)
  end
  -- Dissect Quote Execution Report
  if template_id == 10407 then
    return eurex_cash_eti_t7_v9_1_dissect.quote_execution_report(buffer, offset, packet, parent)
  end
  -- Dissect Rfq Broadcast
  if template_id == 10415 then
    return eurex_cash_eti_t7_v9_1_dissect.rfq_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Rfq Reject Notification
  if template_id == 10420 then
    return eurex_cash_eti_t7_v9_1_dissect.rfq_reject_notification(buffer, offset, packet, parent)
  end
  -- Dissect Rfq Request
  if template_id == 10401 then
    return eurex_cash_eti_t7_v9_1_dissect.rfq_request(buffer, offset, packet, parent)
  end
  -- Dissect Rfq Response
  if template_id == 10402 then
    return eurex_cash_eti_t7_v9_1_dissect.rfq_response(buffer, offset, packet, parent)
  end
  -- Dissect Rfq Specialist Broadcast
  if template_id == 10419 then
    return eurex_cash_eti_t7_v9_1_dissect.rfq_specialist_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Reject
  if template_id == 10010 then
    return eurex_cash_eti_t7_v9_1_dissect.reject(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Me Message Request
  if template_id == 10026 then
    return eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_request(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Me Message Response
  if template_id == 10027 then
    return eurex_cash_eti_t7_v9_1_dissect.retransmit_me_message_response(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Request
  if template_id == 10008 then
    return eurex_cash_eti_t7_v9_1_dissect.retransmit_request(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Response
  if template_id == 10009 then
    return eurex_cash_eti_t7_v9_1_dissect.retransmit_response(buffer, offset, packet, parent)
  end
  -- Dissect Service Availability Broadcast
  if template_id == 10030 then
    return eurex_cash_eti_t7_v9_1_dissect.service_availability_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Service Availability Market Broadcast
  if template_id == 10044 then
    return eurex_cash_eti_t7_v9_1_dissect.service_availability_market_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Single Quote Request
  if template_id == 10418 then
    return eurex_cash_eti_t7_v9_1_dissect.single_quote_request(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Delete All Order Broadcast
  if template_id == 10137 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_delete_all_order_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Instrument Event Notification
  if template_id == 10319 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_instrument_event_notification(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Order Book Notification
  if template_id == 10136 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_order_book_notification(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Rfq Reject Request
  if template_id == 10421 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reject_request(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Rfq Reply Notification
  if template_id == 10424 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_notification(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Rfq Reply Request
  if template_id == 10422 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_request(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Rfq Reply Response
  if template_id == 10423 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_rfq_reply_response(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Security State Change Request
  if template_id == 10317 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_request(buffer, offset, packet, parent)
  end
  -- Dissect Specialist Security State Change Response
  if template_id == 10318 then
    return eurex_cash_eti_t7_v9_1_dissect.specialist_security_state_change_response(buffer, offset, packet, parent)
  end
  -- Dissect Subscribe Request
  if template_id == 10025 then
    return eurex_cash_eti_t7_v9_1_dissect.subscribe_request(buffer, offset, packet, parent)
  end
  -- Dissect Subscribe Response
  if template_id == 10005 then
    return eurex_cash_eti_t7_v9_1_dissect.subscribe_response(buffer, offset, packet, parent)
  end
  -- Dissect Tes Approve Broadcast
  if template_id == 10607 then
    return eurex_cash_eti_t7_v9_1_dissect.tes_approve_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Tes Broadcast
  if template_id == 10604 then
    return eurex_cash_eti_t7_v9_1_dissect.tes_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Tes Delete Broadcast
  if template_id == 10606 then
    return eurex_cash_eti_t7_v9_1_dissect.tes_delete_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Tes Execution Broadcast
  if template_id == 10610 then
    return eurex_cash_eti_t7_v9_1_dissect.tes_execution_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Tes Response
  if template_id == 10611 then
    return eurex_cash_eti_t7_v9_1_dissect.tes_response(buffer, offset, packet, parent)
  end
  -- Dissect Tes Trade Broadcast
  if template_id == 10614 then
    return eurex_cash_eti_t7_v9_1_dissect.tes_trade_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Tes Trading Session Status Broadcast
  if template_id == 10615 then
    return eurex_cash_eti_t7_v9_1_dissect.tes_trading_session_status_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Tm Trading Session Status Broadcast
  if template_id == 10501 then
    return eurex_cash_eti_t7_v9_1_dissect.tm_trading_session_status_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Throttle Update Notification
  if template_id == 10028 then
    return eurex_cash_eti_t7_v9_1_dissect.throttle_update_notification(buffer, offset, packet, parent)
  end
  -- Dissect Trade Broadcast
  if template_id == 10500 then
    return eurex_cash_eti_t7_v9_1_dissect.trade_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Trading Session Status Broadcast
  if template_id == 10307 then
    return eurex_cash_eti_t7_v9_1_dissect.trading_session_status_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Trailing Stop Update Notification
  if template_id == 10127 then
    return eurex_cash_eti_t7_v9_1_dissect.trailing_stop_update_notification(buffer, offset, packet, parent)
  end
  -- Dissect Unsubscribe Request
  if template_id == 10006 then
    return eurex_cash_eti_t7_v9_1_dissect.unsubscribe_request(buffer, offset, packet, parent)
  end
  -- Dissect Unsubscribe Response
  if template_id == 10007 then
    return eurex_cash_eti_t7_v9_1_dissect.unsubscribe_response(buffer, offset, packet, parent)
  end
  -- Dissect User Login Request
  if template_id == 10018 then
    return eurex_cash_eti_t7_v9_1_dissect.user_login_request(buffer, offset, packet, parent)
  end
  -- Dissect User Login Response
  if template_id == 10019 then
    return eurex_cash_eti_t7_v9_1_dissect.user_login_response(buffer, offset, packet, parent)
  end
  -- Dissect User Logout Request
  if template_id == 10029 then
    return eurex_cash_eti_t7_v9_1_dissect.user_logout_request(buffer, offset, packet, parent)
  end
  -- Dissect User Logout Response
  if template_id == 10024 then
    return eurex_cash_eti_t7_v9_1_dissect.user_logout_response(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Create Deal Notification
  if template_id == 10808 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_create_deal_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Deal Response
  if template_id == 10805 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_deal_response(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Enter Quote Request
  if template_id == 10802 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_enter_quote_request(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Hit Quote Request
  if template_id == 10804 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_hit_quote_request(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Negotiation Notification
  if template_id == 10813 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Negotiation Requester Notification
  if template_id == 10812 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_requester_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Negotiation Status Notification
  if template_id == 10815 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_negotiation_status_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Open Negotiation Notification
  if template_id == 10811 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Open Negotiation Request
  if template_id == 10800 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_request(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Open Negotiation Requester Notification
  if template_id == 10810 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_open_negotiation_requester_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Quote Notification
  if template_id == 10807 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Quote Requester Notification
  if template_id == 10816 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_requester_notification(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Quote Response
  if template_id == 10803 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quote_response(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Quoting Status Request
  if template_id == 10817 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_quoting_status_request(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Status Broadcast
  if template_id == 10814 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_status_broadcast(buffer, offset, packet, parent)
  end
  -- Dissect Xetra En Light Update Negotiation Request
  if template_id == 10801 then
    return eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_update_negotiation_request(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
eurex_cash_eti_t7_v9_1_dissect.payload = function(buffer, offset, packet, parent, template_id)
  if not show.payload then
    return eurex_cash_eti_t7_v9_1_dissect.payload_branches(buffer, offset, packet, parent, template_id)
  end

  -- Calculate size and check that branch is not empty
  local size = eurex_cash_eti_t7_v9_1_size_of.payload(buffer, offset, template_id)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = eurex_cash_eti_t7_v9_1_display.payload(buffer, packet, parent)
  local element = parent:add(eurex_cash_eti_t7_v9_1.fields.payload, range, display)

  return eurex_cash_eti_t7_v9_1_dissect.payload_branches(buffer, offset, packet, parent, template_id)
end

-- Size: Template Id
eurex_cash_eti_t7_v9_1_size_of.template_id = 2

-- Display: Template Id
eurex_cash_eti_t7_v9_1_display.template_id = function(value)
  return "Template Id: "..value
end

-- Dissect: Template Id
eurex_cash_eti_t7_v9_1_dissect.template_id = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.template_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.template_id(value, buffer, offset, packet, parent)
...
-- Size: Body Len
eurex_cash_eti_t7_v9_1_size_of.body_len = 4

-- Display: Body Len
eurex_cash_eti_t7_v9_1_display.body_len = function(value)
  return "Body Len: "..value
end

-- Dissect: Body Len
eurex_cash_eti_t7_v9_1_dissect.body_len = function(buffer, offset, packet, parent)
  local length = eurex_cash_eti_t7_v9_1_size_of.body_len
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = eurex_cash_eti_t7_v9_1_display.body_len(value, buffer, offset, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.message_header = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v9_1_size_of.body_len

  index = index + eurex_cash_eti_t7_v9_1_size_of.template_id

  return index
end

-- Display: Message Header
eurex_cash_eti_t7_v9_1_display.message_header = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message Header
eurex_cash_eti_t7_v9_1_dissect.message_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Body Len: 4 Byte Unsigned Fixed Width Integer
  index, body_len = eurex_cash_eti_t7_v9_1_dissect.body_len(buffer, index, packet, parent)

  -- Template Id: 2 Byte Unsigned Fixed Width Integer
  index, template_id = eurex_cash_eti_t7_v9_1_dissect.template_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Message Header
eurex_cash_eti_t7_v9_1_dissect.message_header = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.message_header then
    local length = eurex_cash_eti_t7_v9_1_size_of.message_header(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.message_header(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.message_header, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.message_header_fields(buffer, offset, packet, parent)
end

-- Display: Message
eurex_cash_eti_t7_v9_1_display.message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message
eurex_cash_eti_t7_v9_1_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset

  -- Message Header: Struct of 2 fields
  index, message_header = eurex_cash_eti_t7_v9_1_dissect.message_header(buffer, index, packet, parent)

  -- Dependency element: Template Id
  local template_id = buffer(index - 2, 2):le_uint()

  -- Payload: Runtime Type with 118 branches
  index = eurex_cash_eti_t7_v9_1_dissect.payload(buffer, index, packet, parent, template_id)

  return index
end

-- Dissect: Message
eurex_cash_eti_t7_v9_1_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  -- Optionally add struct element to protocol tree
  if show.message then
    local range = buffer(offset, size_of_message)
    local display = eurex_cash_eti_t7_v9_1_display.message(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.message, range, display)
  end

  eurex_cash_eti_t7_v9_1_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
local message_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < eurex_cash_eti_t7_v9_1_size_of.message_header(buffer, index) then
...
-- Dissect Packet
eurex_cash_eti_t7_v9_1_dissect.packet = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = eurex_cash_eti_t7_v9_1_dissect.message(buffer, index, packet, parent, size_of_message)
    else
...
function eurex_cash_eti_t7_v9_1.dissector(buffer, packet, parent)
  ...
  return eurex_cash_eti_t7_v9_1_dissect.packet(buffer, packet, protocol)
end
