...
omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_instrmt_leg_grp_comp_index = Pref.bool("Show Instrmt Leg Grp Comp Index", show.instrmt_leg_grp_comp_index, "Show generated instrmt leg grp comp index in protocol tree")
omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_md_instrument_entry_grp_comp_index = Pref.bool("Show Md Instrument Entry Grp Comp Index", show.md_instrument_entry_grp_comp_index, "Show generated md instrument entry grp comp index in protocol tree")
omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_md_trade_entry_grp_comp_index = Pref.bool("Show Md Trade Entry Grp Comp Index", show.md_trade_entry_grp_comp_index, "Show generated md trade entry grp comp index in protocol tree")

-- Handle changed preferences
function omi_eurex_derivatives_eobi_t7_v6_1.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_application_messages then
    show.application_messages = omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_application_messages
  end
  ...
  if show.instrmt_leg_grp_comp_index ~= omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_instrmt_leg_grp_comp_index then
    show.instrmt_leg_grp_comp_index = omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_instrmt_leg_grp_comp_index
  end
  if show.md_instrument_entry_grp_comp_index ~= omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_md_instrument_entry_grp_comp_index then
    show.md_instrument_entry_grp_comp_index = omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_md_instrument_entry_grp_comp_index
  end
  if show.md_trade_entry_grp_comp_index ~= omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_md_trade_entry_grp_comp_index then
    show.md_trade_entry_grp_comp_index = omi_eurex_derivatives_eobi_t7_v6_1.prefs.show_md_trade_entry_grp_comp_index
  end
end
...
eurex_derivatives_eobi_t7_v6_1.packet.requiredsize = function(buffer)
  return buffer:len() >= eurex_derivatives_eobi_t7_v6_1.packet_header.size + eurex_derivatives_eobi_t7_v6_1.message_header_comp.size
end
...
-- Dissector Heuristic for Eurex Derivatives Eobi T7 6.1 (Udp)
local function omi_eurex_derivatives_eobi_t7_v6_1_udp_heuristic(buffer, packet, parent)
...
omi_eurex_derivatives_eobi_t7_v6_1:register_heuristic("udp", omi_eurex_derivatives_eobi_t7_v6_1_udp_heuristic)

-- Register Eurex Derivatives Eobi T7 6.1 on default port
