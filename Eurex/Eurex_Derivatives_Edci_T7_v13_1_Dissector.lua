...
eurex_derivatives_edci_t7_v13_1_dissect.sessions_grp_comp = function(buffer, offset, packet, parent, sessions_grp_comp_index)
  if show.sessions_grp_comp then
    ...
    local index = eurex_derivatives_edci_t7_v13_1_dissect.sessions_grp_comp_fields(buffer, offset, packet, parent, sessions_grp_comp_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.sessions_grp_comp_fields(buffer, offset, packet, parent, sessions_grp_comp_index)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.session_list_notification_fields = function(buffer, offset, packet, parent, size_of_session_list_notification)
  ...
  for sessions_grp_comp_index = 1, no_sessions do
    index, sessions_grp_comp = eurex_derivatives_edci_t7_v13_1_dissect.sessions_grp_comp(buffer, index, packet, parent, sessions_grp_comp_index)
  end
...
eurex_derivatives_edci_t7_v13_1_dissect.reject_fields = function(buffer, offset, packet, parent, size_of_reject)
  ...
  index, var_text = eurex_derivatives_edci_t7_v13_1_dissect.var_text(buffer, index, packet, parent, var_text_len)
  ...
  if alignment_padding_exists then
    ...
    index, alignment_padding = eurex_derivatives_edci_t7_v13_1_dissect.alignment_padding(buffer, index, packet, parent, size_of_alignment_padding)
  end
...
eurex_derivatives_edci_t7_v13_1_dissect.partition_grp_comp = function(buffer, offset, packet, parent, partition_grp_comp_index)
  if show.partition_grp_comp then
    ...
    local index = eurex_derivatives_edci_t7_v13_1_dissect.partition_grp_comp_fields(buffer, offset, packet, parent, partition_grp_comp_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.partition_grp_comp_fields(buffer, offset, packet, parent, partition_grp_comp_index)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.partition_list_notification_fields = function(buffer, offset, packet, parent, size_of_partition_list_notification)
  ...
  for partition_grp_comp_index = 1, no_partitions do
    index, partition_grp_comp = eurex_derivatives_edci_t7_v13_1_dissect.partition_grp_comp(buffer, index, packet, parent, partition_grp_comp_index)
  end
...
eurex_derivatives_edci_t7_v13_1_dissect.fills_grp_comp = function(buffer, offset, packet, parent, fills_grp_comp_index)
  if show.fills_grp_comp then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_edci_t7_v13_1.fields.fills_grp_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.fills_grp_comp_fields(buffer, offset, packet, parent, fills_grp_comp_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.fills_grp_comp_fields(buffer, offset, packet, parent, fills_grp_comp_index)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.order_exec_report_broadcast_fields = function(buffer, offset, packet, parent, size_of_order_exec_report_broadcast)
  ...
  for fills_grp_comp_index = 1, no_fills do
    index, fills_grp_comp = eurex_derivatives_edci_t7_v13_1_dissect.fills_grp_comp(buffer, index, packet, parent, fills_grp_comp_index)
  end
...
eurex_derivatives_edci_t7_v13_1_dissect.affected_ord_grp_comp = function(buffer, offset, packet, parent, affected_ord_grp_comp_index)
  if show.affected_ord_grp_comp then
    ...
    local index = eurex_derivatives_edci_t7_v13_1_dissect.affected_ord_grp_comp_fields(buffer, offset, packet, parent, affected_ord_grp_comp_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.affected_ord_grp_comp_fields(buffer, offset, packet, parent, affected_ord_grp_comp_index)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.delete_order_broadcast_fields = function(buffer, offset, packet, parent, size_of_delete_order_broadcast)
  ...
  for affected_ord_grp_comp_index = 1, no_affected_orders do
    index, affected_ord_grp_comp = eurex_derivatives_edci_t7_v13_1_dissect.affected_ord_grp_comp(buffer, index, packet, parent, affected_ord_grp_comp_index)
  end
