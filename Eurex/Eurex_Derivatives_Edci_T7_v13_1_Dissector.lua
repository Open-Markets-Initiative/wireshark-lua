...
eurex_derivatives_edci_t7_v13_1.fields.affected_ord_grp_comp_index = ProtoField.new("Affected Ord Grp Comp Index", "eurex.derivatives.edci.t7.v13.1.affectedordgrpcompindex", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_1.fields.fills_grp_comp_index = ProtoField.new("Fills Grp Comp Index", "eurex.derivatives.edci.t7.v13.1.fillsgrpcompindex", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_1.fields.partition_grp_comp_index = ProtoField.new("Partition Grp Comp Index", "eurex.derivatives.edci.t7.v13.1.partitiongrpcompindex", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_1.fields.sessions_grp_comp_index = ProtoField.new("Sessions Grp Comp Index", "eurex.derivatives.edci.t7.v13.1.sessionsgrpcompindex", ftypes.UINT16)
...
eurex_derivatives_edci_t7_v13_1_dissect.rbc_header_comp = function(buffer, offset, packet, parent)
  if show.rbc_header_comp then
    ...
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.rbc_header_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.rbc_header_comp_fields(buffer, offset, packet, element)
    ...
    return eurex_derivatives_edci_t7_v13_1_dissect.rbc_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.sessions_grp_comp = function(buffer, offset, packet, parent)
  if show.sessions_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.sessions_grp_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.sessions_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.sessions_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.notif_header_comp = function(buffer, offset, packet, parent)
  if show.notif_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.notif_header_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.notif_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.notif_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.response_header_comp = function(buffer, offset, packet, parent)
  if show.response_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.response_header_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.response_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.response_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.partition_grp_comp = function(buffer, offset, packet, parent)
  if show.partition_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.partition_grp_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.partition_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.partition_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.fills_grp_comp = function(buffer, offset, packet, parent)
  if show.fills_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.fills_grp_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.fills_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.fills_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.request_header_comp = function(buffer, offset, packet, parent)
  if show.request_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.request_header_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.request_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.request_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.affected_ord_grp_comp = function(buffer, offset, packet, parent)
  if show.affected_ord_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.affected_ord_grp_comp, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.affected_ord_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.affected_ord_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_derivatives_edci_t7_v13_1_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_derivatives_edci_t7_v13_1.fields.message_header, buffer(offset, 0))
    local index = eurex_derivatives_edci_t7_v13_1_dissect.message_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return eurex_derivatives_edci_t7_v13_1_dissect.message_header_fields(buffer, offset, packet, element)
  end
end
