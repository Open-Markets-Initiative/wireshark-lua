...
local omi_eurex_derivatives_eobi_t7_v8_1 = Proto("Omi.Eurex.Derivatives.Eobi.T7.v8.1", "Eurex Derivatives Eobi T7 8.1")
...
omi_eurex_derivatives_eobi_t7_v8_1.fields.appl_seq_num = ProtoField.new("Appl Seq Num", "eurex.derivatives.eobi.t7.v8.1.applseqnum", ftypes.UINT64)
...
omi_eurex_derivatives_eobi_t7_v8_1.fields.eobi_header = ProtoField.new("Eobi Header", "eurex.derivatives.eobi.t7.v8.1.eobiheader", ftypes.STRING)
...
-- Eurex Derivatives T7 Eobi 8.1 Application Messages
...
omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_eobi_header = Pref.bool("Show Eobi Header", show.eobi_header, "Parse and add Eobi Header to protocol tree")
...
omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_instrmt_leg_grp_comp_index = Pref.bool("Show Instrmt Leg Grp Comp Index", show.instrmt_leg_grp_comp_index, "Show generated instrmt leg grp comp index in protocol tree")
omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_md_instrument_entry_grp_comp_index = Pref.bool("Show Md Instrument Entry Grp Comp Index", show.md_instrument_entry_grp_comp_index, "Show generated md instrument entry grp comp index in protocol tree")
omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_sec_mass_stat_grp_comp_index = Pref.bool("Show Sec Mass Stat Grp Comp Index", show.sec_mass_stat_grp_comp_index, "Show generated sec mass stat grp comp index in protocol tree")
omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_md_trade_entry_grp_comp_index = Pref.bool("Show Md Trade Entry Grp Comp Index", show.md_trade_entry_grp_comp_index, "Show generated md trade entry grp comp index in protocol tree")
...
function omi_eurex_derivatives_eobi_t7_v8_1.prefs_changed()
  ...
  if show.application_messages ~= omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_application_messages then
    show.application_messages = omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_application_messages
  end
  if show.eobi_header ~= omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_eobi_header then
    show.eobi_header = omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_eobi_header
  end
  ...
  if show.instrmt_leg_grp_comp_index ~= omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_instrmt_leg_grp_comp_index then
    show.instrmt_leg_grp_comp_index = omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_instrmt_leg_grp_comp_index
  end
  if show.md_instrument_entry_grp_comp_index ~= omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_md_instrument_entry_grp_comp_index then
    show.md_instrument_entry_grp_comp_index = omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_md_instrument_entry_grp_comp_index
  end
  if show.sec_mass_stat_grp_comp_index ~= omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_sec_mass_stat_grp_comp_index then
    show.sec_mass_stat_grp_comp_index = omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_sec_mass_stat_grp_comp_index
  end
  if show.md_trade_entry_grp_comp_index ~= omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_md_trade_entry_grp_comp_index then
    show.md_trade_entry_grp_comp_index = omi_eurex_derivatives_eobi_t7_v8_1.prefs.show_md_trade_entry_grp_comp_index
  end
end
...
-- Size: Appl Seq Num
eurex_derivatives_eobi_t7_v8_1.appl_seq_num.size = 8
...
eurex_derivatives_eobi_t7_v8_1.trade_reversal.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v8_1.fields.trade_reversal, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v8_1.trade_reversal.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v8_1.trade_reversal.display(packet, parent, length)
    parent:append_text(display)
...
eurex_derivatives_eobi_t7_v8_1.mass_instrument_state_change.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v8_1.fields.mass_instrument_state_change, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v8_1.mass_instrument_state_change.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v8_1.mass_instrument_state_change.display(packet, parent, length)
    parent:append_text(display)
...
eurex_derivatives_eobi_t7_v8_1.instrument_summary.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v8_1.fields.instrument_summary, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v8_1.instrument_summary.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v8_1.instrument_summary.display(packet, parent, length)
    parent:append_text(display)
...
eurex_derivatives_eobi_t7_v8_1.add_complex_instrument.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v8_1.fields.add_complex_instrument, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v8_1.add_complex_instrument.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v8_1.add_complex_instrument.display(packet, parent, length)
    parent:append_text(display)
...
-- Eobi Header
eurex_derivatives_eobi_t7_v8_1.eobi_header = {}

-- Size: Eobi Header
eurex_derivatives_eobi_t7_v8_1.eobi_header.size =
  eurex_derivatives_eobi_t7_v8_1.body_len.size + 
  eurex_derivatives_eobi_t7_v8_1.template_id.size + 
  eurex_derivatives_eobi_t7_v8_1.msg_seq_num.size

-- Display: Eobi Header
eurex_derivatives_eobi_t7_v8_1.eobi_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eobi Header
eurex_derivatives_eobi_t7_v8_1.eobi_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Eobi Header
eurex_derivatives_eobi_t7_v8_1.eobi_header.dissect = function(buffer, offset, packet, parent)
  if show.eobi_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v8_1.fields.eobi_header, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v8_1.eobi_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v8_1.eobi_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return eurex_derivatives_eobi_t7_v8_1.eobi_header.fields(buffer, offset, packet, parent)
  end
end
...
eurex_derivatives_eobi_t7_v8_1.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, eobi_header = eurex_derivatives_eobi_t7_v8_1.eobi_header.dissect(buffer, index, packet, parent)
...
eurex_derivatives_eobi_t7_v8_1.packet.requiredsize = function(buffer)
  return buffer:len() >= eurex_derivatives_eobi_t7_v8_1.packet_header.size + eurex_derivatives_eobi_t7_v8_1.message_header_comp.size
end
...
-- Dissector Heuristic for Eurex Derivatives Eobi T7 8.1 (Udp)
local function omi_eurex_derivatives_eobi_t7_v8_1_udp_heuristic(buffer, packet, parent)
...
omi_eurex_derivatives_eobi_t7_v8_1:register_heuristic("udp", omi_eurex_derivatives_eobi_t7_v8_1_udp_heuristic)

-- Register Eurex Derivatives Eobi T7 8.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_eurex_derivatives_eobi_t7_v8_1)
