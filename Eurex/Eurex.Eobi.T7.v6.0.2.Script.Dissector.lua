...
-- Eurex Eobi T7 6.0.2 Protocol
local eurex_eobi_t7_v6_0_2 = Proto("Eurex.Eobi.T7.v6.0.2.Lua", "Eurex Eobi T7 6.0.2")
...
-- Eurex Eobi T7 6.0.2 Fields
eurex_eobi_t7_v6_0_2.fields.add_complex_instrument = ProtoField.new("Add Complex Instrument", "eurex.eobi.t7.v6.0.2.addcomplexinstrument", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.aggressor_side = ProtoField.new("Aggressor Side", "eurex.eobi.t7.v6.0.2.aggressorside", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.aggressor_time = ProtoField.new("Aggressor Time", "eurex.eobi.t7.v6.0.2.aggressortime", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.algorithmic_trade_indicator = ProtoField.new("Algorithmic Trade Indicator", "eurex.eobi.t7.v6.0.2.algorithmictradeindicator", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.application_sequence_number = ProtoField.new("Application Sequence Number", "eurex.eobi.t7.v6.0.2.applicationsequencenumber", ftypes.UINT32)
eurex_eobi_t7_v6_0_2.fields.application_sequence_reset_indicator = ProtoField.new("Application Sequence Reset Indicator", "eurex.eobi.t7.v6.0.2.applicationsequenceresetindicator", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.auction_bbo = ProtoField.new("Auction Bbo", "eurex.eobi.t7.v6.0.2.auctionbbo", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.auction_clearing_price = ProtoField.new("Auction Clearing Price", "eurex.eobi.t7.v6.0.2.auctionclearingprice", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.bid_px = ProtoField.new("Bid Px", "eurex.eobi.t7.v6.0.2.bidpx", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.bid_size = ProtoField.new("Bid Size", "eurex.eobi.t7.v6.0.2.bidsize", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.body_len = ProtoField.new("Body Len", "eurex.eobi.t7.v6.0.2.bodylen", ftypes.UINT16)
eurex_eobi_t7_v6_0_2.fields.completion_indicator = ProtoField.new("Completion Indicator", "eurex.eobi.t7.v6.0.2.completionindicator", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.cross_request = ProtoField.new("Cross Request", "eurex.eobi.t7.v6.0.2.crossrequest", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.display_qty = ProtoField.new("Display Qty", "eurex.eobi.t7.v6.0.2.displayqty", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.exec_id = ProtoField.new("Exec Id", "eurex.eobi.t7.v6.0.2.execid", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.execution_summary = ProtoField.new("Execution Summary", "eurex.eobi.t7.v6.0.2.executionsummary", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.fast_market_indicator = ProtoField.new("Fast Market Indicator", "eurex.eobi.t7.v6.0.2.fastmarketindicator", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.full_order_execution = ProtoField.new("Full Order Execution", "eurex.eobi.t7.v6.0.2.fullorderexecution", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.header_length = ProtoField.new("Header Length", "eurex.eobi.t7.v6.0.2.headerlength", ftypes.UINT16)
eurex_eobi_t7_v6_0_2.fields.heartbeat = ProtoField.new("Heartbeat", "eurex.eobi.t7.v6.0.2.heartbeat", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.imbalance_qty = ProtoField.new("Imbalance Qty", "eurex.eobi.t7.v6.0.2.imbalanceqty", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.implied_market_indicator = ProtoField.new("Implied Market Indicator", "eurex.eobi.t7.v6.0.2.impliedmarketindicator", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.instrmt_leg_grp = ProtoField.new("Instrmt Leg Grp", "eurex.eobi.t7.v6.0.2.instrmtleggrp", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.instrument_state_change = ProtoField.new("Instrument State Change", "eurex.eobi.t7.v6.0.2.instrumentstatechange", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.instrument_summary = ProtoField.new("Instrument Summary", "eurex.eobi.t7.v6.0.2.instrumentsummary", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.last_msg_seq_num_processed = ProtoField.new("Last Msg Seq Num Processed", "eurex.eobi.t7.v6.0.2.lastmsgseqnumprocessed", ftypes.UINT32)
eurex_eobi_t7_v6_0_2.fields.last_px = ProtoField.new("Last Px", "eurex.eobi.t7.v6.0.2.lastpx", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.last_qty = ProtoField.new("Last Qty", "eurex.eobi.t7.v6.0.2.lastqty", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.last_update_time = ProtoField.new("Last Update Time", "eurex.eobi.t7.v6.0.2.lastupdatetime", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "eurex.eobi.t7.v6.0.2.legratioqty", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.leg_security_id = ProtoField.new("Leg Security Id", "eurex.eobi.t7.v6.0.2.legsecurityid", ftypes.INT64)
eurex_eobi_t7_v6_0_2.fields.leg_side = ProtoField.new("Leg Side", "eurex.eobi.t7.v6.0.2.legside", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.leg_symbol = ProtoField.new("Leg Symbol", "eurex.eobi.t7.v6.0.2.legsymbol", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.market_condition = ProtoField.new("Market Condition", "eurex.eobi.t7.v6.0.2.marketcondition", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.market_segment_id = ProtoField.new("Market Segment ID", "eurex.eobi.t7.v6.0.2.marketsegmentid", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.match_sub_type = ProtoField.new("Match Sub Type", "eurex.eobi.t7.v6.0.2.matchsubtype", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.match_type = ProtoField.new("Match Type", "eurex.eobi.t7.v6.0.2.matchtype", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.md_entry_px = ProtoField.new("Md Entry Px", "eurex.eobi.t7.v6.0.2.mdentrypx", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.md_entry_size = ProtoField.new("Md Entry Size", "eurex.eobi.t7.v6.0.2.mdentrysize", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.md_entry_type = ProtoField.new("Md Entry Type", "eurex.eobi.t7.v6.0.2.mdentrytype", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.md_instrument_entry_grp = ProtoField.new("Md Instrument Entry Grp", "eurex.eobi.t7.v6.0.2.mdinstrumententrygrp", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.md_trade_entry_grp = ProtoField.new("Md Trade Entry Grp", "eurex.eobi.t7.v6.0.2.mdtradeentrygrp", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.message = ProtoField.new("Message", "eurex.eobi.t7.v6.0.2.message", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.message_header = ProtoField.new("Message Header", "eurex.eobi.t7.v6.0.2.messageheader", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.msg_seq_num = ProtoField.new("Msg Seq Num", "eurex.eobi.t7.v6.0.2.msgseqnum", ftypes.UINT32)
eurex_eobi_t7_v6_0_2.fields.no_legs = ProtoField.new("No Legs", "eurex.eobi.t7.v6.0.2.nolegs", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.no_md_entries = ProtoField.new("No Md Entries", "eurex.eobi.t7.v6.0.2.nomdentries", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.offer_px = ProtoField.new("Offer Px", "eurex.eobi.t7.v6.0.2.offerpx", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.offer_size = ProtoField.new("Offer Size", "eurex.eobi.t7.v6.0.2.offersize", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.ord_type = ProtoField.new("Ord Type", "eurex.eobi.t7.v6.0.2.ordtype", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.order_add = ProtoField.new("Order Add", "eurex.eobi.t7.v6.0.2.orderadd", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.order_delete = ProtoField.new("Order Delete", "eurex.eobi.t7.v6.0.2.orderdelete", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.order_details = ProtoField.new("Order Details", "eurex.eobi.t7.v6.0.2.orderdetails", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.order_mass_delete = ProtoField.new("Order Mass Delete", "eurex.eobi.t7.v6.0.2.ordermassdelete", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.order_modify = ProtoField.new("Order Modify", "eurex.eobi.t7.v6.0.2.ordermodify", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.order_modify_same_prio = ProtoField.new("Order Modify Same Prio", "eurex.eobi.t7.v6.0.2.ordermodifysameprio", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.packet = ProtoField.new("Packet", "eurex.eobi.t7.v6.0.2.packet", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.packet_header = ProtoField.new("Packet Header", "eurex.eobi.t7.v6.0.2.packetheader", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.packet_id = ProtoField.new("Packet Id", "eurex.eobi.t7.v6.0.2.packetid", ftypes.UINT16)
eurex_eobi_t7_v6_0_2.fields.packet_info = ProtoField.new("Packet Info", "eurex.eobi.t7.v6.0.2.packetinfo", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.packet_seq_num = ProtoField.new("Packet Seq Num", "eurex.eobi.t7.v6.0.2.packetseqnum", ftypes.UINT32)
eurex_eobi_t7_v6_0_2.fields.pad_1 = ProtoField.new("Pad 1", "eurex.eobi.t7.v6.0.2.pad1", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.pad_2 = ProtoField.new("Pad 2", "eurex.eobi.t7.v6.0.2.pad2", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.pad_3 = ProtoField.new("Pad 3", "eurex.eobi.t7.v6.0.2.pad3", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.pad_4 = ProtoField.new("Pad 4", "eurex.eobi.t7.v6.0.2.pad4", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.pad_5 = ProtoField.new("Pad 5", "eurex.eobi.t7.v6.0.2.pad5", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.pad_6 = ProtoField.new("Pad 6", "eurex.eobi.t7.v6.0.2.pad6", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.pad_7 = ProtoField.new("Pad 7", "eurex.eobi.t7.v6.0.2.pad7", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.pad5 = ProtoField.new("Pad5", "eurex.eobi.t7.v6.0.2.pad5", ftypes.BYTES)
eurex_eobi_t7_v6_0_2.fields.partial_order_execution = ProtoField.new("Partial Order Execution", "eurex.eobi.t7.v6.0.2.partialorderexecution", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.partition_id = ProtoField.new("Partition ID", "eurex.eobi.t7.v6.0.2.partitionid", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.payload = ProtoField.new("Payload", "eurex.eobi.t7.v6.0.2.payload", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.potential_security_trading_event = ProtoField.new("Potential Security Trading Event", "eurex.eobi.t7.v6.0.2.potentialsecuritytradingevent", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.prev_display_qty = ProtoField.new("Prev Display Qty", "eurex.eobi.t7.v6.0.2.prevdisplayqty", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.prev_price = ProtoField.new("Prev Price", "eurex.eobi.t7.v6.0.2.prevprice", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.price = ProtoField.new("Price", "eurex.eobi.t7.v6.0.2.price", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.product_complex = ProtoField.new("Product Complex", "eurex.eobi.t7.v6.0.2.productcomplex", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.product_state_change = ProtoField.new("Product State Change", "eurex.eobi.t7.v6.0.2.productstatechange", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.product_summary = ProtoField.new("Product Summary", "eurex.eobi.t7.v6.0.2.productsummary", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.quote_request = ProtoField.new("Quote Request", "eurex.eobi.t7.v6.0.2.quoterequest", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.request_time = ProtoField.new("Request Time", "eurex.eobi.t7.v6.0.2.requesttime", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.resting_cxl_qty = ProtoField.new("Resting Cxl Qty", "eurex.eobi.t7.v6.0.2.restingcxlqty", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.resting_hidden_qty = ProtoField.new("Resting Hidden Qty", "eurex.eobi.t7.v6.0.2.restinghiddenqty", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.security_id = ProtoField.new("Security Id", "eurex.eobi.t7.v6.0.2.securityid", ftypes.INT64)
eurex_eobi_t7_v6_0_2.fields.security_status = ProtoField.new("Security Status", "eurex.eobi.t7.v6.0.2.securitystatus", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.security_sub_type = ProtoField.new("Security Sub Type", "eurex.eobi.t7.v6.0.2.securitysubtype", ftypes.INT32)
eurex_eobi_t7_v6_0_2.fields.security_trading_event = ProtoField.new("Security Trading Event", "eurex.eobi.t7.v6.0.2.securitytradingevent", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.security_trading_status = ProtoField.new("Security Trading Status", "eurex.eobi.t7.v6.0.2.securitytradingstatus", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.side = ProtoField.new("Side", "eurex.eobi.t7.v6.0.2.side", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.snapshot_order = ProtoField.new("Snapshot Order", "eurex.eobi.t7.v6.0.2.snapshotorder", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.template_id = ProtoField.new("Template Id", "eurex.eobi.t7.v6.0.2.templateid", ftypes.UINT16)
eurex_eobi_t7_v6_0_2.fields.top_of_book = ProtoField.new("Top Of Book", "eurex.eobi.t7.v6.0.2.topofbook", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.tot_no_orders = ProtoField.new("Tot No Orders", "eurex.eobi.t7.v6.0.2.totnoorders", ftypes.UINT16)
eurex_eobi_t7_v6_0_2.fields.trad_ses_status = ProtoField.new("Trad Ses Status", "eurex.eobi.t7.v6.0.2.tradsesstatus", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.trade_condition = ProtoField.new("Trade Condition", "eurex.eobi.t7.v6.0.2.tradecondition", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.trade_report = ProtoField.new("Trade Report", "eurex.eobi.t7.v6.0.2.tradereport", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.trade_reversal = ProtoField.new("Trade Reversal", "eurex.eobi.t7.v6.0.2.tradereversal", ftypes.STRING)
eurex_eobi_t7_v6_0_2.fields.trading_session_id = ProtoField.new("Trading Session Id", "eurex.eobi.t7.v6.0.2.tradingsessionid", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.trading_session_sub_id = ProtoField.new("Trading Session Sub Id", "eurex.eobi.t7.v6.0.2.tradingsessionsubid", ftypes.UINT8)
eurex_eobi_t7_v6_0_2.fields.transact_time = ProtoField.new("Transact Time", "eurex.eobi.t7.v6.0.2.transacttime", ftypes.UINT64)
eurex_eobi_t7_v6_0_2.fields.trd_match_id = ProtoField.new("Trd Match Id", "eurex.eobi.t7.v6.0.2.trdmatchid", ftypes.UINT32)
eurex_eobi_t7_v6_0_2.fields.trd_reg_ts_execution_time = ProtoField.new("Trd Reg Ts Execution Time", "eurex.eobi.t7.v6.0.2.trdregtsexecutiontime", ftypes.UINT64)
...
dissect.pad_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad_3, range, value, display)
...
dissect.md_entry_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.md_entry_type, range, value, display)
...
dissect.md_entry_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.md_entry_size, range, value, display)
...
dissect.md_entry_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.md_entry_px, range, value, display)
...
dissect.md_trade_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.md_trade_entry_grp then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.md_trade_entry_grp, range, display)
  end
...
dissect.no_md_entries = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.no_md_entries, range, value, display)
...
dissect.pad_6 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad_6, range, value, display)
...
dissect.trade_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trade_condition, range, value, display)
...
dissect.trd_reg_ts_execution_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trd_reg_ts_execution_time, range, value, display)
...
dissect.last_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.last_px, range, value, display)
...
dissect.last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.last_qty, range, value, display)
...
dissect.trd_match_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trd_match_id, range, value, display)
...
dissect.transact_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.transact_time, range, value, display)
...
dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.security_id, range, value, display)
...
dissect.trade_reversal = function(buffer, offset, packet, parent)
  ...
  if show.trade_reversal then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.trade_reversal, range, display)
  end
...
dissect.pad_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad_4, range, value, display)
...
dissect.algorithmic_trade_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.algorithmic_trade_indicator, range, value, display)
...
dissect.match_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.match_sub_type, range, value, display)
...
dissect.match_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.match_type, range, value, display)
...
dissect.trade_report = function(buffer, offset, packet, parent)
  ...
  if show.trade_report then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.trade_report, range, display)
  end
...
dissect.offer_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.offer_px, range, value, display)
...
dissect.bid_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.bid_px, range, value, display)
...
dissect.top_of_book = function(buffer, offset, packet, parent)
  ...
  if show.top_of_book then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.top_of_book, range, display)
  end
...
dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.price, range, value, display)
...
dissect.pad_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad_2, range, value, display)
...
dissect.ord_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.ord_type, range, value, display)
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.side, range, value, display)
...
dissect.display_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.display_qty, range, value, display)
...
dissect.trd_reg_ts_time_priority = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trd_reg_ts_time_priority, range, value, display)
...
dissect.order_details = function(buffer, offset, packet, parent)
  ...
  if show.order_details then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.order_details, range, display)
  end
...
dissect.snapshot_order = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_order then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.snapshot_order, range, display)
  end
...
dissect.quote_request = function(buffer, offset, packet, parent)
  ...
  if show.quote_request then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.quote_request, range, display)
  end
...
dissect.pad_7 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad_7, range, value, display)
...
dissect.fast_market_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.fast_market_indicator, range, value, display)
...
dissect.market_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.market_condition, range, value, display)
...
dissect.trad_ses_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trad_ses_status, range, value, display)
...
dissect.trading_session_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trading_session_sub_id, range, value, display)
...
dissect.trading_session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trading_session_id, range, value, display)
...
dissect.last_msg_seq_num_processed = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.last_msg_seq_num_processed, range, value, display)
...
dissect.product_summary = function(buffer, offset, packet, parent)
  ...
  if show.product_summary then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.product_summary, range, display)
  end
...
dissect.product_state_change = function(buffer, offset, packet, parent)
  ...
  if show.product_state_change then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.product_state_change, range, display)
  end
...
dissect.pad_5 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad_5, range, value, display)
...
dissect.partial_order_execution = function(buffer, offset, packet, parent)
  ...
  if show.partial_order_execution then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.partial_order_execution, range, display)
  end
...
dissect.pad5 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad5, range, value, display)
...
dissect.application_sequence_reset_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.application_sequence_reset_indicator, range, value, display)
...
dissect.completion_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.completion_indicator, range, value, display)
...
dissect.partition_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.partition_id, range, value, display)
...
dissect.market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.market_segment_id, range, value, display)
...
dissect.application_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.application_sequence_number, range, value, display)
...
dissect.packet_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.packet_seq_num, range, value, display)
...
dissect.packet_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.packet_id, range, value, display)
...
dissect.header_length = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.header_length, range, value, display)
...
dissect.packet_info = function(buffer, offset, packet, parent)
  ...
  if show.packet_info then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.packet_info, range, display)
  end
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.packet_header, range, display)
  end
...
dissect.prev_display_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.prev_display_qty, range, value, display)
...
dissect.trd_reg_ts_time_in = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trd_reg_ts_time_in, range, value, display)
...
dissect.order_modify_same_prio = function(buffer, offset, packet, parent)
  ...
  if show.order_modify_same_prio then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.order_modify_same_prio, range, display)
  end
...
dissect.prev_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.prev_price, range, value, display)
...
dissect.trd_reg_ts_prev_time_priority = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.trd_reg_ts_prev_time_priority, range, value, display)
...
dissect.order_modify = function(buffer, offset, packet, parent)
  ...
  if show.order_modify then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.order_modify, range, display)
  end
...
dissect.order_mass_delete = function(buffer, offset, packet, parent)
  ...
  if show.order_mass_delete then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.order_mass_delete, range, display)
  end
...
dissect.order_delete = function(buffer, offset, packet, parent)
  ...
  if show.order_delete then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.order_delete, range, display)
  end
...
dissect.order_add = function(buffer, offset, packet, parent)
  ...
  if show.order_add then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.order_add, range, display)
  end
...
dissect.md_instrument_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_entry_grp then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.md_instrument_entry_grp, range, display)
  end
...
dissect.security_trading_event = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.security_trading_event, range, value, display)
...
dissect.security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.security_trading_status, range, value, display)
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.security_status, range, value, display)
...
dissect.tot_no_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.tot_no_orders, range, value, display)
...
dissect.last_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.last_update_time, range, value, display)
...
dissect.instrument_summary = function(buffer, offset, packet, parent)
  ...
  if show.instrument_summary then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.instrument_summary, range, display)
  end
...
dissect.instrument_state_change = function(buffer, offset, packet, parent)
  ...
  if show.instrument_state_change then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.instrument_state_change, range, display)
  end
...
dissect.heartbeat = function(buffer, offset, packet, parent)
  ...
  if show.heartbeat then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.heartbeat, range, display)
  end
...
dissect.full_order_execution = function(buffer, offset, packet, parent)
  ...
  if show.full_order_execution then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.full_order_execution, range, display)
  end
...
dissect.resting_cxl_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.resting_cxl_qty, range, value, display)
...
dissect.resting_hidden_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.resting_hidden_qty, range, value, display)
...
dissect.aggressor_side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.aggressor_side, range, value, display)
...
dissect.exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.exec_id, range, value, display)
...
dissect.request_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.request_time, range, value, display)
...
dissect.aggressor_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.aggressor_time, range, value, display)
...
dissect.execution_summary = function(buffer, offset, packet, parent)
  ...
  if show.execution_summary then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.execution_summary, range, display)
  end
...
dissect.cross_request = function(buffer, offset, packet, parent)
  ...
  if show.cross_request then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.cross_request, range, display)
  end
...
dissect.potential_security_trading_event = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.potential_security_trading_event, range, value, display)
...
dissect.imbalance_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.imbalance_qty, range, value, display)
...
dissect.auction_clearing_price = function(buffer, offset, packet, parent)
  ...
  if show.auction_clearing_price then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.auction_clearing_price, range, display)
  end
...
dissect.offer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.offer_size, range, value, display)
...
dissect.bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.bid_size, range, value, display)
...
dissect.auction_bbo = function(buffer, offset, packet, parent)
  ...
  if show.auction_bbo then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.auction_bbo, range, display)
  end
...
dissect.leg_side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.leg_side, range, value, display)
...
dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.leg_ratio_qty, range, value, display)
...
dissect.leg_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.leg_security_id, range, value, display)
...
dissect.leg_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.leg_symbol, range, value, display)
...
dissect.instrmt_leg_grp = function(buffer, offset, packet, parent)
  ...
  if show.instrmt_leg_grp then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.instrmt_leg_grp, range, display)
  end
...
dissect.pad_1 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.pad_1, range, value, display)
...
dissect.no_legs = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.no_legs, range, value, display)
...
dissect.implied_market_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.implied_market_indicator, range, value, display)
...
dissect.product_complex = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.product_complex, range, value, display)
...
dissect.security_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.security_sub_type, range, value, display)
...
dissect.add_complex_instrument = function(buffer, offset, packet, parent)
  ...
  if show.add_complex_instrument then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.add_complex_instrument, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, code)
  ...
  local element = parent:add(eurex_eobi_t7_v6_0_2.fields.payload, range, display)
...
dissect.msg_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.msg_seq_num, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.template_id, range, value, display)
...
dissect.body_len = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v6_0_2.fields.body_len, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.message_header, range, display)
  end
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(eurex_eobi_t7_v6_0_2.fields.message, range, display)
  end
...
function eurex_eobi_t7_v6_0_2.init()
end

-- Dissector for Eurex Eobi T7 6.0.2
function eurex_eobi_t7_v6_0_2.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = eurex_eobi_t7_v6_0_2.name

  -- Dissect protocol
  local protocol = parent:add(eurex_eobi_t7_v6_0_2, buffer(), eurex_eobi_t7_v6_0_2.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, eurex_eobi_t7_v6_0_2)
...
verify.eurex_eobi_t7_v6_0_2_packet_size = function(buffer)
...
-- Dissector Heuristic for Eurex Eobi T7 6.0.2
local function eurex_eobi_t7_v6_0_2_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.eurex_eobi_t7_v6_0_2_packet_size(buffer) then return false end

  -- Verify Packet Id
  if not verify.packet_id(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = eurex_eobi_t7_v6_0_2
  eurex_eobi_t7_v6_0_2.dissector(buffer, packet, parent)

  return true
end

-- Register Eurex Eobi T7 6.0.2 Heuristic
eurex_eobi_t7_v6_0_2:register_heuristic("udp", eurex_eobi_t7_v6_0_2_heuristic)
