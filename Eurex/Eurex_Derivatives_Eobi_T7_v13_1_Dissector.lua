...
eurex_derivatives_eobi_t7_v13_1_dissect.trade_reversal_fields = function(buffer, offset, packet, parent)
  ...
  for md_trade_entry_grp_comp_index = 1, no_md_entries do
    ...
    if md_trade_entry_grp_comp ~= nil then
      local iteration = md_trade_entry_grp_comp:add(eurex_derivatives_eobi_t7_v13_1.fields.md_trade_entry_grp_comp_index, md_trade_entry_grp_comp_index)
...
eurex_derivatives_eobi_t7_v13_1_dissect.mass_instrument_state_change_fields = function(buffer, offset, packet, parent)
  ...
  for sec_mass_stat_grp_comp_index = 1, no_related_sym do
    ...
    if sec_mass_stat_grp_comp ~= nil then
      local iteration = sec_mass_stat_grp_comp:add(eurex_derivatives_eobi_t7_v13_1.fields.sec_mass_stat_grp_comp_index, sec_mass_stat_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_derivatives_eobi_t7_v13_1_dissect.instrument_summary_fields = function(buffer, offset, packet, parent)
  ...
  for md_instrument_entry_grp_comp_index = 1, no_md_entries do
    ...
    if md_instrument_entry_grp_comp ~= nil then
      local iteration = md_instrument_entry_grp_comp:add(eurex_derivatives_eobi_t7_v13_1.fields.md_instrument_entry_grp_comp_index, md_instrument_entry_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_derivatives_eobi_t7_v13_1_dissect.add_complex_instrument_fields = function(buffer, offset, packet, parent)
  ...
  for instrmt_leg_grp_comp_index = 1, no_legs do
    ...
    if instrmt_leg_grp_comp ~= nil then
      local iteration = instrmt_leg_grp_comp:add(eurex_derivatives_eobi_t7_v13_1.fields.instrmt_leg_grp_comp_index, instrmt_leg_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_derivatives_eobi_t7_v13_1_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(eurex_derivatives_eobi_t7_v13_1.fields.message, buffer(offset, 0))
    local current = eurex_derivatives_eobi_t7_v13_1_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = eurex_derivatives_eobi_t7_v13_1_display.message(buffer, packet, element)
    element:append_text(display)
