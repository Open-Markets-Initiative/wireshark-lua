...
size_of.srqs_update_negotiation_request = function(buffer, offset)
  ...
  index = index + target_parties_comp_count * 16
...
size_of.srqs_open_negotiation_requester_notification = function(buffer, offset)
  ...
  -- Calculate field size from count
  local quot_req_legs_grp_comp_count = buffer(offset + index - 42, 1):le_uint()
  index = index + quot_req_legs_grp_comp_count * 24

  -- Calculate field size from count
  local target_parties_comp_count = buffer(offset + index - 65, 1):le_uint()
  index = index + target_parties_comp_count * 16
...
size_of.srqs_open_negotiation_request = function(buffer, offset)
  ...
  -- Calculate field size from count
  local quot_req_legs_grp_comp_count = buffer(offset + index - 39, 1):le_uint()
  index = index + quot_req_legs_grp_comp_count * 24

  -- Calculate field size from count
  local target_parties_comp_count = buffer(offset + index - 62, 1):le_uint()
  index = index + target_parties_comp_count * 16
...
size_of.srqs_open_negotiation_notification = function(buffer, offset)
  ...
  -- Calculate field size from count
  local quot_req_legs_grp_comp_count = buffer(offset + index - 58, 1):le_uint()
  index = index + quot_req_legs_grp_comp_count * 24
...
size_of.leg_best_offer_size = 4

-- Display: Leg Best Offer Size
display.leg_best_offer_size = function(value)
  return "Leg Best Offer Size: "..value
end

-- Dissect: Leg Best Offer Size
dissect.leg_best_offer_size = function(buffer, offset, packet, parent)
  local length = size_of.leg_best_offer_size
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.leg_best_offer_size(value, buffer, offset, packet, parent)
...
size_of.leg_best_bid_size = 4

-- Display: Leg Best Bid Size
display.leg_best_bid_size = function(value)
  return "Leg Best Bid Size: "..value
end

-- Dissect: Leg Best Bid Size
dissect.leg_best_bid_size = function(buffer, offset, packet, parent)
  local length = size_of.leg_best_bid_size
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.leg_best_bid_size(value, buffer, offset, packet, parent)
...
size_of.leg_best_offer_px = 8

-- Display: Leg Best Offer Px
display.leg_best_offer_px = function(value)
...
dissect.leg_best_offer_px = function(buffer, offset, packet, parent)
  local length = size_of.leg_best_offer_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
  local value = translate.leg_best_offer_px(raw)
  local display = display.leg_best_offer_px(value, buffer, offset, packet, parent)
...
size_of.leg_best_bid_px = 8

-- Display: Leg Best Bid Px
display.leg_best_bid_px = function(value)
...
dissect.leg_best_bid_px = function(buffer, offset, packet, parent)
  local length = size_of.leg_best_bid_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
  local value = translate.leg_best_bid_px(raw)
  local display = display.leg_best_bid_px(value, buffer, offset, packet, parent)
...
size_of.srqs_trd_instrmnt_leg_grp_comp = function(buffer, offset)
  local index = 0

  index = index + size_of.leg_security_id

  index = index + size_of.leg_best_bid_px

  index = index + size_of.leg_best_offer_px

  index = index + size_of.leg_best_bid_size

  index = index + size_of.leg_best_offer_size

  return index
end

-- Display: Srqs Trd Instrmnt Leg Grp Comp
display.srqs_trd_instrmnt_leg_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Srqs Trd Instrmnt Leg Grp Comp
dissect.srqs_trd_instrmnt_leg_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, leg_best_bid_px = dissect.leg_best_bid_px(buffer, index, packet, parent)

  -- Leg Best Offer Px: 8 Byte Unsigned Fixed Width Integer
  index, leg_best_offer_px = dissect.leg_best_offer_px(buffer, index, packet, parent)

  -- Leg Best Bid Size: 4 Byte Signed Fixed Width Integer
  index, leg_best_bid_size = dissect.leg_best_bid_size(buffer, index, packet, parent)

  -- Leg Best Offer Size: 4 Byte Signed Fixed Width Integer
  index, leg_best_offer_size = dissect.leg_best_offer_size(buffer, index, packet, parent)

  return index
end

-- Dissect: Srqs Trd Instrmnt Leg Grp Comp
dissect.srqs_trd_instrmnt_leg_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.srqs_trd_instrmnt_leg_grp_comp then
    local length = size_of.srqs_trd_instrmnt_leg_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = display.srqs_trd_instrmnt_leg_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eti_t7_v6_0.fields.srqs_trd_instrmnt_leg_grp_comp, range, display)
  end

  return dissect.srqs_trd_instrmnt_leg_grp_comp_fields(buffer, offset, packet, parent)
end
...
size_of.srqs_create_deal_notification = function(buffer, offset)
  ...
  -- Calculate field size from count
  local srqs_trd_instrmnt_leg_grp_comp_count = buffer(offset + index - 81, 1):le_uint()
  index = index + srqs_trd_instrmnt_leg_grp_comp_count * 32
...
dissect.srqs_create_deal_notification_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, no_legs do
    index = dissect.srqs_trd_instrmnt_leg_grp_comp(buffer, index, packet, parent)
  end
...
size_of.mass_quote_request = function(buffer, offset)
  ...
  -- Calculate field size from count
  local quote_entry_grp_comp_count = buffer(offset + index - 10, 1):le_uint()
