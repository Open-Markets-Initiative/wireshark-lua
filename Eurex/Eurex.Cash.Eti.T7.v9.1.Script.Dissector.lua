...
eurex_cash_eti_t7_v9_1_size_of.message_header_in_comp = function(buffer, offset)
  local index = 0
  ...
  index = index + eurex_cash_eti_t7_v9_1_size_of.network_msg_id
...
eurex_cash_eti_t7_v9_1_display.message_header_in_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message Header In Comp
eurex_cash_eti_t7_v9_1_dissect.message_header_in_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.message_header_in_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.message_header_in_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.message_header_in_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.message_header_in_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.message_header_in_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.message_header_in_comp_fields(buffer, offset, packet, parent)
end
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_update_negotiation_request_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_update_negotiation_request)
  ...
  index, message_header_in_comp = eurex_cash_eti_t7_v9_1_dissect.message_header_in_comp(buffer, index, packet, parent)
...
eurex_cash_eti_t7_v9_1_size_of.message_header_out_comp = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v9_1_display.message_header_out_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message Header Out Comp
eurex_cash_eti_t7_v9_1_dissect.message_header_out_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_cash_eti_t7_v9_1_dissect.message_header_out_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.message_header_out_comp then
    local length = eurex_cash_eti_t7_v9_1_size_of.message_header_out_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = eurex_cash_eti_t7_v9_1_display.message_header_out_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v9_1.fields.message_header_out_comp, range, display)
  end

  return eurex_cash_eti_t7_v9_1_dissect.message_header_out_comp_fields(buffer, offset, packet, parent)
end
...
eurex_cash_eti_t7_v9_1_dissect.xetra_en_light_status_broadcast_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_status_broadcast)
  ...
  index, message_header_out_comp = eurex_cash_eti_t7_v9_1_dissect.message_header_out_comp(buffer, index, packet, parent)
