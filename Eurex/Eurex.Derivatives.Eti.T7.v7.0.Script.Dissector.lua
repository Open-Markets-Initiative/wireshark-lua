...
-- Eurex Derivatives Eti T7 7.0 Protocol
local eurex_derivatives_eti_t7_v7_0 = Proto("Eurex.Derivatives.Eti.T7.v7.0.Lua", "Eurex Derivatives Eti T7 7.0")
...
-- Eurex Derivatives Eti T7 7.0 Fields
eurex_derivatives_eti_t7_v7_0.fields.account = ProtoField.new("Account", "eurex.derivatives.eti.t7.v7.0.account", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.add_complex_instrument_request = ProtoField.new("Add Complex Instrument Request", "eurex.derivatives.eti.t7.v7.0.addcomplexinstrumentrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.add_complex_instrument_response = ProtoField.new("Add Complex Instrument Response", "eurex.derivatives.eti.t7.v7.0.addcomplexinstrumentresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.add_flexible_instrument_request = ProtoField.new("Add Flexible Instrument Request", "eurex.derivatives.eti.t7.v7.0.addflexibleinstrumentrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.add_flexible_instrument_response = ProtoField.new("Add Flexible Instrument Response", "eurex.derivatives.eti.t7.v7.0.addflexibleinstrumentresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.affected_order_request_id = ProtoField.new("Affected Order Request Id", "eurex.derivatives.eti.t7.v7.0.affectedorderrequestid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.affected_order_requests_grp_comp = ProtoField.new("Affected Order Requests Grp Comp", "eurex.derivatives.eti.t7.v7.0.affectedorderrequestsgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.alloc_id = ProtoField.new("Alloc Id", "eurex.derivatives.eti.t7.v7.0.allocid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.alloc_qty = ProtoField.new("Alloc Qty", "eurex.derivatives.eti.t7.v7.0.allocqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.appl_beg_msg_id = ProtoField.new("Appl Beg Msg Id", "eurex.derivatives.eti.t7.v7.0.applbegmsgid", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.appl_beg_seq_num = ProtoField.new("Appl Beg Seq Num", "eurex.derivatives.eti.t7.v7.0.applbegseqnum", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.appl_end_msg_id = ProtoField.new("Appl End Msg Id", "eurex.derivatives.eti.t7.v7.0.applendmsgid", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.appl_end_seq_num = ProtoField.new("Appl End Seq Num", "eurex.derivatives.eti.t7.v7.0.applendseqnum", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.appl_id = ProtoField.new("Appl Id", "eurex.derivatives.eti.t7.v7.0.applid", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.appl_id_status = ProtoField.new("Appl Id Status", "eurex.derivatives.eti.t7.v7.0.applidstatus", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.appl_msg_id = ProtoField.new("Appl Msg Id", "eurex.derivatives.eti.t7.v7.0.applmsgid", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.appl_resend_flag = ProtoField.new("Appl Resend Flag", "eurex.derivatives.eti.t7.v7.0.applresendflag", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.appl_seq_indicator = ProtoField.new("Appl Seq Indicator", "eurex.derivatives.eti.t7.v7.0.applseqindicator", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.appl_seq_num = ProtoField.new("Appl Seq Num", "eurex.derivatives.eti.t7.v7.0.applseqnum", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.appl_seq_status = ProtoField.new("Appl Seq Status", "eurex.derivatives.eti.t7.v7.0.applseqstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.appl_seq_trade_date = ProtoField.new("Appl Seq Trade Date", "eurex.derivatives.eti.t7.v7.0.applseqtradedate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.appl_sub_id = ProtoField.new("Appl Sub Id", "eurex.derivatives.eti.t7.v7.0.applsubid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.appl_total_message_count = ProtoField.new("Appl Total Message Count", "eurex.derivatives.eti.t7.v7.0.appltotalmessagecount", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.appl_usage_orders = ProtoField.new("Appl Usage Orders", "eurex.derivatives.eti.t7.v7.0.applusageorders", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.appl_usage_quotes = ProtoField.new("Appl Usage Quotes", "eurex.derivatives.eti.t7.v7.0.applusagequotes", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.application_system_name = ProtoField.new("Application System Name", "eurex.derivatives.eti.t7.v7.0.applicationsystemname", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.application_system_vendor = ProtoField.new("Application System Vendor", "eurex.derivatives.eti.t7.v7.0.applicationsystemvendor", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.application_system_version = ProtoField.new("Application System Version", "eurex.derivatives.eti.t7.v7.0.applicationsystemversion", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.approve_tes_trade_request = ProtoField.new("Approve Tes Trade Request", "eurex.derivatives.eti.t7.v7.0.approvetestraderequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.basket_side_trade_report_id = ProtoField.new("Basket Side Trade Report Id", "eurex.derivatives.eti.t7.v7.0.basketsidetradereportid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.basket_trd_match_id = ProtoField.new("Basket Trd Match Id", "eurex.derivatives.eti.t7.v7.0.baskettrdmatchid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.best_bid_px = ProtoField.new("Best Bid Px", "eurex.derivatives.eti.t7.v7.0.bestbidpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.best_bid_size = ProtoField.new("Best Bid Size", "eurex.derivatives.eti.t7.v7.0.bestbidsize", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.best_offer_px = ProtoField.new("Best Offer Px", "eurex.derivatives.eti.t7.v7.0.bestofferpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.best_offer_size = ProtoField.new("Best Offer Size", "eurex.derivatives.eti.t7.v7.0.bestoffersize", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.bid_cxl_size = ProtoField.new("Bid Cxl Size", "eurex.derivatives.eti.t7.v7.0.bidcxlsize", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.bid_px = ProtoField.new("Bid Px", "eurex.derivatives.eti.t7.v7.0.bidpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.bid_size = ProtoField.new("Bid Size", "eurex.derivatives.eti.t7.v7.0.bidsize", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.body_len = ProtoField.new("Body Len", "eurex.derivatives.eti.t7.v7.0.bodylen", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.broadcast_error_notification = ProtoField.new("Broadcast Error Notification", "eurex.derivatives.eti.t7.v7.0.broadcasterrornotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.cl_ord_id = ProtoField.new("Cl Ord Id", "eurex.derivatives.eti.t7.v7.0.clordid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.clearing_trade_price = ProtoField.new("Clearing Trade Price", "eurex.derivatives.eti.t7.v7.0.clearingtradeprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.clearing_trade_qty = ProtoField.new("Clearing Trade Qty", "eurex.derivatives.eti.t7.v7.0.clearingtradeqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.clip_deletion_notification = ProtoField.new("Clip Deletion Notification", "eurex.derivatives.eti.t7.v7.0.clipdeletionnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.clip_execution_notification = ProtoField.new("Clip Execution Notification", "eurex.derivatives.eti.t7.v7.0.clipexecutionnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.clip_response = ProtoField.new("Clip Response", "eurex.derivatives.eti.t7.v7.0.clipresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.compliance_text = ProtoField.new("Compliance Text", "eurex.derivatives.eti.t7.v7.0.compliancetext", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.cross_id = ProtoField.new("Cross Id", "eurex.derivatives.eti.t7.v7.0.crossid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.cross_request = ProtoField.new("Cross Request", "eurex.derivatives.eti.t7.v7.0.crossrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.cross_request_ack_side_grp_comp = ProtoField.new("Cross Request Ack Side Grp Comp", "eurex.derivatives.eti.t7.v7.0.crossrequestacksidegrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.cross_request_id = ProtoField.new("Cross Request Id", "eurex.derivatives.eti.t7.v7.0.crossrequestid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.cross_request_response = ProtoField.new("Cross Request Response", "eurex.derivatives.eti.t7.v7.0.crossrequestresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.cross_request_side_grp_comp = ProtoField.new("Cross Request Side Grp Comp", "eurex.derivatives.eti.t7.v7.0.crossrequestsidegrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.crossed_indicator = ProtoField.new("Crossed Indicator", "eurex.derivatives.eti.t7.v7.0.crossedindicator", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.cum_qty = ProtoField.new("Cum Qty", "eurex.derivatives.eti.t7.v7.0.cumqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.cust_order_handling_inst = ProtoField.new("Cust Order Handling Inst", "eurex.derivatives.eti.t7.v7.0.custorderhandlinginst", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.cxl_qty = ProtoField.new("Cxl Qty", "eurex.derivatives.eti.t7.v7.0.cxlqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.default_cstm_appl_ver_id = ProtoField.new("Default Cstm Appl Ver Id", "eurex.derivatives.eti.t7.v7.0.defaultcstmapplverid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.default_cstm_appl_ver_sub_id = ProtoField.new("Default Cstm Appl Ver Sub Id", "eurex.derivatives.eti.t7.v7.0.defaultcstmapplversubid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_order_broadcast = ProtoField.new("Delete All Order Broadcast", "eurex.derivatives.eti.t7.v7.0.deleteallorderbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_order_nr_response = ProtoField.new("Delete All Order Nr Response", "eurex.derivatives.eti.t7.v7.0.deleteallordernrresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_order_quote_event_broadcast = ProtoField.new("Delete All Order Quote Event Broadcast", "eurex.derivatives.eti.t7.v7.0.deleteallorderquoteeventbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_order_request = ProtoField.new("Delete All Order Request", "eurex.derivatives.eti.t7.v7.0.deleteallorderrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_order_response = ProtoField.new("Delete All Order Response", "eurex.derivatives.eti.t7.v7.0.deleteallorderresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_quote_broadcast = ProtoField.new("Delete All Quote Broadcast", "eurex.derivatives.eti.t7.v7.0.deleteallquotebroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_quote_request = ProtoField.new("Delete All Quote Request", "eurex.derivatives.eti.t7.v7.0.deleteallquoterequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_all_quote_response = ProtoField.new("Delete All Quote Response", "eurex.derivatives.eti.t7.v7.0.deleteallquoteresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_clip_request = ProtoField.new("Delete Clip Request", "eurex.derivatives.eti.t7.v7.0.deletecliprequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_order_broadcast = ProtoField.new("Delete Order Broadcast", "eurex.derivatives.eti.t7.v7.0.deleteorderbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_order_complex_request = ProtoField.new("Delete Order Complex Request", "eurex.derivatives.eti.t7.v7.0.deleteordercomplexrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_order_nr_response = ProtoField.new("Delete Order Nr Response", "eurex.derivatives.eti.t7.v7.0.deleteordernrresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_order_response = ProtoField.new("Delete Order Response", "eurex.derivatives.eti.t7.v7.0.deleteorderresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_order_single_request = ProtoField.new("Delete Order Single Request", "eurex.derivatives.eti.t7.v7.0.deleteordersinglerequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delete_reason = ProtoField.new("Delete Reason", "eurex.derivatives.eti.t7.v7.0.deletereason", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.delete_tes_trade_request = ProtoField.new("Delete Tes Trade Request", "eurex.derivatives.eti.t7.v7.0.deletetestraderequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.delta = ProtoField.new("Delta", "eurex.derivatives.eti.t7.v7.0.delta", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.enrichment_rule_id = ProtoField.new("Enrichment Rule Id", "eurex.derivatives.eti.t7.v7.0.enrichmentruleid", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.enrichment_rules_grp_comp = ProtoField.new("Enrichment Rules Grp Comp", "eurex.derivatives.eti.t7.v7.0.enrichmentrulesgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.enter_clip_request = ProtoField.new("Enter Clip Request", "eurex.derivatives.eti.t7.v7.0.entercliprequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.enter_tes_trade_request = ProtoField.new("Enter Tes Trade Request", "eurex.derivatives.eti.t7.v7.0.entertestraderequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.event_date = ProtoField.new("Event Date", "eurex.derivatives.eti.t7.v7.0.eventdate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.event_type = ProtoField.new("Event Type", "eurex.derivatives.eti.t7.v7.0.eventtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.exec_id = ProtoField.new("Exec Id", "eurex.derivatives.eti.t7.v7.0.execid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.exec_inst = ProtoField.new("Exec Inst", "eurex.derivatives.eti.t7.v7.0.execinst", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.exec_restatement_reason = ProtoField.new("Exec Restatement Reason", "eurex.derivatives.eti.t7.v7.0.execrestatementreason", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.exec_type = ProtoField.new("Exec Type", "eurex.derivatives.eti.t7.v7.0.exectype", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.executing_trader = ProtoField.new("Executing Trader", "eurex.derivatives.eti.t7.v7.0.executingtrader", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.executing_trader_qualifier = ProtoField.new("Executing Trader Qualifier", "eurex.derivatives.eti.t7.v7.0.executingtraderqualifier", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.exercise_style = ProtoField.new("Exercise Style", "eurex.derivatives.eti.t7.v7.0.exercisestyle", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.expire_date = ProtoField.new("Expire Date", "eurex.derivatives.eti.t7.v7.0.expiredate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.expire_time = ProtoField.new("Expire Time", "eurex.derivatives.eti.t7.v7.0.expiretime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.exposure_duration = ProtoField.new("Exposure Duration", "eurex.derivatives.eti.t7.v7.0.exposureduration", ftypes.INT64)
eurex_derivatives_eti_t7_v7_0.fields.fill_exec_id = ProtoField.new("Fill Exec Id", "eurex.derivatives.eti.t7.v7.0.fillexecid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.fill_liquidity_ind = ProtoField.new("Fill Liquidity Ind", "eurex.derivatives.eti.t7.v7.0.fillliquidityind", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.fill_match_id = ProtoField.new("Fill Match Id", "eurex.derivatives.eti.t7.v7.0.fillmatchid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.fill_px = ProtoField.new("Fill Px", "eurex.derivatives.eti.t7.v7.0.fillpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.fill_qty = ProtoField.new("Fill Qty", "eurex.derivatives.eti.t7.v7.0.fillqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.fill_ref_id = ProtoField.new("Fill Ref Id", "eurex.derivatives.eti.t7.v7.0.fillrefid", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.fills_grp_comp = ProtoField.new("Fills Grp Comp", "eurex.derivatives.eti.t7.v7.0.fillsgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.firm_negotiation_id = ProtoField.new("Firm Negotiation Id", "eurex.derivatives.eti.t7.v7.0.firmnegotiationid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.firm_trade_id = ProtoField.new("Firm Trade Id", "eurex.derivatives.eti.t7.v7.0.firmtradeid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.fix_cl_ord_id = ProtoField.new("Fix Cl Ord Id", "eurex.derivatives.eti.t7.v7.0.fixclordid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.fix_engine_name = ProtoField.new("Fix Engine Name", "eurex.derivatives.eti.t7.v7.0.fixenginename", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.fix_engine_vendor = ProtoField.new("Fix Engine Vendor", "eurex.derivatives.eti.t7.v7.0.fixenginevendor", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.fix_engine_version = ProtoField.new("Fix Engine Version", "eurex.derivatives.eti.t7.v7.0.fixengineversion", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.forced_logout_notification = ProtoField.new("Forced Logout Notification", "eurex.derivatives.eti.t7.v7.0.forcedlogoutnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.forced_user_logout_notification = ProtoField.new("Forced User Logout Notification", "eurex.derivatives.eti.t7.v7.0.forceduserlogoutnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.free_text_1 = ProtoField.new("Free Text 1", "eurex.derivatives.eti.t7.v7.0.freetext1", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.free_text_2 = ProtoField.new("Free Text 2", "eurex.derivatives.eti.t7.v7.0.freetext2", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.free_text_3 = ProtoField.new("Free Text 3", "eurex.derivatives.eti.t7.v7.0.freetext3", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.gateway_request = ProtoField.new("Gateway Request", "eurex.derivatives.eti.t7.v7.0.gatewayrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.headline = ProtoField.new("Headline", "eurex.derivatives.eti.t7.v7.0.headline", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "eurex.derivatives.eti.t7.v7.0.heartbtint", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.heartbeat = ProtoField.new("Heartbeat", "eurex.derivatives.eti.t7.v7.0.heartbeat", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.heartbeat_notification = ProtoField.new("Heartbeat Notification", "eurex.derivatives.eti.t7.v7.0.heartbeatnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.hedge_type = ProtoField.new("Hedge Type", "eurex.derivatives.eti.t7.v7.0.hedgetype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.high_limit_price = ProtoField.new("High Limit Price", "eurex.derivatives.eti.t7.v7.0.highlimitprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.implied_market_indicator = ProtoField.new("Implied Market Indicator", "eurex.derivatives.eti.t7.v7.0.impliedmarketindicator", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.individual_alloc_id = ProtoField.new("Individual Alloc Id", "eurex.derivatives.eti.t7.v7.0.individualallocid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.input_source = ProtoField.new("Input Source", "eurex.derivatives.eti.t7.v7.0.inputsource", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.inquire_enrichment_rule_id_list_request = ProtoField.new("Inquire Enrichment Rule Id List Request", "eurex.derivatives.eti.t7.v7.0.inquireenrichmentruleidlistrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_enrichment_rule_id_list_response = ProtoField.new("Inquire Enrichment Rule Id List Response", "eurex.derivatives.eti.t7.v7.0.inquireenrichmentruleidlistresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_mm_parameter_request = ProtoField.new("Inquire Mm Parameter Request", "eurex.derivatives.eti.t7.v7.0.inquiremmparameterrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_mm_parameter_response = ProtoField.new("Inquire Mm Parameter Response", "eurex.derivatives.eti.t7.v7.0.inquiremmparameterresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_pre_trade_risk_limits_request = ProtoField.new("Inquire Pre Trade Risk Limits Request", "eurex.derivatives.eti.t7.v7.0.inquirepretraderisklimitsrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_session_list_request = ProtoField.new("Inquire Session List Request", "eurex.derivatives.eti.t7.v7.0.inquiresessionlistrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_session_list_response = ProtoField.new("Inquire Session List Response", "eurex.derivatives.eti.t7.v7.0.inquiresessionlistresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_user_request = ProtoField.new("Inquire User Request", "eurex.derivatives.eti.t7.v7.0.inquireuserrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.inquire_user_response = ProtoField.new("Inquire User Response", "eurex.derivatives.eti.t7.v7.0.inquireuserresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.instr_attrib_type = ProtoField.new("Instr Attrib Type", "eurex.derivatives.eti.t7.v7.0.instrattribtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.instr_attrib_value = ProtoField.new("Instr Attrib Value", "eurex.derivatives.eti.t7.v7.0.instrattribvalue", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.instrmnt_leg_exec_grp_comp = ProtoField.new("Instrmnt Leg Exec Grp Comp", "eurex.derivatives.eti.t7.v7.0.instrmntlegexecgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.instrmt_leg_grp_comp = ProtoField.new("Instrmt Leg Grp Comp", "eurex.derivatives.eti.t7.v7.0.instrmtleggrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.instrument_attribute_grp_comp = ProtoField.new("Instrument Attribute Grp Comp", "eurex.derivatives.eti.t7.v7.0.instrumentattributegrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.instrument_event_grp_comp = ProtoField.new("Instrument Event Grp Comp", "eurex.derivatives.eti.t7.v7.0.instrumenteventgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.last_entity_processed = ProtoField.new("Last Entity Processed", "eurex.derivatives.eti.t7.v7.0.lastentityprocessed", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.last_fragment = ProtoField.new("Last Fragment", "eurex.derivatives.eti.t7.v7.0.lastfragment", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.last_px = ProtoField.new("Last Px", "eurex.derivatives.eti.t7.v7.0.lastpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.last_px_disclosure_instruction = ProtoField.new("Last Px Disclosure Instruction", "eurex.derivatives.eti.t7.v7.0.lastpxdisclosureinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.last_qty = ProtoField.new("Last Qty", "eurex.derivatives.eti.t7.v7.0.lastqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.last_qty_disclosure_instruction = ProtoField.new("Last Qty Disclosure Instruction", "eurex.derivatives.eti.t7.v7.0.lastqtydisclosureinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.last_update_time = ProtoField.new("Last Update Time", "eurex.derivatives.eti.t7.v7.0.lastupdatetime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.leaves_qty = ProtoField.new("Leaves Qty", "eurex.derivatives.eti.t7.v7.0.leavesqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.leaves_qty_disclosure_instruction = ProtoField.new("Leaves Qty Disclosure Instruction", "eurex.derivatives.eti.t7.v7.0.leavesqtydisclosureinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.leg_account = ProtoField.new("Leg Account", "eurex.derivatives.eti.t7.v7.0.legaccount", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.leg_exec_id = ProtoField.new("Leg Exec Id", "eurex.derivatives.eti.t7.v7.0.legexecid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.leg_input_source = ProtoField.new("Leg Input Source", "eurex.derivatives.eti.t7.v7.0.leginputsource", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.leg_last_px = ProtoField.new("Leg Last Px", "eurex.derivatives.eti.t7.v7.0.leglastpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.leg_last_qty = ProtoField.new("Leg Last Qty", "eurex.derivatives.eti.t7.v7.0.leglastqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.leg_ord_grp_comp = ProtoField.new("Leg Ord Grp Comp", "eurex.derivatives.eti.t7.v7.0.legordgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.leg_position_effect = ProtoField.new("Leg Position Effect", "eurex.derivatives.eti.t7.v7.0.legpositioneffect", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.leg_price = ProtoField.new("Leg Price", "eurex.derivatives.eti.t7.v7.0.legprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "eurex.derivatives.eti.t7.v7.0.legratioqty", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.leg_security_id = ProtoField.new("Leg Security Id", "eurex.derivatives.eti.t7.v7.0.legsecurityid", ftypes.INT64)
eurex_derivatives_eti_t7_v7_0.fields.leg_security_type = ProtoField.new("Leg Security Type", "eurex.derivatives.eti.t7.v7.0.legsecuritytype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.leg_side = ProtoField.new("Leg Side", "eurex.derivatives.eti.t7.v7.0.legside", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.leg_symbol = ProtoField.new("Leg Symbol", "eurex.derivatives.eti.t7.v7.0.legsymbol", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.legal_notification_broadcast = ProtoField.new("Legal Notification Broadcast", "eurex.derivatives.eti.t7.v7.0.legalnotificationbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.list_update_action = ProtoField.new("List Update Action", "eurex.derivatives.eti.t7.v7.0.listupdateaction", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.logon_request = ProtoField.new("Logon Request", "eurex.derivatives.eti.t7.v7.0.logonrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.logon_response = ProtoField.new("Logon Response", "eurex.derivatives.eti.t7.v7.0.logonresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.logout_request = ProtoField.new("Logout Request", "eurex.derivatives.eti.t7.v7.0.logoutrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.logout_response = ProtoField.new("Logout Response", "eurex.derivatives.eti.t7.v7.0.logoutresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.low_limit_price = ProtoField.new("Low Limit Price", "eurex.derivatives.eti.t7.v7.0.lowlimitprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.market_id = ProtoField.new("Market Id", "eurex.derivatives.eti.t7.v7.0.marketid", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.market_segment_id = ProtoField.new("Market Segment Id", "eurex.derivatives.eti.t7.v7.0.marketsegmentid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.mass_action_reason = ProtoField.new("Mass Action Reason", "eurex.derivatives.eti.t7.v7.0.massactionreason", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.mass_action_report_id = ProtoField.new("Mass Action Report Id", "eurex.derivatives.eti.t7.v7.0.massactionreportid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.mass_action_sub_type = ProtoField.new("Mass Action Sub Type", "eurex.derivatives.eti.t7.v7.0.massactionsubtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.mass_action_type = ProtoField.new("Mass Action Type", "eurex.derivatives.eti.t7.v7.0.massactiontype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.mass_quote_request = ProtoField.new("Mass Quote Request", "eurex.derivatives.eti.t7.v7.0.massquoterequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.mass_quote_response = ProtoField.new("Mass Quote Response", "eurex.derivatives.eti.t7.v7.0.massquoteresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.match_date = ProtoField.new("Match Date", "eurex.derivatives.eti.t7.v7.0.matchdate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.match_inst_cross_id = ProtoField.new("Match Inst Cross Id", "eurex.derivatives.eti.t7.v7.0.matchinstcrossid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.match_sub_type = ProtoField.new("Match Sub Type", "eurex.derivatives.eti.t7.v7.0.matchsubtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.match_type = ProtoField.new("Match Type", "eurex.derivatives.eti.t7.v7.0.matchtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.matching_engine_status = ProtoField.new("Matching Engine Status", "eurex.derivatives.eti.t7.v7.0.matchingenginestatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.matching_engine_trade_date = ProtoField.new("Matching Engine Trade Date", "eurex.derivatives.eti.t7.v7.0.matchingenginetradedate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.maturity_date = ProtoField.new("Maturity Date", "eurex.derivatives.eti.t7.v7.0.maturitydate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.maximum_price = ProtoField.new("Maximum Price", "eurex.derivatives.eti.t7.v7.0.maximumprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.md_book_type = ProtoField.new("Md Book Type", "eurex.derivatives.eti.t7.v7.0.mdbooktype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.md_sub_book_type = ProtoField.new("Md Sub Book Type", "eurex.derivatives.eti.t7.v7.0.mdsubbooktype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.message_event_source = ProtoField.new("Message Event Source", "eurex.derivatives.eti.t7.v7.0.messageeventsource", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.message_header_in_comp = ProtoField.new("Message Header In Comp", "eurex.derivatives.eti.t7.v7.0.messageheaderincomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.message_header_out_comp = ProtoField.new("Message Header Out Comp", "eurex.derivatives.eti.t7.v7.0.messageheaderoutcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.mm_parameter_definition_request = ProtoField.new("Mm Parameter Definition Request", "eurex.derivatives.eti.t7.v7.0.mmparameterdefinitionrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.mm_parameter_definition_response = ProtoField.new("Mm Parameter Definition Response", "eurex.derivatives.eti.t7.v7.0.mmparameterdefinitionresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.mm_parameter_grp_comp = ProtoField.new("Mm Parameter Grp Comp", "eurex.derivatives.eti.t7.v7.0.mmparametergrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.mm_parameter_report_id = ProtoField.new("Mm Parameter Report Id", "eurex.derivatives.eti.t7.v7.0.mmparameterreportid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.modify_order_complex_request = ProtoField.new("Modify Order Complex Request", "eurex.derivatives.eti.t7.v7.0.modifyordercomplexrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.modify_order_complex_short_request = ProtoField.new("Modify Order Complex Short Request", "eurex.derivatives.eti.t7.v7.0.modifyordercomplexshortrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.modify_order_nr_response = ProtoField.new("Modify Order Nr Response", "eurex.derivatives.eti.t7.v7.0.modifyordernrresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.modify_order_response = ProtoField.new("Modify Order Response", "eurex.derivatives.eti.t7.v7.0.modifyorderresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.modify_order_single_request = ProtoField.new("Modify Order Single Request", "eurex.derivatives.eti.t7.v7.0.modifyordersinglerequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.modify_order_single_short_request = ProtoField.new("Modify Order Single Short Request", "eurex.derivatives.eti.t7.v7.0.modifyordersingleshortrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.modify_tes_trade_request = ProtoField.new("Modify Tes Trade Request", "eurex.derivatives.eti.t7.v7.0.modifytestraderequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.msg_seq_num = ProtoField.new("Msg Seq Num", "eurex.derivatives.eti.t7.v7.0.msgseqnum", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.multi_leg_reporting_type = ProtoField.new("Multi Leg Reporting Type", "eurex.derivatives.eti.t7.v7.0.multilegreportingtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.multileg_model = ProtoField.new("Multileg Model", "eurex.derivatives.eti.t7.v7.0.multilegmodel", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.multileg_price_model = ProtoField.new("Multileg Price Model", "eurex.derivatives.eti.t7.v7.0.multilegpricemodel", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.negotiate_underlying = ProtoField.new("Negotiate Underlying", "eurex.derivatives.eti.t7.v7.0.negotiateunderlying", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.negotiation_id = ProtoField.new("Negotiation Id", "eurex.derivatives.eti.t7.v7.0.negotiationid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.negotiation_start_time = ProtoField.new("Negotiation Start Time", "eurex.derivatives.eti.t7.v7.0.negotiationstarttime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.network_msg_id = ProtoField.new("Network Msg Id", "eurex.derivatives.eti.t7.v7.0.networkmsgid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.new_order_complex_request = ProtoField.new("New Order Complex Request", "eurex.derivatives.eti.t7.v7.0.newordercomplexrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.new_order_complex_short_request = ProtoField.new("New Order Complex Short Request", "eurex.derivatives.eti.t7.v7.0.newordercomplexshortrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.new_order_nr_response = ProtoField.new("New Order Nr Response", "eurex.derivatives.eti.t7.v7.0.newordernrresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.new_order_response = ProtoField.new("New Order Response", "eurex.derivatives.eti.t7.v7.0.neworderresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.new_order_single_request = ProtoField.new("New Order Single Request", "eurex.derivatives.eti.t7.v7.0.newordersinglerequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.new_order_single_short_request = ProtoField.new("New Order Single Short Request", "eurex.derivatives.eti.t7.v7.0.newordersingleshortrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.news_broadcast = ProtoField.new("News Broadcast", "eurex.derivatives.eti.t7.v7.0.newsbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.no_affected_order_requests = ProtoField.new("No Affected Order Requests", "eurex.derivatives.eti.t7.v7.0.noaffectedorderrequests", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.no_cross_legs = ProtoField.new("No Cross Legs", "eurex.derivatives.eti.t7.v7.0.nocrosslegs", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_enrichment_rules = ProtoField.new("No Enrichment Rules", "eurex.derivatives.eti.t7.v7.0.noenrichmentrules", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.no_events = ProtoField.new("No Events", "eurex.derivatives.eti.t7.v7.0.noevents", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_fills = ProtoField.new("No Fills", "eurex.derivatives.eti.t7.v7.0.nofills", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_instr_attrib = ProtoField.new("No Instr Attrib", "eurex.derivatives.eti.t7.v7.0.noinstrattrib", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_leg_execs = ProtoField.new("No Leg Execs", "eurex.derivatives.eti.t7.v7.0.nolegexecs", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.no_legs = ProtoField.new("No Legs", "eurex.derivatives.eti.t7.v7.0.nolegs", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_mm_parameters = ProtoField.new("No Mm Parameters", "eurex.derivatives.eti.t7.v7.0.nommparameters", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_not_affected_orders = ProtoField.new("No Not Affected Orders", "eurex.derivatives.eti.t7.v7.0.nonotaffectedorders", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.no_not_affected_securities = ProtoField.new("No Not Affected Securities", "eurex.derivatives.eti.t7.v7.0.nonotaffectedsecurities", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.no_order_book_items = ProtoField.new("No Order Book Items", "eurex.derivatives.eti.t7.v7.0.noorderbookitems", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_party_details = ProtoField.new("No Party Details", "eurex.derivatives.eti.t7.v7.0.nopartydetails", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.no_quote_entries = ProtoField.new("No Quote Entries", "eurex.derivatives.eti.t7.v7.0.noquoteentries", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_quote_events = ProtoField.new("No Quote Events", "eurex.derivatives.eti.t7.v7.0.noquoteevents", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_quote_events_index = ProtoField.new("No Quote Events Index", "eurex.derivatives.eti.t7.v7.0.noquoteeventsindex", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_risk_limits = ProtoField.new("No Risk Limits", "eurex.derivatives.eti.t7.v7.0.norisklimits", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_risk_limits_qty = ProtoField.new("No Risk Limits Qty", "eurex.derivatives.eti.t7.v7.0.norisklimitsqty", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_sessions = ProtoField.new("No Sessions", "eurex.derivatives.eti.t7.v7.0.nosessions", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.no_side_allocs = ProtoField.new("No Side Allocs", "eurex.derivatives.eti.t7.v7.0.nosideallocs", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_sides = ProtoField.new("No Sides", "eurex.derivatives.eti.t7.v7.0.nosides", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_target_party_i_ds = ProtoField.new("No Target Party I Ds", "eurex.derivatives.eti.t7.v7.0.notargetpartyids", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.no_underlying_stips = ProtoField.new("No Underlying Stips", "eurex.derivatives.eti.t7.v7.0.nounderlyingstips", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.not_aff_orig_cl_ord_id = ProtoField.new("Not Aff Orig Cl Ord Id", "eurex.derivatives.eti.t7.v7.0.notafforigclordid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.not_affected_order_id = ProtoField.new("Not Affected Order Id", "eurex.derivatives.eti.t7.v7.0.notaffectedorderid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.not_affected_orders_grp_comp = ProtoField.new("Not Affected Orders Grp Comp", "eurex.derivatives.eti.t7.v7.0.notaffectedordersgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.not_affected_securities_grp_comp = ProtoField.new("Not Affected Securities Grp Comp", "eurex.derivatives.eti.t7.v7.0.notaffectedsecuritiesgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.not_affected_security_id = ProtoField.new("Not Affected Security Id", "eurex.derivatives.eti.t7.v7.0.notaffectedsecurityid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.notif_header_comp = ProtoField.new("Notif Header Comp", "eurex.derivatives.eti.t7.v7.0.notifheadercomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.notification_in = ProtoField.new("Notification In", "eurex.derivatives.eti.t7.v7.0.notificationin", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.nr_response_header_me_comp = ProtoField.new("Nr Response Header Me Comp", "eurex.derivatives.eti.t7.v7.0.nrresponseheadermecomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.nrbc_header_comp = ProtoField.new("Nrbc Header Comp", "eurex.derivatives.eti.t7.v7.0.nrbcheadercomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.number_of_resp_disclosure_instruction = ProtoField.new("Number Of Resp Disclosure Instruction", "eurex.derivatives.eti.t7.v7.0.numberofrespdisclosureinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.number_of_respondents = ProtoField.new("Number Of Respondents", "eurex.derivatives.eti.t7.v7.0.numberofrespondents", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.number_of_securities = ProtoField.new("Number Of Securities", "eurex.derivatives.eti.t7.v7.0.numberofsecurities", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.offer_cxl_size = ProtoField.new("Offer Cxl Size", "eurex.derivatives.eti.t7.v7.0.offercxlsize", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.offer_px = ProtoField.new("Offer Px", "eurex.derivatives.eti.t7.v7.0.offerpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.offer_size = ProtoField.new("Offer Size", "eurex.derivatives.eti.t7.v7.0.offersize", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.opt_attribute = ProtoField.new("Opt Attribute", "eurex.derivatives.eti.t7.v7.0.optattribute", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.ord_status = ProtoField.new("Ord Status", "eurex.derivatives.eti.t7.v7.0.ordstatus", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.ord_type = ProtoField.new("Ord Type", "eurex.derivatives.eti.t7.v7.0.ordtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.order_attribute_liquidity_provision = ProtoField.new("Order Attribute Liquidity Provision", "eurex.derivatives.eti.t7.v7.0.orderattributeliquidityprovision", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.order_attribute_risk_reduction = ProtoField.new("Order Attribute Risk Reduction", "eurex.derivatives.eti.t7.v7.0.orderattributeriskreduction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.order_book_item_grp_comp = ProtoField.new("Order Book Item Grp Comp", "eurex.derivatives.eti.t7.v7.0.orderbookitemgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.order_category = ProtoField.new("Order Category", "eurex.derivatives.eti.t7.v7.0.ordercategory", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.order_exec_notification = ProtoField.new("Order Exec Notification", "eurex.derivatives.eti.t7.v7.0.orderexecnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.order_exec_report_broadcast = ProtoField.new("Order Exec Report Broadcast", "eurex.derivatives.eti.t7.v7.0.orderexecreportbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.order_exec_response = ProtoField.new("Order Exec Response", "eurex.derivatives.eti.t7.v7.0.orderexecresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.order_id = ProtoField.new("Order Id", "eurex.derivatives.eti.t7.v7.0.orderid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.order_qty = ProtoField.new("Order Qty", "eurex.derivatives.eti.t7.v7.0.orderqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.order_qty_disclosure_instruction = ProtoField.new("Order Qty Disclosure Instruction", "eurex.derivatives.eti.t7.v7.0.orderqtydisclosureinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.order_routing_indicator = ProtoField.new("Order Routing Indicator", "eurex.derivatives.eti.t7.v7.0.orderroutingindicator", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.order_side = ProtoField.new("Order Side", "eurex.derivatives.eti.t7.v7.0.orderside", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.orig_cl_ord_id = ProtoField.new("Orig Cl Ord Id", "eurex.derivatives.eti.t7.v7.0.origclordid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.orig_time = ProtoField.new("Orig Time", "eurex.derivatives.eti.t7.v7.0.origtime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.orig_trade_id = ProtoField.new("Orig Trade Id", "eurex.derivatives.eti.t7.v7.0.origtradeid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.ownership_indicator = ProtoField.new("Ownership Indicator", "eurex.derivatives.eti.t7.v7.0.ownershipindicator", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.package_id = ProtoField.new("Package Id", "eurex.derivatives.eti.t7.v7.0.packageid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.packet = ProtoField.new("Packet", "eurex.derivatives.eti.t7.v7.0.packet", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.pad_1 = ProtoField.new("Pad 1", "eurex.derivatives.eti.t7.v7.0.pad1", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.pad_2 = ProtoField.new("Pad 2", "eurex.derivatives.eti.t7.v7.0.pad2", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.pad_21 = ProtoField.new("Pad 21", "eurex.derivatives.eti.t7.v7.0.pad21", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.pad_3 = ProtoField.new("Pad 3", "eurex.derivatives.eti.t7.v7.0.pad3", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.pad_4 = ProtoField.new("Pad 4", "eurex.derivatives.eti.t7.v7.0.pad4", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.pad_5 = ProtoField.new("Pad 5", "eurex.derivatives.eti.t7.v7.0.pad5", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.pad_6 = ProtoField.new("Pad 6", "eurex.derivatives.eti.t7.v7.0.pad6", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.pad_7 = ProtoField.new("Pad 7", "eurex.derivatives.eti.t7.v7.0.pad7", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.partition_id = ProtoField.new("Partition Id", "eurex.derivatives.eti.t7.v7.0.partitionid", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.party_action_report = ProtoField.new("Party Action Report", "eurex.derivatives.eti.t7.v7.0.partyactionreport", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_action_type = ProtoField.new("Party Action Type", "eurex.derivatives.eti.t7.v7.0.partyactiontype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.party_detail_desk_id = ProtoField.new("Party Detail Desk Id", "eurex.derivatives.eti.t7.v7.0.partydetaildeskid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_detail_executing_trader = ProtoField.new("Party Detail Executing Trader", "eurex.derivatives.eti.t7.v7.0.partydetailexecutingtrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_detail_executing_unit = ProtoField.new("Party Detail Executing Unit", "eurex.derivatives.eti.t7.v7.0.partydetailexecutingunit", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_detail_id_executing_trader = ProtoField.new("Party Detail Id Executing Trader", "eurex.derivatives.eti.t7.v7.0.partydetailidexecutingtrader", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.party_detail_id_executing_unit = ProtoField.new("Party Detail Id Executing Unit", "eurex.derivatives.eti.t7.v7.0.partydetailidexecutingunit", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.party_detail_role_qualifier = ProtoField.new("Party Detail Role Qualifier", "eurex.derivatives.eti.t7.v7.0.partydetailrolequalifier", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.party_detail_status = ProtoField.new("Party Detail Status", "eurex.derivatives.eti.t7.v7.0.partydetailstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.party_details_grp_comp = ProtoField.new("Party Details Grp Comp", "eurex.derivatives.eti.t7.v7.0.partydetailsgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_entering_trader = ProtoField.new("Party Entering Trader", "eurex.derivatives.eti.t7.v7.0.partyenteringtrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_entitlements_update_report = ProtoField.new("Party Entitlements Update Report", "eurex.derivatives.eti.t7.v7.0.partyentitlementsupdatereport", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_executing_firm = ProtoField.new("Party Executing Firm", "eurex.derivatives.eti.t7.v7.0.partyexecutingfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_executing_trader = ProtoField.new("Party Executing Trader", "eurex.derivatives.eti.t7.v7.0.partyexecutingtrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_executing_unit = ProtoField.new("Party Executing Unit", "eurex.derivatives.eti.t7.v7.0.partyexecutingunit", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_id_beneficiary = ProtoField.new("Party Id Beneficiary", "eurex.derivatives.eti.t7.v7.0.partyidbeneficiary", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_id_client_id = ProtoField.new("Party Id Client Id", "eurex.derivatives.eti.t7.v7.0.partyidclientid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.party_id_entering_firm = ProtoField.new("Party Id Entering Firm", "eurex.derivatives.eti.t7.v7.0.partyidenteringfirm", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.party_id_entering_trader = ProtoField.new("Party Id Entering Trader", "eurex.derivatives.eti.t7.v7.0.partyidenteringtrader", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.party_id_executing_trader = ProtoField.new("Party Id Executing Trader", "eurex.derivatives.eti.t7.v7.0.partyidexecutingtrader", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.party_id_executing_unit = ProtoField.new("Party Id Executing Unit", "eurex.derivatives.eti.t7.v7.0.partyidexecutingunit", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.party_id_investment_decision_maker = ProtoField.new("Party Id Investment Decision Maker", "eurex.derivatives.eti.t7.v7.0.partyidinvestmentdecisionmaker", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.party_id_investment_decision_maker_qualifier = ProtoField.new("Party Id Investment Decision Maker Qualifier", "eurex.derivatives.eti.t7.v7.0.partyidinvestmentdecisionmakerqualifier", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.party_id_location_id = ProtoField.new("Party Id Location Id", "eurex.derivatives.eti.t7.v7.0.partyidlocationid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_id_order_origination_firm = ProtoField.new("Party Id Order Origination Firm", "eurex.derivatives.eti.t7.v7.0.partyidorderoriginationfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_id_origination_market = ProtoField.new("Party Id Origination Market", "eurex.derivatives.eti.t7.v7.0.partyidoriginationmarket", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.party_id_position_account = ProtoField.new("Party Id Position Account", "eurex.derivatives.eti.t7.v7.0.partyidpositionaccount", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.party_id_session_id = ProtoField.new("Party Id Session Id", "eurex.derivatives.eti.t7.v7.0.partyidsessionid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.party_id_settlement_location = ProtoField.new("Party Id Settlement Location", "eurex.derivatives.eti.t7.v7.0.partyidsettlementlocation", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.party_id_take_up_trading_firm = ProtoField.new("Party Id Take Up Trading Firm", "eurex.derivatives.eti.t7.v7.0.partyidtakeuptradingfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.password = ProtoField.new("Password", "eurex.derivatives.eti.t7.v7.0.password", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.pct_count = ProtoField.new("Pct Count", "eurex.derivatives.eti.t7.v7.0.pctcount", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.position_effect = ProtoField.new("Position Effect", "eurex.derivatives.eti.t7.v7.0.positioneffect", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.pre_trade_risk_limit_response = ProtoField.new("Pre Trade Risk Limit Response", "eurex.derivatives.eti.t7.v7.0.pretraderisklimitresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.pre_trade_risk_limits_definition_request = ProtoField.new("Pre Trade Risk Limits Definition Request", "eurex.derivatives.eti.t7.v7.0.pretraderisklimitsdefinitionrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.price = ProtoField.new("Price", "eurex.derivatives.eti.t7.v7.0.price", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.price_disclosure_instruction = ProtoField.new("Price Disclosure Instruction", "eurex.derivatives.eti.t7.v7.0.pricedisclosureinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.price_validity_check_type = ProtoField.new("Price Validity Check Type", "eurex.derivatives.eti.t7.v7.0.pricevaliditychecktype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.product_complex = ProtoField.new("Product Complex", "eurex.derivatives.eti.t7.v7.0.productcomplex", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.put_or_call = ProtoField.new("Put Or Call", "eurex.derivatives.eti.t7.v7.0.putorcall", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quot_req_legs_grp_comp = ProtoField.new("Quot Req Legs Grp Comp", "eurex.derivatives.eti.t7.v7.0.quotreqlegsgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_activation_notification = ProtoField.new("Quote Activation Notification", "eurex.derivatives.eti.t7.v7.0.quoteactivationnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_activation_request = ProtoField.new("Quote Activation Request", "eurex.derivatives.eti.t7.v7.0.quoteactivationrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_activation_response = ProtoField.new("Quote Activation Response", "eurex.derivatives.eti.t7.v7.0.quoteactivationresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_cancel_type = ProtoField.new("Quote Cancel Type", "eurex.derivatives.eti.t7.v7.0.quotecanceltype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_entry_ack_grp_comp = ProtoField.new("Quote Entry Ack Grp Comp", "eurex.derivatives.eti.t7.v7.0.quoteentryackgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_entry_grp_comp = ProtoField.new("Quote Entry Grp Comp", "eurex.derivatives.eti.t7.v7.0.quoteentrygrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_entry_reject_reason = ProtoField.new("Quote Entry Reject Reason", "eurex.derivatives.eti.t7.v7.0.quoteentryrejectreason", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.quote_entry_status = ProtoField.new("Quote Entry Status", "eurex.derivatives.eti.t7.v7.0.quoteentrystatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_exec_id = ProtoField.new("Quote Event Exec Id", "eurex.derivatives.eti.t7.v7.0.quoteeventexecid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_grp_comp = ProtoField.new("Quote Event Grp Comp", "eurex.derivatives.eti.t7.v7.0.quoteeventgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_liquidity_ind = ProtoField.new("Quote Event Liquidity Ind", "eurex.derivatives.eti.t7.v7.0.quoteeventliquidityind", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_match_id = ProtoField.new("Quote Event Match Id", "eurex.derivatives.eti.t7.v7.0.quoteeventmatchid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_px = ProtoField.new("Quote Event Px", "eurex.derivatives.eti.t7.v7.0.quoteeventpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_qty = ProtoField.new("Quote Event Qty", "eurex.derivatives.eti.t7.v7.0.quoteeventqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_reason = ProtoField.new("Quote Event Reason", "eurex.derivatives.eti.t7.v7.0.quoteeventreason", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_side = ProtoField.new("Quote Event Side", "eurex.derivatives.eti.t7.v7.0.quoteeventside", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_event_type = ProtoField.new("Quote Event Type", "eurex.derivatives.eti.t7.v7.0.quoteeventtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_execution_report = ProtoField.new("Quote Execution Report", "eurex.derivatives.eti.t7.v7.0.quoteexecutionreport", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_id = ProtoField.new("Quote Id", "eurex.derivatives.eti.t7.v7.0.quoteid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.quote_instruction = ProtoField.new("Quote Instruction", "eurex.derivatives.eti.t7.v7.0.quoteinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_leg_exec_grp_comp = ProtoField.new("Quote Leg Exec Grp Comp", "eurex.derivatives.eti.t7.v7.0.quotelegexecgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_msg_id = ProtoField.new("Quote Msg Id", "eurex.derivatives.eti.t7.v7.0.quotemsgid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.quote_ref_price = ProtoField.new("Quote Ref Price", "eurex.derivatives.eti.t7.v7.0.quoterefprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.quote_ref_price_source = ProtoField.new("Quote Ref Price Source", "eurex.derivatives.eti.t7.v7.0.quoterefpricesource", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_req_id = ProtoField.new("Quote Req Id", "eurex.derivatives.eti.t7.v7.0.quotereqid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.quote_response_id = ProtoField.new("Quote Response Id", "eurex.derivatives.eti.t7.v7.0.quoteresponseid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.quote_size_type = ProtoField.new("Quote Size Type", "eurex.derivatives.eti.t7.v7.0.quotesizetype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_status = ProtoField.new("Quote Status", "eurex.derivatives.eti.t7.v7.0.quotestatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_sub_type = ProtoField.new("Quote Sub Type", "eurex.derivatives.eti.t7.v7.0.quotesubtype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.quote_type = ProtoField.new("Quote Type", "eurex.derivatives.eti.t7.v7.0.quotetype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.rbc_header_comp = ProtoField.new("Rbc Header Comp", "eurex.derivatives.eti.t7.v7.0.rbcheadercomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.rbc_header_me_comp = ProtoField.new("Rbc Header Me Comp", "eurex.derivatives.eti.t7.v7.0.rbcheadermecomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.ref_appl_id = ProtoField.new("Ref Appl Id", "eurex.derivatives.eti.t7.v7.0.refapplid", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.ref_appl_last_msg_id = ProtoField.new("Ref Appl Last Msg Id", "eurex.derivatives.eti.t7.v7.0.refappllastmsgid", ftypes.BYTES)
eurex_derivatives_eti_t7_v7_0.fields.ref_appl_last_seq_num = ProtoField.new("Ref Appl Last Seq Num", "eurex.derivatives.eti.t7.v7.0.refappllastseqnum", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.ref_appl_sub_id = ProtoField.new("Ref Appl Sub Id", "eurex.derivatives.eti.t7.v7.0.refapplsubid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.regulatory_trade_id = ProtoField.new("Regulatory Trade Id", "eurex.derivatives.eti.t7.v7.0.regulatorytradeid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.reject = ProtoField.new("Reject", "eurex.derivatives.eti.t7.v7.0.reject", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.related_close_price = ProtoField.new("Related Close Price", "eurex.derivatives.eti.t7.v7.0.relatedcloseprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.related_market_segment_id = ProtoField.new("Related Market Segment Id", "eurex.derivatives.eti.t7.v7.0.relatedmarketsegmentid", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.related_product_complex = ProtoField.new("Related Product Complex", "eurex.derivatives.eti.t7.v7.0.relatedproductcomplex", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.related_security_id = ProtoField.new("Related Security Id", "eurex.derivatives.eti.t7.v7.0.relatedsecurityid", ftypes.INT64)
eurex_derivatives_eti_t7_v7_0.fields.related_symbol = ProtoField.new("Related Symbol", "eurex.derivatives.eti.t7.v7.0.relatedsymbol", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.related_trade_id = ProtoField.new("Related Trade Id", "eurex.derivatives.eti.t7.v7.0.relatedtradeid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.related_trade_quantity = ProtoField.new("Related Trade Quantity", "eurex.derivatives.eti.t7.v7.0.relatedtradequantity", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.request_header_comp = ProtoField.new("Request Header Comp", "eurex.derivatives.eti.t7.v7.0.requestheadercomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.request_time = ProtoField.new("Request Time", "eurex.derivatives.eti.t7.v7.0.requesttime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.requesting_party_clearing_firm = ProtoField.new("Requesting Party Clearing Firm", "eurex.derivatives.eti.t7.v7.0.requestingpartyclearingfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.requesting_party_entering_firm = ProtoField.new("Requesting Party Entering Firm", "eurex.derivatives.eti.t7.v7.0.requestingpartyenteringfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.requesting_party_id_entering_firm = ProtoField.new("Requesting Party Id Entering Firm", "eurex.derivatives.eti.t7.v7.0.requestingpartyidenteringfirm", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.requesting_party_id_executing_system = ProtoField.new("Requesting Party Id Executing System", "eurex.derivatives.eti.t7.v7.0.requestingpartyidexecutingsystem", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.requesting_party_id_executing_trader = ProtoField.new("Requesting Party Id Executing Trader", "eurex.derivatives.eti.t7.v7.0.requestingpartyidexecutingtrader", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.response_header_comp = ProtoField.new("Response Header Comp", "eurex.derivatives.eti.t7.v7.0.responseheadercomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.response_header_me_comp = ProtoField.new("Response Header Me Comp", "eurex.derivatives.eti.t7.v7.0.responseheadermecomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.response_in = ProtoField.new("Response In", "eurex.derivatives.eti.t7.v7.0.responsein", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.retransmit_me_message_request = ProtoField.new("Retransmit Me Message Request", "eurex.derivatives.eti.t7.v7.0.retransmitmemessagerequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.retransmit_me_message_response = ProtoField.new("Retransmit Me Message Response", "eurex.derivatives.eti.t7.v7.0.retransmitmemessageresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.retransmit_request = ProtoField.new("Retransmit Request", "eurex.derivatives.eti.t7.v7.0.retransmitrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.retransmit_response = ProtoField.new("Retransmit Response", "eurex.derivatives.eti.t7.v7.0.retransmitresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.rfq_request = ProtoField.new("Rfq Request", "eurex.derivatives.eti.t7.v7.0.rfqrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.rfq_response = ProtoField.new("Rfq Response", "eurex.derivatives.eti.t7.v7.0.rfqresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_action = ProtoField.new("Risk Limit Action", "eurex.derivatives.eti.t7.v7.0.risklimitaction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_group = ProtoField.new("Risk Limit Group", "eurex.derivatives.eti.t7.v7.0.risklimitgroup", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_net_position_qty = ProtoField.new("Risk Limit Net Position Qty", "eurex.derivatives.eti.t7.v7.0.risklimitnetpositionqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_open_qty = ProtoField.new("Risk Limit Open Qty", "eurex.derivatives.eti.t7.v7.0.risklimitopenqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_platform = ProtoField.new("Risk Limit Platform", "eurex.derivatives.eti.t7.v7.0.risklimitplatform", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_qty = ProtoField.new("Risk Limit Qty", "eurex.derivatives.eti.t7.v7.0.risklimitqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_qty_grp_comp = ProtoField.new("Risk Limit Qty Grp Comp", "eurex.derivatives.eti.t7.v7.0.risklimitqtygrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_report_id = ProtoField.new("Risk Limit Report Id", "eurex.derivatives.eti.t7.v7.0.risklimitreportid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_requesting_party_role = ProtoField.new("Risk Limit Requesting Party Role", "eurex.derivatives.eti.t7.v7.0.risklimitrequestingpartyrole", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_type = ProtoField.new("Risk Limit Type", "eurex.derivatives.eti.t7.v7.0.risklimittype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.risk_limit_violation_indicator = ProtoField.new("Risk Limit Violation Indicator", "eurex.derivatives.eti.t7.v7.0.risklimitviolationindicator", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.risk_limits_rpt_grp_comp = ProtoField.new("Risk Limits Rpt Grp Comp", "eurex.derivatives.eti.t7.v7.0.risklimitsrptgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.risk_notification_broadcast = ProtoField.new("Risk Notification Broadcast", "eurex.derivatives.eti.t7.v7.0.risknotificationbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_clearing_firm = ProtoField.new("Root Party Clearing Firm", "eurex.derivatives.eti.t7.v7.0.rootpartyclearingfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_clearing_organization = ProtoField.new("Root Party Clearing Organization", "eurex.derivatives.eti.t7.v7.0.rootpartyclearingorganization", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_contra_firm = ProtoField.new("Root Party Contra Firm", "eurex.derivatives.eti.t7.v7.0.rootpartycontrafirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_contra_trader = ProtoField.new("Root Party Contra Trader", "eurex.derivatives.eti.t7.v7.0.rootpartycontratrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_entering_trader = ProtoField.new("Root Party Entering Trader", "eurex.derivatives.eti.t7.v7.0.rootpartyenteringtrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_executing_firm = ProtoField.new("Root Party Executing Firm", "eurex.derivatives.eti.t7.v7.0.rootpartyexecutingfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_executing_trader = ProtoField.new("Root Party Executing Trader", "eurex.derivatives.eti.t7.v7.0.rootpartyexecutingtrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_beneficiary = ProtoField.new("Root Party Id Beneficiary", "eurex.derivatives.eti.t7.v7.0.rootpartyidbeneficiary", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_clearing_unit = ProtoField.new("Root Party Id Clearing Unit", "eurex.derivatives.eti.t7.v7.0.rootpartyidclearingunit", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_client_id = ProtoField.new("Root Party Id Client Id", "eurex.derivatives.eti.t7.v7.0.rootpartyidclientid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_executing_trader = ProtoField.new("Root Party Id Executing Trader", "eurex.derivatives.eti.t7.v7.0.rootpartyidexecutingtrader", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_executing_unit = ProtoField.new("Root Party Id Executing Unit", "eurex.derivatives.eti.t7.v7.0.rootpartyidexecutingunit", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_investment_decision_maker = ProtoField.new("Root Party Id Investment Decision Maker", "eurex.derivatives.eti.t7.v7.0.rootpartyidinvestmentdecisionmaker", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_investment_decision_maker_qualifier = ProtoField.new("Root Party Id Investment Decision Maker Qualifier", "eurex.derivatives.eti.t7.v7.0.rootpartyidinvestmentdecisionmakerqualifier", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_order_origination_firm = ProtoField.new("Root Party Id Order Origination Firm", "eurex.derivatives.eti.t7.v7.0.rootpartyidorderoriginationfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_position_account = ProtoField.new("Root Party Id Position Account", "eurex.derivatives.eti.t7.v7.0.rootpartyidpositionaccount", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_session_id = ProtoField.new("Root Party Id Session Id", "eurex.derivatives.eti.t7.v7.0.rootpartyidsessionid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.root_party_id_take_up_trading_firm = ProtoField.new("Root Party Id Take Up Trading Firm", "eurex.derivatives.eti.t7.v7.0.rootpartyidtakeuptradingfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.secondary_quote_id = ProtoField.new("Secondary Quote Id", "eurex.derivatives.eti.t7.v7.0.secondaryquoteid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.secondary_trade_id = ProtoField.new("Secondary Trade Id", "eurex.derivatives.eti.t7.v7.0.secondarytradeid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.security_id = ProtoField.new("Security Id", "eurex.derivatives.eti.t7.v7.0.securityid", ftypes.INT64)
eurex_derivatives_eti_t7_v7_0.fields.security_response_id = ProtoField.new("Security Response Id", "eurex.derivatives.eti.t7.v7.0.securityresponseid", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.security_sub_type = ProtoField.new("Security Sub Type", "eurex.derivatives.eti.t7.v7.0.securitysubtype", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.selective_request_for_quote_service_status = ProtoField.new("Selective Request For Quote Service Status", "eurex.derivatives.eti.t7.v7.0.selectiverequestforquoteservicestatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.selective_request_for_quote_service_trade_date = ProtoField.new("Selective Request For Quote Service Trade Date", "eurex.derivatives.eti.t7.v7.0.selectiverequestforquoteservicetradedate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.sender_sub_id = ProtoField.new("Sender Sub Id", "eurex.derivatives.eti.t7.v7.0.sendersubid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.sending_time = ProtoField.new("Sending Time", "eurex.derivatives.eti.t7.v7.0.sendingtime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.service_availability_broadcast = ProtoField.new("Service Availability Broadcast", "eurex.derivatives.eti.t7.v7.0.serviceavailabilitybroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.service_availability_market_broadcast = ProtoField.new("Service Availability Market Broadcast", "eurex.derivatives.eti.t7.v7.0.serviceavailabilitymarketbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.session_instance_id = ProtoField.new("Session Instance Id", "eurex.derivatives.eti.t7.v7.0.sessioninstanceid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.session_mode = ProtoField.new("Session Mode", "eurex.derivatives.eti.t7.v7.0.sessionmode", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.session_reject_reason = ProtoField.new("Session Reject Reason", "eurex.derivatives.eti.t7.v7.0.sessionrejectreason", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.session_status = ProtoField.new("Session Status", "eurex.derivatives.eti.t7.v7.0.sessionstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.session_sub_mode = ProtoField.new("Session Sub Mode", "eurex.derivatives.eti.t7.v7.0.sessionsubmode", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.sessions_grp_comp = ProtoField.new("Sessions Grp Comp", "eurex.derivatives.eti.t7.v7.0.sessionsgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.settl_method = ProtoField.new("Settl Method", "eurex.derivatives.eti.t7.v7.0.settlmethod", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.side = ProtoField.new("Side", "eurex.derivatives.eti.t7.v7.0.side", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.side_alloc_ext_grp_comp = ProtoField.new("Side Alloc Ext Grp Comp", "eurex.derivatives.eti.t7.v7.0.sideallocextgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.side_alloc_grp_bc_comp = ProtoField.new("Side Alloc Grp Bc Comp", "eurex.derivatives.eti.t7.v7.0.sideallocgrpbccomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.side_alloc_grp_comp = ProtoField.new("Side Alloc Grp Comp", "eurex.derivatives.eti.t7.v7.0.sideallocgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.side_compliance_text = ProtoField.new("Side Compliance Text", "eurex.derivatives.eti.t7.v7.0.sidecompliancetext", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.side_cross_leg_grp_comp = ProtoField.new("Side Cross Leg Grp Comp", "eurex.derivatives.eti.t7.v7.0.sidecrossleggrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.side_disclosure_instruction = ProtoField.new("Side Disclosure Instruction", "eurex.derivatives.eti.t7.v7.0.sidedisclosureinstruction", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.side_last_px = ProtoField.new("Side Last Px", "eurex.derivatives.eti.t7.v7.0.sidelastpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.side_last_qty = ProtoField.new("Side Last Qty", "eurex.derivatives.eti.t7.v7.0.sidelastqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.side_liquidity_ind = ProtoField.new("Side Liquidity Ind", "eurex.derivatives.eti.t7.v7.0.sideliquidityind", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.side_trade_id = ProtoField.new("Side Trade Id", "eurex.derivatives.eti.t7.v7.0.sidetradeid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.simple_security_id = ProtoField.new("Simple Security Id", "eurex.derivatives.eti.t7.v7.0.simplesecurityid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.skip_validations = ProtoField.new("Skip Validations", "eurex.derivatives.eti.t7.v7.0.skipvalidations", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.srqs_create_deal_notification = ProtoField.new("Srqs Create Deal Notification", "eurex.derivatives.eti.t7.v7.0.srqscreatedealnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_deal_notification = ProtoField.new("Srqs Deal Notification", "eurex.derivatives.eti.t7.v7.0.srqsdealnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_deal_response = ProtoField.new("Srqs Deal Response", "eurex.derivatives.eti.t7.v7.0.srqsdealresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_enter_quote_request = ProtoField.new("Srqs Enter Quote Request", "eurex.derivatives.eti.t7.v7.0.srqsenterquoterequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_hit_quote_request = ProtoField.new("Srqs Hit Quote Request", "eurex.derivatives.eti.t7.v7.0.srqshitquoterequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_negotiation_notification = ProtoField.new("Srqs Negotiation Notification", "eurex.derivatives.eti.t7.v7.0.srqsnegotiationnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_negotiation_requester_notification = ProtoField.new("Srqs Negotiation Requester Notification", "eurex.derivatives.eti.t7.v7.0.srqsnegotiationrequesternotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_negotiation_status_notification = ProtoField.new("Srqs Negotiation Status Notification", "eurex.derivatives.eti.t7.v7.0.srqsnegotiationstatusnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_open_negotiation_notification = ProtoField.new("Srqs Open Negotiation Notification", "eurex.derivatives.eti.t7.v7.0.srqsopennegotiationnotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_open_negotiation_request = ProtoField.new("Srqs Open Negotiation Request", "eurex.derivatives.eti.t7.v7.0.srqsopennegotiationrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_open_negotiation_requester_notification = ProtoField.new("Srqs Open Negotiation Requester Notification", "eurex.derivatives.eti.t7.v7.0.srqsopennegotiationrequesternotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_quote_notification = ProtoField.new("Srqs Quote Notification", "eurex.derivatives.eti.t7.v7.0.srqsquotenotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_quote_response = ProtoField.new("Srqs Quote Response", "eurex.derivatives.eti.t7.v7.0.srqsquoteresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_related_trade_id = ProtoField.new("Srqs Related Trade Id", "eurex.derivatives.eti.t7.v7.0.srqsrelatedtradeid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.srqs_status_broadcast = ProtoField.new("Srqs Status Broadcast", "eurex.derivatives.eti.t7.v7.0.srqsstatusbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_update_deal_status_request = ProtoField.new("Srqs Update Deal Status Request", "eurex.derivatives.eti.t7.v7.0.srqsupdatedealstatusrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.srqs_update_negotiation_request = ProtoField.new("Srqs Update Negotiation Request", "eurex.derivatives.eti.t7.v7.0.srqsupdatenegotiationrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.stop_px = ProtoField.new("Stop Px", "eurex.derivatives.eti.t7.v7.0.stoppx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.strategy_link_id = ProtoField.new("Strategy Link Id", "eurex.derivatives.eti.t7.v7.0.strategylinkid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.strike_price = ProtoField.new("Strike Price", "eurex.derivatives.eti.t7.v7.0.strikeprice", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.subscribe_request = ProtoField.new("Subscribe Request", "eurex.derivatives.eti.t7.v7.0.subscriberequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.subscribe_response = ProtoField.new("Subscribe Response", "eurex.derivatives.eti.t7.v7.0.subscriberesponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.subscription_scope = ProtoField.new("Subscription Scope", "eurex.derivatives.eti.t7.v7.0.subscriptionscope", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.symbol = ProtoField.new("Symbol", "eurex.derivatives.eti.t7.v7.0.symbol", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_rtm_status = ProtoField.new("T 7 Entry Service Rtm Status", "eurex.derivatives.eti.t7.v7.0.t7entryservicertmstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_rtm_trade_date = ProtoField.new("T 7 Entry Service Rtm Trade Date", "eurex.derivatives.eti.t7.v7.0.t7entryservicertmtradedate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_status = ProtoField.new("T 7 Entry Service Status", "eurex.derivatives.eti.t7.v7.0.t7entryservicestatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_trade_date = ProtoField.new("T 7 Entry Service Trade Date", "eurex.derivatives.eti.t7.v7.0.t7entryservicetradedate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.target_parties_comp = ProtoField.new("Target Parties Comp", "eurex.derivatives.eti.t7.v7.0.targetpartiescomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.target_party_entering_trader = ProtoField.new("Target Party Entering Trader", "eurex.derivatives.eti.t7.v7.0.targetpartyenteringtrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.target_party_executing_firm = ProtoField.new("Target Party Executing Firm", "eurex.derivatives.eti.t7.v7.0.targetpartyexecutingfirm", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.target_party_executing_trader = ProtoField.new("Target Party Executing Trader", "eurex.derivatives.eti.t7.v7.0.targetpartyexecutingtrader", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.target_party_id_desk_id = ProtoField.new("Target Party Id Desk Id", "eurex.derivatives.eti.t7.v7.0.targetpartyiddeskid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.target_party_id_executing_trader = ProtoField.new("Target Party Id Executing Trader", "eurex.derivatives.eti.t7.v7.0.targetpartyidexecutingtrader", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.target_party_id_session_id = ProtoField.new("Target Party Id Session Id", "eurex.derivatives.eti.t7.v7.0.targetpartyidsessionid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.template_id = ProtoField.new("Template Id", "eurex.derivatives.eti.t7.v7.0.templateid", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.tes_approve_broadcast = ProtoField.new("Tes Approve Broadcast", "eurex.derivatives.eti.t7.v7.0.tesapprovebroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tes_broadcast = ProtoField.new("Tes Broadcast", "eurex.derivatives.eti.t7.v7.0.tesbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tes_delete_broadcast = ProtoField.new("Tes Delete Broadcast", "eurex.derivatives.eti.t7.v7.0.tesdeletebroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tes_exec_id = ProtoField.new("Tes Exec Id", "eurex.derivatives.eti.t7.v7.0.tesexecid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.tes_execution_broadcast = ProtoField.new("Tes Execution Broadcast", "eurex.derivatives.eti.t7.v7.0.tesexecutionbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tes_response = ProtoField.new("Tes Response", "eurex.derivatives.eti.t7.v7.0.tesresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tes_trade_broadcast = ProtoField.new("Tes Trade Broadcast", "eurex.derivatives.eti.t7.v7.0.testradebroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tes_trading_session_status_broadcast = ProtoField.new("Tes Trading Session Status Broadcast", "eurex.derivatives.eti.t7.v7.0.testradingsessionstatusbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tes_upload_broadcast = ProtoField.new("Tes Upload Broadcast", "eurex.derivatives.eti.t7.v7.0.tesuploadbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.throttle_disconnect_limit = ProtoField.new("Throttle Disconnect Limit", "eurex.derivatives.eti.t7.v7.0.throttledisconnectlimit", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.throttle_no_msgs = ProtoField.new("Throttle No Msgs", "eurex.derivatives.eti.t7.v7.0.throttlenomsgs", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.throttle_time_interval = ProtoField.new("Throttle Time Interval", "eurex.derivatives.eti.t7.v7.0.throttletimeinterval", ftypes.INT64)
eurex_derivatives_eti_t7_v7_0.fields.throttle_update_notification = ProtoField.new("Throttle Update Notification", "eurex.derivatives.eti.t7.v7.0.throttleupdatenotification", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.time_in_force = ProtoField.new("Time In Force", "eurex.derivatives.eti.t7.v7.0.timeinforce", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.tm_trading_session_status_broadcast = ProtoField.new("Tm Trading Session Status Broadcast", "eurex.derivatives.eti.t7.v7.0.tmtradingsessionstatusbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.tot_num_trade_reports = ProtoField.new("Tot Num Trade Reports", "eurex.derivatives.eti.t7.v7.0.totnumtradereports", ftypes.INT32)
eurex_derivatives_eti_t7_v7_0.fields.trad_ses_event = ProtoField.new("Trad Ses Event", "eurex.derivatives.eti.t7.v7.0.tradsesevent", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trad_ses_mode = ProtoField.new("Trad Ses Mode", "eurex.derivatives.eti.t7.v7.0.tradsesmode", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trade_alloc_status = ProtoField.new("Trade Alloc Status", "eurex.derivatives.eti.t7.v7.0.tradeallocstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trade_broadcast = ProtoField.new("Trade Broadcast", "eurex.derivatives.eti.t7.v7.0.tradebroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.trade_date = ProtoField.new("Trade Date", "eurex.derivatives.eti.t7.v7.0.tradedate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.trade_id = ProtoField.new("Trade Id", "eurex.derivatives.eti.t7.v7.0.tradeid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.trade_manager_status = ProtoField.new("Trade Manager Status", "eurex.derivatives.eti.t7.v7.0.trademanagerstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trade_manager_trade_date = ProtoField.new("Trade Manager Trade Date", "eurex.derivatives.eti.t7.v7.0.trademanagertradedate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.trade_platform = ProtoField.new("Trade Platform", "eurex.derivatives.eti.t7.v7.0.tradeplatform", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trade_publish_indicator = ProtoField.new("Trade Publish Indicator", "eurex.derivatives.eti.t7.v7.0.tradepublishindicator", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trade_report_id = ProtoField.new("Trade Report Id", "eurex.derivatives.eti.t7.v7.0.tradereportid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.trade_report_text = ProtoField.new("Trade Report Text", "eurex.derivatives.eti.t7.v7.0.tradereporttext", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.trade_report_type = ProtoField.new("Trade Report Type", "eurex.derivatives.eti.t7.v7.0.tradereporttype", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trade_underlying = ProtoField.new("Trade Underlying", "eurex.derivatives.eti.t7.v7.0.tradeunderlying", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trading_capacity = ProtoField.new("Trading Capacity", "eurex.derivatives.eti.t7.v7.0.tradingcapacity", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trading_session_status_broadcast = ProtoField.new("Trading Session Status Broadcast", "eurex.derivatives.eti.t7.v7.0.tradingsessionstatusbroadcast", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.trading_session_sub_id = ProtoField.new("Trading Session Sub Id", "eurex.derivatives.eti.t7.v7.0.tradingsessionsubid", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trans_bkd_time = ProtoField.new("Trans Bkd Time", "eurex.derivatives.eti.t7.v7.0.transbkdtime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.transact_time = ProtoField.new("Transact Time", "eurex.derivatives.eti.t7.v7.0.transacttime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.transaction_delay_indicator = ProtoField.new("Transaction Delay Indicator", "eurex.derivatives.eti.t7.v7.0.transactiondelayindicator", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.transfer_reason = ProtoField.new("Transfer Reason", "eurex.derivatives.eti.t7.v7.0.transferreason", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trd_instrmnt_leg_grp_comp = ProtoField.new("Trd Instrmnt Leg Grp Comp", "eurex.derivatives.eti.t7.v7.0.trdinstrmntleggrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.trd_match_id = ProtoField.new("Trd Match Id", "eurex.derivatives.eti.t7.v7.0.trdmatchid", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_entry_time = ProtoField.new("Trd Reg Ts Entry Time", "eurex.derivatives.eti.t7.v7.0.trdregtsentrytime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_execution_time = ProtoField.new("Trd Reg Ts Execution Time", "eurex.derivatives.eti.t7.v7.0.trdregtsexecutiontime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_time_in = ProtoField.new("Trd Reg Ts Time In", "eurex.derivatives.eti.t7.v7.0.trdregtstimein", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_time_out = ProtoField.new("Trd Reg Ts Time Out", "eurex.derivatives.eti.t7.v7.0.trdregtstimeout", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_time_priority = ProtoField.new("Trd Reg Ts Time Priority", "eurex.derivatives.eti.t7.v7.0.trdregtstimepriority", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.trd_rpt_status = ProtoField.new("Trd Rpt Status", "eurex.derivatives.eti.t7.v7.0.trdrptstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.trd_type = ProtoField.new("Trd Type", "eurex.derivatives.eti.t7.v7.0.trdtype", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.triggered = ProtoField.new("Triggered", "eurex.derivatives.eti.t7.v7.0.triggered", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.underlying_currency = ProtoField.new("Underlying Currency", "eurex.derivatives.eti.t7.v7.0.underlyingcurrency", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.underlying_delta_percentage = ProtoField.new("Underlying Delta Percentage", "eurex.derivatives.eti.t7.v7.0.underlyingdeltapercentage", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.underlying_effective_delta_percentage = ProtoField.new("Underlying Effective Delta Percentage", "eurex.derivatives.eti.t7.v7.0.underlyingeffectivedeltapercentage", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.underlying_issuer = ProtoField.new("Underlying Issuer", "eurex.derivatives.eti.t7.v7.0.underlyingissuer", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.underlying_maturity_date = ProtoField.new("Underlying Maturity Date", "eurex.derivatives.eti.t7.v7.0.underlyingmaturitydate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.underlying_price_stip_value = ProtoField.new("Underlying Price Stip Value", "eurex.derivatives.eti.t7.v7.0.underlyingpricestipvalue", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.underlying_px = ProtoField.new("Underlying Px", "eurex.derivatives.eti.t7.v7.0.underlyingpx", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.underlying_qty = ProtoField.new("Underlying Qty", "eurex.derivatives.eti.t7.v7.0.underlyingqty", ftypes.DOUBLE)
eurex_derivatives_eti_t7_v7_0.fields.underlying_security_desc = ProtoField.new("Underlying Security Desc", "eurex.derivatives.eti.t7.v7.0.underlyingsecuritydesc", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.underlying_security_id = ProtoField.new("Underlying Security Id", "eurex.derivatives.eti.t7.v7.0.underlyingsecurityid", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.underlying_settlement_date = ProtoField.new("Underlying Settlement Date", "eurex.derivatives.eti.t7.v7.0.underlyingsettlementdate", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.underlying_stip_grp_comp = ProtoField.new("Underlying Stip Grp Comp", "eurex.derivatives.eti.t7.v7.0.underlyingstipgrpcomp", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.underlying_stip_type = ProtoField.new("Underlying Stip Type", "eurex.derivatives.eti.t7.v7.0.underlyingstiptype", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.underlying_stip_value = ProtoField.new("Underlying Stip Value", "eurex.derivatives.eti.t7.v7.0.underlyingstipvalue", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.unsubscribe_request = ProtoField.new("Unsubscribe Request", "eurex.derivatives.eti.t7.v7.0.unsubscriberequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.unsubscribe_response = ProtoField.new("Unsubscribe Response", "eurex.derivatives.eti.t7.v7.0.unsubscriberesponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.upload_tes_trade_request = ProtoField.new("Upload Tes Trade Request", "eurex.derivatives.eti.t7.v7.0.uploadtestraderequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.user_login_request = ProtoField.new("User Login Request", "eurex.derivatives.eti.t7.v7.0.userloginrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.user_login_response = ProtoField.new("User Login Response", "eurex.derivatives.eti.t7.v7.0.userloginresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.user_logout_request = ProtoField.new("User Logout Request", "eurex.derivatives.eti.t7.v7.0.userlogoutrequest", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.user_logout_response = ProtoField.new("User Logout Response", "eurex.derivatives.eti.t7.v7.0.userlogoutresponse", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.user_status = ProtoField.new("User Status", "eurex.derivatives.eti.t7.v7.0.userstatus", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.username = ProtoField.new("Username", "eurex.derivatives.eti.t7.v7.0.username", ftypes.UINT32)
eurex_derivatives_eti_t7_v7_0.fields.valid_until_time = ProtoField.new("Valid Until Time", "eurex.derivatives.eti.t7.v7.0.validuntiltime", ftypes.UINT64)
eurex_derivatives_eti_t7_v7_0.fields.value_check_type_quantity = ProtoField.new("Value Check Type Quantity", "eurex.derivatives.eti.t7.v7.0.valuechecktypequantity", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.value_check_type_value = ProtoField.new("Value Check Type Value", "eurex.derivatives.eti.t7.v7.0.valuechecktypevalue", ftypes.UINT8)
eurex_derivatives_eti_t7_v7_0.fields.var_text = ProtoField.new("Var Text", "eurex.derivatives.eti.t7.v7.0.vartext", ftypes.STRING)
eurex_derivatives_eti_t7_v7_0.fields.var_text_len = ProtoField.new("Var Text Len", "eurex.derivatives.eti.t7.v7.0.vartextlen", ftypes.UINT16)
eurex_derivatives_eti_t7_v7_0.fields.vega = ProtoField.new("Vega", "eurex.derivatives.eti.t7.v7.0.vega", ftypes.DOUBLE)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Eurex Derivatives Eti T7 7.0 Element Dissection Options
...
-- Register Eurex Derivatives Eti T7 7.0 Show Options
eurex_derivatives_eti_t7_v7_0.prefs.show_add_complex_instrument_request = Pref.bool("Show Add Complex Instrument Request", show.add_complex_instrument_request, "Parse and add Add Complex Instrument Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_add_complex_instrument_response = Pref.bool("Show Add Complex Instrument Response", show.add_complex_instrument_response, "Parse and add Add Complex Instrument Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_add_flexible_instrument_request = Pref.bool("Show Add Flexible Instrument Request", show.add_flexible_instrument_request, "Parse and add Add Flexible Instrument Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_add_flexible_instrument_response = Pref.bool("Show Add Flexible Instrument Response", show.add_flexible_instrument_response, "Parse and add Add Flexible Instrument Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_affected_order_requests_grp_comp = Pref.bool("Show Affected Order Requests Grp Comp", show.affected_order_requests_grp_comp, "Parse and add Affected Order Requests Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_approve_tes_trade_request = Pref.bool("Show Approve Tes Trade Request", show.approve_tes_trade_request, "Parse and add Approve Tes Trade Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_broadcast_error_notification = Pref.bool("Show Broadcast Error Notification", show.broadcast_error_notification, "Parse and add Broadcast Error Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_clip_deletion_notification = Pref.bool("Show Clip Deletion Notification", show.clip_deletion_notification, "Parse and add Clip Deletion Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_clip_execution_notification = Pref.bool("Show Clip Execution Notification", show.clip_execution_notification, "Parse and add Clip Execution Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_clip_response = Pref.bool("Show Clip Response", show.clip_response, "Parse and add Clip Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request = Pref.bool("Show Cross Request", show.cross_request, "Parse and add Cross Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_ack_side_grp_comp = Pref.bool("Show Cross Request Ack Side Grp Comp", show.cross_request_ack_side_grp_comp, "Parse and add Cross Request Ack Side Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_response = Pref.bool("Show Cross Request Response", show.cross_request_response, "Parse and add Cross Request Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_side_grp_comp = Pref.bool("Show Cross Request Side Grp Comp", show.cross_request_side_grp_comp, "Parse and add Cross Request Side Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_broadcast = Pref.bool("Show Delete All Order Broadcast", show.delete_all_order_broadcast, "Parse and add Delete All Order Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_nr_response = Pref.bool("Show Delete All Order Nr Response", show.delete_all_order_nr_response, "Parse and add Delete All Order Nr Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_quote_event_broadcast = Pref.bool("Show Delete All Order Quote Event Broadcast", show.delete_all_order_quote_event_broadcast, "Parse and add Delete All Order Quote Event Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_request = Pref.bool("Show Delete All Order Request", show.delete_all_order_request, "Parse and add Delete All Order Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_response = Pref.bool("Show Delete All Order Response", show.delete_all_order_response, "Parse and add Delete All Order Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_broadcast = Pref.bool("Show Delete All Quote Broadcast", show.delete_all_quote_broadcast, "Parse and add Delete All Quote Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_request = Pref.bool("Show Delete All Quote Request", show.delete_all_quote_request, "Parse and add Delete All Quote Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_response = Pref.bool("Show Delete All Quote Response", show.delete_all_quote_response, "Parse and add Delete All Quote Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_clip_request = Pref.bool("Show Delete Clip Request", show.delete_clip_request, "Parse and add Delete Clip Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_broadcast = Pref.bool("Show Delete Order Broadcast", show.delete_order_broadcast, "Parse and add Delete Order Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_complex_request = Pref.bool("Show Delete Order Complex Request", show.delete_order_complex_request, "Parse and add Delete Order Complex Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_nr_response = Pref.bool("Show Delete Order Nr Response", show.delete_order_nr_response, "Parse and add Delete Order Nr Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_response = Pref.bool("Show Delete Order Response", show.delete_order_response, "Parse and add Delete Order Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_single_request = Pref.bool("Show Delete Order Single Request", show.delete_order_single_request, "Parse and add Delete Order Single Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_delete_tes_trade_request = Pref.bool("Show Delete Tes Trade Request", show.delete_tes_trade_request, "Parse and add Delete Tes Trade Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_enrichment_rules_grp_comp = Pref.bool("Show Enrichment Rules Grp Comp", show.enrichment_rules_grp_comp, "Parse and add Enrichment Rules Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_enter_clip_request = Pref.bool("Show Enter Clip Request", show.enter_clip_request, "Parse and add Enter Clip Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_enter_tes_trade_request = Pref.bool("Show Enter Tes Trade Request", show.enter_tes_trade_request, "Parse and add Enter Tes Trade Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_fills_grp_comp = Pref.bool("Show Fills Grp Comp", show.fills_grp_comp, "Parse and add Fills Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_forced_logout_notification = Pref.bool("Show Forced Logout Notification", show.forced_logout_notification, "Parse and add Forced Logout Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_forced_user_logout_notification = Pref.bool("Show Forced User Logout Notification", show.forced_user_logout_notification, "Parse and add Forced User Logout Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_gateway_request = Pref.bool("Show Gateway Request", show.gateway_request, "Parse and add Gateway Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_heartbeat = Pref.bool("Show Heartbeat", show.heartbeat, "Parse and add Heartbeat to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_heartbeat_notification = Pref.bool("Show Heartbeat Notification", show.heartbeat_notification, "Parse and add Heartbeat Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_enrichment_rule_id_list_request = Pref.bool("Show Inquire Enrichment Rule Id List Request", show.inquire_enrichment_rule_id_list_request, "Parse and add Inquire Enrichment Rule Id List Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_enrichment_rule_id_list_response = Pref.bool("Show Inquire Enrichment Rule Id List Response", show.inquire_enrichment_rule_id_list_response, "Parse and add Inquire Enrichment Rule Id List Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_mm_parameter_request = Pref.bool("Show Inquire Mm Parameter Request", show.inquire_mm_parameter_request, "Parse and add Inquire Mm Parameter Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_mm_parameter_response = Pref.bool("Show Inquire Mm Parameter Response", show.inquire_mm_parameter_response, "Parse and add Inquire Mm Parameter Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_pre_trade_risk_limits_request = Pref.bool("Show Inquire Pre Trade Risk Limits Request", show.inquire_pre_trade_risk_limits_request, "Parse and add Inquire Pre Trade Risk Limits Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_session_list_request = Pref.bool("Show Inquire Session List Request", show.inquire_session_list_request, "Parse and add Inquire Session List Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_session_list_response = Pref.bool("Show Inquire Session List Response", show.inquire_session_list_response, "Parse and add Inquire Session List Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_user_request = Pref.bool("Show Inquire User Request", show.inquire_user_request, "Parse and add Inquire User Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_user_response = Pref.bool("Show Inquire User Response", show.inquire_user_response, "Parse and add Inquire User Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_instrmnt_leg_exec_grp_comp = Pref.bool("Show Instrmnt Leg Exec Grp Comp", show.instrmnt_leg_exec_grp_comp, "Parse and add Instrmnt Leg Exec Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_instrmt_leg_grp_comp = Pref.bool("Show Instrmt Leg Grp Comp", show.instrmt_leg_grp_comp, "Parse and add Instrmt Leg Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_instrument_attribute_grp_comp = Pref.bool("Show Instrument Attribute Grp Comp", show.instrument_attribute_grp_comp, "Parse and add Instrument Attribute Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_instrument_event_grp_comp = Pref.bool("Show Instrument Event Grp Comp", show.instrument_event_grp_comp, "Parse and add Instrument Event Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_leg_ord_grp_comp = Pref.bool("Show Leg Ord Grp Comp", show.leg_ord_grp_comp, "Parse and add Leg Ord Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_legal_notification_broadcast = Pref.bool("Show Legal Notification Broadcast", show.legal_notification_broadcast, "Parse and add Legal Notification Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_logon_request = Pref.bool("Show Logon Request", show.logon_request, "Parse and add Logon Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_logon_response = Pref.bool("Show Logon Response", show.logon_response, "Parse and add Logon Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_logout_request = Pref.bool("Show Logout Request", show.logout_request, "Parse and add Logout Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_logout_response = Pref.bool("Show Logout Response", show.logout_response, "Parse and add Logout Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_mass_quote_request = Pref.bool("Show Mass Quote Request", show.mass_quote_request, "Parse and add Mass Quote Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_mass_quote_response = Pref.bool("Show Mass Quote Response", show.mass_quote_response, "Parse and add Mass Quote Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_message_header_in_comp = Pref.bool("Show Message Header In Comp", show.message_header_in_comp, "Parse and add Message Header In Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_message_header_out_comp = Pref.bool("Show Message Header Out Comp", show.message_header_out_comp, "Parse and add Message Header Out Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_definition_request = Pref.bool("Show Mm Parameter Definition Request", show.mm_parameter_definition_request, "Parse and add Mm Parameter Definition Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_definition_response = Pref.bool("Show Mm Parameter Definition Response", show.mm_parameter_definition_response, "Parse and add Mm Parameter Definition Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_grp_comp = Pref.bool("Show Mm Parameter Grp Comp", show.mm_parameter_grp_comp, "Parse and add Mm Parameter Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_complex_request = Pref.bool("Show Modify Order Complex Request", show.modify_order_complex_request, "Parse and add Modify Order Complex Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_complex_short_request = Pref.bool("Show Modify Order Complex Short Request", show.modify_order_complex_short_request, "Parse and add Modify Order Complex Short Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_nr_response = Pref.bool("Show Modify Order Nr Response", show.modify_order_nr_response, "Parse and add Modify Order Nr Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_response = Pref.bool("Show Modify Order Response", show.modify_order_response, "Parse and add Modify Order Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_single_request = Pref.bool("Show Modify Order Single Request", show.modify_order_single_request, "Parse and add Modify Order Single Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_single_short_request = Pref.bool("Show Modify Order Single Short Request", show.modify_order_single_short_request, "Parse and add Modify Order Single Short Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_modify_tes_trade_request = Pref.bool("Show Modify Tes Trade Request", show.modify_tes_trade_request, "Parse and add Modify Tes Trade Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_complex_request = Pref.bool("Show New Order Complex Request", show.new_order_complex_request, "Parse and add New Order Complex Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_complex_short_request = Pref.bool("Show New Order Complex Short Request", show.new_order_complex_short_request, "Parse and add New Order Complex Short Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_nr_response = Pref.bool("Show New Order Nr Response", show.new_order_nr_response, "Parse and add New Order Nr Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_response = Pref.bool("Show New Order Response", show.new_order_response, "Parse and add New Order Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_single_request = Pref.bool("Show New Order Single Request", show.new_order_single_request, "Parse and add New Order Single Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_single_short_request = Pref.bool("Show New Order Single Short Request", show.new_order_single_short_request, "Parse and add New Order Single Short Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_news_broadcast = Pref.bool("Show News Broadcast", show.news_broadcast, "Parse and add News Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_not_affected_orders_grp_comp = Pref.bool("Show Not Affected Orders Grp Comp", show.not_affected_orders_grp_comp, "Parse and add Not Affected Orders Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_not_affected_securities_grp_comp = Pref.bool("Show Not Affected Securities Grp Comp", show.not_affected_securities_grp_comp, "Parse and add Not Affected Securities Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_notif_header_comp = Pref.bool("Show Notif Header Comp", show.notif_header_comp, "Parse and add Notif Header Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_nr_response_header_me_comp = Pref.bool("Show Nr Response Header Me Comp", show.nr_response_header_me_comp, "Parse and add Nr Response Header Me Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_nrbc_header_comp = Pref.bool("Show Nrbc Header Comp", show.nrbc_header_comp, "Parse and add Nrbc Header Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_order_book_item_grp_comp = Pref.bool("Show Order Book Item Grp Comp", show.order_book_item_grp_comp, "Parse and add Order Book Item Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_notification = Pref.bool("Show Order Exec Notification", show.order_exec_notification, "Parse and add Order Exec Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_report_broadcast = Pref.bool("Show Order Exec Report Broadcast", show.order_exec_report_broadcast, "Parse and add Order Exec Report Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_response = Pref.bool("Show Order Exec Response", show.order_exec_response, "Parse and add Order Exec Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_party_action_report = Pref.bool("Show Party Action Report", show.party_action_report, "Parse and add Party Action Report to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_party_details_grp_comp = Pref.bool("Show Party Details Grp Comp", show.party_details_grp_comp, "Parse and add Party Details Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_party_entitlements_update_report = Pref.bool("Show Party Entitlements Update Report", show.party_entitlements_update_report, "Parse and add Party Entitlements Update Report to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_pre_trade_risk_limit_response = Pref.bool("Show Pre Trade Risk Limit Response", show.pre_trade_risk_limit_response, "Parse and add Pre Trade Risk Limit Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_pre_trade_risk_limits_definition_request = Pref.bool("Show Pre Trade Risk Limits Definition Request", show.pre_trade_risk_limits_definition_request, "Parse and add Pre Trade Risk Limits Definition Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quot_req_legs_grp_comp = Pref.bool("Show Quot Req Legs Grp Comp", show.quot_req_legs_grp_comp, "Parse and add Quot Req Legs Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_notification = Pref.bool("Show Quote Activation Notification", show.quote_activation_notification, "Parse and add Quote Activation Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_request = Pref.bool("Show Quote Activation Request", show.quote_activation_request, "Parse and add Quote Activation Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_response = Pref.bool("Show Quote Activation Response", show.quote_activation_response, "Parse and add Quote Activation Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_entry_ack_grp_comp = Pref.bool("Show Quote Entry Ack Grp Comp", show.quote_entry_ack_grp_comp, "Parse and add Quote Entry Ack Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_entry_grp_comp = Pref.bool("Show Quote Entry Grp Comp", show.quote_entry_grp_comp, "Parse and add Quote Entry Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_event_grp_comp = Pref.bool("Show Quote Event Grp Comp", show.quote_event_grp_comp, "Parse and add Quote Event Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_execution_report = Pref.bool("Show Quote Execution Report", show.quote_execution_report, "Parse and add Quote Execution Report to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_quote_leg_exec_grp_comp = Pref.bool("Show Quote Leg Exec Grp Comp", show.quote_leg_exec_grp_comp, "Parse and add Quote Leg Exec Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_rbc_header_comp = Pref.bool("Show Rbc Header Comp", show.rbc_header_comp, "Parse and add Rbc Header Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_rbc_header_me_comp = Pref.bool("Show Rbc Header Me Comp", show.rbc_header_me_comp, "Parse and add Rbc Header Me Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_reject = Pref.bool("Show Reject", show.reject, "Parse and add Reject to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_request_header_comp = Pref.bool("Show Request Header Comp", show.request_header_comp, "Parse and add Request Header Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_response_header_comp = Pref.bool("Show Response Header Comp", show.response_header_comp, "Parse and add Response Header Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_response_header_me_comp = Pref.bool("Show Response Header Me Comp", show.response_header_me_comp, "Parse and add Response Header Me Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_me_message_request = Pref.bool("Show Retransmit Me Message Request", show.retransmit_me_message_request, "Parse and add Retransmit Me Message Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_me_message_response = Pref.bool("Show Retransmit Me Message Response", show.retransmit_me_message_response, "Parse and add Retransmit Me Message Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_request = Pref.bool("Show Retransmit Request", show.retransmit_request, "Parse and add Retransmit Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_response = Pref.bool("Show Retransmit Response", show.retransmit_response, "Parse and add Retransmit Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_rfq_request = Pref.bool("Show Rfq Request", show.rfq_request, "Parse and add Rfq Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_rfq_response = Pref.bool("Show Rfq Response", show.rfq_response, "Parse and add Rfq Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_risk_limit_qty_grp_comp = Pref.bool("Show Risk Limit Qty Grp Comp", show.risk_limit_qty_grp_comp, "Parse and add Risk Limit Qty Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_risk_limits_rpt_grp_comp = Pref.bool("Show Risk Limits Rpt Grp Comp", show.risk_limits_rpt_grp_comp, "Parse and add Risk Limits Rpt Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_risk_notification_broadcast = Pref.bool("Show Risk Notification Broadcast", show.risk_notification_broadcast, "Parse and add Risk Notification Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_service_availability_broadcast = Pref.bool("Show Service Availability Broadcast", show.service_availability_broadcast, "Parse and add Service Availability Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_service_availability_market_broadcast = Pref.bool("Show Service Availability Market Broadcast", show.service_availability_market_broadcast, "Parse and add Service Availability Market Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_sessions_grp_comp = Pref.bool("Show Sessions Grp Comp", show.sessions_grp_comp, "Parse and add Sessions Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_ext_grp_comp = Pref.bool("Show Side Alloc Ext Grp Comp", show.side_alloc_ext_grp_comp, "Parse and add Side Alloc Ext Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_grp_bc_comp = Pref.bool("Show Side Alloc Grp Bc Comp", show.side_alloc_grp_bc_comp, "Parse and add Side Alloc Grp Bc Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_grp_comp = Pref.bool("Show Side Alloc Grp Comp", show.side_alloc_grp_comp, "Parse and add Side Alloc Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_side_cross_leg_grp_comp = Pref.bool("Show Side Cross Leg Grp Comp", show.side_cross_leg_grp_comp, "Parse and add Side Cross Leg Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_create_deal_notification = Pref.bool("Show Srqs Create Deal Notification", show.srqs_create_deal_notification, "Parse and add Srqs Create Deal Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_deal_notification = Pref.bool("Show Srqs Deal Notification", show.srqs_deal_notification, "Parse and add Srqs Deal Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_deal_response = Pref.bool("Show Srqs Deal Response", show.srqs_deal_response, "Parse and add Srqs Deal Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_enter_quote_request = Pref.bool("Show Srqs Enter Quote Request", show.srqs_enter_quote_request, "Parse and add Srqs Enter Quote Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_hit_quote_request = Pref.bool("Show Srqs Hit Quote Request", show.srqs_hit_quote_request, "Parse and add Srqs Hit Quote Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_notification = Pref.bool("Show Srqs Negotiation Notification", show.srqs_negotiation_notification, "Parse and add Srqs Negotiation Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_requester_notification = Pref.bool("Show Srqs Negotiation Requester Notification", show.srqs_negotiation_requester_notification, "Parse and add Srqs Negotiation Requester Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_status_notification = Pref.bool("Show Srqs Negotiation Status Notification", show.srqs_negotiation_status_notification, "Parse and add Srqs Negotiation Status Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_notification = Pref.bool("Show Srqs Open Negotiation Notification", show.srqs_open_negotiation_notification, "Parse and add Srqs Open Negotiation Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_request = Pref.bool("Show Srqs Open Negotiation Request", show.srqs_open_negotiation_request, "Parse and add Srqs Open Negotiation Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_requester_notification = Pref.bool("Show Srqs Open Negotiation Requester Notification", show.srqs_open_negotiation_requester_notification, "Parse and add Srqs Open Negotiation Requester Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_quote_notification = Pref.bool("Show Srqs Quote Notification", show.srqs_quote_notification, "Parse and add Srqs Quote Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_quote_response = Pref.bool("Show Srqs Quote Response", show.srqs_quote_response, "Parse and add Srqs Quote Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_status_broadcast = Pref.bool("Show Srqs Status Broadcast", show.srqs_status_broadcast, "Parse and add Srqs Status Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_update_deal_status_request = Pref.bool("Show Srqs Update Deal Status Request", show.srqs_update_deal_status_request, "Parse and add Srqs Update Deal Status Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_update_negotiation_request = Pref.bool("Show Srqs Update Negotiation Request", show.srqs_update_negotiation_request, "Parse and add Srqs Update Negotiation Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_subscribe_request = Pref.bool("Show Subscribe Request", show.subscribe_request, "Parse and add Subscribe Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_subscribe_response = Pref.bool("Show Subscribe Response", show.subscribe_response, "Parse and add Subscribe Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_target_parties_comp = Pref.bool("Show Target Parties Comp", show.target_parties_comp, "Parse and add Target Parties Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_approve_broadcast = Pref.bool("Show Tes Approve Broadcast", show.tes_approve_broadcast, "Parse and add Tes Approve Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_broadcast = Pref.bool("Show Tes Broadcast", show.tes_broadcast, "Parse and add Tes Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_delete_broadcast = Pref.bool("Show Tes Delete Broadcast", show.tes_delete_broadcast, "Parse and add Tes Delete Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_execution_broadcast = Pref.bool("Show Tes Execution Broadcast", show.tes_execution_broadcast, "Parse and add Tes Execution Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_response = Pref.bool("Show Tes Response", show.tes_response, "Parse and add Tes Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_trade_broadcast = Pref.bool("Show Tes Trade Broadcast", show.tes_trade_broadcast, "Parse and add Tes Trade Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_trading_session_status_broadcast = Pref.bool("Show Tes Trading Session Status Broadcast", show.tes_trading_session_status_broadcast, "Parse and add Tes Trading Session Status Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tes_upload_broadcast = Pref.bool("Show Tes Upload Broadcast", show.tes_upload_broadcast, "Parse and add Tes Upload Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_throttle_update_notification = Pref.bool("Show Throttle Update Notification", show.throttle_update_notification, "Parse and add Throttle Update Notification to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_tm_trading_session_status_broadcast = Pref.bool("Show Tm Trading Session Status Broadcast", show.tm_trading_session_status_broadcast, "Parse and add Tm Trading Session Status Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_trade_broadcast = Pref.bool("Show Trade Broadcast", show.trade_broadcast, "Parse and add Trade Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_trading_session_status_broadcast = Pref.bool("Show Trading Session Status Broadcast", show.trading_session_status_broadcast, "Parse and add Trading Session Status Broadcast to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_trd_instrmnt_leg_grp_comp = Pref.bool("Show Trd Instrmnt Leg Grp Comp", show.trd_instrmnt_leg_grp_comp, "Parse and add Trd Instrmnt Leg Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_underlying_stip_grp_comp = Pref.bool("Show Underlying Stip Grp Comp", show.underlying_stip_grp_comp, "Parse and add Underlying Stip Grp Comp to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_unsubscribe_request = Pref.bool("Show Unsubscribe Request", show.unsubscribe_request, "Parse and add Unsubscribe Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_unsubscribe_response = Pref.bool("Show Unsubscribe Response", show.unsubscribe_response, "Parse and add Unsubscribe Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_upload_tes_trade_request = Pref.bool("Show Upload Tes Trade Request", show.upload_tes_trade_request, "Parse and add Upload Tes Trade Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_user_login_request = Pref.bool("Show User Login Request", show.user_login_request, "Parse and add User Login Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_user_login_response = Pref.bool("Show User Login Response", show.user_login_response, "Parse and add User Login Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_user_logout_request = Pref.bool("Show User Logout Request", show.user_logout_request, "Parse and add User Logout Request to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_user_logout_response = Pref.bool("Show User Logout Response", show.user_logout_response, "Parse and add User Logout Response to protocol tree")
eurex_derivatives_eti_t7_v7_0.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")

-- Handle changed preferences
function eurex_derivatives_eti_t7_v7_0.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.add_complex_instrument_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_add_complex_instrument_request then
    show.add_complex_instrument_request = eurex_derivatives_eti_t7_v7_0.prefs.show_add_complex_instrument_request
    changed = true
  end
  if show.add_complex_instrument_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_add_complex_instrument_response then
    show.add_complex_instrument_response = eurex_derivatives_eti_t7_v7_0.prefs.show_add_complex_instrument_response
    changed = true
  end
  if show.add_flexible_instrument_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_add_flexible_instrument_request then
    show.add_flexible_instrument_request = eurex_derivatives_eti_t7_v7_0.prefs.show_add_flexible_instrument_request
    changed = true
  end
  if show.add_flexible_instrument_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_add_flexible_instrument_response then
    show.add_flexible_instrument_response = eurex_derivatives_eti_t7_v7_0.prefs.show_add_flexible_instrument_response
    changed = true
  end
  if show.affected_order_requests_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_affected_order_requests_grp_comp then
    show.affected_order_requests_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_affected_order_requests_grp_comp
    changed = true
  end
  if show.approve_tes_trade_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_approve_tes_trade_request then
    show.approve_tes_trade_request = eurex_derivatives_eti_t7_v7_0.prefs.show_approve_tes_trade_request
    changed = true
  end
  if show.broadcast_error_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_broadcast_error_notification then
    show.broadcast_error_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_broadcast_error_notification
    changed = true
  end
  if show.clip_deletion_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_clip_deletion_notification then
    show.clip_deletion_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_clip_deletion_notification
    changed = true
  end
  if show.clip_execution_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_clip_execution_notification then
    show.clip_execution_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_clip_execution_notification
    changed = true
  end
  if show.clip_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_clip_response then
    show.clip_response = eurex_derivatives_eti_t7_v7_0.prefs.show_clip_response
    changed = true
  end
  if show.cross_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request then
    show.cross_request = eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request
    changed = true
  end
  if show.cross_request_ack_side_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_ack_side_grp_comp then
    show.cross_request_ack_side_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_ack_side_grp_comp
    changed = true
  end
  if show.cross_request_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_response then
    show.cross_request_response = eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_response
    changed = true
  end
  if show.cross_request_side_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_side_grp_comp then
    show.cross_request_side_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_cross_request_side_grp_comp
    changed = true
  end
  if show.delete_all_order_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_broadcast then
    show.delete_all_order_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_broadcast
    changed = true
  end
  if show.delete_all_order_nr_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_nr_response then
    show.delete_all_order_nr_response = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_nr_response
    changed = true
  end
  if show.delete_all_order_quote_event_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_quote_event_broadcast then
    show.delete_all_order_quote_event_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_quote_event_broadcast
    changed = true
  end
  if show.delete_all_order_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_request then
    show.delete_all_order_request = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_request
    changed = true
  end
  if show.delete_all_order_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_response then
    show.delete_all_order_response = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_order_response
    changed = true
  end
  if show.delete_all_quote_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_broadcast then
    show.delete_all_quote_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_broadcast
    changed = true
  end
  if show.delete_all_quote_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_request then
    show.delete_all_quote_request = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_request
    changed = true
  end
  if show.delete_all_quote_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_response then
    show.delete_all_quote_response = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_all_quote_response
    changed = true
  end
  if show.delete_clip_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_clip_request then
    show.delete_clip_request = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_clip_request
    changed = true
  end
  if show.delete_order_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_broadcast then
    show.delete_order_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_broadcast
    changed = true
  end
  if show.delete_order_complex_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_complex_request then
    show.delete_order_complex_request = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_complex_request
    changed = true
  end
  if show.delete_order_nr_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_nr_response then
    show.delete_order_nr_response = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_nr_response
    changed = true
  end
  if show.delete_order_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_response then
    show.delete_order_response = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_response
    changed = true
  end
  if show.delete_order_single_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_single_request then
    show.delete_order_single_request = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_order_single_request
    changed = true
  end
  if show.delete_tes_trade_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_delete_tes_trade_request then
    show.delete_tes_trade_request = eurex_derivatives_eti_t7_v7_0.prefs.show_delete_tes_trade_request
    changed = true
  end
  if show.enrichment_rules_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_enrichment_rules_grp_comp then
    show.enrichment_rules_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_enrichment_rules_grp_comp
    changed = true
  end
  if show.enter_clip_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_enter_clip_request then
    show.enter_clip_request = eurex_derivatives_eti_t7_v7_0.prefs.show_enter_clip_request
    changed = true
  end
  if show.enter_tes_trade_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_enter_tes_trade_request then
    show.enter_tes_trade_request = eurex_derivatives_eti_t7_v7_0.prefs.show_enter_tes_trade_request
    changed = true
  end
  if show.fills_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_fills_grp_comp then
    show.fills_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_fills_grp_comp
    changed = true
  end
  if show.forced_logout_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_forced_logout_notification then
    show.forced_logout_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_forced_logout_notification
    changed = true
  end
  if show.forced_user_logout_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_forced_user_logout_notification then
    show.forced_user_logout_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_forced_user_logout_notification
    changed = true
  end
  if show.gateway_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_gateway_request then
    show.gateway_request = eurex_derivatives_eti_t7_v7_0.prefs.show_gateway_request
    changed = true
  end
  if show.heartbeat ~= eurex_derivatives_eti_t7_v7_0.prefs.show_heartbeat then
    show.heartbeat = eurex_derivatives_eti_t7_v7_0.prefs.show_heartbeat
    changed = true
  end
  if show.heartbeat_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_heartbeat_notification then
    show.heartbeat_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_heartbeat_notification
    changed = true
  end
  if show.inquire_enrichment_rule_id_list_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_enrichment_rule_id_list_request then
    show.inquire_enrichment_rule_id_list_request = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_enrichment_rule_id_list_request
    changed = true
  end
  if show.inquire_enrichment_rule_id_list_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_enrichment_rule_id_list_response then
    show.inquire_enrichment_rule_id_list_response = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_enrichment_rule_id_list_response
    changed = true
  end
  if show.inquire_mm_parameter_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_mm_parameter_request then
    show.inquire_mm_parameter_request = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_mm_parameter_request
    changed = true
  end
  if show.inquire_mm_parameter_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_mm_parameter_response then
    show.inquire_mm_parameter_response = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_mm_parameter_response
    changed = true
  end
  if show.inquire_pre_trade_risk_limits_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_pre_trade_risk_limits_request then
    show.inquire_pre_trade_risk_limits_request = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_pre_trade_risk_limits_request
    changed = true
  end
  if show.inquire_session_list_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_session_list_request then
    show.inquire_session_list_request = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_session_list_request
    changed = true
  end
  if show.inquire_session_list_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_session_list_response then
    show.inquire_session_list_response = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_session_list_response
    changed = true
  end
  if show.inquire_user_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_user_request then
    show.inquire_user_request = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_user_request
    changed = true
  end
  if show.inquire_user_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_user_response then
    show.inquire_user_response = eurex_derivatives_eti_t7_v7_0.prefs.show_inquire_user_response
    changed = true
  end
  if show.instrmnt_leg_exec_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_instrmnt_leg_exec_grp_comp then
    show.instrmnt_leg_exec_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_instrmnt_leg_exec_grp_comp
    changed = true
  end
  if show.instrmt_leg_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_instrmt_leg_grp_comp then
    show.instrmt_leg_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_instrmt_leg_grp_comp
    changed = true
  end
  if show.instrument_attribute_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_instrument_attribute_grp_comp then
    show.instrument_attribute_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_instrument_attribute_grp_comp
    changed = true
  end
  if show.instrument_event_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_instrument_event_grp_comp then
    show.instrument_event_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_instrument_event_grp_comp
    changed = true
  end
  if show.leg_ord_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_leg_ord_grp_comp then
    show.leg_ord_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_leg_ord_grp_comp
    changed = true
  end
  if show.legal_notification_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_legal_notification_broadcast then
    show.legal_notification_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_legal_notification_broadcast
    changed = true
  end
  if show.logon_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_logon_request then
    show.logon_request = eurex_derivatives_eti_t7_v7_0.prefs.show_logon_request
    changed = true
  end
  if show.logon_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_logon_response then
    show.logon_response = eurex_derivatives_eti_t7_v7_0.prefs.show_logon_response
    changed = true
  end
  if show.logout_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_logout_request then
    show.logout_request = eurex_derivatives_eti_t7_v7_0.prefs.show_logout_request
    changed = true
  end
  if show.logout_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_logout_response then
    show.logout_response = eurex_derivatives_eti_t7_v7_0.prefs.show_logout_response
    changed = true
  end
  if show.mass_quote_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_mass_quote_request then
    show.mass_quote_request = eurex_derivatives_eti_t7_v7_0.prefs.show_mass_quote_request
    changed = true
  end
  if show.mass_quote_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_mass_quote_response then
    show.mass_quote_response = eurex_derivatives_eti_t7_v7_0.prefs.show_mass_quote_response
    changed = true
  end
  if show.message_header_in_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_message_header_in_comp then
    show.message_header_in_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_message_header_in_comp
    changed = true
  end
  if show.message_header_out_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_message_header_out_comp then
    show.message_header_out_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_message_header_out_comp
    changed = true
  end
  if show.mm_parameter_definition_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_definition_request then
    show.mm_parameter_definition_request = eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_definition_request
    changed = true
  end
  if show.mm_parameter_definition_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_definition_response then
    show.mm_parameter_definition_response = eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_definition_response
    changed = true
  end
  if show.mm_parameter_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_grp_comp then
    show.mm_parameter_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_mm_parameter_grp_comp
    changed = true
  end
  if show.modify_order_complex_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_complex_request then
    show.modify_order_complex_request = eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_complex_request
    changed = true
  end
  if show.modify_order_complex_short_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_complex_short_request then
    show.modify_order_complex_short_request = eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_complex_short_request
    changed = true
  end
  if show.modify_order_nr_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_nr_response then
    show.modify_order_nr_response = eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_nr_response
    changed = true
  end
  if show.modify_order_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_response then
    show.modify_order_response = eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_response
    changed = true
  end
  if show.modify_order_single_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_single_request then
    show.modify_order_single_request = eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_single_request
    changed = true
  end
  if show.modify_order_single_short_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_single_short_request then
    show.modify_order_single_short_request = eurex_derivatives_eti_t7_v7_0.prefs.show_modify_order_single_short_request
    changed = true
  end
  if show.modify_tes_trade_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_modify_tes_trade_request then
    show.modify_tes_trade_request = eurex_derivatives_eti_t7_v7_0.prefs.show_modify_tes_trade_request
    changed = true
  end
  if show.new_order_complex_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_complex_request then
    show.new_order_complex_request = eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_complex_request
    changed = true
  end
  if show.new_order_complex_short_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_complex_short_request then
    show.new_order_complex_short_request = eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_complex_short_request
    changed = true
  end
  if show.new_order_nr_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_nr_response then
    show.new_order_nr_response = eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_nr_response
    changed = true
  end
  if show.new_order_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_response then
    show.new_order_response = eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_response
    changed = true
  end
  if show.new_order_single_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_single_request then
    show.new_order_single_request = eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_single_request
    changed = true
  end
  if show.new_order_single_short_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_single_short_request then
    show.new_order_single_short_request = eurex_derivatives_eti_t7_v7_0.prefs.show_new_order_single_short_request
    changed = true
  end
  if show.news_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_news_broadcast then
    show.news_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_news_broadcast
    changed = true
  end
  if show.not_affected_orders_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_not_affected_orders_grp_comp then
    show.not_affected_orders_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_not_affected_orders_grp_comp
    changed = true
  end
  if show.not_affected_securities_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_not_affected_securities_grp_comp then
    show.not_affected_securities_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_not_affected_securities_grp_comp
    changed = true
  end
  if show.notif_header_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_notif_header_comp then
    show.notif_header_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_notif_header_comp
    changed = true
  end
  if show.nr_response_header_me_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_nr_response_header_me_comp then
    show.nr_response_header_me_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_nr_response_header_me_comp
    changed = true
  end
  if show.nrbc_header_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_nrbc_header_comp then
    show.nrbc_header_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_nrbc_header_comp
    changed = true
  end
  if show.order_book_item_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_order_book_item_grp_comp then
    show.order_book_item_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_order_book_item_grp_comp
    changed = true
  end
  if show.order_exec_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_notification then
    show.order_exec_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_notification
    changed = true
  end
  if show.order_exec_report_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_report_broadcast then
    show.order_exec_report_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_report_broadcast
    changed = true
  end
  if show.order_exec_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_response then
    show.order_exec_response = eurex_derivatives_eti_t7_v7_0.prefs.show_order_exec_response
    changed = true
  end
  if show.party_action_report ~= eurex_derivatives_eti_t7_v7_0.prefs.show_party_action_report then
    show.party_action_report = eurex_derivatives_eti_t7_v7_0.prefs.show_party_action_report
    changed = true
  end
  if show.party_details_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_party_details_grp_comp then
    show.party_details_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_party_details_grp_comp
    changed = true
  end
  if show.party_entitlements_update_report ~= eurex_derivatives_eti_t7_v7_0.prefs.show_party_entitlements_update_report then
    show.party_entitlements_update_report = eurex_derivatives_eti_t7_v7_0.prefs.show_party_entitlements_update_report
    changed = true
  end
  if show.pre_trade_risk_limit_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_pre_trade_risk_limit_response then
    show.pre_trade_risk_limit_response = eurex_derivatives_eti_t7_v7_0.prefs.show_pre_trade_risk_limit_response
    changed = true
  end
  if show.pre_trade_risk_limits_definition_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_pre_trade_risk_limits_definition_request then
    show.pre_trade_risk_limits_definition_request = eurex_derivatives_eti_t7_v7_0.prefs.show_pre_trade_risk_limits_definition_request
    changed = true
  end
  if show.quot_req_legs_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quot_req_legs_grp_comp then
    show.quot_req_legs_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_quot_req_legs_grp_comp
    changed = true
  end
  if show.quote_activation_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_notification then
    show.quote_activation_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_notification
    changed = true
  end
  if show.quote_activation_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_request then
    show.quote_activation_request = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_request
    changed = true
  end
  if show.quote_activation_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_response then
    show.quote_activation_response = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_activation_response
    changed = true
  end
  if show.quote_entry_ack_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_entry_ack_grp_comp then
    show.quote_entry_ack_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_entry_ack_grp_comp
    changed = true
  end
  if show.quote_entry_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_entry_grp_comp then
    show.quote_entry_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_entry_grp_comp
    changed = true
  end
  if show.quote_event_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_event_grp_comp then
    show.quote_event_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_event_grp_comp
    changed = true
  end
  if show.quote_execution_report ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_execution_report then
    show.quote_execution_report = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_execution_report
    changed = true
  end
  if show.quote_leg_exec_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_quote_leg_exec_grp_comp then
    show.quote_leg_exec_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_quote_leg_exec_grp_comp
    changed = true
  end
  if show.rbc_header_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_rbc_header_comp then
    show.rbc_header_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_rbc_header_comp
    changed = true
  end
  if show.rbc_header_me_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_rbc_header_me_comp then
    show.rbc_header_me_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_rbc_header_me_comp
    changed = true
  end
  if show.reject ~= eurex_derivatives_eti_t7_v7_0.prefs.show_reject then
    show.reject = eurex_derivatives_eti_t7_v7_0.prefs.show_reject
    changed = true
  end
  if show.request_header_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_request_header_comp then
    show.request_header_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_request_header_comp
    changed = true
  end
  if show.response_header_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_response_header_comp then
    show.response_header_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_response_header_comp
    changed = true
  end
  if show.response_header_me_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_response_header_me_comp then
    show.response_header_me_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_response_header_me_comp
    changed = true
  end
  if show.retransmit_me_message_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_me_message_request then
    show.retransmit_me_message_request = eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_me_message_request
    changed = true
  end
  if show.retransmit_me_message_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_me_message_response then
    show.retransmit_me_message_response = eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_me_message_response
    changed = true
  end
  if show.retransmit_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_request then
    show.retransmit_request = eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_request
    changed = true
  end
  if show.retransmit_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_response then
    show.retransmit_response = eurex_derivatives_eti_t7_v7_0.prefs.show_retransmit_response
    changed = true
  end
  if show.rfq_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_rfq_request then
    show.rfq_request = eurex_derivatives_eti_t7_v7_0.prefs.show_rfq_request
    changed = true
  end
  if show.rfq_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_rfq_response then
    show.rfq_response = eurex_derivatives_eti_t7_v7_0.prefs.show_rfq_response
    changed = true
  end
  if show.risk_limit_qty_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_risk_limit_qty_grp_comp then
    show.risk_limit_qty_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_risk_limit_qty_grp_comp
    changed = true
  end
  if show.risk_limits_rpt_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_risk_limits_rpt_grp_comp then
    show.risk_limits_rpt_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_risk_limits_rpt_grp_comp
    changed = true
  end
  if show.risk_notification_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_risk_notification_broadcast then
    show.risk_notification_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_risk_notification_broadcast
    changed = true
  end
  if show.service_availability_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_service_availability_broadcast then
    show.service_availability_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_service_availability_broadcast
    changed = true
  end
  if show.service_availability_market_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_service_availability_market_broadcast then
    show.service_availability_market_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_service_availability_market_broadcast
    changed = true
  end
  if show.sessions_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_sessions_grp_comp then
    show.sessions_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_sessions_grp_comp
    changed = true
  end
  if show.side_alloc_ext_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_ext_grp_comp then
    show.side_alloc_ext_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_ext_grp_comp
    changed = true
  end
  if show.side_alloc_grp_bc_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_grp_bc_comp then
    show.side_alloc_grp_bc_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_grp_bc_comp
    changed = true
  end
  if show.side_alloc_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_grp_comp then
    show.side_alloc_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_side_alloc_grp_comp
    changed = true
  end
  if show.side_cross_leg_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_side_cross_leg_grp_comp then
    show.side_cross_leg_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_side_cross_leg_grp_comp
    changed = true
  end
  if show.srqs_create_deal_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_create_deal_notification then
    show.srqs_create_deal_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_create_deal_notification
    changed = true
  end
  if show.srqs_deal_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_deal_notification then
    show.srqs_deal_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_deal_notification
    changed = true
  end
  if show.srqs_deal_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_deal_response then
    show.srqs_deal_response = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_deal_response
    changed = true
  end
  if show.srqs_enter_quote_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_enter_quote_request then
    show.srqs_enter_quote_request = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_enter_quote_request
    changed = true
  end
  if show.srqs_hit_quote_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_hit_quote_request then
    show.srqs_hit_quote_request = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_hit_quote_request
    changed = true
  end
  if show.srqs_negotiation_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_notification then
    show.srqs_negotiation_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_notification
    changed = true
  end
  if show.srqs_negotiation_requester_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_requester_notification then
    show.srqs_negotiation_requester_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_requester_notification
    changed = true
  end
  if show.srqs_negotiation_status_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_status_notification then
    show.srqs_negotiation_status_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_negotiation_status_notification
    changed = true
  end
  if show.srqs_open_negotiation_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_notification then
    show.srqs_open_negotiation_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_notification
    changed = true
  end
  if show.srqs_open_negotiation_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_request then
    show.srqs_open_negotiation_request = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_request
    changed = true
  end
  if show.srqs_open_negotiation_requester_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_requester_notification then
    show.srqs_open_negotiation_requester_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_open_negotiation_requester_notification
    changed = true
  end
  if show.srqs_quote_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_quote_notification then
    show.srqs_quote_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_quote_notification
    changed = true
  end
  if show.srqs_quote_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_quote_response then
    show.srqs_quote_response = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_quote_response
    changed = true
  end
  if show.srqs_status_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_status_broadcast then
    show.srqs_status_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_status_broadcast
    changed = true
  end
  if show.srqs_update_deal_status_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_update_deal_status_request then
    show.srqs_update_deal_status_request = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_update_deal_status_request
    changed = true
  end
  if show.srqs_update_negotiation_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_update_negotiation_request then
    show.srqs_update_negotiation_request = eurex_derivatives_eti_t7_v7_0.prefs.show_srqs_update_negotiation_request
    changed = true
  end
  if show.subscribe_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_subscribe_request then
    show.subscribe_request = eurex_derivatives_eti_t7_v7_0.prefs.show_subscribe_request
    changed = true
  end
  if show.subscribe_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_subscribe_response then
    show.subscribe_response = eurex_derivatives_eti_t7_v7_0.prefs.show_subscribe_response
    changed = true
  end
  if show.target_parties_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_target_parties_comp then
    show.target_parties_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_target_parties_comp
    changed = true
  end
  if show.tes_approve_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_approve_broadcast then
    show.tes_approve_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_approve_broadcast
    changed = true
  end
  if show.tes_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_broadcast then
    show.tes_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_broadcast
    changed = true
  end
  if show.tes_delete_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_delete_broadcast then
    show.tes_delete_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_delete_broadcast
    changed = true
  end
  if show.tes_execution_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_execution_broadcast then
    show.tes_execution_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_execution_broadcast
    changed = true
  end
  if show.tes_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_response then
    show.tes_response = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_response
    changed = true
  end
  if show.tes_trade_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_trade_broadcast then
    show.tes_trade_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_trade_broadcast
    changed = true
  end
  if show.tes_trading_session_status_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_trading_session_status_broadcast then
    show.tes_trading_session_status_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_trading_session_status_broadcast
    changed = true
  end
  if show.tes_upload_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tes_upload_broadcast then
    show.tes_upload_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tes_upload_broadcast
    changed = true
  end
  if show.throttle_update_notification ~= eurex_derivatives_eti_t7_v7_0.prefs.show_throttle_update_notification then
    show.throttle_update_notification = eurex_derivatives_eti_t7_v7_0.prefs.show_throttle_update_notification
    changed = true
  end
  if show.tm_trading_session_status_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_tm_trading_session_status_broadcast then
    show.tm_trading_session_status_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_tm_trading_session_status_broadcast
    changed = true
  end
  if show.trade_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_trade_broadcast then
    show.trade_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_trade_broadcast
    changed = true
  end
  if show.trading_session_status_broadcast ~= eurex_derivatives_eti_t7_v7_0.prefs.show_trading_session_status_broadcast then
    show.trading_session_status_broadcast = eurex_derivatives_eti_t7_v7_0.prefs.show_trading_session_status_broadcast
    changed = true
  end
  if show.trd_instrmnt_leg_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_trd_instrmnt_leg_grp_comp then
    show.trd_instrmnt_leg_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_trd_instrmnt_leg_grp_comp
    changed = true
  end
  if show.underlying_stip_grp_comp ~= eurex_derivatives_eti_t7_v7_0.prefs.show_underlying_stip_grp_comp then
    show.underlying_stip_grp_comp = eurex_derivatives_eti_t7_v7_0.prefs.show_underlying_stip_grp_comp
    changed = true
  end
  if show.unsubscribe_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_unsubscribe_request then
    show.unsubscribe_request = eurex_derivatives_eti_t7_v7_0.prefs.show_unsubscribe_request
    changed = true
  end
  if show.unsubscribe_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_unsubscribe_response then
    show.unsubscribe_response = eurex_derivatives_eti_t7_v7_0.prefs.show_unsubscribe_response
    changed = true
  end
  if show.upload_tes_trade_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_upload_tes_trade_request then
    show.upload_tes_trade_request = eurex_derivatives_eti_t7_v7_0.prefs.show_upload_tes_trade_request
    changed = true
  end
  if show.user_login_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_user_login_request then
    show.user_login_request = eurex_derivatives_eti_t7_v7_0.prefs.show_user_login_request
    changed = true
  end
  if show.user_login_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_user_login_response then
    show.user_login_response = eurex_derivatives_eti_t7_v7_0.prefs.show_user_login_response
    changed = true
  end
  if show.user_logout_request ~= eurex_derivatives_eti_t7_v7_0.prefs.show_user_logout_request then
    show.user_logout_request = eurex_derivatives_eti_t7_v7_0.prefs.show_user_logout_request
    changed = true
  end
  if show.user_logout_response ~= eurex_derivatives_eti_t7_v7_0.prefs.show_user_logout_response then
    show.user_logout_response = eurex_derivatives_eti_t7_v7_0.prefs.show_user_logout_response
    changed = true
  end
  if show.packet ~= eurex_derivatives_eti_t7_v7_0.prefs.show_packet then
    show.packet = eurex_derivatives_eti_t7_v7_0.prefs.show_packet
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Eurex Derivatives Eti T7 7.0
-----------------------------------------------------------------------
...
dissect.pad_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_4, range, value, display)
...
dissect.msg_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.msg_seq_num, range, value, display)
...
dissect.sending_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.sending_time, range, value, display)
...
dissect.request_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.request_time, range, value, display)
...
dissect.response_header_comp = function(buffer, offset, packet, parent)
  ...
  if show.response_header_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.response_header_comp, range, display)
  end
...
dissect.pad_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_2, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.template_id, range, value, display)
...
dissect.body_len = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.body_len, range, value, display)
...
dissect.message_header_out_comp = function(buffer, offset, packet, parent)
  ...
  if show.message_header_out_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.message_header_out_comp, range, display)
  end
...
dissect.username = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.username, range, value, display)
...
dissect.sender_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.sender_sub_id, range, value, display)
...
dissect.request_header_comp = function(buffer, offset, packet, parent)
  ...
  if show.request_header_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.request_header_comp, range, display)
  end
...
dissect.network_msg_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.network_msg_id, range, value, display)
...
dissect.message_header_in_comp = function(buffer, offset, packet, parent)
  ...
  if show.message_header_in_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.message_header_in_comp, range, display)
  end
...
dissect.password = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.password, range, value, display)
...
dissect.pad_1 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_1, range, value, display)
...
dissect.underlying_stip_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_stip_type, range, value, display)
...
dissect.underlying_stip_value = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_stip_value, range, value, display)
...
dissect.underlying_stip_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.underlying_stip_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_stip_grp_comp, range, display)
  end
...
dissect.pad_7 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_7, range, value, display)
...
dissect.instr_attrib_value = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.instr_attrib_value, range, value, display)
...
dissect.instr_attrib_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.instr_attrib_type, range, value, display)
...
dissect.instrument_attribute_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.instrument_attribute_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.instrument_attribute_grp_comp, range, display)
  end
...
dissect.pad_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_3, range, value, display)
...
dissect.event_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.event_type, range, value, display)
...
dissect.event_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.event_date, range, value, display)
...
dissect.instrument_event_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.instrument_event_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.instrument_event_grp_comp, range, display)
  end
...
dissect.leg_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_price, range, value, display)
...
dissect.leg_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_security_id, range, value, display)
...
dissect.trd_instrmnt_leg_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.trd_instrmnt_leg_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_instrmnt_leg_grp_comp, range, display)
  end
...
dissect.compliance_text = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.compliance_text, range, value, display)
...
dissect.cust_order_handling_inst = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.cust_order_handling_inst, range, value, display)
...
dissect.party_id_location_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_location_id, range, value, display)
...
dissect.party_id_beneficiary = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_beneficiary, range, value, display)
...
dissect.party_id_order_origination_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_order_origination_firm, range, value, display)
...
dissect.free_text_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.free_text_3, range, value, display)
...
dissect.free_text_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.free_text_2, range, value, display)
...
dissect.free_text_1 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.free_text_1, range, value, display)
...
dissect.party_id_take_up_trading_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_take_up_trading_firm, range, value, display)
...
dissect.party_id_position_account = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_position_account, range, value, display)
...
dissect.account = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.account, range, value, display)
...
dissect.order_attribute_risk_reduction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_attribute_risk_reduction, range, value, display)
...
dissect.party_id_investment_decision_maker_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_investment_decision_maker_qualifier, range, value, display)
...
dissect.executing_trader_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.executing_trader_qualifier, range, value, display)
...
dissect.order_attribute_liquidity_provision = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_attribute_liquidity_provision, range, value, display)
...
dissect.position_effect = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.position_effect, range, value, display)
...
dissect.trading_capacity = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trading_capacity, range, value, display)
...
dissect.trade_alloc_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_alloc_status, range, value, display)
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.side, range, value, display)
...
dissect.party_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_executing_trader, range, value, display)
...
dissect.party_executing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_executing_firm, range, value, display)
...
dissect.individual_alloc_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.individual_alloc_id, range, value, display)
...
dissect.executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.executing_trader, range, value, display)
...
dissect.party_id_investment_decision_maker = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_investment_decision_maker, range, value, display)
...
dissect.party_id_client_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_client_id, range, value, display)
...
dissect.alloc_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.alloc_qty, range, value, display)
...
dissect.side_alloc_ext_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.side_alloc_ext_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_alloc_ext_grp_comp, range, display)
  end
...
dissect.underlying_issuer = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_issuer, range, value, display)
...
dissect.underlying_currency = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_currency, range, value, display)
...
dissect.underlying_security_desc = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_security_desc, range, value, display)
...
dissect.underlying_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_security_id, range, value, display)
...
dissect.trade_report_text = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_report_text, range, value, display)
...
dissect.trade_report_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_report_id, range, value, display)
...
dissect.party_id_settlement_location = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_settlement_location, range, value, display)
...
dissect.hedge_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.hedge_type, range, value, display)

  return offset + length, value
end

-- Size: Trade Platform
size_of.trade_platform = 1

-- Display: Trade Platform
display.trade_platform = function(value)
  if value == 0 then
    return "Trade Platform: Off Book (0)"
  end
  if value == 1 then
    return "Trade Platform: On Book (1)"
  end

  return "Trade Platform: Unknown("..value..")"
end

-- Dissect: Trade Platform
dissect.trade_platform = function(buffer, offset, packet, parent)
  local length = size_of.trade_platform
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.trade_platform(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_platform, range, value, display)
...
dissect.trd_rpt_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_rpt_status, range, value, display)
...
dissect.skip_validations = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.skip_validations, range, value, display)
...
dissect.no_underlying_stips = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_underlying_stips, range, value, display)
...
dissect.no_instr_attrib = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_instr_attrib, range, value, display)
...
dissect.no_events = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_events, range, value, display)
...
dissect.no_legs = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_legs, range, value, display)
...
dissect.no_side_allocs = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_side_allocs, range, value, display)
...
dissect.trade_publish_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_publish_indicator, range, value, display)
...
dissect.trade_report_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_report_type, range, value, display)
...
dissect.product_complex = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.product_complex, range, value, display)
...
dissect.trd_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_type, range, value, display)
...
dissect.srqs_related_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.srqs_related_trade_id, range, value, display)
...
dissect.negotiation_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.negotiation_id, range, value, display)
...
dissect.related_market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.related_market_segment_id, range, value, display)
...
dissect.related_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.related_trade_id, range, value, display)
...
dissect.underlying_maturity_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_maturity_date, range, value, display)
...
dissect.underlying_settlement_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_settlement_date, range, value, display)
...
dissect.market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.market_segment_id, range, value, display)
...
dissect.underlying_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_qty, range, value, display)

  return offset + length, value
end

-- Size: Related Trade Quantity
size_of.related_trade_quantity = 8
...
dissect.related_trade_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.related_trade_quantity, range, value, display)
...
dissect.related_close_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.related_close_price, range, value, display)
...
dissect.underlying_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_px, range, value, display)
...
dissect.trans_bkd_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trans_bkd_time, range, value, display)
...
dissect.last_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.last_px, range, value, display)
...
dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.security_id, range, value, display)
...
dissect.upload_tes_trade_request_fields = function(buffer, offset, packet, parent, size_of_upload_tes_trade_request)
  ...
  -- Related Trade Quantity: 8 Byte Unsigned Fixed Width Integer
  ...
  -- Trd Type: 2 Byte Unsigned Fixed Width Integer Enum with 6 values
  ...
  -- Trade Platform: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, trade_platform = dissect.trade_platform(buffer, index, packet, parent)
  ...
  -- Side Alloc Ext Grp Comp: Struct of 27 fields
...
dissect.ref_appl_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.ref_appl_sub_id, range, value, display)
...
dissect.ref_appl_last_msg_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.ref_appl_last_msg_id, range, value, display)
...
dissect.trad_ses_event = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trad_ses_event, range, value, display)
...
dissect.trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_date, range, value, display)
...
dissect.last_fragment = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.last_fragment, range, value, display)
...
dissect.appl_resend_flag = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_resend_flag, range, value, display)
...
dissect.appl_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_id, range, value, display)
...
dissect.appl_msg_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_msg_id, range, value, display)
...
dissect.partition_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.partition_id, range, value, display)
...
dissect.appl_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_sub_id, range, value, display)
...
dissect.notification_in = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.notification_in, range, value, display)
...
dissect.trd_reg_ts_time_out = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_time_out, range, value, display)
...
dissect.rbc_header_me_comp = function(buffer, offset, packet, parent)
  ...
  if show.rbc_header_me_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.rbc_header_me_comp, range, display)
  end
...
dissect.regulatory_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.regulatory_trade_id, range, value, display)
...
dissect.root_party_clearing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_clearing_firm, range, value, display)
...
dissect.root_party_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_executing_trader, range, value, display)
...
dissect.root_party_executing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_executing_firm, range, value, display)
...
dissect.root_party_clearing_organization = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_clearing_organization, range, value, display)
...
dissect.order_side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_side, range, value, display)
...
dissect.related_product_complex = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.related_product_complex, range, value, display)
...
dissect.ord_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.ord_type, range, value, display)
...
dissect.order_category = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_category, range, value, display)
...
dissect.root_party_id_position_account = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_position_account, range, value, display)
...
dissect.root_party_id_investment_decision_maker_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_investment_decision_maker_qualifier, range, value, display)
...
dissect.side_liquidity_ind = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_liquidity_ind, range, value, display)
...
display.match_sub_type = function(value)
  ...
  if value == 6 then
    return "Match Sub Type: Outside Bbo (6)"
  end
...
dissect.match_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.match_sub_type, range, value, display)
...
dissect.match_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.match_type, range, value, display)
...
dissect.root_party_id_order_origination_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_order_origination_firm, range, value, display)
...
dissect.root_party_id_take_up_trading_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_take_up_trading_firm, range, value, display)
...
dissect.root_party_id_beneficiary = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_beneficiary, range, value, display)
...
dissect.transfer_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.transfer_reason, range, value, display)
...
dissect.multi_leg_reporting_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.multi_leg_reporting_type, range, value, display)
...
dissect.tot_num_trade_reports = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.tot_num_trade_reports, range, value, display)
...
dissect.strategy_link_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.strategy_link_id, range, value, display)
...
dissect.trd_match_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_match_id, range, value, display)
...
dissect.match_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.match_date, range, value, display)
...
dissect.side_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_trade_id, range, value, display)
...
dissect.related_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.related_symbol, range, value, display)
...
dissect.root_party_id_clearing_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_clearing_unit, range, value, display)
...
dissect.root_party_id_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_executing_trader, range, value, display)
...
dissect.root_party_id_session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_session_id, range, value, display)
...
dissect.root_party_id_executing_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_executing_unit, range, value, display)
...
dissect.orig_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.orig_trade_id, range, value, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_id, range, value, display)
...
dissect.root_party_id_investment_decision_maker = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_investment_decision_maker, range, value, display)
...
dissect.root_party_id_client_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_id_client_id, range, value, display)
...
dissect.cum_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.cum_qty, range, value, display)
...
dissect.leaves_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leaves_qty, range, value, display)
...
dissect.cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.cl_ord_id, range, value, display)
...
dissect.order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_id, range, value, display)
...
dissect.transact_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.transact_time, range, value, display)

  return offset + length, value
end

-- Size: Clearing Trade Qty
size_of.clearing_trade_qty = 8
...
dissect.clearing_trade_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.clearing_trade_qty, range, value, display)
...
dissect.clearing_trade_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.clearing_trade_price, range, value, display)

  return offset + length, value
end

-- Size: Side Last Qty
size_of.side_last_qty = 8
...
dissect.side_last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_last_qty, range, value, display)
...
dissect.side_last_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_last_px, range, value, display)
...
dissect.last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.last_qty, range, value, display)
...
dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.price, range, value, display)
...
dissect.related_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.related_security_id, range, value, display)
...
dissect.appl_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_seq_num, range, value, display)
...
dissect.rbc_header_comp = function(buffer, offset, packet, parent)
  ...
  if show.rbc_header_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.rbc_header_comp, range, display)
  end
...
dissect.trade_broadcast_fields = function(buffer, offset, packet, parent, size_of_trade_broadcast)
  ...
  -- Side Last Qty: 8 Byte Unsigned Fixed Width Integer
  ...
  -- Clearing Trade Qty: 8 Byte Unsigned Fixed Width Integer
...
dissect.throttle_disconnect_limit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.throttle_disconnect_limit, range, value, display)
...
dissect.throttle_no_msgs = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.throttle_no_msgs, range, value, display)
...
dissect.throttle_time_interval = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.throttle_time_interval, range, value, display)
...
dissect.notif_header_comp = function(buffer, offset, packet, parent)
  ...
  if show.notif_header_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.notif_header_comp, range, display)
  end
...
dissect.message_event_source = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.message_event_source, range, value, display)
...
dissect.tes_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.tes_exec_id, range, value, display)
...
dissect.package_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.package_id, range, value, display)
...
size_of.basket_side_trade_report_id = 20

-- Display: Basket Side Trade Report Id
display.basket_side_trade_report_id = function(value)
  return "Basket Side Trade Report Id: "..value
end

-- Dissect: Basket Side Trade Report Id
dissect.basket_side_trade_report_id = function(buffer, offset, packet, parent)
  local length = size_of.basket_side_trade_report_id
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.basket_side_trade_report_id(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.basket_side_trade_report_id, range, value, display)
...
dissect.multileg_price_model = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.multileg_price_model, range, value, display)

  return offset + length, value
end

-- Size: Basket Trd Match Id
size_of.basket_trd_match_id = 4

-- Display: Basket Trd Match Id
display.basket_trd_match_id = function(value)
  return "Basket Trd Match Id: "..value
end

-- Dissect: Basket Trd Match Id
dissect.basket_trd_match_id = function(buffer, offset, packet, parent)
  local length = size_of.basket_trd_match_id
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.basket_trd_match_id(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.basket_trd_match_id, range, value, display)
...
dissect.tes_trade_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_trade_broadcast)
  ...
  -- Basket Trd Match Id: 4 Byte Signed Fixed Width Integer
  index, basket_trd_match_id = dissect.basket_trd_match_id(buffer, index, packet, parent)
  ...
  index, basket_side_trade_report_id = dissect.basket_side_trade_report_id(buffer, index, packet, parent)
...
dissect.alloc_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.alloc_id, range, value, display)
...
display.delete_reason = function(value)
  ...
  if value == 107 then
    return "Delete Reason: Pre Trade Risk Event (107)"
  end
...
dissect.delete_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.delete_reason, range, value, display)
...
dissect.side_alloc_grp_bc_comp = function(buffer, offset, packet, parent)
  ...
  if show.side_alloc_grp_bc_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_alloc_grp_bc_comp, range, display)
  end
...
-- Display: Pad 21
display.pad_21 = function(value)
  return "Pad 21: "..value
end

-- Dissect: Pad 21
dissect.pad_21 = function(buffer, offset, packet, parent)
  local length = size_of.pad_21
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
  local display = display.pad_21(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_21, range, value, display)
...
dissect.party_entering_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_entering_trader, range, value, display)
...
dissect.party_id_entering_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_entering_firm, range, value, display)
...
dissect.tes_approve_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_approve_broadcast)
  ...
  -- Pad 21: 2 Byte
  index, pad_21 = dissect.pad_21(buffer, index, packet, parent)
...
dissect.ref_appl_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.ref_appl_id, range, value, display)
...
dissect.subscription_scope = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.subscription_scope, range, value, display)
...
dissect.selective_request_for_quote_service_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.selective_request_for_quote_service_status, range, value, display)
...
dissect.selective_request_for_quote_service_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.selective_request_for_quote_service_trade_date, range, value, display)
...
dissect.nrbc_header_comp = function(buffer, offset, packet, parent)
  ...
  if show.nrbc_header_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.nrbc_header_comp, range, display)
  end
...
dissect.pad_5 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_5, range, value, display)
...
dissect.t_7_entry_service_rtm_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_rtm_status, range, value, display)
...
dissect.t_7_entry_service_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_status, range, value, display)
...
dissect.appl_seq_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_seq_status, range, value, display)
...
dissect.trade_manager_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_manager_status, range, value, display)
...
dissect.matching_engine_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.matching_engine_status, range, value, display)
...
dissect.t_7_entry_service_rtm_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_rtm_trade_date, range, value, display)
...
dissect.t_7_entry_service_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.t_7_entry_service_trade_date, range, value, display)
...
dissect.appl_seq_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_seq_trade_date, range, value, display)
...
dissect.trade_manager_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_manager_trade_date, range, value, display)
...
dissect.matching_engine_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.matching_engine_trade_date, range, value, display)
...
dissect.target_party_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.target_party_executing_trader, range, value, display)
...
dissect.target_party_executing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.target_party_executing_firm, range, value, display)
...
dissect.quote_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_instruction, range, value, display)
...
dissect.last_qty_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.last_qty_disclosure_instruction, range, value, display)
...
dissect.last_px_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.last_px_disclosure_instruction, range, value, display)
...
dissect.leaves_qty_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leaves_qty_disclosure_instruction, range, value, display)
...
dissect.price_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.price_disclosure_instruction, range, value, display)
...
dissect.side_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_disclosure_instruction, range, value, display)
...
dissect.target_parties_comp = function(buffer, offset, packet, parent)
  ...
  if show.target_parties_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.target_parties_comp, range, display)
  end
...
display.quote_ref_price_source = function(value)
  ...
  if value == 2 then
    return "Quote Ref Price Source: Custom Underlying Price (2)"
  end
...
dissect.quote_ref_price_source = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_ref_price_source, range, value, display)
...
dissect.quote_cancel_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_cancel_type, range, value, display)
...
dissect.number_of_resp_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.number_of_resp_disclosure_instruction, range, value, display)
...
dissect.no_target_party_i_ds = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_target_party_i_ds, range, value, display)
...
dissect.order_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_qty, range, value, display)
...
dissect.offer_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.offer_px, range, value, display)
...
dissect.bid_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.bid_px, range, value, display)
...
dissect.underlying_delta_percentage = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_delta_percentage, range, value, display)
...
dissect.quote_ref_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_ref_price, range, value, display)
...
size_of.underlying_price_stip_value = 8
...
dissect.underlying_price_stip_value = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_price_stip_value, range, value, display)
...
dissect.srqs_update_deal_status_request_fields = function(buffer, offset, packet, parent, size_of_srqs_update_deal_status_request)
  ...
  -- Underlying Price Stip Value: 8 Byte Unsigned Fixed Width Integer
  index, underlying_price_stip_value = dissect.underlying_price_stip_value(buffer, index, packet, parent)
...
dissect.quote_req_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_req_id, range, value, display)
...
dissect.quote_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_id, range, value, display)
...
dissect.offer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.offer_size, range, value, display)
...
dissect.bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.bid_size, range, value, display)
...
dissect.secondary_quote_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.secondary_quote_id, range, value, display)
...
dissect.pad_6 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pad_6, range, value, display)
...
dissect.leg_side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_side, range, value, display)
...
dissect.leg_security_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_security_type, range, value, display)
...
dissect.leg_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_symbol, range, value, display)
...
dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_ratio_qty, range, value, display)
...
dissect.quot_req_legs_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.quot_req_legs_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.quot_req_legs_grp_comp, range, display)
  end
...
dissect.firm_negotiation_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.firm_negotiation_id, range, value, display)
...
dissect.negotiate_underlying = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.negotiate_underlying, range, value, display)
...
dissect.trade_underlying = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trade_underlying, range, value, display)
...
dissect.quote_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_status, range, value, display)

  return offset + length, value
end

-- Size: Quote Sub Type
size_of.quote_sub_type = 1

-- Display: Quote Sub Type
display.quote_sub_type = function(value)
  if value == 1 then
    return "Quote Sub Type: Working Delta (1)"
  end

  return "Quote Sub Type: Unknown("..value..")"
end

-- Dissect: Quote Sub Type
dissect.quote_sub_type = function(buffer, offset, packet, parent)
  local length = size_of.quote_sub_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.quote_sub_type(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_sub_type, range, value, display)
...
dissect.quote_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_type, range, value, display)
...
dissect.number_of_respondents = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.number_of_respondents, range, value, display)
...
dissect.security_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.security_sub_type, range, value, display)
...
dissect.srqs_open_negotiation_requester_notification_fields = function(buffer, offset, packet, parent, size_of_srqs_open_negotiation_requester_notification)
  ...
  -- Quote Sub Type: 1 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, quote_sub_type = dissect.quote_sub_type(buffer, index, packet, parent)
...
dissect.negotiation_start_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.negotiation_start_time, range, value, display)
...
dissect.trd_reg_ts_execution_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_execution_time, range, value, display)
...
dissect.firm_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.firm_trade_id, range, value, display)
...
dissect.value_check_type_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.value_check_type_quantity, range, value, display)
...
dissect.valid_until_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.valid_until_time, range, value, display)
...
dissect.secondary_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.secondary_trade_id, range, value, display)
...
dissect.target_party_entering_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.target_party_entering_trader, range, value, display)
...
dissect.root_party_entering_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_entering_trader, range, value, display)
...
dissect.md_sub_book_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.md_sub_book_type, range, value, display)
...
dissect.md_book_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.md_book_type, range, value, display)
...
dissect.best_offer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.best_offer_size, range, value, display)
...
dissect.best_offer_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.best_offer_px, range, value, display)
...
dissect.best_bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.best_bid_size, range, value, display)
...
dissect.best_bid_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.best_bid_px, range, value, display)
...
dissect.order_book_item_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.order_book_item_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_book_item_grp_comp, range, display)
  end
...
dissect.no_order_book_items = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_order_book_items, range, value, display)
...
dissect.underlying_effective_delta_percentage = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.underlying_effective_delta_percentage, range, value, display)
...
dissect.expire_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.expire_time, range, value, display)
...
dissect.requesting_party_clearing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.requesting_party_clearing_firm, range, value, display)
...
dissect.requesting_party_entering_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.requesting_party_entering_firm, range, value, display)
...
dissect.risk_limit_action = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_action, range, value, display)
...
dissect.list_update_action = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.list_update_action, range, value, display)
...
dissect.market_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.market_id, range, value, display)
...
dissect.requesting_party_id_executing_system = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.requesting_party_id_executing_system, range, value, display)
...
dissect.party_detail_id_executing_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_detail_id_executing_unit, range, value, display)
...
dissect.appl_total_message_count = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_total_message_count, range, value, display)
...
dissect.ref_appl_last_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.ref_appl_last_seq_num, range, value, display)
...
dissect.appl_end_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_end_seq_num, range, value, display)
...
dissect.appl_beg_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_beg_seq_num, range, value, display)
...
dissect.appl_end_msg_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_end_msg_id, range, value, display)
...
dissect.appl_beg_msg_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_beg_msg_id, range, value, display)
...
dissect.var_text = function(buffer, offset, packet, parent, size)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.var_text, range, value, display)
...
dissect.session_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.session_status, range, value, display)
...
dissect.var_text_len = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.var_text_len, range, value, display)
...
dissect.session_reject_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.session_reject_reason, range, value, display)
...
dissect.response_in = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.response_in, range, value, display)
...
dissect.trd_reg_ts_time_in = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_time_in, range, value, display)
...
dissect.nr_response_header_me_comp = function(buffer, offset, packet, parent)
  ...
  if show.nr_response_header_me_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.nr_response_header_me_comp, range, display)
  end
...
dissect.exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.exec_id, range, value, display)
...
dissect.no_quote_events_index = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_quote_events_index, range, value, display)
...
dissect.leg_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_exec_id, range, value, display)
...
dissect.leg_last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_last_qty, range, value, display)
...
dissect.leg_last_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_last_px, range, value, display)
...
dissect.quote_leg_exec_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.quote_leg_exec_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_leg_exec_grp_comp, range, display)
  end
...
dissect.quote_event_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_reason, range, value, display)
...
dissect.quote_event_liquidity_ind = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_liquidity_ind, range, value, display)
...
dissect.quote_event_side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_side, range, value, display)
...
dissect.quote_event_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_type, range, value, display)
...
dissect.quote_event_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_exec_id, range, value, display)
...
dissect.quote_event_match_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_match_id, range, value, display)
...
dissect.quote_msg_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_msg_id, range, value, display)
...
dissect.quote_event_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_qty, range, value, display)
...
dissect.quote_event_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_px, range, value, display)
...
dissect.quote_event_grp_comp_fields = function(buffer, offset, packet, parent)
  ...
  -- Quote Event Reason: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
...
dissect.quote_event_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.quote_event_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_event_grp_comp, range, display)
  end
...
dissect.no_quote_events = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_quote_events, range, value, display)
...
dissect.no_leg_execs = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_leg_execs, range, value, display)
...
dissect.not_affected_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.not_affected_security_id, range, value, display)
...
dissect.not_affected_securities_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.not_affected_securities_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.not_affected_securities_grp_comp, range, display)
  end
...
dissect.no_not_affected_securities = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_not_affected_securities, range, value, display)
...
dissect.mass_action_report_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.mass_action_report_id, range, value, display)
...
dissect.mass_action_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.mass_action_sub_type, range, value, display)
...
dissect.mass_action_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.mass_action_type, range, value, display)
...
dissect.target_party_id_session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.target_party_id_session_id, range, value, display)
...
dissect.mass_action_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.mass_action_reason, range, value, display)
...
dissect.party_id_entering_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_entering_trader, range, value, display)
...
dissect.risk_limit_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_type, range, value, display)

  return offset + length, value
end

-- Size: Risk Limit Qty
size_of.risk_limit_qty = 8
...
dissect.risk_limit_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_qty, range, value, display)

  return offset + length, value
end

-- Calculate size of: Risk Limit Qty Grp Comp
size_of.risk_limit_qty_grp_comp = function(buffer, offset)
  local index = 0

  index = index + size_of.risk_limit_qty
...
-- Display: Risk Limit Qty Grp Comp
display.risk_limit_qty_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Risk Limit Qty Grp Comp
dissect.risk_limit_qty_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Risk Limit Qty: 8 Byte Unsigned Fixed Width Integer
  index, risk_limit_qty = dissect.risk_limit_qty(buffer, index, packet, parent)
...
dissect.risk_limit_qty_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.risk_limit_qty_grp_comp then
    local length = size_of.risk_limit_qty_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = display.risk_limit_qty_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_qty_grp_comp, range, display)
  end

  return dissect.risk_limit_qty_grp_comp_fields(buffer, offset, packet, parent)
end
...
dissect.party_detail_executing_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_detail_executing_unit, range, value, display)
...
dissect.risk_limit_group = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_group, range, value, display)
...
dissect.party_detail_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_detail_status, range, value, display)

  return offset + length, value
end

-- Size: No Risk Limits Qty
size_of.no_risk_limits_qty = 1

-- Display: No Risk Limits Qty
display.no_risk_limits_qty = function(value)
  return "No Risk Limits Qty: "..value
end

-- Dissect: No Risk Limits Qty
dissect.no_risk_limits_qty = function(buffer, offset, packet, parent)
  local length = size_of.no_risk_limits_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.no_risk_limits_qty(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_risk_limits_qty, range, value, display)

  return offset + length, value
end

-- Size: Risk Limit Platform
size_of.risk_limit_platform = 1

-- Display: Risk Limit Platform
display.risk_limit_platform = function(value)
  if value == 0 then
...
dissect.risk_limit_platform = function(buffer, offset, packet, parent)
  local length = size_of.risk_limit_platform
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.risk_limit_platform(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_platform, range, value, display)
...
dissect.pre_trade_risk_limits_definition_request_fields = function(buffer, offset, packet, parent, size_of_pre_trade_risk_limits_definition_request)
  ...
  index, risk_limit_platform = dissect.risk_limit_platform(buffer, index, packet, parent)

  -- No Risk Limits Qty: 1 Byte Unsigned Fixed Width Integer
  index, no_risk_limits_qty = dissect.no_risk_limits_qty(buffer, index, packet, parent)
  ...
  -- Risk Limit Qty Grp Comp: Struct of 3 fields
  for i = 1, no_risk_limits_qty do
    index = dissect.risk_limit_qty_grp_comp(buffer, index, packet, parent)
  end
...
dissect.risk_limit_violation_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_violation_indicator, range, value, display)
...
dissect.risk_limit_requesting_party_role = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_requesting_party_role, range, value, display)

  return offset + length, value
end

-- Size: Risk Limit Net Position Qty
size_of.risk_limit_net_position_qty = 8
...
dissect.risk_limit_net_position_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_net_position_qty, range, value, display)

  return offset + length, value
end

-- Size: Risk Limit Open Qty
size_of.risk_limit_open_qty = 8
...
dissect.risk_limit_open_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_open_qty, range, value, display)
...
size_of.risk_limits_rpt_grp_comp = function(buffer, offset)
  ...
  index = index + size_of.risk_limit_open_qty

  index = index + size_of.risk_limit_net_position_qty
...
dissect.risk_limits_rpt_grp_comp_fields = function(buffer, offset, packet, parent)
  ...
  -- Risk Limit Open Qty: 8 Byte Unsigned Fixed Width Integer
  index, risk_limit_open_qty = dissect.risk_limit_open_qty(buffer, index, packet, parent)

  -- Risk Limit Net Position Qty: 8 Byte Unsigned Fixed Width Integer
  index, risk_limit_net_position_qty = dissect.risk_limit_net_position_qty(buffer, index, packet, parent)
...
dissect.risk_limits_rpt_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.risk_limits_rpt_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limits_rpt_grp_comp, range, display)
  end
...
dissect.no_risk_limits = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_risk_limits, range, value, display)
...
dissect.risk_limit_report_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.risk_limit_report_id, range, value, display)
...
dissect.requesting_party_id_entering_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.requesting_party_id_entering_firm, range, value, display)
...
dissect.party_action_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_action_type, range, value, display)
...
dissect.party_id_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_executing_trader, range, value, display)
...
dissect.party_id_executing_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_executing_unit, range, value, display)
...
dissect.requesting_party_id_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.requesting_party_id_executing_trader, range, value, display)
...
dissect.fill_ref_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fill_ref_id, range, value, display)
...
dissect.instrmnt_leg_exec_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.instrmnt_leg_exec_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.instrmnt_leg_exec_grp_comp, range, display)
  end
...
dissect.fill_liquidity_ind = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fill_liquidity_ind, range, value, display)
...
dissect.fill_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fill_exec_id, range, value, display)
...
dissect.fill_match_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fill_match_id, range, value, display)
...
dissect.fill_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fill_qty, range, value, display)
...
dissect.fill_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fill_px, range, value, display)
...
dissect.fills_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.fills_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.fills_grp_comp, range, display)
  end
...
dissect.no_fills = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_fills, range, value, display)
...
dissect.transaction_delay_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.transaction_delay_indicator, range, value, display)
...
dissect.crossed_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.crossed_indicator, range, value, display)
...
dissect.triggered = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.triggered, range, value, display)
...
dissect.exec_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.exec_type, range, value, display)
...
dissect.ord_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.ord_status, range, value, display)
...
display.exec_restatement_reason = function(value)
  ...
  if value == 340 then
    return "Exec Restatement Reason: Clip Execution (340)"
  end
  if value == 343 then
    return "Exec Restatement Reason: Clip Arrangementtimeout (343)"
  end
  if value == 344 then
    return "Exec Restatement Reason: Clip Arrangement Validation (344)"
  end
...
dissect.exec_restatement_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.exec_restatement_reason, range, value, display)
...
dissect.cxl_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.cxl_qty, range, value, display)
...
dissect.trd_reg_ts_time_priority = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_time_priority, range, value, display)
...
dissect.trd_reg_ts_entry_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trd_reg_ts_entry_time, range, value, display)
...
dissect.orig_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.orig_cl_ord_id, range, value, display)
...
dissect.response_header_me_comp = function(buffer, offset, packet, parent)
  ...
  if show.response_header_me_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.response_header_me_comp, range, display)
  end
...
dissect.order_exec_response_fields = function(buffer, offset, packet, parent, size_of_order_exec_response)
  ...
  -- Exec Restatement Reason: 2 Byte Unsigned Fixed Width Integer Enum with 20 values
...
dissect.leg_position_effect = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_position_effect, range, value, display)
...
dissect.leg_account = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_account, range, value, display)
...
dissect.leg_ord_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.leg_ord_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_ord_grp_comp, range, display)
  end
...
dissect.fix_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fix_cl_ord_id, range, value, display)
...
dissect.appl_seq_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_seq_indicator, range, value, display)
...
dissect.trading_session_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trading_session_sub_id, range, value, display)
...
dissect.exec_inst = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.exec_inst, range, value, display)
...
dissect.time_in_force = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.time_in_force, range, value, display)
...
dissect.party_id_session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_session_id, range, value, display)
...
dissect.match_inst_cross_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.match_inst_cross_id, range, value, display)
...
dissect.expire_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.expire_date, range, value, display)
...
dissect.stop_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.stop_px, range, value, display)
...
dissect.headline = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.headline, range, value, display)
...
dissect.orig_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.orig_time, range, value, display)
...
dissect.value_check_type_value = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.value_check_type_value, range, value, display)
...
dissect.price_validity_check_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.price_validity_check_type, range, value, display)
...
dissect.enrichment_rule_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.enrichment_rule_id, range, value, display)
...
dissect.simple_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.simple_security_id, range, value, display)
...
dissect.side_alloc_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.side_alloc_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_alloc_grp_comp, range, display)
  end
...
dissect.ownership_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.ownership_indicator, range, value, display)
...
dissect.quote_entry_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_entry_status, range, value, display)
...
display.quote_entry_reject_reason = function(value)
  ...
  if value == 143 then
    return "Quote Entry Reject Reason: Tradingindicationrunningfortrader (143)"
  end
  if value == 144 then
...
dissect.quote_entry_reject_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_entry_reject_reason, range, value, display)
...
dissect.offer_cxl_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.offer_cxl_size, range, value, display)
...
dissect.bid_cxl_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.bid_cxl_size, range, value, display)
...
dissect.quote_entry_ack_grp_comp_fields = function(buffer, offset, packet, parent)
  ...
  -- Quote Entry Reject Reason: 4 Byte Unsigned Fixed Width Integer Enum with 27 values
...
dissect.quote_entry_ack_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.quote_entry_ack_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_entry_ack_grp_comp, range, display)
  end
...
dissect.no_quote_entries = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_quote_entries, range, value, display)
...
dissect.quote_response_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_response_id, range, value, display)
...
dissect.quote_entry_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.quote_entry_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_entry_grp_comp, range, display)
  end
...
dissect.quote_size_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.quote_size_type, range, value, display)
...
dissect.pct_count = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.pct_count, range, value, display)
...
dissect.vega = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.vega, range, value, display)
...
dissect.delta = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.delta, range, value, display)
...
dissect.exposure_duration = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.exposure_duration, range, value, display)
...
dissect.mm_parameter_definition_request_fields = function(buffer, offset, packet, parent, size_of_mm_parameter_definition_request)
  ...
  -- Delta: 8 Byte Unsigned Fixed Width Integer
  index, delta = dissect.delta(buffer, index, packet, parent)

  -- Vega: 8 Byte Unsigned Fixed Width Integer
...
display.default_cstm_appl_ver_sub_id = function(value)
  if value == "D0003" then
    return "Default Cstm Appl Ver Sub Id: Derivatives (D0003)"
  end
...
dissect.default_cstm_appl_ver_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.default_cstm_appl_ver_sub_id, range, value, display)
...
dissect.default_cstm_appl_ver_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.default_cstm_appl_ver_id, range, value, display)
...
dissect.trad_ses_mode = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.trad_ses_mode, range, value, display)
...
dissect.session_instance_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.session_instance_id, range, value, display)
...
dissect.heart_bt_int = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.heart_bt_int, range, value, display)
...
dissect.application_system_vendor = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.application_system_vendor, range, value, display)
...
dissect.application_system_version = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.application_system_version, range, value, display)
...
dissect.application_system_name = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.application_system_name, range, value, display)
...
dissect.fix_engine_vendor = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fix_engine_vendor, range, value, display)
...
dissect.fix_engine_version = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fix_engine_version, range, value, display)
...
dissect.fix_engine_name = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.fix_engine_name, range, value, display)
...
dissect.order_routing_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_routing_indicator, range, value, display)
...
dissect.appl_usage_quotes = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_usage_quotes, range, value, display)
...
dissect.appl_usage_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_usage_orders, range, value, display)
...
dissect.user_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.user_status, range, value, display)
...
dissect.party_detail_desk_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_detail_desk_id, range, value, display)
...
dissect.party_detail_role_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_detail_role_qualifier, range, value, display)
...
dissect.party_detail_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_detail_executing_trader, range, value, display)
...
dissect.party_detail_id_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_detail_id_executing_trader, range, value, display)
...
dissect.party_details_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.party_details_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_details_grp_comp, range, display)
  end
...
dissect.no_party_details = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_party_details, range, value, display)
...
dissect.last_entity_processed = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.last_entity_processed, range, value, display)
...
dissect.session_sub_mode = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.session_sub_mode, range, value, display)
...
dissect.session_mode = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.session_mode, range, value, display)
...
dissect.sessions_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.sessions_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.sessions_grp_comp, range, display)
  end
...
dissect.no_sessions = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_sessions, range, value, display)
...
dissect.party_executing_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_executing_unit, range, value, display)
...
dissect.mm_parameter_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.mm_parameter_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.mm_parameter_grp_comp, range, display)
  end
...
dissect.no_mm_parameters = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_mm_parameters, range, value, display)
...
dissect.mm_parameter_report_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.mm_parameter_report_id, range, value, display)
...
dissect.inquire_mm_parameter_response_fields = function(buffer, offset, packet, parent, size_of_inquire_mm_parameter_response)
  ...
  -- Mm Parameter Grp Comp: Struct of 6 fields
...
dissect.party_id_origination_market = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.party_id_origination_market, range, value, display)
...
dissect.enrichment_rules_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.enrichment_rules_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.enrichment_rules_grp_comp, range, display)
  end
...
dissect.no_enrichment_rules = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_enrichment_rules, range, value, display)
...
size_of.leg_input_source = 1

-- Display: Leg Input Source
display.leg_input_source = function(value)
  if value == 1 then
    return "Leg Input Source: Client Broker (1)"
  end
  if value == 2 then
    return "Leg Input Source: Proprietary Broker (2)"
  end

  return "Leg Input Source: Unknown("..value..")"
end

-- Dissect: Leg Input Source
dissect.leg_input_source = function(buffer, offset, packet, parent)
  local length = size_of.leg_input_source
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.leg_input_source(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.leg_input_source, range, value, display)

  return offset + length, value
end

-- Calculate size of: Side Cross Leg Grp Comp
size_of.side_cross_leg_grp_comp = function(buffer, offset)
  local index = 0

  index = index + size_of.leg_input_source
...
-- Display: Side Cross Leg Grp Comp
display.side_cross_leg_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Side Cross Leg Grp Comp
dissect.side_cross_leg_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Leg Input Source: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, leg_input_source = dissect.leg_input_source(buffer, index, packet, parent)
...
dissect.side_cross_leg_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.side_cross_leg_grp_comp then
    local length = size_of.side_cross_leg_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = display.side_cross_leg_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_cross_leg_grp_comp, range, display)
  end

  return dissect.side_cross_leg_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: Side Compliance Text
size_of.side_compliance_text = 20

-- Display: Side Compliance Text
display.side_compliance_text = function(value)
  return "Side Compliance Text: "..value
end

-- Dissect: Side Compliance Text
dissect.side_compliance_text = function(buffer, offset, packet, parent)
  local length = size_of.side_compliance_text
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.side_compliance_text(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.side_compliance_text, range, value, display)
...
dissect.input_source = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.input_source, range, value, display)

  return offset + length, value
end

-- Size: Maximum Price
size_of.maximum_price = 8
...
dissect.maximum_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.maximum_price, range, value, display)

  return offset + length, value
end

-- Calculate size of: Cross Request Side Grp Comp
size_of.cross_request_side_grp_comp = function(buffer, offset)
  local index = 0
  ...
  index = index + size_of.maximum_price
  ...
  index = index + size_of.side_compliance_text
...
display.cross_request_side_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Cross Request Side Grp Comp
dissect.cross_request_side_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  -- Maximum Price: 8 Byte Unsigned Fixed Width Integer
  index, maximum_price = dissect.maximum_price(buffer, index, packet, parent)
  ...
  index, side_compliance_text = dissect.side_compliance_text(buffer, index, packet, parent)
...
dissect.cross_request_side_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.cross_request_side_grp_comp then
    local length = size_of.cross_request_side_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = display.cross_request_side_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.cross_request_side_grp_comp, range, display)
  end

  return dissect.cross_request_side_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: Root Party Contra Trader
size_of.root_party_contra_trader = 6

-- Display: Root Party Contra Trader
display.root_party_contra_trader = function(value)
  return "Root Party Contra Trader: "..value
end

-- Dissect: Root Party Contra Trader
dissect.root_party_contra_trader = function(buffer, offset, packet, parent)
  local length = size_of.root_party_contra_trader
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.root_party_contra_trader(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_contra_trader, range, value, display)
...
dissect.root_party_contra_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.root_party_contra_firm, range, value, display)

  return offset + length, value
end

-- Size: Order Qty Disclosure Instruction
size_of.order_qty_disclosure_instruction = 1

-- Display: Order Qty Disclosure Instruction
display.order_qty_disclosure_instruction = function(value)
  if value == 0 then
    return "Order Qty Disclosure Instruction: No (0)"
  end
  if value == 1 then
    return "Order Qty Disclosure Instruction: Yes (1)"
  end

  return "Order Qty Disclosure Instruction: Unknown("..value..")"
end

-- Dissect: Order Qty Disclosure Instruction
dissect.order_qty_disclosure_instruction = function(buffer, offset, packet, parent)
  local length = size_of.order_qty_disclosure_instruction
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.order_qty_disclosure_instruction(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.order_qty_disclosure_instruction, range, value, display)

  return offset + length, value
end

-- Size: No Cross Legs
size_of.no_cross_legs = 1

-- Display: No Cross Legs
display.no_cross_legs = function(value)
  return "No Cross Legs: "..value
end

-- Dissect: No Cross Legs
dissect.no_cross_legs = function(buffer, offset, packet, parent)
  local length = size_of.no_cross_legs
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.no_cross_legs(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_cross_legs, range, value, display)
...
-- Display: No Sides
display.no_sides = function(value)
  return "No Sides: "..value
end

-- Dissect: No Sides
dissect.no_sides = function(buffer, offset, packet, parent)
  local length = size_of.no_sides
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.no_sides(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_sides, range, value, display)

  return offset + length, value
end

-- Size: Cross Request Id
size_of.cross_request_id = 4

-- Display: Cross Request Id
display.cross_request_id = function(value)
  return "Cross Request Id: "..value
end

-- Dissect: Cross Request Id
dissect.cross_request_id = function(buffer, offset, packet, parent)
  local length = size_of.cross_request_id
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.cross_request_id(value, buffer, offset, packet, parent)

  parent:add(eurex_derivatives_eti_t7_v7_0.fields.cross_request_id, range, value, display)
...
dissect.cross_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.cross_id, range, value, display)
...
dissect.enter_clip_request_fields = function(buffer, offset, packet, parent, size_of_enter_clip_request)
  ...
  -- Cross Id: 4 Byte Signed Fixed Width Integer
  index, cross_id = dissect.cross_id(buffer, index, packet, parent)

  -- Cross Request Id: 4 Byte Signed Fixed Width Integer
  index, cross_request_id = dissect.cross_request_id(buffer, index, packet, parent)

  -- No Sides: 1 Byte Unsigned Fixed Width Integer
  index, no_sides = dissect.no_sides(buffer, index, packet, parent)

  -- No Cross Legs: 1 Byte Unsigned Fixed Width Integer
  index, no_cross_legs = dissect.no_cross_legs(buffer, index, packet, parent)
  ...
  index, order_qty_disclosure_instruction = dissect.order_qty_disclosure_instruction(buffer, index, packet, parent)
  ...
  index, root_party_contra_trader = dissect.root_party_contra_trader(buffer, index, packet, parent)

  -- Pad 4: 4 Byte
  index, pad_4 = dissect.pad_4(buffer, index, packet, parent)

  -- Cross Request Side Grp Comp: Struct of 23 fields
  for i = 1, no_sides do
    index = dissect.cross_request_side_grp_comp(buffer, index, packet, parent)
  end

  -- Side Cross Leg Grp Comp: Struct of 4 fields
  for i = 1, no_cross_legs do
    index = dissect.side_cross_leg_grp_comp(buffer, index, packet, parent)
  end
...
display.delete_clip_request = function(buffer, offset, size, packet, parent)
  return ""
end
...
dissect.target_party_id_desk_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.target_party_id_desk_id, range, value, display)
...
dissect.target_party_id_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.target_party_id_executing_trader, range, value, display)
...
dissect.affected_order_request_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.affected_order_request_id, range, value, display)
...
dissect.affected_order_requests_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.affected_order_requests_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.affected_order_requests_grp_comp, range, display)
  end
...
dissect.not_aff_orig_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.not_aff_orig_cl_ord_id, range, value, display)
...
dissect.not_affected_order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.not_affected_order_id, range, value, display)
...
dissect.not_affected_orders_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.not_affected_orders_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.not_affected_orders_grp_comp, range, display)
  end
...
dissect.no_affected_order_requests = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_affected_order_requests, range, value, display)
...
dissect.no_not_affected_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.no_not_affected_orders, range, value, display)
...
size_of.cross_request_ack_side_grp_comp = function(buffer, offset)
  local index = 0
...
-- Display: Cross Request Ack Side Grp Comp
display.cross_request_ack_side_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Cross Request Ack Side Grp Comp
dissect.cross_request_ack_side_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.cross_request_ack_side_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.cross_request_ack_side_grp_comp then
    local length = size_of.cross_request_ack_side_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = display.cross_request_ack_side_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.cross_request_ack_side_grp_comp, range, display)
  end
...
dissect.clip_response_fields = function(buffer, offset, packet, parent, size_of_clip_response)
  ...
  -- Cross Request Ack Side Grp Comp: Struct of 4 fields
  for i = 1, no_sides do
    index = dissect.cross_request_ack_side_grp_comp(buffer, index, packet, parent)
  end
...
display.clip_execution_notification = function(buffer, offset, size, packet, parent)
  return ""
end
...
display.clip_deletion_notification = function(buffer, offset, size, packet, parent)
  return ""
end
...
dissect.appl_id_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.appl_id_status, range, value, display)
...
dissect.symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.symbol, range, value, display)
...
dissect.exercise_style = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.exercise_style, range, value, display)
...
dissect.put_or_call = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.put_or_call, range, value, display)
...
dissect.opt_attribute = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.opt_attribute, range, value, display)
...
dissect.settl_method = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.settl_method, range, value, display)
...
dissect.maturity_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.maturity_date, range, value, display)
...
dissect.strike_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.strike_price, range, value, display)
...
dissect.security_response_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.security_response_id, range, value, display)
...
dissect.instrmt_leg_grp_comp = function(buffer, offset, packet, parent)
  ...
  if show.instrmt_leg_grp_comp then
    ...
    parent = parent:add(eurex_derivatives_eti_t7_v7_0.fields.instrmt_leg_grp_comp, range, display)
  end
...
dissect.implied_market_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.implied_market_indicator, range, value, display)
...
dissect.multileg_model = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.multileg_model, range, value, display)
...
dissect.number_of_securities = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.number_of_securities, range, value, display)
...
dissect.last_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.last_update_time, range, value, display)
...
dissect.high_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.high_limit_price, range, value, display)
...
dissect.low_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eti_t7_v7_0.fields.low_limit_price, range, value, display)
...
dissect.packet = function(buffer, packet, parent)
  ...
  -- Dissect Clip Deletion Notification
  if template_id == 10134 then
    return dissect.clip_deletion_notification(buffer, offset, packet, parent)
  end
  -- Dissect Clip Execution Notification
  if template_id == 10135 then
    return dissect.clip_execution_notification(buffer, offset, packet, parent)
  end
  -- Dissect Clip Response
  if template_id == 10133 then
    return dissect.clip_response(buffer, offset, packet, parent)
  end
  -- Dissect Cross Request
  ...
  -- Dissect Delete Clip Request
  if template_id == 10132 then
    return dissect.delete_clip_request(buffer, offset, packet, parent)
  end
  -- Dissect Delete Order Broadcast
  ...
  -- Dissect Enter Clip Request
  if template_id == 10131 then
    return dissect.enter_clip_request(buffer, offset, packet, parent)
  end
  -- Dissect Enter Tes Trade Request
...
function eurex_derivatives_eti_t7_v7_0.init()
end

-- Dissector for Eurex Derivatives Eti T7 7.0
function eurex_derivatives_eti_t7_v7_0.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = eurex_derivatives_eti_t7_v7_0.name

  -- Dissect protocol
  local protocol = parent:add(eurex_derivatives_eti_t7_v7_0, buffer(), eurex_derivatives_eti_t7_v7_0.description, "("..buffer:len().." Bytes)")
  return dissect.packet(buffer, packet, protocol)
end

-- Register With Tcp Table
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add(65333, eurex_derivatives_eti_t7_v7_0)
...
verify.eurex_derivatives_eti_t7_v7_0_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Eurex Derivatives Eti T7 7.0
local function eurex_derivatives_eti_t7_v7_0_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.eurex_derivatives_eti_t7_v7_0_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = eurex_derivatives_eti_t7_v7_0
  eurex_derivatives_eti_t7_v7_0.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Eurex Derivatives Eti T7 7.0
eurex_derivatives_eti_t7_v7_0:register_heuristic("tcp", eurex_derivatives_eti_t7_v7_0_heuristic)
