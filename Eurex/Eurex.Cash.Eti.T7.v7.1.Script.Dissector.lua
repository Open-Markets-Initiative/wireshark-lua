...
eurex_cash_eti_t7_v7_1.fields.accrued_interes_amt = ProtoField.new("Accrued Interes Amt", "eurex.cash.eti.t7.v7.1.accruedinteresamt", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.affected_ord_grp = ProtoField.new("Affected Ord Grp", "eurex.cash.eti.t7.v7.1.affectedordgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.affected_order_requests_grp = ProtoField.new("Affected Order Requests Grp", "eurex.cash.eti.t7.v7.1.affectedorderrequestsgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.alloc_qty = ProtoField.new("Alloc Qty", "eurex.cash.eti.t7.v7.1.allocqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.best_bid_px = ProtoField.new("Best Bid Px", "eurex.cash.eti.t7.v7.1.bestbidpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.best_bid_size = ProtoField.new("Best Bid Size", "eurex.cash.eti.t7.v7.1.bestbidsize", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.best_offer_px = ProtoField.new("Best Offer Px", "eurex.cash.eti.t7.v7.1.bestofferpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.best_offer_size = ProtoField.new("Best Offer Size", "eurex.cash.eti.t7.v7.1.bestoffersize", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.bid_cxl_size = ProtoField.new("Bid Cxl Size", "eurex.cash.eti.t7.v7.1.bidcxlsize", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.bid_px = ProtoField.new("Bid Px", "eurex.cash.eti.t7.v7.1.bidpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.bid_size = ProtoField.new("Bid Size", "eurex.cash.eti.t7.v7.1.bidsize", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.coupon_rate = ProtoField.new("Coupon Rate", "eurex.cash.eti.t7.v7.1.couponrate", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.cum_qty = ProtoField.new("Cum Qty", "eurex.cash.eti.t7.v7.1.cumqty", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.currency = ProtoField.new("Currency", "eurex.cash.eti.t7.v7.1.currency", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.cxl_qty = ProtoField.new("Cxl Qty", "eurex.cash.eti.t7.v7.1.cxlqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.display_high_qty = ProtoField.new("Display High Qty", "eurex.cash.eti.t7.v7.1.displayhighqty", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.display_low_qty = ProtoField.new("Display Low Qty", "eurex.cash.eti.t7.v7.1.displaylowqty", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.display_qty = ProtoField.new("Display Qty", "eurex.cash.eti.t7.v7.1.displayqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.enrichment_rules_grp = ProtoField.new("Enrichment Rules Grp", "eurex.cash.eti.t7.v7.1.enrichmentrulesgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.event_px = ProtoField.new("Event Px", "eurex.cash.eti.t7.v7.1.eventpx", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.fill_px = ProtoField.new("Fill Px", "eurex.cash.eti.t7.v7.1.fillpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.fill_qty = ProtoField.new("Fill Qty", "eurex.cash.eti.t7.v7.1.fillqty", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.fills_grp = ProtoField.new("Fills Grp", "eurex.cash.eti.t7.v7.1.fillsgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.imbalance_qty = ProtoField.new("Imbalance Qty", "eurex.cash.eti.t7.v7.1.imbalanceqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.last_px = ProtoField.new("Last Px", "eurex.cash.eti.t7.v7.1.lastpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.last_qty = ProtoField.new("Last Qty", "eurex.cash.eti.t7.v7.1.lastqty", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.leaves_qty = ProtoField.new("Leaves Qty", "eurex.cash.eti.t7.v7.1.leavesqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.message_header_in = ProtoField.new("Message Header In", "eurex.cash.eti.t7.v7.1.messageheaderin", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.message_header_out = ProtoField.new("Message Header Out", "eurex.cash.eti.t7.v7.1.messageheaderout", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.not_affected_orders_grp = ProtoField.new("Not Affected Orders Grp", "eurex.cash.eti.t7.v7.1.notaffectedordersgrp", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.not_affected_securities_grp = ProtoField.new("Not Affected Securities Grp", "eurex.cash.eti.t7.v7.1.notaffectedsecuritiesgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.notif_header = ProtoField.new("Notif Header", "eurex.cash.eti.t7.v7.1.notifheader", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.nr_response_header_me = ProtoField.new("Nr Response Header Me", "eurex.cash.eti.t7.v7.1.nrresponseheaderme", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.nrbc_header = ProtoField.new("Nrbc Header", "eurex.cash.eti.t7.v7.1.nrbcheader", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.offer_cxl_size = ProtoField.new("Offer Cxl Size", "eurex.cash.eti.t7.v7.1.offercxlsize", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.offer_px = ProtoField.new("Offer Px", "eurex.cash.eti.t7.v7.1.offerpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.offer_size = ProtoField.new("Offer Size", "eurex.cash.eti.t7.v7.1.offersize", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.order_book_item_grp = ProtoField.new("Order Book Item Grp", "eurex.cash.eti.t7.v7.1.orderbookitemgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.order_qty = ProtoField.new("Order Qty", "eurex.cash.eti.t7.v7.1.orderqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.party_details_grp = ProtoField.new("Party Details Grp", "eurex.cash.eti.t7.v7.1.partydetailsgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.peg_offset_value_abs = ProtoField.new("Peg Offset Value Abs", "eurex.cash.eti.t7.v7.1.pegoffsetvalueabs", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.peg_offset_value_bid_px = ProtoField.new("Peg Offset Value Bid Px", "eurex.cash.eti.t7.v7.1.pegoffsetvaluebidpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.peg_offset_value_offer_px = ProtoField.new("Peg Offset Value Offer Px", "eurex.cash.eti.t7.v7.1.pegoffsetvalueofferpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.peg_offset_value_pct = ProtoField.new("Peg Offset Value Pct", "eurex.cash.eti.t7.v7.1.pegoffsetvaluepct", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.potential_exec_volume = ProtoField.new("Potential Exec Volume", "eurex.cash.eti.t7.v7.1.potentialexecvolume", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.price = ProtoField.new("Price", "eurex.cash.eti.t7.v7.1.price", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.quote_entry_ack_grp = ProtoField.new("Quote Entry Ack Grp", "eurex.cash.eti.t7.v7.1.quoteentryackgrp", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.quote_entry_grp = ProtoField.new("Quote Entry Grp", "eurex.cash.eti.t7.v7.1.quoteentrygrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.quote_event_grp = ProtoField.new("Quote Event Grp", "eurex.cash.eti.t7.v7.1.quoteeventgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.quote_event_px = ProtoField.new("Quote Event Px", "eurex.cash.eti.t7.v7.1.quoteeventpx", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.quote_event_qty = ProtoField.new("Quote Event Qty", "eurex.cash.eti.t7.v7.1.quoteeventqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.rbc_header = ProtoField.new("Rbc Header", "eurex.cash.eti.t7.v7.1.rbcheader", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.rbc_header_me = ProtoField.new("Rbc Header Me", "eurex.cash.eti.t7.v7.1.rbcheaderme", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.request_header = ProtoField.new("Request Header", "eurex.cash.eti.t7.v7.1.requestheader", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.reserved_bid_size = ProtoField.new("Reserved Bid Size", "eurex.cash.eti.t7.v7.1.reservedbidsize", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.reserved_offer_size = ProtoField.new("Reserved Offer Size", "eurex.cash.eti.t7.v7.1.reservedoffersize", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.reserved_size = ProtoField.new("Reserved Size", "eurex.cash.eti.t7.v7.1.reservedsize", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.response_header = ProtoField.new("Response Header", "eurex.cash.eti.t7.v7.1.responseheader", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.response_header_me = ProtoField.new("Response Header Me", "eurex.cash.eti.t7.v7.1.responseheaderme", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.security_status_event_grp = ProtoField.new("Security Status Event Grp", "eurex.cash.eti.t7.v7.1.securitystatuseventgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.sessions_grp = ProtoField.new("Sessions Grp", "eurex.cash.eti.t7.v7.1.sessionsgrp", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.settl_curr_amt = ProtoField.new("Settl Curr Amt", "eurex.cash.eti.t7.v7.1.settlcurramt", ftypes.UINT64)
eurex_cash_eti_t7_v7_1.fields.settl_curr_fx_rate = ProtoField.new("Settl Curr Fx Rate", "eurex.cash.eti.t7.v7.1.settlcurrfxrate", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.side_alloc_grp = ProtoField.new("Side Alloc Grp", "eurex.cash.eti.t7.v7.1.sideallocgrp", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.side_alloc_grp_bc = ProtoField.new("Side Alloc Grp Bc", "eurex.cash.eti.t7.v7.1.sideallocgrpbc", ftypes.STRING)
eurex_cash_eti_t7_v7_1.fields.side_gross_trade_amt = ProtoField.new("Side Gross Trade Amt", "eurex.cash.eti.t7.v7.1.sidegrosstradeamt", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.srqs_quote_entry_grp = ProtoField.new("Srqs Quote Entry Grp", "eurex.cash.eti.t7.v7.1.srqsquoteentrygrp", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.fields.stop_px = ProtoField.new("Stop Px", "eurex.cash.eti.t7.v7.1.stoppx", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.volume_discovery_price = ProtoField.new("Volume Discovery Price", "eurex.cash.eti.t7.v7.1.volumediscoveryprice", ftypes.UINT64)
...
eurex_cash_eti_t7_v7_1.fields.xetra_en_light_target_parties = ProtoField.new("Xetra En Light Target Parties", "eurex.cash.eti.t7.v7.1.xetraenlighttargetparties", ftypes.STRING)
...
eurex_cash_eti_t7_v7_1.prefs.show_affected_ord_grp = Pref.bool("Show Affected Ord Grp", show.affected_ord_grp, "Parse and add Affected Ord Grp to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_affected_order_requests_grp = Pref.bool("Show Affected Order Requests Grp", show.affected_order_requests_grp, "Parse and add Affected Order Requests Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_enrichment_rules_grp = Pref.bool("Show Enrichment Rules Grp", show.enrichment_rules_grp, "Parse and add Enrichment Rules Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_fills_grp = Pref.bool("Show Fills Grp", show.fills_grp, "Parse and add Fills Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_message_header_in = Pref.bool("Show Message Header In", show.message_header_in, "Parse and add Message Header In to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_message_header_out = Pref.bool("Show Message Header Out", show.message_header_out, "Parse and add Message Header Out to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_not_affected_orders_grp = Pref.bool("Show Not Affected Orders Grp", show.not_affected_orders_grp, "Parse and add Not Affected Orders Grp to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_not_affected_securities_grp = Pref.bool("Show Not Affected Securities Grp", show.not_affected_securities_grp, "Parse and add Not Affected Securities Grp to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_notif_header = Pref.bool("Show Notif Header", show.notif_header, "Parse and add Notif Header to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_nr_response_header_me = Pref.bool("Show Nr Response Header Me", show.nr_response_header_me, "Parse and add Nr Response Header Me to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_nrbc_header = Pref.bool("Show Nrbc Header", show.nrbc_header, "Parse and add Nrbc Header to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_order_book_item_grp = Pref.bool("Show Order Book Item Grp", show.order_book_item_grp, "Parse and add Order Book Item Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_party_details_grp = Pref.bool("Show Party Details Grp", show.party_details_grp, "Parse and add Party Details Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_quote_entry_ack_grp = Pref.bool("Show Quote Entry Ack Grp", show.quote_entry_ack_grp, "Parse and add Quote Entry Ack Grp to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_quote_entry_grp = Pref.bool("Show Quote Entry Grp", show.quote_entry_grp, "Parse and add Quote Entry Grp to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_quote_event_grp = Pref.bool("Show Quote Event Grp", show.quote_event_grp, "Parse and add Quote Event Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_rbc_header = Pref.bool("Show Rbc Header", show.rbc_header, "Parse and add Rbc Header to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_rbc_header_me = Pref.bool("Show Rbc Header Me", show.rbc_header_me, "Parse and add Rbc Header Me to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_reject = Pref.bool("Show Reject", show.reject, "Parse and add Reject to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_request_header = Pref.bool("Show Request Header", show.request_header, "Parse and add Request Header to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_response_header = Pref.bool("Show Response Header", show.response_header, "Parse and add Response Header to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_response_header_me = Pref.bool("Show Response Header Me", show.response_header_me, "Parse and add Response Header Me to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_security_status_event_grp = Pref.bool("Show Security Status Event Grp", show.security_status_event_grp, "Parse and add Security Status Event Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_sessions_grp = Pref.bool("Show Sessions Grp", show.sessions_grp, "Parse and add Sessions Grp to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_side_alloc_grp = Pref.bool("Show Side Alloc Grp", show.side_alloc_grp, "Parse and add Side Alloc Grp to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_side_alloc_grp_bc = Pref.bool("Show Side Alloc Grp Bc", show.side_alloc_grp_bc, "Parse and add Side Alloc Grp Bc to protocol tree")
eurex_cash_eti_t7_v7_1.prefs.show_srqs_quote_entry_grp = Pref.bool("Show Srqs Quote Entry Grp", show.srqs_quote_entry_grp, "Parse and add Srqs Quote Entry Grp to protocol tree")
...
eurex_cash_eti_t7_v7_1.prefs.show_xetra_en_light_target_parties = Pref.bool("Show Xetra En Light Target Parties", show.xetra_en_light_target_parties, "Parse and add Xetra En Light Target Parties to protocol tree")
...
function eurex_cash_eti_t7_v7_1.prefs_changed()
  ...
  if show.affected_ord_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_affected_ord_grp then
    show.affected_ord_grp = eurex_cash_eti_t7_v7_1.prefs.show_affected_ord_grp
    changed = true
  end
  if show.affected_order_requests_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_affected_order_requests_grp then
    show.affected_order_requests_grp = eurex_cash_eti_t7_v7_1.prefs.show_affected_order_requests_grp
    changed = true
  end
  ...
  if show.enrichment_rules_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_enrichment_rules_grp then
    show.enrichment_rules_grp = eurex_cash_eti_t7_v7_1.prefs.show_enrichment_rules_grp
    changed = true
  end
  ...
  if show.fills_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_fills_grp then
    show.fills_grp = eurex_cash_eti_t7_v7_1.prefs.show_fills_grp
    changed = true
  end
  ...
  if show.message_header_in ~= eurex_cash_eti_t7_v7_1.prefs.show_message_header_in then
    show.message_header_in = eurex_cash_eti_t7_v7_1.prefs.show_message_header_in
    changed = true
  end
  if show.message_header_out ~= eurex_cash_eti_t7_v7_1.prefs.show_message_header_out then
    show.message_header_out = eurex_cash_eti_t7_v7_1.prefs.show_message_header_out
    changed = true
  end
  ...
  if show.not_affected_orders_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_not_affected_orders_grp then
    show.not_affected_orders_grp = eurex_cash_eti_t7_v7_1.prefs.show_not_affected_orders_grp
    changed = true
  end
  if show.not_affected_securities_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_not_affected_securities_grp then
    show.not_affected_securities_grp = eurex_cash_eti_t7_v7_1.prefs.show_not_affected_securities_grp
    changed = true
  end
  if show.notif_header ~= eurex_cash_eti_t7_v7_1.prefs.show_notif_header then
    show.notif_header = eurex_cash_eti_t7_v7_1.prefs.show_notif_header
    changed = true
  end
  if show.nr_response_header_me ~= eurex_cash_eti_t7_v7_1.prefs.show_nr_response_header_me then
    show.nr_response_header_me = eurex_cash_eti_t7_v7_1.prefs.show_nr_response_header_me
    changed = true
  end
  if show.nrbc_header ~= eurex_cash_eti_t7_v7_1.prefs.show_nrbc_header then
    show.nrbc_header = eurex_cash_eti_t7_v7_1.prefs.show_nrbc_header
    changed = true
  end
  if show.order_book_item_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_order_book_item_grp then
    show.order_book_item_grp = eurex_cash_eti_t7_v7_1.prefs.show_order_book_item_grp
    changed = true
  end
  ...
  if show.party_details_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_party_details_grp then
    show.party_details_grp = eurex_cash_eti_t7_v7_1.prefs.show_party_details_grp
    changed = true
  end
  ...
  if show.quote_entry_ack_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_quote_entry_ack_grp then
    show.quote_entry_ack_grp = eurex_cash_eti_t7_v7_1.prefs.show_quote_entry_ack_grp
    changed = true
  end
  if show.quote_entry_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_quote_entry_grp then
    show.quote_entry_grp = eurex_cash_eti_t7_v7_1.prefs.show_quote_entry_grp
    changed = true
  end
  if show.quote_event_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_quote_event_grp then
    show.quote_event_grp = eurex_cash_eti_t7_v7_1.prefs.show_quote_event_grp
    changed = true
  end
  ...
  if show.rbc_header ~= eurex_cash_eti_t7_v7_1.prefs.show_rbc_header then
    show.rbc_header = eurex_cash_eti_t7_v7_1.prefs.show_rbc_header
    changed = true
  end
  if show.rbc_header_me ~= eurex_cash_eti_t7_v7_1.prefs.show_rbc_header_me then
    show.rbc_header_me = eurex_cash_eti_t7_v7_1.prefs.show_rbc_header_me
    changed = true
  end
  ...
  if show.request_header ~= eurex_cash_eti_t7_v7_1.prefs.show_request_header then
    show.request_header = eurex_cash_eti_t7_v7_1.prefs.show_request_header
    changed = true
  end
  if show.response_header ~= eurex_cash_eti_t7_v7_1.prefs.show_response_header then
    show.response_header = eurex_cash_eti_t7_v7_1.prefs.show_response_header
    changed = true
  end
  if show.response_header_me ~= eurex_cash_eti_t7_v7_1.prefs.show_response_header_me then
    show.response_header_me = eurex_cash_eti_t7_v7_1.prefs.show_response_header_me
    changed = true
  end
  ...
  if show.security_status_event_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_security_status_event_grp then
    show.security_status_event_grp = eurex_cash_eti_t7_v7_1.prefs.show_security_status_event_grp
    changed = true
  end
  ...
  if show.sessions_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_sessions_grp then
    show.sessions_grp = eurex_cash_eti_t7_v7_1.prefs.show_sessions_grp
    changed = true
  end
  if show.side_alloc_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_side_alloc_grp then
    show.side_alloc_grp = eurex_cash_eti_t7_v7_1.prefs.show_side_alloc_grp
    changed = true
  end
  if show.side_alloc_grp_bc ~= eurex_cash_eti_t7_v7_1.prefs.show_side_alloc_grp_bc then
    show.side_alloc_grp_bc = eurex_cash_eti_t7_v7_1.prefs.show_side_alloc_grp_bc
    changed = true
  end
  if show.srqs_quote_entry_grp ~= eurex_cash_eti_t7_v7_1.prefs.show_srqs_quote_entry_grp then
    show.srqs_quote_entry_grp = eurex_cash_eti_t7_v7_1.prefs.show_srqs_quote_entry_grp
    changed = true
  end
  ...
  if show.xetra_en_light_target_parties ~= eurex_cash_eti_t7_v7_1.prefs.show_xetra_en_light_target_parties then
    show.xetra_en_light_target_parties = eurex_cash_eti_t7_v7_1.prefs.show_xetra_en_light_target_parties
    changed = true
  end
...
dissect.xetra_en_light_target_parties = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_target_parties then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.xetra_en_light_target_parties, range, display)
  end
...
dissect.request_header = function(buffer, offset, packet, parent)
  ...
  if show.request_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.request_header, range, display)
  end
...
dissect.message_header_in = function(buffer, offset, packet, parent)
  ...
  if show.message_header_in then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.message_header_in, range, display)
  end
...
dissect.rbc_header = function(buffer, offset, packet, parent)
  ...
  if show.rbc_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.rbc_header, range, display)
  end
...
dissect.message_header_out = function(buffer, offset, packet, parent)
  ...
  if show.message_header_out then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.message_header_out, range, display)
  end
...
dissect.response_header = function(buffer, offset, packet, parent)
  ...
  if show.response_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.response_header, range, display)
  end
...
dissect.srqs_quote_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.srqs_quote_entry_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.srqs_quote_entry_grp, range, display)
  end
...
dissect.order_book_item_grp = function(buffer, offset, packet, parent)
  ...
  if show.order_book_item_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.order_book_item_grp, range, display)
  end
...
dissect.rbc_header_me = function(buffer, offset, packet, parent)
  ...
  if show.rbc_header_me then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.rbc_header_me, range, display)
  end
...
dissect.notif_header = function(buffer, offset, packet, parent)
  ...
  if show.notif_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.notif_header, range, display)
  end
...
dissect.side_alloc_grp_bc = function(buffer, offset, packet, parent)
  ...
  if show.side_alloc_grp_bc then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.side_alloc_grp_bc, range, display)
  end
...
dissect.nrbc_header = function(buffer, offset, packet, parent)
  ...
  if show.nrbc_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.nrbc_header, range, display)
  end
...
dissect.nr_response_header_me = function(buffer, offset, packet, parent)
  ...
  if show.nr_response_header_me then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.nr_response_header_me, range, display)
  end
...
dissect.quote_event_grp = function(buffer, offset, packet, parent)
  ...
  if show.quote_event_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.quote_event_grp, range, display)
  end
...
dissect.not_affected_securities_grp = function(buffer, offset, packet, parent)
  ...
  if show.not_affected_securities_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.not_affected_securities_grp, range, display)
  end
...
dissect.fills_grp = function(buffer, offset, packet, parent)
  ...
  if show.fills_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.fills_grp, range, display)
  end
...
dissect.response_header_me = function(buffer, offset, packet, parent)
  ...
  if show.response_header_me then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.response_header_me, range, display)
  end
...
dissect.side_alloc_grp = function(buffer, offset, packet, parent)
  ...
  if show.side_alloc_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.side_alloc_grp, range, display)
  end
...
dissect.quote_entry_ack_grp = function(buffer, offset, packet, parent)
  ...
  if show.quote_entry_ack_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.quote_entry_ack_grp, range, display)
  end
...
dissect.quote_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.quote_entry_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.quote_entry_grp, range, display)
  end
...
dissect.security_status_event_grp = function(buffer, offset, packet, parent)
  ...
  if show.security_status_event_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.security_status_event_grp, range, display)
  end
...
dissect.party_details_grp = function(buffer, offset, packet, parent)
  ...
  if show.party_details_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.party_details_grp, range, display)
  end
...
dissect.sessions_grp = function(buffer, offset, packet, parent)
  ...
  if show.sessions_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.sessions_grp, range, display)
  end
...
dissect.enrichment_rules_grp = function(buffer, offset, packet, parent)
  ...
  if show.enrichment_rules_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.enrichment_rules_grp, range, display)
  end
...
dissect.affected_order_requests_grp = function(buffer, offset, packet, parent)
  ...
  if show.affected_order_requests_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.affected_order_requests_grp, range, display)
  end
...
dissect.affected_ord_grp = function(buffer, offset, packet, parent)
  ...
  if show.affected_ord_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.affected_ord_grp, range, display)
  end
...
dissect.not_affected_orders_grp = function(buffer, offset, packet, parent)
  ...
  if show.not_affected_orders_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v7_1.fields.not_affected_orders_grp, range, display)
  end
