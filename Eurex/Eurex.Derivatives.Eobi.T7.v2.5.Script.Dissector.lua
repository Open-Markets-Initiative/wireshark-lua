...
eurex_derivatives_eobi_t7_v2_5.fields.application_sequence_number = ProtoField.new("Application Sequence Number", "eurex.derivatives.eobi.t7.v2.5.applicationsequencenumber", ftypes.UINT32)
eurex_derivatives_eobi_t7_v2_5.fields.application_sequence_reset_indicator = ProtoField.new("Application Sequence Reset Indicator", "eurex.derivatives.eobi.t7.v2.5.applicationsequenceresetindicator", ftypes.UINT8)
...
eurex_derivatives_eobi_t7_v2_5.fields.bid_px = ProtoField.new("Bid Px", "eurex.derivatives.eobi.t7.v2.5.bidpx", ftypes.UINT64)
...
eurex_derivatives_eobi_t7_v2_5.fields.instrmt_leg_grp = ProtoField.new("Instrmt Leg Grp", "eurex.derivatives.eobi.t7.v2.5.instrmtleggrp", ftypes.STRING)
...
eurex_derivatives_eobi_t7_v2_5.fields.last_px = ProtoField.new("Last Px", "eurex.derivatives.eobi.t7.v2.5.lastpx", ftypes.UINT64)
...
eurex_derivatives_eobi_t7_v2_5.fields.md_instrument_entry_grp = ProtoField.new("Md Instrument Entry Grp", "eurex.derivatives.eobi.t7.v2.5.mdinstrumententrygrp", ftypes.STRING)
eurex_derivatives_eobi_t7_v2_5.fields.md_trade_entry_grp = ProtoField.new("Md Trade Entry Grp", "eurex.derivatives.eobi.t7.v2.5.mdtradeentrygrp", ftypes.STRING)
...
eurex_derivatives_eobi_t7_v2_5.fields.message_header = ProtoField.new("Message Header", "eurex.derivatives.eobi.t7.v2.5.messageheader", ftypes.STRING)
...
eurex_derivatives_eobi_t7_v2_5.fields.offer_px = ProtoField.new("Offer Px", "eurex.derivatives.eobi.t7.v2.5.offerpx", ftypes.UINT64)
...
eurex_derivatives_eobi_t7_v2_5.fields.order_details = ProtoField.new("Order Details", "eurex.derivatives.eobi.t7.v2.5.orderdetails", ftypes.STRING)
...
eurex_derivatives_eobi_t7_v2_5.fields.packet_seq_num = ProtoField.new("Packet Seq Num", "eurex.derivatives.eobi.t7.v2.5.packetseqnum", ftypes.UINT32)
...
eurex_derivatives_eobi_t7_v2_5.fields.price = ProtoField.new("Price", "eurex.derivatives.eobi.t7.v2.5.price", ftypes.UINT64)
...
eurex_derivatives_eobi_t7_v2_5.prefs.show_instrmt_leg_grp = Pref.bool("Show Instrmt Leg Grp", show.instrmt_leg_grp, "Parse and add Instrmt Leg Grp to protocol tree")
...
eurex_derivatives_eobi_t7_v2_5.prefs.show_md_instrument_entry_grp = Pref.bool("Show Md Instrument Entry Grp", show.md_instrument_entry_grp, "Parse and add Md Instrument Entry Grp to protocol tree")
eurex_derivatives_eobi_t7_v2_5.prefs.show_md_trade_entry_grp = Pref.bool("Show Md Trade Entry Grp", show.md_trade_entry_grp, "Parse and add Md Trade Entry Grp to protocol tree")
...
eurex_derivatives_eobi_t7_v2_5.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
...
eurex_derivatives_eobi_t7_v2_5.prefs.show_order_details = Pref.bool("Show Order Details", show.order_details, "Parse and add Order Details to protocol tree")
...
function eurex_derivatives_eobi_t7_v2_5.prefs_changed()
  ...
  if show.instrmt_leg_grp ~= eurex_derivatives_eobi_t7_v2_5.prefs.show_instrmt_leg_grp then
    show.instrmt_leg_grp = eurex_derivatives_eobi_t7_v2_5.prefs.show_instrmt_leg_grp
    changed = true
  end
  ...
  if show.md_instrument_entry_grp ~= eurex_derivatives_eobi_t7_v2_5.prefs.show_md_instrument_entry_grp then
    show.md_instrument_entry_grp = eurex_derivatives_eobi_t7_v2_5.prefs.show_md_instrument_entry_grp
    changed = true
  end
  if show.md_trade_entry_grp ~= eurex_derivatives_eobi_t7_v2_5.prefs.show_md_trade_entry_grp then
    show.md_trade_entry_grp = eurex_derivatives_eobi_t7_v2_5.prefs.show_md_trade_entry_grp
    changed = true
  end
  ...
  if show.message_header ~= eurex_derivatives_eobi_t7_v2_5.prefs.show_message_header then
    show.message_header = eurex_derivatives_eobi_t7_v2_5.prefs.show_message_header
    changed = true
  end
  ...
  if show.order_details ~= eurex_derivatives_eobi_t7_v2_5.prefs.show_order_details then
    show.order_details = eurex_derivatives_eobi_t7_v2_5.prefs.show_order_details
    changed = true
  end
...
dissect.md_trade_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.md_trade_entry_grp then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v2_5.fields.md_trade_entry_grp, range, display)
  end
...
dissect.order_details = function(buffer, offset, packet, parent)
  ...
  if show.order_details then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v2_5.fields.order_details, range, display)
  end
...
dissect.application_sequence_reset_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eobi_t7_v2_5.fields.application_sequence_reset_indicator, range, value, display)
...
dissect.application_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eobi_t7_v2_5.fields.application_sequence_number, range, value, display)
...
dissect.packet_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eobi_t7_v2_5.fields.packet_seq_num, range, value, display)
...
dissect.md_instrument_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_entry_grp then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v2_5.fields.md_instrument_entry_grp, range, display)
  end
...
dissect.instrmt_leg_grp = function(buffer, offset, packet, parent)
  ...
  if show.instrmt_leg_grp then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v2_5.fields.instrmt_leg_grp, range, display)
  end
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v2_5.fields.message_header, range, display)
  end
...
-- Register Eurex Derivatives Eobi T7 2.5 Heuristic
