...
local omi_eurex_derivatives_eti_t7_v1_0 = Proto("Omi.Eurex.Derivatives.Eti.T7.v1.0", "Eurex Derivatives Eti T7 1.0")
...
eurex_derivatives_eti_t7_v1_0.packet.requiredsize = function(buffer)
  return buffer:len() >= eurex_derivatives_eti_t7_v1_0.message_header.size + eurex_derivatives_eti_t7_v1_0.payload.size
end
...
-- Dissector Heuristic for Eurex Derivatives Eti T7 1.0 (Tcp)
local function omi_eurex_derivatives_eti_t7_v1_0_tcp_heuristic(buffer, packet, parent)
...
omi_eurex_derivatives_eti_t7_v1_0:register_heuristic("tcp", omi_eurex_derivatives_eti_t7_v1_0_tcp_heuristic)

-- Register Eurex Derivatives Eti T7 1.0 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_eurex_derivatives_eti_t7_v1_0)
