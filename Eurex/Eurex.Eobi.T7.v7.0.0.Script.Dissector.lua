...
eurex_eobi_t7_v7_0_0.fields.pad1 = ProtoField.new("Pad1", "eurex.eobi.t7.v7.0.0.pad1", ftypes.BYTES)
eurex_eobi_t7_v7_0_0.fields.pad2 = ProtoField.new("Pad2", "eurex.eobi.t7.v7.0.0.pad2", ftypes.BYTES)
eurex_eobi_t7_v7_0_0.fields.pad3 = ProtoField.new("Pad3", "eurex.eobi.t7.v7.0.0.pad3", ftypes.BYTES)
eurex_eobi_t7_v7_0_0.fields.pad4 = ProtoField.new("Pad4", "eurex.eobi.t7.v7.0.0.pad4", ftypes.BYTES)
eurex_eobi_t7_v7_0_0.fields.pad5 = ProtoField.new("Pad5", "eurex.eobi.t7.v7.0.0.pad5", ftypes.BYTES)
eurex_eobi_t7_v7_0_0.fields.pad6 = ProtoField.new("Pad6", "eurex.eobi.t7.v7.0.0.pad6", ftypes.BYTES)
eurex_eobi_t7_v7_0_0.fields.pad7 = ProtoField.new("Pad7", "eurex.eobi.t7.v7.0.0.pad7", ftypes.BYTES)
...
dissect.pad7 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v7_0_0.fields.pad7, range, value, display)
...
display.md_entry_size = function(value)
  local factor = 10000
  return "MD Entry Size: "..value/factor
end
...
dissect.pad2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v7_0_0.fields.pad2, range, value, display)
...
display.offer_size = function(value)
  local factor = 10000
  return "Offer Size: "..value/factor
end
...
dissect.pad6 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v7_0_0.fields.pad6, range, value, display)
...
display.display_qty = function(value)
  local factor = 10000
  return "Display Qty: "..value/factor
end
...
dissect.pad3 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v7_0_0.fields.pad3, range, value, display)
...
dissect.pad1 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v7_0_0.fields.pad1, range, value, display)
...
display.prev_display_qty = function(value)
  local factor = 10000
  return "Prev Display Qty: "..value/factor
end
...
dissect.pad4 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v7_0_0.fields.pad4, range, value, display)
...
display.resting_cxl_qty = function(value)
  local factor = 10000
  return "Resting Cxl Qty: "..value/factor
end
...
display.imbalance_qty = function(value)
  local factor = 10000
  return "Imbalance Qty: "..value/factor
end
