...
eurex_cash_eti_t7_v5_0.fields.accrued_interes_amt = ProtoField.new("Accrued Interes Amt", "eurex.cash.eti.t7.v5.0.accruedinteresamt", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.affected_ord_grp = ProtoField.new("Affected Ord Grp", "eurex.cash.eti.t7.v5.0.affectedordgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.affected_order_request_id = ProtoField.new("Affected Order Request Id", "eurex.cash.eti.t7.v5.0.affectedorderrequestid", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.affected_order_requests_grp = ProtoField.new("Affected Order Requests Grp", "eurex.cash.eti.t7.v5.0.affectedorderrequestsgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.alloc_id = ProtoField.new("Alloc Id", "eurex.cash.eti.t7.v5.0.allocid", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.alloc_method = ProtoField.new("Alloc Method", "eurex.cash.eti.t7.v5.0.allocmethod", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.alloc_qty = ProtoField.new("Alloc Qty", "eurex.cash.eti.t7.v5.0.allocqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.approve_tes_trade_request = ProtoField.new("Approve Tes Trade Request", "eurex.cash.eti.t7.v5.0.approvetestraderequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.best_bid_px = ProtoField.new("Best Bid Px", "eurex.cash.eti.t7.v5.0.bestbidpx", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.best_bid_size = ProtoField.new("Best Bid Size", "eurex.cash.eti.t7.v5.0.bestbidsize", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.best_offer_px = ProtoField.new("Best Offer Px", "eurex.cash.eti.t7.v5.0.bestofferpx", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.best_offer_size = ProtoField.new("Best Offer Size", "eurex.cash.eti.t7.v5.0.bestoffersize", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.best_quote_execution_report = ProtoField.new("Best Quote Execution Report", "eurex.cash.eti.t7.v5.0.bestquoteexecutionreport", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.best_quote_response = ProtoField.new("Best Quote Response", "eurex.cash.eti.t7.v5.0.bestquoteresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.bid_cxl_size = ProtoField.new("Bid Cxl Size", "eurex.cash.eti.t7.v5.0.bidcxlsize", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.bid_px = ProtoField.new("Bid Px", "eurex.cash.eti.t7.v5.0.bidpx", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.bid_size = ProtoField.new("Bid Size", "eurex.cash.eti.t7.v5.0.bidsize", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.clearing_instruction = ProtoField.new("Clearing Instruction", "eurex.cash.eti.t7.v5.0.clearinginstruction", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.coupon_rate = ProtoField.new("Coupon Rate", "eurex.cash.eti.t7.v5.0.couponrate", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.crossed_indicator = ProtoField.new("Crossed Indicator", "eurex.cash.eti.t7.v5.0.crossedindicator", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.cum_qty = ProtoField.new("Cum Qty", "eurex.cash.eti.t7.v5.0.cumqty", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.currency = ProtoField.new("Currency", "eurex.cash.eti.t7.v5.0.currency", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.cxl_qty = ProtoField.new("Cxl Qty", "eurex.cash.eti.t7.v5.0.cxlqty", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.cxl_size = ProtoField.new("Cxl Size", "eurex.cash.eti.t7.v5.0.cxlsize", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.default_cstm_appl_ver_sub_id = ProtoField.new("Default Cstm Appl Ver Sub Id", "eurex.cash.eti.t7.v5.0.defaultcstmapplversubid", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.delete_reason = ProtoField.new("Delete Reason", "eurex.cash.eti.t7.v5.0.deletereason", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.delete_tes_trade_request = ProtoField.new("Delete Tes Trade Request", "eurex.cash.eti.t7.v5.0.deletetestraderequest", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.display_high_qty = ProtoField.new("Display High Qty", "eurex.cash.eti.t7.v5.0.displayhighqty", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.display_low_qty = ProtoField.new("Display Low Qty", "eurex.cash.eti.t7.v5.0.displaylowqty", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.display_qty = ProtoField.new("Display Qty", "eurex.cash.eti.t7.v5.0.displayqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.enrichment_rules_grp = ProtoField.new("Enrichment Rules Grp", "eurex.cash.eti.t7.v5.0.enrichmentrulesgrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.enter_best_quote_request = ProtoField.new("Enter Best Quote Request", "eurex.cash.eti.t7.v5.0.enterbestquoterequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.enter_tes_trade_request = ProtoField.new("Enter Tes Trade Request", "eurex.cash.eti.t7.v5.0.entertestraderequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.event_date = ProtoField.new("Event Date", "eurex.cash.eti.t7.v5.0.eventdate", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.event_px = ProtoField.new("Event Px", "eurex.cash.eti.t7.v5.0.eventpx", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.event_type = ProtoField.new("Event Type", "eurex.cash.eti.t7.v5.0.eventtype", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.ex_destination_type = ProtoField.new("Ex Destination Type", "eurex.cash.eti.t7.v5.0.exdestinationtype", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.executing_trader = ProtoField.new("Executing Trader", "eurex.cash.eti.t7.v5.0.executingtrader", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.executing_trader_qualifier = ProtoField.new("Executing Trader Qualifier", "eurex.cash.eti.t7.v5.0.executingtraderqualifier", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.expire_date = ProtoField.new("Expire Date", "eurex.cash.eti.t7.v5.0.expiredate", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.expire_time = ProtoField.new("Expire Time", "eurex.cash.eti.t7.v5.0.expiretime", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.fill_qty = ProtoField.new("Fill Qty", "eurex.cash.eti.t7.v5.0.fillqty", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.fills_grp = ProtoField.new("Fills Grp", "eurex.cash.eti.t7.v5.0.fillsgrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.firm_negotiation_id = ProtoField.new("Firm Negotiation Id", "eurex.cash.eti.t7.v5.0.firmnegotiationid", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.firm_trade_id = ProtoField.new("Firm Trade Id", "eurex.cash.eti.t7.v5.0.firmtradeid", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.fix_cl_ord_id = ProtoField.new("Fix Cl Ord Id", "eurex.cash.eti.t7.v5.0.fixclordid", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.free_text_2 = ProtoField.new("Free Text 2", "eurex.cash.eti.t7.v5.0.freetext2", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.free_text_4 = ProtoField.new("Free Text 4", "eurex.cash.eti.t7.v5.0.freetext4", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.free_text_5 = ProtoField.new("Free Text 5", "eurex.cash.eti.t7.v5.0.freetext5", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.imbalance_qty = ProtoField.new("Imbalance Qty", "eurex.cash.eti.t7.v5.0.imbalanceqty", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.individual_alloc_id = ProtoField.new("Individual Alloc Id", "eurex.cash.eti.t7.v5.0.individualallocid", ftypes.UINT32)
...
eurex_cash_eti_t7_v5_0.fields.issuer_notification = ProtoField.new("Issuer Notification", "eurex.cash.eti.t7.v5.0.issuernotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.issuer_security_state_change_request = ProtoField.new("Issuer Security State Change Request", "eurex.cash.eti.t7.v5.0.issuersecuritystatechangerequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.issuer_security_state_change_response = ProtoField.new("Issuer Security State Change Response", "eurex.cash.eti.t7.v5.0.issuersecuritystatechangeresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.last_coupon_deviation_indicator = ProtoField.new("Last Coupon Deviation Indicator", "eurex.cash.eti.t7.v5.0.lastcoupondeviationindicator", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.last_mkt = ProtoField.new("Last Mkt", "eurex.cash.eti.t7.v5.0.lastmkt", ftypes.UINT16)
eurex_cash_eti_t7_v5_0.fields.last_px = ProtoField.new("Last Px", "eurex.cash.eti.t7.v5.0.lastpx", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.last_qty = ProtoField.new("Last Qty", "eurex.cash.eti.t7.v5.0.lastqty", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.leaves_qty = ProtoField.new("Leaves Qty", "eurex.cash.eti.t7.v5.0.leavesqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.md_book_type = ProtoField.new("Md Book Type", "eurex.cash.eti.t7.v5.0.mdbooktype", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.md_sub_book_type = ProtoField.new("Md Sub Book Type", "eurex.cash.eti.t7.v5.0.mdsubbooktype", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.message_event_source = ProtoField.new("Message Event Source", "eurex.cash.eti.t7.v5.0.messageeventsource", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.message_header_in = ProtoField.new("Message Header In", "eurex.cash.eti.t7.v5.0.messageheaderin", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.message_header_out = ProtoField.new("Message Header Out", "eurex.cash.eti.t7.v5.0.messageheaderout", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.modify_tes_trade_request = ProtoField.new("Modify Tes Trade Request", "eurex.cash.eti.t7.v5.0.modifytestraderequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.msg_seq_num = ProtoField.new("Msg Seq Num", "eurex.cash.eti.t7.v5.0.msgseqnum", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.negotiation_id = ProtoField.new("Negotiation Id", "eurex.cash.eti.t7.v5.0.negotiationid", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.negotiation_start_time = ProtoField.new("Negotiation Start Time", "eurex.cash.eti.t7.v5.0.negotiationstarttime", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.no_affected_order_requests = ProtoField.new("No Affected Order Requests", "eurex.cash.eti.t7.v5.0.noaffectedorderrequests", ftypes.UINT16)
...
eurex_cash_eti_t7_v5_0.fields.no_events = ProtoField.new("No Events", "eurex.cash.eti.t7.v5.0.noevents", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.no_order_book_items = ProtoField.new("No Order Book Items", "eurex.cash.eti.t7.v5.0.noorderbookitems", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.no_quote_side_entries = ProtoField.new("No Quote Side Entries", "eurex.cash.eti.t7.v5.0.noquotesideentries", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.no_sessions = ProtoField.new("No Sessions", "eurex.cash.eti.t7.v5.0.nosessions", ftypes.UINT16)
eurex_cash_eti_t7_v5_0.fields.no_side_allocs = ProtoField.new("No Side Allocs", "eurex.cash.eti.t7.v5.0.nosideallocs", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.no_target_party_i_ds = ProtoField.new("No Target Party I Ds", "eurex.cash.eti.t7.v5.0.notargetpartyids", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.not_affected_orders_grp = ProtoField.new("Not Affected Orders Grp", "eurex.cash.eti.t7.v5.0.notaffectedordersgrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.not_affected_securities_grp = ProtoField.new("Not Affected Securities Grp", "eurex.cash.eti.t7.v5.0.notaffectedsecuritiesgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.notif_header = ProtoField.new("Notif Header", "eurex.cash.eti.t7.v5.0.notifheader", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.nr_response_header_me = ProtoField.new("Nr Response Header Me", "eurex.cash.eti.t7.v5.0.nrresponseheaderme", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.nrbc_header = ProtoField.new("Nrbc Header", "eurex.cash.eti.t7.v5.0.nrbcheader", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.num_days_interest = ProtoField.new("Num Days Interest", "eurex.cash.eti.t7.v5.0.numdaysinterest", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.number_of_resp_disclosure_instruction = ProtoField.new("Number Of Resp Disclosure Instruction", "eurex.cash.eti.t7.v5.0.numberofrespdisclosureinstruction", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.number_of_respondents = ProtoField.new("Number Of Respondents", "eurex.cash.eti.t7.v5.0.numberofrespondents", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.offer_cxl_size = ProtoField.new("Offer Cxl Size", "eurex.cash.eti.t7.v5.0.offercxlsize", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.offer_px = ProtoField.new("Offer Px", "eurex.cash.eti.t7.v5.0.offerpx", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.offer_size = ProtoField.new("Offer Size", "eurex.cash.eti.t7.v5.0.offersize", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.order_attribute_liquidity_provision = ProtoField.new("Order Attribute Liquidity Provision", "eurex.cash.eti.t7.v5.0.orderattributeliquidityprovision", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.order_book_item_grp = ProtoField.new("Order Book Item Grp", "eurex.cash.eti.t7.v5.0.orderbookitemgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.order_event_type = ProtoField.new("Order Event Type", "eurex.cash.eti.t7.v5.0.ordereventtype", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.order_origination = ProtoField.new("Order Origination", "eurex.cash.eti.t7.v5.0.orderorigination", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.order_qty = ProtoField.new("Order Qty", "eurex.cash.eti.t7.v5.0.orderqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.package_id = ProtoField.new("Package Id", "eurex.cash.eti.t7.v5.0.packageid", ftypes.UINT32)
...
eurex_cash_eti_t7_v5_0.fields.party_details_grp = ProtoField.new("Party Details Grp", "eurex.cash.eti.t7.v5.0.partydetailsgrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.party_entering_firm = ProtoField.new("Party Entering Firm", "eurex.cash.eti.t7.v5.0.partyenteringfirm", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.party_entering_trader = ProtoField.new("Party Entering Trader", "eurex.cash.eti.t7.v5.0.partyenteringtrader", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.party_executing_firm = ProtoField.new("Party Executing Firm", "eurex.cash.eti.t7.v5.0.partyexecutingfirm", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.party_executing_trader = ProtoField.new("Party Executing Trader", "eurex.cash.eti.t7.v5.0.partyexecutingtrader", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.party_id_client_id = ProtoField.new("Party Id Client Id", "eurex.cash.eti.t7.v5.0.partyidclientid", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.party_id_investment_decision_maker = ProtoField.new("Party Id Investment Decision Maker", "eurex.cash.eti.t7.v5.0.partyidinvestmentdecisionmaker", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.party_id_investment_decision_maker_qualifier = ProtoField.new("Party Id Investment Decision Maker Qualifier", "eurex.cash.eti.t7.v5.0.partyidinvestmentdecisionmakerqualifier", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.party_id_specialist_trader = ProtoField.new("Party Id Specialist Trader", "eurex.cash.eti.t7.v5.0.partyidspecialisttrader", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.party_specialist_firm = ProtoField.new("Party Specialist Firm", "eurex.cash.eti.t7.v5.0.partyspecialistfirm", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.party_specialist_trader = ProtoField.new("Party Specialist Trader", "eurex.cash.eti.t7.v5.0.partyspecialisttrader", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.peg_offset_value_bid_px = ProtoField.new("Peg Offset Value Bid Px", "eurex.cash.eti.t7.v5.0.pegoffsetvaluebidpx", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.peg_offset_value_offer_px = ProtoField.new("Peg Offset Value Offer Px", "eurex.cash.eti.t7.v5.0.pegoffsetvalueofferpx", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.potential_exec_volume = ProtoField.new("Potential Exec Volume", "eurex.cash.eti.t7.v5.0.potentialexecvolume", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.quote_cancel_type = ProtoField.new("Quote Cancel Type", "eurex.cash.eti.t7.v5.0.quotecanceltype", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.quote_entry_ack_grp = ProtoField.new("Quote Entry Ack Grp", "eurex.cash.eti.t7.v5.0.quoteentryackgrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.quote_entry_grp = ProtoField.new("Quote Entry Grp", "eurex.cash.eti.t7.v5.0.quoteentrygrp", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.quote_event_grp = ProtoField.new("Quote Event Grp", "eurex.cash.eti.t7.v5.0.quoteeventgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.quote_event_qty = ProtoField.new("Quote Event Qty", "eurex.cash.eti.t7.v5.0.quoteeventqty", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.quote_req_id = ProtoField.new("Quote Req Id", "eurex.cash.eti.t7.v5.0.quotereqid", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.quote_request_reject_reason = ProtoField.new("Quote Request Reject Reason", "eurex.cash.eti.t7.v5.0.quoterequestrejectreason", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.quote_status = ProtoField.new("Quote Status", "eurex.cash.eti.t7.v5.0.quotestatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.quote_type = ProtoField.new("Quote Type", "eurex.cash.eti.t7.v5.0.quotetype", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.quoting_status = ProtoField.new("Quoting Status", "eurex.cash.eti.t7.v5.0.quotingstatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.rbc_header = ProtoField.new("Rbc Header", "eurex.cash.eti.t7.v5.0.rbcheader", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.rbc_header_me = ProtoField.new("Rbc Header Me", "eurex.cash.eti.t7.v5.0.rbcheaderme", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.refinancing_eligibility_indicator = ProtoField.new("Refinancing Eligibility Indicator", "eurex.cash.eti.t7.v5.0.refinancingeligibilityindicator", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.regulatory_trade_id = ProtoField.new("Regulatory Trade Id", "eurex.cash.eti.t7.v5.0.regulatorytradeid", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.reject = ProtoField.new("Reject", "eurex.cash.eti.t7.v5.0.reject", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.request_header = ProtoField.new("Request Header", "eurex.cash.eti.t7.v5.0.requestheader", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.reserved_bid_size = ProtoField.new("Reserved Bid Size", "eurex.cash.eti.t7.v5.0.reservedbidsize", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.reserved_offer_size = ProtoField.new("Reserved Offer Size", "eurex.cash.eti.t7.v5.0.reservedoffersize", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.reserved_size = ProtoField.new("Reserved Size", "eurex.cash.eti.t7.v5.0.reservedsize", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.respondent_type = ProtoField.new("Respondent Type", "eurex.cash.eti.t7.v5.0.respondenttype", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.response_header = ProtoField.new("Response Header", "eurex.cash.eti.t7.v5.0.responseheader", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.response_header_me = ProtoField.new("Response Header Me", "eurex.cash.eti.t7.v5.0.responseheaderme", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.rfq_broadcast = ProtoField.new("Rfq Broadcast", "eurex.cash.eti.t7.v5.0.rfqbroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.rfq_publish_indicator = ProtoField.new("Rfq Publish Indicator", "eurex.cash.eti.t7.v5.0.rfqpublishindicator", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.rfq_reject_notification = ProtoField.new("Rfq Reject Notification", "eurex.cash.eti.t7.v5.0.rfqrejectnotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.rfq_request = ProtoField.new("Rfq Request", "eurex.cash.eti.t7.v5.0.rfqrequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.rfq_requester_disclosure_instruction = ProtoField.new("Rfq Requester Disclosure Instruction", "eurex.cash.eti.t7.v5.0.rfqrequesterdisclosureinstruction", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.rfq_response = ProtoField.new("Rfq Response", "eurex.cash.eti.t7.v5.0.rfqresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.rfq_specialist_broadcast = ProtoField.new("Rfq Specialist Broadcast", "eurex.cash.eti.t7.v5.0.rfqspecialistbroadcast", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.root_party_entering_trader = ProtoField.new("Root Party Entering Trader", "eurex.cash.eti.t7.v5.0.rootpartyenteringtrader", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.root_party_id_client_id = ProtoField.new("Root Party Id Client Id", "eurex.cash.eti.t7.v5.0.rootpartyidclientid", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.root_party_id_execution_venue = ProtoField.new("Root Party Id Execution Venue", "eurex.cash.eti.t7.v5.0.rootpartyidexecutionvenue", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.root_party_id_investment_decision_maker = ProtoField.new("Root Party Id Investment Decision Maker", "eurex.cash.eti.t7.v5.0.rootpartyidinvestmentdecisionmaker", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.root_party_id_investment_decision_maker_qualifier = ProtoField.new("Root Party Id Investment Decision Maker Qualifier", "eurex.cash.eti.t7.v5.0.rootpartyidinvestmentdecisionmakerqualifier", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.secondary_quote_id = ProtoField.new("Secondary Quote Id", "eurex.cash.eti.t7.v5.0.secondaryquoteid", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.secondary_trade_id = ProtoField.new("Secondary Trade Id", "eurex.cash.eti.t7.v5.0.secondarytradeid", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.security_id = ProtoField.new("Security Id", "eurex.cash.eti.t7.v5.0.securityid", ftypes.INT64)
eurex_cash_eti_t7_v5_0.fields.security_status = ProtoField.new("Security Status", "eurex.cash.eti.t7.v5.0.securitystatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.security_status_event_grp = ProtoField.new("Security Status Event Grp", "eurex.cash.eti.t7.v5.0.securitystatuseventgrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.security_status_report_id = ProtoField.new("Security Status Report Id", "eurex.cash.eti.t7.v5.0.securitystatusreportid", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.security_trading_status = ProtoField.new("Security Trading Status", "eurex.cash.eti.t7.v5.0.securitytradingstatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.selective_request_for_quote_service_status = ProtoField.new("Selective Request For Quote Service Status", "eurex.cash.eti.t7.v5.0.selectiverequestforquoteservicestatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.selective_request_for_quote_service_trade_date = ProtoField.new("Selective Request For Quote Service Trade Date", "eurex.cash.eti.t7.v5.0.selectiverequestforquoteservicetradedate", ftypes.UINT32)
...
eurex_cash_eti_t7_v5_0.fields.service_availability_market_broadcast = ProtoField.new("Service Availability Market Broadcast", "eurex.cash.eti.t7.v5.0.serviceavailabilitymarketbroadcast", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.sessions_grp = ProtoField.new("Sessions Grp", "eurex.cash.eti.t7.v5.0.sessionsgrp", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.side_alloc_grp = ProtoField.new("Side Alloc Grp", "eurex.cash.eti.t7.v5.0.sideallocgrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.side_alloc_grp_bc = ProtoField.new("Side Alloc Grp Bc", "eurex.cash.eti.t7.v5.0.sideallocgrpbc", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.side_gross_trade_amt = ProtoField.new("Side Gross Trade Amt", "eurex.cash.eti.t7.v5.0.sidegrosstradeamt", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.single_quote_request = ProtoField.new("Single Quote Request", "eurex.cash.eti.t7.v5.0.singlequoterequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.sold_out_indicator = ProtoField.new("Sold Out Indicator", "eurex.cash.eti.t7.v5.0.soldoutindicator", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.specialist_delete_all_order_broadcast = ProtoField.new("Specialist Delete All Order Broadcast", "eurex.cash.eti.t7.v5.0.specialistdeleteallorderbroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_instrument_event_notification = ProtoField.new("Specialist Instrument Event Notification", "eurex.cash.eti.t7.v5.0.specialistinstrumenteventnotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_order_book_notification = ProtoField.new("Specialist Order Book Notification", "eurex.cash.eti.t7.v5.0.specialistorderbooknotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reject_request = ProtoField.new("Specialist Rfq Reject Request", "eurex.cash.eti.t7.v5.0.specialistrfqrejectrequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reply_notification = ProtoField.new("Specialist Rfq Reply Notification", "eurex.cash.eti.t7.v5.0.specialistrfqreplynotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reply_request = ProtoField.new("Specialist Rfq Reply Request", "eurex.cash.eti.t7.v5.0.specialistrfqreplyrequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reply_response = ProtoField.new("Specialist Rfq Reply Response", "eurex.cash.eti.t7.v5.0.specialistrfqreplyresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_security_state_change_request = ProtoField.new("Specialist Security State Change Request", "eurex.cash.eti.t7.v5.0.specialistsecuritystatechangerequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.specialist_security_state_change_response = ProtoField.new("Specialist Security State Change Response", "eurex.cash.eti.t7.v5.0.specialistsecuritystatechangeresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.srqs_quote_entry_grp = ProtoField.new("Srqs Quote Entry Grp", "eurex.cash.eti.t7.v5.0.srqsquoteentrygrp", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.srqs_related_trade_id = ProtoField.new("Srqs Related Trade Id", "eurex.cash.eti.t7.v5.0.srqsrelatedtradeid", ftypes.UINT32)
...
eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_rtm_status = ProtoField.new("T 7 Entry Service Rtm Status", "eurex.cash.eti.t7.v5.0.t7entryservicertmstatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_rtm_trade_date = ProtoField.new("T 7 Entry Service Rtm Trade Date", "eurex.cash.eti.t7.v5.0.t7entryservicertmtradedate", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_status = ProtoField.new("T 7 Entry Service Status", "eurex.cash.eti.t7.v5.0.t7entryservicestatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_trade_date = ProtoField.new("T 7 Entry Service Trade Date", "eurex.cash.eti.t7.v5.0.t7entryservicetradedate", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.target_party_executing_firm = ProtoField.new("Target Party Executing Firm", "eurex.cash.eti.t7.v5.0.targetpartyexecutingfirm", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.target_party_executing_trader = ProtoField.new("Target Party Executing Trader", "eurex.cash.eti.t7.v5.0.targetpartyexecutingtrader", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.tes_approve_broadcast = ProtoField.new("Tes Approve Broadcast", "eurex.cash.eti.t7.v5.0.tesapprovebroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.tes_broadcast = ProtoField.new("Tes Broadcast", "eurex.cash.eti.t7.v5.0.tesbroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.tes_delete_broadcast = ProtoField.new("Tes Delete Broadcast", "eurex.cash.eti.t7.v5.0.tesdeletebroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.tes_exec_id = ProtoField.new("Tes Exec Id", "eurex.cash.eti.t7.v5.0.tesexecid", ftypes.UINT32)
eurex_cash_eti_t7_v5_0.fields.tes_execution_broadcast = ProtoField.new("Tes Execution Broadcast", "eurex.cash.eti.t7.v5.0.tesexecutionbroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.tes_response = ProtoField.new("Tes Response", "eurex.cash.eti.t7.v5.0.tesresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.tes_trade_broadcast = ProtoField.new("Tes Trade Broadcast", "eurex.cash.eti.t7.v5.0.testradebroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.tes_trading_session_status_broadcast = ProtoField.new("Tes Trading Session Status Broadcast", "eurex.cash.eti.t7.v5.0.testradingsessionstatusbroadcast", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.trade_alloc_status = ProtoField.new("Trade Alloc Status", "eurex.cash.eti.t7.v5.0.tradeallocstatus", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.trade_publish_indicator = ProtoField.new("Trade Publish Indicator", "eurex.cash.eti.t7.v5.0.tradepublishindicator", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.trade_report_id = ProtoField.new("Trade Report Id", "eurex.cash.eti.t7.v5.0.tradereportid", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.trade_report_text = ProtoField.new("Trade Report Text", "eurex.cash.eti.t7.v5.0.tradereporttext", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.fields.trans_bkd_time = ProtoField.new("Trans Bkd Time", "eurex.cash.eti.t7.v5.0.transbkdtime", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.transaction_delay_indicator = ProtoField.new("Transaction Delay Indicator", "eurex.cash.eti.t7.v5.0.transactiondelayindicator", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.trd_reg_ts_execution_time = ProtoField.new("Trd Reg Ts Execution Time", "eurex.cash.eti.t7.v5.0.trdregtsexecutiontime", ftypes.UINT64)
...
eurex_cash_eti_t7_v5_0.fields.trd_rpt_status = ProtoField.new("Trd Rpt Status", "eurex.cash.eti.t7.v5.0.trdrptstatus", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.trd_type = ProtoField.new("Trd Type", "eurex.cash.eti.t7.v5.0.trdtype", ftypes.UINT16)
...
eurex_cash_eti_t7_v5_0.fields.valid_until_time = ProtoField.new("Valid Until Time", "eurex.cash.eti.t7.v5.0.validuntiltime", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.value_check_type_quantity = ProtoField.new("Value Check Type Quantity", "eurex.cash.eti.t7.v5.0.valuechecktypequantity", ftypes.UINT8)
eurex_cash_eti_t7_v5_0.fields.value_check_type_value = ProtoField.new("Value Check Type Value", "eurex.cash.eti.t7.v5.0.valuechecktypevalue", ftypes.UINT8)
...
eurex_cash_eti_t7_v5_0.fields.volume_discovery_price = ProtoField.new("Volume Discovery Price", "eurex.cash.eti.t7.v5.0.volumediscoveryprice", ftypes.UINT64)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_create_deal_notification = ProtoField.new("Xetra En Light Create Deal Notification", "eurex.cash.eti.t7.v5.0.xetraenlightcreatedealnotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_deal_response = ProtoField.new("Xetra En Light Deal Response", "eurex.cash.eti.t7.v5.0.xetraenlightdealresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_enter_quote_request = ProtoField.new("Xetra En Light Enter Quote Request", "eurex.cash.eti.t7.v5.0.xetraenlightenterquoterequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_hit_quote_request = ProtoField.new("Xetra En Light Hit Quote Request", "eurex.cash.eti.t7.v5.0.xetraenlighthitquoterequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_negotiation_notification = ProtoField.new("Xetra En Light Negotiation Notification", "eurex.cash.eti.t7.v5.0.xetraenlightnegotiationnotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_negotiation_requester_notification = ProtoField.new("Xetra En Light Negotiation Requester Notification", "eurex.cash.eti.t7.v5.0.xetraenlightnegotiationrequesternotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_negotiation_status_notification = ProtoField.new("Xetra En Light Negotiation Status Notification", "eurex.cash.eti.t7.v5.0.xetraenlightnegotiationstatusnotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_open_negotiation_notification = ProtoField.new("Xetra En Light Open Negotiation Notification", "eurex.cash.eti.t7.v5.0.xetraenlightopennegotiationnotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_open_negotiation_request = ProtoField.new("Xetra En Light Open Negotiation Request", "eurex.cash.eti.t7.v5.0.xetraenlightopennegotiationrequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_open_negotiation_requester_notification = ProtoField.new("Xetra En Light Open Negotiation Requester Notification", "eurex.cash.eti.t7.v5.0.xetraenlightopennegotiationrequesternotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quote_notification = ProtoField.new("Xetra En Light Quote Notification", "eurex.cash.eti.t7.v5.0.xetraenlightquotenotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quote_requester_notification = ProtoField.new("Xetra En Light Quote Requester Notification", "eurex.cash.eti.t7.v5.0.xetraenlightquoterequesternotification", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quote_response = ProtoField.new("Xetra En Light Quote Response", "eurex.cash.eti.t7.v5.0.xetraenlightquoteresponse", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quoting_status_request = ProtoField.new("Xetra En Light Quoting Status Request", "eurex.cash.eti.t7.v5.0.xetraenlightquotingstatusrequest", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_status_broadcast = ProtoField.new("Xetra En Light Status Broadcast", "eurex.cash.eti.t7.v5.0.xetraenlightstatusbroadcast", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_target_parties = ProtoField.new("Xetra En Light Target Parties", "eurex.cash.eti.t7.v5.0.xetraenlighttargetparties", ftypes.STRING)
eurex_cash_eti_t7_v5_0.fields.xetra_en_light_update_negotiation_request = ProtoField.new("Xetra En Light Update Negotiation Request", "eurex.cash.eti.t7.v5.0.xetraenlightupdatenegotiationrequest", ftypes.STRING)
...
eurex_cash_eti_t7_v5_0.prefs.show_affected_ord_grp = Pref.bool("Show Affected Ord Grp", show.affected_ord_grp, "Parse and add Affected Ord Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_affected_order_requests_grp = Pref.bool("Show Affected Order Requests Grp", show.affected_order_requests_grp, "Parse and add Affected Order Requests Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_approve_tes_trade_request = Pref.bool("Show Approve Tes Trade Request", show.approve_tes_trade_request, "Parse and add Approve Tes Trade Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_best_quote_execution_report = Pref.bool("Show Best Quote Execution Report", show.best_quote_execution_report, "Parse and add Best Quote Execution Report to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_best_quote_response = Pref.bool("Show Best Quote Response", show.best_quote_response, "Parse and add Best Quote Response to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_delete_tes_trade_request = Pref.bool("Show Delete Tes Trade Request", show.delete_tes_trade_request, "Parse and add Delete Tes Trade Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_enrichment_rules_grp = Pref.bool("Show Enrichment Rules Grp", show.enrichment_rules_grp, "Parse and add Enrichment Rules Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_enter_best_quote_request = Pref.bool("Show Enter Best Quote Request", show.enter_best_quote_request, "Parse and add Enter Best Quote Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_enter_tes_trade_request = Pref.bool("Show Enter Tes Trade Request", show.enter_tes_trade_request, "Parse and add Enter Tes Trade Request to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_fills_grp = Pref.bool("Show Fills Grp", show.fills_grp, "Parse and add Fills Grp to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_issuer_notification = Pref.bool("Show Issuer Notification", show.issuer_notification, "Parse and add Issuer Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_issuer_security_state_change_request = Pref.bool("Show Issuer Security State Change Request", show.issuer_security_state_change_request, "Parse and add Issuer Security State Change Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_issuer_security_state_change_response = Pref.bool("Show Issuer Security State Change Response", show.issuer_security_state_change_response, "Parse and add Issuer Security State Change Response to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_message_header_in = Pref.bool("Show Message Header In", show.message_header_in, "Parse and add Message Header In to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_message_header_out = Pref.bool("Show Message Header Out", show.message_header_out, "Parse and add Message Header Out to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_modify_tes_trade_request = Pref.bool("Show Modify Tes Trade Request", show.modify_tes_trade_request, "Parse and add Modify Tes Trade Request to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_not_affected_orders_grp = Pref.bool("Show Not Affected Orders Grp", show.not_affected_orders_grp, "Parse and add Not Affected Orders Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_not_affected_securities_grp = Pref.bool("Show Not Affected Securities Grp", show.not_affected_securities_grp, "Parse and add Not Affected Securities Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_notif_header = Pref.bool("Show Notif Header", show.notif_header, "Parse and add Notif Header to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_nr_response_header_me = Pref.bool("Show Nr Response Header Me", show.nr_response_header_me, "Parse and add Nr Response Header Me to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_nrbc_header = Pref.bool("Show Nrbc Header", show.nrbc_header, "Parse and add Nrbc Header to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_order_book_item_grp = Pref.bool("Show Order Book Item Grp", show.order_book_item_grp, "Parse and add Order Book Item Grp to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_party_details_grp = Pref.bool("Show Party Details Grp", show.party_details_grp, "Parse and add Party Details Grp to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_quote_entry_ack_grp = Pref.bool("Show Quote Entry Ack Grp", show.quote_entry_ack_grp, "Parse and add Quote Entry Ack Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_quote_entry_grp = Pref.bool("Show Quote Entry Grp", show.quote_entry_grp, "Parse and add Quote Entry Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_quote_event_grp = Pref.bool("Show Quote Event Grp", show.quote_event_grp, "Parse and add Quote Event Grp to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_rbc_header = Pref.bool("Show Rbc Header", show.rbc_header, "Parse and add Rbc Header to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_rbc_header_me = Pref.bool("Show Rbc Header Me", show.rbc_header_me, "Parse and add Rbc Header Me to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_reject = Pref.bool("Show Reject", show.reject, "Parse and add Reject to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_request_header = Pref.bool("Show Request Header", show.request_header, "Parse and add Request Header to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_response_header = Pref.bool("Show Response Header", show.response_header, "Parse and add Response Header to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_response_header_me = Pref.bool("Show Response Header Me", show.response_header_me, "Parse and add Response Header Me to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_rfq_broadcast = Pref.bool("Show Rfq Broadcast", show.rfq_broadcast, "Parse and add Rfq Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_rfq_reject_notification = Pref.bool("Show Rfq Reject Notification", show.rfq_reject_notification, "Parse and add Rfq Reject Notification to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_rfq_specialist_broadcast = Pref.bool("Show Rfq Specialist Broadcast", show.rfq_specialist_broadcast, "Parse and add Rfq Specialist Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_security_status_event_grp = Pref.bool("Show Security Status Event Grp", show.security_status_event_grp, "Parse and add Security Status Event Grp to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_service_availability_market_broadcast = Pref.bool("Show Service Availability Market Broadcast", show.service_availability_market_broadcast, "Parse and add Service Availability Market Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_sessions_grp = Pref.bool("Show Sessions Grp", show.sessions_grp, "Parse and add Sessions Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_side_alloc_grp = Pref.bool("Show Side Alloc Grp", show.side_alloc_grp, "Parse and add Side Alloc Grp to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_side_alloc_grp_bc = Pref.bool("Show Side Alloc Grp Bc", show.side_alloc_grp_bc, "Parse and add Side Alloc Grp Bc to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_single_quote_request = Pref.bool("Show Single Quote Request", show.single_quote_request, "Parse and add Single Quote Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_delete_all_order_broadcast = Pref.bool("Show Specialist Delete All Order Broadcast", show.specialist_delete_all_order_broadcast, "Parse and add Specialist Delete All Order Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_instrument_event_notification = Pref.bool("Show Specialist Instrument Event Notification", show.specialist_instrument_event_notification, "Parse and add Specialist Instrument Event Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_order_book_notification = Pref.bool("Show Specialist Order Book Notification", show.specialist_order_book_notification, "Parse and add Specialist Order Book Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reject_request = Pref.bool("Show Specialist Rfq Reject Request", show.specialist_rfq_reject_request, "Parse and add Specialist Rfq Reject Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_notification = Pref.bool("Show Specialist Rfq Reply Notification", show.specialist_rfq_reply_notification, "Parse and add Specialist Rfq Reply Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_request = Pref.bool("Show Specialist Rfq Reply Request", show.specialist_rfq_reply_request, "Parse and add Specialist Rfq Reply Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_response = Pref.bool("Show Specialist Rfq Reply Response", show.specialist_rfq_reply_response, "Parse and add Specialist Rfq Reply Response to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_security_state_change_request = Pref.bool("Show Specialist Security State Change Request", show.specialist_security_state_change_request, "Parse and add Specialist Security State Change Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_specialist_security_state_change_response = Pref.bool("Show Specialist Security State Change Response", show.specialist_security_state_change_response, "Parse and add Specialist Security State Change Response to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_srqs_quote_entry_grp = Pref.bool("Show Srqs Quote Entry Grp", show.srqs_quote_entry_grp, "Parse and add Srqs Quote Entry Grp to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_tes_approve_broadcast = Pref.bool("Show Tes Approve Broadcast", show.tes_approve_broadcast, "Parse and add Tes Approve Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_tes_broadcast = Pref.bool("Show Tes Broadcast", show.tes_broadcast, "Parse and add Tes Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_tes_delete_broadcast = Pref.bool("Show Tes Delete Broadcast", show.tes_delete_broadcast, "Parse and add Tes Delete Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_tes_execution_broadcast = Pref.bool("Show Tes Execution Broadcast", show.tes_execution_broadcast, "Parse and add Tes Execution Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_tes_response = Pref.bool("Show Tes Response", show.tes_response, "Parse and add Tes Response to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_tes_trade_broadcast = Pref.bool("Show Tes Trade Broadcast", show.tes_trade_broadcast, "Parse and add Tes Trade Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_tes_trading_session_status_broadcast = Pref.bool("Show Tes Trading Session Status Broadcast", show.tes_trading_session_status_broadcast, "Parse and add Tes Trading Session Status Broadcast to protocol tree")
...
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_create_deal_notification = Pref.bool("Show Xetra En Light Create Deal Notification", show.xetra_en_light_create_deal_notification, "Parse and add Xetra En Light Create Deal Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_deal_response = Pref.bool("Show Xetra En Light Deal Response", show.xetra_en_light_deal_response, "Parse and add Xetra En Light Deal Response to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_enter_quote_request = Pref.bool("Show Xetra En Light Enter Quote Request", show.xetra_en_light_enter_quote_request, "Parse and add Xetra En Light Enter Quote Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_hit_quote_request = Pref.bool("Show Xetra En Light Hit Quote Request", show.xetra_en_light_hit_quote_request, "Parse and add Xetra En Light Hit Quote Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_notification = Pref.bool("Show Xetra En Light Negotiation Notification", show.xetra_en_light_negotiation_notification, "Parse and add Xetra En Light Negotiation Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_requester_notification = Pref.bool("Show Xetra En Light Negotiation Requester Notification", show.xetra_en_light_negotiation_requester_notification, "Parse and add Xetra En Light Negotiation Requester Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_status_notification = Pref.bool("Show Xetra En Light Negotiation Status Notification", show.xetra_en_light_negotiation_status_notification, "Parse and add Xetra En Light Negotiation Status Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_notification = Pref.bool("Show Xetra En Light Open Negotiation Notification", show.xetra_en_light_open_negotiation_notification, "Parse and add Xetra En Light Open Negotiation Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_request = Pref.bool("Show Xetra En Light Open Negotiation Request", show.xetra_en_light_open_negotiation_request, "Parse and add Xetra En Light Open Negotiation Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_requester_notification = Pref.bool("Show Xetra En Light Open Negotiation Requester Notification", show.xetra_en_light_open_negotiation_requester_notification, "Parse and add Xetra En Light Open Negotiation Requester Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_notification = Pref.bool("Show Xetra En Light Quote Notification", show.xetra_en_light_quote_notification, "Parse and add Xetra En Light Quote Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_requester_notification = Pref.bool("Show Xetra En Light Quote Requester Notification", show.xetra_en_light_quote_requester_notification, "Parse and add Xetra En Light Quote Requester Notification to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_response = Pref.bool("Show Xetra En Light Quote Response", show.xetra_en_light_quote_response, "Parse and add Xetra En Light Quote Response to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quoting_status_request = Pref.bool("Show Xetra En Light Quoting Status Request", show.xetra_en_light_quoting_status_request, "Parse and add Xetra En Light Quoting Status Request to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_status_broadcast = Pref.bool("Show Xetra En Light Status Broadcast", show.xetra_en_light_status_broadcast, "Parse and add Xetra En Light Status Broadcast to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_target_parties = Pref.bool("Show Xetra En Light Target Parties", show.xetra_en_light_target_parties, "Parse and add Xetra En Light Target Parties to protocol tree")
eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_update_negotiation_request = Pref.bool("Show Xetra En Light Update Negotiation Request", show.xetra_en_light_update_negotiation_request, "Parse and add Xetra En Light Update Negotiation Request to protocol tree")
...
function eurex_cash_eti_t7_v5_0.prefs_changed()
  ...
  if show.affected_ord_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_affected_ord_grp then
    show.affected_ord_grp = eurex_cash_eti_t7_v5_0.prefs.show_affected_ord_grp
    changed = true
  end
  if show.affected_order_requests_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_affected_order_requests_grp then
    show.affected_order_requests_grp = eurex_cash_eti_t7_v5_0.prefs.show_affected_order_requests_grp
    changed = true
  end
  if show.approve_tes_trade_request ~= eurex_cash_eti_t7_v5_0.prefs.show_approve_tes_trade_request then
    show.approve_tes_trade_request = eurex_cash_eti_t7_v5_0.prefs.show_approve_tes_trade_request
    changed = true
  end
  if show.best_quote_execution_report ~= eurex_cash_eti_t7_v5_0.prefs.show_best_quote_execution_report then
    show.best_quote_execution_report = eurex_cash_eti_t7_v5_0.prefs.show_best_quote_execution_report
    changed = true
  end
  if show.best_quote_response ~= eurex_cash_eti_t7_v5_0.prefs.show_best_quote_response then
    show.best_quote_response = eurex_cash_eti_t7_v5_0.prefs.show_best_quote_response
    changed = true
  end
  ...
  if show.delete_tes_trade_request ~= eurex_cash_eti_t7_v5_0.prefs.show_delete_tes_trade_request then
    show.delete_tes_trade_request = eurex_cash_eti_t7_v5_0.prefs.show_delete_tes_trade_request
    changed = true
  end
  if show.enrichment_rules_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_enrichment_rules_grp then
    show.enrichment_rules_grp = eurex_cash_eti_t7_v5_0.prefs.show_enrichment_rules_grp
    changed = true
  end
  if show.enter_best_quote_request ~= eurex_cash_eti_t7_v5_0.prefs.show_enter_best_quote_request then
    show.enter_best_quote_request = eurex_cash_eti_t7_v5_0.prefs.show_enter_best_quote_request
    changed = true
  end
  if show.enter_tes_trade_request ~= eurex_cash_eti_t7_v5_0.prefs.show_enter_tes_trade_request then
    show.enter_tes_trade_request = eurex_cash_eti_t7_v5_0.prefs.show_enter_tes_trade_request
    changed = true
  end
  ...
  if show.fills_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_fills_grp then
    show.fills_grp = eurex_cash_eti_t7_v5_0.prefs.show_fills_grp
    changed = true
  end
  ...
  if show.issuer_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_issuer_notification then
    show.issuer_notification = eurex_cash_eti_t7_v5_0.prefs.show_issuer_notification
    changed = true
  end
  if show.issuer_security_state_change_request ~= eurex_cash_eti_t7_v5_0.prefs.show_issuer_security_state_change_request then
    show.issuer_security_state_change_request = eurex_cash_eti_t7_v5_0.prefs.show_issuer_security_state_change_request
    changed = true
  end
  if show.issuer_security_state_change_response ~= eurex_cash_eti_t7_v5_0.prefs.show_issuer_security_state_change_response then
    show.issuer_security_state_change_response = eurex_cash_eti_t7_v5_0.prefs.show_issuer_security_state_change_response
    changed = true
  end
  ...
  if show.message_header_in ~= eurex_cash_eti_t7_v5_0.prefs.show_message_header_in then
    show.message_header_in = eurex_cash_eti_t7_v5_0.prefs.show_message_header_in
    changed = true
  end
  if show.message_header_out ~= eurex_cash_eti_t7_v5_0.prefs.show_message_header_out then
    show.message_header_out = eurex_cash_eti_t7_v5_0.prefs.show_message_header_out
    changed = true
  end
  ...
  if show.modify_tes_trade_request ~= eurex_cash_eti_t7_v5_0.prefs.show_modify_tes_trade_request then
    show.modify_tes_trade_request = eurex_cash_eti_t7_v5_0.prefs.show_modify_tes_trade_request
    changed = true
  end
  ...
  if show.not_affected_orders_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_not_affected_orders_grp then
    show.not_affected_orders_grp = eurex_cash_eti_t7_v5_0.prefs.show_not_affected_orders_grp
    changed = true
  end
  if show.not_affected_securities_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_not_affected_securities_grp then
    show.not_affected_securities_grp = eurex_cash_eti_t7_v5_0.prefs.show_not_affected_securities_grp
    changed = true
  end
  if show.notif_header ~= eurex_cash_eti_t7_v5_0.prefs.show_notif_header then
    show.notif_header = eurex_cash_eti_t7_v5_0.prefs.show_notif_header
    changed = true
  end
  if show.nr_response_header_me ~= eurex_cash_eti_t7_v5_0.prefs.show_nr_response_header_me then
    show.nr_response_header_me = eurex_cash_eti_t7_v5_0.prefs.show_nr_response_header_me
    changed = true
  end
  if show.nrbc_header ~= eurex_cash_eti_t7_v5_0.prefs.show_nrbc_header then
    show.nrbc_header = eurex_cash_eti_t7_v5_0.prefs.show_nrbc_header
    changed = true
  end
  if show.order_book_item_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_order_book_item_grp then
    show.order_book_item_grp = eurex_cash_eti_t7_v5_0.prefs.show_order_book_item_grp
    changed = true
  end
  ...
  if show.party_details_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_party_details_grp then
    show.party_details_grp = eurex_cash_eti_t7_v5_0.prefs.show_party_details_grp
    changed = true
  end
  ...
  if show.quote_entry_ack_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_quote_entry_ack_grp then
    show.quote_entry_ack_grp = eurex_cash_eti_t7_v5_0.prefs.show_quote_entry_ack_grp
    changed = true
  end
  if show.quote_entry_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_quote_entry_grp then
    show.quote_entry_grp = eurex_cash_eti_t7_v5_0.prefs.show_quote_entry_grp
    changed = true
  end
  if show.quote_event_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_quote_event_grp then
    show.quote_event_grp = eurex_cash_eti_t7_v5_0.prefs.show_quote_event_grp
    changed = true
  end
  ...
  if show.rbc_header ~= eurex_cash_eti_t7_v5_0.prefs.show_rbc_header then
    show.rbc_header = eurex_cash_eti_t7_v5_0.prefs.show_rbc_header
    changed = true
  end
  if show.rbc_header_me ~= eurex_cash_eti_t7_v5_0.prefs.show_rbc_header_me then
    show.rbc_header_me = eurex_cash_eti_t7_v5_0.prefs.show_rbc_header_me
    changed = true
  end
  ...
  if show.request_header ~= eurex_cash_eti_t7_v5_0.prefs.show_request_header then
    show.request_header = eurex_cash_eti_t7_v5_0.prefs.show_request_header
    changed = true
  end
  if show.response_header ~= eurex_cash_eti_t7_v5_0.prefs.show_response_header then
    show.response_header = eurex_cash_eti_t7_v5_0.prefs.show_response_header
    changed = true
  end
  if show.response_header_me ~= eurex_cash_eti_t7_v5_0.prefs.show_response_header_me then
    show.response_header_me = eurex_cash_eti_t7_v5_0.prefs.show_response_header_me
    changed = true
  end
  ...
  if show.rfq_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_rfq_broadcast then
    show.rfq_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_rfq_broadcast
    changed = true
  end
  if show.rfq_reject_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_rfq_reject_notification then
    show.rfq_reject_notification = eurex_cash_eti_t7_v5_0.prefs.show_rfq_reject_notification
    changed = true
  end
  ...
  if show.rfq_specialist_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_rfq_specialist_broadcast then
    show.rfq_specialist_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_rfq_specialist_broadcast
    changed = true
  end
  if show.security_status_event_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_security_status_event_grp then
    show.security_status_event_grp = eurex_cash_eti_t7_v5_0.prefs.show_security_status_event_grp
    changed = true
  end
  ...
  if show.service_availability_market_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_service_availability_market_broadcast then
    show.service_availability_market_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_service_availability_market_broadcast
    changed = true
  end
  if show.sessions_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_sessions_grp then
    show.sessions_grp = eurex_cash_eti_t7_v5_0.prefs.show_sessions_grp
    changed = true
  end
  if show.side_alloc_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_side_alloc_grp then
    show.side_alloc_grp = eurex_cash_eti_t7_v5_0.prefs.show_side_alloc_grp
    changed = true
  end
  if show.side_alloc_grp_bc ~= eurex_cash_eti_t7_v5_0.prefs.show_side_alloc_grp_bc then
    show.side_alloc_grp_bc = eurex_cash_eti_t7_v5_0.prefs.show_side_alloc_grp_bc
    changed = true
  end
  if show.single_quote_request ~= eurex_cash_eti_t7_v5_0.prefs.show_single_quote_request then
    show.single_quote_request = eurex_cash_eti_t7_v5_0.prefs.show_single_quote_request
    changed = true
  end
  if show.specialist_delete_all_order_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_delete_all_order_broadcast then
    show.specialist_delete_all_order_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_specialist_delete_all_order_broadcast
    changed = true
  end
  if show.specialist_instrument_event_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_instrument_event_notification then
    show.specialist_instrument_event_notification = eurex_cash_eti_t7_v5_0.prefs.show_specialist_instrument_event_notification
    changed = true
  end
  if show.specialist_order_book_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_order_book_notification then
    show.specialist_order_book_notification = eurex_cash_eti_t7_v5_0.prefs.show_specialist_order_book_notification
    changed = true
  end
  if show.specialist_rfq_reject_request ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reject_request then
    show.specialist_rfq_reject_request = eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reject_request
    changed = true
  end
  if show.specialist_rfq_reply_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_notification then
    show.specialist_rfq_reply_notification = eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_notification
    changed = true
  end
  if show.specialist_rfq_reply_request ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_request then
    show.specialist_rfq_reply_request = eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_request
    changed = true
  end
  if show.specialist_rfq_reply_response ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_response then
    show.specialist_rfq_reply_response = eurex_cash_eti_t7_v5_0.prefs.show_specialist_rfq_reply_response
    changed = true
  end
  if show.specialist_security_state_change_request ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_security_state_change_request then
    show.specialist_security_state_change_request = eurex_cash_eti_t7_v5_0.prefs.show_specialist_security_state_change_request
    changed = true
  end
  if show.specialist_security_state_change_response ~= eurex_cash_eti_t7_v5_0.prefs.show_specialist_security_state_change_response then
    show.specialist_security_state_change_response = eurex_cash_eti_t7_v5_0.prefs.show_specialist_security_state_change_response
    changed = true
  end
  if show.srqs_quote_entry_grp ~= eurex_cash_eti_t7_v5_0.prefs.show_srqs_quote_entry_grp then
    show.srqs_quote_entry_grp = eurex_cash_eti_t7_v5_0.prefs.show_srqs_quote_entry_grp
    changed = true
  end
  ...
  if show.tes_approve_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_tes_approve_broadcast then
    show.tes_approve_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_tes_approve_broadcast
    changed = true
  end
  if show.tes_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_tes_broadcast then
    show.tes_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_tes_broadcast
    changed = true
  end
  if show.tes_delete_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_tes_delete_broadcast then
    show.tes_delete_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_tes_delete_broadcast
    changed = true
  end
  if show.tes_execution_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_tes_execution_broadcast then
    show.tes_execution_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_tes_execution_broadcast
    changed = true
  end
  if show.tes_response ~= eurex_cash_eti_t7_v5_0.prefs.show_tes_response then
    show.tes_response = eurex_cash_eti_t7_v5_0.prefs.show_tes_response
    changed = true
  end
  if show.tes_trade_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_tes_trade_broadcast then
    show.tes_trade_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_tes_trade_broadcast
    changed = true
  end
  if show.tes_trading_session_status_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_tes_trading_session_status_broadcast then
    show.tes_trading_session_status_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_tes_trading_session_status_broadcast
    changed = true
  end
  ...
  if show.xetra_en_light_create_deal_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_create_deal_notification then
    show.xetra_en_light_create_deal_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_create_deal_notification
    changed = true
  end
  if show.xetra_en_light_deal_response ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_deal_response then
    show.xetra_en_light_deal_response = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_deal_response
    changed = true
  end
  if show.xetra_en_light_enter_quote_request ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_enter_quote_request then
    show.xetra_en_light_enter_quote_request = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_enter_quote_request
    changed = true
  end
  if show.xetra_en_light_hit_quote_request ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_hit_quote_request then
    show.xetra_en_light_hit_quote_request = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_hit_quote_request
    changed = true
  end
  if show.xetra_en_light_negotiation_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_notification then
    show.xetra_en_light_negotiation_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_notification
    changed = true
  end
  if show.xetra_en_light_negotiation_requester_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_requester_notification then
    show.xetra_en_light_negotiation_requester_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_requester_notification
    changed = true
  end
  if show.xetra_en_light_negotiation_status_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_status_notification then
    show.xetra_en_light_negotiation_status_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_negotiation_status_notification
    changed = true
  end
  if show.xetra_en_light_open_negotiation_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_notification then
    show.xetra_en_light_open_negotiation_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_notification
    changed = true
  end
  if show.xetra_en_light_open_negotiation_request ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_request then
    show.xetra_en_light_open_negotiation_request = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_request
    changed = true
  end
  if show.xetra_en_light_open_negotiation_requester_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_requester_notification then
    show.xetra_en_light_open_negotiation_requester_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_open_negotiation_requester_notification
    changed = true
  end
  if show.xetra_en_light_quote_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_notification then
    show.xetra_en_light_quote_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_notification
    changed = true
  end
  if show.xetra_en_light_quote_requester_notification ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_requester_notification then
    show.xetra_en_light_quote_requester_notification = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_requester_notification
    changed = true
  end
  if show.xetra_en_light_quote_response ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_response then
    show.xetra_en_light_quote_response = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quote_response
    changed = true
  end
  if show.xetra_en_light_quoting_status_request ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quoting_status_request then
    show.xetra_en_light_quoting_status_request = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_quoting_status_request
    changed = true
  end
  if show.xetra_en_light_status_broadcast ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_status_broadcast then
    show.xetra_en_light_status_broadcast = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_status_broadcast
    changed = true
  end
  if show.xetra_en_light_target_parties ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_target_parties then
    show.xetra_en_light_target_parties = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_target_parties
    changed = true
  end
  if show.xetra_en_light_update_negotiation_request ~= eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_update_negotiation_request then
    show.xetra_en_light_update_negotiation_request = eurex_cash_eti_t7_v5_0.prefs.show_xetra_en_light_update_negotiation_request
    changed = true
  end
...
dissect.target_party_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.target_party_executing_trader, range, value, display)
...
dissect.target_party_executing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.target_party_executing_firm, range, value, display)
...
dissect.xetra_en_light_target_parties = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_target_parties then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_target_parties, range, display)
  end
...
dissect.free_text_5 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.free_text_5, range, value, display)
...
dissect.party_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_executing_trader, range, value, display)
...
dissect.party_executing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_executing_firm, range, value, display)
...
dissect.quote_cancel_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.quote_cancel_type, range, value, display)
...
dissect.number_of_resp_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.number_of_resp_disclosure_instruction, range, value, display)
...
dissect.no_target_party_i_ds = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.no_target_party_i_ds, range, value, display)
...
dissect.negotiation_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.negotiation_id, range, value, display)
...
dissect.request_header = function(buffer, offset, packet, parent)
  ...
  if show.request_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.request_header, range, display)
  end
...
dissect.message_header_in = function(buffer, offset, packet, parent)
  ...
  if show.message_header_in then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.message_header_in, range, display)
  end
...
dissect.xetra_en_light_update_negotiation_request = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_update_negotiation_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_update_negotiation_request, range, display)
  end
...
dissect.rbc_header = function(buffer, offset, packet, parent)
  ...
  if show.rbc_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.rbc_header, range, display)
  end
...
dissect.message_header_out = function(buffer, offset, packet, parent)
  ...
  if show.message_header_out then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.message_header_out, range, display)
  end
...
dissect.xetra_en_light_status_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_status_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_status_broadcast, range, display)
  end
...
dissect.quoting_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.quoting_status, range, value, display)
...
dissect.xetra_en_light_quoting_status_request = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_quoting_status_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quoting_status_request, range, display)
  end
...
dissect.quote_req_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.quote_req_id, range, value, display)
...
dissect.response_header = function(buffer, offset, packet, parent)
  ...
  if show.response_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.response_header, range, display)
  end
...
dissect.xetra_en_light_quote_response = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_quote_response then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quote_response, range, display)
  end
...
dissect.party_entering_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_entering_trader, range, value, display)
...
dissect.secondary_quote_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.secondary_quote_id, range, value, display)
...
dissect.srqs_quote_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.srqs_quote_entry_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.srqs_quote_entry_grp, range, display)
  end
...
dissect.xetra_en_light_quote_requester_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_quote_requester_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quote_requester_notification, range, display)
  end
...
dissect.free_text_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.free_text_2, range, value, display)
...
dissect.xetra_en_light_quote_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_quote_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_quote_notification, range, display)
  end
...
dissect.firm_negotiation_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.firm_negotiation_id, range, value, display)
...
dissect.respondent_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.respondent_type, range, value, display)
...
dissect.quote_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.quote_status, range, value, display)
...
dissect.number_of_respondents = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.number_of_respondents, range, value, display)
...
dissect.expire_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.expire_time, range, value, display)
...
dissect.xetra_en_light_open_negotiation_requester_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_open_negotiation_requester_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_open_negotiation_requester_notification, range, display)
  end
...
dissect.value_check_type_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.value_check_type_quantity, range, value, display)
...
dissect.value_check_type_value = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.value_check_type_value, range, value, display)
...
dissect.valid_until_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.valid_until_time, range, value, display)
...
dissect.xetra_en_light_open_negotiation_request = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_open_negotiation_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_open_negotiation_request, range, display)
  end
...
dissect.negotiation_start_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.negotiation_start_time, range, value, display)
...
dissect.xetra_en_light_open_negotiation_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_open_negotiation_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_open_negotiation_notification, range, display)
  end
...
dissect.xetra_en_light_negotiation_status_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_negotiation_status_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_negotiation_status_notification, range, display)
  end
...
dissect.trd_reg_ts_execution_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trd_reg_ts_execution_time, range, value, display)
...
dissect.xetra_en_light_negotiation_requester_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_negotiation_requester_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_negotiation_requester_notification, range, display)
  end
...
dissect.xetra_en_light_negotiation_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_negotiation_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_negotiation_notification, range, display)
  end
...
dissect.firm_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.firm_trade_id, range, value, display)
...
dissect.party_id_investment_decision_maker_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_id_investment_decision_maker_qualifier, range, value, display)
...
dissect.alloc_method = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.alloc_method, range, value, display)
...
dissect.executing_trader_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.executing_trader_qualifier, range, value, display)
...
dissect.order_attribute_liquidity_provision = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.order_attribute_liquidity_provision, range, value, display)
...
dissect.executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.executing_trader, range, value, display)
...
dissect.party_id_investment_decision_maker = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_id_investment_decision_maker, range, value, display)
...
dissect.party_id_client_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_id_client_id, range, value, display)
...
dissect.xetra_en_light_hit_quote_request = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_hit_quote_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_hit_quote_request, range, display)
  end
...
dissect.xetra_en_light_enter_quote_request = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_enter_quote_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_enter_quote_request, range, display)
  end
...
dissect.secondary_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.secondary_trade_id, range, value, display)
...
dissect.xetra_en_light_deal_response = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_deal_response then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_deal_response, range, display)
  end
...
dissect.md_sub_book_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.md_sub_book_type, range, value, display)
...
dissect.md_book_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.md_book_type, range, value, display)
...
dissect.best_offer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.best_offer_size, range, value, display)
...
dissect.best_offer_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.best_offer_px, range, value, display)
...
dissect.best_bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.best_bid_size, range, value, display)
...
dissect.best_bid_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.best_bid_px, range, value, display)
...
dissect.order_book_item_grp = function(buffer, offset, packet, parent)
  ...
  if show.order_book_item_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.order_book_item_grp, range, display)
  end
...
dissect.root_party_entering_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.root_party_entering_trader, range, value, display)
...
dissect.no_order_book_items = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.no_order_book_items, range, value, display)
...
dissect.message_event_source = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.message_event_source, range, value, display)
...
dissect.trd_rpt_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trd_rpt_status, range, value, display)
...
dissect.xetra_en_light_create_deal_notification = function(buffer, offset, packet, parent)
  ...
  if show.xetra_en_light_create_deal_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.xetra_en_light_create_deal_notification, range, display)
  end
...
dissect.fix_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.fix_cl_ord_id, range, value, display)
...
dissect.rbc_header_me = function(buffer, offset, packet, parent)
  ...
  if show.rbc_header_me then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.rbc_header_me, range, display)
  end
...
dissect.root_party_id_execution_venue = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.root_party_id_execution_venue, range, value, display)
...
dissect.regulatory_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.regulatory_trade_id, range, value, display)
...
dissect.party_specialist_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_specialist_trader, range, value, display)
...
dissect.party_specialist_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_specialist_firm, range, value, display)
...
dissect.root_party_id_investment_decision_maker_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.root_party_id_investment_decision_maker_qualifier, range, value, display)
...
dissect.order_origination = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.order_origination, range, value, display)
...
dissect.clearing_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.clearing_instruction, range, value, display)
...
dissect.refinancing_eligibility_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.refinancing_eligibility_indicator, range, value, display)
...
dissect.last_coupon_deviation_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.last_coupon_deviation_indicator, range, value, display)
...
dissect.last_mkt = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.last_mkt, range, value, display)
...
dissect.num_days_interest = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.num_days_interest, range, value, display)
...
dissect.party_id_specialist_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_id_specialist_trader, range, value, display)
...
dissect.root_party_id_investment_decision_maker = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.root_party_id_investment_decision_maker, range, value, display)
...
dissect.root_party_id_client_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.root_party_id_client_id, range, value, display)
...
dissect.coupon_rate = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.coupon_rate, range, value, display)
...
dissect.accrued_interes_amt = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.accrued_interes_amt, range, value, display)
...
dissect.side_gross_trade_amt = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.side_gross_trade_amt, range, value, display)
...
dissect.notif_header = function(buffer, offset, packet, parent)
  ...
  if show.notif_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.notif_header, range, display)
  end
...
dissect.tes_trading_session_status_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.tes_trading_session_status_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.tes_trading_session_status_broadcast, range, display)
  end
...
dissect.trade_publish_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trade_publish_indicator, range, value, display)
...
dissect.trd_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trd_type, range, value, display)
...
dissect.srqs_related_trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.srqs_related_trade_id, range, value, display)
...
dissect.package_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.package_id, range, value, display)
...
dissect.tes_trade_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.tes_trade_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.tes_trade_broadcast, range, display)
  end
...
dissect.trade_report_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trade_report_id, range, value, display)
...
dissect.tes_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.tes_exec_id, range, value, display)
...
dissect.tes_response = function(buffer, offset, packet, parent)
  ...
  if show.tes_response then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.tes_response, range, display)
  end
...
dissect.alloc_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.alloc_id, range, value, display)
...
dissect.tes_execution_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.tes_execution_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.tes_execution_broadcast, range, display)
  end
...
dissect.delete_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.delete_reason, range, value, display)
...
dissect.tes_delete_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.tes_delete_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.tes_delete_broadcast, range, display)
  end
...
dissect.trade_alloc_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trade_alloc_status, range, value, display)
...
dissect.individual_alloc_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.individual_alloc_id, range, value, display)
...
dissect.alloc_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.alloc_qty, range, value, display)
...
dissect.side_alloc_grp_bc = function(buffer, offset, packet, parent)
  ...
  if show.side_alloc_grp_bc then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.side_alloc_grp_bc, range, display)
  end
...
dissect.trade_report_text = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trade_report_text, range, value, display)
...
dissect.no_side_allocs = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.no_side_allocs, range, value, display)
...
dissect.trans_bkd_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.trans_bkd_time, range, value, display)
...
dissect.tes_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.tes_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.tes_broadcast, range, display)
  end
...
dissect.tes_approve_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.tes_approve_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.tes_approve_broadcast, range, display)
  end
...
dissect.security_status_report_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.security_status_report_id, range, value, display)
...
dissect.nr_response_header_me = function(buffer, offset, packet, parent)
  ...
  if show.nr_response_header_me then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.nr_response_header_me, range, display)
  end
...
dissect.specialist_security_state_change_response = function(buffer, offset, packet, parent)
  ...
  if show.specialist_security_state_change_response then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_security_state_change_response, range, display)
  end
...
dissect.event_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.event_type, range, value, display)
...
dissect.specialist_security_state_change_request = function(buffer, offset, packet, parent)
  ...
  if show.specialist_security_state_change_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_security_state_change_request, range, display)
  end
...
dissect.specialist_rfq_reply_response = function(buffer, offset, packet, parent)
  ...
  if show.specialist_rfq_reply_response then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reply_response, range, display)
  end
...
dissect.specialist_rfq_reply_request = function(buffer, offset, packet, parent)
  ...
  if show.specialist_rfq_reply_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reply_request, range, display)
  end
...
dissect.specialist_rfq_reply_notification = function(buffer, offset, packet, parent)
  ...
  if show.specialist_rfq_reply_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reply_notification, range, display)
  end
...
dissect.quote_request_reject_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.quote_request_reject_reason, range, value, display)
...
dissect.specialist_rfq_reject_request = function(buffer, offset, packet, parent)
  ...
  if show.specialist_rfq_reject_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_rfq_reject_request, range, display)
  end
...
dissect.fills_grp = function(buffer, offset, packet, parent)
  ...
  if show.fills_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.fills_grp, range, display)
  end
...
dissect.party_entering_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.party_entering_firm, range, value, display)
...
dissect.order_event_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.order_event_type, range, value, display)
...
dissect.specialist_order_book_notification = function(buffer, offset, packet, parent)
  ...
  if show.specialist_order_book_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_order_book_notification, range, display)
  end
...
dissect.specialist_instrument_event_notification = function(buffer, offset, packet, parent)
  ...
  if show.specialist_instrument_event_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_instrument_event_notification, range, display)
  end
...
dissect.not_affected_orders_grp = function(buffer, offset, packet, parent)
  ...
  if show.not_affected_orders_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.not_affected_orders_grp, range, display)
  end
...
dissect.affected_ord_grp = function(buffer, offset, packet, parent)
  ...
  if show.affected_ord_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.affected_ord_grp, range, display)
  end
...
dissect.specialist_delete_all_order_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.specialist_delete_all_order_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.specialist_delete_all_order_broadcast, range, display)
  end
...
dissect.quote_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.quote_type, range, value, display)
...
dissect.single_quote_request = function(buffer, offset, packet, parent)
  ...
  if show.single_quote_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.single_quote_request, range, display)
  end
...
dissect.selective_request_for_quote_service_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.selective_request_for_quote_service_status, range, value, display)
...
dissect.selective_request_for_quote_service_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.selective_request_for_quote_service_trade_date, range, value, display)
...
dissect.nrbc_header = function(buffer, offset, packet, parent)
  ...
  if show.nrbc_header then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.nrbc_header, range, display)
  end
...
dissect.service_availability_market_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.service_availability_market_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.service_availability_market_broadcast, range, display)
  end
...
dissect.t_7_entry_service_rtm_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_rtm_status, range, value, display)
...
dissect.t_7_entry_service_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_status, range, value, display)
...
dissect.t_7_entry_service_rtm_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_rtm_trade_date, range, value, display)
...
dissect.t_7_entry_service_trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.t_7_entry_service_trade_date, range, value, display)
...
dissect.rfq_specialist_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.rfq_specialist_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.rfq_specialist_broadcast, range, display)
  end
...
dissect.rfq_requester_disclosure_instruction = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.rfq_requester_disclosure_instruction, range, value, display)
...
dissect.rfq_publish_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.rfq_publish_indicator, range, value, display)
...
dissect.rfq_reject_notification = function(buffer, offset, packet, parent)
  ...
  if show.rfq_reject_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.rfq_reject_notification, range, display)
  end
...
dissect.rfq_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.rfq_broadcast then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.rfq_broadcast, range, display)
  end
...
dissect.quote_event_grp = function(buffer, offset, packet, parent)
  ...
  if show.quote_event_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.quote_event_grp, range, display)
  end
...
dissect.not_affected_securities_grp = function(buffer, offset, packet, parent)
  ...
  if show.not_affected_securities_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.not_affected_securities_grp, range, display)
  end
...
dissect.transaction_delay_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.transaction_delay_indicator, range, value, display)
...
dissect.crossed_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.crossed_indicator, range, value, display)
...
dissect.response_header_me = function(buffer, offset, packet, parent)
  ...
  if show.response_header_me then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.response_header_me, range, display)
  end
...
dissect.ex_destination_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.ex_destination_type, range, value, display)
...
dissect.volume_discovery_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.volume_discovery_price, range, value, display)
...
dissect.side_alloc_grp = function(buffer, offset, packet, parent)
  ...
  if show.side_alloc_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.side_alloc_grp, range, display)
  end
...
dissect.modify_tes_trade_request = function(buffer, offset, packet, parent)
  ...
  if show.modify_tes_trade_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.modify_tes_trade_request, range, display)
  end
...
dissect.cxl_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.cxl_size, range, value, display)
...
dissect.quote_entry_ack_grp = function(buffer, offset, packet, parent)
  ...
  if show.quote_entry_ack_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.quote_entry_ack_grp, range, display)
  end
...
dissect.no_quote_side_entries = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.no_quote_side_entries, range, value, display)
...
dissect.quote_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.quote_entry_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.quote_entry_grp, range, display)
  end
...
dissect.default_cstm_appl_ver_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.default_cstm_appl_ver_sub_id, range, value, display)
...
dissect.issuer_security_state_change_response = function(buffer, offset, packet, parent)
  ...
  if show.issuer_security_state_change_response then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.issuer_security_state_change_response, range, display)
  end
...
dissect.event_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.event_date, range, value, display)
...
dissect.event_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.event_px, range, value, display)
...
dissect.security_status_event_grp = function(buffer, offset, packet, parent)
  ...
  if show.security_status_event_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.security_status_event_grp, range, display)
  end
...
dissect.sold_out_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.sold_out_indicator, range, value, display)
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.security_status, range, value, display)
...
dissect.no_events = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.no_events, range, value, display)
...
dissect.issuer_security_state_change_request = function(buffer, offset, packet, parent)
  ...
  if show.issuer_security_state_change_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.issuer_security_state_change_request, range, display)
  end
...
dissect.security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.security_trading_status, range, value, display)
...
dissect.imbalance_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.imbalance_qty, range, value, display)
...
dissect.potential_exec_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.potential_exec_volume, range, value, display)
...
dissect.issuer_notification = function(buffer, offset, packet, parent)
  ...
  if show.issuer_notification then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.issuer_notification, range, display)
  end
...
dissect.party_details_grp = function(buffer, offset, packet, parent)
  ...
  if show.party_details_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.party_details_grp, range, display)
  end
...
dissect.sessions_grp = function(buffer, offset, packet, parent)
  ...
  if show.sessions_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.sessions_grp, range, display)
  end
...
dissect.enrichment_rules_grp = function(buffer, offset, packet, parent)
  ...
  if show.enrichment_rules_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.enrichment_rules_grp, range, display)
  end
...
dissect.enter_tes_trade_request = function(buffer, offset, packet, parent)
  ...
  if show.enter_tes_trade_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.enter_tes_trade_request, range, display)
  end
...
dissect.peg_offset_value_offer_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.peg_offset_value_offer_px, range, value, display)
...
dissect.peg_offset_value_bid_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.peg_offset_value_bid_px, range, value, display)
...
dissect.reserved_offer_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.reserved_offer_size, range, value, display)
...
dissect.reserved_bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.reserved_bid_size, range, value, display)
...
dissect.enter_best_quote_request = function(buffer, offset, packet, parent)
  ...
  if show.enter_best_quote_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.enter_best_quote_request, range, display)
  end
...
dissect.delete_tes_trade_request = function(buffer, offset, packet, parent)
  ...
  if show.delete_tes_trade_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.delete_tes_trade_request, range, display)
  end
...
dissect.affected_order_request_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.affected_order_request_id, range, value, display)
...
dissect.affected_order_requests_grp = function(buffer, offset, packet, parent)
  ...
  if show.affected_order_requests_grp then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.affected_order_requests_grp, range, display)
  end
...
dissect.no_affected_order_requests = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.no_affected_order_requests, range, value, display)
...
dissect.best_quote_response = function(buffer, offset, packet, parent)
  ...
  if show.best_quote_response then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.best_quote_response, range, display)
  end
...
dissect.reserved_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_cash_eti_t7_v5_0.fields.reserved_size, range, value, display)
...
dissect.best_quote_execution_report = function(buffer, offset, packet, parent)
  ...
  if show.best_quote_execution_report then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.best_quote_execution_report, range, display)
  end
...
dissect.approve_tes_trade_request = function(buffer, offset, packet, parent)
  ...
  if show.approve_tes_trade_request then
    ...
    parent = parent:add(eurex_cash_eti_t7_v5_0.fields.approve_tes_trade_request, range, display)
  end
