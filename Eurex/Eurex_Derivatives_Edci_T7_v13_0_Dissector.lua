...
local eurex_derivatives_edci_t7_v13_0 = Proto("Eurex.Derivatives.Edci.T7.v13.0.Lua", "Eurex Derivatives Edci T7 13.0")
...
eurex_derivatives_edci_t7_v13_0.fields.affected_cl_ord_id = ProtoField.new("Affected Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.affectedclordid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.affected_fix_cl_ord_id = ProtoField.new("Affected Fix Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.affectedfixclordid", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.affected_fix_orig_cl_ord_id = ProtoField.new("Affected Fix Orig Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.affectedfixorigclordid", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.affected_ord_grp_comp = ProtoField.new("Affected Ord Grp Comp", "eurex.derivatives.edci.t7.v13.0.affectedordgrpcomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.affected_order_id = ProtoField.new("Affected Order Id", "eurex.derivatives.edci.t7.v13.0.affectedorderid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.affected_orig_cl_ord_id = ProtoField.new("Affected Orig Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.affectedorigclordid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.alignment_padding = ProtoField.new("Alignment Padding", "eurex.derivatives.edci.t7.v13.0.alignmentpadding", ftypes.BYTES)
eurex_derivatives_edci_t7_v13_0.fields.appl_id = ProtoField.new("Appl Id", "eurex.derivatives.edci.t7.v13.0.applid", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.appl_seq_indicator = ProtoField.new("Appl Seq Indicator", "eurex.derivatives.edci.t7.v13.0.applseqindicator", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.body_len = ProtoField.new("Body Len", "eurex.derivatives.edci.t7.v13.0.bodylen", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.cl_ord_id = ProtoField.new("Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.clordid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.crossed_indicator = ProtoField.new("Crossed Indicator", "eurex.derivatives.edci.t7.v13.0.crossedindicator", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.cum_qty = ProtoField.new("Cum Qty", "eurex.derivatives.edci.t7.v13.0.cumqty", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.cust_order_handling_inst = ProtoField.new("Cust Order Handling Inst", "eurex.derivatives.edci.t7.v13.0.custorderhandlinginst", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.cxl_qty = ProtoField.new("Cxl Qty", "eurex.derivatives.edci.t7.v13.0.cxlqty", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.default_cstm_appl_ver_id = ProtoField.new("Default Cstm Appl Ver Id", "eurex.derivatives.edci.t7.v13.0.defaultcstmapplverid", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.default_cstm_appl_ver_sub_id = ProtoField.new("Default Cstm Appl Ver Sub Id", "eurex.derivatives.edci.t7.v13.0.defaultcstmapplversubid", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.delete_order_broadcast = ProtoField.new("Delete Order Broadcast", "eurex.derivatives.edci.t7.v13.0.deleteorderbroadcast", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.exec_id = ProtoField.new("Exec Id", "eurex.derivatives.edci.t7.v13.0.execid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.exec_inst = ProtoField.new("Exec Inst", "eurex.derivatives.edci.t7.v13.0.execinst", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.exec_type = ProtoField.new("Exec Type", "eurex.derivatives.edci.t7.v13.0.exectype", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.executing_trader = ProtoField.new("Executing Trader", "eurex.derivatives.edci.t7.v13.0.executingtrader", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.executing_trader_qualifier = ProtoField.new("Executing Trader Qualifier", "eurex.derivatives.edci.t7.v13.0.executingtraderqualifier", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.expire_date = ProtoField.new("Expire Date", "eurex.derivatives.edci.t7.v13.0.expiredate", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.fill_exec_id = ProtoField.new("Fill Exec Id", "eurex.derivatives.edci.t7.v13.0.fillexecid", ftypes.INT32)
eurex_derivatives_edci_t7_v13_0.fields.fill_match_id = ProtoField.new("Fill Match Id", "eurex.derivatives.edci.t7.v13.0.fillmatchid", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.fill_px = ProtoField.new("Fill Px", "eurex.derivatives.edci.t7.v13.0.fillpx", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.fill_qty = ProtoField.new("Fill Qty", "eurex.derivatives.edci.t7.v13.0.fillqty", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.fills_grp_comp = ProtoField.new("Fills Grp Comp", "eurex.derivatives.edci.t7.v13.0.fillsgrpcomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.fix_cl_ord_id = ProtoField.new("Fix Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.fixclordid", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.fix_orig_cl_ord_id = ProtoField.new("Fix Orig Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.fixorigclordid", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.forced_logout_notification = ProtoField.new("Forced Logout Notification", "eurex.derivatives.edci.t7.v13.0.forcedlogoutnotification", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.free_text_1 = ProtoField.new("Free Text 1", "eurex.derivatives.edci.t7.v13.0.freetext1", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.free_text_2 = ProtoField.new("Free Text 2", "eurex.derivatives.edci.t7.v13.0.freetext2", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.free_text_3 = ProtoField.new("Free Text 3", "eurex.derivatives.edci.t7.v13.0.freetext3", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "eurex.derivatives.edci.t7.v13.0.heartbtint", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.heartbeat = ProtoField.new("Heartbeat", "eurex.derivatives.edci.t7.v13.0.heartbeat", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.heartbeat_notification = ProtoField.new("Heartbeat Notification", "eurex.derivatives.edci.t7.v13.0.heartbeatnotification", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.last_fragment = ProtoField.new("Last Fragment", "eurex.derivatives.edci.t7.v13.0.lastfragment", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.leaves_qty = ProtoField.new("Leaves Qty", "eurex.derivatives.edci.t7.v13.0.leavesqty", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.logon_request = ProtoField.new("Logon Request", "eurex.derivatives.edci.t7.v13.0.logonrequest", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.logon_response = ProtoField.new("Logon Response", "eurex.derivatives.edci.t7.v13.0.logonresponse", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.logout_request = ProtoField.new("Logout Request", "eurex.derivatives.edci.t7.v13.0.logoutrequest", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.logout_response = ProtoField.new("Logout Response", "eurex.derivatives.edci.t7.v13.0.logoutresponse", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.market_id = ProtoField.new("Market Id", "eurex.derivatives.edci.t7.v13.0.marketid", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_0.fields.market_segment_id = ProtoField.new("Market Segment Id", "eurex.derivatives.edci.t7.v13.0.marketsegmentid", ftypes.INT32)
eurex_derivatives_edci_t7_v13_0.fields.match_type = ProtoField.new("Match Type", "eurex.derivatives.edci.t7.v13.0.matchtype", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.message = ProtoField.new("Message", "eurex.derivatives.edci.t7.v13.0.message", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.message_header = ProtoField.new("Message Header", "eurex.derivatives.edci.t7.v13.0.messageheader", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.msg_seq_num = ProtoField.new("Msg Seq Num", "eurex.derivatives.edci.t7.v13.0.msgseqnum", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.no_affected_orders = ProtoField.new("No Affected Orders", "eurex.derivatives.edci.t7.v13.0.noaffectedorders", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_0.fields.no_fills = ProtoField.new("No Fills", "eurex.derivatives.edci.t7.v13.0.nofills", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.no_partitions = ProtoField.new("No Partitions", "eurex.derivatives.edci.t7.v13.0.nopartitions", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.no_sessions = ProtoField.new("No Sessions", "eurex.derivatives.edci.t7.v13.0.nosessions", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_0.fields.notif_header_comp = ProtoField.new("Notif Header Comp", "eurex.derivatives.edci.t7.v13.0.notifheadercomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.ord_status = ProtoField.new("Ord Status", "eurex.derivatives.edci.t7.v13.0.ordstatus", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.ord_type = ProtoField.new("Ord Type", "eurex.derivatives.edci.t7.v13.0.ordtype", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.order_exec_report_broadcast = ProtoField.new("Order Exec Report Broadcast", "eurex.derivatives.edci.t7.v13.0.orderexecreportbroadcast", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.order_id = ProtoField.new("Order Id", "eurex.derivatives.edci.t7.v13.0.orderid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.order_qty = ProtoField.new("Order Qty", "eurex.derivatives.edci.t7.v13.0.orderqty", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.orig_cl_ord_id = ProtoField.new("Orig Cl Ord Id", "eurex.derivatives.edci.t7.v13.0.origclordid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.packet = ProtoField.new("Packet", "eurex.derivatives.edci.t7.v13.0.packet", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.pad_2 = ProtoField.new("Pad 2", "eurex.derivatives.edci.t7.v13.0.pad2", ftypes.BYTES)
eurex_derivatives_edci_t7_v13_0.fields.pad_3 = ProtoField.new("Pad 3", "eurex.derivatives.edci.t7.v13.0.pad3", ftypes.BYTES)
eurex_derivatives_edci_t7_v13_0.fields.pad_4 = ProtoField.new("Pad 4", "eurex.derivatives.edci.t7.v13.0.pad4", ftypes.BYTES)
eurex_derivatives_edci_t7_v13_0.fields.pad_6 = ProtoField.new("Pad 6", "eurex.derivatives.edci.t7.v13.0.pad6", ftypes.BYTES)
eurex_derivatives_edci_t7_v13_0.fields.pad_7 = ProtoField.new("Pad 7", "eurex.derivatives.edci.t7.v13.0.pad7", ftypes.BYTES)
eurex_derivatives_edci_t7_v13_0.fields.partition_grp_comp = ProtoField.new("Partition Grp Comp", "eurex.derivatives.edci.t7.v13.0.partitiongrpcomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.partition_id = ProtoField.new("Partition Id", "eurex.derivatives.edci.t7.v13.0.partitionid", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_0.fields.partition_list_notification = ProtoField.new("Partition List Notification", "eurex.derivatives.edci.t7.v13.0.partitionlistnotification", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.party_end_client_identification = ProtoField.new("Party End Client Identification", "eurex.derivatives.edci.t7.v13.0.partyendclientidentification", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.party_executing_firm = ProtoField.new("Party Executing Firm", "eurex.derivatives.edci.t7.v13.0.partyexecutingfirm", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.party_id_client_id = ProtoField.new("Party Id Client Id", "eurex.derivatives.edci.t7.v13.0.partyidclientid", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.party_id_executing_trader = ProtoField.new("Party Id Executing Trader", "eurex.derivatives.edci.t7.v13.0.partyidexecutingtrader", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.party_id_executing_unit = ProtoField.new("Party Id Executing Unit", "eurex.derivatives.edci.t7.v13.0.partyidexecutingunit", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.party_id_investment_decision_maker = ProtoField.new("Party Id Investment Decision Maker", "eurex.derivatives.edci.t7.v13.0.partyidinvestmentdecisionmaker", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.party_id_investment_decision_maker_qualifier = ProtoField.new("Party Id Investment Decision Maker Qualifier", "eurex.derivatives.edci.t7.v13.0.partyidinvestmentdecisionmakerqualifier", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.party_id_session_id = ProtoField.new("Party Id Session Id", "eurex.derivatives.edci.t7.v13.0.partyidsessionid", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.password = ProtoField.new("Password", "eurex.derivatives.edci.t7.v13.0.password", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.payload = ProtoField.new("Payload", "eurex.derivatives.edci.t7.v13.0.payload", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.price = ProtoField.new("Price", "eurex.derivatives.edci.t7.v13.0.price", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.product_complex = ProtoField.new("Product Complex", "eurex.derivatives.edci.t7.v13.0.productcomplex", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.rbc_header_comp = ProtoField.new("Rbc Header Comp", "eurex.derivatives.edci.t7.v13.0.rbcheadercomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.reject = ProtoField.new("Reject", "eurex.derivatives.edci.t7.v13.0.reject", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.request_header_comp = ProtoField.new("Request Header Comp", "eurex.derivatives.edci.t7.v13.0.requestheadercomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.request_time = ProtoField.new("Request Time", "eurex.derivatives.edci.t7.v13.0.requesttime", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.response_header_comp = ProtoField.new("Response Header Comp", "eurex.derivatives.edci.t7.v13.0.responseheadercomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.security_id = ProtoField.new("Security Id", "eurex.derivatives.edci.t7.v13.0.securityid", ftypes.INT64)
eurex_derivatives_edci_t7_v13_0.fields.sending_time = ProtoField.new("Sending Time", "eurex.derivatives.edci.t7.v13.0.sendingtime", ftypes.UINT64)
eurex_derivatives_edci_t7_v13_0.fields.session_instance_id = ProtoField.new("Session Instance Id", "eurex.derivatives.edci.t7.v13.0.sessioninstanceid", ftypes.UINT32)
...
eurex_derivatives_edci_t7_v13_0.fields.session_mode = ProtoField.new("Session Mode", "eurex.derivatives.edci.t7.v13.0.sessionmode", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.session_reject_reason = ProtoField.new("Session Reject Reason", "eurex.derivatives.edci.t7.v13.0.sessionrejectreason", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.session_status = ProtoField.new("Session Status", "eurex.derivatives.edci.t7.v13.0.sessionstatus", ftypes.UINT8)
...
eurex_derivatives_edci_t7_v13_0.fields.sessions_grp_comp = ProtoField.new("Sessions Grp Comp", "eurex.derivatives.edci.t7.v13.0.sessionsgrpcomp", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.side = ProtoField.new("Side", "eurex.derivatives.edci.t7.v13.0.side", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.stop_px = ProtoField.new("Stop Px", "eurex.derivatives.edci.t7.v13.0.stoppx", ftypes.DOUBLE)
eurex_derivatives_edci_t7_v13_0.fields.template_id = ProtoField.new("Template Id", "eurex.derivatives.edci.t7.v13.0.templateid", ftypes.UINT16)
eurex_derivatives_edci_t7_v13_0.fields.time_in_force = ProtoField.new("Time In Force", "eurex.derivatives.edci.t7.v13.0.timeinforce", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.trad_ses_event = ProtoField.new("Trad Ses Event", "eurex.derivatives.edci.t7.v13.0.tradsesevent", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.trad_ses_mode = ProtoField.new("Trad Ses Mode", "eurex.derivatives.edci.t7.v13.0.tradsesmode", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.trade_date = ProtoField.new("Trade Date", "eurex.derivatives.edci.t7.v13.0.tradedate", ftypes.UINT32)
eurex_derivatives_edci_t7_v13_0.fields.trading_capacity = ProtoField.new("Trading Capacity", "eurex.derivatives.edci.t7.v13.0.tradingcapacity", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.trading_session_sub_id = ProtoField.new("Trading Session Sub Id", "eurex.derivatives.edci.t7.v13.0.tradingsessionsubid", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.triggered = ProtoField.new("Triggered", "eurex.derivatives.edci.t7.v13.0.triggered", ftypes.UINT8)
eurex_derivatives_edci_t7_v13_0.fields.var_text = ProtoField.new("Var Text", "eurex.derivatives.edci.t7.v13.0.vartext", ftypes.STRING)
eurex_derivatives_edci_t7_v13_0.fields.var_text_len = ProtoField.new("Var Text Len", "eurex.derivatives.edci.t7.v13.0.vartextlen", ftypes.UINT16)
...
eurex_derivatives_edci_t7_v13_0.prefs.show_affected_ord_grp_comp = Pref.bool("Show Affected Ord Grp Comp", show.affected_ord_grp_comp, "Parse and add Affected Ord Grp Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_delete_order_broadcast = Pref.bool("Show Delete Order Broadcast", show.delete_order_broadcast, "Parse and add Delete Order Broadcast to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_fills_grp_comp = Pref.bool("Show Fills Grp Comp", show.fills_grp_comp, "Parse and add Fills Grp Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_forced_logout_notification = Pref.bool("Show Forced Logout Notification", show.forced_logout_notification, "Parse and add Forced Logout Notification to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_heartbeat = Pref.bool("Show Heartbeat", show.heartbeat, "Parse and add Heartbeat to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_heartbeat_notification = Pref.bool("Show Heartbeat Notification", show.heartbeat_notification, "Parse and add Heartbeat Notification to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_logon_request = Pref.bool("Show Logon Request", show.logon_request, "Parse and add Logon Request to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_logon_response = Pref.bool("Show Logon Response", show.logon_response, "Parse and add Logon Response to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_logout_request = Pref.bool("Show Logout Request", show.logout_request, "Parse and add Logout Request to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_logout_response = Pref.bool("Show Logout Response", show.logout_response, "Parse and add Logout Response to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_notif_header_comp = Pref.bool("Show Notif Header Comp", show.notif_header_comp, "Parse and add Notif Header Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_order_exec_report_broadcast = Pref.bool("Show Order Exec Report Broadcast", show.order_exec_report_broadcast, "Parse and add Order Exec Report Broadcast to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_partition_grp_comp = Pref.bool("Show Partition Grp Comp", show.partition_grp_comp, "Parse and add Partition Grp Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_partition_list_notification = Pref.bool("Show Partition List Notification", show.partition_list_notification, "Parse and add Partition List Notification to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_rbc_header_comp = Pref.bool("Show Rbc Header Comp", show.rbc_header_comp, "Parse and add Rbc Header Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_reject = Pref.bool("Show Reject", show.reject, "Parse and add Reject to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_request_header_comp = Pref.bool("Show Request Header Comp", show.request_header_comp, "Parse and add Request Header Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_response_header_comp = Pref.bool("Show Response Header Comp", show.response_header_comp, "Parse and add Response Header Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_session_list_notification = Pref.bool("Show Session List Notification", show.session_list_notification, "Parse and add Session List Notification to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_session_status_broadcast = Pref.bool("Show Session Status Broadcast", show.session_status_broadcast, "Parse and add Session Status Broadcast to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_sessions_grp_comp = Pref.bool("Show Sessions Grp Comp", show.sessions_grp_comp, "Parse and add Sessions Grp Comp to protocol tree")
eurex_derivatives_edci_t7_v13_0.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function eurex_derivatives_edci_t7_v13_0.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.affected_ord_grp_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_affected_ord_grp_comp then
    show.affected_ord_grp_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_affected_ord_grp_comp
    changed = true
  end
  if show.delete_order_broadcast ~= eurex_derivatives_edci_t7_v13_0.prefs.show_delete_order_broadcast then
    show.delete_order_broadcast = eurex_derivatives_edci_t7_v13_0.prefs.show_delete_order_broadcast
    changed = true
  end
  if show.fills_grp_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_fills_grp_comp then
    show.fills_grp_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_fills_grp_comp
    changed = true
  end
  if show.forced_logout_notification ~= eurex_derivatives_edci_t7_v13_0.prefs.show_forced_logout_notification then
    show.forced_logout_notification = eurex_derivatives_edci_t7_v13_0.prefs.show_forced_logout_notification
    changed = true
  end
  if show.heartbeat ~= eurex_derivatives_edci_t7_v13_0.prefs.show_heartbeat then
    show.heartbeat = eurex_derivatives_edci_t7_v13_0.prefs.show_heartbeat
    changed = true
  end
  if show.heartbeat_notification ~= eurex_derivatives_edci_t7_v13_0.prefs.show_heartbeat_notification then
    show.heartbeat_notification = eurex_derivatives_edci_t7_v13_0.prefs.show_heartbeat_notification
    changed = true
  end
  if show.logon_request ~= eurex_derivatives_edci_t7_v13_0.prefs.show_logon_request then
    show.logon_request = eurex_derivatives_edci_t7_v13_0.prefs.show_logon_request
    changed = true
  end
  if show.logon_response ~= eurex_derivatives_edci_t7_v13_0.prefs.show_logon_response then
    show.logon_response = eurex_derivatives_edci_t7_v13_0.prefs.show_logon_response
    changed = true
  end
  if show.logout_request ~= eurex_derivatives_edci_t7_v13_0.prefs.show_logout_request then
    show.logout_request = eurex_derivatives_edci_t7_v13_0.prefs.show_logout_request
    changed = true
  end
  if show.logout_response ~= eurex_derivatives_edci_t7_v13_0.prefs.show_logout_response then
    show.logout_response = eurex_derivatives_edci_t7_v13_0.prefs.show_logout_response
    changed = true
  end
  if show.message ~= eurex_derivatives_edci_t7_v13_0.prefs.show_message then
    show.message = eurex_derivatives_edci_t7_v13_0.prefs.show_message
    changed = true
  end
  if show.message_header ~= eurex_derivatives_edci_t7_v13_0.prefs.show_message_header then
    show.message_header = eurex_derivatives_edci_t7_v13_0.prefs.show_message_header
    changed = true
  end
  if show.notif_header_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_notif_header_comp then
    show.notif_header_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_notif_header_comp
    changed = true
  end
  if show.order_exec_report_broadcast ~= eurex_derivatives_edci_t7_v13_0.prefs.show_order_exec_report_broadcast then
    show.order_exec_report_broadcast = eurex_derivatives_edci_t7_v13_0.prefs.show_order_exec_report_broadcast
    changed = true
  end
  if show.packet ~= eurex_derivatives_edci_t7_v13_0.prefs.show_packet then
    show.packet = eurex_derivatives_edci_t7_v13_0.prefs.show_packet
    changed = true
  end
  if show.partition_grp_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_partition_grp_comp then
    show.partition_grp_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_partition_grp_comp
    changed = true
  end
  if show.partition_list_notification ~= eurex_derivatives_edci_t7_v13_0.prefs.show_partition_list_notification then
    show.partition_list_notification = eurex_derivatives_edci_t7_v13_0.prefs.show_partition_list_notification
    changed = true
  end
  if show.rbc_header_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_rbc_header_comp then
    show.rbc_header_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_rbc_header_comp
    changed = true
  end
  if show.reject ~= eurex_derivatives_edci_t7_v13_0.prefs.show_reject then
    show.reject = eurex_derivatives_edci_t7_v13_0.prefs.show_reject
    changed = true
  end
  if show.request_header_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_request_header_comp then
    show.request_header_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_request_header_comp
    changed = true
  end
  if show.response_header_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_response_header_comp then
    show.response_header_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_response_header_comp
    changed = true
  end
  if show.session_list_notification ~= eurex_derivatives_edci_t7_v13_0.prefs.show_session_list_notification then
    show.session_list_notification = eurex_derivatives_edci_t7_v13_0.prefs.show_session_list_notification
    changed = true
  end
  if show.session_status_broadcast ~= eurex_derivatives_edci_t7_v13_0.prefs.show_session_status_broadcast then
    show.session_status_broadcast = eurex_derivatives_edci_t7_v13_0.prefs.show_session_status_broadcast
    changed = true
  end
  if show.sessions_grp_comp ~= eurex_derivatives_edci_t7_v13_0.prefs.show_sessions_grp_comp then
    show.sessions_grp_comp = eurex_derivatives_edci_t7_v13_0.prefs.show_sessions_grp_comp
    changed = true
  end
  if show.payload ~= eurex_derivatives_edci_t7_v13_0.prefs.show_payload then
    show.payload = eurex_derivatives_edci_t7_v13_0.prefs.show_payload
    changed = true
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.pad_7 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.pad_7, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.trad_ses_event = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.trad_ses_event, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.market_segment_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.trade_date, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.last_fragment = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.last_fragment, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.appl_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.appl_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.partition_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.partition_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.party_id_executing_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_id_executing_unit, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.sending_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.sending_time, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.pad_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.pad_2, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.session_status_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.session_status_broadcast then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.session_status_broadcast, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.pad_6 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.pad_6, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.party_executing_firm = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_executing_firm, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.session_mode = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.session_mode, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.party_id_session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_id_session_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.sessions_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_derivatives_edci_t7_v13_0_dissect.no_sessions = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.no_sessions, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.session_list_notification = function(buffer, offset, packet, parent)
  ...
  if show.session_list_notification then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.session_list_notification, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.alignment_padding = function(buffer, offset, packet, parent, size)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.alignment_padding, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.var_text = function(buffer, offset, packet, parent, size)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.var_text, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.session_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.session_status, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.var_text_len = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.var_text_len, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.session_reject_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.session_reject_reason, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.pad_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.pad_3, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.msg_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.msg_seq_num, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.request_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.request_time, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.reject = function(buffer, offset, packet, parent)
  ...
  if show.reject then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.reject, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.partition_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_derivatives_edci_t7_v13_0_dissect.no_partitions = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.no_partitions, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.partition_list_notification = function(buffer, offset, packet, parent)
  ...
  if show.partition_list_notification then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.partition_list_notification, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.fill_exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.fill_exec_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.fill_match_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.fill_match_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.fill_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.fill_qty, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.fill_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.fill_px, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.fills_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_derivatives_edci_t7_v13_0_dissect.party_end_client_identification = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_end_client_identification, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.fix_orig_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.fix_orig_cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.fix_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.fix_cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.free_text_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.free_text_3, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.free_text_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.free_text_2, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.free_text_1 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.free_text_1, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.cust_order_handling_inst = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.cust_order_handling_inst, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.crossed_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.crossed_indicator, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.no_fills = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.no_fills, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.executing_trader_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.executing_trader_qualifier, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.party_id_investment_decision_maker_qualifier = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_id_investment_decision_maker_qualifier, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.appl_seq_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.appl_seq_indicator, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.trading_session_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.trading_session_sub_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.triggered = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.triggered, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.exec_inst = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.exec_inst, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.time_in_force = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.time_in_force, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.trading_capacity = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.trading_capacity, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.match_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.match_type, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.ord_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.ord_type, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.side, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.exec_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.exec_type, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.ord_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.ord_status, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.product_complex = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.product_complex, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.party_id_executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_id_executing_trader, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.expire_date = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.expire_date, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.executing_trader = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.executing_trader, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.party_id_investment_decision_maker = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_id_investment_decision_maker, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.party_id_client_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.party_id_client_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.order_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.order_qty, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.cxl_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.cxl_qty, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.cum_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.cum_qty, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.leaves_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.leaves_qty, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.stop_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.stop_px, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.price, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.exec_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.security_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.orig_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.orig_cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.order_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.order_exec_report_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.order_exec_report_broadcast then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.order_exec_report_broadcast, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.logout_response = function(buffer, offset, packet, parent)
  ...
  if show.logout_response then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.logout_response, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.pad_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.pad_4, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.logout_request = function(buffer, offset, packet, parent)
  ...
  if show.logout_request then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.logout_request, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.default_cstm_appl_ver_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.default_cstm_appl_ver_sub_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.default_cstm_appl_ver_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.default_cstm_appl_ver_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.trad_ses_mode = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.trad_ses_mode, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.market_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.market_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.session_instance_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.session_instance_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.heart_bt_int = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.heart_bt_int, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.logon_response = function(buffer, offset, packet, parent)
  ...
  if show.logon_response then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.logon_response, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.password = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.password, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.logon_request = function(buffer, offset, packet, parent)
  ...
  if show.logon_request then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.logon_request, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.heartbeat_notification = function(buffer, offset, packet, parent)
  ...
  if show.heartbeat_notification then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.heartbeat_notification, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.heartbeat = function(buffer, offset, packet, parent)
  ...
  if show.heartbeat then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.heartbeat, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.forced_logout_notification = function(buffer, offset, packet, parent)
  ...
  if show.forced_logout_notification then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.forced_logout_notification, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.affected_fix_orig_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.affected_fix_orig_cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.affected_fix_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.affected_fix_cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.affected_orig_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.affected_orig_cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.affected_cl_ord_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.affected_cl_ord_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.affected_order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.affected_order_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.affected_ord_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
...
eurex_derivatives_edci_t7_v13_0_dissect.no_affected_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.no_affected_orders, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.delete_order_broadcast = function(buffer, offset, packet, parent)
  ...
  if show.delete_order_broadcast then
    ...
    parent = parent:add(eurex_derivatives_edci_t7_v13_0.fields.delete_order_broadcast, range, display)
  end
...
eurex_derivatives_edci_t7_v13_0_dissect.payload = function(buffer, offset, packet, parent, template_id)
  ...
  local element = parent:add(eurex_derivatives_edci_t7_v13_0.fields.payload, range, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.template_id, range, value, display)
...
eurex_derivatives_edci_t7_v13_0_dissect.body_len = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_edci_t7_v13_0.fields.body_len, range, value, display)
...
function eurex_derivatives_edci_t7_v13_0.init()
end

-- Dissector for Eurex Derivatives Edci T7 13.0
function eurex_derivatives_edci_t7_v13_0.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = eurex_derivatives_edci_t7_v13_0.name

  -- Dissect protocol
  local protocol = parent:add(eurex_derivatives_edci_t7_v13_0, buffer(), eurex_derivatives_edci_t7_v13_0.description, "("..buffer:len().." Bytes)")
  return eurex_derivatives_edci_t7_v13_0_dissect.packet(buffer, packet, protocol)
end

-- Register With Tcp Table
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add(65333, eurex_derivatives_edci_t7_v13_0)
...
verify.eurex_derivatives_edci_t7_v13_0_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Eurex Derivatives Edci T7 13.0
local function eurex_derivatives_edci_t7_v13_0_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.eurex_derivatives_edci_t7_v13_0_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = eurex_derivatives_edci_t7_v13_0
  eurex_derivatives_edci_t7_v13_0.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Eurex Derivatives Edci T7 13.0
eurex_derivatives_edci_t7_v13_0:register_heuristic("tcp", eurex_derivatives_edci_t7_v13_0_heuristic)
