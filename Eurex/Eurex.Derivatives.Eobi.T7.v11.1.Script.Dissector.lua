...
-- Size: Md Origin Type
size_of.md_origin_type = 1

-- Display: Md Origin Type
display.md_origin_type = function(value)
  if value == 0 then
...
dissect.md_origin_type = function(buffer, offset, packet, parent)
  local length = size_of.md_origin_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.md_origin_type(value, buffer, offset, packet, parent)
...
size_of.trade_reversal = function(buffer, offset)
  ...
  index = index + size_of.md_origin_type
...
dissect.trade_reversal_fields = function(buffer, offset, packet, parent)
  ...
  index, md_origin_type = dissect.md_origin_type(buffer, index, packet, parent)
...
size_of.number_of_sell_orders = 2

-- Display: Number Of Sell Orders
display.number_of_sell_orders = function(value)
  return "Number Of Sell Orders: "..value
end

-- Dissect: Number Of Sell Orders
dissect.number_of_sell_orders = function(buffer, offset, packet, parent)
  local length = size_of.number_of_sell_orders
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.number_of_sell_orders(value, buffer, offset, packet, parent)
...
size_of.number_of_buy_orders = 2

-- Display: Number Of Buy Orders
display.number_of_buy_orders = function(value)
  return "Number Of Buy Orders: "..value
end

-- Dissect: Number Of Buy Orders
dissect.number_of_buy_orders = function(buffer, offset, packet, parent)
  local length = size_of.number_of_buy_orders
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.number_of_buy_orders(value, buffer, offset, packet, parent)
...
size_of.top_of_book = function(buffer, offset)
  ...
  index = index + size_of.number_of_buy_orders

  index = index + size_of.number_of_sell_orders
...
dissect.top_of_book_fields = function(buffer, offset, packet, parent)
  ...
  index, number_of_buy_orders = dissect.number_of_buy_orders(buffer, index, packet, parent)

  -- Number Of Sell Orders: 2 Byte Unsigned Fixed Width Integer
  index, number_of_sell_orders = dissect.number_of_sell_orders(buffer, index, packet, parent)
...
size_of.non_disclosed_trade_volume = 8

-- Display: Non Disclosed Trade Volume
display.non_disclosed_trade_volume = function(value)
...
dissect.non_disclosed_trade_volume = function(buffer, offset, packet, parent)
  local length = size_of.non_disclosed_trade_volume
  local range = buffer(offset, length)
  local raw = range:le_uint64()
  local value = translate.non_disclosed_trade_volume(raw)
  local display = display.non_disclosed_trade_volume(value, buffer, offset, packet, parent)
...
size_of.multi_leg_price_model = 1

-- Display: Multi Leg Price Model
display.multi_leg_price_model = function(value)
  if value == 0 then
...
dissect.multi_leg_price_model = function(buffer, offset, packet, parent)
  local length = size_of.multi_leg_price_model
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.multi_leg_price_model(value, buffer, offset, packet, parent)
...
size_of.tes_trade_report = function(buffer, offset)
  local index = 0
  ...
  index = index + size_of.multi_leg_price_model

  index = index + size_of.pad_6

  index = index + size_of.non_disclosed_trade_volume

  return index
end

-- Display: Tes Trade Report
display.tes_trade_report = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Tes Trade Report
dissect.tes_trade_report_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, multi_leg_price_model = dissect.multi_leg_price_model(buffer, index, packet, parent)

  -- Pad 6: 6 Byte
  index, pad_6 = dissect.pad_6(buffer, index, packet, parent)

  -- Non Disclosed Trade Volume: 8 Byte Unsigned Fixed Width Integer
  index, non_disclosed_trade_volume = dissect.non_disclosed_trade_volume(buffer, index, packet, parent)

  return index
end

-- Dissect: Tes Trade Report
dissect.tes_trade_report = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.tes_trade_report then
    local length = size_of.tes_trade_report(buffer, offset)
    local range = buffer(offset, length)
    local display = display.tes_trade_report(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eobi_t7_v11_1.fields.tes_trade_report, range, display)
  end

  return dissect.tes_trade_report_fields(buffer, offset, packet, parent)
end
...
-- Size: Hhi Indicator
size_of.hhi_indicator = 1

-- Display: Hhi Indicator
display.hhi_indicator = function(value)
  if value == -1 then
...
dissect.hhi_indicator = function(buffer, offset, packet, parent)
  local length = size_of.hhi_indicator
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.hhi_indicator(value, buffer, offset, packet, parent)
...
size_of.order_details_comp = function(buffer, offset)
  ...
  index = index + size_of.hhi_indicator
...
dissect.order_details_comp_fields = function(buffer, offset, packet, parent)
  ...
  index, hhi_indicator = dissect.hhi_indicator(buffer, index, packet, parent)
...
size_of.tes_trad_ses_status = 1

-- Display: Tes Trad Ses Status
display.tes_trad_ses_status = function(value)
  if value == 1 then
...
dissect.tes_trad_ses_status = function(buffer, offset, packet, parent)
  local length = size_of.tes_trad_ses_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.tes_trad_ses_status(value, buffer, offset, packet, parent)
...
size_of.product_summary = function(buffer, offset)
  ...
  index = index + size_of.tes_trad_ses_status
...
dissect.product_summary_fields = function(buffer, offset, packet, parent)
  ...
  index, tes_trad_ses_status = dissect.tes_trad_ses_status(buffer, index, packet, parent)
...
size_of.prev_price_hhi_indicator = 1

-- Display: Prev Price Hhi Indicator
display.prev_price_hhi_indicator = function(value)
  if value == -1 then
...
dissect.prev_price_hhi_indicator = function(buffer, offset, packet, parent)
  local length = size_of.prev_price_hhi_indicator
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.prev_price_hhi_indicator(value, buffer, offset, packet, parent)
...
size_of.order_modify = function(buffer, offset)
  ...
  index = index + size_of.prev_price_hhi_indicator
...
dissect.order_modify_fields = function(buffer, offset, packet, parent)
  ...
  index, prev_price_hhi_indicator = dissect.prev_price_hhi_indicator(buffer, index, packet, parent)
...
size_of.tes_security_status = 1

-- Display: Tes Security Status
display.tes_security_status = function(value)
  if value == 1 then
...
dissect.tes_security_status = function(buffer, offset, packet, parent)
  local length = size_of.tes_security_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.tes_security_status(value, buffer, offset, packet, parent)
...
dissect.low_px = function(buffer, offset, packet, parent)
  local length = size_of.low_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
  local value = translate.low_px(raw)
  local display = display.low_px(value, buffer, offset, packet, parent)
...
-- Display: High Px
display.high_px = function(value)
...
dissect.high_px = function(buffer, offset, packet, parent)
  local length = size_of.high_px
  local range = buffer(offset, length)
  local raw = range:le_uint64()
  local value = translate.high_px(raw)
  local display = display.high_px(value, buffer, offset, packet, parent)
...
size_of.sec_mass_stat_grp_comp = function(buffer, offset)
  local index = 0

  index = index + size_of.security_id

  index = index + size_of.high_px

  index = index + size_of.low_px
  ...
  index = index + size_of.tes_security_status
...
display.sec_mass_stat_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Sec Mass Stat Grp Comp
dissect.sec_mass_stat_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, tes_security_status = dissect.tes_security_status(buffer, index, packet, parent)
...
dissect.sec_mass_stat_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.sec_mass_stat_grp_comp then
    local length = size_of.sec_mass_stat_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = display.sec_mass_stat_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eobi_t7_v11_1.fields.sec_mass_stat_grp_comp, range, display)
  end

  return dissect.sec_mass_stat_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Related Sym
size_of.no_related_sym = 1

-- Display: No Related Sym
display.no_related_sym = function(value)
  return "No Related Sym: "..value
end

-- Dissect: No Related Sym
dissect.no_related_sym = function(buffer, offset, packet, parent)
  local length = size_of.no_related_sym
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.no_related_sym(value, buffer, offset, packet, parent)
...
size_of.tes_security_mass_status = 1

-- Display: Tes Security Mass Status
display.tes_security_mass_status = function(value)
  if value == 1 then
...
dissect.tes_security_mass_status = function(buffer, offset, packet, parent)
  local length = size_of.tes_security_mass_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.tes_security_mass_status(value, buffer, offset, packet, parent)
...
size_of.mass_sold_out_indicator = 1

-- Display: Mass Sold Out Indicator
display.mass_sold_out_indicator = function(value)
  if value == 1 then
...
dissect.mass_sold_out_indicator = function(buffer, offset, packet, parent)
  local length = size_of.mass_sold_out_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.mass_sold_out_indicator(value, buffer, offset, packet, parent)
...
size_of.security_mass_trading_event = 1

-- Display: Security Mass Trading Event
display.security_mass_trading_event = function(value)
  if value == 10 then
...
dissect.security_mass_trading_event = function(buffer, offset, packet, parent)
  local length = size_of.security_mass_trading_event
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.security_mass_trading_event(value, buffer, offset, packet, parent)
...
size_of.mass_market_condition = 1

-- Display: Mass Market Condition
display.mass_market_condition = function(value)
  if value == 0 then
...
dissect.mass_market_condition = function(buffer, offset, packet, parent)
  local length = size_of.mass_market_condition
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.mass_market_condition(value, buffer, offset, packet, parent)
...
size_of.security_mass_trading_status = 1

-- Display: Security Mass Trading Status
display.security_mass_trading_status = function(value)
  if value == 2 then
...
dissect.security_mass_trading_status = function(buffer, offset, packet, parent)
  local length = size_of.security_mass_trading_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.security_mass_trading_status(value, buffer, offset, packet, parent)
...
size_of.security_mass_status = 1

-- Display: Security Mass Status
display.security_mass_status = function(value)
  if value == 1 then
...
dissect.security_mass_status = function(buffer, offset, packet, parent)
  local length = size_of.security_mass_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.security_mass_status(value, buffer, offset, packet, parent)
...
size_of.instrument_scope_product_complex = 1

-- Display: Instrument Scope Product Complex
display.instrument_scope_product_complex = function(value)
  if value == 1 then
...
dissect.instrument_scope_product_complex = function(buffer, offset, packet, parent)
  local length = size_of.instrument_scope_product_complex
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.instrument_scope_product_complex(value, buffer, offset, packet, parent)
...
size_of.mass_instrument_state_change = function(buffer, offset)
  local index = 0

  index = index + size_of.instrument_scope_product_complex

  index = index + size_of.security_mass_status

  index = index + size_of.security_mass_trading_status

  index = index + size_of.mass_market_condition

  index = index + size_of.fast_market_indicator

  index = index + size_of.security_mass_trading_event

  index = index + size_of.mass_sold_out_indicator

  index = index + size_of.tes_security_mass_status

  index = index + size_of.transact_time

  index = index + size_of.last_fragment

  index = index + size_of.no_related_sym
...
display.mass_instrument_state_change = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Mass Instrument State Change
dissect.mass_instrument_state_change_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Instrument Scope Product Complex: 1 Byte Unsigned Fixed Width Integer Enum with 11 values
  index, instrument_scope_product_complex = dissect.instrument_scope_product_complex(buffer, index, packet, parent)

  -- Security Mass Status: 1 Byte Unsigned Fixed Width Integer Enum with 8 values
  index, security_mass_status = dissect.security_mass_status(buffer, index, packet, parent)

  -- Security Mass Trading Status: 1 Byte Unsigned Fixed Width Integer Enum with 21 values
  index, security_mass_trading_status = dissect.security_mass_trading_status(buffer, index, packet, parent)

  -- Mass Market Condition: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, mass_market_condition = dissect.mass_market_condition(buffer, index, packet, parent)

  -- Fast Market Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, fast_market_indicator = dissect.fast_market_indicator(buffer, index, packet, parent)

  -- Security Mass Trading Event: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, security_mass_trading_event = dissect.security_mass_trading_event(buffer, index, packet, parent)

  -- Mass Sold Out Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, mass_sold_out_indicator = dissect.mass_sold_out_indicator(buffer, index, packet, parent)

  -- Tes Security Mass Status: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, tes_security_mass_status = dissect.tes_security_mass_status(buffer, index, packet, parent)
  ...
  index, no_related_sym = dissect.no_related_sym(buffer, index, packet, parent)
  ...
  for i = 1, no_related_sym do
    index = dissect.sec_mass_stat_grp_comp(buffer, index, packet, parent)
  end
...
dissect.mass_instrument_state_change = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.mass_instrument_state_change then
    local length = size_of.mass_instrument_state_change(buffer, offset)
    local range = buffer(offset, length)
    local display = display.mass_instrument_state_change(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eobi_t7_v11_1.fields.mass_instrument_state_change, range, display)
  end

  return dissect.mass_instrument_state_change_fields(buffer, offset, packet, parent)
end
...
size_of.trading_hhi_indicator = 1

-- Display: Trading Hhi Indicator
display.trading_hhi_indicator = function(value)
  return "Trading Hhi Indicator: "..value
end

-- Dissect: Trading Hhi Indicator
dissect.trading_hhi_indicator = function(buffer, offset, packet, parent)
  local length = size_of.trading_hhi_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.trading_hhi_indicator(value, buffer, offset, packet, parent)
...
size_of.execution_summary = function(buffer, offset)
  ...
  index = index + size_of.trading_hhi_indicator
...
dissect.execution_summary_fields = function(buffer, offset, packet, parent)
  ...
  index, trading_hhi_indicator = dissect.trading_hhi_indicator(buffer, index, packet, parent)
...
dissect.input_source = function(buffer, offset, packet, parent)
  local length = size_of.input_source
  local range = buffer(offset, length)
  local value = range:le_uint()
...
dissect.cross_request_type = function(buffer, offset, packet, parent)
  local length = size_of.cross_request_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
size_of.cross_request = function(buffer, offset)
  ...
  index = index + size_of.cross_request_type

  index = index + size_of.input_source
...
dissect.cross_request_fields = function(buffer, offset, packet, parent)
  ...
  index, cross_request_type = dissect.cross_request_type(buffer, index, packet, parent)

  -- Input Source: 1 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, input_source = dissect.input_source(buffer, index, packet, parent)
...
-- Size: Offer Ord Type
size_of.offer_ord_type = 1

-- Display: Offer Ord Type
display.offer_ord_type = function(value)
  if value == 1 then
...
dissect.offer_ord_type = function(buffer, offset, packet, parent)
  local length = size_of.offer_ord_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.offer_ord_type(value, buffer, offset, packet, parent)
...
-- Size: Bid Ord Type
size_of.bid_ord_type = 1

-- Display: Bid Ord Type
display.bid_ord_type = function(value)
  if value == 1 then
...
dissect.bid_ord_type = function(buffer, offset, packet, parent)
  local length = size_of.bid_ord_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.bid_ord_type(value, buffer, offset, packet, parent)
...
size_of.auction_bbo = function(buffer, offset)
  ...
  index = index + size_of.bid_ord_type

  index = index + size_of.offer_ord_type
...
dissect.auction_bbo_fields = function(buffer, offset, packet, parent)
  ...
  index, bid_ord_type = dissect.bid_ord_type(buffer, index, packet, parent)

  -- Offer Ord Type: 1 Byte Unsigned Fixed Width Integer Enum with 1 values
  index, offer_ord_type = dissect.offer_ord_type(buffer, index, packet, parent)
...
size_of.add_flexible_instrument = function(buffer, offset)
  local index = 0
...
display.add_flexible_instrument = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Add Flexible Instrument
dissect.add_flexible_instrument_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.add_flexible_instrument = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.add_flexible_instrument then
    local length = size_of.add_flexible_instrument(buffer, offset)
    local range = buffer(offset, length)
    local display = display.add_flexible_instrument(buffer, packet, parent)
    parent = parent:add(eurex_derivatives_eobi_t7_v11_1.fields.add_flexible_instrument, range, display)
  end

  return dissect.add_flexible_instrument_fields(buffer, offset, packet, parent)
end
...
size_of.leg_ratio_multiplier = 4

-- Display: Leg Ratio Multiplier
display.leg_ratio_multiplier = function(value)
  return "Leg Ratio Multiplier: "..value
end

-- Dissect: Leg Ratio Multiplier
dissect.leg_ratio_multiplier = function(buffer, offset, packet, parent)
  local length = size_of.leg_ratio_multiplier
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.leg_ratio_multiplier(value, buffer, offset, packet, parent)
...
size_of.add_complex_instrument = function(buffer, offset)
  ...
  index = index + size_of.leg_ratio_multiplier
...
dissect.add_complex_instrument_fields = function(buffer, offset, packet, parent)
  ...
  index, leg_ratio_multiplier = dissect.leg_ratio_multiplier(buffer, index, packet, parent)
...
size_of.payload = function(buffer, offset, template_id)
  ...
  if template_id == 13401 then
    return size_of.add_flexible_instrument(buffer, offset)
  end
  -- Size of Auction Bbo
  ...
  if template_id == 13302 then
    return size_of.mass_instrument_state_change(buffer, offset)
  end
  -- Size of Order Add
  ...
  if template_id == 13203 then
    return size_of.tes_trade_report(buffer, offset)
  end
  -- Size of Top Of Book
...
dissect.payload_branches = function(buffer, offset, packet, parent, template_id)
  ...
  -- Dissect Add Flexible Instrument
  if template_id == 13401 then
    return dissect.add_flexible_instrument(buffer, offset, packet, parent)
  end
  -- Dissect Auction Bbo
  if template_id == 13500 then
  ...
  -- Dissect Mass Instrument State Change
  if template_id == 13302 then
    return dissect.mass_instrument_state_change(buffer, offset, packet, parent)
  end
  -- Dissect Order Add
  if template_id == 13100 then
  ...
  -- Dissect Tes Trade Report
  if template_id == 13203 then
    return dissect.tes_trade_report(buffer, offset, packet, parent)
  end
  -- Dissect Top Of Book
  if template_id == 13504 then
