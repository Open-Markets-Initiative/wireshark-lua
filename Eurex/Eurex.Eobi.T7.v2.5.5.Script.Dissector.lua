...
-- Eurex Eobi T7 2.5.5 Protocol
local eurex_eobi_t7_v2_5_5 = Proto("Eurex.Eobi.T7.v2.5.5.Lua", "Eurex Eobi T7 2.5.5")
...
-- Eurex Eobi T7 2.5.5 Fields
eurex_eobi_t7_v2_5_5.fields.add_complex_instrument = ProtoField.new("Add Complex Instrument", "eurex.eobi.t7.v2.5.5.addcomplexinstrument", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.aggressor_side = ProtoField.new("Aggressor Side", "eurex.eobi.t7.v2.5.5.aggressorside", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.aggressor_timestamp = ProtoField.new("Aggressor Timestamp", "eurex.eobi.t7.v2.5.5.aggressortimestamp", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.application_sequence_number = ProtoField.new("Application Sequence Number", "eurex.eobi.t7.v2.5.5.applicationsequencenumber", ftypes.UINT32)
eurex_eobi_t7_v2_5_5.fields.application_sequence_reset_indicator = ProtoField.new("Application Sequence Reset Indicator", "eurex.eobi.t7.v2.5.5.applicationsequenceresetindicator", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.auction_bbo = ProtoField.new("Auction Bbo", "eurex.eobi.t7.v2.5.5.auctionbbo", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.auction_clearing_price = ProtoField.new("Auction Clearing Price", "eurex.eobi.t7.v2.5.5.auctionclearingprice", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.bid_px = ProtoField.new("Bid Px", "eurex.eobi.t7.v2.5.5.bidpx", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.body_len = ProtoField.new("Body Len", "eurex.eobi.t7.v2.5.5.bodylen", ftypes.UINT16)
eurex_eobi_t7_v2_5_5.fields.completion_indicator = ProtoField.new("Completion Indicator", "eurex.eobi.t7.v2.5.5.completionindicator", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.cross_request = ProtoField.new("Cross Request", "eurex.eobi.t7.v2.5.5.crossrequest", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.display_qty = ProtoField.new("Display Qty", "eurex.eobi.t7.v2.5.5.displayqty", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.exec_id = ProtoField.new("Exec Id", "eurex.eobi.t7.v2.5.5.execid", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.execution_summary = ProtoField.new("Execution Summary", "eurex.eobi.t7.v2.5.5.executionsummary", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.fast_market_indicator = ProtoField.new("Fast Market Indicator", "eurex.eobi.t7.v2.5.5.fastmarketindicator", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.full_order_execution = ProtoField.new("Full Order Execution", "eurex.eobi.t7.v2.5.5.fullorderexecution", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.header_length = ProtoField.new("Header Length", "eurex.eobi.t7.v2.5.5.headerlength", ftypes.UINT16)
eurex_eobi_t7_v2_5_5.fields.heartbeat = ProtoField.new("Heartbeat", "eurex.eobi.t7.v2.5.5.heartbeat", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.implied_market_indicator = ProtoField.new("Implied Market Indicator", "eurex.eobi.t7.v2.5.5.impliedmarketindicator", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.instrmt_leg_grp = ProtoField.new("Instrmt Leg Grp", "eurex.eobi.t7.v2.5.5.instrmtleggrp", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.instrument_state_change = ProtoField.new("Instrument State Change", "eurex.eobi.t7.v2.5.5.instrumentstatechange", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.instrument_summary = ProtoField.new("Instrument Summary", "eurex.eobi.t7.v2.5.5.instrumentsummary", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.last_msg_seq_num_processed = ProtoField.new("Last Msg Seq Num Processed", "eurex.eobi.t7.v2.5.5.lastmsgseqnumprocessed", ftypes.UINT32)
eurex_eobi_t7_v2_5_5.fields.last_px = ProtoField.new("Last Px", "eurex.eobi.t7.v2.5.5.lastpx", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.last_qty = ProtoField.new("Last Qty", "eurex.eobi.t7.v2.5.5.lastqty", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.last_update_time = ProtoField.new("Last Update Time", "eurex.eobi.t7.v2.5.5.lastupdatetime", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "eurex.eobi.t7.v2.5.5.legratioqty", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.leg_security_id = ProtoField.new("Leg Security Id", "eurex.eobi.t7.v2.5.5.legsecurityid", ftypes.INT64)
eurex_eobi_t7_v2_5_5.fields.leg_side = ProtoField.new("Leg Side", "eurex.eobi.t7.v2.5.5.legside", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.leg_symbol = ProtoField.new("Leg Symbol", "eurex.eobi.t7.v2.5.5.legsymbol", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.market_segment_id = ProtoField.new("Market Segment ID", "eurex.eobi.t7.v2.5.5.marketsegmentid", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.match_sub_type = ProtoField.new("Match Sub Type", "eurex.eobi.t7.v2.5.5.matchsubtype", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.match_type = ProtoField.new("Match Type", "eurex.eobi.t7.v2.5.5.matchtype", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.md_entry_px = ProtoField.new("Md Entry Px", "eurex.eobi.t7.v2.5.5.mdentrypx", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.md_entry_size = ProtoField.new("Md Entry Size", "eurex.eobi.t7.v2.5.5.mdentrysize", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.md_entry_type = ProtoField.new("Md Entry Type", "eurex.eobi.t7.v2.5.5.mdentrytype", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.md_instrument_entry_grp = ProtoField.new("Md Instrument Entry Grp", "eurex.eobi.t7.v2.5.5.mdinstrumententrygrp", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.md_trade_entry_grp = ProtoField.new("Md Trade Entry Grp", "eurex.eobi.t7.v2.5.5.mdtradeentrygrp", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.message = ProtoField.new("Message", "eurex.eobi.t7.v2.5.5.message", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.message_header = ProtoField.new("Message Header", "eurex.eobi.t7.v2.5.5.messageheader", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.msg_seq_num = ProtoField.new("Msg Seq Num", "eurex.eobi.t7.v2.5.5.msgseqnum", ftypes.UINT32)
eurex_eobi_t7_v2_5_5.fields.no_legs = ProtoField.new("No Legs", "eurex.eobi.t7.v2.5.5.nolegs", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.no_md_entries = ProtoField.new("No Md Entries", "eurex.eobi.t7.v2.5.5.nomdentries", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.offer_px = ProtoField.new("Offer Px", "eurex.eobi.t7.v2.5.5.offerpx", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.order_add = ProtoField.new("Order Add", "eurex.eobi.t7.v2.5.5.orderadd", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.order_delete = ProtoField.new("Order Delete", "eurex.eobi.t7.v2.5.5.orderdelete", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.order_details = ProtoField.new("Order Details", "eurex.eobi.t7.v2.5.5.orderdetails", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.order_mass_delete = ProtoField.new("Order Mass Delete", "eurex.eobi.t7.v2.5.5.ordermassdelete", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.order_modify = ProtoField.new("Order Modify", "eurex.eobi.t7.v2.5.5.ordermodify", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.order_modify_same_prio = ProtoField.new("Order Modify Same Prio", "eurex.eobi.t7.v2.5.5.ordermodifysameprio", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.packet = ProtoField.new("Packet", "eurex.eobi.t7.v2.5.5.packet", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.packet_header = ProtoField.new("Packet Header", "eurex.eobi.t7.v2.5.5.packetheader", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.packet_id = ProtoField.new("Packet Id", "eurex.eobi.t7.v2.5.5.packetid", ftypes.UINT16)
eurex_eobi_t7_v2_5_5.fields.packet_info = ProtoField.new("Packet Info", "eurex.eobi.t7.v2.5.5.packetinfo", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.packet_seq_num = ProtoField.new("Packet Seq Num", "eurex.eobi.t7.v2.5.5.packetseqnum", ftypes.UINT32)
eurex_eobi_t7_v2_5_5.fields.pad_1 = ProtoField.new("Pad 1", "eurex.eobi.t7.v2.5.5.pad1", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.pad_2 = ProtoField.new("Pad 2", "eurex.eobi.t7.v2.5.5.pad2", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.pad_3 = ProtoField.new("Pad 3", "eurex.eobi.t7.v2.5.5.pad3", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.pad_4 = ProtoField.new("Pad 4", "eurex.eobi.t7.v2.5.5.pad4", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.pad_5 = ProtoField.new("Pad 5", "eurex.eobi.t7.v2.5.5.pad5", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.pad_6 = ProtoField.new("Pad 6", "eurex.eobi.t7.v2.5.5.pad6", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.pad_7 = ProtoField.new("Pad 7", "eurex.eobi.t7.v2.5.5.pad7", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.pad5 = ProtoField.new("Pad5", "eurex.eobi.t7.v2.5.5.pad5", ftypes.BYTES)
eurex_eobi_t7_v2_5_5.fields.partial_order_execution = ProtoField.new("Partial Order Execution", "eurex.eobi.t7.v2.5.5.partialorderexecution", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.partition_id = ProtoField.new("Partition ID", "eurex.eobi.t7.v2.5.5.partitionid", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.payload = ProtoField.new("Payload", "eurex.eobi.t7.v2.5.5.payload", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.prev_display_qty = ProtoField.new("Prev Display Qty", "eurex.eobi.t7.v2.5.5.prevdisplayqty", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.prev_price = ProtoField.new("Prev Price", "eurex.eobi.t7.v2.5.5.prevprice", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.price = ProtoField.new("Price", "eurex.eobi.t7.v2.5.5.price", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.product_complex = ProtoField.new("Product Complex", "eurex.eobi.t7.v2.5.5.productcomplex", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.product_state_change = ProtoField.new("Product State Change", "eurex.eobi.t7.v2.5.5.productstatechange", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.product_summary = ProtoField.new("Product Summary", "eurex.eobi.t7.v2.5.5.productsummary", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.quote_request = ProtoField.new("Quote Request", "eurex.eobi.t7.v2.5.5.quoterequest", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.request_time = ProtoField.new("Request Time", "eurex.eobi.t7.v2.5.5.requesttime", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.resting_hidden_qty = ProtoField.new("Resting Hidden Qty", "eurex.eobi.t7.v2.5.5.restinghiddenqty", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.security_id = ProtoField.new("Security Id", "eurex.eobi.t7.v2.5.5.securityid", ftypes.INT64)
eurex_eobi_t7_v2_5_5.fields.security_status = ProtoField.new("Security Status", "eurex.eobi.t7.v2.5.5.securitystatus", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.security_sub_type = ProtoField.new("Security Sub Type", "eurex.eobi.t7.v2.5.5.securitysubtype", ftypes.INT32)
eurex_eobi_t7_v2_5_5.fields.security_trading_status = ProtoField.new("Security Trading Status", "eurex.eobi.t7.v2.5.5.securitytradingstatus", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.side = ProtoField.new("Side", "eurex.eobi.t7.v2.5.5.side", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.snapshot_order = ProtoField.new("Snapshot Order", "eurex.eobi.t7.v2.5.5.snapshotorder", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.template_id = ProtoField.new("Template Id", "eurex.eobi.t7.v2.5.5.templateid", ftypes.UINT16)
eurex_eobi_t7_v2_5_5.fields.top_of_book = ProtoField.new("Top Of Book", "eurex.eobi.t7.v2.5.5.topofbook", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.tot_no_orders = ProtoField.new("Tot No Orders", "eurex.eobi.t7.v2.5.5.totnoorders", ftypes.UINT16)
eurex_eobi_t7_v2_5_5.fields.trad_ses_status = ProtoField.new("Trad Ses Status", "eurex.eobi.t7.v2.5.5.tradsesstatus", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.trade_condition = ProtoField.new("Trade Condition", "eurex.eobi.t7.v2.5.5.tradecondition", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.trade_report = ProtoField.new("Trade Report", "eurex.eobi.t7.v2.5.5.tradereport", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.trade_reversal = ProtoField.new("Trade Reversal", "eurex.eobi.t7.v2.5.5.tradereversal", ftypes.STRING)
eurex_eobi_t7_v2_5_5.fields.trading_session_id = ProtoField.new("Trading Session Id", "eurex.eobi.t7.v2.5.5.tradingsessionid", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.trading_session_sub_id = ProtoField.new("Trading Session Sub Id", "eurex.eobi.t7.v2.5.5.tradingsessionsubid", ftypes.UINT8)
eurex_eobi_t7_v2_5_5.fields.transact_time = ProtoField.new("Transact Time", "eurex.eobi.t7.v2.5.5.transacttime", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.trd_match_id = ProtoField.new("Trd Match Id", "eurex.eobi.t7.v2.5.5.trdmatchid", ftypes.UINT32)
eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_execution_time = ProtoField.new("Trd Reg Ts Execution Time", "eurex.eobi.t7.v2.5.5.trdregtsexecutiontime", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_prev_time_priority = ProtoField.new("Trd Reg Ts Prev Time Priority", "eurex.eobi.t7.v2.5.5.trdregtsprevtimepriority", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_time_in = ProtoField.new("Trd Reg Ts Time In", "eurex.eobi.t7.v2.5.5.trdregtstimein", ftypes.UINT64)
eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_time_priority = ProtoField.new("Trd Reg Ts Time Priority", "eurex.eobi.t7.v2.5.5.trdregtstimepriority", ftypes.UINT64)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Eurex Eobi T7 2.5.5 Element Dissection Options
...
-- Register Eurex Eobi T7 2.5.5 Show Options
eurex_eobi_t7_v2_5_5.prefs.show_add_complex_instrument = Pref.bool("Show Add Complex Instrument", show.add_complex_instrument, "Parse and add Add Complex Instrument to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_auction_bbo = Pref.bool("Show Auction Bbo", show.auction_bbo, "Parse and add Auction Bbo to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_auction_clearing_price = Pref.bool("Show Auction Clearing Price", show.auction_clearing_price, "Parse and add Auction Clearing Price to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_cross_request = Pref.bool("Show Cross Request", show.cross_request, "Parse and add Cross Request to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_execution_summary = Pref.bool("Show Execution Summary", show.execution_summary, "Parse and add Execution Summary to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_full_order_execution = Pref.bool("Show Full Order Execution", show.full_order_execution, "Parse and add Full Order Execution to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_heartbeat = Pref.bool("Show Heartbeat", show.heartbeat, "Parse and add Heartbeat to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_instrmt_leg_grp = Pref.bool("Show Instrmt Leg Grp", show.instrmt_leg_grp, "Parse and add Instrmt Leg Grp to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_instrument_state_change = Pref.bool("Show Instrument State Change", show.instrument_state_change, "Parse and add Instrument State Change to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_instrument_summary = Pref.bool("Show Instrument Summary", show.instrument_summary, "Parse and add Instrument Summary to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_md_instrument_entry_grp = Pref.bool("Show Md Instrument Entry Grp", show.md_instrument_entry_grp, "Parse and add Md Instrument Entry Grp to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_md_trade_entry_grp = Pref.bool("Show Md Trade Entry Grp", show.md_trade_entry_grp, "Parse and add Md Trade Entry Grp to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_order_add = Pref.bool("Show Order Add", show.order_add, "Parse and add Order Add to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_order_delete = Pref.bool("Show Order Delete", show.order_delete, "Parse and add Order Delete to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_order_details = Pref.bool("Show Order Details", show.order_details, "Parse and add Order Details to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_order_mass_delete = Pref.bool("Show Order Mass Delete", show.order_mass_delete, "Parse and add Order Mass Delete to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_order_modify = Pref.bool("Show Order Modify", show.order_modify, "Parse and add Order Modify to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_order_modify_same_prio = Pref.bool("Show Order Modify Same Prio", show.order_modify_same_prio, "Parse and add Order Modify Same Prio to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_packet_info = Pref.bool("Show Packet Info", show.packet_info, "Parse and add Packet Info to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_partial_order_execution = Pref.bool("Show Partial Order Execution", show.partial_order_execution, "Parse and add Partial Order Execution to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_product_state_change = Pref.bool("Show Product State Change", show.product_state_change, "Parse and add Product State Change to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_product_summary = Pref.bool("Show Product Summary", show.product_summary, "Parse and add Product Summary to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_quote_request = Pref.bool("Show Quote Request", show.quote_request, "Parse and add Quote Request to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_snapshot_order = Pref.bool("Show Snapshot Order", show.snapshot_order, "Parse and add Snapshot Order to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_top_of_book = Pref.bool("Show Top Of Book", show.top_of_book, "Parse and add Top Of Book to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_trade_report = Pref.bool("Show Trade Report", show.trade_report, "Parse and add Trade Report to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_trade_reversal = Pref.bool("Show Trade Reversal", show.trade_reversal, "Parse and add Trade Reversal to protocol tree")
eurex_eobi_t7_v2_5_5.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function eurex_eobi_t7_v2_5_5.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.add_complex_instrument ~= eurex_eobi_t7_v2_5_5.prefs.show_add_complex_instrument then
    show.add_complex_instrument = eurex_eobi_t7_v2_5_5.prefs.show_add_complex_instrument
    changed = true
  end
  if show.auction_bbo ~= eurex_eobi_t7_v2_5_5.prefs.show_auction_bbo then
    show.auction_bbo = eurex_eobi_t7_v2_5_5.prefs.show_auction_bbo
    changed = true
  end
  if show.auction_clearing_price ~= eurex_eobi_t7_v2_5_5.prefs.show_auction_clearing_price then
    show.auction_clearing_price = eurex_eobi_t7_v2_5_5.prefs.show_auction_clearing_price
    changed = true
  end
  if show.cross_request ~= eurex_eobi_t7_v2_5_5.prefs.show_cross_request then
    show.cross_request = eurex_eobi_t7_v2_5_5.prefs.show_cross_request
    changed = true
  end
  if show.execution_summary ~= eurex_eobi_t7_v2_5_5.prefs.show_execution_summary then
    show.execution_summary = eurex_eobi_t7_v2_5_5.prefs.show_execution_summary
    changed = true
  end
  if show.full_order_execution ~= eurex_eobi_t7_v2_5_5.prefs.show_full_order_execution then
    show.full_order_execution = eurex_eobi_t7_v2_5_5.prefs.show_full_order_execution
    changed = true
  end
  if show.heartbeat ~= eurex_eobi_t7_v2_5_5.prefs.show_heartbeat then
    show.heartbeat = eurex_eobi_t7_v2_5_5.prefs.show_heartbeat
    changed = true
  end
  if show.instrmt_leg_grp ~= eurex_eobi_t7_v2_5_5.prefs.show_instrmt_leg_grp then
    show.instrmt_leg_grp = eurex_eobi_t7_v2_5_5.prefs.show_instrmt_leg_grp
    changed = true
  end
  if show.instrument_state_change ~= eurex_eobi_t7_v2_5_5.prefs.show_instrument_state_change then
    show.instrument_state_change = eurex_eobi_t7_v2_5_5.prefs.show_instrument_state_change
    changed = true
  end
  if show.instrument_summary ~= eurex_eobi_t7_v2_5_5.prefs.show_instrument_summary then
    show.instrument_summary = eurex_eobi_t7_v2_5_5.prefs.show_instrument_summary
    changed = true
  end
  if show.md_instrument_entry_grp ~= eurex_eobi_t7_v2_5_5.prefs.show_md_instrument_entry_grp then
    show.md_instrument_entry_grp = eurex_eobi_t7_v2_5_5.prefs.show_md_instrument_entry_grp
    changed = true
  end
  if show.md_trade_entry_grp ~= eurex_eobi_t7_v2_5_5.prefs.show_md_trade_entry_grp then
    show.md_trade_entry_grp = eurex_eobi_t7_v2_5_5.prefs.show_md_trade_entry_grp
    changed = true
  end
  if show.message ~= eurex_eobi_t7_v2_5_5.prefs.show_message then
    show.message = eurex_eobi_t7_v2_5_5.prefs.show_message
    changed = true
  end
  if show.message_header ~= eurex_eobi_t7_v2_5_5.prefs.show_message_header then
    show.message_header = eurex_eobi_t7_v2_5_5.prefs.show_message_header
    changed = true
  end
  if show.order_add ~= eurex_eobi_t7_v2_5_5.prefs.show_order_add then
    show.order_add = eurex_eobi_t7_v2_5_5.prefs.show_order_add
    changed = true
  end
  if show.order_delete ~= eurex_eobi_t7_v2_5_5.prefs.show_order_delete then
    show.order_delete = eurex_eobi_t7_v2_5_5.prefs.show_order_delete
    changed = true
  end
  if show.order_details ~= eurex_eobi_t7_v2_5_5.prefs.show_order_details then
    show.order_details = eurex_eobi_t7_v2_5_5.prefs.show_order_details
    changed = true
  end
  if show.order_mass_delete ~= eurex_eobi_t7_v2_5_5.prefs.show_order_mass_delete then
    show.order_mass_delete = eurex_eobi_t7_v2_5_5.prefs.show_order_mass_delete
    changed = true
  end
  if show.order_modify ~= eurex_eobi_t7_v2_5_5.prefs.show_order_modify then
    show.order_modify = eurex_eobi_t7_v2_5_5.prefs.show_order_modify
    changed = true
  end
  if show.order_modify_same_prio ~= eurex_eobi_t7_v2_5_5.prefs.show_order_modify_same_prio then
    show.order_modify_same_prio = eurex_eobi_t7_v2_5_5.prefs.show_order_modify_same_prio
    changed = true
  end
  if show.packet ~= eurex_eobi_t7_v2_5_5.prefs.show_packet then
    show.packet = eurex_eobi_t7_v2_5_5.prefs.show_packet
    changed = true
  end
  if show.packet_header ~= eurex_eobi_t7_v2_5_5.prefs.show_packet_header then
    show.packet_header = eurex_eobi_t7_v2_5_5.prefs.show_packet_header
    changed = true
  end
  if show.packet_info ~= eurex_eobi_t7_v2_5_5.prefs.show_packet_info then
    show.packet_info = eurex_eobi_t7_v2_5_5.prefs.show_packet_info
    changed = true
  end
  if show.partial_order_execution ~= eurex_eobi_t7_v2_5_5.prefs.show_partial_order_execution then
    show.partial_order_execution = eurex_eobi_t7_v2_5_5.prefs.show_partial_order_execution
    changed = true
  end
  if show.product_state_change ~= eurex_eobi_t7_v2_5_5.prefs.show_product_state_change then
    show.product_state_change = eurex_eobi_t7_v2_5_5.prefs.show_product_state_change
    changed = true
  end
  if show.product_summary ~= eurex_eobi_t7_v2_5_5.prefs.show_product_summary then
    show.product_summary = eurex_eobi_t7_v2_5_5.prefs.show_product_summary
    changed = true
  end
  if show.quote_request ~= eurex_eobi_t7_v2_5_5.prefs.show_quote_request then
    show.quote_request = eurex_eobi_t7_v2_5_5.prefs.show_quote_request
    changed = true
  end
  if show.snapshot_order ~= eurex_eobi_t7_v2_5_5.prefs.show_snapshot_order then
    show.snapshot_order = eurex_eobi_t7_v2_5_5.prefs.show_snapshot_order
    changed = true
  end
  if show.top_of_book ~= eurex_eobi_t7_v2_5_5.prefs.show_top_of_book then
    show.top_of_book = eurex_eobi_t7_v2_5_5.prefs.show_top_of_book
    changed = true
  end
  if show.trade_report ~= eurex_eobi_t7_v2_5_5.prefs.show_trade_report then
    show.trade_report = eurex_eobi_t7_v2_5_5.prefs.show_trade_report
    changed = true
  end
  if show.trade_reversal ~= eurex_eobi_t7_v2_5_5.prefs.show_trade_reversal then
    show.trade_reversal = eurex_eobi_t7_v2_5_5.prefs.show_trade_reversal
    changed = true
  end
  if show.payload ~= eurex_eobi_t7_v2_5_5.prefs.show_payload then
    show.payload = eurex_eobi_t7_v2_5_5.prefs.show_payload
    changed = true
  end
...
dissect.pad_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad_3, range, value, display)
...
dissect.md_entry_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.md_entry_type, range, value, display)
...
dissect.md_entry_size = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.md_entry_size, range, value, display)
...
dissect.md_entry_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.md_entry_px, range, value, display)
...
dissect.md_trade_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.md_trade_entry_grp then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.md_trade_entry_grp, range, display)
  end
...
dissect.pad_7 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad_7, range, value, display)
...
dissect.no_md_entries = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.no_md_entries, range, value, display)
...
dissect.trd_reg_ts_execution_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_execution_time, range, value, display)
...
dissect.last_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.last_px, range, value, display)
...
dissect.last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.last_qty, range, value, display)
...
dissect.trd_match_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trd_match_id, range, value, display)
...
dissect.transact_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.transact_time, range, value, display)
...
dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.security_id, range, value, display)
...
dissect.trade_reversal = function(buffer, offset, packet, parent)
  ...
  if show.trade_reversal then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.trade_reversal, range, display)
  end
...
dissect.pad_6 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad_6, range, value, display)
...
dissect.match_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.match_sub_type, range, value, display)
...
dissect.match_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.match_type, range, value, display)
...
dissect.trade_report = function(buffer, offset, packet, parent)
  ...
  if show.trade_report then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.trade_report, range, display)
  end
...
dissect.offer_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.offer_px, range, value, display)
...
dissect.bid_px = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.bid_px, range, value, display)
...
dissect.top_of_book = function(buffer, offset, packet, parent)
  ...
  if show.top_of_book then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.top_of_book, range, display)
  end
...
dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.price, range, value, display)
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.side, range, value, display)
...
dissect.display_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.display_qty, range, value, display)
...
dissect.trd_reg_ts_time_priority = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_time_priority, range, value, display)
...
dissect.order_details = function(buffer, offset, packet, parent)
  ...
  if show.order_details then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.order_details, range, display)
  end
...
dissect.snapshot_order = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_order then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.snapshot_order, range, display)
  end
...
dissect.quote_request = function(buffer, offset, packet, parent)
  ...
  if show.quote_request then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.quote_request, range, display)
  end
...
dissect.fast_market_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.fast_market_indicator, range, value, display)
...
dissect.trad_ses_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trad_ses_status, range, value, display)
...
dissect.trading_session_sub_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trading_session_sub_id, range, value, display)
...
dissect.trading_session_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trading_session_id, range, value, display)
...
dissect.last_msg_seq_num_processed = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.last_msg_seq_num_processed, range, value, display)
...
dissect.product_summary = function(buffer, offset, packet, parent)
  ...
  if show.product_summary then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.product_summary, range, display)
  end
...
dissect.pad_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad_4, range, value, display)
...
dissect.product_state_change = function(buffer, offset, packet, parent)
  ...
  if show.product_state_change then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.product_state_change, range, display)
  end
...
dissect.partial_order_execution = function(buffer, offset, packet, parent)
  ...
  if show.partial_order_execution then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.partial_order_execution, range, display)
  end
...
dissect.pad5 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad5, range, value, display)
...
dissect.application_sequence_reset_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.application_sequence_reset_indicator, range, value, display)
...
dissect.completion_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.completion_indicator, range, value, display)
...
dissect.partition_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.partition_id, range, value, display)
...
dissect.market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.market_segment_id, range, value, display)
...
dissect.application_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.application_sequence_number, range, value, display)
...
dissect.packet_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.packet_seq_num, range, value, display)
...
dissect.packet_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.packet_id, range, value, display)
...
dissect.header_length = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.header_length, range, value, display)
...
dissect.packet_info = function(buffer, offset, packet, parent)
  ...
  if show.packet_info then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.packet_info, range, display)
  end
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.packet_header, range, display)
  end
...
dissect.prev_display_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.prev_display_qty, range, value, display)
...
dissect.trd_reg_ts_time_in = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_time_in, range, value, display)
...
dissect.order_modify_same_prio = function(buffer, offset, packet, parent)
  ...
  if show.order_modify_same_prio then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.order_modify_same_prio, range, display)
  end
...
dissect.prev_price = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.prev_price, range, value, display)
...
dissect.trd_reg_ts_prev_time_priority = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trd_reg_ts_prev_time_priority, range, value, display)
...
dissect.order_modify = function(buffer, offset, packet, parent)
  ...
  if show.order_modify then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.order_modify, range, display)
  end
...
dissect.order_mass_delete = function(buffer, offset, packet, parent)
  ...
  if show.order_mass_delete then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.order_mass_delete, range, display)
  end
...
dissect.order_delete = function(buffer, offset, packet, parent)
  ...
  if show.order_delete then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.order_delete, range, display)
  end
...
dissect.order_add = function(buffer, offset, packet, parent)
  ...
  if show.order_add then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.order_add, range, display)
  end
...
dissect.md_instrument_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_entry_grp then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.md_instrument_entry_grp, range, display)
  end
...
dissect.pad_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad_2, range, value, display)
...
dissect.security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.security_trading_status, range, value, display)
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.security_status, range, value, display)
...
dissect.tot_no_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.tot_no_orders, range, value, display)
...
dissect.last_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.last_update_time, range, value, display)
...
dissect.instrument_summary = function(buffer, offset, packet, parent)
  ...
  if show.instrument_summary then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.instrument_summary, range, display)
  end
...
dissect.pad_5 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad_5, range, value, display)
...
dissect.instrument_state_change = function(buffer, offset, packet, parent)
  ...
  if show.instrument_state_change then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.instrument_state_change, range, display)
  end
...
dissect.heartbeat = function(buffer, offset, packet, parent)
  ...
  if show.heartbeat then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.heartbeat, range, display)
  end
...
dissect.full_order_execution = function(buffer, offset, packet, parent)
  ...
  if show.full_order_execution then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.full_order_execution, range, display)
  end
...
dissect.resting_hidden_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.resting_hidden_qty, range, value, display)
...
dissect.trade_condition = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.trade_condition, range, value, display)
...
dissect.aggressor_side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.aggressor_side, range, value, display)
...
dissect.exec_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.exec_id, range, value, display)
...
dissect.request_time = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.request_time, range, value, display)
...
dissect.aggressor_timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.aggressor_timestamp, range, value, display)
...
dissect.execution_summary = function(buffer, offset, packet, parent)
  ...
  if show.execution_summary then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.execution_summary, range, display)
  end
...
dissect.cross_request = function(buffer, offset, packet, parent)
  ...
  if show.cross_request then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.cross_request, range, display)
  end
...
dissect.auction_clearing_price = function(buffer, offset, packet, parent)
  ...
  if show.auction_clearing_price then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.auction_clearing_price, range, display)
  end
...
dissect.auction_bbo = function(buffer, offset, packet, parent)
  ...
  if show.auction_bbo then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.auction_bbo, range, display)
  end
...
dissect.leg_side = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.leg_side, range, value, display)
...
dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.leg_ratio_qty, range, value, display)
...
dissect.leg_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.leg_security_id, range, value, display)
...
dissect.leg_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.leg_symbol, range, value, display)
...
dissect.instrmt_leg_grp = function(buffer, offset, packet, parent)
  ...
  if show.instrmt_leg_grp then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.instrmt_leg_grp, range, display)
  end
...
dissect.pad_1 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.pad_1, range, value, display)
...
dissect.no_legs = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.no_legs, range, value, display)
...
dissect.implied_market_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.implied_market_indicator, range, value, display)
...
dissect.product_complex = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.product_complex, range, value, display)
...
dissect.security_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.security_sub_type, range, value, display)
...
dissect.add_complex_instrument = function(buffer, offset, packet, parent)
  ...
  if show.add_complex_instrument then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.add_complex_instrument, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, code)
  ...
  local element = parent:add(eurex_eobi_t7_v2_5_5.fields.payload, range, display)
...
dissect.msg_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.msg_seq_num, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.template_id, range, value, display)
...
dissect.body_len = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_eobi_t7_v2_5_5.fields.body_len, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.message_header, range, display)
  end
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(eurex_eobi_t7_v2_5_5.fields.message, range, display)
  end
...
function eurex_eobi_t7_v2_5_5.init()
end

-- Dissector for Eurex Eobi T7 2.5.5
function eurex_eobi_t7_v2_5_5.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = eurex_eobi_t7_v2_5_5.name

  -- Dissect protocol
  local protocol = parent:add(eurex_eobi_t7_v2_5_5, buffer(), eurex_eobi_t7_v2_5_5.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, eurex_eobi_t7_v2_5_5)
...
verify.eurex_eobi_t7_v2_5_5_packet_size = function(buffer)
...
-- Dissector Heuristic for Eurex Eobi T7 2.5.5
local function eurex_eobi_t7_v2_5_5_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.eurex_eobi_t7_v2_5_5_packet_size(buffer) then return false end

  -- Verify Packet Id
  if not verify.packet_id(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = eurex_eobi_t7_v2_5_5
  eurex_eobi_t7_v2_5_5.dissector(buffer, packet, parent)

  return true
end

-- Register Eurex Eobi T7 2.5.5 Heuristic
eurex_eobi_t7_v2_5_5:register_heuristic("udp", eurex_eobi_t7_v2_5_5_heuristic)
