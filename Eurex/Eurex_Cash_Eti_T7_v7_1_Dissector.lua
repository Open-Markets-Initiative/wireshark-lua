...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_target_parties_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.xetra_en_light_target_parties_comp = function(buffer, offset, packet, parent)
  if show.xetra_en_light_target_parties_comp then
    ...
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.xetra_en_light_target_parties_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.xetra_en_light_target_parties_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.xetra_en_light_target_parties_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.xetra_en_light_target_parties_comp_fields(buffer, offset, packet, element)
  end
end
...
-- Display: Order Qty
eurex_cash_eti_t7_v7_1_display.order_qty = function(raw, value)
...
-- Display: Offer Px
eurex_cash_eti_t7_v7_1_display.offer_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
-- Display: Bid Px
eurex_cash_eti_t7_v7_1_display.bid_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.request_header_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.request_header_comp = function(buffer, offset, packet, parent)
  if show.request_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.request_header_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.request_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.request_header_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.request_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_update_negotiation_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.xetra_en_light_update_negotiation_request_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_update_negotiation_request)
  ...
  for xetra_en_light_target_parties_comp_index = 1, no_target_party_i_ds do
    index, xetra_en_light_target_parties_comp = eurex_cash_eti_t7_v7_1_dissect.xetra_en_light_target_parties_comp(buffer, index, packet, parent)

    if xetra_en_light_target_parties_comp ~= nil then
      local iteration = xetra_en_light_target_parties_comp:add(eurex_cash_eti_t7_v7_1.fields.xetra_en_light_target_parties_comp_index, xetra_en_light_target_parties_comp_index)
...
eurex_cash_eti_t7_v7_1_display.rbc_header_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.rbc_header_comp = function(buffer, offset, packet, parent)
  if show.rbc_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.rbc_header_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.rbc_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.rbc_header_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.rbc_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_status_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_quoting_status_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.response_header_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.response_header_comp = function(buffer, offset, packet, parent)
  if show.response_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.response_header_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.response_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.response_header_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.response_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_quote_response = function(packet, parent, length)
  return ""
end
...
-- Display: Offer Size
eurex_cash_eti_t7_v7_1_display.offer_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
-- Display: Bid Size
eurex_cash_eti_t7_v7_1_display.bid_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.srqs_quote_entry_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.srqs_quote_entry_grp_comp = function(buffer, offset, packet, parent)
  if show.srqs_quote_entry_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.srqs_quote_entry_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.srqs_quote_entry_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.srqs_quote_entry_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.srqs_quote_entry_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_quote_requester_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.xetra_en_light_quote_requester_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_quote_requester_notification)
  ...
  for srqs_quote_entry_grp_comp_index = 1, no_quote_entries do
    index, srqs_quote_entry_grp_comp = eurex_cash_eti_t7_v7_1_dissect.srqs_quote_entry_grp_comp(buffer, index, packet, parent)

    if srqs_quote_entry_grp_comp ~= nil then
      local iteration = srqs_quote_entry_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.srqs_quote_entry_grp_comp_index, srqs_quote_entry_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_quote_notification = function(packet, parent, length)
  return ""
end
...
-- Display: Last Qty
eurex_cash_eti_t7_v7_1_display.last_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
-- Display: Last Px
eurex_cash_eti_t7_v7_1_display.last_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_open_negotiation_requester_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_open_negotiation_request = function(packet, parent, length)
  return ""
end
...
-- Display: Leaves Qty
eurex_cash_eti_t7_v7_1_display.leaves_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_open_negotiation_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_negotiation_status_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_negotiation_requester_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_negotiation_notification = function(packet, parent, length)
  return ""
end
...
-- Display: Price
eurex_cash_eti_t7_v7_1_display.price = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_hit_quote_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_enter_quote_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_deal_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.best_offer_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.best_offer_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.best_bid_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
-- Display: Best Bid Px
eurex_cash_eti_t7_v7_1_display.best_bid_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.order_book_item_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.order_book_item_grp_comp = function(buffer, offset, packet, parent)
  if show.order_book_item_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.order_book_item_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.order_book_item_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.order_book_item_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.order_book_item_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.xetra_en_light_create_deal_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.xetra_en_light_create_deal_notification_fields = function(buffer, offset, packet, parent, size_of_xetra_en_light_create_deal_notification)
  ...
  for order_book_item_grp_comp_index = 1, no_order_book_items do
    index, order_book_item_grp_comp = eurex_cash_eti_t7_v7_1_dissect.order_book_item_grp_comp(buffer, index, packet, parent)

    if order_book_item_grp_comp ~= nil then
      local iteration = order_book_item_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.order_book_item_grp_comp_index, order_book_item_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.user_logout_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.user_logout_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.user_login_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.user_login_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.unsubscribe_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.unsubscribe_request = function(packet, parent, length)
  return ""
end
...
-- Display: Stop Px
eurex_cash_eti_t7_v7_1_display.stop_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.rbc_header_me_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.rbc_header_me_comp = function(buffer, offset, packet, parent)
  if show.rbc_header_me_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.rbc_header_me_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.rbc_header_me_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.rbc_header_me_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.rbc_header_me_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.trailing_stop_update_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.trading_session_status_broadcast = function(packet, parent, length)
  return ""
end
...
-- Display: Coupon Rate
eurex_cash_eti_t7_v7_1_display.coupon_rate = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.accrued_interes_amt = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.side_gross_trade_amt = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
-- Display: Cum Qty
eurex_cash_eti_t7_v7_1_display.cum_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.settl_curr_fx_rate = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.settl_curr_amt = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.trade_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.notif_header_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.notif_header_comp = function(buffer, offset, packet, parent)
  if show.notif_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.notif_header_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.notif_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.notif_header_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.notif_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.throttle_update_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.tm_trading_session_status_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.tes_trading_session_status_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.tes_trade_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.tes_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.tes_execution_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.tes_delete_broadcast = function(packet, parent, length)
  return ""
end
...
-- Display: Alloc Qty
eurex_cash_eti_t7_v7_1_display.alloc_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.side_alloc_grp_bc_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_bc_comp = function(buffer, offset, packet, parent)
  if show.side_alloc_grp_bc_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.side_alloc_grp_bc_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_bc_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.side_alloc_grp_bc_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_bc_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.tes_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.tes_broadcast_fields = function(buffer, offset, packet, parent, size_of_tes_broadcast)
  ...
  for side_alloc_grp_bc_comp_index = 1, no_side_allocs do
    index, side_alloc_grp_bc_comp = eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_bc_comp(buffer, index, packet, parent)

    if side_alloc_grp_bc_comp ~= nil then
      local iteration = side_alloc_grp_bc_comp:add(eurex_cash_eti_t7_v7_1.fields.side_alloc_grp_bc_comp_index, side_alloc_grp_bc_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.tes_approve_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.subscribe_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.subscribe_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.nrbc_header_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.nrbc_header_comp = function(buffer, offset, packet, parent)
  if show.nrbc_header_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.nrbc_header_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.nrbc_header_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.nrbc_header_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.nrbc_header_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.service_availability_market_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.service_availability_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.retransmit_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.retransmit_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.retransmit_me_message_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.retransmit_me_message_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.alignment_padding = function(value)
  return "Alignment Padding: "..value
end

-- Dissect runtime sized field: Alignment Padding
eurex_cash_eti_t7_v7_1_dissect.alignment_padding = function(buffer, offset, packet, parent, size)
...
eurex_cash_eti_t7_v7_1_display.nr_response_header_me_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.nr_response_header_me_comp = function(buffer, offset, packet, parent)
  if show.nr_response_header_me_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.nr_response_header_me_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.nr_response_header_me_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.nr_response_header_me_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.nr_response_header_me_comp_fields(buffer, offset, packet, element)
  end
end
...
-- Display: Reject
eurex_cash_eti_t7_v7_1_display.reject = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.reject_fields = function(buffer, offset, packet, parent, size_of_reject)
  ...
  index, var_text = eurex_cash_eti_t7_v7_1_dissect.var_text(buffer, index, packet, parent, var_text_len)
  ...
  if alignment_padding_exists then
    ...
    index, alignment_padding = eurex_cash_eti_t7_v7_1_dissect.alignment_padding(buffer, index, packet, parent, size_of_alignment_padding)
  end
...
eurex_cash_eti_t7_v7_1_display.rfq_response = function(packet, parent, length)
  return ""
end
...
-- Display: Rfq Request
eurex_cash_eti_t7_v7_1_display.rfq_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.rfq_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.quote_event_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.quote_event_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.quote_event_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.quote_event_grp_comp = function(buffer, offset, packet, parent)
  if show.quote_event_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.quote_event_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.quote_event_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.quote_event_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.quote_event_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.quote_execution_report = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.quote_execution_report_fields = function(buffer, offset, packet, parent, size_of_quote_execution_report)
  ...
  for quote_event_grp_comp_index = 1, no_quote_events do
    index, quote_event_grp_comp = eurex_cash_eti_t7_v7_1_dissect.quote_event_grp_comp(buffer, index, packet, parent)

    if quote_event_grp_comp ~= nil then
      local iteration = quote_event_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.quote_event_grp_comp_index, quote_event_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.not_affected_securities_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.not_affected_securities_grp_comp = function(buffer, offset, packet, parent)
  if show.not_affected_securities_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.not_affected_securities_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.not_affected_securities_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.not_affected_securities_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.not_affected_securities_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.quote_activation_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.quote_activation_response_fields = function(buffer, offset, packet, parent, size_of_quote_activation_response)
  ...
  for not_affected_securities_grp_comp_index = 1, no_not_affected_securities do
    index, not_affected_securities_grp_comp = eurex_cash_eti_t7_v7_1_dissect.not_affected_securities_grp_comp(buffer, index, packet, parent)

    if not_affected_securities_grp_comp ~= nil then
      local iteration = not_affected_securities_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.not_affected_securities_grp_comp_index, not_affected_securities_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.quote_activation_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.quote_activation_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.party_entitlements_update_report = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.party_action_report = function(packet, parent, length)
  return ""
end
...
-- Display: Fill Qty
eurex_cash_eti_t7_v7_1_display.fill_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
-- Display: Fill Px
eurex_cash_eti_t7_v7_1_display.fill_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.fills_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.fills_grp_comp = function(buffer, offset, packet, parent)
  if show.fills_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.fills_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.fills_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.fills_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.fills_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
-- Display: Display Qty
eurex_cash_eti_t7_v7_1_display.display_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
-- Display: Cxl Qty
eurex_cash_eti_t7_v7_1_display.cxl_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.response_header_me_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.response_header_me_comp = function(buffer, offset, packet, parent)
  if show.response_header_me_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.response_header_me_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.response_header_me_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.response_header_me_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.response_header_me_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.order_exec_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.order_exec_response_fields = function(buffer, offset, packet, parent, size_of_order_exec_response)
  ...
  for fills_grp_comp_index = 1, no_fills do
    index, fills_grp_comp = eurex_cash_eti_t7_v7_1_dissect.fills_grp_comp(buffer, index, packet, parent)

    if fills_grp_comp ~= nil then
      local iteration = fills_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.fills_grp_comp_index, fills_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.peg_offset_value_pct = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.peg_offset_value_abs = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.volume_discovery_price = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.display_high_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.display_low_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.order_exec_report_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.order_exec_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.news_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.new_order_single_short_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.new_order_single_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.new_order_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.new_order_nr_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.side_alloc_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_comp = function(buffer, offset, packet, parent)
  if show.side_alloc_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.side_alloc_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.side_alloc_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.modify_tes_trade_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.modify_tes_trade_request_fields = function(buffer, offset, packet, parent, size_of_modify_tes_trade_request)
  ...
  for side_alloc_grp_comp_index = 1, no_side_allocs do
    index, side_alloc_grp_comp = eurex_cash_eti_t7_v7_1_dissect.side_alloc_grp_comp(buffer, index, packet, parent)

    if side_alloc_grp_comp ~= nil then
      local iteration = side_alloc_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.side_alloc_grp_comp_index, side_alloc_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.modify_order_single_short_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.modify_order_single_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.modify_order_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.modify_order_nr_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.offer_cxl_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.bid_cxl_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.quote_entry_ack_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.quote_entry_ack_grp_comp = function(buffer, offset, packet, parent)
  if show.quote_entry_ack_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.quote_entry_ack_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.quote_entry_ack_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.quote_entry_ack_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.quote_entry_ack_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.mass_quote_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.mass_quote_response_fields = function(buffer, offset, packet, parent, size_of_mass_quote_response)
  ...
  for quote_entry_ack_grp_comp_index = 1, no_quote_entries do
    index, quote_entry_ack_grp_comp = eurex_cash_eti_t7_v7_1_dissect.quote_entry_ack_grp_comp(buffer, index, packet, parent)

    if quote_entry_ack_grp_comp ~= nil then
      local iteration = quote_entry_ack_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.quote_entry_ack_grp_comp_index, quote_entry_ack_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.quote_entry_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.quote_entry_grp_comp = function(buffer, offset, packet, parent)
  if show.quote_entry_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.quote_entry_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.quote_entry_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.quote_entry_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.quote_entry_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.mass_quote_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.mass_quote_request_fields = function(buffer, offset, packet, parent, size_of_mass_quote_request)
  ...
  for quote_entry_grp_comp_index = 1, no_quote_entries do
    index, quote_entry_grp_comp = eurex_cash_eti_t7_v7_1_dissect.quote_entry_grp_comp(buffer, index, packet, parent)

    if quote_entry_grp_comp ~= nil then
      local iteration = quote_entry_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.quote_entry_grp_comp_index, quote_entry_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.logout_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.logout_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.logon_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.logon_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.legal_notification_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.issuer_security_state_change_response = function(packet, parent, length)
  return ""
end
...
-- Display: Event Px
eurex_cash_eti_t7_v7_1_display.event_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.security_status_event_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.security_status_event_grp_comp = function(buffer, offset, packet, parent)
  if show.security_status_event_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.security_status_event_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.security_status_event_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.security_status_event_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.security_status_event_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.issuer_security_state_change_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.issuer_security_state_change_request_fields = function(buffer, offset, packet, parent, size_of_issuer_security_state_change_request)
  ...
  for security_status_event_grp_comp_index = 1, no_events do
    index, security_status_event_grp_comp = eurex_cash_eti_t7_v7_1_dissect.security_status_event_grp_comp(buffer, index, packet, parent)

    if security_status_event_grp_comp ~= nil then
      local iteration = security_status_event_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.security_status_event_grp_comp_index, security_status_event_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.imbalance_qty = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.potential_exec_volume = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.issuer_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.party_details_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.party_details_grp_comp = function(buffer, offset, packet, parent)
  if show.party_details_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.party_details_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.party_details_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.party_details_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.party_details_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.inquire_user_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.inquire_user_response_fields = function(buffer, offset, packet, parent, size_of_inquire_user_response)
  ...
  for party_details_grp_comp_index = 1, no_party_details do
    index, party_details_grp_comp = eurex_cash_eti_t7_v7_1_dissect.party_details_grp_comp(buffer, index, packet, parent)

    if party_details_grp_comp ~= nil then
      local iteration = party_details_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.party_details_grp_comp_index, party_details_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.inquire_user_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.sessions_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.sessions_grp_comp = function(buffer, offset, packet, parent)
  if show.sessions_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.sessions_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.sessions_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.sessions_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.sessions_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.inquire_session_list_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.inquire_session_list_response_fields = function(buffer, offset, packet, parent, size_of_inquire_session_list_response)
  ...
  for sessions_grp_comp_index = 1, no_sessions do
    index, sessions_grp_comp = eurex_cash_eti_t7_v7_1_dissect.sessions_grp_comp(buffer, index, packet, parent)

    if sessions_grp_comp ~= nil then
      local iteration = sessions_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.sessions_grp_comp_index, sessions_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.inquire_session_list_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.enrichment_rules_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.enrichment_rules_grp_comp = function(buffer, offset, packet, parent)
  if show.enrichment_rules_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.enrichment_rules_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.enrichment_rules_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.enrichment_rules_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.enrichment_rules_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.inquire_enrichment_rule_id_list_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.inquire_enrichment_rule_id_list_response_fields = function(buffer, offset, packet, parent, size_of_inquire_enrichment_rule_id_list_response)
  ...
  for enrichment_rules_grp_comp_index = 1, no_enrichment_rules do
    index, enrichment_rules_grp_comp = eurex_cash_eti_t7_v7_1_dissect.enrichment_rules_grp_comp(buffer, index, packet, parent)

    if enrichment_rules_grp_comp ~= nil then
      local iteration = enrichment_rules_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.enrichment_rules_grp_comp_index, enrichment_rules_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.inquire_enrichment_rule_id_list_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.heartbeat_notification = function(packet, parent, length)
  return ""
end
...
-- Display: Heartbeat
eurex_cash_eti_t7_v7_1_display.heartbeat = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.forced_user_logout_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.forced_logout_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.extended_deletion_report = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.enter_tes_trade_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.peg_offset_value_offer_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.peg_offset_value_bid_px = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.reserved_offer_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.reserved_bid_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.enter_best_quote_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_tes_trade_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_order_single_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_order_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_order_nr_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_order_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_all_quote_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_all_quote_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_all_quote_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.affected_order_requests_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.affected_order_requests_grp_comp = function(buffer, offset, packet, parent)
  if show.affected_order_requests_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.affected_order_requests_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.affected_order_requests_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.affected_order_requests_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.affected_order_requests_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.affected_ord_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.affected_ord_grp_comp = function(buffer, offset, packet, parent)
  if show.affected_ord_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.affected_ord_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.affected_ord_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.affected_ord_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.affected_ord_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.not_affected_orders_grp_comp = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.not_affected_orders_grp_comp = function(buffer, offset, packet, parent)
  if show.not_affected_orders_grp_comp then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.not_affected_orders_grp_comp, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.not_affected_orders_grp_comp_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.not_affected_orders_grp_comp(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.not_affected_orders_grp_comp_fields(buffer, offset, packet, element)
  end
end
...
eurex_cash_eti_t7_v7_1_display.delete_all_order_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.delete_all_order_response_fields = function(buffer, offset, packet, parent, size_of_delete_all_order_response)
  ...
  for not_affected_orders_grp_comp_index = 1, no_not_affected_orders do
    index, not_affected_orders_grp_comp = eurex_cash_eti_t7_v7_1_dissect.not_affected_orders_grp_comp(buffer, index, packet, parent)

    if not_affected_orders_grp_comp ~= nil then
      local iteration = not_affected_orders_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.not_affected_orders_grp_comp_index, not_affected_orders_grp_comp_index)
      iteration:set_generated()
    end
  end
  ...
  for affected_ord_grp_comp_index = 1, no_affected_orders do
    index, affected_ord_grp_comp = eurex_cash_eti_t7_v7_1_dissect.affected_ord_grp_comp(buffer, index, packet, parent)

    if affected_ord_grp_comp ~= nil then
      local iteration = affected_ord_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.affected_ord_grp_comp_index, affected_ord_grp_comp_index)
      iteration:set_generated()
    end
  end
  ...
  for affected_order_requests_grp_comp_index = 1, no_affected_order_requests do
    index, affected_order_requests_grp_comp = eurex_cash_eti_t7_v7_1_dissect.affected_order_requests_grp_comp(buffer, index, packet, parent)

    if affected_order_requests_grp_comp ~= nil then
      local iteration = affected_order_requests_grp_comp:add(eurex_cash_eti_t7_v7_1.fields.affected_order_requests_grp_comp_index, affected_order_requests_grp_comp_index)
      iteration:set_generated()
    end
  end
...
eurex_cash_eti_t7_v7_1_display.delete_all_order_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_all_order_quote_event_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_all_order_nr_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.delete_all_order_broadcast = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.cross_request_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.cross_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.broadcast_error_notification = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.best_quote_response = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.reserved_size = function(raw, value)
  -- Check null sentinel value
  if raw == UInt64(0x00000000, 0x80000000) then
...
eurex_cash_eti_t7_v7_1_display.best_quote_execution_report = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.approve_tes_trade_request = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_display.message_header = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.message_header, buffer(offset, 0))
    local index = eurex_cash_eti_t7_v7_1_dissect.message_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = eurex_cash_eti_t7_v7_1_display.message_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return eurex_cash_eti_t7_v7_1_dissect.message_header_fields(buffer, offset, packet, element)
  end
end

-- Display: Message
eurex_cash_eti_t7_v7_1_display.message = function(packet, parent, length)
  return ""
end
...
eurex_cash_eti_t7_v7_1_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(eurex_cash_eti_t7_v7_1.fields.message, buffer(offset, 0))
    local current = eurex_cash_eti_t7_v7_1_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = eurex_cash_eti_t7_v7_1_display.message(buffer, packet, element)
    element:append_text(display)
