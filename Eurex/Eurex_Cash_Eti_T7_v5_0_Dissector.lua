...
eurex_cash_eti_t7_v5_0.response_header_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.request_time.size

  index = index + eurex_cash_eti_t7_v5_0.sending_time.size

  index = index + eurex_cash_eti_t7_v5_0.msg_seq_num.size

  index = index + eurex_cash_eti_t7_v5_0.pad_4.size
...
eurex_cash_eti_t7_v5_0.request_header_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.msg_seq_num.size

  index = index + eurex_cash_eti_t7_v5_0.sender_sub_id.size
...
eurex_cash_eti_t7_v5_0.rbc_header_me_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.trd_reg_ts_time_out.size

  index = index + eurex_cash_eti_t7_v5_0.notification_in.size

  index = index + eurex_cash_eti_t7_v5_0.sending_time.size

  index = index + eurex_cash_eti_t7_v5_0.appl_sub_id.size

  index = index + eurex_cash_eti_t7_v5_0.partition_id.size

  index = index + eurex_cash_eti_t7_v5_0.appl_msg_id.size

  index = index + eurex_cash_eti_t7_v5_0.appl_id.size

  index = index + eurex_cash_eti_t7_v5_0.appl_resend_flag.size

  index = index + eurex_cash_eti_t7_v5_0.last_fragment.size

  index = index + eurex_cash_eti_t7_v5_0.pad_7.size
...
eurex_cash_eti_t7_v5_0.rbc_header_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.sending_time.size

  index = index + eurex_cash_eti_t7_v5_0.appl_seq_num.size
...
eurex_cash_eti_t7_v5_0.notif_header_comp.size = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v5_0.nrbc_header_comp.size = function(buffer, offset)
  local index = 0
  ...
  index = index + eurex_cash_eti_t7_v5_0.pad_2.size
...
eurex_cash_eti_t7_v5_0.alignment_padding.dissect = function(buffer, offset, packet, parent, size)
  ...
  local value = range:bytes():tohex(false, " ")
  local display = eurex_cash_eti_t7_v5_0.alignment_padding.display(value, buffer, offset, packet, parent, size)
...
eurex_cash_eti_t7_v5_0.var_text.dissect = function(buffer, offset, packet, parent, size)
  ...
  local display = eurex_cash_eti_t7_v5_0.var_text.display(value, buffer, offset, packet, parent, size)
...
eurex_cash_eti_t7_v5_0.nr_response_header_me_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.request_time.size

  index = index + eurex_cash_eti_t7_v5_0.request_out.size

  index = index + eurex_cash_eti_t7_v5_0.trd_reg_ts_time_in.size

  index = index + eurex_cash_eti_t7_v5_0.trd_reg_ts_time_out.size

  index = index + eurex_cash_eti_t7_v5_0.response_in.size
  ...
  index = index + eurex_cash_eti_t7_v5_0.pad_3.size
...
eurex_cash_eti_t7_v5_0.quote_event_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.security_id.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_px.size

  index = index + eurex_cash_eti_t7_v5_0.quote_msg_id.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_match_id.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_exec_id.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_qty.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_type.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_side.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_liquidity_ind.size

  index = index + eurex_cash_eti_t7_v5_0.quote_event_reason.size
...
eurex_cash_eti_t7_v5_0.not_affected_securities_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.not_affected_security_id.size
...
eurex_cash_eti_t7_v5_0.fills_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.fill_px.size

  index = index + eurex_cash_eti_t7_v5_0.fill_qty.size

  index = index + eurex_cash_eti_t7_v5_0.fill_match_id.size

  index = index + eurex_cash_eti_t7_v5_0.fill_exec_id.size

  index = index + eurex_cash_eti_t7_v5_0.fill_liquidity_ind.size
...
eurex_cash_eti_t7_v5_0.response_header_me_comp.size = function(buffer, offset)
  local index = 0
...
eurex_cash_eti_t7_v5_0.quote_entry_ack_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.security_id.size

  index = index + eurex_cash_eti_t7_v5_0.bid_cxl_size.size

  index = index + eurex_cash_eti_t7_v5_0.offer_cxl_size.size

  index = index + eurex_cash_eti_t7_v5_0.quote_entry_reject_reason.size

  index = index + eurex_cash_eti_t7_v5_0.quote_entry_status.size
...
eurex_cash_eti_t7_v5_0.quote_entry_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.security_id.size

  index = index + eurex_cash_eti_t7_v5_0.bid_px.size

  index = index + eurex_cash_eti_t7_v5_0.offer_px.size

  index = index + eurex_cash_eti_t7_v5_0.bid_size.size

  index = index + eurex_cash_eti_t7_v5_0.offer_size.size
...
eurex_cash_eti_t7_v5_0.party_details_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.party_detail_id_executing_trader.size

  index = index + eurex_cash_eti_t7_v5_0.party_detail_executing_trader.size

  index = index + eurex_cash_eti_t7_v5_0.party_detail_role_qualifier.size

  index = index + eurex_cash_eti_t7_v5_0.party_detail_status.size

  index = index + eurex_cash_eti_t7_v5_0.party_detail_desk_id.size

  index = index + eurex_cash_eti_t7_v5_0.pad_1.size
...
eurex_cash_eti_t7_v5_0.sessions_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.party_id_session_id.size

  index = index + eurex_cash_eti_t7_v5_0.session_mode.size

  index = index + eurex_cash_eti_t7_v5_0.session_sub_mode.size
...
eurex_cash_eti_t7_v5_0.enrichment_rules_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.enrichment_rule_id.size

  index = index + eurex_cash_eti_t7_v5_0.free_text_1.size

  index = index + eurex_cash_eti_t7_v5_0.free_text_4.size
...
eurex_cash_eti_t7_v5_0.affected_ord_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.affected_order_id.size

  index = index + eurex_cash_eti_t7_v5_0.affected_orig_cl_ord_id.size
...
eurex_cash_eti_t7_v5_0.not_affected_orders_grp_comp.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.not_affected_order_id.size

  index = index + eurex_cash_eti_t7_v5_0.not_aff_orig_cl_ord_id.size
...
eurex_cash_eti_t7_v5_0.message_header.size = function(buffer, offset)
  local index = 0

  index = index + eurex_cash_eti_t7_v5_0.body_len.size

  index = index + eurex_cash_eti_t7_v5_0.template_id.size
...
local message_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < eurex_cash_eti_t7_v5_0.message_header.size(buffer, index) then
