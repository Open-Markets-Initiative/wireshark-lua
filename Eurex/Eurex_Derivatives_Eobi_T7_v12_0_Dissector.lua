...
local omi_eurex_derivatives_eobi_t7_v12_0 = Proto("Omi.Eurex.Derivatives.Eobi.T7.v12.0", "Eurex Derivatives Eobi T7 12.0")
...
omi_eurex_derivatives_eobi_t7_v12_0.fields.appl_seq_num = ProtoField.new("Appl Seq Num", "eurex.derivatives.eobi.t7.v12.0.applseqnum", ftypes.UINT64)
...
omi_eurex_derivatives_eobi_t7_v12_0.fields.eobi_header = ProtoField.new("Eobi Header", "eurex.derivatives.eobi.t7.v12.0.eobiheader", ftypes.STRING)
...
-- Eurex Derivatives T7 Eobi 12.0 Application Messages
...
omi_eurex_derivatives_eobi_t7_v12_0.prefs.show_eobi_header = Pref.bool("Show Eobi Header", show.eobi_header, "Parse and add Eobi Header to protocol tree")
...
function omi_eurex_derivatives_eobi_t7_v12_0.prefs_changed()
  ...
  if show.eobi_header ~= omi_eurex_derivatives_eobi_t7_v12_0.prefs.show_eobi_header then
    show.eobi_header = omi_eurex_derivatives_eobi_t7_v12_0.prefs.show_eobi_header
  end
...
-- Size: Appl Seq Num
eurex_derivatives_eobi_t7_v12_0.appl_seq_num.size = 8
...
eurex_derivatives_eobi_t7_v12_0.trade_reversal.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v12_0.fields.trade_reversal, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v12_0.trade_reversal.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v12_0.trade_reversal.display(packet, parent, length)
    parent:append_text(display)
...
eurex_derivatives_eobi_t7_v12_0.mass_instrument_state_change.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v12_0.fields.mass_instrument_state_change, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v12_0.mass_instrument_state_change.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v12_0.mass_instrument_state_change.display(packet, parent, length)
    parent:append_text(display)
...
eurex_derivatives_eobi_t7_v12_0.instrument_summary.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v12_0.fields.instrument_summary, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v12_0.instrument_summary.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v12_0.instrument_summary.display(packet, parent, length)
    parent:append_text(display)
...
eurex_derivatives_eobi_t7_v12_0.add_complex_instrument.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v12_0.fields.add_complex_instrument, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v12_0.add_complex_instrument.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v12_0.add_complex_instrument.display(packet, parent, length)
    parent:append_text(display)
...
-- Eobi Header
eurex_derivatives_eobi_t7_v12_0.eobi_header = {}

-- Size: Eobi Header
eurex_derivatives_eobi_t7_v12_0.eobi_header.size =
  eurex_derivatives_eobi_t7_v12_0.body_len.size + 
  eurex_derivatives_eobi_t7_v12_0.template_id.size + 
  eurex_derivatives_eobi_t7_v12_0.msg_seq_num.size

-- Display: Eobi Header
eurex_derivatives_eobi_t7_v12_0.eobi_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eobi Header
eurex_derivatives_eobi_t7_v12_0.eobi_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Eobi Header
eurex_derivatives_eobi_t7_v12_0.eobi_header.dissect = function(buffer, offset, packet, parent)
  if show.eobi_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_eurex_derivatives_eobi_t7_v12_0.fields.eobi_header, buffer(offset, 0))
    local index = eurex_derivatives_eobi_t7_v12_0.eobi_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = eurex_derivatives_eobi_t7_v12_0.eobi_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return eurex_derivatives_eobi_t7_v12_0.eobi_header.fields(buffer, offset, packet, parent)
  end
end
...
eurex_derivatives_eobi_t7_v12_0.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, eobi_header = eurex_derivatives_eobi_t7_v12_0.eobi_header.dissect(buffer, index, packet, parent)
...
eurex_derivatives_eobi_t7_v12_0.packet.requiredsize = function(buffer)
  return buffer:len() >= eurex_derivatives_eobi_t7_v12_0.packet_header.size + eurex_derivatives_eobi_t7_v12_0.message_header_comp.size
end
...
-- Dissector Heuristic for Eurex Derivatives Eobi T7 12.0 (Udp)
local function omi_eurex_derivatives_eobi_t7_v12_0_udp_heuristic(buffer, packet, parent)
...
omi_eurex_derivatives_eobi_t7_v12_0:register_heuristic("udp", omi_eurex_derivatives_eobi_t7_v12_0_udp_heuristic)

-- Register Eurex Derivatives Eobi T7 12.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_eurex_derivatives_eobi_t7_v12_0)
