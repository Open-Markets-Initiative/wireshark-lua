...
eurex_derivatives_eobi_t7_v12_0.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 13401 then
    return eurex_derivatives_eobi_t7_v12_0.add_flexible_instrument.size
  end
  -- Size of Add Scaled Simple Instrument
  if template_id == 13402 then
    return eurex_derivatives_eobi_t7_v12_0.add_scaled_simple_instrument.size
  end
  -- Size of Auction Bbo
  if template_id == 13500 then
    return eurex_derivatives_eobi_t7_v12_0.auction_bbo.size
  end
  -- Size of Auction Clearing Price
  if template_id == 13501 then
    return eurex_derivatives_eobi_t7_v12_0.auction_clearing_price.size
  end
  -- Size of Cross Request
  if template_id == 13502 then
    return eurex_derivatives_eobi_t7_v12_0.cross_request.size
  end
  -- Size of Execution Summary
  if template_id == 13202 then
    return eurex_derivatives_eobi_t7_v12_0.execution_summary.size
  end
  -- Size of Full Order Execution
  if template_id == 13104 then
    return eurex_derivatives_eobi_t7_v12_0.full_order_execution.size
  end
  -- Size of Heartbeat
  if template_id == 13001 then
    return eurex_derivatives_eobi_t7_v12_0.heartbeat.size
  end
  -- Size of Instrument State Change
  if template_id == 13301 then
    return eurex_derivatives_eobi_t7_v12_0.instrument_state_change.size
  end
  ...
  if template_id == 13100 then
    return eurex_derivatives_eobi_t7_v12_0.order_add.size
  end
  -- Size of Order Delete
  if template_id == 13102 then
    return eurex_derivatives_eobi_t7_v12_0.order_delete.size
  end
  -- Size of Order Mass Delete
  if template_id == 13103 then
    return eurex_derivatives_eobi_t7_v12_0.order_mass_delete.size
  end
  -- Size of Order Modify
  if template_id == 13101 then
    return eurex_derivatives_eobi_t7_v12_0.order_modify.size
  end
  -- Size of Order Modify Same Prio
  if template_id == 13106 then
    return eurex_derivatives_eobi_t7_v12_0.order_modify_same_prio.size
  end
  -- Size of Partial Order Execution
  if template_id == 13105 then
    return eurex_derivatives_eobi_t7_v12_0.partial_order_execution.size
  end
  -- Size of Product State Change
  if template_id == 13300 then
    return eurex_derivatives_eobi_t7_v12_0.product_state_change.size
  end
  -- Size of Product Summary
  if template_id == 13600 then
    return eurex_derivatives_eobi_t7_v12_0.product_summary.size
  end
  -- Size of Quote Request
  if template_id == 13503 then
    return eurex_derivatives_eobi_t7_v12_0.quote_request.size
  end
  -- Size of Snapshot Order
  if template_id == 13602 then
    return eurex_derivatives_eobi_t7_v12_0.snapshot_order.size
  end
  -- Size of Tes Trade Report
  if template_id == 13203 then
    return eurex_derivatives_eobi_t7_v12_0.tes_trade_report.size
  end
  -- Size of Top Of Book
  if template_id == 13504 then
    return eurex_derivatives_eobi_t7_v12_0.top_of_book.size
  end
  -- Size of Trade Report
  if template_id == 13201 then
    return eurex_derivatives_eobi_t7_v12_0.trade_report.size
  end
