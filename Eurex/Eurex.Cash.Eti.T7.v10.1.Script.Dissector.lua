...
-- Size: Auto Exec Type
size_of.auto_exec_type = 1

-- Display: Auto Exec Type
display.auto_exec_type = function(value)
  if value == 1 then
...
dissect.auto_exec_type = function(buffer, offset, packet, parent)
  local length = size_of.auto_exec_type
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.auto_exec_type(value, buffer, offset, packet, parent)
...
size_of.auto_exec_min_no_of_quotes = 4

-- Display: Auto Exec Min No Of Quotes
display.auto_exec_min_no_of_quotes = function(value)
  return "Auto Exec Min No Of Quotes: "..value
end

-- Dissect: Auto Exec Min No Of Quotes
dissect.auto_exec_min_no_of_quotes = function(buffer, offset, packet, parent)
  local length = size_of.auto_exec_min_no_of_quotes
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.auto_exec_min_no_of_quotes(value, buffer, offset, packet, parent)
...
size_of.auto_exec_reference_price_offset = 4

-- Display: Auto Exec Reference Price Offset
display.auto_exec_reference_price_offset = function(value)
  return "Auto Exec Reference Price Offset: "..value
end

-- Dissect: Auto Exec Reference Price Offset
dissect.auto_exec_reference_price_offset = function(buffer, offset, packet, parent)
  local length = size_of.auto_exec_reference_price_offset
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.auto_exec_reference_price_offset(value, buffer, offset, packet, parent)
...
size_of.auto_exec_limit_price = 8

-- Display: Auto Exec Limit Price
display.auto_exec_limit_price = function(value)
...
dissect.auto_exec_limit_price = function(buffer, offset, packet, parent)
  local length = size_of.auto_exec_limit_price
  local range = buffer(offset, length)
  local raw = range:le_uint64()
  local value = translate.auto_exec_limit_price(raw)
  local display = display.auto_exec_limit_price(value, buffer, offset, packet, parent)
...
size_of.auto_exec_expiry_time = 8

-- Display: Auto Exec Expiry Time
display.auto_exec_expiry_time = function(value)
  return "Auto Exec Expiry Time: "..value
end

-- Dissect: Auto Exec Expiry Time
dissect.auto_exec_expiry_time = function(buffer, offset, packet, parent)
  local length = size_of.auto_exec_expiry_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = display.auto_exec_expiry_time(value, buffer, offset, packet, parent)
...
size_of.xetra_en_light_update_negotiation_request = function(buffer, offset)
  ...
  index = index + size_of.auto_exec_expiry_time

  index = index + size_of.auto_exec_limit_price

  index = index + size_of.auto_exec_reference_price_offset
  ...
  index = index + size_of.auto_exec_min_no_of_quotes
  ...
  index = index + size_of.auto_exec_type
  ...
  local xetra_en_light_target_parties_comp_count = buffer(offset + index - 204, 1):le_uint()
...
dissect.xetra_en_light_update_negotiation_request_fields = function(buffer, offset, packet, parent)
  ...
  index, auto_exec_expiry_time = dissect.auto_exec_expiry_time(buffer, index, packet, parent)

  -- Auto Exec Limit Price: 8 Byte Unsigned Fixed Width Integer
  index, auto_exec_limit_price = dissect.auto_exec_limit_price(buffer, index, packet, parent)

  -- Auto Exec Reference Price Offset: 4 Byte Signed Fixed Width Integer
  index, auto_exec_reference_price_offset = dissect.auto_exec_reference_price_offset(buffer, index, packet, parent)
  ...
  index, auto_exec_min_no_of_quotes = dissect.auto_exec_min_no_of_quotes(buffer, index, packet, parent)
  ...
  index, auto_exec_type = dissect.auto_exec_type(buffer, index, packet, parent)
...
size_of.quote_cancel_reason = 1

-- Display: Quote Cancel Reason
display.quote_cancel_reason = function(value)
  if value == 5 then
...
dissect.quote_cancel_reason = function(buffer, offset, packet, parent)
  local length = size_of.quote_cancel_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.quote_cancel_reason(value, buffer, offset, packet, parent)
...
size_of.xetra_en_light_quote_notification = function(buffer, offset)
  ...
  index = index + size_of.quote_cancel_reason
...
dissect.xetra_en_light_quote_notification_fields = function(buffer, offset, packet, parent)
  ...
  index, quote_cancel_reason = dissect.quote_cancel_reason(buffer, index, packet, parent)
...
-- Size: Side Is Locked
size_of.side_is_locked = 1

-- Display: Side Is Locked
display.side_is_locked = function(value)
  if value == 0 then
...
dissect.side_is_locked = function(buffer, offset, packet, parent)
  local length = size_of.side_is_locked
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.side_is_locked(value, buffer, offset, packet, parent)
...
size_of.offer_px_is_locked = 1

-- Display: Offer Px Is Locked
display.offer_px_is_locked = function(value)
  if value == 0 then
...
dissect.offer_px_is_locked = function(buffer, offset, packet, parent)
  local length = size_of.offer_px_is_locked
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.offer_px_is_locked(value, buffer, offset, packet, parent)
...
size_of.bid_px_is_locked = 1

-- Display: Bid Px Is Locked
display.bid_px_is_locked = function(value)
  if value == 0 then
...
dissect.bid_px_is_locked = function(buffer, offset, packet, parent)
  local length = size_of.bid_px_is_locked
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.bid_px_is_locked(value, buffer, offset, packet, parent)
...
size_of.xetra_en_light_open_negotiation_requester_notification = function(buffer, offset)
  ...
  index = index + size_of.bid_px_is_locked

  index = index + size_of.offer_px_is_locked

  index = index + size_of.side_is_locked
  ...
  -- Calculate field size from count
  local xetra_en_light_target_parties_comp_count = buffer(offset + index - 232, 1):le_uint()
  index = index + xetra_en_light_target_parties_comp_count * 16
...
dissect.xetra_en_light_open_negotiation_requester_notification_fields = function(buffer, offset, packet, parent)
  ...
  index, bid_px_is_locked = dissect.bid_px_is_locked(buffer, index, packet, parent)

  -- Offer Px Is Locked: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, offer_px_is_locked = dissect.offer_px_is_locked(buffer, index, packet, parent)

  -- Side Is Locked: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, side_is_locked = dissect.side_is_locked(buffer, index, packet, parent)
...
size_of.xetra_en_light_open_negotiation_request = function(buffer, offset)
  ...
  -- Calculate field size from count
  local xetra_en_light_target_parties_comp_count = buffer(offset + index - 224, 1):le_uint()
  index = index + xetra_en_light_target_parties_comp_count * 16
...
-- Size: Closure Reason
size_of.closure_reason = 132

-- Display: Closure Reason
display.closure_reason = function(value)
  return "Closure Reason: "..value
end

-- Dissect: Closure Reason
dissect.closure_reason = function(buffer, offset, packet, parent)
  local length = size_of.closure_reason
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.closure_reason(value, buffer, offset, packet, parent)
...
size_of.xetra_en_light_negotiation_requester_notification = function(buffer, offset)
  ...
  index = index + size_of.closure_reason

  index = index + size_of.pad_2

  -- Calculate field size from count
  local xetra_en_light_target_parties_comp_count = buffer(offset + index - 356, 1):le_uint()
  index = index + xetra_en_light_target_parties_comp_count * 16
...
dissect.xetra_en_light_negotiation_requester_notification_fields = function(buffer, offset, packet, parent)
  ...
  index, closure_reason = dissect.closure_reason(buffer, index, packet, parent)
...
size_of.xetra_en_light_create_deal_notification = function(buffer, offset)
  ...
  -- Calculate field size from count
  local order_book_item_grp_comp_count = buffer(offset + index - 118, 1):le_uint()
...
size_of.selective_request_for_quote_rtm_service_status = 1

-- Display: Selective Request For Quote Rtm Service Status
display.selective_request_for_quote_rtm_service_status = function(value)
  if value == 0 then
...
dissect.selective_request_for_quote_rtm_service_status = function(buffer, offset, packet, parent)
  local length = size_of.selective_request_for_quote_rtm_service_status
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.selective_request_for_quote_rtm_service_status(value, buffer, offset, packet, parent)
...
size_of.service_availability_market_broadcast = function(buffer, offset)
  ...
  index = index + size_of.selective_request_for_quote_rtm_service_status
...
dissect.service_availability_market_broadcast_fields = function(buffer, offset, packet, parent)
  ...
  index, selective_request_for_quote_rtm_service_status = dissect.selective_request_for_quote_rtm_service_status(buffer, index, packet, parent)
...
size_of.order_event_match_id = 4

-- Display: Order Event Match Id
display.order_event_match_id = function(value)
  return "Order Event Match Id: "..value
end

-- Dissect: Order Event Match Id
dissect.order_event_match_id = function(buffer, offset, packet, parent)
  local length = size_of.order_event_match_id
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.order_event_match_id(value, buffer, offset, packet, parent)
...
size_of.order_event_grp_comp = function(buffer, offset)
  local index = 0
  ...
  index = index + size_of.order_event_match_id
...
display.order_event_grp_comp = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Order Event Grp Comp
dissect.order_event_grp_comp_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_event_match_id = dissect.order_event_match_id(buffer, index, packet, parent)
...
dissect.order_event_grp_comp = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.order_event_grp_comp then
    local length = size_of.order_event_grp_comp(buffer, offset)
    local range = buffer(offset, length)
    local display = display.order_event_grp_comp(buffer, packet, parent)
    parent = parent:add(eurex_cash_eti_t7_v10_1.fields.order_event_grp_comp, range, display)
  end

  return dissect.order_event_grp_comp_fields(buffer, offset, packet, parent)
end

-- Size: No Order Events
size_of.no_order_events = 1

-- Display: No Order Events
display.no_order_events = function(value)
  return "No Order Events: "..value
end

-- Dissect: No Order Events
dissect.no_order_events = function(buffer, offset, packet, parent)
  local length = size_of.no_order_events
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.no_order_events(value, buffer, offset, packet, parent)
...
size_of.order_exec_response = function(buffer, offset)
  ...
  -- Calculate field size from count
  local order_event_grp_comp_count = buffer(offset + index - 38, 1):le_uint()
...
dissect.order_exec_response_fields = function(buffer, offset, packet, parent)
  ...
  index, no_order_events = dissect.no_order_events(buffer, index, packet, parent)
  ...
  for i = 1, no_order_events do
    index = dissect.order_event_grp_comp(buffer, index, packet, parent)
  end
...
size_of.order_exec_report_broadcast = function(buffer, offset)
  ...
  -- Calculate field size from count
  local order_event_grp_comp_count = buffer(offset + index - 39, 1):le_uint()
  index = index + order_event_grp_comp_count * 24
...
size_of.order_exec_notification = function(buffer, offset)
  ...
  -- Calculate field size from count
  local order_event_grp_comp_count = buffer(offset + index - 34, 1):le_uint()
  index = index + order_event_grp_comp_count * 24
...
size_of.new_order_response = function(buffer, offset)
  ...
  -- Calculate field size from count
  local order_event_grp_comp_count = buffer(offset + index - 5, 1):le_uint()
  index = index + order_event_grp_comp_count * 24
