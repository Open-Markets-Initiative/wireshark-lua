...
eurex_derivatives_eobi_t7_v7_1.fields.pad5 = ProtoField.new("Pad5", "eurex.derivatives.eobi.t7.v7.1.pad5", ftypes.BYTES)
...
dissect.order_details = function(buffer, offset, packet, parent)
  ...
  if show.order_details then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v7_1.fields.order_details, range, display)
  end
...
dissect.md_instrument_entry_grp = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_entry_grp then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v7_1.fields.md_instrument_entry_grp, range, display)
  end
...
dissect.instrmt_leg_grp = function(buffer, offset, packet, parent)
  ...
  if show.instrmt_leg_grp then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v7_1.fields.instrmt_leg_grp, range, display)
  end
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(eurex_derivatives_eobi_t7_v7_1.fields.message_header, range, display)
  end
...
dissect.pad5 = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eobi_t7_v7_1.fields.pad5, range, value, display)
...
dissect.application_sequence_reset_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eobi_t7_v7_1.fields.application_sequence_reset_indicator, range, value, display)
...
dissect.application_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eobi_t7_v7_1.fields.application_sequence_number, range, value, display)
...
dissect.packet_seq_num = function(buffer, offset, packet, parent)
  ...
  parent:add(eurex_derivatives_eobi_t7_v7_1.fields.packet_seq_num, range, value, display)
