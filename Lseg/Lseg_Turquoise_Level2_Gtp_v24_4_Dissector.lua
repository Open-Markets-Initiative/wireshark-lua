...
omi_lseg_turquoise_level2_gtp_v24_4.fields.electronic_order_book = ProtoField.new("Electronic Order Book", "lseg.turquoise.level2.gtp.v24.4.electronicorderbook", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_lseg_turquoise_level2_gtp_v24_4.fields.order_modify_flags = ProtoField.new("Order Modify Flags", "lseg.turquoise.level2.gtp.v24.4.ordermodifyflags", ftypes.STRING)
...
omi_lseg_turquoise_level2_gtp_v24_4.fields.priority = ProtoField.new("Priority", "lseg.turquoise.level2.gtp.v24.4.priority", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_lseg_turquoise_level2_gtp_v24_4.fields.trade_cancellation = ProtoField.new("Trade Cancellation", "lseg.turquoise.level2.gtp.v24.4.tradecancellation", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_lseg_turquoise_level2_gtp_v24_4.fields.unused_3 = ProtoField.new("Unused 3", "lseg.turquoise.level2.gtp.v24.4.unused3", ftypes.UINT8, nil, base.DEC, 0x07)
omi_lseg_turquoise_level2_gtp_v24_4.fields.unused_4 = ProtoField.new("Unused 4", "lseg.turquoise.level2.gtp.v24.4.unused4", ftypes.UINT8, nil, base.DEC, 0xF0)
omi_lseg_turquoise_level2_gtp_v24_4.fields.unused_7 = ProtoField.new("Unused 7", "lseg.turquoise.level2.gtp.v24.4.unused7", ftypes.UINT8, nil, base.DEC, 0xFE)
...
-- Lseg Turquoise Gtp Level2 24.4 Application Messages
...
omi_lseg_turquoise_level2_gtp_v24_4.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_lseg_turquoise_level2_gtp_v24_4.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_lseg_turquoise_level2_gtp_v24_4.prefs_changed()
  ...
  if show.structs ~= omi_lseg_turquoise_level2_gtp_v24_4.prefs.show_structs then
    show.structs = omi_lseg_turquoise_level2_gtp_v24_4.prefs.show_structs
  end
  if show.indexes ~= omi_lseg_turquoise_level2_gtp_v24_4.prefs.show_indexes then
    show.indexes = omi_lseg_turquoise_level2_gtp_v24_4.prefs.show_indexes
  end
end
...
-- Display: Trade Flags
lseg_turquoise_level2_gtp_v24_4.trade_flags.display = function(range, value, packet, parent)
  local flags = {}
...
lseg_turquoise_level2_gtp_v24_4.trade_flags.bits = function(range, value, packet, parent)

  -- Trade Cancellation: 1 Bit
  parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.trade_cancellation, range, value)

  -- Unused 7: 7 Bit
  parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.unused_7, range, value)
end

-- Dissect: Trade Flags
lseg_turquoise_level2_gtp_v24_4.trade_flags.dissect = function(buffer, offset, packet, parent)
  local size = lseg_turquoise_level2_gtp_v24_4.trade_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = lseg_turquoise_level2_gtp_v24_4.trade_flags.display(range, value, packet, parent)
  local element = parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.trade_flags, range, display)

  if show.structs then
    lseg_turquoise_level2_gtp_v24_4.trade_flags.bits(range, value, packet, element)
  end
...
-- Order Modify Flags
lseg_turquoise_level2_gtp_v24_4.order_modify_flags = {}

-- Size: Order Modify Flags
lseg_turquoise_level2_gtp_v24_4.order_modify_flags.size = 1

-- Display: Order Modify Flags
lseg_turquoise_level2_gtp_v24_4.order_modify_flags.display = function(range, value, packet, parent)
  local flags = {}
...
lseg_turquoise_level2_gtp_v24_4.order_modify_flags.bits = function(range, value, packet, parent)

  -- Priority: 1 Bit
  parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.priority, range, value)
...
lseg_turquoise_level2_gtp_v24_4.order_modify_flags.dissect = function(buffer, offset, packet, parent)
  local size = lseg_turquoise_level2_gtp_v24_4.order_modify_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = lseg_turquoise_level2_gtp_v24_4.order_modify_flags.display(range, value, packet, parent)
  local element = parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.order_modify_flags, range, display)

  if show.structs then
    lseg_turquoise_level2_gtp_v24_4.order_modify_flags.bits(range, value, packet, element)
  end
...
lseg_turquoise_level2_gtp_v24_4.order_modify_message.size =
  ...
  lseg_turquoise_level2_gtp_v24_4.instrument.size + 
  lseg_turquoise_level2_gtp_v24_4.side.size + 
  lseg_turquoise_level2_gtp_v24_4.order_modify_flags.size + 
  lseg_turquoise_level2_gtp_v24_4.order_book_type.size + 
...
lseg_turquoise_level2_gtp_v24_4.order_modify_message.fields = function(buffer, offset, packet, parent)
  ...
  index, order_modify_flags = lseg_turquoise_level2_gtp_v24_4.order_modify_flags.dissect(buffer, index, packet, parent)
...
lseg_turquoise_level2_gtp_v24_4.allowed_book_types.display = function(range, value, packet, parent)
  local flags = {}
...
lseg_turquoise_level2_gtp_v24_4.allowed_book_types.bits = function(range, value, packet, parent)

  -- Unused 3: 3 Bit
  parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.unused_3, range, value)

  -- Electronic Order Book: 1 Bit
  parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.electronic_order_book, range, value)

  -- Unused 4: 4 Bit
  parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.unused_4, range, value)
end
...
lseg_turquoise_level2_gtp_v24_4.allowed_book_types.dissect = function(buffer, offset, packet, parent)
  local size = lseg_turquoise_level2_gtp_v24_4.allowed_book_types.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = lseg_turquoise_level2_gtp_v24_4.allowed_book_types.display(range, value, packet, parent)
  local element = parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.allowed_book_types, range, display)

  if show.structs then
    lseg_turquoise_level2_gtp_v24_4.allowed_book_types.bits(range, value, packet, element)
  end
...
-- Dissect: Message
lseg_turquoise_level2_gtp_v24_4.message.dissect = function(buffer, offset, packet, parent, message_index)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_turquoise_level2_gtp_v24_4.fields.message, buffer(offset, 0))
    local index = lseg_turquoise_level2_gtp_v24_4.message.fields(buffer, offset, packet, parent, message_index)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_turquoise_level2_gtp_v24_4.message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_turquoise_level2_gtp_v24_4.message.fields(buffer, offset, packet, parent, message_index)
  end
end
...
lseg_turquoise_level2_gtp_v24_4.packet.requiredsize = function(buffer)
  return buffer:len() >= lseg_turquoise_level2_gtp_v24_4.unit_header.size
end
...
-- Register Lseg Turquoise Level2 Gtp 24.4 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_lseg_turquoise_level2_gtp_v24_4)
