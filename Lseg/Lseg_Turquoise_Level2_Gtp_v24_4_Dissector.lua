...
omi_lseg_turquoise_level2_gtp_v24_4.prefs.show_order_modify_flags = Pref.bool("Show Order Modify Flags", show.order_modify_flags, "Parse and add Order Modify Flags to protocol tree")
...
lseg_turquoise_level2_gtp_v24_4.order_modify_flags.dissect = function(buffer, offset, packet, parent)
  ...
  if show.order_modify_flags then
