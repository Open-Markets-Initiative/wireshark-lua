...
omi_lseg_tradeecho_level2_gtp_v24_4.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
omi_lseg_tradeecho_level2_gtp_v24_4.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_lseg_tradeecho_level2_gtp_v24_4.prefs_changed()
  ...
  if show.structs ~= omi_lseg_tradeecho_level2_gtp_v24_4.prefs.show_structs then
    show.structs = omi_lseg_tradeecho_level2_gtp_v24_4.prefs.show_structs
  end
  if show.indexes ~= omi_lseg_tradeecho_level2_gtp_v24_4.prefs.show_indexes then
    show.indexes = omi_lseg_tradeecho_level2_gtp_v24_4.prefs.show_indexes
  end
end
...
lseg_tradeecho_level2_gtp_v24_4.packet.requiredsize = function(buffer)
  return buffer:len() >= lseg_tradeecho_level2_gtp_v24_4.unit_header.size
end
...
-- Dissector Heuristic for Lseg TradeEcho Level2 Gtp 24.4 (Udp)
local function omi_lseg_tradeecho_level2_gtp_v24_4_udp_heuristic(buffer, packet, parent)
...
-- Register Lseg TradeEcho Level2 Gtp 24.4 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_lseg_tradeecho_level2_gtp_v24_4)
