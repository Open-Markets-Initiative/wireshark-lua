...
function omi_lseg_turquoise_mifid2pretrade_gtp_v26_3.prefs_changed()
  ...
  if show.headers ~= omi_lseg_turquoise_mifid2pretrade_gtp_v26_3.prefs.show_headers then
    show.headers = omi_lseg_turquoise_mifid2pretrade_gtp_v26_3.prefs.show_headers
  end
