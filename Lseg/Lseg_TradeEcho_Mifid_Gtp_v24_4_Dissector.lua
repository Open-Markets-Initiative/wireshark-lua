...
omi_lseg_tradeecho_mifid_gtp_v24_4.fields.off_book = ProtoField.new("Off Book", "lseg.tradeecho.mifid.gtp.v24.4.offbook", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_lseg_tradeecho_mifid_gtp_v24_4.fields.si_quote_book = ProtoField.new("Si Quote Book", "lseg.tradeecho.mifid.gtp.v24.4.siquotebook", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_lseg_tradeecho_mifid_gtp_v24_4.fields.unused_1 = ProtoField.new("Unused 1", "lseg.tradeecho.mifid.gtp.v24.4.unused1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_lseg_tradeecho_mifid_gtp_v24_4.fields.unused_5 = ProtoField.new("Unused 5", "lseg.tradeecho.mifid.gtp.v24.4.unused5", ftypes.UINT8, nil, base.DEC, 0xF8)
...
omi_lseg_tradeecho_mifid_gtp_v24_4.fields.statistics_message = ProtoField.new("Statistics Message", "lseg.tradeecho.mifid.gtp.v24.4.statisticsmessage", ftypes.STRING)
omi_lseg_tradeecho_mifid_gtp_v24_4.fields.system_event_message = ProtoField.new("System Event Message", "lseg.tradeecho.mifid.gtp.v24.4.systemeventmessage", ftypes.STRING)
...
omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_lseg_tradeecho_mifid_gtp_v24_4.prefs_changed()
  ...
  if show.application_messages ~= omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_application_messages then
    show.application_messages = omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_application_messages
  end
  if show.structs ~= omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_structs then
    show.structs = omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_structs
  end
  if show.indexes ~= omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_indexes then
    show.indexes = omi_lseg_tradeecho_mifid_gtp_v24_4.prefs.show_indexes
  end
end
...
lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message = {}

-- Size: Mifid Ii Trade Report Message
lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.size =
...
lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mifid Ii Trade Report Message
lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.mifid_ii_trade_report_message, buffer(offset, 0))
    local index = lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.fields(buffer, offset, packet, parent)
  end
end

-- Statistics Message
lseg_tradeecho_mifid_gtp_v24_4.statistics_message = {}

-- Size: Statistics Message
lseg_tradeecho_mifid_gtp_v24_4.statistics_message.size =
  lseg_tradeecho_mifid_gtp_v24_4.timestamp.size + 
  lseg_tradeecho_mifid_gtp_v24_4.instrument.size + 
  lseg_tradeecho_mifid_gtp_v24_4.source_venue.size + 
...
lseg_tradeecho_mifid_gtp_v24_4.statistics_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Statistics Message
lseg_tradeecho_mifid_gtp_v24_4.statistics_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
lseg_tradeecho_mifid_gtp_v24_4.statistics_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.statistics_message, buffer(offset, 0))
    local index = lseg_tradeecho_mifid_gtp_v24_4.statistics_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_tradeecho_mifid_gtp_v24_4.statistics_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_tradeecho_mifid_gtp_v24_4.statistics_message.fields(buffer, offset, packet, parent)
  end
end

-- Instrument Status Message
lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message = {}

-- Size: Instrument Status Message
lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.size =
  lseg_tradeecho_mifid_gtp_v24_4.timestamp.size + 
  lseg_tradeecho_mifid_gtp_v24_4.instrument.size + 
  lseg_tradeecho_mifid_gtp_v24_4.source_venue.size + 
...
lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Instrument Status Message
lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.instrument_status_message, buffer(offset, 0))
    local index = lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.fields(buffer, offset, packet, parent)
  end
end
...
lseg_tradeecho_mifid_gtp_v24_4.allowed_book_types.display = function(range, value, packet, parent)
  local flags = {}
...
lseg_tradeecho_mifid_gtp_v24_4.allowed_book_types.bits = function(range, value, packet, parent)

  -- Unused 1: 1 Bit
  parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.unused_1, range, value)

  -- Si Quote Book: 1 Bit
  parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.si_quote_book, range, value)

  -- Off Book: 1 Bit
  parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.off_book, range, value)

  -- Unused 5: 5 Bit
  parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.unused_5, range, value)
end

-- Dissect: Allowed Book Types
lseg_tradeecho_mifid_gtp_v24_4.allowed_book_types.dissect = function(buffer, offset, packet, parent)
  local size = lseg_tradeecho_mifid_gtp_v24_4.allowed_book_types.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = lseg_tradeecho_mifid_gtp_v24_4.allowed_book_types.display(range, value, packet, parent)
  local element = parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.allowed_book_types, range, display)

  if show.structs then
    lseg_tradeecho_mifid_gtp_v24_4.allowed_book_types.bits(range, value, packet, element)
  end
...
lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message = {}

-- Size: Instrument Directory Message
lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.size =
  lseg_tradeecho_mifid_gtp_v24_4.timestamp.size + 
  lseg_tradeecho_mifid_gtp_v24_4.instrument.size + 
...
lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Instrument Directory Message
lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.instrument_directory_message, buffer(offset, 0))
    local index = lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.fields(buffer, offset, packet, parent)
  end
end

-- System Event Message
lseg_tradeecho_mifid_gtp_v24_4.system_event_message = {}

-- Size: System Event Message
lseg_tradeecho_mifid_gtp_v24_4.system_event_message.size =
  lseg_tradeecho_mifid_gtp_v24_4.timestamp.size + 
  lseg_tradeecho_mifid_gtp_v24_4.event_code.size + 
  lseg_tradeecho_mifid_gtp_v24_4.source_venue.size

-- Display: System Event Message
lseg_tradeecho_mifid_gtp_v24_4.system_event_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: System Event Message
lseg_tradeecho_mifid_gtp_v24_4.system_event_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
lseg_tradeecho_mifid_gtp_v24_4.system_event_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.system_event_message, buffer(offset, 0))
    local index = lseg_tradeecho_mifid_gtp_v24_4.system_event_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_tradeecho_mifid_gtp_v24_4.system_event_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_tradeecho_mifid_gtp_v24_4.system_event_message.fields(buffer, offset, packet, parent)
  end
end
...
lseg_tradeecho_mifid_gtp_v24_4.payload.dissect = function(buffer, offset, packet, parent, message_type)
  ...
  if message_type == 0x53 then
    return lseg_tradeecho_mifid_gtp_v24_4.system_event_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Instrument Directory Message
  if message_type == 0x70 then
    return lseg_tradeecho_mifid_gtp_v24_4.instrument_directory_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Instrument Status Message
  if message_type == 0x48 then
    return lseg_tradeecho_mifid_gtp_v24_4.instrument_status_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Statistics Message
  if message_type == 0x77 then
    return lseg_tradeecho_mifid_gtp_v24_4.statistics_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Mifid Ii Trade Report Message
  if message_type == 0x54 then
    return lseg_tradeecho_mifid_gtp_v24_4.mifid_ii_trade_report_message.dissect(buffer, offset, packet, parent)
  end
...
-- Dissect: Message
lseg_tradeecho_mifid_gtp_v24_4.message.dissect = function(buffer, offset, packet, parent, message_index)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_lseg_tradeecho_mifid_gtp_v24_4.fields.message, buffer(offset, 0))
    local index = lseg_tradeecho_mifid_gtp_v24_4.message.fields(buffer, offset, packet, parent, message_index)
    local length = index - offset
    parent:set_len(length)
    local display = lseg_tradeecho_mifid_gtp_v24_4.message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return lseg_tradeecho_mifid_gtp_v24_4.message.fields(buffer, offset, packet, parent, message_index)
  end
end
...
omi_lseg_tradeecho_mifid_gtp_v24_4:register_heuristic("udp", omi_lseg_tradeecho_mifid_gtp_v24_4_udp_heuristic)

-- Register Lseg TradeEcho Mifid Gtp 24.4 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_lseg_tradeecho_mifid_gtp_v24_4)
