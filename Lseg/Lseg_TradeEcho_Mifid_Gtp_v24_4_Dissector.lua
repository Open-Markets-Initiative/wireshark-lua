...
lseg_tradeecho_mifid_gtp_v24_4_dissect.message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
lseg_tradeecho_mifid_gtp_v24_4_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    index = lseg_tradeecho_mifid_gtp_v24_4_dissect.message(buffer, index, packet, parent)
  end
