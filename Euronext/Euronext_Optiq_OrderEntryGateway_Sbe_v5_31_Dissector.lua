...
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_group = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.group_size_encoding.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.block_length_short.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.num_in_group.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups = {}

-- Calculate size of: Not Used Group 1 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.group_size_encoding.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Not Used Group 1 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for not_used_group_1_group_index = 1, num_in_group do
    index, not_used_group_1_group = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_group.dissect(buffer, index, packet, parent, not_used_group_1_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.not_used_group_1_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.not_used_group_1_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.declaration_entry_reject_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.declaration_entry_reject_message.fields = function(buffer, offset, packet, parent)
  ...
  index, not_used_group_1_groups = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_1_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.fund_price_input_ack_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.bypass_indicator.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.fund_price_input_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.declaration_cancel_and_refusal_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.action_type.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_group = {}

-- Not Used Group 2 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups = {}

-- Calculate size of: Not Used Group 2 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Not Used Group 2 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for not_used_group_2_group_index = 1, num_in_group do
    index, not_used_group_2_group = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_group.dissect(buffer, index, packet, parent, not_used_group_2_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.not_used_group_2_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.not_used_group_2_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.fields(buffer, offset, packet, parent)
end
...
-- Lrgs
euronext_optiq_orderentrygateway_sbe_v5_31.lrgs = {}

-- Rfpt
euronext_optiq_orderentrygateway_sbe_v5_31.rfpt = {}

-- Nliq
euronext_optiq_orderentrygateway_sbe_v5_31.nliq = {}

-- Oilq
euronext_optiq_orderentrygateway_sbe_v5_31.oilq = {}

-- Pric
euronext_optiq_orderentrygateway_sbe_v5_31.pric = {}

-- Size
euronext_optiq_orderentrygateway_sbe_v5_31.size = {}

-- Ilqd
euronext_optiq_orderentrygateway_sbe_v5_31.ilqd = {}

-- Omf
euronext_optiq_orderentrygateway_sbe_v5_31.omf = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.waiver_indicator.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.waiver_indicator.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.waiver_indicator.dissect = function(buffer, offset, packet, parent)
  ...
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.waiver_indicator.display(range, packet, parent)
  ...
  if show.waiver_indicator then
    euronext_optiq_orderentrygateway_sbe_v5_31.waiver_indicator.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.declaration_notice_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.declaration_notice_message.fields = function(buffer, offset, packet, parent)
  ...
  index, not_used_group_2_groups = euronext_optiq_orderentrygateway_sbe_v5_31.not_used_group_2_groups.dissect(buffer, index, packet, parent)
...
-- Dea Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.dea_indicator = {}

-- Investment Algo Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.investment_algo_indicator = {}

-- Execution Algo Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.execution_algo_indicator = {}

-- Commodity Derivative Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.commodity_derivative_indicator = {}

-- Deferral Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.deferral_indicator = {}

-- Frmaramplp
euronext_optiq_orderentrygateway_sbe_v5_31.frmaramplp = {}

-- Reserved 2
euronext_optiq_orderentrygateway_sbe_v5_31.reserved_2 = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators.display(range, packet, parent)
  ...
  if show.mifid_indicators then
    euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.technical_reject_message.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.oeg_out_to_member_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.rejected_client_message_sequence_number.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.test_request_message = {}

-- Heartbeat Message
euronext_optiq_orderentrygateway_sbe_v5_31.heartbeat_message = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.logout_message.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.log_out_reason_code.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.logon_reject_message.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.exchange_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.logon_reject_code.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.last_cl_msg_seq_num.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.last_msg_seq_num.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.logon_ack_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.logon_message.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.logical_access_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.oe_partition_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.last_msg_seq_num_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.software_provider.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.queueing_indicator.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.clear_book_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wave_for_liquidity_notification_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.exchange_ioi_id_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.ioi_type.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.original_ioiid.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.emm_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.ioi_side.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.order_quantity.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.ioi_quantity.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.ioi_quality_indication.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.error_code_optional.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.euronext_data_driven = {}

-- Interest Lists
euronext_optiq_orderentrygateway_sbe_v5_31.interest_lists = {}

-- Holdings
euronext_optiq_orderentrygateway_sbe_v5_31.holdings = {}

-- Buy Side
euronext_optiq_orderentrygateway_sbe_v5_31.buy_side = {}

-- Sell Side
euronext_optiq_orderentrygateway_sbe_v5_31.sell_side = {}

-- Quality Of Sell Side Counterparty
euronext_optiq_orderentrygateway_sbe_v5_31.quality_of_sell_side_counterparty = {}

-- Local Community Of Specialist Ams
euronext_optiq_orderentrygateway_sbe_v5_31.local_community_of_specialist_ams = {}

-- Local Community Of Specialist Par
euronext_optiq_orderentrygateway_sbe_v5_31.local_community_of_specialist_par = {}

-- Local Community Of Specialist Bru
euronext_optiq_orderentrygateway_sbe_v5_31.local_community_of_specialist_bru = {}

-- Local Community Of Specialist Lis
euronext_optiq_orderentrygateway_sbe_v5_31.local_community_of_specialist_lis = {}

-- Reserved 6
euronext_optiq_orderentrygateway_sbe_v5_31.reserved_6 = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.target_counterparties.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.target_counterparties.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.target_counterparties.dissect = function(buffer, offset, packet, parent)
  local size = 2
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.target_counterparties.display(range, packet, parent)
  ...
  if show.target_counterparties then
    euronext_optiq_orderentrygateway_sbe_v5_31.target_counterparties.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wave_for_liquidity_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.ioi_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.ioi_transaction_type.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.original_ioiid.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.target_counterparties.size
...
-- Dark Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.dark_indicator = {}

-- Deferred Trade Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.deferred_trade_indicator = {}

-- Displayed Order Interaction
euronext_optiq_orderentrygateway_sbe_v5_31.displayed_order_interaction = {}

-- Sweep Order Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.sweep_order_indicator = {}

-- Minimum Quantity Type
euronext_optiq_orderentrygateway_sbe_v5_31.minimum_quantity_type = {}

-- Reserved 3
euronext_optiq_orderentrygateway_sbe_v5_31.reserved_3 = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction_optional.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction_optional.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction_optional.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction_optional.display(range, packet, parent)
  ...
  if show.dark_execution_instruction_optional then
    euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction_optional.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.rfq_counterparts_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.order_origin.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.order_price.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.last_traded_quantity.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.minimum_order_quantity.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group = {}

-- Calculate size of: Strategy Fields Group
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_last_px.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_last_qty.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_instrument_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_side_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.execution_id_optional.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Fields Group
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.fields = function(buffer, offset, packet, parent, strategy_fields_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.dissect = function(buffer, offset, packet, parent, strategy_fields_group_index)
  if show.strategy_fields_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.fields(buffer, offset, packet, parent, strategy_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.fields(buffer, offset, packet, parent, strategy_fields_group_index)
  end
end

-- Strategy Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups = {}

-- Calculate size of: Strategy Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for strategy_fields_group_index = 1, num_in_group do
    index, strategy_fields_group = euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_group.dissect(buffer, index, packet, parent, strategy_fields_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.strategy_fields_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.strategy_fields_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.fields(buffer, offset, packet, parent)
end
...
-- Field Actively Used
euronext_optiq_orderentrygateway_sbe_v5_31.field_actively_used = {}

-- Leg 1
euronext_optiq_orderentrygateway_sbe_v5_31.leg_1 = {}

-- Leg 2
euronext_optiq_orderentrygateway_sbe_v5_31.leg_2 = {}

-- Leg 3
euronext_optiq_orderentrygateway_sbe_v5_31.leg_3 = {}

-- Leg 4
euronext_optiq_orderentrygateway_sbe_v5_31.leg_4 = {}

-- Leg 5
euronext_optiq_orderentrygateway_sbe_v5_31.leg_5 = {}

-- Leg 6
euronext_optiq_orderentrygateway_sbe_v5_31.leg_6 = {}

-- Leg 7
euronext_optiq_orderentrygateway_sbe_v5_31.leg_7 = {}

-- Leg 8
euronext_optiq_orderentrygateway_sbe_v5_31.leg_8 = {}

-- Leg 9
euronext_optiq_orderentrygateway_sbe_v5_31.leg_9 = {}
...
-- Display: Open Close
euronext_optiq_orderentrygateway_sbe_v5_31.open_close.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.open_close.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.open_close.dissect = function(buffer, offset, packet, parent)
  local size = 2
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.open_close.display(range, packet, parent)
  ...
  if show.open_close then
    euronext_optiq_orderentrygateway_sbe_v5_31.open_close.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group = {}

-- Calculate size of: Clearing Fields X Group
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.clearing_firm_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.long_client_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.account_number.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.technical_origin.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.open_close.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.clearing_instruction.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Clearing Fields X Group
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.fields = function(buffer, offset, packet, parent, clearing_fields_x_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.dissect = function(buffer, offset, packet, parent, clearing_fields_x_group_index)
  if show.clearing_fields_x_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.fields(buffer, offset, packet, parent, clearing_fields_x_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.fields(buffer, offset, packet, parent, clearing_fields_x_group_index)
  end
end

-- Clearing Fields X Groups
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups = {}

-- Calculate size of: Clearing Fields X Groups
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Clearing Fields X Groups
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for clearing_fields_x_group_index = 1, num_in_group do
    index, clearing_fields_x_group = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_group.dissect(buffer, index, packet, parent, clearing_fields_x_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.clearing_fields_x_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.clearing_fields_x_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_short_codes_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.investment_decision_w_firm_short_code.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.non_executing_broker_short_code.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group = {}

-- Calculate size of: Free Text Section Group
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Free Text Section Group
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.fields = function(buffer, offset, packet, parent, free_text_section_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.dissect = function(buffer, offset, packet, parent, free_text_section_group_index)
  if show.free_text_section_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.fields(buffer, offset, packet, parent, free_text_section_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.fields(buffer, offset, packet, parent, free_text_section_group_index)
  end
end

-- Free Text Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups = {}

-- Calculate size of: Free Text Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Free Text Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for free_text_section_group_index = 1, num_in_group do
    index, free_text_section_group = euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_group.dissect(buffer, index, packet, parent, free_text_section_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.free_text_section_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.free_text_section_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.cross_order_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.mifid_short_codes_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.cross_order_message.fields = function(buffer, offset, packet, parent)
  ...
  index, free_text_section_groups = euronext_optiq_orderentrygateway_sbe_v5_31.free_text_section_groups.dissect(buffer, index, packet, parent)
  ...
  index, clearing_fields_x_groups = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_x_groups.dissect(buffer, index, packet, parent)

  -- Strategy Fields Groups: Struct of 2 fields
  index, strategy_fields_groups = euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.request_for_implied_execution_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group = {}

-- Calculate size of: Wholesale Ack Clearing Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Clearing Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.fields = function(buffer, offset, packet, parent, wholesale_ack_clearing_rep_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.dissect = function(buffer, offset, packet, parent, wholesale_ack_clearing_rep_group_index)
  if show.wholesale_ack_clearing_rep_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.fields(buffer, offset, packet, parent, wholesale_ack_clearing_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.fields(buffer, offset, packet, parent, wholesale_ack_clearing_rep_group_index)
  end
end

-- Wholesale Ack Clearing Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups = {}

-- Calculate size of: Wholesale Ack Clearing Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Clearing Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_ack_clearing_rep_group_index = 1, num_in_group do
    index, wholesale_ack_clearing_rep_group = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_group.dissect(buffer, index, packet, parent, wholesale_ack_clearing_rep_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.wholesale_ack_clearing_rep_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.wholesale_ack_clearing_rep_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group = {}

-- Calculate size of: Wholesale Ack Legs Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_bid_order_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_offer_order_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_side_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_error_code.size

  return index
end

-- Display: Wholesale Ack Legs Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Legs Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.fields = function(buffer, offset, packet, parent, wholesale_ack_legs_rep_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.dissect = function(buffer, offset, packet, parent, wholesale_ack_legs_rep_group_index)
  if show.wholesale_ack_legs_rep_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.fields(buffer, offset, packet, parent, wholesale_ack_legs_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.fields(buffer, offset, packet, parent, wholesale_ack_legs_rep_group_index)
  end
end

-- Wholesale Ack Legs Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups = {}

-- Calculate size of: Wholesale Ack Legs Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Legs Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_ack_legs_rep_group_index = 1, num_in_group do
    index, wholesale_ack_legs_rep_group = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_group.dissect(buffer, index, packet, parent, wholesale_ack_legs_rep_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.wholesale_ack_legs_rep_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.wholesale_ack_legs_rep_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.fields(buffer, offset, packet, parent)
end

-- Queue Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.queue_indicator = {}

-- Request With Client Order Id
euronext_optiq_orderentrygateway_sbe_v5_31.request_with_client_order_id = {}

-- Use Of Cross Partition
euronext_optiq_orderentrygateway_sbe_v5_31.use_of_cross_partition = {}

-- Internal 1
euronext_optiq_orderentrygateway_sbe_v5_31.internal_1 = {}

-- Internal 2
euronext_optiq_orderentrygateway_sbe_v5_31.internal_2 = {}

-- Execution Upon Entry Flag Enabled
euronext_optiq_orderentrygateway_sbe_v5_31.execution_upon_entry_flag_enabled = {}

-- Executed Upon Entry Flag
euronext_optiq_orderentrygateway_sbe_v5_31.executed_upon_entry_flag = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers.display(range, packet, parent)
  ...
  if show.ack_qualifiers then
    euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_order_ack_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_order_ack_message.fields = function(buffer, offset, packet, parent)
  ...
  index, wholesale_ack_legs_rep_groups = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_legs_rep_groups.dissect(buffer, index, packet, parent)

  -- Wholesale Ack Clearing Rep Groups: Struct of 2 fields
  index, wholesale_ack_clearing_rep_groups = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_ack_clearing_rep_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group = {}

-- Calculate size of: Wholesale Client Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Client Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.fields = function(buffer, offset, packet, parent, wholesale_client_rep_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.dissect = function(buffer, offset, packet, parent, wholesale_client_rep_group_index)
  if show.wholesale_client_rep_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.fields(buffer, offset, packet, parent, wholesale_client_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.fields(buffer, offset, packet, parent, wholesale_client_rep_group_index)
  end
end

-- Wholesale Client Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups = {}

-- Calculate size of: Wholesale Client Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Client Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_client_rep_group_index = 1, num_in_group do
    index, wholesale_client_rep_group = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_group.dissect(buffer, index, packet, parent, wholesale_client_rep_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.wholesale_client_rep_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.wholesale_client_rep_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group = {}

-- Calculate size of: Wholesale Legs Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_price.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.bid_quantity.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.offer_quantity.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_side_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_strike_price.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_ratio_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_put_or_call.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_security_type.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_last_trading_date.size

  return index
end

-- Display: Wholesale Legs Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Legs Rep Group
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.fields = function(buffer, offset, packet, parent, wholesale_legs_rep_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.dissect = function(buffer, offset, packet, parent, wholesale_legs_rep_group_index)
  if show.wholesale_legs_rep_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.fields(buffer, offset, packet, parent, wholesale_legs_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.fields(buffer, offset, packet, parent, wholesale_legs_rep_group_index)
  end
end

-- Wholesale Legs Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups = {}

-- Calculate size of: Wholesale Legs Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Legs Rep Groups
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_legs_rep_group_index = 1, num_in_group do
    index, wholesale_legs_rep_group = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_group.dissect(buffer, index, packet, parent, wholesale_legs_rep_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.wholesale_legs_rep_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.wholesale_legs_rep_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.new_wholesale_order_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.new_wholesale_order_message.fields = function(buffer, offset, packet, parent)
  ...
  index, wholesale_legs_rep_groups = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_legs_rep_groups.dissect(buffer, index, packet, parent)

  -- Wholesale Client Rep Groups: Struct of 2 fields
  index, wholesale_client_rep_groups = euronext_optiq_orderentrygateway_sbe_v5_31.wholesale_client_rep_groups.dissect(buffer, index, packet, parent)
...
-- Mmp Section2 Group
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group = {}

-- Calculate size of: Mmp Section2 Group
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.protection_type_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.protection_threshold.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.breach_action.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.current_mmp_position.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.breach_status.size

  return index
end

-- Display: Mmp Section2 Group
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Section2 Group
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.fields = function(buffer, offset, packet, parent, mmp_section2_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.dissect = function(buffer, offset, packet, parent, mmp_section2_group_index)
  if show.mmp_section2_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.fields(buffer, offset, packet, parent, mmp_section2_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.fields(buffer, offset, packet, parent, mmp_section2_group_index)
  end
end

-- Mmp Section2 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups = {}

-- Calculate size of: Mmp Section2 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Section2 Groups
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for mmp_section2_group_index = 1, num_in_group do
    index, mmp_section2_group = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_group.dissect(buffer, index, packet, parent, mmp_section2_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.mmp_section2_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.mmp_section2_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.fields(buffer, offset, packet, parent)
end

-- Notification
euronext_optiq_orderentrygateway_sbe_v5_31.notification = {}

-- Acknowledgement
euronext_optiq_orderentrygateway_sbe_v5_31.acknowledgement = {}

-- Pull
euronext_optiq_orderentrygateway_sbe_v5_31.pull = {}

-- Reserved 5
euronext_optiq_orderentrygateway_sbe_v5_31.reserved_5 = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_execution_type.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_execution_type.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_execution_type.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_execution_type.display(range, packet, parent)
  ...
  if show.mmp_execution_type then
    euronext_optiq_orderentrygateway_sbe_v5_31.mmp_execution_type.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.mm_protection_ack_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.mm_protection_ack_message.fields = function(buffer, offset, packet, parent)
  ...
  index, mmp_section2_groups = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section2_groups.dissect(buffer, index, packet, parent)
...
-- Mmp Section Group
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group = {}

-- Calculate size of: Mmp Section Group
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.protection_type.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Section Group
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.fields = function(buffer, offset, packet, parent, mmp_section_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.dissect = function(buffer, offset, packet, parent, mmp_section_group_index)
  if show.mmp_section_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.fields(buffer, offset, packet, parent, mmp_section_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.fields(buffer, offset, packet, parent, mmp_section_group_index)
  end
end

-- Mmp Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups = {}

-- Calculate size of: Mmp Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for mmp_section_group_index = 1, num_in_group do
    index, mmp_section_group = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_group.dissect(buffer, index, packet, parent, mmp_section_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.mmp_section_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.mmp_section_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.mm_protection_request_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.mm_protection_request_message.fields = function(buffer, offset, packet, parent)
  ...
  index, mmp_section_groups = euronext_optiq_orderentrygateway_sbe_v5_31.mmp_section_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.security_definition_ack_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.strategy_legs_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_ratio.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_security_type.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_put_or_call.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_price_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_strike_price.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_last_trading_date.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.leg_side.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.synchronization_time_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.last_book_in_time.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group = {}

-- Calculate size of: Instrument Synchronization Section Group
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Instrument Synchronization Section Group
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.fields = function(buffer, offset, packet, parent, instrument_synchronization_section_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.dissect = function(buffer, offset, packet, parent, instrument_synchronization_section_group_index)
  if show.instrument_synchronization_section_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.fields(buffer, offset, packet, parent, instrument_synchronization_section_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.fields(buffer, offset, packet, parent, instrument_synchronization_section_group_index)
  end
end

-- Instrument Synchronization Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups = {}

-- Calculate size of: Instrument Synchronization Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Instrument Synchronization Section Groups
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for instrument_synchronization_section_group_index = 1, num_in_group do
    index, instrument_synchronization_section_group = euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_group.dissect(buffer, index, packet, parent, instrument_synchronization_section_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.instrument_synchronization_section_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.display(buffer, packet, parent)
  ...
  return euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_list_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_list_message.fields = function(buffer, offset, packet, parent)
  ...
  index, instrument_synchronization_section_groups = euronext_optiq_orderentrygateway_sbe_v5_31.instrument_synchronization_section_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.mm_sign_in_ack_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.mm_sign_in_message.size = function(buffer, offset)
  local index = 0
...
-- Stp Resting Order
euronext_optiq_orderentrygateway_sbe_v5_31.stp_resting_order = {}

-- Stp Incoming Order
euronext_optiq_orderentrygateway_sbe_v5_31.stp_incoming_order = {}

-- Disclosed Quantity Randomization
euronext_optiq_orderentrygateway_sbe_v5_31.disclosed_quantity_randomization = {}

-- Disabled Cancel On Disconnect Indicator
euronext_optiq_orderentrygateway_sbe_v5_31.disabled_cancel_on_disconnect_indicator = {}

-- Rfq Answer
euronext_optiq_orderentrygateway_sbe_v5_31.rfq_answer = {}

-- Rfq Confirmation
euronext_optiq_orderentrygateway_sbe_v5_31.rfq_confirmation = {}

-- Conditional Order
euronext_optiq_orderentrygateway_sbe_v5_31.conditional_order = {}

-- Stp Both Orders
euronext_optiq_orderentrygateway_sbe_v5_31.stp_both_orders = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction_optional.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction_optional.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction_optional.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction_optional.display(range, packet, parent)
  ...
  if show.execution_instruction_optional then
    euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction_optional.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.rfqlp_matching_status_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.potential_matching_qty.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.rfq_matching_status_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.potential_matching_px.size
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.number_of_lps.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.recipient_type.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction.display(range, packet, parent)
  ...
  if show.dark_execution_instruction then
    euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.rfq_notification_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.counterpart_firm_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.emm.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.rfq_update_type.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.side_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.end_client.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.dark_execution_instruction.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.min_order_qty.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.request_for_execution_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.ask_for_quote_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.afq_reason.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.liquidity_provider_command_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.lp_action_code.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.price_input_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.input_price_type.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.collar_breach_confirmation_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.trade_bust_notification_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.parent_exec_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.parent_symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.trade_unique_identifier.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.parent_trade_unique_identifier.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.ownership_request_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.ownership_request_ack_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.open_order_request_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators_optional.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators_optional.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators_optional.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators_optional.display(range, packet, parent)
  ...
  if show.mifid_indicators_optional then
    euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators_optional.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.mifid_fields_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.mifid_indicators_optional.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers_optional.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers_optional.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers_optional.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers_optional.display(range, packet, parent)
  ...
  if show.ack_qualifiers_optional then
    euronext_optiq_orderentrygateway_sbe_v5_31.ack_qualifiers_optional.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.quote_request_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.firm_id_publication.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.quote_acks_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.bid_order_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.offer_order_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.emm.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.buy_revision_flag.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.sell_revision_flag.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.bid_error_code.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.offer_error_code.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.quotes_rep_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.bid_size.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.bid_px.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.offer_size.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.offer_px.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_dataset_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.clearing_firm_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.client_id.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.collar_fields_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.collar_rej_type.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.breached_collar_price.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.additional_infos_group.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group = {}

-- Calculate size of: Clearing Fields Group
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Clearing Fields Group
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.fields = function(buffer, offset, packet, parent, clearing_fields_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.dissect = function(buffer, offset, packet, parent, clearing_fields_group_index)
  if show.clearing_fields_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.fields(buffer, offset, packet, parent, clearing_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.fields(buffer, offset, packet, parent, clearing_fields_group_index)
  end
end

-- Clearing Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups = {}

-- Calculate size of: Clearing Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Clearing Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for clearing_fields_group_index = 1, num_in_group do
    index, clearing_fields_group = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_group.dissect(buffer, index, packet, parent, clearing_fields_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.clearing_fields_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.clearing_fields_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.fields(buffer, offset, packet, parent)
end
...
-- Reserved 1
euronext_optiq_orderentrygateway_sbe_v5_31.reserved_1 = {}

-- Session 1
euronext_optiq_orderentrygateway_sbe_v5_31.session_1 = {}

-- Session 2
euronext_optiq_orderentrygateway_sbe_v5_31.session_2 = {}

-- Session 3
euronext_optiq_orderentrygateway_sbe_v5_31.session_3 = {}

-- Session 4
euronext_optiq_orderentrygateway_sbe_v5_31.session_4 = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.trading_session.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.trading_session.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.trading_session.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.trading_session.display(range, packet, parent)
  ...
  if show.trading_session then
    euronext_optiq_orderentrygateway_sbe_v5_31.trading_session.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group = {}

-- Calculate size of: Optional Fields Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.stop_px.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.undisclosed_price.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.disclosed_qty.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.min_order_qty.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.quote_req_id_optional.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.order_expiration_time.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.order_expiration_date.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.peg_offset.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.trading_session.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.undisclosed_iceberg_type.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.stop_triggered_time_in_force.size

  return index
end

-- Display: Optional Fields Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Optional Fields Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.fields = function(buffer, offset, packet, parent, optional_fields_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.dissect = function(buffer, offset, packet, parent, optional_fields_group_index)
  if show.optional_fields_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.fields(buffer, offset, packet, parent, optional_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.fields(buffer, offset, packet, parent, optional_fields_group_index)
  end
end

-- Optional Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups = {}

-- Calculate size of: Optional Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Optional Fields Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for optional_fields_group_index = 1, num_in_group do
    index, optional_fields_group = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_group.dissect(buffer, index, packet, parent, optional_fields_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.optional_fields_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.optional_fields_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction.display(range, packet, parent)
  ...
  if show.execution_instruction then
    euronext_optiq_orderentrygateway_sbe_v5_31.execution_instruction.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.cancel_replace_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.cancel_replace_message.fields = function(buffer, offset, packet, parent)
  ...
  index, optional_fields_groups = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_groups.dissect(buffer, index, packet, parent)

  -- Clearing Fields Groups: Struct of 2 fields
  index, clearing_fields_groups = euronext_optiq_orderentrygateway_sbe_v5_31.clearing_fields_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group = {}

-- Calculate size of: Optional Fields Derivatives Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.evaluated_price.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.message_price_notation.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.final_symbol_index.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.final_execution_id.size

  return index
end

-- Display: Optional Fields Derivatives Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Optional Fields Derivatives Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.fields = function(buffer, offset, packet, parent, optional_fields_derivatives_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.dissect = function(buffer, offset, packet, parent, optional_fields_derivatives_group_index)
  if show.optional_fields_derivatives_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.fields(buffer, offset, packet, parent, optional_fields_derivatives_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.fields(buffer, offset, packet, parent, optional_fields_derivatives_group_index)
  end
end

-- Optional Fields Derivatives Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups = {}

-- Calculate size of: Optional Fields Derivatives Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Optional Fields Derivatives Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for optional_fields_derivatives_group_index = 1, num_in_group do
    index, optional_fields_derivatives_group = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_group.dissect(buffer, index, packet, parent, optional_fields_derivatives_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.optional_fields_derivatives_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.optional_fields_derivatives_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group = {}

-- Calculate size of: Optional Fields Fill Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.counterpart_firm_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.other_leg_last_px.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.package_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.underlying_instrument_id.size

  return index
end

-- Display: Optional Fields Fill Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Optional Fields Fill Group
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.fields = function(buffer, offset, packet, parent, optional_fields_fill_group_index)
  local index = offset
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.dissect = function(buffer, offset, packet, parent, optional_fields_fill_group_index)
  if show.optional_fields_fill_group then
    ...
    local index = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.fields(buffer, offset, packet, parent, optional_fields_fill_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.fields(buffer, offset, packet, parent, optional_fields_fill_group_index)
  end
end

-- Optional Fields Fill Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups = {}

-- Calculate size of: Optional Fields Fill Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Optional Fields Fill Groups
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for optional_fields_fill_group_index = 1, num_in_group do
    index, optional_fields_fill_group = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_group.dissect(buffer, index, packet, parent, optional_fields_fill_group_index)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.optional_fields_fill_groups then
    local length = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_orderentrygateway_sbe_v5_31.fields.optional_fields_fill_groups, range, display)
  end

  return euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.fields(buffer, offset, packet, parent)
end
...
-- Uncrossing Trade
euronext_optiq_orderentrygateway_sbe_v5_31.uncrossing_trade = {}

-- First Trade Price
euronext_optiq_orderentrygateway_sbe_v5_31.first_trade_price = {}

-- Passive Order
euronext_optiq_orderentrygateway_sbe_v5_31.passive_order = {}

-- Aggressive Order
euronext_optiq_orderentrygateway_sbe_v5_31.aggressive_order = {}

-- Trade Creation By Market Operations
euronext_optiq_orderentrygateway_sbe_v5_31.trade_creation_by_market_operations = {}

-- Nav Trade Expressed In Bps
euronext_optiq_orderentrygateway_sbe_v5_31.nav_trade_expressed_in_bps = {}

-- Nav Trade Expressed In Price Currency
euronext_optiq_orderentrygateway_sbe_v5_31.nav_trade_expressed_in_price_currency = {}

-- Deferred Publication
euronext_optiq_orderentrygateway_sbe_v5_31.deferred_publication = {}
...
euronext_optiq_orderentrygateway_sbe_v5_31.trade_qualifier.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_orderentrygateway_sbe_v5_31.trade_qualifier.bits = function(buffer, offset, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.trade_qualifier.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.trade_qualifier.display(range, packet, parent)
  ...
  if show.trade_qualifier then
    euronext_optiq_orderentrygateway_sbe_v5_31.trade_qualifier.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.fill_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.strategy_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.mifid_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.size(buffer, offset + index)
...
euronext_optiq_orderentrygateway_sbe_v5_31.fill_message.fields = function(buffer, offset, packet, parent)
  ...
  index, optional_fields_fill_groups = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_fill_groups.dissect(buffer, index, packet, parent)
  ...
  index, optional_fields_derivatives_groups = euronext_optiq_orderentrygateway_sbe_v5_31.optional_fields_derivatives_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_orderentrygateway_sbe_v5_31.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 10 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.quote_request_message.size(buffer, offset)
  end
  ...
  if template_id == 15 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.open_order_request_message.size(buffer, offset)
  end
  -- Size of Ownership Request Ack Message
  if template_id == 17 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.ownership_request_ack_message.size(buffer, offset)
  end
  -- Size of Ownership Request Message
  if template_id == 18 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.ownership_request_message.size(buffer, offset)
  end
  -- Size of Trade Bust Notification Message
  if template_id == 19 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.trade_bust_notification_message.size(buffer, offset)
  end
  -- Size of Collar Breach Confirmation Message
  if template_id == 20 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.collar_breach_confirmation_message.size(buffer, offset)
  end
  -- Size of Price Input Message
  if template_id == 28 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.price_input_message.size(buffer, offset)
  end
  -- Size of Liquidity Provider Command Message
  if template_id == 32 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.liquidity_provider_command_message.size(buffer, offset)
  end
  -- Size of Ask For Quote Message
  if template_id == 33 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.ask_for_quote_message.size(buffer, offset)
  end
  -- Size of Request For Execution Message
  if template_id == 34 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.request_for_execution_message.size(buffer, offset)
  end
  -- Size of Rfq Notification Message
  if template_id == 35 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.rfq_notification_message.size(buffer, offset)
  end
  -- Size of Rfq Matching Status Message
  if template_id == 36 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.rfq_matching_status_message.size(buffer, offset)
  end
  -- Size of Rfqlp Matching Status Message
  if template_id == 37 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.rfqlp_matching_status_message.size(buffer, offset)
  end
  ...
  if template_id == 47 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.mm_sign_in_message.size(buffer, offset)
  end
  -- Size of Mm Sign In Ack Message
  if template_id == 48 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.mm_sign_in_ack_message.size(buffer, offset)
  end
  ...
  if template_id == 51 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.synchronization_time_message.size(buffer, offset)
  end
  ...
  if template_id == 61 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.security_definition_ack_message.size(buffer, offset)
  end
  ...
  if template_id == 66 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.request_for_implied_execution_message.size(buffer, offset)
  end
  ...
  if template_id == 73 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.wave_for_liquidity_message.size(buffer, offset)
  end
  -- Size of Wave For Liquidity Notification Message
  if template_id == 74 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.wave_for_liquidity_notification_message.size(buffer, offset)
  end
  -- Size of Clear Book Message
  if template_id == 75 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.clear_book_message.size(buffer, offset)
  end
  -- Size of Logon Message
  if template_id == 100 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.logon_message.size(buffer, offset)
  end
  -- Size of Logon Ack Message
  if template_id == 101 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.logon_ack_message.size(buffer, offset)
  end
  -- Size of Logon Reject Message
  if template_id == 102 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.logon_reject_message.size(buffer, offset)
  end
  -- Size of Logout Message
  if template_id == 103 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.logout_message.size(buffer, offset)
  end
  ...
  if template_id == 108 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.technical_reject_message.size(buffer, offset)
  end
  ...
  if template_id == 43 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.declaration_cancel_and_refusal_message.size(buffer, offset)
  end
  -- Size of Fund Price Input Message
  if template_id == 44 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.fund_price_input_message.size(buffer, offset)
  end
  -- Size of Fund Price Input Ack Message
  if template_id == 45 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.fund_price_input_ack_message.size(buffer, offset)
  end
...
euronext_optiq_orderentrygateway_sbe_v5_31.message_header.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.block_length.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.template_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.schema_id.size

  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.version.size
...
euronext_optiq_orderentrygateway_sbe_v5_31.message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_orderentrygateway_sbe_v5_31.message_header.size(buffer, offset + index)
