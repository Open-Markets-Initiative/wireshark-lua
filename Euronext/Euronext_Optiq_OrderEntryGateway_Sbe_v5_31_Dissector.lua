...
-- Euronext Optiq OrderEntryGateway Sbe 5.31 Headers
...
omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs_changed()
  ...
  if show.headers ~= omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_headers then
    show.headers = omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_headers
  end
  if show.repeating_groups ~= omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_repeating_groups then
    show.repeating_groups = omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_repeating_groups
  end
  if show.structs ~= omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_structs then
    show.structs = omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_structs
  end
  if show.indexes ~= omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_indexes then
    show.indexes = omi_euronext_optiq_orderentrygateway_sbe_v5_31.prefs.show_indexes
  end
end
...
euronext_optiq_orderentrygateway_sbe_v5_31.test_request_message.display = function(packet, parent, length)
  return "Test Request Message"
end


-- Dissect: Test Request Message
euronext_optiq_orderentrygateway_sbe_v5_31.test_request_message.dissect = function(buffer, offset, packet, parent)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.test_request_message.display(packet, parent, 0)
...
euronext_optiq_orderentrygateway_sbe_v5_31.heartbeat_message.display = function(packet, parent, length)
  return "Heartbeat Message"
end


-- Dissect: Heartbeat Message
euronext_optiq_orderentrygateway_sbe_v5_31.heartbeat_message.dissect = function(buffer, offset, packet, parent)
  local display = euronext_optiq_orderentrygateway_sbe_v5_31.heartbeat_message.display(packet, parent, 0)
  packet.cols.info = display
...
euronext_optiq_orderentrygateway_sbe_v5_31.payload.dissect = function(buffer, offset, packet, parent, template_id)
  ...
  if template_id == 106 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.heartbeat_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Test Request Message
  if template_id == 107 then
    return euronext_optiq_orderentrygateway_sbe_v5_31.test_request_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Technical Reject Message
