...
euronext_optiq_marketdatagateway_sbe_v4_5.message.fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
euronext_optiq_marketdatagateway_sbe_v4_5.message.dissect = function(buffer, offset, packet, parent, size_of_message)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.message, buffer(offset, 0))
    local current = euronext_optiq_marketdatagateway_sbe_v4_5.message.fields(buffer, offset, packet, parent, size_of_message)
    ...
    -- Skip element, add fields directly
    euronext_optiq_marketdatagateway_sbe_v4_5.message.fields(buffer, offset, packet, parent, size_of_message)
...
euronext_optiq_marketdatagateway_sbe_v4_5.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = euronext_optiq_marketdatagateway_sbe_v4_5.message.dissect(buffer, index, packet, parent, frame)
  end
