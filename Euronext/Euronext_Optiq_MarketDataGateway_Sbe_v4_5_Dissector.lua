...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.buy_write = ProtoField.new("Buy Write", "euronext.optiq.marketdatagateway.sbe.v4.5.buywrite", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000040000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_spread_versus_sell_a_put = ProtoField.new("Call Spread Versus Sell A Put", "euronext.optiq.marketdatagateway.sbe.v4.5.callspreadversussellaput", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000200000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.combo_versus_underlying = ProtoField.new("Combo Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.comboversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000000200000000)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.compression = ProtoField.new("Compression", "euronext.optiq.marketdatagateway.sbe.v4.5.compression", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0001)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.condor_versus_underlying = ProtoField.new("Condor Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.condorversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000020000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.em_m_pattern_rep_group = ProtoField.new("Em M Pattern Rep Group", "euronext.optiq.marketdatagateway.sbe.v4.5.emmpatternrepgroup", ftypes.STRING)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.em_m_pattern_rep_groups = ProtoField.new("Em M Pattern Rep Groups", "euronext.optiq.marketdatagateway.sbe.v4.5.emmpatternrepgroups", ftypes.STRING)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.exchange_for_physical = ProtoField.new("Exchange For Physical", "euronext.optiq.marketdatagateway.sbe.v4.5.exchangeforphysical", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000000800000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.has_end_of_day_snapshot = ProtoField.new("Has End Of Day Snapshot", "euronext.optiq.marketdatagateway.sbe.v4.5.hasendofdaysnapshot", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0100)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.has_start_of_day_snapshot = ProtoField.new("Has Start Of Day Snapshot", "euronext.optiq.marketdatagateway.sbe.v4.5.hasstartofdaysnapshot", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0080)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.has_status_message = ProtoField.new("Has Status Message", "euronext.optiq.marketdatagateway.sbe.v4.5.hasstatusmessage", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0200)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.iron_butterfly_versus_underlying = ProtoField.new("Iron Butterfly Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.ironbutterflyversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000000100000000)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.iron_condor = ProtoField.new("Iron Condor", "euronext.optiq.marketdatagateway.sbe.v4.5.ironcondor", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000100000000000)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.iron_condor_versus_underlying = ProtoField.new("Iron Condor Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.ironcondorversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000080000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.not_used_group_1_groups = ProtoField.new("Not Used Group 1 Groups", "euronext.optiq.marketdatagateway.sbe.v4.5.notusedgroup1groups", ftypes.STRING)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.orders_group = ProtoField.new("Orders Group", "euronext.optiq.marketdatagateway.sbe.v4.5.ordersgroup", ftypes.STRING)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.orders_groups = ProtoField.new("Orders Groups", "euronext.optiq.marketdatagateway.sbe.v4.5.ordersgroups", ftypes.STRING)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.prices_group = ProtoField.new("Prices Group", "euronext.optiq.marketdatagateway.sbe.v4.5.pricesgroup", ftypes.STRING)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.prices_groups = ProtoField.new("Prices Groups", "euronext.optiq.marketdatagateway.sbe.v4.5.pricesgroups", ftypes.STRING)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.put_spread_versus_call_versus_underlying = ProtoField.new("Put Spread Versus Call Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.putspreadversuscallversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000002000000000)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.put_spread_versus_sell_a_call = ProtoField.new("Put Spread Versus Sell A Call", "euronext.optiq.marketdatagateway.sbe.v4.5.putspreadversussellacall", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000400000000000)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.put_straddle_versus_sell_a_call_or_a_put = ProtoField.new("Put Straddle Versus Sell A Call Or A Put", "euronext.optiq.marketdatagateway.sbe.v4.5.putstraddleversussellacalloraput", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000800000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.reserved_16 = ProtoField.new("Reserved 16", "euronext.optiq.marketdatagateway.sbe.v4.5.reserved16", ftypes.UINT64, nil, base.DEC, 0xFFFF000000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.straddle_calendar_spread_versus_underlying = ProtoField.new("Straddle Calendar Spread Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.straddlecalendarspreadversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000001000000000)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.straddle_versus_underlying = ProtoField.new("Straddle Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.straddleversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000010000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strangle_versus_underlying = ProtoField.new("Strangle Versus Underlying", "euronext.optiq.marketdatagateway.sbe.v4.5.strangleversusunderlying", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000000400000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strategy_standing_datarep_1_group = ProtoField.new("Strategy Standing Datarep 1 Group", "euronext.optiq.marketdatagateway.sbe.v4.5.strategystandingdatarep1group", ftypes.STRING)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strategy_standing_datarep_1_groups = ProtoField.new("Strategy Standing Datarep 1 Groups", "euronext.optiq.marketdatagateway.sbe.v4.5.strategystandingdatarep1groups", ftypes.STRING)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.synthetic = ProtoField.new("Synthetic", "euronext.optiq.marketdatagateway.sbe.v4.5.synthetic", ftypes.UINT64, {[1]="Yes",[0]="No"}, base.DEC, 0x0000008000000000)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.updates_group = ProtoField.new("Updates Group", "euronext.optiq.marketdatagateway.sbe.v4.5.updatesgroup", ftypes.STRING)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.updates_groups = ProtoField.new("Updates Groups", "euronext.optiq.marketdatagateway.sbe.v4.5.updatesgroups", ftypes.STRING)
...
-- Euronext Optiq MarketDataGateway Sbe 4.5 messages
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.em_m_pattern_rep_group_index = ProtoField.new("Em M Pattern Rep Group Index", "euronext.optiq.marketdatagateway.sbe.v4.5.emmpatternrepgroupindex", ftypes.UINT16)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.not_used_group_1_group_index = ProtoField.new("Not Used Group 1 Group Index", "euronext.optiq.marketdatagateway.sbe.v4.5.notusedgroup1groupindex", ftypes.UINT16)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.orders_group_index = ProtoField.new("Orders Group Index", "euronext.optiq.marketdatagateway.sbe.v4.5.ordersgroupindex", ftypes.UINT16)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.prices_group_index = ProtoField.new("Prices Group Index", "euronext.optiq.marketdatagateway.sbe.v4.5.pricesgroupindex", ftypes.UINT16)
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strategy_standing_datarep_1_group_index = ProtoField.new("Strategy Standing Datarep 1 Group Index", "euronext.optiq.marketdatagateway.sbe.v4.5.strategystandingdatarep1groupindex", ftypes.UINT16)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.updates_group_index = ProtoField.new("Updates Group Index", "euronext.optiq.marketdatagateway.sbe.v4.5.updatesgroupindex", ftypes.UINT16)
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_em_m_pattern_rep_group = Pref.bool("Show Em M Pattern Rep Group", show.em_m_pattern_rep_group, "Parse and add Em M Pattern Rep Group to protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_em_m_pattern_rep_groups = Pref.bool("Show Em M Pattern Rep Groups", show.em_m_pattern_rep_groups, "Parse and add Em M Pattern Rep Groups to protocol tree")
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_not_used_group_1_groups = Pref.bool("Show Not Used Group 1 Groups", show.not_used_group_1_groups, "Parse and add Not Used Group 1 Groups to protocol tree")
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_orders_group = Pref.bool("Show Orders Group", show.orders_group, "Parse and add Orders Group to protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_orders_groups = Pref.bool("Show Orders Groups", show.orders_groups, "Parse and add Orders Groups to protocol tree")
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_prices_group = Pref.bool("Show Prices Group", show.prices_group, "Parse and add Prices Group to protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_prices_groups = Pref.bool("Show Prices Groups", show.prices_groups, "Parse and add Prices Groups to protocol tree")
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_strategy_standing_datarep_1_group = Pref.bool("Show Strategy Standing Datarep 1 Group", show.strategy_standing_datarep_1_group, "Parse and add Strategy Standing Datarep 1 Group to protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_strategy_standing_datarep_1_groups = Pref.bool("Show Strategy Standing Datarep 1 Groups", show.strategy_standing_datarep_1_groups, "Parse and add Strategy Standing Datarep 1 Groups to protocol tree")
...
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_updates_group = Pref.bool("Show Updates Group", show.updates_group, "Parse and add Updates Group to protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_updates_groups = Pref.bool("Show Updates Groups", show.updates_groups, "Parse and add Updates Groups to protocol tree")
...
function omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs_changed()
  ...
  if show.em_m_pattern_rep_group ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_em_m_pattern_rep_group then
    show.em_m_pattern_rep_group = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_em_m_pattern_rep_group
    changed = true
  end
  if show.em_m_pattern_rep_groups ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_em_m_pattern_rep_groups then
    show.em_m_pattern_rep_groups = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_em_m_pattern_rep_groups
    changed = true
  end
  ...
  if show.not_used_group_1_groups ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_not_used_group_1_groups then
    show.not_used_group_1_groups = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_not_used_group_1_groups
    changed = true
  end
  ...
  if show.orders_group ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_orders_group then
    show.orders_group = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_orders_group
    changed = true
  end
  if show.orders_groups ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_orders_groups then
    show.orders_groups = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_orders_groups
    changed = true
  end
  ...
  if show.prices_group ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_prices_group then
    show.prices_group = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_prices_group
    changed = true
  end
  if show.prices_groups ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_prices_groups then
    show.prices_groups = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_prices_groups
    changed = true
  end
  ...
  if show.strategy_standing_datarep_1_group ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_strategy_standing_datarep_1_group then
    show.strategy_standing_datarep_1_group = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_strategy_standing_datarep_1_group
    changed = true
  end
  if show.strategy_standing_datarep_1_groups ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_strategy_standing_datarep_1_groups then
    show.strategy_standing_datarep_1_groups = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_strategy_standing_datarep_1_groups
    changed = true
  end
  ...
  if show.updates_group ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_updates_group then
    show.updates_group = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_updates_group
    changed = true
  end
  if show.updates_groups ~= omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_updates_groups then
    show.updates_groups = omi_euronext_optiq_marketdatagateway_sbe_v4_5.prefs.show_updates_groups
    changed = true
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.end_of_snapshot_message.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.last_md_seq_num.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.snapshot_time.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.start_of_snapshot_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.bf_instrument_suspension_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.bfnav_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.bid_offer_date_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.mifid_transaction_id.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.mmt_modification_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.nav_price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.event_time_optional.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.nav_bid_price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.nav_offer_price.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.bf_trade_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.bid_price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.offer_price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.quantity.size
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.notional_amount_traded.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.interest_payment_date_rep_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.interest_payment_date.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.group_size_encoding.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.block_length_short.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.num_in_group.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.interest_payment_date_rep_groups.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.group_size_encoding.size(buffer, offset + index)
...
euronext_optiq_marketdatagateway_sbe_v4_5.apa_full_trade_information_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_market_mechanism.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_trading_mode.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_transaction_category.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_negotiation_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_agency_cross_trade_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_modification_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_benchmark_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_special_dividend_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_off_book_automated_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_contributionto_price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_algorithmic_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_publication_mode.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_post_trade_deferral.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.efficient_mmt_duplicative_indicator.size
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.long_trade_reference.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.apa_standing_data_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.mifid_instrument_id_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.mifid_instrument_id.size
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.second_notional_currency.size
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.underlying_index_name.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.underlying_index_term.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.option_type.size
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.expiry_date.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.apa_quotes_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.currency.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.lei_code.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.event_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.quote_update_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.mifid_price.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.package_components_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_symbol_index.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_ratio.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_last_px.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_last_qty.size
...
-- Orders Group
euronext_optiq_marketdatagateway_sbe_v4_5.orders_group = {}

-- Calculate size of: Orders Group
euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.symbol_index.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.action_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.order_priority.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.previous_priority.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.order_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.order_px.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.order_side.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.order_quantity.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.peg_offset.size

  return index
end

-- Display: Orders Group
euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Orders Group
euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.fields = function(buffer, offset, packet, parent, orders_group_index)
  local index = offset

  -- Implicit Orders Group Index
  if orders_group_index ~= nil then
    local iteration = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.orders_group_index, orders_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.dissect = function(buffer, offset, packet, parent, orders_group_index)
  if show.orders_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.orders_group, buffer(offset, 0))
    local index = euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.fields(buffer, offset, packet, parent, orders_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.fields(buffer, offset, packet, parent, orders_group_index)
  end
end

-- Orders Groups
euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups = {}

-- Calculate size of: Orders Groups
euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Orders Groups
euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for orders_group_index = 1, num_in_group do
    index, orders_group = euronext_optiq_marketdatagateway_sbe_v4_5.orders_group.dissect(buffer, index, packet, parent, orders_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.orders_groups then
    local length = euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.orders_groups, range, display)
  end

  return euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.long_order_update_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.size(buffer, offset + index)
...
euronext_optiq_marketdatagateway_sbe_v4_5.long_order_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, orders_groups = euronext_optiq_marketdatagateway_sbe_v4_5.orders_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_marketdatagateway_sbe_v4_5.outright_rep_group.size = function(buffer, offset)
  local index = 0
...
-- Jelly Roll
euronext_optiq_marketdatagateway_sbe_v4_5.jelly_roll = {}

-- Butterfly
euronext_optiq_marketdatagateway_sbe_v4_5.butterfly = {}

-- Call Or Put Cabinet
euronext_optiq_marketdatagateway_sbe_v4_5.call_or_put_cabinet = {}

-- Spread
euronext_optiq_marketdatagateway_sbe_v4_5.spread = {}

-- Calendar Spread
euronext_optiq_marketdatagateway_sbe_v4_5.calendar_spread = {}

-- Diagonal Calendar Spread
euronext_optiq_marketdatagateway_sbe_v4_5.diagonal_calendar_spread = {}

-- Guts
euronext_optiq_marketdatagateway_sbe_v4_5.guts = {}

-- Two By One Ratio Spread
euronext_optiq_marketdatagateway_sbe_v4_5.two_by_one_ratio_spread = {}

-- Iron Butterfly
euronext_optiq_marketdatagateway_sbe_v4_5.iron_butterfly = {}

-- Combo
euronext_optiq_marketdatagateway_sbe_v4_5.combo = {}

-- Strangle
euronext_optiq_marketdatagateway_sbe_v4_5.strangle = {}

-- Ladder
euronext_optiq_marketdatagateway_sbe_v4_5.ladder = {}

-- Strip
euronext_optiq_marketdatagateway_sbe_v4_5.strip = {}

-- Straddle Calendar Spread
euronext_optiq_marketdatagateway_sbe_v4_5.straddle_calendar_spread = {}

-- Pack
euronext_optiq_marketdatagateway_sbe_v4_5.pack = {}

-- Diagonal Straddle Calendar Spread
euronext_optiq_marketdatagateway_sbe_v4_5.diagonal_straddle_calendar_spread = {}

-- Simple Inter Commodity Spread
euronext_optiq_marketdatagateway_sbe_v4_5.simple_inter_commodity_spread = {}

-- Conversion Reversal
euronext_optiq_marketdatagateway_sbe_v4_5.conversion_reversal = {}

-- Straddle
euronext_optiq_marketdatagateway_sbe_v4_5.straddle = {}

-- Volatility Trade
euronext_optiq_marketdatagateway_sbe_v4_5.volatility_trade = {}

-- Condor
euronext_optiq_marketdatagateway_sbe_v4_5.condor = {}

-- Box
euronext_optiq_marketdatagateway_sbe_v4_5.box = {}

-- Bundle
euronext_optiq_marketdatagateway_sbe_v4_5.bundle = {}

-- Reduced Tick Spread
euronext_optiq_marketdatagateway_sbe_v4_5.reduced_tick_spread = {}

-- Ladder Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.ladder_versus_underlying = {}

-- Butterfly Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.butterfly_versus_underlying = {}

-- Call Spread Versus Put Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.call_spread_versus_put_versus_underlying = {}

-- Call Or Put Spread Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.call_or_put_spread_versus_underlying = {}

-- Call Or Put Calendar Spread Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.call_or_put_calendar_spread_versus_underlying = {}

-- Call Put Diagonal Calendar Spread Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.call_put_diagonal_calendar_spread_versus_underlying = {}

-- Guts Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.guts_versus_underlying = {}

-- Two By One Call Or Put Ratio Spread Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.two_by_one_call_or_put_ratio_spread_versus_underlying = {}

-- Iron Butterfly Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.iron_butterfly_versus_underlying = {}

-- Combo Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.combo_versus_underlying = {}

-- Strangle Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.strangle_versus_underlying = {}

-- Exchange For Physical
euronext_optiq_marketdatagateway_sbe_v4_5.exchange_for_physical = {}

-- Straddle Calendar Spread Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.straddle_calendar_spread_versus_underlying = {}

-- Put Spread Versus Call Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.put_spread_versus_call_versus_underlying = {}

-- Diagonal Straddle Calendar Spread Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.diagonal_straddle_calendar_spread_versus_underlying = {}

-- Synthetic
euronext_optiq_marketdatagateway_sbe_v4_5.synthetic = {}

-- Straddle Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.straddle_versus_underlying = {}

-- Condor Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.condor_versus_underlying = {}

-- Buy Write
euronext_optiq_marketdatagateway_sbe_v4_5.buy_write = {}

-- Iron Condor Versus Underlying
euronext_optiq_marketdatagateway_sbe_v4_5.iron_condor_versus_underlying = {}

-- Iron Condor
euronext_optiq_marketdatagateway_sbe_v4_5.iron_condor = {}

-- Call Spread Versus Sell A Put
euronext_optiq_marketdatagateway_sbe_v4_5.call_spread_versus_sell_a_put = {}

-- Put Spread Versus Sell A Call
euronext_optiq_marketdatagateway_sbe_v4_5.put_spread_versus_sell_a_call = {}

-- Put Straddle Versus Sell A Call Or A Put
euronext_optiq_marketdatagateway_sbe_v4_5.put_straddle_versus_sell_a_call_or_a_put = {}

-- Reserved 16
euronext_optiq_marketdatagateway_sbe_v4_5.reserved_16 = {}
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_authorized.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_authorized.bits = function(buffer, offset, packet, parent)

  -- Reserved 16: 16 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.reserved_16, buffer(offset, 8))

  -- Put Straddle Versus Sell A Call Or A Put: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.put_straddle_versus_sell_a_call_or_a_put, buffer(offset, 8))

  -- Put Spread Versus Sell A Call: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.put_spread_versus_sell_a_call, buffer(offset, 8))

  -- Call Spread Versus Sell A Put: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_spread_versus_sell_a_put, buffer(offset, 8))

  -- Iron Condor: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.iron_condor, buffer(offset, 8))

  -- Iron Condor Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.iron_condor_versus_underlying, buffer(offset, 8))

  -- Buy Write: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.buy_write, buffer(offset, 8))

  -- Condor Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.condor_versus_underlying, buffer(offset, 8))

  -- Straddle Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.straddle_versus_underlying, buffer(offset, 8))

  -- Synthetic: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.synthetic, buffer(offset, 8))

  -- Diagonal Straddle Calendar Spread Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.diagonal_straddle_calendar_spread_versus_underlying, buffer(offset, 8))

  -- Put Spread Versus Call Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.put_spread_versus_call_versus_underlying, buffer(offset, 8))

  -- Straddle Calendar Spread Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.straddle_calendar_spread_versus_underlying, buffer(offset, 8))

  -- Exchange For Physical: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.exchange_for_physical, buffer(offset, 8))

  -- Strangle Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strangle_versus_underlying, buffer(offset, 8))

  -- Combo Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.combo_versus_underlying, buffer(offset, 8))

  -- Iron Butterfly Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.iron_butterfly_versus_underlying, buffer(offset, 8))

  -- Two By One Call Or Put Ratio Spread Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.two_by_one_call_or_put_ratio_spread_versus_underlying, buffer(offset, 8))

  -- Guts Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.guts_versus_underlying, buffer(offset, 8))

  -- Call Put Diagonal Calendar Spread Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_put_diagonal_calendar_spread_versus_underlying, buffer(offset, 8))

  -- Call Or Put Calendar Spread Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_or_put_calendar_spread_versus_underlying, buffer(offset, 8))

  -- Call Or Put Spread Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_or_put_spread_versus_underlying, buffer(offset, 8))

  -- Call Spread Versus Put Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_spread_versus_put_versus_underlying, buffer(offset, 8))

  -- Butterfly Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.butterfly_versus_underlying, buffer(offset, 8))

  -- Ladder Versus Underlying: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.ladder_versus_underlying, buffer(offset, 8))

  -- Reduced Tick Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.reduced_tick_spread, buffer(offset, 8))

  -- Bundle: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.bundle, buffer(offset, 8))

  -- Box: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.box, buffer(offset, 8))

  -- Condor: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.condor, buffer(offset, 8))

  -- Volatility Trade: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.volatility_trade, buffer(offset, 8))

  -- Straddle: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.straddle, buffer(offset, 8))

  -- Conversion Reversal: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.conversion_reversal, buffer(offset, 8))

  -- Simple Inter Commodity Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.simple_inter_commodity_spread, buffer(offset, 8))

  -- Diagonal Straddle Calendar Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.diagonal_straddle_calendar_spread, buffer(offset, 8))

  -- Pack: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.pack, buffer(offset, 8))

  -- Straddle Calendar Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.straddle_calendar_spread, buffer(offset, 8))

  -- Strip: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strip, buffer(offset, 8))

  -- Ladder: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.ladder, buffer(offset, 8))

  -- Strangle: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strangle, buffer(offset, 8))

  -- Combo: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.combo, buffer(offset, 8))

  -- Iron Butterfly: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.iron_butterfly, buffer(offset, 8))

  -- Two By One Ratio Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.two_by_one_ratio_spread, buffer(offset, 8))

  -- Guts: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.guts, buffer(offset, 8))

  -- Diagonal Calendar Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.diagonal_calendar_spread, buffer(offset, 8))

  -- Calendar Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.calendar_spread, buffer(offset, 8))

  -- Spread: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.spread, buffer(offset, 8))

  -- Call Or Put Cabinet: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_or_put_cabinet, buffer(offset, 8))

  -- Butterfly: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.butterfly, buffer(offset, 8))

  -- Jelly Roll: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.jelly_roll, buffer(offset, 8))
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_authorized.dissect = function(buffer, offset, packet, parent)
  ...
  local display = euronext_optiq_marketdatagateway_sbe_v4_5.strategy_authorized.display(range, packet, parent)
  ...
  if show.strategy_authorized then
    euronext_optiq_marketdatagateway_sbe_v4_5.strategy_authorized.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.contract_emm_properties_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.emm_optional.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.tick_size_index_id.size
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.strategy_authorized.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.dynamic_collar_logic.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.collar_max_unhalt_nb.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.collar_unhalt_delay.size
...
-- Delta
euronext_optiq_marketdatagateway_sbe_v4_5.delta = {}

-- Volume
euronext_optiq_marketdatagateway_sbe_v4_5.volume = {}

-- Reserved 6
euronext_optiq_marketdatagateway_sbe_v4_5.reserved_6 = {}
...
euronext_optiq_marketdatagateway_sbe_v4_5.mm_protections.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_marketdatagateway_sbe_v4_5.mm_protections.bits = function(buffer, offset, packet, parent)

  -- Reserved 6: 6 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.reserved_6, buffer(offset, 1))

  -- Volume: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.volume, buffer(offset, 1))

  -- Delta: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.delta, buffer(offset, 1))
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.mm_protections.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_marketdatagateway_sbe_v4_5.mm_protections.display(range, packet, parent)
  ...
  if show.mm_protections then
    euronext_optiq_marketdatagateway_sbe_v4_5.mm_protections.bits(buffer, offset, packet, element)
  end
...
-- Market
euronext_optiq_marketdatagateway_sbe_v4_5.market = {}

-- Limit
euronext_optiq_marketdatagateway_sbe_v4_5.limit = {}

-- Stop Stop Loss
euronext_optiq_marketdatagateway_sbe_v4_5.stop_stop_loss = {}

-- Stop Limit
euronext_optiq_marketdatagateway_sbe_v4_5.stop_limit = {}

-- Market On Open Moo
euronext_optiq_marketdatagateway_sbe_v4_5.market_on_open_moo = {}

-- Trade At Settlement
euronext_optiq_marketdatagateway_sbe_v4_5.trade_at_settlement = {}

-- Reserved 10
euronext_optiq_marketdatagateway_sbe_v4_5.reserved_10 = {}
...
euronext_optiq_marketdatagateway_sbe_v4_5.order_type_rules.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_marketdatagateway_sbe_v4_5.order_type_rules.bits = function(buffer, offset, packet, parent)

  -- Reserved 10: 10 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.reserved_10, buffer(offset, 2))

  -- Trade At Settlement: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.trade_at_settlement, buffer(offset, 2))

  -- Market On Open Moo: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.market_on_open_moo, buffer(offset, 2))

  -- Stop Limit: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.stop_limit, buffer(offset, 2))

  -- Stop Stop Loss: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.stop_stop_loss, buffer(offset, 2))

  -- Limit: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.limit, buffer(offset, 2))

  -- Market: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.market, buffer(offset, 2))
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.order_type_rules.dissect = function(buffer, offset, packet, parent)
  local size = 2
  local range = buffer(offset, size)
  local display = euronext_optiq_marketdatagateway_sbe_v4_5.order_type_rules.display(range, packet, parent)
  ...
  if show.order_type_rules then
    euronext_optiq_marketdatagateway_sbe_v4_5.order_type_rules.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group = {}

-- Calculate size of: Strategy Standing Datarep 1 Group
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_symbol_index.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_ratio.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.leg_buy_sell.size

  return index
end

-- Display: Strategy Standing Datarep 1 Group
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Standing Datarep 1 Group
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.fields = function(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  local index = offset

  -- Implicit Strategy Standing Datarep 1 Group Index
  if strategy_standing_datarep_1_group_index ~= nil then
    local iteration = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strategy_standing_datarep_1_group_index, strategy_standing_datarep_1_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.dissect = function(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  if show.strategy_standing_datarep_1_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strategy_standing_datarep_1_group, buffer(offset, 0))
    local index = euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.fields(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.fields(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  end
end

-- Strategy Standing Datarep 1 Groups
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups = {}

-- Calculate size of: Strategy Standing Datarep 1 Groups
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Standing Datarep 1 Groups
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for strategy_standing_datarep_1_group_index = 1, num_in_group do
    index, strategy_standing_datarep_1_group = euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_group.dissect(buffer, index, packet, parent, strategy_standing_datarep_1_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.strategy_standing_datarep_1_groups then
    local length = euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.strategy_standing_datarep_1_groups, range, display)
  end

  return euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_data_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.size(buffer, offset + index)
...
euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_data_message.fields = function(buffer, offset, packet, parent)
  ...
  index, strategy_standing_datarep_1_groups = euronext_optiq_marketdatagateway_sbe_v4_5.strategy_standing_datarep_1_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_marketdatagateway_sbe_v4_5.index_summary_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.opening_level.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.opening_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.confirmed_reference_level.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.confirmed_reference_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.closing_reference_level.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.closing_reference_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.prct_varfrom_prev_close.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.high_level.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.high_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.low_level.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.low_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.liquidation_level.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.liquidation_time.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.new_stats_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.stats_update_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.stats_update_value.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.real_time_index_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.index_level.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.pctg_of_capitalization.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.prct_varfrom_prev_close.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.num_traded_instruments.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.index_level_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.index_price_code.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group = {}

-- Calculate size of: Em M Pattern Rep Group
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.market_model.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.lot_size_optional.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.inst_unit_exp.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.anonymous.size

  return index
end

-- Display: Em M Pattern Rep Group
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Em M Pattern Rep Group
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.fields = function(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  local index = offset

  -- Implicit Em M Pattern Rep Group Index
  if em_m_pattern_rep_group_index ~= nil then
    local iteration = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.em_m_pattern_rep_group_index, em_m_pattern_rep_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.dissect = function(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  if show.em_m_pattern_rep_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.em_m_pattern_rep_group, buffer(offset, 0))
    local index = euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.fields(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.fields(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  end
end

-- Em M Pattern Rep Groups
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups = {}

-- Calculate size of: Em M Pattern Rep Groups
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Em M Pattern Rep Groups
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for em_m_pattern_rep_group_index = 1, num_in_group do
    index, em_m_pattern_rep_group = euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_group.dissect(buffer, index, packet, parent, em_m_pattern_rep_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.em_m_pattern_rep_groups then
    local length = euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.em_m_pattern_rep_groups, range, display)
  end

  return euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.standing_data_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.size(buffer, offset + index)
...
euronext_optiq_marketdatagateway_sbe_v4_5.standing_data_message.fields = function(buffer, offset, packet, parent)
  ...
  index, em_m_pattern_rep_groups = euronext_optiq_marketdatagateway_sbe_v4_5.em_m_pattern_rep_groups.dissect(buffer, index, packet, parent)
...
-- No Qualifier
euronext_optiq_marketdatagateway_sbe_v4_5.no_qualifier = {}

-- Call Bbo Only
euronext_optiq_marketdatagateway_sbe_v4_5.call_bbo_only = {}

-- Trading At Last
euronext_optiq_marketdatagateway_sbe_v4_5.trading_at_last = {}

-- Random Uncrossing
euronext_optiq_marketdatagateway_sbe_v4_5.random_uncrossing = {}

-- Suspended
euronext_optiq_marketdatagateway_sbe_v4_5.suspended = {}

-- Wholesale Allowed
euronext_optiq_marketdatagateway_sbe_v4_5.wholesale_allowed = {}
...
euronext_optiq_marketdatagateway_sbe_v4_5.phase_qualifier.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_marketdatagateway_sbe_v4_5.phase_qualifier.bits = function(buffer, offset, packet, parent)

  -- Reserved 10: 10 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.reserved_10, buffer(offset, 2))

  -- Wholesale Allowed: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.wholesale_allowed, buffer(offset, 2))

  -- Suspended: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.suspended, buffer(offset, 2))

  -- Random Uncrossing: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.random_uncrossing, buffer(offset, 2))

  -- Trading At Last: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.trading_at_last, buffer(offset, 2))

  -- Call Bbo Only: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.call_bbo_only, buffer(offset, 2))

  -- No Qualifier: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.no_qualifier, buffer(offset, 2))
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.phase_qualifier.dissect = function(buffer, offset, packet, parent)
  local size = 2
  local range = buffer(offset, size)
  local display = euronext_optiq_marketdatagateway_sbe_v4_5.phase_qualifier.display(range, packet, parent)
  ...
  if show.phase_qualifier then
    euronext_optiq_marketdatagateway_sbe_v4_5.phase_qualifier.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.timetables_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.phase_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.phase_id.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.phase_qualifier.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.trading_period.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.order_entry_qualifier.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.session.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.scheduled_event.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.market_states_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.change_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.symbol_index.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.event_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.book_state.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.status_reason.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.phase_qualifier.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.trading_period_optional.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.trading_side.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.price_limits.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.quote_spread_multiplier.size
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.scheduled_event_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.instrument_state.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_group = {}

-- Not Used Group 1 Groups
euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups = {}

-- Calculate size of: Not Used Group 1 Groups
euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Not Used Group 1 Groups
euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for not_used_group_1_group_index = 1, num_in_group do
    index, not_used_group_1_group = euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_group.dissect(buffer, index, packet, parent, not_used_group_1_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.not_used_group_1_groups then
    local length = euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.not_used_group_1_groups, range, display)
  end

  return euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.fields(buffer, offset, packet, parent)
end
...
-- Uncrossing Trade
euronext_optiq_marketdatagateway_sbe_v4_5.uncrossing_trade = {}

-- First Trade Price
euronext_optiq_marketdatagateway_sbe_v4_5.first_trade_price = {}

-- Passive Order
euronext_optiq_marketdatagateway_sbe_v4_5.passive_order = {}

-- Aggressive Order
euronext_optiq_marketdatagateway_sbe_v4_5.aggressive_order = {}

-- Trade Creation By Market Operations
euronext_optiq_marketdatagateway_sbe_v4_5.trade_creation_by_market_operations = {}

-- Nav Trade Expressed In Bps
euronext_optiq_marketdatagateway_sbe_v4_5.nav_trade_expressed_in_bps = {}

-- Nav Trade Expressed In Price Currency
euronext_optiq_marketdatagateway_sbe_v4_5.nav_trade_expressed_in_price_currency = {}

-- Deferred Publication
euronext_optiq_marketdatagateway_sbe_v4_5.deferred_publication = {}
...
euronext_optiq_marketdatagateway_sbe_v4_5.trade_qualifier.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_marketdatagateway_sbe_v4_5.trade_qualifier.bits = function(buffer, offset, packet, parent)

  -- Deferred Publication: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.deferred_publication, buffer(offset, 1))

  -- Nav Trade Expressed In Price Currency: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.nav_trade_expressed_in_price_currency, buffer(offset, 1))

  -- Nav Trade Expressed In Bps: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.nav_trade_expressed_in_bps, buffer(offset, 1))

  -- Trade Creation By Market Operations: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.trade_creation_by_market_operations, buffer(offset, 1))

  -- Aggressive Order: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.aggressive_order, buffer(offset, 1))

  -- Passive Order: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.passive_order, buffer(offset, 1))

  -- First Trade Price: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.first_trade_price, buffer(offset, 1))

  -- Uncrossing Trade: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.uncrossing_trade, buffer(offset, 1))
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.trade_qualifier.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = euronext_optiq_marketdatagateway_sbe_v4_5.trade_qualifier.display(range, packet, parent)
  ...
  if show.trade_qualifier then
    euronext_optiq_marketdatagateway_sbe_v4_5.trade_qualifier.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.full_trade_information_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.size(buffer, offset + index)
...
euronext_optiq_marketdatagateway_sbe_v4_5.full_trade_information_message.fields = function(buffer, offset, packet, parent)
  ...
  index, not_used_group_1_groups = euronext_optiq_marketdatagateway_sbe_v4_5.not_used_group_1_groups.dissect(buffer, index, packet, parent)
...
-- Prices Group
euronext_optiq_marketdatagateway_sbe_v4_5.prices_group = {}

-- Calculate size of: Prices Group
euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.price_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.symbol_index.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.price.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.quantity_optional.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.imbalance_qty.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.imbalance_qty_side.size

  return index
end

-- Display: Prices Group
euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prices Group
euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.fields = function(buffer, offset, packet, parent, prices_group_index)
  local index = offset

  -- Implicit Prices Group Index
  if prices_group_index ~= nil then
    local iteration = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.prices_group_index, prices_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.dissect = function(buffer, offset, packet, parent, prices_group_index)
  if show.prices_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.prices_group, buffer(offset, 0))
    local index = euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.fields(buffer, offset, packet, parent, prices_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.fields(buffer, offset, packet, parent, prices_group_index)
  end
end

-- Prices Groups
euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups = {}

-- Calculate size of: Prices Groups
euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Prices Groups
euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for prices_group_index = 1, num_in_group do
    index, prices_group = euronext_optiq_marketdatagateway_sbe_v4_5.prices_group.dissect(buffer, index, packet, parent, prices_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.prices_groups then
    local length = euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.prices_groups, range, display)
  end

  return euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.price_update_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.size(buffer, offset + index)
...
euronext_optiq_marketdatagateway_sbe_v4_5.price_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, prices_groups = euronext_optiq_marketdatagateway_sbe_v4_5.prices_groups.dissect(buffer, index, packet, parent)
...
-- Updates Group
euronext_optiq_marketdatagateway_sbe_v4_5.updates_group = {}

-- Calculate size of: Updates Group
euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.update_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.symbol_index.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.number_of_orders.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Updates Group
euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.fields = function(buffer, offset, packet, parent, updates_group_index)
  local index = offset

  -- Implicit Updates Group Index
  if updates_group_index ~= nil then
    local iteration = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.updates_group_index, updates_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.dissect = function(buffer, offset, packet, parent, updates_group_index)
  if show.updates_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.updates_group, buffer(offset, 0))
    local index = euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.fields(buffer, offset, packet, parent, updates_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.fields(buffer, offset, packet, parent, updates_group_index)
  end
end

-- Updates Groups
euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups = {}

-- Calculate size of: Updates Groups
euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Updates Groups
euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for updates_group_index = 1, num_in_group do
    index, updates_group = euronext_optiq_marketdatagateway_sbe_v4_5.updates_group.dissect(buffer, index, packet, parent, updates_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.updates_groups then
    local length = euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.updates_groups, range, display)
  end

  return euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.fields(buffer, offset, packet, parent)
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.market_update_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.size(buffer, offset + index)
...
euronext_optiq_marketdatagateway_sbe_v4_5.market_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, updates_groups = euronext_optiq_marketdatagateway_sbe_v4_5.updates_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_marketdatagateway_sbe_v4_5.technical_notification_message.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.md_seq_num_optional.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.technical_notification_type.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.rebroadcast_indicator.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.retransmission_start_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.retransmission_end_time.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.health_status_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.end_of_day_message.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.md_seq_num.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.session_trading_day.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.start_of_day_message.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_marketdatagateway_sbe_v4_5.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 1101 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.start_of_day_message.size(buffer, offset)
  end
  -- Size of End Of Day Message
  if template_id == 1102 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.end_of_day_message.size(buffer, offset)
  end
  -- Size of Health Status Message
  if template_id == 1103 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.health_status_message.size(buffer, offset)
  end
  -- Size of Technical Notification Message
  if template_id == 1106 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.technical_notification_message.size(buffer, offset)
  end
  ...
  if template_id == 1008 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.real_time_index_message.size(buffer, offset)
  end
  ...
  if template_id == 1011 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.index_summary_message.size(buffer, offset)
  end
  ...
  if template_id == 1026 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.apa_quotes_message.size(buffer, offset)
  end
  -- Size of Apa Standing Data Message
  if template_id == 1027 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.apa_standing_data_message.size(buffer, offset)
  end
  -- Size of Apa Full Trade Information Message
  if template_id == 1028 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.apa_full_trade_information_message.size(buffer, offset)
  end
  ...
  if template_id == 1202 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.bf_trade_message.size(buffer, offset)
  end
  -- Size of Bfnav Message
  if template_id == 1203 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.bfnav_message.size(buffer, offset)
  end
  -- Size of Bf Instrument Suspension Message
  if template_id == 1204 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.bf_instrument_suspension_message.size(buffer, offset)
  end
  -- Size of Start Of Snapshot Message
  if template_id == 2101 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.start_of_snapshot_message.size(buffer, offset)
  end
  -- Size of End Of Snapshot Message
  if template_id == 2102 then
    return euronext_optiq_marketdatagateway_sbe_v4_5.end_of_snapshot_message.size(buffer, offset)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.message_header.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.block_length.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.template_id.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.schema_id.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.version.size
...
euronext_optiq_marketdatagateway_sbe_v4_5.message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.message_header.size(buffer, offset + index)
...
-- Compression
euronext_optiq_marketdatagateway_sbe_v4_5.compression = {}

-- Mdg Restart Count
euronext_optiq_marketdatagateway_sbe_v4_5.mdg_restart_count = {}

-- Psn High Weight
euronext_optiq_marketdatagateway_sbe_v4_5.psn_high_weight = {}

-- Has Start Of Day Snapshot
euronext_optiq_marketdatagateway_sbe_v4_5.has_start_of_day_snapshot = {}

-- Has End Of Day Snapshot
euronext_optiq_marketdatagateway_sbe_v4_5.has_end_of_day_snapshot = {}

-- Has Status Message
euronext_optiq_marketdatagateway_sbe_v4_5.has_status_message = {}

-- Reserved Bits
euronext_optiq_marketdatagateway_sbe_v4_5.reserved_bits = {}
...
euronext_optiq_marketdatagateway_sbe_v4_5.packet_flags.display = function(buffer, packet, parent)
  local display = ""
...
euronext_optiq_marketdatagateway_sbe_v4_5.packet_flags.bits = function(buffer, offset, packet, parent)

  -- Reserved Bits: 6 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.reserved_bits, buffer(offset, 2))

  -- Has Status Message: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.has_status_message, buffer(offset, 2))

  -- Has End Of Day Snapshot: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.has_end_of_day_snapshot, buffer(offset, 2))

  -- Has Start Of Day Snapshot: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.has_start_of_day_snapshot, buffer(offset, 2))

  -- Psn High Weight: 3 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.psn_high_weight, buffer(offset, 2))

  -- Mdg Restart Count: 3 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.mdg_restart_count, buffer(offset, 2))

  -- Compression: 1 Bit
  parent:add(omi_euronext_optiq_marketdatagateway_sbe_v4_5.fields.compression, buffer(offset, 2))
end
...
euronext_optiq_marketdatagateway_sbe_v4_5.packet_flags.dissect = function(buffer, offset, packet, parent)
  local size = 2
  local range = buffer(offset, size)
  local display = euronext_optiq_marketdatagateway_sbe_v4_5.packet_flags.display(range, packet, parent)
  ...
  if show.packet_flags then
    euronext_optiq_marketdatagateway_sbe_v4_5.packet_flags.bits(buffer, offset, packet, element)
  end
...
euronext_optiq_marketdatagateway_sbe_v4_5.market_data_packet_header.size = function(buffer, offset)
  local index = 0

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.packet_time.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.packet_sequence_number.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.packet_flags.size

  index = index + euronext_optiq_marketdatagateway_sbe_v4_5.channel_id.size
...
verify.omi_euronext_optiq_marketdatagateway_sbe_v4_5_packet_size = function(buffer)
...
local function omi_euronext_optiq_marketdatagateway_sbe_v4_5_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_euronext_optiq_marketdatagateway_sbe_v4_5_packet_size(buffer) then return false end
