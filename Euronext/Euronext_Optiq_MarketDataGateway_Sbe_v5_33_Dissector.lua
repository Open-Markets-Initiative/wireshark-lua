...
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_optiq_message = Pref.bool("Show Optiq Message", show.optiq_message, "Parse and add Optiq Message to protocol tree")
...
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_market_updates_group_index = Pref.bool("Show Market Updates Group Index", show.market_updates_group_index, "Show generated market updates group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_order_updates_group_index = Pref.bool("Show Order Updates Group Index", show.order_updates_group_index, "Show generated order updates group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_price_updates_group_index = Pref.bool("Show Price Updates Group Index", show.price_updates_group_index, "Show generated price updates group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_not_used_group_index = Pref.bool("Show Not Used Group Index", show.not_used_group_index, "Show generated not used group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_market_states_group_index = Pref.bool("Show Market States Group Index", show.market_states_group_index, "Show generated market states group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_timetables_group_index = Pref.bool("Show Timetables Group Index", show.timetables_group_index, "Show generated timetables group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_emm_pattern_rep_group_index = Pref.bool("Show Emm Pattern Rep Group Index", show.emm_pattern_rep_group_index, "Show generated emm pattern rep group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_new_stats_group_index = Pref.bool("Show New Stats Group Index", show.new_stats_group_index, "Show generated new stats group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_strategy_standing_data_group_index = Pref.bool("Show Strategy Standing Data Group Index", show.strategy_standing_data_group_index, "Show generated strategy standing data group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_contract_emm_properties_group_index = Pref.bool("Show Contract Emm Properties Group Index", show.contract_emm_properties_group_index, "Show generated contract emm properties group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_outright_rep_group_index = Pref.bool("Show Outright Rep Group Index", show.outright_rep_group_index, "Show generated outright rep group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_long_order_updates_group_index = Pref.bool("Show Long Order Updates Group Index", show.long_order_updates_group_index, "Show generated long order updates group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_package_components_group_index = Pref.bool("Show Package Components Group Index", show.package_components_group_index, "Show generated package components group index in protocol tree")
omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_interest_payment_date_rep_group_index = Pref.bool("Show Interest Payment Date Rep Group Index", show.interest_payment_date_rep_group_index, "Show generated interest payment date rep group index in protocol tree")
...
function omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs_changed()
  ...
  if show.optiq_message ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_optiq_message then
    show.optiq_message = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_optiq_message
  end
  ...
  if show.market_updates_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_market_updates_group_index then
    show.market_updates_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_market_updates_group_index
  end
  if show.order_updates_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_order_updates_group_index then
    show.order_updates_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_order_updates_group_index
  end
  if show.price_updates_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_price_updates_group_index then
    show.price_updates_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_price_updates_group_index
  end
  if show.not_used_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_not_used_group_index then
    show.not_used_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_not_used_group_index
  end
  if show.market_states_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_market_states_group_index then
    show.market_states_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_market_states_group_index
  end
  if show.timetables_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_timetables_group_index then
    show.timetables_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_timetables_group_index
  end
  if show.emm_pattern_rep_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_emm_pattern_rep_group_index then
    show.emm_pattern_rep_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_emm_pattern_rep_group_index
  end
  if show.new_stats_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_new_stats_group_index then
    show.new_stats_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_new_stats_group_index
  end
  if show.strategy_standing_data_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_strategy_standing_data_group_index then
    show.strategy_standing_data_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_strategy_standing_data_group_index
  end
  if show.contract_emm_properties_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_contract_emm_properties_group_index then
    show.contract_emm_properties_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_contract_emm_properties_group_index
  end
  if show.outright_rep_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_outright_rep_group_index then
    show.outright_rep_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_outright_rep_group_index
  end
  if show.long_order_updates_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_long_order_updates_group_index then
    show.long_order_updates_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_long_order_updates_group_index
  end
  if show.package_components_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_package_components_group_index then
    show.package_components_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_package_components_group_index
  end
  if show.interest_payment_date_rep_group_index ~= omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_interest_payment_date_rep_group_index then
    show.interest_payment_date_rep_group_index = omi_euronext_optiq_marketdatagateway_sbe_v5_33.prefs.show_interest_payment_date_rep_group_index
  end
end
...
-- Register Euronext Optiq MarketDataGateway Sbe 5.33 on default port
