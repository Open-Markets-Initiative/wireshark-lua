...
verify.omi_euronext_optiq_marketdatagateway_sbe_v5_33_packet_size = function(buffer)
...
local function omi_euronext_optiq_marketdatagateway_sbe_v5_33_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_euronext_optiq_marketdatagateway_sbe_v5_33_packet_size(buffer) then return false end
