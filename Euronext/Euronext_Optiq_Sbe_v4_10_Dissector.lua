...
euronext_optiq_sbe_v4_10.not_used_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.not_used_groups then
    local length = euronext_optiq_sbe_v4_10.not_used_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.not_used_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.not_used_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.other_not_used_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.other_not_used_groups then
    local length = euronext_optiq_sbe_v4_10.other_not_used_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.other_not_used_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.other_not_used_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.cross_strategy_fields_groups then
    local length = euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_strategy_fields_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.cross_clearing_fields_groups then
    local length = euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_clearing_fields_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.free_text_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.free_text_groups then
    local length = euronext_optiq_sbe_v4_10.free_text_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.free_text_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.free_text_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.wholesale_ack_clearing_groups then
    local length = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_clearing_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.wholesale_ack_legs_groups then
    local length = euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_legs_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.wholesale_client_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.wholesale_client_groups then
    local length = euronext_optiq_sbe_v4_10.wholesale_client_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.wholesale_client_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_client_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.wholesale_legs_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.wholesale_legs_groups then
    local length = euronext_optiq_sbe_v4_10.wholesale_legs_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.wholesale_legs_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_legs_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.mmp_ack_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.mmp_ack_groups then
    local length = euronext_optiq_sbe_v4_10.mmp_ack_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.mmp_ack_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_ack_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.mmp_request_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.mmp_request_groups then
    local length = euronext_optiq_sbe_v4_10.mmp_request_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.mmp_request_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_request_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.instrument_synchronization_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.instrument_synchronization_groups then
    local length = euronext_optiq_sbe_v4_10.instrument_synchronization_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.instrument_synchronization_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.cancel_replace_clearing_fields_groups then
    local length = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_clearing_fields_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.cancel_replace_optional_field_groups then
    local length = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_optional_field_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.fill_derivatives_field_groups then
    local length = euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_derivatives_field_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.fill_strategy_field_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.fill_strategy_field_groups then
    local length = euronext_optiq_sbe_v4_10.fill_strategy_field_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.fill_strategy_field_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_strategy_field_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.fill_optional_field_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.fill_optional_field_groups then
    local length = euronext_optiq_sbe_v4_10.fill_optional_field_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.fill_optional_field_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_optional_field_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.order_clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.order_clearing_fields_groups then
    local length = euronext_optiq_sbe_v4_10.order_clearing_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.order_clearing_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_clearing_fields_groups, range, display)
  end
...
euronext_optiq_sbe_v4_10.order_optional_fields_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.order_optional_fields_groups then
    local length = euronext_optiq_sbe_v4_10.order_optional_fields_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = euronext_optiq_sbe_v4_10.order_optional_fields_groups.display(buffer, packet, parent)
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_optional_fields_groups, range, display)
  end
