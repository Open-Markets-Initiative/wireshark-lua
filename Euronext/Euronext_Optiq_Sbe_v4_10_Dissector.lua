...
omi_euronext_optiq_sbe_v4_10.fields.unused_execution_instructionset_7 = ProtoField.new("Unused Execution Instructionset 7", "euronext.optiq.sbe.v4.10.unusedexecutioninstructionset7", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, 0x80)
omi_euronext_optiq_sbe_v4_10.fields.unused_trading_session_validityset_0 = ProtoField.new("Unused Trading Session Validityset 0", "euronext.optiq.sbe.v4.10.unusedtradingsessionvalidityset0", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, 0x01)
