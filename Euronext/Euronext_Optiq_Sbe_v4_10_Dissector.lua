...
omi_euronext_optiq_sbe_v4_10.fields.acknowledgement = ProtoField.new("Acknowledgement", "euronext.optiq.sbe.v4.10.acknowledgement", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_euronext_optiq_sbe_v4_10.fields.aggressive_order = ProtoField.new("Aggressive Order", "euronext.optiq.sbe.v4.10.aggressiveorder", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_euronext_optiq_sbe_v4_10.fields.buy_side = ProtoField.new("Buy Side", "euronext.optiq.sbe.v4.10.buyside", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0008)
...
omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_clearing_fields_group = ProtoField.new("Cancel Replace Clearing Fields Group", "euronext.optiq.sbe.v4.10.cancelreplaceclearingfieldsgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_clearing_fields_groups = ProtoField.new("Cancel Replace Clearing Fields Groups", "euronext.optiq.sbe.v4.10.cancelreplaceclearingfieldsgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_optional_field_group = ProtoField.new("Cancel Replace Optional Field Group", "euronext.optiq.sbe.v4.10.cancelreplaceoptionalfieldgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_optional_field_groups = ProtoField.new("Cancel Replace Optional Field Groups", "euronext.optiq.sbe.v4.10.cancelreplaceoptionalfieldgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.commodity_derivative_indicator = ProtoField.new("Commodity Derivative Indicator", "euronext.optiq.sbe.v4.10.commodityderivativeindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_euronext_optiq_sbe_v4_10.fields.conditional_order = ProtoField.new("Conditional Order", "euronext.optiq.sbe.v4.10.conditionalorder", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_euronext_optiq_sbe_v4_10.fields.cross_clearing_fields_group = ProtoField.new("Cross Clearing Fields Group", "euronext.optiq.sbe.v4.10.crossclearingfieldsgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.cross_clearing_fields_groups = ProtoField.new("Cross Clearing Fields Groups", "euronext.optiq.sbe.v4.10.crossclearingfieldsgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.cross_strategy_fields_group = ProtoField.new("Cross Strategy Fields Group", "euronext.optiq.sbe.v4.10.crossstrategyfieldsgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.cross_strategy_fields_groups = ProtoField.new("Cross Strategy Fields Groups", "euronext.optiq.sbe.v4.10.crossstrategyfieldsgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.dark_indicator = ProtoField.new("Dark Indicator", "euronext.optiq.sbe.v4.10.darkindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_euronext_optiq_sbe_v4_10.fields.dea_indicator = ProtoField.new("Dea Indicator", "euronext.optiq.sbe.v4.10.deaindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_euronext_optiq_sbe_v4_10.fields.deferral_indicator = ProtoField.new("Deferral Indicator", "euronext.optiq.sbe.v4.10.deferralindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
omi_euronext_optiq_sbe_v4_10.fields.deferred_publication = ProtoField.new("Deferred Publication", "euronext.optiq.sbe.v4.10.deferredpublication", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_euronext_optiq_sbe_v4_10.fields.deferred_trade_indicator = ProtoField.new("Deferred Trade Indicator", "euronext.optiq.sbe.v4.10.deferredtradeindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_euronext_optiq_sbe_v4_10.fields.disabled_cancel_on_disconnect_indicator = ProtoField.new("Disabled Cancel On Disconnect Indicator", "euronext.optiq.sbe.v4.10.disabledcancelondisconnectindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_euronext_optiq_sbe_v4_10.fields.disclosed_quantity_randomization = ProtoField.new("Disclosed Quantity Randomization", "euronext.optiq.sbe.v4.10.disclosedquantityrandomization", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
omi_euronext_optiq_sbe_v4_10.fields.displayed_order_interaction = ProtoField.new("Displayed Order Interaction", "euronext.optiq.sbe.v4.10.displayedorderinteraction", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_euronext_optiq_sbe_v4_10.fields.euronext_data_driven = ProtoField.new("Euronext Data Driven", "euronext.optiq.sbe.v4.10.euronextdatadriven", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_euronext_optiq_sbe_v4_10.fields.executed_upon_entry_flag = ProtoField.new("Executed Upon Entry Flag", "euronext.optiq.sbe.v4.10.executeduponentryflag", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_euronext_optiq_sbe_v4_10.fields.execution_algo_indicator = ProtoField.new("Execution Algo Indicator", "euronext.optiq.sbe.v4.10.executionalgoindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_euronext_optiq_sbe_v4_10.fields.execution_upon_entry_flag_enabled = ProtoField.new("Execution Upon Entry Flag Enabled", "euronext.optiq.sbe.v4.10.executionuponentryflagenabled", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_euronext_optiq_sbe_v4_10.fields.field_actively_used = ProtoField.new("Field Actively Used", "euronext.optiq.sbe.v4.10.fieldactivelyused", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
omi_euronext_optiq_sbe_v4_10.fields.fill_derivatives_field_group = ProtoField.new("Fill Derivatives Field Group", "euronext.optiq.sbe.v4.10.fillderivativesfieldgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.fill_derivatives_field_groups = ProtoField.new("Fill Derivatives Field Groups", "euronext.optiq.sbe.v4.10.fillderivativesfieldgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.fill_optional_field_group = ProtoField.new("Fill Optional Field Group", "euronext.optiq.sbe.v4.10.filloptionalfieldgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.fill_optional_field_groups = ProtoField.new("Fill Optional Field Groups", "euronext.optiq.sbe.v4.10.filloptionalfieldgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.fill_strategy_field_group = ProtoField.new("Fill Strategy Field Group", "euronext.optiq.sbe.v4.10.fillstrategyfieldgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.fill_strategy_field_groups = ProtoField.new("Fill Strategy Field Groups", "euronext.optiq.sbe.v4.10.fillstrategyfieldgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.first_trade_price = ProtoField.new("First Trade Price", "euronext.optiq.sbe.v4.10.firsttradeprice", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_euronext_optiq_sbe_v4_10.fields.free_text_groups = ProtoField.new("Free Text Groups", "euronext.optiq.sbe.v4.10.freetextgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.frmaramplp = ProtoField.new("Frmaramplp", "euronext.optiq.sbe.v4.10.frmaramplp", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_euronext_optiq_sbe_v4_10.fields.holdings = ProtoField.new("Holdings", "euronext.optiq.sbe.v4.10.holdings", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
omi_euronext_optiq_sbe_v4_10.fields.ilqd = ProtoField.new("Ilqd", "euronext.optiq.sbe.v4.10.ilqd", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_group = ProtoField.new("Instrument Synchronization Group", "euronext.optiq.sbe.v4.10.instrumentsynchronizationgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_groups = ProtoField.new("Instrument Synchronization Groups", "euronext.optiq.sbe.v4.10.instrumentsynchronizationgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.interest_lists = ProtoField.new("Interest Lists", "euronext.optiq.sbe.v4.10.interestlists", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
omi_euronext_optiq_sbe_v4_10.fields.internal_1 = ProtoField.new("Internal 1", "euronext.optiq.sbe.v4.10.internal1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
omi_euronext_optiq_sbe_v4_10.fields.internal_2 = ProtoField.new("Internal 2", "euronext.optiq.sbe.v4.10.internal2", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_euronext_optiq_sbe_v4_10.fields.investment_algo_indicator = ProtoField.new("Investment Algo Indicator", "euronext.optiq.sbe.v4.10.investmentalgoindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_euronext_optiq_sbe_v4_10.fields.leg_1 = ProtoField.new("Leg 1", "euronext.optiq.sbe.v4.10.leg1", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0002)
omi_euronext_optiq_sbe_v4_10.fields.leg_2 = ProtoField.new("Leg 2", "euronext.optiq.sbe.v4.10.leg2", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0004)
omi_euronext_optiq_sbe_v4_10.fields.leg_3 = ProtoField.new("Leg 3", "euronext.optiq.sbe.v4.10.leg3", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0008)
omi_euronext_optiq_sbe_v4_10.fields.leg_4 = ProtoField.new("Leg 4", "euronext.optiq.sbe.v4.10.leg4", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0010)
omi_euronext_optiq_sbe_v4_10.fields.leg_5 = ProtoField.new("Leg 5", "euronext.optiq.sbe.v4.10.leg5", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0020)
omi_euronext_optiq_sbe_v4_10.fields.leg_6 = ProtoField.new("Leg 6", "euronext.optiq.sbe.v4.10.leg6", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0040)
omi_euronext_optiq_sbe_v4_10.fields.leg_7 = ProtoField.new("Leg 7", "euronext.optiq.sbe.v4.10.leg7", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0080)
omi_euronext_optiq_sbe_v4_10.fields.leg_8 = ProtoField.new("Leg 8", "euronext.optiq.sbe.v4.10.leg8", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0100)
omi_euronext_optiq_sbe_v4_10.fields.leg_9 = ProtoField.new("Leg 9", "euronext.optiq.sbe.v4.10.leg9", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0200)
...
omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_ams = ProtoField.new("Local Community Of Specialist Ams", "euronext.optiq.sbe.v4.10.localcommunityofspecialistams", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0040)
omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_bru = ProtoField.new("Local Community Of Specialist Bru", "euronext.optiq.sbe.v4.10.localcommunityofspecialistbru", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0100)
omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_lis = ProtoField.new("Local Community Of Specialist Lis", "euronext.optiq.sbe.v4.10.localcommunityofspecialistlis", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0200)
omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_par = ProtoField.new("Local Community Of Specialist Par", "euronext.optiq.sbe.v4.10.localcommunityofspecialistpar", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0080)
...
omi_euronext_optiq_sbe_v4_10.fields.lrgs = ProtoField.new("Lrgs", "euronext.optiq.sbe.v4.10.lrgs", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_euronext_optiq_sbe_v4_10.fields.minimum_quantity_type = ProtoField.new("Minimum Quantity Type", "euronext.optiq.sbe.v4.10.minimumquantitytype", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_euronext_optiq_sbe_v4_10.fields.mmp_ack_group = ProtoField.new("Mmp Ack Group", "euronext.optiq.sbe.v4.10.mmpackgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.mmp_ack_groups = ProtoField.new("Mmp Ack Groups", "euronext.optiq.sbe.v4.10.mmpackgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.mmp_request_group = ProtoField.new("Mmp Request Group", "euronext.optiq.sbe.v4.10.mmprequestgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.mmp_request_groups = ProtoField.new("Mmp Request Groups", "euronext.optiq.sbe.v4.10.mmprequestgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.nav_trade_expressed_in_bps = ProtoField.new("Nav Trade Expressed In Bps", "euronext.optiq.sbe.v4.10.navtradeexpressedinbps", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_euronext_optiq_sbe_v4_10.fields.nav_trade_expressed_in_price_currency = ProtoField.new("Nav Trade Expressed In Price Currency", "euronext.optiq.sbe.v4.10.navtradeexpressedinpricecurrency", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
omi_euronext_optiq_sbe_v4_10.fields.new_order_message_free_text_section_group = ProtoField.new("New Order Message Free Text Section Group", "euronext.optiq.sbe.v4.10.newordermessagefreetextsectiongroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.nliq = ProtoField.new("Nliq", "euronext.optiq.sbe.v4.10.nliq", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_euronext_optiq_sbe_v4_10.fields.not_used_groups = ProtoField.new("Not Used Groups", "euronext.optiq.sbe.v4.10.notusedgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.notification = ProtoField.new("Notification", "euronext.optiq.sbe.v4.10.notification", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_euronext_optiq_sbe_v4_10.fields.oilq = ProtoField.new("Oilq", "euronext.optiq.sbe.v4.10.oilq", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_euronext_optiq_sbe_v4_10.fields.omf = ProtoField.new("Omf", "euronext.optiq.sbe.v4.10.omf", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_euronext_optiq_sbe_v4_10.fields.order_clearing_fields_group = ProtoField.new("Order Clearing Fields Group", "euronext.optiq.sbe.v4.10.orderclearingfieldsgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.order_clearing_fields_groups = ProtoField.new("Order Clearing Fields Groups", "euronext.optiq.sbe.v4.10.orderclearingfieldsgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.order_optional_fields_group = ProtoField.new("Order Optional Fields Group", "euronext.optiq.sbe.v4.10.orderoptionalfieldsgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.order_optional_fields_groups = ProtoField.new("Order Optional Fields Groups", "euronext.optiq.sbe.v4.10.orderoptionalfieldsgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.other_not_used_groups = ProtoField.new("Other Not Used Groups", "euronext.optiq.sbe.v4.10.othernotusedgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.passive_order = ProtoField.new("Passive Order", "euronext.optiq.sbe.v4.10.passiveorder", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_euronext_optiq_sbe_v4_10.fields.pric = ProtoField.new("Pric", "euronext.optiq.sbe.v4.10.pric", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_euronext_optiq_sbe_v4_10.fields.pull = ProtoField.new("Pull", "euronext.optiq.sbe.v4.10.pull", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
omi_euronext_optiq_sbe_v4_10.fields.quality_of_sell_side_counterparty = ProtoField.new("Quality Of Sell Side Counterparty", "euronext.optiq.sbe.v4.10.qualityofsellsidecounterparty", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0020)
...
omi_euronext_optiq_sbe_v4_10.fields.queue_indicator = ProtoField.new("Queue Indicator", "euronext.optiq.sbe.v4.10.queueindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_euronext_optiq_sbe_v4_10.fields.request_with_client_order_id = ProtoField.new("Request With Client Order Id", "euronext.optiq.sbe.v4.10.requestwithclientorderid", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_euronext_optiq_sbe_v4_10.fields.rfpt = ProtoField.new("Rfpt", "euronext.optiq.sbe.v4.10.rfpt", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_euronext_optiq_sbe_v4_10.fields.rfq_answer = ProtoField.new("Rfq Answer", "euronext.optiq.sbe.v4.10.rfqanswer", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
omi_euronext_optiq_sbe_v4_10.fields.rfq_confirmation = ProtoField.new("Rfq Confirmation", "euronext.optiq.sbe.v4.10.rfqconfirmation", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_euronext_optiq_sbe_v4_10.fields.sell_side = ProtoField.new("Sell Side", "euronext.optiq.sbe.v4.10.sellside", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0010)
...
omi_euronext_optiq_sbe_v4_10.fields.session_1 = ProtoField.new("Session 1", "euronext.optiq.sbe.v4.10.session1", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_euronext_optiq_sbe_v4_10.fields.session_2 = ProtoField.new("Session 2", "euronext.optiq.sbe.v4.10.session2", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
omi_euronext_optiq_sbe_v4_10.fields.session_3 = ProtoField.new("Session 3", "euronext.optiq.sbe.v4.10.session3", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_euronext_optiq_sbe_v4_10.fields.session_4 = ProtoField.new("Session 4", "euronext.optiq.sbe.v4.10.session4", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_euronext_optiq_sbe_v4_10.fields.size = ProtoField.new("Size", "euronext.optiq.sbe.v4.10.size", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_euronext_optiq_sbe_v4_10.fields.stp_incoming_order = ProtoField.new("Stp Incoming Order", "euronext.optiq.sbe.v4.10.stpincomingorder", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
omi_euronext_optiq_sbe_v4_10.fields.stp_resting_order = ProtoField.new("Stp Resting Order", "euronext.optiq.sbe.v4.10.stprestingorder", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_euronext_optiq_sbe_v4_10.fields.sweep_order_indicator = ProtoField.new("Sweep Order Indicator", "euronext.optiq.sbe.v4.10.sweeporderindicator", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_euronext_optiq_sbe_v4_10.fields.trade_creation_by_market_operations = ProtoField.new("Trade Creation By Market Operations", "euronext.optiq.sbe.v4.10.tradecreationbymarketoperations", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_euronext_optiq_sbe_v4_10.fields.uncrossing_trade = ProtoField.new("Uncrossing Trade", "euronext.optiq.sbe.v4.10.uncrossingtrade", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_euronext_optiq_sbe_v4_10.fields.unused_execution_instructionset_7 = ProtoField.new("Unused Execution Instructionset 7", "euronext.optiq.sbe.v4.10.unusedexecutioninstructionset7", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_euronext_optiq_sbe_v4_10.fields.unused_trading_session_validityset_0 = ProtoField.new("Unused Trading Session Validityset 0", "euronext.optiq.sbe.v4.10.unusedtradingsessionvalidityset0", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_euronext_optiq_sbe_v4_10.fields.use_of_cross_partition = ProtoField.new("Use Of Cross Partition", "euronext.optiq.sbe.v4.10.useofcrosspartition", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_clearing_group = ProtoField.new("Wholesale Ack Clearing Group", "euronext.optiq.sbe.v4.10.wholesaleackclearinggroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_clearing_groups = ProtoField.new("Wholesale Ack Clearing Groups", "euronext.optiq.sbe.v4.10.wholesaleackclearinggroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_legs_group = ProtoField.new("Wholesale Ack Legs Group", "euronext.optiq.sbe.v4.10.wholesaleacklegsgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_legs_groups = ProtoField.new("Wholesale Ack Legs Groups", "euronext.optiq.sbe.v4.10.wholesaleacklegsgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_client_group = ProtoField.new("Wholesale Client Group", "euronext.optiq.sbe.v4.10.wholesaleclientgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_client_groups = ProtoField.new("Wholesale Client Groups", "euronext.optiq.sbe.v4.10.wholesaleclientgroups", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_legs_group = ProtoField.new("Wholesale Legs Group", "euronext.optiq.sbe.v4.10.wholesalelegsgroup", ftypes.STRING)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_legs_groups = ProtoField.new("Wholesale Legs Groups", "euronext.optiq.sbe.v4.10.wholesalelegsgroups", ftypes.STRING)
...
omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_clearing_fields_group_index = ProtoField.new("Cancel Replace Clearing Fields Group Index", "euronext.optiq.sbe.v4.10.cancelreplaceclearingfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_optional_field_group_index = ProtoField.new("Cancel Replace Optional Field Group Index", "euronext.optiq.sbe.v4.10.cancelreplaceoptionalfieldgroupindex", ftypes.UINT16)
...
omi_euronext_optiq_sbe_v4_10.fields.cross_clearing_fields_group_index = ProtoField.new("Cross Clearing Fields Group Index", "euronext.optiq.sbe.v4.10.crossclearingfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.cross_strategy_fields_group_index = ProtoField.new("Cross Strategy Fields Group Index", "euronext.optiq.sbe.v4.10.crossstrategyfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.fill_derivatives_field_group_index = ProtoField.new("Fill Derivatives Field Group Index", "euronext.optiq.sbe.v4.10.fillderivativesfieldgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.fill_optional_field_group_index = ProtoField.new("Fill Optional Field Group Index", "euronext.optiq.sbe.v4.10.filloptionalfieldgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.fill_strategy_field_group_index = ProtoField.new("Fill Strategy Field Group Index", "euronext.optiq.sbe.v4.10.fillstrategyfieldgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_group_index = ProtoField.new("Instrument Synchronization Group Index", "euronext.optiq.sbe.v4.10.instrumentsynchronizationgroupindex", ftypes.UINT16)
...
omi_euronext_optiq_sbe_v4_10.fields.mmp_ack_group_index = ProtoField.new("Mmp Ack Group Index", "euronext.optiq.sbe.v4.10.mmpackgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.mmp_request_group_index = ProtoField.new("Mmp Request Group Index", "euronext.optiq.sbe.v4.10.mmprequestgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.new_order_message_free_text_section_group_index = ProtoField.new("New Order Message Free Text Section Group Index", "euronext.optiq.sbe.v4.10.newordermessagefreetextsectiongroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.not_used_group_index = ProtoField.new("Not Used Group Index", "euronext.optiq.sbe.v4.10.notusedgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.order_clearing_fields_group_index = ProtoField.new("Order Clearing Fields Group Index", "euronext.optiq.sbe.v4.10.orderclearingfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.order_optional_fields_group_index = ProtoField.new("Order Optional Fields Group Index", "euronext.optiq.sbe.v4.10.orderoptionalfieldsgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.other_not_used_group_index = ProtoField.new("Other Not Used Group Index", "euronext.optiq.sbe.v4.10.othernotusedgroupindex", ftypes.UINT16)
...
omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_clearing_group_index = ProtoField.new("Wholesale Ack Clearing Group Index", "euronext.optiq.sbe.v4.10.wholesaleackclearinggroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_legs_group_index = ProtoField.new("Wholesale Ack Legs Group Index", "euronext.optiq.sbe.v4.10.wholesaleacklegsgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_client_group_index = ProtoField.new("Wholesale Client Group Index", "euronext.optiq.sbe.v4.10.wholesaleclientgroupindex", ftypes.UINT16)
omi_euronext_optiq_sbe_v4_10.fields.wholesale_legs_group_index = ProtoField.new("Wholesale Legs Group Index", "euronext.optiq.sbe.v4.10.wholesalelegsgroupindex", ftypes.UINT16)
...
omi_euronext_optiq_sbe_v4_10.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_group = Pref.bool("Show Cancel Replace Clearing Fields Group", show.cancel_replace_clearing_fields_group, "Parse and add Cancel Replace Clearing Fields Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_groups = Pref.bool("Show Cancel Replace Clearing Fields Groups", show.cancel_replace_clearing_fields_groups, "Parse and add Cancel Replace Clearing Fields Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_group = Pref.bool("Show Cancel Replace Optional Field Group", show.cancel_replace_optional_field_group, "Parse and add Cancel Replace Optional Field Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_groups = Pref.bool("Show Cancel Replace Optional Field Groups", show.cancel_replace_optional_field_groups, "Parse and add Cancel Replace Optional Field Groups to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_group = Pref.bool("Show Cross Clearing Fields Group", show.cross_clearing_fields_group, "Parse and add Cross Clearing Fields Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_groups = Pref.bool("Show Cross Clearing Fields Groups", show.cross_clearing_fields_groups, "Parse and add Cross Clearing Fields Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_group = Pref.bool("Show Cross Strategy Fields Group", show.cross_strategy_fields_group, "Parse and add Cross Strategy Fields Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_groups = Pref.bool("Show Cross Strategy Fields Groups", show.cross_strategy_fields_groups, "Parse and add Cross Strategy Fields Groups to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_group = Pref.bool("Show Fill Derivatives Field Group", show.fill_derivatives_field_group, "Parse and add Fill Derivatives Field Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_groups = Pref.bool("Show Fill Derivatives Field Groups", show.fill_derivatives_field_groups, "Parse and add Fill Derivatives Field Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_group = Pref.bool("Show Fill Optional Field Group", show.fill_optional_field_group, "Parse and add Fill Optional Field Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_groups = Pref.bool("Show Fill Optional Field Groups", show.fill_optional_field_groups, "Parse and add Fill Optional Field Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_group = Pref.bool("Show Fill Strategy Field Group", show.fill_strategy_field_group, "Parse and add Fill Strategy Field Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_groups = Pref.bool("Show Fill Strategy Field Groups", show.fill_strategy_field_groups, "Parse and add Fill Strategy Field Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_free_text_groups = Pref.bool("Show Free Text Groups", show.free_text_groups, "Parse and add Free Text Groups to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_group = Pref.bool("Show Instrument Synchronization Group", show.instrument_synchronization_group, "Parse and add Instrument Synchronization Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_groups = Pref.bool("Show Instrument Synchronization Groups", show.instrument_synchronization_groups, "Parse and add Instrument Synchronization Groups to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_group = Pref.bool("Show Mmp Ack Group", show.mmp_ack_group, "Parse and add Mmp Ack Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_groups = Pref.bool("Show Mmp Ack Groups", show.mmp_ack_groups, "Parse and add Mmp Ack Groups to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_group = Pref.bool("Show Mmp Request Group", show.mmp_request_group, "Parse and add Mmp Request Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_groups = Pref.bool("Show Mmp Request Groups", show.mmp_request_groups, "Parse and add Mmp Request Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_new_order_message_free_text_section_group = Pref.bool("Show New Order Message Free Text Section Group", show.new_order_message_free_text_section_group, "Parse and add New Order Message Free Text Section Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_not_used_groups = Pref.bool("Show Not Used Groups", show.not_used_groups, "Parse and add Not Used Groups to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_group = Pref.bool("Show Order Clearing Fields Group", show.order_clearing_fields_group, "Parse and add Order Clearing Fields Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_groups = Pref.bool("Show Order Clearing Fields Groups", show.order_clearing_fields_groups, "Parse and add Order Clearing Fields Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_group = Pref.bool("Show Order Optional Fields Group", show.order_optional_fields_group, "Parse and add Order Optional Fields Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_groups = Pref.bool("Show Order Optional Fields Groups", show.order_optional_fields_groups, "Parse and add Order Optional Fields Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_other_not_used_groups = Pref.bool("Show Other Not Used Groups", show.other_not_used_groups, "Parse and add Other Not Used Groups to protocol tree")
...
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_group = Pref.bool("Show Wholesale Ack Clearing Group", show.wholesale_ack_clearing_group, "Parse and add Wholesale Ack Clearing Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_groups = Pref.bool("Show Wholesale Ack Clearing Groups", show.wholesale_ack_clearing_groups, "Parse and add Wholesale Ack Clearing Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_group = Pref.bool("Show Wholesale Ack Legs Group", show.wholesale_ack_legs_group, "Parse and add Wholesale Ack Legs Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_groups = Pref.bool("Show Wholesale Ack Legs Groups", show.wholesale_ack_legs_groups, "Parse and add Wholesale Ack Legs Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_group = Pref.bool("Show Wholesale Client Group", show.wholesale_client_group, "Parse and add Wholesale Client Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_groups = Pref.bool("Show Wholesale Client Groups", show.wholesale_client_groups, "Parse and add Wholesale Client Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_group = Pref.bool("Show Wholesale Legs Group", show.wholesale_legs_group, "Parse and add Wholesale Legs Group to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_groups = Pref.bool("Show Wholesale Legs Groups", show.wholesale_legs_groups, "Parse and add Wholesale Legs Groups to protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_new_order_message_free_text_section_group_index = Pref.bool("Show New Order Message Free Text Section Group Index", show.new_order_message_free_text_section_group_index, "Show generated new order message free text section group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_mifid_short_codes_group_index = Pref.bool("Show Mifid Short Codes Group Index", show.mifid_short_codes_group_index, "Show generated mifid short codes group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_group_index = Pref.bool("Show Order Optional Fields Group Index", show.order_optional_fields_group_index, "Show generated order optional fields group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_group_index = Pref.bool("Show Order Clearing Fields Group Index", show.order_clearing_fields_group_index, "Show generated order clearing fields group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_not_used_group_index = Pref.bool("Show Not Used Group Index", show.not_used_group_index, "Show generated not used group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_other_not_used_group_index = Pref.bool("Show Other Not Used Group Index", show.other_not_used_group_index, "Show generated other not used group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_additional_infos_group_index = Pref.bool("Show Additional Infos Group Index", show.additional_infos_group_index, "Show generated additional infos group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_mifid_fields_group_index = Pref.bool("Show Mifid Fields Group Index", show.mifid_fields_group_index, "Show generated mifid fields group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_group_index = Pref.bool("Show Fill Optional Field Group Index", show.fill_optional_field_group_index, "Show generated fill optional field group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_group_index = Pref.bool("Show Fill Strategy Field Group Index", show.fill_strategy_field_group_index, "Show generated fill strategy field group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_group_index = Pref.bool("Show Fill Derivatives Field Group Index", show.fill_derivatives_field_group_index, "Show generated fill derivatives field group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_group_index = Pref.bool("Show Cancel Replace Optional Field Group Index", show.cancel_replace_optional_field_group_index, "Show generated cancel replace optional field group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_group_index = Pref.bool("Show Cancel Replace Clearing Fields Group Index", show.cancel_replace_clearing_fields_group_index, "Show generated cancel replace clearing fields group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_collar_fields_group_index = Pref.bool("Show Collar Fields Group Index", show.collar_fields_group_index, "Show generated collar fields group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_clearing_dataset_group_index = Pref.bool("Show Clearing Dataset Group Index", show.clearing_dataset_group_index, "Show generated clearing dataset group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_quotes_rep_group_index = Pref.bool("Show Quotes Rep Group Index", show.quotes_rep_group_index, "Show generated quotes rep group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_quote_acks_group_index = Pref.bool("Show Quote Acks Group Index", show.quote_acks_group_index, "Show generated quote acks group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_group_index = Pref.bool("Show Instrument Synchronization Group Index", show.instrument_synchronization_group_index, "Show generated instrument synchronization group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_strategy_legs_group_index = Pref.bool("Show Strategy Legs Group Index", show.strategy_legs_group_index, "Show generated strategy legs group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_group_index = Pref.bool("Show Mmp Request Group Index", show.mmp_request_group_index, "Show generated mmp request group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_group_index = Pref.bool("Show Mmp Ack Group Index", show.mmp_ack_group_index, "Show generated mmp ack group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_group_index = Pref.bool("Show Wholesale Legs Group Index", show.wholesale_legs_group_index, "Show generated wholesale legs group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_group_index = Pref.bool("Show Wholesale Client Group Index", show.wholesale_client_group_index, "Show generated wholesale client group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_group_index = Pref.bool("Show Wholesale Ack Legs Group Index", show.wholesale_ack_legs_group_index, "Show generated wholesale ack legs group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_group_index = Pref.bool("Show Wholesale Ack Clearing Group Index", show.wholesale_ack_clearing_group_index, "Show generated wholesale ack clearing group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_group_index = Pref.bool("Show Cross Clearing Fields Group Index", show.cross_clearing_fields_group_index, "Show generated cross clearing fields group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_group_index = Pref.bool("Show Cross Strategy Fields Group Index", show.cross_strategy_fields_group_index, "Show generated cross strategy fields group index in protocol tree")
omi_euronext_optiq_sbe_v4_10.prefs.show_rfq_counterparts_group_index = Pref.bool("Show Rfq Counterparts Group Index", show.rfq_counterparts_group_index, "Show generated rfq counterparts group index in protocol tree")
...
function omi_euronext_optiq_sbe_v4_10.prefs_changed()
  ...
  if show.application_messages ~= omi_euronext_optiq_sbe_v4_10.prefs.show_application_messages then
    show.application_messages = omi_euronext_optiq_sbe_v4_10.prefs.show_application_messages
  end
  if show.cancel_replace_clearing_fields_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_group then
    show.cancel_replace_clearing_fields_group = omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_group
  end
  if show.cancel_replace_clearing_fields_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_groups then
    show.cancel_replace_clearing_fields_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_groups
  end
  if show.cancel_replace_optional_field_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_group then
    show.cancel_replace_optional_field_group = omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_group
  end
  if show.cancel_replace_optional_field_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_groups then
    show.cancel_replace_optional_field_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_groups
  end
  ...
  if show.cross_clearing_fields_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_group then
    show.cross_clearing_fields_group = omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_group
  end
  if show.cross_clearing_fields_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_groups then
    show.cross_clearing_fields_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_groups
  end
  if show.cross_strategy_fields_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_group then
    show.cross_strategy_fields_group = omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_group
  end
  if show.cross_strategy_fields_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_groups then
    show.cross_strategy_fields_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_groups
  end
  ...
  if show.fill_derivatives_field_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_group then
    show.fill_derivatives_field_group = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_group
  end
  if show.fill_derivatives_field_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_groups then
    show.fill_derivatives_field_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_groups
  end
  if show.fill_optional_field_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_group then
    show.fill_optional_field_group = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_group
  end
  if show.fill_optional_field_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_groups then
    show.fill_optional_field_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_groups
  end
  if show.fill_strategy_field_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_group then
    show.fill_strategy_field_group = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_group
  end
  if show.fill_strategy_field_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_groups then
    show.fill_strategy_field_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_groups
  end
  if show.free_text_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_free_text_groups then
    show.free_text_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_free_text_groups
  end
  ...
  if show.instrument_synchronization_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_group then
    show.instrument_synchronization_group = omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_group
  end
  if show.instrument_synchronization_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_groups then
    show.instrument_synchronization_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_groups
  end
  ...
  if show.mmp_ack_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_group then
    show.mmp_ack_group = omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_group
  end
  if show.mmp_ack_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_groups then
    show.mmp_ack_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_groups
  end
  ...
  if show.mmp_request_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_group then
    show.mmp_request_group = omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_group
  end
  if show.mmp_request_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_groups then
    show.mmp_request_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_groups
  end
  if show.new_order_message_free_text_section_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_new_order_message_free_text_section_group then
    show.new_order_message_free_text_section_group = omi_euronext_optiq_sbe_v4_10.prefs.show_new_order_message_free_text_section_group
  end
  if show.not_used_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_not_used_groups then
    show.not_used_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_not_used_groups
  end
  ...
  if show.order_clearing_fields_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_group then
    show.order_clearing_fields_group = omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_group
  end
  if show.order_clearing_fields_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_groups then
    show.order_clearing_fields_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_groups
  end
  if show.order_optional_fields_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_group then
    show.order_optional_fields_group = omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_group
  end
  if show.order_optional_fields_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_groups then
    show.order_optional_fields_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_groups
  end
  if show.other_not_used_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_other_not_used_groups then
    show.other_not_used_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_other_not_used_groups
  end
  ...
  if show.wholesale_ack_clearing_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_group then
    show.wholesale_ack_clearing_group = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_group
  end
  if show.wholesale_ack_clearing_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_groups then
    show.wholesale_ack_clearing_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_groups
  end
  if show.wholesale_ack_legs_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_group then
    show.wholesale_ack_legs_group = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_group
  end
  if show.wholesale_ack_legs_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_groups then
    show.wholesale_ack_legs_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_groups
  end
  if show.wholesale_client_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_group then
    show.wholesale_client_group = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_group
  end
  if show.wholesale_client_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_groups then
    show.wholesale_client_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_groups
  end
  if show.wholesale_legs_group ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_group then
    show.wholesale_legs_group = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_group
  end
  if show.wholesale_legs_groups ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_groups then
    show.wholesale_legs_groups = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_groups
  end
  if show.new_order_message_free_text_section_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_new_order_message_free_text_section_group_index then
    show.new_order_message_free_text_section_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_new_order_message_free_text_section_group_index
  end
  if show.mifid_short_codes_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mifid_short_codes_group_index then
    show.mifid_short_codes_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_mifid_short_codes_group_index
  end
  if show.order_optional_fields_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_group_index then
    show.order_optional_fields_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_order_optional_fields_group_index
  end
  if show.order_clearing_fields_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_group_index then
    show.order_clearing_fields_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_order_clearing_fields_group_index
  end
  if show.not_used_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_not_used_group_index then
    show.not_used_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_not_used_group_index
  end
  if show.other_not_used_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_other_not_used_group_index then
    show.other_not_used_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_other_not_used_group_index
  end
  if show.additional_infos_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_additional_infos_group_index then
    show.additional_infos_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_additional_infos_group_index
  end
  if show.mifid_fields_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mifid_fields_group_index then
    show.mifid_fields_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_mifid_fields_group_index
  end
  if show.fill_optional_field_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_group_index then
    show.fill_optional_field_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_optional_field_group_index
  end
  if show.fill_strategy_field_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_group_index then
    show.fill_strategy_field_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_strategy_field_group_index
  end
  if show.fill_derivatives_field_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_group_index then
    show.fill_derivatives_field_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_fill_derivatives_field_group_index
  end
  if show.cancel_replace_optional_field_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_group_index then
    show.cancel_replace_optional_field_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_optional_field_group_index
  end
  if show.cancel_replace_clearing_fields_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_group_index then
    show.cancel_replace_clearing_fields_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_cancel_replace_clearing_fields_group_index
  end
  if show.collar_fields_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_collar_fields_group_index then
    show.collar_fields_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_collar_fields_group_index
  end
  if show.clearing_dataset_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_clearing_dataset_group_index then
    show.clearing_dataset_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_clearing_dataset_group_index
  end
  if show.quotes_rep_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_quotes_rep_group_index then
    show.quotes_rep_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_quotes_rep_group_index
  end
  if show.quote_acks_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_quote_acks_group_index then
    show.quote_acks_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_quote_acks_group_index
  end
  if show.instrument_synchronization_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_group_index then
    show.instrument_synchronization_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_instrument_synchronization_group_index
  end
  if show.strategy_legs_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_strategy_legs_group_index then
    show.strategy_legs_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_strategy_legs_group_index
  end
  if show.mmp_request_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_group_index then
    show.mmp_request_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_request_group_index
  end
  if show.mmp_ack_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_group_index then
    show.mmp_ack_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_mmp_ack_group_index
  end
  if show.wholesale_legs_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_group_index then
    show.wholesale_legs_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_legs_group_index
  end
  if show.wholesale_client_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_group_index then
    show.wholesale_client_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_client_group_index
  end
  if show.wholesale_ack_legs_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_group_index then
    show.wholesale_ack_legs_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_legs_group_index
  end
  if show.wholesale_ack_clearing_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_group_index then
    show.wholesale_ack_clearing_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_wholesale_ack_clearing_group_index
  end
  if show.cross_clearing_fields_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_group_index then
    show.cross_clearing_fields_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_cross_clearing_fields_group_index
  end
  if show.cross_strategy_fields_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_group_index then
    show.cross_strategy_fields_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_cross_strategy_fields_group_index
  end
  if show.rfq_counterparts_group_index ~= omi_euronext_optiq_sbe_v4_10.prefs.show_rfq_counterparts_group_index then
    show.rfq_counterparts_group_index = omi_euronext_optiq_sbe_v4_10.prefs.show_rfq_counterparts_group_index
  end
end
...
-- Not Used Groups
euronext_optiq_sbe_v4_10.not_used_groups = {}

-- Calculate size of: Not Used Groups
euronext_optiq_sbe_v4_10.not_used_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.not_used_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Not Used Groups
euronext_optiq_sbe_v4_10.not_used_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for not_used_group_index = 1, num_in_group do
    index, not_used_group = euronext_optiq_sbe_v4_10.not_used_group.dissect(buffer, index, packet, parent, not_used_group_index)
  end
...
euronext_optiq_sbe_v4_10.not_used_groups.dissect = function(buffer, offset, packet, parent)
  if show.not_used_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.not_used_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.not_used_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.not_used_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.not_used_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.declaration_entry_reject_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.not_used_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.declaration_entry_reject_message.fields = function(buffer, offset, packet, parent)
  ...
  index, not_used_groups = euronext_optiq_sbe_v4_10.not_used_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.declaration_entry_reject_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.declaration_entry_reject_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.declaration_entry_reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.declaration_entry_reject_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.other_not_used_groups = {}

-- Calculate size of: Other Not Used Groups
euronext_optiq_sbe_v4_10.other_not_used_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.other_not_used_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Other Not Used Groups
euronext_optiq_sbe_v4_10.other_not_used_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for other_not_used_group_index = 1, num_in_group do
    index, other_not_used_group = euronext_optiq_sbe_v4_10.other_not_used_group.dissect(buffer, index, packet, parent, other_not_used_group_index)
  end
...
euronext_optiq_sbe_v4_10.other_not_used_groups.dissect = function(buffer, offset, packet, parent)
  if show.other_not_used_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.other_not_used_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.other_not_used_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.other_not_used_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.other_not_used_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.waiver_indicator.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.waiver_indicator.bits = function(range, value, packet, parent)

  -- Lrgs: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.lrgs, range, value)

  -- Rfpt: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.rfpt, range, value)

  -- Nliq: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.nliq, range, value)

  -- Oilq: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.oilq, range, value)

  -- Pric: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.pric, range, value)

  -- Size: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.size, range, value)

  -- Ilqd: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.ilqd, range, value)

  -- Omf: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.omf, range, value)
end

-- Dissect: Waiver Indicator
euronext_optiq_sbe_v4_10.waiver_indicator.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.waiver_indicator.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.waiver_indicator.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_sbe_v4_10.fields.waiver_indicator, range, display)

  if show.waiver_indicator then
    euronext_optiq_sbe_v4_10.waiver_indicator.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.declaration_notice_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.other_not_used_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.declaration_notice_message.fields = function(buffer, offset, packet, parent)
  ...
  index, other_not_used_groups = euronext_optiq_sbe_v4_10.other_not_used_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.declaration_notice_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.declaration_notice_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.declaration_notice_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.declaration_notice_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.declaration_entry_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.declaration_entry_ack_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.declaration_entry_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.declaration_entry_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.mifid_indicators.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.mifid_indicators.bits = function(range, value, packet, parent)

  -- Dea Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.dea_indicator, range, value)

  -- Investment Algo Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.investment_algo_indicator, range, value)

  -- Execution Algo Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.execution_algo_indicator, range, value)

  -- Commodity Derivative Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.commodity_derivative_indicator, range, value)

  -- Deferral Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.deferral_indicator, range, value)

  -- Frmaramplp: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.frmaramplp, range, value)

  -- Reserved 2: 2 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.reserved_2, range, value)
end

-- Dissect: Mifid Indicators
euronext_optiq_sbe_v4_10.mifid_indicators.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.mifid_indicators.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.mifid_indicators.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mifid_indicators, range, display)

  if show.mifid_indicators then
    euronext_optiq_sbe_v4_10.mifid_indicators.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.declaration_entry_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.declaration_entry_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.declaration_entry_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.declaration_entry_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.target_counterparties.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.target_counterparties.bits = function(range, value, packet, parent)

  -- Euronext Data Driven: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.euronext_data_driven, range, value)

  -- Interest Lists: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.interest_lists, range, value)

  -- Holdings: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.holdings, range, value)

  -- Buy Side: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.buy_side, range, value)

  -- Sell Side: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.sell_side, range, value)

  -- Quality Of Sell Side Counterparty: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.quality_of_sell_side_counterparty, range, value)

  -- Local Community Of Specialist Ams: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_ams, range, value)

  -- Local Community Of Specialist Par: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_par, range, value)

  -- Local Community Of Specialist Bru: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_bru, range, value)

  -- Local Community Of Specialist Lis: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.local_community_of_specialist_lis, range, value)

  -- Reserved 6: 6 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.reserved_6, range, value)
end

-- Dissect: Target Counterparties
euronext_optiq_sbe_v4_10.target_counterparties.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.target_counterparties.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.target_counterparties.display(range, value, packet, parent)
  ...
  if show.target_counterparties then
    euronext_optiq_sbe_v4_10.target_counterparties.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.dark_execution_instruction_optional.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.dark_execution_instruction_optional.bits = function(range, value, packet, parent)

  -- Dark Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.dark_indicator, range, value)

  -- Deferred Trade Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.deferred_trade_indicator, range, value)

  -- Displayed Order Interaction: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.displayed_order_interaction, range, value)

  -- Sweep Order Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.sweep_order_indicator, range, value)

  -- Minimum Quantity Type: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.minimum_quantity_type, range, value)

  -- Reserved 3: 3 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.reserved_3, range, value)
end
...
euronext_optiq_sbe_v4_10.dark_execution_instruction_optional.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.dark_execution_instruction_optional.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.dark_execution_instruction_optional.display(range, value, packet, parent)
  ...
  if show.dark_execution_instruction_optional then
    euronext_optiq_sbe_v4_10.dark_execution_instruction_optional.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.rfq_counterparts_groups.dissect = function(buffer, offset, packet, parent)
  if show.rfq_counterparts_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.rfq_counterparts_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.rfq_counterparts_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.rfq_counterparts_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.rfq_audit_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.rfq_audit_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.rfq_audit_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.rfq_audit_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.cross_strategy_fields_group = {}

-- Size: Cross Strategy Fields Group
euronext_optiq_sbe_v4_10.cross_strategy_fields_group.size =
...
euronext_optiq_sbe_v4_10.cross_strategy_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cross Strategy Fields Group
euronext_optiq_sbe_v4_10.cross_strategy_fields_group.fields = function(buffer, offset, packet, parent, cross_strategy_fields_group_index)
  local index = offset
  ...
  if cross_strategy_fields_group_index ~= nil and show.cross_strategy_fields_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_strategy_fields_group_index, cross_strategy_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.cross_strategy_fields_group.dissect = function(buffer, offset, packet, parent, cross_strategy_fields_group_index)
  if show.cross_strategy_fields_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_strategy_fields_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cross_strategy_fields_group.fields(buffer, offset, packet, parent, cross_strategy_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cross_strategy_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cross_strategy_fields_group.fields(buffer, offset, packet, parent, cross_strategy_fields_group_index)
  end
end

-- Cross Strategy Fields Groups
euronext_optiq_sbe_v4_10.cross_strategy_fields_groups = {}

-- Calculate size of: Cross Strategy Fields Groups
euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cross Strategy Fields Groups
euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for cross_strategy_fields_group_index = 1, num_in_group do
    index, cross_strategy_fields_group = euronext_optiq_sbe_v4_10.cross_strategy_fields_group.dissect(buffer, index, packet, parent, cross_strategy_fields_group_index)
  end
...
euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.cross_strategy_fields_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_strategy_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.fields(buffer, offset, packet, parent)
  end
end
...
-- Display: Open Close
euronext_optiq_sbe_v4_10.open_close.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.open_close.bits = function(range, value, packet, parent)

  -- Field Actively Used: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.field_actively_used, range, value)

  -- Leg 1: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_1, range, value)

  -- Leg 2: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_2, range, value)

  -- Leg 3: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_3, range, value)

  -- Leg 4: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_4, range, value)

  -- Leg 5: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_5, range, value)

  -- Leg 6: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_6, range, value)

  -- Leg 7: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_7, range, value)

  -- Leg 8: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_8, range, value)

  -- Leg 9: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.leg_9, range, value)
...
euronext_optiq_sbe_v4_10.open_close.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.open_close.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.open_close.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_sbe_v4_10.fields.open_close, range, display)

  if show.open_close then
    euronext_optiq_sbe_v4_10.open_close.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.cross_clearing_fields_group = {}

-- Size: Cross Clearing Fields Group
euronext_optiq_sbe_v4_10.cross_clearing_fields_group.size =
...
euronext_optiq_sbe_v4_10.cross_clearing_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cross Clearing Fields Group
euronext_optiq_sbe_v4_10.cross_clearing_fields_group.fields = function(buffer, offset, packet, parent, cross_clearing_fields_group_index)
  local index = offset
  ...
  if cross_clearing_fields_group_index ~= nil and show.cross_clearing_fields_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_clearing_fields_group_index, cross_clearing_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.cross_clearing_fields_group.dissect = function(buffer, offset, packet, parent, cross_clearing_fields_group_index)
  if show.cross_clearing_fields_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_clearing_fields_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cross_clearing_fields_group.fields(buffer, offset, packet, parent, cross_clearing_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cross_clearing_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cross_clearing_fields_group.fields(buffer, offset, packet, parent, cross_clearing_fields_group_index)
  end
end

-- Cross Clearing Fields Groups
euronext_optiq_sbe_v4_10.cross_clearing_fields_groups = {}

-- Calculate size of: Cross Clearing Fields Groups
euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cross Clearing Fields Groups
euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for cross_clearing_fields_group_index = 1, num_in_group do
    index, cross_clearing_fields_group = euronext_optiq_sbe_v4_10.cross_clearing_fields_group.dissect(buffer, index, packet, parent, cross_clearing_fields_group_index)
  end
...
euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.cross_clearing_fields_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_clearing_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.mifid_short_codes_groups.dissect = function(buffer, offset, packet, parent)
  if show.mifid_short_codes_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mifid_short_codes_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mifid_short_codes_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mifid_short_codes_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group = {}

-- Size: New Order Message Free Text Section Group
euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.size =
  euronext_optiq_sbe_v4_10.free_text.size

-- Display: New Order Message Free Text Section Group
euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: New Order Message Free Text Section Group
euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.fields = function(buffer, offset, packet, parent, new_order_message_free_text_section_group_index)
  local index = offset
  ...
  if new_order_message_free_text_section_group_index ~= nil and show.new_order_message_free_text_section_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.new_order_message_free_text_section_group_index, new_order_message_free_text_section_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.dissect = function(buffer, offset, packet, parent, new_order_message_free_text_section_group_index)
  if show.new_order_message_free_text_section_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.new_order_message_free_text_section_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.fields(buffer, offset, packet, parent, new_order_message_free_text_section_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.fields(buffer, offset, packet, parent, new_order_message_free_text_section_group_index)
  end
end

-- Free Text Groups
euronext_optiq_sbe_v4_10.free_text_groups = {}

-- Calculate size of: Free Text Groups
euronext_optiq_sbe_v4_10.free_text_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.free_text_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Free Text Groups
euronext_optiq_sbe_v4_10.free_text_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for new_order_message_free_text_section_group_index = 1, num_in_group do
    index, new_order_message_free_text_section_group = euronext_optiq_sbe_v4_10.new_order_message_free_text_section_group.dissect(buffer, index, packet, parent, new_order_message_free_text_section_group_index)
  end
...
euronext_optiq_sbe_v4_10.free_text_groups.dissect = function(buffer, offset, packet, parent)
  if show.free_text_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.free_text_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.free_text_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.free_text_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.free_text_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.cross_order_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.free_text_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.mifid_short_codes_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.cross_order_message.fields = function(buffer, offset, packet, parent)
  ...
  index, free_text_groups = euronext_optiq_sbe_v4_10.free_text_groups.dissect(buffer, index, packet, parent)
  ...
  index, cross_clearing_fields_groups = euronext_optiq_sbe_v4_10.cross_clearing_fields_groups.dissect(buffer, index, packet, parent)

  -- Cross Strategy Fields Groups: Struct of 2 fields
  index, cross_strategy_fields_groups = euronext_optiq_sbe_v4_10.cross_strategy_fields_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.cross_order_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cross_order_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cross_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cross_order_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group = {}

-- Size: Wholesale Ack Clearing Group
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.size =
  euronext_optiq_sbe_v4_10.symbol_index.size + 
...
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Clearing Group
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.fields = function(buffer, offset, packet, parent, wholesale_ack_clearing_group_index)
  local index = offset
  ...
  if wholesale_ack_clearing_group_index ~= nil and show.wholesale_ack_clearing_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_clearing_group_index, wholesale_ack_clearing_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.dissect = function(buffer, offset, packet, parent, wholesale_ack_clearing_group_index)
  if show.wholesale_ack_clearing_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_clearing_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.fields(buffer, offset, packet, parent, wholesale_ack_clearing_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.fields(buffer, offset, packet, parent, wholesale_ack_clearing_group_index)
  end
end

-- Wholesale Ack Clearing Groups
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups = {}

-- Calculate size of: Wholesale Ack Clearing Groups
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Clearing Groups
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_ack_clearing_group_index = 1, num_in_group do
    index, wholesale_ack_clearing_group = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_group.dissect(buffer, index, packet, parent, wholesale_ack_clearing_group_index)
  end
...
euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.dissect = function(buffer, offset, packet, parent)
  if show.wholesale_ack_clearing_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_clearing_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.fields(buffer, offset, packet, parent)
  end
end

-- Wholesale Ack Legs Group
euronext_optiq_sbe_v4_10.wholesale_ack_legs_group = {}

-- Size: Wholesale Ack Legs Group
euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.size =
...
euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Legs Group
euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.fields = function(buffer, offset, packet, parent, wholesale_ack_legs_group_index)
  local index = offset
  ...
  if wholesale_ack_legs_group_index ~= nil and show.wholesale_ack_legs_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_legs_group_index, wholesale_ack_legs_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.dissect = function(buffer, offset, packet, parent, wholesale_ack_legs_group_index)
  if show.wholesale_ack_legs_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_legs_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.fields(buffer, offset, packet, parent, wholesale_ack_legs_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.fields(buffer, offset, packet, parent, wholesale_ack_legs_group_index)
  end
end

-- Wholesale Ack Legs Groups
euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups = {}

-- Calculate size of: Wholesale Ack Legs Groups
euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Ack Legs Groups
euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_ack_legs_group_index = 1, num_in_group do
    index, wholesale_ack_legs_group = euronext_optiq_sbe_v4_10.wholesale_ack_legs_group.dissect(buffer, index, packet, parent, wholesale_ack_legs_group_index)
  end
...
euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.dissect = function(buffer, offset, packet, parent)
  if show.wholesale_ack_legs_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_ack_legs_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.ack_qualifiers.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.ack_qualifiers.bits = function(range, value, packet, parent)

  -- Dark Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.dark_indicator, range, value)

  -- Queue Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.queue_indicator, range, value)

  -- Request With Client Order Id: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.request_with_client_order_id, range, value)

  -- Use Of Cross Partition: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.use_of_cross_partition, range, value)

  -- Internal 1: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.internal_1, range, value)

  -- Internal 2: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.internal_2, range, value)

  -- Execution Upon Entry Flag Enabled: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.execution_upon_entry_flag_enabled, range, value)

  -- Executed Upon Entry Flag: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.executed_upon_entry_flag, range, value)
end

-- Dissect: Ack Qualifiers
euronext_optiq_sbe_v4_10.ack_qualifiers.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.ack_qualifiers.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.ack_qualifiers.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_sbe_v4_10.fields.ack_qualifiers, range, display)

  if show.ack_qualifiers then
    euronext_optiq_sbe_v4_10.ack_qualifiers.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.wholesale_order_ack_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.wholesale_order_ack_message.fields = function(buffer, offset, packet, parent)
  ...
  index, wholesale_ack_legs_groups = euronext_optiq_sbe_v4_10.wholesale_ack_legs_groups.dissect(buffer, index, packet, parent)

  -- Wholesale Ack Clearing Groups: Struct of 2 fields
  index, wholesale_ack_clearing_groups = euronext_optiq_sbe_v4_10.wholesale_ack_clearing_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.wholesale_order_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_order_ack_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_order_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_order_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.wholesale_client_group = {}

-- Size: Wholesale Client Group
euronext_optiq_sbe_v4_10.wholesale_client_group.size =
  euronext_optiq_sbe_v4_10.symbol_index.size + 
  euronext_optiq_sbe_v4_10.side.size + 
  euronext_optiq_sbe_v4_10.account_type.size + 
  euronext_optiq_sbe_v4_10.clearing_firm_id.size + 
...
euronext_optiq_sbe_v4_10.wholesale_client_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Client Group
euronext_optiq_sbe_v4_10.wholesale_client_group.fields = function(buffer, offset, packet, parent, wholesale_client_group_index)
  local index = offset

  -- Implicit Wholesale Client Group Index
  if wholesale_client_group_index ~= nil and show.wholesale_client_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_client_group_index, wholesale_client_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.wholesale_client_group.dissect = function(buffer, offset, packet, parent, wholesale_client_group_index)
  if show.wholesale_client_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_client_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_client_group.fields(buffer, offset, packet, parent, wholesale_client_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_client_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_client_group.fields(buffer, offset, packet, parent, wholesale_client_group_index)
  end
end

-- Wholesale Client Groups
euronext_optiq_sbe_v4_10.wholesale_client_groups = {}

-- Calculate size of: Wholesale Client Groups
euronext_optiq_sbe_v4_10.wholesale_client_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.wholesale_client_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Client Groups
euronext_optiq_sbe_v4_10.wholesale_client_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_client_group_index = 1, num_in_group do
    index, wholesale_client_group = euronext_optiq_sbe_v4_10.wholesale_client_group.dissect(buffer, index, packet, parent, wholesale_client_group_index)
  end
...
euronext_optiq_sbe_v4_10.wholesale_client_groups.dissect = function(buffer, offset, packet, parent)
  if show.wholesale_client_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_client_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_client_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_client_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_client_groups.fields(buffer, offset, packet, parent)
  end
end

-- Wholesale Legs Group
euronext_optiq_sbe_v4_10.wholesale_legs_group = {}

-- Size: Wholesale Legs Group
euronext_optiq_sbe_v4_10.wholesale_legs_group.size =
  euronext_optiq_sbe_v4_10.leg_symbol_index.size + 
...
euronext_optiq_sbe_v4_10.wholesale_legs_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Legs Group
euronext_optiq_sbe_v4_10.wholesale_legs_group.fields = function(buffer, offset, packet, parent, wholesale_legs_group_index)
  local index = offset

  -- Implicit Wholesale Legs Group Index
  if wholesale_legs_group_index ~= nil and show.wholesale_legs_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_legs_group_index, wholesale_legs_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.wholesale_legs_group.dissect = function(buffer, offset, packet, parent, wholesale_legs_group_index)
  if show.wholesale_legs_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_legs_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_legs_group.fields(buffer, offset, packet, parent, wholesale_legs_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_legs_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_legs_group.fields(buffer, offset, packet, parent, wholesale_legs_group_index)
  end
end

-- Wholesale Legs Groups
euronext_optiq_sbe_v4_10.wholesale_legs_groups = {}

-- Calculate size of: Wholesale Legs Groups
euronext_optiq_sbe_v4_10.wholesale_legs_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.wholesale_legs_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Wholesale Legs Groups
euronext_optiq_sbe_v4_10.wholesale_legs_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for wholesale_legs_group_index = 1, num_in_group do
    index, wholesale_legs_group = euronext_optiq_sbe_v4_10.wholesale_legs_group.dissect(buffer, index, packet, parent, wholesale_legs_group_index)
  end
...
euronext_optiq_sbe_v4_10.wholesale_legs_groups.dissect = function(buffer, offset, packet, parent)
  if show.wholesale_legs_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.wholesale_legs_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.wholesale_legs_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.wholesale_legs_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.wholesale_legs_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.new_wholesale_order_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.wholesale_legs_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.wholesale_client_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.new_wholesale_order_message.fields = function(buffer, offset, packet, parent)
  ...
  index, wholesale_legs_groups = euronext_optiq_sbe_v4_10.wholesale_legs_groups.dissect(buffer, index, packet, parent)

  -- Wholesale Client Groups: Struct of 2 fields
  index, wholesale_client_groups = euronext_optiq_sbe_v4_10.wholesale_client_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.new_wholesale_order_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.new_wholesale_order_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.new_wholesale_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.new_wholesale_order_message.display(packet, parent, length)
    parent:append_text(display)
...
-- Mmp Ack Group
euronext_optiq_sbe_v4_10.mmp_ack_group = {}

-- Size: Mmp Ack Group
euronext_optiq_sbe_v4_10.mmp_ack_group.size =
...
euronext_optiq_sbe_v4_10.mmp_ack_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Ack Group
euronext_optiq_sbe_v4_10.mmp_ack_group.fields = function(buffer, offset, packet, parent, mmp_ack_group_index)
  local index = offset

  -- Implicit Mmp Ack Group Index
  if mmp_ack_group_index ~= nil and show.mmp_ack_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_ack_group_index, mmp_ack_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.mmp_ack_group.dissect = function(buffer, offset, packet, parent, mmp_ack_group_index)
  if show.mmp_ack_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_ack_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mmp_ack_group.fields(buffer, offset, packet, parent, mmp_ack_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mmp_ack_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.mmp_ack_group.fields(buffer, offset, packet, parent, mmp_ack_group_index)
  end
end

-- Mmp Ack Groups
euronext_optiq_sbe_v4_10.mmp_ack_groups = {}

-- Calculate size of: Mmp Ack Groups
euronext_optiq_sbe_v4_10.mmp_ack_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.mmp_ack_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Ack Groups
euronext_optiq_sbe_v4_10.mmp_ack_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for mmp_ack_group_index = 1, num_in_group do
    index, mmp_ack_group = euronext_optiq_sbe_v4_10.mmp_ack_group.dissect(buffer, index, packet, parent, mmp_ack_group_index)
  end
...
euronext_optiq_sbe_v4_10.mmp_ack_groups.dissect = function(buffer, offset, packet, parent)
  if show.mmp_ack_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_ack_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mmp_ack_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mmp_ack_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.mmp_ack_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.mmp_execution_type.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.mmp_execution_type.bits = function(range, value, packet, parent)

  -- Notification: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.notification, range, value)

  -- Acknowledgement: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.acknowledgement, range, value)

  -- Pull: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.pull, range, value)

  -- Reserved 5: 5 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.reserved_5, range, value)
end

-- Dissect: Mmp Execution Type
euronext_optiq_sbe_v4_10.mmp_execution_type.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.mmp_execution_type.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.mmp_execution_type.display(range, value, packet, parent)
  ...
  if show.mmp_execution_type then
    euronext_optiq_sbe_v4_10.mmp_execution_type.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.mm_protection_ack_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.mmp_ack_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.mm_protection_ack_message.fields = function(buffer, offset, packet, parent)
  ...
  index, mmp_ack_groups = euronext_optiq_sbe_v4_10.mmp_ack_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.mm_protection_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mm_protection_ack_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mm_protection_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mm_protection_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
-- Mmp Request Group
euronext_optiq_sbe_v4_10.mmp_request_group = {}

-- Size: Mmp Request Group
euronext_optiq_sbe_v4_10.mmp_request_group.size =
  euronext_optiq_sbe_v4_10.protection_type.size + 
  euronext_optiq_sbe_v4_10.protection_threshold.size + 
  euronext_optiq_sbe_v4_10.breach_action.size

-- Display: Mmp Request Group
euronext_optiq_sbe_v4_10.mmp_request_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Request Group
euronext_optiq_sbe_v4_10.mmp_request_group.fields = function(buffer, offset, packet, parent, mmp_request_group_index)
  local index = offset

  -- Implicit Mmp Request Group Index
  if mmp_request_group_index ~= nil and show.mmp_request_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_request_group_index, mmp_request_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.mmp_request_group.dissect = function(buffer, offset, packet, parent, mmp_request_group_index)
  if show.mmp_request_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_request_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mmp_request_group.fields(buffer, offset, packet, parent, mmp_request_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mmp_request_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.mmp_request_group.fields(buffer, offset, packet, parent, mmp_request_group_index)
  end
end

-- Mmp Request Groups
euronext_optiq_sbe_v4_10.mmp_request_groups = {}

-- Calculate size of: Mmp Request Groups
euronext_optiq_sbe_v4_10.mmp_request_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.mmp_request_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mmp Request Groups
euronext_optiq_sbe_v4_10.mmp_request_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for mmp_request_group_index = 1, num_in_group do
    index, mmp_request_group = euronext_optiq_sbe_v4_10.mmp_request_group.dissect(buffer, index, packet, parent, mmp_request_group_index)
  end
...
euronext_optiq_sbe_v4_10.mmp_request_groups.dissect = function(buffer, offset, packet, parent)
  if show.mmp_request_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mmp_request_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mmp_request_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mmp_request_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.mmp_request_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.mm_protection_request_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.mmp_request_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.mm_protection_request_message.fields = function(buffer, offset, packet, parent)
  ...
  index, mmp_request_groups = euronext_optiq_sbe_v4_10.mmp_request_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.mm_protection_request_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mm_protection_request_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mm_protection_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mm_protection_request_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.strategy_legs_groups.dissect = function(buffer, offset, packet, parent)
  if show.strategy_legs_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.strategy_legs_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.strategy_legs_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.strategy_legs_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.security_definition_request_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.security_definition_request_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.security_definition_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.security_definition_request_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.instrument_synchronization_group = {}

-- Size: Instrument Synchronization Group
euronext_optiq_sbe_v4_10.instrument_synchronization_group.size =
  euronext_optiq_sbe_v4_10.symbol_index.size + 
  euronext_optiq_sbe_v4_10.emm.size

-- Display: Instrument Synchronization Group
euronext_optiq_sbe_v4_10.instrument_synchronization_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Instrument Synchronization Group
euronext_optiq_sbe_v4_10.instrument_synchronization_group.fields = function(buffer, offset, packet, parent, instrument_synchronization_group_index)
  local index = offset
  ...
  if instrument_synchronization_group_index ~= nil and show.instrument_synchronization_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_group_index, instrument_synchronization_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.instrument_synchronization_group.dissect = function(buffer, offset, packet, parent, instrument_synchronization_group_index)
  if show.instrument_synchronization_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.instrument_synchronization_group.fields(buffer, offset, packet, parent, instrument_synchronization_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.instrument_synchronization_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.instrument_synchronization_group.fields(buffer, offset, packet, parent, instrument_synchronization_group_index)
  end
end

-- Instrument Synchronization Groups
euronext_optiq_sbe_v4_10.instrument_synchronization_groups = {}

-- Calculate size of: Instrument Synchronization Groups
euronext_optiq_sbe_v4_10.instrument_synchronization_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.instrument_synchronization_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Instrument Synchronization Groups
euronext_optiq_sbe_v4_10.instrument_synchronization_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for instrument_synchronization_group_index = 1, num_in_group do
    index, instrument_synchronization_group = euronext_optiq_sbe_v4_10.instrument_synchronization_group.dissect(buffer, index, packet, parent, instrument_synchronization_group_index)
  end
...
euronext_optiq_sbe_v4_10.instrument_synchronization_groups.dissect = function(buffer, offset, packet, parent)
  if show.instrument_synchronization_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.instrument_synchronization_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.instrument_synchronization_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.instrument_synchronization_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.instrument_synchronization_list_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.instrument_synchronization_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.instrument_synchronization_list_message.fields = function(buffer, offset, packet, parent)
  ...
  index, instrument_synchronization_groups = euronext_optiq_sbe_v4_10.instrument_synchronization_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.instrument_synchronization_list_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.instrument_synchronization_list_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.instrument_synchronization_list_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.instrument_synchronization_list_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.execution_instruction_optional.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.execution_instruction_optional.bits = function(range, value, packet, parent)

  -- Stp Resting Order: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.stp_resting_order, range, value)

  -- Stp Incoming Order: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.stp_incoming_order, range, value)

  -- Disclosed Quantity Randomization: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.disclosed_quantity_randomization, range, value)

  -- Disabled Cancel On Disconnect Indicator: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.disabled_cancel_on_disconnect_indicator, range, value)

  -- Rfq Answer: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.rfq_answer, range, value)

  -- Rfq Confirmation: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.rfq_confirmation, range, value)

  -- Conditional Order: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.conditional_order, range, value)

  -- Unused Execution Instructionset 7: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.unused_execution_instructionset_7, range, value)
end
...
euronext_optiq_sbe_v4_10.execution_instruction_optional.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.execution_instruction_optional.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.execution_instruction_optional.display(range, value, packet, parent)
  ...
  if show.execution_instruction_optional then
    euronext_optiq_sbe_v4_10.execution_instruction_optional.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.user_notification_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.user_notification_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.user_notification_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.user_notification_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.dark_execution_instruction.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.dark_execution_instruction.bits = function(range, value, packet, parent)
...
euronext_optiq_sbe_v4_10.dark_execution_instruction.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.dark_execution_instruction.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.dark_execution_instruction.display(range, value, packet, parent)
  ...
  if show.dark_execution_instruction then
    euronext_optiq_sbe_v4_10.dark_execution_instruction.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.mifid_indicators_optional.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.mifid_indicators_optional.bits = function(range, value, packet, parent)
...
euronext_optiq_sbe_v4_10.mifid_indicators_optional.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.mifid_indicators_optional.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.mifid_indicators_optional.display(range, value, packet, parent)
  ...
  if show.mifid_indicators_optional then
    euronext_optiq_sbe_v4_10.mifid_indicators_optional.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.mifid_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.mifid_fields_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mifid_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mifid_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mifid_fields_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.ack_qualifiers_optional.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.ack_qualifiers_optional.bits = function(range, value, packet, parent)
...
euronext_optiq_sbe_v4_10.ack_qualifiers_optional.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.ack_qualifiers_optional.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.ack_qualifiers_optional.display(range, value, packet, parent)
  ...
  if show.ack_qualifiers_optional then
    euronext_optiq_sbe_v4_10.ack_qualifiers_optional.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.mass_cancel_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mass_cancel_ack_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mass_cancel_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mass_cancel_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.mass_cancel_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.mass_cancel_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.mass_cancel_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.mass_cancel_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.cancel_request_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_request_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cancel_request_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cancel_request_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.quote_acks_groups.dissect = function(buffer, offset, packet, parent)
  if show.quote_acks_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.quote_acks_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.quote_acks_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.quote_acks_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.quote_ack_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.quote_ack_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.quote_ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.quote_ack_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.quotes_rep_groups.dissect = function(buffer, offset, packet, parent)
  if show.quotes_rep_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.quotes_rep_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.quotes_rep_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.quotes_rep_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.clearing_dataset_groups.dissect = function(buffer, offset, packet, parent)
  if show.clearing_dataset_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.clearing_dataset_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.clearing_dataset_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.clearing_dataset_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.quotes_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.quotes_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.quotes_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.quotes_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.collar_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.collar_fields_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.collar_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.collar_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.collar_fields_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.reject_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.reject_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.reject_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.reject_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.additional_infos_groups.dissect = function(buffer, offset, packet, parent)
  if show.additional_infos_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.additional_infos_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.additional_infos_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.additional_infos_groups.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group = {}

-- Size: Cancel Replace Clearing Fields Group
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.size =
  euronext_optiq_sbe_v4_10.clearing_firm_id.size + 
  euronext_optiq_sbe_v4_10.client_id.size + 
  euronext_optiq_sbe_v4_10.account_number.size + 
  euronext_optiq_sbe_v4_10.technical_origin.size + 
...
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Replace Clearing Fields Group
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.fields = function(buffer, offset, packet, parent, cancel_replace_clearing_fields_group_index)
  local index = offset
  ...
  if cancel_replace_clearing_fields_group_index ~= nil and show.cancel_replace_clearing_fields_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_clearing_fields_group_index, cancel_replace_clearing_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.dissect = function(buffer, offset, packet, parent, cancel_replace_clearing_fields_group_index)
  if show.cancel_replace_clearing_fields_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_clearing_fields_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.fields(buffer, offset, packet, parent, cancel_replace_clearing_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.fields(buffer, offset, packet, parent, cancel_replace_clearing_fields_group_index)
  end
end

-- Cancel Replace Clearing Fields Groups
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups = {}

-- Calculate size of: Cancel Replace Clearing Fields Groups
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Replace Clearing Fields Groups
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for cancel_replace_clearing_fields_group_index = 1, num_in_group do
    index, cancel_replace_clearing_fields_group = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_group.dissect(buffer, index, packet, parent, cancel_replace_clearing_fields_group_index)
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.cancel_replace_clearing_fields_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_clearing_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.trading_session.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.trading_session.bits = function(range, value, packet, parent)

  -- Unused Trading Session Validityset 0: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.unused_trading_session_validityset_0, range, value)

  -- Session 1: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.session_1, range, value)

  -- Session 2: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.session_2, range, value)

  -- Session 3: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.session_3, range, value)

  -- Session 4: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.session_4, range, value)
...
euronext_optiq_sbe_v4_10.trading_session.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.trading_session.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.trading_session.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_sbe_v4_10.fields.trading_session, range, display)

  if show.trading_session then
    euronext_optiq_sbe_v4_10.trading_session.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group = {}

-- Size: Cancel Replace Optional Field Group
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.size =
...
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Replace Optional Field Group
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.fields = function(buffer, offset, packet, parent, cancel_replace_optional_field_group_index)
  local index = offset
  ...
  if cancel_replace_optional_field_group_index ~= nil and show.cancel_replace_optional_field_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_optional_field_group_index, cancel_replace_optional_field_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.dissect = function(buffer, offset, packet, parent, cancel_replace_optional_field_group_index)
  if show.cancel_replace_optional_field_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_optional_field_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.fields(buffer, offset, packet, parent, cancel_replace_optional_field_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.fields(buffer, offset, packet, parent, cancel_replace_optional_field_group_index)
  end
end

-- Cancel Replace Optional Field Groups
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups = {}

-- Calculate size of: Cancel Replace Optional Field Groups
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Replace Optional Field Groups
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for cancel_replace_optional_field_group_index = 1, num_in_group do
    index, cancel_replace_optional_field_group = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_group.dissect(buffer, index, packet, parent, cancel_replace_optional_field_group_index)
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.dissect = function(buffer, offset, packet, parent)
  if show.cancel_replace_optional_field_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_optional_field_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.execution_instruction.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.execution_instruction.bits = function(range, value, packet, parent)
...
euronext_optiq_sbe_v4_10.execution_instruction.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.execution_instruction.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.execution_instruction.display(range, value, packet, parent)
  ...
  if show.execution_instruction then
    euronext_optiq_sbe_v4_10.execution_instruction.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.cancel_replace_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.cancel_replace_message.fields = function(buffer, offset, packet, parent)
  ...
  index, cancel_replace_optional_field_groups = euronext_optiq_sbe_v4_10.cancel_replace_optional_field_groups.dissect(buffer, index, packet, parent)

  -- Cancel Replace Clearing Fields Groups: Struct of 2 fields
  index, cancel_replace_clearing_fields_groups = euronext_optiq_sbe_v4_10.cancel_replace_clearing_fields_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.cancel_replace_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.cancel_replace_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.cancel_replace_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.cancel_replace_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.kill_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.kill_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.kill_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.kill_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.fill_derivatives_field_group = {}

-- Size: Fill Derivatives Field Group
euronext_optiq_sbe_v4_10.fill_derivatives_field_group.size =
...
euronext_optiq_sbe_v4_10.fill_derivatives_field_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fill Derivatives Field Group
euronext_optiq_sbe_v4_10.fill_derivatives_field_group.fields = function(buffer, offset, packet, parent, fill_derivatives_field_group_index)
  local index = offset
  ...
  if fill_derivatives_field_group_index ~= nil and show.fill_derivatives_field_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_derivatives_field_group_index, fill_derivatives_field_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.fill_derivatives_field_group.dissect = function(buffer, offset, packet, parent, fill_derivatives_field_group_index)
  if show.fill_derivatives_field_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_derivatives_field_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.fill_derivatives_field_group.fields(buffer, offset, packet, parent, fill_derivatives_field_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.fill_derivatives_field_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.fill_derivatives_field_group.fields(buffer, offset, packet, parent, fill_derivatives_field_group_index)
  end
end

-- Fill Derivatives Field Groups
euronext_optiq_sbe_v4_10.fill_derivatives_field_groups = {}

-- Calculate size of: Fill Derivatives Field Groups
euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fill Derivatives Field Groups
euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for fill_derivatives_field_group_index = 1, num_in_group do
    index, fill_derivatives_field_group = euronext_optiq_sbe_v4_10.fill_derivatives_field_group.dissect(buffer, index, packet, parent, fill_derivatives_field_group_index)
  end
...
euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.dissect = function(buffer, offset, packet, parent)
  if show.fill_derivatives_field_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_derivatives_field_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.fields(buffer, offset, packet, parent)
  end
end

-- Fill Strategy Field Group
euronext_optiq_sbe_v4_10.fill_strategy_field_group = {}

-- Size: Fill Strategy Field Group
euronext_optiq_sbe_v4_10.fill_strategy_field_group.size =
  euronext_optiq_sbe_v4_10.leg_last_px.size + 
  euronext_optiq_sbe_v4_10.leg_last_qty.size + 
  euronext_optiq_sbe_v4_10.leg_instrument_id.size + 
  euronext_optiq_sbe_v4_10.leg_side_optional.size + 
...
euronext_optiq_sbe_v4_10.fill_strategy_field_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fill Strategy Field Group
euronext_optiq_sbe_v4_10.fill_strategy_field_group.fields = function(buffer, offset, packet, parent, fill_strategy_field_group_index)
  local index = offset
  ...
  if fill_strategy_field_group_index ~= nil and show.fill_strategy_field_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_strategy_field_group_index, fill_strategy_field_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.fill_strategy_field_group.dissect = function(buffer, offset, packet, parent, fill_strategy_field_group_index)
  if show.fill_strategy_field_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_strategy_field_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.fill_strategy_field_group.fields(buffer, offset, packet, parent, fill_strategy_field_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.fill_strategy_field_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.fill_strategy_field_group.fields(buffer, offset, packet, parent, fill_strategy_field_group_index)
  end
end

-- Fill Strategy Field Groups
euronext_optiq_sbe_v4_10.fill_strategy_field_groups = {}

-- Calculate size of: Fill Strategy Field Groups
euronext_optiq_sbe_v4_10.fill_strategy_field_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.fill_strategy_field_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fill Strategy Field Groups
euronext_optiq_sbe_v4_10.fill_strategy_field_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for fill_strategy_field_group_index = 1, num_in_group do
    index, fill_strategy_field_group = euronext_optiq_sbe_v4_10.fill_strategy_field_group.dissect(buffer, index, packet, parent, fill_strategy_field_group_index)
  end
...
euronext_optiq_sbe_v4_10.fill_strategy_field_groups.dissect = function(buffer, offset, packet, parent)
  if show.fill_strategy_field_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_strategy_field_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.fill_strategy_field_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.fill_strategy_field_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.fill_strategy_field_groups.fields(buffer, offset, packet, parent)
  end
end

-- Fill Optional Field Group
euronext_optiq_sbe_v4_10.fill_optional_field_group = {}

-- Size: Fill Optional Field Group
euronext_optiq_sbe_v4_10.fill_optional_field_group.size =
  euronext_optiq_sbe_v4_10.counterpart_firm_id.size + 
...
euronext_optiq_sbe_v4_10.fill_optional_field_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fill Optional Field Group
euronext_optiq_sbe_v4_10.fill_optional_field_group.fields = function(buffer, offset, packet, parent, fill_optional_field_group_index)
  local index = offset
  ...
  if fill_optional_field_group_index ~= nil and show.fill_optional_field_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_optional_field_group_index, fill_optional_field_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.fill_optional_field_group.dissect = function(buffer, offset, packet, parent, fill_optional_field_group_index)
  if show.fill_optional_field_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_optional_field_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.fill_optional_field_group.fields(buffer, offset, packet, parent, fill_optional_field_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.fill_optional_field_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.fill_optional_field_group.fields(buffer, offset, packet, parent, fill_optional_field_group_index)
  end
end

-- Fill Optional Field Groups
euronext_optiq_sbe_v4_10.fill_optional_field_groups = {}

-- Calculate size of: Fill Optional Field Groups
euronext_optiq_sbe_v4_10.fill_optional_field_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.fill_optional_field_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fill Optional Field Groups
euronext_optiq_sbe_v4_10.fill_optional_field_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for fill_optional_field_group_index = 1, num_in_group do
    index, fill_optional_field_group = euronext_optiq_sbe_v4_10.fill_optional_field_group.dissect(buffer, index, packet, parent, fill_optional_field_group_index)
  end
...
euronext_optiq_sbe_v4_10.fill_optional_field_groups.dissect = function(buffer, offset, packet, parent)
  if show.fill_optional_field_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_optional_field_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.fill_optional_field_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.fill_optional_field_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.fill_optional_field_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.trade_qualifier.display = function(range, value, packet, parent)
  local flags = {}
...
euronext_optiq_sbe_v4_10.trade_qualifier.bits = function(range, value, packet, parent)

  -- Uncrossing Trade: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.uncrossing_trade, range, value)

  -- First Trade Price: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.first_trade_price, range, value)

  -- Passive Order: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.passive_order, range, value)

  -- Aggressive Order: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.aggressive_order, range, value)

  -- Trade Creation By Market Operations: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.trade_creation_by_market_operations, range, value)

  -- Nav Trade Expressed In Bps: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.nav_trade_expressed_in_bps, range, value)

  -- Nav Trade Expressed In Price Currency: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.nav_trade_expressed_in_price_currency, range, value)

  -- Deferred Publication: 1 Bit
  parent:add(omi_euronext_optiq_sbe_v4_10.fields.deferred_publication, range, value)
end

-- Dissect: Trade Qualifier
euronext_optiq_sbe_v4_10.trade_qualifier.dissect = function(buffer, offset, packet, parent)
  local size = euronext_optiq_sbe_v4_10.trade_qualifier.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = euronext_optiq_sbe_v4_10.trade_qualifier.display(range, value, packet, parent)
  local element = parent:add(omi_euronext_optiq_sbe_v4_10.fields.trade_qualifier, range, display)

  if show.trade_qualifier then
    euronext_optiq_sbe_v4_10.trade_qualifier.bits(range, value, packet, element)
  end
...
euronext_optiq_sbe_v4_10.fill_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.fill_optional_field_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.fill_strategy_field_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.mifid_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.fill_message.fields = function(buffer, offset, packet, parent)
  ...
  index, fill_optional_field_groups = euronext_optiq_sbe_v4_10.fill_optional_field_groups.dissect(buffer, index, packet, parent)

  -- Fill Strategy Field Groups: Struct of 2 fields
  index, fill_strategy_field_groups = euronext_optiq_sbe_v4_10.fill_strategy_field_groups.dissect(buffer, index, packet, parent)

  -- Mifid Fields Groups: Struct of 2 fields
  index, mifid_fields_groups = euronext_optiq_sbe_v4_10.mifid_fields_groups.dissect(buffer, index, packet, parent)

  -- Fill Derivatives Field Groups: Struct of 2 fields
  index, fill_derivatives_field_groups = euronext_optiq_sbe_v4_10.fill_derivatives_field_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.fill_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.fill_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.fill_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.fill_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.ack_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.ack_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.ack_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.ack_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.order_clearing_fields_group = {}

-- Size: Order Clearing Fields Group
euronext_optiq_sbe_v4_10.order_clearing_fields_group.size =
  euronext_optiq_sbe_v4_10.clearing_firm_id.size + 
  euronext_optiq_sbe_v4_10.client_id.size + 
  euronext_optiq_sbe_v4_10.account_number.size + 
  euronext_optiq_sbe_v4_10.technical_origin.size + 
...
euronext_optiq_sbe_v4_10.order_clearing_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Clearing Fields Group
euronext_optiq_sbe_v4_10.order_clearing_fields_group.fields = function(buffer, offset, packet, parent, order_clearing_fields_group_index)
  local index = offset
  ...
  if order_clearing_fields_group_index ~= nil and show.order_clearing_fields_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_clearing_fields_group_index, order_clearing_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.order_clearing_fields_group.dissect = function(buffer, offset, packet, parent, order_clearing_fields_group_index)
  if show.order_clearing_fields_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_clearing_fields_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.order_clearing_fields_group.fields(buffer, offset, packet, parent, order_clearing_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.order_clearing_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.order_clearing_fields_group.fields(buffer, offset, packet, parent, order_clearing_fields_group_index)
  end
end

-- Order Clearing Fields Groups
euronext_optiq_sbe_v4_10.order_clearing_fields_groups = {}

-- Calculate size of: Order Clearing Fields Groups
euronext_optiq_sbe_v4_10.order_clearing_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.order_clearing_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Clearing Fields Groups
euronext_optiq_sbe_v4_10.order_clearing_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for order_clearing_fields_group_index = 1, num_in_group do
    index, order_clearing_fields_group = euronext_optiq_sbe_v4_10.order_clearing_fields_group.dissect(buffer, index, packet, parent, order_clearing_fields_group_index)
  end
...
euronext_optiq_sbe_v4_10.order_clearing_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.order_clearing_fields_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_clearing_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.order_clearing_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.order_clearing_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.order_clearing_fields_groups.fields(buffer, offset, packet, parent)
  end
end

-- Order Optional Fields Group
euronext_optiq_sbe_v4_10.order_optional_fields_group = {}

-- Size: Order Optional Fields Group
euronext_optiq_sbe_v4_10.order_optional_fields_group.size =
  euronext_optiq_sbe_v4_10.stop_px.size + 
  euronext_optiq_sbe_v4_10.undisclosed_price.size + 
  euronext_optiq_sbe_v4_10.disclosed_qty.size + 
  euronext_optiq_sbe_v4_10.min_order_qty.size + 
...
euronext_optiq_sbe_v4_10.order_optional_fields_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Optional Fields Group
euronext_optiq_sbe_v4_10.order_optional_fields_group.fields = function(buffer, offset, packet, parent, order_optional_fields_group_index)
  local index = offset
  ...
  if order_optional_fields_group_index ~= nil and show.order_optional_fields_group_index then
    local iteration = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_optional_fields_group_index, order_optional_fields_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_sbe_v4_10.order_optional_fields_group.dissect = function(buffer, offset, packet, parent, order_optional_fields_group_index)
  if show.order_optional_fields_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_optional_fields_group, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.order_optional_fields_group.fields(buffer, offset, packet, parent, order_optional_fields_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.order_optional_fields_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.order_optional_fields_group.fields(buffer, offset, packet, parent, order_optional_fields_group_index)
  end
end

-- Order Optional Fields Groups
euronext_optiq_sbe_v4_10.order_optional_fields_groups = {}

-- Calculate size of: Order Optional Fields Groups
euronext_optiq_sbe_v4_10.order_optional_fields_groups.size = function(buffer, offset)
  local index = 0
...
euronext_optiq_sbe_v4_10.order_optional_fields_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Optional Fields Groups
euronext_optiq_sbe_v4_10.order_optional_fields_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for order_optional_fields_group_index = 1, num_in_group do
    index, order_optional_fields_group = euronext_optiq_sbe_v4_10.order_optional_fields_group.dissect(buffer, index, packet, parent, order_optional_fields_group_index)
  end
...
euronext_optiq_sbe_v4_10.order_optional_fields_groups.dissect = function(buffer, offset, packet, parent)
  if show.order_optional_fields_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.order_optional_fields_groups, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.order_optional_fields_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.order_optional_fields_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return euronext_optiq_sbe_v4_10.order_optional_fields_groups.fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_sbe_v4_10.new_order_message.size = function(buffer, offset)
  ...
  index = index + euronext_optiq_sbe_v4_10.order_optional_fields_groups.size(buffer, offset + index)

  index = index + euronext_optiq_sbe_v4_10.order_clearing_fields_groups.size(buffer, offset + index)
...
euronext_optiq_sbe_v4_10.new_order_message.fields = function(buffer, offset, packet, parent)
  ...
  index, order_optional_fields_groups = euronext_optiq_sbe_v4_10.order_optional_fields_groups.dissect(buffer, index, packet, parent)

  -- Order Clearing Fields Groups: Struct of 2 fields
  index, order_clearing_fields_groups = euronext_optiq_sbe_v4_10.order_clearing_fields_groups.dissect(buffer, index, packet, parent)
...
euronext_optiq_sbe_v4_10.new_order_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.new_order_message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.new_order_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.new_order_message.display(packet, parent, length)
    parent:append_text(display)
...
euronext_optiq_sbe_v4_10.message.dissect = function(buffer, offset, packet, parent)
  if show.message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_euronext_optiq_sbe_v4_10.fields.message, buffer(offset, 0))
    local index = euronext_optiq_sbe_v4_10.message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = euronext_optiq_sbe_v4_10.message.display(packet, parent, length)
    parent:append_text(display)
