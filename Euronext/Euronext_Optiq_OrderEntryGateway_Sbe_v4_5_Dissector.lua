...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.group_size_encoding = function(buffer, offset, packet, parent)
  if show.group_size_encoding then
    ...
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.group_size_encoding, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.group_size_encoding_fields(buffer, offset, packet, element)
    ...
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.group_size_encoding_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.not_used_group_1_groups_fields = function(buffer, offset, packet, parent)
  ...
  for not_used_group_1_group_index = 1, num_in_group do
    index, not_used_group_1_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.not_used_group_1_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.fund_price_input_ack_message = function(buffer, offset, packet, parent)
  if show.fund_price_input_ack_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.fund_price_input_ack_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.fund_price_input_ack_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.fund_price_input_ack_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.fund_price_input_message = function(buffer, offset, packet, parent)
  if show.fund_price_input_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.fund_price_input_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.fund_price_input_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.fund_price_input_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.declaration_cancel_and_refusal_message = function(buffer, offset, packet, parent)
  if show.declaration_cancel_and_refusal_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.declaration_cancel_and_refusal_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.declaration_cancel_and_refusal_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.declaration_cancel_and_refusal_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.not_used_group_2_groups_fields = function(buffer, offset, packet, parent)
  ...
  for not_used_group_2_group_index = 1, num_in_group do
    index, not_used_group_2_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.not_used_group_2_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.technical_reject_message = function(buffer, offset, packet, parent)
  if show.technical_reject_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.technical_reject_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.technical_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.technical_reject_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logout_message = function(buffer, offset, packet, parent)
  if show.logout_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.logout_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logout_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logout_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_reject_message = function(buffer, offset, packet, parent)
  if show.logon_reject_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.logon_reject_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_reject_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_ack_message = function(buffer, offset, packet, parent)
  if show.logon_ack_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.logon_ack_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_ack_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_ack_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_message = function(buffer, offset, packet, parent)
  if show.logon_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.logon_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.logon_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wave_for_liquidity_notification_message = function(buffer, offset, packet, parent)
  if show.wave_for_liquidity_notification_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wave_for_liquidity_notification_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wave_for_liquidity_notification_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wave_for_liquidity_notification_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wave_for_liquidity_message = function(buffer, offset, packet, parent)
  if show.wave_for_liquidity_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wave_for_liquidity_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wave_for_liquidity_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wave_for_liquidity_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_counterparts_group = function(buffer, offset, packet, parent)
  if show.rfq_counterparts_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.rfq_counterparts_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_counterparts_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_counterparts_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_counterparts_groups_fields = function(buffer, offset, packet, parent)
  ...
  for rfq_counterparts_group_index = 1, num_in_group do
    index, rfq_counterparts_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_counterparts_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_fields_group = function(buffer, offset, packet, parent)
  if show.strategy_fields_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.strategy_fields_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_fields_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_fields_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for strategy_fields_group_index = 1, num_in_group do
    index, strategy_fields_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_fields_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_x_group = function(buffer, offset, packet, parent)
  if show.clearing_fields_x_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.clearing_fields_x_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_x_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_x_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_x_groups_fields = function(buffer, offset, packet, parent)
  ...
  for clearing_fields_x_group_index = 1, num_in_group do
    index, clearing_fields_x_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_x_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_short_codes_group = function(buffer, offset, packet, parent)
  if show.mifid_short_codes_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mifid_short_codes_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_short_codes_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_short_codes_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_short_codes_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mifid_short_codes_group_index = 1, num_in_group do
    index, mifid_short_codes_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_short_codes_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.free_text_section_group = function(buffer, offset, packet, parent)
  if show.free_text_section_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.free_text_section_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.free_text_section_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.free_text_section_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.free_text_section_groups_fields = function(buffer, offset, packet, parent)
  ...
  for free_text_section_group_index = 1, num_in_group do
    index, free_text_section_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.free_text_section_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.request_for_implied_execution_message = function(buffer, offset, packet, parent)
  if show.request_for_implied_execution_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.request_for_implied_execution_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.request_for_implied_execution_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.request_for_implied_execution_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_clearing_rep_group = function(buffer, offset, packet, parent)
  if show.wholesale_ack_clearing_rep_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_ack_clearing_rep_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_clearing_rep_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_clearing_rep_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_clearing_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_ack_clearing_rep_group_index = 1, num_in_group do
    index, wholesale_ack_clearing_rep_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_clearing_rep_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_legs_rep_group = function(buffer, offset, packet, parent)
  if show.wholesale_ack_legs_rep_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_ack_legs_rep_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_legs_rep_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_legs_rep_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_legs_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_ack_legs_rep_group_index = 1, num_in_group do
    index, wholesale_ack_legs_rep_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_legs_rep_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_client_rep_group = function(buffer, offset, packet, parent)
  if show.wholesale_client_rep_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_client_rep_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_client_rep_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_client_rep_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_client_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_client_rep_group_index = 1, num_in_group do
    index, wholesale_client_rep_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_client_rep_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_legs_rep_group = function(buffer, offset, packet, parent)
  if show.wholesale_legs_rep_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_legs_rep_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_legs_rep_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_legs_rep_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_legs_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_legs_rep_group_index = 1, num_in_group do
    index, wholesale_legs_rep_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_legs_rep_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section2_group = function(buffer, offset, packet, parent)
  if show.mmp_section2_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mmp_section2_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section2_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section2_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section2_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mmp_section2_group_index = 1, num_in_group do
    index, mmp_section2_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section2_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section_group = function(buffer, offset, packet, parent)
  if show.mmp_section_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mmp_section_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mmp_section_group_index = 1, num_in_group do
    index, mmp_section_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.security_definition_ack_message = function(buffer, offset, packet, parent)
  if show.security_definition_ack_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.security_definition_ack_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.security_definition_ack_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.security_definition_ack_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_legs_group = function(buffer, offset, packet, parent)
  if show.strategy_legs_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.strategy_legs_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_legs_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_legs_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_legs_groups_fields = function(buffer, offset, packet, parent)
  ...
  for strategy_legs_group_index = 1, num_in_group do
    index, strategy_legs_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_legs_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.synchronization_time_message = function(buffer, offset, packet, parent)
  if show.synchronization_time_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.synchronization_time_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.synchronization_time_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.synchronization_time_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.instrument_synchronization_section_group = function(buffer, offset, packet, parent)
  if show.instrument_synchronization_section_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.instrument_synchronization_section_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.instrument_synchronization_section_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.instrument_synchronization_section_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.instrument_synchronization_section_groups_fields = function(buffer, offset, packet, parent)
  ...
  for instrument_synchronization_section_group_index = 1, num_in_group do
    index, instrument_synchronization_section_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.instrument_synchronization_section_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mm_sign_in_ack_message = function(buffer, offset, packet, parent)
  if show.mm_sign_in_ack_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mm_sign_in_ack_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mm_sign_in_ack_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mm_sign_in_ack_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mm_sign_in_message = function(buffer, offset, packet, parent)
  if show.mm_sign_in_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mm_sign_in_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mm_sign_in_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mm_sign_in_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfqlp_matching_status_message = function(buffer, offset, packet, parent)
  if show.rfqlp_matching_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.rfqlp_matching_status_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfqlp_matching_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfqlp_matching_status_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_matching_status_message = function(buffer, offset, packet, parent)
  if show.rfq_matching_status_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.rfq_matching_status_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_matching_status_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_matching_status_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_notification_message = function(buffer, offset, packet, parent)
  if show.rfq_notification_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.rfq_notification_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_notification_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_notification_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.request_for_execution_message = function(buffer, offset, packet, parent)
  if show.request_for_execution_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.request_for_execution_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.request_for_execution_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.request_for_execution_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ask_for_quote_message = function(buffer, offset, packet, parent)
  if show.ask_for_quote_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.ask_for_quote_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ask_for_quote_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ask_for_quote_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.liquidity_provider_command_message = function(buffer, offset, packet, parent)
  if show.liquidity_provider_command_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.liquidity_provider_command_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.liquidity_provider_command_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.liquidity_provider_command_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.price_input_message = function(buffer, offset, packet, parent)
  if show.price_input_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.price_input_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.price_input_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.price_input_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_breach_confirmation_message = function(buffer, offset, packet, parent)
  if show.collar_breach_confirmation_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.collar_breach_confirmation_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_breach_confirmation_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_breach_confirmation_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.trade_bust_notification_message = function(buffer, offset, packet, parent)
  if show.trade_bust_notification_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.trade_bust_notification_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.trade_bust_notification_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.trade_bust_notification_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ownership_request_message = function(buffer, offset, packet, parent)
  if show.ownership_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.ownership_request_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ownership_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ownership_request_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ownership_request_ack_message = function(buffer, offset, packet, parent)
  if show.ownership_request_ack_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.ownership_request_ack_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ownership_request_ack_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.ownership_request_ack_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.open_order_request_message = function(buffer, offset, packet, parent)
  if show.open_order_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.open_order_request_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.open_order_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.open_order_request_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_fields_group = function(buffer, offset, packet, parent)
  if show.mifid_fields_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mifid_fields_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_fields_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_fields_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mifid_fields_group_index = 1, num_in_group do
    index, mifid_fields_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_fields_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_request_message = function(buffer, offset, packet, parent)
  if show.quote_request_message then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.quote_request_message, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_request_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_request_message_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_acks_group = function(buffer, offset, packet, parent)
  if show.quote_acks_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.quote_acks_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_acks_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_acks_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_acks_groups_fields = function(buffer, offset, packet, parent)
  ...
  for quote_acks_group_index = 1, num_in_group do
    index, quote_acks_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_acks_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quotes_rep_group = function(buffer, offset, packet, parent)
  if show.quotes_rep_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.quotes_rep_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quotes_rep_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quotes_rep_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quotes_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for quotes_rep_group_index = 1, num_in_group do
    index, quotes_rep_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quotes_rep_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_dataset_group = function(buffer, offset, packet, parent)
  if show.clearing_dataset_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.clearing_dataset_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_dataset_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_dataset_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_dataset_groups_fields = function(buffer, offset, packet, parent)
  ...
  for clearing_dataset_group_index = 1, num_in_group do
    index, clearing_dataset_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_dataset_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_fields_group = function(buffer, offset, packet, parent)
  if show.collar_fields_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.collar_fields_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_fields_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_fields_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for collar_fields_group_index = 1, num_in_group do
    index, collar_fields_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_fields_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.additional_infos_group = function(buffer, offset, packet, parent)
  if show.additional_infos_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.additional_infos_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.additional_infos_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.additional_infos_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.additional_infos_groups_fields = function(buffer, offset, packet, parent)
  ...
  for additional_infos_group_index = 1, num_in_group do
    index, additional_infos_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.additional_infos_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_group = function(buffer, offset, packet, parent)
  if show.clearing_fields_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.clearing_fields_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for clearing_fields_group_index = 1, num_in_group do
    index, clearing_fields_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_group = function(buffer, offset, packet, parent)
  if show.optional_fields_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.optional_fields_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for optional_fields_group_index = 1, num_in_group do
    index, optional_fields_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_derivatives_group = function(buffer, offset, packet, parent)
  if show.optional_fields_derivatives_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.optional_fields_derivatives_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_derivatives_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_derivatives_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_derivatives_groups_fields = function(buffer, offset, packet, parent)
  ...
  for optional_fields_derivatives_group_index = 1, num_in_group do
    index, optional_fields_derivatives_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_derivatives_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_fill_group = function(buffer, offset, packet, parent)
  if show.optional_fields_fill_group then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.optional_fields_fill_group, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_fill_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_fill_group_fields(buffer, offset, packet, element)
  end
end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_fill_groups_fields = function(buffer, offset, packet, parent)
  ...
  for optional_fields_fill_group_index = 1, num_in_group do
    index, optional_fields_fill_group = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_fill_group(buffer, index, packet, parent)
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    local element = parent:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.message_header, buffer(offset, 0))
    local index = euronext_optiq_orderentrygateway_sbe_v4_5_dissect.message_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_orderentrygateway_sbe_v4_5_dissect.message_header_fields(buffer, offset, packet, element)
  end
end
