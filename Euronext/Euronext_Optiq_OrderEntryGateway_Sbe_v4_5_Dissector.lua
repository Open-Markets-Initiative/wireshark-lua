...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.not_used_group_1_groups_fields = function(buffer, offset, packet, parent)
  ...
  for not_used_group_1_group_index = 1, num_in_group do
    ...
    if not_used_group_1_group ~= nil then
      local iteration = not_used_group_1_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.not_used_group_1_group_index, not_used_group_1_group_index)
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.not_used_group_2_groups_fields = function(buffer, offset, packet, parent)
  ...
  for not_used_group_2_group_index = 1, num_in_group do
    ...
    if not_used_group_2_group ~= nil then
      local iteration = not_used_group_2_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.not_used_group_2_group_index, not_used_group_2_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.rfq_counterparts_groups_fields = function(buffer, offset, packet, parent)
  ...
  for rfq_counterparts_group_index = 1, num_in_group do
    ...
    if rfq_counterparts_group ~= nil then
      local iteration = rfq_counterparts_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.rfq_counterparts_group_index, rfq_counterparts_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for strategy_fields_group_index = 1, num_in_group do
    ...
    if strategy_fields_group ~= nil then
      local iteration = strategy_fields_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.strategy_fields_group_index, strategy_fields_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_x_groups_fields = function(buffer, offset, packet, parent)
  ...
  for clearing_fields_x_group_index = 1, num_in_group do
    ...
    if clearing_fields_x_group ~= nil then
      local iteration = clearing_fields_x_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.clearing_fields_x_group_index, clearing_fields_x_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_short_codes_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mifid_short_codes_group_index = 1, num_in_group do
    ...
    if mifid_short_codes_group ~= nil then
      local iteration = mifid_short_codes_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mifid_short_codes_group_index, mifid_short_codes_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.free_text_section_groups_fields = function(buffer, offset, packet, parent)
  ...
  for free_text_section_group_index = 1, num_in_group do
    ...
    if free_text_section_group ~= nil then
      local iteration = free_text_section_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.free_text_section_group_index, free_text_section_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_clearing_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_ack_clearing_rep_group_index = 1, num_in_group do
    ...
    if wholesale_ack_clearing_rep_group ~= nil then
      local iteration = wholesale_ack_clearing_rep_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_ack_clearing_rep_group_index, wholesale_ack_clearing_rep_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_ack_legs_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_ack_legs_rep_group_index = 1, num_in_group do
    ...
    if wholesale_ack_legs_rep_group ~= nil then
      local iteration = wholesale_ack_legs_rep_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_ack_legs_rep_group_index, wholesale_ack_legs_rep_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_client_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_client_rep_group_index = 1, num_in_group do
    ...
    if wholesale_client_rep_group ~= nil then
      local iteration = wholesale_client_rep_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_client_rep_group_index, wholesale_client_rep_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.wholesale_legs_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for wholesale_legs_rep_group_index = 1, num_in_group do
    ...
    if wholesale_legs_rep_group ~= nil then
      local iteration = wholesale_legs_rep_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.wholesale_legs_rep_group_index, wholesale_legs_rep_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section2_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mmp_section2_group_index = 1, num_in_group do
    ...
    if mmp_section2_group ~= nil then
      local iteration = mmp_section2_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mmp_section2_group_index, mmp_section2_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mmp_section_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mmp_section_group_index = 1, num_in_group do
    ...
    if mmp_section_group ~= nil then
      local iteration = mmp_section_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mmp_section_group_index, mmp_section_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.strategy_legs_groups_fields = function(buffer, offset, packet, parent)
  ...
  for strategy_legs_group_index = 1, num_in_group do
    ...
    if strategy_legs_group ~= nil then
      local iteration = strategy_legs_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.strategy_legs_group_index, strategy_legs_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.instrument_synchronization_section_groups_fields = function(buffer, offset, packet, parent)
  ...
  for instrument_synchronization_section_group_index = 1, num_in_group do
    ...
    if instrument_synchronization_section_group ~= nil then
      local iteration = instrument_synchronization_section_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.instrument_synchronization_section_group_index, instrument_synchronization_section_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.mifid_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for mifid_fields_group_index = 1, num_in_group do
    ...
    if mifid_fields_group ~= nil then
      local iteration = mifid_fields_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.mifid_fields_group_index, mifid_fields_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quote_acks_groups_fields = function(buffer, offset, packet, parent)
  ...
  for quote_acks_group_index = 1, num_in_group do
    ...
    if quote_acks_group ~= nil then
      local iteration = quote_acks_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.quote_acks_group_index, quote_acks_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.quotes_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for quotes_rep_group_index = 1, num_in_group do
    ...
    if quotes_rep_group ~= nil then
      local iteration = quotes_rep_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.quotes_rep_group_index, quotes_rep_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_dataset_groups_fields = function(buffer, offset, packet, parent)
  ...
  for clearing_dataset_group_index = 1, num_in_group do
    ...
    if clearing_dataset_group ~= nil then
      local iteration = clearing_dataset_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.clearing_dataset_group_index, clearing_dataset_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.collar_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for collar_fields_group_index = 1, num_in_group do
    ...
    if collar_fields_group ~= nil then
      local iteration = collar_fields_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.collar_fields_group_index, collar_fields_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.additional_infos_groups_fields = function(buffer, offset, packet, parent)
  ...
  for additional_infos_group_index = 1, num_in_group do
    ...
    if additional_infos_group ~= nil then
      local iteration = additional_infos_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.additional_infos_group_index, additional_infos_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.clearing_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for clearing_fields_group_index = 1, num_in_group do
    ...
    if clearing_fields_group ~= nil then
      local iteration = clearing_fields_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.clearing_fields_group_index, clearing_fields_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_groups_fields = function(buffer, offset, packet, parent)
  ...
  for optional_fields_group_index = 1, num_in_group do
    ...
    if optional_fields_group ~= nil then
      local iteration = optional_fields_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.optional_fields_group_index, optional_fields_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_derivatives_groups_fields = function(buffer, offset, packet, parent)
  ...
  for optional_fields_derivatives_group_index = 1, num_in_group do
    ...
    if optional_fields_derivatives_group ~= nil then
      local iteration = optional_fields_derivatives_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.optional_fields_derivatives_group_index, optional_fields_derivatives_group_index)
      iteration:set_generated()
    end
  end
...
euronext_optiq_orderentrygateway_sbe_v4_5_dissect.optional_fields_fill_groups_fields = function(buffer, offset, packet, parent)
  ...
  for optional_fields_fill_group_index = 1, num_in_group do
    ...
    if optional_fields_fill_group ~= nil then
      local iteration = optional_fields_fill_group:add(euronext_optiq_orderentrygateway_sbe_v4_5.fields.optional_fields_fill_group_index, optional_fields_fill_group_index)
      iteration:set_generated()
    end
  end
