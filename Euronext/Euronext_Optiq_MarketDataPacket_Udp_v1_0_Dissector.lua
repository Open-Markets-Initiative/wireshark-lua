...
omi_euronext_optiq_marketdatapacket_udp_v1_0.fields.compression = ProtoField.new("Compression", "euronext.optiq.marketdatapacket.udp.v1.0.compression", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0001)
...
omi_euronext_optiq_marketdatapacket_udp_v1_0.fields.has_end_of_day_snapshot = ProtoField.new("Has End Of Day Snapshot", "euronext.optiq.marketdatapacket.udp.v1.0.hasendofdaysnapshot", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0100)
omi_euronext_optiq_marketdatapacket_udp_v1_0.fields.has_start_of_day_snapshot = ProtoField.new("Has Start Of Day Snapshot", "euronext.optiq.marketdatapacket.udp.v1.0.hasstartofdaysnapshot", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0080)
omi_euronext_optiq_marketdatapacket_udp_v1_0.fields.has_status_message = ProtoField.new("Has Status Message", "euronext.optiq.marketdatapacket.udp.v1.0.hasstatusmessage", ftypes.UINT16, {[1]="Yes",[0]="No"}, base.DEC, 0x0200)
