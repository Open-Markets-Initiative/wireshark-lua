...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_snapshot_message = function(buffer, offset, packet, parent)
  if show.end_of_snapshot_message then
    ...
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.end_of_snapshot_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_snapshot_message = function(buffer, offset, packet, parent)
  if show.start_of_snapshot_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.start_of_snapshot_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_instrument_suspension_message = function(buffer, offset, packet, parent)
  if show.bf_instrument_suspension_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.bf_instrument_suspension_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bfnav_message = function(buffer, offset, packet, parent)
  if show.bfnav_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.bfnav_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_trade_message = function(buffer, offset, packet, parent)
  if show.bf_trade_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.bf_trade_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_group_fields = function(buffer, offset, packet, parent, interest_payment_date_rep_group_index)
  ...
  if interest_payment_date_rep_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.interest_payment_date_rep_group_index, interest_payment_date_rep_group_index)
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_group = function(buffer, offset, packet, parent, interest_payment_date_rep_group_index)
  if show.interest_payment_date_rep_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.interest_payment_date_rep_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.group_size_encoding = function(buffer, offset, packet, parent)
  if show.group_size_encoding then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.group_size_encoding, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_full_trade_information_message = function(buffer, offset, packet, parent)
  if show.apa_full_trade_information_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.apa_full_trade_information_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_standing_data_message = function(buffer, offset, packet, parent)
  if show.apa_standing_data_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.apa_standing_data_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_quotes_message = function(buffer, offset, packet, parent)
  if show.apa_quotes_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.apa_quotes_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_group_fields = function(buffer, offset, packet, parent, package_components_group_index)
  ...
  if package_components_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.package_components_group_index, package_components_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_group = function(buffer, offset, packet, parent, package_components_group_index)
  if show.package_components_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.package_components_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_group_fields = function(buffer, offset, packet, parent, orders_group_index)
  ...
  if orders_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.orders_group_index, orders_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_group = function(buffer, offset, packet, parent, orders_group_index)
  if show.orders_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.orders_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_group_fields = function(buffer, offset, packet, parent, outright_rep_group_index)
  ...
  if outright_rep_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.outright_rep_group_index, outright_rep_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_group = function(buffer, offset, packet, parent, outright_rep_group_index)
  if show.outright_rep_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.outright_rep_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_group_fields = function(buffer, offset, packet, parent, contract_emm_properties_group_index)
  ...
  if contract_emm_properties_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.contract_emm_properties_group_index, contract_emm_properties_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_group = function(buffer, offset, packet, parent, contract_emm_properties_group_index)
  if show.contract_emm_properties_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.contract_emm_properties_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_group_fields = function(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  ...
  if strategy_standing_datarep_1_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.strategy_standing_datarep_1_group_index, strategy_standing_datarep_1_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_group = function(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  if show.strategy_standing_datarep_1_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.strategy_standing_datarep_1_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.index_summary_message = function(buffer, offset, packet, parent)
  if show.index_summary_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.index_summary_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_group_fields = function(buffer, offset, packet, parent, new_stats_group_index)
  ...
  if new_stats_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.new_stats_group_index, new_stats_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_group = function(buffer, offset, packet, parent, new_stats_group_index)
  if show.new_stats_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.new_stats_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.real_time_index_message = function(buffer, offset, packet, parent)
  if show.real_time_index_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.real_time_index_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_group_fields = function(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  ...
  if em_m_pattern_rep_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.em_m_pattern_rep_group_index, em_m_pattern_rep_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_group = function(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  if show.em_m_pattern_rep_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.em_m_pattern_rep_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_group_fields = function(buffer, offset, packet, parent, timetables_group_index)
  ...
  if timetables_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.timetables_group_index, timetables_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_group = function(buffer, offset, packet, parent, timetables_group_index)
  if show.timetables_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.timetables_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_group_fields = function(buffer, offset, packet, parent, market_states_group_index)
  ...
  if market_states_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.market_states_group_index, market_states_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_group = function(buffer, offset, packet, parent, market_states_group_index)
  if show.market_states_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.market_states_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_group_fields = function(buffer, offset, packet, parent, prices_group_index)
  ...
  if prices_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.prices_group_index, prices_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_group = function(buffer, offset, packet, parent, prices_group_index)
  if show.prices_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.prices_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_group_fields = function(buffer, offset, packet, parent, updates_group_index)
  ...
  if updates_group_index ~= nil then
    local iteration = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.updates_group_index, updates_group_index)
    iteration:set_generated()
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_group = function(buffer, offset, packet, parent, updates_group_index)
  if show.updates_group then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.updates_group, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.technical_notification_message = function(buffer, offset, packet, parent)
  if show.technical_notification_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.technical_notification_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.health_status_message = function(buffer, offset, packet, parent)
  if show.health_status_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.health_status_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_day_message = function(buffer, offset, packet, parent)
  if show.end_of_day_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.end_of_day_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_day_message = function(buffer, offset, packet, parent)
  if show.start_of_day_message then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.start_of_day_message, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.message_header, buffer(offset, 0))
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_data_packet_header = function(buffer, offset, packet, parent)
  if show.market_data_packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(euronext_optiq_marketdatagateway_sbe_v5_39.fields.market_data_packet_header, buffer(offset, 0))
