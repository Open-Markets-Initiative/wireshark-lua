...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_snapshot_message = function(buffer, offset, packet, parent)
  if show.end_of_snapshot_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_snapshot_message_fields(buffer, offset, packet, parent)
    ...
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_snapshot_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_snapshot_message = function(buffer, offset, packet, parent)
  if show.start_of_snapshot_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_snapshot_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_snapshot_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_instrument_suspension_message = function(buffer, offset, packet, parent)
  if show.bf_instrument_suspension_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_instrument_suspension_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_instrument_suspension_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bfnav_message = function(buffer, offset, packet, parent)
  if show.bfnav_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bfnav_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bfnav_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_trade_message = function(buffer, offset, packet, parent)
  if show.bf_trade_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_trade_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.bf_trade_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_group_fields = function(buffer, offset, packet, parent, interest_payment_date_rep_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_group = function(buffer, offset, packet, parent, interest_payment_date_rep_group_index)
  if show.interest_payment_date_rep_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_group_fields(buffer, offset, packet, parent, interest_payment_date_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_group_fields(buffer, offset, packet, parent, interest_payment_date_rep_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.group_size_encoding = function(buffer, offset, packet, parent)
  if show.group_size_encoding then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.group_size_encoding_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.group_size_encoding_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for interest_payment_date_rep_group_index = 1, num_in_group do
    index, interest_payment_date_rep_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.interest_payment_date_rep_group(buffer, index, packet, parent, interest_payment_date_rep_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_full_trade_information_message = function(buffer, offset, packet, parent)
  if show.apa_full_trade_information_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_full_trade_information_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_full_trade_information_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_standing_data_message = function(buffer, offset, packet, parent)
  if show.apa_standing_data_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_standing_data_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_standing_data_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_quotes_message = function(buffer, offset, packet, parent)
  if show.apa_quotes_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_quotes_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.apa_quotes_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_group_fields = function(buffer, offset, packet, parent, package_components_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_group = function(buffer, offset, packet, parent, package_components_group_index)
  if show.package_components_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_group_fields(buffer, offset, packet, parent, package_components_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_group_fields(buffer, offset, packet, parent, package_components_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_groups_fields = function(buffer, offset, packet, parent)
  ...
  for package_components_group_index = 1, num_in_group do
    index, package_components_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.package_components_group(buffer, index, packet, parent, package_components_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_group_fields = function(buffer, offset, packet, parent, orders_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_group = function(buffer, offset, packet, parent, orders_group_index)
  if show.orders_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_group_fields(buffer, offset, packet, parent, orders_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_group_fields(buffer, offset, packet, parent, orders_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_groups_fields = function(buffer, offset, packet, parent)
  ...
  for orders_group_index = 1, num_in_group do
    index, orders_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.orders_group(buffer, index, packet, parent, orders_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_group_fields = function(buffer, offset, packet, parent, outright_rep_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_group = function(buffer, offset, packet, parent, outright_rep_group_index)
  if show.outright_rep_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_group_fields(buffer, offset, packet, parent, outright_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_group_fields(buffer, offset, packet, parent, outright_rep_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for outright_rep_group_index = 1, num_in_group do
    index, outright_rep_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.outright_rep_group(buffer, index, packet, parent, outright_rep_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_group_fields = function(buffer, offset, packet, parent, contract_emm_properties_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_group = function(buffer, offset, packet, parent, contract_emm_properties_group_index)
  if show.contract_emm_properties_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_group_fields(buffer, offset, packet, parent, contract_emm_properties_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_group_fields(buffer, offset, packet, parent, contract_emm_properties_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_groups_fields = function(buffer, offset, packet, parent)
  ...
  for contract_emm_properties_group_index = 1, num_in_group do
    index, contract_emm_properties_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.contract_emm_properties_group(buffer, index, packet, parent, contract_emm_properties_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_group_fields = function(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_group = function(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  if show.strategy_standing_datarep_1_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_group_fields(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_group_fields(buffer, offset, packet, parent, strategy_standing_datarep_1_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_groups_fields = function(buffer, offset, packet, parent)
  ...
  for strategy_standing_datarep_1_group_index = 1, num_in_group do
    index, strategy_standing_datarep_1_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.strategy_standing_datarep_1_group(buffer, index, packet, parent, strategy_standing_datarep_1_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.index_summary_message = function(buffer, offset, packet, parent)
  if show.index_summary_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.index_summary_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.index_summary_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_group_fields = function(buffer, offset, packet, parent, new_stats_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_group = function(buffer, offset, packet, parent, new_stats_group_index)
  if show.new_stats_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_group_fields(buffer, offset, packet, parent, new_stats_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_group_fields(buffer, offset, packet, parent, new_stats_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_groups_fields = function(buffer, offset, packet, parent)
  ...
  for new_stats_group_index = 1, num_in_group do
    index, new_stats_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.new_stats_group(buffer, index, packet, parent, new_stats_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.real_time_index_message = function(buffer, offset, packet, parent)
  if show.real_time_index_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.real_time_index_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.real_time_index_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_group_fields = function(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_group = function(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  if show.em_m_pattern_rep_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_group_fields(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_group_fields(buffer, offset, packet, parent, em_m_pattern_rep_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_groups_fields = function(buffer, offset, packet, parent)
  ...
  for em_m_pattern_rep_group_index = 1, num_in_group do
    index, em_m_pattern_rep_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.em_m_pattern_rep_group(buffer, index, packet, parent, em_m_pattern_rep_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_group_fields = function(buffer, offset, packet, parent, timetables_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_group = function(buffer, offset, packet, parent, timetables_group_index)
  if show.timetables_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_group_fields(buffer, offset, packet, parent, timetables_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_group_fields(buffer, offset, packet, parent, timetables_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_groups_fields = function(buffer, offset, packet, parent)
  ...
  for timetables_group_index = 1, num_in_group do
    index, timetables_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.timetables_group(buffer, index, packet, parent, timetables_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_group_fields = function(buffer, offset, packet, parent, market_states_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_group = function(buffer, offset, packet, parent, market_states_group_index)
  if show.market_states_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_group_fields(buffer, offset, packet, parent, market_states_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_group_fields(buffer, offset, packet, parent, market_states_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_groups_fields = function(buffer, offset, packet, parent)
  ...
  for market_states_group_index = 1, num_in_group do
    index, market_states_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_states_group(buffer, index, packet, parent, market_states_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.not_used_group_1_groups_fields = function(buffer, offset, packet, parent)
  ...
  for not_used_group_1_group_index = 1, num_in_group do
    index, not_used_group_1_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.not_used_group_1_group(buffer, index, packet, parent, not_used_group_1_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_group_fields = function(buffer, offset, packet, parent, prices_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_group = function(buffer, offset, packet, parent, prices_group_index)
  if show.prices_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_group_fields(buffer, offset, packet, parent, prices_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_group_fields(buffer, offset, packet, parent, prices_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_groups_fields = function(buffer, offset, packet, parent)
  ...
  for prices_group_index = 1, num_in_group do
    index, prices_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.prices_group(buffer, index, packet, parent, prices_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_group_fields = function(buffer, offset, packet, parent, updates_group_index)
  local index = offset
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_group = function(buffer, offset, packet, parent, updates_group_index)
  if show.updates_group then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_group_fields(buffer, offset, packet, parent, updates_group_index)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_group_fields(buffer, offset, packet, parent, updates_group_index)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_groups_fields = function(buffer, offset, packet, parent)
  ...
  for updates_group_index = 1, num_in_group do
    index, updates_group = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.updates_group(buffer, index, packet, parent, updates_group_index)
  end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.technical_notification_message = function(buffer, offset, packet, parent)
  if show.technical_notification_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.technical_notification_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.technical_notification_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.health_status_message = function(buffer, offset, packet, parent)
  if show.health_status_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.health_status_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.health_status_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_day_message = function(buffer, offset, packet, parent)
  if show.end_of_day_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_day_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.end_of_day_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_day_message = function(buffer, offset, packet, parent)
  if show.start_of_day_message then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_day_message_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.start_of_day_message_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.message_header_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.message_header_fields(buffer, offset, packet, parent)
  end
end
...
euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_data_packet_header = function(buffer, offset, packet, parent)
  if show.market_data_packet_header then
    ...
    local index = euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_data_packet_header_fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    ...
    -- Skip element, add fields directly
    return euronext_optiq_marketdatagateway_sbe_v5_39_dissect.market_data_packet_header_fields(buffer, offset, packet, parent)
  end
end
