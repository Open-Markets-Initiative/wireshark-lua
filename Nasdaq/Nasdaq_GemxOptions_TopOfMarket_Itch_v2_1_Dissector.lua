...
udp_table:add(65333, omi_nasdaq_gemxoptions_topofmarket_itch_v2_1)
...
-- Dissector Heuristic for Nasdaq GemxOptions TopOfMarket Itch 2.1
local function omi_nasdaq_gemxoptions_topofmarket_itch_v2_1_heuristic(buffer, packet, parent)
...
omi_nasdaq_gemxoptions_topofmarket_itch_v2_1:register_heuristic("udp", omi_nasdaq_gemxoptions_topofmarket_itch_v2_1_heuristic)
