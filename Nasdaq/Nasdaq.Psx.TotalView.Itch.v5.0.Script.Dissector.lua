...
nasdaq_psx_totalview_itch_v5_0.fields.operational_halt_action = ProtoField.new("Operational Halt Action", "nasdaq.psx.totalview.itch.v5.0.operationalhaltaction", ftypes.INT8, {[1]="Yes",[0]="No"})
