...
nasdaq_ise_orderfeed_itch_v1_1_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
nasdaq_ise_orderfeed_itch_v1_1_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  -- Optionally add struct element to protocol tree
  ...
  nasdaq_ise_orderfeed_itch_v1_1_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
nasdaq_ise_orderfeed_itch_v1_1_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index = nasdaq_ise_orderfeed_itch_v1_1_dissect.message(buffer, index, packet, parent, size_of_message)
  end
