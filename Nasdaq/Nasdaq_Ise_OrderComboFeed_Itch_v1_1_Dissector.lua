...
nasdaq_ise_ordercombofeed_itch_v1_1.fields.explicit_strike_price = ProtoField.new("Explicit Strike Price", "nasdaq.ise.ordercombofeed.itch.v1.1.explicitstrikeprice", ftypes.DOUBLE)
...
nasdaq_ise_ordercombofeed_itch_v1_1.fields.price = ProtoField.new("Price", "nasdaq.ise.ordercombofeed.itch.v1.1.price", ftypes.DOUBLE)
nasdaq_ise_ordercombofeed_itch_v1_1.fields.response_price = ProtoField.new("Response Price", "nasdaq.ise.ordercombofeed.itch.v1.1.responseprice", ftypes.DOUBLE)
...
nasdaq_ise_ordercombofeed_itch_v1_1_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
nasdaq_ise_ordercombofeed_itch_v1_1_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  -- Optionally add struct element to protocol tree
  ...
  nasdaq_ise_ordercombofeed_itch_v1_1_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
nasdaq_ise_ordercombofeed_itch_v1_1_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index = nasdaq_ise_ordercombofeed_itch_v1_1_dissect.message(buffer, index, packet, parent, size_of_message)
  end
...
-- Register Heuristic for Nasdaq Ise OrderComboFeed Itch 1.1
