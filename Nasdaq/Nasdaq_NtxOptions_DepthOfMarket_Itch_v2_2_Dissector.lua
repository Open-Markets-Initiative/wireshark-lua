...
-- Dissector Heuristic for Nasdaq NtxOptions DepthOfMarket Itch 2.2
local function omi_nasdaq_ntxoptions_depthofmarket_itch_v2_2_heuristic(buffer, packet, parent)
...
omi_nasdaq_ntxoptions_depthofmarket_itch_v2_2:register_heuristic("udp", omi_nasdaq_ntxoptions_depthofmarket_itch_v2_2_heuristic)
