...
-- Nasdaq PhlxOptions SpreadDepth 2.1 Application Messages
...
-- Nasdaq PhlxOptions SpreadDepth 2.1 Session Messages
...
-- Dissector Heuristic for Nasdaq PhlxOptions SpreadDepth Itch 2.1
local function omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1_heuristic(buffer, packet, parent)
...
omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1:register_heuristic("tcp", omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1_heuristic)
