...
omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1.fields.client_heartbeat_packet = ProtoField.new("Client Heartbeat Packet", "nasdaq.phlxoptions.spreaddepth.itch.v2.1.clientheartbeatpacket", ftypes.BYTES)
...
omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1.fields.end_of_session_packet = ProtoField.new("End Of Session Packet", "nasdaq.phlxoptions.spreaddepth.itch.v2.1.endofsessionpacket", ftypes.BYTES)
...
omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1.fields.logout_request_packet = ProtoField.new("Logout Request Packet", "nasdaq.phlxoptions.spreaddepth.itch.v2.1.logoutrequestpacket", ftypes.BYTES)
...
omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1.fields.server_heartbeat_packet = ProtoField.new("Server Heartbeat Packet", "nasdaq.phlxoptions.spreaddepth.itch.v2.1.serverheartbeatpacket", ftypes.BYTES)
...
nasdaq_phlxoptions_spreaddepth_itch_v2_1.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_phlxoptions_spreaddepth_itch_v2_1.packet_header.size
end
...
-- Register Nasdaq PhlxOptions SpreadDepth Itch 2.1 on default port
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, omi_nasdaq_phlxoptions_spreaddepth_itch_v2_1)
