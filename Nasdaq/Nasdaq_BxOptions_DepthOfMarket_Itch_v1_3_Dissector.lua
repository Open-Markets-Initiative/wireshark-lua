...
-- Dissect: Message
nasdaq_bxoptions_depthofmarket_itch_v1_3.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_bxoptions_depthofmarket_itch_v1_3.fields.message, range, display)
  end
