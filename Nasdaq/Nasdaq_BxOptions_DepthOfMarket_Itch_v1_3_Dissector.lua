...
-----------------------------------------------------------------------
-- Nasdaq BxOptions DepthOfMarket Itch 1.3 Formatting
-----------------------------------------------------------------------
...
nasdaq_bxoptions_depthofmarket_itch_v1_3.nanoseconds_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_bxoptions_depthofmarket_itch_v1_3.utc_offset_hours = 5
...
omi_nasdaq_bxoptions_depthofmarket_itch_v1_3.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
nasdaq_bxoptions_depthofmarket_itch_v1_3.timestamp.composite = function(buffer, offset, stored_second, packet, parent)
  ...
  local display = nasdaq_bxoptions_depthofmarket_itch_v1_3.timestamp.display(nanoseconds, stored_second, packet)
...
nasdaq_bxoptions_depthofmarket_itch_v1_3.timestamp.dissect = function(buffer, offset, packet, parent)
  local stored_second = nasdaq_bxoptions_depthofmarket_itch_v1_3.second.current
...
nasdaq_bxoptions_depthofmarket_itch_v1_3.seconds_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Store Second Value
  nasdaq_bxoptions_depthofmarket_itch_v1_3.second.current = second

  if not packet.visited then
    nasdaq_bxoptions_depthofmarket_itch_v1_3.conversation.current.second.last = second
  end
...
nasdaq_bxoptions_depthofmarket_itch_v1_3.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_bxoptions_depthofmarket_itch_v1_3.packet_header.size
end

-- Dissect Packet
nasdaq_bxoptions_depthofmarket_itch_v1_3.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nasdaq_bxoptions_depthofmarket_itch_v1_3.conversation.data(packet)
  if not packet.visited then
    data.second.frames[packet.number] = data.second.last
  end
  nasdaq_bxoptions_depthofmarket_itch_v1_3.second.current = data.second.frames[packet.number]
  nasdaq_bxoptions_depthofmarket_itch_v1_3.conversation.current = data
...
-- Dissector Heuristic for Nasdaq BxOptions DepthOfMarket Itch 1.3 (Udp)
local function omi_nasdaq_bxoptions_depthofmarket_itch_v1_3_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_bxoptions_depthofmarket_itch_v1_3:register_heuristic("udp", omi_nasdaq_bxoptions_depthofmarket_itch_v1_3_udp_heuristic)

-- Register Nasdaq BxOptions DepthOfMarket Itch 1.3 on default port
