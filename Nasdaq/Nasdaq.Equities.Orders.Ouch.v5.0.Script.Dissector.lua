...
nasdaq_equities_orders_ouch_v5_0.fields.cancel_order_reason = ProtoField.new("Cancel Order Reason", "nasdaq.equities.orders.ouch.v5.0.cancelorderreason", ftypes.STRING)
...
nasdaq_equities_orders_ouch_v5_0.fields.clordid = ProtoField.new("ClOrdId", "nasdaq.equities.orders.ouch.v5.0.clordid", ftypes.STRING)
...
nasdaq_equities_orders_ouch_v5_0.fields.discretion_peg_offset = ProtoField.new("Discretion Peg Offset", "nasdaq.equities.orders.ouch.v5.0.discretionpegoffset", ftypes.DOUBLE)
...
nasdaq_equities_orders_ouch_v5_0.fields.discretion_price = ProtoField.new("Discretion Price", "nasdaq.equities.orders.ouch.v5.0.discretionprice", ftypes.DOUBLE)
...
nasdaq_equities_orders_ouch_v5_0.fields.display_price = ProtoField.new("Display Price", "nasdaq.equities.orders.ouch.v5.0.displayprice", ftypes.DOUBLE)
...
nasdaq_equities_orders_ouch_v5_0.fields.enter_order_optional_field = ProtoField.new("Enter Order Optional Field", "nasdaq.equities.orders.ouch.v5.0.enterorderoptionalfield", ftypes.INT8)
...
nasdaq_equities_orders_ouch_v5_0.fields.execution_price = ProtoField.new("Execution Price", "nasdaq.equities.orders.ouch.v5.0.executionprice", ftypes.DOUBLE)
...
nasdaq_equities_orders_ouch_v5_0.fields.optional_field_length = ProtoField.new("Optional Field Length", "nasdaq.equities.orders.ouch.v5.0.optionalfieldlength", ftypes.INT8)
...
nasdaq_equities_orders_ouch_v5_0.fields.order_accepted_optional_field = ProtoField.new("Order Accepted Optional Field", "nasdaq.equities.orders.ouch.v5.0.orderacceptedoptionalfield", ftypes.INT8)
...
nasdaq_equities_orders_ouch_v5_0.fields.order_cancel_reason = ProtoField.new("Order Cancel Reason", "nasdaq.equities.orders.ouch.v5.0.ordercancelreason", ftypes.STRING)
...
nasdaq_equities_orders_ouch_v5_0.fields.order_executed_optional_field = ProtoField.new("Order Executed Optional Field", "nasdaq.equities.orders.ouch.v5.0.orderexecutedoptionalfield", ftypes.INT8)
...
nasdaq_equities_orders_ouch_v5_0.fields.order_restated_optional_field = ProtoField.new("Order Restated Optional Field", "nasdaq.equities.orders.ouch.v5.0.orderrestatedoptionalfield", ftypes.INT8)
...
nasdaq_equities_orders_ouch_v5_0.fields.peg_offset = ProtoField.new("Peg Offset", "nasdaq.equities.orders.ouch.v5.0.pegoffset", ftypes.DOUBLE)
...
nasdaq_equities_orders_ouch_v5_0.fields.price = ProtoField.new("Price", "nasdaq.equities.orders.ouch.v5.0.price", ftypes.DOUBLE)
...
nasdaq_equities_orders_ouch_v5_0.fields.reference_price = ProtoField.new("Reference Price", "nasdaq.equities.orders.ouch.v5.0.referenceprice", ftypes.DOUBLE)
...
nasdaq_equities_orders_ouch_v5_0.fields.replace_order_optional_field = ProtoField.new("Replace Order Optional Field", "nasdaq.equities.orders.ouch.v5.0.replaceorderoptionalfield", ftypes.INT8)
...
nasdaq_equities_orders_ouch_v5_0.fields.sequenced_message = ProtoField.new("Sequenced Message", "nasdaq.equities.orders.ouch.v5.0.sequencedmessage", ftypes.STRING)
...
nasdaq_equities_orders_ouch_v5_0.fields.unsequenced_message = ProtoField.new("Unsequenced Message", "nasdaq.equities.orders.ouch.v5.0.unsequencedmessage", ftypes.STRING)
...
nasdaq_equities_orders_ouch_v5_0.prefs.show_sequenced_message = Pref.bool("Show Sequenced Message", show.sequenced_message, "Parse and add Sequenced Message to protocol tree")
nasdaq_equities_orders_ouch_v5_0.prefs.show_unsequenced_message = Pref.bool("Show Unsequenced Message", show.unsequenced_message, "Parse and add Unsequenced Message to protocol tree")
...
function nasdaq_equities_orders_ouch_v5_0.prefs_changed()
  ...
  if show.sequenced_message ~= nasdaq_equities_orders_ouch_v5_0.prefs.show_sequenced_message then
    show.sequenced_message = nasdaq_equities_orders_ouch_v5_0.prefs.show_sequenced_message
    changed = true
  end
  if show.unsequenced_message ~= nasdaq_equities_orders_ouch_v5_0.prefs.show_unsequenced_message then
    show.unsequenced_message = nasdaq_equities_orders_ouch_v5_0.prefs.show_unsequenced_message
    changed = true
  end
...
nasdaq_equities_orders_ouch_v5_0_size_of.replace_order_optional_value = function(buffer, offset, replace_order_optional_field)
  -- Size of Min Qty
...
nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_optional_value_branches = function(buffer, offset, packet, parent, replace_order_optional_field)
  -- Dissect Min Qty
  if replace_order_optional_field == 3 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_optional_value = function(buffer, offset, packet, parent, replace_order_optional_field)
  if not show.replace_order_optional_value then
    return nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_optional_value_branches(buffer, offset, packet, parent, replace_order_optional_field)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_orders_ouch_v5_0_size_of.replace_order_optional_value(buffer, offset, replace_order_optional_field)
  if size == 0 then
    return offset
  end
...
nasdaq_equities_orders_ouch_v5_0_size_of.replace_order_optional_field = 1

-- Display: Replace Order Optional Field
nasdaq_equities_orders_ouch_v5_0_display.replace_order_optional_field = function(value)
  if value == 3 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_optional_field = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.replace_order_optional_field
  local range = buffer(offset, length)
  local value = range:int()
  local display = nasdaq_equities_orders_ouch_v5_0_display.replace_order_optional_field(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.replace_order_optional_field, range, value, display)

  return offset + length, value
end

-- Size: Optional Field Length
nasdaq_equities_orders_ouch_v5_0_size_of.optional_field_length = 1

-- Display: Optional Field Length
nasdaq_equities_orders_ouch_v5_0_display.optional_field_length = function(value)
  return "Optional Field Length: "..value
end

-- Dissect: Optional Field Length
nasdaq_equities_orders_ouch_v5_0_dissect.optional_field_length = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.optional_field_length
  local range = buffer(offset, length)
  local value = range:int()
  local display = nasdaq_equities_orders_ouch_v5_0_display.optional_field_length(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.optional_field_length, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_appendage_fields = function(buffer, offset, packet, parent, size_of_replace_order_appendage)
  ...
  index, optional_field_length = nasdaq_equities_orders_ouch_v5_0_dissect.optional_field_length(buffer, index, packet, parent)

  -- Replace Order Optional Field: 1 Byte Signed Fixed Width Integer Enum with 7 values
  index, replace_order_optional_field = nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_optional_field(buffer, index, packet, parent)

  -- Replace Order Optional Value: Runtime Type with 7 branches
  index = nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_optional_value(buffer, index, packet, parent, replace_order_optional_field)
...
-- Size: ClOrdId
nasdaq_equities_orders_ouch_v5_0_size_of.clordid = 14

-- Display: ClOrdId
nasdaq_equities_orders_ouch_v5_0_display.clordid = function(value)
  return "ClOrdId: "..value
end

-- Dissect: ClOrdId
nasdaq_equities_orders_ouch_v5_0_dissect.clordid = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.clordid
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_equities_orders_ouch_v5_0_display.clordid(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.clordid, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.replace_order_message_fields = function(buffer, offset, packet, parent)
  ...
  index, clordid = nasdaq_equities_orders_ouch_v5_0_dissect.clordid(buffer, index, packet, parent)
...
nasdaq_equities_orders_ouch_v5_0_size_of.enter_order_optional_value = function(buffer, offset, enter_order_optional_field)
  -- Size of Firm
...
nasdaq_equities_orders_ouch_v5_0_dissect.enter_order_optional_value_branches = function(buffer, offset, packet, parent, enter_order_optional_field)
  -- Dissect Firm
  if enter_order_optional_field == 2 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.enter_order_optional_value = function(buffer, offset, packet, parent, enter_order_optional_field)
  if not show.enter_order_optional_value then
    return nasdaq_equities_orders_ouch_v5_0_dissect.enter_order_optional_value_branches(buffer, offset, packet, parent, enter_order_optional_field)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_orders_ouch_v5_0_size_of.enter_order_optional_value(buffer, offset, enter_order_optional_field)
  if size == 0 then
    return offset
  end
...
nasdaq_equities_orders_ouch_v5_0_size_of.enter_order_optional_field = 1

-- Display: Enter Order Optional Field
nasdaq_equities_orders_ouch_v5_0_display.enter_order_optional_field = function(value)
  if value == 2 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.enter_order_optional_field = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.enter_order_optional_field
  local range = buffer(offset, length)
  local value = range:int()
  local display = nasdaq_equities_orders_ouch_v5_0_display.enter_order_optional_field(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.enter_order_optional_field, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.enter_order_appendage_fields = function(buffer, offset, packet, parent, size_of_enter_order_appendage)
  ...
  index, enter_order_optional_field = nasdaq_equities_orders_ouch_v5_0_dissect.enter_order_optional_field(buffer, index, packet, parent)

  -- Enter Order Optional Value: Runtime Type with 4 branches
  index = nasdaq_equities_orders_ouch_v5_0_dissect.enter_order_optional_value(buffer, index, packet, parent, enter_order_optional_field)
...
nasdaq_equities_orders_ouch_v5_0_size_of.unsequenced_message = function(buffer, offset, unsequenced_message_type)
  -- Size of Enter Order Message
...
nasdaq_equities_orders_ouch_v5_0_display.unsequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Unsequenced Message
nasdaq_equities_orders_ouch_v5_0_dissect.unsequenced_message_branches = function(buffer, offset, packet, parent, unsequenced_message_type)
  -- Dissect Enter Order Message
  if unsequenced_message_type == "O" then
...
nasdaq_equities_orders_ouch_v5_0_dissect.unsequenced_message = function(buffer, offset, packet, parent, unsequenced_message_type)
  if not show.unsequenced_message then
    return nasdaq_equities_orders_ouch_v5_0_dissect.unsequenced_message_branches(buffer, offset, packet, parent, unsequenced_message_type)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_orders_ouch_v5_0_size_of.unsequenced_message(buffer, offset, unsequenced_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = nasdaq_equities_orders_ouch_v5_0_display.unsequenced_message(buffer, packet, parent)
  local element = parent:add(nasdaq_equities_orders_ouch_v5_0.fields.unsequenced_message, range, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.unsequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  ...
  index = nasdaq_equities_orders_ouch_v5_0_dissect.unsequenced_message(buffer, index, packet, parent, unsequenced_message_type)
...
nasdaq_equities_orders_ouch_v5_0_dissect.unsequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_unsequenced_data_packet = nasdaq_equities_orders_ouch_v5_0_size_of.unsequenced_data_packet(buffer, offset)
...
nasdaq_equities_orders_ouch_v5_0_size_of.order_restated_optional_value = function(buffer, offset, order_restated_optional_field)
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_restated_optional_value_branches = function(buffer, offset, packet, parent, order_restated_optional_field)
  -- Dissect Display Quantity
  if order_restated_optional_field == 22 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_restated_optional_value = function(buffer, offset, packet, parent, order_restated_optional_field)
  if not show.order_restated_optional_value then
    return nasdaq_equities_orders_ouch_v5_0_dissect.order_restated_optional_value_branches(buffer, offset, packet, parent, order_restated_optional_field)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_orders_ouch_v5_0_size_of.order_restated_optional_value(buffer, offset, order_restated_optional_field)
  if size == 0 then
    return offset
  end
...
nasdaq_equities_orders_ouch_v5_0_size_of.order_restated_optional_field = 1

-- Display: Order Restated Optional Field
nasdaq_equities_orders_ouch_v5_0_display.order_restated_optional_field = function(value)
  if value == 22 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_restated_optional_field = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.order_restated_optional_field
  local range = buffer(offset, length)
  local value = range:int()
  local display = nasdaq_equities_orders_ouch_v5_0_display.order_restated_optional_field(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.order_restated_optional_field, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_restated_appendage_fields = function(buffer, offset, packet, parent, size_of_order_restated_appendage)
  ...
  index, order_restated_optional_field = nasdaq_equities_orders_ouch_v5_0_dissect.order_restated_optional_field(buffer, index, packet, parent)

  -- Order Restated Optional Value: Runtime Type with 3 branches
  index = nasdaq_equities_orders_ouch_v5_0_dissect.order_restated_optional_value(buffer, index, packet, parent, order_restated_optional_field)
...
nasdaq_equities_orders_ouch_v5_0_size_of.rejected_order_message = function(buffer, offset)
  ...
  index = index + nasdaq_equities_orders_ouch_v5_0_size_of.clordid
...
nasdaq_equities_orders_ouch_v5_0_size_of.order_executed_optional_value = function(buffer, offset, order_executed_optional_field)
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_executed_optional_value_branches = function(buffer, offset, packet, parent, order_executed_optional_field)
  -- Dissect Reference Price
  if order_executed_optional_field == 19 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_executed_optional_value = function(buffer, offset, packet, parent, order_executed_optional_field)
  if not show.order_executed_optional_value then
    return nasdaq_equities_orders_ouch_v5_0_dissect.order_executed_optional_value_branches(buffer, offset, packet, parent, order_executed_optional_field)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_orders_ouch_v5_0_size_of.order_executed_optional_value(buffer, offset, order_executed_optional_field)
  if size == 0 then
    return offset
  end
...
nasdaq_equities_orders_ouch_v5_0_size_of.order_executed_optional_field = 1

-- Display: Order Executed Optional Field
nasdaq_equities_orders_ouch_v5_0_display.order_executed_optional_field = function(value)
  if value == 19 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_executed_optional_field = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.order_executed_optional_field
  local range = buffer(offset, length)
  local value = range:int()
  local display = nasdaq_equities_orders_ouch_v5_0_display.order_executed_optional_field(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.order_executed_optional_field, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_executed_appendage_fields = function(buffer, offset, packet, parent, size_of_order_executed_appendage)
  ...
  index, order_executed_optional_field = nasdaq_equities_orders_ouch_v5_0_dissect.order_executed_optional_field(buffer, index, packet, parent)

  -- Order Executed Optional Value: Runtime Type with 2 branches
  index = nasdaq_equities_orders_ouch_v5_0_dissect.order_executed_optional_value(buffer, index, packet, parent, order_executed_optional_field)
...
nasdaq_equities_orders_ouch_v5_0_size_of.order_cancel_reason = 1

-- Display: Order Cancel Reason
nasdaq_equities_orders_ouch_v5_0_display.order_cancel_reason = function(value)
  return "Order Cancel Reason: "..value
end

-- Dissect: Order Cancel Reason
nasdaq_equities_orders_ouch_v5_0_dissect.order_cancel_reason = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.order_cancel_reason
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_orders_ouch_v5_0_display.order_cancel_reason(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.order_cancel_reason, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_size_of.aiq_canceled_message = function(buffer, offset)
  ...
  index = index + nasdaq_equities_orders_ouch_v5_0_size_of.order_cancel_reason
...
nasdaq_equities_orders_ouch_v5_0_dissect.aiq_canceled_message_fields = function(buffer, offset, packet, parent)
  ...
  index, order_cancel_reason = nasdaq_equities_orders_ouch_v5_0_dissect.order_cancel_reason(buffer, index, packet, parent)
...
nasdaq_equities_orders_ouch_v5_0_size_of.cancel_order_reason = 1

-- Display: Cancel Order Reason
nasdaq_equities_orders_ouch_v5_0_display.cancel_order_reason = function(value)
  if value == "U" then
...
nasdaq_equities_orders_ouch_v5_0_dissect.cancel_order_reason = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.cancel_order_reason
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_orders_ouch_v5_0_display.cancel_order_reason(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.cancel_order_reason, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_size_of.canceled_message = function(buffer, offset)
  ...
  index = index + nasdaq_equities_orders_ouch_v5_0_size_of.cancel_order_reason
...
nasdaq_equities_orders_ouch_v5_0_dissect.canceled_message_fields = function(buffer, offset, packet, parent)
  ...
  index, cancel_order_reason = nasdaq_equities_orders_ouch_v5_0_dissect.cancel_order_reason(buffer, index, packet, parent)
...
nasdaq_equities_orders_ouch_v5_0_size_of.order_accepted_optional_value = function(buffer, offset, order_accepted_optional_field)
  -- Size of Firm
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_accepted_optional_value_branches = function(buffer, offset, packet, parent, order_accepted_optional_field)
  -- Dissect Firm
  if order_accepted_optional_field == 2 then
    return nasdaq_equities_orders_ouch_v5_0_dissect.firm(buffer, offset, packet, parent)
  end
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_accepted_optional_value = function(buffer, offset, packet, parent, order_accepted_optional_field)
  if not show.order_accepted_optional_value then
    return nasdaq_equities_orders_ouch_v5_0_dissect.order_accepted_optional_value_branches(buffer, offset, packet, parent, order_accepted_optional_field)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_orders_ouch_v5_0_size_of.order_accepted_optional_value(buffer, offset, order_accepted_optional_field)
  if size == 0 then
    return offset
  end
...
nasdaq_equities_orders_ouch_v5_0_size_of.order_accepted_optional_field = 1

-- Display: Order Accepted Optional Field
nasdaq_equities_orders_ouch_v5_0_display.order_accepted_optional_field = function(value)
  if value == 2 then
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_accepted_optional_field = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_orders_ouch_v5_0_size_of.order_accepted_optional_field
  local range = buffer(offset, length)
  local value = range:int()
  local display = nasdaq_equities_orders_ouch_v5_0_display.order_accepted_optional_field(value, buffer, offset, packet, parent)

  parent:add(nasdaq_equities_orders_ouch_v5_0.fields.order_accepted_optional_field, range, value, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.order_accepted_appendage_fields = function(buffer, offset, packet, parent, size_of_order_accepted_appendage)
  ...
  index, order_accepted_optional_field = nasdaq_equities_orders_ouch_v5_0_dissect.order_accepted_optional_field(buffer, index, packet, parent)

  -- Order Accepted Optional Value: Runtime Type with 17 branches
  index = nasdaq_equities_orders_ouch_v5_0_dissect.order_accepted_optional_value(buffer, index, packet, parent, order_accepted_optional_field)
...
nasdaq_equities_orders_ouch_v5_0_size_of.sequenced_message = function(buffer, offset, sequenced_message_type)
...
nasdaq_equities_orders_ouch_v5_0_display.sequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Sequenced Message
nasdaq_equities_orders_ouch_v5_0_dissect.sequenced_message_branches = function(buffer, offset, packet, parent, sequenced_message_type)
  -- Dissect System Event Message
  if sequenced_message_type == "S" then
...
nasdaq_equities_orders_ouch_v5_0_dissect.sequenced_message = function(buffer, offset, packet, parent, sequenced_message_type)
  if not show.sequenced_message then
    return nasdaq_equities_orders_ouch_v5_0_dissect.sequenced_message_branches(buffer, offset, packet, parent, sequenced_message_type)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_orders_ouch_v5_0_size_of.sequenced_message(buffer, offset, sequenced_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = nasdaq_equities_orders_ouch_v5_0_display.sequenced_message(buffer, packet, parent)
  local element = parent:add(nasdaq_equities_orders_ouch_v5_0.fields.sequenced_message, range, display)
...
nasdaq_equities_orders_ouch_v5_0_dissect.sequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  ...
  index = nasdaq_equities_orders_ouch_v5_0_dissect.sequenced_message(buffer, index, packet, parent, sequenced_message_type)
...
nasdaq_equities_orders_ouch_v5_0_dissect.sequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_sequenced_data_packet = nasdaq_equities_orders_ouch_v5_0_size_of.sequenced_data_packet(buffer, offset)
