...
-- Dissect: Message
nasdaq_nsmequities_totalview_itch_v5_0_2017.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_nsmequities_totalview_itch_v5_0_2017.fields.message, range, display)
  end
