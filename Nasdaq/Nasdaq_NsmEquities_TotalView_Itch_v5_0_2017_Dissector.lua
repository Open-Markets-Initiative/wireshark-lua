...
nasdaq_nsmequities_totalview_itch_v5_0_2017.messages.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  ...
  for messages_index = 1, message_count do
    ...
    offset = nasdaq_nsmequities_totalview_itch_v5_0_2017.messages.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_nsmequities_totalview_itch_v5_0_2017.messages.dissect = function(buffer, offset, packet, parent, message_count)
  return nasdaq_nsmequities_totalview_itch_v5_0_2017.messages.branches(buffer, offset, packet, parent, message_count)
end
