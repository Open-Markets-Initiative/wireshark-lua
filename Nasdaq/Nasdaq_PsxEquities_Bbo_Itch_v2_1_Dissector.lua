...
-- Dissect: Message
nasdaq_psxequities_bbo_itch_v2_1.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_psxequities_bbo_itch_v2_1.fields.message, range, display)
  end
