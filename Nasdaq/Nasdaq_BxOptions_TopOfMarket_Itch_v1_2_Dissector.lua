...
-----------------------------------------------------------------------
-- Nasdaq BxOptions TopOfMarket Itch 1.2 Formatting
-----------------------------------------------------------------------
...
nasdaq_bxoptions_topofmarket_itch_v1_2.nanoseconds_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_bxoptions_topofmarket_itch_v1_2.utc_offset_hours = 5
...
omi_nasdaq_bxoptions_topofmarket_itch_v1_2.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
nasdaq_bxoptions_topofmarket_itch_v1_2.conversation = {}
nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.data = function(packet)
  local key = nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.key(packet)
  local data = nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.flows[key]
  if data == nil then
    data = { second = { last = nil, frames = {} } }
    nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.current = nil
...
-- Store: Second
nasdaq_bxoptions_topofmarket_itch_v1_2.second.current = nil
...
nasdaq_bxoptions_topofmarket_itch_v1_2.timestamp.composite = function(buffer, offset, stored_second, packet, parent)
  ...
  local display = nasdaq_bxoptions_topofmarket_itch_v1_2.timestamp.display(nanoseconds, stored_second, packet)
...
nasdaq_bxoptions_topofmarket_itch_v1_2.timestamp.dissect = function(buffer, offset, packet, parent)
  local stored_second = nasdaq_bxoptions_topofmarket_itch_v1_2.second.current
...
nasdaq_bxoptions_topofmarket_itch_v1_2.timestamp_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Store Second Value
  nasdaq_bxoptions_topofmarket_itch_v1_2.second.current = second

  if not packet.visited then
    nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.current.second.last = second
  end
...
nasdaq_bxoptions_topofmarket_itch_v1_2.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_bxoptions_topofmarket_itch_v1_2.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_bxoptions_topofmarket_itch_v1_2.message.size(buffer, offset)
...
nasdaq_bxoptions_topofmarket_itch_v1_2.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  for message_index = 1, message_count do
    ...
    offset = nasdaq_bxoptions_topofmarket_itch_v1_2.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_bxoptions_topofmarket_itch_v1_2.packet.dissect = function(buffer, packet, parent)
  ...
  local data = nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.data(packet)
  if not packet.visited then
    data.second.frames[packet.number] = data.second.last
  end
  nasdaq_bxoptions_topofmarket_itch_v1_2.second.current = data.second.frames[packet.number]
  nasdaq_bxoptions_topofmarket_itch_v1_2.conversation.current = data
  ...
  index = nasdaq_bxoptions_topofmarket_itch_v1_2.messages.dissect(buffer, index, packet, parent, message_count)
