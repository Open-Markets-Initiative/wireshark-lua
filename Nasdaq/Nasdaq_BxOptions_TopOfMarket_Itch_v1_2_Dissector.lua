...
-- Dissect: Message
nasdaq_bxoptions_topofmarket_itch_v1_2.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_bxoptions_topofmarket_itch_v1_2.fields.message, range, display)
  end
