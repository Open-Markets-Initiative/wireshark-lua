...
udp_table:add(65333, omi_nasdaq_ntxoptions_tradefeed_itch_v2_1)
...
-- Dissector Heuristic for Nasdaq NtxOptions TradeFeed Itch 2.1
local function omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_heuristic(buffer, packet, parent)
...
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1:register_heuristic("udp", omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_heuristic)
