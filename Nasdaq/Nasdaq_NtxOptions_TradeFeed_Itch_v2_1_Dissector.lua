...
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.ntxoptions.tradefeed.itch.v2.1.clientpackettype", ftypes.STRING)
...
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.server_packet_type = ProtoField.new("Packet Type", "nasdaq.ntxoptions.tradefeed.itch.v2.1.serverpackettype", ftypes.STRING)
...
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.unsequenced_message = ProtoField.new("Unsequenced Message", "nasdaq.ntxoptions.tradefeed.itch.v2.1.unsequencedmessage", ftypes.BYTES)
...
-- Nasdaq NtxOptions TradeFeed Itch 2.1 Headers
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.client_soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.ntxoptions.tradefeed.itch.v2.1.clientsoupbintcppacket", ftypes.STRING)
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.client_tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.ntxoptions.tradefeed.itch.v2.1.clienttcppacket", ftypes.STRING)
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.client_tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.ntxoptions.tradefeed.itch.v2.1.clienttcppacketheader", ftypes.STRING)
...
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.server_soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.ntxoptions.tradefeed.itch.v2.1.serversoupbintcppacket", ftypes.STRING)
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.server_tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.ntxoptions.tradefeed.itch.v2.1.servertcppacket", ftypes.STRING)
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.server_tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.ntxoptions.tradefeed.itch.v2.1.servertcppacketheader", ftypes.STRING)
...
-----------------------------------------------------------------------
-- Nasdaq NtxOptions TradeFeed Itch 2.1 Formatting
-----------------------------------------------------------------------
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_ntxoptions_tradefeed_itch_v2_1.utc_offset_hours = 5
...
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.assume_role = Pref.enum("Assume Role", 0, "Connection role assumed for every frame, for captures that start mid conversation", role_enum, false)
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.swap_sides = Pref.bool("Swap Sides", false, "The first frame seen of each conversation was the acceptor's, not the initiator's; for captures that start mid conversation")
...
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs_changed()
  ...
  if nasdaq_ntxoptions_tradefeed_itch_v2_1.timestamp_format ~= omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.timestamp_format then
    nasdaq_ntxoptions_tradefeed_itch_v2_1.timestamp_format = omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.timestamp_format
  end
  if nasdaq_ntxoptions_tradefeed_itch_v2_1.utc_offset_hours ~= omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.utc_offset_hours then
    nasdaq_ntxoptions_tradefeed_itch_v2_1.utc_offset_hours = omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.utc_offset_hours
  end
end
...
-- Client Packet Type
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.client_packet_type, range, value, display)
...
-- Server Packet Type
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.server_packet_type, range, value, display)
...
-- Display: Timestamp
nasdaq_ntxoptions_tradefeed_itch_v2_1.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_ntxoptions_tradefeed_itch_v2_1.timestamp_format == 0 then
  ...
  if nasdaq_ntxoptions_tradefeed_itch_v2_1.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_ntxoptions_tradefeed_itch_v2_1.utc_offset_hours * 3600
...
-- Unsequenced Message
nasdaq_ntxoptions_tradefeed_itch_v2_1.unsequenced_message = {}

-- Display: Unsequenced Message
nasdaq_ntxoptions_tradefeed_itch_v2_1.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_ntxoptions_tradefeed_itch_v2_1.unsequenced_message.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.unsequenced_message.display(value, packet, parent, size)

  parent:add(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.unsequenced_message, range, value, display)
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.end_of_session_packet = {}

-- Display: End Of Session Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.end_of_session_packet.display = function(packet, parent, length)
  return "End Of Session Packet"
end


-- Dissect: End Of Session Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.end_of_session_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.end_of_session_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_heartbeat_packet = {}

-- Display: Server Heartbeat Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_heartbeat_packet.display = function(packet, parent, length)
  return "Server Heartbeat Packet"
end


-- Dissect: Server Heartbeat Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
-- Server Tcp Payload
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_payload = {}

-- Dissect: Server Tcp Payload
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
  ...
  if server_packet_type == "H" then
    return nasdaq_ntxoptions_tradefeed_itch_v2_1.server_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session Packet
  if server_packet_type == "Z" then
    return nasdaq_ntxoptions_tradefeed_itch_v2_1.end_of_session_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header = {}

-- Size: Server Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.size =
  nasdaq_ntxoptions_tradefeed_itch_v2_1.packet_length.size + 
  nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type.size

-- Display: Server Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, server_packet_type = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Server Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.server_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Tcp Packet Header: Struct of 2 fields
  index, server_tcp_packet_header = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.size then
...
-- Server Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet_header.size
end

-- Dissect Server Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_ntxoptions_tradefeed_itch_v2_1.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.logout_request_packet = {}

-- Display: Logout Request Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.logout_request_packet.display = function(packet, parent, length)
  return "Logout Request Packet"
end


-- Dissect: Logout Request Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.logout_request_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.logout_request_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_heartbeat_packet = {}

-- Display: Client Heartbeat Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_heartbeat_packet.display = function(packet, parent, length)
  return "Client Heartbeat Packet"
end


-- Dissect: Client Heartbeat Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
-- Client Tcp Payload
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_payload = {}

-- Dissect: Client Tcp Payload
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
  ...
  if client_packet_type == "R" then
    return nasdaq_ntxoptions_tradefeed_itch_v2_1.client_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request Packet
  if client_packet_type == "O" then
    return nasdaq_ntxoptions_tradefeed_itch_v2_1.logout_request_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header = {}

-- Size: Client Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.size =
  nasdaq_ntxoptions_tradefeed_itch_v2_1.packet_length.size + 
  nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type.size

-- Display: Client Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Client Tcp Packet Header
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.client_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Tcp Packet Header: Struct of 2 fields
  index, client_tcp_packet_header = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet_header.size
end

-- Dissect Client Tcp Packet
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_ntxoptions_tradefeed_itch_v2_1.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
-- Connection roles for Nasdaq NtxOptions TradeFeed Itch 2.1: Client is the initiator, Server is the acceptor
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.role = function(packet)
  if omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.assume_role == 1 then
    return "initiator"
  end
  if omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.assume_role == 2 then
    return "acceptor"
  end
  local port = omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.acceptor_port
  ...
  if omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.prefs.swap_sides then
    first = not first
  end
  if swapped[key] then
    first = not first
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.swap = function(packet)
  local key = conversation(packet)
...
function omi_nasdaq_ntxoptions_tradefeed_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    local role = nasdaq_ntxoptions_tradefeed_itch_v2_1.role(packet)
    if role == "initiator" then
      return nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet.dissect(buffer, packet, protocol)
    end
    return nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet.dissect(buffer, packet, protocol)
  end
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet.fingerprint = function(buffer)
...
nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_ntxoptions_tradefeed_itch_v2_1.client_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq NtxOptions TradeFeed Itch 2.1 (Tcp)
local function omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_ntxoptions_tradefeed_itch_v2_1.server_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq NtxOptions TradeFeed Itch 2.1 (Tcp): apply the heuristic of the sender's connection role
local function omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_ntxoptions_tradefeed_itch_v2_1.role(packet)
  local first, second = omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_initiator_heuristic, omi_nasdaq_ntxoptions_tradefeed_itch_v2_1_tcp_acceptor_heuristic
  ...
  nasdaq_ntxoptions_tradefeed_itch_v2_1.swap(packet)
...
-- Register Nasdaq NtxOptions TradeFeed Itch 2.1 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1)
-- Register Nasdaq NtxOptions TradeFeed Itch 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_ntxoptions_tradefeed_itch_v2_1)
