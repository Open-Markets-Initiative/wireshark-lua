...
local omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1 = Proto("Nasdaq.MrxOptions.SpreadTradeFeed.Itch.v2.1.Lua", "Nasdaq MrxOptions SpreadTradeFeed Itch 2.1")
