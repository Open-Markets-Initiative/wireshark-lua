...
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.clientpackettype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.expiration_day = ProtoField.new("Expiration Day", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.expirationday", ftypes.UINT8)
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.expiration_month = ProtoField.new("Expiration Month", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.expirationmonth", ftypes.UINT8)
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.expiration_year = ProtoField.new("Expiration Year", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.expirationyear", ftypes.UINT8)
...
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.option_id = ProtoField.new("Option Id", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.optionid", ftypes.UINT32)
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.option_type = ProtoField.new("Option Type", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.optiontype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.side = ProtoField.new("Side", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.side", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.unsequenced_message = ProtoField.new("Unsequenced Message", "nasdaq.mrxoptions.spreadtradefeed.itch.v2.1.unsequencedmessage", ftypes.BYTES)
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.utc_offset_hours = 5
...
omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
...
function omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.show_headers then
    show.headers = omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.show_headers
  end
  if show.repeating_groups ~= omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.show_repeating_groups then
    show.repeating_groups = omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.show_repeating_groups
  end
  ...
  if show.structs ~= omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.show_structs then
    show.structs = omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.show_structs
  end
  ...
  if nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.utc_offset_hours ~= omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.utc_offset_hours then
    nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.utc_offset_hours = omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.utc_offset_hours
  end
end
...
-- Client Packet Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.client_packet_type, range, value, display)
...
-- Expiration Day
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day = {}

-- Size: Expiration Day
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day.size = 1

-- Display: Expiration Day
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day.display = function(value)
  return "Expiration Day: "..value
end

-- Dissect: Expiration Day
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.expiration_day, range, value, display)

  return offset + length, value
end

-- Expiration Month
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month = {}

-- Size: Expiration Month
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month.size = 1

-- Display: Expiration Month
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month.display = function(value)
  return "Expiration Month: "..value
end

-- Dissect: Expiration Month
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.expiration_month, range, value, display)

  return offset + length, value
end

-- Expiration Year
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year = {}

-- Size: Expiration Year
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year.size = 1

-- Display: Expiration Year
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year.display = function(value)
  return "Expiration Year: "..value
end

-- Dissect: Expiration Year
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.expiration_year, range, value, display)

  return offset + length, value
end

-- Explicit Strike Price
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price = {}

-- Size: Explicit Strike Price
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.size = 4

-- Display: Explicit Strike Price
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.display = function(value)
  return "Explicit Strike Price: "..value
end

-- Translate: Explicit Strike Price
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.translate = function(raw)
  return raw/10000
end

-- Dissect: Explicit Strike Price
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.translate(raw)
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.explicit_strike_price, range, value, display)

  return offset + length, value
end

-- Leg Ratio
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio = {}

-- Size: Leg Ratio
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio.size = 4

-- Display: Leg Ratio
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio.display = function(value)
  return "Leg Ratio: "..value
end

-- Dissect: Leg Ratio
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.leg_ratio, range, value, display)
...
-- Option Id
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id = {}

-- Size: Option Id
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id.size = 4

-- Display: Option Id
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id.display = function(value)
  return "Option Id: "..value
end

-- Dissect: Option Id
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.option_id, range, value, display)

  return offset + length, value
end

-- Option Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type = {}

-- Size: Option Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type.size = 1

-- Display: Option Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type.display = function(value)
  return "Option Type: "..value
end

-- Dissect: Option Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.option_type, range, value, display)
...
-- Security Symbol
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol = {}

-- Size: Security Symbol
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol.size = 8

-- Display: Security Symbol
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol.display = function(value)
  return "Security Symbol: "..value
end

-- Dissect: Security Symbol
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.security_symbol, range, value, display)
...
-- Server Packet Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.server_packet_type, range, value, display)

  return offset + length, value
end

-- Side
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side = {}

-- Size: Side
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side.size = 1

-- Display: Side
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side.display = function(value)
  return "Side: "..value
end

-- Dissect: Side
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.side, range, value, display)
...
-- Display: Timestamp
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.timestamp_format == 0 then
  ...
  if nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.utc_offset_hours * 3600
...
-- Unsequenced Message
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.unsequenced_message = {}

-- Display: Unsequenced Message
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.unsequenced_message.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.unsequenced_message.display(value, packet, parent, size)

  parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.unsequenced_message, range, value, display)
...
-- Leg Information
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information = {}

-- Size: Leg Information
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.size =
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio.size

-- Display: Leg Information
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Leg Information
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.fields = function(buffer, offset, packet, parent, leg_information_index)
  local index = offset

  -- Implicit Leg Information Index
  if leg_information_index ~= nil and show.indexes then
    local iteration = parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.leg_information_index, leg_information_index)
    iteration:set_generated()
  end

  -- Option Id: Integer
  index, option_id = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_id.dissect(buffer, index, packet, parent)

  -- Security Symbol: Alphanumeric
  index, security_symbol = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.security_symbol.dissect(buffer, index, packet, parent)

  -- Expiration Year: Integer
  index, expiration_year = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_year.dissect(buffer, index, packet, parent)

  -- Expiration Month: Integer
  index, expiration_month = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_month.dissect(buffer, index, packet, parent)

  -- Expiration Day: Integer
  index, expiration_day = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.expiration_day.dissect(buffer, index, packet, parent)

  -- Explicit Strike Price: Integer
  index, explicit_strike_price = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.explicit_strike_price.dissect(buffer, index, packet, parent)

  -- Option Type: Alpha
  index, option_type = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.option_type.dissect(buffer, index, packet, parent)

  -- Side: Alpha
  index, side = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.side.dissect(buffer, index, packet, parent)

  -- Leg Ratio: Integer
  index, leg_ratio = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_ratio.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Leg Information
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.dissect = function(buffer, offset, packet, parent, leg_information_index)
  if show.repeating_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.leg_information, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.fields(buffer, offset, packet, parent, leg_information_index)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.fields(buffer, offset, packet, parent, leg_information_index)
  end
end
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.complex_strategy_directory_message.size = function(buffer, offset)
  local index = 0

  index = index + nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.tracking_number.size

  index = index + nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.timestamp.size

  index = index + nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.strategy_id.size

  index = index + nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.strategy_type.size

  index = index + nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.underlying_symbol.size

  index = index + nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.reserved_16.size

  index = index + nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.number_of_legs.size
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.complex_strategy_directory_message.fields = function(buffer, offset, packet, parent)
  ...
  for leg_information_index = 1, number_of_legs do
    index, leg_information = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.leg_information.dissect(buffer, index, packet, parent, leg_information_index)
  end
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.end_of_session_packet = {}

-- Display: End Of Session Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.display = function(packet, parent, length)
  return "End Of Session Packet"
end


-- Dissect: End Of Session Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet = {}

-- Display: Server Heartbeat Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.display = function(packet, parent, length)
  return "Server Heartbeat Packet"
end


-- Dissect: Server Heartbeat Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
-- Server Tcp Payload
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_payload = {}

-- Dissect: Server Tcp Payload
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
  ...
  if server_packet_type == "H" then
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session Packet
  if server_packet_type == "Z" then
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header = {}

-- Size: Server Tcp Packet Header
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.size =
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type.size

-- Display: Server Tcp Packet Header
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Tcp Packet Header
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, server_packet_type = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_packet_type.dissect(buffer, index, packet, parent)
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Tcp Packet Header: Struct of 2 fields
  index, server_tcp_packet_header = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.size then
...
-- Server Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet_header.size
end

-- Dissect Server Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.logout_request_packet = {}

-- Display: Logout Request Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.logout_request_packet.display = function(packet, parent, length)
  return "Logout Request Packet"
end


-- Dissect: Logout Request Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.logout_request_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.logout_request_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet = {}

-- Display: Client Heartbeat Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.display = function(packet, parent, length)
  return "Client Heartbeat Packet"
end


-- Dissect: Client Heartbeat Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
-- Client Tcp Payload
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_payload = {}

-- Dissect: Client Tcp Payload
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
  ...
  if client_packet_type == "R" then
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request Packet
  if client_packet_type == "O" then
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.logout_request_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header = {}

-- Size: Client Tcp Packet Header
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.size =
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type.size

-- Display: Client Tcp Packet Header
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Tcp Packet Header
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_packet_type.dissect(buffer, index, packet, parent)
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Tcp Packet Header: Struct of 2 fields
  index, client_tcp_packet_header = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet_header.size
end

-- Dissect Client Tcp Packet
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
-- Connection roles for Nasdaq MrxOptions SpreadTradeFeed Itch 2.1: Client is the initiator, Server is the acceptor
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.role = function(packet)
  if omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.assume_role == 1 then
    return "initiator"
  end
  if omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.assume_role == 2 then
    return "acceptor"
  end
  local port = omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.acceptor_port
  ...
  if omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.prefs.swap_sides then
    first = not first
  end
  if swapped[key] then
    first = not first
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.swap = function(packet)
  local key = conversation(packet)
...
function omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    local role = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.role(packet)
    if role == "initiator" then
      return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet.dissect(buffer, packet, protocol)
    end
    return nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet.dissect(buffer, packet, protocol)
  end
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet.fingerprint = function(buffer)
...
nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
local function omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.client_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions SpreadTradeFeed Itch 2.1 (Tcp)
local function omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.server_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions SpreadTradeFeed Itch 2.1 (Tcp): apply the heuristic of the sender's connection role
local function omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.role(packet)
  local first, second = omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1_tcp_initiator_heuristic, omi_nasdaq_mrxoptions_spreadtradefeed_itch_v2_1_tcp_acceptor_heuristic
  ...
  nasdaq_mrxoptions_spreadtradefeed_itch_v2_1.swap(packet)
