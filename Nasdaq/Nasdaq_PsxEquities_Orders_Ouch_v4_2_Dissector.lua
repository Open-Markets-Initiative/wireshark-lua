...
local nasdaq_psxequities_orders_ouch_v4_2 = Proto("Nasdaq.PsxEquities.Orders.Ouch.v4.2.Lua", "Nasdaq PsxEquities Orders Ouch 4.2")
...
nasdaq_psxequities_orders_ouch_v4_2.fields.accepted_message = ProtoField.new("Accepted Message", "nasdaq.psxequities.orders.ouch.v4.2.acceptedmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.aiq_canceled_message = ProtoField.new("Aiq Canceled Message", "nasdaq.psxequities.orders.ouch.v4.2.aiqcanceledmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.aiq_canceled_reason = ProtoField.new("Aiq Canceled Reason", "nasdaq.psxequities.orders.ouch.v4.2.aiqcanceledreason", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.bbo_weight_indicator = ProtoField.new("Bbo Weight Indicator", "nasdaq.psxequities.orders.ouch.v4.2.bboweightindicator", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.broken_trade_message = ProtoField.new("Broken Trade Message", "nasdaq.psxequities.orders.ouch.v4.2.brokentrademessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.broken_trade_reason = ProtoField.new("Broken Trade Reason", "nasdaq.psxequities.orders.ouch.v4.2.brokentradereason", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.buy_sell_indicator = ProtoField.new("Buy Sell Indicator", "nasdaq.psxequities.orders.ouch.v4.2.buysellindicator", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.cancel_order_message = ProtoField.new("Cancel Order Message", "nasdaq.psxequities.orders.ouch.v4.2.cancelordermessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.cancel_pending_message = ProtoField.new("Cancel Pending Message", "nasdaq.psxequities.orders.ouch.v4.2.cancelpendingmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.cancel_reject_message = ProtoField.new("Cancel Reject Message", "nasdaq.psxequities.orders.ouch.v4.2.cancelrejectmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.canceled_message = ProtoField.new("Canceled Message", "nasdaq.psxequities.orders.ouch.v4.2.canceledmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.canceled_reason = ProtoField.new("Canceled Reason", "nasdaq.psxequities.orders.ouch.v4.2.canceledreason", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.capacity = ProtoField.new("Capacity", "nasdaq.psxequities.orders.ouch.v4.2.capacity", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.cross_type = ProtoField.new("Cross Type", "nasdaq.psxequities.orders.ouch.v4.2.crosstype", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.debug_packet = ProtoField.new("Debug Packet", "nasdaq.psxequities.orders.ouch.v4.2.debugpacket", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.decrement_shares = ProtoField.new("Decrement Shares", "nasdaq.psxequities.orders.ouch.v4.2.decrementshares", ftypes.UINT32)
nasdaq_psxequities_orders_ouch_v4_2.fields.display = ProtoField.new("Display", "nasdaq.psxequities.orders.ouch.v4.2.display", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.enter_order_message = ProtoField.new("Enter Order Message", "nasdaq.psxequities.orders.ouch.v4.2.enterordermessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.event_code = ProtoField.new("Event Code", "nasdaq.psxequities.orders.ouch.v4.2.eventcode", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.executed_message = ProtoField.new("Executed Message", "nasdaq.psxequities.orders.ouch.v4.2.executedmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.executed_shares = ProtoField.new("Executed Shares", "nasdaq.psxequities.orders.ouch.v4.2.executedshares", ftypes.UINT32)
nasdaq_psxequities_orders_ouch_v4_2.fields.execution_price = ProtoField.new("Execution Price", "nasdaq.psxequities.orders.ouch.v4.2.executionprice", ftypes.UINT32)
nasdaq_psxequities_orders_ouch_v4_2.fields.existing_order_token = ProtoField.new("Existing Order Token", "nasdaq.psxequities.orders.ouch.v4.2.existingordertoken", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.firm = ProtoField.new("Firm", "nasdaq.psxequities.orders.ouch.v4.2.firm", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.intermarket_sweep_eligibility = ProtoField.new("Intermarket Sweep Eligibility", "nasdaq.psxequities.orders.ouch.v4.2.intermarketsweepeligibility", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.liquidity_flag = ProtoField.new("Liquidity Flag", "nasdaq.psxequities.orders.ouch.v4.2.liquidityflag", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.login_accepted_packet = ProtoField.new("Login Accepted Packet", "nasdaq.psxequities.orders.ouch.v4.2.loginacceptedpacket", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.login_rejected_packet = ProtoField.new("Login Rejected Packet", "nasdaq.psxequities.orders.ouch.v4.2.loginrejectedpacket", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.login_request_packet = ProtoField.new("Login Request Packet", "nasdaq.psxequities.orders.ouch.v4.2.loginrequestpacket", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.match_number = ProtoField.new("Match Number", "nasdaq.psxequities.orders.ouch.v4.2.matchnumber", ftypes.UINT64)
nasdaq_psxequities_orders_ouch_v4_2.fields.minimum_quantity = ProtoField.new("Minimum Quantity", "nasdaq.psxequities.orders.ouch.v4.2.minimumquantity", ftypes.UINT32)
nasdaq_psxequities_orders_ouch_v4_2.fields.modify_order_message = ProtoField.new("Modify Order Message", "nasdaq.psxequities.orders.ouch.v4.2.modifyordermessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.order_modified_message = ProtoField.new("Order Modified Message", "nasdaq.psxequities.orders.ouch.v4.2.ordermodifiedmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.order_priority_update_message = ProtoField.new("Order Priority Update Message", "nasdaq.psxequities.orders.ouch.v4.2.orderpriorityupdatemessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.order_reference_number = ProtoField.new("Order Reference Number", "nasdaq.psxequities.orders.ouch.v4.2.orderreferencenumber", ftypes.UINT64)
nasdaq_psxequities_orders_ouch_v4_2.fields.order_state = ProtoField.new("Order State", "nasdaq.psxequities.orders.ouch.v4.2.orderstate", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.order_token = ProtoField.new("Order Token", "nasdaq.psxequities.orders.ouch.v4.2.ordertoken", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.packet = ProtoField.new("Packet", "nasdaq.psxequities.orders.ouch.v4.2.packet", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.packet_header = ProtoField.new("Packet Header", "nasdaq.psxequities.orders.ouch.v4.2.packetheader", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.packet_length = ProtoField.new("Packet Length", "nasdaq.psxequities.orders.ouch.v4.2.packetlength", ftypes.UINT16)
nasdaq_psxequities_orders_ouch_v4_2.fields.packet_type = ProtoField.new("Packet Type", "nasdaq.psxequities.orders.ouch.v4.2.packettype", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.password = ProtoField.new("Password", "nasdaq.psxequities.orders.ouch.v4.2.password", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.payload = ProtoField.new("Payload", "nasdaq.psxequities.orders.ouch.v4.2.payload", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.previous_order_token = ProtoField.new("Previous Order Token", "nasdaq.psxequities.orders.ouch.v4.2.previousordertoken", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.price = ProtoField.new("Price", "nasdaq.psxequities.orders.ouch.v4.2.price", ftypes.DOUBLE)
nasdaq_psxequities_orders_ouch_v4_2.fields.quantity_prevented_from_trading = ProtoField.new("Quantity Prevented From Trading", "nasdaq.psxequities.orders.ouch.v4.2.quantitypreventedfromtrading", ftypes.UINT32)
nasdaq_psxequities_orders_ouch_v4_2.fields.reject_reason_code = ProtoField.new("Reject Reason Code", "nasdaq.psxequities.orders.ouch.v4.2.rejectreasoncode", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.rejected_message = ProtoField.new("Rejected Message", "nasdaq.psxequities.orders.ouch.v4.2.rejectedmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.rejected_reason = ProtoField.new("Rejected Reason", "nasdaq.psxequities.orders.ouch.v4.2.rejectedreason", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.replace_order_message = ProtoField.new("Replace Order Message", "nasdaq.psxequities.orders.ouch.v4.2.replaceordermessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.replaced_message = ProtoField.new("Replaced Message", "nasdaq.psxequities.orders.ouch.v4.2.replacedmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.replacement_order_token_alphanumeric_14 = ProtoField.new("Replacement Order Token Alphanumeric 14", "nasdaq.psxequities.orders.ouch.v4.2.replacementordertokenalphanumeric14", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.replacement_order_token_token_14 = ProtoField.new("Replacement Order Token Token 14", "nasdaq.psxequities.orders.ouch.v4.2.replacementordertokentoken14", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.requested_sequence_number = ProtoField.new("Requested Sequence Number", "nasdaq.psxequities.orders.ouch.v4.2.requestedsequencenumber", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.requested_session = ProtoField.new("Requested Session", "nasdaq.psxequities.orders.ouch.v4.2.requestedsession", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.sequence_number = ProtoField.new("Sequence Number", "nasdaq.psxequities.orders.ouch.v4.2.sequencenumber", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.sequenced_data_packet = ProtoField.new("Sequenced Data Packet", "nasdaq.psxequities.orders.ouch.v4.2.sequenceddatapacket", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.sequenced_message = ProtoField.new("Sequenced Message", "nasdaq.psxequities.orders.ouch.v4.2.sequencedmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.sequenced_message_type = ProtoField.new("Sequenced Message Type", "nasdaq.psxequities.orders.ouch.v4.2.sequencedmessagetype", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.session = ProtoField.new("Session", "nasdaq.psxequities.orders.ouch.v4.2.session", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.shares = ProtoField.new("Shares", "nasdaq.psxequities.orders.ouch.v4.2.shares", ftypes.UINT32)
nasdaq_psxequities_orders_ouch_v4_2.fields.soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.psxequities.orders.ouch.v4.2.soupbintcppacket", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.stock = ProtoField.new("Stock", "nasdaq.psxequities.orders.ouch.v4.2.stock", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.system_event_message = ProtoField.new("System Event Message", "nasdaq.psxequities.orders.ouch.v4.2.systemeventmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.text = ProtoField.new("Text", "nasdaq.psxequities.orders.ouch.v4.2.text", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.time_in_force = ProtoField.new("Time In Force", "nasdaq.psxequities.orders.ouch.v4.2.timeinforce", ftypes.UINT32)
nasdaq_psxequities_orders_ouch_v4_2.fields.timestamp = ProtoField.new("Timestamp", "nasdaq.psxequities.orders.ouch.v4.2.timestamp", ftypes.UINT64)
nasdaq_psxequities_orders_ouch_v4_2.fields.unsequenced_data_packet = ProtoField.new("Unsequenced Data Packet", "nasdaq.psxequities.orders.ouch.v4.2.unsequenceddatapacket", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.unsequenced_message = ProtoField.new("Unsequenced Message", "nasdaq.psxequities.orders.ouch.v4.2.unsequencedmessage", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.unsequenced_message_type = ProtoField.new("Unsequenced Message Type", "nasdaq.psxequities.orders.ouch.v4.2.unsequencedmessagetype", ftypes.STRING)
nasdaq_psxequities_orders_ouch_v4_2.fields.username = ProtoField.new("Username", "nasdaq.psxequities.orders.ouch.v4.2.username", ftypes.STRING)
...
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_accepted_message = Pref.bool("Show Accepted Message", show.accepted_message, "Parse and add Accepted Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_aiq_canceled_message = Pref.bool("Show Aiq Canceled Message", show.aiq_canceled_message, "Parse and add Aiq Canceled Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_broken_trade_message = Pref.bool("Show Broken Trade Message", show.broken_trade_message, "Parse and add Broken Trade Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_order_message = Pref.bool("Show Cancel Order Message", show.cancel_order_message, "Parse and add Cancel Order Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_pending_message = Pref.bool("Show Cancel Pending Message", show.cancel_pending_message, "Parse and add Cancel Pending Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_reject_message = Pref.bool("Show Cancel Reject Message", show.cancel_reject_message, "Parse and add Cancel Reject Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_canceled_message = Pref.bool("Show Canceled Message", show.canceled_message, "Parse and add Canceled Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_debug_packet = Pref.bool("Show Debug Packet", show.debug_packet, "Parse and add Debug Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_enter_order_message = Pref.bool("Show Enter Order Message", show.enter_order_message, "Parse and add Enter Order Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_executed_message = Pref.bool("Show Executed Message", show.executed_message, "Parse and add Executed Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_accepted_packet = Pref.bool("Show Login Accepted Packet", show.login_accepted_packet, "Parse and add Login Accepted Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_rejected_packet = Pref.bool("Show Login Rejected Packet", show.login_rejected_packet, "Parse and add Login Rejected Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_request_packet = Pref.bool("Show Login Request Packet", show.login_request_packet, "Parse and add Login Request Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_modify_order_message = Pref.bool("Show Modify Order Message", show.modify_order_message, "Parse and add Modify Order Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_order_modified_message = Pref.bool("Show Order Modified Message", show.order_modified_message, "Parse and add Order Modified Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_order_priority_update_message = Pref.bool("Show Order Priority Update Message", show.order_priority_update_message, "Parse and add Order Priority Update Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_rejected_message = Pref.bool("Show Rejected Message", show.rejected_message, "Parse and add Rejected Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_replace_order_message = Pref.bool("Show Replace Order Message", show.replace_order_message, "Parse and add Replace Order Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_replaced_message = Pref.bool("Show Replaced Message", show.replaced_message, "Parse and add Replaced Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_sequenced_data_packet = Pref.bool("Show Sequenced Data Packet", show.sequenced_data_packet, "Parse and add Sequenced Data Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_soup_bin_tcp_packet = Pref.bool("Show Soup Bin Tcp Packet", show.soup_bin_tcp_packet, "Parse and add Soup Bin Tcp Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_system_event_message = Pref.bool("Show System Event Message", show.system_event_message, "Parse and add System Event Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_unsequenced_data_packet = Pref.bool("Show Unsequenced Data Packet", show.unsequenced_data_packet, "Parse and add Unsequenced Data Packet to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_sequenced_message = Pref.bool("Show Sequenced Message", show.sequenced_message, "Parse and add Sequenced Message to protocol tree")
nasdaq_psxequities_orders_ouch_v4_2.prefs.show_unsequenced_message = Pref.bool("Show Unsequenced Message", show.unsequenced_message, "Parse and add Unsequenced Message to protocol tree")

-- Handle changed preferences
function nasdaq_psxequities_orders_ouch_v4_2.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.accepted_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_accepted_message then
    show.accepted_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_accepted_message
    changed = true
  end
  if show.aiq_canceled_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_aiq_canceled_message then
    show.aiq_canceled_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_aiq_canceled_message
    changed = true
  end
  if show.broken_trade_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_broken_trade_message then
    show.broken_trade_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_broken_trade_message
    changed = true
  end
  if show.cancel_order_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_order_message then
    show.cancel_order_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_order_message
    changed = true
  end
  if show.cancel_pending_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_pending_message then
    show.cancel_pending_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_pending_message
    changed = true
  end
  if show.cancel_reject_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_reject_message then
    show.cancel_reject_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_cancel_reject_message
    changed = true
  end
  if show.canceled_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_canceled_message then
    show.canceled_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_canceled_message
    changed = true
  end
  if show.debug_packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_debug_packet then
    show.debug_packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_debug_packet
    changed = true
  end
  if show.enter_order_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_enter_order_message then
    show.enter_order_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_enter_order_message
    changed = true
  end
  if show.executed_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_executed_message then
    show.executed_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_executed_message
    changed = true
  end
  if show.login_accepted_packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_accepted_packet then
    show.login_accepted_packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_accepted_packet
    changed = true
  end
  if show.login_rejected_packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_rejected_packet then
    show.login_rejected_packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_rejected_packet
    changed = true
  end
  if show.login_request_packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_request_packet then
    show.login_request_packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_login_request_packet
    changed = true
  end
  if show.modify_order_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_modify_order_message then
    show.modify_order_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_modify_order_message
    changed = true
  end
  if show.order_modified_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_order_modified_message then
    show.order_modified_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_order_modified_message
    changed = true
  end
  if show.order_priority_update_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_order_priority_update_message then
    show.order_priority_update_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_order_priority_update_message
    changed = true
  end
  if show.packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_packet then
    show.packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_packet
    changed = true
  end
  if show.packet_header ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_packet_header then
    show.packet_header = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_packet_header
    changed = true
  end
  if show.rejected_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_rejected_message then
    show.rejected_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_rejected_message
    changed = true
  end
  if show.replace_order_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_replace_order_message then
    show.replace_order_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_replace_order_message
    changed = true
  end
  if show.replaced_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_replaced_message then
    show.replaced_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_replaced_message
    changed = true
  end
  if show.sequenced_data_packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_sequenced_data_packet then
    show.sequenced_data_packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_sequenced_data_packet
    changed = true
  end
  if show.soup_bin_tcp_packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_soup_bin_tcp_packet then
    show.soup_bin_tcp_packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_soup_bin_tcp_packet
    changed = true
  end
  if show.system_event_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_system_event_message then
    show.system_event_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_system_event_message
    changed = true
  end
  if show.unsequenced_data_packet ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_unsequenced_data_packet then
    show.unsequenced_data_packet = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_unsequenced_data_packet
    changed = true
  end
  if show.payload ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_payload then
    show.payload = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_payload
    changed = true
  end
  if show.sequenced_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_sequenced_message then
    show.sequenced_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_sequenced_message
    changed = true
  end
  if show.unsequenced_message ~= nasdaq_psxequities_orders_ouch_v4_2.prefs.show_unsequenced_message then
    show.unsequenced_message = nasdaq_psxequities_orders_ouch_v4_2.prefs.show_unsequenced_message
    changed = true
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.shares = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.shares, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.buy_sell_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.buy_sell_indicator, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.order_token = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.order_token, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.modify_order_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.modify_order_message = function(buffer, offset, packet, parent)
  ...
  if show.modify_order_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.modify_order_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.modify_order_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.modify_order_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_display.cancel_order_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.cancel_order_message = function(buffer, offset, packet, parent)
  ...
  if show.cancel_order_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.cancel_order_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.cancel_order_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.cancel_order_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.minimum_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.minimum_quantity, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.intermarket_sweep_eligibility = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.intermarket_sweep_eligibility, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.display = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.display, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.time_in_force = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.time_in_force, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.price, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.replacement_order_token_token_14 = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.replacement_order_token_token_14, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.existing_order_token = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.existing_order_token, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.replace_order_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.replace_order_message = function(buffer, offset, packet, parent)
  ...
  if show.replace_order_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.replace_order_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.replace_order_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.replace_order_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.cross_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.cross_type, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.capacity = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.capacity, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.firm = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.firm, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.stock = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.stock, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.enter_order_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.enter_order_message = function(buffer, offset, packet, parent)
  ...
  if show.enter_order_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.enter_order_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.enter_order_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.enter_order_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.unsequenced_message = function(buffer, offset, packet, parent, unsequenced_message_type)
  ...
  local element = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.unsequenced_message, range, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.unsequenced_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.unsequenced_message_type, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.unsequenced_data_packet = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.unsequenced_data_packet = function(buffer, offset, packet, parent)
  ...
  if show.unsequenced_data_packet then
    ...
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.unsequenced_data_packet, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.requested_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.requested_sequence_number, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.requested_session = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.requested_session, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.password = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.password, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.username = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.username, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.login_request_packet = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.login_request_packet = function(buffer, offset, packet, parent)
  ...
  if show.login_request_packet then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.login_request_packet(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.login_request_packet(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.login_request_packet, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.timestamp, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.order_modified_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.order_modified_message = function(buffer, offset, packet, parent)
  ...
  if show.order_modified_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.order_modified_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.order_modified_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.order_modified_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.order_reference_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.order_reference_number, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.order_priority_update_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.order_priority_update_message = function(buffer, offset, packet, parent)
  ...
  if show.order_priority_update_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.order_priority_update_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.order_priority_update_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.order_priority_update_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_display.cancel_reject_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.cancel_reject_message = function(buffer, offset, packet, parent)
  ...
  if show.cancel_reject_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.cancel_reject_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.cancel_reject_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.cancel_reject_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_display.cancel_pending_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.cancel_pending_message = function(buffer, offset, packet, parent)
  ...
  if show.cancel_pending_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.cancel_pending_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.cancel_pending_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.cancel_pending_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.rejected_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.rejected_reason, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.rejected_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.rejected_message = function(buffer, offset, packet, parent)
  ...
  if show.rejected_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.rejected_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.rejected_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.rejected_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.broken_trade_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.broken_trade_reason, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.match_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.match_number, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.broken_trade_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.broken_trade_message = function(buffer, offset, packet, parent)
  ...
  if show.broken_trade_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.broken_trade_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.broken_trade_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.broken_trade_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.liquidity_flag = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.liquidity_flag, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.execution_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.execution_price, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.executed_shares = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.executed_shares, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.executed_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.executed_message = function(buffer, offset, packet, parent)
  ...
  if show.executed_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.executed_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.executed_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.executed_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.quantity_prevented_from_trading = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.quantity_prevented_from_trading, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.aiq_canceled_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.aiq_canceled_reason, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.decrement_shares = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.decrement_shares, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.aiq_canceled_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.aiq_canceled_message = function(buffer, offset, packet, parent)
  ...
  if show.aiq_canceled_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.aiq_canceled_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.aiq_canceled_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.aiq_canceled_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.canceled_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.canceled_reason, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.canceled_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.canceled_message = function(buffer, offset, packet, parent)
  ...
  if show.canceled_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.canceled_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.canceled_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.canceled_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.bbo_weight_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.bbo_weight_indicator, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.previous_order_token = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.previous_order_token, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.order_state = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.order_state, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.replacement_order_token_alphanumeric_14 = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.replacement_order_token_alphanumeric_14, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.replaced_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.replaced_message = function(buffer, offset, packet, parent)
  ...
  if show.replaced_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.replaced_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.replaced_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.replaced_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_display.accepted_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.accepted_message = function(buffer, offset, packet, parent)
  ...
  if show.accepted_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.accepted_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.accepted_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.accepted_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.event_code = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.event_code, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.system_event_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.system_event_message = function(buffer, offset, packet, parent)
  ...
  if show.system_event_message then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.system_event_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.system_event_message(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.system_event_message, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.sequenced_message = function(buffer, offset, packet, parent, sequenced_message_type)
  ...
  local element = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.sequenced_message, range, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.sequenced_message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.sequenced_message_type, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.sequenced_data_packet = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.sequenced_data_packet = function(buffer, offset, packet, parent)
  ...
  if show.sequenced_data_packet then
    ...
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.sequenced_data_packet, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.reject_reason_code = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.reject_reason_code, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.login_rejected_packet = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.login_rejected_packet = function(buffer, offset, packet, parent)
  ...
  if show.login_rejected_packet then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.login_rejected_packet(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.login_rejected_packet(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.login_rejected_packet, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.sequence_number, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.session = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.session, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.login_accepted_packet = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.login_accepted_packet = function(buffer, offset, packet, parent)
  ...
  if show.login_accepted_packet then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.login_accepted_packet(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.login_accepted_packet(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.login_accepted_packet, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.text = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.text, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.debug_packet = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.debug_packet = function(buffer, offset, packet, parent)
  ...
  if show.debug_packet then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.debug_packet(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.debug_packet(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.debug_packet, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.payload = function(buffer, offset, packet, parent, packet_type)
  ...
  local element = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.payload, range, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.packet_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.packet_type, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.packet_length = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.packet_length, range, value, display)
...
nasdaq_psxequities_orders_ouch_v4_2_display.packet_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    local length = nasdaq_psxequities_orders_ouch_v4_2_size_of.packet_header(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_psxequities_orders_ouch_v4_2_display.packet_header(buffer, packet, parent)
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.packet_header, range, display)
  end
...
nasdaq_psxequities_orders_ouch_v4_2_display.soup_bin_tcp_packet = function(buffer, offset, size, packet, parent)
  return ""
end
...
nasdaq_psxequities_orders_ouch_v4_2_dissect.soup_bin_tcp_packet = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  ...
  if show.soup_bin_tcp_packet then
    ...
    parent = parent:add(nasdaq_psxequities_orders_ouch_v4_2.fields.soup_bin_tcp_packet, range, display)
  end
...
function nasdaq_psxequities_orders_ouch_v4_2.init()
end

-- Dissector for Nasdaq PsxEquities Orders Ouch 4.2
function nasdaq_psxequities_orders_ouch_v4_2.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = nasdaq_psxequities_orders_ouch_v4_2.name

  -- Dissect protocol
  local protocol = parent:add(nasdaq_psxequities_orders_ouch_v4_2, buffer(), nasdaq_psxequities_orders_ouch_v4_2.description, "("..buffer:len().." Bytes)")
  return nasdaq_psxequities_orders_ouch_v4_2_dissect.packet(buffer, packet, protocol)
end

-- Register With Tcp Table
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add(65333, nasdaq_psxequities_orders_ouch_v4_2)
...
verify.nasdaq_psxequities_orders_ouch_v4_2_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Nasdaq PsxEquities Orders Ouch 4.2
local function nasdaq_psxequities_orders_ouch_v4_2_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.nasdaq_psxequities_orders_ouch_v4_2_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = nasdaq_psxequities_orders_ouch_v4_2
  nasdaq_psxequities_orders_ouch_v4_2.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Nasdaq PsxEquities Orders Ouch 4.2
nasdaq_psxequities_orders_ouch_v4_2:register_heuristic("tcp", nasdaq_psxequities_orders_ouch_v4_2_heuristic)
