...
local omi_nasdaq_ntxequities_qbbo_itch_v2_1 = Proto("Omi.Nasdaq.NtxEquities.Qbbo.Itch.v2.1", "Nasdaq NtxEquities Qbbo Itch 2.1")
...
-- Nasdaq NtxEquities Qbbo 2.1 Application Messages
...
-----------------------------------------------------------------------
-- Nasdaq NtxEquities Qbbo Itch 2.1 Formatting
-----------------------------------------------------------------------
...
nasdaq_ntxequities_qbbo_itch_v2_1.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_ntxequities_qbbo_itch_v2_1.utc_offset_hours = 5
...
omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")

omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.timestamp_format = Pref.enum("Time Stamp Format", 2, "Time Stamp display format", timestamp_format_enum, false)
omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_headers then
    show.headers = omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_structs then
    show.structs = omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_indexes then
    show.indexes = omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_sequences then
    show.sequences = omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.show_sequences
  end
  if nasdaq_ntxequities_qbbo_itch_v2_1.timestamp_format ~= omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.timestamp_format then
    nasdaq_ntxequities_qbbo_itch_v2_1.timestamp_format = omi_nasdaq_ntxequities_qbbo_itch_v2_1.prefs.timestamp_format
  end
...
nasdaq_ntxequities_qbbo_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_ntxequities_qbbo_itch_v2_1.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_ntxequities_qbbo_itch_v2_1.fields.message_sequence_number, UInt64.new(nasdaq_ntxequities_qbbo_itch_v2_1.sequence + message_index - 1))
...
-- End Of Session
nasdaq_ntxequities_qbbo_itch_v2_1.end_of_session = {}

-- Display: End Of Session
nasdaq_ntxequities_qbbo_itch_v2_1.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_ntxequities_qbbo_itch_v2_1.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_ntxequities_qbbo_itch_v2_1.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_ntxequities_qbbo_itch_v2_1.heartbeat = {}

-- Display: Heartbeat
nasdaq_ntxequities_qbbo_itch_v2_1.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_ntxequities_qbbo_itch_v2_1.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_ntxequities_qbbo_itch_v2_1.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_ntxequities_qbbo_itch_v2_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_ntxequities_qbbo_itch_v2_1.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_ntxequities_qbbo_itch_v2_1.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
...
nasdaq_ntxequities_qbbo_itch_v2_1.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_ntxequities_qbbo_itch_v2_1.sequence = sequence_number
...
nasdaq_ntxequities_qbbo_itch_v2_1.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_ntxequities_qbbo_itch_v2_1.packet_header.size
end
...
-- Dissector Heuristic for Nasdaq NtxEquities Qbbo Itch 2.1 (Udp)
local function omi_nasdaq_ntxequities_qbbo_itch_v2_1_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_ntxequities_qbbo_itch_v2_1:register_heuristic("udp", omi_nasdaq_ntxequities_qbbo_itch_v2_1_udp_heuristic)

-- Register Nasdaq NtxEquities Qbbo Itch 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_ntxequities_qbbo_itch_v2_1)
