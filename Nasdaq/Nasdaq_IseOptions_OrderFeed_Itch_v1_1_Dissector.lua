...
nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.auction_response = function(buffer, offset, packet, parent, auction_response_index)
  if show.auction_response then
    ...
    local index = nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.auction_response_fields(buffer, offset, packet, parent, auction_response_index)
    ...
    return nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.auction_response_fields(buffer, offset, packet, parent, auction_response_index)
  end
end
...
nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.auction_message_fields = function(buffer, offset, packet, parent)
  ...
  for auction_response_index = 1, number_of_responses do
    index, auction_response = nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.auction_response(buffer, index, packet, parent, auction_response_index)
  end
...
-- Dissect: Message
nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.message = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(nasdaq_iseoptions_orderfeed_itch_v1_1.fields.message, buffer(offset, 0))
    local current = nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.message_fields(buffer, offset, packet, parent, size_of_message, message_index)
    ...
    -- Skip element, add fields directly
    nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.message_fields(buffer, offset, packet, parent, size_of_message, message_index)
...
nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.packet = function(buffer, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = nasdaq_iseoptions_orderfeed_itch_v1_1_dissect.message(buffer, index, packet, parent, size_of_message, message_index)
  end
