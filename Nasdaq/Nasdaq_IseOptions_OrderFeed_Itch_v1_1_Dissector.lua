...
local omi_nasdaq_iseoptions_orderfeed_itch_v1_1 = Proto("Omi.Nasdaq.IseOptions.OrderFeed.Itch.v1.1", "Nasdaq IseOptions OrderFeed Itch 1.1")
...
-- Nasdaq IseOptions OrderFeed 1.1 Application Messages
...
omi_nasdaq_iseoptions_orderfeed_itch_v1_1.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
...
function omi_nasdaq_iseoptions_orderfeed_itch_v1_1.prefs_changed()
  ...
  if show.indexes ~= omi_nasdaq_iseoptions_orderfeed_itch_v1_1.prefs.show_indexes then
    show.indexes = omi_nasdaq_iseoptions_orderfeed_itch_v1_1.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_iseoptions_orderfeed_itch_v1_1.prefs.show_sequences then
    show.sequences = omi_nasdaq_iseoptions_orderfeed_itch_v1_1.prefs.show_sequences
  end
...
nasdaq_iseoptions_orderfeed_itch_v1_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_iseoptions_orderfeed_itch_v1_1.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_iseoptions_orderfeed_itch_v1_1.fields.message_sequence_number, UInt64.new(nasdaq_iseoptions_orderfeed_itch_v1_1.sequence + message_index - 1))
...
-- End Of Session
nasdaq_iseoptions_orderfeed_itch_v1_1.end_of_session = {}

-- Display: End Of Session
nasdaq_iseoptions_orderfeed_itch_v1_1.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_iseoptions_orderfeed_itch_v1_1.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_orderfeed_itch_v1_1.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_iseoptions_orderfeed_itch_v1_1.heartbeat = {}

-- Display: Heartbeat
nasdaq_iseoptions_orderfeed_itch_v1_1.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_iseoptions_orderfeed_itch_v1_1.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_orderfeed_itch_v1_1.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_iseoptions_orderfeed_itch_v1_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_iseoptions_orderfeed_itch_v1_1.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
...
nasdaq_iseoptions_orderfeed_itch_v1_1.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_iseoptions_orderfeed_itch_v1_1.sequence = sequence_number
...
nasdaq_iseoptions_orderfeed_itch_v1_1.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_iseoptions_orderfeed_itch_v1_1.packet_header.size
end
...
nasdaq_iseoptions_orderfeed_itch_v1_1.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_iseoptions_orderfeed_itch_v1_1.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq IseOptions OrderFeed Itch 1.1 (Udp)
local function omi_nasdaq_iseoptions_orderfeed_itch_v1_1_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_iseoptions_orderfeed_itch_v1_1:register_heuristic("udp", omi_nasdaq_iseoptions_orderfeed_itch_v1_1_udp_heuristic)

-- Register Nasdaq IseOptions OrderFeed Itch 1.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_iseoptions_orderfeed_itch_v1_1)
