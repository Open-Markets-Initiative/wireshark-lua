...
local show = {}
local format = {}
local nasdaq_common_soupbin_tcp_v3_0_display = {}
local nasdaq_common_soupbin_tcp_v3_0_dissect = {}
local nasdaq_common_soupbin_tcp_v3_0_size_of = {}
local verify = {}
...
nasdaq_common_soupbin_tcp_v3_0_display.unsequenced_message = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_common_soupbin_tcp_v3_0_dissect.unsequenced_message = function(buffer, offset, packet, parent, size)
...
nasdaq_common_soupbin_tcp_v3_0_size_of.unsequenced_message_type = 1

-- Display: Unsequenced Message Type
nasdaq_common_soupbin_tcp_v3_0_display.unsequenced_message_type = function(value)
  return "Unsequenced Message Type: "..value
end

-- Dissect: Unsequenced Message Type
nasdaq_common_soupbin_tcp_v3_0_dissect.unsequenced_message_type = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.unsequenced_message_type
...
nasdaq_common_soupbin_tcp_v3_0_size_of.unsequenced_data_packet = function(buffer, offset)
  local index = offset
...
nasdaq_common_soupbin_tcp_v3_0_display.unsequenced_data_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Unsequenced Data Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.unsequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  local index = offset

  -- Unsequenced Message Type: 1 Byte Ascii String
  index, unsequenced_message_type = nasdaq_common_soupbin_tcp_v3_0_dissect.unsequenced_message_type(buffer, index, packet, parent)
  ...
  index, unsequenced_message = nasdaq_common_soupbin_tcp_v3_0_dissect.unsequenced_message(buffer, index, packet, parent, size_of_unsequenced_message)

  return index
end

-- Dissect: Unsequenced Data Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.unsequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_unsequenced_data_packet = nasdaq_common_soupbin_tcp_v3_0_size_of.unsequenced_data_packet(buffer, offset)
...
nasdaq_common_soupbin_tcp_v3_0_size_of.requested_sequence_number = 20

-- Display: Requested Sequence Number
nasdaq_common_soupbin_tcp_v3_0_display.requested_sequence_number = function(value)
  return "Requested Sequence Number: "..value
end

-- Dissect: Requested Sequence Number
nasdaq_common_soupbin_tcp_v3_0_dissect.requested_sequence_number = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.requested_sequence_number
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_common_soupbin_tcp_v3_0_size_of.requested_session = 10

-- Display: Requested Session
nasdaq_common_soupbin_tcp_v3_0_display.requested_session = function(value)
  return "Requested Session: "..value
end

-- Dissect: Requested Session
nasdaq_common_soupbin_tcp_v3_0_dissect.requested_session = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.requested_session
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Password
nasdaq_common_soupbin_tcp_v3_0_size_of.password = 10

-- Display: Password
nasdaq_common_soupbin_tcp_v3_0_display.password = function(value)
  return "Password: "..value
end

-- Dissect: Password
nasdaq_common_soupbin_tcp_v3_0_dissect.password = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.password
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Username
nasdaq_common_soupbin_tcp_v3_0_size_of.username = 6

-- Display: Username
nasdaq_common_soupbin_tcp_v3_0_display.username = function(value)
  return "Username: "..value
end

-- Dissect: Username
nasdaq_common_soupbin_tcp_v3_0_dissect.username = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.username
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_common_soupbin_tcp_v3_0_size_of.login_request_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.username

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.password

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.requested_session

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.requested_sequence_number

  return index
end

-- Display: Login Request Packet
nasdaq_common_soupbin_tcp_v3_0_display.login_request_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Request Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.login_request_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Username: 6 Byte Ascii String
  index, username = nasdaq_common_soupbin_tcp_v3_0_dissect.username(buffer, index, packet, parent)

  -- Password: 10 Byte Ascii String
  index, password = nasdaq_common_soupbin_tcp_v3_0_dissect.password(buffer, index, packet, parent)

  -- Requested Session: 10 Byte Ascii String
  index, requested_session = nasdaq_common_soupbin_tcp_v3_0_dissect.requested_session(buffer, index, packet, parent)

  -- Requested Sequence Number: 20 Byte Ascii String
  index, requested_sequence_number = nasdaq_common_soupbin_tcp_v3_0_dissect.requested_sequence_number(buffer, index, packet, parent)
...
nasdaq_common_soupbin_tcp_v3_0_dissect.login_request_packet = function(buffer, offset, packet, parent)
  if show.login_request_packet then
    ...
    local element = parent:add(nasdaq_common_soupbin_tcp_v3_0.fields.login_request_packet, buffer(offset, 0))
    local index = nasdaq_common_soupbin_tcp_v3_0_dissect.login_request_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_common_soupbin_tcp_v3_0_display.login_request_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_common_soupbin_tcp_v3_0_dissect.login_request_packet_fields(buffer, offset, packet, element)
  end
end

-- Display: Sequenced Message
nasdaq_common_soupbin_tcp_v3_0_display.sequenced_message = function(value)
  return "Sequenced Message: "..value
end

-- Dissect runtime sized field: Sequenced Message
nasdaq_common_soupbin_tcp_v3_0_dissect.sequenced_message = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
...
nasdaq_common_soupbin_tcp_v3_0_size_of.sequenced_message_type = 1

-- Display: Sequenced Message Type
nasdaq_common_soupbin_tcp_v3_0_display.sequenced_message_type = function(value)
  return "Sequenced Message Type: "..value
end

-- Dissect: Sequenced Message Type
nasdaq_common_soupbin_tcp_v3_0_dissect.sequenced_message_type = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.sequenced_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_common_soupbin_tcp_v3_0_size_of.sequenced_data_packet = function(buffer, offset)
  local index = offset
...
nasdaq_common_soupbin_tcp_v3_0_display.sequenced_data_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequenced Data Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.sequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  local index = offset

  -- Sequenced Message Type: 1 Byte Ascii String
  index, sequenced_message_type = nasdaq_common_soupbin_tcp_v3_0_dissect.sequenced_message_type(buffer, index, packet, parent)
  ...
  index, sequenced_message = nasdaq_common_soupbin_tcp_v3_0_dissect.sequenced_message(buffer, index, packet, parent, size_of_sequenced_message)

  return index
end

-- Dissect: Sequenced Data Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.sequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_sequenced_data_packet = nasdaq_common_soupbin_tcp_v3_0_size_of.sequenced_data_packet(buffer, offset)
...
nasdaq_common_soupbin_tcp_v3_0_size_of.reject_reason_code = 1

-- Display: Reject Reason Code
nasdaq_common_soupbin_tcp_v3_0_display.reject_reason_code = function(value)
  return "Reject Reason Code: "..value
end

-- Dissect: Reject Reason Code
nasdaq_common_soupbin_tcp_v3_0_dissect.reject_reason_code = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.reject_reason_code
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_common_soupbin_tcp_v3_0_size_of.login_rejected_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.reject_reason_code

  return index
end

-- Display: Login Rejected Packet
nasdaq_common_soupbin_tcp_v3_0_display.login_rejected_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Rejected Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.login_rejected_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Reject Reason Code: 1 Byte Ascii String
  index, reject_reason_code = nasdaq_common_soupbin_tcp_v3_0_dissect.reject_reason_code(buffer, index, packet, parent)
...
nasdaq_common_soupbin_tcp_v3_0_dissect.login_rejected_packet = function(buffer, offset, packet, parent)
  if show.login_rejected_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_common_soupbin_tcp_v3_0.fields.login_rejected_packet, buffer(offset, 0))
    local index = nasdaq_common_soupbin_tcp_v3_0_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_common_soupbin_tcp_v3_0_display.login_rejected_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_common_soupbin_tcp_v3_0_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
  end
end

-- Size: Sequence Number
nasdaq_common_soupbin_tcp_v3_0_size_of.sequence_number = 20

-- Display: Sequence Number
nasdaq_common_soupbin_tcp_v3_0_display.sequence_number = function(value)
  return "Sequence Number: "..value
end

-- Dissect: Sequence Number
nasdaq_common_soupbin_tcp_v3_0_dissect.sequence_number = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.sequence_number
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Session
nasdaq_common_soupbin_tcp_v3_0_size_of.session = 10

-- Display: Session
nasdaq_common_soupbin_tcp_v3_0_display.session = function(value)
  return "Session: "..value
end

-- Dissect: Session
nasdaq_common_soupbin_tcp_v3_0_dissect.session = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.session
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_common_soupbin_tcp_v3_0_size_of.login_accepted_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.session

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.sequence_number

  return index
end

-- Display: Login Accepted Packet
nasdaq_common_soupbin_tcp_v3_0_display.login_accepted_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Accepted Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.login_accepted_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session: 10 Byte Ascii String
  index, session = nasdaq_common_soupbin_tcp_v3_0_dissect.session(buffer, index, packet, parent)

  -- Sequence Number: 20 Byte Ascii String
  index, sequence_number = nasdaq_common_soupbin_tcp_v3_0_dissect.sequence_number(buffer, index, packet, parent)
...
nasdaq_common_soupbin_tcp_v3_0_dissect.login_accepted_packet = function(buffer, offset, packet, parent)
  if show.login_accepted_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_common_soupbin_tcp_v3_0.fields.login_accepted_packet, buffer(offset, 0))
    local index = nasdaq_common_soupbin_tcp_v3_0_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_common_soupbin_tcp_v3_0_display.login_accepted_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_common_soupbin_tcp_v3_0_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
  end
end

-- Size: Text
nasdaq_common_soupbin_tcp_v3_0_size_of.text = 1

-- Display: Text
nasdaq_common_soupbin_tcp_v3_0_display.text = function(value)
  return "Text: "..value
end

-- Dissect: Text
nasdaq_common_soupbin_tcp_v3_0_dissect.text = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.text
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_common_soupbin_tcp_v3_0_size_of.debug_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.text

  return index
end

-- Display: Debug Packet
nasdaq_common_soupbin_tcp_v3_0_display.debug_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Debug Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.debug_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Text: 1 Byte Ascii String
  index, text = nasdaq_common_soupbin_tcp_v3_0_dissect.text(buffer, index, packet, parent)
...
nasdaq_common_soupbin_tcp_v3_0_dissect.debug_packet = function(buffer, offset, packet, parent)
  if show.debug_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_common_soupbin_tcp_v3_0.fields.debug_packet, buffer(offset, 0))
    local index = nasdaq_common_soupbin_tcp_v3_0_dissect.debug_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_common_soupbin_tcp_v3_0_display.debug_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_common_soupbin_tcp_v3_0_dissect.debug_packet_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Payload
nasdaq_common_soupbin_tcp_v3_0_size_of.payload = function(buffer, offset, packet_type)
  -- Size of Debug Packet
  if packet_type == "+" then
    return nasdaq_common_soupbin_tcp_v3_0_size_of.debug_packet(buffer, offset)
  end
  -- Size of Login Accepted Packet
  if packet_type == "A" then
    return nasdaq_common_soupbin_tcp_v3_0_size_of.login_accepted_packet(buffer, offset)
  end
  -- Size of Login Rejected Packet
  if packet_type == "J" then
    return nasdaq_common_soupbin_tcp_v3_0_size_of.login_rejected_packet(buffer, offset)
  end
  -- Size of Sequenced Data Packet
  if packet_type == "S" then
    return nasdaq_common_soupbin_tcp_v3_0_size_of.sequenced_data_packet(buffer, offset)
  end
  -- Size of Login Request Packet
  if packet_type == "L" then
    return nasdaq_common_soupbin_tcp_v3_0_size_of.login_request_packet(buffer, offset)
  end
  -- Size of Unsequenced Data Packet
  if packet_type == "U" then
    return nasdaq_common_soupbin_tcp_v3_0_size_of.unsequenced_data_packet(buffer, offset)
  end
...
-- Display: Payload
nasdaq_common_soupbin_tcp_v3_0_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
nasdaq_common_soupbin_tcp_v3_0_dissect.payload_branches = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Debug Packet
  if packet_type == "+" then
    return nasdaq_common_soupbin_tcp_v3_0_dissect.debug_packet(buffer, offset, packet, parent)
  end
  -- Dissect Login Accepted Packet
  if packet_type == "A" then
    return nasdaq_common_soupbin_tcp_v3_0_dissect.login_accepted_packet(buffer, offset, packet, parent)
  end
  -- Dissect Login Rejected Packet
  if packet_type == "J" then
    return nasdaq_common_soupbin_tcp_v3_0_dissect.login_rejected_packet(buffer, offset, packet, parent)
  end
  -- Dissect Sequenced Data Packet
  if packet_type == "S" then
    return nasdaq_common_soupbin_tcp_v3_0_dissect.sequenced_data_packet(buffer, offset, packet, parent)
  end
  -- Dissect Login Request Packet
  if packet_type == "L" then
    return nasdaq_common_soupbin_tcp_v3_0_dissect.login_request_packet(buffer, offset, packet, parent)
  end
  -- Dissect Unsequenced Data Packet
  if packet_type == "U" then
    return nasdaq_common_soupbin_tcp_v3_0_dissect.unsequenced_data_packet(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
nasdaq_common_soupbin_tcp_v3_0_dissect.payload = function(buffer, offset, packet, parent, packet_type)
  if not show.payload then
    return nasdaq_common_soupbin_tcp_v3_0_dissect.payload_branches(buffer, offset, packet, parent, packet_type)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_common_soupbin_tcp_v3_0_size_of.payload(buffer, offset, packet_type)
  if size == 0 then
    return offset
  end
...
-- Size: Packet Type
nasdaq_common_soupbin_tcp_v3_0_size_of.packet_type = 1

-- Display: Packet Type
nasdaq_common_soupbin_tcp_v3_0_display.packet_type = function(value)
  if value == "+" then
...
-- Dissect: Packet Type
nasdaq_common_soupbin_tcp_v3_0_dissect.packet_type = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.packet_type
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Packet Length
nasdaq_common_soupbin_tcp_v3_0_size_of.packet_length = 2

-- Display: Packet Length
nasdaq_common_soupbin_tcp_v3_0_display.packet_length = function(value)
  return "Packet Length: "..value
end

-- Dissect: Packet Length
nasdaq_common_soupbin_tcp_v3_0_dissect.packet_length = function(buffer, offset, packet, parent)
  local length = nasdaq_common_soupbin_tcp_v3_0_size_of.packet_length
  local range = buffer(offset, length)
...
nasdaq_common_soupbin_tcp_v3_0_size_of.packet_header = function(buffer, offset)
  local index = 0

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.packet_length

  index = index + nasdaq_common_soupbin_tcp_v3_0_size_of.packet_type

  return index
end

-- Display: Packet Header
nasdaq_common_soupbin_tcp_v3_0_display.packet_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
nasdaq_common_soupbin_tcp_v3_0_dissect.packet_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Packet Length: 2 Byte Unsigned Fixed Width Integer
  index, packet_length = nasdaq_common_soupbin_tcp_v3_0_dissect.packet_length(buffer, index, packet, parent)

  -- Packet Type: 1 Byte Ascii String Enum with 10 values
  index, packet_type = nasdaq_common_soupbin_tcp_v3_0_dissect.packet_type(buffer, index, packet, parent)
...
nasdaq_common_soupbin_tcp_v3_0_dissect.packet_header = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_common_soupbin_tcp_v3_0.fields.packet_header, buffer(offset, 0))
    local index = nasdaq_common_soupbin_tcp_v3_0_dissect.packet_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_common_soupbin_tcp_v3_0_display.packet_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_common_soupbin_tcp_v3_0_dissect.packet_header_fields(buffer, offset, packet, element)
  end
end

-- Display: Soup Bin Tcp Packet
nasdaq_common_soupbin_tcp_v3_0_display.soup_bin_tcp_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Soup Bin Tcp Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.soup_bin_tcp_packet_fields = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset

  -- Packet Header: Struct of 2 fields
  index, packet_header = nasdaq_common_soupbin_tcp_v3_0_dissect.packet_header(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 6 branches
  index = nasdaq_common_soupbin_tcp_v3_0_dissect.payload(buffer, index, packet, parent, packet_type)

  return index
end

-- Dissect: Soup Bin Tcp Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.soup_bin_tcp_packet = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
...
local soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_common_soupbin_tcp_v3_0_size_of.packet_header(buffer, index) then
...
-- Dissect Packet
nasdaq_common_soupbin_tcp_v3_0_dissect.packet = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_common_soupbin_tcp_v3_0_dissect.soup_bin_tcp_packet(buffer, index, packet, parent, size_of_soup_bin_tcp_packet)
    else
