...
-- Dissect: Message
nasdaq_phlxoptions_topo_itch_v3_3.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_phlxoptions_topo_itch_v3_3.fields.message, range, display)
  end
