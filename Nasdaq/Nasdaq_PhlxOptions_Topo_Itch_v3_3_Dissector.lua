...
-- Nasdaq PhlxOptions Topo 3.3 Application Messages
...
-----------------------------------------------------------------------
-- Nasdaq PhlxOptions Topo Itch 3.3 Formatting
-----------------------------------------------------------------------
...
nasdaq_phlxoptions_topo_itch_v3_3.timestamp_format = 2
...
omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")

omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.timestamp_format = Pref.enum("Nanoseconds Format", 2, "Nanoseconds display format", timestamp_format_enum, false)
omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_headers then
    show.headers = omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_structs then
    show.structs = omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_indexes then
    show.indexes = omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.show_indexes
  end
  if nasdaq_phlxoptions_topo_itch_v3_3.timestamp_format ~= omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.timestamp_format then
    nasdaq_phlxoptions_topo_itch_v3_3.timestamp_format = omi_nasdaq_phlxoptions_topo_itch_v3_3.prefs.timestamp_format
  end
...
nasdaq_phlxoptions_topo_itch_v3_3.conversation.key = function(packet)
...
nasdaq_phlxoptions_topo_itch_v3_3.conversation.data = function(packet)
  local key = nasdaq_phlxoptions_topo_itch_v3_3.conversation.key(packet)
  local data = nasdaq_phlxoptions_topo_itch_v3_3.conversation.flows[key]
  if data == nil then
    data = { second = { last = nil, frames = {} } }
    nasdaq_phlxoptions_topo_itch_v3_3.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_phlxoptions_topo_itch_v3_3.conversation.current = nil
...
-- Store: Second
nasdaq_phlxoptions_topo_itch_v3_3.second.current = nil
...
nasdaq_phlxoptions_topo_itch_v3_3.timestamp.display = function(nanoseconds, stored_second, packet)
  -- Raw display mode
  if nasdaq_phlxoptions_topo_itch_v3_3.timestamp_format == 0 then
    return "Timestamp: "..(stored_second * 1000000000 + nanoseconds)
  end

  -- Full datetime mode (calculate from capture date + UTC offset)
  if nasdaq_phlxoptions_topo_itch_v3_3.timestamp_format == 2 and packet then
...
nasdaq_phlxoptions_topo_itch_v3_3.timestamp.composite = function(buffer, offset, stored_second, packet, parent)
  ...
  local display = nasdaq_phlxoptions_topo_itch_v3_3.timestamp.display(nanoseconds, stored_second, packet)
...
nasdaq_phlxoptions_topo_itch_v3_3.timestamp.dissect = function(buffer, offset, packet, parent)
  local stored_second = nasdaq_phlxoptions_topo_itch_v3_3.second.current
...
nasdaq_phlxoptions_topo_itch_v3_3.timestamp_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Store Second Value
  nasdaq_phlxoptions_topo_itch_v3_3.second.current = second

  if not packet.visited then
    nasdaq_phlxoptions_topo_itch_v3_3.conversation.current.second.last = second
  end
...
nasdaq_phlxoptions_topo_itch_v3_3.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_phlxoptions_topo_itch_v3_3.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_phlxoptions_topo_itch_v3_3.message.size(buffer, offset)
...
-- End Of Session
nasdaq_phlxoptions_topo_itch_v3_3.end_of_session = {}

-- Display: End Of Session
nasdaq_phlxoptions_topo_itch_v3_3.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_phlxoptions_topo_itch_v3_3.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_phlxoptions_topo_itch_v3_3.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_phlxoptions_topo_itch_v3_3.heartbeat = {}

-- Display: Heartbeat
nasdaq_phlxoptions_topo_itch_v3_3.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_phlxoptions_topo_itch_v3_3.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_phlxoptions_topo_itch_v3_3.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
-- Messages
nasdaq_phlxoptions_topo_itch_v3_3.messages = {}

-- Dissect: Messages
nasdaq_phlxoptions_topo_itch_v3_3.messages.dissect = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
    return nasdaq_phlxoptions_topo_itch_v3_3.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_phlxoptions_topo_itch_v3_3.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, message_count do
    ...
    offset = nasdaq_phlxoptions_topo_itch_v3_3.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_phlxoptions_topo_itch_v3_3.packet.dissect = function(buffer, packet, parent)
  ...
  local data = nasdaq_phlxoptions_topo_itch_v3_3.conversation.data(packet)
  if not packet.visited then
    data.second.frames[packet.number] = data.second.last
  end
  nasdaq_phlxoptions_topo_itch_v3_3.second.current = data.second.frames[packet.number]
  nasdaq_phlxoptions_topo_itch_v3_3.conversation.current = data
  ...
  index = nasdaq_phlxoptions_topo_itch_v3_3.messages.dissect(buffer, index, packet, parent, message_count)
