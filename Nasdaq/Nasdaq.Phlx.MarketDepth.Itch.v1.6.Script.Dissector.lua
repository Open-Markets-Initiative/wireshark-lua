...
size_of.quote_replace_long_message = function(buffer, offset)
  local index = 0
...
display.quote_replace_long_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Replace Long Message
dissect.quote_replace_long_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.quote_replace_long_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.quote_replace_long_message then
    local length = size_of.quote_replace_long_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.quote_replace_long_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.quote_replace_long_message, range, display)
  end

  return dissect.quote_replace_long_message_fields(buffer, offset, packet, parent)
end
...
size_of.short_ask_price = 2

-- Display: Short Ask Price
display.short_ask_price = function(value)
  return "Short Ask Price: "..value
end

-- Dissect: Short Ask Price
dissect.short_ask_price = function(buffer, offset, packet, parent)
  local length = size_of.short_ask_price
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.short_ask_price(value, buffer, offset, packet, parent)
...
size_of.short_bid_price = 2

-- Display: Short Bid Price
display.short_bid_price = function(value)
  return "Short Bid Price: "..value
end

-- Dissect: Short Bid Price
dissect.short_bid_price = function(buffer, offset, packet, parent)
  local length = size_of.short_bid_price
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.short_bid_price(value, buffer, offset, packet, parent)
...
size_of.quote_replace_short_message = function(buffer, offset)
  local index = 0
  ...
  index = index + size_of.short_bid_price

  index = index + size_of.short_bid_size

  index = index + size_of.short_ask_price
...
display.quote_replace_short_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Replace Short Message
dissect.quote_replace_short_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, short_bid_price = dissect.short_bid_price(buffer, index, packet, parent)
  ...
  index, short_ask_price = dissect.short_ask_price(buffer, index, packet, parent)
...
dissect.quote_replace_short_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.quote_replace_short_message then
    local length = size_of.quote_replace_short_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.quote_replace_short_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.quote_replace_short_message, range, display)
  end

  return dissect.quote_replace_short_message_fields(buffer, offset, packet, parent)
end
...
size_of.order_replace_long_message = function(buffer, offset)
  local index = 0
...
display.order_replace_long_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Order Replace Long Message
dissect.order_replace_long_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.order_replace_long_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.order_replace_long_message then
    local length = size_of.order_replace_long_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.order_replace_long_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.order_replace_long_message, range, display)
  end

  return dissect.order_replace_long_message_fields(buffer, offset, packet, parent)
end
...
size_of.order_replace_short_message = function(buffer, offset)
  local index = 0
...
display.order_replace_short_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Order Replace Short Message
dissect.order_replace_short_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.order_replace_short_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.order_replace_short_message then
    local length = size_of.order_replace_short_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.order_replace_short_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.order_replace_short_message, range, display)
  end

  return dissect.order_replace_short_message_fields(buffer, offset, packet, parent)
end

-- Calculate size of: Single Side Replace Long Message
size_of.single_side_replace_long_message = function(buffer, offset)
  local index = 0
...
display.single_side_replace_long_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Single Side Replace Long Message
dissect.single_side_replace_long_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.single_side_replace_long_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.single_side_replace_long_message then
    local length = size_of.single_side_replace_long_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.single_side_replace_long_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.single_side_replace_long_message, range, display)
  end

  return dissect.single_side_replace_long_message_fields(buffer, offset, packet, parent)
end

-- Calculate size of: Single Side Replace Short Message
size_of.single_side_replace_short_message = function(buffer, offset)
  local index = 0
...
display.single_side_replace_short_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Single Side Replace Short Message
dissect.single_side_replace_short_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.single_side_replace_short_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.single_side_replace_short_message then
    local length = size_of.single_side_replace_short_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.single_side_replace_short_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.single_side_replace_short_message, range, display)
  end

  return dissect.single_side_replace_short_message_fields(buffer, offset, packet, parent)
end
...
size_of.add_quote_long_message = function(buffer, offset)
  local index = 0
...
display.add_quote_long_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Add Quote Long Message
dissect.add_quote_long_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.add_quote_long_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.add_quote_long_message then
    local length = size_of.add_quote_long_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.add_quote_long_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.add_quote_long_message, range, display)
  end

  return dissect.add_quote_long_message_fields(buffer, offset, packet, parent)
end

-- Calculate size of: Add Quote Short Message
size_of.add_quote_short_message = function(buffer, offset)
  local index = 0
...
display.add_quote_short_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Add Quote Short Message
dissect.add_quote_short_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
dissect.add_quote_short_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.add_quote_short_message then
    local length = size_of.add_quote_short_message(buffer, offset)
    local range = buffer(offset, length)
    local display = display.add_quote_short_message(buffer, packet, parent)
    parent = parent:add(nasdaq_phlx_marketdepth_itch_v1_6.fields.add_quote_short_message, range, display)
  end

  return dissect.add_quote_short_message_fields(buffer, offset, packet, parent)
end
...
size_of.payload = function(buffer, offset, message_type)
  ...
  if message_type == "j" then
    return size_of.add_quote_short_message(buffer, offset)
  end
  -- Size of Add Quote Long Message
  if message_type == "J" then
    return size_of.add_quote_long_message(buffer, offset)
  end
  ...
  if message_type == "u" then
    return size_of.single_side_replace_short_message(buffer, offset)
  end
  -- Size of Single Side Replace Long Message
  if message_type == "U" then
    return size_of.single_side_replace_long_message(buffer, offset)
  end
  -- Size of Order Replace Short Message
  if message_type == "v" then
    return size_of.order_replace_short_message(buffer, offset)
  end
  -- Size of Order Replace Long Message
  if message_type == "V" then
    return size_of.order_replace_long_message(buffer, offset)
  end
  ...
  if message_type == "k" then
    return size_of.quote_replace_short_message(buffer, offset)
  end
  -- Size of Quote Replace Long Message
  if message_type == "K" then
    return size_of.quote_replace_long_message(buffer, offset)
  end
...
dissect.payload_branches = function(buffer, offset, packet, parent, message_type)
  ...
  -- Dissect Add Quote Short Message
  if message_type == "j" then
    return dissect.add_quote_short_message(buffer, offset, packet, parent)
  end
  -- Dissect Add Quote Long Message
  if message_type == "J" then
    return dissect.add_quote_long_message(buffer, offset, packet, parent)
  end
  -- Dissect Single Side Executed Message
  if message_type == "E" then
  ...
  -- Dissect Single Side Replace Short Message
  if message_type == "u" then
    return dissect.single_side_replace_short_message(buffer, offset, packet, parent)
  end
  -- Dissect Single Side Replace Long Message
  if message_type == "U" then
    return dissect.single_side_replace_long_message(buffer, offset, packet, parent)
  end
  -- Dissect Order Replace Short Message
  if message_type == "v" then
    return dissect.order_replace_short_message(buffer, offset, packet, parent)
  end
  -- Dissect Order Replace Long Message
  if message_type == "V" then
    return dissect.order_replace_long_message(buffer, offset, packet, parent)
  end
  -- Dissect Single Side Delete Message
  if message_type == "D" then
  ...
  -- Dissect Quote Replace Short Message
  if message_type == "k" then
    return dissect.quote_replace_short_message(buffer, offset, packet, parent)
  end
  -- Dissect Quote Replace Long Message
  if message_type == "K" then
    return dissect.quote_replace_long_message(buffer, offset, packet, parent)
  end
  -- Dissect Quote Delete Message
  if message_type == "Y" then
