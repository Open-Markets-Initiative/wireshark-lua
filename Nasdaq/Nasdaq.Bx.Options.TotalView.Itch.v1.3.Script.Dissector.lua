...
-- Nasdaq Bx Options TotalView Itch 1.3 Protocol
local nasdaq_bx_options_totalview_itch_v1_3 = Proto("Nasdaq.Bx.Options.TotalView.Itch.v1.3.Lua", "Nasdaq Bx Options TotalView Itch 1.3")
...
-- Nasdaq Bx Options TotalView Itch 1.3 Fields
nasdaq_bx_options_totalview_itch_v1_3.fields.add_order_message_long_form = ProtoField.new("Add Order Message Long Form", "nasdaq.bx.options.totalview.itch.v1.3.addordermessagelongform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.add_order_message_short_form = ProtoField.new("Add Order Message Short Form", "nasdaq.bx.options.totalview.itch.v1.3.addordermessageshortform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.add_quote_message_long_form = ProtoField.new("Add Quote Message Long Form", "nasdaq.bx.options.totalview.itch.v1.3.addquotemessagelongform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.add_quote_message_short_form = ProtoField.new("Add Quote Message Short Form", "nasdaq.bx.options.totalview.itch.v1.3.addquotemessageshortform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.ask = ProtoField.new("Ask", "nasdaq.bx.options.totalview.itch.v1.3.ask", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.ask_price = ProtoField.new("Ask Price", "nasdaq.bx.options.totalview.itch.v1.3.askprice", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.ask_reference_delta_number = ProtoField.new("Ask Reference Delta Number", "nasdaq.bx.options.totalview.itch.v1.3.askreferencedeltanumber", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.ask_reference_number_delta = ProtoField.new("Ask Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.askreferencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.ask_size = ProtoField.new("Ask Size", "nasdaq.bx.options.totalview.itch.v1.3.asksize", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.auction_id = ProtoField.new("Auction Id", "nasdaq.bx.options.totalview.itch.v1.3.auctionid", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.auction_type = ProtoField.new("Auction Type", "nasdaq.bx.options.totalview.itch.v1.3.auctiontype", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.base_reference_message = ProtoField.new("Base Reference Message", "nasdaq.bx.options.totalview.itch.v1.3.basereferencemessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.base_reference_number = ProtoField.new("Base Reference Number", "nasdaq.bx.options.totalview.itch.v1.3.basereferencenumber", ftypes.UINT64)
nasdaq_bx_options_totalview_itch_v1_3.fields.bid = ProtoField.new("Bid", "nasdaq.bx.options.totalview.itch.v1.3.bid", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.bid_price = ProtoField.new("Bid Price", "nasdaq.bx.options.totalview.itch.v1.3.bidprice", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.bid_reference_number_delta = ProtoField.new("Bid Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.bidreferencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.bid_size = ProtoField.new("Bid Size", "nasdaq.bx.options.totalview.itch.v1.3.bidsize", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.block_delete_message = ProtoField.new("Block Delete Message", "nasdaq.bx.options.totalview.itch.v1.3.blockdeletemessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.broken_trade_or_order_execution_message = ProtoField.new("Broken Trade Or Order Execution Message", "nasdaq.bx.options.totalview.itch.v1.3.brokentradeororderexecutionmessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.buy_sell_indicator = ProtoField.new("Buy Sell Indicator", "nasdaq.bx.options.totalview.itch.v1.3.buysellindicator", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.cancelled_contracts = ProtoField.new("Cancelled Contracts", "nasdaq.bx.options.totalview.itch.v1.3.cancelledcontracts", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.change_reason = ProtoField.new("Change Reason", "nasdaq.bx.options.totalview.itch.v1.3.changereason", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.count = ProtoField.new("Count", "nasdaq.bx.options.totalview.itch.v1.3.count", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.cross_number = ProtoField.new("Cross Number", "nasdaq.bx.options.totalview.itch.v1.3.crossnumber", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.cross_type = ProtoField.new("Cross Type", "nasdaq.bx.options.totalview.itch.v1.3.crosstype", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.current_trading_state = ProtoField.new("Current Trading State", "nasdaq.bx.options.totalview.itch.v1.3.currenttradingstate", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.customer_firm_indicator = ProtoField.new("Customer Firm Indicator", "nasdaq.bx.options.totalview.itch.v1.3.customerfirmindicator", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.event_code = ProtoField.new("Event Code", "nasdaq.bx.options.totalview.itch.v1.3.eventcode", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.executed_contracts = ProtoField.new("Executed Contracts", "nasdaq.bx.options.totalview.itch.v1.3.executedcontracts", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.expiration_date = ProtoField.new("Expiration Date", "nasdaq.bx.options.totalview.itch.v1.3.expirationdate", ftypes.UINT8)
nasdaq_bx_options_totalview_itch_v1_3.fields.expiration_month = ProtoField.new("Expiration Month", "nasdaq.bx.options.totalview.itch.v1.3.expirationmonth", ftypes.UINT8)
nasdaq_bx_options_totalview_itch_v1_3.fields.expiration_year = ProtoField.new("Expiration Year", "nasdaq.bx.options.totalview.itch.v1.3.expirationyear", ftypes.UINT8)
nasdaq_bx_options_totalview_itch_v1_3.fields.explicit_strike_price = ProtoField.new("Explicit Strike Price", "nasdaq.bx.options.totalview.itch.v1.3.explicitstrikeprice", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.imbalance_direction = ProtoField.new("Imbalance Direction", "nasdaq.bx.options.totalview.itch.v1.3.imbalancedirection", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.imbalance_price = ProtoField.new("Imbalance Price", "nasdaq.bx.options.totalview.itch.v1.3.imbalanceprice", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.imbalance_volume = ProtoField.new("Imbalance Volume", "nasdaq.bx.options.totalview.itch.v1.3.imbalancevolume", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.length = ProtoField.new("Length", "nasdaq.bx.options.totalview.itch.v1.3.length", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.market_side = ProtoField.new("Market Side", "nasdaq.bx.options.totalview.itch.v1.3.marketside", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.match_number = ProtoField.new("Match Number", "nasdaq.bx.options.totalview.itch.v1.3.matchnumber", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.message = ProtoField.new("Message", "nasdaq.bx.options.totalview.itch.v1.3.message", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.message_header = ProtoField.new("Message Header", "nasdaq.bx.options.totalview.itch.v1.3.messageheader", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.message_type = ProtoField.new("Message Type", "nasdaq.bx.options.totalview.itch.v1.3.messagetype", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.mpv = ProtoField.new("Mpv", "nasdaq.bx.options.totalview.itch.v1.3.mpv", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.net_order_imbalance_indicator_message = ProtoField.new("Net Order Imbalance Indicator Message", "nasdaq.bx.options.totalview.itch.v1.3.netorderimbalanceindicatormessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.new_reference_number_delta = ProtoField.new("New Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.newreferencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.non_auction_options_trade_message = ProtoField.new("Non Auction Options Trade Message", "nasdaq.bx.options.totalview.itch.v1.3.nonauctionoptionstrademessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.open_state = ProtoField.new("Open State", "nasdaq.bx.options.totalview.itch.v1.3.openstate", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.option_directory_message = ProtoField.new("Option Directory Message", "nasdaq.bx.options.totalview.itch.v1.3.optiondirectorymessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.option_id = ProtoField.new("Option Id", "nasdaq.bx.options.totalview.itch.v1.3.optionid", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.option_open_message = ProtoField.new("Option Open Message", "nasdaq.bx.options.totalview.itch.v1.3.optionopenmessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.option_type = ProtoField.new("Option Type", "nasdaq.bx.options.totalview.itch.v1.3.optiontype", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.options_closing_type = ProtoField.new("Options Closing Type", "nasdaq.bx.options.totalview.itch.v1.3.optionsclosingtype", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.options_cross_trade_message = ProtoField.new("Options Cross Trade Message", "nasdaq.bx.options.totalview.itch.v1.3.optionscrosstrademessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.order_cancel_message = ProtoField.new("Order Cancel Message", "nasdaq.bx.options.totalview.itch.v1.3.ordercancelmessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.order_reference_number_delta = ProtoField.new("Order Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.orderreferencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.original_ask_reference_number_delta = ProtoField.new("Original Ask Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.originalaskreferencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.original_bid_reference_number_delta = ProtoField.new("Original Bid Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.originalbidreferencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.original_reference_number_delta = ProtoField.new("Original Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.originalreferencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.packet = ProtoField.new("Packet", "nasdaq.bx.options.totalview.itch.v1.3.packet", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.packet_header = ProtoField.new("Packet Header", "nasdaq.bx.options.totalview.itch.v1.3.packetheader", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.paired_contracts = ProtoField.new("Paired Contracts", "nasdaq.bx.options.totalview.itch.v1.3.pairedcontracts", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.payload = ProtoField.new("Payload", "nasdaq.bx.options.totalview.itch.v1.3.payload", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.price = ProtoField.new("Price", "nasdaq.bx.options.totalview.itch.v1.3.price", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.printable = ProtoField.new("Printable", "nasdaq.bx.options.totalview.itch.v1.3.printable", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.quote_delete_message = ProtoField.new("Quote Delete Message", "nasdaq.bx.options.totalview.itch.v1.3.quotedeletemessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.quote_replace_message_long_form = ProtoField.new("Quote Replace Message Long Form", "nasdaq.bx.options.totalview.itch.v1.3.quotereplacemessagelongform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.quote_replace_message_short_form = ProtoField.new("Quote Replace Message Short Form", "nasdaq.bx.options.totalview.itch.v1.3.quotereplacemessageshortform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.reference_number_delta = ProtoField.new("Reference Number Delta", "nasdaq.bx.options.totalview.itch.v1.3.referencenumberdelta", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.reference_number_deltan = ProtoField.new("Reference Number Deltan", "nasdaq.bx.options.totalview.itch.v1.3.referencenumberdeltan", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.reserved = ProtoField.new("Reserved", "nasdaq.bx.options.totalview.itch.v1.3.reserved", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.second = ProtoField.new("Second", "nasdaq.bx.options.totalview.itch.v1.3.second", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.seconds_message = ProtoField.new("Seconds Message", "nasdaq.bx.options.totalview.itch.v1.3.secondsmessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.security_symbol = ProtoField.new("Security Symbol", "nasdaq.bx.options.totalview.itch.v1.3.securitysymbol", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.sequence = ProtoField.new("Sequence", "nasdaq.bx.options.totalview.itch.v1.3.sequence", ftypes.UINT64)
nasdaq_bx_options_totalview_itch_v1_3.fields.session = ProtoField.new("Session", "nasdaq.bx.options.totalview.itch.v1.3.session", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_delete_message = ProtoField.new("Single Side Delete Message", "nasdaq.bx.options.totalview.itch.v1.3.singlesidedeletemessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_executed_message = ProtoField.new("Single Side Executed Message", "nasdaq.bx.options.totalview.itch.v1.3.singlesideexecutedmessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_order_executed_with_price_message = ProtoField.new("Single Side Order Executed With Price Message", "nasdaq.bx.options.totalview.itch.v1.3.singlesideorderexecutedwithpricemessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_replace_message_long_form = ProtoField.new("Single Side Replace Message Long Form", "nasdaq.bx.options.totalview.itch.v1.3.singlesidereplacemessagelongform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_replace_message_short_form = ProtoField.new("Single Side Replace Message Short Form", "nasdaq.bx.options.totalview.itch.v1.3.singlesidereplacemessageshortform", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_update_message = ProtoField.new("Single Side Update Message", "nasdaq.bx.options.totalview.itch.v1.3.singlesideupdatemessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.source = ProtoField.new("Source", "nasdaq.bx.options.totalview.itch.v1.3.source", ftypes.UINT8)
nasdaq_bx_options_totalview_itch_v1_3.fields.system_event_message = ProtoField.new("System Event Message", "nasdaq.bx.options.totalview.itch.v1.3.systemeventmessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.timestamp = ProtoField.new("Timestamp", "nasdaq.bx.options.totalview.itch.v1.3.timestamp", ftypes.UINT32)
nasdaq_bx_options_totalview_itch_v1_3.fields.total_number_of_reference_number_deltas = ProtoField.new("Total Number Of Reference Number Deltas", "nasdaq.bx.options.totalview.itch.v1.3.totalnumberofreferencenumberdeltas", ftypes.UINT16)
nasdaq_bx_options_totalview_itch_v1_3.fields.tradable = ProtoField.new("Tradable", "nasdaq.bx.options.totalview.itch.v1.3.tradable", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.trading_action_message = ProtoField.new("Trading Action Message", "nasdaq.bx.options.totalview.itch.v1.3.tradingactionmessage", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "nasdaq.bx.options.totalview.itch.v1.3.underlyingsymbol", ftypes.STRING)
nasdaq_bx_options_totalview_itch_v1_3.fields.volume = ProtoField.new("Volume", "nasdaq.bx.options.totalview.itch.v1.3.volume", ftypes.UINT16)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Nasdaq Bx Options TotalView Itch 1.3 Element Dissection Options
...
-- Register Nasdaq Bx Options TotalView Itch 1.3 Show Options
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_order_message_long_form = Pref.bool("Show Add Order Message Long Form", show.add_order_message_long_form, "Parse and add Add Order Message Long Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_order_message_short_form = Pref.bool("Show Add Order Message Short Form", show.add_order_message_short_form, "Parse and add Add Order Message Short Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_quote_message_long_form = Pref.bool("Show Add Quote Message Long Form", show.add_quote_message_long_form, "Parse and add Add Quote Message Long Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_quote_message_short_form = Pref.bool("Show Add Quote Message Short Form", show.add_quote_message_short_form, "Parse and add Add Quote Message Short Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_base_reference_message = Pref.bool("Show Base Reference Message", show.base_reference_message, "Parse and add Base Reference Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_block_delete_message = Pref.bool("Show Block Delete Message", show.block_delete_message, "Parse and add Block Delete Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_broken_trade_or_order_execution_message = Pref.bool("Show Broken Trade Or Order Execution Message", show.broken_trade_or_order_execution_message, "Parse and add Broken Trade Or Order Execution Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_net_order_imbalance_indicator_message = Pref.bool("Show Net Order Imbalance Indicator Message", show.net_order_imbalance_indicator_message, "Parse and add Net Order Imbalance Indicator Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_non_auction_options_trade_message = Pref.bool("Show Non Auction Options Trade Message", show.non_auction_options_trade_message, "Parse and add Non Auction Options Trade Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_option_directory_message = Pref.bool("Show Option Directory Message", show.option_directory_message, "Parse and add Option Directory Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_option_open_message = Pref.bool("Show Option Open Message", show.option_open_message, "Parse and add Option Open Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_options_cross_trade_message = Pref.bool("Show Options Cross Trade Message", show.options_cross_trade_message, "Parse and add Options Cross Trade Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_order_cancel_message = Pref.bool("Show Order Cancel Message", show.order_cancel_message, "Parse and add Order Cancel Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_delete_message = Pref.bool("Show Quote Delete Message", show.quote_delete_message, "Parse and add Quote Delete Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_replace_message_long_form = Pref.bool("Show Quote Replace Message Long Form", show.quote_replace_message_long_form, "Parse and add Quote Replace Message Long Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_replace_message_short_form = Pref.bool("Show Quote Replace Message Short Form", show.quote_replace_message_short_form, "Parse and add Quote Replace Message Short Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_seconds_message = Pref.bool("Show Seconds Message", show.seconds_message, "Parse and add Seconds Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_delete_message = Pref.bool("Show Single Side Delete Message", show.single_side_delete_message, "Parse and add Single Side Delete Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_executed_message = Pref.bool("Show Single Side Executed Message", show.single_side_executed_message, "Parse and add Single Side Executed Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_order_executed_with_price_message = Pref.bool("Show Single Side Order Executed With Price Message", show.single_side_order_executed_with_price_message, "Parse and add Single Side Order Executed With Price Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_replace_message_long_form = Pref.bool("Show Single Side Replace Message Long Form", show.single_side_replace_message_long_form, "Parse and add Single Side Replace Message Long Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_replace_message_short_form = Pref.bool("Show Single Side Replace Message Short Form", show.single_side_replace_message_short_form, "Parse and add Single Side Replace Message Short Form to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_update_message = Pref.bool("Show Single Side Update Message", show.single_side_update_message, "Parse and add Single Side Update Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_system_event_message = Pref.bool("Show System Event Message", show.system_event_message, "Parse and add System Event Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_trading_action_message = Pref.bool("Show Trading Action Message", show.trading_action_message, "Parse and add Trading Action Message to protocol tree")
nasdaq_bx_options_totalview_itch_v1_3.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function nasdaq_bx_options_totalview_itch_v1_3.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.add_order_message_long_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_order_message_long_form then
    show.add_order_message_long_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_order_message_long_form
    changed = true
  end
  if show.add_order_message_short_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_order_message_short_form then
    show.add_order_message_short_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_order_message_short_form
    changed = true
  end
  if show.add_quote_message_long_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_quote_message_long_form then
    show.add_quote_message_long_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_quote_message_long_form
    changed = true
  end
  if show.add_quote_message_short_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_quote_message_short_form then
    show.add_quote_message_short_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_add_quote_message_short_form
    changed = true
  end
  if show.base_reference_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_base_reference_message then
    show.base_reference_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_base_reference_message
    changed = true
  end
  if show.block_delete_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_block_delete_message then
    show.block_delete_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_block_delete_message
    changed = true
  end
  if show.broken_trade_or_order_execution_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_broken_trade_or_order_execution_message then
    show.broken_trade_or_order_execution_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_broken_trade_or_order_execution_message
    changed = true
  end
  if show.message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_message then
    show.message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_message
    changed = true
  end
  if show.message_header ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_message_header then
    show.message_header = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_message_header
    changed = true
  end
  if show.net_order_imbalance_indicator_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_net_order_imbalance_indicator_message then
    show.net_order_imbalance_indicator_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_net_order_imbalance_indicator_message
    changed = true
  end
  if show.non_auction_options_trade_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_non_auction_options_trade_message then
    show.non_auction_options_trade_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_non_auction_options_trade_message
    changed = true
  end
  if show.option_directory_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_option_directory_message then
    show.option_directory_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_option_directory_message
    changed = true
  end
  if show.option_open_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_option_open_message then
    show.option_open_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_option_open_message
    changed = true
  end
  if show.options_cross_trade_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_options_cross_trade_message then
    show.options_cross_trade_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_options_cross_trade_message
    changed = true
  end
  if show.order_cancel_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_order_cancel_message then
    show.order_cancel_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_order_cancel_message
    changed = true
  end
  if show.packet ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_packet then
    show.packet = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_packet
    changed = true
  end
  if show.packet_header ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_packet_header then
    show.packet_header = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_packet_header
    changed = true
  end
  if show.quote_delete_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_delete_message then
    show.quote_delete_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_delete_message
    changed = true
  end
  if show.quote_replace_message_long_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_replace_message_long_form then
    show.quote_replace_message_long_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_replace_message_long_form
    changed = true
  end
  if show.quote_replace_message_short_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_replace_message_short_form then
    show.quote_replace_message_short_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_quote_replace_message_short_form
    changed = true
  end
  if show.seconds_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_seconds_message then
    show.seconds_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_seconds_message
    changed = true
  end
  if show.single_side_delete_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_delete_message then
    show.single_side_delete_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_delete_message
    changed = true
  end
  if show.single_side_executed_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_executed_message then
    show.single_side_executed_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_executed_message
    changed = true
  end
  if show.single_side_order_executed_with_price_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_order_executed_with_price_message then
    show.single_side_order_executed_with_price_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_order_executed_with_price_message
    changed = true
  end
  if show.single_side_replace_message_long_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_replace_message_long_form then
    show.single_side_replace_message_long_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_replace_message_long_form
    changed = true
  end
  if show.single_side_replace_message_short_form ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_replace_message_short_form then
    show.single_side_replace_message_short_form = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_replace_message_short_form
    changed = true
  end
  if show.single_side_update_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_update_message then
    show.single_side_update_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_single_side_update_message
    changed = true
  end
  if show.system_event_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_system_event_message then
    show.system_event_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_system_event_message
    changed = true
  end
  if show.trading_action_message ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_trading_action_message then
    show.trading_action_message = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_trading_action_message
    changed = true
  end
  if show.payload ~= nasdaq_bx_options_totalview_itch_v1_3.prefs.show_payload then
    show.payload = nasdaq_bx_options_totalview_itch_v1_3.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Nasdaq Bx Options TotalView Itch 1.3
-----------------------------------------------------------------------
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.reserved, range, value, display)
...
dissect.customer_firm_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.customer_firm_indicator, range, value, display)
...
dissect.imbalance_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.imbalance_volume, range, value, display)
...
dissect.imbalance_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.imbalance_price, range, value, display)
...
dissect.option_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.option_id, range, value, display)
...
dissect.imbalance_direction = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.imbalance_direction, range, value, display)
...
dissect.paired_contracts = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.paired_contracts, range, value, display)
...
dissect.auction_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.auction_type, range, value, display)
...
dissect.auction_id = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.auction_id, range, value, display)
...
dissect.timestamp = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.timestamp, range, value, display)
...
dissect.net_order_imbalance_indicator_message = function(buffer, offset, packet, parent)
  ...
  if show.net_order_imbalance_indicator_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.net_order_imbalance_indicator_message, range, display)
  end
...
dissect.match_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.match_number, range, value, display)
...
dissect.cross_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.cross_number, range, value, display)
...
dissect.broken_trade_or_order_execution_message = function(buffer, offset, packet, parent)
  ...
  if show.broken_trade_or_order_execution_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.broken_trade_or_order_execution_message, range, display)
  end
...
dissect.volume = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.volume, range, value, display)
...
dissect.price = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.price, range, value, display)
...
dissect.cross_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.cross_type, range, value, display)
...
dissect.options_cross_trade_message = function(buffer, offset, packet, parent)
  ...
  if show.options_cross_trade_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.options_cross_trade_message, range, display)
  end
...
dissect.buy_sell_indicator = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.buy_sell_indicator, range, value, display)
...
dissect.non_auction_options_trade_message = function(buffer, offset, packet, parent)
  ...
  if show.non_auction_options_trade_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.non_auction_options_trade_message, range, display)
  end
...
dissect.reference_number_deltan = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.reference_number_deltan, range, value, display)
...
dissect.total_number_of_reference_number_deltas = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.total_number_of_reference_number_deltas, range, value, display)
...
dissect.block_delete_message = function(buffer, offset, packet, parent)
  ...
  if show.block_delete_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.block_delete_message, range, display)
  end
...
dissect.ask_reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.ask_reference_number_delta, range, value, display)
...
dissect.bid_reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.bid_reference_number_delta, range, value, display)
...
dissect.quote_delete_message = function(buffer, offset, packet, parent)
  ...
  if show.quote_delete_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.quote_delete_message, range, display)
  end
...
dissect.ask_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.ask_size, range, value, display)
...
dissect.ask_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.ask_price, range, value, display)
...
dissect.bid_size = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.bid_size, range, value, display)
...
dissect.bid_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.bid_price, range, value, display)
...
dissect.ask_reference_delta_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.ask_reference_delta_number, range, value, display)
...
dissect.original_ask_reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.original_ask_reference_number_delta, range, value, display)
...
dissect.original_bid_reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.original_bid_reference_number_delta, range, value, display)
...
dissect.quote_replace_message_long_form = function(buffer, offset, packet, parent)
  ...
  if show.quote_replace_message_long_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.quote_replace_message_long_form, range, display)
  end
...
dissect.quote_replace_message_short_form = function(buffer, offset, packet, parent)
  ...
  if show.quote_replace_message_short_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.quote_replace_message_short_form, range, display)
  end
...
dissect.change_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.change_reason, range, value, display)
...
dissect.reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.reference_number_delta, range, value, display)
...
dissect.single_side_update_message = function(buffer, offset, packet, parent)
  ...
  if show.single_side_update_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_update_message, range, display)
  end
...
dissect.single_side_delete_message = function(buffer, offset, packet, parent)
  ...
  if show.single_side_delete_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_delete_message, range, display)
  end
...
dissect.new_reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.new_reference_number_delta, range, value, display)
...
dissect.original_reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.original_reference_number_delta, range, value, display)
...
dissect.single_side_replace_message_long_form = function(buffer, offset, packet, parent)
  ...
  if show.single_side_replace_message_long_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_replace_message_long_form, range, display)
  end
...
dissect.single_side_replace_message_short_form = function(buffer, offset, packet, parent)
  ...
  if show.single_side_replace_message_short_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_replace_message_short_form, range, display)
  end
...
dissect.cancelled_contracts = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.cancelled_contracts, range, value, display)
...
dissect.order_reference_number_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.order_reference_number_delta, range, value, display)
...
dissect.order_cancel_message = function(buffer, offset, packet, parent)
  ...
  if show.order_cancel_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.order_cancel_message, range, display)
  end
...
dissect.printable = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.printable, range, value, display)
...
dissect.single_side_order_executed_with_price_message = function(buffer, offset, packet, parent)
  ...
  if show.single_side_order_executed_with_price_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_order_executed_with_price_message, range, display)
  end
...
dissect.executed_contracts = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.executed_contracts, range, value, display)
...
dissect.single_side_executed_message = function(buffer, offset, packet, parent)
  ...
  if show.single_side_executed_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.single_side_executed_message, range, display)
  end
...
dissect.ask = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.ask, range, value, display)
...
dissect.bid = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.bid, range, value, display)
...
dissect.add_quote_message_long_form = function(buffer, offset, packet, parent)
  ...
  if show.add_quote_message_long_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.add_quote_message_long_form, range, display)
  end
...
dissect.add_quote_message_short_form = function(buffer, offset, packet, parent)
  ...
  if show.add_quote_message_short_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.add_quote_message_short_form, range, display)
  end
...
dissect.market_side = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.market_side, range, value, display)
...
dissect.add_order_message_long_form = function(buffer, offset, packet, parent)
  ...
  if show.add_order_message_long_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.add_order_message_long_form, range, display)
  end
...
dissect.add_order_message_short_form = function(buffer, offset, packet, parent)
  ...
  if show.add_order_message_short_form then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.add_order_message_short_form, range, display)
  end
...
dissect.open_state = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.open_state, range, value, display)
...
dissect.option_open_message = function(buffer, offset, packet, parent)
  ...
  if show.option_open_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.option_open_message, range, display)
  end
...
dissect.current_trading_state = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.current_trading_state, range, value, display)
...
dissect.trading_action_message = function(buffer, offset, packet, parent)
  ...
  if show.trading_action_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.trading_action_message, range, display)
  end
...
dissect.mpv = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.mpv, range, value, display)
...
dissect.tradable = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.tradable, range, value, display)
...
dissect.options_closing_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.options_closing_type, range, value, display)
...
dissect.underlying_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.underlying_symbol, range, value, display)
...
dissect.source = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.source, range, value, display)
...
dissect.option_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.option_type, range, value, display)
...
dissect.explicit_strike_price = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.explicit_strike_price, range, value, display)
...
dissect.expiration_date = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.expiration_date, range, value, display)
...
dissect.expiration_month = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.expiration_month, range, value, display)
...
dissect.expiration_year = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.expiration_year, range, value, display)
...
dissect.security_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.security_symbol, range, value, display)
...
dissect.option_directory_message = function(buffer, offset, packet, parent)
  ...
  if show.option_directory_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.option_directory_message, range, display)
  end
...
dissect.base_reference_number = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.base_reference_number, range, value, display)
...
dissect.base_reference_message = function(buffer, offset, packet, parent)
  ...
  if show.base_reference_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.base_reference_message, range, display)
  end
...
display.event_code = function(value)
  ...
  if value == "S" then
    return "Event Code: Start Of System Hours This Message Indicates That Bx Is Open And Ready To Start Accepting Orders (S)"
  end
  if value == "Q" then
    return "Event Code: Start Of Opening Process This Message Is Intended To Indicate That Bx Has Started Its Opening Auction Process (Q)"
  end
  if value == "N" then
    return "Event Code: End Of Normal Hours Processing This Message Is Intended To Indicate That Bx Will No Longer Accept Any New Orders Or Changes To Existing Orders For Options That Trade During Normal Trading Hours (N)"
  end
  if value == "L" then
    return "Event Code: End Of Late Hours Processing This Message Is Intended To Indicate That Bx Will No Longer Accept Any New Orders Or Changes To Existing Orders For Options That Trade During Extended Hours (L)"
  end
  if value == "E" then
    return "Event Code: End Of System Hours This Message Indicates That Bx Options System Is Now Closed (E)"
  end
  if value == "C" then
...
dissect.event_code = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.event_code, range, value, display)
...
dissect.system_event_message = function(buffer, offset, packet, parent)
  ...
  if show.system_event_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.system_event_message, range, display)
  end
...
dissect.second = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.second, range, value, display)
...
dissect.seconds_message = function(buffer, offset, packet, parent)
  ...
  if show.seconds_message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.seconds_message, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, code)
  ...
  local element = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.payload, range, display)
...
dissect.message_type = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.message_type, range, value, display)
...
dissect.length = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.length, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.message_header, range, display)
  end
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.message, range, display)
  end
...
dissect.count = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.count, range, value, display)
...
dissect.sequence = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.sequence, range, value, display)
...
dissect.session = function(buffer, offset, packet, parent)
  ...
  parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.session, range, value, display)
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    ...
    parent = parent:add(nasdaq_bx_options_totalview_itch_v1_3.fields.packet_header, range, display)
  end
...
function nasdaq_bx_options_totalview_itch_v1_3.init()
end

-- Dissector for Nasdaq Bx Options TotalView Itch 1.3
function nasdaq_bx_options_totalview_itch_v1_3.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = nasdaq_bx_options_totalview_itch_v1_3.name

  -- Dissect protocol
  local protocol = parent:add(nasdaq_bx_options_totalview_itch_v1_3, buffer(), nasdaq_bx_options_totalview_itch_v1_3.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, nasdaq_bx_options_totalview_itch_v1_3)
...
verify.nasdaq_bx_options_totalview_itch_v1_3_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Nasdaq Bx Options TotalView Itch 1.3
local function nasdaq_bx_options_totalview_itch_v1_3_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.nasdaq_bx_options_totalview_itch_v1_3_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = nasdaq_bx_options_totalview_itch_v1_3
  nasdaq_bx_options_totalview_itch_v1_3.dissector(buffer, packet, parent)

  return true
end

-- Register Nasdaq Bx Options TotalView Itch 1.3 Heuristic
nasdaq_bx_options_totalview_itch_v1_3:register_heuristic("udp", nasdaq_bx_options_totalview_itch_v1_3_heuristic)
