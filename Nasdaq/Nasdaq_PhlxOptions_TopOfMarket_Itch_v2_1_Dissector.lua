...
local omi_nasdaq_phlxoptions_topofmarket_itch_v2_1 = Proto("Nasdaq.PhlxOptions.TopOfMarket.Itch.v2.1.Lua", "Nasdaq PhlxOptions TopOfMarket Itch 2.1")
...
-- Nasdaq PhlxOptions Itch TopOfMarket 2.1 Application Messages
...
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs_changed()
  ...
  if show.message ~= omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message then
    show.message = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message
  end
  if show.message_header ~= omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message_header then
    show.message_header = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message_header
  end
  if show.packet ~= omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_packet then
    show.packet = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_packet
  end
  if show.packet_header ~= omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_packet_header then
    show.packet_header = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_packet_header
  end
  if show.message_index ~= omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message_index then
    show.message_index = omi_nasdaq_phlxoptions_topofmarket_itch_v2_1.prefs.show_message_index
  end
end
...
-- Display: Timestamp
nasdaq_phlxoptions_topofmarket_itch_v2_1.timestamp.display = function(value)
...
-- Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.payload = {}

-- Dissect: Payload
nasdaq_phlxoptions_topofmarket_itch_v2_1.payload.dissect = function(buffer, offset, packet, parent, message_type)
  -- Dissect System Event Message
...
nasdaq_phlxoptions_topofmarket_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  index = nasdaq_phlxoptions_topofmarket_itch_v2_1.payload.dissect(buffer, index, packet, parent, message_type)
...
udp_table:add(65333, omi_nasdaq_phlxoptions_topofmarket_itch_v2_1)
...
-- Dissector Heuristic for Nasdaq PhlxOptions TopOfMarket Itch 2.1
local function omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_heuristic(buffer, packet, parent)
...
-- Register Heuristic for Nasdaq PhlxOptions TopOfMarket Itch 2.1
omi_nasdaq_phlxoptions_topofmarket_itch_v2_1:register_heuristic("udp", omi_nasdaq_phlxoptions_topofmarket_itch_v2_1_heuristic)
