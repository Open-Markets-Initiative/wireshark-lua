...
omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Timestamp Display Preferences
nasdaq_nsmequities_totalview_itch_v5_0.timestamp_format = 2  -- 0=Raw, 1=TimeOfDay, 2=FullDateTime
nasdaq_nsmequities_totalview_itch_v5_0.utc_offset_hours = 5 -- Hours behind UTC (EST = 5, EDT = 4, UTC = 0)
...
omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC for midnight calculation (EST=5, EDT=4, UTC=0)")
...
function omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs_changed()
  ...
  if show.message_index ~= omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.show_message_index then
    show.message_index = omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.show_message_index
  end

  -- Check Timestamp preferences
  if nasdaq_nsmequities_totalview_itch_v5_0.timestamp_format ~= omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.timestamp_format then
    nasdaq_nsmequities_totalview_itch_v5_0.timestamp_format = omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.timestamp_format
  end
  if nasdaq_nsmequities_totalview_itch_v5_0.utc_offset_hours ~= omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.utc_offset_hours then
    nasdaq_nsmequities_totalview_itch_v5_0.utc_offset_hours = omi_nasdaq_nsmequities_totalview_itch_v5_0.prefs.utc_offset_hours
  end
end
...
-- Display: Timestamp
nasdaq_nsmequities_totalview_itch_v5_0.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_nsmequities_totalview_itch_v5_0.timestamp_format == 0 then
  ...
  if nasdaq_nsmequities_totalview_itch_v5_0.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_nsmequities_totalview_itch_v5_0.utc_offset_hours * 3600
...
nasdaq_nsmequities_totalview_itch_v5_0.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_nsmequities_totalview_itch_v5_0.packet_header.size
end
...
-- Dissector Heuristic for Nasdaq NsmEquities TotalView Itch 5.0 (Udp)
local function omi_nasdaq_nsmequities_totalview_itch_v5_0_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_nsmequities_totalview_itch_v5_0:register_heuristic("udp", omi_nasdaq_nsmequities_totalview_itch_v5_0_udp_heuristic)

-- Register Nasdaq NsmEquities TotalView Itch 5.0 on default port
