...
-- Messages
nasdaq_nsmequities_totalview_itch_v5_0.messages = {}

-- Dissect Branches: Messages
nasdaq_nsmequities_totalview_itch_v5_0.messages.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
...
-- Dissect: Messages
nasdaq_nsmequities_totalview_itch_v5_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  return nasdaq_nsmequities_totalview_itch_v5_0.messages.branches(buffer, offset, packet, parent, message_count)
end
...
nasdaq_nsmequities_totalview_itch_v5_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_nsmequities_totalview_itch_v5_0.messages.dissect(buffer, index, packet, parent, message_count)
