...
-- Dissector Heuristic for Nasdaq MrxOptions SpreadTopOfMarket Itch 2.1
local function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1_heuristic(buffer, packet, parent)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1:register_heuristic("tcp", omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1_heuristic)
