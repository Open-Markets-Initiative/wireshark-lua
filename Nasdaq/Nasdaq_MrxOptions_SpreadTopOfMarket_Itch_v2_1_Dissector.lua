...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.tcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.tcppacketheader", ftypes.STRING)
...
-- Tcp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_payload = {}

-- Dissect: Tcp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_payload.dissect = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Debug Packet
  if packet_type == "+" then
...
-- Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header = {}

-- Size: Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.size =
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  ...
  index, tcp_packet_header = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Tcp Payload: Runtime Type with 10 branches
  index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_payload.dissect(buffer, index, packet, parent, packet_type)
...
local soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.size then
...
-- Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet_header.size
end

-- Dissect Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
...
function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet.dissect(buffer, packet, protocol)
  end
...
local function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  ...
  if not nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tcp_packet.requiredsize(buffer) then return false end
