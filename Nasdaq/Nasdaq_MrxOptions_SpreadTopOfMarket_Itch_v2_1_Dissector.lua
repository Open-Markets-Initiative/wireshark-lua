...
local omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1 = Proto("Omi.Nasdaq.MrxOptions.SpreadTopOfMarket.Itch.v2.1", "Nasdaq MrxOptions SpreadTopOfMarket Itch 2.1")
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.clientpackettype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.end_of_replay_sequence_number = ProtoField.new("End Of Replay Sequence Number", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.endofreplaysequencenumber", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.explicit_strike_price = ProtoField.new("Explicit Strike Price", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.explicitstrikeprice", ftypes.DOUBLE)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message = ProtoField.new("Message", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.message", ftypes.STRING)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_count = ProtoField.new("Message Count", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.messagecount", ftypes.UINT16)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_header = ProtoField.new("Message Header", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.messageheader", ftypes.STRING)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_length = ProtoField.new("Message Length", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.messagelength", ftypes.UINT16)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_type = ProtoField.new("Message Type", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.messagetype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.price = ProtoField.new("Price", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.price", ftypes.DOUBLE)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.server_packet_type = ProtoField.new("Packet Type", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.serverpackettype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.udp_sequence_number = ProtoField.new("Udp Sequence Number", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.udpsequencenumber", ftypes.UINT64)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.udp_session = ProtoField.new("Udp Session", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.udpsession", ftypes.STRING)
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.strategy_best_ask_update_message = ProtoField.new("Strategy Best Ask Update Message", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.strategybestaskupdatemessage", ftypes.STRING)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.strategy_best_bid_and_ask_update_message = ProtoField.new("Strategy Best Bid And Ask Update Message", "nasdaq.mrxoptions.spreadtopofmarket.itch.v2.1.strategybestbidandaskupdatemessage", ftypes.STRING)
...
-----------------------------------------------------------------------
-- Nasdaq MrxOptions SpreadTopOfMarket Itch 2.1 Formatting
-----------------------------------------------------------------------
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp_format = 2
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_repeating_groups = Pref.bool("Show Repeating Groups", show.repeating_groups, "Parse and add Repeating Groups to protocol tree")
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")

omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_headers then
    show.headers = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_headers
  end
  if show.repeating_groups ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_repeating_groups then
    show.repeating_groups = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_repeating_groups
  end
  ...
  if show.structs ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_structs then
    show.structs = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_indexes then
    show.indexes = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_indexes
  end
  if nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp_format ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.timestamp_format then
    nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp_format = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.timestamp_format
  end
  if nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.utc_offset_hours ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.utc_offset_hours then
    nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.utc_offset_hours = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.utc_offset_hours
  end
end
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number = {}

-- Size: Accepted Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number.size = 20

-- Display: Accepted Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number.display = function(value)
  return "Accepted Sequence Number: "..value
end

-- Dissect: Accepted Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.accepted_sequence_number, range, value, display)

  return offset + length, value
end

-- Accepted Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session = {}

-- Size: Accepted Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session.size = 10

-- Display: Accepted Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session.display = function(value)
  return "Accepted Session: "..value
end

-- Dissect: Accepted Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.accepted_session, range, value, display)
...
-- Client Packet Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.client_packet_type, range, value, display)
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number = {}

-- Size: End Of Replay Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number.size = 20

-- Display: End Of Replay Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number.display = function(value)
  return "End Of Replay Sequence Number: "..value
end

-- Dissect: End Of Replay Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.end_of_replay_sequence_number, range, value, display)
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.explicit_strike_price.translate = function(raw)
  return raw/10000
end
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.explicit_strike_price.dissect = function(buffer, offset, packet, parent)
  ...
  local value = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.explicit_strike_price.translate(raw)
...
-- Message Count
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count = {}

-- Size: Message Count
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count.size = 2

-- Display: Message Count
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count.display = function(value)
  return "Message Count: "..value
end

-- Dissect: Message Count
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_count, range, value, display)

  return offset + length, value
end

-- Message Length
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length = {}

-- Size: Message Length
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length.size = 2

-- Display: Message Length
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length.display = function(value)
  return "Message Length: "..value
end

-- Dissect: Message Length
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_length, range, value, display)

  return offset + length, value
end

-- Message Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type = {}

-- Size: Message Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type.size = 1

-- Display: Message Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type.display = function(value)
  if value == "S" then
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_type, range, value, display)
...
-- Translate: Price
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.price.translate = function(raw)
  return raw/10000
end
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.price.dissect = function(buffer, offset, packet, parent)
  ...
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.price.translate(raw)
...
-- Server Packet Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.server_packet_type, range, value, display)
...
-- Display: Timestamp
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp_format == 0 then
  ...
  if nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.utc_offset_hours * 3600
...
-- Udp Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number = {}

-- Size: Udp Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number.size = 8

-- Display: Udp Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number.display = function(value)
  return "Udp Sequence Number: "..value
end

-- Dissect: Udp Sequence Number
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.udp_sequence_number, range, value, display)

  return offset + length, value
end

-- Udp Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session = {}

-- Size: Udp Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session.size = 10

-- Display: Udp Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session.display = function(value)
...
-- Dissect: Udp Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session.size
  local range = buffer(offset, length)
  ...
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.udp_session, range, value, display)
...
-- Unsequenced Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.unsequenced_message = {}

-- Display: Unsequenced Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.unsequenced_message.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.unsequenced_message.display(value, packet, parent, size)

  parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.unsequenced_message, range, value, display)
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message = {}

-- Size: Strategy Best Ask Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.size =
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Best Ask Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.strategy_best_ask_update_message, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Strategy Best Bid Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message = {}

-- Size: Strategy Best Bid Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tracking_number.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_id.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.quote_condition.size + 
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Best Bid Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.strategy_best_bid_update_message, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.fields(buffer, offset, packet, parent)
  end
end

-- Strategy Best Bid And Ask Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message = {}

-- Size: Strategy Best Bid And Ask Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.tracking_number.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.timestamp.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_id.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.quote_condition.size + 
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Strategy Best Bid And Ask Update Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.strategy_best_bid_and_ask_update_message, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.fields(buffer, offset, packet, parent)
  end
end
...
-- Udp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_payload = {}

-- Dissect: Udp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_payload.dissect = function(buffer, offset, packet, parent, message_type)
  -- Dissect System Event Message
  ...
  if message_type == "E" then
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_and_ask_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Strategy Best Bid Update Message
  if message_type == "c" then
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_bid_update_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Strategy Best Ask Update Message
  if message_type == "d" then
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.strategy_best_ask_update_message.dissect(buffer, offset, packet, parent)
  end
...
-- Message Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header = {}

-- Size: Message Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type.size

-- Display: Message Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Length: 2 Byte Unsigned Fixed Width Integer
  index, message_length = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_length.dissect(buffer, index, packet, parent)

  -- Message Type: 1 Byte Ascii String Enum with 6 values
  index, message_type = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Message Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.fields(buffer, offset, packet, parent)
  end
end

-- Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message = {}

-- Read runtime size of: Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.size = function(buffer, offset)
  local index = offset
...
-- Display: Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset

  -- Implicit Message Index
  if message_index ~= nil and show.indexes then
    local iteration = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message_index, message_index)
    iteration:set_generated()
  end

  -- Message Header: Struct of 2 fields
  index, message_header = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Message Type
  local message_type = buffer(index - 1, 1):string()

  -- Udp Payload: Runtime Type with 6 branches
  index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_payload.dissect(buffer, index, packet, parent, message_type)

  return index
end

-- Dissect: Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.size(buffer, offset)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.message, buffer(offset, 0))
    local current = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    parent:set_len(size_of_message)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
-- End Of Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_session = {}

-- Display: End Of Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.heartbeat = {}

-- Display: Heartbeat
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
-- Messages
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.messages = {}

-- Dissect: Messages
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, message_count do
    ...
    offset = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
-- Udp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header = {}

-- Size: Udp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count.size

-- Display: Udp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Udp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Udp Session: 10 Byte Ascii String
  index, udp_session = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_session.dissect(buffer, index, packet, parent)

  -- Udp Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, udp_sequence_number = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_sequence_number.dissect(buffer, index, packet, parent)

  -- Message Count: 2 Byte Unsigned Fixed Width Integer
  index, message_count = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.message_count.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Udp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.udp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Mold Udp 64 Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.mold_udp_64_packet = {}

-- Verify required size of Udp packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.mold_udp_64_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.size
end

-- Dissect Mold Udp 64 Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.mold_udp_64_packet.dissect = function(buffer, packet, parent)
  local index = 0

  -- Udp Packet Header: Struct of 3 fields
  index, udp_packet_header = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.udp_packet_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Message Count
  local message_count = buffer(index - 2, 2):uint()

  -- Messages: Runtime Type with 3 branches
  index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.messages.dissect(buffer, index, packet, parent, message_count)
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number.size

-- Display: End Of Replay Sequence Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: End Of Replay Sequence Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- End Of Replay Sequence Number: Alphanumeric
  index, end_of_replay_sequence_number = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_number.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: End Of Replay Sequence Message
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.end_of_replay_sequence_message, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.sequenced_message.dissect = function(buffer, offset, packet, parent, sequenced_message_type)
  ...
  if sequenced_message_type == "M" then
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.end_of_replay_sequence_message.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.login_accepted_packet.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number.size
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  ...
  index, accepted_session = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_session.dissect(buffer, index, packet, parent)

  -- Accepted Sequence Number: 20 Byte Ascii String
  index, accepted_sequence_number = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.accepted_sequence_number.dissect(buffer, index, packet, parent)
...
-- Server Tcp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_payload = {}

-- Dissect: Server Tcp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header = {}

-- Size: Server Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type.size

-- Display: Server Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, server_packet_type = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Server Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.server_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Tcp Packet Header: Struct of 2 fields
  index, server_tcp_packet_header = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.size then
...
-- Server Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet_header.size
end

-- Dissect Server Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
-- Client Tcp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_payload = {}

-- Dissect: Client Tcp Payload
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header = {}

-- Size: Client Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.size =
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type.size

-- Display: Client Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Client Tcp Packet Header
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.client_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Tcp Packet Header: Struct of 2 fields
  index, client_tcp_packet_header = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet_header.size
end

-- Dissect Client Tcp Packet
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
-- Connection roles for Nasdaq MrxOptions SpreadTopOfMarket Itch 2.1: Client is the initiator, Server is the acceptor
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.role = function(packet)
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.swap = function(packet)
  local key = conversation(packet)
...
nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet.fingerprint = function(buffer)
...
local function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.client_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions SpreadTopOfMarket Itch 2.1 (Tcp)
local function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.server_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions SpreadTopOfMarket Itch 2.1 (Udp)
local function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1_udp_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.mold_udp_64_packet.requiredsize(buffer) then return false end
