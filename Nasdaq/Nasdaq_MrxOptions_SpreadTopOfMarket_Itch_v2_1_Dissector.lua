...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_mold_udp_64_packet = Pref.bool("Show Mold Udp 64 Packet", show.mold_udp_64_packet, "Parse and add Mold Udp 64 Packet to protocol tree")
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_tcp_packet = Pref.bool("Show Tcp Packet", show.tcp_packet, "Parse and add Tcp Packet to protocol tree")
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_tcp_packet_header = Pref.bool("Show Tcp Packet Header", show.tcp_packet_header, "Parse and add Tcp Packet Header to protocol tree")
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_udp_packet_header = Pref.bool("Show Udp Packet Header", show.udp_packet_header, "Parse and add Udp Packet Header to protocol tree")
...
omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs_changed()
  ...
  if show.message ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message then
    show.message = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message
  end
  if show.message_header ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message_header then
    show.message_header = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message_header
  end
  if show.mold_udp_64_packet ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_mold_udp_64_packet then
    show.mold_udp_64_packet = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_mold_udp_64_packet
  end
  ...
  if show.tcp_packet ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_tcp_packet then
    show.tcp_packet = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_tcp_packet
  end
  if show.tcp_packet_header ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_tcp_packet_header then
    show.tcp_packet_header = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_tcp_packet_header
  end
  if show.udp_packet_header ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_udp_packet_header then
    show.udp_packet_header = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_udp_packet_header
  end
  ...
  if show.message_index ~= omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message_index then
    show.message_index = omi_nasdaq_mrxoptions_spreadtopofmarket_itch_v2_1.prefs.show_message_index
  end
end
