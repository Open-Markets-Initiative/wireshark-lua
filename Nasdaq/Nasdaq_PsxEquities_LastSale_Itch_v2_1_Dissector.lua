...
local omi_nasdaq_psxequities_lastsale_itch_v2_1 = Proto("Omi.Nasdaq.PsxEquities.LastSale.Itch.v2.1", "Nasdaq PsxEquities LastSale Itch 2.1")
...
-- Nasdaq PsxEquities Itch LastSale 2.1 Application Messages
...
omi_nasdaq_psxequities_lastsale_itch_v2_1.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_nasdaq_psxequities_lastsale_itch_v2_1.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nasdaq_psxequities_lastsale_itch_v2_1.prefs_changed()
  ...
  if show.application_messages ~= omi_nasdaq_psxequities_lastsale_itch_v2_1.prefs.show_application_messages then
    show.application_messages = omi_nasdaq_psxequities_lastsale_itch_v2_1.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_nasdaq_psxequities_lastsale_itch_v2_1.prefs.show_message_index then
    show.message_index = omi_nasdaq_psxequities_lastsale_itch_v2_1.prefs.show_message_index
  end
end
...
nasdaq_psxequities_lastsale_itch_v2_1.trade_correction_for_next_shares_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Original Trade Control Number: Alpha
  ...
  -- Original Sale Condition Modifier: Alpha
  ...
  -- Corrected Trade Control Number: Alpha
  ...
  -- Corrected Sale Condition Modifier: Alpha
...
nasdaq_psxequities_lastsale_itch_v2_1.next_shares_trade_report_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Sale Condition Modifier Level 1: Alpha
  ...
  -- Sale Condition Modifier Level 2: Alpha
  ...
  -- Sale Condition Modifier Level 3: Alpha
  ...
  -- Sale Condition Modifier Level 4: Alpha
...
nasdaq_psxequities_lastsale_itch_v2_1.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_psxequities_lastsale_itch_v2_1.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_psxequities_lastsale_itch_v2_1.message.size(buffer, offset)
...
-- Messages
nasdaq_psxequities_lastsale_itch_v2_1.messages = {}

-- Dissect: Messages
nasdaq_psxequities_lastsale_itch_v2_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  ...
  for message_index = 1, message_count do
    ...
    offset = nasdaq_psxequities_lastsale_itch_v2_1.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_psxequities_lastsale_itch_v2_1.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_psxequities_lastsale_itch_v2_1.messages.dissect(buffer, index, packet, parent, message_count)
