...
-- Dissector Heuristic for Nasdaq MrxOptions DepthOfMarket Itch 2.1
local function omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_heuristic(buffer, packet, parent)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1:register_heuristic("udp", omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_heuristic)
