...
local omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1 = Proto("Omi.Nasdaq.MrxOptions.DepthOfMarket.Itch.v2.1", "Nasdaq MrxOptions DepthOfMarket Itch 2.1")
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.accepted_sequence_number = ProtoField.new("Accepted Sequence Number", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.acceptedsequencenumber", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.accepted_session = ProtoField.new("Accepted Session", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.acceptedsession", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.client_packet_type = ProtoField.new("Packet Type", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.clientpackettype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.end_of_replay_sequence_number = ProtoField.new("End Of Replay Sequence Number", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.endofreplaysequencenumber", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.packet_length = ProtoField.new("Packet Length", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.packetlength", ftypes.UINT16)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.password = ProtoField.new("Password", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.password", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.reject_reason_code = ProtoField.new("Reject Reason Code", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.rejectreasoncode", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.requested_sequence_number = ProtoField.new("Requested Sequence Number", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.requestedsequencenumber", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.requested_session = ProtoField.new("Requested Session", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.requestedsession", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.sequenced_message_type = ProtoField.new("Sequenced Message Type", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.sequencedmessagetype", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.server_packet_type = ProtoField.new("Packet Type", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.serverpackettype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.text = ProtoField.new("Text", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.text", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.udp_sequence_number = ProtoField.new("Udp Sequence Number", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.udpsequencenumber", ftypes.UINT64)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.udp_session = ProtoField.new("Udp Session", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.udpsession", ftypes.STRING)
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.unsequenced_message = ProtoField.new("Unsequenced Message", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.unsequencedmessage", ftypes.BYTES)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.unsequenced_message_type = ProtoField.new("Unsequenced Message Type", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.unsequencedmessagetype", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.username = ProtoField.new("Username", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.username", ftypes.STRING)
...
-- Nasdaq MrxOptions DepthOfMarket Itch 2.1 Headers
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.client_soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.clientsoupbintcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.client_tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.clienttcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.client_tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.clienttcppacketheader", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.mold_udp_64_packet = ProtoField.new("Mold Udp 64 Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.moldudp64packet", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.server_soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.serversoupbintcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.server_tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.servertcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.server_tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.servertcppacketheader", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.udp_packet_header = ProtoField.new("Udp Packet Header", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.udppacketheader", ftypes.STRING)

-- Nasdaq MrxOptions DepthOfMarket 2.1 Application Messages
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.end_of_replay_sequence_message = ProtoField.new("End Of Replay Sequence Message", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.endofreplaysequencemessage", ftypes.STRING)
...
-- Nasdaq MrxOptions DepthOfMarket 2.1 Session Messages
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.debug_packet = ProtoField.new("Debug Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.debugpacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.login_accepted_packet = ProtoField.new("Login Accepted Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.loginacceptedpacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.login_rejected_packet = ProtoField.new("Login Rejected Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.loginrejectedpacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.login_request_packet = ProtoField.new("Login Request Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.loginrequestpacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.sequenced_data_packet = ProtoField.new("Sequenced Data Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.sequenceddatapacket", ftypes.STRING)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.unsequenced_data_packet = ProtoField.new("Unsequenced Data Packet", "nasdaq.mrxoptions.depthofmarket.itch.v2.1.unsequenceddatapacket", ftypes.STRING)
...
-----------------------------------------------------------------------
-- Nasdaq MrxOptions DepthOfMarket Itch 2.1 Formatting
-----------------------------------------------------------------------
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_mrxoptions_depthofmarket_itch_v2_1.utc_offset_hours = 5
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.acceptor_port = Pref.uint("Acceptor Port", 0, "Port the acceptor listens on; 0 resolves each frame's role from its conversation")
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.assume_role = Pref.enum("Assume Role", 0, "Connection role assumed for every frame, for captures that start mid conversation", role_enum, false)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.swap_sides = Pref.bool("Swap Sides", false, "The first frame seen of each conversation was the acceptor's, not the initiator's; for captures that start mid conversation")
...
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_session_messages = Pref.bool("Show Session Messages", show.session_messages, "Parse and add Session Messages to protocol tree")
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")

omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_headers then
    show.headers = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_headers
  end
  if show.session_messages ~= omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_session_messages then
    show.session_messages = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_session_messages
  end
  if show.structs ~= omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_structs then
    show.structs = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_indexes then
    show.indexes = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.show_indexes
  end
  if nasdaq_mrxoptions_depthofmarket_itch_v2_1.timestamp_format ~= omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.timestamp_format then
    nasdaq_mrxoptions_depthofmarket_itch_v2_1.timestamp_format = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.timestamp_format
  end
  if nasdaq_mrxoptions_depthofmarket_itch_v2_1.utc_offset_hours ~= omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.utc_offset_hours then
    nasdaq_mrxoptions_depthofmarket_itch_v2_1.utc_offset_hours = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.utc_offset_hours
  end
end
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number = {}

-- Size: Accepted Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number.size = 20

-- Display: Accepted Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number.display = function(value)
  return "Accepted Sequence Number: "..value
end

-- Dissect: Accepted Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.accepted_sequence_number, range, value, display)

  return offset + length, value
end

-- Accepted Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session = {}

-- Size: Accepted Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session.size = 10

-- Display: Accepted Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session.display = function(value)
  return "Accepted Session: "..value
end

-- Dissect: Accepted Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.accepted_session, range, value, display)
...
-- Client Packet Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type = {}

-- Size: Client Packet Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type.size = 1

-- Display: Client Packet Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type.display = function(value)
  if value == "+" then
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.client_packet_type, range, value, display)
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number = {}

-- Size: End Of Replay Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number.size = 20

-- Display: End Of Replay Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number.display = function(value)
  return "End Of Replay Sequence Number: "..value
end

-- Dissect: End Of Replay Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.end_of_replay_sequence_number, range, value, display)
...
-- Packet Length
nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length = {}

-- Size: Packet Length
nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.size = 2

-- Display: Packet Length
nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.display = function(value)
  return "Packet Length: "..value
end

-- Dissect: Packet Length
nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.packet_length, range, value, display)
...
-- Password
nasdaq_mrxoptions_depthofmarket_itch_v2_1.password = {}

-- Size: Password
nasdaq_mrxoptions_depthofmarket_itch_v2_1.password.size = 10

-- Display: Password
nasdaq_mrxoptions_depthofmarket_itch_v2_1.password.display = function(value)
  return "Password: "..value
end

-- Dissect: Password
nasdaq_mrxoptions_depthofmarket_itch_v2_1.password.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.password.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.password.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.password, range, value, display)
...
-- Reject Reason Code
nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code = {}

-- Size: Reject Reason Code
nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code.size = 1

-- Display: Reject Reason Code
nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code.display = function(value)
  return "Reject Reason Code: "..value
end

-- Dissect: Reject Reason Code
nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.reject_reason_code, range, value, display)

  return offset + length, value
end

-- Requested Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number = {}

-- Size: Requested Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number.size = 20

-- Display: Requested Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number.display = function(value)
  return "Requested Sequence Number: "..value
end

-- Dissect: Requested Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.requested_sequence_number, range, value, display)

  return offset + length, value
end

-- Requested Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session = {}

-- Size: Requested Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session.size = 10

-- Display: Requested Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session.display = function(value)
  return "Requested Session: "..value
end

-- Dissect: Requested Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.requested_session, range, value, display)
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message_type = {}

-- Size: Sequenced Message Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message_type.size = 1

-- Display: Sequenced Message Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message_type.display = function(value)
  if value == "S" then
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.sequenced_message_type, range, value, display)

  return offset + length, value
end

-- Server Packet Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type = {}

-- Size: Server Packet Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type.size = 1

-- Display: Server Packet Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type.display = function(value)
  if value == "+" then
    return "Packet Type: Debug Packet (+)"
  end
  if value == "A" then
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.server_packet_type, range, value, display)
...
-- Text
nasdaq_mrxoptions_depthofmarket_itch_v2_1.text = {}

-- Size: Text
nasdaq_mrxoptions_depthofmarket_itch_v2_1.text.size = 1

-- Display: Text
nasdaq_mrxoptions_depthofmarket_itch_v2_1.text.display = function(value)
  return "Text: "..value
end

-- Dissect: Text
nasdaq_mrxoptions_depthofmarket_itch_v2_1.text.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.text.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.text.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.text, range, value, display)
...
-- Display: Timestamp
nasdaq_mrxoptions_depthofmarket_itch_v2_1.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_mrxoptions_depthofmarket_itch_v2_1.timestamp_format == 0 then
  ...
  if nasdaq_mrxoptions_depthofmarket_itch_v2_1.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_mrxoptions_depthofmarket_itch_v2_1.utc_offset_hours * 3600
...
-- Udp Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number = {}

-- Size: Udp Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number.size = 8

-- Display: Udp Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number.display = function(value)
  return "Udp Sequence Number: "..value
end

-- Dissect: Udp Sequence Number
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.udp_sequence_number, range, value, display)

  return offset + length, value
end

-- Udp Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session = {}

-- Size: Udp Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session.size = 10

-- Display: Udp Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session.display = function(value)
...
-- Dissect: Udp Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session.size
  local range = buffer(offset, length)
  ...
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.udp_session, range, value, display)
...
-- Unsequenced Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message = {}

-- Display: Unsequenced Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message.display = function(value)
  return "Unsequenced Message: "..value
end

-- Dissect runtime sized field: Unsequenced Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message.dissect = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:bytes():tohex(false, " ")
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message.display(value, packet, parent, size)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.unsequenced_message, range, value, display)

  return offset + size, value
end

-- Unsequenced Message Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message_type = {}

-- Size: Unsequenced Message Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message_type.size = 1

-- Display: Unsequenced Message Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message_type.display = function(value)
  return "Unsequenced Message Type: "..value
end

-- Dissect: Unsequenced Message Type
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.unsequenced_message_type, range, value, display)

  return offset + length, value
end

-- Username
nasdaq_mrxoptions_depthofmarket_itch_v2_1.username = {}

-- Size: Username
nasdaq_mrxoptions_depthofmarket_itch_v2_1.username.size = 6

-- Display: Username
nasdaq_mrxoptions_depthofmarket_itch_v2_1.username.display = function(value)
  return "Username: "..value
end

-- Dissect: Username
nasdaq_mrxoptions_depthofmarket_itch_v2_1.username.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.username.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.username.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.username, range, value, display)
...
-- Udp Payload
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_payload = {}

-- Dissect: Udp Payload
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_payload.dissect = function(buffer, offset, packet, parent, message_type)
  -- Dissect System Event Message
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_payload.dissect(buffer, index, packet, parent, message_type)
...
-- End Of Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session = {}

-- Display: End Of Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_mrxoptions_depthofmarket_itch_v2_1.heartbeat = {}

-- Display: Heartbeat
nasdaq_mrxoptions_depthofmarket_itch_v2_1.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_mrxoptions_depthofmarket_itch_v2_1.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
...
-- Udp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header = {}

-- Size: Udp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.message_count.size

-- Display: Udp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Udp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Udp Session: 10 Byte Ascii String
  index, udp_session = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_session.dissect(buffer, index, packet, parent)

  -- Udp Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, udp_sequence_number = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_sequence_number.dissect(buffer, index, packet, parent)
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.headers then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.udp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Mold Udp 64 Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.mold_udp_64_packet = {}

-- Verify required size of Udp packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.mold_udp_64_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.size
end

-- Dissect Mold Udp 64 Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.mold_udp_64_packet.dissect = function(buffer, packet, parent)
  local index = 0

  -- Udp Packet Header: Struct of 3 fields
  index, udp_packet_header = nasdaq_mrxoptions_depthofmarket_itch_v2_1.udp_packet_header.dissect(buffer, index, packet, parent)
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session_packet = {}

-- Display: End Of Session Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session_packet.display = function(packet, parent, length)
  return "End Of Session Packet"
end


-- Dissect: End Of Session Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_heartbeat_packet = {}

-- Display: Server Heartbeat Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_heartbeat_packet.display = function(packet, parent, length)
  return "Server Heartbeat Packet"
end


-- Dissect: Server Heartbeat Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message = {}

-- Size: End Of Replay Sequence Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number.size

-- Display: End Of Replay Sequence Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: End Of Replay Sequence Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- End Of Replay Sequence Number: Alphanumeric
  index, end_of_replay_sequence_number = nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_number.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: End Of Replay Sequence Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.end_of_replay_sequence_message, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.fields(buffer, offset, packet, parent)
  end
end

-- Sequenced Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message = {}

-- Dissect: Sequenced Message
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message.dissect = function(buffer, offset, packet, parent, sequenced_message_type)
  -- Dissect System Event Message
  ...
  -- Dissect End Of Replay Sequence Message
  if sequenced_message_type == "M" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_replay_sequence_message.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet = {}

-- Read runtime size of: Sequenced Data Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.size = function(buffer, offset)
  local index = offset
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequenced Data Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  local index = offset

  -- Sequenced Message Type: 1 Byte Ascii String Enum with 20 values
  index, sequenced_message_type = nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message_type.dissect(buffer, index, packet, parent)

  -- Sequenced Message: Runtime Type with 20 branches
  index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_message.dissect(buffer, index, packet, parent, sequenced_message_type)

  return index
end

-- Dissect: Sequenced Data Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.dissect = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  local size_of_sequenced_data_packet = nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.size(buffer, offset)
  local index = offset + size_of_sequenced_data_packet

  -- Optionally add group/struct element to protocol tree
  if show.session_messages then
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.sequenced_data_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.fields(buffer, offset, packet, parent, size_of_sequenced_data_packet)
    parent:set_len(size_of_sequenced_data_packet)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.fields(buffer, offset, packet, parent, size_of_sequenced_data_packet)
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet = {}

-- Size: Login Rejected Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code.size

-- Display: Login Rejected Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Rejected Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Reject Reason Code: 1 Byte Ascii String
  index, reject_reason_code = nasdaq_mrxoptions_depthofmarket_itch_v2_1.reject_reason_code.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Login Rejected Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.dissect = function(buffer, offset, packet, parent)
  if show.session_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.login_rejected_packet, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.fields(buffer, offset, packet, parent)
  end
end

-- Login Accepted Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet = {}

-- Size: Login Accepted Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number.size

-- Display: Login Accepted Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Accepted Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Accepted Session: 10 Byte Ascii String
  index, accepted_session = nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_session.dissect(buffer, index, packet, parent)

  -- Accepted Sequence Number: 20 Byte Ascii String
  index, accepted_sequence_number = nasdaq_mrxoptions_depthofmarket_itch_v2_1.accepted_sequence_number.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Login Accepted Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.dissect = function(buffer, offset, packet, parent)
  if show.session_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.login_accepted_packet, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.fields(buffer, offset, packet, parent)
  end
end

-- Debug Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet = {}

-- Size: Debug Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.text.size

-- Display: Debug Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Debug Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Text: 1 Byte Ascii String
  index, text = nasdaq_mrxoptions_depthofmarket_itch_v2_1.text.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Debug Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.dissect = function(buffer, offset, packet, parent)
  if show.session_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.debug_packet, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.fields(buffer, offset, packet, parent)
  end
end

-- Server Tcp Payload
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_payload = {}

-- Dissect: Server Tcp Payload
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  -- Dissect Debug Packet
  if server_packet_type == "+" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.debug_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Login Accepted Packet
  if server_packet_type == "A" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_accepted_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Login Rejected Packet
  if server_packet_type == "J" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_rejected_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Sequenced Data Packet
  if server_packet_type == "S" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.sequenced_data_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Server Heartbeat Packet
  if server_packet_type == "H" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session Packet
  if server_packet_type == "Z" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.end_of_session_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header = {}

-- Size: Server Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type.size

-- Display: Server Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Packet Length: 2 Byte Unsigned Fixed Width Integer
  index, packet_length = nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.dissect(buffer, index, packet, parent)

  -- Server Packet Type: 1 Byte Ascii String Enum with 6 values
  index, server_packet_type = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Server Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.server_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Server Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet = {}

-- Display: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset

  -- Server Tcp Packet Header: Struct of 2 fields
  index, server_tcp_packet_header = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_payload.dissect(buffer, index, packet, parent, server_packet_type)

  return index
end

-- Dissect: Server Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
  local index = offset + size_of_server_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.server_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
    parent:set_len(size_of_server_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_server_soup_bin_tcp_packet)
...
local server_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.size then
...
-- Server Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet_header.size
end

-- Dissect Server Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_server_soup_bin_tcp_packet)
    else
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.logout_request_packet = {}

-- Display: Logout Request Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.logout_request_packet.display = function(packet, parent, length)
  return "Logout Request Packet"
end


-- Dissect: Logout Request Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.logout_request_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.logout_request_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_heartbeat_packet = {}

-- Display: Client Heartbeat Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_heartbeat_packet.display = function(packet, parent, length)
  return "Client Heartbeat Packet"
end


-- Dissect: Client Heartbeat Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet = {}

-- Read runtime size of: Unsequenced Data Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.size = function(buffer, offset)
  local index = offset
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Unsequenced Data Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  local index = offset

  -- Unsequenced Message Type: 1 Byte Ascii String
  index, unsequenced_message_type = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message_type.dissect(buffer, index, packet, parent)
  ...
  index, unsequenced_message = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_message.dissect(buffer, index, packet, parent, size_of_unsequenced_message)

  return index
end

-- Dissect: Unsequenced Data Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.dissect = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  local size_of_unsequenced_data_packet = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.size(buffer, offset)
  local index = offset + size_of_unsequenced_data_packet

  -- Optionally add group/struct element to protocol tree
  if show.session_messages then
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.unsequenced_data_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.fields(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
    parent:set_len(size_of_unsequenced_data_packet)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.fields(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet = {}

-- Size: Login Request Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.username.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.password.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number.size

-- Display: Login Request Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Request Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Username: 6 Byte Ascii String
  index, username = nasdaq_mrxoptions_depthofmarket_itch_v2_1.username.dissect(buffer, index, packet, parent)

  -- Password: 10 Byte Ascii String
  index, password = nasdaq_mrxoptions_depthofmarket_itch_v2_1.password.dissect(buffer, index, packet, parent)

  -- Requested Session: 10 Byte Ascii String
  index, requested_session = nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_session.dissect(buffer, index, packet, parent)

  -- Requested Sequence Number: 20 Byte Ascii String
  index, requested_sequence_number = nasdaq_mrxoptions_depthofmarket_itch_v2_1.requested_sequence_number.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Login Request Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.dissect = function(buffer, offset, packet, parent)
  if show.session_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.login_request_packet, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.fields(buffer, offset, packet, parent)
  end
end

-- Client Tcp Payload
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_payload = {}

-- Dissect: Client Tcp Payload
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  -- Dissect Debug Packet
  ...
  if client_packet_type == "L" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.login_request_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Unsequenced Data Packet
  if client_packet_type == "U" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.unsequenced_data_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Client Heartbeat Packet
  if client_packet_type == "R" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request Packet
  if client_packet_type == "O" then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.logout_request_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header = {}

-- Size: Client Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.size =
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type.size

-- Display: Client Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, client_packet_type = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Client Tcp Packet Header
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.client_tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Client Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet = {}

-- Display: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset

  -- Client Tcp Packet Header: Struct of 2 fields
  index, client_tcp_packet_header = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.dissect(buffer, index, packet, parent)
  ...
  index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_payload.dissect(buffer, index, packet, parent, client_packet_type)

  return index
end

-- Dissect: Client Soup Bin Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
  local index = offset + size_of_client_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.fields.client_soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
    parent:set_len(size_of_client_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_client_soup_bin_tcp_packet)
...
local client_soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  -- Check if packet size can be read
  if remaining < nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.size then
    return -DESEGMENT_ONE_MORE_SEGMENT
  end
...
-- Client Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet_header.size
end

-- Dissect Client Tcp Packet
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_client_soup_bin_tcp_packet)
    else
      -- More bytes needed, so set packet information
      packet.desegment_offset = index
      packet.desegment_len = -(available)
...
-- Connection roles for Nasdaq MrxOptions DepthOfMarket Itch 2.1: Client is the initiator, Server is the acceptor
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.role = function(packet)
  if omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.assume_role == 1 then
    return "initiator"
  end
  if omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.assume_role == 2 then
    return "acceptor"
  end
  local port = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.acceptor_port
  ...
  if omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.prefs.swap_sides then
    first = not first
  end
  if swapped[key] then
    first = not first
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.swap = function(packet)
  local key = conversation(packet)
...
function omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    local role = nasdaq_mrxoptions_depthofmarket_itch_v2_1.role(packet)
    if role == "initiator" then
      return nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet.dissect(buffer, packet, protocol)
    end
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet.dissect(buffer, packet, protocol)
  end
  if packet.port_type == 3 then
    return nasdaq_mrxoptions_depthofmarket_itch_v2_1.mold_udp_64_packet.dissect(buffer, packet, protocol)
  end
end
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet.fingerprint = function(buffer)
...
nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet.fingerprint = function(buffer)
  if buffer:len() < 3 then
    return false
  end
...
-- Dissector Heuristic for Nasdaq MrxOptions DepthOfMarket Itch 2.1 (Tcp)
local function omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_tcp_initiator_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_depthofmarket_itch_v2_1.client_tcp_packet.fingerprint(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions DepthOfMarket Itch 2.1 (Tcp)
local function omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_tcp_acceptor_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet.requiredsize(buffer) then return false end

  -- Verify the frame matches this side's fingerprint
  if not nasdaq_mrxoptions_depthofmarket_itch_v2_1.server_tcp_packet.fingerprint(buffer) then return false end
...
local function omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_udp_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_mrxoptions_depthofmarket_itch_v2_1.mold_udp_64_packet.requiredsize(buffer) then return false end
...
-- Dissector Heuristic for Nasdaq MrxOptions DepthOfMarket Itch 2.1 (Tcp): apply the heuristic of the sender's connection role
local function omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  local role = nasdaq_mrxoptions_depthofmarket_itch_v2_1.role(packet)
  local first, second = omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_tcp_initiator_heuristic, omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_tcp_acceptor_heuristic
  ...
  nasdaq_mrxoptions_depthofmarket_itch_v2_1.swap(packet)
...
-- Register Heuristics for Nasdaq MrxOptions DepthOfMarket Itch 2.1
omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1:register_heuristic("tcp", omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1_tcp_heuristic)
...
-- Register Nasdaq MrxOptions DepthOfMarket Itch 2.1 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1)
-- Register Nasdaq MrxOptions DepthOfMarket Itch 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_mrxoptions_depthofmarket_itch_v2_1)
