...
-- Dissect: Message
nasdaq_nsmequities_totalview_itch_v4_1.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_nsmequities_totalview_itch_v4_1.fields.message, range, display)
  end
