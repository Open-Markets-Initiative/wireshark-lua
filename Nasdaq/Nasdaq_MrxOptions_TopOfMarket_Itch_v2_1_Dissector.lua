...
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.fields.packet_header = ProtoField.new("Packet Header", "nasdaq.mrxoptions.topofmarket.itch.v2.1.packetheader", ftypes.STRING)
...
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.fields.sequence_number = ProtoField.new("Sequence Number", "nasdaq.mrxoptions.topofmarket.itch.v2.1.sequencenumber", ftypes.UINT64)
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.fields.session = ProtoField.new("Session", "nasdaq.mrxoptions.topofmarket.itch.v2.1.session", ftypes.STRING)
...
-- Nasdaq MrxOptions Itch TopOfMarket 2.1 Application Messages
...
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs_changed()
  ...
  if show.message ~= omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message then
    show.message = omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message
  end
  if show.message_header ~= omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message_header then
    show.message_header = omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message_header
  end
  if show.packet ~= omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_packet then
    show.packet = omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_packet
  end
  if show.packet_header ~= omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_packet_header then
    show.packet_header = omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_packet_header
  end
  if show.message_index ~= omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message_index then
    show.message_index = omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.prefs.show_message_index
  end
end
...
-- Sequence Number
nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number = {}

-- Size: Sequence Number
nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number.size = 8

-- Display: Sequence Number
nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number.display = function(value)
  return "Sequence Number: "..value
end

-- Dissect: Sequence Number
nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.fields.sequence_number, range, value, display)

  return offset + length, value
end

-- Session
nasdaq_mrxoptions_topofmarket_itch_v2_1.session = {}

-- Size: Session
nasdaq_mrxoptions_topofmarket_itch_v2_1.session.size = 10

-- Display: Session
nasdaq_mrxoptions_topofmarket_itch_v2_1.session.display = function(value)
...
-- Dissect: Session
nasdaq_mrxoptions_topofmarket_itch_v2_1.session.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_topofmarket_itch_v2_1.session.size
  local range = buffer(offset, length)
  ...
  local display = nasdaq_mrxoptions_topofmarket_itch_v2_1.session.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.fields.session, range, value, display)
...
-- Display: Timestamp
nasdaq_mrxoptions_topofmarket_itch_v2_1.timestamp.display = function(value)
...
-- Payload
nasdaq_mrxoptions_topofmarket_itch_v2_1.payload = {}

-- Dissect: Payload
nasdaq_mrxoptions_topofmarket_itch_v2_1.payload.dissect = function(buffer, offset, packet, parent, message_type)
  -- Dissect System Event Message
...
nasdaq_mrxoptions_topofmarket_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  index = nasdaq_mrxoptions_topofmarket_itch_v2_1.payload.dissect(buffer, index, packet, parent, message_type)
...
-- Packet Header
nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header = {}

-- Size: Packet Header
nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.size =
  nasdaq_mrxoptions_topofmarket_itch_v2_1.session.size + 
  nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number.size + 
  nasdaq_mrxoptions_topofmarket_itch_v2_1.message_count.size

-- Display: Packet Header
nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session: 10 Byte Ascii String
  index, session = nasdaq_mrxoptions_topofmarket_itch_v2_1.session.dissect(buffer, index, packet, parent)

  -- Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, sequence_number = nasdaq_mrxoptions_topofmarket_itch_v2_1.sequence_number.dissect(buffer, index, packet, parent)
...
nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_topofmarket_itch_v2_1.fields.packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_mrxoptions_topofmarket_itch_v2_1.packet.dissect = function(buffer, packet, parent)
  ...
  index, packet_header = nasdaq_mrxoptions_topofmarket_itch_v2_1.packet_header.dissect(buffer, index, packet, parent)
...
udp_table:add(65333, omi_nasdaq_mrxoptions_topofmarket_itch_v2_1)
...
-- Dissector Heuristic for Nasdaq MrxOptions TopOfMarket Itch 2.1
local function omi_nasdaq_mrxoptions_topofmarket_itch_v2_1_heuristic(buffer, packet, parent)
...
-- Register Heuristic for Nasdaq MrxOptions TopOfMarket Itch 2.1
omi_nasdaq_mrxoptions_topofmarket_itch_v2_1:register_heuristic("udp", omi_nasdaq_mrxoptions_topofmarket_itch_v2_1_heuristic)
