...
-----------------------------------------------------------------------
-- Nasdaq NtxEquities NlsPlus Itch 4.0 Formatting
-----------------------------------------------------------------------
...
nasdaq_ntxequities_nlsplus_itch_v4_0.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_ntxequities_nlsplus_itch_v4_0.utc_offset_hours = 5
...
-- 0=Raw, 1=TimeOfDay, 2=FullDateTime
nasdaq_ntxequities_nlsplus_itch_v4_0.client_timestamp_format = 2
...
omi_nasdaq_ntxequities_nlsplus_itch_v4_0.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
omi_nasdaq_ntxequities_nlsplus_itch_v4_0.prefs.client_timestamp_format = Pref.enum("Client Timestamp Format", 2, "Client Timestamp display format", client_timestamp_format_enum, false)
omi_nasdaq_ntxequities_nlsplus_itch_v4_0.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")
...
function omi_nasdaq_ntxequities_nlsplus_itch_v4_0.prefs_changed()
  ...
  if nasdaq_ntxequities_nlsplus_itch_v4_0.client_timestamp_format ~= omi_nasdaq_ntxequities_nlsplus_itch_v4_0.prefs.client_timestamp_format then
    nasdaq_ntxequities_nlsplus_itch_v4_0.client_timestamp_format = omi_nasdaq_ntxequities_nlsplus_itch_v4_0.prefs.client_timestamp_format
  end
...
-- Dissector Heuristic for Nasdaq NtxEquities NlsPlus Itch 4.0 (Udp)
local function omi_nasdaq_ntxequities_nlsplus_itch_v4_0_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_ntxequities_nlsplus_itch_v4_0:register_heuristic("udp", omi_nasdaq_ntxequities_nlsplus_itch_v4_0_udp_heuristic)

-- Register Nasdaq NtxEquities NlsPlus Itch 4.0 on default port
