...
-- Nasdaq PsxEquities LastSale Itch 2.1.2026 Protocol
local omi_nasdaq_psxequities_lastsale_itch_v2_1_2026 = Proto("Nasdaq.PsxEquities.LastSale.Itch.v2.1.2026.Lua", "Nasdaq PsxEquities LastSale Itch 2.1.2026")

-- Protocol table
local nasdaq_psxequities_lastsale_itch_v2_1_2026 = {}
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.corrected_nav_premium_discount_amount = ProtoField.new("Corrected Nav Premium Discount Amount", "nasdaq.psxequities.lastsale.itch.v2.1.2026.correctednavpremiumdiscountamount", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.corrected_sale_condition_modifier = ProtoField.new("Corrected Sale Condition Modifier", "nasdaq.psxequities.lastsale.itch.v2.1.2026.correctedsaleconditionmodifier", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.corrected_trade_control_number = ProtoField.new("Corrected Trade Control Number", "nasdaq.psxequities.lastsale.itch.v2.1.2026.correctedtradecontrolnumber", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.corrected_trade_price = ProtoField.new("Corrected Trade Price", "nasdaq.psxequities.lastsale.itch.v2.1.2026.correctedtradeprice", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.corrected_trade_size = ProtoField.new("Corrected Trade Size", "nasdaq.psxequities.lastsale.itch.v2.1.2026.correctedtradesize", ftypes.UINT32)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.current_trading_state = ProtoField.new("Current Trading State", "nasdaq.psxequities.lastsale.itch.v2.1.2026.currenttradingstate", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.etp_flag = ProtoField.new("Etp Flag", "nasdaq.psxequities.lastsale.itch.v2.1.2026.etpflag", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.etp_leverage_factor = ProtoField.new("Etp Leverage Factor", "nasdaq.psxequities.lastsale.itch.v2.1.2026.etpleveragefactor", ftypes.UINT32)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.event_code = ProtoField.new("Event Code", "nasdaq.psxequities.lastsale.itch.v2.1.2026.eventcode", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.financial_status_indicator = ProtoField.new("Financial Status Indicator", "nasdaq.psxequities.lastsale.itch.v2.1.2026.financialstatusindicator", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.inverse_indicator = ProtoField.new("Inverse Indicator", "nasdaq.psxequities.lastsale.itch.v2.1.2026.inverseindicator", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.ipo_flag = ProtoField.new("Ipo Flag", "nasdaq.psxequities.lastsale.itch.v2.1.2026.ipoflag", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.issue_classification = ProtoField.new("Issue Classification", "nasdaq.psxequities.lastsale.itch.v2.1.2026.issueclassification", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.issue_sub_type = ProtoField.new("Issue Sub Type", "nasdaq.psxequities.lastsale.itch.v2.1.2026.issuesubtype", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.issue_symbol = ProtoField.new("Issue Symbol", "nasdaq.psxequities.lastsale.itch.v2.1.2026.issuesymbol", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.level_1 = ProtoField.new("Level 1", "nasdaq.psxequities.lastsale.itch.v2.1.2026.level1", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.level_2 = ProtoField.new("Level 2", "nasdaq.psxequities.lastsale.itch.v2.1.2026.level2", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.level_3 = ProtoField.new("Level 3", "nasdaq.psxequities.lastsale.itch.v2.1.2026.level3", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.luld_reference_price_tier = ProtoField.new("Luld Reference Price Tier", "nasdaq.psxequities.lastsale.itch.v2.1.2026.luldreferencepricetier", ftypes.STRING)
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.next_shares_symbol = ProtoField.new("Next Shares Symbol", "nasdaq.psxequities.lastsale.itch.v2.1.2026.nextsharessymbol", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.operational_halt_action = ProtoField.new("Operational Halt Action", "nasdaq.psxequities.lastsale.itch.v2.1.2026.operationalhaltaction", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.original_nav_premium_discount_amount = ProtoField.new("Original Nav Premium Discount Amount", "nasdaq.psxequities.lastsale.itch.v2.1.2026.originalnavpremiumdiscountamount", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.original_sale_condition_modifier = ProtoField.new("Original Sale Condition Modifier", "nasdaq.psxequities.lastsale.itch.v2.1.2026.originalsaleconditionmodifier", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.original_trade_control_number = ProtoField.new("Original Trade Control Number", "nasdaq.psxequities.lastsale.itch.v2.1.2026.originaltradecontrolnumber", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.original_trade_price = ProtoField.new("Original Trade Price", "nasdaq.psxequities.lastsale.itch.v2.1.2026.originaltradeprice", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.original_trade_size = ProtoField.new("Original Trade Size", "nasdaq.psxequities.lastsale.itch.v2.1.2026.originaltradesize", ftypes.UINT32)
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.proxy_price = ProtoField.new("Proxy Price", "nasdaq.psxequities.lastsale.itch.v2.1.2026.proxyprice", ftypes.DOUBLE)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.reg_sho_action = ProtoField.new("Reg Sho Action", "nasdaq.psxequities.lastsale.itch.v2.1.2026.regshoaction", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.round_lot_size = ProtoField.new("Round Lot Size", "nasdaq.psxequities.lastsale.itch.v2.1.2026.roundlotsize", ftypes.UINT32)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.round_lots_only = ProtoField.new("Round Lots Only", "nasdaq.psxequities.lastsale.itch.v2.1.2026.roundlotsonly", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.sale_condition_modifier_level_1 = ProtoField.new("Sale Condition Modifier Level 1", "nasdaq.psxequities.lastsale.itch.v2.1.2026.saleconditionmodifierlevel1", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.sale_condition_modifier_level_2 = ProtoField.new("Sale Condition Modifier Level 2", "nasdaq.psxequities.lastsale.itch.v2.1.2026.saleconditionmodifierlevel2", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.sale_condition_modifier_level_3 = ProtoField.new("Sale Condition Modifier Level 3", "nasdaq.psxequities.lastsale.itch.v2.1.2026.saleconditionmodifierlevel3", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.sale_condition_modifier_level_4 = ProtoField.new("Sale Condition Modifier Level 4", "nasdaq.psxequities.lastsale.itch.v2.1.2026.saleconditionmodifierlevel4", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.security_class = ProtoField.new("Security Class", "nasdaq.psxequities.lastsale.itch.v2.1.2026.securityclass", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.sequence_number = ProtoField.new("Sequence Number", "nasdaq.psxequities.lastsale.itch.v2.1.2026.sequencenumber", ftypes.UINT64)
...
-- Nasdaq PsxEquities Itch LastSale 2.1.2026 Application Messages
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.next_shares_trade_report_message = ProtoField.new("Next Shares Trade Report Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.nextsharestradereportmessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.operational_halt_message = ProtoField.new("Operational Halt Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.operationalhaltmessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.reg_sho_short_sale_price_test_restricted_indicator_message = ProtoField.new("Reg Sho Short Sale Price Test Restricted Indicator Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.regshoshortsalepricetestrestrictedindicatormessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.stock_directory_message = ProtoField.new("Stock Directory Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.stockdirectorymessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.system_event_message = ProtoField.new("System Event Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.systemeventmessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_cancel_error_for_next_shares_message = ProtoField.new("Trade Cancel Error For Next Shares Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.tradecancelerrorfornextsharesmessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_cancel_error_message = ProtoField.new("Trade Cancel Error Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.tradecancelerrormessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_correction_for_next_shares_message = ProtoField.new("Trade Correction For Next Shares Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.tradecorrectionfornextsharesmessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_correction_message = ProtoField.new("Trade Correction Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.tradecorrectionmessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_report_message = ProtoField.new("Trade Report Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.tradereportmessage", ftypes.STRING)
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trading_action_message = ProtoField.new("Trading Action Message", "nasdaq.psxequities.lastsale.itch.v2.1.2026.tradingactionmessage", ftypes.STRING)

-- Nasdaq PsxEquities LastSale Itch 2.1.2026 generated fields
...
-- Nasdaq PsxEquities LastSale Itch 2.1.2026 Element Dissection Options
show.message = true
...
-- Register Nasdaq PsxEquities LastSale Itch 2.1.2026 Show Options
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_mwcb_breach_message = Pref.bool("Show Mwcb Breach Message", show.mwcb_breach_message, "Parse and add Mwcb Breach Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_mwcb_decline_level_message = Pref.bool("Show Mwcb Decline Level Message", show.mwcb_decline_level_message, "Parse and add Mwcb Decline Level Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_next_shares_trade_report_message = Pref.bool("Show Next Shares Trade Report Message", show.next_shares_trade_report_message, "Parse and add Next Shares Trade Report Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_operational_halt_message = Pref.bool("Show Operational Halt Message", show.operational_halt_message, "Parse and add Operational Halt Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message = Pref.bool("Show Reg Sho Short Sale Price Test Restricted Indicator Message", show.reg_sho_short_sale_price_test_restricted_indicator_message, "Parse and add Reg Sho Short Sale Price Test Restricted Indicator Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_stock_directory_message = Pref.bool("Show Stock Directory Message", show.stock_directory_message, "Parse and add Stock Directory Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_system_event_message = Pref.bool("Show System Event Message", show.system_event_message, "Parse and add System Event Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_cancel_error_for_next_shares_message = Pref.bool("Show Trade Cancel Error For Next Shares Message", show.trade_cancel_error_for_next_shares_message, "Parse and add Trade Cancel Error For Next Shares Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_cancel_error_message = Pref.bool("Show Trade Cancel Error Message", show.trade_cancel_error_message, "Parse and add Trade Cancel Error Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_correction_for_next_shares_message = Pref.bool("Show Trade Correction For Next Shares Message", show.trade_correction_for_next_shares_message, "Parse and add Trade Correction For Next Shares Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_correction_message = Pref.bool("Show Trade Correction Message", show.trade_correction_message, "Parse and add Trade Correction Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_report_message = Pref.bool("Show Trade Report Message", show.trade_report_message, "Parse and add Trade Report Message to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trading_action_message = Pref.bool("Show Trading Action Message", show.trading_action_message, "Parse and add Trading Action Message to protocol tree")
...
function omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs_changed()
  ...
  if show.message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_message then
    show.message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_message
    changed = true
  end
  if show.message_header ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_message_header then
    show.message_header = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_message_header
    changed = true
  end
  if show.mwcb_breach_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_mwcb_breach_message then
    show.mwcb_breach_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_mwcb_breach_message
    changed = true
  end
  if show.mwcb_decline_level_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_mwcb_decline_level_message then
    show.mwcb_decline_level_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_mwcb_decline_level_message
    changed = true
  end
  if show.next_shares_trade_report_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_next_shares_trade_report_message then
    show.next_shares_trade_report_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_next_shares_trade_report_message
    changed = true
  end
  if show.operational_halt_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_operational_halt_message then
    show.operational_halt_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_operational_halt_message
    changed = true
  end
  if show.packet ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_packet then
    show.packet = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_packet
    changed = true
  end
  if show.packet_header ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_packet_header then
    show.packet_header = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_packet_header
    changed = true
  end
  if show.reg_sho_short_sale_price_test_restricted_indicator_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message then
    show.reg_sho_short_sale_price_test_restricted_indicator_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message
    changed = true
  end
  if show.stock_directory_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_stock_directory_message then
    show.stock_directory_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_stock_directory_message
    changed = true
  end
  if show.system_event_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_system_event_message then
    show.system_event_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_system_event_message
    changed = true
  end
  if show.trade_cancel_error_for_next_shares_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_cancel_error_for_next_shares_message then
    show.trade_cancel_error_for_next_shares_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_cancel_error_for_next_shares_message
    changed = true
  end
  if show.trade_cancel_error_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_cancel_error_message then
    show.trade_cancel_error_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_cancel_error_message
    changed = true
  end
  if show.trade_correction_for_next_shares_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_correction_for_next_shares_message then
    show.trade_correction_for_next_shares_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_correction_for_next_shares_message
    changed = true
  end
  if show.trade_correction_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_correction_message then
    show.trade_correction_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_correction_message
    changed = true
  end
  if show.trade_report_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_report_message then
    show.trade_report_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trade_report_message
    changed = true
  end
  if show.trading_action_message ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trading_action_message then
    show.trading_action_message = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_trading_action_message
    changed = true
  end
...
-- Breached Level
nasdaq_psxequities_lastsale_itch_v2_1_2026.breached_level = {}

-- Size: Breached Level
nasdaq_psxequities_lastsale_itch_v2_1_2026.breached_level.size = 1

-- Display: Breached Level
nasdaq_psxequities_lastsale_itch_v2_1_2026.breached_level.display = function(value)
  if value == "1" then
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.breached_level.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_lastsale_itch_v2_1_2026.breached_level.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.breached_level.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.breached_level, range, value, display)
...
-- Etp Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.etp_flag = {}

-- Size: Etp Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.etp_flag.size = 1

-- Display: Etp Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.etp_flag.display = function(value)
  if value == "Y" then
...
-- Dissect: Etp Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.etp_flag.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_lastsale_itch_v2_1_2026.etp_flag.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.etp_flag.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.etp_flag, range, value, display)
...
-- Ipo Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.ipo_flag = {}

-- Size: Ipo Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.ipo_flag.size = 1

-- Display: Ipo Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.ipo_flag.display = function(value)
  if value == "Y" then
...
-- Dissect: Ipo Flag
nasdaq_psxequities_lastsale_itch_v2_1_2026.ipo_flag.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_lastsale_itch_v2_1_2026.ipo_flag.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.ipo_flag.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.ipo_flag, range, value, display)
...
-- Issue Sub Type
nasdaq_psxequities_lastsale_itch_v2_1_2026.issue_sub_type = {}

-- Size: Issue Sub Type
nasdaq_psxequities_lastsale_itch_v2_1_2026.issue_sub_type.size = 2

-- Display: Issue Sub Type
nasdaq_psxequities_lastsale_itch_v2_1_2026.issue_sub_type.display = function(value)
  if value == "A" then
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.issue_sub_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_lastsale_itch_v2_1_2026.issue_sub_type.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.issue_sub_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.issue_sub_type, range, value, display)
...
-- Market Category
nasdaq_psxequities_lastsale_itch_v2_1_2026.market_category = {}

-- Size: Market Category
nasdaq_psxequities_lastsale_itch_v2_1_2026.market_category.size = 1

-- Display: Market Category
nasdaq_psxequities_lastsale_itch_v2_1_2026.market_category.display = function(value)
  if value == "Q" then
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.market_category.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_lastsale_itch_v2_1_2026.market_category.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.market_category.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.market_category, range, value, display)
...
-- Reg Sho Action
nasdaq_psxequities_lastsale_itch_v2_1_2026.reg_sho_action = {}

-- Size: Reg Sho Action
nasdaq_psxequities_lastsale_itch_v2_1_2026.reg_sho_action.size = 1

-- Display: Reg Sho Action
nasdaq_psxequities_lastsale_itch_v2_1_2026.reg_sho_action.display = function(value)
  if value == "0" then
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.reg_sho_action.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_lastsale_itch_v2_1_2026.reg_sho_action.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.reg_sho_action.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.reg_sho_action, range, value, display)
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason = {}

-- Size: Trading Action Reason
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason.size = 4

-- Display: Trading Action Reason
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason.display = function(value)
  if value == "T1" then
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason.size
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trading_action_reason, range, value, display)
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message = {}
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message.size =
  ...
  nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason.size

-- Display: Trading Action Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message.fields = function(buffer, offset, packet, parent)
  ...
  index, security_class = nasdaq_psxequities_lastsale_itch_v2_1_2026.security_class.dissect(buffer, index, packet, parent)

  -- Current Trading State: Alpha
  index, current_trading_state = nasdaq_psxequities_lastsale_itch_v2_1_2026.current_trading_state.dissect(buffer, index, packet, parent)

  -- Trading Action Reason: Alpha
  index, trading_action_reason = nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_reason.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Trading Action Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message.dissect = function(buffer, offset, packet, parent)
  if show.trading_action_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trading_action_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message.display(packet, parent, length)
    parent:append_text(display)
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message = {}
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.size =
  ...
  nasdaq_psxequities_lastsale_itch_v2_1_2026.issue_symbol.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.security_class.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.original_trade_control_number.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.original_trade_price.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.original_nav_premium_discount_amount.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.original_trade_size.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.original_sale_condition_modifier.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_trade_control_number.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_trade_price.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_nav_premium_discount_amount.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_trade_size.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_sale_condition_modifier.size

-- Display: Trade Correction For Next Shares Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.fields = function(buffer, offset, packet, parent)
  ...
  index, original_trade_control_number = nasdaq_psxequities_lastsale_itch_v2_1_2026.original_trade_control_number.dissect(buffer, index, packet, parent)

  -- Original Trade Price: Price (4)
  index, original_trade_price = nasdaq_psxequities_lastsale_itch_v2_1_2026.original_trade_price.dissect(buffer, index, packet, parent)

  -- Original Nav Premium Discount Amount: Price (4)
  index, original_nav_premium_discount_amount = nasdaq_psxequities_lastsale_itch_v2_1_2026.original_nav_premium_discount_amount.dissect(buffer, index, packet, parent)

  -- Original Trade Size: Integer
  index, original_trade_size = nasdaq_psxequities_lastsale_itch_v2_1_2026.original_trade_size.dissect(buffer, index, packet, parent)

  -- Original Sale Condition Modifier: Alpha
  index, original_sale_condition_modifier = nasdaq_psxequities_lastsale_itch_v2_1_2026.original_sale_condition_modifier.dissect(buffer, index, packet, parent)

  -- Corrected Trade Control Number: Alpha
  index, corrected_trade_control_number = nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_trade_control_number.dissect(buffer, index, packet, parent)

  -- Corrected Trade Price: Price (4)
  index, corrected_trade_price = nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_trade_price.dissect(buffer, index, packet, parent)

  -- Corrected Nav Premium Discount Amount: Price (4)
  index, corrected_nav_premium_discount_amount = nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_nav_premium_discount_amount.dissect(buffer, index, packet, parent)

  -- Corrected Trade Size: Integer
  index, corrected_trade_size = nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_trade_size.dissect(buffer, index, packet, parent)

  -- Corrected Sale Condition Modifier: Alpha
  index, corrected_sale_condition_modifier = nasdaq_psxequities_lastsale_itch_v2_1_2026.corrected_sale_condition_modifier.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Trade Correction For Next Shares Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_correction_for_next_shares_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_correction_for_next_shares_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.fields(buffer, offset, packet, parent)
  end
end

-- Trade Correction Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_message = {}
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_correction_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_correction_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_message.fields(buffer, offset, packet, parent)
  end
end

-- Trade Cancel Error For Next Shares Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_for_next_shares_message = {}
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_for_next_shares_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_for_next_shares_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_cancel_error_for_next_shares_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_cancel_error_for_next_shares_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_for_next_shares_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_for_next_shares_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_for_next_shares_message.fields(buffer, offset, packet, parent)
  end
end

-- Trade Cancel Error Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_message = {}
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_cancel_error_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_cancel_error_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_message.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.size =
  ...
  nasdaq_psxequities_lastsale_itch_v2_1_2026.security_class.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_control_number.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.proxy_price.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_size.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.nav_premium_discount_amount.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_1.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_2.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_3.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_4.size

-- Display: Next Shares Trade Report Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.fields = function(buffer, offset, packet, parent)
  ...
  index, next_shares_symbol = nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_symbol.dissect(buffer, index, packet, parent)

  -- Security Class: Alpha
  index, security_class = nasdaq_psxequities_lastsale_itch_v2_1_2026.security_class.dissect(buffer, index, packet, parent)

  -- Trade Control Number: Alpha
  index, trade_control_number = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_control_number.dissect(buffer, index, packet, parent)

  -- Proxy Price: Price (4)
  index, proxy_price = nasdaq_psxequities_lastsale_itch_v2_1_2026.proxy_price.dissect(buffer, index, packet, parent)

  -- Trade Size: Integer
  index, trade_size = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_size.dissect(buffer, index, packet, parent)

  -- Nav Premium Discount Amount: Price (4)
  index, nav_premium_discount_amount = nasdaq_psxequities_lastsale_itch_v2_1_2026.nav_premium_discount_amount.dissect(buffer, index, packet, parent)

  -- Sale Condition Modifier Level 1: Alpha
  index, sale_condition_modifier_level_1 = nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_1.dissect(buffer, index, packet, parent)

  -- Sale Condition Modifier Level 2: Alpha
  index, sale_condition_modifier_level_2 = nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_2.dissect(buffer, index, packet, parent)

  -- Sale Condition Modifier Level 3: Alpha
  index, sale_condition_modifier_level_3 = nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_3.dissect(buffer, index, packet, parent)

  -- Sale Condition Modifier Level 4: Alpha
  index, sale_condition_modifier_level_4 = nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_4.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Next Shares Trade Report Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.dissect = function(buffer, offset, packet, parent)
  if show.next_shares_trade_report_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.next_shares_trade_report_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_report_message.size =
  ...
  nasdaq_psxequities_lastsale_itch_v2_1_2026.security_class.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_control_number.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_price.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_size.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_1.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_2.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sale_condition_modifier_level_3.size + 
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_report_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_report_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Trade Price: Price (4)
  index, trade_price = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_price.dissect(buffer, index, packet, parent)
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_report_message.dissect = function(buffer, offset, packet, parent)
  if show.trade_report_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.trade_report_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_report_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_report_message.display(packet, parent, length)
    parent:append_text(display)
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.system_event_message = {}
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.system_event_message.display = function(packet, parent, length)
  return ""
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.system_event_message.dissect = function(buffer, offset, packet, parent)
  if show.system_event_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.system_event_message, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.system_event_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.system_event_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.system_event_message.fields(buffer, offset, packet, parent)
  end
end

-- Payload
nasdaq_psxequities_lastsale_itch_v2_1_2026.payload = {}

-- Dissect: Payload
nasdaq_psxequities_lastsale_itch_v2_1_2026.payload.dissect = function(buffer, offset, packet, parent, message_type)
  -- Dissect System Event Message
  if message_type == "S" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.system_event_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Report Message
  if message_type == "T" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_report_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Next Shares Trade Report Message
  if message_type == "M" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.next_shares_trade_report_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Cancel Error Message
  if message_type == "X" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Cancel Error For Next Shares Message
  if message_type == "O" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_cancel_error_for_next_shares_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Correction Message
  if message_type == "C" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trade Correction For Next Shares Message
  if message_type == "Z" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trade_correction_for_next_shares_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Trading Action Message
  if message_type == "H" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.trading_action_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Reg Sho Short Sale Price Test Restricted Indicator Message
  if message_type == "Y" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.reg_sho_short_sale_price_test_restricted_indicator_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stock Directory Message
  if message_type == "R" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.stock_directory_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Mwcb Decline Level Message
  if message_type == "V" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.mwcb_decline_level_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Mwcb Breach Message
  if message_type == "W" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.mwcb_breach_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Operational Halt Message
  if message_type == "h" then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.operational_halt_message.dissect(buffer, offset, packet, parent)
  end
...
-- Size: Message Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.size =
  nasdaq_psxequities_lastsale_itch_v2_1_2026.message_length.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.tracking_number.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.timestamp.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.message_type.size

-- Display: Message Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Length: 2 Byte Unsigned Fixed Width Integer
  index, message_length = nasdaq_psxequities_lastsale_itch_v2_1_2026.message_length.dissect(buffer, index, packet, parent)
  ...
  index, message_type = nasdaq_psxequities_lastsale_itch_v2_1_2026.message_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Message Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.dissect = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.message_header, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.fields(buffer, offset, packet, parent)
  end
end

-- Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.message = {}

-- Display: Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset

  -- Implicit Message Index
  if message_index ~= nil then
    local iteration = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.message_index, message_index)
    iteration:set_generated()
  end

  -- Message Header: Struct of 4 fields
  index, message_header = nasdaq_psxequities_lastsale_itch_v2_1_2026.message_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Message Type
  local message_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 13 branches
  index = nasdaq_psxequities_lastsale_itch_v2_1_2026.payload.dissect(buffer, index, packet, parent, message_type)

  return index
end

-- Dissect: Message
nasdaq_psxequities_lastsale_itch_v2_1_2026.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.message, buffer(offset, 0))
    local current = nasdaq_psxequities_lastsale_itch_v2_1_2026.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
    parent:set_len(size_of_message)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.message.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_psxequities_lastsale_itch_v2_1_2026.message.fields(buffer, offset, packet, parent, size_of_message, message_index)
...
-- Packet Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header = {}

-- Size: Packet Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.size =
  nasdaq_psxequities_lastsale_itch_v2_1_2026.session.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sequence_number.size + 
  nasdaq_psxequities_lastsale_itch_v2_1_2026.message_count.size

-- Display: Packet Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session: 10 Byte Ascii String
  index, session = nasdaq_psxequities_lastsale_itch_v2_1_2026.session.dissect(buffer, index, packet, parent)

  -- Sequence Number: 8 Byte Unsigned Fixed Width Integer
  index, sequence_number = nasdaq_psxequities_lastsale_itch_v2_1_2026.sequence_number.dissect(buffer, index, packet, parent)

  -- Message Count: 2 Byte Unsigned Fixed Width Integer
  index, message_count = nasdaq_psxequities_lastsale_itch_v2_1_2026.message_count.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Packet Header
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.dissect = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.packet_header, buffer(offset, 0))
    local index = nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Packet
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet = {}

-- Dissect Packet
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet.dissect = function(buffer, packet, parent)
  local index = 0

  -- Packet Header: Struct of 3 fields
  index, packet_header = nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.dissect(buffer, index, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = nasdaq_psxequities_lastsale_itch_v2_1_2026.message.dissect(buffer, index, packet, parent, size_of_message, message_index)
  end
...
function omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.init()
end

-- Dissector for Nasdaq PsxEquities LastSale Itch 2.1.2026
function omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.name

  -- Dissect protocol
  local protocol = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026, buffer(), omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.description, "("..buffer:len().." Bytes)")
  return nasdaq_psxequities_lastsale_itch_v2_1_2026.packet.dissect(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, omi_nasdaq_psxequities_lastsale_itch_v2_1_2026)
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet.requiredsize = function(buffer)

  return true
end

-- Dissector Heuristic for Nasdaq PsxEquities LastSale Itch 2.1.2026
local function omi_nasdaq_psxequities_lastsale_itch_v2_1_2026_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not nasdaq_psxequities_lastsale_itch_v2_1_2026.packet.requiredsize(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026
  omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Nasdaq PsxEquities LastSale Itch 2.1.2026
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026:register_heuristic("udp", omi_nasdaq_psxequities_lastsale_itch_v2_1_2026_heuristic)
