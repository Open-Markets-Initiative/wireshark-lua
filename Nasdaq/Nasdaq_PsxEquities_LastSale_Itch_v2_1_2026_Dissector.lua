...
local omi_nasdaq_psxequities_lastsale_itch_v2_1_2026 = Proto("Omi.Nasdaq.PsxEquities.LastSale.Itch.v2.1.2026", "Nasdaq PsxEquities LastSale Itch 2.1.2026")
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nasdaq.psxequities.lastsale.itch.v2.1.2026.messagesequencenumber", ftypes.UINT64)
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
...
function omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs_changed()
  ...
  if show.application_messages ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_application_messages then
    show.application_messages = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_application_messages
  end
  if show.headers ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_headers then
    show.headers = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_structs then
    show.structs = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_indexes then
    show.indexes = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_sequences then
    show.sequences = omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.prefs.show_sequences
  end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_psxequities_lastsale_itch_v2_1_2026.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026.fields.message_sequence_number, UInt64.new(nasdaq_psxequities_lastsale_itch_v2_1_2026.sequence + message_index - 1))
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_psxequities_lastsale_itch_v2_1_2026.message.size(buffer, offset)
...
-- End Of Session
nasdaq_psxequities_lastsale_itch_v2_1_2026.end_of_session = {}

-- Display: End Of Session
nasdaq_psxequities_lastsale_itch_v2_1_2026.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_psxequities_lastsale_itch_v2_1_2026.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_psxequities_lastsale_itch_v2_1_2026.heartbeat = {}

-- Display: Heartbeat
nasdaq_psxequities_lastsale_itch_v2_1_2026.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_psxequities_lastsale_itch_v2_1_2026.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_psxequities_lastsale_itch_v2_1_2026.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
-- Messages
nasdaq_psxequities_lastsale_itch_v2_1_2026.messages = {}

-- Dissect: Messages
nasdaq_psxequities_lastsale_itch_v2_1_2026.messages.dissect = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_psxequities_lastsale_itch_v2_1_2026.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, message_count do
    ...
    offset = nasdaq_psxequities_lastsale_itch_v2_1_2026.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_psxequities_lastsale_itch_v2_1_2026.sequence = sequence_number
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_psxequities_lastsale_itch_v2_1_2026.packet_header.size
end
...
nasdaq_psxequities_lastsale_itch_v2_1_2026.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_psxequities_lastsale_itch_v2_1_2026.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq PsxEquities LastSale Itch 2.1.2026 (Udp)
local function omi_nasdaq_psxequities_lastsale_itch_v2_1_2026_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_psxequities_lastsale_itch_v2_1_2026:register_heuristic("udp", omi_nasdaq_psxequities_lastsale_itch_v2_1_2026_udp_heuristic)

-- Register Nasdaq PsxEquities LastSale Itch 2.1.2026 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_psxequities_lastsale_itch_v2_1_2026)
