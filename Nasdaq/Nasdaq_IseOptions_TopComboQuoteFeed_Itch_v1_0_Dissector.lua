...
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.utc_offset_hours = 5
...
function omi_nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.prefs_changed()
  ...
  if nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.utc_offset_hours ~= omi_nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.prefs.utc_offset_hours then
    nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.utc_offset_hours = omi_nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.prefs.utc_offset_hours
  end
end
...
-- Display: Timestamp
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.timestamp_format == 0 then
  ...
  if nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.utc_offset_hours * 3600
...
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.complex_strategy_directory_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.complex_strategy_directory_message.display(packet, parent, length)
    parent:append_text(display)
...
-- End Of Session
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.end_of_session = {}

-- Display: End Of Session
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.heartbeat = {}

-- Display: Heartbeat
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
-- Messages
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.messages = {}

-- Dissect: Messages
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
    return nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, message_count do
    ...
    offset = nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_iseoptions_topcomboquotefeed_itch_v1_0.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq IseOptions TopComboQuoteFeed Itch 1.0 (Udp)
local function omi_nasdaq_iseoptions_topcomboquotefeed_itch_v1_0_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_iseoptions_topcomboquotefeed_itch_v1_0:register_heuristic("udp", omi_nasdaq_iseoptions_topcomboquotefeed_itch_v1_0_udp_heuristic)

-- Register Nasdaq IseOptions TopComboQuoteFeed Itch 1.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_iseoptions_topcomboquotefeed_itch_v1_0)
