...
omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.fields.packet_type = ProtoField.new("Packet Type", "nasdaq.mrxoptions.orderfeed.itch.v2.1.packettype", ftypes.STRING)
...
omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.fields.soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.mrxoptions.orderfeed.itch.v2.1.soupbintcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.fields.tcp_packet = ProtoField.new("Tcp Packet", "nasdaq.mrxoptions.orderfeed.itch.v2.1.tcppacket", ftypes.STRING)
omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.fields.tcp_packet_header = ProtoField.new("Tcp Packet Header", "nasdaq.mrxoptions.orderfeed.itch.v2.1.tcppacketheader", ftypes.STRING)
...
-- Packet Type
nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type = {}

-- Size: Packet Type
nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type.size = 1

-- Display: Packet Type
nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type.display = function(value)
  if value == "+" then
...
-- Dissect: Packet Type
nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.fields.packet_type, range, value, display)
...
nasdaq_mrxoptions_orderfeed_itch_v2_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  -- Udp Payload
  index, udp_payload = nasdaq_mrxoptions_orderfeed_itch_v2_1.udp_payload.dissect(buffer, index, packet, parent, size_of_udp_payload)
...
-- Tcp Payload
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_payload = {}

-- Dissect: Tcp Payload
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_payload.dissect = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Debug Packet
  if packet_type == "+" then
...
-- Tcp Packet Header
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header = {}

-- Size: Tcp Packet Header
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.size =
  nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_length.size + 
  nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type.size

-- Display: Tcp Packet Header
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Tcp Packet Header
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, packet_type = nasdaq_mrxoptions_orderfeed_itch_v2_1.packet_type.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Tcp Packet Header
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.structs then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.fields.tcp_packet_header, buffer(offset, 0))
    local index = nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Soup Bin Tcp Packet
nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet = {}

-- Display: Soup Bin Tcp Packet
nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Soup Bin Tcp Packet
nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet.fields = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset

  -- Tcp Packet Header: Struct of 2 fields
  index, tcp_packet_header = nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Tcp Payload: Runtime Type with 6 branches
  index = nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_payload.dissect(buffer, index, packet, parent, packet_type)

  return index
end

-- Dissect: Soup Bin Tcp Packet
nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet.dissect = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset + size_of_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.structs then
    parent = parent:add(omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
    parent:set_len(size_of_soup_bin_tcp_packet)
    local display = nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet.fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
...
local soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.size then
...
-- Tcp Packet
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet = {}

-- Verify required size of Tcp packet
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet_header.size
end

-- Dissect Tcp Packet
nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet.dissect = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_mrxoptions_orderfeed_itch_v2_1.soup_bin_tcp_packet.dissect(buffer, index, packet, parent, size_of_soup_bin_tcp_packet)
    else
...
function omi_nasdaq_mrxoptions_orderfeed_itch_v2_1.dissector(buffer, packet, parent)
  ...
  if packet.port_type == 2 then
    return nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet.dissect(buffer, packet, protocol)
  end
...
local function omi_nasdaq_mrxoptions_orderfeed_itch_v2_1_tcp_heuristic(buffer, packet, parent)
  ...
  if not nasdaq_mrxoptions_orderfeed_itch_v2_1.tcp_packet.requiredsize(buffer) then return false end
