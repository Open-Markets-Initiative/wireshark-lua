...
size_of.participant_token = 8

-- Display: Participant Token
display.participant_token = function(value)
  return "Participant Token: "..value
end

-- Dissect: Participant Token
dissect.participant_token = function(buffer, offset, packet, parent)
  local length = size_of.participant_token
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.participant_token(value, buffer, offset, packet, parent)
...
size_of.participant_timestamp = 8

-- Display: Participant Timestamp
display.participant_timestamp = function(value)
...
dissect.participant_timestamp = function(buffer, offset, packet, parent)
  local length = size_of.participant_timestamp
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.participant_timestamp(value, buffer, offset, packet, parent)
...
-- Size: Sip Timestamp
size_of.sip_timestamp = 8

-- Display: Sip Timestamp
display.sip_timestamp = function(value)
  return "Sip Timestamp: "..value
end

-- Dissect: Sip Timestamp
dissect.sip_timestamp = function(buffer, offset, packet, parent)
  local length = size_of.sip_timestamp
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.sip_timestamp(value, buffer, offset, packet, parent)
...
size_of.sub_market_center_id = 1

-- Display: Sub Market Center Id
display.sub_market_center_id = function(value)
  if value == "N" then
...
dissect.sub_market_center_id = function(buffer, offset, packet, parent)
  local length = size_of.sub_market_center_id
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.sub_market_center_id(value, buffer, offset, packet, parent)
...
size_of.market_center_originator_id = 1
...
size_of.message_info = function(buffer, offset)
  local index = 0

  index = index + size_of.market_center_originator_id

  index = index + size_of.sub_market_center_id

  index = index + size_of.sip_timestamp

  index = index + size_of.participant_timestamp

  index = index + size_of.participant_token

  return index
end

-- Display: Message Info
display.message_info = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message Info
dissect.message_info_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, sub_market_center_id = dissect.sub_market_center_id(buffer, index, packet, parent)

  -- Sip Timestamp: 8 Byte Unsigned Fixed Width Integer
  index, sip_timestamp = dissect.sip_timestamp(buffer, index, packet, parent)
  ...
  index, participant_token = dissect.participant_token(buffer, index, packet, parent)

  return index
end

-- Dissect: Message Info
dissect.message_info = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.message_info then
    local length = size_of.message_info(buffer, offset)
    local range = buffer(offset, length)
    local display = display.message_info(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.message_info, range, display)
  end

  return dissect.message_info_fields(buffer, offset, packet, parent)
end

-- Display: Quote Wipe Out Message
display.quote_wipe_out_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Wipe Out Message
dissect.quote_wipe_out_message_fields = function(buffer, offset, packet, parent, size_of_quote_wipe_out_message)
  local index = offset

  -- Message Info: Struct of 5 fields
  index, message_info = dissect.message_info(buffer, index, packet, parent)

  return index
end

-- Dissect: Quote Wipe Out Message
dissect.quote_wipe_out_message = function(buffer, offset, packet, parent)
  ...
  if show.quote_wipe_out_message then
    ...
    local display = display.quote_wipe_out_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.quote_wipe_out_message, range, display)
  end

  dissect.quote_wipe_out_message_fields(buffer, offset, packet, parent, size_of_quote_wipe_out_message)
...
dissect.end_of_transmissions_message_fields = function(buffer, offset, packet, parent, size_of_end_of_transmissions_message)
  local index = offset
...
dissect.end_of_transmissions_message = function(buffer, offset, packet, parent)
  ...
  dissect.end_of_transmissions_message_fields(buffer, offset, packet, parent, size_of_end_of_transmissions_message)
...
dissect.market_session_close_message_fields = function(buffer, offset, packet, parent, size_of_market_session_close_message)
  local index = offset
...
dissect.market_session_close_message = function(buffer, offset, packet, parent)
  ...
  dissect.market_session_close_message_fields(buffer, offset, packet, parent, size_of_market_session_close_message)
...
dissect.market_session_open_message_fields = function(buffer, offset, packet, parent, size_of_market_session_open_message)
  local index = offset
...
dissect.market_session_open_message = function(buffer, offset, packet, parent)
  ...
  dissect.market_session_open_message_fields(buffer, offset, packet, parent, size_of_market_session_open_message)
...
size_of.control_payload = function(buffer, offset, control_message_type)
  ...
  if control_message_type == "P" then
    return size_of.quote_wipe_out_message(buffer, offset)
  end
...
dissect.control_payload_branches = function(buffer, offset, packet, parent, control_message_type)
  ...
  -- Dissect Quote Wipe Out Message
  if control_message_type == "P" then
    return dissect.quote_wipe_out_message(buffer, offset, packet, parent)
  end
...
size_of.market_center_ask_size = 8

-- Display: Market Center Ask Size
display.market_center_ask_size = function(value)
  return "Market Center Ask Size: "..value
end

-- Dissect: Market Center Ask Size
dissect.market_center_ask_size = function(buffer, offset, packet, parent)
  local length = size_of.market_center_ask_size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.market_center_ask_size(value, buffer, offset, packet, parent)
...
size_of.market_center_ask_price = 8
...
size_of.market_center_bid_size = 8

-- Display: Market Center Bid Size
display.market_center_bid_size = function(value)
  return "Market Center Bid Size: "..value
end

-- Dissect: Market Center Bid Size
dissect.market_center_bid_size = function(buffer, offset, packet, parent)
  local length = size_of.market_center_bid_size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.market_center_bid_size(value, buffer, offset, packet, parent)
...
size_of.market_center_bid_price = 8
...
size_of.market_center_close_recap = function(buffer, offset)
  local index = 0

  index = index + size_of.market_center_identifier

  index = index + size_of.market_center_bid_price

  index = index + size_of.market_center_bid_size

  index = index + size_of.market_center_ask_price

  index = index + size_of.market_center_ask_size

  return index
end

-- Display: Market Center Close Recap
display.market_center_close_recap = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Market Center Close Recap
dissect.market_center_close_recap_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, market_center_bid_price = dissect.market_center_bid_price(buffer, index, packet, parent)

  -- Market Center Bid Size: 8 Byte Unsigned Fixed Width Integer
  index, market_center_bid_size = dissect.market_center_bid_size(buffer, index, packet, parent)

  -- Market Center Ask Price: 8 Byte Unsigned Fixed Width Integer
  index, market_center_ask_price = dissect.market_center_ask_price(buffer, index, packet, parent)

  -- Market Center Ask Size: 8 Byte Unsigned Fixed Width Integer
  index, market_center_ask_size = dissect.market_center_ask_size(buffer, index, packet, parent)

  return index
end

-- Dissect: Market Center Close Recap
dissect.market_center_close_recap = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.market_center_close_recap then
    local length = size_of.market_center_close_recap(buffer, offset)
    local range = buffer(offset, length)
    local display = display.market_center_close_recap(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.market_center_close_recap, range, display)
  end

  return dissect.market_center_close_recap_fields(buffer, offset, packet, parent)
end

-- Size: Number Of Market Center Attachments
size_of.number_of_market_center_attachments = 2

-- Display: Number Of Market Center Attachments
display.number_of_market_center_attachments = function(value)
  return "Number Of Market Center Attachments: "..value
end

-- Dissect: Number Of Market Center Attachments
dissect.number_of_market_center_attachments = function(buffer, offset, packet, parent)
  local length = size_of.number_of_market_center_attachments
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.number_of_market_center_attachments(value, buffer, offset, packet, parent)
...
size_of.special_condition = 1

-- Display: Special Condition
display.special_condition = function(value)
  if value == "O" then
...
dissect.special_condition = function(buffer, offset, packet, parent)
  local length = size_of.special_condition
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.special_condition(value, buffer, offset, packet, parent)
...
size_of.national_best_ask_size = 8

-- Display: National Best Ask Size
display.national_best_ask_size = function(value)
  return "National Best Ask Size: "..value
end

-- Dissect: National Best Ask Size
dissect.national_best_ask_size = function(buffer, offset, packet, parent)
  local length = size_of.national_best_ask_size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.national_best_ask_size(value, buffer, offset, packet, parent)
...
size_of.national_best_ask_price = 8
...
size_of.national_best_ask_market_center = 1

-- Display: National Best Ask Market Center
display.national_best_ask_market_center = function(value)
  return "National Best Ask Market Center: "..value
end

-- Dissect: National Best Ask Market Center
dissect.national_best_ask_market_center = function(buffer, offset, packet, parent)
  local length = size_of.national_best_ask_market_center
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.national_best_ask_market_center(value, buffer, offset, packet, parent)
...
size_of.national_best_bid_size = 8

-- Display: National Best Bid Size
display.national_best_bid_size = function(value)
  return "National Best Bid Size: "..value
end

-- Dissect: National Best Bid Size
dissect.national_best_bid_size = function(buffer, offset, packet, parent)
  local length = size_of.national_best_bid_size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.national_best_bid_size(value, buffer, offset, packet, parent)
...
size_of.national_best_bid_price = 8
...
size_of.national_best_bid_market_center = 1

-- Display: National Best Bid Market Center
display.national_best_bid_market_center = function(value)
  return "National Best Bid Market Center: "..value
end

-- Dissect: National Best Bid Market Center
dissect.national_best_bid_market_center = function(buffer, offset, packet, parent)
  local length = size_of.national_best_bid_market_center
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.national_best_bid_market_center(value, buffer, offset, packet, parent)
...
display.session_close_recap_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Session Close Recap Message
dissect.session_close_recap_message_fields = function(buffer, offset, packet, parent, size_of_session_close_recap_message)
  local index = offset
  ...
  index, national_best_bid_market_center = dissect.national_best_bid_market_center(buffer, index, packet, parent)

  -- National Best Bid Price: 8 Byte Unsigned Fixed Width Integer
  index, national_best_bid_price = dissect.national_best_bid_price(buffer, index, packet, parent)

  -- National Best Bid Size: 8 Byte Unsigned Fixed Width Integer
  index, national_best_bid_size = dissect.national_best_bid_size(buffer, index, packet, parent)

  -- National Best Ask Market Center: 1 Byte Ascii String
  index, national_best_ask_market_center = dissect.national_best_ask_market_center(buffer, index, packet, parent)

  -- National Best Ask Price: 8 Byte Unsigned Fixed Width Integer
  index, national_best_ask_price = dissect.national_best_ask_price(buffer, index, packet, parent)

  -- National Best Ask Size: 8 Byte Unsigned Fixed Width Integer
  index, national_best_ask_size = dissect.national_best_ask_size(buffer, index, packet, parent)

  -- Special Condition: 1 Byte Ascii String Enum with 4 values
  index, special_condition = dissect.special_condition(buffer, index, packet, parent)

  -- Number Of Market Center Attachments: 2 Byte Unsigned Fixed Width Integer
  index, number_of_market_center_attachments = dissect.number_of_market_center_attachments(buffer, index, packet, parent)

  -- Market Center Close Recap: Struct of 5 fields
  for i = 1, number_of_market_center_attachments do
    index = dissect.market_center_close_recap(buffer, index, packet, parent)
  end
...
dissect.session_close_recap_message = function(buffer, offset, packet, parent)
  ...
  if show.session_close_recap_message then
    ...
    local display = display.session_close_recap_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.session_close_recap_message, range, display)
  end

  dissect.session_close_recap_message_fields(buffer, offset, packet, parent, size_of_session_close_recap_message)

  return offset + size_of_session_close_recap_message
end

-- Size: Collar Extension Indicator
size_of.collar_extension_indicator = 1

-- Display: Collar Extension Indicator
display.collar_extension_indicator = function(value)
  return "Collar Extension Indicator: "..value
end

-- Dissect: Collar Extension Indicator
dissect.collar_extension_indicator = function(buffer, offset, packet, parent)
  local length = size_of.collar_extension_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.collar_extension_indicator(value, buffer, offset, packet, parent)
...
size_of.trading_action_sequence_number = 4

-- Display: Trading Action Sequence Number
display.trading_action_sequence_number = function(value)
  return "Trading Action Sequence Number: "..value
end

-- Dissect: Trading Action Sequence Number
dissect.trading_action_sequence_number = function(buffer, offset, packet, parent)
  local length = size_of.trading_action_sequence_number
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.trading_action_sequence_number(value, buffer, offset, packet, parent)
...
display.auction_collar_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Auction Collar Message
dissect.auction_collar_message_fields = function(buffer, offset, packet, parent, size_of_auction_collar_message)
  local index = offset
  ...
  index, trading_action_sequence_number = dissect.trading_action_sequence_number(buffer, index, packet, parent)
  ...
  index, collar_up_price = dissect.collar_up_price(buffer, index, packet, parent)

  -- Collar Down Price: 8 Byte Unsigned Fixed Width Integer
  index, collar_down_price = dissect.collar_down_price(buffer, index, packet, parent)

  -- Collar Extension Indicator: 1 Byte Ascii String
  index, collar_extension_indicator = dissect.collar_extension_indicator(buffer, index, packet, parent)

  return index
end

-- Dissect: Auction Collar Message
dissect.auction_collar_message = function(buffer, offset, packet, parent)
  ...
  if show.auction_collar_message then
    ...
    local display = display.auction_collar_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.auction_collar_message, range, display)
  end

  dissect.auction_collar_message_fields(buffer, offset, packet, parent, size_of_auction_collar_message)
...
-- Size: Mwcb Level 1
size_of.mwcb_level_1 = 8

-- Display: Mwcb Level 1
display.mwcb_level_1 = function(value)
  return "Mwcb Level 1: "..value
end

-- Dissect: Mwcb Level 1
dissect.mwcb_level_1 = function(buffer, offset, packet, parent)
  local length = size_of.mwcb_level_1
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.mwcb_level_1(value, buffer, offset, packet, parent)
...
display.market_wide_circuit_breaker_decline_level_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Market Wide Circuit Breaker Decline Level Message
dissect.market_wide_circuit_breaker_decline_level_message_fields = function(buffer, offset, packet, parent, size_of_market_wide_circuit_breaker_decline_level_message)
  local index = offset
...
dissect.market_wide_circuit_breaker_decline_level_message = function(buffer, offset, packet, parent)
  ...
  if show.market_wide_circuit_breaker_decline_level_message then
    ...
    local display = display.market_wide_circuit_breaker_decline_level_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.market_wide_circuit_breaker_decline_level_message, range, display)
  end

  dissect.market_wide_circuit_breaker_decline_level_message_fields(buffer, offset, packet, parent, size_of_market_wide_circuit_breaker_decline_level_message)
...
-- Size: Luld Timestamp
size_of.luld_timestamp = 8

-- Display: Luld Timestamp
display.luld_timestamp = function(value)
  return "Luld Timestamp: "..value
end

-- Dissect: Luld Timestamp
dissect.luld_timestamp = function(buffer, offset, packet, parent)
  local length = size_of.luld_timestamp
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.luld_timestamp(value, buffer, offset, packet, parent)
...
size_of.luld_price_band_indicator = 1

-- Display: Luld Price Band Indicator
display.luld_price_band_indicator = function(value)
  if value == "A" then
...
dissect.luld_price_band_indicator = function(buffer, offset, packet, parent)
  local length = size_of.luld_price_band_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.luld_price_band_indicator(value, buffer, offset, packet, parent)
...
display.limit_up_limit_down_price_band_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Limit Up Limit Down Price Band Message
dissect.limit_up_limit_down_price_band_message_fields = function(buffer, offset, packet, parent, size_of_limit_up_limit_down_price_band_message)
  local index = offset
  ...
  index, luld_price_band_indicator = dissect.luld_price_band_indicator(buffer, index, packet, parent)

  -- Luld Timestamp: 8 Byte Unsigned Fixed Width Integer
  index, luld_timestamp = dissect.luld_timestamp(buffer, index, packet, parent)
...
dissect.limit_up_limit_down_price_band_message = function(buffer, offset, packet, parent)
  ...
  if show.limit_up_limit_down_price_band_message then
    ...
    local display = display.limit_up_limit_down_price_band_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.limit_up_limit_down_price_band_message, range, display)
  end

  dissect.limit_up_limit_down_price_band_message_fields(buffer, offset, packet, parent, size_of_limit_up_limit_down_price_band_message)
...
display.regulation_sho_short_sale_price_test_restricted_indicator_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Regulation Sho Short Sale Price Test Restricted Indicator Message
dissect.regulation_sho_short_sale_price_test_restricted_indicator_message_fields = function(buffer, offset, packet, parent, size_of_regulation_sho_short_sale_price_test_restricted_indicator_message)
  local index = offset
...
dissect.regulation_sho_short_sale_price_test_restricted_indicator_message = function(buffer, offset, packet, parent)
  ...
  if show.regulation_sho_short_sale_price_test_restricted_indicator_message then
    ...
    local display = display.regulation_sho_short_sale_price_test_restricted_indicator_message(buffer, packet, parent)
  ...
  dissect.regulation_sho_short_sale_price_test_restricted_indicator_message_fields(buffer, offset, packet, parent, size_of_regulation_sho_short_sale_price_test_restricted_indicator_message)
...
-- Size: Market Tier
size_of.market_tier = 1

-- Display: Market Tier
display.market_tier = function(value)
  if value == "Q" then
...
-- Dissect: Market Tier
dissect.market_tier = function(buffer, offset, packet, parent)
  local length = size_of.market_tier
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.market_tier(value, buffer, offset, packet, parent)
...
dissect.issue_subtype = function(buffer, offset, packet, parent)
  local length = size_of.issue_subtype
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Issue Type
size_of.issue_type = 1

-- Display: Issue Type
display.issue_type = function(value)
  if value == "A" then
...
-- Dissect: Issue Type
dissect.issue_type = function(buffer, offset, packet, parent)
  local length = size_of.issue_type
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.issue_type(value, buffer, offset, packet, parent)
...
-- Size: Issue Name
size_of.issue_name = 30

-- Display: Issue Name
display.issue_name = function(value)
  return "Issue Name: "..value
end

-- Dissect: Issue Name
dissect.issue_name = function(buffer, offset, packet, parent)
  local length = size_of.issue_name
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.issue_name(value, buffer, offset, packet, parent)
...
-- Size: Old Symbol
size_of.old_symbol = 11

-- Display: Old Symbol
display.old_symbol = function(value)
  return "Old Symbol: "..value
end

-- Dissect: Old Symbol
dissect.old_symbol = function(buffer, offset, packet, parent)
  local length = size_of.old_symbol
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.old_symbol(value, buffer, offset, packet, parent)
...
display.issue_symbol_directory_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Issue Symbol Directory Message
dissect.issue_symbol_directory_message_fields = function(buffer, offset, packet, parent, size_of_issue_symbol_directory_message)
  local index = offset
  ...
  index, old_symbol = dissect.old_symbol(buffer, index, packet, parent)

  -- Issue Name: 30 Byte Ascii String
  index, issue_name = dissect.issue_name(buffer, index, packet, parent)

  -- Issue Type: 1 Byte Ascii String Enum with 16 values
  index, issue_type = dissect.issue_type(buffer, index, packet, parent)

  -- Issue Subtype: 2 Byte Ascii String
  index, issue_subtype = dissect.issue_subtype(buffer, index, packet, parent)

  -- Market Tier: 1 Byte Ascii String Enum with 3 values
  index, market_tier = dissect.market_tier(buffer, index, packet, parent)
...
dissect.issue_symbol_directory_message = function(buffer, offset, packet, parent)
  ...
  if show.issue_symbol_directory_message then
    ...
    local display = display.issue_symbol_directory_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.issue_symbol_directory_message, range, display)
  end

  dissect.issue_symbol_directory_message_fields(buffer, offset, packet, parent, size_of_issue_symbol_directory_message)

  return offset + size_of_issue_symbol_directory_message
end

-- Size: Action Timestamp
size_of.action_timestamp = 8

-- Display: Action Timestamp
display.action_timestamp = function(value)
  return "Action Timestamp: "..value
end

-- Dissect: Action Timestamp
dissect.action_timestamp = function(buffer, offset, packet, parent)
  local length = size_of.action_timestamp
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.action_timestamp(value, buffer, offset, packet, parent)
...
size_of.trading_action_code = 1

-- Display: Trading Action Code
display.trading_action_code = function(value)
  if value == "H" then
...
dissect.trading_action_code = function(buffer, offset, packet, parent)
  local length = size_of.trading_action_code
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.trading_action_code(value, buffer, offset, packet, parent)
...
display.market_center_trading_action_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Market Center Trading Action Message
dissect.market_center_trading_action_message_fields = function(buffer, offset, packet, parent, size_of_market_center_trading_action_message)
  local index = offset
  ...
  index, trading_action_code = dissect.trading_action_code(buffer, index, packet, parent)

  -- Action Timestamp: 8 Byte Unsigned Fixed Width Integer
  index, action_timestamp = dissect.action_timestamp(buffer, index, packet, parent)
...
dissect.market_center_trading_action_message = function(buffer, offset, packet, parent)
  ...
  if show.market_center_trading_action_message then
    ...
    local display = display.market_center_trading_action_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.market_center_trading_action_message, range, display)
  end

  dissect.market_center_trading_action_message_fields(buffer, offset, packet, parent, size_of_market_center_trading_action_message)

  return offset + size_of_market_center_trading_action_message
end

-- Size: Trading Action Reason
size_of.trading_action_reason = 6
...
display.cross_sro_trading_action_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Cross Sro Trading Action Message
dissect.cross_sro_trading_action_message_fields = function(buffer, offset, packet, parent, size_of_cross_sro_trading_action_message)
  local index = offset
...
dissect.cross_sro_trading_action_message = function(buffer, offset, packet, parent)
  ...
  if show.cross_sro_trading_action_message then
    ...
    local display = display.cross_sro_trading_action_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.cross_sro_trading_action_message, range, display)
  end

  dissect.cross_sro_trading_action_message_fields(buffer, offset, packet, parent, size_of_cross_sro_trading_action_message)
...
dissect.text = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
  local value = range:string()
  local display = display.text(value, buffer, offset, packet, parent, size)
...
-- Size: Text Length
size_of.text_length = 2

-- Display: Text Length
display.text_length = function(value)
  return "Text Length: "..value
end

-- Dissect: Text Length
dissect.text_length = function(buffer, offset, packet, parent)
  local length = size_of.text_length
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.text_length(value, buffer, offset, packet, parent)
...
dissect.general_administrative_message_fields = function(buffer, offset, packet, parent, size_of_general_administrative_message)
  local index = offset
  ...
  index, text_length = dissect.text_length(buffer, index, packet, parent)

  -- Text: 0 Byte Ascii String
  index = dissect.text(buffer, index, packet, parent, text_length)
...
dissect.general_administrative_message = function(buffer, offset, packet, parent)
  ...
  dissect.general_administrative_message_fields(buffer, offset, packet, parent, size_of_general_administrative_message)
...
size_of.administrative_payload = function(buffer, offset, administrative_message_type)
  ...
  if administrative_message_type == "H" then
    return size_of.cross_sro_trading_action_message(buffer, offset)
  end
  -- Size of Market Center Trading Action Message
  if administrative_message_type == "H" then
    return size_of.market_center_trading_action_message(buffer, offset)
  end
  -- Size of Issue Symbol Directory Message
  if administrative_message_type == "B" then
    return size_of.issue_symbol_directory_message(buffer, offset)
  end
  -- Size of Regulation Sho Short Sale Price Test Restricted Indicator Message
  if administrative_message_type == "V" then
    return size_of.regulation_sho_short_sale_price_test_restricted_indicator_message(buffer, offset)
  end
  -- Size of Limit Up Limit Down Price Band Message
  if administrative_message_type == "P" then
    return size_of.limit_up_limit_down_price_band_message(buffer, offset)
  end
  -- Size of Market Wide Circuit Breaker Decline Level Message
  if administrative_message_type == "C" then
    return size_of.market_wide_circuit_breaker_decline_level_message(buffer, offset)
  end
  -- Size of Market Wide Circuit Breaker Decline Level Message
  ...
  if administrative_message_type == "E" then
    return size_of.auction_collar_message(buffer, offset)
  end
  -- Size of Session Close Recap Message
  if administrative_message_type == "R" then
    return size_of.session_close_recap_message(buffer, offset)
  end
...
dissect.administrative_payload_branches = function(buffer, offset, packet, parent, administrative_message_type)
  ...
  -- Dissect Cross Sro Trading Action Message
  if administrative_message_type == "H" then
    return dissect.cross_sro_trading_action_message(buffer, offset, packet, parent)
  end
  -- Dissect Market Center Trading Action Message
  if administrative_message_type == "H" then
    return dissect.market_center_trading_action_message(buffer, offset, packet, parent)
  end
  -- Dissect Issue Symbol Directory Message
  if administrative_message_type == "B" then
    return dissect.issue_symbol_directory_message(buffer, offset, packet, parent)
  end
  -- Dissect Regulation Sho Short Sale Price Test Restricted Indicator Message
  if administrative_message_type == "V" then
    return dissect.regulation_sho_short_sale_price_test_restricted_indicator_message(buffer, offset, packet, parent)
  end
  -- Dissect Limit Up Limit Down Price Band Message
  if administrative_message_type == "P" then
    return dissect.limit_up_limit_down_price_band_message(buffer, offset, packet, parent)
  end
  -- Dissect Market Wide Circuit Breaker Decline Level Message
  if administrative_message_type == "C" then
    return dissect.market_wide_circuit_breaker_decline_level_message(buffer, offset, packet, parent)
  end
  -- Dissect Market Wide Circuit Breaker Decline Level Message
  if administrative_message_type == "D" then
    return dissect.market_wide_circuit_breaker_decline_level_message(buffer, offset, packet, parent)
  ...
  -- Dissect Auction Collar Message
  if administrative_message_type == "E" then
    return dissect.auction_collar_message(buffer, offset, packet, parent)
  end
  -- Dissect Session Close Recap Message
  if administrative_message_type == "R" then
    return dissect.session_close_recap_message(buffer, offset, packet, parent)
  end
...
size_of.finra_market_participant = 4

-- Display: Finra Market Participant
display.finra_market_participant = function(value)
  return "Finra Market Participant: "..value
end

-- Dissect: Finra Market Participant
dissect.finra_market_participant = function(buffer, offset, packet, parent)
  local length = size_of.finra_market_participant
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.finra_market_participant(value, buffer, offset, packet, parent)
...
size_of.finra_timestamp = 8

-- Display: Finra Timestamp
display.finra_timestamp = function(value)
  return "Finra Timestamp: "..value
end

-- Dissect: Finra Timestamp
dissect.finra_timestamp = function(buffer, offset, packet, parent)
  local length = size_of.finra_timestamp
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = display.finra_timestamp(value, buffer, offset, packet, parent)
...
display.finra_adf_market_participant_quotation_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Finra Adf Market Participant Quotation Message
dissect.finra_adf_market_participant_quotation_message_fields = function(buffer, offset, packet, parent, size_of_finra_adf_market_participant_quotation_message)
  local index = offset
  ...
  index, finra_market_participant = dissect.finra_market_participant(buffer, index, packet, parent)

  return index
end

-- Dissect: Finra Adf Market Participant Quotation Message
dissect.finra_adf_market_participant_quotation_message = function(buffer, offset, packet, parent)
  ...
  if show.finra_adf_market_participant_quotation_message then
    ...
    local display = display.finra_adf_market_participant_quotation_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.finra_adf_market_participant_quotation_message, range, display)
  end

  dissect.finra_adf_market_participant_quotation_message_fields(buffer, offset, packet, parent, size_of_finra_adf_market_participant_quotation_message)

  return offset + size_of_finra_adf_market_participant_quotation_message
end

-- Size: Ask Adf Mpid
size_of.ask_adf_mpid = 4

-- Display: Ask Adf Mpid
display.ask_adf_mpid = function(value)
  return "Ask Adf Mpid: "..value
end

-- Dissect: Ask Adf Mpid
dissect.ask_adf_mpid = function(buffer, offset, packet, parent)
  local length = size_of.ask_adf_mpid
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.ask_adf_mpid(value, buffer, offset, packet, parent)
...
-- Size: Bid Adf Mpid
size_of.bid_adf_mpid = 4

-- Display: Bid Adf Mpid
display.bid_adf_mpid = function(value)
  return "Bid Adf Mpid: "..value
end

-- Dissect: Bid Adf Mpid
dissect.bid_adf_mpid = function(buffer, offset, packet, parent)
  local length = size_of.bid_adf_mpid
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.bid_adf_mpid(value, buffer, offset, packet, parent)
...
size_of.finra_adf_mpid_appendage = function(buffer, offset)
  local index = 0

  index = index + size_of.bid_adf_mpid

  index = index + size_of.ask_adf_mpid

  return index
end

-- Display: Finra Adf Mpid Appendage
display.finra_adf_mpid_appendage = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Finra Adf Mpid Appendage
dissect.finra_adf_mpid_appendage_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Bid Adf Mpid: 4 Byte Ascii String
  index, bid_adf_mpid = dissect.bid_adf_mpid(buffer, index, packet, parent)

  -- Ask Adf Mpid: 4 Byte Ascii String
  index, ask_adf_mpid = dissect.ask_adf_mpid(buffer, index, packet, parent)

  return index
end

-- Dissect: Finra Adf Mpid Appendage
dissect.finra_adf_mpid_appendage = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.finra_adf_mpid_appendage then
    local length = size_of.finra_adf_mpid_appendage(buffer, offset)
    local range = buffer(offset, length)
    local display = display.finra_adf_mpid_appendage(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.finra_adf_mpid_appendage, range, display)
  end

  return dissect.finra_adf_mpid_appendage_fields(buffer, offset, packet, parent)
end

-- Size: Best Ask Size
size_of.best_ask_size = 4

-- Display: Best Ask Size
display.best_ask_size = function(value)
  return "Best Ask Size: "..value
end

-- Dissect: Best Ask Size
dissect.best_ask_size = function(buffer, offset, packet, parent)
  local length = size_of.best_ask_size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.best_ask_size(value, buffer, offset, packet, parent)
...
size_of.best_ask_market_center = 1

-- Display: Best Ask Market Center
display.best_ask_market_center = function(value)
  return "Best Ask Market Center: "..value
end

-- Dissect: Best Ask Market Center
dissect.best_ask_market_center = function(buffer, offset, packet, parent)
  local length = size_of.best_ask_market_center
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.best_ask_market_center(value, buffer, offset, packet, parent)
...
size_of.best_bid_market_center = 1

-- Display: Best Bid Market Center
display.best_bid_market_center = function(value)
  return "Best Bid Market Center: "..value
end

-- Dissect: Best Bid Market Center
dissect.best_bid_market_center = function(buffer, offset, packet, parent)
  local length = size_of.best_bid_market_center
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.best_bid_market_center(value, buffer, offset, packet, parent)
...
size_of.nbbo_quote_condition = 1

-- Display: Nbbo Quote Condition
display.nbbo_quote_condition = function(value)
  if value == "A" then
...
dissect.nbbo_quote_condition = function(buffer, offset, packet, parent)
  local length = size_of.nbbo_quote_condition
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.nbbo_quote_condition(value, buffer, offset, packet, parent)
...
size_of.long_form_national_bbo_appendage = function(buffer, offset)
  local index = 0

  index = index + size_of.nbbo_quote_condition

  index = index + size_of.best_bid_market_center

  index = index + size_of.best_bid_price

  index = index + size_of.best_bid_size

  index = index + size_of.best_ask_market_center

  index = index + size_of.best_ask_price

  index = index + size_of.best_ask_size

  return index
end

-- Display: Long Form National Bbo Appendage
display.long_form_national_bbo_appendage = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Long Form National Bbo Appendage
dissect.long_form_national_bbo_appendage_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Nbbo Quote Condition: 1 Byte Ascii String Enum with 14 values
  index, nbbo_quote_condition = dissect.nbbo_quote_condition(buffer, index, packet, parent)

  -- Best Bid Market Center: 1 Byte Ascii String
  index, best_bid_market_center = dissect.best_bid_market_center(buffer, index, packet, parent)
  ...
  index, best_ask_market_center = dissect.best_ask_market_center(buffer, index, packet, parent)
  ...
  index, best_ask_size = dissect.best_ask_size(buffer, index, packet, parent)

  return index
end

-- Dissect: Long Form National Bbo Appendage
dissect.long_form_national_bbo_appendage = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.long_form_national_bbo_appendage then
    local length = size_of.long_form_national_bbo_appendage(buffer, offset)
    local range = buffer(offset, length)
    local display = display.long_form_national_bbo_appendage(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.long_form_national_bbo_appendage, range, display)
  end

  return dissect.long_form_national_bbo_appendage_fields(buffer, offset, packet, parent)
end

-- Size: National Best Ask Size Short
size_of.national_best_ask_size_short = 2

-- Display: National Best Ask Size Short
display.national_best_ask_size_short = function(value)
  return "National Best Ask Size Short: "..value
end

-- Dissect: National Best Ask Size Short
dissect.national_best_ask_size_short = function(buffer, offset, packet, parent)
  local length = size_of.national_best_ask_size_short
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.national_best_ask_size_short(value, buffer, offset, packet, parent)
...
size_of.national_best_ask_price_short = 2
...
size_of.national_best_bid_size_short = 2

-- Display: National Best Bid Size Short
display.national_best_bid_size_short = function(value)
  return "National Best Bid Size Short: "..value
end

-- Dissect: National Best Bid Size Short
dissect.national_best_bid_size_short = function(buffer, offset, packet, parent)
  local length = size_of.national_best_bid_size_short
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.national_best_bid_size_short(value, buffer, offset, packet, parent)
...
size_of.national_best_bid_price_short = 2
...
size_of.short_form_national_bbo_appendage = function(buffer, offset)
  local index = 0

  index = index + size_of.nbbo_quote_condition

  index = index + size_of.national_best_bid_market_center

  index = index + size_of.national_best_bid_price_short

  index = index + size_of.national_best_bid_size_short

  index = index + size_of.national_best_ask_market_center

  index = index + size_of.national_best_ask_price_short

  index = index + size_of.national_best_ask_size_short

  return index
end

-- Display: Short Form National Bbo Appendage
display.short_form_national_bbo_appendage = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Short Form National Bbo Appendage
dissect.short_form_national_bbo_appendage_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, national_best_bid_price_short = dissect.national_best_bid_price_short(buffer, index, packet, parent)

  -- National Best Bid Size Short: 2 Byte Unsigned Fixed Width Integer
  index, national_best_bid_size_short = dissect.national_best_bid_size_short(buffer, index, packet, parent)

  -- National Best Ask Market Center: 1 Byte Ascii String
  index, national_best_ask_market_center = dissect.national_best_ask_market_center(buffer, index, packet, parent)

  -- National Best Ask Price Short: 2 Byte Unsigned Fixed Width Integer
  index, national_best_ask_price_short = dissect.national_best_ask_price_short(buffer, index, packet, parent)

  -- National Best Ask Size Short: 2 Byte Unsigned Fixed Width Integer
  index, national_best_ask_size_short = dissect.national_best_ask_size_short(buffer, index, packet, parent)

  return index
end

-- Dissect: Short Form National Bbo Appendage
dissect.short_form_national_bbo_appendage = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.short_form_national_bbo_appendage then
    local length = size_of.short_form_national_bbo_appendage(buffer, offset)
    local range = buffer(offset, length)
    local display = display.short_form_national_bbo_appendage(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.short_form_national_bbo_appendage, range, display)
  end

  return dissect.short_form_national_bbo_appendage_fields(buffer, offset, packet, parent)
end

-- Size: Finra Adf Mpid Appendage Indicator
size_of.finra_adf_mpid_appendage_indicator = 1

-- Display: Finra Adf Mpid Appendage Indicator
display.finra_adf_mpid_appendage_indicator = function(value)
  if value == " " then
...
dissect.finra_adf_mpid_appendage_indicator = function(buffer, offset, packet, parent)
  local length = size_of.finra_adf_mpid_appendage_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.finra_adf_mpid_appendage_indicator(value, buffer, offset, packet, parent)
...
size_of.luld_national_bbo_indicator = 1

-- Display: Luld National Bbo Indicator
display.luld_national_bbo_indicator = function(value)
  if value == " " then
...
dissect.luld_national_bbo_indicator = function(buffer, offset, packet, parent)
  local length = size_of.luld_national_bbo_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.luld_national_bbo_indicator(value, buffer, offset, packet, parent)
...
size_of.nbbo_appendage_indicator = 1

-- Display: Nbbo Appendage Indicator
display.nbbo_appendage_indicator = function(value)
  if value == "0" then
...
dissect.nbbo_appendage_indicator = function(buffer, offset, packet, parent)
  local length = size_of.nbbo_appendage_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.nbbo_appendage_indicator(value, buffer, offset, packet, parent)
...
size_of.luld_bbo_indicator = 1

-- Display: Luld Bbo Indicator
display.luld_bbo_indicator = function(value)
  if value == " " then
...
dissect.luld_bbo_indicator = function(buffer, offset, packet, parent)
  local length = size_of.luld_bbo_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.luld_bbo_indicator(value, buffer, offset, packet, parent)
...
size_of.sip_generated_update = 1

-- Display: Sip Generated Update
display.sip_generated_update = function(value)
  if value == " " then
...
dissect.sip_generated_update = function(buffer, offset, packet, parent)
  local length = size_of.sip_generated_update
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.sip_generated_update(value, buffer, offset, packet, parent)
...
display.quote_long_form_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Long Form Message
dissect.quote_long_form_message_fields = function(buffer, offset, packet, parent, size_of_quote_long_form_message)
  local index = offset
  ...
  index, sip_generated_update = dissect.sip_generated_update(buffer, index, packet, parent)

  -- Luld Bbo Indicator: 1 Byte Ascii String Enum with 4 values
  index, luld_bbo_indicator = dissect.luld_bbo_indicator(buffer, index, packet, parent)
  ...
  index, nbbo_appendage_indicator = dissect.nbbo_appendage_indicator(buffer, index, packet, parent)

  -- Luld National Bbo Indicator: 1 Byte Ascii String Enum with 10 values
  index, luld_national_bbo_indicator = dissect.luld_national_bbo_indicator(buffer, index, packet, parent)

  -- Finra Adf Mpid Appendage Indicator: 1 Byte Ascii String Enum with 4 values
  index, finra_adf_mpid_appendage_indicator = dissect.finra_adf_mpid_appendage_indicator(buffer, index, packet, parent)
  ...
  if short_form_national_bbo_appendage_exists then
    index = dissect.short_form_national_bbo_appendage(buffer, index, packet, parent)
  end
  ...
  if long_form_national_bbo_appendage_exists then
    index = dissect.long_form_national_bbo_appendage(buffer, index, packet, parent)
  end
  ...
  if finra_adf_mpid_appendage_exists then
    index = dissect.finra_adf_mpid_appendage(buffer, index, packet, parent)
  end
...
dissect.quote_long_form_message = function(buffer, offset, packet, parent)
  ...
  if show.quote_long_form_message then
    ...
    local display = display.quote_long_form_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.quote_long_form_message, range, display)
  end

  dissect.quote_long_form_message_fields(buffer, offset, packet, parent, size_of_quote_long_form_message)

  return offset + size_of_quote_long_form_message
end

-- Size: Ask Size Short
size_of.ask_size_short = 2

-- Display: Ask Size Short
display.ask_size_short = function(value)
  return "Ask Size Short: "..value
end

-- Dissect: Ask Size Short
dissect.ask_size_short = function(buffer, offset, packet, parent)
  local length = size_of.ask_size_short
  local range = buffer(offset, length)
  local value = range:uint()
  local display = display.ask_size_short(value, buffer, offset, packet, parent)
...
-- Size: Symbol Short
size_of.symbol_short = 5

-- Display: Symbol Short
display.symbol_short = function(value)
  return "Symbol Short: "..value
end

-- Dissect: Symbol Short
dissect.symbol_short = function(buffer, offset, packet, parent)
  local length = size_of.symbol_short
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.symbol_short(value, buffer, offset, packet, parent)
...
display.quote_short_form_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Quote Short Form Message
dissect.quote_short_form_message_fields = function(buffer, offset, packet, parent, size_of_quote_short_form_message)
  local index = offset
  ...
  index, symbol_short = dissect.symbol_short(buffer, index, packet, parent)
  ...
  index, ask_price_short = dissect.ask_price_short(buffer, index, packet, parent)

  -- Ask Size Short: 2 Byte Unsigned Fixed Width Integer
  index, ask_size_short = dissect.ask_size_short(buffer, index, packet, parent)
...
dissect.quote_short_form_message = function(buffer, offset, packet, parent)
  ...
  if show.quote_short_form_message then
    ...
    local display = display.quote_short_form_message(buffer, packet, parent)
    parent = parent:add(nasdaq_uqdf_output_utp_v1_5.fields.quote_short_form_message, range, display)
  end

  dissect.quote_short_form_message_fields(buffer, offset, packet, parent, size_of_quote_short_form_message)
...
size_of.quote_payload = function(buffer, offset, quote_message_type)
  ...
  if quote_message_type == "E" then
    return size_of.quote_short_form_message(buffer, offset)
  end
  -- Size of Quote Long Form Message
  if quote_message_type == "F" then
    return size_of.quote_long_form_message(buffer, offset)
  end
  -- Size of Finra Adf Market Participant Quotation Message
  if quote_message_type == "M" then
    return size_of.finra_adf_market_participant_quotation_message(buffer, offset)
  end
...
dissect.quote_payload_branches = function(buffer, offset, packet, parent, quote_message_type)
  -- Dissect Quote Short Form Message
  if quote_message_type == "E" then
    return dissect.quote_short_form_message(buffer, offset, packet, parent)
  end
  -- Dissect Quote Long Form Message
  if quote_message_type == "F" then
    return dissect.quote_long_form_message(buffer, offset, packet, parent)
  end
  -- Dissect Finra Adf Market Participant Quotation Message
  if quote_message_type == "M" then
    return dissect.finra_adf_market_participant_quotation_message(buffer, offset, packet, parent)
  end
