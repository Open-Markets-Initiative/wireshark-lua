...
local show = {}
local format = {}
local nasdaq_bxequities_orders_ouch_v4_2_display = {}
local nasdaq_bxequities_orders_ouch_v4_2_dissect = {}
local nasdaq_bxequities_orders_ouch_v4_2_size_of = {}
local verify = {}
local translate = {}
...
-- Size: Order Token
nasdaq_bxequities_orders_ouch_v4_2_size_of.order_token = 14

-- Display: Order Token
nasdaq_bxequities_orders_ouch_v4_2_display.order_token = function(value)
  return "Order Token: "..value
end

-- Dissect: Order Token
nasdaq_bxequities_orders_ouch_v4_2_dissect.order_token = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.order_token
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.trade_now_message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.order_token

  return index
end

-- Display: Trade Now Message
nasdaq_bxequities_orders_ouch_v4_2_display.trade_now_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Now Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.trade_now_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Order Token: 14 Byte Ascii String
  index, order_token = nasdaq_bxequities_orders_ouch_v4_2_dissect.order_token(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.trade_now_message = function(buffer, offset, packet, parent)
  if show.trade_now_message then
    ...
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.trade_now_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.trade_now_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.trade_now_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.trade_now_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Shares
nasdaq_bxequities_orders_ouch_v4_2_size_of.shares = 4

-- Display: Shares
nasdaq_bxequities_orders_ouch_v4_2_display.shares = function(value)
  return "Shares: "..value
end

-- Dissect: Shares
nasdaq_bxequities_orders_ouch_v4_2_dissect.shares = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.shares
  local range = buffer(offset, length)
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.buy_sell_indicator = 1

-- Display: Buy Sell Indicator
nasdaq_bxequities_orders_ouch_v4_2_display.buy_sell_indicator = function(value)
  if value == "B" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.buy_sell_indicator = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.buy_sell_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.modify_order_message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.order_token

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.buy_sell_indicator

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.shares

  return index
end

-- Display: Modify Order Message
nasdaq_bxequities_orders_ouch_v4_2_display.modify_order_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Modify Order Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.modify_order_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, buy_sell_indicator = nasdaq_bxequities_orders_ouch_v4_2_dissect.buy_sell_indicator(buffer, index, packet, parent)

  -- Shares: 4 Byte Unsigned Fixed Width Integer
  index, shares = nasdaq_bxequities_orders_ouch_v4_2_dissect.shares(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.modify_order_message = function(buffer, offset, packet, parent)
  if show.modify_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.modify_order_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.modify_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.modify_order_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.modify_order_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Cancel Order Message
nasdaq_bxequities_orders_ouch_v4_2_size_of.cancel_order_message = function(buffer, offset)
  local index = 0
...
nasdaq_bxequities_orders_ouch_v4_2_display.cancel_order_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Order Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_order_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_order_message = function(buffer, offset, packet, parent)
  if show.cancel_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.cancel_order_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.cancel_order_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_order_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Minimum Quantity
nasdaq_bxequities_orders_ouch_v4_2_size_of.minimum_quantity = 4

-- Display: Minimum Quantity
nasdaq_bxequities_orders_ouch_v4_2_display.minimum_quantity = function(value)
  return "Minimum Quantity: "..value
end

-- Dissect: Minimum Quantity
nasdaq_bxequities_orders_ouch_v4_2_dissect.minimum_quantity = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.minimum_quantity
  local range = buffer(offset, length)
  local value = range:uint()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.intermarket_sweep_eligibility = 1

-- Display: Intermarket Sweep Eligibility
nasdaq_bxequities_orders_ouch_v4_2_display.intermarket_sweep_eligibility = function(value)
  if value == "Y" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.intermarket_sweep_eligibility = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.intermarket_sweep_eligibility
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Display
nasdaq_bxequities_orders_ouch_v4_2_size_of.display = 1

-- Display: Display
nasdaq_bxequities_orders_ouch_v4_2_display.display = function(value)
  if value == "A" then
...
-- Dissect: Display
nasdaq_bxequities_orders_ouch_v4_2_dissect.display = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.display
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Time In Force
nasdaq_bxequities_orders_ouch_v4_2_size_of.time_in_force = 4

-- Display: Time In Force
nasdaq_bxequities_orders_ouch_v4_2_display.time_in_force = function(value)
  return "Time In Force: "..value
end

-- Dissect: Time In Force
nasdaq_bxequities_orders_ouch_v4_2_dissect.time_in_force = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.time_in_force
  local range = buffer(offset, length)
  local value = range:uint()
...
-- Size: Price
nasdaq_bxequities_orders_ouch_v4_2_size_of.price = 4

-- Display: Price
nasdaq_bxequities_orders_ouch_v4_2_display.price = function(value)
  return "Price: "..value
end
...
-- Dissect: Price
nasdaq_bxequities_orders_ouch_v4_2_dissect.price = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.price
  local range = buffer(offset, length)
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.replacement_order_token_token_14 = 14

-- Display: Replacement Order Token Token 14
nasdaq_bxequities_orders_ouch_v4_2_display.replacement_order_token_token_14 = function(value)
  return "Replacement Order Token Token 14: "..value
end

-- Dissect: Replacement Order Token Token 14
nasdaq_bxequities_orders_ouch_v4_2_dissect.replacement_order_token_token_14 = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.replacement_order_token_token_14
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.existing_order_token = 14

-- Display: Existing Order Token
nasdaq_bxequities_orders_ouch_v4_2_display.existing_order_token = function(value)
  return "Existing Order Token: "..value
end

-- Dissect: Existing Order Token
nasdaq_bxequities_orders_ouch_v4_2_dissect.existing_order_token = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.existing_order_token
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.replace_order_message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.existing_order_token

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.replacement_order_token_token_14

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.shares

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.price

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.time_in_force

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.display

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.intermarket_sweep_eligibility

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.minimum_quantity

  return index
end

-- Display: Replace Order Message
nasdaq_bxequities_orders_ouch_v4_2_display.replace_order_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replace Order Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.replace_order_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Existing Order Token: 14 Byte Ascii String
  index, existing_order_token = nasdaq_bxequities_orders_ouch_v4_2_dissect.existing_order_token(buffer, index, packet, parent)

  -- Replacement Order Token Token 14: 14 Byte Ascii String
  index, replacement_order_token_token_14 = nasdaq_bxequities_orders_ouch_v4_2_dissect.replacement_order_token_token_14(buffer, index, packet, parent)

  -- Shares: 4 Byte Unsigned Fixed Width Integer
  index, shares = nasdaq_bxequities_orders_ouch_v4_2_dissect.shares(buffer, index, packet, parent)

  -- Price: 4 Byte Unsigned Fixed Width Integer
  index, price = nasdaq_bxequities_orders_ouch_v4_2_dissect.price(buffer, index, packet, parent)

  -- Time In Force: 4 Byte Unsigned Fixed Width Integer
  index, time_in_force = nasdaq_bxequities_orders_ouch_v4_2_dissect.time_in_force(buffer, index, packet, parent)

  -- Display: 1 Byte Ascii String Enum with 10 values
  index, display = nasdaq_bxequities_orders_ouch_v4_2_dissect.display(buffer, index, packet, parent)

  -- Intermarket Sweep Eligibility: 1 Byte Ascii String Enum with 3 values
  index, intermarket_sweep_eligibility = nasdaq_bxequities_orders_ouch_v4_2_dissect.intermarket_sweep_eligibility(buffer, index, packet, parent)

  -- Minimum Quantity: 4 Byte Unsigned Fixed Width Integer
  index, minimum_quantity = nasdaq_bxequities_orders_ouch_v4_2_dissect.minimum_quantity(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.replace_order_message = function(buffer, offset, packet, parent)
  if show.replace_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.replace_order_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.replace_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.replace_order_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.replace_order_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Cross Type
nasdaq_bxequities_orders_ouch_v4_2_size_of.cross_type = 1

-- Display: Cross Type
nasdaq_bxequities_orders_ouch_v4_2_display.cross_type = function(value)
  if value == "N" then
...
-- Dissect: Cross Type
nasdaq_bxequities_orders_ouch_v4_2_dissect.cross_type = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.cross_type
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Capacity
nasdaq_bxequities_orders_ouch_v4_2_size_of.capacity = 1

-- Display: Capacity
nasdaq_bxequities_orders_ouch_v4_2_display.capacity = function(value)
  if value == "O" then
...
-- Dissect: Capacity
nasdaq_bxequities_orders_ouch_v4_2_dissect.capacity = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.capacity
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Firm
nasdaq_bxequities_orders_ouch_v4_2_size_of.firm = 4

-- Display: Firm
nasdaq_bxequities_orders_ouch_v4_2_display.firm = function(value)
  return "Firm: "..value
end

-- Dissect: Firm
nasdaq_bxequities_orders_ouch_v4_2_dissect.firm = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.firm
  local range = buffer(offset, length)
...
-- Size: Stock
nasdaq_bxequities_orders_ouch_v4_2_size_of.stock = 8

-- Display: Stock
nasdaq_bxequities_orders_ouch_v4_2_display.stock = function(value)
  return "Stock: "..value
end

-- Dissect: Stock
nasdaq_bxequities_orders_ouch_v4_2_dissect.stock = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.stock
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.enter_order_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.stock

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.price

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.time_in_force

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.firm

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.display

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.capacity

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.intermarket_sweep_eligibility

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.minimum_quantity

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.cross_type

  return index
end

-- Display: Enter Order Message
nasdaq_bxequities_orders_ouch_v4_2_display.enter_order_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Enter Order Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.enter_order_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, stock = nasdaq_bxequities_orders_ouch_v4_2_dissect.stock(buffer, index, packet, parent)
  ...
  index, firm = nasdaq_bxequities_orders_ouch_v4_2_dissect.firm(buffer, index, packet, parent)

  -- Display: 1 Byte Ascii String Enum with 10 values
  index, display = nasdaq_bxequities_orders_ouch_v4_2_dissect.display(buffer, index, packet, parent)

  -- Capacity: 1 Byte Ascii String Enum with 4 values
  index, capacity = nasdaq_bxequities_orders_ouch_v4_2_dissect.capacity(buffer, index, packet, parent)
  ...
  index, cross_type = nasdaq_bxequities_orders_ouch_v4_2_dissect.cross_type(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.enter_order_message = function(buffer, offset, packet, parent)
  if show.enter_order_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.enter_order_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.enter_order_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.enter_order_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.enter_order_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Unsequenced Message
nasdaq_bxequities_orders_ouch_v4_2_size_of.unsequenced_message = function(buffer, offset, unsequenced_message_type)
  -- Size of Enter Order Message
  if unsequenced_message_type == "O" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.enter_order_message(buffer, offset)
  end
  -- Size of Replace Order Message
  if unsequenced_message_type == "U" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.replace_order_message(buffer, offset)
  end
  -- Size of Cancel Order Message
  if unsequenced_message_type == "X" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.cancel_order_message(buffer, offset)
  end
  -- Size of Modify Order Message
  if unsequenced_message_type == "M" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.modify_order_message(buffer, offset)
  end
  -- Size of Trade Now Message
  if unsequenced_message_type == "N" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.trade_now_message(buffer, offset)
  end
...
nasdaq_bxequities_orders_ouch_v4_2_display.unsequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Unsequenced Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_message_branches = function(buffer, offset, packet, parent, unsequenced_message_type)
  -- Dissect Enter Order Message
  if unsequenced_message_type == "O" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.enter_order_message(buffer, offset, packet, parent)
  end
  -- Dissect Replace Order Message
  if unsequenced_message_type == "U" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.replace_order_message(buffer, offset, packet, parent)
  end
  -- Dissect Cancel Order Message
  if unsequenced_message_type == "X" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_order_message(buffer, offset, packet, parent)
  end
  -- Dissect Modify Order Message
  if unsequenced_message_type == "M" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.modify_order_message(buffer, offset, packet, parent)
  end
  -- Dissect Trade Now Message
  if unsequenced_message_type == "N" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.trade_now_message(buffer, offset, packet, parent)
  end
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_message = function(buffer, offset, packet, parent, unsequenced_message_type)
  ...
  local size = nasdaq_bxequities_orders_ouch_v4_2_size_of.unsequenced_message(buffer, offset, unsequenced_message_type)
  if size == 0 then
    return offset
  end
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.unsequenced_message_type = 1

-- Display: Unsequenced Message Type
nasdaq_bxequities_orders_ouch_v4_2_display.unsequenced_message_type = function(value)
  if value == "O" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_message_type = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.unsequenced_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.unsequenced_data_packet = function(buffer, offset)
  local index = offset
...
nasdaq_bxequities_orders_ouch_v4_2_display.unsequenced_data_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Unsequenced Data Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  local index = offset

  -- Unsequenced Message Type: 1 Byte Ascii String Enum with 5 values
  index, unsequenced_message_type = nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_message_type(buffer, index, packet, parent)

  -- Unsequenced Message: Runtime Type with 5 branches
  index = nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_message(buffer, index, packet, parent, unsequenced_message_type)

  return index
end

-- Dissect: Unsequenced Data Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_unsequenced_data_packet = nasdaq_bxequities_orders_ouch_v4_2_size_of.unsequenced_data_packet(buffer, offset)
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.requested_sequence_number = 20

-- Display: Requested Sequence Number
nasdaq_bxequities_orders_ouch_v4_2_display.requested_sequence_number = function(value)
  return "Requested Sequence Number: "..value
end

-- Dissect: Requested Sequence Number
nasdaq_bxequities_orders_ouch_v4_2_dissect.requested_sequence_number = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.requested_sequence_number
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.requested_session = 10

-- Display: Requested Session
nasdaq_bxequities_orders_ouch_v4_2_display.requested_session = function(value)
  return "Requested Session: "..value
end

-- Dissect: Requested Session
nasdaq_bxequities_orders_ouch_v4_2_dissect.requested_session = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.requested_session
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Password
nasdaq_bxequities_orders_ouch_v4_2_size_of.password = 10

-- Display: Password
nasdaq_bxequities_orders_ouch_v4_2_display.password = function(value)
  return "Password: "..value
end

-- Dissect: Password
nasdaq_bxequities_orders_ouch_v4_2_dissect.password = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.password
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Username
nasdaq_bxequities_orders_ouch_v4_2_size_of.username = 6

-- Display: Username
nasdaq_bxequities_orders_ouch_v4_2_display.username = function(value)
  return "Username: "..value
end

-- Dissect: Username
nasdaq_bxequities_orders_ouch_v4_2_dissect.username = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.username
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.login_request_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.username

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.password

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.requested_session

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.requested_sequence_number

  return index
end

-- Display: Login Request Packet
nasdaq_bxequities_orders_ouch_v4_2_display.login_request_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Request Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.login_request_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Username: 6 Byte Ascii String
  index, username = nasdaq_bxequities_orders_ouch_v4_2_dissect.username(buffer, index, packet, parent)

  -- Password: 10 Byte Ascii String
  index, password = nasdaq_bxequities_orders_ouch_v4_2_dissect.password(buffer, index, packet, parent)

  -- Requested Session: 10 Byte Ascii String
  index, requested_session = nasdaq_bxequities_orders_ouch_v4_2_dissect.requested_session(buffer, index, packet, parent)

  -- Requested Sequence Number: 20 Byte Ascii String
  index, requested_sequence_number = nasdaq_bxequities_orders_ouch_v4_2_dissect.requested_sequence_number(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.login_request_packet = function(buffer, offset, packet, parent)
  if show.login_request_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.login_request_packet, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.login_request_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.login_request_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.login_request_packet_fields(buffer, offset, packet, element)
  end
end

-- Size: Timestamp
nasdaq_bxequities_orders_ouch_v4_2_size_of.timestamp = 8

-- Display: Timestamp
nasdaq_bxequities_orders_ouch_v4_2_display.timestamp = function(value)
  return "Timestamp: "..value
end

-- Dissect: Timestamp
nasdaq_bxequities_orders_ouch_v4_2_dissect.timestamp = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.timestamp
  local range = buffer(offset, length)
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.order_modified_message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.timestamp
...
nasdaq_bxequities_orders_ouch_v4_2_display.order_modified_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Modified Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.order_modified_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Timestamp: 8 Byte Unsigned Fixed Width Integer
  index, timestamp = nasdaq_bxequities_orders_ouch_v4_2_dissect.timestamp(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.order_modified_message = function(buffer, offset, packet, parent)
  if show.order_modified_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.order_modified_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.order_modified_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.order_modified_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.order_modified_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Order Reference Number
nasdaq_bxequities_orders_ouch_v4_2_size_of.order_reference_number = 8

-- Display: Order Reference Number
nasdaq_bxequities_orders_ouch_v4_2_display.order_reference_number = function(value)
  return "Order Reference Number: "..value
end

-- Dissect: Order Reference Number
nasdaq_bxequities_orders_ouch_v4_2_dissect.order_reference_number = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.order_reference_number
  local range = buffer(offset, length)
  local value = range:uint64()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.order_priority_update_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.order_reference_number

  return index
end

-- Display: Order Priority Update Message
nasdaq_bxequities_orders_ouch_v4_2_display.order_priority_update_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Priority Update Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.order_priority_update_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_reference_number = nasdaq_bxequities_orders_ouch_v4_2_dissect.order_reference_number(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.order_priority_update_message = function(buffer, offset, packet, parent)
  if show.order_priority_update_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.order_priority_update_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.order_priority_update_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.order_priority_update_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.order_priority_update_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Cancel Reject Message
nasdaq_bxequities_orders_ouch_v4_2_size_of.cancel_reject_message = function(buffer, offset)
  local index = 0
...
nasdaq_bxequities_orders_ouch_v4_2_display.cancel_reject_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Reject Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_reject_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_reject_message = function(buffer, offset, packet, parent)
  if show.cancel_reject_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.cancel_reject_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_reject_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.cancel_reject_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_reject_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Cancel Pending Message
nasdaq_bxequities_orders_ouch_v4_2_size_of.cancel_pending_message = function(buffer, offset)
  local index = 0
...
nasdaq_bxequities_orders_ouch_v4_2_display.cancel_pending_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Cancel Pending Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_pending_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_pending_message = function(buffer, offset, packet, parent)
  if show.cancel_pending_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.cancel_pending_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_pending_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.cancel_pending_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_pending_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Rejected Reason
nasdaq_bxequities_orders_ouch_v4_2_size_of.rejected_reason = 1

-- Display: Rejected Reason
nasdaq_bxequities_orders_ouch_v4_2_display.rejected_reason = function(value)
  if value == "T" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.rejected_reason = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.rejected_reason
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.rejected_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.rejected_reason

  return index
end

-- Display: Rejected Message
nasdaq_bxequities_orders_ouch_v4_2_display.rejected_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Rejected Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.rejected_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, rejected_reason = nasdaq_bxequities_orders_ouch_v4_2_dissect.rejected_reason(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.rejected_message = function(buffer, offset, packet, parent)
  if show.rejected_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.rejected_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.rejected_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.rejected_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.rejected_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Broken Trade Reason
nasdaq_bxequities_orders_ouch_v4_2_size_of.broken_trade_reason = 1

-- Display: Broken Trade Reason
nasdaq_bxequities_orders_ouch_v4_2_display.broken_trade_reason = function(value)
  if value == "E" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.broken_trade_reason = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.broken_trade_reason
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Match Number
nasdaq_bxequities_orders_ouch_v4_2_size_of.match_number = 8

-- Display: Match Number
nasdaq_bxequities_orders_ouch_v4_2_display.match_number = function(value)
  return "Match Number: "..value
end

-- Dissect: Match Number
nasdaq_bxequities_orders_ouch_v4_2_dissect.match_number = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.match_number
  local range = buffer(offset, length)
  local value = range:uint64()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.broken_trade_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.match_number

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.broken_trade_reason

  return index
end

-- Display: Broken Trade Message
nasdaq_bxequities_orders_ouch_v4_2_display.broken_trade_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Broken Trade Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.broken_trade_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, match_number = nasdaq_bxequities_orders_ouch_v4_2_dissect.match_number(buffer, index, packet, parent)

  -- Broken Trade Reason: 1 Byte Ascii String Enum with 4 values
  index, broken_trade_reason = nasdaq_bxequities_orders_ouch_v4_2_dissect.broken_trade_reason(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.broken_trade_message = function(buffer, offset, packet, parent)
  if show.broken_trade_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.broken_trade_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.broken_trade_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.broken_trade_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.broken_trade_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Liquidity Flag
nasdaq_bxequities_orders_ouch_v4_2_size_of.liquidity_flag = 1

-- Display: Liquidity Flag
nasdaq_bxequities_orders_ouch_v4_2_display.liquidity_flag = function(value)
  if value == "A" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.liquidity_flag = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.liquidity_flag
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.execution_price = 4

-- Display: Execution Price
nasdaq_bxequities_orders_ouch_v4_2_display.execution_price = function(value)
  return "Execution Price: "..value
end

-- Dissect: Execution Price
nasdaq_bxequities_orders_ouch_v4_2_dissect.execution_price = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.execution_price
  local range = buffer(offset, length)
  local value = range:uint()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.executed_shares = 4

-- Display: Executed Shares
nasdaq_bxequities_orders_ouch_v4_2_display.executed_shares = function(value)
  return "Executed Shares: "..value
end

-- Dissect: Executed Shares
nasdaq_bxequities_orders_ouch_v4_2_dissect.executed_shares = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.executed_shares
  local range = buffer(offset, length)
  local value = range:uint()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.executed_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.executed_shares

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.execution_price

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.liquidity_flag
...
nasdaq_bxequities_orders_ouch_v4_2_display.executed_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Executed Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.executed_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, executed_shares = nasdaq_bxequities_orders_ouch_v4_2_dissect.executed_shares(buffer, index, packet, parent)

  -- Execution Price: 4 Byte Unsigned Fixed Width Integer
  index, execution_price = nasdaq_bxequities_orders_ouch_v4_2_dissect.execution_price(buffer, index, packet, parent)

  -- Liquidity Flag: 1 Byte Ascii String Enum with 13 values
  index, liquidity_flag = nasdaq_bxequities_orders_ouch_v4_2_dissect.liquidity_flag(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.executed_message = function(buffer, offset, packet, parent)
  if show.executed_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.executed_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.executed_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.executed_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.executed_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Quantity Prevented From Trading
nasdaq_bxequities_orders_ouch_v4_2_size_of.quantity_prevented_from_trading = 4

-- Display: Quantity Prevented From Trading
nasdaq_bxequities_orders_ouch_v4_2_display.quantity_prevented_from_trading = function(value)
  return "Quantity Prevented From Trading: "..value
end

-- Dissect: Quantity Prevented From Trading
nasdaq_bxequities_orders_ouch_v4_2_dissect.quantity_prevented_from_trading = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.quantity_prevented_from_trading
  local range = buffer(offset, length)
  local value = range:uint()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.aiq_canceled_reason = 1

-- Display: Aiq Canceled Reason
nasdaq_bxequities_orders_ouch_v4_2_display.aiq_canceled_reason = function(value)
  return "Aiq Canceled Reason: "..value
end

-- Dissect: Aiq Canceled Reason
nasdaq_bxequities_orders_ouch_v4_2_dissect.aiq_canceled_reason = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.aiq_canceled_reason
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.decrement_shares = 4

-- Display: Decrement Shares
nasdaq_bxequities_orders_ouch_v4_2_display.decrement_shares = function(value)
  return "Decrement Shares: "..value
end

-- Dissect: Decrement Shares
nasdaq_bxequities_orders_ouch_v4_2_dissect.decrement_shares = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.decrement_shares
  local range = buffer(offset, length)
  local value = range:uint()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.aiq_canceled_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.decrement_shares

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.aiq_canceled_reason

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.quantity_prevented_from_trading
...
nasdaq_bxequities_orders_ouch_v4_2_display.aiq_canceled_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Aiq Canceled Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.aiq_canceled_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, decrement_shares = nasdaq_bxequities_orders_ouch_v4_2_dissect.decrement_shares(buffer, index, packet, parent)

  -- Aiq Canceled Reason: 1 Byte Ascii String
  index, aiq_canceled_reason = nasdaq_bxequities_orders_ouch_v4_2_dissect.aiq_canceled_reason(buffer, index, packet, parent)

  -- Quantity Prevented From Trading: 4 Byte Unsigned Fixed Width Integer
  index, quantity_prevented_from_trading = nasdaq_bxequities_orders_ouch_v4_2_dissect.quantity_prevented_from_trading(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.aiq_canceled_message = function(buffer, offset, packet, parent)
  if show.aiq_canceled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.aiq_canceled_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.aiq_canceled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.aiq_canceled_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.aiq_canceled_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Canceled Reason
nasdaq_bxequities_orders_ouch_v4_2_size_of.canceled_reason = 1

-- Display: Canceled Reason
nasdaq_bxequities_orders_ouch_v4_2_display.canceled_reason = function(value)
  if value == "U" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.canceled_reason = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.canceled_reason
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.canceled_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.canceled_reason

  return index
end

-- Display: Canceled Message
nasdaq_bxequities_orders_ouch_v4_2_display.canceled_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Canceled Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.canceled_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, canceled_reason = nasdaq_bxequities_orders_ouch_v4_2_dissect.canceled_reason(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.canceled_message = function(buffer, offset, packet, parent)
  if show.canceled_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.canceled_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.canceled_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.canceled_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.canceled_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Bbo Weight Indicator
nasdaq_bxequities_orders_ouch_v4_2_size_of.bbo_weight_indicator = 1

-- Display: Bbo Weight Indicator
nasdaq_bxequities_orders_ouch_v4_2_display.bbo_weight_indicator = function(value)
  if value == "0" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.bbo_weight_indicator = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.bbo_weight_indicator
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.previous_order_token = 14

-- Display: Previous Order Token
nasdaq_bxequities_orders_ouch_v4_2_display.previous_order_token = function(value)
  return "Previous Order Token: "..value
end

-- Dissect: Previous Order Token
nasdaq_bxequities_orders_ouch_v4_2_dissect.previous_order_token = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.previous_order_token
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Order State
nasdaq_bxequities_orders_ouch_v4_2_size_of.order_state = 1

-- Display: Order State
nasdaq_bxequities_orders_ouch_v4_2_display.order_state = function(value)
  if value == "L" then
...
-- Dissect: Order State
nasdaq_bxequities_orders_ouch_v4_2_dissect.order_state = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.order_state
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.replacement_order_token_alphanumeric_14 = 14

-- Display: Replacement Order Token Alphanumeric 14
nasdaq_bxequities_orders_ouch_v4_2_display.replacement_order_token_alphanumeric_14 = function(value)
  return "Replacement Order Token Alphanumeric 14: "..value
end

-- Dissect: Replacement Order Token Alphanumeric 14
nasdaq_bxequities_orders_ouch_v4_2_dissect.replacement_order_token_alphanumeric_14 = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.replacement_order_token_alphanumeric_14
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.replaced_message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.timestamp

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.replacement_order_token_alphanumeric_14
  ...
  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.order_state

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.previous_order_token

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.bbo_weight_indicator

  return index
end

-- Display: Replaced Message
nasdaq_bxequities_orders_ouch_v4_2_display.replaced_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Replaced Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.replaced_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, replacement_order_token_alphanumeric_14 = nasdaq_bxequities_orders_ouch_v4_2_dissect.replacement_order_token_alphanumeric_14(buffer, index, packet, parent)
  ...
  index, order_state = nasdaq_bxequities_orders_ouch_v4_2_dissect.order_state(buffer, index, packet, parent)

  -- Previous Order Token: 14 Byte Ascii String
  index, previous_order_token = nasdaq_bxequities_orders_ouch_v4_2_dissect.previous_order_token(buffer, index, packet, parent)

  -- Bbo Weight Indicator: 1 Byte Ascii String Enum with 6 values
  index, bbo_weight_indicator = nasdaq_bxequities_orders_ouch_v4_2_dissect.bbo_weight_indicator(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.replaced_message = function(buffer, offset, packet, parent)
  if show.replaced_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.replaced_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.replaced_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.replaced_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.replaced_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Accepted Message
nasdaq_bxequities_orders_ouch_v4_2_size_of.accepted_message = function(buffer, offset)
  local index = 0
...
nasdaq_bxequities_orders_ouch_v4_2_display.accepted_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Accepted Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.accepted_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.accepted_message = function(buffer, offset, packet, parent)
  if show.accepted_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.accepted_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.accepted_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.accepted_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.accepted_message_fields(buffer, offset, packet, element)
  end
end

-- Size: Event Code
nasdaq_bxequities_orders_ouch_v4_2_size_of.event_code = 1

-- Display: Event Code
nasdaq_bxequities_orders_ouch_v4_2_display.event_code = function(value)
  if value == "S" then
...
-- Dissect: Event Code
nasdaq_bxequities_orders_ouch_v4_2_dissect.event_code = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.event_code
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.system_event_message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.timestamp

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.event_code

  return index
end

-- Display: System Event Message
nasdaq_bxequities_orders_ouch_v4_2_display.system_event_message = function(packet, parent, length)
  return ""
end

-- Dissect Fields: System Event Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.system_event_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, event_code = nasdaq_bxequities_orders_ouch_v4_2_dissect.event_code(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.system_event_message = function(buffer, offset, packet, parent)
  if show.system_event_message then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.system_event_message, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.system_event_message_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.system_event_message(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.system_event_message_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Sequenced Message
nasdaq_bxequities_orders_ouch_v4_2_size_of.sequenced_message = function(buffer, offset, sequenced_message_type)
  -- Size of System Event Message
  if sequenced_message_type == "S" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.system_event_message(buffer, offset)
  end
  -- Size of Accepted Message
  if sequenced_message_type == "A" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.accepted_message(buffer, offset)
  end
  -- Size of Replaced Message
  if sequenced_message_type == "U" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.replaced_message(buffer, offset)
  end
  -- Size of Canceled Message
  if sequenced_message_type == "C" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.canceled_message(buffer, offset)
  end
  -- Size of Aiq Canceled Message
  if sequenced_message_type == "D" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.aiq_canceled_message(buffer, offset)
  end
  -- Size of Executed Message
  if sequenced_message_type == "E" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.executed_message(buffer, offset)
  end
  -- Size of Broken Trade Message
  if sequenced_message_type == "B" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.broken_trade_message(buffer, offset)
  end
  -- Size of Rejected Message
  if sequenced_message_type == "J" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.rejected_message(buffer, offset)
  end
  -- Size of Cancel Pending Message
  if sequenced_message_type == "P" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.cancel_pending_message(buffer, offset)
  end
  -- Size of Cancel Reject Message
  if sequenced_message_type == "I" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.cancel_reject_message(buffer, offset)
  end
  -- Size of Order Priority Update Message
  if sequenced_message_type == "T" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.order_priority_update_message(buffer, offset)
  end
  -- Size of Order Modified Message
  if sequenced_message_type == "M" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.order_modified_message(buffer, offset)
  end
...
nasdaq_bxequities_orders_ouch_v4_2_display.sequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Sequenced Message
nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_message_branches = function(buffer, offset, packet, parent, sequenced_message_type)
  -- Dissect System Event Message
  if sequenced_message_type == "S" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.system_event_message(buffer, offset, packet, parent)
  end
  -- Dissect Accepted Message
  if sequenced_message_type == "A" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.accepted_message(buffer, offset, packet, parent)
  end
  -- Dissect Replaced Message
  if sequenced_message_type == "U" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.replaced_message(buffer, offset, packet, parent)
  end
  -- Dissect Canceled Message
  if sequenced_message_type == "C" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.canceled_message(buffer, offset, packet, parent)
  end
  -- Dissect Aiq Canceled Message
  if sequenced_message_type == "D" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.aiq_canceled_message(buffer, offset, packet, parent)
  end
  -- Dissect Executed Message
  if sequenced_message_type == "E" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.executed_message(buffer, offset, packet, parent)
  end
  -- Dissect Broken Trade Message
  if sequenced_message_type == "B" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.broken_trade_message(buffer, offset, packet, parent)
  end
  -- Dissect Rejected Message
  if sequenced_message_type == "J" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.rejected_message(buffer, offset, packet, parent)
  end
  -- Dissect Cancel Pending Message
  if sequenced_message_type == "P" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_pending_message(buffer, offset, packet, parent)
  end
  -- Dissect Cancel Reject Message
  if sequenced_message_type == "I" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.cancel_reject_message(buffer, offset, packet, parent)
  end
  -- Dissect Order Priority Update Message
  if sequenced_message_type == "T" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.order_priority_update_message(buffer, offset, packet, parent)
  end
  -- Dissect Order Modified Message
  if sequenced_message_type == "M" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.order_modified_message(buffer, offset, packet, parent)
  end
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_message = function(buffer, offset, packet, parent, sequenced_message_type)
  ...
  -- Calculate size and check that branch is not empty
  local size = nasdaq_bxequities_orders_ouch_v4_2_size_of.sequenced_message(buffer, offset, sequenced_message_type)
  if size == 0 then
    return offset
  end
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.sequenced_message_type = 1

-- Display: Sequenced Message Type
nasdaq_bxequities_orders_ouch_v4_2_display.sequenced_message_type = function(value)
  if value == "S" then
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_message_type = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.sequenced_message_type
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.sequenced_data_packet = function(buffer, offset)
  local index = offset
...
nasdaq_bxequities_orders_ouch_v4_2_display.sequenced_data_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequenced Data Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  local index = offset

  -- Sequenced Message Type: 1 Byte Ascii String Enum with 12 values
  index, sequenced_message_type = nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_message_type(buffer, index, packet, parent)

  -- Sequenced Message: Runtime Type with 12 branches
  index = nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_message(buffer, index, packet, parent, sequenced_message_type)

  return index
end

-- Dissect: Sequenced Data Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_sequenced_data_packet = nasdaq_bxequities_orders_ouch_v4_2_size_of.sequenced_data_packet(buffer, offset)
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.reject_reason_code = 1

-- Display: Reject Reason Code
nasdaq_bxequities_orders_ouch_v4_2_display.reject_reason_code = function(value)
  return "Reject Reason Code: "..value
end

-- Dissect: Reject Reason Code
nasdaq_bxequities_orders_ouch_v4_2_dissect.reject_reason_code = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.reject_reason_code
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.login_rejected_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.reject_reason_code

  return index
end

-- Display: Login Rejected Packet
nasdaq_bxequities_orders_ouch_v4_2_display.login_rejected_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Rejected Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.login_rejected_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Reject Reason Code: 1 Byte Ascii String
  index, reject_reason_code = nasdaq_bxequities_orders_ouch_v4_2_dissect.reject_reason_code(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.login_rejected_packet = function(buffer, offset, packet, parent)
  if show.login_rejected_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.login_rejected_packet, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.login_rejected_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.login_rejected_packet_fields(buffer, offset, packet, element)
  end
end

-- Size: Sequence Number
nasdaq_bxequities_orders_ouch_v4_2_size_of.sequence_number = 20

-- Display: Sequence Number
nasdaq_bxequities_orders_ouch_v4_2_display.sequence_number = function(value)
  return "Sequence Number: "..value
end

-- Dissect: Sequence Number
nasdaq_bxequities_orders_ouch_v4_2_dissect.sequence_number = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.sequence_number
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Session
nasdaq_bxequities_orders_ouch_v4_2_size_of.session = 10

-- Display: Session
nasdaq_bxequities_orders_ouch_v4_2_display.session = function(value)
  return "Session: "..value
end

-- Dissect: Session
nasdaq_bxequities_orders_ouch_v4_2_dissect.session = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.session
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.login_accepted_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.session

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.sequence_number

  return index
end

-- Display: Login Accepted Packet
nasdaq_bxequities_orders_ouch_v4_2_display.login_accepted_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Login Accepted Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.login_accepted_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session: 10 Byte Ascii String
  index, session = nasdaq_bxequities_orders_ouch_v4_2_dissect.session(buffer, index, packet, parent)

  -- Sequence Number: 20 Byte Ascii String
  index, sequence_number = nasdaq_bxequities_orders_ouch_v4_2_dissect.sequence_number(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.login_accepted_packet = function(buffer, offset, packet, parent)
  if show.login_accepted_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.login_accepted_packet, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.login_accepted_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.login_accepted_packet_fields(buffer, offset, packet, element)
  end
end

-- Size: Text
nasdaq_bxequities_orders_ouch_v4_2_size_of.text = 1

-- Display: Text
nasdaq_bxequities_orders_ouch_v4_2_display.text = function(value)
  return "Text: "..value
end

-- Dissect: Text
nasdaq_bxequities_orders_ouch_v4_2_dissect.text = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.text
  local range = buffer(offset, length)
  local value = range:string()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.debug_packet = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.text

  return index
end

-- Display: Debug Packet
nasdaq_bxequities_orders_ouch_v4_2_display.debug_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Debug Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.debug_packet_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Text: 1 Byte Ascii String
  index, text = nasdaq_bxequities_orders_ouch_v4_2_dissect.text(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.debug_packet = function(buffer, offset, packet, parent)
  if show.debug_packet then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.debug_packet, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.debug_packet_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.debug_packet(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.debug_packet_fields(buffer, offset, packet, element)
  end
end

-- Calculate runtime size of: Payload
nasdaq_bxequities_orders_ouch_v4_2_size_of.payload = function(buffer, offset, packet_type)
  -- Size of Debug Packet
  if packet_type == "+" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.debug_packet(buffer, offset)
  end
  -- Size of Login Accepted Packet
  if packet_type == "A" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.login_accepted_packet(buffer, offset)
  end
  -- Size of Login Rejected Packet
  if packet_type == "J" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.login_rejected_packet(buffer, offset)
  end
  -- Size of Sequenced Data Packet
  if packet_type == "S" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.sequenced_data_packet(buffer, offset)
  end
  -- Size of Login Request Packet
  if packet_type == "L" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.login_request_packet(buffer, offset)
  end
  -- Size of Unsequenced Data Packet
  if packet_type == "U" then
    return nasdaq_bxequities_orders_ouch_v4_2_size_of.unsequenced_data_packet(buffer, offset)
  end
...
-- Display: Payload
nasdaq_bxequities_orders_ouch_v4_2_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
nasdaq_bxequities_orders_ouch_v4_2_dissect.payload_branches = function(buffer, offset, packet, parent, packet_type)
  -- Dissect Debug Packet
  if packet_type == "+" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.debug_packet(buffer, offset, packet, parent)
  end
  -- Dissect Login Accepted Packet
  if packet_type == "A" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.login_accepted_packet(buffer, offset, packet, parent)
  end
  -- Dissect Login Rejected Packet
  if packet_type == "J" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.login_rejected_packet(buffer, offset, packet, parent)
  end
  -- Dissect Sequenced Data Packet
  if packet_type == "S" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.sequenced_data_packet(buffer, offset, packet, parent)
  end
  -- Dissect Login Request Packet
  if packet_type == "L" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.login_request_packet(buffer, offset, packet, parent)
  end
  -- Dissect Unsequenced Data Packet
  if packet_type == "U" then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.unsequenced_data_packet(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
nasdaq_bxequities_orders_ouch_v4_2_dissect.payload = function(buffer, offset, packet, parent, packet_type)
  if not show.payload then
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.payload_branches(buffer, offset, packet, parent, packet_type)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_bxequities_orders_ouch_v4_2_size_of.payload(buffer, offset, packet_type)
  if size == 0 then
    return offset
  end
...
-- Size: Packet Type
nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_type = 1

-- Display: Packet Type
nasdaq_bxequities_orders_ouch_v4_2_display.packet_type = function(value)
  if value == "+" then
...
-- Dissect: Packet Type
nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_type = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_type
  local range = buffer(offset, length)
  local value = range:string()
...
-- Size: Packet Length
nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_length = 2

-- Display: Packet Length
nasdaq_bxequities_orders_ouch_v4_2_display.packet_length = function(value)
  return "Packet Length: "..value
end

-- Dissect: Packet Length
nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_length = function(buffer, offset, packet, parent)
  local length = nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_length
  local range = buffer(offset, length)
  local value = range:uint()
...
nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_header = function(buffer, offset)
  local index = 0

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_length

  index = index + nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_type

  return index
end

-- Display: Packet Header
nasdaq_bxequities_orders_ouch_v4_2_display.packet_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Packet Header
nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Packet Length: 2 Byte Unsigned Fixed Width Integer
  index, packet_length = nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_length(buffer, index, packet, parent)

  -- Packet Type: 1 Byte Ascii String Enum with 10 values
  index, packet_type = nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_type(buffer, index, packet, parent)
...
nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_header = function(buffer, offset, packet, parent)
  if show.packet_header then
    -- Optionally add element to protocol tree
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.packet_header, buffer(offset, 0))
    local index = nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.packet_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_header_fields(buffer, offset, packet, element)
  end
end

-- Display: Soup Bin Tcp Packet
nasdaq_bxequities_orders_ouch_v4_2_display.soup_bin_tcp_packet = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Soup Bin Tcp Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.soup_bin_tcp_packet_fields = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset

  -- Packet Header: Struct of 2 fields
  index, packet_header = nasdaq_bxequities_orders_ouch_v4_2_dissect.packet_header(buffer, index, packet, parent)

  -- Dependency element: Packet Type
  local packet_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 6 branches
  index = nasdaq_bxequities_orders_ouch_v4_2_dissect.payload(buffer, index, packet, parent, packet_type)

  return index
end

-- Dissect: Soup Bin Tcp Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.soup_bin_tcp_packet = function(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
  local index = offset + size_of_soup_bin_tcp_packet

  -- Optionally add group/struct element to protocol tree
  if show.soup_bin_tcp_packet then
    local element = parent:add(nasdaq_bxequities_orders_ouch_v4_2.fields.soup_bin_tcp_packet, buffer(offset, 0))
    local current = nasdaq_bxequities_orders_ouch_v4_2_dissect.soup_bin_tcp_packet_fields(buffer, offset, packet, element, size_of_soup_bin_tcp_packet)
    element:set_len(size_of_soup_bin_tcp_packet)
    local display = nasdaq_bxequities_orders_ouch_v4_2_display.soup_bin_tcp_packet(buffer, packet, element)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    nasdaq_bxequities_orders_ouch_v4_2_dissect.soup_bin_tcp_packet_fields(buffer, offset, packet, parent, size_of_soup_bin_tcp_packet)
...
local soup_bin_tcp_packet_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < nasdaq_bxequities_orders_ouch_v4_2_size_of.packet_header(buffer, index) then
...
-- Dissect Packet
nasdaq_bxequities_orders_ouch_v4_2_dissect.packet = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = nasdaq_bxequities_orders_ouch_v4_2_dissect.soup_bin_tcp_packet(buffer, index, packet, parent, size_of_soup_bin_tcp_packet)
    else
