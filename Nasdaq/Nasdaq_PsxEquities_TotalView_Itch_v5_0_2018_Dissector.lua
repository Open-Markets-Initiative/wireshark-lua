...
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_add_order_no_mpid_attribution_message = Pref.bool("Show Add Order No Mpid Attribution Message", show.add_order_no_mpid_attribution_message, "Parse and add Add Order No Mpid Attribution Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_add_order_with_mpid_attribution_message = Pref.bool("Show Add Order With Mpid Attribution Message", show.add_order_with_mpid_attribution_message, "Parse and add Add Order With Mpid Attribution Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_broken_trade_message = Pref.bool("Show Broken Trade Message", show.broken_trade_message, "Parse and add Broken Trade Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_cross_trade_message = Pref.bool("Show Cross Trade Message", show.cross_trade_message, "Parse and add Cross Trade Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_luld_auction_collar_message = Pref.bool("Show Luld Auction Collar Message", show.luld_auction_collar_message, "Parse and add Luld Auction Collar Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_market_participant_position_message = Pref.bool("Show Market Participant Position Message", show.market_participant_position_message, "Parse and add Market Participant Position Message to protocol tree")
...
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_mwcb_decline_level_message = Pref.bool("Show Mwcb Decline Level Message", show.mwcb_decline_level_message, "Parse and add Mwcb Decline Level Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_mwcb_status_level_message = Pref.bool("Show Mwcb Status Level Message", show.mwcb_status_level_message, "Parse and add Mwcb Status Level Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_net_order_imbalance_indicator_message = Pref.bool("Show Net Order Imbalance Indicator Message", show.net_order_imbalance_indicator_message, "Parse and add Net Order Imbalance Indicator Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_operational_halt_message = Pref.bool("Show Operational Halt Message", show.operational_halt_message, "Parse and add Operational Halt Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_cancel_message = Pref.bool("Show Order Cancel Message", show.order_cancel_message, "Parse and add Order Cancel Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_delete_message = Pref.bool("Show Order Delete Message", show.order_delete_message, "Parse and add Order Delete Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_executed_message = Pref.bool("Show Order Executed Message", show.order_executed_message, "Parse and add Order Executed Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_executed_with_price_message = Pref.bool("Show Order Executed With Price Message", show.order_executed_with_price_message, "Parse and add Order Executed With Price Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_replace_message = Pref.bool("Show Order Replace Message", show.order_replace_message, "Parse and add Order Replace Message to protocol tree")
...
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message = Pref.bool("Show Reg Sho Short Sale Price Test Restricted Indicator Message", show.reg_sho_short_sale_price_test_restricted_indicator_message, "Parse and add Reg Sho Short Sale Price Test Restricted Indicator Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_stock_directory_message = Pref.bool("Show Stock Directory Message", show.stock_directory_message, "Parse and add Stock Directory Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_stock_trading_action_message = Pref.bool("Show Stock Trading Action Message", show.stock_trading_action_message, "Parse and add Stock Trading Action Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_system_event_message = Pref.bool("Show System Event Message", show.system_event_message, "Parse and add System Event Message to protocol tree")
omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_trade_message_non_cross = Pref.bool("Show Trade Message Non Cross", show.trade_message_non_cross, "Parse and add Trade Message Non Cross to protocol tree")
...
function omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs_changed()
  ...
  if show.add_order_no_mpid_attribution_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_add_order_no_mpid_attribution_message then
    show.add_order_no_mpid_attribution_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_add_order_no_mpid_attribution_message
    changed = true
  end
  if show.add_order_with_mpid_attribution_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_add_order_with_mpid_attribution_message then
    show.add_order_with_mpid_attribution_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_add_order_with_mpid_attribution_message
    changed = true
  end
  if show.broken_trade_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_broken_trade_message then
    show.broken_trade_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_broken_trade_message
    changed = true
  end
  if show.cross_trade_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_cross_trade_message then
    show.cross_trade_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_cross_trade_message
    changed = true
  end
  if show.luld_auction_collar_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_luld_auction_collar_message then
    show.luld_auction_collar_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_luld_auction_collar_message
    changed = true
  end
  if show.market_participant_position_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_market_participant_position_message then
    show.market_participant_position_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_market_participant_position_message
    changed = true
  end
  ...
  if show.mwcb_decline_level_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_mwcb_decline_level_message then
    show.mwcb_decline_level_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_mwcb_decline_level_message
    changed = true
  end
  if show.mwcb_status_level_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_mwcb_status_level_message then
    show.mwcb_status_level_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_mwcb_status_level_message
    changed = true
  end
  if show.net_order_imbalance_indicator_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_net_order_imbalance_indicator_message then
    show.net_order_imbalance_indicator_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_net_order_imbalance_indicator_message
    changed = true
  end
  if show.operational_halt_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_operational_halt_message then
    show.operational_halt_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_operational_halt_message
    changed = true
  end
  if show.order_cancel_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_cancel_message then
    show.order_cancel_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_cancel_message
    changed = true
  end
  if show.order_delete_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_delete_message then
    show.order_delete_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_delete_message
    changed = true
  end
  if show.order_executed_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_executed_message then
    show.order_executed_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_executed_message
    changed = true
  end
  if show.order_executed_with_price_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_executed_with_price_message then
    show.order_executed_with_price_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_executed_with_price_message
    changed = true
  end
  if show.order_replace_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_replace_message then
    show.order_replace_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_order_replace_message
    changed = true
  end
  ...
  if show.reg_sho_short_sale_price_test_restricted_indicator_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message then
    show.reg_sho_short_sale_price_test_restricted_indicator_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message
    changed = true
  end
  if show.stock_directory_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_stock_directory_message then
    show.stock_directory_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_stock_directory_message
    changed = true
  end
  if show.stock_trading_action_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_stock_trading_action_message then
    show.stock_trading_action_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_stock_trading_action_message
    changed = true
  end
  if show.system_event_message ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_system_event_message then
    show.system_event_message = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_system_event_message
    changed = true
  end
  if show.trade_message_non_cross ~= omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_trade_message_non_cross then
    show.trade_message_non_cross = omi_nasdaq_psxequities_totalview_itch_v5_0_2018.prefs.show_trade_message_non_cross
    changed = true
  end
...
-- Dissector Heuristic for Nasdaq PsxEquities TotalView Itch 5.0.2018
local function omi_nasdaq_psxequities_totalview_itch_v5_0_2018_heuristic(buffer, packet, parent)
...
omi_nasdaq_psxequities_totalview_itch_v5_0_2018:register_heuristic("udp", omi_nasdaq_psxequities_totalview_itch_v5_0_2018_heuristic)
