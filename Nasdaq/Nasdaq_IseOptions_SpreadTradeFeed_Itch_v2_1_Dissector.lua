...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.end_of_session_packet = {}

-- Display: End Of Session Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.display = function(packet, parent, length)
  return "End Of Session Packet"
end


-- Dissect: End Of Session Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet = {}

-- Display: Server Heartbeat Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.display = function(packet, parent, length)
  return "Server Heartbeat Packet"
end


-- Dissect: Server Heartbeat Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_tcp_payload.dissect = function(buffer, offset, packet, parent, server_packet_type)
  ...
  if server_packet_type == "H" then
    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.server_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session Packet
  if server_packet_type == "Z" then
    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.end_of_session_packet.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.logout_request_packet = {}

-- Display: Logout Request Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.logout_request_packet.display = function(packet, parent, length)
  return "Logout Request Packet"
end


-- Dissect: Logout Request Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.logout_request_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.logout_request_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet = {}

-- Display: Client Heartbeat Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.display = function(packet, parent, length)
  return "Client Heartbeat Packet"
end


-- Dissect: Client Heartbeat Packet
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_tcp_payload.dissect = function(buffer, offset, packet, parent, client_packet_type)
  ...
  if client_packet_type == "R" then
    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.client_heartbeat_packet.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Logout Request Packet
  if client_packet_type == "O" then
    return nasdaq_iseoptions_spreadtradefeed_itch_v2_1.logout_request_packet.dissect(buffer, offset, packet, parent)
  end
...
-- Register Nasdaq IseOptions SpreadTradeFeed Itch 2.1 for Decode As
local tcp_table = DissectorTable.get("tcp.port")
tcp_table:add_for_decode_as(omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1)
-- Register Nasdaq IseOptions SpreadTradeFeed Itch 2.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_iseoptions_spreadtradefeed_itch_v2_1)
