...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.complex_strategy_directory_message.size =
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.tracking_number.size + 
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.timestamp.size + 
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.strategy_id.size + 
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.strategy_type.size + 
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.underlying_symbol.size + 
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.reserved_16.size + 
  nasdaq_iseoptions_spreadtradefeed_itch_v2_1.number_of_legs.size + 
...
nasdaq_iseoptions_spreadtradefeed_itch_v2_1.complex_strategy_directory_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Leg Information
  index, leg_information = nasdaq_iseoptions_spreadtradefeed_itch_v2_1.leg_information.dissect(buffer, index, packet, parent)
