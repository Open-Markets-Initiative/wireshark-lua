...
nasdaq_psx_orders_ouch_v4_2.fields.data = ProtoField.new("Data", "nasdaq.psx.orders.ouch.v4.2.data", ftypes.STRING)
...
nasdaq_psx_orders_ouch_v4_2.fields.message = ProtoField.new("Message", "nasdaq.psx.orders.ouch.v4.2.message", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.message_type = ProtoField.new("Message Type", "nasdaq.psx.orders.ouch.v4.2.messagetype", ftypes.STRING)
...
nasdaq_psx_orders_ouch_v4_2.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
...
nasdaq_psx_orders_ouch_v4_2.prefs.show_data = Pref.bool("Show Data", show.data, "Parse and add Data to protocol tree")
...
function nasdaq_psx_orders_ouch_v4_2.prefs_changed()
  ...
  if show.message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_message then
    show.message = nasdaq_psx_orders_ouch_v4_2.prefs.show_message
    changed = true
  end
  ...
  if show.data ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_data then
    show.data = nasdaq_psx_orders_ouch_v4_2.prefs.show_data
    changed = true
  end
...
nasdaq_psx_orders_ouch_v4_2_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
nasdaq_psx_orders_ouch_v4_2_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  -- Optionally add struct element to protocol tree
  ...
  nasdaq_psx_orders_ouch_v4_2_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  ...
  index = nasdaq_psx_orders_ouch_v4_2_dissect.message(buffer, index, packet, parent, size_of_message)
