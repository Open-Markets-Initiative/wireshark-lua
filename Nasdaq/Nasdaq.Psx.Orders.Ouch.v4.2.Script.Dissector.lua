...
-- Nasdaq Psx Orders Ouch 4.2 Protocol
local nasdaq_psx_orders_ouch_v4_2 = Proto("Nasdaq.Psx.Orders.Ouch.v4.2.Lua", "Nasdaq Psx Orders Ouch 4.2")
...
-- Nasdaq Psx Orders Ouch 4.2 Fields
nasdaq_psx_orders_ouch_v4_2.fields.accepted_message = ProtoField.new("Accepted Message", "nasdaq.psx.orders.ouch.v4.2.acceptedmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.aiq_canceled_message = ProtoField.new("Aiq Canceled Message", "nasdaq.psx.orders.ouch.v4.2.aiqcanceledmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.aiq_canceled_reason = ProtoField.new("Aiq Canceled Reason", "nasdaq.psx.orders.ouch.v4.2.aiqcanceledreason", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.bbo_weight_indicator = ProtoField.new("Bbo Weight Indicator", "nasdaq.psx.orders.ouch.v4.2.bboweightindicator", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.broken_trade_message = ProtoField.new("Broken Trade Message", "nasdaq.psx.orders.ouch.v4.2.brokentrademessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.broken_trade_reason = ProtoField.new("Broken Trade Reason", "nasdaq.psx.orders.ouch.v4.2.brokentradereason", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.buy_sell_indicator = ProtoField.new("Buy Sell Indicator", "nasdaq.psx.orders.ouch.v4.2.buysellindicator", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.cancel_order_message = ProtoField.new("Cancel Order Message", "nasdaq.psx.orders.ouch.v4.2.cancelordermessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.cancel_pending_message = ProtoField.new("Cancel Pending Message", "nasdaq.psx.orders.ouch.v4.2.cancelpendingmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.cancel_reject_message = ProtoField.new("Cancel Reject Message", "nasdaq.psx.orders.ouch.v4.2.cancelrejectmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.canceled_message = ProtoField.new("Canceled Message", "nasdaq.psx.orders.ouch.v4.2.canceledmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.canceled_reason = ProtoField.new("Canceled Reason", "nasdaq.psx.orders.ouch.v4.2.canceledreason", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.capacity = ProtoField.new("Capacity", "nasdaq.psx.orders.ouch.v4.2.capacity", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.cross_type = ProtoField.new("Cross Type", "nasdaq.psx.orders.ouch.v4.2.crosstype", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.debug_packet = ProtoField.new("Debug Packet", "nasdaq.psx.orders.ouch.v4.2.debugpacket", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.decrement_shares = ProtoField.new("Decrement Shares", "nasdaq.psx.orders.ouch.v4.2.decrementshares", ftypes.UINT32)
nasdaq_psx_orders_ouch_v4_2.fields.display = ProtoField.new("Display", "nasdaq.psx.orders.ouch.v4.2.display", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.enter_order_message = ProtoField.new("Enter Order Message", "nasdaq.psx.orders.ouch.v4.2.enterordermessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.event_code = ProtoField.new("Event Code", "nasdaq.psx.orders.ouch.v4.2.eventcode", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.executed_message = ProtoField.new("Executed Message", "nasdaq.psx.orders.ouch.v4.2.executedmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.executed_shares = ProtoField.new("Executed Shares", "nasdaq.psx.orders.ouch.v4.2.executedshares", ftypes.UINT32)
nasdaq_psx_orders_ouch_v4_2.fields.execution_price = ProtoField.new("Execution Price", "nasdaq.psx.orders.ouch.v4.2.executionprice", ftypes.UINT32)
nasdaq_psx_orders_ouch_v4_2.fields.existing_order_token = ProtoField.new("Existing Order Token", "nasdaq.psx.orders.ouch.v4.2.existingordertoken", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.firm = ProtoField.new("Firm", "nasdaq.psx.orders.ouch.v4.2.firm", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.intermarket_sweep_eligibility = ProtoField.new("Intermarket Sweep Eligibility", "nasdaq.psx.orders.ouch.v4.2.intermarketsweepeligibility", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.liquidity_flag = ProtoField.new("Liquidity Flag", "nasdaq.psx.orders.ouch.v4.2.liquidityflag", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.login_accepted_packet = ProtoField.new("Login Accepted Packet", "nasdaq.psx.orders.ouch.v4.2.loginacceptedpacket", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.login_rejected_packet = ProtoField.new("Login Rejected Packet", "nasdaq.psx.orders.ouch.v4.2.loginrejectedpacket", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.login_request_packet = ProtoField.new("Login Request Packet", "nasdaq.psx.orders.ouch.v4.2.loginrequestpacket", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.match_number = ProtoField.new("Match Number", "nasdaq.psx.orders.ouch.v4.2.matchnumber", ftypes.UINT64)
nasdaq_psx_orders_ouch_v4_2.fields.minimum_quantity = ProtoField.new("Minimum Quantity", "nasdaq.psx.orders.ouch.v4.2.minimumquantity", ftypes.UINT32)
nasdaq_psx_orders_ouch_v4_2.fields.modify_order_message = ProtoField.new("Modify Order Message", "nasdaq.psx.orders.ouch.v4.2.modifyordermessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.order_modified_message = ProtoField.new("Order Modified Message", "nasdaq.psx.orders.ouch.v4.2.ordermodifiedmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.order_priority_update_message = ProtoField.new("Order Priority Update Message", "nasdaq.psx.orders.ouch.v4.2.orderpriorityupdatemessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.order_reference_number = ProtoField.new("Order Reference Number", "nasdaq.psx.orders.ouch.v4.2.orderreferencenumber", ftypes.UINT64)
nasdaq_psx_orders_ouch_v4_2.fields.order_state = ProtoField.new("Order State", "nasdaq.psx.orders.ouch.v4.2.orderstate", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.order_token = ProtoField.new("Order Token", "nasdaq.psx.orders.ouch.v4.2.ordertoken", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.packet = ProtoField.new("Packet", "nasdaq.psx.orders.ouch.v4.2.packet", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.packet_header = ProtoField.new("Packet Header", "nasdaq.psx.orders.ouch.v4.2.packetheader", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.packet_length = ProtoField.new("Packet Length", "nasdaq.psx.orders.ouch.v4.2.packetlength", ftypes.UINT16)
nasdaq_psx_orders_ouch_v4_2.fields.packet_type = ProtoField.new("Packet Type", "nasdaq.psx.orders.ouch.v4.2.packettype", ftypes.STRING)
...
nasdaq_psx_orders_ouch_v4_2.fields.rejected_reason = ProtoField.new("Rejected Reason", "nasdaq.psx.orders.ouch.v4.2.rejectedreason", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.replace_order_message = ProtoField.new("Replace Order Message", "nasdaq.psx.orders.ouch.v4.2.replaceordermessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.replaced_message = ProtoField.new("Replaced Message", "nasdaq.psx.orders.ouch.v4.2.replacedmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.replacement_order_token = ProtoField.new("Replacement Order Token", "nasdaq.psx.orders.ouch.v4.2.replacementordertoken", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.requested_sequence_number = ProtoField.new("Requested Sequence Number", "nasdaq.psx.orders.ouch.v4.2.requestedsequencenumber", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.requested_session = ProtoField.new("Requested Session", "nasdaq.psx.orders.ouch.v4.2.requestedsession", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.sequence_number = ProtoField.new("Sequence Number", "nasdaq.psx.orders.ouch.v4.2.sequencenumber", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.sequenced_data_packet = ProtoField.new("Sequenced Data Packet", "nasdaq.psx.orders.ouch.v4.2.sequenceddatapacket", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.sequenced_message = ProtoField.new("Sequenced Message", "nasdaq.psx.orders.ouch.v4.2.sequencedmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.sequenced_message_type = ProtoField.new("Sequenced Message Type", "nasdaq.psx.orders.ouch.v4.2.sequencedmessagetype", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.session = ProtoField.new("Session", "nasdaq.psx.orders.ouch.v4.2.session", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.shares = ProtoField.new("Shares", "nasdaq.psx.orders.ouch.v4.2.shares", ftypes.UINT32)
nasdaq_psx_orders_ouch_v4_2.fields.soup_bin_tcp_packet = ProtoField.new("Soup Bin Tcp Packet", "nasdaq.psx.orders.ouch.v4.2.soupbintcppacket", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.stock = ProtoField.new("Stock", "nasdaq.psx.orders.ouch.v4.2.stock", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.system_event_message = ProtoField.new("System Event Message", "nasdaq.psx.orders.ouch.v4.2.systemeventmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.text = ProtoField.new("Text", "nasdaq.psx.orders.ouch.v4.2.text", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.time_in_force = ProtoField.new("Time In Force", "nasdaq.psx.orders.ouch.v4.2.timeinforce", ftypes.UINT32)
nasdaq_psx_orders_ouch_v4_2.fields.timestamp = ProtoField.new("Timestamp", "nasdaq.psx.orders.ouch.v4.2.timestamp", ftypes.UINT64)
nasdaq_psx_orders_ouch_v4_2.fields.unsequenced_data_packet = ProtoField.new("Unsequenced Data Packet", "nasdaq.psx.orders.ouch.v4.2.unsequenceddatapacket", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.unsequenced_message = ProtoField.new("Unsequenced Message", "nasdaq.psx.orders.ouch.v4.2.unsequencedmessage", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.unsequenced_message_type = ProtoField.new("Unsequenced Message Type", "nasdaq.psx.orders.ouch.v4.2.unsequencedmessagetype", ftypes.STRING)
nasdaq_psx_orders_ouch_v4_2.fields.username = ProtoField.new("Username", "nasdaq.psx.orders.ouch.v4.2.username", ftypes.STRING)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Nasdaq Psx Orders Ouch 4.2 Element Dissection Options
...
-- Register Nasdaq Psx Orders Ouch 4.2 Show Options
nasdaq_psx_orders_ouch_v4_2.prefs.show_accepted_message = Pref.bool("Show Accepted Message", show.accepted_message, "Parse and add Accepted Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_aiq_canceled_message = Pref.bool("Show Aiq Canceled Message", show.aiq_canceled_message, "Parse and add Aiq Canceled Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_broken_trade_message = Pref.bool("Show Broken Trade Message", show.broken_trade_message, "Parse and add Broken Trade Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_order_message = Pref.bool("Show Cancel Order Message", show.cancel_order_message, "Parse and add Cancel Order Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_pending_message = Pref.bool("Show Cancel Pending Message", show.cancel_pending_message, "Parse and add Cancel Pending Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_reject_message = Pref.bool("Show Cancel Reject Message", show.cancel_reject_message, "Parse and add Cancel Reject Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_canceled_message = Pref.bool("Show Canceled Message", show.canceled_message, "Parse and add Canceled Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_debug_packet = Pref.bool("Show Debug Packet", show.debug_packet, "Parse and add Debug Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_enter_order_message = Pref.bool("Show Enter Order Message", show.enter_order_message, "Parse and add Enter Order Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_executed_message = Pref.bool("Show Executed Message", show.executed_message, "Parse and add Executed Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_login_accepted_packet = Pref.bool("Show Login Accepted Packet", show.login_accepted_packet, "Parse and add Login Accepted Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_login_rejected_packet = Pref.bool("Show Login Rejected Packet", show.login_rejected_packet, "Parse and add Login Rejected Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_login_request_packet = Pref.bool("Show Login Request Packet", show.login_request_packet, "Parse and add Login Request Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_modify_order_message = Pref.bool("Show Modify Order Message", show.modify_order_message, "Parse and add Modify Order Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_order_modified_message = Pref.bool("Show Order Modified Message", show.order_modified_message, "Parse and add Order Modified Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_order_priority_update_message = Pref.bool("Show Order Priority Update Message", show.order_priority_update_message, "Parse and add Order Priority Update Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_rejected_message = Pref.bool("Show Rejected Message", show.rejected_message, "Parse and add Rejected Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_replace_order_message = Pref.bool("Show Replace Order Message", show.replace_order_message, "Parse and add Replace Order Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_replaced_message = Pref.bool("Show Replaced Message", show.replaced_message, "Parse and add Replaced Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_sequenced_data_packet = Pref.bool("Show Sequenced Data Packet", show.sequenced_data_packet, "Parse and add Sequenced Data Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_soup_bin_tcp_packet = Pref.bool("Show Soup Bin Tcp Packet", show.soup_bin_tcp_packet, "Parse and add Soup Bin Tcp Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_system_event_message = Pref.bool("Show System Event Message", show.system_event_message, "Parse and add System Event Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_unsequenced_data_packet = Pref.bool("Show Unsequenced Data Packet", show.unsequenced_data_packet, "Parse and add Unsequenced Data Packet to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_sequenced_message = Pref.bool("Show Sequenced Message", show.sequenced_message, "Parse and add Sequenced Message to protocol tree")
nasdaq_psx_orders_ouch_v4_2.prefs.show_unsequenced_message = Pref.bool("Show Unsequenced Message", show.unsequenced_message, "Parse and add Unsequenced Message to protocol tree")

-- Handle changed preferences
function nasdaq_psx_orders_ouch_v4_2.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.accepted_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_accepted_message then
    show.accepted_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_accepted_message
    changed = true
  end
  if show.aiq_canceled_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_aiq_canceled_message then
    show.aiq_canceled_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_aiq_canceled_message
    changed = true
  end
  if show.broken_trade_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_broken_trade_message then
    show.broken_trade_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_broken_trade_message
    changed = true
  end
  if show.cancel_order_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_order_message then
    show.cancel_order_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_order_message
    changed = true
  end
  if show.cancel_pending_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_pending_message then
    show.cancel_pending_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_pending_message
    changed = true
  end
  if show.cancel_reject_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_reject_message then
    show.cancel_reject_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_cancel_reject_message
    changed = true
  end
  if show.canceled_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_canceled_message then
    show.canceled_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_canceled_message
    changed = true
  end
  if show.debug_packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_debug_packet then
    show.debug_packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_debug_packet
    changed = true
  end
  if show.enter_order_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_enter_order_message then
    show.enter_order_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_enter_order_message
    changed = true
  end
  if show.executed_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_executed_message then
    show.executed_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_executed_message
    changed = true
  end
  if show.login_accepted_packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_login_accepted_packet then
    show.login_accepted_packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_login_accepted_packet
    changed = true
  end
  if show.login_rejected_packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_login_rejected_packet then
    show.login_rejected_packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_login_rejected_packet
    changed = true
  end
  if show.login_request_packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_login_request_packet then
    show.login_request_packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_login_request_packet
    changed = true
  end
  if show.modify_order_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_modify_order_message then
    show.modify_order_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_modify_order_message
    changed = true
  end
  if show.order_modified_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_order_modified_message then
    show.order_modified_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_order_modified_message
    changed = true
  end
  if show.order_priority_update_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_order_priority_update_message then
    show.order_priority_update_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_order_priority_update_message
    changed = true
  end
  if show.packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_packet then
    show.packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_packet
    changed = true
  end
  if show.packet_header ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_packet_header then
    show.packet_header = nasdaq_psx_orders_ouch_v4_2.prefs.show_packet_header
    changed = true
  end
  if show.rejected_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_rejected_message then
    show.rejected_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_rejected_message
    changed = true
  end
  if show.replace_order_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_replace_order_message then
    show.replace_order_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_replace_order_message
    changed = true
  end
  if show.replaced_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_replaced_message then
    show.replaced_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_replaced_message
    changed = true
  end
  if show.sequenced_data_packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_sequenced_data_packet then
    show.sequenced_data_packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_sequenced_data_packet
    changed = true
  end
  if show.soup_bin_tcp_packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_soup_bin_tcp_packet then
    show.soup_bin_tcp_packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_soup_bin_tcp_packet
    changed = true
  end
  if show.system_event_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_system_event_message then
    show.system_event_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_system_event_message
    changed = true
  end
  if show.unsequenced_data_packet ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_unsequenced_data_packet then
    show.unsequenced_data_packet = nasdaq_psx_orders_ouch_v4_2.prefs.show_unsequenced_data_packet
    changed = true
  end
  if show.payload ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_payload then
    show.payload = nasdaq_psx_orders_ouch_v4_2.prefs.show_payload
    changed = true
  end
  if show.sequenced_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_sequenced_message then
    show.sequenced_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_sequenced_message
    changed = true
  end
  if show.unsequenced_message ~= nasdaq_psx_orders_ouch_v4_2.prefs.show_unsequenced_message then
    show.unsequenced_message = nasdaq_psx_orders_ouch_v4_2.prefs.show_unsequenced_message
    changed = true
  end
...
nasdaq_psx_orders_ouch_v4_2_size_of.unsequenced_message = function(buffer, offset, unsequenced_message_type)
...
nasdaq_psx_orders_ouch_v4_2_display.unsequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Unsequenced Message
nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_message_branches = function(buffer, offset, packet, parent, unsequenced_message_type)
  -- Dissect Enter Order Message
  if unsequenced_message_type == "O" then
...
nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_message = function(buffer, offset, packet, parent, unsequenced_message_type)
  if not show.unsequenced_message then
    return nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_message_branches(buffer, offset, packet, parent, unsequenced_message_type)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_psx_orders_ouch_v4_2_size_of.unsequenced_message(buffer, offset, unsequenced_message_type)
  if size == 0 then
    return offset
  end
  ...
  local display = nasdaq_psx_orders_ouch_v4_2_display.unsequenced_message(buffer, packet, parent)
  local element = parent:add(nasdaq_psx_orders_ouch_v4_2.fields.unsequenced_message, range, display)

  return nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_message_branches(buffer, offset, packet, parent, unsequenced_message_type)
end

-- Size: Unsequenced Message Type
nasdaq_psx_orders_ouch_v4_2_size_of.unsequenced_message_type = 1

-- Display: Unsequenced Message Type
nasdaq_psx_orders_ouch_v4_2_display.unsequenced_message_type = function(value)
  if value == "O" then
...
nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_message_type = function(buffer, offset, packet, parent)
  local length = nasdaq_psx_orders_ouch_v4_2_size_of.unsequenced_message_type
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_psx_orders_ouch_v4_2_display.unsequenced_message_type(value, buffer, offset, packet, parent)

  parent:add(nasdaq_psx_orders_ouch_v4_2.fields.unsequenced_message_type, range, value, display)
...
nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
  local index = offset

  -- Unsequenced Message Type: 1 Byte Ascii String Enum with 4 values
  index, unsequenced_message_type = nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_message_type(buffer, index, packet, parent)

  -- Unsequenced Message: Runtime Type with 4 branches
  index = nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_message(buffer, index, packet, parent, unsequenced_message_type)
...
nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_unsequenced_data_packet = nasdaq_psx_orders_ouch_v4_2_size_of.unsequenced_data_packet(buffer, offset)
  ...
  nasdaq_psx_orders_ouch_v4_2_dissect.unsequenced_data_packet_fields(buffer, offset, packet, parent, size_of_unsequenced_data_packet)
...
nasdaq_psx_orders_ouch_v4_2_size_of.sequenced_message = function(buffer, offset, sequenced_message_type)
...
nasdaq_psx_orders_ouch_v4_2_display.sequenced_message = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Sequenced Message
nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_message_branches = function(buffer, offset, packet, parent, sequenced_message_type)
  -- Dissect System Event Message
  if sequenced_message_type == "S" then
...
nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_message = function(buffer, offset, packet, parent, sequenced_message_type)
  if not show.sequenced_message then
    return nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_message_branches(buffer, offset, packet, parent, sequenced_message_type)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_psx_orders_ouch_v4_2_size_of.sequenced_message(buffer, offset, sequenced_message_type)
  if size == 0 then
    return offset
  end
  ...
  -- Dissect Element
  local range = buffer(offset, size)
  local display = nasdaq_psx_orders_ouch_v4_2_display.sequenced_message(buffer, packet, parent)
  local element = parent:add(nasdaq_psx_orders_ouch_v4_2.fields.sequenced_message, range, display)

  return nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_message_branches(buffer, offset, packet, parent, sequenced_message_type)
end

-- Size: Sequenced Message Type
nasdaq_psx_orders_ouch_v4_2_size_of.sequenced_message_type = 1

-- Display: Sequenced Message Type
nasdaq_psx_orders_ouch_v4_2_display.sequenced_message_type = function(value)
  if value == "S" then
...
nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_message_type = function(buffer, offset, packet, parent)
  local length = nasdaq_psx_orders_ouch_v4_2_size_of.sequenced_message_type
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_psx_orders_ouch_v4_2_display.sequenced_message_type(value, buffer, offset, packet, parent)

  parent:add(nasdaq_psx_orders_ouch_v4_2.fields.sequenced_message_type, range, value, display)
...
nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_data_packet_fields = function(buffer, offset, packet, parent, size_of_sequenced_data_packet)
  local index = offset

  -- Sequenced Message Type: 1 Byte Ascii String Enum with 12 values
  index, sequenced_message_type = nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_message_type(buffer, index, packet, parent)

  -- Sequenced Message: Runtime Type with 12 branches
  index = nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_message(buffer, index, packet, parent, sequenced_message_type)
...
nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_data_packet = function(buffer, offset, packet, parent)
  -- Parse runtime size
  local size_of_sequenced_data_packet = nasdaq_psx_orders_ouch_v4_2_size_of.sequenced_data_packet(buffer, offset)
  ...
  nasdaq_psx_orders_ouch_v4_2_dissect.sequenced_data_packet_fields(buffer, offset, packet, parent, size_of_sequenced_data_packet)
...
function nasdaq_psx_orders_ouch_v4_2.init()
end

-- Dissector for Nasdaq Psx Orders Ouch 4.2
function nasdaq_psx_orders_ouch_v4_2.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = nasdaq_psx_orders_ouch_v4_2.name
...
tcp_table:add(65333, nasdaq_psx_orders_ouch_v4_2)
...
verify.nasdaq_psx_orders_ouch_v4_2_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Nasdaq Psx Orders Ouch 4.2
local function nasdaq_psx_orders_ouch_v4_2_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.nasdaq_psx_orders_ouch_v4_2_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = nasdaq_psx_orders_ouch_v4_2
  nasdaq_psx_orders_ouch_v4_2.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Nasdaq Psx Orders Ouch 4.2
nasdaq_psx_orders_ouch_v4_2:register_heuristic("tcp", nasdaq_psx_orders_ouch_v4_2_heuristic)
