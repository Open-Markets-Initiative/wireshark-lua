...
local show = {}
local format = {}
local nasdaq_equities_aggregated_itch_v2_0_display = {}
...
-- Size: Interest Flag
nasdaq_equities_aggregated_itch_v2_0_size_of.interest_flag = 1

-- Display: Interest Flag
nasdaq_equities_aggregated_itch_v2_0_display.interest_flag = function(value)
  if value == "B" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.interest_flag = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.interest_flag
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.interest_flag(value, buffer, offset, packet, parent)
...
-- Size: Stock
nasdaq_equities_aggregated_itch_v2_0_size_of.stock = 8

-- Display: Stock
nasdaq_equities_aggregated_itch_v2_0_display.stock = function(value)
  return "Stock: "..value
end

-- Dissect: Stock
nasdaq_equities_aggregated_itch_v2_0_dissect.stock = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.stock
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_equities_aggregated_itch_v2_0_display.stock(value, buffer, offset, packet, parent)
...
-- Size: Timestamp
nasdaq_equities_aggregated_itch_v2_0_size_of.timestamp = 6

-- Display: Timestamp
nasdaq_equities_aggregated_itch_v2_0_display.timestamp = function(value)
  return "Timestamp: "..value
end

-- Dissect: Timestamp
nasdaq_equities_aggregated_itch_v2_0_dissect.timestamp = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.timestamp
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.timestamp(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.tracking_number = 2

-- Display: Tracking Number
nasdaq_equities_aggregated_itch_v2_0_display.tracking_number = function(value)
  return "Tracking Number: "..value
end

-- Dissect: Tracking Number
nasdaq_equities_aggregated_itch_v2_0_dissect.tracking_number = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.tracking_number
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.tracking_number(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.rpii_message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.tracking_number

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.timestamp

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.stock

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.interest_flag

  return index
end

-- Display: Rpii Message
nasdaq_equities_aggregated_itch_v2_0_display.rpii_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Rpii Message
nasdaq_equities_aggregated_itch_v2_0_dissect.rpii_message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Tracking Number: 2 Byte Unsigned Fixed Width Integer
  index, tracking_number = nasdaq_equities_aggregated_itch_v2_0_dissect.tracking_number(buffer, index, packet, parent)
  ...
  index, interest_flag = nasdaq_equities_aggregated_itch_v2_0_dissect.interest_flag(buffer, index, packet, parent)

  return index
end

-- Dissect: Rpii Message
nasdaq_equities_aggregated_itch_v2_0_dissect.rpii_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.rpii_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.rpii_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.rpii_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.rpii_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.rpii_message_fields(buffer, offset, packet, parent)
end

-- Size: Price Variation Indicator
nasdaq_equities_aggregated_itch_v2_0_size_of.price_variation_indicator = 1

-- Display: Price Variation Indicator
nasdaq_equities_aggregated_itch_v2_0_display.price_variation_indicator = function(value)
  if value == "L" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.price_variation_indicator = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.price_variation_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.price_variation_indicator(value, buffer, offset, packet, parent)
...
-- Size: Cross Type
nasdaq_equities_aggregated_itch_v2_0_size_of.cross_type = 1

-- Display: Cross Type
nasdaq_equities_aggregated_itch_v2_0_display.cross_type = function(value)
  if value == "O" then
...
-- Dissect: Cross Type
nasdaq_equities_aggregated_itch_v2_0_dissect.cross_type = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.cross_type
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.cross_type(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.current_reference_price = 4

-- Display: Current Reference Price
nasdaq_equities_aggregated_itch_v2_0_display.current_reference_price = function(value)
...
-- Size: Near Price
nasdaq_equities_aggregated_itch_v2_0_size_of.near_price = 4

-- Display: Near Price
nasdaq_equities_aggregated_itch_v2_0_display.near_price = function(value)
...
-- Size: Far Price
nasdaq_equities_aggregated_itch_v2_0_size_of.far_price = 4

-- Display: Far Price
nasdaq_equities_aggregated_itch_v2_0_display.far_price = function(value)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.imbalance_direction = 1

-- Display: Imbalance Direction
nasdaq_equities_aggregated_itch_v2_0_display.imbalance_direction = function(value)
  if value == "B" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.imbalance_direction = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.imbalance_direction
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.imbalance_direction(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.imbalance_shares = 8

-- Display: Imbalance Shares
nasdaq_equities_aggregated_itch_v2_0_display.imbalance_shares = function(value)
  return "Imbalance Shares: "..value
end

-- Dissect: Imbalance Shares
nasdaq_equities_aggregated_itch_v2_0_dissect.imbalance_shares = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.imbalance_shares
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.imbalance_shares(value, buffer, offset, packet, parent)
...
-- Size: Paired Shares
nasdaq_equities_aggregated_itch_v2_0_size_of.paired_shares = 8

-- Display: Paired Shares
nasdaq_equities_aggregated_itch_v2_0_display.paired_shares = function(value)
  return "Paired Shares: "..value
end

-- Dissect: Paired Shares
nasdaq_equities_aggregated_itch_v2_0_dissect.paired_shares = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.paired_shares
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.paired_shares(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.noii_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.paired_shares

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.imbalance_shares

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.imbalance_direction

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.stock

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.far_price

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.near_price

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.current_reference_price

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.cross_type

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.price_variation_indicator

  return index
end

-- Display: Noii Message
nasdaq_equities_aggregated_itch_v2_0_display.noii_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Noii Message
nasdaq_equities_aggregated_itch_v2_0_dissect.noii_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, paired_shares = nasdaq_equities_aggregated_itch_v2_0_dissect.paired_shares(buffer, index, packet, parent)

  -- Imbalance Shares: 8 Byte Unsigned Fixed Width Integer
  index, imbalance_shares = nasdaq_equities_aggregated_itch_v2_0_dissect.imbalance_shares(buffer, index, packet, parent)

  -- Imbalance Direction: 1 Byte Ascii String Enum with 4 values
  index, imbalance_direction = nasdaq_equities_aggregated_itch_v2_0_dissect.imbalance_direction(buffer, index, packet, parent)

  -- Stock: 8 Byte Ascii String
  index, stock = nasdaq_equities_aggregated_itch_v2_0_dissect.stock(buffer, index, packet, parent)

  -- Far Price: 4 Byte Unsigned Fixed Width Integer
  index, far_price = nasdaq_equities_aggregated_itch_v2_0_dissect.far_price(buffer, index, packet, parent)

  -- Near Price: 4 Byte Unsigned Fixed Width Integer
  index, near_price = nasdaq_equities_aggregated_itch_v2_0_dissect.near_price(buffer, index, packet, parent)

  -- Current Reference Price: 4 Byte Unsigned Fixed Width Integer
  index, current_reference_price = nasdaq_equities_aggregated_itch_v2_0_dissect.current_reference_price(buffer, index, packet, parent)

  -- Cross Type: 1 Byte Ascii String Enum with 4 values
  index, cross_type = nasdaq_equities_aggregated_itch_v2_0_dissect.cross_type(buffer, index, packet, parent)

  -- Price Variation Indicator: 1 Byte Ascii String Enum with 14 values
  index, price_variation_indicator = nasdaq_equities_aggregated_itch_v2_0_dissect.price_variation_indicator(buffer, index, packet, parent)

  return index
end

-- Dissect: Noii Message
nasdaq_equities_aggregated_itch_v2_0_dissect.noii_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.noii_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.noii_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.noii_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.noii_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.noii_message_fields(buffer, offset, packet, parent)
end

-- Size: Mpid
nasdaq_equities_aggregated_itch_v2_0_size_of.mpid = 4

-- Display: Mpid
nasdaq_equities_aggregated_itch_v2_0_display.mpid = function(value)
  return "Mpid: "..value
end

-- Dissect: Mpid
nasdaq_equities_aggregated_itch_v2_0_dissect.mpid = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.mpid
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_equities_aggregated_itch_v2_0_display.mpid(value, buffer, offset, packet, parent)
...
-- Size: Price
nasdaq_equities_aggregated_itch_v2_0_size_of.price = 4

-- Display: Price
nasdaq_equities_aggregated_itch_v2_0_display.price = function(value)
  return "Price: "..value
end
...
nasdaq_equities_aggregated_itch_v2_0_size_of.aggregate_shares = 4

-- Display: Aggregate Shares
nasdaq_equities_aggregated_itch_v2_0_display.aggregate_shares = function(value)
  return "Aggregate Shares: "..value
end

-- Dissect: Aggregate Shares
nasdaq_equities_aggregated_itch_v2_0_dissect.aggregate_shares = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.aggregate_shares
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.aggregate_shares(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.participant_shares = 4

-- Display: Participant Shares
nasdaq_equities_aggregated_itch_v2_0_display.participant_shares = function(value)
  return "Participant Shares: "..value
end

-- Dissect: Participant Shares
nasdaq_equities_aggregated_itch_v2_0_dissect.participant_shares = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.participant_shares
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.participant_shares(value, buffer, offset, packet, parent)
...
-- Size: Market Side
nasdaq_equities_aggregated_itch_v2_0_size_of.market_side = 1

-- Display: Market Side
nasdaq_equities_aggregated_itch_v2_0_display.market_side = function(value)
  if value == "B" then
...
-- Dissect: Market Side
nasdaq_equities_aggregated_itch_v2_0_dissect.market_side = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.market_side
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.market_side(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.price_level_update_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.market_side

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.participant_shares

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.aggregate_shares

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.stock

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.price

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.mpid

  return index
end

-- Display: Price Level Update Message
nasdaq_equities_aggregated_itch_v2_0_display.price_level_update_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Price Level Update Message
nasdaq_equities_aggregated_itch_v2_0_dissect.price_level_update_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, market_side = nasdaq_equities_aggregated_itch_v2_0_dissect.market_side(buffer, index, packet, parent)

  -- Participant Shares: 4 Byte Unsigned Fixed Width Integer
  index, participant_shares = nasdaq_equities_aggregated_itch_v2_0_dissect.participant_shares(buffer, index, packet, parent)

  -- Aggregate Shares: 4 Byte Unsigned Fixed Width Integer
  index, aggregate_shares = nasdaq_equities_aggregated_itch_v2_0_dissect.aggregate_shares(buffer, index, packet, parent)

  -- Stock: 8 Byte Ascii String
  index, stock = nasdaq_equities_aggregated_itch_v2_0_dissect.stock(buffer, index, packet, parent)

  -- Price: 4 Byte Unsigned Fixed Width Integer
  index, price = nasdaq_equities_aggregated_itch_v2_0_dissect.price(buffer, index, packet, parent)

  -- Mpid: 4 Byte Ascii String
  index, mpid = nasdaq_equities_aggregated_itch_v2_0_dissect.mpid(buffer, index, packet, parent)

  return index
end

-- Dissect: Price Level Update Message
nasdaq_equities_aggregated_itch_v2_0_dissect.price_level_update_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.price_level_update_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.price_level_update_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.price_level_update_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.price_level_update_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.price_level_update_message_fields(buffer, offset, packet, parent)
end

-- Size: Auction Collar Extension
nasdaq_equities_aggregated_itch_v2_0_size_of.auction_collar_extension = 4

-- Display: Auction Collar Extension
nasdaq_equities_aggregated_itch_v2_0_display.auction_collar_extension = function(value)
  return "Auction Collar Extension: "..value
end

-- Dissect: Auction Collar Extension
nasdaq_equities_aggregated_itch_v2_0_dissect.auction_collar_extension = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.auction_collar_extension
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.auction_collar_extension(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.lower_auction_collar_price = 4

-- Display: Lower Auction Collar Price
nasdaq_equities_aggregated_itch_v2_0_display.lower_auction_collar_price = function(value)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.upper_auction_collar_price = 4

-- Display: Upper Auction Collar Price
nasdaq_equities_aggregated_itch_v2_0_display.upper_auction_collar_price = function(value)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.auction_collar_reference_price = 4

-- Display: Auction Collar Reference Price
nasdaq_equities_aggregated_itch_v2_0_display.auction_collar_reference_price = function(value)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.luld_auction_collar_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.auction_collar_reference_price

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.upper_auction_collar_price

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.lower_auction_collar_price

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.auction_collar_extension

  return index
end

-- Display: Luld Auction Collar Message
nasdaq_equities_aggregated_itch_v2_0_display.luld_auction_collar_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Luld Auction Collar Message
nasdaq_equities_aggregated_itch_v2_0_dissect.luld_auction_collar_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, auction_collar_extension = nasdaq_equities_aggregated_itch_v2_0_dissect.auction_collar_extension(buffer, index, packet, parent)

  return index
end

-- Dissect: Luld Auction Collar Message
nasdaq_equities_aggregated_itch_v2_0_dissect.luld_auction_collar_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.luld_auction_collar_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.luld_auction_collar_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.luld_auction_collar_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.luld_auction_collar_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.luld_auction_collar_message_fields(buffer, offset, packet, parent)
end

-- Size: Ipo Price
nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_price = 4

-- Display: Ipo Price
nasdaq_equities_aggregated_itch_v2_0_display.ipo_price = function(value)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quotation_release_qualifier = 1

-- Display: Ipo Quotation Release Qualifier
nasdaq_equities_aggregated_itch_v2_0_display.ipo_quotation_release_qualifier = function(value)
  if value == "A" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_quotation_release_qualifier = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quotation_release_qualifier
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.ipo_quotation_release_qualifier(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quotation_release_time = 4

-- Display: Ipo Quotation Release Time
nasdaq_equities_aggregated_itch_v2_0_display.ipo_quotation_release_time = function(value)
  return "Ipo Quotation Release Time: "..value
end

-- Dissect: Ipo Quotation Release Time
nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_quotation_release_time = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quotation_release_time
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.ipo_quotation_release_time(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quoting_period_update_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quotation_release_time

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quotation_release_qualifier

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_price

  return index
end

-- Display: Ipo Quoting Period Update Message
nasdaq_equities_aggregated_itch_v2_0_display.ipo_quoting_period_update_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Ipo Quoting Period Update Message
nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_quoting_period_update_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, ipo_quotation_release_time = nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_quotation_release_time(buffer, index, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_quoting_period_update_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.ipo_quoting_period_update_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quoting_period_update_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.ipo_quoting_period_update_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.ipo_quoting_period_update_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_quoting_period_update_message_fields(buffer, offset, packet, parent)
end

-- Size: Breached Level
nasdaq_equities_aggregated_itch_v2_0_size_of.breached_level = 1

-- Display: Breached Level
nasdaq_equities_aggregated_itch_v2_0_display.breached_level = function(value)
  if value == "1" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.breached_level = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.breached_level
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.breached_level(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.mwcb_status_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.breached_level

  return index
end

-- Display: Mwcb Status Message
nasdaq_equities_aggregated_itch_v2_0_display.mwcb_status_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Mwcb Status Message
nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_status_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, breached_level = nasdaq_equities_aggregated_itch_v2_0_dissect.breached_level(buffer, index, packet, parent)

  return index
end

-- Dissect: Mwcb Status Message
nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_status_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.mwcb_status_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.mwcb_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.mwcb_status_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.mwcb_status_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_status_message_fields(buffer, offset, packet, parent)
end

-- Size: Level 3
nasdaq_equities_aggregated_itch_v2_0_size_of.level_3 = 8

-- Display: Level 3
nasdaq_equities_aggregated_itch_v2_0_display.level_3 = function(value)
...
-- Size: Level 2
nasdaq_equities_aggregated_itch_v2_0_size_of.level_2 = 8

-- Display: Level 2
nasdaq_equities_aggregated_itch_v2_0_display.level_2 = function(value)
...
-- Size: Level 1
nasdaq_equities_aggregated_itch_v2_0_size_of.level_1 = 8

-- Display: Level 1
nasdaq_equities_aggregated_itch_v2_0_display.level_1 = function(value)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.mwcb_decline_level_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.level_1

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.level_2

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.level_3

  return index
end

-- Display: Mwcb Decline Level Message
nasdaq_equities_aggregated_itch_v2_0_display.mwcb_decline_level_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Mwcb Decline Level Message
nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_decline_level_message_fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_decline_level_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.mwcb_decline_level_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.mwcb_decline_level_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.mwcb_decline_level_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.mwcb_decline_level_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_decline_level_message_fields(buffer, offset, packet, parent)
end

-- Size: Market Participant State
nasdaq_equities_aggregated_itch_v2_0_size_of.market_participant_state = 1

-- Display: Market Participant State
nasdaq_equities_aggregated_itch_v2_0_display.market_participant_state = function(value)
  if value == "A" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.market_participant_state = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.market_participant_state
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.market_participant_state(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.market_maker_mode = 1

-- Display: Market Maker Mode
nasdaq_equities_aggregated_itch_v2_0_display.market_maker_mode = function(value)
  if value == "N" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.market_maker_mode = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.market_maker_mode
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.market_maker_mode(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.primary_market_maker = 1

-- Display: Primary Market Maker
nasdaq_equities_aggregated_itch_v2_0_display.primary_market_maker = function(value)
  if value == "Y" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.primary_market_maker = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.primary_market_maker
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.primary_market_maker(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.market_participant_position_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.primary_market_maker

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.market_maker_mode

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.market_participant_state

  return index
end

-- Display: Market Participant Position Message
nasdaq_equities_aggregated_itch_v2_0_display.market_participant_position_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Market Participant Position Message
nasdaq_equities_aggregated_itch_v2_0_dissect.market_participant_position_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, primary_market_maker = nasdaq_equities_aggregated_itch_v2_0_dissect.primary_market_maker(buffer, index, packet, parent)

  -- Market Maker Mode: 1 Byte Ascii String Enum with 5 values
  index, market_maker_mode = nasdaq_equities_aggregated_itch_v2_0_dissect.market_maker_mode(buffer, index, packet, parent)

  -- Market Participant State: 1 Byte Ascii String Enum with 5 values
  index, market_participant_state = nasdaq_equities_aggregated_itch_v2_0_dissect.market_participant_state(buffer, index, packet, parent)

  return index
end

-- Dissect: Market Participant Position Message
nasdaq_equities_aggregated_itch_v2_0_dissect.market_participant_position_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.market_participant_position_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.market_participant_position_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.market_participant_position_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.market_participant_position_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.market_participant_position_message_fields(buffer, offset, packet, parent)
end

-- Size: Reg Sho Action
nasdaq_equities_aggregated_itch_v2_0_size_of.reg_sho_action = 1

-- Display: Reg Sho Action
nasdaq_equities_aggregated_itch_v2_0_display.reg_sho_action = function(value)
  if value == "0" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.reg_sho_action = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.reg_sho_action
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.reg_sho_action(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.reg_sho_restriction_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.reg_sho_action

  return index
end

-- Display: Reg Sho Restriction Message
nasdaq_equities_aggregated_itch_v2_0_display.reg_sho_restriction_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Reg Sho Restriction Message
nasdaq_equities_aggregated_itch_v2_0_dissect.reg_sho_restriction_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, reg_sho_action = nasdaq_equities_aggregated_itch_v2_0_dissect.reg_sho_action(buffer, index, packet, parent)

  return index
end

-- Dissect: Reg Sho Restriction Message
nasdaq_equities_aggregated_itch_v2_0_dissect.reg_sho_restriction_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.reg_sho_restriction_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.reg_sho_restriction_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.reg_sho_restriction_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.reg_sho_restriction_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.reg_sho_restriction_message_fields(buffer, offset, packet, parent)
end

-- Size: Trading Action Reason
nasdaq_equities_aggregated_itch_v2_0_size_of.trading_action_reason = 4

-- Display: Trading Action Reason
nasdaq_equities_aggregated_itch_v2_0_display.trading_action_reason = function(value)
  if value == "T1" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.trading_action_reason = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.trading_action_reason
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_equities_aggregated_itch_v2_0_display.trading_action_reason(value, buffer, offset, packet, parent)
...
-- Size: Trading State
nasdaq_equities_aggregated_itch_v2_0_size_of.trading_state = 1

-- Display: Trading State
nasdaq_equities_aggregated_itch_v2_0_display.trading_state = function(value)
  if value == "H" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.trading_state = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.trading_state
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.trading_state(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.stock_trading_action_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.trading_state

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.trading_action_reason

  return index
end

-- Display: Stock Trading Action Message
nasdaq_equities_aggregated_itch_v2_0_display.stock_trading_action_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Stock Trading Action Message
nasdaq_equities_aggregated_itch_v2_0_dissect.stock_trading_action_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, trading_state = nasdaq_equities_aggregated_itch_v2_0_dissect.trading_state(buffer, index, packet, parent)

  -- Trading Action Reason: 4 Byte Ascii String Enum with 34 values
  index, trading_action_reason = nasdaq_equities_aggregated_itch_v2_0_dissect.trading_action_reason(buffer, index, packet, parent)

  return index
end

-- Dissect: Stock Trading Action Message
nasdaq_equities_aggregated_itch_v2_0_dissect.stock_trading_action_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.stock_trading_action_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.stock_trading_action_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.stock_trading_action_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.stock_trading_action_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.stock_trading_action_message_fields(buffer, offset, packet, parent)
end

-- Size: Inverse Indicator
nasdaq_equities_aggregated_itch_v2_0_size_of.inverse_indicator = 1

-- Display: Inverse Indicator
nasdaq_equities_aggregated_itch_v2_0_display.inverse_indicator = function(value)
  if value == "Y" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.inverse_indicator = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.inverse_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.inverse_indicator(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.etp_leverage_factor = 4

-- Display: Etp Leverage Factor
nasdaq_equities_aggregated_itch_v2_0_display.etp_leverage_factor = function(value)
  return "Etp Leverage Factor: "..value
end

-- Dissect: Etp Leverage Factor
nasdaq_equities_aggregated_itch_v2_0_dissect.etp_leverage_factor = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.etp_leverage_factor
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.etp_leverage_factor(value, buffer, offset, packet, parent)
...
-- Size: Etp Flag
nasdaq_equities_aggregated_itch_v2_0_size_of.etp_flag = 1

-- Display: Etp Flag
nasdaq_equities_aggregated_itch_v2_0_display.etp_flag = function(value)
  if value == "Y" then
...
-- Dissect: Etp Flag
nasdaq_equities_aggregated_itch_v2_0_dissect.etp_flag = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.etp_flag
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.etp_flag(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.luld_reference_price_tier = 1

-- Display: Luld Reference Price Tier
nasdaq_equities_aggregated_itch_v2_0_display.luld_reference_price_tier = function(value)
  if value == "1" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.luld_reference_price_tier = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.luld_reference_price_tier
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.luld_reference_price_tier(value, buffer, offset, packet, parent)
...
-- Size: Ipo Flag
nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_flag = 1

-- Display: Ipo Flag
nasdaq_equities_aggregated_itch_v2_0_display.ipo_flag = function(value)
  if value == "Y" then
...
-- Dissect: Ipo Flag
nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_flag = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_flag
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.ipo_flag(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.short_sale_threshold_indicator = 1

-- Display: Short Sale Threshold Indicator
nasdaq_equities_aggregated_itch_v2_0_display.short_sale_threshold_indicator = function(value)
  if value == "Y" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.short_sale_threshold_indicator = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.short_sale_threshold_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.short_sale_threshold_indicator(value, buffer, offset, packet, parent)
...
-- Size: Authenticity
nasdaq_equities_aggregated_itch_v2_0_size_of.authenticity = 1

-- Display: Authenticity
nasdaq_equities_aggregated_itch_v2_0_display.authenticity = function(value)
  if value == "P" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.authenticity = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.authenticity
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.authenticity(value, buffer, offset, packet, parent)
...
-- Size: Issue Sub Type
nasdaq_equities_aggregated_itch_v2_0_size_of.issue_sub_type = 2

-- Display: Issue Sub Type
nasdaq_equities_aggregated_itch_v2_0_display.issue_sub_type = function(value)
  if value == "A" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.issue_sub_type = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.issue_sub_type
  local range = buffer(offset, length)
  local value = trim_right_spaces(range:string())
  local display = nasdaq_equities_aggregated_itch_v2_0_display.issue_sub_type(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.issue_classification = 1

-- Display: Issue Classification
nasdaq_equities_aggregated_itch_v2_0_display.issue_classification = function(value)
  if value == "A" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.issue_classification = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.issue_classification
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.issue_classification(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.round_lots_only = 1

-- Display: Round Lots Only
nasdaq_equities_aggregated_itch_v2_0_display.round_lots_only = function(value)
  if value == "Y" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.round_lots_only = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.round_lots_only
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.round_lots_only(value, buffer, offset, packet, parent)
...
-- Size: Round Lot Size
nasdaq_equities_aggregated_itch_v2_0_size_of.round_lot_size = 4

-- Display: Round Lot Size
nasdaq_equities_aggregated_itch_v2_0_display.round_lot_size = function(value)
  return "Round Lot Size: "..value
end

-- Dissect: Round Lot Size
nasdaq_equities_aggregated_itch_v2_0_dissect.round_lot_size = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.round_lot_size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.round_lot_size(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.financial_status_indicator = 1

-- Display: Financial Status Indicator
nasdaq_equities_aggregated_itch_v2_0_display.financial_status_indicator = function(value)
  if value == "D" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.financial_status_indicator = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.financial_status_indicator
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.financial_status_indicator(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.market_category = 1

-- Display: Market Category
nasdaq_equities_aggregated_itch_v2_0_display.market_category = function(value)
  if value == "Q" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.market_category = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.market_category
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.market_category(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.stock_directory_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.market_category

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.financial_status_indicator

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.round_lot_size

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.round_lots_only

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.issue_classification

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.issue_sub_type

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.authenticity

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.short_sale_threshold_indicator

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_flag

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.luld_reference_price_tier

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.etp_flag

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.etp_leverage_factor

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.inverse_indicator

  return index
end

-- Display: Stock Directory Message
nasdaq_equities_aggregated_itch_v2_0_display.stock_directory_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Stock Directory Message
nasdaq_equities_aggregated_itch_v2_0_dissect.stock_directory_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, market_category = nasdaq_equities_aggregated_itch_v2_0_dissect.market_category(buffer, index, packet, parent)

  -- Financial Status Indicator: 1 Byte Ascii String Enum with 11 values
  index, financial_status_indicator = nasdaq_equities_aggregated_itch_v2_0_dissect.financial_status_indicator(buffer, index, packet, parent)

  -- Round Lot Size: 4 Byte Unsigned Fixed Width Integer
  index, round_lot_size = nasdaq_equities_aggregated_itch_v2_0_dissect.round_lot_size(buffer, index, packet, parent)

  -- Round Lots Only: 1 Byte Ascii String Enum with 2 values
  index, round_lots_only = nasdaq_equities_aggregated_itch_v2_0_dissect.round_lots_only(buffer, index, packet, parent)

  -- Issue Classification: 1 Byte Ascii String Enum with 16 values
  index, issue_classification = nasdaq_equities_aggregated_itch_v2_0_dissect.issue_classification(buffer, index, packet, parent)

  -- Issue Sub Type: 2 Byte Ascii String Enum with 58 values
  index, issue_sub_type = nasdaq_equities_aggregated_itch_v2_0_dissect.issue_sub_type(buffer, index, packet, parent)

  -- Authenticity: 1 Byte Ascii String Enum with 2 values
  index, authenticity = nasdaq_equities_aggregated_itch_v2_0_dissect.authenticity(buffer, index, packet, parent)

  -- Short Sale Threshold Indicator: 1 Byte Ascii String Enum with 3 values
  index, short_sale_threshold_indicator = nasdaq_equities_aggregated_itch_v2_0_dissect.short_sale_threshold_indicator(buffer, index, packet, parent)

  -- Ipo Flag: 1 Byte Ascii String Enum with 3 values
  index, ipo_flag = nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_flag(buffer, index, packet, parent)

  -- Luld Reference Price Tier: 1 Byte Ascii String Enum with 3 values
  index, luld_reference_price_tier = nasdaq_equities_aggregated_itch_v2_0_dissect.luld_reference_price_tier(buffer, index, packet, parent)

  -- Etp Flag: 1 Byte Ascii String Enum with 3 values
  index, etp_flag = nasdaq_equities_aggregated_itch_v2_0_dissect.etp_flag(buffer, index, packet, parent)

  -- Etp Leverage Factor: 4 Byte Unsigned Fixed Width Integer
  index, etp_leverage_factor = nasdaq_equities_aggregated_itch_v2_0_dissect.etp_leverage_factor(buffer, index, packet, parent)

  -- Inverse Indicator: 1 Byte Ascii String Enum with 2 values
  index, inverse_indicator = nasdaq_equities_aggregated_itch_v2_0_dissect.inverse_indicator(buffer, index, packet, parent)

  return index
end

-- Dissect: Stock Directory Message
nasdaq_equities_aggregated_itch_v2_0_dissect.stock_directory_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.stock_directory_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.stock_directory_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.stock_directory_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.stock_directory_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.stock_directory_message_fields(buffer, offset, packet, parent)
end

-- Size: Event Code
nasdaq_equities_aggregated_itch_v2_0_size_of.event_code = 1

-- Display: Event Code
nasdaq_equities_aggregated_itch_v2_0_display.event_code = function(value)
  if value == "O" then
...
-- Dissect: Event Code
nasdaq_equities_aggregated_itch_v2_0_dissect.event_code = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.event_code
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.event_code(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.system_event_message = function(buffer, offset)
  local index = 0
  ...
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.event_code

  return index
end

-- Display: System Event Message
nasdaq_equities_aggregated_itch_v2_0_display.system_event_message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: System Event Message
nasdaq_equities_aggregated_itch_v2_0_dissect.system_event_message_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, event_code = nasdaq_equities_aggregated_itch_v2_0_dissect.event_code(buffer, index, packet, parent)

  return index
end

-- Dissect: System Event Message
nasdaq_equities_aggregated_itch_v2_0_dissect.system_event_message = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.system_event_message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.system_event_message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.system_event_message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.system_event_message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.system_event_message_fields(buffer, offset, packet, parent)
end

-- Calculate runtime size of: Payload
nasdaq_equities_aggregated_itch_v2_0_size_of.payload = function(buffer, offset, message_type)
  -- Size of System Event Message
  if message_type == "S" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.system_event_message(buffer, offset)
  end
  -- Size of Stock Directory Message
  if message_type == "R" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.stock_directory_message(buffer, offset)
  end
  -- Size of Stock Trading Action Message
  if message_type == "H" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.stock_trading_action_message(buffer, offset)
  end
  -- Size of Reg Sho Restriction Message
  if message_type == "Y" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.reg_sho_restriction_message(buffer, offset)
  end
  -- Size of Market Participant Position Message
  if message_type == "P" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.market_participant_position_message(buffer, offset)
  end
  -- Size of Mwcb Decline Level Message
  if message_type == "V" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.mwcb_decline_level_message(buffer, offset)
  end
  -- Size of Mwcb Status Message
  if message_type == "W" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.mwcb_status_message(buffer, offset)
  end
  -- Size of Ipo Quoting Period Update Message
  if message_type == "K" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.ipo_quoting_period_update_message(buffer, offset)
  end
  -- Size of Luld Auction Collar Message
  if message_type == "J" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.luld_auction_collar_message(buffer, offset)
  end
  -- Size of Price Level Update Message
  if message_type == "U" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.price_level_update_message(buffer, offset)
  end
  -- Size of Noii Message
  if message_type == "I" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.noii_message(buffer, offset)
  end
  -- Size of Rpii Message
  if message_type == "N" then
    return nasdaq_equities_aggregated_itch_v2_0_size_of.rpii_message(buffer, offset)
  end
...
-- Display: Payload
nasdaq_equities_aggregated_itch_v2_0_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
nasdaq_equities_aggregated_itch_v2_0_dissect.payload_branches = function(buffer, offset, packet, parent, message_type)
  -- Dissect System Event Message
  if message_type == "S" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.system_event_message(buffer, offset, packet, parent)
  end
  -- Dissect Stock Directory Message
  if message_type == "R" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.stock_directory_message(buffer, offset, packet, parent)
  end
  -- Dissect Stock Trading Action Message
  if message_type == "H" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.stock_trading_action_message(buffer, offset, packet, parent)
  end
  -- Dissect Reg Sho Restriction Message
  if message_type == "Y" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.reg_sho_restriction_message(buffer, offset, packet, parent)
  end
  -- Dissect Market Participant Position Message
  if message_type == "P" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.market_participant_position_message(buffer, offset, packet, parent)
  end
  -- Dissect Mwcb Decline Level Message
  if message_type == "V" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_decline_level_message(buffer, offset, packet, parent)
  end
  -- Dissect Mwcb Status Message
  if message_type == "W" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.mwcb_status_message(buffer, offset, packet, parent)
  end
  -- Dissect Ipo Quoting Period Update Message
  if message_type == "K" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.ipo_quoting_period_update_message(buffer, offset, packet, parent)
  end
  -- Dissect Luld Auction Collar Message
  if message_type == "J" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.luld_auction_collar_message(buffer, offset, packet, parent)
  end
  -- Dissect Price Level Update Message
  if message_type == "U" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.price_level_update_message(buffer, offset, packet, parent)
  end
  -- Dissect Noii Message
  if message_type == "I" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.noii_message(buffer, offset, packet, parent)
  end
  -- Dissect Rpii Message
  if message_type == "N" then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.rpii_message(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
nasdaq_equities_aggregated_itch_v2_0_dissect.payload = function(buffer, offset, packet, parent, message_type)
  if not show.payload then
    return nasdaq_equities_aggregated_itch_v2_0_dissect.payload_branches(buffer, offset, packet, parent, message_type)
  end

  -- Calculate size and check that branch is not empty
  local size = nasdaq_equities_aggregated_itch_v2_0_size_of.payload(buffer, offset, message_type)
  if size == 0 then
    return offset
  end
  ...
  local display = nasdaq_equities_aggregated_itch_v2_0_display.payload(buffer, packet, parent)
...
-- Size: Message Type
nasdaq_equities_aggregated_itch_v2_0_size_of.message_type = 1

-- Display: Message Type
nasdaq_equities_aggregated_itch_v2_0_display.message_type = function(value)
  if value == "S" then
...
nasdaq_equities_aggregated_itch_v2_0_dissect.message_type = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.message_type
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.message_type(value, buffer, offset, packet, parent)
...
-- Size: Length
nasdaq_equities_aggregated_itch_v2_0_size_of.length = 2

-- Display: Length
nasdaq_equities_aggregated_itch_v2_0_display.length = function(value)
  return "Length: "..value
end

-- Dissect: Length
nasdaq_equities_aggregated_itch_v2_0_dissect.length = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.length
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.length(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.message_header = function(buffer, offset)
  local index = 0

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.length

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.message_type

  return index
end

-- Display: Message Header
nasdaq_equities_aggregated_itch_v2_0_display.message_header = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message Header
nasdaq_equities_aggregated_itch_v2_0_dissect.message_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Length: 2 Byte Unsigned Fixed Width Integer
  index, length = nasdaq_equities_aggregated_itch_v2_0_dissect.length(buffer, index, packet, parent)

  -- Message Type: 1 Byte Ascii String Enum with 12 values
  index, message_type = nasdaq_equities_aggregated_itch_v2_0_dissect.message_type(buffer, index, packet, parent)

  return index
end

-- Dissect: Message Header
nasdaq_equities_aggregated_itch_v2_0_dissect.message_header = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.message_header then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.message_header(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.message_header(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.message_header, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.message_header_fields(buffer, offset, packet, parent)
end

-- Calculate size of: Message
nasdaq_equities_aggregated_itch_v2_0_size_of.message = function(buffer, offset)
  local index = 0

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.message_header(buffer, offset + index)

  -- Calculate runtime size of Payload field
  local payload_offset = offset + index
  local payload_type = buffer(payload_offset - 1, 1):string()
  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.payload(buffer, payload_offset, payload_type)

  return index
end

-- Display: Message
nasdaq_equities_aggregated_itch_v2_0_display.message = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Message
nasdaq_equities_aggregated_itch_v2_0_dissect.message_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Header: Struct of 2 fields
  index, message_header = nasdaq_equities_aggregated_itch_v2_0_dissect.message_header(buffer, index, packet, parent)

  -- Dependency element: Message Type
  local message_type = buffer(index - 1, 1):string()

  -- Payload: Runtime Type with 12 branches
  index = nasdaq_equities_aggregated_itch_v2_0_dissect.payload(buffer, index, packet, parent, message_type)

  return index
end

-- Dissect: Message
nasdaq_equities_aggregated_itch_v2_0_dissect.message = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.message then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.message(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.message(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.message, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.message_fields(buffer, offset, packet, parent)
end

-- Size: Count
nasdaq_equities_aggregated_itch_v2_0_size_of.count = 2

-- Display: Count
nasdaq_equities_aggregated_itch_v2_0_display.count = function(value)
  return "Count: "..value
end

-- Dissect: Count
nasdaq_equities_aggregated_itch_v2_0_dissect.count = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.count
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.count(value, buffer, offset, packet, parent)
...
-- Size: Sequence
nasdaq_equities_aggregated_itch_v2_0_size_of.sequence = 8

-- Display: Sequence
nasdaq_equities_aggregated_itch_v2_0_display.sequence = function(value)
  return "Sequence: "..value
end

-- Dissect: Sequence
nasdaq_equities_aggregated_itch_v2_0_dissect.sequence = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.sequence
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_equities_aggregated_itch_v2_0_display.sequence(value, buffer, offset, packet, parent)
...
-- Size: Session
nasdaq_equities_aggregated_itch_v2_0_size_of.session = 10

-- Display: Session
nasdaq_equities_aggregated_itch_v2_0_display.session = function(value)
...
-- Dissect: Session
nasdaq_equities_aggregated_itch_v2_0_dissect.session = function(buffer, offset, packet, parent)
  local length = nasdaq_equities_aggregated_itch_v2_0_size_of.session
  local range = buffer(offset, length)
  ...
  local display = nasdaq_equities_aggregated_itch_v2_0_display.session(value, buffer, offset, packet, parent)
...
nasdaq_equities_aggregated_itch_v2_0_size_of.packet_header = function(buffer, offset)
  local index = 0

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.session

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.sequence

  index = index + nasdaq_equities_aggregated_itch_v2_0_size_of.count

  return index
end

-- Display: Packet Header
nasdaq_equities_aggregated_itch_v2_0_display.packet_header = function(buffer, offset, size, packet, parent)
  return ""
end

-- Dissect Fields: Packet Header
nasdaq_equities_aggregated_itch_v2_0_dissect.packet_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Session: 10 Byte Ascii String
  index, session = nasdaq_equities_aggregated_itch_v2_0_dissect.session(buffer, index, packet, parent)

  -- Sequence: 8 Byte Unsigned Fixed Width Integer
  index, sequence = nasdaq_equities_aggregated_itch_v2_0_dissect.sequence(buffer, index, packet, parent)

  -- Count: 2 Byte Unsigned Fixed Width Integer
  index, count = nasdaq_equities_aggregated_itch_v2_0_dissect.count(buffer, index, packet, parent)

  return index
end

-- Dissect: Packet Header
nasdaq_equities_aggregated_itch_v2_0_dissect.packet_header = function(buffer, offset, packet, parent)
  -- Optionally add struct element to protocol tree
  if show.packet_header then
    local length = nasdaq_equities_aggregated_itch_v2_0_size_of.packet_header(buffer, offset)
    local range = buffer(offset, length)
    local display = nasdaq_equities_aggregated_itch_v2_0_display.packet_header(buffer, packet, parent)
    parent = parent:add(nasdaq_equities_aggregated_itch_v2_0.fields.packet_header, range, display)
  end

  return nasdaq_equities_aggregated_itch_v2_0_dissect.packet_header_fields(buffer, offset, packet, parent)
end

-- Dissect Packet
nasdaq_equities_aggregated_itch_v2_0_dissect.packet = function(buffer, packet, parent)
  local index = 0

  -- Packet Header: Struct of 3 fields
  index, packet_header = nasdaq_equities_aggregated_itch_v2_0_dissect.packet_header(buffer, index, packet, parent)
  ...
  while index < end_of_payload do
    index = nasdaq_equities_aggregated_itch_v2_0_dissect.message(buffer, index, packet, parent)
  end
...
function nasdaq_equities_aggregated_itch_v2_0.dissector(buffer, packet, parent)
  ...
  return nasdaq_equities_aggregated_itch_v2_0_dissect.packet(buffer, packet, protocol)
end
