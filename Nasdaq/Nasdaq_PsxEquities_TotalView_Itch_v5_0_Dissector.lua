...
local omi_nasdaq_psxequities_totalview_itch_v5_0 = Proto("Omi.Nasdaq.PsxEquities.TotalView.Itch.v5.0", "Nasdaq PsxEquities TotalView Itch 5.0")
...
nasdaq_psxequities_totalview_itch_v5_0.timestamp_format = 2
...
omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
function omi_nasdaq_psxequities_totalview_itch_v5_0.prefs_changed()
  ...
  if show.records ~= omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.resolve_records then
    show.records = omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.resolve_records
  end
  ...
  if show.headers ~= omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.show_headers then
    show.headers = omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.show_structs then
    show.structs = omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.show_structs
  end
  ...
  if nasdaq_psxequities_totalview_itch_v5_0.utc_offset_hours ~= omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.utc_offset_hours then
    nasdaq_psxequities_totalview_itch_v5_0.utc_offset_hours = omi_nasdaq_psxequities_totalview_itch_v5_0.prefs.utc_offset_hours
  end
end
...
nasdaq_psxequities_totalview_itch_v5_0.conversation = {}
nasdaq_psxequities_totalview_itch_v5_0.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nasdaq_psxequities_totalview_itch_v5_0.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_psxequities_totalview_itch_v5_0.conversation.data = function(packet)
  local key = nasdaq_psxequities_totalview_itch_v5_0.conversation.key(packet)
  local data = nasdaq_psxequities_totalview_itch_v5_0.conversation.flows[key]
  if data == nil then
    data = { stock_directory_message = {} }
    nasdaq_psxequities_totalview_itch_v5_0.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_psxequities_totalview_itch_v5_0.conversation.current = nil
...
-- Cancelled Shares
nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares = {}

-- Size: Cancelled Shares
nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares.size = 4

-- Display: Cancelled Shares
nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares.display = function(value)
  return "Cancelled Shares: "..value
end

-- Dissect: Cancelled Shares
nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares.size
  local range = buffer(offset, length)
  local value = range:uint()
  local display = nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_psxequities_totalview_itch_v5_0.fields.cancelled_shares, range, value, display)
...
nasdaq_psxequities_totalview_itch_v5_0.locate_code.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nasdaq_psxequities_totalview_itch_v5_0.conversation.current.stock_directory_message[value]
  if record ~= nil and record.stock ~= nil then
    display = "Locate Code: " .. tostring(record.stock) .. " (" .. tostring(value) .. ")"
  end

  local field_tree = parent:add(omi_nasdaq_psxequities_totalview_itch_v5_0.fields.locate_code, range, value, display)
...
nasdaq_psxequities_totalview_itch_v5_0.stock_locate.dissect = function(buffer, offset, packet, parent)
  ...
  local field_tree = parent:add(omi_nasdaq_psxequities_totalview_itch_v5_0.fields.stock_locate, range, value, display)
...
-- Display: Timestamp
nasdaq_psxequities_totalview_itch_v5_0.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_psxequities_totalview_itch_v5_0.timestamp_format == 0 then
  ...
  if nasdaq_psxequities_totalview_itch_v5_0.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_psxequities_totalview_itch_v5_0.utc_offset_hours * 3600
...
nasdaq_psxequities_totalview_itch_v5_0.order_cancel_message.size =
  ...
  nasdaq_psxequities_totalview_itch_v5_0.timestamp.size + 
  nasdaq_psxequities_totalview_itch_v5_0.order_reference_number.size + 
  nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares.size
...
nasdaq_psxequities_totalview_itch_v5_0.order_cancel_message.fields = function(buffer, offset, packet, parent)
  ...
  index, cancelled_shares = nasdaq_psxequities_totalview_itch_v5_0.cancelled_shares.dissect(buffer, index, packet, parent)
...
nasdaq_psxequities_totalview_itch_v5_0.stock_directory_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nasdaq_psxequities_totalview_itch_v5_0.conversation.current.stock_directory_message[stock_locate] = {
...
nasdaq_psxequities_totalview_itch_v5_0.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_psxequities_totalview_itch_v5_0.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_psxequities_totalview_itch_v5_0.message.size(buffer, offset)
...
-- End Of Session
nasdaq_psxequities_totalview_itch_v5_0.end_of_session = {}

-- Display: End Of Session
nasdaq_psxequities_totalview_itch_v5_0.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_psxequities_totalview_itch_v5_0.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_psxequities_totalview_itch_v5_0.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_psxequities_totalview_itch_v5_0.heartbeat = {}

-- Display: Heartbeat
nasdaq_psxequities_totalview_itch_v5_0.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_psxequities_totalview_itch_v5_0.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_psxequities_totalview_itch_v5_0.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_psxequities_totalview_itch_v5_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_psxequities_totalview_itch_v5_0.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
...
nasdaq_psxequities_totalview_itch_v5_0.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_psxequities_totalview_itch_v5_0.packet_header.size
end

-- Dissect Packet
nasdaq_psxequities_totalview_itch_v5_0.packet.dissect = function(buffer, packet, parent)
  -- establish frame context from the conversation's stored values
  local data = nasdaq_psxequities_totalview_itch_v5_0.conversation.data(packet)
  if not packet.visited then
  end
  nasdaq_psxequities_totalview_itch_v5_0.conversation.current = data
  ...
  index = nasdaq_psxequities_totalview_itch_v5_0.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq PsxEquities TotalView Itch 5.0 (Udp)
local function omi_nasdaq_psxequities_totalview_itch_v5_0_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_psxequities_totalview_itch_v5_0:register_heuristic("udp", omi_nasdaq_psxequities_totalview_itch_v5_0_udp_heuristic)

-- Register Nasdaq PsxEquities TotalView Itch 5.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_psxequities_totalview_itch_v5_0)
