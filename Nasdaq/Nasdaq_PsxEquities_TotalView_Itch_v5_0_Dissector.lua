...
nasdaq_psxequities_totalview_itch_v5_0_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(nasdaq_psxequities_totalview_itch_v5_0.fields.message, buffer(offset, 0))
    local current = nasdaq_psxequities_totalview_itch_v5_0_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = nasdaq_psxequities_totalview_itch_v5_0_display.message(buffer, packet, element)
    element:append_text(display)
...
nasdaq_psxequities_totalview_itch_v5_0_dissect.packet = function(buffer, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = nasdaq_psxequities_totalview_itch_v5_0_dissect.message(buffer, index, packet, parent, size_of_message)

    if message ~= nil then
      local iteration = message:add(nasdaq_psxequities_totalview_itch_v5_0.fields.message_index, message_index)
