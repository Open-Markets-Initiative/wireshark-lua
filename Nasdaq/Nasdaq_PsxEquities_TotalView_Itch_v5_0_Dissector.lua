...
-- Dissect: Message
nasdaq_psxequities_totalview_itch_v5_0.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_psxequities_totalview_itch_v5_0.fields.message, range, display)
  end
