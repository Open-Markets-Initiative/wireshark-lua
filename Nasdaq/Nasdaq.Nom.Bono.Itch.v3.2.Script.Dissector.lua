...
-- Nasdaq Nom Bono Itch 3.2 Protocol
local nasdaq_nom_bono_itch_v3_2 = Proto("Nasdaq.Nom.Bono.Itch.v3.2.Lua", "Nasdaq Nom Bono Itch 3.2")
...
nasdaq_nom_bono_itch_v3_2.fields.count = ProtoField.new("Count", "nasdaq.nom.bono.itch.v3.2.count", ftypes.UINT16)
nasdaq_nom_bono_itch_v3_2.fields.cross_id = ProtoField.new("Cross Id", "nasdaq.nom.bono.itch.v3.2.crossid", ftypes.UINT32)
nasdaq_nom_bono_itch_v3_2.fields.current_trading_state = ProtoField.new("Current Trading State", "nasdaq.nom.bono.itch.v3.2.currenttradingstate", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.event_code = ProtoField.new("Event Code", "nasdaq.nom.bono.itch.v3.2.eventcode", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.expiration_day = ProtoField.new("Expiration Day", "nasdaq.nom.bono.itch.v3.2.expirationday", ftypes.UINT8)
nasdaq_nom_bono_itch_v3_2.fields.expiration_month = ProtoField.new("Expiration Month", "nasdaq.nom.bono.itch.v3.2.expirationmonth", ftypes.UINT8)
nasdaq_nom_bono_itch_v3_2.fields.expiration_year = ProtoField.new("Expiration Year", "nasdaq.nom.bono.itch.v3.2.expirationyear", ftypes.UINT8)
nasdaq_nom_bono_itch_v3_2.fields.length = ProtoField.new("Length", "nasdaq.nom.bono.itch.v3.2.length", ftypes.UINT16)
nasdaq_nom_bono_itch_v3_2.fields.long_best_ask_update_message = ProtoField.new("Long Best Ask Update Message", "nasdaq.nom.bono.itch.v3.2.longbestaskupdatemessage", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.long_best_bid_and_ask_update_message = ProtoField.new("Long Best Bid And Ask Update Message", "nasdaq.nom.bono.itch.v3.2.longbestbidandaskupdatemessage", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.long_best_bid_update_message = ProtoField.new("Long Best Bid Update Message", "nasdaq.nom.bono.itch.v3.2.longbestbidupdatemessage", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.message = ProtoField.new("Message", "nasdaq.nom.bono.itch.v3.2.message", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.message_header = ProtoField.new("Message Header", "nasdaq.nom.bono.itch.v3.2.messageheader", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.message_type = ProtoField.new("Message Type", "nasdaq.nom.bono.itch.v3.2.messagetype", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.mpv = ProtoField.new("Mpv", "nasdaq.nom.bono.itch.v3.2.mpv", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.nanoseconds = ProtoField.new("Nanoseconds", "nasdaq.nom.bono.itch.v3.2.nanoseconds", ftypes.UINT32)
nasdaq_nom_bono_itch_v3_2.fields.open_state = ProtoField.new("Open State", "nasdaq.nom.bono.itch.v3.2.openstate", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.option_closing_type = ProtoField.new("Option Closing Type", "nasdaq.nom.bono.itch.v3.2.optionclosingtype", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.option_id = ProtoField.new("Option Id", "nasdaq.nom.bono.itch.v3.2.optionid", ftypes.UINT32)
...
nasdaq_nom_bono_itch_v3_2.fields.security_symbol = ProtoField.new("Security Symbol", "nasdaq.nom.bono.itch.v3.2.securitysymbol", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.sequence = ProtoField.new("Sequence", "nasdaq.nom.bono.itch.v3.2.sequence", ftypes.UINT64)
nasdaq_nom_bono_itch_v3_2.fields.session = ProtoField.new("Session", "nasdaq.nom.bono.itch.v3.2.session", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.short_best_ask_update_message = ProtoField.new("Short Best Ask Update Message", "nasdaq.nom.bono.itch.v3.2.shortbestaskupdatemessage", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.short_best_bid_and_ask_update_message = ProtoField.new("Short Best Bid And Ask Update Message", "nasdaq.nom.bono.itch.v3.2.shortbestbidandaskupdatemessage", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.short_best_bid_update_message = ProtoField.new("Short Best Bid Update Message", "nasdaq.nom.bono.itch.v3.2.shortbestbidupdatemessage", ftypes.STRING)
...
nasdaq_nom_bono_itch_v3_2.fields.tradable = ProtoField.new("Tradable", "nasdaq.nom.bono.itch.v3.2.tradable", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.trade_condition = ProtoField.new("Trade Condition", "nasdaq.nom.bono.itch.v3.2.tradecondition", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.trade_report_message = ProtoField.new("Trade Report Message", "nasdaq.nom.bono.itch.v3.2.tradereportmessage", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.trading_action_message = ProtoField.new("Trading Action Message", "nasdaq.nom.bono.itch.v3.2.tradingactionmessage", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "nasdaq.nom.bono.itch.v3.2.underlyingsymbol", ftypes.STRING)
nasdaq_nom_bono_itch_v3_2.fields.version = ProtoField.new("Version", "nasdaq.nom.bono.itch.v3.2.version", ftypes.UINT8)
nasdaq_nom_bono_itch_v3_2.fields.volume = ProtoField.new("Volume", "nasdaq.nom.bono.itch.v3.2.volume", ftypes.UINT32)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Nasdaq Nom Bono Itch 3.2 Element Dissection Options
...
-- Register Nasdaq Nom Bono Itch 3.2 Show Options
nasdaq_nom_bono_itch_v3_2.prefs.show_broken_trade_report_message = Pref.bool("Show Broken Trade Report Message", show.broken_trade_report_message, "Parse and add Broken Trade Report Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_ask_update_message = Pref.bool("Show Long Best Ask Update Message", show.long_best_ask_update_message, "Parse and add Long Best Ask Update Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_bid_and_ask_update_message = Pref.bool("Show Long Best Bid And Ask Update Message", show.long_best_bid_and_ask_update_message, "Parse and add Long Best Bid And Ask Update Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_bid_update_message = Pref.bool("Show Long Best Bid Update Message", show.long_best_bid_update_message, "Parse and add Long Best Bid Update Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_options_directory_message = Pref.bool("Show Options Directory Message", show.options_directory_message, "Parse and add Options Directory Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_packet_header = Pref.bool("Show Packet Header", show.packet_header, "Parse and add Packet Header to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_security_open_closed_message = Pref.bool("Show Security Open Closed Message", show.security_open_closed_message, "Parse and add Security Open Closed Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_ask_update_message = Pref.bool("Show Short Best Ask Update Message", show.short_best_ask_update_message, "Parse and add Short Best Ask Update Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_bid_and_ask_update_message = Pref.bool("Show Short Best Bid And Ask Update Message", show.short_best_bid_and_ask_update_message, "Parse and add Short Best Bid And Ask Update Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_bid_update_message = Pref.bool("Show Short Best Bid Update Message", show.short_best_bid_update_message, "Parse and add Short Best Bid Update Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_system_event_message = Pref.bool("Show System Event Message", show.system_event_message, "Parse and add System Event Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_timestamp_message = Pref.bool("Show Timestamp Message", show.timestamp_message, "Parse and add Timestamp Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_trade_report_message = Pref.bool("Show Trade Report Message", show.trade_report_message, "Parse and add Trade Report Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_trading_action_message = Pref.bool("Show Trading Action Message", show.trading_action_message, "Parse and add Trading Action Message to protocol tree")
nasdaq_nom_bono_itch_v3_2.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function nasdaq_nom_bono_itch_v3_2.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.broken_trade_report_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_broken_trade_report_message then
    show.broken_trade_report_message = nasdaq_nom_bono_itch_v3_2.prefs.show_broken_trade_report_message
    changed = true
  end
  if show.long_best_ask_update_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_ask_update_message then
    show.long_best_ask_update_message = nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_ask_update_message
    changed = true
  end
  if show.long_best_bid_and_ask_update_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_bid_and_ask_update_message then
    show.long_best_bid_and_ask_update_message = nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_bid_and_ask_update_message
    changed = true
  end
  if show.long_best_bid_update_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_bid_update_message then
    show.long_best_bid_update_message = nasdaq_nom_bono_itch_v3_2.prefs.show_long_best_bid_update_message
    changed = true
  end
  if show.message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_message then
    show.message = nasdaq_nom_bono_itch_v3_2.prefs.show_message
    changed = true
  end
  if show.message_header ~= nasdaq_nom_bono_itch_v3_2.prefs.show_message_header then
    show.message_header = nasdaq_nom_bono_itch_v3_2.prefs.show_message_header
    changed = true
  end
  if show.options_directory_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_options_directory_message then
    show.options_directory_message = nasdaq_nom_bono_itch_v3_2.prefs.show_options_directory_message
    changed = true
  end
  if show.packet ~= nasdaq_nom_bono_itch_v3_2.prefs.show_packet then
    show.packet = nasdaq_nom_bono_itch_v3_2.prefs.show_packet
    changed = true
  end
  if show.packet_header ~= nasdaq_nom_bono_itch_v3_2.prefs.show_packet_header then
    show.packet_header = nasdaq_nom_bono_itch_v3_2.prefs.show_packet_header
    changed = true
  end
  if show.security_open_closed_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_security_open_closed_message then
    show.security_open_closed_message = nasdaq_nom_bono_itch_v3_2.prefs.show_security_open_closed_message
    changed = true
  end
  if show.short_best_ask_update_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_ask_update_message then
    show.short_best_ask_update_message = nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_ask_update_message
    changed = true
  end
  if show.short_best_bid_and_ask_update_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_bid_and_ask_update_message then
    show.short_best_bid_and_ask_update_message = nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_bid_and_ask_update_message
    changed = true
  end
  if show.short_best_bid_update_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_bid_update_message then
    show.short_best_bid_update_message = nasdaq_nom_bono_itch_v3_2.prefs.show_short_best_bid_update_message
    changed = true
  end
  if show.system_event_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_system_event_message then
    show.system_event_message = nasdaq_nom_bono_itch_v3_2.prefs.show_system_event_message
    changed = true
  end
  if show.timestamp_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_timestamp_message then
    show.timestamp_message = nasdaq_nom_bono_itch_v3_2.prefs.show_timestamp_message
    changed = true
  end
  if show.trade_report_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_trade_report_message then
    show.trade_report_message = nasdaq_nom_bono_itch_v3_2.prefs.show_trade_report_message
    changed = true
  end
  if show.trading_action_message ~= nasdaq_nom_bono_itch_v3_2.prefs.show_trading_action_message then
    show.trading_action_message = nasdaq_nom_bono_itch_v3_2.prefs.show_trading_action_message
    changed = true
  end
  if show.payload ~= nasdaq_nom_bono_itch_v3_2.prefs.show_payload then
    show.payload = nasdaq_nom_bono_itch_v3_2.prefs.show_payload
    changed = true
  end
...
function nasdaq_nom_bono_itch_v3_2.init()
end

-- Dissector for Nasdaq Nom Bono Itch 3.2
function nasdaq_nom_bono_itch_v3_2.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = nasdaq_nom_bono_itch_v3_2.name
...
udp_table:add(65333, nasdaq_nom_bono_itch_v3_2)
...
verify.nasdaq_nom_bono_itch_v3_2_packet_size = function(buffer)

  return true
end

-- Dissector Heuristic for Nasdaq Nom Bono Itch 3.2
local function nasdaq_nom_bono_itch_v3_2_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.nasdaq_nom_bono_itch_v3_2_packet_size(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = nasdaq_nom_bono_itch_v3_2
  nasdaq_nom_bono_itch_v3_2.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Nasdaq Nom Bono Itch 3.2
nasdaq_nom_bono_itch_v3_2:register_heuristic("udp", nasdaq_nom_bono_itch_v3_2_heuristic)
