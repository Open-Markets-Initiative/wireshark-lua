...
-- Dissect: Message
nasdaq_iseoptions_ordercombofeed_itch_v1_1.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.fields.message, range, display)
  end
