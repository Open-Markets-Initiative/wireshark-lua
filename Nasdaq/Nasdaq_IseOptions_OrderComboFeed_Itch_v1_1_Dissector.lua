...
local omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1 = Proto("Omi.Nasdaq.IseOptions.OrderComboFeed.Itch.v1.1", "Nasdaq IseOptions OrderComboFeed Itch 1.1")
...
-- Nasdaq IseOptions OrderComboFeed 1.1 Application Messages
...
omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "nasdaq.iseoptions.ordercombofeed.itch.v1.1.messagesequencenumber", ftypes.UINT64)
...
omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
...
omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
...
function omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_headers then
    show.headers = omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_structs then
    show.structs = omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_indexes then
    show.indexes = omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_sequences then
    show.sequences = omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.prefs.show_sequences
  end
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.auction_response.fields = function(buffer, offset, packet, parent, auction_response_index)
  ...
  if auction_response_index ~= nil and show.indexes then
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.complex_strategy_auction_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_iseoptions_ordercombofeed_itch_v1_1.complex_strategy_auction_message.display(packet, parent, length)
    parent:append_text(display)
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.complex_strategy_directory_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_iseoptions_ordercombofeed_itch_v1_1.complex_strategy_directory_message.display(packet, parent, length)
    parent:append_text(display)
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_iseoptions_ordercombofeed_itch_v1_1.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1.fields.message_sequence_number, UInt64.new(nasdaq_iseoptions_ordercombofeed_itch_v1_1.sequence + message_index - 1))
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_iseoptions_ordercombofeed_itch_v1_1.message.size(buffer, offset)
...
-- End Of Session
nasdaq_iseoptions_ordercombofeed_itch_v1_1.end_of_session = {}

-- Display: End Of Session
nasdaq_iseoptions_ordercombofeed_itch_v1_1.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_iseoptions_ordercombofeed_itch_v1_1.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_ordercombofeed_itch_v1_1.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_iseoptions_ordercombofeed_itch_v1_1.heartbeat = {}

-- Display: Heartbeat
nasdaq_iseoptions_ordercombofeed_itch_v1_1.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_iseoptions_ordercombofeed_itch_v1_1.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_iseoptions_ordercombofeed_itch_v1_1.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_iseoptions_ordercombofeed_itch_v1_1.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_iseoptions_ordercombofeed_itch_v1_1.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
  for message_index = 1, message_count do
    ...
    offset = nasdaq_iseoptions_ordercombofeed_itch_v1_1.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_iseoptions_ordercombofeed_itch_v1_1.sequence = sequence_number
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_iseoptions_ordercombofeed_itch_v1_1.packet_header.size
end
...
nasdaq_iseoptions_ordercombofeed_itch_v1_1.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_iseoptions_ordercombofeed_itch_v1_1.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq IseOptions OrderComboFeed Itch 1.1 (Udp)
local function omi_nasdaq_iseoptions_ordercombofeed_itch_v1_1_udp_heuristic(buffer, packet, parent)
