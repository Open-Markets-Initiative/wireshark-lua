...
nasdaq_phlxoptions_marketdepth_itch_v1_5_dissect.block_delete_message_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, number_of_reference_number_deltas do
    index = nasdaq_phlxoptions_marketdepth_itch_v1_5_dissect.cancelled_reference_number_delta(buffer, index, packet, parent)
  end
...
nasdaq_phlxoptions_marketdepth_itch_v1_5_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    ...
    parent = parent:add(nasdaq_phlxoptions_marketdepth_itch_v1_5.fields.message, range, display)
  end
...
nasdaq_phlxoptions_marketdepth_itch_v1_5_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    -- Message: Struct of 2 fields
    index = nasdaq_phlxoptions_marketdepth_itch_v1_5_dissect.message(buffer, index, packet, parent, size_of_message)
  end
