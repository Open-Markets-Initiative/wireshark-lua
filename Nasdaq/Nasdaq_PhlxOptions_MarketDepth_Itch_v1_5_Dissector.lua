...
omi_nasdaq_phlxoptions_marketdepth_itch_v1_5.fields.reserved = ProtoField.new("Reserved", "nasdaq.phlxoptions.marketdepth.itch.v1.5.reserved", ftypes.BYTES)
...
-- Nasdaq PhlxOptions Itch MarketDepth 1.5 Application Messages
...
show.cancelled_reference_number_delta_index = true
...
function omi_nasdaq_phlxoptions_marketdepth_itch_v1_5.prefs_changed()
  ...
  if show.message_index ~= omi_nasdaq_phlxoptions_marketdepth_itch_v1_5.prefs.show_message_index then
    show.message_index = omi_nasdaq_phlxoptions_marketdepth_itch_v1_5.prefs.show_message_index
  end
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.data = function(packet)
  local key = nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.key(packet)
  local data = nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.flows[key]
  if data == nil then
    data = { second = { last = nil, frames = {} } }
    nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.current = nil
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.market_side.display = function(value)
  ...
  if value == "N" then
    return "Market Side: Sell Implied (N)"
  end
...
-- Store: Second
nasdaq_phlxoptions_marketdepth_itch_v1_5.second.current = nil
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.timestamp.composite = function(buffer, offset, stored_second, packet, parent)
  ...
  local display = nasdaq_phlxoptions_marketdepth_itch_v1_5.timestamp.display(nanoseconds, stored_second, packet)
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.timestamp.dissect = function(buffer, offset, packet, parent)
  local stored_second = nasdaq_phlxoptions_marketdepth_itch_v1_5.second.current
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.block_delete_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_phlxoptions_marketdepth_itch_v1_5.block_delete_message.display(packet, parent, length)
    parent:append_text(display)
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.seconds_message.fields = function(buffer, offset, packet, parent)
  ...
  -- Store Second Value
  nasdaq_phlxoptions_marketdepth_itch_v1_5.second.current = second

  if not packet.visited then
    nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.current.second.last = second
  end
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  for message_index = 1, message_count do
    ...
    offset = nasdaq_phlxoptions_marketdepth_itch_v1_5.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_phlxoptions_marketdepth_itch_v1_5.packet.dissect = function(buffer, packet, parent)
  ...
  local data = nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.data(packet)
  if not packet.visited then
    data.second.frames[packet.number] = data.second.last
  end
  nasdaq_phlxoptions_marketdepth_itch_v1_5.second.current = data.second.frames[packet.number]
  nasdaq_phlxoptions_marketdepth_itch_v1_5.conversation.current = data
  ...
  index = nasdaq_phlxoptions_marketdepth_itch_v1_5.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq PhlxOptions MarketDepth Itch 1.5 (Udp)
local function omi_nasdaq_phlxoptions_marketdepth_itch_v1_5_udp_heuristic(buffer, packet, parent)
