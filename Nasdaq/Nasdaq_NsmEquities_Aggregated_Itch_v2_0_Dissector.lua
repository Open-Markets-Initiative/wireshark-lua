...
omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_sequences = Pref.bool("Show Sequence Numbers", show.sequences, "Show each message's own feed sequence number in the protocol tree")
...
function omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs_changed()
  ...
  if show.headers ~= omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_headers then
    show.headers = omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_headers
  end
  if show.structs ~= omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_structs then
    show.structs = omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_structs
  end
  if show.indexes ~= omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_indexes then
    show.indexes = omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_indexes
  end
  if show.sequences ~= omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_sequences then
    show.sequences = omi_nasdaq_nsmequities_aggregated_itch_v2_0.prefs.show_sequences
  end
...
nasdaq_nsmequities_aggregated_itch_v2_0.message.fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if message_index ~= nil and show.sequences and nasdaq_nsmequities_aggregated_itch_v2_0.sequence ~= nil then
    local sequence = parent:add(omi_nasdaq_nsmequities_aggregated_itch_v2_0.fields.message_sequence_number, UInt64.new(nasdaq_nsmequities_aggregated_itch_v2_0.sequence + message_index - 1))
...
-- End Of Session
nasdaq_nsmequities_aggregated_itch_v2_0.end_of_session = {}

-- Display: End Of Session
nasdaq_nsmequities_aggregated_itch_v2_0.end_of_session.display = function(packet, parent, length)
  return "End Of Session"
end


-- Dissect: End Of Session
nasdaq_nsmequities_aggregated_itch_v2_0.end_of_session.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nsmequities_aggregated_itch_v2_0.end_of_session.display(packet, parent, 0)
...
-- Heartbeat
nasdaq_nsmequities_aggregated_itch_v2_0.heartbeat = {}

-- Display: Heartbeat
nasdaq_nsmequities_aggregated_itch_v2_0.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
nasdaq_nsmequities_aggregated_itch_v2_0.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = nasdaq_nsmequities_aggregated_itch_v2_0.heartbeat.display(packet, parent, 0)
  packet.cols.info = display
...
nasdaq_nsmequities_aggregated_itch_v2_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return nasdaq_nsmequities_aggregated_itch_v2_0.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Dissect End Of Session
  if message_count == 65535 then
    return nasdaq_nsmequities_aggregated_itch_v2_0.end_of_session.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
...
nasdaq_nsmequities_aggregated_itch_v2_0.packet_header.fields = function(buffer, offset, packet, parent)
  ...
  nasdaq_nsmequities_aggregated_itch_v2_0.sequence = sequence_number
...
nasdaq_nsmequities_aggregated_itch_v2_0.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_nsmequities_aggregated_itch_v2_0.packet_header.size
end
...
-- Dissector Heuristic for Nasdaq NsmEquities Aggregated Itch 2.0 (Udp)
local function omi_nasdaq_nsmequities_aggregated_itch_v2_0_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_nsmequities_aggregated_itch_v2_0:register_heuristic("udp", omi_nasdaq_nsmequities_aggregated_itch_v2_0_udp_heuristic)

-- Register Nasdaq NsmEquities Aggregated Itch 2.0 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_nasdaq_nsmequities_aggregated_itch_v2_0)
