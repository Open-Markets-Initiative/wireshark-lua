...
-- Dissect: Message
nasdaq_nsmequities_aggregated_itch_v2_0.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_nsmequities_aggregated_itch_v2_0.fields.message, range, display)
  end
