...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.lower_price_range_collar = ProtoField.new("Lower Price Range Collar", "nasdaq.nsmequities.noi.itch.v3.0.lowerpricerangecollar", ftypes.DOUBLE)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.maximum_allowable_price = ProtoField.new("Maximum Allowable Price", "nasdaq.nsmequities.noi.itch.v3.0.maximumallowableprice", ftypes.DOUBLE)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.minimum_allowable_price = ProtoField.new("Minimum Allowable Price", "nasdaq.nsmequities.noi.itch.v3.0.minimumallowableprice", ftypes.DOUBLE)
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.near_execution_price = ProtoField.new("Near Execution Price", "nasdaq.nsmequities.noi.itch.v3.0.nearexecutionprice", ftypes.DOUBLE)
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.near_execution_time = ProtoField.new("Near Execution Time", "nasdaq.nsmequities.noi.itch.v3.0.nearexecutiontime", ftypes.UINT64)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.open_eligibility_status = ProtoField.new("Open Eligibility Status", "nasdaq.nsmequities.noi.itch.v3.0.openeligibilitystatus", ftypes.STRING)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.timestamp_integer_6 = ProtoField.new("Timestamp Integer 6", "nasdaq.nsmequities.noi.itch.v3.0.timestampinteger6", ftypes.UINT64)
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.timestamp_timestamp_6 = ProtoField.new("Timestamp Timestamp 6", "nasdaq.nsmequities.noi.itch.v3.0.timestamptimestamp6", ftypes.UINT64)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.upper_price_range_collar = ProtoField.new("Upper Price Range Collar", "nasdaq.nsmequities.noi.itch.v3.0.upperpricerangecollar", ftypes.DOUBLE)

-- Nasdaq NsmEquities Itch Noi 3.0 Application Messages
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.direct_listing_with_capital_raise_price_discovery_message = ProtoField.new("Direct Listing With Capital Raise Price Discovery Message", "nasdaq.nsmequities.noi.itch.v3.0.directlistingwithcapitalraisepricediscoverymessage", ftypes.STRING)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.net_order_imbalance_indicator_message = ProtoField.new("Net Order Imbalance Indicator Message", "nasdaq.nsmequities.noi.itch.v3.0.netorderimbalanceindicatormessage", ftypes.STRING)
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.reg_sho_short_sale_price_test_restricted_indicator_message = ProtoField.new("Reg Sho Short Sale Price Test Restricted Indicator Message", "nasdaq.nsmequities.noi.itch.v3.0.regshoshortsalepricetestrestrictedindicatormessage", ftypes.STRING)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.fields.system_event = ProtoField.new("System Event", "nasdaq.nsmequities.noi.itch.v3.0.systemevent", ftypes.STRING)
...
omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_net_order_imbalance_indicator_message = Pref.bool("Show Net Order Imbalance Indicator Message", show.net_order_imbalance_indicator_message, "Parse and add Net Order Imbalance Indicator Message to protocol tree")
...
omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_system_event = Pref.bool("Show System Event", show.system_event, "Parse and add System Event to protocol tree")
...
function omi_nasdaq_nsmequities_noi_itch_v3_0.prefs_changed()
  ...
  if show.direct_listing_with_capital_raise_price_discovery_message ~= omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_direct_listing_with_capital_raise_price_discovery_message then
    show.direct_listing_with_capital_raise_price_discovery_message = omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_direct_listing_with_capital_raise_price_discovery_message
    changed = true
  end
  ...
  if show.net_order_imbalance_indicator_message ~= omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_net_order_imbalance_indicator_message then
    show.net_order_imbalance_indicator_message = omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_net_order_imbalance_indicator_message
    changed = true
  end
  ...
  if show.reg_sho_short_sale_price_test_restricted_indicator_message ~= omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message then
    show.reg_sho_short_sale_price_test_restricted_indicator_message = omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_reg_sho_short_sale_price_test_restricted_indicator_message
    changed = true
  end
  ...
  if show.system_event ~= omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_system_event then
    show.system_event = omi_nasdaq_nsmequities_noi_itch_v3_0.prefs.show_system_event
    changed = true
  end
...
nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar = {}

-- Size: Upper Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.size = 4

-- Display: Upper Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.display = function(value)
  return "Upper Price Range Collar: "..value
end

-- Translate: Upper Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.translate = function(raw)
  return raw/10000
end

-- Dissect: Upper Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.translate(raw)
  local display = nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.upper_price_range_collar, range, value, display)

  return offset + length, value
end

-- Lower Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar = {}

-- Size: Lower Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.size = 4

-- Display: Lower Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.display = function(value)
  return "Lower Price Range Collar: "..value
end

-- Translate: Lower Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.translate = function(raw)
  return raw/10000
end

-- Dissect: Lower Price Range Collar
nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.translate(raw)
  local display = nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.lower_price_range_collar, range, value, display)

  return offset + length, value
end

-- Near Execution Time
nasdaq_nsmequities_noi_itch_v3_0.near_execution_time = {}

-- Size: Near Execution Time
nasdaq_nsmequities_noi_itch_v3_0.near_execution_time.size = 8

-- Display: Near Execution Time
nasdaq_nsmequities_noi_itch_v3_0.near_execution_time.display = function(value)
  return "Near Execution Time: "..value
end

-- Dissect: Near Execution Time
nasdaq_nsmequities_noi_itch_v3_0.near_execution_time.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.near_execution_time.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_nsmequities_noi_itch_v3_0.near_execution_time.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.near_execution_time, range, value, display)

  return offset + length, value
end

-- Near Execution Price
nasdaq_nsmequities_noi_itch_v3_0.near_execution_price = {}

-- Size: Near Execution Price
nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.size = 4

-- Display: Near Execution Price
nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.display = function(value)
  return "Near Execution Price: "..value
end

-- Translate: Near Execution Price
nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.translate = function(raw)
  return raw/10000
end

-- Dissect: Near Execution Price
nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.translate(raw)
  local display = nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.near_execution_price, range, value, display)

  return offset + length, value
end

-- Maximum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price = {}

-- Size: Maximum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.size = 4

-- Display: Maximum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.display = function(value)
  return "Maximum Allowable Price: "..value
end

-- Translate: Maximum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.translate = function(raw)
  return raw/10000
end

-- Dissect: Maximum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.translate(raw)
  local display = nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.maximum_allowable_price, range, value, display)

  return offset + length, value
end

-- Minimum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price = {}

-- Size: Minimum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.size = 4

-- Display: Minimum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.display = function(value)
  return "Minimum Allowable Price: "..value
end

-- Translate: Minimum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.translate = function(raw)
  return raw/10000
end

-- Dissect: Minimum Allowable Price
nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.size
  local range = buffer(offset, length)
  local raw = range:uint()
  local value = nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.translate(raw)
  local display = nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.minimum_allowable_price, range, value, display)

  return offset + length, value
end

-- Open Eligibility Status
nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status = {}

-- Size: Open Eligibility Status
nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status.size = 1

-- Display: Open Eligibility Status
nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status.display = function(value)
  return "Open Eligibility Status: "..value
end

-- Dissect: Open Eligibility Status
nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.open_eligibility_status, range, value, display)
...
-- Timestamp Integer 6
nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6 = {}

-- Size: Timestamp Integer 6
nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6.size = 6

-- Display: Timestamp Integer 6
nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6.display = function(value)
  return "Timestamp Integer 6: "..value
end

-- Dissect: Timestamp Integer 6
nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.timestamp_integer_6, range, value, display)
...
nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message = {}

-- Size: Direct Listing With Capital Raise Price Discovery Message
nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.size =
  nasdaq_nsmequities_noi_itch_v3_0.tracking_number.size + 
  nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6.size + 
  nasdaq_nsmequities_noi_itch_v3_0.stock.size + 
  nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status.size + 
  nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.size + 
  nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.size + 
  nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.size + 
  nasdaq_nsmequities_noi_itch_v3_0.near_execution_time.size + 
  nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.size + 
  nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.size

-- Display: Direct Listing With Capital Raise Price Discovery Message
nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Direct Listing With Capital Raise Price Discovery Message
nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, timestamp_integer_6 = nasdaq_nsmequities_noi_itch_v3_0.timestamp_integer_6.dissect(buffer, index, packet, parent)

  -- Stock: Alpha
  index, stock = nasdaq_nsmequities_noi_itch_v3_0.stock.dissect(buffer, index, packet, parent)

  -- Open Eligibility Status: Alpha
  index, open_eligibility_status = nasdaq_nsmequities_noi_itch_v3_0.open_eligibility_status.dissect(buffer, index, packet, parent)

  -- Minimum Allowable Price: Price (4)
  index, minimum_allowable_price = nasdaq_nsmequities_noi_itch_v3_0.minimum_allowable_price.dissect(buffer, index, packet, parent)

  -- Maximum Allowable Price: Price (4)
  index, maximum_allowable_price = nasdaq_nsmequities_noi_itch_v3_0.maximum_allowable_price.dissect(buffer, index, packet, parent)

  -- Near Execution Price: Price (4)
  index, near_execution_price = nasdaq_nsmequities_noi_itch_v3_0.near_execution_price.dissect(buffer, index, packet, parent)

  -- Near Execution Time: Integer
  index, near_execution_time = nasdaq_nsmequities_noi_itch_v3_0.near_execution_time.dissect(buffer, index, packet, parent)

  -- Lower Price Range Collar: Price (4)
  index, lower_price_range_collar = nasdaq_nsmequities_noi_itch_v3_0.lower_price_range_collar.dissect(buffer, index, packet, parent)

  -- Upper Price Range Collar: Price (4)
  index, upper_price_range_collar = nasdaq_nsmequities_noi_itch_v3_0.upper_price_range_collar.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Direct Listing With Capital Raise Price Discovery Message
nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.dissect = function(buffer, offset, packet, parent)
  if show.direct_listing_with_capital_raise_price_discovery_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.direct_listing_with_capital_raise_price_discovery_message, buffer(offset, 0))
    local index = nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6 = {}

-- Size: Timestamp Timestamp 6
nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.size = 6

-- Display: Timestamp Timestamp 6
nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.display = function(value)
  return "Timestamp Timestamp 6: "..value
end

-- Dissect: Timestamp Timestamp 6
nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.dissect = function(buffer, offset, packet, parent)
  local length = nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.size
  local range = buffer(offset, length)
  local value = range:uint64()
  local display = nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.display(value, buffer, offset, packet, parent)

  parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.timestamp_timestamp_6, range, value, display)
...
nasdaq_nsmequities_noi_itch_v3_0.ipo_quoting_period_update_message.size =
  nasdaq_nsmequities_noi_itch_v3_0.tracking_number.size + 
  nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.size + 
  nasdaq_nsmequities_noi_itch_v3_0.stock.size + 
...
nasdaq_nsmequities_noi_itch_v3_0.ipo_quoting_period_update_message.fields = function(buffer, offset, packet, parent)
  ...
  index, timestamp_timestamp_6 = nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.dissect(buffer, index, packet, parent)
...
nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message = {}

-- Size: Net Order Imbalance Indicator Message
nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.size =
  nasdaq_nsmequities_noi_itch_v3_0.tracking_number.size + 
  nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.size + 
...
nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Net Order Imbalance Indicator Message
nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.dissect = function(buffer, offset, packet, parent)
  if show.net_order_imbalance_indicator_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.net_order_imbalance_indicator_message, buffer(offset, 0))
    local index = nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message = {}

-- Size: Reg Sho Short Sale Price Test Restricted Indicator Message
nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.size =
  nasdaq_nsmequities_noi_itch_v3_0.tracking_number.size + 
  nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.size + 
  nasdaq_nsmequities_noi_itch_v3_0.stock.size + 
...
nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Reg Sho Short Sale Price Test Restricted Indicator Message
nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.dissect = function(buffer, offset, packet, parent)
  if show.reg_sho_short_sale_price_test_restricted_indicator_message then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.reg_sho_short_sale_price_test_restricted_indicator_message, buffer(offset, 0))
    local index = nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.fields(buffer, offset, packet, parent)
  end
end
...
-- System Event
nasdaq_nsmequities_noi_itch_v3_0.system_event = {}

-- Size: System Event
nasdaq_nsmequities_noi_itch_v3_0.system_event.size =
  nasdaq_nsmequities_noi_itch_v3_0.tracking_number.size + 
  nasdaq_nsmequities_noi_itch_v3_0.timestamp_timestamp_6.size + 
  nasdaq_nsmequities_noi_itch_v3_0.event_code.size

-- Display: System Event
nasdaq_nsmequities_noi_itch_v3_0.system_event.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: System Event
nasdaq_nsmequities_noi_itch_v3_0.system_event.fields = function(buffer, offset, packet, parent)
  local index = offset
...
nasdaq_nsmequities_noi_itch_v3_0.system_event.dissect = function(buffer, offset, packet, parent)
  if show.system_event then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.system_event, buffer(offset, 0))
    local index = nasdaq_nsmequities_noi_itch_v3_0.system_event.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = nasdaq_nsmequities_noi_itch_v3_0.system_event.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return nasdaq_nsmequities_noi_itch_v3_0.system_event.fields(buffer, offset, packet, parent)
  end
end
...
nasdaq_nsmequities_noi_itch_v3_0.payload.size = function(buffer, offset, message_type)
  ...
  if message_type == "S" then
    return nasdaq_nsmequities_noi_itch_v3_0.system_event.size
  end
  -- Size of Stock Directory Message
  if message_type == "R" then
    return nasdaq_nsmequities_noi_itch_v3_0.stock_directory_message.size
  end
  -- Size of Stock Trading Action Message
  if message_type == "H" then
    return nasdaq_nsmequities_noi_itch_v3_0.stock_trading_action_message.size
  end
  -- Size of Reg Sho Short Sale Price Test Restricted Indicator Message
  if message_type == "Y" then
    return nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.size
  end
  -- Size of Net Order Imbalance Indicator Message
  if message_type == "I" then
    return nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.size
  end
  -- Size of Cross Trade Message
  if message_type == "Q" then
    return nasdaq_nsmequities_noi_itch_v3_0.cross_trade_message.size
  end
  -- Size of Ipo Quoting Period Update Message
  if message_type == "K" then
    return nasdaq_nsmequities_noi_itch_v3_0.ipo_quoting_period_update_message.size
  end
  -- Size of Direct Listing With Capital Raise Price Discovery Message
  if message_type == "O" then
    return nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.size
  end
...
nasdaq_nsmequities_noi_itch_v3_0.payload.branches = function(buffer, offset, packet, parent, message_type)
  -- Dissect System Event
  if message_type == "S" then
    return nasdaq_nsmequities_noi_itch_v3_0.system_event.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Stock Directory Message
  if message_type == "R" then
  ...
  -- Dissect Reg Sho Short Sale Price Test Restricted Indicator Message
  if message_type == "Y" then
    return nasdaq_nsmequities_noi_itch_v3_0.reg_sho_short_sale_price_test_restricted_indicator_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Net Order Imbalance Indicator Message
  if message_type == "I" then
    return nasdaq_nsmequities_noi_itch_v3_0.net_order_imbalance_indicator_message.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Cross Trade Message
  if message_type == "Q" then
  ...
  -- Dissect Direct Listing With Capital Raise Price Discovery Message
  if message_type == "O" then
    return nasdaq_nsmequities_noi_itch_v3_0.direct_listing_with_capital_raise_price_discovery_message.dissect(buffer, offset, packet, parent)
  end
...
nasdaq_nsmequities_noi_itch_v3_0.message.size = function(buffer, offset)
  local index = offset
...
nasdaq_nsmequities_noi_itch_v3_0.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = nasdaq_nsmequities_noi_itch_v3_0.message.size(buffer, offset)
...
-- Messages
nasdaq_nsmequities_noi_itch_v3_0.messages = {}

-- Dissect Branches: Messages
nasdaq_nsmequities_noi_itch_v3_0.messages.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  ...
  for message_index = 1, message_count do
    ...
    offset = nasdaq_nsmequities_noi_itch_v3_0.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
-- Dissect: Messages
nasdaq_nsmequities_noi_itch_v3_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  return nasdaq_nsmequities_noi_itch_v3_0.messages.branches(buffer, offset, packet, parent, message_count)
end
...
nasdaq_nsmequities_noi_itch_v3_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_nsmequities_noi_itch_v3_0.messages.dissect(buffer, index, packet, parent, message_count)
