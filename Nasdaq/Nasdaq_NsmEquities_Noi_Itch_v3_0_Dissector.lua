...
-- Dissect: Message
nasdaq_nsmequities_noi_itch_v3_0.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_nasdaq_nsmequities_noi_itch_v3_0.fields.message, range, display)
  end
