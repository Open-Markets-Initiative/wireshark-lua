...
nasdaq_nsmequities_noi_itch_v3_0.payload.size = function(buffer, offset, message_type)
  ...
  if message_type == "S" then
    return nasdaq_nsmequities_noi_itch_v3_0.system_event_message.size
  end
  ...
  if message_type == "Y" then
    return nasdaq_nsmequities_noi_itch_v3_0.reg_sho_restriction_message.size
  end
  -- Size of Noii Message
  if message_type == "I" then
    return nasdaq_nsmequities_noi_itch_v3_0.noii_message.size
  end
...
-- Message Block
nasdaq_nsmequities_noi_itch_v3_0.message_block = {}

-- Size: Message Block
nasdaq_nsmequities_noi_itch_v3_0.message_block.size = function(buffer, offset, message_count)
  -- Size of Heartbeat
...
nasdaq_nsmequities_noi_itch_v3_0.message_block.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
  end
...
nasdaq_nsmequities_noi_itch_v3_0.message_block.dissect = function(buffer, offset, packet, parent, message_count)
  return nasdaq_nsmequities_noi_itch_v3_0.message_block.branches(buffer, offset, packet, parent, message_count)
end
...
nasdaq_nsmequities_noi_itch_v3_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_nsmequities_noi_itch_v3_0.message_block.dissect(buffer, index, packet, parent, message_count)
