...
nasdaq_nsmequities_noi_itch_v3_0_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message, message_index)
  local index = offset
...
-- Dissect: Message
nasdaq_nsmequities_noi_itch_v3_0_dissect.message = function(buffer, offset, packet, parent, size_of_message, message_index)
  ...
  if show.message then
    ...
    -- Skip element, add fields directly
    nasdaq_nsmequities_noi_itch_v3_0_dissect.message_fields(buffer, offset, packet, parent, size_of_message, message_index)
...
nasdaq_nsmequities_noi_itch_v3_0_dissect.packet = function(buffer, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = nasdaq_nsmequities_noi_itch_v3_0_dissect.message(buffer, index, packet, parent, size_of_message, message_index)
  end
