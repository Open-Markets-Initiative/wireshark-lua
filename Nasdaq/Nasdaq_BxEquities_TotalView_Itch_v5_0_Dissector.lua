...
-----------------------------------------------------------------------
-- Nasdaq BxEquities TotalView Itch 5.0 Formatting
-----------------------------------------------------------------------
...
nasdaq_bxequities_totalview_itch_v5_0.timestamp_format = 2

-- Hours behind UTC (EST) for midnight calculation
nasdaq_bxequities_totalview_itch_v5_0.utc_offset_hours = 5
...
omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.resolve_records = Pref.bool("Stock Directory Message", show.records, "Cache records and resolve cross-packet lookups")
omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.timestamp_format = Pref.enum("Timestamp Format", 2, "Timestamp display format", timestamp_format_enum, false)
omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.utc_offset_hours = Pref.uint("UTC Offset (hours)", 5, "Hours behind UTC (EST) for midnight calculation")

-- Handle changed preferences
function omi_nasdaq_bxequities_totalview_itch_v5_0.prefs_changed()

  -- Check if preferences have changed
  if show.records ~= omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.resolve_records then
    show.records = omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.resolve_records
  end
  if show.application_messages ~= omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.show_application_messages then
    show.application_messages = omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.show_message_index then
    show.message_index = omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.show_message_index
  end
  if nasdaq_bxequities_totalview_itch_v5_0.timestamp_format ~= omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.timestamp_format then
    nasdaq_bxequities_totalview_itch_v5_0.timestamp_format = omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.timestamp_format
  end
  if nasdaq_bxequities_totalview_itch_v5_0.utc_offset_hours ~= omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.utc_offset_hours then
    nasdaq_bxequities_totalview_itch_v5_0.utc_offset_hours = omi_nasdaq_bxequities_totalview_itch_v5_0.prefs.utc_offset_hours
  end
end
...
nasdaq_bxequities_totalview_itch_v5_0.conversation = {}
nasdaq_bxequities_totalview_itch_v5_0.conversation.flows = {}

-- Conversation key for the current packet (src/dst tuple)
nasdaq_bxequities_totalview_itch_v5_0.conversation.key = function(packet)
  return string.format("%s|%s|%s|%s", tostring(packet.src), packet.src_port, tostring(packet.dst), packet.dst_port)
end


-- Get/create our protocol's data record for the current packet's flow
nasdaq_bxequities_totalview_itch_v5_0.conversation.data = function(packet)
  local key = nasdaq_bxequities_totalview_itch_v5_0.conversation.key(packet)
  local data = nasdaq_bxequities_totalview_itch_v5_0.conversation.flows[key]
  if data == nil then
    data = { stock_directory_message = {} }
    nasdaq_bxequities_totalview_itch_v5_0.conversation.flows[key] = data
  end
  return data
end
...
nasdaq_bxequities_totalview_itch_v5_0.conversation.current = nil
...
nasdaq_bxequities_totalview_itch_v5_0.locate_code.dissect = function(buffer, offset, packet, parent)
  ...
  local record = nasdaq_bxequities_totalview_itch_v5_0.conversation.current.stock_directory_message[value]
  if record ~= nil and record.stock ~= nil then
    display = "Locate Code: " .. tostring(record.stock) .. " (" .. tostring(value) .. ")"
  end

  local field_tree = parent:add(omi_nasdaq_bxequities_totalview_itch_v5_0.fields.locate_code, range, value, display)

  if record ~= nil then
    nasdaq_bxequities_totalview_itch_v5_0.stock_directory_message.current = record
...
nasdaq_bxequities_totalview_itch_v5_0.stock_locate.dissect = function(buffer, offset, packet, parent)
  ...
  local field_tree = parent:add(omi_nasdaq_bxequities_totalview_itch_v5_0.fields.stock_locate, range, value, display)
...
-- Display: Timestamp
nasdaq_bxequities_totalview_itch_v5_0.timestamp.display = function(value, buffer, offset, packet, parent)
  -- Raw display mode
  if nasdaq_bxequities_totalview_itch_v5_0.timestamp_format == 0 then
  ...
  if nasdaq_bxequities_totalview_itch_v5_0.timestamp_format == 2 and packet then
    local capture_time = type(packet.abs_ts) == "number" and packet.abs_ts or packet.abs_ts:tonumber()
    local utc_offset_seconds = nasdaq_bxequities_totalview_itch_v5_0.utc_offset_hours * 3600
...
nasdaq_bxequities_totalview_itch_v5_0.retail_interest_message.fields = function(buffer, offset, packet, parent)
  ...
  index, stock_locate, stock_locate_record = nasdaq_bxequities_totalview_itch_v5_0.stock_locate.dissect(buffer, index, packet, parent)
...
nasdaq_bxequities_totalview_itch_v5_0.reg_sho_short_sale_price_test_restricted_indicator_message.fields = function(buffer, offset, packet, parent)
  ...
  index, locate_code, locate_code_record = nasdaq_bxequities_totalview_itch_v5_0.locate_code.dissect(buffer, index, packet, parent)
...
nasdaq_bxequities_totalview_itch_v5_0.stock_directory_message.fields = function(buffer, offset, packet, parent)
  ...
  if show.records and not packet.visited then
    nasdaq_bxequities_totalview_itch_v5_0.conversation.current.stock_directory_message[stock_locate] = {
...
nasdaq_bxequities_totalview_itch_v5_0.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  for message_index = 1, message_count do
    ...
    offset = nasdaq_bxequities_totalview_itch_v5_0.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
nasdaq_bxequities_totalview_itch_v5_0.packet.requiredsize = function(buffer)
  return buffer:len() >= nasdaq_bxequities_totalview_itch_v5_0.packet_header.size
end
...
nasdaq_bxequities_totalview_itch_v5_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = nasdaq_bxequities_totalview_itch_v5_0.messages.dissect(buffer, index, packet, parent, message_count)
...
-- Dissector Heuristic for Nasdaq BxEquities TotalView Itch 5.0 (Udp)
local function omi_nasdaq_bxequities_totalview_itch_v5_0_udp_heuristic(buffer, packet, parent)
...
omi_nasdaq_bxequities_totalview_itch_v5_0:register_heuristic("udp", omi_nasdaq_bxequities_totalview_itch_v5_0_udp_heuristic)

-- Register Nasdaq BxEquities TotalView Itch 5.0 on default port
