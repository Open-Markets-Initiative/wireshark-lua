...
nasdaq_bxequities_totalview_itch_v5_0.broken_trade_order_execution_message.size =
  nasdaq_bxequities_totalview_itch_v5_0.stock_locate.size + 
  nasdaq_bxequities_totalview_itch_v5_0.tracking_number.size + 
  nasdaq_bxequities_totalview_itch_v5_0.timestamp.size + 
...
nasdaq_bxequities_totalview_itch_v5_0.add_order_no_mpid_attribution.size =
  ...
  nasdaq_bxequities_totalview_itch_v5_0.shares.size + 
  nasdaq_bxequities_totalview_itch_v5_0.stock.size + 
  nasdaq_bxequities_totalview_itch_v5_0.price_4.size
...
nasdaq_bxequities_totalview_itch_v5_0.stock_trading_action.size =
  ...
  nasdaq_bxequities_totalview_itch_v5_0.reason.size
...
nasdaq_bxequities_totalview_itch_v5_0.payload.size = function(buffer, offset, message_type)
  ...
  if message_type == "S" then
    return nasdaq_bxequities_totalview_itch_v5_0.system_event_message.size
  end
  ...
  if message_type == "V" then
    return nasdaq_bxequities_totalview_itch_v5_0.mwcb_decline_level_message.size
  end
  ...
  if message_type == "E" then
    return nasdaq_bxequities_totalview_itch_v5_0.order_executed_message.size
  end
  -- Size of Order Executed With Price Message
  if message_type == "C" then
    return nasdaq_bxequities_totalview_itch_v5_0.order_executed_with_price_message.size
  end
  -- Size of Order Cancel Message
  if message_type == "X" then
    return nasdaq_bxequities_totalview_itch_v5_0.order_cancel_message.size
  end
  -- Size of Order Delete Message
  if message_type == "D" then
    return nasdaq_bxequities_totalview_itch_v5_0.order_delete_message.size
  end
  -- Size of Order Replace Message
  if message_type == "U" then
    return nasdaq_bxequities_totalview_itch_v5_0.order_replace_message.size
  end
  -- Size of Non Cross Trade Message
  if message_type == "P" then
    return nasdaq_bxequities_totalview_itch_v5_0.non_cross_trade_message.size
  end
  -- Size of Cross Trade Message
  if message_type == "Q" then
    return nasdaq_bxequities_totalview_itch_v5_0.cross_trade_message.size
  end
  -- Size of Broken Trade Order Execution Message
  if message_type == "B" then
    return nasdaq_bxequities_totalview_itch_v5_0.broken_trade_order_execution_message.size
  end
  -- Size of Net Order Imbalance Indicator Message
  if message_type == "I" then
    return nasdaq_bxequities_totalview_itch_v5_0.net_order_imbalance_indicator_message.size
  end
