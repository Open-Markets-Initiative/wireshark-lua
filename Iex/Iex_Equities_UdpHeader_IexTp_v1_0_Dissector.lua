...
-- Message Block
iex_equities_udpheader_iextp_v1_0.message_block = {}

-- Size: Message Block
iex_equities_udpheader_iextp_v1_0.message_block.size = function(buffer, offset, message_count)
  -- Size of Heartbeat
...
iex_equities_udpheader_iextp_v1_0.message_block.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
  end
  ...
  for message_index = 1, message_count do
    ...
    offset = iex_equities_udpheader_iextp_v1_0.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
iex_equities_udpheader_iextp_v1_0.message_block.dissect = function(buffer, offset, packet, parent, message_count)
  return iex_equities_udpheader_iextp_v1_0.message_block.branches(buffer, offset, packet, parent, message_count)
end
...
iex_equities_udpheader_iextp_v1_0.packet.dissect = function(buffer, packet, parent)
  ...
  index = iex_equities_udpheader_iextp_v1_0.message_block.dissect(buffer, index, packet, parent, message_count)
