...
omi_iex_equities_tops_iextp_v1_5_6.fields.symbol_availability = ProtoField.new("Symbol Availability", "iex.equities.tops.iextp.v1.5.6.symbolavailability", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, 0x80)
