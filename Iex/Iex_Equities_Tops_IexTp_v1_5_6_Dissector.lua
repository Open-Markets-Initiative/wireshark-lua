...
-- Message Block
iex_equities_tops_iextp_v1_5_6.message_block = {}

-- Size: Message Block
iex_equities_tops_iextp_v1_5_6.message_block.size = function(buffer, offset, message_count)
  -- Size of Heartbeat
...
iex_equities_tops_iextp_v1_5_6.message_block.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
  end
...
iex_equities_tops_iextp_v1_5_6.message_block.dissect = function(buffer, offset, packet, parent, message_count)
  return iex_equities_tops_iextp_v1_5_6.message_block.branches(buffer, offset, packet, parent, message_count)
end
...
iex_equities_tops_iextp_v1_5_6.packet.dissect = function(buffer, packet, parent)
  ...
  index = iex_equities_tops_iextp_v1_5_6.message_block.dissect(buffer, index, packet, parent, message_count)
