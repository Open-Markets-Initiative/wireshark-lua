...
iex_equities_tops_iextp_v1_5_6.messages.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
...
iex_equities_tops_iextp_v1_5_6.messages.dissect = function(buffer, offset, packet, parent, message_count)
  return iex_equities_tops_iextp_v1_5_6.messages.branches(buffer, offset, packet, parent, message_count)
end
