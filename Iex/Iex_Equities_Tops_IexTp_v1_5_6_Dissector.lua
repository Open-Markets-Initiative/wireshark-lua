...
-- Dissect: Message
iex_equities_tops_iextp_v1_5_6.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_iex_equities_tops_iextp_v1_5_6.fields.message, range, display)
  end
