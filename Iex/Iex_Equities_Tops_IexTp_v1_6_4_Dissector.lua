...
omi_iex_equities_tops_iextp_v1_6_4.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_iex_equities_tops_iextp_v1_6_4.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Handle changed preferences
function omi_iex_equities_tops_iextp_v1_6_4.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_iex_equities_tops_iextp_v1_6_4.prefs.show_application_messages then
    show.application_messages = omi_iex_equities_tops_iextp_v1_6_4.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_iex_equities_tops_iextp_v1_6_4.prefs.show_message_index then
    show.message_index = omi_iex_equities_tops_iextp_v1_6_4.prefs.show_message_index
  end
end
...
iex_equities_tops_iextp_v1_6_4.message.size = function(buffer, offset)
  local index = offset
...
iex_equities_tops_iextp_v1_6_4.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = iex_equities_tops_iextp_v1_6_4.message.size(buffer, offset)
...
-- Messages
iex_equities_tops_iextp_v1_6_4.messages = {}

-- Dissect: Messages
iex_equities_tops_iextp_v1_6_4.messages.dissect = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  ...
  for message_index = 1, message_count do
    ...
    offset = iex_equities_tops_iextp_v1_6_4.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
...
iex_equities_tops_iextp_v1_6_4.packet.dissect = function(buffer, packet, parent)
  ...
  index = iex_equities_tops_iextp_v1_6_4.messages.dissect(buffer, index, packet, parent, message_count)
