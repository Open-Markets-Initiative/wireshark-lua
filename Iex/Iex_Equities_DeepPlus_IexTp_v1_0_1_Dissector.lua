...
-- Dissect: Message
iex_equities_deepplus_iextp_v1_0_1.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_iex_equities_deepplus_iextp_v1_0_1.fields.message, range, display)
  end
