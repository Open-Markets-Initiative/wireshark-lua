...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.etp = ProtoField.new("Etp", "iex.equities.deepplus.iextp.v1.0.1.etp", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_iex_equities_deepplus_iextp_v1_0_1.fields.extended_hours = ProtoField.new("Extended Hours", "iex.equities.deepplus.iextp.v1.0.1.extendedhours", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.intermarket_sweep = ProtoField.new("Intermarket Sweep", "iex.equities.deepplus.iextp.v1.0.1.intermarketsweep", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.odd_lot = ProtoField.new("Odd Lot", "iex.equities.deepplus.iextp.v1.0.1.oddlot", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.priority = ProtoField.new("Priority", "iex.equities.deepplus.iextp.v1.0.1.priority", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.singleprice_cross_trade = ProtoField.new("Singleprice Cross Trade", "iex.equities.deepplus.iextp.v1.0.1.singlepricecrosstrade", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.test_security = ProtoField.new("Test Security", "iex.equities.deepplus.iextp.v1.0.1.testsecurity", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.trade_through_exempt = ProtoField.new("Trade Through Exempt", "iex.equities.deepplus.iextp.v1.0.1.tradethroughexempt", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_iex_equities_deepplus_iextp_v1_0_1.fields.when_issued = ProtoField.new("When Issued", "iex.equities.deepplus.iextp.v1.0.1.whenissued", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)

-- Iex Equities IexTp DeepPlus 1.0.1 Application Messages
...
iex_equities_deepplus_iextp_v1_0_1.message.size = function(buffer, offset)
  local index = offset
...
iex_equities_deepplus_iextp_v1_0_1.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = iex_equities_deepplus_iextp_v1_0_1.message.size(buffer, offset)
...
-- Message Block
iex_equities_deepplus_iextp_v1_0_1.message_block = {}

-- Size: Message Block
iex_equities_deepplus_iextp_v1_0_1.message_block.size = function(buffer, offset, message_count)
  -- Size of Heartbeat
...
iex_equities_deepplus_iextp_v1_0_1.message_block.branches = function(buffer, offset, packet, parent, message_count)
  -- Dissect Heartbeat
  if message_count == 0 then
  end
...
iex_equities_deepplus_iextp_v1_0_1.message_block.dissect = function(buffer, offset, packet, parent, message_count)
  return iex_equities_deepplus_iextp_v1_0_1.message_block.branches(buffer, offset, packet, parent, message_count)
end
...
iex_equities_deepplus_iextp_v1_0_1.packet.dissect = function(buffer, packet, parent)
  ...
  index = iex_equities_deepplus_iextp_v1_0_1.message_block.dissect(buffer, index, packet, parent, message_count)
