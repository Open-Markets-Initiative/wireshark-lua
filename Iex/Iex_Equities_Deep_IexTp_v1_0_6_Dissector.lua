...
omi_iex_equities_deep_iextp_v1_0_6.fields.iextp_header = ProtoField.new("Iextp Header", "iex.equities.deep.iextp.v1.0.6.iextpheader", ftypes.STRING)
...
-- Iex Equities IexTp Deep 1.0.6 Application Messages
...
omi_iex_equities_deep_iextp_v1_0_6.prefs.show_iextp_header = Pref.bool("Show Iextp Header", show.iextp_header, "Parse and add Iextp Header to protocol tree")
...
function omi_iex_equities_deep_iextp_v1_0_6.prefs_changed()
  ...
  if show.iextp_header ~= omi_iex_equities_deep_iextp_v1_0_6.prefs.show_iextp_header then
    show.iextp_header = omi_iex_equities_deep_iextp_v1_0_6.prefs.show_iextp_header
    changed = true
  end
...
iex_equities_deep_iextp_v1_0_6.sale_condition_flags.display = function(range, value, packet, parent)
  local flags = {}
...
iex_equities_deep_iextp_v1_0_6.sale_condition_flags.bits = function(range, value, packet, parent)

  -- Unused 3: 3 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.unused_3, range, value)

  -- Singleprice Cross Trade: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.singleprice_cross_trade, range, value)

  -- Trade Through Exempt: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.trade_through_exempt, range, value)

  -- Odd Lot: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.odd_lot, range, value)

  -- Extended Hours: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.extended_hours, range, value)

  -- Intermarket Sweep: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.intermarket_sweep, range, value)
end
...
iex_equities_deep_iextp_v1_0_6.sale_condition_flags.dissect = function(buffer, offset, packet, parent)
  local size = iex_equities_deep_iextp_v1_0_6.sale_condition_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = iex_equities_deep_iextp_v1_0_6.sale_condition_flags.display(range, value, packet, parent)
  ...
  if show.sale_condition_flags then
    iex_equities_deep_iextp_v1_0_6.sale_condition_flags.bits(range, value, packet, element)
  end
...
iex_equities_deep_iextp_v1_0_6.security_directory_flags.display = function(range, value, packet, parent)
  local flags = {}
...
iex_equities_deep_iextp_v1_0_6.security_directory_flags.bits = function(range, value, packet, parent)

  -- Unused 5: 5 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.unused_5, range, value)

  -- Etp: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.etp, range, value)

  -- When Issued: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.when_issued, range, value)

  -- Test Security: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.test_security, range, value)
end
...
iex_equities_deep_iextp_v1_0_6.security_directory_flags.dissect = function(buffer, offset, packet, parent)
  local size = iex_equities_deep_iextp_v1_0_6.security_directory_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = iex_equities_deep_iextp_v1_0_6.security_directory_flags.display(range, value, packet, parent)
  ...
  if show.security_directory_flags then
    iex_equities_deep_iextp_v1_0_6.security_directory_flags.bits(range, value, packet, element)
  end
...
-- Iextp Header
iex_equities_deep_iextp_v1_0_6.iextp_header = {}

-- Size: Iextp Header
iex_equities_deep_iextp_v1_0_6.iextp_header.size =
...
iex_equities_deep_iextp_v1_0_6.iextp_header.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Iextp Header
iex_equities_deep_iextp_v1_0_6.iextp_header.fields = function(buffer, offset, packet, parent)
  local index = offset
...
iex_equities_deep_iextp_v1_0_6.iextp_header.dissect = function(buffer, offset, packet, parent)
  if show.iextp_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_iex_equities_deep_iextp_v1_0_6.fields.iextp_header, buffer(offset, 0))
    local index = iex_equities_deep_iextp_v1_0_6.iextp_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = iex_equities_deep_iextp_v1_0_6.iextp_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return iex_equities_deep_iextp_v1_0_6.iextp_header.fields(buffer, offset, packet, parent)
  end
end
...
iex_equities_deep_iextp_v1_0_6.packet.dissect = function(buffer, packet, parent)
  ...
  index, iextp_header = iex_equities_deep_iextp_v1_0_6.iextp_header.dissect(buffer, index, packet, parent)
