...
iex_equities_tops_iextp_v1_6_6_dissect.message_fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
iex_equities_tops_iextp_v1_6_6_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  -- Optionally add struct element to protocol tree
  if show.message then
    local range = buffer(offset, size_of_message)
    local display = iex_equities_tops_iextp_v1_6_6_display.message(buffer, packet, parent)
    parent = parent:add(iex_equities_tops_iextp_v1_6_6.fields.message, range, display)
  end

  iex_equities_tops_iextp_v1_6_6_dissect.message_fields(buffer, offset, packet, parent, size_of_message)
...
iex_equities_tops_iextp_v1_6_6_dissect.packet = function(buffer, packet, parent)
  ...
  for i = 1, message_count do
    ...
    -- Message: Struct of 2 fields
    index = iex_equities_tops_iextp_v1_6_6_dissect.message(buffer, index, packet, parent, size_of_message)
  end
