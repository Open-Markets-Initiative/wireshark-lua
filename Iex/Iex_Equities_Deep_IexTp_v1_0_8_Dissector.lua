...
omi_iex_equities_deep_iextp_v1_0_8.fields.etp = ProtoField.new("Etp", "iex.equities.deep.iextp.v1.0.8.etp", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_iex_equities_deep_iextp_v1_0_8.fields.extended_hours = ProtoField.new("Extended Hours", "iex.equities.deep.iextp.v1.0.8.extendedhours", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_iex_equities_deep_iextp_v1_0_8.fields.intermarket_sweep = ProtoField.new("Intermarket Sweep", "iex.equities.deep.iextp.v1.0.8.intermarketsweep", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_iex_equities_deep_iextp_v1_0_8.fields.odd_lot = ProtoField.new("Odd Lot", "iex.equities.deep.iextp.v1.0.8.oddlot", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_iex_equities_deep_iextp_v1_0_8.fields.singleprice_cross_trade = ProtoField.new("Singleprice Cross Trade", "iex.equities.deep.iextp.v1.0.8.singlepricecrosstrade", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_iex_equities_deep_iextp_v1_0_8.fields.test_security = ProtoField.new("Test Security", "iex.equities.deep.iextp.v1.0.8.testsecurity", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_iex_equities_deep_iextp_v1_0_8.fields.trade_through_exempt = ProtoField.new("Trade Through Exempt", "iex.equities.deep.iextp.v1.0.8.tradethroughexempt", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_iex_equities_deep_iextp_v1_0_8.fields.when_issued = ProtoField.new("When Issued", "iex.equities.deep.iextp.v1.0.8.whenissued", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)

-- Iex Equities IexTp Deep 1.0.8 Application Messages
...
omi_iex_equities_deep_iextp_v1_0_8.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_iex_equities_deep_iextp_v1_0_8.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Handle changed preferences
function omi_iex_equities_deep_iextp_v1_0_8.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_iex_equities_deep_iextp_v1_0_8.prefs.show_application_messages then
    show.application_messages = omi_iex_equities_deep_iextp_v1_0_8.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_iex_equities_deep_iextp_v1_0_8.prefs.show_message_index then
    show.message_index = omi_iex_equities_deep_iextp_v1_0_8.prefs.show_message_index
  end
end
...
iex_equities_deep_iextp_v1_0_8.sale_condition_flags.display = function(range, value, packet, parent)
  local flags = {}
...
iex_equities_deep_iextp_v1_0_8.sale_condition_flags.bits = function(range, value, packet, parent)

  -- Unused 3: 3 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.unused_3, range, value)

  -- Singleprice Cross Trade: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.singleprice_cross_trade, range, value)

  -- Trade Through Exempt: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.trade_through_exempt, range, value)

  -- Odd Lot: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.odd_lot, range, value)

  -- Extended Hours: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.extended_hours, range, value)

  -- Intermarket Sweep: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.intermarket_sweep, range, value)
end
...
iex_equities_deep_iextp_v1_0_8.sale_condition_flags.dissect = function(buffer, offset, packet, parent)
  local size = iex_equities_deep_iextp_v1_0_8.sale_condition_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = iex_equities_deep_iextp_v1_0_8.sale_condition_flags.display(range, value, packet, parent)
  ...
  if show.sale_condition_flags then
    iex_equities_deep_iextp_v1_0_8.sale_condition_flags.bits(range, value, packet, element)
  end
...
iex_equities_deep_iextp_v1_0_8.security_directory_flags.display = function(range, value, packet, parent)
  local flags = {}
...
iex_equities_deep_iextp_v1_0_8.security_directory_flags.bits = function(range, value, packet, parent)

  -- Unused 5: 5 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.unused_5, range, value)

  -- Etp: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.etp, range, value)

  -- When Issued: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.when_issued, range, value)

  -- Test Security: 1 Bit
  parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.test_security, range, value)
end
...
iex_equities_deep_iextp_v1_0_8.security_directory_flags.dissect = function(buffer, offset, packet, parent)
  local size = iex_equities_deep_iextp_v1_0_8.security_directory_flags.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = iex_equities_deep_iextp_v1_0_8.security_directory_flags.display(range, value, packet, parent)
  ...
  if show.security_directory_flags then
    iex_equities_deep_iextp_v1_0_8.security_directory_flags.bits(range, value, packet, element)
  end
...
iex_equities_deep_iextp_v1_0_8.message.size = function(buffer, offset)
  local index = offset
...
iex_equities_deep_iextp_v1_0_8.message.dissect = function(buffer, offset, packet, parent, size_of_message, message_index)
  local size_of_message = iex_equities_deep_iextp_v1_0_8.message.size(buffer, offset)
...
iex_equities_deep_iextp_v1_0_8.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  for message_index = 1, message_count do
    ...
    offset = iex_equities_deep_iextp_v1_0_8.message.dissect(buffer, offset, packet, parent, size_of_message, message_index)
  end
