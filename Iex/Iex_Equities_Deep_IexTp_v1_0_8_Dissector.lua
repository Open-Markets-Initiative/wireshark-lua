...
-- Dissect: Message
iex_equities_deep_iextp_v1_0_8.message.dissect = function(buffer, offset, packet, parent)
  -- Parse runtime size
  ...
  if show.message then
    ...
    parent = parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.message, range, display)
  end
