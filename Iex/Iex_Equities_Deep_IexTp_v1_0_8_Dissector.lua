...
omi_iex_equities_deep_iextp_v1_0_8.fields.iex_tp_header = ProtoField.new("Iex Tp Header", "iex.equities.deep.iextp.v1.0.8.iextpheader", ftypes.STRING)
...
omi_iex_equities_deep_iextp_v1_0_8.prefs.show_iex_tp_header = Pref.bool("Show Iex Tp Header", show.iex_tp_header, "Parse and add Iex Tp Header to protocol tree")
...
function omi_iex_equities_deep_iextp_v1_0_8.prefs_changed()
  ...
  if show.iex_tp_header ~= omi_iex_equities_deep_iextp_v1_0_8.prefs.show_iex_tp_header then
    show.iex_tp_header = omi_iex_equities_deep_iextp_v1_0_8.prefs.show_iex_tp_header
    changed = true
  end
...
iex_equities_deep_iextp_v1_0_8_dissect.iex_tp_header = function(buffer, offset, packet, parent)
  if show.iex_tp_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_iex_equities_deep_iextp_v1_0_8.fields.iex_tp_header, buffer(offset, 0))
...
verify.omi_iex_equities_deep_iextp_v1_0_8_packet_size = function(buffer)
...
local function omi_iex_equities_deep_iextp_v1_0_8_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_iex_equities_deep_iextp_v1_0_8_packet_size(buffer) then return false end
