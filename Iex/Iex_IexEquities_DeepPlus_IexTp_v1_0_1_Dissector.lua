...
local omi_iex_iexequities_deepplus_iextp_v1_0_1 = Proto("Omi.Iex.IexEquities.DeepPlus.IexTp.v1.0.1", "Iex IexEquities DeepPlus IexTp 1.0.1")
...
omi_iex_iexequities_deepplus_iextp_v1_0_1.fields.short_sale_price_test_status = ProtoField.new("Short Sale Price Test Status", "iex.iexequities.deepplus.iextp.v1.0.1.shortsalepriceteststatus", ftypes.UINT8)
...
omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_headers = Pref.bool("Show Headers", show.headers, "Parse and add Headers to protocol tree")
omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_structs = Pref.bool("Show Structs", show.structs, "Parse and add Structs to protocol tree")
omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_indexes = Pref.bool("Show Indexes", show.indexes, "Show generated repeating group index counts in the protocol tree")
...
function omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs_changed()
  ...
  if show.headers ~= omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_headers then
    show.headers = omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_headers
  end
  if show.structs ~= omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_structs then
    show.structs = omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_structs
  end
  if show.indexes ~= omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_indexes then
    show.indexes = omi_iex_iexequities_deepplus_iextp_v1_0_1.prefs.show_indexes
  end
end
...
iex_iexequities_deepplus_iextp_v1_0_1.message_protocol_id.display = function(value)
  if value == 32773 then
    return "Message Protocol Id: Iex Deep Plus"
  end
...
-- Heartbeat
iex_iexequities_deepplus_iextp_v1_0_1.heartbeat = {}

-- Display: Heartbeat
iex_iexequities_deepplus_iextp_v1_0_1.heartbeat.display = function(packet, parent, length)
  return "Heartbeat"
end


-- Dissect: Heartbeat
iex_iexequities_deepplus_iextp_v1_0_1.heartbeat.dissect = function(buffer, offset, packet, parent)
  local display = iex_iexequities_deepplus_iextp_v1_0_1.heartbeat.display(packet, parent, 0)
...
iex_iexequities_deepplus_iextp_v1_0_1.messages.dissect = function(buffer, offset, packet, parent, message_count)
  ...
  if message_count == 0 then
    return iex_iexequities_deepplus_iextp_v1_0_1.heartbeat.dissect(buffer, offset, packet, parent)
  end
  -- Repeating: Message
...
iex_iexequities_deepplus_iextp_v1_0_1.message_protocol_id.verify = function(buffer)
...
local function omi_iex_iexequities_deepplus_iextp_v1_0_1_udp_heuristic(buffer, packet, parent)
  ...
  if not iex_iexequities_deepplus_iextp_v1_0_1.message_protocol_id.verify(buffer) then return false end
...
-- Register Iex IexEquities DeepPlus IexTp 1.0.1 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_iex_iexequities_deepplus_iextp_v1_0_1)
