...
iex_equities_tops_iextp_v1_6_6_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(iex_equities_tops_iextp_v1_6_6.fields.message, buffer(offset, 0))
    local current = iex_equities_tops_iextp_v1_6_6_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = iex_equities_tops_iextp_v1_6_6_display.message(buffer, packet, element)
    element:append_text(display)
...
iex_equities_tops_iextp_v1_6_6_dissect.packet = function(buffer, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = iex_equities_tops_iextp_v1_6_6_dissect.message(buffer, index, packet, parent, size_of_message)

    if message ~= nil then
      local iteration = message:add(iex_equities_tops_iextp_v1_6_6.fields.message_index, message_index)
