...
cme_futures_ilink3_sbe_v8_7.fields.price_optional = ProtoField.new("Price Optional", "cme.futures.ilink3.sbe.v8.7.priceoptional", ftypes.INT64)
...
display.ord_type_optional = function(value)
  ...
  if value == "0" then
    return "Ord Type Optional: No Value (0)"
  end
