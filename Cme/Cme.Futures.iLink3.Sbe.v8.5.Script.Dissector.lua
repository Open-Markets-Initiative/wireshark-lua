...
cme_futures_ilink3_sbe_v8_5.fields.cmta_give_up_cd = ProtoField.new("Cmta Give Up Cd", "cme.futures.ilink3.sbe.v8.5.cmtagiveupcd", ftypes.STRING)
...
cme_futures_ilink3_sbe_v8_5.fields.mantissa32 = ProtoField.new("Mantissa32", "cme.futures.ilink3.sbe.v8.5.mantissa32", ftypes.INT32)
cme_futures_ilink3_sbe_v8_5.fields.mantissa64 = ProtoField.new("Mantissa64", "cme.futures.ilink3.sbe.v8.5.mantissa64", ftypes.INT64)
...
size_of.no_processed_entries = 4
...
dissect.mantissa32 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_5.fields.mantissa32, range, value, display)
...
size_of.no_processed_quotes = 1

-- Display: No Processed Quotes
display.no_processed_quotes = function(value)
  return "No Processed Quotes: "..value
end

-- Dissect: No Processed Quotes
dissect.no_processed_quotes = function(buffer, offset, packet, parent)
  local length = size_of.no_processed_quotes
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.no_processed_quotes(value, buffer, offset, packet, parent)
...
size_of.mass_quote_ack_545 = function(buffer, offset)
  ...
  index = index + size_of.no_processed_quotes
...
dissect.mass_quote_ack_545_fields = function(buffer, offset, packet, parent)
  ...
  index, no_processed_quotes = dissect.no_processed_quotes(buffer, index, packet, parent)
...
dissect.cmta_give_up_cd = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_5.fields.cmta_give_up_cd, range, value, display)
...
dissect.mantissa64 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_5.fields.mantissa64, range, value, display)
