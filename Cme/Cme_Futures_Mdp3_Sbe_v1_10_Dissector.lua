...
cme_futures_mdp3_sbe_v1_10_dissect.snapshot_full_refresh_tcp_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.snapshot_full_refresh_tcp_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.security_status_workup_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.security_status_workup_order_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.snapshot_refresh_top_orders_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.snapshot_refresh_top_orders_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.related_instruments_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.related_instruments_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.underlyings_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.underlyings_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.lot_type_rules_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.lot_type_rules_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.inst_attrib_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.inst_attrib_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_feed_types_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_feed_types_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.events_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.events_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_instrument_definition_spread_leg_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_instrument_definition_spread_leg_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.snapshot_full_refresh_order_book_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.snapshot_full_refresh_order_book_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.snapshot_full_refresh_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.snapshot_full_refresh_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_session_statistics_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_session_statistics_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_limits_banding_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_limits_banding_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_daily_statistics_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_daily_statistics_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_trade_summary_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_trade_summary_order_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_trade_summary_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_trade_summary_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_order_book_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_order_book_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_book_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_book_order_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_book_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_book_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.related_sym_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.related_sym_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_volume_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.m_d_incremental_refresh_volume_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.channel_reset_groups_fields = function(buffer, offset, packet, parent)
  ...
  for i = 1, num_in_group do
    index = cme_futures_mdp3_sbe_v1_10_dissect.channel_reset_group(buffer, index, packet, parent)
  end
...
cme_futures_mdp3_sbe_v1_10_dissect.packet = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    index = cme_futures_mdp3_sbe_v1_10_dissect.message(buffer, index, packet, parent)
  end
