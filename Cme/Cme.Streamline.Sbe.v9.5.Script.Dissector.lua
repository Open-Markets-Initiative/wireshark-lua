...
cme_streamline_sbe_v9_5.fields.final_daily = ProtoField.new("Final Daily", "cme.streamline.sbe.v9.5.finaldaily", ftypes.UINT8, nil, base.DEC, "0x01")
...
cme_streamline_sbe_v9_5.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "cme.streamline.sbe.v9.5.heartbtint", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cme_streamline_sbe_v9_5.fields.last_implied_msg = ProtoField.new("Last Implied Msg", "cme.streamline.sbe.v9.5.lastimpliedmsg", ftypes.UINT8, nil, base.DEC, "0x10")
cme_streamline_sbe_v9_5.fields.last_quote_msg = ProtoField.new("Last Quote Msg", "cme.streamline.sbe.v9.5.lastquotemsg", ftypes.UINT8, nil, base.DEC, "0x04")
cme_streamline_sbe_v9_5.fields.last_stats_msg = ProtoField.new("Last Stats Msg", "cme.streamline.sbe.v9.5.laststatsmsg", ftypes.UINT8, nil, base.DEC, "0x08")
cme_streamline_sbe_v9_5.fields.last_trade_msg = ProtoField.new("Last Trade Msg", "cme.streamline.sbe.v9.5.lasttrademsg", ftypes.UINT8, nil, base.DEC, "0x01")
cme_streamline_sbe_v9_5.fields.last_volume_msg = ProtoField.new("Last Volume Msg", "cme.streamline.sbe.v9.5.lastvolumemsg", ftypes.UINT8, nil, base.DEC, "0x02")
...
cme_streamline_sbe_v9_5.fields.leg_date_offset = ProtoField.new("Leg Date Offset", "cme.streamline.sbe.v9.5.legdateoffset", ftypes.INT8, {[1]="Yes",[0]="No"})
...
cme_streamline_sbe_v9_5.fields.null_value = ProtoField.new("Null Value", "cme.streamline.sbe.v9.5.nullvalue", ftypes.UINT8, nil, base.DEC, "0x80")
...
cme_streamline_sbe_v9_5.fields.reserved = ProtoField.new("Reserved", "cme.streamline.sbe.v9.5.reserved", ftypes.UINT8, nil, base.DEC, "0x40")
...
cme_streamline_sbe_v9_5.fields.rounded = ProtoField.new("Rounded", "cme.streamline.sbe.v9.5.rounded", ftypes.UINT8, nil, base.DEC, "0x04")
...
function cme_streamline_sbe_v9_5.prefs_changed()
  ...
  if show.md_feed_types_group ~= cme_streamline_sbe_v9_5.prefs.show_md_feed_types_group then
    show.md_feed_types_group = cme_streamline_sbe_v9_5.prefs.show_md_feed_types_group
    changed = true
  end
  if show.md_feed_types_groups ~= cme_streamline_sbe_v9_5.prefs.show_md_feed_types_groups then
  ...
  if show.md_incremental_refresh_eris_reference_data_and_daily_statistics_group ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_eris_reference_data_and_daily_statistics_group then
    show.md_incremental_refresh_eris_reference_data_and_daily_statistics_group = cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_eris_reference_data_and_daily_statistics_group
    changed = true
  end
  if show.md_incremental_refresh_eris_reference_data_and_daily_statistics_groups ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_eris_reference_data_and_daily_statistics_groups then
  ...
  if show.md_incremental_refresh_indices_group ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_indices_group then
    show.md_incremental_refresh_indices_group = cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_indices_group
    changed = true
  end
  if show.md_incremental_refresh_indices_groups ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_indices_groups then
  ...
  if show.md_incremental_refresh_otc_group ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_otc_group then
    show.md_incremental_refresh_otc_group = cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_otc_group
    changed = true
  end
  if show.md_incremental_refresh_otc_groups ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_otc_groups then
  ...
  if show.md_incremental_refresh_trade_blocks_group ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_trade_blocks_group then
    show.md_incremental_refresh_trade_blocks_group = cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_trade_blocks_group
    changed = true
  end
  if show.md_incremental_refresh_trade_blocks_groups ~= cme_streamline_sbe_v9_5.prefs.show_md_incremental_refresh_trade_blocks_groups then
...
dissect.md_incremental_refresh_otc_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_otc_group then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_otc_group, range, display)
  end
...
dissect.md_incremental_refresh_otc_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_otc_groups then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_otc_groups, range, display)
  end
...
dissect.md_incremental_refresh_trade_blocks_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_blocks_group then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_trade_blocks_group, range, display)
  end
...
dissect.md_incremental_refresh_trade_blocks_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_blocks_groups then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_trade_blocks_groups, range, display)
  end
...
dissect.md_feed_types_group = function(buffer, offset, packet, parent)
  ...
  if show.md_feed_types_group then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_feed_types_group, range, display)
  end
...
dissect.md_feed_types_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_feed_types_groups then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_feed_types_groups, range, display)
  end
...
dissect.md_incremental_refresh_eris_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_eris_group then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_eris_group, range, display)
  end
...
dissect.md_incremental_refresh_eris_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_eris_groups then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_eris_groups, range, display)
  end
...
dissect.md_incremental_refresh_indices_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_indices_group then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_indices_group, range, display)
  end
...
dissect.md_incremental_refresh_indices_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_indices_groups then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_indices_groups, range, display)
  end
...
dissect.md_incremental_refresh_eris_reference_data_and_daily_statistics_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_eris_reference_data_and_daily_statistics_group then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_eris_reference_data_and_daily_statistics_group, range, display)
  end
...
dissect.md_incremental_refresh_eris_reference_data_and_daily_statistics_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_eris_reference_data_and_daily_statistics_groups then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.md_incremental_refresh_eris_reference_data_and_daily_statistics_groups, range, display)
  end
...
-- Register Cme Streamline Sbe 9.5 Heuristic
