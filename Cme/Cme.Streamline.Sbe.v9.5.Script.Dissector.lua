...
cme_streamline_sbe_v9_5.fields.legs_group = ProtoField.new("Legs Group", "cme.streamline.sbe.v9.5.legsgroup", ftypes.STRING)
cme_streamline_sbe_v9_5.fields.legs_groups = ProtoField.new("Legs Groups", "cme.streamline.sbe.v9.5.legsgroups", ftypes.STRING)
...
cme_streamline_sbe_v9_5.prefs.show_legs_group = Pref.bool("Show Legs Group", show.legs_group, "Parse and add Legs Group to protocol tree")
cme_streamline_sbe_v9_5.prefs.show_legs_groups = Pref.bool("Show Legs Groups", show.legs_groups, "Parse and add Legs Groups to protocol tree")
...
function cme_streamline_sbe_v9_5.prefs_changed()
  ...
  if show.legs_group ~= cme_streamline_sbe_v9_5.prefs.show_legs_group then
    show.legs_group = cme_streamline_sbe_v9_5.prefs.show_legs_group
    changed = true
  end
  if show.legs_groups ~= cme_streamline_sbe_v9_5.prefs.show_legs_groups then
    show.legs_groups = cme_streamline_sbe_v9_5.prefs.show_legs_groups
    changed = true
  end
...
dissect.legs_group = function(buffer, offset, packet, parent)
  ...
  if show.legs_group then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.legs_group, range, display)
  end
...
dissect.legs_groups = function(buffer, offset, packet, parent)
  ...
  if show.legs_groups then
    ...
    parent = parent:add(cme_streamline_sbe_v9_5.fields.legs_groups, range, display)
  end
