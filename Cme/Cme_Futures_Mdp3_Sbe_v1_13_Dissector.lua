...
omi_cme_futures_mdp3_sbe_v1_13.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "cme.futures.mdp3.sbe.v1.13.messagesequencenumber", ftypes.UINT32)
...
cme_futures_mdp3_sbe_v1_13_dissect.message_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(omi_cme_futures_mdp3_sbe_v1_13.fields.message_sequence_number, range, value, display)
...
verify.omi_cme_futures_mdp3_sbe_v1_13_packet_size = function(buffer)
...
local function omi_cme_futures_mdp3_sbe_v1_13_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_cme_futures_mdp3_sbe_v1_13_packet_size(buffer) then return false end
