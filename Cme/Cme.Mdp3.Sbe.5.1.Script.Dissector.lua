...
-- Cme Mdp3 Sbe 5.1 Protocol
local cme_mdp3_sbe_5_1 = Proto("Cme.Mdp3.Sbe.5.1.Lua", "Cme Mdp3 Sbe 5.1")
...
cme_mdp3_sbe_5_1.fields.actual = ProtoField.new("Actual", "cme.mdp3.sbe.5.1.actual", ftypes.UINT8, nil, base.DEC, "0x02")
cme_mdp3_sbe_5_1.fields.admin_login = ProtoField.new("Admin Login", "cme.mdp3.sbe.5.1.adminlogin", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.admin_logout = ProtoField.new("Admin Logout", "cme.mdp3.sbe.5.1.adminlogout", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.aggressor_side = ProtoField.new("Aggressor Side", "cme.mdp3.sbe.5.1.aggressorside", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.appl_id = ProtoField.new("Appl ID", "cme.mdp3.sbe.5.1.applid", ftypes.INT16)
cme_mdp3_sbe_5_1.fields.asset = ProtoField.new("Asset", "cme.mdp3.sbe.5.1.asset", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.block_length = ProtoField.new("block Length", "cme.mdp3.sbe.5.1.blocklength", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.block_length = ProtoField.new("Block Length", "cme.mdp3.sbe.5.1.blocklength", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.block_trade_eligible = ProtoField.new("Block Trade Eligible", "cme.mdp3.sbe.5.1.blocktradeeligible", ftypes.UINT32, nil, base.DEC, "0x00000004")
cme_mdp3_sbe_5_1.fields.cfi_code = ProtoField.new("CFI Code", "cme.mdp3.sbe.5.1.cficode", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.channel_reset = ProtoField.new("Channel Reset", "cme.mdp3.sbe.5.1.channelreset", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.channel_reset_group = ProtoField.new("Channel Reset Group", "cme.mdp3.sbe.5.1.channelresetgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.channel_reset_groups = ProtoField.new("Channel Reset Groups", "cme.mdp3.sbe.5.1.channelresetgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.cleared_volume = ProtoField.new("Cleared Volume", "cme.mdp3.sbe.5.1.clearedvolume", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.contract_multiplier = ProtoField.new("Contract Multiplier", "cme.mdp3.sbe.5.1.contractmultiplier", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.contract_multiplier_unit = ProtoField.new("Contract Multiplier Unit", "cme.mdp3.sbe.5.1.contractmultiplierunit", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.currency = ProtoField.new("Currency", "cme.mdp3.sbe.5.1.currency", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.daily_product_eligibility = ProtoField.new("Daily Product Eligibility", "cme.mdp3.sbe.5.1.dailyproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00020000")
cme_mdp3_sbe_5_1.fields.day = ProtoField.new("day", "cme.mdp3.sbe.5.1.day", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.decay_quantity = ProtoField.new("Decay Quantity", "cme.mdp3.sbe.5.1.decayquantity", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.decay_start_date = ProtoField.new("Decay Start Date", "cme.mdp3.sbe.5.1.decaystartdate", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.decaying_product_eligibility = ProtoField.new("Decaying Product Eligibility", "cme.mdp3.sbe.5.1.decayingproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00008000")
cme_mdp3_sbe_5_1.fields.display_factor = ProtoField.new("Display Factor", "cme.mdp3.sbe.5.1.displayfactor", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.ebf_eligible = ProtoField.new("EBF Eligible", "cme.mdp3.sbe.5.1.ebfeligible", ftypes.UINT32, nil, base.DEC, "0x00000010")
cme_mdp3_sbe_5_1.fields.efp_eligible = ProtoField.new("EFP Eligible", "cme.mdp3.sbe.5.1.efpeligible", ftypes.UINT32, nil, base.DEC, "0x00000008")
cme_mdp3_sbe_5_1.fields.efr_eligible = ProtoField.new("EFR Eligible", "cme.mdp3.sbe.5.1.efreligible", ftypes.UINT32, nil, base.DEC, "0x00000040")
cme_mdp3_sbe_5_1.fields.efs_eligible = ProtoField.new("EFS Eligible", "cme.mdp3.sbe.5.1.efseligible", ftypes.UINT32, nil, base.DEC, "0x00000020")
cme_mdp3_sbe_5_1.fields.electronic_match_eligible = ProtoField.new("Electronic Match Eligible", "cme.mdp3.sbe.5.1.electronicmatcheligible", ftypes.UINT32, nil, base.DEC, "0x00000001")
cme_mdp3_sbe_5_1.fields.end_of_event = ProtoField.new("End Of Event", "cme.mdp3.sbe.5.1.endofevent", ftypes.UINT8, nil, base.DEC, "0x80")
cme_mdp3_sbe_5_1.fields.event_time = ProtoField.new("Event Time", "cme.mdp3.sbe.5.1.eventtime", ftypes.UINT64)
cme_mdp3_sbe_5_1.fields.event_type = ProtoField.new("Event Type", "cme.mdp3.sbe.5.1.eventtype", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.events_group = ProtoField.new("Events Group", "cme.mdp3.sbe.5.1.eventsgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.events_groups = ProtoField.new("Events Groups", "cme.mdp3.sbe.5.1.eventsgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.final = ProtoField.new("Final", "cme.mdp3.sbe.5.1.final", ftypes.UINT8, nil, base.DEC, "0x01")
cme_mdp3_sbe_5_1.fields.flow_schedule_type = ProtoField.new("Flow Schedule Type", "cme.mdp3.sbe.5.1.flowscheduletype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.group_size = ProtoField.new("group Size", "cme.mdp3.sbe.5.1.groupsize", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.group_size8_byte = ProtoField.new("group Size8 Byte", "cme.mdp3.sbe.5.1.groupsize8byte", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.gt_orders_eligibility = ProtoField.new("GT Orders Eligibility", "cme.mdp3.sbe.5.1.gtorderseligibility", ftypes.UINT32, nil, base.DEC, "0x00040000")
cme_mdp3_sbe_5_1.fields.halt_reason = ProtoField.new("Halt Reason", "cme.mdp3.sbe.5.1.haltreason", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "cme.mdp3.sbe.5.1.heartbtint", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.high_limit_price = ProtoField.new("High Limit Price", "cme.mdp3.sbe.5.1.highlimitprice", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.i_link_indicative_mass_quoting_eligible = ProtoField.new("i Link Indicative Mass Quoting Eligible", "cme.mdp3.sbe.5.1.ilinkindicativemassquotingeligible", ftypes.UINT32, nil, base.DEC, "0x00000100")
cme_mdp3_sbe_5_1.fields.implied_matching_eligibility = ProtoField.new("Implied Matching Eligibility", "cme.mdp3.sbe.5.1.impliedmatchingeligibility", ftypes.UINT32, nil, base.DEC, "0x00080000")
cme_mdp3_sbe_5_1.fields.inst_attrib_group = ProtoField.new("Inst Attrib Group", "cme.mdp3.sbe.5.1.instattribgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.inst_attrib_groups = ProtoField.new("Inst Attrib Groups", "cme.mdp3.sbe.5.1.instattribgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.inst_attrib_value = ProtoField.new("Inst Attrib Value", "cme.mdp3.sbe.5.1.instattribvalue", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.intraday = ProtoField.new("Intraday", "cme.mdp3.sbe.5.1.intraday", ftypes.UINT8, nil, base.DEC, "0x08")
cme_mdp3_sbe_5_1.fields.is_fractional = ProtoField.new("Is Fractional", "cme.mdp3.sbe.5.1.isfractional", ftypes.UINT32, nil, base.DEC, "0x00000800")
cme_mdp3_sbe_5_1.fields.last_implied_msg = ProtoField.new("Last Implied Msg", "cme.mdp3.sbe.5.1.lastimpliedmsg", ftypes.UINT8, nil, base.DEC, "0x10")
cme_mdp3_sbe_5_1.fields.last_msg_seq_num_processed = ProtoField.new("Last Msg Seq Num Processed", "cme.mdp3.sbe.5.1.lastmsgseqnumprocessed", ftypes.UINT32)
cme_mdp3_sbe_5_1.fields.last_qty = ProtoField.new("Last Qty", "cme.mdp3.sbe.5.1.lastqty", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.last_quote_msg = ProtoField.new("Last Quote Msg", "cme.mdp3.sbe.5.1.lastquotemsg", ftypes.UINT8, nil, base.DEC, "0x04")
cme_mdp3_sbe_5_1.fields.last_stats_msg = ProtoField.new("Last Stats Msg", "cme.mdp3.sbe.5.1.laststatsmsg", ftypes.UINT8, nil, base.DEC, "0x08")
cme_mdp3_sbe_5_1.fields.last_trade_msg = ProtoField.new("Last Trade Msg", "cme.mdp3.sbe.5.1.lasttrademsg", ftypes.UINT8, nil, base.DEC, "0x01")
cme_mdp3_sbe_5_1.fields.last_update_time = ProtoField.new("Last Update Time", "cme.mdp3.sbe.5.1.lastupdatetime", ftypes.UINT64)
cme_mdp3_sbe_5_1.fields.last_volume_msg = ProtoField.new("Last Volume Msg", "cme.mdp3.sbe.5.1.lastvolumemsg", ftypes.UINT8, nil, base.DEC, "0x02")
cme_mdp3_sbe_5_1.fields.leg_option_delta = ProtoField.new("Leg Option Delta", "cme.mdp3.sbe.5.1.legoptiondelta", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.leg_price = ProtoField.new("Leg Price", "cme.mdp3.sbe.5.1.legprice", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "cme.mdp3.sbe.5.1.legratioqty", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.leg_security_id = ProtoField.new("Leg Security ID", "cme.mdp3.sbe.5.1.legsecurityid", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.leg_side = ProtoField.new("Leg Side", "cme.mdp3.sbe.5.1.legside", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.legs_group = ProtoField.new("Legs Group", "cme.mdp3.sbe.5.1.legsgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.legs_groups = ProtoField.new("Legs Groups", "cme.mdp3.sbe.5.1.legsgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.lot_type = ProtoField.new("Lot Type", "cme.mdp3.sbe.5.1.lottype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.lot_type_rules_group = ProtoField.new("Lot Type Rules Group", "cme.mdp3.sbe.5.1.lottyperulesgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.lot_type_rules_groups = ProtoField.new("Lot Type Rules Groups", "cme.mdp3.sbe.5.1.lottyperulesgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.low_limit_price = ProtoField.new("Low Limit Price", "cme.mdp3.sbe.5.1.lowlimitprice", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.main_fraction = ProtoField.new("Main Fraction", "cme.mdp3.sbe.5.1.mainfraction", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.market_depth = ProtoField.new("Market Depth", "cme.mdp3.sbe.5.1.marketdepth", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.market_segment_id = ProtoField.new("Market Segment ID", "cme.mdp3.sbe.5.1.marketsegmentid", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.match_algorithm = ProtoField.new("Match Algorithm", "cme.mdp3.sbe.5.1.matchalgorithm", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.match_event_indicator = ProtoField.new("Match Event Indicator", "cme.mdp3.sbe.5.1.matcheventindicator", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.maturity_month_year = ProtoField.new("Maturity Month Year", "cme.mdp3.sbe.5.1.maturitymonthyear", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.max_price_variation = ProtoField.new("Max Price Variation", "cme.mdp3.sbe.5.1.maxpricevariation", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.max_trade_vol = ProtoField.new("Max Trade Vol", "cme.mdp3.sbe.5.1.maxtradevol", ftypes.UINT32)
cme_mdp3_sbe_5_1.fields.md_entry_px = ProtoField.new("MD Entry Px", "cme.mdp3.sbe.5.1.mdentrypx", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.md_entry_size = ProtoField.new("MD Entry Size", "cme.mdp3.sbe.5.1.mdentrysize", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.md_entry_type = ProtoField.new("MD Entry Type", "cme.mdp3.sbe.5.1.mdentrytype", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_feed_type = ProtoField.new("MD Feed Type", "cme.mdp3.sbe.5.1.mdfeedtype", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_feed_types_group = ProtoField.new("MD Feed Types Group", "cme.mdp3.sbe.5.1.mdfeedtypesgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_feed_types_groups = ProtoField.new("MD Feed Types Groups", "cme.mdp3.sbe.5.1.mdfeedtypesgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_book = ProtoField.new("MD Incremental Refresh Book", "cme.mdp3.sbe.5.1.mdincrementalrefreshbook", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_book_group = ProtoField.new("MD Incremental Refresh Book Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshbookgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_book_groups = ProtoField.new("MD Incremental Refresh Book Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshbookgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_daily_statistics = ProtoField.new("MD Incremental Refresh Daily Statistics", "cme.mdp3.sbe.5.1.mdincrementalrefreshdailystatistics", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_daily_statistics_group = ProtoField.new("MD Incremental Refresh Daily Statistics Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshdailystatisticsgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_daily_statistics_groups = ProtoField.new("MD Incremental Refresh Daily Statistics Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshdailystatisticsgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_limits_banding = ProtoField.new("MD Incremental Refresh Limits Banding", "cme.mdp3.sbe.5.1.mdincrementalrefreshlimitsbanding", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_limits_banding_group = ProtoField.new("MD Incremental Refresh Limits Banding Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshlimitsbandinggroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_limits_banding_groups = ProtoField.new("MD Incremental Refresh Limits Banding Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshlimitsbandinggroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_session_statistics = ProtoField.new("MD Incremental Refresh Session Statistics", "cme.mdp3.sbe.5.1.mdincrementalrefreshsessionstatistics", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_session_statistics_group = ProtoField.new("MD Incremental Refresh Session Statistics Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshsessionstatisticsgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_session_statistics_groups = ProtoField.new("MD Incremental Refresh Session Statistics Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshsessionstatisticsgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade = ProtoField.new("MD Incremental Refresh Trade", "cme.mdp3.sbe.5.1.mdincrementalrefreshtrade", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_group = ProtoField.new("MD Incremental Refresh Trade Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshtradegroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_groups = ProtoField.new("MD Incremental Refresh Trade Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshtradegroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary = ProtoField.new("MD Incremental Refresh Trade Summary", "cme.mdp3.sbe.5.1.mdincrementalrefreshtradesummary", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_group = ProtoField.new("MD Incremental Refresh Trade Summary Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshtradesummarygroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_groups = ProtoField.new("MD Incremental Refresh Trade Summary Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshtradesummarygroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_order_group = ProtoField.new("MD Incremental Refresh Trade Summary Order Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshtradesummaryordergroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_order_groups = ProtoField.new("MD Incremental Refresh Trade Summary Order Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshtradesummaryordergroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_volume = ProtoField.new("MD Incremental Refresh Volume", "cme.mdp3.sbe.5.1.mdincrementalrefreshvolume", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_volume_group = ProtoField.new("MD Incremental Refresh Volume Group", "cme.mdp3.sbe.5.1.mdincrementalrefreshvolumegroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_incremental_refresh_volume_groups = ProtoField.new("MD Incremental Refresh Volume Groups", "cme.mdp3.sbe.5.1.mdincrementalrefreshvolumegroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_instrument_definition_future = ProtoField.new("MD Instrument Definition Future", "cme.mdp3.sbe.5.1.mdinstrumentdefinitionfuture", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_instrument_definition_option = ProtoField.new("MD Instrument Definition Option", "cme.mdp3.sbe.5.1.mdinstrumentdefinitionoption", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_instrument_definition_spread = ProtoField.new("MD Instrument Definition Spread", "cme.mdp3.sbe.5.1.mdinstrumentdefinitionspread", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.md_price_level = ProtoField.new("MD Price Level", "cme.mdp3.sbe.5.1.mdpricelevel", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.md_security_trading_status = ProtoField.new("MD Security Trading Status", "cme.mdp3.sbe.5.1.mdsecuritytradingstatus", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.md_update_action = ProtoField.new("MD Update Action", "cme.mdp3.sbe.5.1.mdupdateaction", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.message = ProtoField.new("Message", "cme.mdp3.sbe.5.1.message", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.message_header = ProtoField.new("Message Header", "cme.mdp3.sbe.5.1.messageheader", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "cme.mdp3.sbe.5.1.messagesequencenumber", ftypes.UINT32)
cme_mdp3_sbe_5_1.fields.message_size = ProtoField.new("Message Size", "cme.mdp3.sbe.5.1.messagesize", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.min_cab_price = ProtoField.new("Min Cab Price", "cme.mdp3.sbe.5.1.mincabprice", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.min_lot_size = ProtoField.new("Min Lot Size", "cme.mdp3.sbe.5.1.minlotsize", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.min_price_increment = ProtoField.new("Min Price Increment", "cme.mdp3.sbe.5.1.minpriceincrement", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.min_price_increment_amount = ProtoField.new("Min Price Increment Amount", "cme.mdp3.sbe.5.1.minpriceincrementamount", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.min_trade_vol = ProtoField.new("Min Trade Vol", "cme.mdp3.sbe.5.1.mintradevol", ftypes.UINT32)
cme_mdp3_sbe_5_1.fields.month = ProtoField.new("month", "cme.mdp3.sbe.5.1.month", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.negative_price_outright_eligible = ProtoField.new("Negative Price Outright Eligible", "cme.mdp3.sbe.5.1.negativepriceoutrighteligible", ftypes.UINT32, nil, base.DEC, "0x00000400")
cme_mdp3_sbe_5_1.fields.negative_strike_eligible = ProtoField.new("Negative Strike Eligible", "cme.mdp3.sbe.5.1.negativestrikeeligible", ftypes.UINT32, nil, base.DEC, "0x00000200")
cme_mdp3_sbe_5_1.fields.null_value = ProtoField.new("Null Value", "cme.mdp3.sbe.5.1.nullvalue", ftypes.UINT8, nil, base.DEC, "0x80")
cme_mdp3_sbe_5_1.fields.num_in_group = ProtoField.new("num In Group", "cme.mdp3.sbe.5.1.numingroup", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.number_of_orders = ProtoField.new("Number Of Orders", "cme.mdp3.sbe.5.1.numberoforders", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.open_close_settl_flag = ProtoField.new("Open Close Settl Flag", "cme.mdp3.sbe.5.1.openclosesettlflag", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.open_interest_qty = ProtoField.new("Open Interest Qty", "cme.mdp3.sbe.5.1.openinterestqty", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.order_cross_eligible = ProtoField.new("Order Cross Eligible", "cme.mdp3.sbe.5.1.ordercrosseligible", ftypes.UINT32, nil, base.DEC, "0x00000002")
cme_mdp3_sbe_5_1.fields.order_id = ProtoField.new("Order ID", "cme.mdp3.sbe.5.1.orderid", ftypes.UINT64)
cme_mdp3_sbe_5_1.fields.order_qty = ProtoField.new("Order Qty", "cme.mdp3.sbe.5.1.orderqty", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.original_contract_size = ProtoField.new("Original Contract Size", "cme.mdp3.sbe.5.1.originalcontractsize", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.otc_eligible = ProtoField.new("OTC Eligible", "cme.mdp3.sbe.5.1.otceligible", ftypes.UINT32, nil, base.DEC, "0x00000080")
cme_mdp3_sbe_5_1.fields.packet = ProtoField.new("Packet", "cme.mdp3.sbe.5.1.packet", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.packet_header = ProtoField.new("Packet Header", "cme.mdp3.sbe.5.1.packetheader", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.padding_2 = ProtoField.new("Padding 2", "cme.mdp3.sbe.5.1.padding2", ftypes.BYTES)
cme_mdp3_sbe_5_1.fields.padding_3 = ProtoField.new("Padding 3", "cme.mdp3.sbe.5.1.padding3", ftypes.BYTES)
cme_mdp3_sbe_5_1.fields.padding_4 = ProtoField.new("Padding 4", "cme.mdp3.sbe.5.1.padding4", ftypes.BYTES)
cme_mdp3_sbe_5_1.fields.padding_5 = ProtoField.new("Padding 5", "cme.mdp3.sbe.5.1.padding5", ftypes.BYTES)
cme_mdp3_sbe_5_1.fields.padding_6 = ProtoField.new("Padding 6", "cme.mdp3.sbe.5.1.padding6", ftypes.BYTES)
cme_mdp3_sbe_5_1.fields.padding_7 = ProtoField.new("Padding 7", "cme.mdp3.sbe.5.1.padding7", ftypes.BYTES)
cme_mdp3_sbe_5_1.fields.payload = ProtoField.new("Payload", "cme.mdp3.sbe.5.1.payload", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.price_display_format = ProtoField.new("Price Display Format", "cme.mdp3.sbe.5.1.pricedisplayformat", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.price_ratio = ProtoField.new("Price Ratio", "cme.mdp3.sbe.5.1.priceratio", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.put_or_call = ProtoField.new("Put Or Call", "cme.mdp3.sbe.5.1.putorcall", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.quote_req_id = ProtoField.new("Quote Req ID", "cme.mdp3.sbe.5.1.quotereqid", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.quote_request = ProtoField.new("Quote Request", "cme.mdp3.sbe.5.1.quoterequest", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.quote_type = ProtoField.new("Quote Type", "cme.mdp3.sbe.5.1.quotetype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.recovery_msg = ProtoField.new("Recovery Msg", "cme.mdp3.sbe.5.1.recoverymsg", ftypes.UINT8, nil, base.DEC, "0x20")
cme_mdp3_sbe_5_1.fields.related_sym_group = ProtoField.new("Related Sym Group", "cme.mdp3.sbe.5.1.relatedsymgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.related_sym_groups = ProtoField.new("Related Sym Groups", "cme.mdp3.sbe.5.1.relatedsymgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.reserved = ProtoField.new("Reserved", "cme.mdp3.sbe.5.1.reserved", ftypes.UINT8, nil, base.DEC, "0x40")
cme_mdp3_sbe_5_1.fields.reserved_12 = ProtoField.new("Reserved 12", "cme.mdp3.sbe.5.1.reserved12", ftypes.UINT32, nil, base.DEC, "0xFFF00000")
cme_mdp3_sbe_5_1.fields.reserved_bits = ProtoField.new("Reserved Bits", "cme.mdp3.sbe.5.1.reservedbits", ftypes.UINT8, nil, base.DEC, "0x70")
cme_mdp3_sbe_5_1.fields.rfq_cross_eligible = ProtoField.new("RFQ Cross Eligible", "cme.mdp3.sbe.5.1.rfqcrosseligible", ftypes.UINT32, nil, base.DEC, "0x00002000")
cme_mdp3_sbe_5_1.fields.rounded = ProtoField.new("Rounded", "cme.mdp3.sbe.5.1.rounded", ftypes.UINT8, nil, base.DEC, "0x04")
cme_mdp3_sbe_5_1.fields.rpt_seq = ProtoField.new("Rpt Seq", "cme.mdp3.sbe.5.1.rptseq", ftypes.UINT32)
cme_mdp3_sbe_5_1.fields.schema_id = ProtoField.new("Schema Id", "cme.mdp3.sbe.5.1.schemaid", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.security_exchange = ProtoField.new("Security Exchange", "cme.mdp3.sbe.5.1.securityexchange", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.security_group = ProtoField.new("Security Group", "cme.mdp3.sbe.5.1.securitygroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.security_id = ProtoField.new("Security ID", "cme.mdp3.sbe.5.1.securityid", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.security_status = ProtoField.new("Security Status", "cme.mdp3.sbe.5.1.securitystatus", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.security_sub_type = ProtoField.new("Security Sub Type", "cme.mdp3.sbe.5.1.securitysubtype", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.security_trading_event = ProtoField.new("Security Trading Event", "cme.mdp3.sbe.5.1.securitytradingevent", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.security_trading_status = ProtoField.new("Security Trading Status", "cme.mdp3.sbe.5.1.securitytradingstatus", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.security_type = ProtoField.new("Security Type", "cme.mdp3.sbe.5.1.securitytype", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.security_update_action = ProtoField.new("Security Update Action", "cme.mdp3.sbe.5.1.securityupdateaction", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.sending_time = ProtoField.new("Sending Time", "cme.mdp3.sbe.5.1.sendingtime", ftypes.UINT64)
cme_mdp3_sbe_5_1.fields.settl_currency = ProtoField.new("Settl Currency", "cme.mdp3.sbe.5.1.settlcurrency", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.settl_price_type = ProtoField.new("Settl Price Type", "cme.mdp3.sbe.5.1.settlpricetype", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.side = ProtoField.new("Side", "cme.mdp3.sbe.5.1.side", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.snapshot_full_refresh = ProtoField.new("Snapshot Full Refresh", "cme.mdp3.sbe.5.1.snapshotfullrefresh", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.snapshot_full_refresh_group = ProtoField.new("Snapshot Full Refresh Group", "cme.mdp3.sbe.5.1.snapshotfullrefreshgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.snapshot_full_refresh_groups = ProtoField.new("Snapshot Full Refresh Groups", "cme.mdp3.sbe.5.1.snapshotfullrefreshgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.strike_currency = ProtoField.new("Strike Currency", "cme.mdp3.sbe.5.1.strikecurrency", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.strike_price = ProtoField.new("Strike Price", "cme.mdp3.sbe.5.1.strikeprice", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.sub_fraction = ProtoField.new("Sub Fraction", "cme.mdp3.sbe.5.1.subfraction", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.symbol = ProtoField.new("Symbol", "cme.mdp3.sbe.5.1.symbol", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.template_id = ProtoField.new("Template Id", "cme.mdp3.sbe.5.1.templateid", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.text = ProtoField.new("Text", "cme.mdp3.sbe.5.1.text", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.tick_rule = ProtoField.new("Tick Rule", "cme.mdp3.sbe.5.1.tickrule", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_mdp3_sbe_5_1.fields.tot_num_reports = ProtoField.new("Tot Num Reports", "cme.mdp3.sbe.5.1.totnumreports", ftypes.UINT32)
cme_mdp3_sbe_5_1.fields.trade_date = ProtoField.new("Trade Date", "cme.mdp3.sbe.5.1.tradedate", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.trade_id = ProtoField.new("Trade ID", "cme.mdp3.sbe.5.1.tradeid", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.trading_reference_date = ProtoField.new("Trading Reference Date", "cme.mdp3.sbe.5.1.tradingreferencedate", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.trading_reference_price = ProtoField.new("Trading Reference Price", "cme.mdp3.sbe.5.1.tradingreferenceprice", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.transact_time = ProtoField.new("Transact Time", "cme.mdp3.sbe.5.1.transacttime", ftypes.UINT64)
cme_mdp3_sbe_5_1.fields.underlying_product = ProtoField.new("Underlying Product", "cme.mdp3.sbe.5.1.underlyingproduct", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.underlying_security_id = ProtoField.new("Underlying Security ID", "cme.mdp3.sbe.5.1.underlyingsecurityid", ftypes.INT32)
cme_mdp3_sbe_5_1.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "cme.mdp3.sbe.5.1.underlyingsymbol", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.underlyings_group = ProtoField.new("Underlyings Group", "cme.mdp3.sbe.5.1.underlyingsgroup", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.underlyings_groups = ProtoField.new("Underlyings Groups", "cme.mdp3.sbe.5.1.underlyingsgroups", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.unit_of_measure = ProtoField.new("Unit Of Measure", "cme.mdp3.sbe.5.1.unitofmeasure", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.unit_of_measure_qty = ProtoField.new("Unit Of Measure Qty", "cme.mdp3.sbe.5.1.unitofmeasureqty", ftypes.INT64)
cme_mdp3_sbe_5_1.fields.user_defined_instrument = ProtoField.new("User Defined Instrument", "cme.mdp3.sbe.5.1.userdefinedinstrument", ftypes.STRING)
cme_mdp3_sbe_5_1.fields.variable_product_eligibility = ProtoField.new("Variable Product Eligibility", "cme.mdp3.sbe.5.1.variableproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00010000")
cme_mdp3_sbe_5_1.fields.version = ProtoField.new("Version", "cme.mdp3.sbe.5.1.version", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.volatility_quoted_option = ProtoField.new("Volatility Quoted Option", "cme.mdp3.sbe.5.1.volatilityquotedoption", ftypes.UINT32, nil, base.DEC, "0x00001000")
cme_mdp3_sbe_5_1.fields.week = ProtoField.new("week", "cme.mdp3.sbe.5.1.week", ftypes.UINT8)
cme_mdp3_sbe_5_1.fields.year = ProtoField.new("year", "cme.mdp3.sbe.5.1.year", ftypes.UINT16)
cme_mdp3_sbe_5_1.fields.zero_price_outright_eligible = ProtoField.new("Zero Price Outright Eligible", "cme.mdp3.sbe.5.1.zeropriceoutrighteligible", ftypes.UINT32, nil, base.DEC, "0x00004000")
...
dissect.padding_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.padding_4, range, value, display)
...
dissect.last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.last_qty, range, value, display)
...
dissect.order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.order_id, range, value, display)
...
dissect.md_incremental_refresh_trade_summary_order_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_order_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_order_group, range, display)
  end
...
dissect.num_in_group = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.num_in_group, range, value, display)
...
dissect.padding_5 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.padding_5, range, value, display)
...
dissect.block_length = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.block_length, range, value, display)
...
dissect.group_size8_byte = function(buffer, offset, packet, parent)
  ...
  if show.group_size8_byte then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.group_size8_byte, range, display)
  end
...
dissect.md_incremental_refresh_trade_summary_order_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_order_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_order_groups, range, display)
  end
...
dissect.padding_6 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.padding_6, range, value, display)
...
dissect.md_update_action = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.md_update_action, range, value, display)
...
dissect.aggressor_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.aggressor_side, range, value, display)
...
dissect.number_of_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.number_of_orders, range, value, display)
...
dissect.rpt_seq = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.rpt_seq, range, value, display)
...
dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_id, range, value, display)
...
dissect.md_entry_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.md_entry_size, range, value, display)
...
dissect.md_entry_px = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.md_entry_px, range, value, display)
...
dissect.md_incremental_refresh_trade_summary_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_group, range, display)
  end
...
dissect.group_size = function(buffer, offset, packet, parent)
  ...
  if show.group_size then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.group_size, range, display)
  end
...
dissect.md_incremental_refresh_trade_summary_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary_groups, range, display)
  end
...
dissect.padding_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.padding_2, range, value, display)
...
dissect.match_event_indicator_bits = function(buffer, offset, packet, parent)
  ...
  -- End Of Event: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.end_of_event, buffer(offset, 1))

  -- Reserved: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.reserved, buffer(offset, 1))

  -- Recovery Msg: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.recovery_msg, buffer(offset, 1))

  -- Last Implied Msg: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.last_implied_msg, buffer(offset, 1))

  -- Last Stats Msg: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.last_stats_msg, buffer(offset, 1))

  -- Last Quote Msg: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.last_quote_msg, buffer(offset, 1))

  -- Last Volume Msg: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.last_volume_msg, buffer(offset, 1))

  -- Last Trade Msg: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.last_trade_msg, buffer(offset, 1))
end
...
dissect.match_event_indicator = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_mdp3_sbe_5_1.fields.match_event_indicator, range, display)
...
dissect.transact_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.transact_time, range, value, display)
...
dissect.md_incremental_refresh_trade_summary = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_summary, range, display)
  end
...
dissect.underlying_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.underlying_symbol, range, value, display)
...
dissect.underlying_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.underlying_security_id, range, value, display)
...
dissect.underlyings_group = function(buffer, offset, packet, parent)
  ...
  if show.underlyings_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.underlyings_group, range, display)
  end
...
dissect.underlyings_groups = function(buffer, offset, packet, parent)
  ...
  if show.underlyings_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.underlyings_groups, range, display)
  end
...
dissect.min_lot_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.min_lot_size, range, value, display)
...
dissect.lot_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.lot_type, range, value, display)
...
dissect.lot_type_rules_group = function(buffer, offset, packet, parent)
  ...
  if show.lot_type_rules_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.lot_type_rules_group, range, display)
  end
...
dissect.lot_type_rules_groups = function(buffer, offset, packet, parent)
  ...
  if show.lot_type_rules_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.lot_type_rules_groups, range, display)
  end
...
dissect.inst_attrib_value_bits = function(buffer, offset, packet, parent)
  ...
  -- Reserved 12: 12 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.reserved_12, buffer(offset, 4))

  -- Implied Matching Eligibility: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.implied_matching_eligibility, buffer(offset, 4))

  -- GT Orders Eligibility: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.gt_orders_eligibility, buffer(offset, 4))

  -- Daily Product Eligibility: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.daily_product_eligibility, buffer(offset, 4))

  -- Variable Product Eligibility: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.variable_product_eligibility, buffer(offset, 4))

  -- Decaying Product Eligibility: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.decaying_product_eligibility, buffer(offset, 4))

  -- Zero Price Outright Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.zero_price_outright_eligible, buffer(offset, 4))

  -- RFQ Cross Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.rfq_cross_eligible, buffer(offset, 4))

  -- Volatility Quoted Option: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.volatility_quoted_option, buffer(offset, 4))

  -- Is Fractional: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.is_fractional, buffer(offset, 4))

  -- Negative Price Outright Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.negative_price_outright_eligible, buffer(offset, 4))

  -- Negative Strike Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.negative_strike_eligible, buffer(offset, 4))

  -- i Link Indicative Mass Quoting Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.i_link_indicative_mass_quoting_eligible, buffer(offset, 4))

  -- OTC Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.otc_eligible, buffer(offset, 4))

  -- EFR Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.efr_eligible, buffer(offset, 4))

  -- EFS Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.efs_eligible, buffer(offset, 4))

  -- EBF Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.ebf_eligible, buffer(offset, 4))

  -- EFP Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.efp_eligible, buffer(offset, 4))

  -- Block Trade Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.block_trade_eligible, buffer(offset, 4))

  -- Order Cross Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.order_cross_eligible, buffer(offset, 4))

  -- Electronic Match Eligible: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.electronic_match_eligible, buffer(offset, 4))
end
...
dissect.inst_attrib_value = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_mdp3_sbe_5_1.fields.inst_attrib_value, range, display)
...
dissect.inst_attrib_group = function(buffer, offset, packet, parent)
  ...
  if show.inst_attrib_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.inst_attrib_group, range, display)
  end
...
dissect.inst_attrib_groups = function(buffer, offset, packet, parent)
  ...
  if show.inst_attrib_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.inst_attrib_groups, range, display)
  end
...
dissect.market_depth = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.market_depth, range, value, display)
...
dissect.md_feed_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.md_feed_type, range, value, display)
...
dissect.md_feed_types_group = function(buffer, offset, packet, parent)
  ...
  if show.md_feed_types_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_feed_types_group, range, display)
  end
...
dissect.md_feed_types_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_feed_types_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_feed_types_groups, range, display)
  end
...
dissect.event_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.event_time, range, value, display)
...
dissect.event_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.event_type, range, value, display)
...
dissect.events_group = function(buffer, offset, packet, parent)
  ...
  if show.events_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.events_group, range, display)
  end
...
dissect.events_groups = function(buffer, offset, packet, parent)
  ...
  if show.events_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.events_groups, range, display)
  end
...
dissect.user_defined_instrument = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.user_defined_instrument, range, value, display)
...
dissect.high_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.high_limit_price, range, value, display)
...
dissect.low_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.low_limit_price, range, value, display)
...
dissect.open_interest_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.open_interest_qty, range, value, display)
...
dissect.cleared_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.cleared_volume, range, value, display)
...
dissect.settl_price_type_bits = function(buffer, offset, packet, parent)
  ...
  -- Null Value: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.null_value, buffer(offset, 1))

  -- Reserved Bits: 3 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.reserved_bits, buffer(offset, 1))

  -- Intraday: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.intraday, buffer(offset, 1))

  -- Rounded: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.rounded, buffer(offset, 1))

  -- Actual: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.actual, buffer(offset, 1))

  -- Final: 1 Bit
  parent:add(cme_mdp3_sbe_5_1.fields.final, buffer(offset, 1))
end
...
dissect.settl_price_type = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_mdp3_sbe_5_1.fields.settl_price_type, range, display)
...
dissect.trading_reference_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.trading_reference_price, range, value, display)
...
dissect.unit_of_measure_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.unit_of_measure_qty, range, value, display)
...
dissect.unit_of_measure = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.unit_of_measure, range, value, display)
...
dissect.price_display_format = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.price_display_format, range, value, display)
...
dissect.sub_fraction = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.sub_fraction, range, value, display)
...
dissect.main_fraction = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.main_fraction, range, value, display)
...
dissect.tick_rule = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.tick_rule, range, value, display)
...
dissect.display_factor = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.display_factor, range, value, display)
...
dissect.min_price_increment_amount = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.min_price_increment_amount, range, value, display)
...
dissect.min_price_increment = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.min_price_increment, range, value, display)
...
dissect.max_trade_vol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.max_trade_vol, range, value, display)
...
dissect.min_trade_vol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.min_trade_vol, range, value, display)
...
dissect.match_algorithm = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.match_algorithm, range, value, display)
...
dissect.min_cab_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.min_cab_price, range, value, display)
...
dissect.settl_currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.settl_currency, range, value, display)
...
dissect.strike_currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.strike_currency, range, value, display)
...
dissect.strike_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.strike_price, range, value, display)
...
dissect.currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.currency, range, value, display)
...
dissect.week = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.week, range, value, display)
...
dissect.day = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.day, range, value, display)
...
dissect.month = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.month, range, value, display)
...
dissect.year = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.year, range, value, display)
...
dissect.maturity_month_year = function(buffer, offset, packet, parent)
  ...
  if show.maturity_month_year then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.maturity_month_year, range, display)
  end
...
dissect.put_or_call = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.put_or_call, range, value, display)
...
dissect.cfi_code = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.cfi_code, range, value, display)
...
dissect.security_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_type, range, value, display)
...
dissect.symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.symbol, range, value, display)
...
dissect.asset = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.asset, range, value, display)
...
dissect.security_group = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_group, range, value, display)
...
dissect.security_exchange = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_exchange, range, value, display)
...
dissect.underlying_product = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.underlying_product, range, value, display)
...
dissect.market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.market_segment_id, range, value, display)
...
dissect.appl_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.appl_id, range, value, display)
...
dissect.md_security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.md_security_trading_status, range, value, display)
...
dissect.last_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.last_update_time, range, value, display)
...
dissect.security_update_action = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_update_action, range, value, display)
...
dissect.tot_num_reports = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.tot_num_reports, range, value, display)
...
dissect.md_instrument_definition_option = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_option then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_instrument_definition_option, range, display)
  end
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.side, range, value, display)
...
dissect.quote_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.quote_type, range, value, display)
...
dissect.order_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.order_qty, range, value, display)
...
dissect.related_sym_group = function(buffer, offset, packet, parent)
  ...
  if show.related_sym_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.related_sym_group, range, display)
  end
...
dissect.related_sym_groups = function(buffer, offset, packet, parent)
  ...
  if show.related_sym_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.related_sym_groups, range, display)
  end
...
dissect.padding_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.padding_3, range, value, display)
...
dissect.quote_req_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.quote_req_id, range, value, display)
...
dissect.quote_request = function(buffer, offset, packet, parent)
  ...
  if show.quote_request then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.quote_request, range, display)
  end
...
dissect.md_entry_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.md_entry_type, range, value, display)
...
dissect.open_close_settl_flag = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.open_close_settl_flag, range, value, display)
...
dissect.trading_reference_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.trading_reference_date, range, value, display)
...
dissect.md_price_level = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.md_price_level, range, value, display)
...
dissect.snapshot_full_refresh_group = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.snapshot_full_refresh_group, range, display)
  end
...
dissect.snapshot_full_refresh_groups = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.snapshot_full_refresh_groups, range, display)
  end
...
dissect.max_price_variation = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.max_price_variation, range, value, display)
...
dissect.trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.trade_date, range, value, display)
...
dissect.last_msg_seq_num_processed = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.last_msg_seq_num_processed, range, value, display)
...
dissect.snapshot_full_refresh = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.snapshot_full_refresh, range, display)
  end
...
dissect.md_incremental_refresh_volume_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_volume_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_volume_group, range, display)
  end
...
dissect.md_incremental_refresh_volume_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_volume_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_volume_groups, range, display)
  end
...
dissect.md_incremental_refresh_volume = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_volume then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_volume, range, display)
  end
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.trade_id, range, value, display)
...
dissect.md_incremental_refresh_trade_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_group, range, display)
  end
...
dissect.md_incremental_refresh_trade_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade_groups, range, display)
  end
...
dissect.md_incremental_refresh_trade = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_trade, range, display)
  end
...
dissect.md_incremental_refresh_session_statistics_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_session_statistics_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_session_statistics_group, range, display)
  end
...
dissect.md_incremental_refresh_session_statistics_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_session_statistics_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_session_statistics_groups, range, display)
  end
...
dissect.md_incremental_refresh_session_statistics = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_session_statistics then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_session_statistics, range, display)
  end
...
dissect.md_incremental_refresh_limits_banding_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_limits_banding_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_limits_banding_group, range, display)
  end
...
dissect.md_incremental_refresh_limits_banding_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_limits_banding_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_limits_banding_groups, range, display)
  end
...
dissect.md_incremental_refresh_limits_banding = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_limits_banding then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_limits_banding, range, display)
  end
...
dissect.padding_7 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.padding_7, range, value, display)
...
dissect.md_incremental_refresh_daily_statistics_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_daily_statistics_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_daily_statistics_group, range, display)
  end
...
dissect.md_incremental_refresh_daily_statistics_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_daily_statistics_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_daily_statistics_groups, range, display)
  end
...
dissect.md_incremental_refresh_daily_statistics = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_daily_statistics then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_daily_statistics, range, display)
  end
...
dissect.md_incremental_refresh_book_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_book_group, range, display)
  end
...
dissect.md_incremental_refresh_book_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_book_groups, range, display)
  end
...
dissect.md_incremental_refresh_book = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_incremental_refresh_book, range, display)
  end
...
dissect.security_trading_event = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_trading_event, range, value, display)
...
dissect.halt_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.halt_reason, range, value, display)
...
dissect.security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_trading_status, range, value, display)
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  if show.security_status then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.security_status, range, display)
  end
...
dissect.leg_option_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.leg_option_delta, range, value, display)
...
dissect.leg_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.leg_price, range, value, display)
...
dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.leg_ratio_qty, range, value, display)
...
dissect.leg_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.leg_side, range, value, display)
...
dissect.leg_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.leg_security_id, range, value, display)
...
dissect.legs_group = function(buffer, offset, packet, parent)
  ...
  if show.legs_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.legs_group, range, display)
  end
...
dissect.legs_groups = function(buffer, offset, packet, parent)
  ...
  if show.legs_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.legs_groups, range, display)
  end
...
dissect.price_ratio = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.price_ratio, range, value, display)
...
dissect.security_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.security_sub_type, range, value, display)
...
dissect.md_instrument_definition_spread = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_spread then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_instrument_definition_spread, range, display)
  end
...
dissect.flow_schedule_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.flow_schedule_type, range, value, display)
...
dissect.contract_multiplier_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.contract_multiplier_unit, range, value, display)
...
dissect.contract_multiplier = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.contract_multiplier, range, value, display)
...
dissect.original_contract_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.original_contract_size, range, value, display)
...
dissect.decay_start_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.decay_start_date, range, value, display)
...
dissect.decay_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.decay_quantity, range, value, display)
...
dissect.md_instrument_definition_future = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_future then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.md_instrument_definition_future, range, display)
  end
...
dissect.text = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.text, range, value, display)
...
dissect.admin_logout = function(buffer, offset, packet, parent)
  ...
  if show.admin_logout then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.admin_logout, range, display)
  end
...
dissect.heart_bt_int = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.heart_bt_int, range, value, display)
...
dissect.admin_login = function(buffer, offset, packet, parent)
  ...
  if show.admin_login then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.admin_login, range, display)
  end
...
dissect.channel_reset_group = function(buffer, offset, packet, parent)
  ...
  if show.channel_reset_group then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.channel_reset_group, range, display)
  end
...
dissect.channel_reset_groups = function(buffer, offset, packet, parent)
  ...
  if show.channel_reset_groups then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.channel_reset_groups, range, display)
  end
...
dissect.channel_reset = function(buffer, offset, packet, parent)
  ...
  if show.channel_reset then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.channel_reset, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_mdp3_sbe_5_1.fields.payload, range, display)
...
dissect.version = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.version, range, value, display)
...
dissect.schema_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.schema_id, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.template_id, range, value, display)
...
dissect.message_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.message_size, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.message_header, range, display)
  end
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.message, range, display)
  end
...
dissect.sending_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.sending_time, range, value, display)
...
dissect.message_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_mdp3_sbe_5_1.fields.message_sequence_number, range, value, display)
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    ...
    parent = parent:add(cme_mdp3_sbe_5_1.fields.packet_header, range, display)
  end
...
function cme_mdp3_sbe_5_1.init()
end

-- Dissector for Cme Mdp3 Sbe 5.1
function cme_mdp3_sbe_5_1.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = cme_mdp3_sbe_5_1.name

  -- Dissect protocol
  local protocol = parent:add(cme_mdp3_sbe_5_1, buffer(), cme_mdp3_sbe_5_1.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, cme_mdp3_sbe_5_1)
...
verify.cme_mdp3_sbe_5_1_packet_size = function(buffer)
...
-- Dissector Heuristic for Cme Mdp3 Sbe 5.1
local function cme_mdp3_sbe_5_1_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.cme_mdp3_sbe_5_1_packet_size(buffer) then return false end

  -- Verify Version
  if not verify.version(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = cme_mdp3_sbe_5_1
  cme_mdp3_sbe_5_1.dissector(buffer, packet, parent)

  return true
end

-- Register Cme Mdp3 Sbe 5.1 Heuristic
cme_mdp3_sbe_5_1:register_heuristic("udp", cme_mdp3_sbe_5_1_heuristic)
