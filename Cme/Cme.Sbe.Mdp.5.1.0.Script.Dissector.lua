...
-- Cme Sbe Mdp 5.1.0 Protocol
local cme_sbe_mdp_5_1_0 = Proto("Cme.Sbe.Mdp.5.1.0.Lua", "Cme Sbe Mdp 5.1.0")
...
-- Cme Sbe Mdp 5.1.0 Format Options
...
-- Cme Sbe Mdp 5.1.0 Element Dissection Options
...
-- Cme Sbe Mdp 5.1.0 Fields
cme_sbe_mdp_5_1_0.fields.actual = ProtoField.new("Actual", "Cme.Sbe.Mdp.actual", ftypes.UINT8, nil, base.DEC, "0x02")
cme_sbe_mdp_5_1_0.fields.admin_login = ProtoField.new("Admin Login", "Cme.Sbe.Mdp.adminlogin", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.admin_logout = ProtoField.new("Admin Logout", "Cme.Sbe.Mdp.adminlogout", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.aggressor_side = ProtoField.new("Aggressor Side", "Cme.Sbe.Mdp.aggressorside", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.appl_id = ProtoField.new("Appl ID", "Cme.Sbe.Mdp.applid", ftypes.INT16)
cme_sbe_mdp_5_1_0.fields.asset = ProtoField.new("Asset", "Cme.Sbe.Mdp.asset", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.block_length = ProtoField.new("block Length", "Cme.Sbe.Mdp.blocklength", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.block_length = ProtoField.new("Block Length", "Cme.Sbe.Mdp.blocklength", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.block_trade_eligible = ProtoField.new("Block Trade Eligible", "Cme.Sbe.Mdp.blocktradeeligible", ftypes.UINT32, nil, base.DEC, "0x00000004")
cme_sbe_mdp_5_1_0.fields.cfi_code = ProtoField.new("CFI Code", "Cme.Sbe.Mdp.cficode", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.channel_reset = ProtoField.new("Channel Reset", "Cme.Sbe.Mdp.channelreset", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.channel_reset_group = ProtoField.new("Channel Reset Group", "Cme.Sbe.Mdp.channelresetgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.channel_reset_groups = ProtoField.new("Channel Reset Groups", "Cme.Sbe.Mdp.channelresetgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.cleared_volume = ProtoField.new("Cleared Volume", "Cme.Sbe.Mdp.clearedvolume", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.contract_multiplier = ProtoField.new("Contract Multiplier", "Cme.Sbe.Mdp.contractmultiplier", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.contract_multiplier_unit = ProtoField.new("Contract Multiplier Unit", "Cme.Sbe.Mdp.contractmultiplierunit", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.currency = ProtoField.new("Currency", "Cme.Sbe.Mdp.currency", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.daily_product_eligibility = ProtoField.new("Daily Product Eligibility", "Cme.Sbe.Mdp.dailyproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00020000")
cme_sbe_mdp_5_1_0.fields.day = ProtoField.new("day", "Cme.Sbe.Mdp.day", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.decay_quantity = ProtoField.new("Decay Quantity", "Cme.Sbe.Mdp.decayquantity", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.decay_start_date = ProtoField.new("Decay Start Date", "Cme.Sbe.Mdp.decaystartdate", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.decaying_product_eligibility = ProtoField.new("Decaying Product Eligibility", "Cme.Sbe.Mdp.decayingproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00008000")
cme_sbe_mdp_5_1_0.fields.display_factor = ProtoField.new("Display Factor", "Cme.Sbe.Mdp.displayfactor", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.ebf_eligible = ProtoField.new("EBF Eligible", "Cme.Sbe.Mdp.ebfeligible", ftypes.UINT32, nil, base.DEC, "0x00000010")
cme_sbe_mdp_5_1_0.fields.efp_eligible = ProtoField.new("EFP Eligible", "Cme.Sbe.Mdp.efpeligible", ftypes.UINT32, nil, base.DEC, "0x00000008")
cme_sbe_mdp_5_1_0.fields.efr_eligible = ProtoField.new("EFR Eligible", "Cme.Sbe.Mdp.efreligible", ftypes.UINT32, nil, base.DEC, "0x00000040")
cme_sbe_mdp_5_1_0.fields.efs_eligible = ProtoField.new("EFS Eligible", "Cme.Sbe.Mdp.efseligible", ftypes.UINT32, nil, base.DEC, "0x00000020")
cme_sbe_mdp_5_1_0.fields.electronic_match_eligible = ProtoField.new("Electronic Match Eligible", "Cme.Sbe.Mdp.electronicmatcheligible", ftypes.UINT32, nil, base.DEC, "0x00000001")
cme_sbe_mdp_5_1_0.fields.end_of_event = ProtoField.new("End Of Event", "Cme.Sbe.Mdp.endofevent", ftypes.UINT8, nil, base.DEC, "0x80")
cme_sbe_mdp_5_1_0.fields.event_time = ProtoField.new("Event Time", "Cme.Sbe.Mdp.eventtime", ftypes.UINT64)
cme_sbe_mdp_5_1_0.fields.event_type = ProtoField.new("Event Type", "Cme.Sbe.Mdp.eventtype", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.events_group = ProtoField.new("Events Group", "Cme.Sbe.Mdp.eventsgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.events_groups = ProtoField.new("Events Groups", "Cme.Sbe.Mdp.eventsgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.final = ProtoField.new("Final", "Cme.Sbe.Mdp.final", ftypes.UINT8, nil, base.DEC, "0x01")
cme_sbe_mdp_5_1_0.fields.flow_schedule_type = ProtoField.new("Flow Schedule Type", "Cme.Sbe.Mdp.flowscheduletype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.group_size = ProtoField.new("group Size", "Cme.Sbe.Mdp.groupsize", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.group_size8_byte = ProtoField.new("group Size8 Byte", "Cme.Sbe.Mdp.groupsize8byte", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.gt_orders_eligibility = ProtoField.new("GT Orders Eligibility", "Cme.Sbe.Mdp.gtorderseligibility", ftypes.UINT32, nil, base.DEC, "0x00040000")
cme_sbe_mdp_5_1_0.fields.halt_reason = ProtoField.new("Halt Reason", "Cme.Sbe.Mdp.haltreason", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "Cme.Sbe.Mdp.heartbtint", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.high_limit_price = ProtoField.new("High Limit Price", "Cme.Sbe.Mdp.highlimitprice", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.i_link_indicative_mass_quoting_eligible = ProtoField.new("i Link Indicative Mass Quoting Eligible", "Cme.Sbe.Mdp.ilinkindicativemassquotingeligible", ftypes.UINT32, nil, base.DEC, "0x00000100")
cme_sbe_mdp_5_1_0.fields.implied_matching_eligibility = ProtoField.new("Implied Matching Eligibility", "Cme.Sbe.Mdp.impliedmatchingeligibility", ftypes.UINT32, nil, base.DEC, "0x00080000")
cme_sbe_mdp_5_1_0.fields.inst_attrib_group = ProtoField.new("Inst Attrib Group", "Cme.Sbe.Mdp.instattribgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.inst_attrib_groups = ProtoField.new("Inst Attrib Groups", "Cme.Sbe.Mdp.instattribgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.inst_attrib_value = ProtoField.new("Inst Attrib Value", "Cme.Sbe.Mdp.instattribvalue", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.intraday = ProtoField.new("Intraday", "Cme.Sbe.Mdp.intraday", ftypes.UINT8, nil, base.DEC, "0x08")
cme_sbe_mdp_5_1_0.fields.is_fractional = ProtoField.new("Is Fractional", "Cme.Sbe.Mdp.isfractional", ftypes.UINT32, nil, base.DEC, "0x00000800")
cme_sbe_mdp_5_1_0.fields.last_implied_msg = ProtoField.new("Last Implied Msg", "Cme.Sbe.Mdp.lastimpliedmsg", ftypes.UINT8, nil, base.DEC, "0x10")
cme_sbe_mdp_5_1_0.fields.last_msg_seq_num_processed = ProtoField.new("Last Msg Seq Num Processed", "Cme.Sbe.Mdp.lastmsgseqnumprocessed", ftypes.UINT32)
cme_sbe_mdp_5_1_0.fields.last_qty = ProtoField.new("Last Qty", "Cme.Sbe.Mdp.lastqty", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.last_quote_msg = ProtoField.new("Last Quote Msg", "Cme.Sbe.Mdp.lastquotemsg", ftypes.UINT8, nil, base.DEC, "0x04")
cme_sbe_mdp_5_1_0.fields.last_stats_msg = ProtoField.new("Last Stats Msg", "Cme.Sbe.Mdp.laststatsmsg", ftypes.UINT8, nil, base.DEC, "0x08")
cme_sbe_mdp_5_1_0.fields.last_trade_msg = ProtoField.new("Last Trade Msg", "Cme.Sbe.Mdp.lasttrademsg", ftypes.UINT8, nil, base.DEC, "0x01")
cme_sbe_mdp_5_1_0.fields.last_update_time = ProtoField.new("Last Update Time", "Cme.Sbe.Mdp.lastupdatetime", ftypes.UINT64)
cme_sbe_mdp_5_1_0.fields.last_volume_msg = ProtoField.new("Last Volume Msg", "Cme.Sbe.Mdp.lastvolumemsg", ftypes.UINT8, nil, base.DEC, "0x02")
cme_sbe_mdp_5_1_0.fields.leg_option_delta = ProtoField.new("Leg Option Delta", "Cme.Sbe.Mdp.legoptiondelta", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.leg_price = ProtoField.new("Leg Price", "Cme.Sbe.Mdp.legprice", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "Cme.Sbe.Mdp.legratioqty", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.leg_security_id = ProtoField.new("Leg Security ID", "Cme.Sbe.Mdp.legsecurityid", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.leg_side = ProtoField.new("Leg Side", "Cme.Sbe.Mdp.legside", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.legs_group = ProtoField.new("Legs Group", "Cme.Sbe.Mdp.legsgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.legs_groups = ProtoField.new("Legs Groups", "Cme.Sbe.Mdp.legsgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.lot_type = ProtoField.new("Lot Type", "Cme.Sbe.Mdp.lottype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.lot_type_rules_group = ProtoField.new("Lot Type Rules Group", "Cme.Sbe.Mdp.lottyperulesgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.lot_type_rules_groups = ProtoField.new("Lot Type Rules Groups", "Cme.Sbe.Mdp.lottyperulesgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.low_limit_price = ProtoField.new("Low Limit Price", "Cme.Sbe.Mdp.lowlimitprice", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.main_fraction = ProtoField.new("Main Fraction", "Cme.Sbe.Mdp.mainfraction", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.market_depth = ProtoField.new("Market Depth", "Cme.Sbe.Mdp.marketdepth", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.market_segment_id = ProtoField.new("Market Segment ID", "Cme.Sbe.Mdp.marketsegmentid", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.match_algorithm = ProtoField.new("Match Algorithm", "Cme.Sbe.Mdp.matchalgorithm", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.match_event_indicator = ProtoField.new("Match Event Indicator", "Cme.Sbe.Mdp.matcheventindicator", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.maturity_month_year = ProtoField.new("Maturity Month Year", "Cme.Sbe.Mdp.maturitymonthyear", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.max_price_variation = ProtoField.new("Max Price Variation", "Cme.Sbe.Mdp.maxpricevariation", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.max_trade_vol = ProtoField.new("Max Trade Vol", "Cme.Sbe.Mdp.maxtradevol", ftypes.UINT32)
cme_sbe_mdp_5_1_0.fields.md_entry_px = ProtoField.new("MD Entry Px", "Cme.Sbe.Mdp.mdentrypx", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.md_entry_size = ProtoField.new("MD Entry Size", "Cme.Sbe.Mdp.mdentrysize", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.md_entry_type = ProtoField.new("MD Entry Type", "Cme.Sbe.Mdp.mdentrytype", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_feed_type = ProtoField.new("MD Feed Type", "Cme.Sbe.Mdp.mdfeedtype", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_feed_types_group = ProtoField.new("MD Feed Types Group", "Cme.Sbe.Mdp.mdfeedtypesgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_feed_types_groups = ProtoField.new("MD Feed Types Groups", "Cme.Sbe.Mdp.mdfeedtypesgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_book = ProtoField.new("MD Incremental Refresh Book", "Cme.Sbe.Mdp.mdincrementalrefreshbook", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_book_group = ProtoField.new("MD Incremental Refresh Book Group", "Cme.Sbe.Mdp.mdincrementalrefreshbookgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_book_groups = ProtoField.new("MD Incremental Refresh Book Groups", "Cme.Sbe.Mdp.mdincrementalrefreshbookgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_daily_statistics = ProtoField.new("MD Incremental Refresh Daily Statistics", "Cme.Sbe.Mdp.mdincrementalrefreshdailystatistics", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_daily_statistics_group = ProtoField.new("MD Incremental Refresh Daily Statistics Group", "Cme.Sbe.Mdp.mdincrementalrefreshdailystatisticsgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_daily_statistics_groups = ProtoField.new("MD Incremental Refresh Daily Statistics Groups", "Cme.Sbe.Mdp.mdincrementalrefreshdailystatisticsgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_limits_banding = ProtoField.new("MD Incremental Refresh Limits Banding", "Cme.Sbe.Mdp.mdincrementalrefreshlimitsbanding", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_limits_banding_group = ProtoField.new("MD Incremental Refresh Limits Banding Group", "Cme.Sbe.Mdp.mdincrementalrefreshlimitsbandinggroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_limits_banding_groups = ProtoField.new("MD Incremental Refresh Limits Banding Groups", "Cme.Sbe.Mdp.mdincrementalrefreshlimitsbandinggroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_session_statistics = ProtoField.new("MD Incremental Refresh Session Statistics", "Cme.Sbe.Mdp.mdincrementalrefreshsessionstatistics", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_session_statistics_group = ProtoField.new("MD Incremental Refresh Session Statistics Group", "Cme.Sbe.Mdp.mdincrementalrefreshsessionstatisticsgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_session_statistics_groups = ProtoField.new("MD Incremental Refresh Session Statistics Groups", "Cme.Sbe.Mdp.mdincrementalrefreshsessionstatisticsgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade = ProtoField.new("MD Incremental Refresh Trade", "Cme.Sbe.Mdp.mdincrementalrefreshtrade", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade_group = ProtoField.new("MD Incremental Refresh Trade Group", "Cme.Sbe.Mdp.mdincrementalrefreshtradegroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade_groups = ProtoField.new("MD Incremental Refresh Trade Groups", "Cme.Sbe.Mdp.mdincrementalrefreshtradegroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade_summary = ProtoField.new("MD Incremental Refresh Trade Summary", "Cme.Sbe.Mdp.mdincrementalrefreshtradesummary", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade_summary_group = ProtoField.new("MD Incremental Refresh Trade Summary Group", "Cme.Sbe.Mdp.mdincrementalrefreshtradesummarygroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade_summary_groups = ProtoField.new("MD Incremental Refresh Trade Summary Groups", "Cme.Sbe.Mdp.mdincrementalrefreshtradesummarygroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade_summary_order_group = ProtoField.new("MD Incremental Refresh Trade Summary Order Group", "Cme.Sbe.Mdp.mdincrementalrefreshtradesummaryordergroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_trade_summary_order_groups = ProtoField.new("MD Incremental Refresh Trade Summary Order Groups", "Cme.Sbe.Mdp.mdincrementalrefreshtradesummaryordergroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_volume = ProtoField.new("MD Incremental Refresh Volume", "Cme.Sbe.Mdp.mdincrementalrefreshvolume", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_volume_group = ProtoField.new("MD Incremental Refresh Volume Group", "Cme.Sbe.Mdp.mdincrementalrefreshvolumegroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_incremental_refresh_volume_groups = ProtoField.new("MD Incremental Refresh Volume Groups", "Cme.Sbe.Mdp.mdincrementalrefreshvolumegroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_instrument_definition_future = ProtoField.new("MD Instrument Definition Future", "Cme.Sbe.Mdp.mdinstrumentdefinitionfuture", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_instrument_definition_option = ProtoField.new("MD Instrument Definition Option", "Cme.Sbe.Mdp.mdinstrumentdefinitionoption", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_instrument_definition_spread = ProtoField.new("MD Instrument Definition Spread", "Cme.Sbe.Mdp.mdinstrumentdefinitionspread", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.md_price_level = ProtoField.new("MD Price Level", "Cme.Sbe.Mdp.mdpricelevel", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.md_security_trading_status = ProtoField.new("MD Security Trading Status", "Cme.Sbe.Mdp.mdsecuritytradingstatus", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.md_update_action = ProtoField.new("MD Update Action", "Cme.Sbe.Mdp.mdupdateaction", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.message = ProtoField.new("Message", "Cme.Sbe.Mdp.message", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.message_header = ProtoField.new("Message Header", "Cme.Sbe.Mdp.messageheader", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "Cme.Sbe.Mdp.messagesequencenumber", ftypes.UINT32)
cme_sbe_mdp_5_1_0.fields.message_size = ProtoField.new("Message Size", "Cme.Sbe.Mdp.messagesize", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.min_cab_price = ProtoField.new("Min Cab Price", "Cme.Sbe.Mdp.mincabprice", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.min_lot_size = ProtoField.new("Min Lot Size", "Cme.Sbe.Mdp.minlotsize", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.min_price_increment = ProtoField.new("Min Price Increment", "Cme.Sbe.Mdp.minpriceincrement", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.min_price_increment_amount = ProtoField.new("Min Price Increment Amount", "Cme.Sbe.Mdp.minpriceincrementamount", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.min_trade_vol = ProtoField.new("Min Trade Vol", "Cme.Sbe.Mdp.mintradevol", ftypes.UINT32)
cme_sbe_mdp_5_1_0.fields.month = ProtoField.new("month", "Cme.Sbe.Mdp.month", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.negative_price_outright_eligible = ProtoField.new("Negative Price Outright Eligible", "Cme.Sbe.Mdp.negativepriceoutrighteligible", ftypes.UINT32, nil, base.DEC, "0x00000400")
cme_sbe_mdp_5_1_0.fields.negative_strike_eligible = ProtoField.new("Negative Strike Eligible", "Cme.Sbe.Mdp.negativestrikeeligible", ftypes.UINT32, nil, base.DEC, "0x00000200")
cme_sbe_mdp_5_1_0.fields.null_value = ProtoField.new("Null Value", "Cme.Sbe.Mdp.nullvalue", ftypes.UINT8, nil, base.DEC, "0x80")
cme_sbe_mdp_5_1_0.fields.num_in_group = ProtoField.new("num In Group", "Cme.Sbe.Mdp.numingroup", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.number_of_orders = ProtoField.new("Number Of Orders", "Cme.Sbe.Mdp.numberoforders", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.open_close_settl_flag = ProtoField.new("Open Close Settl Flag", "Cme.Sbe.Mdp.openclosesettlflag", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.open_interest_qty = ProtoField.new("Open Interest Qty", "Cme.Sbe.Mdp.openinterestqty", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.order_cross_eligible = ProtoField.new("Order Cross Eligible", "Cme.Sbe.Mdp.ordercrosseligible", ftypes.UINT32, nil, base.DEC, "0x00000002")
cme_sbe_mdp_5_1_0.fields.order_id = ProtoField.new("Order ID", "Cme.Sbe.Mdp.orderid", ftypes.UINT64)
cme_sbe_mdp_5_1_0.fields.order_qty = ProtoField.new("Order Qty", "Cme.Sbe.Mdp.orderqty", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.original_contract_size = ProtoField.new("Original Contract Size", "Cme.Sbe.Mdp.originalcontractsize", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.otc_eligible = ProtoField.new("OTC Eligible", "Cme.Sbe.Mdp.otceligible", ftypes.UINT32, nil, base.DEC, "0x00000080")
cme_sbe_mdp_5_1_0.fields.packet = ProtoField.new("Packet", "Cme.Sbe.Mdp.packet", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.packet_header = ProtoField.new("Packet Header", "Cme.Sbe.Mdp.packetheader", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.padding_2 = ProtoField.new("Padding 2", "Cme.Sbe.Mdp.padding2", ftypes.BYTES)
cme_sbe_mdp_5_1_0.fields.padding_3 = ProtoField.new("Padding 3", "Cme.Sbe.Mdp.padding3", ftypes.BYTES)
cme_sbe_mdp_5_1_0.fields.padding_4 = ProtoField.new("Padding 4", "Cme.Sbe.Mdp.padding4", ftypes.BYTES)
cme_sbe_mdp_5_1_0.fields.padding_5 = ProtoField.new("Padding 5", "Cme.Sbe.Mdp.padding5", ftypes.BYTES)
cme_sbe_mdp_5_1_0.fields.padding_6 = ProtoField.new("Padding 6", "Cme.Sbe.Mdp.padding6", ftypes.BYTES)
cme_sbe_mdp_5_1_0.fields.padding_7 = ProtoField.new("Padding 7", "Cme.Sbe.Mdp.padding7", ftypes.BYTES)
cme_sbe_mdp_5_1_0.fields.payload = ProtoField.new("Payload", "Cme.Sbe.Mdp.payload", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.price_display_format = ProtoField.new("Price Display Format", "Cme.Sbe.Mdp.pricedisplayformat", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.price_ratio = ProtoField.new("Price Ratio", "Cme.Sbe.Mdp.priceratio", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.put_or_call = ProtoField.new("Put Or Call", "Cme.Sbe.Mdp.putorcall", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.quote_req_id = ProtoField.new("Quote Req ID", "Cme.Sbe.Mdp.quotereqid", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.quote_request = ProtoField.new("Quote Request", "Cme.Sbe.Mdp.quoterequest", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.quote_type = ProtoField.new("Quote Type", "Cme.Sbe.Mdp.quotetype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.recovery_msg = ProtoField.new("Recovery Msg", "Cme.Sbe.Mdp.recoverymsg", ftypes.UINT8, nil, base.DEC, "0x20")
cme_sbe_mdp_5_1_0.fields.related_sym_group = ProtoField.new("Related Sym Group", "Cme.Sbe.Mdp.relatedsymgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.related_sym_groups = ProtoField.new("Related Sym Groups", "Cme.Sbe.Mdp.relatedsymgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.reserved = ProtoField.new("Reserved", "Cme.Sbe.Mdp.reserved", ftypes.UINT8, nil, base.DEC, "0x40")
cme_sbe_mdp_5_1_0.fields.reserved_12 = ProtoField.new("Reserved 12", "Cme.Sbe.Mdp.reserved12", ftypes.UINT32, nil, base.DEC, "0xFFF00000")
cme_sbe_mdp_5_1_0.fields.reserved_bits = ProtoField.new("Reserved Bits", "Cme.Sbe.Mdp.reservedbits", ftypes.UINT8, nil, base.DEC, "0x70")
cme_sbe_mdp_5_1_0.fields.rfq_cross_eligible = ProtoField.new("RFQ Cross Eligible", "Cme.Sbe.Mdp.rfqcrosseligible", ftypes.UINT32, nil, base.DEC, "0x00002000")
cme_sbe_mdp_5_1_0.fields.rounded = ProtoField.new("Rounded", "Cme.Sbe.Mdp.rounded", ftypes.UINT8, nil, base.DEC, "0x04")
cme_sbe_mdp_5_1_0.fields.rpt_seq = ProtoField.new("Rpt Seq", "Cme.Sbe.Mdp.rptseq", ftypes.UINT32)
cme_sbe_mdp_5_1_0.fields.schema_id = ProtoField.new("Schema Id", "Cme.Sbe.Mdp.schemaid", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.security_exchange = ProtoField.new("Security Exchange", "Cme.Sbe.Mdp.securityexchange", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.security_group = ProtoField.new("Security Group", "Cme.Sbe.Mdp.securitygroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.security_id = ProtoField.new("Security ID", "Cme.Sbe.Mdp.securityid", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.security_status = ProtoField.new("Security Status", "Cme.Sbe.Mdp.securitystatus", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.security_sub_type = ProtoField.new("Security Sub Type", "Cme.Sbe.Mdp.securitysubtype", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.security_trading_event = ProtoField.new("Security Trading Event", "Cme.Sbe.Mdp.securitytradingevent", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.security_trading_status = ProtoField.new("Security Trading Status", "Cme.Sbe.Mdp.securitytradingstatus", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.security_type = ProtoField.new("Security Type", "Cme.Sbe.Mdp.securitytype", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.security_update_action = ProtoField.new("Security Update Action", "Cme.Sbe.Mdp.securityupdateaction", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.sending_time = ProtoField.new("Sending Time", "Cme.Sbe.Mdp.sendingtime", ftypes.UINT64)
cme_sbe_mdp_5_1_0.fields.settl_currency = ProtoField.new("Settl Currency", "Cme.Sbe.Mdp.settlcurrency", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.settl_price_type = ProtoField.new("Settl Price Type", "Cme.Sbe.Mdp.settlpricetype", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.side = ProtoField.new("Side", "Cme.Sbe.Mdp.side", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.snapshot_full_refresh = ProtoField.new("Snapshot Full Refresh", "Cme.Sbe.Mdp.snapshotfullrefresh", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.snapshot_full_refresh_group = ProtoField.new("Snapshot Full Refresh Group", "Cme.Sbe.Mdp.snapshotfullrefreshgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.snapshot_full_refresh_groups = ProtoField.new("Snapshot Full Refresh Groups", "Cme.Sbe.Mdp.snapshotfullrefreshgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.strike_currency = ProtoField.new("Strike Currency", "Cme.Sbe.Mdp.strikecurrency", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.strike_price = ProtoField.new("Strike Price", "Cme.Sbe.Mdp.strikeprice", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.sub_fraction = ProtoField.new("Sub Fraction", "Cme.Sbe.Mdp.subfraction", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.symbol = ProtoField.new("Symbol", "Cme.Sbe.Mdp.symbol", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.template_id = ProtoField.new("Template Id", "Cme.Sbe.Mdp.templateid", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.text = ProtoField.new("Text", "Cme.Sbe.Mdp.text", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.tick_rule = ProtoField.new("Tick Rule", "Cme.Sbe.Mdp.tickrule", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp_5_1_0.fields.tot_num_reports = ProtoField.new("Tot Num Reports", "Cme.Sbe.Mdp.totnumreports", ftypes.UINT32)
cme_sbe_mdp_5_1_0.fields.trade_date = ProtoField.new("Trade Date", "Cme.Sbe.Mdp.tradedate", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.trade_id = ProtoField.new("Trade ID", "Cme.Sbe.Mdp.tradeid", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.trading_reference_date = ProtoField.new("Trading Reference Date", "Cme.Sbe.Mdp.tradingreferencedate", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.trading_reference_price = ProtoField.new("Trading Reference Price", "Cme.Sbe.Mdp.tradingreferenceprice", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.transact_time = ProtoField.new("Transact Time", "Cme.Sbe.Mdp.transacttime", ftypes.UINT64)
cme_sbe_mdp_5_1_0.fields.underlying_product = ProtoField.new("Underlying Product", "Cme.Sbe.Mdp.underlyingproduct", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.underlying_security_id = ProtoField.new("Underlying Security ID", "Cme.Sbe.Mdp.underlyingsecurityid", ftypes.INT32)
cme_sbe_mdp_5_1_0.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "Cme.Sbe.Mdp.underlyingsymbol", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.underlyings_group = ProtoField.new("Underlyings Group", "Cme.Sbe.Mdp.underlyingsgroup", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.underlyings_groups = ProtoField.new("Underlyings Groups", "Cme.Sbe.Mdp.underlyingsgroups", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.unit_of_measure = ProtoField.new("Unit Of Measure", "Cme.Sbe.Mdp.unitofmeasure", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.unit_of_measure_qty = ProtoField.new("Unit Of Measure Qty", "Cme.Sbe.Mdp.unitofmeasureqty", ftypes.INT64)
cme_sbe_mdp_5_1_0.fields.user_defined_instrument = ProtoField.new("User Defined Instrument", "Cme.Sbe.Mdp.userdefinedinstrument", ftypes.STRING)
cme_sbe_mdp_5_1_0.fields.variable_product_eligibility = ProtoField.new("Variable Product Eligibility", "Cme.Sbe.Mdp.variableproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00010000")
cme_sbe_mdp_5_1_0.fields.version = ProtoField.new("Version", "Cme.Sbe.Mdp.version", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.volatility_quoted_option = ProtoField.new("Volatility Quoted Option", "Cme.Sbe.Mdp.volatilityquotedoption", ftypes.UINT32, nil, base.DEC, "0x00001000")
cme_sbe_mdp_5_1_0.fields.week = ProtoField.new("week", "Cme.Sbe.Mdp.week", ftypes.UINT8)
cme_sbe_mdp_5_1_0.fields.year = ProtoField.new("year", "Cme.Sbe.Mdp.year", ftypes.UINT16)
cme_sbe_mdp_5_1_0.fields.zero_price_outright_eligible = ProtoField.new("Zero Price Outright Eligible", "Cme.Sbe.Mdp.zeropriceoutrighteligible", ftypes.UINT32, nil, base.DEC, "0x00004000")

-----------------------------------------------------------------------
-- Dissect Cme Sbe Mdp 5.1.0
-----------------------------------------------------------------------
...
dissect.padding_4 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.padding_4, range, value, display)
...
dissect.last_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.last_qty, range, value, display)
...
dissect.order_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.order_id, range, value, display)
...
dissect.num_in_group = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.num_in_group, range, value, display)
...
dissect.padding_5 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.padding_5, range, value, display)
...
dissect.block_length = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.block_length, range, value, display)
...
dissect.padding_6 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.padding_6, range, value, display)
...
dissect.md_update_action = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.md_update_action, range, value, display)
...
dissect.aggressor_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.aggressor_side, range, value, display)
...
dissect.number_of_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.number_of_orders, range, value, display)
...
dissect.rpt_seq = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.rpt_seq, range, value, display)
...
dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_id, range, value, display)
...
dissect.md_entry_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.md_entry_size, range, value, display)
...
dissect.md_entry_px = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.md_entry_px, range, value, display)
...
dissect.padding_2 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.padding_2, range, value, display)
...
dissect.last_trade_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.last_trade_msg, range, display)
...
dissect.last_volume_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.last_volume_msg, range, display)
...
dissect.last_quote_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.last_quote_msg, range, display)
...
dissect.last_stats_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.last_stats_msg, range, display)
...
dissect.last_implied_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.last_implied_msg, range, display)
...
dissect.recovery_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.recovery_msg, range, display)
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.reserved, range, display)
...
dissect.end_of_event = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.end_of_event, range, display)
...
dissect.match_event_indicator_bits = function(buffer, offset, packet, parent)
  ...
  -- End Of Event: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.end_of_event, buffer(offset + 0, 1))

  -- Reserved: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.reserved, buffer(offset + 0, 1))

  -- Recovery Msg: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.recovery_msg, buffer(offset + 0, 1))

  -- Last Implied Msg: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.last_implied_msg, buffer(offset + 0, 1))

  -- Last Stats Msg: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.last_stats_msg, buffer(offset + 0, 1))

  -- Last Quote Msg: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.last_quote_msg, buffer(offset + 0, 1))

  -- Last Volume Msg: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.last_volume_msg, buffer(offset + 0, 1))

  -- Last Trade Msg: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.last_trade_msg, buffer(offset + 0, 1))
end
...
dissect.match_event_indicator = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.match_event_indicator, range, display)
...
dissect.transact_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.transact_time, range, value, display)
...
dissect.underlying_symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.underlying_symbol, range, value, display)
...
dissect.underlying_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.underlying_security_id, range, value, display)
...
dissect.min_lot_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.min_lot_size, range, value, display)
...
dissect.lot_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.lot_type, range, value, display)
...
dissect.electronic_match_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.electronic_match_eligible, range, display)
...
dissect.order_cross_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.order_cross_eligible, range, display)
...
dissect.block_trade_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.block_trade_eligible, range, display)
...
dissect.efp_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.efp_eligible, range, display)
...
dissect.ebf_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.ebf_eligible, range, display)
...
dissect.efs_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.efs_eligible, range, display)
...
dissect.efr_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.efr_eligible, range, display)
...
dissect.otc_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.otc_eligible, range, display)
...
dissect.i_link_indicative_mass_quoting_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.i_link_indicative_mass_quoting_eligible, range, display)
...
dissect.negative_strike_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.negative_strike_eligible, range, display)
...
dissect.negative_price_outright_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.negative_price_outright_eligible, range, display)
...
dissect.is_fractional = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.is_fractional, range, display)
...
dissect.volatility_quoted_option = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.volatility_quoted_option, range, display)
...
dissect.rfq_cross_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.rfq_cross_eligible, range, display)
...
dissect.zero_price_outright_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.zero_price_outright_eligible, range, display)
...
dissect.decaying_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.decaying_product_eligibility, range, display)
...
dissect.variable_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.variable_product_eligibility, range, display)
...
dissect.daily_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.daily_product_eligibility, range, display)
...
dissect.gt_orders_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.gt_orders_eligibility, range, display)
...
dissect.implied_matching_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.implied_matching_eligibility, range, display)
...
dissect.reserved_12 = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.reserved_12, range, display)
...
dissect.inst_attrib_value_bits = function(buffer, offset, packet, parent)
  ...
  -- Reserved 12: 12 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.reserved_12, buffer(offset + 0, 4))

  -- Implied Matching Eligibility: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.implied_matching_eligibility, buffer(offset + 0, 4))

  -- GT Orders Eligibility: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.gt_orders_eligibility, buffer(offset + 0, 4))

  -- Daily Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.daily_product_eligibility, buffer(offset + 0, 4))

  -- Variable Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.variable_product_eligibility, buffer(offset + 0, 4))

  -- Decaying Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.decaying_product_eligibility, buffer(offset + 0, 4))

  -- Zero Price Outright Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.zero_price_outright_eligible, buffer(offset + 0, 4))

  -- RFQ Cross Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.rfq_cross_eligible, buffer(offset + 0, 4))

  -- Volatility Quoted Option: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.volatility_quoted_option, buffer(offset + 0, 4))

  -- Is Fractional: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.is_fractional, buffer(offset + 0, 4))

  -- Negative Price Outright Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.negative_price_outright_eligible, buffer(offset + 0, 4))

  -- Negative Strike Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.negative_strike_eligible, buffer(offset + 0, 4))

  -- i Link Indicative Mass Quoting Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.i_link_indicative_mass_quoting_eligible, buffer(offset + 0, 4))

  -- OTC Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.otc_eligible, buffer(offset + 0, 4))

  -- EFR Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.efr_eligible, buffer(offset + 0, 4))

  -- EFS Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.efs_eligible, buffer(offset + 0, 4))

  -- EBF Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.ebf_eligible, buffer(offset + 0, 4))

  -- EFP Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.efp_eligible, buffer(offset + 0, 4))

  -- Block Trade Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.block_trade_eligible, buffer(offset + 0, 4))

  -- Order Cross Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.order_cross_eligible, buffer(offset + 0, 4))

  -- Electronic Match Eligible: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.electronic_match_eligible, buffer(offset + 0, 4))
end
...
dissect.inst_attrib_value = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.inst_attrib_value, range, display)
...
dissect.market_depth = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.market_depth, range, value, display)
...
dissect.md_feed_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.md_feed_type, range, value, display)
...
dissect.event_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.event_time, range, value, display)
...
dissect.event_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.event_type, range, value, display)
...
dissect.user_defined_instrument = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.user_defined_instrument, range, value, display)
...
dissect.high_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.high_limit_price, range, value, display)
...
dissect.low_limit_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.low_limit_price, range, value, display)
...
dissect.open_interest_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.open_interest_qty, range, value, display)
...
dissect.cleared_volume = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.cleared_volume, range, value, display)
...
dissect.final = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.final, range, display)
...
dissect.actual = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.actual, range, display)
...
dissect.rounded = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.rounded, range, display)
...
dissect.intraday = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.intraday, range, display)
...
dissect.reserved_bits = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.reserved_bits, range, display)
...
dissect.null_value = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.null_value, range, display)
...
dissect.settl_price_type_bits = function(buffer, offset, packet, parent)
  ...
  -- Null Value: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.null_value, buffer(offset + 0, 1))

  -- Reserved Bits: 3 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.reserved_bits, buffer(offset + 0, 1))

  -- Intraday: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.intraday, buffer(offset + 0, 1))

  -- Rounded: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.rounded, buffer(offset + 0, 1))

  -- Actual: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.actual, buffer(offset + 0, 1))

  -- Final: 1 Bit
  parent:add(cme_sbe_mdp_5_1_0.fields.final, buffer(offset + 0, 1))
end
...
dissect.settl_price_type = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.settl_price_type, range, display)
...
dissect.trading_reference_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.trading_reference_price, range, value, display)
...
dissect.unit_of_measure_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.unit_of_measure_qty, range, value, display)
...
dissect.unit_of_measure = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.unit_of_measure, range, value, display)
...
dissect.price_display_format = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.price_display_format, range, value, display)
...
dissect.sub_fraction = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.sub_fraction, range, value, display)
...
dissect.main_fraction = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.main_fraction, range, value, display)
...
dissect.tick_rule = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.tick_rule, range, value, display)
...
dissect.display_factor = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.display_factor, range, value, display)
...
dissect.min_price_increment_amount = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.min_price_increment_amount, range, value, display)
...
dissect.min_price_increment = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.min_price_increment, range, value, display)
...
dissect.max_trade_vol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.max_trade_vol, range, value, display)
...
dissect.min_trade_vol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.min_trade_vol, range, value, display)
...
dissect.match_algorithm = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.match_algorithm, range, value, display)
...
dissect.min_cab_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.min_cab_price, range, value, display)
...
dissect.settl_currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.settl_currency, range, value, display)
...
dissect.strike_currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.strike_currency, range, value, display)
...
dissect.strike_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.strike_price, range, value, display)
...
dissect.currency = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.currency, range, value, display)
...
dissect.week = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.week, range, value, display)
...
dissect.day = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.day, range, value, display)
...
dissect.month = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.month, range, value, display)
...
dissect.year = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.year, range, value, display)
...
dissect.put_or_call = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.put_or_call, range, value, display)
...
dissect.cfi_code = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.cfi_code, range, value, display)
...
dissect.security_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_type, range, value, display)
...
dissect.symbol = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.symbol, range, value, display)
...
dissect.asset = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.asset, range, value, display)
...
dissect.security_group = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_group, range, value, display)
...
dissect.security_exchange = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_exchange, range, value, display)
...
dissect.underlying_product = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.underlying_product, range, value, display)
...
dissect.market_segment_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.market_segment_id, range, value, display)
...
dissect.appl_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.appl_id, range, value, display)
...
dissect.md_security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.md_security_trading_status, range, value, display)
...
dissect.last_update_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.last_update_time, range, value, display)
...
dissect.security_update_action = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_update_action, range, value, display)
...
dissect.tot_num_reports = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.tot_num_reports, range, value, display)
...
dissect.side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.side, range, value, display)
...
dissect.quote_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.quote_type, range, value, display)
...
dissect.order_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.order_qty, range, value, display)
...
dissect.padding_3 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.padding_3, range, value, display)
...
dissect.quote_req_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.quote_req_id, range, value, display)
...
dissect.md_entry_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.md_entry_type, range, value, display)
...
dissect.open_close_settl_flag = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.open_close_settl_flag, range, value, display)
...
dissect.trading_reference_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.trading_reference_date, range, value, display)
...
dissect.md_price_level = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.md_price_level, range, value, display)
...
dissect.max_price_variation = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.max_price_variation, range, value, display)
...
dissect.trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.trade_date, range, value, display)
...
dissect.last_msg_seq_num_processed = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.last_msg_seq_num_processed, range, value, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.trade_id, range, value, display)
...
dissect.padding_7 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.padding_7, range, value, display)
...
dissect.security_trading_event = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_trading_event, range, value, display)
...
dissect.halt_reason = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.halt_reason, range, value, display)
...
dissect.security_trading_status = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_trading_status, range, value, display)
...
dissect.leg_option_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.leg_option_delta, range, value, display)
...
dissect.leg_price = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.leg_price, range, value, display)
...
dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.leg_ratio_qty, range, value, display)
...
dissect.leg_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.leg_side, range, value, display)
...
dissect.leg_security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.leg_security_id, range, value, display)
...
dissect.price_ratio = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.price_ratio, range, value, display)
...
dissect.security_sub_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.security_sub_type, range, value, display)
...
dissect.flow_schedule_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.flow_schedule_type, range, value, display)
...
dissect.contract_multiplier_unit = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.contract_multiplier_unit, range, value, display)
...
dissect.contract_multiplier = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.contract_multiplier, range, value, display)
...
dissect.original_contract_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.original_contract_size, range, value, display)
...
dissect.decay_start_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.decay_start_date, range, value, display)
...
dissect.decay_quantity = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.decay_quantity, range, value, display)
...
dissect.text = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.text, range, value, display)
...
dissect.heart_bt_int = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.heart_bt_int, range, value, display)
...
dissect.payload = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp_5_1_0.fields.payload, range, display)
...
dissect.version = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.version, range, value, display)
...
dissect.schema_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.schema_id, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.template_id, range, value, display)
...
dissect.message_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.message_size, range, value, display)
...
dissect.sending_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.sending_time, range, value, display)
...
dissect.message_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp_5_1_0.fields.message_sequence_number, range, value, display)
...
function cme_sbe_mdp_5_1_0.init()
end

-- Dissector for Cme Sbe Mdp 5.1.0
function cme_sbe_mdp_5_1_0.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = cme_sbe_mdp_5_1_0.name

  -- Dissect protocol
  local protocol = parent:add(cme_sbe_mdp_5_1_0, buffer(), cme_sbe_mdp_5_1_0.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, cme_sbe_mdp_5_1_0)
...
verify.cme_sbe_mdp_5_1_0_packet_size = function(buffer)
...
-- Dissector Heuristic for Cme Sbe Mdp 5.1.0
local function cme_sbe_mdp_5_1_0_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.cme_sbe_mdp_5_1_0_packet_size(buffer) then return false end

  -- Verify Version
  if not verify.version(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = cme_sbe_mdp_5_1_0
  cme_sbe_mdp_5_1_0.dissector(buffer, packet, parent)

  return true
end

-- Register Cme Sbe Mdp 5.1.0 Heuristic
cme_sbe_mdp_5_1_0:register_heuristic("udp", cme_sbe_mdp_5_1_0_heuristic)
