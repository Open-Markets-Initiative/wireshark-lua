...
omi_cme_futures_mdp3_sbe_v1_6.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "cme.futures.mdp3.sbe.v1.6.messagesequencenumber", ftypes.UINT32)
...
omi_cme_futures_mdp3_sbe_v1_6.fields.min_price_increment_price = ProtoField.new("Min Price Increment Price", "cme.futures.mdp3.sbe.v1.6.minpriceincrementprice", ftypes.DOUBLE)
omi_cme_futures_mdp3_sbe_v1_6.fields.min_price_increment_pricenull = ProtoField.new("Min Price Increment Pricenull", "cme.futures.mdp3.sbe.v1.6.minpriceincrementpricenull", ftypes.DOUBLE)
...
cme_futures_mdp3_sbe_v1_6_dissect.min_price_increment_pricenull = function(buffer, offset, packet, parent)
  ...
  parent:add(omi_cme_futures_mdp3_sbe_v1_6.fields.min_price_increment_pricenull, range, value, display)
...
cme_futures_mdp3_sbe_v1_6_dissect.min_price_increment_price = function(buffer, offset, packet, parent)
  ...
  parent:add(omi_cme_futures_mdp3_sbe_v1_6.fields.min_price_increment_price, range, value, display)
...
cme_futures_mdp3_sbe_v1_6_dissect.message_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(omi_cme_futures_mdp3_sbe_v1_6.fields.message_sequence_number, range, value, display)
...
verify.omi_cme_futures_mdp3_sbe_v1_6_packet_size = function(buffer)
...
local function omi_cme_futures_mdp3_sbe_v1_6_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_cme_futures_mdp3_sbe_v1_6_packet_size(buffer) then return false end
