...
verify.omi_cme_futures_ilink3_sbe_v8_5_packet_size = function(buffer)
...
local function omi_cme_futures_ilink3_sbe_v8_5_heuristic(buffer, packet, parent)
  ...
  if not verify.omi_cme_futures_ilink3_sbe_v8_5_packet_size(buffer) then return false end
