...
cme_futures_ilink3_sbe_v8_6.fields.cmta_give_up_cd = ProtoField.new("Cmta Give Up Cd", "cme.futures.ilink3.sbe.v8.6.cmtagiveupcd", ftypes.STRING)
...
cme_futures_ilink3_sbe_v8_6.fields.cross_type = ProtoField.new("Cross Type", "cme.futures.ilink3.sbe.v8.6.crosstype", ftypes.STRING)
...
cme_futures_ilink3_sbe_v8_6.fields.hmac_signature = ProtoField.new("Hmac Signature", "cme.futures.ilink3.sbe.v8.6.hmacsignature", ftypes.STRING)
...
cme_futures_ilink3_sbe_v8_6.fields.length = ProtoField.new("Length", "cme.futures.ilink3.sbe.v8.6.length", ftypes.UINT16)
...
cme_futures_ilink3_sbe_v8_6.fields.mantissa32 = ProtoField.new("Mantissa32", "cme.futures.ilink3.sbe.v8.6.mantissa32", ftypes.INT32)
cme_futures_ilink3_sbe_v8_6.fields.mantissa64 = ProtoField.new("Mantissa64", "cme.futures.ilink3.sbe.v8.6.mantissa64", ftypes.INT64)
...
cme_futures_ilink3_sbe_v8_6.fields.msg_count = ProtoField.new("Msg Count", "cme.futures.ilink3.sbe.v8.6.msgcount", ftypes.UINT16)
...
cme_futures_ilink3_sbe_v8_6.fields.quote_status = ProtoField.new("Quote Status", "cme.futures.ilink3.sbe.v8.6.quotestatus", ftypes.UINT8)
...
cme_futures_ilink3_sbe_v8_6.fields.var_data = ProtoField.new("Var Data", "cme.futures.ilink3.sbe.v8.6.vardata", ftypes.STRING)
...
display.leaves_qty = function(value)
  -- Check if field has value
  if value == 4294967295 then
    return "Leaves Qty: No Value ("..value..")"
  end
...
dissect.execution_report_pending_replace_565_fields = function(buffer, offset, packet, parent)
  ...
  -- Leaves Qty: 4 Byte Unsigned Fixed Width Integer Nullable
  ...
  -- Time In Force: 1 Byte Unsigned Fixed Width Integer Enum with 11 values
  ...
  -- Discretion Price: 8 Byte Signed Fixed Width Integer
...
dissect.quote_status = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_6.fields.quote_status, range, value, display)
...
dissect.mantissa32 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_6.fields.mantissa32, range, value, display)
...
dissect.mantissa64 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_6.fields.mantissa64, range, value, display)
...
dissect.execution_report_trade_addendum_spread_leg_550_fields = function(buffer, offset, packet, parent)
  ...
  -- Ord Status: 1 Byte Ascii String Enum with 12 values
...
dissect.execution_report_trade_addendum_outright_548_fields = function(buffer, offset, packet, parent)
  ...
  -- Benchmark Price: 8 Byte Signed Fixed Width Integer
...
dissect.cmta_give_up_cd = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_6.fields.cmta_give_up_cd, range, value, display)
...
dissect.length = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_6.fields.length, range, value, display)
