...
cme_mdp3_sbe_v6_1.prefs.show_admin_login = Pref.bool("Show Admin Login", show.admin_login, "Parse and add Admin Login to protocol tree")
cme_mdp3_sbe_v6_1.prefs.show_admin_logout = Pref.bool("Show Admin Logout", show.admin_logout, "Parse and add Admin Logout to protocol tree")
cme_mdp3_sbe_v6_1.prefs.show_channel_reset = Pref.bool("Show Channel Reset", show.channel_reset, "Parse and add Channel Reset to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_book = Pref.bool("Show MD Incremental Refresh Book", show.md_incremental_refresh_book, "Parse and add MD Incremental Refresh Book to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_daily_statistics = Pref.bool("Show MD Incremental Refresh Daily Statistics", show.md_incremental_refresh_daily_statistics, "Parse and add MD Incremental Refresh Daily Statistics to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_limits_banding = Pref.bool("Show MD Incremental Refresh Limits Banding", show.md_incremental_refresh_limits_banding, "Parse and add MD Incremental Refresh Limits Banding to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_session_statistics = Pref.bool("Show MD Incremental Refresh Session Statistics", show.md_incremental_refresh_session_statistics, "Parse and add MD Incremental Refresh Session Statistics to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_trade = Pref.bool("Show MD Incremental Refresh Trade", show.md_incremental_refresh_trade, "Parse and add MD Incremental Refresh Trade to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_trade_summary = Pref.bool("Show MD Incremental Refresh Trade Summary", show.md_incremental_refresh_trade_summary, "Parse and add MD Incremental Refresh Trade Summary to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_volume = Pref.bool("Show MD Incremental Refresh Volume", show.md_incremental_refresh_volume, "Parse and add MD Incremental Refresh Volume to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_future = Pref.bool("Show MD Instrument Definition Future", show.md_instrument_definition_future, "Parse and add MD Instrument Definition Future to protocol tree")
cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_option = Pref.bool("Show MD Instrument Definition Option", show.md_instrument_definition_option, "Parse and add MD Instrument Definition Option to protocol tree")
cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_spread = Pref.bool("Show MD Instrument Definition Spread", show.md_instrument_definition_spread, "Parse and add MD Instrument Definition Spread to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_quote_request = Pref.bool("Show Quote Request", show.quote_request, "Parse and add Quote Request to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_security_status = Pref.bool("Show Security Status", show.security_status, "Parse and add Security Status to protocol tree")
...
cme_mdp3_sbe_v6_1.prefs.show_snapshot_full_refresh = Pref.bool("Show Snapshot Full Refresh", show.snapshot_full_refresh, "Parse and add Snapshot Full Refresh to protocol tree")
...
function cme_mdp3_sbe_v6_1.prefs_changed()
  ...
  if show.admin_login ~= cme_mdp3_sbe_v6_1.prefs.show_admin_login then
    show.admin_login = cme_mdp3_sbe_v6_1.prefs.show_admin_login
    changed = true
  end
  if show.admin_logout ~= cme_mdp3_sbe_v6_1.prefs.show_admin_logout then
    show.admin_logout = cme_mdp3_sbe_v6_1.prefs.show_admin_logout
    changed = true
  end
  if show.channel_reset ~= cme_mdp3_sbe_v6_1.prefs.show_channel_reset then
    show.channel_reset = cme_mdp3_sbe_v6_1.prefs.show_channel_reset
    changed = true
  end
  ...
  if show.md_incremental_refresh_book ~= cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_book then
    show.md_incremental_refresh_book = cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_book
    changed = true
  end
  ...
  if show.md_incremental_refresh_daily_statistics ~= cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_daily_statistics then
    show.md_incremental_refresh_daily_statistics = cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_daily_statistics
    changed = true
  end
  ...
  if show.md_incremental_refresh_limits_banding ~= cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_limits_banding then
    show.md_incremental_refresh_limits_banding = cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_limits_banding
    changed = true
  end
  ...
  if show.md_incremental_refresh_session_statistics ~= cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_session_statistics then
    show.md_incremental_refresh_session_statistics = cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_session_statistics
    changed = true
  end
  ...
  if show.md_incremental_refresh_trade ~= cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_trade then
    show.md_incremental_refresh_trade = cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_trade
    changed = true
  end
  ...
  if show.md_incremental_refresh_trade_summary ~= cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_trade_summary then
    show.md_incremental_refresh_trade_summary = cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_trade_summary
    changed = true
  end
  ...
  if show.md_incremental_refresh_volume ~= cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_volume then
    show.md_incremental_refresh_volume = cme_mdp3_sbe_v6_1.prefs.show_md_incremental_refresh_volume
    changed = true
  end
  ...
  if show.md_instrument_definition_future ~= cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_future then
    show.md_instrument_definition_future = cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_future
    changed = true
  end
  if show.md_instrument_definition_option ~= cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_option then
    show.md_instrument_definition_option = cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_option
    changed = true
  end
  if show.md_instrument_definition_spread ~= cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_spread then
    show.md_instrument_definition_spread = cme_mdp3_sbe_v6_1.prefs.show_md_instrument_definition_spread
    changed = true
  end
  ...
  if show.quote_request ~= cme_mdp3_sbe_v6_1.prefs.show_quote_request then
    show.quote_request = cme_mdp3_sbe_v6_1.prefs.show_quote_request
    changed = true
  end
  ...
  if show.security_status ~= cme_mdp3_sbe_v6_1.prefs.show_security_status then
    show.security_status = cme_mdp3_sbe_v6_1.prefs.show_security_status
    changed = true
  end
  ...
  if show.snapshot_full_refresh ~= cme_mdp3_sbe_v6_1.prefs.show_snapshot_full_refresh then
    show.snapshot_full_refresh = cme_mdp3_sbe_v6_1.prefs.show_snapshot_full_refresh
    changed = true
  end
