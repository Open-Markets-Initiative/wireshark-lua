...
local omi_cme_ebs_spectrum_sbe_v12_0 = Proto("Cme.Ebs.Spectrum.Sbe.v12.0.Lua", "Cme Ebs Spectrum Sbe 12.0")

-- Protocol table
local cme_ebs_spectrum_sbe_v12_0 = {}
...
omi_cme_ebs_spectrum_sbe_v12_0.fields.aggressor_side = ProtoField.new("Aggressor Side", "cme.ebs.spectrum.sbe.v12.0.aggressorside", ftypes.UINT8)
omi_cme_ebs_spectrum_sbe_v12_0.fields.binary_packet_header = ProtoField.new("Binary Packet Header", "cme.ebs.spectrum.sbe.v12.0.binarypacketheader", ftypes.STRING)
...
omi_cme_ebs_spectrum_sbe_v12_0.fields.md_entry_type_spectrum_entry_type = ProtoField.new("Md Entry Type Spectrum Entry Type", "cme.ebs.spectrum.sbe.v12.0.mdentrytypespectrumentrytype", ftypes.STRING)
...
-- Cme Ebs Spectrum 12.0 Application Messages
...
omi_cme_ebs_spectrum_sbe_v12_0.fields.md_snapshot_refresh_spectrum = ProtoField.new("Md Snapshot Refresh Spectrum", "cme.ebs.spectrum.sbe.v12.0.mdsnapshotrefreshspectrum", ftypes.STRING)
...
omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_incremental_refresh_spectrum_group_index = Pref.bool("Show Incremental Refresh Spectrum Group Index", show.incremental_refresh_spectrum_group_index, "Show generated incremental refresh spectrum group index in protocol tree")
omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_incremental_refresh_ticker_group_index = Pref.bool("Show Incremental Refresh Ticker Group Index", show.incremental_refresh_ticker_group_index, "Show generated incremental refresh ticker group index in protocol tree")
omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_snapshot_refresh_spectrum_group_index = Pref.bool("Show Snapshot Refresh Spectrum Group Index", show.snapshot_refresh_spectrum_group_index, "Show generated snapshot refresh spectrum group index in protocol tree")
omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_snapshot_refresh_ticker_group_index = Pref.bool("Show Snapshot Refresh Ticker Group Index", show.snapshot_refresh_ticker_group_index, "Show generated snapshot refresh ticker group index in protocol tree")

-- Handle changed preferences
function omi_cme_ebs_spectrum_sbe_v12_0.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_application_messages then
    show.application_messages = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_application_messages
  end
  if show.binary_packet_header ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_binary_packet_header then
    show.binary_packet_header = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_binary_packet_header
  end
  if show.group_size ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_group_size then
  ...
  if show.message ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_message then
    show.message = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_message
  end
  if show.message_header ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_message_header then
    show.message_header = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_message_header
  end
  ...
  if show.incremental_refresh_spectrum_group_index ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_incremental_refresh_spectrum_group_index then
    show.incremental_refresh_spectrum_group_index = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_incremental_refresh_spectrum_group_index
  end
  if show.incremental_refresh_ticker_group_index ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_incremental_refresh_ticker_group_index then
    show.incremental_refresh_ticker_group_index = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_incremental_refresh_ticker_group_index
  end
  if show.snapshot_refresh_spectrum_group_index ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_snapshot_refresh_spectrum_group_index then
    show.snapshot_refresh_spectrum_group_index = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_snapshot_refresh_spectrum_group_index
  end
  if show.snapshot_refresh_ticker_group_index ~= omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_snapshot_refresh_ticker_group_index then
    show.snapshot_refresh_ticker_group_index = omi_cme_ebs_spectrum_sbe_v12_0.prefs.show_snapshot_refresh_ticker_group_index
  end
end
...
cme_ebs_spectrum_sbe_v12_0.aggressor_side.display = function(value)
  if value == 255 then
...
cme_ebs_spectrum_sbe_v12_0.aggressor_side.dissect = function(buffer, offset, packet, parent)
  local length = cme_ebs_spectrum_sbe_v12_0.aggressor_side.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_ebs_spectrum_sbe_v12_0.aggressor_side.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.aggressor_side, range, value, display)
...
-- Display: Md Entry Px
cme_ebs_spectrum_sbe_v12_0.md_entry_px.display = function(raw, value)
...
-- Dissect: Md Entry Px
cme_ebs_spectrum_sbe_v12_0.md_entry_px.dissect = function(buffer, offset, packet, parent)
...
cme_ebs_spectrum_sbe_v12_0.md_entry_type_ticker_entry_type.display = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_ebs_spectrum_sbe_v12_0.md_entry_type_ticker_entry_type.dissect = function(buffer, offset, packet, parent)
  local length = cme_ebs_spectrum_sbe_v12_0.md_entry_type_ticker_entry_type.size
  local range = buffer(offset, length)
  ...
  local display = cme_ebs_spectrum_sbe_v12_0.md_entry_type_ticker_entry_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.md_entry_type_ticker_entry_type, range, value, display)
...
-- Dissect: Group Size
cme_ebs_spectrum_sbe_v12_0.group_size.dissect = function(buffer, offset, packet, parent)
  if show.group_size then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.group_size, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.group_size.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.group_size.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_ebs_spectrum_sbe_v12_0.group_size.fields(buffer, offset, packet, parent)
  end
end
...
cme_ebs_spectrum_sbe_v12_0.snapshot_refresh_ticker_groups.dissect = function(buffer, offset, packet, parent)
  if show.snapshot_refresh_ticker_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.snapshot_refresh_ticker_groups, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.snapshot_refresh_ticker_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.snapshot_refresh_ticker_groups.display(packet, parent, length)
    parent:append_text(display)
...
cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_ticker.size = function(buffer, offset)
  local index = 0
...
cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_ticker.display = function(packet, parent, length)
  return ""
end
...
cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_ticker.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.md_snapshot_refresh_ticker, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_ticker.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_ticker.display(packet, parent, length)
    parent:append_text(display)
...
cme_ebs_spectrum_sbe_v12_0.snapshot_refresh_spectrum_groups.dissect = function(buffer, offset, packet, parent)
  if show.snapshot_refresh_spectrum_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.snapshot_refresh_spectrum_groups, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.snapshot_refresh_spectrum_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.snapshot_refresh_spectrum_groups.display(packet, parent, length)
    parent:append_text(display)
...
cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_spectrum = {}

-- Calculate size of: Md Snapshot Refresh Spectrum
cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_spectrum.size = function(buffer, offset)
  local index = 0
...
cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_spectrum.display = function(packet, parent, length)
  return ""
end
...
cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_spectrum.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.md_snapshot_refresh_spectrum, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_spectrum.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_spectrum.display(packet, parent, length)
    parent:append_text(display)
...
cme_ebs_spectrum_sbe_v12_0.incremental_refresh_ticker_groups.dissect = function(buffer, offset, packet, parent)
  if show.incremental_refresh_ticker_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.incremental_refresh_ticker_groups, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.incremental_refresh_ticker_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.incremental_refresh_ticker_groups.display(packet, parent, length)
    parent:append_text(display)
...
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_ticker = {}

-- Calculate size of: Md Incremental Refresh Ticker
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_ticker.size = function(buffer, offset)
  local index = 0
...
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_ticker.display = function(packet, parent, length)
  return ""
end
...
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_ticker.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.md_incremental_refresh_ticker, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_ticker.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_ticker.display(packet, parent, length)
    parent:append_text(display)
...
cme_ebs_spectrum_sbe_v12_0.incremental_refresh_spectrum_groups.dissect = function(buffer, offset, packet, parent)
  if show.incremental_refresh_spectrum_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.incremental_refresh_spectrum_groups, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.incremental_refresh_spectrum_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.incremental_refresh_spectrum_groups.display(packet, parent, length)
    parent:append_text(display)
...
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum = {}

-- Calculate size of: Md Incremental Refresh Spectrum
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum.size = function(buffer, offset)
  local index = 0
...
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum.display = function(packet, parent, length)
  return ""
end
...
cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.md_incremental_refresh_spectrum, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum.fields(buffer, offset, packet, parent)
  end
end

-- Payload
cme_ebs_spectrum_sbe_v12_0.payload = {}
...
cme_ebs_spectrum_sbe_v12_0.payload.dissect = function(buffer, offset, packet, parent, template_id)
  ...
  if template_id == 303 then
    return cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_spectrum.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Md Incremental Refresh Ticker
  if template_id == 304 then
    return cme_ebs_spectrum_sbe_v12_0.md_incremental_refresh_ticker.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Md Snapshot Refresh Spectrum
  if template_id == 305 then
    return cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_spectrum.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Md Snapshot Refresh Ticker
  if template_id == 306 then
    return cme_ebs_spectrum_sbe_v12_0.md_snapshot_refresh_ticker.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Global Day Roll
  if template_id == 307 then
    return cme_ebs_spectrum_sbe_v12_0.global_day_roll.dissect(buffer, offset, packet, parent)
  end
...
cme_ebs_spectrum_sbe_v12_0.message_header.dissect = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.message_header, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.message_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.message_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_ebs_spectrum_sbe_v12_0.message_header.fields(buffer, offset, packet, parent)
  end
end
...
-- Display: Message
cme_ebs_spectrum_sbe_v12_0.message.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message
cme_ebs_spectrum_sbe_v12_0.message.fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset

  -- Message Size: 2 Byte Unsigned Fixed Width Integer
  index, message_size = cme_ebs_spectrum_sbe_v12_0.message_size.dissect(buffer, index, packet, parent)

  -- Message Header: Struct of 4 fields
  index, message_header = cme_ebs_spectrum_sbe_v12_0.message_header.dissect(buffer, index, packet, parent)

  -- Dependency element: Template Id
  local template_id = buffer(index - 6, 2):le_uint()

  -- Payload: Runtime Type with 6 branches
  index = cme_ebs_spectrum_sbe_v12_0.payload.dissect(buffer, index, packet, parent, template_id)

  return index
end

-- Dissect: Message
cme_ebs_spectrum_sbe_v12_0.message.dissect = function(buffer, offset, packet, parent, size_of_message)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.message, buffer(offset, 0))
    local current = cme_ebs_spectrum_sbe_v12_0.message.fields(buffer, offset, packet, parent, size_of_message)
    parent:set_len(size_of_message)
    local display = cme_ebs_spectrum_sbe_v12_0.message.display(buffer, packet, parent)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    cme_ebs_spectrum_sbe_v12_0.message.fields(buffer, offset, packet, parent, size_of_message)
...
cme_ebs_spectrum_sbe_v12_0.binary_packet_header.dissect = function(buffer, offset, packet, parent)
  if show.binary_packet_header then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_ebs_spectrum_sbe_v12_0.fields.binary_packet_header, buffer(offset, 0))
    local index = cme_ebs_spectrum_sbe_v12_0.binary_packet_header.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_ebs_spectrum_sbe_v12_0.binary_packet_header.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_ebs_spectrum_sbe_v12_0.binary_packet_header.fields(buffer, offset, packet, parent)
  end
end

-- Packet
cme_ebs_spectrum_sbe_v12_0.packet = {}

-- Dissect Packet
cme_ebs_spectrum_sbe_v12_0.packet.dissect = function(buffer, packet, parent)
  local index = 0

  -- Binary Packet Header: Struct of 2 fields
  index, binary_packet_header = cme_ebs_spectrum_sbe_v12_0.binary_packet_header.dissect(buffer, index, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = cme_ebs_spectrum_sbe_v12_0.message.dissect(buffer, index, packet, parent, message_size)
  end
...
function omi_cme_ebs_spectrum_sbe_v12_0.init()
end

-- Dissector for Cme Ebs Spectrum Sbe 12.0
function omi_cme_ebs_spectrum_sbe_v12_0.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = omi_cme_ebs_spectrum_sbe_v12_0.name

  -- Dissect protocol
  local protocol = parent:add(omi_cme_ebs_spectrum_sbe_v12_0, buffer(), omi_cme_ebs_spectrum_sbe_v12_0.description, "("..buffer:len().." Bytes)")
  return cme_ebs_spectrum_sbe_v12_0.packet.dissect(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, omi_cme_ebs_spectrum_sbe_v12_0)
...
local function omi_cme_ebs_spectrum_sbe_v12_0_heuristic(buffer, packet, parent)
  ...
  omi_cme_ebs_spectrum_sbe_v12_0.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Cme Ebs Spectrum Sbe 12.0
omi_cme_ebs_spectrum_sbe_v12_0:register_heuristic("udp", omi_cme_ebs_spectrum_sbe_v12_0_heuristic)
