...
omi_cme_futures_streamlined_sbe_v5_8.fields.actual = ProtoField.new("Actual", "cme.futures.streamlined.sbe.v5.8.actual", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.end_of_event = ProtoField.new("End Of Event", "cme.futures.streamlined.sbe.v5.8.endofevent", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_feed_types_group = ProtoField.new("Eris Feed Types Group", "cme.futures.streamlined.sbe.v5.8.erisfeedtypesgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_feed_types_groups = ProtoField.new("Eris Feed Types Groups", "cme.futures.streamlined.sbe.v5.8.erisfeedtypesgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_group = ProtoField.new("Eris Group", "cme.futures.streamlined.sbe.v5.8.erisgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_groups = ProtoField.new("Eris Groups", "cme.futures.streamlined.sbe.v5.8.erisgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_legs_group = ProtoField.new("Eris Legs Group", "cme.futures.streamlined.sbe.v5.8.erislegsgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_legs_groups = ProtoField.new("Eris Legs Groups", "cme.futures.streamlined.sbe.v5.8.erislegsgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_original_group = ProtoField.new("Eris Original Group", "cme.futures.streamlined.sbe.v5.8.erisoriginalgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_original_groups = ProtoField.new("Eris Original Groups", "cme.futures.streamlined.sbe.v5.8.erisoriginalgroups", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_reference_data_group = ProtoField.new("Eris Reference Data Group", "cme.futures.streamlined.sbe.v5.8.erisreferencedatagroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_reference_data_groups = ProtoField.new("Eris Reference Data Groups", "cme.futures.streamlined.sbe.v5.8.erisreferencedatagroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_security_alt_id_group = ProtoField.new("Eris Security Alt Id Group", "cme.futures.streamlined.sbe.v5.8.erissecurityaltidgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_security_alt_id_groups = ProtoField.new("Eris Security Alt Id Groups", "cme.futures.streamlined.sbe.v5.8.erissecurityaltidgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.event_time_optional = ProtoField.new("Event Time Optional", "cme.futures.streamlined.sbe.v5.8.eventtimeoptional", ftypes.UINT64)
omi_cme_futures_streamlined_sbe_v5_8.fields.event_type_optional = ProtoField.new("Event Type Optional", "cme.futures.streamlined.sbe.v5.8.eventtypeoptional", ftypes.UINT8)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.final = ProtoField.new("Final", "cme.futures.streamlined.sbe.v5.8.final", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_eris_related_instruments_group = ProtoField.new("Incremental Refresh Eris Related Instruments Group", "cme.futures.streamlined.sbe.v5.8.incrementalrefresherisrelatedinstrumentsgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_eris_related_instruments_groups = ProtoField.new("Incremental Refresh Eris Related Instruments Groups", "cme.futures.streamlined.sbe.v5.8.incrementalrefresherisrelatedinstrumentsgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_indices_group = ProtoField.new("Incremental Refresh Indices Group", "cme.futures.streamlined.sbe.v5.8.incrementalrefreshindicesgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_indices_groups = ProtoField.new("Incremental Refresh Indices Groups", "cme.futures.streamlined.sbe.v5.8.incrementalrefreshindicesgroups", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.last_implied_msg = ProtoField.new("Last Implied Msg", "cme.futures.streamlined.sbe.v5.8.lastimpliedmsg", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
omi_cme_futures_streamlined_sbe_v5_8.fields.last_quote_msg = ProtoField.new("Last Quote Msg", "cme.futures.streamlined.sbe.v5.8.lastquotemsg", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
omi_cme_futures_streamlined_sbe_v5_8.fields.last_stats_msg = ProtoField.new("Last Stats Msg", "cme.futures.streamlined.sbe.v5.8.laststatsmsg", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_cme_futures_streamlined_sbe_v5_8.fields.last_trade_msg = ProtoField.new("Last Trade Msg", "cme.futures.streamlined.sbe.v5.8.lasttrademsg", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_cme_futures_streamlined_sbe_v5_8.fields.last_volume_msg = ProtoField.new("Last Volume Msg", "cme.futures.streamlined.sbe.v5.8.lastvolumemsg", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_id = ProtoField.new("Leg Id", "cme.futures.streamlined.sbe.v5.8.legid", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_maturity_date = ProtoField.new("Leg Maturity Date", "cme.futures.streamlined.sbe.v5.8.legmaturitydate", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_maturity_month_year = ProtoField.new("Leg Maturity Month Year", "cme.futures.streamlined.sbe.v5.8.legmaturitymonthyear", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_put_or_call = ProtoField.new("Leg Put Or Call", "cme.futures.streamlined.sbe.v5.8.legputorcall", ftypes.UINT8)
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_ratio_qty_int_32_null = ProtoField.new("Leg Ratio Qty Int 32 Null", "cme.futures.streamlined.sbe.v5.8.legratioqtyint32null", ftypes.INT32)
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_ratio_qty_u_int_16_null = ProtoField.new("Leg Ratio Qty u Int 16 Null", "cme.futures.streamlined.sbe.v5.8.legratioqtyuint16null", ftypes.UINT16)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_security_exchange = ProtoField.new("Leg Security Exchange", "cme.futures.streamlined.sbe.v5.8.legsecurityexchange", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_security_id = ProtoField.new("Leg Security Id", "cme.futures.streamlined.sbe.v5.8.legsecurityid", ftypes.UINT64)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_security_type_4 = ProtoField.new("leg Security Type 4", "cme.futures.streamlined.sbe.v5.8.legsecuritytype4", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_strike_price = ProtoField.new("Leg Strike Price", "cme.futures.streamlined.sbe.v5.8.legstrikeprice", ftypes.DOUBLE)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_unit_of_measure = ProtoField.new("Leg Unit Of Measure", "cme.futures.streamlined.sbe.v5.8.legunitofmeasure", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_unit_of_measure_currency = ProtoField.new("Leg Unit Of Measure Currency", "cme.futures.streamlined.sbe.v5.8.legunitofmeasurecurrency", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.leg_unit_of_measure_qty = ProtoField.new("Leg Unit Of Measure Qty", "cme.futures.streamlined.sbe.v5.8.legunitofmeasureqty", ftypes.DOUBLE)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.news_indices_related_sym_group = ProtoField.new("News Indices Related Sym Group", "cme.futures.streamlined.sbe.v5.8.newsindicesrelatedsymgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.news_indices_related_sym_groups = ProtoField.new("News Indices Related Sym Groups", "cme.futures.streamlined.sbe.v5.8.newsindicesrelatedsymgroups", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.null_value = ProtoField.new("Null Value", "cme.futures.streamlined.sbe.v5.8.nullvalue", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_cme_futures_streamlined_sbe_v5_8.fields.num_in_group = ProtoField.new("Num In Group", "cme.futures.streamlined.sbe.v5.8.numingroup", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.num_in_group_8 = ProtoField.new("Num In Group 8", "cme.futures.streamlined.sbe.v5.8.numingroup8", ftypes.UINT8)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.open_close_settl_flag = ProtoField.new("Open Close Settl Flag", "cme.futures.streamlined.sbe.v5.8.openclosesettlflag", ftypes.INT8)
omi_cme_futures_streamlined_sbe_v5_8.fields.order_qty = ProtoField.new("Order Qty", "cme.futures.streamlined.sbe.v5.8.orderqty", ftypes.UINT64)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_original_group = ProtoField.new("Otc Original Group", "cme.futures.streamlined.sbe.v5.8.otcoriginalgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_original_groups = ProtoField.new("Otc Original Groups", "cme.futures.streamlined.sbe.v5.8.otcoriginalgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_security_alt_id_group = ProtoField.new("Otc Security Alt Id Group", "cme.futures.streamlined.sbe.v5.8.otcsecurityaltidgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_security_alt_id_groups = ProtoField.new("Otc Security Alt Id Groups", "cme.futures.streamlined.sbe.v5.8.otcsecurityaltidgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_underlyings_group = ProtoField.new("Otc Underlyings Group", "cme.futures.streamlined.sbe.v5.8.otcunderlyingsgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_underlyings_groups = ProtoField.new("Otc Underlyings Groups", "cme.futures.streamlined.sbe.v5.8.otcunderlyingsgroups", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.packet_sequence_number = ProtoField.new("Packet Sequence Number", "cme.futures.streamlined.sbe.v5.8.packetsequencenumber", ftypes.UINT32)
omi_cme_futures_streamlined_sbe_v5_8.fields.party_id = ProtoField.new("Party Id", "cme.futures.streamlined.sbe.v5.8.partyid", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.party_role = ProtoField.new("Party Role", "cme.futures.streamlined.sbe.v5.8.partyrole", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.quote_request_related_sym_group = ProtoField.new("Quote Request Related Sym Group", "cme.futures.streamlined.sbe.v5.8.quoterequestrelatedsymgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.quote_request_related_sym_groups = ProtoField.new("Quote Request Related Sym Groups", "cme.futures.streamlined.sbe.v5.8.quoterequestrelatedsymgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.quote_type = ProtoField.new("Quote Type", "cme.futures.streamlined.sbe.v5.8.quotetype", ftypes.UINT8)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.recovery_msg = ProtoField.new("Recovery Msg", "cme.futures.streamlined.sbe.v5.8.recoverymsg", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.related_instrument_type = ProtoField.new("Related Instrument Type", "cme.futures.streamlined.sbe.v5.8.relatedinstrumenttype", ftypes.UINT8)
omi_cme_futures_streamlined_sbe_v5_8.fields.related_security_group = ProtoField.new("Related Security Group", "cme.futures.streamlined.sbe.v5.8.relatedsecuritygroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.related_symbol = ProtoField.new("Related Symbol", "cme.futures.streamlined.sbe.v5.8.relatedsymbol", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.reserved = ProtoField.new("Reserved", "cme.futures.streamlined.sbe.v5.8.reserved", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
omi_cme_futures_streamlined_sbe_v5_8.fields.reserved_bits = ProtoField.new("Reserved Bits", "cme.futures.streamlined.sbe.v5.8.reservedbits", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.rounded = ProtoField.new("Rounded", "cme.futures.streamlined.sbe.v5.8.rounded", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.security_alt_i_d_string_length_50 = ProtoField.new("Security Alt I D String Length 50", "cme.futures.streamlined.sbe.v5.8.securityaltidstringlength50", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.security_alt_id_50 = ProtoField.new("Security Alt Id 50", "cme.futures.streamlined.sbe.v5.8.securityaltid50", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.security_alt_id_source_optional = ProtoField.new("Security Alt Id Source Optional", "cme.futures.streamlined.sbe.v5.8.securityaltidsourceoptional", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_legacy_group = ProtoField.new("Trade Blocks Legacy Group", "cme.futures.streamlined.sbe.v5.8.tradeblockslegacygroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_legacy_groups = ProtoField.new("Trade Blocks Legacy Groups", "cme.futures.streamlined.sbe.v5.8.tradeblockslegacygroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_group = ProtoField.new("Trade Blocks Original Group", "cme.futures.streamlined.sbe.v5.8.tradeblocksoriginalgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_groups = ProtoField.new("Trade Blocks Original Groups", "cme.futures.streamlined.sbe.v5.8.tradeblocksoriginalgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_legs_group = ProtoField.new("Trade Blocks Original Legs Group", "cme.futures.streamlined.sbe.v5.8.tradeblocksoriginallegsgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_legs_groups = ProtoField.new("Trade Blocks Original Legs Groups", "cme.futures.streamlined.sbe.v5.8.tradeblocksoriginallegsgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_party_ids_group = ProtoField.new("Trade Blocks Party Ids Group", "cme.futures.streamlined.sbe.v5.8.tradeblockspartyidsgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_party_ids_groups = ProtoField.new("Trade Blocks Party Ids Groups", "cme.futures.streamlined.sbe.v5.8.tradeblockspartyidsgroups", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_underlyings_group = ProtoField.new("Trade Blocks Underlyings Group", "cme.futures.streamlined.sbe.v5.8.tradeblocksunderlyingsgroup", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_underlyings_groups = ProtoField.new("Trade Blocks Underlyings Groups", "cme.futures.streamlined.sbe.v5.8.tradeblocksunderlyingsgroups", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_maturity_month_year = ProtoField.new("Underlying Maturity Month Year", "cme.futures.streamlined.sbe.v5.8.underlyingmaturitymonthyear", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_security_exchange_security_exchange = ProtoField.new("Underlying Security Exchange Security Exchange", "cme.futures.streamlined.sbe.v5.8.underlyingsecurityexchangesecurityexchange", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_security_exchange_string_4 = ProtoField.new("Underlying Security Exchange String 4", "cme.futures.streamlined.sbe.v5.8.underlyingsecurityexchangestring4", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_security_type = ProtoField.new("Underlying Security Type", "cme.futures.streamlined.sbe.v5.8.underlyingsecuritytype", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "cme.futures.streamlined.sbe.v5.8.underlyingsymbol", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.unused_settl_price_type_4 = ProtoField.new("Unused Settl Price Type 4", "cme.futures.streamlined.sbe.v5.8.unusedsettlpricetype4", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
omi_cme_futures_streamlined_sbe_v5_8.fields.unused_settl_price_type_5 = ProtoField.new("Unused Settl Price Type 5", "cme.futures.streamlined.sbe.v5.8.unusedsettlpricetype5", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_cme_futures_streamlined_sbe_v5_8.fields.unused_settl_price_type_6 = ProtoField.new("Unused Settl Price Type 6", "cme.futures.streamlined.sbe.v5.8.unusedsettlpricetype6", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
-- Cme Futures Sbe Streamlined 5.8 Application Messages
...
omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_eris_351 = ProtoField.new("Md Incremental Refresh Eris 351", "cme.futures.streamlined.sbe.v5.8.mdincrementalrefresheris351", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_eris_353 = ProtoField.new("Md Incremental Refresh Eris 353", "cme.futures.streamlined.sbe.v5.8.mdincrementalrefresheris353", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_340 = ProtoField.new("Md Incremental Refresh Trade Blocks 340", "cme.futures.streamlined.sbe.v5.8.mdincrementalrefreshtradeblocks340", ftypes.STRING)
omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_349 = ProtoField.new("Md Incremental Refresh Trade Blocks 349", "cme.futures.streamlined.sbe.v5.8.mdincrementalrefreshtradeblocks349", ftypes.STRING)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_feed_types_group_index = ProtoField.new("Eris Feed Types Group Index", "cme.futures.streamlined.sbe.v5.8.erisfeedtypesgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_group_index = ProtoField.new("Eris Group Index", "cme.futures.streamlined.sbe.v5.8.erisgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_legs_group_index = ProtoField.new("Eris Legs Group Index", "cme.futures.streamlined.sbe.v5.8.erislegsgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_original_group_index = ProtoField.new("Eris Original Group Index", "cme.futures.streamlined.sbe.v5.8.erisoriginalgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_reference_data_group_index = ProtoField.new("Eris Reference Data Group Index", "cme.futures.streamlined.sbe.v5.8.erisreferencedatagroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.eris_security_alt_id_group_index = ProtoField.new("Eris Security Alt Id Group Index", "cme.futures.streamlined.sbe.v5.8.erissecurityaltidgroupindex", ftypes.UINT16)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_eris_related_instruments_group_index = ProtoField.new("Incremental Refresh Eris Related Instruments Group Index", "cme.futures.streamlined.sbe.v5.8.incrementalrefresherisrelatedinstrumentsgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_indices_group_index = ProtoField.new("Incremental Refresh Indices Group Index", "cme.futures.streamlined.sbe.v5.8.incrementalrefreshindicesgroupindex", ftypes.UINT16)
...
omi_cme_futures_streamlined_sbe_v5_8.fields.news_indices_related_sym_group_index = ProtoField.new("News Indices Related Sym Group Index", "cme.futures.streamlined.sbe.v5.8.newsindicesrelatedsymgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_original_group_index = ProtoField.new("Otc Original Group Index", "cme.futures.streamlined.sbe.v5.8.otcoriginalgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_security_alt_id_group_index = ProtoField.new("Otc Security Alt Id Group Index", "cme.futures.streamlined.sbe.v5.8.otcsecurityaltidgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.otc_underlyings_group_index = ProtoField.new("Otc Underlyings Group Index", "cme.futures.streamlined.sbe.v5.8.otcunderlyingsgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.quote_request_related_sym_group_index = ProtoField.new("Quote Request Related Sym Group Index", "cme.futures.streamlined.sbe.v5.8.quoterequestrelatedsymgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_legacy_group_index = ProtoField.new("Trade Blocks Legacy Group Index", "cme.futures.streamlined.sbe.v5.8.tradeblockslegacygroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_group_index = ProtoField.new("Trade Blocks Original Group Index", "cme.futures.streamlined.sbe.v5.8.tradeblocksoriginalgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_legs_group_index = ProtoField.new("Trade Blocks Original Legs Group Index", "cme.futures.streamlined.sbe.v5.8.tradeblocksoriginallegsgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_party_ids_group_index = ProtoField.new("Trade Blocks Party Ids Group Index", "cme.futures.streamlined.sbe.v5.8.tradeblockspartyidsgroupindex", ftypes.UINT16)
omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_underlyings_group_index = ProtoField.new("Trade Blocks Underlyings Group Index", "cme.futures.streamlined.sbe.v5.8.tradeblocksunderlyingsgroupindex", ftypes.UINT16)
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_feed_types_group = Pref.bool("Show Eris Feed Types Group", show.eris_feed_types_group, "Parse and add Eris Feed Types Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_feed_types_groups = Pref.bool("Show Eris Feed Types Groups", show.eris_feed_types_groups, "Parse and add Eris Feed Types Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_group = Pref.bool("Show Eris Group", show.eris_group, "Parse and add Eris Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_groups = Pref.bool("Show Eris Groups", show.eris_groups, "Parse and add Eris Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_legs_group = Pref.bool("Show Eris Legs Group", show.eris_legs_group, "Parse and add Eris Legs Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_legs_groups = Pref.bool("Show Eris Legs Groups", show.eris_legs_groups, "Parse and add Eris Legs Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_original_group = Pref.bool("Show Eris Original Group", show.eris_original_group, "Parse and add Eris Original Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_original_groups = Pref.bool("Show Eris Original Groups", show.eris_original_groups, "Parse and add Eris Original Groups to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_reference_data_group = Pref.bool("Show Eris Reference Data Group", show.eris_reference_data_group, "Parse and add Eris Reference Data Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_reference_data_groups = Pref.bool("Show Eris Reference Data Groups", show.eris_reference_data_groups, "Parse and add Eris Reference Data Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_security_alt_id_group = Pref.bool("Show Eris Security Alt Id Group", show.eris_security_alt_id_group, "Parse and add Eris Security Alt Id Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_eris_security_alt_id_groups = Pref.bool("Show Eris Security Alt Id Groups", show.eris_security_alt_id_groups, "Parse and add Eris Security Alt Id Groups to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_incremental_refresh_eris_related_instruments_group = Pref.bool("Show Incremental Refresh Eris Related Instruments Group", show.incremental_refresh_eris_related_instruments_group, "Parse and add Incremental Refresh Eris Related Instruments Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_incremental_refresh_eris_related_instruments_groups = Pref.bool("Show Incremental Refresh Eris Related Instruments Groups", show.incremental_refresh_eris_related_instruments_groups, "Parse and add Incremental Refresh Eris Related Instruments Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_incremental_refresh_indices_group = Pref.bool("Show Incremental Refresh Indices Group", show.incremental_refresh_indices_group, "Parse and add Incremental Refresh Indices Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_incremental_refresh_indices_groups = Pref.bool("Show Incremental Refresh Indices Groups", show.incremental_refresh_indices_groups, "Parse and add Incremental Refresh Indices Groups to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_leg_maturity_month_year = Pref.bool("Show Leg Maturity Month Year", show.leg_maturity_month_year, "Parse and add Leg Maturity Month Year to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_eris_351 = Pref.bool("Show Md Incremental Refresh Eris 351", show.md_incremental_refresh_eris_351, "Parse and add Md Incremental Refresh Eris 351 to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_eris_353 = Pref.bool("Show Md Incremental Refresh Eris 353", show.md_incremental_refresh_eris_353, "Parse and add Md Incremental Refresh Eris 353 to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_340 = Pref.bool("Show Md Incremental Refresh Trade Blocks 340", show.md_incremental_refresh_trade_blocks_340, "Parse and add Md Incremental Refresh Trade Blocks 340 to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_349 = Pref.bool("Show Md Incremental Refresh Trade Blocks 349", show.md_incremental_refresh_trade_blocks_349, "Parse and add Md Incremental Refresh Trade Blocks 349 to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_news_indices_related_sym_group = Pref.bool("Show News Indices Related Sym Group", show.news_indices_related_sym_group, "Parse and add News Indices Related Sym Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_news_indices_related_sym_groups = Pref.bool("Show News Indices Related Sym Groups", show.news_indices_related_sym_groups, "Parse and add News Indices Related Sym Groups to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_otc_original_group = Pref.bool("Show Otc Original Group", show.otc_original_group, "Parse and add Otc Original Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_otc_original_groups = Pref.bool("Show Otc Original Groups", show.otc_original_groups, "Parse and add Otc Original Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_otc_security_alt_id_group = Pref.bool("Show Otc Security Alt Id Group", show.otc_security_alt_id_group, "Parse and add Otc Security Alt Id Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_otc_security_alt_id_groups = Pref.bool("Show Otc Security Alt Id Groups", show.otc_security_alt_id_groups, "Parse and add Otc Security Alt Id Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_otc_underlyings_group = Pref.bool("Show Otc Underlyings Group", show.otc_underlyings_group, "Parse and add Otc Underlyings Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_otc_underlyings_groups = Pref.bool("Show Otc Underlyings Groups", show.otc_underlyings_groups, "Parse and add Otc Underlyings Groups to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_quote_request_related_sym_group = Pref.bool("Show Quote Request Related Sym Group", show.quote_request_related_sym_group, "Parse and add Quote Request Related Sym Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_quote_request_related_sym_groups = Pref.bool("Show Quote Request Related Sym Groups", show.quote_request_related_sym_groups, "Parse and add Quote Request Related Sym Groups to protocol tree")
...
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_legacy_group = Pref.bool("Show Trade Blocks Legacy Group", show.trade_blocks_legacy_group, "Parse and add Trade Blocks Legacy Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_legacy_groups = Pref.bool("Show Trade Blocks Legacy Groups", show.trade_blocks_legacy_groups, "Parse and add Trade Blocks Legacy Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_original_group = Pref.bool("Show Trade Blocks Original Group", show.trade_blocks_original_group, "Parse and add Trade Blocks Original Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_original_groups = Pref.bool("Show Trade Blocks Original Groups", show.trade_blocks_original_groups, "Parse and add Trade Blocks Original Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_original_legs_group = Pref.bool("Show Trade Blocks Original Legs Group", show.trade_blocks_original_legs_group, "Parse and add Trade Blocks Original Legs Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_original_legs_groups = Pref.bool("Show Trade Blocks Original Legs Groups", show.trade_blocks_original_legs_groups, "Parse and add Trade Blocks Original Legs Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_party_ids_group = Pref.bool("Show Trade Blocks Party Ids Group", show.trade_blocks_party_ids_group, "Parse and add Trade Blocks Party Ids Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_party_ids_groups = Pref.bool("Show Trade Blocks Party Ids Groups", show.trade_blocks_party_ids_groups, "Parse and add Trade Blocks Party Ids Groups to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_underlyings_group = Pref.bool("Show Trade Blocks Underlyings Group", show.trade_blocks_underlyings_group, "Parse and add Trade Blocks Underlyings Group to protocol tree")
omi_cme_futures_streamlined_sbe_v5_8.prefs.show_trade_blocks_underlyings_groups = Pref.bool("Show Trade Blocks Underlyings Groups", show.trade_blocks_underlyings_groups, "Parse and add Trade Blocks Underlyings Groups to protocol tree")
...
function omi_cme_futures_streamlined_sbe_v5_8.prefs_changed()
  ...
  if show.md_incremental_refresh_eris_351 ~= omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_eris_351 then
    show.md_incremental_refresh_eris_351 = omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_eris_351
    changed = true
  end
  if show.md_incremental_refresh_eris_353 ~= omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_eris_353 then
    show.md_incremental_refresh_eris_353 = omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_eris_353
    changed = true
  end
  ...
  if show.md_incremental_refresh_trade_blocks_340 ~= omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_340 then
    show.md_incremental_refresh_trade_blocks_340 = omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_340
    changed = true
  end
  if show.md_incremental_refresh_trade_blocks_349 ~= omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_349 then
    show.md_incremental_refresh_trade_blocks_349 = omi_cme_futures_streamlined_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_349
    changed = true
  end
...
cme_futures_streamlined_sbe_v5_8.security_alt_id_source_optional = {}

-- Size: Security Alt Id Source Optional
cme_futures_streamlined_sbe_v5_8.security_alt_id_source_optional.size = 1

-- Display: Security Alt Id Source Optional
cme_futures_streamlined_sbe_v5_8.security_alt_id_source_optional.display = function(value)
...
cme_futures_streamlined_sbe_v5_8.security_alt_id_source_optional.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.security_alt_id_source_optional.size
  ...
  local display = cme_futures_streamlined_sbe_v5_8.security_alt_id_source_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.security_alt_id_source_optional, range, value, display)

  return offset + length, value
end

-- Security Alt Id 50
cme_futures_streamlined_sbe_v5_8.security_alt_id_50 = {}

-- Size: Security Alt Id 50
cme_futures_streamlined_sbe_v5_8.security_alt_id_50.size = 26

-- Display: Security Alt Id 50
cme_futures_streamlined_sbe_v5_8.security_alt_id_50.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.security_alt_id_50.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.security_alt_id_50.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.security_alt_id_50.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.security_alt_id_50, range, value, display)

  return offset + length, value
end

-- Eris Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group = {}

-- Size: Eris Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.size =
  cme_futures_streamlined_sbe_v5_8.security_alt_id_50.size + 
  cme_futures_streamlined_sbe_v5_8.security_alt_id_source_optional.size

-- Display: Eris Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.fields = function(buffer, offset, packet, parent, eris_security_alt_id_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.dissect = function(buffer, offset, packet, parent, eris_security_alt_id_group_index)
  if show.eris_security_alt_id_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_security_alt_id_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.fields(buffer, offset, packet, parent, eris_security_alt_id_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.fields(buffer, offset, packet, parent, eris_security_alt_id_group_index)
  end
end

-- Num In Group 8
cme_futures_streamlined_sbe_v5_8.num_in_group_8 = {}

-- Size: Num In Group 8
cme_futures_streamlined_sbe_v5_8.num_in_group_8.size = 1

-- Display: Num In Group 8
cme_futures_streamlined_sbe_v5_8.num_in_group_8.display = function(value)
  return "Num In Group 8: "..value
end

-- Dissect: Num In Group 8
cme_futures_streamlined_sbe_v5_8.num_in_group_8.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.num_in_group_8.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.num_in_group_8.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.num_in_group_8, range, value, display)
...
cme_futures_streamlined_sbe_v5_8.group_size.size =
  ...
  cme_futures_streamlined_sbe_v5_8.num_in_group_8.size
...
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups = {}

-- Calculate size of: Eris Security Alt Id Groups
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Security Alt Id Groups
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for eris_security_alt_id_group_index = 1, num_in_group_8 do
    index, eris_security_alt_id_group = cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_group.dissect(buffer, index, packet, parent, eris_security_alt_id_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.dissect = function(buffer, offset, packet, parent)
  if show.eris_security_alt_id_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_security_alt_id_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.fields(buffer, offset, packet, parent)
  end
end
...
-- leg Security Type 4
cme_futures_streamlined_sbe_v5_8.leg_security_type_4 = {}

-- Size: leg Security Type 4
cme_futures_streamlined_sbe_v5_8.leg_security_type_4.size = 8

-- Display: leg Security Type 4
cme_futures_streamlined_sbe_v5_8.leg_security_type_4.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.leg_security_type_4.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_security_type_4.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.leg_security_type_4.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_security_type_4, range, value, display)
...
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_int_32_null = {}

-- Size: Leg Ratio Qty Int 32 Null
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_int_32_null.size = 4

-- Display: Leg Ratio Qty Int 32 Null
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_int_32_null.display = function(value)
  -- Check if field has value
...
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_int_32_null.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_int_32_null.size
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_int_32_null.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_ratio_qty_int_32_null, range, value, display)
...
-- Eris Legs Group
cme_futures_streamlined_sbe_v5_8.eris_legs_group = {}

-- Calculate size of: Eris Legs Group
cme_futures_streamlined_sbe_v5_8.eris_legs_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.previous_fixing_rate.size

  index = index + cme_futures_streamlined_sbe_v5_8.leg_symbol.size

  index = index + cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_int_32_null.size

  index = index + cme_futures_streamlined_sbe_v5_8.leg_side.size

  index = index + cme_futures_streamlined_sbe_v5_8.leg_currency.size

  index = index + cme_futures_streamlined_sbe_v5_8.leg_security_type_4.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.interpolation_factor.size

  index = index + cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.size(buffer, offset + index)

  return index
end

-- Display: Eris Legs Group
cme_futures_streamlined_sbe_v5_8.eris_legs_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Legs Group
cme_futures_streamlined_sbe_v5_8.eris_legs_group.fields = function(buffer, offset, packet, parent, eris_legs_group_index)
  local index = offset
  ...
  index, eris_security_alt_id_groups = cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Eris Legs Group
cme_futures_streamlined_sbe_v5_8.eris_legs_group.dissect = function(buffer, offset, packet, parent, eris_legs_group_index)
  if show.eris_legs_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_legs_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_legs_group.fields(buffer, offset, packet, parent, eris_legs_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_legs_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_legs_group.fields(buffer, offset, packet, parent, eris_legs_group_index)
  end
end

-- Eris Legs Groups
cme_futures_streamlined_sbe_v5_8.eris_legs_groups = {}

-- Calculate size of: Eris Legs Groups
cme_futures_streamlined_sbe_v5_8.eris_legs_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, eris_legs_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.eris_legs_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Eris Legs Groups
cme_futures_streamlined_sbe_v5_8.eris_legs_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Legs Groups
cme_futures_streamlined_sbe_v5_8.eris_legs_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for eris_legs_group_index = 1, num_in_group_8 do
    index, eris_legs_group = cme_futures_streamlined_sbe_v5_8.eris_legs_group.dissect(buffer, index, packet, parent, eris_legs_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.eris_legs_groups.dissect = function(buffer, offset, packet, parent)
  if show.eris_legs_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_legs_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_legs_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_legs_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_legs_groups.fields(buffer, offset, packet, parent)
  end
end

-- Event Time Optional
cme_futures_streamlined_sbe_v5_8.event_time_optional = {}

-- Size: Event Time Optional
cme_futures_streamlined_sbe_v5_8.event_time_optional.size = 8

-- Display: Event Time Optional
cme_futures_streamlined_sbe_v5_8.event_time_optional.display = function(value)
  -- Check if field has value
...
cme_futures_streamlined_sbe_v5_8.event_time_optional.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.event_time_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = cme_futures_streamlined_sbe_v5_8.event_time_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.event_time_optional, range, value, display)

  return offset + length, value
end

-- Event Type Optional
cme_futures_streamlined_sbe_v5_8.event_type_optional = {}

-- Size: Event Type Optional
cme_futures_streamlined_sbe_v5_8.event_type_optional.size = 1

-- Display: Event Type Optional
cme_futures_streamlined_sbe_v5_8.event_type_optional.display = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_streamlined_sbe_v5_8.event_type_optional.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.event_type_optional.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.event_type_optional.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.event_type_optional, range, value, display)
...
cme_futures_streamlined_sbe_v5_8.events_group.size =
  cme_futures_streamlined_sbe_v5_8.event_type_optional.size + 
  cme_futures_streamlined_sbe_v5_8.event_time_optional.size
...
cme_futures_streamlined_sbe_v5_8.events_groups.dissect = function(buffer, offset, packet, parent)
  if show.events_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.events_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.events_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.events_groups.display(packet, parent, length)
    parent:append_text(display)
...
cme_futures_streamlined_sbe_v5_8.eris_feed_types_group = {}

-- Size: Eris Feed Types Group
cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.size =
...
cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Feed Types Group
cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.fields = function(buffer, offset, packet, parent, eris_feed_types_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.dissect = function(buffer, offset, packet, parent, eris_feed_types_group_index)
  if show.eris_feed_types_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_feed_types_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.fields(buffer, offset, packet, parent, eris_feed_types_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.fields(buffer, offset, packet, parent, eris_feed_types_group_index)
  end
end

-- Eris Feed Types Groups
cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups = {}

-- Calculate size of: Eris Feed Types Groups
cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Feed Types Groups
cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for eris_feed_types_group_index = 1, num_in_group_8 do
    index, eris_feed_types_group = cme_futures_streamlined_sbe_v5_8.eris_feed_types_group.dissect(buffer, index, packet, parent, eris_feed_types_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.dissect = function(buffer, offset, packet, parent)
  if show.eris_feed_types_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_feed_types_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.md_instrument_definition_eris.size = function(buffer, offset)
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.size(buffer, offset + index)

  index = index + cme_futures_streamlined_sbe_v5_8.events_groups.size(buffer, offset + index)

  index = index + cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.size(buffer, offset + index)

  index = index + cme_futures_streamlined_sbe_v5_8.eris_legs_groups.size(buffer, offset + index)
...
cme_futures_streamlined_sbe_v5_8.md_instrument_definition_eris.fields = function(buffer, offset, packet, parent)
  ...
  index, eris_feed_types_groups = cme_futures_streamlined_sbe_v5_8.eris_feed_types_groups.dissect(buffer, index, packet, parent)
  ...
  index, eris_legs_groups = cme_futures_streamlined_sbe_v5_8.eris_legs_groups.dissect(buffer, index, packet, parent)
...
cme_futures_streamlined_sbe_v5_8.md_instrument_definition_eris.dissect = function(buffer, offset, packet, parent)
  if show.md_instrument_definition_eris then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_instrument_definition_eris, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_instrument_definition_eris.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_instrument_definition_eris.display(packet, parent, length)
    parent:append_text(display)
...
cme_futures_streamlined_sbe_v5_8.security_alt_i_d_string_length_50 = {}

-- Size: Security Alt I D String Length 50
cme_futures_streamlined_sbe_v5_8.security_alt_i_d_string_length_50.size = 50

-- Display: Security Alt I D String Length 50
cme_futures_streamlined_sbe_v5_8.security_alt_i_d_string_length_50.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.security_alt_i_d_string_length_50.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.security_alt_i_d_string_length_50.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.security_alt_i_d_string_length_50.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.security_alt_i_d_string_length_50, range, value, display)

  return offset + length, value
end

-- Otc Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group = {}

-- Size: Otc Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.size =
  cme_futures_streamlined_sbe_v5_8.security_alt_i_d_string_length_50.size + 
  cme_futures_streamlined_sbe_v5_8.security_alt_id_source.size

-- Display: Otc Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Otc Security Alt Id Group
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.fields = function(buffer, offset, packet, parent, otc_security_alt_id_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.dissect = function(buffer, offset, packet, parent, otc_security_alt_id_group_index)
  if show.otc_security_alt_id_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.otc_security_alt_id_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.fields(buffer, offset, packet, parent, otc_security_alt_id_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.fields(buffer, offset, packet, parent, otc_security_alt_id_group_index)
  end
end

-- Otc Security Alt Id Groups
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups = {}

-- Calculate size of: Otc Security Alt Id Groups
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Otc Security Alt Id Groups
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for otc_security_alt_id_group_index = 1, num_in_group_8 do
    index, otc_security_alt_id_group = cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_group.dissect(buffer, index, packet, parent, otc_security_alt_id_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.dissect = function(buffer, offset, packet, parent)
  if show.otc_security_alt_id_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.otc_security_alt_id_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.fields(buffer, offset, packet, parent)
  end
end

-- Underlying Security Exchange Security Exchange
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_security_exchange = {}

-- Size: Underlying Security Exchange Security Exchange
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_security_exchange.size = 4

-- Display: Underlying Security Exchange Security Exchange
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_security_exchange.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_security_exchange.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_security_exchange.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_security_exchange.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_security_exchange_security_exchange, range, value, display)

  return offset + length, value
end

-- Underlying Security Type
cme_futures_streamlined_sbe_v5_8.underlying_security_type = {}

-- Size: Underlying Security Type
cme_futures_streamlined_sbe_v5_8.underlying_security_type.size = 9

-- Display: Underlying Security Type
cme_futures_streamlined_sbe_v5_8.underlying_security_type.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.underlying_security_type.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.underlying_security_type.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.underlying_security_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_security_type, range, value, display)
...
cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year = {}

-- Size: Underlying Maturity Month Year
cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.size =
...
cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.display = function(packet, parent, length)
  return ""
end
...
cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.dissect = function(buffer, offset, packet, parent)
  if show.underlying_maturity_month_year then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_maturity_month_year, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.fields(buffer, offset, packet, parent)
  end
end

-- Underlying Symbol
cme_futures_streamlined_sbe_v5_8.underlying_symbol = {}

-- Size: Underlying Symbol
cme_futures_streamlined_sbe_v5_8.underlying_symbol.size = 50

-- Display: Underlying Symbol
cme_futures_streamlined_sbe_v5_8.underlying_symbol.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.underlying_symbol.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.underlying_symbol.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.underlying_symbol.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_symbol, range, value, display)

  return offset + length, value
end

-- Otc Underlyings Group
cme_futures_streamlined_sbe_v5_8.otc_underlyings_group = {}

-- Size: Otc Underlyings Group
cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.size =
  cme_futures_streamlined_sbe_v5_8.underlying_symbol.size + 
  cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.size + 
  cme_futures_streamlined_sbe_v5_8.underlying_security_type.size + 
  cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_security_exchange.size

-- Display: Otc Underlyings Group
cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Otc Underlyings Group
cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.fields = function(buffer, offset, packet, parent, otc_underlyings_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.dissect = function(buffer, offset, packet, parent, otc_underlyings_group_index)
  if show.otc_underlyings_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.otc_underlyings_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.fields(buffer, offset, packet, parent, otc_underlyings_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.fields(buffer, offset, packet, parent, otc_underlyings_group_index)
  end
end

-- Otc Underlyings Groups
cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups = {}

-- Calculate size of: Otc Underlyings Groups
cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Otc Underlyings Groups
cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for otc_underlyings_group_index = 1, num_in_group_8 do
    index, otc_underlyings_group = cme_futures_streamlined_sbe_v5_8.otc_underlyings_group.dissect(buffer, index, packet, parent, otc_underlyings_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.dissect = function(buffer, offset, packet, parent)
  if show.otc_underlyings_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.otc_underlyings_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.fields(buffer, offset, packet, parent)
  end
end
...
-- Otc Original Group
cme_futures_streamlined_sbe_v5_8.otc_original_group = {}

-- Calculate size of: Otc Original Group
cme_futures_streamlined_sbe_v5_8.otc_original_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.md_entry_size.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.maturity_month_year.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.strike_price_decimal.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.unit_of_measure_qty_decimal.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.size(buffer, offset + index)

  index = index + cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.size(buffer, offset + index)

  return index
end

-- Display: Otc Original Group
cme_futures_streamlined_sbe_v5_8.otc_original_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Otc Original Group
cme_futures_streamlined_sbe_v5_8.otc_original_group.fields = function(buffer, offset, packet, parent, otc_original_group_index)
  local index = offset
  ...
  index, otc_underlyings_groups = cme_futures_streamlined_sbe_v5_8.otc_underlyings_groups.dissect(buffer, index, packet, parent)

  -- Otc Security Alt Id Groups: Struct of 2 fields
  index, otc_security_alt_id_groups = cme_futures_streamlined_sbe_v5_8.otc_security_alt_id_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Otc Original Group
cme_futures_streamlined_sbe_v5_8.otc_original_group.dissect = function(buffer, offset, packet, parent, otc_original_group_index)
  if show.otc_original_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.otc_original_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.otc_original_group.fields(buffer, offset, packet, parent, otc_original_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.otc_original_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.otc_original_group.fields(buffer, offset, packet, parent, otc_original_group_index)
  end
end

-- Otc Original Groups
cme_futures_streamlined_sbe_v5_8.otc_original_groups = {}

-- Calculate size of: Otc Original Groups
cme_futures_streamlined_sbe_v5_8.otc_original_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, otc_original_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.otc_original_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Otc Original Groups
cme_futures_streamlined_sbe_v5_8.otc_original_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Otc Original Groups
cme_futures_streamlined_sbe_v5_8.otc_original_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for otc_original_group_index = 1, num_in_group_8 do
    index, otc_original_group = cme_futures_streamlined_sbe_v5_8.otc_original_group.dissect(buffer, index, packet, parent, otc_original_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.otc_original_groups.dissect = function(buffer, offset, packet, parent)
  if show.otc_original_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.otc_original_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.otc_original_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.otc_original_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.otc_original_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.match_event_indicator.bits = function(range, value, packet, parent)

  -- Last Trade Msg: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.last_trade_msg, range, value)

  -- Last Volume Msg: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.last_volume_msg, range, value)

  -- Last Quote Msg: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.last_quote_msg, range, value)

  -- Last Stats Msg: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.last_stats_msg, range, value)

  -- Last Implied Msg: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.last_implied_msg, range, value)

  -- Recovery Msg: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.recovery_msg, range, value)

  -- Reserved: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.reserved, range, value)

  -- End Of Event: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.end_of_event, range, value)
end
...
cme_futures_streamlined_sbe_v5_8.match_event_indicator.dissect = function(buffer, offset, packet, parent)
  local size = cme_futures_streamlined_sbe_v5_8.match_event_indicator.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.match_event_indicator.display(range, value, packet, parent)
  ...
  if show.match_event_indicator then
    cme_futures_streamlined_sbe_v5_8.match_event_indicator.bits(range, value, packet, element)
  end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_otc.size = function(buffer, offset)
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.otc_original_groups.size(buffer, offset + index)
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_otc.fields = function(buffer, offset, packet, parent)
  ...
  index, otc_original_groups = cme_futures_streamlined_sbe_v5_8.otc_original_groups.dissect(buffer, index, packet, parent)
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_otc.dissect = function(buffer, offset, packet, parent)
  if show.md_incremental_refresh_otc then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_otc, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_otc.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_otc.display(packet, parent, length)
    parent:append_text(display)
...
-- Eris Group
cme_futures_streamlined_sbe_v5_8.eris_group = {}

-- Calculate size of: Eris Group
cme_futures_streamlined_sbe_v5_8.eris_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.md_entry_px_decimal.size

  index = index + cme_futures_streamlined_sbe_v5_8.md_entry_size_optional.size

  index = index + cme_futures_streamlined_sbe_v5_8.cal_fut_px.size
...
-- Display: Eris Group
cme_futures_streamlined_sbe_v5_8.eris_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Group
cme_futures_streamlined_sbe_v5_8.eris_group.fields = function(buffer, offset, packet, parent, eris_group_index)
  local index = offset
...
-- Dissect: Eris Group
cme_futures_streamlined_sbe_v5_8.eris_group.dissect = function(buffer, offset, packet, parent, eris_group_index)
  if show.eris_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_group.fields(buffer, offset, packet, parent, eris_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_group.fields(buffer, offset, packet, parent, eris_group_index)
  end
end

-- Eris Groups
cme_futures_streamlined_sbe_v5_8.eris_groups = {}

-- Calculate size of: Eris Groups
cme_futures_streamlined_sbe_v5_8.eris_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, eris_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.eris_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Eris Groups
cme_futures_streamlined_sbe_v5_8.eris_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Groups
cme_futures_streamlined_sbe_v5_8.eris_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for eris_group_index = 1, num_in_group_8 do
    index, eris_group = cme_futures_streamlined_sbe_v5_8.eris_group.dissect(buffer, index, packet, parent, eris_group_index)
  end
...
-- Dissect: Eris Groups
cme_futures_streamlined_sbe_v5_8.eris_groups.dissect = function(buffer, offset, packet, parent)
  if show.eris_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_groups.fields(buffer, offset, packet, parent)
  end
end

-- Md Incremental Refresh Eris 353
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353 = {}

-- Calculate size of: Md Incremental Refresh Eris 353
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.eris_groups.size(buffer, offset + index)

  return index
end

-- Display: Md Incremental Refresh Eris 353
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.display = function(packet, parent, length)
  return ""
end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.fields = function(buffer, offset, packet, parent)
  ...
  index, eris_groups = cme_futures_streamlined_sbe_v5_8.eris_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Md Incremental Refresh Eris 353
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.dissect = function(buffer, offset, packet, parent)
  if show.md_incremental_refresh_eris_353 then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_eris_353, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.fields(buffer, offset, packet, parent)
  end
end

-- Eris Original Group
cme_futures_streamlined_sbe_v5_8.eris_original_group = {}

-- Calculate size of: Eris Original Group
cme_futures_streamlined_sbe_v5_8.eris_original_group.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.eris_original_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Original Group
cme_futures_streamlined_sbe_v5_8.eris_original_group.fields = function(buffer, offset, packet, parent, eris_original_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.eris_original_group.dissect = function(buffer, offset, packet, parent, eris_original_group_index)
  if show.eris_original_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_original_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_original_group.fields(buffer, offset, packet, parent, eris_original_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_original_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_original_group.fields(buffer, offset, packet, parent, eris_original_group_index)
  end
end

-- Eris Original Groups
cme_futures_streamlined_sbe_v5_8.eris_original_groups = {}

-- Calculate size of: Eris Original Groups
cme_futures_streamlined_sbe_v5_8.eris_original_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, eris_original_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.eris_original_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Eris Original Groups
cme_futures_streamlined_sbe_v5_8.eris_original_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Original Groups
cme_futures_streamlined_sbe_v5_8.eris_original_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for eris_original_group_index = 1, num_in_group_8 do
    index, eris_original_group = cme_futures_streamlined_sbe_v5_8.eris_original_group.dissect(buffer, index, packet, parent, eris_original_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.eris_original_groups.dissect = function(buffer, offset, packet, parent)
  if show.eris_original_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_original_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_original_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_original_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_original_groups.fields(buffer, offset, packet, parent)
  end
end

-- Md Incremental Refresh Eris 351
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351 = {}

-- Calculate size of: Md Incremental Refresh Eris 351
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.eris_original_groups.size(buffer, offset + index)

  return index
end

-- Display: Md Incremental Refresh Eris 351
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.display = function(packet, parent, length)
  return ""
end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.fields = function(buffer, offset, packet, parent)
  ...
  index, eris_original_groups = cme_futures_streamlined_sbe_v5_8.eris_original_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Md Incremental Refresh Eris 351
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.dissect = function(buffer, offset, packet, parent)
  if show.md_incremental_refresh_eris_351 then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_eris_351, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.fields(buffer, offset, packet, parent)
  end
end

-- Leg Unit Of Measure Currency
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_currency = {}

-- Size: Leg Unit Of Measure Currency
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_currency.size = 3

-- Display: Leg Unit Of Measure Currency
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_currency.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_currency.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_currency.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_currency.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_unit_of_measure_currency, range, value, display)

  return offset + length, value
end

-- Leg Put Or Call
cme_futures_streamlined_sbe_v5_8.leg_put_or_call = {}

-- Size: Leg Put Or Call
cme_futures_streamlined_sbe_v5_8.leg_put_or_call.size = 1

-- Display: Leg Put Or Call
cme_futures_streamlined_sbe_v5_8.leg_put_or_call.display = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_streamlined_sbe_v5_8.leg_put_or_call.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_put_or_call.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.leg_put_or_call.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_put_or_call, range, value, display)

  return offset + length, value
end

-- Leg Ratio Qty u Int 16 Null
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_u_int_16_null = {}

-- Size: Leg Ratio Qty u Int 16 Null
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_u_int_16_null.size = 2

-- Display: Leg Ratio Qty u Int 16 Null
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_u_int_16_null.display = function(value)
  -- Check if field has value
  if value == 65535 then
...
cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_u_int_16_null.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_u_int_16_null.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_u_int_16_null.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_ratio_qty_u_int_16_null, range, value, display)

  return offset + length, value
end

-- Leg Security Exchange
cme_futures_streamlined_sbe_v5_8.leg_security_exchange = {}

-- Size: Leg Security Exchange
cme_futures_streamlined_sbe_v5_8.leg_security_exchange.size = 4

-- Display: Leg Security Exchange
cme_futures_streamlined_sbe_v5_8.leg_security_exchange.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.leg_security_exchange.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_security_exchange.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.leg_security_exchange.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_security_exchange, range, value, display)

  return offset + length, value
end

-- Leg Unit Of Measure Qty
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty = {}

-- Size: Leg Unit Of Measure Qty
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.size = 8

-- Display: Leg Unit Of Measure Qty
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.display = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
    return 0/0
  end
...
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.size
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.translate(raw)
  local display = cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.display(raw, value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_unit_of_measure_qty, range, value, display)

  return offset + length, value
end

-- Leg Unit Of Measure
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure = {}

-- Size: Leg Unit Of Measure
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure.size = 5

-- Display: Leg Unit Of Measure
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_unit_of_measure, range, value, display)

  return offset + length, value
end

-- Leg Strike Price
cme_futures_streamlined_sbe_v5_8.leg_strike_price = {}

-- Size: Leg Strike Price
cme_futures_streamlined_sbe_v5_8.leg_strike_price.size = 8

-- Display: Leg Strike Price
cme_futures_streamlined_sbe_v5_8.leg_strike_price.display = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
cme_futures_streamlined_sbe_v5_8.leg_strike_price.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
    return 0/0
  end
...
cme_futures_streamlined_sbe_v5_8.leg_strike_price.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_strike_price.size
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = cme_futures_streamlined_sbe_v5_8.leg_strike_price.translate(raw)
  local display = cme_futures_streamlined_sbe_v5_8.leg_strike_price.display(raw, value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_strike_price, range, value, display)

  return offset + length, value
end

-- Leg Maturity Date
cme_futures_streamlined_sbe_v5_8.leg_maturity_date = {}

-- Size: Leg Maturity Date
cme_futures_streamlined_sbe_v5_8.leg_maturity_date.size = 2

-- Display: Leg Maturity Date
cme_futures_streamlined_sbe_v5_8.leg_maturity_date.display = function(value)
  -- Check if field has value
  if value == 65535 then
...
cme_futures_streamlined_sbe_v5_8.leg_maturity_date.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_maturity_date.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.leg_maturity_date.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_maturity_date, range, value, display)

  return offset + length, value
end

-- Leg Maturity Month Year
cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year = {}

-- Size: Leg Maturity Month Year
cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year.size =
  cme_futures_streamlined_sbe_v5_8.year.size + 
  cme_futures_streamlined_sbe_v5_8.month.size + 
  cme_futures_streamlined_sbe_v5_8.day.size + 
  cme_futures_streamlined_sbe_v5_8.week.size
...
cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year.display = function(packet, parent, length)
  return ""
end
...
cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year.dissect = function(buffer, offset, packet, parent)
  if show.leg_maturity_month_year then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_maturity_month_year, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.leg_security_type.size = 9
...
-- Leg Id
cme_futures_streamlined_sbe_v5_8.leg_id = {}

-- Size: Leg Id
cme_futures_streamlined_sbe_v5_8.leg_id.size = 17

-- Display: Leg Id
cme_futures_streamlined_sbe_v5_8.leg_id.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Leg Id
cme_futures_streamlined_sbe_v5_8.leg_id.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_id.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.leg_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_id, range, value, display)

  return offset + length, value
end

-- Leg Security Id
cme_futures_streamlined_sbe_v5_8.leg_security_id = {}

-- Size: Leg Security Id
cme_futures_streamlined_sbe_v5_8.leg_security_id.size = 8

-- Display: Leg Security Id
cme_futures_streamlined_sbe_v5_8.leg_security_id.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_streamlined_sbe_v5_8.leg_security_id.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.leg_security_id.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = cme_futures_streamlined_sbe_v5_8.leg_security_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.leg_security_id, range, value, display)

  return offset + length, value
end

-- Trade Blocks Original Legs Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group = {}

-- Size: Trade Blocks Original Legs Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.size =
  cme_futures_streamlined_sbe_v5_8.leg_symbol.size + 
  cme_futures_streamlined_sbe_v5_8.leg_security_id.size + 
  cme_futures_streamlined_sbe_v5_8.leg_security_group.size + 
  cme_futures_streamlined_sbe_v5_8.leg_id.size + 
  cme_futures_streamlined_sbe_v5_8.leg_security_type.size + 
  cme_futures_streamlined_sbe_v5_8.leg_maturity_month_year.size + 
  cme_futures_streamlined_sbe_v5_8.leg_maturity_date.size + 
  cme_futures_streamlined_sbe_v5_8.leg_strike_price.size + 
  cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure.size + 
  cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_qty.size + 
  cme_futures_streamlined_sbe_v5_8.leg_security_exchange.size + 
  cme_futures_streamlined_sbe_v5_8.leg_ratio_qty_u_int_16_null.size + 
  cme_futures_streamlined_sbe_v5_8.leg_side.size + 
  cme_futures_streamlined_sbe_v5_8.leg_put_or_call.size + 
  cme_futures_streamlined_sbe_v5_8.leg_unit_of_measure_currency.size

-- Display: Trade Blocks Original Legs Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Original Legs Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.fields = function(buffer, offset, packet, parent, trade_blocks_original_legs_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.dissect = function(buffer, offset, packet, parent, trade_blocks_original_legs_group_index)
  if show.trade_blocks_original_legs_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_legs_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.fields(buffer, offset, packet, parent, trade_blocks_original_legs_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.fields(buffer, offset, packet, parent, trade_blocks_original_legs_group_index)
  end
end

-- Trade Blocks Original Legs Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups = {}

-- Calculate size of: Trade Blocks Original Legs Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Original Legs Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trade_blocks_original_legs_group_index = 1, num_in_group_8 do
    index, trade_blocks_original_legs_group = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_group.dissect(buffer, index, packet, parent, trade_blocks_original_legs_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.dissect = function(buffer, offset, packet, parent)
  if show.trade_blocks_original_legs_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_legs_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.fields(buffer, offset, packet, parent)
  end
end

-- Party Role
cme_futures_streamlined_sbe_v5_8.party_role = {}

-- Size: Party Role
cme_futures_streamlined_sbe_v5_8.party_role.size = 2

-- Display: Party Role
cme_futures_streamlined_sbe_v5_8.party_role.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Party Role
cme_futures_streamlined_sbe_v5_8.party_role.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.party_role.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.party_role.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.party_role, range, value, display)

  return offset + length, value
end

-- Party Id
cme_futures_streamlined_sbe_v5_8.party_id = {}

-- Size: Party Id
cme_futures_streamlined_sbe_v5_8.party_id.size = 50

-- Display: Party Id
cme_futures_streamlined_sbe_v5_8.party_id.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Party Id
cme_futures_streamlined_sbe_v5_8.party_id.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.party_id.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.party_id.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.party_id, range, value, display)

  return offset + length, value
end

-- Trade Blocks Party Ids Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group = {}

-- Size: Trade Blocks Party Ids Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.size =
  cme_futures_streamlined_sbe_v5_8.party_id.size + 
  cme_futures_streamlined_sbe_v5_8.party_role.size

-- Display: Trade Blocks Party Ids Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Party Ids Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.fields = function(buffer, offset, packet, parent, trade_blocks_party_ids_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.dissect = function(buffer, offset, packet, parent, trade_blocks_party_ids_group_index)
  if show.trade_blocks_party_ids_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_party_ids_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.fields(buffer, offset, packet, parent, trade_blocks_party_ids_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.fields(buffer, offset, packet, parent, trade_blocks_party_ids_group_index)
  end
end

-- Trade Blocks Party Ids Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups = {}

-- Calculate size of: Trade Blocks Party Ids Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Party Ids Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trade_blocks_party_ids_group_index = 1, num_in_group_8 do
    index, trade_blocks_party_ids_group = cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_group.dissect(buffer, index, packet, parent, trade_blocks_party_ids_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.dissect = function(buffer, offset, packet, parent)
  if show.trade_blocks_party_ids_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_party_ids_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.fields(buffer, offset, packet, parent)
  end
end

-- Underlying Security Exchange String 4
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_string_4 = {}

-- Size: Underlying Security Exchange String 4
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_string_4.size = 4

-- Display: Underlying Security Exchange String 4
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_string_4.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_string_4.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_string_4.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_string_4.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.underlying_security_exchange_string_4, range, value, display)

  return offset + length, value
end

-- Trade Blocks Underlyings Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group = {}

-- Size: Trade Blocks Underlyings Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.size =
  cme_futures_streamlined_sbe_v5_8.underlying_symbol.size + 
  cme_futures_streamlined_sbe_v5_8.underlying_maturity_month_year.size + 
  cme_futures_streamlined_sbe_v5_8.underlying_security_type.size + 
  cme_futures_streamlined_sbe_v5_8.underlying_security_exchange_string_4.size

-- Display: Trade Blocks Underlyings Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Underlyings Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.fields = function(buffer, offset, packet, parent, trade_blocks_underlyings_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.dissect = function(buffer, offset, packet, parent, trade_blocks_underlyings_group_index)
  if show.trade_blocks_underlyings_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_underlyings_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.fields(buffer, offset, packet, parent, trade_blocks_underlyings_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.fields(buffer, offset, packet, parent, trade_blocks_underlyings_group_index)
  end
end

-- Trade Blocks Underlyings Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups = {}

-- Calculate size of: Trade Blocks Underlyings Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Underlyings Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trade_blocks_underlyings_group_index = 1, num_in_group_8 do
    index, trade_blocks_underlyings_group = cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_group.dissect(buffer, index, packet, parent, trade_blocks_underlyings_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.dissect = function(buffer, offset, packet, parent)
  if show.trade_blocks_underlyings_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_underlyings_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group = {}

-- Calculate size of: Trade Blocks Legacy Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.size(buffer, offset + index)

  index = index + cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.size(buffer, offset + index)

  index = index + cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.size(buffer, offset + index)

  return index
end

-- Display: Trade Blocks Legacy Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Legacy Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.fields = function(buffer, offset, packet, parent, trade_blocks_legacy_group_index)
  local index = offset
  ...
  index, trade_blocks_underlyings_groups = cme_futures_streamlined_sbe_v5_8.trade_blocks_underlyings_groups.dissect(buffer, index, packet, parent)

  -- Trade Blocks Party Ids Groups: Struct of 2 fields
  index, trade_blocks_party_ids_groups = cme_futures_streamlined_sbe_v5_8.trade_blocks_party_ids_groups.dissect(buffer, index, packet, parent)

  -- Trade Blocks Original Legs Groups: Struct of 2 fields
  index, trade_blocks_original_legs_groups = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_legs_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Trade Blocks Legacy Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.dissect = function(buffer, offset, packet, parent, trade_blocks_legacy_group_index)
  if show.trade_blocks_legacy_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_legacy_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.fields(buffer, offset, packet, parent, trade_blocks_legacy_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.fields(buffer, offset, packet, parent, trade_blocks_legacy_group_index)
  end
end

-- Trade Blocks Legacy Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups = {}

-- Calculate size of: Trade Blocks Legacy Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, trade_blocks_legacy_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Trade Blocks Legacy Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Legacy Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trade_blocks_legacy_group_index = 1, num_in_group_8 do
    index, trade_blocks_legacy_group = cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_group.dissect(buffer, index, packet, parent, trade_blocks_legacy_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.dissect = function(buffer, offset, packet, parent)
  if show.trade_blocks_legacy_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_legacy_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349 = {}

-- Calculate size of: Md Incremental Refresh Trade Blocks 349
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.size(buffer, offset + index)

  return index
end

-- Display: Md Incremental Refresh Trade Blocks 349
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.display = function(packet, parent, length)
  return ""
end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.fields = function(buffer, offset, packet, parent)
  ...
  index, trade_blocks_legacy_groups = cme_futures_streamlined_sbe_v5_8.trade_blocks_legacy_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Md Incremental Refresh Trade Blocks 349
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.dissect = function(buffer, offset, packet, parent)
  if show.md_incremental_refresh_trade_blocks_349 then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_349, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group = {}

-- Size: Incremental Refresh Indices Group
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.size =
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Incremental Refresh Indices Group
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.fields = function(buffer, offset, packet, parent, incremental_refresh_indices_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.dissect = function(buffer, offset, packet, parent, incremental_refresh_indices_group_index)
  if show.incremental_refresh_indices_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_indices_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.fields(buffer, offset, packet, parent, incremental_refresh_indices_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.fields(buffer, offset, packet, parent, incremental_refresh_indices_group_index)
  end
end

-- Incremental Refresh Indices Groups
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups = {}

-- Calculate size of: Incremental Refresh Indices Groups
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Incremental Refresh Indices Groups
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for incremental_refresh_indices_group_index = 1, num_in_group_8 do
    index, incremental_refresh_indices_group = cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_group.dissect(buffer, index, packet, parent, incremental_refresh_indices_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.dissect = function(buffer, offset, packet, parent)
  if show.incremental_refresh_indices_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_indices_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_indices.size = function(buffer, offset)
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.size(buffer, offset + index)
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_indices.fields = function(buffer, offset, packet, parent)
  ...
  index, incremental_refresh_indices_groups = cme_futures_streamlined_sbe_v5_8.incremental_refresh_indices_groups.dissect(buffer, index, packet, parent)
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_indices.dissect = function(buffer, offset, packet, parent)
  if show.md_incremental_refresh_indices then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_indices, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_indices.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_indices.display(packet, parent, length)
    parent:append_text(display)
...
-- Num In Group
cme_futures_streamlined_sbe_v5_8.num_in_group = {}

-- Size: Num In Group
cme_futures_streamlined_sbe_v5_8.num_in_group.size = 2

-- Display: Num In Group
cme_futures_streamlined_sbe_v5_8.num_in_group.display = function(value)
  return "Num In Group: "..value
end

-- Dissect: Num In Group
cme_futures_streamlined_sbe_v5_8.num_in_group.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.num_in_group.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.num_in_group.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.num_in_group, range, value, display)
...
cme_futures_streamlined_sbe_v5_8.group_size_encoding.size =
  cme_futures_streamlined_sbe_v5_8.block_length.size + 
  cme_futures_streamlined_sbe_v5_8.num_in_group.size
...
cme_futures_streamlined_sbe_v5_8.inst_attrib_groups.dissect = function(buffer, offset, packet, parent)
  if show.inst_attrib_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.inst_attrib_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.inst_attrib_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.inst_attrib_groups.display(packet, parent, length)
    parent:append_text(display)
...
cme_futures_streamlined_sbe_v5_8.md_instrument_definition_indices.dissect = function(buffer, offset, packet, parent)
  if show.md_instrument_definition_indices then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_instrument_definition_indices, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_instrument_definition_indices.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_instrument_definition_indices.display(packet, parent, length)
    parent:append_text(display)
...
-- Quote Type
cme_futures_streamlined_sbe_v5_8.quote_type = {}

-- Size: Quote Type
cme_futures_streamlined_sbe_v5_8.quote_type.size = 1

-- Display: Quote Type
cme_futures_streamlined_sbe_v5_8.quote_type.display = function(value)
  -- Check if field has value
  if value == 255 then
...
-- Dissect: Quote Type
cme_futures_streamlined_sbe_v5_8.quote_type.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.quote_type.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.quote_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.quote_type, range, value, display)

  return offset + length, value
end

-- Order Qty
cme_futures_streamlined_sbe_v5_8.order_qty = {}

-- Size: Order Qty
cme_futures_streamlined_sbe_v5_8.order_qty.size = 8

-- Display: Order Qty
cme_futures_streamlined_sbe_v5_8.order_qty.display = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
-- Dissect: Order Qty
cme_futures_streamlined_sbe_v5_8.order_qty.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.order_qty.size
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = cme_futures_streamlined_sbe_v5_8.order_qty.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.order_qty, range, value, display)

  return offset + length, value
end

-- Quote Request Related Sym Group
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group = {}

-- Calculate size of: Quote Request Related Sym Group
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.order_qty.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.quote_type.size
...
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Request Related Sym Group
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.fields = function(buffer, offset, packet, parent, quote_request_related_sym_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.dissect = function(buffer, offset, packet, parent, quote_request_related_sym_group_index)
  if show.quote_request_related_sym_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.quote_request_related_sym_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.fields(buffer, offset, packet, parent, quote_request_related_sym_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.fields(buffer, offset, packet, parent, quote_request_related_sym_group_index)
  end
end

-- Quote Request Related Sym Groups
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups = {}

-- Calculate size of: Quote Request Related Sym Groups
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, quote_request_related_sym_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Quote Request Related Sym Groups
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Request Related Sym Groups
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for quote_request_related_sym_group_index = 1, num_in_group_8 do
    index, quote_request_related_sym_group = cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_group.dissect(buffer, index, packet, parent, quote_request_related_sym_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.dissect = function(buffer, offset, packet, parent)
  if show.quote_request_related_sym_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.quote_request_related_sym_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.quote_request.size = function(buffer, offset)
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.size(buffer, offset + index)
...
cme_futures_streamlined_sbe_v5_8.quote_request.fields = function(buffer, offset, packet, parent)
  ...
  index, quote_request_related_sym_groups = cme_futures_streamlined_sbe_v5_8.quote_request_related_sym_groups.dissect(buffer, index, packet, parent)
...
cme_futures_streamlined_sbe_v5_8.quote_request.dissect = function(buffer, offset, packet, parent)
  if show.quote_request then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.quote_request, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.quote_request.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.quote_request.display(packet, parent, length)
    parent:append_text(display)
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group = {}

-- Calculate size of: Trade Blocks Original Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Original Group
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.fields = function(buffer, offset, packet, parent, trade_blocks_original_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.dissect = function(buffer, offset, packet, parent, trade_blocks_original_group_index)
  if show.trade_blocks_original_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.fields(buffer, offset, packet, parent, trade_blocks_original_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.fields(buffer, offset, packet, parent, trade_blocks_original_group_index)
  end
end

-- Trade Blocks Original Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups = {}

-- Calculate size of: Trade Blocks Original Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, trade_blocks_original_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Trade Blocks Original Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trade Blocks Original Groups
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trade_blocks_original_group_index = 1, num_in_group_8 do
    index, trade_blocks_original_group = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_group.dissect(buffer, index, packet, parent, trade_blocks_original_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.dissect = function(buffer, offset, packet, parent)
  if show.trade_blocks_original_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.trade_blocks_original_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.fields(buffer, offset, packet, parent)
  end
end

-- Md Incremental Refresh Trade Blocks 340
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340 = {}

-- Calculate size of: Md Incremental Refresh Trade Blocks 340
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.size(buffer, offset + index)

  return index
end

-- Display: Md Incremental Refresh Trade Blocks 340
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.display = function(packet, parent, length)
  return ""
end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.fields = function(buffer, offset, packet, parent)
  ...
  index, trade_blocks_original_groups = cme_futures_streamlined_sbe_v5_8.trade_blocks_original_groups.dissect(buffer, index, packet, parent)

  return index
end

-- Dissect: Md Incremental Refresh Trade Blocks 340
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.dissect = function(buffer, offset, packet, parent)
  if show.md_incremental_refresh_trade_blocks_340 then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_340, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.lines_of_text_groups.dissect = function(buffer, offset, packet, parent)
  if show.lines_of_text_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.lines_of_text_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.lines_of_text_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.lines_of_text_groups.display(packet, parent, length)
    parent:append_text(display)
...
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group = {}

-- Size: News Indices Related Sym Group
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.size =
  cme_futures_streamlined_sbe_v5_8.symbol.size

-- Display: News Indices Related Sym Group
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: News Indices Related Sym Group
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.fields = function(buffer, offset, packet, parent, news_indices_related_sym_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.dissect = function(buffer, offset, packet, parent, news_indices_related_sym_group_index)
  if show.news_indices_related_sym_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.news_indices_related_sym_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.fields(buffer, offset, packet, parent, news_indices_related_sym_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.fields(buffer, offset, packet, parent, news_indices_related_sym_group_index)
  end
end

-- News Indices Related Sym Groups
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups = {}

-- Calculate size of: News Indices Related Sym Groups
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: News Indices Related Sym Groups
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for news_indices_related_sym_group_index = 1, num_in_group_8 do
    index, news_indices_related_sym_group = cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_group.dissect(buffer, index, packet, parent, news_indices_related_sym_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.dissect = function(buffer, offset, packet, parent)
  if show.news_indices_related_sym_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.news_indices_related_sym_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.md_news_indices.size = function(buffer, offset)
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.size(buffer, offset + index)
...
cme_futures_streamlined_sbe_v5_8.md_news_indices.fields = function(buffer, offset, packet, parent)
  ...
  index, news_indices_related_sym_groups = cme_futures_streamlined_sbe_v5_8.news_indices_related_sym_groups.dissect(buffer, index, packet, parent)
...
cme_futures_streamlined_sbe_v5_8.md_news_indices.dissect = function(buffer, offset, packet, parent)
  if show.md_news_indices then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_news_indices, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_news_indices.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_news_indices.display(packet, parent, length)
    parent:append_text(display)
...
cme_futures_streamlined_sbe_v5_8.related_security_group = {}

-- Size: Related Security Group
cme_futures_streamlined_sbe_v5_8.related_security_group.size = 26

-- Display: Related Security Group
cme_futures_streamlined_sbe_v5_8.related_security_group.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.related_security_group.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.related_security_group.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.related_security_group.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.related_security_group, range, value, display)

  return offset + length, value
end

-- Related Symbol
cme_futures_streamlined_sbe_v5_8.related_symbol = {}

-- Size: Related Symbol
cme_futures_streamlined_sbe_v5_8.related_symbol.size = 50

-- Display: Related Symbol
cme_futures_streamlined_sbe_v5_8.related_symbol.display = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_streamlined_sbe_v5_8.related_symbol.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.related_symbol.size
  local range = buffer(offset, length)
  ...
  local display = cme_futures_streamlined_sbe_v5_8.related_symbol.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.related_symbol, range, value, display)

  return offset + length, value
end

-- Related Instrument Type
cme_futures_streamlined_sbe_v5_8.related_instrument_type = {}

-- Size: Related Instrument Type
cme_futures_streamlined_sbe_v5_8.related_instrument_type.size = 1

-- Display: Related Instrument Type
cme_futures_streamlined_sbe_v5_8.related_instrument_type.display = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_streamlined_sbe_v5_8.related_instrument_type.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.related_instrument_type.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.related_instrument_type.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.related_instrument_type, range, value, display)

  return offset + length, value
end

-- Incremental Refresh Eris Related Instruments Group
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group = {}

-- Size: Incremental Refresh Eris Related Instruments Group
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.size =
  cme_futures_streamlined_sbe_v5_8.related_instrument_type.size + 
  cme_futures_streamlined_sbe_v5_8.related_symbol.size + 
  cme_futures_streamlined_sbe_v5_8.related_security_group.size

-- Display: Incremental Refresh Eris Related Instruments Group
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Incremental Refresh Eris Related Instruments Group
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.fields = function(buffer, offset, packet, parent, incremental_refresh_eris_related_instruments_group_index)
  local index = offset
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.dissect = function(buffer, offset, packet, parent, incremental_refresh_eris_related_instruments_group_index)
  if show.incremental_refresh_eris_related_instruments_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_eris_related_instruments_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.fields(buffer, offset, packet, parent, incremental_refresh_eris_related_instruments_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.fields(buffer, offset, packet, parent, incremental_refresh_eris_related_instruments_group_index)
  end
end

-- Incremental Refresh Eris Related Instruments Groups
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups = {}

-- Calculate size of: Incremental Refresh Eris Related Instruments Groups
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.size = function(buffer, offset)
  local index = 0
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Incremental Refresh Eris Related Instruments Groups
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for incremental_refresh_eris_related_instruments_group_index = 1, num_in_group_8 do
    index, incremental_refresh_eris_related_instruments_group = cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_group.dissect(buffer, index, packet, parent, incremental_refresh_eris_related_instruments_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.dissect = function(buffer, offset, packet, parent)
  if show.incremental_refresh_eris_related_instruments_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.incremental_refresh_eris_related_instruments_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.settl_price_type.bits = function(range, value, packet, parent)

  -- Final: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.final, range, value)

  -- Actual: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.actual, range, value)

  -- Rounded: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.rounded, range, value)

  -- Reserved Bits: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.reserved_bits, range, value)

  -- Unused Settl Price Type 4: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.unused_settl_price_type_4, range, value)

  -- Unused Settl Price Type 5: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.unused_settl_price_type_5, range, value)

  -- Unused Settl Price Type 6: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.unused_settl_price_type_6, range, value)

  -- Null Value: 1 Bit
  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.null_value, range, value)
end

-- Dissect: Settl Price Type
cme_futures_streamlined_sbe_v5_8.settl_price_type.dissect = function(buffer, offset, packet, parent)
  local size = cme_futures_streamlined_sbe_v5_8.settl_price_type.size
  local range = buffer(offset, size)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.settl_price_type.display(range, value, packet, parent)
  ...
  if show.settl_price_type then
    cme_futures_streamlined_sbe_v5_8.settl_price_type.bits(range, value, packet, element)
  end
...
cme_futures_streamlined_sbe_v5_8.eris_reference_data_group = {}

-- Calculate size of: Eris Reference Data Group
cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.md_entry_px_decimal_optional.size

  index = index + cme_futures_streamlined_sbe_v5_8.open_close_settl_flag.size

  index = index + cme_futures_streamlined_sbe_v5_8.settl_price_type.size

  index = index + cme_futures_streamlined_sbe_v5_8.cal_fut_px_optional.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.coupon_rate_optional.size

  index = index + cme_futures_streamlined_sbe_v5_8.trade_date.size

  index = index + cme_futures_streamlined_sbe_v5_8.fair_coupon_pct.size

  index = index + cme_futures_streamlined_sbe_v5_8.leg_purchase_rate.size

  index = index + cme_futures_streamlined_sbe_v5_8.fixed_npv.size

  index = index + cme_futures_streamlined_sbe_v5_8.float_npv.size

  index = index + cme_futures_streamlined_sbe_v5_8.npv.size

  index = index + cme_futures_streamlined_sbe_v5_8.accrued_coupons.size

  index = index + cme_futures_streamlined_sbe_v5_8.daily_incremental_eris_pai.size

  index = index + cme_futures_streamlined_sbe_v5_8.eris_pai.size

  index = index + cme_futures_streamlined_sbe_v5_8.fed_funds_rate.size

  index = index + cme_futures_streamlined_sbe_v5_8.min_price_increment_optional.size

  index = index + cme_futures_streamlined_sbe_v5_8.fixed_payment.size

  index = index + cme_futures_streamlined_sbe_v5_8.floating_payment.size

  index = index + cme_futures_streamlined_sbe_v5_8.next_fixed_payment_date.size

  index = index + cme_futures_streamlined_sbe_v5_8.next_fixed_payment_amount.size

  index = index + cme_futures_streamlined_sbe_v5_8.next_floating_payment_amount.size

  index = index + cme_futures_streamlined_sbe_v5_8.trading_reference_date.size

  index = index + cme_futures_streamlined_sbe_v5_8.previous_eris_pai.size
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.leg_contract_multiplier.size

  index = index + cme_futures_streamlined_sbe_v5_8.next_floating_payment_date.size

  index = index + cme_futures_streamlined_sbe_v5_8.p_v_01.size

  index = index + cme_futures_streamlined_sbe_v5_8.d_v_01.size

  index = index + cme_futures_streamlined_sbe_v5_8.settlement_npv.size

  index = index + cme_futures_streamlined_sbe_v5_8.final_settlement_futures_price.size

  index = index + cme_futures_streamlined_sbe_v5_8.security_description.size

  index = index + cme_futures_streamlined_sbe_v5_8.eris_security_alt_id_groups.size(buffer, offset + index)

  index = index + cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.size(buffer, offset + index)
...
cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Reference Data Group
cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.fields = function(buffer, offset, packet, parent, eris_reference_data_group_index)
  local index = offset
  ...
  index, incremental_refresh_eris_related_instruments_groups = cme_futures_streamlined_sbe_v5_8.incremental_refresh_eris_related_instruments_groups.dissect(buffer, index, packet, parent)
...
cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.dissect = function(buffer, offset, packet, parent, eris_reference_data_group_index)
  if show.eris_reference_data_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_reference_data_group, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.fields(buffer, offset, packet, parent, eris_reference_data_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.fields(buffer, offset, packet, parent, eris_reference_data_group_index)
  end
end

-- Eris Reference Data Groups
cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups = {}

-- Calculate size of: Eris Reference Data Groups
cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.size = function(buffer, offset)
  local index = 0
  ...
  for i = 1, eris_reference_data_group_count do
    index = index + cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.size(buffer, offset + index)
  end
  return index
end

-- Display: Eris Reference Data Groups
cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Eris Reference Data Groups
cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for eris_reference_data_group_index = 1, num_in_group_8 do
    index, eris_reference_data_group = cme_futures_streamlined_sbe_v5_8.eris_reference_data_group.dissect(buffer, index, packet, parent, eris_reference_data_group_index)
  end
...
cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.dissect = function(buffer, offset, packet, parent)
  if show.eris_reference_data_groups then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.eris_reference_data_groups, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.fields(buffer, offset, packet, parent)
  end
end
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_reference_data_and_daily_statistics.size = function(buffer, offset)
  ...
  index = index + cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.size(buffer, offset + index)
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_reference_data_and_daily_statistics.fields = function(buffer, offset, packet, parent)
  ...
  index, eris_reference_data_groups = cme_futures_streamlined_sbe_v5_8.eris_reference_data_groups.dissect(buffer, index, packet, parent)
...
cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_reference_data_and_daily_statistics.dissect = function(buffer, offset, packet, parent)
  if show.md_incremental_refresh_eris_reference_data_and_daily_statistics then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.md_incremental_refresh_eris_reference_data_and_daily_statistics, buffer(offset, 0))
    local index = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_reference_data_and_daily_statistics.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_reference_data_and_daily_statistics.display(packet, parent, length)
    parent:append_text(display)
...
cme_futures_streamlined_sbe_v5_8.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 315 then
    return cme_futures_streamlined_sbe_v5_8.admin_login.size
  end
  -- Size of Admin Logout
  if template_id == 316 then
    return cme_futures_streamlined_sbe_v5_8.admin_logout.size
  end
  ...
  if template_id == 340 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.size(buffer, offset)
  end
  ...
  if template_id == 349 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.size(buffer, offset)
  end
  -- Size of Md Incremental Refresh Eris 351
  if template_id == 351 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.size(buffer, offset)
  end
  -- Size of Md Incremental Refresh Eris 353
  if template_id == 353 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.size(buffer, offset)
  end
...
cme_futures_streamlined_sbe_v5_8.payload.branches = function(buffer, offset, packet, parent, template_id)
  ...
  -- Dissect Md Incremental Refresh Trade Blocks 340
  if template_id == 340 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_340.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Quote Request
  if template_id == 345 then
  ...
  -- Dissect Md Incremental Refresh Trade Blocks 349
  if template_id == 349 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_trade_blocks_349.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Md Incremental Refresh Eris 351
  if template_id == 351 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_351.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Md Incremental Refresh Eris 353
  if template_id == 353 then
    return cme_futures_streamlined_sbe_v5_8.md_incremental_refresh_eris_353.dissect(buffer, offset, packet, parent)
  end
  -- Dissect Md Incremental Refresh Otc
  if template_id == 356 then
...
cme_futures_streamlined_sbe_v5_8.packet_sequence_number = {}

-- Size: Packet Sequence Number
cme_futures_streamlined_sbe_v5_8.packet_sequence_number.size = 4

-- Display: Packet Sequence Number
cme_futures_streamlined_sbe_v5_8.packet_sequence_number.display = function(value)
  return "Packet Sequence Number: "..value
end

-- Dissect: Packet Sequence Number
cme_futures_streamlined_sbe_v5_8.packet_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_streamlined_sbe_v5_8.packet_sequence_number.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_streamlined_sbe_v5_8.packet_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_streamlined_sbe_v5_8.fields.packet_sequence_number, range, value, display)
...
cme_futures_streamlined_sbe_v5_8.binary_packet_header.size =
  cme_futures_streamlined_sbe_v5_8.packet_sequence_number.size + 
...
cme_futures_streamlined_sbe_v5_8.binary_packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, packet_sequence_number = cme_futures_streamlined_sbe_v5_8.packet_sequence_number.dissect(buffer, index, packet, parent)
