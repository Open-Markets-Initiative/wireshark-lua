...
-- Cme Futures iLink3 Sbe 8.8 Protocol
local cme_futures_ilink3_sbe_v8_8 = Proto("Cme.Futures.iLink3.Sbe.v8.8.Lua", "Cme Futures iLink3 Sbe 8.8")
...
-- Cme Futures iLink3 Sbe 8.8 Fields
cme_futures_ilink3_sbe_v8_8.fields.access_key_id = ProtoField.new("Access Key Id", "cme.futures.ilink3.sbe.v8.8.accesskeyid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.affected_order_id = ProtoField.new("Affected Order Id", "cme.futures.ilink3.sbe.v8.8.affectedorderid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.affected_orders_group = ProtoField.new("Affected Orders Group", "cme.futures.ilink3.sbe.v8.8.affectedordersgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.affected_orders_groups = ProtoField.new("Affected Orders Groups", "cme.futures.ilink3.sbe.v8.8.affectedordersgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.aggressor_indicator = ProtoField.new("Aggressor Indicator", "cme.futures.ilink3.sbe.v8.8.aggressorindicator", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.aon = ProtoField.new("Aon", "cme.futures.ilink3.sbe.v8.8.aon", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x01")
cme_futures_ilink3_sbe_v8_8.fields.auto_quote_request = ProtoField.new("Auto Quote Request", "cme.futures.ilink3.sbe.v8.8.autoquoterequest", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.avg_px_group_id = ProtoField.new("Avg Px Group Id", "cme.futures.ilink3.sbe.v8.8.avgpxgroupid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.avg_px_indicator = ProtoField.new("Avg Px Indicator", "cme.futures.ilink3.sbe.v8.8.avgpxindicator", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.benchmark_price = ProtoField.new("Benchmark Price", "cme.futures.ilink3.sbe.v8.8.benchmarkprice", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.bid_px = ProtoField.new("Bid Px", "cme.futures.ilink3.sbe.v8.8.bidpx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.bid_size = ProtoField.new("Bid Size", "cme.futures.ilink3.sbe.v8.8.bidsize", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.block_length = ProtoField.new("Block Length", "cme.futures.ilink3.sbe.v8.8.blocklength", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.broken_date_end = ProtoField.new("Broken Date End", "cme.futures.ilink3.sbe.v8.8.brokendateend", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.broken_date_start = ProtoField.new("Broken Date Start", "cme.futures.ilink3.sbe.v8.8.brokendatestart", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.broken_date_term_type = ProtoField.new("Broken Date Term Type", "cme.futures.ilink3.sbe.v8.8.brokendatetermtype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.broken_dates_group = ProtoField.new("Broken Dates Group", "cme.futures.ilink3.sbe.v8.8.brokendatesgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.broken_dates_groups = ProtoField.new("Broken Dates Groups", "cme.futures.ilink3.sbe.v8.8.brokendatesgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.business_reject = ProtoField.new("Business Reject", "cme.futures.ilink3.sbe.v8.8.businessreject", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.business_reject_reason = ProtoField.new("Business Reject Reason", "cme.futures.ilink3.sbe.v8.8.businessrejectreason", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.business_reject_ref_id = ProtoField.new("Business Reject Ref Id", "cme.futures.ilink3.sbe.v8.8.businessrejectrefid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.calculated_ccy_last_qty = ProtoField.new("Calculated Ccy Last Qty", "cme.futures.ilink3.sbe.v8.8.calculatedccylastqty", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.cancel_text = ProtoField.new("Cancel Text", "cme.futures.ilink3.sbe.v8.8.canceltext", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.cancelled_symbol = ProtoField.new("Cancelled Symbol", "cme.futures.ilink3.sbe.v8.8.cancelledsymbol", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.clearing_account_type = ProtoField.new("Clearing Account Type", "cme.futures.ilink3.sbe.v8.8.clearingaccounttype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.clearing_trade_price_type = ProtoField.new("Clearing Trade Price Type", "cme.futures.ilink3.sbe.v8.8.clearingtradepricetype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.clordid = ProtoField.new("ClOrdId", "cme.futures.ilink3.sbe.v8.8.clordid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.cmta_giveup_cd = ProtoField.new("Cmta Giveup Cd", "cme.futures.ilink3.sbe.v8.8.cmtagiveupcd", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.contra_calculated_ccy_last_qty = ProtoField.new("Contra Calculated Ccy Last Qty", "cme.futures.ilink3.sbe.v8.8.contracalculatedccylastqty", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.contra_gross_trade_amt = ProtoField.new("Contra Gross Trade Amt", "cme.futures.ilink3.sbe.v8.8.contragrosstradeamt", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.credentials = ProtoField.new("Credentials", "cme.futures.ilink3.sbe.v8.8.credentials", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.cross_id = ProtoField.new("Cross Id", "cme.futures.ilink3.sbe.v8.8.crossid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.cross_id_optional = ProtoField.new("Cross Id Optional", "cme.futures.ilink3.sbe.v8.8.crossidoptional", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.cross_type = ProtoField.new("Cross Type", "cme.futures.ilink3.sbe.v8.8.crosstype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.cum_qty = ProtoField.new("Cum Qty", "cme.futures.ilink3.sbe.v8.8.cumqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.currency = ProtoField.new("Currency", "cme.futures.ilink3.sbe.v8.8.currency", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.cust_order_capacity = ProtoField.new("Cust Order Capacity", "cme.futures.ilink3.sbe.v8.8.custordercapacity", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.cust_order_handling_inst = ProtoField.new("Cust Order Handling Inst", "cme.futures.ilink3.sbe.v8.8.custorderhandlinginst", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.cxl_quantity = ProtoField.new("Cxl Quantity", "cme.futures.ilink3.sbe.v8.8.cxlquantity", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.cxl_rej_reason = ProtoField.new("Cxl Rej Reason", "cme.futures.ilink3.sbe.v8.8.cxlrejreason", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.data_length = ProtoField.new("Data Length", "cme.futures.ilink3.sbe.v8.8.datalength", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.day = ProtoField.new("Day", "cme.futures.ilink3.sbe.v8.8.day", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.delay_duration = ProtoField.new("Delay Duration", "cme.futures.ilink3.sbe.v8.8.delayduration", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.delay_to_time = ProtoField.new("Delay To Time", "cme.futures.ilink3.sbe.v8.8.delaytotime", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.discretion_price = ProtoField.new("Discretion Price", "cme.futures.ilink3.sbe.v8.8.discretionprice", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.display_limit_price = ProtoField.new("Display Limit Price", "cme.futures.ilink3.sbe.v8.8.displaylimitprice", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.display_qty = ProtoField.new("Display Qty", "cme.futures.ilink3.sbe.v8.8.displayqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.dk_reason = ProtoField.new("Dk Reason", "cme.futures.ilink3.sbe.v8.8.dkreason", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.encoding_type = ProtoField.new("Encoding Type", "cme.futures.ilink3.sbe.v8.8.encodingtype", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.end_date = ProtoField.new("End Date", "cme.futures.ilink3.sbe.v8.8.enddate", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.error_codes = ProtoField.new("Error Codes", "cme.futures.ilink3.sbe.v8.8.errorcodes", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.establish = ProtoField.new("Establish", "cme.futures.ilink3.sbe.v8.8.establish", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.establishment_ack = ProtoField.new("Establishment Ack", "cme.futures.ilink3.sbe.v8.8.establishmentack", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.establishment_reject = ProtoField.new("Establishment Reject", "cme.futures.ilink3.sbe.v8.8.establishmentreject", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.exchange_quote_req_id = ProtoField.new("Exchange Quote Req Id", "cme.futures.ilink3.sbe.v8.8.exchangequotereqid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.exec_ack_status = ProtoField.new("Exec Ack Status", "cme.futures.ilink3.sbe.v8.8.execackstatus", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.exec_id = ProtoField.new("Exec Id", "cme.futures.ilink3.sbe.v8.8.execid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.exec_inst = ProtoField.new("Exec Inst", "cme.futures.ilink3.sbe.v8.8.execinst", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.exec_restatement_reason = ProtoField.new("Exec Restatement Reason", "cme.futures.ilink3.sbe.v8.8.execrestatementreason", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.exec_type = ProtoField.new("Exec Type", "cme.futures.ilink3.sbe.v8.8.exectype", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_ack = ProtoField.new("Execution Ack", "cme.futures.ilink3.sbe.v8.8.executionack", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_mode = ProtoField.new("Execution Mode", "cme.futures.ilink3.sbe.v8.8.executionmode", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_cancel = ProtoField.new("Execution Report Cancel", "cme.futures.ilink3.sbe.v8.8.executionreportcancel", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_elimination = ProtoField.new("Execution Report Elimination", "cme.futures.ilink3.sbe.v8.8.executionreportelimination", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_modify = ProtoField.new("Execution Report Modify", "cme.futures.ilink3.sbe.v8.8.executionreportmodify", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_new = ProtoField.new("Execution Report New", "cme.futures.ilink3.sbe.v8.8.executionreportnew", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_pending_cancel = ProtoField.new("Execution Report Pending Cancel", "cme.futures.ilink3.sbe.v8.8.executionreportpendingcancel", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_pending_replace = ProtoField.new("Execution Report Pending Replace", "cme.futures.ilink3.sbe.v8.8.executionreportpendingreplace", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_reject = ProtoField.new("Execution Report Reject", "cme.futures.ilink3.sbe.v8.8.executionreportreject", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_status = ProtoField.new("Execution Report Status", "cme.futures.ilink3.sbe.v8.8.executionreportstatus", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_outright = ProtoField.new("Execution Report Trade Addendum Outright", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumoutright", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_outright_order_event_group = ProtoField.new("Execution Report Trade Addendum Outright Order Event Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumoutrightordereventgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_outright_order_event_groups = ProtoField.new("Execution Report Trade Addendum Outright Order Event Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumoutrightordereventgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread = ProtoField.new("Execution Report Trade Addendum Spread", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspread", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread_leg = ProtoField.new("Execution Report Trade Addendum Spread Leg", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspreadleg", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread_leg_group = ProtoField.new("Execution Report Trade Addendum Spread Leg Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspreadleggroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread_leg_groups = ProtoField.new("Execution Report Trade Addendum Spread Leg Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspreadleggroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread_leg_order_event_group = ProtoField.new("Execution Report Trade Addendum Spread Leg Order Event Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspreadlegordereventgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread_leg_order_event_groups = ProtoField.new("Execution Report Trade Addendum Spread Leg Order Event Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspreadlegordereventgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread_order_event_group = ProtoField.new("Execution Report Trade Addendum Spread Order Event Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspreadordereventgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_addendum_spread_order_event_groups = ProtoField.new("Execution Report Trade Addendum Spread Order Event Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradeaddendumspreadordereventgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_outright = ProtoField.new("Execution Report Trade Outright", "cme.futures.ilink3.sbe.v8.8.executionreporttradeoutright", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_outright_order_event_group = ProtoField.new("Execution Report Trade Outright Order Event Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradeoutrightordereventgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_outright_order_event_groups = ProtoField.new("Execution Report Trade Outright Order Event Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradeoutrightordereventgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread = ProtoField.new("Execution Report Trade Spread", "cme.futures.ilink3.sbe.v8.8.executionreporttradespread", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread_leg = ProtoField.new("Execution Report Trade Spread Leg", "cme.futures.ilink3.sbe.v8.8.executionreporttradespreadleg", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread_leg_group = ProtoField.new("Execution Report Trade Spread Leg Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradespreadleggroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread_leg_groups = ProtoField.new("Execution Report Trade Spread Leg Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradespreadleggroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread_leg_order_event_group = ProtoField.new("Execution Report Trade Spread Leg Order Event Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradespreadlegordereventgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread_leg_order_event_groups = ProtoField.new("Execution Report Trade Spread Leg Order Event Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradespreadlegordereventgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread_order_event_group = ProtoField.new("Execution Report Trade Spread Order Event Group", "cme.futures.ilink3.sbe.v8.8.executionreporttradespreadordereventgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.execution_report_trade_spread_order_event_groups = ProtoField.new("Execution Report Trade Spread Order Event Groups", "cme.futures.ilink3.sbe.v8.8.executionreporttradespreadordereventgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.executor = ProtoField.new("Executor", "cme.futures.ilink3.sbe.v8.8.executor", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.expiration_cycle = ProtoField.new("Expiration Cycle", "cme.futures.ilink3.sbe.v8.8.expirationcycle", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.expire_date = ProtoField.new("Expire Date", "cme.futures.ilink3.sbe.v8.8.expiredate", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.exponent = ProtoField.new("Exponent", "cme.futures.ilink3.sbe.v8.8.exponent", ftypes.INT8)
cme_futures_ilink3_sbe_v8_8.fields.fault_tolerance_indicator = ProtoField.new("Fault Tolerance Indicator", "cme.futures.ilink3.sbe.v8.8.faulttoleranceindicator", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.fill_exec_id = ProtoField.new("Fill Exec Id", "cme.futures.ilink3.sbe.v8.8.fillexecid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.fill_px = ProtoField.new("Fill Px", "cme.futures.ilink3.sbe.v8.8.fillpx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.fill_qty = ProtoField.new("Fill Qty", "cme.futures.ilink3.sbe.v8.8.fillqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.fill_yield_type = ProtoField.new("Fill Yield Type", "cme.futures.ilink3.sbe.v8.8.fillyieldtype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.fills_group = ProtoField.new("Fills Group", "cme.futures.ilink3.sbe.v8.8.fillsgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.fills_groups = ProtoField.new("Fills Groups", "cme.futures.ilink3.sbe.v8.8.fillsgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.financial_instrument_full_name = ProtoField.new("Financial Instrument Full Name", "cme.futures.ilink3.sbe.v8.8.financialinstrumentfullname", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.firm = ProtoField.new("Firm", "cme.futures.ilink3.sbe.v8.8.firm", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.from_seq_no = ProtoField.new("From Seq No", "cme.futures.ilink3.sbe.v8.8.fromseqno", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.gross_trade_amt = ProtoField.new("Gross Trade Amt", "cme.futures.ilink3.sbe.v8.8.grosstradeamt", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.group_size = ProtoField.new("Group Size", "cme.futures.ilink3.sbe.v8.8.groupsize", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.hmac_signature = ProtoField.new("Hmac Signature", "cme.futures.ilink3.sbe.v8.8.hmacsignature", ftypes.BYTES)
cme_futures_ilink3_sbe_v8_8.fields.host_cross_id = ProtoField.new("Host Cross Id", "cme.futures.ilink3.sbe.v8.8.hostcrossid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.idm_short_code = ProtoField.new("Idm Short Code", "cme.futures.ilink3.sbe.v8.8.idmshortcode", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.keep_alive_interval = ProtoField.new("Keep Alive Interval", "cme.futures.ilink3.sbe.v8.8.keepaliveinterval", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.keep_alive_interval_lapsed = ProtoField.new("Keep Alive Interval Lapsed", "cme.futures.ilink3.sbe.v8.8.keepaliveintervallapsed", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.last_fragment = ProtoField.new("Last Fragment", "cme.futures.ilink3.sbe.v8.8.lastfragment", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.last_px = ProtoField.new("Last Px", "cme.futures.ilink3.sbe.v8.8.lastpx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.last_qty = ProtoField.new("Last Qty", "cme.futures.ilink3.sbe.v8.8.lastqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.last_rpt_requested = ProtoField.new("Last Rpt Requested", "cme.futures.ilink3.sbe.v8.8.lastrptrequested", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.last_uuid = ProtoField.new("Last Uuid", "cme.futures.ilink3.sbe.v8.8.lastuuid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.leaves = ProtoField.new("Leaves", "cme.futures.ilink3.sbe.v8.8.leaves", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.leaves_qty_optional = ProtoField.new("Leaves Qty Optional", "cme.futures.ilink3.sbe.v8.8.leavesqtyoptional", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.leg_exec_id = ProtoField.new("Leg Exec Id", "cme.futures.ilink3.sbe.v8.8.legexecid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.leg_exec_ref_id = ProtoField.new("Leg Exec Ref Id", "cme.futures.ilink3.sbe.v8.8.legexecrefid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.leg_last_px = ProtoField.new("Leg Last Px", "cme.futures.ilink3.sbe.v8.8.leglastpx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.leg_last_qty = ProtoField.new("Leg Last Qty", "cme.futures.ilink3.sbe.v8.8.leglastqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.leg_option_delta = ProtoField.new("Leg Option Delta", "cme.futures.ilink3.sbe.v8.8.legoptiondelta", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.leg_price = ProtoField.new("Leg Price", "cme.futures.ilink3.sbe.v8.8.legprice", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "cme.futures.ilink3.sbe.v8.8.legratioqty", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.leg_security_id = ProtoField.new("Leg Security Id", "cme.futures.ilink3.sbe.v8.8.legsecurityid", ftypes.INT32)
cme_futures_ilink3_sbe_v8_8.fields.leg_side = ProtoField.new("Leg Side", "cme.futures.ilink3.sbe.v8.8.legside", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.leg_trade_id = ProtoField.new("Leg Trade Id", "cme.futures.ilink3.sbe.v8.8.legtradeid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.leg_trade_ref_id = ProtoField.new("Leg Trade Ref Id", "cme.futures.ilink3.sbe.v8.8.legtraderefid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.liquidity_flag = ProtoField.new("Liquidity Flag", "cme.futures.ilink3.sbe.v8.8.liquidityflag", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.list_update_action = ProtoField.new("List Update Action", "cme.futures.ilink3.sbe.v8.8.listupdateaction", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.location = ProtoField.new("Location", "cme.futures.ilink3.sbe.v8.8.location", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.location_optional = ProtoField.new("Location Optional", "cme.futures.ilink3.sbe.v8.8.locationoptional", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.managed_order = ProtoField.new("Managed Order", "cme.futures.ilink3.sbe.v8.8.managedorder", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mantissa = ProtoField.new("Mantissa", "cme.futures.ilink3.sbe.v8.8.mantissa", ftypes.INT64)
cme_futures_ilink3_sbe_v8_8.fields.mantissa_32 = ProtoField.new("Mantissa 32", "cme.futures.ilink3.sbe.v8.8.mantissa32", ftypes.INT32)
cme_futures_ilink3_sbe_v8_8.fields.manual_order_indicator = ProtoField.new("Manual Order Indicator", "cme.futures.ilink3.sbe.v8.8.manualorderindicator", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.manual_order_indicator_optional = ProtoField.new("Manual Order Indicator Optional", "cme.futures.ilink3.sbe.v8.8.manualorderindicatoroptional", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.market_segment_id = ProtoField.new("Market Segment Id", "cme.futures.ilink3.sbe.v8.8.marketsegmentid", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mass_action_ord_typ = ProtoField.new("Mass Action Ord Typ", "cme.futures.ilink3.sbe.v8.8.massactionordtyp", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.mass_action_reject_reason = ProtoField.new("Mass Action Reject Reason", "cme.futures.ilink3.sbe.v8.8.massactionrejectreason", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mass_action_report_id = ProtoField.new("Mass Action Report Id", "cme.futures.ilink3.sbe.v8.8.massactionreportid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.mass_action_response = ProtoField.new("Mass Action Response", "cme.futures.ilink3.sbe.v8.8.massactionresponse", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mass_action_scope = ProtoField.new("Mass Action Scope", "cme.futures.ilink3.sbe.v8.8.massactionscope", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mass_cancel_request_type = ProtoField.new("Mass Cancel Request Type", "cme.futures.ilink3.sbe.v8.8.masscancelrequesttype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mass_cancel_tif = ProtoField.new("Mass Cancel Tif", "cme.futures.ilink3.sbe.v8.8.masscanceltif", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mass_quote = ProtoField.new("Mass Quote", "cme.futures.ilink3.sbe.v8.8.massquote", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.mass_quote_ack = ProtoField.new("Mass Quote Ack", "cme.futures.ilink3.sbe.v8.8.massquoteack", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.mass_quote_ack_entry_group = ProtoField.new("Mass Quote Ack Entry Group", "cme.futures.ilink3.sbe.v8.8.massquoteackentrygroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.mass_quote_ack_entry_groups = ProtoField.new("Mass Quote Ack Entry Groups", "cme.futures.ilink3.sbe.v8.8.massquoteackentrygroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.mass_quote_entry_group = ProtoField.new("Mass Quote Entry Group", "cme.futures.ilink3.sbe.v8.8.massquoteentrygroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.mass_quote_entry_groups = ProtoField.new("Mass Quote Entry Groups", "cme.futures.ilink3.sbe.v8.8.massquoteentrygroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.mass_status_req_id = ProtoField.new("Mass Status Req Id", "cme.futures.ilink3.sbe.v8.8.massstatusreqid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.mass_status_req_id_optional = ProtoField.new("Mass Status Req Id Optional", "cme.futures.ilink3.sbe.v8.8.massstatusreqidoptional", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.mass_status_req_type = ProtoField.new("Mass Status Req Type", "cme.futures.ilink3.sbe.v8.8.massstatusreqtype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.mass_status_tif = ProtoField.new("Mass Status Tif", "cme.futures.ilink3.sbe.v8.8.massstatustif", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.maturity_date = ProtoField.new("Maturity Date", "cme.futures.ilink3.sbe.v8.8.maturitydate", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.maturity_month_year = ProtoField.new("Maturity Month Year", "cme.futures.ilink3.sbe.v8.8.maturitymonthyear", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.max_no_of_substitutions = ProtoField.new("Max No Of Substitutions", "cme.futures.ilink3.sbe.v8.8.maxnoofsubstitutions", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.md_trade_entry_id = ProtoField.new("Md Trade Entry Id", "cme.futures.ilink3.sbe.v8.8.mdtradeentryid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.memo = ProtoField.new("Memo", "cme.futures.ilink3.sbe.v8.8.memo", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.message_header = ProtoField.new("Message Header", "cme.futures.ilink3.sbe.v8.8.messageheader", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.message_length = ProtoField.new("Message Length", "cme.futures.ilink3.sbe.v8.8.messagelength", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.min_qty = ProtoField.new("Min Qty", "cme.futures.ilink3.sbe.v8.8.minqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.mm_protection_reset = ProtoField.new("Mm Protection Reset", "cme.futures.ilink3.sbe.v8.8.mmprotectionreset", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.month = ProtoField.new("Month", "cme.futures.ilink3.sbe.v8.8.month", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.msg_count = ProtoField.new("Msg Count", "cme.futures.ilink3.sbe.v8.8.msgcount", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.msg_count_16 = ProtoField.new("Msg Count 16", "cme.futures.ilink3.sbe.v8.8.msgcount16", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.negotiate = ProtoField.new("Negotiate", "cme.futures.ilink3.sbe.v8.8.negotiate", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.negotiation_reject = ProtoField.new("Negotiation Reject", "cme.futures.ilink3.sbe.v8.8.negotiationreject", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.negotiation_response = ProtoField.new("Negotiation Response", "cme.futures.ilink3.sbe.v8.8.negotiationresponse", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.new_order_cross = ProtoField.new("New Order Cross", "cme.futures.ilink3.sbe.v8.8.newordercross", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.new_order_single = ProtoField.new("New Order Single", "cme.futures.ilink3.sbe.v8.8.newordersingle", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.next_seq_no = ProtoField.new("Next Seq No", "cme.futures.ilink3.sbe.v8.8.nextseqno", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.nh = ProtoField.new("Nh", "cme.futures.ilink3.sbe.v8.8.nh", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x04")
cme_futures_ilink3_sbe_v8_8.fields.no_processed_entries = ProtoField.new("No Processed Entries", "cme.futures.ilink3.sbe.v8.8.noprocessedentries", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.no_processed_entries_32 = ProtoField.new("No Processed Entries 32", "cme.futures.ilink3.sbe.v8.8.noprocessedentries32", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.not_applied = ProtoField.new("Not Applied", "cme.futures.ilink3.sbe.v8.8.notapplied", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.num_in_group = ProtoField.new("Num In Group", "cme.futures.ilink3.sbe.v8.8.numingroup", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.ob = ProtoField.new("Ob", "cme.futures.ilink3.sbe.v8.8.ob", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x02")
cme_futures_ilink3_sbe_v8_8.fields.offer_px = ProtoField.new("Offer Px", "cme.futures.ilink3.sbe.v8.8.offerpx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.offer_size = ProtoField.new("Offer Size", "cme.futures.ilink3.sbe.v8.8.offersize", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.ofm_override = ProtoField.new("Ofm Override", "cme.futures.ilink3.sbe.v8.8.ofmoverride", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.option_delta = ProtoField.new("Option Delta", "cme.futures.ilink3.sbe.v8.8.optiondelta", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.ord_rej_reason = ProtoField.new("Ord Rej Reason", "cme.futures.ilink3.sbe.v8.8.ordrejreason", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.ord_status = ProtoField.new("Ord Status", "cme.futures.ilink3.sbe.v8.8.ordstatus", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.ord_status_req_id = ProtoField.new("Ord Status Req Id", "cme.futures.ilink3.sbe.v8.8.ordstatusreqid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.ord_status_req_id_optional = ProtoField.new("Ord Status Req Id Optional", "cme.futures.ilink3.sbe.v8.8.ordstatusreqidoptional", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.ord_status_req_type = ProtoField.new("Ord Status Req Type", "cme.futures.ilink3.sbe.v8.8.ordstatusreqtype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.ord_status_trd = ProtoField.new("Ord Status Trd", "cme.futures.ilink3.sbe.v8.8.ordstatustrd", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.ord_status_trd_cxl = ProtoField.new("Ord Status Trd Cxl", "cme.futures.ilink3.sbe.v8.8.ordstatustrdcxl", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.ord_type = ProtoField.new("Ord Type", "cme.futures.ilink3.sbe.v8.8.ordtype", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.ord_type_optional = ProtoField.new("Ord Type Optional", "cme.futures.ilink3.sbe.v8.8.ordtypeoptional", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_cancel_reject = ProtoField.new("Order Cancel Reject", "cme.futures.ilink3.sbe.v8.8.ordercancelreject", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_cancel_replace_reject = ProtoField.new("Order Cancel Replace Reject", "cme.futures.ilink3.sbe.v8.8.ordercancelreplacereject", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_cancel_replace_request = ProtoField.new("Order Cancel Replace Request", "cme.futures.ilink3.sbe.v8.8.ordercancelreplacerequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_cancel_request = ProtoField.new("Order Cancel Request", "cme.futures.ilink3.sbe.v8.8.ordercancelrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_event_exec_id = ProtoField.new("Order Event Exec Id", "cme.futures.ilink3.sbe.v8.8.ordereventexecid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.order_event_px = ProtoField.new("Order Event Px", "cme.futures.ilink3.sbe.v8.8.ordereventpx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.order_event_qty = ProtoField.new("Order Event Qty", "cme.futures.ilink3.sbe.v8.8.ordereventqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.order_event_reason = ProtoField.new("Order Event Reason", "cme.futures.ilink3.sbe.v8.8.ordereventreason", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.order_event_text = ProtoField.new("Order Event Text", "cme.futures.ilink3.sbe.v8.8.ordereventtext", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_event_type = ProtoField.new("Order Event Type", "cme.futures.ilink3.sbe.v8.8.ordereventtype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.order_id = ProtoField.new("Order Id", "cme.futures.ilink3.sbe.v8.8.orderid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.order_id_optional = ProtoField.new("Order Id Optional", "cme.futures.ilink3.sbe.v8.8.orderidoptional", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.order_mass_action_report = ProtoField.new("Order Mass Action Report", "cme.futures.ilink3.sbe.v8.8.ordermassactionreport", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_mass_action_request = ProtoField.new("Order Mass Action Request", "cme.futures.ilink3.sbe.v8.8.ordermassactionrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_mass_status_request = ProtoField.new("Order Mass Status Request", "cme.futures.ilink3.sbe.v8.8.ordermassstatusrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.order_qty = ProtoField.new("Order Qty", "cme.futures.ilink3.sbe.v8.8.orderqty", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.order_qty_optional = ProtoField.new("Order Qty Optional", "cme.futures.ilink3.sbe.v8.8.orderqtyoptional", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.order_request_id = ProtoField.new("Order Request Id", "cme.futures.ilink3.sbe.v8.8.orderrequestid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.order_status_request = ProtoField.new("Order Status Request", "cme.futures.ilink3.sbe.v8.8.orderstatusrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.orig_order_user = ProtoField.new("Orig Order User", "cme.futures.ilink3.sbe.v8.8.origorderuser", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.orig_secondary_execution_id = ProtoField.new("Orig Secondary Execution Id", "cme.futures.ilink3.sbe.v8.8.origsecondaryexecutionid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.orig_side_trade_id = ProtoField.new("Orig Side Trade Id", "cme.futures.ilink3.sbe.v8.8.origsidetradeid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.origclordid = ProtoField.new("OrigClOrdId", "cme.futures.ilink3.sbe.v8.8.origclordid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.original_order_event_exec_id = ProtoField.new("Original Order Event Exec Id", "cme.futures.ilink3.sbe.v8.8.originalordereventexecid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.ownership = ProtoField.new("Ownership", "cme.futures.ilink3.sbe.v8.8.ownership", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.packet = ProtoField.new("Packet", "cme.futures.ilink3.sbe.v8.8.packet", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_detail_definition_status = ProtoField.new("Party Detail Definition Status", "cme.futures.ilink3.sbe.v8.8.partydetaildefinitionstatus", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.party_detail_id = ProtoField.new("Party Detail Id", "cme.futures.ilink3.sbe.v8.8.partydetailid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_detail_request_status = ProtoField.new("Party Detail Request Status", "cme.futures.ilink3.sbe.v8.8.partydetailrequeststatus", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.party_detail_role = ProtoField.new("Party Detail Role", "cme.futures.ilink3.sbe.v8.8.partydetailrole", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.party_details_definition_request = ProtoField.new("Party Details Definition Request", "cme.futures.ilink3.sbe.v8.8.partydetailsdefinitionrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_details_definition_request_ack = ProtoField.new("Party Details Definition Request Ack", "cme.futures.ilink3.sbe.v8.8.partydetailsdefinitionrequestack", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_details_group = ProtoField.new("Party Details Group", "cme.futures.ilink3.sbe.v8.8.partydetailsgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_details_groups = ProtoField.new("Party Details Groups", "cme.futures.ilink3.sbe.v8.8.partydetailsgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_details_list_report = ProtoField.new("Party Details List Report", "cme.futures.ilink3.sbe.v8.8.partydetailslistreport", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_details_list_report_id = ProtoField.new("Party Details List Report Id", "cme.futures.ilink3.sbe.v8.8.partydetailslistreportid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.party_details_list_req_id = ProtoField.new("Party Details List Req Id", "cme.futures.ilink3.sbe.v8.8.partydetailslistreqid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.party_details_list_req_id_optional = ProtoField.new("Party Details List Req Id Optional", "cme.futures.ilink3.sbe.v8.8.partydetailslistreqidoptional", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.party_details_list_request = ProtoField.new("Party Details List Request", "cme.futures.ilink3.sbe.v8.8.partydetailslistrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_i_ds_group = ProtoField.new("Party I Ds Group", "cme.futures.ilink3.sbe.v8.8.partyidsgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_i_ds_groups = ProtoField.new("Party I Ds Groups", "cme.futures.ilink3.sbe.v8.8.partyidsgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_id = ProtoField.new("Party Id", "cme.futures.ilink3.sbe.v8.8.partyid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.party_id_source = ProtoField.new("Party Id Source", "cme.futures.ilink3.sbe.v8.8.partyidsource", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.party_role = ProtoField.new("Party Role", "cme.futures.ilink3.sbe.v8.8.partyrole", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.payload = ProtoField.new("Payload", "cme.futures.ilink3.sbe.v8.8.payload", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.poss_retrans_flag = ProtoField.new("Poss Retrans Flag", "cme.futures.ilink3.sbe.v8.8.possretransflag", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.previous_seq_no = ProtoField.new("Previous Seq No", "cme.futures.ilink3.sbe.v8.8.previousseqno", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.previous_uuid = ProtoField.new("Previous Uuid", "cme.futures.ilink3.sbe.v8.8.previousuuid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.price = ProtoField.new("Price", "cme.futures.ilink3.sbe.v8.8.price", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.price_optional = ProtoField.new("Price Optional", "cme.futures.ilink3.sbe.v8.8.priceoptional", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.priority_indicator = ProtoField.new("Priority Indicator", "cme.futures.ilink3.sbe.v8.8.priorityindicator", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.quote_ack_status = ProtoField.new("Quote Ack Status", "cme.futures.ilink3.sbe.v8.8.quoteackstatus", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel = ProtoField.new("Quote Cancel", "cme.futures.ilink3.sbe.v8.8.quotecancel", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_ack = ProtoField.new("Quote Cancel Ack", "cme.futures.ilink3.sbe.v8.8.quotecancelack", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_ack_entry_group = ProtoField.new("Quote Cancel Ack Entry Group", "cme.futures.ilink3.sbe.v8.8.quotecancelackentrygroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_ack_entry_groups = ProtoField.new("Quote Cancel Ack Entry Groups", "cme.futures.ilink3.sbe.v8.8.quotecancelackentrygroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_ack_set_group = ProtoField.new("Quote Cancel Ack Set Group", "cme.futures.ilink3.sbe.v8.8.quotecancelacksetgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_ack_set_groups = ProtoField.new("Quote Cancel Ack Set Groups", "cme.futures.ilink3.sbe.v8.8.quotecancelacksetgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_entry_group = ProtoField.new("Quote Cancel Entry Group", "cme.futures.ilink3.sbe.v8.8.quotecancelentrygroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_entry_groups = ProtoField.new("Quote Cancel Entry Groups", "cme.futures.ilink3.sbe.v8.8.quotecancelentrygroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_set_group = ProtoField.new("Quote Cancel Set Group", "cme.futures.ilink3.sbe.v8.8.quotecancelsetgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_set_groups = ProtoField.new("Quote Cancel Set Groups", "cme.futures.ilink3.sbe.v8.8.quotecancelsetgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.quote_cancel_type = ProtoField.new("Quote Cancel Type", "cme.futures.ilink3.sbe.v8.8.quotecanceltype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.quote_cxl_status = ProtoField.new("Quote Cxl Status", "cme.futures.ilink3.sbe.v8.8.quotecxlstatus", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.quote_entry_id = ProtoField.new("Quote Entry Id", "cme.futures.ilink3.sbe.v8.8.quoteentryid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.quote_entry_open = ProtoField.new("Quote Entry Open", "cme.futures.ilink3.sbe.v8.8.quoteentryopen", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.quote_entry_reject_reason = ProtoField.new("Quote Entry Reject Reason", "cme.futures.ilink3.sbe.v8.8.quoteentryrejectreason", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.quote_error_code = ProtoField.new("Quote Error Code", "cme.futures.ilink3.sbe.v8.8.quoteerrorcode", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.quote_id = ProtoField.new("Quote Id", "cme.futures.ilink3.sbe.v8.8.quoteid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.quote_reject_reason = ProtoField.new("Quote Reject Reason", "cme.futures.ilink3.sbe.v8.8.quoterejectreason", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.quote_req_id = ProtoField.new("Quote Req Id", "cme.futures.ilink3.sbe.v8.8.quotereqid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.quote_req_id_optional = ProtoField.new("Quote Req Id Optional", "cme.futures.ilink3.sbe.v8.8.quotereqidoptional", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.quote_set_id = ProtoField.new("Quote Set Id", "cme.futures.ilink3.sbe.v8.8.quotesetid", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.quote_type = ProtoField.new("Quote Type", "cme.futures.ilink3.sbe.v8.8.quotetype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.reason = ProtoField.new("Reason", "cme.futures.ilink3.sbe.v8.8.reason", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.ref_msg_type = ProtoField.new("Ref Msg Type", "cme.futures.ilink3.sbe.v8.8.refmsgtype", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.ref_seq_num = ProtoField.new("Ref Seq Num", "cme.futures.ilink3.sbe.v8.8.refseqnum", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.ref_tag_id = ProtoField.new("Ref Tag Id", "cme.futures.ilink3.sbe.v8.8.reftagid", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.related_sym_group = ProtoField.new("Related Sym Group", "cme.futures.ilink3.sbe.v8.8.relatedsymgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.related_sym_groups = ProtoField.new("Related Sym Groups", "cme.futures.ilink3.sbe.v8.8.relatedsymgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.request_for_quote = ProtoField.new("Request For Quote", "cme.futures.ilink3.sbe.v8.8.requestforquote", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.request_for_quote_ack = ProtoField.new("Request For Quote Ack", "cme.futures.ilink3.sbe.v8.8.requestforquoteack", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.request_result = ProtoField.new("Request Result", "cme.futures.ilink3.sbe.v8.8.requestresult", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.request_time = ProtoField.new("Request Time", "cme.futures.ilink3.sbe.v8.8.requesttime", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.request_timestamp = ProtoField.new("Request Timestamp", "cme.futures.ilink3.sbe.v8.8.requesttimestamp", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.requesting_party_i_ds_group = ProtoField.new("Requesting Party I Ds Group", "cme.futures.ilink3.sbe.v8.8.requestingpartyidsgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.requesting_party_i_ds_groups = ProtoField.new("Requesting Party I Ds Groups", "cme.futures.ilink3.sbe.v8.8.requestingpartyidsgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.requesting_party_id = ProtoField.new("Requesting Party Id", "cme.futures.ilink3.sbe.v8.8.requestingpartyid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.requesting_party_id_source = ProtoField.new("Requesting Party Id Source", "cme.futures.ilink3.sbe.v8.8.requestingpartyidsource", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.requesting_party_role = ProtoField.new("Requesting Party Role", "cme.futures.ilink3.sbe.v8.8.requestingpartyrole", ftypes.STRING)
...
cme_futures_ilink3_sbe_v8_8.fields.reserved_5 = ProtoField.new("Reserved 5", "cme.futures.ilink3.sbe.v8.8.reserved5", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x80")
cme_futures_ilink3_sbe_v8_8.fields.retransmission = ProtoField.new("Retransmission", "cme.futures.ilink3.sbe.v8.8.retransmission", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.retransmit_reject = ProtoField.new("Retransmit Reject", "cme.futures.ilink3.sbe.v8.8.retransmitreject", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.retransmit_request = ProtoField.new("Retransmit Request", "cme.futures.ilink3.sbe.v8.8.retransmitrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.rfq_side = ProtoField.new("Rfq Side", "cme.futures.ilink3.sbe.v8.8.rfqside", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.risk_free_rate = ProtoField.new("Risk Free Rate", "cme.futures.ilink3.sbe.v8.8.riskfreerate", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.schema_id = ProtoField.new("Schema Id", "cme.futures.ilink3.sbe.v8.8.schemaid", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.sec_exec_id = ProtoField.new("Sec Exec Id", "cme.futures.ilink3.sbe.v8.8.secexecid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.secret_key_secure_id_expiration = ProtoField.new("Secret Key Secure Id Expiration", "cme.futures.ilink3.sbe.v8.8.secretkeysecureidexpiration", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.security_definition_request = ProtoField.new("Security Definition Request", "cme.futures.ilink3.sbe.v8.8.securitydefinitionrequest", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_definition_request_leg_group = ProtoField.new("Security Definition Request Leg Group", "cme.futures.ilink3.sbe.v8.8.securitydefinitionrequestleggroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_definition_request_leg_groups = ProtoField.new("Security Definition Request Leg Groups", "cme.futures.ilink3.sbe.v8.8.securitydefinitionrequestleggroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_definition_response = ProtoField.new("Security Definition Response", "cme.futures.ilink3.sbe.v8.8.securitydefinitionresponse", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_definition_response_leg_group = ProtoField.new("Security Definition Response Leg Group", "cme.futures.ilink3.sbe.v8.8.securitydefinitionresponseleggroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_definition_response_leg_groups = ProtoField.new("Security Definition Response Leg Groups", "cme.futures.ilink3.sbe.v8.8.securitydefinitionresponseleggroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_group = ProtoField.new("Security Group", "cme.futures.ilink3.sbe.v8.8.securitygroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_id = ProtoField.new("Security Id", "cme.futures.ilink3.sbe.v8.8.securityid", ftypes.INT32)
cme_futures_ilink3_sbe_v8_8.fields.security_id_optional = ProtoField.new("Security Id Optional", "cme.futures.ilink3.sbe.v8.8.securityidoptional", ftypes.INT32)
cme_futures_ilink3_sbe_v8_8.fields.security_req_id = ProtoField.new("Security Req Id", "cme.futures.ilink3.sbe.v8.8.securityreqid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.security_response_id = ProtoField.new("Security Response Id", "cme.futures.ilink3.sbe.v8.8.securityresponseid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.security_response_type = ProtoField.new("Security Response Type", "cme.futures.ilink3.sbe.v8.8.securityresponsetype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.security_sub_type = ProtoField.new("Security Sub Type", "cme.futures.ilink3.sbe.v8.8.securitysubtype", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.security_type = ProtoField.new("Security Type", "cme.futures.ilink3.sbe.v8.8.securitytype", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.self_match_prevention_id = ProtoField.new("Self Match Prevention Id", "cme.futures.ilink3.sbe.v8.8.selfmatchpreventionid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.self_match_prevention_instruction = ProtoField.new("Self Match Prevention Instruction", "cme.futures.ilink3.sbe.v8.8.selfmatchpreventioninstruction", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.sender_id = ProtoField.new("Sender Id", "cme.futures.ilink3.sbe.v8.8.senderid", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.sender_id_optional = ProtoField.new("Sender Id Optional", "cme.futures.ilink3.sbe.v8.8.senderidoptional", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.sending_time_epoch = ProtoField.new("Sending Time Epoch", "cme.futures.ilink3.sbe.v8.8.sendingtimeepoch", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.seq_num = ProtoField.new("Seq Num", "cme.futures.ilink3.sbe.v8.8.seqnum", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.sequence = ProtoField.new("Sequence", "cme.futures.ilink3.sbe.v8.8.sequence", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.session = ProtoField.new("Session", "cme.futures.ilink3.sbe.v8.8.session", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.settl_date = ProtoField.new("Settl Date", "cme.futures.ilink3.sbe.v8.8.settldate", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.short_sale_type = ProtoField.new("Short Sale Type", "cme.futures.ilink3.sbe.v8.8.shortsaletype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.side = ProtoField.new("Side", "cme.futures.ilink3.sbe.v8.8.side", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.side_optional = ProtoField.new("Side Optional", "cme.futures.ilink3.sbe.v8.8.sideoptional", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.side_time_in_force = ProtoField.new("Side Time In Force", "cme.futures.ilink3.sbe.v8.8.sidetimeinforce", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.side_trade_id = ProtoField.new("Side Trade Id", "cme.futures.ilink3.sbe.v8.8.sidetradeid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.sides_group = ProtoField.new("Sides Group", "cme.futures.ilink3.sbe.v8.8.sidesgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.sides_groups = ProtoField.new("Sides Groups", "cme.futures.ilink3.sbe.v8.8.sidesgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.simple_open_frame = ProtoField.new("Simple Open Frame", "cme.futures.ilink3.sbe.v8.8.simpleopenframe", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.simple_open_framing_header = ProtoField.new("Simple Open Framing Header", "cme.futures.ilink3.sbe.v8.8.simpleopenframingheader", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.source_repo_id = ProtoField.new("Source Repo Id", "cme.futures.ilink3.sbe.v8.8.sourcerepoid", ftypes.INT32)
cme_futures_ilink3_sbe_v8_8.fields.split_msg = ProtoField.new("Split Msg", "cme.futures.ilink3.sbe.v8.8.splitmsg", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.start_date = ProtoField.new("Start Date", "cme.futures.ilink3.sbe.v8.8.startdate", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.stop_px = ProtoField.new("Stop Px", "cme.futures.ilink3.sbe.v8.8.stoppx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.symbol = ProtoField.new("Symbol", "cme.futures.ilink3.sbe.v8.8.symbol", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.template_id = ProtoField.new("Template Id", "cme.futures.ilink3.sbe.v8.8.templateid", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.terminate = ProtoField.new("Terminate", "cme.futures.ilink3.sbe.v8.8.terminate", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.termination_type = ProtoField.new("Termination Type", "cme.futures.ilink3.sbe.v8.8.terminationtype", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.text = ProtoField.new("Text", "cme.futures.ilink3.sbe.v8.8.text", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.time_in_force = ProtoField.new("Time In Force", "cme.futures.ilink3.sbe.v8.8.timeinforce", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.time_to_expiration = ProtoField.new("Time To Expiration", "cme.futures.ilink3.sbe.v8.8.timetoexpiration", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.tot_no_quote_entries = ProtoField.new("Tot No Quote Entries", "cme.futures.ilink3.sbe.v8.8.totnoquoteentries", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.tot_no_quote_entries_optional = ProtoField.new("Tot No Quote Entries Optional", "cme.futures.ilink3.sbe.v8.8.totnoquoteentriesoptional", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.tot_num_parties = ProtoField.new("Tot Num Parties", "cme.futures.ilink3.sbe.v8.8.totnumparties", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.total_affected_orders = ProtoField.new("Total Affected Orders", "cme.futures.ilink3.sbe.v8.8.totalaffectedorders", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.total_num_securities = ProtoField.new("Total Num Securities", "cme.futures.ilink3.sbe.v8.8.totalnumsecurities", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.trade_addendum = ProtoField.new("Trade Addendum", "cme.futures.ilink3.sbe.v8.8.tradeaddendum", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.trade_date = ProtoField.new("Trade Date", "cme.futures.ilink3.sbe.v8.8.tradedate", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.trade_link_id = ProtoField.new("Trade Link Id", "cme.futures.ilink3.sbe.v8.8.tradelinkid", ftypes.UINT32)
cme_futures_ilink3_sbe_v8_8.fields.trading_system_name = ProtoField.new("Trading System Name", "cme.futures.ilink3.sbe.v8.8.tradingsystemname", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.trading_system_vendor = ProtoField.new("Trading System Vendor", "cme.futures.ilink3.sbe.v8.8.tradingsystemvendor", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.trading_system_version = ProtoField.new("Trading System Version", "cme.futures.ilink3.sbe.v8.8.tradingsystemversion", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.trans_bkd_time = ProtoField.new("Trans Bkd Time", "cme.futures.ilink3.sbe.v8.8.transbkdtime", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.transact_time = ProtoField.new("Transact Time", "cme.futures.ilink3.sbe.v8.8.transacttime", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.trd_reg_publication_reason = ProtoField.new("Trd Reg Publication Reason", "cme.futures.ilink3.sbe.v8.8.trdregpublicationreason", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.trd_reg_publication_type = ProtoField.new("Trd Reg Publication Type", "cme.futures.ilink3.sbe.v8.8.trdregpublicationtype", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.trd_reg_publications_group = ProtoField.new("Trd Reg Publications Group", "cme.futures.ilink3.sbe.v8.8.trdregpublicationsgroup", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.trd_reg_publications_groups = ProtoField.new("Trd Reg Publications Groups", "cme.futures.ilink3.sbe.v8.8.trdregpublicationsgroups", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.trd_type = ProtoField.new("Trd Type", "cme.futures.ilink3.sbe.v8.8.trdtype", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.underlying_px = ProtoField.new("Underlying Px", "cme.futures.ilink3.sbe.v8.8.underlyingpx", ftypes.DOUBLE)
cme_futures_ilink3_sbe_v8_8.fields.underlying_security_id = ProtoField.new("Underlying Security Id", "cme.futures.ilink3.sbe.v8.8.underlyingsecurityid", ftypes.INT32)
cme_futures_ilink3_sbe_v8_8.fields.unsolicited_cancel_type = ProtoField.new("Unsolicited Cancel Type", "cme.futures.ilink3.sbe.v8.8.unsolicitedcanceltype", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.uuid = ProtoField.new("Uuid", "cme.futures.ilink3.sbe.v8.8.uuid", ftypes.UINT64)
cme_futures_ilink3_sbe_v8_8.fields.var_data = ProtoField.new("Var Data", "cme.futures.ilink3.sbe.v8.8.vardata", ftypes.BYTES)
cme_futures_ilink3_sbe_v8_8.fields.version = ProtoField.new("Version", "cme.futures.ilink3.sbe.v8.8.version", ftypes.UINT16)
cme_futures_ilink3_sbe_v8_8.fields.volatility = ProtoField.new("Volatility", "cme.futures.ilink3.sbe.v8.8.volatility", ftypes.STRING)
cme_futures_ilink3_sbe_v8_8.fields.week = ProtoField.new("Week", "cme.futures.ilink3.sbe.v8.8.week", ftypes.UINT8)
cme_futures_ilink3_sbe_v8_8.fields.year = ProtoField.new("Year", "cme.futures.ilink3.sbe.v8.8.year", ftypes.UINT16)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Cme Futures iLink3 Sbe 8.8 Element Dissection Options
...
-- Register Cme Futures iLink3 Sbe 8.8 Show Options
cme_futures_ilink3_sbe_v8_8.prefs.show_affected_orders_group = Pref.bool("Show Affected Orders Group", show.affected_orders_group, "Parse and add Affected Orders Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_affected_orders_groups = Pref.bool("Show Affected Orders Groups", show.affected_orders_groups, "Parse and add Affected Orders Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_broken_dates_group = Pref.bool("Show Broken Dates Group", show.broken_dates_group, "Parse and add Broken Dates Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_broken_dates_groups = Pref.bool("Show Broken Dates Groups", show.broken_dates_groups, "Parse and add Broken Dates Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_business_reject = Pref.bool("Show Business Reject", show.business_reject, "Parse and add Business Reject to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_calculated_ccy_last_qty = Pref.bool("Show Calculated Ccy Last Qty", show.calculated_ccy_last_qty, "Parse and add Calculated Ccy Last Qty to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_contra_calculated_ccy_last_qty = Pref.bool("Show Contra Calculated Ccy Last Qty", show.contra_calculated_ccy_last_qty, "Parse and add Contra Calculated Ccy Last Qty to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_contra_gross_trade_amt = Pref.bool("Show Contra Gross Trade Amt", show.contra_gross_trade_amt, "Parse and add Contra Gross Trade Amt to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_credentials = Pref.bool("Show Credentials", show.credentials, "Parse and add Credentials to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_establish = Pref.bool("Show Establish", show.establish, "Parse and add Establish to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_establishment_ack = Pref.bool("Show Establishment Ack", show.establishment_ack, "Parse and add Establishment Ack to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_establishment_reject = Pref.bool("Show Establishment Reject", show.establishment_reject, "Parse and add Establishment Reject to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_exec_inst = Pref.bool("Show Exec Inst", show.exec_inst, "Parse and add Exec Inst to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_ack = Pref.bool("Show Execution Ack", show.execution_ack, "Parse and add Execution Ack to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_cancel = Pref.bool("Show Execution Report Cancel", show.execution_report_cancel, "Parse and add Execution Report Cancel to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_elimination = Pref.bool("Show Execution Report Elimination", show.execution_report_elimination, "Parse and add Execution Report Elimination to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_modify = Pref.bool("Show Execution Report Modify", show.execution_report_modify, "Parse and add Execution Report Modify to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_new = Pref.bool("Show Execution Report New", show.execution_report_new, "Parse and add Execution Report New to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_pending_cancel = Pref.bool("Show Execution Report Pending Cancel", show.execution_report_pending_cancel, "Parse and add Execution Report Pending Cancel to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_pending_replace = Pref.bool("Show Execution Report Pending Replace", show.execution_report_pending_replace, "Parse and add Execution Report Pending Replace to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_reject = Pref.bool("Show Execution Report Reject", show.execution_report_reject, "Parse and add Execution Report Reject to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_status = Pref.bool("Show Execution Report Status", show.execution_report_status, "Parse and add Execution Report Status to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright = Pref.bool("Show Execution Report Trade Addendum Outright", show.execution_report_trade_addendum_outright, "Parse and add Execution Report Trade Addendum Outright to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright_order_event_group = Pref.bool("Show Execution Report Trade Addendum Outright Order Event Group", show.execution_report_trade_addendum_outright_order_event_group, "Parse and add Execution Report Trade Addendum Outright Order Event Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright_order_event_groups = Pref.bool("Show Execution Report Trade Addendum Outright Order Event Groups", show.execution_report_trade_addendum_outright_order_event_groups, "Parse and add Execution Report Trade Addendum Outright Order Event Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread = Pref.bool("Show Execution Report Trade Addendum Spread", show.execution_report_trade_addendum_spread, "Parse and add Execution Report Trade Addendum Spread to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg = Pref.bool("Show Execution Report Trade Addendum Spread Leg", show.execution_report_trade_addendum_spread_leg, "Parse and add Execution Report Trade Addendum Spread Leg to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_group = Pref.bool("Show Execution Report Trade Addendum Spread Leg Group", show.execution_report_trade_addendum_spread_leg_group, "Parse and add Execution Report Trade Addendum Spread Leg Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_groups = Pref.bool("Show Execution Report Trade Addendum Spread Leg Groups", show.execution_report_trade_addendum_spread_leg_groups, "Parse and add Execution Report Trade Addendum Spread Leg Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_order_event_group = Pref.bool("Show Execution Report Trade Addendum Spread Leg Order Event Group", show.execution_report_trade_addendum_spread_leg_order_event_group, "Parse and add Execution Report Trade Addendum Spread Leg Order Event Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_order_event_groups = Pref.bool("Show Execution Report Trade Addendum Spread Leg Order Event Groups", show.execution_report_trade_addendum_spread_leg_order_event_groups, "Parse and add Execution Report Trade Addendum Spread Leg Order Event Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_order_event_group = Pref.bool("Show Execution Report Trade Addendum Spread Order Event Group", show.execution_report_trade_addendum_spread_order_event_group, "Parse and add Execution Report Trade Addendum Spread Order Event Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_order_event_groups = Pref.bool("Show Execution Report Trade Addendum Spread Order Event Groups", show.execution_report_trade_addendum_spread_order_event_groups, "Parse and add Execution Report Trade Addendum Spread Order Event Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright = Pref.bool("Show Execution Report Trade Outright", show.execution_report_trade_outright, "Parse and add Execution Report Trade Outright to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright_order_event_group = Pref.bool("Show Execution Report Trade Outright Order Event Group", show.execution_report_trade_outright_order_event_group, "Parse and add Execution Report Trade Outright Order Event Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright_order_event_groups = Pref.bool("Show Execution Report Trade Outright Order Event Groups", show.execution_report_trade_outright_order_event_groups, "Parse and add Execution Report Trade Outright Order Event Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread = Pref.bool("Show Execution Report Trade Spread", show.execution_report_trade_spread, "Parse and add Execution Report Trade Spread to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg = Pref.bool("Show Execution Report Trade Spread Leg", show.execution_report_trade_spread_leg, "Parse and add Execution Report Trade Spread Leg to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_group = Pref.bool("Show Execution Report Trade Spread Leg Group", show.execution_report_trade_spread_leg_group, "Parse and add Execution Report Trade Spread Leg Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_groups = Pref.bool("Show Execution Report Trade Spread Leg Groups", show.execution_report_trade_spread_leg_groups, "Parse and add Execution Report Trade Spread Leg Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_order_event_group = Pref.bool("Show Execution Report Trade Spread Leg Order Event Group", show.execution_report_trade_spread_leg_order_event_group, "Parse and add Execution Report Trade Spread Leg Order Event Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_order_event_groups = Pref.bool("Show Execution Report Trade Spread Leg Order Event Groups", show.execution_report_trade_spread_leg_order_event_groups, "Parse and add Execution Report Trade Spread Leg Order Event Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_order_event_group = Pref.bool("Show Execution Report Trade Spread Order Event Group", show.execution_report_trade_spread_order_event_group, "Parse and add Execution Report Trade Spread Order Event Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_order_event_groups = Pref.bool("Show Execution Report Trade Spread Order Event Groups", show.execution_report_trade_spread_order_event_groups, "Parse and add Execution Report Trade Spread Order Event Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_fills_group = Pref.bool("Show Fills Group", show.fills_group, "Parse and add Fills Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_fills_groups = Pref.bool("Show Fills Groups", show.fills_groups, "Parse and add Fills Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_gross_trade_amt = Pref.bool("Show Gross Trade Amt", show.gross_trade_amt, "Parse and add Gross Trade Amt to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_group_size = Pref.bool("Show Group Size", show.group_size, "Parse and add Group Size to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_leg_option_delta = Pref.bool("Show Leg Option Delta", show.leg_option_delta, "Parse and add Leg Option Delta to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote = Pref.bool("Show Mass Quote", show.mass_quote, "Parse and add Mass Quote to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack = Pref.bool("Show Mass Quote Ack", show.mass_quote_ack, "Parse and add Mass Quote Ack to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack_entry_group = Pref.bool("Show Mass Quote Ack Entry Group", show.mass_quote_ack_entry_group, "Parse and add Mass Quote Ack Entry Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack_entry_groups = Pref.bool("Show Mass Quote Ack Entry Groups", show.mass_quote_ack_entry_groups, "Parse and add Mass Quote Ack Entry Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_entry_group = Pref.bool("Show Mass Quote Entry Group", show.mass_quote_entry_group, "Parse and add Mass Quote Entry Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_entry_groups = Pref.bool("Show Mass Quote Entry Groups", show.mass_quote_entry_groups, "Parse and add Mass Quote Entry Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_maturity_month_year = Pref.bool("Show Maturity Month Year", show.maturity_month_year, "Parse and add Maturity Month Year to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_negotiate = Pref.bool("Show Negotiate", show.negotiate, "Parse and add Negotiate to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_negotiation_reject = Pref.bool("Show Negotiation Reject", show.negotiation_reject, "Parse and add Negotiation Reject to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_negotiation_response = Pref.bool("Show Negotiation Response", show.negotiation_response, "Parse and add Negotiation Response to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_new_order_cross = Pref.bool("Show New Order Cross", show.new_order_cross, "Parse and add New Order Cross to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_new_order_single = Pref.bool("Show New Order Single", show.new_order_single, "Parse and add New Order Single to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_not_applied = Pref.bool("Show Not Applied", show.not_applied, "Parse and add Not Applied to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_option_delta = Pref.bool("Show Option Delta", show.option_delta, "Parse and add Option Delta to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_reject = Pref.bool("Show Order Cancel Reject", show.order_cancel_reject, "Parse and add Order Cancel Reject to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_replace_reject = Pref.bool("Show Order Cancel Replace Reject", show.order_cancel_replace_reject, "Parse and add Order Cancel Replace Reject to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_replace_request = Pref.bool("Show Order Cancel Replace Request", show.order_cancel_replace_request, "Parse and add Order Cancel Replace Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_request = Pref.bool("Show Order Cancel Request", show.order_cancel_request, "Parse and add Order Cancel Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_action_report = Pref.bool("Show Order Mass Action Report", show.order_mass_action_report, "Parse and add Order Mass Action Report to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_action_request = Pref.bool("Show Order Mass Action Request", show.order_mass_action_request, "Parse and add Order Mass Action Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_status_request = Pref.bool("Show Order Mass Status Request", show.order_mass_status_request, "Parse and add Order Mass Status Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_order_status_request = Pref.bool("Show Order Status Request", show.order_status_request, "Parse and add Order Status Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_definition_request = Pref.bool("Show Party Details Definition Request", show.party_details_definition_request, "Parse and add Party Details Definition Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_definition_request_ack = Pref.bool("Show Party Details Definition Request Ack", show.party_details_definition_request_ack, "Parse and add Party Details Definition Request Ack to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_group = Pref.bool("Show Party Details Group", show.party_details_group, "Parse and add Party Details Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_groups = Pref.bool("Show Party Details Groups", show.party_details_groups, "Parse and add Party Details Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_list_report = Pref.bool("Show Party Details List Report", show.party_details_list_report, "Parse and add Party Details List Report to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_list_request = Pref.bool("Show Party Details List Request", show.party_details_list_request, "Parse and add Party Details List Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_i_ds_group = Pref.bool("Show Party I Ds Group", show.party_i_ds_group, "Parse and add Party I Ds Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_party_i_ds_groups = Pref.bool("Show Party I Ds Groups", show.party_i_ds_groups, "Parse and add Party I Ds Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel = Pref.bool("Show Quote Cancel", show.quote_cancel, "Parse and add Quote Cancel to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack = Pref.bool("Show Quote Cancel Ack", show.quote_cancel_ack, "Parse and add Quote Cancel Ack to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_entry_group = Pref.bool("Show Quote Cancel Ack Entry Group", show.quote_cancel_ack_entry_group, "Parse and add Quote Cancel Ack Entry Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_entry_groups = Pref.bool("Show Quote Cancel Ack Entry Groups", show.quote_cancel_ack_entry_groups, "Parse and add Quote Cancel Ack Entry Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_set_group = Pref.bool("Show Quote Cancel Ack Set Group", show.quote_cancel_ack_set_group, "Parse and add Quote Cancel Ack Set Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_set_groups = Pref.bool("Show Quote Cancel Ack Set Groups", show.quote_cancel_ack_set_groups, "Parse and add Quote Cancel Ack Set Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_entry_group = Pref.bool("Show Quote Cancel Entry Group", show.quote_cancel_entry_group, "Parse and add Quote Cancel Entry Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_entry_groups = Pref.bool("Show Quote Cancel Entry Groups", show.quote_cancel_entry_groups, "Parse and add Quote Cancel Entry Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_set_group = Pref.bool("Show Quote Cancel Set Group", show.quote_cancel_set_group, "Parse and add Quote Cancel Set Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_set_groups = Pref.bool("Show Quote Cancel Set Groups", show.quote_cancel_set_groups, "Parse and add Quote Cancel Set Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_related_sym_group = Pref.bool("Show Related Sym Group", show.related_sym_group, "Parse and add Related Sym Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_related_sym_groups = Pref.bool("Show Related Sym Groups", show.related_sym_groups, "Parse and add Related Sym Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_request_for_quote = Pref.bool("Show Request For Quote", show.request_for_quote, "Parse and add Request For Quote to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_request_for_quote_ack = Pref.bool("Show Request For Quote Ack", show.request_for_quote_ack, "Parse and add Request For Quote Ack to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_requesting_party_i_ds_group = Pref.bool("Show Requesting Party I Ds Group", show.requesting_party_i_ds_group, "Parse and add Requesting Party I Ds Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_requesting_party_i_ds_groups = Pref.bool("Show Requesting Party I Ds Groups", show.requesting_party_i_ds_groups, "Parse and add Requesting Party I Ds Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_retransmission = Pref.bool("Show Retransmission", show.retransmission, "Parse and add Retransmission to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_retransmit_reject = Pref.bool("Show Retransmit Reject", show.retransmit_reject, "Parse and add Retransmit Reject to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_retransmit_request = Pref.bool("Show Retransmit Request", show.retransmit_request, "Parse and add Retransmit Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_risk_free_rate = Pref.bool("Show Risk Free Rate", show.risk_free_rate, "Parse and add Risk Free Rate to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request = Pref.bool("Show Security Definition Request", show.security_definition_request, "Parse and add Security Definition Request to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request_leg_group = Pref.bool("Show Security Definition Request Leg Group", show.security_definition_request_leg_group, "Parse and add Security Definition Request Leg Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request_leg_groups = Pref.bool("Show Security Definition Request Leg Groups", show.security_definition_request_leg_groups, "Parse and add Security Definition Request Leg Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response = Pref.bool("Show Security Definition Response", show.security_definition_response, "Parse and add Security Definition Response to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response_leg_group = Pref.bool("Show Security Definition Response Leg Group", show.security_definition_response_leg_group, "Parse and add Security Definition Response Leg Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response_leg_groups = Pref.bool("Show Security Definition Response Leg Groups", show.security_definition_response_leg_groups, "Parse and add Security Definition Response Leg Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_sequence = Pref.bool("Show Sequence", show.sequence, "Parse and add Sequence to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_sides_group = Pref.bool("Show Sides Group", show.sides_group, "Parse and add Sides Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_sides_groups = Pref.bool("Show Sides Groups", show.sides_groups, "Parse and add Sides Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_simple_open_frame = Pref.bool("Show Simple Open Frame", show.simple_open_frame, "Parse and add Simple Open Frame to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_simple_open_framing_header = Pref.bool("Show Simple Open Framing Header", show.simple_open_framing_header, "Parse and add Simple Open Framing Header to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_terminate = Pref.bool("Show Terminate", show.terminate, "Parse and add Terminate to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_time_to_expiration = Pref.bool("Show Time To Expiration", show.time_to_expiration, "Parse and add Time To Expiration to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_trd_reg_publications_group = Pref.bool("Show Trd Reg Publications Group", show.trd_reg_publications_group, "Parse and add Trd Reg Publications Group to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_trd_reg_publications_groups = Pref.bool("Show Trd Reg Publications Groups", show.trd_reg_publications_groups, "Parse and add Trd Reg Publications Groups to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_volatility = Pref.bool("Show Volatility", show.volatility, "Parse and add Volatility to protocol tree")
cme_futures_ilink3_sbe_v8_8.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function cme_futures_ilink3_sbe_v8_8.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.affected_orders_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_affected_orders_group then
    show.affected_orders_group = cme_futures_ilink3_sbe_v8_8.prefs.show_affected_orders_group
    changed = true
  end
  if show.affected_orders_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_affected_orders_groups then
    show.affected_orders_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_affected_orders_groups
    changed = true
  end
  if show.broken_dates_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_broken_dates_group then
    show.broken_dates_group = cme_futures_ilink3_sbe_v8_8.prefs.show_broken_dates_group
    changed = true
  end
  if show.broken_dates_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_broken_dates_groups then
    show.broken_dates_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_broken_dates_groups
    changed = true
  end
  if show.business_reject ~= cme_futures_ilink3_sbe_v8_8.prefs.show_business_reject then
    show.business_reject = cme_futures_ilink3_sbe_v8_8.prefs.show_business_reject
    changed = true
  end
  if show.calculated_ccy_last_qty ~= cme_futures_ilink3_sbe_v8_8.prefs.show_calculated_ccy_last_qty then
    show.calculated_ccy_last_qty = cme_futures_ilink3_sbe_v8_8.prefs.show_calculated_ccy_last_qty
    changed = true
  end
  if show.contra_calculated_ccy_last_qty ~= cme_futures_ilink3_sbe_v8_8.prefs.show_contra_calculated_ccy_last_qty then
    show.contra_calculated_ccy_last_qty = cme_futures_ilink3_sbe_v8_8.prefs.show_contra_calculated_ccy_last_qty
    changed = true
  end
  if show.contra_gross_trade_amt ~= cme_futures_ilink3_sbe_v8_8.prefs.show_contra_gross_trade_amt then
    show.contra_gross_trade_amt = cme_futures_ilink3_sbe_v8_8.prefs.show_contra_gross_trade_amt
    changed = true
  end
  if show.credentials ~= cme_futures_ilink3_sbe_v8_8.prefs.show_credentials then
    show.credentials = cme_futures_ilink3_sbe_v8_8.prefs.show_credentials
    changed = true
  end
  if show.establish ~= cme_futures_ilink3_sbe_v8_8.prefs.show_establish then
    show.establish = cme_futures_ilink3_sbe_v8_8.prefs.show_establish
    changed = true
  end
  if show.establishment_ack ~= cme_futures_ilink3_sbe_v8_8.prefs.show_establishment_ack then
    show.establishment_ack = cme_futures_ilink3_sbe_v8_8.prefs.show_establishment_ack
    changed = true
  end
  if show.establishment_reject ~= cme_futures_ilink3_sbe_v8_8.prefs.show_establishment_reject then
    show.establishment_reject = cme_futures_ilink3_sbe_v8_8.prefs.show_establishment_reject
    changed = true
  end
  if show.exec_inst ~= cme_futures_ilink3_sbe_v8_8.prefs.show_exec_inst then
    show.exec_inst = cme_futures_ilink3_sbe_v8_8.prefs.show_exec_inst
    changed = true
  end
  if show.execution_ack ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_ack then
    show.execution_ack = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_ack
    changed = true
  end
  if show.execution_report_cancel ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_cancel then
    show.execution_report_cancel = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_cancel
    changed = true
  end
  if show.execution_report_elimination ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_elimination then
    show.execution_report_elimination = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_elimination
    changed = true
  end
  if show.execution_report_modify ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_modify then
    show.execution_report_modify = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_modify
    changed = true
  end
  if show.execution_report_new ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_new then
    show.execution_report_new = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_new
    changed = true
  end
  if show.execution_report_pending_cancel ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_pending_cancel then
    show.execution_report_pending_cancel = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_pending_cancel
    changed = true
  end
  if show.execution_report_pending_replace ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_pending_replace then
    show.execution_report_pending_replace = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_pending_replace
    changed = true
  end
  if show.execution_report_reject ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_reject then
    show.execution_report_reject = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_reject
    changed = true
  end
  if show.execution_report_status ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_status then
    show.execution_report_status = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_status
    changed = true
  end
  if show.execution_report_trade_addendum_outright ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright then
    show.execution_report_trade_addendum_outright = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright
    changed = true
  end
  if show.execution_report_trade_addendum_outright_order_event_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright_order_event_group then
    show.execution_report_trade_addendum_outright_order_event_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright_order_event_group
    changed = true
  end
  if show.execution_report_trade_addendum_outright_order_event_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright_order_event_groups then
    show.execution_report_trade_addendum_outright_order_event_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_outright_order_event_groups
    changed = true
  end
  if show.execution_report_trade_addendum_spread ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread then
    show.execution_report_trade_addendum_spread = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread
    changed = true
  end
  if show.execution_report_trade_addendum_spread_leg ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg then
    show.execution_report_trade_addendum_spread_leg = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg
    changed = true
  end
  if show.execution_report_trade_addendum_spread_leg_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_group then
    show.execution_report_trade_addendum_spread_leg_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_group
    changed = true
  end
  if show.execution_report_trade_addendum_spread_leg_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_groups then
    show.execution_report_trade_addendum_spread_leg_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_groups
    changed = true
  end
  if show.execution_report_trade_addendum_spread_leg_order_event_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_order_event_group then
    show.execution_report_trade_addendum_spread_leg_order_event_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_order_event_group
    changed = true
  end
  if show.execution_report_trade_addendum_spread_leg_order_event_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_order_event_groups then
    show.execution_report_trade_addendum_spread_leg_order_event_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_leg_order_event_groups
    changed = true
  end
  if show.execution_report_trade_addendum_spread_order_event_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_order_event_group then
    show.execution_report_trade_addendum_spread_order_event_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_order_event_group
    changed = true
  end
  if show.execution_report_trade_addendum_spread_order_event_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_order_event_groups then
    show.execution_report_trade_addendum_spread_order_event_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_addendum_spread_order_event_groups
    changed = true
  end
  if show.execution_report_trade_outright ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright then
    show.execution_report_trade_outright = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright
    changed = true
  end
  if show.execution_report_trade_outright_order_event_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright_order_event_group then
    show.execution_report_trade_outright_order_event_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright_order_event_group
    changed = true
  end
  if show.execution_report_trade_outright_order_event_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright_order_event_groups then
    show.execution_report_trade_outright_order_event_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_outright_order_event_groups
    changed = true
  end
  if show.execution_report_trade_spread ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread then
    show.execution_report_trade_spread = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread
    changed = true
  end
  if show.execution_report_trade_spread_leg ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg then
    show.execution_report_trade_spread_leg = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg
    changed = true
  end
  if show.execution_report_trade_spread_leg_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_group then
    show.execution_report_trade_spread_leg_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_group
    changed = true
  end
  if show.execution_report_trade_spread_leg_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_groups then
    show.execution_report_trade_spread_leg_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_groups
    changed = true
  end
  if show.execution_report_trade_spread_leg_order_event_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_order_event_group then
    show.execution_report_trade_spread_leg_order_event_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_order_event_group
    changed = true
  end
  if show.execution_report_trade_spread_leg_order_event_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_order_event_groups then
    show.execution_report_trade_spread_leg_order_event_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_leg_order_event_groups
    changed = true
  end
  if show.execution_report_trade_spread_order_event_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_order_event_group then
    show.execution_report_trade_spread_order_event_group = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_order_event_group
    changed = true
  end
  if show.execution_report_trade_spread_order_event_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_order_event_groups then
    show.execution_report_trade_spread_order_event_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_execution_report_trade_spread_order_event_groups
    changed = true
  end
  if show.fills_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_fills_group then
    show.fills_group = cme_futures_ilink3_sbe_v8_8.prefs.show_fills_group
    changed = true
  end
  if show.fills_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_fills_groups then
    show.fills_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_fills_groups
    changed = true
  end
  if show.gross_trade_amt ~= cme_futures_ilink3_sbe_v8_8.prefs.show_gross_trade_amt then
    show.gross_trade_amt = cme_futures_ilink3_sbe_v8_8.prefs.show_gross_trade_amt
    changed = true
  end
  if show.group_size ~= cme_futures_ilink3_sbe_v8_8.prefs.show_group_size then
    show.group_size = cme_futures_ilink3_sbe_v8_8.prefs.show_group_size
    changed = true
  end
  if show.leg_option_delta ~= cme_futures_ilink3_sbe_v8_8.prefs.show_leg_option_delta then
    show.leg_option_delta = cme_futures_ilink3_sbe_v8_8.prefs.show_leg_option_delta
    changed = true
  end
  if show.mass_quote ~= cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote then
    show.mass_quote = cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote
    changed = true
  end
  if show.mass_quote_ack ~= cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack then
    show.mass_quote_ack = cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack
    changed = true
  end
  if show.mass_quote_ack_entry_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack_entry_group then
    show.mass_quote_ack_entry_group = cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack_entry_group
    changed = true
  end
  if show.mass_quote_ack_entry_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack_entry_groups then
    show.mass_quote_ack_entry_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_ack_entry_groups
    changed = true
  end
  if show.mass_quote_entry_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_entry_group then
    show.mass_quote_entry_group = cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_entry_group
    changed = true
  end
  if show.mass_quote_entry_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_entry_groups then
    show.mass_quote_entry_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_mass_quote_entry_groups
    changed = true
  end
  if show.maturity_month_year ~= cme_futures_ilink3_sbe_v8_8.prefs.show_maturity_month_year then
    show.maturity_month_year = cme_futures_ilink3_sbe_v8_8.prefs.show_maturity_month_year
    changed = true
  end
  if show.message_header ~= cme_futures_ilink3_sbe_v8_8.prefs.show_message_header then
    show.message_header = cme_futures_ilink3_sbe_v8_8.prefs.show_message_header
    changed = true
  end
  if show.negotiate ~= cme_futures_ilink3_sbe_v8_8.prefs.show_negotiate then
    show.negotiate = cme_futures_ilink3_sbe_v8_8.prefs.show_negotiate
    changed = true
  end
  if show.negotiation_reject ~= cme_futures_ilink3_sbe_v8_8.prefs.show_negotiation_reject then
    show.negotiation_reject = cme_futures_ilink3_sbe_v8_8.prefs.show_negotiation_reject
    changed = true
  end
  if show.negotiation_response ~= cme_futures_ilink3_sbe_v8_8.prefs.show_negotiation_response then
    show.negotiation_response = cme_futures_ilink3_sbe_v8_8.prefs.show_negotiation_response
    changed = true
  end
  if show.new_order_cross ~= cme_futures_ilink3_sbe_v8_8.prefs.show_new_order_cross then
    show.new_order_cross = cme_futures_ilink3_sbe_v8_8.prefs.show_new_order_cross
    changed = true
  end
  if show.new_order_single ~= cme_futures_ilink3_sbe_v8_8.prefs.show_new_order_single then
    show.new_order_single = cme_futures_ilink3_sbe_v8_8.prefs.show_new_order_single
    changed = true
  end
  if show.not_applied ~= cme_futures_ilink3_sbe_v8_8.prefs.show_not_applied then
    show.not_applied = cme_futures_ilink3_sbe_v8_8.prefs.show_not_applied
    changed = true
  end
  if show.option_delta ~= cme_futures_ilink3_sbe_v8_8.prefs.show_option_delta then
    show.option_delta = cme_futures_ilink3_sbe_v8_8.prefs.show_option_delta
    changed = true
  end
  if show.order_cancel_reject ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_reject then
    show.order_cancel_reject = cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_reject
    changed = true
  end
  if show.order_cancel_replace_reject ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_replace_reject then
    show.order_cancel_replace_reject = cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_replace_reject
    changed = true
  end
  if show.order_cancel_replace_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_replace_request then
    show.order_cancel_replace_request = cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_replace_request
    changed = true
  end
  if show.order_cancel_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_request then
    show.order_cancel_request = cme_futures_ilink3_sbe_v8_8.prefs.show_order_cancel_request
    changed = true
  end
  if show.order_mass_action_report ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_action_report then
    show.order_mass_action_report = cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_action_report
    changed = true
  end
  if show.order_mass_action_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_action_request then
    show.order_mass_action_request = cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_action_request
    changed = true
  end
  if show.order_mass_status_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_status_request then
    show.order_mass_status_request = cme_futures_ilink3_sbe_v8_8.prefs.show_order_mass_status_request
    changed = true
  end
  if show.order_status_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_order_status_request then
    show.order_status_request = cme_futures_ilink3_sbe_v8_8.prefs.show_order_status_request
    changed = true
  end
  if show.packet ~= cme_futures_ilink3_sbe_v8_8.prefs.show_packet then
    show.packet = cme_futures_ilink3_sbe_v8_8.prefs.show_packet
    changed = true
  end
  if show.party_details_definition_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_definition_request then
    show.party_details_definition_request = cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_definition_request
    changed = true
  end
  if show.party_details_definition_request_ack ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_definition_request_ack then
    show.party_details_definition_request_ack = cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_definition_request_ack
    changed = true
  end
  if show.party_details_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_group then
    show.party_details_group = cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_group
    changed = true
  end
  if show.party_details_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_groups then
    show.party_details_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_groups
    changed = true
  end
  if show.party_details_list_report ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_list_report then
    show.party_details_list_report = cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_list_report
    changed = true
  end
  if show.party_details_list_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_list_request then
    show.party_details_list_request = cme_futures_ilink3_sbe_v8_8.prefs.show_party_details_list_request
    changed = true
  end
  if show.party_i_ds_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_i_ds_group then
    show.party_i_ds_group = cme_futures_ilink3_sbe_v8_8.prefs.show_party_i_ds_group
    changed = true
  end
  if show.party_i_ds_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_party_i_ds_groups then
    show.party_i_ds_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_party_i_ds_groups
    changed = true
  end
  if show.quote_cancel ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel then
    show.quote_cancel = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel
    changed = true
  end
  if show.quote_cancel_ack ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack then
    show.quote_cancel_ack = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack
    changed = true
  end
  if show.quote_cancel_ack_entry_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_entry_group then
    show.quote_cancel_ack_entry_group = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_entry_group
    changed = true
  end
  if show.quote_cancel_ack_entry_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_entry_groups then
    show.quote_cancel_ack_entry_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_entry_groups
    changed = true
  end
  if show.quote_cancel_ack_set_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_set_group then
    show.quote_cancel_ack_set_group = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_set_group
    changed = true
  end
  if show.quote_cancel_ack_set_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_set_groups then
    show.quote_cancel_ack_set_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_ack_set_groups
    changed = true
  end
  if show.quote_cancel_entry_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_entry_group then
    show.quote_cancel_entry_group = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_entry_group
    changed = true
  end
  if show.quote_cancel_entry_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_entry_groups then
    show.quote_cancel_entry_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_entry_groups
    changed = true
  end
  if show.quote_cancel_set_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_set_group then
    show.quote_cancel_set_group = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_set_group
    changed = true
  end
  if show.quote_cancel_set_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_set_groups then
    show.quote_cancel_set_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_quote_cancel_set_groups
    changed = true
  end
  if show.related_sym_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_related_sym_group then
    show.related_sym_group = cme_futures_ilink3_sbe_v8_8.prefs.show_related_sym_group
    changed = true
  end
  if show.related_sym_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_related_sym_groups then
    show.related_sym_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_related_sym_groups
    changed = true
  end
  if show.request_for_quote ~= cme_futures_ilink3_sbe_v8_8.prefs.show_request_for_quote then
    show.request_for_quote = cme_futures_ilink3_sbe_v8_8.prefs.show_request_for_quote
    changed = true
  end
  if show.request_for_quote_ack ~= cme_futures_ilink3_sbe_v8_8.prefs.show_request_for_quote_ack then
    show.request_for_quote_ack = cme_futures_ilink3_sbe_v8_8.prefs.show_request_for_quote_ack
    changed = true
  end
  if show.requesting_party_i_ds_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_requesting_party_i_ds_group then
    show.requesting_party_i_ds_group = cme_futures_ilink3_sbe_v8_8.prefs.show_requesting_party_i_ds_group
    changed = true
  end
  if show.requesting_party_i_ds_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_requesting_party_i_ds_groups then
    show.requesting_party_i_ds_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_requesting_party_i_ds_groups
    changed = true
  end
  if show.retransmission ~= cme_futures_ilink3_sbe_v8_8.prefs.show_retransmission then
    show.retransmission = cme_futures_ilink3_sbe_v8_8.prefs.show_retransmission
    changed = true
  end
  if show.retransmit_reject ~= cme_futures_ilink3_sbe_v8_8.prefs.show_retransmit_reject then
    show.retransmit_reject = cme_futures_ilink3_sbe_v8_8.prefs.show_retransmit_reject
    changed = true
  end
  if show.retransmit_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_retransmit_request then
    show.retransmit_request = cme_futures_ilink3_sbe_v8_8.prefs.show_retransmit_request
    changed = true
  end
  if show.risk_free_rate ~= cme_futures_ilink3_sbe_v8_8.prefs.show_risk_free_rate then
    show.risk_free_rate = cme_futures_ilink3_sbe_v8_8.prefs.show_risk_free_rate
    changed = true
  end
  if show.security_definition_request ~= cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request then
    show.security_definition_request = cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request
    changed = true
  end
  if show.security_definition_request_leg_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request_leg_group then
    show.security_definition_request_leg_group = cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request_leg_group
    changed = true
  end
  if show.security_definition_request_leg_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request_leg_groups then
    show.security_definition_request_leg_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_request_leg_groups
    changed = true
  end
  if show.security_definition_response ~= cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response then
    show.security_definition_response = cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response
    changed = true
  end
  if show.security_definition_response_leg_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response_leg_group then
    show.security_definition_response_leg_group = cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response_leg_group
    changed = true
  end
  if show.security_definition_response_leg_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response_leg_groups then
    show.security_definition_response_leg_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_security_definition_response_leg_groups
    changed = true
  end
  if show.sequence ~= cme_futures_ilink3_sbe_v8_8.prefs.show_sequence then
    show.sequence = cme_futures_ilink3_sbe_v8_8.prefs.show_sequence
    changed = true
  end
  if show.sides_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_sides_group then
    show.sides_group = cme_futures_ilink3_sbe_v8_8.prefs.show_sides_group
    changed = true
  end
  if show.sides_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_sides_groups then
    show.sides_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_sides_groups
    changed = true
  end
  if show.simple_open_frame ~= cme_futures_ilink3_sbe_v8_8.prefs.show_simple_open_frame then
    show.simple_open_frame = cme_futures_ilink3_sbe_v8_8.prefs.show_simple_open_frame
    changed = true
  end
  if show.simple_open_framing_header ~= cme_futures_ilink3_sbe_v8_8.prefs.show_simple_open_framing_header then
    show.simple_open_framing_header = cme_futures_ilink3_sbe_v8_8.prefs.show_simple_open_framing_header
    changed = true
  end
  if show.terminate ~= cme_futures_ilink3_sbe_v8_8.prefs.show_terminate then
    show.terminate = cme_futures_ilink3_sbe_v8_8.prefs.show_terminate
    changed = true
  end
  if show.time_to_expiration ~= cme_futures_ilink3_sbe_v8_8.prefs.show_time_to_expiration then
    show.time_to_expiration = cme_futures_ilink3_sbe_v8_8.prefs.show_time_to_expiration
    changed = true
  end
  if show.trd_reg_publications_group ~= cme_futures_ilink3_sbe_v8_8.prefs.show_trd_reg_publications_group then
    show.trd_reg_publications_group = cme_futures_ilink3_sbe_v8_8.prefs.show_trd_reg_publications_group
    changed = true
  end
  if show.trd_reg_publications_groups ~= cme_futures_ilink3_sbe_v8_8.prefs.show_trd_reg_publications_groups then
    show.trd_reg_publications_groups = cme_futures_ilink3_sbe_v8_8.prefs.show_trd_reg_publications_groups
    changed = true
  end
  if show.volatility ~= cme_futures_ilink3_sbe_v8_8.prefs.show_volatility then
    show.volatility = cme_futures_ilink3_sbe_v8_8.prefs.show_volatility
    changed = true
  end
  if show.payload ~= cme_futures_ilink3_sbe_v8_8.prefs.show_payload then
    show.payload = cme_futures_ilink3_sbe_v8_8.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Cme Futures iLink3 Sbe 8.8
-----------------------------------------------------------------------
...
translate.reservation_price = function(raw)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
    return 0/0
  end
...
cme_futures_ilink3_sbe_v8_8_size_of.broken_dates_groups = function(buffer, offset)
  ...
  index = index + broken_dates_group_count * 4
...
cme_futures_ilink3_sbe_v8_8_dissect.exec_inst_bits = function(buffer, offset, packet, parent)
  ...
  -- Reserved 4: 1 Bit
  parent:add(cme_futures_ilink3_sbe_v8_8.fields.reserved_4, buffer(offset, 1))

  -- Reserved 3: 1 Bit
  parent:add(cme_futures_ilink3_sbe_v8_8.fields.reserved_3, buffer(offset, 1))
  ...
  -- Nh: 1 Bit
  parent:add(cme_futures_ilink3_sbe_v8_8.fields.nh, buffer(offset, 1))

  -- Ob: 1 Bit
  parent:add(cme_futures_ilink3_sbe_v8_8.fields.ob, buffer(offset, 1))

  -- Aon: 1 Bit
  parent:add(cme_futures_ilink3_sbe_v8_8.fields.aon, buffer(offset, 1))
end
...
translate.display_limit_price = function(raw)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
    return 0/0
  end
...
function cme_futures_ilink3_sbe_v8_8.init()
end

-- Dissector for Cme Futures iLink3 Sbe 8.8
function cme_futures_ilink3_sbe_v8_8.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = cme_futures_ilink3_sbe_v8_8.name
...
tcp_table:add(65333, cme_futures_ilink3_sbe_v8_8)
...
verify.cme_futures_ilink3_sbe_v8_8_packet_size = function(buffer)
...
-- Dissector Heuristic for Cme Futures iLink3 Sbe 8.8
local function cme_futures_ilink3_sbe_v8_8_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.cme_futures_ilink3_sbe_v8_8_packet_size(buffer) then return false end
  ...
  packet.conversation = cme_futures_ilink3_sbe_v8_8
  cme_futures_ilink3_sbe_v8_8.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Cme Futures iLink3 Sbe 8.8
cme_futures_ilink3_sbe_v8_8:register_heuristic("tcp", cme_futures_ilink3_sbe_v8_8_heuristic)
