...
omi_cme_futures_settlements_sbe_v7_0.fields.actual = ProtoField.new("Actual", "cme.futures.settlements.sbe.v7.0.actual", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_cme_futures_settlements_sbe_v7_0.fields.cabinet = ProtoField.new("Cabinet", "cme.futures.settlements.sbe.v7.0.cabinet", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_cme_futures_settlements_sbe_v7_0.fields.final_daily = ProtoField.new("Final Daily", "cme.futures.settlements.sbe.v7.0.finaldaily", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_cme_futures_settlements_sbe_v7_0.fields.intraday = ProtoField.new("Intraday", "cme.futures.settlements.sbe.v7.0.intraday", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_cme_futures_settlements_sbe_v7_0.fields.null_value = ProtoField.new("Null Value", "cme.futures.settlements.sbe.v7.0.nullvalue", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_cme_futures_settlements_sbe_v7_0.fields.rounded = ProtoField.new("Rounded", "cme.futures.settlements.sbe.v7.0.rounded", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_cme_futures_settlements_sbe_v7_0.fields.unused_settl_price_type_6 = ProtoField.new("Unused Settl Price Type 6", "cme.futures.settlements.sbe.v7.0.unusedsettlpricetype6", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
-- Cme Futures Sbe Settlements 7.0 Application Messages
...
cme_futures_settlements_sbe_v7_0.high_px.size =
  cme_futures_settlements_sbe_v7_0.mantissa.size + 
  cme_futures_settlements_sbe_v7_0.exponent.size
...
cme_futures_settlements_sbe_v7_0.high_px.dissect = function(buffer, offset, packet, parent)
  if show.high_px then
    ...
    local index, value = cme_futures_settlements_sbe_v7_0.high_px.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_settlements_sbe_v7_0.high_px.display(packet, parent, value, length)
...
cme_futures_settlements_sbe_v7_0.low_px.dissect = function(buffer, offset, packet, parent)
  if show.low_px then
    ...
    local index, value = cme_futures_settlements_sbe_v7_0.low_px.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_settlements_sbe_v7_0.low_px.display(packet, parent, value, length)
    parent:append_text(display)
...
cme_futures_settlements_sbe_v7_0.strike_price.dissect = function(buffer, offset, packet, parent)
  if show.strike_price then
    ...
    local index, value = cme_futures_settlements_sbe_v7_0.strike_price.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_settlements_sbe_v7_0.strike_price.display(packet, parent, value, length)
    parent:append_text(display)
...
cme_futures_settlements_sbe_v7_0.formatted_last_px.dissect = function(buffer, offset, packet, parent)
  if show.formatted_last_px then
    ...
    local index, value = cme_futures_settlements_sbe_v7_0.formatted_last_px.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_settlements_sbe_v7_0.formatted_last_px.display(packet, parent, value, length)
    parent:append_text(display)
...
cme_futures_settlements_sbe_v7_0.message.fields = function(buffer, offset, packet, parent, size_of_message)
  local index = offset
...
-- Dissect: Message
cme_futures_settlements_sbe_v7_0.message.dissect = function(buffer, offset, packet, parent, size_of_message)
  local index = offset + size_of_message

  -- Optionally add group/struct element to protocol tree
  if show.message then
    parent = parent:add(omi_cme_futures_settlements_sbe_v7_0.fields.message, buffer(offset, 0))
    local current = cme_futures_settlements_sbe_v7_0.message.fields(buffer, offset, packet, parent, size_of_message)
    ...
    -- Skip element, add fields directly
    cme_futures_settlements_sbe_v7_0.message.fields(buffer, offset, packet, parent, size_of_message)
...
cme_futures_settlements_sbe_v7_0.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = cme_futures_settlements_sbe_v7_0.message.dissect(buffer, index, packet, parent, message_size)
  end
