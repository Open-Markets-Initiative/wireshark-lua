...
-- Cme Sbe Mdp3 8.1 Protocol
local cme_sbe_mdp3_8_1 = Proto("Cme.Sbe.Mdp3.8.1.Lua", "Cme Sbe Mdp3 8.1")
...
-- Cme Sbe Mdp3 8.1 Format Options
...
-- Cme Sbe Mdp3 8.1 Element Dissection Options
...
-- Cme Sbe Mdp3 8.1 Fields
cme_sbe_mdp3_8_1.fields.actual = ProtoField.new("Actual", "cme.sbe.mdp3.actual", ftypes.UINT8, nil, base.DEC, "0x02")
cme_sbe_mdp3_8_1.fields.admin_login = ProtoField.new("Admin Login", "cme.sbe.mdp3.adminlogin", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.admin_logout = ProtoField.new("Admin Logout", "cme.sbe.mdp3.adminlogout", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.aggressor_side = ProtoField.new("Aggressor Side", "cme.sbe.mdp3.aggressorside", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.appl_id = ProtoField.new("Appl ID", "cme.sbe.mdp3.applid", ftypes.INT16)
cme_sbe_mdp3_8_1.fields.asset = ProtoField.new("Asset", "cme.sbe.mdp3.asset", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.block_length = ProtoField.new("block Length", "cme.sbe.mdp3.blocklength", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.block_length = ProtoField.new("Block Length", "cme.sbe.mdp3.blocklength", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.block_trade_eligible = ProtoField.new("Block Trade Eligible", "cme.sbe.mdp3.blocktradeeligible", ftypes.UINT32, nil, base.DEC, "0x00000004")
cme_sbe_mdp3_8_1.fields.cfi_code = ProtoField.new("CFI Code", "cme.sbe.mdp3.cficode", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.channel_reset = ProtoField.new("Channel Reset", "cme.sbe.mdp3.channelreset", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.channel_reset_group = ProtoField.new("Channel Reset Group", "cme.sbe.mdp3.channelresetgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.channel_reset_groups = ProtoField.new("Channel Reset Groups", "cme.sbe.mdp3.channelresetgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.cleared_volume = ProtoField.new("Cleared Volume", "cme.sbe.mdp3.clearedvolume", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.contract_multiplier = ProtoField.new("Contract Multiplier", "cme.sbe.mdp3.contractmultiplier", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.contract_multiplier_unit = ProtoField.new("Contract Multiplier Unit", "cme.sbe.mdp3.contractmultiplierunit", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.currency = ProtoField.new("Currency", "cme.sbe.mdp3.currency", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.current_chunk = ProtoField.new("Current Chunk", "cme.sbe.mdp3.currentchunk", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.daily_product_eligibility = ProtoField.new("Daily Product Eligibility", "cme.sbe.mdp3.dailyproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00020000")
cme_sbe_mdp3_8_1.fields.day = ProtoField.new("day", "cme.sbe.mdp3.day", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.decay_quantity = ProtoField.new("Decay Quantity", "cme.sbe.mdp3.decayquantity", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.decay_start_date = ProtoField.new("Decay Start Date", "cme.sbe.mdp3.decaystartdate", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.decaying_product_eligibility = ProtoField.new("Decaying Product Eligibility", "cme.sbe.mdp3.decayingproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00008000")
cme_sbe_mdp3_8_1.fields.display_factor = ProtoField.new("Display Factor", "cme.sbe.mdp3.displayfactor", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.ebf_eligible = ProtoField.new("EBF Eligible", "cme.sbe.mdp3.ebfeligible", ftypes.UINT32, nil, base.DEC, "0x00000010")
cme_sbe_mdp3_8_1.fields.efp_eligible = ProtoField.new("EFP Eligible", "cme.sbe.mdp3.efpeligible", ftypes.UINT32, nil, base.DEC, "0x00000008")
cme_sbe_mdp3_8_1.fields.efr_eligible = ProtoField.new("EFR Eligible", "cme.sbe.mdp3.efreligible", ftypes.UINT32, nil, base.DEC, "0x00000040")
cme_sbe_mdp3_8_1.fields.efs_eligible = ProtoField.new("EFS Eligible", "cme.sbe.mdp3.efseligible", ftypes.UINT32, nil, base.DEC, "0x00000020")
cme_sbe_mdp3_8_1.fields.electronic_match_eligible = ProtoField.new("Electronic Match Eligible", "cme.sbe.mdp3.electronicmatcheligible", ftypes.UINT32, nil, base.DEC, "0x00000001")
cme_sbe_mdp3_8_1.fields.end_of_event = ProtoField.new("End Of Event", "cme.sbe.mdp3.endofevent", ftypes.UINT8, nil, base.DEC, "0x80")
cme_sbe_mdp3_8_1.fields.event_time = ProtoField.new("Event Time", "cme.sbe.mdp3.eventtime", ftypes.UINT64)
cme_sbe_mdp3_8_1.fields.event_type = ProtoField.new("Event Type", "cme.sbe.mdp3.eventtype", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.events_group = ProtoField.new("Events Group", "cme.sbe.mdp3.eventsgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.events_groups = ProtoField.new("Events Groups", "cme.sbe.mdp3.eventsgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.final = ProtoField.new("Final", "cme.sbe.mdp3.final", ftypes.UINT8, nil, base.DEC, "0x01")
cme_sbe_mdp3_8_1.fields.flow_schedule_type = ProtoField.new("Flow Schedule Type", "cme.sbe.mdp3.flowscheduletype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.group_size = ProtoField.new("group Size", "cme.sbe.mdp3.groupsize", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.group_size8_byte = ProtoField.new("group Size8 Byte", "cme.sbe.mdp3.groupsize8byte", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.gt_orders_eligibility = ProtoField.new("GT Orders Eligibility", "cme.sbe.mdp3.gtorderseligibility", ftypes.UINT32, nil, base.DEC, "0x00040000")
cme_sbe_mdp3_8_1.fields.halt_reason = ProtoField.new("Halt Reason", "cme.sbe.mdp3.haltreason", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "cme.sbe.mdp3.heartbtint", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.high_limit_price = ProtoField.new("High Limit Price", "cme.sbe.mdp3.highlimitprice", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.i_link_indicative_mass_quoting_eligible = ProtoField.new("i Link Indicative Mass Quoting Eligible", "cme.sbe.mdp3.ilinkindicativemassquotingeligible", ftypes.UINT32, nil, base.DEC, "0x00000100")
cme_sbe_mdp3_8_1.fields.implied_matching_eligibility = ProtoField.new("Implied Matching Eligibility", "cme.sbe.mdp3.impliedmatchingeligibility", ftypes.UINT32, nil, base.DEC, "0x00080000")
cme_sbe_mdp3_8_1.fields.inst_attrib_group = ProtoField.new("Inst Attrib Group", "cme.sbe.mdp3.instattribgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.inst_attrib_groups = ProtoField.new("Inst Attrib Groups", "cme.sbe.mdp3.instattribgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.inst_attrib_value = ProtoField.new("Inst Attrib Value", "cme.sbe.mdp3.instattribvalue", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.intraday = ProtoField.new("Intraday", "cme.sbe.mdp3.intraday", ftypes.UINT8, nil, base.DEC, "0x08")
cme_sbe_mdp3_8_1.fields.is_fractional = ProtoField.new("Is Fractional", "cme.sbe.mdp3.isfractional", ftypes.UINT32, nil, base.DEC, "0x00000800")
cme_sbe_mdp3_8_1.fields.last_implied_msg = ProtoField.new("Last Implied Msg", "cme.sbe.mdp3.lastimpliedmsg", ftypes.UINT8, nil, base.DEC, "0x10")
cme_sbe_mdp3_8_1.fields.last_msg_seq_num_processed = ProtoField.new("Last Msg Seq Num Processed", "cme.sbe.mdp3.lastmsgseqnumprocessed", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.last_qty = ProtoField.new("Last Qty", "cme.sbe.mdp3.lastqty", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.last_quote_msg = ProtoField.new("Last Quote Msg", "cme.sbe.mdp3.lastquotemsg", ftypes.UINT8, nil, base.DEC, "0x04")
cme_sbe_mdp3_8_1.fields.last_stats_msg = ProtoField.new("Last Stats Msg", "cme.sbe.mdp3.laststatsmsg", ftypes.UINT8, nil, base.DEC, "0x08")
cme_sbe_mdp3_8_1.fields.last_trade_msg = ProtoField.new("Last Trade Msg", "cme.sbe.mdp3.lasttrademsg", ftypes.UINT8, nil, base.DEC, "0x01")
cme_sbe_mdp3_8_1.fields.last_update_time = ProtoField.new("Last Update Time", "cme.sbe.mdp3.lastupdatetime", ftypes.UINT64)
cme_sbe_mdp3_8_1.fields.last_volume_msg = ProtoField.new("Last Volume Msg", "cme.sbe.mdp3.lastvolumemsg", ftypes.UINT8, nil, base.DEC, "0x02")
cme_sbe_mdp3_8_1.fields.leg_option_delta = ProtoField.new("Leg Option Delta", "cme.sbe.mdp3.legoptiondelta", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.leg_price = ProtoField.new("Leg Price", "cme.sbe.mdp3.legprice", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "cme.sbe.mdp3.legratioqty", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.leg_security_id = ProtoField.new("Leg Security ID", "cme.sbe.mdp3.legsecurityid", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.leg_side = ProtoField.new("Leg Side", "cme.sbe.mdp3.legside", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.legs_group = ProtoField.new("Legs Group", "cme.sbe.mdp3.legsgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.legs_groups = ProtoField.new("Legs Groups", "cme.sbe.mdp3.legsgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.lot_type = ProtoField.new("Lot Type", "cme.sbe.mdp3.lottype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.lot_type_rules_group = ProtoField.new("Lot Type Rules Group", "cme.sbe.mdp3.lottyperulesgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.lot_type_rules_groups = ProtoField.new("Lot Type Rules Groups", "cme.sbe.mdp3.lottyperulesgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.low_limit_price = ProtoField.new("Low Limit Price", "cme.sbe.mdp3.lowlimitprice", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.main_fraction = ProtoField.new("Main Fraction", "cme.sbe.mdp3.mainfraction", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.market_depth = ProtoField.new("Market Depth", "cme.sbe.mdp3.marketdepth", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.market_segment_id = ProtoField.new("Market Segment ID", "cme.sbe.mdp3.marketsegmentid", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.match_algorithm = ProtoField.new("Match Algorithm", "cme.sbe.mdp3.matchalgorithm", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.match_event_indicator = ProtoField.new("Match Event Indicator", "cme.sbe.mdp3.matcheventindicator", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.maturity_month_year = ProtoField.new("Maturity Month Year", "cme.sbe.mdp3.maturitymonthyear", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.max_price_variation = ProtoField.new("Max Price Variation", "cme.sbe.mdp3.maxpricevariation", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.max_trade_vol = ProtoField.new("Max Trade Vol", "cme.sbe.mdp3.maxtradevol", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.md_display_qty = ProtoField.new("MD Display Qty", "cme.sbe.mdp3.mddisplayqty", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.md_entry_px = ProtoField.new("MD Entry Px", "cme.sbe.mdp3.mdentrypx", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.md_entry_size = ProtoField.new("MD Entry Size", "cme.sbe.mdp3.mdentrysize", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.md_entry_type = ProtoField.new("MD Entry Type", "cme.sbe.mdp3.mdentrytype", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_feed_type = ProtoField.new("MD Feed Type", "cme.sbe.mdp3.mdfeedtype", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_feed_types_group = ProtoField.new("MD Feed Types Group", "cme.sbe.mdp3.mdfeedtypesgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_feed_types_groups = ProtoField.new("MD Feed Types Groups", "cme.sbe.mdp3.mdfeedtypesgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book = ProtoField.new("MD Incremental Refresh Book", "cme.sbe.mdp3.mdincrementalrefreshbook", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_group = ProtoField.new("MD Incremental Refresh Book Group", "cme.sbe.mdp3.mdincrementalrefreshbookgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_groups = ProtoField.new("MD Incremental Refresh Book Groups", "cme.sbe.mdp3.mdincrementalrefreshbookgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_order_group = ProtoField.new("MD Incremental Refresh Book Order Group", "cme.sbe.mdp3.mdincrementalrefreshbookordergroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_order_groups = ProtoField.new("MD Incremental Refresh Book Order Groups", "cme.sbe.mdp3.mdincrementalrefreshbookordergroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_daily_statistics = ProtoField.new("MD Incremental Refresh Daily Statistics", "cme.sbe.mdp3.mdincrementalrefreshdailystatistics", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_daily_statistics_group = ProtoField.new("MD Incremental Refresh Daily Statistics Group", "cme.sbe.mdp3.mdincrementalrefreshdailystatisticsgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_daily_statistics_groups = ProtoField.new("MD Incremental Refresh Daily Statistics Groups", "cme.sbe.mdp3.mdincrementalrefreshdailystatisticsgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_limits_banding = ProtoField.new("MD Incremental Refresh Limits Banding", "cme.sbe.mdp3.mdincrementalrefreshlimitsbanding", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_limits_banding_group = ProtoField.new("MD Incremental Refresh Limits Banding Group", "cme.sbe.mdp3.mdincrementalrefreshlimitsbandinggroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_limits_banding_groups = ProtoField.new("MD Incremental Refresh Limits Banding Groups", "cme.sbe.mdp3.mdincrementalrefreshlimitsbandinggroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_order_book = ProtoField.new("MD Incremental Refresh Order Book", "cme.sbe.mdp3.mdincrementalrefreshorderbook", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_order_book_group = ProtoField.new("MD Incremental Refresh Order Book Group", "cme.sbe.mdp3.mdincrementalrefreshorderbookgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_order_book_groups = ProtoField.new("MD Incremental Refresh Order Book Groups", "cme.sbe.mdp3.mdincrementalrefreshorderbookgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_session_statistics = ProtoField.new("MD Incremental Refresh Session Statistics", "cme.sbe.mdp3.mdincrementalrefreshsessionstatistics", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_session_statistics_group = ProtoField.new("MD Incremental Refresh Session Statistics Group", "cme.sbe.mdp3.mdincrementalrefreshsessionstatisticsgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_session_statistics_groups = ProtoField.new("MD Incremental Refresh Session Statistics Groups", "cme.sbe.mdp3.mdincrementalrefreshsessionstatisticsgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade = ProtoField.new("MD Incremental Refresh Trade", "cme.sbe.mdp3.mdincrementalrefreshtrade", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_group = ProtoField.new("MD Incremental Refresh Trade Group", "cme.sbe.mdp3.mdincrementalrefreshtradegroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_groups = ProtoField.new("MD Incremental Refresh Trade Groups", "cme.sbe.mdp3.mdincrementalrefreshtradegroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary = ProtoField.new("MD Incremental Refresh Trade Summary", "cme.sbe.mdp3.mdincrementalrefreshtradesummary", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_group = ProtoField.new("MD Incremental Refresh Trade Summary Group", "cme.sbe.mdp3.mdincrementalrefreshtradesummarygroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_groups = ProtoField.new("MD Incremental Refresh Trade Summary Groups", "cme.sbe.mdp3.mdincrementalrefreshtradesummarygroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_order_group = ProtoField.new("MD Incremental Refresh Trade Summary Order Group", "cme.sbe.mdp3.mdincrementalrefreshtradesummaryordergroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_order_groups = ProtoField.new("MD Incremental Refresh Trade Summary Order Groups", "cme.sbe.mdp3.mdincrementalrefreshtradesummaryordergroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_volume = ProtoField.new("MD Incremental Refresh Volume", "cme.sbe.mdp3.mdincrementalrefreshvolume", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_volume_group = ProtoField.new("MD Incremental Refresh Volume Group", "cme.sbe.mdp3.mdincrementalrefreshvolumegroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_incremental_refresh_volume_groups = ProtoField.new("MD Incremental Refresh Volume Groups", "cme.sbe.mdp3.mdincrementalrefreshvolumegroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_instrument_definition_future = ProtoField.new("MD Instrument Definition Future", "cme.sbe.mdp3.mdinstrumentdefinitionfuture", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_instrument_definition_option = ProtoField.new("MD Instrument Definition Option", "cme.sbe.mdp3.mdinstrumentdefinitionoption", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_instrument_definition_spread = ProtoField.new("MD Instrument Definition Spread", "cme.sbe.mdp3.mdinstrumentdefinitionspread", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.md_order_priority = ProtoField.new("MD Order Priority", "cme.sbe.mdp3.mdorderpriority", ftypes.UINT64)
cme_sbe_mdp3_8_1.fields.md_price_level = ProtoField.new("MD Price Level", "cme.sbe.mdp3.mdpricelevel", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.md_security_trading_status = ProtoField.new("MD Security Trading Status", "cme.sbe.mdp3.mdsecuritytradingstatus", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.md_trade_entry_id = ProtoField.new("MD Trade Entry ID", "cme.sbe.mdp3.mdtradeentryid", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.md_update_action = ProtoField.new("MD Update Action", "cme.sbe.mdp3.mdupdateaction", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.message = ProtoField.new("Message", "cme.sbe.mdp3.message", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.message_header = ProtoField.new("Message Header", "cme.sbe.mdp3.messageheader", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "cme.sbe.mdp3.messagesequencenumber", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.message_size = ProtoField.new("Message Size", "cme.sbe.mdp3.messagesize", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.min_cab_price = ProtoField.new("Min Cab Price", "cme.sbe.mdp3.mincabprice", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.min_lot_size = ProtoField.new("Min Lot Size", "cme.sbe.mdp3.minlotsize", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.min_price_increment = ProtoField.new("Min Price Increment", "cme.sbe.mdp3.minpriceincrement", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.min_price_increment_amount = ProtoField.new("Min Price Increment Amount", "cme.sbe.mdp3.minpriceincrementamount", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.min_trade_vol = ProtoField.new("Min Trade Vol", "cme.sbe.mdp3.mintradevol", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.month = ProtoField.new("month", "cme.sbe.mdp3.month", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.negative_price_outright_eligible = ProtoField.new("Negative Price Outright Eligible", "cme.sbe.mdp3.negativepriceoutrighteligible", ftypes.UINT32, nil, base.DEC, "0x00000400")
cme_sbe_mdp3_8_1.fields.negative_strike_eligible = ProtoField.new("Negative Strike Eligible", "cme.sbe.mdp3.negativestrikeeligible", ftypes.UINT32, nil, base.DEC, "0x00000200")
cme_sbe_mdp3_8_1.fields.no_chunks = ProtoField.new("No Chunks", "cme.sbe.mdp3.nochunks", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.null_value = ProtoField.new("Null Value", "cme.sbe.mdp3.nullvalue", ftypes.UINT8, nil, base.DEC, "0x80")
cme_sbe_mdp3_8_1.fields.num_in_group = ProtoField.new("num In Group", "cme.sbe.mdp3.numingroup", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.number_of_orders = ProtoField.new("Number Of Orders", "cme.sbe.mdp3.numberoforders", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.open_close_settl_flag = ProtoField.new("Open Close Settl Flag", "cme.sbe.mdp3.openclosesettlflag", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.open_interest_qty = ProtoField.new("Open Interest Qty", "cme.sbe.mdp3.openinterestqty", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.order_cross_eligible = ProtoField.new("Order Cross Eligible", "cme.sbe.mdp3.ordercrosseligible", ftypes.UINT32, nil, base.DEC, "0x00000002")
cme_sbe_mdp3_8_1.fields.order_id = ProtoField.new("Order ID", "cme.sbe.mdp3.orderid", ftypes.UINT64)
cme_sbe_mdp3_8_1.fields.order_qty = ProtoField.new("Order Qty", "cme.sbe.mdp3.orderqty", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.order_update_action = ProtoField.new("Order Update Action", "cme.sbe.mdp3.orderupdateaction", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.original_contract_size = ProtoField.new("Original Contract Size", "cme.sbe.mdp3.originalcontractsize", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.otc_eligible = ProtoField.new("OTC Eligible", "cme.sbe.mdp3.otceligible", ftypes.UINT32, nil, base.DEC, "0x00000080")
cme_sbe_mdp3_8_1.fields.packet = ProtoField.new("Packet", "cme.sbe.mdp3.packet", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.packet_header = ProtoField.new("Packet Header", "cme.sbe.mdp3.packetheader", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.padding_1 = ProtoField.new("Padding 1", "cme.sbe.mdp3.padding1", ftypes.BYTES)
cme_sbe_mdp3_8_1.fields.padding_2 = ProtoField.new("Padding 2", "cme.sbe.mdp3.padding2", ftypes.BYTES)
cme_sbe_mdp3_8_1.fields.padding_3 = ProtoField.new("Padding 3", "cme.sbe.mdp3.padding3", ftypes.BYTES)
cme_sbe_mdp3_8_1.fields.padding_4 = ProtoField.new("Padding 4", "cme.sbe.mdp3.padding4", ftypes.BYTES)
cme_sbe_mdp3_8_1.fields.padding_5 = ProtoField.new("Padding 5", "cme.sbe.mdp3.padding5", ftypes.BYTES)
cme_sbe_mdp3_8_1.fields.padding_6 = ProtoField.new("Padding 6", "cme.sbe.mdp3.padding6", ftypes.BYTES)
cme_sbe_mdp3_8_1.fields.padding_7 = ProtoField.new("Padding 7", "cme.sbe.mdp3.padding7", ftypes.BYTES)
cme_sbe_mdp3_8_1.fields.payload = ProtoField.new("Payload", "cme.sbe.mdp3.payload", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.price_display_format = ProtoField.new("Price Display Format", "cme.sbe.mdp3.pricedisplayformat", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.price_ratio = ProtoField.new("Price Ratio", "cme.sbe.mdp3.priceratio", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.put_or_call = ProtoField.new("Put Or Call", "cme.sbe.mdp3.putorcall", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.quote_req_id = ProtoField.new("Quote Req ID", "cme.sbe.mdp3.quotereqid", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.quote_request = ProtoField.new("Quote Request", "cme.sbe.mdp3.quoterequest", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.quote_type = ProtoField.new("Quote Type", "cme.sbe.mdp3.quotetype", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.recovery_msg = ProtoField.new("Recovery Msg", "cme.sbe.mdp3.recoverymsg", ftypes.UINT8, nil, base.DEC, "0x20")
cme_sbe_mdp3_8_1.fields.reference_id = ProtoField.new("Reference ID", "cme.sbe.mdp3.referenceid", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.related_instruments_group = ProtoField.new("Related Instruments Group", "cme.sbe.mdp3.relatedinstrumentsgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.related_instruments_groups = ProtoField.new("Related Instruments Groups", "cme.sbe.mdp3.relatedinstrumentsgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.related_security_id = ProtoField.new("Related Security ID", "cme.sbe.mdp3.relatedsecurityid", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.related_sym_group = ProtoField.new("Related Sym Group", "cme.sbe.mdp3.relatedsymgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.related_sym_groups = ProtoField.new("Related Sym Groups", "cme.sbe.mdp3.relatedsymgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.related_symbol = ProtoField.new("Related Symbol", "cme.sbe.mdp3.relatedsymbol", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.reserved = ProtoField.new("Reserved", "cme.sbe.mdp3.reserved", ftypes.UINT8, nil, base.DEC, "0x40")
cme_sbe_mdp3_8_1.fields.reserved_12 = ProtoField.new("Reserved 12", "cme.sbe.mdp3.reserved12", ftypes.UINT32, nil, base.DEC, "0xFFF00000")
cme_sbe_mdp3_8_1.fields.reserved_bits = ProtoField.new("Reserved Bits", "cme.sbe.mdp3.reservedbits", ftypes.UINT8, nil, base.DEC, "0x70")
cme_sbe_mdp3_8_1.fields.rfq_cross_eligible = ProtoField.new("RFQ Cross Eligible", "cme.sbe.mdp3.rfqcrosseligible", ftypes.UINT32, nil, base.DEC, "0x00002000")
cme_sbe_mdp3_8_1.fields.rounded = ProtoField.new("Rounded", "cme.sbe.mdp3.rounded", ftypes.UINT8, nil, base.DEC, "0x04")
cme_sbe_mdp3_8_1.fields.rpt_seq = ProtoField.new("Rpt Seq", "cme.sbe.mdp3.rptseq", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.schema_id = ProtoField.new("Schema Id", "cme.sbe.mdp3.schemaid", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.security_exchange = ProtoField.new("Security Exchange", "cme.sbe.mdp3.securityexchange", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.security_group = ProtoField.new("Security Group", "cme.sbe.mdp3.securitygroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.security_id = ProtoField.new("Security ID", "cme.sbe.mdp3.securityid", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.security_status = ProtoField.new("Security Status", "cme.sbe.mdp3.securitystatus", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.security_sub_type = ProtoField.new("Security Sub Type", "cme.sbe.mdp3.securitysubtype", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.security_trading_event = ProtoField.new("Security Trading Event", "cme.sbe.mdp3.securitytradingevent", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.security_trading_status = ProtoField.new("Security Trading Status", "cme.sbe.mdp3.securitytradingstatus", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.security_type = ProtoField.new("Security Type", "cme.sbe.mdp3.securitytype", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.security_update_action = ProtoField.new("Security Update Action", "cme.sbe.mdp3.securityupdateaction", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.sending_time = ProtoField.new("Sending Time", "cme.sbe.mdp3.sendingtime", ftypes.UINT64)
cme_sbe_mdp3_8_1.fields.settl_currency = ProtoField.new("Settl Currency", "cme.sbe.mdp3.settlcurrency", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.settl_price_type = ProtoField.new("Settl Price Type", "cme.sbe.mdp3.settlpricetype", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.side = ProtoField.new("Side", "cme.sbe.mdp3.side", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.snapshot_full_refresh = ProtoField.new("Snapshot Full Refresh", "cme.sbe.mdp3.snapshotfullrefresh", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_group = ProtoField.new("Snapshot Full Refresh Group", "cme.sbe.mdp3.snapshotfullrefreshgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_groups = ProtoField.new("Snapshot Full Refresh Groups", "cme.sbe.mdp3.snapshotfullrefreshgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_order_book = ProtoField.new("Snapshot Full Refresh Order Book", "cme.sbe.mdp3.snapshotfullrefreshorderbook", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_order_book_group = ProtoField.new("Snapshot Full Refresh Order Book Group", "cme.sbe.mdp3.snapshotfullrefreshorderbookgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_order_book_groups = ProtoField.new("Snapshot Full Refresh Order Book Groups", "cme.sbe.mdp3.snapshotfullrefreshorderbookgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.strike_currency = ProtoField.new("Strike Currency", "cme.sbe.mdp3.strikecurrency", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.strike_price = ProtoField.new("Strike Price", "cme.sbe.mdp3.strikeprice", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.sub_fraction = ProtoField.new("Sub Fraction", "cme.sbe.mdp3.subfraction", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.symbol = ProtoField.new("Symbol", "cme.sbe.mdp3.symbol", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.template_id = ProtoField.new("Template Id", "cme.sbe.mdp3.templateid", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.text = ProtoField.new("Text", "cme.sbe.mdp3.text", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.tick_rule = ProtoField.new("Tick Rule", "cme.sbe.mdp3.tickrule", ftypes.INT8, {[1]="Yes",[0]="No"})
cme_sbe_mdp3_8_1.fields.tot_num_reports = ProtoField.new("Tot Num Reports", "cme.sbe.mdp3.totnumreports", ftypes.UINT32)
cme_sbe_mdp3_8_1.fields.trade_date = ProtoField.new("Trade Date", "cme.sbe.mdp3.tradedate", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.trade_id = ProtoField.new("Trade ID", "cme.sbe.mdp3.tradeid", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.trading_reference_date = ProtoField.new("Trading Reference Date", "cme.sbe.mdp3.tradingreferencedate", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.trading_reference_price = ProtoField.new("Trading Reference Price", "cme.sbe.mdp3.tradingreferenceprice", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.transact_time = ProtoField.new("Transact Time", "cme.sbe.mdp3.transacttime", ftypes.UINT64)
cme_sbe_mdp3_8_1.fields.underlying_product = ProtoField.new("Underlying Product", "cme.sbe.mdp3.underlyingproduct", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.underlying_security_id = ProtoField.new("Underlying Security ID", "cme.sbe.mdp3.underlyingsecurityid", ftypes.INT32)
cme_sbe_mdp3_8_1.fields.underlying_symbol = ProtoField.new("Underlying Symbol", "cme.sbe.mdp3.underlyingsymbol", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.underlyings_group = ProtoField.new("Underlyings Group", "cme.sbe.mdp3.underlyingsgroup", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.underlyings_groups = ProtoField.new("Underlyings Groups", "cme.sbe.mdp3.underlyingsgroups", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.unit_of_measure = ProtoField.new("Unit Of Measure", "cme.sbe.mdp3.unitofmeasure", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.unit_of_measure_qty = ProtoField.new("Unit Of Measure Qty", "cme.sbe.mdp3.unitofmeasureqty", ftypes.INT64)
cme_sbe_mdp3_8_1.fields.user_defined_instrument = ProtoField.new("User Defined Instrument", "cme.sbe.mdp3.userdefinedinstrument", ftypes.STRING)
cme_sbe_mdp3_8_1.fields.variable_product_eligibility = ProtoField.new("Variable Product Eligibility", "cme.sbe.mdp3.variableproducteligibility", ftypes.UINT32, nil, base.DEC, "0x00010000")
cme_sbe_mdp3_8_1.fields.version = ProtoField.new("Version", "cme.sbe.mdp3.version", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.volatility_quoted_option = ProtoField.new("Volatility Quoted Option", "cme.sbe.mdp3.volatilityquotedoption", ftypes.UINT32, nil, base.DEC, "0x00001000")
cme_sbe_mdp3_8_1.fields.week = ProtoField.new("week", "cme.sbe.mdp3.week", ftypes.UINT8)
cme_sbe_mdp3_8_1.fields.year = ProtoField.new("year", "cme.sbe.mdp3.year", ftypes.UINT16)
cme_sbe_mdp3_8_1.fields.zero_price_outright_eligible = ProtoField.new("Zero Price Outright Eligible", "cme.sbe.mdp3.zeropriceoutrighteligible", ftypes.UINT32, nil, base.DEC, "0x00004000")
...
dissect.snapshot_full_refresh_order_book_group = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_order_book_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_order_book_group, range, display)
  end
...
dissect.num_in_group = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp3_8_1.fields.num_in_group, range, value, display)
...
dissect.group_size = function(buffer, offset, packet, parent)
  ...
  if show.group_size then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.group_size, range, display)
  end
...
dissect.snapshot_full_refresh_order_book_groups = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_order_book_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_order_book_groups, range, display)
  end
...
dissect.snapshot_full_refresh_order_book = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_order_book then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_order_book, range, display)
  end
...
dissect.md_incremental_refresh_order_book_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_order_book_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_order_book_group, range, display)
  end
...
dissect.md_incremental_refresh_order_book_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_order_book_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_order_book_groups, range, display)
  end
...
dissect.last_trade_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.last_trade_msg, range, display)
...
dissect.last_volume_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.last_volume_msg, range, display)
...
dissect.last_quote_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.last_quote_msg, range, display)
...
dissect.last_stats_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.last_stats_msg, range, display)
...
dissect.last_implied_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.last_implied_msg, range, display)
...
dissect.recovery_msg = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.recovery_msg, range, display)
...
dissect.reserved = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.reserved, range, display)
...
dissect.end_of_event = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.end_of_event, range, display)
...
dissect.match_event_indicator_bits = function(buffer, offset, packet, parent)
  ...
  -- End Of Event: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.end_of_event, buffer(offset + 0, 1))

  -- Reserved: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.reserved, buffer(offset + 0, 1))

  -- Recovery Msg: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.recovery_msg, buffer(offset + 0, 1))

  -- Last Implied Msg: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.last_implied_msg, buffer(offset + 0, 1))

  -- Last Stats Msg: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.last_stats_msg, buffer(offset + 0, 1))

  -- Last Quote Msg: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.last_quote_msg, buffer(offset + 0, 1))

  -- Last Volume Msg: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.last_volume_msg, buffer(offset + 0, 1))

  -- Last Trade Msg: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.last_trade_msg, buffer(offset + 0, 1))
end
...
dissect.match_event_indicator = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.match_event_indicator, range, display)
...
dissect.md_incremental_refresh_order_book = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_order_book then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_order_book, range, display)
  end
...
dissect.md_incremental_refresh_trade_summary_order_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_order_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_order_group, range, display)
  end
...
dissect.group_size8_byte = function(buffer, offset, packet, parent)
  ...
  if show.group_size8_byte then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.group_size8_byte, range, display)
  end
...
dissect.md_incremental_refresh_trade_summary_order_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_order_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_order_groups, range, display)
  end
...
dissect.md_incremental_refresh_trade_summary_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_group, range, display)
  end
...
dissect.md_incremental_refresh_trade_summary_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary_groups, range, display)
  end
...
dissect.md_incremental_refresh_trade_summary = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_summary then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_summary, range, display)
  end
...
dissect.related_instruments_group = function(buffer, offset, packet, parent)
  ...
  if show.related_instruments_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.related_instruments_group, range, display)
  end
...
dissect.related_instruments_groups = function(buffer, offset, packet, parent)
  ...
  if show.related_instruments_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.related_instruments_groups, range, display)
  end
...
dissect.underlyings_group = function(buffer, offset, packet, parent)
  ...
  if show.underlyings_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.underlyings_group, range, display)
  end
...
dissect.underlyings_groups = function(buffer, offset, packet, parent)
  ...
  if show.underlyings_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.underlyings_groups, range, display)
  end
...
dissect.lot_type_rules_group = function(buffer, offset, packet, parent)
  ...
  if show.lot_type_rules_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.lot_type_rules_group, range, display)
  end
...
dissect.lot_type_rules_groups = function(buffer, offset, packet, parent)
  ...
  if show.lot_type_rules_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.lot_type_rules_groups, range, display)
  end
...
dissect.electronic_match_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.electronic_match_eligible, range, display)
...
dissect.order_cross_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.order_cross_eligible, range, display)
...
dissect.block_trade_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.block_trade_eligible, range, display)
...
dissect.efp_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.efp_eligible, range, display)
...
dissect.ebf_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.ebf_eligible, range, display)
...
dissect.efs_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.efs_eligible, range, display)
...
dissect.efr_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.efr_eligible, range, display)
...
dissect.otc_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.otc_eligible, range, display)
...
dissect.i_link_indicative_mass_quoting_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.i_link_indicative_mass_quoting_eligible, range, display)
...
dissect.negative_strike_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.negative_strike_eligible, range, display)
...
dissect.negative_price_outright_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.negative_price_outright_eligible, range, display)
...
dissect.is_fractional = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.is_fractional, range, display)
...
dissect.volatility_quoted_option = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.volatility_quoted_option, range, display)
...
dissect.rfq_cross_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.rfq_cross_eligible, range, display)
...
dissect.zero_price_outright_eligible = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.zero_price_outright_eligible, range, display)
...
dissect.decaying_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.decaying_product_eligibility, range, display)
...
dissect.variable_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.variable_product_eligibility, range, display)
...
dissect.daily_product_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.daily_product_eligibility, range, display)
...
dissect.gt_orders_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.gt_orders_eligibility, range, display)
...
dissect.implied_matching_eligibility = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.implied_matching_eligibility, range, display)
...
dissect.reserved_12 = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.reserved_12, range, display)
...
dissect.inst_attrib_value_bits = function(buffer, offset, packet, parent)
  ...
  -- Reserved 12: 12 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.reserved_12, buffer(offset + 0, 4))

  -- Implied Matching Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.implied_matching_eligibility, buffer(offset + 0, 4))

  -- GT Orders Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.gt_orders_eligibility, buffer(offset + 0, 4))

  -- Daily Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.daily_product_eligibility, buffer(offset + 0, 4))

  -- Variable Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.variable_product_eligibility, buffer(offset + 0, 4))

  -- Decaying Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.decaying_product_eligibility, buffer(offset + 0, 4))

  -- Zero Price Outright Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.zero_price_outright_eligible, buffer(offset + 0, 4))

  -- RFQ Cross Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.rfq_cross_eligible, buffer(offset + 0, 4))

  -- Volatility Quoted Option: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.volatility_quoted_option, buffer(offset + 0, 4))

  -- Is Fractional: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.is_fractional, buffer(offset + 0, 4))

  -- Negative Price Outright Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.negative_price_outright_eligible, buffer(offset + 0, 4))

  -- Negative Strike Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.negative_strike_eligible, buffer(offset + 0, 4))

  -- i Link Indicative Mass Quoting Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.i_link_indicative_mass_quoting_eligible, buffer(offset + 0, 4))

  -- OTC Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.otc_eligible, buffer(offset + 0, 4))

  -- EFR Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.efr_eligible, buffer(offset + 0, 4))

  -- EFS Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.efs_eligible, buffer(offset + 0, 4))

  -- EBF Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.ebf_eligible, buffer(offset + 0, 4))

  -- EFP Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.efp_eligible, buffer(offset + 0, 4))

  -- Block Trade Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.block_trade_eligible, buffer(offset + 0, 4))

  -- Order Cross Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.order_cross_eligible, buffer(offset + 0, 4))

  -- Electronic Match Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.electronic_match_eligible, buffer(offset + 0, 4))
end
...
dissect.inst_attrib_value = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.inst_attrib_value, range, display)
...
dissect.inst_attrib_group = function(buffer, offset, packet, parent)
  ...
  if show.inst_attrib_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.inst_attrib_group, range, display)
  end
...
dissect.inst_attrib_groups = function(buffer, offset, packet, parent)
  ...
  if show.inst_attrib_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.inst_attrib_groups, range, display)
  end
...
dissect.md_feed_types_group = function(buffer, offset, packet, parent)
  ...
  if show.md_feed_types_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_feed_types_group, range, display)
  end
...
dissect.md_feed_types_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_feed_types_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_feed_types_groups, range, display)
  end
...
dissect.events_group = function(buffer, offset, packet, parent)
  ...
  if show.events_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.events_group, range, display)
  end
...
dissect.events_groups = function(buffer, offset, packet, parent)
  ...
  if show.events_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.events_groups, range, display)
  end
...
dissect.final = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.final, range, display)
...
dissect.actual = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.actual, range, display)
...
dissect.rounded = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.rounded, range, display)
...
dissect.intraday = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.intraday, range, display)
...
dissect.reserved_bits = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.reserved_bits, range, display)
...
dissect.null_value = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.null_value, range, display)
...
dissect.settl_price_type_bits = function(buffer, offset, packet, parent)
  ...
  -- Null Value: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.null_value, buffer(offset + 0, 1))

  -- Reserved Bits: 3 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.reserved_bits, buffer(offset + 0, 1))

  -- Intraday: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.intraday, buffer(offset + 0, 1))

  -- Rounded: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.rounded, buffer(offset + 0, 1))

  -- Actual: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.actual, buffer(offset + 0, 1))

  -- Final: 1 Bit
  parent:add(cme_sbe_mdp3_8_1.fields.final, buffer(offset + 0, 1))
end
...
dissect.settl_price_type = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.settl_price_type, range, display)
...
dissect.maturity_month_year = function(buffer, offset, packet, parent)
  ...
  if show.maturity_month_year then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.maturity_month_year, range, display)
  end
...
dissect.md_instrument_definition_option = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_option then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_instrument_definition_option, range, display)
  end
...
dissect.related_sym_group = function(buffer, offset, packet, parent)
  ...
  if show.related_sym_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.related_sym_group, range, display)
  end
...
dissect.related_sym_groups = function(buffer, offset, packet, parent)
  ...
  if show.related_sym_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.related_sym_groups, range, display)
  end
...
dissect.quote_request = function(buffer, offset, packet, parent)
  ...
  if show.quote_request then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.quote_request, range, display)
  end
...
dissect.snapshot_full_refresh_group = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_group, range, display)
  end
...
dissect.snapshot_full_refresh_groups = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.snapshot_full_refresh_groups, range, display)
  end
...
dissect.snapshot_full_refresh = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.snapshot_full_refresh, range, display)
  end
...
dissect.md_incremental_refresh_volume_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_volume_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_volume_group, range, display)
  end
...
dissect.md_incremental_refresh_volume_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_volume_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_volume_groups, range, display)
  end
...
dissect.md_incremental_refresh_volume = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_volume then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_volume, range, display)
  end
...
dissect.md_incremental_refresh_trade_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_group, range, display)
  end
...
dissect.md_incremental_refresh_trade_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade_groups, range, display)
  end
...
dissect.md_incremental_refresh_trade = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_trade, range, display)
  end
...
dissect.md_incremental_refresh_session_statistics_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_session_statistics_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_session_statistics_group, range, display)
  end
...
dissect.md_incremental_refresh_session_statistics_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_session_statistics_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_session_statistics_groups, range, display)
  end
...
dissect.md_incremental_refresh_session_statistics = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_session_statistics then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_session_statistics, range, display)
  end
...
dissect.md_incremental_refresh_limits_banding_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_limits_banding_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_limits_banding_group, range, display)
  end
...
dissect.md_incremental_refresh_limits_banding_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_limits_banding_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_limits_banding_groups, range, display)
  end
...
dissect.md_incremental_refresh_limits_banding = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_limits_banding then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_limits_banding, range, display)
  end
...
dissect.md_incremental_refresh_daily_statistics_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_daily_statistics_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_daily_statistics_group, range, display)
  end
...
dissect.md_incremental_refresh_daily_statistics_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_daily_statistics_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_daily_statistics_groups, range, display)
  end
...
dissect.md_incremental_refresh_daily_statistics = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_daily_statistics then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_daily_statistics, range, display)
  end
...
dissect.md_incremental_refresh_book_order_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book_order_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_order_group, range, display)
  end
...
dissect.md_incremental_refresh_book_order_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book_order_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_order_groups, range, display)
  end
...
dissect.md_incremental_refresh_book_group = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_group, range, display)
  end
...
dissect.md_incremental_refresh_book_groups = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book_groups, range, display)
  end
...
dissect.md_incremental_refresh_book = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_book then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_incremental_refresh_book, range, display)
  end
...
dissect.security_status = function(buffer, offset, packet, parent)
  ...
  if show.security_status then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.security_status, range, display)
  end
...
dissect.legs_group = function(buffer, offset, packet, parent)
  ...
  if show.legs_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.legs_group, range, display)
  end
...
dissect.legs_groups = function(buffer, offset, packet, parent)
  ...
  if show.legs_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.legs_groups, range, display)
  end
...
dissect.md_instrument_definition_spread = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_spread then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_instrument_definition_spread, range, display)
  end
...
dissect.md_instrument_definition_future = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_future then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.md_instrument_definition_future, range, display)
  end
...
dissect.admin_logout = function(buffer, offset, packet, parent)
  ...
  if show.admin_logout then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.admin_logout, range, display)
  end
...
dissect.admin_login = function(buffer, offset, packet, parent)
  ...
  if show.admin_login then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.admin_login, range, display)
  end
...
dissect.channel_reset_group = function(buffer, offset, packet, parent)
  ...
  if show.channel_reset_group then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.channel_reset_group, range, display)
  end
...
dissect.channel_reset_groups = function(buffer, offset, packet, parent)
  ...
  if show.channel_reset_groups then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.channel_reset_groups, range, display)
  end
...
dissect.channel_reset = function(buffer, offset, packet, parent)
  ...
  if show.channel_reset then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.channel_reset, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_sbe_mdp3_8_1.fields.payload, range, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_sbe_mdp3_8_1.fields.template_id, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.message_header, range, display)
  end
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.message, range, display)
  end
...
dissect.packet_header = function(buffer, offset, packet, parent)
  ...
  if show.packet_header then
    ...
    parent = parent:add(cme_sbe_mdp3_8_1.fields.packet_header, range, display)
  end
...
function cme_sbe_mdp3_8_1.init()
end

-- Dissector for Cme Sbe Mdp3 8.1
function cme_sbe_mdp3_8_1.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = cme_sbe_mdp3_8_1.name

  -- Dissect protocol
  local protocol = parent:add(cme_sbe_mdp3_8_1, buffer(), cme_sbe_mdp3_8_1.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, cme_sbe_mdp3_8_1)
...
verify.cme_sbe_mdp3_8_1_packet_size = function(buffer)
...
-- Dissector Heuristic for Cme Sbe Mdp3 8.1
local function cme_sbe_mdp3_8_1_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.cme_sbe_mdp3_8_1_packet_size(buffer) then return false end

  -- Verify Version
  if not verify.version(buffer) then return false end

  -- Protocol is valid, set conversation and dissect this packet
  packet.conversation = cme_sbe_mdp3_8_1
  cme_sbe_mdp3_8_1.dissector(buffer, packet, parent)

  return true
end

-- Register Cme Sbe Mdp3 8.1 Heuristic
cme_sbe_mdp3_8_1:register_heuristic("udp", cme_sbe_mdp3_8_1_heuristic)
