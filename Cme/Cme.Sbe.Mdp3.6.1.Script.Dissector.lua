...
dissect.match_event_indicator_bits = function(buffer, offset, packet, parent)
  ...
  -- End Of Event: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.end_of_event, buffer(offset, 1))

  -- Reserved: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.reserved, buffer(offset, 1))

  -- Recovery Msg: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.recovery_msg, buffer(offset, 1))

  -- Last Implied Msg: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.last_implied_msg, buffer(offset, 1))

  -- Last Stats Msg: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.last_stats_msg, buffer(offset, 1))

  -- Last Quote Msg: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.last_quote_msg, buffer(offset, 1))

  -- Last Volume Msg: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.last_volume_msg, buffer(offset, 1))

  -- Last Trade Msg: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.last_trade_msg, buffer(offset, 1))
end
...
dissect.inst_attrib_value_bits = function(buffer, offset, packet, parent)
  ...
  -- Reserved 12: 12 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.reserved_12, buffer(offset, 4))

  -- Implied Matching Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.implied_matching_eligibility, buffer(offset, 4))

  -- GT Orders Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.gt_orders_eligibility, buffer(offset, 4))

  -- Daily Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.daily_product_eligibility, buffer(offset, 4))

  -- Variable Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.variable_product_eligibility, buffer(offset, 4))

  -- Decaying Product Eligibility: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.decaying_product_eligibility, buffer(offset, 4))

  -- Zero Price Outright Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.zero_price_outright_eligible, buffer(offset, 4))

  -- RFQ Cross Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.rfq_cross_eligible, buffer(offset, 4))

  -- Volatility Quoted Option: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.volatility_quoted_option, buffer(offset, 4))

  -- Is Fractional: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.is_fractional, buffer(offset, 4))

  -- Negative Price Outright Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.negative_price_outright_eligible, buffer(offset, 4))

  -- Negative Strike Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.negative_strike_eligible, buffer(offset, 4))

  -- i Link Indicative Mass Quoting Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.i_link_indicative_mass_quoting_eligible, buffer(offset, 4))

  -- OTC Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.otc_eligible, buffer(offset, 4))

  -- EFR Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.efr_eligible, buffer(offset, 4))

  -- EFS Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.efs_eligible, buffer(offset, 4))

  -- EBF Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.ebf_eligible, buffer(offset, 4))

  -- EFP Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.efp_eligible, buffer(offset, 4))

  -- Block Trade Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.block_trade_eligible, buffer(offset, 4))

  -- Order Cross Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.order_cross_eligible, buffer(offset, 4))

  -- Electronic Match Eligible: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.electronic_match_eligible, buffer(offset, 4))
end
...
dissect.settl_price_type_bits = function(buffer, offset, packet, parent)
  ...
  -- Null Value: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.null_value, buffer(offset, 1))

  -- Reserved Bits: 3 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.reserved_bits, buffer(offset, 1))

  -- Intraday: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.intraday, buffer(offset, 1))

  -- Rounded: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.rounded, buffer(offset, 1))

  -- Actual: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.actual, buffer(offset, 1))

  -- Final: 1 Bit
  parent:add(cme_sbe_mdp3_6_1.fields.final, buffer(offset, 1))
end
