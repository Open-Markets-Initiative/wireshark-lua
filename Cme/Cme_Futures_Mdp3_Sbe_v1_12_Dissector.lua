...
cme_futures_mdp3_sbe_v1_12.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 15 then
    return cme_futures_mdp3_sbe_v1_12.admin_login.size
  end
  -- Size of Admin Logout
  if template_id == 16 then
    return cme_futures_mdp3_sbe_v1_12.admin_logout.size
  end
  -- Size of Security Status
  if template_id == 30 then
    return cme_futures_mdp3_sbe_v1_12.security_status.size
  end
