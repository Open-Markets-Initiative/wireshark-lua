...
cme_futures_mdp3_sbe_v1_12.snapshot_full_refresh_long_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.snapshot_full_refresh_long_groups then
    local length = cme_futures_mdp3_sbe_v1_12.snapshot_full_refresh_long_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.snapshot_full_refresh_long_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_long_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.snapshotfull_refresh_tcp_long_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.snapshotfull_refresh_tcp_long_groups then
    local length = cme_futures_mdp3_sbe_v1_12.snapshotfull_refresh_tcp_long_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.snapshotfull_refresh_tcp_long_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.snapshotfull_refresh_tcp_long_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_session_statistics_long_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_session_statistics_long_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_session_statistics_long_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_session_statistics_long_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_session_statistics_long_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_volume_long_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_volume_long_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_volume_long_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_volume_long_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_volume_long_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_long_order_id_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_trade_summary_long_order_id_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_long_order_id_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_long_order_id_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_trade_summary_long_order_id_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_long_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_trade_summary_long_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_long_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_long_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_trade_summary_long_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_long_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_book_long_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_long_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_long_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_book_long_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.feed_types_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.feed_types_groups then
    local length = cme_futures_mdp3_sbe_v1_12.feed_types_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.feed_types_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.feed_types_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.security_status_workup_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.security_status_workup_groups then
    local length = cme_futures_mdp3_sbe_v1_12.security_status_workup_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.security_status_workup_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.security_status_workup_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.repo_related_instruments_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.repo_related_instruments_groups then
    local length = cme_futures_mdp3_sbe_v1_12.repo_related_instruments_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.repo_related_instruments_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.repo_related_instruments_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.repo_underlyings_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.repo_underlyings_groups then
    local length = cme_futures_mdp3_sbe_v1_12.repo_underlyings_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.repo_underlyings_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.repo_underlyings_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.legs_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.legs_groups then
    local length = cme_futures_mdp3_sbe_v1_12.legs_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.legs_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.legs_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.option_related_instruments_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.option_related_instruments_groups then
    local length = cme_futures_mdp3_sbe_v1_12.option_related_instruments_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.option_related_instruments_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.option_related_instruments_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.option_underlyings_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.option_underlyings_groups then
    local length = cme_futures_mdp3_sbe_v1_12.option_underlyings_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.option_underlyings_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.option_underlyings_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_session_statistics_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_session_statistics_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_session_statistics_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_session_statistics_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_session_statistics_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_limits_banding_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_limits_banding_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_limits_banding_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_limits_banding_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_limits_banding_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_daily_statistics_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_daily_statistics_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_daily_statistics_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_daily_statistics_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_daily_statistics_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_order_id_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_trade_summary_order_id_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_order_id_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_order_id_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_trade_summary_order_id_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_trade_summary_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_trade_summary_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_trade_summary_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_order_book_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_order_book_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_order_book_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_order_book_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_order_book_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_order_id_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_book_order_id_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_order_id_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_order_id_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_book_order_id_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_book_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_book_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_book_groups, range, display)
  end
...
cme_futures_mdp3_sbe_v1_12.incremental_refresh_volume_groups.dissect = function(buffer, offset, packet, parent)
  ...
  if show.incremental_refresh_volume_groups then
    local length = cme_futures_mdp3_sbe_v1_12.incremental_refresh_volume_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_12.incremental_refresh_volume_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_12.fields.incremental_refresh_volume_groups, range, display)
  end
