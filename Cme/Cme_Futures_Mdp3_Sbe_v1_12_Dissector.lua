...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_long_qty_group = function(buffer, offset, packet, parent)
  if show.snapshot_full_refresh_long_qty_group then
    ...
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_long_qty_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_long_qty_group_fields(buffer, offset, packet, element)
    ...
    return cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_long_qty_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.group_size = function(buffer, offset, packet, parent)
  if show.group_size then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.group_size, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.group_size_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.group_size_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_long_qty_groups_fields = function(buffer, offset, packet, parent)
  ...
  for snapshot_full_refresh_long_qty_group_index = 1, num_in_group do
    index, snapshot_full_refresh_long_qty_group = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_long_qty_group(buffer, index, packet, parent)

    if snapshot_full_refresh_long_qty_group ~= nil then
      local iteration = snapshot_full_refresh_long_qty_group:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_long_qty_group_index, snapshot_full_refresh_long_qty_group_index)
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tc_p_long_qty_group = function(buffer, offset, packet, parent)
  if show.snapshot_full_refresh_tc_p_long_qty_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_tc_p_long_qty_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tc_p_long_qty_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tc_p_long_qty_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tc_p_long_qty_groups_fields = function(buffer, offset, packet, parent)
  ...
  for snapshot_full_refresh_tc_p_long_qty_group_index = 1, num_in_group do
    index, snapshot_full_refresh_tc_p_long_qty_group = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tc_p_long_qty_group(buffer, index, packet, parent)

    if snapshot_full_refresh_tc_p_long_qty_group ~= nil then
      local iteration = snapshot_full_refresh_tc_p_long_qty_group:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_tc_p_long_qty_group_index, snapshot_full_refresh_tc_p_long_qty_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_long_qty_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_session_statistics_long_qty_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_session_statistics_long_qty_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_long_qty_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_long_qty_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_long_qty_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_session_statistics_long_qty_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_session_statistics_long_qty_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_long_qty_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_session_statistics_long_qty_group ~= nil then
      local iteration = m_d_incremental_refresh_session_statistics_long_qty_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_session_statistics_long_qty_group_index, m_d_incremental_refresh_session_statistics_long_qty_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_long_qty_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_volume_long_qty_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_volume_long_qty_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_long_qty_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_long_qty_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_long_qty_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_volume_long_qty_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_volume_long_qty_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_long_qty_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_volume_long_qty_group ~= nil then
      local iteration = m_d_incremental_refresh_volume_long_qty_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_volume_long_qty_group_index, m_d_incremental_refresh_volume_long_qty_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_order_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_trade_summary_long_qty_order_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_long_qty_order_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_order_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_order_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.group_size_8_byte = function(buffer, offset, packet, parent)
  if show.group_size_8_byte then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.group_size_8_byte, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.group_size_8_byte_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.group_size_8_byte_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_trade_summary_long_qty_order_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_trade_summary_long_qty_order_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_order_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_trade_summary_long_qty_order_group ~= nil then
      local iteration = m_d_incremental_refresh_trade_summary_long_qty_order_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_long_qty_order_group_index, m_d_incremental_refresh_trade_summary_long_qty_order_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_trade_summary_long_qty_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_long_qty_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_trade_summary_long_qty_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_trade_summary_long_qty_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_long_qty_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_trade_summary_long_qty_group ~= nil then
      local iteration = m_d_incremental_refresh_trade_summary_long_qty_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_long_qty_group_index, m_d_incremental_refresh_trade_summary_long_qty_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_order_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_book_long_qty_order_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_long_qty_order_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_order_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_order_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_book_long_qty_order_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_book_long_qty_order_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_order_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_book_long_qty_order_group ~= nil then
      local iteration = m_d_incremental_refresh_book_long_qty_order_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_long_qty_order_group_index, m_d_incremental_refresh_book_long_qty_order_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_book_long_qty_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_long_qty_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_book_long_qty_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_book_long_qty_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_long_qty_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_book_long_qty_group ~= nil then
      local iteration = m_d_incremental_refresh_book_long_qty_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_long_qty_group_index, m_d_incremental_refresh_book_long_qty_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.trading_sessions_group = function(buffer, offset, packet, parent)
  if show.trading_sessions_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.trading_sessions_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.trading_sessions_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.trading_sessions_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.trading_sessions_groups_fields = function(buffer, offset, packet, parent)
  ...
  for trading_sessions_group_index = 1, num_in_group do
    index, trading_sessions_group = cme_futures_mdp3_sbe_v1_12_dissect.trading_sessions_group(buffer, index, packet, parent)

    if trading_sessions_group ~= nil then
      local iteration = trading_sessions_group:add(cme_futures_mdp3_sbe_v1_12.fields.trading_sessions_group_index, trading_sessions_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.lot_type_rules_group = function(buffer, offset, packet, parent)
  if show.lot_type_rules_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.lot_type_rules_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.lot_type_rules_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.lot_type_rules_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.lot_type_rules_groups_fields = function(buffer, offset, packet, parent)
  ...
  for lot_type_rules_group_index = 1, num_in_group do
    index, lot_type_rules_group = cme_futures_mdp3_sbe_v1_12_dissect.lot_type_rules_group(buffer, index, packet, parent)

    if lot_type_rules_group ~= nil then
      local iteration = lot_type_rules_group:add(cme_futures_mdp3_sbe_v1_12.fields.lot_type_rules_group_index, lot_type_rules_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.inst_attrib_group = function(buffer, offset, packet, parent)
  if show.inst_attrib_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.inst_attrib_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.inst_attrib_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.inst_attrib_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.inst_attrib_groups_fields = function(buffer, offset, packet, parent)
  ...
  for inst_attrib_group_index = 1, num_in_group do
    index, inst_attrib_group = cme_futures_mdp3_sbe_v1_12_dissect.inst_attrib_group(buffer, index, packet, parent)

    if inst_attrib_group ~= nil then
      local iteration = inst_attrib_group:add(cme_futures_mdp3_sbe_v1_12.fields.inst_attrib_group_index, inst_attrib_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_feed_types_group = function(buffer, offset, packet, parent)
  if show.m_d_feed_types_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_feed_types_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_feed_types_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_feed_types_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_feed_types_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_feed_types_group_index = 1, num_in_group do
    index, m_d_feed_types_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_feed_types_group(buffer, index, packet, parent)

    if m_d_feed_types_group ~= nil then
      local iteration = m_d_feed_types_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_feed_types_group_index, m_d_feed_types_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.events_group = function(buffer, offset, packet, parent)
  if show.events_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.events_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.events_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.events_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.events_groups_fields = function(buffer, offset, packet, parent)
  ...
  for events_group_index = 1, num_in_group do
    index, events_group = cme_futures_mdp3_sbe_v1_12_dissect.events_group(buffer, index, packet, parent)

    if events_group ~= nil then
      local iteration = events_group:add(cme_futures_mdp3_sbe_v1_12.fields.events_group_index, events_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.maturity_month_year = function(buffer, offset, packet, parent)
  if show.maturity_month_year then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.maturity_month_year, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.maturity_month_year_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.maturity_month_year_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.collateral_market_value_group = function(buffer, offset, packet, parent)
  if show.collateral_market_value_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.collateral_market_value_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.collateral_market_value_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.collateral_market_value_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.collateral_market_value_groups_fields = function(buffer, offset, packet, parent)
  ...
  for collateral_market_value_group_index = 1, num_in_group do
    index, collateral_market_value_group = cme_futures_mdp3_sbe_v1_12_dissect.collateral_market_value_group(buffer, index, packet, parent)

    if collateral_market_value_group ~= nil then
      local iteration = collateral_market_value_group:add(cme_futures_mdp3_sbe_v1_12.fields.collateral_market_value_group_index, collateral_market_value_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tcp_group = function(buffer, offset, packet, parent)
  if show.snapshot_full_refresh_tcp_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_tcp_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tcp_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tcp_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tcp_groups_fields = function(buffer, offset, packet, parent)
  ...
  for snapshot_full_refresh_tcp_group_index = 1, num_in_group do
    index, snapshot_full_refresh_tcp_group = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_tcp_group(buffer, index, packet, parent)

    if snapshot_full_refresh_tcp_group ~= nil then
      local iteration = snapshot_full_refresh_tcp_group:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_tcp_group_index, snapshot_full_refresh_tcp_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.security_status_workup_order_group = function(buffer, offset, packet, parent)
  if show.security_status_workup_order_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.security_status_workup_order_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.security_status_workup_order_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.security_status_workup_order_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.security_status_workup_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for security_status_workup_order_group_index = 1, num_in_group do
    index, security_status_workup_order_group = cme_futures_mdp3_sbe_v1_12_dissect.security_status_workup_order_group(buffer, index, packet, parent)

    if security_status_workup_order_group ~= nil then
      local iteration = security_status_workup_order_group:add(cme_futures_mdp3_sbe_v1_12.fields.security_status_workup_order_group_index, security_status_workup_order_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_refresh_top_orders_group = function(buffer, offset, packet, parent)
  if show.snapshot_refresh_top_orders_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_refresh_top_orders_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_refresh_top_orders_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.snapshot_refresh_top_orders_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_refresh_top_orders_groups_fields = function(buffer, offset, packet, parent)
  ...
  for snapshot_refresh_top_orders_group_index = 1, num_in_group do
    index, snapshot_refresh_top_orders_group = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_refresh_top_orders_group(buffer, index, packet, parent)

    if snapshot_refresh_top_orders_group ~= nil then
      local iteration = snapshot_refresh_top_orders_group:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_refresh_top_orders_group_index, snapshot_refresh_top_orders_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.related_instruments_group = function(buffer, offset, packet, parent)
  if show.related_instruments_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.related_instruments_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.related_instruments_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.related_instruments_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.related_instruments_groups_fields = function(buffer, offset, packet, parent)
  ...
  for related_instruments_group_index = 1, num_in_group do
    index, related_instruments_group = cme_futures_mdp3_sbe_v1_12_dissect.related_instruments_group(buffer, index, packet, parent)

    if related_instruments_group ~= nil then
      local iteration = related_instruments_group:add(cme_futures_mdp3_sbe_v1_12.fields.related_instruments_group_index, related_instruments_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.underlyings_group = function(buffer, offset, packet, parent)
  if show.underlyings_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.underlyings_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.underlyings_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.underlyings_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.underlyings_groups_fields = function(buffer, offset, packet, parent)
  ...
  for underlyings_group_index = 1, num_in_group do
    index, underlyings_group = cme_futures_mdp3_sbe_v1_12_dissect.underlyings_group(buffer, index, packet, parent)

    if underlyings_group ~= nil then
      local iteration = underlyings_group:add(cme_futures_mdp3_sbe_v1_12.fields.underlyings_group_index, underlyings_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_instrument_definition_spread_leg_group = function(buffer, offset, packet, parent)
  if show.m_d_instrument_definition_spread_leg_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_instrument_definition_spread_leg_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_instrument_definition_spread_leg_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_instrument_definition_spread_leg_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_instrument_definition_spread_leg_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_instrument_definition_spread_leg_group_index = 1, num_in_group do
    index, m_d_instrument_definition_spread_leg_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_instrument_definition_spread_leg_group(buffer, index, packet, parent)

    if m_d_instrument_definition_spread_leg_group ~= nil then
      local iteration = m_d_instrument_definition_spread_leg_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_instrument_definition_spread_leg_group_index, m_d_instrument_definition_spread_leg_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_order_book_group = function(buffer, offset, packet, parent)
  if show.snapshot_full_refresh_order_book_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_order_book_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_order_book_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_order_book_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_order_book_groups_fields = function(buffer, offset, packet, parent)
  ...
  for snapshot_full_refresh_order_book_group_index = 1, num_in_group do
    index, snapshot_full_refresh_order_book_group = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_order_book_group(buffer, index, packet, parent)

    if snapshot_full_refresh_order_book_group ~= nil then
      local iteration = snapshot_full_refresh_order_book_group:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_order_book_group_index, snapshot_full_refresh_order_book_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_group = function(buffer, offset, packet, parent)
  if show.snapshot_full_refresh_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_groups_fields = function(buffer, offset, packet, parent)
  ...
  for snapshot_full_refresh_group_index = 1, num_in_group do
    index, snapshot_full_refresh_group = cme_futures_mdp3_sbe_v1_12_dissect.snapshot_full_refresh_group(buffer, index, packet, parent)

    if snapshot_full_refresh_group ~= nil then
      local iteration = snapshot_full_refresh_group:add(cme_futures_mdp3_sbe_v1_12.fields.snapshot_full_refresh_group_index, snapshot_full_refresh_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_session_statistics_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_session_statistics_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_session_statistics_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_session_statistics_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_session_statistics_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_session_statistics_group ~= nil then
      local iteration = m_d_incremental_refresh_session_statistics_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_session_statistics_group_index, m_d_incremental_refresh_session_statistics_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_limits_banding_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_limits_banding_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_limits_banding_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_limits_banding_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_limits_banding_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_limits_banding_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_limits_banding_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_limits_banding_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_limits_banding_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_limits_banding_group ~= nil then
      local iteration = m_d_incremental_refresh_limits_banding_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_limits_banding_group_index, m_d_incremental_refresh_limits_banding_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_daily_statistics_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_daily_statistics_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_daily_statistics_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_daily_statistics_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_daily_statistics_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_daily_statistics_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_daily_statistics_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_daily_statistics_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_daily_statistics_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_daily_statistics_group ~= nil then
      local iteration = m_d_incremental_refresh_daily_statistics_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_daily_statistics_group_index, m_d_incremental_refresh_daily_statistics_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_order_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_trade_summary_order_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_order_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_order_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_order_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_trade_summary_order_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_trade_summary_order_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_order_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_trade_summary_order_group ~= nil then
      local iteration = m_d_incremental_refresh_trade_summary_order_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_order_group_index, m_d_incremental_refresh_trade_summary_order_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_trade_summary_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_trade_summary_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_trade_summary_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_trade_summary_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_trade_summary_group ~= nil then
      local iteration = m_d_incremental_refresh_trade_summary_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_trade_summary_group_index, m_d_incremental_refresh_trade_summary_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_order_book_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_order_book_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_order_book_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_order_book_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_order_book_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_order_book_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_order_book_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_order_book_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_order_book_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_order_book_group ~= nil then
      local iteration = m_d_incremental_refresh_order_book_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_order_book_group_index, m_d_incremental_refresh_order_book_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_order_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_book_order_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_order_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_order_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_order_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_book_order_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_book_order_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_order_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_book_order_group ~= nil then
      local iteration = m_d_incremental_refresh_book_order_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_order_group_index, m_d_incremental_refresh_book_order_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_book_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_book_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_book_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_book_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_book_group ~= nil then
      local iteration = m_d_incremental_refresh_book_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_book_group_index, m_d_incremental_refresh_book_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.related_sym_group = function(buffer, offset, packet, parent)
  if show.related_sym_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.related_sym_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.related_sym_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.related_sym_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.related_sym_groups_fields = function(buffer, offset, packet, parent)
  ...
  for related_sym_group_index = 1, num_in_group do
    index, related_sym_group = cme_futures_mdp3_sbe_v1_12_dissect.related_sym_group(buffer, index, packet, parent)

    if related_sym_group ~= nil then
      local iteration = related_sym_group:add(cme_futures_mdp3_sbe_v1_12.fields.related_sym_group_index, related_sym_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_group = function(buffer, offset, packet, parent)
  if show.m_d_incremental_refresh_volume_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_volume_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_volume_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_volume_group = cme_futures_mdp3_sbe_v1_12_dissect.m_d_incremental_refresh_volume_group(buffer, index, packet, parent)

    if m_d_incremental_refresh_volume_group ~= nil then
      local iteration = m_d_incremental_refresh_volume_group:add(cme_futures_mdp3_sbe_v1_12.fields.m_d_incremental_refresh_volume_group_index, m_d_incremental_refresh_volume_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.security_status = function(buffer, offset, packet, parent)
  if show.security_status then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.security_status, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.security_status_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.security_status_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.admin_logout = function(buffer, offset, packet, parent)
  if show.admin_logout then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.admin_logout, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.admin_logout_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.admin_logout_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.admin_login = function(buffer, offset, packet, parent)
  if show.admin_login then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.admin_login, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.admin_login_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.admin_login_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.channel_reset_group = function(buffer, offset, packet, parent)
  if show.channel_reset_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.channel_reset_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.channel_reset_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.channel_reset_group_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.channel_reset_groups_fields = function(buffer, offset, packet, parent)
  ...
  for channel_reset_group_index = 1, num_in_group do
    index, channel_reset_group = cme_futures_mdp3_sbe_v1_12_dissect.channel_reset_group(buffer, index, packet, parent)

    if channel_reset_group ~= nil then
      local iteration = channel_reset_group:add(cme_futures_mdp3_sbe_v1_12.fields.channel_reset_group_index, channel_reset_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_12_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.message_header, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.message_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.message_header_fields(buffer, offset, packet, element)
  end
end
...
cme_futures_mdp3_sbe_v1_12_dissect.binary_packet_header = function(buffer, offset, packet, parent)
  if show.binary_packet_header then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_mdp3_sbe_v1_12.fields.binary_packet_header, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_12_dissect.binary_packet_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    ...
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_12_dissect.binary_packet_header_fields(buffer, offset, packet, element)
  end
end
