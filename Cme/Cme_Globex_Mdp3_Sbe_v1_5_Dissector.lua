...
omi_cme_globex_mdp3_sbe_v1_5.fields.subscriber_heartbeat = ProtoField.new("Subscriber Heartbeat", "cme.globex.mdp3.sbe.v1.5.subscriberheartbeat", ftypes.BYTES)
...
cme_globex_mdp3_sbe_v1_5.encoding_type.tcp_packet_verify = function(buffer)
  -- Attempt to read field
...
local function omi_cme_globex_mdp3_sbe_v1_5_tcp_heuristic(buffer, packet, parent)
  ...
  if not cme_globex_mdp3_sbe_v1_5.encoding_type.tcp_packet_verify(buffer) then return false end
