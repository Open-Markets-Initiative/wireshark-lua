...
cme_globex_mdp3_sbe_v1_5.server_tcp_packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, server_tcp_message = cme_globex_mdp3_sbe_v1_5.server_tcp_message.dissect(buffer, index, packet, parent, tcp_message_size)
  end
...
cme_globex_mdp3_sbe_v1_5.client_tcp_packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, client_tcp_message = cme_globex_mdp3_sbe_v1_5.client_tcp_message.dissect(buffer, index, packet, parent, tcp_message_size)
  end
