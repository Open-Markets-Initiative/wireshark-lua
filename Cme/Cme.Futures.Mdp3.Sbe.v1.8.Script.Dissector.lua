...
cme_futures_mdp3_sbe_v1_8.fields.md_entry_type = ProtoField.new("Md Entry Type", "cme.futures.mdp3.sbe.v1.8.mdentrytype", ftypes.STRING)
...
cme_futures_mdp3_sbe_v1_8.fields.min_price_increment = ProtoField.new("Min Price Increment", "cme.futures.mdp3.sbe.v1.8.minpriceincrement", ftypes.INT64)
...
dissect.min_price_increment = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_mdp3_sbe_v1_8.fields.min_price_increment, range, value, display)
...
dissect.md_entry_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_mdp3_sbe_v1_8.fields.md_entry_type, range, value, display)
