...
cme_futures_mdp3_sbe_v1_8.fields.legs_group = ProtoField.new("Legs Group", "cme.futures.mdp3.sbe.v1.8.legsgroup", ftypes.STRING)
cme_futures_mdp3_sbe_v1_8.fields.legs_groups = ProtoField.new("Legs Groups", "cme.futures.mdp3.sbe.v1.8.legsgroups", ftypes.STRING)
...
cme_futures_mdp3_sbe_v1_8.prefs.show_legs_group = Pref.bool("Show Legs Group", show.legs_group, "Parse and add Legs Group to protocol tree")
cme_futures_mdp3_sbe_v1_8.prefs.show_legs_groups = Pref.bool("Show Legs Groups", show.legs_groups, "Parse and add Legs Groups to protocol tree")
...
function cme_futures_mdp3_sbe_v1_8.prefs_changed()
  ...
  if show.legs_group ~= cme_futures_mdp3_sbe_v1_8.prefs.show_legs_group then
    show.legs_group = cme_futures_mdp3_sbe_v1_8.prefs.show_legs_group
    changed = true
  end
  if show.legs_groups ~= cme_futures_mdp3_sbe_v1_8.prefs.show_legs_groups then
    show.legs_groups = cme_futures_mdp3_sbe_v1_8.prefs.show_legs_groups
    changed = true
  end
...
-- Calculate runtime size: Snapshot Full Refresh Order Book 44
...
-- Calculate runtime size: Md Incremental Refresh Order Book 43
...
dissect.legs_group = function(buffer, offset, packet, parent)
  ...
  if show.legs_group then
    ...
    parent = parent:add(cme_futures_mdp3_sbe_v1_8.fields.legs_group, range, display)
  end
...
dissect.legs_groups = function(buffer, offset, packet, parent)
  ...
  if show.legs_groups then
    ...
    parent = parent:add(cme_futures_mdp3_sbe_v1_8.fields.legs_groups, range, display)
  end
