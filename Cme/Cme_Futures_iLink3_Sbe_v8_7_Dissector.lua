...
local show = {}
local format = {}
local cme_futures_ilink3_sbe_v8_7_display = {}
local cme_futures_ilink3_sbe_v8_7_dissect = {}
local cme_futures_ilink3_sbe_v8_7_size_of = {}
local verify = {}
local translate = {}
...
cme_futures_ilink3_sbe_v8_7_size_of.discretion_price = 8

-- Display: Discretion Price
cme_futures_ilink3_sbe_v8_7_display.discretion_price = function(raw, value)
...
cme_futures_ilink3_sbe_v8_7_dissect.discretion_price = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.discretion_price
...
-- Size: Delay To Time
cme_futures_ilink3_sbe_v8_7_size_of.delay_to_time = 8

-- Display: Delay To Time
cme_futures_ilink3_sbe_v8_7_display.delay_to_time = function(value)
...
cme_futures_ilink3_sbe_v8_7_dissect.delay_to_time = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.delay_to_time
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.short_sale_type = 1

-- Display: Short Sale Type
cme_futures_ilink3_sbe_v8_7_display.short_sale_type = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.short_sale_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.short_sale_type
  local range = buffer(offset, length)
...
-- Size: Liquidity Flag
cme_futures_ilink3_sbe_v8_7_size_of.liquidity_flag = 1

-- Display: Liquidity Flag
cme_futures_ilink3_sbe_v8_7_display.liquidity_flag = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.liquidity_flag = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.liquidity_flag
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Split Msg
cme_futures_ilink3_sbe_v8_7_size_of.split_msg = 1

-- Display: Split Msg
cme_futures_ilink3_sbe_v8_7_display.split_msg = function(value)
  if value == 255 then
...
-- Dissect: Split Msg
cme_futures_ilink3_sbe_v8_7_dissect.split_msg = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.split_msg
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.poss_retrans_flag = 1

-- Display: Poss Retrans Flag
cme_futures_ilink3_sbe_v8_7_display.poss_retrans_flag = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.poss_retrans_flag = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.poss_retrans_flag
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator = 1

-- Display: Manual Order Indicator
cme_futures_ilink3_sbe_v8_7_display.manual_order_indicator = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.manual_order_indicator = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Time In Force
cme_futures_ilink3_sbe_v8_7_size_of.time_in_force = 1

-- Display: Time In Force
cme_futures_ilink3_sbe_v8_7_display.time_in_force = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.time_in_force = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.time_in_force
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Side
cme_futures_ilink3_sbe_v8_7_size_of.side = 1

-- Display: Side
cme_futures_ilink3_sbe_v8_7_display.side = function(value)
  if value == 1 then
    return "Side: Buy (1)"
  end
  if value == 2 then
...
-- Dissect: Side
cme_futures_ilink3_sbe_v8_7_dissect.side = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.side
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.ord_type_optional = 1

-- Display: Ord Type Optional
cme_futures_ilink3_sbe_v8_7_display.ord_type_optional = function(value)
  -- Check if field has value
...
cme_futures_ilink3_sbe_v8_7_dissect.ord_type_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_type_optional
  local range = buffer(offset, length)
...
-- Size: Expire Date
cme_futures_ilink3_sbe_v8_7_size_of.expire_date = 2

-- Display: Expire Date
cme_futures_ilink3_sbe_v8_7_display.expire_date = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: Expire Date
cme_futures_ilink3_sbe_v8_7_dissect.expire_date = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.expire_date
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Display Qty
cme_futures_ilink3_sbe_v8_7_size_of.display_qty = 4

-- Display: Display Qty
cme_futures_ilink3_sbe_v8_7_display.display_qty = function(value)
  -- Check if field has value
...
-- Dissect: Display Qty
cme_futures_ilink3_sbe_v8_7_dissect.display_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.display_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Min Qty
cme_futures_ilink3_sbe_v8_7_size_of.min_qty = 4

-- Display: Min Qty
cme_futures_ilink3_sbe_v8_7_display.min_qty = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
-- Dissect: Min Qty
cme_futures_ilink3_sbe_v8_7_dissect.min_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.min_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Leaves
cme_futures_ilink3_sbe_v8_7_size_of.leaves = 4

-- Display: Leaves
cme_futures_ilink3_sbe_v8_7_display.leaves = function(value)
  return "Leaves: "..value
end

-- Dissect: Leaves
cme_futures_ilink3_sbe_v8_7_dissect.leaves = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leaves
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Cum Qty
cme_futures_ilink3_sbe_v8_7_size_of.cum_qty = 4

-- Display: Cum Qty
cme_futures_ilink3_sbe_v8_7_display.cum_qty = function(value)
  return "Cum Qty: "..value
end

-- Dissect: Cum Qty
cme_futures_ilink3_sbe_v8_7_dissect.cum_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cum_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Order Qty
cme_futures_ilink3_sbe_v8_7_size_of.order_qty = 4

-- Display: Order Qty
cme_futures_ilink3_sbe_v8_7_display.order_qty = function(value)
  return "Order Qty: "..value
end

-- Dissect: Order Qty
cme_futures_ilink3_sbe_v8_7_dissect.order_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Security Id
cme_futures_ilink3_sbe_v8_7_size_of.security_id = 4

-- Display: Security Id
cme_futures_ilink3_sbe_v8_7_display.security_id = function(value)
  return "Security Id: "..value
end

-- Dissect: Security Id
cme_futures_ilink3_sbe_v8_7_dissect.security_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_id
  local range = buffer(offset, length)
...
-- Size: Location
cme_futures_ilink3_sbe_v8_7_size_of.location = 5

-- Display: Location
cme_futures_ilink3_sbe_v8_7_display.location = function(value)
  -- Check if field has value
...
-- Dissect: Location
cme_futures_ilink3_sbe_v8_7_dissect.location = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.location
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.order_request_id = 8

-- Display: Order Request Id
cme_futures_ilink3_sbe_v8_7_display.order_request_id = function(value)
  return "Order Request Id: "..value
end

-- Dissect: Order Request Id
cme_futures_ilink3_sbe_v8_7_dissect.order_request_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_request_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch = 8

-- Display: Sending Time Epoch
cme_futures_ilink3_sbe_v8_7_display.sending_time_epoch = function(value)
  return "Sending Time Epoch: "..value
end

-- Dissect: Sending Time Epoch
cme_futures_ilink3_sbe_v8_7_dissect.sending_time_epoch = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Transact Time
cme_futures_ilink3_sbe_v8_7_size_of.transact_time = 8

-- Display: Transact Time
cme_futures_ilink3_sbe_v8_7_display.transact_time = function(value)
  return "Transact Time: "..value
end

-- Dissect: Transact Time
cme_futures_ilink3_sbe_v8_7_dissect.transact_time = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.transact_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Price
cme_futures_ilink3_sbe_v8_7_size_of.price = 8

-- Display: Price
cme_futures_ilink3_sbe_v8_7_display.price = function(value)
  return "Price: "..value
end
...
-- Dissect: Price
cme_futures_ilink3_sbe_v8_7_dissect.price = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.price
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
-- Size: Order Id
cme_futures_ilink3_sbe_v8_7_size_of.order_id = 8

-- Display: Order Id
cme_futures_ilink3_sbe_v8_7_display.order_id = function(value)
  return "Order Id: "..value
end

-- Dissect: Order Id
cme_futures_ilink3_sbe_v8_7_dissect.order_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id = 8

-- Display: Party Details List Req Id
cme_futures_ilink3_sbe_v8_7_display.party_details_list_req_id = function(value)
  return "Party Details List Req Id: "..value
end

-- Dissect: Party Details List Req Id
cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_req_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: ClOrdId
cme_futures_ilink3_sbe_v8_7_size_of.clordid = 20

-- Display: ClOrdId
cme_futures_ilink3_sbe_v8_7_display.clordid = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: ClOrdId
cme_futures_ilink3_sbe_v8_7_dissect.clordid = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.clordid
  local range = buffer(offset, length)
...
-- Size: Sender Id
cme_futures_ilink3_sbe_v8_7_size_of.sender_id = 20

-- Display: Sender Id
cme_futures_ilink3_sbe_v8_7_display.sender_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Sender Id
cme_futures_ilink3_sbe_v8_7_dissect.sender_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.sender_id
  local range = buffer(offset, length)
...
-- Size: Exec Id
cme_futures_ilink3_sbe_v8_7_size_of.exec_id = 40

-- Display: Exec Id
cme_futures_ilink3_sbe_v8_7_display.exec_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Exec Id
cme_futures_ilink3_sbe_v8_7_dissect.exec_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.exec_id
  local range = buffer(offset, length)
...
-- Size: Uuid
cme_futures_ilink3_sbe_v8_7_size_of.uuid = 8

-- Display: Uuid
cme_futures_ilink3_sbe_v8_7_display.uuid = function(value)
  return "Uuid: "..value
end

-- Dissect: Uuid
cme_futures_ilink3_sbe_v8_7_dissect.uuid = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.uuid
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Seq Num
cme_futures_ilink3_sbe_v8_7_size_of.seq_num = 4

-- Display: Seq Num
cme_futures_ilink3_sbe_v8_7_display.seq_num = function(value)
  return "Seq Num: "..value
end

-- Dissect: Seq Num
cme_futures_ilink3_sbe_v8_7_dissect.seq_num = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.seq_num
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_pending_replace = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.seq_num

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.uuid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.exec_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sender_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.clordid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.price

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.transact_time

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_request_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.location

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_qty

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cum_qty

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leaves

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.min_qty

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.display_qty

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.expire_date

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_type_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.side

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.time_in_force

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.poss_retrans_flag

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.split_msg

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.liquidity_flag

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.short_sale_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.delay_to_time

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.discretion_price

  return index
end

-- Display: Execution Report Pending Replace
cme_futures_ilink3_sbe_v8_7_display.execution_report_pending_replace = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Pending Replace
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_replace_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Seq Num: 4 Byte Unsigned Fixed Width Integer
  index, seq_num = cme_futures_ilink3_sbe_v8_7_dissect.seq_num(buffer, index, packet, parent)

  -- Uuid: 8 Byte Unsigned Fixed Width Integer
  index, uuid = cme_futures_ilink3_sbe_v8_7_dissect.uuid(buffer, index, packet, parent)

  -- Exec Id: 40 Byte Ascii String
  index, exec_id = cme_futures_ilink3_sbe_v8_7_dissect.exec_id(buffer, index, packet, parent)

  -- Sender Id: 20 Byte Ascii String
  index, sender_id = cme_futures_ilink3_sbe_v8_7_dissect.sender_id(buffer, index, packet, parent)

  -- ClOrdId: 20 Byte Ascii String
  index, clordid = cme_futures_ilink3_sbe_v8_7_dissect.clordid(buffer, index, packet, parent)

  -- Party Details List Req Id: 8 Byte Unsigned Fixed Width Integer
  index, party_details_list_req_id = cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_req_id(buffer, index, packet, parent)

  -- Order Id: 8 Byte Unsigned Fixed Width Integer
  index, order_id = cme_futures_ilink3_sbe_v8_7_dissect.order_id(buffer, index, packet, parent)

  -- Price: 8 Byte Signed Fixed Width Integer
  index, price = cme_futures_ilink3_sbe_v8_7_dissect.price(buffer, index, packet, parent)

  -- Transact Time: 8 Byte Unsigned Fixed Width Integer
  index, transact_time = cme_futures_ilink3_sbe_v8_7_dissect.transact_time(buffer, index, packet, parent)

  -- Sending Time Epoch: 8 Byte Unsigned Fixed Width Integer
  index, sending_time_epoch = cme_futures_ilink3_sbe_v8_7_dissect.sending_time_epoch(buffer, index, packet, parent)

  -- Order Request Id: 8 Byte Unsigned Fixed Width Integer
  index, order_request_id = cme_futures_ilink3_sbe_v8_7_dissect.order_request_id(buffer, index, packet, parent)

  -- Location: 5 Byte Ascii String
  index, location = cme_futures_ilink3_sbe_v8_7_dissect.location(buffer, index, packet, parent)

  -- Security Id: 4 Byte Signed Fixed Width Integer
  index, security_id = cme_futures_ilink3_sbe_v8_7_dissect.security_id(buffer, index, packet, parent)

  -- Order Qty: 4 Byte Unsigned Fixed Width Integer
  index, order_qty = cme_futures_ilink3_sbe_v8_7_dissect.order_qty(buffer, index, packet, parent)

  -- Cum Qty: 4 Byte Unsigned Fixed Width Integer
  index, cum_qty = cme_futures_ilink3_sbe_v8_7_dissect.cum_qty(buffer, index, packet, parent)

  -- Leaves: 4 Byte Unsigned Fixed Width Integer
  index, leaves = cme_futures_ilink3_sbe_v8_7_dissect.leaves(buffer, index, packet, parent)

  -- Min Qty: 4 Byte Unsigned Fixed Width Integer Nullable
  index, min_qty = cme_futures_ilink3_sbe_v8_7_dissect.min_qty(buffer, index, packet, parent)

  -- Display Qty: 4 Byte Unsigned Fixed Width Integer Nullable
  index, display_qty = cme_futures_ilink3_sbe_v8_7_dissect.display_qty(buffer, index, packet, parent)

  -- Expire Date: 2 Byte Unsigned Fixed Width Integer Nullable
  index, expire_date = cme_futures_ilink3_sbe_v8_7_dissect.expire_date(buffer, index, packet, parent)

  -- Ord Type Optional: 1 Byte Ascii String Enum with 4 values
  index, ord_type_optional = cme_futures_ilink3_sbe_v8_7_dissect.ord_type_optional(buffer, index, packet, parent)

  -- Side: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, side = cme_futures_ilink3_sbe_v8_7_dissect.side(buffer, index, packet, parent)

  -- Time In Force: 1 Byte Unsigned Fixed Width Integer Enum with 7 values
  index, time_in_force = cme_futures_ilink3_sbe_v8_7_dissect.time_in_force(buffer, index, packet, parent)

  -- Manual Order Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, manual_order_indicator = cme_futures_ilink3_sbe_v8_7_dissect.manual_order_indicator(buffer, index, packet, parent)

  -- Poss Retrans Flag: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, poss_retrans_flag = cme_futures_ilink3_sbe_v8_7_dissect.poss_retrans_flag(buffer, index, packet, parent)

  -- Split Msg: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, split_msg = cme_futures_ilink3_sbe_v8_7_dissect.split_msg(buffer, index, packet, parent)

  -- Liquidity Flag: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, liquidity_flag = cme_futures_ilink3_sbe_v8_7_dissect.liquidity_flag(buffer, index, packet, parent)

  -- Short Sale Type: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, short_sale_type = cme_futures_ilink3_sbe_v8_7_dissect.short_sale_type(buffer, index, packet, parent)

  -- Delay To Time: 8 Byte Unsigned Fixed Width Integer Nullable
  index, delay_to_time = cme_futures_ilink3_sbe_v8_7_dissect.delay_to_time(buffer, index, packet, parent)

  -- Discretion Price: 8 Byte Signed Fixed Width Integer Nullable
  index, discretion_price = cme_futures_ilink3_sbe_v8_7_dissect.discretion_price(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_replace = function(buffer, offset, packet, parent)
  if show.execution_report_pending_replace then
    ...
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_pending_replace, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_replace_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_pending_replace(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_replace_fields(buffer, offset, packet, element)
  end
end

-- Size: Leaves Qty Optional
cme_futures_ilink3_sbe_v8_7_size_of.leaves_qty_optional = 4

-- Display: Leaves Qty Optional
cme_futures_ilink3_sbe_v8_7_display.leaves_qty_optional = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
cme_futures_ilink3_sbe_v8_7_dissect.leaves_qty_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leaves_qty_optional
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_pending_cancel = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leaves_qty_optional
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_pending_cancel = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Pending Cancel
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_cancel_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, leaves_qty_optional = cme_futures_ilink3_sbe_v8_7_dissect.leaves_qty_optional(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_cancel = function(buffer, offset, packet, parent)
  if show.execution_report_pending_cancel then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_pending_cancel, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_cancel_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_pending_cancel(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_cancel_fields(buffer, offset, packet, element)
  end
end

-- Size: Quote Error Code
cme_futures_ilink3_sbe_v8_7_size_of.quote_error_code = 2

-- Display: Quote Error Code
cme_futures_ilink3_sbe_v8_7_display.quote_error_code = function(value)
  return "Quote Error Code: "..value
end

-- Dissect: Quote Error Code
cme_futures_ilink3_sbe_v8_7_dissect.quote_error_code = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_error_code
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Quote Set Id
cme_futures_ilink3_sbe_v8_7_size_of.quote_set_id = 2

-- Display: Quote Set Id
cme_futures_ilink3_sbe_v8_7_display.quote_set_id = function(value)
  return "Quote Set Id: "..value
end

-- Dissect: Quote Set Id
cme_futures_ilink3_sbe_v8_7_dissect.quote_set_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_set_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack_set_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_set_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_error_code

  return index
end

-- Display: Quote Cancel Ack Set Group
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_ack_set_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Ack Set Group
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Quote Set Id: 2 Byte Unsigned Fixed Width Integer
  index, quote_set_id = cme_futures_ilink3_sbe_v8_7_dissect.quote_set_id(buffer, index, packet, parent)

  -- Quote Error Code: 2 Byte Unsigned Fixed Width Integer
  index, quote_error_code = cme_futures_ilink3_sbe_v8_7_dissect.quote_error_code(buffer, index, packet, parent)

  return index
end

-- Dissect: Quote Cancel Ack Set Group
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_group = function(buffer, offset, packet, parent)
  if show.quote_cancel_ack_set_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_ack_set_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.quote_cancel_ack_set_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_group_fields(buffer, offset, packet, element)
  end
end

-- Size: Num In Group
cme_futures_ilink3_sbe_v8_7_size_of.num_in_group = 1

-- Display: Num In Group
cme_futures_ilink3_sbe_v8_7_display.num_in_group = function(value)
  return "Num In Group: "..value
end

-- Dissect: Num In Group
cme_futures_ilink3_sbe_v8_7_dissect.num_in_group = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.num_in_group
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Block Length
cme_futures_ilink3_sbe_v8_7_size_of.block_length = 2

-- Display: Block Length
cme_futures_ilink3_sbe_v8_7_display.block_length = function(value)
  return "Block Length: "..value
end

-- Dissect: Block Length
cme_futures_ilink3_sbe_v8_7_dissect.block_length = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.block_length
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.group_size = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.block_length

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.num_in_group

  return index
end

-- Display: Group Size
cme_futures_ilink3_sbe_v8_7_display.group_size = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Group Size
cme_futures_ilink3_sbe_v8_7_dissect.group_size_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Block Length: 2 Byte Unsigned Fixed Width Integer
  index, block_length = cme_futures_ilink3_sbe_v8_7_dissect.block_length(buffer, index, packet, parent)

  -- Num In Group: 1 Byte Unsigned Fixed Width Integer
  index, num_in_group = cme_futures_ilink3_sbe_v8_7_dissect.num_in_group(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.group_size = function(buffer, offset, packet, parent)
  if show.group_size then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.group_size, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.group_size_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.group_size(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.group_size_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Quote Cancel Ack Set Groups
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack_set_groups = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.group_size(buffer, offset + index)
...
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_ack_set_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Ack Set Groups
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_groups_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Group Size: Struct of 2 fields
  index, group_size = cme_futures_ilink3_sbe_v8_7_dissect.group_size(buffer, index, packet, parent)
  ...
  for quote_cancel_ack_set_group_index = 1, num_in_group do
    index, quote_cancel_ack_set_group = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_group(buffer, index, packet, parent)

    if quote_cancel_ack_set_group ~= nil then
      local iteration = quote_cancel_ack_set_group:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_ack_set_group_index, quote_cancel_ack_set_group_index)
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_groups = function(buffer, offset, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_entry_reject_reason = 1

-- Display: Quote Entry Reject Reason
cme_futures_ilink3_sbe_v8_7_display.quote_entry_reject_reason = function(value)
  return "Quote Entry Reject Reason: "..value
end

-- Dissect: Quote Entry Reject Reason
cme_futures_ilink3_sbe_v8_7_dissect.quote_entry_reject_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_entry_reject_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Quote Entry Id
cme_futures_ilink3_sbe_v8_7_size_of.quote_entry_id = 4

-- Display: Quote Entry Id
cme_futures_ilink3_sbe_v8_7_display.quote_entry_id = function(value)
  return "Quote Entry Id: "..value
end

-- Dissect: Quote Entry Id
cme_futures_ilink3_sbe_v8_7_dissect.quote_entry_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_entry_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack_entry_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_entry_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_entry_reject_reason

  return index
end

-- Display: Quote Cancel Ack Entry Group
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_ack_entry_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Ack Entry Group
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Quote Entry Id: 4 Byte Unsigned Fixed Width Integer
  index, quote_entry_id = cme_futures_ilink3_sbe_v8_7_dissect.quote_entry_id(buffer, index, packet, parent)

  -- Security Id: 4 Byte Signed Fixed Width Integer
  index, security_id = cme_futures_ilink3_sbe_v8_7_dissect.security_id(buffer, index, packet, parent)

  -- Quote Entry Reject Reason: 1 Byte Unsigned Fixed Width Integer
  index, quote_entry_reject_reason = cme_futures_ilink3_sbe_v8_7_dissect.quote_entry_reject_reason(buffer, index, packet, parent)

  return index
end

-- Dissect: Quote Cancel Ack Entry Group
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_group = function(buffer, offset, packet, parent)
  if show.quote_cancel_ack_entry_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_ack_entry_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.quote_cancel_ack_entry_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Quote Cancel Ack Entry Groups
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack_entry_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_ack_entry_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Ack Entry Groups
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for quote_cancel_ack_entry_group_index = 1, num_in_group do
    index, quote_cancel_ack_entry_group = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_group(buffer, index, packet, parent)

    if quote_cancel_ack_entry_group ~= nil then
      local iteration = quote_cancel_ack_entry_group:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_ack_entry_group_index, quote_cancel_ack_entry_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.tot_no_quote_entries_optional = 1

-- Display: Tot No Quote Entries Optional
cme_futures_ilink3_sbe_v8_7_display.tot_no_quote_entries_optional = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.tot_no_quote_entries_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.tot_no_quote_entries_optional
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.unsolicited_cancel_type = 1

-- Display: Unsolicited Cancel Type
cme_futures_ilink3_sbe_v8_7_display.unsolicited_cancel_type = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.unsolicited_cancel_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.unsolicited_cancel_type
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.mm_protection_reset = 1

-- Display: Mm Protection Reset
cme_futures_ilink3_sbe_v8_7_display.mm_protection_reset = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mm_protection_reset = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mm_protection_reset
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.no_processed_entries_32 = 4

-- Display: No Processed Entries 32
cme_futures_ilink3_sbe_v8_7_display.no_processed_entries_32 = function(value)
  return "No Processed Entries 32: "..value
end

-- Dissect: No Processed Entries 32
cme_futures_ilink3_sbe_v8_7_dissect.no_processed_entries_32 = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.no_processed_entries_32
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cxl_status = 1

-- Display: Quote Cxl Status
cme_futures_ilink3_sbe_v8_7_display.quote_cxl_status = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cxl_status = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_cxl_status
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Delay Duration
cme_futures_ilink3_sbe_v8_7_size_of.delay_duration = 2

-- Display: Delay Duration
cme_futures_ilink3_sbe_v8_7_display.delay_duration = function(value)
  -- Check if field has value
  if value == 65535 then
...
cme_futures_ilink3_sbe_v8_7_dissect.delay_duration = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.delay_duration
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_reject_reason = 2

-- Display: Quote Reject Reason
cme_futures_ilink3_sbe_v8_7_display.quote_reject_reason = function(value)
  -- Check if field has value
  if value == 65535 then
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_reject_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_reject_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Quote Id
cme_futures_ilink3_sbe_v8_7_size_of.quote_id = 4

-- Display: Quote Id
cme_futures_ilink3_sbe_v8_7_display.quote_id = function(value)
  return "Quote Id: "..value
end

-- Dissect: Quote Id
cme_futures_ilink3_sbe_v8_7_dissect.quote_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.cancelled_symbol = 6

-- Display: Cancelled Symbol
cme_futures_ilink3_sbe_v8_7_display.cancelled_symbol = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.cancelled_symbol = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cancelled_symbol
  local range = buffer(offset, length)
...
-- Size: Request Time
cme_futures_ilink3_sbe_v8_7_size_of.request_time = 8

-- Display: Request Time
cme_futures_ilink3_sbe_v8_7_display.request_time = function(value)
  return "Request Time: "..value
end

-- Dissect: Request Time
cme_futures_ilink3_sbe_v8_7_dissect.request_time = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.request_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Text
cme_futures_ilink3_sbe_v8_7_size_of.text = 256

-- Display: Text
cme_futures_ilink3_sbe_v8_7_display.text = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Text
cme_futures_ilink3_sbe_v8_7_dissect.text = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.text
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.text

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sender_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.request_time

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cancelled_symbol

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.location

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_reject_reason

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.delay_duration

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_cxl_status

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.no_processed_entries_32

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mm_protection_reset

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.unsolicited_cancel_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.split_msg

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.tot_no_quote_entries_optional
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack_entry_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack_set_groups(buffer, offset + index)

  return index
end

-- Display: Quote Cancel Ack
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_ack = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Ack
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, text = cme_futures_ilink3_sbe_v8_7_dissect.text(buffer, index, packet, parent)
  ...
  index, request_time = cme_futures_ilink3_sbe_v8_7_dissect.request_time(buffer, index, packet, parent)

  -- Sending Time Epoch: 8 Byte Unsigned Fixed Width Integer
  index, sending_time_epoch = cme_futures_ilink3_sbe_v8_7_dissect.sending_time_epoch(buffer, index, packet, parent)

  -- Cancelled Symbol: 6 Byte Ascii String
  index, cancelled_symbol = cme_futures_ilink3_sbe_v8_7_dissect.cancelled_symbol(buffer, index, packet, parent)

  -- Location: 5 Byte Ascii String
  index, location = cme_futures_ilink3_sbe_v8_7_dissect.location(buffer, index, packet, parent)

  -- Quote Id: 4 Byte Unsigned Fixed Width Integer
  index, quote_id = cme_futures_ilink3_sbe_v8_7_dissect.quote_id(buffer, index, packet, parent)

  -- Quote Reject Reason: 2 Byte Unsigned Fixed Width Integer Nullable
  index, quote_reject_reason = cme_futures_ilink3_sbe_v8_7_dissect.quote_reject_reason(buffer, index, packet, parent)

  -- Delay Duration: 2 Byte Unsigned Fixed Width Integer Nullable
  index, delay_duration = cme_futures_ilink3_sbe_v8_7_dissect.delay_duration(buffer, index, packet, parent)

  -- Manual Order Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, manual_order_indicator = cme_futures_ilink3_sbe_v8_7_dissect.manual_order_indicator(buffer, index, packet, parent)

  -- Quote Cxl Status: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, quote_cxl_status = cme_futures_ilink3_sbe_v8_7_dissect.quote_cxl_status(buffer, index, packet, parent)

  -- No Processed Entries 32: 4 Byte Unsigned Fixed Width Integer
  index, no_processed_entries_32 = cme_futures_ilink3_sbe_v8_7_dissect.no_processed_entries_32(buffer, index, packet, parent)

  -- Mm Protection Reset: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, mm_protection_reset = cme_futures_ilink3_sbe_v8_7_dissect.mm_protection_reset(buffer, index, packet, parent)

  -- Unsolicited Cancel Type: 1 Byte Ascii String Nullable
  index, unsolicited_cancel_type = cme_futures_ilink3_sbe_v8_7_dissect.unsolicited_cancel_type(buffer, index, packet, parent)

  -- Split Msg: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, split_msg = cme_futures_ilink3_sbe_v8_7_dissect.split_msg(buffer, index, packet, parent)

  -- Tot No Quote Entries Optional: 1 Byte Unsigned Fixed Width Integer Nullable
  index, tot_no_quote_entries_optional = cme_futures_ilink3_sbe_v8_7_dissect.tot_no_quote_entries_optional(buffer, index, packet, parent)
  ...
  index, quote_cancel_ack_entry_groups = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_entry_groups(buffer, index, packet, parent)

  -- Quote Cancel Ack Set Groups: Struct of 2 fields
  index, quote_cancel_ack_set_groups = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack_set_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Quote Cancel Ack
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Cxl Quantity
cme_futures_ilink3_sbe_v8_7_size_of.cxl_quantity = 4

-- Display: Cxl Quantity
cme_futures_ilink3_sbe_v8_7_display.cxl_quantity = function(value)
  return "Cxl Quantity: "..value
end

-- Dissect: Cxl Quantity
cme_futures_ilink3_sbe_v8_7_dissect.cxl_quantity = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cxl_quantity
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.affected_order_id = 8

-- Display: Affected Order Id
cme_futures_ilink3_sbe_v8_7_display.affected_order_id = function(value)
  return "Affected Order Id: "..value
end

-- Dissect: Affected Order Id
cme_futures_ilink3_sbe_v8_7_dissect.affected_order_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.affected_order_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: OrigClOrdId
cme_futures_ilink3_sbe_v8_7_size_of.origclordid = 20

-- Display: OrigClOrdId
cme_futures_ilink3_sbe_v8_7_display.origclordid = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: OrigClOrdId
cme_futures_ilink3_sbe_v8_7_dissect.origclordid = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.origclordid
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.affected_orders_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.origclordid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.affected_order_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cxl_quantity

  return index
end

-- Display: Affected Orders Group
cme_futures_ilink3_sbe_v8_7_display.affected_orders_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Affected Orders Group
cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- OrigClOrdId: 20 Byte Ascii String
  index, origclordid = cme_futures_ilink3_sbe_v8_7_dissect.origclordid(buffer, index, packet, parent)

  -- Affected Order Id: 8 Byte Unsigned Fixed Width Integer
  index, affected_order_id = cme_futures_ilink3_sbe_v8_7_dissect.affected_order_id(buffer, index, packet, parent)

  -- Cxl Quantity: 4 Byte Unsigned Fixed Width Integer
  index, cxl_quantity = cme_futures_ilink3_sbe_v8_7_dissect.cxl_quantity(buffer, index, packet, parent)

  return index
end

-- Dissect: Affected Orders Group
cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_group = function(buffer, offset, packet, parent)
  if show.affected_orders_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.affected_orders_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.affected_orders_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Affected Orders Groups
cme_futures_ilink3_sbe_v8_7_size_of.affected_orders_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.affected_orders_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Affected Orders Groups
cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for affected_orders_group_index = 1, num_in_group do
    index, affected_orders_group = cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_group(buffer, index, packet, parent)

    if affected_orders_group ~= nil then
      local iteration = affected_orders_group:add(cme_futures_ilink3_sbe_v8_7.fields.affected_orders_group_index, affected_orders_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_cancel_tif = 1

-- Display: Mass Cancel Tif
cme_futures_ilink3_sbe_v8_7_display.mass_cancel_tif = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_cancel_tif = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_cancel_tif
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_action_ord_typ = 1

-- Display: Mass Action Ord Typ
cme_futures_ilink3_sbe_v8_7_display.mass_action_ord_typ = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_action_ord_typ = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_action_ord_typ
  local range = buffer(offset, length)
...
-- Size: Side Optional
cme_futures_ilink3_sbe_v8_7_size_of.side_optional = 1

-- Display: Side Optional
cme_futures_ilink3_sbe_v8_7_display.side_optional = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.side_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.side_optional
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_cancel_request_type = 1

-- Display: Mass Cancel Request Type
cme_futures_ilink3_sbe_v8_7_display.mass_cancel_request_type = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_cancel_request_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_cancel_request_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.market_segment_id = 1

-- Display: Market Segment Id
cme_futures_ilink3_sbe_v8_7_display.market_segment_id = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.market_segment_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.market_segment_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_action_reject_reason = 1

-- Display: Mass Action Reject Reason
cme_futures_ilink3_sbe_v8_7_display.mass_action_reject_reason = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_action_reject_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_action_reject_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Last Fragment
cme_futures_ilink3_sbe_v8_7_size_of.last_fragment = 1

-- Display: Last Fragment
cme_futures_ilink3_sbe_v8_7_display.last_fragment = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.last_fragment = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.last_fragment
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.total_affected_orders = 4

-- Display: Total Affected Orders
cme_futures_ilink3_sbe_v8_7_display.total_affected_orders = function(value)
  return "Total Affected Orders: "..value
end

-- Dissect: Total Affected Orders
cme_futures_ilink3_sbe_v8_7_dissect.total_affected_orders = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.total_affected_orders
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_action_scope = 1

-- Display: Mass Action Scope
cme_futures_ilink3_sbe_v8_7_display.mass_action_scope = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_action_scope = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_action_scope
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_action_response = 1

-- Display: Mass Action Response
cme_futures_ilink3_sbe_v8_7_display.mass_action_response = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_action_response = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_action_response
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.security_id_optional = 4

-- Display: Security Id Optional
cme_futures_ilink3_sbe_v8_7_display.security_id_optional = function(value)
  -- Check if field has value
...
cme_futures_ilink3_sbe_v8_7_dissect.security_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_id_optional
  local range = buffer(offset, length)
  local value = range:le_int()
...
-- Size: Security Group
cme_futures_ilink3_sbe_v8_7_size_of.security_group = 6

-- Display: Security Group
cme_futures_ilink3_sbe_v8_7_display.security_group = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.security_group = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_group
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_action_report_id = 8

-- Display: Mass Action Report Id
cme_futures_ilink3_sbe_v8_7_display.mass_action_report_id = function(value)
  return "Mass Action Report Id: "..value
end

-- Dissect: Mass Action Report Id
cme_futures_ilink3_sbe_v8_7_dissect.mass_action_report_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_action_report_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_mass_action_report = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_action_report_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_group

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.location

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_id_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.delay_duration

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_action_response

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_action_scope

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.total_affected_orders

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.last_fragment

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_action_reject_reason

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.market_segment_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_cancel_request_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.side_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_action_ord_typ

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_cancel_tif
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.affected_orders_groups(buffer, offset + index)

  return index
end

-- Display: Order Mass Action Report
cme_futures_ilink3_sbe_v8_7_display.order_mass_action_report = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Mass Action Report
cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_report_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, mass_action_report_id = cme_futures_ilink3_sbe_v8_7_dissect.mass_action_report_id(buffer, index, packet, parent)

  -- Security Group: 6 Byte Ascii String
  index, security_group = cme_futures_ilink3_sbe_v8_7_dissect.security_group(buffer, index, packet, parent)

  -- Location: 5 Byte Ascii String
  index, location = cme_futures_ilink3_sbe_v8_7_dissect.location(buffer, index, packet, parent)

  -- Security Id Optional: 4 Byte Signed Fixed Width Integer Nullable
  index, security_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.security_id_optional(buffer, index, packet, parent)

  -- Delay Duration: 2 Byte Unsigned Fixed Width Integer Nullable
  index, delay_duration = cme_futures_ilink3_sbe_v8_7_dissect.delay_duration(buffer, index, packet, parent)

  -- Mass Action Response: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, mass_action_response = cme_futures_ilink3_sbe_v8_7_dissect.mass_action_response(buffer, index, packet, parent)

  -- Manual Order Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, manual_order_indicator = cme_futures_ilink3_sbe_v8_7_dissect.manual_order_indicator(buffer, index, packet, parent)

  -- Mass Action Scope: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, mass_action_scope = cme_futures_ilink3_sbe_v8_7_dissect.mass_action_scope(buffer, index, packet, parent)

  -- Total Affected Orders: 4 Byte Unsigned Fixed Width Integer
  index, total_affected_orders = cme_futures_ilink3_sbe_v8_7_dissect.total_affected_orders(buffer, index, packet, parent)

  -- Last Fragment: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, last_fragment = cme_futures_ilink3_sbe_v8_7_dissect.last_fragment(buffer, index, packet, parent)

  -- Mass Action Reject Reason: 1 Byte Unsigned Fixed Width Integer Nullable
  index, mass_action_reject_reason = cme_futures_ilink3_sbe_v8_7_dissect.mass_action_reject_reason(buffer, index, packet, parent)

  -- Market Segment Id: 1 Byte Unsigned Fixed Width Integer Nullable
  index, market_segment_id = cme_futures_ilink3_sbe_v8_7_dissect.market_segment_id(buffer, index, packet, parent)

  -- Mass Cancel Request Type: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, mass_cancel_request_type = cme_futures_ilink3_sbe_v8_7_dissect.mass_cancel_request_type(buffer, index, packet, parent)

  -- Side Optional: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, side_optional = cme_futures_ilink3_sbe_v8_7_dissect.side_optional(buffer, index, packet, parent)

  -- Mass Action Ord Typ: 1 Byte Ascii String Enum with 2 values
  index, mass_action_ord_typ = cme_futures_ilink3_sbe_v8_7_dissect.mass_action_ord_typ(buffer, index, packet, parent)

  -- Mass Cancel Tif: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, mass_cancel_tif = cme_futures_ilink3_sbe_v8_7_dissect.mass_cancel_tif(buffer, index, packet, parent)
  ...
  index, affected_orders_groups = cme_futures_ilink3_sbe_v8_7_dissect.affected_orders_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Order Mass Action Report
cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_report = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Leg Ratio Qty
cme_futures_ilink3_sbe_v8_7_size_of.leg_ratio_qty = 1

-- Display: Leg Ratio Qty
cme_futures_ilink3_sbe_v8_7_display.leg_ratio_qty = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_ratio_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Leg Side
cme_futures_ilink3_sbe_v8_7_size_of.leg_side = 1

-- Display: Leg Side
cme_futures_ilink3_sbe_v8_7_display.leg_side = function(value)
  if value == 1 then
...
-- Dissect: Leg Side
cme_futures_ilink3_sbe_v8_7_dissect.leg_side = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_side
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.leg_security_id = 4

-- Display: Leg Security Id
cme_futures_ilink3_sbe_v8_7_display.leg_security_id = function(value)
  return "Leg Security Id: "..value
end

-- Dissect: Leg Security Id
cme_futures_ilink3_sbe_v8_7_dissect.leg_security_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_security_id
  local range = buffer(offset, length)
  local value = range:le_int()
...
-- Size: Exponent
cme_futures_ilink3_sbe_v8_7_size_of.exponent = 1

-- Display: Exponent
cme_futures_ilink3_sbe_v8_7_display.exponent = function(value)
  -- Check if field has value
  if value == 127 then
...
-- Dissect: Exponent
cme_futures_ilink3_sbe_v8_7_dissect.exponent = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.exponent
  local range = buffer(offset, length)
  local value = range:le_int()
...
-- Size: Mantissa 32
cme_futures_ilink3_sbe_v8_7_size_of.mantissa_32 = 4

-- Display: Mantissa 32
cme_futures_ilink3_sbe_v8_7_display.mantissa_32 = function(value)
  -- Check if field has value
  if value == 2147483647 then
...
-- Dissect: Mantissa 32
cme_futures_ilink3_sbe_v8_7_dissect.mantissa_32 = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mantissa_32
  local range = buffer(offset, length)
  local value = range:le_int()
...
cme_futures_ilink3_sbe_v8_7_size_of.leg_option_delta = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mantissa_32

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.exponent

  return index
end

-- Display: Leg Option Delta
cme_futures_ilink3_sbe_v8_7_display.leg_option_delta = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Leg Option Delta
cme_futures_ilink3_sbe_v8_7_dissect.leg_option_delta_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Mantissa 32: 4 Byte Signed Fixed Width Integer Nullable
  index, mantissa_32 = cme_futures_ilink3_sbe_v8_7_dissect.mantissa_32(buffer, index, packet, parent)

  -- Exponent: 1 Byte Signed Fixed Width Integer Nullable
  index, exponent = cme_futures_ilink3_sbe_v8_7_dissect.exponent(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.leg_option_delta = function(buffer, offset, packet, parent)
  if show.leg_option_delta then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.leg_option_delta, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.leg_option_delta_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.leg_option_delta(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.leg_option_delta_fields(buffer, offset, packet, element)
  end
end

-- Size: Leg Price
cme_futures_ilink3_sbe_v8_7_size_of.leg_price = 8

-- Display: Leg Price
cme_futures_ilink3_sbe_v8_7_display.leg_price = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
-- Dissect: Leg Price
cme_futures_ilink3_sbe_v8_7_dissect.leg_price = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_price
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.security_definition_response_leg_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_price

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_option_delta(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_security_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_side

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_ratio_qty

  return index
end

-- Display: Security Definition Response Leg Group
cme_futures_ilink3_sbe_v8_7_display.security_definition_response_leg_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Response Leg Group
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Leg Price: 8 Byte Signed Fixed Width Integer Nullable
  index, leg_price = cme_futures_ilink3_sbe_v8_7_dissect.leg_price(buffer, index, packet, parent)

  -- Leg Option Delta: Struct of 2 fields
  index, leg_option_delta = cme_futures_ilink3_sbe_v8_7_dissect.leg_option_delta(buffer, index, packet, parent)

  -- Leg Security Id: 4 Byte Signed Fixed Width Integer
  index, leg_security_id = cme_futures_ilink3_sbe_v8_7_dissect.leg_security_id(buffer, index, packet, parent)

  -- Leg Side: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, leg_side = cme_futures_ilink3_sbe_v8_7_dissect.leg_side(buffer, index, packet, parent)

  -- Leg Ratio Qty: 1 Byte Unsigned Fixed Width Integer Nullable
  index, leg_ratio_qty = cme_futures_ilink3_sbe_v8_7_dissect.leg_ratio_qty(buffer, index, packet, parent)

  return index
end

-- Dissect: Security Definition Response Leg Group
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_group = function(buffer, offset, packet, parent)
  if show.security_definition_response_leg_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.security_definition_response_leg_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.security_definition_response_leg_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Security Definition Response Leg Groups
cme_futures_ilink3_sbe_v8_7_size_of.security_definition_response_leg_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.security_definition_response_leg_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Response Leg Groups
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for security_definition_response_leg_group_index = 1, num_in_group do
    index, security_definition_response_leg_group = cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_group(buffer, index, packet, parent)

    if security_definition_response_leg_group ~= nil then
      local iteration = security_definition_response_leg_group:add(cme_futures_ilink3_sbe_v8_7.fields.security_definition_response_leg_group_index, security_definition_response_leg_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.auto_quote_request = 1

-- Display: Auto Quote Request
cme_futures_ilink3_sbe_v8_7_display.auto_quote_request = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.auto_quote_request = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.auto_quote_request
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.expiration_cycle = 1

-- Display: Expiration Cycle
cme_futures_ilink3_sbe_v8_7_display.expiration_cycle = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.expiration_cycle = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.expiration_cycle
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.security_response_type = 1

-- Display: Security Response Type
cme_futures_ilink3_sbe_v8_7_display.security_response_type = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.security_response_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_response_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.termination_type = 8

-- Display: Termination Type
cme_futures_ilink3_sbe_v8_7_display.termination_type = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.termination_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.termination_type
  local range = buffer(offset, length)
...
-- Size: Source Repo Id
cme_futures_ilink3_sbe_v8_7_size_of.source_repo_id = 4

-- Display: Source Repo Id
cme_futures_ilink3_sbe_v8_7_display.source_repo_id = function(value)
  -- Check if field has value
  if value == 2147483647 then
...
cme_futures_ilink3_sbe_v8_7_dissect.source_repo_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.source_repo_id
  local range = buffer(offset, length)
  local value = range:le_int()
...
cme_futures_ilink3_sbe_v8_7_size_of.max_no_of_substitutions = 1

-- Display: Max No Of Substitutions
cme_futures_ilink3_sbe_v8_7_display.max_no_of_substitutions = function(value)
  -- Check if field has value
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.max_no_of_substitutions = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.max_no_of_substitutions
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: End Date
cme_futures_ilink3_sbe_v8_7_size_of.end_date = 2

-- Display: End Date
cme_futures_ilink3_sbe_v8_7_display.end_date = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: End Date
cme_futures_ilink3_sbe_v8_7_dissect.end_date = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.end_date
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Start Date
cme_futures_ilink3_sbe_v8_7_size_of.start_date = 2

-- Display: Start Date
cme_futures_ilink3_sbe_v8_7_display.start_date = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: Start Date
cme_futures_ilink3_sbe_v8_7_dissect.start_date = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.start_date
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Week
cme_futures_ilink3_sbe_v8_7_size_of.week = 1

-- Display: Week
cme_futures_ilink3_sbe_v8_7_display.week = function(value)
  -- Check if field has value
  if value == 255 then
...
-- Dissect: Week
cme_futures_ilink3_sbe_v8_7_dissect.week = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.week
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Day
cme_futures_ilink3_sbe_v8_7_size_of.day = 1

-- Display: Day
cme_futures_ilink3_sbe_v8_7_display.day = function(value)
  -- Check if field has value
  if value == 255 then
    return "Day: No Value"
  end
...
-- Dissect: Day
cme_futures_ilink3_sbe_v8_7_dissect.day = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.day
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Month
cme_futures_ilink3_sbe_v8_7_size_of.month = 1

-- Display: Month
cme_futures_ilink3_sbe_v8_7_display.month = function(value)
  -- Check if field has value
  if value == 255 then
...
-- Dissect: Month
cme_futures_ilink3_sbe_v8_7_dissect.month = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.month
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Year
cme_futures_ilink3_sbe_v8_7_size_of.year = 2

-- Display: Year
cme_futures_ilink3_sbe_v8_7_display.year = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: Year
cme_futures_ilink3_sbe_v8_7_dissect.year = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.year
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.maturity_month_year = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.year

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.month

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.day

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.week

  return index
end

-- Display: Maturity Month Year
cme_futures_ilink3_sbe_v8_7_display.maturity_month_year = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Maturity Month Year
cme_futures_ilink3_sbe_v8_7_dissect.maturity_month_year_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Year: 2 Byte Unsigned Fixed Width Integer Nullable
  index, year = cme_futures_ilink3_sbe_v8_7_dissect.year(buffer, index, packet, parent)

  -- Month: 1 Byte Unsigned Fixed Width Integer Nullable
  index, month = cme_futures_ilink3_sbe_v8_7_dissect.month(buffer, index, packet, parent)

  -- Day: 1 Byte Unsigned Fixed Width Integer Nullable
  index, day = cme_futures_ilink3_sbe_v8_7_dissect.day(buffer, index, packet, parent)

  -- Week: 1 Byte Unsigned Fixed Width Integer Nullable
  index, week = cme_futures_ilink3_sbe_v8_7_dissect.week(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.maturity_month_year = function(buffer, offset, packet, parent)
  if show.maturity_month_year then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.maturity_month_year, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.maturity_month_year_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.maturity_month_year(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.maturity_month_year_fields(buffer, offset, packet, element)
  end
end

-- Size: Currency
cme_futures_ilink3_sbe_v8_7_size_of.currency = 3

-- Display: Currency
cme_futures_ilink3_sbe_v8_7_display.currency = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Currency
cme_futures_ilink3_sbe_v8_7_dissect.currency = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.currency
  local range = buffer(offset, length)
...
-- Size: Security Type
cme_futures_ilink3_sbe_v8_7_size_of.security_type = 6

-- Display: Security Type
cme_futures_ilink3_sbe_v8_7_display.security_type = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.security_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_type
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.security_response_id = 8

-- Display: Security Response Id
cme_futures_ilink3_sbe_v8_7_display.security_response_id = function(value)
  return "Security Response Id: "..value
end

-- Dissect: Security Response Id
cme_futures_ilink3_sbe_v8_7_dissect.security_response_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_response_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.security_req_id = 8

-- Display: Security Req Id
cme_futures_ilink3_sbe_v8_7_display.security_req_id = function(value)
  return "Security Req Id: "..value
end

-- Dissect: Security Req Id
cme_futures_ilink3_sbe_v8_7_dissect.security_req_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_req_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Symbol
cme_futures_ilink3_sbe_v8_7_size_of.symbol = 20

-- Display: Symbol
cme_futures_ilink3_sbe_v8_7_display.symbol = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Symbol
cme_futures_ilink3_sbe_v8_7_dissect.symbol = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.symbol
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.financial_instrument_full_name = 35

-- Display: Financial Instrument Full Name
cme_futures_ilink3_sbe_v8_7_display.financial_instrument_full_name = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.financial_instrument_full_name = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.financial_instrument_full_name
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.security_definition_response = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.financial_instrument_full_name

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sender_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.symbol

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_req_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_response_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_group

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.location

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_id_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.currency

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.maturity_month_year(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.delay_duration

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.start_date

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.end_date

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.max_no_of_substitutions

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.source_repo_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.termination_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_response_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.expiration_cycle

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.split_msg

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.auto_quote_request

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.poss_retrans_flag

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_definition_response_leg_groups(buffer, offset + index)

  return index
end

-- Display: Security Definition Response
cme_futures_ilink3_sbe_v8_7_display.security_definition_response = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Response
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, financial_instrument_full_name = cme_futures_ilink3_sbe_v8_7_dissect.financial_instrument_full_name(buffer, index, packet, parent)

  -- Sender Id: 20 Byte Ascii String
  index, sender_id = cme_futures_ilink3_sbe_v8_7_dissect.sender_id(buffer, index, packet, parent)

  -- Symbol: 20 Byte Ascii String
  index, symbol = cme_futures_ilink3_sbe_v8_7_dissect.symbol(buffer, index, packet, parent)

  -- Party Details List Req Id: 8 Byte Unsigned Fixed Width Integer
  index, party_details_list_req_id = cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_req_id(buffer, index, packet, parent)

  -- Security Req Id: 8 Byte Unsigned Fixed Width Integer
  index, security_req_id = cme_futures_ilink3_sbe_v8_7_dissect.security_req_id(buffer, index, packet, parent)

  -- Security Response Id: 8 Byte Unsigned Fixed Width Integer
  index, security_response_id = cme_futures_ilink3_sbe_v8_7_dissect.security_response_id(buffer, index, packet, parent)
  ...
  index, security_type = cme_futures_ilink3_sbe_v8_7_dissect.security_type(buffer, index, packet, parent)
  ...
  index, currency = cme_futures_ilink3_sbe_v8_7_dissect.currency(buffer, index, packet, parent)

  -- Maturity Month Year: Struct of 4 fields
  index, maturity_month_year = cme_futures_ilink3_sbe_v8_7_dissect.maturity_month_year(buffer, index, packet, parent)

  -- Delay Duration: 2 Byte Unsigned Fixed Width Integer Nullable
  index, delay_duration = cme_futures_ilink3_sbe_v8_7_dissect.delay_duration(buffer, index, packet, parent)

  -- Start Date: 2 Byte Unsigned Fixed Width Integer Nullable
  index, start_date = cme_futures_ilink3_sbe_v8_7_dissect.start_date(buffer, index, packet, parent)

  -- End Date: 2 Byte Unsigned Fixed Width Integer Nullable
  index, end_date = cme_futures_ilink3_sbe_v8_7_dissect.end_date(buffer, index, packet, parent)

  -- Max No Of Substitutions: 1 Byte Unsigned Fixed Width Integer Nullable
  index, max_no_of_substitutions = cme_futures_ilink3_sbe_v8_7_dissect.max_no_of_substitutions(buffer, index, packet, parent)

  -- Source Repo Id: 4 Byte Signed Fixed Width Integer Nullable
  index, source_repo_id = cme_futures_ilink3_sbe_v8_7_dissect.source_repo_id(buffer, index, packet, parent)

  -- Termination Type: 8 Byte Ascii String
  index, termination_type = cme_futures_ilink3_sbe_v8_7_dissect.termination_type(buffer, index, packet, parent)

  -- Security Response Type: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, security_response_type = cme_futures_ilink3_sbe_v8_7_dissect.security_response_type(buffer, index, packet, parent)

  -- Expiration Cycle: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, expiration_cycle = cme_futures_ilink3_sbe_v8_7_dissect.expiration_cycle(buffer, index, packet, parent)
  ...
  index, auto_quote_request = cme_futures_ilink3_sbe_v8_7_dissect.auto_quote_request(buffer, index, packet, parent)

  -- Poss Retrans Flag: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, poss_retrans_flag = cme_futures_ilink3_sbe_v8_7_dissect.poss_retrans_flag(buffer, index, packet, parent)

  -- Security Definition Response Leg Groups: Struct of 2 fields
  index, security_definition_response_leg_groups = cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response_leg_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Security Definition Response
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.security_definition_request_leg_group = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.security_definition_request_leg_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Request Leg Group
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_group = function(buffer, offset, packet, parent)
  if show.security_definition_request_leg_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.security_definition_request_leg_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.security_definition_request_leg_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Security Definition Request Leg Groups
cme_futures_ilink3_sbe_v8_7_size_of.security_definition_request_leg_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.security_definition_request_leg_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Request Leg Groups
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for security_definition_request_leg_group_index = 1, num_in_group do
    index, security_definition_request_leg_group = cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_group(buffer, index, packet, parent)

    if security_definition_request_leg_group ~= nil then
      local iteration = security_definition_request_leg_group:add(cme_futures_ilink3_sbe_v8_7.fields.security_definition_request_leg_group_index, security_definition_request_leg_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.security_sub_type = 8

-- Display: Security Sub Type
cme_futures_ilink3_sbe_v8_7_display.security_sub_type = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.security_sub_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.security_sub_type
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.sender_id_optional = 20

-- Display: Sender Id Optional
cme_futures_ilink3_sbe_v8_7_display.sender_id_optional = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.sender_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.sender_id_optional
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.security_definition_request = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sender_id_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_sub_type
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_definition_request_leg_groups(buffer, offset + index)

  return index
end

-- Display: Security Definition Request
cme_futures_ilink3_sbe_v8_7_display.security_definition_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Definition Request
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, sender_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.sender_id_optional(buffer, index, packet, parent)

  -- Sending Time Epoch: 8 Byte Unsigned Fixed Width Integer
  index, sending_time_epoch = cme_futures_ilink3_sbe_v8_7_dissect.sending_time_epoch(buffer, index, packet, parent)

  -- Security Sub Type: 8 Byte Ascii String
  index, security_sub_type = cme_futures_ilink3_sbe_v8_7_dissect.security_sub_type(buffer, index, packet, parent)
  ...
  index, security_definition_request_leg_groups = cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request_leg_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Security Definition Request
cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.original_order_event_exec_id = 4

-- Display: Original Order Event Exec Id
cme_futures_ilink3_sbe_v8_7_display.original_order_event_exec_id = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
cme_futures_ilink3_sbe_v8_7_dissect.original_order_event_exec_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.original_order_event_exec_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_event_reason = 1

-- Display: Order Event Reason
cme_futures_ilink3_sbe_v8_7_display.order_event_reason = function(value)
  return "Order Event Reason: "..value
end

-- Dissect: Order Event Reason
cme_futures_ilink3_sbe_v8_7_dissect.order_event_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_event_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Trade Addendum
cme_futures_ilink3_sbe_v8_7_size_of.trade_addendum = 1

-- Display: Trade Addendum
cme_futures_ilink3_sbe_v8_7_display.trade_addendum = function(value)
  if value == 4 then
...
cme_futures_ilink3_sbe_v8_7_dissect.trade_addendum = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trade_addendum
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_event_qty = 4

-- Display: Order Event Qty
cme_futures_ilink3_sbe_v8_7_display.order_event_qty = function(value)
  return "Order Event Qty: "..value
end

-- Dissect: Order Event Qty
cme_futures_ilink3_sbe_v8_7_dissect.order_event_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_event_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_event_exec_id = 4

-- Display: Order Event Exec Id
cme_futures_ilink3_sbe_v8_7_display.order_event_exec_id = function(value)
  return "Order Event Exec Id: "..value
end

-- Dissect: Order Event Exec Id
cme_futures_ilink3_sbe_v8_7_dissect.order_event_exec_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_event_exec_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_event_text = 5

-- Display: Order Event Text
cme_futures_ilink3_sbe_v8_7_display.order_event_text = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.order_event_text = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_event_text
  local range = buffer(offset, length)
...
-- Size: Order Event Px
cme_futures_ilink3_sbe_v8_7_size_of.order_event_px = 8

-- Display: Order Event Px
cme_futures_ilink3_sbe_v8_7_display.order_event_px = function(value)
...
cme_futures_ilink3_sbe_v8_7_dissect.order_event_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_event_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg_order_event_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_event_px

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_event_text

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_event_exec_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_event_qty

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trade_addendum

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_event_reason

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.original_order_event_exec_id

  return index
end

-- Display: Execution Report Trade Addendum Spread Leg Order Event Group
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_leg_order_event_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread Leg Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Order Event Px: 8 Byte Signed Fixed Width Integer
  index, order_event_px = cme_futures_ilink3_sbe_v8_7_dissect.order_event_px(buffer, index, packet, parent)

  -- Order Event Text: 5 Byte Ascii String
  index, order_event_text = cme_futures_ilink3_sbe_v8_7_dissect.order_event_text(buffer, index, packet, parent)

  -- Order Event Exec Id: 4 Byte Unsigned Fixed Width Integer
  index, order_event_exec_id = cme_futures_ilink3_sbe_v8_7_dissect.order_event_exec_id(buffer, index, packet, parent)

  -- Order Event Qty: 4 Byte Unsigned Fixed Width Integer
  index, order_event_qty = cme_futures_ilink3_sbe_v8_7_dissect.order_event_qty(buffer, index, packet, parent)

  -- Trade Addendum: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, trade_addendum = cme_futures_ilink3_sbe_v8_7_dissect.trade_addendum(buffer, index, packet, parent)

  -- Order Event Reason: 1 Byte Unsigned Fixed Width Integer
  index, order_event_reason = cme_futures_ilink3_sbe_v8_7_dissect.order_event_reason(buffer, index, packet, parent)

  -- Original Order Event Exec Id: 4 Byte Unsigned Fixed Width Integer Nullable
  index, original_order_event_exec_id = cme_futures_ilink3_sbe_v8_7_dissect.original_order_event_exec_id(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Addendum Spread Leg Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_addendum_spread_leg_order_event_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_spread_leg_order_event_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_leg_order_event_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Addendum Spread Leg Order Event Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg_order_event_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_leg_order_event_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread Leg Order Event Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_addendum_spread_leg_order_event_group_index = 1, num_in_group do
    index, execution_report_trade_addendum_spread_leg_order_event_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_group(buffer, index, packet, parent)

    if execution_report_trade_addendum_spread_leg_order_event_group ~= nil then
      local iteration = execution_report_trade_addendum_spread_leg_order_event_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_spread_leg_order_event_group_index, execution_report_trade_addendum_spread_leg_order_event_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.fill_yield_type = 1

-- Display: Fill Yield Type
cme_futures_ilink3_sbe_v8_7_display.fill_yield_type = function(value)
  return "Fill Yield Type: "..value
end

-- Dissect: Fill Yield Type
cme_futures_ilink3_sbe_v8_7_dissect.fill_yield_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.fill_yield_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Fill Exec Id
cme_futures_ilink3_sbe_v8_7_size_of.fill_exec_id = 2

-- Display: Fill Exec Id
cme_futures_ilink3_sbe_v8_7_display.fill_exec_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.fill_exec_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.fill_exec_id
  local range = buffer(offset, length)
...
-- Size: Fill Qty
cme_futures_ilink3_sbe_v8_7_size_of.fill_qty = 4

-- Display: Fill Qty
cme_futures_ilink3_sbe_v8_7_display.fill_qty = function(value)
  return "Fill Qty: "..value
end

-- Dissect: Fill Qty
cme_futures_ilink3_sbe_v8_7_dissect.fill_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.fill_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Fill Px
cme_futures_ilink3_sbe_v8_7_size_of.fill_px = 8

-- Display: Fill Px
cme_futures_ilink3_sbe_v8_7_display.fill_px = function(value)
...
-- Dissect: Fill Px
cme_futures_ilink3_sbe_v8_7_dissect.fill_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.fill_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.fills_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fill_px

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fill_qty

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fill_exec_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fill_yield_type

  return index
end

-- Display: Fills Group
cme_futures_ilink3_sbe_v8_7_display.fills_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fills Group
cme_futures_ilink3_sbe_v8_7_dissect.fills_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Fill Px: 8 Byte Signed Fixed Width Integer
  index, fill_px = cme_futures_ilink3_sbe_v8_7_dissect.fill_px(buffer, index, packet, parent)

  -- Fill Qty: 4 Byte Unsigned Fixed Width Integer
  index, fill_qty = cme_futures_ilink3_sbe_v8_7_dissect.fill_qty(buffer, index, packet, parent)

  -- Fill Exec Id: 2 Byte Ascii String
  index, fill_exec_id = cme_futures_ilink3_sbe_v8_7_dissect.fill_exec_id(buffer, index, packet, parent)

  -- Fill Yield Type: 1 Byte Unsigned Fixed Width Integer
  index, fill_yield_type = cme_futures_ilink3_sbe_v8_7_dissect.fill_yield_type(buffer, index, packet, parent)

  return index
end

-- Dissect: Fills Group
cme_futures_ilink3_sbe_v8_7_dissect.fills_group = function(buffer, offset, packet, parent)
  if show.fills_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.fills_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.fills_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.fills_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.fills_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Fills Groups
cme_futures_ilink3_sbe_v8_7_size_of.fills_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.fills_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Fills Groups
cme_futures_ilink3_sbe_v8_7_dissect.fills_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for fills_group_index = 1, num_in_group do
    index, fills_group = cme_futures_ilink3_sbe_v8_7_dissect.fills_group(buffer, index, packet, parent)

    if fills_group ~= nil then
      local iteration = fills_group:add(cme_futures_ilink3_sbe_v8_7.fields.fills_group_index, fills_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.fills_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Mantissa
cme_futures_ilink3_sbe_v8_7_size_of.mantissa = 8

-- Display: Mantissa
cme_futures_ilink3_sbe_v8_7_display.mantissa = function(value)
  -- Check if field has value
...
-- Dissect: Mantissa
cme_futures_ilink3_sbe_v8_7_dissect.mantissa = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mantissa
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.gross_trade_amt = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mantissa
...
cme_futures_ilink3_sbe_v8_7_display.gross_trade_amt = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Gross Trade Amt
cme_futures_ilink3_sbe_v8_7_dissect.gross_trade_amt_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Mantissa: 8 Byte Signed Fixed Width Integer Nullable
  index, mantissa = cme_futures_ilink3_sbe_v8_7_dissect.mantissa(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.gross_trade_amt = function(buffer, offset, packet, parent)
  if show.gross_trade_amt then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.gross_trade_amt, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.gross_trade_amt_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.gross_trade_amt(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.gross_trade_amt_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Calculated Ccy Last Qty
cme_futures_ilink3_sbe_v8_7_size_of.calculated_ccy_last_qty = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.calculated_ccy_last_qty = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Calculated Ccy Last Qty
cme_futures_ilink3_sbe_v8_7_dissect.calculated_ccy_last_qty_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.calculated_ccy_last_qty = function(buffer, offset, packet, parent)
  if show.calculated_ccy_last_qty then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.calculated_ccy_last_qty, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.calculated_ccy_last_qty_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.calculated_ccy_last_qty(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.calculated_ccy_last_qty_fields(buffer, offset, packet, element)
  end
end

-- Size: Settl Date
cme_futures_ilink3_sbe_v8_7_size_of.settl_date = 2

-- Display: Settl Date
cme_futures_ilink3_sbe_v8_7_display.settl_date = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: Settl Date
cme_futures_ilink3_sbe_v8_7_dissect.settl_date = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.settl_date
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Exec Type
cme_futures_ilink3_sbe_v8_7_size_of.exec_type = 1

-- Display: Exec Type
cme_futures_ilink3_sbe_v8_7_display.exec_type = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Exec Type
cme_futures_ilink3_sbe_v8_7_dissect.exec_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.exec_type
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.ord_status_trd_cxl = 1

-- Display: Ord Status Trd Cxl
cme_futures_ilink3_sbe_v8_7_display.ord_status_trd_cxl = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.ord_status_trd_cxl = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_status_trd_cxl
  local range = buffer(offset, length)
...
-- Size: Trade Date
cme_futures_ilink3_sbe_v8_7_size_of.trade_date = 2

-- Display: Trade Date
cme_futures_ilink3_sbe_v8_7_display.trade_date = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: Trade Date
cme_futures_ilink3_sbe_v8_7_dissect.trade_date = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trade_date
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.orig_side_trade_id = 4

-- Display: Orig Side Trade Id
cme_futures_ilink3_sbe_v8_7_display.orig_side_trade_id = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
cme_futures_ilink3_sbe_v8_7_dissect.orig_side_trade_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.orig_side_trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Side Trade Id
cme_futures_ilink3_sbe_v8_7_size_of.side_trade_id = 4

-- Display: Side Trade Id
cme_futures_ilink3_sbe_v8_7_display.side_trade_id = function(value)
  return "Side Trade Id: "..value
end

-- Dissect: Side Trade Id
cme_futures_ilink3_sbe_v8_7_dissect.side_trade_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.side_trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Last Qty
cme_futures_ilink3_sbe_v8_7_size_of.last_qty = 4

-- Display: Last Qty
cme_futures_ilink3_sbe_v8_7_display.last_qty = function(value)
  return "Last Qty: "..value
end

-- Dissect: Last Qty
cme_futures_ilink3_sbe_v8_7_dissect.last_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.last_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.orig_secondary_execution_id = 8

-- Display: Orig Secondary Execution Id
cme_futures_ilink3_sbe_v8_7_display.orig_secondary_execution_id = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.orig_secondary_execution_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.orig_secondary_execution_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Sec Exec Id
cme_futures_ilink3_sbe_v8_7_size_of.sec_exec_id = 8

-- Display: Sec Exec Id
cme_futures_ilink3_sbe_v8_7_display.sec_exec_id = function(value)
  return "Sec Exec Id: "..value
end

-- Dissect: Sec Exec Id
cme_futures_ilink3_sbe_v8_7_dissect.sec_exec_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.sec_exec_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Last Px
cme_futures_ilink3_sbe_v8_7_size_of.last_px = 8

-- Display: Last Px
cme_futures_ilink3_sbe_v8_7_display.last_px = function(value)
...
-- Dissect: Last Px
cme_futures_ilink3_sbe_v8_7_dissect.last_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.last_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.last_px
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sec_exec_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.orig_secondary_execution_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.location

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.last_qty

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.side_trade_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.orig_side_trade_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trade_date

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_status_trd_cxl

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.exec_type
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.settl_date

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.calculated_ccy_last_qty(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.gross_trade_amt(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fills_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg_order_event_groups(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Addendum Spread Leg
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_leg = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread Leg
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, last_px = cme_futures_ilink3_sbe_v8_7_dissect.last_px(buffer, index, packet, parent)
  ...
  index, sec_exec_id = cme_futures_ilink3_sbe_v8_7_dissect.sec_exec_id(buffer, index, packet, parent)

  -- Orig Secondary Execution Id: 8 Byte Unsigned Fixed Width Integer Nullable
  index, orig_secondary_execution_id = cme_futures_ilink3_sbe_v8_7_dissect.orig_secondary_execution_id(buffer, index, packet, parent)
  ...
  index, last_qty = cme_futures_ilink3_sbe_v8_7_dissect.last_qty(buffer, index, packet, parent)

  -- Side Trade Id: 4 Byte Unsigned Fixed Width Integer
  index, side_trade_id = cme_futures_ilink3_sbe_v8_7_dissect.side_trade_id(buffer, index, packet, parent)

  -- Orig Side Trade Id: 4 Byte Unsigned Fixed Width Integer Nullable
  index, orig_side_trade_id = cme_futures_ilink3_sbe_v8_7_dissect.orig_side_trade_id(buffer, index, packet, parent)

  -- Trade Date: 2 Byte Unsigned Fixed Width Integer Nullable
  index, trade_date = cme_futures_ilink3_sbe_v8_7_dissect.trade_date(buffer, index, packet, parent)

  -- Ord Status Trd Cxl: 1 Byte Ascii String Enum with 2 values
  index, ord_status_trd_cxl = cme_futures_ilink3_sbe_v8_7_dissect.ord_status_trd_cxl(buffer, index, packet, parent)

  -- Exec Type: 1 Byte Ascii String Enum with 2 values
  index, exec_type = cme_futures_ilink3_sbe_v8_7_dissect.exec_type(buffer, index, packet, parent)
  ...
  index, settl_date = cme_futures_ilink3_sbe_v8_7_dissect.settl_date(buffer, index, packet, parent)

  -- Calculated Ccy Last Qty: Struct of 2 fields
  index, calculated_ccy_last_qty = cme_futures_ilink3_sbe_v8_7_dissect.calculated_ccy_last_qty(buffer, index, packet, parent)

  -- Gross Trade Amt: Struct of 2 fields
  index, gross_trade_amt = cme_futures_ilink3_sbe_v8_7_dissect.gross_trade_amt(buffer, index, packet, parent)

  -- Fills Groups: Struct of 2 fields
  index, fills_groups = cme_futures_ilink3_sbe_v8_7_dissect.fills_groups(buffer, index, packet, parent)

  -- Execution Report Trade Addendum Spread Leg Order Event Groups: Struct of 2 fields
  index, execution_report_trade_addendum_spread_leg_order_event_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_order_event_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Addendum Spread Leg
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_order_event_group = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_order_event_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_addendum_spread_order_event_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_spread_order_event_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_order_event_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Addendum Spread Order Event Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_order_event_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_order_event_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread Order Event Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_addendum_spread_order_event_group_index = 1, num_in_group do
    index, execution_report_trade_addendum_spread_order_event_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_group(buffer, index, packet, parent)

    if execution_report_trade_addendum_spread_order_event_group ~= nil then
      local iteration = execution_report_trade_addendum_spread_order_event_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_spread_order_event_group_index, execution_report_trade_addendum_spread_order_event_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Leg Last Qty
cme_futures_ilink3_sbe_v8_7_size_of.leg_last_qty = 4

-- Display: Leg Last Qty
cme_futures_ilink3_sbe_v8_7_display.leg_last_qty = function(value)
  return "Leg Last Qty: "..value
end

-- Dissect: Leg Last Qty
cme_futures_ilink3_sbe_v8_7_dissect.leg_last_qty = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_last_qty
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.leg_trade_ref_id = 4

-- Display: Leg Trade Ref Id
cme_futures_ilink3_sbe_v8_7_display.leg_trade_ref_id = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
cme_futures_ilink3_sbe_v8_7_dissect.leg_trade_ref_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_trade_ref_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Leg Trade Id
cme_futures_ilink3_sbe_v8_7_size_of.leg_trade_id = 4

-- Display: Leg Trade Id
cme_futures_ilink3_sbe_v8_7_display.leg_trade_id = function(value)
  return "Leg Trade Id: "..value
end

-- Dissect: Leg Trade Id
cme_futures_ilink3_sbe_v8_7_dissect.leg_trade_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_trade_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.leg_exec_ref_id = 8

-- Display: Leg Exec Ref Id
cme_futures_ilink3_sbe_v8_7_display.leg_exec_ref_id = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.leg_exec_ref_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_exec_ref_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Leg Last Px
cme_futures_ilink3_sbe_v8_7_size_of.leg_last_px = 8

-- Display: Leg Last Px
cme_futures_ilink3_sbe_v8_7_display.leg_last_px = function(value)
...
-- Dissect: Leg Last Px
cme_futures_ilink3_sbe_v8_7_dissect.leg_last_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_last_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
-- Size: Leg Exec Id
cme_futures_ilink3_sbe_v8_7_size_of.leg_exec_id = 8

-- Display: Leg Exec Id
cme_futures_ilink3_sbe_v8_7_display.leg_exec_id = function(value)
  return "Leg Exec Id: "..value
end

-- Dissect: Leg Exec Id
cme_futures_ilink3_sbe_v8_7_dissect.leg_exec_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.leg_exec_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_exec_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_last_px

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_exec_ref_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_trade_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_trade_ref_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_security_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.leg_last_qty
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_leg_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread Leg Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Leg Exec Id: 8 Byte Unsigned Fixed Width Integer
  index, leg_exec_id = cme_futures_ilink3_sbe_v8_7_dissect.leg_exec_id(buffer, index, packet, parent)

  -- Leg Last Px: 8 Byte Signed Fixed Width Integer
  index, leg_last_px = cme_futures_ilink3_sbe_v8_7_dissect.leg_last_px(buffer, index, packet, parent)

  -- Leg Exec Ref Id: 8 Byte Unsigned Fixed Width Integer Nullable
  index, leg_exec_ref_id = cme_futures_ilink3_sbe_v8_7_dissect.leg_exec_ref_id(buffer, index, packet, parent)

  -- Leg Trade Id: 4 Byte Unsigned Fixed Width Integer
  index, leg_trade_id = cme_futures_ilink3_sbe_v8_7_dissect.leg_trade_id(buffer, index, packet, parent)

  -- Leg Trade Ref Id: 4 Byte Unsigned Fixed Width Integer Nullable
  index, leg_trade_ref_id = cme_futures_ilink3_sbe_v8_7_dissect.leg_trade_ref_id(buffer, index, packet, parent)

  -- Leg Security Id: 4 Byte Signed Fixed Width Integer
  index, leg_security_id = cme_futures_ilink3_sbe_v8_7_dissect.leg_security_id(buffer, index, packet, parent)

  -- Leg Last Qty: 4 Byte Unsigned Fixed Width Integer
  index, leg_last_qty = cme_futures_ilink3_sbe_v8_7_dissect.leg_last_qty(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_addendum_spread_leg_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_spread_leg_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_leg_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Addendum Spread Leg Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread_leg_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread Leg Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_addendum_spread_leg_group_index = 1, num_in_group do
    index, execution_report_trade_addendum_spread_leg_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_group(buffer, index, packet, parent)

    if execution_report_trade_addendum_spread_leg_group ~= nil then
      local iteration = execution_report_trade_addendum_spread_leg_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_spread_leg_group_index, execution_report_trade_addendum_spread_leg_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Managed Order
cme_futures_ilink3_sbe_v8_7_size_of.managed_order = 1

-- Display: Managed Order
cme_futures_ilink3_sbe_v8_7_display.managed_order = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.managed_order = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.managed_order
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Execution Mode
cme_futures_ilink3_sbe_v8_7_size_of.execution_mode = 1

-- Display: Execution Mode
cme_futures_ilink3_sbe_v8_7_display.execution_mode = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_mode = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.execution_mode
  local range = buffer(offset, length)
...
-- Size: Exec Inst
cme_futures_ilink3_sbe_v8_7_size_of.exec_inst = 1

-- Display: Exec Inst
cme_futures_ilink3_sbe_v8_7_display.exec_inst = function(buffer, packet, parent)
  local display = ""
...
-- Dissect: Exec Inst
cme_futures_ilink3_sbe_v8_7_dissect.exec_inst = function(buffer, offset, packet, parent)
  local size = 1
...
cme_futures_ilink3_sbe_v8_7_size_of.total_num_securities = 1

-- Display: Total Num Securities
cme_futures_ilink3_sbe_v8_7_display.total_num_securities = function(value)
  return "Total Num Securities: "..value
end

-- Dissect: Total Num Securities
cme_futures_ilink3_sbe_v8_7_dissect.total_num_securities = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.total_num_securities
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.md_trade_entry_id = 4

-- Display: Md Trade Entry Id
cme_futures_ilink3_sbe_v8_7_display.md_trade_entry_id = function(value)
  return "Md Trade Entry Id: "..value
end

-- Dissect: Md Trade Entry Id
cme_futures_ilink3_sbe_v8_7_dissect.md_trade_entry_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.md_trade_entry_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.md_trade_entry_id
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.total_num_securities

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.exec_inst

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_mode

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.liquidity_flag

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.managed_order

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.short_sale_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fills_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_order_event_groups(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Addendum Spread
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_spread = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Spread
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, md_trade_entry_id = cme_futures_ilink3_sbe_v8_7_dissect.md_trade_entry_id(buffer, index, packet, parent)
  ...
  index, total_num_securities = cme_futures_ilink3_sbe_v8_7_dissect.total_num_securities(buffer, index, packet, parent)

  -- Exec Inst: Struct of 8 fields
  index, exec_inst = cme_futures_ilink3_sbe_v8_7_dissect.exec_inst(buffer, index, packet, parent)

  -- Execution Mode: 1 Byte Ascii String Enum with 2 values
  index, execution_mode = cme_futures_ilink3_sbe_v8_7_dissect.execution_mode(buffer, index, packet, parent)

  -- Liquidity Flag: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, liquidity_flag = cme_futures_ilink3_sbe_v8_7_dissect.liquidity_flag(buffer, index, packet, parent)

  -- Managed Order: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, managed_order = cme_futures_ilink3_sbe_v8_7_dissect.managed_order(buffer, index, packet, parent)
  ...
  index, execution_report_trade_addendum_spread_leg_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg_groups(buffer, index, packet, parent)

  -- Execution Report Trade Addendum Spread Order Event Groups: Struct of 2 fields
  index, execution_report_trade_addendum_spread_order_event_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_order_event_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Addendum Spread
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.contra_calculated_ccy_last_qty = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.contra_calculated_ccy_last_qty = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Contra Calculated Ccy Last Qty
cme_futures_ilink3_sbe_v8_7_dissect.contra_calculated_ccy_last_qty_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.contra_calculated_ccy_last_qty = function(buffer, offset, packet, parent)
  if show.contra_calculated_ccy_last_qty then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.contra_calculated_ccy_last_qty, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.contra_calculated_ccy_last_qty_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.contra_calculated_ccy_last_qty(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.contra_calculated_ccy_last_qty_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Contra Gross Trade Amt
cme_futures_ilink3_sbe_v8_7_size_of.contra_gross_trade_amt = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.contra_gross_trade_amt = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Contra Gross Trade Amt
cme_futures_ilink3_sbe_v8_7_dissect.contra_gross_trade_amt_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.contra_gross_trade_amt = function(buffer, offset, packet, parent)
  if show.contra_gross_trade_amt then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.contra_gross_trade_amt, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.contra_gross_trade_amt_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.contra_gross_trade_amt(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.contra_gross_trade_amt_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Addendum Outright Order Event Group
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_outright_order_event_group = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.contra_gross_trade_amt(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.contra_calculated_ccy_last_qty(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Addendum Outright Order Event Group
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_outright_order_event_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Outright Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_group_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, contra_gross_trade_amt = cme_futures_ilink3_sbe_v8_7_dissect.contra_gross_trade_amt(buffer, index, packet, parent)

  -- Contra Calculated Ccy Last Qty: Struct of 2 fields
  index, contra_calculated_ccy_last_qty = cme_futures_ilink3_sbe_v8_7_dissect.contra_calculated_ccy_last_qty(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Addendum Outright Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_addendum_outright_order_event_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_outright_order_event_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_outright_order_event_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Addendum Outright Order Event Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_outright_order_event_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_outright_order_event_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Outright Order Event Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_addendum_outright_order_event_group_index = 1, num_in_group do
    index, execution_report_trade_addendum_outright_order_event_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_group(buffer, index, packet, parent)

    if execution_report_trade_addendum_outright_order_event_group ~= nil then
      local iteration = execution_report_trade_addendum_outright_order_event_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_addendum_outright_order_event_group_index, execution_report_trade_addendum_outright_order_event_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.benchmark_price = 8

-- Display: Benchmark Price
cme_futures_ilink3_sbe_v8_7_display.benchmark_price = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.benchmark_price = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.benchmark_price
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
-- Size: Maturity Date
cme_futures_ilink3_sbe_v8_7_size_of.maturity_date = 2

-- Display: Maturity Date
cme_futures_ilink3_sbe_v8_7_display.maturity_date = function(value)
  -- Check if field has value
  if value == 65535 then
...
cme_futures_ilink3_sbe_v8_7_dissect.maturity_date = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.maturity_date
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.exec_restatement_reason = 1

-- Display: Exec Restatement Reason
cme_futures_ilink3_sbe_v8_7_display.exec_restatement_reason = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.exec_restatement_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.exec_restatement_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Trd Type
cme_futures_ilink3_sbe_v8_7_size_of.trd_type = 2

-- Display: Trd Type
cme_futures_ilink3_sbe_v8_7_display.trd_type = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: Trd Type
cme_futures_ilink3_sbe_v8_7_dissect.trd_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trd_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_outright = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trd_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.exec_restatement_reason

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.settl_date

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.maturity_date

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.calculated_ccy_last_qty(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.gross_trade_amt(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.benchmark_price

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fills_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_outright_order_event_groups(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Addendum Outright
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_addendum_outright = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Addendum Outright
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, trd_type = cme_futures_ilink3_sbe_v8_7_dissect.trd_type(buffer, index, packet, parent)

  -- Exec Restatement Reason: 1 Byte Unsigned Fixed Width Integer Enum with 10 values
  index, exec_restatement_reason = cme_futures_ilink3_sbe_v8_7_dissect.exec_restatement_reason(buffer, index, packet, parent)

  -- Settl Date: 2 Byte Unsigned Fixed Width Integer Nullable
  index, settl_date = cme_futures_ilink3_sbe_v8_7_dissect.settl_date(buffer, index, packet, parent)

  -- Maturity Date: 2 Byte Unsigned Fixed Width Integer Nullable
  index, maturity_date = cme_futures_ilink3_sbe_v8_7_dissect.maturity_date(buffer, index, packet, parent)
  ...
  index, benchmark_price = cme_futures_ilink3_sbe_v8_7_dissect.benchmark_price(buffer, index, packet, parent)

  -- Fills Groups: Struct of 2 fields
  index, fills_groups = cme_futures_ilink3_sbe_v8_7_dissect.fills_groups(buffer, index, packet, parent)

  -- Execution Report Trade Addendum Outright Order Event Groups: Struct of 2 fields
  index, execution_report_trade_addendum_outright_order_event_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright_order_event_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Addendum Outright
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_ack_status = 1

-- Display: Quote Ack Status
cme_futures_ilink3_sbe_v8_7_display.quote_ack_status = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_ack_status = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_ack_status
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Quote Req Id
cme_futures_ilink3_sbe_v8_7_size_of.quote_req_id = 8

-- Display: Quote Req Id
cme_futures_ilink3_sbe_v8_7_display.quote_req_id = function(value)
  return "Quote Req Id: "..value
end

-- Dissect: Quote Req Id
cme_futures_ilink3_sbe_v8_7_dissect.quote_req_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_req_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.exchange_quote_req_id = 17

-- Display: Exchange Quote Req Id
cme_futures_ilink3_sbe_v8_7_display.exchange_quote_req_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.exchange_quote_req_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.exchange_quote_req_id
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.request_for_quote_ack = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.exchange_quote_req_id
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_req_id
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_ack_status
...
cme_futures_ilink3_sbe_v8_7_display.request_for_quote_ack = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Request For Quote Ack
cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote_ack_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, exchange_quote_req_id = cme_futures_ilink3_sbe_v8_7_dissect.exchange_quote_req_id(buffer, index, packet, parent)
  ...
  index, quote_req_id = cme_futures_ilink3_sbe_v8_7_dissect.quote_req_id(buffer, index, packet, parent)
  ...
  index, quote_ack_status = cme_futures_ilink3_sbe_v8_7_dissect.quote_ack_status(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote_ack = function(buffer, offset, packet, parent)
  if show.request_for_quote_ack then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.request_for_quote_ack, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote_ack_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.request_for_quote_ack(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote_ack_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Mass Quote Ack Entry Group
cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_ack_entry_group = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.mass_quote_ack_entry_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Quote Ack Entry Group
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_group = function(buffer, offset, packet, parent)
  if show.mass_quote_ack_entry_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.mass_quote_ack_entry_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.mass_quote_ack_entry_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Mass Quote Ack Entry Groups
cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_ack_entry_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.mass_quote_ack_entry_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Quote Ack Entry Groups
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for mass_quote_ack_entry_group_index = 1, num_in_group do
    index, mass_quote_ack_entry_group = cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_group(buffer, index, packet, parent)

    if mass_quote_ack_entry_group ~= nil then
      local iteration = mass_quote_ack_entry_group:add(cme_futures_ilink3_sbe_v8_7.fields.mass_quote_ack_entry_group_index, mass_quote_ack_entry_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.no_processed_entries = 1

-- Display: No Processed Entries
cme_futures_ilink3_sbe_v8_7_display.no_processed_entries = function(value)
  return "No Processed Entries: "..value
end

-- Dissect: No Processed Entries
cme_futures_ilink3_sbe_v8_7_dissect.no_processed_entries = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.no_processed_entries
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_req_id_optional = 8

-- Display: Quote Req Id Optional
cme_futures_ilink3_sbe_v8_7_display.quote_req_id_optional = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_req_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_req_id_optional
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_ack = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_req_id_optional
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.no_processed_entries
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_ack_entry_groups(buffer, offset + index)

  return index
end

-- Display: Mass Quote Ack
cme_futures_ilink3_sbe_v8_7_display.mass_quote_ack = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Quote Ack
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, quote_req_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.quote_req_id_optional(buffer, index, packet, parent)
  ...
  index, no_processed_entries = cme_futures_ilink3_sbe_v8_7_dissect.no_processed_entries(buffer, index, packet, parent)
  ...
  index, mass_quote_ack_entry_groups = cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack_entry_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Mass Quote Ack
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.side_time_in_force = 1

-- Display: Side Time In Force
cme_futures_ilink3_sbe_v8_7_display.side_time_in_force = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.side_time_in_force = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.side_time_in_force
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.sides_group = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.side_time_in_force

  return index
end

-- Display: Sides Group
cme_futures_ilink3_sbe_v8_7_display.sides_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sides Group
cme_futures_ilink3_sbe_v8_7_dissect.sides_group_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, side_time_in_force = cme_futures_ilink3_sbe_v8_7_dissect.side_time_in_force(buffer, index, packet, parent)

  return index
end

-- Dissect: Sides Group
cme_futures_ilink3_sbe_v8_7_dissect.sides_group = function(buffer, offset, packet, parent)
  if show.sides_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.sides_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.sides_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.sides_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.sides_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Sides Groups
cme_futures_ilink3_sbe_v8_7_size_of.sides_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.sides_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sides Groups
cme_futures_ilink3_sbe_v8_7_dissect.sides_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for sides_group_index = 1, num_in_group do
    index, sides_group = cme_futures_ilink3_sbe_v8_7_dissect.sides_group(buffer, index, packet, parent)

    if sides_group ~= nil then
      local iteration = sides_group:add(cme_futures_ilink3_sbe_v8_7.fields.sides_group_index, sides_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.sides_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Trans Bkd Time
cme_futures_ilink3_sbe_v8_7_size_of.trans_bkd_time = 8

-- Display: Trans Bkd Time
cme_futures_ilink3_sbe_v8_7_display.trans_bkd_time = function(value)
  return "Trans Bkd Time: "..value
end

-- Dissect: Trans Bkd Time
cme_futures_ilink3_sbe_v8_7_dissect.trans_bkd_time = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trans_bkd_time
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Cross Id
cme_futures_ilink3_sbe_v8_7_size_of.cross_id = 8

-- Display: Cross Id
cme_futures_ilink3_sbe_v8_7_display.cross_id = function(value)
  return "Cross Id: "..value
end

-- Dissect: Cross Id
cme_futures_ilink3_sbe_v8_7_dissect.cross_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cross_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.new_order_cross = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cross_id
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trans_bkd_time
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sides_groups(buffer, offset + index)

  return index
end

-- Display: New Order Cross
cme_futures_ilink3_sbe_v8_7_display.new_order_cross = function(packet, parent, length)
  return ""
end

-- Dissect Fields: New Order Cross
cme_futures_ilink3_sbe_v8_7_dissect.new_order_cross_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Cross Id: 8 Byte Unsigned Fixed Width Integer
  index, cross_id = cme_futures_ilink3_sbe_v8_7_dissect.cross_id(buffer, index, packet, parent)
  ...
  index, trans_bkd_time = cme_futures_ilink3_sbe_v8_7_dissect.trans_bkd_time(buffer, index, packet, parent)
  ...
  index, sides_groups = cme_futures_ilink3_sbe_v8_7_dissect.sides_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: New Order Cross
cme_futures_ilink3_sbe_v8_7_dissect.new_order_cross = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Rfq Side
cme_futures_ilink3_sbe_v8_7_size_of.rfq_side = 1

-- Display: Rfq Side
cme_futures_ilink3_sbe_v8_7_display.rfq_side = function(value)
  if value == 255 then
...
-- Dissect: Rfq Side
cme_futures_ilink3_sbe_v8_7_dissect.rfq_side = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.rfq_side
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_qty_optional = 4

-- Display: Order Qty Optional
cme_futures_ilink3_sbe_v8_7_display.order_qty_optional = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
cme_futures_ilink3_sbe_v8_7_dissect.order_qty_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_qty_optional
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.related_sym_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.security_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_qty_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.rfq_side

  return index
end

-- Display: Related Sym Group
cme_futures_ilink3_sbe_v8_7_display.related_sym_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Related Sym Group
cme_futures_ilink3_sbe_v8_7_dissect.related_sym_group_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_qty_optional = cme_futures_ilink3_sbe_v8_7_dissect.order_qty_optional(buffer, index, packet, parent)

  -- Rfq Side: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, rfq_side = cme_futures_ilink3_sbe_v8_7_dissect.rfq_side(buffer, index, packet, parent)

  return index
end

-- Dissect: Related Sym Group
cme_futures_ilink3_sbe_v8_7_dissect.related_sym_group = function(buffer, offset, packet, parent)
  if show.related_sym_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.related_sym_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.related_sym_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.related_sym_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.related_sym_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Related Sym Groups
cme_futures_ilink3_sbe_v8_7_size_of.related_sym_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.related_sym_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Related Sym Groups
cme_futures_ilink3_sbe_v8_7_dissect.related_sym_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for related_sym_group_index = 1, num_in_group do
    index, related_sym_group = cme_futures_ilink3_sbe_v8_7_dissect.related_sym_group(buffer, index, packet, parent)

    if related_sym_group ~= nil then
      local iteration = related_sym_group:add(cme_futures_ilink3_sbe_v8_7.fields.related_sym_group_index, related_sym_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.related_sym_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Quote Type
cme_futures_ilink3_sbe_v8_7_size_of.quote_type = 1

-- Display: Quote Type
cme_futures_ilink3_sbe_v8_7_display.quote_type = function(value)
  if value == 255 then
...
-- Dissect: Quote Type
cme_futures_ilink3_sbe_v8_7_dissect.quote_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.request_for_quote = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.related_sym_groups(buffer, offset + index)

  return index
end

-- Display: Request For Quote
cme_futures_ilink3_sbe_v8_7_display.request_for_quote = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Request For Quote
cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, quote_type = cme_futures_ilink3_sbe_v8_7_dissect.quote_type(buffer, index, packet, parent)

  -- Related Sym Groups: Struct of 2 fields
  index, related_sym_groups = cme_futures_ilink3_sbe_v8_7_dissect.related_sym_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Request For Quote
cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Dk Reason
cme_futures_ilink3_sbe_v8_7_size_of.dk_reason = 1

-- Display: Dk Reason
cme_futures_ilink3_sbe_v8_7_display.dk_reason = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Dk Reason
cme_futures_ilink3_sbe_v8_7_dissect.dk_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.dk_reason
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.exec_ack_status = 1

-- Display: Exec Ack Status
cme_futures_ilink3_sbe_v8_7_display.exec_ack_status = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.exec_ack_status = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.exec_ack_status
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_ack = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.exec_ack_status
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.dk_reason
...
cme_futures_ilink3_sbe_v8_7_display.execution_ack = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Ack
cme_futures_ilink3_sbe_v8_7_dissect.execution_ack_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, exec_ack_status = cme_futures_ilink3_sbe_v8_7_dissect.exec_ack_status(buffer, index, packet, parent)
  ...
  index, dk_reason = cme_futures_ilink3_sbe_v8_7_dissect.dk_reason(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_ack = function(buffer, offset, packet, parent)
  if show.execution_ack then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_ack, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_ack_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_ack(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_ack_fields(buffer, offset, packet, element)
  end
end

-- Size: Trd Reg Publication Reason
cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publication_reason = 1

-- Display: Trd Reg Publication Reason
cme_futures_ilink3_sbe_v8_7_display.trd_reg_publication_reason = function(value)
  return "Trd Reg Publication Reason: "..value
end

-- Dissect: Trd Reg Publication Reason
cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publication_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publication_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publication_type = 1

-- Display: Trd Reg Publication Type
cme_futures_ilink3_sbe_v8_7_display.trd_reg_publication_type = function(value)
  return "Trd Reg Publication Type: "..value
end

-- Dissect: Trd Reg Publication Type
cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publication_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publication_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publications_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publication_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publication_reason

  return index
end

-- Display: Trd Reg Publications Group
cme_futures_ilink3_sbe_v8_7_display.trd_reg_publications_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trd Reg Publications Group
cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Trd Reg Publication Type: 1 Byte Unsigned Fixed Width Integer
  index, trd_reg_publication_type = cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publication_type(buffer, index, packet, parent)

  -- Trd Reg Publication Reason: 1 Byte Unsigned Fixed Width Integer
  index, trd_reg_publication_reason = cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publication_reason(buffer, index, packet, parent)

  return index
end

-- Dissect: Trd Reg Publications Group
cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_group = function(buffer, offset, packet, parent)
  if show.trd_reg_publications_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.trd_reg_publications_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.trd_reg_publications_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Trd Reg Publications Groups
cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publications_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.trd_reg_publications_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Trd Reg Publications Groups
cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for trd_reg_publications_group_index = 1, num_in_group do
    index, trd_reg_publications_group = cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_group(buffer, index, packet, parent)

    if trd_reg_publications_group ~= nil then
      local iteration = trd_reg_publications_group:add(cme_futures_ilink3_sbe_v8_7.fields.trd_reg_publications_group_index, trd_reg_publications_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.party_detail_role = 2

-- Display: Party Detail Role
cme_futures_ilink3_sbe_v8_7_display.party_detail_role = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.party_detail_role = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_detail_role
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.party_detail_id = 20

-- Display: Party Detail Id
cme_futures_ilink3_sbe_v8_7_display.party_detail_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.party_detail_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_detail_id
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_detail_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_detail_role

  return index
end

-- Display: Party Details Group
cme_futures_ilink3_sbe_v8_7_display.party_details_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party Details Group
cme_futures_ilink3_sbe_v8_7_dissect.party_details_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Party Detail Id: 20 Byte Ascii String
  index, party_detail_id = cme_futures_ilink3_sbe_v8_7_dissect.party_detail_id(buffer, index, packet, parent)

  -- Party Detail Role: 2 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, party_detail_role = cme_futures_ilink3_sbe_v8_7_dissect.party_detail_role(buffer, index, packet, parent)

  return index
end

-- Dissect: Party Details Group
cme_futures_ilink3_sbe_v8_7_dissect.party_details_group = function(buffer, offset, packet, parent)
  if show.party_details_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.party_details_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.party_details_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.party_details_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.party_details_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Party Details Groups
cme_futures_ilink3_sbe_v8_7_size_of.party_details_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.party_details_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party Details Groups
cme_futures_ilink3_sbe_v8_7_dissect.party_details_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for party_details_group_index = 1, num_in_group do
    index, party_details_group = cme_futures_ilink3_sbe_v8_7_dissect.party_details_group(buffer, index, packet, parent)

    if party_details_group ~= nil then
      local iteration = party_details_group:add(cme_futures_ilink3_sbe_v8_7.fields.party_details_group_index, party_details_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.party_details_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Idm Short Code
cme_futures_ilink3_sbe_v8_7_size_of.idm_short_code = 8

-- Display: Idm Short Code
cme_futures_ilink3_sbe_v8_7_display.idm_short_code = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.idm_short_code = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.idm_short_code
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Executor
cme_futures_ilink3_sbe_v8_7_size_of.executor = 8

-- Display: Executor
cme_futures_ilink3_sbe_v8_7_display.executor = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
-- Dissect: Executor
cme_futures_ilink3_sbe_v8_7_dissect.executor = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.executor
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.cust_order_handling_inst = 1

-- Display: Cust Order Handling Inst
cme_futures_ilink3_sbe_v8_7_display.cust_order_handling_inst = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.cust_order_handling_inst = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cust_order_handling_inst
  local range = buffer(offset, length)
...
-- Size: Cmta Giveup Cd
cme_futures_ilink3_sbe_v8_7_size_of.cmta_giveup_cd = 1

-- Display: Cmta Giveup Cd
cme_futures_ilink3_sbe_v8_7_display.cmta_giveup_cd = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.cmta_giveup_cd = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cmta_giveup_cd
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.clearing_trade_price_type = 1

-- Display: Clearing Trade Price Type
cme_futures_ilink3_sbe_v8_7_display.clearing_trade_price_type = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.clearing_trade_price_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.clearing_trade_price_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.avg_px_indicator = 1

-- Display: Avg Px Indicator
cme_futures_ilink3_sbe_v8_7_display.avg_px_indicator = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.avg_px_indicator = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.avg_px_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.self_match_prevention_instruction = 1

-- Display: Self Match Prevention Instruction
cme_futures_ilink3_sbe_v8_7_display.self_match_prevention_instruction = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.self_match_prevention_instruction = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.self_match_prevention_instruction
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.clearing_account_type = 1

-- Display: Clearing Account Type
cme_futures_ilink3_sbe_v8_7_display.clearing_account_type = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.clearing_account_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.clearing_account_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.cust_order_capacity = 1

-- Display: Cust Order Capacity
cme_futures_ilink3_sbe_v8_7_display.cust_order_capacity = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.cust_order_capacity = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cust_order_capacity
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Request Result
cme_futures_ilink3_sbe_v8_7_size_of.request_result = 1

-- Display: Request Result
cme_futures_ilink3_sbe_v8_7_display.request_result = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.request_result = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.request_result
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.tot_num_parties = 2

-- Display: Tot Num Parties
cme_futures_ilink3_sbe_v8_7_display.tot_num_parties = function(value)
  return "Tot Num Parties: "..value
end

-- Dissect: Tot Num Parties
cme_futures_ilink3_sbe_v8_7_dissect.tot_num_parties = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.tot_num_parties
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.self_match_prevention_id = 8

-- Display: Self Match Prevention Id
cme_futures_ilink3_sbe_v8_7_display.self_match_prevention_id = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.self_match_prevention_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.self_match_prevention_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_report_id = 8

-- Display: Party Details List Report Id
cme_futures_ilink3_sbe_v8_7_display.party_details_list_report_id = function(value)
  return "Party Details List Report Id: "..value
end

-- Dissect: Party Details List Report Id
cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_report_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_report_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.avg_px_group_id = 20

-- Display: Avg Px Group Id
cme_futures_ilink3_sbe_v8_7_display.avg_px_group_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.avg_px_group_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.avg_px_group_id
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_report = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.avg_px_group_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_report_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.self_match_prevention_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.tot_num_parties

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.request_result

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.last_fragment

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cust_order_capacity

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.clearing_account_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.self_match_prevention_instruction

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.avg_px_indicator

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.clearing_trade_price_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cmta_giveup_cd

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cust_order_handling_inst

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.executor

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.idm_short_code

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.poss_retrans_flag

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.split_msg

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trd_reg_publications_groups(buffer, offset + index)

  return index
end

-- Display: Party Details List Report
cme_futures_ilink3_sbe_v8_7_display.party_details_list_report = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party Details List Report
cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_report_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, avg_px_group_id = cme_futures_ilink3_sbe_v8_7_dissect.avg_px_group_id(buffer, index, packet, parent)

  -- Party Details List Req Id: 8 Byte Unsigned Fixed Width Integer
  index, party_details_list_req_id = cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_req_id(buffer, index, packet, parent)

  -- Party Details List Report Id: 8 Byte Unsigned Fixed Width Integer
  index, party_details_list_report_id = cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_report_id(buffer, index, packet, parent)

  -- Sending Time Epoch: 8 Byte Unsigned Fixed Width Integer
  index, sending_time_epoch = cme_futures_ilink3_sbe_v8_7_dissect.sending_time_epoch(buffer, index, packet, parent)

  -- Self Match Prevention Id: 8 Byte Unsigned Fixed Width Integer Nullable
  index, self_match_prevention_id = cme_futures_ilink3_sbe_v8_7_dissect.self_match_prevention_id(buffer, index, packet, parent)

  -- Tot Num Parties: 2 Byte Unsigned Fixed Width Integer
  index, tot_num_parties = cme_futures_ilink3_sbe_v8_7_dissect.tot_num_parties(buffer, index, packet, parent)

  -- Request Result: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, request_result = cme_futures_ilink3_sbe_v8_7_dissect.request_result(buffer, index, packet, parent)

  -- Last Fragment: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, last_fragment = cme_futures_ilink3_sbe_v8_7_dissect.last_fragment(buffer, index, packet, parent)

  -- Cust Order Capacity: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, cust_order_capacity = cme_futures_ilink3_sbe_v8_7_dissect.cust_order_capacity(buffer, index, packet, parent)

  -- Clearing Account Type: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, clearing_account_type = cme_futures_ilink3_sbe_v8_7_dissect.clearing_account_type(buffer, index, packet, parent)

  -- Self Match Prevention Instruction: 1 Byte Ascii String Enum with 2 values
  index, self_match_prevention_instruction = cme_futures_ilink3_sbe_v8_7_dissect.self_match_prevention_instruction(buffer, index, packet, parent)

  -- Avg Px Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 4 values
  index, avg_px_indicator = cme_futures_ilink3_sbe_v8_7_dissect.avg_px_indicator(buffer, index, packet, parent)

  -- Clearing Trade Price Type: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, clearing_trade_price_type = cme_futures_ilink3_sbe_v8_7_dissect.clearing_trade_price_type(buffer, index, packet, parent)

  -- Cmta Giveup Cd: 1 Byte Ascii String Enum with 2 values
  index, cmta_giveup_cd = cme_futures_ilink3_sbe_v8_7_dissect.cmta_giveup_cd(buffer, index, packet, parent)

  -- Cust Order Handling Inst: 1 Byte Ascii String Enum with 6 values
  index, cust_order_handling_inst = cme_futures_ilink3_sbe_v8_7_dissect.cust_order_handling_inst(buffer, index, packet, parent)

  -- Executor: 8 Byte Unsigned Fixed Width Integer Nullable
  index, executor = cme_futures_ilink3_sbe_v8_7_dissect.executor(buffer, index, packet, parent)

  -- Idm Short Code: 8 Byte Unsigned Fixed Width Integer Nullable
  index, idm_short_code = cme_futures_ilink3_sbe_v8_7_dissect.idm_short_code(buffer, index, packet, parent)
  ...
  index, party_details_groups = cme_futures_ilink3_sbe_v8_7_dissect.party_details_groups(buffer, index, packet, parent)

  -- Trd Reg Publications Groups: Struct of 2 fields
  index, trd_reg_publications_groups = cme_futures_ilink3_sbe_v8_7_dissect.trd_reg_publications_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Party Details List Report
cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_report = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Party Role
cme_futures_ilink3_sbe_v8_7_size_of.party_role = 2

-- Display: Party Role
cme_futures_ilink3_sbe_v8_7_display.party_role = function(value)
  return "Party Role: "..value
end

-- Dissect: Party Role
cme_futures_ilink3_sbe_v8_7_dissect.party_role = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_role
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.party_id_source = 1

-- Display: Party Id Source
cme_futures_ilink3_sbe_v8_7_display.party_id_source = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.party_id_source = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_id_source
  local range = buffer(offset, length)
...
-- Size: Party Id
cme_futures_ilink3_sbe_v8_7_size_of.party_id = 8

-- Display: Party Id
cme_futures_ilink3_sbe_v8_7_display.party_id = function(value)
  return "Party Id: "..value
end

-- Dissect: Party Id
cme_futures_ilink3_sbe_v8_7_dissect.party_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.party_i_ds_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_id_source

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_role

  return index
end

-- Display: Party I Ds Group
cme_futures_ilink3_sbe_v8_7_display.party_i_ds_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party I Ds Group
cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Party Id: 8 Byte Unsigned Fixed Width Integer
  index, party_id = cme_futures_ilink3_sbe_v8_7_dissect.party_id(buffer, index, packet, parent)

  -- Party Id Source: 1 Byte Ascii String
  index, party_id_source = cme_futures_ilink3_sbe_v8_7_dissect.party_id_source(buffer, index, packet, parent)

  -- Party Role: 2 Byte Unsigned Fixed Width Integer
  index, party_role = cme_futures_ilink3_sbe_v8_7_dissect.party_role(buffer, index, packet, parent)

  return index
end

-- Dissect: Party I Ds Group
cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_group = function(buffer, offset, packet, parent)
  if show.party_i_ds_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.party_i_ds_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.party_i_ds_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Party I Ds Groups
cme_futures_ilink3_sbe_v8_7_size_of.party_i_ds_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.party_i_ds_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party I Ds Groups
cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for party_i_ds_group_index = 1, num_in_group do
    index, party_i_ds_group = cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_group(buffer, index, packet, parent)

    if party_i_ds_group ~= nil then
      local iteration = party_i_ds_group:add(cme_futures_ilink3_sbe_v8_7.fields.party_i_ds_group_index, party_i_ds_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_role = 1

-- Display: Requesting Party Role
cme_futures_ilink3_sbe_v8_7_display.requesting_party_role = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_role = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_role
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_id_source = 1

-- Display: Requesting Party Id Source
cme_futures_ilink3_sbe_v8_7_display.requesting_party_id_source = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_id_source = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_id_source
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_id = 5

-- Display: Requesting Party Id
cme_futures_ilink3_sbe_v8_7_display.requesting_party_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_id
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_i_ds_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_id_source

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_role

  return index
end

-- Display: Requesting Party I Ds Group
cme_futures_ilink3_sbe_v8_7_display.requesting_party_i_ds_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Requesting Party I Ds Group
cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Requesting Party Id: 5 Byte Ascii String
  index, requesting_party_id = cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_id(buffer, index, packet, parent)

  -- Requesting Party Id Source: 1 Byte Ascii String
  index, requesting_party_id_source = cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_id_source(buffer, index, packet, parent)

  -- Requesting Party Role: 1 Byte Ascii String
  index, requesting_party_role = cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_role(buffer, index, packet, parent)

  return index
end

-- Dissect: Requesting Party I Ds Group
cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_group = function(buffer, offset, packet, parent)
  if show.requesting_party_i_ds_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.requesting_party_i_ds_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.requesting_party_i_ds_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Requesting Party I Ds Groups
cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_i_ds_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.requesting_party_i_ds_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Requesting Party I Ds Groups
cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for requesting_party_i_ds_group_index = 1, num_in_group do
    index, requesting_party_i_ds_group = cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_group(buffer, index, packet, parent)

    if requesting_party_i_ds_group ~= nil then
      local iteration = requesting_party_i_ds_group:add(cme_futures_ilink3_sbe_v8_7.fields.requesting_party_i_ds_group_index, requesting_party_i_ds_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_request = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.requesting_party_i_ds_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_i_ds_groups(buffer, offset + index)

  return index
end

-- Display: Party Details List Request
cme_futures_ilink3_sbe_v8_7_display.party_details_list_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party Details List Request
cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_request_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, requesting_party_i_ds_groups = cme_futures_ilink3_sbe_v8_7_dissect.requesting_party_i_ds_groups(buffer, index, packet, parent)

  -- Party I Ds Groups: Struct of 2 fields
  index, party_i_ds_groups = cme_futures_ilink3_sbe_v8_7_dissect.party_i_ds_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Party Details List Request
cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_request = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Cxl Rej Reason
cme_futures_ilink3_sbe_v8_7_size_of.cxl_rej_reason = 2

-- Display: Cxl Rej Reason
cme_futures_ilink3_sbe_v8_7_display.cxl_rej_reason = function(value)
  return "Cxl Rej Reason: "..value
end

-- Dissect: Cxl Rej Reason
cme_futures_ilink3_sbe_v8_7_dissect.cxl_rej_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cxl_rej_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_replace_reject = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cxl_rej_reason
...
cme_futures_ilink3_sbe_v8_7_display.order_cancel_replace_reject = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Replace Reject
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_reject_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, cxl_rej_reason = cme_futures_ilink3_sbe_v8_7_dissect.cxl_rej_reason(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_reject = function(buffer, offset, packet, parent)
  if show.order_cancel_replace_reject then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.order_cancel_replace_reject, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_reject_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.order_cancel_replace_reject(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_reject_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Order Cancel Reject
cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_reject = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.order_cancel_reject = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Reject
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_reject_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_reject = function(buffer, offset, packet, parent)
  if show.order_cancel_reject then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.order_cancel_reject, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_reject_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.order_cancel_reject(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_reject_fields(buffer, offset, packet, element)
  end
end

-- Size: Cross Type
cme_futures_ilink3_sbe_v8_7_size_of.cross_type = 1

-- Display: Cross Type
cme_futures_ilink3_sbe_v8_7_display.cross_type = function(value)
  -- Check if field has value
  if value == 255 then
...
-- Dissect: Cross Type
cme_futures_ilink3_sbe_v8_7_dissect.cross_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cross_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Host Cross Id
cme_futures_ilink3_sbe_v8_7_size_of.host_cross_id = 8

-- Display: Host Cross Id
cme_futures_ilink3_sbe_v8_7_display.host_cross_id = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.host_cross_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.host_cross_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.cross_id_optional = 8

-- Display: Cross Id Optional
cme_futures_ilink3_sbe_v8_7_display.cross_id_optional = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.cross_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.cross_id_optional
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Stop Px
cme_futures_ilink3_sbe_v8_7_size_of.stop_px = 8

-- Display: Stop Px
cme_futures_ilink3_sbe_v8_7_display.stop_px = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
-- Dissect: Stop Px
cme_futures_ilink3_sbe_v8_7_dissect.stop_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.stop_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_cancel = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.stop_px
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cross_id_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.host_cross_id
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.cross_type
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_cancel = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Cancel
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_cancel_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, stop_px = cme_futures_ilink3_sbe_v8_7_dissect.stop_px(buffer, index, packet, parent)
  ...
  index, cross_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.cross_id_optional(buffer, index, packet, parent)

  -- Host Cross Id: 8 Byte Unsigned Fixed Width Integer Nullable
  index, host_cross_id = cme_futures_ilink3_sbe_v8_7_dissect.host_cross_id(buffer, index, packet, parent)
  ...
  index, cross_type = cme_futures_ilink3_sbe_v8_7_dissect.cross_type(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_cancel = function(buffer, offset, packet, parent)
  if show.execution_report_cancel then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_cancel, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_cancel_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_cancel(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_cancel_fields(buffer, offset, packet, element)
  end
end

-- Size: Ord Status Req Id
cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_id = 8

-- Display: Ord Status Req Id
cme_futures_ilink3_sbe_v8_7_display.ord_status_req_id = function(value)
  return "Ord Status Req Id: "..value
end

-- Dissect: Ord Status Req Id
cme_futures_ilink3_sbe_v8_7_dissect.ord_status_req_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_status_request = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_id
...
cme_futures_ilink3_sbe_v8_7_display.order_status_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Status Request
cme_futures_ilink3_sbe_v8_7_dissect.order_status_request_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, ord_status_req_id = cme_futures_ilink3_sbe_v8_7_dissect.ord_status_req_id(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.order_status_request = function(buffer, offset, packet, parent)
  if show.order_status_request then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.order_status_request, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.order_status_request_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.order_status_request(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.order_status_request_fields(buffer, offset, packet, element)
  end
end

-- Size: Last Rpt Requested
cme_futures_ilink3_sbe_v8_7_size_of.last_rpt_requested = 1

-- Display: Last Rpt Requested
cme_futures_ilink3_sbe_v8_7_display.last_rpt_requested = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.last_rpt_requested = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.last_rpt_requested
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Ord Status
cme_futures_ilink3_sbe_v8_7_size_of.ord_status = 1

-- Display: Ord Status
cme_futures_ilink3_sbe_v8_7_display.ord_status = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Ord Status
cme_futures_ilink3_sbe_v8_7_dissect.ord_status = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_status
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_id_optional = 8

-- Display: Mass Status Req Id Optional
cme_futures_ilink3_sbe_v8_7_display.mass_status_req_id_optional = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_status_req_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_id_optional
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_id_optional = 8

-- Display: Ord Status Req Id Optional
cme_futures_ilink3_sbe_v8_7_display.ord_status_req_id_optional = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.ord_status_req_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_id_optional
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Price Optional
cme_futures_ilink3_sbe_v8_7_size_of.price_optional = 8

-- Display: Price Optional
cme_futures_ilink3_sbe_v8_7_display.price_optional = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.price_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.price_optional
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_status = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.price_optional
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_id_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_id_optional
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_status
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.last_rpt_requested
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_status = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Status
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_status_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, price_optional = cme_futures_ilink3_sbe_v8_7_dissect.price_optional(buffer, index, packet, parent)
  ...
  index, ord_status_req_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.ord_status_req_id_optional(buffer, index, packet, parent)

  -- Mass Status Req Id Optional: 8 Byte Unsigned Fixed Width Integer Nullable
  index, mass_status_req_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.mass_status_req_id_optional(buffer, index, packet, parent)
  ...
  index, ord_status = cme_futures_ilink3_sbe_v8_7_dissect.ord_status(buffer, index, packet, parent)
  ...
  index, last_rpt_requested = cme_futures_ilink3_sbe_v8_7_dissect.last_rpt_requested(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_status = function(buffer, offset, packet, parent)
  if show.execution_report_status then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_status, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_status_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_status(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_status_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Modify
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_modify = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_modify = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Modify
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_modify_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_modify = function(buffer, offset, packet, parent)
  if show.execution_report_modify then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_modify, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_modify_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_modify(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_modify_fields(buffer, offset, packet, element)
  end
end

-- Size: Mass Status Tif
cme_futures_ilink3_sbe_v8_7_size_of.mass_status_tif = 1

-- Display: Mass Status Tif
cme_futures_ilink3_sbe_v8_7_display.mass_status_tif = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_status_tif = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_status_tif
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_type = 1

-- Display: Ord Status Req Type
cme_futures_ilink3_sbe_v8_7_display.ord_status_req_type = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.ord_status_req_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_type = 1

-- Display: Mass Status Req Type
cme_futures_ilink3_sbe_v8_7_display.mass_status_req_type = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_status_req_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_id = 8

-- Display: Mass Status Req Id
cme_futures_ilink3_sbe_v8_7_display.mass_status_req_id = function(value)
  return "Mass Status Req Id: "..value
end

-- Dissect: Mass Status Req Id
cme_futures_ilink3_sbe_v8_7_dissect.mass_status_req_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_mass_status_request = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_id
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_status_req_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_status_req_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_status_tif
...
cme_futures_ilink3_sbe_v8_7_display.order_mass_status_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Mass Status Request
cme_futures_ilink3_sbe_v8_7_dissect.order_mass_status_request_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, mass_status_req_id = cme_futures_ilink3_sbe_v8_7_dissect.mass_status_req_id(buffer, index, packet, parent)
  ...
  index, mass_status_req_type = cme_futures_ilink3_sbe_v8_7_dissect.mass_status_req_type(buffer, index, packet, parent)

  -- Ord Status Req Type: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, ord_status_req_type = cme_futures_ilink3_sbe_v8_7_dissect.ord_status_req_type(buffer, index, packet, parent)

  -- Mass Status Tif: 1 Byte Unsigned Fixed Width Integer Enum with 5 values
  index, mass_status_tif = cme_futures_ilink3_sbe_v8_7_dissect.mass_status_tif(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.order_mass_status_request = function(buffer, offset, packet, parent)
  if show.order_mass_status_request then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.order_mass_status_request, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.order_mass_status_request_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.order_mass_status_request(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.order_mass_status_request_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Order Mass Action Request
cme_futures_ilink3_sbe_v8_7_size_of.order_mass_action_request = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.order_mass_action_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Mass Action Request
cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_request_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_request = function(buffer, offset, packet, parent)
  if show.order_mass_action_request then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.order_mass_action_request, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_request_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.order_mass_action_request(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_request_fields(buffer, offset, packet, element)
  end
end

-- Size: Offer Size
cme_futures_ilink3_sbe_v8_7_size_of.offer_size = 4

-- Display: Offer Size
cme_futures_ilink3_sbe_v8_7_display.offer_size = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
-- Dissect: Offer Size
cme_futures_ilink3_sbe_v8_7_dissect.offer_size = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.offer_size
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Bid Size
cme_futures_ilink3_sbe_v8_7_size_of.bid_size = 4

-- Display: Bid Size
cme_futures_ilink3_sbe_v8_7_display.bid_size = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
-- Dissect: Bid Size
cme_futures_ilink3_sbe_v8_7_dissect.bid_size = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.bid_size
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_set_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.bid_size

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.offer_size
...
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_set_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Set Group
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Bid Size: 4 Byte Unsigned Fixed Width Integer Nullable
  index, bid_size = cme_futures_ilink3_sbe_v8_7_dissect.bid_size(buffer, index, packet, parent)

  -- Offer Size: 4 Byte Unsigned Fixed Width Integer Nullable
  index, offer_size = cme_futures_ilink3_sbe_v8_7_dissect.offer_size(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_group = function(buffer, offset, packet, parent)
  if show.quote_cancel_set_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_set_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.quote_cancel_set_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Quote Cancel Set Groups
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_set_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_set_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Set Groups
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for quote_cancel_set_group_index = 1, num_in_group do
    index, quote_cancel_set_group = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_group(buffer, index, packet, parent)

    if quote_cancel_set_group ~= nil then
      local iteration = quote_cancel_set_group:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_set_group_index, quote_cancel_set_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_entry_group = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_entry_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Entry Group
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_group = function(buffer, offset, packet, parent)
  if show.quote_cancel_entry_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_entry_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.quote_cancel_entry_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Quote Cancel Entry Groups
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_entry_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_entry_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel Entry Groups
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for quote_cancel_entry_group_index = 1, num_in_group do
    index, quote_cancel_entry_group = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_group(buffer, index, packet, parent)

    if quote_cancel_entry_group ~= nil then
      local iteration = quote_cancel_entry_group:add(cme_futures_ilink3_sbe_v8_7.fields.quote_cancel_entry_group_index, quote_cancel_entry_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_type = 1

-- Display: Quote Cancel Type
cme_futures_ilink3_sbe_v8_7_display.quote_cancel_type = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.liquidity_flag

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_entry_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_set_groups(buffer, offset + index)

  return index
end

-- Display: Quote Cancel
cme_futures_ilink3_sbe_v8_7_display.quote_cancel = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Quote Cancel
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, quote_cancel_type = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_type(buffer, index, packet, parent)

  -- Liquidity Flag: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, liquidity_flag = cme_futures_ilink3_sbe_v8_7_dissect.liquidity_flag(buffer, index, packet, parent)

  -- Quote Cancel Entry Groups: Struct of 2 fields
  index, quote_cancel_entry_groups = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_entry_groups(buffer, index, packet, parent)

  -- Quote Cancel Set Groups: Struct of 2 fields
  index, quote_cancel_set_groups = cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_set_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Quote Cancel
cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.order_event_type = 1

-- Display: Order Event Type
cme_futures_ilink3_sbe_v8_7_display.order_event_type = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.order_event_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_event_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg_order_event_group = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_event_type
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_leg_order_event_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread Leg Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_group_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, order_event_type = cme_futures_ilink3_sbe_v8_7_dissect.order_event_type(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_spread_leg_order_event_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_spread_leg_order_event_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_leg_order_event_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Spread Leg Order Event Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg_order_event_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_leg_order_event_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread Leg Order Event Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_spread_leg_order_event_group_index = 1, num_in_group do
    index, execution_report_trade_spread_leg_order_event_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_group(buffer, index, packet, parent)

    if execution_report_trade_spread_leg_order_event_group ~= nil then
      local iteration = execution_report_trade_spread_leg_order_event_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_spread_leg_order_event_group_index, execution_report_trade_spread_leg_order_event_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Ord Status Trd
cme_futures_ilink3_sbe_v8_7_size_of.ord_status_trd = 1

-- Display: Ord Status Trd
cme_futures_ilink3_sbe_v8_7_display.ord_status_trd = function(value)
  if value == 1 then
...
cme_futures_ilink3_sbe_v8_7_dissect.ord_status_trd = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_status_trd
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.risk_free_rate = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.risk_free_rate = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Risk Free Rate
cme_futures_ilink3_sbe_v8_7_dissect.risk_free_rate_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.risk_free_rate = function(buffer, offset, packet, parent)
  if show.risk_free_rate then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.risk_free_rate, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.risk_free_rate_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.risk_free_rate(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.risk_free_rate_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Time To Expiration
cme_futures_ilink3_sbe_v8_7_size_of.time_to_expiration = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.time_to_expiration = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Time To Expiration
cme_futures_ilink3_sbe_v8_7_dissect.time_to_expiration_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.time_to_expiration = function(buffer, offset, packet, parent)
  if show.time_to_expiration then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.time_to_expiration, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.time_to_expiration_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.time_to_expiration(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.time_to_expiration_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Option Delta
cme_futures_ilink3_sbe_v8_7_size_of.option_delta = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.option_delta = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Option Delta
cme_futures_ilink3_sbe_v8_7_dissect.option_delta_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.option_delta = function(buffer, offset, packet, parent)
  if show.option_delta then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.option_delta, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.option_delta_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.option_delta(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.option_delta_fields(buffer, offset, packet, element)
  end
end

-- Size: Underlying Px
cme_futures_ilink3_sbe_v8_7_size_of.underlying_px = 8

-- Display: Underlying Px
cme_futures_ilink3_sbe_v8_7_display.underlying_px = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.underlying_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.underlying_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.volatility = function(buffer, offset)
  local index = 0
...
-- Display: Volatility
cme_futures_ilink3_sbe_v8_7_display.volatility = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Volatility
cme_futures_ilink3_sbe_v8_7_dissect.volatility_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.volatility = function(buffer, offset, packet, parent)
  if show.volatility then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.volatility, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.volatility_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.volatility(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.volatility_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Spread Leg
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.volatility(buffer, offset + index)
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.underlying_px
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.option_delta(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.time_to_expiration(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.risk_free_rate(buffer, offset + index)
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_status_trd
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg_order_event_groups(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Spread Leg
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_leg = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread Leg
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, volatility = cme_futures_ilink3_sbe_v8_7_dissect.volatility(buffer, index, packet, parent)
  ...
  index, underlying_px = cme_futures_ilink3_sbe_v8_7_dissect.underlying_px(buffer, index, packet, parent)
  ...
  index, option_delta = cme_futures_ilink3_sbe_v8_7_dissect.option_delta(buffer, index, packet, parent)

  -- Time To Expiration: Struct of 2 fields
  index, time_to_expiration = cme_futures_ilink3_sbe_v8_7_dissect.time_to_expiration(buffer, index, packet, parent)

  -- Risk Free Rate: Struct of 2 fields
  index, risk_free_rate = cme_futures_ilink3_sbe_v8_7_dissect.risk_free_rate(buffer, index, packet, parent)
  ...
  index, ord_status_trd = cme_futures_ilink3_sbe_v8_7_dissect.ord_status_trd(buffer, index, packet, parent)
  ...
  index, execution_report_trade_spread_leg_order_event_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_order_event_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Spread Leg
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_order_event_group = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_order_event_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_spread_order_event_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_spread_order_event_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_order_event_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Spread Order Event Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_order_event_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_order_event_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread Order Event Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_spread_order_event_group_index = 1, num_in_group do
    index, execution_report_trade_spread_order_event_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_group(buffer, index, packet, parent)

    if execution_report_trade_spread_order_event_group ~= nil then
      local iteration = execution_report_trade_spread_order_event_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_spread_order_event_group_index, execution_report_trade_spread_order_event_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg_group = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_leg_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread Leg Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_spread_leg_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_spread_leg_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_leg_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Spread Leg Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread_leg_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread Leg Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_spread_leg_group_index = 1, num_in_group do
    index, execution_report_trade_spread_leg_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_group(buffer, index, packet, parent)

    if execution_report_trade_spread_leg_group ~= nil then
      local iteration = execution_report_trade_spread_leg_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_spread_leg_group_index, execution_report_trade_spread_leg_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.aggressor_indicator = 1

-- Display: Aggressor Indicator
cme_futures_ilink3_sbe_v8_7_display.aggressor_indicator = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.aggressor_indicator = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.aggressor_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.aggressor_indicator
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg_groups(buffer, offset + index)

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_order_event_groups(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Spread
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_spread = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Spread
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, aggressor_indicator = cme_futures_ilink3_sbe_v8_7_dissect.aggressor_indicator(buffer, index, packet, parent)
  ...
  index, execution_report_trade_spread_leg_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg_groups(buffer, index, packet, parent)

  -- Execution Report Trade Spread Order Event Groups: Struct of 2 fields
  index, execution_report_trade_spread_order_event_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_order_event_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Spread
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_outright_order_event_group = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_outright_order_event_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Outright Order Event Group
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_group_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_group = function(buffer, offset, packet, parent)
  if show.execution_report_trade_outright_order_event_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_outright_order_event_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_outright_order_event_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report Trade Outright Order Event Groups
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_outright_order_event_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_outright_order_event_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Outright Order Event Groups
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for execution_report_trade_outright_order_event_group_index = 1, num_in_group do
    index, execution_report_trade_outright_order_event_group = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_group(buffer, index, packet, parent)

    if execution_report_trade_outright_order_event_group ~= nil then
      local iteration = execution_report_trade_outright_order_event_group:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_trade_outright_order_event_group_index, execution_report_trade_outright_order_event_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Ownership
cme_futures_ilink3_sbe_v8_7_size_of.ownership = 1

-- Display: Ownership
cme_futures_ilink3_sbe_v8_7_display.ownership = function(value)
  return "Ownership: "..value
end

-- Dissect: Ownership
cme_futures_ilink3_sbe_v8_7_dissect.ownership = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ownership
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Trade Link Id
cme_futures_ilink3_sbe_v8_7_size_of.trade_link_id = 4

-- Display: Trade Link Id
cme_futures_ilink3_sbe_v8_7_display.trade_link_id = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
cme_futures_ilink3_sbe_v8_7_dissect.trade_link_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trade_link_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_outright = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trade_link_id
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ownership
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_outright_order_event_groups(buffer, offset + index)

  return index
end

-- Display: Execution Report Trade Outright
cme_futures_ilink3_sbe_v8_7_display.execution_report_trade_outright = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Trade Outright
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, trade_link_id = cme_futures_ilink3_sbe_v8_7_dissect.trade_link_id(buffer, index, packet, parent)
  ...
  index, ownership = cme_futures_ilink3_sbe_v8_7_dissect.ownership(buffer, index, packet, parent)
  ...
  index, execution_report_trade_outright_order_event_groups = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright_order_event_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Execution Report Trade Outright
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_elimination = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_elimination = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Elimination
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_elimination_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_elimination = function(buffer, offset, packet, parent)
  if show.execution_report_elimination then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_elimination, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_elimination_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_elimination(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_elimination_fields(buffer, offset, packet, element)
  end
end

-- Size: Ord Rej Reason
cme_futures_ilink3_sbe_v8_7_size_of.ord_rej_reason = 2

-- Display: Ord Rej Reason
cme_futures_ilink3_sbe_v8_7_display.ord_rej_reason = function(value)
  return "Ord Rej Reason: "..value
end

-- Dissect: Ord Rej Reason
cme_futures_ilink3_sbe_v8_7_dissect.ord_rej_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_rej_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_reject = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_rej_reason
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_reject = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report Reject
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_reject_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, ord_rej_reason = cme_futures_ilink3_sbe_v8_7_dissect.ord_rej_reason(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_reject = function(buffer, offset, packet, parent)
  if show.execution_report_reject then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_reject, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_reject_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_reject(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_reject_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Execution Report New
cme_futures_ilink3_sbe_v8_7_size_of.execution_report_new = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.execution_report_new = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Execution Report New
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_new_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.execution_report_new = function(buffer, offset, packet, parent)
  if show.execution_report_new then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.execution_report_new, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.execution_report_new_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.execution_report_new(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_new_fields(buffer, offset, packet, element)
  end
end

-- Size: Manual Order Indicator Optional
cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator_optional = 1

-- Display: Manual Order Indicator Optional
cme_futures_ilink3_sbe_v8_7_display.manual_order_indicator_optional = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.manual_order_indicator_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator_optional
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Ref Msg Type
cme_futures_ilink3_sbe_v8_7_size_of.ref_msg_type = 2

-- Display: Ref Msg Type
cme_futures_ilink3_sbe_v8_7_display.ref_msg_type = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.ref_msg_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ref_msg_type
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.business_reject_reason = 2

-- Display: Business Reject Reason
cme_futures_ilink3_sbe_v8_7_display.business_reject_reason = function(value)
  return "Business Reject Reason: "..value
end

-- Dissect: Business Reject Reason
cme_futures_ilink3_sbe_v8_7_dissect.business_reject_reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.business_reject_reason
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Ref Tag Id
cme_futures_ilink3_sbe_v8_7_size_of.ref_tag_id = 2

-- Display: Ref Tag Id
cme_futures_ilink3_sbe_v8_7_display.ref_tag_id = function(value)
  -- Check if field has value
  if value == 65535 then
...
-- Dissect: Ref Tag Id
cme_futures_ilink3_sbe_v8_7_dissect.ref_tag_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ref_tag_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Ref Seq Num
cme_futures_ilink3_sbe_v8_7_size_of.ref_seq_num = 4

-- Display: Ref Seq Num
cme_futures_ilink3_sbe_v8_7_display.ref_seq_num = function(value)
  -- Check if field has value
  if value == 4294967295 then
...
-- Dissect: Ref Seq Num
cme_futures_ilink3_sbe_v8_7_dissect.ref_seq_num = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ref_seq_num
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.location_optional = 5

-- Display: Location Optional
cme_futures_ilink3_sbe_v8_7_display.location_optional = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.location_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.location_optional
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.business_reject_ref_id = 8

-- Display: Business Reject Ref Id
cme_futures_ilink3_sbe_v8_7_display.business_reject_ref_id = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.business_reject_ref_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.business_reject_ref_id
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id_optional = 8

-- Display: Party Details List Req Id Optional
cme_futures_ilink3_sbe_v8_7_display.party_details_list_req_id_optional = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_req_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id_optional
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.business_reject = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_req_id_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.sending_time_epoch

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.business_reject_ref_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.location_optional

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ref_seq_num

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ref_tag_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.business_reject_reason

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ref_msg_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.poss_retrans_flag

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator_optional
...
cme_futures_ilink3_sbe_v8_7_display.business_reject = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Business Reject
cme_futures_ilink3_sbe_v8_7_dissect.business_reject_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, party_details_list_req_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_req_id_optional(buffer, index, packet, parent)

  -- Sending Time Epoch: 8 Byte Unsigned Fixed Width Integer
  index, sending_time_epoch = cme_futures_ilink3_sbe_v8_7_dissect.sending_time_epoch(buffer, index, packet, parent)

  -- Business Reject Ref Id: 8 Byte Unsigned Fixed Width Integer Nullable
  index, business_reject_ref_id = cme_futures_ilink3_sbe_v8_7_dissect.business_reject_ref_id(buffer, index, packet, parent)

  -- Location Optional: 5 Byte Ascii String
  index, location_optional = cme_futures_ilink3_sbe_v8_7_dissect.location_optional(buffer, index, packet, parent)

  -- Ref Seq Num: 4 Byte Unsigned Fixed Width Integer Nullable
  index, ref_seq_num = cme_futures_ilink3_sbe_v8_7_dissect.ref_seq_num(buffer, index, packet, parent)

  -- Ref Tag Id: 2 Byte Unsigned Fixed Width Integer Nullable
  index, ref_tag_id = cme_futures_ilink3_sbe_v8_7_dissect.ref_tag_id(buffer, index, packet, parent)

  -- Business Reject Reason: 2 Byte Unsigned Fixed Width Integer
  index, business_reject_reason = cme_futures_ilink3_sbe_v8_7_dissect.business_reject_reason(buffer, index, packet, parent)

  -- Ref Msg Type: 2 Byte Ascii String
  index, ref_msg_type = cme_futures_ilink3_sbe_v8_7_dissect.ref_msg_type(buffer, index, packet, parent)

  -- Poss Retrans Flag: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, poss_retrans_flag = cme_futures_ilink3_sbe_v8_7_dissect.poss_retrans_flag(buffer, index, packet, parent)

  -- Manual Order Indicator Optional: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, manual_order_indicator_optional = cme_futures_ilink3_sbe_v8_7_dissect.manual_order_indicator_optional(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.business_reject = function(buffer, offset, packet, parent)
  if show.business_reject then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.business_reject, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.business_reject_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.business_reject(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.business_reject_fields(buffer, offset, packet, element)
  end
end

-- Size: Party Detail Definition Status
cme_futures_ilink3_sbe_v8_7_size_of.party_detail_definition_status = 1

-- Display: Party Detail Definition Status
cme_futures_ilink3_sbe_v8_7_display.party_detail_definition_status = function(value)
  return "Party Detail Definition Status: "..value
end

-- Dissect: Party Detail Definition Status
cme_futures_ilink3_sbe_v8_7_dissect.party_detail_definition_status = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_detail_definition_status
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.list_update_action = 1

-- Display: List Update Action
cme_futures_ilink3_sbe_v8_7_display.list_update_action = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.list_update_action = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.list_update_action
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.party_detail_request_status = 1

-- Display: Party Detail Request Status
cme_futures_ilink3_sbe_v8_7_display.party_detail_request_status = function(value)
  return "Party Detail Request Status: "..value
end

-- Dissect: Party Detail Request Status
cme_futures_ilink3_sbe_v8_7_dissect.party_detail_request_status = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.party_detail_request_status
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Memo
cme_futures_ilink3_sbe_v8_7_size_of.memo = 75

-- Display: Memo
cme_futures_ilink3_sbe_v8_7_display.memo = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Memo
cme_futures_ilink3_sbe_v8_7_dissect.memo = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.memo
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_definition_request_ack = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.memo
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_detail_request_status
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.list_update_action

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.party_detail_definition_status
...
cme_futures_ilink3_sbe_v8_7_display.party_details_definition_request_ack = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party Details Definition Request Ack
cme_futures_ilink3_sbe_v8_7_dissect.party_details_definition_request_ack_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, memo = cme_futures_ilink3_sbe_v8_7_dissect.memo(buffer, index, packet, parent)
  ...
  index, party_detail_request_status = cme_futures_ilink3_sbe_v8_7_dissect.party_detail_request_status(buffer, index, packet, parent)
  ...
  index, list_update_action = cme_futures_ilink3_sbe_v8_7_dissect.list_update_action(buffer, index, packet, parent)

  -- Party Detail Definition Status: 1 Byte Unsigned Fixed Width Integer
  index, party_detail_definition_status = cme_futures_ilink3_sbe_v8_7_dissect.party_detail_definition_status(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.party_details_definition_request_ack = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.party_details_definition_request = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.party_details_definition_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Party Details Definition Request
cme_futures_ilink3_sbe_v8_7_dissect.party_details_definition_request_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.party_details_definition_request = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.underlying_security_id = 4

-- Display: Underlying Security Id
cme_futures_ilink3_sbe_v8_7_display.underlying_security_id = function(value)
  -- Check if field has value
  if value == 2147483647 then
...
cme_futures_ilink3_sbe_v8_7_dissect.underlying_security_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.underlying_security_id
  local range = buffer(offset, length)
  local value = range:le_int()
...
-- Size: Offer Px
cme_futures_ilink3_sbe_v8_7_size_of.offer_px = 8

-- Display: Offer Px
cme_futures_ilink3_sbe_v8_7_display.offer_px = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
-- Dissect: Offer Px
cme_futures_ilink3_sbe_v8_7_dissect.offer_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.offer_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
-- Size: Bid Px
cme_futures_ilink3_sbe_v8_7_size_of.bid_px = 8

-- Display: Bid Px
cme_futures_ilink3_sbe_v8_7_display.bid_px = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
-- Dissect: Bid Px
cme_futures_ilink3_sbe_v8_7_dissect.bid_px = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.bid_px
  local range = buffer(offset, length)
  local raw = range:le_int64()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_entry_group = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.bid_px

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.offer_px
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.underlying_security_id
...
cme_futures_ilink3_sbe_v8_7_display.mass_quote_entry_group = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Quote Entry Group
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_group_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Bid Px: 8 Byte Signed Fixed Width Integer Nullable
  index, bid_px = cme_futures_ilink3_sbe_v8_7_dissect.bid_px(buffer, index, packet, parent)

  -- Offer Px: 8 Byte Signed Fixed Width Integer Nullable
  index, offer_px = cme_futures_ilink3_sbe_v8_7_dissect.offer_px(buffer, index, packet, parent)
  ...
  index, underlying_security_id = cme_futures_ilink3_sbe_v8_7_dissect.underlying_security_id(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_group = function(buffer, offset, packet, parent)
  if show.mass_quote_entry_group then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.mass_quote_entry_group, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_group_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.mass_quote_entry_group(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_group_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Mass Quote Entry Groups
cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_entry_groups = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.mass_quote_entry_groups = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Quote Entry Groups
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_groups_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for mass_quote_entry_group_index = 1, num_in_group do
    index, mass_quote_entry_group = cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_group(buffer, index, packet, parent)

    if mass_quote_entry_group ~= nil then
      local iteration = mass_quote_entry_group:add(cme_futures_ilink3_sbe_v8_7.fields.mass_quote_entry_group_index, mass_quote_entry_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_groups = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Reserved
cme_futures_ilink3_sbe_v8_7_size_of.reserved = 30

-- Display: Reserved
cme_futures_ilink3_sbe_v8_7_display.reserved = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Reserved
cme_futures_ilink3_sbe_v8_7_dissect.reserved = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.reserved
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.tot_no_quote_entries = 1

-- Display: Tot No Quote Entries
cme_futures_ilink3_sbe_v8_7_display.tot_no_quote_entries = function(value)
  return "Tot No Quote Entries: "..value
end

-- Dissect: Tot No Quote Entries
cme_futures_ilink3_sbe_v8_7_dissect.tot_no_quote_entries = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.tot_no_quote_entries
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.mass_quote = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.tot_no_quote_entries
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.reserved

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_entry_groups(buffer, offset + index)

  return index
end

-- Display: Mass Quote
cme_futures_ilink3_sbe_v8_7_display.mass_quote = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Mass Quote
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, tot_no_quote_entries = cme_futures_ilink3_sbe_v8_7_dissect.tot_no_quote_entries(buffer, index, packet, parent)
  ...
  index, reserved = cme_futures_ilink3_sbe_v8_7_dissect.reserved(buffer, index, packet, parent)

  -- Mass Quote Entry Groups: Struct of 2 fields
  index, mass_quote_entry_groups = cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_entry_groups(buffer, index, packet, parent)

  return index
end

-- Dissect: Mass Quote
cme_futures_ilink3_sbe_v8_7_dissect.mass_quote = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.order_id_optional = 8

-- Display: Order Id Optional
cme_futures_ilink3_sbe_v8_7_display.order_id_optional = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
cme_futures_ilink3_sbe_v8_7_dissect.order_id_optional = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.order_id_optional
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_request = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.order_id_optional
...
cme_futures_ilink3_sbe_v8_7_display.order_cancel_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Request
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_request_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Order Id Optional: 8 Byte Unsigned Fixed Width Integer Nullable
  index, order_id_optional = cme_futures_ilink3_sbe_v8_7_dissect.order_id_optional(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_request = function(buffer, offset, packet, parent)
  if show.order_cancel_request then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.order_cancel_request, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_request_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.order_cancel_request(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_request_fields(buffer, offset, packet, element)
  end
end

-- Size: Ofm Override
cme_futures_ilink3_sbe_v8_7_size_of.ofm_override = 1

-- Display: Ofm Override
cme_futures_ilink3_sbe_v8_7_display.ofm_override = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.ofm_override = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ofm_override
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Ord Type
cme_futures_ilink3_sbe_v8_7_size_of.ord_type = 1

-- Display: Ord Type
cme_futures_ilink3_sbe_v8_7_display.ord_type = function(value)
  -- Check if field has value
  if value == nil or value == 0 then
...
-- Dissect: Ord Type
cme_futures_ilink3_sbe_v8_7_dissect.ord_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.ord_type
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_replace_request = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ord_type

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.time_in_force

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.manual_order_indicator

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.ofm_override
...
cme_futures_ilink3_sbe_v8_7_display.order_cancel_replace_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Order Cancel Replace Request
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_request_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, ord_type = cme_futures_ilink3_sbe_v8_7_dissect.ord_type(buffer, index, packet, parent)
  ...
  index, ofm_override = cme_futures_ilink3_sbe_v8_7_dissect.ofm_override(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_request = function(buffer, offset, packet, parent)
  if show.order_cancel_replace_request then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.order_cancel_replace_request, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_request_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.order_cancel_replace_request(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_request_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: New Order Single
cme_futures_ilink3_sbe_v8_7_size_of.new_order_single = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.new_order_single = function(packet, parent, length)
  return ""
end

-- Dissect Fields: New Order Single
cme_futures_ilink3_sbe_v8_7_dissect.new_order_single_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.new_order_single = function(buffer, offset, packet, parent)
  if show.new_order_single then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.new_order_single, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.new_order_single_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.new_order_single(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.new_order_single_fields(buffer, offset, packet, element)
  end
end

-- Size: Msg Count
cme_futures_ilink3_sbe_v8_7_size_of.msg_count = 4

-- Display: Msg Count
cme_futures_ilink3_sbe_v8_7_display.msg_count = function(value)
  return "Msg Count: "..value
end

-- Dissect: Msg Count
cme_futures_ilink3_sbe_v8_7_dissect.msg_count = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.msg_count
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: From Seq No
cme_futures_ilink3_sbe_v8_7_size_of.from_seq_no = 4

-- Display: From Seq No
cme_futures_ilink3_sbe_v8_7_display.from_seq_no = function(value)
  return "From Seq No: "..value
end

-- Dissect: From Seq No
cme_futures_ilink3_sbe_v8_7_dissect.from_seq_no = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.from_seq_no
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.not_applied = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.uuid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.from_seq_no

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.msg_count
...
-- Display: Not Applied
cme_futures_ilink3_sbe_v8_7_display.not_applied = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Not Applied
cme_futures_ilink3_sbe_v8_7_dissect.not_applied_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, from_seq_no = cme_futures_ilink3_sbe_v8_7_dissect.from_seq_no(buffer, index, packet, parent)

  -- Msg Count: 4 Byte Unsigned Fixed Width Integer
  index, msg_count = cme_futures_ilink3_sbe_v8_7_dissect.msg_count(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.not_applied = function(buffer, offset, packet, parent)
  if show.not_applied then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.not_applied, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.not_applied_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.not_applied(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.not_applied_fields(buffer, offset, packet, element)
  end
end

-- Size: Error Codes
cme_futures_ilink3_sbe_v8_7_size_of.error_codes = 2

-- Display: Error Codes
cme_futures_ilink3_sbe_v8_7_display.error_codes = function(value)
  return "Error Codes: "..value
end

-- Dissect: Error Codes
cme_futures_ilink3_sbe_v8_7_dissect.error_codes = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.error_codes
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.request_timestamp = 8

-- Display: Request Timestamp
cme_futures_ilink3_sbe_v8_7_display.request_timestamp = function(value)
  return "Request Timestamp: "..value
end

-- Dissect: Request Timestamp
cme_futures_ilink3_sbe_v8_7_dissect.request_timestamp = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.request_timestamp
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Last Uuid
cme_futures_ilink3_sbe_v8_7_size_of.last_uuid = 8

-- Display: Last Uuid
cme_futures_ilink3_sbe_v8_7_display.last_uuid = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFFF) then
...
-- Dissect: Last Uuid
cme_futures_ilink3_sbe_v8_7_dissect.last_uuid = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.last_uuid
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
-- Size: Reason
cme_futures_ilink3_sbe_v8_7_size_of.reason = 48

-- Display: Reason
cme_futures_ilink3_sbe_v8_7_display.reason = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Reason
cme_futures_ilink3_sbe_v8_7_dissect.reason = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.reason
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.retransmit_reject = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.reason

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.uuid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.last_uuid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.request_timestamp

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.error_codes
...
cme_futures_ilink3_sbe_v8_7_display.retransmit_reject = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Retransmit Reject
cme_futures_ilink3_sbe_v8_7_dissect.retransmit_reject_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Reason: 48 Byte Ascii String
  index, reason = cme_futures_ilink3_sbe_v8_7_dissect.reason(buffer, index, packet, parent)

  -- Uuid: 8 Byte Unsigned Fixed Width Integer
  index, uuid = cme_futures_ilink3_sbe_v8_7_dissect.uuid(buffer, index, packet, parent)

  -- Last Uuid: 8 Byte Unsigned Fixed Width Integer Nullable
  index, last_uuid = cme_futures_ilink3_sbe_v8_7_dissect.last_uuid(buffer, index, packet, parent)

  -- Request Timestamp: 8 Byte Unsigned Fixed Width Integer
  index, request_timestamp = cme_futures_ilink3_sbe_v8_7_dissect.request_timestamp(buffer, index, packet, parent)

  -- Error Codes: 2 Byte Unsigned Fixed Width Integer
  index, error_codes = cme_futures_ilink3_sbe_v8_7_dissect.error_codes(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.retransmit_reject = function(buffer, offset, packet, parent)
  if show.retransmit_reject then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.retransmit_reject, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.retransmit_reject_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.retransmit_reject(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.retransmit_reject_fields(buffer, offset, packet, element)
  end
end

-- Size: Msg Count 16
cme_futures_ilink3_sbe_v8_7_size_of.msg_count_16 = 2

-- Display: Msg Count 16
cme_futures_ilink3_sbe_v8_7_display.msg_count_16 = function(value)
  return "Msg Count 16: "..value
end

-- Dissect: Msg Count 16
cme_futures_ilink3_sbe_v8_7_dissect.msg_count_16 = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.msg_count_16
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.retransmission = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.msg_count_16
...
cme_futures_ilink3_sbe_v8_7_display.retransmission = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Retransmission
cme_futures_ilink3_sbe_v8_7_dissect.retransmission_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, msg_count_16 = cme_futures_ilink3_sbe_v8_7_dissect.msg_count_16(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.retransmission = function(buffer, offset, packet, parent)
  if show.retransmission then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.retransmission, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.retransmission_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.retransmission(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.retransmission_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Retransmit Request
cme_futures_ilink3_sbe_v8_7_size_of.retransmit_request = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.retransmit_request = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Retransmit Request
cme_futures_ilink3_sbe_v8_7_dissect.retransmit_request_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.retransmit_request = function(buffer, offset, packet, parent)
  if show.retransmit_request then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.retransmit_request, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.retransmit_request_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.retransmit_request(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.retransmit_request_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Terminate
cme_futures_ilink3_sbe_v8_7_size_of.terminate = function(buffer, offset)
  local index = 0
...
-- Display: Terminate
cme_futures_ilink3_sbe_v8_7_display.terminate = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Terminate
cme_futures_ilink3_sbe_v8_7_dissect.terminate_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.terminate = function(buffer, offset, packet, parent)
  if show.terminate then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.terminate, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.terminate_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.terminate(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.terminate_fields(buffer, offset, packet, element)
  end
end

-- Size: Keep Alive Interval Lapsed
cme_futures_ilink3_sbe_v8_7_size_of.keep_alive_interval_lapsed = 1

-- Display: Keep Alive Interval Lapsed
cme_futures_ilink3_sbe_v8_7_display.keep_alive_interval_lapsed = function(value)
  if value == 0 then
...
cme_futures_ilink3_sbe_v8_7_dissect.keep_alive_interval_lapsed = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.keep_alive_interval_lapsed
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.fault_tolerance_indicator = 1

-- Display: Fault Tolerance Indicator
cme_futures_ilink3_sbe_v8_7_display.fault_tolerance_indicator = function(value)
  if value == 255 then
...
cme_futures_ilink3_sbe_v8_7_dissect.fault_tolerance_indicator = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.fault_tolerance_indicator
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Next Seq No
cme_futures_ilink3_sbe_v8_7_size_of.next_seq_no = 4

-- Display: Next Seq No
cme_futures_ilink3_sbe_v8_7_display.next_seq_no = function(value)
  return "Next Seq No: "..value
end

-- Dissect: Next Seq No
cme_futures_ilink3_sbe_v8_7_dissect.next_seq_no = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.next_seq_no
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.sequence = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.uuid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.next_seq_no

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.fault_tolerance_indicator

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.keep_alive_interval_lapsed

  return index
end

-- Display: Sequence
cme_futures_ilink3_sbe_v8_7_display.sequence = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Sequence
cme_futures_ilink3_sbe_v8_7_dissect.sequence_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, next_seq_no = cme_futures_ilink3_sbe_v8_7_dissect.next_seq_no(buffer, index, packet, parent)

  -- Fault Tolerance Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, fault_tolerance_indicator = cme_futures_ilink3_sbe_v8_7_dissect.fault_tolerance_indicator(buffer, index, packet, parent)

  -- Keep Alive Interval Lapsed: 1 Byte Unsigned Fixed Width Integer Enum with 2 values
  index, keep_alive_interval_lapsed = cme_futures_ilink3_sbe_v8_7_dissect.keep_alive_interval_lapsed(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.sequence = function(buffer, offset, packet, parent)
  if show.sequence then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.sequence, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.sequence_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.sequence(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.sequence_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Establishment Reject
cme_futures_ilink3_sbe_v8_7_size_of.establishment_reject = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.establishment_reject = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Establishment Reject
cme_futures_ilink3_sbe_v8_7_dissect.establishment_reject_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.establishment_reject = function(buffer, offset, packet, parent)
  if show.establishment_reject then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.establishment_reject, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.establishment_reject_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.establishment_reject(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.establishment_reject_fields(buffer, offset, packet, element)
  end
end

-- Size: Secret Key Secure Id Expiration
cme_futures_ilink3_sbe_v8_7_size_of.secret_key_secure_id_expiration = 2

-- Display: Secret Key Secure Id Expiration
cme_futures_ilink3_sbe_v8_7_display.secret_key_secure_id_expiration = function(value)
  -- Check if field has value
  if value == 65535 then
...
cme_futures_ilink3_sbe_v8_7_dissect.secret_key_secure_id_expiration = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.secret_key_secure_id_expiration
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.keep_alive_interval = 2

-- Display: Keep Alive Interval
cme_futures_ilink3_sbe_v8_7_display.keep_alive_interval = function(value)
  return "Keep Alive Interval: "..value
end

-- Dissect: Keep Alive Interval
cme_futures_ilink3_sbe_v8_7_dissect.keep_alive_interval = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.keep_alive_interval
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Previous Uuid
cme_futures_ilink3_sbe_v8_7_size_of.previous_uuid = 8

-- Display: Previous Uuid
cme_futures_ilink3_sbe_v8_7_display.previous_uuid = function(value)
  return "Previous Uuid: "..value
end

-- Dissect: Previous Uuid
cme_futures_ilink3_sbe_v8_7_dissect.previous_uuid = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.previous_uuid
  local range = buffer(offset, length)
  local value = range:le_uint64()
...
cme_futures_ilink3_sbe_v8_7_size_of.previous_seq_no = 4

-- Display: Previous Seq No
cme_futures_ilink3_sbe_v8_7_display.previous_seq_no = function(value)
  return "Previous Seq No: "..value
end

-- Dissect: Previous Seq No
cme_futures_ilink3_sbe_v8_7_dissect.previous_seq_no = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.previous_seq_no
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.establishment_ack = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.previous_seq_no

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.previous_uuid

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.keep_alive_interval

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.secret_key_secure_id_expiration
...
cme_futures_ilink3_sbe_v8_7_display.establishment_ack = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Establishment Ack
cme_futures_ilink3_sbe_v8_7_dissect.establishment_ack_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, previous_seq_no = cme_futures_ilink3_sbe_v8_7_dissect.previous_seq_no(buffer, index, packet, parent)

  -- Previous Uuid: 8 Byte Unsigned Fixed Width Integer
  index, previous_uuid = cme_futures_ilink3_sbe_v8_7_dissect.previous_uuid(buffer, index, packet, parent)

  -- Keep Alive Interval: 2 Byte Unsigned Fixed Width Integer
  index, keep_alive_interval = cme_futures_ilink3_sbe_v8_7_dissect.keep_alive_interval(buffer, index, packet, parent)

  -- Secret Key Secure Id Expiration: 2 Byte Unsigned Fixed Width Integer Nullable
  index, secret_key_secure_id_expiration = cme_futures_ilink3_sbe_v8_7_dissect.secret_key_secure_id_expiration(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.establishment_ack = function(buffer, offset, packet, parent)
  if show.establishment_ack then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.establishment_ack, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.establishment_ack_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.establishment_ack(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.establishment_ack_fields(buffer, offset, packet, element)
  end
end

-- Display: Var Data
cme_futures_ilink3_sbe_v8_7_display.var_data = function(value)
  return "Var Data: "..value
end

-- Dissect runtime sized field: Var Data
cme_futures_ilink3_sbe_v8_7_dissect.var_data = function(buffer, offset, packet, parent, size)
  local range = buffer(offset, size)
...
-- Size: Data Length
cme_futures_ilink3_sbe_v8_7_size_of.data_length = 2

-- Display: Data Length
cme_futures_ilink3_sbe_v8_7_display.data_length = function(value)
  return "Data Length: "..value
end

-- Dissect: Data Length
cme_futures_ilink3_sbe_v8_7_dissect.data_length = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.data_length
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.credentials = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.data_length
...
-- Display: Credentials
cme_futures_ilink3_sbe_v8_7_display.credentials = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Credentials
cme_futures_ilink3_sbe_v8_7_dissect.credentials_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Data Length: 2 Byte Unsigned Fixed Width Integer
  index, data_length = cme_futures_ilink3_sbe_v8_7_dissect.data_length(buffer, index, packet, parent)

  -- Runtime Size Of: Var Data
  index, var_data = cme_futures_ilink3_sbe_v8_7_dissect.var_data(buffer, index, packet, parent, data_length)

  return index
end

-- Dissect: Credentials
cme_futures_ilink3_sbe_v8_7_dissect.credentials = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
-- Size: Firm
cme_futures_ilink3_sbe_v8_7_size_of.firm = 5

-- Display: Firm
cme_futures_ilink3_sbe_v8_7_display.firm = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Firm
cme_futures_ilink3_sbe_v8_7_dissect.firm = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.firm
  local range = buffer(offset, length)
...
-- Size: Session
cme_futures_ilink3_sbe_v8_7_size_of.session = 3

-- Display: Session
cme_futures_ilink3_sbe_v8_7_display.session = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Session
cme_futures_ilink3_sbe_v8_7_dissect.session = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.session
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.trading_system_vendor = 10

-- Display: Trading System Vendor
cme_futures_ilink3_sbe_v8_7_display.trading_system_vendor = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.trading_system_vendor = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trading_system_vendor
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.trading_system_version = 10

-- Display: Trading System Version
cme_futures_ilink3_sbe_v8_7_display.trading_system_version = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.trading_system_version = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trading_system_version
  local range = buffer(offset, length)
...
cme_futures_ilink3_sbe_v8_7_size_of.trading_system_name = 30

-- Display: Trading System Name
cme_futures_ilink3_sbe_v8_7_display.trading_system_name = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.trading_system_name = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.trading_system_name
  local range = buffer(offset, length)
...
-- Size: Access Key Id
cme_futures_ilink3_sbe_v8_7_size_of.access_key_id = 20

-- Display: Access Key Id
cme_futures_ilink3_sbe_v8_7_display.access_key_id = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
cme_futures_ilink3_sbe_v8_7_dissect.access_key_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.access_key_id
  local range = buffer(offset, length)
...
-- Size: Hmac Signature
cme_futures_ilink3_sbe_v8_7_size_of.hmac_signature = 32

-- Display: Hmac Signature
cme_futures_ilink3_sbe_v8_7_display.hmac_signature = function(value)
  return "Hmac Signature: "..value
end

-- Dissect: Hmac Signature
cme_futures_ilink3_sbe_v8_7_dissect.hmac_signature = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.hmac_signature
  local range = buffer(offset, length)
  local value = range:bytes():tohex(false, " ")
...
cme_futures_ilink3_sbe_v8_7_size_of.establish = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.hmac_signature

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.access_key_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trading_system_name

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trading_system_version

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.trading_system_vendor
  ...
  index = index + cme_futures_ilink3_sbe_v8_7_size_of.session

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.firm

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.keep_alive_interval

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.credentials(buffer, offset + index)

  return index
end

-- Display: Establish
cme_futures_ilink3_sbe_v8_7_display.establish = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Establish
cme_futures_ilink3_sbe_v8_7_dissect.establish_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Hmac Signature: 32 Byte
  index, hmac_signature = cme_futures_ilink3_sbe_v8_7_dissect.hmac_signature(buffer, index, packet, parent)

  -- Access Key Id: 20 Byte Ascii String
  index, access_key_id = cme_futures_ilink3_sbe_v8_7_dissect.access_key_id(buffer, index, packet, parent)

  -- Trading System Name: 30 Byte Ascii String
  index, trading_system_name = cme_futures_ilink3_sbe_v8_7_dissect.trading_system_name(buffer, index, packet, parent)

  -- Trading System Version: 10 Byte Ascii String
  index, trading_system_version = cme_futures_ilink3_sbe_v8_7_dissect.trading_system_version(buffer, index, packet, parent)

  -- Trading System Vendor: 10 Byte Ascii String
  index, trading_system_vendor = cme_futures_ilink3_sbe_v8_7_dissect.trading_system_vendor(buffer, index, packet, parent)
  ...
  index, session = cme_futures_ilink3_sbe_v8_7_dissect.session(buffer, index, packet, parent)

  -- Firm: 5 Byte Ascii String
  index, firm = cme_futures_ilink3_sbe_v8_7_dissect.firm(buffer, index, packet, parent)

  -- Keep Alive Interval: 2 Byte Unsigned Fixed Width Integer
  index, keep_alive_interval = cme_futures_ilink3_sbe_v8_7_dissect.keep_alive_interval(buffer, index, packet, parent)

  -- Credentials: Struct of 2 fields
  index, credentials = cme_futures_ilink3_sbe_v8_7_dissect.credentials(buffer, index, packet, parent)

  return index
end

-- Dissect: Establish
cme_futures_ilink3_sbe_v8_7_dissect.establish = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.negotiation_reject = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.negotiation_reject = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Negotiation Reject
cme_futures_ilink3_sbe_v8_7_dissect.negotiation_reject_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.negotiation_reject = function(buffer, offset, packet, parent)
  if show.negotiation_reject then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.negotiation_reject, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.negotiation_reject_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.negotiation_reject(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.negotiation_reject_fields(buffer, offset, packet, element)
  end
end

-- Calculate size of: Negotiation Response
cme_futures_ilink3_sbe_v8_7_size_of.negotiation_response = function(buffer, offset)
  local index = 0
...
cme_futures_ilink3_sbe_v8_7_display.negotiation_response = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Negotiation Response
cme_futures_ilink3_sbe_v8_7_dissect.negotiation_response_fields = function(buffer, offset, packet, parent)
  local index = offset
...
cme_futures_ilink3_sbe_v8_7_dissect.negotiation_response = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.negotiate = function(buffer, offset)
  local index = 0
...
-- Display: Negotiate
cme_futures_ilink3_sbe_v8_7_display.negotiate = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Negotiate
cme_futures_ilink3_sbe_v8_7_dissect.negotiate_fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Negotiate
cme_futures_ilink3_sbe_v8_7_dissect.negotiate = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
...
cme_futures_ilink3_sbe_v8_7_size_of.payload = function(buffer, offset, template_id)
  -- Size of Negotiate
  if template_id == 500 then
    return cme_futures_ilink3_sbe_v8_7_size_of.negotiate(buffer, offset)
  end
  -- Size of Negotiation Response
  if template_id == 501 then
    return cme_futures_ilink3_sbe_v8_7_size_of.negotiation_response(buffer, offset)
  end
  -- Size of Negotiation Reject
  if template_id == 502 then
    return cme_futures_ilink3_sbe_v8_7_size_of.negotiation_reject(buffer, offset)
  end
  -- Size of Establish
  if template_id == 503 then
    return cme_futures_ilink3_sbe_v8_7_size_of.establish(buffer, offset)
  end
  -- Size of Establishment Ack
  if template_id == 504 then
    return cme_futures_ilink3_sbe_v8_7_size_of.establishment_ack(buffer, offset)
  end
  -- Size of Establishment Reject
  if template_id == 505 then
    return cme_futures_ilink3_sbe_v8_7_size_of.establishment_reject(buffer, offset)
  end
  -- Size of Sequence
  if template_id == 506 then
    return cme_futures_ilink3_sbe_v8_7_size_of.sequence(buffer, offset)
  end
  -- Size of Terminate
  if template_id == 507 then
    return cme_futures_ilink3_sbe_v8_7_size_of.terminate(buffer, offset)
  end
  -- Size of Retransmit Request
  if template_id == 508 then
    return cme_futures_ilink3_sbe_v8_7_size_of.retransmit_request(buffer, offset)
  end
  -- Size of Retransmission
  if template_id == 509 then
    return cme_futures_ilink3_sbe_v8_7_size_of.retransmission(buffer, offset)
  end
  -- Size of Retransmit Reject
  if template_id == 510 then
    return cme_futures_ilink3_sbe_v8_7_size_of.retransmit_reject(buffer, offset)
  end
  -- Size of Not Applied
  if template_id == 513 then
    return cme_futures_ilink3_sbe_v8_7_size_of.not_applied(buffer, offset)
  end
  -- Size of New Order Single
  if template_id == 514 then
    return cme_futures_ilink3_sbe_v8_7_size_of.new_order_single(buffer, offset)
  end
  -- Size of Order Cancel Replace Request
  if template_id == 515 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_replace_request(buffer, offset)
  end
  -- Size of Order Cancel Request
  if template_id == 516 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_request(buffer, offset)
  end
  -- Size of Mass Quote
  if template_id == 517 then
    return cme_futures_ilink3_sbe_v8_7_size_of.mass_quote(buffer, offset)
  end
  -- Size of Party Details Definition Request
  if template_id == 518 then
    return cme_futures_ilink3_sbe_v8_7_size_of.party_details_definition_request(buffer, offset)
  end
  -- Size of Party Details Definition Request Ack
  if template_id == 519 then
    return cme_futures_ilink3_sbe_v8_7_size_of.party_details_definition_request_ack(buffer, offset)
  end
  -- Size of Business Reject
  if template_id == 521 then
    return cme_futures_ilink3_sbe_v8_7_size_of.business_reject(buffer, offset)
  end
  -- Size of Execution Report New
  if template_id == 522 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_new(buffer, offset)
  end
  -- Size of Execution Report Reject
  if template_id == 523 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_reject(buffer, offset)
  end
  -- Size of Execution Report Elimination
  if template_id == 524 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_elimination(buffer, offset)
  end
  -- Size of Execution Report Trade Outright
  if template_id == 525 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_outright(buffer, offset)
  end
  -- Size of Execution Report Trade Spread
  if template_id == 526 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread(buffer, offset)
  end
  -- Size of Execution Report Trade Spread Leg
  if template_id == 527 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_spread_leg(buffer, offset)
  end
  -- Size of Quote Cancel
  if template_id == 528 then
    return cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel(buffer, offset)
  end
  -- Size of Order Mass Action Request
  if template_id == 529 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_mass_action_request(buffer, offset)
  end
  -- Size of Order Mass Status Request
  if template_id == 530 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_mass_status_request(buffer, offset)
  end
  -- Size of Execution Report Modify
  if template_id == 531 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_modify(buffer, offset)
  end
  -- Size of Execution Report Status
  if template_id == 532 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_status(buffer, offset)
  end
  -- Size of Order Status Request
  if template_id == 533 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_status_request(buffer, offset)
  end
  -- Size of Execution Report Cancel
  if template_id == 534 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_cancel(buffer, offset)
  end
  -- Size of Order Cancel Reject
  if template_id == 535 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_reject(buffer, offset)
  end
  -- Size of Order Cancel Replace Reject
  if template_id == 536 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_cancel_replace_reject(buffer, offset)
  end
  -- Size of Party Details List Request
  if template_id == 537 then
    return cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_request(buffer, offset)
  end
  -- Size of Party Details List Report
  if template_id == 538 then
    return cme_futures_ilink3_sbe_v8_7_size_of.party_details_list_report(buffer, offset)
  end
  -- Size of Execution Ack
  if template_id == 539 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_ack(buffer, offset)
  end
  -- Size of Request For Quote
  if template_id == 543 then
    return cme_futures_ilink3_sbe_v8_7_size_of.request_for_quote(buffer, offset)
  end
  -- Size of New Order Cross
  if template_id == 544 then
    return cme_futures_ilink3_sbe_v8_7_size_of.new_order_cross(buffer, offset)
  end
  -- Size of Mass Quote Ack
  if template_id == 545 then
    return cme_futures_ilink3_sbe_v8_7_size_of.mass_quote_ack(buffer, offset)
  end
  -- Size of Request For Quote Ack
  if template_id == 546 then
    return cme_futures_ilink3_sbe_v8_7_size_of.request_for_quote_ack(buffer, offset)
  end
  -- Size of Execution Report Trade Addendum Outright
  if template_id == 548 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_outright(buffer, offset)
  end
  -- Size of Execution Report Trade Addendum Spread
  if template_id == 549 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread(buffer, offset)
  end
  -- Size of Execution Report Trade Addendum Spread Leg
  if template_id == 550 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_trade_addendum_spread_leg(buffer, offset)
  end
  -- Size of Security Definition Request
  if template_id == 560 then
    return cme_futures_ilink3_sbe_v8_7_size_of.security_definition_request(buffer, offset)
  end
  -- Size of Security Definition Response
  if template_id == 561 then
    return cme_futures_ilink3_sbe_v8_7_size_of.security_definition_response(buffer, offset)
  end
  -- Size of Order Mass Action Report
  if template_id == 562 then
    return cme_futures_ilink3_sbe_v8_7_size_of.order_mass_action_report(buffer, offset)
  end
  -- Size of Quote Cancel Ack
  if template_id == 563 then
    return cme_futures_ilink3_sbe_v8_7_size_of.quote_cancel_ack(buffer, offset)
  end
  -- Size of Execution Report Pending Cancel
  if template_id == 564 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_pending_cancel(buffer, offset)
  end
  -- Size of Execution Report Pending Replace
  if template_id == 565 then
    return cme_futures_ilink3_sbe_v8_7_size_of.execution_report_pending_replace(buffer, offset)
  end
...
-- Display: Payload
cme_futures_ilink3_sbe_v8_7_display.payload = function(buffer, offset, packet, parent)
  return ""
end

-- Dissect Branches: Payload
cme_futures_ilink3_sbe_v8_7_dissect.payload_branches = function(buffer, offset, packet, parent, template_id)
  -- Dissect Negotiate
  if template_id == 500 then
    return cme_futures_ilink3_sbe_v8_7_dissect.negotiate(buffer, offset, packet, parent)
  end
  -- Dissect Negotiation Response
  if template_id == 501 then
    return cme_futures_ilink3_sbe_v8_7_dissect.negotiation_response(buffer, offset, packet, parent)
  end
  -- Dissect Negotiation Reject
  if template_id == 502 then
    return cme_futures_ilink3_sbe_v8_7_dissect.negotiation_reject(buffer, offset, packet, parent)
  end
  -- Dissect Establish
  if template_id == 503 then
    return cme_futures_ilink3_sbe_v8_7_dissect.establish(buffer, offset, packet, parent)
  end
  -- Dissect Establishment Ack
  if template_id == 504 then
    return cme_futures_ilink3_sbe_v8_7_dissect.establishment_ack(buffer, offset, packet, parent)
  end
  -- Dissect Establishment Reject
  if template_id == 505 then
    return cme_futures_ilink3_sbe_v8_7_dissect.establishment_reject(buffer, offset, packet, parent)
  end
  -- Dissect Sequence
  if template_id == 506 then
    return cme_futures_ilink3_sbe_v8_7_dissect.sequence(buffer, offset, packet, parent)
  end
  -- Dissect Terminate
  if template_id == 507 then
    return cme_futures_ilink3_sbe_v8_7_dissect.terminate(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Request
  if template_id == 508 then
    return cme_futures_ilink3_sbe_v8_7_dissect.retransmit_request(buffer, offset, packet, parent)
  end
  -- Dissect Retransmission
  if template_id == 509 then
    return cme_futures_ilink3_sbe_v8_7_dissect.retransmission(buffer, offset, packet, parent)
  end
  -- Dissect Retransmit Reject
  if template_id == 510 then
    return cme_futures_ilink3_sbe_v8_7_dissect.retransmit_reject(buffer, offset, packet, parent)
  end
  -- Dissect Not Applied
  if template_id == 513 then
    return cme_futures_ilink3_sbe_v8_7_dissect.not_applied(buffer, offset, packet, parent)
  end
  -- Dissect New Order Single
  if template_id == 514 then
    return cme_futures_ilink3_sbe_v8_7_dissect.new_order_single(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Replace Request
  if template_id == 515 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_request(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Request
  if template_id == 516 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_request(buffer, offset, packet, parent)
  end
  -- Dissect Mass Quote
  if template_id == 517 then
    return cme_futures_ilink3_sbe_v8_7_dissect.mass_quote(buffer, offset, packet, parent)
  end
  -- Dissect Party Details Definition Request
  if template_id == 518 then
    return cme_futures_ilink3_sbe_v8_7_dissect.party_details_definition_request(buffer, offset, packet, parent)
  end
  -- Dissect Party Details Definition Request Ack
  if template_id == 519 then
    return cme_futures_ilink3_sbe_v8_7_dissect.party_details_definition_request_ack(buffer, offset, packet, parent)
  end
  -- Dissect Business Reject
  if template_id == 521 then
    return cme_futures_ilink3_sbe_v8_7_dissect.business_reject(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report New
  if template_id == 522 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_new(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Reject
  if template_id == 523 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_reject(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Elimination
  if template_id == 524 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_elimination(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Outright
  if template_id == 525 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_outright(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Spread
  if template_id == 526 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Spread Leg
  if template_id == 527 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_spread_leg(buffer, offset, packet, parent)
  end
  -- Dissect Quote Cancel
  if template_id == 528 then
    return cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel(buffer, offset, packet, parent)
  end
  -- Dissect Order Mass Action Request
  if template_id == 529 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_request(buffer, offset, packet, parent)
  end
  -- Dissect Order Mass Status Request
  if template_id == 530 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_mass_status_request(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Modify
  if template_id == 531 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_modify(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Status
  if template_id == 532 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_status(buffer, offset, packet, parent)
  end
  -- Dissect Order Status Request
  if template_id == 533 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_status_request(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Cancel
  if template_id == 534 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_cancel(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Reject
  if template_id == 535 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_reject(buffer, offset, packet, parent)
  end
  -- Dissect Order Cancel Replace Reject
  if template_id == 536 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_cancel_replace_reject(buffer, offset, packet, parent)
  end
  -- Dissect Party Details List Request
  if template_id == 537 then
    return cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_request(buffer, offset, packet, parent)
  end
  -- Dissect Party Details List Report
  if template_id == 538 then
    return cme_futures_ilink3_sbe_v8_7_dissect.party_details_list_report(buffer, offset, packet, parent)
  end
  -- Dissect Execution Ack
  if template_id == 539 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_ack(buffer, offset, packet, parent)
  end
  -- Dissect Request For Quote
  if template_id == 543 then
    return cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote(buffer, offset, packet, parent)
  end
  -- Dissect New Order Cross
  if template_id == 544 then
    return cme_futures_ilink3_sbe_v8_7_dissect.new_order_cross(buffer, offset, packet, parent)
  end
  -- Dissect Mass Quote Ack
  if template_id == 545 then
    return cme_futures_ilink3_sbe_v8_7_dissect.mass_quote_ack(buffer, offset, packet, parent)
  end
  -- Dissect Request For Quote Ack
  if template_id == 546 then
    return cme_futures_ilink3_sbe_v8_7_dissect.request_for_quote_ack(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Addendum Outright
  if template_id == 548 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_outright(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Addendum Spread
  if template_id == 549 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Trade Addendum Spread Leg
  if template_id == 550 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_trade_addendum_spread_leg(buffer, offset, packet, parent)
  end
  -- Dissect Security Definition Request
  if template_id == 560 then
    return cme_futures_ilink3_sbe_v8_7_dissect.security_definition_request(buffer, offset, packet, parent)
  end
  -- Dissect Security Definition Response
  if template_id == 561 then
    return cme_futures_ilink3_sbe_v8_7_dissect.security_definition_response(buffer, offset, packet, parent)
  end
  -- Dissect Order Mass Action Report
  if template_id == 562 then
    return cme_futures_ilink3_sbe_v8_7_dissect.order_mass_action_report(buffer, offset, packet, parent)
  end
  -- Dissect Quote Cancel Ack
  if template_id == 563 then
    return cme_futures_ilink3_sbe_v8_7_dissect.quote_cancel_ack(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Pending Cancel
  if template_id == 564 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_cancel(buffer, offset, packet, parent)
  end
  -- Dissect Execution Report Pending Replace
  if template_id == 565 then
    return cme_futures_ilink3_sbe_v8_7_dissect.execution_report_pending_replace(buffer, offset, packet, parent)
  end
...
-- Dissect: Payload
cme_futures_ilink3_sbe_v8_7_dissect.payload = function(buffer, offset, packet, parent, template_id)
  if not show.payload then
    return cme_futures_ilink3_sbe_v8_7_dissect.payload_branches(buffer, offset, packet, parent, template_id)
  end

  -- Calculate size and check that branch is not empty
  local size = cme_futures_ilink3_sbe_v8_7_size_of.payload(buffer, offset, template_id)
  if size == 0 then
    return offset
  end
...
-- Size: Version
cme_futures_ilink3_sbe_v8_7_size_of.version = 2

-- Display: Version
cme_futures_ilink3_sbe_v8_7_display.version = function(value)
  return "Version: "..value
end

-- Dissect: Version
cme_futures_ilink3_sbe_v8_7_dissect.version = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.version
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Schema Id
cme_futures_ilink3_sbe_v8_7_size_of.schema_id = 2

-- Display: Schema Id
cme_futures_ilink3_sbe_v8_7_display.schema_id = function(value)
  return "Schema Id: "..value
end

-- Dissect: Schema Id
cme_futures_ilink3_sbe_v8_7_dissect.schema_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.schema_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Template Id
cme_futures_ilink3_sbe_v8_7_size_of.template_id = 2

-- Display: Template Id
cme_futures_ilink3_sbe_v8_7_display.template_id = function(value)
  if value == 500 then
...
-- Dissect: Template Id
cme_futures_ilink3_sbe_v8_7_dissect.template_id = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.template_id
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.message_header = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.block_length

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.template_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.schema_id

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.version

  return index
end

-- Display: Message Header
cme_futures_ilink3_sbe_v8_7_display.message_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Message Header
cme_futures_ilink3_sbe_v8_7_dissect.message_header_fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  index, template_id = cme_futures_ilink3_sbe_v8_7_dissect.template_id(buffer, index, packet, parent)

  -- Schema Id: 2 Byte Unsigned Fixed Width Integer Static
  index, schema_id = cme_futures_ilink3_sbe_v8_7_dissect.schema_id(buffer, index, packet, parent)

  -- Version: 2 Byte Unsigned Fixed Width Integer Static
  index, version = cme_futures_ilink3_sbe_v8_7_dissect.version(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.message_header = function(buffer, offset, packet, parent)
  if show.message_header then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.message_header, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.message_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.message_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.message_header_fields(buffer, offset, packet, element)
  end
end

-- Size: Encoding Type
cme_futures_ilink3_sbe_v8_7_size_of.encoding_type = 2

-- Display: Encoding Type
cme_futures_ilink3_sbe_v8_7_display.encoding_type = function(value)
  return "Encoding Type: "..value
end

-- Dissect: Encoding Type
cme_futures_ilink3_sbe_v8_7_dissect.encoding_type = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.encoding_type
  local range = buffer(offset, length)
  local value = range:le_uint()
...
-- Size: Message Length
cme_futures_ilink3_sbe_v8_7_size_of.message_length = 2

-- Display: Message Length
cme_futures_ilink3_sbe_v8_7_display.message_length = function(value)
  return "Message Length: "..value
end

-- Dissect: Message Length
cme_futures_ilink3_sbe_v8_7_dissect.message_length = function(buffer, offset, packet, parent)
  local length = cme_futures_ilink3_sbe_v8_7_size_of.message_length
  local range = buffer(offset, length)
  local value = range:le_uint()
...
cme_futures_ilink3_sbe_v8_7_size_of.simple_open_framing_header = function(buffer, offset)
  local index = 0

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.message_length

  index = index + cme_futures_ilink3_sbe_v8_7_size_of.encoding_type

  return index
end

-- Display: Simple Open Framing Header
cme_futures_ilink3_sbe_v8_7_display.simple_open_framing_header = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Simple Open Framing Header
cme_futures_ilink3_sbe_v8_7_dissect.simple_open_framing_header_fields = function(buffer, offset, packet, parent)
  local index = offset

  -- Message Length: 2 Byte Unsigned Fixed Width Integer
  index, message_length = cme_futures_ilink3_sbe_v8_7_dissect.message_length(buffer, index, packet, parent)

  -- Encoding Type: 2 Byte Unsigned Fixed Width Integer
  index, encoding_type = cme_futures_ilink3_sbe_v8_7_dissect.encoding_type(buffer, index, packet, parent)
...
cme_futures_ilink3_sbe_v8_7_dissect.simple_open_framing_header = function(buffer, offset, packet, parent)
  if show.simple_open_framing_header then
    -- Optionally add element to protocol tree
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.simple_open_framing_header, buffer(offset, 0))
    local index = cme_futures_ilink3_sbe_v8_7_dissect.simple_open_framing_header_fields(buffer, offset, packet, element)
    local length = index - offset
    element:set_len(length)
    local display = cme_futures_ilink3_sbe_v8_7_display.simple_open_framing_header(packet, parent, length)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    return cme_futures_ilink3_sbe_v8_7_dissect.simple_open_framing_header_fields(buffer, offset, packet, element)
  end
end

-- Display: Simple Open Frame
cme_futures_ilink3_sbe_v8_7_display.simple_open_frame = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Simple Open Frame
cme_futures_ilink3_sbe_v8_7_dissect.simple_open_frame_fields = function(buffer, offset, packet, parent, size_of_simple_open_frame)
  local index = offset

  -- Simple Open Framing Header: Struct of 2 fields
  index, simple_open_framing_header = cme_futures_ilink3_sbe_v8_7_dissect.simple_open_framing_header(buffer, index, packet, parent)

  -- Message Header: Struct of 4 fields
  index, message_header = cme_futures_ilink3_sbe_v8_7_dissect.message_header(buffer, index, packet, parent)

  -- Dependency element: Template Id
  local template_id = buffer(index - 6, 2):le_uint()

  -- Payload: Runtime Type with 50 branches
  index = cme_futures_ilink3_sbe_v8_7_dissect.payload(buffer, index, packet, parent, template_id)

  return index
end

-- Dissect: Simple Open Frame
cme_futures_ilink3_sbe_v8_7_dissect.simple_open_frame = function(buffer, offset, packet, parent, size_of_simple_open_frame)
  local index = offset + size_of_simple_open_frame

  -- Optionally add group/struct element to protocol tree
  if show.simple_open_frame then
    local element = parent:add(cme_futures_ilink3_sbe_v8_7.fields.simple_open_frame, buffer(offset, 0))
    local current = cme_futures_ilink3_sbe_v8_7_dissect.simple_open_frame_fields(buffer, offset, packet, element, size_of_simple_open_frame)
    element:set_len(size_of_simple_open_frame)
    local display = cme_futures_ilink3_sbe_v8_7_display.simple_open_frame(buffer, packet, element)
    element:append_text(display)

    return index, element
  else
    -- Skip element, add fields directly
    cme_futures_ilink3_sbe_v8_7_dissect.simple_open_frame_fields(buffer, offset, packet, parent, size_of_simple_open_frame)
...
local simple_open_frame_bytes_remaining = function(buffer, index, available)
  ...
  if remaining < cme_futures_ilink3_sbe_v8_7_size_of.simple_open_framing_header(buffer, index) then
...
-- Dissect Packet
cme_futures_ilink3_sbe_v8_7_dissect.packet = function(buffer, packet, parent)
  local index = 0
  ...
  while index < end_of_payload do
    ...
    if available > 0 then
      index = cme_futures_ilink3_sbe_v8_7_dissect.simple_open_frame(buffer, index, packet, parent, size_of_simple_open_frame)
    else
