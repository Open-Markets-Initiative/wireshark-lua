...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_trade_summary_order_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_trade_summary_order_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_trade_summary_order_group ~= nil then
      local iteration = m_d_incremental_refresh_trade_summary_order_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_trade_summary_order_group_index, m_d_incremental_refresh_trade_summary_order_group_index)
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_trade_summary_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_trade_summary_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_trade_summary_group ~= nil then
      local iteration = m_d_incremental_refresh_trade_summary_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_trade_summary_group_index, m_d_incremental_refresh_trade_summary_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.underlyings_groups_fields = function(buffer, offset, packet, parent)
  ...
  for underlyings_group_index = 1, num_in_group do
    ...
    if underlyings_group ~= nil then
      local iteration = underlyings_group:add(cme_futures_mdp3_sbe_v1_5.fields.underlyings_group_index, underlyings_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.lot_type_rules_groups_fields = function(buffer, offset, packet, parent)
  ...
  for lot_type_rules_group_index = 1, num_in_group do
    ...
    if lot_type_rules_group ~= nil then
      local iteration = lot_type_rules_group:add(cme_futures_mdp3_sbe_v1_5.fields.lot_type_rules_group_index, lot_type_rules_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.inst_attrib_groups_fields = function(buffer, offset, packet, parent)
  ...
  for inst_attrib_group_index = 1, num_in_group do
    ...
    if inst_attrib_group ~= nil then
      local iteration = inst_attrib_group:add(cme_futures_mdp3_sbe_v1_5.fields.inst_attrib_group_index, inst_attrib_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_feed_types_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_feed_types_group_index = 1, num_in_group do
    ...
    if m_d_feed_types_group ~= nil then
      local iteration = m_d_feed_types_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_feed_types_group_index, m_d_feed_types_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.events_groups_fields = function(buffer, offset, packet, parent)
  ...
  for events_group_index = 1, num_in_group do
    ...
    if events_group ~= nil then
      local iteration = events_group:add(cme_futures_mdp3_sbe_v1_5.fields.events_group_index, events_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.related_sym_groups_fields = function(buffer, offset, packet, parent)
  ...
  for related_sym_group_index = 1, num_in_group do
    ...
    if related_sym_group ~= nil then
      local iteration = related_sym_group:add(cme_futures_mdp3_sbe_v1_5.fields.related_sym_group_index, related_sym_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.snapshot_full_refresh_groups_fields = function(buffer, offset, packet, parent)
  ...
  for snapshot_full_refresh_group_index = 1, num_in_group do
    ...
    if snapshot_full_refresh_group ~= nil then
      local iteration = snapshot_full_refresh_group:add(cme_futures_mdp3_sbe_v1_5.fields.snapshot_full_refresh_group_index, snapshot_full_refresh_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_volume_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_volume_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_volume_group ~= nil then
      local iteration = m_d_incremental_refresh_volume_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_volume_group_index, m_d_incremental_refresh_volume_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_trade_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_trade_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_trade_group ~= nil then
      local iteration = m_d_incremental_refresh_trade_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_trade_group_index, m_d_incremental_refresh_trade_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_session_statistics_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_session_statistics_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_session_statistics_group ~= nil then
      local iteration = m_d_incremental_refresh_session_statistics_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_session_statistics_group_index, m_d_incremental_refresh_session_statistics_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_limits_banding_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_limits_banding_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_limits_banding_group ~= nil then
      local iteration = m_d_incremental_refresh_limits_banding_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_limits_banding_group_index, m_d_incremental_refresh_limits_banding_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_daily_statistics_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_daily_statistics_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_daily_statistics_group ~= nil then
      local iteration = m_d_incremental_refresh_daily_statistics_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_daily_statistics_group_index, m_d_incremental_refresh_daily_statistics_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_incremental_refresh_book_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_incremental_refresh_book_group_index = 1, num_in_group do
    ...
    if m_d_incremental_refresh_book_group ~= nil then
      local iteration = m_d_incremental_refresh_book_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_incremental_refresh_book_group_index, m_d_incremental_refresh_book_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.m_d_instrument_definition_spread_leg_groups_fields = function(buffer, offset, packet, parent)
  ...
  for m_d_instrument_definition_spread_leg_group_index = 1, num_in_group do
    ...
    if m_d_instrument_definition_spread_leg_group ~= nil then
      local iteration = m_d_instrument_definition_spread_leg_group:add(cme_futures_mdp3_sbe_v1_5.fields.m_d_instrument_definition_spread_leg_group_index, m_d_instrument_definition_spread_leg_group_index)
      iteration:set_generated()
    end
  end
...
cme_futures_mdp3_sbe_v1_5_dissect.channel_reset_groups_fields = function(buffer, offset, packet, parent)
  ...
  for channel_reset_group_index = 1, num_in_group do
    ...
    if channel_reset_group ~= nil then
      local iteration = channel_reset_group:add(cme_futures_mdp3_sbe_v1_5.fields.channel_reset_group_index, channel_reset_group_index)
      iteration:set_generated()
    end
  end
