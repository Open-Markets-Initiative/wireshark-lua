...
omi_cme_futures_mdp3_sbe_v1_8.fields.events_group = ProtoField.new("Events Group", "cme.futures.mdp3.sbe.v1.8.eventsgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.events_groups = ProtoField.new("Events Groups", "cme.futures.mdp3.sbe.v1.8.eventsgroups", ftypes.STRING)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.inst_attrib_group = ProtoField.new("Inst Attrib Group", "cme.futures.mdp3.sbe.v1.8.instattribgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.inst_attrib_groups = ProtoField.new("Inst Attrib Groups", "cme.futures.mdp3.sbe.v1.8.instattribgroups", ftypes.STRING)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.lot_type_rules_group = ProtoField.new("Lot Type Rules Group", "cme.futures.mdp3.sbe.v1.8.lottyperulesgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.lot_type_rules_groups = ProtoField.new("Lot Type Rules Groups", "cme.futures.mdp3.sbe.v1.8.lottyperulesgroups", ftypes.STRING)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_feed_types_group = ProtoField.new("M D Feed Types Group", "cme.futures.mdp3.sbe.v1.8.mdfeedtypesgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_feed_types_groups = ProtoField.new("M D Feed Types Groups", "cme.futures.mdp3.sbe.v1.8.mdfeedtypesgroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_group = ProtoField.new("M D Incremental Refresh Book Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshbookgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_groups = ProtoField.new("M D Incremental Refresh Book Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshbookgroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_order_group = ProtoField.new("M D Incremental Refresh Book Order Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshbookordergroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_order_groups = ProtoField.new("M D Incremental Refresh Book Order Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshbookordergroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_daily_statistics_group = ProtoField.new("M D Incremental Refresh Daily Statistics Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshdailystatisticsgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_daily_statistics_groups = ProtoField.new("M D Incremental Refresh Daily Statistics Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshdailystatisticsgroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_limits_banding_group = ProtoField.new("M D Incremental Refresh Limits Banding Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshlimitsbandinggroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_limits_banding_groups = ProtoField.new("M D Incremental Refresh Limits Banding Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshlimitsbandinggroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_order_book_group = ProtoField.new("M D Incremental Refresh Order Book Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshorderbookgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_order_book_groups = ProtoField.new("M D Incremental Refresh Order Book Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshorderbookgroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_session_statistics_group = ProtoField.new("M D Incremental Refresh Session Statistics Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshsessionstatisticsgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_session_statistics_groups = ProtoField.new("M D Incremental Refresh Session Statistics Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshsessionstatisticsgroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_group = ProtoField.new("M D Incremental Refresh Trade Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradegroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_groups = ProtoField.new("M D Incremental Refresh Trade Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradegroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_group = ProtoField.new("M D Incremental Refresh Trade Summary Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradesummarygroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_groups = ProtoField.new("M D Incremental Refresh Trade Summary Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradesummarygroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_order_group = ProtoField.new("M D Incremental Refresh Trade Summary Order Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradesummaryordergroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_order_groups = ProtoField.new("M D Incremental Refresh Trade Summary Order Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradesummaryordergroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_volume_group = ProtoField.new("M D Incremental Refresh Volume Group", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshvolumegroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_volume_groups = ProtoField.new("M D Incremental Refresh Volume Groups", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshvolumegroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_instrument_definition_spread_leg_group = ProtoField.new("M D Instrument Definition Spread Leg Group", "cme.futures.mdp3.sbe.v1.8.mdinstrumentdefinitionspreadleggroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_instrument_definition_spread_leg_groups = ProtoField.new("M D Instrument Definition Spread Leg Groups", "cme.futures.mdp3.sbe.v1.8.mdinstrumentdefinitionspreadleggroups", ftypes.STRING)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "cme.futures.mdp3.sbe.v1.8.messagesequencenumber", ftypes.UINT32)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.min_price_increment_price = ProtoField.new("Min Price Increment Price", "cme.futures.mdp3.sbe.v1.8.minpriceincrementprice", ftypes.DOUBLE)
omi_cme_futures_mdp3_sbe_v1_8.fields.min_price_increment_pricenull = ProtoField.new("Min Price Increment Pricenull", "cme.futures.mdp3.sbe.v1.8.minpriceincrementpricenull", ftypes.DOUBLE)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.related_instruments_group = ProtoField.new("Related Instruments Group", "cme.futures.mdp3.sbe.v1.8.relatedinstrumentsgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.related_instruments_groups = ProtoField.new("Related Instruments Groups", "cme.futures.mdp3.sbe.v1.8.relatedinstrumentsgroups", ftypes.STRING)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_group = ProtoField.new("Snapshot Full Refresh Group", "cme.futures.mdp3.sbe.v1.8.snapshotfullrefreshgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_groups = ProtoField.new("Snapshot Full Refresh Groups", "cme.futures.mdp3.sbe.v1.8.snapshotfullrefreshgroups", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_order_book_group = ProtoField.new("Snapshot Full Refresh Order Book Group", "cme.futures.mdp3.sbe.v1.8.snapshotfullrefreshorderbookgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_order_book_groups = ProtoField.new("Snapshot Full Refresh Order Book Groups", "cme.futures.mdp3.sbe.v1.8.snapshotfullrefreshorderbookgroups", ftypes.STRING)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.underlyings_group = ProtoField.new("Underlyings Group", "cme.futures.mdp3.sbe.v1.8.underlyingsgroup", ftypes.STRING)
omi_cme_futures_mdp3_sbe_v1_8.fields.underlyings_groups = ProtoField.new("Underlyings Groups", "cme.futures.mdp3.sbe.v1.8.underlyingsgroups", ftypes.STRING)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.events_group_index = ProtoField.new("Events Group Index", "cme.futures.mdp3.sbe.v1.8.eventsgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.inst_attrib_group_index = ProtoField.new("Inst Attrib Group Index", "cme.futures.mdp3.sbe.v1.8.instattribgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.lot_type_rules_group_index = ProtoField.new("Lot Type Rules Group Index", "cme.futures.mdp3.sbe.v1.8.lottyperulesgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_feed_types_group_index = ProtoField.new("M D Feed Types Group Index", "cme.futures.mdp3.sbe.v1.8.mdfeedtypesgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_group_index = ProtoField.new("M D Incremental Refresh Book Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshbookgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_order_group_index = ProtoField.new("M D Incremental Refresh Book Order Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshbookordergroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_daily_statistics_group_index = ProtoField.new("M D Incremental Refresh Daily Statistics Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshdailystatisticsgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_limits_banding_group_index = ProtoField.new("M D Incremental Refresh Limits Banding Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshlimitsbandinggroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_order_book_group_index = ProtoField.new("M D Incremental Refresh Order Book Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshorderbookgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_session_statistics_group_index = ProtoField.new("M D Incremental Refresh Session Statistics Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshsessionstatisticsgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_group_index = ProtoField.new("M D Incremental Refresh Trade Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradegroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_group_index = ProtoField.new("M D Incremental Refresh Trade Summary Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradesummarygroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_order_group_index = ProtoField.new("M D Incremental Refresh Trade Summary Order Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshtradesummaryordergroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_volume_group_index = ProtoField.new("M D Incremental Refresh Volume Group Index", "cme.futures.mdp3.sbe.v1.8.mdincrementalrefreshvolumegroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_instrument_definition_spread_leg_group_index = ProtoField.new("M D Instrument Definition Spread Leg Group Index", "cme.futures.mdp3.sbe.v1.8.mdinstrumentdefinitionspreadleggroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.related_instruments_group_index = ProtoField.new("Related Instruments Group Index", "cme.futures.mdp3.sbe.v1.8.relatedinstrumentsgroupindex", ftypes.UINT16)
...
omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_group_index = ProtoField.new("Snapshot Full Refresh Group Index", "cme.futures.mdp3.sbe.v1.8.snapshotfullrefreshgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_order_book_group_index = ProtoField.new("Snapshot Full Refresh Order Book Group Index", "cme.futures.mdp3.sbe.v1.8.snapshotfullrefreshorderbookgroupindex", ftypes.UINT16)
omi_cme_futures_mdp3_sbe_v1_8.fields.underlyings_group_index = ProtoField.new("Underlyings Group Index", "cme.futures.mdp3.sbe.v1.8.underlyingsgroupindex", ftypes.UINT16)
...
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_events_group = Pref.bool("Show Events Group", show.events_group, "Parse and add Events Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_events_groups = Pref.bool("Show Events Groups", show.events_groups, "Parse and add Events Groups to protocol tree")
...
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_inst_attrib_group = Pref.bool("Show Inst Attrib Group", show.inst_attrib_group, "Parse and add Inst Attrib Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_inst_attrib_groups = Pref.bool("Show Inst Attrib Groups", show.inst_attrib_groups, "Parse and add Inst Attrib Groups to protocol tree")
...
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_lot_type_rules_group = Pref.bool("Show Lot Type Rules Group", show.lot_type_rules_group, "Parse and add Lot Type Rules Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_lot_type_rules_groups = Pref.bool("Show Lot Type Rules Groups", show.lot_type_rules_groups, "Parse and add Lot Type Rules Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_feed_types_group = Pref.bool("Show M D Feed Types Group", show.m_d_feed_types_group, "Parse and add M D Feed Types Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_feed_types_groups = Pref.bool("Show M D Feed Types Groups", show.m_d_feed_types_groups, "Parse and add M D Feed Types Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_group = Pref.bool("Show M D Incremental Refresh Book Group", show.m_d_incremental_refresh_book_group, "Parse and add M D Incremental Refresh Book Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_groups = Pref.bool("Show M D Incremental Refresh Book Groups", show.m_d_incremental_refresh_book_groups, "Parse and add M D Incremental Refresh Book Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_order_group = Pref.bool("Show M D Incremental Refresh Book Order Group", show.m_d_incremental_refresh_book_order_group, "Parse and add M D Incremental Refresh Book Order Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_order_groups = Pref.bool("Show M D Incremental Refresh Book Order Groups", show.m_d_incremental_refresh_book_order_groups, "Parse and add M D Incremental Refresh Book Order Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_daily_statistics_group = Pref.bool("Show M D Incremental Refresh Daily Statistics Group", show.m_d_incremental_refresh_daily_statistics_group, "Parse and add M D Incremental Refresh Daily Statistics Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_daily_statistics_groups = Pref.bool("Show M D Incremental Refresh Daily Statistics Groups", show.m_d_incremental_refresh_daily_statistics_groups, "Parse and add M D Incremental Refresh Daily Statistics Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_limits_banding_group = Pref.bool("Show M D Incremental Refresh Limits Banding Group", show.m_d_incremental_refresh_limits_banding_group, "Parse and add M D Incremental Refresh Limits Banding Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_limits_banding_groups = Pref.bool("Show M D Incremental Refresh Limits Banding Groups", show.m_d_incremental_refresh_limits_banding_groups, "Parse and add M D Incremental Refresh Limits Banding Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_order_book_group = Pref.bool("Show M D Incremental Refresh Order Book Group", show.m_d_incremental_refresh_order_book_group, "Parse and add M D Incremental Refresh Order Book Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_order_book_groups = Pref.bool("Show M D Incremental Refresh Order Book Groups", show.m_d_incremental_refresh_order_book_groups, "Parse and add M D Incremental Refresh Order Book Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_session_statistics_group = Pref.bool("Show M D Incremental Refresh Session Statistics Group", show.m_d_incremental_refresh_session_statistics_group, "Parse and add M D Incremental Refresh Session Statistics Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_session_statistics_groups = Pref.bool("Show M D Incremental Refresh Session Statistics Groups", show.m_d_incremental_refresh_session_statistics_groups, "Parse and add M D Incremental Refresh Session Statistics Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_group = Pref.bool("Show M D Incremental Refresh Trade Group", show.m_d_incremental_refresh_trade_group, "Parse and add M D Incremental Refresh Trade Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_groups = Pref.bool("Show M D Incremental Refresh Trade Groups", show.m_d_incremental_refresh_trade_groups, "Parse and add M D Incremental Refresh Trade Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_group = Pref.bool("Show M D Incremental Refresh Trade Summary Group", show.m_d_incremental_refresh_trade_summary_group, "Parse and add M D Incremental Refresh Trade Summary Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_groups = Pref.bool("Show M D Incremental Refresh Trade Summary Groups", show.m_d_incremental_refresh_trade_summary_groups, "Parse and add M D Incremental Refresh Trade Summary Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_order_group = Pref.bool("Show M D Incremental Refresh Trade Summary Order Group", show.m_d_incremental_refresh_trade_summary_order_group, "Parse and add M D Incremental Refresh Trade Summary Order Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_order_groups = Pref.bool("Show M D Incremental Refresh Trade Summary Order Groups", show.m_d_incremental_refresh_trade_summary_order_groups, "Parse and add M D Incremental Refresh Trade Summary Order Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_volume_group = Pref.bool("Show M D Incremental Refresh Volume Group", show.m_d_incremental_refresh_volume_group, "Parse and add M D Incremental Refresh Volume Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_volume_groups = Pref.bool("Show M D Incremental Refresh Volume Groups", show.m_d_incremental_refresh_volume_groups, "Parse and add M D Incremental Refresh Volume Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_instrument_definition_spread_leg_group = Pref.bool("Show M D Instrument Definition Spread Leg Group", show.m_d_instrument_definition_spread_leg_group, "Parse and add M D Instrument Definition Spread Leg Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_instrument_definition_spread_leg_groups = Pref.bool("Show M D Instrument Definition Spread Leg Groups", show.m_d_instrument_definition_spread_leg_groups, "Parse and add M D Instrument Definition Spread Leg Groups to protocol tree")
...
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_related_instruments_group = Pref.bool("Show Related Instruments Group", show.related_instruments_group, "Parse and add Related Instruments Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_related_instruments_groups = Pref.bool("Show Related Instruments Groups", show.related_instruments_groups, "Parse and add Related Instruments Groups to protocol tree")
...
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_group = Pref.bool("Show Snapshot Full Refresh Group", show.snapshot_full_refresh_group, "Parse and add Snapshot Full Refresh Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_groups = Pref.bool("Show Snapshot Full Refresh Groups", show.snapshot_full_refresh_groups, "Parse and add Snapshot Full Refresh Groups to protocol tree")
...
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_order_book_group = Pref.bool("Show Snapshot Full Refresh Order Book Group", show.snapshot_full_refresh_order_book_group, "Parse and add Snapshot Full Refresh Order Book Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_order_book_groups = Pref.bool("Show Snapshot Full Refresh Order Book Groups", show.snapshot_full_refresh_order_book_groups, "Parse and add Snapshot Full Refresh Order Book Groups to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_underlyings_group = Pref.bool("Show Underlyings Group", show.underlyings_group, "Parse and add Underlyings Group to protocol tree")
omi_cme_futures_mdp3_sbe_v1_8.prefs.show_underlyings_groups = Pref.bool("Show Underlyings Groups", show.underlyings_groups, "Parse and add Underlyings Groups to protocol tree")
...
function omi_cme_futures_mdp3_sbe_v1_8.prefs_changed()
  ...
  if show.events_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_events_group then
    show.events_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_events_group
    changed = true
  end
  if show.events_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_events_groups then
    show.events_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_events_groups
    changed = true
  end
  ...
  if show.inst_attrib_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_inst_attrib_group then
    show.inst_attrib_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_inst_attrib_group
    changed = true
  end
  if show.inst_attrib_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_inst_attrib_groups then
    show.inst_attrib_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_inst_attrib_groups
    changed = true
  end
  ...
  if show.lot_type_rules_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_lot_type_rules_group then
    show.lot_type_rules_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_lot_type_rules_group
    changed = true
  end
  if show.lot_type_rules_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_lot_type_rules_groups then
    show.lot_type_rules_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_lot_type_rules_groups
    changed = true
  end
  if show.m_d_feed_types_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_feed_types_group then
    show.m_d_feed_types_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_feed_types_group
    changed = true
  end
  if show.m_d_feed_types_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_feed_types_groups then
    show.m_d_feed_types_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_feed_types_groups
    changed = true
  end
  if show.m_d_incremental_refresh_book_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_group then
    show.m_d_incremental_refresh_book_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_group
    changed = true
  end
  if show.m_d_incremental_refresh_book_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_groups then
    show.m_d_incremental_refresh_book_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_groups
    changed = true
  end
  if show.m_d_incremental_refresh_book_order_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_order_group then
    show.m_d_incremental_refresh_book_order_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_order_group
    changed = true
  end
  if show.m_d_incremental_refresh_book_order_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_order_groups then
    show.m_d_incremental_refresh_book_order_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_book_order_groups
    changed = true
  end
  if show.m_d_incremental_refresh_daily_statistics_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_daily_statistics_group then
    show.m_d_incremental_refresh_daily_statistics_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_daily_statistics_group
    changed = true
  end
  if show.m_d_incremental_refresh_daily_statistics_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_daily_statistics_groups then
    show.m_d_incremental_refresh_daily_statistics_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_daily_statistics_groups
    changed = true
  end
  if show.m_d_incremental_refresh_limits_banding_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_limits_banding_group then
    show.m_d_incremental_refresh_limits_banding_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_limits_banding_group
    changed = true
  end
  if show.m_d_incremental_refresh_limits_banding_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_limits_banding_groups then
    show.m_d_incremental_refresh_limits_banding_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_limits_banding_groups
    changed = true
  end
  if show.m_d_incremental_refresh_order_book_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_order_book_group then
    show.m_d_incremental_refresh_order_book_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_order_book_group
    changed = true
  end
  if show.m_d_incremental_refresh_order_book_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_order_book_groups then
    show.m_d_incremental_refresh_order_book_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_order_book_groups
    changed = true
  end
  if show.m_d_incremental_refresh_session_statistics_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_session_statistics_group then
    show.m_d_incremental_refresh_session_statistics_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_session_statistics_group
    changed = true
  end
  if show.m_d_incremental_refresh_session_statistics_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_session_statistics_groups then
    show.m_d_incremental_refresh_session_statistics_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_session_statistics_groups
    changed = true
  end
  if show.m_d_incremental_refresh_trade_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_group then
    show.m_d_incremental_refresh_trade_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_group
    changed = true
  end
  if show.m_d_incremental_refresh_trade_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_groups then
    show.m_d_incremental_refresh_trade_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_groups
    changed = true
  end
  if show.m_d_incremental_refresh_trade_summary_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_group then
    show.m_d_incremental_refresh_trade_summary_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_group
    changed = true
  end
  if show.m_d_incremental_refresh_trade_summary_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_groups then
    show.m_d_incremental_refresh_trade_summary_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_groups
    changed = true
  end
  if show.m_d_incremental_refresh_trade_summary_order_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_order_group then
    show.m_d_incremental_refresh_trade_summary_order_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_order_group
    changed = true
  end
  if show.m_d_incremental_refresh_trade_summary_order_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_order_groups then
    show.m_d_incremental_refresh_trade_summary_order_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_trade_summary_order_groups
    changed = true
  end
  if show.m_d_incremental_refresh_volume_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_volume_group then
    show.m_d_incremental_refresh_volume_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_volume_group
    changed = true
  end
  if show.m_d_incremental_refresh_volume_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_volume_groups then
    show.m_d_incremental_refresh_volume_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_incremental_refresh_volume_groups
    changed = true
  end
  if show.m_d_instrument_definition_spread_leg_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_instrument_definition_spread_leg_group then
    show.m_d_instrument_definition_spread_leg_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_instrument_definition_spread_leg_group
    changed = true
  end
  if show.m_d_instrument_definition_spread_leg_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_instrument_definition_spread_leg_groups then
    show.m_d_instrument_definition_spread_leg_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_m_d_instrument_definition_spread_leg_groups
    changed = true
  end
  ...
  if show.related_instruments_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_related_instruments_group then
    show.related_instruments_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_related_instruments_group
    changed = true
  end
  if show.related_instruments_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_related_instruments_groups then
    show.related_instruments_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_related_instruments_groups
    changed = true
  end
  ...
  if show.snapshot_full_refresh_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_group then
    show.snapshot_full_refresh_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_group
    changed = true
  end
  if show.snapshot_full_refresh_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_groups then
    show.snapshot_full_refresh_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_groups
    changed = true
  end
  ...
  if show.snapshot_full_refresh_order_book_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_order_book_group then
    show.snapshot_full_refresh_order_book_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_order_book_group
    changed = true
  end
  if show.snapshot_full_refresh_order_book_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_order_book_groups then
    show.snapshot_full_refresh_order_book_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_snapshot_full_refresh_order_book_groups
    changed = true
  end
  if show.underlyings_group ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_underlyings_group then
    show.underlyings_group = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_underlyings_group
    changed = true
  end
  if show.underlyings_groups ~= omi_cme_futures_mdp3_sbe_v1_8.prefs.show_underlyings_groups then
    show.underlyings_groups = omi_cme_futures_mdp3_sbe_v1_8.prefs.show_underlyings_groups
    changed = true
  end
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_group.fields = function(buffer, offset, packet, parent, snapshot_full_refresh_order_book_group_index)
  local index = offset

  -- Implicit Snapshot Full Refresh Order Book Group Index
  if snapshot_full_refresh_order_book_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_order_book_group_index, snapshot_full_refresh_order_book_group_index)
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_group.dissect = function(buffer, offset, packet, parent, snapshot_full_refresh_order_book_group_index)
  if show.snapshot_full_refresh_order_book_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_order_book_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_group.fields(buffer, offset, packet, parent, snapshot_full_refresh_order_book_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_group.fields(buffer, offset, packet, parent, snapshot_full_refresh_order_book_group_index)
  end
end
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups = {}
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Snapshot Full Refresh Order Book Groups
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for snapshot_full_refresh_order_book_group_index = 1, num_in_group do
    index, snapshot_full_refresh_order_book_group = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_group.dissect(buffer, index, packet, parent, snapshot_full_refresh_order_book_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.snapshot_full_refresh_order_book_groups then
    local length = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_order_book_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book.fields = function(buffer, offset, packet, parent)
  ...
  index, snapshot_full_refresh_order_book_groups = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_order_book_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_order_book_group_index)
  local index = offset

  -- Implicit M D Incremental Refresh Order Book Group Index
  if m_d_incremental_refresh_order_book_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_order_book_group_index, m_d_incremental_refresh_order_book_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_order_book_group_index)
  if show.m_d_incremental_refresh_order_book_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_order_book_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_order_book_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_order_book_group_index)
  end
end

-- M D Incremental Refresh Order Book Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Order Book Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_order_book_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_order_book_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_order_book_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_order_book_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_order_book_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.fields(buffer, offset, packet, parent)
end
...
-- Last Trade Msg
cme_futures_mdp3_sbe_v1_8.last_trade_msg = {}

-- Last Volume Msg
cme_futures_mdp3_sbe_v1_8.last_volume_msg = {}

-- Last Quote Msg
cme_futures_mdp3_sbe_v1_8.last_quote_msg = {}

-- Last Stats Msg
cme_futures_mdp3_sbe_v1_8.last_stats_msg = {}

-- Last Implied Msg
cme_futures_mdp3_sbe_v1_8.last_implied_msg = {}

-- Recovery Msg
cme_futures_mdp3_sbe_v1_8.recovery_msg = {}

-- Reserved
cme_futures_mdp3_sbe_v1_8.reserved = {}

-- End Of Event
cme_futures_mdp3_sbe_v1_8.end_of_event = {}
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_order_book.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_order_book.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_order_book_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_order_book_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_order_group_index)
  local index = offset
  ...
  if m_d_incremental_refresh_trade_summary_order_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_order_group_index, m_d_incremental_refresh_trade_summary_order_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_order_group_index)
  if show.m_d_incremental_refresh_trade_summary_order_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_order_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_order_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_order_group_index)
  end
end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Trade Summary Order Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_trade_summary_order_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_trade_summary_order_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_trade_summary_order_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_trade_summary_order_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_order_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_group_index)
  local index = offset

  -- Implicit M D Incremental Refresh Trade Summary Group Index
  if m_d_incremental_refresh_trade_summary_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_group_index, m_d_incremental_refresh_trade_summary_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_group_index)
  if show.m_d_incremental_refresh_trade_summary_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_trade_summary_group_index)
  end
end

-- M D Incremental Refresh Trade Summary Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Trade Summary Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_trade_summary_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_trade_summary_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_trade_summary_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_trade_summary_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_summary_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_trade_summary.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.size(buffer, offset + index)

  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_trade_summary.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_trade_summary_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_groups.dissect(buffer, index, packet, parent)

  -- M D Incremental Refresh Trade Summary Order Groups: Struct of 2 fields
  index, m_d_incremental_refresh_trade_summary_order_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_summary_order_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.related_instruments_group.fields = function(buffer, offset, packet, parent, related_instruments_group_index)
  local index = offset

  -- Implicit Related Instruments Group Index
  if related_instruments_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.related_instruments_group_index, related_instruments_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.related_instruments_group.dissect = function(buffer, offset, packet, parent, related_instruments_group_index)
  if show.related_instruments_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.related_instruments_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.related_instruments_group.fields(buffer, offset, packet, parent, related_instruments_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.related_instruments_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.related_instruments_group.fields(buffer, offset, packet, parent, related_instruments_group_index)
  end
end

-- Related Instruments Groups
cme_futures_mdp3_sbe_v1_8.related_instruments_groups = {}
...
cme_futures_mdp3_sbe_v1_8.related_instruments_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Related Instruments Groups
cme_futures_mdp3_sbe_v1_8.related_instruments_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for related_instruments_group_index = 1, num_in_group do
    index, related_instruments_group = cme_futures_mdp3_sbe_v1_8.related_instruments_group.dissect(buffer, index, packet, parent, related_instruments_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.related_instruments_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.related_instruments_groups then
    local length = cme_futures_mdp3_sbe_v1_8.related_instruments_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.related_instruments_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.related_instruments_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.related_instruments_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.underlyings_group.fields = function(buffer, offset, packet, parent, underlyings_group_index)
  local index = offset

  -- Implicit Underlyings Group Index
  if underlyings_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.underlyings_group_index, underlyings_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.underlyings_group.dissect = function(buffer, offset, packet, parent, underlyings_group_index)
  if show.underlyings_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.underlyings_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.underlyings_group.fields(buffer, offset, packet, parent, underlyings_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.underlyings_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.underlyings_group.fields(buffer, offset, packet, parent, underlyings_group_index)
  end
end

-- Underlyings Groups
cme_futures_mdp3_sbe_v1_8.underlyings_groups = {}
...
cme_futures_mdp3_sbe_v1_8.underlyings_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Underlyings Groups
cme_futures_mdp3_sbe_v1_8.underlyings_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for underlyings_group_index = 1, num_in_group do
    index, underlyings_group = cme_futures_mdp3_sbe_v1_8.underlyings_group.dissect(buffer, index, packet, parent, underlyings_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.underlyings_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.underlyings_groups then
    local length = cme_futures_mdp3_sbe_v1_8.underlyings_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.underlyings_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.underlyings_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.underlyings_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.lot_type_rules_group.fields = function(buffer, offset, packet, parent, lot_type_rules_group_index)
  local index = offset

  -- Implicit Lot Type Rules Group Index
  if lot_type_rules_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.lot_type_rules_group_index, lot_type_rules_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.lot_type_rules_group.dissect = function(buffer, offset, packet, parent, lot_type_rules_group_index)
  if show.lot_type_rules_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.lot_type_rules_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.lot_type_rules_group.fields(buffer, offset, packet, parent, lot_type_rules_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.lot_type_rules_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.lot_type_rules_group.fields(buffer, offset, packet, parent, lot_type_rules_group_index)
  end
end

-- Lot Type Rules Groups
cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups = {}
...
cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Lot Type Rules Groups
cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for lot_type_rules_group_index = 1, num_in_group do
    index, lot_type_rules_group = cme_futures_mdp3_sbe_v1_8.lot_type_rules_group.dissect(buffer, index, packet, parent, lot_type_rules_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.lot_type_rules_groups then
    local length = cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.lot_type_rules_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.fields(buffer, offset, packet, parent)
end

-- Reserved 8
cme_futures_mdp3_sbe_v1_8.reserved_8 = {}

-- Variable Product Eligibility
cme_futures_mdp3_sbe_v1_8.variable_product_eligibility = {}

-- Daily Product Eligibility
cme_futures_mdp3_sbe_v1_8.daily_product_eligibility = {}

-- Gt Orders Eligibility
cme_futures_mdp3_sbe_v1_8.gt_orders_eligibility = {}

-- Implied Matching Eligibility
cme_futures_mdp3_sbe_v1_8.implied_matching_eligibility = {}

-- Reserved 4
cme_futures_mdp3_sbe_v1_8.reserved_4 = {}

-- ILink Indicative Mass Quoting Eligible
cme_futures_mdp3_sbe_v1_8.ilink_indicative_mass_quoting_eligible = {}

-- Negative Strike Eligible
cme_futures_mdp3_sbe_v1_8.negative_strike_eligible = {}

-- Negative Price Outright Eligible
cme_futures_mdp3_sbe_v1_8.negative_price_outright_eligible = {}

-- Is Fractional
cme_futures_mdp3_sbe_v1_8.is_fractional = {}

-- Volatility Quoted Option
cme_futures_mdp3_sbe_v1_8.volatility_quoted_option = {}

-- Rfq Cross Eligible
cme_futures_mdp3_sbe_v1_8.rfq_cross_eligible = {}

-- Zero Price Outright Eligible
cme_futures_mdp3_sbe_v1_8.zero_price_outright_eligible = {}

-- Decaying Product Eligibility
cme_futures_mdp3_sbe_v1_8.decaying_product_eligibility = {}

-- Electronic Match Eligible
cme_futures_mdp3_sbe_v1_8.electronic_match_eligible = {}

-- Order Cross Eligible
cme_futures_mdp3_sbe_v1_8.order_cross_eligible = {}

-- Block Trade Eligible
cme_futures_mdp3_sbe_v1_8.block_trade_eligible = {}

-- Efp Eligible
cme_futures_mdp3_sbe_v1_8.efp_eligible = {}

-- Ebf Eligible
cme_futures_mdp3_sbe_v1_8.ebf_eligible = {}

-- Efs Eligible
cme_futures_mdp3_sbe_v1_8.efs_eligible = {}

-- Efr Eligible
cme_futures_mdp3_sbe_v1_8.efr_eligible = {}

-- Otc Eligible
cme_futures_mdp3_sbe_v1_8.otc_eligible = {}
...
cme_futures_mdp3_sbe_v1_8.inst_attrib_group.fields = function(buffer, offset, packet, parent, inst_attrib_group_index)
  local index = offset

  -- Implicit Inst Attrib Group Index
  if inst_attrib_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.inst_attrib_group_index, inst_attrib_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.inst_attrib_group.dissect = function(buffer, offset, packet, parent, inst_attrib_group_index)
  if show.inst_attrib_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.inst_attrib_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.inst_attrib_group.fields(buffer, offset, packet, parent, inst_attrib_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.inst_attrib_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.inst_attrib_group.fields(buffer, offset, packet, parent, inst_attrib_group_index)
  end
end

-- Inst Attrib Groups
cme_futures_mdp3_sbe_v1_8.inst_attrib_groups = {}
...
cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Inst Attrib Groups
cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for inst_attrib_group_index = 1, num_in_group do
    index, inst_attrib_group = cme_futures_mdp3_sbe_v1_8.inst_attrib_group.dissect(buffer, index, packet, parent, inst_attrib_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.inst_attrib_groups then
    local length = cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.inst_attrib_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.m_d_feed_types_group.fields = function(buffer, offset, packet, parent, m_d_feed_types_group_index)
  local index = offset

  -- Implicit M D Feed Types Group Index
  if m_d_feed_types_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_feed_types_group_index, m_d_feed_types_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_feed_types_group.dissect = function(buffer, offset, packet, parent, m_d_feed_types_group_index)
  if show.m_d_feed_types_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_feed_types_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_feed_types_group.fields(buffer, offset, packet, parent, m_d_feed_types_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_feed_types_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_feed_types_group.fields(buffer, offset, packet, parent, m_d_feed_types_group_index)
  end
end

-- M D Feed Types Groups
cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Feed Types Groups
cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_feed_types_group_index = 1, num_in_group do
    index, m_d_feed_types_group = cme_futures_mdp3_sbe_v1_8.m_d_feed_types_group.dissect(buffer, index, packet, parent, m_d_feed_types_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_feed_types_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_feed_types_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.events_group.fields = function(buffer, offset, packet, parent, events_group_index)
  local index = offset

  -- Implicit Events Group Index
  if events_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.events_group_index, events_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.events_group.dissect = function(buffer, offset, packet, parent, events_group_index)
  if show.events_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.events_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.events_group.fields(buffer, offset, packet, parent, events_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.events_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.events_group.fields(buffer, offset, packet, parent, events_group_index)
  end
end

-- Events Groups
cme_futures_mdp3_sbe_v1_8.events_groups = {}
...
cme_futures_mdp3_sbe_v1_8.events_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Events Groups
cme_futures_mdp3_sbe_v1_8.events_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for events_group_index = 1, num_in_group do
    index, events_group = cme_futures_mdp3_sbe_v1_8.events_group.dissect(buffer, index, packet, parent, events_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.events_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.events_groups then
    local length = cme_futures_mdp3_sbe_v1_8.events_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.events_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.events_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.events_groups.fields(buffer, offset, packet, parent)
end
...
-- Final
cme_futures_mdp3_sbe_v1_8.final = {}

-- Actual
cme_futures_mdp3_sbe_v1_8.actual = {}

-- Rounded
cme_futures_mdp3_sbe_v1_8.rounded = {}

-- Intraday
cme_futures_mdp3_sbe_v1_8.intraday = {}

-- Reserved Bits
cme_futures_mdp3_sbe_v1_8.reserved_bits = {}

-- Null Value
cme_futures_mdp3_sbe_v1_8.null_value = {}
...
cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.display = function(raw, value)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
...
cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.translate = function(raw)
  -- Check null sentinel value
  if raw == Int64(0xFFFFFFFF, 0x7FFFFFFF) then
    return 0/0
  end
...
cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.size
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.translate(raw)
  local display = cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.display(raw, value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.min_price_increment_pricenull, range, value, display)
...
cme_futures_mdp3_sbe_v1_8.md_instrument_definition_option.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.size
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.events_groups.size(buffer, offset + index)

  index = index + cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.size(buffer, offset + index)

  index = index + cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.size(buffer, offset + index)

  index = index + cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.size(buffer, offset + index)

  index = index + cme_futures_mdp3_sbe_v1_8.underlyings_groups.size(buffer, offset + index)

  index = index + cme_futures_mdp3_sbe_v1_8.related_instruments_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_instrument_definition_option.fields = function(buffer, offset, packet, parent)
  ...
  index, min_price_increment_pricenull = cme_futures_mdp3_sbe_v1_8.min_price_increment_pricenull.dissect(buffer, index, packet, parent)
  ...
  index, events_groups = cme_futures_mdp3_sbe_v1_8.events_groups.dissect(buffer, index, packet, parent)

  -- M D Feed Types Groups: Struct of 2 fields
  index, m_d_feed_types_groups = cme_futures_mdp3_sbe_v1_8.m_d_feed_types_groups.dissect(buffer, index, packet, parent)

  -- Inst Attrib Groups: Struct of 2 fields
  index, inst_attrib_groups = cme_futures_mdp3_sbe_v1_8.inst_attrib_groups.dissect(buffer, index, packet, parent)

  -- Lot Type Rules Groups: Struct of 2 fields
  index, lot_type_rules_groups = cme_futures_mdp3_sbe_v1_8.lot_type_rules_groups.dissect(buffer, index, packet, parent)

  -- Underlyings Groups: Struct of 2 fields
  index, underlyings_groups = cme_futures_mdp3_sbe_v1_8.underlyings_groups.dissect(buffer, index, packet, parent)

  -- Related Instruments Groups: Struct of 2 fields
  index, related_instruments_groups = cme_futures_mdp3_sbe_v1_8.related_instruments_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_group.fields = function(buffer, offset, packet, parent, snapshot_full_refresh_group_index)
  local index = offset

  -- Implicit Snapshot Full Refresh Group Index
  if snapshot_full_refresh_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_group_index, snapshot_full_refresh_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_group.dissect = function(buffer, offset, packet, parent, snapshot_full_refresh_group_index)
  if show.snapshot_full_refresh_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_group.fields(buffer, offset, packet, parent, snapshot_full_refresh_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_group.fields(buffer, offset, packet, parent, snapshot_full_refresh_group_index)
  end
end

-- Snapshot Full Refresh Groups
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups = {}
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Snapshot Full Refresh Groups
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for snapshot_full_refresh_group_index = 1, num_in_group do
    index, snapshot_full_refresh_group = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_group.dissect(buffer, index, packet, parent, snapshot_full_refresh_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.snapshot_full_refresh_groups then
    local length = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.snapshot_full_refresh_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh.fields = function(buffer, offset, packet, parent)
  ...
  index, snapshot_full_refresh_groups = cme_futures_mdp3_sbe_v1_8.snapshot_full_refresh_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_volume_group_index)
  local index = offset

  -- Implicit M D Incremental Refresh Volume Group Index
  if m_d_incremental_refresh_volume_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_volume_group_index, m_d_incremental_refresh_volume_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_volume_group_index)
  if show.m_d_incremental_refresh_volume_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_volume_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_volume_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_volume_group_index)
  end
end

-- M D Incremental Refresh Volume Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Volume Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_volume_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_volume_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_volume_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_volume_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_volume_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_volume.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_volume.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_volume_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_volume_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_trade_group_index)
  local index = offset

  -- Implicit M D Incremental Refresh Trade Group Index
  if m_d_incremental_refresh_trade_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_group_index, m_d_incremental_refresh_trade_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_trade_group_index)
  if show.m_d_incremental_refresh_trade_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_trade_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_trade_group_index)
  end
end

-- M D Incremental Refresh Trade Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Trade Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_trade_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_trade_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_trade_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_trade_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_trade_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_trade.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_trade.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_trade_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_trade_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_session_statistics_group_index)
  local index = offset
  ...
  if m_d_incremental_refresh_session_statistics_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_session_statistics_group_index, m_d_incremental_refresh_session_statistics_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_session_statistics_group_index)
  if show.m_d_incremental_refresh_session_statistics_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_session_statistics_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_session_statistics_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_session_statistics_group_index)
  end
end

-- M D Incremental Refresh Session Statistics Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Session Statistics Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_session_statistics_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_session_statistics_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_session_statistics_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_session_statistics_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_session_statistics_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_session_statistics.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_session_statistics.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_session_statistics_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_session_statistics_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_limits_banding_group_index)
  local index = offset
  ...
  if m_d_incremental_refresh_limits_banding_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_limits_banding_group_index, m_d_incremental_refresh_limits_banding_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_limits_banding_group_index)
  if show.m_d_incremental_refresh_limits_banding_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_limits_banding_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_limits_banding_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_limits_banding_group_index)
  end
end

-- M D Incremental Refresh Limits Banding Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Limits Banding Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_limits_banding_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_limits_banding_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_limits_banding_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_limits_banding_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_limits_banding_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_limits_banding.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_limits_banding.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_limits_banding_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_limits_banding_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_daily_statistics_group_index)
  local index = offset
  ...
  if m_d_incremental_refresh_daily_statistics_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_daily_statistics_group_index, m_d_incremental_refresh_daily_statistics_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_daily_statistics_group_index)
  if show.m_d_incremental_refresh_daily_statistics_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_daily_statistics_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_daily_statistics_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_daily_statistics_group_index)
  end
end

-- M D Incremental Refresh Daily Statistics Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Daily Statistics Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_daily_statistics_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_daily_statistics_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_daily_statistics_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_daily_statistics_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_daily_statistics_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_daily_statistics.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_daily_statistics.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_daily_statistics_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_daily_statistics_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_book_order_group_index)
  local index = offset

  -- Implicit M D Incremental Refresh Book Order Group Index
  if m_d_incremental_refresh_book_order_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_order_group_index, m_d_incremental_refresh_book_order_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_book_order_group_index)
  if show.m_d_incremental_refresh_book_order_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_order_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_book_order_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_book_order_group_index)
  end
end

-- M D Incremental Refresh Book Order Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Book Order Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_book_order_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_book_order_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_book_order_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_book_order_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_order_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_group.fields = function(buffer, offset, packet, parent, m_d_incremental_refresh_book_group_index)
  local index = offset

  -- Implicit M D Incremental Refresh Book Group Index
  if m_d_incremental_refresh_book_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_group_index, m_d_incremental_refresh_book_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_group.dissect = function(buffer, offset, packet, parent, m_d_incremental_refresh_book_group_index)
  if show.m_d_incremental_refresh_book_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_book_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_group.fields(buffer, offset, packet, parent, m_d_incremental_refresh_book_group_index)
  end
end

-- M D Incremental Refresh Book Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Incremental Refresh Book Groups
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_incremental_refresh_book_group_index = 1, num_in_group do
    index, m_d_incremental_refresh_book_group = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_group.dissect(buffer, index, packet, parent, m_d_incremental_refresh_book_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_incremental_refresh_book_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_incremental_refresh_book_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_book.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.size(buffer, offset + index)

  index = index + cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_incremental_refresh_book.fields = function(buffer, offset, packet, parent)
  ...
  index, m_d_incremental_refresh_book_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_groups.dissect(buffer, index, packet, parent)

  -- M D Incremental Refresh Book Order Groups: Struct of 2 fields
  index, m_d_incremental_refresh_book_order_groups = cme_futures_mdp3_sbe_v1_8.m_d_incremental_refresh_book_order_groups.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_group.fields = function(buffer, offset, packet, parent, m_d_instrument_definition_spread_leg_group_index)
  local index = offset

  -- Implicit M D Instrument Definition Spread Leg Group Index
  if m_d_instrument_definition_spread_leg_group_index ~= nil then
    local iteration = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_instrument_definition_spread_leg_group_index, m_d_instrument_definition_spread_leg_group_index)
    iteration:set_generated()
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_group.dissect = function(buffer, offset, packet, parent, m_d_instrument_definition_spread_leg_group_index)
  if show.m_d_instrument_definition_spread_leg_group then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_instrument_definition_spread_leg_group, buffer(offset, 0))
    local index = cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_group.fields(buffer, offset, packet, parent, m_d_instrument_definition_spread_leg_group_index)
    local length = index - offset
    parent:set_len(length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_group.display(packet, parent, length)
    parent:append_text(display)

    return index, parent
  else
    -- Skip element, add fields directly
    return cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_group.fields(buffer, offset, packet, parent, m_d_instrument_definition_spread_leg_group_index)
  end
end

-- M D Instrument Definition Spread Leg Groups
cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups = {}
...
cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: M D Instrument Definition Spread Leg Groups
cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  for m_d_instrument_definition_spread_leg_group_index = 1, num_in_group do
    index, m_d_instrument_definition_spread_leg_group = cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_group.dissect(buffer, index, packet, parent, m_d_instrument_definition_spread_leg_group_index)
  end
...
cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.m_d_instrument_definition_spread_leg_groups then
    local length = cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.m_d_instrument_definition_spread_leg_groups, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.min_price_increment_price.display = function(value)
  return "Min Price Increment Price: "..value
end

-- Translate: Min Price Increment Price
cme_futures_mdp3_sbe_v1_8.min_price_increment_price.translate = function(raw)
  return raw:tonumber()/10000000
end

-- Dissect: Min Price Increment Price
cme_futures_mdp3_sbe_v1_8.min_price_increment_price.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_mdp3_sbe_v1_8.min_price_increment_price.size
  local range = buffer(offset, length)
  local raw = range:le_int64()
  local value = cme_futures_mdp3_sbe_v1_8.min_price_increment_price.translate(raw)
  local display = cme_futures_mdp3_sbe_v1_8.min_price_increment_price.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.min_price_increment_price, range, value, display)
...
cme_futures_mdp3_sbe_v1_8.md_instrument_definition_spread.size = function(buffer, offset)
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.min_price_increment_price.size
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.size(buffer, offset + index)
...
cme_futures_mdp3_sbe_v1_8.md_instrument_definition_spread.fields = function(buffer, offset, packet, parent)
  ...
  index, min_price_increment_price = cme_futures_mdp3_sbe_v1_8.min_price_increment_price.dissect(buffer, index, packet, parent)
  ...
  index, m_d_instrument_definition_spread_leg_groups = cme_futures_mdp3_sbe_v1_8.m_d_instrument_definition_spread_leg_groups.dissect(buffer, index, packet, parent)
...
-- Admin Heartbeat
cme_futures_mdp3_sbe_v1_8.admin_heartbeat = {}
...
cme_futures_mdp3_sbe_v1_8.payload.size = function(buffer, offset, template_id)
  ...
  if template_id == 15 then
    return cme_futures_mdp3_sbe_v1_8.admin_login.size(buffer, offset)
  end
  -- Size of Admin Logout
  if template_id == 16 then
    return cme_futures_mdp3_sbe_v1_8.admin_logout.size(buffer, offset)
  end
  ...
  if template_id == 30 then
    return cme_futures_mdp3_sbe_v1_8.security_status.size(buffer, offset)
  end
...
cme_futures_mdp3_sbe_v1_8.message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + cme_futures_mdp3_sbe_v1_8.payload.size(buffer, payload_offset, payload_type)
...
cme_futures_mdp3_sbe_v1_8.message.fields = function(buffer, offset, packet, parent)
  local index = offset
...
-- Dissect: Message
cme_futures_mdp3_sbe_v1_8.message.dissect = function(buffer, offset, packet, parent)
  -- Optionally add dynamic struct element to protocol tree
  if show.message then
    local length = cme_futures_mdp3_sbe_v1_8.message.size(buffer, offset)
    local range = buffer(offset, length)
    local display = cme_futures_mdp3_sbe_v1_8.message.display(buffer, packet, parent)
    parent = parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.message, range, display)
  end

  return cme_futures_mdp3_sbe_v1_8.message.fields(buffer, offset, packet, parent)
end
...
cme_futures_mdp3_sbe_v1_8.message_sequence_number.display = function(value)
  return "Message Sequence Number: "..value
end

-- Dissect: Message Sequence Number
cme_futures_mdp3_sbe_v1_8.message_sequence_number.dissect = function(buffer, offset, packet, parent)
  local length = cme_futures_mdp3_sbe_v1_8.message_sequence_number.size
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = cme_futures_mdp3_sbe_v1_8.message_sequence_number.display(value, buffer, offset, packet, parent)

  parent:add(omi_cme_futures_mdp3_sbe_v1_8.fields.message_sequence_number, range, value, display)
...
cme_futures_mdp3_sbe_v1_8.binary_packet_header.fields = function(buffer, offset, packet, parent)
  ...
  index, message_sequence_number = cme_futures_mdp3_sbe_v1_8.message_sequence_number.dissect(buffer, index, packet, parent)
...
cme_futures_mdp3_sbe_v1_8.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    index, message = cme_futures_mdp3_sbe_v1_8.message.dissect(buffer, index, packet, parent)
  end
