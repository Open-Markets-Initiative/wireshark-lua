...
-- Cme Futures Streamline Sbe 5.8 Protocol
local cme_futures_streamline_sbe_v5_8 = Proto("Cme.Futures.Streamline.Sbe.v5.8.Lua", "Cme Futures Streamline Sbe 5.8")
...
-- Cme Futures Streamline Sbe 5.8 Fields
cme_futures_streamline_sbe_v5_8.fields.accrual_days = ProtoField.new("Accrual Days", "cme.futures.streamline.sbe.v5.8.accrualdays", ftypes.UINT32)
cme_futures_streamline_sbe_v5_8.fields.accrued_coupons = ProtoField.new("Accrued Coupons", "cme.futures.streamline.sbe.v5.8.accruedcoupons", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.actual = ProtoField.new("Actual", "cme.futures.streamline.sbe.v5.8.actual", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x02")
cme_futures_streamline_sbe_v5_8.fields.admin_login_315 = ProtoField.new("Admin Login 315", "cme.futures.streamline.sbe.v5.8.adminlogin315", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.admin_logout_316 = ProtoField.new("Admin Logout 316", "cme.futures.streamline.sbe.v5.8.adminlogout316", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.aggressor_side = ProtoField.new("Aggressor Side", "cme.futures.streamline.sbe.v5.8.aggressorside", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.appl_id = ProtoField.new("Appl Id", "cme.futures.streamline.sbe.v5.8.applid", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.batch_total_messages_u_int_16 = ProtoField.new("Batch Total Messages u Int 16", "cme.futures.streamline.sbe.v5.8.batchtotalmessagesuint16", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.batch_total_messages_u_int_16_null = ProtoField.new("Batch Total Messages u Int 16 Null", "cme.futures.streamline.sbe.v5.8.batchtotalmessagesuint16null", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.binary_packet_header = ProtoField.new("Binary Packet Header", "cme.futures.streamline.sbe.v5.8.binarypacketheader", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.block_length = ProtoField.new("Block Length", "cme.futures.streamline.sbe.v5.8.blocklength", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.coupon_rate_decimal_32 = ProtoField.new("Coupon Rate Decimal 32", "cme.futures.streamline.sbe.v5.8.couponratedecimal32", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.currency = ProtoField.new("Currency", "cme.futures.streamline.sbe.v5.8.currency", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.d_v_01 = ProtoField.new("D V 01", "cme.futures.streamline.sbe.v5.8.dv01", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.daily_incremental_eris_pai = ProtoField.new("Daily Incremental Eris Pai", "cme.futures.streamline.sbe.v5.8.dailyincrementalerispai", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.day = ProtoField.new("Day", "cme.futures.streamline.sbe.v5.8.day", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.end_of_event = ProtoField.new("End Of Event", "cme.futures.streamline.sbe.v5.8.endofevent", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x80")
cme_futures_streamline_sbe_v5_8.fields.eris_pai = ProtoField.new("Eris Pai", "cme.futures.streamline.sbe.v5.8.erispai", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.event_time_u_int_64 = ProtoField.new("Event Time u Int 64", "cme.futures.streamline.sbe.v5.8.eventtimeuint64", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.event_type_event_type_indices = ProtoField.new("Event Type Event Type Indices", "cme.futures.streamline.sbe.v5.8.eventtypeeventtypeindices", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.events_group = ProtoField.new("Events Group", "cme.futures.streamline.sbe.v5.8.eventsgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.events_groups = ProtoField.new("Events Groups", "cme.futures.streamline.sbe.v5.8.eventsgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.exponent = ProtoField.new("Exponent", "cme.futures.streamline.sbe.v5.8.exponent", ftypes.INT8)
cme_futures_streamline_sbe_v5_8.fields.fair_coupon_pct = ProtoField.new("Fair Coupon Pct", "cme.futures.streamline.sbe.v5.8.faircouponpct", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.fed_funds_date = ProtoField.new("Fed Funds Date", "cme.futures.streamline.sbe.v5.8.fedfundsdate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.fed_funds_rate = ProtoField.new("Fed Funds Rate", "cme.futures.streamline.sbe.v5.8.fedfundsrate", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.final = ProtoField.new("Final", "cme.futures.streamline.sbe.v5.8.final", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x01")
cme_futures_streamline_sbe_v5_8.fields.final_settlement_futures_price = ProtoField.new("Final Settlement Futures Price", "cme.futures.streamline.sbe.v5.8.finalsettlementfuturesprice", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.fixed_npv = ProtoField.new("Fixed Npv", "cme.futures.streamline.sbe.v5.8.fixednpv", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.fixed_payment = ProtoField.new("Fixed Payment", "cme.futures.streamline.sbe.v5.8.fixedpayment", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.float_npv = ProtoField.new("Float Npv", "cme.futures.streamline.sbe.v5.8.floatnpv", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.floating_payment = ProtoField.new("Floating Payment", "cme.futures.streamline.sbe.v5.8.floatingpayment", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.group_size = ProtoField.new("Group Size", "cme.futures.streamline.sbe.v5.8.groupsize", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.group_size_encoding = ProtoField.new("Group Size Encoding", "cme.futures.streamline.sbe.v5.8.groupsizeencoding", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.headline = ProtoField.new("Headline", "cme.futures.streamline.sbe.v5.8.headline", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.heart_bt_int = ProtoField.new("Heart Bt Int", "cme.futures.streamline.sbe.v5.8.heartbtint", ftypes.INT8)
cme_futures_streamline_sbe_v5_8.fields.inst_attrib_group = ProtoField.new("Inst Attrib Group", "cme.futures.streamline.sbe.v5.8.instattribgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.inst_attrib_groups = ProtoField.new("Inst Attrib Groups", "cme.futures.streamline.sbe.v5.8.instattribgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.inst_attrib_type = ProtoField.new("Inst Attrib Type", "cme.futures.streamline.sbe.v5.8.instattribtype", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.inst_attrib_value = ProtoField.new("Inst Attrib Value", "cme.futures.streamline.sbe.v5.8.instattribvalue", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.interpolation_factor = ProtoField.new("Interpolation Factor", "cme.futures.streamline.sbe.v5.8.interpolationfactor", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.last_implied_msg = ProtoField.new("Last Implied Msg", "cme.futures.streamline.sbe.v5.8.lastimpliedmsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x10")
cme_futures_streamline_sbe_v5_8.fields.last_quote_msg = ProtoField.new("Last Quote Msg", "cme.futures.streamline.sbe.v5.8.lastquotemsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x04")
cme_futures_streamline_sbe_v5_8.fields.last_stats_msg = ProtoField.new("Last Stats Msg", "cme.futures.streamline.sbe.v5.8.laststatsmsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x08")
cme_futures_streamline_sbe_v5_8.fields.last_trade_msg = ProtoField.new("Last Trade Msg", "cme.futures.streamline.sbe.v5.8.lasttrademsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x01")
cme_futures_streamline_sbe_v5_8.fields.last_volume_msg = ProtoField.new("Last Volume Msg", "cme.futures.streamline.sbe.v5.8.lastvolumemsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x02")
cme_futures_streamline_sbe_v5_8.fields.leg_benchmark_curve_name = ProtoField.new("Leg Benchmark Curve Name", "cme.futures.streamline.sbe.v5.8.legbenchmarkcurvename", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_contract_multiplier = ProtoField.new("Leg Contract Multiplier", "cme.futures.streamline.sbe.v5.8.legcontractmultiplier", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_credit_rating = ProtoField.new("Leg Credit Rating", "cme.futures.streamline.sbe.v5.8.legcreditrating", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_currency = ProtoField.new("Leg Currency", "cme.futures.streamline.sbe.v5.8.legcurrency", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_date_offset = ProtoField.new("Leg Date Offset", "cme.futures.streamline.sbe.v5.8.legdateoffset", ftypes.INT8)
cme_futures_streamline_sbe_v5_8.fields.leg_pay_frequencey = ProtoField.new("Leg Pay Frequencey", "cme.futures.streamline.sbe.v5.8.legpayfrequencey", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_purchase_rate = ProtoField.new("Leg Purchase Rate", "cme.futures.streamline.sbe.v5.8.legpurchaserate", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_ratio_qty = ProtoField.new("Leg Ratio Qty", "cme.futures.streamline.sbe.v5.8.legratioqty", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.leg_ref_id = ProtoField.new("Leg Ref Id", "cme.futures.streamline.sbe.v5.8.legrefid", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_security_group = ProtoField.new("Leg Security Group", "cme.futures.streamline.sbe.v5.8.legsecuritygroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_security_type = ProtoField.new("Leg Security Type", "cme.futures.streamline.sbe.v5.8.legsecuritytype", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.leg_side = ProtoField.new("Leg Side", "cme.futures.streamline.sbe.v5.8.legside", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.leg_symbol = ProtoField.new("Leg Symbol", "cme.futures.streamline.sbe.v5.8.legsymbol", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.lines_of_text_group = ProtoField.new("Lines Of Text Group", "cme.futures.streamline.sbe.v5.8.linesoftextgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.lines_of_text_groups = ProtoField.new("Lines Of Text Groups", "cme.futures.streamline.sbe.v5.8.linesoftextgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_feed_types_group = ProtoField.new("M D Feed Types Group", "cme.futures.streamline.sbe.v5.8.mdfeedtypesgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_feed_types_groups = ProtoField.new("M D Feed Types Groups", "cme.futures.streamline.sbe.v5.8.mdfeedtypesgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_group = ProtoField.new("M D Incremental Refresh Eris Group", "cme.futures.streamline.sbe.v5.8.mdincrementalrefresherisgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_groups = ProtoField.new("M D Incremental Refresh Eris Groups", "cme.futures.streamline.sbe.v5.8.mdincrementalrefresherisgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group = ProtoField.new("M D Incremental Refresh Eris Reference Data And Daily Statistics Group", "cme.futures.streamline.sbe.v5.8.mdincrementalrefresherisreferencedataanddailystatisticsgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups = ProtoField.new("M D Incremental Refresh Eris Reference Data And Daily Statistics Groups", "cme.futures.streamline.sbe.v5.8.mdincrementalrefresherisreferencedataanddailystatisticsgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_indices_group = ProtoField.new("M D Incremental Refresh Indices Group", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshindicesgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_indices_groups = ProtoField.new("M D Incremental Refresh Indices Groups", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshindicesgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_otc_group = ProtoField.new("M D Incremental Refresh Otc Group", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshotcgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_otc_groups = ProtoField.new("M D Incremental Refresh Otc Groups", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshotcgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_trade_blocks_group = ProtoField.new("M D Incremental Refresh Trade Blocks Group", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshtradeblocksgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_trade_blocks_groups = ProtoField.new("M D Incremental Refresh Trade Blocks Groups", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshtradeblocksgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_instrument_definition_eris_leg_group = ProtoField.new("M D Instrument Definition Eris Leg Group", "cme.futures.streamline.sbe.v5.8.mdinstrumentdefinitionerisleggroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.m_d_instrument_definition_eris_leg_groups = ProtoField.new("M D Instrument Definition Eris Leg Groups", "cme.futures.streamline.sbe.v5.8.mdinstrumentdefinitionerisleggroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.mantissa64 = ProtoField.new("Mantissa64", "cme.futures.streamline.sbe.v5.8.mantissa64", ftypes.INT64)
cme_futures_streamline_sbe_v5_8.fields.market_depth = ProtoField.new("Market Depth", "cme.futures.streamline.sbe.v5.8.marketdepth", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.market_sector = ProtoField.new("Market Sector", "cme.futures.streamline.sbe.v5.8.marketsector", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.match_event_indicator = ProtoField.new("Match Event Indicator", "cme.futures.streamline.sbe.v5.8.matcheventindicator", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.maturity_date = ProtoField.new("Maturity Date", "cme.futures.streamline.sbe.v5.8.maturitydate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.maturity_month_year = ProtoField.new("Maturity Month Year", "cme.futures.streamline.sbe.v5.8.maturitymonthyear", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_entry_code = ProtoField.new("Md Entry Code", "cme.futures.streamline.sbe.v5.8.mdentrycode", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.md_entry_date = ProtoField.new("Md Entry Date", "cme.futures.streamline.sbe.v5.8.mdentrydate", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.md_entry_id = ProtoField.new("Md Entry Id", "cme.futures.streamline.sbe.v5.8.mdentryid", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_entry_position_no = ProtoField.new("Md Entry Position No", "cme.futures.streamline.sbe.v5.8.mdentrypositionno", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.md_entry_px_pricenull = ProtoField.new("Md Entry Px Pricenull", "cme.futures.streamline.sbe.v5.8.mdentrypxpricenull", ftypes.INT64)
cme_futures_streamline_sbe_v5_8.fields.md_entry_size_u_int_64_null = ProtoField.new("Md Entry Size u Int 64 Null", "cme.futures.streamline.sbe.v5.8.mdentrysizeuint64null", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.md_entry_time = ProtoField.new("Md Entry Time", "cme.futures.streamline.sbe.v5.8.mdentrytime", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.md_entry_type_char = ProtoField.new("Md Entry Type Char", "cme.futures.streamline.sbe.v5.8.mdentrytypechar", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_entry_type_md_entry_type_indices = ProtoField.new("Md Entry Type Md Entry Type Indices", "cme.futures.streamline.sbe.v5.8.mdentrytypemdentrytypeindices", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_feed_type_string_len_3 = ProtoField.new("Md Feed Type String Len 3", "cme.futures.streamline.sbe.v5.8.mdfeedtypestringlen3", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_feed_type_string_length_2 = ProtoField.new("Md Feed Type String Length 2", "cme.futures.streamline.sbe.v5.8.mdfeedtypestringlength2", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_eris_351 = ProtoField.new("Md Incremental Refresh Eris 351", "cme.futures.streamline.sbe.v5.8.mdincrementalrefresheris351", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_eris_353 = ProtoField.new("Md Incremental Refresh Eris 353", "cme.futures.streamline.sbe.v5.8.mdincrementalrefresheris353", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_eris_reference_data_and_daily_statistics_333 = ProtoField.new("Md Incremental Refresh Eris Reference Data And Daily Statistics 333", "cme.futures.streamline.sbe.v5.8.mdincrementalrefresherisreferencedataanddailystatistics333", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_indices_348 = ProtoField.new("Md Incremental Refresh Indices 348", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshindices348", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_ot_c_356 = ProtoField.new("Md Incremental Refresh Ot C 356", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshotc356", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_340 = ProtoField.new("Md Incremental Refresh Trade Blocks 340", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshtradeblocks340", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_349 = ProtoField.new("Md Incremental Refresh Trade Blocks 349", "cme.futures.streamline.sbe.v5.8.mdincrementalrefreshtradeblocks349", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_instrument_definition_eris_363 = ProtoField.new("Md Instrument Definition Eris 363", "cme.futures.streamline.sbe.v5.8.mdinstrumentdefinitioneris363", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_instrument_definition_indices_347 = ProtoField.new("Md Instrument Definition Indices 347", "cme.futures.streamline.sbe.v5.8.mdinstrumentdefinitionindices347", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_news_indices_339 = ProtoField.new("Md News Indices 339", "cme.futures.streamline.sbe.v5.8.mdnewsindices339", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_update_action_char = ProtoField.new("Md Update Action Char", "cme.futures.streamline.sbe.v5.8.mdupdateactionchar", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.md_update_action_md_update_action = ProtoField.new("Md Update Action Md Update Action", "cme.futures.streamline.sbe.v5.8.mdupdateactionmdupdateaction", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.message = ProtoField.new("Message", "cme.futures.streamline.sbe.v5.8.message", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.message_header = ProtoField.new("Message Header", "cme.futures.streamline.sbe.v5.8.messageheader", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.message_sequence_number = ProtoField.new("Message Sequence Number", "cme.futures.streamline.sbe.v5.8.messagesequencenumber", ftypes.UINT32)
cme_futures_streamline_sbe_v5_8.fields.message_size = ProtoField.new("Message Size", "cme.futures.streamline.sbe.v5.8.messagesize", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.month = ProtoField.new("Month", "cme.futures.streamline.sbe.v5.8.month", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.net_chg_prev_day = ProtoField.new("Net Chg Prev Day", "cme.futures.streamline.sbe.v5.8.netchgprevday", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.net_pct_chg = ProtoField.new("Net Pct Chg", "cme.futures.streamline.sbe.v5.8.netpctchg", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.next_fixed_payment_amount = ProtoField.new("Next Fixed Payment Amount", "cme.futures.streamline.sbe.v5.8.nextfixedpaymentamount", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.next_fixed_payment_date = ProtoField.new("Next Fixed Payment Date", "cme.futures.streamline.sbe.v5.8.nextfixedpaymentdate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.next_floating_payment_amount = ProtoField.new("Next Floating Payment Amount", "cme.futures.streamline.sbe.v5.8.nextfloatingpaymentamount", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.next_floating_payment_date = ProtoField.new("Next Floating Payment Date", "cme.futures.streamline.sbe.v5.8.nextfloatingpaymentdate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.nominal = ProtoField.new("Nominal", "cme.futures.streamline.sbe.v5.8.nominal", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.notional_percentage_outstanding = ProtoField.new("Notional Percentage Outstanding", "cme.futures.streamline.sbe.v5.8.notionalpercentageoutstanding", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.npv = ProtoField.new("Npv", "cme.futures.streamline.sbe.v5.8.npv", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.null_value = ProtoField.new("Null Value", "cme.futures.streamline.sbe.v5.8.nullvalue", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x80")
cme_futures_streamline_sbe_v5_8.fields.num_in_group_uint_16 = ProtoField.new("Num In Group uint 16", "cme.futures.streamline.sbe.v5.8.numingroupuint16", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.num_in_group_uint_8 = ProtoField.new("Num In Group uint 8", "cme.futures.streamline.sbe.v5.8.numingroupuint8", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.number_of_orders = ProtoField.new("Number Of Orders", "cme.futures.streamline.sbe.v5.8.numberoforders", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.open_close_settl_flag_int_8_null = ProtoField.new("Open Close Settl Flag Int 8 Null", "cme.futures.streamline.sbe.v5.8.openclosesettlflagint8null", ftypes.INT8)
cme_futures_streamline_sbe_v5_8.fields.open_close_settl_flag_u_int_8_null = ProtoField.new("Open Close Settl Flag u Int 8 Null", "cme.futures.streamline.sbe.v5.8.openclosesettlflaguint8null", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.orig_time = ProtoField.new("Orig Time", "cme.futures.streamline.sbe.v5.8.origtime", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.p_v_01 = ProtoField.new("P V 01", "cme.futures.streamline.sbe.v5.8.pv01", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.packet = ProtoField.new("Packet", "cme.futures.streamline.sbe.v5.8.packet", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.payload = ProtoField.new("Payload", "cme.futures.streamline.sbe.v5.8.payload", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.percent_trading = ProtoField.new("Percent Trading", "cme.futures.streamline.sbe.v5.8.percenttrading", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.previous_eris_pai = ProtoField.new("Previous Eris Pai", "cme.futures.streamline.sbe.v5.8.previouserispai", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.previous_fixing_date = ProtoField.new("Previous Fixing Date", "cme.futures.streamline.sbe.v5.8.previousfixingdate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.previous_fixing_rate = ProtoField.new("Previous Fixing Rate", "cme.futures.streamline.sbe.v5.8.previousfixingrate", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.price_type = ProtoField.new("Price Type", "cme.futures.streamline.sbe.v5.8.pricetype", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.product_complex = ProtoField.new("Product Complex", "cme.futures.streamline.sbe.v5.8.productcomplex", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.product_int_8 = ProtoField.new("Product Int 8", "cme.futures.streamline.sbe.v5.8.productint8", ftypes.INT8)
cme_futures_streamline_sbe_v5_8.fields.product_u_int_8_null = ProtoField.new("Product u Int 8 Null", "cme.futures.streamline.sbe.v5.8.productuint8null", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.put_or_call = ProtoField.new("Put Or Call", "cme.futures.streamline.sbe.v5.8.putorcall", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.quote_condition = ProtoField.new("Quote Condition", "cme.futures.streamline.sbe.v5.8.quotecondition", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.quote_req_id = ProtoField.new("Quote Req Id", "cme.futures.streamline.sbe.v5.8.quotereqid", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.quote_request_345 = ProtoField.new("Quote Request 345", "cme.futures.streamline.sbe.v5.8.quoterequest345", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.rate_descriptor = ProtoField.new("Rate Descriptor", "cme.futures.streamline.sbe.v5.8.ratedescriptor", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.rate_type = ProtoField.new("Rate Type", "cme.futures.streamline.sbe.v5.8.ratetype", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.recovery_msg = ProtoField.new("Recovery Msg", "cme.futures.streamline.sbe.v5.8.recoverymsg", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x20")
cme_futures_streamline_sbe_v5_8.fields.reference_i_d_string_100 = ProtoField.new("Reference I D String 100", "cme.futures.streamline.sbe.v5.8.referenceidstring100", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.reference_i_d_string_length_50 = ProtoField.new("Reference I D String Length 50", "cme.futures.streamline.sbe.v5.8.referenceidstringlength50", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.related_sym_group = ProtoField.new("Related Sym Group", "cme.futures.streamline.sbe.v5.8.relatedsymgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.related_sym_groups = ProtoField.new("Related Sym Groups", "cme.futures.streamline.sbe.v5.8.relatedsymgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.reserved = ProtoField.new("Reserved", "cme.futures.streamline.sbe.v5.8.reserved", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x40")
cme_futures_streamline_sbe_v5_8.fields.reserved_bits = ProtoField.new("Reserved Bits", "cme.futures.streamline.sbe.v5.8.reservedbits", ftypes.UINT8, nil, base.DEC, "0x78")
cme_futures_streamline_sbe_v5_8.fields.restructuring_type = ProtoField.new("Restructuring Type", "cme.futures.streamline.sbe.v5.8.restructuringtype", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.rounded = ProtoField.new("Rounded", "cme.futures.streamline.sbe.v5.8.rounded", ftypes.UINT8, {[1]="Yes",[0]="No"}, base.DEC, "0x04")
cme_futures_streamline_sbe_v5_8.fields.rpt_seq = ProtoField.new("Rpt Seq", "cme.futures.streamline.sbe.v5.8.rptseq", ftypes.UINT32)
cme_futures_streamline_sbe_v5_8.fields.schema_id = ProtoField.new("Schema Id", "cme.futures.streamline.sbe.v5.8.schemaid", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.sector_group = ProtoField.new("Sector Group", "cme.futures.streamline.sbe.v5.8.sectorgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.sector_sub_group = ProtoField.new("Sector Sub Group", "cme.futures.streamline.sbe.v5.8.sectorsubgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_alt_id = ProtoField.new("Security Alt Id", "cme.futures.streamline.sbe.v5.8.securityaltid", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_alt_id_group = ProtoField.new("Security Alt Id Group", "cme.futures.streamline.sbe.v5.8.securityaltidgroup", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_alt_id_groups = ProtoField.new("Security Alt Id Groups", "cme.futures.streamline.sbe.v5.8.securityaltidgroups", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_alt_id_source = ProtoField.new("Security Alt Id Source", "cme.futures.streamline.sbe.v5.8.securityaltidsource", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_description = ProtoField.new("Security Description", "cme.futures.streamline.sbe.v5.8.securitydescription", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_exchange_security_exchange = ProtoField.new("Security Exchange Security Exchange", "cme.futures.streamline.sbe.v5.8.securityexchangesecurityexchange", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_exchange_string_4 = ProtoField.new("Security Exchange String 4", "cme.futures.streamline.sbe.v5.8.securityexchangestring4", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_group_string_12 = ProtoField.new("Security Group String 12", "cme.futures.streamline.sbe.v5.8.securitygroupstring12", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_group_string_length_26 = ProtoField.new("Security Group String Length 26", "cme.futures.streamline.sbe.v5.8.securitygroupstringlength26", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_id = ProtoField.new("Security Id", "cme.futures.streamline.sbe.v5.8.securityid", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.security_sub_type = ProtoField.new("Security Sub Type", "cme.futures.streamline.sbe.v5.8.securitysubtype", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_type_string_4 = ProtoField.new("Security Type String 4", "cme.futures.streamline.sbe.v5.8.securitytypestring4", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_type_string_length_9 = ProtoField.new("Security Type String Length 9", "cme.futures.streamline.sbe.v5.8.securitytypestringlength9", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.security_update_action = ProtoField.new("Security Update Action", "cme.futures.streamline.sbe.v5.8.securityupdateaction", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.sending_time = ProtoField.new("Sending Time", "cme.futures.streamline.sbe.v5.8.sendingtime", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.seniority = ProtoField.new("Seniority", "cme.futures.streamline.sbe.v5.8.seniority", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.settl_date = ProtoField.new("Settl Date", "cme.futures.streamline.sbe.v5.8.settldate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.settl_price_type = ProtoField.new("Settl Price Type", "cme.futures.streamline.sbe.v5.8.settlpricetype", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.settlement_npv = ProtoField.new("Settlement Npv", "cme.futures.streamline.sbe.v5.8.settlementnpv", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.strategy_link_id = ProtoField.new("Strategy Link Id", "cme.futures.streamline.sbe.v5.8.strategylinkid", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.strike_price_pricenull = ProtoField.new("Strike Price Pricenull", "cme.futures.streamline.sbe.v5.8.strikepricepricenull", ftypes.INT64)
cme_futures_streamline_sbe_v5_8.fields.symbol = ProtoField.new("Symbol", "cme.futures.streamline.sbe.v5.8.symbol", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.template_id = ProtoField.new("Template Id", "cme.futures.streamline.sbe.v5.8.templateid", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.text_string_length_500 = ProtoField.new("Text String Length 500", "cme.futures.streamline.sbe.v5.8.textstringlength500", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.text_text = ProtoField.new("Text Text", "cme.futures.streamline.sbe.v5.8.texttext", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.trade_date = ProtoField.new("Trade Date", "cme.futures.streamline.sbe.v5.8.tradedate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.trade_id = ProtoField.new("Trade Id", "cme.futures.streamline.sbe.v5.8.tradeid", ftypes.INT32)
cme_futures_streamline_sbe_v5_8.fields.trading_reference_date = ProtoField.new("Trading Reference Date", "cme.futures.streamline.sbe.v5.8.tradingreferencedate", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.transact_time_u_int_64 = ProtoField.new("Transact Time u Int 64", "cme.futures.streamline.sbe.v5.8.transacttimeuint64", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.transact_time_u_int_64_null = ProtoField.new("Transact Time u Int 64 Null", "cme.futures.streamline.sbe.v5.8.transacttimeuint64null", ftypes.UINT64)
cme_futures_streamline_sbe_v5_8.fields.trd_type = ProtoField.new("Trd Type", "cme.futures.streamline.sbe.v5.8.trdtype", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.unit_of_measure = ProtoField.new("Unit Of Measure", "cme.futures.streamline.sbe.v5.8.unitofmeasure", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.unit_of_measure_currency_currency = ProtoField.new("Unit Of Measure Currency Currency", "cme.futures.streamline.sbe.v5.8.unitofmeasurecurrencycurrency", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.unit_of_measure_currency_string_len_3 = ProtoField.new("Unit Of Measure Currency String Len 3", "cme.futures.streamline.sbe.v5.8.unitofmeasurecurrencystringlen3", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.unit_of_measure_qty_pricenull = ProtoField.new("Unit Of Measure Qty Pricenull", "cme.futures.streamline.sbe.v5.8.unitofmeasureqtypricenull", ftypes.INT64)
cme_futures_streamline_sbe_v5_8.fields.user_defined_instrument = ProtoField.new("User Defined Instrument", "cme.futures.streamline.sbe.v5.8.userdefinedinstrument", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.version = ProtoField.new("Version", "cme.futures.streamline.sbe.v5.8.version", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.vol_type = ProtoField.new("Vol Type", "cme.futures.streamline.sbe.v5.8.voltype", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.week = ProtoField.new("Week", "cme.futures.streamline.sbe.v5.8.week", ftypes.UINT8)
cme_futures_streamline_sbe_v5_8.fields.year = ProtoField.new("Year", "cme.futures.streamline.sbe.v5.8.year", ftypes.UINT16)
cme_futures_streamline_sbe_v5_8.fields.yield = ProtoField.new("Yield", "cme.futures.streamline.sbe.v5.8.yield", ftypes.STRING)
cme_futures_streamline_sbe_v5_8.fields.yield_type = ProtoField.new("Yield Type", "cme.futures.streamline.sbe.v5.8.yieldtype", ftypes.STRING)

-----------------------------------------------------------------------
-- Declare Dissection Options
-----------------------------------------------------------------------

-- Cme Futures Streamline Sbe 5.8 Element Dissection Options
...
-- Register Cme Futures Streamline Sbe 5.8 Show Options
cme_futures_streamline_sbe_v5_8.prefs.show_accrued_coupons = Pref.bool("Show Accrued Coupons", show.accrued_coupons, "Parse and add Accrued Coupons to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_admin_login_315 = Pref.bool("Show Admin Login 315", show.admin_login_315, "Parse and add Admin Login 315 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_admin_logout_316 = Pref.bool("Show Admin Logout 316", show.admin_logout_316, "Parse and add Admin Logout 316 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_binary_packet_header = Pref.bool("Show Binary Packet Header", show.binary_packet_header, "Parse and add Binary Packet Header to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_d_v_01 = Pref.bool("Show D V 01", show.d_v_01, "Parse and add D V 01 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_daily_incremental_eris_pai = Pref.bool("Show Daily Incremental Eris Pai", show.daily_incremental_eris_pai, "Parse and add Daily Incremental Eris Pai to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_eris_pai = Pref.bool("Show Eris Pai", show.eris_pai, "Parse and add Eris Pai to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_events_group = Pref.bool("Show Events Group", show.events_group, "Parse and add Events Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_events_groups = Pref.bool("Show Events Groups", show.events_groups, "Parse and add Events Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_fair_coupon_pct = Pref.bool("Show Fair Coupon Pct", show.fair_coupon_pct, "Parse and add Fair Coupon Pct to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_fed_funds_rate = Pref.bool("Show Fed Funds Rate", show.fed_funds_rate, "Parse and add Fed Funds Rate to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_final_settlement_futures_price = Pref.bool("Show Final Settlement Futures Price", show.final_settlement_futures_price, "Parse and add Final Settlement Futures Price to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_fixed_npv = Pref.bool("Show Fixed Npv", show.fixed_npv, "Parse and add Fixed Npv to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_fixed_payment = Pref.bool("Show Fixed Payment", show.fixed_payment, "Parse and add Fixed Payment to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_float_npv = Pref.bool("Show Float Npv", show.float_npv, "Parse and add Float Npv to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_floating_payment = Pref.bool("Show Floating Payment", show.floating_payment, "Parse and add Floating Payment to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_group_size = Pref.bool("Show Group Size", show.group_size, "Parse and add Group Size to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_group_size_encoding = Pref.bool("Show Group Size Encoding", show.group_size_encoding, "Parse and add Group Size Encoding to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_inst_attrib_group = Pref.bool("Show Inst Attrib Group", show.inst_attrib_group, "Parse and add Inst Attrib Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_inst_attrib_groups = Pref.bool("Show Inst Attrib Groups", show.inst_attrib_groups, "Parse and add Inst Attrib Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_interpolation_factor = Pref.bool("Show Interpolation Factor", show.interpolation_factor, "Parse and add Interpolation Factor to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_leg_contract_multiplier = Pref.bool("Show Leg Contract Multiplier", show.leg_contract_multiplier, "Parse and add Leg Contract Multiplier to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_leg_purchase_rate = Pref.bool("Show Leg Purchase Rate", show.leg_purchase_rate, "Parse and add Leg Purchase Rate to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_lines_of_text_group = Pref.bool("Show Lines Of Text Group", show.lines_of_text_group, "Parse and add Lines Of Text Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_lines_of_text_groups = Pref.bool("Show Lines Of Text Groups", show.lines_of_text_groups, "Parse and add Lines Of Text Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_feed_types_group = Pref.bool("Show M D Feed Types Group", show.m_d_feed_types_group, "Parse and add M D Feed Types Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_feed_types_groups = Pref.bool("Show M D Feed Types Groups", show.m_d_feed_types_groups, "Parse and add M D Feed Types Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_group = Pref.bool("Show M D Incremental Refresh Eris Group", show.m_d_incremental_refresh_eris_group, "Parse and add M D Incremental Refresh Eris Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_groups = Pref.bool("Show M D Incremental Refresh Eris Groups", show.m_d_incremental_refresh_eris_groups, "Parse and add M D Incremental Refresh Eris Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group = Pref.bool("Show M D Incremental Refresh Eris Reference Data And Daily Statistics Group", show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group, "Parse and add M D Incremental Refresh Eris Reference Data And Daily Statistics Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups = Pref.bool("Show M D Incremental Refresh Eris Reference Data And Daily Statistics Groups", show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups, "Parse and add M D Incremental Refresh Eris Reference Data And Daily Statistics Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_indices_group = Pref.bool("Show M D Incremental Refresh Indices Group", show.m_d_incremental_refresh_indices_group, "Parse and add M D Incremental Refresh Indices Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_indices_groups = Pref.bool("Show M D Incremental Refresh Indices Groups", show.m_d_incremental_refresh_indices_groups, "Parse and add M D Incremental Refresh Indices Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_otc_group = Pref.bool("Show M D Incremental Refresh Otc Group", show.m_d_incremental_refresh_otc_group, "Parse and add M D Incremental Refresh Otc Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_otc_groups = Pref.bool("Show M D Incremental Refresh Otc Groups", show.m_d_incremental_refresh_otc_groups, "Parse and add M D Incremental Refresh Otc Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_trade_blocks_group = Pref.bool("Show M D Incremental Refresh Trade Blocks Group", show.m_d_incremental_refresh_trade_blocks_group, "Parse and add M D Incremental Refresh Trade Blocks Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_trade_blocks_groups = Pref.bool("Show M D Incremental Refresh Trade Blocks Groups", show.m_d_incremental_refresh_trade_blocks_groups, "Parse and add M D Incremental Refresh Trade Blocks Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_instrument_definition_eris_leg_group = Pref.bool("Show M D Instrument Definition Eris Leg Group", show.m_d_instrument_definition_eris_leg_group, "Parse and add M D Instrument Definition Eris Leg Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_m_d_instrument_definition_eris_leg_groups = Pref.bool("Show M D Instrument Definition Eris Leg Groups", show.m_d_instrument_definition_eris_leg_groups, "Parse and add M D Instrument Definition Eris Leg Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_match_event_indicator = Pref.bool("Show Match Event Indicator", show.match_event_indicator, "Parse and add Match Event Indicator to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_maturity_month_year = Pref.bool("Show Maturity Month Year", show.maturity_month_year, "Parse and add Maturity Month Year to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_351 = Pref.bool("Show Md Incremental Refresh Eris 351", show.md_incremental_refresh_eris_351, "Parse and add Md Incremental Refresh Eris 351 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_353 = Pref.bool("Show Md Incremental Refresh Eris 353", show.md_incremental_refresh_eris_353, "Parse and add Md Incremental Refresh Eris 353 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_reference_data_and_daily_statistics_333 = Pref.bool("Show Md Incremental Refresh Eris Reference Data And Daily Statistics 333", show.md_incremental_refresh_eris_reference_data_and_daily_statistics_333, "Parse and add Md Incremental Refresh Eris Reference Data And Daily Statistics 333 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_indices_348 = Pref.bool("Show Md Incremental Refresh Indices 348", show.md_incremental_refresh_indices_348, "Parse and add Md Incremental Refresh Indices 348 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_ot_c_356 = Pref.bool("Show Md Incremental Refresh Ot C 356", show.md_incremental_refresh_ot_c_356, "Parse and add Md Incremental Refresh Ot C 356 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_340 = Pref.bool("Show Md Incremental Refresh Trade Blocks 340", show.md_incremental_refresh_trade_blocks_340, "Parse and add Md Incremental Refresh Trade Blocks 340 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_349 = Pref.bool("Show Md Incremental Refresh Trade Blocks 349", show.md_incremental_refresh_trade_blocks_349, "Parse and add Md Incremental Refresh Trade Blocks 349 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_instrument_definition_eris_363 = Pref.bool("Show Md Instrument Definition Eris 363", show.md_instrument_definition_eris_363, "Parse and add Md Instrument Definition Eris 363 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_instrument_definition_indices_347 = Pref.bool("Show Md Instrument Definition Indices 347", show.md_instrument_definition_indices_347, "Parse and add Md Instrument Definition Indices 347 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_md_news_indices_339 = Pref.bool("Show Md News Indices 339", show.md_news_indices_339, "Parse and add Md News Indices 339 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_message = Pref.bool("Show Message", show.message, "Parse and add Message to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_message_header = Pref.bool("Show Message Header", show.message_header, "Parse and add Message Header to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_net_chg_prev_day = Pref.bool("Show Net Chg Prev Day", show.net_chg_prev_day, "Parse and add Net Chg Prev Day to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_net_pct_chg = Pref.bool("Show Net Pct Chg", show.net_pct_chg, "Parse and add Net Pct Chg to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_next_fixed_payment_amount = Pref.bool("Show Next Fixed Payment Amount", show.next_fixed_payment_amount, "Parse and add Next Fixed Payment Amount to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_next_floating_payment_amount = Pref.bool("Show Next Floating Payment Amount", show.next_floating_payment_amount, "Parse and add Next Floating Payment Amount to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_npv = Pref.bool("Show Npv", show.npv, "Parse and add Npv to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_p_v_01 = Pref.bool("Show P V 01", show.p_v_01, "Parse and add P V 01 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_packet = Pref.bool("Show Packet", show.packet, "Parse and add Packet to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_percent_trading = Pref.bool("Show Percent Trading", show.percent_trading, "Parse and add Percent Trading to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_previous_eris_pai = Pref.bool("Show Previous Eris Pai", show.previous_eris_pai, "Parse and add Previous Eris Pai to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_previous_fixing_rate = Pref.bool("Show Previous Fixing Rate", show.previous_fixing_rate, "Parse and add Previous Fixing Rate to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_quote_request_345 = Pref.bool("Show Quote Request 345", show.quote_request_345, "Parse and add Quote Request 345 to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_related_sym_group = Pref.bool("Show Related Sym Group", show.related_sym_group, "Parse and add Related Sym Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_related_sym_groups = Pref.bool("Show Related Sym Groups", show.related_sym_groups, "Parse and add Related Sym Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_security_alt_id_group = Pref.bool("Show Security Alt Id Group", show.security_alt_id_group, "Parse and add Security Alt Id Group to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_security_alt_id_groups = Pref.bool("Show Security Alt Id Groups", show.security_alt_id_groups, "Parse and add Security Alt Id Groups to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_settl_price_type = Pref.bool("Show Settl Price Type", show.settl_price_type, "Parse and add Settl Price Type to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_settlement_npv = Pref.bool("Show Settlement Npv", show.settlement_npv, "Parse and add Settlement Npv to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_yield = Pref.bool("Show Yield", show.yield, "Parse and add Yield to protocol tree")
cme_futures_streamline_sbe_v5_8.prefs.show_payload = Pref.bool("Show Payload", show.payload, "Parse and add Payload to protocol tree")

-- Handle changed preferences
function cme_futures_streamline_sbe_v5_8.prefs_changed()
  local changed = false

  -- Check if show options have changed
  if show.accrued_coupons ~= cme_futures_streamline_sbe_v5_8.prefs.show_accrued_coupons then
    show.accrued_coupons = cme_futures_streamline_sbe_v5_8.prefs.show_accrued_coupons
    changed = true
  end
  if show.admin_login_315 ~= cme_futures_streamline_sbe_v5_8.prefs.show_admin_login_315 then
    show.admin_login_315 = cme_futures_streamline_sbe_v5_8.prefs.show_admin_login_315
    changed = true
  end
  if show.admin_logout_316 ~= cme_futures_streamline_sbe_v5_8.prefs.show_admin_logout_316 then
    show.admin_logout_316 = cme_futures_streamline_sbe_v5_8.prefs.show_admin_logout_316
    changed = true
  end
  if show.binary_packet_header ~= cme_futures_streamline_sbe_v5_8.prefs.show_binary_packet_header then
    show.binary_packet_header = cme_futures_streamline_sbe_v5_8.prefs.show_binary_packet_header
    changed = true
  end
  if show.d_v_01 ~= cme_futures_streamline_sbe_v5_8.prefs.show_d_v_01 then
    show.d_v_01 = cme_futures_streamline_sbe_v5_8.prefs.show_d_v_01
    changed = true
  end
  if show.daily_incremental_eris_pai ~= cme_futures_streamline_sbe_v5_8.prefs.show_daily_incremental_eris_pai then
    show.daily_incremental_eris_pai = cme_futures_streamline_sbe_v5_8.prefs.show_daily_incremental_eris_pai
    changed = true
  end
  if show.eris_pai ~= cme_futures_streamline_sbe_v5_8.prefs.show_eris_pai then
    show.eris_pai = cme_futures_streamline_sbe_v5_8.prefs.show_eris_pai
    changed = true
  end
  if show.events_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_events_group then
    show.events_group = cme_futures_streamline_sbe_v5_8.prefs.show_events_group
    changed = true
  end
  if show.events_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_events_groups then
    show.events_groups = cme_futures_streamline_sbe_v5_8.prefs.show_events_groups
    changed = true
  end
  if show.fair_coupon_pct ~= cme_futures_streamline_sbe_v5_8.prefs.show_fair_coupon_pct then
    show.fair_coupon_pct = cme_futures_streamline_sbe_v5_8.prefs.show_fair_coupon_pct
    changed = true
  end
  if show.fed_funds_rate ~= cme_futures_streamline_sbe_v5_8.prefs.show_fed_funds_rate then
    show.fed_funds_rate = cme_futures_streamline_sbe_v5_8.prefs.show_fed_funds_rate
    changed = true
  end
  if show.final_settlement_futures_price ~= cme_futures_streamline_sbe_v5_8.prefs.show_final_settlement_futures_price then
    show.final_settlement_futures_price = cme_futures_streamline_sbe_v5_8.prefs.show_final_settlement_futures_price
    changed = true
  end
  if show.fixed_npv ~= cme_futures_streamline_sbe_v5_8.prefs.show_fixed_npv then
    show.fixed_npv = cme_futures_streamline_sbe_v5_8.prefs.show_fixed_npv
    changed = true
  end
  if show.fixed_payment ~= cme_futures_streamline_sbe_v5_8.prefs.show_fixed_payment then
    show.fixed_payment = cme_futures_streamline_sbe_v5_8.prefs.show_fixed_payment
    changed = true
  end
  if show.float_npv ~= cme_futures_streamline_sbe_v5_8.prefs.show_float_npv then
    show.float_npv = cme_futures_streamline_sbe_v5_8.prefs.show_float_npv
    changed = true
  end
  if show.floating_payment ~= cme_futures_streamline_sbe_v5_8.prefs.show_floating_payment then
    show.floating_payment = cme_futures_streamline_sbe_v5_8.prefs.show_floating_payment
    changed = true
  end
  if show.group_size ~= cme_futures_streamline_sbe_v5_8.prefs.show_group_size then
    show.group_size = cme_futures_streamline_sbe_v5_8.prefs.show_group_size
    changed = true
  end
  if show.group_size_encoding ~= cme_futures_streamline_sbe_v5_8.prefs.show_group_size_encoding then
    show.group_size_encoding = cme_futures_streamline_sbe_v5_8.prefs.show_group_size_encoding
    changed = true
  end
  if show.inst_attrib_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_inst_attrib_group then
    show.inst_attrib_group = cme_futures_streamline_sbe_v5_8.prefs.show_inst_attrib_group
    changed = true
  end
  if show.inst_attrib_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_inst_attrib_groups then
    show.inst_attrib_groups = cme_futures_streamline_sbe_v5_8.prefs.show_inst_attrib_groups
    changed = true
  end
  if show.interpolation_factor ~= cme_futures_streamline_sbe_v5_8.prefs.show_interpolation_factor then
    show.interpolation_factor = cme_futures_streamline_sbe_v5_8.prefs.show_interpolation_factor
    changed = true
  end
  if show.leg_contract_multiplier ~= cme_futures_streamline_sbe_v5_8.prefs.show_leg_contract_multiplier then
    show.leg_contract_multiplier = cme_futures_streamline_sbe_v5_8.prefs.show_leg_contract_multiplier
    changed = true
  end
  if show.leg_purchase_rate ~= cme_futures_streamline_sbe_v5_8.prefs.show_leg_purchase_rate then
    show.leg_purchase_rate = cme_futures_streamline_sbe_v5_8.prefs.show_leg_purchase_rate
    changed = true
  end
  if show.lines_of_text_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_lines_of_text_group then
    show.lines_of_text_group = cme_futures_streamline_sbe_v5_8.prefs.show_lines_of_text_group
    changed = true
  end
  if show.lines_of_text_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_lines_of_text_groups then
    show.lines_of_text_groups = cme_futures_streamline_sbe_v5_8.prefs.show_lines_of_text_groups
    changed = true
  end
  if show.m_d_feed_types_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_feed_types_group then
    show.m_d_feed_types_group = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_feed_types_group
    changed = true
  end
  if show.m_d_feed_types_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_feed_types_groups then
    show.m_d_feed_types_groups = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_feed_types_groups
    changed = true
  end
  if show.m_d_incremental_refresh_eris_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_group then
    show.m_d_incremental_refresh_eris_group = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_group
    changed = true
  end
  if show.m_d_incremental_refresh_eris_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_groups then
    show.m_d_incremental_refresh_eris_groups = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_groups
    changed = true
  end
  if show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group then
    show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group
    changed = true
  end
  if show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups then
    show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups
    changed = true
  end
  if show.m_d_incremental_refresh_indices_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_indices_group then
    show.m_d_incremental_refresh_indices_group = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_indices_group
    changed = true
  end
  if show.m_d_incremental_refresh_indices_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_indices_groups then
    show.m_d_incremental_refresh_indices_groups = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_indices_groups
    changed = true
  end
  if show.m_d_incremental_refresh_otc_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_otc_group then
    show.m_d_incremental_refresh_otc_group = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_otc_group
    changed = true
  end
  if show.m_d_incremental_refresh_otc_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_otc_groups then
    show.m_d_incremental_refresh_otc_groups = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_otc_groups
    changed = true
  end
  if show.m_d_incremental_refresh_trade_blocks_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_trade_blocks_group then
    show.m_d_incremental_refresh_trade_blocks_group = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_trade_blocks_group
    changed = true
  end
  if show.m_d_incremental_refresh_trade_blocks_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_trade_blocks_groups then
    show.m_d_incremental_refresh_trade_blocks_groups = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_incremental_refresh_trade_blocks_groups
    changed = true
  end
  if show.m_d_instrument_definition_eris_leg_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_instrument_definition_eris_leg_group then
    show.m_d_instrument_definition_eris_leg_group = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_instrument_definition_eris_leg_group
    changed = true
  end
  if show.m_d_instrument_definition_eris_leg_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_m_d_instrument_definition_eris_leg_groups then
    show.m_d_instrument_definition_eris_leg_groups = cme_futures_streamline_sbe_v5_8.prefs.show_m_d_instrument_definition_eris_leg_groups
    changed = true
  end
  if show.match_event_indicator ~= cme_futures_streamline_sbe_v5_8.prefs.show_match_event_indicator then
    show.match_event_indicator = cme_futures_streamline_sbe_v5_8.prefs.show_match_event_indicator
    changed = true
  end
  if show.maturity_month_year ~= cme_futures_streamline_sbe_v5_8.prefs.show_maturity_month_year then
    show.maturity_month_year = cme_futures_streamline_sbe_v5_8.prefs.show_maturity_month_year
    changed = true
  end
  if show.md_incremental_refresh_eris_351 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_351 then
    show.md_incremental_refresh_eris_351 = cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_351
    changed = true
  end
  if show.md_incremental_refresh_eris_353 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_353 then
    show.md_incremental_refresh_eris_353 = cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_353
    changed = true
  end
  if show.md_incremental_refresh_eris_reference_data_and_daily_statistics_333 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_reference_data_and_daily_statistics_333 then
    show.md_incremental_refresh_eris_reference_data_and_daily_statistics_333 = cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_eris_reference_data_and_daily_statistics_333
    changed = true
  end
  if show.md_incremental_refresh_indices_348 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_indices_348 then
    show.md_incremental_refresh_indices_348 = cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_indices_348
    changed = true
  end
  if show.md_incremental_refresh_ot_c_356 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_ot_c_356 then
    show.md_incremental_refresh_ot_c_356 = cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_ot_c_356
    changed = true
  end
  if show.md_incremental_refresh_trade_blocks_340 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_340 then
    show.md_incremental_refresh_trade_blocks_340 = cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_340
    changed = true
  end
  if show.md_incremental_refresh_trade_blocks_349 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_349 then
    show.md_incremental_refresh_trade_blocks_349 = cme_futures_streamline_sbe_v5_8.prefs.show_md_incremental_refresh_trade_blocks_349
    changed = true
  end
  if show.md_instrument_definition_eris_363 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_instrument_definition_eris_363 then
    show.md_instrument_definition_eris_363 = cme_futures_streamline_sbe_v5_8.prefs.show_md_instrument_definition_eris_363
    changed = true
  end
  if show.md_instrument_definition_indices_347 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_instrument_definition_indices_347 then
    show.md_instrument_definition_indices_347 = cme_futures_streamline_sbe_v5_8.prefs.show_md_instrument_definition_indices_347
    changed = true
  end
  if show.md_news_indices_339 ~= cme_futures_streamline_sbe_v5_8.prefs.show_md_news_indices_339 then
    show.md_news_indices_339 = cme_futures_streamline_sbe_v5_8.prefs.show_md_news_indices_339
    changed = true
  end
  if show.message ~= cme_futures_streamline_sbe_v5_8.prefs.show_message then
    show.message = cme_futures_streamline_sbe_v5_8.prefs.show_message
    changed = true
  end
  if show.message_header ~= cme_futures_streamline_sbe_v5_8.prefs.show_message_header then
    show.message_header = cme_futures_streamline_sbe_v5_8.prefs.show_message_header
    changed = true
  end
  if show.net_chg_prev_day ~= cme_futures_streamline_sbe_v5_8.prefs.show_net_chg_prev_day then
    show.net_chg_prev_day = cme_futures_streamline_sbe_v5_8.prefs.show_net_chg_prev_day
    changed = true
  end
  if show.net_pct_chg ~= cme_futures_streamline_sbe_v5_8.prefs.show_net_pct_chg then
    show.net_pct_chg = cme_futures_streamline_sbe_v5_8.prefs.show_net_pct_chg
    changed = true
  end
  if show.next_fixed_payment_amount ~= cme_futures_streamline_sbe_v5_8.prefs.show_next_fixed_payment_amount then
    show.next_fixed_payment_amount = cme_futures_streamline_sbe_v5_8.prefs.show_next_fixed_payment_amount
    changed = true
  end
  if show.next_floating_payment_amount ~= cme_futures_streamline_sbe_v5_8.prefs.show_next_floating_payment_amount then
    show.next_floating_payment_amount = cme_futures_streamline_sbe_v5_8.prefs.show_next_floating_payment_amount
    changed = true
  end
  if show.npv ~= cme_futures_streamline_sbe_v5_8.prefs.show_npv then
    show.npv = cme_futures_streamline_sbe_v5_8.prefs.show_npv
    changed = true
  end
  if show.p_v_01 ~= cme_futures_streamline_sbe_v5_8.prefs.show_p_v_01 then
    show.p_v_01 = cme_futures_streamline_sbe_v5_8.prefs.show_p_v_01
    changed = true
  end
  if show.packet ~= cme_futures_streamline_sbe_v5_8.prefs.show_packet then
    show.packet = cme_futures_streamline_sbe_v5_8.prefs.show_packet
    changed = true
  end
  if show.percent_trading ~= cme_futures_streamline_sbe_v5_8.prefs.show_percent_trading then
    show.percent_trading = cme_futures_streamline_sbe_v5_8.prefs.show_percent_trading
    changed = true
  end
  if show.previous_eris_pai ~= cme_futures_streamline_sbe_v5_8.prefs.show_previous_eris_pai then
    show.previous_eris_pai = cme_futures_streamline_sbe_v5_8.prefs.show_previous_eris_pai
    changed = true
  end
  if show.previous_fixing_rate ~= cme_futures_streamline_sbe_v5_8.prefs.show_previous_fixing_rate then
    show.previous_fixing_rate = cme_futures_streamline_sbe_v5_8.prefs.show_previous_fixing_rate
    changed = true
  end
  if show.quote_request_345 ~= cme_futures_streamline_sbe_v5_8.prefs.show_quote_request_345 then
    show.quote_request_345 = cme_futures_streamline_sbe_v5_8.prefs.show_quote_request_345
    changed = true
  end
  if show.related_sym_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_related_sym_group then
    show.related_sym_group = cme_futures_streamline_sbe_v5_8.prefs.show_related_sym_group
    changed = true
  end
  if show.related_sym_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_related_sym_groups then
    show.related_sym_groups = cme_futures_streamline_sbe_v5_8.prefs.show_related_sym_groups
    changed = true
  end
  if show.security_alt_id_group ~= cme_futures_streamline_sbe_v5_8.prefs.show_security_alt_id_group then
    show.security_alt_id_group = cme_futures_streamline_sbe_v5_8.prefs.show_security_alt_id_group
    changed = true
  end
  if show.security_alt_id_groups ~= cme_futures_streamline_sbe_v5_8.prefs.show_security_alt_id_groups then
    show.security_alt_id_groups = cme_futures_streamline_sbe_v5_8.prefs.show_security_alt_id_groups
    changed = true
  end
  if show.settl_price_type ~= cme_futures_streamline_sbe_v5_8.prefs.show_settl_price_type then
    show.settl_price_type = cme_futures_streamline_sbe_v5_8.prefs.show_settl_price_type
    changed = true
  end
  if show.settlement_npv ~= cme_futures_streamline_sbe_v5_8.prefs.show_settlement_npv then
    show.settlement_npv = cme_futures_streamline_sbe_v5_8.prefs.show_settlement_npv
    changed = true
  end
  if show.yield ~= cme_futures_streamline_sbe_v5_8.prefs.show_yield then
    show.yield = cme_futures_streamline_sbe_v5_8.prefs.show_yield
    changed = true
  end
  if show.payload ~= cme_futures_streamline_sbe_v5_8.prefs.show_payload then
    show.payload = cme_futures_streamline_sbe_v5_8.prefs.show_payload
    changed = true
  end
...
-----------------------------------------------------------------------
-- Dissect Cme Futures Streamline Sbe 5.8
-----------------------------------------------------------------------
...
dissect.exponent = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.exponent, range, value, display)
...
dissect.mantissa64 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.mantissa64, range, value, display)
...
dissect.interpolation_factor = function(buffer, offset, packet, parent)
  ...
  if show.interpolation_factor then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.interpolation_factor, range, display)
  end
...
dissect.leg_date_offset = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.leg_date_offset, range, value, display)
...
dissect.leg_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.leg_side, range, value, display)
...
dissect.leg_ratio_qty = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.leg_ratio_qty, range, value, display)
...
dissect.previous_fixing_rate = function(buffer, offset, packet, parent)
  ...
  if show.previous_fixing_rate then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.previous_fixing_rate, range, display)
  end
...
dissect.previous_fixing_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.previous_fixing_date, range, value, display)
...
dissect.m_d_instrument_definition_eris_leg_group = function(buffer, offset, packet, parent)
  ...
  if show.m_d_instrument_definition_eris_leg_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_instrument_definition_eris_leg_group, range, display)
  end
...
dissect.num_in_group_uint_8 = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.num_in_group_uint_8, range, value, display)
...
dissect.block_length = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.block_length, range, value, display)
...
dissect.group_size = function(buffer, offset, packet, parent)
  ...
  if show.group_size then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.group_size, range, display)
  end
...
dissect.m_d_instrument_definition_eris_leg_groups = function(buffer, offset, packet, parent)
  ...
  if show.m_d_instrument_definition_eris_leg_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_instrument_definition_eris_leg_groups, range, display)
  end
...
dissect.security_alt_id_group = function(buffer, offset, packet, parent)
  ...
  if show.security_alt_id_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.security_alt_id_group, range, display)
  end
...
dissect.security_alt_id_groups = function(buffer, offset, packet, parent)
  ...
  if show.security_alt_id_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.security_alt_id_groups, range, display)
  end

  return dissect.security_alt_id_groups_fields(buffer, offset, packet, parent)
end

-- Size: Event Time u Int 64
size_of.event_time_u_int_64 = 8

-- Display: Event Time u Int 64
display.event_time_u_int_64 = function(value)
  return "Event Time u Int 64: "..value
end

-- Dissect: Event Time u Int 64
dissect.event_time_u_int_64 = function(buffer, offset, packet, parent)
  local length = size_of.event_time_u_int_64
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = display.event_time_u_int_64(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.event_time_u_int_64, range, value, display)

  return offset + length, value
end

-- Size: Event Type Event Type Indices
size_of.event_type_event_type_indices = 1

-- Display: Event Type Event Type Indices
display.event_type_event_type_indices = function(value)
  if value == 5 then
    return "Event Type Event Type Indices: Activation (5)"
  end
  if value == 6 then
    return "Event Type Event Type Indices: Deletion (6)"
  end
  if value == 120 then
    return "Event Type Event Type Indices: Modification (120)"
  end

  return "Event Type Event Type Indices: Unknown("..value..")"
end

-- Dissect: Event Type Event Type Indices
dissect.event_type_event_type_indices = function(buffer, offset, packet, parent)
  local length = size_of.event_type_event_type_indices
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.event_type_event_type_indices(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.event_type_event_type_indices, range, value, display)
...
size_of.events_group = function(buffer, offset)
  ...
  index = index + size_of.event_type_event_type_indices

  index = index + size_of.event_time_u_int_64
...
dissect.events_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Event Type Event Type Indices: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
  index, event_type_event_type_indices = dissect.event_type_event_type_indices(buffer, index, packet, parent)

  -- Event Time u Int 64: 8 Byte Unsigned Fixed Width Integer
  index, event_time_u_int_64 = dissect.event_time_u_int_64(buffer, index, packet, parent)
...
dissect.events_group = function(buffer, offset, packet, parent)
  ...
  if show.events_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.events_group, range, display)
  end

  return dissect.events_group_fields(buffer, offset, packet, parent)
end

-- Size: Num In Group uint 16
size_of.num_in_group_uint_16 = 2

-- Display: Num In Group uint 16
display.num_in_group_uint_16 = function(value)
  return "Num In Group uint 16: "..value
end

-- Dissect: Num In Group uint 16
dissect.num_in_group_uint_16 = function(buffer, offset, packet, parent)
  local length = size_of.num_in_group_uint_16
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.num_in_group_uint_16(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.num_in_group_uint_16, range, value, display)
...
size_of.group_size_encoding = function(buffer, offset)
  ...
  index = index + size_of.num_in_group_uint_16
...
dissect.group_size_encoding_fields = function(buffer, offset, packet, parent)
  ...
  -- Num In Group uint 16: 2 Byte Unsigned Fixed Width Integer
  index, num_in_group_uint_16 = dissect.num_in_group_uint_16(buffer, index, packet, parent)
...
dissect.group_size_encoding = function(buffer, offset, packet, parent)
  ...
  if show.group_size_encoding then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.group_size_encoding, range, display)
  end
...
dissect.events_groups_fields = function(buffer, offset, packet, parent)
  ...
  -- Dependency element: Num In Group uint 16
  local num_in_group_uint_16 = buffer(index - 2, 2):le_uint()

  -- Events Group: Struct of 2 fields
  for i = 1, num_in_group_uint_16 do
...
dissect.events_groups = function(buffer, offset, packet, parent)
  ...
  if show.events_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.events_groups, range, display)
  end
...
dissect.market_depth = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.market_depth, range, value, display)

  return offset + length, value
end

-- Size: Md Feed Type String Len 3
size_of.md_feed_type_string_len_3 = 3

-- Display: Md Feed Type String Len 3
display.md_feed_type_string_len_3 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Md Feed Type String Len 3: No Value"
  end

  return "Md Feed Type String Len 3: "..value
end

-- Dissect: Md Feed Type String Len 3
dissect.md_feed_type_string_len_3 = function(buffer, offset, packet, parent)
  local length = size_of.md_feed_type_string_len_3
  local range = buffer(offset, length)
  ...
  local display = display.md_feed_type_string_len_3(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_feed_type_string_len_3, range, value, display)
...
size_of.m_d_feed_types_group = function(buffer, offset)
  ...
  index = index + size_of.md_feed_type_string_len_3
...
dissect.m_d_feed_types_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Md Feed Type String Len 3: 3 Byte Ascii String Nullable
  index, md_feed_type_string_len_3 = dissect.md_feed_type_string_len_3(buffer, index, packet, parent)
...
dissect.m_d_feed_types_group = function(buffer, offset, packet, parent)
  ...
  if show.m_d_feed_types_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_feed_types_group, range, display)
  end
...
dissect.m_d_feed_types_groups = function(buffer, offset, packet, parent)
  ...
  if show.m_d_feed_types_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_feed_types_groups, range, display)
  end
...
dissect.appl_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.appl_id, range, value, display)
...
-- Size: Coupon Rate Decimal 32
size_of.coupon_rate_decimal_32 = 4

-- Display: Coupon Rate Decimal 32
display.coupon_rate_decimal_32 = function(value)
  -- Check if field has value
  if value == 2147483647 then
    return "Coupon Rate Decimal 32: No Value"
  end
  return "Coupon Rate Decimal 32: "..value/10000
end

-- Dissect: Coupon Rate Decimal 32
dissect.coupon_rate_decimal_32 = function(buffer, offset, packet, parent)
  local length = size_of.coupon_rate_decimal_32
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.coupon_rate_decimal_32(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.coupon_rate_decimal_32, range, value, display)
...
dissect.maturity_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.maturity_date, range, value, display)

  return offset + length, value
end

-- Size: Security Exchange Security Exchange
size_of.security_exchange_security_exchange = 4

-- Display: Security Exchange Security Exchange
display.security_exchange_security_exchange = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Security Exchange Security Exchange: No Value"
  end

  return "Security Exchange Security Exchange: "..value
end

-- Dissect: Security Exchange Security Exchange
dissect.security_exchange_security_exchange = function(buffer, offset, packet, parent)
  local length = size_of.security_exchange_security_exchange
  local range = buffer(offset, length)
  ...
  local display = display.security_exchange_security_exchange(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.security_exchange_security_exchange, range, value, display)

  return offset + length, value
end

-- Size: Product u Int 8 Null
size_of.product_u_int_8_null = 1

-- Display: Product u Int 8 Null
display.product_u_int_8_null = function(value)
  -- Check if field has value
  if value == 255 then
    return "Product u Int 8 Null: No Value"
  end

  return "Product u Int 8 Null: "..value
end

-- Dissect: Product u Int 8 Null
dissect.product_u_int_8_null = function(buffer, offset, packet, parent)
  local length = size_of.product_u_int_8_null
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.product_u_int_8_null(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.product_u_int_8_null, range, value, display)

  return offset + length, value
end

-- Size: Security Type String 4
size_of.security_type_string_4 = 4

-- Display: Security Type String 4
display.security_type_string_4 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Security Type String 4: No Value"
  end

  return "Security Type String 4: "..value
end

-- Dissect: Security Type String 4
dissect.security_type_string_4 = function(buffer, offset, packet, parent)
  local length = size_of.security_type_string_4
  local range = buffer(offset, length)
  ...
  local display = display.security_type_string_4(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.security_type_string_4, range, value, display)
...
-- Size: Security Group String 12
size_of.security_group_string_12 = 12

-- Display: Security Group String 12
display.security_group_string_12 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Security Group String 12: No Value"
  end

  return "Security Group String 12: "..value
end

-- Dissect: Security Group String 12
dissect.security_group_string_12 = function(buffer, offset, packet, parent)
  local length = size_of.security_group_string_12
  local range = buffer(offset, length)
  ...
  local display = display.security_group_string_12(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.security_group_string_12, range, value, display)
...
size_of.md_instrument_definition_eris_363 = function(buffer, offset)
  ...
  index = index + size_of.security_group_string_12

  index = index + size_of.symbol

  index = index + size_of.security_type_string_4

  index = index + size_of.product_u_int_8_null

  index = index + size_of.security_exchange_security_exchange

  index = index + size_of.maturity_date

  index = index + size_of.currency

  index = index + size_of.min_price_increment_decimal_64

  index = index + size_of.security_update_action

  index = index + size_of.rate_type

  index = index + size_of.coupon_rate_decimal_32
...
dissect.md_instrument_definition_eris_363_fields = function(buffer, offset, packet, parent)
  ...
  -- Security Group String 12: 12 Byte Ascii String Nullable
  index, security_group_string_12 = dissect.security_group_string_12(buffer, index, packet, parent)

  -- Symbol: 50 Byte Ascii String Nullable
  index, symbol = dissect.symbol(buffer, index, packet, parent)

  -- Security Type String 4: 4 Byte Ascii String Nullable
  index, security_type_string_4 = dissect.security_type_string_4(buffer, index, packet, parent)

  -- Product u Int 8 Null: 1 Byte Unsigned Fixed Width Integer Nullable
  index, product_u_int_8_null = dissect.product_u_int_8_null(buffer, index, packet, parent)

  -- Security Exchange Security Exchange: 4 Byte Ascii String
  index, security_exchange_security_exchange = dissect.security_exchange_security_exchange(buffer, index, packet, parent)
  ...
  -- Min Price Increment Decimal 64
  index, min_price_increment_decimal_64 = dissect.min_price_increment_decimal_64(buffer, index, packet, parent)
  ...
  -- Coupon Rate Decimal 32: 4 Byte Signed Fixed Width Integer Nullable
  index, coupon_rate_decimal_32 = dissect.coupon_rate_decimal_32(buffer, index, packet, parent)
...
dissect.md_instrument_definition_eris_363 = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_eris_363 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_instrument_definition_eris_363, range, display)
  end

  return dissect.md_instrument_definition_eris_363_fields(buffer, offset, packet, parent)
end

-- Size: Reference I D String 100
size_of.reference_i_d_string_100 = 100

-- Display: Reference I D String 100
display.reference_i_d_string_100 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Reference I D String 100: No Value"
  end

  return "Reference I D String 100: "..value
end

-- Dissect: Reference I D String 100
dissect.reference_i_d_string_100 = function(buffer, offset, packet, parent)
  local length = size_of.reference_i_d_string_100
  local range = buffer(offset, length)
  ...
  local display = display.reference_i_d_string_100(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.reference_i_d_string_100, range, value, display)
...
dissect.vol_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.vol_type, range, value, display)
...
dissect.settl_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.settl_date, range, value, display)
...
dissect.price_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.price_type, range, value, display)

  return offset + length, value
end

-- Size: Open Close Settl Flag u Int 8 Null
size_of.open_close_settl_flag_u_int_8_null = 1

-- Display: Open Close Settl Flag u Int 8 Null
display.open_close_settl_flag_u_int_8_null = function(value)
  -- Check if field has value
  if value == 255 then
    return "Open Close Settl Flag u Int 8 Null: No Value"
  end

  return "Open Close Settl Flag u Int 8 Null: "..value
end

-- Dissect: Open Close Settl Flag u Int 8 Null
dissect.open_close_settl_flag_u_int_8_null = function(buffer, offset, packet, parent)
  local length = size_of.open_close_settl_flag_u_int_8_null
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.open_close_settl_flag_u_int_8_null(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.open_close_settl_flag_u_int_8_null, range, value, display)
...
dissect.md_entry_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_date, range, value, display)

  return offset + length, value
end

-- Size: Unit Of Measure Currency Currency
size_of.unit_of_measure_currency_currency = 3

-- Display: Unit Of Measure Currency Currency
display.unit_of_measure_currency_currency = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Unit Of Measure Currency Currency: No Value"
  end

  return "Unit Of Measure Currency Currency: "..value
end

-- Dissect: Unit Of Measure Currency Currency
dissect.unit_of_measure_currency_currency = function(buffer, offset, packet, parent)
  local length = size_of.unit_of_measure_currency_currency
  local range = buffer(offset, length)
  ...
  local display = display.unit_of_measure_currency_currency(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.unit_of_measure_currency_currency, range, value, display)
...
dissect.put_or_call = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.put_or_call, range, value, display)
...
dissect.notional_percentage_outstanding = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.notional_percentage_outstanding, range, value, display)
...
dissect.week = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.week, range, value, display)
...
dissect.day = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.day, range, value, display)
...
dissect.month = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.month, range, value, display)
...
dissect.year = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.year, range, value, display)
...
dissect.maturity_month_year = function(buffer, offset, packet, parent)
  ...
  if show.maturity_month_year then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.maturity_month_year, range, display)
  end

  return dissect.maturity_month_year_fields(buffer, offset, packet, parent)
end

-- Size: Security Type String Length 9
size_of.security_type_string_length_9 = 9

-- Display: Security Type String Length 9
display.security_type_string_length_9 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Security Type String Length 9: No Value"
  end

  return "Security Type String Length 9: "..value
end

-- Dissect: Security Type String Length 9
dissect.security_type_string_length_9 = function(buffer, offset, packet, parent)
  local length = size_of.security_type_string_length_9
  local range = buffer(offset, length)
  ...
  local display = display.security_type_string_length_9(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.security_type_string_length_9, range, value, display)

  return offset + length, value
end

-- Size: Md Entry Px Pricenull
size_of.md_entry_px_pricenull = 8

-- Display: Md Entry Px Pricenull
display.md_entry_px_pricenull = function(value)
  -- Check if field has value
  if value == 9223372036854775807 then
    return "Md Entry Px Pricenull: No Value"
  end
  return "Md Entry Px Pricenull: "..value:tonumber()/10000000
end

-- Dissect: Md Entry Px Pricenull
dissect.md_entry_px_pricenull = function(buffer, offset, packet, parent)
  local length = size_of.md_entry_px_pricenull
  local range = buffer(offset, length)
  local value = range:le_int64()
  local display = display.md_entry_px_pricenull(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_px_pricenull, range, value, display)
...
dissect.rpt_seq = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.rpt_seq, range, value, display)

  return offset + length, value
end

-- Size: Md Entry Type Char
size_of.md_entry_type_char = 1

-- Display: Md Entry Type Char
display.md_entry_type_char = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Md Entry Type Char: No Value"
  end

  return "Md Entry Type Char: "..value
end

-- Dissect: Md Entry Type Char
dissect.md_entry_type_char = function(buffer, offset, packet, parent)
  local length = size_of.md_entry_type_char
  local range = buffer(offset, length)
  ...
  local display = display.md_entry_type_char(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_type_char, range, value, display)
...
size_of.m_d_incremental_refresh_otc_group = function(buffer, offset)
  ...
  index = index + size_of.md_entry_type_char

  index = index + size_of.rpt_seq

  index = index + size_of.md_entry_px_pricenull

  index = index + size_of.md_entry_size_decimal_64

  index = index + size_of.symbol

  index = index + size_of.security_group_string_12

  index = index + size_of.security_type_string_length_9
  ...
  index = index + size_of.strike_price_decimal_64

  index = index + size_of.unit_of_measure

  index = index + size_of.unit_of_measure_currency_currency

  index = index + size_of.unit_of_measure_qty_decimal_64

  index = index + size_of.md_entry_date

  index = index + size_of.open_close_settl_flag_u_int_8_null
  ...
  index = index + size_of.reference_i_d_string_100
...
dissect.m_d_incremental_refresh_otc_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Md Entry Type Char: 1 Byte Ascii String
  index, md_entry_type_char = dissect.md_entry_type_char(buffer, index, packet, parent)

  -- Rpt Seq: 4 Byte Unsigned Fixed Width Integer
  index, rpt_seq = dissect.rpt_seq(buffer, index, packet, parent)

  -- Md Entry Px Pricenull: 8 Byte Signed Fixed Width Integer Nullable
  index, md_entry_px_pricenull = dissect.md_entry_px_pricenull(buffer, index, packet, parent)

  -- Md Entry Size Decimal 64
  index, md_entry_size_decimal_64 = dissect.md_entry_size_decimal_64(buffer, index, packet, parent)
  ...
  -- Security Type String Length 9: 9 Byte Ascii String Nullable
  index, security_type_string_length_9 = dissect.security_type_string_length_9(buffer, index, packet, parent)
  ...
  -- Strike Price Decimal 64
  index, strike_price_decimal_64 = dissect.strike_price_decimal_64(buffer, index, packet, parent)

  -- Unit Of Measure: 5 Byte Ascii String Nullable
  index, unit_of_measure = dissect.unit_of_measure(buffer, index, packet, parent)

  -- Unit Of Measure Currency Currency: 3 Byte Ascii String
  index, unit_of_measure_currency_currency = dissect.unit_of_measure_currency_currency(buffer, index, packet, parent)

  -- Unit Of Measure Qty Decimal 64
  index, unit_of_measure_qty_decimal_64 = dissect.unit_of_measure_qty_decimal_64(buffer, index, packet, parent)
  ...
  -- Open Close Settl Flag u Int 8 Null: 1 Byte Unsigned Fixed Width Integer Nullable
  index, open_close_settl_flag_u_int_8_null = dissect.open_close_settl_flag_u_int_8_null(buffer, index, packet, parent)
  ...
  -- Reference I D String 100: 100 Byte Ascii String Nullable
  index, reference_i_d_string_100 = dissect.reference_i_d_string_100(buffer, index, packet, parent)
...
dissect.m_d_incremental_refresh_otc_group = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_otc_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_otc_group, range, display)
  end
...
size_of.m_d_incremental_refresh_otc_groups = function(buffer, offset)
  ...
  index = index + m_d_incremental_refresh_otc_group_count * 311
...
dissect.m_d_incremental_refresh_otc_groups = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_otc_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_otc_groups, range, display)
  end

  return dissect.m_d_incremental_refresh_otc_groups_fields(buffer, offset, packet, parent)
end

-- Size: Batch Total Messages u Int 16 Null
size_of.batch_total_messages_u_int_16_null = 2

-- Display: Batch Total Messages u Int 16 Null
display.batch_total_messages_u_int_16_null = function(value)
  -- Check if field has value
  if value == 65535 then
    return "Batch Total Messages u Int 16 Null: No Value"
  end

  return "Batch Total Messages u Int 16 Null: "..value
end

-- Dissect: Batch Total Messages u Int 16 Null
dissect.batch_total_messages_u_int_16_null = function(buffer, offset, packet, parent)
  local length = size_of.batch_total_messages_u_int_16_null
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.batch_total_messages_u_int_16_null(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.batch_total_messages_u_int_16_null, range, value, display)
...
dissect.match_event_indicator_bits = function(buffer, offset, packet, parent)
  ...
  -- End Of Event: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.end_of_event, buffer(offset, 1))

  -- Reserved: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.reserved, buffer(offset, 1))

  -- Recovery Msg: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.recovery_msg, buffer(offset, 1))

  -- Last Implied Msg: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.last_implied_msg, buffer(offset, 1))

  -- Last Stats Msg: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.last_stats_msg, buffer(offset, 1))

  -- Last Quote Msg: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.last_quote_msg, buffer(offset, 1))

  -- Last Volume Msg: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.last_volume_msg, buffer(offset, 1))

  -- Last Trade Msg: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.last_trade_msg, buffer(offset, 1))
end
...
dissect.match_event_indicator = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_futures_streamline_sbe_v5_8.fields.match_event_indicator, range, display)
...
dissect.trade_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.trade_date, range, value, display)

  return offset + length, value
end

-- Size: Transact Time u Int 64
size_of.transact_time_u_int_64 = 8

-- Display: Transact Time u Int 64
display.transact_time_u_int_64 = function(value)
  return "Transact Time u Int 64: "..value
end

-- Dissect: Transact Time u Int 64
dissect.transact_time_u_int_64 = function(buffer, offset, packet, parent)
  local length = size_of.transact_time_u_int_64
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = display.transact_time_u_int_64(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.transact_time_u_int_64, range, value, display)
...
size_of.md_incremental_refresh_ot_c_356 = function(buffer, offset)
  ...
  index = index + size_of.transact_time_u_int_64

  index = index + size_of.trade_date

  index = index + size_of.match_event_indicator

  index = index + size_of.batch_total_messages_u_int_16_null
...
dissect.md_incremental_refresh_ot_c_356_fields = function(buffer, offset, packet, parent)
  ...
  -- Transact Time u Int 64: 8 Byte Unsigned Fixed Width Integer
  index, transact_time_u_int_64 = dissect.transact_time_u_int_64(buffer, index, packet, parent)
  ...
  -- Batch Total Messages u Int 16 Null: 2 Byte Unsigned Fixed Width Integer Nullable
  index, batch_total_messages_u_int_16_null = dissect.batch_total_messages_u_int_16_null(buffer, index, packet, parent)
...
dissect.md_incremental_refresh_ot_c_356 = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_ot_c_356 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_ot_c_356, range, display)
  end

  return dissect.md_incremental_refresh_ot_c_356_fields(buffer, offset, packet, parent)
end

-- Size: Reference I D String Length 50
size_of.reference_i_d_string_length_50 = 50

-- Display: Reference I D String Length 50
display.reference_i_d_string_length_50 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Reference I D String Length 50: No Value"
  end

  return "Reference I D String Length 50: "..value
end

-- Dissect: Reference I D String Length 50
dissect.reference_i_d_string_length_50 = function(buffer, offset, packet, parent)
  local length = size_of.reference_i_d_string_length_50
  local range = buffer(offset, length)
  ...
  local display = display.reference_i_d_string_length_50(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.reference_i_d_string_length_50, range, value, display)

  return offset + length, value
end

-- Size: Security Group String Length 26
size_of.security_group_string_length_26 = 26

-- Display: Security Group String Length 26
display.security_group_string_length_26 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Security Group String Length 26: No Value"
  end

  return "Security Group String Length 26: "..value
end

-- Dissect: Security Group String Length 26
dissect.security_group_string_length_26 = function(buffer, offset, packet, parent)
  local length = size_of.security_group_string_length_26
  local range = buffer(offset, length)
  ...
  local display = display.security_group_string_length_26(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.security_group_string_length_26, range, value, display)
...
dissect.aggressor_side = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.aggressor_side, range, value, display)
...
dissect.trade_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.trade_id, range, value, display)
...
dissect.number_of_orders = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.number_of_orders, range, value, display)
...
dissect.md_entry_position_no = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_position_no, range, value, display)

  return offset + length, value
end

-- Size: Md Entry Size u Int 64 Null
size_of.md_entry_size_u_int_64_null = 8
...
dissect.md_entry_size_u_int_64_null = function(buffer, offset, packet, parent)
  local length = size_of.md_entry_size_u_int_64_null
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = display.md_entry_size_u_int_64_null(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_size_u_int_64_null, range, value, display)
...
dissect.md_update_action_char = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_update_action_char, range, value, display)
...
size_of.m_d_incremental_refresh_eris_group = function(buffer, offset)
  ...
  index = index + size_of.md_entry_px_decimal_64

  index = index + size_of.md_entry_size_u_int_64_null

  index = index + size_of.cal_fut_px_decimal_64
  ...
  index = index + size_of.security_group_string_length_26
  ...
  index = index + size_of.reference_i_d_string_length_50
...
dissect.m_d_incremental_refresh_eris_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Md Entry Px Decimal 64
  index, md_entry_px_decimal_64 = dissect.md_entry_px_decimal_64(buffer, index, packet, parent)

  -- Md Entry Size u Int 64 Null: 8 Byte Unsigned Fixed Width Integer Nullable
  index, md_entry_size_u_int_64_null = dissect.md_entry_size_u_int_64_null(buffer, index, packet, parent)

  -- Cal Fut Px Decimal 64
  index, cal_fut_px_decimal_64 = dissect.cal_fut_px_decimal_64(buffer, index, packet, parent)
  ...
  -- Security Group String Length 26: 26 Byte Ascii String Nullable
  index, security_group_string_length_26 = dissect.security_group_string_length_26(buffer, index, packet, parent)
  ...
  -- Reference I D String Length 50: 50 Byte Ascii String Nullable
  index, reference_i_d_string_length_50 = dissect.reference_i_d_string_length_50(buffer, index, packet, parent)
...
dissect.m_d_incremental_refresh_eris_group = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_eris_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_group, range, display)
  end
...
dissect.m_d_incremental_refresh_eris_groups = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_eris_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_groups, range, display)
  end
...
dissect.md_incremental_refresh_eris_353 = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_eris_353 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_eris_353, range, display)
  end
...
dissect.md_incremental_refresh_eris_351 = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_eris_351 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_eris_351, range, display)
  end
...
dissect.strike_price_pricenull = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.strike_price_pricenull, range, value, display)
...
dissect.trd_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.trd_type, range, value, display)
...
dissect.unit_of_measure_qty_pricenull = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.unit_of_measure_qty_pricenull, range, value, display)

  return offset + length, value
end

-- Size: Unit Of Measure Currency String Len 3
size_of.unit_of_measure_currency_string_len_3 = 3

-- Display: Unit Of Measure Currency String Len 3
display.unit_of_measure_currency_string_len_3 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Unit Of Measure Currency String Len 3: No Value"
  end

  return "Unit Of Measure Currency String Len 3: "..value
end

-- Dissect: Unit Of Measure Currency String Len 3
dissect.unit_of_measure_currency_string_len_3 = function(buffer, offset, packet, parent)
  local length = size_of.unit_of_measure_currency_string_len_3
  local range = buffer(offset, length)
  ...
  local display = display.unit_of_measure_currency_string_len_3(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.unit_of_measure_currency_string_len_3, range, value, display)

  return offset + length, value
end

-- Size: Security Exchange String 4
size_of.security_exchange_string_4 = 4

-- Display: Security Exchange String 4
display.security_exchange_string_4 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Security Exchange String 4: No Value"
  end

  return "Security Exchange String 4: "..value
end

-- Dissect: Security Exchange String 4
dissect.security_exchange_string_4 = function(buffer, offset, packet, parent)
  local length = size_of.security_exchange_string_4
  local range = buffer(offset, length)
  ...
  local display = display.security_exchange_string_4(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.security_exchange_string_4, range, value, display)
...
dissect.security_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.security_id, range, value, display)

  return offset + length, value
end

-- Size: Md Update Action Md Update Action
size_of.md_update_action_md_update_action = 1

-- Display: Md Update Action Md Update Action
display.md_update_action_md_update_action = function(value)
  if value == 0 then
    return "Md Update Action Md Update Action: New (0)"
  end
  if value == 1 then
    return "Md Update Action Md Update Action: Change (1)"
  end
  if value == 2 then
    return "Md Update Action Md Update Action: Delete (2)"
  end
  if value == 3 then
    return "Md Update Action Md Update Action: Delete Thru (3)"
  end
  if value == 4 then
    return "Md Update Action Md Update Action: Delete From (4)"
  end
  if value == 5 then
    return "Md Update Action Md Update Action: Overlay (5)"
  end

  return "Md Update Action Md Update Action: Unknown("..value..")"
end

-- Dissect: Md Update Action Md Update Action
dissect.md_update_action_md_update_action = function(buffer, offset, packet, parent)
  local length = size_of.md_update_action_md_update_action
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.md_update_action_md_update_action(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_update_action_md_update_action, range, value, display)
...
size_of.m_d_incremental_refresh_trade_blocks_group = function(buffer, offset)
  ...
  index = index + size_of.md_update_action_md_update_action
  ...
  index = index + size_of.security_exchange_string_4

  index = index + size_of.maturity_date

  index = index + size_of.unit_of_measure

  index = index + size_of.unit_of_measure_currency_string_len_3
...
dissect.m_d_incremental_refresh_trade_blocks_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Md Update Action Md Update Action: 1 Byte Unsigned Fixed Width Integer Enum with 6 values
  index, md_update_action_md_update_action = dissect.md_update_action_md_update_action(buffer, index, packet, parent)
  ...
  -- Security Exchange String 4: 4 Byte Ascii String Nullable
  index, security_exchange_string_4 = dissect.security_exchange_string_4(buffer, index, packet, parent)
  ...
  -- Unit Of Measure Currency String Len 3: 3 Byte Ascii String Nullable
  index, unit_of_measure_currency_string_len_3 = dissect.unit_of_measure_currency_string_len_3(buffer, index, packet, parent)
...
dissect.m_d_incremental_refresh_trade_blocks_group = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_trade_blocks_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_trade_blocks_group, range, display)
  end
...
size_of.m_d_incremental_refresh_trade_blocks_groups = function(buffer, offset)
  ...
  index = index + m_d_incremental_refresh_trade_blocks_group_count * 327
...
dissect.m_d_incremental_refresh_trade_blocks_groups = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_trade_blocks_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_trade_blocks_groups, range, display)
  end

  return dissect.m_d_incremental_refresh_trade_blocks_groups_fields(buffer, offset, packet, parent)
end

-- Size: Batch Total Messages u Int 16
size_of.batch_total_messages_u_int_16 = 2

-- Display: Batch Total Messages u Int 16
display.batch_total_messages_u_int_16 = function(value)
  return "Batch Total Messages u Int 16: "..value
end

-- Dissect: Batch Total Messages u Int 16
dissect.batch_total_messages_u_int_16 = function(buffer, offset, packet, parent)
  local length = size_of.batch_total_messages_u_int_16
  local range = buffer(offset, length)
  local value = range:le_uint()
  local display = display.batch_total_messages_u_int_16(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.batch_total_messages_u_int_16, range, value, display)

  return offset + length, value
end

-- Size: Transact Time u Int 64 Null
size_of.transact_time_u_int_64_null = 8

-- Display: Transact Time u Int 64 Null
display.transact_time_u_int_64_null = function(value)
  -- Check if field has value
  if value == UInt64(0xFFFFFFFF, 0xFFFFFFF) then
    return "Transact Time u Int 64 Null: No Value"
  end

  return "Transact Time u Int 64 Null: "..value
end

-- Dissect: Transact Time u Int 64 Null
dissect.transact_time_u_int_64_null = function(buffer, offset, packet, parent)
  local length = size_of.transact_time_u_int_64_null
  local range = buffer(offset, length)
  local value = range:le_uint64()
  local display = display.transact_time_u_int_64_null(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.transact_time_u_int_64_null, range, value, display)
...
size_of.md_incremental_refresh_trade_blocks_349 = function(buffer, offset)
  ...
  index = index + size_of.transact_time_u_int_64_null

  index = index + size_of.match_event_indicator

  index = index + size_of.batch_total_messages_u_int_16
...
dissect.md_incremental_refresh_trade_blocks_349_fields = function(buffer, offset, packet, parent)
  ...
  -- Transact Time u Int 64 Null: 8 Byte Unsigned Fixed Width Integer Nullable
  index, transact_time_u_int_64_null = dissect.transact_time_u_int_64_null(buffer, index, packet, parent)

  -- Match Event Indicator: Struct of 8 fields
  index, match_event_indicator = dissect.match_event_indicator(buffer, index, packet, parent)

  -- Batch Total Messages u Int 16: 2 Byte Unsigned Fixed Width Integer
  index, batch_total_messages_u_int_16 = dissect.batch_total_messages_u_int_16(buffer, index, packet, parent)
...
dissect.md_incremental_refresh_trade_blocks_349 = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_blocks_349 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_349, range, display)
  end
...
dissect.md_entry_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_time, range, value, display)
...
dissect.md_entry_code = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_code, range, value, display)
...
dissect.percent_trading = function(buffer, offset, packet, parent)
  ...
  if show.percent_trading then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.percent_trading, range, display)
  end
...
dissect.net_pct_chg = function(buffer, offset, packet, parent)
  ...
  if show.net_pct_chg then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.net_pct_chg, range, display)
  end
...
dissect.net_chg_prev_day = function(buffer, offset, packet, parent)
  ...
  if show.net_chg_prev_day then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.net_chg_prev_day, range, display)
  end
...
dissect.yield = function(buffer, offset, packet, parent)
  ...
  if show.yield then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.yield, range, display)
  end
...
-- Size: Open Close Settl Flag Int 8 Null
size_of.open_close_settl_flag_int_8_null = 1

-- Display: Open Close Settl Flag Int 8 Null
display.open_close_settl_flag_int_8_null = function(value)
  -- Check if field has value
  if value == 127 then
    return "Open Close Settl Flag Int 8 Null: No Value"
  end

  return "Open Close Settl Flag Int 8 Null: "..value
end

-- Dissect: Open Close Settl Flag Int 8 Null
dissect.open_close_settl_flag_int_8_null = function(buffer, offset, packet, parent)
  local length = size_of.open_close_settl_flag_int_8_null
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.open_close_settl_flag_int_8_null(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.open_close_settl_flag_int_8_null, range, value, display)

  return offset + length, value
end

-- Size: Md Entry Type Md Entry Type Indices
size_of.md_entry_type_md_entry_type_indices = 1

-- Display: Md Entry Type Md Entry Type Indices
display.md_entry_type_md_entry_type_indices = function(value)
  if value == "0" then
    return "Md Entry Type Md Entry Type Indices: Bid (0)"
  end
  if value == "1" then
    return "Md Entry Type Md Entry Type Indices: Offer (1)"
  end
  if value == "2" then
    return "Md Entry Type Md Entry Type Indices: Trade (2)"
  end
  if value == "3" then
    return "Md Entry Type Md Entry Type Indices: Index Value (3)"
  end
  if value == "4" then
    return "Md Entry Type Md Entry Type Indices: Opening Value (4)"
  end
  if value == "5" then
    return "Md Entry Type Md Entry Type Indices: Closing Price (5)"
  end
  if value == "6" then
    return "Md Entry Type Md Entry Type Indices: Settlement Price (6)"
  end
  if value == "7" then
    return "Md Entry Type Md Entry Type Indices: Session High Price (7)"
  end
  if value == "8" then
    return "Md Entry Type Md Entry Type Indices: Session Low Price (8)"
  end
  if value == "e" then
    return "Md Entry Type Md Entry Type Indices: Trade Volume (e)"
  end

  return "Md Entry Type Md Entry Type Indices: Unknown("..value..")"
end

-- Dissect: Md Entry Type Md Entry Type Indices
dissect.md_entry_type_md_entry_type_indices = function(buffer, offset, packet, parent)
  local length = size_of.md_entry_type_md_entry_type_indices
  local range = buffer(offset, length)
  local value = range:string()
  local display = display.md_entry_type_md_entry_type_indices(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_entry_type_md_entry_type_indices, range, value, display)
...
size_of.m_d_incremental_refresh_indices_group = function(buffer, offset)
  ...
  index = index + size_of.md_entry_type_md_entry_type_indices
  ...
  index = index + size_of.open_close_settl_flag_int_8_null
...
dissect.m_d_incremental_refresh_indices_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Md Entry Type Md Entry Type Indices: 1 Byte Ascii String Enum with 10 values
  index, md_entry_type_md_entry_type_indices = dissect.md_entry_type_md_entry_type_indices(buffer, index, packet, parent)
  ...
  -- Open Close Settl Flag Int 8 Null: 1 Byte Signed Fixed Width Integer Nullable
  index, open_close_settl_flag_int_8_null = dissect.open_close_settl_flag_int_8_null(buffer, index, packet, parent)
...
dissect.m_d_incremental_refresh_indices_group = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_indices_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_indices_group, range, display)
  end
...
size_of.m_d_incremental_refresh_indices_groups = function(buffer, offset)
  ...
  index = index + m_d_incremental_refresh_indices_group_count * 167
...
dissect.m_d_incremental_refresh_indices_groups = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_indices_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_indices_groups, range, display)
  end

  return dissect.m_d_incremental_refresh_indices_groups_fields(buffer, offset, packet, parent)
end

-- Size: Md Feed Type String Length 2
size_of.md_feed_type_string_length_2 = 2

-- Display: Md Feed Type String Length 2
display.md_feed_type_string_length_2 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Md Feed Type String Length 2: No Value"
  end

  return "Md Feed Type String Length 2: "..value
end

-- Dissect: Md Feed Type String Length 2
dissect.md_feed_type_string_length_2 = function(buffer, offset, packet, parent)
  local length = size_of.md_feed_type_string_length_2
  local range = buffer(offset, length)
  ...
  local display = display.md_feed_type_string_length_2(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.md_feed_type_string_length_2, range, value, display)
...
size_of.md_incremental_refresh_indices_348 = function(buffer, offset)
  ...
  index = index + size_of.md_feed_type_string_length_2
...
dissect.md_incremental_refresh_indices_348_fields = function(buffer, offset, packet, parent)
  ...
  -- Md Feed Type String Length 2: 2 Byte Ascii String Nullable
  index, md_feed_type_string_length_2 = dissect.md_feed_type_string_length_2(buffer, index, packet, parent)
...
dissect.md_incremental_refresh_indices_348 = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_indices_348 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_indices_348, range, display)
  end
...
dissect.inst_attrib_type = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.inst_attrib_type, range, value, display)
...
dissect.inst_attrib_group = function(buffer, offset, packet, parent)
  ...
  if show.inst_attrib_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.inst_attrib_group, range, display)
  end
...
dissect.inst_attrib_groups = function(buffer, offset, packet, parent)
  ...
  if show.inst_attrib_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.inst_attrib_groups, range, display)
  end
...
-- Size: Product Int 8
size_of.product_int_8 = 1

-- Display: Product Int 8
display.product_int_8 = function(value)
  return "Product Int 8: "..value
end

-- Dissect: Product Int 8
dissect.product_int_8 = function(buffer, offset, packet, parent)
  local length = size_of.product_int_8
  local range = buffer(offset, length)
  local value = range:le_int()
  local display = display.product_int_8(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.product_int_8, range, value, display)
...
size_of.md_instrument_definition_indices_347 = function(buffer, offset)
  ...
  index = index + size_of.product_int_8
...
dissect.md_instrument_definition_indices_347_fields = function(buffer, offset, packet, parent)
  ...
  -- Product Int 8: 1 Byte Signed Fixed Width Integer
  index, product_int_8 = dissect.product_int_8(buffer, index, packet, parent)
...
dissect.md_instrument_definition_indices_347 = function(buffer, offset, packet, parent)
  ...
  if show.md_instrument_definition_indices_347 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_instrument_definition_indices_347, range, display)
  end
...
dissect.related_sym_group = function(buffer, offset, packet, parent)
  ...
  if show.related_sym_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.related_sym_group, range, display)
  end
...
dissect.related_sym_groups = function(buffer, offset, packet, parent)
  ...
  if show.related_sym_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.related_sym_groups, range, display)
  end
...
dissect.quote_request_345 = function(buffer, offset, packet, parent)
  ...
  if show.quote_request_345 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.quote_request_345, range, display)
  end
...
dissect.md_incremental_refresh_trade_blocks_340 = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_trade_blocks_340 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_trade_blocks_340, range, display)
  end

  return dissect.md_incremental_refresh_trade_blocks_340_fields(buffer, offset, packet, parent)
end

-- Size: Text String Length 500
size_of.text_string_length_500 = 500

-- Display: Text String Length 500
display.text_string_length_500 = function(value)
  -- Check if field has value
  if value == nil or value == '' then
    return "Text String Length 500: No Value"
  end

  return "Text String Length 500: "..value
end

-- Dissect: Text String Length 500
dissect.text_string_length_500 = function(buffer, offset, packet, parent)
  local length = size_of.text_string_length_500
  local range = buffer(offset, length)
  ...
  local display = display.text_string_length_500(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.text_string_length_500, range, value, display)
...
size_of.lines_of_text_group = function(buffer, offset)
  ...
  index = index + size_of.text_string_length_500
...
dissect.lines_of_text_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Text String Length 500: 500 Byte Ascii String
  index, text_string_length_500 = dissect.text_string_length_500(buffer, index, packet, parent)
...
dissect.lines_of_text_group = function(buffer, offset, packet, parent)
  ...
  if show.lines_of_text_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.lines_of_text_group, range, display)
  end
...
dissect.lines_of_text_groups = function(buffer, offset, packet, parent)
  ...
  if show.lines_of_text_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.lines_of_text_groups, range, display)
  end
...
dissect.orig_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.orig_time, range, value, display)
...
dissect.md_news_indices_339 = function(buffer, offset, packet, parent)
  ...
  if show.md_news_indices_339 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_news_indices_339, range, display)
  end
...
dissect.final_settlement_futures_price = function(buffer, offset, packet, parent)
  ...
  if show.final_settlement_futures_price then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.final_settlement_futures_price, range, display)
  end
...
dissect.settlement_npv = function(buffer, offset, packet, parent)
  ...
  if show.settlement_npv then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.settlement_npv, range, display)
  end
...
dissect.d_v_01 = function(buffer, offset, packet, parent)
  ...
  if show.d_v_01 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.d_v_01, range, display)
  end
...
dissect.p_v_01 = function(buffer, offset, packet, parent)
  ...
  if show.p_v_01 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.p_v_01, range, display)
  end
...
dissect.next_floating_payment_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.next_floating_payment_date, range, value, display)
...
dissect.leg_contract_multiplier = function(buffer, offset, packet, parent)
  ...
  if show.leg_contract_multiplier then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.leg_contract_multiplier, range, display)
  end
...
dissect.nominal = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.nominal, range, value, display)
...
dissect.accrual_days = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.accrual_days, range, value, display)
...
dissect.fed_funds_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.fed_funds_date, range, value, display)
...
dissect.previous_eris_pai = function(buffer, offset, packet, parent)
  ...
  if show.previous_eris_pai then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.previous_eris_pai, range, display)
  end
...
dissect.trading_reference_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.trading_reference_date, range, value, display)
...
dissect.next_floating_payment_amount = function(buffer, offset, packet, parent)
  ...
  if show.next_floating_payment_amount then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.next_floating_payment_amount, range, display)
  end
...
dissect.next_fixed_payment_amount = function(buffer, offset, packet, parent)
  ...
  if show.next_fixed_payment_amount then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.next_fixed_payment_amount, range, display)
  end
...
dissect.next_fixed_payment_date = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.next_fixed_payment_date, range, value, display)
...
dissect.floating_payment = function(buffer, offset, packet, parent)
  ...
  if show.floating_payment then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.floating_payment, range, display)
  end
...
dissect.fixed_payment = function(buffer, offset, packet, parent)
  ...
  if show.fixed_payment then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.fixed_payment, range, display)
  end
...
dissect.fed_funds_rate = function(buffer, offset, packet, parent)
  ...
  if show.fed_funds_rate then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.fed_funds_rate, range, display)
  end
...
dissect.eris_pai = function(buffer, offset, packet, parent)
  ...
  if show.eris_pai then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.eris_pai, range, display)
  end
...
dissect.daily_incremental_eris_pai = function(buffer, offset, packet, parent)
  ...
  if show.daily_incremental_eris_pai then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.daily_incremental_eris_pai, range, display)
  end
...
dissect.accrued_coupons = function(buffer, offset, packet, parent)
  ...
  if show.accrued_coupons then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.accrued_coupons, range, display)
  end
...
dissect.npv = function(buffer, offset, packet, parent)
  ...
  if show.npv then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.npv, range, display)
  end
...
dissect.float_npv = function(buffer, offset, packet, parent)
  ...
  if show.float_npv then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.float_npv, range, display)
  end
...
dissect.fixed_npv = function(buffer, offset, packet, parent)
  ...
  if show.fixed_npv then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.fixed_npv, range, display)
  end
...
dissect.leg_purchase_rate = function(buffer, offset, packet, parent)
  ...
  if show.leg_purchase_rate then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.leg_purchase_rate, range, display)
  end
...
dissect.fair_coupon_pct = function(buffer, offset, packet, parent)
  ...
  if show.fair_coupon_pct then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.fair_coupon_pct, range, display)
  end
...
dissect.settl_price_type_bits = function(buffer, offset, packet, parent)
  ...
  -- Null Value: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.null_value, buffer(offset, 1))

  -- Reserved Bits: 4 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.reserved_bits, buffer(offset, 1))

  -- Rounded: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.rounded, buffer(offset, 1))

  -- Actual: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.actual, buffer(offset, 1))

  -- Final: 1 Bit
  parent:add(cme_futures_streamline_sbe_v5_8.fields.final, buffer(offset, 1))
end
...
dissect.settl_price_type = function(buffer, offset, packet, parent)
  ...
  local element = parent:add(cme_futures_streamline_sbe_v5_8.fields.settl_price_type, range, display)
...
size_of.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group = function(buffer, offset)
  ...
  index = index + size_of.md_entry_px_decimal_64_null

  index = index + size_of.open_close_settl_flag_u_int_8_null

  index = index + size_of.settl_price_type

  index = index + size_of.cal_fut_px_decimal_64_null
  ...
  index = index + size_of.coupon_rate_decimal_32_null
  ...
  index = index + size_of.min_price_increment_decimal_64_null
...
dissect.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group_fields = function(buffer, offset, packet, parent)
  ...
  -- Md Entry Px Decimal 64 Null
  index, md_entry_px_decimal_64_null = dissect.md_entry_px_decimal_64_null(buffer, index, packet, parent)
  ...
  -- Cal Fut Px Decimal 64 Null
  index, cal_fut_px_decimal_64_null = dissect.cal_fut_px_decimal_64_null(buffer, index, packet, parent)
  ...
  -- Coupon Rate Decimal 32 Null
  index, coupon_rate_decimal_32_null = dissect.coupon_rate_decimal_32_null(buffer, index, packet, parent)
  ...
  -- Min Price Increment Decimal 64 Null
  index, min_price_increment_decimal_64_null = dissect.min_price_increment_decimal_64_null(buffer, index, packet, parent)
...
dissect.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group, range, display)
  end
...
size_of.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups = function(buffer, offset)
  ...
  index = index + m_d_incremental_refresh_eris_reference_data_and_daily_statistics_group_count * 387
...
dissect.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups = function(buffer, offset, packet, parent)
  ...
  if show.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.m_d_incremental_refresh_eris_reference_data_and_daily_statistics_groups, range, display)
  end
...
dissect.md_incremental_refresh_eris_reference_data_and_daily_statistics_333 = function(buffer, offset, packet, parent)
  ...
  if show.md_incremental_refresh_eris_reference_data_and_daily_statistics_333 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.md_incremental_refresh_eris_reference_data_and_daily_statistics_333, range, display)
  end
...
-- Size: Text Text
size_of.text_text = 180

-- Display: Text Text
display.text_text = function(value)
  -- Check if field has value
  if value == nil or value == '' then
...
-- Dissect: Text Text
dissect.text_text = function(buffer, offset, packet, parent)
  local length = size_of.text_text
  local range = buffer(offset, length)
  ...
  local display = display.text_text(value, buffer, offset, packet, parent)

  parent:add(cme_futures_streamline_sbe_v5_8.fields.text_text, range, value, display)
...
dissect.admin_logout_316_fields = function(buffer, offset, packet, parent)
  ...
  -- Text Text: 180 Byte Ascii String
  index, text_text = dissect.text_text(buffer, index, packet, parent)
...
dissect.admin_logout_316 = function(buffer, offset, packet, parent)
  ...
  if show.admin_logout_316 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.admin_logout_316, range, display)
  end
...
dissect.heart_bt_int = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.heart_bt_int, range, value, display)
...
dissect.admin_login_315 = function(buffer, offset, packet, parent)
  ...
  if show.admin_login_315 then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.admin_login_315, range, display)
  end
...
dissect.payload = function(buffer, offset, packet, parent, template_id)
  ...
  local element = parent:add(cme_futures_streamline_sbe_v5_8.fields.payload, range, display)
...
dissect.version = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.version, range, value, display)
...
dissect.schema_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.schema_id, range, value, display)
...
dissect.template_id = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.template_id, range, value, display)
...
dissect.message_header = function(buffer, offset, packet, parent)
  ...
  if show.message_header then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.message_header, range, display)
  end
...
dissect.message_size = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.message_size, range, value, display)
...
dissect.message = function(buffer, offset, packet, parent)
  ...
  if show.message then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.message, range, display)
  end
...
dissect.sending_time = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.sending_time, range, value, display)
...
dissect.message_sequence_number = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_streamline_sbe_v5_8.fields.message_sequence_number, range, value, display)
...
dissect.binary_packet_header = function(buffer, offset, packet, parent)
  ...
  if show.binary_packet_header then
    ...
    parent = parent:add(cme_futures_streamline_sbe_v5_8.fields.binary_packet_header, range, display)
  end
...
function cme_futures_streamline_sbe_v5_8.init()
end

-- Dissector for Cme Futures Streamline Sbe 5.8
function cme_futures_streamline_sbe_v5_8.dissector(buffer, packet, parent)

  -- Set protocol name
  packet.cols.protocol = cme_futures_streamline_sbe_v5_8.name

  -- Dissect protocol
  local protocol = parent:add(cme_futures_streamline_sbe_v5_8, buffer(), cme_futures_streamline_sbe_v5_8.description, "("..buffer:len().." Bytes)")
  local protocol_size = dissect.packet(buffer, packet, protocol)
end

-- Register With Udp Table
local udp_table = DissectorTable.get("udp.port")
udp_table:add(65333, cme_futures_streamline_sbe_v5_8)
...
verify.cme_futures_streamline_sbe_v5_8_packet_size = function(buffer)
...
-- Dissector Heuristic for Cme Futures Streamline Sbe 5.8
local function cme_futures_streamline_sbe_v5_8_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not verify.cme_futures_streamline_sbe_v5_8_packet_size(buffer) then return false end
  ...
  packet.conversation = cme_futures_streamline_sbe_v5_8
  cme_futures_streamline_sbe_v5_8.dissector(buffer, packet, parent)

  return true
end

-- Register Heuristic for Cme Futures Streamline Sbe 5.8
cme_futures_streamline_sbe_v5_8:register_heuristic("udp", cme_futures_streamline_sbe_v5_8_heuristic)
