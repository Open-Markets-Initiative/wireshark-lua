...
cme_futures_ilink3_sbe_v8_3.fields.leg_option_delta = ProtoField.new("Leg Option Delta", "cme.futures.ilink3.sbe.v8.3.legoptiondelta", ftypes.INT32)
cme_futures_ilink3_sbe_v8_3.fields.leg_price = ProtoField.new("Leg Price", "cme.futures.ilink3.sbe.v8.3.legprice", ftypes.INT64)
...
dissect.leg_option_delta = function(buffer, offset, packet, parent)
  ...
  parent:add(cme_futures_ilink3_sbe_v8_3.fields.leg_option_delta, range, value, display)
