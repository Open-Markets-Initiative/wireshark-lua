...
otc_markets_multicast_ats_v4_5.payload.size = function(buffer, offset, message_type)
  ...
  if message_type == 11 then
    return otc_markets_multicast_ats_v4_5.start_of_spin_message.size
  end
  -- Size of End Of Spin Message
  if message_type == 12 then
    return otc_markets_multicast_ats_v4_5.end_of_spin_message.size
  end
  -- Size of Market Open Message
  if message_type == 13 then
    return otc_markets_multicast_ats_v4_5.market_open_message.size
  end
  -- Size of Market Close Message
  if message_type == 14 then
    return otc_markets_multicast_ats_v4_5.market_close_message.size
  end
  -- Size of Security Message
  if message_type == 9 then
    return otc_markets_multicast_ats_v4_5.security_message.size
  end
  -- Size of Quote Message
  if message_type == 1 then
    return otc_markets_multicast_ats_v4_5.quote_message.size
  end
  -- Size of Quote Update Message
  if message_type == 2 then
    return otc_markets_multicast_ats_v4_5.quote_update_message.size
  end
  -- Size of Market Open Message
  ...
  if message_type == 4 then
    return otc_markets_multicast_ats_v4_5.inside_update_message.size
  end
  -- Size of Reference Price Message
  if message_type == 7 then
    return otc_markets_multicast_ats_v4_5.reference_price_message.size
  end
  -- Size of Reference Price Update Message
  if message_type == 8 then
    return otc_markets_multicast_ats_v4_5.reference_price_update_message.size
  end
  ...
  if message_type == 17 then
    return otc_markets_multicast_ats_v4_5.trade_message.size
  end
