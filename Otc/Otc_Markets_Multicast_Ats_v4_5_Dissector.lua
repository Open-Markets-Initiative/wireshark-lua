...
omi_otc_markets_multicast_ats_v4_5.fields.ask_bid_wanted = ProtoField.new("Ask Bid Wanted", "otc.markets.multicast.ats.v4.5.askbidwanted", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_otc_markets_multicast_ats_v4_5.fields.ask_priced = ProtoField.new("Ask Priced", "otc.markets.multicast.ats.v4.5.askpriced", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_otc_markets_multicast_ats_v4_5.fields.ask_unsolicited = ProtoField.new("Ask Unsolicited", "otc.markets.multicast.ats.v4.5.askunsolicited", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_otc_markets_multicast_ats_v4_5.fields.bb_quoted = ProtoField.new("Bb Quoted", "otc.markets.multicast.ats.v4.5.bbquoted", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
omi_otc_markets_multicast_ats_v4_5.fields.bid_ask_wanted = ProtoField.new("Bid Ask Wanted", "otc.markets.multicast.ats.v4.5.bidaskwanted", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_otc_markets_multicast_ats_v4_5.fields.bid_auto_ex = ProtoField.new("Bid Auto Ex", "otc.markets.multicast.ats.v4.5.bidautoex", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_5.fields.bid_priced = ProtoField.new("Bid Priced", "otc.markets.multicast.ats.v4.5.bidpriced", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_otc_markets_multicast_ats_v4_5.fields.bid_unsolicited = ProtoField.new("Bid Unsolicited", "otc.markets.multicast.ats.v4.5.bidunsolicited", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_otc_markets_multicast_ats_v4_5.fields.callable = ProtoField.new("Callable", "otc.markets.multicast.ats.v4.5.callable", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0400)
...
omi_otc_markets_multicast_ats_v4_5.fields.caveat_emptor_warning = ProtoField.new("Caveat Emptor Warning", "otc.markets.multicast.ats.v4.5.caveatemptorwarning", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_5.fields.heartbeat = ProtoField.new("Heartbeat", "otc.markets.multicast.ats.v4.5.heartbeat", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_otc_markets_multicast_ats_v4_5.fields.investment_grade = ProtoField.new("Investment Grade", "otc.markets.multicast.ats.v4.5.investmentgrade", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0100)
omi_otc_markets_multicast_ats_v4_5.fields.irregular = ProtoField.new("Irregular", "otc.markets.multicast.ats.v4.5.irregular", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_otc_markets_multicast_ats_v4_5.fields.nms_conditional_quote = ProtoField.new("Nms Conditional Quote", "otc.markets.multicast.ats.v4.5.nmsconditionalquote", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_otc_markets_multicast_ats_v4_5.fields.offer_auto_ex = ProtoField.new("Offer Auto Ex", "otc.markets.multicast.ats.v4.5.offerautoex", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_otc_markets_multicast_ats_v4_5.fields.otc_link_ecn_eligible = ProtoField.new("Otc Link Ecn Eligible", "otc.markets.multicast.ats.v4.5.otclinkecneligible", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_otc_markets_multicast_ats_v4_5.fields.otc_link_messaging_disabled = ProtoField.new("Otc Link Messaging Disabled", "otc.markets.multicast.ats.v4.5.otclinkmessagingdisabled", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_otc_markets_multicast_ats_v4_5.fields.piggyback = ProtoField.new("Piggyback", "otc.markets.multicast.ats.v4.5.piggyback", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0001)
...
omi_otc_markets_multicast_ats_v4_5.fields.proprietary_quote_eligible = ProtoField.new("Proprietary Quote Eligible", "otc.markets.multicast.ats.v4.5.proprietaryquoteeligible", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_otc_markets_multicast_ats_v4_5.fields.qap = ProtoField.new("Qap", "otc.markets.multicast.ats.v4.5.qap", ftypes.INT8)
omi_otc_markets_multicast_ats_v4_5.fields.qualified_institutional_buyers_only = ProtoField.new("Qualified Institutional Buyers Only", "otc.markets.multicast.ats.v4.5.qualifiedinstitutionalbuyersonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_otc_markets_multicast_ats_v4_5.fields.quote_saturated = ProtoField.new("Quote Saturated", "otc.markets.multicast.ats.v4.5.quotesaturated", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_otc_markets_multicast_ats_v4_5.fields.replay = ProtoField.new("Replay", "otc.markets.multicast.ats.v4.5.replay", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_otc_markets_multicast_ats_v4_5.fields.saturation_eligible = ProtoField.new("Saturation Eligible", "otc.markets.multicast.ats.v4.5.saturationeligible", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_otc_markets_multicast_ats_v4_5.fields.seq_num_reset = ProtoField.new("Seq Num Reset", "otc.markets.multicast.ats.v4.5.seqnumreset", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_5.fields.sponsored_status = ProtoField.new("Sponsored Status", "otc.markets.multicast.ats.v4.5.sponsoredstatus", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0010)
omi_otc_markets_multicast_ats_v4_5.fields.state = ProtoField.new("State", "otc.markets.multicast.ats.v4.5.state", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_5.fields.test = ProtoField.new("Test", "otc.markets.multicast.ats.v4.5.test", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_otc_markets_multicast_ats_v4_5.fields.trading_flat = ProtoField.new("Trading Flat", "otc.markets.multicast.ats.v4.5.tradingflat", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0200)
omi_otc_markets_multicast_ats_v4_5.fields.unsolicited_only = ProtoField.new("Unsolicited Only", "otc.markets.multicast.ats.v4.5.unsolicitedonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_otc_markets_multicast_ats_v4_5.fields.update_side = ProtoField.new("Update Side", "otc.markets.multicast.ats.v4.5.updateside", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_otc_markets_multicast_ats_v4_5.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")
...
function omi_otc_markets_multicast_ats_v4_5.prefs_changed()
  ...
  if show.message_index ~= omi_otc_markets_multicast_ats_v4_5.prefs.show_message_index then
    show.message_index = omi_otc_markets_multicast_ats_v4_5.prefs.show_message_index
  end
end
...
otc_markets_multicast_ats_v4_5.issuer_name.dissect = function(buffer, offset, packet, parent, size)
  ...
  local value = range:string()
  local display = otc_markets_multicast_ats_v4_5.issuer_name.display(value, packet, parent, size)
...
otc_markets_multicast_ats_v4_5.issuer.dissect = function(buffer, offset, packet, parent)
  if show.issuer then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_otc_markets_multicast_ats_v4_5.fields.issuer, buffer(offset, 0))
    local index = otc_markets_multicast_ats_v4_5.issuer.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = otc_markets_multicast_ats_v4_5.issuer.display(packet, parent, length)
    parent:append_text(display)
...
otc_markets_multicast_ats_v4_5.security_detail.dissect = function(buffer, offset, packet, parent)
  if show.security_detail then
    -- Optionally add element to protocol tree
    parent = parent:add(omi_otc_markets_multicast_ats_v4_5.fields.security_detail, buffer(offset, 0))
    local index = otc_markets_multicast_ats_v4_5.security_detail.fields(buffer, offset, packet, parent)
    local length = index - offset
    parent:set_len(length)
    local display = otc_markets_multicast_ats_v4_5.security_detail.display(packet, parent, length)
    parent:append_text(display)
...
otc_markets_multicast_ats_v4_5.extended_security_no_cusip_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = otc_markets_multicast_ats_v4_5.extended_security_no_cusip_message.display(packet, parent, length)
    parent:append_text(display)
...
otc_markets_multicast_ats_v4_5.extended_security_message.dissect = function(buffer, offset, packet, parent)
  if show.application_messages then
    ...
    local length = index - offset
    parent:set_len(length)
    local display = otc_markets_multicast_ats_v4_5.extended_security_message.display(packet, parent, length)
    parent:append_text(display)
...
otc_markets_multicast_ats_v4_5.packet.requiredsize = function(buffer)
  return buffer:len() >= otc_markets_multicast_ats_v4_5.packet_header.size
end
...
otc_markets_multicast_ats_v4_5.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = otc_markets_multicast_ats_v4_5.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
...
-- Dissector Heuristic for Otc Markets Multicast Ats 4.5 (Udp)
local function omi_otc_markets_multicast_ats_v4_5_udp_heuristic(buffer, packet, parent)
...
omi_otc_markets_multicast_ats_v4_5:register_heuristic("udp", omi_otc_markets_multicast_ats_v4_5_udp_heuristic)

-- Register Otc Markets Multicast Ats 4.5 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_otc_markets_multicast_ats_v4_5)
