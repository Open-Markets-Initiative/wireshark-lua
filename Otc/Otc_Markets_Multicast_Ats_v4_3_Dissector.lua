...
local omi_otc_markets_multicast_ats_v4_3 = Proto("Omi.Otc.Markets.Multicast.Ats.v4.3", "Otc Markets Multicast Ats 4.3")
...
omi_otc_markets_multicast_ats_v4_3.fields.ask_bid_wanted = ProtoField.new("Ask Bid Wanted", "otc.markets.multicast.ats.v4.3.askbidwanted", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
...
omi_otc_markets_multicast_ats_v4_3.fields.ask_priced = ProtoField.new("Ask Priced", "otc.markets.multicast.ats.v4.3.askpriced", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_otc_markets_multicast_ats_v4_3.fields.ask_unsolicited = ProtoField.new("Ask Unsolicited", "otc.markets.multicast.ats.v4.3.askunsolicited", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_otc_markets_multicast_ats_v4_3.fields.bb_quoted = ProtoField.new("Bb Quoted", "otc.markets.multicast.ats.v4.3.bbquoted", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x10)
omi_otc_markets_multicast_ats_v4_3.fields.bid_ask_wanted = ProtoField.new("Bid Ask Wanted", "otc.markets.multicast.ats.v4.3.bidaskwanted", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
omi_otc_markets_multicast_ats_v4_3.fields.bid_auto_ex = ProtoField.new("Bid Auto Ex", "otc.markets.multicast.ats.v4.3.bidautoex", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_3.fields.bid_priced = ProtoField.new("Bid Priced", "otc.markets.multicast.ats.v4.3.bidpriced", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_otc_markets_multicast_ats_v4_3.fields.bid_unsolicited = ProtoField.new("Bid Unsolicited", "otc.markets.multicast.ats.v4.3.bidunsolicited", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_otc_markets_multicast_ats_v4_3.fields.callable = ProtoField.new("Callable", "otc.markets.multicast.ats.v4.3.callable", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0400)
...
omi_otc_markets_multicast_ats_v4_3.fields.caveat_emptor_warning = ProtoField.new("Caveat Emptor Warning", "otc.markets.multicast.ats.v4.3.caveatemptorwarning", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_3.fields.heartbeat = ProtoField.new("Heartbeat", "otc.markets.multicast.ats.v4.3.heartbeat", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_otc_markets_multicast_ats_v4_3.fields.investment_grade = ProtoField.new("Investment Grade", "otc.markets.multicast.ats.v4.3.investmentgrade", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0100)
omi_otc_markets_multicast_ats_v4_3.fields.irregular = ProtoField.new("Irregular", "otc.markets.multicast.ats.v4.3.irregular", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
omi_otc_markets_multicast_ats_v4_3.fields.issuer = ProtoField.new("Issuer", "otc.markets.multicast.ats.v4.3.issuer", ftypes.STRING)
...
omi_otc_markets_multicast_ats_v4_3.fields.nms_conditional_quote = ProtoField.new("Nms Conditional Quote", "otc.markets.multicast.ats.v4.3.nmsconditionalquote", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
...
omi_otc_markets_multicast_ats_v4_3.fields.offer_auto_ex = ProtoField.new("Offer Auto Ex", "otc.markets.multicast.ats.v4.3.offerautoex", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_otc_markets_multicast_ats_v4_3.fields.otc_link_ecn_eligible = ProtoField.new("Otc Link Ecn Eligible", "otc.markets.multicast.ats.v4.3.otclinkecneligible", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x20)
omi_otc_markets_multicast_ats_v4_3.fields.otc_link_messaging_disabled = ProtoField.new("Otc Link Messaging Disabled", "otc.markets.multicast.ats.v4.3.otclinkmessagingdisabled", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_otc_markets_multicast_ats_v4_3.fields.qualified_institutional_buyers_only = ProtoField.new("Qualified Institutional Buyers Only", "otc.markets.multicast.ats.v4.3.qualifiedinstitutionalbuyersonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x04)
...
omi_otc_markets_multicast_ats_v4_3.fields.quote_saturated = ProtoField.new("Quote Saturated", "otc.markets.multicast.ats.v4.3.quotesaturated", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)
...
omi_otc_markets_multicast_ats_v4_3.fields.replay = ProtoField.new("Replay", "otc.markets.multicast.ats.v4.3.replay", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x40)
...
omi_otc_markets_multicast_ats_v4_3.fields.saturation_eligible = ProtoField.new("Saturation Eligible", "otc.markets.multicast.ats.v4.3.saturationeligible", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_otc_markets_multicast_ats_v4_3.fields.security_detail_name = ProtoField.new("Security Detail Name", "otc.markets.multicast.ats.v4.3.securitydetailname", ftypes.STRING)
...
omi_otc_markets_multicast_ats_v4_3.fields.seq_num_reset = ProtoField.new("Seq Num Reset", "otc.markets.multicast.ats.v4.3.seqnumreset", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_3.fields.sponsored_status = ProtoField.new("Sponsored Status", "otc.markets.multicast.ats.v4.3.sponsoredstatus", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0010)
omi_otc_markets_multicast_ats_v4_3.fields.state = ProtoField.new("State", "otc.markets.multicast.ats.v4.3.state", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x02)
...
omi_otc_markets_multicast_ats_v4_3.fields.test = ProtoField.new("Test", "otc.markets.multicast.ats.v4.3.test", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x80)
...
omi_otc_markets_multicast_ats_v4_3.fields.trading_flat = ProtoField.new("Trading Flat", "otc.markets.multicast.ats.v4.3.tradingflat", ftypes.UINT16, {[0]="No", [1]="Yes"}, base.DEC, 0x0200)
omi_otc_markets_multicast_ats_v4_3.fields.unsolicited_only = ProtoField.new("Unsolicited Only", "otc.markets.multicast.ats.v4.3.unsolicitedonly", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x08)
omi_otc_markets_multicast_ats_v4_3.fields.update_side = ProtoField.new("Update Side", "otc.markets.multicast.ats.v4.3.updateside", ftypes.UINT8, {[0]="No", [1]="Yes"}, base.DEC, 0x01)

-- Otc Markets Ats Multicast 4.3 Application Messages
...
omi_otc_markets_multicast_ats_v4_3.prefs.show_issuer = Pref.bool("Show Issuer", show.issuer, "Parse and add Issuer to protocol tree")
...
otc_markets_multicast_ats_v4_3.issuer.size = function(buffer, offset)
  local index = 0
...
-- Display: Issuer
otc_markets_multicast_ats_v4_3.issuer.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Issuer
otc_markets_multicast_ats_v4_3.issuer.fields = function(buffer, offset, packet, parent)
  local index = offset
...
otc_markets_multicast_ats_v4_3.security_detail.size = function(buffer, offset)
  local index = 0
...
otc_markets_multicast_ats_v4_3.security_detail.display = function(packet, parent, length)
  return ""
end

-- Dissect Fields: Security Detail
otc_markets_multicast_ats_v4_3.security_detail.fields = function(buffer, offset, packet, parent)
  local index = offset
  ...
  if security_detail_name_exists then
    ...
    index, security_detail_name = otc_markets_multicast_ats_v4_3.security_detail_name.dissect(buffer, index, packet, parent, security_detail_size)
  end
...
otc_markets_multicast_ats_v4_3.extended_security_no_cusip_message.size = function(buffer, offset)
  ...
  index = index + otc_markets_multicast_ats_v4_3.security_detail.size(buffer, offset + index)

  index = index + otc_markets_multicast_ats_v4_3.issuer.size(buffer, offset + index)
...
otc_markets_multicast_ats_v4_3.extended_security_no_cusip_message.fields = function(buffer, offset, packet, parent)
  ...
  index, security_detail = otc_markets_multicast_ats_v4_3.security_detail.dissect(buffer, index, packet, parent)

  -- Issuer: Struct of 2 fields
  index, issuer = otc_markets_multicast_ats_v4_3.issuer.dissect(buffer, index, packet, parent)
...
otc_markets_multicast_ats_v4_3.packet.requiredsize = function(buffer)
  return buffer:len() >= otc_markets_multicast_ats_v4_3.packet_header.size
end
...
otc_markets_multicast_ats_v4_3.packet.dissect = function(buffer, packet, parent)
  ...
  while index < end_of_payload do
    ...
    index, message = otc_markets_multicast_ats_v4_3.message.dissect(buffer, index, packet, parent, message_size, message_index)
  end
...
-- Register Otc Markets Multicast Ats 4.3 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_otc_markets_multicast_ats_v4_3)
