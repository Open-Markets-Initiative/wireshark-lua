...
otc_markets_multicast_ats_v4_3.trade_status.display = function(buffer, packet, parent)
  local display = ""
...
otc_markets_multicast_ats_v4_3.trade_status.bits = function(buffer, offset, packet, parent)
...
otc_markets_multicast_ats_v4_3.trade_status.dissect = function(buffer, offset, packet, parent)
  ...
  local display = otc_markets_multicast_ats_v4_3.trade_status.display(range, packet, parent)
  local element = parent:add(omi_otc_markets_multicast_ats_v4_3.fields.trade_status, range, display)

  if show.trade_status then
    otc_markets_multicast_ats_v4_3.trade_status.bits(buffer, offset, packet, element)
  end
...
otc_markets_multicast_ats_v4_3.trade_message.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.channel_seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.trade_id.size

  index = index + otc_markets_multicast_ats_v4_3.trade_action.size

  index = index + otc_markets_multicast_ats_v4_3.trade_flags.size

  index = index + otc_markets_multicast_ats_v4_3.security_id.size

  index = index + otc_markets_multicast_ats_v4_3.trade_status.size

  index = index + otc_markets_multicast_ats_v4_3.deprecated.size

  index = index + otc_markets_multicast_ats_v4_3.trade_price.size

  index = index + otc_markets_multicast_ats_v4_3.trade_size.size

  index = index + otc_markets_multicast_ats_v4_3.trade_time_milli.size
...
otc_markets_multicast_ats_v4_3.security_flags.display = function(buffer, packet, parent)
  local display = ""
...
otc_markets_multicast_ats_v4_3.security_flags.bits = function(buffer, offset, packet, parent)
...
otc_markets_multicast_ats_v4_3.security_flags.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = otc_markets_multicast_ats_v4_3.security_flags.display(range, packet, parent)
  ...
  if show.security_flags then
    otc_markets_multicast_ats_v4_3.security_flags.bits(buffer, offset, packet, element)
  end
...
otc_markets_multicast_ats_v4_3.extended_security_flags.display = function(buffer, packet, parent)
  local display = ""
...
otc_markets_multicast_ats_v4_3.extended_security_flags.bits = function(buffer, offset, packet, parent)
...
otc_markets_multicast_ats_v4_3.extended_security_flags.dissect = function(buffer, offset, packet, parent)
  local size = 2
  local range = buffer(offset, size)
  local display = otc_markets_multicast_ats_v4_3.extended_security_flags.display(range, packet, parent)
  ...
  if show.extended_security_flags then
    otc_markets_multicast_ats_v4_3.extended_security_flags.bits(buffer, offset, packet, element)
  end
...
-- Display: Quote Flags
otc_markets_multicast_ats_v4_3.quote_flags.display = function(buffer, packet, parent)
  local display = ""
...
otc_markets_multicast_ats_v4_3.quote_flags.bits = function(buffer, offset, packet, parent)
...
otc_markets_multicast_ats_v4_3.quote_flags.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = otc_markets_multicast_ats_v4_3.quote_flags.display(range, packet, parent)
  local element = parent:add(omi_otc_markets_multicast_ats_v4_3.fields.quote_flags, range, display)

  if show.quote_flags then
    otc_markets_multicast_ats_v4_3.quote_flags.bits(buffer, offset, packet, element)
  end
...
otc_markets_multicast_ats_v4_3.reference_price_update_message.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.channel_seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.reference_price_id.size

  index = index + otc_markets_multicast_ats_v4_3.quote_flags.size

  index = index + otc_markets_multicast_ats_v4_3.price.size

  index = index + otc_markets_multicast_ats_v4_3.size.size

  index = index + otc_markets_multicast_ats_v4_3.time_milli.size
...
otc_markets_multicast_ats_v4_3.reference_price_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + otc_markets_multicast_ats_v4_3.reference_price_action.size

  index = index + otc_markets_multicast_ats_v4_3.quote_flags.size

  index = index + otc_markets_multicast_ats_v4_3.security_id.size

  index = index + otc_markets_multicast_ats_v4_3.ask_price.size

  index = index + otc_markets_multicast_ats_v4_3.ask_size.size

  index = index + otc_markets_multicast_ats_v4_3.ask_time_milli.size

  index = index + otc_markets_multicast_ats_v4_3.bid_price.size

  index = index + otc_markets_multicast_ats_v4_3.bid_size.size

  index = index + otc_markets_multicast_ats_v4_3.bid_time_milli.size
...
otc_markets_multicast_ats_v4_3.inside_update_message.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.channel_seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.inside_id.size
  ...
  index = index + otc_markets_multicast_ats_v4_3.inside_time_milli.size

  index = index + otc_markets_multicast_ats_v4_3.num_priced_mp.size
...
otc_markets_multicast_ats_v4_3.market_open_message.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.channel_seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.market_open.size

  index = index + otc_markets_multicast_ats_v4_3.market_close.size
...
otc_markets_multicast_ats_v4_3.extended_quote_flags.display = function(buffer, packet, parent)
  local display = ""
...
otc_markets_multicast_ats_v4_3.extended_quote_flags.bits = function(buffer, offset, packet, parent)
...
otc_markets_multicast_ats_v4_3.extended_quote_flags.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = otc_markets_multicast_ats_v4_3.extended_quote_flags.display(range, packet, parent)
  ...
  if show.extended_quote_flags then
    otc_markets_multicast_ats_v4_3.extended_quote_flags.bits(buffer, offset, packet, element)
  end
...
otc_markets_multicast_ats_v4_3.quote_update_message.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.channel_seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.quote_id.size
  ...
  index = index + otc_markets_multicast_ats_v4_3.qap.size

  index = index + otc_markets_multicast_ats_v4_3.quote_time_milli.size

  index = index + otc_markets_multicast_ats_v4_3.quote_reference_id.size

  index = index + otc_markets_multicast_ats_v4_3.extended_quote_flags.size
...
otc_markets_multicast_ats_v4_3.quote_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + otc_markets_multicast_ats_v4_3.quote_action.size

  index = index + otc_markets_multicast_ats_v4_3.quote_flags.size

  index = index + otc_markets_multicast_ats_v4_3.security_id.size

  index = index + otc_markets_multicast_ats_v4_3.mpid.size

  index = index + otc_markets_multicast_ats_v4_3.ask_price.size

  index = index + otc_markets_multicast_ats_v4_3.ask_size.size

  index = index + otc_markets_multicast_ats_v4_3.ask_qap.size
  ...
  index = index + otc_markets_multicast_ats_v4_3.bid_qap.size
...
otc_markets_multicast_ats_v4_3.security_message.size = function(buffer, offset)
  local index = 0
...
otc_markets_multicast_ats_v4_3.market_close_message.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.channel_seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.market_close_time_milli.size

  index = index + otc_markets_multicast_ats_v4_3.market_msg_ct.size
...
otc_markets_multicast_ats_v4_3.end_of_spin_message.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.channel_seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.spin_type.size

  index = index + otc_markets_multicast_ats_v4_3.spin_msg_ct.size

  index = index + otc_markets_multicast_ats_v4_3.spin_end_time_milli.size

  index = index + otc_markets_multicast_ats_v4_3.spin_last_seq_num.size
...
otc_markets_multicast_ats_v4_3.start_of_spin_message.size = function(buffer, offset)
  local index = 0
  ...
  index = index + otc_markets_multicast_ats_v4_3.spin_start_time_milli.size
...
otc_markets_multicast_ats_v4_3.payload.size = function(buffer, offset, message_type)
  ...
  if message_type == 11 then
    return otc_markets_multicast_ats_v4_3.start_of_spin_message.size(buffer, offset)
  end
  -- Size of End Of Spin Message
  if message_type == 12 then
    return otc_markets_multicast_ats_v4_3.end_of_spin_message.size(buffer, offset)
  end
  -- Size of Market Open Message
  if message_type == 13 then
    return otc_markets_multicast_ats_v4_3.market_open_message.size(buffer, offset)
  end
  -- Size of Market Close Message
  if message_type == 14 then
    return otc_markets_multicast_ats_v4_3.market_close_message.size(buffer, offset)
  end
  -- Size of Security Message
  if message_type == 9 then
    return otc_markets_multicast_ats_v4_3.security_message.size(buffer, offset)
  end
  -- Size of Quote Message
  if message_type == 1 then
    return otc_markets_multicast_ats_v4_3.quote_message.size(buffer, offset)
  end
  -- Size of Quote Update Message
  if message_type == 2 then
    return otc_markets_multicast_ats_v4_3.quote_update_message.size(buffer, offset)
  end
  -- Size of Market Open Message
  ...
  if message_type == 4 then
    return otc_markets_multicast_ats_v4_3.inside_update_message.size(buffer, offset)
  end
  -- Size of Reference Price Message
  if message_type == 7 then
    return otc_markets_multicast_ats_v4_3.reference_price_message.size(buffer, offset)
  end
  -- Size of Reference Price Update Message
  if message_type == 8 then
    return otc_markets_multicast_ats_v4_3.reference_price_update_message.size(buffer, offset)
  end
  ...
  if message_type == 17 then
    return otc_markets_multicast_ats_v4_3.trade_message.size(buffer, offset)
  end
...
otc_markets_multicast_ats_v4_3.message_header.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.message_size.size

  index = index + otc_markets_multicast_ats_v4_3.message_type.size
...
-- Display: Packet Flag
otc_markets_multicast_ats_v4_3.packet_flag.display = function(buffer, packet, parent)
  local display = ""
...
otc_markets_multicast_ats_v4_3.packet_flag.bits = function(buffer, offset, packet, parent)
...
otc_markets_multicast_ats_v4_3.packet_flag.dissect = function(buffer, offset, packet, parent)
  local size = 1
  local range = buffer(offset, size)
  local display = otc_markets_multicast_ats_v4_3.packet_flag.display(range, packet, parent)
  local element = parent:add(omi_otc_markets_multicast_ats_v4_3.fields.packet_flag, range, display)

  if show.packet_flag then
    otc_markets_multicast_ats_v4_3.packet_flag.bits(buffer, offset, packet, element)
  end
...
otc_markets_multicast_ats_v4_3.packet_header.size = function(buffer, offset)
  local index = 0

  index = index + otc_markets_multicast_ats_v4_3.packet_size.size

  index = index + otc_markets_multicast_ats_v4_3.seq_num.size

  index = index + otc_markets_multicast_ats_v4_3.packet_flag.size

  index = index + otc_markets_multicast_ats_v4_3.messages.size

  index = index + otc_markets_multicast_ats_v4_3.packet_milli.size
