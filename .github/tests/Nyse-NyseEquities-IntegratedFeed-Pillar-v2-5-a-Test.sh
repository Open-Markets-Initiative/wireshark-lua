...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/AddOrderMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/AddOrderMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for AddOrderMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/CrossTradeMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/CrossTradeMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for CrossTradeMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/DeleteOrderMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/DeleteOrderMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for DeleteOrderMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/ImbalanceMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/ImbalanceMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for ImbalanceMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/OrderExecutionMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/OrderExecutionMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for OrderExecutionMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/ReplaceOrderMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/ReplaceOrderMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for ReplaceOrderMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/SecurityStatusMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/SecurityStatusMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for SecurityStatusMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/SourceTimeReferenceMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/SourceTimeReferenceMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for SourceTimeReferenceMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/StockSummaryMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nyse/IntegratedFeed.Pillar.v2.5/StockSummaryMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nyse.nyseequities.integratedfeed.pillar.v2.5.a.lua"; else echo "could not detect transport port for StockSummaryMessage"; exit 1; fi
