...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.AddOrderMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.CrossTradeMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.DeleteOrderMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.ImbalanceMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.OrderExecutionMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.ReplaceOrderMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.SecurityStatusMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.SourceTimeReferenceMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.NyseEquities.IntegratedFeed.Pillar.v2.5.a.StockSummaryMessage.json; echo
