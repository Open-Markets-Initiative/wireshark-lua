...
grep "nyse.equities.openbook.ultra.v2.1.b.symbolindex" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
grep "nyse.equities.openbook.ultra.v2.1.b.sourcetime" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
grep "nyse.equities.openbook.ultra.v2.1.b.sourcetimemicrosecs" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
grep "nyse.equities.openbook.ultra.v2.1.b.sourceseqnum" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
grep "nyse.equities.openbook.ultra.v2.1.b.sourcesessionid" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
grep "nyse.equities.openbook.ultra.v2.1.b.quotecondition" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
grep "nyse.equities.openbook.ultra.v2.1.b.tradingstatus" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
grep "nyse.equities.openbook.ultra.v2.1.b.pricescalecode" Nyse.Equities.OpenBook.Ultra.v2.1.b.DeltaUpdateMessage.json
tshark \
