...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeedRefresh.v2.5/AddOrderRefreshMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeedRefresh.v2.5/RefreshHeaderMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeedRefresh_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeedRefresh.v2.5/SecurityStatusMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeedRefresh_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeedRefresh.v2.5/SymbolIndexMappingMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeedRefresh_Pillar_v2_5_g_Dissector.lua" \
  -T json \
