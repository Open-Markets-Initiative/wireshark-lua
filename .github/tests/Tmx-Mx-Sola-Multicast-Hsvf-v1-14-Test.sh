...
runuser -u tester -- tshark \
  -r "omi-data-packets/Tmx/Mx.Sola.Multicast.v1.14/OptionMarketDepthMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Tmx/Mx.Sola.Multicast.v1.14/OptionTradeMessage.pcap" \
  -X "lua_script:Tmx/Tmx_Mx_Sola_Multicast_Hsvf_v1_14_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Tmx/Mx.Sola.Multicast.v1.14/StrategyAuctionBeginningMessage.pcap" \
  -X "lua_script:Tmx/Tmx_Mx_Sola_Multicast_Hsvf_v1_14_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Tmx/Mx.Sola.Multicast.v1.14/StrategyMarketDepthMessage.pcap" \
  -X "lua_script:Tmx/Tmx_Mx_Sola_Multicast_Hsvf_v1_14_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Tmx/Mx.Sola.Multicast.v1.14/StrategyTradeMessage.pcap" \
  -X "lua_script:Tmx/Tmx_Mx_Sola_Multicast_Hsvf_v1_14_Dissector.lua" \
  -T json \
