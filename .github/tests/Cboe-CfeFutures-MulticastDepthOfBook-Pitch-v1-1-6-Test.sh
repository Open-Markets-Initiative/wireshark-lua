...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/CfeFutures.MulticastDepthOfBook.v1.1.6/AddOrderShortMessage.pcap" \
...
grep "cboe.cfefutures.multicastdepthofbook.pitch.v1.1.6.timeoffset" Cboe.CfeFutures.MulticastDepthOfBook.Pitch.v1.1.6.AddOrderShortMessage.json
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/CfeFutures.MulticastDepthOfBook.v1.1.6/Heartbeat.pcap" \
  -X "lua_script:Cboe/Cboe_CfeFutures_MulticastDepthOfBook_Pitch_v1_1_6_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/CfeFutures.MulticastDepthOfBook.v1.1.6/ModifyOrderShortMessage.pcap" \
  -X "lua_script:Cboe/Cboe_CfeFutures_MulticastDepthOfBook_Pitch_v1_1_6_Dissector.lua" \
  -T json \
...
grep "cboe.cfefutures.multicastdepthofbook.pitch.v1.1.6.timeoffset" Cboe.CfeFutures.MulticastDepthOfBook.Pitch.v1.1.6.ModifyOrderShortMessage.json
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/CfeFutures.MulticastDepthOfBook.v1.1.6/TimeMessage.pcap" \
  -X "lua_script:Cboe/Cboe_CfeFutures_MulticastDepthOfBook_Pitch_v1_1_6_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/CfeFutures.MulticastDepthOfBook.v1.1.6/TradingStatusMessage.pcap" \
  -X "lua_script:Cboe/Cboe_CfeFutures_MulticastDepthOfBook_Pitch_v1_1_6_Dissector.lua" \
  -T json \
...
grep "cboe.cfefutures.multicastdepthofbook.pitch.v1.1.6.timeoffset" Cboe.CfeFutures.MulticastDepthOfBook.Pitch.v1.1.6.TradingStatusMessage.json
