...
grep "cboe.cfefutures.multicastdepthofbook.pitch.v1.1.6.nanoseconds" Cboe.CfeFutures.MulticastDepthOfBook.Pitch.v1.1.6.AddOrderShortMessage.json
...
grep "cboe.cfefutures.multicastdepthofbook.pitch.v1.1.6.nanoseconds" Cboe.CfeFutures.MulticastDepthOfBook.Pitch.v1.1.6.ModifyOrderShortMessage.json
...
grep "cboe.cfefutures.multicastdepthofbook.pitch.v1.1.6.nanoseconds" Cboe.CfeFutures.MulticastDepthOfBook.Pitch.v1.1.6.TradingStatusMessage.json
