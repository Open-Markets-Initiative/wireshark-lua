...
runuser -u tester -- tshark \
  -r "omi-data-packets/Iex/IexEquities.Deep.v1.0/Heartbeat.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Iex/IexEquities.Deep.v1.0/PriceLevelBuyUpdateMessage.pcap" \
  -X "lua_script:Iex/Iex_IexEquities_Deep_IexTp_v1_06_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Iex/IexEquities.Deep.v1.0/PriceLevelSellUpdateMessage.pcap" \
  -X "lua_script:Iex/Iex_IexEquities_Deep_IexTp_v1_06_Dissector.lua" \
  -T json \
