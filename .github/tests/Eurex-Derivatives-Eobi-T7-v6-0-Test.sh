...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/ExecutionSummary.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/FullOrderExecution.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/Heartbeat.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/InstrumentSummary.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/OrderAdd.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/OrderModify.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/PartialOrderExecution.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/ProductSummary.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
...
port=$(runuser -u tester -- tshark -r "omi-data-packets/Eurex/Eobi.T7.v6.0/SnapshotOrder.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
