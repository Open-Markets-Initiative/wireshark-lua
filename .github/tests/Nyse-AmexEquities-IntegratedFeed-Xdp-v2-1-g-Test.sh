...
echo "json head:"
head -c 1500 Nyse.AmexEquities.IntegratedFeed.Xdp.v2.1.g.AddOrderMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.AmexEquities.IntegratedFeed.Xdp.v2.1.g.ImbalanceMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.AmexEquities.IntegratedFeed.Xdp.v2.1.g.OrderExecutionMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.AmexEquities.IntegratedFeed.Xdp.v2.1.g.ReplaceOrderMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.AmexEquities.IntegratedFeed.Xdp.v2.1.g.SecurityStatusMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.AmexEquities.IntegratedFeed.Xdp.v2.1.g.SourceTimeReferenceMessage.json; echo
...
echo "json head:"
head -c 1500 Nyse.AmexEquities.IntegratedFeed.Xdp.v2.1.g.SymbolIndexMappingMessage.json; echo
