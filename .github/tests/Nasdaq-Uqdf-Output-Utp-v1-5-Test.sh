...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/Uqdf.Output.v1.5/LimitUpLimitDownPriceBandMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/Uqdf.Output.v1.5/QuoteLongFormMessage.pcap" \
  -X "lua_script:Nasdaq/Nasdaq_Uqdf_Output_Utp_v1_5_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nasdaq/Uqdf.Output.v1.5/QuoteShortFormMessage.pcap" \
  -X "lua_script:Nasdaq/Nasdaq_Uqdf_Output_Utp_v1_5_Dissector.lua" \
  -T json \
