...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/AddOrderMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/DeleteOrderMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeed_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/ModifyOrderMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeed_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/NonDisplayedTradeMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeed_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/OrderExecutionMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeed_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/ReplaceOrderMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeed_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/SecurityStatusMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeed_Pillar_v2_5_g_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/TexasEquities.IntegratedFeed.v2.5/SourceTimeReferenceMessage.pcap" \
  -X "lua_script:Nyse/Nyse_TexasEquities_IntegratedFeed_Pillar_v2_5_g_Dissector.lua" \
  -T json \
