...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/ArcaEquities.Bbo.v2.3a/QuoteMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/ArcaEquities.Bbo.v2.3a/SequenceNumberResetMessage.pcap" \
  -X "lua_script:Nyse/Nyse_ArcaEquities_Bbo_Xdp_v2_4_c_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Nyse/ArcaEquities.Bbo.v2.3a/SymbolIndexMappingMessage.pcap" \
  -X "lua_script:Nyse/Nyse_ArcaEquities_Bbo_Xdp_v2_4_c_Dissector.lua" \
  -T json \
