...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cme/Globex.Mdp3.v1.12/MdIncrementalRefreshBookLongQty.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cme/Globex.Mdp3.v1.12/MdIncrementalRefreshTradeSummaryLongQty.pcap" \
  -X "lua_script:Cme/Cme_Globex_Mdp3_Sbe_v1_12_Dissector.lua" \
  -T json \
