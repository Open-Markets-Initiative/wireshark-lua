...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/Options.MulticastDepthOfBook.Pitch.v2.39.4/AddOrderLongMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/Options.MulticastDepthOfBook.Pitch.v2.39.4/DeleteOrderMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_MulticastDepthOfBook_Pitch_v2_39_4_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/Options.MulticastDepthOfBook.Pitch.v2.39.4/ModifyOrderLongMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_MulticastDepthOfBook_Pitch_v2_39_4_Dissector.lua" \
  -T json \
