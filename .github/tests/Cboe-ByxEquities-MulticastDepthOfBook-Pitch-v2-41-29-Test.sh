...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/ByxEquities.MulticastDepthOfBook.v2.41.29/AddOrderShortMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/ByxEquities.MulticastDepthOfBook.v2.41.29/ModifyOrderShortMessage.pcap" \
  -X "lua_script:Cboe/Cboe_ByxEquities_MulticastDepthOfBook_Pitch_v2_41_29_Dissector.lua" \
  -T json \
