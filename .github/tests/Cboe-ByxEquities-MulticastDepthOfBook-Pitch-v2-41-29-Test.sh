...
grep "cboe.byxequities.multicastdepthofbook.pitch.v2.41.29.nanoseconds" Cboe.ByxEquities.MulticastDepthOfBook.Pitch.v2.41.29.AddOrderShortMessage.json
...
grep "cboe.byxequities.multicastdepthofbook.pitch.v2.41.29.nanoseconds" Cboe.ByxEquities.MulticastDepthOfBook.Pitch.v2.41.29.ModifyOrderShortMessage.json
