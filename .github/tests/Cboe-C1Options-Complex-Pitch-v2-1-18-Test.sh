...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/AuctionCancelMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/AuctionNotificationMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/AuctionUpdateMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/ComplexInstrumentDefinitionExpandedMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/DeleteOrderMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/Heartbeat.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
  > Cboe.C1Options.Complex.Pitch.v2.1.18.Heartbeat.json 2> Cboe.C1Options.Complex.Pitch.v2.1.18.Heartbeat.json.stderr \
  || { echo "--- tshark FAILED (Heartbeat) ---"; cat Cboe.C1Options.Complex.Pitch.v2.1.18.Heartbeat.json.stderr; exit 1; }

runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/ModifyOrderShortMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/OrderExecutedMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/SymbolMappingMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/C1Options.Complex.v2.1.18/TimeMessage.pcap" \
  -X "lua_script:Cboe/Cboe_C1Options_Complex_Pitch_v2_1_18_Dissector.lua" \
  -T json \
