...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/ComplexStrategyDirectoryMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/ComplexStrategyDirectoryMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; else echo "could not detect transport port for ComplexStrategyDirectoryMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/ComplexStrategyTickerMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/ComplexStrategyTickerMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; else echo "could not detect transport port for ComplexStrategyTickerMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyBestAskUpdate.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyBestAskUpdate.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; else echo "could not detect transport port for StrategyBestAskUpdate"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyBestBidAndAskUpdate.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyBestBidAndAskUpdate.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; else echo "could not detect transport port for StrategyBestBidAndAskUpdate"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyBestBidUpdate.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyBestBidUpdate.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; else echo "could not detect transport port for StrategyBestBidUpdate"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyOpenClosedMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyOpenClosedMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; else echo "could not detect transport port for StrategyOpenClosedMessage"; exit 1; fi
...
udp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyTradingActionMessage.pcap" -c 1 -T fields -e udp.dstport 2>/dev/null | tr -d '[:space:]')
tcp_port=$(runuser -u tester -- tshark -r "omi-data-packets/Nasdaq/Ise.TopComboQuoteFeed.v1.0/StrategyTradingActionMessage.pcap" -c 1 -T fields -e tcp.dstport 2>/dev/null | tr -d '[:space:]')
if [ -n "$udp_port" ]; then decode="udp.port==$udp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; elif [ -n "$tcp_port" ]; then decode="tcp.port==$tcp_port,nasdaq.iseoptions.topcomboquotefeed.itch.v1.0.lua"; else echo "could not detect transport port for StrategyTradingActionMessage"; exit 1; fi
