...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/TitaniumConsolidated.Indices.v1.4.13/ContributorValueMessage.pcap" \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/TitaniumConsolidated.Indices.v1.4.13/HeartbeatMessage.pcap" \
  -X "lua_script:Cboe/Cboe_TitaniumConsolidated_Indices_Cgif_v1_4_13_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/TitaniumConsolidated.Indices.v1.4.13/IndexDefinitionMessage.pcap" \
  -X "lua_script:Cboe/Cboe_TitaniumConsolidated_Indices_Cgif_v1_4_13_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/TitaniumConsolidated.Indices.v1.4.13/IndexValueMessage.pcap" \
  -X "lua_script:Cboe/Cboe_TitaniumConsolidated_Indices_Cgif_v1_4_13_Dissector.lua" \
  -T json \
...
runuser -u tester -- tshark \
  -r "omi-data-packets/Cboe/TitaniumConsolidated.Indices.v1.4.13/IndexValueWithStatusMessage.pcap" \
  -X "lua_script:Cboe/Cboe_TitaniumConsolidated_Indices_Cgif_v1_4_13_Dissector.lua" \
  -T json \
