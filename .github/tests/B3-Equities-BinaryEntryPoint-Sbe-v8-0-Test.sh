...
grep "b3.equities.binaryentrypoint.sbe.v8.0.sessionverid" B3.Equities.BinaryEntryPoint.Sbe.v8.0.TerminateMessage.json
grep "b3.equities.binaryentrypoint.sbe.v8.0.terminationcode" B3.Equities.BinaryEntryPoint.Sbe.v8.0.TerminateMessage.json
