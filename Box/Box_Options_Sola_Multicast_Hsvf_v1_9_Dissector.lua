...
omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_market_depth_level_index = Pref.bool("Show Market Depth Level Index", show.market_depth_level_index, "Show generated market depth level index in protocol tree")
omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_complex_market_depth_level_index = Pref.bool("Show Complex Market Depth Level Index", show.complex_market_depth_level_index, "Show generated complex market depth level index in protocol tree")
omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_instrument_leg_index = Pref.bool("Show Instrument Leg Index", show.instrument_leg_index, "Show generated instrument leg index in protocol tree")
...
function omi_box_options_sola_multicast_hsvf_v1_9.prefs_changed()
  ...
  if show.market_depth_level_index ~= omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_market_depth_level_index then
    show.market_depth_level_index = omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_market_depth_level_index
  end
  if show.complex_market_depth_level_index ~= omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_complex_market_depth_level_index then
    show.complex_market_depth_level_index = omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_complex_market_depth_level_index
  end
  if show.instrument_leg_index ~= omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_instrument_leg_index then
    show.instrument_leg_index = omi_box_options_sola_multicast_hsvf_v1_9.prefs.show_instrument_leg_index
  end
end
