...
-- Box Options Sola Hsvf Multicast 1.9 Application Messages
...
box_options_sola_multicast_hsvf_v1_9.message_body.size = function(buffer, offset, message_type)
  ...
  if message_type == "U" then
    return box_options_sola_multicast_hsvf_v1_9.end_of_transmission_message.size
  end
  -- Size of Circuit Assurance Message
  if message_type == "V" then
    return box_options_sola_multicast_hsvf_v1_9.circuit_assurance_message.size
  end
  -- Size of System Timestamp Message
  if message_type == "Z" then
    return box_options_sola_multicast_hsvf_v1_9.system_timestamp_message.size
  end
  -- Size of Option Trade Message
  if message_type == "C" then
    return box_options_sola_multicast_hsvf_v1_9.option_trade_message.size
  end
  -- Size of Strategy Trade Message
  if message_type == "CS" then
    return box_options_sola_multicast_hsvf_v1_9.strategy_trade_message.size
  end
  -- Size of Option Request For Quote Message
  if message_type == "D" then
    return box_options_sola_multicast_hsvf_v1_9.option_request_for_quote_message.size
  end
  -- Size of Option Quote Message
  if message_type == "F" then
    return box_options_sola_multicast_hsvf_v1_9.option_quote_message.size
  end
  -- Size of Complex Order Quote Message
  if message_type == "FS" then
    return box_options_sola_multicast_hsvf_v1_9.complex_order_quote_message.size
  end
  -- Size of Group Opening Time Message
  if message_type == "GC" then
    return box_options_sola_multicast_hsvf_v1_9.group_opening_time_message.size
  end
  -- Size of Group Status Message
  if message_type == "GR" then
    return box_options_sola_multicast_hsvf_v1_9.group_status_message.size
  end
  -- Size of Strategies Group Status Message
  if message_type == "GS" then
    return box_options_sola_multicast_hsvf_v1_9.strategies_group_status_message.size
  end
  ...
  if message_type == "I" then
    return box_options_sola_multicast_hsvf_v1_9.option_trade_cancellation_message.size
  end
  -- Size of Complex Order Trade Cancellation Message
  if message_type == "IS" then
    return box_options_sola_multicast_hsvf_v1_9.complex_order_trade_cancellation_message.size
  end
  -- Size of Option Instrument Keys Message
  if message_type == "J" then
    return box_options_sola_multicast_hsvf_v1_9.option_instrument_keys_message.size
  end
  ...
  if message_type == "L" then
    return box_options_sola_multicast_hsvf_v1_9.bulletins_message.size
  end
  -- Size of Option Summary Message
  if message_type == "N" then
    return box_options_sola_multicast_hsvf_v1_9.option_summary_message.size
  end
  -- Size of Complex Order Summary Message
  if message_type == "NS" then
    return box_options_sola_multicast_hsvf_v1_9.complex_order_summary_message.size
  end
  -- Size of Beginning Of Options Summary Message
  if message_type == "Q" then
    return box_options_sola_multicast_hsvf_v1_9.beginning_of_options_summary_message.size
  end
  -- Size of Beginning Of Complex Order Summary Message
  if message_type == "QS" then
    return box_options_sola_multicast_hsvf_v1_9.beginning_of_complex_order_summary_message.size
  end
  -- Size of End Of Sales Message
  if message_type == "S" then
    return box_options_sola_multicast_hsvf_v1_9.end_of_sales_message.size
  end
  -- Size of Option Improvement Process Beginning Message
  if message_type == "M" then
    return box_options_sola_multicast_hsvf_v1_9.option_improvement_process_beginning_message.size
  end
  -- Size of Complex Order Improvement Process Beginning Message Message
  if message_type == "MS" then
    return box_options_sola_multicast_hsvf_v1_9.complex_order_improvement_process_beginning_message_message.size
  end
  -- Size of Market Sheet Initial And Improvement Order Message
  if message_type == "O" then
    return box_options_sola_multicast_hsvf_v1_9.market_sheet_initial_and_improvement_order_message.size
  end
  -- Size of Complex Order Market Sheet Initial And Improvement Order Message
  if message_type == "OS" then
    return box_options_sola_multicast_hsvf_v1_9.complex_order_market_sheet_initial_and_improvement_order_message.size
  end
  -- Size of Initial And Improvement Order Message
  if message_type == "T" then
    return box_options_sola_multicast_hsvf_v1_9.initial_and_improvement_order_message.size
  end
  -- Size of Complex Order Initial And Improvement Order Message
  if message_type == "TS" then
    return box_options_sola_multicast_hsvf_v1_9.complex_order_initial_and_improvement_order_message.size
  end
