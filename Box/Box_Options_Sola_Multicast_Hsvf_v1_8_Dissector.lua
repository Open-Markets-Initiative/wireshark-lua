...
omi_box_options_sola_multicast_hsvf_v1_8.fields.second_filler_1 = ProtoField.new("Second Filler 1", "box.options.sola.multicast.hsvf.v1.8.secondfiller1", ftypes.STRING)
...
function omi_box_options_sola_multicast_hsvf_v1_8.prefs_changed()
  ...
  if show.repeating_groups ~= omi_box_options_sola_multicast_hsvf_v1_8.prefs.show_repeating_groups then
    show.repeating_groups = omi_box_options_sola_multicast_hsvf_v1_8.prefs.show_repeating_groups
  end
  if show.structs ~= omi_box_options_sola_multicast_hsvf_v1_8.prefs.show_structs then
    show.structs = omi_box_options_sola_multicast_hsvf_v1_8.prefs.show_structs
  end
  if show.indexes ~= omi_box_options_sola_multicast_hsvf_v1_8.prefs.show_indexes then
    show.indexes = omi_box_options_sola_multicast_hsvf_v1_8.prefs.show_indexes
  end
end
...
-- Second Filler 1
box_options_sola_multicast_hsvf_v1_8.second_filler_1 = {}

-- Size: Second Filler 1
box_options_sola_multicast_hsvf_v1_8.second_filler_1.size = 1

-- Display: Second Filler 1
box_options_sola_multicast_hsvf_v1_8.second_filler_1.display = function(value)
  return "Second Filler 1: "..value
end

-- Dissect: Second Filler 1
box_options_sola_multicast_hsvf_v1_8.second_filler_1.dissect = function(buffer, offset, packet, parent)
  local length = box_options_sola_multicast_hsvf_v1_8.second_filler_1.size
  local range = buffer(offset, length)
  local value = range:string()
  local display = box_options_sola_multicast_hsvf_v1_8.second_filler_1.display(value, buffer, offset, packet, parent)

  parent:add(omi_box_options_sola_multicast_hsvf_v1_8.fields.second_filler_1, range, value, display)
...
box_options_sola_multicast_hsvf_v1_8.complex_order_market_sheet_initial_and_improvement_order_message.size =
  ...
  box_options_sola_multicast_hsvf_v1_8.second_filler_1.size + 
...
box_options_sola_multicast_hsvf_v1_8.complex_order_market_sheet_initial_and_improvement_order_message.fields = function(buffer, offset, packet, parent)
  ...
  index, second_filler_1 = box_options_sola_multicast_hsvf_v1_8.second_filler_1.dissect(buffer, index, packet, parent)
...
box_options_sola_multicast_hsvf_v1_8.packet.requiredsize = function(buffer)
  return buffer:len() >= box_options_sola_multicast_hsvf_v1_8.hsvf_stx.size + box_options_sola_multicast_hsvf_v1_8.message_header.size
end
...
box_options_sola_multicast_hsvf_v1_8.hsvf_stx.packet_verify = function(buffer)
...
-- Dissector Heuristic for Box Options Sola Multicast Hsvf 1.8 (Udp)
local function omi_box_options_sola_multicast_hsvf_v1_8_udp_heuristic(buffer, packet, parent)
  -- Verify packet length
  if not box_options_sola_multicast_hsvf_v1_8.packet.requiredsize(buffer) then return false end

  -- Verify Hsvf Stx
  if not box_options_sola_multicast_hsvf_v1_8.hsvf_stx.packet_verify(buffer) then return false end
...
omi_box_options_sola_multicast_hsvf_v1_8:register_heuristic("udp", omi_box_options_sola_multicast_hsvf_v1_8_udp_heuristic)

-- Register Box Options Sola Multicast Hsvf 1.8 for Decode As
local udp_table = DissectorTable.get("udp.port")
udp_table:add_for_decode_as(omi_box_options_sola_multicast_hsvf_v1_8)
