...
-- Imperative IntelligentCross 1.11 Application Messages
...
function omi_imperative_intelligentcross_mdf_v1_11.prefs_changed()
  ...
  if show.message_index ~= omi_imperative_intelligentcross_mdf_v1_11.prefs.show_message_index then
    show.message_index = omi_imperative_intelligentcross_mdf_v1_11.prefs.show_message_index
  end
end
