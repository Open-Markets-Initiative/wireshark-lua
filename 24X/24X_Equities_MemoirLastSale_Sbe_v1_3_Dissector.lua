...
n24x_equities_memoirlastsale_sbe_v1_3_display.trade_correct_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.trade_correct_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_correct_message then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.trade_correct_message(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.trade_correct_message(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.trade_correct_message, range, display)
  end
...
n24x_equities_memoirlastsale_sbe_v1_3_display.trade_cancel_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.trade_cancel_message = function(buffer, offset, packet, parent)
  ...
  if show.trade_cancel_message then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.trade_cancel_message(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.trade_cancel_message(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.trade_cancel_message, range, display)
  end
...
n24x_equities_memoirlastsale_sbe_v1_3_display.trading_session_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.trading_session_status_message = function(buffer, offset, packet, parent)
  ...
  if show.trading_session_status_message then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.trading_session_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.trading_session_status_message(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.trading_session_status_message, range, display)
  end
...
n24x_equities_memoirlastsale_sbe_v1_3_display.security_trading_status_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.security_trading_status_message = function(buffer, offset, packet, parent)
  ...
  if show.security_trading_status_message then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.security_trading_status_message(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.security_trading_status_message(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.security_trading_status_message, range, display)
  end
...
n24x_equities_memoirlastsale_sbe_v1_3_display.reg_sho_restriction_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.reg_sho_restriction_message = function(buffer, offset, packet, parent)
  ...
  if show.reg_sho_restriction_message then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.reg_sho_restriction_message(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.reg_sho_restriction_message(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.reg_sho_restriction_message, range, display)
  end
...
n24x_equities_memoirlastsale_sbe_v1_3_display.instrument_directory_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.instrument_directory_message = function(buffer, offset, packet, parent)
  ...
  if show.instrument_directory_message then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.instrument_directory_message(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.instrument_directory_message(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.instrument_directory_message, range, display)
  end
...
-- Display: Sbe Header
n24x_equities_memoirlastsale_sbe_v1_3_display.sbe_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.sbe_header = function(buffer, offset, packet, parent)
  ...
  if show.sbe_header then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.sbe_header(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.sbe_header(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.sbe_header, range, display)
  end
...
n24x_equities_memoirlastsale_sbe_v1_3_display.sequenced_message = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_display.common_header = function(buffer, offset, size, packet, parent)
  return ""
end
...
n24x_equities_memoirlastsale_sbe_v1_3_dissect.common_header = function(buffer, offset, packet, parent)
  ...
  if show.common_header then
    local length = n24x_equities_memoirlastsale_sbe_v1_3_size_of.common_header(buffer, offset)
    local range = buffer(offset, length)
    local display = n24x_equities_memoirlastsale_sbe_v1_3_display.common_header(buffer, packet, parent)
    parent = parent:add(n24x_equities_memoirlastsale_sbe_v1_3.fields.common_header, range, display)
  end
