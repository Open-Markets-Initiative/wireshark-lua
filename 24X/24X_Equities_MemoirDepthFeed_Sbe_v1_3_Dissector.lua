...
n24x_equities_memoirdepthfeed_sbe_v1_3_dissect.sbe_message = function(buffer, offset, packet, parent, size_of_sbe_message)
  ...
  if show.sbe_message then
    local element = parent:add(n24x_equities_memoirdepthfeed_sbe_v1_3.fields.sbe_message, buffer(offset, 0))
    local current = n24x_equities_memoirdepthfeed_sbe_v1_3_dissect.sbe_message_fields(buffer, offset, packet, element, size_of_sbe_message)
    element:set_len(size_of_sbe_message)
    local display = n24x_equities_memoirdepthfeed_sbe_v1_3_display.sbe_message(buffer, packet, element)
    element:append_text(display)
...
n24x_equities_memoirdepthfeed_sbe_v1_3_dissect.message = function(buffer, offset, packet, parent, size_of_message)
  ...
  if show.message then
    local element = parent:add(n24x_equities_memoirdepthfeed_sbe_v1_3.fields.message, buffer(offset, 0))
    local current = n24x_equities_memoirdepthfeed_sbe_v1_3_dissect.message_fields(buffer, offset, packet, element, size_of_message)
    element:set_len(size_of_message)
    local display = n24x_equities_memoirdepthfeed_sbe_v1_3_display.message(buffer, packet, element)
    element:append_text(display)
...
n24x_equities_memoirdepthfeed_sbe_v1_3_dissect.sequenced_message_fields = function(buffer, offset, packet, parent)
  ...
  for message_index = 1, message_count do
    ...
    index, message = n24x_equities_memoirdepthfeed_sbe_v1_3_dissect.message(buffer, index, packet, parent, size_of_message)

    if message ~= nil then
      local iteration = message:add(n24x_equities_memoirdepthfeed_sbe_v1_3.fields.message_index, message_index)
