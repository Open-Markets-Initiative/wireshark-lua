...
omi_n24x_equities_memoirdepthfeed_sbe_v1_3.prefs.show_application_messages = Pref.bool("Show Application Messages", show.application_messages, "Parse and add Application Messages to protocol tree")
...
omi_n24x_equities_memoirdepthfeed_sbe_v1_3.prefs.show_message_index = Pref.bool("Show Message Index", show.message_index, "Show generated message index in protocol tree")

-- Handle changed preferences
function omi_n24x_equities_memoirdepthfeed_sbe_v1_3.prefs_changed()

  -- Check if show options have changed
  if show.application_messages ~= omi_n24x_equities_memoirdepthfeed_sbe_v1_3.prefs.show_application_messages then
    show.application_messages = omi_n24x_equities_memoirdepthfeed_sbe_v1_3.prefs.show_application_messages
  end
  ...
  if show.message_index ~= omi_n24x_equities_memoirdepthfeed_sbe_v1_3.prefs.show_message_index then
    show.message_index = omi_n24x_equities_memoirdepthfeed_sbe_v1_3.prefs.show_message_index
  end
end
